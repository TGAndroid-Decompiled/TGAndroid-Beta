...
public final class l extends LinearLayout {
    ...
    public l(Context context, d6 d6Var) {
        ...
        cuVar.setLinkTextColor(h6.v0(h6.f19121hc, d6Var));
        cuVar.setHighlightColor(h6.v0(h6.f19367uf, d6Var));
        int i10 = h6.Vd;
        cuVar.setHintColor(h6.v0(i10, d6Var));
        cuVar.setHintTextColor(h6.v0(i10, d6Var));
        cuVar.setCursorColor(h6.v0(h6.Wd, d6Var));
        cuVar.setHandlesColor(h6.v0(h6.f19384vf, d6Var));
    ...
    public void setCount(int i10) {
        this.f44600b.setText(String.valueOf(i10));
    }
}
