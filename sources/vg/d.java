...
public final class d extends View implements ViewTreeObserver.OnPreDrawListener, ViewTreeObserver.OnScrollChangedListener, ViewTreeObserver.OnGlobalLayoutListener {
    ...
    public final RectF f49309b;
    public final RectF f49310c;
    public long d;
    public int f49311e;
    public ViewGroup f49312f;
    public ViewGroup h;
    public long f49313n;
    public b f49314r;
    public long f49315s;
    public final ArrayList v;
    public final LongSparseArray f49316w;
    public final LongSparseArray f49317x;
    public final b f49318y;

    public d(Context context) {
        super(context);
        this.f49309b = new RectF();
        this.f49310c = new RectF();
        this.v = new ArrayList();
        this.f49316w = new LongSparseArray();
        this.f49317x = new LongSparseArray();
        this.f49318y = new b(this, 1);
        this.f49308a = SharedConfig.debugViewMetrics;
    }
    ...
    public final void a() {
        ...
        if (!arrayList.isEmpty()) {
            ...
            tL_messages_reportReadMetrics.peer = MessagesController.getInstance(this.f49311e).getInputPeer(this.d);
            tL_messages_reportReadMetrics.metrics = new ArrayList<>(arrayList);
            ConnectionsManager.getInstance(this.f49311e).sendRequestTyped(tL_messages_reportReadMetrics, null, new as(2));
            arrayList.clear();
        }
    }
    ...
    public final void onAttachedToWindow() {
        ...
        AndroidUtilities.runOnUIThread(this.f49318y, 400L);
    ...
    public final void onDetachedFromWindow() {
        ...
        this.B = null;
        this.f49315s = 0L;
        AndroidUtilities.cancelRunOnUIThread(this.f49318y);
        if (BuildVars.LOGS_ENABLED) {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.f49308a) {
            ...
            LongSparseArray longSparseArray = this.f49316w;
            int size = longSparseArray.size();
            for (int i10 = 0; i10 < size; i10++) {
                c cVar = (c) longSparseArray.valueAt(i10);
                RectF rectF2 = cVar.f49299c;
                ...
                canvas.save();
                canvas.drawText("time_in_view_ms: " + cVar.f49302g, 0.0f, 0.0f, this.D);
                ...
                float f10 = cVar.f49305k;
                if (f10 == 0.0f) {
                    round = 1000;
                } else {
                    round = Math.round((cVar.f49304j / f10) * 1000.0f);
                }
                sb.append(round);
    ...
    public final void onLayout(boolean z4, int i10, int i11, int i12, int i13) {
        ...
        RectF rectF = this.f49309b;
        this.f49310c.set(rectF.left, rectF.top, getMeasuredWidth() - rectF.right, getMeasuredHeight() - rectF.bottom);
    }
