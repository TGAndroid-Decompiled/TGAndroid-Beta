...
public final class d extends View implements ViewTreeObserver.OnPreDrawListener, ViewTreeObserver.OnScrollChangedListener, ViewTreeObserver.OnGlobalLayoutListener {
    ...
    public boolean C;
    public TextPaint D;
    public final boolean f49272a;
    public final RectF f49273b;
    public final RectF f49274c;
    public long d;
    public int f49275e;
    public ViewGroup f49276f;
    public ViewGroup h;
    public long f49277n;
    public b f49278r;
    public long f49279s;
    public final ArrayList v;
    public final LongSparseArray f49280w;
    public final LongSparseArray f49281x;
    public final b f49282y;

    public d(Context context) {
        super(context);
        this.f49273b = new RectF();
        this.f49274c = new RectF();
        this.v = new ArrayList();
        this.f49280w = new LongSparseArray();
        this.f49281x = new LongSparseArray();
        this.f49282y = new b(this, 1);
        this.f49272a = SharedConfig.debugViewMetrics;
    }
    ...
    public final void a() {
        ...
        if (!arrayList.isEmpty()) {
            ...
            tL_messages_reportReadMetrics.peer = MessagesController.getInstance(this.f49275e).getInputPeer(this.d);
            tL_messages_reportReadMetrics.metrics = new ArrayList<>(arrayList);
            ConnectionsManager.getInstance(this.f49275e).sendRequestTyped(tL_messages_reportReadMetrics, null, new as(2));
            arrayList.clear();
        }
    }
    ...
    public final void onAttachedToWindow() {
        ...
        AndroidUtilities.runOnUIThread(this.f49282y, 400L);
    ...
    public final void onDetachedFromWindow() {
        ...
        this.B = null;
        this.f49279s = 0L;
        AndroidUtilities.cancelRunOnUIThread(this.f49282y);
        if (BuildVars.LOGS_ENABLED) {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.f49272a) {
            ...
            super.onDraw(canvas);
            Paint paint = k6.Ll;
            RectF rectF = this.f49274c;
            canvas.drawRect(rectF, paint);
            LongSparseArray longSparseArray = this.f49280w;
            int size = longSparseArray.size();
            for (int i10 = 0; i10 < size; i10++) {
                c cVar = (c) longSparseArray.valueAt(i10);
                RectF rectF2 = cVar.f49263c;
                ...
                canvas.save();
                canvas.drawText("time_in_view_ms: " + cVar.f49266g, 0.0f, 0.0f, this.D);
                ...
                float f10 = cVar.f49269k;
                if (f10 == 0.0f) {
                    round = 1000;
                } else {
                    round = Math.round((cVar.f49268j / f10) * 1000.0f);
                }
                sb.append(round);
    ...
    public final void onLayout(boolean z4, int i10, int i11, int i12, int i13) {
        ...
        RectF rectF = this.f49273b;
        this.f49274c.set(rectF.left, rectF.top, getMeasuredWidth() - rectF.right, getMeasuredHeight() - rectF.bottom);
    }
