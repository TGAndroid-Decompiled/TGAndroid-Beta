...
public final class a extends FrameLayout {
    public final ci.d f44577a;
    public final View f44578b;
    public final d6 f44579c;
    ...
    public final void a(int i10, boolean z10) {
        this.e = true;
        ci.d dVar = this.f44577a;
        dVar.k();
        dVar.setShowZero(true);
        dVar.setEnabled(true);
        dVar.b(i10, z10);
        dVar.g(LocaleController.getString(R.string.BoostingStartGiveaway), z10, true);
        this.f44578b.setBackgroundColor(h6.v0(h6.f19129h5, this.f44579c));
    }

    public final void b(boolean z10) {
        this.f44577a.setLoading(z10);
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.e) {
            int v02 = h6.v0(h6.f19003a7, this.f44579c);
            Paint paint = this.d;
            paint.setColor(v02);
            paint.setAlpha(255);
    ...
    public void setOnClickListener(View.OnClickListener onClickListener) {
        this.f44577a.setOnClickListener(onClickListener);
    }
}
