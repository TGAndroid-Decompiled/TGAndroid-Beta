...
public final class a extends FrameLayout {
    public final ci.d f44550a;
    public final View f44551b;
    public final e6 f44552c;
    ...
    public final void a(int i10, boolean z10) {
        this.e = true;
        ci.d dVar = this.f44550a;
        dVar.k();
        dVar.setShowZero(true);
        dVar.setEnabled(true);
        dVar.b(i10, z10);
        dVar.g(LocaleController.getString(R.string.BoostingStartGiveaway), z10, true);
        this.f44551b.setBackgroundColor(j6.v0(j6.f19133h5, this.f44552c));
    }

    public final void b(boolean z10) {
        this.f44550a.setLoading(z10);
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.e) {
            int v02 = j6.v0(j6.f19006a7, this.f44552c);
            Paint paint = this.d;
            paint.setColor(v02);
            paint.setAlpha(255);
    ...
    public void setOnClickListener(View.OnClickListener onClickListener) {
        this.f44550a.setOnClickListener(onClickListener);
    }
}
