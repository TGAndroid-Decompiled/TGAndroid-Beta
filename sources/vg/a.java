...
public final class a extends FrameLayout {
    public final ci.d f44297a;
    public final View f44298b;
    public final e6 f44299c;
    ...
    public final void a(int i10, boolean z10) {
        this.e = true;
        ci.d dVar = this.f44297a;
        dVar.k();
        dVar.setShowZero(true);
        dVar.setEnabled(true);
        dVar.b(i10, z10);
        dVar.g(LocaleController.getString(R.string.BoostingStartGiveaway), z10, true);
        this.f44298b.setBackgroundColor(i6.v0(i6.f18907h5, this.f44299c));
    }

    public final void b(boolean z10) {
        this.f44297a.setLoading(z10);
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.e) {
            int v02 = i6.v0(i6.f18780a7, this.f44299c);
            Paint paint = this.d;
            paint.setColor(v02);
            paint.setAlpha(255);
    ...
    public void setOnClickListener(View.OnClickListener onClickListener) {
        this.f44297a.setOnClickListener(onClickListener);
    }
}
