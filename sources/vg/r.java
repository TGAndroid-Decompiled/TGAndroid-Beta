...
public final class r extends FrameLayout {
    public final yf0 f44626a;
    public final o f44627b;
    public final TextView f44628c;
    public final n90 d;
    public final d6 e;
    public final k90 f44629f;
    public final Paint[] h;
    public ValueAnimator f44630n;
    ...
    public r(Context context, d6 d6Var) {
        ...
        this.h = new Paint[20];
        a(0.0f);
        v1 v1Var = oVar.f42815a;
        v1Var.f42799q = false;
        v1Var.K = false;
        v1Var.L = true;
        v1Var.H = true;
        v1Var.f42794l = new x7(this, 4);
        v1Var.c();
        yf0Var.setStarParticlesView(oVar);
        TextView textView = new TextView(context);
        this.f44628c = textView;
    ...
    public void setBoostViaGifsText(TLRPC.Chat chat) {
        ...
        this.f44628c.setText(LocaleController.formatString("BoostingBoostsViaGifts", R.string.BoostingBoostsViaGifts, new Object[0]));
        ...
        n90Var.setTextColor(h6.v0(h6.f19315r5, d6Var));
    }

    public void setPaused(boolean z10) {
        this.f44626a.setPaused(z10);
        this.f44627b.setPaused(z10);
    }

    public void setStars(final boolean z10) {
        final float f7;
        ValueAnimator valueAnimator = this.f44630n;
        if (valueAnimator != null) {
            valueAnimator.cancel();
        }
        yf0 yf0Var = this.f44626a;
        final float f10 = yf0Var.f43225b.f43200i;
        if (z10) {
            f7 = 1.0f;
        } else {
            f7 = 0.0f;
        }
        this.f44630n = ValueAnimator.ofFloat(0.0f, 1.0f);
        final float[] fArr = {0.0f};
        AndroidUtilities.cancelRunOnUIThread(yf0Var.U);
        yf0Var.d();
        yf0Var.i();
        this.f44630n.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            @Override
            public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                ...
                fArr2[0] = floatValue;
                r rVar = r.this;
                yf0 yf0Var2 = rVar.f44626a;
                yf0Var2.f43225b.f43200i = AndroidUtilities.lerp(f10, f7, floatValue);
                sg.a aVar = yf0Var2.f43225b;
                float f12 = aVar.f43198f;
                ...
                aVar.f43198f = (f13 * i10) + f12;
                aVar.b();
                rVar.a(yf0Var2.f43225b.f43200i);
            }
        });
        this.f44630n.addListener(new q(this, fArr, f10, f7, z10));
        this.f44630n.setDuration(680L);
        this.f44630n.setInterpolator(rr.h);
        this.f44630n.start();
    }
}
