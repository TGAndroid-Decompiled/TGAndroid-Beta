...
public final class r extends FrameLayout {
    public final gg0 f44664a;
    public final o f44665b;
    public final TextView f44666c;
    public final n90 d;
    public final f6 e;
    public final k90 f44667f;
    public final Paint[] h;
    public ValueAnimator f44668n;
    ...
    public r(Context context, f6 f6Var) {
        ...
        int i10 = j6.Mj;
        canvas.drawColor(i0.a.d(0.5f, j6.v0(i10, f6Var), j6.v0(j6.f19180h5, f6Var)));
        ...
        this.h = new Paint[20];
        a(0.0f);
        v1 v1Var = oVar.f42850a;
        v1Var.f42834q = false;
        v1Var.K = false;
        v1Var.L = true;
        v1Var.H = true;
        v1Var.f42829l = new a8(this, 4);
        v1Var.c();
        gg0Var.setStarParticlesView(oVar);
        TextView textView = new TextView(context);
        this.f44666c = textView;
    ...
    public void setBoostViaGifsText(TLRPC.Chat chat) {
        ...
        this.f44666c.setText(LocaleController.formatString("BoostingBoostsViaGifts", R.string.BoostingBoostsViaGifts, new Object[0]));
        ...
        n90Var.setTextColor(j6.v0(j6.f19365r5, f6Var));
    }

    public void setPaused(boolean z10) {
        this.f44664a.setPaused(z10);
        this.f44665b.setPaused(z10);
    }

    public void setStars(final boolean z10) {
        final float f7;
        ValueAnimator valueAnimator = this.f44668n;
        if (valueAnimator != null) {
            valueAnimator.cancel();
        }
        gg0 gg0Var = this.f44664a;
        final float f10 = gg0Var.f43260b.f43235i;
        if (z10) {
            f7 = 1.0f;
        } else {
            f7 = 0.0f;
        }
        this.f44668n = ValueAnimator.ofFloat(0.0f, 1.0f);
        final float[] fArr = {0.0f};
        AndroidUtilities.cancelRunOnUIThread(gg0Var.U);
        gg0Var.d();
        gg0Var.i();
        this.f44668n.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            @Override
            public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                ...
                fArr2[0] = floatValue;
                r rVar = r.this;
                gg0 gg0Var2 = rVar.f44664a;
                gg0Var2.f43260b.f43235i = AndroidUtilities.lerp(f10, f7, floatValue);
                sg.a aVar = gg0Var2.f43260b;
                float f12 = aVar.f43233f;
                ...
                aVar.f43233f = (f13 * i10) + f12;
                aVar.b();
                rVar.a(gg0Var2.f43260b.f43235i);
            }
        });
        this.f44668n.addListener(new q(this, fArr, f10, f7, z10));
        this.f44668n.setDuration(680L);
        this.f44668n.setInterpolator(qr.h);
        this.f44668n.start();
    }
}
