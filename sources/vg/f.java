...
public final class f extends FrameLayout {
    ...
    public boolean I;
    public dh.g f49320a;
    public final nw0 f49321b;
    public final FrameLayout f49322c;
    public final n9 d;
    public boolean f49323e;
    public qg.b f49324f;
    public qg.b h;
    public final Path f49325n;
    public int f49326r;
    public float f49327s;
    public float v;
    public boolean f49328w;
    public float f49329x;
    public float f49330y;

    public f(Context context) {
        super(context);
        this.f49323e = true;
        this.f49325n = new Path();
        this.D = new Rect();
        this.E = new RectF();
        FrameLayout frameLayout = new FrameLayout(context);
        this.f49322c = frameLayout;
        addView(frameLayout, c6.e(-1, -2, 80));
        n9 n9Var = new n9(this, context, 3);
        this.d = n9Var;
        addView(n9Var, c6.e(-1, -2, 80));
        this.f49321b = new nw0(this, context, 11);
    }

    public final void a(boolean z4) {
        e();
        int round = Math.round(this.f49327s) + AndroidUtilities.dp(9.0f) + this.C;
        if (this.f49326r == round && !z4) {
            return;
        }
        this.f49326r = round;
    ...
    public final void b() {
        ...
        if (bVar != null && (i10 = bVar.getBounds().top) != (measuredHeight = getMeasuredHeight() - Math.round(this.G))) {
            ...
            this.f49321b.invalidate(0, Math.max(0, Math.min(i10, measuredHeight)), getMeasuredWidth(), getMeasuredHeight());
    ...
    public final void c() {
        int i10;
        m1 m1Var = ((dh.i) this.f49320a).f4763r;
        if (m1Var != null) {
            i10 = m1Var.f46483a.f(2).d;
        } else {
            i10 = 0;
        }
        float b10 = ((dh.i) this.f49320a).b();
        n9 n9Var = this.d;
        int childCount = n9Var.getChildCount();
        for (int i11 = 0; i11 < childCount; i11++) {
            View childAt = n9Var.getChildAt(i11);
    ...
    public final void d() {
        ...
        int i11;
        this.f49327s = ((dh.i) this.f49320a).c();
        this.v = ((dh.i) this.f49320a).b();
        int i12 = 0;
        boolean z10 = true;
        if (((dh.i) this.f49320a).f4764s != 1) {
            z4 = true;
        } else {
            z4 = false;
        }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        int measuredHeight = getMeasuredHeight() - this.f49326r;
        int round = Math.round(this.f49329x);
        int measuredWidth = getMeasuredWidth() - Math.round(this.f49330y);
        int i10 = this.C;
        Rect rect = this.D;
        rect.set(round, 0, measuredWidth, i10);
        rect.inset(0, -AndroidUtilities.dp(7.0f));
        rect.offset(0, measuredHeight + ((int) this.H));
        this.f49324f.setBounds(rect);
        if (this.f49323e) {
            this.f49324f.draw(canvas);
        }
        if (this.f49328w) {
            this.h.draw(canvas);
        }
    ...
    public final void e() {
        this.f49322c.setTranslationY((-this.f49327s) - AndroidUtilities.dp(9.0f));
        n9 n9Var = this.d;
        n9Var.setTranslationY(n9Var.getMeasuredHeight() - this.v);
    }
    ...
    public float getInputBubbleBottom() {
        return (getMeasuredHeight() - this.f49327s) - AndroidUtilities.dp(9.0f);
    }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            qg.b bVar2 = this.f49324f;
            if ((bVar2 != null && bVar2.f44887j == 255 && bVar2.getBounds().contains(x10, y10)) || ((bVar = this.h) != null && bVar.getBounds().contains(x10, y10))) {
                z4 = true;
            } else {
                z4 = false;
            }
    ...
    public void setInputIslandBubbleDrawable(qg.b bVar) {
        ...
        this.f49324f.p(AndroidUtilities.dp(22.0f));
    }
