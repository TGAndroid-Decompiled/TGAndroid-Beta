...
public final class w extends FrameLayout {
    public final RadioButton f44638a;
    public final Drawable f44639b;
    public final Drawable f44640c;
    public final p6 d;
    public final p6 e;
    public final TextView f44641f;
    public final SpannableString h;
    public final SpannableString f44642n;
    public TL_stars.TL_starsGiveawayOption f44643r;
    public int f44644s;
    public final e6 v;
    ...
    public w(Context context, d6 d6Var) {
        ...
        this.f44639b = mutate;
        mutate.setColorFilter(new PorterDuffColorFilter(h6.v0(h6.f19129h5, d6Var), PorterDuff.Mode.SRC_IN));
        this.f44640c = context.getResources().getDrawable(R.drawable.star_small_inner).mutate();
        ...
        spannableString.setSpan(new t90(AndroidUtilities.dp(90.0f), p6Var), 0, 1, 33);
        ...
        this.f44642n = spannableString2;
        spannableString2.setSpan(new t90(AndroidUtilities.dp(70.0f), p6Var2), 0, 1, 33);
        TextView textView = new TextView(context);
        this.f44641f = textView;
        ok.n(i10, d6Var, textView, 1, 16.0f);
        textView.setGravity(5);
        addView(textView, y5.d(-2, -2.0f, 21, 0.0f, 0.0f, 19.0f, 0.0f));
        RadioButton radioButton = new RadioButton(context);
        this.f44638a = radioButton;
    ...
    public final void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        float d = this.v.d(this.f44644s, false);
        ...
        for (int ceil = ((int) Math.ceil(d)) - 1; ceil >= 0; ceil--) {
            ...
            int i12 = (int) (f7 + dp);
            int i13 = (int) (dp5 + dp2);
            Drawable drawable = this.f44639b;
            drawable.setBounds(i10, i11, i12, i13);
            int i14 = (int) (clamp * 255.0f);
            drawable.setAlpha(i14);
            drawable.draw(canvas);
            Drawable drawable2 = this.f44640c;
