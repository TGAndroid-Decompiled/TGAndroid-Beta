...
public final class w extends FrameLayout {
    public final RadioButton f44655a;
    public final Drawable f44656b;
    public final Drawable f44657c;
    public final o6 d;
    public final o6 e;
    public final TextView f44658f;
    public final SpannableString h;
    public final SpannableString f44659n;
    public TL_stars.TL_starsGiveawayOption f44660r;
    public int f44661s;
    public final d6 v;
    ...
    public w(Context context, f6 f6Var) {
        ...
        this.f44656b = mutate;
        mutate.setColorFilter(new PorterDuffColorFilter(j6.v0(j6.f19165h5, f6Var), PorterDuff.Mode.SRC_IN));
        this.f44657c = context.getResources().getDrawable(R.drawable.star_small_inner).mutate();
    ...
    public final void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        float d = this.v.d(this.f44661s, false);
        ...
        for (int ceil = ((int) Math.ceil(d)) - 1; ceil >= 0; ceil--) {
            ...
            Drawable drawable2 = this.f44657c;
