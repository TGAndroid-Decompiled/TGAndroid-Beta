...
public final class w extends FrameLayout {
    public final RadioButton f44386a;
    public final Drawable f44387b;
    public final Drawable f44388c;
    public final n6 d;
    public final n6 e;
    public final TextView f44389f;
    public final SpannableString h;
    public final SpannableString f44390n;
    public TL_stars.TL_starsGiveawayOption f44391r;
    public int f44392s;
    public final c6 v;
    ...
    public w(Context context, f6 f6Var) {
        ...
        this.f44387b = mutate;
        mutate.setColorFilter(new PorterDuffColorFilter(j6.v0(j6.f18934h5, f6Var), PorterDuff.Mode.SRC_IN));
        this.f44388c = context.getResources().getDrawable(R.drawable.star_small_inner).mutate();
    ...
    public final void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        float d = this.v.d(this.f44392s, false);
        ...
        for (int ceil = ((int) Math.ceil(d)) - 1; ceil >= 0; ceil--) {
            ...
            int i12 = (int) (f7 + dp);
            int i13 = (int) (dp5 + dp2);
            Drawable drawable = this.f44387b;
            drawable.setBounds(i10, i11, i12, i13);
            int i14 = (int) (clamp * 255.0f);
            drawable.setAlpha(i14);
            drawable.draw(canvas);
            Drawable drawable2 = this.f44388c;
