...
public final class b extends FrameLayout {
    public final k5 f44326a;
    public final ImageView f44327b;
    ...
    public b(Context context, f6 f6Var) {
        ...
        drawable2.setColorFilter(new PorterDuffColorFilter(j6.v0(j6.f18991k7, f6Var), mode));
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        int measuredWidth;
        int i14 = i12 - i10;
        k5 k5Var = this.f44326a;
        int textHeight = ((i13 - i11) - k5Var.getTextHeight()) / 2;
        boolean z11 = LocaleController.isRTL;
        float f7 = 23.0f;
        ImageView imageView = this.f44327b;
        if (z11) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f44326a.measure(wl.d(94.0f, size, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), 1073741824));
        this.f44327b.measure(View.MeasureSpec.makeMeasureSpec(size, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(50.0f), 1073741824));
