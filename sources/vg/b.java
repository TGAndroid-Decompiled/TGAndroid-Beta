...
public final class b extends FrameLayout {
    ...
    public b(Context context, d6 d6Var) {
        ...
        drawable2.setColorFilter(new PorterDuffColorFilter(h6.v0(h6.f19173k7, d6Var), mode));
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        int measuredWidth;
        int i14 = i12 - i10;
        h5 h5Var = this.f44570a;
        int textHeight = ((i13 - i11) - h5Var.getTextHeight()) / 2;
        boolean z11 = LocaleController.isRTL;
        float f7 = 23.0f;
        ImageView imageView = this.f44571b;
        if (z11) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f44570a.measure(ok.c(94.0f, size, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), 1073741824));
        this.f44571b.measure(View.MeasureSpec.makeMeasureSpec(size, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(50.0f), 1073741824));
