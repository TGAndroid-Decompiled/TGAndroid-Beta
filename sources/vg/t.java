...
public final class t extends FrameLayout {
    public final vh.o f44380a;
    public final FrameLayout f44381b;
    ...
    public t(Context context, f6 f6Var) {
        ...
        frameLayout.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view) {
                switch (r2) {
                    case 0:
                        AndroidUtilities.addToClipboard(this.f44379b.d);
                        return;
                    default:
                        AndroidUtilities.addToClipboard(this.f44379b.d);
                        return;
        ...
        imageView.setColorFilter(j6.v0(j6.f18970j5, f6Var));
    ...
    public final void a(Runnable runnable) {
        ...
        vh.o oVar = this.f44380a;
        oVar.setPadding(dp, dp2, dp3, dp4);
        ?? obj = new Object();
        obj.f26908a |= 256;
        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder("t.me/giftcode/" + this.f44382c);
        ...
        this.f44381b.setOnClickListener(new bi.p(4, runnable));
    }

    public void setSlug(String str) {
        this.f44382c = str;
        this.d = p6.i("https://t.me/giftcode/", str);
        this.f44380a.setText("t.me/giftcode/" + str);
    }
}
