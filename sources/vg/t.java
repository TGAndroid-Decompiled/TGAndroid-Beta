...
public final class t extends FrameLayout {
    ...
    public t(Context context, e6 e6Var) {
        ...
        frameLayout.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view) {
                switch (r2) {
                    case 0:
                        AndroidUtilities.addToClipboard(this.f44347b.d);
                        return;
                    default:
                        AndroidUtilities.addToClipboard(this.f44347b.d);
                        return;
        ...
        imageView.setColorFilter(i6.v0(i6.f18940j5, e6Var));
    ...
    public final void a(Runnable runnable) {
        ...
        vh.o oVar = this.f44348a;
        oVar.setPadding(dp, dp2, dp3, dp4);
        ?? obj = new Object();
        obj.f26642a |= 256;
        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder("t.me/giftcode/" + this.f44350c);
        ...
        this.f44349b.setOnClickListener(new bi.p(4, runnable));
    }

    public void setSlug(String str) {
        this.f44350c = str;
        this.d = q3.i("https://t.me/giftcode/", str);
        this.f44348a.setText("t.me/giftcode/" + str);
    }
}
