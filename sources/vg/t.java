...
public final class t extends FrameLayout {
    public final vh.n f44671a;
    public final FrameLayout f44672b;
    ...
    public t(Context context, f6 f6Var) {
        ...
        frameLayout.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view) {
                switch (r2) {
                    case 0:
                        AndroidUtilities.addToClipboard(this.f44670b.d);
                        return;
                    default:
                        AndroidUtilities.addToClipboard(this.f44670b.d);
                        return;
        ...
        imageView.setColorFilter(j6.v0(j6.f19216j5, f6Var));
    ...
    public final void a(Runnable runnable) {
        ...
        vh.n nVar = this.f44671a;
        nVar.setPadding(dp, dp2, dp3, dp4);
        ?? obj = new Object();
        obj.f23827a |= 256;
        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder("t.me/giftcode/" + this.f44673c);
        if (this.f44673c == null) {
            spannableStringBuilder.append((CharSequence) "1234567891011123654897566536223");
        }
        spannableStringBuilder.setSpan(new f11(obj, 0), 0, spannableStringBuilder.length(), 33);
        nVar.setText(spannableStringBuilder);
        this.f44672b.setOnClickListener(new bi.p(4, runnable));
    }

    public void setSlug(String str) {
        this.f44673c = str;
        this.d = j0.g("https://t.me/giftcode/", str);
        this.f44671a.setText("t.me/giftcode/" + str);
    }
}
