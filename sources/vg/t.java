...
public final class t extends FrameLayout {
    ...
    public t(Context context, d6 d6Var) {
        ...
        frameLayout.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view) {
                switch (r2) {
                    case 0:
                        AndroidUtilities.addToClipboard(this.f44618b.d);
                        return;
                    default:
                        AndroidUtilities.addToClipboard(this.f44618b.d);
                        return;
        ...
        imageView.setColorFilter(h6.v0(h6.f19151j5, d6Var));
    ...
    public final void a(Runnable runnable) {
        ...
        vh.n nVar = this.f44619a;
        nVar.setPadding(dp, dp2, dp3, dp4);
        ?? obj = new Object();
        obj.f22840a |= 256;
        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder("t.me/giftcode/" + this.f44621c);
        ...
        this.f44620b.setOnClickListener(new bi.p(4, runnable));
    }

    public void setSlug(String str) {
        this.f44621c = str;
        this.d = v7.j.g("https://t.me/giftcode/", str);
        this.f44619a.setText("t.me/giftcode/" + str);
    }
}
