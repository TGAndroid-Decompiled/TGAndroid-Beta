...
public final class a {
    ...
    public a(String str, Integer num, Integer num2, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9, String str10, String str11, String str12, String str13, String str14, String str15) {
        ...
        this.f6508a = p8.e(replaceAll);
        this.f6510c = num;
        this.d = num2;
        this.f6509b = p8.e(str2);
        this.e = p8.e(str3);
        this.f6511f = p8.e(str4);
        this.f6512g = p8.e(str5);
        this.h = p8.e(str6);
        this.f6513i = p8.e(str7);
        this.f6514j = p8.e(str8);
        this.f6515k = p8.e(str9);
        this.f6517m = p8.a(str10) == null ? a() : str10;
        if (p8.e(str11) == null) {
            str16 = b();
        } else {
            str16 = str11;
    ...
    public final String a() {
        ...
        if (p8.d(this.f6517m)) {
            ...
            if (!p8.d(str2)) {
                ...
                } else if (p8.c(str2, f6503p)) {
                    str = "Discover";
                } else if (p8.c(str2, f6504q)) {
                    str = "JCB";
                } else if (p8.c(str2, f6505r)) {
                    str = "Diners Club";
                } else if (p8.c(str2, f6506s)) {
                    str = "Visa";
                } else if (p8.c(str2, f6507t)) {
                    str = "MasterCard";
                } else {
                    str = "Unknown";
                }
