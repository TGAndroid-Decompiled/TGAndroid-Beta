...
public enum c {
    ...
    public static final HashMap f16738c = new HashMap();
    ...
    static {
        ...
        for (c cVar : values()) {
            if (Charset.isSupported(cVar.name())) {
                for (int i9 : cVar.f16740a) {
                    f16738c.put(Integer.valueOf(i9), cVar);
                }
                d.put(cVar.name(), cVar);
                for (String str : cVar.f16741b) {
                    d.put(str, cVar);
                }
            }
        }
