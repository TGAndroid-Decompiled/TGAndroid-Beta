...
public final class c implements b {
    ...
    public c(Context context, kb.b bVar) {
        ...
        this.f11841b = new t6(1, -1, bVar.f9358a, 1);
        ...
        if (this.e != null) {
            ...
            try {
                ...
                for (s4 s4Var : s4VarArr) {
                    arrayList.add(new jb.a(s4Var.f11618c, s4Var.d, s4Var.f11617b, s4Var.f11616a));
                }
                return arrayList;
    ...
    public final void zzb() {
        ...
        if (this.e == null) {
            try {
                IBinder b10 = m6.e.c(context, m6.e.f13755b, str).b("com.google.android.gms.vision.label.ChimeraNativeImageLabelerCreator");
                int i10 = q2.f11600b;
                if (b10 == null) {
                    aVar = null;
                } else {
                ...
                r0 U0 = ((p1) aVar).U0(new l6.b(context), this.f11841b);
                this.e = U0;
                if (U0 == null && !this.d) {
