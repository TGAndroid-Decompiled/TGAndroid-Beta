...
public final class b {
    ...
    public final a a() {
        a aVar = new a(0);
        aVar.f42433c = this.f42436a;
        aVar.f42432b = this.f42437b;
        aVar.d = this.f42438c;
        aVar.e = this.d;
        aVar.f42435g = Long.valueOf(this.e);
        aVar.h = Long.valueOf(this.f42439f);
        aVar.f42434f = this.f42440g;
        return aVar;
    }
    ...
    public final boolean equals(Object obj) {
        if (obj != this) {
            if (obj instanceof b) {
                b bVar = (b) obj;
                String str = bVar.f42440g;
                String str2 = bVar.d;
                String str3 = bVar.f42438c;
                String str4 = bVar.f42436a;
                String str5 = this.f42436a;
                if (str5 == null) {
                    if (str4 != null) {
                        return false;
                    }
                ...
                if (j.b(this.f42437b, bVar.f42437b)) {
                    String str6 = this.f42438c;
                    if (str6 == null) {
                        if (str3 != null) {
                            return false;
                        }
                    ...
                    if (this.e == bVar.e && this.f42439f == bVar.f42439f) {
                        String str8 = this.f42440g;
                        if (str8 == null) {
                            if (str == null) {
                                return true;
                            }
    ...
    public final int hashCode() {
        ...
        int c10 = (((hashCode ^ 1000003) * 1000003) ^ j.c(this.f42437b)) * 1000003;
    ...
    public final String toString() {
        ...
        sb2.append(this.f42439f);
        sb2.append(", fisError=");
        return a4.a.s(sb2, this.f42440g, "}");
    }
}
