...
public final class a {
    public static boolean f42460i = true;
    public final int f42461a;
    public int f42462b;
    public Object f42463c;
    public Serializable d;
    public Object e;
    public Object f42464f;
    ...
    public b a() {
        ...
        if (str.isEmpty()) {
            return new b((String) this.f42463c, this.f42462b, (String) this.d, (String) this.e, ((Long) this.f42465g).longValue(), ((Long) this.h).longValue(), (String) this.f42464f);
        }
    ...
    public void c() {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            ((h) this.f42464f).a((s4.a) arrayList.get(i10));
        }
        m(arrayList);
        this.f42462b = 0;
    }
    ...
    public void d() {
        h hVar = (h) this.f42464f;
        c();
        ArrayList arrayList = (ArrayList) this.d;
        int size = arrayList.size();
        for (int i10 = 0; i10 < size; i10++) {
            s4.a aVar = (s4.a) arrayList.get(i10);
            int i11 = aVar.f42924a;
            if (i11 != 1) {
                if (i11 != 2) {
                    if (i11 != 4) {
                        if (i11 == 8) {
                            hVar.a(aVar);
                            hVar.d(aVar.f42925b, aVar.d);
                        }
                    } else {
                        hVar.a(aVar);
                        hVar.b(aVar.f42925b, aVar.d, aVar.f42926c);
                    }
                } else {
                    hVar.a(aVar);
                    int i12 = aVar.f42925b;
                    int i13 = aVar.d;
                    RecyclerView recyclerView = hVar.f10517a;
                    recyclerView.e0(i12, i13, true);
                    recyclerView.f2859w0 = true;
                    recyclerView.f2855t0.f43120c += i13;
                }
            } else {
                hVar.a(aVar);
                hVar.c(aVar.f42925b, aVar.d);
            }
        }
        m(arrayList);
        this.f42462b = 0;
    ...
    public void e(s4.a aVar) {
        int i10;
        b0 b0Var = (b0) this.f42463c;
        int i11 = aVar.f42924a;
        if (i11 != 1 && i11 != 8) {
            int o9 = o(aVar.f42925b, i11);
            int i12 = aVar.f42925b;
            int i13 = aVar.f42924a;
            if (i13 != 2) {
                if (i13 == 4) {
                    i10 = 1;
                } else {
            ...
            for (int i15 = 1; i15 < aVar.d; i15++) {
                int o10 = o((i10 * i15) + aVar.f42925b, aVar.f42924a);
                int i16 = aVar.f42924a;
                if (i16 == 2 ? o10 == o9 : !(i16 != 4 || o10 != o9 + 1)) {
                    i14++;
                } else {
                    s4.a j3 = j(i16, o9, aVar.f42926c, i14);
                    f(j3, i12);
                    j3.f42926c = null;
                    b0Var.i(j3);
                    if (aVar.f42924a == 4) {
            ...
            b0Var.i(aVar);
            if (i14 > 0) {
                s4.a j10 = j(aVar.f42924a, o9, obj, i14);
                f(j10, i12);
                j10.f42926c = null;
                b0Var.i(j10);
                return;
    ...
    public void f(s4.a aVar, int i10) {
        ...
        if (i11 != 2) {
            if (i11 == 4) {
                hVar.b(i10, aVar.d, aVar.f42926c);
                return;
            }
        ...
        recyclerView.f2859w0 = true;
        recyclerView.f2855t0.f43120c += i12;
    }
    ...
    public s4.a j(int i10, int i11, Object obj, int i12) {
        s4.a aVar = (s4.a) ((b0) this.f42463c).a();
        if (aVar == null) {
            ?? obj2 = new Object();
            obj2.f42924a = i10;
            obj2.f42925b = i11;
    ...
    public int o(int i10, int i11) {
        ...
        for (int size = arrayList.size() - 1; size >= 0; size--) {
            ...
            int i14 = aVar.f42924a;
            if (i14 == 8) {
                int i15 = aVar.f42925b;
                int i16 = aVar.d;
                if (i15 < i16) {
                    i13 = i15;
                    i12 = i16;
