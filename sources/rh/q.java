...
public final class q extends FrameLayout {
    public final n9 f45687a;
    public final TextView f45688b;
    public k f45689c;

    public q(Context context, int i10, f6 f6Var) {
        super(context);
        this.f45687a = new n9(i10, this, AndroidUtilities.dp(24.0f), AndroidUtilities.dp(10.0f), AndroidUtilities.dpf2(1.0f));
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        n9 n9Var = this.f45687a;
        n9Var.setBounds(width - ((int) n9Var.f28720c.d.f15415f.f15423a), AndroidUtilities.dp(12.0f), getWidth() - AndroidUtilities.dp(11.0f), AndroidUtilities.dp(24.0f) + AndroidUtilities.dp(12.0f));
        n9Var.c(canvas);
    }
