...
public final class h extends FrameLayout {
    public final ImageView f43533a;
    public final FrameLayout.LayoutParams f43534b;
    public final FrameLayout.LayoutParams f43535c;
    public final TextView d;
    public final TextView e;
    public final TextView f43536f;

    public h(Context context, f6 f6Var) {
        super(context);
        ImageView imageView = new ImageView(context);
        this.f43533a = imageView;
    ...
    public final void a(int i10, int i11, CharSequence charSequence, CharSequence charSequence2) {
        ImageView imageView = this.f43533a;
        ...
        FrameLayout.LayoutParams layoutParams = this.f43535c;
        FrameLayout.LayoutParams layoutParams2 = this.f43534b;
        if (isEmpty) {
