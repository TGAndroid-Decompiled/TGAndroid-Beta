...
public final class h extends qh.e {
    public final TLRPC.Document f42629b;
    public final Object f42630c;

    public h(TLRPC.Document document, Object obj) {
        boolean z10;
        String str;
        this.f42629b = document;
        this.f42630c = obj;
        ...
        SvgHelper.SvgDrawable svgThumb = DocumentObject.getSvgThumb(document, j6.f19015lc, 1.0f);
        boolean z11 = z10;
