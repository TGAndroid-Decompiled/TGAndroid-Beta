...
public final class h {
    public final f f45637a;
    public final TLRPC.TL_messageMediaPoll f45638b;
    public final TLRPC.TL_inputMediaPoll f45639c;
    public final long d;
    public final String f45640e;
    public final ArrayList f45641f;
        ...
        if (fVar != null) {
            ...
            for (int i11 = 0; i11 < size2; i11++) {
                ...
                if (eVar instanceof sh.e) {
                    ...
                    f.k(tL_inputMediaPoll, keyAt, zf.d.h(((sh.f) eVar).f46406b));
                } else if (eVar instanceof sh.h) {
                    TLRPC.TL_inputMediaDocument tL_inputMediaDocument = new TLRPC.TL_inputMediaDocument();
                    TLRPC.TL_inputDocument tL_inputDocument = new TLRPC.TL_inputDocument();
                    TLRPC.Document document = ((sh.h) eVar).f46409b;
