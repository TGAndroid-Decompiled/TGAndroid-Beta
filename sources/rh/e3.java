...
public final class e3 extends l20 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static void A0(e3 e3Var, TLObject tLObject, org.telegram.ui.ActionBar.d2 d2Var) {
        ...
        if (tLObject instanceof TL_payments.connectedStarRefBots) {
                ...
                while (true) {
                    if (i12 >= arrayList.size()) {
                        ...
                        if (connectedbotstarref.revoked) {
                            ...
                            d.f13369c = Math.max(d.f13369c - 1, 0);
                        } else {
            ...
            NotificationCenter.getInstance(i10).lambda$postNotificationNameOnUIThread$1(NotificationCenter.channelConnectedBotsUpdate, Long.valueOf(d.f13368b));
            d.a();
    ...
    public static int C0(e3 e3Var) {
        return e3Var.currentAccount;
    }

    public static int D0(e3 e3Var) {
        return e3Var.currentAccount;
    }
    ...
    public static void G0(android.content.Context r36, int r37, final org.telegram.tgnet.tl.TL_payments.starRefProgram r38, long r39, org.telegram.ui.ActionBar.f6 r41, boolean r42) {
        throw new UnsupportedOperationException("Method not decompiled: rh.e3.G0(android.content.Context, int, org.telegram.tgnet.tl.TL_payments$starRefProgram, long, org.telegram.ui.ActionBar.f6, boolean):void");
    }
    ...
    public static org.telegram.ui.ActionBar.g3 H0(Context context, int i10, TL_payments.connectedBotStarRef connectedbotstarref, long j10, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        if (connectedbotstarref.participants > 0) {
            ...
            frameLayout2.setBackground(j6.b0(AndroidUtilities.dp(50.0f), j6.v0(j6.f19977h5, f6Var)));
        ...
        int v = j6.v(j6.v0(i18, f6Var), j6.v0(j6.f19996i6, f6Var));
        ...
        g3Var2.fixNavigationBar(j6.v0(j6.f19977h5, f6Var2));
    ...
    public static void z0(e3 e3Var, Context context, int i10) {
        w2 w2Var = e3Var.Q;
        if (w2Var != null) {
            Object obj = w2Var.G(i10).G;
    ...
    public final void F0(java.util.ArrayList r18, org.telegram.ui.Components.w51 r19) {
        throw new UnsupportedOperationException("Method not decompiled: rh.e3.F0(java.util.ArrayList, org.telegram.ui.Components.w51):void");
    }
    ...
    public final View createView(Context context) {
        ...
        this.P = hnVar;
        hnVar.setBackgroundColor(j6.w0(null, j6.f19995i5, false));
        ...
        this.f35881c.setOnItemClickListener(new gg.v0(24, this, context));
        this.f35881c.setOnItemLongClickListener(new org.telegram.ui.web.m(5, this, context));
        f2.l lVar = new f2.l();
        lVar.f5818m = false;
        lVar.C = false;
        lVar.o(nr.h);
        ...
        this.f35881c.setOnScrollListener(new lb0(this, 15));
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        } else if (i10 == NotificationCenter.channelSuggestedBotsUpdate && ((Long) objArr[0]).longValue() == j10 && (w2Var = this.Q) != null) {
            w2Var.N(true);
        }
    }
    ...
    public final f2.o0 n0() {
        w2 w2Var = new w2(this, this.f35881c, getParentActivity(), this.currentAccount, this.classGuid, new d4(this, 12), getResourceProvider());
        this.Q = w2Var;
        return w2Var;
    }
