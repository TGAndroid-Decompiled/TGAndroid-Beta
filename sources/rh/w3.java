...
public final class w3 extends Drawable implements s6, NotificationCenter.NotificationCenterDelegate {
    public final Paint f43831a;
    public final Paint f43832b;
    public final ImageReceiver f43833c;
    public final ImageReceiver d;
    public int e;
    public final l5[] f43834f;
    public final k01 h;
    public final RectF f43835n;
    public final boolean f43836r;
    public final z5 f43837s;
    public boolean v;
    ...
    public w3(TLRPC.User user) {
        ...
        this.f43833c = imageReceiver;
        this.d = new ImageReceiver();
        this.e = 1;
        this.f43834f = new l5[2];
        this.f43835n = new RectF();
        this.f43837s = new z5(new v3(this, 1), 320L, nr.h, 0);
        this.f43836r = false;
        int i10 = j6.f19906d6;
    ...
    public final void a(jj0 jj0Var) {
        ...
        this.f43833c.setParentView(jj0Var);
    }

    @Override
    public final void b(ImageReceiver imageReceiver) {
        this.f43838w = false;
        this.f43833c.onDetachedFromWindow();
        ...
        l5[] l5VarArr = this.f43834f;
        l5 l5Var = l5VarArr[0];
        if (l5Var != null) {
            l5Var.o(this.f43839x);
        }
        l5 l5Var2 = l5VarArr[1];
        if (l5Var2 != null) {
            l5Var2.o(this.f43839x);
        }
    }
    ...
    public final void c(ImageReceiver imageReceiver) {
        this.f43838w = true;
        this.f43833c.onAttachedToWindow();
        ...
        l5 l5Var = l5VarArr[0];
        if (l5Var != null) {
            l5Var.a(this.f43839x);
        }
        l5 l5Var2 = l5VarArr[1];
        if (l5Var2 != null) {
            l5Var2.a(this.f43839x);
        }
    }
    ...
    public final void d() {
        ...
        if (stickerSet != null && !stickerSet.documents.isEmpty()) {
            ...
            if (this.f43838w && (l5Var = l5VarArr[this.e]) != null) {
                l5Var.a(this.f43839x);
            }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.groupStickersDidLoad && this.v && this.f43838w) {
            this.v = false;
            d();
        }
    }
    ...
    public final void draw(Canvas canvas) {
        ...
        boolean z4 = this.f43836r;
        if (z4) {
            i10 = 48;
        } else {
            i10 = 28;
        }
        float dp = (AndroidUtilities.dp((i10 + 38) + 6.66f) + this.h.f26084c) / 2.0f;
        float dp2 = AndroidUtilities.dp(32.0f) / 2.0f;
        RectF rectF = this.f43835n;
        rectF.set(bounds.centerX() - dp, bounds.centerY() - dp2, bounds.centerX() + dp, bounds.centerY() + dp2);
        canvas.drawRoundRect(rectF, dp2, dp2, this.f43831a);
        ImageReceiver imageReceiver = this.f43833c;
        ...
        if (z4) {
            ...
            canvas.drawCircle(dp3, rectF.centerY(), AndroidUtilities.dp(24.0f), this.f43832b);
        ...
        float d = this.f43837s.d(this.e, false);
        canvas.save();
    ...
    public w3(TLRPC.User user, TLRPC.Document document) {
        ...
        imageReceiver2.setImage(ImageLocation.getForDocument(document), "120_120", ImageLocation.getForDocument(closestPhotoSizeWithSize, document), "120_120", DocumentObject.getSvgThumb(document.thumbs, j6.f19852a7, 0.35f), 0L, null, null, 0);
        this.h = new k01(UserObject.getUserName(user), 14.0f, null);
    }
