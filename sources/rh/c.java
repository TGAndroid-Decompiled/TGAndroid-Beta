...
public final class c extends qh.e {
    ...
    public final Uri f42584c;
    public final String d;
    public final long e;
    public final String f42585f;
    public final Drawable h;
    public final StaticLayout f42586n;
    ...
    public c(String str) {
        ...
        if (!TextUtils.isEmpty(str2)) {
            ...
            this.f42586n = new StaticLayout(TextUtils.ellipsize(str2, textPaint, AndroidUtilities.dp(34.0f), TextUtils.TruncateAt.END), textPaint, AndroidUtilities.dp(34.0f), Layout.Alignment.ALIGN_CENTER, 1.0f, 0.0f, false);
            return;
        }
        this.f42586n = null;
    }
    ...
    public static b d(View view, String str, String str2, TLRPC.Document document, MessageObject messageObject) {
        b bVar = new b();
        bVar.f42574a.setColor(i6.w0(null, i6.G6, false));
        bVar.f42575b.setColor(i6.w0(null, i6.f19215y6, false));
        RadialProgress2 radialProgress2 = new RadialProgress2(view, null);
        bVar.f42576c = radialProgress2;
        radialProgress2.setCircleRadius(AndroidUtilities.dp(21.0f));
        bVar.f42576c.g(i6.f18931ie, i6.f18949je, i6.f19151uc, i6.f19168vc);
        if (MessageObject.isMusicDocument(document)) {
            if (MessageObject.isDocumentHasThumb(document)) {
                ...
                bVar.f42576c.j(FileLoader.getClosestPhotoSizeWithSize(document.thumbs, AndroidUtilities.dp(44.0f), true, closestPhotoSizeWithSize, true), closestPhotoSizeWithSize, document, messageObject);
            } else {
                String artworkUrl = MessageObject.getArtworkUrl(document, true);
                if (!TextUtils.isEmpty(artworkUrl)) {
                    bVar.f42576c.h(artworkUrl);
                } else {
                    bVar.f42576c.i(null, null, null);
                }
            }
            bVar.f42576c.setIcon(0, false, false);
        } else {
            bVar.f42576c.setIcon(5, false, false);
        }
        if (str == null) {
            str = "";
        }
    ...
    public c(Uri uri) {
        ...
        if (!TextUtils.isEmpty(str)) {
            ...
            textPaint.setTypeface(AndroidUtilities.bold());
            textPaint.setColor(i6.w0(null, i6.Bi, false));
            this.f42586n = new StaticLayout(TextUtils.ellipsize(str, textPaint, AndroidUtilities.dp(34.0f), TextUtils.TruncateAt.END), textPaint, AndroidUtilities.dp(34.0f), Layout.Alignment.ALIGN_CENTER, 1.0f, 0.0f, false);
            return;
        }
        this.f42586n = null;
    }
