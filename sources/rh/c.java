...
public final class c extends FrameLayout implements ViewTreeObserver.OnPreDrawListener {
    ...
    public final le.b H;
    public final le.b I;
    public final b6 f45632a;
    public final b f45633b;
    public final d f45634c;
    public final co d;
    public final FrameLayout.LayoutParams f45635e;
    public final j5 f45636f;
    public e h;
    public t1 f45637n;
    public int f45638r;
    public ug f45639s;
    public final v51 v;
    public final v51 f45640w;
    public final int f45641x;
    public final int[] f45642y;

    public c(Activity activity, f6 f6Var, co coVar) {
        super(activity);
        FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams(0, -2);
        this.f45635e = layoutParams;
        this.f45642y = new int[2];
        this.E = new Rect();
        ...
        this.d = coVar;
        this.f45641x = coVar.getMessagesController().config.pollAnswerLengthMax.get();
    ...
    public static void a(c cVar) {
        j5 j5Var = cVar.f45636f;
        y10.d(j5Var, cVar.H.f15395e);
        int i10 = j6.A6;
        co coVar = cVar.d;
        j5Var.setTextColor(i0.a.d(cVar.I.f15395e, j6.v0(i10, coVar.getResourceProvider()), j6.v0(j6.f20908p7, coVar.getResourceProvider())));
    }
    ...
    public final boolean onPreDraw() {
        t1 t1Var;
        th.a aVar;
        t1 t1Var2 = this.f45637n;
        if (t1Var2 != null) {
            int id2 = t1Var2.getMessageObject().getId();
            if (this.f45637n.isAttachedToWindow() && this.f45638r == id2 && (aVar = (t1Var = this.f45637n).f22889a6) != null && t1Var.f23073n6) {
                Rect bounds = aVar.getBounds();
                Rect rect = this.E;
                rect.set(bounds);
                t1 t1Var3 = this.f45637n;
                int[] iArr = this.f45642y;
                ...
                FrameLayout.LayoutParams layoutParams = this.f45635e;
                int i12 = layoutParams.width;
                v51 v51Var = this.f45640w;
                if (i12 != width) {
    ...
    public void setCellToWatch(t1 t1Var) {
        this.f45637n = t1Var;
        this.f45638r = t1Var.getMessageObject().getId();
    }
    ...
    public void setColor(int i10) {
        if (this.G != i10) {
            ...
            b bVar = this.f45633b;
            bVar.f45630b.setColorFilter(porterDuffColorFilter);
            bVar.f45631c.setColorFilter(porterDuffColorFilter);
            this.f45634c.f45643a.setColorFilter(porterDuffColorFilter);
            b6 b6Var = this.f45632a;
