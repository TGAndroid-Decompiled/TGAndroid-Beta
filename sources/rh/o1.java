...
public abstract class o1 {
    public static void a(Activity activity, final int i10, final long j10, final long j11, TL_bots.botVerifierSettings botverifiersettings, final k1 k1Var) {
        ...
        p9Var2.setEmojiColorFilter(new PorterDuffColorFilter(j6.w0(null, j6.f20301z9, false), PorterDuff.Mode.SRC_IN));
        ...
        k5Var.setTextColor(j6.w0(null, j6.f20012j5, false));
        ...
        alertDialog$Builder.f19503a.O = LocaleController.getString(R.string.BotRemoveVerificationTitle);
        if (i12 >= 0) {
        ...
        alertDialog$Builder.k(LocaleController.getString(R.string.Remove), new org.telegram.ui.ActionBar.c2() {
            ...
            public final void i(org.telegram.ui.ActionBar.d2 d2Var, int i13) {
                ...
                ConnectionsManager.getInstance(i14).sendRequest(setcustomverification, new ii1(4, zArr2, k1Var));
            }
        });
