...
public final class o1 {
    public final SparseIntArray f43704a = new SparseIntArray();
    public final SparseIntArray f43705b = new SparseIntArray();
    public final int[] f43706c = {j6.G6, j6.f20184u8, j6.G8, j6.E8, j6.F8, j6.I5, j6.Ii};
    public float d;

    public final int a(int i10) {
        return i0.a.d(this.d, this.f43704a.get(i10), this.f43705b.get(i10));
    }
    ...
    public final void c(SparseIntArray sparseIntArray, int i10, f6 f6Var) {
        ...
        while (i13 < iArr.length) {
            ...
            if (i15 != j6.G8 && i15 != j6.E8 && i15 != j6.F8 && i15 != (i12 = j6.I5)) {
                ...
                } else if (i15 != j6.f20184u8 && i15 != i12) {
