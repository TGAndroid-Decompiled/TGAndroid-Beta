...
public final class f0 extends Drawable {
    public final ImageView f43505a;
    public final Paint f43506b;
    public final RectF f43507c;
    public final long d;
    public final Drawable e;
    public boolean f43508f;
    public float f43509g;
    public boolean h;
    public final z5 f43510i;
    public final z5 f43511j;
    public final z5 f43512k;
    public gj0 f43513l;

    public f0(Context context, ImageView imageView) {
        Paint paint = new Paint(1);
        this.f43506b = paint;
        this.f43507c = new RectF();
        this.h = false;
        ga gaVar = new ga(this, 5);
        nr nrVar = nr.h;
        this.f43510i = new z5(gaVar, 320L, nrVar, 0);
        this.f43511j = new z5(new ga(this, 5), 320L, nrVar, 0);
        this.f43512k = new z5(new ga(this, 5), 320L, nrVar, 0);
        this.f43505a = imageView;
    ...
    public final void draw(Canvas canvas) {
        ...
        if (e < 1.0f) {
            ...
            float f19 = f14 + dp;
            float f20 = f15 + dp;
            RectF rectF = this.f43507c;
            rectF.set(f17, f18, f19, f20);
            float e6 = this.f43510i.e(this.f43508f);
            ...
            paint.setColor(j6.l1(f16, -1));
            canvas2 = canvas;
            canvas2.drawArc(rectF, (-90.0f) - max, Math.max(0.02f, this.f43511j.d(this.f43509g, false)) * (-360.0f) * e6, false, paint);
            invalidateSelf();
            canvas2.restore();
        } else {
            f10 = 255.0f;
        ...
        if (e > f11 && (gj0Var = this.f43513l) != null) {
            int i12 = gj0Var.f25148b / 2;
            int i13 = gj0Var.f25150c / 2;
            gj0Var.setBounds(centerX - i12, centerY - i13, i12 + centerX, i13 + centerY);
            this.f43513l.setAlpha((int) (e * f10));
            this.f43513l.draw(canvas2);
        }
    }
