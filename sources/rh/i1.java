...
public final class i1 {
        ...
        try {
            ...
            try {
                ...
                while (keys.hasNext()) {
                    ...
                    ?? obj = new Object();
                    obj.f43611a = next;
                    obj.f43612b = jSONObject2.getLong("user_id");
                    obj.f43613c = jSONObject2.getString("user_name");
    ...
    public static void k(HashMap hashMap) {
        try {
            ...
            for (Map.Entry entry : hashMap.entrySet()) {
                ...
                jSONObject2.put("user_id", ((h1) entry.getValue()).f43612b);
                jSONObject2.put("user_name", ((h1) entry.getValue()).f43613c);
    ...
    public final File c() {
        ...
        if (this.d && TextUtils.isEmpty(this.e)) {
            ...
            while (true) {
                ...
                if (((h1) entry.getValue()).f43612b == j10) {
            ...
            if (TextUtils.isEmpty(this.e)) {
                ...
                obj.f43611a = uuid;
                obj.f43612b = j10;
                obj.f43613c = DialogObject.getName(UserConfig.getInstance(this.f43618a).getCurrentUser());
    ...
    public final void j(String str) {
        ...
        if (!e(c()).keys().hasNext()) {
            ...
            if (h1Var != null) {
                h1Var.f43612b = this.f43620c;
                h1Var.f43613c = DialogObject.getName(UserConfig.getInstance(this.f43618a).getCurrentUser());
                h1Var.e = System.currentTimeMillis();
                k(i11);
                this.e = h1Var.f43611a;
                return;
            }
