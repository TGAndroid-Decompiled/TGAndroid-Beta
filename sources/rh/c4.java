...
public final class c4 extends ReplacementSpan {
    ...
    public final TL_iv.textButton f47088a;

    public RichMessageLayout.RichButtonSpan f47089b;
    ...
    public final void a(int i10, View view, c6 c6Var) {
        View view2;
        RichMessageLayout.RichButtonSpan richButtonSpan = this.f47089b;
        if (richButtonSpan != null && (view2 = this.f47090c) != null) {
    ...
    public final RichMessageLayout.RichButtonSpan b() {
        if (this.f47089b == null) {
            RichMessageLayout.RichButtonSpan richButtonSpanCreateEditorButtonSpan = RichMessageLayout.createEditorButtonSpan(this.d, AndroidUtilities.dp(240.0f), this.f47091e, this.f47088a);
            this.f47089b = richButtonSpanCreateEditorButtonSpan;
