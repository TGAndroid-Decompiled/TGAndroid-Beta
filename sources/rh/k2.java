...
public final class k2 implements org.telegram.ui.web.g0 {
    ...
    public final Context f43647b;
    public final f6 f43648c;
    public final p2 d;
    ...
    public final void l(boolean z4, boolean z10, String str, long j10, int i10, int i11, boolean z11, boolean z12, String str2) {
        ...
        l2Var.e.d = obj;
        u.b(l2Var.f43841f[1].f43809l, obj, true);
        l2Var.invalidate();
    ...
    public final void n(TLRPC.InputInvoice inputInvoice, String str, TLObject tLObject) {
        ...
        g2 g2Var = p2Var.v;
        o2 o2Var = p2Var.e;
        org.telegram.ui.ActionBar.p2 lastFragment = ((LaunchActivity) p2Var.f43741h0).O().getLastFragment();
        lo0 lo0Var = null;
        ...
        if (lo0Var != null) {
            ...
            AndroidUtilities.hideKeyboard(o2Var);
            cd0 cd0Var = new cd0(this.f43647b);
            cd0Var.show();
            lo0Var.W0 = new ph.l1(this, cd0Var, str);
            lo0Var.V0 = this.f43648c;
            cd0Var.c(lo0Var);
        }
    }
    ...
    public final void q(boolean z4, boolean z10, String str, long j10, int i10, int i11, boolean z11, boolean z12) {
        ...
        int totalHeight = l2Var.getTotalHeight();
        l2Var.e.f1379c = obj;
        s[] sVarArr = l2Var.f43841f;
        sVarArr[0].f43809l.b();
        if (obj.f43826f != 0) {
            SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder();
            spannableStringBuilder.append((CharSequence) "* ");
            spannableStringBuilder.append((CharSequence) obj.e);
            spannableStringBuilder.setSpan(new u5(obj.f43826f, 1.4f, sVarArr[0].f43809l.f25846a.getFontMetricsInt()), 0, 1, 33);
            sVarArr[0].f43809l.q(spannableStringBuilder, true, true);
        } else {
            sVarArr[0].f43809l.q(obj.e, true, true);
        }
        l2Var.invalidate();
        if (totalHeight != l2Var.getTotalHeight() && l2Var.f43843r != null) {
            if (totalHeight < l2Var.getTotalHeight()) {
    ...
    public final void v(TLRPC.User user, String str, ArrayList arrayList) {
        ...
        cd0 cd0Var = new cd0(this.f43647b);
        qyVar.f37649z2 = new a1.d(this, user, str, cd0Var, 21);
        cd0Var.show();
        cd0Var.c(qyVar);
    }
    ...
    public final u0 z() {
        p2 p2Var = this.d;
        if (p2Var.f43763y0 == null) {
            u0 u0Var = new u0(this.f43647b);
            p2Var.f43763y0 = u0Var;
            u0Var.f43851k = p2Var.f43760x.getWebView();
        }
        return p2Var.f43763y0;
    }
