...
public final class y3 extends org.telegram.ui.ActionBar.p2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public org.telegram.ui.ActionBar.i2 f43862b;
    public g61 f43863c;
    ...
    public final void U(ArrayList arrayList, w51 w51Var) {
        lh.z e = lh.b0.g(this.currentAccount).e(this.f43861a);
    ...
    public final void V(i51 i51Var) {
        ...
        if (obj instanceof TL_payments.starRefProgram) {
            e3.G0(getParentActivity(), this.currentAccount, (TL_payments.starRefProgram) obj, this.f43861a, this.resourceProvider, false);
        }
    }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        g61 g61Var;
        if (i10 == NotificationCenter.channelSuggestedBotsUpdate && ((Long) objArr[0]).longValue() == this.f43861a && (g61Var = this.f43863c) != null && (g61Var.getAdapter() instanceof w51)) {
            ((w51) this.f43863c.getAdapter()).N(true);
        }
    }
