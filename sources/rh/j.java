...
public final class j extends n20 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static void A0(j jVar, int i10) {
        ...
        if (eVar != null) {
            ...
            if (i11 == 4) {
                ...
                alertDialog$Builder.f19478a.O = LocaleController.getString(R.string.AffiliateProgramAlert);
    ...
    public static void x0(j jVar, Context context) {
        ...
        alertDialog$Builder.f19478a.Q = LocaleController.getString(i10);
        ...
        alertDialog$Builder.k(LocaleController.getString(i11), new z8(dVar, 2));
    ...
    public final void E0(ArrayList arrayList, w51 w51Var) {
        ...
        i51Var3.f25589p = strArr2;
        i51Var3.f25598z = indexOf;
        i51Var3.C = aVar2;
        i51Var3.B = -1L;
    ...
    public final void H0(boolean z4) {
        ...
        f90Var.setText(AndroidUtilities.replaceSingleTag(LocaleController.getString(i11), new d(this, 2)));
        I0();
        e eVar = this.Z;
        if (eVar != null) {
            eVar.N(z4);
    ...
    public final View createView(Context context) {
        ...
        new nw0(this, context, 8).setBackgroundColor(j6.w0(null, j6.f19970i5, false));
        ...
        this.P = linearLayout;
        linearLayout.setOrientation(1);
        this.P.setBackgroundColor(getThemedColor(j6.f19881d6));
        ...
        this.R = f90Var;
        f90Var.setTextColor(getThemedColor(j6.f20273z6));
        this.R.setLinkTextColor(getThemedColor(j6.f19941gc));
        this.R.setTextSize(1, 12.0f);
        this.R.setGravity(17);
        this.P.addView(this.R, b6.k(32.0f, 1.0f, 32.0f, 8.0f, -1, -2));
        H0(false);
        ((FrameLayout) this.fragmentView).addView(this.P, b6.e(-1, -2, 87));
        this.f36318c.setPadding(0, 0, 0, AndroidUtilities.dp(84.0f));
        this.f36318c.setOnItemClickListener(new dg.n(this, 19));
        f2.l lVar = new f2.l();
        lVar.f5807m = false;
        lVar.C = false;
        lVar.o(mr.h);
    ...
    public final int getNavigationBarColor() {
        return getThemedColor(j6.f19881d6);
    }

    @Override
    public final f2.o0 n0() {
        e eVar = new e(this, this.f36318c, getParentActivity(), this.currentAccount, this.classGuid, new d4(this, 7), getResourceProvider());
        this.Z = eVar;
        return eVar;
    }
    ...
    public final void onInsets(int i10, int i11, int i12, int i13) {
        this.f36318c.setPadding(0, 0, 0, AndroidUtilities.dp(84.0f) + i13);
