...
public final class p0 extends Drawable implements s6 {
    public final Paint f43724a;
    public final Paint f43725b;
    public final Paint f43726c;
    public final ImageReceiver d;
    public final ImageReceiver e;
    public final Drawable f43727f;

    public p0(Context context, TLRPC.User user, TLRPC.User user2) {
        Paint paint = new Paint(1);
        this.f43724a = paint;
        this.f43725b = new Paint(1);
    ...
    public final void draw(Canvas canvas) {
        ...
        canvas.drawCircle(centerX, dp2, AndroidUtilities.dp(12.0f), this.f43726c);
