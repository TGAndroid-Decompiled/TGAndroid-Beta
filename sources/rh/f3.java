...
public final class f3 extends FrameLayout {
    ...
    public final void draw(Canvas canvas) {
        ...
        float max = Math.max((getWidth() - this.e) - AndroidUtilities.dp(4.0f), getHeight()) * this.f43519b;
        ...
        Path path = this.f43518a;
        path.rewind();
        path.addRoundRect(rectF, dp, dp, Path.Direction.CW);
        canvas.clipPath(path);
        canvas.drawColor(this.d);
        canvas.saveLayerAlpha(rectF, (int) ((1.0f - (Math.min(0.5f, this.f43519b) / 0.5f)) * 255.0f), 31);
        canvas.translate(AndroidUtilities.dp(10.0f), height);
        a0 a0Var = this.f43521f;
        if (a0Var != null) {
            a0Var.setDrawBackgroundDrawable(false);
            this.f43521f.draw(canvas);
            this.f43521f.setDrawBackgroundDrawable(true);
        }
        canvas.restore();
        canvas.translate((1.0f - this.f43519b) * (-AndroidUtilities.dp(8.0f)), 0.0f);
        super.draw(canvas);
        canvas.restore();
    }
    ...
    public void setProgress(float f10) {
        this.f43519b = f10;
        this.d = i0.a.d(f10, j6.w0(null, j6.f19897cf, false), this.f43520c);
