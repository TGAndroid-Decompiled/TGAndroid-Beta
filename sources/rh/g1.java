...
public final class g1 extends FrameLayout {
    ...
    public final RadioButton f43601b;
    public final boolean f43602c;

    public g1(h1 h1Var, boolean z4, Context context) {
        super(context);
        this.f43600a = h1Var.f43611a;
        RadioButton radioButton = new RadioButton(context);
        this.f43601b = radioButton;
        ...
        b10.setText(h1Var.f43613c);
        addView(b10, b6.t(-1, -2, 7, 62, 9, 8, 0));
        TextView b11 = f6.b(context, 14.0f, j6.f20256y6, false, null);
    ...
    public final void onDraw(Canvas canvas) {
        if (this.f43602c) {
            canvas.drawLine(AndroidUtilities.dp(62.0f), getMeasuredHeight() - 1, getMeasuredWidth(), getMeasuredHeight() - 1, j6.f20000k0);
        }
    }
}
