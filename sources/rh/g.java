...
public final class g extends Drawable implements DownloadController.FileDownloadProgressListener, ao0 {
    ...
    public boolean X;
    public boolean Y;
    public final le.b f45647a;
    public int f45648a0;
    public final ImageReceiver f45649b;
    public int f45650b0;
    public final int f45651c;
    public final t1 d;
    public final int f45653d0;
    ...
    public f01 f45661s;
    public f01 v;
    public final RadialProgress2 f45663x;
    public final boolean f45664y;
    public final Paint f45662w = new Paint(1);
    public int Z = 0;
    public int f45652c0 = 255;

    public g(int i10, t1 t1Var, f6 f6Var, boolean z10) {
        ImageReceiver imageReceiver = new ImageReceiver(t1Var);
        this.f45649b = imageReceiver;
        imageReceiver.setRoundRadius(AndroidUtilities.dp(6.0f));
        this.f45651c = i10;
        this.f45664y = z10;
        this.f45663x = new RadialProgress2(t1Var, f6Var);
        this.d = t1Var;
        bo0 bo0Var = new bo0(t1Var);
        this.K = bo0Var;
        bo0Var.h = this;
        this.f45647a = new le.b(t1Var, ke.a.f14926a, 180L);
        this.f45653d0 = DownloadController.getInstance(i10).generateObserverTag();
    }

    public final void a() {
        this.f45649b.onAttachedToWindow();
        this.f45663x.e();
    }
    ...
    public final void d(boolean z10) {
        ...
        this.f45662w.setColor(1711276032);
        f01 f01Var2 = this.v;
        if (f01Var2 != null) {
            f01Var2.o(-1);
        }
        ...
        boolean z11 = this.X;
        RadialProgress2 radialProgress2 = this.f45663x;
        if (!z11 && !this.W) {
            radialProgress2.g(j6.f20844le, j6.f20862me, j6.ne, j6.f20896oe);
            return;
        }
        bo0 bo0Var = this.K;
        if (z10) {
            int w02 = j6.w0(null, j6.f21040wb, false);
            int w03 = j6.w0(null, j6.f21057xb, false);
            int i12 = j6.f21093zb;
            bo0Var.h(w02, w03, j6.w0(null, i12, false), j6.w0(null, i12, false), j6.w0(null, j6.f21074yb, false));
            radialProgress2.g(j6.Nb, j6.Ob, j6.Pa, j6.Qa);
            return;
        }
        radialProgress2.g(j6.f20788ie, j6.f20806je, j6.f21005uc, j6.f21022vc);
        int w04 = j6.w0(null, j6.f21006ud, false);
        int w05 = j6.w0(null, j6.f21023vd, false);
        int i13 = j6.f21058xd;
        bo0Var.h(w04, w05, j6.w0(null, i13, false), j6.w0(null, i13, false), j6.w0(null, j6.f21041wd, false));
    }
    ...
    public final void draw(Canvas canvas) {
        ...
        if (this.f45652c0 != 0 && !bounds.isEmpty()) {
            int i11 = 0;
            f(false);
            boolean z10 = this.W;
            int i12 = 2;
            RadialProgress2 radialProgress2 = this.f45663x;
            if (!z10 && !this.X) {
                ImageReceiver imageReceiver = this.f45649b;
                imageReceiver.setAlpha(this.f45652c0 / 255.0f);
                ...
                if (this.Y && (drawable = this.P) != null) {
                    ...
                    int imageHeight = (int) ((((imageReceiver.getImageHeight() / 2.0f) - intrinsicHeight) + imageReceiver.getImageY()) - ((1.0f - pr.f29497k.getInterpolation(imageReceiver.getCurrentAlpha())) * AndroidUtilities.dp(16.0f)));
                ...
                if (this.G && this.v != null) {
                    canvas.drawRoundRect(AndroidUtilities.dp(6.0f) + bounds.left, AndroidUtilities.dp(6.0f) + bounds.top, bounds.left + this.v.f25874c + AndroidUtilities.dp(18.0f), AndroidUtilities.dp(23.0f) + bounds.top, AndroidUtilities.dp(8.5f), AndroidUtilities.dp(8.5f), this.f45662w);
                    this.v.e(canvas, AndroidUtilities.dp(12.0f) + bounds.left, AndroidUtilities.dp(15.0f) + bounds.top);
                }
            } else {
                int i13 = bounds.left;
                boolean z11 = this.f45664y;
                if (z11) {
                    dp = 0;
                } else {
                ...
                if (this.X) {
                    float f7 = this.f45647a.f15395e;
                    if (this.f45660r != null && f7 < 1.0f) {
                        canvas.save();
                        float f10 = 1.0f - f7;
                        int i17 = i16 + i11;
                        canvas.scale(f10, f10, AndroidUtilities.dp(56.0f) + i14, AndroidUtilities.dp(35.0f) + i17);
                        this.f45660r.f25872a.setAlpha((int) (f10 * 255.0f));
                        this.f45660r.e(canvas, AndroidUtilities.dp(56.0f) + i14, AndroidUtilities.dp(35.0f) + i17);
                        canvas.restore();
                    }
                    if (f7 > 0.0f) {
                        bo0 bo0Var = this.K;
                        bo0Var.f24798t = f7;
                        bo0Var.j(wl.v(56.0f, i14, bounds.right), AndroidUtilities.dp(30.0f));
                        canvas.save();
    ...
    public final void f(boolean z10) {
        ...
        if (this.Z != dp || z10) {
            ...
            if (str != null) {
                if (this.f45659n == null) {
                    this.f45659n = new f01(str, 15.0f, AndroidUtilities.bold());
                }
                f01 f01Var = this.f45659n;
                f01Var.r(TextUtils.ellipsize(this.f45654e, f01Var.f25872a, dp, TextUtils.TruncateAt.MIDDLE));
            }
            String str2 = this.f45656f;
            if (str2 != null) {
                if (this.f45660r == null) {
                    this.f45660r = new f01(str2, 14.0f, null);
                }
                f01 f01Var2 = this.f45660r;
                f01Var2.r(TextUtils.ellipsize(this.f45656f, f01Var2.f25872a, dp, TextUtils.TruncateAt.END));
            }
            String str3 = this.h;
            if (str3 != null) {
                if (this.f45661s == null) {
                    this.f45661s = new f01(str3, 12.0f, null);
                }
                f01 f01Var3 = this.f45661s;
                f01Var3.r(TextUtils.ellipsize(this.h, f01Var3.f25872a, dp, TextUtils.TruncateAt.END));
            }
            if (this.G && this.v == null) {
    ...
    public final int getAlpha() {
        return this.f45652c0;
    }

    @Override
    public final int getObserverTag() {
        return this.f45653d0;
    }
    ...
    public final boolean i() {
        if (this.X && MediaController.getInstance().isPlayingMessage(this.H) && MediaController.getInstance().getPlayingMessageObject() != null && MediaController.getInstance().getPlayingMessageObject().isPlayingExplanationObject == this.f45664y) {
            return true;
        }
        return false;
    }
    ...
    public final boolean j(float f7, float f10, int i10) {
        if (!this.X || this.f45657f0 == 4) {
            return false;
        }
        if (i10 == 0) {
            int dp = AndroidUtilities.dp(36.0f);
            int dp2 = AndroidUtilities.dp(27.0f);
            int i11 = this.f45648a0 + dp2;
            if (f7 >= i11 && f7 <= i11 + dp) {
                int i12 = this.f45650b0 + dp2;
        ...
        if (z10) {
            if (i10 == 1) {
                a aVar = this.Q;
                if (aVar != null) {
                    TLRPC.Document document = aVar.f45623b;
                    int i13 = aVar.f45622a;
                    if (aVar.f45627g) {
    ...
    public final void k(int i10) {
        if (this.f45655e0 != i10) {
            this.f45655e0 = i10;
            this.f45663x.setIcon(i10, true, true);
        }
    }

    public final void l(int i10, boolean z10) {
        if (this.f45657f0 != i10) {
            this.f45657f0 = i10;
            this.f45663x.k(i10, true, z10);
        }
    }
