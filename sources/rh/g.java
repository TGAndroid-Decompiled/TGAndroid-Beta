...
public final class g extends FrameLayout {
    public final ImageView f43585a;
    public final FrameLayout.LayoutParams f43586b;
    public final FrameLayout.LayoutParams f43587c;
    public final TextView d;
    public final TextView e;
    public final TextView f43588f;

    public g(Context context, f6 f6Var) {
        super(context);
        ImageView imageView = new ImageView(context);
        this.f43585a = imageView;
        ...
        i10.setTextColor(j6.v0(j6.f20273z6, f6Var));
    ...
    public final void a(int i10, int i11, CharSequence charSequence, CharSequence charSequence2) {
        ImageView imageView = this.f43585a;
        ...
        FrameLayout.LayoutParams layoutParams = this.f43587c;
        FrameLayout.LayoutParams layoutParams2 = this.f43586b;
        if (isEmpty) {
    ...
    public void setPercent(CharSequence charSequence) {
        ...
        TextView textView = this.f43588f;
        if (isEmpty) {
