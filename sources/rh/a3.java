...
public final class a3 extends FrameLayout {
    ...
    public final f6 f43524b;
    public final p9 f43525c;
    public final View d;
    public final View e;
    public final ImageView f43526f;
    public final TextView h;
    public final TextView f43527n;
    public final ImageView f43528r;
    public boolean f43529s;
    ...
    public a3(Context context, int i10, f6 f6Var) {
        ...
        this.d = view;
        view.setBackground(j6.K(AndroidUtilities.dp(11.0f), j6.v0(j6.f19881d6, f6Var)));
        ...
        i11.setTextColor(j6.v0(j6.f20273z6, f6Var));
        linearLayout.addView(i11, b6.t(-1, -2, 55, 6, 1, 24, 0));
        ImageView imageView2 = new ImageView(context);
        this.f43528r = imageView2;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.f43529s) {
            canvas.drawRect(AndroidUtilities.dp(72.0f), getHeight() - 1, getWidth(), getHeight(), j6.f20000k0);
        }
    }
