            ...
            case 0:
                ...
                AndroidUtilities.runOnUIThread(new Runnable() {
                    ...
                    public final void run() {
                        ...
                        switch (i10) {
                            case 0:
                                long j3 = i5Var2.f52035b;
                                int i11 = i5Var2.f52034a;
                                ArrayList arrayList = i5Var2.f52037e;
                            ...
                            case 1:
                                ...
                                if (tLObject2 instanceof TL_stars.TL_starGiftCollection) {
                                    ...
                                    if (f7 >= 0) {
                                        i5Var2.f52037e.set(f7, tL_starGiftCollection2);
                                        return;
                                    }
                                    return;
                                }
                            ...
                            default:
                                ...
                                if (tLObject2 instanceof TL_stars.TL_starGiftCollection) {
                                    ...
                                    if (f10 >= 0) {
                                        i5Var2.f52037e.set(f10, tL_starGiftCollection3);
                                        return;
                                    }
                                    return;
                                }
            ...
            case 1:
                ...
                AndroidUtilities.runOnUIThread(new Runnable() {
                    ...
                    public final void run() {
                        ...
                        switch (i10) {
                            case 0:
                                long j3 = i5Var22.f52035b;
                                int i11 = i5Var22.f52034a;
                                ArrayList arrayList = i5Var22.f52037e;
                                if (tLObject2 instanceof TL_stars.TL_starGiftCollections) {
                                    arrayList.clear();
                                    arrayList.addAll(((TL_stars.TL_starGiftCollections) tLObject2).collections);
                                    i5Var22.j();
                            ...
                            case 1:
                                ...
                                if (tLObject2 instanceof TL_stars.TL_starGiftCollection) {
                                    ...
                                    if (f7 >= 0) {
                                        i5Var22.f52037e.set(f7, tL_starGiftCollection2);
                                        return;
                                    }
                                    return;
                                }
                            ...
                            default:
                                ...
                                if (tLObject2 instanceof TL_stars.TL_starGiftCollection) {
                                    ...
                                    if (f10 >= 0) {
                                        i5Var22.f52037e.set(f10, tL_starGiftCollection3);
                                        return;
                                    }
                                    return;
                                }
