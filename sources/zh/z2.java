...
public final class z2 extends View {
    public final l3 f52910a;
    public final ImageReceiver f52911b;
    public final Path f52912c;
    ...
    public final void onAttachedToWindow() {
        ...
        this.f52911b.onAttachedToWindow();
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        this.f52911b.onDetachedFromWindow();
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        canvas.drawPath(this.f52912c, this.d);
        canvas.restore();
        ImageReceiver imageReceiver = this.f52911b;
