...
public final class z2 extends View {
    public final l3 f52941a;
    public final ImageReceiver f52942b;
    public final Path f52943c;
    ...
    public final void onAttachedToWindow() {
        ...
        this.f52942b.onAttachedToWindow();
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        this.f52942b.onDetachedFromWindow();
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        canvas.drawPath(this.f52943c, this.d);
        canvas.restore();
        ImageReceiver imageReceiver = this.f52942b;
