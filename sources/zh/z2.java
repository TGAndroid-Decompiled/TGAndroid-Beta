...
public final class z2 extends View {
    public final l3 f52909a;
    public final ImageReceiver f52910b;
    public final Path f52911c;
    ...
    public final void onAttachedToWindow() {
        ...
        this.f52910b.onAttachedToWindow();
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        this.f52910b.onDetachedFromWindow();
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        canvas.drawPath(this.f52911c, this.d);
        canvas.restore();
        ImageReceiver imageReceiver = this.f52910b;
