...
public final class v7 extends r20 implements NotificationCenter.NotificationCenterDelegate {
    public static DecimalFormat f52763h0;
    public static DecimalFormat f52764i0;
    ...
    public di.d Y;
    public sg.l1 Z;
    public di.d f52765a0;
    public cc1 f52766b0;
    public di.d f52767c0;
    public di.d f52768d0;
    public boolean f52769e0;
    public boolean f52770f0;
    public y6 f52771g0;
    ...
    public static void F0(oz0 oz0Var, int i10, TL_stars.StarGift starGift, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        if (!starGift.sold_out) {
            ...
            final long j3 = starGift.f20123id;
            ...
            final NotificationCenter.NotificationCenterDelegate[] notificationCenterDelegateArr = {new NotificationCenter.NotificationCenterDelegate() {
                ...
                public final void didReceivedNotification(int i11, int i12, Object[] objArr) {
                    ...
                    if (!zArr2[0] && i11 == (i13 = NotificationCenter.starGiftsLoaded) && (J = (s5Var = s5.this).J(j3)) != null) {
                        zArr2[0] = true;
                        NotificationCenter.getInstance(s5Var.f52598a).removeObserver(notificationCenterDelegateArr[0], i13);
                        b1Var.run(J);
                    }
                }
            }};
    ...
    public static SpannableStringBuilder J0(TL_stars.StarsAmount starsAmount, float f7, char c10) {
        ...
        int i10;
        if (f52764i0 == null) {
            f52764i0 = new DecimalFormat("0.################", new DecimalFormatSymbols(Locale.US));
        }
        ...
        if (starsAmount instanceof TL_stars.TL_starsTonAmount) {
            ...
            if (j3 % 1000000000 != 0) {
                String format = f52764i0.format(j3 / 1.0E9d);
            ...
            if (i11 != 0) {
                ...
                DecimalFormat decimalFormat = f52764i0;
    ...
    public static SpannableStringBuilder K0(TL_stars.StarsAmount starsAmount, float f7, char c10) {
        ...
        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder();
        if (starsAmount instanceof TL_stars.TL_starsTonAmount) {
            String format = f52764i0.format(starsAmount.amount / 1.0E9d);
            spannableStringBuilder.append((CharSequence) format);
            int indexOf = format.indexOf(".");
            if (indexOf >= 0) {
                spannableStringBuilder.setSpan(new RelativeSizeSpan(f7), indexOf, spannableStringBuilder.length(), 33);
    ...
    public static String M0(long j3) {
        String str;
        if (f52763h0 == null) {
            f52763h0 = new DecimalFormat("0.####", new DecimalFormatSymbols(Locale.US));
        }
        if (j3 % 1000000000 != 0) {
            return f52763h0.format(j3 / 1.0E9d);
        }
        StringBuilder sb2 = new StringBuilder();
        if (j3 < 0) {
            str = "-";
    ...
    public static void Z0(ImageReceiver imageReceiver, TLRPC.Document document, int i10) {
        ...
        imageReceiver.setImage(ImageLocation.getForDocument(document), a4.a.k(i10, i10, "_"), ImageLocation.getForDocument(closestPhotoSizeWithSize, document), a4.a.k(i10, i10, "_"), DocumentObject.getSvgThumb(document.thumbs, org.telegram.ui.ActionBar.j6.f20635a7, 0.35f), 0L, null, null, 0);
    }
    ...
    public static void e1(Context context, int i10, long j3, TL_stories.Boost boost, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        aVar.f46536w = org.telegram.ui.ActionBar.j6.fk;
        aVar.f46537x = org.telegram.ui.ActionBar.j6.gk;
        aVar.b();
        eVar.setStarParticlesView(x6Var);
        frameLayout.addView(eVar, w7.x5.d(170, 170.0f, 17, 0.0f, 32.0f, 0.0f, 24.0f));
        eVar.setPaused(false);
        TextView textView = new TextView(context);
        vl.x(org.telegram.ui.ActionBar.j6.f20798j5, f6Var, textView, 1, 20.0f);
        ...
        d90Var.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f21089z6, f6Var));
    ...
    public static i0 f1(Context context, int i10, TL_stars.TL_starGiftUnique tL_starGiftUnique, Utilities.Callback2 callback2, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        if (tL_starGiftUnique == null) {
            ...
            resellAmount = tL_starGiftUnique.getResellAmount(zf.b.f51657b);
        } else {
    ...
    public static void g1(Context context, long j3, boolean z10, final Utilities.Callback2 callback2, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        editTextBoldCursor.setHighlightColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f21009uf, f6Var));
        editTextBoldCursor.setHandlesColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f21026vf, f6Var));
    ...
    public static void i1(Activity activity, int i10, int i11, TLRPC.TL_messageActionPaymentRefunded tL_messageActionPaymentRefunded, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        starsTransaction.f20125id = tL_messageActionPaymentRefunded.charge.f20024id;
    ...
    public static void j1(Context context, int i10, TLRPC.TL_payments_paymentReceiptStars tL_payments_paymentReceiptStars, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        starsTransaction.f20125id = tL_payments_paymentReceiptStars.transaction_id;
    ...
    public final void H0(ArrayList arrayList, v51 v51Var) {
        ...
        h51Var.f26615c = (eb) super.r0(getParentActivity());
        arrayList.add(h51Var);
        arrayList.add(h51.k(this.U));
        di.d dVar = this.f52768d0;
        if (dVar != null) {
        ...
        if (y3.f52601e && !arrayList2.isEmpty()) {
    ...
    public final View createView(final Context context) {
        ...
        aVar.f46537x = org.telegram.ui.ActionBar.j6.gk;
        aVar.b();
        this.Q.setStarParticlesView(this.f40070e);
        ...
        this.f40069c.setOverScrollMode(2);
        s4.j jVar = new s4.j();
        jVar.f45806m = false;
        jVar.C = false;
        jVar.o(pr.h);
        ...
        this.f40069c.setOnItemClickListener(new bi.d(this, 21));
        r00 r00Var = new r00(getParentActivity());
        this.T = r00Var;
        this.f40074s.addView(r00Var, w7.x5.c(-1.0f, -1));
        s5 y3 = s5.y(this.currentAccount, false);
        ...
        ImageReceiver imageReceiver = x70Var.f42635b;
        ...
        this.X.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f21089z6, this.resourceProvider));
        ...
        this.f52765a0 = dVar;
        dVar.e();
        this.f52765a0.g("", false, true);
        this.f52765a0.setOnClickListener(new View.OnClickListener(this) {
            public final v7 f51750b;
            ...
            public final void onClick(View view) {
                switch (r3) {
                    case 0:
                        v7.B0(this.f51750b, context);
                        return;
                    default:
                        new l7(context, this.f51750b.resourceProvider).show();
                        return;
                }
            }
        });
        this.Z.addView(this.f52765a0, w7.x5.e(-1, 48, 119));
        cc1 cc1Var = new cc1(this, getParentActivity(), 20);
        this.f52766b0 = cc1Var;
        ...
        this.f52767c0.g(spannableStringBuilder, false, true);
        this.f52767c0.setOnClickListener(new View.OnClickListener(this) {
            public final v7 f51750b;
        ...
        this.f52766b0.addView(this.f52767c0, w7.x5.p(-1, 48, 17.0f, 1, 0, 0, 8, 0));
        ...
        this.f52766b0.addView(this.Y, w7.x5.p(-1, 48, 17.0f, 1, 0, 0, 0, 0));
        ...
        this.f52768d0.g(spannableStringBuilder3, false, true);
        this.f52768d0.setOnClickListener(new View.OnClickListener(this) {
            public final v7 f51800b;
        ...
        this.U.addView(this.f52768d0, w7.x5.d(-1, 48.0f, 17, 20.0f, 8.0f, 20.0f, 0.0f));
        k1();
        y6 y6Var = this.f52771g0;
        if (y6Var != null) {
            y6Var.N(false);
        }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.starOptionsLoaded) {
            ...
            s5 y3 = s5.y(this.currentAccount, false);
            if (this.f52769e0 != y3.O(0)) {
                this.f52769e0 = y3.O(0);
                s0();
                y6 y6Var2 = this.f52771g0;
                if (y6Var2 != null) {
                    y6Var2.N(true);
                }
                if (this.N == 0 && this.O < 0) {
    ...
    public final void l1(final boolean z10, boolean z11) {
        ...
        if (z11) {
            ...
            animate.alpha(f10).withEndAction(new Runnable(this) {
                ...
                public final void run() {
                    switch (r3) {
                        case 0:
                            if (z10) {
                                this.f51831b.Z.setVisibility(8);
                                return;
                            }
                            return;
                        default:
                            if (!z10) {
                                this.f51831b.f52766b0.setVisibility(8);
                                return;
                            }
                            return;
                    }
            ...
            ViewPropertyAnimator animate2 = this.f52766b0.animate();
            if (!z10) {
                f11 = 0.0f;
            }
        ...
        this.f52766b0.animate().cancel();
        cc1 cc1Var = this.f52766b0;
        if (z10) {
            f7 = 1.0f;
        } else {
            f7 = 0.0f;
    ...
    public final s4.h0 n0() {
        y6 y6Var = new y6(this, this.f40069c, getParentActivity(), this.currentAccount, this.classGuid, new ii.a(this, 26), getResourceProvider());
        this.f52771g0 = y6Var;
        y6Var.f31163r = false;
        return y6Var;
    }
    ...
    public final boolean q0() {
        ...
        if (u7Var != null && (u7Var.getParent() instanceof View)) {
            if ((this.f40069c.getHeight() - this.f40069c.getPaddingBottom()) - ((View) this.R.getParent()).getBottom() >= 0) {
                z10 = true;
            }
        }
        return !z10;
