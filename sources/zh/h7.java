...
public final class h7 extends g51 {
    ...
    public final void bindView(View view, h51 h51Var, boolean z10, v51 v51Var, d61 d61Var) {
        ...
        org.telegram.ui.Components.q6 q6Var = i7Var.f52051e;
        TextView textView = i7Var.d;
        boolean equals = TextUtils.equals(textView.getText(), charSequence);
        i7Var.f52053n = i10;
        if (!equals) {
            i7Var.f52054r.d(i10, true);
        }
        textView.setText(charSequence);
        if (charSequence2 == null) {
            if (i7Var.f52052f == null) {
                SpannableString spannableString = new SpannableString("x");
                i7Var.f52052f = spannableString;
                spannableString.setSpan(new i90(AndroidUtilities.dp(55.0f), q6Var), 0, i7Var.f52052f.length(), 33);
            }
            charSequence2 = i7Var.f52052f;
        }
    ...
    public final boolean contentsEquals(h51 h51Var, h51 h51Var2) {
        if (h51Var.f26608z == h51Var2.f26608z && h51Var.d == h51Var2.d && TextUtils.equals(h51Var.f26596m, h51Var2.f26596m)) {
            return true;
        }
        return false;
    }
