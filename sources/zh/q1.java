...
public final class q1 implements Runnable {
    ...
    public final org.telegram.tgnet.e f52484b;
    public final ad[] f52485c;
    ...
    public final void run() {
        ...
        String str = this.f52486e;
        TL_stars.UniqueStarGiftValueInfo uniqueStarGiftValueInfo = this.d;
        ad[] adVarArr = this.f52485c;
        org.telegram.tgnet.e eVar = this.f52484b;
        switch (i10) {
            case 0:
