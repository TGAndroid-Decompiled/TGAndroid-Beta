...
public final class e0 extends org.telegram.ui.ActionBar.f3 {
    ...
    public final int d;
    public final l40 f51808e;
    public final zc0 f51809f;
    public final EditTextBoldCursor h;
    public final TextView f51810n;
    public final c0 f51811r;
    public final di.d f51812s;
    public final org.telegram.ui.Components.q6 v;
    public final ImageView f51813w;
    public final ImageView f51814x;
    public final zf.a f51815y;
    ...
    public e0(final Context context, int i10, long j3, MessageSuggestionParams messageSuggestionParams, co coVar, final org.telegram.ui.ActionBar.f6 f6Var, int i11, Utilities.Callback callback) {
        ...
        this.f51807c = canManageMonoForum;
        ...
        if (!canManageMonoForum) {
            ...
            aVar.setOnClickListener(new View.OnClickListener(this) {
                ...
                public final void onClick(View view) {
                    switch (r4) {
                        case 0:
                            if (this.f51703b.H.f51622a == zf.b.f51624a) {
                                new l7(context, f6Var).show();
                                return;
                            }
                            return;
                        default:
                            e0 e0Var = this.f51703b;
                            org.telegram.ui.Components.e5.T(context, e0Var.I, new rg.p2(e0Var, 19), f6Var, 0).f20204a.show();
                            return;
                    }
                }
            });
        ...
        this.f51811r = editTextBoldCursor2;
        ...
        if (aVar3 != null) {
            z12 = false;
            q(zf.a.i(aVar3.f51623b, aVar3.f51622a), !messageSuggestionParams.amount.k(), true, false);
        } else {
            z12 = false;
    ...
    public final boolean isTouchOutside(float f7, float f10) {
        a aVar;
        if (this.K && (aVar = this.f51806b) != null && f7 >= aVar.getX() && f7 <= aVar.getX() + aVar.getWidth() && f10 >= aVar.getY() && f10 <= aVar.getY() + aVar.getHeight()) {
            return false;
        }
    ...
    public final void m() {
        ...
        boolean z11 = this.N;
        a aVar = this.f51806b;
        if ((z11 && !isDismissed() && aVar != null && this.containerView.getY() > AndroidUtilities.dp(32.0f)) || this.f51808e == null) {
            z10 = true;
        } else {
            z10 = false;
        }
    ...
    public final void n(boolean z10) {
        boolean z11;
        if (this.J == 0 && (this.H.f51623b >= 0 || this.I > 0)) {
            z11 = true;
        } else {
            z11 = false;
        }
        di.d dVar = this.f51812s;
        if (dVar.W != z11) {
            dVar.setEnabled(z11);
    ...
    public final zf.a p() {
        if (this.H.f51622a == zf.b.f51625b) {
            return this.G;
        }
        return this.E;
    }
    ...
    public final void q(zf.a aVar, boolean z10, boolean z11, boolean z12) {
        ...
        if (aVar != null) {
            ...
            this.H = zf.a.i(0L, aVar5.f51622a);
            this.J |= 1;
        }
        long j3 = p().f51623b;
        zf.a aVar6 = this.H;
        ...
        boolean k10 = aVar6.k();
        zf.a aVar7 = this.f51815y;
        zf.a aVar8 = this.F;
        zf.b bVar2 = zf.b.f51625b;
        if (!k10) {
            zf.a aVar9 = this.H;
            if (aVar9.f51622a == bVar2) {
                aVar4 = aVar8;
            } else {
                aVar4 = aVar7;
            }
            if (aVar4.f51623b > aVar9.f51623b) {
                this.J |= 2;
            }
        }
        if (!z11 && aVar5.f51622a == this.H.f51622a) {
            z13 = false;
        } else {
            z13 = true;
        }
        if (!z11 && aVar5.f51623b == this.H.f51623b) {
            z14 = false;
        } else {
            z14 = true;
        }
        ...
        if (z13) {
            c10 = 0;
            l40 l40Var = this.f51808e;
            if (l40Var != null) {
                if (this.H.f51622a == bVar3) {
                    i11 = 0;
                } else {
                    i11 = 1;
                }
            ...
            zf.b bVar4 = this.H.f51622a;
            TextView textView = this.f51810n;
            if (bVar4 == bVar3) {
            ...
            ImageView imageView = this.f51814x;
            ImageView imageView2 = this.f51813w;
            if (z12) {
            ...
            a aVar10 = this.f51806b;
            if (aVar10 != null && aVar10.f51643e != (bVar = this.H.f51622a)) {
                aVar10.f51643e = bVar;
                aVar10.a();
            }
        } else {
