...
public final class s0 extends bb {
    ...
    public final ArrayList f52561a0;
    public final ArrayList f52562b0;
    public final ArrayList f52563c0;
    public final ArrayList f52564d0;
    public final com.google.android.gms.common.api.internal.r f52565e0;
    public final com.google.android.gms.common.api.internal.r f52566f0;
    public final com.google.android.gms.common.api.internal.r f52567g0;
    public final nz f52568h0;
    public final l0 f52569i0;
    public final r0 f52570j0;
    public n0 f52571k0;
    public final FrameLayout f52572l0;
    public final ImageView m0;
    public final ImageView f52573n0;
    public final m0 f52574o0;
    public final TextView f52575p0;
    public final View f52576q0;
    public final bh.l f52577r0;
    public final bh.f f52578s0;
    public final gh.d f52579t0;
    public final bh.b f52580u0;
    public o0 f52581v0;
    public final boolean f52582w0;
    public boolean f52583x0;
    public final RectF f52584y0;
    public final PointF f52585z0;
    ...
    public s0(Context context, org.telegram.ui.ActionBar.f6 f6Var, int i10, String str, ArrayList arrayList, boolean z10) {
        ...
        this.f52577r0 = new bh.l(ll0Var, d3Var, new xs(ll0Var, 0));
        ...
        this.f52566f0 = rVar2;
        rVar2.f5124b = false;
        this.f52563c0 = zf.d.c(arrayList, TL_stars.starGiftAttributeModel.class);
        ArrayList arrayList3 = new ArrayList();
        this.f52564d0 = arrayList3;
        if (z10) {
            int i12 = 0;
            while (i12 < this.f52563c0.size()) {
                TL_stars.starGiftAttributeModel stargiftattributemodel = (TL_stars.starGiftAttributeModel) this.f52563c0.get(i12);
                if (stargiftattributemodel.rarity instanceof TL_stars.TL_starGiftAttributeRarity) {
                    this.f52564d0.add(stargiftattributemodel);
                    this.f52563c0.remove(i12);
                    i12--;
                }
                i12++;
            }
        ...
        List.EL.sort(this.f52561a0, Comparator$CC.comparingDouble(new k71(4)));
        List.EL.sort(this.f52562b0, Comparator$CC.comparingDouble(new k71(5)));
        List.EL.sort(this.f52563c0, Comparator$CC.comparingDouble(new k71(6)));
        List.EL.sort(this.f52564d0, Comparator$CC.comparingDouble(new k71(6)));
        com.google.android.gms.common.api.internal.r rVar3 = new com.google.android.gms.common.api.internal.r(this.f52563c0);
        this.f52567g0 = rVar3;
        rVar3.f5124b = false;
        ViewParent parent = this.f24674e.getParent();
        if (parent instanceof ViewGroup) {
            ((ViewGroup) parent).removeView(this.f24674e);
        }
        this.L = false;
        this.K = AndroidUtilities.dp(6.0f);
        this.occupyNavigationBar = true;
        int i13 = org.telegram.ui.ActionBar.j6.f20779i5;
        ...
        if (Build.VERSION.SDK_INT >= 31 && SharedConfig.chatBlurEnabled()) {
            this.f52578s0 = new bh.f(false);
            gh.d dVar = new gh.d(cVar);
            this.f52579t0 = dVar;
            dVar.v = new Runnable(this) {
                public final s0 f52156b;
                    ...
                    switch (r2) {
                        case 0:
                            if (Build.VERSION.SDK_INT >= 31) {
                                s0 s0Var = this.f52156b;
                                if (s0Var.f52578s0 != null) {
                                    s0Var.Q(2);
                                    return;
                                }
                                return;
            ...
            this.f52578s0 = null;
            this.f52579t0 = null;
            this.f52580u0 = new bh.b(cVar);
        }
        ih.k kVar = new ih.k(this.container);
        bh.b bVar2 = this.f52580u0;
        ...
        this.Z = new bi.e7[3];
        this.f52570j0 = new r0(context, f6Var, new org.telegram.ui.web.b1(this, 22));
        int i19 = 0;
        while (true) {
            ...
            if (i19 < e7VarArr.length) {
                ...
                if (i19 != 0) {
                    if (i19 != 1) {
                        if (i19 == 2) {
                            ((TextView) this.Z[i19].f2942b).setText(LocaleController.getString(R.string.GiftPreviewSymbol));
                        }
                    } else {
                        ((TextView) this.Z[i19].f2942b).setText(LocaleController.getString(R.string.GiftPreviewBackdrop));
                    }
                } else {
                    ((TextView) this.Z[i19].f2942b).setText(LocaleController.getString(R.string.GiftPreviewModel));
                }
                w7.z5.a(this.Z[i19]);
                ...
                this.f52572l0.addView(this.Y, w7.x5.d(-1, -2.0f, 87, 16.0f, 0.0f, 16.0f, 18.0f));
                this.containerView.addView(this.f52572l0, w7.x5.e(-1, 315, 55));
                int d = i0.a.d(0.1f, getThemedColor(org.telegram.ui.ActionBar.j6.f20779i5), getThemedColor(org.telegram.ui.ActionBar.j6.f20761h5));
                ...
                this.f52570j0.setPadding(AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f));
                dh.d c12 = this.f52580u0.c(this.f52570j0, null, false);
                c12.o(AndroidUtilities.dp(4.0f));
                c12.p(AndroidUtilities.dp(28.0f));
                c12.n(new eh.b(org.telegram.ui.ActionBar.j6.f20690d6, f6Var));
                this.f52570j0.setBackground(c12);
                this.containerView.addView(this.f52570j0, w7.x5.d(268, 64.0f, 81, 0.0f, 0.0f, 0.0f, 5.0f));
                this.f52581v0 = new o0((TL_stars.starGiftAttributeBackdrop) zf.d.d(arrayList, TL_stars.starGiftAttributeBackdrop.class), (TL_stars.starGiftAttributePattern) zf.d.d(arrayList, TL_stars.starGiftAttributePattern.class), (TL_stars.starGiftAttributeModel) zf.d.d(arrayList, TL_stars.starGiftAttributeModel.class));
                this.f52571k0.N(false);
                T(false);
                return;
            }
        }
    ...
    public final void Q(int i10) {
        bh.f fVar;
        int dp;
        if (Build.VERSION.SDK_INT >= 31 && (fVar = this.f52578s0) != null) {
            if (w7.b0.a(i10, 2)) {
                org.telegram.ui.ActionBar.d3 d3Var = this.container;
                r0 r0Var = this.f52570j0;
                PointF pointF = this.f52585z0;
                ih.k.b(r0Var, d3Var, pointF);
                float f7 = pointF.x;
                RectF rectF = this.f52584y0;
                rectF.left = f7;
                rectF.top = pointF.y;
            ...
            if (fVar.f2716j != 0) {
                fVar.e(this.f52577r0, this.container.getWidth(), this.container.getHeight());
            }
        }
    }
    ...
    public final boolean R(o0 o0Var) {
        if (this.C0 != 1) {
            int i10 = this.f52570j0.f52532r;
            o0 o0Var2 = this.f52581v0;
            if (o0Var2 != null) {
                if (i10 == 1) {
                    if (o0Var.f52389a != o0Var2.f52389a) {
                        return false;
                    }
                } else if (i10 == 2) {
                    if (o0Var.f52390b != o0Var2.f52390b) {
                        return false;
                    }
                } else if (i10 != 0 || o0Var.f52391c != o0Var2.f52391c) {
                    return false;
                }
                return true;
            }
    ...
    public final void U() {
        ...
        for (int i10 = 0; i10 < childCount; i10++) {
            ...
            if ((childAt instanceof q0) && (o0Var = (q0Var = (q0) childAt).v) != null) {
                boolean R = R(o0Var);
                q0Var.f52476c.f(R, true);
                q0Var.f52480r.a(R, true);
            }
        }
    }
    ...
    public final boolean isTouchOutside(float f7, float f10) {
        FrameLayout frameLayout = this.f52572l0;
    ...
    public final void mainContainerDispatchDraw(Canvas canvas) {
        ...
        if (Build.VERSION.SDK_INT >= 31 && canvas.isHardwareAccelerated() && (fVar = this.f52578s0) != null && (dVar = this.f52579t0) != null && !dVar.f10686n && dVar.f(width, height)) {
            RecordingCanvas a2 = dVar.a(width, height);
            a2.drawColor(getThemedColor(org.telegram.ui.ActionBar.j6.f20779i5));
            if (LiteMode.isEnabled(262144)) {
                i10 = -2;
            } else {
                i10 = -3;
