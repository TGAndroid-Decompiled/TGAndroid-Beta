...
public final class s3 extends AnimatorListenerAdapter {
    ...
    public final void onAnimationEnd(Animator animator) {
        t3 t3Var = this.f52593a;
        m2 m2Var = t3Var.f52659i0;
        t3Var.f52671s0 = t3Var.f52669r0;
        t3Var.d(t3Var.U);
        TL_stars.starGiftAttributeModel[] stargiftattributemodelArr = t3Var.f52653e;
        int i10 = 2 - t3Var.f52669r0;
        stargiftattributemodelArr[i10] = (TL_stars.starGiftAttributeModel) t3Var.W.f5127f;
        v7.Z0(t3Var.d[i10].getImageReceiver(), stargiftattributemodelArr[2 - t3Var.f52669r0].document, 160);
        TL_stars.starGiftAttributePattern stargiftattributepattern = (TL_stars.starGiftAttributePattern) t3Var.f52647a0.f5127f;
