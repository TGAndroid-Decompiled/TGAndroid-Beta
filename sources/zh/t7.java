...
public final class t7 extends a81 {
    ...
    public final int d;
    public final org.telegram.ui.ActionBar.f6 f52671e;
    public final long f52672f;
    public final ArrayList f52673g = new ArrayList();
    ...
    public final View d(int i10) {
        return new s7(this.f52668a, this.f52670c, this.f52672f, i10, this.f52669b, this.d, this.f52671e);
    }

    @Override
    public final int e() {
        return this.f52673g.size();
    }
    ...
    public final int h(int i10) {
        if (i10 >= 0) {
            ArrayList arrayList = this.f52673g;
            if (i10 < arrayList.size()) {
                return ((h51) arrayList.get(i10)).f26608z;
            }
            return 0;
        }
        return 0;
    ...
    public final void i() {
        ...
        long j3 = this.f52672f;
        if (j3 == 0) {
            s5 y3 = s5.y(i10, this.f52670c);
        ...
        o g10 = o.g(i10);
        arrayList.add(h51.C(0));
        if (!g10.k(j3).f52286a[1].isEmpty()) {
            arrayList.add(h51.C(1));
        }
        if (!g10.k(j3).f52286a[2].isEmpty()) {
            arrayList.add(h51.C(2));
        }
    }
