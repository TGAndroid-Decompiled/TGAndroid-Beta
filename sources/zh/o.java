...
public final class o {
    public static volatile o[] f52347m = new o[4];
    public static final Object[] f52348n = new Object[4];
    public final int f52349a;
    public final HashMap f52350b = new HashMap();
    public final HashMap f52351c = new HashMap();
    public final HashMap d = new HashMap();
    public final HashMap f52352e = new HashMap();
    public final HashMap f52353f = new HashMap();
    public final HashMap f52354g = new HashMap();
    public final HashMap h = new HashMap();
    public boolean f52355i;
    public ArrayList f52356j;
    public boolean f52357k;
    public ArrayList f52358l;

    static {
        for (int i10 = 0; i10 < 4; i10++) {
            f52348n[i10] = new Object();
        }
    }
    ...
    public final l d(long j3) {
        ...
        HashMap hashMap = this.f52354g;
        l lVar = (l) hashMap.get(valueOf);
        if (lVar == null) {
            Long valueOf2 = Long.valueOf(j3);
            l lVar2 = new l(this.f52349a, j3);
    ...
    public final void f(Context context, long j3, long j10, Utilities.Callback callback) {
        l lVar = (l) this.f52354g.get(Long.valueOf(j3));
        if (lVar != null) {
            ArrayList arrayList = lVar.f52177e;
    ...
    public final TLRPC.TL_payments_starsRevenueStats h(long j3, boolean z10) {
        Long l4 = (Long) this.f52350b.get(Long.valueOf(j3));
        TLRPC.TL_payments_starsRevenueStats tL_payments_starsRevenueStats = (TLRPC.TL_payments_starsRevenueStats) this.f52351c.get(Long.valueOf(j3));
    ...
    public final TLRPC.TL_payments_starsRevenueStats j(long j3, boolean z10) {
        ...
        TLRPC.TL_payments_starsRevenueStats tL_payments_starsRevenueStats = (TLRPC.TL_payments_starsRevenueStats) this.f52352e.get(Long.valueOf(j3));
        if (l4 != null && System.currentTimeMillis() - l4.longValue() <= 300000 && !z10) {
            return tL_payments_starsRevenueStats;
        }
        TLRPC.TL_payments_getStarsRevenueStats tL_payments_getStarsRevenueStats = new TLRPC.TL_payments_getStarsRevenueStats();
    ...
    public final void l(long j3) {
        ...
        for (int i10 = 0; i10 < 3; i10++) {
            if (!zArr[i10]) {
                k10.f52286a[i10].clear();
                k10.f52288c[i10] = null;
                zArr[i10] = false;
                k10.f52289e[i10] = false;
                p(i10, j3);
            }
        }
    }
    ...
    public final void n() {
        if (!this.f52355i && this.f52356j == null) {
            this.f52355i = true;
            ConnectionsManager.getInstance(this.f52349a).sendRequest(new TL_bots.getAdminedBots(), new i(this, 0));
        }
    }

    public final void o() {
        if (!this.f52357k && this.f52358l == null) {
            this.f52357k = true;
            ConnectionsManager.getInstance(this.f52349a).sendRequest(new TLRPC.TL_channels_getAdminedPublicChannels(), new i(this, 1));
        }
    }
    ...
    public final void q(TL_update.TL_updateStarsRevenueStatus tL_updateStarsRevenueStatus) {
        ...
        if (peerDialogId < 0) {
            ke keVar = ke.f38012x1;
            if (keVar != null && keVar.f38039z0 == DialogObject.getPeerDialogId(tL_updateStarsRevenueStatus.peer)) {
                ke keVar2 = ke.f38012x1;
        ...
        if (h != null) {
            ...
            NotificationCenter.getInstance(this.f52349a).lambda$postNotificationNameOnUIThread$1(NotificationCenter.botStarsUpdated, Long.valueOf(peerDialogId));
        }
        l(peerDialogId);
    }
