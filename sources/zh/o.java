...
public final class o {
    public static volatile o[] f52378m = new o[4];
    public static final Object[] f52379n = new Object[4];
    public final int f52380a;
    public final HashMap f52381b = new HashMap();
    public final HashMap f52382c = new HashMap();
    public final HashMap d = new HashMap();
    public final HashMap f52383e = new HashMap();
    public final HashMap f52384f = new HashMap();
    public final HashMap f52385g = new HashMap();
    public final HashMap h = new HashMap();
    public boolean f52386i;
    public ArrayList f52387j;
    public boolean f52388k;
    public ArrayList f52389l;

    static {
        for (int i10 = 0; i10 < 4; i10++) {
            f52379n[i10] = new Object();
        }
    }
    ...
    public final l d(long j3) {
        ...
        HashMap hashMap = this.f52385g;
        l lVar = (l) hashMap.get(valueOf);
        if (lVar == null) {
            Long valueOf2 = Long.valueOf(j3);
            l lVar2 = new l(this.f52380a, j3);
    ...
    public final void f(Context context, long j3, long j10, Utilities.Callback callback) {
        l lVar = (l) this.f52385g.get(Long.valueOf(j3));
        if (lVar != null) {
            ArrayList arrayList = lVar.f52208e;
    ...
    public final TLRPC.TL_payments_starsRevenueStats h(long j3, boolean z10) {
        Long l4 = (Long) this.f52381b.get(Long.valueOf(j3));
        TLRPC.TL_payments_starsRevenueStats tL_payments_starsRevenueStats = (TLRPC.TL_payments_starsRevenueStats) this.f52382c.get(Long.valueOf(j3));
    ...
    public final TLRPC.TL_payments_starsRevenueStats j(long j3, boolean z10) {
        ...
        TLRPC.TL_payments_starsRevenueStats tL_payments_starsRevenueStats = (TLRPC.TL_payments_starsRevenueStats) this.f52383e.get(Long.valueOf(j3));
        if (l4 != null && System.currentTimeMillis() - l4.longValue() <= 300000 && !z10) {
            return tL_payments_starsRevenueStats;
        }
        TLRPC.TL_payments_getStarsRevenueStats tL_payments_getStarsRevenueStats = new TLRPC.TL_payments_getStarsRevenueStats();
    ...
    public final void l(long j3) {
        ...
        for (int i10 = 0; i10 < 3; i10++) {
            if (!zArr[i10]) {
                k10.f52317a[i10].clear();
                k10.f52319c[i10] = null;
                zArr[i10] = false;
                k10.f52320e[i10] = false;
                p(i10, j3);
            }
        }
    }
    ...
    public final void n() {
        if (!this.f52386i && this.f52387j == null) {
            this.f52386i = true;
            ConnectionsManager.getInstance(this.f52380a).sendRequest(new TL_bots.getAdminedBots(), new i(this, 0));
        }
    }

    public final void o() {
        if (!this.f52388k && this.f52389l == null) {
            this.f52388k = true;
            ConnectionsManager.getInstance(this.f52380a).sendRequest(new TLRPC.TL_channels_getAdminedPublicChannels(), new i(this, 1));
        }
    }
    ...
    public final void q(TL_update.TL_updateStarsRevenueStatus tL_updateStarsRevenueStatus) {
        ...
        if (peerDialogId < 0) {
            ke keVar = ke.f38039x1;
            if (keVar != null && keVar.f38066z0 == DialogObject.getPeerDialogId(tL_updateStarsRevenueStatus.peer)) {
                ke keVar2 = ke.f38039x1;
        ...
        if (h != null) {
            ...
            NotificationCenter.getInstance(this.f52380a).lambda$postNotificationNameOnUIThread$1(NotificationCenter.botStarsUpdated, Long.valueOf(peerDialogId));
        }
        l(peerDialogId);
    }
