...
public final class v2 extends FrameLayout {
    public final yh.e1 f52707a;
    public final FrameLayout f52708b;
    public final x9 f52709c;
    public final TextView d;
    public final FrameLayout f52710e;
    public final ImageView f52711f;
    ...
    public final void a(TL_stars.StarGift starGift, boolean z10) {
        ...
        if (starGift != null) {
            ...
            v7.Z0(this.f52709c.getImageReceiver(), ((TL_stars.starGiftAttributeModel) s5.l(starGift.attributes, TL_stars.starGiftAttributeModel.class)).document, 52);
            ...
            this.f52710e.setBackground(new k3(AndroidUtilities.dp(10.0f), b10));
        }
        if (starGift != null) {
            z11 = true;
        } else {
    ...
    public final void b(final boolean z10, boolean z11) {
        ...
        int i11;
        float f14;
        FrameLayout frameLayout = this.f52708b;
        frameLayout.animate().cancel();
        TextView textView = this.d;
        textView.animate().cancel();
        FrameLayout frameLayout2 = this.f52710e;
        ...
        alpha.setInterpolator(prVar).setDuration(420L).withEndAction(new Runnable(this) {
            ...
            public final void run() {
                switch (r3) {
                    case 0:
                        boolean z12 = z10;
                        v2 v2Var = this.f52685b;
                        if (!z12) {
                            v2Var.f52710e.setVisibility(8);
                            return;
                        } else {
                            v2Var.getClass();
                            return;
                    ...
                    case 1:
                        boolean z13 = z10;
                        v2 v2Var2 = this.f52685b;
                        if (!z13) {
                            v2Var2.f52710e.setVisibility(8);
                            return;
                        } else {
                            v2Var2.getClass();
                            return;
                    ...
                    default:
                        boolean z14 = z10;
                        v2 v2Var3 = this.f52685b;
                        if (!z14) {
                            v2Var3.f52710e.setVisibility(8);
                            return;
                        } else {
                            v2Var3.getClass();
                            return;
