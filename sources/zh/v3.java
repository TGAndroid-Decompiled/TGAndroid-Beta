...
public final class v3 extends ua {
    public final ArrayList f52713a0;
    public final LimitPreviewView f52714b0;

    public v3(Context context, long j3, ArrayList arrayList, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context, f6Var);
        float f7;
        int i10;
        this.f52713a0 = arrayList;
        ...
        this.f52714b0 = limitPreviewView;
        ...
        TextView b12 = w7.b6.b(context, 12.0f, org.telegram.ui.ActionBar.j6.f21043y6, false, null);
        b12.setGravity(17);
        ...
        this.Y = frameLayout;
        frameLayout.setBackgroundColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20735h5, this.resourcesProvider));
        View view = new View(getContext());
        view.setBackgroundColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20665d7, this.resourcesProvider));
    ...
    public final void P(long j3) {
        int v02;
        ArrayList arrayList = this.f52713a0;
        if (arrayList != null && !arrayList.isEmpty()) {
            ...
            LimitPreviewView limitPreviewView = this.f52714b0;
            ...
            limitPreviewView.f24046a = AndroidUtilities.ilerp((float) j3, (float) starGiftUpgradePrice.upgrade_stars, (float) starGiftUpgradePrice2.upgrade_stars);
            ...
            limitPreviewView.f24065w.setVisibility(8);
