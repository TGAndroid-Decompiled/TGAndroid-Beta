...
public final class i0 extends org.telegram.ui.ActionBar.f3 {
    public zf.a E;
    public int F;
    public final zc0 f52006b;
    public final EditTextBoldCursor f52007c;
    public final TextView d;
    public final org.telegram.ui.Components.q6 f52008e;
    public final di.d f52009f;
    public final org.telegram.ui.Components.q6 h;
    public final x8 f52010n;
    public final ImageView f52011r;
    public final ImageView f52012s;
    public final zf.a v;
    public final zf.a f52013w;
    public final zf.a f52014x;
    public final zf.a f52015y;
    ...
    public i0(Context context, org.telegram.ui.ActionBar.f6 f6Var, int i10, zf.a aVar, oj0 oj0Var) {
        ...
        this.f52014x = zf.a.i(max, bVar);
        this.f52015y = zf.a.i(appGlobalConfig.tonStarGiftResaleAmountMax.get(), bVar);
        zf.b bVar2 = zf.b.f51624a;
        this.v = zf.a.g(appGlobalConfig.starsStarGiftResaleAmountMin.get(), bVar2);
        this.f52013w = zf.a.g(appGlobalConfig.starsStarGiftResaleAmountMax.get(), bVar2);
        ...
        this.f52007c = editTextBoldCursor;
        ...
        this.f52010n = x8Var;
        x8Var.f23542c.setLayoutParams(w7.x5.d(20, 20.0f, (LocaleController.isRTL ? 5 : 3) | 48, 22.0f, 22.0f, 22.0f, 0.0f));
        ...
        if (aVar != null) {
            n(zf.a.i(aVar.f51623b, aVar.f51622a), !aVar.k(), true, false);
        } else {
    ...
    public final zf.a m() {
        if (this.E.f51622a == zf.b.f51625b) {
            return this.f52015y;
        }
        return this.f52013w;
    }
    ...
    public final void n(zf.a aVar, boolean z10, boolean z11, boolean z12) {
        ...
        if (aVar != null) {
            ...
            this.E = zf.a.i(0L, aVar5.f51622a);
            this.F |= 1;
        }
        long j10 = m().f51623b;
        zf.a aVar6 = this.E;
        if (j10 < aVar6.f51623b) {
            this.F |= 4;
        }
        boolean k10 = aVar6.k();
        zf.a aVar7 = this.v;
        zf.a aVar8 = this.f52014x;
        zf.b bVar = zf.b.f51625b;
        if (!k10) {
            zf.a aVar9 = this.E;
            if (aVar9.f51622a == bVar) {
                aVar4 = aVar8;
            } else {
                aVar4 = aVar7;
            }
        ...
        if (!z11 && aVar5.f51622a == this.E.f51622a) {
            z13 = false;
        } else {
            z13 = true;
        }
        if (!z11 && aVar5.f51623b == this.E.f51623b) {
            z14 = false;
        } else {
            z14 = true;
        }
        ...
        zf.b bVar2 = zf.b.f51624a;
        long j11 = j3;
        EditTextBoldCursor editTextBoldCursor = this.f52007c;
        if (z13) {
            c10 = 0;
            zf.b bVar3 = this.E.f51622a;
            org.telegram.ui.Components.q6 q6Var = this.f52008e;
            if (bVar3 == bVar2) {
            ...
            mp mpVar = this.f52010n.f23542c;
            if (this.E.f51622a == bVar) {
                z17 = true;
            } else {
                z17 = false;
            }
            mpVar.a(z17, z12);
            ImageView imageView = this.f52012s;
            ImageView imageView2 = this.f52011r;
            if (z12) {
                ViewPropertyAnimator animate = imageView2.animate();
                if (this.E.f51622a == bVar2) {
                    f13 = 1.0f;
                } else {
                    f13 = 0.0f;
                }
        ...
        if (z13 || z14 || z15) {
            if (this.F == 0 && this.E.f51623b > j11) {
                z16 = true;
            } else {
                z16 = false;
            }
            di.d dVar = this.f52009f;
            if (dVar.W != z16) {
                dVar.setEnabled(z16);
        ...
        if (z13 || z14) {
            ...
            zf.a aVar10 = this.E;
            zf.b bVar4 = aVar10.f51622a;
            zf.b bVar5 = aVar10.f51622a;
            long j12 = aVar10.f51623b;
