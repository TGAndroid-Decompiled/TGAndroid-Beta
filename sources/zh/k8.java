...
public abstract class k8 extends View {
    ...
    public final Path V;
    public final Path W;
    public final org.telegram.ui.ActionBar.f6 f52182a;
    public final RectF f52183a0;
    public final Paint f52184b;
    public final Path f52185b0;
    public final Paint f52186c;
    public float f52187c0;
    public final Paint d;
    public float f52188d0;
    public final Paint f52189e;
    public int[] f52190e0;
    public final Paint f52191f;
    public final le.b f52192f0;
    public float f52193g0;
    public final h8 h;
    public float f52194h0;
    public long f52195i0;
    public int f52196j0;
    public boolean f52197k0;
    public ValueAnimator f52198l0;
    public final h8 f52199n;
    public int f52200r;
    public int f52201s;
    public ValueAnimator v;
    public int f52202w;
    public int f52203x;
    public LinearGradient f52204y;

    public k8(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context);
        this.f52184b = new Paint(1);
        this.f52186c = new Paint(1);
        this.d = new Paint(1);
        this.f52189e = new Paint(1);
        this.f52191f = new Paint(1);
        this.h = new h8(0, 300);
        this.f52199n = new h8(2, 30);
        this.f52200r = -1135603;
        this.f52201s = -404714;
        this.f52202w = -1135603;
        this.f52203x = -404714;
        this.f52204y = new LinearGradient(0.0f, 0.0f, 255.0f, 0.0f, new int[]{this.f52200r, this.f52201s}, new float[]{0.0f, 1.0f}, Shader.TileMode.CLAMP);
        this.E = new Matrix();
        this.F = true;
        ...
        this.V = new Path();
        this.W = new Path();
        this.f52183a0 = new RectF();
        this.f52185b0 = new Path();
        this.f52187c0 = 0.0f;
        this.f52192f0 = new le.b(this, prVar, 320L);
        this.f52182a = f6Var;
        ...
        p6Var2.f29313b = 17;
        paint.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20762h5, f6Var));
        paint.setStyle(Paint.Style.STROKE);
        paint.setStrokeWidth(AndroidUtilities.dp(1.0f));
    }

    public final void a(float f7) {
        ValueAnimator valueAnimator = this.f52198l0;
        if (valueAnimator != null) {
            valueAnimator.cancel();
        }
        ValueAnimator ofFloat = ValueAnimator.ofFloat(this.f52187c0, f7);
        this.f52198l0 = ofFloat;
        ofFloat.addUpdateListener(new ki.a(this, 27));
        int value = getValue();
        this.f52198l0.addListener(new h00(this, f7, value));
        this.f52198l0.setDuration(320L);
        this.f52198l0.setInterpolator(pr.h);
        this.f52198l0.start();
        if (c(f7) != value) {
            e(c(f7));
        }
    ...
    public final int c(float f7) {
        ...
        int[] iArr;
        if (f7 <= 0.0f) {
            return this.f52190e0[0];
        }
        if (f7 >= 1.0f) {
            return this.f52190e0[iArr.length - 1];
        }
        int[] iArr2 = this.f52190e0;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        this.f52204y.setLocalMatrix(matrix);
        LinearGradient linearGradient = this.f52204y;
        Paint paint3 = this.f52186c;
        paint3.setShader(linearGradient);
        int d = i0.a.d(this.f52187c0, this.f52200r, this.f52201s);
        Path path = this.U;
        path.rewind();
        Path.Direction direction2 = Path.Direction.CW;
        path.addRoundRect(rectF2, AndroidUtilities.dp(12.0f), AndroidUtilities.dp(12.0f), direction2);
        int l1 = org.telegram.ui.ActionBar.j6.l1(0.15f, this.f52200r);
        Paint paint4 = this.f52184b;
        paint4.setColor(l1);
        ...
        h8 h8Var = this.h;
        h8Var.g(rectF2);
        float f13 = this.f52187c0;
        h8Var.h = (f13 * 15.0f) + 1.0f;
        h8Var.f52030j = (int) (h8Var.f52024b.size() * ((f13 * 0.85f) + 0.15f));
        h8Var.d();
        canvas.save();
        ...
        if (j3 != -1 && b((int) j3) < 1.0f && b((int) this.P) > 0.0f) {
            ...
            if (clamp01 + f01Var.f25875c + (AndroidUtilities.dp(16.0f) * 2) > rectF2.right) {
                f12 = (clamp01 - lerp) - f01Var.f25875c;
            } else {
                f12 = clamp01 + lerp;
            }
            float f14 = f12;
        ...
        if (j10 != -1 && b((int) j10) < 1.0f && b((int) this.P) > 0.0f) {
            ...
            if (f01Var.f25875c + dp3 + (AndroidUtilities.dp(16.0f) * 2) > rectF2.right) {
                f11 = (dp3 - lerp2) - f01Var.f25875c;
            } else {
                f11 = lerp2 + dp3;
            }
            float f15 = f11;
            paint2.setStrokeWidth(AndroidUtilities.dp(1.0f));
            paint2.setColor(org.telegram.ui.ActionBar.j6.l1(0.4f, org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20762h5, this.f52182a)));
            i11 = i10;
        ...
        if (this.O) {
            ...
            int d10 = i0.a.d(0.5f, paint.getColor(), this.f52201s);
            Paint paint6 = this.d;
            paint6.setColor(d10);
            Path path3 = this.W;
            path3.rewind();
        ...
        canvas2.drawRoundRect(rectF4, AndroidUtilities.dp(12.0f), AndroidUtilities.dp(12.0f), this.f52189e);
        ...
        float clamp5 = Utilities.clamp(this.f52187c0 - this.f52188d0, 1.0f, -1.0f) * 60.0f;
        float dp12 = rectF5.bottom + AndroidUtilities.dp(8.0f);
        Path path4 = this.f52185b0;
        path4.rewind();
        ...
        h8 h8Var2 = this.f52199n;
        h8Var2.g(rectF7);
        h8Var2.h = (this.f52187c0 * 15.0f) + 1.0f;
        h8Var2.d();
        canvas2.save();
        ...
        if (Math.abs(this.f52187c0 - this.f52188d0) > 0.001f) {
            this.f52188d0 = AndroidUtilities.lerp(this.f52188d0, this.f52187c0, 0.1f);
            invalidate();
        }
        this.f52191f.setShader(this.f52204y);
        canvas2.drawPath(path4, this.f52191f);
        canvas2.save();
        ...
        canvas2.restore();
        canvas2.save();
        float f27 = 1.0f - (this.f52192f0.f15395e * 0.15f);
        ...
        p6Var.f29331w = (int) (this.f52192f0.f15395e * 255.0f);
        p6Var.draw(canvas2);
        canvas2.restore();
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        if (motionEvent.getAction() == 0) {
            this.f52193g0 = motionEvent.getX();
            this.f52194h0 = motionEvent.getY();
            this.f52196j0 = motionEvent.getPointerId(0);
            this.f52195i0 = System.currentTimeMillis();
            this.f52197k0 = false;
            return true;
        }
        if (motionEvent.getAction() == 2 && motionEvent.getPointerId(0) == this.f52196j0) {
            float x10 = motionEvent.getX() - this.f52193g0;
            float y3 = motionEvent.getY() - this.f52194h0;
            if (!this.f52197k0 && Math.abs(x10) > Math.abs(y3 * 1.5f) && Math.abs(x10) > AndroidUtilities.touchSlop) {
            ...
            if (this.f52197k0) {
                int value = getValue();
                this.f52187c0 = Utilities.clamp01((x10 / (getWidth() * 1.0f)) + this.f52187c0);
                if (getValue() != value) {
                    e(getValue());
                    org.telegram.ui.Components.p6 p6Var = this.H;
                    p6Var.b();
            ...
            if (!this.f52197k0 && motionEvent.getPointerId(0) == this.f52196j0 && v7.z6.a(this.f52193g0, this.f52194h0, motionEvent.getX(), motionEvent.getY()) < AndroidUtilities.touchSlop && ((float) (System.currentTimeMillis() - this.f52195i0)) <= ViewConfiguration.getTapTimeout() * 1.5f) {
    ...
    public final void f(int i10, int i11, boolean z10) {
        if (this.f52202w == i10 && this.f52203x == i11) {
            return;
        }
        ...
        if (z10) {
            int i12 = this.f52200r;
            int i13 = this.f52201s;
            this.f52202w = i10;
            this.f52203x = i11;
    ...
    public final void g(String str) {
        this.f52192f0.a(!TextUtils.isEmpty(str), true);
        org.telegram.ui.Components.p6 p6Var = this.I;
        p6Var.b();
    ...
    public float getProgress() {
        return this.f52187c0;
    }

    public int getValue() {
        return c(this.f52187c0);
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f52186c.setColor(-1069811);
        this.f52189e.setColor(-1);
    }
