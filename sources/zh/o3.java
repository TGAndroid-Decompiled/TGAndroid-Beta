...
public final class o3 extends FrameLayout {
    public final x0 f52373a;
    public final n3 f52374b;
    public final n3 f52375c;
    public final n3 d;
    public boolean f52376e;
    public final l20 f52377f;
    public final RectF h;

    public o3(Context context, org.telegram.ui.ActionBar.f6 f6Var, x0 x0Var) {
        super(context);
        this.f52377f = new l20();
        this.h = new RectF();
        this.f52373a = x0Var;
    ...
    public final void a(e3 e3Var, float f7, boolean z10, e3 e3Var2, float f10, boolean z11, e3 e3Var3, float f11, boolean z12) {
        x0 x0Var = this.f52373a;
        n3 n3Var = this.f52374b;
        if (e3Var != null) {
            if (z10) {
                f7 = Math.max(0.5f, f7);
            }
            n3Var.setVisibility(0);
            n3Var.e(e3Var.f51821a, e3Var.f51822b, x0Var);
            n3Var.setTranslationY(AndroidUtilities.dp(36.0f) * ((f7 - 0.5f) / 1.5f));
        } else {
            n3Var.setVisibility(4);
        }
        n3 n3Var2 = this.f52375c;
        if (e3Var2 != null) {
            float f12 = f10;
            if (z11) {
            ...
            n3Var2.e(e3Var2.f51821a, e3Var2.f51822b, x0Var);
            n3Var2.setTranslationY(AndroidUtilities.dp(36.0f) * f13);
            if (z11 && f13 <= 0.0f && !this.f52376e) {
                this.f52376e = true;
        ...
        if (e3Var3 != null) {
            ...
            n3Var3.e(e3Var3.f51821a, e3Var3.f51822b, x0Var);
