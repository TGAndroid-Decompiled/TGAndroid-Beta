...
public final class r7 implements Utilities.Callback2 {
    ...
    public final NotificationCenter.NotificationCenterDelegate f52561b;

    public r7(NotificationCenter.NotificationCenterDelegate notificationCenterDelegate, int i10) {
        this.f52560a = i10;
        this.f52561b = notificationCenterDelegate;
    }

    @Override
    public final void run(Object obj, Object obj2) {
        int i10 = this.f52560a;
        NotificationCenter.NotificationCenterDelegate notificationCenterDelegate = this.f52561b;
        switch (i10) {
            case 0:
                s7 s7Var = (s7) notificationCenterDelegate;
                ArrayList arrayList = (ArrayList) obj;
                v51 v51Var = (v51) obj2;
                int i11 = s7Var.f52625c;
                int i12 = s7Var.d;
                long j3 = s7Var.f52627f;
                int i13 = 0;
                if (j3 != 0) {
                    o g10 = o.g(i11);
                    ArrayList arrayList2 = g10.k(j3).f52317a[i12];
                ...
                s5 y3 = s5.y(i11, s7Var.f52626e);
                ArrayList arrayList3 = y3.f52612q[i12];
