...
public final class d0 implements TextWatcher {
    ...
    public final void afterTextChanged(Editable editable) {
        ...
        e0 e0Var = this.f51809a;
        if (!z10) {
            i10 = zf.a.h(editable.toString(), e0Var.H.f51653a);
        } else {
            i10 = zf.a.i(0L, e0Var.H.f51653a);
        }
        e0Var.q(i10, false, false, true);
        e0Var.f51840f.c(e0Var.h.isFocused(), true ^ TextUtils.isEmpty(e0Var.h.getText()));
    }
