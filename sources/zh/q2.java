...
public final class q2 extends FrameLayout {
    ...
    public final Matrix f52488b;
    public final float[] f52489c;
    public float d;
    public float f52490e;
    public boolean f52491f;
    public final float[][] h;
    public final float[] f52492n;
    public final float[] f52493r;
    public final Integer[] f52494s;
    public final HashSet v;
    public final HashMap f52495w;
    public final HashMap f52496x;
    public final float[] f52497y;

    public q2(Context context, View[] viewArr) {
        super(context);
        this.f52488b = new Matrix();
        ...
        this.f52492n = new float[4];
        this.f52493r = new float[6];
        this.f52494s = new Integer[]{0, 1, 2, 3, 4, 5};
        this.v = new HashSet();
        this.f52495w = new HashMap();
        this.f52496x = new HashMap();
        this.f52497y = new float[6];
        this.F = -1;
        this.I = new m2(this, 1);
        setClipToOutline(false);
        setClipToPadding(false);
        android.opengl.Matrix.setIdentityM(fArr, 0);
        this.f52487a = viewArr;
    ...
    public final void a() {
        if (Math.abs(this.d) > 1.0E-4f || Math.abs(this.f52490e) > 1.0E-4f) {
            float[] fArr = new float[16];
            b(1.0f, 0.0f, this.d, fArr);
            float[] fArr2 = this.f52489c;
            d(fArr, fArr2, fArr2);
            b(0.0f, 1.0f, this.f52490e, fArr);
            d(fArr, fArr2, fArr2);
            if (this.f52491f) {
                this.d *= 0.96f;
                this.f52490e *= 0.96f;
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        if (indexOfChild >= 6) {
            ...
            rectF = (RectF) this.f52496x.get(Integer.valueOf(indexOfChild));
            Integer num = (Integer) this.f52495w.get(Integer.valueOf(indexOfChild));
            if (num != null) {
            ...
            if (view instanceof v2) {
                ...
                v2Var.f52741e.setAlpha(f15);
                if (!z10 || this.E >= 1.0f) {
                    this.f52487a[indexOfChild].setVisibility(8);
                }
            }
            z11 = true;
        } else {
        ...
        float[][] fArr = this.h;
        android.opengl.Matrix.multiplyMV(this.f52492n, 0, this.f52489c, 0, fArr[indexOfChild], 0);
        float f16 = this.f52492n[2];
        if (f16 < 0.001f) {
            return false;
        }
        ...
        fArr3[i10] = 0.0f;
        fArr4[i10] = 0.0f;
        float f17 = this.f52497y[indexOfChild];
        if (f17 != 0.0f) {
        ...
        android.opengl.Matrix.multiplyMV(fArr5, 0, this.f52489c, 0, fArr2, 0);
        float[] fArr8 = fArr5;
        android.opengl.Matrix.multiplyMV(fArr6, 0, this.f52489c, 0, fArr3, 0);
        float[] fArr9 = fArr6;
        android.opengl.Matrix.multiplyMV(fArr7, 0, this.f52489c, 0, fArr4, 0);
        float f24 = 64.0f * dp2;
        int i11 = 2;
        int i12 = 1;
    ...
    public final void f(int i10, FrameLayout frameLayout) {
        ...
        this.f52495w.put(Integer.valueOf(childCount), Integer.valueOf(i10));
    }

    @Override
    public final int getChildDrawingOrder(int i10, int i11) {
        if (i11 < 6) {
            Integer[] numArr = this.f52494s;
