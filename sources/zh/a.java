...
public final class a extends LinearLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final org.telegram.ui.ActionBar.f6 f51641b;
    public final TextView f51642c;
    public final d90 d;
    public zf.b f51643e;
    public final nq[] f51644f;

    public a(Context context, int i10, org.telegram.ui.ActionBar.f6 f6Var) {
        this(context, i10, zf.b.f51624a, f6Var);
    }

    public final void a() {
        zf.b bVar = this.f51643e;
        int i10 = this.f51640a;
        zf.a s10 = s5.x(i10, bVar).s();
        zf.b bVar2 = this.f51643e;
        zf.b bVar3 = zf.b.f51624a;
        TextView textView = this.f51642c;
        org.telegram.ui.ActionBar.f6 f6Var = this.f51641b;
        d90 d90Var = this.d;
        if (bVar2 == bVar3) {
