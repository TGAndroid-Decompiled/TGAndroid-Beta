...
public final class a extends LinearLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final org.telegram.ui.ActionBar.f6 f51673b;
    public final TextView f51674c;
    public final d90 d;
    public zf.b f51675e;
    public final nq[] f51676f;

    public a(Context context, int i10, org.telegram.ui.ActionBar.f6 f6Var) {
        this(context, i10, zf.b.f51656a, f6Var);
    }

    public final void a() {
        zf.b bVar = this.f51675e;
        int i10 = this.f51672a;
        zf.a s10 = s5.x(i10, bVar).s();
        zf.b bVar2 = this.f51675e;
        zf.b bVar3 = zf.b.f51656a;
        TextView textView = this.f51674c;
        org.telegram.ui.ActionBar.f6 f6Var = this.f51673b;
        d90 d90Var = this.d;
        if (bVar2 == bVar3) {
