...
public final class a extends LinearLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final org.telegram.ui.ActionBar.f6 f51642b;
    public final TextView f51643c;
    public final d90 d;
    public zf.b f51644e;
    public final nq[] f51645f;

    public a(Context context, int i10, org.telegram.ui.ActionBar.f6 f6Var) {
        this(context, i10, zf.b.f51625a, f6Var);
    }

    public final void a() {
        zf.b bVar = this.f51644e;
        int i10 = this.f51641a;
        zf.a s10 = s5.x(i10, bVar).s();
        zf.b bVar2 = this.f51644e;
        zf.b bVar3 = zf.b.f51625a;
        TextView textView = this.f51643c;
        org.telegram.ui.ActionBar.f6 f6Var = this.f51642b;
        d90 d90Var = this.d;
        if (bVar2 == bVar3) {
