...
public final class r0 extends ph.c implements le.d {
    ...
    public r0(Context context, org.telegram.ui.ActionBar.f6 f6Var, org.telegram.ui.web.b1 b1Var) {
        ...
        this.f44127e.setColor(l1);
        this.f52532n = new ph.b[]{ph.b.b(context, f6Var, ph.a.G, R.string.GiftPreviewModels), ph.b.b(context, f6Var, ph.a.v, R.string.GiftPreviewBackdrops), ph.b.b(context, f6Var, ph.a.J, R.string.GiftPreviewSymbols)};
        int i11 = 0;
        while (true) {
            ph.b[] bVarArr = this.f52532n;
            if (i11 < bVarArr.length) {
                this.f44124a.addView(bVarArr[i11], w7.x5.l(1.0f, 0, -1));
                this.f52532n[i11].setOnClickListener(new di.o4(this, i11, 27));
                i11++;
            } else {
    ...
    public final void b() {
        ...
        int dp = AndroidUtilities.dp(this.f44125b * 7.0f);
        Rect rect2 = this.d;
        rect2.set(rect);
        int i10 = -dp;
        rect2.inset(i10, i10);
