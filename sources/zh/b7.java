...
public final class b7 extends LinearLayout {
    public final Path f51752a;
    public final Matrix f51753b;
    public final RadialGradient f51754c;
    public final Paint d;
    public final org.telegram.ui.Components.o5 f51755e;

    public b7(Context context, Matrix matrix, RadialGradient radialGradient, Paint paint, org.telegram.ui.Components.o5 o5Var) {
        super(context);
        this.f51753b = matrix;
        this.f51754c = radialGradient;
        this.d = paint;
        this.f51755e = o5Var;
        this.f51752a = new Path();
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        Path path = this.f51752a;
        path.rewind();
        path.addRoundRect(rectF, dp, dp, Path.Direction.CW);
        canvas.save();
        canvas.clipPath(path);
        Matrix matrix = this.f51753b;
        matrix.reset();
        matrix.postTranslate(getWidth() / 2.0f, AndroidUtilities.dp(100.0f));
        this.f51754c.setLocalMatrix(matrix);
        canvas.drawRect(0.0f, 0.0f, getWidth(), getHeight(), this.d);
        canvas.save();
        canvas.translate(getWidth() / 2.0f, AndroidUtilities.dp(100.0f));
        j0.a(canvas, 0, this.f51755e, getWidth(), AndroidUtilities.dp(180.0f), 1.0f, 1.0f);
        canvas.restore();
