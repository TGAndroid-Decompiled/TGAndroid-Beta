...
public final class k7 extends bb implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final r00 f52176a0;
    public Runnable f52177b0;
    public final TLRPC.InputPeer f52178c0;
    public final boolean f52179d0;
    public v51 f52180e0;
    public boolean f52181f0;
    ...
    public static void P(k7 k7Var, int i10) {
        h51 G;
        v51 v51Var = k7Var.f52180e0;
        if (v51Var != null && (G = v51Var.G(i10 - 1)) != null) {
            v51 v51Var2 = k7Var.f52180e0;
            if (G.d == -1) {
                k7Var.f52181f0 = !k7Var.f52181f0;
                v51Var2.N(true);
                ...
                if (findActivity != null) {
                    s5.y(k7Var.currentAccount, false).f(findActivity, (TL_stars.TL_starsTopupOption) G.G, new bi.f0(25, k7Var, G), k7Var.f52178c0);
                }
            }
        }
    }
            ...
            if (z11 != null && !z11.isEmpty()) {
                ...
                while (true) {
                    ...
                    if (tL_starsTopupOption.stars >= j3) {
                        if (tL_starsTopupOption.extended && !this.f52181f0 && z12) {
                            i15++;
                        } else {
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.starOptionsLoaded || i10 == NotificationCenter.starBalanceUpdated) {
            v51 v51Var = this.f52180e0;
            if (v51Var != null) {
                v51Var.N(true);
            }
            long j3 = s5.y(this.currentAccount, false).p().amount;
            long j10 = this.X;
            ((TextView) this.Y.f39116b).setText(LocaleController.formatPluralStringComma("StarsNeededTitle", (int) (j10 - j3)));
            xa xaVar = this.f24675e;
            if (xaVar != null) {
                xaVar.setTitle(y());
            }
            if (j3 >= j10 && (runnable = this.f52177b0) != null) {
                runnable.run();
                this.f52177b0 = null;
                dismiss();
            }
    ...
    public final void dismiss() {
        ...
        o20 o20Var = this.Y;
        if (o20Var != null) {
            ((tg.e) o20Var.f39117c).setPaused(true);
        }
    }
    ...
    public final void show() {
        ...
        if (!this.f52179d0) {
            ...
            Runnable runnable = this.f52177b0;
            if (runnable != null) {
                runnable.run();
                this.f52177b0 = null;
            }
    ...
    public final CharSequence y() {
        ...
        return ((TextView) o20Var.f39116b).getText();
    }
}
