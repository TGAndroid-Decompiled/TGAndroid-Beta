...
public final class u7 extends LinearLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final i81 f52728b;
    public final t7 f52729c;
    ...
    public ll0 getCurrentListView() {
        View currentView = this.f52728b.getCurrentView();
        if (!(currentView instanceof s7)) {
            return null;
        }
        return ((s7) currentView).f52623a;
    }

    @Override
    public final void onAttachedToWindow() {
        this.f52729c.i();
        this.f52728b.o(false);
        NotificationCenter.getInstance(this.f52727a).addObserver(this, NotificationCenter.starTransactionsLoaded);
        super.onAttachedToWindow();
    }

    @Override
    public final void onDetachedFromWindow() {
        NotificationCenter.getInstance(this.f52727a).removeObserver(this, NotificationCenter.starTransactionsLoaded);
