...
public final class u7 extends LinearLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final i81 f52696b;
    public final t7 f52697c;
    ...
    public ll0 getCurrentListView() {
        View currentView = this.f52696b.getCurrentView();
        if (!(currentView instanceof s7)) {
            return null;
        }
        return ((s7) currentView).f52591a;
    }

    @Override
    public final void onAttachedToWindow() {
        this.f52697c.i();
        this.f52696b.o(false);
        NotificationCenter.getInstance(this.f52695a).addObserver(this, NotificationCenter.starTransactionsLoaded);
        super.onAttachedToWindow();
    }

    @Override
    public final void onDetachedFromWindow() {
        NotificationCenter.getInstance(this.f52695a).removeObserver(this, NotificationCenter.starTransactionsLoaded);
