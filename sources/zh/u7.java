...
public final class u7 extends LinearLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final i81 f52697b;
    public final t7 f52698c;
    ...
    public ll0 getCurrentListView() {
        View currentView = this.f52697b.getCurrentView();
        if (!(currentView instanceof s7)) {
            return null;
        }
        return ((s7) currentView).f52592a;
    }

    @Override
    public final void onAttachedToWindow() {
        this.f52698c.i();
        this.f52697b.o(false);
        NotificationCenter.getInstance(this.f52696a).addObserver(this, NotificationCenter.starTransactionsLoaded);
        super.onAttachedToWindow();
    }

    @Override
    public final void onDetachedFromWindow() {
        NotificationCenter.getInstance(this.f52696a).removeObserver(this, NotificationCenter.starTransactionsLoaded);
