...
public final class a0 extends bb {
    public static final int[] f51646w0 = {21600, 43200, 86400, 129600, 172800, 259200};
    public final a X;
    public final TL_stars.TL_starGiftUnique Y;
    public final String Z;
    public final long f51647a0;
    public final l40 f51648b0;
    public final zc0 f51649c0;
    public final EditTextBoldCursor f51650d0;
    public final TextView f51651e0;
    public final y f51652f0;
    public final TextView f51653g0;
    public final di.d f51654h0;
    public final org.telegram.ui.Components.q6 f51655i0;
    public final ImageView f51656j0;
    public final ImageView f51657k0;
    public final mg.n f51658l0;
    public zf.a m0;
    public int f51659n0;
    public int f51660o0;
    public boolean f51661p0;
    public final b1 f51662q0;
    public final nq[] f51663r0;
    public final nq[] f51664s0;
    public boolean f51665t0;
    public v51 f51666u0;
    public final h51 f51667v0;
    ...
    public a0(final Context context, final int i10, final long j3, TL_stars.TL_starGiftUnique tL_starGiftUnique, final org.telegram.ui.ActionBar.f6 f6Var, b1 b1Var) {
        ...
        n7.z0[] z0VarArr = (n7.z0[]) nVar.f16292b;
        this.f51658l0 = nVar;
        this.f51663r0 = new nq[1];
        this.f51664s0 = new nq[1];
        this.L = false;
        ...
        zf.a i11 = zf.a.i(Math.max(g10.e(bVar2).n(2).f51624b, appGlobalConfig.tonStarGiftResaleAmountMin.get()), bVar2);
        zf.a i12 = zf.a.i(Math.max(i11.f51624b * 2, appGlobalConfig.tonStarGiftResaleAmountMax.get()), bVar2);
        zf.b bVar3 = g10.f51623a;
        if (bVar3 == g11.f51623a) {
            z0VarArr[bVar3.ordinal()] = new n7.z0(29, g10, g11);
        }
        zf.b bVar4 = i11.f51623a;
        if (bVar4 == i12.f51623a) {
        ...
        this.f51650d0 = editTextBoldCursor;
        if (j10) {
            l40 l40Var = new l40(context, f6Var);
            this.f51648b0 = l40Var;
        ...
        this.f51667v0 = h51.k(linearLayout);
        this.f51666u0.N(false);
    }
    ...
    public static void P(a0 a0Var, long j3, boolean z10, zf.a aVar, long j10, org.telegram.ui.ActionBar.b2 b2Var) {
        ...
        if (i11 > 0) {
            ...
            if (z10) {
                ...
                i10 = zf.a.i(a0Var.m0.f51624b + aVar.f51624b, bVar);
            }
            if (aVar2 == null || aVar2.f51624b < i10.f51624b) {
                new k7(a0Var.getContext(), a0Var.resourcesProvider, i10.a(), 14, null, null, a0Var.f51647a0).show();
                return;
            }
        }
        ...
        tL_sendStarGiftOffer.peer = MessagesController.getInstance(a0Var.currentAccount).getInputPeer(a0Var.f51647a0);
        tL_sendStarGiftOffer.duration = a0Var.f51659n0;
    ...
    public static void Q(a0 a0Var, int i10, Context context, org.telegram.ui.ActionBar.f6 f6Var, long j3) {
        ...
        if (a0Var.f51654h0.W) {
            ...
            s5 x10 = s5.x(i10, a0Var.m0.f51623a);
            if (x10.f52570e) {
                aVar = zf.a.l(x10.p());
            } else {
                aVar = null;
            ...
            zf.b bVar2 = zf.b.f51626b;
            if (aVar != null) {
                long j10 = aVar.f51624b;
                zf.a aVar2 = a0Var.m0;
                if (j10 >= aVar2.f51624b) {
                    String str2 = a0Var.Z;
                    long j11 = a0Var.f51647a0;
                    String d = aVar2.d();
                    if (a0Var.m0.f51623a == bVar2) {
                        str = str2;
                        z10 = true;
                    } else {
                        str = str2;
                    ...
                    oz0Var.c(LocaleController.getString(R.string.GiftOfferRowDuration), LocaleController.formatPluralString("GiftOfferHours", a0Var.f51659n0 / 3600, new Object[0]), r14, r14);
                    ...
                    if (i12 == 0) {
                        ...
                        z11 = z10;
                        spannableStringBuilder.append((CharSequence) v7.Q0(LocaleController.formatString(R.string.GiftOfferPay, zf.a.i(a0Var.m0.f51624b + g10.f51624b, bVar).d())));
    ...
    public final void S() {
        boolean z10;
        float f7;
        boolean z11 = this.f51665t0;
        a aVar = this.X;
        if ((z11 && !isDismissed() && aVar != null && this.containerView.getY() > AndroidUtilities.dp(32.0f)) || this.f51648b0 == null) {
            z10 = true;
        } else {
            z10 = false;
        }
        if (this.f51661p0 != z10) {
            this.f51661p0 = z10;
            if (aVar != null) {
                aVar.setEnabled(z10);
    ...
    public final void T(boolean z10) {
        boolean z11;
        if (this.f51660o0 == 0 && this.m0.f51624b > 0) {
            z11 = true;
        } else {
            z11 = false;
        }
        di.d dVar = this.f51654h0;
        if (dVar.W != z11) {
            dVar.setEnabled(z11);
    ...
    public final void U(zf.a aVar, boolean z10, boolean z11, boolean z12) {
        ...
        int i15;
        zf.a aVar2 = this.m0;
        int i16 = this.f51660o0;
        this.f51660o0 = 0;
        if (aVar != null) {
            this.m0 = aVar;
        } else {
            this.m0 = zf.a.i(0L, aVar2.f51623a);
            this.f51660o0 |= 1;
        }
        zf.b bVar2 = this.m0.f51623a;
        mg.n nVar = this.f51658l0;
        n7.z0[] z0VarArr = (n7.z0[]) nVar.f16292b;
        long j3 = ((zf.a) ((n7.z0[]) nVar.f16292b)[bVar2.ordinal()].f16704c).f51624b;
        zf.a aVar3 = this.m0;
        if (j3 < aVar3.f51624b) {
            this.f51660o0 |= 4;
        }
        if (!aVar3.k() && ((zf.a) z0VarArr[this.m0.f51623a.ordinal()].f16703b).f51624b > this.m0.f51624b) {
            this.f51660o0 |= 2;
        }
        if (!z11 && aVar2.f51623a == this.m0.f51623a) {
            z13 = false;
        } else {
            z13 = true;
        }
        if (!z11 && aVar2.f51624b == this.m0.f51624b) {
            z14 = false;
        } else {
            z14 = true;
        }
        if (!z11 && i16 == this.f51660o0) {
            z15 = false;
        } else {
            z15 = true;
        }
        zf.b bVar3 = zf.b.f51625a;
        EditTextBoldCursor editTextBoldCursor = this.f51650d0;
        zf.b bVar4 = zf.b.f51626b;
        if (z13) {
            l40 l40Var = this.f51648b0;
            if (l40Var != null) {
                if (this.m0.f51623a == bVar3) {
                    i15 = 0;
                } else {
                    i15 = 1;
                }
            ...
            String shortName = DialogObject.getShortName(this.f51647a0);
            zf.b bVar5 = this.m0.f51623a;
            TextView textView = this.f51653g0;
            if (bVar5 == bVar3) {
                ...
                editTextBoldCursor.setFilters(new InputFilter[]{new InputFilter.LengthFilter(Long.toString(((zf.a) z0VarArr[this.m0.f51623a.ordinal()].f16704c).a()).length())});
            } else if (bVar5 == bVar4) {
                ...
                editTextBoldCursor.setFilters(new InputFilter[]{new InputFilter.LengthFilter(Long.toString(((zf.a) z0VarArr[this.m0.f51623a.ordinal()].f16704c).a()).length() + 3)});
            }
            ImageView imageView = this.f51657k0;
            ImageView imageView2 = this.f51656j0;
            if (z12) {
            ...
            a aVar4 = this.X;
            if (aVar4 != null && aVar4.f51644e != (bVar = this.m0.f51623a)) {
                aVar4.f51644e = bVar;
                aVar4.a();
            }
        } else {
        ...
        if (z13 || z15) {
            ...
            this.f51649c0.setText(LocaleController.getString(i10));
            zf.b bVar6 = this.m0.f51623a;
            int i17 = this.f51660o0;
            int i18 = i17 & 4;
            String str = this.Z;
            TextView textView2 = this.f51651e0;
            if (i18 != 0) {
                if (bVar6 == bVar3) {
                ...
                objArr[c10] = ((zf.a) z0VarArr[bVar6.ordinal()].f16704c).d();
                objArr[1] = str;
                vl.p(i14, objArr, textView2);
            } else if ((i17 & 2) != 0) {
                if (bVar6 == bVar3) {
                ...
                objArr2[c10] = ((zf.a) z0VarArr[bVar6.ordinal()].f16703b).d();
                objArr2[1] = str;
                vl.p(i12, objArr2, textView2);
            } else {
                if (bVar6 == bVar3) {
                ...
                objArr3[c10] = str;
                vl.p(i11, objArr3, textView2);
            }
            if ((this.f51660o0 & (-9)) == 0) {
        ...
        if (z13 || z14 || z15) {
            ...
            if (z16) {
                nqVarArr = this.f51664s0;
            } else {
                nqVarArr = this.f51663r0;
            }
            this.f51654h0.g(v7.V0(z16, formatString, nqVarArr), z12, true);
            T(z12);
        }
        if (z13 || z14) {
    ...
    public final boolean isTouchOutside(float f7, float f10) {
        a aVar;
        if (this.f51661p0 && (aVar = this.X) != null && f7 >= aVar.getX() && f7 <= aVar.getX() + aVar.getWidth() && f10 >= aVar.getY() && f10 <= aVar.getY() + aVar.getHeight()) {
            return false;
        }
