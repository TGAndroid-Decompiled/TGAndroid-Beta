...
public final class g7 extends bb implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final ug.b1 f51990a0;
    public v51 f51991b0;
    public boolean f51992c0;
    ...
    public g7(Context context, org.telegram.ui.ActionBar.f6 f6Var, TLRPC.User user, ug.b1 b1Var) {
        ...
        this.X = v0Var;
        ((TextView) v0Var.f3911c).setText(LocaleController.getString(R.string.GiftStarsTitle));
            ...
            public final void run() {
                ...
                switch (r2) {
                    case 0:
                        ...
                        return;
                    default:
                        of.f.s(this.f51927b.getContext(), LocaleController.getString(R.string.StarsTOSLink));
                        return;
                }
            }
        }), true)));
    ...
    public static void P(g7 g7Var, int i10) {
        h51 G;
        v51 v51Var = g7Var.f51991b0;
        if (v51Var != null && (G = v51Var.G(i10 - 1)) != null) {
            v51 v51Var2 = g7Var.f51991b0;
            if (G.d == -1) {
                g7Var.f51992c0 = !g7Var.f51992c0;
                v51Var2.N(true);
                g7Var.d.v0(0, AndroidUtilities.dp(200.0f), pr.f29495g);
                ...
                if (context != null) {
                    ...
                    if (!MessagesController.getInstance(i11).starsPurchaseAvailable()) {
                        ...
                        ?? obj = new Object();
                        obj.f4369b = "inapp";
                        obj.f4368a = tL_starsGiftOption.store_product;
    ...
    public static void Q(g7 g7Var, h51 h51Var, long j3, Boolean bool, String str) {
        ...
        if (g7Var.getContext() != null) {
            if ((bool.booleanValue() || str != null) && (b1Var = g7Var.f51990a0) != null) {
                b1Var.run();
            }
            super.dismiss();
            org.telegram.ui.ActionBar.n2 U = LaunchActivity.U();
            gb0 gb0Var = LaunchActivity.G1.f33495x0;
            if (U != null) {
    ...
    public final void R(ArrayList arrayList, v51 v51Var) {
        ...
        if (u10 != null && !u10.isEmpty()) {
            ...
            for (int i13 = 0; i13 < u10.size(); i13++) {
                ...
                if (!this.f51992c0 && tL_starsGiftOption.extended) {
                    i11++;
                } else {
                    int i14 = i12 + 1;
                    int i15 = h7.f52022a;
                    ...
                    J.B = j3;
                    J.f26622l = LocaleController.formatPluralStringSpaced("StarsCount", (int) j3);
                    ...
                    J.f26623m = formatCurrency;
                    J.G = tL_starsGiftOption;
                    arrayList.add(J);
                    i12 = i14;
                }
            }
            boolean z10 = this.f51992c0;
            if (!z10 && i11 > 0) {
                if (z10) {
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        v51 v51Var;
        if ((i10 == NotificationCenter.starGiftOptionsLoaded || i10 == NotificationCenter.starBalanceUpdated) && (v51Var = this.f51991b0) != null) {
            v51Var.N(true);
        }
    }
