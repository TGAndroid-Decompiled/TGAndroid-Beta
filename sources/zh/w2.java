...
public final class w2 extends Drawable {
    public Drawable f52784g;
    public int h;
    public int f52785i;
    public final Paint f52780b = new Paint(1);
    public final Shader[] f52781c = new Shader[2];
    public final Matrix d = new Matrix();
    public final org.telegram.ui.Components.e6 f52782e = new org.telegram.ui.Components.e6(1.0f, new m2(this, 3), 0, 420, pr.h);
    public final RectF f52783f = new RectF();
    public final int f52779a = 1;

    public final void a(int i10, int i11) {
        if (this.h == i10 && this.f52785i == i11) {
            return;
        }
        Shader[] shaderArr = this.f52781c;
    ...
    public final void draw(Canvas canvas) {
        ...
        RectF rectF = this.f52783f;
        rectF.set(bounds);
        rectF.right = rectF.width() + rectF.left;
        int i10 = 0;
        float d = this.f52782e.d(1.0f, false);
        while (true) {
            Shader[] shaderArr = this.f52781c;
        ...
        if (this.f52784g != null) {
            canvas.save();
            canvas.translate(rectF.centerX(), AndroidUtilities.dp(145.0f));
            j0.a(canvas, 0, this.f52784g, rectF.width(), AndroidUtilities.dp(290.0f), 2.0f, 1.0f);
            canvas.restore();
        }
    }
