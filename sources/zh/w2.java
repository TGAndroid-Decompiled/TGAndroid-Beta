...
public final class w2 extends Drawable {
    public Drawable f52753g;
    public int h;
    public int f52754i;
    public final Paint f52749b = new Paint(1);
    public final Shader[] f52750c = new Shader[2];
    public final Matrix d = new Matrix();
    public final org.telegram.ui.Components.e6 f52751e = new org.telegram.ui.Components.e6(1.0f, new m2(this, 3), 0, 420, pr.h);
    public final RectF f52752f = new RectF();
    public final int f52748a = 1;

    public final void a(int i10, int i11) {
        if (this.h == i10 && this.f52754i == i11) {
            return;
        }
        Shader[] shaderArr = this.f52750c;
    ...
    public final void draw(Canvas canvas) {
        ...
        RectF rectF = this.f52752f;
        rectF.set(bounds);
        rectF.right = rectF.width() + rectF.left;
        int i10 = 0;
        float d = this.f52751e.d(1.0f, false);
        while (true) {
            Shader[] shaderArr = this.f52750c;
        ...
        if (this.f52753g != null) {
            ...
            j0.a(canvas, 0, this.f52753g, rectF.width(), AndroidUtilities.dp(290.0f), 2.0f, 1.0f);
            canvas.restore();
        }
    }
