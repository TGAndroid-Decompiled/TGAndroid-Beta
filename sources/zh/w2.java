...
public final class w2 extends Drawable {
    public Drawable f52752g;
    public int h;
    public int f52753i;
    public final Paint f52748b = new Paint(1);
    public final Shader[] f52749c = new Shader[2];
    public final Matrix d = new Matrix();
    public final org.telegram.ui.Components.e6 f52750e = new org.telegram.ui.Components.e6(1.0f, new m2(this, 3), 0, 420, pr.h);
    public final RectF f52751f = new RectF();
    public final int f52747a = 1;

    public final void a(int i10, int i11) {
        if (this.h == i10 && this.f52753i == i11) {
            return;
        }
        Shader[] shaderArr = this.f52749c;
    ...
    public final void draw(Canvas canvas) {
        ...
        RectF rectF = this.f52751f;
        rectF.set(bounds);
        rectF.right = rectF.width() + rectF.left;
        int i10 = 0;
        float d = this.f52750e.d(1.0f, false);
        while (true) {
            Shader[] shaderArr = this.f52749c;
        ...
        if (this.f52752g != null) {
            ...
            j0.a(canvas, 0, this.f52752g, rectF.width(), AndroidUtilities.dp(290.0f), 2.0f, 1.0f);
            canvas.restore();
        }
    }
