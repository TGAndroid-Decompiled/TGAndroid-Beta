...
public final class f extends ov0 implements r0.m {
    public final b2.q0 f51872w0;
    public final g f51873x0;

    public f(g gVar, Context context) {
        super(context, null);
        this.f51873x0 = gVar;
        this.f51872w0 = new Object();
    }
    ...
    public final void E(ViewGroup viewGroup, int i10, int i11, int[] iArr, int i12) {
        ...
        boolean z10;
        int max;
        g gVar = this.f51873x0;
        if (viewGroup == gVar.f51940e && gVar.F.isAttachedToWindow()) {
            kVar = ((org.telegram.ui.ActionBar.n2) gVar).actionBar;
            boolean z11 = kVar.f21131n0;
            ...
            if (i11 < 0) {
                ...
                if (gVar.f51940e.getHeight() - bottom < 0) {
                    z10 = true;
                } else {
                    z10 = false;
                }
                ...
                if (gVar.f51940e.getHeight() - bottom >= 0 && currentListView3 != null && !currentListView3.canScrollVertically(1)) {
                    iArr[1] = i11;
                    gVar.f51940e.B0();
                }
            }
