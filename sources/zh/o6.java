...
public final class o6 implements Runnable {
    ...
    public final KeyEvent.Callback f52392c;
    public final Object d;
    public final TLObject f52393e;
    public final Object f52394f;
    ...
    public final void run() {
        ...
        Object obj = this.f52394f;
        TLObject tLObject = this.f52393e;
        Object obj2 = this.d;
        KeyEvent.Callback callback = this.f52392c;
        switch (i10) {
            case 0:
            ...
            default:
                ...
                long j3 = p1Var.f50485c0;
                yh.m0 m0Var = new yh.m0(p1Var, (Utilities.Callback) obj, 2);
                boolean z12 = starGift.limited;
                if (z12 && (disallowedGiftsSettings2 = p1Var.f50484b0) != null && disallowedGiftsSettings2.disallow_limited_stargifts) {
                    z10 = true;
                } else {
                    z10 = false;
                }
                if (z12 && (disallowedGiftsSettings = p1Var.f50484b0) != null && disallowedGiftsSettings.disallow_unique_stargifts) {
                    z11 = true;
                } else {
                    z11 = false;
                }
                new yh.s0(p1Var, context, this.f52391b, starGift, j3, m0Var, z10, z11).show();
                return;
        }
    }
}
