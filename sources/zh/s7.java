...
public final class s7 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    public final d61 f52623a;
    public final org.telegram.ui.ActionBar.f6 f52624b;
    public final int f52625c;
    public final int d;
    public final boolean f52626e;
    public final long f52627f;
    public final q7 h;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == i12) {
            ...
            this.h.run();
        } else if (i10 == NotificationCenter.botStarsTransactionsLoaded && ((Long) objArr[0]).longValue() == this.f52627f) {
            d61Var.Y2.N(true);
        }
    }
