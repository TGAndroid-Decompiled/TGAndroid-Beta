...
public final class s7 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    public final d61 f52592a;
    public final org.telegram.ui.ActionBar.f6 f52593b;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == i12) {
            ...
            this.h.run();
        } else if (i10 == NotificationCenter.botStarsTransactionsLoaded && ((Long) objArr[0]).longValue() == this.f52596f) {
            d61Var.Y2.N(true);
        }
    }
