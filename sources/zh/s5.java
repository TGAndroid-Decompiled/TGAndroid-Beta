...
public final class s5 {
    ...
    public ArrayList f52573j;
    public boolean f52574k;
    public boolean f52575l;
    public ArrayList f52576m;
    public boolean f52577n;
    public boolean f52578o;
    public ArrayList f52579p;
    public String f52585w;
    public boolean f52586x;
    public boolean f52587y;
    public TL_stars.StarsAmount f52570f = TL_stars.StarsAmount.ofStars(0);
    public final ArrayList[] f52580q = {new ArrayList(), new ArrayList(), new ArrayList()};
    public final boolean[] f52581r = new boolean[3];
    public final String[] f52582s = new String[3];
    public final boolean[] f52583t = new boolean[3];
    public final boolean[] f52584u = new boolean[3];
    public final ArrayList v = new ArrayList();
    public final ArrayList f52588z = new ArrayList();
    ...
    public static boolean U(int i10, zf.a aVar) {
        if (aVar == null || x(i10, aVar.f51622a).s().f51623b >= aVar.f51623b) {
            return true;
        }
        return false;
    }
    ...
    public static void e0(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        alertDialog$Builder.f20198a.R = LocaleController.getString(R.string.StarsNotAvailableTitle);
        alertDialog$Builder.f20198a.T = LocaleController.getString(R.string.StarsNotAvailableText);
    ...
    public final long A(MessageObject messageObject) {
        ...
        Long l4;
        r5 r5Var = this.B;
        if (r5Var != null && r5Var.f52512a.equals(l5.b(messageObject)) && (l4 = this.B.f52523n) != null) {
            return l4.longValue();
        }
        ...
        Long paidReactionsDialogId = MessagesController.getInstance(this.f52566a).getPaidReactionsDialogId();
    ...
    public final long B(l5 l5Var, TLRPC.TL_messageReactions tL_messageReactions) {
        Long l4;
        r5 r5Var = this.B;
        if (r5Var != null && r5Var.f52512a.equals(l5Var) && (l4 = this.B.f52523n) != null) {
            return l4.longValue();
        }
    ...
    public final long D(int i10, long j3) {
        r5 r5Var = this.B;
        if (r5Var != null) {
            l5 l5Var = r5Var.f52512a;
            if (l5Var.f52213a == j3 && l5Var.f52214b == i10 && r5Var.f52521l) {
                return r5Var.h;
            }
            return 0L;
        }
    ...
    public final i5 F(long j3, boolean z10) {
        ...
        if (i5Var == null && z10) {
            i5 i5Var2 = new i5(this.f52566a, j3);
    ...
    public final j5 G(long j3, boolean z10) {
        ...
        if (j5Var == null && z10) {
            j5 j5Var2 = new j5(this.f52566a, j3, true);
    ...
    public final void H(TL_stars.StarGift starGift, long j3, TLRPC.TL_textWithEntities tL_textWithEntities, boolean z10, Utilities.Callback callback) {
        ...
        if (starGift != null && context != null) {
            ...
            tL_inputInvoiceStarGiftResale.to_id = MessagesController.getInstance(this.f52566a).getInputPeer(j3);
            tL_inputInvoiceStarGiftResale.ton = this.f52567b;
            ...
            ConnectionsManager.getInstance(this.f52566a).sendRequest(tL_payments_getPaymentForm, new cj1(10, this, callback));
        }
    }
    ...
    public final void K(long j3, Utilities.Callback callback) {
        ...
        ConnectionsManager.getInstance(this.f52566a).sendRequest(getstargiftupgradepreview, new bi.l1(this, j3, callback, 5));
    }
    ...
    public final void M(TL_stars.InputSavedStarGift inputSavedStarGift, Utilities.Callback callback) {
        ...
        ConnectionsManager.getInstance(this.f52566a).sendRequest(getsavedstargift, new bi.c3(this, b2Var, inputSavedStarGift, callback, 18));
    }
    ...
    public final boolean O(int i10) {
        if (this.f52569e && !this.f52580q[i10].isEmpty()) {
            return true;
        }
        return false;
    }
    ...
    public final void R(TLRPC.UserFull userFull) {
        ...
        j5 G = G(j3, false);
        if (G != null && G.f52103n != userFull.stargifts_count) {
            G.i(false);
        }
        i5 i5Var = (i5) this.K.get(j3);
        if (i5Var != null) {
    ...
    public final void T(boolean z10) {
        for (int i10 = 0; i10 < 3; i10++) {
            boolean[] zArr = this.f52583t;
            if (!zArr[i10]) {
                this.f52580q[i10].clear();
                this.f52582s[i10] = null;
                zArr[i10] = false;
                this.f52584u[i10] = false;
                if (z10) {
                    X(i10);
                }
            }
    ...
    public final void W() {
        if (!this.f52567b && !this.f52586x && !this.f52587y) {
            this.f52586x = true;
            ...
            String str = this.f52585w;
            tL_getStarsSubscriptions.offset = str;
            if (str == null) {
                tL_getStarsSubscriptions.offset = "";
            }
            ConnectionsManager.getInstance(this.f52566a).sendRequest(tL_getStarsSubscriptions, new u4(this, 1));
        }
    }
    ...
    public final void X(int i10) {
        boolean z10;
        boolean[] zArr = this.f52583t;
        if (!zArr[i10] && !this.f52584u[i10]) {
            boolean z11 = true;
            zArr[i10] = true;
            TL_stars.TL_payments_getStarsTransactions tL_payments_getStarsTransactions = new TL_stars.TL_payments_getStarsTransactions();
            tL_payments_getStarsTransactions.ton = this.f52567b;
            ...
            String str = this.f52582s[i10];
            tL_payments_getStarsTransactions.offset = str;
            if (str == null) {
                tL_payments_getStarsTransactions.offset = "";
            }
            ConnectionsManager.getInstance(this.f52566a).sendRequest(tL_payments_getStarsTransactions, new bi.p7(this, i10, 9));
        }
    }
    ...
    public final void Z(final String str, final TLRPC.ChatInvite chatInvite, final Utilities.Callback2 callback2) {
        if (chatInvite != null && chatInvite.subscription_pricing != null) {
            ...
            if (context != null) {
                ...
                ConnectionsManager.getInstance(this.f52566a).sendRequest(tL_payments_sendStarsForm, new RequestDelegate() {
                    @Override
    ...
    public final void a0(final MessageObject messageObject, final TLRPC.InputInvoice inputInvoice, final TLRPC.TL_payments_paymentFormStars tL_payments_paymentFormStars, final Utilities.Callback callback) {
        ...
        if (tL_payments_paymentFormStars != null) {
            ...
            if (messageObject != null) {
                ...
                if (j3 < 0 && messageObject.getFromChatId() > 0 && (user = MessagesController.getInstance(this.f52566a).getUser(Long.valueOf(messageObject.getFromChatId()))) != null && user.bot) {
                    j3 = user.f20016id;
                }
            } else {
            ...
            final long j11 = j3;
            if (j11 >= 0) {
                str = UserObject.getUserName(MessagesController.getInstance(this.f52566a).getUser(Long.valueOf(j11)));
            } else {
                TLRPC.Chat chat = MessagesController.getInstance(this.f52566a).getChat(Long.valueOf(-j11));
                if (chat == null) {
                    str = "";
                } else {
                    str = chat.title;
    ...
    public final void c0(int i10, long j3, ArrayList arrayList) {
        MessagesStorage messagesStorage = MessagesStorage.getInstance(this.f52566a);
    ...
    public final r5 d0(final MessageObject messageObject, final co coVar, final long j3, boolean z10, boolean z11, final Long l4) {
        ...
        String str2 = "";
        if (z11 && y3.f52569e && y3.q(false, false, null).amount <= 0) {
            long a2 = coVar.a();
            if (a2 >= 0) {
            ...
            new k7(t10, coVar.getResourceProvider(), j3, 5, str2, new Runnable(this) {
                ...
                public final void run() {
                    switch (r7) {
                        case 0:
                            this.f52796b.d0(messageObject, coVar, j3, true, true, l4);
                            return;
                        default:
                            this.f52796b.d0(messageObject, coVar, j3, true, true, l4);
                            return;
        ...
        r5 r5Var = this.B;
        if (r5Var != null && r5Var.f52512a.equals(b10)) {
            j10 = 0;
            s5Var = this;
        } else {
            r5 r5Var2 = this.B;
        ...
        if (z11 && y3.f52569e && y3.q(false, false, null).amount < j11) {
            s5Var.B.a();
            long a10 = coVar.a();
            if (a10 >= j10) {
            ...
            new k7(t10, coVar.getResourceProvider(), j11, 5, str, new Runnable(s5Var) {
                ...
                public final void run() {
                    switch (r7) {
                        case 0:
                            this.f52796b.d0(messageObject, coVar, j11, true, true, l4);
                            return;
                        default:
                            this.f52796b.d0(messageObject, coVar, j11, true, true, l4);
                            return;
        ...
        o5 o5Var = r5Var4.f52525p;
        s5 s5Var2 = r5Var4.f52526q;
        int i11 = s5Var2.f52566a;
        kc kcVar = r5Var4.f52515e;
        MessageObject messageObject2 = r5Var4.f52513b;
        if (!r5Var4.f52518i && !r5Var4.f52519j) {
            r5Var4.h += j3;
            System.currentTimeMillis();
            kcVar.f27798c.a();
            kcVar.f27798c.c(AndroidUtilities.replaceTags(LocaleController.formatPluralString("StarsSentText", (int) r5Var4.h, new Object[0])), true, true);
            if (r5Var4.f52522m) {
                r5Var4.f52516f.f27428b = 5000L;
            ...
            kcVar.f27797b.setText(r5Var4.d());
    ...
    public final void g(final long j3, final TLObject tLObject, final TLRPC.TL_textWithEntities tL_textWithEntities, final Utilities.Callback2 callback2) {
        ...
        if ((z10 || (tLObject instanceof TLRPC.TL_premiumGiftCodeOption)) && context2 != null) {
            ...
            final String name = DialogObject.getName(this.f52566a, j3);
            final TLRPC.TL_inputInvoicePremiumGiftStars tL_inputInvoicePremiumGiftStars = new TLRPC.TL_inputInvoicePremiumGiftStars();
            tL_inputInvoicePremiumGiftStars.user_id = MessagesController.getInstance(this.f52566a).getInputUser(j3);
            ...
            ConnectionsManager.getInstance(this.f52566a).sendRequest(tL_payments_getPaymentForm, new RequestDelegate() {
                @Override
                public final void run(final TLObject tLObject2, final TLRPC.TL_error tL_error) {
                    ...
                    AndroidUtilities.runOnUIThread(new Runnable() {
                        ...
                        public final void run() {
                            ...
                            s5 s5Var2 = s5.this;
                            ConnectionsManager.getInstance(s5Var2.f52566a).sendRequest(tL_payments_sendStarsForm, new p4(s5Var2, callback23, context3, f6Var, j11, str, j10, tLObject3, tL_textWithEntities2));
                        }
                    });
                }
            });
    ...
    public final void h(TLRPC.TL_payments_paymentFormStarGift tL_payments_paymentFormStarGift, TL_stars.StarGift starGift, long j3, TLRPC.TL_textWithEntities tL_textWithEntities, boolean z10, Utilities.Callback2 callback2) {
        ...
        if (starGift != null && context2 != null) {
            ...
            String name = DialogObject.getName(this.f52566a, j3);
            TLRPC.TL_inputInvoiceStarGiftResale tL_inputInvoiceStarGiftResale = new TLRPC.TL_inputInvoiceStarGiftResale();
            tL_inputInvoiceStarGiftResale.slug = starGift.slug;
            tL_inputInvoiceStarGiftResale.to_id = MessagesController.getInstance(this.f52566a).getInputPeer(j3);
            tL_inputInvoiceStarGiftResale.ton = this.f52567b;
            ...
            ConnectionsManager.getInstance(this.f52566a).sendRequest(tL_payments_sendStarsForm, new p4(this, callback2, context2, I, j10, name, tL_payments_paymentFormStarGift, starGift, j3));
        }
    }
    ...
    public final void i(final TL_stars.StarGift starGift, final boolean z10, final boolean z11, final long j3, final TLRPC.TL_textWithEntities tL_textWithEntities, final yh.l4 l4Var) {
        ...
        if (starGift != null && context2 != null) {
            ...
            tL_inputInvoiceStarGift.peer = MessagesController.getInstance(this.f52566a).getInputPeer(j3);
            tL_inputInvoiceStarGift.gift_id = starGift.f20097id;
                ...
                public final void run(final TLObject tLObject, final TLRPC.TL_error tL_error) {
                    ...
                    AndroidUtilities.runOnUIThread(new Runnable() {
                        ...
                        public final void run() {
                            ...
                            ConnectionsManager connectionsManager = ConnectionsManager.getInstance(s5Var2.f52566a);
                                        ...
                                        public final void run() {
                                            ...
                                            if (!(tLObject4 instanceof TLRPC.TL_payments_paymentResult)) {
                                                if (tL_error4 != null && "BALANCE_TOO_LOW".equals(tL_error4.text)) {
                                                    if (!MessagesController.getInstance(s5Var4.f52566a).starsPurchaseAvailable()) {
                                            ...
                                            if (BirthdayController.getInstance(s5Var4.f52566a).contains(j16)) {
                                                i11 = 0;
                                                MessagesController.getInstance(s5Var4.f52566a).getMainSettings().edit().putBoolean(Calendar.getInstance().get(1) + "bdayhint_" + j16, false).apply();
                                            } else {
                                                i11 = 0;
                                            }
                                            ...
                                            if (j16 < 0) {
                                                long j17 = -j16;
                                                TLRPC.ChatFull chatFull = MessagesController.getInstance(s5Var4.f52566a).getChatFull(j17);
                                                if (chatFull != null) {
                                                    chatFull.stargifts_count++;
                                                    chatFull.flags2 |= 262144;
                                                    MessagesController.getInstance(s5Var4.f52566a).putChatFull(chatFull);
                                                }
                                                ...
                                                NotificationCenter notificationCenter = NotificationCenter.getInstance(s5Var4.f52566a);
                                                ...
                                                NotificationCenter.getInstance(s5Var4.f52566a).lambda$postNotificationNameOnUIThread$1(NotificationCenter.closeChatActivity, Long.valueOf(j16), bool);
                                                co R9 = co.R9(j16);
                                                R9.whenFullyVisible(new i21(R9, starGift5, spannableStringBuilder, j15, 12));
                                                R.presentFragment(R9);
                                            }
                                            MessagesController.getInstance(s5Var4.f52566a).getMainSettings().edit().putBoolean("show_gift_for_" + j16, true).putBoolean(Calendar.getInstance().get(1) + "show_gift_for_" + j16, true).apply();
                                            LaunchActivity launchActivity = LaunchActivity.G1;
                                            if (launchActivity != null && (gb0Var = launchActivity.f33467x0) != null) {
                                                gb0Var.c(true);
                                            }
    ...
    public final void j0(String str, TLRPC.ChatInvite chatInvite, Utilities.Callback2 callback2) {
        ...
        if (chatInvite != null && chatInvite.subscription_pricing != null) {
            ...
            if (context2 != null) {
                ...
                i9Var.f27036n = 0;
                i9Var.f27035m = false;
                i9.a(str3, null, null, i9Var.f27039q);
    ...
    public final void k0(TL_stars.StarsAmount starsAmount) {
        boolean equals = this.f52570f.equals(starsAmount);
        int i10 = this.f52566a;
        if (!equals) {
            this.f52570f = starsAmount;
            this.f52571g = 0L;
    ...
    public final TL_stars.SavedStarGift n(long j3) {
        ...
        while (true) {
            ...
            if (i10 < longSparseArray.size()) {
                ...
                for (int i11 = 0; i11 < j5Var.f52101l.size(); i11++) {
                    TL_stars.SavedStarGift savedStarGift = (TL_stars.SavedStarGift) j5Var.f52101l.get(i11);
                    if (savedStarGift != null && (starGift = savedStarGift.gift) != null && starGift.f20097id == j3) {
    ...
    public final TL_stars.StarsAmount q(boolean z10, boolean z11, Runnable runnable) {
        if (((!this.f52569e || System.currentTimeMillis() - this.f52568c > 60000) && !this.d) || z11) {
            this.d = true;
            TL_stars.TL_payments_getStarsStatus tL_payments_getStarsStatus = new TL_stars.TL_payments_getStarsStatus();
            tL_payments_getStarsStatus.ton = this.f52567b;
            tL_payments_getStarsStatus.peer = new TLRPC.TL_inputPeerSelf();
            ConnectionsManager.getInstance(this.f52566a).sendRequest(tL_payments_getStarsStatus, new cj1(11, this, runnable));
        }
        if (z10 && this.f52571g > 0) {
            zf.a m10 = zf.a.m(this.f52570f);
            return zf.a.g(Math.max(0L, m10.a() - this.f52571g), m10.f51622a).o();
        }
        return this.f52570f;
    }
    ...
    public final ArrayList u() {
        if (!this.f52574k && !this.f52575l) {
            this.f52574k = true;
            ConnectionsManager.getInstance(this.f52566a).sendRequest(new TL_stars.TL_payments_getStarsGiftOptions(), new u4(this, 3));
            return this.f52576m;
        }
        return this.f52576m;
    }
    ...
    public final ArrayList v() {
        if (!this.f52577n && !this.f52578o) {
            this.f52577n = true;
            ConnectionsManager.getInstance(this.f52566a).sendRequest(new TL_stars.TL_payments_getStarsGiveawayOptions(), new u4(this, 4));
            return this.f52579p;
        }
        return this.f52579p;
    }
    ...
    public final ArrayList z() {
        if (!this.h && !this.f52572i) {
            this.h = true;
            ConnectionsManager.getInstance(this.f52566a).sendRequest(new TL_stars.TL_payments_getStarsTopupOptions(), new u4(this, 2));
            return this.f52573j;
        }
        return this.f52573j;
    }
