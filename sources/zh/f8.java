...
public final class f8 extends AnimatorListenerAdapter {
    public final ah.h1 f51928a;
    public final View f51929b;
    public final bi.z0[] f51930c;
    public final boolean[] d;
    public final RectF f51931e;
    public final Runnable f51932f;
    public final n8 h;
    ...
    public f8(n8 n8Var, ah.h1 h1Var, View view, bi.z0[] z0VarArr, boolean[] zArr, RectF rectF, Runnable runnable) {
        ...
        this.f51928a = h1Var;
        this.f51929b = view;
        this.f51930c = z0VarArr;
        this.d = zArr;
        this.f51931e = rectF;
        this.f51932f = runnable;
    }
    ...
    public final void onAnimationEnd(Animator animator) {
        ...
        ah.h1 h1Var = this.f51928a;
        if (h1Var != null) {
            h1Var.f580l = true;
        }
        View view = this.f51929b;
        if (view != null) {
            view.invalidate();
        }
        bi.z0 z0Var = this.f51930c[0];
        if (z0Var != null) {
