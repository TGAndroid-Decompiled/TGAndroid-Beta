...
public final class f8 extends AnimatorListenerAdapter {
    public final ah.h1 f51897a;
    public final View f51898b;
    public final bi.z0[] f51899c;
    public final boolean[] d;
    public final RectF f51900e;
    public final Runnable f51901f;
    public final n8 h;
    ...
    public f8(n8 n8Var, ah.h1 h1Var, View view, bi.z0[] z0VarArr, boolean[] zArr, RectF rectF, Runnable runnable) {
        ...
        this.f51897a = h1Var;
        this.f51898b = view;
        this.f51899c = z0VarArr;
        this.d = zArr;
        this.f51900e = rectF;
        this.f51901f = runnable;
    }
    ...
    public final void onAnimationEnd(Animator animator) {
        ...
        ah.h1 h1Var = this.f51897a;
        if (h1Var != null) {
            h1Var.f568l = true;
        }
        View view = this.f51898b;
        if (view != null) {
            view.invalidate();
        }
        bi.z0 z0Var = this.f51899c[0];
        if (z0Var != null) {
