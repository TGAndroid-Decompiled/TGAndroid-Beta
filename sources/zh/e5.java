...
public final class e5 implements Utilities.Callback {
    public final s5 f51859a;
    public final long f51860b;
    public final int f51861c;
    public final boolean[] d;
    public final Utilities.Callback2 f51862e;
    public final Context f51863f;
    public final org.telegram.ui.ActionBar.f6 f51864g;
    ...
    public final void run(Object obj) {
        ...
        s5 s5Var = this.f51859a;
        long j3 = s5Var.f52601f.amount;
        long j10 = this.f51860b;
        boolean[] zArr = this.d;
        Utilities.Callback2 callback2 = this.f51862e;
        TLRPC.ChatInvite chatInvite = this.h;
        String str = this.f51865i;
        if (j3 < j10) {
            boolean starsPurchaseAvailable = MessagesController.getInstance(this.f51861c).starsPurchaseAvailable();
            Context context = this.f51863f;
            org.telegram.ui.ActionBar.f6 f6Var = this.f51864g;
