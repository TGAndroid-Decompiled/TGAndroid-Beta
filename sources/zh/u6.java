...
public final class u6 extends FrameLayout {
    public final Paint f48912a;
    public final Paint f48913b;
    public final TextView f48914c;
    ...
    public u6(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.f48913b = paint2;
        paint.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f18162q7, f6Var));
        paint2.setColor(-1);
        setWillNotDraw(false);
        TextView textView = new TextView(context);
        this.f48914c = textView;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        canvas.drawCircle(dp, height, AndroidUtilities.dp(10.0f), this.f48912a);
    ...
    public void set(TLRPC.TL_error tL_error) {
        TextView textView = this.f48914c;
