...
public final class v4 implements Utilities.Callback {
    ...
    public final void run(Object obj) {
        ...
        if (j3 < j10) {
            ...
            k7 k7Var = new k7(context, f6Var, j10, i11, this.h, new jb(s5Var, zArr2, messageObject, inputInvoice, tL_payments_paymentFormStars, zArr, i10, callback2, callback), this.f52724m);
