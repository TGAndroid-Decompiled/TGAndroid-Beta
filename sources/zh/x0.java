...
public final class x0 implements Utilities.Callback3 {
    ...
    public final NotificationCenter.NotificationCenterDelegate f52848b;

    public x0(NotificationCenter.NotificationCenterDelegate notificationCenterDelegate, int i10) {
        this.f52847a = i10;
        this.f52848b = notificationCenterDelegate;
    }
    ...
    public final void run(Object obj, Object obj2, Object obj3) {
        ...
        switch (this.f52847a) {
            case 0:
                ((w3) this.f52848b).o2((View) obj2, (CharSequence) obj, ((Boolean) obj3).booleanValue());
                return;
            case 1:
                w3.v0((w3) this.f52848b, (ArrayList) obj, (Utilities.Callback2) obj2, (Runnable) obj3);
                return;
            default:
                pc pcVar = (pc) this.f52848b;
