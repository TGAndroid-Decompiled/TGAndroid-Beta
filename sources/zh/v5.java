...
public final class v5 implements Runnable {
    ...
    public final org.telegram.ui.ActionBar.f3[] f52727b;
    public final TL_stars.StarsTransaction f52728c;
    public final long d;

    public v5(org.telegram.ui.ActionBar.f3[] f3VarArr, long j3, TL_stars.StarsTransaction starsTransaction) {
        this.f52726a = 2;
        this.f52727b = f3VarArr;
        this.d = j3;
        this.f52728c = starsTransaction;
    }
    ...
    public final void run() {
        switch (this.f52726a) {
            case 0:
                this.f52727b[0].dismiss();
                org.telegram.ui.ActionBar.n2 U = LaunchActivity.U();
                if (U != null) {
                    TL_stars.StarsTransaction starsTransaction = this.f52728c;
            ...
            case 1:
                ...
                if (U2 != null) {
                    TL_stars.StarsTransaction starsTransaction2 = this.f52728c;
            ...
            case 2:
                ...
                if (U3 != null) {
                    ...
                    bundle.putInt("message_id", this.f52728c.msg_id);
            ...
            case 3:
                ...
                if (U4 != null) {
                    TL_stars.StarsTransaction starsTransaction3 = this.f52728c;
            ...
            default:
                ...
                if (U5 != null) {
                    TL_stars.StarsTransaction starsTransaction4 = this.f52728c;
