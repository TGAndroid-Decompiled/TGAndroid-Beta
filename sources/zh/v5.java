...
public final class v5 implements Runnable {
    ...
    public final org.telegram.ui.ActionBar.f3[] f52758b;
    public final TL_stars.StarsTransaction f52759c;
    public final long d;

    public v5(org.telegram.ui.ActionBar.f3[] f3VarArr, long j3, TL_stars.StarsTransaction starsTransaction) {
        this.f52757a = 2;
        this.f52758b = f3VarArr;
        this.d = j3;
        this.f52759c = starsTransaction;
    }
    ...
    public final void run() {
        switch (this.f52757a) {
            case 0:
                this.f52758b[0].dismiss();
                org.telegram.ui.ActionBar.n2 U = LaunchActivity.U();
                if (U != null) {
                    TL_stars.StarsTransaction starsTransaction = this.f52759c;
            ...
            case 1:
                ...
                if (U2 != null) {
                    TL_stars.StarsTransaction starsTransaction2 = this.f52759c;
            ...
            case 2:
                ...
                if (U3 != null) {
                    ...
                    bundle.putInt("message_id", this.f52759c.msg_id);
            ...
            case 3:
                ...
                if (U4 != null) {
                    TL_stars.StarsTransaction starsTransaction3 = this.f52759c;
            ...
            default:
                ...
                if (U5 != null) {
                    TL_stars.StarsTransaction starsTransaction4 = this.f52759c;
