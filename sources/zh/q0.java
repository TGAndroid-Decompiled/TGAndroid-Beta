...
public final class q0 extends FrameLayout implements le.d {
    public final org.telegram.ui.ActionBar.f6 f52443a;
    public final FrameLayout f52444b;
    public final yh.e1 f52445c;
    public final x9 d;
    public final TextView f52446e;
    public final TextView f52447f;
    public Integer h;
    public TLRPC.Document f52448n;
    public final le.b f52449r;
    public boolean f52450s;
    public o0 v;

    public q0(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context);
        this.f52449r = new le.b(0, this, pr.h, 320L, false);
        this.f52443a = f6Var;
        FrameLayout frameLayout = new FrameLayout(context);
        this.f52444b = frameLayout;
    ...
    public static void a(q0 q0Var, TLRPC.Document document, int i10, Object obj, boolean z10) {
        ...
        if (document == null) {
            x9Var.b();
            q0Var.f52448n = null;
        } else if (q0Var.f52448n == document) {
        } else {
            q0Var.f52448n = document;
            TLRPC.PhotoSize closestPhotoSizeWithSize = FileLoader.getClosestPhotoSizeWithSize(document.thumbs, AndroidUtilities.dp(100.0f));
            SvgHelper.SvgDrawable svgThumb = DocumentObject.getSvgThumb(document, org.telegram.ui.ActionBar.j6.f20607a7, 0.3f);
    ...
    public final void b() {
        int d;
        yh.e1 e1Var = this.f52445c;
        e1Var.f50257x = null;
        Integer num = this.h;
        le.b bVar = this.f52449r;
        TextView textView = this.f52447f;
        if (num != null) {
            d = org.telegram.ui.ActionBar.j6.v(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20663d6, false), org.telegram.ui.ActionBar.j6.l1(AndroidUtilities.lerp(0.15f, 1.0f, bVar.f15368e), this.h.intValue()));
            e1Var.f50257x = this.h;
            this.f52444b.invalidate();
            textView.setTextColor(i0.a.d(bVar.f15368e, this.h.intValue(), -1));
        } else if (this.f52450s) {
            ...
            d = i0.a.d(0.5f, i0.a.k(this.v.f52358a.center_color, 255), i0.a.k(this.v.f52358a.pattern_color, 255));
            textView.setTextColor(-1);
        }
