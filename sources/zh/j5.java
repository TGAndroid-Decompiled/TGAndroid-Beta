...
public final class j5 implements k5 {
    ...
    public ArrayList f52137q;
    public boolean f52125c = false;
    public boolean f52126e = true;
    public boolean f52127f = false;
    public int f52128g = 783;
    public final ArrayList f52132l = new ArrayList();
    public int f52133m = -1;
    public long f52136p = 0;
    ...
    public final void a() {
        ...
        if (!this.f52129i && !this.f52130j) {
            ...
            this.f52129i = true;
            long j3 = this.f52136p;
            int i10 = 30;
            String str = "";
            int i11 = this.f52123a;
            if (j3 != 0) {
                TL_stars.getCraftStarGifts getcraftstargifts = new TL_stars.getCraftStarGifts();
                getcraftstargifts.gift_id = this.f52136p;
                if (!z10) {
                    str = this.f52131k;
                }
                ...
                getsavedstargifts2.sort_by_value = !this.f52126e;
                getsavedstargifts2.exclude_unupgradable = !TLObject.hasFlag(this.f52128g, 2);
                getsavedstargifts2.exclude_upgradable = !TLObject.hasFlag(this.f52128g, 4);
                getsavedstargifts2.exclude_unlimited = !TLObject.hasFlag(this.f52128g, 1);
                getsavedstargifts2.exclude_unique = !TLObject.hasFlag(this.f52128g, 8);
                getsavedstargifts2.exclude_saved = !TLObject.hasFlag(this.f52128g, 256);
                getsavedstargifts2.exclude_unsaved = !TLObject.hasFlag(this.f52128g, 512);
                getsavedstargifts2.peer_color_available = this.f52127f;
                long j10 = this.f52124b;
                if (j10 == 0) {
    ...
    public final int b(int i10) {
        if (!w3.O1(this.f52123a, this.f52124b)) {
            return -1;
        }
        int i11 = i10 + 1;
        while (true) {
            ArrayList arrayList = this.f52132l;
    ...
    @Override
    public final void d() {
        NotificationCenter.getInstance(this.f52123a).lambda$postNotificationNameOnUIThread$1(NotificationCenter.starUserGiftsLoaded, Long.valueOf(this.f52124b), this);
    }

    @Override
    public final int e() {
        return this.f52132l.size();
    }
    ...
    public final TL_stars.InputSavedStarGift g(TL_stars.SavedStarGift savedStarGift) {
        ...
        tL_inputSavedStarGiftChat.peer = MessagesController.getInstance(this.f52123a).getInputPeer(this.f52124b);
    ...
    public final ArrayList h() {
        ...
        int i10 = 0;
        while (true) {
            ArrayList arrayList2 = this.f52132l;
    ...
    public final void i(boolean z10) {
        if (this.f52133m != -1) {
            ConnectionsManager.getInstance(this.f52123a).cancelRequest(this.f52133m, true);
            this.f52133m = -1;
        }
        this.f52129i = false;
        this.f52132l.clear();
    ...
    public final int indexOf(Object obj) {
        return this.f52132l.indexOf(obj);
    }
    ...
    public final void j(ArrayList arrayList, TL_stars.StarGift starGift) {
        ...
        if (arrayList != null && !arrayList.isEmpty()) {
            ...
            while (i11 < size) {
                ...
                while (true) {
                    ...
                    if (i12 < arrayList2.size()) {
                        ...
                        if (starGift3 != null && starGift3.f20124id == starGift2.f20124id) {
                            arrayList2.remove(i12);
                            this.f52134n = Math.max(0, this.f52134n - 1);
                            z10 = true;
                            break;
                        }
                        i12++;
            ...
            if (z10) {
                NotificationCenter.getInstance(i10).lambda$postNotificationNameOnUIThread$1(NotificationCenter.starUserGiftsLoaded, Long.valueOf(this.f52124b), this);
            }
        }
        if (starGift != null) {
    ...
    public final void l() {
        boolean z10 = this.f52125c;
        int i10 = 0;
        long j3 = this.f52124b;
        int i11 = this.f52123a;
        if (z10) {
        ...
        if (savedStarGift != null) {
            ...
            if (contains) {
                if (!z10) {
                    ...
                    arrayList = this.f52132l;
                    arrayList.removeAll(h);
                    if (this.f52126e && !this.f52125c) {
