...
public final class g3 extends e3 {
    public final Paint f51974c;
    public final Matrix d;
    public final RadialGradient f51975e;
    public final int f51976f;
    public final int f51977g;
    public final int h;

    public g3(TL_stars.starGiftAttributeBackdrop stargiftattributebackdrop) {
        this.f51852a = stargiftattributebackdrop.name;
        this.f51853b = stargiftattributebackdrop.getRarityPermille();
        ...
        this.f51975e = radialGradient;
        paint.setShader(radialGradient);
        this.f51977g = stargiftattributebackdrop.text_color | (-16777216);
        int i10 = stargiftattributebackdrop.pattern_color;
        this.h = i10 | (-16777216);
        this.f51976f = i0.a.d(0.25f, stargiftattributebackdrop.edge_color | (-16777216), i10 | (-16777216));
    }
}
