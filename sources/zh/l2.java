...
public final class l2 extends FrameLayout {
    public final x9 f52185a;
    public final s2 f52186b;
    public final org.telegram.ui.Components.q6 f52187c;
    public TL_stars.starGiftAttributeBackdrop d;
    public TL_stars.starGiftAttributePattern f52188e;
    public float f52189f;
    ...
    public l2(Context context) {
        ...
        this.f52186b = s2Var;
        s2Var.f52562e = AndroidUtilities.dp(18.0f);
        s2Var.f52559a.setStrokeWidth(AndroidUtilities.dp(3.0f));
    ...
    public final void b(TL_stars.starGiftAttributePattern stargiftattributepattern) {
        this.d = null;
        this.f52188e = stargiftattributepattern;
        x9 x9Var = this.f52185a;
    ...
    public final void c(float f7, boolean z10) {
        this.f52189f = f7;
        s2 s2Var = this.f52186b;
        s2Var.d = f7;
        if (!z10) {
            s2Var.f52560b.d(f7, true);
        }
        s2Var.invalidate();
        this.f52187c.c(Math.round(f7 * 100.0f) + "%", z10, true);
    }
}
