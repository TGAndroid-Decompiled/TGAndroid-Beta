...
public final class l2 extends FrameLayout {
    public final x9 f52216a;
    public final s2 f52217b;
    public final org.telegram.ui.Components.q6 f52218c;
    public TL_stars.starGiftAttributeBackdrop d;
    public TL_stars.starGiftAttributePattern f52219e;
    ...
    public l2(Context context) {
        ...
        this.f52217b = s2Var;
        s2Var.f52593e = AndroidUtilities.dp(18.0f);
        s2Var.f52590a.setStrokeWidth(AndroidUtilities.dp(3.0f));
    ...
    public final void b(TL_stars.starGiftAttributePattern stargiftattributepattern) {
        this.d = null;
        this.f52219e = stargiftattributepattern;
        x9 x9Var = this.f52216a;
    ...
    public final void c(float f7, boolean z10) {
        this.f52220f = f7;
        s2 s2Var = this.f52217b;
        s2Var.d = f7;
        if (!z10) {
            s2Var.f52591b.d(f7, true);
        }
        s2Var.invalidate();
        this.f52218c.c(Math.round(f7 * 100.0f) + "%", z10, true);
    }
}
