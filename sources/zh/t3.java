...
public class t3 extends FrameLayout {
    ...
    public final org.telegram.ui.ActionBar.f6 f52647a;
    public com.google.android.gms.common.api.internal.r f52648a0;
    public final FrameLayout f52649b;
    public com.google.android.gms.common.api.internal.r f52650b0;
    public final m3 f52651c;
    public boolean f52652c0;
    public final x9[] d;
    public boolean f52653d0;
    public final TL_stars.starGiftAttributeModel[] f52654e;
    public float f52655e0;
    public final LinearLayout[] f52656f;
    public float f52657f0;
    public float f52658g0;
    public final FrameLayout.LayoutParams[] h;
    public ValueAnimator f52659h0;
    public final m2 f52660i0;
    public final Paint[] f52661j0;
    public final RadialGradient[] f52662k0;
    public final Matrix[] f52663l0;
    public RadialGradient m0;
    public final yh.i1 f52664n;
    public final Matrix f52665n0;
    public final Paint f52666o0;
    public final TL_stars.starGiftAttributePattern[] f52667p0;
    public final org.telegram.ui.Components.o5[] f52668q0;
    public final d90[] f52669r;
    public int f52670r0;
    public final d90 f52671s;
    public float f52672s0;
    public float f52673t0;
    public ValueAnimator f52674u0;
    public final TextView v;
    public final RectF f52675v0;
    public int f52676w;
    public h8 f52677w0;
    public final FrameLayout f52678x;
    public final int[] f52679x0;
    public final d90[] f52680y;
    public final int[] f52681y0;
    public final int[] f52682z0;
    ...
    public t3(Context context, org.telegram.ui.ActionBar.f6 f6Var, Runnable runnable, View.OnClickListener onClickListener, u0 u0Var, View.OnClickListener onClickListener2, View.OnClickListener onClickListener3, View.OnClickListener onClickListener4, View.OnClickListener onClickListener5, View.OnClickListener onClickListener6) {
        ...
        float f7;
        this.d = new x9[5];
        this.f52654e = new TL_stars.starGiftAttributeModel[3];
        this.f52656f = new LinearLayout[5];
        this.h = new FrameLayout.LayoutParams[5];
        this.f52669r = new d90[5];
        this.f52680y = new d90[5];
        this.E = new LinearLayout.LayoutParams[5];
        this.F = new yh.l0[5];
        this.U = new f4.d(0, 0);
        this.V = new TL_stars.starGiftAttributeBackdrop[3];
        this.f52660i0 = new m2(this, 4);
        this.f52661j0 = new Paint[3];
        this.f52662k0 = new RadialGradient[3];
        this.f52663l0 = new Matrix[3];
        this.f52665n0 = new Matrix();
        this.f52666o0 = new Paint(1);
        this.f52667p0 = new TL_stars.starGiftAttributePattern[2];
        this.f52668q0 = new org.telegram.ui.Components.o5[2];
        int i10 = 0;
        while (true) {
            Paint[] paintArr = this.f52661j0;
        ...
        int i11 = 0;
        while (true) {
            org.telegram.ui.Components.o5[] o5VarArr = this.f52668q0;
        ...
        this.f52673t0 = 1.0f;
        this.f52675v0 = new RectF();
        this.f52679x0 = new int[12];
        this.f52681y0 = new int[12];
        this.f52682z0 = new int[12];
        this.f52647a = f6Var;
        this.R = onClickListener4;
        this.S = onClickListener5;
        this.T = onClickListener6;
        setWillNotDraw(false);
        this.f52649b = new FrameLayout(context);
        int i12 = 0;
        while (true) {
            x9[] x9VarArr = this.d;
            float f10 = 0.0f;
            ...
            this.f52649b.addView(this.d[i12], w7.x5.e(-1, -1, 119));
            x9 x9Var = this.d[i12];
            if (i12 == 0) {
                f10 = 1.0f;
            }
        ...
        this.f52678x = new FrameLayout(context);
        int i14 = 0;
        while (true) {
            LinearLayout[] linearLayoutArr = this.f52656f;
            if (i14 >= linearLayoutArr.length) {
                break;
            }
            linearLayoutArr[i14] = new LinearLayout(context);
            this.f52656f[i14].setOrientation(1);
            if (i14 == 2) {
                FrameLayout frameLayout = new FrameLayout(context);
                this.J = frameLayout;
                this.f52656f[i14].addView(frameLayout, w7.x5.q(-1, 144, 119));
                ...
                this.f52669r[i14] = new d90(context, null);
                this.f52669r[i14].setTextColor(-1);
                this.f52669r[i14].setTextSize(1, 20.0f);
                this.f52669r[i14].setTypeface(AndroidUtilities.bold());
                this.f52669r[i14].setSingleLine();
                d90 d90Var2 = this.f52669r[i14];
                TextUtils.TruncateAt truncateAt = TextUtils.TruncateAt.END;
                d90Var2.setEllipsize(truncateAt);
                this.f52669r[i14].setGravity(17);
                frameLayout.addView(this.f52669r[i14], w7.x5.d(-1, -2.0f, 49, 16.0f, 95.33f, 16.0f, 0.0f));
                this.f52680y[i14] = new d90(context, null);
                this.f52680y[i14].setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20798j5, f6Var));
                this.f52680y[i14].setTextSize(1, 14.0f);
                this.f52680y[i14].setLinkTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.gc, f6Var));
                this.f52680y[i14].setLineSpacing(AndroidUtilities.dp(2.0f), 1.0f);
                this.f52680y[i14].setDisablePaddingsOffsetY(true);
                this.f52680y[i14].setSingleLine();
                this.f52680y[i14].setGravity(17);
                this.f52680y[i14].setEllipsize(truncateAt);
                frameLayout.addView(this.f52680y[i14], w7.x5.d(-1, -2.0f, 49, 16.0f, 122.0f, 16.0f, 0.0f));
            } else if (i14 == 4) {
                x2 x2Var = new x2(context, f6Var);
                this.L = x2Var;
                this.f52656f[i14].addView(x2Var, w7.x5.n(-1, -2));
                View view = this.f52656f[i14];
                ...
                this.f52669r[i14] = new d90(context, null);
                this.f52669r[i14].setTextColor(i14 == 3 ? -1 : org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20798j5, f6Var));
                this.f52669r[i14].setTextSize(1, 20.0f);
                this.f52669r[i14].setTypeface(AndroidUtilities.bold());
                this.f52669r[i14].setGravity(17);
                this.f52656f[i14].addView(this.f52669r[i14], w7.x5.t(-1, -2, 17, 24, i14 == 3 ? 10 : 0, 24, 0));
                if (i14 == 0) {
                    this.f52656f[i14].addView(this.f52671s, w7.x5.t(-2, -2, 17, 0, 4, 0, 4));
                    this.f52656f[i14].addView(this.v, w7.x5.s(-2, 17, 0, 6, 0, 19.33f, 2));
                }
                if (i14 == 0) {
                    this.f52680y[i14] = new d90(context, null);
                    this.f52680y[i14].setTextColor(i14 == 3 ? org.telegram.ui.ActionBar.j6.l1(0.75f, -1) : org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20798j5, f6Var));
                    this.f52680y[i14].setTextSize(1, 14.0f);
                    this.f52680y[i14].setGravity(17);
                    this.f52680y[i14].setLinkTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.gc, f6Var));
                    this.f52680y[i14].setLineSpacing(AndroidUtilities.dp(2.0f), 1.0f);
                    this.f52680y[i14].setDisablePaddingsOffsetY(true);
                    this.f52678x.addView(this.f52680y[i14], w7.x5.e(-2, -2, 17));
                    this.f52678x.addView(this.N, w7.x5.a(-2.0f, 20.33f, 17));
                    LinearLayout linearLayout = this.f52656f[i14];
                    FrameLayout frameLayout2 = this.f52678x;
                    ...
                    this.f52680y[i14].setLineSpacing(AndroidUtilities.dp(2.0f), 1.0f);
                    this.f52680y[i14].setDisablePaddingsOffsetY(true);
                    LinearLayout linearLayout2 = this.f52656f[i14];
                    d90 d90Var3 = this.f52680y[i14];
                ...
                this.f52656f[i14].addView(this.F[i14], w7.x5.t(-1, -2, 17, 24, 8, 24, 0));
            }
            if (i14 == 0) {
                this.f52656f[i14].addView(this.H, w7.x5.t(-1, -2, 7, 0, 15, 0, 0));
            }
            View view2 = this.f52656f[i14];
        ...
        addView(this.f52649b, w7.x5.d(160, 160.0f, 49, 0.0f, 8.0f, 0.0f, 0.0f));
        ...
        yh.k1 k1Var = i1Var.f50362a;
        if (k1Var.f50408f == null) {
            h8 h8Var = new h8(2, 12);
            k1Var.f50408f = h8Var;
            h8Var.h = 5.0f;
        }
        Path path = k1Var.f50406c;
        float f11 = k1Var.f50407e;
        k1Var.f50409g = true;
    ...
    public final void a() {
        ValueAnimator valueAnimator = this.f52674u0;
        if (valueAnimator != null) {
            valueAnimator.cancel();
            this.f52674u0 = null;
        }
        ValueAnimator ofFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
        this.f52674u0 = ofFloat;
        ofFloat.addUpdateListener(new q3(this, 1));
        this.f52674u0.addListener(new r3(this, 4));
        this.f52674u0.setDuration(320L);
        this.f52674u0.setInterpolator(pr.f29495g);
        this.f52674u0.start();
    }

    public final int b(Canvas canvas, float f7, float f10, float f11, float f12) {
        int i10 = this.f52670r0;
        RadialGradient[] radialGradientArr = this.f52662k0;
        TL_stars.starGiftAttributeBackdrop[] stargiftattributebackdropArr = this.V;
        Matrix[] matrixArr = this.f52663l0;
        Paint[] paintArr = this.f52661j0;
        int i11 = 0;
        if (i10 == 0) {
            if (this.f52672s0 > 0.0f && stargiftattributebackdropArr[2] != null) {
            ...
            if (this.f52672s0 < 1.0f && stargiftattributebackdropArr[1] != null) {
                paintArr[1].setAlpha((int) ((1.0f - this.f52672s0) * this.U.a(1) * 255.0f));
                matrixArr[1].reset();
        ...
        if (this.f52672s0 > 0.0f && stargiftattributebackdropArr[2] != null) {
            paintArr[2].setAlpha((int) (this.U.a(1) * 255.0f * this.f52672s0));
            matrixArr[2].reset();
            matrixArr[2].postTranslate(f7, f10);
            radialGradientArr[2].setLocalMatrix(matrixArr[2]);
            canvas.drawRect(0.0f, 0.0f, f11, f12, paintArr[2]);
    ...
    public final void c(Canvas canvas, float f7, float f10, float f11, float f12) {
        ...
        int d = i0.a.d(this.f52672s0, i10, i11);
        org.telegram.ui.Components.o5[] o5VarArr = this.f52668q0;
        o5VarArr[1].k(Integer.valueOf(d));
        j0.a(canvas, 0, o5VarArr[1], f11, f12, this.U.a(1), this.f52673t0);
        canvas.restore();
    }
    ...
    public void d(f4.d dVar) {
        ...
        int v02 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20798j5, this.f52647a);
        int i22 = 0;
        while (true) {
            d90VarArr = this.f52680y;
            if (i22 >= 2) {
                break;
            }
            d90 d90Var = this.f52669r[i22];
            ...
            if (i22 != 0 && i22 != 2) {
                ...
                i14 = i0.a.d(this.f52672s0, i15, i16);
            } else {
            ...
            if (z11) {
                ...
                if (i22 == 0) {
                    this.f52678x.setLayoutParams(layoutParamsArr2[i22]);
                } else {
        ...
        x9VarArr[1].setAlpha((1.0f - this.f52672s0) * dVar.a(1));
        x9VarArr[2].setAlpha(dVar.a(1) * this.f52672s0);
        float lerp3 = AndroidUtilities.lerp(1.0f, this.f52658g0, dVar.a(2));
        FrameLayout frameLayout = this.f52649b;
        frameLayout.setScaleX(lerp3);
        frameLayout.setScaleY(AndroidUtilities.lerp(1.0f, this.f52658g0, dVar.a(2)));
        frameLayout.setTranslationX(dVar.a(2) * this.f52655e0);
        frameLayout.setTranslationY((dVar.a(2) * this.f52657f0) + (dVar.a(1) * AndroidUtilities.dp(16.0f)));
        ...
        if (this.f52652c0 && this.U.b(0)) {
            i12 = 0;
        } else {
            i12 = 8;
        }
        yh.i1 i1Var = this.f52664n;
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        int[] iArr4 = this.f52682z0;
        int[] iArr5 = this.f52681y0;
        int[] iArr6 = this.f52679x0;
        if (stargiftattributebackdrop != null) {
        ...
        m3 m3Var2 = this.f52651c;
        if (m3Var2.f52292s == null && m3Var2.v == null && m3Var2.f52293w == null) {
            t3Var = this;
            f12 = f7;
            f11 = f10;
            iArr3 = iArr4;
            ...
            float f13 = f7;
            g3 g3Var = m3Var2.f52292s;
            float f14 = f10;
            float f15 = m3Var2.f52294x;
            int[] iArr7 = this.f52681y0;
            int[] iArr8 = this.f52679x0;
            int[] iArr9 = this.f52682z0;
            f11 = f14;
            iArr = iArr5;
            iArr2 = iArr6;
            iArr3 = iArr4;
            ...
            m3Var2.a(canvas2, m3Var2.v, m3Var2.f52295y, width2, realHeight, iArr7, iArr8, iArr9);
            m3Var2.a(canvas2, m3Var2.f52293w, m3Var2.E, width2, realHeight, iArr7, iArr8, iArr9);
            m3Var = m3Var2;
            t3Var.invalidate();
        }
        if (i10 > 0 && stargiftattributebackdropArr[0] != null) {
            ...
            org.telegram.ui.Components.o5[] o5VarArr = t3Var.f52668q0;
            if (max2 > 0.0f) {
                canvas2.save();
            ...
            if (t3Var.U.a(2) > 0.0f) {
                ...
                LinearLayout[] linearLayoutArr = t3Var.f52656f;
            ...
            if (textView != null && t3Var.f52676w != i14) {
                t3Var.f52676w = i14;
                textView.setTextColor(i14);
                org.telegram.ui.ActionBar.j6.B1(textView.getBackground(), i15, false);
            }
            if (m3Var.f52292s != null || m3Var.v != null || m3Var.f52293w != null) {
                t3Var.f52680y[0].setTextColor(i14);
            }
            if (t3Var.U.a(2) > 0.0f) {
                if (t3Var.f52677w0 == null) {
                    t3Var.f52677w0 = new h8(1, 12);
                }
                FrameLayout frameLayout2 = t3Var.f52649b;
                ...
                RectF rectF2 = t3Var.f52675v0;
                rectF2.set(measuredWidth - scaleX, measuredHeight - scaleY, measuredWidth + scaleX, f17);
                t3Var.f52677w0.g(rectF2);
                t3Var.f52677w0.d();
                t3Var.f52677w0.a(canvas2, org.telegram.ui.ActionBar.j6.l1(t3Var.U.a(2), -1));
                t3Var.invalidate();
            }
        }
        if (t3Var.U.a(1) > 0.0f) {
    ...
    public final void e(int i10, TL_stars.starGiftAttributeBackdrop stargiftattributebackdrop) {
        ...
        if (i10 == 0) {
            ...
            this.f52666o0.setShader(radialGradient2);
        }
        Matrix[] matrixArr = this.f52663l0;
        if (matrixArr[i10] == null) {
            matrixArr[i10] = new Matrix();
        }
        this.f52661j0[i10].setShader(radialGradientArr[i10]);
    }
    ...
    public final void f(TL_stars.StarGift starGift, boolean z10, boolean z11, boolean z12) {
        ...
        if (z15) {
            ...
            this.f52652c0 = starGift.crafted;
            this.f52664n.f50362a.d(stargiftattributebackdropArr[0], false, true);
        } else {
        ...
        this.f52654e[0] = (TL_stars.starGiftAttributeModel) s5.l(starGift.attributes, TL_stars.starGiftAttributeModel.class);
        d(this.U);
    }

    public final void g(int i10, TL_stars.starGiftAttributePattern stargiftattributepattern, boolean z10) {
        if (stargiftattributepattern != null) {
            TL_stars.starGiftAttributePattern[] stargiftattributepatternArr = this.f52667p0;
            if (stargiftattributepatternArr[i10] != stargiftattributepattern) {
                stargiftattributepatternArr[i10] = stargiftattributepattern;
                this.f52668q0[i10].i(stargiftattributepattern.document, z10);
            }
        }
    }
    ...
    public TL_stars.starGiftAttributeModel getUpgradeImageViewAttribute() {
        float f7 = this.f52672s0;
        TL_stars.starGiftAttributeModel[] stargiftattributemodelArr = this.f52654e;
        if (f7 > 0.5f) {
    ...
    public final void h(int i10, CharSequence charSequence, CharSequence charSequence2, SpannableStringBuilder spannableStringBuilder, CharSequence charSequence3, TLObject tLObject, Spannable spannable) {
        int i11;
        int i12;
        this.f52669r[i10].setText(charSequence);
        FrameLayout frameLayout = this.f52678x;
        d90[] d90VarArr = this.f52680y;
        d90 d90Var = this.f52671s;
    ...
    public final void k() {
        this.f52658g0 = AndroidUtilities.dpf2(33.33f) / AndroidUtilities.dpf2(160.0f);
        FrameLayout frameLayout = this.f52649b;
        d90[] d90VarArr = this.f52669r;
        this.f52655e0 = ((((Math.min(d90VarArr[2].getPaint().measureText(d90VarArr[2].getText().toString()), d90VarArr[2].getWidth()) + d90VarArr[2].getWidth()) / 2.0f) + (d90VarArr[2].getX() + (-frameLayout.getLeft()))) + AndroidUtilities.dp(24.0f)) - (AndroidUtilities.dp(126.67f) / 2.0f);
        this.f52657f0 = (AndroidUtilities.dp(124.0f) + (-frameLayout.getTop())) - (AndroidUtilities.dp(126.67f) / 2.0f);
    }
    ...
    public final void onDetachedFromWindow() {
        ...
        o5VarArr[0].b();
        o5VarArr[1].b();
        AndroidUtilities.cancelRunOnUIThread(this.f52660i0);
    }
    ...
    public void setPreviewAttributes(o0 o0Var) {
        ...
        if (dVar != null && dVar.f9285b == 1 && isAttachedToWindow()) {
            AndroidUtilities.cancelRunOnUIThread(this.f52660i0);
            ValueAnimator valueAnimator = this.f52659h0;
            if (valueAnimator != null) {
                valueAnimator.cancel();
                this.f52659h0 = null;
            }
            int i10 = 1 - this.f52670r0;
            this.f52670r0 = i10;
            x9[] x9VarArr = this.d;
            xi0 lottieAnimation = x9VarArr[2 - i10].getImageReceiver().getLottieAnimation();
            xi0 lottieAnimation2 = x9VarArr[this.f52670r0 + 1].getImageReceiver().getLottieAnimation();
            if (lottieAnimation2 != null && lottieAnimation != null) {
                lottieAnimation2.Q(lottieAnimation.r(), false);
            }
            int i11 = this.f52670r0 + 1;
            TL_stars.starGiftAttributeBackdrop stargiftattributebackdrop = o0Var.f52390a;
            this.V[i11] = stargiftattributebackdrop;
            e(i11, stargiftattributebackdrop);
            g(1, o0Var.f52391b, true);
            int i12 = this.f52670r0 + 1;
            TL_stars.starGiftAttributeModel stargiftattributemodel = o0Var.f52392c;
            TL_stars.starGiftAttributeModel[] stargiftattributemodelArr = this.f52654e;
            stargiftattributemodelArr[i12] = stargiftattributemodel;
            v7.Z0(x9VarArr[i12].getImageReceiver(), stargiftattributemodelArr[this.f52670r0 + 1].document, 160);
            a();
            float f7 = this.f52670r0;
            ValueAnimator ofFloat = ValueAnimator.ofFloat(1.0f - f7, f7);
            this.f52659h0 = ofFloat;
            ofFloat.addUpdateListener(new q3(this, 0));
            this.f52659h0.addListener(new r3(this, 3));
            this.f52659h0.setDuration(320L);
            this.f52659h0.setInterpolator(pr.h);
            this.f52659h0.start();
        }
    }
    ...
    public void setPreviewingAttributes(ArrayList<TL_stars.StarGiftAttribute> arrayList) {
        ...
        this.f52648a0 = new com.google.android.gms.common.api.internal.r(s5.m(arrayList, TL_stars.starGiftAttributePattern.class));
        this.f52650b0 = new com.google.android.gms.common.api.internal.r(s5.m(arrayList, TL_stars.starGiftAttributeBackdrop.class));
        this.f52680y[1].setTextSize(1, 14.0f);
        this.H.setVisibility(8);
        this.f52672s0 = 0.0f;
        this.f52670r0 = 0;
        g(1, (TL_stars.starGiftAttributePattern) this.f52648a0.c(), true);
        TL_stars.starGiftAttributeModel[] stargiftattributemodelArr = this.f52654e;
        ...
        TL_stars.starGiftAttributeBackdrop stargiftattributebackdrop = (TL_stars.starGiftAttributeBackdrop) this.f52650b0.c();
    ...
    public void setWearPreview(TLObject tLObject) {
        ...
        this.f52669r[2].setText(str2);
        this.f52680y[2].setText(str);
        k();
        d(this.U);
    }
