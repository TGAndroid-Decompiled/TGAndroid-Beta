...
public final class a4 extends View {
    ...
    public final int[] K;
    public final co f51709a;
    public org.telegram.ui.Cells.a0 f51710b;
    public int f51711c;
    public final int[] d;
    public final int[] f51712e;
    public final RectF f51713f;
    public final RectF h;
    public final Paint f51714n;
    public boolean f51715r;
    public final org.telegram.ui.Components.e6 f51716s;
    public final org.telegram.ui.Components.p6 v;
    public boolean f51717w;
    public final ug.r f51718x;
    public float f51719y;

    public a4(co coVar) {
        super(coVar.getParentActivity());
        this.d = new int[2];
        this.f51712e = new int[2];
        this.f51713f = new RectF();
        this.h = new RectF();
        this.f51714n = new Paint();
        new Paint();
        this.f51716s = new org.telegram.ui.Components.e6(this, 0L, 420L, pr.h);
        ...
        this.f51718x = new ug.r(26, this, coVar);
    }

    private MessageObject getMessageObject() {
        org.telegram.ui.Cells.a0 a0Var = this.f51710b;
    ...
    public final void a() {
        ...
        if (getMessageObject() != null) {
            ...
            co coVar = this.f51709a;
            s5 y3 = s5.y(coVar.getCurrentAccount(), false);
            long E = y3.E(messageObject);
            if (y3.f52600e && y3.q(false, false, null).amount < E) {
    ...
    public final void b(float f7, z3 z3Var) {
        ...
        ValueAnimator ofFloat = ValueAnimator.ofFloat(this.f51719y, f7);
        this.E = ofFloat;
        ...
        if (this.f51710b != null && !this.I) {
            ...
            if (messageObject != null && reactionsLayoutInBubble != null) {
                ...
                if (z10) {
                    ...
                    s5.y(coVar.getCurrentAccount(), false).d0(messageObject, this.f51709a, 1L, true, false, null);
                }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (this.f51710b == null || this.I || (reactionsLayoutInBubble = getReactionsLayoutInBubble()) == null) {
            return false;
        }
        int action = motionEvent.getAction();
        ug.r rVar = this.f51718x;
        if (action == 0) {
    ...
    public void setMessageCell(org.telegram.ui.Cells.a0 a0Var) {
        ...
        this.f51711c = id2;
        org.telegram.ui.Cells.a0 a0Var3 = this.f51710b;
        if (a0Var3 instanceof org.telegram.ui.Cells.t1) {
            a0Var3.invalidate();
            ((org.telegram.ui.Cells.t1) this.f51710b).setInvalidateListener(new z3(this, 1));
        } else if (a0Var3 instanceof org.telegram.ui.Cells.w0) {
            a0Var3.invalidate();
            ((org.telegram.ui.Cells.w0) this.f51710b).setInvalidateListener(new z3(this, 1));
        }
        invalidate();
    }
}
