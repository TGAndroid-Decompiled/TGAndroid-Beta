...
public final class u implements Runnable {
    ...
    public final Object f52706b;
    public final Object f52707c;
    public final Object d;
    public final Object f52708e;
    ...
    public final void run() {
        ...
        xo0 xo0Var3 = null;
        Object obj = this.f52706b;
        Object obj2 = this.f52709f;
        Object obj3 = this.f52708e;
        Object obj4 = this.d;
        Object obj5 = this.f52707c;
        int i13 = 0;
        switch (i12) {
            case 0:
                a0 a0Var = (a0) obj5;
                ...
                if (U != null) {
                    if (updates != null) {
                        qc M = yc.a0(U).M(LocaleController.getString(R.string.GiftOfferSentTitle), AndroidUtilities.replaceTags(LocaleController.formatString(R.string.GiftOfferSentText, a0Var.Z, DialogObject.getShortName(a0Var.f51678a0))), R.raw.forward);
                        M.f29717t = true;
                        M.j();
                        return;
                    }
            ...
            case 1:
                ...
                if (tLObject instanceof TLRPC.PaymentForm) {
                    ...
                    MessagesController.getInstance(s5Var.f52598a).putUsers(paymentForm.users, false);
            ...
            case 2:
                ...
                if (tLObject2 instanceof TLRPC.PaymentForm) {
                    ...
                    MessagesController.getInstance(s5Var2.f52598a).putUsers(paymentForm2.users, false);
            ...
            case 6:
                ...
                if (tLObject4 instanceof TLRPC.PaymentForm) {
                    ...
                    MessagesController.getInstance(s5Var3.f52598a).putUsers(paymentForm3.users, false);
            ...
            default:
                ...
                tL_inputStorePaymentStarsTopup.currency = a2.f4437c;
                tL_inputStorePaymentStarsTopup.amount = (long) (Math.pow(10.0d, BillingController.getInstance().getCurrencyExp(tL_starsTopupOption.currency)) * (a2.f4436b / Math.pow(10.0d, 6.0d)));
                BillingController.getInstance().addResultListener(oVar.f4449c, new di.e5(callback22, 6));
    ...
    public u(s5 s5Var, TLRPC.TL_error tL_error, Utilities.Callback2 callback2, TLObject tLObject, TLRPC.TL_inputInvoiceStars tL_inputInvoiceStars, int i10) {
        this.f52705a = i10;
        this.f52707c = s5Var;
        this.f52706b = tL_error;
        this.d = callback2;
        this.f52708e = tLObject;
        this.f52709f = tL_inputInvoiceStars;
    }
    ...
    public u(s5 s5Var, org.telegram.ui.ActionBar.b2 b2Var, TLObject tLObject, TL_stars.InputSavedStarGift inputSavedStarGift, Utilities.Callback callback) {
        ...
        this.f52708e = b2Var;
        this.d = tLObject;
        this.f52709f = inputSavedStarGift;
        this.f52706b = callback;
    }
}
