...
public class h extends o6.a {
    ...
    public final boolean equals(Object obj) {
        ...
        h hVar = (h) obj;
        if (this.f12940a == hVar.f12940a && l.l(this.f12941b, hVar.f12941b)) {
            return true;
        }
        return false;
    }
    ...
    public final int hashCode() {
        return Arrays.hashCode(new Object[]{Integer.valueOf(this.f12940a), this.f12941b});
    }

    public String toString() {
        return "[PatternItem: type=" + this.f12940a + " length=" + this.f12941b + "]";
    }
