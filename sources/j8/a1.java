...
public final class a1 {
    ...
    public final boolean b() {
        ...
        try {
            packageInfoB = h6.b.a(context).b(64, "com.google.android.wearable.app.cn");
        ...
        if (v5.g.a(context)) {
            return c(packageInfoB, true);
        }
        boolean zC = c(packageInfoB, false);
        if (zC || !c(packageInfoB, true)) {
            return zC;
        }
