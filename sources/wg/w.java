...
public final class w extends FrameLayout {
    public final RadioButton f48563a;
    public final Drawable f48564b;
    public final Drawable f48565c;
    public final q6 d;
    public final q6 f48566e;
    public final TextView f48567f;
    public final SpannableString h;
    public final SpannableString f48568n;
    public TL_stars.TL_starsGiveawayOption f48569r;
    public int f48570s;
    public final e6 v;
    ...
    public w(Context context, f6 f6Var) {
        ...
        this.f48564b = mutate;
        mutate.setColorFilter(new PorterDuffColorFilter(j6.v0(j6.f20735h5, f6Var), PorterDuff.Mode.SRC_IN));
        this.f48565c = context.getResources().getDrawable(R.drawable.star_small_inner).mutate();
    ...
    public final void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        float d = this.v.d(this.f48570s, false);
        ...
        for (int ceil = ((int) Math.ceil(d)) - 1; ceil >= 0; ceil--) {
            ...
            int i12 = (int) (f7 + dp);
            int i13 = (int) (dp5 + dp2);
            Drawable drawable = this.f48564b;
            drawable.setBounds(i10, i11, i12, i13);
            int i14 = (int) (clamp * 255.0f);
            drawable.setAlpha(i14);
            drawable.draw(canvas);
            Drawable drawable2 = this.f48565c;
