...
public final class w extends FrameLayout {
    public final RadioButton f48592a;
    public final Drawable f48593b;
    public final Drawable f48594c;
    public final q6 d;
    public final q6 f48595e;
    public final TextView f48596f;
    public final SpannableString h;
    public final SpannableString f48597n;
    public TL_stars.TL_starsGiveawayOption f48598r;
    public int f48599s;
    public final e6 v;
    ...
    public w(Context context, f6 f6Var) {
        ...
        this.f48593b = mutate;
        mutate.setColorFilter(new PorterDuffColorFilter(j6.v0(j6.f20762h5, f6Var), PorterDuff.Mode.SRC_IN));
        this.f48594c = context.getResources().getDrawable(R.drawable.star_small_inner).mutate();
    ...
    public final void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        float d = this.v.d(this.f48599s, false);
        ...
        for (int ceil = ((int) Math.ceil(d)) - 1; ceil >= 0; ceil--) {
            ...
            Drawable drawable2 = this.f48594c;
