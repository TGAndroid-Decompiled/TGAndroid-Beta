...
public class e extends FrameLayout implements xd.b {
    ...
    public final View.OnClickListener[] f46555b;
    public final te[] f46556c;
    public d d;
    public final FrameLayout e;
    public final HashSet f46557f;
    public final f6 h;
    public final ng.a f46558n;
    public final qg.a f46559r;
    public pg.b f46560s;
    public final xd.a v;
    public final xd.a f46561w;
    ...
    public e(Context context, ng.a aVar, f6 f6Var, qg.a aVar2) {
        super(context);
        this.f46554a = new o[5];
        this.f46555b = new View.OnClickListener[5];
        this.f46556c = new te[5];
        this.f46557f = new HashSet();
        nr nrVar = nr.h;
        this.v = new xd.a(99, this, nrVar, 320L, false);
        this.f46561w = new xd.a(100, this, nrVar, 320L, false);
        this.C = new Paint(1);
        this.D = 0;
        this.f46558n = aVar;
        this.f46559r = aVar2;
    ...
    public final void a() {
        ...
        for (o oVar : oVarArr) {
            if (oVar != null) {
                vg.a aVar = (vg.a) oVar.f318b;
                float f11 = ((xd.a) oVar.f319c).e * this.f46562x;
                if (f11 > 0.0f) {
                    i10 = 0;
                } else {
                    i10 = 8;
        ...
        if (oVar2 != null) {
            float dp = ((xd.a) oVar2.f319c).e * AndroidUtilities.dp(54.0f);
            ((vg.a) oVar2.f318b).setTranslationX(AndroidUtilities.dp(1.0f) + this.f46563y);
            this.f46563y += dp;
        }
        int i11 = 0;
        while (true) {
            ...
            if (oVar3 != null) {
                vg.a aVar2 = (vg.a) oVar3.f318b;
                float dp2 = ((xd.a) oVar3.f319c).e * AndroidUtilities.dp(54.0f);
                aVar2.setTranslationX(((getMeasuredWidth() - aVar2.getMeasuredWidth()) - AndroidUtilities.dp(1.0f)) - this.B);
                this.B += dp2;
            }
            i11++;
        }
        if (this.f46562x < 1.0f) {
            o oVar4 = oVarArr[iArr2[0]];
            if (oVar4 != null) {
                vg.a aVar3 = (vg.a) oVar4.f318b;
                aVar3.setTranslationX(aVar3.getTranslationX() - ((1.0f - this.f46562x) * this.f46563y));
            }
            for (int i12 = 0; i12 < 4; i12++) {
                o oVar5 = oVarArr[iArr[i12]];
                if (oVar5 != null) {
                    vg.a aVar4 = (vg.a) oVar5.f318b;
                    aVar4.setTranslationX(((1.0f - this.f46562x) * this.B) + aVar4.getTranslationX());
                }
            }
            float f12 = this.f46563y;
            float f13 = this.f46562x;
            this.f46563y = f12 * f13;
            this.B *= f13;
        }
        float f14 = this.f46561w.e;
        if (f14 > 0.0f && getMeasuredWidth() > 0) {
            float measuredWidth = getMeasuredWidth();
            for (int i13 = 0; i13 < getContainer().getChildCount(); i13++) {
                if (this.f46557f.contains(getContainer().getChildAt(i13))) {
            ...
            this.f46563y = AndroidUtilities.lerp(this.f46563y, measuredWidth - AndroidUtilities.dp(3.33f), f14);
            this.B = AndroidUtilities.lerp(this.B, (getMeasuredWidth() - f10) - AndroidUtilities.dp(17.66f), f14);
        }
        d dVar = this.d;
        if (dVar != null) {
            float f15 = this.f46563y;
            float f16 = this.B;
            ug.f fVar = ((te) dVar).f38643b.P;
            fVar.f45526x = f15;
            fVar.f45527y = f16;
            fVar.invalidate();
        }
        ...
        if (i10 >= 0) {
            ...
            if (i10 < oVarArr.length && ((objArr = oVarArr[i10]) != 0 || z4)) {
                if (objArr == 0) {
                    ...
                    vg.a d = vg.a.d(getContext(), this.f46558n, this.f46559r, this.h, E[i10], 48);
                    if (i10 == 1) {
                ...
                ((xd.a) oVarArr[i10].f319c).a(z4, z10);
            }
        }
    }
    ...
    public final void d(boolean z4) {
        ...
        if (getVisibility() == 0 && getContainer().getVisibility() == 0) {
            ...
            for (int i10 = 0; i10 < getContainer().getChildCount(); i10++) {
                ...
                if (this.f46557f.contains(childAt) && childAt.getVisibility() == 0) {
                    z11 = true;
                }
            }
            z10 = z11;
        }
        this.f46561w.a(z10, z4);
    }

    @Override
    public final void dispatchDraw(Canvas canvas) {
        int i10 = (int) (this.f46562x * 255.0f * this.v.e);
        if (i10 > 0) {
            ...
            RectF rectF = H;
            rectF.set(this.f46563y + AndroidUtilities.dp(10.0f), AndroidUtilities.dp(9.0f), measuredWidth, measuredHeight);
            int i11 = this.D;
            Paint paint = this.C;
            paint.setColor(i11);
            paint.setAlpha(i10);
    ...
    public final boolean drawChild(Canvas canvas, View view, long j10) {
        if (view == this.e && this.f46560s != null) {
            RectF rectF = H;
            rectF.set(this.f46563y + AndroidUtilities.dp(1.0f), 0.0f, (getMeasuredWidth() - AndroidUtilities.dp(1.0f)) - this.B, getMeasuredHeight());
            Rect rect = AndroidUtilities.rectTmp2;
            rectF.round(rect);
            this.f46560s.setBounds(rect);
            this.f46560s.draw(canvas);
        }
    ...
    public final void z(float f10, int i10) {
        ...
        if (i11 >= 0) {
            o[] oVarArr = this.f46554a;
            if (i11 < oVarArr.length && (oVar = oVarArr[i11]) != null && i12 == 1 && ((xd.a) oVar.f319c).f46893f) {
                te teVar = this.f46556c[i11];
                if (teVar != null) {
                    final vg.a aVar = (vg.a) oVar.f318b;
                    boolean z4 = oVar.f317a;
                    int i13 = teVar.f38642a;
                    final xn xnVar = teVar.f38643b;
                    switch (i13) {
                        case 24:
                                        ...
                                        switch (r3) {
                                            case 0:
                                                ...
                                                if (xnVar2.getParentActivity() != null) {
                                                    ...
                                                    f3Var4.f41617i0 = new lf(xnVar2, 21);
                                                    f3Var4.v();
                                                    org.telegram.ui.Components.l40.f26545f.b();
                                                    return;
                                                }
                                                return;
                                            default:
                                                ...
                                                if (xnVar3.getParentActivity() != null) {
                                                    ...
                                                    f3Var6.f41617i0 = new ng(xnVar3, 0);
                                                    f3Var6.v();
                            ...
                            break;
                        default:
                            if (xnVar.I0 == null && !z4 && l40.f26545f.c()) {
                                AndroidUtilities.runOnUIThread(new Runnable() {
                                    @Override
                                    public final void run() {
                                        switch (r3) {
