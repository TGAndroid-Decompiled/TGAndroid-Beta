...
public final class f extends View implements a6 {
    ...
    public final void a() {
        this.f46633a.setBounds(0, 0, getMeasuredWidth(), this.f46635c);
        this.f46634b.setBounds(0, getMeasuredHeight() - this.d, getMeasuredWidth(), getMeasuredHeight());
    }
    ...
    public final void e() {
        int i10;
        sg.c cVar = this.e;
        if (cVar != null && (i10 = this.f46636f) != -1) {
    ...
    public final void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        this.f46633a.draw(canvas);
        this.f46634b.draw(canvas);
    }
    ...
    public void setIgnoreFastWay(boolean z4) {
        this.f46633a.f14965p = z4;
        this.f46634b.f14965p = z4;
    }
