...
public final class r extends FrameLayout {
    public final eg0 f48577a;
    public final o f48578b;
    public final TextView f48579c;
    public final d90 d;
    public final f6 f48580e;
    public final a90 f48581f;
    public final Paint[] h;
    public ValueAnimator f48582n;
    ...
    public r(Context context, f6 f6Var) {
        ...
        int i10 = j6.Mj;
        canvas.drawColor(i0.a.d(0.5f, j6.v0(i10, f6Var), j6.v0(j6.f20762h5, f6Var)));
        ...
        this.h = new Paint[20];
        a(0.0f);
        y1 y1Var = oVar.f46405a;
        y1Var.f46387q = false;
        y1Var.K = false;
        y1Var.L = true;
        y1Var.H = true;
        y1Var.f46382l = new a8(this, 4);
        y1Var.c();
        eg0Var.setStarParticlesView(oVar);
        TextView textView = new TextView(context);
        this.f48579c = textView;
    ...
    public void setBoostViaGifsText(TLRPC.Chat chat) {
        ...
        this.f48579c.setText(LocaleController.formatString("BoostingBoostsViaGifts", R.string.BoostingBoostsViaGifts, new Object[0]));
        ...
        d90Var.setTextColor(j6.v0(j6.f20943r5, f6Var));
    }

    public void setPaused(boolean z10) {
        this.f48577a.setPaused(z10);
        this.f48578b.setPaused(z10);
    }

    public void setStars(final boolean z10) {
        final float f7;
        ValueAnimator valueAnimator = this.f48582n;
        if (valueAnimator != null) {
            valueAnimator.cancel();
        }
        eg0 eg0Var = this.f48577a;
        final float f10 = eg0Var.f46548b.f46523i;
        if (z10) {
            f7 = 1.0f;
        } else {
            f7 = 0.0f;
        }
        this.f48582n = ValueAnimator.ofFloat(0.0f, 1.0f);
        final float[] fArr = {0.0f};
        AndroidUtilities.cancelRunOnUIThread(eg0Var.U);
        eg0Var.d();
        eg0Var.i();
        this.f48582n.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            @Override
            public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                ...
                fArr2[0] = floatValue;
                r rVar = r.this;
                eg0 eg0Var2 = rVar.f48577a;
                eg0Var2.f46548b.f46523i = AndroidUtilities.lerp(f10, f7, floatValue);
                tg.a aVar = eg0Var2.f46548b;
                float f12 = aVar.f46521f;
                ...
                aVar.f46521f = (f13 * i10) + f12;
                aVar.b();
                rVar.a(eg0Var2.f46548b.f46523i);
            }
        });
        this.f48582n.addListener(new q(this, fArr, f10, f7, z10));
        this.f48582n.setDuration(680L);
        this.f48582n.setInterpolator(pr.h);
        this.f48582n.start();
    }
}
