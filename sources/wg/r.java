...
public final class r extends FrameLayout {
    public final eg0 f48548a;
    public final o f48549b;
    public final TextView f48550c;
    public final d90 d;
    public final f6 f48551e;
    public final a90 f48552f;
    public final Paint[] h;
    public ValueAnimator f48553n;
    ...
    public r(Context context, f6 f6Var) {
        ...
        int i10 = j6.Mj;
        canvas.drawColor(i0.a.d(0.5f, j6.v0(i10, f6Var), j6.v0(j6.f20735h5, f6Var)));
        ...
        this.h = new Paint[20];
        a(0.0f);
        y1 y1Var = oVar.f46377a;
        y1Var.f46359q = false;
        y1Var.K = false;
        y1Var.L = true;
        y1Var.H = true;
        y1Var.f46354l = new a8(this, 4);
        y1Var.c();
        eg0Var.setStarParticlesView(oVar);
        TextView textView = new TextView(context);
        this.f48550c = textView;
    ...
    public void setBoostViaGifsText(TLRPC.Chat chat) {
        ...
        this.f48550c.setText(LocaleController.formatString("BoostingBoostsViaGifts", R.string.BoostingBoostsViaGifts, new Object[0]));
        ...
        d90Var.setTextColor(j6.v0(j6.f20916r5, f6Var));
    }

    public void setPaused(boolean z10) {
        this.f48548a.setPaused(z10);
        this.f48549b.setPaused(z10);
    }

    public void setStars(final boolean z10) {
        final float f7;
        ValueAnimator valueAnimator = this.f48553n;
        if (valueAnimator != null) {
            valueAnimator.cancel();
        }
        eg0 eg0Var = this.f48548a;
        final float f10 = eg0Var.f46520b.f46495i;
        if (z10) {
            f7 = 1.0f;
        } else {
            f7 = 0.0f;
        }
        this.f48553n = ValueAnimator.ofFloat(0.0f, 1.0f);
        final float[] fArr = {0.0f};
        AndroidUtilities.cancelRunOnUIThread(eg0Var.U);
        eg0Var.d();
        eg0Var.i();
        this.f48553n.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            @Override
            public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                ...
                fArr2[0] = floatValue;
                r rVar = r.this;
                eg0 eg0Var2 = rVar.f48548a;
                eg0Var2.f46520b.f46495i = AndroidUtilities.lerp(f10, f7, floatValue);
                tg.a aVar = eg0Var2.f46520b;
                float f12 = aVar.f46493f;
                ...
                aVar.f46493f = (f13 * i10) + f12;
                aVar.b();
                rVar.a(eg0Var2.f46520b.f46495i);
            }
        });
        this.f48553n.addListener(new q(this, fArr, f10, f7, z10));
        this.f48553n.setDuration(680L);
        this.f48553n.setInterpolator(pr.h);
        this.f48553n.start();
    }
}
