...
public final class b implements Runnable {
    ...
    public final MessageObject f45325c;
    ...
    public final void run() {
        switch (this.f45323a) {
            case 0:
                AndroidUtilities.runOnUIThread(new b(this.f45324b, this.f45325c, this.d, 1));
                return;
            default:
                u1 u1Var = this.f45324b.f45328c;
                long dialogId = this.f45325c.getDialogId();
