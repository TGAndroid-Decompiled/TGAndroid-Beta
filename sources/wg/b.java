...
public final class b implements Runnable {
    ...
    public final MessageObject f45044c;
    ...
    public final void run() {
        switch (this.f45042a) {
            case 0:
                AndroidUtilities.runOnUIThread(new b(this.f45043b, this.f45044c, this.d, 1));
                return;
            default:
                t1 t1Var = this.f45043b.f45047c;
                long dialogId = this.f45044c.getDialogId();
