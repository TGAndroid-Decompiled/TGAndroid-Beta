...
public final class b implements Runnable {
    ...
    public final c f45070b;
    public final MessageObject f45071c;
    ...
    public final void run() {
        switch (this.f45069a) {
            case 0:
                AndroidUtilities.runOnUIThread(new b(this.f45070b, this.f45071c, this.d, 1));
                return;
            default:
                t1 t1Var = this.f45070b.f45074c;
                long dialogId = this.f45071c.getDialogId();
