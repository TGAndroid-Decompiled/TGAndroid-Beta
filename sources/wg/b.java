...
public final class b implements Runnable {
    ...
    public final c f45075b;
    public final MessageObject f45076c;
    ...
    public final void run() {
        switch (this.f45074a) {
            case 0:
                AndroidUtilities.runOnUIThread(new b(this.f45075b, this.f45076c, this.d, 1));
                return;
            default:
                t1 t1Var = this.f45075b.f45079c;
                long dialogId = this.f45076c.getDialogId();
