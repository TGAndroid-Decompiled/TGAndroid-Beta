...
public final class g extends FrameLayout implements xd.b {
    public static final int[] f46568s;
    public final String[] f46569a;
    public final f6 f46570b;
    public final qg.a f46571c;
    public final ng.a d;
    public final m[] e;
    public final i[] f46572f;
    public a h;
    public b f46573n;
    public int f46574r;
    ...
    static {
        ...
        f46568s = new int[]{i10, i11, R.drawable.mentionbutton, R.drawable.reactionbutton, R.drawable.menu_poll_notify, i11, i11};
    }

    public g(Context context, f6 f6Var, qg.b bVar, ng.a aVar) {
        super(context);
        this.f46569a = new String[]{LocaleController.getString(R.string.AttachMenu), LocaleController.getString(R.string.AccDescrPageDown), LocaleController.getString(R.string.AccDescrMentionDown), LocaleController.getString(R.string.AccDescrReactionMentionDown), LocaleController.getString(R.string.AccDescrPollVotesMentionDown), LocaleController.getString(R.string.AccDescrSearchPrev), LocaleController.getString(R.string.AccDescrSearchNext)};
        this.e = new m[7];
        this.f46572f = new i[7];
        this.f46574r = 83;
        this.d = aVar;
        this.f46571c = bVar;
        this.f46570b = f6Var;
    ...
    public final void a() {
        ...
        while (true) {
            ...
            if (i11 < mVarArr.length) {
                m mVar = mVarArr[i11];
                if (mVar != null) {
                    vg.b bVar = (vg.b) mVar.f44088b;
                    float f11 = ((xd.a) mVar.f44089c).e;
    ...
    public final void e(int i10, boolean z4, boolean z10) {
        ...
        if (mVar == null) {
            ...
            int i16 = f46568s[i10];
            f6 f6Var = this.f46570b;
            vg.b bVar = new vg.b(context, f6Var);
            vg.a d = vg.a.d(context, this.d, this.f46571c, f6Var, i16, i12);
            bVar.f45771b = d;
            ...
            if (i10 == 1) {
                bVar.d = true;
                uq uqVar = bVar.f45772c;
                if (uqVar != null) {
                    uqVar.setReverse(true);
                }
            }
            addView(bVar, b6.e(i11, i11 + 8, this.f46574r));
            mVarArr[i10] = new m(bVar, aVar, aVar2, 7);
            i iVar = this.f46572f[i10];
            if (iVar != null) {
                bVar.a(iVar.f10368a, false);
                aVar.a(false, false);
                if (iVar.f10368a <= 0) {
                    z11 = false;
                }
                aVar2.a(z11, false);
                bVar.c(iVar.f10369b, false);
                bVar.b(iVar.f10370c, false);
            }
            a();
        }
        ((xd.a) mVarArr[i10].f44089c).a(z4, z10);
    }
