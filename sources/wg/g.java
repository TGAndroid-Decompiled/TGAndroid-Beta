...
public final class g extends c {
    public final ImageView f48524r;
    public f f48525s;
    public TLRPC.Chat v;
    public boolean f48526w;
    ...
    public g(Context context, f6 f6Var) {
        ...
        this.f48524r = imageView;
        imageView.setFocusable(false);
        imageView.setScaleType(ImageView.ScaleType.CENTER);
        imageView.setBackground(j6.f0(j6.w0(null, j6.Vh, false), 1, -1));
        imageView.setImageResource(R.drawable.poll_remove);
        imageView.setColorFilter(new PorterDuffColorFilter(j6.w0(null, j6.f20827m6, false), PorterDuff.Mode.MULTIPLY));
    ...
    public final void f(TLRPC.Chat chat, int i10, boolean z10, int i11) {
        ...
        setDivider(true);
        ImageView imageView = this.f48524r;
        if (z10) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f48524r.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(48.0f), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(48.0f), 1073741824));
    }
