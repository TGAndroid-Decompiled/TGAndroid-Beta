...
public final class t extends FrameLayout {
    public final wh.p f48556a;
    public final FrameLayout f48557b;
    public String f48558c;
    public String d;
    public final ImageView f48559e;

    public t(Context context, f6 f6Var) {
        super(context);
        FrameLayout frameLayout = new FrameLayout(context);
        this.f48557b = frameLayout;
        ...
        frameLayout.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view) {
                switch (r2) {
                    case 0:
                        AndroidUtilities.addToClipboard(this.f48555b.d);
                        return;
                    default:
                        AndroidUtilities.addToClipboard(this.f48555b.d);
                        return;
        ...
        this.f48559e = imageView;
        imageView.setImageResource(R.drawable.menu_copy_s);
        imageView.setColorFilter(j6.v0(j6.f20771j5, f6Var));
    ...
    public final void a(Runnable runnable) {
        this.f48559e.setVisibility(4);
        int dp = AndroidUtilities.dp(18.0f);
        int dp2 = AndroidUtilities.dp(14.0f);
        int dp3 = AndroidUtilities.dp(14.0f);
        int dp4 = AndroidUtilities.dp(18.0f);
        wh.p pVar = this.f48556a;
        pVar.setPadding(dp, dp2, dp3, dp4);
        ?? obj = new Object();
        obj.f28592a |= 256;
        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder("t.me/giftcode/" + this.f48558c);
        ...
        this.f48557b.setOnClickListener(new ci.o(4, runnable));
    }

    public void setSlug(String str) {
        this.f48558c = str;
        this.d = p6.i("https://t.me/giftcode/", str);
        this.f48556a.setText("t.me/giftcode/" + str);
    }
}
