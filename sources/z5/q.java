...
public abstract class q {
    public static final a0.k f50665a = new a0.k(0);
    public static Locale f50666b;

    public static String a(Context context) {
        String packageName = context.getPackageName();
        try {
            Context context2 = i6.b.a(context).f1053a;
    ...
    public static String e(Context context, String str, String str2) {
        ...
        if (f9 == null) {
            f9 = resources.getString(2131701331);
        }
    ...
    public static String f(Context context, String str) {
        ...
        synchronized (kVar) {
            try {
                Locale locale = i7.c0.a(context.getResources().getConfiguration()).f17076a.get(0);
                if (!locale.equals(f50666b)) {
                    kVar.clear();
                    f50666b = locale;
                }
