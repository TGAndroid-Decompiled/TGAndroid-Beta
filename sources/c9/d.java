        ...
        switch (this.f2153a) {
            case 0:
                ...
                try {
                    ...
                    throw new RuntimeException(v2.e("Could not instantiate ", str), e10);
                } catch (InvocationTargetException e11) {
                    throw new RuntimeException(v2.e("Could not instantiate ", str), e11);
                }
            case 1:
                return (ComponentRegistrar) this.f2154b;
            default:
                return new da.c((w8.g) this.f2154b);
        }
    }
}
