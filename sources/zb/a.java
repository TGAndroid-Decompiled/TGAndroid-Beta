...
public final class a implements b {
    ...
    public final ArrayList a(vb.a aVar) {
        ...
        int i10 = aVar.e;
        int i11 = aVar.f44563b;
        int i12 = aVar.f44564c;
        int a2 = d8.a(aVar.d);
        ...
        try {
            ...
            while (i15 < size) {
                ...
                i15++;
                na naVar = (na) obj;
                arrayList.add(new xb.a(naVar.f45808b, naVar.d, naVar.f45807a, naVar.f45809c));
            }
            return arrayList;
    ...
    public final void zzb() {
        ...
        try {
            IBinder b10 = y6.e.c(context, y6.e.f46598b, "com.google.android.gms.vision.ica").b("com.google.android.gms.vision.label.mlkit.ImageLabelerCreator");
            int i10 = la.f45772b;
            if (b10 == null) {
                aVar = null;
            } else {
            ...
            this.e = ((ka) aVar).W0(new x6.b(context), new oa(this.f49119b.f46019a, -1));
        } catch (RemoteException e) {
