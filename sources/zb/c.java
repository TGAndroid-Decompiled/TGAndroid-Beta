...
public final class c implements b {
    public final Context f51530a;
    public final n6 f51531b;
    ...
    public c(Context context, yb.a aVar) {
        ...
        this.f51531b = new n6(1, -1, aVar.f49365a, 1);
    ...
    public final ArrayList a(vb.a aVar) {
        ...
        if (this.f51533e != null) {
            ...
            l.h(bitmap);
            int i11 = aVar.d;
            int i12 = aVar.f47798b;
            int i13 = aVar.f47799c;
            if (i11 == 0) {
            ...
            try {
                ...
                for (m4 m4Var : m4VarArr) {
                    arrayList.add(new xb.a(m4Var.f49108c, m4Var.d, m4Var.f49107b, m4Var.f49106a));
                }
                return arrayList;
    ...
    public final void zzb() {
        ...
        Context context = this.f51530a;
        Log.d("LegacyLabelDelegate", "Try to load legacy label module.");
        if (this.f51533e == null) {
            try {
                IBinder b10 = y6.e.c(context, y6.e.f49575b, str).b("com.google.android.gms.vision.label.ChimeraNativeImageLabelerCreator");
                int i10 = k2.f49087b;
                if (b10 == null) {
                    aVar = null;
                } else {
                ...
                m0 W0 = ((j1) aVar).W0(new x6.b(context), this.f51531b);
                this.f51533e = W0;
                if (W0 == null && !this.d) {
