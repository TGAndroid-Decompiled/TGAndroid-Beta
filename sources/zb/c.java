...
public final class c implements b {
    ...
    public c(Context context, yb.a aVar) {
        ...
        this.f49123b = new n6(1, -1, aVar.f46020a, 1);
    ...
    public final ArrayList a(vb.a aVar) {
        ...
        if (this.e != null) {
            ...
            l.h(bitmap);
            int i11 = aVar.d;
            int i12 = aVar.f44564b;
            int i13 = aVar.f44565c;
            if (i11 == 0) {
            ...
            try {
                ...
                for (m4 m4Var : m4VarArr) {
                    arrayList.add(new xb.a(m4Var.f45781c, m4Var.d, m4Var.f45780b, m4Var.f45779a));
                }
                return arrayList;
    ...
    public final void zzb() {
        ...
        if (this.e == null) {
            try {
                IBinder b10 = y6.e.c(context, y6.e.f46599b, str).b("com.google.android.gms.vision.label.ChimeraNativeImageLabelerCreator");
                int i10 = k2.f45761b;
                if (b10 == null) {
                    aVar = null;
                } else {
                ...
                m0 W0 = ((j1) aVar).W0(new x6.b(context), this.f49123b);
                this.e = W0;
                if (W0 == null && !this.d) {
