...
public final class f extends qb.e {
    ...
    public final h8 f51507e;
    public final b f51508f;
    public final fa f51509g;
    public final o0.a h;
    ...
    public f(yb.a aVar, b bVar, fa faVar) {
        ...
        this.f51509g = faVar;
        ?? obj = new Object();
        obj.f47751a = Float.valueOf(aVar.f49336a);
        this.f51507e = new h8(obj);
    ...
    public final synchronized void b() {
        this.f51508f.zzb();
        fa faVar = this.f51509g;
        ?? obj = new Object();
        obj.f6376c = m7.TYPE_THIN;
        z0 z0Var = new z0(26, false);
        z0Var.f16703b = this.f51507e;
        m mVar = o.f49113b;
        Object[] objArr = {n7.NO_ERROR};
        j8.a(1, objArr);
        z0Var.f16704c = new s(1, objArr);
        obj.d = new g8(z0Var);
        qb.m.f44294a.execute(new p(faVar, new a5.a((n) obj, 0), o7.ON_DEVICE_IMAGE_LABEL_LOAD, faVar.b(), 7));
    }
    ...
    public final synchronized void c() {
        ...
        ?? obj = new Object();
        obj.f6376c = m7.TYPE_THIN;
        qb.m.f44294a.execute(new p(faVar, new a5.a((n) obj, 0), o7.ON_DEVICE_IMAGE_LABEL_CLOSE, faVar.b(), 7));
    }
    ...
    public final void f(n7 n7Var, vb.a aVar, long j3) {
        ...
        if (faVar.c(o7Var, elapsedRealtime2)) {
            faVar.f48999i.put(o7Var, Long.valueOf(elapsedRealtime2));
            ?? obj = new Object();
            obj.f6376c = m7.TYPE_THIN;
            ...
            a6Var.f47380c = this.f51507e;
            obj.f6377e = new f8(a6Var);
            qb.m.f44294a.execute(new p(faVar, new a5.a((n) obj, 0), o7Var, faVar.b(), 7));
        }
        a6 a6Var2 = new a6(6, false);
        a6Var2.f47380c = this.f51507e;
        a6Var2.f47379b = n7Var;
        a6Var2.d = Boolean.valueOf(this.d);
        qb.m.f44294a.execute(new da(this.f51509g, new r0(a6Var2), elapsedRealtime));
        long currentTimeMillis = System.currentTimeMillis();
        o0.a aVar3 = this.h;
        int i12 = n7Var.f49109a;
