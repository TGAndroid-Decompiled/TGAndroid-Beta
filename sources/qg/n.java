...
public final class n implements Runnable {
    ...
    public final void run() {
        ...
        switch (this.f41470a) {
            case 0:
                p0 p0Var = this.f41471b;
                x01 x01Var = p0Var.f41511a1;
                if (x01Var != null) {
                    p0Var.f41511a1 = null;
            ...
            case 3:
                ...
                return;
            default:
                p0 p0Var3 = this.f41471b;
                boolean z10 = pg.s0.e(p0Var3.P1).f40995k;
                int i10 = 0;
                while (true) {
