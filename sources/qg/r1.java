...
public final class r1 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    public static final List f41624w = Arrays.asList(new o1(0, 1, 20, 0), new o1(0, 2, 20, 40), new o1(1, 0, 0, 20), new o1(1, 2, 60, 40), new o1(2, 0, 40, 20), new o1(2, 1, 40, 60));
    public int f41625a;
    public final aj0 f41626b;
    public final ImageView f41627c;
    public final ImageView d;
    public final View e;
    public final q1 f41628f;
    public p1 h;
    public int f41629n;
    public int f41630r;
    public int f41631s;
            ...
            public final void onClick(View view2) {
                switch (r2) {
                    case 0:
                        ...
                        return;
                    case 1:
                        r1 r1Var = this.f41475b;
                        r1Var.d((r1Var.f41625a + 1) % 3, true);
                        return;
                    case 2:
                        this.f41475b.h.f();
                        return;
    ...
    public final void c(View view) {
        if (view.getVisibility() != 8) {
            ...
            int i10 = this.f41630r + layoutParams.leftMargin;
            this.f41630r = i10;
            view.layout(i10, (getMeasuredHeight() - layoutParams.height) / 2, this.f41630r + layoutParams.width, (getMeasuredHeight() + layoutParams.height) / 2);
            this.f41630r = layoutParams.width + layoutParams.rightMargin + this.f41630r;
        }
    }
    ...
    public final void d(int i10, boolean z10) {
        ...
        if (i11 == i10) {
            ...
            while (true) {
                ...
                if (this.f41625a == o1Var2.f41503b) {
                    o1Var = o1Var2;
                    break;
                }
            }
        ...
        while (true) {
            ...
            if (i11 == o1Var4.f41502a && this.f41625a == o1Var4.f41503b) {
                o1Var3 = o1Var4;
                break;
            }
        }
        xi0 animatedDrawable2 = aj0Var.getAnimatedDrawable();
        animatedDrawable2.M(o1Var3.f41504c);
    ...
    public final void e(int i10, boolean z10) {
        ...
        ImageView imageView = this.f41627c;
        if (z10) {
        ...
        if (q1Var != null) {
            for (pg.j0 j0Var : pg.j0.c()) {
                if (j0Var.f40883a.equals(str)) {
                    ...
                    String str2 = j0Var.f40885c;
                    if (str2 == null) {
                        str2 = LocaleController.getString(j0Var.f40884b);
                    }
                    q1Var.setText(str2);
                    return;
                }
