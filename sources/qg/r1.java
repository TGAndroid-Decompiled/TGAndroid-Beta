...
public final class r1 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    public static final List f41650w = Arrays.asList(new o1(0, 1, 20, 0), new o1(0, 2, 20, 40), new o1(1, 0, 0, 20), new o1(1, 2, 60, 40), new o1(2, 0, 40, 20), new o1(2, 1, 40, 60));
    public int f41651a;
    public final bj0 f41652b;
    public final ImageView f41653c;
    public final ImageView d;
    public final View e;
    public final q1 f41654f;
    public p1 h;
    public int f41655n;
    public int f41656r;
    public int f41657s;
            ...
            public final void onClick(View view2) {
                switch (r2) {
                    case 0:
                        ...
                        return;
                    case 1:
                        r1 r1Var = this.f41501b;
                        r1Var.d((r1Var.f41651a + 1) % 3, true);
                        return;
                    case 2:
                        this.f41501b.h.f();
                        return;
    ...
    public final void c(View view) {
        if (view.getVisibility() != 8) {
            ...
            int i10 = this.f41656r + layoutParams.leftMargin;
            this.f41656r = i10;
            view.layout(i10, (getMeasuredHeight() - layoutParams.height) / 2, this.f41656r + layoutParams.width, (getMeasuredHeight() + layoutParams.height) / 2);
            this.f41656r = layoutParams.width + layoutParams.rightMargin + this.f41656r;
        }
    }
    ...
    public final void d(int i10, boolean z10) {
        ...
        if (i11 == i10) {
            ...
            while (true) {
                ...
                if (this.f41651a == o1Var2.f41529b) {
                    o1Var = o1Var2;
                    break;
                }
            }
        ...
        while (true) {
            ...
            if (i11 == o1Var4.f41528a && this.f41651a == o1Var4.f41529b) {
                o1Var3 = o1Var4;
                break;
            }
        }
        yi0 animatedDrawable2 = bj0Var.getAnimatedDrawable();
        animatedDrawable2.M(o1Var3.f41530c);
    ...
    public final void e(int i10, boolean z10) {
        ...
        ImageView imageView = this.f41653c;
        if (z10) {
        ...
        if (q1Var != null) {
            for (pg.j0 j0Var : pg.j0.c()) {
                if (j0Var.f40909a.equals(str)) {
                    ...
                    String str2 = j0Var.f40911c;
                    if (str2 == null) {
                        str2 = LocaleController.getString(j0Var.f40910b);
                    }
                    q1Var.setText(str2);
                    return;
                }
