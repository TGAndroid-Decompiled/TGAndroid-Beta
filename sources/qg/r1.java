...
public final class r1 {
    ...
    public static int b(iv0 iv0Var) {
        int i10 = (int) iv0Var.f27271a;
        int i11 = (int) iv0Var.f27272b;
        int[] iArr = new int[1];
    ...
    public final void a(boolean z10) {
        ...
        if (i10 != 0) {
            ...
            this.f44553b = 0;
            if (z10 && (bitmap = this.f44552a) != null && !bitmap.isRecycled()) {
                bitmap.recycle();
            }
        }
    }
    ...
    public final int c() {
        ...
        GLES20.glTexParameteri(3553, 10241, 9729);
        try {
            GLUtils.texImage2D(3553, 0, 6408, this.f44552a, 5121, 0);
        } catch (Exception e7) {
            FileLog.e(e7);
            ...
            this.f44552a.getPixels(iArr2, 0, width, 0, 0, width, height);
