...
public final class r1 {
    ...
    public static int b(iv0 iv0Var) {
        int i10 = (int) iv0Var.f27298a;
        int i11 = (int) iv0Var.f27299b;
        int[] iArr = new int[1];
    ...
    public final void a(boolean z10) {
        ...
        if (i10 != 0) {
            ...
            this.f44581b = 0;
            if (z10 && (bitmap = this.f44580a) != null && !bitmap.isRecycled()) {
                bitmap.recycle();
            }
        }
    }
    ...
    public final int c() {
        ...
        GLES20.glTexParameteri(3553, 10241, 9729);
        try {
            GLUtils.texImage2D(3553, 0, 6408, this.f44580a, 5121, 0);
        } catch (Exception e7) {
            FileLog.e(e7);
            ...
            this.f44580a.getPixels(iArr2, 0, width, 0, 0, width, height);
