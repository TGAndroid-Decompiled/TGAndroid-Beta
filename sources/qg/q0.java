...
public final class q0 extends i {
    public final int f41881n = 2;
    public final Paint f41882r;
    public final Path f41883s;

    public q0(r0 r0Var, Context context) {
        super(r0Var, context);
        Paint paint = new Paint(1);
        this.f41882r = paint;
        this.f41883s = new Path();
        ...
        switch (this.f41881n) {
            case 0:
                ...
                if (showAlpha > 0.0f) {
                    ...
                    canvas.drawPath(path, paint);
                    float f19 = dp + f12;
                    Paint paint2 = this.f41646c;
                    canvas.drawCircle(dp, f19, dpf2, paint2);
                    Paint paint3 = this.f41645b;
            ...
            case 1:
                ...
                if (showAlpha2 > 0.0f) {
                    ...
                    canvas.drawPath(path2, paint5);
                    float f32 = dp3 + f25;
                    Paint paint6 = this.f41646c;
                    canvas.drawCircle(dp3, f32, dpf22, paint6);
                    Paint paint7 = this.f41645b;
            ...
            case 2:
                ...
                if (showAlpha3 > 0.0f) {
                    ...
                    canvas.drawPath(path3, paint9);
                    float f45 = dp5 + f38;
                    Paint paint10 = this.f41646c;
                    canvas.drawCircle(dp5, f45, dpf23, paint10);
                    Paint paint11 = this.f41645b;
            ...
            case 3:
                ...
                if (showAlpha4 > 0.0f) {
                    ...
                    canvas.drawPath(path4, paint13);
                    float f58 = dp7 + f51;
                    Paint paint14 = this.f41646c;
                    canvas.drawCircle(dp7, f58, dpf24, paint14);
                    Paint paint15 = this.f41645b;
            ...
            case 4:
                ...
                if (showAlpha5 > 0.0f) {
                    ...
                    canvas.drawPath(path5, paint17);
                    float f71 = dp9 + f64;
                    Paint paint18 = this.f41646c;
                    canvas.drawCircle(dp9, f71, dpf25, paint18);
                    Paint paint19 = this.f41645b;
            ...
            default:
                ...
                if (showAlpha6 > 0.0f) {
                    ...
                    canvas2.drawPath(path6, paint21);
                    float f84 = dp11 + f77;
                    Paint paint22 = this.f41646c;
                    canvas2.drawCircle(dp11, f84, dpf26, paint22);
                    Paint paint23 = this.f41645b;
