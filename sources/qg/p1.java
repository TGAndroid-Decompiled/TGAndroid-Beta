...
public final class p1 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    public static final List f41870w = Arrays.asList(new m1(0, 1, 20, 0), new m1(0, 2, 20, 40), new m1(1, 0, 0, 20), new m1(1, 2, 60, 40), new m1(2, 0, 40, 20), new m1(2, 1, 40, 60));
    public int f41871a;
    public final lj0 f41872b;
    public final ImageView f41873c;
    public final ImageView d;
    public final View e;
    public final o1 f41874f;
    public n1 h;
    public int f41875n;
    public int f41876r;
    public int f41877s;
            ...
            public final void onClick(View view2) {
                switch (r2) {
                    case 0:
                        ...
                        return;
                    case 1:
                        p1 p1Var = this.f41721b;
                        p1Var.d((p1Var.f41871a + 1) % 3, true);
                        return;
                    case 2:
                        this.f41721b.h.f();
                        return;
    ...
    public final void c(View view) {
        if (view.getVisibility() != 8) {
            ...
            int i10 = this.f41876r + layoutParams.leftMargin;
            this.f41876r = i10;
            view.layout(i10, (getMeasuredHeight() - layoutParams.height) / 2, this.f41876r + layoutParams.width, (getMeasuredHeight() + layoutParams.height) / 2);
            this.f41876r = layoutParams.width + layoutParams.rightMargin + this.f41876r;
        }
    }
    ...
    public final void d(int i10, boolean z10) {
        ...
        if (i11 == i10) {
            ...
            while (true) {
                ...
                if (this.f41871a == m1Var2.f41749b) {
                    m1Var = m1Var2;
                    break;
                }
            }
        ...
        while (true) {
            ...
            if (i11 == m1Var4.f41748a && this.f41871a == m1Var4.f41749b) {
                m1Var3 = m1Var4;
                break;
            }
        }
        ij0 animatedDrawable2 = lj0Var.getAnimatedDrawable();
        animatedDrawable2.M(m1Var3.f41750c);
    ...
    public final void e(int i10, boolean z10) {
        ...
        ImageView imageView = this.f41873c;
        if (z10) {
        ...
        if (o1Var != null) {
            for (pg.k0 k0Var : pg.k0.c()) {
                if (k0Var.f41143a.equals(str)) {
                    ...
                    String str2 = k0Var.f41145c;
                    if (str2 == null) {
                        str2 = LocaleController.getString(k0Var.f41144b);
                    }
                    o1Var.setText(str2);
                    return;
                }
