...
public final class d1 extends kl0 {
    public final Context f41325c;
    public final ha d;
    public final c7 e;
    public final boolean f41326f;
    public final c6 h;
    ...
    @Override
    public final int h() {
        return this.h.f41368s0.size();
    }

    @Override
    public final int j(int i10) {
        ArrayList arrayList = this.h.f41368s0;
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (view instanceof org.telegram.ui.Cells.t1) {
            ...
            MessageObject.GroupedMessages groupedMessages2 = c6Var.f41369t0;
