...
public final class y1 extends j {
    ...
    public final TLObject f42040q0;
    public final String f42041r0;
    public final int f42042s0;
    public boolean f42043t0;
    public final d6 f42044u0;
    public final wv0 f42045v0;
    public final int f42046w0;
    public boolean f42047x0;
    public final d6 f42048y0;
    public final ai.f0 f42049z0;
    ...
    public y1(Context context, PointF pointF, wv0 wv0Var, String str, int i10) {
        ...
        setScale(1.0f);
        this.f42041r0 = str;
        this.f42045v0 = wv0Var;
        ai.f0 f0Var = new ai.f0(this, context);
        this.f42049z0 = f0Var;
        addView(f0Var, y5.c(-1.0f, -1));
        qr qrVar = qr.h;
        this.f42044u0 = new d6(f0Var, 0L, 500L, qrVar);
        this.f42048y0 = new d6(f0Var, 0L, 350L, qrVar);
        this.f42046w0 = i10;
    ...
    public int getAnchor() {
        return this.f42042s0;
    }

    public wv0 getBaseSize() {
        return this.f42045v0;
    }
    ...
    public uk0 getSelectionBounds() {
        ...
        return new uk0(w10, rk.w(dp2, 2.0f, getPositionY(), scaleX), ((((AndroidUtilities.dp(64.0f) / scaleX) + scale2) * scaleX) + w10) - w10, dp2 * scaleX);
    }

    @Override
    public final void k() {
        wv0 wv0Var = this.f42045v0;
        float f7 = wv0Var.f30161a / 2.0f;
        float f10 = wv0Var.f30162b / 2.0f;
    ...
    public final String q(int i10) {
        TLObject tLObject = this.f42040q0;
        ...
        return this.f42041r0;
    }

    public final void r(boolean z10) {
        boolean z11 = !this.f42043t0;
        this.f42043t0 = z11;
        if (!z10) {
            this.f42044u0.f(z11, true);
        }
        ai.f0 f0Var = this.f42049z0;
        if (f0Var != null) {
            f0Var.invalidate();
        }
    }
    ...
    public final void s(Bitmap bitmap) {
        if (!this.C0 && !this.B0 && bitmap != null && Build.VERSION.SDK_INT >= 24) {
            ...
            this.B0 = true;
            a2.g(vb.a.a(bitmap, this.f42046w0)).addOnSuccessListener(new k2.v(this, 23)).addOnFailureListener(new rv0(26, this, bitmap));
        }
    }

    public final void t(boolean z10) {
        boolean z11 = !this.f42047x0;
        this.f42047x0 = z11;
        if (!z10) {
            this.f42048y0.f(z11, true);
        }
        ai.f0 f0Var = this.f42049z0;
        if (f0Var != null) {
            f0Var.invalidate();
