...
public abstract class j extends FrameLayout {
    public static final List f41675p0 = Arrays.asList(-90, 0, 90, 180);
    public boolean E;
    public h F;
    public PointF G;
    public i H;
    ...
    public int V;
    public int W;
    public final yc f41676a;
    public ValueAnimator f41677a0;
    public float f41678b;
    public ValueAnimator f41679b0;
    public float f41680c;
    public boolean f41681c0;
    public float d;
    public boolean f41682d0;
    public float e;
    public final float[] f41683e0;
    public float f41684f;
    public final float[] f41685f0;
    public final float[] f41686g0;
    public float h;
    public float f41687h0;
    public float f41688i0;
    public float f41689j0;
    public ValueAnimator f41690k0;
    public boolean f41691l0;
    public ViewGroup m0;
    public boolean f41692n;
    public float f41693n0;
    public ValueAnimator f41694o0;
    public boolean f41695r;
    public boolean f41696s;
    public boolean v;
    public boolean f41697w;
    public boolean f41698x;
    public boolean f41699y;

    public j(Context context, PointF pointF) {
        super(context);
        this.f41676a = new yc(this);
        this.f41692n = false;
        this.f41695r = false;
        this.f41696s = false;
        this.v = false;
        ...
        this.f41683e0 = new float[2];
        this.f41685f0 = new float[2];
        this.f41686g0 = new float[2];
        this.f41687h0 = 1.0f;
        this.f41691l0 = false;
        this.f41693n0 = 1.0f;
    ...
    public final boolean c(float f7, float f10, boolean z10, float f11, float f12) {
        ...
        if (getParent() != null) {
            ...
            float f17 = (f13 - this.f41684f) / scaleX;
            ...
            if (hypot > f15 || z10) {
                ...
                if (z10) {
                    ...
                    float a10 = a7.a(this.f41678b, this.f41680c, this.d, this.e);
                    if (a10 > 0.0f) {
                        j(a2 / a10);
                    }
                    f(this.f41688i0 + ((float) Math.toDegrees(Math.atan2(f10 - f12, f7 - f11) - Math.atan2(this.f41680c - this.e, this.f41678b - this.d))));
                }
                this.f41678b = f7;
                this.f41680c = f10;
                this.f41684f = f13;
                ...
                if (!this.f41697w && z10 && (hVar3 = this.F) != null) {
                    this.f41697w = true;
                    hVar3.l();
                }
                if (this.f41697w && !z10 && (hVar2 = this.F) != null) {
                    this.f41697w = false;
                    hVar2.k();
                }
                if (!this.f41691l0 && !this.f41698x && (hVar = this.F) != null) {
                    hVar.d(this);
                    this.f41698x = true;
                }
                h hVar5 = this.F;
                ...
                if (this.f41699y != z11) {
                    ValueAnimator valueAnimator = this.f41694o0;
                    if (valueAnimator != null) {
                        valueAnimator.cancel();
                        this.f41694o0 = null;
                    }
                    float f19 = this.f41693n0;
                    if (z11) {
                        f16 = 0.5f;
                    } else {
                        f16 = 1.0f;
                    ...
                    this.f41694o0 = ofFloat;
                    ofFloat.addUpdateListener(new f(this, 1));
                    this.f41694o0.setInterpolator(rr.h);
                    this.f41694o0.setDuration(280L);
                    this.f41694o0.start();
                    this.f41699y = z11;
                    h hVar8 = this.F;
                    if (hVar8 != null) {
    ...
    public final void d(boolean z10) {
        ...
        h hVar2;
        if (this.v) {
            this.F.i(this.f41699y);
            this.v = false;
        }
        this.f41697w = false;
        if (!z10 && !this.E && !this.f41692n && !this.f41696s && !this.f41698x && (hVar2 = this.F) != null) {
            hVar2.d(this);
        }
        if (this.f41692n && (hVar = this.F) != null) {
            hVar.A(false);
            this.F.h(false);
        }
        AndroidUtilities.cancelRunOnUIThread(this.I);
    ...
    public void dispatchDraw(Canvas canvas) {
        float a2 = this.f41676a.a(getBounceScale());
        canvas.save();
        canvas.scale(a2, a2, getWidth() / 2.0f, getHeight() / 2.0f);
        if (getParent() instanceof View) {
            View view = (View) getParent();
            if (this instanceof c2) {
                float f7 = this.f41693n0;
    ...
    public final void f(float f7) {
        ...
        this.f41688i0 = f7;
        boolean z10 = this.K;
        if (!z10 && !this.f41681c0) {
            Iterator it = f41675p0.iterator();
            while (true) {
                if (!it.hasNext()) {
                    break;
                }
            ...
            if (Math.abs(this.L - f7) < 12.0f && !this.f41681c0) {
                if (this.P != null) {
                    f7 = this.O;
                } else {
                    f7 = this.L;
    ...
    public float getPositionX() {
        ...
        if (getParent() != null) {
            ...
            ValueAnimator valueAnimator = this.f41677a0;
            if (valueAnimator != null) {
    ...
    public float getPositionY() {
        ...
        if (getParent() != null) {
            ...
            ValueAnimator valueAnimator = this.f41679b0;
            if (valueAnimator != null) {
                return AndroidUtilities.lerp(f10, f7, ((Float) valueAnimator.getAnimatedValue()).floatValue());
            }
            if (f7 != 0.0f) {
    ...
    public final void h(float... fArr) {
        ...
        this.f41677a0 = duration;
        duration.setInterpolator(rr.f28031f);
        this.f41677a0.addUpdateListener(new f(this, 3));
        this.f41677a0.addListener(new g(this, 0));
        this.f41677a0.start();
    }
    ...
    public final void i(float... fArr) {
        ...
        ValueAnimator duration = ValueAnimator.ofFloat(fArr).setDuration(150L);
        this.f41679b0 = duration;
        duration.setInterpolator(rr.f28031f);
        this.f41679b0.addUpdateListener(new f(this, 4));
        this.f41679b0.addListener(new g(this, 1));
        this.f41679b0.start();
    }

    @Override
    public final boolean isSelected() {
        return this.f41691l0;
    }

    public final void j(float f7) {
        boolean z10;
        float f10 = this.f41687h0;
        float f11 = f7 * f10;
        this.f41687h0 = f11;
    ...
    public final void l(ViewGroup viewGroup, boolean z10) {
        if (this.f41691l0 != z10) {
            this.f41691l0 = z10;
            ValueAnimator valueAnimator = this.f41690k0;
            if (valueAnimator != null) {
                valueAnimator.cancel();
                this.f41690k0 = null;
            }
            ...
            this.H.b();
            float f10 = this.f41689j0;
            if (z10) {
                f7 = 1.0f;
            }
            ValueAnimator ofFloat = ValueAnimator.ofFloat(f10, f7);
            this.f41690k0 = ofFloat;
            ofFloat.addUpdateListener(new f(this, 2));
            this.f41690k0.addListener(new g(this, 4));
            this.f41690k0.setDuration(280L);
            this.f41690k0.setInterpolator(rr.h);
            this.f41690k0.start();
        }
    }
