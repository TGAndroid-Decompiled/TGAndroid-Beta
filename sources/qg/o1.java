...
public final class o1 extends TextView {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.f41842a) {
            ...
            if (LocaleController.isRTL) {
                this.f41843b.setBounds(AndroidUtilities.dp(7.0f), A, AndroidUtilities.dp(23.0f), AndroidUtilities.dp(16.0f) + A);
            } else {
                this.f41843b.setBounds(getWidth() - AndroidUtilities.dp(23.0f), A, getWidth() - AndroidUtilities.dp(7.0f), AndroidUtilities.dp(16.0f) + A);
            }
            this.f41843b.draw(canvas);
        }
    }
    ...
    public void setCurrent(boolean z10) {
        ...
        if (this.f41842a && this.f41843b == null) {
