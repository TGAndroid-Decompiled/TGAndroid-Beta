...
public abstract class e1 extends j {
    ...
    public f5 K0;
    public f5 L0;
    public final t5 f41596q0;
    public final x0 f41597r0;
    public final ArrayList f41598s0;
    public final MessageObject.GroupedMessages f41599t0;
    public boolean f41600u0;
    public boolean f41601v0;
    public TextureView f41602w0;
    public boolean f41603x0;
    public int f41604y0;
    public int f41605z0;
    ...
    public e1(Context context, PointF pointF, ArrayList arrayList, ja jaVar, boolean z10, c7 c7Var) {
        ...
        obj.f7329a = textPaint;
        TextPaint textPaint2 = new TextPaint();
        obj.f7330b = textPaint2;
        TextPaint textPaint3 = new TextPaint();
        obj.f7331c = textPaint3;
        new Paint(3);
        obj.d = new Paint(3);
        ...
        for (int i10 = 0; i10 < arrayList.size(); i10++) {
            ...
            if (message2 instanceof TLRPC.TL_message) {
                ...
                this.f41598s0.add(messageObject2);
            }
            tL_messageService.f18317id = message2.f18317id;
            ...
            this.f41598s0.add(messageObject22);
        }
        this.f41599t0 = null;
        if (this.f41598s0.size() > 1) {
            MessageObject.GroupedMessages groupedMessages = new MessageObject.GroupedMessages();
            this.f41599t0 = groupedMessages;
            groupedMessages.messages.addAll(this.f41598s0);
            groupedMessages.groupId = ((MessageObject) this.f41598s0.get(0)).getGroupId();
    ...
    public void setupTheme(ci.o8 r8) {
        throw new UnsupportedOperationException("Method not decompiled: qg.e1.setupTheme(ci.o8):void");
    }
}
