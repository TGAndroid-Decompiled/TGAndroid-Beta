    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.f41810a) {
            ...
            if (LocaleController.isRTL) {
                this.f41811b.setBounds(AndroidUtilities.dp(7.0f), A, AndroidUtilities.dp(23.0f), AndroidUtilities.dp(16.0f) + A);
            } else {
                this.f41811b.setBounds(getWidth() - AndroidUtilities.dp(23.0f), A, getWidth() - AndroidUtilities.dp(7.0f), AndroidUtilities.dp(16.0f) + A);
            }
            this.f41811b.draw(canvas);
        }
    }
