...
public abstract class z1 extends View {
    public Bitmap f42006a;
    public Paint f42007b;
    public Paint f42008c;
    public Paint d;
    public float e;
    public float f42009f;
    public Path h;
    public Rect f42010n;
    public RectF f42011r;
    public int f42012s;
    public boolean v;
    public q0.a f42013w;
    public float f42014x;
    ...
    public final void onDetachedFromWindow() {
        ...
        ((pg.n) this).f41162y.f41294n.d();
        this.f42006a.recycle();
        this.f42006a = null;
    }
    ...
    public final void onDraw(Canvas canvas) {
        int i10;
        float f7;
        Rect rect = this.f42010n;
        Paint paint = this.f42007b;
        RectF rectF = this.f42011r;
        Path path = this.h;
        super.onDraw(canvas);
        float min = Math.min(getWidth(), getHeight()) * 0.2f;
        float width = this.e * getWidth();
        float height = this.f42009f * getHeight();
        int round = Math.round(this.e * this.f42006a.getWidth());
        int round2 = Math.round(this.f42009f * this.f42006a.getHeight());
        Bitmap bitmap = this.f42006a;
        int pixel = bitmap.getPixel(Utilities.clamp(round, bitmap.getWidth() - 1, 0), Utilities.clamp(round2, this.f42006a.getHeight() - 1, 0));
        this.f42012s = pixel;
        Paint paint2 = this.d;
        paint2.setColor(pixel);
        float f10 = this.f42014x;
        if (f10 != 0.0f && f10 != 1.0f) {
            RectF rectF2 = AndroidUtilities.rectTmp;
            f7 = 1.0f;
            i10 = round;
            rectF2.set(width - min, height - min, width + min, height + min);
            canvas.saveLayerAlpha(rectF2, (int) (this.f42014x * 255.0f), 31);
        } else {
            i10 = round;
            f7 = 1.0f;
            canvas.save();
        }
        float f11 = (this.f42014x * 0.5f) + 0.5f;
        ...
        canvas.drawBitmap(this.f42006a, rect, rectF, (Paint) null);
        ...
        canvas.drawPath(path, this.f42008c);
        float f17 = f12 / 2.0f;
    ...
    public final void onSizeChanged(int i10, int i11, int i12, int i13) {
        ...
        if (i10 != 0 && i11 != 0 && i12 != 0 && i13 != 0 && isLaidOut()) {
            ...
            this.f42009f = (i13 * this.f42009f) / i11;
        }
    }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked != 0) {
            if (actionMasked != 1) {
                ...
                this.f42009f = motionEvent.getY() / getHeight();
                invalidate();
                return true;
            }
            a(true);
