...
public abstract class h1 extends j {
    ...
    public g5 K0;
    public g5 L0;
    public final t5 f41397q0;
    public final a1 f41398r0;
    public final ArrayList f41399s0;
    public final MessageObject.GroupedMessages f41400t0;
    public boolean f41401u0;
    public boolean f41402v0;
    public TextureView f41403w0;
    public boolean f41404x0;
    public int f41405y0;
    public int f41406z0;
    ...
    public h1(Context context, PointF pointF, ArrayList arrayList, ha haVar, boolean z10, c7 c7Var) {
        ...
        for (int i10 = 0; i10 < arrayList.size(); i10++) {
            ...
            if (message2 instanceof TLRPC.TL_message) {
                ...
                this.f41399s0.add(messageObject2);
            }
            ...
            this.f41399s0.add(messageObject22);
        }
        this.f41400t0 = null;
        if (this.f41399s0.size() > 1) {
            MessageObject.GroupedMessages groupedMessages = new MessageObject.GroupedMessages();
            this.f41400t0 = groupedMessages;
            groupedMessages.messages.addAll(this.f41399s0);
            groupedMessages.groupId = ((MessageObject) this.f41399s0.get(0)).getGroupId();
