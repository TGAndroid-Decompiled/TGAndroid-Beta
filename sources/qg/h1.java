...
public final class h1 extends s4.h0 {
    public final Context f41640c;
    public final j1 d;

    public h1(j1 j1Var, Context context) {
        this.d = j1Var;
        this.f41640c = context;
    }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        pg.u0 u0Var = j1Var.f41690a3;
        if (u0Var != null) {
            i1Var.f41648a = u0Var.b(i10);
            i1Var.invalidate();
            if (j1Var.Z2 == i10) {
                f7 = 1.0f;
            } else {
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        return new s4.c1(new i1(this.d, this.f41640c));
    }
}
