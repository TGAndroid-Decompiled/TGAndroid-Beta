...
public class b extends EditTextBoldCursor {
    public final Canvas f41319b;
    public final TextPaint f41320c;
    ...
    public int f41323r;
    public final uq f41324s;
    public RectF[] v;
    public RectF f41325w;
    public boolean f41326x;
    public float f41327y;

    public b(Context context) {
        super(context);
        this.f41319b = new Canvas();
        TextPaint textPaint = new TextPaint(1);
        this.f41320c = textPaint;
        this.d = new Paint(1);
        this.f41324s = new uq();
        this.h = 0;
    ...
    private void setFrameRoundRadius(float f7) {
        if (Math.abs(this.f41327y - f7) > 0.1f) {
            this.f41327y = f7;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.e != null && this.h != 0) {
            ...
            TextPaint textPaint = this.f41320c;
            if (z11) {
                int measuredWidth = (getMeasuredWidth() - getPaddingLeft()) - getPaddingRight();
                int measuredHeight = getMeasuredHeight();
                Editable text = getText();
                Bitmap bitmap = this.e;
                Canvas canvas2 = this.f41319b;
                canvas2.setBitmap(bitmap);
                canvas2.drawColor(0, PorterDuff.Mode.CLEAR);
                float f7 = this.f41322n;
                if (f7 <= 0.0f) {
        ...
        if (this.f41323r != 0) {
            ...
            if (this.f41326x) {
                ...
                if (this.f41325w == null) {
                    this.f41325w = new RectF();
                }
                this.f41325w.left = getMeasuredWidth();
                this.f41325w.top = getMeasuredHeight();
                RectF rectF4 = this.f41325w;
                rectF4.bottom = 0.0f;
                rectF4.right = 0.0f;
                for (int i14 = 0; i14 < this.v.length; i14++) {
                    RectF rectF5 = this.f41325w;
                    rectF5.left = Math.min(rectF5.left, getPaddingLeft() + this.v[i14].left);
                    RectF rectF6 = this.f41325w;
                    rectF6.top = Math.min(rectF6.top, getPaddingTop() + this.v[i14].top);
                    RectF rectF7 = this.f41325w;
                    rectF7.right = Math.max(rectF7.right, getPaddingLeft() + this.v[i14].right);
                    RectF rectF8 = this.f41325w;
                    rectF8.bottom = Math.max(rectF8.bottom, getPaddingTop() + this.v[i14].bottom);
                }
                RectF rectF9 = this.f41325w;
                RectF rectF10 = this.f41325w;
                rectF9.right = getMeasuredWidth() - rectF10.right;
                rectF10.bottom = getMeasuredHeight() - this.f41325w.bottom;
            }
            uq uqVar = this.f41324s;
            uqVar.rewind();
    ...
    public void setFrameColor(int i10) {
        ...
        if (i10 != 0) {
            ...
            if (computePerceivedBrightness == 0.0f) {
                computePerceivedBrightness = Color.red(this.f41323r) / 255.0f;
            }
