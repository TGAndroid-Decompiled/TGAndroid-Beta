...
public class b extends EditTextBoldCursor {
    public final Canvas f41297b;
    public final TextPaint f41298c;
    public final Paint d;
    public Bitmap e;
    public boolean f41299f;
    public int h;
    public float f41300n;
    public int f41301r;
    public final uq f41302s;
    public RectF[] v;
    public RectF f41303w;
    public boolean f41304x;
    public float f41305y;

    public b(Context context) {
        super(context);
        this.f41297b = new Canvas();
        TextPaint textPaint = new TextPaint(1);
        this.f41298c = textPaint;
        this.d = new Paint(1);
        this.f41302s = new uq();
        this.h = 0;
    ...
    private void setFrameRoundRadius(float f7) {
        if (Math.abs(this.f41305y - f7) > 0.1f) {
            this.f41305y = f7;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.e != null && this.h != 0) {
            ...
            TextPaint textPaint = this.f41298c;
            if (z11) {
                int measuredWidth = (getMeasuredWidth() - getPaddingLeft()) - getPaddingRight();
                int measuredHeight = getMeasuredHeight();
                Editable text = getText();
                Bitmap bitmap = this.e;
                Canvas canvas2 = this.f41297b;
                canvas2.setBitmap(bitmap);
                canvas2.drawColor(0, PorterDuff.Mode.CLEAR);
                float f7 = this.f41300n;
                if (f7 <= 0.0f) {
        ...
        if (this.f41301r != 0) {
            ...
            if (this.f41304x) {
                ...
                if (this.f41303w == null) {
                    this.f41303w = new RectF();
                }
                this.f41303w.left = getMeasuredWidth();
                this.f41303w.top = getMeasuredHeight();
                RectF rectF4 = this.f41303w;
                rectF4.bottom = 0.0f;
                rectF4.right = 0.0f;
                for (int i14 = 0; i14 < this.v.length; i14++) {
                    RectF rectF5 = this.f41303w;
                    rectF5.left = Math.min(rectF5.left, getPaddingLeft() + this.v[i14].left);
                    RectF rectF6 = this.f41303w;
                    rectF6.top = Math.min(rectF6.top, getPaddingTop() + this.v[i14].top);
                    RectF rectF7 = this.f41303w;
                    rectF7.right = Math.max(rectF7.right, getPaddingLeft() + this.v[i14].right);
                    RectF rectF8 = this.f41303w;
                    rectF8.bottom = Math.max(rectF8.bottom, getPaddingTop() + this.v[i14].bottom);
                }
                RectF rectF9 = this.f41303w;
                RectF rectF10 = this.f41303w;
                rectF9.right = getMeasuredWidth() - rectF10.right;
                rectF10.bottom = getMeasuredHeight() - this.f41303w.bottom;
            }
            uq uqVar = this.f41302s;
            uqVar.rewind();
    ...
    public void setFrameColor(int i10) {
        ...
        if (i10 != 0) {
            ...
            if (computePerceivedBrightness == 0.0f) {
                computePerceivedBrightness = Color.red(this.f41301r) / 255.0f;
            }
