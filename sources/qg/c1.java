...
public final class c1 extends org.telegram.ui.Cells.t1 {
    ...
    public final boolean a2(Canvas canvas) {
        ...
        d1 d1Var = this.Me;
        c6 c6Var = d1Var.h;
        if (d1Var.f41357f && photoImage != null && (((c7Var = d1Var.e) != null && c7Var.f4434g && c7Var.d && c6Var.f41404x0) || c6Var.f41401u0 || (c6Var.f41403w0 != null && c6Var.M0.I0))) {
            int i10 = 0;
            while (true) {
            ...
            if (textureView != null && c6Var.M0.I0) {
                ...
                if (bitmap != null) {
                    ...
                    canvas.translate(photoImage.getCenterX() - ((c6Var.f41405y0 * max) / 2.0f), photoImage.getCenterY() - ((c6Var.f41406z0 * max) / 2.0f));
                    canvas.scale((c6Var.f41405y0 / c6Var.f41403w0.getWidth()) * max, (c6Var.f41406z0 / c6Var.f41403w0.getHeight()) * max);
                    int width = bitmap.getWidth();
                    int height = bitmap.getHeight();
                    Rect rect = this.Ke;
                    rect.set(0, 0, width, height);
                    RectF rectF2 = this.Le;
                    rectF2.set(0.0f, 0.0f, c6Var.f41403w0.getWidth(), c6Var.f41403w0.getHeight());
    ...
    public final void onDraw(Canvas canvas) {
        ...
        d1 d1Var = this.Me;
        c7 c7Var = d1Var.e;
        if ((c7Var != null && c7Var.f4434g && c7Var.d) || d1Var.h.f41401u0) {
            canvas2 = canvas;
