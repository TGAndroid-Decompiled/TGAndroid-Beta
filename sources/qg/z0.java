...
public abstract class z0 extends FrameLayout {
    ...
    public final pg.t1 f41752b;
    public final DispatchQueue f41753c;
    public final MediaController.CropState d;
    public final pg.c1 e;
    public final Bitmap f41754f;
    public final int h;
    public final boolean f41755n;
    public final FrameLayout f41756r;
    public final TextView f41757s;
    public final TextView v;
    public final z1 f41758w;
    public kv0 f41759x;
    ...
    public z0(Context context, int i10, Bitmap bitmap, Bitmap bitmap2, int i11, MediaController.CropState cropState) {
        ...
        this.J = new Rect();
        this.f41751a = i10;
        this.f41755n = context instanceof BubbleActivity;
        pg.t1 t1Var = new pg.t1();
        this.f41752b = t1Var;
        t1Var.f41039a = new Object();
        DispatchQueue dispatchQueue = new DispatchQueue("MaskPaint");
        this.f41753c = dispatchQueue;
        this.d = cropState;
        this.f41754f = bitmap;
        this.h = i11;
    ...
    private kv0 getPaintingSize() {
        float f7;
        float f10;
        kv0 kv0Var = this.f41759x;
        if (kv0Var != null) {
            return kv0Var;
        }
        Bitmap bitmap = this.f41754f;
        ...
        if (floor > f11) {
            kv0Var2.f25699b = f11;
            kv0Var2.f25698a = (float) Math.floor((f11 * f7) / f10);
        }
        this.f41759x = kv0Var2;
        return kv0Var2;
    }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        FrameLayout frameLayout = this.f41756r;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.H = 1.0f;
        measureChild(this.f41758w, i10, i11);
        measureChild(this.f41756r, i10, i11);
        this.G = false;
