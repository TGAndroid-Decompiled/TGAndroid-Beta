...
public final class z0 extends org.telegram.ui.Cells.w0 {
    public final na f42017l2;
    public final TextPaint f42018m2;
    public final b1 f42019n2;

    public z0(b1 b1Var, Context context, com.google.firebase.messaging.n nVar) {
        super(context, nVar, false);
        this.f42019n2 = b1Var;
        this.f42017l2 = new na(b1Var.d, this, 10, false);
        TextPaint textPaint = new TextPaint(1);
        this.f42018m2 = textPaint;
    ...
    public final Paint H(String str) {
        ...
        if (!"paintChatActionText".equals(str) && !"paintChatActionText2".equals(str)) {
            if ("paintChatActionBackground".equals(str)) {
                b6 b6Var = this.f42019n2.h;
                b6Var.f41634v0 = true;
                boolean z10 = b6Var.B0;
                na naVar = this.f42017l2;
                if (naVar.f26701r != z10) {
                    naVar.f26701r = z10;
                    if (naVar.f26692i == 10) {
                        ...
                        naVar.f26691g.setColorFilter(new ColorMatrixColorFilter(colorMatrix));
                    }
                }
