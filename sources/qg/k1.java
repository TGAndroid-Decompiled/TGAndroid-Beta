...
public final class k1 extends View {
    ...
    public final void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        l1 l1Var = this.f41457c;
        l1Var.X2.setColor(this.f41455a);
        float min = Math.min((getWidth() - getPaddingLeft()) - getPaddingRight(), (getHeight() - getPaddingTop()) - getPaddingBottom()) / 2.0f;
        if (this.f41456b != 0.0f) {
            min -= (l1Var.Y2.getStrokeWidth() + AndroidUtilities.dp(3.0f)) * this.f41456b;
        }
        float width = ((getWidth() / 2.0f) + getPaddingLeft()) - getPaddingRight();
        float height = ((getHeight() / 2.0f) + getPaddingTop()) - getPaddingBottom();
        l1.y1(width, height, min, this.f41455a, canvas);
        if (this.f41456b != 0.0f) {
            ...
            l1Var.Y2.setColor(this.f41455a);
