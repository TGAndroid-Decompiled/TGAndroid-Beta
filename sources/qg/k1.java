...
public final class k1 extends View {
    public int f41424a;
    public float f41425b;
    public final l1 f41426c;
    ...
    public final void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        l1 l1Var = this.f41426c;
        l1Var.X2.setColor(this.f41424a);
        float min = Math.min((getWidth() - getPaddingLeft()) - getPaddingRight(), (getHeight() - getPaddingTop()) - getPaddingBottom()) / 2.0f;
        if (this.f41425b != 0.0f) {
            min -= (l1Var.Y2.getStrokeWidth() + AndroidUtilities.dp(3.0f)) * this.f41425b;
        }
        float width = ((getWidth() / 2.0f) + getPaddingLeft()) - getPaddingRight();
        float height = ((getHeight() / 2.0f) + getPaddingTop()) - getPaddingBottom();
        l1.x1(width, height, min, this.f41424a, canvas);
        if (this.f41425b != 0.0f) {
            ...
            l1Var.Y2.setColor(this.f41424a);
