...
public final class b1 extends org.telegram.ui.Cells.w0 {
    public final la f41304l2;
    public final TextPaint f41305m2;
    public final d1 f41306n2;

    public b1(d1 d1Var, Context context, com.google.firebase.messaging.n nVar) {
        super(context, nVar, false);
        this.f41306n2 = d1Var;
        this.f41304l2 = new la(d1Var.d, this, 10, false);
        TextPaint textPaint = new TextPaint(1);
        this.f41305m2 = textPaint;
    ...
    public final Paint H(String str) {
        ...
        if (!"paintChatActionText".equals(str) && !"paintChatActionText2".equals(str)) {
            if ("paintChatActionBackground".equals(str)) {
                c6 c6Var = this.f41306n2.h;
                c6Var.f41371v0 = true;
                boolean z10 = c6Var.B0;
                la laVar = this.f41304l2;
                if (laVar.f25899r != z10) {
                    laVar.f25899r = z10;
                    if (laVar.f25890i == 10) {
                        ...
                        laVar.f25889g.setColorFilter(new ColorMatrixColorFilter(colorMatrix));
                    }
                }
