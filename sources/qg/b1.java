...
public final class b1 extends org.telegram.ui.Cells.w0 {
    public final la f41330k2;
    public final TextPaint f41331l2;
    public final d1 f41332m2;

    public b1(d1 d1Var, Context context, com.google.firebase.messaging.n nVar) {
        super(context, nVar, false);
        this.f41332m2 = d1Var;
        this.f41330k2 = new la(d1Var.d, this, 10, false);
        TextPaint textPaint = new TextPaint(1);
        this.f41331l2 = textPaint;
    ...
    public final Paint H(String str) {
        ...
        if (!"paintChatActionText".equals(str) && !"paintChatActionText2".equals(str)) {
            if ("paintChatActionBackground".equals(str)) {
                c6 c6Var = this.f41332m2.h;
                c6Var.f41397v0 = true;
                boolean z10 = c6Var.B0;
                la laVar = this.f41330k2;
                if (laVar.f25881r != z10) {
                    laVar.f25881r = z10;
                    if (laVar.f25872i == 10) {
                        ...
                        laVar.f25871g.setColorFilter(new ColorMatrixColorFilter(colorMatrix));
                    }
                }
