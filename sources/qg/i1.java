...
public final class i1 extends View {
    ...
    public final void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        j1 j1Var = this.f41665c;
        j1Var.X2.setColor(this.f41663a);
        float min = Math.min((getWidth() - getPaddingLeft()) - getPaddingRight(), (getHeight() - getPaddingTop()) - getPaddingBottom()) / 2.0f;
        if (this.f41664b != 0.0f) {
            min -= (j1Var.Y2.getStrokeWidth() + AndroidUtilities.dp(3.0f)) * this.f41664b;
        }
        float width = ((getWidth() / 2.0f) + getPaddingLeft()) - getPaddingRight();
        float height = ((getHeight() / 2.0f) + getPaddingTop()) - getPaddingBottom();
        j1.x1(width, height, min, this.f41663a, canvas);
        if (this.f41664b != 0.0f) {
            ...
            j1Var.Y2.setColor(this.f41663a);
