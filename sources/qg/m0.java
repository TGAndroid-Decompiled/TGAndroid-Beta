...
public final class m0 extends FrameLayout {
    public float f41479a;
    public float f41480b;
    public final cu0 f41481c;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (cu0Var.f41546c2 != null) {
            rect.inset(-AndroidUtilities.dp(4.0f), -AndroidUtilities.dp(4.0f));
            cu0Var.f41546c2.q(lerp);
            cu0Var.f41546c2.setBounds(rect);
            cu0Var.f41546c2.draw(canvas2);
        } else {
        ...
        if (barView.getChildCount() >= 1 && cu0Var.N1 != 1.0f) {
            ...
            if (childAt.getAlpha() != 0.0f) {
                ...
                int i11 = cu0Var.f41555h1;
                View view = childAt;
                if (i11 != -1) {
                    if (i11 == 0) {
                        viewGroup = cu0Var.f41573t1;
                    } else if (i11 == 2) {
                        viewGroup = cu0Var.f41574u1;
                    } else {
                        viewGroup = null;
                    }
                    if (viewGroup == null) {
                    ...
                    x10 = AndroidUtilities.lerp(x10, (((childAt2.getWidth() - childAt2.getPaddingLeft()) - childAt2.getPaddingRight()) / 2.0f) + childAt2.getX() + childAt2.getPaddingLeft(), cu0Var.f41557i1);
                    y3 = AndroidUtilities.lerp(y3, (((childAt2.getHeight() - childAt2.getPaddingTop()) - childAt2.getPaddingBottom()) / 2.0f) + childAt2.getY() + childAt2.getPaddingTop(), cu0Var.f41557i1);
                }
                if (l0Var != null && l0Var.getChildCount() > 0) {
                    ...
                    i10 = i0.a.d(cu0Var.N1, q1Var.f40997a, cu0Var.V1.b(0));
                }
                float f7 = x10;
                float f10 = y3;
                if (f7 != this.f41479a || f10 != this.f41480b) {
                    this.f41479a = f7;
                    this.f41480b = f10;
    ...
    public final void setTranslationY(float f7) {
        ...
        k0 k0Var = this.f41481c.f41547d1;
        if (k0Var != null) {
            k0Var.invalidate();
        }
    }
