...
public class s0 extends View {
    ...
    public final Paint f41897f;
    public final Drawable h;
    public boolean f41898n;
    public final ImageReceiver f41899r;
    public final ImageReceiver f41900s;
    public TLRPC.Document v;
    public TLRPC.Document f41901w;
    public boolean f41902x;
    public final float f41903y;
    ...
    public s0(Context context, float f7) {
        ...
        this.e = textPaint;
        this.f41897f = new Paint(1);
        ImageReceiver imageReceiver = new ImageReceiver(this);
        this.f41899r = imageReceiver;
        ImageReceiver imageReceiver2 = new ImageReceiver(this);
        this.f41900s = imageReceiver2;
        this.E = 1.0f;
        this.O = new RectF();
        new Path();
    ...
    public final void a(Canvas canvas) {
        ...
        canvas.drawRoundRect(rectF, f12, f12, this.f41897f);
        boolean z10 = this.f41898n;
        float f13 = this.f41903y;
        RectF rectF2 = this.d;
        if (z10) {
            ...
            if (e > 0.0f) {
                ...
                ImageReceiver imageReceiver = this.f41900s;
            ...
            if (e < 1.0f) {
                ...
                ImageReceiver imageReceiver2 = this.f41899r;
        ...
        if (isEmpty) {
            ...
            MediaDataController.getInstance(i10).getStickerSet(tL_inputStickerSetShortName, 0, false, new Utilities.Callback(this) {
                ...
                public final void run(Object obj) {
                    switch (r3) {
                        case 0:
                            s0 s0Var = this.f41882b;
                            s0Var.getClass();
                            String str2 = str;
                            TLRPC.Document b10 = s0.b(str2, (TLRPC.TL_messages_stickerSet) obj);
                            s0Var.v = b10;
                            s0Var.f41899r.setImage(ImageLocation.getForDocument(b10), "80_80", s0.c(str2), null, null, 0);
                            s0Var.f41900s.setImage(ImageLocation.getForDocument(s0Var.f41901w), "80_80", ImageLocation.getForDocument(s0Var.v), "80_80", null, null, s0.c(str2), 0L, null, null, 0);
                            return;
                        default:
                            s0 s0Var2 = this.f41882b;
                            s0Var2.getClass();
                            String str3 = str;
                            TLRPC.Document b11 = s0.b(str3, (TLRPC.TL_messages_stickerSet) obj);
                            s0Var2.f41901w = b11;
                            if (b11 != null) {
                                s0Var2.f41900s.setImage(ImageLocation.getForDocument(b11), "80_80", ImageLocation.getForDocument(s0Var2.v), "80_80", null, null, s0.c(str3), 0L, null, null, 0);
                                return;
                            }
                            return;
                    }
            ...
            imageReceiver.setImage(ImageLocation.getForDocument(this.f41901w), "80_80", ImageLocation.getForDocument(this.v), "80_80", null, null, c(str), 0L, null, null, 0);
        }
        this.f41896c = true;
        requestLayout();
    }
    ...
    public final void f() {
        ...
        if (min < 0.4f) {
            ...
            f10 = 1.0f;
            this.F = new StaticLayout(this.f41895b, textPaint, (int) Math.ceil(measureText), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
        }
        this.G = 0.0f;
    ...
    public TLRPC.Document getCodeEmojiDocument() {
        ...
        if (this.L && (document = this.f41901w) != null) {
            return document;
        }
        return this.v;
    }
    ...
    public final void onAttachedToWindow() {
        ...
        this.K = true;
        if (this.L) {
            this.f41900s.onAttachedToWindow();
        } else {
            this.f41899r.onAttachedToWindow();
        }
    }
    ...
    public final void onDetachedFromWindow() {
        ...
        this.K = false;
        this.f41899r.onDetachedFromWindow();
        this.f41900s.onDetachedFromWindow();
    }
