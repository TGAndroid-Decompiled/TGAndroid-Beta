...
public final class l0 implements ValueAnimator.AnimatorUpdateListener {
    ...
    public final void onAnimationUpdate(final ValueAnimator valueAnimator) {
        switch (this.f44504a) {
            case 0:
                final q0 q0Var = this.f44505b;
                q0Var.f44550f.f(new Runnable() {
                    @Override
                ...
                return;
            default:
                final q0 q0Var2 = this.f44505b;
                q0Var2.f44550f.f(new Runnable() {
                    @Override
                    public final void run() {
                        switch (r3) {
                            case 0:
