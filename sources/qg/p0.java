...
public abstract class p0 extends rv0 implements t1, h, p1, pv0, NotificationCenter.NotificationCenterDelegate {
    ...
    public final FrameLayout f41538b1;
    public final Paint f41539b2;
    public final m0 f41540c1;
    public ch.d f41541c2;
    public final k0 f41542d1;
    public final float[] f41543d2;
    public final FrameLayout f41544e1;
    public final int[] f41545e2;
    public x5 f41546f1;
    public kz f41547f2;
    public int f41548g1;
    public boolean f41549g2;
    public int f41550h1;
    public boolean f41551h2;
    public float f41552i1;
    public boolean f41553i2;
    public ValueAnimator f41554j1;
    public int f41555j2;
    public boolean f41556k1;
    public int f41557k2;
    public final z1 l1;
    public int f41558l2;
    public final k2.c0 f41559m1;
    public int f41560m2;
    public ArrayList f41561n1;
    public boolean f41562n2;
    public final int f41563o1;
    public BigInteger f41564p1;
    public TextView f41565q1;
    public TextView f41566r1;
    public TextView f41567s1;
    public final u1 f41568t1;
    public final r1 f41569u1;
    public final w1 f41570v1;
    public final ImageView f41571w1;
    public final LinearLayout f41572x1;
    public final TextView f41573y1;
    public final TextView f41574z1;
    ...
    public p0(Context context, Activity activity, int i10, Bitmap bitmap, Bitmap bitmap2, int i11, ArrayList arrayList, MediaController.CropState cropState, kr0 kr0Var, f6 f6Var) {
        ...
        this.f41559m1 = new k2.c0(cu0Var, 20);
        this.B1 = new Paint(1);
        this.C1 = new Paint(1);
        this.H1 = new Paint(1);
        this.I1 = new Paint(1);
        ...
        new Matrix();
        this.f41543d2 = new float[2];
        this.f41545e2 = new int[2];
        new b0(cu0Var, 0);
        setDelegate(this);
        this.P1 = i10;
        ...
        this.F0 = t1Var;
        t1Var.f41034a = new k2.v(cu0Var, 19);
        ...
        if (arrayList != null && !arrayList.isEmpty()) {
            ...
            while (i14 < size) {
                ...
                a2Var.setX((mediaEntity.f15636x * this.R0.f25695a) - (((1.0f - mediaEntity.scale) * mediaEntity.viewWidth) / f7));
                a2Var.setY((mediaEntity.f15637y * this.R0.f25696b) - (((1.0f - mediaEntity.scale) * mediaEntity.viewHeight) / f7));
                ...
                switch (r2) {
                    case 0:
                        ...
                        if (e0Var2 != null && (e0Var2.getCurrentBrush() instanceof pg.l)) {
                            e0Var2.b();
                            cu0Var2.f41568t1.setSelectedIndex(1);
                            cu0Var2.b((pg.m) pg.m.f40934a.get(0));
                            return;
                        }
                        cu0Var2.F0.c();
                        return;
                    case 1:
                        ...
                        if (t1Var2.a()) {
                            if (e0Var3 != null && (e0Var3.getCurrentBrush() instanceof pg.l)) {
                                e0Var3.b();
                                cu0Var3.f41568t1.setSelectedIndex(1);
                                cu0Var3.b((pg.m) pg.m.f40934a.get(0));
                            }
                            e0Var3.a();
        ...
        z1Var.setValueOverride(this.f41559m1);
        this.K1.f40994c = this.f41559m1.get();
        z1Var.setOnUpdate(new v(cu0Var, i10, 0));
        addView(z1Var, w7.x5.c(-1.0f, -1));
        FrameLayout frameLayout3 = new FrameLayout(context);
        this.f41544e1 = frameLayout3;
    ...
    public static void b0(p0 p0Var) {
        ...
        if (jVar != null) {
            ...
            if (jVar2 instanceof q2) {
                ...
                x2Var.setMaxWidth((int) (p0Var.getPaintingSize().f25695a - 20.0f));
    ...
    public ViewGroup getBarView() {
        if (this.f41548g1 == 2) {
            return this.f41569u1;
        }
        return this.f41568t1;
    }

    private int getFrameRotation() {
        int i10 = this.f41563o1;
        if (i10 != 90) {
            if (i10 != 180) {
                if (i10 != 270) {
                    return 0;
    ...
    private kv0 getPaintingSize() {
        ...
        if (floor > f7) {
            kv0Var2.f25696b = f7;
            kv0Var2.f25695a = (float) Math.floor((f7 * width) / height);
        }
        this.R0 = kv0Var2;
        return kv0Var2;
    }
    ...
    private void setTextType(int i10) {
        ...
        this.f41569u1.setOutlineType(i10);
    }
    ...
    private void setupTabsLayout(Context context) {
        ...
        this.f41546f1.setOrientation(0);
        this.f41540c1.addView(this.f41546f1, w7.x5.d(-1, 40.0f, 80, 52.0f, 0.0f, 52.0f, 0.0f));
        TextView textView = new TextView(context);
        this.f41565q1 = textView;
        textView.setText(LocaleController.getString(R.string.PhotoEditorDraw).toUpperCase());
        TextView textView2 = this.f41565q1;
        int i10 = j6.f18952i6;
        eh.a aVar = this.Q1;
        textView2.setBackground(j6.f0(j6.v0(i10, aVar), 7, -1));
        this.f41565q1.setPadding(0, AndroidUtilities.dp(8.0f), 0, AndroidUtilities.dp(8.0f));
        this.f41565q1.setTextColor(-1);
        this.f41565q1.setTextSize(1, 14.0f);
        this.f41565q1.setGravity(1);
        this.f41565q1.setTypeface(AndroidUtilities.bold());
        this.f41565q1.setSingleLine();
        this.f41565q1.setOnClickListener(new k(this, 0));
        this.f41546f1.addView(this.f41565q1, w7.x5.l(1.0f, 0, -2));
        TextView textView3 = new TextView(context);
        this.f41566r1 = textView3;
        textView3.setText(LocaleController.getString(R.string.PhotoEditorSticker).toUpperCase());
        this.f41566r1.setBackground(j6.f0(j6.v0(i10, aVar), 7, -1));
        this.f41566r1.setPadding(0, AndroidUtilities.dp(8.0f), 0, AndroidUtilities.dp(8.0f));
        this.f41566r1.setOnClickListener(new k(this, 1));
        this.f41566r1.setTextColor(-1);
        this.f41566r1.setTextSize(1, 14.0f);
        this.f41566r1.setGravity(1);
        this.f41566r1.setTypeface(AndroidUtilities.bold());
        this.f41566r1.setAlpha(0.6f);
        this.f41566r1.setSingleLine();
        this.f41546f1.addView(this.f41566r1, w7.x5.l(1.0f, 0, -2));
        TextView textView4 = new TextView(context);
        this.f41567s1 = textView4;
        textView4.setText(LocaleController.getString(R.string.PhotoEditorText).toUpperCase());
        this.f41567s1.setBackground(j6.f0(j6.v0(i10, aVar), 7, -1));
        this.f41567s1.setPadding(0, AndroidUtilities.dp(8.0f), 0, AndroidUtilities.dp(8.0f));
        this.f41567s1.setTextColor(-1);
        this.f41567s1.setTextSize(1, 14.0f);
        this.f41567s1.setGravity(1);
        this.f41567s1.setTypeface(AndroidUtilities.bold());
        this.f41567s1.setAlpha(0.6f);
        this.f41567s1.setSingleLine();
        this.f41567s1.setOnClickListener(new k(this, 4));
        this.f41546f1.addView(this.f41567s1, w7.x5.l(1.0f, 0, -2));
    }
    ...
    public final void B0(int i10) {
        ...
        boolean z10;
        if (this.f41548g1 != i10 && this.f41550h1 != i10) {
            ValueAnimator valueAnimator = this.f41554j1;
            if (valueAnimator != null) {
                valueAnimator.cancel();
            }
            int i11 = this.f41548g1;
            ViewGroup viewGroup3 = this.f41569u1;
            ViewGroup viewGroup4 = this.f41568t1;
            if (i11 == 0) {
            ...
            this.f41554j1 = duration;
            duration.setInterpolator(qr.f27380f);
            this.f41554j1.addUpdateListener(new x4(this, viewGroup, viewGroup2, 4));
            this.f41554j1.addListener(new y5(this, viewGroup, viewGroup2, i10, 2));
            this.f41554j1.start();
        }
    }
        ...
        while (true) {
            ...
            if (i10 < i0Var.getChildCount()) {
                ...
                if (childAt != this.S0) {
                    if (childAt instanceof j) {
                        j jVar = (j) childAt;
                        if (!jVar.f41434l0 && jVar.f41432j0 <= 0.0f) {
                        }
                    }
                    i10++;
                }
    ...
    public final void H(int i10, boolean z10) {
        ...
        boolean z12;
        int i11;
        if (i10 > AndroidUtilities.dp(50.0f) && this.f41551h2 && !AndroidUtilities.isInMultiwindow && !AndroidUtilities.isTablet()) {
            if (z10) {
                this.f41558l2 = i10;
                MessagesController.getGlobalEmojiSettings().edit().putInt("kbd_height_land3", this.f41558l2).commit();
            } else {
                this.f41557k2 = i10;
                MessagesController.getGlobalEmojiSettings().edit().putInt("kbd_height", this.f41557k2).commit();
            }
        }
        if (this.f41549g2) {
            if (z10) {
            ...
            FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) this.f41547f2.getLayoutParams();
            int i12 = layoutParams.width;
            int i13 = AndroidUtilities.displaySize.x;
            if (i12 != i13 || layoutParams.height != i11) {
                layoutParams.width = i13;
                layoutParams.height = i11;
                this.f41547f2.setLayoutParams(layoutParams);
                this.f41555j2 = layoutParams.height;
                requestLayout();
                j4 j4Var = ((cu0) this).f32920o2.K1;
                if (j4Var != null) {
                    j4Var.a();
                }
                getHeight();
        ...
        if (this.f41560m2 == i10 && this.f41562n2 == z10) {
            getHeight();
            return;
        }
        this.f41560m2 = i10;
        this.f41562n2 = z10;
        boolean z13 = this.f41551h2;
        j jVar = this.S0;
        if (jVar instanceof x2) {
        ...
        if (this.f41551h2 && this.f41549g2) {
            x0(0);
        }
        if (this.f41555j2 != 0 && !(z11 = this.f41551h2) && z11 != z13 && !this.f41549g2) {
            this.f41555j2 = 0;
            requestLayout();
            j4 j4Var2 = ((cu0) this).f32920o2.K1;
            if (j4Var2 != null) {
                j4Var2.a();
            }
        }
    ...
    public final void b(pg.m mVar) {
        ...
        q1Var.f40992a = pg.s0.e(this.P1).c();
        q1Var.f40994c = this.f41559m1.get();
    ...
    public final PointF g0() {
        ...
        float f7 = paintingSize.f25695a / 2.0f;
        float f10 = paintingSize.f25696b / 2.0f;
        if (this.H0 != null) {
            ...
            f7 -= cos * paintingSize.f25695a;
            f10 -= e * paintingSize.f25696b;
        }
    ...
    public long getLcm() {
        return this.f41564p1.longValue();
    }
    ...
    public y01 getThanosEffect() {
        ...
        if (this.f41537a1 == null) {
            y01 y01Var = new y01(getContext(), new n(this, 0));
            this.f41537a1 = y01Var;
            addView(y01Var);
        }
        return this.f41537a1;
    }
    ...
    public final x2 j0(boolean z10) {
        ((cu0) this).f32920o2.f30967g0.isFocusable();
        kv0 paintingSize = getPaintingSize();
        PointF A0 = A0(null);
        x2 x2Var = new x2(getContext(), A0, (int) (paintingSize.f25695a / 9.0f), "", this.K1, this.U0);
        ...
        x2Var.setMaxWidth((int) (paintingSize.f25695a - 20.0f));
        int i10 = this.P1;
    ...
    public final void l0(boolean z10) {
        ...
        if (z10) {
            kz kzVar = this.f41547f2;
            if (kzVar != null && kzVar.getVisibility() == 0) {
                ValueAnimator ofFloat = ValueAnimator.ofFloat(0.0f, this.f41547f2.getMeasuredHeight());
    ...
    public final void m0() {
        kz kzVar;
        j4 j4Var;
        if (this.f41555j2 > 0 && (j4Var = ((cu0) this).f32920o2.K1) != null) {
            j4Var.a();
        }
        if (!this.f41549g2 && (kzVar = this.f41547f2) != null && kzVar.getVisibility() != 8) {
            this.f41547f2.setVisibility(8);
        }
        this.f41555j2 = 0;
    }
    ...
    public final void n0(boolean z10) {
        ...
        if (this.f41548g1 == 0) {
            ...
            this.f41540c1.setLayerType(i11, null);
            if (z10) {
                i12 = 2;
            }
            this.f41538b1.setLayerType(i12, null);
        }
    }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        int i15 = i13 - i11;
        int i16 = 0;
        if (this.f41547f2 != null) {
            if (AndroidUtilities.isTablet()) {
                R = i15 - this.f41547f2.getMeasuredHeight();
            } else {
                R = (R() + i15) - this.f41547f2.getMeasuredHeight();
            }
            kz kzVar = this.f41547f2;
            kzVar.layout(0, R, kzVar.getMeasuredWidth(), this.f41547f2.getMeasuredHeight() + R);
        }
        if (!this.V0) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        float f12 = f10 / this.R0.f25695a;
        this.Q0 = f12;
        i0 i0Var = this.Z0;
        i0Var.setScaleX(f12);
        i0Var.setScaleY(this.Q0);
        i0Var.measure(View.MeasureSpec.makeMeasureSpec((int) this.R0.f25695a, 1073741824), View.MeasureSpec.makeMeasureSpec((int) this.R0.f25696b, 1073741824));
        y01 y01Var = this.f41537a1;
        if (y01Var != null) {
            y01Var.measure(View.MeasureSpec.makeMeasureSpec((int) this.R0.f25695a, 1073741824), View.MeasureSpec.makeMeasureSpec((int) this.R0.f25696b, 1073741824));
            this.f41537a1.setScaleX(this.Q0);
            this.f41537a1.setScaleY(this.Q0);
        }
        C0();
        this.Y0.measure(View.MeasureSpec.makeMeasureSpec(i12, 1073741824), View.MeasureSpec.makeMeasureSpec(i13, 1073741824));
        measureChild(this.f41540c1, i10, i11);
        measureChild(this.l1, i10, i11);
        measureChild(this.f41544e1, i10, i11);
        measureChild(this.f41542d1, i10, View.MeasureSpec.makeMeasureSpec(size2 - Math.max(getPKeyboardHeight(), this.f41555j2), 1073741824));
        FrameLayout frameLayout = this.f41538b1;
        ...
        this.P0 = false;
        if (AndroidUtilities.dp(20.0f) >= 0 && !this.f41549g2 && !this.f41553i2) {
            this.P0 = true;
            m0();
            this.P0 = false;
        }
    ...
    public final void q0(j jVar) {
        ...
        if (jVar == jVar2 && jVar2 != null) {
            ...
            if (jVar instanceof x2) {
                ValueAnimator valueAnimator = this.f41554j1;
                if (valueAnimator != null && this.f41550h1 != 0) {
                    valueAnimator.cancel();
                }
                B0(0);
            }
    ...
    public final boolean r0(j jVar, boolean z10) {
        ...
        int i11 = 2;
        if (z12 && (((i10 = this.f41550h1) == -1 && this.f41548g1 != 2) || (i10 != -1 && i10 != 2))) {
            ValueAnimator valueAnimator = this.f41554j1;
        ...
        if (z12 && z10) {
            ...
            r1Var.setTypeface(x2Var.getTypeface().f40909a);
            r1Var.e(x2Var.getType(), true);
            this.f41542d1.invalidate();
        }
        j jVar2 = this.S0;
        if (jVar2 != null) {
            if (jVar2 == jVar) {
        ...
        if (jVar5 != null) {
            ...
            if (jVar6 instanceof x2) {
                ...
                z1Var.setValueOverride(new u5(x2Var3, (int) (p0Var.R0.f25695a / 9.0f), 1));
                z1Var.setShowPreview(false);
                return true;
            }
            z1Var.setValueOverride(c0Var);
            z1Var.setShowPreview(true);
            q1Var.f40994c = c0Var.get();
            s0(q1Var, null);
            return true;
        }
        ValueAnimator valueAnimator2 = p0Var.f41554j1;
        if (valueAnimator2 != null && p0Var.f41550h1 != 0) {
    ...
    public final void s0(pg.q1 q1Var, Integer num) {
        ...
        e0 e0Var = this.W0;
        e0Var.setColor(i11);
        e0Var.setBrushSize(q1Var.f40994c);
        ...
        j jVar = this.S0;
        if (jVar instanceof x2) {
            ((x2) jVar).setSwatch(new pg.q1(q1Var.f40993b, q1Var.f40994c, q1Var.f40992a));
        }
    }
    ...
    public final void t() {
        ...
        boolean z10 = this.f41549g2;
        if (z10 && (j4Var = ((cu0) this).f32920o2.K1) != null) {
            j4Var.e = true;
        }
        x0(!z10 ? 1 : 0);
        if (z10) {
    ...
    public final void t0(float f7) {
        this.C0 = f7;
        this.f41538b1.setTranslationY(-f7);
        this.f41540c1.setTranslationY(f7);
    }
    ...
    public final void v0(float f7, float f10, float f11, float f12, float f13) {
        ...
        for (int i10 = 0; i10 < 4; i10++) {
            ...
            float f23 = ((-this.f41555j2) / 2.0f) + f16;
            float f24 = f7 * f14;
            if (Float.isNaN(f24)) {
                f24 = 1.0f;
            }
    ...
    public final void w0(final boolean z10) {
        ...
        if (this.L1 != z10) {
            ...
            final float translationY = this.f41540c1.getTranslationY();
            ...
            this.M1.b(new o1.g() {
                ...
                public final void a(o1.h hVar, float f11, float f12) {
                    ...
                    p0Var.f41546f1.setTranslationY(AndroidUtilities.dp(32.0f) * p0Var.N1);
                    if (zArr[0]) {
                        float f16 = p0Var.N1;
                        if (!z12) {
                            f16 = 1.0f - f16;
    ...
    public final void x0(int i10) {
        ...
        if (i10 == 1) {
            ...
            if (this.f41547f2 == null) {
                ...
                this.f41547f2 = kzVar3;
                kzVar3.U0 = true;
                kzVar3.setVisibility(8);
                if (AndroidUtilities.isTablet()) {
                    this.f41547f2.setForseMultiwindowLayout(true);
                }
                this.f41547f2.setDelegate(new d0(this));
                addView(this.f41547f2);
            }
            this.f41547f2.setVisibility(0);
            this.f41549g2 = true;
            kz kzVar4 = this.f41547f2;
            if (this.f41557k2 <= 0) {
                if (AndroidUtilities.isTablet()) {
                    this.f41557k2 = AndroidUtilities.dp(150.0f);
                } else {
                    this.f41557k2 = MessagesController.getGlobalEmojiSettings().getInt("kbd_height", AndroidUtilities.dp(200.0f));
                }
            }
            if (this.f41558l2 <= 0) {
                if (AndroidUtilities.isTablet()) {
                    this.f41558l2 = AndroidUtilities.dp(150.0f);
                } else {
                    this.f41558l2 = MessagesController.getGlobalEmojiSettings().getInt("kbd_height_land3", AndroidUtilities.dp(200.0f));
                }
            }
            Point point = AndroidUtilities.displaySize;
            if (point.x > point.y) {
            ...
            getHeight();
            if (!z10 && !this.f41551h2) {
                ValueAnimator ofFloat = ValueAnimator.ofFloat(this.f41555j2, 0.0f);
