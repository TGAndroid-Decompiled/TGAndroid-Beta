...
public abstract class p0 extends qv0 implements t1, h, p1, ov0, NotificationCenter.NotificationCenterDelegate {
    ...
    public final FrameLayout f41516b1;
    public final Paint f41517b2;
    public final m0 f41518c1;
    public ch.d f41519c2;
    public final k0 f41520d1;
    public final float[] f41521d2;
    public final FrameLayout f41522e1;
    public final int[] f41523e2;
    public x5 f41524f1;
    public kz f41525f2;
    public int f41526g1;
    public boolean f41527g2;
    public int f41528h1;
    public boolean f41529h2;
    public float f41530i1;
    public boolean f41531i2;
    public ValueAnimator f41532j1;
    public int f41533j2;
    public boolean f41534k1;
    public int f41535k2;
    public final z1 l1;
    public int f41536l2;
    public final k2.c0 f41537m1;
    public int f41538m2;
    public ArrayList f41539n1;
    public boolean f41540n2;
    public final int f41541o1;
    public BigInteger f41542p1;
    public TextView f41543q1;
    public TextView f41544r1;
    public TextView f41545s1;
    public final u1 f41546t1;
    public final r1 f41547u1;
    public final w1 f41548v1;
    public final ImageView f41549w1;
    public final LinearLayout f41550x1;
    public final TextView f41551y1;
    public final TextView f41552z1;
    ...
    public p0(Context context, Activity activity, int i10, Bitmap bitmap, Bitmap bitmap2, int i11, ArrayList arrayList, MediaController.CropState cropState, ir0 ir0Var, e6 e6Var) {
        ...
        this.f41537m1 = new k2.c0(au0Var, 20);
        this.B1 = new Paint(1);
        this.C1 = new Paint(1);
        this.H1 = new Paint(1);
        this.I1 = new Paint(1);
        ...
        new Matrix();
        this.f41521d2 = new float[2];
        this.f41523e2 = new int[2];
        new b0(au0Var, 0);
        setDelegate(this);
        this.P1 = i10;
        ...
        this.F0 = t1Var;
        t1Var.f41012a = new k2.v(au0Var, 19);
        ...
        if (arrayList != null && !arrayList.isEmpty()) {
            ...
            while (i14 < size) {
                ...
                a2Var.setX((mediaEntity.f15627x * this.R0.f25443a) - (((1.0f - mediaEntity.scale) * mediaEntity.viewWidth) / f7));
                a2Var.setY((mediaEntity.f15628y * this.R0.f25444b) - (((1.0f - mediaEntity.scale) * mediaEntity.viewHeight) / f7));
                ...
                switch (r2) {
                    case 0:
                        ...
                        if (e0Var2 != null && (e0Var2.getCurrentBrush() instanceof pg.l)) {
                            e0Var2.b();
                            au0Var2.f41546t1.setSelectedIndex(1);
                            au0Var2.b((pg.m) pg.m.f40912a.get(0));
                            return;
                        }
                        au0Var2.F0.c();
                        return;
                    case 1:
                        ...
                        if (t1Var2.a()) {
                            if (e0Var3 != null && (e0Var3.getCurrentBrush() instanceof pg.l)) {
                                e0Var3.b();
                                au0Var3.f41546t1.setSelectedIndex(1);
                                au0Var3.b((pg.m) pg.m.f40912a.get(0));
                            }
                            e0Var3.a();
        ...
        z1Var.setValueOverride(this.f41537m1);
        this.K1.f40972c = this.f41537m1.get();
        z1Var.setOnUpdate(new v(au0Var, i10, 0));
        addView(z1Var, w7.x5.c(-1.0f, -1));
        FrameLayout frameLayout3 = new FrameLayout(context);
        this.f41522e1 = frameLayout3;
    ...
    public static void b0(p0 p0Var) {
        ...
        if (jVar != null) {
            ...
            if (jVar2 instanceof q2) {
                ...
                x2Var.setMaxWidth((int) (p0Var.getPaintingSize().f25443a - 20.0f));
    ...
    public ViewGroup getBarView() {
        if (this.f41526g1 == 2) {
            return this.f41547u1;
        }
        return this.f41546t1;
    }

    private int getFrameRotation() {
        int i10 = this.f41541o1;
        if (i10 != 90) {
            if (i10 != 180) {
                if (i10 != 270) {
                    return 0;
    ...
    private jv0 getPaintingSize() {
        ...
        if (floor > f7) {
            jv0Var2.f25444b = f7;
            jv0Var2.f25443a = (float) Math.floor((f7 * width) / height);
        }
        this.R0 = jv0Var2;
        return jv0Var2;
    }
    ...
    private void setTextType(int i10) {
        ...
        this.f41547u1.setOutlineType(i10);
    }
    ...
    private void setupTabsLayout(Context context) {
        ...
        this.f41524f1.setOrientation(0);
        this.f41518c1.addView(this.f41524f1, w7.x5.d(-1, 40.0f, 80, 52.0f, 0.0f, 52.0f, 0.0f));
        TextView textView = new TextView(context);
        this.f41543q1 = textView;
        textView.setText(LocaleController.getString(R.string.PhotoEditorDraw).toUpperCase());
        TextView textView2 = this.f41543q1;
        int i10 = i6.f18926i6;
        eh.a aVar = this.Q1;
        textView2.setBackground(i6.f0(i6.v0(i10, aVar), 7, -1));
        this.f41543q1.setPadding(0, AndroidUtilities.dp(8.0f), 0, AndroidUtilities.dp(8.0f));
        this.f41543q1.setTextColor(-1);
        this.f41543q1.setTextSize(1, 14.0f);
        this.f41543q1.setGravity(1);
        this.f41543q1.setTypeface(AndroidUtilities.bold());
        this.f41543q1.setSingleLine();
        this.f41543q1.setOnClickListener(new k(this, 0));
        this.f41524f1.addView(this.f41543q1, w7.x5.l(1.0f, 0, -2));
        TextView textView3 = new TextView(context);
        this.f41544r1 = textView3;
        textView3.setText(LocaleController.getString(R.string.PhotoEditorSticker).toUpperCase());
        this.f41544r1.setBackground(i6.f0(i6.v0(i10, aVar), 7, -1));
        this.f41544r1.setPadding(0, AndroidUtilities.dp(8.0f), 0, AndroidUtilities.dp(8.0f));
        this.f41544r1.setOnClickListener(new k(this, 1));
        this.f41544r1.setTextColor(-1);
        this.f41544r1.setTextSize(1, 14.0f);
        this.f41544r1.setGravity(1);
        this.f41544r1.setTypeface(AndroidUtilities.bold());
        this.f41544r1.setAlpha(0.6f);
        this.f41544r1.setSingleLine();
        this.f41524f1.addView(this.f41544r1, w7.x5.l(1.0f, 0, -2));
        TextView textView4 = new TextView(context);
        this.f41545s1 = textView4;
        textView4.setText(LocaleController.getString(R.string.PhotoEditorText).toUpperCase());
        this.f41545s1.setBackground(i6.f0(i6.v0(i10, aVar), 7, -1));
        this.f41545s1.setPadding(0, AndroidUtilities.dp(8.0f), 0, AndroidUtilities.dp(8.0f));
        this.f41545s1.setTextColor(-1);
        this.f41545s1.setTextSize(1, 14.0f);
        this.f41545s1.setGravity(1);
        this.f41545s1.setTypeface(AndroidUtilities.bold());
        this.f41545s1.setAlpha(0.6f);
        this.f41545s1.setSingleLine();
        this.f41545s1.setOnClickListener(new k(this, 4));
        this.f41524f1.addView(this.f41545s1, w7.x5.l(1.0f, 0, -2));
    }
    ...
    public final void B0(int i10) {
        ...
        boolean z10;
        if (this.f41526g1 != i10 && this.f41528h1 != i10) {
            ValueAnimator valueAnimator = this.f41532j1;
            if (valueAnimator != null) {
                valueAnimator.cancel();
            }
            int i11 = this.f41526g1;
            ViewGroup viewGroup3 = this.f41547u1;
            ViewGroup viewGroup4 = this.f41546t1;
            if (i11 == 0) {
            ...
            this.f41532j1 = duration;
            duration.setInterpolator(qr.f27423f);
            this.f41532j1.addUpdateListener(new x4(this, viewGroup, viewGroup2, 4));
            this.f41532j1.addListener(new y5(this, viewGroup, viewGroup2, i10, 2));
            this.f41532j1.start();
        }
    }
        ...
        while (true) {
            ...
            if (i10 < i0Var.getChildCount()) {
                ...
                if (childAt != this.S0) {
                    if (childAt instanceof j) {
                        j jVar = (j) childAt;
                        if (!jVar.f41412l0 && jVar.f41410j0 <= 0.0f) {
                        }
                    }
                    i10++;
                }
    ...
    public final void H(int i10, boolean z10) {
        ...
        boolean z12;
        int i11;
        if (i10 > AndroidUtilities.dp(50.0f) && this.f41529h2 && !AndroidUtilities.isInMultiwindow && !AndroidUtilities.isTablet()) {
            if (z10) {
                this.f41536l2 = i10;
                MessagesController.getGlobalEmojiSettings().edit().putInt("kbd_height_land3", this.f41536l2).commit();
            } else {
                this.f41535k2 = i10;
                MessagesController.getGlobalEmojiSettings().edit().putInt("kbd_height", this.f41535k2).commit();
            }
        }
        if (this.f41527g2) {
            if (z10) {
            ...
            FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) this.f41525f2.getLayoutParams();
            int i12 = layoutParams.width;
            int i13 = AndroidUtilities.displaySize.x;
            if (i12 != i13 || layoutParams.height != i11) {
                layoutParams.width = i13;
                layoutParams.height = i11;
                this.f41525f2.setLayoutParams(layoutParams);
                this.f41533j2 = layoutParams.height;
                requestLayout();
                j4 j4Var = ((au0) this).f31957o2.K1;
                if (j4Var != null) {
                    j4Var.a();
                }
                getHeight();
        ...
        if (this.f41538m2 == i10 && this.f41540n2 == z10) {
            getHeight();
            return;
        }
        this.f41538m2 = i10;
        this.f41540n2 = z10;
        boolean z13 = this.f41529h2;
        j jVar = this.S0;
        if (jVar instanceof x2) {
        ...
        if (this.f41529h2 && this.f41527g2) {
            x0(0);
        }
        if (this.f41533j2 != 0 && !(z11 = this.f41529h2) && z11 != z13 && !this.f41527g2) {
            this.f41533j2 = 0;
            requestLayout();
            j4 j4Var2 = ((au0) this).f31957o2.K1;
            if (j4Var2 != null) {
                j4Var2.a();
            }
        }
    ...
    public final void b(pg.m mVar) {
        ...
        q1Var.f40970a = pg.s0.e(this.P1).c();
        q1Var.f40972c = this.f41537m1.get();
    ...
    public final PointF g0() {
        ...
        float f7 = paintingSize.f25443a / 2.0f;
        float f10 = paintingSize.f25444b / 2.0f;
        if (this.H0 != null) {
            ...
            f7 -= cos * paintingSize.f25443a;
            f10 -= e * paintingSize.f25444b;
        }
    ...
    public long getLcm() {
        return this.f41542p1.longValue();
    }
    ...
    public x01 getThanosEffect() {
        ...
        if (this.f41515a1 == null) {
            x01 x01Var = new x01(getContext(), new n(this, 0));
            this.f41515a1 = x01Var;
            addView(x01Var);
        }
        return this.f41515a1;
    }
    ...
    public final x2 j0(boolean z10) {
        ((au0) this).f31957o2.f30953g0.isFocusable();
        jv0 paintingSize = getPaintingSize();
        PointF A0 = A0(null);
        x2 x2Var = new x2(getContext(), A0, (int) (paintingSize.f25443a / 9.0f), "", this.K1, this.U0);
        ...
        x2Var.setMaxWidth((int) (paintingSize.f25443a - 20.0f));
        int i10 = this.P1;
    ...
    public final void l0(boolean z10) {
        ...
        if (z10) {
            kz kzVar = this.f41525f2;
            if (kzVar != null && kzVar.getVisibility() == 0) {
                ValueAnimator ofFloat = ValueAnimator.ofFloat(0.0f, this.f41525f2.getMeasuredHeight());
    ...
    public final void m0() {
        kz kzVar;
        j4 j4Var;
        if (this.f41533j2 > 0 && (j4Var = ((au0) this).f31957o2.K1) != null) {
            j4Var.a();
        }
        if (!this.f41527g2 && (kzVar = this.f41525f2) != null && kzVar.getVisibility() != 8) {
            this.f41525f2.setVisibility(8);
        }
        this.f41533j2 = 0;
    }
    ...
    public final void n0(boolean z10) {
        ...
        if (this.f41526g1 == 0) {
            ...
            this.f41518c1.setLayerType(i11, null);
            if (z10) {
                i12 = 2;
            }
            this.f41516b1.setLayerType(i12, null);
        }
    }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        int i15 = i13 - i11;
        int i16 = 0;
        if (this.f41525f2 != null) {
            if (AndroidUtilities.isTablet()) {
                R = i15 - this.f41525f2.getMeasuredHeight();
            } else {
                R = (R() + i15) - this.f41525f2.getMeasuredHeight();
            }
            kz kzVar = this.f41525f2;
            kzVar.layout(0, R, kzVar.getMeasuredWidth(), this.f41525f2.getMeasuredHeight() + R);
        }
        if (!this.V0) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        float f12 = f10 / this.R0.f25443a;
        this.Q0 = f12;
        i0 i0Var = this.Z0;
        i0Var.setScaleX(f12);
        i0Var.setScaleY(this.Q0);
        i0Var.measure(View.MeasureSpec.makeMeasureSpec((int) this.R0.f25443a, 1073741824), View.MeasureSpec.makeMeasureSpec((int) this.R0.f25444b, 1073741824));
        x01 x01Var = this.f41515a1;
        if (x01Var != null) {
            x01Var.measure(View.MeasureSpec.makeMeasureSpec((int) this.R0.f25443a, 1073741824), View.MeasureSpec.makeMeasureSpec((int) this.R0.f25444b, 1073741824));
            this.f41515a1.setScaleX(this.Q0);
            this.f41515a1.setScaleY(this.Q0);
        }
        C0();
        this.Y0.measure(View.MeasureSpec.makeMeasureSpec(i12, 1073741824), View.MeasureSpec.makeMeasureSpec(i13, 1073741824));
        measureChild(this.f41518c1, i10, i11);
        measureChild(this.l1, i10, i11);
        measureChild(this.f41522e1, i10, i11);
        measureChild(this.f41520d1, i10, View.MeasureSpec.makeMeasureSpec(size2 - Math.max(getPKeyboardHeight(), this.f41533j2), 1073741824));
        FrameLayout frameLayout = this.f41516b1;
        ...
        this.P0 = false;
        if (AndroidUtilities.dp(20.0f) >= 0 && !this.f41527g2 && !this.f41531i2) {
            this.P0 = true;
            m0();
            this.P0 = false;
        }
    ...
    public final void q0(j jVar) {
        ...
        if (jVar == jVar2 && jVar2 != null) {
            ...
            if (jVar instanceof x2) {
                ValueAnimator valueAnimator = this.f41532j1;
                if (valueAnimator != null && this.f41528h1 != 0) {
                    valueAnimator.cancel();
                }
                B0(0);
            }
    ...
    public final boolean r0(j jVar, boolean z10) {
        ...
        int i11 = 2;
        if (z12 && (((i10 = this.f41528h1) == -1 && this.f41526g1 != 2) || (i10 != -1 && i10 != 2))) {
            ValueAnimator valueAnimator = this.f41532j1;
        ...
        if (z12 && z10) {
            ...
            r1Var.setTypeface(x2Var.getTypeface().f40887a);
            r1Var.e(x2Var.getType(), true);
            this.f41520d1.invalidate();
        }
        j jVar2 = this.S0;
        if (jVar2 != null) {
            if (jVar2 == jVar) {
        ...
        if (jVar5 != null) {
            ...
            if (jVar6 instanceof x2) {
                ...
                z1Var.setValueOverride(new u5(x2Var3, (int) (p0Var.R0.f25443a / 9.0f), 1));
                z1Var.setShowPreview(false);
                return true;
            }
            z1Var.setValueOverride(c0Var);
            z1Var.setShowPreview(true);
            q1Var.f40972c = c0Var.get();
            s0(q1Var, null);
            return true;
        }
        ValueAnimator valueAnimator2 = p0Var.f41532j1;
        if (valueAnimator2 != null && p0Var.f41528h1 != 0) {
    ...
    public final void s0(pg.q1 q1Var, Integer num) {
        ...
        e0 e0Var = this.W0;
        e0Var.setColor(i11);
        e0Var.setBrushSize(q1Var.f40972c);
        ...
        j jVar = this.S0;
        if (jVar instanceof x2) {
            ((x2) jVar).setSwatch(new pg.q1(q1Var.f40971b, q1Var.f40972c, q1Var.f40970a));
        }
    }
    ...
    public final void t() {
        ...
        boolean z10 = this.f41527g2;
        if (z10 && (j4Var = ((au0) this).f31957o2.K1) != null) {
            j4Var.e = true;
        }
        x0(!z10 ? 1 : 0);
        if (z10) {
    ...
    public final void t0(float f7) {
        this.C0 = f7;
        this.f41516b1.setTranslationY(-f7);
        this.f41518c1.setTranslationY(f7);
    }
    ...
    public final void v0(float f7, float f10, float f11, float f12, float f13) {
        ...
        for (int i10 = 0; i10 < 4; i10++) {
            ...
            float f23 = ((-this.f41533j2) / 2.0f) + f16;
            float f24 = f7 * f14;
            if (Float.isNaN(f24)) {
                f24 = 1.0f;
            }
    ...
    public final void w0(final boolean z10) {
        ...
        if (this.L1 != z10) {
            ...
            final float translationY = this.f41518c1.getTranslationY();
            ...
            this.M1.b(new o1.g() {
                ...
                public final void a(o1.h hVar, float f11, float f12) {
                    ...
                    p0Var.f41524f1.setTranslationY(AndroidUtilities.dp(32.0f) * p0Var.N1);
                    if (zArr[0]) {
                        float f16 = p0Var.N1;
                        if (!z12) {
                            f16 = 1.0f - f16;
    ...
    public final void x0(int i10) {
        ...
        if (i10 == 1) {
            ...
            if (this.f41525f2 == null) {
                ...
                this.f41525f2 = kzVar3;
                kzVar3.U0 = true;
                kzVar3.setVisibility(8);
                if (AndroidUtilities.isTablet()) {
                    this.f41525f2.setForseMultiwindowLayout(true);
                }
                this.f41525f2.setDelegate(new d0(this));
                addView(this.f41525f2);
            }
            this.f41525f2.setVisibility(0);
            this.f41527g2 = true;
            kz kzVar4 = this.f41525f2;
            if (this.f41535k2 <= 0) {
                if (AndroidUtilities.isTablet()) {
                    this.f41535k2 = AndroidUtilities.dp(150.0f);
                } else {
                    this.f41535k2 = MessagesController.getGlobalEmojiSettings().getInt("kbd_height", AndroidUtilities.dp(200.0f));
                }
            }
            if (this.f41536l2 <= 0) {
                if (AndroidUtilities.isTablet()) {
                    this.f41536l2 = AndroidUtilities.dp(150.0f);
                } else {
                    this.f41536l2 = MessagesController.getGlobalEmojiSettings().getInt("kbd_height_land3", AndroidUtilities.dp(200.0f));
                }
            }
            Point point = AndroidUtilities.displaySize;
            if (point.x > point.y) {
            ...
            getHeight();
            if (!z10 && !this.f41529h2) {
                ValueAnimator ofFloat = ValueAnimator.ofFloat(this.f41533j2, 0.0f);
