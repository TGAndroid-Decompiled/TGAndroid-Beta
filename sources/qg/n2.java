...
public final class n2 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    public static final int f41807r0 = 0;
    public k2 E;
    public float F;
    public boolean G;
    public k2[] H;
    ...
    public l2 W;
    public int f41808a;
    public final d6 f41809a0;
    public final e6 f41810b;
    public d2 f41811b0;
    public final e6 f41812c;
    public String f41813c0;
    public final Paint d;
    public ci.t0 f41814d0;
    public final Paint e;
    public final Matrix f41815e0;
    public final Paint f41816f;
    public float f41817f0;
    public float f41818g0;
    public final Paint h;
    public final x1 f41819h0;
    public boolean f41820i0;
    public final Matrix f41821j0;
    public Path f41822k0;
    public Path f41823l0;
    public final RectF m0;
    public final PathMeasure f41824n;
    public float f41825n0;
    public float f41826o0;
    public final ArrayList f41827p0;
    public final Rect f41828q0;
    public final Path f41829r;
    public final Path f41830s;
    public final Path v;
    public final Path f41831w;
    public volatile boolean f41832x;
    public volatile boolean f41833y;

    public n2(ContextThemeWrapper contextThemeWrapper, d6 d6Var) {
        super(contextThemeWrapper);
        this.f41808a = -1;
        sr srVar = sr.h;
        this.f41810b = new e6(0.0f, (View) null, 0L, 420L, srVar);
        this.f41812c = new e6(0.0f, (View) null, 0L, 420L, srVar);
        ...
        this.h = paint4;
        this.f41824n = new PathMeasure();
        this.f41829r = new Path();
        this.f41830s = new Path();
        this.v = new Path();
        this.f41831w = new Path();
        this.F = 2.0f;
        this.f41815e0 = new Matrix();
        this.f41821j0 = new Matrix();
        this.m0 = new RectF();
        this.f41827p0 = new ArrayList();
        this.f41828q0 = new Rect();
        this.f41809a0 = d6Var;
        paint.setColor(-1);
    ...
    public final void a() {
        ...
        if (l2Var != null) {
            ...
            l2Var.f41746o = true;
            if (l2Var.f41744m != null) {
                h();
                l2Var.f41744m.run(l2Var.f41736b, l2Var.e.document);
                AndroidUtilities.runOnUIThread(new l21(13), 250L);
            } else if (l2Var.f41742k != null) {
                TLRPC.TL_stickers_replaceSticker tL_stickers_replaceSticker = new TLRPC.TL_stickers_replaceSticker();
                tL_stickers_replaceSticker.sticker = MediaDataController.getInputStickerSetItem(l2Var.f41742k, l2Var.f41737c).document;
                                    ...
                                    public final void run() {
                                        ...
                                        switch (r6) {
                                            case 0:
                                                        ...
                                                        public final void run() {
                                                            ...
                                                            switch (i13) {
                                                                case 0:
                                                                    ...
                                                                    TLRPC.Document document = l2Var4.f41738f.document;
                                                                    String str = l2Var4.f41743l;
                                                                    Boolean bool = Boolean.FALSE;
                                                                    notificationCenter.postNotificationNameOnUIThread(i14, bool, tLObject3, document, str, bool);
                                                                    n2Var3.h();
                                                                    return;
                                                                case 1:
                                                                    NotificationCenter.getInstance(UserConfig.selectedAccount).postNotificationNameOnUIThread(NotificationCenter.customStickerCreated, Boolean.FALSE, tLObject3, l2Var4.f41738f.document, l2Var4.f41743l, Boolean.TRUE);
                                                                    n2Var3.h();
                                                                    return;
                                                                default:
                                                                    ...
                                                                    TLRPC.Document document2 = l2Var4.f41738f.document;
                                                                    String str2 = l2Var4.f41743l;
                                                ...
                                                Utilities.Callback callback = l2Var3.f41745n;
                                                if (callback != null) {
                                            ...
                                            case 1:
                                                        ...
                                                        public final void run() {
                                                            ...
                                                            switch (i132) {
                                                                case 0:
                                                                    NotificationCenter notificationCenter = NotificationCenter.getInstance(UserConfig.selectedAccount);
                                                                    int i14 = NotificationCenter.customStickerCreated;
                                                                    TLRPC.Document document = l2Var42.f41738f.document;
                                                                    String str = l2Var42.f41743l;
                                                                    Boolean bool = Boolean.FALSE;
                                                                    notificationCenter.postNotificationNameOnUIThread(i14, bool, tLObject32, document, str, bool);
                                                                    n2Var32.h();
                                                                    return;
                                                                case 1:
                                                                    NotificationCenter.getInstance(UserConfig.selectedAccount).postNotificationNameOnUIThread(NotificationCenter.customStickerCreated, Boolean.FALSE, tLObject32, l2Var42.f41738f.document, l2Var42.f41743l, Boolean.TRUE);
                                                                    n2Var32.h();
                                                                    return;
                                                                default:
                                                                    NotificationCenter notificationCenter2 = NotificationCenter.getInstance(UserConfig.selectedAccount);
                                                                    int i15 = NotificationCenter.customStickerCreated;
                                                                    TLRPC.Document document2 = l2Var42.f41738f.document;
                                                                    String str2 = l2Var42.f41743l;
                                                                    Boolean bool2 = Boolean.FALSE;
                                                ...
                                                Utilities.Callback callback2 = l2Var4.f41745n;
                                                if (callback2 != null) {
                                            ...
                                            default:
                                                ...
                                                Utilities.Callback callback3 = l2Var5.f41745n;
                                                if (callback3 != null) {
                                    ...
                                    public final void run() {
                                        ...
                                        switch (r6) {
                                            case 0:
                                                ...
                                                Utilities.Callback callback = l2Var32.f41745n;
                                                if (callback != null) {
                                                    callback.run(Boolean.valueOf(z10));
                                                    l2Var32.f41745n = null;
                                                    return;
                                                }
                                                return;
                                            case 1:
                                    ...
                                    public final void run() {
                                        ...
                                        switch (r6) {
                                            ...
                                            case 1:
                                                        ...
                                                        public final void run() {
                                                            ...
                                                            switch (i1322) {
                                                                case 0:
                                                                    NotificationCenter notificationCenter = NotificationCenter.getInstance(UserConfig.selectedAccount);
                                                                    int i142 = NotificationCenter.customStickerCreated;
                                                                    TLRPC.Document document = l2Var422.f41738f.document;
                                                                    String str = l2Var422.f41743l;
                                                                    Boolean bool = Boolean.FALSE;
                                                                    notificationCenter.postNotificationNameOnUIThread(i142, bool, tLObject32, document, str, bool);
                                                                    n2Var322.h();
                                                                    return;
                                                                case 1:
                                                                    NotificationCenter.getInstance(UserConfig.selectedAccount).postNotificationNameOnUIThread(NotificationCenter.customStickerCreated, Boolean.FALSE, tLObject32, l2Var422.f41738f.document, l2Var422.f41743l, Boolean.TRUE);
                                                                    n2Var322.h();
                                                                    return;
                                                                default:
                                                                    NotificationCenter notificationCenter2 = NotificationCenter.getInstance(UserConfig.selectedAccount);
                                                                    int i15 = NotificationCenter.customStickerCreated;
                                                                    TLRPC.Document document2 = l2Var422.f41738f.document;
                                                                    String str2 = l2Var422.f41743l;
                                                                    Boolean bool2 = Boolean.FALSE;
                                                                    notificationCenter2.postNotificationNameOnUIThread(i15, bool2, tLObject32, document2, str2, bool2);
                                                                    n2Var322.h();
                                                                    return;
                                                ...
                                                Utilities.Callback callback2 = l2Var42.f41745n;
                                                if (callback2 != null) {
                                                    callback2.run(Boolean.valueOf(z11));
                                                    l2Var42.f41745n = null;
                                                    return;
                                                }
                                                return;
                                            default:
                ...
                Utilities.Callback callback = l2Var.f41745n;
                if (callback != null) {
                    callback.run(Boolean.TRUE);
                }
            } else if (l2Var.f41740i != 0) {
                SendMessagesHelper.getInstance(i10).sendSticker(l2Var.f41738f.document, null, l2Var.f41740i, null, null, null, null, null, true, 0, 0, false, null, null, 0L, 0L, null);
                ci.t0 t0Var = this.f41814d0;
                if (t0Var != null) {
                    t0Var.setProgress(1.0f);
                }
                AndroidUtilities.runOnUIThread(new v(this, i10, 1), 450L);
                Utilities.Callback callback2 = l2Var.f41745n;
                if (callback2 != null) {
                    callback2.run(Boolean.TRUE);
                    l2Var.f41745n = null;
                }
            } else if (l2Var.f41741j != null) {
                TLRPC.TL_stickers_addStickerToSet tL_stickers_addStickerToSet = new TLRPC.TL_stickers_addStickerToSet();
                tL_stickers_addStickerToSet.stickerset = MediaDataController.getInputStickerSet(l2Var.f41741j);
                                    ...
                                    public final void run() {
                                        ...
                                        switch (r6) {
                                            case 0:
                                                ...
                                                Utilities.Callback callback3 = l2Var32.f41745n;
                                                if (callback3 != null) {
                                            ...
                                            case 1:
                                                ...
                                                if (z14) {
                                                    ...
                                                    MediaDataController.getInstance(i132).putStickerSet((TLRPC.TL_messages_stickerSet) tLObject3);
                                                    MediaDataController.getInstance(i132).toggleStickerSet(null, tLObject3, 2, null, false, false);
                                                    ci.t0 t0Var22 = n2Var32.f41814d0;
                                                    if (t0Var22 != null) {
                                                ...
                                                Utilities.Callback callback22 = l2Var42.f41745n;
                                                if (callback22 != null) {
                                            ...
                                            default:
                                                ...
                                                Utilities.Callback callback32 = l2Var5.f41745n;
                                                if (callback32 != null) {
        ...
        if (this.H != null) {
            ...
            while (true) {
                ...
                if (k2Var != null) {
                    ...
                    Bitmap bitmap3 = k2Var.f41715g;
                    if (bitmap3 != null) {
                        bitmap3.recycle();
                        k2Var.f41715g = null;
                    }
                    Bitmap bitmap4 = k2Var.f41714f;
                    if (bitmap4 != null) {
                        bitmap4.recycle();
                        k2Var.f41714f = null;
                    }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.fileUploaded) {
            ...
            l2 l2Var2 = this.W;
            if (l2Var2 != null && str.equalsIgnoreCase(l2Var2.f41736b)) {
                l2 l2Var3 = this.W;
                l2Var3.f41739g = inputFile;
                TLRPC.TL_messages_uploadMedia tL_messages_uploadMedia = new TLRPC.TL_messages_uploadMedia();
                tL_messages_uploadMedia.peer = new TLRPC.TL_inputPeerSelf();
                TLRPC.TL_inputMediaUploadedDocument tL_inputMediaUploadedDocument = new TLRPC.TL_inputMediaUploadedDocument();
                tL_messages_uploadMedia.media = tL_inputMediaUploadedDocument;
                tL_inputMediaUploadedDocument.file = l2Var3.f41739g;
                if (l2Var3.f41750s != null) {
                ...
                tL_documentAttributeSticker.alt = l2Var3.f41737c;
            ...
            l2 l2Var4 = this.W;
            if (l2Var4 != null && str2.equalsIgnoreCase(l2Var4.f41736b)) {
                long longValue = ((Long) objArr[1]).longValue();
                long longValue2 = ((Long) objArr[2]).longValue();
                if (longValue2 > 0) {
                    l2 l2Var5 = this.W;
                    l2Var5.f41752u = Utilities.clamp(((float) longValue) / ((float) longValue2), 1.0f, l2Var5.f41752u);
                    ci.t0 t0Var = this.f41814d0;
                    if (t0Var != null) {
            ...
            l2 l2Var6 = this.W;
            if (l2Var6 != null && str3.equalsIgnoreCase(l2Var6.f41736b)) {
                h();
            }
        } else if (i10 == NotificationCenter.filePreparingStarted) {
            l2 l2Var7 = this.W;
            if (l2Var7 != null && objArr[0] == l2Var7.f41749r) {
                FileLoader.getInstance(UserConfig.selectedAccount).uploadFile(this.W.f41736b, false, true, 67108864);
            }
        } else if (i10 == NotificationCenter.fileNewChunkAvailable) {
            l2 l2Var8 = this.W;
            if (l2Var8 != null && objArr[0] == l2Var8.f41749r) {
                String str4 = (String) objArr[1];
                long longValue3 = ((Long) objArr[2]).longValue();
                long longValue4 = ((Long) objArr[3]).longValue();
                Float f7 = (Float) objArr[4];
                float floatValue = f7.floatValue();
                this.W.f41749r.videoEditedInfo.needUpdateProgress = true;
                FileLoader.getInstance(this.f41808a).checkUploadNewDataAvailable(str4, false, Math.max(1L, longValue3), longValue4, f7);
                l2 l2Var9 = this.W;
                l2Var9.f41751t = Math.max(l2Var9.f41751t, floatValue);
                ci.t0 t0Var2 = this.f41814d0;
                if (t0Var2 != null) {
                    t0Var2.setProgress(this.W.b());
                }
            }
        } else if (i10 == NotificationCenter.filePreparingFailed && (l2Var = this.W) != null && objArr[0] == l2Var.f41749r) {
            h();
        }
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        canvas.drawPath(this.f41831w, this.d);
    }
        ...
        if (k2Var != null) {
            ...
            if (k2Var.f41714f != null && this.L) {
                ...
                if (k2Var2.f41713c != 0) {
                    ...
                    k2 k2Var3 = this.E;
                    matrix.postRotate(k2Var3.f41713c, k2Var3.a().getWidth() / 2.0f, this.E.a().getHeight() / 2.0f);
                    k2 k2Var4 = this.E;
                    if ((k2Var4.f41713c / 90) % 2 != 0) {
    ...
    public final void g(Canvas canvas, boolean z10, ViewGroup viewGroup, boolean z11) {
        ...
        float f7;
        Paint paint;
        e6 e6Var = this.f41812c;
        e6Var.f23848a = viewGroup;
        boolean z13 = this.f41820i0;
        if (z13 || e6Var.f23850c > 0.0f) {
            if (viewGroup == null) {
                e = 1.0f;
            } else {
                if (z13 && !z11) {
            ...
            if (k2VarArr != null) {
                for (k2 k2Var : k2VarArr) {
                    if (k2Var != null && k2Var == this.E) {
                        if (this.F > 0.0f) {
                            if (k2Var.f41727t.f41822k0 != null) {
                                canvas.save();
                                canvas.clipPath(k2Var.f41727t.f41822k0);
                                if (k2Var.f41727t.I != null) {
                                    if (z10) {
                                        paint = k2Var.f41724q;
                                    } else {
                                        paint = k2Var.f41723p;
                                    ...
                                    canvas.drawPath(k2Var.f41719l, paint);
                                    if (k2Var.f41727t.f41822k0 != null && z10) {
                                        canvas.clipPath(k2Var.f41719l);
                                        paint.setStrokeWidth(AndroidUtilities.dp(f7 * 2.0f));
                                        canvas.drawPath(k2Var.f41727t.f41822k0, paint);
                                    }
                                }
                                canvas.restore();
                                return;
    ...
    public final k2 j(float f7, float f10) {
        ...
        while (true) {
            ...
            if (k2Var != null) {
                ...
                RectF rectF2 = this.H[i10].f41716i;
                float f11 = width;
                float f12 = this.f41817f0;
                float f13 = height;
                float f14 = this.f41818g0;
                rectF.set((rectF2.left / f11) * f12, (rectF2.top / f13) * f14, (rectF2.right / f11) * f12, (rectF2.bottom / f13) * f14);
                this.f41815e0.mapRect(rectF);
    ...
    public final void m(Bitmap bitmap, int i10, int i11, int i12, gr0 gr0Var) {
        ...
        this.T = i13;
        this.U = i14;
        if (!this.f41833y && !this.f41832x && bitmap != null && Build.VERSION.SDK_INT >= 24) {
            this.I = bitmap;
            this.J = i10;
            this.f41813c0 = null;
            ...
            if (EmuDetector.with(getContext()).detect()) {
                ...
                obj.e = min;
                obj.d = min;
                obj.f41764a = Bitmap.createBitmap(min, min, Bitmap.Config.ARGB_8888);
                new Canvas(obj.f41764a).drawRect(0.0f, 0.0f, obj.d, obj.e, h6.Jl);
                obj.f41765b = (bitmap2.getWidth() - obj.d) / 2;
                obj.f41766c = (bitmap2.getHeight() - obj.e) / 2;
                arrayList.add(obj);
                r4Var.run(arrayList);
                return;
            }
            ...
            if (this.f41813c0 == null) {
                yb.a aVar = yb.a.f46941b;
                n6.l.i(aVar, "options cannot be null");
                synchronized (wb.c.class) {
                    cVar = (wb.c) qb.g.c().a(wb.c.class);
                }
                pa.b bVar = (pa.b) cVar.f45289a.get(yb.a.class);
                n6.l.h(bVar);
                zb.d dVar2 = (zb.d) bVar.get();
                dVar2.getClass();
                fa faVar = dVar2.f49125c;
                ?? obj2 = new Object();
                obj2.f7314c = m7.TYPE_THIN;
                qb.m.f41542a.execute(new com.google.android.gms.internal.cast.p(faVar, new a5.a((com.google.firebase.messaging.n) obj2, 1), o7.ON_DEVICE_IMAGE_LABEL_CREATE, faVar.b(), 7));
                new ImageLabelerImpl((qb.e) dVar2.f49123a.O0(aVar), (Executor) dVar2.f49124b.f41523a.get(), new k6.c("vision.ica", 1L)).g(a10).addOnSuccessListener(new le.b(this, 25)).addOnFailureListener(new org.webrtc.audio.b(13));
            }
            List<TLRPC.TL_availableReaction> enabledReactionsList = MediaDataController.getInstance(this.f41808a).getEnabledReactionsList();
    ...
    public final void n(TLRPC.TL_error tL_error) {
        if (tL_error != null && !"PACK_TITLE_INVALID".equals(tL_error.text)) {
            new xc((FrameLayout) getParent(), this.f41809a0).t(tL_error.text, null).j();
        }
    }

    public final void o() {
        Path path = this.f41822k0;
        if (path == null) {
            this.f41822k0 = new Path();
        } else {
            path.rewind();
        }
        if (this.f41823l0 == null) {
            this.f41823l0 = new Path();
            RectF rectF = AndroidUtilities.rectTmp;
            rectF.set(0.0f, 0.0f, 1.0f, 1.0f);
            this.f41823l0.addRoundRect(rectF, rectF.width() * 0.12f, rectF.height() * 0.12f, Path.Direction.CW);
        }
        this.f41822k0.addPath(this.f41823l0, this.f41821j0);
        this.f41822k0.computeBounds(this.m0, true);
    }

    @Override
    public final void onAttachedToWindow() {
        super.onAttachedToWindow();
        NotificationCenter.getInstance(this.f41808a).addObserver(this, NotificationCenter.fileUploaded);
        NotificationCenter.getInstance(this.f41808a).addObserver(this, NotificationCenter.fileUploadProgressChanged);
        NotificationCenter.getInstance(this.f41808a).addObserver(this, NotificationCenter.fileUploadFailed);
        NotificationCenter.getInstance(this.f41808a).addObserver(this, NotificationCenter.filePreparingFailed);
        NotificationCenter.getInstance(this.f41808a).addObserver(this, NotificationCenter.filePreparingStarted);
        NotificationCenter.getInstance(this.f41808a).addObserver(this, NotificationCenter.fileNewChunkAvailable);
    }
    ...
    public final void onDetachedFromWindow() {
        ...
        if (i10 >= 0) {
            ...
            NotificationCenter.getInstance(this.f41808a).removeObserver(this, NotificationCenter.fileUploadProgressChanged);
            NotificationCenter.getInstance(this.f41808a).removeObserver(this, NotificationCenter.fileUploadFailed);
            NotificationCenter.getInstance(this.f41808a).removeObserver(this, NotificationCenter.filePreparingFailed);
            NotificationCenter.getInstance(this.f41808a).removeObserver(this, NotificationCenter.filePreparingStarted);
            NotificationCenter.getInstance(this.f41808a).removeObserver(this, NotificationCenter.fileNewChunkAvailable);
        }
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (Build.VERSION.SDK_INT >= 29) {
            ArrayList arrayList = this.f41827p0;
            arrayList.clear();
            if (this.f41820i0) {
                Rect rect = this.f41828q0;
                arrayList.add(rect);
    ...
    public final void p(final String str, final VideoEditedInfo videoEditedInfo, final String str2, final CharSequence charSequence, final boolean z10, final long j3, final TLRPC.StickerSet stickerSet, final TLRPC.Document document, final TLRPC.Document document2, final String str3, final Utilities.Callback callback, final Utilities.Callback2 callback2) {
        AndroidUtilities.runOnUIThread(new Runnable() {
            ...
            public final void run() {
                ...
                if (callback3 != null && (l2Var = n2Var.W) != null && l2Var.f41746o) {
                    z11 = false;
                } else {
                    z11 = true;
                }
                if (z11) {
                    ...
                    ?? obj = new Object();
                    obj.f41747p = new ArrayList();
                    obj.f41748q = new ArrayList();
                    obj.f41751t = 0.0f;
                    obj.f41752u = 0.0f;
                    n2Var.W = obj;
                }
                ...
                l2Var3.h = z10;
                l2Var3.f41740i = j3;
                l2Var3.f41741j = stickerSet;
                l2Var3.f41742k = document;
                VideoEditedInfo videoEditedInfo2 = videoEditedInfo;
                l2Var3.f41750s = videoEditedInfo2;
                l2Var3.f41743l = str3;
                l2Var3.f41745n = callback3;
                l2Var3.f41744m = callback2;
                ArrayList arrayList = l2Var3.f41748q;
                if (!TextUtils.isEmpty(str4)) {
                    l2Var3.f41747p.add(new File(l2Var3.f41736b));
                }
                if (!TextUtils.isEmpty(l2Var3.f41735a) && !TextUtils.equals(l2Var3.f41735a, l2Var3.f41736b)) {
                    arrayList.add(new File(l2Var3.f41735a));
                }
                if (!TextUtils.isEmpty(l2Var3.f41743l)) {
                    arrayList.add(new File(l2Var3.f41743l));
                }
                if (!z11) {
                    n2Var.a();
                } else {
                    ...
                    if (document3 != null) {
                        l2 l2Var4 = n2Var.W;
                        l2Var4.e = MediaDataController.getInputStickerSetItem(document3, l2Var4.f41737c);
                        n2Var.W.f41738f = new TLRPC.TL_messageMediaDocument();
                        TLRPC.TL_messageMediaDocument tL_messageMediaDocument = n2Var.W.f41738f;
                        ...
                        l2Var5.f41736b = absolutePath;
                        n2Var.W.f41749r = new MessageObject(UserConfig.selectedAccount, (TLRPC.Message) tL_message, (MessageObject) null, false, false);
                        n2Var.W.f41749r.videoEditedInfo = videoEditedInfo2;
                        MediaController.getInstance().scheduleVideoConvert(n2Var.W.f41749r, false, false, false);
                    } else {
                        FileLoader.getInstance(n2Var.f41808a).uploadFile(str4, false, true, 67108864);
                    }
                }
                if (callback3 == null) {
                    if (n2Var.f41814d0 == null) {
                        n2Var.f41814d0 = new ci.t0(n2Var.getContext(), LocaleController.getString(R.string.PreparingSticker));
                    }
                    n2Var.f41814d0.setOnCancelListener(new e2(n2Var, 0));
                    if (n2Var.f41814d0.getParent() == null) {
                        n2Var.addView(n2Var.f41814d0, y5.e(-1, -1, 17));
                    }
                    ci.t0 t0Var = n2Var.f41814d0;
                    t0Var.E = true;
                    t0Var.invalidate();
                }
            }
    ...
    public void setCurrentAccount(int i10) {
        ...
        if (i11 != i10) {
            if (i11 >= 0 && isAttachedToWindow()) {
                NotificationCenter.getInstance(this.f41808a).removeObserver(this, NotificationCenter.fileUploaded);
                NotificationCenter.getInstance(this.f41808a).removeObserver(this, NotificationCenter.fileUploadProgressChanged);
                NotificationCenter.getInstance(this.f41808a).removeObserver(this, NotificationCenter.fileUploadFailed);
                NotificationCenter.getInstance(this.f41808a).removeObserver(this, NotificationCenter.filePreparingFailed);
                NotificationCenter.getInstance(this.f41808a).removeObserver(this, NotificationCenter.filePreparingStarted);
    ...
    public void setOutlineVisible(boolean z10) {
        float f7;
        if (this.f41820i0 != z10) {
            this.f41820i0 = z10;
            ViewPropertyAnimator animate = this.f41819h0.animate();
            float f10 = 0.0f;
            if (z10) {
                f7 = 1.0f;
            } else {
            ...
            alpha.translationX(f10).setInterpolator(sr.h).setDuration(320L).start();
