...
public final class y0 extends xl0 {
    public final ArrayList X2;
    public final ArrayList Y2;
    public final ArrayList Z2;
    public final ArrayList f42001a3;
    public final ArrayList f42002b3;
    public final b6 f42003c3;
    ...
    public y0(b6 b6Var, Context context, com.google.firebase.messaging.n nVar) {
        ...
        this.f42001a3 = new ArrayList();
        this.f42002b3 = new ArrayList(10);
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
            ...
            if (childAt.getVisibility() != 4) {
                if (childAt instanceof org.telegram.ui.Cells.u1) {
                    ...
                    if (currentMessagesGroup2 == null || currentMessagesGroup2 != groupedMessages) {
                        ...
                        cb0 backgroundDrawable = u1Var.getBackgroundDrawable();
                        if ((backgroundDrawable.f23295f || u1Var.g3()) && (currentPosition == null || (2 & currentPosition.flags) != 0)) {
                            ...
                            if (currentPosition == null) {
                                ...
                                backgroundDrawable.f23298j = f7;
                                backgroundDrawable.f23299k = f16 - y3;
                                i12 = measuredHeight - y3;
                            }
                            int i15 = i12 + y3;
                            canvas.clipRect(0, y3, getMeasuredWidth(), i15);
                            backgroundDrawable.f23293b = null;
                            backgroundDrawable.f23292a.setColor(h6.v0(h6.Hc, this.f30399p2));
        ...
        int i16 = 0;
        while (i16 < 3) {
            ArrayList arrayList = this.f42002b3;
            arrayList.clear();
            if (i16 != i11 || this.X1) {
                int i17 = 0;
            ...
            while (i28 < size3) {
                ...
                if (currentMessagesGroup3 != null && currentMessagesGroup3.transitionParams.backgroundChangeBounds) {
                    ...
                    if (!transitionParams6.backgroundChangeBounds) {
                        f24 += u1Var7.getTranslationY();
                        f26 += u1Var7.getTranslationY();
                    }
                ...
                if (u1Var7.getTransitionParams().f21166v0) {
        ...
        ArrayList arrayList6 = this.f42001a3;
                ...
                if (u1Var8.getCurrentPosition() == null || (u1Var8.getCurrentPosition().flags & 1) != 0) {
                    ...
                    if (currentMessagesGroup4 != null && currentMessagesGroup4.transitionParams.backgroundChangeBounds) {
                        ...
                        if (!transitionParams7.backgroundChangeBounds) {
                            f28 += u1Var8.getTranslationY();
                            f30 += u1Var8.getTranslationY();
                        }
                    ...
                    if (u1Var8.getTransitionParams().f21166v0) {
    ...
    public final boolean drawChild(android.graphics.Canvas r20, android.view.View r21, long r22) {
        throw new UnsupportedOperationException("Method not decompiled: qg.y0.drawChild(android.graphics.Canvas, android.view.View, long):boolean");
    }
}
