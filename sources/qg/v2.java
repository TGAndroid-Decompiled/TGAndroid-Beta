...
public final class v2 extends j {
    public String A0;
    public final u2 f41962q0;
    public pg.t1 f41963r0;
    public int f41964s0;
    public int f41965t0;
    public int f41966u0;
    public pg.k0 f41967v0;
    public int f41968w0;
    public int f41969x0;
    public Runnable f41970y0;
    public boolean f41971z0;

    public v2(Context context, PointF pointF, int i10, CharSequence charSequence, pg.t1 t1Var, int i11) {
        super(context, pointF);
        this.f41967v0 = pg.k0.e;
        this.f41965t0 = i10;
        ...
        u2Var.setTextSize(0, this.f41965t0);
        u2Var.setCursorSize(AndroidUtilities.dp(this.f41965t0 * 0.4f));
        u2Var.setText(charSequence);
        s();
        u2Var.setTextColor(t1Var.f41264a);
    ...
    public int getAlign() {
        return this.f41966u0;
    }

    public int getBaseFontSize() {
        return this.f41965t0;
    }

    public b getEditText() {
        return this.f41962q0;
    }
    ...
    public Paint.FontMetricsInt getFontMetricsInt() {
        return this.f41962q0.getPaint().getFontMetricsInt();
    }

    public float getFontSize() {
        return this.f41962q0.getTextSize();
    }
    ...
    public tk0 getSelectionBounds() {
        ...
        u2 u2Var = this.f41962q0;
        return new tk0(x10, (positionY - (((dp2 - u2Var.getExtendedPaddingTop()) - AndroidUtilities.dpf2(4.0f)) / 2.0f)) * scaleX, ((dp * scaleX) + x10) - x10, (dp2 - u2Var.getExtendedPaddingBottom()) * scaleX);
    }

    @Override
    public float getStickyPaddingBottom() {
        RectF rectF = this.f41962q0.f41580w;
        if (rectF == null) {
            return 0.0f;
        }
        return rectF.bottom;
    ...
    public pg.t1 getSwatch() {
        return this.f41963r0;
    }

    public CharSequence getText() {
        return this.f41962q0.getText();
    }

    public int getTextSize() {
        return (int) this.f41962q0.getTextSize();
    }

    public int getType() {
        return this.f41964s0;
    }

    public pg.k0 getTypeface() {
        return this.f41967v0;
    }
    ...
    public final void r() {
        ...
        int i11 = this.f41963r0.f41264a;
        int i12 = this.f41964s0;
        int i13 = -1;
        if (i12 == 0) {
            u2Var.setFrameColor(i11);
            i11 = AndroidUtilities.computePerceivedBrightness(this.f41963r0.f41264a) >= 0.721f ? -16777216 : -1;
        } else if (i12 == 1) {
    ...
    public void setMaxWidth(int i10) {
        this.f41962q0.setMaxWidth(i10);
    }

    public void setSwatch(pg.t1 t1Var) {
        this.f41963r0 = new pg.t1(t1Var.f41265b, t1Var.f41266c, t1Var.f41264a);
        r();
    }

    public void setText(CharSequence charSequence) {
        this.f41962q0.setText(charSequence);
        s();
    }
    ...
    public void setTypeface(pg.k0 k0Var) {
        this.f41967v0 = k0Var;
        if (k0Var != null) {
            this.f41962q0.setTypeface(k0Var.d());
        }
        m();
    }
    ...
    public v2(Context context, v2 v2Var, PointF pointF) {
        this(context, pointF, v2Var.f41965t0, v2Var.getText(), v2Var.getSwatch(), v2Var.f41964s0);
        ...
        int align = getAlign();
        int i10 = 2;
        this.f41962q0.setGravity(align != 1 ? align != 2 ? 19 : 21 : 17);
        int align2 = getAlign();
        if (align2 == 1) {
            i10 = 4;
        ...
        this.f41962q0.setTextAlignment(i10);
    }
}
