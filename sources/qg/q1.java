...
public final class q1 extends TextView {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.f41583a) {
            ...
            if (LocaleController.isRTL) {
                this.f41584b.setBounds(AndroidUtilities.dp(7.0f), y3, AndroidUtilities.dp(23.0f), AndroidUtilities.dp(16.0f) + y3);
            } else {
                this.f41584b.setBounds(getWidth() - AndroidUtilities.dp(23.0f), y3, getWidth() - AndroidUtilities.dp(7.0f), AndroidUtilities.dp(16.0f) + y3);
            }
            this.f41584b.draw(canvas);
        }
    }
    ...
    public void setCurrent(boolean z10) {
        ...
        if (this.f41583a && this.f41584b == null) {
