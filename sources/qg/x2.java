...
public final class x2 extends j {
    ...
    public x2(Context context, PointF pointF, int i10, CharSequence charSequence, pg.q1 q1Var, int i11) {
        ...
        w2Var.setTextSize(0, this.f41705t0);
        w2Var.setCursorSize(AndroidUtilities.dp(this.f41705t0 * 0.4f));
        w2Var.setText(charSequence);
        s();
        w2Var.setTextColor(q1Var.f40966a);
    ...
    public int getAlign() {
        return this.f41706u0;
    }

    public int getBaseFontSize() {
        return this.f41705t0;
    }

    public b getEditText() {
        return this.f41702q0;
    }
    ...
    public Paint.FontMetricsInt getFontMetricsInt() {
        return this.f41702q0.getPaint().getFontMetricsInt();
    }

    public float getFontSize() {
        return this.f41702q0.getTextSize();
    }
    ...
    public float getStickyPaddingBottom() {
        RectF rectF = this.f41702q0.f41299w;
        if (rectF == null) {
            return 0.0f;
        }
        return rectF.bottom;
    ...
    public pg.q1 getSwatch() {
        return this.f41703r0;
    }

    public CharSequence getText() {
        return this.f41702q0.getText();
    }

    public int getTextSize() {
        return (int) this.f41702q0.getTextSize();
    }

    public int getType() {
        return this.f41704s0;
    }

    public pg.j0 getTypeface() {
        return this.f41707v0;
    }
    ...
    public final void r() {
        ...
        int i11 = this.f41703r0.f40966a;
        int i12 = this.f41704s0;
        int i13 = -1;
        if (i12 == 0) {
            w2Var.setFrameColor(i11);
            i11 = AndroidUtilities.computePerceivedBrightness(this.f41703r0.f40966a) >= 0.721f ? -16777216 : -1;
        } else if (i12 == 1) {
    ...
    public void setMaxWidth(int i10) {
        this.f41702q0.setMaxWidth(i10);
    }

    public void setSwatch(pg.q1 q1Var) {
        this.f41703r0 = new pg.q1(q1Var.f40967b, q1Var.f40968c, q1Var.f40966a);
        r();
    }

    public void setText(CharSequence charSequence) {
        this.f41702q0.setText(charSequence);
        s();
    }
    ...
    public void setTypeface(pg.j0 j0Var) {
        this.f41707v0 = j0Var;
        if (j0Var != null) {
            this.f41702q0.setTypeface(j0Var.d());
        }
        m();
    }
    ...
    public x2(Context context, x2 x2Var, PointF pointF) {
        this(context, pointF, x2Var.f41705t0, x2Var.getText(), x2Var.getSwatch(), x2Var.f41704s0);
        ...
        int align = getAlign();
        int i10 = 2;
        this.f41702q0.setGravity(align != 1 ? align != 2 ? 19 : 21 : 17);
        int align2 = getAlign();
        if (align2 == 1) {
            i10 = 4;
        ...
        this.f41702q0.setTextAlignment(i10);
    }
}
