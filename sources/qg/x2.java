...
public final class x2 extends j {
    public String A0;
    public final w2 f41658q0;
    public pg.r1 f41659r0;
    public int f41660s0;
    public int f41661t0;
    public int f41662u0;
    public pg.k0 f41663v0;
    public int f41664w0;
    public int f41665x0;
    public Runnable f41666y0;
    public boolean f41667z0;

    public x2(Context context, PointF pointF, int i10, CharSequence charSequence, pg.r1 r1Var, int i11) {
        super(context, pointF);
        this.f41663v0 = pg.k0.e;
        this.f41661t0 = i10;
        ...
        w2Var.setTextSize(0, this.f41661t0);
        w2Var.setCursorSize(AndroidUtilities.dp(this.f41661t0 * 0.4f));
        w2Var.setText(charSequence);
        s();
        w2Var.setTextColor(r1Var.f40927a);
    ...
    public int getAlign() {
        return this.f41662u0;
    }

    public int getBaseFontSize() {
        return this.f41661t0;
    }

    public b getEditText() {
        return this.f41658q0;
    }
    ...
    public Paint.FontMetricsInt getFontMetricsInt() {
        return this.f41658q0.getPaint().getFontMetricsInt();
    }

    public float getFontSize() {
        return this.f41658q0.getTextSize();
    }
    ...
    public float getStickyPaddingBottom() {
        RectF rectF = this.f41658q0.f41255w;
        if (rectF == null) {
            return 0.0f;
        }
        return rectF.bottom;
    ...
    public pg.r1 getSwatch() {
        return this.f41659r0;
    }

    public CharSequence getText() {
        return this.f41658q0.getText();
    }

    public int getTextSize() {
        return (int) this.f41658q0.getTextSize();
    }
    ...
    public final void r() {
        ...
        int i11 = this.f41659r0.f40927a;
        int i12 = this.f41660s0;
        int i13 = -1;
        if (i12 == 0) {
            w2Var.setFrameColor(i11);
            i11 = AndroidUtilities.computePerceivedBrightness(this.f41659r0.f40927a) >= 0.721f ? -16777216 : -1;
        } else if (i12 == 1) {
        ...
        w2Var.setHighlightColor(h6.l1(0.4f, i11));
    }
    ...
    public void setMaxWidth(int i10) {
        this.f41658q0.setMaxWidth(i10);
    }

    public void setSwatch(pg.r1 r1Var) {
        this.f41659r0 = new pg.r1(r1Var.f40928b, r1Var.f40929c, r1Var.f40927a);
        r();
    }

    public void setText(CharSequence charSequence) {
        this.f41658q0.setText(charSequence);
        s();
    }
    ...
    public void setTypeface(pg.k0 k0Var) {
        this.f41663v0 = k0Var;
        if (k0Var != null) {
            this.f41658q0.setTypeface(k0Var.d());
        }
        m();
    }
    ...
    public x2(Context context, x2 x2Var, PointF pointF) {
        this(context, pointF, x2Var.f41661t0, x2Var.getText(), x2Var.getSwatch(), x2Var.f41660s0);
        ...
        int align = getAlign();
        int i10 = 2;
        this.f41658q0.setGravity(align != 1 ? align != 2 ? 19 : 21 : 17);
        int align2 = getAlign();
        if (align2 == 1) {
            i10 = 4;
        ...
        this.f41658q0.setTextAlignment(i10);
    }
}
