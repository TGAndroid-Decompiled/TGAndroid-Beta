...
public final class s1 extends LinearLayout {
    public final lj0[] f41904a;
    public r1 f41905b;
    public final Paint f41906c;
    public final int d;
    public boolean e;
    public int f41907f;
    public int h;
    public float f41908n;
    public ValueAnimator f41909r;
    ...
    public s1(Context context, boolean z10) {
        ...
        float f7;
        float f10;
        List list = pg.m.f41155a;
        this.f41904a = new lj0[list.size() + 2];
        ...
        int i11 = 0;
        while (true) {
            List list2 = pg.m.f41155a;
            if (i10 < list2.size() + 2) {
                lj0[] lj0VarArr = this.f41904a;
                if (i10 == 0) {
                    z11 = true;
                } else {
                    z11 = false;
                ...
                if (i10 == 0) {
                    this.f41904a[i11].setOnClickListener(new View.OnClickListener(this) {
                        public final s1 f41885b;
                        ...
                        public final void onClick(View view) {
                            switch (r2) {
                                case 0:
                                    this.f41885b.f41905b.a();
                                    return;
                                default:
                                    this.f41885b.f41905b.y();
                                    return;
                            }
                        }
                    });
                    ...
                    if (z10 || !(mVar instanceof pg.b)) {
                        this.f41904a[i11].f(mVar.e(), 28, 28, null);
                        this.f41904a[i11].setOnClickListener(new ua(this, i11, mVar, 18));
                    } else {
                        i10++;
                    }
                } else if (i10 == list2.size() + 1) {
                    this.f41904a[i11].setImageResource(R.drawable.msg_add);
                    this.f41904a[i11].setOnClickListener(new View.OnClickListener(this) {
                        public final s1 f41885b;
    ...
    public final void a(int i10) {
        if (i10 >= 0) {
            ...
            if (i10 < lj0VarArr.length) {
                if (this.f41909r == null || this.h != i10) {
                    ...
                    ValueAnimator valueAnimator = this.f41909r;
                    ...
                    if (this.f41907f != i10) {
                        ...
                        this.f41909r = duration;
                        duration.setInterpolator(rr.f28022f);
                        this.f41909r.addUpdateListener(new org.telegram.ui.Components.voip.r0(this, 9));
                        this.f41909r.addListener(new pg.d0(this, 2));
                        this.f41909r.start();
                    }
                }
            }
        ...
        if (motionEvent.getAction() == 0 || motionEvent.getAction() == 2 || motionEvent.getAction() == 1) {
            ...
            for (int i10 = 1; i10 < getChildCount() - 1; i10++) {
                ...
                if (x10 >= childAt.getLeft() && x10 <= childAt.getRight()) {
                    if (this.f41909r != null) {
                        if (this.h != i10) {
                            a(i10);
                            post(new org.telegram.ui.web.q0(childAt, 16));
                            return true;
                        }
                    } else if (this.f41907f != i10) {
                        a(i10);
                        post(new org.telegram.ui.web.q0(childAt, 16));
                        return true;
                    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        canvas.drawCircle(AndroidUtilities.lerp(f14, f11 + f12, f7), (lj0Var2.getHeight() / 2.0f) + lj0Var2.getY(), dp, this.f41906c);
    }
    ...
    public void setSelectedIndex(int i10) {
        ...
        if (this.e) {
            this.e = false;
            AndroidUtilities.updateImageViewImageAnimated(this.f41904a[this.d + 1], R.drawable.msg_add);
        }
        invalidate();
    }
}
