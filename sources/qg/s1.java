...
public final class s1 extends LinearLayout {
    public final kj0[] f41932a;
    public r1 f41933b;
    public final Paint f41934c;
    public final int d;
    public boolean e;
    public int f41935f;
    public int h;
    public float f41936n;
    public ValueAnimator f41937r;
    ...
    public s1(Context context, boolean z10) {
        ...
        float f7;
        float f10;
        List list = pg.m.f41199a;
        this.f41932a = new kj0[list.size() + 2];
        ...
        int i11 = 0;
        while (true) {
            List list2 = pg.m.f41199a;
            if (i10 < list2.size() + 2) {
                kj0[] kj0VarArr = this.f41932a;
                if (i10 == 0) {
                    z11 = true;
                } else {
                    z11 = false;
                ...
                if (i10 == 0) {
                    this.f41932a[i11].setOnClickListener(new View.OnClickListener(this) {
                        public final s1 f41913b;
                        ...
                        public final void onClick(View view) {
                            switch (r2) {
                                case 0:
                                    this.f41913b.f41933b.a();
                                    return;
                                default:
                                    this.f41913b.f41933b.y();
                                    return;
                            }
                        }
                    });
                    ...
                    if (z10 || !(mVar instanceof pg.b)) {
                        this.f41932a[i11].f(mVar.e(), 28, 28, null);
                        this.f41932a[i11].setOnClickListener(new va(this, i11, mVar, 18));
                    } else {
                        i10++;
                    }
                } else if (i10 == list2.size() + 1) {
                    this.f41932a[i11].setImageResource(R.drawable.msg_add);
                    this.f41932a[i11].setOnClickListener(new View.OnClickListener(this) {
                        public final s1 f41913b;
    ...
    public final void a(int i10) {
        if (i10 >= 0) {
            ...
            if (i10 < kj0VarArr.length) {
                if (this.f41937r == null || this.h != i10) {
                    ...
                    ValueAnimator valueAnimator = this.f41937r;
                    ...
                    if (this.f41935f != i10) {
                        ...
                        this.f41937r = duration;
                        duration.setInterpolator(qr.f27642f);
                        this.f41937r.addUpdateListener(new org.telegram.ui.Components.voip.r0(this, 9));
                        this.f41937r.addListener(new pg.d0(this, 2));
                        this.f41937r.start();
                    }
                }
            }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        canvas.drawCircle(AndroidUtilities.lerp(f14, f11 + f12, f7), (kj0Var2.getHeight() / 2.0f) + kj0Var2.getY(), dp, this.f41934c);
    }
    ...
    public void setSelectedIndex(int i10) {
        ...
        if (this.e) {
            this.e = false;
            AndroidUtilities.updateImageViewImageAnimated(this.f41932a[this.d + 1], R.drawable.msg_add);
        }
        invalidate();
    }
}
