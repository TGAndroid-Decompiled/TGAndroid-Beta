...
public final class s1 extends LinearLayout {
    ...
    public int f41921f;
    public int h;
    public float f41922n;
    public ValueAnimator f41923r;
    ...
    public s1(Context context, boolean z10) {
        ...
        float f7;
        float f10;
        List list = pg.m.f41169a;
        this.f41918a = new lj0[list.size() + 2];
        ...
        int i11 = 0;
        while (true) {
            List list2 = pg.m.f41169a;
            if (i10 < list2.size() + 2) {
                lj0[] lj0VarArr = this.f41918a;
                if (i10 == 0) {
                    z11 = true;
                } else {
                    z11 = false;
                ...
                if (i10 == 0) {
                    this.f41918a[i11].setOnClickListener(new View.OnClickListener(this) {
                        public final s1 f41899b;
                        ...
                        public final void onClick(View view) {
                            switch (r2) {
                                case 0:
                                    this.f41899b.f41919b.a();
                                    return;
                                default:
                                    this.f41899b.f41919b.y();
                                    return;
                            }
                        }
                    });
                    ...
                    if (z10 || !(mVar instanceof pg.b)) {
                        this.f41918a[i11].f(mVar.e(), 28, 28, null);
                        this.f41918a[i11].setOnClickListener(new ua(this, i11, mVar, 18));
                    } else {
                        i10++;
                    }
                } else if (i10 == list2.size() + 1) {
                    this.f41918a[i11].setImageResource(R.drawable.msg_add);
                    this.f41918a[i11].setOnClickListener(new View.OnClickListener(this) {
                        public final s1 f41899b;
    ...
    public final void a(int i10) {
        if (i10 >= 0) {
            ...
            if (i10 < lj0VarArr.length) {
                if (this.f41923r == null || this.h != i10) {
                    ...
                    ValueAnimator valueAnimator = this.f41923r;
                    ...
                    if (this.f41921f != i10) {
                        ...
                        this.f41923r = duration;
                        duration.setInterpolator(rr.f28030f);
                        this.f41923r.addUpdateListener(new org.telegram.ui.Components.voip.r0(this, 9));
                        this.f41923r.addListener(new pg.d0(this, 2));
                        this.f41923r.start();
                    }
                }
            }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        canvas.drawCircle(AndroidUtilities.lerp(f14, f11 + f12, f7), (lj0Var2.getHeight() / 2.0f) + lj0Var2.getY(), dp, this.f41920c);
    }
    ...
    public void setSelectedIndex(int i10) {
        ...
        if (this.e) {
            this.e = false;
            AndroidUtilities.updateImageViewImageAnimated(this.f41918a[this.d + 1], R.drawable.msg_add);
        }
        invalidate();
    }
}
