...
public final class p2 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    public static final int f41575r0 = 0;
    public m2 E;
    public float F;
    public boolean G;
    public m2[] H;
    ...
    public n2 W;
    public int f41576a;
    public final f6 f41577a0;
    public final c6 f41578b;
    public f2 f41579b0;
    public final c6 f41580c;
    public String f41581c0;
    public final Paint d;
    public ci.t0 f41582d0;
    public final Paint e;
    public final Matrix f41583e0;
    public final Paint f41584f;
    public float f41585f0;
    public float f41586g0;
    public final Paint h;
    public final z1 f41587h0;
    public boolean f41588i0;
    public final Matrix f41589j0;
    public Path f41590k0;
    public Path f41591l0;
    public final RectF m0;
    public final PathMeasure f41592n;
    public float f41593n0;
    public float f41594o0;
    public final ArrayList f41595p0;
    public final Rect f41596q0;
    public final Path f41597r;
    public final Path f41598s;
    public final Path v;
    public final Path f41599w;
    public volatile boolean f41600x;
    public volatile boolean f41601y;

    public p2(ContextThemeWrapper contextThemeWrapper, f6 f6Var) {
        super(contextThemeWrapper);
        this.f41576a = -1;
        qr qrVar = qr.h;
        this.f41578b = new c6(0.0f, (View) null, 0L, 420L, qrVar);
        this.f41580c = new c6(0.0f, (View) null, 0L, 420L, qrVar);
        ...
        this.h = paint4;
        this.f41592n = new PathMeasure();
        this.f41597r = new Path();
        this.f41598s = new Path();
        this.v = new Path();
        this.f41599w = new Path();
        this.F = 2.0f;
        this.f41583e0 = new Matrix();
        this.f41589j0 = new Matrix();
        this.m0 = new RectF();
        this.f41595p0 = new ArrayList();
        this.f41596q0 = new Rect();
        this.f41577a0 = f6Var;
        paint.setColor(-1);
    ...
    public final void a() {
        ...
        if (n2Var != null) {
            ...
            n2Var.f41513o = true;
            if (n2Var.f41511m != null) {
                h();
                n2Var.f41511m.run(n2Var.f41503b, n2Var.e.document);
                AndroidUtilities.runOnUIThread(new p91(11), 250L);
            } else if (n2Var.f41509k != null) {
                TLRPC.TL_stickers_replaceSticker tL_stickers_replaceSticker = new TLRPC.TL_stickers_replaceSticker();
                tL_stickers_replaceSticker.sticker = MediaDataController.getInputStickerSetItem(n2Var.f41509k, n2Var.f41504c).document;
                                    ...
                                    public final void run() {
                                        ...
                                        switch (r6) {
                                            case 0:
                                                        ...
                                                        public final void run() {
                                                            ...
                                                            switch (i13) {
                                                                case 0:
                                                                    ...
                                                                    TLRPC.Document document = n2Var4.f41505f.document;
                                                                    String str = n2Var4.f41510l;
                                                                    Boolean bool = Boolean.FALSE;
                                                                    notificationCenter.postNotificationNameOnUIThread(i14, bool, tLObject3, document, str, bool);
                                                                    p2Var3.h();
                                                                    return;
                                                                case 1:
                                                                    NotificationCenter.getInstance(UserConfig.selectedAccount).postNotificationNameOnUIThread(NotificationCenter.customStickerCreated, Boolean.FALSE, tLObject3, n2Var4.f41505f.document, n2Var4.f41510l, Boolean.TRUE);
                                                                    p2Var3.h();
                                                                    return;
                                                                default:
                                                                    ...
                                                                    TLRPC.Document document2 = n2Var4.f41505f.document;
                                                                    String str2 = n2Var4.f41510l;
                                                ...
                                                Utilities.Callback callback = n2Var3.f41512n;
                                                if (callback != null) {
                                            ...
                                            case 1:
                                                        ...
                                                        public final void run() {
                                                            ...
                                                            switch (i132) {
                                                                case 0:
                                                                    NotificationCenter notificationCenter = NotificationCenter.getInstance(UserConfig.selectedAccount);
                                                                    int i14 = NotificationCenter.customStickerCreated;
                                                                    TLRPC.Document document = n2Var42.f41505f.document;
                                                                    String str = n2Var42.f41510l;
                                                                    Boolean bool = Boolean.FALSE;
                                                                    notificationCenter.postNotificationNameOnUIThread(i14, bool, tLObject32, document, str, bool);
                                                                    p2Var32.h();
                                                                    return;
                                                                case 1:
                                                                    NotificationCenter.getInstance(UserConfig.selectedAccount).postNotificationNameOnUIThread(NotificationCenter.customStickerCreated, Boolean.FALSE, tLObject32, n2Var42.f41505f.document, n2Var42.f41510l, Boolean.TRUE);
                                                                    p2Var32.h();
                                                                    return;
                                                                default:
                                                                    NotificationCenter notificationCenter2 = NotificationCenter.getInstance(UserConfig.selectedAccount);
                                                                    int i15 = NotificationCenter.customStickerCreated;
                                                                    TLRPC.Document document2 = n2Var42.f41505f.document;
                                                                    String str2 = n2Var42.f41510l;
                                                                    Boolean bool2 = Boolean.FALSE;
                                                ...
                                                Utilities.Callback callback2 = n2Var4.f41512n;
                                                if (callback2 != null) {
                                            ...
                                            default:
                                                ...
                                                Utilities.Callback callback3 = n2Var5.f41512n;
                                                if (callback3 != null) {
                                    ...
                                    public final void run() {
                                        ...
                                        switch (r6) {
                                            case 0:
                                                ...
                                                Utilities.Callback callback = n2Var32.f41512n;
                                                if (callback != null) {
                                                    callback.run(Boolean.valueOf(z10));
                                                    n2Var32.f41512n = null;
                                                    return;
                                                }
                                                return;
                                            case 1:
                                    ...
                                    public final void run() {
                                        ...
                                        switch (r6) {
                                            ...
                                            case 1:
                                                        ...
                                                        public final void run() {
                                                            ...
                                                            switch (i1322) {
                                                                case 0:
                                                                    NotificationCenter notificationCenter = NotificationCenter.getInstance(UserConfig.selectedAccount);
                                                                    int i142 = NotificationCenter.customStickerCreated;
                                                                    TLRPC.Document document = n2Var422.f41505f.document;
                                                                    String str = n2Var422.f41510l;
                                                                    Boolean bool = Boolean.FALSE;
                                                                    notificationCenter.postNotificationNameOnUIThread(i142, bool, tLObject32, document, str, bool);
                                                                    p2Var322.h();
                                                                    return;
                                                                case 1:
                                                                    NotificationCenter.getInstance(UserConfig.selectedAccount).postNotificationNameOnUIThread(NotificationCenter.customStickerCreated, Boolean.FALSE, tLObject32, n2Var422.f41505f.document, n2Var422.f41510l, Boolean.TRUE);
                                                                    p2Var322.h();
                                                                    return;
                                                                default:
                                                                    NotificationCenter notificationCenter2 = NotificationCenter.getInstance(UserConfig.selectedAccount);
                                                                    int i15 = NotificationCenter.customStickerCreated;
                                                                    TLRPC.Document document2 = n2Var422.f41505f.document;
                                                                    String str2 = n2Var422.f41510l;
                                                                    Boolean bool2 = Boolean.FALSE;
                                                                    notificationCenter2.postNotificationNameOnUIThread(i15, bool2, tLObject32, document2, str2, bool2);
                                                                    p2Var322.h();
                                                                    return;
                                                ...
                                                Utilities.Callback callback2 = n2Var42.f41512n;
                                                if (callback2 != null) {
                                                    callback2.run(Boolean.valueOf(z11));
                                                    n2Var42.f41512n = null;
                                                    return;
                                                }
                                                return;
                                            default:
                ...
                Utilities.Callback callback = n2Var.f41512n;
                if (callback != null) {
                    callback.run(Boolean.TRUE);
                }
            } else if (n2Var.f41507i != 0) {
                SendMessagesHelper.getInstance(i10).sendSticker(n2Var.f41505f.document, null, n2Var.f41507i, null, null, null, null, null, true, 0, 0, false, null, null, 0L, 0L, null);
                ci.t0 t0Var = this.f41582d0;
                if (t0Var != null) {
                    t0Var.setProgress(1.0f);
                }
                AndroidUtilities.runOnUIThread(new v(this, i10, 1), 450L);
                Utilities.Callback callback2 = n2Var.f41512n;
                if (callback2 != null) {
                    callback2.run(Boolean.TRUE);
                    n2Var.f41512n = null;
                }
            } else if (n2Var.f41508j != null) {
                TLRPC.TL_stickers_addStickerToSet tL_stickers_addStickerToSet = new TLRPC.TL_stickers_addStickerToSet();
                tL_stickers_addStickerToSet.stickerset = MediaDataController.getInputStickerSet(n2Var.f41508j);
                                    ...
                                    public final void run() {
                                        ...
                                        switch (r6) {
                                            case 0:
                                                ...
                                                Utilities.Callback callback3 = n2Var32.f41512n;
                                                if (callback3 != null) {
                                            ...
                                            case 1:
                                                ...
                                                if (z14) {
                                                    ...
                                                    MediaDataController.getInstance(i132).putStickerSet((TLRPC.TL_messages_stickerSet) tLObject3);
                                                    MediaDataController.getInstance(i132).toggleStickerSet(null, tLObject3, 2, null, false, false);
                                                    ci.t0 t0Var22 = p2Var32.f41582d0;
                                                    if (t0Var22 != null) {
                                                ...
                                                Utilities.Callback callback22 = n2Var42.f41512n;
                                                if (callback22 != null) {
                                            ...
                                            default:
                                                ...
                                                Utilities.Callback callback32 = n2Var5.f41512n;
                                                if (callback32 != null) {
        ...
        if (this.H != null) {
            ...
            while (true) {
                ...
                if (m2Var != null) {
                    ...
                    Bitmap bitmap3 = m2Var.f41483g;
                    if (bitmap3 != null) {
                        bitmap3.recycle();
                        m2Var.f41483g = null;
                    }
                    Bitmap bitmap4 = m2Var.f41482f;
                    if (bitmap4 != null) {
                        bitmap4.recycle();
                        m2Var.f41482f = null;
                    }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.fileUploaded) {
            ...
            n2 n2Var2 = this.W;
            if (n2Var2 != null && str.equalsIgnoreCase(n2Var2.f41503b)) {
                n2 n2Var3 = this.W;
                n2Var3.f41506g = inputFile;
                TLRPC.TL_messages_uploadMedia tL_messages_uploadMedia = new TLRPC.TL_messages_uploadMedia();
                tL_messages_uploadMedia.peer = new TLRPC.TL_inputPeerSelf();
                TLRPC.TL_inputMediaUploadedDocument tL_inputMediaUploadedDocument = new TLRPC.TL_inputMediaUploadedDocument();
                tL_messages_uploadMedia.media = tL_inputMediaUploadedDocument;
                tL_inputMediaUploadedDocument.file = n2Var3.f41506g;
                if (n2Var3.f41517s != null) {
                ...
                tL_documentAttributeSticker.alt = n2Var3.f41504c;
            ...
            n2 n2Var4 = this.W;
            if (n2Var4 != null && str2.equalsIgnoreCase(n2Var4.f41503b)) {
                long longValue = ((Long) objArr[1]).longValue();
                long longValue2 = ((Long) objArr[2]).longValue();
                if (longValue2 > 0) {
                    n2 n2Var5 = this.W;
                    n2Var5.f41519u = Utilities.clamp(((float) longValue) / ((float) longValue2), 1.0f, n2Var5.f41519u);
                    ci.t0 t0Var = this.f41582d0;
                    if (t0Var != null) {
            ...
            n2 n2Var6 = this.W;
            if (n2Var6 != null && str3.equalsIgnoreCase(n2Var6.f41503b)) {
                h();
            }
        } else if (i10 == NotificationCenter.filePreparingStarted) {
            n2 n2Var7 = this.W;
            if (n2Var7 != null && objArr[0] == n2Var7.f41516r) {
                FileLoader.getInstance(UserConfig.selectedAccount).uploadFile(this.W.f41503b, false, true, 67108864);
            }
        } else if (i10 == NotificationCenter.fileNewChunkAvailable) {
            n2 n2Var8 = this.W;
            if (n2Var8 != null && objArr[0] == n2Var8.f41516r) {
                String str4 = (String) objArr[1];
                long longValue3 = ((Long) objArr[2]).longValue();
                long longValue4 = ((Long) objArr[3]).longValue();
                Float f7 = (Float) objArr[4];
                float floatValue = f7.floatValue();
                this.W.f41516r.videoEditedInfo.needUpdateProgress = true;
                FileLoader.getInstance(this.f41576a).checkUploadNewDataAvailable(str4, false, Math.max(1L, longValue3), longValue4, f7);
                n2 n2Var9 = this.W;
                n2Var9.f41518t = Math.max(n2Var9.f41518t, floatValue);
                ci.t0 t0Var2 = this.f41582d0;
                if (t0Var2 != null) {
                    t0Var2.setProgress(this.W.b());
                }
            }
        } else if (i10 == NotificationCenter.filePreparingFailed && (n2Var = this.W) != null && objArr[0] == n2Var.f41516r) {
            h();
        }
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        canvas.drawPath(this.f41599w, this.d);
    }
        ...
        if (m2Var != null) {
            ...
            if (m2Var.f41482f != null && this.L) {
                ...
                if (m2Var2.f41481c != 0) {
                    ...
                    m2 m2Var3 = this.E;
                    matrix.postRotate(m2Var3.f41481c, m2Var3.a().getWidth() / 2.0f, this.E.a().getHeight() / 2.0f);
                    m2 m2Var4 = this.E;
                    if ((m2Var4.f41481c / 90) % 2 != 0) {
    ...
    public final void g(Canvas canvas, boolean z10, ViewGroup viewGroup, boolean z11) {
        ...
        float f7;
        Paint paint;
        c6 c6Var = this.f41580c;
        c6Var.f22935a = viewGroup;
        boolean z13 = this.f41588i0;
        if (z13 || c6Var.f22937c > 0.0f) {
            if (viewGroup == null) {
                e = 1.0f;
            } else {
                if (z13 && !z11) {
            ...
            if (m2VarArr != null) {
                for (m2 m2Var : m2VarArr) {
                    if (m2Var != null && m2Var == this.E) {
                        if (this.F > 0.0f) {
                            if (m2Var.f41495t.f41590k0 != null) {
                                canvas.save();
                                canvas.clipPath(m2Var.f41495t.f41590k0);
                                if (m2Var.f41495t.I != null) {
                                    if (z10) {
                                        paint = m2Var.f41492q;
                                    } else {
                                        paint = m2Var.f41491p;
                                    ...
                                    canvas.drawPath(m2Var.f41487l, paint);
                                    if (m2Var.f41495t.f41590k0 != null && z10) {
                                        canvas.clipPath(m2Var.f41487l);
                                        paint.setStrokeWidth(AndroidUtilities.dp(f7 * 2.0f));
                                        canvas.drawPath(m2Var.f41495t.f41590k0, paint);
                                    }
                                }
                                canvas.restore();
                                return;
    ...
    public final m2 j(float f7, float f10) {
        ...
        while (true) {
            ...
            if (m2Var != null) {
                ...
                RectF rectF2 = this.H[i10].f41484i;
                float f11 = width;
                float f12 = this.f41585f0;
                float f13 = height;
                float f14 = this.f41586g0;
                rectF.set((rectF2.left / f11) * f12, (rectF2.top / f13) * f14, (rectF2.right / f11) * f12, (rectF2.bottom / f13) * f14);
                this.f41583e0.mapRect(rectF);
    ...
    public final void m(Bitmap bitmap, int i10, int i11, int i12, qr0 qr0Var) {
        ...
        this.T = i13;
        this.U = i14;
        if (!this.f41601y && !this.f41600x && bitmap != null && Build.VERSION.SDK_INT >= 24) {
            this.I = bitmap;
            this.J = i10;
            this.f41581c0 = null;
            ...
            if (EmuDetector.with(getContext()).detect()) {
                ...
                obj.e = min;
                obj.d = min;
                obj.f41531a = Bitmap.createBitmap(min, min, Bitmap.Config.ARGB_8888);
                new Canvas(obj.f41531a).drawRect(0.0f, 0.0f, obj.d, obj.e, j6.Jl);
                obj.f41532b = (bitmap2.getWidth() - obj.d) / 2;
                obj.f41533c = (bitmap2.getHeight() - obj.e) / 2;
                arrayList.add(obj);
                r4Var.run(arrayList);
                return;
            }
            ...
            if (this.f41581c0 == null) {
                yb.a aVar = yb.a.f46686b;
                n6.l.i(aVar, "options cannot be null");
                synchronized (wb.c.class) {
                    cVar = (wb.c) qb.g.c().a(wb.c.class);
                }
                pa.b bVar = (pa.b) cVar.f45035a.get(yb.a.class);
                n6.l.h(bVar);
                zb.d dVar2 = (zb.d) bVar.get();
                dVar2.getClass();
                fa faVar = dVar2.f48876c;
                ?? obj2 = new Object();
                obj2.f7338c = m7.TYPE_THIN;
                qb.m.f41276a.execute(new com.google.android.gms.internal.cast.p(faVar, new a5.a((com.google.firebase.messaging.n) obj2, 1), o7.ON_DEVICE_IMAGE_LABEL_CREATE, faVar.b(), 7));
                new ImageLabelerImpl((qb.e) dVar2.f48874a.O0(aVar), (Executor) dVar2.f48875b.f41257a.get(), new k6.c("vision.ica", 1L)).g(a10).addOnSuccessListener(new k2.v(this, 25)).addOnFailureListener(new bs0(24));
            }
            List<TLRPC.TL_availableReaction> enabledReactionsList = MediaDataController.getInstance(this.f41576a).getEnabledReactionsList();
    ...
    public final void n(TLRPC.TL_error tL_error) {
        if (tL_error != null && !"PACK_TITLE_INVALID".equals(tL_error.text)) {
            new vc((FrameLayout) getParent(), this.f41577a0).t(tL_error.text, null).j();
        }
    }

    public final void o() {
        Path path = this.f41590k0;
        if (path == null) {
            this.f41590k0 = new Path();
        } else {
            path.rewind();
        }
        if (this.f41591l0 == null) {
            this.f41591l0 = new Path();
            RectF rectF = AndroidUtilities.rectTmp;
            rectF.set(0.0f, 0.0f, 1.0f, 1.0f);
            this.f41591l0.addRoundRect(rectF, rectF.width() * 0.12f, rectF.height() * 0.12f, Path.Direction.CW);
        }
        this.f41590k0.addPath(this.f41591l0, this.f41589j0);
        this.f41590k0.computeBounds(this.m0, true);
    }

    @Override
    public final void onAttachedToWindow() {
        super.onAttachedToWindow();
        NotificationCenter.getInstance(this.f41576a).addObserver(this, NotificationCenter.fileUploaded);
        NotificationCenter.getInstance(this.f41576a).addObserver(this, NotificationCenter.fileUploadProgressChanged);
        NotificationCenter.getInstance(this.f41576a).addObserver(this, NotificationCenter.fileUploadFailed);
        NotificationCenter.getInstance(this.f41576a).addObserver(this, NotificationCenter.filePreparingFailed);
        NotificationCenter.getInstance(this.f41576a).addObserver(this, NotificationCenter.filePreparingStarted);
        NotificationCenter.getInstance(this.f41576a).addObserver(this, NotificationCenter.fileNewChunkAvailable);
    }
    ...
    public final void onDetachedFromWindow() {
        ...
        if (i10 >= 0) {
            ...
            NotificationCenter.getInstance(this.f41576a).removeObserver(this, NotificationCenter.fileUploadProgressChanged);
            NotificationCenter.getInstance(this.f41576a).removeObserver(this, NotificationCenter.fileUploadFailed);
            NotificationCenter.getInstance(this.f41576a).removeObserver(this, NotificationCenter.filePreparingFailed);
            NotificationCenter.getInstance(this.f41576a).removeObserver(this, NotificationCenter.filePreparingStarted);
            NotificationCenter.getInstance(this.f41576a).removeObserver(this, NotificationCenter.fileNewChunkAvailable);
        }
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (Build.VERSION.SDK_INT >= 29) {
            ArrayList arrayList = this.f41595p0;
            arrayList.clear();
            if (this.f41588i0) {
                Rect rect = this.f41596q0;
                arrayList.add(rect);
    ...
    public final void p(final String str, final VideoEditedInfo videoEditedInfo, final String str2, final CharSequence charSequence, final boolean z10, final long j3, final TLRPC.StickerSet stickerSet, final TLRPC.Document document, final TLRPC.Document document2, final String str3, final Utilities.Callback callback, final Utilities.Callback2 callback2) {
        AndroidUtilities.runOnUIThread(new Runnable() {
            ...
            public final void run() {
                ...
                if (callback3 != null && (n2Var = p2Var.W) != null && n2Var.f41513o) {
                    z11 = false;
                } else {
                    z11 = true;
                }
                if (z11) {
                    ...
                    ?? obj = new Object();
                    obj.f41514p = new ArrayList();
                    obj.f41515q = new ArrayList();
                    obj.f41518t = 0.0f;
                    obj.f41519u = 0.0f;
                    p2Var.W = obj;
                }
                ...
                n2Var3.h = z10;
                n2Var3.f41507i = j3;
                n2Var3.f41508j = stickerSet;
                n2Var3.f41509k = document;
                VideoEditedInfo videoEditedInfo2 = videoEditedInfo;
                n2Var3.f41517s = videoEditedInfo2;
                n2Var3.f41510l = str3;
                n2Var3.f41512n = callback3;
                n2Var3.f41511m = callback2;
                ArrayList arrayList = n2Var3.f41515q;
                if (!TextUtils.isEmpty(str4)) {
                    n2Var3.f41514p.add(new File(n2Var3.f41503b));
                }
                if (!TextUtils.isEmpty(n2Var3.f41502a) && !TextUtils.equals(n2Var3.f41502a, n2Var3.f41503b)) {
                    arrayList.add(new File(n2Var3.f41502a));
                }
                if (!TextUtils.isEmpty(n2Var3.f41510l)) {
                    arrayList.add(new File(n2Var3.f41510l));
                }
                if (!z11) {
                    p2Var.a();
                } else {
                    ...
                    if (document3 != null) {
                        n2 n2Var4 = p2Var.W;
                        n2Var4.e = MediaDataController.getInputStickerSetItem(document3, n2Var4.f41504c);
                        p2Var.W.f41505f = new TLRPC.TL_messageMediaDocument();
                        TLRPC.TL_messageMediaDocument tL_messageMediaDocument = p2Var.W.f41505f;
                        ...
                        n2Var5.f41503b = absolutePath;
                        p2Var.W.f41516r = new MessageObject(UserConfig.selectedAccount, (TLRPC.Message) tL_message, (MessageObject) null, false, false);
                        p2Var.W.f41516r.videoEditedInfo = videoEditedInfo2;
                        MediaController.getInstance().scheduleVideoConvert(p2Var.W.f41516r, false, false, false);
                    } else {
                        FileLoader.getInstance(p2Var.f41576a).uploadFile(str4, false, true, 67108864);
                    }
                }
                if (callback3 == null) {
                    if (p2Var.f41582d0 == null) {
                        p2Var.f41582d0 = new ci.t0(p2Var.getContext(), LocaleController.getString(R.string.PreparingSticker));
                    }
                    p2Var.f41582d0.setOnCancelListener(new g2(p2Var, 0));
                    if (p2Var.f41582d0.getParent() == null) {
                        p2Var.addView(p2Var.f41582d0, x5.e(-1, -1, 17));
                    }
                    ci.t0 t0Var = p2Var.f41582d0;
                    t0Var.E = true;
                    t0Var.invalidate();
                }
            }
    ...
    public void setCurrentAccount(int i10) {
        int i11 = this.f41576a;
        if (i11 != i10) {
            if (i11 >= 0 && isAttachedToWindow()) {
                NotificationCenter.getInstance(this.f41576a).removeObserver(this, NotificationCenter.fileUploaded);
                NotificationCenter.getInstance(this.f41576a).removeObserver(this, NotificationCenter.fileUploadProgressChanged);
                NotificationCenter.getInstance(this.f41576a).removeObserver(this, NotificationCenter.fileUploadFailed);
                NotificationCenter.getInstance(this.f41576a).removeObserver(this, NotificationCenter.filePreparingFailed);
                NotificationCenter.getInstance(this.f41576a).removeObserver(this, NotificationCenter.filePreparingStarted);
    ...
    public void setOutlineVisible(boolean z10) {
        float f7;
        if (this.f41588i0 != z10) {
            this.f41588i0 = z10;
            ViewPropertyAnimator animate = this.f41587h0.animate();
            float f10 = 0.0f;
            if (z10) {
                f7 = 1.0f;
            } else {
