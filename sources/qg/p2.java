...
public final class p2 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    public static final int f41553r0 = 0;
    public m2 E;
    public float F;
    public boolean G;
    public m2[] H;
    ...
    public n2 W;
    public int f41554a;
    public final e6 f41555a0;
    public final c6 f41556b;
    public f2 f41557b0;
    public final c6 f41558c;
    public String f41559c0;
    public final Paint d;
    public ci.t0 f41560d0;
    public final Paint e;
    public final Matrix f41561e0;
    public final Paint f41562f;
    public float f41563f0;
    public float f41564g0;
    public final Paint h;
    public final z1 f41565h0;
    public boolean f41566i0;
    public final Matrix f41567j0;
    public Path f41568k0;
    public Path f41569l0;
    public final RectF m0;
    public final PathMeasure f41570n;
    public float f41571n0;
    public float f41572o0;
    public final ArrayList f41573p0;
    public final Rect f41574q0;
    public final Path f41575r;
    public final Path f41576s;
    public final Path v;
    public final Path f41577w;
    public volatile boolean f41578x;
    public volatile boolean f41579y;

    public p2(ContextThemeWrapper contextThemeWrapper, e6 e6Var) {
        super(contextThemeWrapper);
        this.f41554a = -1;
        qr qrVar = qr.h;
        this.f41556b = new c6(0.0f, (View) null, 0L, 420L, qrVar);
        this.f41558c = new c6(0.0f, (View) null, 0L, 420L, qrVar);
        ...
        this.h = paint4;
        this.f41570n = new PathMeasure();
        this.f41575r = new Path();
        this.f41576s = new Path();
        this.v = new Path();
        this.f41577w = new Path();
        this.F = 2.0f;
        this.f41561e0 = new Matrix();
        this.f41567j0 = new Matrix();
        this.m0 = new RectF();
        this.f41573p0 = new ArrayList();
        this.f41574q0 = new Rect();
        this.f41555a0 = e6Var;
        paint.setColor(-1);
    ...
    public final void a() {
        ...
        if (n2Var != null) {
            ...
            n2Var.f41491o = true;
            if (n2Var.f41489m != null) {
                h();
                n2Var.f41489m.run(n2Var.f41481b, n2Var.e.document);
                AndroidUtilities.runOnUIThread(new n91(11), 250L);
            } else if (n2Var.f41487k != null) {
                TLRPC.TL_stickers_replaceSticker tL_stickers_replaceSticker = new TLRPC.TL_stickers_replaceSticker();
                tL_stickers_replaceSticker.sticker = MediaDataController.getInputStickerSetItem(n2Var.f41487k, n2Var.f41482c).document;
                                        ...
                                        switch (r6) {
                                            case 0:
                                                ...
                                                if (z13) {
                                                    ...
                                                    if (!MediaDataController.getInstance(i12).isStickerPackInstalled(tL_messages_stickerSet.set.f18139id)) {
                                                        MediaDataController.getInstance(i12).toggleStickerSet(null, tLObject2, 2, null, false, false);
                                                    }
                                                    ci.t0 t0Var = p2Var2.f41560d0;
                                                    if (t0Var != null) {
                                                        ...
                                                        public final void run() {
                                                            ...
                                                            switch (i13) {
                                                                case 0:
                                                                    ...
                                                                    TLRPC.Document document = n2Var4.f41483f.document;
                                                                    String str = n2Var4.f41488l;
                                                                    Boolean bool = Boolean.FALSE;
                                                                    notificationCenter.postNotificationNameOnUIThread(i14, bool, tLObject3, document, str, bool);
                                                                    p2Var3.h();
                                                                    return;
                                                                case 1:
                                                                    NotificationCenter.getInstance(UserConfig.selectedAccount).postNotificationNameOnUIThread(NotificationCenter.customStickerCreated, Boolean.FALSE, tLObject3, n2Var4.f41483f.document, n2Var4.f41488l, Boolean.TRUE);
                                                                    p2Var3.h();
                                                                    return;
                                                                default:
                                                                    ...
                                                                    TLRPC.Document document2 = n2Var4.f41483f.document;
                                                                    String str2 = n2Var4.f41488l;
                                                ...
                                                Utilities.Callback callback = n2Var3.f41490n;
                                                if (callback != null) {
                                            ...
                                            case 1:
                                                        ...
                                                        public final void run() {
                                                            ...
                                                            switch (i132) {
                                                                case 0:
                                                                    NotificationCenter notificationCenter = NotificationCenter.getInstance(UserConfig.selectedAccount);
                                                                    int i14 = NotificationCenter.customStickerCreated;
                                                                    TLRPC.Document document = n2Var42.f41483f.document;
                                                                    String str = n2Var42.f41488l;
                                                                    Boolean bool = Boolean.FALSE;
                                                                    notificationCenter.postNotificationNameOnUIThread(i14, bool, tLObject32, document, str, bool);
                                                                    p2Var32.h();
                                                                    return;
                                                                case 1:
                                                                    NotificationCenter.getInstance(UserConfig.selectedAccount).postNotificationNameOnUIThread(NotificationCenter.customStickerCreated, Boolean.FALSE, tLObject32, n2Var42.f41483f.document, n2Var42.f41488l, Boolean.TRUE);
                                                                    p2Var32.h();
                                                                    return;
                                                                default:
                                                                    NotificationCenter notificationCenter2 = NotificationCenter.getInstance(UserConfig.selectedAccount);
                                                                    int i15 = NotificationCenter.customStickerCreated;
                                                                    TLRPC.Document document2 = n2Var42.f41483f.document;
                                                                    String str2 = n2Var42.f41488l;
                                                                    Boolean bool2 = Boolean.FALSE;
                                                ...
                                                Utilities.Callback callback2 = n2Var4.f41490n;
                                                if (callback2 != null) {
                                            ...
                                            default:
                                                ...
                                                if (z15) {
                                                    ...
                                                    if (!MediaDataController.getInstance(i14).isStickerPackInstalled(tL_messages_stickerSet2.set.f18139id)) {
                                                        MediaDataController.getInstance(i14).toggleStickerSet(null, tLObject4, 2, null, false, false);
                                                    }
                                                    ci.t0 t0Var3 = p2Var4.f41560d0;
                                                    if (t0Var3 != null) {
                                                ...
                                                Utilities.Callback callback3 = n2Var5.f41490n;
                                                if (callback3 != null) {
                                        ...
                                        switch (r6) {
                                            case 0:
                                                ...
                                                if (z13) {
                                                    ...
                                                    if (!MediaDataController.getInstance(i122).isStickerPackInstalled(tL_messages_stickerSet.set.f18139id)) {
                                                        MediaDataController.getInstance(i122).toggleStickerSet(null, tLObject2, 2, null, false, false);
                                                    }
                                                    ci.t0 t0Var = p2Var22.f41560d0;
                                                    if (t0Var != null) {
                                                        t0Var.setProgress(1.0f);
                                                    }
                                                    AndroidUtilities.runOnUIThread(new Runnable() {
                                                ...
                                                Utilities.Callback callback = n2Var32.f41490n;
                                                if (callback != null) {
                                                    callback.run(Boolean.valueOf(z10));
                                                    n2Var32.f41490n = null;
                                                    return;
                                                }
                                                return;
                                            case 1:
                                    ...
                                    public final void run() {
                                        ...
                                        switch (r6) {
                                            ...
                                            case 1:
                                                        ...
                                                        public final void run() {
                                                            ...
                                                            switch (i1322) {
                                                                case 0:
                                                                    NotificationCenter notificationCenter = NotificationCenter.getInstance(UserConfig.selectedAccount);
                                                                    int i142 = NotificationCenter.customStickerCreated;
                                                                    TLRPC.Document document = n2Var422.f41483f.document;
                                                                    String str = n2Var422.f41488l;
                                                                    Boolean bool = Boolean.FALSE;
                                                                    notificationCenter.postNotificationNameOnUIThread(i142, bool, tLObject32, document, str, bool);
                                                                    p2Var322.h();
                                                                    return;
                                                                case 1:
                                                                    NotificationCenter.getInstance(UserConfig.selectedAccount).postNotificationNameOnUIThread(NotificationCenter.customStickerCreated, Boolean.FALSE, tLObject32, n2Var422.f41483f.document, n2Var422.f41488l, Boolean.TRUE);
                                                                    p2Var322.h();
                                                                    return;
                                                                default:
                                                                    NotificationCenter notificationCenter2 = NotificationCenter.getInstance(UserConfig.selectedAccount);
                                                                    int i15 = NotificationCenter.customStickerCreated;
                                                                    TLRPC.Document document2 = n2Var422.f41483f.document;
                                                                    String str2 = n2Var422.f41488l;
                                                                    Boolean bool2 = Boolean.FALSE;
                                                                    notificationCenter2.postNotificationNameOnUIThread(i15, bool2, tLObject32, document2, str2, bool2);
                                                                    p2Var322.h();
                                                                    return;
                                                ...
                                                Utilities.Callback callback2 = n2Var42.f41490n;
                                                if (callback2 != null) {
                                                    callback2.run(Boolean.valueOf(z11));
                                                    n2Var42.f41490n = null;
                                                    return;
                                                }
                                                return;
                                            default:
                ...
                Utilities.Callback callback = n2Var.f41490n;
                if (callback != null) {
                    callback.run(Boolean.TRUE);
                }
            } else if (n2Var.f41485i != 0) {
                SendMessagesHelper.getInstance(i10).sendSticker(n2Var.f41483f.document, null, n2Var.f41485i, null, null, null, null, null, true, 0, 0, false, null, null, 0L, 0L, null);
                ci.t0 t0Var = this.f41560d0;
                if (t0Var != null) {
                    t0Var.setProgress(1.0f);
                }
                AndroidUtilities.runOnUIThread(new v(this, i10, 1), 450L);
                Utilities.Callback callback2 = n2Var.f41490n;
                if (callback2 != null) {
                    callback2.run(Boolean.TRUE);
                    n2Var.f41490n = null;
                }
            } else if (n2Var.f41486j != null) {
                TLRPC.TL_stickers_addStickerToSet tL_stickers_addStickerToSet = new TLRPC.TL_stickers_addStickerToSet();
                tL_stickers_addStickerToSet.stickerset = MediaDataController.getInputStickerSet(n2Var.f41486j);
                                    ...
                                    public final void run() {
                                        ...
                                        switch (r6) {
                                            case 0:
                                                ...
                                                Utilities.Callback callback3 = n2Var32.f41490n;
                                                if (callback3 != null) {
                                            ...
                                            case 1:
                                                ...
                                                if (z14) {
                                                    ...
                                                    MediaDataController.getInstance(i132).putStickerSet((TLRPC.TL_messages_stickerSet) tLObject3);
                                                    MediaDataController.getInstance(i132).toggleStickerSet(null, tLObject3, 2, null, false, false);
                                                    ci.t0 t0Var22 = p2Var32.f41560d0;
                                                    if (t0Var22 != null) {
                                                ...
                                                Utilities.Callback callback22 = n2Var42.f41490n;
                                                if (callback22 != null) {
                                            ...
                                            default:
                                                ...
                                                Utilities.Callback callback32 = n2Var5.f41490n;
                                                if (callback32 != null) {
        ...
        if (this.H != null) {
            ...
            while (true) {
                ...
                if (m2Var != null) {
                    ...
                    Bitmap bitmap3 = m2Var.f41461g;
                    if (bitmap3 != null) {
                        bitmap3.recycle();
                        m2Var.f41461g = null;
                    }
                    Bitmap bitmap4 = m2Var.f41460f;
                    if (bitmap4 != null) {
                        bitmap4.recycle();
                        m2Var.f41460f = null;
                    }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.fileUploaded) {
            ...
            n2 n2Var2 = this.W;
            if (n2Var2 != null && str.equalsIgnoreCase(n2Var2.f41481b)) {
                n2 n2Var3 = this.W;
                n2Var3.f41484g = inputFile;
                TLRPC.TL_messages_uploadMedia tL_messages_uploadMedia = new TLRPC.TL_messages_uploadMedia();
                tL_messages_uploadMedia.peer = new TLRPC.TL_inputPeerSelf();
                TLRPC.TL_inputMediaUploadedDocument tL_inputMediaUploadedDocument = new TLRPC.TL_inputMediaUploadedDocument();
                tL_messages_uploadMedia.media = tL_inputMediaUploadedDocument;
                tL_inputMediaUploadedDocument.file = n2Var3.f41484g;
                if (n2Var3.f41495s != null) {
                ...
                tL_documentAttributeSticker.alt = n2Var3.f41482c;
            ...
            n2 n2Var4 = this.W;
            if (n2Var4 != null && str2.equalsIgnoreCase(n2Var4.f41481b)) {
                long longValue = ((Long) objArr[1]).longValue();
                long longValue2 = ((Long) objArr[2]).longValue();
                if (longValue2 > 0) {
                    n2 n2Var5 = this.W;
                    n2Var5.f41497u = Utilities.clamp(((float) longValue) / ((float) longValue2), 1.0f, n2Var5.f41497u);
                    ci.t0 t0Var = this.f41560d0;
                    if (t0Var != null) {
            ...
            n2 n2Var6 = this.W;
            if (n2Var6 != null && str3.equalsIgnoreCase(n2Var6.f41481b)) {
                h();
            }
        } else if (i10 == NotificationCenter.filePreparingStarted) {
            n2 n2Var7 = this.W;
            if (n2Var7 != null && objArr[0] == n2Var7.f41494r) {
                FileLoader.getInstance(UserConfig.selectedAccount).uploadFile(this.W.f41481b, false, true, 67108864);
            }
        } else if (i10 == NotificationCenter.fileNewChunkAvailable) {
            n2 n2Var8 = this.W;
            if (n2Var8 != null && objArr[0] == n2Var8.f41494r) {
                String str4 = (String) objArr[1];
                long longValue3 = ((Long) objArr[2]).longValue();
                long longValue4 = ((Long) objArr[3]).longValue();
                Float f7 = (Float) objArr[4];
                float floatValue = f7.floatValue();
                this.W.f41494r.videoEditedInfo.needUpdateProgress = true;
                FileLoader.getInstance(this.f41554a).checkUploadNewDataAvailable(str4, false, Math.max(1L, longValue3), longValue4, f7);
                n2 n2Var9 = this.W;
                n2Var9.f41496t = Math.max(n2Var9.f41496t, floatValue);
                ci.t0 t0Var2 = this.f41560d0;
                if (t0Var2 != null) {
                    t0Var2.setProgress(this.W.b());
                }
            }
        } else if (i10 == NotificationCenter.filePreparingFailed && (n2Var = this.W) != null && objArr[0] == n2Var.f41494r) {
            h();
        }
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        canvas.drawPath(this.f41577w, this.d);
    }
        ...
        if (m2Var != null) {
            ...
            if (m2Var.f41460f != null && this.L) {
                ...
                if (m2Var2.f41459c != 0) {
                    ...
                    m2 m2Var3 = this.E;
                    matrix.postRotate(m2Var3.f41459c, m2Var3.a().getWidth() / 2.0f, this.E.a().getHeight() / 2.0f);
                    m2 m2Var4 = this.E;
                    if ((m2Var4.f41459c / 90) % 2 != 0) {
    ...
    public final void g(Canvas canvas, boolean z10, ViewGroup viewGroup, boolean z11) {
        ...
        float f7;
        Paint paint;
        c6 c6Var = this.f41558c;
        c6Var.f22951a = viewGroup;
        boolean z13 = this.f41566i0;
        if (z13 || c6Var.f22953c > 0.0f) {
            if (viewGroup == null) {
                e = 1.0f;
            } else {
                if (z13 && !z11) {
            ...
            if (m2VarArr != null) {
                for (m2 m2Var : m2VarArr) {
                    if (m2Var != null && m2Var == this.E) {
                        if (this.F > 0.0f) {
                            if (m2Var.f41473t.f41568k0 != null) {
                                canvas.save();
                                canvas.clipPath(m2Var.f41473t.f41568k0);
                                if (m2Var.f41473t.I != null) {
                                    if (z10) {
                                        paint = m2Var.f41470q;
                                    } else {
                                        paint = m2Var.f41469p;
                                    ...
                                    canvas.drawPath(m2Var.f41465l, paint);
                                    if (m2Var.f41473t.f41568k0 != null && z10) {
                                        canvas.clipPath(m2Var.f41465l);
                                        paint.setStrokeWidth(AndroidUtilities.dp(f7 * 2.0f));
                                        canvas.drawPath(m2Var.f41473t.f41568k0, paint);
                                    }
                                }
                                canvas.restore();
                                return;
    ...
    public final m2 j(float f7, float f10) {
        ...
        while (true) {
            ...
            if (m2Var != null) {
                ...
                RectF rectF2 = this.H[i10].f41462i;
                float f11 = width;
                float f12 = this.f41563f0;
                float f13 = height;
                float f14 = this.f41564g0;
                rectF.set((rectF2.left / f11) * f12, (rectF2.top / f13) * f14, (rectF2.right / f11) * f12, (rectF2.bottom / f13) * f14);
                this.f41561e0.mapRect(rectF);
    ...
    public final void m(Bitmap bitmap, int i10, int i11, int i12, or0 or0Var) {
        ...
        this.T = i13;
        this.U = i14;
        if (!this.f41579y && !this.f41578x && bitmap != null && Build.VERSION.SDK_INT >= 24) {
            this.I = bitmap;
            this.J = i10;
            this.f41559c0 = null;
            ...
            if (EmuDetector.with(getContext()).detect()) {
                ...
                obj.e = min;
                obj.d = min;
                obj.f41509a = Bitmap.createBitmap(min, min, Bitmap.Config.ARGB_8888);
                new Canvas(obj.f41509a).drawRect(0.0f, 0.0f, obj.d, obj.e, i6.Jl);
                obj.f41510b = (bitmap2.getWidth() - obj.d) / 2;
                obj.f41511c = (bitmap2.getHeight() - obj.e) / 2;
                arrayList.add(obj);
                r4Var.run(arrayList);
                return;
            }
            vb.a a10 = vb.a.a(bitmap, i10);
            a2.g(a10).addOnSuccessListener(new k2.v(r4Var, 24)).addOnFailureListener(new org.telegram.ui.Components.d2(this, bitmap, i10, or0Var, r4Var, 4));
            if (this.f41559c0 == null) {
                yb.a aVar = yb.a.f46663b;
                n6.l.i(aVar, "options cannot be null");
                synchronized (wb.c.class) {
                    cVar = (wb.c) qb.g.c().a(wb.c.class);
                }
                pa.b bVar = (pa.b) cVar.f45012a.get(yb.a.class);
                n6.l.h(bVar);
                zb.d dVar2 = (zb.d) bVar.get();
                dVar2.getClass();
                fa faVar = dVar2.f48853c;
                ?? obj2 = new Object();
                obj2.f7333c = m7.TYPE_THIN;
                qb.m.f41254a.execute(new com.google.android.gms.internal.cast.p(faVar, new a5.a((com.google.firebase.messaging.n) obj2, 1), o7.ON_DEVICE_IMAGE_LABEL_CREATE, faVar.b(), 7));
                new ImageLabelerImpl((qb.e) dVar2.f48851a.O0(aVar), (Executor) dVar2.f48852b.f41235a.get(), new k6.c("vision.ica", 1L)).g(a10).addOnSuccessListener(new k2.v(this, 25)).addOnFailureListener(new zr0(24));
            }
            List<TLRPC.TL_availableReaction> enabledReactionsList = MediaDataController.getInstance(this.f41554a).getEnabledReactionsList();
    ...
    public final void n(TLRPC.TL_error tL_error) {
        if (tL_error != null && !"PACK_TITLE_INVALID".equals(tL_error.text)) {
            new vc((FrameLayout) getParent(), this.f41555a0).t(tL_error.text, null).j();
        }
    }

    public final void o() {
        Path path = this.f41568k0;
        if (path == null) {
            this.f41568k0 = new Path();
        } else {
            path.rewind();
        }
        if (this.f41569l0 == null) {
            this.f41569l0 = new Path();
            RectF rectF = AndroidUtilities.rectTmp;
            rectF.set(0.0f, 0.0f, 1.0f, 1.0f);
            this.f41569l0.addRoundRect(rectF, rectF.width() * 0.12f, rectF.height() * 0.12f, Path.Direction.CW);
        }
        this.f41568k0.addPath(this.f41569l0, this.f41567j0);
        this.f41568k0.computeBounds(this.m0, true);
    }

    @Override
    public final void onAttachedToWindow() {
        super.onAttachedToWindow();
        NotificationCenter.getInstance(this.f41554a).addObserver(this, NotificationCenter.fileUploaded);
        NotificationCenter.getInstance(this.f41554a).addObserver(this, NotificationCenter.fileUploadProgressChanged);
        NotificationCenter.getInstance(this.f41554a).addObserver(this, NotificationCenter.fileUploadFailed);
        NotificationCenter.getInstance(this.f41554a).addObserver(this, NotificationCenter.filePreparingFailed);
        NotificationCenter.getInstance(this.f41554a).addObserver(this, NotificationCenter.filePreparingStarted);
        NotificationCenter.getInstance(this.f41554a).addObserver(this, NotificationCenter.fileNewChunkAvailable);
    }
    ...
    public final void onDetachedFromWindow() {
        ...
        if (i10 >= 0) {
            ...
            NotificationCenter.getInstance(this.f41554a).removeObserver(this, NotificationCenter.fileUploadProgressChanged);
            NotificationCenter.getInstance(this.f41554a).removeObserver(this, NotificationCenter.fileUploadFailed);
            NotificationCenter.getInstance(this.f41554a).removeObserver(this, NotificationCenter.filePreparingFailed);
            NotificationCenter.getInstance(this.f41554a).removeObserver(this, NotificationCenter.filePreparingStarted);
            NotificationCenter.getInstance(this.f41554a).removeObserver(this, NotificationCenter.fileNewChunkAvailable);
        }
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (Build.VERSION.SDK_INT >= 29) {
            ArrayList arrayList = this.f41573p0;
            arrayList.clear();
            if (this.f41566i0) {
                Rect rect = this.f41574q0;
                arrayList.add(rect);
    ...
    public final void p(final String str, final VideoEditedInfo videoEditedInfo, final String str2, final CharSequence charSequence, final boolean z10, final long j3, final TLRPC.StickerSet stickerSet, final TLRPC.Document document, final TLRPC.Document document2, final String str3, final Utilities.Callback callback, final Utilities.Callback2 callback2) {
        AndroidUtilities.runOnUIThread(new Runnable() {
            ...
            public final void run() {
                ...
                if (callback3 != null && (n2Var = p2Var.W) != null && n2Var.f41491o) {
                    z11 = false;
                } else {
                    z11 = true;
                }
                if (z11) {
                    ...
                    ?? obj = new Object();
                    obj.f41492p = new ArrayList();
                    obj.f41493q = new ArrayList();
                    obj.f41496t = 0.0f;
                    obj.f41497u = 0.0f;
                    p2Var.W = obj;
                }
                ...
                n2Var3.h = z10;
                n2Var3.f41485i = j3;
                n2Var3.f41486j = stickerSet;
                n2Var3.f41487k = document;
                VideoEditedInfo videoEditedInfo2 = videoEditedInfo;
                n2Var3.f41495s = videoEditedInfo2;
                n2Var3.f41488l = str3;
                n2Var3.f41490n = callback3;
                n2Var3.f41489m = callback2;
                ArrayList arrayList = n2Var3.f41493q;
                if (!TextUtils.isEmpty(str4)) {
                    n2Var3.f41492p.add(new File(n2Var3.f41481b));
                }
                if (!TextUtils.isEmpty(n2Var3.f41480a) && !TextUtils.equals(n2Var3.f41480a, n2Var3.f41481b)) {
                    arrayList.add(new File(n2Var3.f41480a));
                }
                if (!TextUtils.isEmpty(n2Var3.f41488l)) {
                    arrayList.add(new File(n2Var3.f41488l));
                }
                if (!z11) {
                    p2Var.a();
                } else {
                    ...
                    if (document3 != null) {
                        n2 n2Var4 = p2Var.W;
                        n2Var4.e = MediaDataController.getInputStickerSetItem(document3, n2Var4.f41482c);
                        p2Var.W.f41483f = new TLRPC.TL_messageMediaDocument();
                        TLRPC.TL_messageMediaDocument tL_messageMediaDocument = p2Var.W.f41483f;
                        ...
                        n2Var5.f41481b = absolutePath;
                        p2Var.W.f41494r = new MessageObject(UserConfig.selectedAccount, (TLRPC.Message) tL_message, (MessageObject) null, false, false);
                        p2Var.W.f41494r.videoEditedInfo = videoEditedInfo2;
                        MediaController.getInstance().scheduleVideoConvert(p2Var.W.f41494r, false, false, false);
                    } else {
                        FileLoader.getInstance(p2Var.f41554a).uploadFile(str4, false, true, 67108864);
                    }
                }
                if (callback3 == null) {
                    if (p2Var.f41560d0 == null) {
                        p2Var.f41560d0 = new ci.t0(p2Var.getContext(), LocaleController.getString(R.string.PreparingSticker));
                    }
                    p2Var.f41560d0.setOnCancelListener(new g2(p2Var, 0));
                    if (p2Var.f41560d0.getParent() == null) {
                        p2Var.addView(p2Var.f41560d0, x5.e(-1, -1, 17));
                    }
                    ci.t0 t0Var = p2Var.f41560d0;
                    t0Var.E = true;
                    t0Var.invalidate();
                }
            }
    ...
    public void setCurrentAccount(int i10) {
        ...
        if (i11 != i10) {
            if (i11 >= 0 && isAttachedToWindow()) {
                NotificationCenter.getInstance(this.f41554a).removeObserver(this, NotificationCenter.fileUploaded);
                NotificationCenter.getInstance(this.f41554a).removeObserver(this, NotificationCenter.fileUploadProgressChanged);
                NotificationCenter.getInstance(this.f41554a).removeObserver(this, NotificationCenter.fileUploadFailed);
                NotificationCenter.getInstance(this.f41554a).removeObserver(this, NotificationCenter.filePreparingFailed);
                NotificationCenter.getInstance(this.f41554a).removeObserver(this, NotificationCenter.filePreparingStarted);
    ...
    public void setOutlineVisible(boolean z10) {
        float f7;
        if (this.f41566i0 != z10) {
            this.f41566i0 = z10;
            ViewPropertyAnimator animate = this.f41565h0.animate();
            float f10 = 0.0f;
            if (z10) {
                f7 = 1.0f;
            } else {
