...
public final class t extends View {
    ...
    public long f44607e;
    public final Path f44608f;
    public final float[] h;
    public final HashMap f44609n;
    public final x f44610r;

    public t(x xVar, Context context) {
        super(context);
        int d;
        this.f44610r = xVar;
        this.f44604a = new Paint(1);
        this.f44605b = new int[]{-16735784, -16752387, -11788361, -6804548, -4707235, -180718, -38656, -152832, -211200, -198077, -2495689, -8996289};
        Paint paint = new Paint(1);
        this.f44606c = paint;
        this.d = new LongSparseArray();
        this.f44607e = Long.MIN_VALUE;
        this.f44608f = new Path();
        this.h = new float[8];
        this.f44609n = new HashMap();
        ...
        for (int i10 = 0; i10 < 12; i10++) {
            for (int i11 = 0; i11 < 10; i11++) {
                if (i11 == 0) {
                    this.f44609n.put(Long.valueOf((i10 << 16) + i11), Integer.valueOf(i0.a.d(i10 / 11.0f, -1, -16777216)));
                } else {
                    if (i11 < 6) {
                        d = i0.a.d(((5 - i11) / 4.0f) * 0.5f, this.f44605b[i10], -16777216);
                    } else {
                        d = i0.a.d(wl.c(9 - i11, 5.0f, 0.5f, 0.5f), this.f44605b[i10], -1);
                    }
                    this.f44609n.put(Long.valueOf((i10 << 16) + i11), Integer.valueOf(d));
                }
            }
        }
    }
    ...
    public final void a(int i10) {
        for (Map.Entry entry : this.f44609n.entrySet()) {
    ...
    public final void b(int i10, int i11) {
        ...
        if (longSparseArray.get(j3) == null) {
            longSparseArray.put(this.f44607e, Float.valueOf(0.0f));
        }
        invalidate();
    }
    ...
    public final void c(MotionEvent motionEvent) {
        ...
        Integer num = (Integer) this.f44609n.get(Long.valueOf((x10 << 16) + y3));
        if (num != null) {
            int intValue = num.intValue();
            int i10 = x.f44643s;
            this.f44610r.m(intValue, 3);
            b(x10, y3);
        }
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        canvas.save();
        Path path = this.f44610r.f44646e;
        path.rewind();
        ...
        while (true) {
            ...
            if (i13 < longSparseArray.size()) {
                ...
                if (max <= 0.0f && this.f44607e != keyAt) {
