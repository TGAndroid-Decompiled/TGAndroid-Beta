...
public abstract class d2 extends ci.d {
    public final na f41600h0;
    public final RectF f41601i0;
    public int f41602j0;
    public final n2 f41603k0;
    public final d6 f41604l0;
    public int m0;
    public boolean f41605n0;

    public d2(n2 n2Var, ContextThemeWrapper contextThemeWrapper, d6 d6Var, ja jaVar) {
        super(contextThemeWrapper, d6Var, false);
        this.f41601i0 = new RectF();
        this.m0 = 8;
        this.f41604l0 = d6Var;
        this.f41603k0 = n2Var;
        this.f41600h0 = new na(jaVar, this, 0, true);
    ...
    public void setAlpha(float f7) {
        k2[] k2VarArr;
        n2 n2Var = this.f41603k0;
        super.setAlpha((!n2Var.f41820y || (k2VarArr = n2Var.H) == null || k2VarArr.length <= 0) ? 0.0f : 0.0f);
    }
    ...
    public void setRad(int i10) {
        this.m0 = i10;
        setForeground(h6.Y(h6.v0(h6.f19134i6, this.f41604l0), i10, i10));
    }
