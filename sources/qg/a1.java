...
public final class a1 extends vl0 {
    ...
    @Override
    public final int h() {
        return this.h.f41598s0.size();
    }

    @Override
    public final int j(int i10) {
        ArrayList arrayList = this.h.f41598s0;
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        boolean z12;
        c6 c6Var = this.h;
        ArrayList arrayList = c6Var.f41598s0;
        ...
        if (view instanceof org.telegram.ui.Cells.u1) {
            ...
            MessageObject.GroupedMessages groupedMessages2 = c6Var.f41599t0;
