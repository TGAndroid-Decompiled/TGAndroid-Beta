...
public class v0 extends View {
    ...
    public final Paint f41704f;
    public final Drawable h;
    public boolean f41705n;
    public final ImageReceiver f41706r;
    public final ImageReceiver f41707s;
    public TLRPC.Document v;
    public TLRPC.Document f41708w;
    public boolean f41709x;
    public final float f41710y;
    ...
    public v0(Context context, float f7) {
        ...
        this.e = textPaint;
        this.f41704f = new Paint(1);
        ImageReceiver imageReceiver = new ImageReceiver(this);
        this.f41706r = imageReceiver;
        ImageReceiver imageReceiver2 = new ImageReceiver(this);
        this.f41707s = imageReceiver2;
        this.E = 1.0f;
        this.O = new RectF();
        new Path();
    ...
    public final void a(Canvas canvas) {
        ...
        canvas.drawRoundRect(rectF, f12, f12, this.f41704f);
        boolean z10 = this.f41705n;
        float f13 = this.f41710y;
        RectF rectF2 = this.d;
        if (z10) {
            ...
            if (e > 0.0f) {
                ...
                ImageReceiver imageReceiver = this.f41707s;
            ...
            if (e < 1.0f) {
                ...
                ImageReceiver imageReceiver2 = this.f41706r;
        ...
        if (isEmpty) {
            ...
            MediaDataController.getInstance(i10).getStickerSet(tL_inputStickerSetShortName, 0, false, new Utilities.Callback(this) {
                ...
                public final void run(Object obj) {
                    switch (r3) {
                        case 0:
                            v0 v0Var = this.f41689b;
                            v0Var.getClass();
                            String str2 = str;
                            TLRPC.Document b10 = v0.b(str2, (TLRPC.TL_messages_stickerSet) obj);
                            v0Var.v = b10;
                            v0Var.f41706r.setImage(ImageLocation.getForDocument(b10), "80_80", v0.c(str2), null, null, 0);
                            v0Var.f41707s.setImage(ImageLocation.getForDocument(v0Var.f41708w), "80_80", ImageLocation.getForDocument(v0Var.v), "80_80", null, null, v0.c(str2), 0L, null, null, 0);
                            return;
                        default:
                            v0 v0Var2 = this.f41689b;
                            v0Var2.getClass();
                            String str3 = str;
                            TLRPC.Document b11 = v0.b(str3, (TLRPC.TL_messages_stickerSet) obj);
                            v0Var2.f41708w = b11;
                            if (b11 != null) {
                                v0Var2.f41707s.setImage(ImageLocation.getForDocument(b11), "80_80", ImageLocation.getForDocument(v0Var2.v), "80_80", null, null, v0.c(str3), 0L, null, null, 0);
                                return;
                            }
                            return;
                    }
            ...
            imageReceiver.setImage(ImageLocation.getForDocument(this.f41708w), "80_80", ImageLocation.getForDocument(this.v), "80_80", null, null, c(str), 0L, null, null, 0);
        }
        this.f41703c = true;
        requestLayout();
    }
    ...
    public final void f() {
        ...
        if (min < 0.4f) {
            ...
            f10 = 1.0f;
            this.F = new StaticLayout(this.f41702b, textPaint, (int) Math.ceil(measureText), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
        }
        this.G = 0.0f;
    ...
    public TLRPC.Document getCodeEmojiDocument() {
        ...
        if (this.L && (document = this.f41708w) != null) {
            return document;
        }
        return this.v;
    }
    ...
    public final void onAttachedToWindow() {
        ...
        this.K = true;
        if (this.L) {
            this.f41707s.onAttachedToWindow();
        } else {
            this.f41706r.onAttachedToWindow();
        }
    }
    ...
    public final void onDetachedFromWindow() {
        ...
        this.K = false;
        this.f41706r.onDetachedFromWindow();
        this.f41707s.onDetachedFromWindow();
    }
