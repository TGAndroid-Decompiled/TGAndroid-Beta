...
public final class t0 {
    ...
    public final float f44615e;
    public final PointF f44616f;
    public final PointF f44617g;
    ...
    public t0(t8.a aVar, Bitmap bitmap, iv0 iv0Var, boolean z10) {
        ...
        PointF pointF3 = null;
        PointF pointF4 = null;
        for (t8.d dVar : aVar.f46495b) {
            PointF pointF5 = dVar.f46503a;
            int i10 = dVar.f46504b;
            if (i10 != 4) {
                if (i10 != 5) {
                    if (i10 != 10) {
                        if (i10 == 11) {
        ...
        if (pointF != null && pointF2 != null) {
            ...
            this.f44615e = hypot;
            this.f44613b = (float) Math.toDegrees(Math.atan2(pointF2.y - pointF.y, pointF2.x - pointF.x) + 3.141592653589793d);
            this.f44612a = 2.35f * hypot;
            float f7 = hypot * 0.8f;
            float f10 = pointF7.x;
            double radians = (float) Math.toRadians(degrees - 90.0f);
            this.f44614c = new PointF((((float) Math.cos(radians)) * f7) + f10, (f7 * ((float) Math.sin(radians))) + pointF7.y);
        }
        if (pointF3 != null && pointF4 != null) {
            ...
            this.f44616f = pointF9;
            float f11 = this.f44615e * 0.7f;
            float f12 = pointF9.x;
            double radians2 = (float) Math.toRadians(this.f44613b + 90.0f);
            this.f44617g = new PointF((((float) Math.cos(radians2)) * f11) + f12, (f11 * ((float) Math.sin(radians2))) + pointF9.y);
        }
    }
    ...
    public static PointF b(PointF pointF, Bitmap bitmap, iv0 iv0Var, boolean z10) {
        ...
        return new PointF((iv0Var.f27299a * pointF.x) / f7, (iv0Var.f27300b * pointF.y) / height);
    }
