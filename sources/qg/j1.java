...
public abstract class j1 extends xl0 {
    public static final Paint f41699c3;
    public static final Paint f41700d3;
    public static final Path f41701e3;
    public static final Paint f41702f3;
    public final Paint X2;
    public final Paint Y2;
    public int Z2;
    public pg.u0 f41703a3;
    public q0.a f41704b3;
    ...
    public static void w1(Canvas canvas, RectF rectF, int i10) {
        ...
        while (f7 <= rectF.right) {
            ...
            while (f10 <= rectF.bottom) {
                ...
                float f12 = f7 + f11;
                float f13 = f10 + f11;
                Paint paint = f41699c3;
                Canvas canvas2 = canvas;
                canvas2.drawRect(f7, f10, f12, f13, paint);
                float f14 = i10 * 2;
                float f15 = f7 + f14;
                Paint paint2 = f41700d3;
                float f16 = f10;
    ...
    public final void y1(float f7, boolean z10) {
        ...
        float f10;
        if (z10) {
            interpolation = sr.f28340g.getInterpolation(f7);
        } else {
            interpolation = sr.f28341i.getInterpolation(f7);
        }
