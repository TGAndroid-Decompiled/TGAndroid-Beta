...
public abstract class j1 extends wl0 {
    public static final Paint f41700c3;
    public static final Paint f41701d3;
    public static final Path f41702e3;
    public static final Paint f41703f3;
    public final Paint X2;
    public final Paint Y2;
    public int Z2;
    public pg.u0 f41704a3;
    public q0.a f41705b3;
    ...
    public static void w1(Canvas canvas, RectF rectF, int i10) {
        ...
        while (f7 <= rectF.right) {
            ...
            while (f10 <= rectF.bottom) {
                ...
                float f12 = f7 + f11;
                float f13 = f10 + f11;
                Paint paint = f41700c3;
                Canvas canvas2 = canvas;
                canvas2.drawRect(f7, f10, f12, f13, paint);
                float f14 = i10 * 2;
                float f15 = f7 + f14;
                Paint paint2 = f41701d3;
                float f16 = f10;
    ...
    public final void y1(float f7, boolean z10) {
        ...
        float f10;
        if (z10) {
            interpolation = rr.f28031g.getInterpolation(f7);
        } else {
            interpolation = rr.f28032i.getInterpolation(f7);
        }
