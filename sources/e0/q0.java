...
public final class q0 {
    ...
    public final Bundle f5012b;
    public final HashSet f5013c;
    ...
    public static RemoteInput[] a(q0[] q0VarArr) {
        ...
        for (int i10 = 0; i10 < q0VarArr.length; i10++) {
            ...
            q0Var.getClass();
            RemoteInput.Builder addExtras = new RemoteInput.Builder("extra_voice_reply").setLabel(q0Var.f5011a).setChoices(null).setAllowFreeFormInput(true).addExtras(q0Var.f5012b);
            if (Build.VERSION.SDK_INT >= 26) {
                Iterator it = q0Var.f5013c.iterator();
                while (it.hasNext()) {
