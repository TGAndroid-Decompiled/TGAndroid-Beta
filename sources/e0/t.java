...
public final class t {
    ...
    public final void a(int i10, String str, PendingIntent pendingIntent) {
        ...
        this.f7831b.add(new k(iconCompat, str, pendingIntent, new Bundle(), null, null, true, 0, true));
    }
    ...
    public final void c(g0 g0Var) {
        ...
        if (!g0Var.f7777a.isEmpty()) {
            ArrayList<? extends Parcelable> arrayList = new ArrayList<>(g0Var.f7777a.size());
            ArrayList arrayList2 = g0Var.f7777a;
            ...
            while (i11 < size) {
                ...
                if (i12 >= 23) {
                    ...
                    d = d0.a(icon, kVar.h, kVar.f7800i);
                } else {
                    ...
                    d = c0.d(i10, kVar.h, kVar.f7800i);
                }
                Bundle bundle3 = kVar.f7795a;
                boolean z10 = kVar.d;
                if (bundle3 != null) {
                    bundle = new Bundle(kVar.f7795a);
                } else {
                    bundle = new Bundle();
                }
        ...
        int i13 = g0Var.f7778b;
        if (i13 != 1) {
            bundle2.putInt("flags", i13);
        }
        if (!g0Var.f7779c.isEmpty()) {
            ArrayList arrayList3 = g0Var.f7779c;
        ...
        int i16 = g0Var.f7780f;
        if (i16 != 80) {
            bundle2.putInt("gravity", i16);
        }
        String str = g0Var.f7781g;
        if (str != null) {
    ...
    public final void n(b0 b0Var) {
        if (this.f7838l != b0Var) {
            this.f7838l = b0Var;
            if (b0Var.f7765a != this) {
                b0Var.f7765a = this;
                n(b0Var);
            }
        }
