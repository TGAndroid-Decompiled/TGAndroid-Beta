...
public final class t {
    ...
    public final ArrayList f7835b;
    public final ArrayList f7836c;
    public final ArrayList d;
    public CharSequence e;
    public CharSequence f7837f;
    public PendingIntent f7838g;
    public IconCompat h;
    public int f7839i;
    public int f7840j;
    public boolean f7841k;
    public b0 f7842l;
    public CharSequence f7843m;
    public int f7844n;
    public int f7845o;
    ...
    public int f7852w;
    public int f7853x;
    public String f7854y;
    public String f7855z;
    ...
    public final void a(int i10, String str, PendingIntent pendingIntent) {
        ...
        this.f7835b.add(new k(iconCompat, str, pendingIntent, new Bundle(), null, null, true, 0, true));
    }
    ...
    public final Notification b() {
        ...
        t tVar = (t) i0Var.d;
        b0 b0Var = tVar.f7842l;
        if (b0Var != null) {
            b0Var.b(i0Var);
        }
        Notification.Builder builder = (Notification.Builder) i0Var.f7790c;
        int i10 = i0Var.f7788a;
    ...
    public final void c(g0 g0Var) {
        ...
        if (!g0Var.f7781a.isEmpty()) {
            ArrayList<? extends Parcelable> arrayList = new ArrayList<>(g0Var.f7781a.size());
            ArrayList arrayList2 = g0Var.f7781a;
            ...
            while (i11 < size) {
                ...
                if (i12 >= 23) {
                    ...
                    d = d0.a(icon, kVar.h, kVar.f7804i);
                } else {
                    ...
                    d = c0.d(i10, kVar.h, kVar.f7804i);
                }
                Bundle bundle3 = kVar.f7799a;
                boolean z10 = kVar.d;
                if (bundle3 != null) {
                    bundle = new Bundle(kVar.f7799a);
                } else {
                    bundle = new Bundle();
                }
        ...
        int i13 = g0Var.f7782b;
        if (i13 != 1) {
            bundle2.putInt("flags", i13);
        }
        if (!g0Var.f7783c.isEmpty()) {
            ArrayList arrayList3 = g0Var.f7783c;
        ...
        int i16 = g0Var.f7784f;
        if (i16 != 80) {
            bundle2.putInt("gravity", i16);
        }
        String str = g0Var.f7785g;
        if (str != null) {
    ...
    public final void n(b0 b0Var) {
        if (this.f7842l != b0Var) {
            this.f7842l = b0Var;
            if (b0Var.f7769a != this) {
                b0Var.f7769a = this;
                n(b0Var);
            }
        }
