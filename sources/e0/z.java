...
public final class z {
    ...
    public static Bundle[] a(ArrayList arrayList) {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            ...
            CharSequence charSequence = zVar.f7840a;
            if (charSequence != null) {
                bundle.putCharSequence("text", charSequence);
            }
            bundle.putLong("time", zVar.f7841b);
            if (p0Var != null) {
                bundle.putCharSequence("sender", p0Var.f7807a);
    ...
    public final Notification.MessagingStyle.Message b() {
        ...
        Person person = null;
        long j3 = this.f7841b;
        CharSequence charSequence2 = this.f7840a;
        p0 p0Var = this.f7842c;
        if (i10 >= 28) {
            if (p0Var != null) {
                person = b5.d.E(p0Var);
            }
