...
public abstract class p {
    public static Notification.BubbleMetadata a(r rVar) {
        ...
        boolean z10;
        if (rVar == null || (pendingIntent = rVar.f7829a) == null) {
            return null;
        }
        Notification.BubbleMetadata.Builder deleteIntent = new Notification.BubbleMetadata.Builder().setIcon(rVar.f7830b.m(null)).setIntent(pendingIntent).setDeleteIntent(null);
        boolean z11 = true;
        if ((rVar.d & 1) != 0) {
            z10 = true;
        } else {
