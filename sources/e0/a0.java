...
public final class a0 extends b0 {
    ...
    public final ArrayList f7767f = new ArrayList();
    ...
    public final void a(Bundle bundle) {
        super.a(bundle);
        p0 p0Var = this.f7768g;
        bundle.putCharSequence("android.selfDisplayName", p0Var.f7824a);
        bundle.putBundle("android.messagingStyleUser", p0Var.c());
        bundle.putCharSequence("android.hiddenConversationTitle", this.h);
        if (this.h != null && this.f7769i.booleanValue()) {
    ...
    public final SpannableStringBuilder e(z zVar) {
        ...
        if (TextUtils.isEmpty(charSequence)) {
            charSequence = this.f7768g.f7824a;
            int i11 = this.f7770a.f7853w;
            if (i11 != 0) {
                i10 = i11;
            }
        }
        ...
        CharSequence charSequence3 = zVar.f7857a;
    ...
    public a0(p0 p0Var) {
        if (!TextUtils.isEmpty(p0Var.f7824a)) {
            this.f7768g = p0Var;
            return;
        }
