...
public final class a0 extends b0 {
    ...
    public final void a(Bundle bundle) {
        super.a(bundle);
        p0 p0Var = this.f7763g;
        bundle.putCharSequence("android.selfDisplayName", p0Var.f7819a);
        bundle.putBundle("android.messagingStyleUser", p0Var.c());
        bundle.putCharSequence("android.hiddenConversationTitle", this.h);
        if (this.h != null && this.f7764i.booleanValue()) {
    ...
    public final SpannableStringBuilder e(z zVar) {
        ...
        if (TextUtils.isEmpty(charSequence)) {
            charSequence = this.f7763g.f7819a;
            int i11 = this.f7765a.f7848w;
            if (i11 != 0) {
                i10 = i11;
            }
        }
        ...
        CharSequence charSequence3 = zVar.f7852a;
    ...
    public a0(p0 p0Var) {
        if (!TextUtils.isEmpty(p0Var.f7819a)) {
            this.f7763g = p0Var;
            return;
        }
