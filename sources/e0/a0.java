...
public final class a0 extends b0 {
    ...
    public final ArrayList f7766f = new ArrayList();
    public final p0 f7767g;
    ...
    public final void a(Bundle bundle) {
        super.a(bundle);
        p0 p0Var = this.f7767g;
        bundle.putCharSequence("android.selfDisplayName", p0Var.f7823a);
        bundle.putBundle("android.messagingStyleUser", p0Var.c());
        bundle.putCharSequence("android.hiddenConversationTitle", this.h);
        if (this.h != null && this.f7768i.booleanValue()) {
    ...
    public final SpannableStringBuilder e(z zVar) {
        ...
        p0 p0Var = zVar.f7858c;
        CharSequence charSequence2 = "";
        if (p0Var == null) {
            charSequence = "";
        } else {
            charSequence = p0Var.f7823a;
        }
        int i10 = -16777216;
        if (TextUtils.isEmpty(charSequence)) {
            charSequence = this.f7767g.f7823a;
            int i11 = this.f7769a.f7852w;
            if (i11 != 0) {
                i10 = i11;
            }
        }
        ...
        CharSequence charSequence3 = zVar.f7856a;
    ...
    public a0(p0 p0Var) {
        if (!TextUtils.isEmpty(p0Var.f7823a)) {
            this.f7767g = p0Var;
            return;
        }
