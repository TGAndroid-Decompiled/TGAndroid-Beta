...
public final class h1 extends ch.c implements xd.b {
    public static final int f14151s = 0;
    public final xd.c f14152f;
    public final dg.h0 h;
    public final ch.b[] f14153n;
    public int f14154r;

    public h1(Context context, org.telegram.ui.ActionBar.g6 g6Var, dg.h0 h0Var) {
        super(context);
        this.f14152f = new xd.c(0, this, pr.h, 1600L);
        this.h = h0Var;
        ...
        this.f14153n = new ch.b[]{ch.b.b(context, g6Var, ch.a.D, R.string.GiftPreviewModels), ch.b.b(context, g6Var, ch.a.v, R.string.GiftPreviewBackdrops), ch.b.b(context, g6Var, ch.a.G, R.string.GiftPreviewSymbols)};
        int i11 = 0;
        while (true) {
            ch.b[] bVarArr = this.f14153n;
            if (i11 < bVarArr.length) {
                this.f2530a.addView(bVarArr[i11], k7.c6.l(1.0f, 0, -1));
                this.f14153n[i11].setOnClickListener(new x0(this, i11, 1));
                i11++;
            } else {
