...
public final class c extends ViewGroup implements me.a, NotificationCenter.NotificationCenterDelegate, le.d {
    ...
    public c(Context context) {
        ...
        hVar.f31502c.setStrokeWidth(AndroidUtilities.dp(1.0f));
    ...
    public final void E(int i10, float f7, float f10, le.e eVar) {
        ...
        hVar.f31500a.setAlpha(round);
        hVar.f31502c.setAlpha(round);
        invalidate();
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.h.f31504f = Math.round(((RectF) this.f16322w.f2066c).width() + AndroidUtilities.dp(48.0f));
    }
