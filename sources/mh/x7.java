...
public final class x7 implements Runnable {
    ...
    public final org.telegram.ui.ActionBar.h3[] f15055b;
    public final TL_stars.StarsTransaction f15056c;
    public final long d;

    public x7(org.telegram.ui.ActionBar.h3[] h3VarArr, long j10, TL_stars.StarsTransaction starsTransaction) {
        this.f15054a = 2;
        this.f15055b = h3VarArr;
        this.d = j10;
        this.f15056c = starsTransaction;
    }
    ...
    public final void run() {
        switch (this.f15054a) {
            case 0:
                this.f15055b[0].dismiss();
                org.telegram.ui.ActionBar.p2 U = LaunchActivity.U();
                if (U != null) {
                    TL_stars.StarsTransaction starsTransaction = this.f15056c;
            ...
            case 1:
                ...
                if (U2 != null) {
                    TL_stars.StarsTransaction starsTransaction2 = this.f15056c;
            ...
            case 2:
                ...
                if (U3 != null) {
                    ...
                    bundle.putInt("message_id", this.f15056c.msg_id);
            ...
            case 3:
                ...
                if (U4 != null) {
                    TL_stars.StarsTransaction starsTransaction3 = this.f15056c;
            ...
            default:
                ...
                if (U5 != null) {
                    TL_stars.StarsTransaction starsTransaction4 = this.f15056c;
