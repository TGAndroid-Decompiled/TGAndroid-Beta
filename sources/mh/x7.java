...
public final class x7 implements Runnable {
    ...
    public final org.telegram.ui.ActionBar.h3[] f15057b;
    public final TL_stars.StarsTransaction f15058c;
    public final long d;

    public x7(org.telegram.ui.ActionBar.h3[] h3VarArr, long j10, TL_stars.StarsTransaction starsTransaction) {
        this.f15056a = 2;
        this.f15057b = h3VarArr;
        this.d = j10;
        this.f15058c = starsTransaction;
    }
    ...
    public final void run() {
        switch (this.f15056a) {
            case 0:
                this.f15057b[0].dismiss();
                org.telegram.ui.ActionBar.p2 U = LaunchActivity.U();
                if (U != null) {
                    TL_stars.StarsTransaction starsTransaction = this.f15058c;
            ...
            case 1:
                ...
                if (U2 != null) {
                    TL_stars.StarsTransaction starsTransaction2 = this.f15058c;
            ...
            case 2:
                ...
                if (U3 != null) {
                    ...
                    bundle.putInt("message_id", this.f15058c.msg_id);
            ...
            case 3:
                ...
                if (U4 != null) {
                    TL_stars.StarsTransaction starsTransaction3 = this.f15058c;
            ...
            default:
                ...
                if (U5 != null) {
                    TL_stars.StarsTransaction starsTransaction4 = this.f15058c;
    ...
    public x7(org.telegram.ui.ActionBar.h3[] h3VarArr, TL_stars.StarsTransaction starsTransaction, long j10, int i10) {
        this.f15056a = i10;
        this.f15057b = h3VarArr;
        this.f15058c = starsTransaction;
        this.d = j10;
