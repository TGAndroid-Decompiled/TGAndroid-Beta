...
public final class ja extends m20 implements NotificationCenter.NotificationCenterDelegate {
    public static DecimalFormat f14316e0;
    public static DecimalFormat f14317f0;
    ...
    public ob1 Y;
    public qh.d Z;
    public qh.d f14318a0;
    public boolean f14319b0;
    public boolean f14320c0;
    public k9 f14321d0;
    ...
    public static void F0(sz0 sz0Var, int i10, TL_stars.StarGift starGift, org.telegram.ui.ActionBar.g6 g6Var) {
        ...
        if (!starGift.sold_out) {
            ...
            final long j10 = starGift.f21072id;
            ...
            final NotificationCenter.NotificationCenterDelegate[] notificationCenterDelegateArr = {new NotificationCenter.NotificationCenterDelegate() {
                ...
                public final void didReceivedNotification(int i11, int i12, Object[] objArr) {
                    ...
                    if (!zArr2[0] && i11 == (i13 = NotificationCenter.starGiftsLoaded) && (J = (t7Var = t7.this).J(j10)) != null) {
                        zArr2[0] = true;
                        NotificationCenter.getInstance(t7Var.f14830a).removeObserver(notificationCenterDelegateArr[0], i13);
                        h0Var.run(J);
                    }
                }
            }};
    ...
    public static SpannableStringBuilder J0(TL_stars.StarsAmount starsAmount, float f10, char c3) {
        ...
        int i10;
        if (f14317f0 == null) {
            f14317f0 = new DecimalFormat("0.################", new DecimalFormatSymbols(Locale.US));
        }
        ...
        if (starsAmount instanceof TL_stars.TL_starsTonAmount) {
            ...
            if (j10 % 1000000000 != 0) {
                String format = f14317f0.format(j10 / 1.0E9d);
            ...
            if (i11 != 0) {
                ...
                DecimalFormat decimalFormat = f14317f0;
    ...
    public static SpannableStringBuilder K0(TL_stars.StarsAmount starsAmount, float f10, char c3) {
        ...
        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder();
        if (starsAmount instanceof TL_stars.TL_starsTonAmount) {
            String format = f14317f0.format(starsAmount.amount / 1.0E9d);
            spannableStringBuilder.append((CharSequence) format);
            int indexOf = format.indexOf(".");
            if (indexOf >= 0) {
                spannableStringBuilder.setSpan(new RelativeSizeSpan(f10), indexOf, spannableStringBuilder.length(), 33);
    ...
    public static String M0(long j10) {
        String str;
        if (f14316e0 == null) {
            f14316e0 = new DecimalFormat("0.####", new DecimalFormatSymbols(Locale.US));
        }
        if (j10 % 1000000000 != 0) {
            return f14316e0.format(j10 / 1.0E9d);
        }
        StringBuilder sb = new StringBuilder();
        if (j10 < 0) {
            str = "-";
    ...
    public static void Z0(ImageReceiver imageReceiver, TLRPC.Document document, int i10) {
        ...
        imageReceiver.setImage(ImageLocation.getForDocument(document), e2.c.h(i10, "_", i10), ImageLocation.getForDocument(closestPhotoSizeWithSize, document), e2.c.h(i10, "_", i10), DocumentObject.getSvgThumb(document.thumbs, org.telegram.ui.ActionBar.k6.f21607a7, 0.35f), 0L, null, null, 0);
    }
    ...
    public static void e1(Context context, int i10, long j10, TL_stories.Boost boost, org.telegram.ui.ActionBar.g6 g6Var) {
        ...
        sz0Var.k(LocaleController.getString(R.string.BoostFrom), i10, j10, new w7(h3VarArr, j10, 2));
        ...
        g90Var.setTextColor(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.f22055z6, g6Var));
    ...
    public static v0 f1(Context context, int i10, TL_stars.TL_starGiftUnique tL_starGiftUnique, Utilities.Callback2 callback2, org.telegram.ui.ActionBar.g6 g6Var) {
        ...
        if (tL_starGiftUnique == null) {
            ...
            resellAmount = tL_starGiftUnique.getResellAmount(mf.b.f13654b);
        } else {
    ...
    public static void g1(Context context, long j10, boolean z4, final Utilities.Callback2 callback2, org.telegram.ui.ActionBar.g6 g6Var) {
        ...
        editTextBoldCursor.setHighlightColor(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.f21972uf, g6Var));
        editTextBoldCursor.setHandlesColor(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.f21990vf, g6Var));
    ...
    public static void i1(Activity activity, int i10, int i11, TLRPC.TL_messageActionPaymentRefunded tL_messageActionPaymentRefunded, org.telegram.ui.ActionBar.g6 g6Var) {
        ...
        starsTransaction.f21074id = tL_messageActionPaymentRefunded.charge.f20973id;
    ...
    public static void j1(Context context, int i10, TLRPC.TL_payments_paymentReceiptStars tL_payments_paymentReceiptStars, org.telegram.ui.ActionBar.g6 g6Var) {
        ...
        starsTransaction.f21074id = tL_payments_paymentReceiptStars.transaction_id;
    ...
    public final void H0(ArrayList arrayList, w51 w51Var) {
        ...
        h51Var.f27368c = (fg.h0) super.r0(getParentActivity());
        arrayList.add(h51Var);
        arrayList.add(h51.k(this.R));
        qh.d dVar = this.f14318a0;
        if (dVar != null) {
        ...
        if (y10.f14833e && !arrayList2.isEmpty()) {
    ...
    public final View createView(final Context context) {
        ...
        this.f38834c.setOnItemClickListener(new ag.h(this, 8));
        s00 s00Var = new s00(getParentActivity());
        this.Q = s00Var;
        this.f38839s.addView(s00Var, k7.c6.c(-1.0f, -1));
        t7 y10 = t7.y(this.currentAccount, false);
        ...
        ImageReceiver imageReceiver = q70Var.f40355b;
        ...
        this.X.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view) {
                switch (r3) {
                    case 0:
                        ja.B0(this.f14129b, context);
                        return;
                    default:
                        new aa(context, this.f14129b.resourceProvider).show();
                        return;
                }
            }
        });
        ...
        this.f14318a0.g(spannableStringBuilder3, false, true);
        this.f14318a0.setOnClickListener(new View.OnClickListener(this) {
            public final ja f14185b;
        ...
        this.R.addView(this.f14318a0, k7.c6.d(-1, 48.0f, 17, 20.0f, 8.0f, 20.0f, 0.0f));
        k1();
        k9 k9Var = this.f14321d0;
        if (k9Var != null) {
            k9Var.N(false);
        }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.starOptionsLoaded) {
            ...
            t7 y10 = t7.y(this.currentAccount, false);
            if (this.f14319b0 != y10.O(0)) {
                this.f14319b0 = y10.O(0);
                s0();
                k9 k9Var2 = this.f14321d0;
                if (k9Var2 != null) {
                    k9Var2.N(true);
                }
                if (this.K == 0 && this.L < 0) {
            ...
            animate.alpha(f11).withEndAction(new Runnable(this) {
                ...
                public final void run() {
                    switch (r3) {
                        case 0:
                            if (z4) {
                                this.f14270b.W.setVisibility(8);
                                return;
                            }
                            return;
                        default:
                            if (!z4) {
                                this.f14270b.Y.setVisibility(8);
                                return;
                            }
                            return;
                    }
    ...
    public final f2.p0 n0() {
        k9 k9Var = new k9(this, this.f38834c, getParentActivity(), this.currentAccount, this.classGuid, new eg.p1(this, 19), getResourceProvider());
        this.f14321d0 = k9Var;
        k9Var.f32651r = false;
        return k9Var;
    }
    ...
    public final boolean q0() {
        ...
        if (iaVar != null && (iaVar.getParent() instanceof View)) {
            if ((this.f38834c.getHeight() - this.f38834c.getPaddingBottom()) - ((View) this.O.getParent()).getBottom() >= 0) {
                z4 = true;
            }
        }
        return !z4;
