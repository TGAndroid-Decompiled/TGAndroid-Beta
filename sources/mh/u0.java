...
public final class u0 implements TextWatcher {
    ...
    public final void afterTextChanged(Editable editable) {
        ...
        if (!z4) {
            i10 = mf.a.h(editable.toString(), v0Var.B.f13649a);
        } else {
            i10 = mf.a.i(0L, v0Var.B.f13649a);
        }
        v0Var.n(i10, false, false, true);
        v0Var.f14913b.c(v0Var.f14914c.isFocused(), true ^ TextUtils.isEmpty(v0Var.f14914c.getText()));
    }
