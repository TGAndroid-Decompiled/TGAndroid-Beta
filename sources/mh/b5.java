...
public final class b5 extends AnimatorListenerAdapter {
    ...
    public final void onAnimationEnd(Animator animator) {
        c5 c5Var = this.f13741a;
        lh.c3 c3Var = c5Var.f13807f0;
        c5Var.f13817p0 = c5Var.f13816o0;
        c5Var.d(c5Var.R);
        TL_stars.starGiftAttributeModel[] stargiftattributemodelArr = c5Var.f13804e;
        int i10 = 2 - c5Var.f13816o0;
        stargiftattributemodelArr[i10] = (TL_stars.starGiftAttributeModel) c5Var.T.f2802f;
        ja.Z0(c5Var.d[i10].getImageReceiver(), stargiftattributemodelArr[2 - c5Var.f13816o0].document, 160);
