...
public final class a4 extends View {
    ...
    public final org.telegram.ui.Components.z5 f13687b;
    public final org.telegram.ui.Components.z5 f13688c;
    public float d;
    ...
    public a4(Context context) {
        ...
        pr prVar = pr.h;
        this.f13687b = new org.telegram.ui.Components.z5(c3Var, 420L, prVar, 0);
        this.f13688c = new org.telegram.ui.Components.z5(new lh.c3(this, 10), 420L, prVar, 0);
    ...
    public final void dispatchDraw(Canvas canvas) {
        boolean z4 = false;
        float d = this.f13687b.d(this.d, false);
        if (this.d > 0.0f) {
            z4 = true;
        }
        float e6 = this.f13688c.e(z4);
        float width = getWidth() / 2.0f;
        float height = getHeight() / 2.0f;
        float f10 = this.f13689e;
