...
public final class f5 extends View {
    public final int f14035a = 2;
    public final Paint f14036b;
    ...
    public f5(Activity activity, org.telegram.ui.ActionBar.g6 g6Var) {
        super(activity);
        this.f14037c = new xd.a(this, pr.h, 380L);
        this.f14036b = new Paint(1);
        this.d = g6Var;
    ...
    public void onAttachedToWindow() {
        switch (this.f14035a) {
            case 0:
                ...
                ((ImageReceiver) this.f14037c).onAttachedToWindow();
    ...
    public void onDetachedFromWindow() {
        switch (this.f14035a) {
            case 0:
                ...
                ((ImageReceiver) this.f14037c).onDetachedFromWindow();
    ...
    public final void onDraw(Canvas canvas) {
        switch (this.f14035a) {
            case 0:
                ...
                ImageReceiver imageReceiver = (ImageReceiver) this.f14037c;
                float f10 = height;
                ...
                canvas.drawPath((Path) this.f14038e, this.f14036b);
                canvas.restore();
            ...
            case 1:
                super.onDraw(canvas);
                RectF rectF = (RectF) this.f14038e;
                rectF.set(0.0f, 0.0f, getWidth(), getHeight());
                canvas.drawRoundRect(rectF, rectF.width() / 2.0f, rectF.height() / 2.0f, this.f14036b);
                ...
                canvas.drawRoundRect(rectF, rectF.height() / 2.0f, rectF.height() / 2.0f, (Paint) this.f14037c);
                return;
            default:
    ...
    public void onSizeChanged(int i10, int i11, int i12, int i13) {
        switch (this.f14035a) {
            case 2:
                ...
                lf.r.d((h51) this.f14038e, i10 / 2.0f, i11 / 2.0f, 17);
                return;
            default:
                super.onSizeChanged(i10, i11, i12, i13);
                return;
    ...
    public f5(Context context, org.telegram.ui.ActionBar.g6 g6Var) {
        ...
        this.d = paint3;
        this.f14038e = new RectF();
        paint2.setColor(-1);
        paint.setColor(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.f21659d6, g6Var));
