...
public final class r8 implements View.OnClickListener {
    public final int f14699a = 1;
    public final int f14700b;
    public final boolean f14701c;
    public final org.telegram.ui.ActionBar.g6 d;
    public final long f14702e;
    public final KeyEvent.Callback f14703f;
    public final Object h;
    public final Object f14704n;
    public final Context f14705r;
    public final Object f14706s;
    ...
    public final void onClick(View view) {
        ...
        switch (this.f14699a) {
            case 0:
                qh.d dVar = (qh.d) this.f14703f;
                TL_stars.StarsSubscription starsSubscription = (TL_stars.StarsSubscription) this.h;
                org.telegram.ui.ActionBar.h3[] h3VarArr = (org.telegram.ui.ActionBar.h3[]) this.f14704n;
                Activity activity = (Activity) this.f14705r;
                String str2 = (String) this.f14706s;
                if (!dVar.K) {
                    ...
                    if (y10.f14834f.amount < starsSubscription.pricing.amount) {
                ...
                return;
            default:
                eb ebVar = (eb) this.f14703f;
                MessageObject messageObject = (MessageObject) this.h;
                xn xnVar = (xn) this.f14704n;
                TLRPC.Chat chat = (TLRPC.Chat) this.f14706s;
                if (!ebVar.O) {
                    long value = ebVar.f13995r.getValue();
                    if ((ebVar.M != null || (messageObject != null && xnVar != null)) && ebVar.S == null) {
                        ...
                        if (y11.f14833e && y11.p().amount < value) {
                            boolean z4 = this.f14701c;
                            Context context = this.f14705r;
                            org.telegram.ui.ActionBar.g6 g6Var = this.d;
                            long j12 = this.f14702e;
                            if (z4) {
    ...
    public r8(qh.d dVar, int i10, TL_stars.StarsSubscription starsSubscription, org.telegram.ui.ActionBar.h3[] h3VarArr, long j10, Activity activity, org.telegram.ui.ActionBar.g6 g6Var, boolean z4, String str) {
        ...
        this.f14704n = h3VarArr;
        this.f14702e = j10;
        this.f14705r = activity;
        this.d = g6Var;
        this.f14701c = z4;
        this.f14706s = str;
    }
