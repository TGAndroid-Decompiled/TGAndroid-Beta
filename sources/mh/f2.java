...
public final class f2 implements Utilities.Callback {
    ...
    public final void run(Object obj) {
        ...
        switch (this.f14007a) {
            case 0:
                g5.r0((g5) this.f14008b, (TL_stars.StarGift) this.f14009c, (TL_stars.StarGiftAttribute) this.d, (sc[]) this.f14010e, (boolean[]) this.f14011f, (ArrayList) obj);
                return;
            case 1:
                AndroidUtilities.runOnUIThread(new lh.e1((sb) this.f14008b, (TLRPC.ChannelParticipant) obj, (ArrayList) this.f14009c, (ArrayList) this.d, (ArrayList) this.f14010e, (org.telegram.ui.ra) this.f14011f, 10));
                return;
            case 2:
                final xn xnVar = (xn) this.f14008b;
                org.telegram.ui.Cells.t1 t1Var = (org.telegram.ui.Cells.t1) this.f14009c;
                String str = (String) this.d;
                TLRPC.TL_contact tL_contact = (TLRPC.TL_contact) this.f14010e;
                CharacterStyle characterStyle = (CharacterStyle) this.f14011f;
                final TLRPC.User user = (TLRPC.User) obj;
                if (user != null) {
                    userFull = xnVar.getMessagesController().getUserFull(user.f20990id);
                } else {
                    userFull = null;
                }
                q70 I = q70.I(xnVar, t1Var);
                jm0 jm0Var = new jm0(xnVar.getParentActivity(), xnVar.f43136ba);
                I.f30324p = new pe(jm0Var, 1);
                ...
                if (tL_contact == null && (user == null || !xnVar.getContactsController().contactsDict.containsKey(Long.valueOf(user.f20990id)))) {
                ...
                return;
            case 3:
                xn xnVar2 = (xn) this.f14008b;
                TLRPC.TL_document tL_document = (TLRPC.TL_document) this.f14009c;
                String str2 = (String) this.d;
                MessageObject.SendAnimationData sendAnimationData = (MessageObject.SendAnimationData) this.f14011f;
                Long l10 = (Long) obj;
                int i10 = xnVar2.O3;
                Object obj2 = this.f14010e;
                if (i10 == 1) {
                    org.telegram.ui.Components.z4.M(xnVar2.getParentActivity(), xnVar2.Q5, new a1.d(xnVar2, tL_document, str2, obj2, 5), xnVar2.f43136ba);
                } else {
                    xnVar2.getSendMessagesHelper().sendSticker(tL_document, str2, xnVar2.Q5, xnVar2.f43245k5, xnVar2.U3, null, xnVar2.f43221i5, sendAnimationData, true, 0, 0, false, obj2, xnVar2.C8(), l10.longValue(), xnVar2.N8(), xnVar2.f43157d5);
            ...
            case 4:
                ...
                ArrayList arrayList2 = (ArrayList) this.f14010e;
                ArrayList arrayList3 = (ArrayList) this.f14011f;
                Runnable runnable = (Runnable) obj;
                ly lyVar = ((ky) this.f14008b).f28473a;
                String str3 = lyVar.v;
                ArrayList arrayList4 = lyVar.f28846r;
                ArrayList arrayList5 = lyVar.h;
                ArrayList arrayList6 = lyVar.f28847s;
                mz mzVar = lyVar.C;
                if (((String) this.f14009c).equals(str3)) {
                    iw iwVar = mzVar.S;
                    kx kxVar = mzVar.M;
                    int i11 = 0;
                    iwVar.e(false);
                    ...
                    arrayList5.clear();
                    arrayList5.addAll(lyVar.f28845n);
                    arrayList4.clear();
                    ...
                    while (i12 < size) {
                        ...
                        i12++;
                        dy dyVar = (dy) obj3;
                        if (longSparseIntArray.indexOfKey(dyVar.f26341c.f20870id) < 0) {
                            longSparseIntArray.append(dyVar.f26341c.f20870id, 1);
                    ...
                    while (i11 < size2) {
                        ...
                        i11++;
                        dy dyVar2 = (dy) obj4;
                        if (longSparseIntArray.indexOfKey(dyVar2.f26341c.f20870id) < 0) {
                            longSparseIntArray.append(dyVar2.f26341c.f20870id, 1);
                ...
                return;
            default:
                py pyVar = (py) this.f14008b;
                Long l11 = (Long) this.d;
                Runnable runnable2 = (Runnable) obj;
                pyVar.getClass();
                ((org.telegram.ui.ActionBar.d2) this.f14009c).dismiss();
                pyVar.getMessagesController().loadChannelParticipants(l11);
                jy jyVar = pyVar.f40308z2;
                pyVar.removeSelfFromStack();
                ((nd) this.f14010e).removeSelfFromStack();
                ((org.telegram.ui.ActionBar.p2) this.f14011f).finishFragment();
                if (jyVar != null) {
