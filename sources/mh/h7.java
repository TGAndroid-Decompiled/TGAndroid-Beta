            ...
            case 0:
                ...
                AndroidUtilities.runOnUIThread(new Runnable() {
                    ...
                    public final void run() {
                        ...
                        switch (i10) {
                            case 0:
                                long j10 = j7Var2.f14303b;
                                int i11 = j7Var2.f14302a;
                                ArrayList arrayList = j7Var2.f14305e;
                            ...
                            case 1:
                                ...
                                if (tLObject2 instanceof TL_stars.TL_starGiftCollection) {
                                    ...
                                    if (f10 >= 0) {
                                        j7Var2.f14305e.set(f10, tL_starGiftCollection2);
                                        return;
                                    }
                                    return;
                                }
                            ...
                            default:
                                ...
                                if (tLObject2 instanceof TL_stars.TL_starGiftCollection) {
                                    ...
                                    if (f11 >= 0) {
                                        j7Var2.f14305e.set(f11, tL_starGiftCollection3);
                                        return;
                                    }
                                    return;
                                }
            ...
            case 1:
                ...
                AndroidUtilities.runOnUIThread(new Runnable() {
                    ...
                    public final void run() {
                        ...
                        switch (i10) {
                            case 0:
                                long j10 = j7Var22.f14303b;
                                int i11 = j7Var22.f14302a;
                                ArrayList arrayList = j7Var22.f14305e;
                                if (tLObject2 instanceof TL_stars.TL_starGiftCollections) {
                                    arrayList.clear();
                                    arrayList.addAll(((TL_stars.TL_starGiftCollections) tLObject2).collections);
                                    j7Var22.j();
                            ...
                            case 1:
                                ...
                                if (tLObject2 instanceof TL_stars.TL_starGiftCollection) {
                                    ...
                                    if (f10 >= 0) {
                                        j7Var22.f14305e.set(f10, tL_starGiftCollection2);
                                        return;
                                    }
                                    return;
                                }
                            ...
                            default:
                                ...
                                if (tLObject2 instanceof TL_stars.TL_starGiftCollection) {
                                    ...
                                    if (f11 >= 0) {
                                        j7Var22.f14305e.set(f11, tL_starGiftCollection3);
                                        return;
                                    }
                                    return;
                                }
