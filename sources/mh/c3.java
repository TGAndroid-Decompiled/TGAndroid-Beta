...
public final class c3 implements org.telegram.ui.ActionBar.c2, o3.n, j3.f, v2.e, NativeInstance.AudioLevelsCallback, gv0, hv0, tv0, Utilities.Callback2Return, vg.g, hl0 {
    ...
    public void b(Object obj, float f10) {
        switch (this.f13793a) {
            case 9:
                ...
                AndroidUtilities.updateViewLayout(j1Var.f17314b, j1Var.d, layoutParams);
                return;
            case 11:
                oh.j1 j1Var2 = (oh.j1) obj;
                WindowManager.LayoutParams layoutParams2 = j1Var2.f17315c;
                j1Var2.L = f10;
                layoutParams2.y = (int) f10;
                AndroidUtilities.updateViewLayout(j1Var2.f17314b, j1Var2.d, layoutParams2);
                return;
            case 26:
                cs csVar = (cs) obj;
                csVar.f35846b = f10;
    ...
    public j3.g c(Bundle bundle) {
        ...
        switch (this.f13793a) {
            case 4:
                ArrayList parcelableArrayList = bundle.getParcelableArrayList(o4.s0.f16571f);
            ...
            default:
                ArrayList parcelableArrayList2 = bundle.getParcelableArrayList(o4.t0.f16577e);
                if (parcelableArrayList2 == null) {
                    return new o4.t0(new o4.s0[0]);
                }
                return new o4.t0((o4.s0[]) h5.a.s(o4.s0.f16572n, parcelableArrayList2).toArray(new o4.s0[0]));
        }
    }
    ...
    public float get(Object obj) {
        switch (this.f13793a) {
            ...
            case 10:
                return ((oh.j1) obj).L;
            case 25:
                return ((cs) obj).f35846b;
            case 27:
                return ((cs) obj).f35847c;
            default:
                return ((cs) obj).d;
        }
    }
