...
public final class b4 extends View {
    public final Paint f13733a;
    public final Paint f13734b;
    public final Paint f13735c;
    public final RadialGradient[] d;
    public final Matrix f13736e;
    public final org.telegram.ui.Components.z5 f13737f;
    public final RadialGradient h;
    public final Path f13738n;
    public int f13739r;
    public int f13740s;
    ...
    public b4(Context context) {
        ...
        this.f13734b = new Paint(1);
        Paint paint = new Paint(1);
        this.f13735c = paint;
        this.d = new RadialGradient[2];
        this.f13736e = new Matrix();
        this.f13737f = new org.telegram.ui.Components.z5(1.0f, this, 0L, 420L, pr.h);
        this.h = new RadialGradient(0.0f, 0.0f, 100.0f, new int[]{0, -1, -1, 0}, new float[]{0.15f, 0.35f, 0.65f, 0.88f}, Shader.TileMode.CLAMP);
        this.f13738n = new Path();
        paint.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.DST_IN));
    }

    public final void a(int i10, int i11) {
        if (this.f13739r == i10 && this.f13740s == i11) {
            return;
        }
