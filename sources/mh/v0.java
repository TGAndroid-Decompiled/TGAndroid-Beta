...
public final class v0 extends org.telegram.ui.ActionBar.h3 {
    public mf.a B;
    public int C;
    public final cd0 f14913b;
    public final EditTextBoldCursor f14914c;
    public final TextView d;
    public final org.telegram.ui.Components.k6 f14915e;
    public final qh.d f14916f;
    public final org.telegram.ui.Components.k6 h;
    public final org.telegram.ui.Cells.t8 f14917n;
    public final ImageView f14918r;
    public final ImageView f14919s;
    public final mf.a v;
    public final mf.a f14920w;
    public final mf.a f14921x;
    public final mf.a f14922y;
    ...
    public v0(Context context, org.telegram.ui.ActionBar.g6 g6Var, int i10, mf.a aVar, lh.a1 a1Var) {
        ...
        this.f14921x = mf.a.i(max, bVar);
        this.f14922y = mf.a.i(appGlobalConfig.tonStarGiftResaleAmountMax.get(), bVar);
        mf.b bVar2 = mf.b.f13651a;
        this.v = mf.a.g(appGlobalConfig.starsStarGiftResaleAmountMin.get(), bVar2);
        this.f14920w = mf.a.g(appGlobalConfig.starsStarGiftResaleAmountMax.get(), bVar2);
        ...
        this.f14914c = editTextBoldCursor;
        ...
        this.f14917n = t8Var;
        t8Var.f24176c.setLayoutParams(k7.c6.d(20, 20.0f, (LocaleController.isRTL ? 5 : 3) | 48, 22.0f, 22.0f, 22.0f, 0.0f));
        ...
        if (aVar != null) {
            n(mf.a.i(aVar.f13650b, aVar.f13649a), !aVar.k(), true, false);
        } else {
    ...
    public final mf.a m() {
        if (this.B.f13649a == mf.b.f13652b) {
            return this.f14922y;
        }
        return this.f14920w;
    }
    ...
    public final void n(mf.a aVar, boolean z4, boolean z10, boolean z11) {
        ...
        if (aVar != null) {
            ...
            this.B = mf.a.i(0L, aVar5.f13649a);
            this.C |= 1;
        }
        long j11 = m().f13650b;
        mf.a aVar6 = this.B;
        if (j11 < aVar6.f13650b) {
            this.C |= 4;
        }
        boolean k10 = aVar6.k();
        mf.a aVar7 = this.v;
        mf.a aVar8 = this.f14921x;
        mf.b bVar = mf.b.f13652b;
        if (!k10) {
            mf.a aVar9 = this.B;
            if (aVar9.f13649a == bVar) {
                aVar4 = aVar8;
            } else {
                aVar4 = aVar7;
            }
        ...
        if (!z10 && aVar5.f13649a == this.B.f13649a) {
            z12 = false;
        } else {
            z12 = true;
        }
        if (!z10 && aVar5.f13650b == this.B.f13650b) {
            z13 = false;
        } else {
            z13 = true;
        }
        ...
        mf.b bVar2 = mf.b.f13651a;
        long j12 = j10;
        EditTextBoldCursor editTextBoldCursor = this.f14914c;
        if (z12) {
            c3 = 0;
            mf.b bVar3 = this.B.f13649a;
            org.telegram.ui.Components.k6 k6Var = this.f14915e;
            if (bVar3 == bVar2) {
            ...
            np npVar = this.f14917n.f24176c;
            if (this.B.f13649a == bVar) {
                z16 = true;
            } else {
                z16 = false;
            }
            npVar.a(z16, z11);
            ImageView imageView = this.f14919s;
            ImageView imageView2 = this.f14918r;
            if (z11) {
                ViewPropertyAnimator animate = imageView2.animate();
                if (this.B.f13649a == bVar2) {
                    f14 = 1.0f;
                } else {
                    f14 = 0.0f;
                }
        ...
        if (z12 || z13 || z14) {
            if (this.C == 0 && this.B.f13650b > j12) {
                z15 = true;
            } else {
                z15 = false;
            }
            qh.d dVar = this.f14916f;
            if (dVar.T != z15) {
                dVar.setEnabled(z15);
        ...
        if (z12 || z13) {
            ...
            mf.a aVar10 = this.B;
            mf.b bVar4 = aVar10.f13649a;
            mf.b bVar5 = aVar10.f13649a;
            long j13 = aVar10.f13650b;
