...
public final class w4 extends FrameLayout {
    public final n1 f14978a;
    public final v4 f14979b;
    public final v4 f14980c;
    public final v4 d;
    public boolean f14981e;
    public final h20 f14982f;
    public final RectF h;

    public w4(Context context, org.telegram.ui.ActionBar.g6 g6Var, n1 n1Var) {
        super(context);
        this.f14982f = new h20();
        this.h = new RectF();
        this.f14978a = n1Var;
    ...
    public final void a(m4 m4Var, float f10, boolean z4, m4 m4Var2, float f11, boolean z10, m4 m4Var3, float f12, boolean z11) {
        ...
        if (m4Var2 != null) {
            ...
            v4Var2.e(m4Var2.f14447a, m4Var2.f14448b, n1Var);
            v4Var2.setTranslationY(AndroidUtilities.dp(36.0f) * f14);
            if (z10 && f14 <= 0.0f && !this.f14981e) {
                this.f14981e = true;
        ...
        if (m4Var3 != null) {
            ...
            v4Var3.e(m4Var3.f14447a, m4Var3.f14448b, n1Var);
