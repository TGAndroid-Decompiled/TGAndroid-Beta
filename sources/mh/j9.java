...
public final class j9 extends fg.p2 {
    ...
    @Override
    public final void a() {
        fg.o2 o2Var = new fg.o2(this.f14314r);
        this.f6501a = o2Var;
        o2Var.N = 105;
        int i10 = 0;
        o2Var.M = false;
        ...
        this.f14313n = new Paint[20];
        while (true) {
            Paint[] paintArr = this.f14313n;
            if (i10 < paintArr.length) {
                paintArr[i10] = new Paint(1);
                this.f14313n[i10].setColorFilter(new PorterDuffColorFilter(i0.a.d(i10 / (this.f14313n.length - 1), -371690, -14281), PorterDuff.Mode.SRC_IN));
                i10++;
            } else {
