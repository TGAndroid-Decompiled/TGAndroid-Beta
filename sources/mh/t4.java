...
public final class t4 extends rq {
    public final Path f14799b;
    public final RectF f14800c;
    public final wa d;
    public final int f14801e;
    public final View f14802f;
    public final ImageReceiver f14803g;
    public final org.telegram.ui.Components.j5 h;
    public RadialGradient f14804i;
    public final Matrix f14805j;
    public final k01 f14806k;
    public final k01 f14807l;
    public org.telegram.ui.Components.j6 f14808m;
    public final float f14809n;
    public lf.p f14810o;
    public int f14811p;
    public int f14812q;
    public final Paint f14813r;
    public int f14814s;
    public int f14815t;
    ...
    public t4(View view, TL_stars.StarGift starGift, int i10, float f10) {
        ...
        this.f14800c = new RectF();
        this.f14805j = new Matrix();
        this.f14813r = new Paint(1);
        this.f14814s = AndroidUtilities.dp(16.0f);
        this.f14815t = 0;
        this.f14802f = view;
        this.f14809n = f10;
        ImageReceiver imageReceiver = new ImageReceiver(view);
        this.f14803g = imageReceiver;
        if (i10 > 180) {
            f11 = 24.0f;
        } else {
            f11 = 18.0f;
        ...
        if (starGift instanceof TL_stars.TL_starGift) {
            ...
            ArrayList arrayList3 = waVar.f15008b;
            ...
            if (stargiftattributebackdrop != null) {
                this.f14804i = new RadialGradient(0.0f, 0.0f, AndroidUtilities.dpf2(i10) / 2.0f, new int[]{stargiftattributebackdrop.center_color | (-16777216), stargiftattributebackdrop.edge_color | (-16777216)}, new float[]{0.0f, 1.0f}, Shader.TileMode.CLAMP);
        ...
        this.f30869a.setShader(this.f14804i);
    ...
    public final void a() {
        this.h.a();
        this.f14803g.onAttachedToWindow();
        if (this.f14810o != null) {
            ...
            this.f14810o.a(i10 - currentTime);
        }
    }
    ...
    public final void b() {
        this.h.b();
        this.f14803g.onDetachedFromWindow();
        lf.p pVar = this.f14810o;
        if (pVar != null) {
            pVar.b();
        }
    }
    ...
    public final void d(int i10, int i11) {
        ...
        this.f14811p = i11;
        if (this.f14810o == null) {
            this.f14810o = new lf.p(new hg.f(this, 28));
        }
        int currentTime = ConnectionsManager.getInstance(UserConfig.selectedAccount).getCurrentTime();
        if (currentTime < i10) {
            i12 = i10 - currentTime;
        ...
        if (this.f14808m == null) {
            ...
            this.f14808m = j6Var;
            j6Var.r(-1);
            this.f14808m.t(AndroidUtilities.dp(12.0f));
            this.f14808m.setCallback(new i.f(this, 4));
        }
        h();
    }
    ...
    public final void draw(Canvas canvas) {
        ...
        RectF rectF = this.f14800c;
        rectF.set(bounds);
        canvas.save();
        Path path = this.f14799b;
        path.rewind();
        float f10 = this.f14814s;
        path.addRoundRect(rectF, f10, f10, Path.Direction.CW);
        canvas.clipPath(path);
        RadialGradient radialGradient = this.f14804i;
        Paint paint = this.f30869a;
        if (radialGradient != null) {
            Matrix matrix = this.f14805j;
            matrix.reset();
            matrix.postTranslate(rectF.centerX(), rectF.centerY());
            this.f14804i.setLocalMatrix(matrix);
            paint.setShader(this.f14804i);
        }
        canvas.drawPaint(paint);
        canvas.save();
        canvas.translate(rectF.centerX(), rectF.centerY());
        w0.a(canvas, this.f14815t, this.h, rectF.width(), rectF.height(), 1.0f, this.f14809n);
        wa waVar = this.d;
        if (waVar != null) {
            waVar.b(canvas, -1, 1.0f);
        }
        canvas.restore();
        k01 k01Var2 = this.f14806k;
        ImageReceiver imageReceiver = this.f14803g;
        if (k01Var2 != null && (k01Var = this.f14807l) != null) {
            if (this.f14808m != null) {
                Paint paint2 = this.f14813r;
                paint2.setColor(1342177280);
                canvas.drawRoundRect(rectF.left + AndroidUtilities.dp(6.0f), AndroidUtilities.dp(6.0f) + rectF.top, rectF.left + AndroidUtilities.dp(20.0f) + Math.max(this.f14808m.d(), AndroidUtilities.dp(3.0f)), rectF.top + AndroidUtilities.dp(23.0f), AndroidUtilities.dp(8.5f), AndroidUtilities.dp(8.5f), paint2);
                canvas.save();
                canvas.translate(rectF.left + AndroidUtilities.dp(13.0f), rectF.top + AndroidUtilities.dp(14.0f));
                this.f14808m.draw(canvas);
                canvas.restore();
            }
    ...
    public final void e(int i10, int i11) {
        RadialGradient radialGradient = new RadialGradient(0.0f, 0.0f, AndroidUtilities.dpf2(this.f14801e) / 2.0f, new int[]{i10 | (-16777216), i11 | (-16777216)}, new float[]{0.0f, 1.0f}, Shader.TileMode.CLAMP);
        this.f14804i = radialGradient;
        this.f30869a.setShader(radialGradient);
    }
    ...
    public final int getIntrinsicHeight() {
        return AndroidUtilities.dp(this.f14801e);
    }
    ...
    public final void h() {
        ...
        if (currentTime > i10) {
            this.f14808m.q(LocaleController.getString(R.string.Gift2AuctionCountdownFinished), true, true);
        } else {
            int i11 = this.f14812q;
            if (currentTime < i11) {
                this.f14808m.q(LocaleController.formatString(R.string.Gift2AuctionCountdownStartsIn, AndroidUtilities.formatDuration(i11 - currentTime, true)), true, true);
            } else {
                this.f14808m.q(AndroidUtilities.formatDuration(i10 - currentTime, true), true, true);
            }
        }
        if (currentTime > this.f14811p && (k01Var = this.f14807l) != null) {
