...
public final class b1 extends c5 {
    public final i1 A0;
    public final float[] f13723x0;
    public final Path f13724y0;
    public final float[] f13725z0;
    ...
    public b1(i1 i1Var, Context context, org.telegram.ui.ActionBar.g6 g6Var, z0 z0Var, eg.m mVar, eg.m mVar2, eg.m mVar3, eg.m mVar4, eg.m mVar5, eg.m mVar6) {
        ...
        this.A0 = i1Var;
        this.f13723x0 = new float[3];
        this.f13724y0 = new Path();
        this.f13725z0 = new float[8];
    }
    ...
    public final void j(int i10) {
        ...
        for (eg.t3 t3Var : i1Var.W) {
            ...
            if (k6Var.getSizeableBackground() instanceof s4) {
                ((s4) k6Var.getSizeableBackground()).f14736b.setColor(HSVToColor);
                k6Var.invalidate();
    ...
    public final void onSizeChanged(int i10, int i11, int i12, int i13) {
        ...
        float[] fArr = this.f13725z0;
        fArr[3] = dp;
        fArr[2] = dp;
        fArr[1] = dp;
        fArr[0] = dp;
        Path path = this.f13724y0;
        path.rewind();
        path.addRoundRect(0.0f, 0.0f, i10, i11, this.f13725z0, Path.Direction.CW);
    }
}
