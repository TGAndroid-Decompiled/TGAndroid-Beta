    ...
    public final void run(Object obj, Object obj2) {
        ...
        switch (this.f14634a) {
            case 0:
                ...
                this.f14635b[0] = true;
                Utilities.Callback2 callback2 = this.f14636c;
                if (callback2 != null) {
            ...
            default:
                this.f14635b[0] = true;
                Utilities.Callback2 callback22 = this.f14636c;
                if (callback22 != null) {
                    if (bool.booleanValue()) {
                        str2 = "paid";
                    } else {
