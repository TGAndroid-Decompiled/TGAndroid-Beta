...
public final class l5 extends View {
    ...
    public final int[] H;
    public final xn f14382a;
    public org.telegram.ui.Cells.a0 f14383b;
    public int f14384c;
    public final int[] d;
    public final int[] f14385e;
    public final RectF f14386f;
    public final RectF h;
    public final Paint f14387n;
    public boolean f14388r;
    public final org.telegram.ui.Components.z5 f14389s;
    public final org.telegram.ui.Components.j6 v;
    public boolean f14390w;
    public final m2 f14391x;
    public float f14392y;

    public l5(xn xnVar) {
        super(xnVar.getParentActivity());
        this.d = new int[2];
        this.f14385e = new int[2];
        this.f14386f = new RectF();
        this.h = new RectF();
        this.f14387n = new Paint();
        new Paint();
        this.f14389s = new org.telegram.ui.Components.z5(this, 0L, 420L, pr.h);
        ...
        this.f14391x = new m2(9, this, xnVar);
    }

    private MessageObject getMessageObject() {
        org.telegram.ui.Cells.a0 a0Var = this.f14383b;
    ...
    public final void a() {
        ...
        if (getMessageObject() != null) {
            ...
            xn xnVar = this.f14382a;
            t7 y10 = t7.y(xnVar.getCurrentAccount(), false);
            long E = y10.E(messageObject);
            if (y10.f14831e && y10.q(false, false, null).amount < E) {
    ...
    public final void b(float f10, j5 j5Var) {
        ...
        ValueAnimator ofFloat = ValueAnimator.ofFloat(this.f14392y, f10);
        this.B = ofFloat;
        ...
        if (this.f14383b != null && !this.F) {
            ...
            if (messageObject != null && reactionsLayoutInBubble != null) {
                ...
                if (z4) {
                    ...
                    t7.y(xnVar.getCurrentAccount(), false).d0(messageObject, this.f14382a, 1L, true, false, null);
                }
    ...
    public ng.r0 getReactionsLayoutInBubble() {
        ...
        if (a0Var instanceof org.telegram.ui.Cells.v0) {
            return ((org.telegram.ui.Cells.v0) a0Var).f24298z0;
        }
        return null;
    }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (this.f14383b == null || this.F || (reactionsLayoutInBubble = getReactionsLayoutInBubble()) == null) {
            return false;
        }
        int action = motionEvent.getAction();
        m2 m2Var = this.f14391x;
        if (action == 0) {
    ...
    public void setMessageCell(org.telegram.ui.Cells.a0 a0Var) {
        ...
        this.f14384c = id2;
        org.telegram.ui.Cells.a0 a0Var3 = this.f14383b;
        if (a0Var3 instanceof org.telegram.ui.Cells.t1) {
            a0Var3.invalidate();
            ((org.telegram.ui.Cells.t1) this.f14383b).setInvalidateListener(new j5(this, 1));
        } else if (a0Var3 instanceof org.telegram.ui.Cells.v0) {
            a0Var3.invalidate();
            ((org.telegram.ui.Cells.v0) this.f14383b).setInvalidateListener(new j5(this, 1));
        }
        invalidate();
    }
}
