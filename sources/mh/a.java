...
public final class a implements Runnable {
    public final int f13662a = 0;
    public final org.telegram.ui.ActionBar.g6 f13663b;
    ...
    public final void run() {
        switch (this.f13662a) {
            case 0:
                new aa(this.f13664c, this.f13663b).show();
                return;
            default:
                ...
                org.telegram.ui.ActionBar.g6 g6Var = this.f13663b;
