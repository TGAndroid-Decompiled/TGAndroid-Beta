...
public final class e4 extends Drawable {
    ...
    public int h;
    public int f13952i;
    public final Paint f13947b = new Paint(1);
    public final Shader[] f13948c = new Shader[2];
    public final Matrix d = new Matrix();
    public final org.telegram.ui.Components.z5 f13949e = new org.telegram.ui.Components.z5(1.0f, new lh.c3(this, 11), 0, 420, pr.h);
    public final RectF f13950f = new RectF();
    public final int f13946a = 1;

    public final void a(int i10, int i11) {
        if (this.h == i10 && this.f13952i == i11) {
            return;
        }
        Shader[] shaderArr = this.f13948c;
    ...
    public final void draw(Canvas canvas) {
        ...
        RectF rectF = this.f13950f;
        rectF.set(bounds);
        rectF.right = rectF.width() + rectF.left;
        int i10 = 0;
        float d = this.f13949e.d(1.0f, false);
        while (true) {
            Shader[] shaderArr = this.f13948c;
        ...
        if (this.f13951g != null) {
            ...
            w0.a(canvas, 0, this.f13951g, rectF.width(), AndroidUtilities.dp(290.0f), 2.0f, 1.0f);
            canvas.restore();
        }
    }
