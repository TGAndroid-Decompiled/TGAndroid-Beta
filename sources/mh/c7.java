...
public final class c7 implements Runnable {
    ...
    public final TLObject f13841b;
    public final Utilities.Callback f13842c;

    public c7(TLObject tLObject, Utilities.Callback callback, int i10) {
        this.f13840a = i10;
        this.f13841b = tLObject;
        this.f13842c = callback;
    }
    ...
    public final void run() {
        ...
        switch (this.f13840a) {
            case 0:
                TLObject tLObject = this.f13841b;
                boolean z10 = tLObject instanceof TL_account.paidMessagesRevenue;
                Utilities.Callback callback = this.f13842c;
                if (z10) {
            ...
            default:
                TLObject tLObject2 = this.f13841b;
                if (tLObject2 instanceof TLRPC.TL_messages_stickerSet) {
                    ...
                    if (!MediaDataController.getInstance(UserConfig.selectedAccount).isStickerPackInstalled(tL_messages_stickerSet.set.f20872id)) {
                ...
                this.f13842c.run(Boolean.valueOf(z4));
                return;
        }
    }
}
