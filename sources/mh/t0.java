...
public final class t0 extends Drawable implements r6 {
    ...
    public final Paint f18126c;
    public final ImageReceiver d;
    public final ImageReceiver f18127e;
    public final Drawable f18128f;

    public t0(Context context, TLRPC.User user, TLRPC.User user2) {
        Paint paint = new Paint(1);
        this.f18124a = paint;
        this.f18125b = new Paint(1);
        Paint paint2 = new Paint(1);
        this.f18126c = paint2;
        ImageReceiver imageReceiver = new ImageReceiver();
        this.d = imageReceiver;
        ImageReceiver imageReceiver2 = new ImageReceiver();
        this.f18127e = imageReceiver2;
        new RectF();
        paint.setColor(-1);
    ...
    public final void a(pi0 pi0Var) {
        this.f18127e.setParentView(pi0Var);
    ...
    public final void b(ImageReceiver imageReceiver) {
        ...
        this.f18127e.onDetachedFromWindow();
    }

    @Override
    public final void c(ImageReceiver imageReceiver) {
        this.d.onAttachedToWindow();
        this.f18127e.onAttachedToWindow();
    }
    ...
    public final void draw(Canvas canvas) {
        ...
        canvas.drawCircle(centerX, dp2, AndroidUtilities.dp(12.0f), this.f18126c);
        int dp3 = (int) (dp2 + AndroidUtilities.dp(9.0f));
        Drawable drawable = this.f18128f;
        ...
        ImageReceiver imageReceiver2 = this.f18127e;
