...
public final class o0 implements View.OnClickListener {
    ...
    public final void onClick(View view) {
        ...
        switch (this.f14504a) {
            case 0:
                r0 r0Var = (r0) this.d;
                Context context = (Context) this.f14507e;
                org.telegram.ui.ActionBar.g6 g6Var = (org.telegram.ui.ActionBar.g6) this.f14508f;
                ...
                if (r0Var.f14659s.T) {
                    ...
                    t7 x10 = t7.x(i10, r0Var.E.f13649a);
                    if (x10.f14831e) {
                        aVar = mf.a.l(x10.p());
                    } else {
                        aVar = null;
                    }
                    if (!r0Var.f14654c && (aVar == null || aVar.f13650b < r0Var.E.f13650b)) {
                        mf.a aVar2 = r0Var.E;
                        mf.b bVar = aVar2.f13649a;
            ...
            case 1:
                ...
                String str = (String) this.f14507e;
                String str2 = (String) this.f14508f;
                String str3 = (String) this.h;
                qh.d dVar = xf0Var.f43044b;
                if (!dVar.K) {
                    ...
                    tL_inputStorePaymentAuthCode.amount = this.f14505b;
                    if (TextUtils.isEmpty(str2)) {
                        str2 = "";
                    }
                    tL_inputStorePaymentAuthCode.phone_code_hash = str2;
                    tL_inputStorePaymentAuthCode.phone_number = str3;
                    tL_inputStorePaymentAuthCode.premium_days = this.f14506c;
            ...
            default:
                ...
                TLRPC.TL_messages_preparedInlineMessage tL_messages_preparedInlineMessage2 = (TLRPC.TL_messages_preparedInlineMessage) this.f14507e;
                final eh.w wVar = (eh.w) this.f14508f;
                ...
                if (U != null) {
                    ...
                    final int i12 = this.f14506c;
                    final long j11 = this.f14505b;
                    c1Var.f40308z2 = new jy() {
                        @Override
                        ...
                        public final boolean v(py pyVar, ArrayList arrayList2, CharSequence charSequence, boolean z4, boolean z10, int i13, int i14, mf1 mf1Var) {
                            ...
                            while (i15 < size2) {
                                ...
                                if (!DialogObject.isEncryptedDialog(j12)) {
                                    ...
                                    hashMap.put("id", "" + tL_messages_preparedInlineMessage4.result.f20841id);
                                    hashMap.put("bot", "" + j11);
                                    long j14 = j12;
    ...
    public o0(sh.e1 e1Var, TLRPC.TL_messages_preparedInlineMessage tL_messages_preparedInlineMessage, eh.w wVar, int i10, long j10, org.telegram.ui.web.u uVar) {
        this.d = e1Var;
        this.f14507e = tL_messages_preparedInlineMessage;
        this.f14508f = wVar;
        this.f14506c = i10;
        this.f14505b = j10;
        this.h = uVar;
