...
public final class g {
    ...
    public FileDescriptor f42203b;
    public AssetManager.AssetInputStream f42204c;
    public int d;
    public final HashMap[] e;
    public final HashSet f42205f;
    public ByteOrder f42206g;
    public boolean h;
    public int f42207i;
    public int f42208j;
    public int f42209k;
    public int f42210l;
    public static final boolean f42189m = Log.isLoggable("ExifInterface", 3);
    public static final List f42190n = Arrays.asList(1, 6, 3, 8);
    public static final List f42191o = Arrays.asList(2, 7, 4, 5);
    public static final int[] f42192p = {8, 8, 8};
    public static final int[] f42193q = {8};
    public static final byte[] f42194r = {-1, -40, -1};
    public static final byte[] f42195s = {102, 116, 121, 112};
    public static final byte[] f42196t = {109, 105, 102, 49};
    public static final byte[] f42197u = {104, 101, 105, 99};
    public static final byte[] v = {79, 76, 89, 77, 80, 0};
    public static final byte[] f42198w = {79, 76, 89, 77, 80, 85, 83, 0, 73, 73};
    public static final byte[] f42199x = {-119, 80, 78, 71, 13, 10, 26, 10};
    public static final byte[] f42200y = {101, 88, 73, 102};
    public static final byte[] f42201z = {73, 72, 68, 82};
        ...
        while (true) {
            ...
            if (i10 < dVarArr3.length) {
                ...
                for (d dVar : dVarArr3[i10]) {
                    K[i10].put(Integer.valueOf(dVar.f42184a), dVar);
                    L[i10].put(dVar.f42185b, dVar);
                }
                i10++;
            } else {
                HashMap hashMap = N;
                d[] dVarArr4 = J;
                hashMap.put(Integer.valueOf(dVarArr4[0].f42184a), 5);
                hashMap.put(Integer.valueOf(dVarArr4[1].f42184a), 1);
                hashMap.put(Integer.valueOf(dVarArr4[2].f42184a), 2);
                hashMap.put(Integer.valueOf(dVarArr4[3].f42184a), 3);
                hashMap.put(Integer.valueOf(dVarArr4[4].f42184a), 7);
                hashMap.put(Integer.valueOf(dVarArr4[5].f42184a), 8);
                Pattern.compile(".*[1-9].*");
    ...
    public g(File file) {
        ...
        this.f42205f = new HashSet(dVarArr.length);
        this.f42206g = ByteOrder.BIG_ENDIAN;
        if (file != null) {
    ...
    public final void a() {
        ...
        if (b("ImageWidth") == null) {
            hashMapArr[0].put("ImageWidth", c.a(0L, this.f42206g));
        }
        if (b("ImageLength") == null) {
            hashMapArr[0].put("ImageLength", c.a(0L, this.f42206g));
        }
        if (b("Orientation") == null) {
            hashMapArr[0].put("Orientation", c.a(0L, this.f42206g));
        }
        if (b("LightSource") == null) {
            hashMapArr[1].put("LightSource", c.a(0L, this.f42206g));
        }
    }
    ...
    public final String b(String str) {
        ...
        if (d != null) {
            ...
            if (str.equals("GPSTimeStamp")) {
                ...
                e[] eVarArr = (e[]) d.g(this.f42206g);
                if (eVarArr != null && eVarArr.length == 3) {
                    e eVar = eVarArr[0];
                    Integer valueOf = Integer.valueOf((int) (((float) eVar.f42187a) / ((float) eVar.f42188b)));
                    e eVar2 = eVarArr[1];
                    Integer valueOf2 = Integer.valueOf((int) (((float) eVar2.f42187a) / ((float) eVar2.f42188b)));
                    e eVar3 = eVarArr[2];
                    return String.format("%02d:%02d:%02d", valueOf, valueOf2, Integer.valueOf((int) (((float) eVar3.f42187a) / ((float) eVar3.f42188b))));
                }
                Log.w("ExifInterface", "Invalid GPS Timestamp array. array=" + Arrays.toString(eVarArr));
                return null;
            }
            try {
                return Double.toString(d.d(this.f42206g));
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            try {
                try {
                    ...
                    HashMap[] hashMapArr = this.e;
                    if (str != null) {
                        hashMapArr[0].put("ImageWidth", c.c(Integer.parseInt(str), this.f42206g));
                    }
                    if (str2 != null) {
                        hashMapArr[0].put("ImageLength", c.c(Integer.parseInt(str2), this.f42206g));
                    }
                    if (str3 != null) {
                        ...
                        hashMapArr[0].put("Orientation", c.c(i10, this.f42206g));
                    }
    ...
    public final void h(f fVar) {
        ...
        if (cVar != null) {
            ...
            if (cVar4 != null) {
                int[] iArr = (int[]) cVar4.g(this.f42206g);
                if (iArr != null && iArr.length == 4) {
                    ...
                    if (i12 > i13 && (i10 = iArr[3]) > (i11 = iArr[1])) {
                        ...
                        c c10 = c.c(i14, this.f42206g);
                        c c11 = c.c(i15, this.f42206g);
    ...
    public final void i(b bVar) {
        ...
        bVar.f42179b = ByteOrder.BIG_ENDIAN;
        byte[] bArr = f42199x;
        bVar.a(bArr.length);
        ...
        while (true) {
            try {
                ...
                if (bVar.read(bArr2) == 4) {
                    int i10 = length + 8;
                    if (i10 == 16 && !Arrays.equals(bArr2, f42201z)) {
                        throw new IOException("Encountered invalid PNG file--IHDR chunk should appearas the first chunk");
                    }
                    if (Arrays.equals(bArr2, A)) {
                        return;
                    }
                    if (Arrays.equals(bArr2, f42200y)) {
    ...
    public final void j(b bVar) {
        ...
        bVar.a(i10 - bVar.f42180c);
        bVar.read(bArr4);
        f(new b(bArr4), i10, 5);
        bVar.a(i12 - bVar.f42180c);
        bVar.f42179b = ByteOrder.BIG_ENDIAN;
        int readInt = bVar.readInt();
        if (z10) {
        ...
        for (int i13 = 0; i13 < readInt; i13++) {
            ...
            if (readUnsignedShort == H.f42184a) {
                short readShort = bVar.readShort();
                short readShort2 = bVar.readShort();
                c c10 = c.c(readShort, this.f42206g);
                c c11 = c.c(readShort2, this.f42206g);
                HashMap[] hashMapArr = this.e;
    ...
    public final void l(f fVar) {
        ...
        if (cVar != null) {
            f(new b(cVar.d), (int) cVar.f42183c, 5);
        }
    ...
    public final void m(b bVar) {
        ...
        bVar.f42179b = ByteOrder.LITTLE_ENDIAN;
        bVar.a(B.length);
    ...
    public final void n(b bVar, HashMap hashMap) {
        ...
        if (cVar != null && cVar2 != null) {
            int e = cVar.e(this.f42206g);
            int e7 = cVar2.e(this.f42206g);
            if (this.d == 7) {
                e += this.f42208j;
            }
            if (e > 0 && e7 > 0 && this.f42202a == null && this.f42204c == null && this.f42203b == null) {
                bVar.skip(e);
    ...
    public final void o(String str) {
        ...
        if (str != null) {
            ...
            try {
                ...
                if (z10) {
                    this.f42203b = fileInputStream.getFD();
                } else {
                    this.f42203b = null;
                }
                q(fileInputStream);
        ...
        while (true) {
            ...
            if (i10 < hashMapArr.length) {
                ...
                for (Map.Entry entry : hashMapArr[i10].entrySet()) {
                    ...
                    Log.d("ExifInterface", "tagName: " + ((String) entry.getKey()) + ", tagType: " + cVar.toString() + ", tagValue: '" + cVar.f(this.f42206g) + "'");
                }
                i10++;
            } else {
                return;
    ...
    public final void x(b bVar) {
        ...
        if (cVar2 != null) {
            ...
            if (cVar3 != null) {
                int[] iArr = (int[]) cVar3.g(this.f42206g);
                int[] iArr2 = f42192p;
                if (Arrays.equals(iArr2, iArr) || (this.d == 3 && (cVar = (c) hashMap.get("PhotometricInterpretation")) != null && (((e = cVar.e(this.f42206g)) == 1 && Arrays.equals(iArr, f42193q)) || (e == 6 && Arrays.equals(iArr, iArr2))))) {
                    c cVar4 = (c) hashMap.get("StripOffsets");
                    c cVar5 = (c) hashMap.get("StripByteCounts");
                    if (cVar4 != null && cVar5 != null) {
                        long[] b10 = z6.b(cVar4.g(this.f42206g));
                        long[] b11 = z6.b(cVar5.g(this.f42206g));
        ...
        if (!isEmpty && !hashMapArr[i11].isEmpty()) {
            ...
            if (cVar != null && cVar2 != null) {
                if (cVar3 != null && cVar4 != null) {
                    int e = cVar.e(this.f42206g);
                    int e7 = cVar2.e(this.f42206g);
                    int e10 = cVar3.e(this.f42206g);
                    int e11 = cVar4.e(this.f42206g);
                    if (e < e10 && e7 < e11) {
                        HashMap hashMap = hashMapArr[i10];
    ...
    public final void z(f fVar, int i10) {
        ...
        if (cVar != null) {
            if (cVar.f42181a == 5) {
                e[] eVarArr = (e[]) cVar.g(this.f42206g);
                if (eVarArr != null && eVarArr.length == 2) {
                    c10 = c.b(eVarArr[0], this.f42206g);
                    c11 = c.b(eVarArr[1], this.f42206g);
                } else {
                    Log.w("ExifInterface", "Invalid crop size values. cropSize=" + Arrays.toString(eVarArr));
                    return;
                }
            } else {
                int[] iArr = (int[]) cVar.g(this.f42206g);
                if (iArr != null && iArr.length == 2) {
                    c10 = c.c(iArr[0], this.f42206g);
                    c11 = c.c(iArr[1], this.f42206g);
                } else {
            ...
            int e = cVar2.e(this.f42206g);
            int e7 = cVar4.e(this.f42206g);
            int e10 = cVar5.e(this.f42206g);
            int e11 = cVar3.e(this.f42206g);
            if (e7 > e && e10 > e11) {
                c c12 = c.c(e7 - e, this.f42206g);
                c c13 = c.c(e10 - e11, this.f42206g);
            ...
            if (cVar6 == null || cVar7 == null) {
                ...
                if (cVar8 != null && cVar9 != null) {
                    int e12 = cVar8.e(this.f42206g);
                    int e13 = cVar8.e(this.f42206g);
                    fVar.b(e12);
    ...
    public g(InputStream inputStream) {
        ...
        if (inputStream != null) {
            ...
            if (inputStream instanceof AssetManager.AssetInputStream) {
                this.f42204c = (AssetManager.AssetInputStream) inputStream;
                this.f42203b = null;
            } else {
