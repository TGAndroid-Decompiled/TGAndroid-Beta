...
public final class g {
    ...
    public FileDescriptor f46519b;
    public AssetManager.AssetInputStream f46520c;
    public int d;
    public final HashMap[] f46521e;
    public final HashSet f46522f;
    public ByteOrder f46523g;
    public boolean h;
    public int f46524i;
    public int f46525j;
    public int f46526k;
    public int f46527l;
    public static final boolean f46505m = Log.isLoggable("ExifInterface", 3);
    public static final List f46506n = Arrays.asList(1, 6, 3, 8);
    public static final List f46507o = Arrays.asList(2, 7, 4, 5);
    public static final int[] f46508p = {8, 8, 8};
    public static final int[] f46509q = {8};
    public static final byte[] f46510r = {-1, -40, -1};
    public static final byte[] f46511s = {102, 116, 121, 112};
    public static final byte[] f46512t = {109, 105, 102, 49};
    public static final byte[] f46513u = {104, 101, 105, 99};
    public static final byte[] v = {79, 76, 89, 77, 80, 0};
    public static final byte[] f46514w = {79, 76, 89, 77, 80, 85, 83, 0, 73, 73};
    public static final byte[] f46515x = {-119, 80, 78, 71, 13, 10, 26, 10};
    public static final byte[] f46516y = {101, 88, 73, 102};
    public static final byte[] f46517z = {73, 72, 68, 82};
        ...
        while (true) {
            ...
            if (i10 < dVarArr3.length) {
                ...
                for (d dVar : dVarArr3[i10]) {
                    K[i10].put(Integer.valueOf(dVar.f46500a), dVar);
                    L[i10].put(dVar.f46501b, dVar);
                }
                i10++;
            } else {
                HashMap hashMap = N;
                d[] dVarArr4 = J;
                hashMap.put(Integer.valueOf(dVarArr4[0].f46500a), 5);
                hashMap.put(Integer.valueOf(dVarArr4[1].f46500a), 1);
                hashMap.put(Integer.valueOf(dVarArr4[2].f46500a), 2);
                hashMap.put(Integer.valueOf(dVarArr4[3].f46500a), 3);
                hashMap.put(Integer.valueOf(dVarArr4[4].f46500a), 7);
                hashMap.put(Integer.valueOf(dVarArr4[5].f46500a), 8);
                Pattern.compile(".*[1-9].*");
    ...
    public g(File file) {
        d[][] dVarArr = I;
        this.f46521e = new HashMap[dVarArr.length];
        this.f46522f = new HashSet(dVarArr.length);
        this.f46523g = ByteOrder.BIG_ENDIAN;
        if (file != null) {
    ...
    public final void a() {
        ...
        HashMap[] hashMapArr = this.f46521e;
        ...
        if (b("ImageWidth") == null) {
            hashMapArr[0].put("ImageWidth", c.a(0L, this.f46523g));
        }
        if (b("ImageLength") == null) {
            hashMapArr[0].put("ImageLength", c.a(0L, this.f46523g));
        }
        if (b("Orientation") == null) {
            hashMapArr[0].put("Orientation", c.a(0L, this.f46523g));
        }
        if (b("LightSource") == null) {
            hashMapArr[1].put("LightSource", c.a(0L, this.f46523g));
        }
    }
    ...
    public final String b(String str) {
        ...
        if (c3 != null) {
            ...
            if (str.equals("GPSTimeStamp")) {
                ...
                e[] eVarArr = (e[]) c3.g(this.f46523g);
                if (eVarArr != null && eVarArr.length == 3) {
                    e eVar = eVarArr[0];
                    Integer valueOf = Integer.valueOf((int) (((float) eVar.f46503a) / ((float) eVar.f46504b)));
                    e eVar2 = eVarArr[1];
                    Integer valueOf2 = Integer.valueOf((int) (((float) eVar2.f46503a) / ((float) eVar2.f46504b)));
                    e eVar3 = eVarArr[2];
                    return String.format("%02d:%02d:%02d", valueOf, valueOf2, Integer.valueOf((int) (((float) eVar3.f46503a) / ((float) eVar3.f46504b))));
                }
                Log.w("ExifInterface", "Invalid GPS Timestamp array. array=" + Arrays.toString(eVarArr));
                return null;
            }
            try {
                return Double.toString(c3.d(this.f46523g));
    ...
    public final c c(String str) {
        ...
        for (int i10 = 0; i10 < I.length; i10++) {
            c cVar = (c) this.f46521e[i10].get(str);
            if (cVar != null) {
                return cVar;
            }
        }
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            try {
                try {
                    ...
                    HashMap[] hashMapArr = this.f46521e;
                    if (str != null) {
                        hashMapArr[0].put("ImageWidth", c.c(Integer.parseInt(str), this.f46523g));
                    }
                    if (str2 != null) {
                        hashMapArr[0].put("ImageLength", c.c(Integer.parseInt(str2), this.f46523g));
                    }
                    if (str3 != null) {
                        ...
                        hashMapArr[0].put("Orientation", c.c(i10, this.f46523g));
                    }
    ...
    public final void g(f fVar) {
        ...
        if (cVar != null) {
            ...
            if (cVar4 != null) {
                int[] iArr = (int[]) cVar4.g(this.f46523g);
                if (iArr != null && iArr.length == 4) {
                    ...
                    if (i12 > i13 && (i10 = iArr[3]) > (i11 = iArr[1])) {
                        ...
                        c c3 = c.c(i14, this.f46523g);
                        c c10 = c.c(i15, this.f46523g);
    ...
    public final void h(b bVar) {
        ...
        bVar.f46495b = ByteOrder.BIG_ENDIAN;
        byte[] bArr = f46515x;
        bVar.a(bArr.length);
        ...
        while (true) {
            try {
                ...
                if (bVar.read(bArr2) == 4) {
                    int i10 = length + 8;
                    if (i10 == 16 && !Arrays.equals(bArr2, f46517z)) {
                        throw new IOException("Encountered invalid PNG file--IHDR chunk should appearas the first chunk");
                    }
                    if (Arrays.equals(bArr2, A)) {
                        return;
                    }
                    if (Arrays.equals(bArr2, f46516y)) {
    ...
    public final void i(b bVar) {
        ...
        bVar.a(i10 - bVar.f46496c);
        bVar.read(bArr4);
        e(new b(bArr4), i10, 5);
        bVar.a(i12 - bVar.f46496c);
        bVar.f46495b = ByteOrder.BIG_ENDIAN;
        int readInt = bVar.readInt();
        if (z4) {
        ...
        for (int i13 = 0; i13 < readInt; i13++) {
            ...
            if (readUnsignedShort == H.f46500a) {
                short readShort = bVar.readShort();
                short readShort2 = bVar.readShort();
                c c3 = c.c(readShort, this.f46523g);
                c c10 = c.c(readShort2, this.f46523g);
                HashMap[] hashMapArr = this.f46521e;
    ...
    public final void k(f fVar) {
        ...
        if (cVar != null) {
            e(new b(cVar.d), (int) cVar.f46499c, 5);
        }
    ...
    public final void l(b bVar) {
        ...
        bVar.f46495b = ByteOrder.LITTLE_ENDIAN;
        bVar.a(B.length);
    ...
    public final void m(b bVar, HashMap hashMap) {
        ...
        if (cVar != null && cVar2 != null) {
            int e6 = cVar.e(this.f46523g);
            int e10 = cVar2.e(this.f46523g);
            if (this.d == 7) {
                e6 += this.f46525j;
            }
            if (e6 > 0 && e10 > 0 && this.f46518a == null && this.f46520c == null && this.f46519b == null) {
                bVar.skip(e6);
    ...
    public final void n(String str) {
        ...
        if (str != null) {
            ...
            try {
                ...
                if (z4) {
                    this.f46519b = fileInputStream.getFD();
                } else {
                    this.f46519b = null;
                }
                p(fileInputStream);
        ...
        while (true) {
            ...
            if (i10 < hashMapArr.length) {
                ...
                for (Map.Entry entry : hashMapArr[i10].entrySet()) {
                    ...
                    Log.d("ExifInterface", "tagName: " + ((String) entry.getKey()) + ", tagType: " + cVar.toString() + ", tagValue: '" + cVar.f(this.f46523g) + "'");
                }
                i10++;
            } else {
                return;
    ...
    public final void w(b bVar) {
        c cVar;
        int e6;
        HashMap hashMap = this.f46521e[4];
        ...
        if (cVar2 != null) {
            ...
            if (cVar3 != null) {
                int[] iArr = (int[]) cVar3.g(this.f46523g);
                int[] iArr2 = f46508p;
                if (Arrays.equals(iArr2, iArr) || (this.d == 3 && (cVar = (c) hashMap.get("PhotometricInterpretation")) != null && (((e6 = cVar.e(this.f46523g)) == 1 && Arrays.equals(iArr, f46509q)) || (e6 == 6 && Arrays.equals(iArr, iArr2))))) {
                    c cVar4 = (c) hashMap.get("StripOffsets");
                    c cVar5 = (c) hashMap.get("StripByteCounts");
                    if (cVar4 != null && cVar5 != null) {
                        long[] b10 = s6.b(cVar4.g(this.f46523g));
                        long[] b11 = s6.b(cVar5.g(this.f46523g));
        ...
        if (!isEmpty && !hashMapArr[i11].isEmpty()) {
            ...
            if (cVar != null && cVar2 != null) {
                if (cVar3 != null && cVar4 != null) {
                    int e6 = cVar.e(this.f46523g);
                    int e10 = cVar2.e(this.f46523g);
                    int e11 = cVar3.e(this.f46523g);
                    int e12 = cVar4.e(this.f46523g);
                    if (e6 < e11 && e10 < e12) {
                        HashMap hashMap = hashMapArr[i10];
    ...
    public final void y(f fVar, int i10) {
        ...
        if (cVar != null) {
            if (cVar.f46497a == 5) {
                e[] eVarArr = (e[]) cVar.g(this.f46523g);
                if (eVarArr != null && eVarArr.length == 2) {
                    c3 = c.b(eVarArr[0], this.f46523g);
                    c10 = c.b(eVarArr[1], this.f46523g);
                } else {
                    Log.w("ExifInterface", "Invalid crop size values. cropSize=" + Arrays.toString(eVarArr));
                    return;
                }
            } else {
                int[] iArr = (int[]) cVar.g(this.f46523g);
                if (iArr != null && iArr.length == 2) {
                    c3 = c.c(iArr[0], this.f46523g);
                    c10 = c.c(iArr[1], this.f46523g);
                } else {
            ...
            int e6 = cVar2.e(this.f46523g);
            int e10 = cVar4.e(this.f46523g);
            int e11 = cVar5.e(this.f46523g);
            int e12 = cVar3.e(this.f46523g);
            if (e10 > e6 && e11 > e12) {
                c c11 = c.c(e10 - e6, this.f46523g);
                c c12 = c.c(e11 - e12, this.f46523g);
            ...
            if (cVar6 == null || cVar7 == null) {
                ...
                if (cVar8 != null && cVar9 != null) {
                    int e13 = cVar8.e(this.f46523g);
                    int e14 = cVar8.e(this.f46523g);
                    fVar.b(e13);
    ...
    public g(InputStream inputStream) {
        ...
        if (inputStream != null) {
            ...
            if (inputStream instanceof AssetManager.AssetInputStream) {
                this.f46520c = (AssetManager.AssetInputStream) inputStream;
                this.f46519b = null;
            } else {
