...
public final class g {
    ...
    public FileDescriptor f44810b;
    public AssetManager.AssetInputStream f44811c;
    public int d;
    public final HashMap[] f44812e;
    public final HashSet f44813f;
    public ByteOrder f44814g;
    public boolean h;
    public int f44815i;
    public int f44816j;
    public int f44817k;
    public int f44818l;
    public static final boolean f44796m = Log.isLoggable("ExifInterface", 3);
    public static final List f44797n = Arrays.asList(1, 6, 3, 8);
    public static final List f44798o = Arrays.asList(2, 7, 4, 5);
    public static final int[] f44799p = {8, 8, 8};
    public static final int[] f44800q = {8};
    public static final byte[] f44801r = {-1, -40, -1};
    public static final byte[] f44802s = {102, 116, 121, 112};
    public static final byte[] f44803t = {109, 105, 102, 49};
    public static final byte[] f44804u = {104, 101, 105, 99};
    public static final byte[] v = {79, 76, 89, 77, 80, 0};
    public static final byte[] f44805w = {79, 76, 89, 77, 80, 85, 83, 0, 73, 73};
    public static final byte[] f44806x = {-119, 80, 78, 71, 13, 10, 26, 10};
    public static final byte[] f44807y = {101, 88, 73, 102};
    public static final byte[] f44808z = {73, 72, 68, 82};
        ...
        while (true) {
            ...
            if (i10 < dVarArr3.length) {
                ...
                for (d dVar : dVarArr3[i10]) {
                    K[i10].put(Integer.valueOf(dVar.f44791a), dVar);
                    L[i10].put(dVar.f44792b, dVar);
                }
                i10++;
            } else {
                HashMap hashMap = N;
                d[] dVarArr4 = J;
                hashMap.put(Integer.valueOf(dVarArr4[0].f44791a), 5);
                hashMap.put(Integer.valueOf(dVarArr4[1].f44791a), 1);
                hashMap.put(Integer.valueOf(dVarArr4[2].f44791a), 2);
                hashMap.put(Integer.valueOf(dVarArr4[3].f44791a), 3);
                hashMap.put(Integer.valueOf(dVarArr4[4].f44791a), 7);
                hashMap.put(Integer.valueOf(dVarArr4[5].f44791a), 8);
                Pattern.compile(".*[1-9].*");
    ...
    public g(File file) {
        d[][] dVarArr = I;
        this.f44812e = new HashMap[dVarArr.length];
        this.f44813f = new HashSet(dVarArr.length);
        this.f44814g = ByteOrder.BIG_ENDIAN;
        if (file != null) {
    ...
    public final void A() {
        ...
        y(0, 4);
        y(5, 4);
        HashMap[] hashMapArr = this.f44812e;
    ...
    public final void a() {
        ...
        if (b("ImageWidth") == null) {
            hashMapArr[0].put("ImageWidth", c.a(0L, this.f44814g));
        }
        if (b("ImageLength") == null) {
            hashMapArr[0].put("ImageLength", c.a(0L, this.f44814g));
        }
        if (b("Orientation") == null) {
            hashMapArr[0].put("Orientation", c.a(0L, this.f44814g));
        }
        if (b("LightSource") == null) {
            hashMapArr[1].put("LightSource", c.a(0L, this.f44814g));
        }
    }
    ...
    public final String b(String str) {
        ...
        if (d != null) {
            ...
            if (str.equals("GPSTimeStamp")) {
                ...
                e[] eVarArr = (e[]) d.g(this.f44814g);
                if (eVarArr != null && eVarArr.length == 3) {
                    e eVar = eVarArr[0];
                    Integer valueOf = Integer.valueOf((int) (((float) eVar.f44794a) / ((float) eVar.f44795b)));
                    e eVar2 = eVarArr[1];
                    Integer valueOf2 = Integer.valueOf((int) (((float) eVar2.f44794a) / ((float) eVar2.f44795b)));
                    e eVar3 = eVarArr[2];
                    return String.format("%02d:%02d:%02d", valueOf, valueOf2, Integer.valueOf((int) (((float) eVar3.f44794a) / ((float) eVar3.f44795b))));
                }
                Log.w("ExifInterface", "Invalid GPS Timestamp array. array=" + Arrays.toString(eVarArr));
                return null;
            }
            try {
                return Double.toString(d.d(this.f44814g));
    ...
    public final c d(String str) {
        ...
        for (int i10 = 0; i10 < I.length; i10++) {
            c cVar = (c) this.f44812e[i10].get(str);
            if (cVar != null) {
                return cVar;
            }
        }
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            try {
                try {
                    ...
                    HashMap[] hashMapArr = this.f44812e;
                    if (str != null) {
                        hashMapArr[0].put("ImageWidth", c.c(Integer.parseInt(str), this.f44814g));
                    }
                    if (str2 != null) {
                        hashMapArr[0].put("ImageLength", c.c(Integer.parseInt(str2), this.f44814g));
                    }
                    if (str3 != null) {
                        ...
                        hashMapArr[0].put("Orientation", c.c(i10, this.f44814g));
                    }
    ...
    public final void h(f fVar) {
        ...
        if (cVar != null) {
            ...
            if (cVar4 != null) {
                int[] iArr = (int[]) cVar4.g(this.f44814g);
                if (iArr != null && iArr.length == 4) {
                    ...
                    if (i12 > i13 && (i10 = iArr[3]) > (i11 = iArr[1])) {
                        ...
                        c c10 = c.c(i14, this.f44814g);
                        c c11 = c.c(i15, this.f44814g);
    ...
    public final void i(b bVar) {
        ...
        bVar.f44786b = ByteOrder.BIG_ENDIAN;
        byte[] bArr = f44806x;
        bVar.a(bArr.length);
        ...
        while (true) {
            try {
                ...
                if (bVar.read(bArr2) == 4) {
                    int i10 = length + 8;
                    if (i10 == 16 && !Arrays.equals(bArr2, f44808z)) {
                        throw new IOException("Encountered invalid PNG file--IHDR chunk should appearas the first chunk");
                    }
                    if (Arrays.equals(bArr2, A)) {
                        return;
                    }
                    if (Arrays.equals(bArr2, f44807y)) {
    ...
    public final void j(b bVar) {
        ...
        bVar.a(i10 - bVar.f44787c);
        bVar.read(bArr4);
        f(new b(bArr4), i10, 5);
        bVar.a(i12 - bVar.f44787c);
        bVar.f44786b = ByteOrder.BIG_ENDIAN;
        int readInt = bVar.readInt();
        if (z10) {
        ...
        for (int i13 = 0; i13 < readInt; i13++) {
            ...
            if (readUnsignedShort == H.f44791a) {
                short readShort = bVar.readShort();
                short readShort2 = bVar.readShort();
                c c10 = c.c(readShort, this.f44814g);
                c c11 = c.c(readShort2, this.f44814g);
                HashMap[] hashMapArr = this.f44812e;
    ...
    public final void l(f fVar) {
        ...
        if (cVar != null) {
            f(new b(cVar.d), (int) cVar.f44790c, 5);
        }
    ...
    public final void m(b bVar) {
        ...
        bVar.f44786b = ByteOrder.LITTLE_ENDIAN;
        bVar.a(B.length);
    ...
    public final void n(b bVar, HashMap hashMap) {
        ...
        if (cVar != null && cVar2 != null) {
            int e7 = cVar.e(this.f44814g);
            int e10 = cVar2.e(this.f44814g);
            if (this.d == 7) {
                e7 += this.f44816j;
            }
            if (e7 > 0 && e10 > 0 && this.f44809a == null && this.f44811c == null && this.f44810b == null) {
                bVar.skip(e7);
    ...
    public final void o(String str) {
        ...
        if (str != null) {
            ...
            try {
                ...
                if (z10) {
                    this.f44810b = fileInputStream.getFD();
                } else {
                    this.f44810b = null;
                }
                q(fileInputStream);
        ...
        while (true) {
            ...
            if (i10 < hashMapArr.length) {
                ...
                for (Map.Entry entry : hashMapArr[i10].entrySet()) {
                    ...
                    Log.d("ExifInterface", "tagName: " + ((String) entry.getKey()) + ", tagType: " + cVar.toString() + ", tagValue: '" + cVar.f(this.f44814g) + "'");
                }
                i10++;
            } else {
                return;
    ...
    public final void x(b bVar) {
        c cVar;
        int e7;
        HashMap hashMap = this.f44812e[4];
        ...
        if (cVar2 != null) {
            ...
            if (cVar3 != null) {
                int[] iArr = (int[]) cVar3.g(this.f44814g);
                int[] iArr2 = f44799p;
                if (Arrays.equals(iArr2, iArr) || (this.d == 3 && (cVar = (c) hashMap.get("PhotometricInterpretation")) != null && (((e7 = cVar.e(this.f44814g)) == 1 && Arrays.equals(iArr, f44800q)) || (e7 == 6 && Arrays.equals(iArr, iArr2))))) {
                    c cVar4 = (c) hashMap.get("StripOffsets");
                    c cVar5 = (c) hashMap.get("StripByteCounts");
                    if (cVar4 != null && cVar5 != null) {
                        long[] b10 = x6.b(cVar4.g(this.f44814g));
                        long[] b11 = x6.b(cVar5.g(this.f44814g));
        ...
        if (!isEmpty && !hashMapArr[i11].isEmpty()) {
            ...
            if (cVar != null && cVar2 != null) {
                if (cVar3 != null && cVar4 != null) {
                    int e7 = cVar.e(this.f44814g);
                    int e10 = cVar2.e(this.f44814g);
                    int e11 = cVar3.e(this.f44814g);
                    int e12 = cVar4.e(this.f44814g);
                    if (e7 < e11 && e10 < e12) {
                        HashMap hashMap = hashMapArr[i10];
    ...
    public final void z(f fVar, int i10) {
        ...
        if (cVar != null) {
            if (cVar.f44788a == 5) {
                e[] eVarArr = (e[]) cVar.g(this.f44814g);
                if (eVarArr != null && eVarArr.length == 2) {
                    c10 = c.b(eVarArr[0], this.f44814g);
                    c11 = c.b(eVarArr[1], this.f44814g);
                } else {
                    Log.w("ExifInterface", "Invalid crop size values. cropSize=" + Arrays.toString(eVarArr));
                    return;
                }
            } else {
                int[] iArr = (int[]) cVar.g(this.f44814g);
                if (iArr != null && iArr.length == 2) {
                    c10 = c.c(iArr[0], this.f44814g);
                    c11 = c.c(iArr[1], this.f44814g);
                } else {
            ...
            int e7 = cVar2.e(this.f44814g);
            int e10 = cVar4.e(this.f44814g);
            int e11 = cVar5.e(this.f44814g);
            int e12 = cVar3.e(this.f44814g);
            if (e10 > e7 && e11 > e12) {
                c c12 = c.c(e10 - e7, this.f44814g);
                c c13 = c.c(e11 - e12, this.f44814g);
            ...
            if (cVar6 == null || cVar7 == null) {
                ...
                if (cVar8 != null && cVar9 != null) {
                    int e13 = cVar8.e(this.f44814g);
                    int e14 = cVar8.e(this.f44814g);
                    fVar.b(e13);
    ...
    public g(InputStream inputStream) {
        ...
        if (inputStream != null) {
            ...
            if (inputStream instanceof AssetManager.AssetInputStream) {
                this.f44811c = (AssetManager.AssetInputStream) inputStream;
                this.f44810b = null;
            } else {
