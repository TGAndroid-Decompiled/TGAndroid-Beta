...
public final class g extends b6.g {
    ...
    public g(Context context, Looper looper, s3 s3Var, k5.b bVar, k kVar, l lVar) {
        ...
        bVar = bVar == null ? k5.b.f9730c : bVar;
        f7.b bVar2 = new f7.b((char) 0, 20);
        bVar2.f6001b = Boolean.FALSE;
        k5.b bVar3 = k5.b.f9730c;
        bVar.getClass();
        bVar2.f6001b = Boolean.valueOf(bVar.f9731a);
        bVar2.f6002c = bVar.f9732b;
        bVar2.f6002c = e.a();
    ...
    public final Bundle t() {
        ...
        bundle.putBoolean("force_save_dialog", bVar.f9731a);
        bundle.putString("log_session_id", bVar.f9732b);
        return bundle;
    }
