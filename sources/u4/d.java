...
public abstract class d {
    public static volatile ArrayList f43865a;
    public static final Object f43866b = new Object();
    ...
    public static h f(XmlPullParser xmlPullParser, Context context) {
        ...
        if (!arrayList.isEmpty()) {
            obj.f9331c = (Intent[]) arrayList.toArray(new Intent[0]);
        }
        if (!hashSet.isEmpty()) {
    ...
    public static void h(XmlSerializer xmlSerializer, h hVar) {
        ...
        g0.c cVar = hVar.f43878c;
        String str = hVar.f43877b;
        String str2 = hVar.f43876a;
        g(xmlSerializer, "id", cVar.f9330b);
        g(xmlSerializer, "short_label", cVar.e.toString());
        g(xmlSerializer, "rank", Integer.toString(cVar.f9338m));
        if (!TextUtils.isEmpty(cVar.f9332f)) {
            g(xmlSerializer, "long_label", cVar.f9332f.toString());
        }
        if (!TextUtils.isEmpty(cVar.f9333g)) {
            g(xmlSerializer, "disabled_message", cVar.f9333g.toString());
        }
