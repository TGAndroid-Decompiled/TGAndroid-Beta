...
public abstract class d {
    public static volatile ArrayList f43558a;
    public static final Object f43559b = new Object();
    ...
    public static h f(XmlPullParser xmlPullParser, Context context) {
        ...
        if (!arrayList.isEmpty()) {
            obj.f9315c = (Intent[]) arrayList.toArray(new Intent[0]);
        }
        if (!hashSet.isEmpty()) {
    ...
    public static void h(XmlSerializer xmlSerializer, h hVar) {
        ...
        g0.c cVar = hVar.f43571c;
        String str = hVar.f43570b;
        String str2 = hVar.f43569a;
        g(xmlSerializer, "id", cVar.f9314b);
        g(xmlSerializer, "short_label", cVar.e.toString());
        g(xmlSerializer, "rank", Integer.toString(cVar.f9322m));
        if (!TextUtils.isEmpty(cVar.f9316f)) {
            g(xmlSerializer, "long_label", cVar.f9316f.toString());
        }
        if (!TextUtils.isEmpty(cVar.f9317g)) {
            g(xmlSerializer, "disabled_message", cVar.f9317g.toString());
        }
