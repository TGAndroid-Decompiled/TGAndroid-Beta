...
public abstract class d {
    public static volatile ArrayList f46938a;
    public static final Object f46939b = new Object();
            ...
            if (file.exists()) {
                ...
                while (true) {
                    ...
                    if (next == 1) {
                        ...
                        lVar.put(f7.f46951c.f10274b, f7);
                    }
                }
            }
    ...
    public static void h(XmlSerializer xmlSerializer, h hVar) {
        ...
        g0.c cVar = hVar.f46951c;
        String str = hVar.f46950b;
        String str2 = hVar.f46949a;
