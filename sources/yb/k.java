...
public abstract class k {
    public static final Logger f47153a = Logger.getLogger(k.class.getName());
    public static final HashMap f47154b = new HashMap();
    ...
    static {
        ...
        while (it.hasNext()) {
            ...
            Map map = (Map) f47154b.get(Integer.valueOf(objectTypeIndication));
            if (map == null) {
                map = new HashMap();
            }
            for (int i10 : tags) {
            ...
            f47154b.put(Integer.valueOf(objectTypeIndication), map);
        }
    }
    ...
    public static b a(int i10, ByteBuffer byteBuffer) {
        ...
        while ((a2 >>> 7) == 1) {
            ...
            i11++;
            bVar.f47131b = (bVar.f47131b << 7) | (a2 & 127);
        }
        bVar.f47132c = i11;
        ByteBuffer slice = byteBuffer.slice();
        slice.limit(bVar.f47131b);
        bVar.b(slice);
        byteBuffer.position(byteBuffer.position() + bVar.f47131b);
        return bVar;
    }
}
