...
public class q extends FrameLayout implements a {
    ...
    public q(Context context) {
        ...
        viewGroup.f23976e = new RectF();
        viewGroup.f23978f = new RectF();
        viewGroup.h = new RectF();
        viewGroup.f23986n = new RectF();
        viewGroup.f23991r = new RectF();
        viewGroup.f23993s = new RectF();
        viewGroup.v = new RectF();
        viewGroup.f23997x = new RectF();
        viewGroup.f23998y = new RectF();
        viewGroup.K = -1.0f;
        viewGroup.L = 1.0f;
        viewGroup.M = -1.0f;
        viewGroup.U = new AccelerateDecelerateInterpolator();
        viewGroup.f23979f0 = true;
        viewGroup.f23985l0 = new RectF();
        viewGroup.f23987n0 = 0.0f;
        viewGroup.f23988o0 = 1.0f;
        viewGroup.f23989p0 = 0.0f;
        viewGroup.f23990q0 = 0.0f;
        viewGroup.f23970a0 = z10;
        viewGroup.J = true;
        viewGroup.I = true;
        viewGroup.V = AndroidUtilities.dp(16.0f);
        viewGroup.W = AndroidUtilities.dp(32.0f);
        viewGroup.f23995t0 = 1;
    ...
    public final void d(RectF rectF) {
        ...
        AnimatorSet animatorSet = cropAreaView.f23984k0;
        if (animatorSet != null) {
            animatorSet.cancel();
            cropAreaView.f23984k0 = null;
        }
        AnimatorSet animatorSet2 = new AnimatorSet();
        cropAreaView.f23984k0 = animatorSet2;
    ...
    public final void i() {
        ...
        rectF.set(cropAreaView.f23997x);
        o oVar3 = this.L;
    ...
    public final void q() {
        ...
        if (this.f16333e != null && this.L != null) {
            ...
            float f14 = ceil4;
            float f15 = ceil3;
            RectF rectF2 = cropAreaView.f23985l0;
