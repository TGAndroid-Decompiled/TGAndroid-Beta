...
public class q extends FrameLayout implements a {
    ...
    public final CropAreaView f16303a;
    public final ImageView f16304b;
    public final Matrix f16305c;
    public u61 d;
    public g f16306e;
    public final RectF f16307f;
    public final RectF h;
    public float f16308n;
    public final boolean f16309r;
    public final n f16310s;
    public final Matrix v;
    public Bitmap f16311w;
    ...
    public q(Context context) {
        ...
        this.f16309r = z10;
        this.f16307f = new RectF();
        this.h = new RectF();
        this.f16305c = new Matrix();
        n nVar = new n(0, false);
        nVar.f16292b = new float[8];
        this.f16310s = nVar;
        this.v = new Matrix();
        this.F = false;
        ImageView imageView = new ImageView(context);
        this.f16304b = imageView;
        ...
        viewGroup.f23949e = new RectF();
        viewGroup.f23951f = new RectF();
        viewGroup.h = new RectF();
        viewGroup.f23959n = new RectF();
        viewGroup.f23964r = new RectF();
        viewGroup.f23966s = new RectF();
        viewGroup.v = new RectF();
        viewGroup.f23970x = new RectF();
        viewGroup.f23971y = new RectF();
        viewGroup.K = -1.0f;
        viewGroup.L = 1.0f;
        viewGroup.M = -1.0f;
        viewGroup.U = new AccelerateDecelerateInterpolator();
        viewGroup.f23952f0 = true;
        viewGroup.f23958l0 = new RectF();
        viewGroup.f23960n0 = 0.0f;
        viewGroup.f23961o0 = 1.0f;
        viewGroup.f23962p0 = 0.0f;
        viewGroup.f23963q0 = 0.0f;
        viewGroup.f23943a0 = z10;
        viewGroup.J = true;
        viewGroup.I = true;
        viewGroup.V = AndroidUtilities.dp(16.0f);
        viewGroup.W = AndroidUtilities.dp(32.0f);
        viewGroup.f23968t0 = 1;
    ...
    public static void a(q qVar, Integer[][] numArr, int i10) {
        ...
        if (i10 != 0) {
            if (i10 != 1) {
                ...
                if (qVar.f16303a.getAspectRatio() > 1.0f) {
        ...
        o oVar = qVar.L;
        int i11 = ((oVar.f16298g % 180.0f) > 0.0f ? 1 : ((oVar.f16298g % 180.0f) == 0.0f ? 0 : -1));
        if (i11 != 0) {
            f7 = oVar.f16294b;
        } else {
            f7 = oVar.f16293a;
    ...
    private void setLockedAspectRatio(float f7) {
        CropAreaView cropAreaView = this.f16303a;
    ...
    public final void b(MediaController.CropState cropState) {
        ...
        Matrix matrix = this.L.f16301k;
        float[] fArr = this.H;
        matrix.getValues(fArr);
        o oVar = this.L;
        float f11 = oVar.f16297f * cropWidth;
        ...
        if (i10 != 90 && i10 != 270) {
            o oVar2 = this.L;
            i11 = (int) oVar2.f16293a;
            f10 = oVar2.f16294b;
        } else {
            o oVar3 = this.L;
            i11 = (int) oVar3.f16294b;
            f10 = oVar3.f16293a;
        }
        int i12 = (int) f10;
        float f12 = i11;
        ...
        cropState.cropScale = Math.min(f12 / cropAreaView.getCropWidth(), f13 / cropAreaView.getCropHeight()) * this.L.f16296e;
        float f15 = fArr[2] / f12;
        o oVar4 = this.L;
        float f16 = oVar4.f16296e;
        cropState.cropPx = f15 / f16;
        cropState.cropPy = (fArr[5] / f13) / f16;
        cropState.cropRotate = oVar4.f16299i;
        cropState.stateScale = f16;
        cropState.mirrored = oVar4.f16300j;
        cropState.scale = cropWidth;
        cropState.matrix = oVar4.f16301k;
        cropState.width = ceil;
        cropState.height = ceil2;
        cropState.freeform = this.f16312x;
    ...
    public final void d(RectF rectF) {
        ...
        ImageView imageView = this.f16304b;
        float a2 = o.a(this.L) * ((centerX - (imageView.getWidth() / 2)) / cropAreaView.getCropWidth());
        float b10 = o.b(this.L) * ((rectF.centerY() - ((((imageView.getHeight() - this.f16313y) + i10) + this.E) / 2.0f)) / cropAreaView.getCropHeight());
        ...
        AnimatorSet animatorSet = cropAreaView.f23957k0;
        if (animatorSet != null) {
            animatorSet.cancel();
            cropAreaView.f23957k0 = null;
        }
        AnimatorSet animatorSet2 = new AnimatorSet();
        cropAreaView.f23957k0 = animatorSet2;
    ...
    public final void e(boolean z10, boolean z11, boolean z12, boolean z13) {
        ...
        if (this.L != null) {
            ...
            o oVar = this.L;
            float f12 = oVar.f16296e;
            n nVar = this.f16310s;
            float[] fArr = (float[]) nVar.f16292b;
            float[] fArr2 = (float[]) nVar.f16292b;
            ...
            o oVar2 = this.L;
            PointF pointF = new PointF(oVar2.f16295c, oVar2.d);
            ...
            } else if (z11 && this.f16308n > 0.0f) {
                float width = rectF.width() / n(rectF, rectF2);
                if (this.L.f16296e * width < this.f16308n) {
                    width = 1.0f;
                }
    ...
    public float getCropHeight() {
        return this.f16303a.getCropHeight();
    }

    public float getCropLeft() {
        return this.f16303a.getCropLeft();
    }

    public float getCropTop() {
        return this.f16303a.getCropTop();
    }

    public float getCropWidth() {
        return this.f16303a.getCropWidth();
    }
    ...
    public float getStateFullOrientation() {
        ...
        return oVar.f16298g + oVar.h;
    }

    public boolean getStateMirror() {
        o oVar = this.L;
        if (oVar != null && oVar.f16300j) {
            return true;
        }
        return false;
    }
    ...
    public final void i() {
        ...
        o oVar2 = this.L;
        if ((oVar2.h + oVar2.f16298g) % 180.0f != 0.0f) {
        ...
        rectF.set(cropAreaView.f23970x);
        o oVar3 = this.L;
        final float f12 = oVar3.f16295c;
        final float f13 = oVar3.d;
        final float f14 = oVar3.f16296e;
        final float f15 = oVar3.f16299i;
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                ...
                qVar.f16303a.setActualRect(rectF5);
                o oVar4 = qVar.L;
                float f16 = 1.0f - floatValue;
                float f17 = oVar4.f16295c - (f12 * f16);
                float f18 = oVar4.d - (f13 * f16);
                float f19 = oVar4.f16299i - (f15 * f16);
                float lerp = AndroidUtilities.lerp(f14, f7, floatValue);
                o oVar5 = qVar.L;
                o.f(oVar5, -f17, -f18);
                o.g(qVar.L, lerp / oVar5.f16296e, 0.0f, 0.0f);
                o.e(qVar.L, -f19);
    ...
    public final boolean j() {
        ...
        oVar.f16300j = !oVar.f16300j;
        r(false);
        p pVar = this.M;
        if (pVar != null) {
            o oVar2 = this.L;
            float f7 = oVar2.h;
            float f10 = oVar2.f16298g;
            float f11 = ((f7 + f10) - f10) % 360.0f;
            if (!o.c(oVar2) && f11 == 0.0f && this.f16303a.getLockAspectRatio() == 0.0f && !this.L.f16300j) {
                z10 = true;
            }
            pVar.W(z10);
        }
        return this.L.f16300j;
    }

    public final void k() {
        this.f16303a.g(2, false);
        if (this.f16308n < 1.0E-5f) {
            this.f16308n = this.L.f16296e;
        }
    }
    ...
    public final void l(boolean z10) {
        ...
        o oVar = this.L;
        if (oVar != null && oVar.f16298g % 180.0f != 0.0f) {
            z11 = true;
        } else {
            z11 = false;
        }
        cropAreaView.e(currentWidth, currentHeight, z11, this.f16312x);
        if (this.f16312x) {
            f7 = 0.0f;
        } else {
            f7 = 1.0f;
    ...
    public final boolean m(float f7) {
        ...
        if (this.L != null) {
            ...
            o oVar = this.L;
            float f10 = oVar.h;
            float f11 = oVar.f16298g;
            float f12 = (((f10 + f11) - f11) + f7) % 360.0f;
            if (this.f16312x && cropAreaView.getLockAspectRatio() > 0.0f) {
                cropAreaView.setLockedAspectRatio(1.0f / cropAreaView.getLockAspectRatio());
                cropAreaView.setActualRect(cropAreaView.getLockAspectRatio());
            } else {
                int currentWidth = getCurrentWidth();
                int currentHeight = getCurrentHeight();
                if ((this.L.f16298g + f12) % 180.0f != 0.0f) {
                    z10 = true;
                } else {
                    z10 = false;
                }
                cropAreaView.e(currentWidth, currentHeight, z10, this.f16312x);
            }
            o.d(this.L, f12);
            r(false);
            ...
            p pVar = this.M;
            if (pVar != null) {
                if (f12 == 0.0f && cropAreaView.getLockAspectRatio() == 0.0f && !this.L.f16300j) {
                    z11 = true;
                } else {
                    z11 = false;
                }
    ...
    public final void o() {
        ...
        for (int i11 = 0; i11 < 6; i11++) {
            ...
            if (this.f16303a.getAspectRatio() > 1.0f) {
    ...
    public final void q() {
        ...
        float max;
        boolean z10;
        if (this.f16306e != null && this.L != null) {
            CropAreaView cropAreaView = this.f16303a;
            cropAreaView.d(this.N);
            int ceil = (int) Math.ceil(n(rectF, this.O));
            int ceil2 = (int) Math.ceil(f7 / cropAreaView.getAspectRatio());
            ...
            if (i11 != 90 && i11 != 270) {
                o oVar2 = this.L;
                i10 = (int) oVar2.f16293a;
                f10 = oVar2.f16294b;
            } else {
                o oVar3 = this.L;
                i10 = (int) oVar3.f16294b;
                f10 = oVar3.f16293a;
            }
            int i12 = (int) f10;
            double d = ceil;
            ...
            float f14 = ceil4;
            float f15 = ceil3;
            RectF rectF2 = cropAreaView.f23958l0;
            ...
            float f16 = oVar4.f16296e;
            float f17 = f16 / max;
            float f18 = f16 / oVar4.f16297f;
            float f19 = (fArr[2] / f12) / f16;
            float f20 = (fArr[5] / f13) / f16;
            float f21 = oVar4.f16299i;
            ...
            g gVar = this.f16306e;
            o oVar5 = this.L;
            if (!oVar5.f16300j && !o.c(oVar5) && this.L.f16298g < 1.0E-5f) {
                z10 = false;
            } else {
                z10 = true;
            }
            o oVar6 = this.L;
            gVar.e(z10, f19, f20, f21, (int) oVar6.h, f17, f18, oVar6.f16297f / max, f15, f14, cropCenterX, cropCenterY, oVar6.f16300j);
        }
    }
    ...
    public final void r(boolean z10) {
        ...
        Matrix matrix = this.f16305c;
        matrix.reset();
        o oVar = this.L;
        float f7 = oVar.f16298g;
        if (f7 != 90.0f && f7 != 270.0f) {
            matrix.postTranslate((-oVar.f16293a) / 2.0f, (-oVar.f16294b) / 2.0f);
        } else {
            matrix.postTranslate((-oVar.f16294b) / 2.0f, (-oVar.f16293a) / 2.0f);
        }
        matrix.postRotate((int) this.L.h);
        matrix.postConcat(this.L.f16301k);
        CropAreaView cropAreaView = this.f16303a;
        matrix.postTranslate(cropAreaView.getCropCenterX(), cropAreaView.getCropCenterY());
        if (!this.f16312x || this.J || z10) {
            q();
            this.M.s();
        }
        invalidate();
    ...
    public void setAspectRatio(float f7) {
        this.f16303a.setActualRect(f7);
    }

    public void setBottomPadding(float f7) {
        this.f16313y = f7;
        this.f16303a.setBottomPadding(f7);
    }

    public void setFreeform(boolean z10) {
        this.f16303a.setFreeform(z10);
        this.f16312x = z10;
    }
    ...
    public void setRotation(float f7) {
        o oVar = this.L;
        o.e(oVar, f7 - oVar.f16299i);
        e(true, true, false, false);
    }

    public void setSubtitle(String str) {
        this.f16303a.setSubtitle(str);
    }

    public void setTopPadding(float f7) {
        this.E = f7;
        this.f16303a.setTopPadding(f7);
    }
}
