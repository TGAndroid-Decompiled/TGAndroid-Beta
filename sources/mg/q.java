...
public final class q extends x61 {
    ...
    public final void onLayout(boolean z4, int i10, int i11, int i12, int i13) {
        ...
        if (this.a2) {
            this.a2 = false;
            this.f14091b2.f14124b.s(null);
        }
    }

    @Override
    public final void p(View view, Long l10, TLRPC.Document document, TL_stars.TL_starGiftUnique tL_starGiftUnique, Integer num) {
        s sVar = this.f14091b2;
        int i10 = sVar.G;
        ...
        if (linkedHashMap.containsKey(l10)) {
            ...
            try {
                ...
                u5 e = s0.e(document, l10, sVar.f14127n.getFontMetricsInt());
                e.cacheType = l5.g();
                e.setAdded();
                ...
                sVar.f14127n.getText().insert(editTextSelectionEnd, spannableString);
                sVar.f14127n.setSelection(editTextSelectionEnd + spannableString.length());
                sVar.f14124b.x(l10, true);
                sVar.Y(true);
                sVar.W(e);
            } catch (Exception e6) {
