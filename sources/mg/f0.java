...
public abstract class f0 extends ut {
    ...
    public f0(Context context, int i10, f6 f6Var) {
        super(context, f6Var);
        this.f13987c = f6Var;
        this.d = new zz(getContext(), new GestureDetector.SimpleOnGestureListener());
        setBackground(null);
        ...
        setLinkTextColor(j6.v0(j6.f19958hc, f6Var));
        setHighlightColor(j6.v0(j6.f20191uf, f6Var));
        int i12 = j6.Vd;
        setHintColor(j6.v0(i12, f6Var));
        setHintTextColor(j6.v0(i12, f6Var));
        setCursorColor(j6.v0(j6.Wd, f6Var));
        setHandlesColor(j6.v0(j6.f20209vf, f6Var));
        if (i11 >= 28) {
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        if (((GestureDetector) this.d.f31508b).onTouchEvent(motionEvent) && !isLongClickable()) {
            return false;
        }
    ...
    public final void m() {
        ...
        if (((b[]) spannableStringBuilder.getSpans(0, spannableStringBuilder.length(), b.class)).length == 0) {
            ...
            b bVar = new b(this.f13987c);
            ValueAnimator ofInt = ValueAnimator.ofInt(bVar.f13930f, 255);
    ...
    public final void n(boolean z4) {
        ...
        for (b bVar : (b[]) spannableStringBuilder.getSpans(0, spannableStringBuilder.length(), b.class)) {
            ...
            if (z4) {
                ...
                ValueAnimator ofInt = ValueAnimator.ofInt(bVar.f13930f, 0);
