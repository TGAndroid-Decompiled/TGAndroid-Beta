...
public final class q0 {
    ...
    public static q0 e(TLRPC.TL_availableEffect tL_availableEffect) {
        ...
        boolean z4 = true;
        obj.f14105b = true;
        long j10 = tL_availableEffect.f19215id;
        obj.f14106c = j10;
        if (tL_availableEffect.effect_animation_id != 0) {
            z4 = false;
        }
        obj.e = z4;
        obj.f14108g = tL_availableEffect.effect_sticker_id;
        obj.h = j10;
        obj.d = tL_availableEffect.premium_required;
        obj.f14107f = tL_availableEffect.emoticon;
        return obj;
    }

    public final q0 a() {
        String findAnimatedEmojiEmoticon;
        long j10 = this.f14108g;
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj != null && q0.class == obj.getClass()) {
            q0 q0Var = (q0) obj;
            if (this.f14108g == q0Var.f14108g && Objects.equals(this.f14107f, q0Var.f14107f)) {
                return true;
            }
        }
        return false;
    ...
    public final boolean f(TLRPC.Reaction reaction) {
        if (reaction instanceof TLRPC.TL_reactionEmoji) {
            return TextUtils.equals(((TLRPC.TL_reactionEmoji) reaction).emoticon, this.f14107f);
        }
        if (!(reaction instanceof TLRPC.TL_reactionCustomEmoji) || ((TLRPC.TL_reactionCustomEmoji) reaction).document_id != this.f14108g) {
            return false;
        }
        return true;
    }
    ...
    public final TLRPC.Reaction g() {
        ...
        if (this.f14107f != null) {
            ...
            tL_reactionEmoji.emoticon = this.f14107f;
            return tL_reactionEmoji;
        }
        TLRPC.TL_reactionCustomEmoji tL_reactionCustomEmoji = new TLRPC.TL_reactionCustomEmoji();
        tL_reactionCustomEmoji.document_id = this.f14108g;
        return tL_reactionCustomEmoji;
    }

    public final int hashCode() {
        return Objects.hash(this.f14107f, Long.valueOf(this.f14108g));
    }

    public final String toString() {
        TLRPC.Document f10;
        if (!TextUtils.isEmpty(this.f14107f)) {
            return this.f14107f;
        }
        long j10 = this.f14108g;
        ...
        sb.append(", ");
        return android.support.v4.media.a.r(sb, this.f14107f, "}");
    }
}
