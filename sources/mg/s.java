...
public final class s extends p2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public f d;
    public r8 e;
    public LinearLayout f14126f;
    public u3 h;
    public p f14127n;
    public w7 f14128r;
    public r8 f14129s;
    public t0 v;
    public FrameLayout f14130w;
    public ImageView f14131x;
    public do0 f14132y;
    ...
    public final void W(u5 u5Var) {
        Editable text = this.f14127n.getText();
        Layout layout = this.f14127n.getLayout();
        ...
        if (z4 && z10) {
            ...
            alertDialog$Builder.k(LocaleController.getString("ApplyTheme", R.string.ApplyTheme), new c2(this) {
                ...
                public final void l(d2 d2Var, int i10) {
                    switch (r2) {
                        case 0:
                            this.f13990b.v.performClick();
                            return;
                        default:
                            this.f13990b.finishFragment();
                            return;
                    }
                }
            });
    ...
    public final void Z() {
        if (this.H) {
            ...
            if (Build.MODEL.toLowerCase().startsWith("zte") && Build.VERSION.SDK_INT <= 28) {
                this.f14126f.setFocusableInTouchMode(true);
                this.f14126f.requestFocus();
            } else {
                this.f14127n.clearFocus();
            }
            ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) this.f14132y.getLayoutParams();
            marginLayoutParams.bottomMargin = 0;
            this.f14132y.setLayoutParams(marginLayoutParams);
            NotificationCenter.getGlobalInstance().lambda$postNotificationNameOnUIThread$1(NotificationCenter.stopAllHeavyOperations, 512);
            this.f14125c.animate().setListener(null).cancel();
            this.f14125c.animate().translationY(this.f14125c.getMeasuredHeight()).setDuration(350L).withLayer().setInterpolator(mr.f27122f).setUpdateListener(new j(this, 1)).setListener(new m(this, 0)).start();
        }
    }

    public final boolean a0() {
        int editTextSelectionEnd = this.f14127n.getEditTextSelectionEnd();
        int editTextSelectionStart = this.f14127n.getEditTextSelectionStart();
        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(this.f14127n.getText());
        if (!this.f14127n.hasSelection()) {
            return false;
        }
        ...
        for (u5 u5Var : u5VarArr) {
            ...
            this.f14124b.A(Long.valueOf(u5Var.documentId));
        }
        this.f14127n.dispatchKeyEvent(new KeyEvent(0, 67));
        Y(false);
        return true;
    }
            ...
            if (l10.longValue() != -1) {
                ...
                while (true) {
                    if (i11 < size2) {
                        ...
                        if (l10.longValue() == tL_availableReaction.activate_animation.f19165id) {
    ...
    public final void c0(int i10, boolean z4, boolean z10) {
        ...
        if (this.P != i10 || this.f14123a != z4) {
            ...
            if (i10 != 1 && i10 != 0 && !z4) {
                if (z10) {
                    Z();
                    this.f14130w.animate().setListener(null).cancel();
                    this.f14126f.animate().setListener(null).cancel();
                    ViewPropertyAnimator duration = this.f14130w.animate().alpha(0.0f).setDuration(350L);
                    mr mrVar = mr.f27122f;
                    duration.setInterpolator(mrVar).setListener(new m(this, 2)).start();
                    this.f14126f.animate().alpha(0.0f).setDuration(350L).setInterpolator(mrVar).setListener(new m(this, 3)).start();
                    return;
                }
                this.f14126f.setVisibility(4);
                this.f14130w.setVisibility(4);
                return;
            }
            this.f14126f.setVisibility(0);
            this.f14130w.setVisibility(0);
            if (z10) {
                this.f14130w.animate().setListener(null).cancel();
                this.f14126f.animate().setListener(null).cancel();
                ViewPropertyAnimator duration2 = this.f14126f.animate().alpha(1.0f).setDuration(350L);
                mr mrVar2 = mr.f27122f;
                duration2.setInterpolator(mrVar2).setListener(new m(this, 1)).start();
                this.f14130w.animate().alpha(1.0f).setDuration(350L).setInterpolator(mrVar2).start();
                LinkedHashMap linkedHashMap = this.B;
                if (linkedHashMap.isEmpty()) {
                    this.f14124b.H.clear();
                    this.f14127n.setText("");
                    ...
                    while (i13 < size) {
                        int i14 = i13 + 1;
                        s0.a((TLRPC.TL_availableReaction) arrayList.get(i13), linkedHashMap, this.C, spannableStringBuilder, this.f14124b, this.f14127n.getFontMetricsInt());
                        i12++;
                        if (i12 >= this.G) {
                            break;
                        }
                    ...
                    this.f14127n.append(spannableStringBuilder);
                    this.f14127n.m();
                    v51 v51Var = this.f14124b.m0;
                    if (v51Var != null) {
                        v51Var.l();
                    }
                    Y(false);
    ...
    public final void d0() {
        ...
        if (z4) {
            ...
            W(u5Var);
            this.f14124b.x(-1L, true);
            Y(false);
            this.f14127n.setMaxLength(i10);
            c0(this.P, this.f14123a, true);
        } else {
            r8Var.setChecked(true);
            try {
                this.f14127n.setMaxLength(i10 + 1);
                ...
                this.f14127n.getText().insert(0, spannableString);
                this.f14124b.x(-1L, true);
                Y(true);
                W(nVar);
            } catch (Exception e) {
        ...
        this.f14127n.updateAnimatedEmoji(true);
    }
    ...
    public final void onPause() {
        this.Q = true;
        this.f14127n.setFocusable(false);
        super.onPause();
    }
    ...
    public final void onResume() {
        ...
        if (this.Q) {
            this.Q = false;
            this.f14127n.setFocusable(true);
            this.f14127n.setFocusableInTouchMode(true);
            if (this.H) {
                this.f14127n.n(false);
    ...
    public final void onTransitionAnimationEnd(boolean z4, boolean z10) {
        ...
        if (z4 && !z10) {
            if (this.f14124b == null) {
                ...
                this.f14124b.setClipChildren(false);
                this.f14124b.setBackgroundColor(j6.w0(null, j6.f19881d6, false));
                this.f14125c.addView(this.f14124b, b6.e(-1, -2, 80));
                f fVar = new f(getParentActivity(), getResourceProvider());
                this.d = fVar;
                fVar.setOnBackspace(new k(this, 0));
                this.f14125c.addView(this.d, b6.d(-1, -2.0f, 85, 0.0f, 0.0f, 8.0f, 8.0f));
                ArrayList arrayList = this.C;
                int size = arrayList.size();
                int i10 = 0;
                while (i10 < size) {
