...
public final class k0 extends p9 {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (getImageReceiver().getLottieAnimation() != null && getImageReceiver().getLottieAnimation().f25164i0) {
            this.D = true;
        }
        if (!this.D && getImageReceiver().getLottieAnimation() != null && !getImageReceiver().getLottieAnimation().f25164i0) {
            m0 m0Var = this.H;
            if (m0Var.f14036a == 2 && !m0Var.f14057z) {
