...
public final class i extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final void c(final boolean z10) {
        ...
        if (z10) {
            ...
            if (getContext() instanceof LaunchActivity) {
                ...
                ActionBarLayout actionBarLayout = ((LaunchActivity) getContext()).f31153s0;
                if (actionBarLayout != null) {
                    arrayList.addAll(actionBarLayout.z());
                }
                ActionBarLayout actionBarLayout2 = ((LaunchActivity) getContext()).f31151r0;
                if (actionBarLayout2 != null) {
                    arrayList.addAll(actionBarLayout2.z());
                }
            }
            arrayList.addAll(getBuiltInDebugItems());
            this.f15069y.getAdapter().l();
        }
        ...
        kVar.b(new o1.g() {
            ...
            public final void a(o1.h hVar, float f11, float f12) {
                ...
                i iVar = i.this;
                LinearLayout linearLayout = iVar.f15067w;
    ...
    public final void d() {
        ...
        drawable.setColorFilter(new PorterDuffColorFilter(j6.w0(null, j6.f19180h5, false), mode));
        this.f15067w.setBackground(drawable);
        this.f15068x.setTextColor(j6.w0(null, j6.f19216j5, false));
        invalidate();
    }
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        LinearLayout linearLayout = this.f15067w;
    ...
    public final void onAttachedToWindow() {
        ...
        k kVar = new k(n6Var, o1.h.f15519m, n6Var.getTranslationX());
        l lVar = new l(n6Var.getTranslationX());
        lVar.b(650.0f);
        lVar.a(0.75f);
        kVar.f15537u = lVar;
        this.f15062c = kVar;
        k kVar2 = new k(n6Var, o1.h.f15520n, n6Var.getTranslationY());
    ...
    public final void onConfigurationChanged(Configuration configuration) {
        ...
        this.f15062c.f15537u.f15543i = n6Var.getTranslationX();
        this.d.f15537u.f15543i = n6Var.getTranslationY();
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        this.f15061b.setAlpha((int) (n6Var.getAlpha() * 255.0f));
        this.f15061b.setBounds(n6Var.getLeft(), n6Var.getTop(), n6Var.getRight(), n6Var.getBottom());
        this.f15061b.draw(canvas);
        canvas.restore();
    }
