...
public abstract class s0 {
    ...
    public static boolean c(TLRPC.Reaction reaction, q0 q0Var) {
        if ((reaction instanceof TLRPC.TL_reactionEmoji) && q0Var.f14096g == 0 && TextUtils.equals(((TLRPC.TL_reactionEmoji) reaction).emoticon, q0Var.f14095f)) {
            return true;
        }
    ...
    public static u5 e(TLRPC.Document document, Long l10, Paint.FontMetricsInt fontMetricsInt) {
        u5 u5Var;
        if (document != null) {
            u5Var = new u5(document.f19165id, 1.0f, fontMetricsInt);
