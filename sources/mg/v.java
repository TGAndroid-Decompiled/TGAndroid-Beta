...
public final class v extends FrameLayout {
    ...
    public final int h;
    public float f14142n;
    public float f14143r;
    public float f14144s;
    public long v;
    ...
    public v(zn znVar, Context context) {
        super(context);
        this.f14140c = Collections.EMPTY_LIST;
        this.f14141f = 22;
        this.h = 24;
        this.f14147y = new int[2];
        setVisibility(8);
        this.f14138a = znVar;
        setClipToPadding(false);
        setClipChildren(false);
        znVar.f40759u0.j(new f2(this, 10));
    }
    ...
    public final MessageObject b() {
        ...
        if (this.d && !this.f14140c.isEmpty()) {
            int i10 = 0;
            MessageObject messageObject = (MessageObject) this.f14140c.get(0);
            if (messageObject.getGroupId() != 0 && (y82 = this.f14138a.y8(messageObject.getGroupId())) != null && (arrayList = y82.messages) != null) {
