...
public final class g extends ll0 {
    ...
    public long i(int i10) {
        switch (this.f14828c) {
            case 1:
                return ((f81) ((i81) this.e).h.get(i10)).f23821a;
            default:
                return super.i(i10);
        }
    }
    ...
    public final void v(c1 c1Var, int i10) {
        ...
        switch (this.f14828c) {
            case 0:
                ...
                y1 y1Var = (y1) view;
                y1Var.setTextColor(j6.w0(null, j6.f18969j5, false));
                y1Var.a(0, charSequence);
                return;
            default:
                g81 g81Var = (g81) c1Var.f42697a;
                i81 i81Var = (i81) this.e;
                f81 f81Var = (f81) i81Var.h.get(i10);
                g81Var.f24117a = f81Var;
                g81Var.setContentDescription(f81Var.f23822b);
                g81Var.setAlpha(1.0f);
                g81Var.requestLayout();
                if (i81Var.m0 && (h81Var = i81Var.f24896y) != null && ((ka.c) h81Var).d(i10)) {
                    z10 = true;
                } else {
                    z10 = false;
                }
