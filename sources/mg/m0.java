...
public final class m0 {
    ...
    public static void f() {
        ...
        if (m0Var != null) {
            ...
            if (B.f14048a == 0 && System.currentTimeMillis() - E > 200) {
        ...
        if (m0Var2 != null) {
            ...
            if (view instanceof t1) {
                ((t1) view).K.b(m0Var2.f14060p);
            } else if (view instanceof v0) {
                ((v0) view).f22486z0.b(m0Var2.f14060p);
            }
        }
    }
    ...
    public static void g() {
        m0 m0Var = C;
        if (m0Var != null && !m0Var.f14063s) {
            m0Var.f14063s = true;
            m0Var.f14068y = System.currentTimeMillis();
            if (C.f14048a == 1 && System.currentTimeMillis() - E > 200) {
                E = System.currentTimeMillis();
                View view = C.v;
                if (view != null) {
    ...
    public final void c() {
        try {
            boolean z4 = this.f14066w;
            j0 j0Var = this.f14053i;
            if (z4) {
                this.f14055k.removeView(j0Var);
            } else {
