...
public final class b implements ScaleGestureDetector.OnScaleGestureListener {
    ...
    public void b() {
        switch (this.f16234a) {
            ...
            default:
                ...
                WindowManager.LayoutParams layoutParams3 = h1Var.f31521c;
                int m10 = (int) (h1Var.m() * h1Var.P);
                layoutParams3.width = m10;
                h1Var.M = m10;
                WindowManager.LayoutParams layoutParams4 = h1Var.f31521c;
                int l4 = (int) (h1Var.l() * h1Var.P);
                layoutParams4.height = l4;
                h1Var.N = l4;
                AndroidUtilities.updateViewLayout(h1Var.f31520b, h1Var.d, h1Var.f31521c);
                return;
        }
    }
    ...
    public final boolean onScale(ScaleGestureDetector scaleGestureDetector) {
        ...
        switch (this.f16234a) {
            ...
            case 1:
                eg0 eg0Var = (eg0) this.f16235b;
                eg0Var.J = w7.p.a(scaleGestureDetector.getScaleFactor() * eg0Var.J, 0.75f, eg0Var.f25677a);
            ...
            default:
                h1 h1Var = (h1) this.f16235b;
                h1Var.P = w7.p.a(scaleGestureDetector.getScaleFactor() * h1Var.P, 0.6f, h1Var.f31518a);
    ...
    public final boolean onScaleBegin(ScaleGestureDetector scaleGestureDetector) {
        switch (this.f16234a) {
            ...
            case 1:
                ...
                eg0Var.f25698x = true;
                eg0Var.f25681c.width = (int) (eg0Var.t() * eg0Var.f25677a);
                eg0Var.f25681c.height = (int) (eg0Var.r() * eg0Var.f25677a);
                AndroidUtilities.updateViewLayout(eg0Var.f25679b, eg0Var.d, eg0Var.f25681c);
                return true;
            default:
                h1 h1Var = (h1) this.f16235b;
                ...
                h1Var.I = true;
                h1Var.f31521c.width = (int) (h1Var.m() * h1Var.f31518a);
                h1Var.f31521c.height = (int) (h1Var.l() * h1Var.f31518a);
                AndroidUtilities.updateViewLayout(h1Var.f31520b, h1Var.d, h1Var.f31521c);
                return true;
        }
    }
