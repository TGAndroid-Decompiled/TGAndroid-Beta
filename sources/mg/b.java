...
public final class b implements ScaleGestureDetector.OnScaleGestureListener {
    ...
    public void b() {
        switch (this.f16261a) {
            ...
            default:
                ...
                WindowManager.LayoutParams layoutParams3 = h1Var.f31548c;
                int m10 = (int) (h1Var.m() * h1Var.P);
                layoutParams3.width = m10;
                h1Var.M = m10;
                WindowManager.LayoutParams layoutParams4 = h1Var.f31548c;
                int l4 = (int) (h1Var.l() * h1Var.P);
                layoutParams4.height = l4;
                h1Var.N = l4;
                AndroidUtilities.updateViewLayout(h1Var.f31547b, h1Var.d, h1Var.f31548c);
                return;
        }
    }
    ...
    public final boolean onScale(ScaleGestureDetector scaleGestureDetector) {
        ...
        switch (this.f16261a) {
            ...
            case 1:
                eg0 eg0Var = (eg0) this.f16262b;
                eg0Var.J = w7.p.a(scaleGestureDetector.getScaleFactor() * eg0Var.J, 0.75f, eg0Var.f25704a);
            ...
            default:
                h1 h1Var = (h1) this.f16262b;
                h1Var.P = w7.p.a(scaleGestureDetector.getScaleFactor() * h1Var.P, 0.6f, h1Var.f31545a);
    ...
    public final boolean onScaleBegin(ScaleGestureDetector scaleGestureDetector) {
        switch (this.f16261a) {
            ...
            case 1:
                ...
                eg0Var.f25725x = true;
                eg0Var.f25708c.width = (int) (eg0Var.t() * eg0Var.f25704a);
                eg0Var.f25708c.height = (int) (eg0Var.r() * eg0Var.f25704a);
                AndroidUtilities.updateViewLayout(eg0Var.f25706b, eg0Var.d, eg0Var.f25708c);
                return true;
            default:
                h1 h1Var = (h1) this.f16262b;
                ...
                h1Var.I = true;
                h1Var.f31548c.width = (int) (h1Var.m() * h1Var.f31545a);
                h1Var.f31548c.height = (int) (h1Var.l() * h1Var.f31545a);
                AndroidUtilities.updateViewLayout(h1Var.f31547b, h1Var.d, h1Var.f31548c);
                return true;
        }
    }
