...
public final class v {
    ...
    public static final m0 f7928f = m0.u(5, StandardCharsets.US_ASCII, StandardCharsets.UTF_8, StandardCharsets.UTF_16, StandardCharsets.UTF_16BE, StandardCharsets.UTF_16LE);
    public byte[] f7929a;
    public int f7930b;
    public int f7931c;

    public v() {
        this.f7929a = d0.f7884b;
    }
    ...
    public static int d(Charset charset) {
        boolean contains = f7928f.contains(charset);
    ...
    public final long E() {
        ...
        byte b10;
        int i12;
        long j3 = this.f7929a[this.f7930b];
        int i13 = 7;
        while (true) {
            if (i13 < 0) {
                break;
        ...
        if (i11 != 0) {
            for (i10 = 1; i10 < i11; i10++) {
                if ((this.f7929a[this.f7930b + i10] & 192) == 128) {
                    j3 = (j3 << 6) | (b10 & 63);
                } else {
    ...
    public final void I(int i10) {
        boolean z10;
        if (i10 >= 0 && i10 <= this.f7929a.length) {
            z10 = true;
        } else {
            z10 = false;
        }
    ...
    public final int a() {
        return Math.max(this.f7931c - this.f7930b, 0);
    }

    public final void c(int i10) {
        byte[] bArr = this.f7929a;
        if (i10 > bArr.length) {
            this.f7929a = Arrays.copyOf(bArr, i10);
        }
    }
    ...
    public final int g(Charset charset) {
        ...
        if (a() >= d(charset)) {
            ...
            if (charset.equals(StandardCharsets.US_ASCII)) {
                byte b10 = this.f7929a[this.f7930b];
                if ((b10 & 128) == 0) {
                    i10 = b10 & 255;
                    return (i10 << 8) | i13;
                }
            ...
            if (charset.equals(StandardCharsets.UTF_8)) {
                byte b11 = this.f7929a[this.f7930b];
                if ((b11 & 128) == 0) {
                    i11 = 1;
                } else if ((b11 & 224) == 192 && a() >= 2 && e(this.f7929a[this.f7930b + 1])) {
                    i11 = 2;
                } else if ((this.f7929a[this.f7930b] & 240) == 224 && a() >= 3 && e(this.f7929a[this.f7930b + 1]) && e(this.f7929a[this.f7930b + 2])) {
                    i11 = 3;
                } else if ((this.f7929a[this.f7930b] & 248) == 240 && a() >= 4 && e(this.f7929a[this.f7930b + 1]) && e(this.f7929a[this.f7930b + 2]) && e(this.f7929a[this.f7930b + 3])) {
                    i11 = 4;
                } else {
                    i11 = 0;
                }
                if (i11 != 1) {
                    ...
                    i12 = this.f7929a[this.f7930b] & 255;
                }
                i13 = i11;
                i10 = i12;
            } else {
        ...
        throw new IndexOutOfBoundsException("position=" + this.f7930b + ", limit=" + this.f7931c);
    }

    public final void h(int i10, int i11, byte[] bArr) {
        System.arraycopy(this.f7929a, this.f7930b, bArr, i10, i11);
        this.f7930b += i11;
    }
    ...
    public final char i(Charset charset, char[] cArr) {
        ...
        if (a() >= d(charset) && (g10 = g(charset)) != 0) {
            ...
            if (!Character.isSupplementaryCodePoint(i10)) {
                ...
                for (char c11 : cArr) {
                    if (c11 == c10) {
                        this.f7930b = y7.b(g10 & 255) + this.f7930b;
                        return c10;
                    }
                }
            }
    ...
    public final String k(Charset charset) {
        ...
        while (true) {
            int i12 = this.f7931c;
            if (i11 < i12 - (i10 - 1)) {
                if ((charset.equals(StandardCharsets.UTF_8) || charset.equals(StandardCharsets.US_ASCII)) && d0.M(this.f7929a[i11])) {
                    break;
                }
        ...
        String v = v(i11 - this.f7930b, charset);
        if (this.f7930b != this.f7931c && i(charset, d) == '\r') {
            i(charset, e);
        }
        return v;
    }
    ...
    public final String s() {
        ...
        int i10 = this.f7930b;
        while (i10 < this.f7931c && this.f7929a[i10] != 0) {
            i10++;
        }
        byte[] bArr = this.f7929a;
        int i11 = this.f7930b;
    ...
    public final String t(int i10) {
        ...
        int i12 = this.f7930b;
        int i13 = (i12 + i10) - 1;
        if (i13 < this.f7931c && this.f7929a[i13] == 0) {
            i11 = i10 - 1;
        } else {
            i11 = i10;
        }
    ...
    public final String v(int i10, Charset charset) {
        String str = new String(this.f7929a, this.f7930b, i10, charset);
        this.f7930b += i10;
        return str;
    }
    ...
    public v(int i10) {
        this.f7929a = new byte[i10];
        this.f7931c = i10;
    }

    public v(byte[] bArr) {
        this.f7929a = bArr;
        this.f7931c = bArr.length;
    }
