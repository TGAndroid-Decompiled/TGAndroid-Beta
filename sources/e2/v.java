...
public final class v {
    ...
    public static final char[] f8815e = {'\n'};
    public static final m0 f8816f = m0.u(5, StandardCharsets.US_ASCII, StandardCharsets.UTF_8, StandardCharsets.UTF_16, StandardCharsets.UTF_16BE, StandardCharsets.UTF_16LE);
    public byte[] f8817a;
    public int f8818b;
    public int f8819c;

    public v() {
        this.f8817a = d0.f8766b;
    }
    ...
    public static int d(Charset charset) {
        boolean contains = f8816f.contains(charset);
    ...
    public final long E() {
        ...
        byte b10;
        int i12;
        long j3 = this.f8817a[this.f8818b];
        int i13 = 7;
        while (true) {
            if (i13 < 0) {
                break;
        ...
        if (i11 != 0) {
            for (i10 = 1; i10 < i11; i10++) {
                if ((this.f8817a[this.f8818b + i10] & 192) == 128) {
                    j3 = (j3 << 6) | (b10 & 63);
                } else {
    ...
    public final void I(int i10) {
        boolean z10;
        if (i10 >= 0 && i10 <= this.f8817a.length) {
            z10 = true;
        } else {
            z10 = false;
        }
    ...
    public final int a() {
        return Math.max(this.f8819c - this.f8818b, 0);
    }

    public final void c(int i10) {
        byte[] bArr = this.f8817a;
        if (i10 > bArr.length) {
            this.f8817a = Arrays.copyOf(bArr, i10);
        }
    }
    ...
    public final char f(int i10, ByteOrder byteOrder) {
        ...
        if (byteOrder == ByteOrder.BIG_ENDIAN) {
            byte[] bArr = this.f8817a;
            int i11 = this.f8818b + i10;
            b10 = bArr[i11];
            b11 = bArr[i11 + 1];
        } else {
            byte[] bArr2 = this.f8817a;
            int i12 = this.f8818b + i10;
            b10 = bArr2[i12 + 1];
            b11 = bArr2[i12];
        }
    ...
    public final int g(Charset charset) {
        ...
        if (a() >= d(charset)) {
            ...
            if (charset.equals(StandardCharsets.US_ASCII)) {
                byte b10 = this.f8817a[this.f8818b];
                if ((b10 & 128) == 0) {
                    i10 = b10 & 255;
                    return (i10 << 8) | i13;
                }
            ...
            if (charset.equals(StandardCharsets.UTF_8)) {
                byte b11 = this.f8817a[this.f8818b];
                if ((b11 & 128) == 0) {
                    i11 = 1;
                } else if ((b11 & 224) == 192 && a() >= 2 && e(this.f8817a[this.f8818b + 1])) {
                    i11 = 2;
                } else if ((this.f8817a[this.f8818b] & 240) == 224 && a() >= 3 && e(this.f8817a[this.f8818b + 1]) && e(this.f8817a[this.f8818b + 2])) {
                    i11 = 3;
                } else if ((this.f8817a[this.f8818b] & 248) == 240 && a() >= 4 && e(this.f8817a[this.f8818b + 1]) && e(this.f8817a[this.f8818b + 2]) && e(this.f8817a[this.f8818b + 3])) {
                    i11 = 4;
                } else {
                    i11 = 0;
                }
                if (i11 != 1) {
                    if (i11 != 2) {
                        ...
                        byte[] bArr3 = this.f8817a;
                        int i16 = this.f8818b;
                        i12 = b(0, 0, bArr3[i16], bArr3[i16 + 1]);
                    }
                } else {
                    i12 = this.f8817a[this.f8818b] & 255;
                }
                i13 = i11;
                i10 = i12;
            } else {
        ...
        throw new IndexOutOfBoundsException("position=" + this.f8818b + ", limit=" + this.f8819c);
    }

    public final void h(int i10, int i11, byte[] bArr) {
        System.arraycopy(this.f8817a, this.f8818b, bArr, i10, i11);
        this.f8818b += i11;
    }
    ...
    public final char i(Charset charset, char[] cArr) {
        ...
        if (a() >= d(charset) && (g10 = g(charset)) != 0) {
            ...
            if (!Character.isSupplementaryCodePoint(i10)) {
                ...
                for (char c11 : cArr) {
                    if (c11 == c10) {
                        this.f8818b = x7.b(g10 & 255) + this.f8818b;
                        return c10;
                    }
                }
            }
    ...
    public final String k(Charset charset) {
        ...
        while (true) {
            int i12 = this.f8819c;
            if (i11 < i12 - (i10 - 1)) {
                if ((charset.equals(StandardCharsets.UTF_8) || charset.equals(StandardCharsets.US_ASCII)) && d0.M(this.f8817a[i11])) {
                    break;
                }
        ...
        String v = v(i11 - this.f8818b, charset);
        if (this.f8818b != this.f8819c && i(charset, d) == '\r') {
            i(charset, f8815e);
        }
        return v;
    }
    ...
    public final String s() {
        ...
        int i10 = this.f8818b;
        while (i10 < this.f8819c && this.f8817a[i10] != 0) {
            i10++;
        }
        byte[] bArr = this.f8817a;
        int i11 = this.f8818b;
    ...
    public final String t(int i10) {
        ...
        int i12 = this.f8818b;
        int i13 = (i12 + i10) - 1;
        if (i13 < this.f8819c && this.f8817a[i13] == 0) {
            i11 = i10 - 1;
        } else {
            i11 = i10;
        }
    ...
    public final String v(int i10, Charset charset) {
        String str = new String(this.f8817a, this.f8818b, i10, charset);
        this.f8818b += i10;
        return str;
    }
    ...
    public v(int i10) {
        this.f8817a = new byte[i10];
        this.f8819c = i10;
    }

    public v(byte[] bArr) {
        this.f8817a = bArr;
        this.f8819c = bArr.length;
    }
