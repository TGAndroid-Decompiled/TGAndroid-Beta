...
public abstract class e {
    public static final byte[] f7894a = {0, 0, 0, 1};
    public static final String[] f7895b = {"", "A", "B", "C"};
    public static final Pattern f7896c = Pattern.compile("^\\D?(\\d+)$");

    public static String a(int i10, int i11, int i12, int i13, boolean z10, int[] iArr) {
        char c10;
        String str = f7895b[i10];
