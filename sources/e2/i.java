...
public final class i implements Iterable {
    ...
    public final int i(n2.j jVar) {
        ...
        synchronized (this.f7904a) {
            try {
                if (this.f7905b.containsKey(jVar)) {
                    i10 = ((Integer) this.f7905b.get(jVar)).intValue();
                } else {
                    i10 = 0;
                }
            } catch (Throwable th2) {
    ...
    public final void n(n2.j jVar) {
        synchronized (this.f7904a) {
            try {
                Integer num = (Integer) this.f7905b.get(jVar);
                if (num == null) {
                    return;
                }
