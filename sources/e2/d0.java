...
public abstract class d0 {
    public static final String f7887a;
    public static final byte[] f7888b;
    public static final long[] f7889c;
    public static final Pattern d;
    public static final Pattern e;
    public static final Pattern f7890f;
    public static HashMap f7891g;
    public static final String[] h;
    public static final String[] f7892i;
    public static final int[] f7893j;
    public static final int[] f7894k;
    public static final int[] f7895l;

    static {
        String str = Build.DEVICE;
        String str2 = Build.MANUFACTURER;
        String str3 = Build.MODEL;
        f7887a = str + ", " + str3 + ", " + str2 + ", " + Build.VERSION.SDK_INT;
        f7888b = new byte[0];
        f7889c = new long[0];
        ...
        f7890f = Pattern.compile("(?:.*\\.)?isml?(?:/(manifest(.*))?)?", 2);
    ...
    public static boolean L(Context context) {
        ...
        if (i10 >= 29 && context.getApplicationInfo().targetSdkVersion >= 29) {
            ...
            if (i10 != 34 || !s6.a(Build.MODEL, "sm-x200")) {
                return false;
            }
            return true;
        }
    ...
    public static boolean O(v vVar, v vVar2, Inflater inflater) {
        if (vVar.a() > 0 && (vVar.f7933a[vVar.f7934b] & 255) == 120 && vVar.a() != 0) {
            if (vVar2.f7933a.length < vVar.a()) {
                vVar2.c(vVar.a() * 2);
            }
            if (inflater == null) {
                inflater = new Inflater();
            }
            inflater.setInput(vVar.f7933a, vVar.f7934b, vVar.a());
            int i10 = 0;
            while (true) {
                try {
    ...
    public static String R(String str) {
        ...
        String str4 = (String) f7891g.get(str2);
        if (str4 != null) {
        ...
        if (i11 >= 0 && j3 % 1000000 == 0) {
            ...
            while (i12 < jArr.length) {
                ...
                if (j11 != 0) {
                    ...
                    if (i13 >= 0 && j3 % j11 == 0) {
                        jArr[i12] = q7.b(1000000L, q7.b(j3, j11, RoundingMode.UNNECESSARY), roundingMode);
                    } else if (i13 < 0 && j11 % j3 == 0) {
                        jArr[i12] = q7.d(1000000L, q7.b(j11, j3, RoundingMode.UNNECESSARY));
                    } else {
                        j10 = j3;
    ...
    public static long Y(long j3, long j10, long j11, RoundingMode roundingMode) {
        ...
        if (i10 >= 0 && j11 % j10 == 0) {
            return q7.b(j3, q7.b(j11, j10, RoundingMode.UNNECESSARY), roundingMode);
        }
        if (i10 < 0 && j10 % j11 == 0) {
            return q7.d(j3, q7.b(j10, j11, RoundingMode.UNNECESSARY));
        }
        int i11 = (j11 > j3 ? 1 : (j11 == j3 ? 0 : -1));
        if (i11 >= 0 && j11 % j3 == 0) {
            return q7.b(j10, q7.b(j11, j3, RoundingMode.UNNECESSARY), roundingMode);
        }
        if (i11 < 0 && j3 % j11 == 0) {
            return q7.d(j10, q7.b(j3, j11, RoundingMode.UNNECESSARY));
        }
    ...
    public static int b(c5.a0 a0Var, long j3) {
        ...
        int i13 = i10 + 1;
        if (i13 < a0Var.f3844b && a0Var.f(i13) == j3) {
            return i13;
        }
        if (i10 == -1) {
            return 0;
    ...
    public static i9.c0 d0(i9.w wVar, i9.p pVar) {
        ?? obj = new Object();
        b9 b9Var = new b9(14, obj, wVar);
        i9.q qVar = i9.q.f11053a;
        obj.a(b9Var, qVar);
        wVar.a(new a3.k0(wVar, obj, pVar, 22), qVar);
        return obj;
    }
    ...
    public static int n(int i10, int i11, int i12, byte[] bArr) {
        while (i10 < i11) {
            i12 = f7893j[((i12 >>> 24) ^ (bArr[i10] & 255)) & 255] ^ (i12 << 8);
            i10++;
        }
        return i12;
    }
