...
public abstract class d0 {
    public static final String f7871a;
    public static final byte[] f7872b;
    public static final long[] f7873c;
    public static final Pattern d;
    public static final Pattern e;
    public static final Pattern f7874f;
    public static HashMap f7875g;
    public static final String[] h;
    public static final String[] f7876i;
    public static final int[] f7877j;
    public static final int[] f7878k;
    public static final int[] f7879l;

    static {
        String str = Build.DEVICE;
        String str2 = Build.MANUFACTURER;
        String str3 = Build.MODEL;
        f7871a = str + ", " + str3 + ", " + str2 + ", " + Build.VERSION.SDK_INT;
        f7872b = new byte[0];
        f7873c = new long[0];
        ...
        f7874f = Pattern.compile("(?:.*\\.)?isml?(?:/(manifest(.*))?)?", 2);
        ...
        f7876i = new String[]{"i-lux", "lb", "i-hak", "zh-hak", "i-navajo", "nv", "no-bok", "no-nob", "no-nyn", "no-nno", "zh-guoyu", "zh-cmn", "zh-hakka", "zh-hak", "zh-min-nan", "zh-nan", "zh-xiang", "zh-hsn"};
        ...
        f7878k = new int[]{0, 4129, 8258, 12387, 16516, 20645, 24774, 28903, 33032, 37161, 41290, 45419, 49548, 53677, 57806, 61935};
    ...
    public static boolean O(v vVar, v vVar2, Inflater inflater) {
        if (vVar.a() > 0 && (vVar.f7917a[vVar.f7918b] & 255) == 120 && vVar.a() != 0) {
            if (vVar2.f7917a.length < vVar.a()) {
                vVar2.c(vVar.a() * 2);
            }
            if (inflater == null) {
                inflater = new Inflater();
            }
            inflater.setInput(vVar.f7917a, vVar.f7918b, vVar.a());
            int i10 = 0;
            while (true) {
                try {
    ...
    public static String R(String str) {
        ...
        String str4 = (String) f7875g.get(str2);
        if (str4 != null) {
    ...
    public static int n(int i10, int i11, int i12, byte[] bArr) {
        while (i10 < i11) {
            i12 = f7877j[((i12 >>> 24) ^ (bArr[i10] & 255)) & 255] ^ (i12 << 8);
            i10++;
        }
        return i12;
    }
