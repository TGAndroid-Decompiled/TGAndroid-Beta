...
public abstract class d0 {
    ...
    public static final byte[] f8738b;
    public static final long[] f8739c;
    public static final Pattern d;
    public static final Pattern f8740e;
    public static final Pattern f8741f;
    public static HashMap f8742g;
    public static final String[] h;
    public static final String[] f8743i;
    public static final int[] f8744j;
    public static final int[] f8745k;
    ...
    static {
        ...
        f8737a = str + ", " + str3 + ", " + str2 + ", " + Build.VERSION.SDK_INT;
        f8738b = new byte[0];
        f8739c = new long[0];
        d = Pattern.compile("(\\d\\d\\d\\d)\\-(\\d\\d)\\-(\\d\\d)[Tt](\\d\\d):(\\d\\d):(\\d\\d)([\\.,](\\d+))?([Zz]|((\\+|\\-)(\\d?\\d):?(\\d\\d)))?");
        f8740e = Pattern.compile("^(-)?P(([0-9]*)Y)?(([0-9]*)M)?(([0-9]*)D)?(T(([0-9]*)H)?(([0-9]*)M)?(([0-9.]*)S)?)?$");
        Pattern.compile("%([A-Fa-f0-9]{2})");
        f8741f = Pattern.compile("(?:.*\\.)?isml?(?:/(manifest(.*))?)?", 2);
    ...
    public static boolean O(v vVar, v vVar2, Inflater inflater) {
        if (vVar.a() > 0 && (vVar.f8789a[vVar.f8790b] & 255) == 120 && vVar.a() != 0) {
            if (vVar2.f8789a.length < vVar.a()) {
                vVar2.c(vVar.a() * 2);
            }
            if (inflater == null) {
                inflater = new Inflater();
            }
            inflater.setInput(vVar.f8789a, vVar.f8790b, vVar.a());
            int i10 = 0;
            while (true) {
                try {
    ...
    public static String R(String str) {
        ...
        String str4 = (String) f8742g.get(str2);
        if (str4 != null) {
    ...
    public static int b(c5.b0 b0Var, long j3) {
        ...
        int i13 = i10 + 1;
        if (i13 < b0Var.f4346b && b0Var.f(i13) == j3) {
            return i13;
        }
        if (i10 == -1) {
            return 0;
    ...
    public static i9.c0 d0(i9.w wVar, i9.p pVar) {
        ...
        i9.q qVar = i9.q.f11920a;
        obj.a(b7Var, qVar);
        wVar.a(new j0(wVar, obj, pVar, 22), qVar);
        return obj;
    }
    ...
    public static int n(int i10, int i11, int i12, byte[] bArr) {
        while (i10 < i11) {
            i12 = f8744j[((i12 >>> 24) ^ (bArr[i10] & 255)) & 255] ^ (i12 << 8);
            i10++;
        }
        return i12;
    }
