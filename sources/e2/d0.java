...
public abstract class d0 {
    ...
    public static final byte[] f7871b;
    public static final long[] f7872c;
    public static final Pattern d;
    public static final Pattern e;
    public static final Pattern f7873f;
    public static HashMap f7874g;
    public static final String[] h;
    public static final String[] f7875i;
    public static final int[] f7876j;
    public static final int[] f7877k;
    public static final int[] f7878l;

    static {
        String str = Build.DEVICE;
        String str2 = Build.MANUFACTURER;
        String str3 = Build.MODEL;
        f7870a = str + ", " + str3 + ", " + str2 + ", " + Build.VERSION.SDK_INT;
        f7871b = new byte[0];
        f7872c = new long[0];
        ...
        f7873f = Pattern.compile("(?:.*\\.)?isml?(?:/(manifest(.*))?)?", 2);
    ...
    public static boolean O(v vVar, v vVar2, Inflater inflater) {
        if (vVar.a() > 0 && (vVar.f7916a[vVar.f7917b] & 255) == 120 && vVar.a() != 0) {
            if (vVar2.f7916a.length < vVar.a()) {
                vVar2.c(vVar.a() * 2);
            }
            if (inflater == null) {
                inflater = new Inflater();
            }
            inflater.setInput(vVar.f7916a, vVar.f7917b, vVar.a());
            int i10 = 0;
            while (true) {
                try {
    ...
    public static String R(String str) {
        ...
        String str4 = (String) f7874g.get(str2);
        if (str4 != null) {
    ...
    public static int b(c5.b0 b0Var, long j3) {
        ...
        int i13 = i10 + 1;
        if (i13 < b0Var.f3838b && b0Var.f(i13) == j3) {
            return i13;
        }
        if (i10 == -1) {
            return 0;
    ...
    public static i9.c0 d0(i9.w wVar, i9.p pVar) {
        ?? obj = new Object();
        y8 y8Var = new y8(14, obj, wVar);
        i9.q qVar = i9.q.f11039a;
        obj.a(y8Var, qVar);
    ...
    public static int n(int i10, int i11, int i12, byte[] bArr) {
        while (i10 < i11) {
            i12 = f7876j[((i12 >>> 24) ^ (bArr[i10] & 255)) & 255] ^ (i12 << 8);
            i10++;
        }
        return i12;
    }
