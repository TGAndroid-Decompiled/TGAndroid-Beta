...
public abstract class d0 {
    public static final String f7888a;
    public static final byte[] f7889b;
    public static final long[] f7890c;
    public static final Pattern d;
    public static final Pattern e;
    public static final Pattern f7891f;
    public static HashMap f7892g;
    public static final String[] h;
    public static final String[] f7893i;
    public static final int[] f7894j;
    public static final int[] f7895k;
    public static final int[] f7896l;

    static {
        String str = Build.DEVICE;
        String str2 = Build.MANUFACTURER;
        String str3 = Build.MODEL;
        f7888a = str + ", " + str3 + ", " + str2 + ", " + Build.VERSION.SDK_INT;
        f7889b = new byte[0];
        f7890c = new long[0];
        ...
        f7891f = Pattern.compile("(?:.*\\.)?isml?(?:/(manifest(.*))?)?", 2);
    ...
    public static boolean O(v vVar, v vVar2, Inflater inflater) {
        if (vVar.a() > 0 && (vVar.f7934a[vVar.f7935b] & 255) == 120 && vVar.a() != 0) {
            if (vVar2.f7934a.length < vVar.a()) {
                vVar2.c(vVar.a() * 2);
            }
            if (inflater == null) {
                inflater = new Inflater();
            }
            inflater.setInput(vVar.f7934a, vVar.f7935b, vVar.a());
            int i10 = 0;
            while (true) {
                try {
    ...
    public static String R(String str) {
        ...
        String str4 = (String) f7892g.get(str2);
        if (str4 != null) {
    ...
    public static int b(c5.b0 b0Var, long j3) {
        ...
        int i13 = i10 + 1;
        if (i13 < b0Var.f3847b && b0Var.f(i13) == j3) {
            return i13;
        }
        if (i10 == -1) {
            return 0;
    ...
    public static int n(int i10, int i11, int i12, byte[] bArr) {
        while (i10 < i11) {
            i12 = f7894j[((i12 >>> 24) ^ (bArr[i10] & 255)) & 255] ^ (i12 << 8);
            i10++;
        }
        return i12;
    }
