...
public abstract class d0 {
    public static final String f7883a;
    public static final byte[] f7884b;
    public static final long[] f7885c;
    public static final Pattern d;
    public static final Pattern e;
    public static final Pattern f7886f;
    public static HashMap f7887g;
    public static final String[] h;
    public static final String[] f7888i;
    public static final int[] f7889j;
    public static final int[] f7890k;
    public static final int[] f7891l;

    static {
        String str = Build.DEVICE;
        String str2 = Build.MANUFACTURER;
        String str3 = Build.MODEL;
        f7883a = str + ", " + str3 + ", " + str2 + ", " + Build.VERSION.SDK_INT;
        f7884b = new byte[0];
        f7885c = new long[0];
        ...
        f7886f = Pattern.compile("(?:.*\\.)?isml?(?:/(manifest(.*))?)?", 2);
        ...
        f7888i = new String[]{"i-lux", "lb", "i-hak", "zh-hak", "i-navajo", "nv", "no-bok", "no-nob", "no-nyn", "no-nno", "zh-guoyu", "zh-cmn", "zh-hakka", "zh-hak", "zh-min-nan", "zh-nan", "zh-xiang", "zh-hsn"};
        ...
        f7890k = new int[]{0, 4129, 8258, 12387, 16516, 20645, 24774, 28903, 33032, 37161, 41290, 45419, 49548, 53677, 57806, 61935};
    ...
    public static boolean O(v vVar, v vVar2, Inflater inflater) {
        if (vVar.a() > 0 && (vVar.f7929a[vVar.f7930b] & 255) == 120 && vVar.a() != 0) {
            if (vVar2.f7929a.length < vVar.a()) {
                vVar2.c(vVar.a() * 2);
            }
            if (inflater == null) {
                inflater = new Inflater();
            }
            inflater.setInput(vVar.f7929a, vVar.f7930b, vVar.a());
            int i10 = 0;
            while (true) {
                try {
    ...
    public static String R(String str) {
        ...
        String str4 = (String) f7887g.get(str2);
        if (str4 != null) {
    ...
    public static int b(c5.b0 b0Var, long j3) {
        ...
        int i13 = i10 + 1;
        if (i13 < b0Var.f3841b && b0Var.f(i13) == j3) {
            return i13;
        }
        if (i10 == -1) {
            return 0;
    ...
    public static int n(int i10, int i11, int i12, byte[] bArr) {
        while (i10 < i11) {
            i12 = f7889j[((i12 >>> 24) ^ (bArr[i10] & 255)) & 255] ^ (i12 << 8);
            i10++;
        }
        return i12;
    }
