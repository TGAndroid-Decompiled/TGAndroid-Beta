...
public abstract class d0 {
    ...
    public static final byte[] f7189b;
    public static final long[] f7190c;
    public static final Pattern d;
    public static final Pattern e;
    public static final Pattern f7191f;
    public static HashMap f7192g;
    public static final String[] h;
    public static final String[] f7193i;
    public static final int[] f7194j;
    public static final int[] f7195k;
    public static final int[] f7196l;

    static {
        String str = Build.DEVICE;
        String str2 = Build.MANUFACTURER;
        String str3 = Build.MODEL;
        f7188a = str + ", " + str3 + ", " + str2 + ", " + Build.VERSION.SDK_INT;
        f7189b = new byte[0];
        f7190c = new long[0];
        ...
        f7191f = Pattern.compile("(?:.*\\.)?isml?(?:/(manifest(.*))?)?", 2);
    ...
    public static boolean O(v vVar, v vVar2, Inflater inflater) {
        if (vVar.a() > 0 && (vVar.f7234a[vVar.f7235b] & 255) == 120 && vVar.a() != 0) {
            if (vVar2.f7234a.length < vVar.a()) {
                vVar2.c(vVar.a() * 2);
            }
            if (inflater == null) {
                inflater = new Inflater();
            }
            inflater.setInput(vVar.f7234a, vVar.f7235b, vVar.a());
            int i10 = 0;
            while (true) {
                try {
    ...
    public static String R(String str) {
        ...
        String str4 = (String) f7192g.get(str2);
        if (str4 != null) {
    ...
    public static int b(c5.b0 b0Var, long j3) {
        ...
        int i13 = i10 + 1;
        if (i13 < b0Var.f4260b && b0Var.f(i13) == j3) {
            return i13;
        }
        if (i10 == -1) {
            return 0;
    ...
    public static i9.c0 d0(i9.w wVar, i9.p pVar) {
        ?? obj = new Object();
        af afVar = new af(23, obj, wVar);
        i9.q qVar = i9.q.f10533a;
        obj.a(afVar, qVar);
        wVar.a(new k0(wVar, obj, pVar, 19), qVar);
        return obj;
    }
    ...
    public static int n(int i10, int i11, int i12, byte[] bArr) {
        while (i10 < i11) {
            i12 = f7194j[((i12 >>> 24) ^ (bArr[i10] & 255)) & 255] ^ (i12 << 8);
            i10++;
        }
        return i12;
    }
