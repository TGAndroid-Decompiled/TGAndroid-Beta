...
public abstract class a {
    public static ExecutorService f7867a;
        ...
        synchronized (a.class) {
            try {
                if (f7867a == null) {
                    ...
                    f7867a = Executors.newSingleThreadExecutor(new androidx.emoji2.text.a("ExoPlayer:BackgroundExecutor", 1));
                }
                executorService = f7867a;
            } catch (Throwable th2) {
                throw th2;
            }
        }
