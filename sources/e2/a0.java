...
public final class a0 {
    public int f7873a;
    public int f7874b;
    public Object f7875c = new long[10];
    ...
    public void e(Typeface typeface) {
        ...
        if (w0Var.f14576m) {
            w0Var.f14575l = typeface;
            TextView textView = (TextView) weakReference.get();
            if (textView != null) {
                WeakHashMap weakHashMap = i0.f42163a;
                if (textView.isAttachedToWindow()) {
                    textView.post(new androidx.activity.g(textView, typeface, w0Var.f14573j, 5));
                } else {
                    textView.setTypeface(typeface, w0Var.f14573j);
                }
            }
        }
    }
