...
public final class b implements g, c2, MessagesController.ErrorDelegate, MessagesStorage.LongCallback {
    ...
    public void i(d2 d2Var, int i10) {
        ...
        switch (this.f16505a) {
            case 1:
                xn xnVar = (xn) this.f16507c;
                boolean z4 = this.f16506b;
                ...
                xnVar.E5 = null;
                xnVar.Ya((CharSequence) this.e, z4);
                return;
            case 2:
                boolean z10 = this.f16506b;
                Context context = (Context) this.f16507c;
            ...
            case 3:
                ...
                return;
            default:
                boolean z12 = this.f16506b;
                u0 u0Var = (u0) this.f16507c;
    ...
    public boolean run(TLRPC.TL_error tL_error) {
        return ProfileActivity.Z((ProfileActivity) this.f16507c, (boolean[]) this.d, this.f16506b, (p2) this.e, tL_error);
    }
