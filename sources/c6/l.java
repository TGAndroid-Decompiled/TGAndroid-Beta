...
public final class l extends o6.a {
    ...
    public final JSONObject d() {
        ...
        try {
            jSONObject.put("metadataType", this.f4008c);
        } catch (JSONException unused) {
        }
        JSONArray b10 = h6.a.b(this.f4006a);
        if (b10.length() != 0) {
            try {
    ...
    public final void e(JSONObject jSONObject) {
        HashSet hashSet;
        int i10;
        Bundle bundle = this.f4007b;
        bundle.clear();
        List list = this.f4006a;
        list.clear();
        this.f4008c = 0;
        try {
            this.f4008c = jSONObject.getInt("metadataType");
        } catch (JSONException unused) {
        }
    ...
    public final boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof l) {
                l lVar = (l) obj;
                if (f(this.f4007b, lVar.f4007b) && this.f4006a.equals(lVar.f4006a)) {
                    return true;
                }
                return false;
            }
    ...
    public final int hashCode() {
        ...
        return this.f4006a.hashCode() + (i11 * 31);
    }

    @Override
    public final void writeToParcel(Parcel parcel, int i10) {
        int q6 = w7.f0.q(parcel, 20293);
        w7.f0.p(parcel, 2, this.f4006a);
        w7.f0.b(parcel, 3, this.f4007b);
        int i11 = this.f4008c;
        w7.f0.s(parcel, 4, 4);
        parcel.writeInt(i11);
        w7.f0.r(parcel, q6);
