...
public final class d0 extends g6.g {
    ...
    public final void P(int i10) {
        e0.k(this.f3973b).post(new c0(this, i10, 0));
    }

    @Override
    public final void T(String str, String str2) {
        e0.G.b("Receive (type=text, ns=%s) %s", str, str2);
        e0.k(this.f3973b).post(new c5.v(this, str, str2, 3));
    }
    ...
    public final void u0(g6.d dVar) {
        e0.k(this.f3973b).post(new i9.s(7, this, dVar));
    }

    @Override
    public final void w0(int i10) {
        e0.k(this.f3973b).post(new c0(this, i10, 3));
    }

    @Override
    public final void z0(g6.c cVar) {
        e0.k(this.f3973b).post(new i9.s(8, this, cVar));
    }
