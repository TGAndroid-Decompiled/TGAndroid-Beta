...
public final class a implements Comparable {
    public static final long f46979b;
    public static final long f46980c;
    public static final int d = 0;
    public final long f46981a;

    static {
        int i10 = b.f46982a;
        f46979b = Long.MAX_VALUE;
        f46980c = -9223372036854775805L;
    }
    ...
    public static final long c(long j3, c unit) {
        ...
        long j10 = j3 >> 1;
        if ((((int) j3) & 1) == 0) {
            sourceUnit = c.f46983b;
        } else {
            sourceUnit = c.f46984c;
        }
        i.e(sourceUnit, "sourceUnit");
        return unit.f46987a.convert(j10, sourceUnit.f46987a);
    }

    @Override
    public final int compareTo(Object obj) {
        long j3 = ((a) obj).f46981a;
