...
public final class n {
    ...
    public static final AtomicLongFieldUpdater f8174f = AtomicLongFieldUpdater.newUpdater(n.class, "_state$volatile");
    public static final v f8175g = new v("REMOVE_FROZEN", 0);
    ...
    public final int a(Object obj) {
        while (true) {
            AtomicLongFieldUpdater atomicLongFieldUpdater = f8174f;
            ...
            if (((i11 + 2) & i12) != (i10 & i12)) {
                ...
                if (!z10 && atomicReferenceArray.get(i11 & i12) != null) {
                    ...
                    if (f8174f.compareAndSet(this, j3, ((-1152921503533105153L) & j3) | (((i11 + 1) & 1073741823) << 30))) {
                        ...
                        while ((atomicLongFieldUpdater.get(nVar) & 1152921504606846976L) != 0) {
                            ...
                            int i14 = nVar.f8178c & i11;
                            Object obj2 = atomicReferenceArray2.get(i14);
                            if ((obj2 instanceof m) && ((m) obj2).f8173a == i11) {
    ...
    public final n c() {
        ...
        while (true) {
            ...
            n nVar3 = new n(nVar.f8176a * 2, nVar.f8177b);
            int i10 = (int) (1073741823 & j3);
            int i11 = (int) ((1152921503533105152L & j3) >> 30);
            while (true) {
                int i12 = nVar.f8178c;
                ...
                nVar3.d.set(nVar3.f8178c & i10, obj);
                i10++;
            }
    ...
    public final Object d() {
        ...
        while (true) {
            ...
            if (obj == null) {
                ...
                if (f8174f.compareAndSet(nVar, j3, (j3 & (-1073741824)) | j10)) {
                ...
                if (z10) {
                    while (true) {
                        ...
                        if ((j11 & 1152921504606846976L) != 0) {
                            ...
                            n nVar2 = nVar;
                            if (f8174f.compareAndSet(nVar2, j11, (j11 & (-1073741824)) | j10)) {
                                nVar2.d.set(i14 & nVar2.f8178c, null);
                                nVar = null;
                            } else {
                                nVar = nVar2;
                            }
