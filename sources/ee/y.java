...
import zd.u0;
public class y {
    public static final AtomicIntegerFieldUpdater f8189b = AtomicIntegerFieldUpdater.newUpdater(y.class, "_size$volatile");
    private volatile int _size$volatile;
    public t0[] f8190a;

    public final void a(t0 t0Var) {
        t0Var.e((u0) this);
        t0[] t0VarArr = this.f8190a;
        AtomicIntegerFieldUpdater atomicIntegerFieldUpdater = f8189b;
        if (t0VarArr == null) {
            t0VarArr = new t0[4];
            this.f8190a = t0VarArr;
