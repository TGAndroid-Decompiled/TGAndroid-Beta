...
import zd.u0;
public class y {
    public static final AtomicIntegerFieldUpdater f8205b = AtomicIntegerFieldUpdater.newUpdater(y.class, "_size$volatile");
    private volatile int _size$volatile;
    public t0[] f8206a;

    public final void a(t0 t0Var) {
        t0Var.e((u0) this);
        t0[] t0VarArr = this.f8206a;
        AtomicIntegerFieldUpdater atomicIntegerFieldUpdater = f8205b;
        if (t0VarArr == null) {
            t0VarArr = new t0[4];
            this.f8206a = t0VarArr;
