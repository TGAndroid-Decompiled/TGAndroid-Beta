...
import zd.u0;
public class y {
    public static final AtomicIntegerFieldUpdater f7506b = AtomicIntegerFieldUpdater.newUpdater(y.class, "_size$volatile");
    private volatile int _size$volatile;
    public t0[] f7507a;

    public final void a(t0 t0Var) {
        t0Var.e((u0) this);
        t0[] t0VarArr = this.f7507a;
        AtomicIntegerFieldUpdater atomicIntegerFieldUpdater = f7506b;
        if (t0VarArr == null) {
            t0VarArr = new t0[4];
            this.f7507a = t0VarArr;
    ...
    public final zd.t0 d(int r9) {
        throw new UnsupportedOperationException("Method not decompiled: ee.y.d(int):zd.t0");
    }
