...
public class l {
    public static final AtomicReferenceFieldUpdater f8187a = AtomicReferenceFieldUpdater.newUpdater(l.class, Object.class, "_cur$volatile");
    private volatile Object _cur$volatile = new n(8, false);

    public final boolean a(Runnable runnable) {
        while (true) {
            AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = f8187a;
    ...
    public final int c() {
        n nVar = (n) f8187a.get(this);
        nVar.getClass();
        long j3 = n.f8189f.get(nVar);
