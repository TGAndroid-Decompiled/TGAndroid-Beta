...
public class l {
    public static final AtomicReferenceFieldUpdater f9082a = AtomicReferenceFieldUpdater.newUpdater(l.class, Object.class, "_cur$volatile");
    private volatile Object _cur$volatile = new n(8, false);

    public final boolean a(Runnable runnable) {
        while (true) {
            AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = f9082a;
    ...
    public final int c() {
        n nVar = (n) f9082a.get(this);
        nVar.getClass();
        long j3 = n.f9085f.get(nVar);
