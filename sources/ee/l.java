...
public class l {
    public static final AtomicReferenceFieldUpdater f8185a = AtomicReferenceFieldUpdater.newUpdater(l.class, Object.class, "_cur$volatile");
    ...
    public final int c() {
        n nVar = (n) f8185a.get(this);
        nVar.getClass();
        long j3 = n.f8187f.get(nVar);
