...
public class l {
    public static final AtomicReferenceFieldUpdater f8172a = AtomicReferenceFieldUpdater.newUpdater(l.class, Object.class, "_cur$volatile");
    ...
    public final int c() {
        n nVar = (n) f8172a.get(this);
        nVar.getClass();
        long j3 = n.f8174f.get(nVar);
