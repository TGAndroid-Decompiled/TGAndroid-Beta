...
public class l {
    public static final AtomicReferenceFieldUpdater f7490a = AtomicReferenceFieldUpdater.newUpdater(l.class, Object.class, "_cur$volatile");
    private volatile Object _cur$volatile = new n(8, false);

    public final boolean a(Runnable runnable) {
        while (true) {
            AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = f7490a;
    ...
    public final int c() {
        n nVar = (n) f7490a.get(this);
        nVar.getClass();
        long j3 = n.f7492f.get(nVar);
