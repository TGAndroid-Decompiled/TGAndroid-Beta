...
public abstract class a {
    public static final v f8166a = new v("NO_DECISION", 0);
    public static final v f8167b = new v("CLOSED", 0);
    public static final v f8168c = new v("UNDEFINED", 0);
    public static final v d = new v("REUSABLE_CLAIMED", 0);
    public static final v e = new v("CONDITION_FALSE", 0);
    public static final v f8169f = new v("NO_THREAD_ELEMENTS", 0);

    public static final Object a(t tVar, long j3, rd.p pVar) {
        while (true) {
            if (tVar.f8194c >= j3 && !tVar.d()) {
                return tVar;
            }
            AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = d.f8172a;
            ...
            t tVar2 = (t) ((d) obj);
            if (tVar2 == null) {
                tVar2 = (t) pVar.invoke(Long.valueOf(tVar.f8194c + 1), tVar);
    ...
    public static final void f(id.h hVar, Object obj) {
        if (obj != f8169f) {
            if (obj instanceof z) {
                ...
                Object obj2 = zVar.f8203a[length];
                throw null;
            }
    ...
    public static final void g(Object obj, id.c cVar) {
        ...
        if (cVar instanceof h) {
            ...
            a10.h(true);
            try {
                f1 f1Var = (f1) cVar2.getContext().get(b0.f48869b);
