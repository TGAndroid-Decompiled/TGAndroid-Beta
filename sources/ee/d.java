...
public abstract class d {
    public static final AtomicReferenceFieldUpdater f9095a = AtomicReferenceFieldUpdater.newUpdater(d.class, Object.class, "_next$volatile");
    public static final AtomicReferenceFieldUpdater f9096b = AtomicReferenceFieldUpdater.newUpdater(d.class, Object.class, "_prev$volatile");
    ...
    public final void b() {
        f9096b.set(this, null);
    }

    public final d c() {
        Object obj = f9095a.get(this);
        if (obj == a.f9089b) {
            return null;
        }
        return (d) obj;
