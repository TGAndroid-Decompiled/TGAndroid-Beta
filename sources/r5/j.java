...
public final class j extends a7.c {
    public final int f43372b = 0;
    public final Object f43373c;
        ...
        switch (i12) {
            ...
            case 1:
                ...
                switch (i10) {
                    ...
                    case 3:
                        ...
                        return true;
                    case 4:
                        int i13 = com.google.android.gms.internal.cast.t.f3163a;
                        if (parcel.readInt() != 0) {
                            i11 = 1;
                        } else {
                            i11 = 0;
                        ...
                        if (qVar != null) {
                            try {
                                ...
                                c.f43354m.a(e, "Unable to call %s on %s.", "disconnectFromDevice", q.class.getSimpleName());
                            }
                            cVar.d(0);
                        }
                        parcel2.writeNoException();
                    ...
                    case 5:
                        ...
                        s5.h hVar = cVar2.f43359j;
                        if (hVar == null) {
                            g10 = 0;
                        } else {
                            g10 = hVar.g() - cVar2.f43359j.a();
                        }
                        parcel2.writeNoException();
                    ...
                    case 7:
                        com.google.android.gms.internal.cast.t.b(parcel);
                        ((c) fVar).f43360k = CastDevice.e((Bundle) com.google.android.gms.internal.cast.t.a(parcel, Bundle.CREATOR));
                        parcel2.writeNoException();
                        return true;
                    case 8:
                        com.google.android.gms.internal.cast.t.b(parcel);
                    ...
                    case 9:
                        ...
                        if (e6 != null) {
                            String str2 = e6.d;
                            if (!e6.equals(cVar3.f43360k)) {
                                if (!TextUtils.isEmpty(str2) && ((castDevice2 = cVar3.f43360k) == null || !TextUtils.equals(castDevice2.d, str2))) {
                                    z4 = true;
                                } else {
                                    z4 = false;
                                }
                                cVar3.f43360k = e6;
                                u5.b bVar3 = c.f43354m;
                                if (true != z4) {
                                    str = "unchanged";
                                } else {
                                    str = "changed";
                                ...
                                if (z4 && (castDevice = cVar3.f43360k) != null) {
                                    t5.h hVar2 = cVar3.h;
                                    if (hVar2 != null) {
                                        u5.b bVar4 = t5.h.v;
                                        Log.i(bVar4.f45098a, bVar4.d("update Cast device to %s", castDevice));
                                        hVar2.f44607o = castDevice;
                                        hVar2.b();
                                    }
            ...
            case 2:
                ...
                if (i10 != 1) {
                    ...
                    boolean z10 = bVar5.e;
                    parcel2.writeNoException();
                    int i14 = com.google.android.gms.internal.cast.t.f3163a;
                    parcel2.writeInt(z10 ? 1 : 0);
                    return true;
                }
                String readString = parcel.readString();
                com.google.android.gms.internal.cast.t.b(parcel);
                l6.a f10 = new c(eVar.f3036a, eVar.f3037b, readString, eVar.d, eVar.e, new t5.h(eVar.f3036a, bVar5, eVar.e)).f();
                parcel2.writeNoException();
            ...
            case 3:
                ...
                com.google.android.gms.internal.cast.t.b(parcel);
                q5.e0 e0Var3 = cVar4.f43358i;
                if (e0Var3 != null && e0Var3.F == 2) {
                    com.google.android.gms.common.api.internal.v e12 = com.google.android.gms.common.api.internal.w.e();
                    e12.f2885c = new q5.b0(e0Var3, readString4, readString5, 0);
                    e12.f2883a = 8407;
                    e0Var3.e(1, e12.e()).addOnCompleteListener(new f1(this, 16));
                }
                parcel2.writeNoException();
                return true;
            default:
