...
public final class d implements t5.b, f, pa.a, b2, bl0, uh.a, Continuation, m, yf.m, n, BillingController.ProductDetailsResponseListenerLegacy, b5, le.d, Utilities.Callback5, xo0, i5.e {
    ...
    public void D(int i10, float f7, float f10, le.e eVar) {
        View view = ((c4) this.f42076b).f47065b;
    ...
    public void J(int i10, int i11, boolean z10) {
        e0 e0Var = (e0) this.f42076b;
        if (z10) {
            long j3 = i10;
            if (e0Var.I != j3) {
                e0Var.I = j3;
                e0Var.f47123r.setText(e0.o(j3));
            }
            e0Var.n(true);
        }
    }
    ...
    public void a(int i10) {
        switch (this.f42075a) {
            case 24:
                Utilities.Callback2 callback2 = (Utilities.Callback2) this.f42076b;
                if (i10 == 1) {
    ...
    public void c(float f7, float f10, int i10, View view) {
        tg.a1.Q((tg.a1) this.f42076b, view);
    }
    ...
    public void f(c2 c2Var, int i10) {
        switch (this.f42075a) {
            case 5:
                ...
                return;
            case 6:
                TLRPC.TL_payments_giveawayInfoResults tL_payments_giveawayInfoResults = (TLRPC.TL_payments_giveawayInfoResults) this.f42076b;
            ...
            case 15:
                ...
                return;
            default:
                ((Utilities.Callback) this.f42076b).run(c2Var.g(i10, true, true));
                return;
        }
    }
    ...
    public boolean h(j jVar, int i10, Bundle bundle) {
        r0.d dVar;
        s sVar = (s) this.f42076b;
        int i11 = Build.VERSION.SDK_INT;
        if (i11 >= 25 && (i10 & 1) != 0) {
            try {
                jVar.f43028a.d();
                Parcelable parcelable = (Parcelable) jVar.f43028a.l();
                if (bundle == null) {
                    bundle = new Bundle();
                } else {
    ...
    public Object i() {
        ...
        switch (this.f42075a) {
            case 0:
                g gVar = (g) ((s5.d) this.f42076b);
                long q6 = gVar.f42882b.q() - gVar.d.d;
                a2 = gVar.a();
                a2.beginTransaction();
                try {
            ...
            case 1:
                g gVar2 = (g) ((s5.c) ((da.b) this.f42076b).f7586i);
                a2 = gVar2.a();
                a2.beginTransaction();
                try {
                    a2.compileStatement("DELETE FROM log_event_dropped").execute();
                    a2.compileStatement("UPDATE global_log_event_state SET last_metrics_upload_ms=" + gVar2.f42882b.q()).execute();
                    a2.setTransactionSuccessful();
                    a2.endTransaction();
                    return null;
                } finally {
    ...
    public void j(pa.b bVar) {
        t9.a aVar = (t9.a) this.f42076b;
        if (Log.isLoggable("FirebaseCrashlytics", 3)) {
            Log.d("FirebaseCrashlytics", "Crashlytics native component now available.", null);
        }
        aVar.f43077b.set((t9.a) bVar.get());
    }

    @Override
    public void onProductDetailsResponse(h hVar, List list) {
        int i10;
        q1 q1Var = (q1) this.f42076b;
        ArrayList arrayList = q1Var.f46116n0;
    ...
    public void mo17run(Object obj, Object obj2, Object obj3, Object obj4, Object obj5) {
        switch (this.f42075a) {
            case 23:
                v5.b((v5) this.f42076b, (ArrayList) obj, (Integer) obj2, (Long) obj3, (ArrayList) obj4, (ArrayList) obj5);
                return;
            default:
                v7 v7Var = (v7) this.f42076b;
                j51 j51Var = (j51) obj;
                View view = (View) obj2;
                ...
                if (j51Var.G instanceof TL_stars.StarsTransaction) {
                    y7.h1(v7Var.getContext(), false, 0L, v7Var.f47949c, (TL_stars.StarsTransaction) j51Var.G, v7Var.f47948b);
                    return;
                }
                return;
        }
    ...
    public Object then(Task task) {
        ((CountDownLatch) this.f42076b).countDown();
        return null;
    }
