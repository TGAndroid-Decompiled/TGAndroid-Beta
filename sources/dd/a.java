...
public final class a {
    public final char[] f6415a;
    public final StringReader f6416b;
    public int f6417c;
    public int d;
    public int e;
    public int f6418f;
    ...
    public a(String str) {
        ...
        if (stringReader.markSupported()) {
            this.f6416b = stringReader;
            this.f6415a = new char[4096];
            b();
            return;
        }
    ...
    public final void b() {
        StringReader stringReader = this.f6416b;
        int i10 = this.e;
        if (i10 >= this.d) {
            try {
                stringReader.skip(i10);
                stringReader.mark(4096);
                int read = stringReader.read(this.f6415a);
                stringReader.reset();
                if (read != -1) {
                    this.f6417c = read;
                    this.f6418f += this.e;
    ...
    public final String f(char c10) {
        ...
        b();
        int i13 = this.e;
        String c12 = c(cArr, strArr, i13, this.f6417c - i13);
        this.e = this.f6417c;
        return c12;
    }
    ...
    public final char i() {
        ...
        return this.f6415a[i10];
    }

    public final boolean j() {
        b();
        if (this.e >= this.f6417c) {
            return true;
        }
        return false;
    }
    ...
    public final boolean k(String str) {
        ...
        if (length <= this.f6417c - this.e) {
            for (int i10 = 0; i10 < length; i10++) {
                if (str.charAt(i10) == this.f6415a[this.e + i10]) {
                }
            }
    ...
    public final boolean l(String str) {
        ...
        if (length <= this.f6417c - this.e) {
            for (int i10 = 0; i10 < length; i10++) {
                if (Character.toUpperCase(str.charAt(i10)) == Character.toUpperCase(this.f6415a[this.e + i10])) {
                }
            }
            this.e = str.length() + this.e;
            return true;
    ...
    public final int p(String str) {
        ...
        int i10 = this.e;
        while (i10 < this.f6417c) {
            char[] cArr = this.f6415a;
            if (charAt != cArr[i10]) {
                do {
                    i10++;
                    if (i10 >= this.f6417c) {
    ...
    public final String toString() {
        int i10 = this.e;
        return new String(this.f6415a, i10, this.f6417c - i10);
    }
}
