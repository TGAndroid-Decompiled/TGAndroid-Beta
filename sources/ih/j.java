...
public final class j extends Drawable implements Animator.AnimatorListener {
    ...
    public static final int[] f8156a0 = new int[2];
    public static final g f8157b0 = new g("openFactor", 0);
    public static final g f8158c0 = new g("openFactor", 1);
    ...
    public final gf.c f8160b;
    public final LinearGradient f8163f;
    public final d[] f8167w;
    public final Drawable f8168x;
    public final t1 f8169y;
    public final Paint f8161c = new Paint(1);
    public final Matrix d = new Matrix();
    public final Path f8162e = new Path();
    public final RectF h = new RectF();
    public final RectF f8164n = new RectF();
    public final RectF f8165r = new RectF();
    public final RectF f8166s = new RectF();
    ...
    public int O = -1;
    public final ObjectAnimator W = ObjectAnimator.ofFloat(this, f8157b0, 1.0f).setDuration(560L);
    public final ObjectAnimator X = ObjectAnimator.ofFloat(this, f8158c0, 1.0f).setDuration(240L);
    ...
    public j(k kVar, t1 t1Var, ArrayList arrayList, gf.c cVar) {
        ...
        this.f8167w = new d[Math.min(5, arrayList.size())];
        int i10 = 0;
        while (true) {
            d[] dVarArr = this.f8167w;
            if (i10 < dVarArr.length) {
                ...
                int v02 = k6.v0(k6.G8, this.f8169y.getResourcesProvider());
                ...
                this.f8163f = linearGradient;
                this.f8161c.setShader(linearGradient);
                ObjectAnimator objectAnimator = this.W;
                LinearInterpolator linearInterpolator = h.f8137b;
    ...
    public final void d() {
        ...
        Bitmap bitmap2;
        Bitmap bitmap3;
        this.f8169y.setHideSideButtonByQuickShare(false);
        if (!this.Q) {
            this.Q = true;
            ...
            b bVar = this.M;
            if (bVar != null && (bitmap3 = bVar.f8108c) != null) {
                bitmap3.recycle();
                bVar.f8108c = null;
            }
            for (d dVar : this.f8167w) {
                b bVar2 = dVar.f8119f;
                if (bVar2 != null && (bitmap2 = bVar2.f8108c) != null) {
                    bitmap2.recycle();
                    bVar2.f8108c = null;
                }
                b bVar3 = dVar.f8118e;
                if (bVar3 != null && (bitmap = bVar3.f8108c) != null) {
                    bitmap.recycle();
                    bVar3.f8108c = null;
                }
            }
    ...
    public final void e(Canvas canvas, boolean z4, int i10) {
        ...
        b bVar = jVar.M;
        d[] dVarArr = jVar.f8167w;
        int i19 = 2;
        RectF rectF2 = jVar.f8165r;
        if (bVar != null && !z4) {
            bVar.setBounds((int) rectF2.left, (int) (rectF2.top - AndroidUtilities.dp(30.0f)), (int) rectF2.right, (int) rectF2.bottom);
            jVar.M.f8112i = (int) ((1.0f - h.f8138c.getInterpolation(jVar.E)) * 255.0f);
            jVar.M.draw(canvas);
            if (jVar.O != -1) {
                float interpolation = 1.0f - h.f8139e.getInterpolation(jVar.E);
                        ...
                        public final void p(Canvas canvas3, int i21) {
                            ...
                            switch (r2) {
                                case 0:
                                    ...
                                    dVar2.getClass();
                                    canvas3.save();
                                    canvas3.translate(-dVar2.f8121i, -dVar2.f8122j);
                                    float f24 = dVar2.f8121i;
                                    float f25 = dVar2.f8122j;
                                    ...
                                    t1 t1Var2 = dVar2.f8116b;
                                    boolean R2 = t1Var2.R2();
                                    Paint paint = dVar2.f8120g;
                                    if (paint != null) {
                ...
                b bVar3 = dVar.f8118e;
                bVar3.f8112i = (int) (interpolation * 255.0f);
                bVar3.draw(canvas);
                canvas.restore();
                return;
            }
        ...
        float f23 = f10;
        float g13 = g(0.3f, 0.075f, h.f8144k.getInterpolation(jVar.D));
        Matrix matrix = jVar.d;
        matrix.reset();
        matrix.setScale(g13, g13);
        matrix.postTranslate(0.0f, rectF2.bottom);
        jVar.f8163f.setLocalMatrix(matrix);
        Paint paint = jVar.f8161c;
        paint.setAlpha((int) (h.f8143j.getInterpolation(jVar.D) * 255.0f * f23));
        RectF rectF3 = Y;
        rectF3.set(rectF2);
        rectF3.inset(-AndroidUtilities.dp(8.0f), -AndroidUtilities.dp(8.0f));
        Rect rect = Z;
        rectF3.round(rect);
        Drawable drawable = jVar.f8168x;
        drawable.setAlpha((int) (f23 * 255.0f));
        drawable.setBounds(rect);
        drawable.draw(canvas);
        boolean z12 = jVar.J;
        RectF rectF4 = jVar.f8164n;
        if (!z12) {
            canvas.save();
            canvas.translate(rectF4.left, rectF4.top);
            canvas.rotate((h.f8140f.getInterpolation(jVar.D) - h.f8141g.getInterpolation(jVar.D)) * (-40.0f), AndroidUtilities.dp(16.0f), AndroidUtilities.dp(16.0f));
            canvas.translate(-t1Var.getSideButtonStartX(), -t1Var.getSideButtonStartY());
            t1Var.k2(canvas, true);
            canvas.restore();
        }
        if (jVar.N && !jVar.J) {
            canvas.drawPath(jVar.f8162e, paint);
        } else {
        ...
        float interpolation3 = h.f8153t.getInterpolation(jVar.D) * AndroidUtilities.dp(2.0f);
        float f24 = i.f8154a + 2;
        float interpolation4 = ((h.f8150q.getInterpolation(jVar.D) * AndroidUtilities.dp(f24)) / 2.0f) - interpolation3;
        float interpolation5 = ((h.f8151r.getInterpolation(jVar.D) * AndroidUtilities.dp(f24)) / 2.0f) - interpolation3;
        float interpolation6 = ((h.f8152s.getInterpolation(jVar.D) * AndroidUtilities.dp(f24)) / 2.0f) - interpolation3;
        int i21 = 0;
        while (i21 < i19) {
            int i22 = 0;
            while (i22 < dVarArr.length) {
                if ((i21 == 0 && i22 == jVar.O) || (i21 == i14 && i22 != jVar.O)) {
                    ...
                    float dp4 = (AndroidUtilities.dp(i.f8154a + 11) * length) + rectF2.centerX();
                    ...
                    if (!z10) {
                        ...
                        i12 = i22;
                        f12 = dp4;
                        dVar2.a(canvas2, f12, centerY2, f11 + (AndroidUtilities.dp(2.0f) * dVar2.f8127o), f23);
                    } else {
                        canvas2 = canvas;
                        i12 = i22;
                        f12 = dp4;
                    }
                    float f28 = dVar2.f8127o;
                    if (f28 > 0.0f && dVar2.h != null) {
                        float f29 = (f28 * 0.15f) + 0.85f;
                        canvas2.save();
                        canvas2.scale(f29, f29, f12, centerY2);
                        float f30 = dVar2.f8127o * f23;
                        i13 = i12;
                        float D = y3.D(8, 2, dVar2.h.getWidth());
                        dVar2.f8121i = d.b(d.b(f12, D, f26, f27), D, dp5, measuredWidth) - (D / 2.0f);
                        dVar2.f8122j = centerY2 - AndroidUtilities.dp(58.0f);
                        if (dVar2.f8119f == null) {
                            j jVar2 = dVar2.f8115a;
                            if (!jVar2.Q) {
                                dVar2.f8120g = jVar2.I;
                                b bVar4 = new b(new a() {
                                    @Override
                                    public final void p(Canvas canvas3, int i212) {
                                        ...
                                        switch (r2) {
                                            case 0:
                                                ...
                                                dVar22.getClass();
                                                canvas3.save();
                                                canvas3.translate(-dVar22.f8121i, -dVar22.f8122j);
                                                float f242 = dVar22.f8121i;
                                                float f252 = dVar22.f8122j;
                                                ...
                                                t1 t1Var2 = dVar22.f8116b;
                                                boolean R2 = t1Var2.R2();
                                                Paint paint2 = dVar22.f8120g;
                                                if (paint2 != null) {
                        ...
                        b bVar5 = dVar2.f8119f;
                        if (bVar5 != null) {
                            float f31 = dVar2.f8121i;
                            float f32 = dVar2.f8122j;
                            bVar5.setBounds((int) f31, (int) f32, (int) (f31 + D), (int) (f32 + AndroidUtilities.dp(21.0f)));
                            b bVar6 = dVar2.f8119f;
                            bVar6.f8112i = (int) (f30 * 255.0f);
                            bVar6.draw(canvas2);
                        }
                        canvas2.restore();
                    } else {
    ...
    public final int h() {
        return AndroidUtilities.dp(((i.f8154a + 11) * this.f8167w.length) + 7);
    }

    @Override
    public final void onAnimationEnd(Animator animator) {
        ObjectAnimator objectAnimator = this.W;
        gf.c cVar = this.f8160b;
