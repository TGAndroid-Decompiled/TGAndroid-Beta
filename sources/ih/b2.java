...
public final class b2 extends lq {
    ...
    public b2(View view) {
        ...
        this.f9034e = 1.0f;
        c(path, 1.0f, false);
        this.f30413a.setColor(-698031);
        this.f30413a.setPathEffect(new CornerPathEffect(AndroidUtilities.dp(2.33f)));
        paint.setColor(0);
    ...
    public static void c(Path path, float f9, final boolean z10) {
        ...
        path.cubicTo(com.google.android.recaptcha.internal.a.g((Float) callbackReturn.run(Float.valueOf(46.56f)), f9), AndroidUtilities.dp(48.28f * f9), com.google.android.recaptcha.internal.a.g((Float) callbackReturn.run(valueOf), f9), AndroidUtilities.dp(47.68f * f9), com.google.android.recaptcha.internal.a.g((Float) callbackReturn.run(valueOf), f9), AndroidUtilities.dp(46.5f * f9));
    ...
    public final void d(TL_stars.starGiftAttributeBackdrop stargiftattributebackdrop, boolean z10, boolean z11) {
        ...
        int[] iArr = {b10, g6.b(f13, f14 - f15, i11)};
        if (z12) {
            f12 = 1.0f;
        } else {
            f12 = 0.0f;
    ...
    public final void draw(Canvas canvas) {
        ...
        Path path = this.f9033c;
        if (alpha > 0) {
            paint.setStrokeWidth(AndroidUtilities.dp(1.33f) * 2);
            canvas.drawPath(path, paint);
        }
        canvas.drawPath(path, this.f30413a);
        if (this.f9035f != null) {
            canvas.clipPath(path);
            this.f9035f.f(0, 0, AndroidUtilities.dp(48.0f), AndroidUtilities.dp(48.0f));
            this.f9035f.d();
            this.f9035f.a(canvas, -1);
            invalidateSelf();
        }
        if (this.f9032b != null) {
            canvas.save();
            ...
            canvas.rotate(f9, dp, height - AndroidUtilities.dp(f11));
            float min = Math.min(1.0f, AndroidUtilities.dp(40.0f) / this.f9032b.f35462c);
            ...
            zz0 zz0Var = this.f9032b;
            float width3 = getBounds().width() / 2.0f;
            if (!this.f9036g) {
                f14 = 6.0f;
            }
            float dp3 = (width3 + AndroidUtilities.dp(f14)) - (this.f9032b.l() / 2.0f);
            float height3 = getBounds().height() / 2.0f;
            if (this.f9036g) {
                f15 = 4.0f;
            }
            canvas2 = canvas;
            zz0Var.c(dp3, height3 - AndroidUtilities.dp(f15), 1.0f, this.h, canvas2);
            canvas2.restore();
        } else {
            canvas2 = canvas;
        }
    ...
    public final void e(int i10, CharSequence charSequence, boolean z10) {
        ...
        this.f9032b = new zz0(charSequence, f9, typeface);
    }
}
