    ...
    public final void run(Object obj, Object obj2) {
        ...
        switch (i10) {
            case 0:
                ...
                boolean isEmpty = b5Var.f9050j.isEmpty();
                ...
                while (i11 < size) {
                    ...
                    boolean contains = b5Var.f9050j.contains(Long.valueOf(stargiftattributemodel.document.f22398id));
                    ...
                    if (TextUtils.isEmpty(lowerCase) || stargiftattributemodel.name.toLowerCase().startsWith(lowerCase) || stargiftattributemodel.name.toLowerCase().startsWith(translitSafe) || org.telegram.messenger.x3.w(" ", lowerCase, stargiftattributemodel.name.toLowerCase()) || org.telegram.messenger.x3.w(" ", translitSafe, stargiftattributemodel.name.toLowerCase())) {
                        Integer num = (Integer) b5Var.f9053m.get(Long.valueOf(stargiftattributemodel.document.f22398id));
                        if (num == null) {
                            intValue = 0;
                        } else {
            ...
            default:
                ...
                b5 b5Var3 = p5Var.f9329c;
                boolean isEmpty3 = b5Var3.f9052l.isEmpty();
                ...
                while (i15 < size3) {
                    ...
                    boolean contains3 = b5Var3.f9052l.contains(Long.valueOf(stargiftattributepattern.document.f22398id));
                    boolean z12 = !contains3;
                    if (!TextUtils.isEmpty(lowerCase3) && !stargiftattributepattern.name.toLowerCase().startsWith(lowerCase3) && !stargiftattributepattern.name.toLowerCase().startsWith(translitSafe3) && !org.telegram.messenger.x3.w(str3, lowerCase3, stargiftattributepattern.name.toLowerCase()) && !org.telegram.messenger.x3.w(str3, translitSafe3, stargiftattributepattern.name.toLowerCase())) {
                        str2 = str3;
                    } else {
                        str2 = str3;
                        Integer num3 = (Integer) b5Var3.f9055o.get(Long.valueOf(stargiftattributepattern.document.f22398id));
                        if (num3 == null) {
                            intValue3 = 0;
                        } else {
