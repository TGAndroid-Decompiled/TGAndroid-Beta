...
public final class k extends Drawable {
    ...
    public final Paint[] f7585a;
    public final float[] f7586b;
    public final Stack f7587c;
    public int d;
    ...
    public Runnable f7598q;
    public ValueAnimator f7599r;
    public int f7600s;
    public TimeInterpolator f7601t;
    public boolean f7602u;
    public PorterDuffColorFilter v;
    public int f7603w;
    public int f7604x;
    public boolean f7605y;
    public final RectF f7606z;
    ...
    public k() {
        float[] fArr = C;
        this.f7585a = new Paint[fArr.length];
        this.f7586b = new float[fArr.length];
        this.f7587c = new Stack();
        this.e = new float[14];
        this.f7588f = new int[fArr.length];
        this.h = new ArrayList();
        this.f7595n = -1.0f;
        this.f7600s = 255;
        this.f7601t = new a(0);
        this.f7606z = new RectF();
        for (int i10 = 0; i10 < fArr.length; i10++) {
            this.f7585a[i10] = new Paint();
            if (i10 == 0) {
                this.f7585a[i10].setStrokeWidth(AndroidUtilities.dp(1.4f));
                this.f7585a[i10].setStyle(Paint.Style.STROKE);
                this.f7585a[i10].setStrokeCap(Paint.Cap.ROUND);
            } else {
                this.f7585a[i10].setStrokeWidth(AndroidUtilities.dp(1.2f));
                this.f7585a[i10].setStyle(Paint.Style.STROKE);
                this.f7585a[i10].setStrokeCap(Paint.Cap.ROUND);
            }
            this.f7586b[i10] = this.f7585a[i10].getStrokeWidth() * 0.5f;
        }
    ...
    public static void g(View view, boolean z4, int i10, int i11, AtomicReference atomicReference, int i12, Layout layout, List list, Canvas canvas, boolean z10) {
        ...
        if (list != null && !list.isEmpty()) {
            ...
            if (!list.isEmpty()) {
                ...
                int i16 = 0;
                if (!list.isEmpty() && ((k) list.get(0)).f7595n != -1.0f) {
                    canvas.save();
                ...
                while (it2.hasNext()) {
                    ...
                    boolean z12 = kVar.f7597p;
                    kVar.f7597p = false;
                    if (z12) {
                        if (i12 == 1) {
                            textPaint = layout.getPaint();
                        } else {
                            textPaint = j6.f20074o2;
                        }
                        kVar.h(i0.a.d(Math.max(0.0f, kVar.f7595n), i10, textPaint.getColor()));
                    } else {
                        kVar.h(i10);
                    }
                    kVar.draw(canvas);
    ...
    public final void draw(Canvas canvas) {
        ...
        if (!bounds.isEmpty()) {
            ...
            if (bVarArr[0] == null) {
                ...
                mVar.f7615g = new Paint();
                mVar.f7616i = new ArrayList(100);
                float f10 = i11;
                ...
                while (true) {
                    ...
                    for (int i15 = 10; i14 < i15; i15 = 10) {
                        ...
                        kVar.h(-1);
                        mVar.f7616i.add(kVar);
                        i14++;
                    }
                    i13++;
                }
                i10 = 128;
                mVar.a(new Canvas((Bitmap) bVarArr[0].f6001b), new Rect(0, 0, i11, i11));
                mVar.f7615g.setShader((BitmapShader) bVarArr[0].f6002c);
                mVar.h = System.currentTimeMillis();
            } else {
                i10 = 128;
                if (mVar.f7623p && !LiteMode.isEnabled(128)) {
                    mVar.d = 0;
                    mVar.a(new Canvas((Bitmap) bVarArr[0].f6001b), new Rect(0, 0, i11, i11));
                    mVar.f7615g.setShader((BitmapShader) bVarArr[0].f6002c);
                    mVar.h = System.currentTimeMillis();
            ...
            if (LiteMode.isEnabled(i10)) {
                ...
                if (!mVar2.f7619l && !rect.isEmpty()) {
                    mVar2.f7619l = true;
                    Choreographer.getInstance().postFrameCallback(mVar2.f7621n);
                }
            }
        }
    }
    ...
    public final void e(Path path) {
        path.addCircle(this.f7592k, this.f7593l, k7.n.a(this.f7595n, 0.0f, 1.0f) * this.f7594m, Path.Direction.CW);
    }
    ...
    public final void h(int i10) {
        if (this.f7603w != i10) {
            ...
            while (true) {
                float[] fArr = C;
                if (i11 < fArr.length) {
                    this.f7585a[i11].setColor(i0.a.k(i10, (int) (this.f7600s * fArr[i11])));
                    i11++;
                } else {
    ...
    public final void i(float f10, float f11, float f12) {
        if (this.f7589g == null) {
            this.f7589g = new RectF();
        }
        RectF rectF = this.f7589g;
    ...
    public final void invalidateSelf() {
        ...
        if (view != null) {
            if (view.getParent() != null && this.f7602u) {
    ...
    public final void j(float f10, float f11, float f12, boolean z4) {
        ...
        this.f7595n = f13;
        this.f7596o = z4;
        ValueAnimator valueAnimator = this.f7599r;
        ...
        if (this.f7596o) {
            ...
            alpha = this.f7585a[C.length - 1].getAlpha();
        }
        float f15 = this.f7595n;
        if (!z4) {
            f14 = 1.0f;
        }
        ValueAnimator duration = ValueAnimator.ofFloat(f15, f14).setDuration(k7.n.a(this.f7594m * 0.3f, 250.0f, 550.0f));
        this.f7599r = duration;
        duration.setInterpolator(this.f7601t);
        this.f7599r.addUpdateListener(new b(this, alpha, 0));
        this.f7599r.addListener(new l0(this, 7));
        this.f7599r.start();
        invalidateSelf();
    }
    ...
    public final void setAlpha(int i10) {
        ...
        while (true) {
            float[] fArr = C;
            if (i11 < fArr.length) {
                this.f7585a[i11].setAlpha((int) (fArr[i11] * i10));
                i11++;
            } else {
                return;
            }
    ...
    public final void setBounds(int i10, int i11, int i12, int i13) {
        ...
        while (it.hasNext()) {
            e eVar = (e) it.next();
            if (!getBounds().contains((int) eVar.f7554a, (int) eVar.f7555b)) {
                it.remove();
            }
            Stack stack = this.f7587c;
