...
public final class u implements Utilities.Callback2 {
    public final int f9406a = 1;
    public final int f9407b;
    public final long f9408c;
    public final Context d;
    public final Object f9409e;
    public final Object f9410f;

    public u(int i10, long j10, TLRPC.Photo photo, Context context, lh.b bVar) {
        this.f9407b = i10;
        this.f9408c = j10;
        this.f9409e = photo;
        this.d = context;
    ...
    public final void run(Object obj, Object obj2) {
        ...
        int i13;
        int i14 = this.f9406a;
        Object obj3 = this.f9410f;
        Object obj4 = this.f9409e;
        switch (i14) {
            case 0:
                ...
                if (auction != null) {
                    ...
                    long j12 = this.f9408c;
                    if (j12 != peerDialogId && j12 != 0 && peerDialogId != 0) {
                        y yVar2 = new y(context, i15, auction, j12, runnable);
                        if (i11 >= 0) {
                        ...
                        g10.addView(new jh.g5(context, chat, chat2), i7.f6.t(-1, -2, 48, 0, -4, 0, 0));
                        TextView textView = new TextView(context);
                        NotificationCenter.listenEmojiLoading(textView);
                        textView.setText(LocaleController.getString(R.string.Gift2AuctionsChangeRecipient));
                        int i16 = g6.f23169j5;
                        org.telegram.ui.b.w(i16, c6Var, textView, 1, 20.0f);
                        ...
                        g10.addView(textView, i7.f6.d(-2, -2.0f, i13 | 48, 24.0f, 19.0f, 24.0f, 2.0f));
                        TextView textView2 = new TextView(context);
                        org.telegram.ui.b.m(i16, c6Var, textView2, 1, 16.0f);
            ...
            default:
                ...
                int i17 = this.f9407b;
                reportprofilephoto.peer = MessagesController.getInstance(i17).getInputPeer(this.f9408c);
    ...
    public u(Context context, org.telegram.ui.ActionBar.c6 c6Var, int i10, long j10, Runnable runnable) {
        this.d = context;
        this.f9409e = c6Var;
        this.f9407b = i10;
        this.f9408c = j10;
        this.f9410f = runnable;
    }
}
