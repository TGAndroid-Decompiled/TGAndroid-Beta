...
public final class v6 {
    ...
    public final i7 f12244k;
    public final SharedPreferences f12245l;
    ...
    public final HashSet f12253t;
    public int f12254u;
    public int v;
    public final kh.b1 f12255w;
    public String f12257y;
    public final a0.h f12237b = new a0.h();
    public final a0.h f12238c = new a0.h();
    public int d = 0;
    public final a0.h f12239e = new a0.h();
    public LongSparseIntArray f12240f = new LongSparseIntArray();
    public final ArrayList f12241g = new ArrayList();
    public final ArrayList h = new ArrayList();
    public final a0.h f12242i = new a0.h();
    public final LongSparseIntArray f12243j = new LongSparseIntArray();
    public final a0.h f12246m = new a0.h();
    public final a0.h f12256x = new a0.h();
    public boolean f12258z = true;
    ...
    public v6(int i9) {
        ...
        ?? obj = new Object();
        obj.f11619a = i9;
        obj.f11620b = MessagesStorage.getInstance(i9);
        this.f12244k = obj;
        SharedPreferences mainSettings = MessagesController.getInstance(i9).getMainSettings();
        this.f12245l = mainSettings;
        this.f12248o = mainSettings.getString("last_stories_state", "");
        this.f12257y = mainSettings.getString("last_stories_state_hidden", "");
        this.v = mainSettings.getInt("total_stores_hidden", 0);
        this.f12254u = mainSettings.getInt("total_stores", 0);
        this.f12252s = mainSettings.getBoolean("read_loaded", false);
        this.f12253t = new HashSet(mainSettings.getStringSet("unsupported_stories_checked", new HashSet()));
        ...
        i7 i7Var = this.f12244k;
        i7Var.f11620b.getStorageQueue().postRunnable(new h3.g0(26, i7Var, new y5(this, 0)));
        this.K = new bg.c2(this, i9, 6);
        this.f12255w = new kh.b1(i9);
    }
    ...
    public static String a(ArrayList arrayList) {
        ...
        for (int i9 = 0; i9 < arrayList.size(); i9++) {
            try {
                ...
                if (((MessageObject) arrayList.get(i9)).storyItem == null) {
                    str = str + "null";
                } else {
                    str = str + storyItem.f22617id + "@" + storyItem.dialogId;
                }
    ...
    public static String h0(List list) {
        ...
        for (int i9 = 0; i9 < list.size(); i9++) {
            try {
                ...
                str = str + ((TL_stories.StoryItem) list.get(i9)).f22617id + "@" + ((TL_stories.StoryItem) list.get(i9)).dialogId;
            } catch (Exception unused) {
                return "err";
            }
        }
    ...
    public final n6 A(long j10, int i9, int i10, boolean z10) {
        if (i9 == 0 && i10 > 0) {
            ...
            if (n6Var == null && z10) {
                n6 n6Var2 = new n6(this.f12236a, j10, i9, i10, new bg.i(this, 20));
        ...
        if (n6Var3 == null && z10) {
            if (i9 == 4) {
                ...
                f6 f6Var = new f6(this.f12236a, j10, null, new bg.i(this, 20));
                hashMap4.put(valueOf2, f6Var);
                return f6Var;
            }
            HashMap hashMap5 = hashMapArr[i9];
            Long valueOf3 = Long.valueOf(j10);
            n6 n6Var4 = new n6(this.f12236a, j10, i9, i10, new bg.i(this, 20));
    ...
    public final j6 B(long j10, boolean z10) {
        ...
        if (j6Var == null && z10) {
            j6 j6Var2 = new j6(this.f12236a, j10, this);
            hVar.k(j6Var2, j10);
            return j6Var2;
        }
        return j6Var;
    ...
    public final int C(boolean z10) {
        if (z10) {
            ...
            return this.h.size();
        } else if (this.f12249p) {
            return Math.max(1, this.f12254u);
        } else {
            return this.f12241g.size();
        }
    }
    ...
    public final int D(int i9, long j10) {
        ...
        TL_stories.PeerStories peerStories = (TL_stories.PeerStories) this.f12242i.f(j10);
        if (peerStories == null) {
            peerStories = z(j10);
        }
        if (peerStories == null) {
        ...
        if (j10 == UserConfig.getInstance(this.f12236a).getClientUserId() && !Utilities.isNullOrEmpty((Collection) this.f12237b.f(j10))) {
            return 1;
        }
        int max = Math.max(peerStories.max_read_id, this.f12240f.get(j10, 0));
        boolean z10 = false;
        for (int i10 = 0; i10 < peerStories.stories.size(); i10++) {
            ...
            if ((i9 == 0 || peerStories.stories.get(i10).f22617id == i9) && peerStories.stories.get(i10).f22617id > max) {
    ...
    public final ArrayList E(long j10) {
        return (ArrayList) this.f12237b.f(j10);
    }
    ...
    public final boolean G() {
        if (H()) {
            ArrayList arrayList = this.f12241g;
            if (arrayList.isEmpty() || (arrayList.size() == 1 && DialogObject.getPeerDialogId(((TL_stories.PeerStories) arrayList.get(0)).peer) == UserConfig.getInstance(this.f12236a).clientUserId)) {
                return true;
            }
        }
        return false;
    ...
    public final boolean H() {
        long j10 = UserConfig.getInstance(this.f12236a).clientUserId;
        TL_stories.PeerStories peerStories = (TL_stories.PeerStories) this.f12242i.f(j10);
        if ((peerStories != null && !peerStories.stories.isEmpty()) || !Utilities.isNullOrEmpty((Collection) this.f12237b.f(j10))) {
            return true;
        }
        return false;
    }
    ...
    public final boolean J(long j10) {
        ...
        for (int i9 = 0; i9 < peerStories.stories.size(); i9++) {
            ...
            if (storyItem != null && storyItem.f22617id > peerStories.max_read_id) {
                return true;
            }
        }
        return false;
    ...
    public final boolean K(long j10) {
        ArrayList arrayList = (ArrayList) this.f12237b.f(j10);
        HashMap hashMap = (HashMap) this.f12239e.f(j10);
    ...
    public final boolean M(TLRPC.User user) {
        if (user != null) {
            if (user.contact || user.f22527id == MessagesController.getInstance(this.f12236a).storiesChangelogUserId) {
                return true;
            }
            return false;
        }
    ...
    public final void P() {
        ...
        ConnectionsManager.getInstance(this.f12236a).sendRequest(tL_contacts_getBlocked, new t5(this, 3));
    }
    ...
    public final void Q(boolean z10) {
        ...
        boolean z11;
        if (!z10 || !this.f12251r) {
            if ((!z10 && this.f12250q) || this.f12247n) {
                return;
            }
            boolean z12 = true;
            if (z10) {
            ...
            ConnectionsManager.getInstance(this.f12236a).sendRequest(tL_stories_getAllStories, new b6(this, z10, tL_stories_getAllStories, z12));
        }
    }
    ...
    public final void R() {
        if (!this.U && !this.V) {
            this.U = true;
            ConnectionsManager.getInstance(this.f12236a).sendRequest(new TL_stories.TL_stories_getChatsToSend(), new t5(this, 2));
        }
    }
    ...
    public final void S(final TL_stories.PeerStories peerStories, final boolean z10) {
        ...
        if (peerStories != null) {
            ...
            final long j10 = peerDialogId * i9;
            Long valueOf = Long.valueOf(j10);
    ...
    public final void T() {
        if (this.A) {
            ...
            i7 i7Var = this.f12244k;
            i7Var.f11620b.getStorageQueue().postRunnable(new h3.g0(27, i7Var, y5Var));
        } else {
            Q(false);
            Q(true);
        }
    ...
    public final boolean V(TL_stories.PeerStories peerStories, TL_stories.StoryItem storyItem, boolean z10) {
        if (storyItem != null && peerStories != null) {
            ...
            int i9 = this.f12240f.get(peerDialogId);
            int max = Math.max(peerStories.max_read_id, Math.max(i9, storyItem.f22617id));
            ...
            this.f12240f.put(peerDialogId, max);
            if (max > i9) {
                if (!z10) {
                    this.f12244k.i(max, peerDialogId);
                }
            ...
            if (DownloadController.getInstance(i9).canPreloadStories()) {
                ...
                if (z10) {
                    ...
                    if (photo != null && (arrayList = photo.sizes) != null) {
                        FileLoader.getInstance(i9).loadFile(ImageLocation.getForPhoto(FileLoader.getClosestPhotoSizeWithSize(arrayList, Integer.MAX_VALUE), photo), storyItem, "jpg", 0, 1);
                    }
                }
                    ...
                    for (int i10 = 0; i10 < Math.min(2, storyItem.media_areas.size()); i10++) {
                        if (storyItem.media_areas.get(i10) instanceof TL_stories.TL_mediaAreaSuggestedReaction) {
                            ...
                            if (d.f10717f != null) {
                                ...
                                org.telegram.ui.Components.k5 k5Var = new org.telegram.ui.Components.k5(1, i9, d.f10718g);
                                k5Var.f29953m = true;
                                k5Var.v();
                            }
                        }
    ...
    public final void X(TL_stories.PeerStories peerStories) {
        ...
        while (true) {
            if (i10 >= peerStories.stories.size()) {
                break;
            } else if (peerStories.stories.get(i10).f22617id > peerStories.max_read_id) {
                i9 = i10;
                break;
            } else {
                i10++;
    ...
    public final void Y(TL_stories.TL_stories_allStories tL_stories_allStories, boolean z10, boolean z11, boolean z12) {
        ...
        ArrayList arrayList3 = this.f12241g;
        if (!z12) {
            if (!z10) {
                arrayList3.clear();
            } else {
        ...
        for (int i11 = 0; i11 < tL_stories_allStories.peer_stories.size(); i11++) {
            ...
            while (i12 < peerStories.stories.size()) {
                ...
                if ((storyItem instanceof TL_stories.TL_storyItemDeleted) || ((storyItem instanceof TL_stories.TL_storyItem) && currentTime > storyItem.expire_date && !(storyItem.media instanceof TLRPC.TL_messageMediaVideoStream))) {
                    NotificationsController.getInstance(i10).processDeleteStory(peerDialogId, storyItem.f22617id);
                ...
                for (int i13 = 0; i13 < 2; i13++) {
                    ...
                    while (true) {
                        if (i14 >= arrayList.size()) {
                            break;
                        } else if (DialogObject.getPeerDialogId(((TL_stories.PeerStories) arrayList.get(i14)).peer) == peerDialogId) {
        ...
        if (!z11) {
            ...
            i7 i7Var = this.f12244k;
            i7Var.f11620b.getStorageQueue().postRunnable(new u5(i7Var, arrayList4, z12, z10, d2Var, 1));
        }
        bg.c2 c2Var = this.K;
    ...
    public final void Z(TL_stories.TL_updateStory tL_updateStory) {
        ...
        int i9 = (peerDialogId > 0L ? 1 : (peerDialogId == 0L ? 0 : -1));
        if (i9 == 0) {
        ...
        i7 i7Var = this.f12244k;
        if (i9 > 0) {
            user = MessagesController.getInstance(this.f12236a).getUser(Long.valueOf(peerDialogId));
            if (user != null && (M(user) || user.self)) {
                i7Var.f11620b.getStorageQueue().postRunnable(new h3.g0(25, i7Var, tL_updateStory));
            }
        } else {
            i7Var.f11620b.getStorageQueue().postRunnable(new h3.g0(25, i7Var, tL_updateStory));
            user = null;
    ...
    public final void a0(long j10, TL_stories.PeerStories peerStories) {
        ...
        if (j10 > 0) {
            ...
            if (M(user) || user.self) {
                i7Var.f11620b.getStorageQueue().postRunnable(new f7(i7Var, peerStories, 0));
            }
        } else if (ChatObject.isInChat(MessagesController.getInstance(i9).getChat(Long.valueOf(-j10)))) {
            i7Var.f11620b.getStorageQueue().postRunnable(new f7(i7Var, peerStories, 0));
        }
    }
    ...
    public final void b(int i9, long j10, ArrayList arrayList) {
        ...
        n6 A = v6Var.A(B.f11632b, 0, i9, false);
        if (A != null) {
            A.D(arrayList, true);
        }
        ...
        while (i13 < size3) {
            ...
            i13++;
            n6 A2 = v6Var.A(B.f11632b, 0, ((o6) obj3).f11901a, false);
            if (A2 != null) {
        ...
        if (peerStories2 != null && (arrayList = peerStories2.stories) != null && !arrayList.isEmpty() && peerStories != null && (arrayList2 = peerStories.stories) != null && !arrayList2.isEmpty()) {
            for (int i9 = 0; i9 < peerStories.stories.size(); i9++) {
                if (peerStories.stories.get(i9) instanceof TL_stories.TL_storyItemSkipped) {
                    int i10 = peerStories.stories.get(i9).f22617id;
                    int i11 = 0;
                    while (true) {
                        if (i11 >= peerStories2.stories.size()) {
                            break;
                        }
                        if (peerStories2.stories.get(i11).f22617id == i10 && (peerStories2.stories.get(i11) instanceof TL_stories.TL_storyItem)) {
    ...
    public final void d0(long j10, int i9, d5.d dVar) {
        ...
        if (y10 != null) {
            for (int i10 = 0; i10 < y10.stories.size(); i10++) {
                if (y10.stories.get(i10).f22617id == i9 && !(y10.stories.get(i10) instanceof TL_stories.TL_storyItemSkipped)) {
    ...
    public final void e0(long j10, boolean z10) {
        LongSparseIntArray longSparseIntArray = this.f12243j;
        if (z10) {
    ...
    public final void g(TL_stories.PeerStories peerStories) {
        ...
        while (true) {
            ...
            if (i11 >= arrayList2.size()) {
                break;
            } else if (DialogObject.getPeerDialogId(((TL_stories.PeerStories) arrayList2.get(i11)).peer) == peerDialogId) {
    ...
    public final boolean h(long j10) {
        TLRPC.Chat chat;
        if (j10 >= 0 || (chat = MessagesController.getInstance(this.f12236a).getChat(Long.valueOf(-j10))) == null) {
            return false;
        }
        if (!chat.creator) {
    ...
    public final boolean i(long j10) {
        if (UserConfig.getInstance(this.f12236a).getClientUserId() != j10 && !h(j10)) {
            return false;
        }
        return true;
    }
    ...
    public final void i0(long j10, boolean z10, boolean z11) {
        ...
        ArrayList arrayList2 = this.f12241g;
        if (z10) {
    ...
    public final boolean j(long j10) {
        ...
        if (i10 < 0) {
            ...
            return false;
        } else if (i10 > 0 && (user = MessagesController.getInstance(i9).getUser(Long.valueOf(j10))) != null && user.bot && user.bot_can_edit) {
            return true;
        } else {
            return false;
        }
        ...
        if (inputPeer != null && !(inputPeer instanceof TLRPC.TL_inputPeerEmpty)) {
            ...
            if (z11) {
                if (z10) {
                    ...
                    tL_contacts_unblock2.f22428id = inputPeer;
    ...
    public final void k0(long j10, List list) {
        ...
        if (B != null && (arrayList = B.h) != null) {
            ...
            while (i9 < size) {
                ...
                i9++;
                n6 A3 = v6Var.A(j10, 0, ((o6) obj).f11901a, false);
                if (A3 != null) {
                    A3.A(list);
                }
                v6Var = this;
        ...
        for (int i10 = 0; i10 < list.size(); i10++) {
            ...
            while (true) {
                if (i11 < peerStories.stories.size()) {
                    if (peerStories.stories.get(i11).f22617id == storyItem.f22617id) {
                        z11 = true;
                        if (storyItem instanceof TL_stories.TL_storyItemDeleted) {
                            ...
                            org.telegram.messenger.l0.n(storyItem.f22617id, new StringBuilder("StoriesController update story for full peer storyId="));
                        }
                    } else {
                        i11++;
                    }
            ...
            if (!z11) {
                if (storyItem instanceof TL_stories.TL_storyItemDeleted) {
                    org.telegram.messenger.l0.n(storyItem.f22617id, new StringBuilder("StoriesController story is not found, but already deleted storyId="));
                } else if (z10) {
                    org.telegram.messenger.l0.n(storyItem.f22617id, new StringBuilder("StoriesController add new story for full peer storyId="));
    ...
    public final void m(TL_stories.PeerStories peerStories) {
        if (peerStories != null && peerStories.stories != null) {
            ...
            while (i9 < peerStories.stories.size()) {
                if (p7.w(this.f12236a, peerStories.stories.get(i9))) {
    ...
    public final void m0(long j10, TL_stories.PeerStories peerStories) {
        ...
        if (peerStories != null && (peerStories2 = (TL_stories.PeerStories) this.f12242i.f(j10)) != null) {
            ...
            for (int i9 = 0; i9 < peerStories2.stories.size(); i9++) {
                if (peerStories2.stories.get(i9) instanceof TL_stories.TL_storyItemSkipped) {
                    int i10 = peerStories2.stories.get(i9).f22617id;
                    int i11 = 0;
                    while (true) {
                        if (i11 >= peerStories.stories.size()) {
                            break;
                        }
                        if (peerStories.stories.get(i11).f22617id == i10 && (peerStories.stories.get(i11) instanceof TL_stories.TL_storyItem)) {
    ...
    public final boolean n(org.telegram.tgnet.TLRPC.TL_error r8) {
        throw new UnsupportedOperationException("Method not decompiled: ih.v6.n(org.telegram.tgnet.TLRPC$TL_error):boolean");
    }
    ...
    public final void n0(long j10, List list, boolean z10) {
        ...
        if (B != null && (arrayList = B.h) != null) {
            ...
            while (i9 < size2) {
                int i11 = i9 + 1;
                n6 A3 = v6Var.A(j10, 0, ((o6) arrayList.get(i9)).f11901a, false);
                if (A3 != null) {
                    A3.D(list, z10);
                }
                v6Var = this;
    ...
    public final p6 o() {
        ...
        if (UserConfig.getInstance(i10).isPremium()) {
            i9 = MessagesController.getInstance(i10).storyExpiringLimitPremium;
        } else {
            i9 = MessagesController.getInstance(i10).storyExpiringLimitDefault;
        }
        ArrayList arrayList2 = (ArrayList) this.f12238c.f(UserConfig.getInstance(i10).getClientUserId());
        if (arrayList2 == null) {
            size = 0;
        } else {
        ...
        ConnectionsManager.getInstance(i10).sendRequest(tL_stories_canSendStory, new t5(this, 1), 1024);
        return null;
    }
    ...
    public final void o0(long j10, ArrayList arrayList, boolean z10, e3 e3Var) {
        ...
        for (int i9 = 0; i9 < arrayList.size(); i9++) {
            ...
            if (!(storyItem instanceof TL_stories.TL_storyItemDeleted)) {
                ...
                if (y10 != null) {
                    for (int i10 = 0; i10 < y10.stories.size(); i10++) {
                        if (y10.stories.get(i10).f22617id == storyItem.f22617id) {
                            y10.stories.get(i10).pinned = z10;
                            this.f12244k.k(j10, storyItem);
                        }
                    }
                }
            }
    ...
    public final void p(int i9, long j10) {
        ...
        if (hashSet.contains(str) || this.f12253t.contains(str)) {
            return;
        }
        hashSet.add(str);
        TL_stories.TL_stories_getStoriesByID tL_stories_getStoriesByID = new TL_stories.TL_stories_getStoriesByID();
    ...
    public final void q() {
        ...
        this.f12257y = "";
        this.f12248o = "";
        this.f12245l.edit().putBoolean("stories_loaded", false).remove("last_stories_state").putBoolean("stories_loaded_hidden", false).remove("last_stories_state_hidden").putBoolean("read_loaded", false).apply();
        kh.b1 b1Var = this.f12255w;
        ...
        ConnectionsManager.getInstance(this.f12236a).sendRequest(new TL_stories.TL_stories_getAllReadPeerStories(), new t5(this, 0));
    }
    ...
    public final void r(long j10, String str, Utilities.Callback callback) {
        ...
        tL_createAlbum.peer = MessagesController.getInstance(i9).getInputPeer(B.f11632b);
    ...
    public final void s(long j10, ArrayList arrayList) {
            ...
            if (!(storyItem instanceof TL_stories.TL_storyItemDeleted)) {
                if (peerStories2 != null) {
                    ...
                    while (true) {
                        if (i11 >= peerStories2.stories.size()) {
                            break;
                        } else if (peerStories2.stories.get(i11).f22617id == storyItem.f22617id) {
            ...
            if (!(storyItem2 instanceof TL_stories.TL_storyItemDeleted) && peerStories2 != null) {
                ...
                while (true) {
                    if (i13 >= peerStories2.stories.size()) {
                        break;
                    } else if (peerStories2.stories.get(i13).f22617id == storyItem2.f22617id) {
        ...
        i7 i7Var = this.f12244k;
        i7Var.f11620b.getStorageQueue().postRunnable(new e5.w(i7Var, arrayList2, j10, 8));
        NotificationCenter.getInstance(i9).lambda$postNotificationNameOnUIThread$1(NotificationCenter.storiesUpdated, new Object[0]);
    }
    ...
    public final u6 t(long j10, TL_stories.StoryItem storyItem) {
        HashMap hashMap = (HashMap) this.f12239e.f(j10);
        if (hashMap != null && !hashMap.isEmpty()) {
            return (u6) hashMap.get(Integer.valueOf(storyItem.f22617id));
        }
        return null;
    }
    ...
    public final void v(ArrayList arrayList) {
        ...
        while (i9 < arrayList.size()) {
            ...
            long peerDialogId = DialogObject.getPeerDialogId(peerStories.peer);
            if (peerDialogId > 0 && (user = MessagesController.getInstance(this.f12236a).getUser(Long.valueOf(peerDialogId))) != null && !M(user)) {
                arrayList.remove(i9);
                i9--;
                z10 = true;
            } else {
    ...
    public final int x(long j10) {
        ...
        if (y10 != null) {
            return Math.max(y10.max_read_id, this.f12240f.get(j10, 0));
        }
        return this.f12240f.get(j10, 0);
    }

    public final TL_stories.PeerStories y(long j10) {
        return (TL_stories.PeerStories) this.f12242i.f(j10);
    }
