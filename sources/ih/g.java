...
public final class g extends FrameLayout {
    ...
    public boolean L;
    public qh.g f12329a;
    public final eb f12330b;
    public final FrameLayout f12331c;
    public final y d;
    public boolean f12332e;
    public dh.d f12333f;
    public dh.d h;
    public final Path f12334n;
    public int f12335r;
    public float f12336s;
    public float v;
    public boolean f12337w;
    public float f12338x;
    public float f12339y;

    public g(Context context) {
        super(context);
        this.f12332e = true;
        this.f12334n = new Path();
        this.G = new Rect();
        this.H = new RectF();
        ...
        this.f12330b = new eb(this, context, 5);
    }

    public final void a(boolean z10) {
        e();
        int round = Math.round(this.f12336s) + AndroidUtilities.dp(9.0f) + this.F;
        if (this.f12335r == round && !z10) {
            return;
        }
        this.f12335r = round;
    ...
    public final void b() {
        ...
        if (cVar != null && (i10 = cVar.getBounds().top) != (measuredHeight = getMeasuredHeight() - Math.round(this.J))) {
            ...
            this.f12330b.invalidate(0, Math.max(0, Math.min(i10, measuredHeight)), getMeasuredWidth(), getMeasuredHeight());
    ...
    public final void c() {
        int i10;
        l1 l1Var = ((qh.i) this.f12329a).f44655r;
        if (l1Var != null) {
            i10 = l1Var.f44711a.f(2).d;
        } else {
            i10 = 0;
        }
        float b10 = ((qh.i) this.f12329a).b();
        y yVar = this.d;
    ...
    public final void d() {
        ...
        int i11;
        this.f12336s = ((qh.i) this.f12329a).c();
        this.v = ((qh.i) this.f12329a).b();
        int i12 = 0;
        boolean z11 = true;
        if (((qh.i) this.f12329a).f44656s != 1) {
            z10 = true;
        } else {
            z10 = false;
        }
        ...
        int i14 = ((qh.i) this.f12329a).f44657w;
        if (i13 != i14) {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        int measuredHeight = getMeasuredHeight() - this.f12335r;
        int round = Math.round(this.f12338x);
        int measuredWidth = getMeasuredWidth() - Math.round(this.f12339y);
        int i10 = this.F;
        Rect rect = this.G;
        rect.set(round, 0, measuredWidth, i10);
        rect.inset(0, -AndroidUtilities.dp(7.0f));
        rect.offset(0, measuredHeight + ((int) this.K));
        this.f12333f.setBounds(rect);
        if (this.f12332e) {
            this.f12333f.draw(canvas);
        }
        if (this.f12337w) {
            this.h.draw(canvas);
        }
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        if (z10) {
            canvas.save();
            canvas.clipPath(this.h.h.f6826k);
        }
    ...
    public final void e() {
        this.f12331c.setTranslationY((-this.f12336s) - AndroidUtilities.dp(9.0f));
        y yVar = this.d;
    ...
    public float getInputBubbleBottom() {
        return (getMeasuredHeight() - this.f12336s) - AndroidUtilities.dp(9.0f);
    }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            dh.d dVar2 = this.f12333f;
            if ((dVar2 != null && dVar2.f6838j == 255 && dVar2.getBounds().contains(x10, y3)) || ((dVar = this.h) != null && dVar.getBounds().contains(x10, y3))) {
                z10 = true;
            } else {
                z10 = false;
            }
    ...
    public void setInputIslandBubbleDrawable(dh.d dVar) {
        ...
        this.f12333f.p(AndroidUtilities.dp(22.0f));
    }
