...
public final class a extends FrameLayout implements d {
    public final le.b f11193a;
    public final le.b f11194b;
    ...
    public a(Context context) {
        super(context);
        qr qrVar = qr.h;
        this.f11193a = new le.b(0, this, qrVar, 320L, false);
        this.f11194b = new le.b(1, this, qrVar, 320L, true);
        this.h = 1.0f;
    }
    ...
    public final void a() {
        int i10;
        float f7 = 1.0f - this.f11193a.e;
        float lerp = AndroidUtilities.lerp(f7 / 2.0f, f7, this.f11194b.e);
        ImageView imageView = this.f11195c;
        if (imageView != null) {
            imageView.setAlpha(lerp);
            this.f11195c.setScaleX(AndroidUtilities.lerp(0.4f, 1.0f, f7));
            this.f11195c.setScaleY(AndroidUtilities.lerp(0.4f, 1.0f, f7) * this.h);
            ImageView imageView2 = this.f11195c;
            if (f7 > 0.0f) {
                i10 = 0;
            } else {
                i10 = 8;
    ...
    public final void draw(Canvas canvas) {
        this.f11197n.draw(canvas);
        super.draw(canvas);
    }

    public final void e(boolean z10, boolean z11) {
        super.setEnabled(z10);
        this.f11194b.a(z10, z11);
    }
    ...
    public final void f(int i10, int i11) {
        if (this.f11195c == null) {
            ...
            addView(this.f11195c, x5.e(i11, i11, 17));
            a();
        }
        this.f11195c.setImageResource(i10);
    }

    public final void g() {
        ch.d dVar = this.f11197n;
        if (dVar != null) {
            dVar.v();
            invalidate();
        }
        int i10 = i6.Wk;
        int v02 = i6.v0(i10, this.f11196f);
        setIconColor(i6.v0(i10, this.f11196f));
        int dp = AndroidUtilities.dp(22.0f);
        int l1 = i6.l1(0.15f, v02);
        int dp2 = AndroidUtilities.dp(6.0f);
