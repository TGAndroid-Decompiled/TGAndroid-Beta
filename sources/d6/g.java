...
public final class g {
    public static final g6.b f7540c = new g6.b("SessionManager", null);
    ...
    public final void a(h hVar) {
        ...
        try {
            ...
            f7540c.a(e, "Unable to call %s on %s.", "addSessionManagerListener", y.class.getSimpleName());
        }
    }
    ...
    public final void b(boolean z10) {
        ...
        n6.l.e("Must be called from the main thread.");
        try {
            Log.i(bVar.f9425a, bVar.d("End session for %s", this.f7542b.getPackageName()));
            y yVar = this.f7541a;
            Parcel O0 = yVar.O0();
    ...
    public final f d() {
        ...
        try {
            ...
            f7540c.a(e, "Unable to call %s on %s.", "getWrappedCurrentSession", y.class.getSimpleName());
            return null;
        }
    }
}
