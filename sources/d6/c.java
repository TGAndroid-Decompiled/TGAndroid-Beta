...
public final class c extends f {
    public static final g6.b f7515m = new g6.b("CastSession", null);
    public final Context f7516c;
    public final HashSet d;
    public final q e;
    public final b f7517f;
    public final com.google.android.gms.internal.cast.r f7518g;
    public final f6.i h;
    public e0 f7519i;
    public e6.h f7520j;
    ...
    public static void g(c cVar, int i10) {
        ...
        if (iVar.f8989q) {
            ...
            if (hVar != null) {
                c0 c0Var = iVar.f8985m;
                n6.l.e("Must be called from the main thread.");
                if (c0Var != null) {
                    hVar.f8002i.remove(c0Var);
                }
            }
            iVar.f8978c.L0(null);
            cf.c cVar2 = iVar.h;
            ...
            cf.c cVar3 = iVar.f8981i;
            if (cVar3 != null) {
                cVar3.B();
                cVar3.e = null;
            }
            android.support.v4.media.session.b0 b0Var = iVar.f8988p;
            if (b0Var != null) {
                b0Var.d(null, null);
                iVar.f8988p.e(new MediaMetadataCompat(new Bundle()));
                iVar.j(0, null);
            }
            android.support.v4.media.session.b0 b0Var2 = iVar.f8988p;
            if (b0Var2 != null) {
                b0Var2.c(false);
                iVar.f8988p.b();
                iVar.f8988p = null;
        ...
        if (e0Var != null) {
            ...
            e0Var.e(1, e.a());
            e0Var.h();
            com.google.android.gms.common.api.internal.n nVar = xa.c.o(e0Var.f6195f, e0Var.f3972k, "castDeviceControllerListenerKey").f6128c;
            n6.l.i(nVar, "Key must not be null");
            e0Var.c(nVar, 8415);
            cVar.f7519i = null;
        }
        cVar.f7521k = null;
        e6.h hVar2 = cVar.f7520j;
        if (hVar2 != null) {
            hVar2.v(null);
            cVar.f7520j = null;
        }
    ...
    public static void h(c cVar, String str, Task task) {
        ...
        try {
            if (task.isSuccessful()) {
                ...
                Status status = tVar.f9449a;
                if (status.b()) {
                    bVar.b("%s() -> success result", str);
                    e6.h hVar = new e6.h(new g6.m());
                    cVar.f7520j = hVar;
                    hVar.v(cVar.f7519i);
                    cVar.f7520j.p(new c0(cVar, 0));
                    cVar.f7520j.u();
                    f6.i iVar = cVar.h;
                    e6.h hVar2 = cVar.f7520j;
                    n6.l.e("Must be called from the main thread.");
                    iVar.a(hVar2, cVar.f7521k);
                    c6.d dVar = tVar.f9450b;
                    n6.l.h(dVar);
                    String str2 = tVar.f9451c;
                    String str3 = tVar.d;
                    n6.l.h(str3);
                    boolean z10 = tVar.e;
                    o oVar = (o) qVar;
