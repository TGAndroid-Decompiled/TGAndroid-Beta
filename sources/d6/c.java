...
public final class c extends f {
    public static final g6.b f7531m = new g6.b("CastSession", null);
    public final Context f7532c;
    public final HashSet d;
    public final q e;
    public final b f7533f;
    public final com.google.android.gms.internal.cast.r f7534g;
    public final f6.i h;
    public e0 f7535i;
    public e6.h f7536j;
    public CastDevice f7537k;
    public q4 f7538l;
    ...
    public static void g(c cVar, int i10) {
        ...
        if (e0Var != null) {
            ...
            e0Var.e(1, e.a());
            e0Var.h();
            com.google.android.gms.common.api.internal.n nVar = xa.c.t(e0Var.f6212f, e0Var.f3980k, "castDeviceControllerListenerKey").f6145c;
            n6.l.i(nVar, "Key must not be null");
            e0Var.c(nVar, 8415);
            cVar.f7535i = null;
        }
        cVar.f7537k = null;
        e6.h hVar2 = cVar.f7536j;
        if (hVar2 != null) {
            hVar2.v(null);
            cVar.f7536j = null;
        }
    ...
    public static void h(c cVar, String str, Task task) {
        ...
        try {
            if (task.isSuccessful()) {
                ...
                Status status = tVar.f9465a;
                if (status.b()) {
                    bVar.b("%s() -> success result", str);
                    e6.h hVar = new e6.h(new g6.m());
                    cVar.f7536j = hVar;
                    hVar.v(cVar.f7535i);
                    cVar.f7536j.p(new c0(cVar, 0));
                    cVar.f7536j.u();
                    f6.i iVar = cVar.h;
                    e6.h hVar2 = cVar.f7536j;
                    n6.l.e("Must be called from the main thread.");
                    iVar.a(hVar2, cVar.f7537k);
                    c6.d dVar = tVar.f9466b;
                    n6.l.h(dVar);
                    String str2 = tVar.f9467c;
                    String str3 = tVar.d;
                    n6.l.h(str3);
                    boolean z10 = tVar.e;
                    o oVar = (o) qVar;
