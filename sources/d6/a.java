...
public final class a {
    public static final g6.b f7508l = new g6.b("CastContext", null);
    public static final Object f7509m = new Object();
    public static volatile a f7510n;
    public final Context f7511a;
    public final n f7512b;
    public final g f7513c;
    public final k d;
    public final b e;
    public final g6.r f7514f;
    public final com.google.android.gms.internal.cast.d f7515g;
    public final com.google.android.gms.internal.cast.n h;
    public final List f7516i;
    public final com.google.android.gms.internal.cast.u f7517j;
    public final com.google.android.gms.internal.cast.f f7518k;
    ...
    public a(Context context, b bVar, List list, com.google.android.gms.internal.cast.r rVar, g6.r rVar2) {
        ...
        this.f7517j = rVar.f6475f;
        if (!TextUtils.isEmpty(bVar.f7520a)) {
            this.f7518k = new com.google.android.gms.internal.cast.f(context, bVar, rVar);
        } else {
            this.f7518k = null;
        }
        HashMap hashMap = new HashMap();
        com.google.android.gms.internal.cast.f fVar = this.f7518k;
        if (fVar != null) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    com.google.android.gms.internal.cast.u uVar = this.f7517j;
                    if (uVar != null) {
                        uVar.f6501f = gVar;
                    ...
                    try {
                        ...
                        if (!DesugarCollections.unmodifiableList(bVar.f7527w).isEmpty()) {
                            g6.b bVar2 = f7508l;
                            Log.i(bVar2.f9429a, bVar2.d("Setting Route Discovery for appIds: ".concat(String.valueOf(DesugarCollections.unmodifiableList(this.e.f7527w))), new Object[0]));
                            com.google.android.gms.internal.cast.n nVar = this.h;
                            List<String> unmodifiableList = DesugarCollections.unmodifiableList(this.e.f7527w);
                            nVar.getClass();
                            com.google.android.gms.internal.cast.n.f6441f.b(k0.i(unmodifiableList.size(), "SetRouteDiscovery for ", " IDs"), new Object[0]);
        ...
        if (f7510n == null) {
            synchronized (f7509m) {
                if (f7510n == null) {
                    ...
                    ?? jVar = new com.google.android.gms.common.api.j(applicationContext, g6.r.f9464k, com.google.android.gms.common.api.b.f6025t, com.google.android.gms.common.api.i.f6034c);
                    try {
                        f7510n = new a(applicationContext, castOptions, d.getAdditionalSessionProviders(applicationContext), new com.google.android.gms.internal.cast.r(applicationContext, p4.x.d(applicationContext), castOptions, jVar), jVar);
                    } catch (d e) {
    ...
    public static e d(Context context) {
        ...
        try {
            Bundle bundle = a2.f13516a.getPackageManager().getApplicationInfo(context.getPackageName(), 128).metaData;
            if (bundle == null) {
                f7508l.c(new Object[0]);
            }
