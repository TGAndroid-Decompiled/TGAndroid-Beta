...
public final class a {
    ...
    public a(Context context, b bVar, List list, com.google.android.gms.internal.cast.r rVar, g6.r rVar2) {
        ...
        if (fVar != null) {
            hashMap.put(fVar.f6339b, fVar.f6340c);
        }
        if (list != null) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    if (uVar != null) {
                        uVar.f6502f = gVar;
                        com.google.android.gms.internal.cast.c0 c0Var = uVar.f6501c;
                        n6.l.h(c0Var);
                    ...
                    try {
                        ...
                        if (!DesugarCollections.unmodifiableList(bVar.f7528w).isEmpty()) {
                            ...
                            nVar.getClass();
                            com.google.android.gms.internal.cast.n.f6442f.b(k0.i(unmodifiableList.size(), "SetRouteDiscovery for ", " IDs"), new Object[0]);
                            LinkedHashSet<String> linkedHashSet = new LinkedHashSet();
                            for (String str2 : unmodifiableList) {
                                linkedHashSet.add(k5.a(str2));
                            }
                            com.google.android.gms.internal.cast.n.f6442f.b("resetting routes. appIdToRouteInfo has these appId route keys: ".concat(String.valueOf(nVar.f6445c.keySet())), new Object[0]);
                            HashMap hashMap2 = new HashMap();
                            synchronized (nVar.f6445c) {
                                try {
                                    for (String str3 : linkedHashSet) {
                                        com.google.android.gms.internal.cast.l lVar4 = (com.google.android.gms.internal.cast.l) nVar.f6445c.get(k5.a(str3));
                                        if (lVar4 != null) {
                                            hashMap2.put(str3, lVar4);
                                        }
                                    }
                                    nVar.f6445c.clear();
                                    nVar.f6445c.putAll(hashMap2);
                                } finally {
                                }
                            }
                            com.google.android.gms.internal.cast.n.f6442f.b("Routes reset. appIdToRouteInfo has these appId route keys: ".concat(String.valueOf(nVar.f6445c.keySet())), new Object[0]);
                            synchronized (nVar.d) {
                                nVar.d.clear();
                        ...
                        e.f6184c = new xa.c(rVar2, new String[]{"com.google.android.gms.cast.MAP_CAST_STATUS_CODES_TO_CAST_REASON_CODES"});
                        e.d = new k6.c[]{c6.y.d};
                        e.f6183b = false;
                        e.f6182a = 8427;
        ...
        if (f7511n == null) {
            synchronized (f7510m) {
                if (f7511n == null) {
                    ...
                    ?? jVar = new com.google.android.gms.common.api.j(applicationContext, g6.r.f9465k, com.google.android.gms.common.api.b.f6026t, com.google.android.gms.common.api.i.f6035c);
                    try {
    ...
    public static e d(Context context) {
        ...
        try {
            Bundle bundle = a2.f13517a.getPackageManager().getApplicationInfo(context.getPackageName(), 128).metaData;
            if (bundle == null) {
