            ...
            case 1:
                ...
                switch (i10) {
                    ...
                    case 4:
                        ...
                        if (qVar != null) {
                            try {
                                ...
                                c.f7531m.a(e, "Unable to call %s on %s.", "disconnectFromDevice", q.class.getSimpleName());
                            }
                            cVar.d(0);
                        }
                        parcel2.writeNoException();
                    ...
                    case 5:
                        ...
                        e6.h hVar = cVar2.f7536j;
                        if (hVar == null) {
                            g10 = 0;
                        } else {
                            g10 = hVar.g() - cVar2.f7536j.a();
                        }
                        parcel2.writeNoException();
                    ...
                    case 7:
                        com.google.android.gms.internal.cast.v.b(parcel);
                        ((c) fVar).f7537k = CastDevice.b((Bundle) com.google.android.gms.internal.cast.v.a(parcel, Bundle.CREATOR));
                        parcel2.writeNoException();
                        return true;
                    case 8:
                        com.google.android.gms.internal.cast.v.b(parcel);
                    ...
                    case 9:
                        ...
                        if (b10 != null) {
                            String str2 = b10.d;
                            if (!b10.equals(cVar3.f7537k)) {
                                if (!TextUtils.isEmpty(str2) && ((castDevice2 = cVar3.f7537k) == null || !TextUtils.equals(castDevice2.d, str2))) {
                                    z10 = true;
                                } else {
                                    z10 = false;
                                }
                                ...
                                if (z10 && (castDevice = cVar3.f7537k) != null) {
                                    f6.i iVar = cVar3.h;
                                    if (iVar != null) {
                                        g6.b bVar4 = f6.i.v;
                                        Log.i(bVar4.f9429a, bVar4.d("update Cast device to %s", castDevice));
