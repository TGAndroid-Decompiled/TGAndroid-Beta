        ...
        switch (i12) {
            ...
            case 1:
                ...
                switch (i10) {
                    ...
                    case 3:
                        ...
                        return true;
                    case 4:
                        int i13 = com.google.android.gms.internal.cast.v.f6513a;
                        if (parcel.readInt() != 0) {
                            i11 = 1;
                        } else {
                            i11 = 0;
                        ...
                        if (qVar != null) {
                            try {
                                ...
                                c.f7529m.a(e, "Unable to call %s on %s.", "disconnectFromDevice", q.class.getSimpleName());
                            }
                            cVar.d(0);
                        }
                        parcel2.writeNoException();
                    ...
                    case 5:
                        ...
                        e6.h hVar = cVar2.f7534j;
                        if (hVar == null) {
                            g10 = 0;
                        } else {
                            g10 = hVar.g() - cVar2.f7534j.a();
                        }
                        parcel2.writeNoException();
                    ...
                    case 7:
                        com.google.android.gms.internal.cast.v.b(parcel);
                        ((c) fVar).f7535k = CastDevice.b((Bundle) com.google.android.gms.internal.cast.v.a(parcel, Bundle.CREATOR));
                        parcel2.writeNoException();
                        return true;
                    case 8:
                        com.google.android.gms.internal.cast.v.b(parcel);
                    ...
                    case 9:
                        ...
                        if (b10 != null) {
                            String str2 = b10.d;
                            if (!b10.equals(cVar3.f7535k)) {
                                if (!TextUtils.isEmpty(str2) && ((castDevice2 = cVar3.f7535k) == null || !TextUtils.equals(castDevice2.d, str2))) {
                                    z10 = true;
                                } else {
                                    z10 = false;
                                }
                                ...
                                if (z10 && (castDevice = cVar3.f7535k) != null) {
                                    f6.i iVar = cVar3.h;
                                    if (iVar != null) {
                                        g6.b bVar4 = f6.i.v;
                                        Log.i(bVar4.f9427a, bVar4.d("update Cast device to %s", castDevice));
                                        iVar.f9001o = castDevice;
                                        iVar.b();
                                    }
            ...
            case 2:
                ...
                if (i10 != 1) {
                    ...
                    boolean z11 = bVar5.e;
                    parcel2.writeNoException();
                    int i14 = com.google.android.gms.internal.cast.v.f6513a;
                    parcel2.writeInt(z11 ? 1 : 0);
                    return true;
                }
                String readString = parcel.readString();
                com.google.android.gms.internal.cast.v.b(parcel);
                x6.a f7 = new c(fVar2.f6334a, fVar2.f6335b, readString, fVar2.d, fVar2.e, new f6.i(fVar2.f6334a, bVar5, fVar2.e)).f();
                parcel2.writeNoException();
            ...
            case 3:
                ...
                if (i10 != 1) {
                    if (i10 != 2) {
                        ...
                        com.google.android.gms.internal.cast.v.b(parcel);
                        e0 e0Var = cVar4.f7533i;
                        if (e0Var != null && e0Var.F == 2) {
                            com.google.android.gms.common.api.internal.v e7 = com.google.android.gms.common.api.internal.w.e();
                            e7.f6180c = new of.b(e0Var, readString2, false, 9);
                            e7.f6178a = 8409;
                            e0Var.e(1, e7.a());
                        }
                        parcel2.writeNoException();
