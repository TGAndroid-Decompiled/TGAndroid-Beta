...
public final class b extends o6.a {
    ...
    public final e6.a f7519f;
    public final boolean h;
    public final double f7520n;
    ...
    public b(String str, ArrayList arrayList, boolean z10, c6.i iVar, boolean z11, e6.a aVar, boolean z12, double d, boolean z13, boolean z14, boolean z15, ArrayList arrayList2, boolean z16, boolean z17, a0 a0Var, b0 b0Var) {
        int size;
        this.f7516a = true == TextUtils.isEmpty(str) ? "" : str;
        if (arrayList == null) {
            size = 0;
        } else {
            size = arrayList.size();
    ...
    public final void writeToParcel(Parcel parcel, int i10) {
        ...
        e0.l(parcel, 2, this.f7516a);
        e0.n(parcel, 3, DesugarCollections.unmodifiableList(this.f7517b));
        e0.s(parcel, 4, 4);
        parcel.writeInt(this.f7518c ? 1 : 0);
        e0.k(parcel, 5, this.d, i10);
        e0.s(parcel, 6, 4);
        parcel.writeInt(this.e ? 1 : 0);
        e0.k(parcel, 7, this.f7519f, i10);
        e0.s(parcel, 8, 4);
        parcel.writeInt(this.h ? 1 : 0);
        e0.s(parcel, 9, 8);
        parcel.writeDouble(this.f7520n);
        e0.s(parcel, 10, 4);
        parcel.writeInt(this.f7521r ? 1 : 0);
        e0.s(parcel, 11, 4);
        parcel.writeInt(this.f7522s ? 1 : 0);
        e0.s(parcel, 12, 4);
        parcel.writeInt(this.v ? 1 : 0);
        e0.n(parcel, 13, DesugarCollections.unmodifiableList(this.f7523w));
        e0.s(parcel, 14, 4);
