...
public final class a {
    public static final Object f43009b = new Object();
    public static volatile a f43010c;
    public final ConcurrentHashMap f43011a = new ConcurrentHashMap();

    public static a a() {
        if (f43010c == null) {
            synchronized (f43009b) {
                try {
                    if (f43010c == null) {
                        f43010c = new a();
                    }
    ...
    public final void b(Context context, ServiceConnection serviceConnection) {
        if (!(serviceConnection instanceof h0)) {
            ConcurrentHashMap concurrentHashMap = this.f43011a;
    ...
    public final boolean c(Context context, String str, Intent intent, ServiceConnection serviceConnection, int i10, Executor executor) {
        ...
        if (component != null) {
            ...
            try {
                if ((b.a(context).f43813a.getPackageManager().getApplicationInfo(packageName, 0).flags & 2097152) != 0) {
