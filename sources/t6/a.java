...
public final class a {
    public static final Object f46431b = new Object();
    public static volatile a f46432c;
    public final ConcurrentHashMap f46433a = new ConcurrentHashMap();

    public static a a() {
        if (f46432c == null) {
            synchronized (f46431b) {
                try {
                    if (f46432c == null) {
                        f46432c = new a();
                    }
    ...
    public final void b(Context context, ServiceConnection serviceConnection) {
        if (!(serviceConnection instanceof h0)) {
            ConcurrentHashMap concurrentHashMap = this.f46433a;
    ...
    public final boolean c(Context context, String str, Intent intent, ServiceConnection serviceConnection, int i10, Executor executor) {
        ...
        if (component != null) {
            ...
            try {
                if ((b.a(context).f14823a.getPackageManager().getApplicationInfo(packageName, 0).flags & 2097152) != 0) {
