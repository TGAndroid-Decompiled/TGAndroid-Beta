...
public final class a {
    public static final Object f46458b = new Object();
    public static volatile a f46459c;
    public final ConcurrentHashMap f46460a = new ConcurrentHashMap();

    public static a a() {
        if (f46459c == null) {
            synchronized (f46458b) {
                try {
                    if (f46459c == null) {
                        f46459c = new a();
                    }
    ...
    public final void b(Context context, ServiceConnection serviceConnection) {
        if (!(serviceConnection instanceof h0)) {
            ConcurrentHashMap concurrentHashMap = this.f46460a;
    ...
    public final boolean c(Context context, String str, Intent intent, ServiceConnection serviceConnection, int i10, Executor executor) {
        ...
        if (component != null) {
            ...
            try {
                if ((b.a(context).f14849a.getPackageManager().getApplicationInfo(packageName, 0).flags & 2097152) != 0) {
