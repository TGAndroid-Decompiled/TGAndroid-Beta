...
public abstract class CompletionStateKt {
    ...
    public static final Object toState(Object obj, Function1 function1) {
        ...
        if (thM285exceptionOrNullimpl == null) {
            return function1 != null ? new CompletedWithCancellation(obj, function1) : obj;
        }
        return new CompletedExceptionally(thM285exceptionOrNullimpl, false, 2, null);
    }

    public static final Object toState(Object obj, CancellableContinuation cancellableContinuation) {
        Throwable thM285exceptionOrNullimpl = Result.m285exceptionOrNullimpl(obj);
        return thM285exceptionOrNullimpl == null ? obj : new CompletedExceptionally(thM285exceptionOrNullimpl, false, 2, null);
    }

    public static final Object recoverResult(Object obj, Continuation continuation) {
        if (obj instanceof CompletedExceptionally) {
            Result.Companion companion = Result.Companion;
            return Result.m283constructorimpl(ResultKt.createFailure(((CompletedExceptionally) obj).cause));
        }
