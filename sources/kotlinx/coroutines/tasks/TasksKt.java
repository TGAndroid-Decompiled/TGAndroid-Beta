        ...
        task.addOnCompleteListener(DirectExecutor.INSTANCE, new OnCompleteListener() {
            ...
            public final void onComplete(Task task2) {
                ...
                if (exception2 == null) {
                    ...
                    cancellableContinuation.resumeWith(Result.m213constructorimpl(task2.getResult()));
                    return;
                }
                CancellableContinuation cancellableContinuation2 = CancellableContinuation.this;
                Result.Companion companion2 = Result.Companion;
                cancellableContinuation2.resumeWith(Result.m213constructorimpl(ResultKt.createFailure(exception2)));
            }
        });
