        ...
        try {
            ...
            try {
                ...
                if (objWrapWithContinuationImpl != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                    continuationProbeCoroutineCreated.resumeWith(Result.m283constructorimpl(objWrapWithContinuationImpl));
                }
            } catch (Throwable th) {
                ThreadContextKt.restoreThreadContext(context, objUpdateThreadContext);
                throw th;
            ...
            continuationProbeCoroutineCreated.resumeWith(Result.m283constructorimpl(ResultKt.createFailure(th2)));
        }
    }
