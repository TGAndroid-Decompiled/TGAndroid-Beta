...
public abstract class CancellableKt {
    ...
    public static final void startCoroutineCancellable(Function2 function2, Object obj, Continuation continuation, Function1 function1) throws Throwable {
        try {
            ...
            DispatchedContinuationKt.resumeCancellableWith(continuationIntercepted, Result.m275constructorimpl(Unit.INSTANCE), function1);
        } catch (Throwable th) {
    ...
    public static final void startCoroutineCancellable(Continuation continuation, Continuation continuation2) throws Throwable {
        try {
            ...
            Result.Companion companion = Result.Companion;
            DispatchedContinuationKt.resumeCancellableWith$default(continuationIntercepted, Result.m275constructorimpl(Unit.INSTANCE), null, 2, null);
        } catch (Throwable th) {
