...
public class BufferedChannel implements Channel {
    ...
    @Override
    public java.lang.Object mo252trySendJP2dKIU(java.lang.Object r15) {
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.channels.BufferedChannel.mo252trySendJP2dKIU(java.lang.Object):java.lang.Object");
    }
    ...
    public final void onClosedReceiveOnNoWaiterSuspend(CancellableContinuation cancellableContinuation) {
        ...
        cancellableContinuation.resumeWith(Result.m213constructorimpl(ResultKt.createFailure(getReceiveException())));
    }

    @Override
    public Object mo251tryReceivePtdJZtk() {
        Object obj;
        ...
        if (isClosedForReceive0(j2)) {
            return ChannelResult.Companion.m258closedJP2dKIU(getCloseCause());
        }
            ...
            while (!isClosedForReceive()) {
                ...
                if (updateCellReceive != symbol) {
                    ...
                    if (updateCellReceive != symbol2) {
                        ...
                        channelSegment.cleanPrev();
                        return ChannelResult.Companion.m260successJP2dKIU(updateCellReceive);
                    }
                    ...
                    return ChannelResult.Companion.m259failurePtdJZtk();
                }
            }
            return ChannelResult.Companion.m258closedJP2dKIU(getCloseCause());
        }
    ...
    private final void cancelSuspendedReceiveRequests(ChannelSegment channelSegment, long j) {
        Symbol symbol;
        Object m267constructorimpl$default = InlineList.m267constructorimpl$default(null, 1, null);
                        ...
                        if (state$kotlinx_coroutines_core != symbol) {
                            if (state$kotlinx_coroutines_core instanceof WaiterEB) {
                                if (channelSegment.casState$kotlinx_coroutines_core(i, state$kotlinx_coroutines_core, BufferedChannelKt.getCHANNEL_CLOSED())) {
                                    m267constructorimpl$default = InlineList.m268plusFjFbRPM(m267constructorimpl$default, ((WaiterEB) state$kotlinx_coroutines_core).waiter);
                                    channelSegment.onCancelledRequest(i, true);
                                    break;
                                }
                            } else {
                                ...
                                if (channelSegment.casState$kotlinx_coroutines_core(i, state$kotlinx_coroutines_core, BufferedChannelKt.getCHANNEL_CLOSED())) {
                                    m267constructorimpl$default = InlineList.m268plusFjFbRPM(m267constructorimpl$default, state$kotlinx_coroutines_core);
                                    channelSegment.onCancelledRequest(i, true);
                                    break;
                                }
                            }
        ...
        if (m267constructorimpl$default != null) {
            if (m267constructorimpl$default instanceof ArrayList) {
                Intrinsics.checkNotNull(m267constructorimpl$default, "null cannot be cast to non-null type java.util.ArrayList<E of kotlinx.coroutines.internal.InlineList>{ kotlin.collections.TypeAliasesKt.ArrayList<E of kotlinx.coroutines.internal.InlineList> }");
                ArrayList arrayList = (ArrayList) m267constructorimpl$default;
                for (int size = arrayList.size() - 1; -1 < size; size--) {
                    resumeReceiverOnClosedChannel((Waiter) arrayList.get(size));
                }
                return;
            }
            resumeReceiverOnClosedChannel((Waiter) m267constructorimpl$default);
        }
    }
    ...
    public final ChannelSegment findSegmentSend(long j, ChannelSegment channelSegment) {
        ...
        loop0: while (true) {
            ...
            if (!SegmentOrClosed.m271isClosedimpl(findSegmentInternal)) {
                Segment m270getSegmentimpl = SegmentOrClosed.m270getSegmentimpl(findSegmentInternal);
                while (true) {
                    Segment segment = (Segment) atomicReferenceFieldUpdater.get(this);
                    if (segment.id >= m270getSegmentimpl.id) {
                        break loop0;
                    }
                    if (!m270getSegmentimpl.tryIncPointers$kotlinx_coroutines_core()) {
                        break;
                    }
                    if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater, this, segment, m270getSegmentimpl)) {
                        if (segment.decPointers$kotlinx_coroutines_core()) {
                            segment.remove();
                        }
                    } else if (m270getSegmentimpl.decPointers$kotlinx_coroutines_core()) {
                        m270getSegmentimpl.remove();
                    }
                }
            } else {
                break;
        ...
        ChannelSegment channelSegment2 = (ChannelSegment) SegmentOrClosed.m270getSegmentimpl(findSegmentInternal);
