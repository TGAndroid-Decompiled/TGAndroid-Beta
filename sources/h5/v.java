...
public final class v {
    ...
    public void a() {
        ...
        switch (this.f6996a) {
            ...
            default:
                int i13 = this.d;
                if (i13 >= 0 && (i13 < (i11 = this.f6998c) || (i13 == i11 && this.e == 0))) {
                    z10 = true;
                } else {
                    z10 = false;
                }
    ...
    public int b() {
        return ((this.e - this.f6998c) * 8) - this.d;
    }
    ...
    public boolean e() {
        ...
        int i11 = this.e;
        int i12 = 0;
        while (this.d < this.f6998c && !h()) {
            i12++;
        }
        if (this.d == this.f6998c) {
            z4 = true;
        } else {
            z4 = false;
        }
    ...
    public boolean h() {
        ...
        switch (this.f6996a) {
            case 0:
                if ((this.f6997b[this.f6998c] & (128 >> this.d)) != 0) {
                    z4 = true;
                } else {
                    z4 = false;
                }
                ...
                return z4;
            case 1:
                if ((this.f6997b[this.d] & (128 >> this.e)) != 0) {
                    z10 = true;
                } else {
                    z10 = false;
                }
                ...
                return z10;
            default:
                if ((((this.f6997b[this.d] & 255) >> this.e) & 1) == 1) {
                    z11 = true;
                } else {
                    z11 = false;
                }
            ...
            case 0:
                ...
                while (true) {
                    ...
                    if (i12 > 8) {
                        int i13 = i12 - 8;
                        this.d = i13;
                        byte[] bArr = this.f6997b;
                        int i14 = this.f6998c;
                        this.f6998c = i14 + 1;
                        i11 |= (bArr[i14] & 255) << i13;
                    } else {
                        byte[] bArr2 = this.f6997b;
                        int i15 = this.f6998c;
    ...
    public void k(int i10, byte[] bArr) {
        ...
        a.i(z4);
        System.arraycopy(this.f6997b, this.f6998c, bArr, 0, i10);
        this.f6998c += i10;
        a();
    }
    ...
    public void s(int i10) {
        ...
        switch (this.f6996a) {
            ...
            default:
                ...
                int i22 = this.d;
                if (i22 < 0 || (i22 >= (i11 = this.f6998c) && (i22 != i11 || this.e != 0))) {
                    z4 = false;
                }
                a.i(z4);
                return;
