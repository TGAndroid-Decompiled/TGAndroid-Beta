...
public final class w {
    ...
    public static final s8.z f6986f = s8.z.t(5, r8.d.f43411a, r8.d.f43413c, r8.d.f43414f, r8.d.d, r8.d.e);
    public byte[] f6987a;
    public int f6988b;
    public int f6989c;

    public w() {
        this.f6987a = d0.f6927f;
    }
    ...
    public final long A() {
        ...
        byte b10;
        int i12;
        long j10 = this.f6987a[this.f6988b];
        int i13 = 7;
        while (true) {
            if (i13 < 0) {
                break;
        ...
        if (i11 != 0) {
            for (i10 = 1; i10 < i11; i10++) {
                if ((this.f6987a[this.f6988b + i10] & 192) == 128) {
                    j10 = (j10 << 6) | (b10 & 63);
                } else {
    ...
    public final void E(int i10) {
        boolean z4;
        if (i10 >= 0 && i10 <= this.f6987a.length) {
            z4 = true;
        } else {
            z4 = false;
        }
    ...
    public final int a() {
        return this.f6989c - this.f6988b;
    }

    public final void b(int i10) {
        byte[] bArr = this.f6987a;
        if (i10 > bArr.length) {
            this.f6987a = Arrays.copyOf(bArr, i10);
        }
    }

    public final char c(Charset charset) {
        boolean contains = f6986f.contains(charset);
    ...
    public final int d(Charset charset) {
        ...
        byte b12;
        boolean z10 = false;
        if ((charset.equals(r8.d.f43413c) || charset.equals(r8.d.f43411a)) && a() >= 1) {
            long j10 = this.f6987a[this.f6988b] & 255;
            char c3 = (char) j10;
            if (c3 == j10) {
                z4 = true;
            } else {
            ...
            i10 = 2;
            if ((charset.equals(r8.d.f43414f) || charset.equals(r8.d.d)) && a() >= 2) {
                byte[] bArr = this.f6987a;
                int i11 = this.f6988b;
                b11 = bArr[i11];
                b12 = bArr[i11 + 1];
    ...
    public final void e(int i10, int i11, byte[] bArr) {
        System.arraycopy(this.f6987a, this.f6988b, bArr, i10, i11);
        this.f6988b += i11;
    }
    ...
    public final String h(Charset charset) {
        ...
        Charset charset2 = r8.d.f43411a;
        if (!charset.equals(charset2)) {
            B();
        }
        if (!charset.equals(r8.d.f43413c) && !charset.equals(charset2)) {
            if (!charset.equals(r8.d.f43414f) && !charset.equals(r8.d.e) && !charset.equals(r8.d.d)) {
        ...
        while (true) {
            int i12 = this.f6989c;
            if (i11 < i12 - (i10 - 1)) {
                if ((charset.equals(r8.d.f43413c) || charset.equals(r8.d.f43411a)) && d0.E(this.f6987a[i11])) {
                    break;
                }
                if (charset.equals(r8.d.f43414f) || charset.equals(r8.d.d)) {
                    byte[] bArr = this.f6987a;
        ...
        String s6 = s(i11 - this.f6988b, charset);
        if (this.f6988b != this.f6989c && f(charset, d) == '\r') {
            f(charset, e);
        }
        return s6;
    }
    ...
    public final String p() {
        ...
        int i10 = this.f6988b;
        while (i10 < this.f6989c && this.f6987a[i10] != 0) {
            i10++;
        }
        byte[] bArr = this.f6987a;
        int i11 = this.f6988b;
        int i12 = d0.f6924a;
        String str = new String(bArr, i11, i10 - i11, r8.d.f43413c);
        this.f6988b = i10;
        if (i10 < this.f6989c) {
            this.f6988b = i10 + 1;
        }
    ...
    public final String q(int i10) {
        ...
        int i12 = this.f6988b;
        int i13 = (i12 + i10) - 1;
        if (i13 < this.f6989c && this.f6987a[i13] == 0) {
            i11 = i10 - 1;
        } else {
            i11 = i10;
        }
        byte[] bArr = this.f6987a;
        int i14 = d0.f6924a;
        String str = new String(bArr, i12, i11, r8.d.f43413c);
        this.f6988b += i10;
        return str;
    }
    ...
    public final String s(int i10, Charset charset) {
        String str = new String(this.f6987a, this.f6988b, i10, charset);
        this.f6988b += i10;
        return str;
    }
    ...
    public w(int i10) {
        this.f6987a = new byte[i10];
        this.f6989c = i10;
    }

    public w(byte[] bArr) {
        this.f6987a = bArr;
        this.f6989c = bArr.length;
    }
