...
public final class w {
    ...
    public final long A() {
        ...
        byte b10;
        int i12;
        long j10 = this.f7308a[this.f7309b];
        int i13 = 7;
        while (true) {
            if (i13 < 0) {
                break;
        ...
        if (i11 != 0) {
            for (i10 = 1; i10 < i11; i10++) {
                if ((this.f7308a[this.f7309b + i10] & 192) == 128) {
                    j10 = (j10 << 6) | (b10 & 63);
                } else {
    ...
    public final void E(int i10) {
        boolean z4;
        if (i10 >= 0 && i10 <= this.f7308a.length) {
            z4 = true;
        } else {
            z4 = false;
        }
    ...
    public final void b(int i10) {
        byte[] bArr = this.f7308a;
        if (i10 > bArr.length) {
            this.f7308a = Arrays.copyOf(bArr, i10);
        }
    }

    public final char c(Charset charset) {
        boolean contains = f7307f.contains(charset);
    ...
    public final void e(int i10, int i11, byte[] bArr) {
        System.arraycopy(this.f7308a, this.f7309b, bArr, i10, i11);
        this.f7309b += i11;
    }
    ...
    public final String h(Charset charset) {
        ...
        String s6 = s(i11 - this.f7309b, charset);
        if (this.f7309b != this.f7310c && f(charset, d) == '\r') {
            f(charset, f7306e);
        }
        return s6;
    }
    ...
    public final String p() {
        ...
        int i10 = this.f7309b;
        while (i10 < this.f7310c && this.f7308a[i10] != 0) {
            i10++;
        }
        byte[] bArr = this.f7308a;
        int i11 = this.f7309b;
    ...
    public final String q(int i10) {
        ...
        int i12 = this.f7309b;
        int i13 = (i12 + i10) - 1;
        if (i13 < this.f7310c && this.f7308a[i13] == 0) {
            i11 = i10 - 1;
        } else {
            i11 = i10;
        }
    ...
    public final String s(int i10, Charset charset) {
        String str = new String(this.f7308a, this.f7309b, i10, charset);
        this.f7309b += i10;
        return str;
    }
