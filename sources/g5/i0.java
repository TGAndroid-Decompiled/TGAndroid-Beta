...
public final class i0 extends Handler implements Runnable {
    ...
    public final void a(boolean z4) {
        ...
        if (z4) {
            ...
            h0 h0Var = this.d;
            h0Var.getClass();
            h0Var.s(this.f6382b, elapsedRealtime, elapsedRealtime - this.f6383c, true);
            this.d = null;
        }
    }
    ...
    public final void handleMessage(Message message) {
        if (!this.f6386r) {
            ...
            if (i10 == 0) {
                ...
                h0Var.getClass();
                if (this.f6385n) {
                    h0Var.s(this.f6382b, elapsedRealtime, j10, false);
                    return;
                }
                ...
                if (i11 != 1) {
                    if (i11 == 2) {
                        ...
                        this.f6384f = i12;
                        c4.e m9 = h0Var.m(this.f6382b, iOException, i12);
                        int i13 = m9.f2072a;
                        if (i13 == 3) {
                ...
                try {
                    h0Var.A(this.f6382b, elapsedRealtime, j10);
