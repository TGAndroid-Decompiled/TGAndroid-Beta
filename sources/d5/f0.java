...
public abstract class f0 {
    ...
    public static final String f4350b;
    public static final String f4351c;
    public static final String d;
    public static final String f4352e;
    public static final byte[] f4353f;
    public static final Pattern f4354g;
    public static final Pattern h;
    public static final Pattern f4355i;
    public static HashMap f4356j;
    public static final String[] f4357k;
    public static final String[] f4358l;
    public static final int[] f4359m;
    public static final int[] f4360n;
    ...
    static {
        ...
        d = str3;
        f4352e = str + ", " + str3 + ", " + str2 + ", " + i9;
        f4353f = new byte[0];
        f4354g = Pattern.compile("(\\d\\d\\d\\d)\\-(\\d\\d)\\-(\\d\\d)[Tt](\\d\\d):(\\d\\d):(\\d\\d)([\\.,](\\d+))?([Zz]|((\\+|\\-)(\\d?\\d):?(\\d\\d)))?");
        h = Pattern.compile("^(-)?P(([0-9]*)Y)?(([0-9]*)M)?(([0-9]*)D)?(T(([0-9]*)H)?(([0-9]*)M)?(([0-9.]*)S)?)?$");
        Pattern.compile("%([A-Fa-f0-9]{2})");
        f4355i = Pattern.compile("(?:.*\\.)?isml?(?:/(manifest(.*))?)?", 2);
        f4357k = new String[]{"alb", "sq", "arm", "hy", "baq", "eu", "bur", "my", "tib", "bo", "chi", "zh", "cze", "cs", "dut", "nl", "ger", "de", "gre", "el", "fre", "fr", "geo", "ka", "ice", "is", "mac", "mk", "mao", "mi", "may", "ms", "per", "fa", "rum", "ro", "scc", "hbs-srp", "slo", "sk", "wel", "cy", "id", "ms-ind", "iw", "he", "heb", "he", "ji", "yi", "arb", "ar-arb", "in", "ms-ind", "ind", "ms-ind", "nb", "no-nob", "nob", "no-nob", "nn", "no-nno", "nno", "no-nno", "tw", "ak-twi", "twi", "ak-twi", "bs", "hbs-bos", "bos", "hbs-bos", "hr", "hbs-hrv", "hrv", "hbs-hrv", "sr", "hbs-srp", "srp", "hbs-srp", "cmn", "zh-cmn", "hak", "zh-hak", "nan", "zh-nan", "hsn", "zh-hsn"};
        f4358l = new String[]{"i-lux", "lb", "i-hak", "zh-hak", "i-navajo", "nv", "no-bok", "no-nob", "no-nyn", "no-nno", "zh-guoyu", "zh-cmn", "zh-hakka", "zh-hak", "zh-min-nan", "zh-nan", "zh-xiang", "zh-hsn"};
    ...
    public static String I(String str) {
        ...
        String str4 = (String) f4356j.get(str2);
        if (str4 != null) {
    ...
    public static long K(String str) {
        Matcher matcher = f4354g.matcher(str);
        if (matcher.matches()) {
            int i9 = 0;
    ...
    public static String l(byte[] bArr) {
        return new String(bArr, n8.d.f18513c);
    }
    ...
    public static Point p(Context context) {
        ...
        if (display.getDisplayId() == 0 && F(context)) {
            ...
            if ("Sony".equals(f4351c) && d.startsWith("BRAVIA") && context.getPackageManager().hasSystemFeature("com.sony.dtv.hardware.panel.qfhd")) {
