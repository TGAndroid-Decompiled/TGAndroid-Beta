...
public final class q0 implements Utilities.Callback5, c2 {
    ...
    public void j(d2 d2Var, int i10) {
        switch (this.f49175a) {
            case 1:
                ...
                return;
            case 2:
                this.f49176b.finishFragment();
                return;
            default:
                v0 v0Var = this.f49176b;
                v0Var.f49219b.a(1.0f);
    ...
    public void mo27run(Object obj, Object obj2, Object obj3, Object obj4, Object obj5) {
        ...
        } else if (v0Var.f49227x != null && j51Var.f28007c != v0Var.h) {
            v0Var.f49227x = null;
            v0Var.f49218a.V2.N(true);
        } else {
            bd0 bd0Var = new bd0(8);
            if (v0Var.f49227x != null) {
                TLRPC.TL_channelLocation tL_channelLocation = new TLRPC.TL_channelLocation();
                tL_channelLocation.address = v0Var.f49228y;
                tL_channelLocation.geo_point = v0Var.f49227x;
                bd0Var.f35484x0 = tL_channelLocation;
            }
            bd0Var.C0 = new org.telegram.ui.web.m(10, v0Var, bd0Var);
            if (v0Var.f49227x == null && !TextUtils.isEmpty(v0Var.f49228y)) {
