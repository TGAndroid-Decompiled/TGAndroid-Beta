...
public final class g0 implements Runnable {
    ...
    public final l0 f49089b;

    public g0(l0 l0Var, int i10) {
        this.f49088a = i10;
        this.f49089b = l0Var;
    }
    ...
    public final void run() {
        switch (this.f49088a) {
            ...
            case 2:
                ...
                return;
            case 3:
                l0 l0Var4 = this.f49089b;
                l0Var4.f49148c.V2.N(true);
                l0Var4.Y(true);
                return;
            default:
                l0 l0Var5 = this.f49089b;
                String obj = l0Var5.f49150f.getText().toString();
                String str = l0Var5.f49156y;
                if (str == null || !TextUtils.equals(str, obj)) {
                    l0Var5.f49155x = false;
