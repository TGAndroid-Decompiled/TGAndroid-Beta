...
public final class l0 extends p2 {
    ...
    public static final int f49098a0 = -10;
    public static final int f49099b0 = -11;
    public static final int f49100c0 = -12;
    public static final int f49101d0 = -13;
    public static final int f49102e0 = -14;
    public static final int f49103f0 = -15;
    public static final int f49104g0 = -16;
    public static final int f49105h0 = -17;
    public static final int f49106i0 = -18;
    public static final int f49107j0 = -19;
    public static final int f49108k0 = -20;
    public static final int f49109l0 = -21;
    public int B;
    public final h0 C;
    ...
    public boolean Q;
    public or f49110a;
    public org.telegram.ui.ActionBar.w0 f49111b;
    public i61 f49112c;
    public uf.k1 d;
    public FrameLayout f49113e;
    public EditTextBoldCursor f49114f;
    public View h;
    public c51 f49115n;
    public TextView f49116r;
    public ImageView f49117s;
    public v v;
    public boolean f49118w;
    public boolean f49119x;
    public String f49120y;
    ...
    public static void W(l0 l0Var, j51 j51Var, final View view) {
        if (j51Var.f28010g && !l0Var.v.h(j51Var)) {
            int i10 = j51Var.d;
            if (i10 == R) {
                v vVar = l0Var.v;
                l0Var.F = true;
                ...
                l0Var.f49112c.V2.N(true);
                l0Var.Y(true);
            } else if (j51Var.f2505a == 13) {
                TLRPC.User user = (TLRPC.User) l0Var.K.get(j51Var.f28025x);
                if (user != null) {
                    if (!user.bot_business) {
                        ...
                        alertDialog$Builder.f21166a.O = LocaleController.getString(R.string.BusinessBotNotSupportedTitle);
                        alertDialog$Builder.f21166a.Q = AndroidUtilities.replaceTags(LocaleController.getString(R.string.BusinessBotNotSupportedMessage));
                        alertDialog$Builder.k(LocaleController.getString(R.string.OK), null);
                        l0Var.showDialog(alertDialog$Builder.f21166a);
                        return;
                    }
                    l0Var.J = user;
                    AndroidUtilities.hideKeyboard(l0Var.f49114f);
                    l0Var.f49112c.V2.N(true);
                    l0Var.Y(true);
                }
            } else if (i10 == U) {
                ...
                l0Var.f49112c.V2.N(true);
                l0Var.Y(true);
            } else if (i10 == f49098a0) {
                boolean z14 = !l0Var.N;
                l0Var.N = z14;
                ((r8) view).setChecked(z14);
                l0Var.f49112c.V2.N(true);
            } else if (i10 == f49099b0) {
                    ...
                    public final void run() {
                        switch (r3) {
                            ...
                            default:
                                ...
                                ((z1) view).c(z23, true);
                                l0Var7.f49112c.V2.N(true);
                                l0Var7.Y(true);
                                return;
                        }
                    }
                });
            } else if (i10 == f49103f0) {
                boolean z18 = !l0Var.O;
                l0Var.O = z18;
                ((r8) view).setChecked(z18);
                l0Var.f49112c.V2.N(true);
            } else if (i10 == f49104g0) {
    ...
    public final void X(int i10, boolean z4, final Runnable runnable) {
        if (!this.H && i10 == f49102e0 && z4) {
        ...
        } else if (!this.I && z4 && (i10 == f49105h0 || i10 == f49106i0 || i10 == f49107j0 || i10 == f49108k0)) {
            ...
            d2 d2Var2 = alertDialog$Builder2.f21166a;
            d2Var2.O = string2;
    ...
    public final void Y(boolean z4) {
        ...
        boolean Z2 = Z();
        this.f49111b.setEnabled(Z2);
        float f14 = 0.0f;
        if (z4) {
            ViewPropertyAnimator animate = this.f49111b.animate();
            if (Z2) {
                f12 = 1.0f;
            } else {
                f12 = 0.0f;
        ...
        org.telegram.ui.ActionBar.w0 w0Var = this.f49111b;
        if (Z2) {
            f10 = 1.0f;
        } else {
            f10 = 0.0f;
        ...
        w0Var.setAlpha(f10);
        org.telegram.ui.ActionBar.w0 w0Var2 = this.f49111b;
        if (Z2) {
            f11 = 1.0f;
        } else {
            f11 = 0.0f;
        ...
        org.telegram.ui.ActionBar.w0 w0Var3 = this.f49111b;
        if (Z2) {
            f14 = 1.0f;
        }
    ...
    public final void a0() {
        ...
        if (this.f49110a.f29840c <= 0.0f) {
            if (!Z()) {
                finishFragment();
            } else if (this.v.k(this.f49112c)) {
                TLRPC.User user2 = this.J;
                if (user2 != null && ((tL_connectedBot = this.E) == null || tL_connectedBot.bot_id != user2.f20990id)) {
                    z4 = true;
                } else {
                    z4 = false;
                }
                ...
                if (tL_connectedBot2 != null && ((user = this.J) == null || tL_connectedBot2.bot_id != user.f20990id)) {
                ...
                if (this.J != null) {
                    ...
                    if (tL_connectedBot3 != null) {
                        tL_connectedBot3.bot_id = this.J.f20990id;
    ...
    public final void b0() {
        ...
        float f10;
        float f11;
        boolean z10 = this.f49118w;
        boolean e6 = this.d.e();
        boolean z11 = true;
        LongSparseArray longSparseArray = this.K;
        if (!e6 && !this.f49119x && longSparseArray.size() <= 0) {
            z4 = false;
        } else {
            z4 = true;
        }
        if (z10 != z4) {
            if (!this.d.e() && !this.f49119x && longSparseArray.size() <= 0) {
                z11 = false;
            }
            this.f49118w = z11;
            ViewPropertyAnimator animate = this.f49116r.animate();
            float f12 = 1.0f;
            float f13 = 0.0f;
            if (z11) {
                f10 = 0.0f;
            ...
            ViewPropertyAnimator animate2 = this.f49117s.animate();
            if (!z11) {
                f12 = 0.0f;
            }
    ...
    public final View createView(Context context) {
        ...
        this.f49110a = new or(mutate, new tp(k6.w0(null, i12, false)));
        this.f49111b = this.actionBar.n().i(AndroidUtilities.dp(56.0f), LocaleController.getString(R.string.Done), this.f49110a);
        Y(false);
        ...
        this.f49114f = editTextBoldCursor;
        editTextBoldCursor.setTextSize(1, 17.0f);
        this.f49114f.setHintTextColor(k6.w0(null, k6.H6, false));
        EditTextBoldCursor editTextBoldCursor2 = this.f49114f;
        int i13 = k6.G6;
        editTextBoldCursor2.setTextColor(k6.w0(null, i13, false));
        this.f49114f.setBackgroundDrawable(null);
        this.f49114f.setMaxLines(1);
        this.f49114f.setLines(1);
        this.f49114f.setPadding(0, 0, 0, 0);
        this.f49114f.setSingleLine(true);
        EditTextBoldCursor editTextBoldCursor3 = this.f49114f;
        ...
        this.f49114f.setInputType(180224);
        this.f49114f.setImeOptions(6);
        this.f49114f.setHint(LocaleController.getString(R.string.BusinessBotLink));
        this.f49114f.setCursorColor(k6.w0(null, i13, false));
        this.f49114f.setCursorSize(AndroidUtilities.dp(19.0f));
        this.f49114f.setCursorWidth(1.5f);
        this.f49114f.setOnEditorActionListener(new mh.j(this, 1));
        this.f49114f.addTextChangedListener(new eh.c(this, 18));
        FrameLayout frameLayout2 = new FrameLayout(context);
        this.f49113e = frameLayout2;
        frameLayout2.addView(this.f49114f, c6.d(-1, -1.0f, 48, 21.0f, 15.0f, 21.0f, 15.0f));
        FrameLayout frameLayout3 = this.f49113e;
        int i14 = k6.f21659d6;
        frameLayout3.setBackgroundColor(getThemedColor(i14));
        View view = new View(context);
        this.h = view;
        view.setBackgroundColor(getThemedColor(k6.f21660d7));
        FrameLayout frameLayout4 = this.f49113e;
        View view2 = this.h;
        ...
        this.f49115n = c51Var;
        c51Var.setBackgroundColor(getThemedColor(i14));
        TextView textView = new TextView(context);
        this.f49116r = textView;
        textView.setText(LocaleController.getString(R.string.BusinessBotNotFound));
        this.f49116r.setTextSize(1, 14.0f);
        TextView textView2 = this.f49116r;
        int i16 = k6.f22053z6;
        textView2.setTextColor(getThemedColor(i16));
        this.f49115n.addView(this.f49116r, c6.e(-2, -2, 17));
        this.f49117s = new ImageView(context);
        y6 y6Var = new y6(getThemedColor(i16));
        this.f49117s.setScaleType(ImageView.ScaleType.CENTER);
        this.f49117s.setImageDrawable(y6Var);
        this.f49115n.addView(this.f49117s, c6.e(-2, -2, 17));
        this.f49117s.setAlpha(0.0f);
        this.f49117s.setTranslationY(AndroidUtilities.dp(8.0f));
        uf.k1 k1Var = new uf.k1(true);
        this.d = k1Var;
        k1Var.f48618a = new org.telegram.ui.Cells.f1(this, 24);
    ...
    public final boolean onBackPressed(boolean z4) {
        if (Z()) {
            if (z4) {
                ...
                alertDialog$Builder.f21166a.Q = LocaleController.getString(R.string.BusinessBotUnsavedChanges);
        ...
        } else if (this.J != null || Z() || (this.d.d.isEmpty() && this.d.f48621e.isEmpty())) {
            return super.onBackPressed(z4);
        } else {
            if (z4) {
                AlertDialog$Builder alertDialog$Builder2 = new AlertDialog$Builder(getParentActivity());
                alertDialog$Builder2.f21166a.O = LocaleController.getString(R.string.BusinessBotNoAddedTitle);
                alertDialog$Builder2.f21166a.Q = LocaleController.getString(R.string.BusinessBotNoAddedText);
    ...
    public final void onInsets(int i10, int i11, int i12, int i13) {
        this.f49112c.setPadding(0, 0, 0, i13);
        this.f49112c.setClipToPadding(false);
    }
}
