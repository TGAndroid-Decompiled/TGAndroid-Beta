...
public final class l extends g {
    ...
    public final void k(android.graphics.Canvas r26) {
        throw new UnsupportedOperationException("Method not decompiled: vf.l.k(android.graphics.Canvas):void");
    }
                ...
                if (!z10 && fVar.f46960o == 0.0f) {
                    ...
                    while (true) {
                        ...
                        if (j10 < 0) {
                            ...
                            arrayList2 = arrayList3;
                            float f14 = this.f45745z0 * bVar2.f46538b[i14];
                            ...
                            if (z11) {
                                ...
                                f12 = f11;
                                f13 = (float) bVar2.f46540f;
                            }
                            float f15 = (1.0f - ((((float) j10) - f13) / (f12 - f13))) * this.f45744y0;
                            if (z4) {
                                if (i13 == 0) {
                                    float f16 = f10 / 2.0f;
                                    fArr2[i13] = f14 - f16;
                    ...
                    if (fVar.f46959n || fVar.f46960o != 0.0f) {
                        ...
                        if (z4) {
                            canvas.drawLines(fArr2, 0, fVar.f46955j, paint);
                        } else {
