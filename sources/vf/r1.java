...
public final class r1 extends p2 implements NotificationCenter.NotificationCenterDelegate {
    public i61 f49184a;
    public LinearLayout f49185b;
    public v1 f49186c;
    public boolean d;
    public String f49187e;
    public String f49188f;
    public boolean h;
    public String f49189n;
    ...
    public static void U(r1 r1Var, j51 j51Var, View view) {
        if (j51Var.d == -1) {
            ...
            r1Var.h = !z4;
            if (!z4) {
                String str = r1Var.f49188f;
                r1Var.f49189n = str;
                v1 v1Var = r1Var.f49186c;
                if (v1Var != null) {
                    v1Var.run(str);
                }
            }
    ...
    public static void V(r1 r1Var, ArrayList arrayList, x51 x51Var) {
        boolean z4;
        boolean z10;
        if (r1Var.d && !TextUtils.isEmpty(r1Var.f49187e)) {
            z4 = true;
        } else {
            z4 = false;
        }
        ...
        if (!z4) {
            ...
            x51Var.T();
            arrayList.add(j51.B(LocaleController.formatString(R.string.TimezoneDetectAutomaticallyInfo, b10.d(r1Var.f49189n, true))));
        }
        x51Var.U();
        if (!z4) {
        ...
        while (true) {
            ...
            if (z4) {
                ...
                String lowerCase = AndroidUtilities.translitSafe(r1Var.f49187e).toLowerCase();
                if (y3.w(" ", lowerCase, replace) || replace.startsWith(lowerCase)) {
                    e6 = AndroidUtilities.highlightText(e6, r1Var.f49187e, r1Var.resourceProvider);
                } else {
                    i10++;
                }
            }
            ...
            j51Var2.f28014l = e6;
            j51Var2.f28016n = f10;
            j51Var2.K(TextUtils.equals(tL_timezone.f20981id, r1Var.f49189n));
            if (r1Var.h && !z4) {
                z10 = false;
            } else {
                z10 = true;
        ...
        x51Var.T();
        if (z11) {
            arrayList.add(j51.l(r1Var.f49185b));
        } else {
    ...
    public final View createView(Context context) {
        ...
        this.f49184a = i61Var;
        i61Var.p1();
        this.actionBar.setAdaptiveBackground(this.f49184a);
        frameLayout.addView(this.f49184a, c6.c(-1.0f, -1));
        this.f49184a.setOnScrollListener(new nb0(this, 21));
        LinearLayout linearLayout = new LinearLayout(context);
        this.f49185b = linearLayout;
        linearLayout.setOrientation(1);
        this.f49185b.setMinimumHeight(AndroidUtilities.dp(500.0f));
        ...
        this.f49185b.addView(p9Var, c6.t(130, 130, 49, 0, 42, 0, 12));
        TextView textView = new TextView(context);
        textView.setText(LocaleController.getString(R.string.TimezoneNotFound));
        org.telegram.ui.b.l(k6.f22036y6, this.resourceProvider, textView, 1, 15.0f);
        this.f49185b.addView(textView, c6.t(-2, -2, 49, 0, 0, 0, 0));
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        i61 i61Var;
        x51 x51Var;
        if (i10 == NotificationCenter.timezonesUpdated && (i61Var = this.f49184a) != null && (x51Var = i61Var.V2) != null) {
            x51Var.N(true);
        }
    }
    ...
    public final boolean onFragmentCreate() {
        ...
        this.f49188f = c3;
        this.h = TextUtils.equals(c3, this.f49189n);
    ...
    public final void onInsets(int i10, int i11, int i12, int i13) {
        this.f49184a.setPadding(0, 0, 0, i13);
        this.f49184a.setClipToPadding(false);
    }
}
