...
public final class t {
    public static volatile t[] f49236e = new t[4];
    public static final Object[] f49237f = new Object[4];
    public final int f49238a;
    public final ArrayList f49239b = new ArrayList();
    public boolean f49240c = false;
    public boolean d = false;

    static {
        for (int i10 = 0; i10 < 4; i10++) {
            f49237f[i10] = new Object();
        }
    }
    ...
    public final void a(q qVar, String str) {
        ...
        if (c3 != null) {
            ...
            arrayList.remove(c3);
            NotificationCenter.getInstance(this.f49238a).lambda$postNotificationNameOnUIThread$1(NotificationCenter.businessLinksUpdated, new Object[0]);
    ...
    public final void b(TL_account.TL_businessChatLink tL_businessChatLink, TL_account.TL_inputBusinessChatLink tL_inputBusinessChatLink, id idVar) {
        ...
        ConnectionsManager.getInstance(this.f49238a).sendRequest(editbusinesschatlink, new hg.y(this, tL_businessChatLink, idVar, 25));
    }
    ...
    public final void f() {
        ArrayList arrayList = new ArrayList(this.f49239b);
        MessagesStorage messagesStorage = MessagesStorage.getInstance(this.f49238a);
