...
public final class p {
    public TL_account.TL_businessChatLink f49202a;

    public final boolean equals(Object obj) {
        TL_account.TL_businessChatLink tL_businessChatLink = this.f49202a;
        if (this == obj) {
            return true;
        }
        if (obj != null && p.class == obj.getClass()) {
            TL_account.TL_businessChatLink tL_businessChatLink2 = ((p) obj).f49202a;
