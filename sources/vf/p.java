...
public final class p {
    public TL_account.TL_businessChatLink f49166a;

    public final boolean equals(Object obj) {
        TL_account.TL_businessChatLink tL_businessChatLink = this.f49166a;
        if (this == obj) {
            return true;
        }
        if (obj != null && p.class == obj.getClass()) {
            TL_account.TL_businessChatLink tL_businessChatLink2 = ((p) obj).f49166a;
