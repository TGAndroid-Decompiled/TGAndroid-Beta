...
public final class s1 {
    public static volatile s1[] f49231e = new s1[4];
    public static final Object[] f49232f = new Object[4];
    ...
    public static s1 b(int i10) {
        s1 s1Var;
        s1 s1Var2 = f49231e[i10];
        if (s1Var2 == null) {
            synchronized (f49232f[i10]) {
                try {
                    s1Var = f49231e[i10];
                    if (s1Var == null) {
                        s1[] s1VarArr = f49231e;
    ...
    public final TLRPC.TL_timezone a(String str) {
        ...
        while (true) {
            ...
            if (TextUtils.equals(tL_timezone.f20983id, str)) {
                return tL_timezone;
            }
            i10++;
        }
    ...
    public final java.lang.String c() {
        throw new UnsupportedOperationException("Method not decompiled: vf.s1.c():java.lang.String");
    }
