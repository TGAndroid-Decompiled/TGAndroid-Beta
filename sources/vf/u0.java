...
public final class u0 extends View {
    public final Drawable f49241a;
    public final ImageReceiver f49242b;

    public u0(v0 v0Var, Context context) {
        super(context);
        this.f49241a = getContext().getResources().getDrawable(R.drawable.map_pin_photo).mutate();
        z8 z8Var = new z8((g6) null);
        ImageReceiver imageReceiver = new ImageReceiver(this);
        this.f49242b = imageReceiver;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        Drawable drawable = this.f49241a;
        drawable.setBounds(0, 0, dp, dp2);
        drawable.draw(canvas);
        int dp3 = AndroidUtilities.dp(62.0f);
        ImageReceiver imageReceiver = this.f49242b;
