...
public final class g1 extends EditTextBoldCursor {
    public final c5 f49055b;
    public int f49056c;
    public final j6 d;
    public final g6 f49057e;

    public g1(Context context, g6 g6Var) {
        super(context);
        this.f49057e = g6Var;
        this.f49055b = new c5(this);
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        int a2 = this.f49055b.a(k6.v0(i10, this.f49057e), false);
        j6 j6Var = this.d;
        j6Var.r(a2);
    ...
    public final void onTextChanged(CharSequence charSequence, int i10, int i11, int i12) {
        ...
        j6 j6Var = this.d;
        if (j6Var != null) {
            this.f49056c = 32 - charSequence.length();
            j6Var.b();
            String str = "";
            if (this.f49056c <= 4) {
                str = "" + this.f49056c;
