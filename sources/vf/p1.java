...
public final class p1 {
    public static volatile p1[] f49169g = new p1[4];
    public static final Object[] h = new Object[4];
    public final int f49170a;
    public final ArrayList f49171b = new ArrayList();
    public final ArrayList f49172c = new ArrayList();
    ...
    public final void a(String str) {
        o1 o1Var;
        ArrayList arrayList = this.f49172c;
        ...
        while (true) {
            if (i10 < size) {
                ...
                i10++;
                o1Var = (o1) obj;
                if (TextUtils.equals(str, o1Var.f49160b)) {
                    break;
                }
            } else {
                o1Var = null;
        ...
        if (o1Var != null) {
            ...
            NotificationCenter.getInstance(this.f49170a).lambda$postNotificationNameOnUIThread$1(NotificationCenter.quickRepliesUpdated, new Object[0]);
        }
    }
    ...
    public final o1 c(long j10) {
        ArrayList arrayList = this.f49171b;
        int size = arrayList.size();
        int i10 = 0;
        while (i10 < size) {
            Object obj = arrayList.get(i10);
    ...
    public final ArrayList e() {
        ...
        int i10 = 0;
        while (true) {
            ArrayList arrayList2 = this.f49171b;
            if (i10 < arrayList2.size()) {
                if (!g(((o1) arrayList2.get(i10)).f49160b)) {
                            ...
                            for (int i12 = 0; i12 < arrayList.size(); i12++) {
                                ...
                                while (true) {
                                    if (i13 < arrayList3.size()) {
                                        if (((o1) arrayList3.get(i13)).f49159a == tL_quickReply.shortcut_id) {
                                ...
                                o1Var.f49159a = tL_quickReply.shortcut_id;
                                o1Var.f49160b = tL_quickReply.shortcut;
                                o1Var.f49163f = tL_quickReply.count;
                                o1Var.f49161c = i12;
                                o1Var.d = tL_quickReply.top_message;
                                MessageObject messageObject = o1Var.f49162e;
                                if (messageObject != null && messageObject.getId() != tL_quickReply.top_message) {
                                    o1Var.f49162e = null;
                                }
                                arrayList2.add(o1Var);
                                p1Var.a(o1Var.f49160b);
                            }
                            p1Var.l();
                            NotificationCenter.getInstance(p1Var.f49170a).lambda$postNotificationNameOnUIThread$1(NotificationCenter.quickRepliesUpdated, new Object[0]);
                            return;
                        case 1:
                            p1 p1Var2 = this.f49149b;
                            ArrayList arrayList4 = p1Var2.f49171b;
                            int i14 = p1Var2.f49170a;
                            ...
                            if (c3 != null) {
                                c3.f49160b = tL_quickReply2.shortcut;
                                c3.f49163f = tL_quickReply2.count;
                                c3.d = tL_quickReply2.top_message;
                                MessageObject messageObject2 = c3.f49162e;
                                ...
                                o1 o1Var2 = new o1();
                                o1Var2.f49159a = tL_quickReply2.shortcut_id;
                                o1Var2.f49160b = tL_quickReply2.shortcut;
                                o1Var2.f49163f = tL_quickReply2.count;
                                o1Var2.d = tL_quickReply2.top_message;
                                for (int i15 = 0; i15 < arrayList4.size(); i15++) {
                                    ((o1) arrayList4.get(i15)).f49161c = i15;
                                }
                                arrayList4.add(o1Var2);
                                p1Var2.a(o1Var2.f49160b);
                            }
                            p1Var2.l();
                            ...
                            return;
                        case 2:
                            p1 p1Var3 = this.f49149b;
                            int i16 = p1Var3.f49170a;
                            o1 c10 = p1Var3.c(((TL_update.TL_updateDeleteQuickReply) update).shortcut_id);
                            if (c10 != null) {
                                p1Var3.f49171b.remove(c10);
                                p1Var3.a(c10.f49160b);
                                int i17 = c10.f49159a;
                            ...
                            return;
                        default:
                            p1 p1Var4 = this.f49149b;
                            int i18 = p1Var4.f49170a;
                            ...
                            if (c11 != null) {
                                int size = c11.f49163f - tL_updateDeleteQuickReplyMessages.messages.size();
                                c11.f49163f = size;
                                if (size <= 0) {
                                    p1Var4.f49171b.remove(c11);
                                }
                                ArrayList<Integer> arrayList5 = tL_updateDeleteQuickReplyMessages.messages;
                                MessageObject messageObject3 = c11.f49162e;
                                if (messageObject3 != null) {
                                    i11 = messageObject3.getId();
                                } else {
                                    i11 = c11.d;
                                }
                                if (!arrayList5.contains(Integer.valueOf(i11)) && c11.f49162e != null) {
                                    p1Var4.l();
    ...
    public final void l() {
        MessagesStorage messagesStorage = MessagesStorage.getInstance(this.f49170a);
