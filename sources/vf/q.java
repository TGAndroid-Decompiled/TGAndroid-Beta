...
public class q extends g {
    ...
    public void k(android.graphics.Canvas r46) {
        throw new UnsupportedOperationException("Method not decompiled: vf.q.k(android.graphics.Canvas):void");
    }

    @Override
    public void n(android.graphics.Canvas r27) {
        throw new UnsupportedOperationException("Method not decompiled: vf.q.n(android.graphics.Canvas):void");
    }
    ...
    @Override
    public void q(xf.j r21) {
        throw new UnsupportedOperationException("Method not decompiled: vf.q.q(xf.j):void");
    }
