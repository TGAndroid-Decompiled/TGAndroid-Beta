...
public final class j extends Drawable implements Animator.AnimatorListener {
    ...
    public static final int[] f7138a0 = new int[2];
    public static final g f7139b0 = new g("openFactor", 0);
    public static final g f7140c0 = new g("openFactor", 1);
    ...
    public final ff.c f7142b;
    public final LinearGradient f7144f;
    public final d[] f7148w;
    public final Drawable f7149x;
    public final s1 f7150y;
    public final Paint f7143c = new Paint(1);
    public final Matrix d = new Matrix();
    public final Path e = new Path();
    public final RectF h = new RectF();
    public final RectF f7145n = new RectF();
    public final RectF f7146r = new RectF();
    public final RectF f7147s = new RectF();
    ...
    public int O = -1;
    public final ObjectAnimator W = ObjectAnimator.ofFloat(this, f7139b0, 1.0f).setDuration(560L);
    public final ObjectAnimator X = ObjectAnimator.ofFloat(this, f7140c0, 1.0f).setDuration(240L);
    ...
    public j(k kVar, s1 s1Var, ArrayList arrayList, ff.c cVar) {
        ...
        this.f7148w = new d[Math.min(5, arrayList.size())];
        int i10 = 0;
        while (true) {
            d[] dVarArr = this.f7148w;
            if (i10 < dVarArr.length) {
                dVarArr[i10] = new d(this, ((Long) arrayList.get(i10)).longValue());
                i10++;
            } else {
                this.f7143c.setStyle(Paint.Style.FILL);
                ...
                int v02 = j6.v0(j6.G8, this.f7150y.getResourcesProvider());
                ...
                this.f7144f = linearGradient;
                this.f7143c.setShader(linearGradient);
                ObjectAnimator objectAnimator = this.W;
                LinearInterpolator linearInterpolator = h.f7120b;
    ...
    public final void d() {
        ...
        Bitmap bitmap2;
        Bitmap bitmap3;
        this.f7150y.setHideSideButtonByQuickShare(false);
        if (!this.Q) {
            this.Q = true;
            ...
            b bVar = this.M;
            if (bVar != null && (bitmap3 = bVar.f7093c) != null) {
                bitmap3.recycle();
                bVar.f7093c = null;
            }
            for (d dVar : this.f7148w) {
                b bVar2 = dVar.f7102f;
                if (bVar2 != null && (bitmap2 = bVar2.f7093c) != null) {
                    bitmap2.recycle();
                    bVar2.f7093c = null;
                }
                b bVar3 = dVar.e;
                if (bVar3 != null && (bitmap = bVar3.f7093c) != null) {
                    bitmap.recycle();
                    bVar3.f7093c = null;
                }
            }
    ...
    public final void e(Canvas canvas, boolean z4, int i10) {
        ...
        b bVar = jVar.M;
        d[] dVarArr = jVar.f7148w;
        int i19 = 2;
        RectF rectF2 = jVar.f7146r;
        if (bVar != null && !z4) {
            bVar.setBounds((int) rectF2.left, (int) (rectF2.top - AndroidUtilities.dp(30.0f)), (int) rectF2.right, (int) rectF2.bottom);
            jVar.M.f7096i = (int) ((1.0f - h.f7121c.getInterpolation(jVar.E)) * 255.0f);
            jVar.M.draw(canvas);
            if (jVar.O != -1) {
                        ...
                        public final void p(Canvas canvas3, int i21) {
                            ...
                            switch (r2) {
                                case 0:
                                    ...
                                    dVar2.getClass();
                                    canvas3.save();
                                    canvas3.translate(-dVar2.f7104i, -dVar2.f7105j);
                                    float f24 = dVar2.f7104i;
                                    float f25 = dVar2.f7105j;
                                    ...
                                    s1 s1Var2 = dVar2.f7100b;
                                    boolean R2 = s1Var2.R2();
                                    Paint paint = dVar2.f7103g;
                                    if (paint != null) {
                                    ...
                                    if (R2 || paint != null) {
                                        int alpha3 = j6.f19949h2.getAlpha();
                                        j6.f19949h2.setAlpha((int) (alpha3 * f26));
                                        canvas3.drawRoundRect(rectF3, dp4, dp4, j6.f19949h2);
                                        j6.f19949h2.setAlpha(alpha3);
                                    }
                                    canvas3.save();
                ...
                b bVar3 = dVar.e;
                bVar3.f7096i = (int) (interpolation * 255.0f);
                bVar3.draw(canvas);
                canvas.restore();
                return;
            }
        ...
        float f23 = f10;
        float g13 = g(0.3f, 0.075f, h.f7126k.getInterpolation(jVar.D));
        Matrix matrix = jVar.d;
        matrix.reset();
        matrix.setScale(g13, g13);
        matrix.postTranslate(0.0f, rectF2.bottom);
        jVar.f7144f.setLocalMatrix(matrix);
        Paint paint = jVar.f7143c;
        paint.setAlpha((int) (h.f7125j.getInterpolation(jVar.D) * 255.0f * f23));
        RectF rectF3 = Y;
        rectF3.set(rectF2);
        rectF3.inset(-AndroidUtilities.dp(8.0f), -AndroidUtilities.dp(8.0f));
        Rect rect = Z;
        rectF3.round(rect);
        Drawable drawable = jVar.f7149x;
        drawable.setAlpha((int) (f23 * 255.0f));
        drawable.setBounds(rect);
        drawable.draw(canvas);
        boolean z12 = jVar.J;
        RectF rectF4 = jVar.f7145n;
        if (!z12) {
            canvas.save();
            canvas.translate(rectF4.left, rectF4.top);
            canvas.rotate((h.f7122f.getInterpolation(jVar.D) - h.f7123g.getInterpolation(jVar.D)) * (-40.0f), AndroidUtilities.dp(16.0f), AndroidUtilities.dp(16.0f));
        ...
        float interpolation3 = h.f7135t.getInterpolation(jVar.D) * AndroidUtilities.dp(2.0f);
        float f24 = i.f7136a + 2;
        float interpolation4 = ((h.f7132q.getInterpolation(jVar.D) * AndroidUtilities.dp(f24)) / 2.0f) - interpolation3;
        float interpolation5 = ((h.f7133r.getInterpolation(jVar.D) * AndroidUtilities.dp(f24)) / 2.0f) - interpolation3;
        float interpolation6 = ((h.f7134s.getInterpolation(jVar.D) * AndroidUtilities.dp(f24)) / 2.0f) - interpolation3;
        int i21 = 0;
        while (i21 < i19) {
            int i22 = 0;
            while (i22 < dVarArr.length) {
                if ((i21 == 0 && i22 == jVar.O) || (i21 == i14 && i22 != jVar.O)) {
                    ...
                    float dp4 = (AndroidUtilities.dp(i.f7136a + 11) * length) + rectF2.centerX();
                    ...
                    if (!z10) {
                        ...
                        i12 = i22;
                        f12 = dp4;
                        dVar2.a(canvas2, f12, centerY2, f11 + (AndroidUtilities.dp(2.0f) * dVar2.f7110o), f23);
                    } else {
                        canvas2 = canvas;
                        i12 = i22;
                        f12 = dp4;
                    }
                    float f28 = dVar2.f7110o;
                    if (f28 > 0.0f && dVar2.h != null) {
                        float f29 = (f28 * 0.15f) + 0.85f;
                        canvas2.save();
                        canvas2.scale(f29, f29, f12, centerY2);
                        float f30 = dVar2.f7110o * f23;
                        i13 = i12;
                        float D = y3.D(8, 2, dVar2.h.getWidth());
                        dVar2.f7104i = d.b(d.b(f12, D, f26, f27), D, dp5, measuredWidth) - (D / 2.0f);
                        dVar2.f7105j = centerY2 - AndroidUtilities.dp(58.0f);
                        if (dVar2.f7102f == null) {
                            j jVar2 = dVar2.f7099a;
                            if (!jVar2.Q) {
                                dVar2.f7103g = jVar2.I;
                                b bVar4 = new b(new a() {
                                    @Override
                                    public final void p(Canvas canvas3, int i212) {
                                        ...
                                        switch (r2) {
                                            case 0:
                                                ...
                                                dVar22.getClass();
                                                canvas3.save();
                                                canvas3.translate(-dVar22.f7104i, -dVar22.f7105j);
                                                float f242 = dVar22.f7104i;
                                                float f252 = dVar22.f7105j;
                                                ...
                                                s1 s1Var2 = dVar22.f7100b;
                                                boolean R2 = s1Var2.R2();
                                                Paint paint2 = dVar22.f7103g;
                                                if (paint2 != null) {
                                                ...
                                                if (R2 || paint2 != null) {
                                                    int alpha3 = j6.f19949h2.getAlpha();
                                                    j6.f19949h2.setAlpha((int) (alpha3 * f262));
                                                    canvas3.drawRoundRect(rectF32, dp42, dp42, j6.f19949h2);
                                                    j6.f19949h2.setAlpha(alpha3);
                                                }
                                                canvas3.save();
                        ...
                        b bVar5 = dVar2.f7102f;
                        if (bVar5 != null) {
                            float f31 = dVar2.f7104i;
                            float f32 = dVar2.f7105j;
                            bVar5.setBounds((int) f31, (int) f32, (int) (f31 + D), (int) (f32 + AndroidUtilities.dp(21.0f)));
                            b bVar6 = dVar2.f7102f;
                            bVar6.f7096i = (int) (f30 * 255.0f);
                            bVar6.draw(canvas2);
                        }
                        canvas2.restore();
                    } else {
    ...
    public final int h() {
        return AndroidUtilities.dp(((i.f7136a + 11) * this.f7148w.length) + 7);
    }

    @Override
    public final void onAnimationEnd(Animator animator) {
        ObjectAnimator objectAnimator = this.W;
        ff.c cVar = this.f7142b;
