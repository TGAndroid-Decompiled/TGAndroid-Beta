...
public final class g extends FrameLayout {
    ...
    public boolean L;
    public ph.g f10521a;
    public final eb f10522b;
    public final FrameLayout f10523c;
    public final f0 d;
    public boolean e;
    public ch.d f10524f;
    public ch.d h;
    public final Path f10525n;
    public int f10526r;
    ...
    public g(Context context) {
        ...
        this.f10522b = new eb(this, context, 5);
    }

    public final void a(boolean z10) {
        e();
        int round = Math.round(this.f10527s) + AndroidUtilities.dp(9.0f) + this.F;
        if (this.f10526r == round && !z10) {
            return;
        }
        this.f10526r = round;
    ...
    public final void b() {
        ...
        if (dVar != null && (i10 = dVar.getBounds().top) != (measuredHeight = getMeasuredHeight() - Math.round(this.J))) {
            ...
            this.f10522b.invalidate(0, Math.max(0, Math.min(i10, measuredHeight)), getMeasuredWidth(), getMeasuredHeight());
    ...
    public final void c() {
        int i10;
        l1 l1Var = ((ph.i) this.f10521a).f41066r;
        if (l1Var != null) {
            i10 = l1Var.f41851a.f(2).d;
        } else {
            i10 = 0;
        }
        float b10 = ((ph.i) this.f10521a).b();
        f0 f0Var = this.d;
    ...
    public final void d() {
        ...
        int i11;
        this.f10527s = ((ph.i) this.f10521a).c();
        this.v = ((ph.i) this.f10521a).b();
        int i12 = 0;
        boolean z11 = true;
        if (((ph.i) this.f10521a).f41067s != 1) {
            z10 = true;
        } else {
            z10 = false;
        }
        ...
        int i14 = ((ph.i) this.f10521a).f41068w;
        if (i13 != i14) {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        int measuredHeight = getMeasuredHeight() - this.f10526r;
        int round = Math.round(this.f10529x);
        int measuredWidth = getMeasuredWidth() - Math.round(this.f10530y);
        int i10 = this.F;
        Rect rect = this.G;
        rect.set(round, 0, measuredWidth, i10);
        rect.inset(0, -AndroidUtilities.dp(7.0f));
        rect.offset(0, measuredHeight + ((int) this.K));
        this.f10524f.setBounds(rect);
        if (this.e) {
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        if (z10) {
            canvas.save();
            canvas.clipPath(this.h.f4285j.f4274k);
        }
    ...
    public final void e() {
        this.f10523c.setTranslationY((-this.f10527s) - AndroidUtilities.dp(9.0f));
        f0 f0Var = this.d;
    ...
    public float getInputBubbleBottom() {
        return (getMeasuredHeight() - this.f10527s) - AndroidUtilities.dp(9.0f);
    }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            ch.d dVar2 = this.f10524f;
            if ((dVar2 != null && dVar2.f4287l == 255 && dVar2.getBounds().contains(x10, y3)) || ((dVar = this.h) != null && dVar.getBounds().contains(x10, y3))) {
                z10 = true;
            } else {
                z10 = false;
            }
    ...
    public void setInputIslandBubbleDrawable(ch.d dVar) {
        ...
        this.f10524f.q(AndroidUtilities.dp(22.0f));
    }
