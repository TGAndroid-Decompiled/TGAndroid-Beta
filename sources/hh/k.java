...
public final class k implements ViewTreeObserver.OnPreDrawListener, View.OnAttachStateChangeListener {
    public static final int[] f10535f = new int[2];
    public static final RectF h = new RectF();
    public final View f10536a;
    public ViewTreeObserver f10537b;
    ...
    public final boolean onPreDraw() {
        ViewTreeObserver viewTreeObserver = this.f10536a.getViewTreeObserver();
        ViewTreeObserver viewTreeObserver2 = this.f10537b;
        if (viewTreeObserver != viewTreeObserver2) {
            if (this.f10538c && viewTreeObserver2 != null && viewTreeObserver2.isAlive()) {
                this.f10537b.removeOnPreDrawListener(this);
            }
            this.f10538c = false;
            this.f10537b = null;
            a();
        ...
        if (!weakHashMap.isEmpty()) {
            for (Map.Entry entry : weakHashMap.entrySet()) {
                ...
                if (view != null && list != null) {
                    for (j jVar : list) {
                        boolean z10 = jVar.d;
                        RectF rectF = jVar.f10534c;
                        ViewGroup viewGroup = jVar.f10532a;
                        RectF rectF2 = this.e;
                        if (z10) {
                            int[] iArr = f10535f;
                        ...
                        if (!jVar.e || !rectF2.equals(rectF)) {
                            ...
                            jVar.e = true;
                            try {
                                jVar.f10533b.j(new RectF(rectF2), view);
    ...
    public final void onViewDetachedFromWindow(View view) {
        ViewTreeObserver viewTreeObserver;
        if (view == this.f10536a) {
            if (this.f10538c && (viewTreeObserver = this.f10537b) != null && viewTreeObserver.isAlive()) {
                this.f10537b.removeOnPreDrawListener(this);
            }
            this.f10538c = false;
            this.f10537b = null;
