...
public final class b {
    public final pb.b f45268a;
    public final int f45270c;
    public final int d;
    public final int e;
    public final int f45271f;
    public final float f45272g;
    public final ArrayList f45269b = new ArrayList(5);
    ...
    public final a b(int i10, int i11, int[] iArr) {
        ...
        if (!Float.isNaN(f11)) {
            ...
            ArrayList arrayList = this.f45269b;
            int size = arrayList.size();
            while (i13 < size) {
                Object obj = arrayList.get(i13);
                i13++;
                a aVar = (a) obj;
                float f13 = aVar.f45267c;
                float f14 = aVar.f16517a;
                float f15 = aVar.f16518b;
                if (Math.abs(f11 - f15) <= f12 && Math.abs(f10 - f14) <= f12) {
                    float abs = Math.abs(f12 - f13);
                    if (abs <= 1.0f || abs <= f13) {
                        return new a((f14 + f10) / 2.0f, (f15 + f11) / 2.0f, (aVar.f45267c + f12) / 2.0f);
                    }
                }
            }
