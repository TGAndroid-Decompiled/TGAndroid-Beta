...
public final class e extends i {
    ...
    @Override
    public final void b() {
        l.k(Thread.currentThread().equals(((AtomicReference) this.f41196a.d).get()));
        if (this.d == null) {
            this.f43607f.getClass();
        ...
        if (!str.isEmpty()) {
            ...
            while (true) {
                if (i10 < size) {
                    ...
                    if (!"unknown".equals(identifiedLanguage.f7358a)) {
                        str2 = identifiedLanguage.f7358a;
                        break;
                    }
                } else {
                    str2 = "";
