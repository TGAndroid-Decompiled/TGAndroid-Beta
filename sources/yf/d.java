...
public final class d {
    ...
    public final CharSequence[] f50942b;
    public final CharSequence[] f50943c;
    public final StaticLayout[] d;
    public final StaticLayout[] f50944e;
    public int f50945f;
    public int f50946g;
    ...
    public final void a(Canvas canvas, int i10, int i11, float f10, float f11, TextPaint textPaint) {
        ...
        StaticLayout[] staticLayoutArr2 = this.f50944e;
        ...
        if (staticLayout == null) {
            if (i10 == 0) {
                charSequenceArr = this.f50942b;
            } else {
                charSequenceArr = this.f50943c;
            }
