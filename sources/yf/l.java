    ...
    public static SpannableStringBuilder a(String str) {
        ...
        try {
            ...
            for (Object obj : spans) {
                ...
                if (obj instanceof StyleSpan) {
                    ...
                    if (i10 == 0) {
                        ...
                        if (!TextUtils.isEmpty(kVar.f46870b)) {
                            arrayList2.add(kVar);
                        } else {
            ...
            for (int i11 = 0; i11 < arrayList2.size(); i11++) {
                ...
                spannableStringBuilder.setSpan(new CodeHighlighting.Span(true, 0, null, kVar2.f46870b, spannableStringBuilder.subSequence(spanStart3, spanEnd3).toString()), spanStart3, spanEnd3, 33);
            }
