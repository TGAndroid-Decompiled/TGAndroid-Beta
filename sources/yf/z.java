...
public final class z extends OutputStream {
    ...
    public z(int i10) {
        this.f46906a = new byte[i10];
    }

    public final void a(int i10) {
        byte[] bArr = this.f46906a;
        if (i10 - bArr.length > 0) {
            ...
            this.f46906a = Arrays.copyOf(bArr, length);
        }
    }
    ...
    public final synchronized void write(byte[] bArr, int i10, int i11) {
        if (i10 >= 0) {
            if (i10 <= bArr.length && i11 >= 0 && (i10 + i11) - bArr.length <= 0) {
                a(this.f46907b + i11);
                System.arraycopy(bArr, i10, this.f46906a, this.f46907b, i11);
                this.f46907b += i11;
            }
        }
