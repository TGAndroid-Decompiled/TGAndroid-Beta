...
public final class o0 extends i {
    public final int f50043n = 2;
    public final Paint f50044r;
    public final Path f50045s;

    public o0(p0 p0Var, Context context) {
        super(p0Var, context);
        Paint paint = new Paint(1);
        this.f50044r = paint;
        this.f50045s = new Path();
    ...
    public final int a(float f10, float f11) {
        switch (this.f50043n) {
            case 0:
                ...
                if (f10 > f13 - dp && f11 > A - dp && f10 < f13 + dp && f11 < A + dp) {
                    return 2;
                }
                return 0;
            case 1:
                ...
                float A2 = e2.c.A(getMeasuredHeight(), f14, 2.0f, dp4);
                if (f10 > dp4 - dp3 && f11 > A2 - dp3 && f10 < dp4 + dp3 && f11 < A2 + dp3) {
                    return 1;
                }
                float f15 = dp4 + measuredWidth2;
                if (f10 > f15 - dp3 && f11 > A2 - dp3 && f10 < f15 + dp3 && f11 < A2 + dp3) {
                    return 2;
                }
                return 0;
            case 2:
            ...
            case 4:
                ...
                float A3 = e2.c.A(getMeasuredHeight(), f22, 2.0f, dp10);
                if (f10 > dp10 - dp9 && f11 > A3 - dp9 && f10 < dp10 + dp9 && f11 < A3 + dp9) {
                    return 1;
                }
                float f23 = dp10 + measuredWidth5;
                if (f10 > f23 - dp9 && f11 > A3 - dp9 && f10 < f23 + dp9 && f11 < A3 + dp9) {
                    return 2;
                }
                return 0;
            default:
                ...
                float A4 = e2.c.A(getMeasuredHeight(), f24, 2.0f, dp12);
                if (f10 > dp12 - dp11 && f11 > A4 - dp11 && f10 < dp12 + dp11 && f11 < A4 + dp11) {
                    return 1;
                }
                float f25 = dp12 + measuredWidth6;
                if (f10 > f25 - dp11 && f11 > A4 - dp11 && f10 < f25 + dp11 && f11 < A4 + dp11) {
                    return 2;
                }
                return 0;
        }
        ...
        switch (this.f50043n) {
            ...
            case 1:
                ...
                if (showAlpha2 > 0.0f) {
                    ...
                    canvas.drawPath(path2, paint5);
                    float f33 = dp3 + f26;
                    Paint paint6 = this.f49843c;
                    canvas.drawCircle(dp3, f33, dpf22, paint6);
                    Paint paint7 = this.f49842b;
            ...
            case 2:
                ...
                if (showAlpha3 > 0.0f) {
                    ...
                    canvas.drawPath(path3, paint9);
                    float f46 = dp5 + f39;
                    Paint paint10 = this.f49843c;
                    canvas.drawCircle(dp5, f46, dpf23, paint10);
                    Paint paint11 = this.f49842b;
            ...
            case 3:
                ...
                if (showAlpha4 > 0.0f) {
                    ...
                    canvas.drawPath(path4, paint13);
                    float f59 = dp7 + f52;
                    Paint paint14 = this.f49843c;
                    canvas.drawCircle(dp7, f59, dpf24, paint14);
                    Paint paint15 = this.f49842b;
            ...
            case 4:
                ...
                if (showAlpha5 > 0.0f) {
                    ...
                    canvas.drawPath(path5, paint17);
                    float f72 = dp9 + f65;
                    Paint paint18 = this.f49843c;
                    canvas.drawCircle(dp9, f72, dpf25, paint18);
                    Paint paint19 = this.f49842b;
            ...
            default:
                ...
                if (showAlpha6 > 0.0f) {
                    ...
                    canvas2.drawPath(path6, paint21);
                    float f85 = dp11 + f78;
                    Paint paint22 = this.f49843c;
                    canvas2.drawCircle(dp11, f85, dpf26, paint22);
                    Paint paint23 = this.f49842b;
