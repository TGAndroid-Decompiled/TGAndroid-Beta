...
public class n extends FrameLayout implements a {
    ...
    public final CropAreaView f47246a;
    public final ImageView f47247b;
    public final Matrix f47248c;
    public w61 d;
    public f e;
    public final RectF f47249f;
    public final RectF h;
    public float f47250n;
    public final boolean f47251r;
    public final p1 f47252s;
    public final Matrix v;
    public Bitmap f47253w;
    public boolean f47254x;
    public float f47255y;
    ...
    public n(Context context) {
        ...
        this.f47251r = z4;
        this.f47249f = new RectF();
        this.h = new RectF();
        this.f47248c = new Matrix();
        ?? obj = new Object();
        obj.f46065a = new float[8];
        this.f47252s = obj;
        this.v = new Matrix();
        this.C = false;
        ...
        viewGroup.f23004f = new RectF();
        viewGroup.h = new RectF();
        viewGroup.f23012n = new RectF();
        viewGroup.f23017r = new RectF();
        viewGroup.f23018s = new RectF();
        viewGroup.v = new RectF();
        viewGroup.f23020x = new RectF();
        viewGroup.f23021y = new RectF();
        viewGroup.H = -1.0f;
        viewGroup.I = 1.0f;
        viewGroup.J = -1.0f;
        viewGroup.R = new AccelerateDecelerateInterpolator();
        viewGroup.f23001c0 = true;
        viewGroup.f23008i0 = new RectF();
        viewGroup.f23010k0 = 0.0f;
        viewGroup.f23011l0 = 1.0f;
        viewGroup.m0 = 0.0f;
        viewGroup.f23013n0 = 0.0f;
        viewGroup.U = z4;
        viewGroup.G = true;
        viewGroup.F = true;
        viewGroup.S = AndroidUtilities.dp(16.0f);
        viewGroup.T = AndroidUtilities.dp(32.0f);
        viewGroup.f23016q0 = 1;
    ...
    public static void a(n nVar, Integer[][] numArr, int i10) {
        ...
        if (i10 != 0) {
            if (i10 != 1) {
                ...
                if (nVar.f47246a.getAspectRatio() > 1.0f) {
        ...
        l lVar = nVar.I;
        int i11 = ((lVar.f47241g % 180.0f) > 0.0f ? 1 : ((lVar.f47241g % 180.0f) == 0.0f ? 0 : -1));
        if (i11 != 0) {
            f10 = lVar.f47238b;
        } else {
            f10 = lVar.f47237a;
    ...
    private void setLockedAspectRatio(float f10) {
        CropAreaView cropAreaView = this.f47246a;
    ...
    public final void b(MediaController.CropState cropState) {
        ...
        Matrix matrix = this.I.f47244k;
        float[] fArr = this.E;
        matrix.getValues(fArr);
        l lVar = this.I;
        float f12 = lVar.f47240f * cropWidth;
        ...
        if (i10 != 90 && i10 != 270) {
            l lVar2 = this.I;
            i11 = (int) lVar2.f47237a;
            f11 = lVar2.f47238b;
        } else {
            l lVar3 = this.I;
            i11 = (int) lVar3.f47238b;
            f11 = lVar3.f47237a;
        }
        int i12 = (int) f11;
        float f13 = i11;
        ...
        cropState.cropRotate = lVar4.f47242i;
        cropState.stateScale = f17;
        cropState.mirrored = lVar4.f47243j;
        cropState.scale = cropWidth;
        cropState.matrix = lVar4.f47244k;
        cropState.width = ceil;
        cropState.height = ceil2;
        cropState.freeform = this.f47254x;
    ...
    public final void d(RectF rectF) {
        ...
        ImageView imageView = this.f47247b;
        float a2 = l.a(this.I) * ((centerX - (imageView.getWidth() / 2)) / cropAreaView.getCropWidth());
        float b10 = l.b(this.I) * ((rectF.centerY() - ((((imageView.getHeight() - this.f47255y) + i10) + this.B) / 2.0f)) / cropAreaView.getCropHeight());
        ...
        AnimatorSet animatorSet = cropAreaView.f23007h0;
        if (animatorSet != null) {
            animatorSet.cancel();
            cropAreaView.f23007h0 = null;
        }
        AnimatorSet animatorSet2 = new AnimatorSet();
        cropAreaView.f23007h0 = animatorSet2;
    ...
    public final void e(boolean z4, boolean z10, boolean z11, boolean z12) {
        ...
        if (this.I != null) {
            ...
            l lVar = this.I;
            float f13 = lVar.e;
            p1 p1Var = this.f47252s;
            float[] fArr = (float[]) p1Var.f46065a;
            float[] fArr2 = (float[]) p1Var.f46065a;
            ...
            l lVar2 = this.I;
            PointF pointF = new PointF(lVar2.f47239c, lVar2.d);
            ...
            } else if (z10 && this.f47250n > 0.0f) {
                float width = rectF.width() / n(rectF, rectF2);
                if (this.I.e * width < this.f47250n) {
                    width = 1.0f;
                }
    ...
    public float getCropHeight() {
        return this.f47246a.getCropHeight();
    }

    public float getCropLeft() {
        return this.f47246a.getCropLeft();
    }

    public float getCropTop() {
        return this.f47246a.getCropTop();
    }

    public float getCropWidth() {
        return this.f47246a.getCropWidth();
    }
    ...
    public float getStateFullOrientation() {
        ...
        return lVar.f47241g + lVar.h;
    }

    public boolean getStateMirror() {
        l lVar = this.I;
        if (lVar != null && lVar.f47243j) {
            return true;
        }
        return false;
    }
    ...
    public final void i() {
        ...
        l lVar2 = this.I;
        if ((lVar2.h + lVar2.f47241g) % 180.0f != 0.0f) {
        ...
        rectF.set(cropAreaView.f23020x);
        l lVar3 = this.I;
        final float f13 = lVar3.f47239c;
        final float f14 = lVar3.d;
        final float f15 = lVar3.e;
        final float f16 = lVar3.f47242i;
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                ...
                nVar.f47246a.setActualRect(rectF5);
                l lVar4 = nVar.I;
                float f17 = 1.0f - floatValue;
                float f18 = lVar4.f47239c - (f13 * f17);
                float f19 = lVar4.d - (f14 * f17);
                float f20 = lVar4.f47242i - (f16 * f17);
    ...
    public final boolean j() {
        ...
        lVar.f47243j = !lVar.f47243j;
        r(false);
        m mVar = this.J;
        if (mVar != null) {
            l lVar2 = this.I;
            float f10 = lVar2.h;
            float f11 = lVar2.f47241g;
            float f12 = ((f10 + f11) - f11) % 360.0f;
            if (!l.c(lVar2) && f12 == 0.0f && this.f47246a.getLockAspectRatio() == 0.0f && !this.I.f47243j) {
                z4 = true;
            }
            mVar.b0(z4);
        }
        return this.I.f47243j;
    }

    public final void k() {
        this.f47246a.g(2, false);
        if (this.f47250n < 1.0E-5f) {
            this.f47250n = this.I.e;
        }
    }
    ...
    public final void l(boolean z4) {
        ...
        l lVar = this.I;
        if (lVar != null && lVar.f47241g % 180.0f != 0.0f) {
            z10 = true;
        } else {
            z10 = false;
        }
        cropAreaView.e(currentWidth, currentHeight, z10, this.f47254x);
        if (this.f47254x) {
            f10 = 0.0f;
        } else {
            f10 = 1.0f;
    ...
    public final boolean m(float f10) {
        ...
        if (this.I != null) {
            ...
            l lVar = this.I;
            float f11 = lVar.h;
            float f12 = lVar.f47241g;
            float f13 = (((f11 + f12) - f12) + f10) % 360.0f;
            if (this.f47254x && cropAreaView.getLockAspectRatio() > 0.0f) {
                cropAreaView.setLockedAspectRatio(1.0f / cropAreaView.getLockAspectRatio());
                cropAreaView.setActualRect(cropAreaView.getLockAspectRatio());
            } else {
                int currentWidth = getCurrentWidth();
                int currentHeight = getCurrentHeight();
                if ((this.I.f47241g + f13) % 180.0f != 0.0f) {
                    z4 = true;
                } else {
                    z4 = false;
                }
                cropAreaView.e(currentWidth, currentHeight, z4, this.f47254x);
            }
            l.d(this.I, f13);
            r(false);
            ...
            m mVar = this.J;
            if (mVar != null) {
                if (f13 == 0.0f && cropAreaView.getLockAspectRatio() == 0.0f && !this.I.f47243j) {
                    z10 = true;
                } else {
                    z10 = false;
                }
    ...
    public final void o() {
        ...
        for (int i11 = 0; i11 < 6; i11++) {
            ...
            if (this.f47246a.getAspectRatio() > 1.0f) {
    ...
    public final void q() {
        ...
        if (this.e != null && this.I != null) {
            ...
            if (i11 != 90 && i11 != 270) {
                l lVar2 = this.I;
                i10 = (int) lVar2.f47237a;
                f11 = lVar2.f47238b;
            } else {
                l lVar3 = this.I;
                i10 = (int) lVar3.f47238b;
                f11 = lVar3.f47237a;
            }
            int i12 = (int) f11;
            double d = ceil;
            ...
            float f15 = ceil4;
            float f16 = ceil3;
            RectF rectF2 = cropAreaView.f23008i0;
            ...
            float f17 = lVar4.e;
            float f18 = f17 / max;
            float f19 = f17 / lVar4.f47240f;
            float f20 = (fArr[2] / f13) / f17;
            float f21 = (fArr[5] / f14) / f17;
            float f22 = lVar4.f47242i;
            ...
            f fVar = this.e;
            l lVar5 = this.I;
            if (!lVar5.f47243j && !l.c(lVar5) && this.I.f47241g < 1.0E-5f) {
                z4 = false;
            } else {
                z4 = true;
            }
            l lVar6 = this.I;
            fVar.e(z4, f20, f21, f22, (int) lVar6.h, f18, f19, lVar6.f47240f / max, f16, f15, cropCenterX, cropCenterY, lVar6.f47243j);
        }
    }
    ...
    public final void r(boolean z4) {
        ...
        Matrix matrix = this.f47248c;
        matrix.reset();
        l lVar = this.I;
        float f10 = lVar.f47241g;
        if (f10 != 90.0f && f10 != 270.0f) {
            matrix.postTranslate((-lVar.f47237a) / 2.0f, (-lVar.f47238b) / 2.0f);
        } else {
            matrix.postTranslate((-lVar.f47238b) / 2.0f, (-lVar.f47237a) / 2.0f);
        }
        matrix.postRotate((int) this.I.h);
        matrix.postConcat(this.I.f47244k);
        CropAreaView cropAreaView = this.f47246a;
        matrix.postTranslate(cropAreaView.getCropCenterX(), cropAreaView.getCropCenterY());
        if (!this.f47254x || this.G || z4) {
            q();
            this.J.G();
        }
        invalidate();
    ...
    public void setAspectRatio(float f10) {
        this.f47246a.setActualRect(f10);
    }

    public void setBottomPadding(float f10) {
        this.f47255y = f10;
        this.f47246a.setBottomPadding(f10);
    }

    public void setFreeform(boolean z4) {
        this.f47246a.setFreeform(z4);
        this.f47254x = z4;
    }
    ...
    public void setRotation(float f10) {
        l lVar = this.I;
        l.e(lVar, f10 - lVar.f47242i);
        e(true, true, false, false);
    }

    public void setSubtitle(String str) {
        this.f47246a.setSubtitle(str);
    }

    public void setTopPadding(float f10) {
        this.B = f10;
        this.f47246a.setTopPadding(f10);
    }
}
