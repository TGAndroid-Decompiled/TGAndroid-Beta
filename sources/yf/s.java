...
public final class s {
    public final q f46853a = new q();
    public final q f46854b = new q();
    public final r f46855c = new q();
    ...
    public final void b(TL_update.TL_updateEditEphemeralMessage tL_updateEditEphemeralMessage, int i10, ConcurrentHashMap concurrentHashMap, ConcurrentHashMap concurrentHashMap2) {
        ...
        if (ephemeralMessage.anchor_msg_id != 0) {
            this.e.f46850a.add(ephemeralMessage);
            ...
            b10.flags |= 32768;
            q.a(this.f46854b, ephemeralMessage, b10, messageObject);
        } else {
            this.d.f46850a.add(ephemeralMessage);
        }
    }
    ...
    public final void c(TL_update.TL_updateNewEphemeralMessage tL_updateNewEphemeralMessage, int i10, ConcurrentHashMap concurrentHashMap, ConcurrentHashMap concurrentHashMap2) {
        ...
        if (ephemeralMessage.anchor_msg_id != 0) {
            ...
            TLRPC.TL_message b10 = u.b(ephemeralMessage);
            q.a(this.f46853a, ephemeralMessage, b10, new MessageObject(i10, (TLRPC.Message) b10, (AbstractMap<Long, TLRPC.User>) concurrentHashMap, (AbstractMap<Long, TLRPC.Chat>) concurrentHashMap2, true, true));
        } else {
            this.f46855c.f46850a.add(ephemeralMessage);
        }
    }
}
