...
public final class x0 extends wk0 {
    ...
    public final void dispatchDraw(Canvas canvas) {
            ...
            if (childAt.getVisibility() != 4) {
                if (childAt instanceof org.telegram.ui.Cells.t1) {
                    ...
                    if (currentMessagesGroup2 == null || currentMessagesGroup2 != groupedMessages) {
                        ...
                        if ((backgroundDrawable.f34906f || t1Var.g3()) && (currentPosition == null || (2 & currentPosition.flags) != 0)) {
                            ...
                            if (currentPosition == null) {
                                ...
                                for (int i13 = 0; i13 < childCount; i13++) {
                                    ...
                                    if (childAt2 instanceof org.telegram.ui.Cells.t1) {
                                        ...
                                        if (t1Var2.getCurrentMessagesGroup() == currentMessagesGroup2) {
                                            ...
                                            long j11 = backgroundDrawable2.f34911l;
                                            if (j11 > j10) {
                                                float x10 = t1Var2.getX() + backgroundDrawable2.h;
                                                f17 = t1Var2.getY() + backgroundDrawable2.f34908i;
                                                f10 = x10;
                                                j10 = j11;
                                            }
                                            y10 = min;
                                ...
                                backgroundDrawable.f34909j = f10;
                                backgroundDrawable.f34910k = f17 - y10;
                                i11 = measuredHeight - y10;
                            }
                            int i14 = i11 + y10;
                            canvas.clipRect(0, y10, getMeasuredWidth(), i14);
                            backgroundDrawable.f34903b = null;
                            backgroundDrawable.f34902a.setColor(f6.v0(f6.Hc, this.f34260l2));
        ...
        while (i15 < 3) {
            ...
            if (i15 != i10 || this.T1) {
                ...
                while (i23 < arrayList.size()) {
                    ...
                    if (z12) {
                        canvas.save();
                        canvas.scale(groupedMessages2.transitionParams.cell.getScaleX(), groupedMessages2.transitionParams.cell.getScaleY(), e2.c.A(f20, f18, f11, f18), e2.c.A(f23, f22, f11, f22));
                    }
        ...
        if (size3 > 0) {
            ...
            while (i27 < size3) {
                ...
                if (t1Var7.getTransitionParams().f25231v0) {
                    canvas.translate(E23, y12);
                    t1Var7.setInvalidatesParent(true);
                    t1Var7.I1(f14, canvas, z11);
        ...
        if (size4 > 0) {
            for (int i28 = 0; i28 < size4; i28++) {
                ...
                if (t1Var8.getCurrentPosition() == null || (t1Var8.getCurrentPosition().flags & 1) != 0) {
                    ...
                    if (t1Var8.getTransitionParams().f25231v0) {
    ...
    public final boolean drawChild(android.graphics.Canvas r20, android.view.View r21, long r22) {
        throw new UnsupportedOperationException("Method not decompiled: yf.x0.drawChild(android.graphics.Canvas, android.view.View, long):boolean");
    }
}
