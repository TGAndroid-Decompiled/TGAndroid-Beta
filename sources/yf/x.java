...
public final class x extends View {
    ...
    public final Paint f46894n;
    public WindowManager f46895r;
    public WindowManager.LayoutParams f46896s;
    public Window v;
    public HandlerThread f46897w;
    public v f46898x;
    public View f46899y;
    ...
    public static void a(FrameMetrics frameMetrics) {
        w[] values;
        for (w wVar : w.values()) {
            if (Build.VERSION.SDK_INT >= wVar.f46889c) {
                long metric = frameMetrics.getMetric(wVar.f46887a);
                wVar.d = metric;
                if (metric >= 0) {
    ...
    public final void c() {
        ...
        if (window != null && (vVar = this.f46898x) != null) {
        ...
        HandlerThread handlerThread = this.f46897w;
        if (handlerThread != null) {
            handlerThread.quitSafely();
        }
        if (this.f46895r != null && this.G.getAndSet(false)) {
            try {
                this.f46895r.removeViewImmediate(this);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        while (true) {
            ...
            if (i10 < length2) {
                ...
                canvas.drawText(String.format(locale, "%-16s : %d /s", "vsync", Integer.valueOf(this.f46892c)), dp2, f17, paint);
                float f18 = f17 + f11;
                if (this.f46899y != null) {
                    str = "onDraw";
                } else {
                    str = "onDraw (none)";
                }
                canvas.drawText(String.format(locale, "%-16s : %d /s", str, Integer.valueOf(this.f46893f)), dp2, f18, paint);
                return;
            }
        }
    }
    ...
    public void setObservedView(View view) {
        ...
        this.f46899y = view;
        if (this.F.get() && (view2 = this.f46899y) != null) {
