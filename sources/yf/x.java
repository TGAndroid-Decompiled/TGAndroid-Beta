...
public final class x extends View {
    ...
    public final Paint f47141n;
    public WindowManager f47142r;
    public WindowManager.LayoutParams f47143s;
    public Window v;
    public HandlerThread f47144w;
    public v f47145x;
    public View f47146y;
    ...
    public static void a(FrameMetrics frameMetrics) {
        w[] values;
        for (w wVar : w.values()) {
            if (Build.VERSION.SDK_INT >= wVar.f47136c) {
                long metric = frameMetrics.getMetric(wVar.f47134a);
                wVar.d = metric;
                if (metric >= 0) {
    ...
    public final void c() {
        ...
        if (window != null && (vVar = this.f47145x) != null) {
        ...
        HandlerThread handlerThread = this.f47144w;
        if (handlerThread != null) {
            handlerThread.quitSafely();
        }
        if (this.f47142r != null && this.G.getAndSet(false)) {
            try {
                this.f47142r.removeViewImmediate(this);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        while (true) {
            ...
            if (i10 < length2) {
                ...
                canvas.drawText(String.format(locale, "%-16s : %d /s", "vsync", Integer.valueOf(this.f47139c)), dp2, f17, paint);
                float f18 = f17 + f11;
                if (this.f47146y != null) {
                    str = "onDraw";
                } else {
                    str = "onDraw (none)";
                }
                canvas.drawText(String.format(locale, "%-16s : %d /s", str, Integer.valueOf(this.f47140f)), dp2, f18, paint);
                return;
            }
        }
    }
    ...
    public void setObservedView(View view) {
        ...
        this.f47146y = view;
        if (this.F.get() && (view2 = this.f47146y) != null) {
