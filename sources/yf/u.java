...
public final class u extends BaseController {
    public static volatile u[] f47134a = new u[4];
    ...
    public static TLRPC.TL_message b(TL_ephemeral.EphemeralMessage ephemeralMessage) {
        ...
        tL_message.f18357id = MessageObject.ephemeralMessageIdPack(ephemeralMessage.f18547id);
    ...
    public static TL_ephemeral.TL_ephemeralMessage c(TLRPC.Message message, int i10) {
        ...
        tL_ephemeralMessage.f18547id = MessageObject.ephemeralMessageIdUnpack(message.f18357id);
            ...
            if (tL_messages_sendMessage.ephemeralReceiverBotId != 0) {
                ...
                if (z10) {
                    ...
                    if (MessageObject.isEphemeralMessageId(tL_inputReplyToMessage.reply_to_msg_id)) {
                        ...
                        tL_inputReplyToEphemeralMessage2.f18402id = MessageObject.ephemeralMessageIdUnpack(tL_inputReplyToMessage.reply_to_msg_id);
            ...
            if (tL_messages_sendMedia.ephemeralReceiverBotId != 0) {
                ...
                if (z11) {
                    ...
                    if (MessageObject.isEphemeralMessageId(tL_inputReplyToMessage2.reply_to_msg_id)) {
                        ...
                        tL_inputReplyToEphemeralMessage4.f18402id = MessageObject.ephemeralMessageIdUnpack(tL_inputReplyToMessage2.reply_to_msg_id);
