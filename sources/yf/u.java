...
public final class u extends BaseController {
    public static volatile u[] f46880a = new u[4];
    ...
    public static TLRPC.TL_message b(TL_ephemeral.EphemeralMessage ephemeralMessage) {
        ...
        tL_message.f18142id = MessageObject.ephemeralMessageIdPack(ephemeralMessage.f18333id);
    ...
    public static TL_ephemeral.TL_ephemeralMessage c(TLRPC.Message message, int i10) {
        ...
        tL_ephemeralMessage.f18333id = MessageObject.ephemeralMessageIdUnpack(message.f18142id);
