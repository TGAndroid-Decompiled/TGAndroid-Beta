...
public final class u extends BaseController {
    public static volatile u[] f50163a = new u[4];
    ...
    public static TLRPC.TL_message b(TL_ephemeral.EphemeralMessage ephemeralMessage) {
        ...
        tL_message.f19917id = MessageObject.ephemeralMessageIdPack(ephemeralMessage.f20109id);
    ...
    public static TL_ephemeral.TL_ephemeralMessage c(TLRPC.Message message, int i10) {
        ...
        tL_ephemeralMessage.f20109id = MessageObject.ephemeralMessageIdUnpack(message.f19917id);
