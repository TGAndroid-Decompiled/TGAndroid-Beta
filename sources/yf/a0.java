...
public final class a0 implements wx {
    ...
    public final boolean k() {
        b editText = ((v2) this.f49737a.O0).getEditText();
    ...
    public final void x(long j10, TLRPC.Document document, String str, boolean z10) {
        ...
        if (editText != null) {
            ...
            try {
                ...
                if (document != null) {
                    t5Var = new t5(document, editText.getPaint().getFontMetricsInt());
                } else {
                    t5Var = new t5(j10, editText.getPaint().getFontMetricsInt());
                }
