...
public abstract class o {
    public static void a(b11 b11Var, StringBuilder sb2) {
        if (b11Var != null) {
            if ((b11Var.f22840a & 768) > 0) {
                sb2.append("<spoiler>");
            }
            if ((b11Var.f22840a & 1) > 0) {
                sb2.append("<b>");
            }
            if ((b11Var.f22840a & 2) > 0) {
                sb2.append("<i>");
            }
            if ((b11Var.f22840a & 16) > 0) {
                sb2.append("<u>");
            }
            if ((b11Var.f22840a & 8) > 0) {
                sb2.append("<s>");
            }
            if ((b11Var.f22840a & 128) > 0 && b11Var.d != null) {
                sb2.append("<a href=\"");
