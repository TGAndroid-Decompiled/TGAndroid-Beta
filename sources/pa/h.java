...
public final class h extends i implements Iterable {
    public final ArrayList f44276a = new ArrayList();

    public final boolean equals(Object obj) {
        if (obj != this) {
            if (!(obj instanceof h) || !((h) obj).f44276a.equals(this.f44276a)) {
                return false;
            }
            return true;
        }
    ...
    public final Iterator iterator() {
        return this.f44276a.iterator();
    }

    @Override
    public final String n() {
        ArrayList arrayList = this.f44276a;
