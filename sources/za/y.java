...
public final class y extends kd.j implements rd.q {
    public int f48783a;
    public ce.c f48784b;
    public Throwable f48785c;

    @Override
    public final Object c(Object obj, Object obj2, kd.c cVar) {
        ?? jVar = new kd.j(3, cVar);
        jVar.f48784b = (ce.c) obj;
        jVar.f48785c = (Throwable) obj2;
        return jVar.invokeSuspend(gd.i.f9603a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i10 != 0) {
            ...
            t7.b(obj);
            ce.c cVar = this.f48784b;
            Log.e("FirebaseSessionsRepo", "Error reading stored session data.", this.f48785c);
