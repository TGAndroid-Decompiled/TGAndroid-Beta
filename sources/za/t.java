...
public final class t extends kd.j implements rd.p {
    ...
    public final id.c create(Object obj, id.c cVar) {
        switch (this.f51507a) {
            case 0:
                return new t((y) this.f51509c, cVar, 0);
            default:
                return new t((String) this.f51509c, cVar, 1);
        }
    }
    ...
    public final Object invokeSuspend(Object obj) {
        switch (this.f51507a) {
            ...
            default:
                ...
                String str = (String) this.f51509c;
                for (w9.j jVar2 : ((Map) obj).values()) {
                    ...
                    w9.i iVar = jVar2.f48424b;
                    synchronized (iVar) {
                        if (!Objects.equals(iVar.f48422c, str)) {
                            w9.i.a(iVar.f48420a, iVar.f48421b, str);
                            iVar.f48422c = str;
                        }
                    }
