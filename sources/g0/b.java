...
public final class b {
    ...
    public b(Context context, ShortcutInfo shortcutInfo) {
        ...
        this.f9328a = obj;
        obj.f9329a = context;
        obj.f9330b = shortcutInfo.getId();
        shortcutInfo.getPackage();
        Intent[] intents = shortcutInfo.getIntents();
        obj.f9331c = (Intent[]) Arrays.copyOf(intents, intents.length);
        obj.d = shortcutInfo.getActivity();
        obj.e = shortcutInfo.getShortLabel();
        obj.f9332f = shortcutInfo.getLongLabel();
        obj.f9333g = shortcutInfo.getDisabledMessage();
        if (Build.VERSION.SDK_INT >= 28) {
            shortcutInfo.getDisabledReason();
        } else {
            shortcutInfo.isEnabled();
        }
        obj.f9335j = shortcutInfo.getCategories();
        ...
        cVar.f9336k = hVar;
        this.f9328a.f9338m = shortcutInfo.getRank();
        this.f9328a.f9339n = shortcutInfo.getExtras();
    }

    public final c a() {
        c cVar = this.f9328a;
        if (!TextUtils.isEmpty(cVar.e)) {
            Intent[] intentArr = cVar.f9331c;
