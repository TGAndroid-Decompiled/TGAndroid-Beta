...
public final class a {
    public static final Hashtable f42500b;
    public static final Object[] f42501c;
    public static Class d;
    public final ClassLoader f42502a;
    ...
    static {
        ...
        f42501c = new Object[0];
    }

    public a(Class cls, String str) {
        this.f42502a = cls.getClassLoader();
    }
    ...
    public static Class a(ClassLoader classLoader, String str) {
        ...
        Class cls = (Class) f42500b.get(str);
        if (cls != null) {
            return cls;
        }
        try {
    ...
    public static t b(c cVar, Object obj, Object obj2) {
        return new t(cVar, obj, obj2, f42501c);
    }
    ...
    public final ra.a d(String str, String str2, String str3, String str4, String str5) {
        ...
        ClassLoader classLoader = this.f42502a;
