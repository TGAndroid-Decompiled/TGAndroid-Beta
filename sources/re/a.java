...
public final class a {
    public static final Hashtable f42239b;
    public static final Object[] f42240c;
    public static Class d;
    public final ClassLoader f42241a;
    ...
    static {
        ...
        f42240c = new Object[0];
    }

    public a(Class cls, String str) {
        this.f42241a = cls.getClassLoader();
    }
    ...
    public static Class a(ClassLoader classLoader, String str) {
        ...
        Class cls = (Class) f42239b.get(str);
        if (cls != null) {
            return cls;
        }
        try {
    ...
    public static t b(c0 c0Var, Object obj, Object obj2) {
        return new t(c0Var, obj, obj2, f42240c);
    }
    ...
    public final ra.a d(String str, String str2, String str3, String str4, String str5) {
        ...
        ClassLoader classLoader = this.f42241a;
