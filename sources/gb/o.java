...
public final class o extends db.u {
        ...
        switch (this.f9576a) {
            case 0:
                ...
                if (x10 == 1) {
                    ...
                    while (aVar.k()) {
                        aVar.a();
                        Object read = ((db.u) ((o) this.f9577b).f9578c).read(aVar);
                        if (map.put(read, ((db.u) ((o) this.f9578c).f9578c).read(aVar)) == null) {
                            aVar.e();
                        } else {
                    ...
                    while (aVar.k()) {
                        ...
                        Object read2 = ((db.u) ((o) this.f9577b).f9578c).read(aVar);
                        if (map.put(read2, ((db.u) ((o) this.f9578c).f9578c).read(aVar)) != null) {
                ...
                return map;
            case 1:
                return ((db.u) this.f9578c).read(aVar);
            default:
                if (aVar.x() == 9) {
                    aVar.t();
                    return null;
                ...
                String v = aVar.v();
                Enum r02 = (Enum) ((HashMap) this.f9577b).get(v);
                if (r02 == null) {
                    return (Enum) ((HashMap) this.f9578c).get(v);
                }
                return r02;
        }
    }
    ...
    public o(d dVar, db.g gVar, Type type, db.u uVar, Type type2, db.u uVar2, fb.n nVar) {
        this.f9576a = 0;
        this.f9577b = new o(gVar, uVar, type);
        this.f9578c = new o(gVar, uVar2, type2);
        this.d = nVar;
    }
            ...
            for (Field field : (Field[]) AccessController.doPrivileged(new g1(cls))) {
                ...
                if (bVar != null) {
                    ...
                    for (String str2 : bVar.alternate()) {
                        ((HashMap) this.f9577b).put(str2, r42);
                    }
                }
                ((HashMap) this.f9577b).put(name, r42);
                ((HashMap) this.f9578c).put(str, r42);
