...
public final class w extends t {
    ...
    public final Constructor f9596b;
    ...
    public w(Class cls, v vVar) {
        ...
        Class<?>[] parameterTypes = this.f9596b.getParameterTypes();
        this.f9597c = new Object[parameterTypes.length];
        for (int i11 = 0; i11 < parameterTypes.length; i11++) {
            this.f9597c[i11] = e.get(parameterTypes[i11]);
        }
    }

    @Override
    public final Object a() {
        return (Object[]) this.f9597c.clone();
    }

    @Override
    public final Object b(Object obj) {
        Object[] objArr = (Object[]) obj;
        Constructor constructor = this.f9596b;
        try {
