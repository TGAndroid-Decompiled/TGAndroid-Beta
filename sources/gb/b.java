...
public final class b extends db.u {
    ...
    public final o f9541b;

    public b(db.g gVar, db.u uVar, Class cls) {
        this.f9541b = new o(gVar, uVar, cls);
        this.f9540a = cls;
    }
    ...
    public final Object read(lb.a aVar) {
        ...
        aVar.a();
        while (aVar.k()) {
            arrayList.add(((db.u) this.f9541b.f9579c).read(aVar));
        }
        aVar.e();
        int size = arrayList.size();
        Class cls = this.f9540a;
        if (cls.isPrimitive()) {
    ...
    public final void write(lb.b bVar, Object obj) {
        ...
        for (int i10 = 0; i10 < length; i10++) {
            this.f9541b.write(bVar, Array.get(obj, i10));
        }
        bVar.e();
    }
}
