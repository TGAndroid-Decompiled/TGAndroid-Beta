...
public final class b extends db.u {
    public static final a f9521c = new a();
    public final Class f9522a;
    public final o f9523b;

    public b(db.g gVar, db.u uVar, Class cls) {
        this.f9523b = new o(gVar, uVar, cls);
        this.f9522a = cls;
    }
    ...
    public final Object read(lb.a aVar) {
        ...
        aVar.a();
        while (aVar.k()) {
            arrayList.add(((db.u) this.f9523b.f9561c).read(aVar));
        }
        aVar.e();
    ...
    public final void write(lb.b bVar, Object obj) {
        ...
        for (int i10 = 0; i10 < length; i10++) {
            this.f9523b.write(bVar, Array.get(obj, i10));
        }
        bVar.e();
    }
}
