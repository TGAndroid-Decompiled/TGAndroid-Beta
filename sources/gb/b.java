...
public final class b extends db.u {
    public static final a f9535c = new a();
    public final Class f9536a;
    public final o f9537b;

    public b(db.g gVar, db.u uVar, Class cls) {
        this.f9537b = new o(gVar, uVar, cls);
        this.f9536a = cls;
    }
    ...
    public final Object read(lb.a aVar) {
        ...
        aVar.a();
        while (aVar.k()) {
            arrayList.add(((db.u) this.f9537b.f9575c).read(aVar));
        }
        aVar.e();
    ...
    public final void write(lb.b bVar, Object obj) {
        ...
        for (int i10 = 0; i10 < length; i10++) {
            this.f9537b.write(bVar, Array.get(obj, i10));
        }
        bVar.e();
    }
}
