...
public final class j implements db.v {
    public static final i f9569c = new i(0);
    public static final i d = new i(0);
    public final of.b f9570a;
    public final ConcurrentHashMap f9571b = new ConcurrentHashMap();
    ...
    public final db.u a(of.b bVar, db.g gVar, kb.a aVar, eb.a aVar2, boolean z10) {
        ...
        if (p22 instanceof db.u) {
            ...
            db.v vVar = (db.v) p22;
            if (z10) {
                db.v vVar2 = (db.v) this.f9571b.putIfAbsent(aVar.f13575a, vVar);
                if (vVar2 != null) {
                    vVar = vVar2;
                }
            }
    ...
    public final db.u create(db.g gVar, kb.a aVar) {
        ...
        return a(this.f9570a, gVar, aVar, aVar2, true);
    }
}
