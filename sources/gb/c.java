...
public final class c extends db.u {
    ...
    public c(db.g gVar, Type type, db.u uVar, fb.n nVar) {
        this.f9542b = new o(gVar, uVar, type);
        this.f9543c = nVar;
    }
    ...
    public final Object read(lb.a aVar) {
        switch (this.f9541a) {
            case 0:
                ...
                Collection collection = (Collection) ((fb.n) this.f9543c).p2();
                aVar.a();
                while (aVar.k()) {
                    collection.add(((db.u) ((o) this.f9542b).f9578c).read(aVar));
                }
                aVar.e();
                return collection;
            default:
                Class cls = (Class) this.f9542b;
                Object read = ((x0) this.f9543c).f9603c.read(aVar);
        ...
        switch (this.f9541a) {
            case 0:
                ...
                for (Object obj2 : collection) {
                    ((o) this.f9542b).write(bVar, obj2);
                }
                bVar.e();
                return;
            default:
                ((x0) this.f9543c).f9603c.write(bVar, obj);
                return;
        }
    }
