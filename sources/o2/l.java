...
public final class l extends u2.a {
    ...
    public static p2.g u(long j3, List list) {
        ...
        for (int i10 = 0; i10 < list.size(); i10++) {
            ...
            long j10 = gVar2.f43732e;
            if (j10 <= j3 && gVar2.f43722w) {
                gVar = gVar2;
            } else if (j10 > j3) {
                break;
            }
    ...
    public final void k() {
        ...
        if (uri != null) {
            ...
            bVar.f43670b.b();
            IOException iOException = bVar.f43676s;
            if (iOException != null) {
                throw iOException;
            }
        }
    ...
    public final void m(c0 c0Var) {
        ...
        p2.c cVar = this.f16919o;
        cVar.getClass();
        cVar.f43683n = e2.d0.o(null);
        cVar.f43682f = b10;
        cVar.f43684r = this;
        Map map = Collections.EMPTY_MAP;
        e2.d.i(uri, "The uri must be set.");
        y2.p pVar = new y2.p(((g2.g) cVar.f43678a.f14247b).createDataSource(), new g2.m(uri, 1, null, map, 0L, -1L, null, 1), 4, cVar.f43679b.U());
        if (cVar.h == null) {
            z10 = true;
        } else {
            z10 = false;
        ...
        cVar.h = mVar2;
        mVar2.f(pVar, cVar, cVar.f43680c.L3(pVar.f49553c));
    }
    ...
    public final void o(d0 d0Var) {
        ...
        p[] pVarArr;
        k kVar = (k) d0Var;
        kVar.f16903b.f43681e.remove(kVar);
        for (q qVar : kVar.J) {
            if (qVar.T) {
                for (p pVar : qVar.L) {
                    pVar.k();
    ...
    public final void q() {
        ...
        cVar.f43686w = null;
        cVar.f43685s = null;
        cVar.f43688y = -9223372036854775807L;
        cVar.h.e(null);
        cVar.h = null;
        ...
        cVar.f43683n.removeCallbacksAndMessages(null);
        cVar.f43683n = null;
        hashMap.clear();
    ...
    public final void v(p2.l lVar) {
        ...
        long j16;
        boolean z12;
        boolean z13 = lVar.f43751p;
        boolean z14 = lVar.f43743g;
        i0 i0Var = lVar.f43753r;
        long j17 = lVar.f43756u;
        long j18 = lVar.f43741e;
        int i10 = lVar.d;
        long j19 = lVar.h;
        if (z13) {
            j3 = e2.d0.e0(j19);
        ...
        p2.c cVar = this.f16919o;
        cVar.f43685s.getClass();
        ?? obj = new Object();
        long j20 = 0;
        if (cVar.f43687x) {
            p2.k kVar = lVar.v;
            long j21 = j19 - cVar.f43688y;
            boolean z15 = lVar.f43750o;
            if (z15) {
                j12 = j21 + j17;
            } else {
            ...
            if (j22 != -9223372036854775807L) {
                ...
                if (j18 != -9223372036854775807L) {
                    ...
                    j14 = kVar.d;
                    if (j14 == -9223372036854775807L || lVar.f43749n == -9223372036854775807L) {
                        j14 = kVar.f43739c;
            ...
            e0 e0Var = i().f2155c;
            if (e0Var.d == -3.4028235E38f && e0Var.f2045e == -3.4028235E38f && kVar.f43739c == -9223372036854775807L && kVar.d == -9223372036854775807L) {
                z11 = true;
            } else {
                z11 = false;
            }
            ...
            if (i10 == 2 && lVar.f43742f) {
                z12 = true;
            } else {
                z12 = false;
            }
            h1Var = new h1(j10, j3, j12, lVar.f43756u, j21, j20, true, !z15, z12, obj, i(), this.f16921q);
        } else {
            if (j18 != -9223372036854775807L && !i0Var.isEmpty()) {
                if (!z14 && j18 != j17) {
                    j18 = ((p2.i) i0Var.get(e2.d0.c(i0Var, Long.valueOf(j18), true))).f43732e;
                }
                j11 = j18;
            } else {
                j11 = 0;
            }
            long j24 = lVar.f43756u;
