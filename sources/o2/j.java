...
public final class j extends v2.k {
    public static final AtomicInteger f15558c0 = new AtomicInteger();
    public final int E;
    public final g2.h F;
    public final g2.m G;
    public final b H;
    ...
    public i0 Y;
    public boolean Z;
    public long f15559a0;
    public boolean f15560b0;
    public final int v;
    public final int f15561w;
    public final Uri f15562x;
    ...
    public j(c cVar, g2.h hVar, g2.m mVar, b2.s sVar, boolean z10, g2.h hVar2, g2.m mVar2, boolean z11, Uri uri, List list, int i10, Object obj, long j3, long j10, long j11, int i11, boolean z12, int i12, boolean z13, boolean z14, b0 b0Var, b2.o oVar, b bVar, q3.i iVar, v vVar, boolean z15, boolean z16, j2.k kVar) {
        ...
        g0 g0Var = i0.f8066b;
        this.Y = a1.e;
        this.v = f15558c0.getAndIncrement();
    }
    ...
    public final void a() {
        ...
        if (!this.W) {
            if (!this.J) {
                d(this.f44115r, this.f44111b, this.Q);
            }
            this.X = !this.W;
        }
    }
            ...
            do {
                try {
                    ...
                    if ((this.d.f3290f & 16384) != 0) {
                        this.S.f15530a.h(0L, 0L);
                        j3 = h.d;
                    } else {
                        throw e;
                    }
                }
            } while (this.S.f15530a.m(h, b.f15529f) == 0);
            j3 = h.d;
    ...
    public final boolean g() {
        if (this.f15559a0 != -9223372036854775807L) {
            return true;
        }
        return false;
    }
            ...
            if (this.S == null) {
                    ...
                    if (c10 != null) {
                        for (o0 o0Var : c10.f3170a) {
                            if (o0Var instanceof q3.n) {
                                ...
                                if ("com.apple.streaming.transportStreamTimestamp".equals(nVar.f41408b)) {
                                    System.arraycopy(nVar.f41409c, 0, vVar.f7916a, 0, 8);
                                    vVar.J(0);
                                    vVar.I(8);
                ...
                if (bVar2 != null) {
                    ...
                    if (oVar instanceof t) {
                        dVar = new t(bVar2.f15531b.d, bVar2.f15532c, bVar2.d, bVar2.e);
                    ...
                    bVar = new b(dVar, bVar2.f15531b, bVar2.f15532c, bVar2.d, bVar2.e);
                    j11 = j13;
                } else {
                    Uri uri = mVar.f9362a;
                    ...
                    while (true) {
                        ...
                        if (i16 < size) {
                                            ...
                                            if (intValue != 8) {
                                                if (intValue != 11) {
                                                    if (intValue != 13) {
                                                        ...
                                                        i10 = i16;
                                                        arrayList = arrayList2;
                                                        aVar = new t(sVar.d, b0Var3, cVar.f15534a, cVar.f15535b);
                                                        b0Var = b0Var3;
                                                    }
                                                } else {
                                                    i10 = i16;
                                                    arrayList = arrayList2;
                                                    z3.k kVar5 = cVar.f15534a;
                                                    boolean z15 = cVar.f15535b;
                                                    if (list2 != null) {
                                                        singletonList = list2;
                                                        i12 = 48;
                                                    } else {
                                                ...
                                                b0Var = b0Var3;
                                                arrayList = arrayList2;
                                                z3.k kVar6 = cVar.f15534a;
                                                boolean z16 = cVar.f15535b;
                            ...
                            if (z10) {
                                bVar = new b(aVar, sVar, b0Var, cVar.f15534a, cVar.f15535b);
                                break;
                            }
                            b2.s sVar2 = sVar;
                            ...
                            j11 = j13;
                            oVar2.getClass();
                            bVar = new b(oVar2, sVar, b0Var3, cVar.f15534a, cVar.f15535b);
                            break;
                        }
                    }
                }
