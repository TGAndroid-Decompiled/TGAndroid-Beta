...
public final class o implements h0 {
    public static final b2.s f14206f;
    public static final b2.s f14207g;
    public final h0 f14208a;
    public final b2.s f14209b;
    public b2.s f14210c;
    public byte[] d;
    public int e;
    ...
    static {
        ...
        f14206f = new b2.s(rVar);
        b2.r rVar2 = new b2.r();
        rVar2.f1946q = r0.n("application/x-emsg");
        f14207g = new b2.s(rVar2);
    }
    ...
    public final void b(b2.s sVar) {
        this.f14210c = sVar;
        this.f14208a.b(this.f14209b);
    }

    @Override
    public final void c(long j3, int i10, int i11, int i12, g0 g0Var) {
        this.f14210c.getClass();
        int i13 = this.e - i12;
        v vVar = new v(Arrays.copyOfRange(this.d, i13 - i11, i13));
        byte[] bArr = this.d;
        System.arraycopy(bArr, i13, bArr, 0, i12);
        this.e = i12;
        String str = this.f14210c.f2002r;
        b2.s sVar = this.f14209b;
        String str2 = sVar.f2002r;
        String str3 = sVar.f2002r;
        if (!Objects.equals(str, str2)) {
            if ("application/x-emsg".equals(this.f14210c.f2002r)) {
                n3.a c10 = m3.b.c(vVar);
                b2.s a2 = c10.a();
                if (a2 != null && Objects.equals(str3, a2.f2002r)) {
                    byte[] c11 = c10.c();
                    c11.getClass();
                    vVar = new v(c11);
                } else {
                ...
                e2.a.n("HlsSampleStreamWrapper", "Ignoring sample for unsupported format: " + this.f14210c.f2002r);
                return;
            }
        }
        int a11 = vVar.a();
        h0 h0Var = this.f14208a;
        h0Var.d(a11, vVar);
