...
public final class q implements y2.h, y2.k, d1, c3.q, z0 {
    ...
    public final void D() {
        ...
        if (bVar == null) {
            ...
            if (uri != null && uri.equals(iVar.f16892p)) {
                ...
                bVar2.f43670b.b();
                IOException iOException = bVar2.f43676s;
                if (iOException != null) {
                    throw iOException;
                }
                return;
    ...
    public final k4.d g(y2.j jVar, long j3, long j10, IOException iOException, int i10) {
        ...
        k4.d dVar2 = dVar;
        boolean a10 = dVar2.a();
        this.v.p(tVar, eVar.f47329c, this.f16938b, eVar.d, eVar.f47330e, eVar.f47331f, eVar.h, eVar.f47332n, iOException, !a10);
        if (!a10) {
            this.K = null;
        }
        if (z10) {
    ...
    public final void h(y2.j jVar, long j3, long j10, int i10) {
        ...
        u2.t tVar2 = tVar;
        this.v.r(tVar2, eVar.f47329c, this.f16938b, eVar.d, eVar.f47330e, eVar.f47331f, eVar.h, eVar.f47332n, i10);
    }
    ...
    public final void i(y2.j jVar, long j3, long j10) {
        ...
        long j11 = eVar.f47327a;
        Uri uri2 = eVar.f47333r.f10326c;
        u2.t tVar = new u2.t(j10);
        this.f16955r.getClass();
        this.v.o(tVar, eVar.f47329c, this.f16938b, eVar.d, eVar.f47330e, eVar.f47331f, eVar.h, eVar.f47332n);
        if (!this.T) {
            q0 q0Var = new q0();
            q0Var.f11745a = this.f16946f0;
            p(new i2.r0(q0Var));
    ...
    public final void w(y2.j jVar, long j3, long j10, boolean z10) {
        ...
        u2.t tVar = new u2.t(j10);
        this.f16955r.getClass();
        this.v.n(tVar, eVar.f47329c, this.f16938b, eVar.d, eVar.f47330e, eVar.f47331f, eVar.h, eVar.f47332n);
        if (!z10) {
            if (B() || this.U == 0) {
                F();
            }
