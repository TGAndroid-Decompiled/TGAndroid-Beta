...
public final class q implements y2.h, y2.k, d1, c3.q, z0 {
    ...
    public final void V(y2.j jVar, long j3, long j10, boolean z10) {
        ...
        this.v.o(tVar, eVar.f43872c, this.f15441b, eVar.d, eVar.e, eVar.f43873f, eVar.h, eVar.f43874n);
        if (!z10) {
            if (A() || this.U == 0) {
                E();
            }
    ...
    public final k4.d n(y2.j jVar, long j3, long j10, IOException iOException, int i10) {
        ...
        k4.d dVar2 = dVar;
        boolean a10 = dVar2.a();
        this.v.q(tVar, eVar.f43872c, this.f15441b, eVar.d, eVar.e, eVar.f43873f, eVar.h, eVar.f43874n, iOException, !a10);
        if (!a10) {
            this.K = null;
        }
        if (z10) {
    ...
    public final void o(y2.j jVar, long j3, long j10, int i10) {
        ...
        u2.t tVar2 = tVar;
        this.v.s(tVar2, eVar.f43872c, this.f15441b, eVar.d, eVar.e, eVar.f43873f, eVar.h, eVar.f43874n, i10);
    }
    ...
    public final void q(y2.j jVar, long j3, long j10) {
        ...
        long j11 = eVar.f43870a;
        Uri uri2 = eVar.f43875r.f9352c;
        u2.t tVar = new u2.t(j10);
        this.f15457r.getClass();
        this.v.p(tVar, eVar.f43872c, this.f15441b, eVar.d, eVar.e, eVar.f43873f, eVar.h, eVar.f43874n);
        if (!this.T) {
            q0 q0Var = new q0();
            q0Var.f10863a = this.f15448f0;
            m(new i2.r0(q0Var));
