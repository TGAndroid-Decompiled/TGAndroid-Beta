...
public abstract class k {
    public static final b f19063a;
    public static final b f19064b;
    public static final b f19065c;
    ...
    static {
        ...
        f19063a = new b(2, "WEB_MESSAGE_ARRAY_BUFFER", "WEB_MESSAGE_ARRAY_BUFFER");
        ...
        f19064b = new b(2, "MULTI_PROCESS", "MULTI_PROCESS_QUERY");
        new b(6, "FORCE_DARK", "FORCE_DARK");
        new b(2, "FORCE_DARK_STRATEGY", "FORCE_DARK_BEHAVIOR");
        f19065c = new b(2, "WEB_MESSAGE_LISTENER", "WEB_MESSAGE_LISTENER");
