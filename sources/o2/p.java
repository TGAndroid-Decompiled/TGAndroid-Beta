...
public final class p extends a1 {
    ...
    public final b2.s p(b2.s sVar) {
        ...
        if (oVar2 != null && (oVar = (b2.o) this.H.get(oVar2.f3164c)) != null) {
            oVar2 = oVar;
        }
        ...
        if (p0Var != null) {
            ...
            while (true) {
                if (i10 < length) {
                    ...
                    if ((o0Var instanceof q3.n) && "com.apple.streaming.transportStreamTimestamp".equals(((q3.n) o0Var).f41133b)) {
                        break;
                    }
                    i10++;
                } else {
            ...
            if (oVar2 == sVar.v || p0Var != sVar.f3298l) {
                b2.r a2 = sVar.a();
                a2.f3252u = oVar2;
                a2.f3242k = p0Var;
                sVar = new b2.s(a2);
