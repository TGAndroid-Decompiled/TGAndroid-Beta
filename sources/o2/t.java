...
public final class t implements c3.o {
    public static final Pattern f15457i = Pattern.compile("LOCAL:([^,]+)");
    public static final Pattern f15458j = Pattern.compile("MPEGTS:(-?\\d+)");
    public final String f15459a;
    public final b0 f15460b;
    public final z3.l d;
    public final boolean e;
    public c3.q f15462f;
    public int h;
    public final v f15461c = new v();
    public byte[] f15463g = new byte[1024];
    ...
    public final boolean a(c3.p pVar) {
        c3.l lVar = (c3.l) pVar;
        lVar.h(this.f15463g, 0, 6, false);
        byte[] bArr = this.f15463g;
        v vVar = this.f15461c;
        vVar.H(6, bArr);
        if (i4.i.a(vVar)) {
            return true;
        }
        lVar.h(this.f15463g, 6, 3, false);
        vVar.H(9, this.f15463g);
        return i4.i.a(vVar);
    }

    public final h0 b(long j3) {
        h0 Z1 = this.f15462f.Z1(0, 3);
        b2.r rVar = new b2.r();
        rVar.f3250q = r0.n("text/vtt");
        rVar.d = this.f15459a;
        rVar.v = j3;
        hg.c.u(rVar, Z1);
        this.f15462f.e1();
    ...
    public final int m(c3.p pVar, c3.s sVar) {
        ...
        if (i10 == bArr.length) {
            ...
            this.f15463g = Arrays.copyOf(bArr, (length * 3) / 2);
        }
        byte[] bArr2 = this.f15463g;
        int i11 = this.h;
        ...
        while (true) {
            ...
            if (!TextUtils.isEmpty(k11)) {
                if (k11.startsWith("X-TIMESTAMP-MAP")) {
                    Matcher matcher2 = f15457i.matcher(k11);
                    if (matcher2.find()) {
                        Matcher matcher3 = f15458j.matcher(k11);
                        if (matcher3.find()) {
                ...
                while (true) {
                    ...
                    if (k12 == null) {
                        break;
                    } else if (i4.i.f10989a.matcher(k12).matches()) {
                        do {
                        ...
                        Matcher matcher4 = i4.h.f10986a.matcher(k12);
                        if (matcher4.matches()) {
                            matcher = matcher4;
                            break;
                        }
                ...
                long b10 = this.f15460b.b(d0.Y((j3 + c10) - j10, 90000L, 1000000L, RoundingMode.DOWN) % 8589934592L);
                h0 b11 = b(b10 - c10);
                byte[] bArr3 = this.f15463g;
                int i13 = this.h;
                v vVar2 = this.f15461c;
                vVar2.H(i13, bArr3);
                b11.d(this.h, vVar2);
