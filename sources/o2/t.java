...
public final class t implements c3.o {
    public static final Pattern f14242i = Pattern.compile("LOCAL:([^,]+)");
    public static final Pattern f14243j = Pattern.compile("MPEGTS:(-?\\d+)");
    public final String f14244a;
    public final b0 f14245b;
    public final z3.k d;
    public final boolean e;
    public c3.q f14247f;
    public int h;
    public final v f14246c = new v();
    ...
    public final h0 a(long j3) {
        h0 I = this.f14247f.I(0, 3);
        b2.r rVar = new b2.r();
        rVar.f1946q = r0.n("text/vtt");
        rVar.d = this.f14244a;
        rVar.v = j3;
        hc.b.u(rVar, I);
        this.f14247f.B();
    ...
    public final boolean b(c3.p pVar) {
        ...
        lVar.g(this.f14248g, 6, 3, false);
        vVar.H(9, this.f14248g);
        return i4.i.a(vVar);
    }
    ...
    public final int m(c3.p pVar, c3.s sVar) {
        ...
        if (i10 == bArr.length) {
            ...
            this.f14248g = Arrays.copyOf(bArr, (length * 3) / 2);
        }
        ...
        while (true) {
            ...
            if (!TextUtils.isEmpty(k11)) {
                if (k11.startsWith("X-TIMESTAMP-MAP")) {
                    Matcher matcher2 = f14242i.matcher(k11);
                    if (matcher2.find()) {
                        Matcher matcher3 = f14243j.matcher(k11);
                        if (matcher3.find()) {
                ...
                while (true) {
                    ...
                    if (k12 == null) {
                        break;
                    } else if (i4.i.f10471a.matcher(k12).matches()) {
                        do {
                        ...
                        Matcher matcher4 = i4.h.f10468a.matcher(k12);
                        if (matcher4.matches()) {
                            matcher = matcher4;
                            break;
                        }
                ...
                long b10 = this.f14245b.b(d0.Y((j3 + c10) - j10, 90000L, 1000000L, RoundingMode.DOWN) % 8589934592L);
                h0 a2 = a(b10 - c10);
                byte[] bArr3 = this.f14248g;
                int i13 = this.h;
                v vVar2 = this.f14246c;
                vVar2.H(i13, bArr3);
                a2.d(this.h, vVar2);
