...
public final class t implements c3.o {
    public static final Pattern f15645i = Pattern.compile("LOCAL:([^,]+)");
    public static final Pattern f15646j = Pattern.compile("MPEGTS:(-?\\d+)");
    public final String f15647a;
    public final b0 f15648b;
    public final z3.k d;
    public final boolean e;
    public c3.q f15650f;
    public int h;
    public final v f15649c = new v();
    public byte[] f15651g = new byte[1024];
    ...
    public final boolean a(c3.p pVar) {
        c3.l lVar = (c3.l) pVar;
        lVar.h(this.f15651g, 0, 6, false);
        byte[] bArr = this.f15651g;
        v vVar = this.f15649c;
        vVar.H(6, bArr);
        if (i4.i.a(vVar)) {
            return true;
        }
        lVar.h(this.f15651g, 6, 3, false);
        vVar.H(9, this.f15651g);
        return i4.i.a(vVar);
    }

    public final h0 b(long j3) {
        h0 Z1 = this.f15650f.Z1(0, 3);
        b2.r rVar = new b2.r();
        rVar.f3252q = r0.n("text/vtt");
        rVar.d = this.f15647a;
        rVar.v = j3;
        k0.s(rVar, Z1);
        this.f15650f.f1();
    ...
    public final int m(c3.p pVar, c3.s sVar) {
        ...
        if (i10 == bArr.length) {
            ...
            this.f15651g = Arrays.copyOf(bArr, (length * 3) / 2);
        }
        byte[] bArr2 = this.f15651g;
        int i11 = this.h;
        ...
        while (true) {
            ...
            if (!TextUtils.isEmpty(k11)) {
                if (k11.startsWith("X-TIMESTAMP-MAP")) {
                    Matcher matcher2 = f15645i.matcher(k11);
                    if (matcher2.find()) {
                        Matcher matcher3 = f15646j.matcher(k11);
                        if (matcher3.find()) {
                ...
                long b10 = this.f15648b.b(d0.Y((j3 + c10) - j10, 90000L, 1000000L, RoundingMode.DOWN) % 8589934592L);
                h0 b11 = b(b10 - c10);
                byte[] bArr3 = this.f15651g;
                int i13 = this.h;
                v vVar2 = this.f15649c;
                vVar2.H(i13, bArr3);
                b11.d(this.h, vVar2);
