...
public final class t implements c3.o {
    public static final Pattern f16941i = Pattern.compile("LOCAL:([^,]+)");
    public static final Pattern f16942j = Pattern.compile("MPEGTS:(-?\\d+)");
    ...
    public c3.q f16947f;
    public int h;
    public final v f16945c = new v();
    public byte[] f16948g = new byte[1024];
    ...
    public final h0 a(long j3) {
        h0 R1 = this.f16947f.R1(0, 3);
        b2.r rVar = new b2.r();
        rVar.f2312q = r0.n("text/vtt");
        rVar.d = this.f16943a;
        rVar.v = j3;
        i2.g.u(rVar, R1);
        this.f16947f.Z0();
    ...
    public final boolean b(c3.p pVar) {
        ...
        lVar.j(this.f16948g, 6, 3, false);
        vVar.H(9, this.f16948g);
        return i4.i.a(vVar);
    }
    ...
    public final int m(c3.p pVar, c3.s sVar) {
        ...
        if (i10 == bArr.length) {
            ...
            this.f16948g = Arrays.copyOf(bArr, (length * 3) / 2);
        }
        byte[] bArr2 = this.f16948g;
        int i11 = this.h;
        ...
        while (true) {
            ...
            if (!TextUtils.isEmpty(k11)) {
                if (k11.startsWith("X-TIMESTAMP-MAP")) {
                    Matcher matcher2 = f16941i.matcher(k11);
                    if (matcher2.find()) {
                        Matcher matcher3 = f16942j.matcher(k11);
                        if (matcher3.find()) {
                ...
                while (true) {
                    ...
                    if (k12 == null) {
                        break;
                    } else if (i4.i.f11853a.matcher(k12).matches()) {
                        do {
                        ...
                        Matcher matcher4 = i4.h.f11850a.matcher(k12);
                        if (matcher4.matches()) {
                            matcher = matcher4;
                            break;
                        }
                ...
                long b10 = this.f16944b.b(d0.Y((j3 + c10) - j10, 90000L, 1000000L, RoundingMode.DOWN) % 8589934592L);
                h0 a2 = a(b10 - c10);
                byte[] bArr3 = this.f16948g;
                int i13 = this.h;
                v vVar2 = this.f16945c;
                vVar2.H(i13, bArr3);
                a2.d(this.h, vVar2);
