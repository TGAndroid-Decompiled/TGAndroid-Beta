...
public final class m implements b1 {
    ...
    public final q f15417b;
    public int f15418c = -1;
    ...
    public final void a() {
        ...
        qVar.e();
        throw new IOException(a4.a.q("Unable to bind a sample queue to TrackGroup with MIME type ", qVar.Y.a(this.f15416a).d[0].f3306r, "."));
    }
    ...
    public final void b() {
        ...
        q qVar = this.f15417b;
        qVar.e();
        qVar.f15428a0.getClass();
        int[] iArr = qVar.f15428a0;
    ...
    public final boolean e() {
        if (this.f15418c != -3) {
            if (c()) {
                int i10 = this.f15418c;
                q qVar = this.f15417b;
                if (qVar.A() || !qVar.L[i10].x(qVar.f15440j0)) {
                    return false;
                }
                return true;
            }
                ...
                if (!arrayList.isEmpty()) {
                    ...
                    loop0: while (i13 < arrayList.size() - 1) {
                        ...
                        for (int i15 = 0; i15 < length; i15++) {
                            if (qVar.f15433d0[i15] && qVar.L[i15].B() == i14) {
                                break loop0;
                            }
                        }
                        i13++;
                    ...
                    if (!sVar2.equals(qVar.W)) {
                        qVar.v.k(qVar.f15429b, sVar2, jVar.e, jVar.f43841f, jVar.h);
                    }
                    qVar.W = sVar2;
                }
                if (arrayList.isEmpty() || ((j) arrayList.get(0)).g()) {
                    int C = qVar.L[i11].C(yVar, hVar, i10, qVar.f15440j0);
                    if (C == -5) {
                        b2.s sVar3 = (b2.s) yVar.f14993c;
                        sVar3.getClass();
                        if (i11 == qVar.R) {
