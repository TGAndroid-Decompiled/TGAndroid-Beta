...
public final class m implements b1 {
    ...
    public final void a() {
        ...
        q qVar = this.f16898b;
        qVar.e();
        qVar.f16910a0.getClass();
        int[] iArr = qVar.f16910a0;
    ...
    public final void b() {
        ...
        qVar.e();
        throw new IOException(a4.a.p("Unable to bind a sample queue to TrackGroup with MIME type ", qVar.Y.a(this.f16897a).d[0].f2370r, "."));
    }
    ...
    public final boolean e() {
        if (this.f16899c != -3) {
            if (c()) {
                int i10 = this.f16899c;
                q qVar = this.f16898b;
                if (qVar.B() || !qVar.L[i10].x(qVar.f16923j0)) {
                    return false;
                }
                return true;
            }
                ...
                if (!arrayList.isEmpty()) {
                    ...
                    loop0: while (i13 < arrayList.size() - 1) {
                        ...
                        for (int i15 = 0; i15 < length; i15++) {
                            if (qVar.f16915d0[i15] && qVar.L[i15].B() == i14) {
                                break loop0;
                            }
                        }
                        i13++;
                    ...
                    if (!sVar2.equals(qVar.W)) {
                        qVar.v.j(qVar.f16911b, sVar2, jVar.f47301e, jVar.f47302f, jVar.h);
                    }
                    qVar.W = sVar2;
                }
                if (arrayList.isEmpty() || ((j) arrayList.get(0)).g()) {
                    int C = qVar.L[i11].C(yVar, gVar, i10, qVar.f16923j0);
                    if (C == -5) {
                        b2.s sVar3 = (b2.s) yVar.f16497c;
                        sVar3.getClass();
                        if (i11 == qVar.R) {
