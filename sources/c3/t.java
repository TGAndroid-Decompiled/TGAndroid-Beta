...
public class t implements b0 {
    ...
    public final a0 j(long j3) {
        ...
        switch (this.f3798a) {
            case 0:
                u uVar = (u) this.f3800c;
                e2.d.h(uVar.f3808k);
                of.b bVar = uVar.f3808k;
                long[] jArr = (long[]) bVar.f15697b;
                long[] jArr2 = (long[]) bVar.f15698c;
                int e = e2.d0.e(jArr, e2.d0.i((uVar.e * j3) / 1000000, 0L, uVar.f3807j - 1), false);
                long j11 = 0;
                if (e == -1) {
                    j10 = 0;
                } else {
            ...
            case 1:
                return (a0) this.f3800c;
            default:
                e3.b bVar2 = (e3.b) this.f3800c;
                ...
                while (true) {
                    ...
                    if (i12 < eVarArr.length) {
                        ...
                        if (b11.f3710a.f3740b < b10.f3710a.f3740b) {
                            b10 = b11;
                        }
                        i12++;
                    } else {
    ...
    public t(long j3, long j10) {
        this.f3798a = 1;
        this.f3799b = j3;
        c0 c0Var = j10 == 0 ? c0.f3738c : new c0(0L, j10);
        this.f3800c = new a0(c0Var, c0Var);
    }
}
