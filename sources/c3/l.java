...
public final class l implements p {
    public final b2.k f3786b;
    public final long f3787c;
    public long d;
    public int f3788f;
    public int h;
    public byte[] e = new byte[65536];
    public final byte[] f3785a = new byte[4096];
    ...
    public final int c(byte[] bArr, int i10, int i11, int i12, boolean z10) {
        if (!Thread.interrupted()) {
            int read = this.f3786b.read(bArr, i10 + i12, i11 - i12);
            if (read == -1) {
                if (i12 == 0 && z10) {
                    return -1;
                }
    ...
    public final int e(int i10, int i11, byte[] bArr) {
        ...
        System.arraycopy(lVar.e, lVar.f3788f, bArr, i10, min);
        lVar.f3788f += min;
        return min;
    }
    ...
    public final boolean h(byte[] bArr, int i10, int i11, boolean z10) {
        ...
        System.arraycopy(this.e, this.f3788f - i11, bArr, i10, i11);
        return true;
    }

    @Override
    public final long i() {
        return this.d + this.f3788f;
    }
    ...
    public final boolean s(int i10, boolean z10) {
        b(i10);
        int i11 = this.h - this.f3788f;
        while (i11 < i10) {
            int i12 = i10;
            boolean z11 = z10;
            i11 = c(this.e, this.f3788f, i12, i11, z11);
            if (i11 == -1) {
                return false;
            }
            this.h = this.f3788f + i11;
            i10 = i12;
            z10 = z11;
        }
        this.f3788f += i10;
