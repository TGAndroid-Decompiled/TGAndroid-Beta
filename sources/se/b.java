...
public final class b {
    public static volatile b f44354j;
    public final byte[] f44355a;
    public final boolean f44356b;
    public final ByteBuffer f44357c;
    public final String d;
    public final String e;
    public final HashMap f44358f;
    public final HashMap f44359g;
    public final HashMap h;
    public final HashMap f44360i;
    ...
    public b() {
        ...
        try {
            ...
            this.f44358f = new HashMap(255);
            this.f44359g = new HashMap(255);
            this.h = new HashMap(10);
            this.f44360i = new HashMap(255);
            int f10 = f(0);
            int i10 = 4;
            int i11 = (f10 * 12) + 4;
            for (int i12 = 0; i12 < f10; i12++) {
                ...
                this.f44360i.put(g11, g10);
                this.f44358f.put(g10, Integer.valueOf(f11));
                ArrayList arrayList = (ArrayList) this.f44359g.get(g10);
                if (arrayList == null) {
                    arrayList = new ArrayList();
                    this.f44359g.put(g10, arrayList);
                }
                arrayList.add(g11);
            }
            String str = this.e;
    ...
    public final a a(String str) {
        ...
        if (aVar == null && (num = (Integer) bVar.f44358f.get(str)) != null) {
            int intValue = num.intValue();
            ?? obj = new Object();
            new ArrayList();
            obj.f44351a = "";
            obj.f44352b = new ArrayList();
            obj.f44353c = new ArrayList();
            obj.d = new ArrayList();
            obj.f44351a = str;
            ArrayList arrayList = (ArrayList) bVar.f44359g.get(str);
            bVar.h.put(str, obj);
            ...
            while (i14 < e10) {
                ?? obj2 = new Object();
                obj2.f44366b = new ArrayList();
                obj2.f44365a = bVar.e(i13);
                ...
                while (i15 < e11) {
                    ?? obj3 = new Object();
                    obj3.f44361a = bVar.f(i13);
                    obj3.f44362b = bVar.f(i13 + 4);
                    byte[] bArr = bVar.f44355a;
                    byte b10 = bArr[i13 + 8];
                    obj3.f44363c = bArr[i13 + 9];
                    ...
                    if (indexOf != -1) {
                        obj3.e = w2.k(obj3.e.substring(0, indexOf), obj3.e.substring(obj3.e.indexOf("]]") + 2));
                    }
                    arrayList5.add(obj3);
                    i15++;
                    bVar = this;
                }
                obj2.f44366b = arrayList5;
                arrayList4.add(obj2);
                i14++;
                bVar = this;
            }
        ...
        if (this.f44356b) {
            try {
                ...
                if (sb2.startsWith("+")) {
                    ...
                    a a2 = a(this.e);
                    if (a2 != null) {
                        ArrayList arrayList = a2.f44353c;
    ...
    public final short e(int i10) {
        if (i10 + 2 <= this.f44355a.length) {
            this.f44357c.position(i10);
            return this.f44357c.getShort();
        }
        return (short) 0;
    }

    public final int f(int i10) {
        if (i10 + 4 <= this.f44355a.length) {
            this.f44357c.position(i10);
            return this.f44357c.getInt();
        }
        return 0;
    }
