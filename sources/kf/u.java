...
public final class u {
    public final s f10505a = new s();
    public final s f10506b = new s();
    public final t f10507c = new s();
    ...
    public final void b(TL_update.TL_updateEditEphemeralMessage tL_updateEditEphemeralMessage, int i10, ConcurrentHashMap concurrentHashMap, ConcurrentHashMap concurrentHashMap2) {
        ...
        if (ephemeralMessage.anchor_msg_id != 0) {
            this.e.f10499a.add(ephemeralMessage);
            ...
            b10.flags |= 32768;
            s.a(this.f10506b, ephemeralMessage, b10, messageObject);
        } else {
            this.d.f10499a.add(ephemeralMessage);
        }
    }
    ...
    public final void c(TL_update.TL_updateNewEphemeralMessage tL_updateNewEphemeralMessage, int i10, ConcurrentHashMap concurrentHashMap, ConcurrentHashMap concurrentHashMap2) {
        ...
        if (ephemeralMessage.anchor_msg_id != 0) {
            ...
            TLRPC.TL_message b10 = w.b(ephemeralMessage);
            s.a(this.f10505a, ephemeralMessage, b10, new MessageObject(i10, (TLRPC.Message) b10, (AbstractMap<Long, TLRPC.User>) concurrentHashMap, (AbstractMap<Long, TLRPC.Chat>) concurrentHashMap2, true, true));
        } else {
            this.f10507c.f10499a.add(ephemeralMessage);
        }
    }
}
