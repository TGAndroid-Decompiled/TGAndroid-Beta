...
public abstract class q {
    public static void a(s01 s01Var, StringBuilder sb) {
        if (s01Var != null) {
            if ((s01Var.f28632a & 768) > 0) {
                sb.append("<spoiler>");
            }
            if ((s01Var.f28632a & 1) > 0) {
                sb.append("<b>");
            }
            if ((s01Var.f28632a & 2) > 0) {
                sb.append("<i>");
            }
            if ((s01Var.f28632a & 16) > 0) {
                sb.append("<u>");
            }
            if ((s01Var.f28632a & 8) > 0) {
                sb.append("<s>");
            }
            if ((s01Var.f28632a & 128) > 0 && s01Var.d != null) {
                sb.append("<a href=\"");
    ...
    public static String c(Spanned spanned) {
        ...
        int i15 = 0;
        while (i15 < length) {
            int nextSpanTransition = spanned.nextSpanTransition(i15, length, aj0.class);
            if (nextSpanTransition < 0) {
                nextSpanTransition = length;
            }
            aj0[] aj0VarArr = (aj0[]) spanned.getSpans(i15, nextSpanTransition, aj0.class);
            if (aj0VarArr != null) {
