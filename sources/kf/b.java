...
public final class b extends p {
    ...
    public long i() {
        return ((mf.a) ((d) this.f2245b)).e();
    }

    public boolean j() {
        long j3;
        b bVar = (b) this.f2247f;
        if (bVar != null) {
            j3 = bVar.i();
        } else {
            j3 = 0;
    ...
    public final String toString() {
        switch (this.f12434g) {
            case 0:
                ...
                long j3 = ((d) ((p) this.f2246c).f2245b).f6077b;
                d dVar = (d) this.f2245b;
                stringBuffer.append(j3 - dVar.f6077b);
                stringBuffer.append(",pos=");
                stringBuffer.append(dVar.f6077b);
                stringBuffer.append(",len=");
                mf.a aVar = (mf.a) dVar;
                stringBuffer.append(aVar.e() + aVar.f6077b);
                stringBuffer.append("]");
                return stringBuffer.toString();
            default:
                return a4.a.r(new StringBuilder("mp4[pos="), ((d) this.f2245b).f6077b, "]");
        }
    }
}
