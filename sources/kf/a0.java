...
public final class a0 extends View {
    ...
    public WindowManager f10394r;
    public WindowManager.LayoutParams f10395s;
    public Window v;
    public HandlerThread f10396w;
    public x f10397x;
    public View f10398y;
    ...
    public static void a(FrameMetrics frameMetrics) {
        z[] values;
        for (z zVar : z.values()) {
            if (Build.VERSION.SDK_INT >= zVar.f10517c) {
                long metric = frameMetrics.getMetric(zVar.f10515a);
                zVar.d = metric;
                if (metric >= 0) {
    ...
    public final void c() {
        ...
        if (window != null && (xVar = this.f10397x) != null) {
        ...
        HandlerThread handlerThread = this.f10396w;
        if (handlerThread != null) {
            handlerThread.quitSafely();
        }
        if (this.f10394r != null && this.D.getAndSet(false)) {
            try {
                this.f10394r.removeViewImmediate(this);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        while (true) {
            ...
            if (i10 < length2) {
                ...
                canvas.drawText(String.format(locale, "%-16s : %d /s", "vsync", Integer.valueOf(this.f10391c)), dp2, f18, paint);
                float f19 = f18 + f12;
                ...
                canvas.drawText(String.format(locale, "%-16s : %d /s", str, Integer.valueOf(this.f10392f)), dp2, f19, paint);
                return;
            }
        }
    }
    ...
    public void setObservedView(View view) {
        ...
        this.f10398y = view;
        if (this.C.get() && (view2 = this.f10398y) != null) {
            this.B = new y(this);
