...
public final class j implements Choreographer.FrameCallback {
    public static j f10467s;
    public final Choreographer f10468a;
    public final LinkedHashSet f10469b;
    public final SparseArray f10470c;
    public final be.b d;
    public final be.b e;
    public final be.b f10471f;
    public long h;
    public long f10472n;
    public int f10473r;
    ...
    public j() {
        ...
        this.f10468a = choreographer;
        this.f10469b = new LinkedHashSet();
        this.f10470c = new SparseArray();
        this.d = new be.b(true);
        this.e = new be.b(true);
        this.f10471f = new be.b(true);
    ...
    public final void doFrame(long r10) {
        throw new UnsupportedOperationException("Method not decompiled: kf.j.doFrame(long):void");
    }

    public final h e(int i10) {
        int i11;
        SparseArray sparseArray = this.f10470c;
        ...
        if (runnable != null) {
            ...
            while (true) {
                ...
                if (i10 < sparseArray.size()) {
                    be.b bVar = ((h) sparseArray.valueAt(i10)).f10455f;
