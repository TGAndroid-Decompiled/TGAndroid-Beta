...
public abstract class k0 {
    ...
    public static u9.c s(int i10, q5.c0 c0Var) {
        ...
        if (((HashMap) c0Var.f42808c) == null) {
            c0Var.f42808c = new HashMap();
        }
        ((HashMap) c0Var.f42808c).put(n7.w.class, sVar);
        String str = (String) c0Var.f42807b;
        if (((HashMap) c0Var.f42808c) == null) {
            unmodifiableMap = Collections.EMPTY_MAP;
        } else {
            unmodifiableMap = DesugarCollections.unmodifiableMap(new HashMap((HashMap) c0Var.f42808c));
        }
