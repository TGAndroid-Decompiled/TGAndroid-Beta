        ...
        if (powerManager != null) {
            ...
            if (f.b(context)) {
                ...
                if (context.getPackageManager() != null && packageName != null) {
                    try {
                        ApplicationInfo applicationInfo = w6.b.a(context).f13516a.getPackageManager().getApplicationInfo(packageName, 0);
    ...
    public final void a(long j3) {
        ...
        synchronized (this.f40981a) {
            try {
                ...
                c cVar = (c) this.f40988k.get(null);
                c cVar2 = cVar;
                if (cVar == null) {
                ...
                if (j10 > this.e) {
                    ...
                    this.d = this.f40990m.schedule(new b(this, 0), max, TimeUnit.MILLISECONDS);
                }
            } catch (Throwable th2) {
                throw th2;
            }
    ...
    public final void e() {
        synchronized (this.f40981a) {
            try {
                ...
                d();
                for (c cVar : this.f40988k.values()) {
                    cVar.f40993a = 0;
                }
                this.f40988k.clear();
                ScheduledFuture scheduledFuture = this.d;
