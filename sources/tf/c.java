...
public abstract class c extends bg.c {
    ...
    public boolean h;
    public boolean f44670n;
    public Location v;
    public String f44673w;
    public String f44674x;
    public b f44675y;
    public boolean f44669f = false;
    public final ArrayList f44671r = new ArrayList();
    public final ArrayList f44672s = new ArrayList();
    ...
    public final void H(String str, Location location, boolean z4) {
        ...
        if ((location != null || this.d) && ((location2 = this.v) == null || location == null || location.distanceTo(location2) >= 200.0f)) {
            ...
            if (!(userOrChat instanceof TLRPC.User)) {
                ...
                if (TextUtils.isEmpty(str) || (!this.d && !this.e)) {
                    ...
                    if (this.d) {
                        if (currentLocale.getLanguage().contains("en")) {
                            ...
                            str4 = str;
                            location4 = location;
                            Utilities.globalQueue.postRunnable(new kh.e1(cVar, currentLocale, str4, locale, location4, str, 21));
                        } else {
                            locale2 = Locale.US;
                        }
                    }
                ...
                cVar.C = ConnectionsManager.getInstance(cVar.D).sendRequest(tL_messages_getInlineBotResults, new ii1(6, this, str4));
                l();
            }
        }
    }
