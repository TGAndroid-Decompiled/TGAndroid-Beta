...
public abstract class c extends bg.c {
    ...
    public Location v;
    public String f44735w;
    public String f44736x;
    public b f44737y;
    public boolean f44731f = false;
    public final ArrayList f44733r = new ArrayList();
    public final ArrayList f44734s = new ArrayList();
    ...
    public final void H(String str, Location location, boolean z4) {
        ...
        if ((location != null || this.d) && ((location2 = this.v) == null || location == null || location.distanceTo(location2) >= 200.0f)) {
            ...
            if (!(userOrChat instanceof TLRPC.User)) {
                ...
                cVar.C = ConnectionsManager.getInstance(cVar.D).sendRequest(tL_messages_getInlineBotResults, new qi1(6, this, str4));
                l();
            }
        }
    }
