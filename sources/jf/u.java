...
public final class u {
    public final s f11680a = new s();
    public final s f11681b = new s();
    public final t f11682c = new s();
    public final t d = new s();
    public final t f11683e = new s();
    ...
    public final void b(TL_update.TL_updateEditEphemeralMessage tL_updateEditEphemeralMessage, int i10, ConcurrentHashMap concurrentHashMap, ConcurrentHashMap concurrentHashMap2) {
        ...
        if (ephemeralMessage.anchor_msg_id != 0) {
            this.f11683e.f11671a.add(ephemeralMessage);
            ...
            b10.flags |= 32768;
            s.a(this.f11681b, ephemeralMessage, b10, messageObject);
        } else {
            this.d.f11671a.add(ephemeralMessage);
        }
    }
    ...
    public final void c(TL_update.TL_updateNewEphemeralMessage tL_updateNewEphemeralMessage, int i10, ConcurrentHashMap concurrentHashMap, ConcurrentHashMap concurrentHashMap2) {
        ...
        if (ephemeralMessage.anchor_msg_id != 0) {
            ...
            TLRPC.TL_message b10 = w.b(ephemeralMessage);
            s.a(this.f11680a, ephemeralMessage, b10, new MessageObject(i10, (TLRPC.Message) b10, (AbstractMap<Long, TLRPC.User>) concurrentHashMap, (AbstractMap<Long, TLRPC.Chat>) concurrentHashMap2, true, true));
        } else {
            this.f11682c.f11671a.add(ephemeralMessage);
        }
    }
}
