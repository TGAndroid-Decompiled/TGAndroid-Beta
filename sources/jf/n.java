    ...
    public static SpannableStringBuilder a(String str) {
        ...
        try {
            if (Build.VERSION.SDK_INT >= 24) {
                fromHtml = Html.fromHtml("<inject>" + str + "</inject>", 63, null, new l(new bb.a(10)));
            } else {
                fromHtml = Html.fromHtml("<inject>" + str + "</inject>", null, new l(new bb.a(10)));
            }
            if (fromHtml == null) {
                return null;
            }
            ...
            for (Object obj : spans) {
                ...
                if (obj instanceof StyleSpan) {
                    ...
                    if (i10 == 0) {
                        ...
                        if (!TextUtils.isEmpty(mVar.f11655b)) {
                            arrayList2.add(mVar);
                        } else {
            ...
            for (int i11 = 0; i11 < arrayList2.size(); i11++) {
                ...
                spannableStringBuilder.setSpan(new CodeHighlighting.Span(true, 0, null, mVar2.f11655b, spannableStringBuilder.subSequence(spanStart3, spanEnd3).toString()), spanStart3, spanEnd3, 33);
            }
            for (int i12 = 0; i12 < arrayList3.size(); i12++) {
                ...
                qi0.c(spannableStringBuilder, spanStart4, spanEnd4, z10);
            }
