...
public final class g extends FrameLayout implements b6 {
    ...
    public long B;
    public final g6 f48847a;
    public final int f48848b;
    public final p9 f48849c;
    public final TextView d;
    public final p9 f48850e;
    public final TextView f48851f;
    public final TextView h;
    public final TextView f48852n;
    public final oq f48853r;
    public final tg.d f48854s;
    public final qg.b v;
    public boolean f48855w;
    public d f48856x;
    public long f48857y;
    ...
    public g(Context context, int i10, g6 g6Var) {
            ...
            public final void onClick(View view) {
                switch (r2) {
                    case 0:
                        ...
                        return;
                    case 1:
                        g gVar2 = this.f48842b;
                        d dVar4 = gVar2.f48856x;
                        if (dVar4 != null) {
                            long j11 = gVar2.B;
                        ...
                        return;
                    case 2:
                        g gVar3 = this.f48842b;
                        d dVar5 = gVar3.f48856x;
                        if (dVar5 != null) {
                            ((n0) dVar5).g(gVar3.f48857y, false);
                            return;
                        }
                        return;
                    default:
                        g gVar4 = this.f48842b;
                        d dVar6 = gVar4.f48856x;
                        if (dVar6 != null) {
                            ((n0) dVar6).g(gVar4.f48857y, true);
                            return;
                        }
                        return;
                }
        ...
        dVar3.e();
        dVar3.d();
        dVar3.setColor(k6.l1(0.14f, k6.v0(k6.f22055z6, g6Var)));
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.f48855w) {
            canvas2 = canvas;
            canvas2.drawLine(AndroidUtilities.dp(76.0f), getHeight() - 1, getMeasuredWidth(), getHeight() - 1, k6.f21781k0);
        } else {
            canvas2 = canvas;
        }
    ...
    public final boolean drawChild(Canvas canvas, View view, long j10) {
        tg.d dVar;
        p9 p9Var;
        if (Build.VERSION.SDK_INT >= 31 && (dVar = this.f48854s) != null && view == (p9Var = this.f48849c)) {
            ...
            a2.drawColor(k6.v0(k6.f21661d6, this.f48847a));
            a2.save();
            float f10 = dp2 / 2.0f;
    ...
    public final void e() {
        int i10 = k6.G6;
        g6 g6Var = this.f48847a;
        this.f48851f.setTextColor(k6.v0(i10, g6Var));
        int i11 = k6.f22055z6;
        this.h.setTextColor(k6.v0(i11, g6Var));
        this.f48852n.setTextColor(k6.v0(i11, g6Var));
    }
