...
public final class a extends sa {
    ...
    public a(Context context, TLRPC.Chat chat, long j10, Utilities.Callback callback) {
        ...
        this.e.setTitle(y());
        setBackgroundColor(j6.v0(j6.f19852a7, this.resourcesProvider));
    ...
    public final void P(Utilities.Callback callback, boolean z4, boolean z10) {
        ...
        if (z10 && !z4 && !this.Y) {
            ...
            z4.P(context, f6Var, string, LocaleController.getString(i10), LocaleController.getString(R.string.Add), new vq0(this, callback, z4, 11)).show();
            return;
        }
