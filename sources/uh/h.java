...
public final class h extends Drawable {
    ...
    public final Paint[] f42772a;
    public final float[] f42773b;
    public final Stack f42774c;
    public int d;
    public final float[] e;
    public final int[] f42775f;
    public RectF f42776g;
    public final ArrayList h;
    public View f42777i;
    public long f42778j;
    public float f42779k;
    public float f42780l;
    public float f42781m;
    public float f42782n;
    public boolean f42783o;
    public boolean f42784p;
    public Runnable f42785q;
    public ValueAnimator f42786r;
    public int f42787s;
    public TimeInterpolator f42788t;
    public boolean f42789u;
    public PorterDuffColorFilter v;
    public int f42790w;
    public int f42791x;
    public boolean f42792y;
    public final RectF f42793z;
    ...
    public h() {
        float[] fArr = C;
        this.f42772a = new Paint[fArr.length];
        this.f42773b = new float[fArr.length];
        this.f42774c = new Stack();
        this.e = new float[14];
        this.f42775f = new int[fArr.length];
        this.h = new ArrayList();
        this.f42782n = -1.0f;
        this.f42787s = 255;
        this.f42788t = new fd(1);
        this.f42793z = new RectF();
        for (int i10 = 0; i10 < fArr.length; i10++) {
            this.f42772a[i10] = new Paint();
            if (i10 == 0) {
                this.f42772a[i10].setStrokeWidth(AndroidUtilities.dp(1.4f));
                this.f42772a[i10].setStyle(Paint.Style.STROKE);
                this.f42772a[i10].setStrokeCap(Paint.Cap.ROUND);
            } else {
                this.f42772a[i10].setStrokeWidth(AndroidUtilities.dp(1.2f));
                this.f42772a[i10].setStyle(Paint.Style.STROKE);
                this.f42772a[i10].setStrokeCap(Paint.Cap.ROUND);
            }
            this.f42773b[i10] = this.f42772a[i10].getStrokeWidth() * 0.5f;
        }
    ...
    public static void g(View view, boolean z10, int i10, int i11, AtomicReference atomicReference, int i12, Layout layout, List list, Canvas canvas, boolean z11) {
        ...
        if (list != null && !list.isEmpty()) {
            ...
            if (!list.isEmpty()) {
                ...
                int i16 = 0;
                if (!list.isEmpty() && ((h) list.get(0)).f42782n != -1.0f) {
                    canvas.save();
                ...
                if (((h) list.get(i16)).f42782n != -1.0f) {
                    z12 = true;
                } else {
                    z12 = false;
                }
                ...
                while (it2.hasNext()) {
                    h hVar = (h) it2.next();
                    hVar.f42789u = z10;
                    if (hVar.f42777i != view) {
                        hVar.f42777i = view;
                    }
                    boolean z13 = hVar.f42784p;
                    hVar.f42784p = false;
                    if (z13) {
                        if (i12 == 1) {
                            textPaint = layout.getPaint();
                        } else {
                            textPaint = j6.f18122o2;
                        }
                        hVar.h(i0.a.d(Math.max(0.0f, hVar.f42782n), i10, textPaint.getColor()));
                    } else {
                        hVar.h(i10);
                    }
                    hVar.draw(canvas);
    ...
    public final void draw(Canvas canvas) {
        ...
        if (!bounds.isEmpty()) {
            ...
            j jVar = j.f42797q;
            int i11 = jVar.f42805k;
            a1[] a1VarArr = jVar.f42800c;
            if (a1VarArr[0] == null) {
                a1VarArr[0] = new a1(i11);
                jVar.f42802g = new Paint();
                jVar.f42803i = new ArrayList(100);
                float f7 = i11;
                ...
                while (true) {
                    ...
                    for (int i15 = 10; i14 < i15; i15 = 10) {
                        ...
                        hVar.h(-1);
                        jVar.f42803i.add(hVar);
                        i14++;
                    }
                    i13++;
                }
                i10 = 128;
                jVar.a(new Canvas((Bitmap) a1VarArr[0].f13938b), new Rect(0, 0, i11, i11));
                jVar.f42802g.setShader((BitmapShader) a1VarArr[0].f13939c);
                jVar.h = System.currentTimeMillis();
            } else {
                i10 = 128;
                if (jVar.f42810p && !LiteMode.isEnabled(128)) {
                    jVar.d = 0;
                    jVar.a(new Canvas((Bitmap) a1VarArr[0].f13938b), new Rect(0, 0, i11, i11));
                    jVar.f42802g.setShader((BitmapShader) a1VarArr[0].f13939c);
                    jVar.h = System.currentTimeMillis();
            ...
            if (LiteMode.isEnabled(i10)) {
                ...
                if (!jVar2.f42806l && !rect.isEmpty()) {
                    jVar2.f42806l = true;
                    Choreographer.getInstance().postFrameCallback(jVar2.f42808n);
                }
            }
        }
    }
    ...
    public final void e(Path path) {
        path.addCircle(this.f42779k, this.f42780l, q.a(this.f42782n, 0.0f, 1.0f) * this.f42781m, Path.Direction.CW);
    }
    ...
    public final void h(int i10) {
        if (this.f42790w != i10) {
            ...
            while (true) {
                float[] fArr = C;
                if (i11 < fArr.length) {
                    this.f42772a[i11].setColor(i0.a.k(i10, (int) (this.f42787s * fArr[i11])));
                    i11++;
                } else {
    ...
    public final void i(float f7, float f10, float f11) {
        if (this.f42776g == null) {
            this.f42776g = new RectF();
        }
        RectF rectF = this.f42776g;
    ...
    public final void invalidateSelf() {
        ...
        View view = this.f42777i;
        if (view != null) {
            if (view.getParent() != null && this.f42789u) {
    ...
    public final void j(float f7, float f10, float f11, boolean z10) {
        ...
        this.f42782n = f12;
        this.f42783o = z10;
        ValueAnimator valueAnimator = this.f42786r;
        ...
        if (this.f42783o) {
            ...
            alpha = this.f42772a[C.length - 1].getAlpha();
        }
        float f14 = this.f42782n;
        if (!z10) {
            f13 = 1.0f;
        }
        ValueAnimator duration = ValueAnimator.ofFloat(f14, f13).setDuration(q.a(this.f42781m * 0.3f, 250.0f, 550.0f));
        this.f42786r = duration;
        duration.setInterpolator(this.f42788t);
        this.f42786r.addUpdateListener(new s2(this, alpha, 6));
        this.f42786r.addListener(new mv0(this, 26));
        this.f42786r.start();
        invalidateSelf();
    }
    ...
    public final void setAlpha(int i10) {
        ...
        while (true) {
            float[] fArr = C;
            if (i11 < fArr.length) {
                this.f42772a[i11].setAlpha((int) (fArr[i11] * i10));
                i11++;
            } else {
                return;
            }
    ...
    public final void setBounds(int i10, int i11, int i12, int i13) {
        ...
        while (it.hasNext()) {
            c cVar = (c) it.next();
            if (!getBounds().contains((int) cVar.f42743a, (int) cVar.f42744b)) {
                it.remove();
            }
            Stack stack = this.f42774c;
