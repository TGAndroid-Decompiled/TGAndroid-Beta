...
public final class h extends Drawable implements Animator.AnimatorListener {
    public static final RectF f43786b0 = new RectF();
    public static final Rect f43787c0 = new Rect();
    public static final int[] f43788d0 = new int[2];
    public static final t8 f43789e0 = new t8("openFactor", 11);
    public static final t8 f43790f0 = new t8("openFactor", 12);
    ...
    public final i f43793b;
    public final LinearGradient f43795f;
    public final d[] f43799w;
    public final Drawable f43800x;
    public final t1 f43801y;
    public final Paint f43794c = new Paint(1);
    public final Matrix d = new Matrix();
    public final Path e = new Path();
    public final RectF h = new RectF();
    public final RectF f43796n = new RectF();
    public final RectF f43797r = new RectF();
    public final RectF f43798s = new RectF();
    ...
    public int R = -1;
    public final ObjectAnimator Z = ObjectAnimator.ofFloat(this, f43789e0, 1.0f).setDuration(560L);
    public final ObjectAnimator f43792a0 = ObjectAnimator.ofFloat(this, f43790f0, 1.0f).setDuration(240L);
    ...
    public h(j jVar, t1 t1Var, ArrayList arrayList, i iVar) {
        ...
        this.f43799w = new d[Math.min(5, arrayList.size())];
        int i10 = 0;
        while (true) {
            d[] dVarArr = this.f43799w;
            if (i10 < dVarArr.length) {
                dVarArr[i10] = new d(this, ((Long) arrayList.get(i10)).longValue());
                i10++;
            } else {
                this.f43794c.setStyle(Paint.Style.FILL);
                ...
                int v02 = i6.v0(i6.G8, this.f43801y.getResourcesProvider());
                ...
                this.f43795f = linearGradient;
                this.f43794c.setShader(linearGradient);
                ObjectAnimator objectAnimator = this.Z;
                LinearInterpolator linearInterpolator = f.f43768b;
                objectAnimator.setInterpolator(linearInterpolator);
                this.Z.addListener(this);
                this.f43792a0.setInterpolator(linearInterpolator);
                this.f43792a0.addListener(this);
    ...
    public final void d() {
        ...
        Bitmap bitmap2;
        Bitmap bitmap3;
        this.f43801y.setHideSideButtonByQuickShare(false);
        if (!this.T) {
            this.T = true;
            ...
            b bVar = this.P;
            if (bVar != null && (bitmap3 = bVar.f43745c) != null) {
                bitmap3.recycle();
                bVar.f43745c = null;
            }
            for (d dVar : this.f43799w) {
                b bVar2 = dVar.f43754f;
                if (bVar2 != null && (bitmap2 = bVar2.f43745c) != null) {
                    bitmap2.recycle();
                    bVar2.f43745c = null;
                }
                b bVar3 = dVar.e;
                if (bVar3 != null && (bitmap = bVar3.f43745c) != null) {
                    bitmap.recycle();
                    bVar3.f43745c = null;
                }
            }
    ...
    public final void e(Canvas canvas, boolean z10, int i10) {
        ...
        b bVar = hVar.P;
        d[] dVarArr = hVar.f43799w;
        int i19 = 2;
        RectF rectF2 = hVar.f43797r;
        if (bVar != null && !z10) {
            bVar.setBounds((int) rectF2.left, (int) (rectF2.top - AndroidUtilities.dp(30.0f)), (int) rectF2.right, (int) rectF2.bottom);
            hVar.P.f43748i = (int) ((1.0f - f.f43769c.getInterpolation(hVar.H)) * 255.0f);
            hVar.P.draw(canvas);
            if (hVar.R != -1) {
                        ...
                        public final void p(Canvas canvas3, int i21) {
                            ...
                            switch (r2) {
                                case 0:
                                    ...
                                    dVar2.getClass();
                                    canvas3.save();
                                    canvas3.translate(-dVar2.f43756i, -dVar2.f43757j);
                                    float f23 = dVar2.f43756i;
                                    float f24 = dVar2.f43757j;
                                    ...
                                    t1 t1Var2 = dVar2.f43752b;
                                    boolean R2 = t1Var2.R2();
                                    Paint paint = dVar2.f43755g;
                                    if (paint != null) {
                                    ...
                                    if (R2 || paint != null) {
                                        int alpha3 = i6.f18904h2.getAlpha();
                                        i6.f18904h2.setAlpha((int) (alpha3 * f25));
                                        canvas3.drawRoundRect(rectF3, dp4, dp4, i6.f18904h2);
                                        i6.f18904h2.setAlpha(alpha3);
                                    }
                                    canvas3.save();
                ...
                b bVar3 = dVar.e;
                bVar3.f43748i = (int) (interpolation * 255.0f);
                bVar3.draw(canvas);
                canvas.restore();
                return;
            }
        ...
        float f22 = f7;
        float g13 = g(0.3f, 0.075f, f.f43774k.getInterpolation(hVar.G));
        Matrix matrix = hVar.d;
        matrix.reset();
        matrix.setScale(g13, g13);
        matrix.postTranslate(0.0f, rectF2.bottom);
        hVar.f43795f.setLocalMatrix(matrix);
        Paint paint = hVar.f43794c;
        paint.setAlpha((int) (f.f43773j.getInterpolation(hVar.G) * 255.0f * f22));
        RectF rectF3 = f43786b0;
        rectF3.set(rectF2);
        rectF3.inset(-AndroidUtilities.dp(8.0f), -AndroidUtilities.dp(8.0f));
        Rect rect = f43787c0;
        rectF3.round(rect);
        Drawable drawable = hVar.f43800x;
        drawable.setAlpha((int) (f22 * 255.0f));
        drawable.setBounds(rect);
        drawable.draw(canvas);
        boolean z13 = hVar.M;
        RectF rectF4 = hVar.f43796n;
        if (!z13) {
            canvas.save();
            canvas.translate(rectF4.left, rectF4.top);
            canvas.rotate((f.f43770f.getInterpolation(hVar.G) - f.f43771g.getInterpolation(hVar.G)) * (-40.0f), AndroidUtilities.dp(16.0f), AndroidUtilities.dp(16.0f));
        ...
        float interpolation3 = f.f43783t.getInterpolation(hVar.G) * AndroidUtilities.dp(2.0f);
        float f23 = g.f43784a + 2;
        float interpolation4 = ((f.f43780q.getInterpolation(hVar.G) * AndroidUtilities.dp(f23)) / 2.0f) - interpolation3;
        float interpolation5 = ((f.f43781r.getInterpolation(hVar.G) * AndroidUtilities.dp(f23)) / 2.0f) - interpolation3;
        float interpolation6 = ((f.f43782s.getInterpolation(hVar.G) * AndroidUtilities.dp(f23)) / 2.0f) - interpolation3;
        int i21 = 0;
        while (i21 < i19) {
            int i22 = 0;
            while (i22 < dVarArr.length) {
                if ((i21 == 0 && i22 == hVar.R) || (i21 == i14 && i22 != hVar.R)) {
                    ...
                    float dp4 = (AndroidUtilities.dp(g.f43784a + 11) * length) + rectF2.centerX();
                    ...
                    if (!z11) {
                        ...
                        i12 = i22;
                        f11 = dp4;
                        dVar2.a(canvas2, f11, centerY2, f10 + (AndroidUtilities.dp(2.0f) * dVar2.f43762o), f22);
                    } else {
                        canvas2 = canvas;
                        i12 = i22;
                        f11 = dp4;
                    }
                    float f27 = dVar2.f43762o;
                    if (f27 > 0.0f && dVar2.h != null) {
                        float f28 = (f27 * 0.15f) + 0.85f;
                        canvas2.save();
                        canvas2.scale(f28, f28, f11, centerY2);
                        float f29 = dVar2.f43762o * f22;
                        i13 = i12;
                        float D = w1.D(8, 2, dVar2.h.getWidth());
                        dVar2.f43756i = d.b(d.b(f11, D, f25, f26), D, dp5, measuredWidth) - (D / 2.0f);
                        dVar2.f43757j = centerY2 - AndroidUtilities.dp(58.0f);
                        if (dVar2.f43754f == null) {
                            h hVar2 = dVar2.f43751a;
                            if (!hVar2.T) {
                                dVar2.f43755g = hVar2.L;
                                b bVar4 = new b(new a() {
                                    @Override
                                    public final void p(Canvas canvas3, int i212) {
                                        ...
                                        switch (r2) {
                                            case 0:
                                                ...
                                                dVar22.getClass();
                                                canvas3.save();
                                                canvas3.translate(-dVar22.f43756i, -dVar22.f43757j);
                                                float f232 = dVar22.f43756i;
                                                float f242 = dVar22.f43757j;
                                                ...
                                                t1 t1Var2 = dVar22.f43752b;
                                                boolean R2 = t1Var2.R2();
                                                Paint paint2 = dVar22.f43755g;
                                                if (paint2 != null) {
                                                ...
                                                if (R2 || paint2 != null) {
                                                    int alpha3 = i6.f18904h2.getAlpha();
                                                    i6.f18904h2.setAlpha((int) (alpha3 * f252));
                                                    canvas3.drawRoundRect(rectF32, dp42, dp42, i6.f18904h2);
                                                    i6.f18904h2.setAlpha(alpha3);
                                                }
                                                canvas3.save();
                        ...
                        b bVar5 = dVar2.f43754f;
                        if (bVar5 != null) {
                            float f30 = dVar2.f43756i;
                            float f31 = dVar2.f43757j;
                            bVar5.setBounds((int) f30, (int) f31, (int) (f30 + D), (int) (f31 + AndroidUtilities.dp(21.0f)));
                            b bVar6 = dVar2.f43754f;
                            bVar6.f43748i = (int) (f29 * 255.0f);
                            bVar6.draw(canvas2);
                        }
                        canvas2.restore();
                    } else {
    ...
    public final int h() {
        return AndroidUtilities.dp(((g.f43784a + 11) * this.f43799w.length) + 7);
    }
    ...
    public final void onAnimationEnd(Animator animator) {
        ...
        } else if (animator == this.f43792a0) {
            this.N = true;
            invalidateSelf();
            wb wbVar = this.W;
            if (wbVar != null) {
                wbVar.f29681a.setVisibility(0);
            }
            if (this.M) {
                iVar.run();
            }
