...
public final class i extends View {
    public final HashMap f44087a;
    public final ArrayList f44088b;
    public final ArrayList f44089c;
    public final int d;

    public i(Activity activity) {
        super(activity);
        this.f44087a = new HashMap();
    ...
    public final boolean a() {
        for (Map.Entry entry : this.f44087a.entrySet()) {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        ArrayList arrayList = this.f44088b;
