...
public final class i extends View {
    public final HashMap f44088a;
    public final ArrayList f44089b;
    public final ArrayList f44090c;
    public final int d;

    public i(Activity activity) {
        super(activity);
        this.f44088a = new HashMap();
        this.f44089b = new ArrayList();
        this.f44090c = new ArrayList();
    ...
    public final boolean a() {
        for (Map.Entry entry : this.f44088a.entrySet()) {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        ArrayList arrayList = this.f44089b;
