...
public final class i extends View {
    ...
    public final boolean a() {
        for (Map.Entry entry : this.f44060a.entrySet()) {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        ArrayList arrayList = this.f44061b;
