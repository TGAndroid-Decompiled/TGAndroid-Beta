...
public abstract class d extends h0 implements GroupCallMessagesController.CallMessageListener {
    ...
    public boolean d;
    public int e;
    public TLRPC.InputGroupCall f14344f;
    ...
    public final void onNewGroupCallMessage(long j3, GroupCallMessage groupCallMessage) {
        ...
        this.f14343c.add(0, groupCallMessage);
        o(0);
    }
    ...
    public final void onPopGroupCallMessage() {
        ...
        if (list != null && !list.isEmpty()) {
            int size = this.f14343c.size() - 1;
            this.f14343c.remove(size);
            u(size);
        }
    }
    ...
    public final void v(c1 c1Var, int i10) {
        ...
        if (list != null && list.size() > i10) {
            ((c) bVar.f42959a).set((GroupCallMessage) this.f14343c.get(i10));
        }
    }
}
