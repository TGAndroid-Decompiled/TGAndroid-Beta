...
public final class gb extends cb.e {
    ...
    public final RuntimeShader f12517c;
    ...
    public gb(View view) {
        ...
        this.f12520i = new float[7];
        this.f12521j = new float[7];
        this.f12522k = new float[7];
        this.f12523l = new float[7];
        RuntimeShader runtimeShader = new RuntimeShader(AndroidUtilities.readRes(R.raw.superripple_effect));
        this.f12517c = runtimeShader;
        L(true);
    ...
    public final void L(boolean z4) {
        ...
        float f11;
        float radius2;
        View view = (View) this.f2215a;
        if (!z4 && this.f12518f == view.getWidth() && this.f12519g == view.getHeight() && Math.abs(this.h - AndroidUtilities.density) <= 0.01f) {
            return;
        }
        RuntimeShader runtimeShader = this.f12517c;
        int width = view.getWidth();
        this.f12518f = width;
        int height = view.getHeight();
        this.f12519g = height;
        runtimeShader.setFloatUniform("size", width, height);
        RuntimeShader runtimeShader2 = this.f12517c;
        ...
        RuntimeShader runtimeShader3 = this.f12517c;
    ...
    public final void M() {
        ...
        if (!arrayList.isEmpty()) {
            ...
            while (true) {
                ...
                float f10 = fbVar.d;
                float f11 = fbVar.f12447c;
                float f12 = fbVar.f12446b;
                float f13 = fbVar.f12445a;
                fArr4[i10] = f10;
            ...
            if (z14) {
                this.f12517c.setIntUniform("count", this.e);
                this.f12517c.setFloatUniform("t", fArr4);
                this.f12517c.setFloatUniform("centerX", fArr3);
                this.f12517c.setFloatUniform("centerY", fArr2);
                this.f12517c.setFloatUniform("intensity", fArr);
                L(false);
                this.d = RenderEffect.createRuntimeShaderEffect(this.f12517c, "img");
            }
            z13 = z14;
        }
        if (arrayList.isEmpty()) {
