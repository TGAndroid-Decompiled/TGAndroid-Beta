...
public final class e6 implements Runnable {
    public final int f12347a = 1;
    public final t7 f12348b;
    public final TLObject f12349c;
    ...
    public e6(t7 t7Var, TLObject tLObject, TLRPC.TL_error tL_error, Utilities.Callback2 callback2, Context context, org.telegram.ui.ActionBar.f6 f6Var, long j10, String str, long j11, TLObject tLObject2, TLRPC.TL_textWithEntities tL_textWithEntities) {
        ...
        this.f12353s = j11;
        this.v = tLObject2;
        this.f12354w = tL_textWithEntities;
    }
    ...
    public final void run() {
        ...
        switch (this.f12347a) {
            case 0:
                t7 t7Var = this.f12348b;
                TLObject tLObject = this.f12349c;
                ...
                long j10 = this.f12351n;
                String str3 = this.f12352r;
                TLRPC.TL_payments_paymentFormStarGift tL_payments_paymentFormStarGift = (TLRPC.TL_payments_paymentFormStarGift) this.v;
                TL_stars.StarGift starGift = (TL_stars.StarGift) this.f12354w;
                long j11 = this.f12353s;
                ...
                if (!(tLObject instanceof TLRPC.TL_payments_paymentResult)) {
                    if (tL_error != null && "BALANCE_TOO_LOW".equals(tL_error.text)) {
                        if (!MessagesController.getInstance(t7Var.f13149a).starsPurchaseAvailable()) {
                ...
                if (BirthdayController.getInstance(t7Var.f13149a).contains(j11)) {
                    SharedPreferences.Editor edit = MessagesController.getInstance(t7Var.f13149a).getMainSettings().edit();
                    edit.putBoolean(Calendar.getInstance().get(1) + "bdayhint_" + j11, false).apply();
                }
                SharedPreferences.Editor edit2 = MessagesController.getInstance(t7Var.f13149a).getMainSettings().edit();
                ...
                if (launchActivity != null && (wa0Var = launchActivity.f31652u0) != null) {
                    wa0Var.c(true);
                    return;
                }
                return;
            default:
                t7 t7Var2 = this.f12348b;
                TLObject tLObject2 = this.f12349c;
                TLRPC.TL_error tL_error2 = this.d;
                Utilities.Callback2 callback22 = this.e;
                Context context2 = this.f12350f;
                org.telegram.ui.ActionBar.f6 f6Var2 = this.h;
                long j12 = this.f12351n;
                String str4 = this.f12352r;
                long j13 = this.f12353s;
                TLObject tLObject3 = this.v;
                TLRPC.TL_textWithEntities tL_textWithEntities = (TLRPC.TL_textWithEntities) this.f12354w;
                ...
                if (!(tLObject2 instanceof TLRPC.TL_payments_paymentResult)) {
                    if (tL_error2 != null && "BALANCE_TOO_LOW".equals(tL_error2.text)) {
                        if (!MessagesController.getInstance(t7Var2.f13149a).starsPurchaseAvailable()) {
                ...
                if (BirthdayController.getInstance(t7Var2.f13149a).contains(j13)) {
                    SharedPreferences.Editor edit3 = MessagesController.getInstance(t7Var2.f13149a).getMainSettings().edit();
                    edit3.putBoolean(Calendar.getInstance().get(1) + "bdayhint_" + j13, false).apply();
                }
                SharedPreferences.Editor edit4 = MessagesController.getInstance(t7Var2.f13149a).getMainSettings().edit();
                ...
                if (launchActivity2 != null && (wa0Var2 = launchActivity2.f31652u0) != null) {
                    wa0Var2.c(true);
                    return;
                }
                return;
