...
public final class q extends org.telegram.ui.ActionBar.p2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public TLRPC.TL_payments_starsRevenueStats f12953f;
    public boolean f12954f0;
    public final ArrayList f12955g0;
    public TLRPC.TL_starsRevenueStatus h;
    public String f12956h0;
    public DecimalFormat f12957i0;
    public SpannableStringBuilder f12958j0;
    public final d f12959k0;
    public final int f12960l0;
    public s91 f12961n;
    public final he f12962r;
    public final he f12963s;
    public final he v;
    public final he f12964w;
    public final he f12965x;
    public final he f12966y;

    public q(int i10, long j10) {
        super(null);
        boolean z4;
        String string;
        this.f12962r = he.a("XTR", LocaleController.getString(R.string.BotStarsOverviewAvailableBalance));
        this.f12963s = he.a("XTR", LocaleController.getString(R.string.BotStarsOverviewTotalBalance));
        this.v = he.a("XTR", LocaleController.getString(R.string.BotStarsOverviewTotalProceeds));
        this.f12964w = he.a("TON", LocaleController.getString(R.string.BotMonetizationOverviewAvailable));
        this.f12965x = he.a("TON", LocaleController.getString(R.string.BotMonetizationOverviewLastWithdrawal));
        this.f12966y = he.a("TON", LocaleController.getString(R.string.BotMonetizationOverviewTotal));
        boolean z10 = false;
        this.K = false;
        this.L = true;
        this.Q = new mq[1];
        this.f12952e0 = false;
        this.f12954f0 = false;
        this.f12955g0 = new ArrayList();
        this.f12956h0 = "";
        this.f12959k0 = new d(this, 0);
        this.f12960l0 = -1;
        this.f12945a = i10;
        this.f12947b = j10;
    ...
    public static void U(q qVar) {
        ...
        ic.e();
        TLRPC.TL_payments_starsRevenueStats h = b0.g(qVar.currentAccount).h(qVar.f12947b, false);
        if (h == null) {
            j10 = 0;
        } else {
    ...
    public static void W(q qVar, i51 i51Var) {
        if (i51Var.G(da.class)) {
            ja.h1(qVar.getParentActivity(), true, qVar.f12947b, qVar.currentAccount, (TL_stars.StarsTransaction) i51Var.G, qVar.getResourceProvider());
        } else if (i51Var.G instanceof TL_stats.BroadcastRevenueTransaction) {
            ke.h0(qVar.getParentActivity(), qVar.currentAccount, (TL_stats.BroadcastRevenueTransaction) i51Var.G, qVar.f12947b, qVar.resourceProvider);
        } else if (i51Var.d == 2) {
            qVar.presentFragment(new rh.e3(qVar.f12947b));
        }
    }
    ...
    public static void X(q qVar, Context context, View view) {
        if (view.isEnabled()) {
            ...
            if (!dVar.K) {
                ...
                tL_payments_getStarsRevenueAdsAccountUrl.peer = MessagesController.getInstance(qVar.currentAccount).getInputPeer(qVar.f12947b);
    ...
    public static void Y(q qVar, ArrayList arrayList) {
        ...
        int i15;
        he heVar = qVar.f12965x;
        ArrayList arrayList2 = qVar.f12955g0;
        he heVar2 = qVar.f12966y;
        he heVar3 = qVar.v;
        he heVar4 = qVar.f12963s;
        he heVar5 = qVar.f12962r;
        long j10 = qVar.f12947b;
        he heVar6 = qVar.f12964w;
        boolean z4 = qVar.f12949c;
        int i16 = qVar.f12960l0;
        b0 g10 = b0.g(qVar.currentAccount);
        int i17 = qVar.f12945a;
        if (i17 == 0) {
            arrayList.add(i51.h(2, i16, qVar.f12961n));
            ...
            if (h != null && (tL_starsRevenueStatus2 = h.status) != null) {
                heVar5.f34828a = false;
                heVar5.f34832g = true;
                TL_stars.StarsAmount starsAmount = tL_starsRevenueStatus2.available_balance;
                heVar5.f34833i = starsAmount;
                heVar5.h = "XTR";
                heVar5.f34831f = "USD";
                double d10 = qVar.W;
                heVar5.f34834j = (long) (starsAmount.amount * d10 * 100.0d);
                heVar4.f34828a = false;
                heVar4.f34832g = true;
                TL_stars.StarsAmount starsAmount2 = tL_starsRevenueStatus2.current_balance;
                heVar4.f34833i = starsAmount2;
                heVar4.h = "XTR";
                heVar4.f34834j = (long) (starsAmount2.amount * d10 * 100.0d);
                heVar4.f34831f = "USD";
                heVar3.f34828a = false;
                heVar3.f34832g = true;
                TL_stars.StarsAmount starsAmount3 = tL_starsRevenueStatus2.overall_revenue;
                heVar3.f34833i = starsAmount3;
                heVar3.h = "XTR";
                heVar3.f34834j = (long) (starsAmount3.amount * d10 * 100.0d);
                heVar3.f34831f = "USD";
            ...
            if (qVar.f12950c0 == null && j11 != null) {
            ...
            s91 s91Var = qVar.f12950c0;
            if (s91Var != null && !s91Var.f38237l) {
                arrayList.add(i51.h(5, i16, s91Var));
                arrayList.add(i51.A(-1, null));
            }
            if (qVar.f12951d0 == null && j11 != null) {
                TL_stats.StatsGraph statsGraph = j11.revenue_graph;
                if (statsGraph != null) {
                    statsGraph.rate = (float) (1.0E7d / j11.usd_rate);
                }
                i10 = 2;
                qVar.f12951d0 = ga1.f0(statsGraph, LocaleController.getString(R.string.BotMonetizationGraphRevenue), 2, false);
            } else {
                i10 = 2;
            }
            s91 s91Var2 = qVar.f12951d0;
            if (s91Var2 != null && !s91Var2.f38237l) {
                arrayList.add(i51.h(i10, i16, s91Var2));
                arrayList.add(i51.A(-2, null));
            }
            if (!qVar.f12948b0 && j11 != null && (tL_starsRevenueStatus = j11.status) != null) {
                ...
                heVar6.e = j13;
                if (qVar.f12957i0 == null) {
                    DecimalFormatSymbols decimalFormatSymbols = new DecimalFormatSymbols(Locale.US);
                    decimalFormatSymbols.setDecimalSeparator('.');
                    d = d11;
                    DecimalFormat decimalFormat = new DecimalFormat("#.##", decimalFormatSymbols);
                    qVar.f12957i0 = decimalFormat;
                    decimalFormat.setMinimumFractionDigits(2);
                    i12 = 6;
                    qVar.f12957i0.setMaximumFractionDigits(6);
                    qVar.f12957i0.setGroupingUsed(false);
                } else {
                    d = d11;
                    i12 = 6;
                }
                DecimalFormat decimalFormat2 = qVar.f12957i0;
                if (d12 > 1.5d) {
                    i12 = 2;
                }
                decimalFormat2.setMaximumFractionDigits(i12);
                SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(ke.f0("TON " + qVar.f12957i0.format(d12), qVar.T.getPaint(), 0.9f, 0.0f, true));
            ...
            if (qVar.f12946a0 == null) {
                ...
                qVar.f12946a0 = AndroidUtilities.replaceArrows(AndroidUtilities.replaceSingleTag(LocaleController.getString(i11), -1, 3, new d(qVar, 3)), true);
            }
            arrayList.add(i51.A(-5, qVar.f12946a0));
            if (!qVar.f12954f0 || !arrayList2.isEmpty()) {
    ...
    public static void Z(q qVar, TLRPC.TL_error tL_error, TwoStepVerificationActivity twoStepVerificationActivity, Activity activity, boolean z4, long j10, TLObject tLObject) {
        ...
        if (tL_error != null) {
            ...
            alertDialog$Builder.f19503a.O = LocaleController.getString(R.string.EditAdminTransferAlertTitle);
    ...
    public static void a0(q qVar, TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        if (tLObject instanceof TL_stars.StarsStatus) {
            ...
            qVar.f12956h0 = starsStatus.next_offset;
            qVar.f12955g0.addAll(starsStatus.history);
    ...
    public static void e0(q qVar) {
        int i10;
        if (!qVar.f12952e0 && !qVar.f12954f0 && qVar.f12956h0 != null) {
            qVar.f12952e0 = true;
            TL_stars.TL_payments_getStarsTransactions tL_payments_getStarsTransactions = new TL_stars.TL_payments_getStarsTransactions();
            tL_payments_getStarsTransactions.ton = true;
            tL_payments_getStarsTransactions.peer = MessagesController.getInstance(qVar.currentAccount).getInputPeer(qVar.f12947b);
            tL_payments_getStarsTransactions.offset = qVar.f12956h0;
            if (qVar.f12955g0.isEmpty()) {
                i10 = 5;
            } else {
                i10 = 20;
            }
    ...
    public final View createView(Context context) {
        ...
        TLRPC.User user = getMessagesController().getUser(Long.valueOf(this.f12947b));
        this.d.k(user, true);
        ...
        znVar3.i(org.telegram.ui.ActionBar.j6.w0(null, i12, false), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.Pi, false));
        ...
        this.C = new ia(context, this.currentAccount, false, this.f12947b, getClassGuid(), getResourceProvider());
        ...
        this.N.setHighlightColor(getThemedColor(org.telegram.ui.ActionBar.j6.f20216uf));
        this.N.setHandlesColor(getThemedColor(org.telegram.ui.ActionBar.j6.f20234vf));
        n nVar2 = this.N;
        if (LocaleController.isRTL) {
            i10 = 5;
        } else {
        ...
        this.e = g61Var;
        g61Var.setBackgroundColor(getThemedColor(org.telegram.ui.ActionBar.j6.f19852a7));
        this.e.p1();
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.botStarsUpdated && ((Long) objArr[0]).longValue() == this.f12947b) {
            g0();
        }
    }
    ...
    public final void g0() {
        ...
        ArrayList arrayList;
        TLRPC.TL_starsRevenueStatus tL_starsRevenueStatus;
        TLRPC.TL_payments_starsRevenueStats h = b0.g(this.currentAccount).h(this.f12947b, false);
        ...
        if (h != null) {
            ...
            this.f12961n = f02;
            if (f02 != null && (bVar = f02.d) != null && (arrayList = bVar.d) != null && !arrayList.isEmpty() && this.f12961n.d.d.get(0) != null) {
                s91 s91Var = this.f12961n;
                s91Var.h = true;
                ((wf.a) s91Var.d.d.get(0)).f46535g = org.telegram.ui.ActionBar.j6.yj;
                this.f12961n.d.h = (float) ((1.0d / this.W) / 100.0d);
            }
    ...
    public final boolean isLightStatusBar() {
        if (AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19906d6, false)) <= 0.721f) {
            return false;
        }
        return true;
    }
