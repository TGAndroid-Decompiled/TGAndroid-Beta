...
public final class j7 {
    ...
    public final ArrayList f12657f = new ArrayList();
    ...
    public final void a(int i10, ArrayList arrayList) {
        ...
        int i12 = this.f12654a;
        if (e != null) {
            e.f12756l.addAll(0, arrayList);
            e.f12758n = arrayList.size() + e.f12758n;
    ...
    public final void g() {
        if (this.f12659i != -1) {
            ConnectionsManager.getInstance(this.f12654a).cancelRequest(this.f12659i, true);
            this.f12659i = -1;
        }
        this.f12656c = false;
        this.d = false;
    ...
    public final void i() {
        if (!this.f12656c && !this.d) {
            this.f12656c = true;
            TL_stars.getStarGiftCollections getstargiftcollections = new TL_stars.getStarGiftCollections();
            int i10 = this.f12654a;
            getstargiftcollections.peer = MessagesController.getInstance(i10).getInputPeer(this.f12655b);
            ArrayList arrayList = this.e;
            int size = arrayList.size();
            long j10 = 0;
            int i11 = 0;
            ...
            this.f12659i = ConnectionsManager.getInstance(i10).sendRequest(getstargiftcollections, new h7(this, 0));
        }
    }

    public final void j() {
        ArrayList arrayList = this.f12657f;
        arrayList.clear();
        int i10 = 0;
        while (true) {
    ...
    public final void k(int i10, TL_stars.SavedStarGift savedStarGift) {
        ...
        boolean z4 = false;
        if (e != null) {
            ArrayList arrayList2 = e.f12756l;
                ...
                while (i11 < arrayList2.size()) {
                    ...
                    while (true) {
                        if (i12 >= arrayList.size()) {
                            ...
                            e.f12758n = Math.max(0, e.f12758n - 1);
                            i11--;
                            break;
                        } else {
                            i12++;
    ...
    public final void n(int i10) {
        ...
        if (e != null) {
            ...
            if (c3 != null) {
                ...
                NotificationCenter.getInstance(this.f12654a).lambda$postNotificationNameOnUIThread$1(NotificationCenter.starUserGiftCollectionsLoaded, Long.valueOf(this.f12655b), this);
            }
        }
    }
}
