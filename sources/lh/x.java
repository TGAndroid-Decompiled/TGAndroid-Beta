...
public final class x implements Runnable {
    ...
    public x(Context context, int i10, GiftAuctionController.Auction auction, long j10, Runnable runnable) {
        ...
        this.d = context;
        this.f13068b = i10;
        this.f13070e = auction;
        this.f13069c = j10;
        this.f13071f = runnable;
    }
    ...
    public final void run() {
        ...
        int i12 = this.f13068b;
        Object obj = this.f13071f;
        Object obj2 = this.f13070e;
        Object obj3 = this.d;
        switch (i10) {
            case 0:
                new e6((Context) obj3, this.f13068b, ((GiftAuctionController.Auction) obj2).gift, null, this.f13069c, (Runnable) obj, false, false).show();
                return;
            case 1:
                mh.z zVar = (mh.z) obj2;
                TLObject tLObject = (TLObject) obj;
                int i13 = ((mh.a0) obj3).f13669a;
                boolean[] zArr = zVar.d;
                boolean[] zArr2 = zVar.f15125b;
                ArrayList[] arrayListArr = zVar.f15124a;
                zArr[i12] = false;
            ...
            case 2:
                ...
                tL_fulfillStarsSubscription.subscription_id = ((TL_stars.StarsSubscription) obj2).f21073id;
                tL_fulfillStarsSubscription.peer = new TLRPC.TL_inputPeerSelf();
                int i14 = this.f13068b;
                ConnectionsManager.getInstance(i14).sendRequest(tL_fulfillStarsSubscription, new mh.t(dVar, (org.telegram.ui.ActionBar.h3[]) obj, i14, this.f13069c, 1));
                return;
            case 3:
                t6 t6Var = (t6) obj3;
                TLObject tLObject2 = (TLObject) obj2;
                String str2 = (String) obj;
                int i15 = t6Var.f17772a;
                HashSet hashSet = t6Var.f17789t;
                if (tLObject2 != null) {
                    ...
                    while (true) {
                        if (i11 < tL_stories_stories.stories.size()) {
                            if (tL_stories_stories.stories.get(i11).f21082id == i12) {
                ...
                hashSet.add(str2);
                t6Var.f17781l.edit().putStringSet("unsupported_stories_checked", hashSet).apply();
                return;
            case 4:
                ((BotForumHelper) obj3).lambda$beforeSendingFinalRequest$3((long[]) obj2, this.f13069c, this.f13068b, (Runnable) obj);
                return;
            case 5:
                ((MediaDataController) obj3).lambda$loadStickers$100((TLObject) obj2, this.f13068b, (Utilities.Callback) obj, this.f13069c);
                return;
            case 6:
                int i16 = this.f13068b;
                ((MessagesStorage) obj3).lambda$checkMessageId$154(this.f13069c, i16, (boolean[]) obj2, (CountDownLatch) obj);
                return;
            case 7:
                ((MessagesStorage) obj3).lambda$overwriteChannel$190(this.f13069c, this.f13068b, (TLRPC.TL_updates_channelDifferenceTooLong) obj2, (Runnable) obj);
                return;
            case 8:
                ((MessagesStorage) obj3).lambda$updateMessageVoiceTranscription$109(this.f13068b, this.f13069c, (TLRPC.Message) obj2, (String) obj);
                return;
            case 9:
                ((MessagesStorage) obj3).lambda$setDialogsFolderId$244((ArrayList) obj2, (ArrayList) obj, this.f13068b, this.f13069c);
                return;
            case 10:
                ((TopicsController) obj3).lambda$loadTopics$2((TLRPC.TL_messages_savedDialogs) obj2, this.f13069c, (a0.h) obj, this.f13068b);
                return;
            case 11:
                ((TopicsController) obj3).lambda$loadTopics$3((TLRPC.TL_messages_savedDialogsSlice) obj2, this.f13069c, (a0.h) obj, this.f13068b);
                return;
            default:
    ...
    public x(TopicsController topicsController, TLRPC.messages_SavedDialogs messages_saveddialogs, long j10, a0.h hVar, int i10, int i11) {
        ...
        this.f13070e = messages_saveddialogs;
        this.f13069c = j10;
        this.f13071f = hVar;
        this.f13068b = i10;
    }
