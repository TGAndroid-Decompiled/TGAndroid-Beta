...
public final class s8 implements View.OnClickListener {
    ...
    public final KeyEvent.Callback f13079c;
    public final Object d;
    public final Object e;
    public final Object f13080f;
    ...
    public final void onClick(View view) {
        ...
        int i11 = this.f13078b;
        Object obj = this.h;
        Object obj2 = this.f13080f;
        Object obj3 = this.e;
        Object obj4 = this.d;
        KeyEvent.Callback callback = this.f13079c;
        switch (i10) {
            case 0:
                ...
                if (!dVar.K) {
                    ...
                    tL_changeStarsSubscription.subscription_id = starsSubscription.f19385id;
                    int i12 = this.f13078b;
            ...
            case 3:
                ...
                alertDialog$Builder.k(LocaleController.getString(R.string.RevokeButton), new gg.a0((ir) obj4, (ph.d) callback, (TL_phone.getGroupCallStreamRtmpUrl) obj, this.f13078b, 4));
            ...
            case 4:
                ...
                if (tL_messages_requestUrlAuth != null && !TextUtils.isEmpty(tL_messages_requestUrlAuth.url)) {
                    if (!dVar2.K) {
                        ...
                        if (c1Var != null) {
                            boolean z10 = org.telegram.ui.web.c1.M0;
                            try {
            ...
            default:
                ...
                while (i13 < size) {
                    ...
                    if (tLObject2 instanceof TLRPC.User) {
                        j10 = ((TLRPC.User) tLObject2).f19306id;
                    ...
                    F.g(tLObject2, z4, new ov0(jArr, j11, f3Var, 3));
                }
                F.f27778t = false;
                F.f27777s = 0;
                F.V(5);
    ...
    public s8(m2.h hVar, int i10, LinearLayout linearLayout, AtomicBoolean atomicBoolean, HorizontalScrollView horizontalScrollView, zj0 zj0Var) {
        ...
        this.f13080f = horizontalScrollView;
        this.h = zj0Var;
    }

    public s8(xc0 xc0Var, xc0 xc0Var2, xc0 xc0Var3, int i10, org.telegram.ui.ActionBar.b3 b3Var, Utilities.Callback callback) {
        this.f13077a = 2;
        this.f13079c = xc0Var;
        this.d = xc0Var2;
        this.e = xc0Var3;
