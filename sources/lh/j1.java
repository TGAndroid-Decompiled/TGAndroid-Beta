...
public final class j1 extends org.telegram.ui.Components.sa {
    ...
    public final com.google.android.gms.common.api.internal.r f12621b0;
    public final com.google.android.gms.common.api.internal.r f12622c0;
    public final com.google.android.gms.common.api.internal.r f12623d0;
    public final nz f12624e0;
    public final b1 f12625f0;
    public final i1 f12626g0;
    public d1 f12627h0;
    public final FrameLayout f12628i0;
    public final ImageView f12629j0;
    public final ImageView f12630k0;
    public final c1 f12631l0;
    public final TextView m0;
    public final View f12632n0;
    public final ng.k f12633o0;
    public final ng.e f12634p0;
    public final sg.d f12635q0;
    public final ng.a f12636r0;
    public f1 f12637s0;
    public final boolean f12638t0;
    public boolean f12639u0;
    public final RectF f12640v0;
    public final PointF f12641w0;
    public final ArrayList f12642x0;
    public int f12643y0;
    public int f12644z0;
    ...
    public j1(Context context, org.telegram.ui.ActionBar.f6 f6Var, int i10, String str, ArrayList arrayList, boolean z4) {
        ...
        this.f12640v0 = rectF;
        this.f12641w0 = new PointF();
        ArrayList arrayList2 = new ArrayList(1);
        this.f12642x0 = arrayList2;
        ...
        this.f12633o0 = new ng.k(rl0Var, e3Var, new vs(rl0Var, 0));
        ...
        if (z4) {
            ...
            while (i12 < this.Z.size()) {
                ...
                if (stargiftattributemodel.rarity instanceof TL_stars.TL_starGiftAttributeRarity) {
                    this.f12620a0.add(stargiftattributemodel);
                    this.Z.remove(i12);
                    i12--;
                }
                i12++;
        ...
        List.EL.sort(this.f12620a0, Comparator$CC.comparingDouble(new z0(2)));
        ...
        int i13 = org.telegram.ui.ActionBar.j6.f19970i5;
        ...
        if (Build.VERSION.SDK_INT >= 31 && SharedConfig.chatBlurEnabled()) {
            this.f12634p0 = new ng.e(false);
            sg.d dVar = new sg.d(cVar);
            this.f12635q0 = dVar;
            dVar.v = new Runnable(this) {
                public final j1 f12073b;
                    ...
                    switch (r2) {
                        case 0:
                            if (Build.VERSION.SDK_INT >= 31) {
                                j1 j1Var = this.f12073b;
                                if (j1Var.f12634p0 != null) {
                                    j1Var.Q(2);
                                    return;
                                }
                                return;
            ...
            this.f12634p0 = null;
            this.f12635q0 = null;
            this.f12636r0 = new ng.a(cVar);
        }
        ug.i iVar = new ug.i(this.container);
        ng.a aVar2 = this.f12636r0;
        ...
        this.W = new dg.v3[3];
        this.f12626g0 = new i1(context, f6Var, new cg.h0(this, 19));
        int i19 = 0;
        while (true) {
            dg.v3[] v3VarArr = this.W;
            if (i19 < v3VarArr.length) {
                ...
                if (i19 != 0) {
                    if (i19 != 1) {
                        if (i19 == 2) {
                            ((TextView) this.W[i19].f4838c).setText(LocaleController.getString(R.string.GiftPreviewSymbol));
                        }
                    } else {
                        ((TextView) this.W[i19].f4838c).setText(LocaleController.getString(R.string.GiftPreviewBackdrop));
                    }
                } else {
                    ((TextView) this.W[i19].f4838c).setText(LocaleController.getString(R.string.GiftPreviewModel));
                }
                k7.d6.a(this.W[i19]);
                this.W[i19].setOnClickListener(new y0(this, i19, 0));
                this.W[i19].setBackground(org.telegram.ui.ActionBar.j6.Z(0, 285212671, 10, 10));
                LinearLayout linearLayout2 = this.V;
                dg.v3[] v3VarArr2 = this.W;
                dg.v3 v3Var2 = v3VarArr2[i19];
                if (i19 != v3VarArr2.length - 1) {
                    i11 = 11;
                } else {
                    i11 = 0;
                }
                ...
                this.f12628i0.addView(this.V, k7.b6.d(-1, -2.0f, 87, 16.0f, 0.0f, 16.0f, 18.0f));
                this.containerView.addView(this.f12628i0, k7.b6.e(-1, 315, 55));
                int d = i0.a.d(0.1f, getThemedColor(org.telegram.ui.ActionBar.j6.f19970i5), getThemedColor(org.telegram.ui.ActionBar.j6.f19952h5));
                ...
                this.f12626g0.setPadding(AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f));
                pg.b c11 = this.f12636r0.c(this.f12626g0, null, false);
                c11.o(AndroidUtilities.dp(4.0f));
                c11.p(AndroidUtilities.dp(28.0f));
                c11.n(new qg.b(org.telegram.ui.ActionBar.j6.f19881d6, f6Var));
                this.f12626g0.setBackground(c11);
                this.containerView.addView(this.f12626g0, k7.b6.d(268, 64.0f, 81, 0.0f, 0.0f, 0.0f, 5.0f));
                this.f12637s0 = new f1((TL_stars.starGiftAttributeBackdrop) lf.d.d(arrayList, TL_stars.starGiftAttributeBackdrop.class), (TL_stars.starGiftAttributePattern) lf.d.d(arrayList, TL_stars.starGiftAttributePattern.class), (TL_stars.starGiftAttributeModel) lf.d.d(arrayList, TL_stars.starGiftAttributeModel.class));
                this.f12627h0.N(false);
                T(false);
                return;
            }
        }
    ...
    public final void Q(int i10) {
        ng.e eVar;
        int dp;
        if (Build.VERSION.SDK_INT >= 31 && (eVar = this.f12634p0) != null) {
            if (k7.w8.a(i10, 2)) {
                org.telegram.ui.ActionBar.e3 e3Var = this.container;
                i1 i1Var = this.f12626g0;
                PointF pointF = this.f12641w0;
                ug.i.b(i1Var, e3Var, pointF);
                float f10 = pointF.x;
                RectF rectF = this.f12640v0;
                rectF.left = f10;
                rectF.top = pointF.y;
                ...
                if (!rectF.isEmpty()) {
                    ...
                    float f11 = -dp;
                    rectF.inset(f11, f11);
                    eVar.g(1, this.f12642x0);
                } else {
                    return;
                }
            }
            if (eVar.f14983j != 0) {
                eVar.e(this.f12633o0, this.container.getWidth(), this.container.getHeight());
            }
        }
    }
    ...
    public final boolean R(f1 f1Var) {
        if (this.f12644z0 != 1) {
            int i10 = this.f12626g0.f12562r;
            f1 f1Var2 = this.f12637s0;
            if (f1Var2 != null) {
                if (i10 == 1) {
                    if (f1Var.f12377a != f1Var2.f12377a) {
                        return false;
                    }
                } else if (i10 == 2) {
                    if (f1Var.f12378b != f1Var2.f12378b) {
                        return false;
                    }
                } else if (i10 != 0 || f1Var.f12379c != f1Var2.f12379c) {
                    return false;
                }
                return true;
            }
    ...
    public final void S(int i10) {
        ...
        this.f12630k0.setImageResource(i11);
        if (i10 == 2) {
    ...
    public final void T(boolean z4) {
        ...
        if (c1Var.getUpgradeImageViewAttribute() != null && c1Var.getUpgradeBackdropAttribute() != null && c1Var.getUpgradePatternAttribute() != null) {
            ...
            ((org.telegram.ui.Components.k6) v3VarArr[0].f4837b).setText(g5.J1(c1Var.getUpgradeImageViewAttribute().rarity, new Integer[1]));
            ((org.telegram.ui.Components.k6) v3VarArr[1].d).c(c1Var.getUpgradeBackdropAttribute().name, z4, true);
            ((org.telegram.ui.Components.k6) v3VarArr[1].f4837b).c(rh.j.G0(c1Var.getUpgradeBackdropAttribute().getRarityPermille()), z4, true);
            ((org.telegram.ui.Components.k6) v3VarArr[2].d).c(c1Var.getUpgradePatternAttribute().name, z4, true);
            ((org.telegram.ui.Components.k6) v3VarArr[2].f4837b).c(rh.j.G0(c1Var.getUpgradePatternAttribute().getRarityPermille()), z4, true);
        }
    }
    ...
    public final void U() {
        ...
        for (int i10 = 0; i10 < childCount; i10++) {
            ...
            if ((childAt instanceof h1) && (f1Var = (h1Var = (h1) childAt).v) != null) {
                boolean R = R(f1Var);
                h1Var.f12514c.f(R, true);
                h1Var.f12517r.a(R, true);
            }
        }
    }
    ...
    public final boolean isTouchOutside(float f10, float f11) {
        FrameLayout frameLayout = this.f12628i0;
    ...
    public final void mainContainerDispatchDraw(Canvas canvas) {
        ...
        if (Build.VERSION.SDK_INT >= 31 && canvas.isHardwareAccelerated() && (eVar = this.f12634p0) != null && (dVar = this.f12635q0) != null && !dVar.f44379n && dVar.f(width, height)) {
            RecordingCanvas a2 = dVar.a(width, height);
            a2.drawColor(getThemedColor(org.telegram.ui.ActionBar.j6.f19970i5));
            if (LiteMode.isEnabled(262144)) {
                i10 = -2;
            } else {
                i10 = -3;
    ...
    public final void onInsetsChanged() {
        ...
        if (this.f12643y0 != systemBottomInset) {
            this.f12643y0 = systemBottomInset;
            this.d.setPadding(AndroidUtilities.dp(16.0f), 0, AndroidUtilities.dp(16.0f), AndroidUtilities.dp(74.0f) + systemBottomInset);
            i1 i1Var = this.f12626g0;
            ((ViewGroup.MarginLayoutParams) i1Var.getLayoutParams()).bottomMargin = AndroidUtilities.dp(5.0f) + this.f12643y0;
            i1Var.requestLayout();
        }
    }
