...
public final class u0 extends View implements NotificationCenter.NotificationCenterDelegate {
    ...
    public float f13167r;
    public float f13168s;
    public float v;
    public float f13169w;
    public float f13170x;
    public final org.telegram.ui.Components.z5 f13171y;

    public u0(Context context, int i10, long j10, org.telegram.ui.n0 n0Var) {
        super(context);
        this.d = true;
        this.f13171y = new org.telegram.ui.Components.z5(this, 0L, 350L, mr.h);
        this.B = 1.0f;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.starUserGiftsLoaded && ((Long) objArr[0]).longValue() == this.f13163b) {
            a();
        }
    }
    ...
    public final void onAttachedToWindow() {
        ...
        NotificationCenter.getInstance(this.f13162a).addObserver(this, NotificationCenter.starUserGiftsLoaded);
    ...
    public final void onDetachedFromWindow() {
        ...
        NotificationCenter.getInstance(this.f13162a).removeObserver(this, NotificationCenter.starUserGiftsLoaded);
        ArrayList arrayList = this.E;
        int size = arrayList.size();
        int i10 = 0;
        while (i10 < size) {
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        while (true) {
            ...
            if (i10 < arrayList.size()) {
                if (((t0) arrayList.get(i10)).f13095l.contains(x10, y10)) {
        ...
        if (motionEvent.getAction() == 0) {
            this.J = t0Var;
            if (t0Var != null) {
                t0Var.f13096m.c(true);
            }
        } else if (motionEvent.getAction() == 2) {
            t0 t0Var4 = this.J;
            if (t0Var4 != t0Var && t0Var4 != null) {
                t0Var4.f13096m.c(false);
                this.J = null;
            }
        } else if (motionEvent.getAction() == 1) {
            if (this.J != null) {
                ze.d.s(getContext(), "https://t.me/nft/" + t0Var3.e);
                this.J.f13096m.c(false);
                this.J = null;
            }
        } else if (motionEvent.getAction() == 3 && (t0Var2 = this.J) != null) {
            t0Var2.f13096m.c(false);
            this.J = null;
        }
        if (this.J == null) {
            return false;
