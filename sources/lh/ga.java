...
public final class ga extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    public final g61 f12496a;
    public final org.telegram.ui.ActionBar.f6 f12497b;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == i12) {
            ...
            this.h.run();
        } else if (i10 == NotificationCenter.botStarsTransactionsLoaded && ((Long) objArr[0]).longValue() == this.f12499f) {
            g61Var.V2.N(true);
        }
    }
