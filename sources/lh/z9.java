...
public final class z9 extends org.telegram.ui.Components.sa implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static void P(z9 z9Var, int i10) {
        i51 G;
        w51 w51Var = z9Var.f13446b0;
        if (w51Var != null && (G = w51Var.G(i10 - 1)) != null) {
            w51 w51Var2 = z9Var.f13446b0;
            if (G.d == -1) {
                z9Var.f13447c0 = !z9Var.f13447c0;
                w51Var2.N(true);
            ...
            if (z10 != null && !z10.isEmpty()) {
                ...
                while (true) {
                    ...
                    if (tL_starsTopupOption.stars >= j10) {
                        if (tL_starsTopupOption.extended && !this.f13447c0 && z11) {
                            i15++;
                        } else {
    ...
    public final void dismiss() {
        ...
        kg.a aVar = this.V;
        if (aVar != null) {
            ((fg.i) aVar.f10409b).setPaused(true);
        }
    }
