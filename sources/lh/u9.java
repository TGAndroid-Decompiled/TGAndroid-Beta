...
public final class u9 extends m20 {
    ...
    public final void E(ViewGroup viewGroup, int i10, int i11, int[] iArr, int i12) {
        ...
        switch (this.H0) {
            case 0:
                ja jaVar = (ja) this.J0;
                if (viewGroup == jaVar.f36318c && jaVar.O.isAttachedToWindow()) {
                    ...
                    boolean z10 = false;
                    if (i11 < 0) {
                        if ((jaVar.f36318c.getHeight() - jaVar.f36318c.getPaddingBottom()) - bottom >= 0) {
                        ...
                        if ((jaVar.f36318c.getHeight() - jaVar.f36318c.getPaddingBottom()) - bottom >= 0 && currentListView3 != null && !currentListView3.canScrollVertically(1)) {
                            iArr[1] = i11;
                            jaVar.f36318c.B0();
                            return;
                        }
            ...
            default:
                ...
                if (viewGroup == gVar.f36318c && gVar.O.isAttachedToWindow()) {
                    kVar2 = ((org.telegram.ui.ActionBar.p2) gVar).actionBar;
                    boolean z11 = kVar2.f20305k0;
                    ...
                    boolean z12 = false;
                    if (i11 < 0) {
                        if (gVar.f36318c.getHeight() - bottom2 >= 0) {
                        ...
                        if (gVar.f36318c.getHeight() - bottom2 >= 0 && currentListView6 != null && !currentListView6.canScrollVertically(1)) {
                            iArr[1] = i11;
                            gVar.f36318c.B0();
                            return;
                        }
        ...
        switch (this.H0) {
            case 0:
                ...
                try {
                    if (viewGroup == jaVar.f36318c && jaVar.O.isAttachedToWindow()) {
                        rl0 currentListView = jaVar.O.getCurrentListView();
                        if ((jaVar.f36318c.getHeight() - jaVar.f36318c.getPaddingBottom()) - ((View) jaVar.O.getParent()).getBottom() >= 0) {
                            iArr[1] = i13;
            ...
            default:
                ...
                try {
                    if (viewGroup == gVar.f36318c && gVar.O.isAttachedToWindow()) {
                        ...
                        if (gVar.f36318c.getHeight() - ((View) gVar.O.getParent()).getBottom() >= 0) {
                            iArr[1] = i13;
                            currentListView2.scrollBy(0, i13);
                            return;
                        }
