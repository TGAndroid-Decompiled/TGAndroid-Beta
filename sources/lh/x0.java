...
public abstract class x0 {
    public static final float[][] f13327a;
    public static final a4.k f13328b;
    ...
    public static void b(Canvas canvas, int i10, Paint paint, Bitmap bitmap, float f10, float f11, float f12) {
        ...
        while (true) {
            ...
            a4.k.b((float[]) kVar.f87c, i12, 0.0f, 0.0f, width, height);
            i12++;
        }
        while (true) {
            float[] fArr = f13327a[i10];
            if (i11 < fArr.length) {
                ...
                float f19 = f15 * 1.0f;
                int i13 = i11 / 4;
                a4.k.b((float[]) kVar.f86b, i13, AndroidUtilities.dp(f17) - (AndroidUtilities.dp(f19) / 2.0f), AndroidUtilities.dp(f18) - (AndroidUtilities.dp(f19) / 2.0f), (AndroidUtilities.dp(f19) / 2.0f) + AndroidUtilities.dp(f17), (AndroidUtilities.dp(f19) / 2.0f) + AndroidUtilities.dp(f18));
        ...
        if (f16 > 0.0f) {
            ...
            for (int i13 = 54; i12 < i13; i13 = 54) {
                ...
                if (i12 == 18 || i12 == 19 || i12 == 6 || i12 == 7) {
                    clamp01 = nr.f27348i.getInterpolation(clamp01);
                }
                float[] fArr3 = fArr;
                float c3 = yh.c(1.0f, f16, AndroidUtilities.dp(12.0f), f48);
                int i14 = (clamp01 > 1.0f ? 1 : (clamp01 == 1.0f ? 0 : -1));
                if (i14 < 0) {
                    f47 = AndroidUtilities.lerp(f19, f47, nr.f27348i.getInterpolation(clamp01));
