...
public final class v3 extends Drawable {
    ...
    public final LinearGradient[] f13226b;
    public final Matrix f13227c;
    public final org.telegram.ui.Components.z5 d;
    public final Path e;
    public final wa f13228f;
    public int f13229g;
    public int h;
    ...
    public v3() {
        ...
        this.f13226b = new LinearGradient[2];
        this.f13227c = new Matrix();
        this.d = new org.telegram.ui.Components.z5(1.0f, new b(this, 7), 0L, 420L, mr.h);
        this.e = new Path();
        this.f13228f = new wa(1, 45);
    ...
    public final void a(int i10, int i11) {
        if (this.f13229g == i10 && this.h == i11) {
            return;
        }
        LinearGradient[] linearGradientArr = this.f13226b;
