    ...
    public final void run(Object obj, Object obj2) {
        ...
        switch (this.f12964a) {
            case 0:
                ...
                this.f12965b[0] = true;
                Utilities.Callback2 callback2 = this.f12966c;
                if (callback2 != null) {
            ...
            default:
                this.f12965b[0] = true;
                Utilities.Callback2 callback22 = this.f12966c;
                if (callback22 != null) {
                    if (bool.booleanValue()) {
                        str2 = "paid";
                    } else {
