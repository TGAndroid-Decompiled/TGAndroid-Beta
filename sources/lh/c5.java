...
public class c5 extends FrameLayout {
    ...
    public boolean W;
    public final org.telegram.ui.ActionBar.f6 f12213a;
    public boolean f12214a0;
    public final FrameLayout f12215b;
    public float f12216b0;
    public final u4 f12217c;
    public float f12218c0;
    public final org.telegram.ui.Components.p9[] d;
    public float f12219d0;
    public final TL_stars.starGiftAttributeModel[] e;
    public ValueAnimator f12220e0;
    public final LinearLayout[] f12221f;
    public final b f12222f0;
    public final Paint[] f12223g0;
    public final FrameLayout.LayoutParams[] h;
    public final RadialGradient[] f12224h0;
    public final Matrix[] f12225i0;
    public RadialGradient f12226j0;
    public final Matrix f12227k0;
    public final Paint f12228l0;
    public final TL_stars.starGiftAttributePattern[] m0;
    public final kh.y1 f12229n;
    public final org.telegram.ui.Components.j5[] f12230n0;
    public int f12231o0;
    public float f12232p0;
    public float f12233q0;
    public final e90[] f12234r;
    public ValueAnimator f12235r0;
    public final e90 f12236s;
    public final RectF f12237s0;
    public wa f12238t0;
    public final int[] f12239u0;
    public final TextView v;
    public final int[] f12240v0;
    public int f12241w;
    public final int[] f12242w0;
    public final FrameLayout f12243x;
    public final e90[] f12244y;
    ...
    public c5(Context context, org.telegram.ui.ActionBar.f6 f6Var, Runnable runnable, View.OnClickListener onClickListener, l1 l1Var, View.OnClickListener onClickListener2, View.OnClickListener onClickListener3, View.OnClickListener onClickListener4, View.OnClickListener onClickListener5, View.OnClickListener onClickListener6) {
        ...
        this.f12221f = new LinearLayout[5];
        this.h = new FrameLayout.LayoutParams[5];
        this.f12234r = new e90[5];
        this.f12244y = new e90[5];
        this.B = new LinearLayout.LayoutParams[5];
        this.C = new kh.w0[5];
        this.R = new c5.d(0, 0);
        this.S = new TL_stars.starGiftAttributeBackdrop[3];
        this.f12222f0 = new b(this, 11);
        this.f12223g0 = new Paint[3];
        this.f12224h0 = new RadialGradient[3];
        this.f12225i0 = new Matrix[3];
        this.f12227k0 = new Matrix();
        this.f12228l0 = new Paint(1);
        this.m0 = new TL_stars.starGiftAttributePattern[2];
        this.f12230n0 = new org.telegram.ui.Components.j5[2];
        int i10 = 0;
        while (true) {
            Paint[] paintArr = this.f12223g0;
        ...
        int i11 = 0;
        while (true) {
            org.telegram.ui.Components.j5[] j5VarArr = this.f12230n0;
        ...
        this.f12233q0 = 1.0f;
        this.f12237s0 = new RectF();
        this.f12239u0 = new int[12];
        this.f12240v0 = new int[12];
        this.f12242w0 = new int[12];
        this.f12213a = f6Var;
        this.O = onClickListener4;
        this.P = onClickListener5;
        this.Q = onClickListener6;
        setWillNotDraw(false);
        this.f12215b = new FrameLayout(context);
        int i12 = 0;
        while (true) {
            ...
            this.f12215b.addView(this.d[i12], k7.b6.e(-1, -1, 119));
        ...
        this.f12243x = new FrameLayout(context);
        int i14 = 0;
        while (true) {
            LinearLayout[] linearLayoutArr = this.f12221f;
            if (i14 >= linearLayoutArr.length) {
                break;
            }
            linearLayoutArr[i14] = new LinearLayout(context);
            this.f12221f[i14].setOrientation(1);
            if (i14 == 2) {
                FrameLayout frameLayout = new FrameLayout(context);
                this.G = frameLayout;
                this.f12221f[i14].addView(frameLayout, k7.b6.q(-1, 144, 119));
                ...
                this.f12234r[i14] = new e90(context, null);
                this.f12234r[i14].setTextColor(-1);
                this.f12234r[i14].setTextSize(1, 20.0f);
                this.f12234r[i14].setTypeface(AndroidUtilities.bold());
                this.f12234r[i14].setSingleLine();
                e90 e90Var2 = this.f12234r[i14];
                TextUtils.TruncateAt truncateAt = TextUtils.TruncateAt.END;
                e90Var2.setEllipsize(truncateAt);
                this.f12234r[i14].setGravity(17);
                frameLayout.addView(this.f12234r[i14], k7.b6.d(-1, -2.0f, 49, 16.0f, 95.33f, 16.0f, 0.0f));
                this.f12244y[i14] = new e90(context, null);
                this.f12244y[i14].setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20012j5, f6Var));
                this.f12244y[i14].setTextSize(1, 14.0f);
                this.f12244y[i14].setLinkTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19966gc, f6Var));
                this.f12244y[i14].setLineSpacing(AndroidUtilities.dp(2.0f), 1.0f);
                this.f12244y[i14].setDisablePaddingsOffsetY(true);
                this.f12244y[i14].setSingleLine();
                this.f12244y[i14].setGravity(17);
                this.f12244y[i14].setEllipsize(truncateAt);
                frameLayout.addView(this.f12244y[i14], k7.b6.d(-1, -2.0f, 49, 16.0f, 122.0f, 16.0f, 0.0f));
            } else if (i14 == 4) {
                f4 f4Var = new f4(context, f6Var);
                this.I = f4Var;
                this.f12221f[i14].addView(f4Var, k7.b6.n(-1, -2));
                View view = this.f12221f[i14];
                ...
                this.f12234r[i14] = new e90(context, null);
                this.f12234r[i14].setTextColor(i14 == 3 ? -1 : org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20012j5, f6Var));
                this.f12234r[i14].setTextSize(1, 20.0f);
                this.f12234r[i14].setTypeface(AndroidUtilities.bold());
                this.f12234r[i14].setGravity(17);
                this.f12221f[i14].addView(this.f12234r[i14], k7.b6.t(-1, -2, 17, 24, i14 == 3 ? 10 : 0, 24, 0));
                if (i14 == 0) {
                    this.f12221f[i14].addView(this.f12236s, k7.b6.t(-2, -2, 17, 0, 4, 0, 4));
                    this.f12221f[i14].addView(this.v, k7.b6.s(-2, 17, 0, 6, 0, 19.33f, 2));
                }
                if (i14 == 0) {
                    this.f12244y[i14] = new e90(context, null);
                    this.f12244y[i14].setTextColor(i14 == 3 ? org.telegram.ui.ActionBar.j6.l1(0.75f, -1) : org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20012j5, f6Var));
                    this.f12244y[i14].setTextSize(1, 14.0f);
                    this.f12244y[i14].setGravity(17);
                    this.f12244y[i14].setLinkTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19966gc, f6Var));
                    this.f12244y[i14].setLineSpacing(AndroidUtilities.dp(2.0f), 1.0f);
                    this.f12244y[i14].setDisablePaddingsOffsetY(true);
                    this.f12243x.addView(this.f12244y[i14], k7.b6.e(-2, -2, 17));
                    this.f12243x.addView(this.K, k7.b6.a(-2.0f, 20.33f, 17));
                    LinearLayout linearLayout = this.f12221f[i14];
                    FrameLayout frameLayout2 = this.f12243x;
                    ...
                    this.f12244y[i14].setLineSpacing(AndroidUtilities.dp(2.0f), 1.0f);
                    this.f12244y[i14].setDisablePaddingsOffsetY(true);
                    LinearLayout linearLayout2 = this.f12221f[i14];
                    e90 e90Var3 = this.f12244y[i14];
                ...
                this.f12221f[i14].addView(this.C[i14], k7.b6.t(-1, -2, 17, 24, 8, 24, 0));
            }
            if (i14 == 0) {
                this.f12221f[i14].addView(this.E, k7.b6.t(-1, -2, 7, 0, 15, 0, 0));
            }
            View view2 = this.f12221f[i14];
        ...
        addView(this.f12215b, k7.b6.d(160, 160.0f, 49, 0.0f, 8.0f, 0.0f, 0.0f));
        ...
        kh.b2 b2Var = y1Var.f10955a;
        if (b2Var.f10474f == null) {
            wa waVar = new wa(2, 12);
            b2Var.f10474f = waVar;
            waVar.h = 5.0f;
        }
        Path path = b2Var.f10473c;
        float f12 = b2Var.e;
        b2Var.f10475g = true;
    ...
    public final void a() {
        ValueAnimator valueAnimator = this.f12235r0;
        if (valueAnimator != null) {
            valueAnimator.cancel();
            this.f12235r0 = null;
        }
        ValueAnimator ofFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
        this.f12235r0 = ofFloat;
        ofFloat.addUpdateListener(new y4(this, 1));
        this.f12235r0.addListener(new a5(this, 4));
        this.f12235r0.setDuration(320L);
        this.f12235r0.setInterpolator(nr.f27347g);
        this.f12235r0.start();
    }

    public final int b(Canvas canvas, float f10, float f11, float f12, float f13) {
        int i10 = this.f12231o0;
        RadialGradient[] radialGradientArr = this.f12224h0;
        TL_stars.starGiftAttributeBackdrop[] stargiftattributebackdropArr = this.S;
        Matrix[] matrixArr = this.f12225i0;
        Paint[] paintArr = this.f12223g0;
        int i11 = 0;
        if (i10 == 0) {
            if (this.f12232p0 > 0.0f && stargiftattributebackdropArr[2] != null) {
            ...
            if (this.f12232p0 < 1.0f && stargiftattributebackdropArr[1] != null) {
                paintArr[1].setAlpha((int) ((1.0f - this.f12232p0) * this.R.a(1) * 255.0f));
                matrixArr[1].reset();
        ...
        if (this.f12232p0 > 0.0f && stargiftattributebackdropArr[2] != null) {
            paintArr[2].setAlpha((int) (this.R.a(1) * 255.0f * this.f12232p0));
            matrixArr[2].reset();
            matrixArr[2].postTranslate(f10, f11);
            radialGradientArr[2].setLocalMatrix(matrixArr[2]);
            canvas.drawRect(0.0f, 0.0f, f12, f13, paintArr[2]);
    ...
    public final void c(Canvas canvas, float f10, float f11, float f12, float f13) {
        ...
        int d = i0.a.d(this.f12232p0, i10, i11);
        org.telegram.ui.Components.j5[] j5VarArr = this.f12230n0;
        j5VarArr[1].k(Integer.valueOf(d));
        x0.a(canvas, 0, j5VarArr[1], f12, f13, this.R.a(1), this.f12233q0);
        canvas.restore();
    }
    ...
    public void d(c5.d dVar) {
        ...
        if ((stargiftattributebackdropArr[0] != null && dVar.f2083b == 2) || (stargiftattributebackdropArr[1] != null && dVar.f2083b == 1)) {
            i10 = 0;
        } else {
            i10 = 8;
        }
        ...
        int v02 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20012j5, this.f12213a);
        int i22 = 0;
        while (true) {
            e90VarArr = this.f12244y;
            if (i22 >= 2) {
                break;
            }
            e90 e90Var = this.f12234r[i22];
            if (stargiftattributebackdropArr[Math.min(1, i22)] == null) {
                i13 = v02;
            } else {
                i13 = -1;
            }
            e90Var.setTextColor(i13);
            e90 e90Var2 = e90VarArr[i22];
            if (i22 != 0 && i22 != 2) {
                TL_stars.starGiftAttributeBackdrop stargiftattributebackdrop = stargiftattributebackdropArr[1];
                if (stargiftattributebackdrop == null) {
                    i15 = v02;
                ...
                i14 = i0.a.d(this.f12232p0, i15, i16);
            } else {
            ...
            if (z10) {
                ...
                if (i22 == 0) {
                    this.f12243x.setLayoutParams(layoutParamsArr2[i22]);
                } else {
                    e90VarArr[i22].setLayoutParams(layoutParamsArr2[i22]);
                }
            }
            i22++;
        }
        ...
        p9VarArr[1].setAlpha((1.0f - this.f12232p0) * dVar.a(1));
        p9VarArr[2].setAlpha(dVar.a(1) * this.f12232p0);
        float lerp3 = AndroidUtilities.lerp(1.0f, this.f12219d0, dVar.a(2));
        FrameLayout frameLayout = this.f12215b;
        frameLayout.setScaleX(lerp3);
        frameLayout.setScaleY(AndroidUtilities.lerp(1.0f, this.f12219d0, dVar.a(2)));
        frameLayout.setTranslationX(dVar.a(2) * this.f12216b0);
        frameLayout.setTranslationY((dVar.a(2) * this.f12218c0) + (dVar.a(1) * AndroidUtilities.dp(16.0f)));
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        if (i10 > 0 && stargiftattributebackdropArr2[0] != null) {
            if (this.f12226j0 != null && this.R.a(2) >= 1.0f) {
                ...
                this.f12224h0[0].setLocalMatrix(matrixArr[0]);
                stargiftattributebackdropArr = stargiftattributebackdropArr2;
                canvas.drawRect(0.0f, 0.0f, getWidth(), realHeight, paintArr[0]);
            }
            if (this.f12226j0 != null && this.R.a(2) > 0.0f) {
                Paint paint = this.f12228l0;
                paint.setAlpha((int) (this.R.a(2) * 255.0f));
                Matrix matrix = this.f12227k0;
                matrix.reset();
                matrix.postTranslate(getWidth() / 2.0f, 0.4f * realHeight);
                this.f12226j0.setLocalMatrix(matrix);
        ...
        int[] iArr4 = this.f12242w0;
        int[] iArr5 = this.f12240v0;
        int[] iArr6 = this.f12239u0;
        if (stargiftattributebackdrop != null) {
        ...
        u4 u4Var2 = this.f12217c;
        if (u4Var2.f13205s == null && u4Var2.v == null && u4Var2.f13206w == null) {
            c5Var = this;
            f13 = f10;
            f12 = f11;
            iArr3 = iArr4;
            ...
            float f14 = f10;
            o4 o4Var = u4Var2.f13205s;
            float f15 = f11;
            float f16 = u4Var2.f13207x;
            int[] iArr7 = this.f12240v0;
            int[] iArr8 = this.f12239u0;
            int[] iArr9 = this.f12242w0;
            f12 = f15;
            iArr = iArr5;
            iArr2 = iArr6;
            iArr3 = iArr4;
            ...
            u4Var2.a(canvas2, u4Var2.v, u4Var2.f13208y, width2, realHeight, iArr7, iArr8, iArr9);
            u4Var2.a(canvas2, u4Var2.f13206w, u4Var2.B, width2, realHeight, iArr7, iArr8, iArr9);
            u4Var = u4Var2;
            c5Var.invalidate();
        }
        if (i10 > 0 && stargiftattributebackdropArr[0] != null) {
            ...
            org.telegram.ui.Components.j5[] j5VarArr = c5Var.f12230n0;
            if (max2 > 0.0f) {
                canvas2.save();
            ...
            if (c5Var.R.a(2) > 0.0f) {
                ...
                LinearLayout[] linearLayoutArr = c5Var.f12221f;
            ...
            if (textView != null && c5Var.f12241w != i14) {
                c5Var.f12241w = i14;
                textView.setTextColor(i14);
                org.telegram.ui.ActionBar.j6.B1(textView.getBackground(), i15, false);
            }
            if (u4Var.f13205s != null || u4Var.v != null || u4Var.f13206w != null) {
                c5Var.f12244y[0].setTextColor(i14);
            }
            if (c5Var.R.a(2) > 0.0f) {
                if (c5Var.f12238t0 == null) {
                    c5Var.f12238t0 = new wa(1, 12);
                }
                FrameLayout frameLayout2 = c5Var.f12215b;
                ...
                RectF rectF2 = c5Var.f12237s0;
                rectF2.set(measuredWidth - scaleX, measuredHeight - scaleY, measuredWidth + scaleX, f18);
                c5Var.f12238t0.g(rectF2);
                c5Var.f12238t0.d();
                c5Var.f12238t0.a(canvas2, org.telegram.ui.ActionBar.j6.l1(c5Var.R.a(2), -1));
                c5Var.invalidate();
            }
        }
        if (c5Var.R.a(1) > 0.0f) {
    ...
    public final void e(int i10, TL_stars.starGiftAttributeBackdrop stargiftattributebackdrop) {
        ...
        if (i10 == 0) {
            ...
            this.f12226j0 = radialGradient2;
            this.f12228l0.setShader(radialGradient2);
        }
        Matrix[] matrixArr = this.f12225i0;
        if (matrixArr[i10] == null) {
            matrixArr[i10] = new Matrix();
        }
        this.f12223g0[i10].setShader(radialGradientArr[i10]);
    }
    ...
    public final void f(TL_stars.StarGift starGift, boolean z4, boolean z10, boolean z11) {
        ...
        if (z14) {
            ...
            if (z12) {
                ...
                dVar.b(i10, LocaleController.getString(i11), false);
            }
            float f10 = 1.0f;
            ...
            this.f12229n.f10955a.d(stargiftattributebackdropArr[0], false, true);
        } else {
    ...
    public final void g(int i10, TL_stars.starGiftAttributePattern stargiftattributepattern, boolean z4) {
        if (stargiftattributepattern != null) {
            ...
            if (stargiftattributepatternArr[i10] != stargiftattributepattern) {
                ...
                this.f12230n0[i10].i(stargiftattributepattern.document, z4);
            }
        }
    }
    ...
    public final void h(int i10, CharSequence charSequence, CharSequence charSequence2, SpannableStringBuilder spannableStringBuilder, CharSequence charSequence3, TLObject tLObject, Spannable spannable) {
        int i11;
        int i12;
        this.f12234r[i10].setText(charSequence);
        FrameLayout frameLayout = this.f12243x;
        e90[] e90VarArr = this.f12244y;
        e90 e90Var = this.f12236s;
        ...
        if (i10 == 0 && !TextUtils.isEmpty(spannableStringBuilder)) {
            ...
            if (i10 == 0) {
                ...
                e90 e90Var2 = e90VarArr[i10];
                if (TextUtils.isEmpty(charSequence2)) {
                    i11 = 8;
                } else {
                    i11 = 0;
                }
                e90Var2.setVisibility(i11);
            }
            e90Var.setVisibility(8);
            textView.setVisibility(8);
        }
    ...
    public final void k() {
        this.f12219d0 = AndroidUtilities.dpf2(33.33f) / AndroidUtilities.dpf2(160.0f);
        FrameLayout frameLayout = this.f12215b;
        e90[] e90VarArr = this.f12234r;
        this.f12216b0 = ((((Math.min(e90VarArr[2].getPaint().measureText(e90VarArr[2].getText().toString()), e90VarArr[2].getWidth()) + e90VarArr[2].getWidth()) / 2.0f) + (e90VarArr[2].getX() + (-frameLayout.getLeft()))) + AndroidUtilities.dp(24.0f)) - (AndroidUtilities.dp(126.67f) / 2.0f);
        this.f12218c0 = (AndroidUtilities.dp(124.0f) + (-frameLayout.getTop())) - (AndroidUtilities.dp(126.67f) / 2.0f);
    }
    ...
    public final void onDetachedFromWindow() {
        ...
        j5VarArr[0].b();
        j5VarArr[1].b();
        AndroidUtilities.cancelRunOnUIThread(this.f12222f0);
    }
    ...
    public void setPreviewAttributes(f1 f1Var) {
        c5.d dVar = this.R;
        if (dVar != null && dVar.f2083b == 1 && isAttachedToWindow()) {
            AndroidUtilities.cancelRunOnUIThread(this.f12222f0);
            ValueAnimator valueAnimator = this.f12220e0;
            if (valueAnimator != null) {
                valueAnimator.cancel();
                this.f12220e0 = null;
            }
            int i10 = 1 - this.f12231o0;
            this.f12231o0 = i10;
            org.telegram.ui.Components.p9[] p9VarArr = this.d;
            gj0 lottieAnimation = p9VarArr[2 - i10].getImageReceiver().getLottieAnimation();
            gj0 lottieAnimation2 = p9VarArr[this.f12231o0 + 1].getImageReceiver().getLottieAnimation();
            if (lottieAnimation2 != null && lottieAnimation != null) {
                lottieAnimation2.Q(lottieAnimation.r(), false);
            }
            int i11 = this.f12231o0 + 1;
            ...
            g(1, f1Var.f12394b, true);
            int i12 = this.f12231o0 + 1;
            TL_stars.starGiftAttributeModel stargiftattributemodel = f1Var.f12395c;
            TL_stars.starGiftAttributeModel[] stargiftattributemodelArr = this.e;
            stargiftattributemodelArr[i12] = stargiftattributemodel;
            ja.Z0(p9VarArr[i12].getImageReceiver(), stargiftattributemodelArr[this.f12231o0 + 1].document, 160);
            a();
            float f10 = this.f12231o0;
            ValueAnimator ofFloat = ValueAnimator.ofFloat(1.0f - f10, f10);
            this.f12220e0 = ofFloat;
            ofFloat.addUpdateListener(new y4(this, 0));
            this.f12220e0.addListener(new a5(this, 3));
            this.f12220e0.setDuration(320L);
            this.f12220e0.setInterpolator(nr.h);
            this.f12220e0.start();
        }
    }
    ...
    public void setPreviewingAttributes(ArrayList<TL_stars.StarGiftAttribute> arrayList) {
        ...
        this.f12244y[1].setTextSize(1, 14.0f);
        ...
        stargiftattributemodelArr[2] = (TL_stars.starGiftAttributeModel) this.T.f2864f;
        ja.Z0(p9VarArr[2].getImageReceiver(), stargiftattributemodelArr[2].document, 160);
        b bVar = this.f12222f0;
    ...
    public void setResellPrice(mf.a aVar) {
        ...
        if (!k10) {
            ...
            nr nrVar = nr.h;
            duration.setInterpolator(nrVar).setListener(new a5(this, 0)).start();
            e90VarArr[0].animate().alpha(0.0f).setDuration(420L).setInterpolator(nrVar).start();
        } else {
            ViewPropertyAnimator duration2 = textView.animate().scaleX(0.4f).scaleY(0.4f).alpha(0.0f).setDuration(420L);
            nr nrVar2 = nr.h;
            duration2.setInterpolator(nrVar2).setListener(new a5(this, 2)).setListener(new a5(this, 1)).start();
            e90VarArr[0].animate().alpha(1.0f).setDuration(420L).setInterpolator(nrVar2).start();
        }
        boolean z10 = this.J;
        ah.d[] dVarArr = this.F;
        if (z10) {
    ...
    public void setWearPreview(TLObject tLObject) {
        ...
        this.f12234r[2].setText(str2);
        this.f12244y[2].setText(str);
        k();
        d(this.R);
    }
