...
public abstract class x3 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public n2 O;
    public ViewGroup P;
    public final org.telegram.ui.ActionBar.p2 f13100a;
    public final int f13101b;
    public final long f13102c;
    public final l7 d;
    public final j7 f13103e;
    public final g6 f13104f;
    public final q2 h;
    public final k81 f13105n;
    public final FrameLayout f13106r;
    public final SpannableStringBuilder f13107s;
    public final SpannableStringBuilder v;
    public final qh.d f13108w;
    public int f13109x;
    public final LinearLayout f13110y;
    ...
    public final void a() {
        ...
        if (currentPage != null && (l7Var = currentPage.f12865e) != null && currentPage.d) {
            int i10 = l7Var.d;
            new s3(this.f13100a, this.f13102c, i10, new eg.h3(this, i10, currentPage, 1)).show();
        }
    }

    public final boolean b() {
        j7 j7Var = this.f13103e;
        if (!j7Var.h() || j7Var.d().size() >= MessagesController.getInstance(this.f13101b).config.stargiftsCollectionsLimit.get()) {
            return false;
        }
        return true;
    }
    ...
    public final boolean d() {
        if (this.f13102c >= 0 || this.d.h == null) {
            return false;
        }
        return true;
    }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        LinearLayout linearLayout = this.f13110y;
        qh.d dVar = this.f13108w;
        long j10 = this.f13102c;
        int i15 = 8;
        if (i10 == i14) {
    ...
    public final void e() {
        ...
        if (this.J > 0) {
            ...
            if (i10 >= 0 && tL_starGiftCollection != null) {
                this.J = 0;
                this.f13105n.d(tL_starGiftCollection.collection_id, i10 + 1);
            }
        }
    }
    ...
    public final void f(boolean z4) {
        q2 q2Var = this.h;
        if (q2Var != null && this.f13105n != null) {
            q2Var.o(z4);
            e();
        }
    }
    ...
    public final boolean g() {
        ...
        n3 currentPage = getCurrentPage();
        if (currentPage != null && currentPage.f12867n) {
            return true;
        }
        return false;
    }
    ...
    public int getBottomOffset() {
        FrameLayout frameLayout = this.f13106r;
        float translationY = frameLayout.getTranslationY() - org.telegram.messenger.y3.B(this.f13109x, Math.max(AndroidUtilities.dp(240.0f), this.N) + (-frameLayout.getTop()), 1);
        if (this.N < AndroidUtilities.dp(240.0f)) {
            translationY += Math.min(AndroidUtilities.dp(240.0f) - this.N, AndroidUtilities.dp(this.f13109x));
        }
        return (int) (AndroidUtilities.dp(this.f13109x) - translationY);
    }

    public l7 getCurrentList() {
        n3 currentPage = getCurrentPage();
        if (currentPage != null) {
            return currentPage.f12865e;
        }
        return this.d;
    }
    ...
    public int getGiftsCount() {
        ...
        n3 currentPage = getCurrentPage();
        l7 l7Var2 = this.d;
        if (currentPage != null && (l7Var = currentPage.f12865e) != l7Var2) {
            if (l7Var != null && (i11 = l7Var.f14409n) > 0) {
                return i11;
            }
        } else if (l7Var2 != null && (i10 = l7Var2.f14409n) > 0) {
            return i10;
        }
        int i12 = this.f13101b;
        long j10 = this.f13102c;
        if (j10 >= 0) {
    ...
    public long getLastEmojisHash() {
        long j10 = 0;
        l7 l7Var = this.d;
        if (l7Var != null && !l7Var.f14407l.isEmpty()) {
            HashSet hashSet = new HashSet();
            int i10 = 0;
            for (int i11 = 0; i10 < 3 && i11 < l7Var.f14407l.size(); i11++) {
                TLRPC.Document document = ((TL_stars.SavedStarGift) l7Var.f14407l.get(i11)).gift.getDocument();
                if (document != null) {
                    hashSet.add(Long.valueOf(document.f20851id));
                    j10 = Objects.hash(Long.valueOf(j10), Long.valueOf(document.f20851id));
                    i10++;
                }
            }
        }
    ...
    public final void h(String str, Utilities.Callback callback) {
        ...
        g6 g6Var = this.f13104f;
        AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(context, 0, g6Var);
        if (str != null) {
            alertDialog$Builder.f21168a.O = LocaleController.getString(R.string.Gift2EditCollectionNameTitle);
        } else {
            alertDialog$Builder.f21168a.O = LocaleController.getString(R.string.Gift2NewCollectionTitle);
            alertDialog$Builder.f21168a.Q = LocaleController.getString(R.string.Gift2NewCollectionText);
        }
        u2 u2Var = new u2(this, context, g6Var);
        u2Var.lineYFix = true;
        u2Var.setOnEditorActionListener(new v2(u2Var, callback, d2VarArr, view));
        MediaDataController.getInstance(this.f13101b).fetchNewEmojiKeywords(AndroidUtilities.getCurrentKeyboardLanguage(), true);
        u2Var.setTextSize(1, 18.0f);
        u2Var.setTextColor(k6.v0(k6.f21768j5, g6Var));
        ...
        u2Var.setLineColors(k6.v0(k6.f21787k6, g6Var), k6.v0(k6.f21805l6, g6Var), k6.v0(k6.f21878p7, g6Var));
        ...
        alertDialog$Builder.f21168a.f21237a = AndroidUtilities.dp(292.0f);
        if (str != null) {
            i10 = R.string.Edit;
        } else {
            i10 = R.string.Create;
        ...
        q70 q70Var = this.F;
        if (q70Var != null && (l70Var = q70Var.f30323m) != null) {
            l70Var.setSoftInputMode(48);
        }
        AndroidUtilities.requestAdjustNothing(findActivity, this.f13100a.getClassGuid());
    ...
    public final void l() {
        ...
        if (q2Var != null) {
            ...
            FrameLayout frameLayout = this.f13106r;
            float B = nextPositionAlpha + org.telegram.messenger.y3.B(this.f13109x, (-frameLayout.getTop()) + this.N, 1);
            int i10 = 0;
            ...
            if (this.f13103e.h() && q2Var.getPositionAnimated() >= 0.5f) {
                spannableStringBuilder = this.v;
            } else {
                spannableStringBuilder = this.f13107s;
            }
            this.f13108w.g(spannableStringBuilder, true, true);
            ic icVar = ic.f27770w;
    ...
    public final void m() {
        ...
        if (viewPages != null) {
            for (View view : viewPages) {
                if (view != null) {
                    n3 n3Var = (n3) view;
                    g6 g6Var2 = n3Var.f12864c;
                    if (n3Var.f12869s != null) {
                        n3Var.f12870w.setTextColor(k6.v0(k6.G6, g6Var2));
                        TextView textView = n3Var.f12871x;
                        int i11 = k6.Oh;
                        textView.setTextColor(k6.v0(i11, g6Var2));
                        n3Var.f12871x.setBackground(k6.Y(k6.l1(0.1f, k6.v0(i11, g6Var2)), 4, 4));
                    } else {
                        n3Var.C.setTextColor(k6.v0(k6.G6, g6Var2));
                        n3Var.D.setTextColor(k6.v0(k6.f22038y6, g6Var2));
                        n3Var.E.j();
                    }
                }
            }
        }
        this.B.setTextColor(k6.v0(k6.f21768j5, g6Var));
        this.f13110y.setBackground(k6.Y(k6.v0(k6.f21752i6, g6Var), 24, 24));
    }

    public final void n() {
        boolean z4;
        View[] viewPages;
        if (this.f13103e.d().isEmpty() && !b()) {
            z4 = false;
        } else {
            z4 = true;
        }
