...
public final class w9 extends FrameLayout {
    public final org.telegram.ui.ActionBar.f6 f13306a;
    public final Drawable f13307b;
    public final Drawable f13308c;
    public final TextView d;
    public final org.telegram.ui.Components.k6 e;
    public SpannableString f13309f;
    public boolean h;
    public int f13310n;
    public final org.telegram.ui.Components.z5 f13311r;

    public w9(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context);
        int i10;
        this.f13311r = new org.telegram.ui.Components.z5(this, 0L, 500L, nr.h);
        this.f13306a = f6Var;
        Drawable mutate = context.getResources().getDrawable(R.drawable.star_small_outline).mutate();
        this.f13307b = mutate;
        mutate.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19977h5, f6Var), PorterDuff.Mode.SRC_IN));
        this.f13308c = context.getResources().getDrawable(R.drawable.star_small_inner).mutate();
    ...
    public final void onDraw(Canvas canvas) {
        ...
        int i10;
        super.onDraw(canvas);
        float d = this.f13311r.d(this.f13310n, false);
        if (LocaleController.isRTL) {
            f10 = -1.0f;
        } else {
            f10 = 1.0f;
        ...
        for (int ceil = ((int) Math.ceil(d)) - 1; ceil >= 0; ceil--) {
            ...
            Drawable drawable2 = this.f13308c;
            drawable2.setBounds(i11, i12, i13, i14);
            drawable2.setAlpha(i15);
            drawable2.draw(canvas);
        }
        if (this.h) {
            org.telegram.ui.ActionBar.f6 f6Var = this.f13306a;
            if (f6Var != null) {
