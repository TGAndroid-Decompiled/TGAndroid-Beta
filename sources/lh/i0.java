...
public final class i0 implements Utilities.Callback2 {
    ...
    public i0(int i10, org.telegram.ui.ActionBar.p2 p2Var, ze.c cVar, org.telegram.ui.ActionBar.d2 d2Var) {
        this.f12556a = 0;
        this.f12557b = i10;
        this.f12558c = p2Var;
        this.d = cVar;
    ...
    public final void run(Object obj, Object obj2) {
        ...
        switch (this.f12556a) {
            case 0:
                org.telegram.ui.ActionBar.p2 p2Var = (org.telegram.ui.ActionBar.p2) this.f12558c;
                ...
                if (updates != null && tL_error == null) {
                    MessagesController.getInstance(this.f12557b).processUpdates(updates, false);
                }
                AndroidUtilities.runOnUIThread(new androidx.car.app.utils.c(p2Var, tL_error, cVar, d2Var, 6));
                return;
            case 1:
                org.telegram.ui.g1 g1Var = (org.telegram.ui.g1) this.f12558c;
                ...
                if (!z10) {
                    MessagesController.getInstance(i10).generateJoinMessage(chat.f19159id, true);
                }
                ...
                return;
            case 2:
                org.telegram.ui.Components.f0.Z((org.telegram.ui.Components.f0) this.f12558c, (org.telegram.ui.ActionBar.k5) this.d, this.f12557b, (TLRPC.TL_messages_composeMessageWithAI) this.e, (TLRPC.TL_composedMessageWithAI) obj, (TLRPC.TL_error) obj2);
                return;
            case 3:
                org.telegram.ui.Components.f0.V((org.telegram.ui.Components.f0) this.f12558c, (org.telegram.ui.ActionBar.k5) this.d, this.f12557b, (TLRPC.TL_messages_composeRichMessageWithAI) this.e, (TLRPC.TL_composedRichMessageWithAI) obj, (TLRPC.TL_error) obj2);
                return;
            case 4:
                boolean[] zArr = (boolean[]) this.f12558c;
                ...
                if (!zArr[0]) {
                    if (str != null) {
                        arrayList.set(this.f12557b, str);
            ...
            case 5:
                ...
                ((ph.d) this.f12558c).setLoading(false);
                if (!"CANCELLED".equalsIgnoreCase(str2)) {
                    if ("EMPTY".equalsIgnoreCase(str2)) {
                        ...
                        alertDialog$Builder.f19478a.setOnDismissListener(new org.telegram.ui.x5(g3Var, 10));
                    ...
                    if (U != null) {
                        if (str2 != null) {
                            ...
                            if (U instanceof PasskeysActivity) {
                                ...
                                ConnectionsManager.getInstance(i13).sendRequestTyped(new TL_account.getPasskeys(), new Object(), new org.telegram.ui.r6(g3Var, passkey, str2, 3));
                                return;
                            }
                        } else {
                            return;
                    ...
                    if (!(webPage2 instanceof TLRPC.TL_webPageEmpty)) {
                        if (messageMedia instanceof TLRPC.TL_messageMediaWebPage) {
                            if (webPage2 instanceof TLRPC.TL_webPagePending) {
                                long j11 = webPage2.f19312id;
                                int i14 = this.f12557b;
            ...
            default:
                ...
                org.telegram.ui.ActionBar.p2 p2Var2 = (org.telegram.ui.ActionBar.p2) this.f12558c;
                ...
                if (tL_error4 != null) {
                    ...
                    if (arrayList3.isEmpty()) {
                        ...
                        p2Var2.showDialog(new sh.i0(p2Var2, 0L, arrayList3, new dg.j3(p2Var2, chat2, this.f12557b, 5)));
                        return;
                    } else {
