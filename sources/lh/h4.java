...
public final class h4 extends View {
    public final t4 f12543a;
    public final ImageReceiver f12544b;
    public final Path f12545c;
    ...
    public final void onAttachedToWindow() {
        ...
        this.f12544b.onAttachedToWindow();
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        this.f12544b.onDetachedFromWindow();
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        canvas.drawPath(this.f12545c, this.d);
        canvas.restore();
        ImageReceiver imageReceiver = this.f12544b;
