...
public final class h4 extends View {
    public final t4 f12527a;
    public final ImageReceiver f12528b;
    public final Path f12529c;
    ...
    public final void onAttachedToWindow() {
        ...
        this.f12528b.onAttachedToWindow();
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        this.f12528b.onDetachedFromWindow();
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        canvas.drawPath(this.f12529c, this.d);
        canvas.restore();
        ImageReceiver imageReceiver = this.f12528b;
