...
public final class g8 extends FrameLayout {
    public final Paint f15644a;
    public final Paint f15645b;
    ...
    public g8(Context context, org.telegram.ui.ActionBar.c6 c6Var) {
        ...
        this.f15645b = paint2;
        paint.setColor(org.telegram.ui.ActionBar.g6.v0(org.telegram.ui.ActionBar.g6.f23295q7, c6Var));
        paint2.setColor(-1);
        setWillNotDraw(false);
        TextView textView = new TextView(context);
        this.f15646c = textView;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        canvas.drawCircle(dp, height, AndroidUtilities.dp(10.0f), this.f15644a);
    ...
    public void set(TLRPC.TL_error tL_error) {
        TextView textView = this.f15646c;
    ...
    public void setOnClickListener(View.OnClickListener onClickListener) {
        this.f15647e.setOnClickListener(onClickListener);
    }
}
