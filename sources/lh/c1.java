...
public final class c1 extends c5 {
    public final j1 A0;
    public final float[] f12185x0;
    public final Path f12186y0;
    public final float[] f12187z0;
    ...
    public c1(j1 j1Var, Context context, org.telegram.ui.ActionBar.f6 f6Var, a1 a1Var, dg.m mVar, dg.m mVar2, dg.m mVar3, dg.m mVar4, dg.m mVar5, dg.m mVar6) {
        ...
        this.A0 = j1Var;
        this.f12185x0 = new float[3];
        this.f12186y0 = new Path();
        this.f12187z0 = new float[8];
    }
    ...
    public final void j(int i10) {
        ...
        for (dg.v3 v3Var : j1Var.W) {
            ...
            if (k6Var.getSizeableBackground() instanceof s4) {
                ((s4) k6Var.getSizeableBackground()).f13051b.setColor(HSVToColor);
                k6Var.invalidate();
    ...
    public final void onSizeChanged(int i10, int i11, int i12, int i13) {
        ...
        float[] fArr = this.f12187z0;
        fArr[3] = dp;
        fArr[2] = dp;
        fArr[1] = dp;
        fArr[0] = dp;
        Path path = this.f12186y0;
        path.rewind();
        path.addRoundRect(0.0f, 0.0f, i10, i11, this.f12187z0, Path.Direction.CW);
    }
}
