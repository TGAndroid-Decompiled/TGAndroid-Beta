...
public final class d4 extends FrameLayout {
    public final kh.u1 f12296a;
    public final FrameLayout f12297b;
    public final org.telegram.ui.Components.p9 f12298c;
    public final TextView d;
    public final FrameLayout e;
    public final ImageView f12299f;
    ...
    public final void a(TL_stars.StarGift starGift, boolean z4) {
        ...
        if (starGift != null) {
            ...
            ja.Z0(this.f12298c.getImageReceiver(), ((TL_stars.starGiftAttributeModel) t7.l(starGift.attributes, TL_stars.starGiftAttributeModel.class)).document, 52);
    ...
    public final void b(final boolean z4, boolean z10) {
        ...
        int i11;
        float f15;
        FrameLayout frameLayout = this.f12297b;
        ...
        animate2.alpha(f12).setInterpolator(nrVar).setDuration(420L).withEndAction(new Runnable(this) {
            public final d4 f12211b;
        ...
        animate3.alpha(f17).setInterpolator(nrVar).setDuration(420L).withEndAction(new Runnable(this) {
            public final d4 f12211b;
