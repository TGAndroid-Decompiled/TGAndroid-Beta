...
public final class d4 extends FrameLayout {
    public final kh.u1 f12280a;
    public final FrameLayout f12281b;
    public final org.telegram.ui.Components.p9 f12282c;
    ...
    public final void a(TL_stars.StarGift starGift, boolean z4) {
        ...
        if (starGift != null) {
            ...
            ja.Z0(this.f12282c.getImageReceiver(), ((TL_stars.starGiftAttributeModel) t7.l(starGift.attributes, TL_stars.starGiftAttributeModel.class)).document, 52);
    ...
    public final void b(final boolean z4, boolean z10) {
        ...
        int i11;
        float f15;
        FrameLayout frameLayout = this.f12281b;
        ...
        animate2.alpha(f12).setInterpolator(mrVar).setDuration(420L).withEndAction(new Runnable(this) {
            public final d4 f12195b;
        ...
        animate3.alpha(f17).setInterpolator(mrVar).setDuration(420L).withEndAction(new Runnable(this) {
            public final d4 f12195b;
