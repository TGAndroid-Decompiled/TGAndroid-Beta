...
public final class w6 implements Runnable {
    ...
    public final MessagesStorage f13280b;
    ...
    public final void run() {
        switch (this.f13279a) {
            case 0:
                ...
                long j10 = this.e;
                SQLiteDatabase database = this.f13280b.getDatabase();
                    ...
                    try {
                        ...
                        if (arrayList != null) {
                            ...
                            for (int i11 = 0; i11 < arrayList.size(); i11++) {
                                ...
                                sQLitePreparedStatement.bindLong(1, starGift.f19384id);
            ...
            case 1:
                this.f13280b.lambda$loadPendingTasks$27(this.f13281c, this.d, this.e);
                return;
            default:
                this.f13280b.lambda$loadPendingTasks$28(this.f13281c, this.d, this.e);
                return;
        }
    }
