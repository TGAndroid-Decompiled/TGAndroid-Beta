    ...
    public final void onAnimationEnd(Animator animator) {
        ...
        switch (this.f12685a) {
            case 0:
                ...
                g5Var.s2();
                g5Var.W0 = null;
                Runnable runnable = (Runnable) this.f12687c;
                if (runnable != null) {
                    runnable.run();
                    return;
                }
            ...
            case 1:
                li liVar = (li) this.d;
                liVar.f26744v0.setAlpha(0.0f);
                liVar.f26744v0.setTranslationY(AndroidUtilities.dp(78.0f) + this.f12686b);
                yh yhVar = liVar.f26681b0;
                ...
                o1.j jVar = new o1.j(liVar.f26748w0, o1.h.f16162n, 0.0f);
                jVar.f16178u.a(0.75f);
                jVar.f16178u.b(500.0f);
                jVar.b(new org.telegram.ui.Components.f7(this, 3));
                jVar.a(new lb(2, this, (wg) this.f12687c));
                liVar.f26728q1 = jVar;
                jVar.f();
                return;
            default:
                b4.e0 e0Var = (b4.e0) this.d;
                ((rl0) e0Var.d).scrollBy(0, this.f12686b - ((int[]) this.f12687c)[0]);
                e0Var.f1379c = null;
                return;
        }
    }
