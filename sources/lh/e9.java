...
public final class e9 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final org.telegram.ui.ActionBar.g3[] f12353b;

    public e9(boolean[] zArr, org.telegram.ui.ActionBar.g3[] g3VarArr) {
        this.f12352a = zArr;
        this.f12353b = g3VarArr;
    }

    @Override
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        org.telegram.ui.ActionBar.g3 g3Var;
        if (i10 == NotificationCenter.starSubscriptionsLoaded && this.f12352a[0] && (g3Var = this.f12353b[0]) != null) {
            g3Var.dismiss();
        }
    }
}
