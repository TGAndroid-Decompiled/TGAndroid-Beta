...
public final class ja extends l20 implements NotificationCenter.NotificationCenterDelegate {
    public static DecimalFormat f12683e0;
    public static DecimalFormat f12684f0;
    ...
    public hb1 Y;
    public ph.d Z;
    public ph.d f12685a0;
    public boolean f12686b0;
    public boolean f12687c0;
    public k9 f12688d0;
    ...
    public static void F0(sz0 sz0Var, int i10, TL_stars.StarGift starGift, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        if (!starGift.sold_out) {
            ...
            final long j10 = starGift.f19409id;
            ...
            final NotificationCenter.NotificationCenterDelegate[] notificationCenterDelegateArr = {new NotificationCenter.NotificationCenterDelegate() {
                ...
                public final void didReceivedNotification(int i11, int i12, Object[] objArr) {
                    ...
                    if (!zArr2[0] && i11 == (i13 = NotificationCenter.starGiftsLoaded) && (J = (t7Var = t7.this).J(j10)) != null) {
                        zArr2[0] = true;
                        NotificationCenter.getInstance(t7Var.f13149a).removeObserver(notificationCenterDelegateArr[0], i13);
                        h0Var.run(J);
                    }
                }
            }};
    ...
    public static SpannableStringBuilder J0(TL_stars.StarsAmount starsAmount, float f10, char c3) {
        ...
        int i10;
        if (f12684f0 == null) {
            f12684f0 = new DecimalFormat("0.################", new DecimalFormatSymbols(Locale.US));
        }
        ...
        if (starsAmount instanceof TL_stars.TL_starsTonAmount) {
            ...
            if (j10 % 1000000000 != 0) {
                String format = f12684f0.format(j10 / 1.0E9d);
            ...
            if (i11 != 0) {
                ...
                DecimalFormat decimalFormat = f12684f0;
    ...
    public static SpannableStringBuilder K0(TL_stars.StarsAmount starsAmount, float f10, char c3) {
        ...
        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder();
        if (starsAmount instanceof TL_stars.TL_starsTonAmount) {
            String format = f12684f0.format(starsAmount.amount / 1.0E9d);
            spannableStringBuilder.append((CharSequence) format);
            int indexOf = format.indexOf(".");
            if (indexOf >= 0) {
                spannableStringBuilder.setSpan(new RelativeSizeSpan(f10), indexOf, spannableStringBuilder.length(), 33);
    ...
    public static String M0(long j10) {
        String str;
        if (f12683e0 == null) {
            f12683e0 = new DecimalFormat("0.####", new DecimalFormatSymbols(Locale.US));
        }
        if (j10 % 1000000000 != 0) {
            return f12683e0.format(j10 / 1.0E9d);
        }
        StringBuilder sb = new StringBuilder();
        if (j10 < 0) {
            str = "-";
    ...
    public static void Z0(ImageReceiver imageReceiver, TLRPC.Document document, int i10) {
        ...
        imageReceiver.setImage(ImageLocation.getForDocument(document), e2.c.h(i10, "_", i10), ImageLocation.getForDocument(closestPhotoSizeWithSize, document), e2.c.h(i10, "_", i10), DocumentObject.getSvgThumb(document.thumbs, org.telegram.ui.ActionBar.j6.f19852a7, 0.35f), 0L, null, null, 0);
    }
    ...
    public static void e1(Context context, int i10, long j10, TL_stories.Boost boost, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        sb.append(LocaleController.formatPluralStringSpaced("BoostingBoostsCount", i11));
    ...
    public static w0 f1(Context context, int i10, TL_stars.TL_starGiftUnique tL_starGiftUnique, Utilities.Callback2 callback2, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        if (tL_starGiftUnique == null) {
            ...
            resellAmount = tL_starGiftUnique.getResellAmount(mf.b.f13931b);
        } else {
    ...
    public static void g1(Context context, long j10, boolean z4, final Utilities.Callback2 callback2, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        editTextBoldCursor.setOnFocusChangeListener(new n8(ad0Var, editTextBoldCursor, 0));
    ...
    public static void i1(Activity activity, int i10, int i11, TLRPC.TL_messageActionPaymentRefunded tL_messageActionPaymentRefunded, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        starsTransaction.f19411id = tL_messageActionPaymentRefunded.charge.f19312id;
    ...
    public static void j1(Context context, int i10, TLRPC.TL_payments_paymentReceiptStars tL_payments_paymentReceiptStars, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        starsTransaction.f19411id = tL_payments_paymentReceiptStars.transaction_id;
    ...
    public final View createView(final Context context) {
        ...
        this.f35881c.setOverScrollMode(2);
        f2.l lVar = new f2.l();
        lVar.f5818m = false;
        lVar.C = false;
        lVar.o(nr.h);
        ...
        this.f35881c.setOnItemClickListener(new dg.n(this, 7));
        r00 r00Var = new r00(getParentActivity());
        this.Q = r00Var;
        this.f35885s.addView(r00Var, k7.b6.c(-1.0f, -1));
        t7 y10 = t7.y(this.currentAccount, false);
        ...
        gj0 gj0Var = new gj0(i10, AndroidUtilities.dp(42.0f), "s" + R.raw.star_reaction, AndroidUtilities.dp(42.0f));
        ImageReceiver imageReceiver = p70Var.f37201b;
        ...
        this.U.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20298z6, this.resourceProvider));
        ...
        this.X.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view) {
                switch (r3) {
                    case 0:
                        ja.B0(this.f12510b, context);
                        return;
                    default:
                        new aa(context, this.f12510b.resourceProvider).show();
                        return;
                }
            }
        });
        ...
        this.f12685a0.g(spannableStringBuilder3, false, true);
        this.f12685a0.setOnClickListener(new View.OnClickListener(this) {
            public final ja f12560b;
        ...
        this.R.addView(this.f12685a0, k7.b6.d(-1, 48.0f, 17, 20.0f, 8.0f, 20.0f, 0.0f));
        k1();
        k9 k9Var = this.f12688d0;
        if (k9Var != null) {
            k9Var.N(false);
        }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.starOptionsLoaded) {
            ...
            t7 y10 = t7.y(this.currentAccount, false);
            if (this.f12686b0 != y10.O(0)) {
                this.f12686b0 = y10.O(0);
                s0();
                k9 k9Var2 = this.f12688d0;
                if (k9Var2 != null) {
                    k9Var2.N(true);
                }
                if (this.K == 0 && this.L < 0) {
            ...
            animate.alpha(f11).withEndAction(new Runnable(this) {
                ...
                public final void run() {
                    switch (r3) {
                        case 0:
                            if (z4) {
                                this.f12620b.W.setVisibility(8);
                                return;
                            }
                            return;
                        default:
                            if (!z4) {
                                this.f12620b.Y.setVisibility(8);
                                return;
                            }
                            return;
                    }
    ...
    public final f2.o0 n0() {
        k9 k9Var = new k9(this, this.f35881c, getParentActivity(), this.currentAccount, this.classGuid, new dg.r1(this, 19), getResourceProvider());
        this.f12688d0 = k9Var;
        k9Var.f30240r = false;
        return k9Var;
    }
    ...
    public final boolean q0() {
        ...
        if (iaVar != null && (iaVar.getParent() instanceof View)) {
            if ((this.f35881c.getHeight() - this.f35881c.getPaddingBottom()) - ((View) this.O.getParent()).getBottom() >= 0) {
                z4 = true;
            }
        }
        return !z4;
