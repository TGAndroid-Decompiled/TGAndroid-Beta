...
public final class b0 {
    public static volatile b0[] f12113m = new b0[4];
    public static final Object[] f12114n = new Object[4];
    public final int f12115a;
    public final HashMap f12116b = new HashMap();
    public final HashMap f12117c = new HashMap();
    public final HashMap d = new HashMap();
    public final HashMap e = new HashMap();
    public final HashMap f12118f = new HashMap();
    public final HashMap f12119g = new HashMap();
    public final HashMap h = new HashMap();
    public boolean f12120i;
    public ArrayList f12121j;
    public boolean f12122k;
    public ArrayList f12123l;

    static {
        for (int i10 = 0; i10 < 4; i10++) {
            f12114n[i10] = new Object();
        }
    }
    ...
    public static b0 g(int i10) {
        b0 b0Var;
        b0 b0Var2 = f12113m[i10];
        if (b0Var2 == null) {
            synchronized (f12114n[i10]) {
                try {
                    b0Var = f12113m[i10];
                    if (b0Var == null) {
                        b0[] b0VarArr = f12113m;
    ...
    public final y d(long j10) {
        ...
        HashMap hashMap = this.f12119g;
        y yVar = (y) hashMap.get(valueOf);
        if (yVar == null) {
            Long valueOf2 = Long.valueOf(j10);
            y yVar2 = new y(this.f12115a, j10);
    ...
    public final z e(long j10) {
        ...
        if (zVar == null) {
            Long valueOf2 = Long.valueOf(j10);
            z zVar2 = new z(this.f12115a, j10);
    ...
    public final void f(Context context, long j10, long j11, Utilities.Callback callback) {
        y yVar = (y) this.f12119g.get(Long.valueOf(j10));
        if (yVar != null) {
    ...
    public final TLRPC.TL_payments_starsRevenueStats h(long j10, boolean z4) {
        Long l10 = (Long) this.f12116b.get(Long.valueOf(j10));
        TLRPC.TL_payments_starsRevenueStats tL_payments_starsRevenueStats = (TLRPC.TL_payments_starsRevenueStats) this.f12117c.get(Long.valueOf(j10));
    ...
    public final void l(long j10) {
        ...
        for (int i10 = 0; i10 < 3; i10++) {
            if (!zArr[i10]) {
                k10.f12069a[i10].clear();
                k10.f12071c[i10] = null;
                zArr[i10] = false;
                k10.e[i10] = false;
                p(i10, j10);
            }
    ...
    public final void n() {
        if (!this.f12120i && this.f12121j == null) {
            this.f12120i = true;
            ConnectionsManager.getInstance(this.f12115a).sendRequest(new TL_bots.getAdminedBots(), new s(this, 0));
        }
    }

    public final void o() {
        if (!this.f12122k && this.f12123l == null) {
            this.f12122k = true;
            ConnectionsManager.getInstance(this.f12115a).sendRequest(new TLRPC.TL_channels_getAdminedPublicChannels(), new s(this, 1));
        }
    }
    ...
    public final void q(TL_update.TL_updateStarsRevenueStatus tL_updateStarsRevenueStatus) {
        ...
        if (peerDialogId < 0) {
            me meVar = me.f36035u1;
            if (meVar != null && meVar.f36059w0 == DialogObject.getPeerDialogId(tL_updateStarsRevenueStatus.peer)) {
                me meVar2 = me.f36035u1;
        ...
        if (h != null) {
            ...
            NotificationCenter.getInstance(this.f12115a).lambda$postNotificationNameOnUIThread$1(NotificationCenter.botStarsUpdated, Long.valueOf(peerDialogId));
        }
        l(peerDialogId);
    }
