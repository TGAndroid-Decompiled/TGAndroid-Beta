...
public final class y0 implements Utilities.Callback {
    ...
    public final void run(Object obj) {
        ...
        Object obj2 = this.f13117e;
        Object obj3 = this.d;
        Object obj4 = this.f13116c;
        switch (i10) {
            case 0:
                r1 r1Var = (r1) obj3;
                af.f fVar = (af.f) obj;
                ...
                return;
            case 1:
                ((FactCheckController) obj4).lambda$loadMissing$3(this.f13115b, (ArrayList) obj3, (HashMap) obj2, (ArrayList) obj);
                return;
            case 2:
                ((MessagesController) obj4).lambda$checkSensitive$448(this.f13115b, (boolean[]) obj3, (Runnable) obj2, (Boolean) obj);
                return;
            case 3:
                ((TranslateController) obj4).lambda$checkTranslation$6((MessageObject) obj3, (String) obj2, this.f13115b, (TLRPC.TL_textWithEntities) obj);
                return;
            case 4:
                px pxVar = (px) obj4;
            ...
            default:
                ...
                try {
                    ...
                    AndroidUtilities.runOnUIThread(new g1(photoViewer, photoEntry, this.f13115b, str, createBitmap, 14));
                    return;
                } catch (Exception e6) {
                    FileLog.e(e6);
