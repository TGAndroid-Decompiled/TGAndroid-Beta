...
public final class e5 extends org.telegram.ui.Components.ma {
    ...
    public e5(Context context, long j10, ArrayList arrayList, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        while (i12 < arrayList.size()) {
            ...
            if (currentTime > starGiftUpgradePrice.date && ((i10 = i12 + 1) >= arrayList.size() || currentTime > ((TL_stars.StarGiftUpgradePrice) arrayList.get(i10)).date)) {
                ...
                sz0Var.c(LocaleController.getInstance().getFormatterDay().format(date) + ", " + LocaleController.getInstance().getFormatterDayMonth().format(date), ja.X0(false, kf.k0.l((int) starGiftUpgradePrice.upgrade_stars, ',', new StringBuilder("⭐️ ")), 0.8f, null), null, null);
                z4 = true;
            }
            i12++;
            f12 = f10;
        ...
        if (!z4) {
            ...
            while (i13 < size) {
                ...
                sz0Var.c(LocaleController.getInstance().getFormatterDay().format(date2) + ", " + LocaleController.getInstance().getFormatterDayMonth().format(date2), ja.X0(false, kf.k0.l((int) starGiftUpgradePrice2.upgrade_stars, ',', new StringBuilder("⭐️ ")), 0.8f, null), null, null);
            }
        }
        float f14 = f13 + 14.0f;
    ...
    public final void P(long j10) {
        ...
        if (arrayList != null && !arrayList.isEmpty()) {
            ...
            limitPreviewView.f23064a = AndroidUtilities.ilerp((float) j10, (float) starGiftUpgradePrice.upgrade_stars, (float) starGiftUpgradePrice2.upgrade_stars);
            ...
            limitPreviewView.f23079w.setVisibility(8);
