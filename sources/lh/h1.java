...
public final class h1 extends FrameLayout implements xd.b {
    public final org.telegram.ui.ActionBar.f6 f12512a;
    public final FrameLayout f12513b;
    public final kh.u1 f12514c;
    public final org.telegram.ui.Components.p9 d;
    public final TextView e;
    public final TextView f12515f;
    public Integer h;
    public TLRPC.Document f12516n;
    public final xd.a f12517r;
    public boolean f12518s;
    public f1 v;

    public h1(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context);
        this.f12517r = new xd.a(0, this, mr.h, 320L, false);
        this.f12512a = f6Var;
        FrameLayout frameLayout = new FrameLayout(context);
        this.f12513b = frameLayout;
    ...
    public static void a(h1 h1Var, TLRPC.Document document, int i10, Object obj, boolean z4) {
        ...
        if (document == null) {
            p9Var.b();
            h1Var.f12516n = null;
        } else if (h1Var.f12516n == document) {
        } else {
            h1Var.f12516n = document;
            TLRPC.PhotoSize closestPhotoSizeWithSize = FileLoader.getClosestPhotoSizeWithSize(document.thumbs, AndroidUtilities.dp(100.0f));
            SvgHelper.SvgDrawable svgThumb = DocumentObject.getSvgThumb(document, org.telegram.ui.ActionBar.j6.f19827a7, 0.3f);
    ...
    public final void b() {
        int d;
        kh.u1 u1Var = this.f12514c;
        u1Var.f10971x = null;
        Integer num = this.h;
        xd.a aVar = this.f12517r;
        TextView textView = this.f12515f;
        if (num != null) {
            d = org.telegram.ui.ActionBar.j6.v(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19881d6, false), org.telegram.ui.ActionBar.j6.l1(AndroidUtilities.lerp(0.15f, 1.0f, aVar.e), this.h.intValue()));
            u1Var.f10971x = this.h;
            this.f12513b.invalidate();
            textView.setTextColor(i0.a.d(aVar.e, this.h.intValue(), -1));
        } else if (this.f12518s) {
            ...
            d = i0.a.d(0.5f, i0.a.k(this.v.f12377a.center_color, 255), i0.a.k(this.v.f12377a.pattern_color, 255));
            textView.setTextColor(-1);
        }
