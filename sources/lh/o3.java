...
public final class o3 extends l81 {
    ...
    public final void E(View view, float f10) {
        ...
        if (view instanceof FrameLayout) {
            ...
            if (frameLayout.getChildCount() > 0) {
                ...
                m3Var = g5Var.Y;
                if (m3Var != null && view2 == m3Var.V && (q3Var3 = m3Var.f12466a0) != null) {
                    q3Var3.invalidate();
                }
                if (view2 == g5Var.V && (q3Var2 = g5Var.f12466a0) != null) {
                    q3Var2.invalidate();
                }
                m3Var2 = g5Var.Z;
                if (m3Var2 == null && view2 == m3Var2.V && (q3Var = m3Var2.f12466a0) != null) {
                    q3Var.invalidate();
                    return;
                }
                return;
    ...
    public final void F() {
        ...
        if (i10 != g5Var.L1(false)) {
            if (this.f26593b > g5Var.L1(false)) {
                z4 = true;
            }
