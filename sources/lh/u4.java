...
public final class u4 extends View {
    ...
    public o4 v;
    public o4 f13206w;
    public float f13207x;
    public float f13208y;
        ...
        if (o4Var != null) {
            ...
            if (paint != null) {
                ...
                for (int i10 = 0; i10 < iArr.length; i10++) {
                    ...
                    iArr[i10] = org.telegram.ui.ActionBar.j6.v(iArr[i10], org.telegram.ui.ActionBar.j6.l1(clamp01 * f15, o4Var.f12875g));
                }
                for (int i11 = 0; i11 < iArr2.length; i11++) {
                    ...
                    iArr2[i11] = org.telegram.ui.ActionBar.j6.v(iArr2[i11], org.telegram.ui.ActionBar.j6.l1(clamp01 * f14, o4Var.f12874f));
                }
    ...
    public final void c() {
        boolean z4;
        if (this.f13199a == null && this.f13200b == null && this.f13201c == null && this.f13205s == null && this.v == null && this.f13206w == null) {
            z4 = false;
        } else {
            z4 = true;
        }
    ...
    public final void dispatchDraw(Canvas canvas) {
        b(canvas, this.f13199a, this.d, this.h);
        b(canvas, this.f13200b, this.e, this.f13203n);
        b(canvas, this.f13201c, this.f13202f, this.f13204r);
    }
}
