...
public final class ba extends h51 {
    ...
    public final void bindView(View view, i51 i51Var, boolean z4, w51 w51Var, g61 g61Var) {
        ...
        org.telegram.ui.Components.p9 p9Var = caVar.f12248c;
        org.telegram.ui.ActionBar.f6 f6Var = caVar.f12247b;
        TextView textView = caVar.h;
        TextView textView2 = caVar.f12249f;
        TextView textView3 = caVar.e;
        int i12 = caVar.f12246a;
        TextView textView4 = caVar.f12250n;
        long peerDialogId = DialogObject.getPeerDialogId(starsSubscription.peer);
        caVar.f12251r = !TextUtils.isEmpty(starsSubscription.title);
        if (peerDialogId < 0) {
        ...
        if (!TextUtils.isEmpty(starsSubscription.title)) {
            ...
            if (starsSubscription.photo != null) {
                r70 r70Var = new r70(textView3, 14.0f, i12);
                r70Var.a(4.0f);
                ...
                r70Var.f37725b.setImage(ImageLocation.getForWebFile(WebFile.createWithWebDocument(starsSubscription.photo)), "14_14", null, null, 0, 0);
        ...
        if (!starsSubscription.canceled && !starsSubscription.bot_canceled) {
            ...
            if (j10 < currentTime) {
                ...
                textView4.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20273z6, f6Var));
        ...
        if (i51Var2 != null) {
            ...
            if (obj instanceof TL_stars.StarsSubscription) {
                ...
                if (obj2 instanceof TL_stars.StarsSubscription) {
                    return TextUtils.equals(((TL_stars.StarsSubscription) obj).f19385id, ((TL_stars.StarsSubscription) obj2).f19385id);
                }
                return false;
            }
            return false;
