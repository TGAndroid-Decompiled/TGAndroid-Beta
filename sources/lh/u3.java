...
public final class u3 extends FrameLayout {
    public final org.telegram.ui.Components.p9 f13195a;
    public final a4 f13196b;
    public final org.telegram.ui.Components.k6 f13197c;
    ...
    public u3(Context context) {
        ...
        a4Var.f12101a.setStrokeWidth(AndroidUtilities.dp(3.0f));
    ...
    public final void a(TL_stars.starGiftAttributeBackdrop stargiftattributebackdrop) {
        ...
        this.e = null;
        org.telegram.ui.Components.p9 p9Var = this.f13195a;
    ...
    public final void c(float f10, boolean z4) {
        this.f13198f = f10;
        a4 a4Var = this.f13196b;
        a4Var.d = f10;
        if (!z4) {
            a4Var.f12102b.d(f10, true);
        }
        a4Var.invalidate();
        this.f13197c.c(Math.round(f10 * 100.0f) + "%", z4, true);
    }
}
