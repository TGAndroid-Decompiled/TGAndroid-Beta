...
public final class b1 implements RequestDelegate {
    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        Object obj2 = this.f12603e;
        Object obj3 = this.d;
        Object obj4 = this.f12601b;
        switch (i10) {
            case 0:
            ...
            case 5:
                ...
                return;
            case 6:
                AndroidUtilities.runOnUIThread(new hg.j0((Object) ((oh.f4) obj4), (Object) ((Runnable) obj), tL_error, (TLObject) ((TL_stories.StoryItem) obj3), (Object) ((b8) obj2), 14));
                return;
            case 7:
                mb mbVar = (mb) obj4;
                ...
                sb sbVar = mbVar.f39069a.f39702n;
                if (tL_error == null) {
                    ...
                    for (int i11 = 0; i11 < tL_messages_exportedChatInvite.users.size(); i11++) {
                        ...
                        sbVar.A0.put(Long.valueOf(user.f20990id), user);
                    }
                } else {
            ...
            case 9:
                ...
                return;
            case 10:
                yx0.p((xr0) obj4, this.f12602c, (TLRPC.TL_messages_getAttachedStickers) obj3, (lo) obj2, tLObject, tL_error);
                return;
            case 11:
            ...
            case 17:
                ...
                if (tL_error != null && FileRefController.isFileRefError(tL_error.text) && storyItem != null) {
                    FileRefController.getInstance(s6Var.f46041a).requestReference(storyItem, tL_messages_getAttachedStickers, aVar);
                    return;
                } else {
