...
public final class u6 implements Runnable {
    ...
    public final void run() {
        ...
        switch (this.f13198a) {
            case 0:
                ...
                m5Var.mo27run(arrayList, Integer.valueOf(i10), Long.valueOf(j11), (ArrayList) this.f13201f, (ArrayList) this.h);
                return;
            case 1:
                ((TopicsController) this.d).lambda$loadTopics$5((TLRPC.TL_messages_forumTopics) this.e, this.f13199b, (TLRPC.TL_messages_forumTopics) this.f13201f, (a0.h) this.h, this.f13200c);
                return;
            case 2:
                org.telegram.ui.Cells.e6.a((org.telegram.ui.Cells.e6) this.d, (TLObject) this.f13201f, (MessagesStorage) this.h, this.f13199b, this.f13200c, (ArrayList) this.e);
                return;
            case 3:
                TLObject tLObject = (TLObject) this.d;
                int i11 = this.f13200c;
                ph.d dVar = (ph.d) this.e;
                org.telegram.ui.ActionBar.g3 g3Var = (org.telegram.ui.ActionBar.g3) this.f13201f;
                long j12 = this.f13199b;
            ...
            case 4:
                ...
                TLObject tLObject2 = (TLObject) this.f13201f;
                long j13 = this.f13199b;
                final int i13 = this.f13200c;
                ...
                if (tL_error2 == null && (tLObject2 instanceof Vector)) {
                    ...
                    if (arrayList2.isEmpty()) {
                        for (int i16 = 0; i16 < arrayList4.size(); i16++) {
                            ...
                            yh0Var.f40276a.add((Long) pair.first);
                            yh0Var.f40277b.add((Integer) pair.second);
                            yh0Var.f40278c.add((TLObject) hashMap.get(pair.first));
                        }
                        yh0Var.b();
                        return;
                        ...
                        tL_channels_getParticipants.channel = MessagesController.getInstance(i13).getInputChannel(chat.f19159id);
                                                        ...
                                                        if (tLObject4 != null) {
                                                            ...
                                                            while (true) {
                                                                ...
                                                                if (i19 < size3) {
                                                                    ...
                                                                    hashMap3.put(Long.valueOf(user.f19306id), user);
                                                                    i19++;
                                                                } else {
                                                                    while (true) {
                                                                        ...
                                                                        if (i18 < arrayList6.size()) {
                                                                            ...
                                                                            yh0Var3.f40276a.add((Long) pair2.first);
                                                                            yh0Var3.f40277b.add((Integer) pair2.second);
                                                                            yh0Var3.f40278c.add((TLObject) hashMap3.get(pair2.first));
                                                                            i18++;
                                                                        }
                                                                    }
                                                                }
                                                        ...
                                                        if (tLObject5 != null) {
                                                            ...
                                                            while (true) {
                                                                ...
                                                                if (i21 < size4) {
                                                                    ...
                                                                    hashMap4.put(Long.valueOf(user2.f19306id), user2);
                                                                    i21++;
                                                                } else {
                                                                    while (true) {
                                                                        ...
                                                                        if (i20 < arrayList7.size()) {
                                                                            ...
                                                                            yh0Var4.f40276a.add((Long) pair3.first);
                                                                            yh0Var4.f40277b.add((Integer) pair3.second);
                                                                            yh0Var4.f40278c.add((TLObject) hashMap4.get(pair3.first));
                                                                            i20++;
                                                                        }
                                                                    }
                                                                }
                                                        ...
                                                        if (tLObject4 != null) {
                                                            ...
                                                            while (true) {
                                                                ...
                                                                if (i19 < size3) {
                                                                    ...
                                                                    hashMap32.put(Long.valueOf(user.f19306id), user);
                                                                    i19++;
                                                                } else {
                                                                    while (true) {
                                                                        ...
                                                                        if (i182 < arrayList62.size()) {
                                                                            ...
                                                                            yh0Var32.f40276a.add((Long) pair2.first);
                                                                            yh0Var32.f40277b.add((Integer) pair2.second);
                                                                            yh0Var32.f40278c.add((TLObject) hashMap32.get(pair2.first));
                                                                            i182++;
                                                                        }
                                                                    }
                                                                }
                        ...
                        tL_messages_getFullChat.chat_id = chat.f19159id;
                ...
                return;
            default:
                int i17 = this.f13200c;
                Context context = (Context) this.d;
                long j16 = this.f13199b;
                TL_payments.connectedBotStarRef connectedbotstarref = (TL_payments.connectedBotStarRef) this.e;
                b0.g(i17).f(context, j16, connectedbotstarref.bot_id, new ze1(i17, j16, context, connectedbotstarref, (org.telegram.ui.ActionBar.g3) this.f13201f, (org.telegram.ui.ActionBar.f6) this.h));
                return;
        }
    }
    ...
    public u6(TopicsController topicsController, TLRPC.TL_messages_forumTopics tL_messages_forumTopics, long j10, TLRPC.TL_messages_forumTopics tL_messages_forumTopics2, a0.h hVar, int i10) {
        ...
        this.f13199b = j10;
        this.f13201f = tL_messages_forumTopics2;
        this.h = hVar;
        this.f13200c = i10;
    }
    ...
    public u6(org.telegram.ui.Cells.e6 e6Var, TLObject tLObject, MessagesStorage messagesStorage, long j10, int i10, ArrayList arrayList) {
        this.d = e6Var;
        this.f13201f = tLObject;
    ...
    public u6(yh0 yh0Var, TLRPC.TL_error tL_error, TLObject tLObject, long j10, int i10, TLRPC.Chat chat) {
        this.d = yh0Var;
        this.e = tL_error;
        this.f13201f = tLObject;
        this.f13199b = j10;
