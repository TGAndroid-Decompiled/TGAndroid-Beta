...
public final class c extends ViewGroup implements me.a, NotificationCenter.NotificationCenterDelegate, le.d {
    ...
    public final le.b f14302a;
    public final le.b f14303b;
    public final me.b f14304c;
    public final ImageReceiver d;
    public final Paint e;
    public final Paint f14305f;
    public final org.telegram.ui.Components.voip.h h;
    public final ImageReceiver f14306n;
    public p5 f14307r;
    public o0 f14308s;
    public final o v;
    public i0 f14309w;
    public boolean f14310x;
    public final g0 f14311y;

    public c(Context context) {
        super(context);
        qr qrVar = qr.h;
        this.f14302a = new le.b(0, this, qrVar, 320L, false);
        this.f14303b = new le.b(1, this, qrVar, 320L, false);
        this.f14304c = new me.b(this);
        ...
        this.f14306n = new ImageReceiver(this);
    ...
    public final void D(int i10, float f7, float f10, le.e eVar) {
        this.f14305f.setAlpha(Math.round(this.f14303b.e * 100.0f));
        int round = Math.round(this.f14302a.e * 220.0f);
    ...
    public final int a(float f7, float f10) {
        ...
        if (!((RectF) this.f14309w.f3022c).contains(f7, f10)) {
            return -1;
        }
        return 0;
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (i0Var != null) {
            ...
            if (Build.VERSION.SDK_INT >= 29 && this.E != null && canvas.isHardwareAccelerated()) {
                ...
                canvas.save();
                canvas.clipPath((Path) this.f14309w.d);
            ...
            Paint paint = this.f14305f;
            if (paint.getAlpha() > 0) {
                canvas.drawPath((Path) this.f14309w.d, paint);
            }
            if (this.f14302a.e > 0.0f) {
                RectF rectF = this.K;
                rectF.set((RectF) this.f14309w.f3022c);
            ...
            this.d.draw(canvas);
            this.f14306n.draw(canvas);
            p5 p5Var = this.f14307r;
            if (p5Var != null) {
                p5Var.draw(canvas);
            }
        }
    ...
    public final void onAttachedToWindow() {
        ...
        this.f14306n.onAttachedToWindow();
        p5 p5Var = this.f14307r;
        if (p5Var != null) {
            p5Var.a(this);
        }
        ...
        if (groupCallMessage != null) {
            groupCallMessage.subscribeToStateUpdates(this.f14311y);
        }
    }
    ...
    public final void onDetachedFromWindow() {
        ...
        this.f14306n.onDetachedFromWindow();
        p5 p5Var = this.f14307r;
        if (p5Var != null) {
            p5Var.o(this);
        }
        ...
        GroupCallMessage groupCallMessage = this.H;
        if (groupCallMessage != null) {
            groupCallMessage.unsubscribeFromStateUpdates(this.f14311y);
        }
    }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        int round2 = Math.round(((PointF) this.f14309w.f3024g).y);
        o oVar = this.v;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        i0 i0Var = this.f14309w;
        if (i0Var == null || this.f14310x || i0Var.f3020a != size) {
            int paddingLeft = getPaddingLeft();
            int paddingRight = getPaddingRight();
            o0 o0Var = this.f14308s;
            ...
            this.f14306n.setImageCoords((RectF) this.f14309w.f3023f);
            if (this.f14307r != null) {
                Rect rect = L;
                ((RectF) this.f14309w.f3023f).round(rect);
                this.f14307r.setBounds(rect);
            }
        }
        setMeasuredDimension(size, this.f14309w.f3021b);
        this.h.f29368f = Math.round(((RectF) this.f14309w.f3022c).width() + AndroidUtilities.dp(48.0f));
    }

    @Override
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        return this.f14304c.a(motionEvent, this);
    }
    ...
    public void set(GroupCallMessage groupCallMessage) {
        ...
        if (groupCallMessage4 != null) {
            this.f14302a.a(groupCallMessage4.isSendDelayed(), false);
            this.f14303b.a(this.H.isSendError(), false);
        }
        ...
        ImageReceiver imageReceiver = this.f14306n;
        imageReceiver.setImage(null, null, null, null, null, 0);
        if (this.f14307r != null && isAttachedToWindow()) {
            this.f14307r.o(this);
        }
        this.f14307r = null;
        ...
        if (o0Var == null) {
            ...
            TLRPC.TL_availableReaction tL_availableReaction = MediaDataController.getInstance(groupCallMessage.currentAccount).getReactionsMap().get(groupCallMessage.visibleReaction.f49423f);
            ...
            p5 p5Var = new p5(0, groupCallMessage.currentAccount, groupCallMessage.visibleReaction.f49424g);
            this.f14307r = p5Var;
        ...
        this.f14308s = groupCallMessage.visibleReaction;
        this.f14310x = true;
