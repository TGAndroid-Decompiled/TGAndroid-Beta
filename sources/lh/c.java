...
public final class c extends ViewGroup implements me.a, NotificationCenter.NotificationCenterDelegate, le.d {
    ...
    public c(Context context) {
        ...
        hVar.f28944c.setStrokeWidth(AndroidUtilities.dp(1.0f));
    ...
    public final void D(int i10, float f7, float f10, le.e eVar) {
        ...
        hVar.f28942a.setAlpha(round);
        hVar.f28944c.setAlpha(round);
        invalidate();
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.h.f28945f = Math.round(((RectF) this.f14127w.f3022c).width() + AndroidUtilities.dp(48.0f));
    }
    ...
    public void set(GroupCallMessage groupCallMessage) {
        ...
        if (p0Var == null) {
            ...
            TLRPC.TL_availableReaction tL_availableReaction = MediaDataController.getInstance(groupCallMessage.currentAccount).getReactionsMap().get(groupCallMessage.visibleReaction.f49155f);
            ...
            o5 o5Var = new o5(0, groupCallMessage.currentAccount, groupCallMessage.visibleReaction.f49156g);
            this.f14125r = o5Var;
