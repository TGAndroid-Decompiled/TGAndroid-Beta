...
public final class c7 implements Runnable {
    ...
    public final TLObject f12255b;
    public final Utilities.Callback f12256c;

    public c7(TLObject tLObject, Utilities.Callback callback, int i10) {
        this.f12254a = i10;
        this.f12255b = tLObject;
        this.f12256c = callback;
    }
    ...
    public final void run() {
        ...
        switch (this.f12254a) {
            case 0:
                TLObject tLObject = this.f12255b;
                boolean z10 = tLObject instanceof TL_account.paidMessagesRevenue;
                Utilities.Callback callback = this.f12256c;
                if (z10) {
            ...
            default:
                TLObject tLObject2 = this.f12255b;
                if (tLObject2 instanceof TLRPC.TL_messages_stickerSet) {
                    ...
                    if (!MediaDataController.getInstance(UserConfig.selectedAccount).isStickerPackInstalled(tL_messages_stickerSet.set.f19211id)) {
                ...
                this.f12256c.run(Boolean.valueOf(z4));
                return;
        }
    }
}
