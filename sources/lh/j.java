...
public final class j implements DialogInterface.OnShowListener {
    ...
    public final EditTextBoldCursor f12816b;

    public j(int i10, EditTextBoldCursor editTextBoldCursor) {
        this.f12815a = i10;
        this.f12816b = editTextBoldCursor;
    }
    ...
    public final void onShow(DialogInterface dialogInterface) {
        switch (this.f12815a) {
            case 0:
                eh.b bVar = (eh.b) this.f12816b;
                bVar.requestFocus();
                AndroidUtilities.showKeyboard(bVar);
                return;
            case 1:
                u2 u2Var = (u2) this.f12816b;
                u2Var.requestFocus();
                AndroidUtilities.showKeyboard(u2Var);
                return;
            case 2:
                vf.n nVar = (vf.n) this.f12816b;
                nVar.requestFocus();
                AndroidUtilities.showKeyboard(nVar);
                return;
            default:
                EditTextBoldCursor editTextBoldCursor = this.f12816b;
