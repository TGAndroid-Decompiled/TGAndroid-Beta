...
public final class x8 implements Runnable {
    ...
    public x8(int i10, TLObject tLObject, TL_stars.StarsSubscription starsSubscription, ph.d dVar, boolean z4, boolean z10, org.telegram.ui.ActionBar.g3[] g3VarArr) {
        this.e = dVar;
        this.f13344f = g3VarArr;
        this.d = i10;
        this.f13342b = z4;
        this.h = starsSubscription;
        this.f13343c = z10;
        this.f13345n = tLObject;
    }
    ...
    public final void run() {
        ...
        switch (i10) {
            case 0:
                ...
                if (U != null) {
                    if (this.f13342b && !TextUtils.isEmpty(starsSubscription.title)) {
                    ...
                    } else if (this.f13343c && !TextUtils.isEmpty(starsSubscription.title)) {
                ...
                return;
            default:
                ((SendMessagesHelper) obj4).lambda$performSendMessageRequest$95(this.f13342b, (TLRPC.Message) obj3, (ArrayList) obj2, this.f13343c, (ArrayList) obj, this.d);
                return;
        }
    }
    ...
    public x8(SendMessagesHelper sendMessagesHelper, boolean z4, TLRPC.Message message, ArrayList arrayList, boolean z10, ArrayList arrayList2, int i10) {
        ...
        this.f13342b = z4;
        this.f13344f = message;
        this.h = arrayList;
        this.f13343c = z10;
        this.f13345n = arrayList2;
        this.d = i10;
    }
}
