...
public final class t6 implements Utilities.Callback {
    public final int f13145a = 0;
    public final t7 f13146b;
    public final boolean[] f13147c;
    public final int d;
    public final Utilities.Callback e;
    public final Utilities.Callback f13148f;
    ...
    public final void run(Object obj) {
        ...
        switch (this.f13145a) {
            case 0:
                ...
                this.f13147c[0] = true;
                Utilities.Callback callback2 = this.f13148f;
                if (callback2 != null) {
            ...
            default:
                ...
                Utilities.Callback callback4 = this.f13148f;
                if (callback4 != null) {
