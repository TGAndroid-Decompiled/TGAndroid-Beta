...
public final class i1 extends bh.c implements xd.b {
    ...
    public i1(Context context, org.telegram.ui.ActionBar.f6 f6Var, cg.h0 h0Var) {
        ...
        this.e.setColor(l1);
        this.f12577n = new bh.b[]{bh.b.b(context, f6Var, bh.a.D, R.string.GiftPreviewModels), bh.b.b(context, f6Var, bh.a.v, R.string.GiftPreviewBackdrops), bh.b.b(context, f6Var, bh.a.G, R.string.GiftPreviewSymbols)};
        int i11 = 0;
        while (true) {
            bh.b[] bVarArr = this.f12577n;
            if (i11 < bVarArr.length) {
                this.f1831a.addView(bVarArr[i11], k7.b6.l(1.0f, 0, -1));
                this.f12577n[i11].setOnClickListener(new y0(this, i11, 1));
                i11++;
            } else {
    ...
    public final void b() {
        ...
        int dp = AndroidUtilities.dp(this.f1832b * 7.0f);
        Rect rect2 = this.d;
        rect2.set(rect);
        int i10 = -dp;
        rect2.inset(i10, i10);
