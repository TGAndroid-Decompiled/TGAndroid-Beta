...
public final class s3 extends sa implements NotificationCenter.NotificationCenterDelegate {
    ...
    public s3(org.telegram.ui.ActionBar.p2 p2Var, long j10, int i10, eg.h3 h3Var) {
        ...
        frameLayout.setBackgroundColor(k6.v0(k6.f21733h5, this.resourcesProvider));
        ...
        view.setBackgroundColor(k6.v0(k6.f21662d7, this.resourcesProvider));
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        w51 w51Var;
        if (i10 == NotificationCenter.starUserGiftsLoaded && (w51Var = this.f12964a0) != null) {
            w51Var.N(true);
            if (S()) {
                this.V.a();
            }
