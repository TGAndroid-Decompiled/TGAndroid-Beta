    ...
    public final void onClick(View view) {
        ...
        switch (i10) {
            ...
            case 3:
                ...
                return;
            case 4:
                f4 f4Var2 = this.f13049b;
                LinearLayout linearLayout = f4Var2.D;
                d4[] d4VarArr = f4Var2.f12402n;
                if (f4Var2.getAlpha() >= 1.0f && !f4Var2.f12395e0) {
                    if (f4Var2.f12398g0) {
                    ...
                    if (!arrayList.isEmpty() && f4Var2.f12391b0 != null) {
                        TextView textView = f4Var2.H;
                        f4Var2.f12395e0 = true;
                        f4Var2.f12398g0 = false;
                        ...
                        f4Var2.f12391b0.run(arrayList2, new dh.v(3, f4Var2, arrayList2), new b(f4Var2, 6));
                        return;
                    }
            ...
            default:
                ...
                if (starGift8 != null && !d4Var7.f12284n) {
                    d4Var7.a(null, true);
                    f4Var.d(true);
                    return;
                }
                ...
                f4Var.f12393c0.run(new kh.a1(6, f4Var, d4Var7), Boolean.valueOf(z4));
                return;
        }
    }
}
