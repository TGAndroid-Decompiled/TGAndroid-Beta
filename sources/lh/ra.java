...
public final class ra extends View {
    public final LinearGradient f13043a;
    public final Matrix f13044b;
    public final Paint f13045c;
    public final Paint d;
    public final k01 e;
    public final org.telegram.ui.ActionBar.f6 f13046f;

    public ra(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context);
        this.f13046f = f6Var;
        this.f13043a = new LinearGradient(0.0f, 0.0f, 255.0f, 0.0f, new int[]{-1135603, -404714}, new float[]{0.0f, 1.0f}, Shader.TileMode.CLAMP);
        this.f13044b = new Matrix();
    ...
    public final void dispatchDraw(Canvas canvas) {
        Matrix matrix = this.f13044b;
        matrix.reset();
        matrix.postTranslate(AndroidUtilities.dp(14.0f), 0.0f);
        matrix.postScale((getWidth() - AndroidUtilities.dp(28.0f)) / 255.0f, 1.0f);
        LinearGradient linearGradient = this.f13043a;
        linearGradient.setLocalMatrix(matrix);
        Paint paint = this.f13045c;
        paint.setShader(linearGradient);
        k01 k01Var = this.e;
        float dp = k01Var.f26084c + AndroidUtilities.dp(30.0f);
        int v02 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19907d7, this.f13046f);
        Paint paint2 = this.d;
        paint2.setColor(v02);
        ...
        this.e.c((getWidth() - k01Var.f26084c) / 2.0f, getHeight() / 2.0f, 1.0f, -1, canvas);
    }
}
