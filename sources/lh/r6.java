...
public final class r6 implements Runnable {
    ...
    public final t7 f13013b;
    public final TLObject f13014c;

    public r6(t7 t7Var, TLObject tLObject, int i10) {
        this.f13012a = i10;
        this.f13013b = t7Var;
        this.f13014c = tLObject;
    }
    ...
    public final void run() {
        ...
        switch (this.f13012a) {
            case 0:
                t7 t7Var = this.f13013b;
                int i10 = t7Var.f13133a;
                t7Var.A = false;
                TLObject tLObject = this.f13014c;
                if (tLObject instanceof TL_stars.StarsStatus) {
                    ...
                    t7Var.f13154z.addAll(starsStatus.subscriptions);
                ...
                return;
            case 1:
                t7 t7Var2 = this.f13013b;
                int i11 = t7Var2.f13133a;
                t7Var2.f13152x = false;
                TLObject tLObject2 = this.f13014c;
                if (tLObject2 instanceof TL_stars.StarsStatus) {
                    ...
                    t7Var2.f13153y = z4;
                    t7Var2.f13151w = starsStatus2.subscriptions_next_offset;
            ...
            case 2:
                ...
                TLObject tLObject3 = this.f13014c;
                boolean z10 = tLObject3 instanceof Vector;
                final t7 t7Var3 = this.f13013b;
                if (z10) {
                ...
                t7Var3.f13139j = arrayList;
                t7Var3.h = false;
                NotificationCenter.getInstance(t7Var3.f13133a).lambda$postNotificationNameOnUIThread$1(NotificationCenter.starOptionsLoaded, new Object[0]);
                                ...
                                case 0:
                                    ...
                                    while (true) {
                                        ...
                                        if (i13 < arrayList5.size()) {
                                            b6.h hVar = new b6.h();
                                            hVar.f1610c = "inapp";
                                            hVar.f1609b = ((TL_stars.TL_starsTopupOption) arrayList5.get(i13)).store_product;
                                                                ...
                                                                public final void run() {
                                                                    ...
                                                                    switch (r5) {
                                                                        case 0:
                                                                            p2.h hVar3 = hVar2;
                                                                            if (hVar3.f41015a != 0) {
                                                                                t7.e("BILLING_" + BillingController.getResponseCodeString(hVar3.f41015a));
                                                                                return;
                                                                            }
                                                                            List list2 = list;
                                                                            if (list2 != null) {
                                                                                for (int i14 = 0; i14 < list2.size(); i14++) {
                                                                                    ...
                                                                                    while (true) {
                                                                                        ...
                                                                                        if (i15 < arrayList7.size()) {
                                                                                            if (((TL_stars.TL_starsGiftOption) arrayList7.get(i15)).store_product.equals(nVar.f41031c)) {
                                                                                    ...
                                                                                    if (tL_starsGiftOption != null && (a2 = nVar.a()) != null) {
                                                                                        tL_starsGiftOption.currency = a2.f41020c;
                                                                                        tL_starsGiftOption.amount = (long) (Math.pow(10.0d, BillingController.getInstance().getCurrencyExp(tL_starsGiftOption.currency)) * (a2.f41019b / Math.pow(10.0d, 6.0d)));
                                                                                        tL_starsGiftOption.loadingStorePrice = false;
                                                                                    }
                                                                                }
                                                                            }
                                                                            t7 t7Var6 = t7Var5;
                                                                            if (t7Var6.f13142m != null) {
                                                                                for (int i16 = 0; i16 < t7Var6.f13142m.size(); i16++) {
                                                                                    TL_stars.TL_starsGiftOption tL_starsGiftOption2 = (TL_stars.TL_starsGiftOption) t7Var6.f13142m.get(i16);
                                                                                    if (tL_starsGiftOption2 != null && tL_starsGiftOption2.loadingStorePrice) {
                                                                                        tL_starsGiftOption2.missingStorePrice = true;
                                                                                    }
                                                                                }
                                                                            }
                                                                            NotificationCenter.getInstance(t7Var6.f13133a).lambda$postNotificationNameOnUIThread$1(NotificationCenter.starGiftOptionsLoaded, new Object[0]);
                                                                            return;
                                                                        case 1:
                                                                            p2.h hVar4 = hVar2;
                                                                            if (hVar4.f41015a != 0) {
                                                                                t7.e("BILLING_" + BillingController.getResponseCodeString(hVar4.f41015a));
                                                                                return;
                                                                            }
                                                                            List list3 = list;
                                                                            if (list3 != null) {
                                                                                for (int i17 = 0; i17 < list3.size(); i17++) {
                                                                                    ...
                                                                                    while (true) {
                                                                                        ...
                                                                                        if (i18 < arrayList8.size()) {
                                                                                            if (((TL_stars.TL_starsGiveawayOption) arrayList8.get(i18)).store_product.equals(nVar2.f41031c)) {
                                                                                    ...
                                                                                    if (tL_starsGiveawayOption != null && (a10 = nVar2.a()) != null) {
                                                                                        tL_starsGiveawayOption.currency = a10.f41020c;
                                                                                        tL_starsGiveawayOption.amount = (long) (Math.pow(10.0d, BillingController.getInstance().getCurrencyExp(tL_starsGiveawayOption.currency)) * (a10.f41019b / Math.pow(10.0d, 6.0d)));
                                                                                        tL_starsGiveawayOption.loadingStorePrice = false;
                                                                                    }
                                                                                }
                                                                            }
                                                                            t7 t7Var7 = t7Var5;
                                                                            if (t7Var7.f13145p != null) {
                                                                                for (int i19 = 0; i19 < t7Var7.f13145p.size(); i19++) {
                                                                                    TL_stars.TL_starsGiveawayOption tL_starsGiveawayOption2 = (TL_stars.TL_starsGiveawayOption) t7Var7.f13145p.get(i19);
                                                                                    if (tL_starsGiveawayOption2 != null && tL_starsGiveawayOption2.loadingStorePrice) {
                                                                                        tL_starsGiveawayOption2.missingStorePrice = true;
                                                                                    }
                                                                                }
                                                                            }
                                                                            NotificationCenter.getInstance(t7Var7.f13133a).lambda$postNotificationNameOnUIThread$1(NotificationCenter.starGiveawayOptionsLoaded, new Object[0]);
                                                                            return;
                                                                        default:
                                                                            p2.h hVar5 = hVar2;
                                                                            if (hVar5.f41015a != 0) {
                                                                                t7.e("BILLING_" + BillingController.getResponseCodeString(hVar5.f41015a));
                                                                                return;
                                                                            }
                                                                            List list4 = list;
                                                                            if (list4 != null) {
                                                                                for (int i20 = 0; i20 < list4.size(); i20++) {
                                                                                    ...
                                                                                    while (true) {
                                                                                        ...
                                                                                        if (i21 < arrayList9.size()) {
                                                                                            if (((TL_stars.TL_starsTopupOption) arrayList9.get(i21)).store_product.equals(nVar3.f41031c)) {
                                                                                    ...
                                                                                    if (tL_starsTopupOption2 != null && (a11 = nVar3.a()) != null) {
                                                                                        tL_starsTopupOption2.currency = a11.f41020c;
                                                                                        tL_starsTopupOption2.amount = (long) (Math.pow(10.0d, BillingController.getInstance().getCurrencyExp(tL_starsTopupOption2.currency)) * (a11.f41019b / Math.pow(10.0d, 6.0d)));
                                                                                        tL_starsTopupOption2.loadingStorePrice = false;
                                                                                    }
                                                                                }
                                                                            }
                                                                            t7 t7Var8 = t7Var5;
                                                                            if (t7Var8.f13139j != null) {
                                                                                for (int i22 = 0; i22 < t7Var8.f13139j.size(); i22++) {
                                                                                    TL_stars.TL_starsTopupOption tL_starsTopupOption3 = (TL_stars.TL_starsTopupOption) t7Var8.f13139j.get(i22);
                                                                                    if (tL_starsTopupOption3 != null && tL_starsTopupOption3.loadingStorePrice) {
                                                                                        tL_starsTopupOption3.missingStorePrice = true;
                                                                                    }
                                                                                }
                                                                            }
                                                                            NotificationCenter.getInstance(t7Var8.f13133a).lambda$postNotificationNameOnUIThread$1(NotificationCenter.starOptionsLoaded, new Object[0]);
                                                                            return;
                                                                    }
                                                                }
                                                            });
                                                                ...
                                                                public final void run() {
                                                                    ...
                                                                    switch (r5) {
                                                                        case 0:
                                                                                ...
                                                                                for (int i14 = 0; i14 < list2.size(); i14++) {
                                                                                    ...
                                                                                    while (true) {
                                                                                        ...
                                                                                        if (i15 < arrayList72.size()) {
                                                                                            if (((TL_stars.TL_starsGiftOption) arrayList72.get(i15)).store_product.equals(nVar.f41031c)) {
                                                                            ...
                                                                            t7 t7Var62 = t7Var6;
                                                                            if (t7Var62.f13142m != null) {
                                                                                for (int i16 = 0; i16 < t7Var62.f13142m.size(); i16++) {
                                                                                    TL_stars.TL_starsGiftOption tL_starsGiftOption2 = (TL_stars.TL_starsGiftOption) t7Var62.f13142m.get(i16);
                                                                                    if (tL_starsGiftOption2 != null && tL_starsGiftOption2.loadingStorePrice) {
                                                                                        tL_starsGiftOption2.missingStorePrice = true;
                                                                                    }
                                                                                }
                                                                            }
                                                                            NotificationCenter.getInstance(t7Var62.f13133a).lambda$postNotificationNameOnUIThread$1(NotificationCenter.starGiftOptionsLoaded, new Object[0]);
                                                                            return;
                                                                        case 1:
                                                                            p2.h hVar4 = hVar2;
                                                                            if (hVar4.f41015a != 0) {
                                                                ...
                                                                public final void run() {
                                                                    ...
                                                                    switch (r5) {
                                                                        ...
                                                                        case 1:
                                                                                ...
                                                                                for (int i17 = 0; i17 < list3.size(); i17++) {
                                                                                    ...
                                                                                    while (true) {
                                                                                        ...
                                                                                        if (i18 < arrayList82.size()) {
                                                                                            if (((TL_stars.TL_starsGiveawayOption) arrayList82.get(i18)).store_product.equals(nVar2.f41031c)) {
                                                                            ...
                                                                            t7 t7Var72 = t7Var7;
                                                                            if (t7Var72.f13145p != null) {
                                                                                for (int i19 = 0; i19 < t7Var72.f13145p.size(); i19++) {
                                                                                    TL_stars.TL_starsGiveawayOption tL_starsGiveawayOption2 = (TL_stars.TL_starsGiveawayOption) t7Var72.f13145p.get(i19);
                                                                                    if (tL_starsGiveawayOption2 != null && tL_starsGiveawayOption2.loadingStorePrice) {
                                                                                        tL_starsGiveawayOption2.missingStorePrice = true;
                                                                                    }
                                                                                }
                                                                            }
                                                                            NotificationCenter.getInstance(t7Var72.f13133a).lambda$postNotificationNameOnUIThread$1(NotificationCenter.starGiveawayOptionsLoaded, new Object[0]);
                                                                            return;
                                                                        default:
                                                                            p2.h hVar5 = hVar2;
                                                                            if (hVar5.f41015a != 0) {
                                ...
                                case 1:
                                    ...
                                    while (true) {
                                        ...
                                        if (i14 < arrayList7.size()) {
                                            b6.h hVar2 = new b6.h();
                                            hVar2.f1610c = "inapp";
                                            hVar2.f1609b = ((TL_stars.TL_starsGiftOption) arrayList7.get(i14)).store_product;
                                                                                ...
                                                                                for (int i142 = 0; i142 < list2.size(); i142++) {
                                                                                    ...
                                                                                    while (true) {
                                                                                        ...
                                                                                        if (i15 < arrayList722.size()) {
                                                                                            if (((TL_stars.TL_starsGiftOption) arrayList722.get(i15)).store_product.equals(nVar.f41031c)) {
                                ...
                                default:
                                    ...
                                    while (true) {
                                        ...
                                        if (i15 < arrayList9.size()) {
                                            b6.h hVar3 = new b6.h();
                                            hVar3.f1610c = "inapp";
                                            hVar3.f1609b = ((TL_stars.TL_starsGiveawayOption) arrayList9.get(i15)).store_product;
                                                                ...
                                                                public final void run() {
                                                                    ...
                                                                    switch (r5) {
                                                                        case 0:
                                                                            p2.h hVar32 = hVar22;
                                                                            if (hVar32.f41015a != 0) {
                                                                                t7.e("BILLING_" + BillingController.getResponseCodeString(hVar32.f41015a));
                                                                                return;
                                                                            }
                                                                            List list2 = list;
                                                                            if (list2 != null) {
                                                                                for (int i142 = 0; i142 < list2.size(); i142++) {
                                                                                    ...
                                                                                    while (true) {
                                                                                        ...
                                                                                        if (i152 < arrayList722.size()) {
                                                                                            if (((TL_stars.TL_starsGiftOption) arrayList722.get(i152)).store_product.equals(nVar.f41031c)) {
                                                                                ...
                                                                                for (int i20 = 0; i20 < list4.size(); i20++) {
                                                                                    ...
                                                                                    while (true) {
                                                                                        ...
                                                                                        if (i21 < arrayList92.size()) {
                                                                                            if (((TL_stars.TL_starsTopupOption) arrayList92.get(i21)).store_product.equals(nVar3.f41031c)) {
                                                                ...
                                                                public final void run() {
                                                                    ...
                                                                    switch (r5) {
                                                                        case 0:
                                                                            ...
                                                                            t7 t7Var622 = t7Var62;
                                                                            if (t7Var622.f13142m != null) {
                                                                                for (int i16 = 0; i16 < t7Var622.f13142m.size(); i16++) {
                                                                                    TL_stars.TL_starsGiftOption tL_starsGiftOption2 = (TL_stars.TL_starsGiftOption) t7Var622.f13142m.get(i16);
                                                                                    if (tL_starsGiftOption2 != null && tL_starsGiftOption2.loadingStorePrice) {
                                                                                        tL_starsGiftOption2.missingStorePrice = true;
                                                                                    }
                                                                                }
                                                                            }
                                                                            NotificationCenter.getInstance(t7Var622.f13133a).lambda$postNotificationNameOnUIThread$1(NotificationCenter.starGiftOptionsLoaded, new Object[0]);
                                                                            return;
                                                                        case 1:
                                                                            p2.h hVar4 = hVar22;
                                                                            if (hVar4.f41015a != 0) {
                                                                                ...
                                                                                for (int i17 = 0; i17 < list3.size(); i17++) {
                                                                                    ...
                                                                                    while (true) {
                                                                                        ...
                                                                                        if (i18 < arrayList822.size()) {
                                                                                            if (((TL_stars.TL_starsGiveawayOption) arrayList822.get(i18)).store_product.equals(nVar2.f41031c)) {
            ...
            case 3:
                ...
                TLObject tLObject4 = this.f13014c;
                boolean z11 = tLObject4 instanceof Vector;
                final t7 t7Var4 = this.f13013b;
                if (z11) {
                ...
                t7Var4.f13142m = arrayList4;
                t7Var4.f13140k = false;
                NotificationCenter.getInstance(t7Var4.f13133a).lambda$postNotificationNameOnUIThread$1(NotificationCenter.starGiftOptionsLoaded, new Object[0]);
                                ...
                                case 0:
                                    ...
                                    while (true) {
                                        ...
                                        if (i132 < arrayList52.size()) {
                                            b6.h hVar = new b6.h();
                                            hVar.f1610c = "inapp";
                                            hVar.f1609b = ((TL_stars.TL_starsTopupOption) arrayList52.get(i132)).store_product;
                                                                ...
                                                                public final void run() {
                                                                    ...
                                                                    switch (r5) {
                                                                        case 0:
                                                                            ...
                                                                            if (list2 != null) {
                                                                                for (int i142 = 0; i142 < list2.size(); i142++) {
                                                                                    ...
                                                                                    if (tL_starsGiftOption2 != null && (a2 = nVar.a()) != null) {
                                                                                        tL_starsGiftOption2.currency = a2.f41020c;
                                                                                        tL_starsGiftOption2.amount = (long) (Math.pow(10.0d, BillingController.getInstance().getCurrencyExp(tL_starsGiftOption2.currency)) * (a2.f41019b / Math.pow(10.0d, 6.0d)));
                                                                            ...
                                                                            if (t7Var622.f13142m != null) {
                                                                                for (int i16 = 0; i16 < t7Var622.f13142m.size(); i16++) {
                                                                                    TL_stars.TL_starsGiftOption tL_starsGiftOption22 = (TL_stars.TL_starsGiftOption) t7Var622.f13142m.get(i16);
            ...
            case 4:
                ...
                TLObject tLObject5 = this.f13014c;
                boolean z12 = tLObject5 instanceof Vector;
                final t7 t7Var5 = this.f13013b;
                if (z12) {
                ...
                t7Var5.f13145p = arrayList7;
                t7Var5.f13143n = false;
                NotificationCenter.getInstance(t7Var5.f13133a).lambda$postNotificationNameOnUIThread$1(NotificationCenter.starGiveawayOptionsLoaded, new Object[0]);
                                                                ...
                                                                public final void run() {
                                                                    ...
                                                                    switch (r5) {
                                                                        ...
                                                                        case 1:
                                                                            ...
                                                                            if (list3 != null) {
                                                                                for (int i17 = 0; i17 < list3.size(); i17++) {
                                                                                    ...
                                                                                    if (tL_starsGiveawayOption2 != null && (a10 = nVar2.a()) != null) {
                                                                                        tL_starsGiveawayOption2.currency = a10.f41020c;
                                                                                        tL_starsGiveawayOption2.amount = (long) (Math.pow(10.0d, BillingController.getInstance().getCurrencyExp(tL_starsGiveawayOption2.currency)) * (a10.f41019b / Math.pow(10.0d, 6.0d)));
                                                                            ...
                                                                            if (t7Var72.f13145p != null) {
                                                                                for (int i19 = 0; i19 < t7Var72.f13145p.size(); i19++) {
                                                                                    TL_stars.TL_starsGiveawayOption tL_starsGiveawayOption22 = (TL_stars.TL_starsGiveawayOption) t7Var72.f13145p.get(i19);
                                ...
                                case 1:
                                    ...
                                    while (true) {
                                        ...
                                        if (i142 < arrayList72.size()) {
                                            b6.h hVar2 = new b6.h();
                                            hVar2.f1610c = "inapp";
                                            hVar2.f1609b = ((TL_stars.TL_starsGiftOption) arrayList72.get(i142)).store_product;
                                            arrayList62.add(hVar2.a());
                                            i142++;
                                        } else {
                                            BillingController billingController2 = BillingController.getInstance();
                                                                                ...
                                                                                for (int i1422 = 0; i1422 < list2.size(); i1422++) {
                                                                                    ...
                                                                                    while (true) {
                                                                                        ...
                                                                                        if (i152 < arrayList7222.size()) {
                                                                                            if (((TL_stars.TL_starsGiftOption) arrayList7222.get(i152)).store_product.equals(nVar.f41031c)) {
                                ...
                                default:
                                    ...
                                    while (true) {
                                        ...
                                        if (i15 < arrayList92.size()) {
                                            b6.h hVar3 = new b6.h();
                                            hVar3.f1610c = "inapp";
                                            hVar3.f1609b = ((TL_stars.TL_starsGiveawayOption) arrayList92.get(i15)).store_product;
                                                                                ...
                                                                                for (int i20 = 0; i20 < list4.size(); i20++) {
                                                                                    ...
                                                                                    while (true) {
                                                                                        ...
                                                                                        if (i21 < arrayList922.size()) {
                                                                                            if (((TL_stars.TL_starsTopupOption) arrayList922.get(i21)).store_product.equals(nVar3.f41031c)) {
                                                                                ...
                                                                                for (int i17 = 0; i17 < list3.size(); i17++) {
                                                                                    ...
                                                                                    while (true) {
                                                                                        ...
                                                                                        if (i18 < arrayList8222.size()) {
                                                                                            if (((TL_stars.TL_starsGiveawayOption) arrayList8222.get(i18)).store_product.equals(nVar2.f41031c)) {
                ...
                return;
            default:
                MessagesController.getInstance(this.f13013b.f13133a).processUpdates((TLRPC.Updates) this.f13014c, false);
                return;
        }
    }
}
