...
public final class t4 extends pq {
    public final Path f13121b;
    public final RectF f13122c;
    public final wa d;
    public final int e;
    public final View f13123f;
    public final ImageReceiver f13124g;
    public final org.telegram.ui.Components.j5 h;
    public RadialGradient f13125i;
    public final Matrix f13126j;
    public final k01 f13127k;
    public final k01 f13128l;
    public org.telegram.ui.Components.j6 f13129m;
    public final float f13130n;
    public lf.p f13131o;
    public int f13132p;
    public int f13133q;
    public final Paint f13134r;
    public int f13135s;
    public int f13136t;
    ...
    public t4(View view, TL_stars.StarGift starGift, int i10, float f10) {
        ...
        int i14;
        int i15;
        this.f13121b = new Path();
        this.f13122c = new RectF();
        this.f13126j = new Matrix();
        this.f13134r = new Paint(1);
        this.f13135s = AndroidUtilities.dp(16.0f);
        this.f13136t = 0;
        this.f13123f = view;
        this.f13130n = f10;
        ImageReceiver imageReceiver = new ImageReceiver(view);
        this.f13124g = imageReceiver;
        if (i10 > 180) {
            f11 = 24.0f;
        } else {
            f11 = 18.0f;
        ...
        if (starGift instanceof TL_stars.TL_starGift) {
            ...
            ArrayList arrayList3 = waVar.f13313b;
            ...
            if (waVar.f13320l != null) {
                ...
                while (i27 < kVar.f85a) {
                    int i28 = i27;
                    a4.k.b((float[]) kVar.f87c, i28, 0.0f, 0.0f, width2, height2);
                    i27 = i28 + 1;
                }
            }
            long currentTimeMillis = System.currentTimeMillis();
            for (int i29 = 0; i29 < waVar.f13318j; i29++) {
                va vaVar = (va) arrayList3.get(i29);
                PointF pointF5 = (PointF) arrayList.get(i29);
                waVar.c(vaVar, currentTimeMillis, true);
                vaVar.f13259a = pointF5.x + rectF.left;
                vaVar.f13260b = pointF5.y + rectF.top;
            ...
            if (stargiftattributebackdrop != null) {
                this.f13125i = new RadialGradient(0.0f, 0.0f, AndroidUtilities.dpf2(i10) / 2.0f, new int[]{stargiftattributebackdrop.center_color | (-16777216), stargiftattributebackdrop.edge_color | (-16777216)}, new float[]{0.0f, 1.0f}, Shader.TileMode.CLAMP);
        ...
        this.f27967a.setShader(this.f13125i);
    ...
    public final void a() {
        this.h.a();
        this.f13124g.onAttachedToWindow();
        if (this.f13131o != null) {
            ...
            this.f13131o.a(i10 - currentTime);
        }
    }
    ...
    public final void b() {
        this.h.b();
        this.f13124g.onDetachedFromWindow();
        lf.p pVar = this.f13131o;
        if (pVar != null) {
            pVar.b();
        }
    }
    ...
    public final void d(int i10, int i11) {
        ...
        this.f13132p = i11;
        if (this.f13131o == null) {
            this.f13131o = new lf.p(new gg.f(this, 28));
        }
        int currentTime = ConnectionsManager.getInstance(UserConfig.selectedAccount).getCurrentTime();
        if (currentTime < i10) {
            i12 = i10 - currentTime;
        ...
        if (this.f13129m == null) {
            ...
            this.f13129m = j6Var;
            j6Var.r(-1);
            this.f13129m.t(AndroidUtilities.dp(12.0f));
            this.f13129m.setCallback(new i.f(this, 4));
        }
        h();
    }
    ...
    public final void draw(Canvas canvas) {
        ...
        RectF rectF = this.f13122c;
        rectF.set(bounds);
        canvas.save();
        Path path = this.f13121b;
        path.rewind();
        float f10 = this.f13135s;
        path.addRoundRect(rectF, f10, f10, Path.Direction.CW);
        canvas.clipPath(path);
        RadialGradient radialGradient = this.f13125i;
        Paint paint = this.f27967a;
        if (radialGradient != null) {
            Matrix matrix = this.f13126j;
            matrix.reset();
            matrix.postTranslate(rectF.centerX(), rectF.centerY());
            this.f13125i.setLocalMatrix(matrix);
            paint.setShader(this.f13125i);
        }
        canvas.drawPaint(paint);
        canvas.save();
        canvas.translate(rectF.centerX(), rectF.centerY());
        x0.a(canvas, this.f13136t, this.h, rectF.width(), rectF.height(), 1.0f, this.f13130n);
        wa waVar = this.d;
        if (waVar != null) {
            waVar.b(canvas, -1, 1.0f);
        }
        canvas.restore();
        k01 k01Var2 = this.f13127k;
        ImageReceiver imageReceiver = this.f13124g;
        if (k01Var2 != null && (k01Var = this.f13128l) != null) {
            if (this.f13129m != null) {
                Paint paint2 = this.f13134r;
                paint2.setColor(1342177280);
                canvas.drawRoundRect(rectF.left + AndroidUtilities.dp(6.0f), AndroidUtilities.dp(6.0f) + rectF.top, rectF.left + AndroidUtilities.dp(20.0f) + Math.max(this.f13129m.d(), AndroidUtilities.dp(3.0f)), rectF.top + AndroidUtilities.dp(23.0f), AndroidUtilities.dp(8.5f), AndroidUtilities.dp(8.5f), paint2);
                canvas.save();
                canvas.translate(rectF.left + AndroidUtilities.dp(13.0f), rectF.top + AndroidUtilities.dp(14.0f));
                this.f13129m.draw(canvas);
                canvas.restore();
            }
    ...
    public final void e(int i10, int i11) {
        ...
        this.f13125i = radialGradient;
        this.f27967a.setShader(radialGradient);
    }
    ...
    public final void h() {
        ...
        if (currentTime > i10) {
            this.f13129m.q(LocaleController.getString(R.string.Gift2AuctionCountdownFinished), true, true);
        } else {
            int i11 = this.f13133q;
            if (currentTime < i11) {
                this.f13129m.q(LocaleController.formatString(R.string.Gift2AuctionCountdownStartsIn, AndroidUtilities.formatDuration(i11 - currentTime, true)), true, true);
            } else {
                this.f13129m.q(AndroidUtilities.formatDuration(i10 - currentTime, true), true, true);
            }
        }
        if (currentTime > this.f13132p && (k01Var = this.f13128l) != null) {
