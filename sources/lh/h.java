...
public final class h extends RecyclerView {
    ...
    public h(LaunchActivity launchActivity) {
        ...
        this.V0 = paint;
        this.f14347c1 = Integer.MIN_VALUE;
        this.f14348d1 = Integer.MIN_VALUE;
    ...
    public final void dispatchDraw(Canvas canvas) {
        int measuredHeight = getMeasuredHeight() - this.f14346b1;
        ...
        this.f14347c1 = i10;
        this.f14348d1 = getMeasuredHeight();
        super.dispatchDraw(canvas);
        canvas.restore();
        this.f14347c1 = Integer.MIN_VALUE;
        this.f14348d1 = Integer.MIN_VALUE;
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent.getAction() == 0) {
            ...
            if (y3 < getMeasuredHeight() - this.f14346b1) {
                return false;
            }
            int childCount = getChildCount();
            int i10 = 0;
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        if (this.f14347c1 != Integer.MIN_VALUE && view.getY() + view.getHeight() < this.f14347c1) {
            return true;
        }
        if (this.f14348d1 != Integer.MIN_VALUE && view.getY() > this.f14348d1) {
            return true;
        }
