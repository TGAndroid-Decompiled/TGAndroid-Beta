    ...
    public final void run(Object obj) {
        ...
        switch (i10) {
            case 0:
                ...
                new d(sVar.getContext(), (g6) obj2, sVar.f12945i0, (List) obj).show();
                return;
            case 1:
                f0 f0Var = (f0) obj4;
                g6 g6Var = (g6) obj2;
                ...
                f0Var.getClass();
                ((boolean[]) obj3)[0] = false;
                if (f0Var.f12727j0 != null) {
                    new d(f0Var.getContext(), g6Var, f0Var.f12727j0, list).show();
                    f0Var.dismiss();
                    return;
                }
                return;
            ...
            case 4:
                ...
                ov ovVar = new ov(((i9) obj3).f17266f, n3Var.getContext(), (g6) obj2, arrayList2);
                oh.z3 z3Var = n3Var.f17481w0.N1;
                if (z3Var != null) {
                    ((z8) z3Var).h(ovVar);
                    return;
                }
            ...
            case 5:
                ...
                oh.f4 f4Var = y3Var.f17950l;
                if ((storyItem instanceof oh.c6) && (d6Var = ((oh.c6) storyItem).f16940a) != null) {
                    p6 p6Var = new p6(d6Var, storyItem2, callback, 6);
                    if (d6Var.F != 0) {
                        ConnectionsManager.getInstance(d6Var.f17398c).cancelRequest(d6Var.F, true);
                        d6Var.F = 0;
                    }
                    d6Var.C = false;
                    d6Var.D = false;
                ...
                tL_stories_getStoriesByID.peer = MessagesController.getInstance(f4Var.f17133z2).getInputPeer(storyItem.dialogId);
                tL_stories_getStoriesByID.f21087id.add(Integer.valueOf(storyItem.f21080id));
                ConnectionsManager.getInstance(f4Var.f17133z2).sendRequest(tL_stories_getStoriesByID, new hg.y(y3Var, storyItem, callback));
                return;
            case 6:
                m6 m6Var = (m6) obj;
                oh.f4 f4Var2 = ((oh.y3) obj4).f17950l;
                f4Var2.P1.c(m6Var.f17439a, f4Var2.f17128y1, (TL_stories.StoryItem) obj3);
                new qc(f4Var2.Z0, (g6) obj2).Q(R.raw.contact_check, 36, AndroidUtilities.replaceTags(LocaleController.formatString(R.string.StoryAddedToAlbumX, m6Var.f17440b))).j();
                return;
            case 7:
            ...
            case 8:
                ...
                snVar.f31106g0.b(tL_messageMediaToDo, null, null, null, true, 0, l10.longValue());
            ...
            case 9:
                ...
                while (i11 < size) {
                    ...
                    if (stickerSetCovered instanceof TLRPC.TL_stickerSetFullCovered) {
                        ...
                        TLRPC.TL_messages_stickerSet stickerSet = MediaDataController.getInstance(kyVar.f28473a.C.Z0).getStickerSet(MediaDataController.getInputStickerSet(stickerSetCovered.set), Integer.valueOf(stickerSetCovered.set.hash), true);
                        if (stickerSet != null) {
