...
public final class t7 {
    ...
    public ArrayList f13155j;
    public boolean f13156k;
    public boolean f13157l;
    public ArrayList f13158m;
    public boolean f13159n;
    public boolean f13160o;
    public ArrayList f13161p;
    public String f13167w;
    public boolean f13168x;
    public boolean f13169y;
    public TL_stars.StarsAmount f13152f = TL_stars.StarsAmount.ofStars(0);
    public final ArrayList[] f13162q = {new ArrayList(), new ArrayList(), new ArrayList()};
    public final boolean[] f13163r = new boolean[3];
    public final String[] f13164s = new String[3];
    public final boolean[] f13165t = new boolean[3];
    public final boolean[] f13166u = new boolean[3];
    public final ArrayList v = new ArrayList();
    public final ArrayList f13170z = new ArrayList();
    ...
    public static boolean U(int i10, mf.a aVar) {
        if (aVar == null || x(i10, aVar.f13928a).s().f13929b >= aVar.f13929b) {
            return true;
        }
        return false;
    }
    ...
    public static void e0(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        alertDialog$Builder.f19503a.O = LocaleController.getString(R.string.StarsNotAvailableTitle);
        alertDialog$Builder.f19503a.Q = LocaleController.getString(R.string.StarsNotAvailableText);
    ...
    public static long o(TLObject tLObject) {
        ...
        if (tLObject instanceof TLRPC.TL_messages_forwardMessages) {
            ...
            return tL_messages_forwardMessages.allow_paid_stars / tL_messages_forwardMessages.f19270id.size();
    ...
    public final long A(n7 n7Var, TLRPC.TL_messageReactions tL_messageReactions) {
        Long l10;
        s7 s7Var = this.B;
        if (s7Var != null && s7Var.f13079a.equals(n7Var) && (l10 = this.B.f13089n) != null) {
        ...
        Long paidReactionsDialogId = MessagesController.getInstance(this.f13149a).getPaidReactionsDialogId();
    ...
    public final long B(MessageObject messageObject) {
        ...
        Long l10;
        s7 s7Var = this.B;
        if (s7Var != null && s7Var.f13079a.equals(n7.b(messageObject)) && (l10 = this.B.f13089n) != null) {
            return l10.longValue();
        }
    ...
    public final long D(int i10, long j10) {
        s7 s7Var = this.B;
        if (s7Var != null) {
            n7 n7Var = s7Var.f13079a;
            if (n7Var.f12852a == j10 && n7Var.f12853b == i10 && s7Var.f13087l) {
                return s7Var.h;
            }
            return 0L;
        }
    ...
    public final j7 F(long j10, boolean z4) {
        ...
        if (j7Var == null && z4) {
            j7 j7Var2 = new j7(this.f13149a, j10);
    ...
    public final l7 G(long j10, boolean z4) {
        ...
        if (l7Var == null && z4) {
            l7 l7Var2 = new l7(this.f13149a, j10, true);
    ...
    public final void H(TL_stars.StarGift starGift, long j10, TLRPC.TL_textWithEntities tL_textWithEntities, boolean z4, Utilities.Callback callback) {
        ...
        if (starGift != null && context != null) {
            ...
            tL_inputInvoiceStarGiftResale.to_id = MessagesController.getInstance(this.f13149a).getInputPeer(j10);
            tL_inputInvoiceStarGiftResale.ton = this.f13150b;
            ...
            ConnectionsManager.getInstance(this.f13149a).sendRequest(tL_payments_getPaymentForm, new dg.d3(9, this, callback));
        }
    }
    ...
    public final void K(long j10, Utilities.Callback callback) {
        ...
        ConnectionsManager.getInstance(this.f13149a).sendRequest(getstargiftupgradepreview, new gg.c0(this, j10, callback, 1));
    }
    ...
    public final void M(TL_stars.InputSavedStarGift inputSavedStarGift, Utilities.Callback callback) {
        ...
        ConnectionsManager.getInstance(this.f13149a).sendRequest(getsavedstargift, new kh.b1(this, d2Var, inputSavedStarGift, callback, 3));
    }
    ...
    public final boolean O(int i10) {
        if (this.e && !this.f13162q[i10].isEmpty()) {
            return true;
        }
        return false;
    }
    ...
    public final void R(TLRPC.UserFull userFull) {
        ...
        l7 G = G(j10, false);
        if (G != null && G.f12774n != userFull.stargifts_count) {
            G.i(false);
        }
        j7 j7Var = (j7) this.K.get(j10);
        if (j7Var != null) {
    ...
    public final void T(boolean z4) {
        for (int i10 = 0; i10 < 3; i10++) {
            boolean[] zArr = this.f13165t;
            if (!zArr[i10]) {
                this.f13162q[i10].clear();
                this.f13164s[i10] = null;
                zArr[i10] = false;
                this.f13166u[i10] = false;
                if (z4) {
                    X(i10);
                }
            }
    ...
    public final void W() {
        if (!this.f13150b && !this.f13168x && !this.f13169y) {
            this.f13168x = true;
            ...
            String str = this.f13167w;
            tL_getStarsSubscriptions.offset = str;
            if (str == null) {
                tL_getStarsSubscriptions.offset = "";
            }
            ConnectionsManager.getInstance(this.f13149a).sendRequest(tL_getStarsSubscriptions, new j6(this, 1));
        }
    }
    ...
    public final void X(int i10) {
        boolean z4;
        boolean[] zArr = this.f13165t;
        if (!zArr[i10] && !this.f13166u[i10]) {
            boolean z10 = true;
            zArr[i10] = true;
            TL_stars.TL_payments_getStarsTransactions tL_payments_getStarsTransactions = new TL_stars.TL_payments_getStarsTransactions();
            tL_payments_getStarsTransactions.ton = this.f13150b;
            ...
            String str = this.f13164s[i10];
            tL_payments_getStarsTransactions.offset = str;
            if (str == null) {
                tL_payments_getStarsTransactions.offset = "";
            }
            ConnectionsManager.getInstance(this.f13149a).sendRequest(tL_payments_getStarsTransactions, new s1(this, i10, 1));
        }
    }
    ...
    public final void Z(final String str, final TLRPC.ChatInvite chatInvite, final Utilities.Callback2 callback2) {
        if (chatInvite != null && chatInvite.subscription_pricing != null) {
            ...
            if (context != null) {
                ...
                ConnectionsManager.getInstance(this.f13149a).sendRequest(tL_payments_sendStarsForm, new RequestDelegate() {
                    @Override
    ...
    public final void a0(final MessageObject messageObject, final TLRPC.InputInvoice inputInvoice, final TLRPC.TL_payments_paymentFormStars tL_payments_paymentFormStars, final Utilities.Callback callback) {
        ...
        if (tL_payments_paymentFormStars != null) {
            ...
            if (messageObject != null) {
                ...
                if (j10 < 0 && messageObject.getFromChatId() > 0 && (user = MessagesController.getInstance(this.f13149a).getUser(Long.valueOf(messageObject.getFromChatId()))) != null && user.bot) {
                    j10 = user.f19331id;
                }
            } else {
            ...
            final long j12 = j10;
            if (j12 >= 0) {
                str = UserObject.getUserName(MessagesController.getInstance(this.f13149a).getUser(Long.valueOf(j12)));
            } else {
                TLRPC.Chat chat = MessagesController.getInstance(this.f13149a).getChat(Long.valueOf(-j12));
                if (chat == null) {
                    str = "";
                } else {
                    str = chat.title;
    ...
    public final void c0(int i10, long j10, ArrayList arrayList) {
        MessagesStorage messagesStorage = MessagesStorage.getInstance(this.f13149a);
    ...
    public final s7 d0(final MessageObject messageObject, final xn xnVar, final long j10, boolean z4, boolean z10, final Long l10) {
        ...
        if (z10 && y10.e && y10.q(false, false, null).amount <= 0) {
            ...
            new z9(t6, xnVar.getResourceProvider(), j10, 5, str2, new Runnable(this) {
                ...
                public final void run() {
                    switch (r7) {
                        case 0:
                            this.f12886b.d0(messageObject, xnVar, j10, true, true, l10);
                            return;
                        default:
                            this.f12886b.d0(messageObject, xnVar, j10, true, true, l10);
                            return;
        ...
        s7 s7Var = this.B;
        if (s7Var != null && s7Var.f13079a.equals(b10)) {
            j11 = 0;
            t7Var = this;
        } else {
            s7 s7Var2 = this.B;
        ...
        if (z10 && y10.e && y10.q(false, false, null).amount < j12) {
            ...
            new z9(t6, xnVar.getResourceProvider(), j12, 5, str, new Runnable(t7Var) {
                ...
                public final void run() {
                    switch (r7) {
                        case 0:
                            this.f12886b.d0(messageObject, xnVar, j12, true, true, l10);
                            return;
                        default:
                            this.f12886b.d0(messageObject, xnVar, j12, true, true, l10);
                            return;
        ...
        q7 q7Var = s7Var4.f13091p;
        t7 t7Var2 = s7Var4.f13092q;
        int i11 = t7Var2.f13149a;
        cc ccVar = s7Var4.e;
        MessageObject messageObject2 = s7Var4.f13080b;
        if (!s7Var4.f13084i && !s7Var4.f13085j) {
            s7Var4.h += j10;
            System.currentTimeMillis();
            ccVar.f23961c.a();
            ccVar.f23961c.c(AndroidUtilities.replaceTags(LocaleController.formatPluralString("StarsSentText", (int) s7Var4.h, new Object[0])), true, true);
            if (s7Var4.f13088m) {
                s7Var4.f13082f.f23628b = 5000L;
            ...
            ccVar.f23960b.setText(s7Var4.d());
    ...
    public final void f(Activity activity, TL_stars.TL_starsTopupOption tL_starsTopupOption, Utilities.Callback2 callback2, TLRPC.InputPeer inputPeer) {
        ...
        if ((BuildVars.useInvoiceBilling() || !BillingController.getInstance().isReady()) && !z4) {
            ...
            b6.h hVar = new b6.h();
            hVar.f1599c = "inapp";
            hVar.f1598b = tL_starsTopupOption.store_product;
            p2.q a2 = hVar.a();
    ...
    public final void g(final long j10, final TLObject tLObject, final TLRPC.TL_textWithEntities tL_textWithEntities, final Utilities.Callback2 callback2) {
        ...
        if ((z4 || (tLObject instanceof TLRPC.TL_premiumGiftCodeOption)) && context2 != null) {
            ...
            final String name = DialogObject.getName(this.f13149a, j10);
            final TLRPC.TL_inputInvoicePremiumGiftStars tL_inputInvoicePremiumGiftStars = new TLRPC.TL_inputInvoicePremiumGiftStars();
            tL_inputInvoicePremiumGiftStars.user_id = MessagesController.getInstance(this.f13149a).getInputUser(j10);
            ...
            ConnectionsManager.getInstance(this.f13149a).sendRequest(tL_payments_getPaymentForm, new RequestDelegate() {
                @Override
                public final void run(final TLObject tLObject2, final TLRPC.TL_error tL_error) {
                    ...
                    AndroidUtilities.runOnUIThread(new Runnable() {
                        ...
                        public final void run() {
                            ...
                            t7 t7Var2 = t7.this;
                            ConnectionsManager.getInstance(t7Var2.f13149a).sendRequest(tL_payments_sendStarsForm, new d6(t7Var2, callback23, context3, f6Var, j12, str, j11, tLObject3, tL_textWithEntities2));
                        }
                    });
                }
            });
    ...
    public final void h(TLRPC.TL_payments_paymentFormStarGift tL_payments_paymentFormStarGift, TL_stars.StarGift starGift, long j10, TLRPC.TL_textWithEntities tL_textWithEntities, boolean z4, Utilities.Callback2 callback2) {
        ...
        if (starGift != null && context2 != null) {
            ...
            String name = DialogObject.getName(this.f13149a, j10);
            TLRPC.TL_inputInvoiceStarGiftResale tL_inputInvoiceStarGiftResale = new TLRPC.TL_inputInvoiceStarGiftResale();
            tL_inputInvoiceStarGiftResale.slug = starGift.slug;
            tL_inputInvoiceStarGiftResale.to_id = MessagesController.getInstance(this.f13149a).getInputPeer(j10);
            tL_inputInvoiceStarGiftResale.ton = this.f13150b;
            ...
            ConnectionsManager.getInstance(this.f13149a).sendRequest(tL_payments_sendStarsForm, new d6(this, callback2, context2, I, j11, name, tL_payments_paymentFormStarGift, starGift, j10));
        }
    }
    ...
    public final void i(final TL_stars.StarGift starGift, final boolean z4, final boolean z10, final long j10, final TLRPC.TL_textWithEntities tL_textWithEntities, final kh.s5 s5Var) {
        ...
        if (starGift != null && context2 != null) {
            ...
            tL_inputInvoiceStarGift.peer = MessagesController.getInstance(this.f13149a).getInputPeer(j10);
            tL_inputInvoiceStarGift.gift_id = starGift.f19409id;
                ...
                public final void run(final TLObject tLObject, final TLRPC.TL_error tL_error) {
                    ...
                    AndroidUtilities.runOnUIThread(new Runnable() {
                        ...
                        public final void run() {
                            ...
                            ConnectionsManager connectionsManager = ConnectionsManager.getInstance(t7Var2.f13149a);
                                ...
                                public final void run(final TLObject tLObject3, final TLRPC.TL_error tL_error3) {
                                    ...
                                    AndroidUtilities.runOnUIThread(new Runnable() {
                                        ...
                                        public final void run() {
                                            ...
                                            if (!(tLObject4 instanceof TLRPC.TL_payments_paymentResult)) {
                                                if (tL_error4 != null) {
                                                    ...
                                                    if ("BALANCE_TOO_LOW".equals(tL_error4.text)) {
                                                        if (!MessagesController.getInstance(t7Var4.f13149a).starsPurchaseAvailable()) {
                                                            s5Var5.run(Boolean.FALSE, null);
                                                            t7.e0(context6, f6Var4);
                                                            return;
                                                        }
                                                        boolean[] zArr = {false};
                                                        z9 z9Var = new z9(context6, f6Var4, j16, 6, str6, new i6(t7Var4, zArr, starGift5, z18, z19, j17, tL_textWithEntities5, s5Var5), 0L);
                                                        z9Var.setOnDismissListener(new gg.g(1, s5Var5, zArr));
                                                        z9Var.show();
                                                        return;
                                                    }
                                                } else {
                                            ...
                                            if (BirthdayController.getInstance(t7Var4.f13149a).contains(j17)) {
                                                i11 = 0;
                                                MessagesController.getInstance(t7Var4.f13149a).getMainSettings().edit().putBoolean(Calendar.getInstance().get(1) + "bdayhint_" + j17, false).apply();
                                            } else {
                                                i11 = 0;
                                            }
                                            ...
                                            if (j17 < 0) {
                                                long j18 = -j17;
                                                TLRPC.ChatFull chatFull = MessagesController.getInstance(t7Var4.f13149a).getChatFull(j18);
                                                if (chatFull != null) {
                                                    chatFull.stargifts_count++;
                                                    chatFull.flags2 |= 262144;
                                                    MessagesController.getInstance(t7Var4.f13149a).putChatFull(chatFull);
                                                }
                                                ...
                                                if ((R instanceof xn) && ((xn) R).a() == j17) {
                                                    ...
                                                    NotificationCenter notificationCenter = NotificationCenter.getInstance(t7Var4.f13149a);
                                                    ...
                                                    NotificationCenter.getInstance(t7Var4.f13149a).lambda$postNotificationNameOnUIThread$1(NotificationCenter.closeChatActivity, Long.valueOf(j17), bool);
                                                    xn R9 = xn.R9(j17);
                                                    R9.whenFullyVisible(new c2(R9, starGift5, spannableStringBuilder2, j16, 6));
                                                    R.presentFragment(R9);
                                                }
                                            }
                                            MessagesController.getInstance(t7Var4.f13149a).getMainSettings().edit().putBoolean("show_gift_for_" + j17, true).putBoolean(Calendar.getInstance().get(1) + "show_gift_for_" + j17, true).apply();
                                            LaunchActivity launchActivity = LaunchActivity.D1;
                                            if (launchActivity != null && (wa0Var = launchActivity.f31652u0) != null) {
                                                wa0Var.c(true);
                                            }
    ...
    public final void j0(String str, TLRPC.ChatInvite chatInvite, Utilities.Callback2 callback2) {
        ...
        if (chatInvite != null && chatInvite.subscription_pricing != null) {
            ...
            if (context2 != null) {
                ...
                z8Var.f31274n = 0;
                z8Var.f31273m = false;
                org.telegram.ui.Components.z8.a(str3, null, null, z8Var.f31277q);
                ...
                if (i14 == 2592000) {
                    ...
                    j11.setText(AndroidUtilities.replaceTags(LocaleController.formatPluralString("StarsSubscribeTextTest", (int) tL_starsSubscriptionPricing.amount, chatInvite.title, str2)));
                }
                ...
                e90Var.setText(AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.StarsSubscribeInfo), new e2.f(context2, 9)));
                ...
                e90Var.setLinkTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19966gc, I));
    ...
    public final void k0(TL_stars.StarsAmount starsAmount) {
        boolean equals = this.f13152f.equals(starsAmount);
        int i10 = this.f13149a;
        if (!equals) {
            this.f13152f = starsAmount;
            this.f13153g = 0L;
    ...
    public final void l0(final MessageObject messageObject, final long j10, final Runnable runnable, final boolean z4) {
        ...
        tL_messages_editMessage.f19267id = id2;
    ...
    public final TL_stars.SavedStarGift n(long j10) {
        ...
        while (true) {
            ...
            if (i10 < longSparseArray.size()) {
                ...
                for (int i11 = 0; i11 < l7Var.f12772l.size(); i11++) {
                    TL_stars.SavedStarGift savedStarGift = (TL_stars.SavedStarGift) l7Var.f12772l.get(i11);
                    if (savedStarGift != null && (starGift = savedStarGift.gift) != null && starGift.f19409id == j10) {
    ...
    public final TL_stars.StarsAmount q(boolean z4, boolean z10, Runnable runnable) {
        if (((!this.e || System.currentTimeMillis() - this.f13151c > 60000) && !this.d) || z10) {
            this.d = true;
            TL_stars.TL_payments_getStarsStatus tL_payments_getStarsStatus = new TL_stars.TL_payments_getStarsStatus();
            tL_payments_getStarsStatus.ton = this.f13150b;
            tL_payments_getStarsStatus.peer = new TLRPC.TL_inputPeerSelf();
            ConnectionsManager.getInstance(this.f13149a).sendRequest(tL_payments_getStarsStatus, new dg.d3(10, this, runnable));
        }
        if (z4 && this.f13153g > 0) {
            mf.a m9 = mf.a.m(this.f13152f);
            return mf.a.g(Math.max(0L, m9.a() - this.f13153g), m9.f13928a).o();
        }
        return this.f13152f;
    }
    ...
    public final ArrayList u() {
        if (!this.f13156k && !this.f13157l) {
            this.f13156k = true;
            ConnectionsManager.getInstance(this.f13149a).sendRequest(new TL_stars.TL_payments_getStarsGiftOptions(), new j6(this, 3));
            return this.f13158m;
        }
        return this.f13158m;
    }
    ...
    public final ArrayList v() {
        if (!this.f13159n && !this.f13160o) {
            this.f13159n = true;
            ConnectionsManager.getInstance(this.f13149a).sendRequest(new TL_stars.TL_payments_getStarsGiveawayOptions(), new j6(this, 4));
            return this.f13161p;
        }
        return this.f13161p;
    }
    ...
    public final ArrayList z() {
        if (!this.h && !this.f13154i) {
            this.h = true;
            ConnectionsManager.getInstance(this.f13149a).sendRequest(new TL_stars.TL_payments_getStarsTopupOptions(), new j6(this, 2));
            return this.f13155j;
        }
        return this.f13155j;
    }
