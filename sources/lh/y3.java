...
public final class y3 extends FrameLayout {
    ...
    public final Matrix f13383b;
    public final float[] f13384c;
    public float d;
    public float e;
    public boolean f13385f;
    public final float[][] h;
    public final float[] f13386n;
    public final float[] f13387r;
    public final Integer[] f13388s;
    public final HashSet v;
    public final HashMap f13389w;
    public final HashMap f13390x;
    public final float[] f13391y;

    public y3(Context context, View[] viewArr) {
        super(context);
        this.f13383b = new Matrix();
        ...
        this.f13386n = new float[4];
        this.f13387r = new float[6];
        this.f13388s = new Integer[]{0, 1, 2, 3, 4, 5};
        this.v = new HashSet();
        this.f13389w = new HashMap();
        this.f13390x = new HashMap();
        this.f13391y = new float[6];
        this.C = -1;
        this.F = new b(this, 8);
        setClipToOutline(false);
        setClipToPadding(false);
        android.opengl.Matrix.setIdentityM(fArr, 0);
        this.f13382a = viewArr;
    ...
    public final boolean drawChild(Canvas canvas, View view, long j10) {
        ...
        if (indexOfChild >= 6) {
            ...
            rectF = (RectF) this.f13390x.get(Integer.valueOf(indexOfChild));
            Integer num = (Integer) this.f13389w.get(Integer.valueOf(indexOfChild));
            if (num != null) {
            ...
            if (view instanceof d4) {
                ...
                if (!z4 || this.B >= 1.0f) {
                    this.f13382a[indexOfChild].setVisibility(8);
                }
            }
            z10 = true;
        } else {
        ...
        float[][] fArr = this.h;
        android.opengl.Matrix.multiplyMV(this.f13386n, 0, this.f13384c, 0, fArr[indexOfChild], 0);
        float f17 = this.f13386n[2];
        if (f17 < 0.001f) {
            return false;
        }
        ...
        fArr3[i10] = 0.0f;
        fArr4[i10] = 0.0f;
        float f18 = this.f13391y[indexOfChild];
        if (f18 != 0.0f) {
        ...
        android.opengl.Matrix.multiplyMV(fArr5, 0, this.f13384c, 0, fArr2, 0);
        float[] fArr8 = fArr5;
        android.opengl.Matrix.multiplyMV(fArr6, 0, this.f13384c, 0, fArr3, 0);
        float[] fArr9 = fArr6;
        android.opengl.Matrix.multiplyMV(fArr7, 0, this.f13384c, 0, fArr4, 0);
        float f25 = 64.0f * dp2;
        int i11 = 2;
        int i12 = 1;
    ...
    public final void f(int i10, FrameLayout frameLayout) {
        ...
        this.f13389w.put(Integer.valueOf(childCount), Integer.valueOf(i10));
    }

    @Override
    public final int getChildDrawingOrder(int i10, int i11) {
        if (i11 < 6) {
            Integer[] numArr = this.f13388s;
