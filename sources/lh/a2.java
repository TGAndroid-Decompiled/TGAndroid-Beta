...
public final class a2 extends rq {
    ...
    public a2(View view) {
        ...
        this.f12586e = 1.0f;
        c(path, 1.0f, false);
        this.f30818a.setColor(-698031);
        this.f30818a.setPathEffect(new CornerPathEffect(AndroidUtilities.dp(2.33f)));
        paint.setColor(0);
    ...
    public final void draw(Canvas canvas) {
        ...
        Path path = this.f12585c;
        if (alpha > 0) {
            paint.setStrokeWidth(AndroidUtilities.dp(1.33f) * 2);
            canvas.drawPath(path, paint);
        }
        canvas.drawPath(path, this.f30818a);
        if (this.f12587f != null) {
            canvas.clipPath(path);
            this.f12587f.f(0, 0, AndroidUtilities.dp(48.0f), AndroidUtilities.dp(48.0f));
            this.f12587f.d();
            this.f12587f.a(canvas, -1);
            invalidateSelf();
        }
        if (this.f12584b != null) {
            ...
            float min = Math.min(1.0f, AndroidUtilities.dp(40.0f) / this.f12584b.f28521c);
            ...
            l01 l01Var = this.f12584b;
            float width3 = getBounds().width() / 2.0f;
            if (!this.f12588g) {
                f15 = 6.0f;
            }
            float dp3 = (width3 + AndroidUtilities.dp(f15)) - (this.f12584b.l() / 2.0f);
            float height3 = getBounds().height() / 2.0f;
            if (this.f12588g) {
                f16 = 4.0f;
            }
            canvas2 = canvas;
            l01Var.c(dp3, height3 - AndroidUtilities.dp(f16), 1.0f, this.h, canvas2);
            canvas2.restore();
        } else {
            canvas2 = canvas;
        }
    ...
    public final void e(int i10, CharSequence charSequence, boolean z4) {
        ...
        this.f12584b = new l01(charSequence, f10, typeface);
    }
}
