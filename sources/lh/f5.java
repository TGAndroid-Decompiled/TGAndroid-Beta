...
public final class f5 extends View {
    public final int f12408a = 2;
    public final Paint f12409b;
    ...
    public f5(Activity activity, org.telegram.ui.ActionBar.f6 f6Var) {
        super(activity);
        this.f12410c = new xd.a(this, mr.h, 380L);
    ...
    public void onAttachedToWindow() {
        switch (this.f12408a) {
            case 0:
                ...
                ((ImageReceiver) this.f12410c).onAttachedToWindow();
    ...
    public void onDetachedFromWindow() {
        switch (this.f12408a) {
            case 0:
                ...
                ((ImageReceiver) this.f12410c).onDetachedFromWindow();
    ...
    public final void onDraw(Canvas canvas) {
        switch (this.f12408a) {
            case 0:
                ...
                ImageReceiver imageReceiver = (ImageReceiver) this.f12410c;
                float f10 = height;
                ...
                canvas.drawPath((Path) this.e, this.f12409b);
                canvas.restore();
            ...
            case 1:
                ...
                canvas.drawRoundRect(rectF, rectF.width() / 2.0f, rectF.height() / 2.0f, this.f12409b);
                ...
                canvas.drawRoundRect(rectF, rectF.height() / 2.0f, rectF.height() / 2.0f, (Paint) this.f12410c);
                return;
            default:
    ...
    public boolean verifyDrawable(Drawable drawable) {
        switch (this.f12408a) {
            case 2:
                if (!super.verifyDrawable(drawable) && (drawable != ((g51) this.e) || ((xd.a) this.f12410c).f46961f)) {
                    return false;
                }
                return true;
            default:
    ...
    public f5(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.e = new RectF();
        paint2.setColor(-1);
        paint.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19881d6, f6Var));
