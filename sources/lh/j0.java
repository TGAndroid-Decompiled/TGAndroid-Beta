...
public final class j0 extends x1 {
    public final RectF f12815j0;
    public final RectF f12816k0;
    public final Path f12817l0;
    public final m0 m0;

    public j0(m0 m0Var, Context context, int i10, g6 g6Var) {
        super(context, i10, g6Var);
        this.m0 = m0Var;
        this.f12815j0 = new RectF();
        this.f12816k0 = new RectF();
        this.f12817l0 = new Path();
    }
    ...
    public final boolean drawChild(Canvas canvas, View view, long j10) {
        ...
        if (view == frameLayout) {
            FrameLayout frameLayout2 = h0Var.f13797b;
            g0 g0Var = m0Var.V;
            RectF rectF = this.f12815j0;
            if (vg.i.c(frameLayout2, g0Var, rectF)) {
                RectF rectF2 = this.f12816k0;
