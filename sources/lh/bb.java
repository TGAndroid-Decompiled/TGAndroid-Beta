...
public abstract class bb extends View {
    ...
    public final Path V;
    public float W;
    public final org.telegram.ui.ActionBar.f6 f12162a;
    public float f12163a0;
    public final Paint f12164b;
    public int[] f12165b0;
    public final Paint f12166c;
    public final xd.a f12167c0;
    public final Paint d;
    public float f12168d0;
    public final Paint e;
    public float f12169e0;
    public final Paint f12170f;
    public long f12171f0;
    public int f12172g0;
    public final wa h;
    public boolean f12173h0;
    public ValueAnimator f12174i0;
    public final wa f12175n;
    public int f12176r;
    public int f12177s;
    public ValueAnimator v;
    public int f12178w;
    public int f12179x;
    public LinearGradient f12180y;

    public bb(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context);
        this.f12164b = new Paint(1);
        this.f12166c = new Paint(1);
        this.d = new Paint(1);
        this.e = new Paint(1);
        this.f12170f = new Paint(1);
        this.h = new wa(0, 300);
        this.f12175n = new wa(2, 30);
        this.f12176r = -1135603;
        this.f12177s = -404714;
        this.f12178w = -1135603;
        this.f12179x = -404714;
        this.f12180y = new LinearGradient(0.0f, 0.0f, 255.0f, 0.0f, new int[]{this.f12176r, this.f12177s}, new float[]{0.0f, 1.0f}, Shader.TileMode.CLAMP);
        this.B = new Matrix();
        this.C = true;
        ...
        this.V = new Path();
        this.W = 0.0f;
        this.f12167c0 = new xd.a(this, mrVar, 320L);
        this.f12162a = f6Var;
        ...
        j6Var2.f25847b = 17;
        paint.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19952h5, f6Var));
        paint.setStyle(Paint.Style.STROKE);
        paint.setStrokeWidth(AndroidUtilities.dp(1.0f));
    }

    public final void a(float f10) {
        ValueAnimator valueAnimator = this.f12174i0;
        if (valueAnimator != null) {
            valueAnimator.cancel();
        }
        ValueAnimator ofFloat = ValueAnimator.ofFloat(this.W, f10);
        this.f12174i0 = ofFloat;
        ofFloat.addUpdateListener(new dg.o1(this, 17));
        int value = getValue();
        this.f12174i0.addListener(new ab(this, f10, value));
        this.f12174i0.setDuration(320L);
        this.f12174i0.setInterpolator(mr.h);
        this.f12174i0.start();
        if (c(f10) != value) {
            e(c(f10));
        }
    ...
    public final int c(float f10) {
        ...
        int[] iArr;
        if (f10 <= 0.0f) {
            return this.f12165b0[0];
        }
        if (f10 >= 1.0f) {
            return this.f12165b0[iArr.length - 1];
        }
        int[] iArr2 = this.f12165b0;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        this.f12180y.setLocalMatrix(matrix);
        LinearGradient linearGradient = this.f12180y;
        Paint paint3 = this.f12166c;
        paint3.setShader(linearGradient);
        int d = i0.a.d(this.W, this.f12176r, this.f12177s);
        Path path = this.R;
        path.rewind();
        Path.Direction direction2 = Path.Direction.CW;
        path.addRoundRect(rectF2, AndroidUtilities.dp(12.0f), AndroidUtilities.dp(12.0f), direction2);
        int l1 = org.telegram.ui.ActionBar.j6.l1(0.15f, this.f12176r);
        Paint paint4 = this.f12164b;
        paint4.setColor(l1);
        ...
        waVar.f13302j = (int) (waVar.f13297b.size() * ((f14 * 0.85f) + 0.15f));
        waVar.d();
        canvas.save();
        ...
        if (j10 != -1 && b((int) j10) < 1.0f && b((int) this.M) > 0.0f) {
            ...
            if (clamp01 + k01Var.f26124c + (AndroidUtilities.dp(16.0f) * 2) > rectF2.right) {
                f13 = (clamp01 - lerp) - k01Var.f26124c;
            } else {
                f13 = clamp01 + lerp;
            }
            float f15 = f13;
        ...
        if (j11 != -1 && b((int) j11) < 1.0f && b((int) this.M) > 0.0f) {
            ...
            if (k01Var.f26124c + dp3 + (AndroidUtilities.dp(16.0f) * 2) > rectF2.right) {
                f12 = (dp3 - lerp2) - k01Var.f26124c;
            } else {
                f12 = lerp2 + dp3;
            }
            float f16 = f12;
            paint2.setStrokeWidth(AndroidUtilities.dp(1.0f));
            paint2.setColor(org.telegram.ui.ActionBar.j6.l1(0.4f, org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19952h5, this.f12162a)));
            i11 = i10;
        ...
        if (this.L) {
            ...
            int d10 = i0.a.d(0.5f, paint.getColor(), this.f12177s);
            Paint paint6 = this.d;
            paint6.setColor(d10);
            Path path3 = this.T;
            path3.rewind();
        ...
        float clamp5 = Utilities.clamp(this.W - this.f12163a0, 1.0f, -1.0f) * 60.0f;
        ...
        if (Math.abs(this.W - this.f12163a0) > 0.001f) {
            this.f12163a0 = AndroidUtilities.lerp(this.f12163a0, this.W, 0.1f);
            invalidate();
        }
        this.f12170f.setShader(this.f12180y);
        canvas2.drawPath(path4, this.f12170f);
        canvas2.save();
        ...
        canvas2.restore();
        canvas2.save();
        float f28 = 1.0f - (this.f12167c0.e * 0.15f);
        ...
        j6Var.f25864w = (int) (this.f12167c0.e * 255.0f);
        j6Var.draw(canvas2);
        canvas2.restore();
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        if (motionEvent.getAction() == 0) {
            this.f12168d0 = motionEvent.getX();
            this.f12169e0 = motionEvent.getY();
            this.f12172g0 = motionEvent.getPointerId(0);
            this.f12171f0 = System.currentTimeMillis();
            this.f12173h0 = false;
            return true;
        }
        if (motionEvent.getAction() == 2 && motionEvent.getPointerId(0) == this.f12172g0) {
            float x10 = motionEvent.getX() - this.f12168d0;
            float y10 = motionEvent.getY() - this.f12169e0;
            if (!this.f12173h0 && Math.abs(x10) > Math.abs(y10 * 1.5f) && Math.abs(x10) > AndroidUtilities.touchSlop) {
            ...
            if (!this.f12173h0 && motionEvent.getPointerId(0) == this.f12172g0 && k7.n6.a(this.f12168d0, this.f12169e0, motionEvent.getX(), motionEvent.getY()) < AndroidUtilities.touchSlop && ((float) (System.currentTimeMillis() - this.f12171f0)) <= ViewConfiguration.getTapTimeout() * 1.5f) {
    ...
    public final void f(int i10, int i11, boolean z4) {
        if (this.f12178w == i10 && this.f12179x == i11) {
            return;
        }
        ...
        if (z4) {
            int i12 = this.f12176r;
            int i13 = this.f12177s;
            this.f12178w = i10;
            this.f12179x = i11;
    ...
    public final void g(String str) {
        this.f12167c0.a(!TextUtils.isEmpty(str), true);
        org.telegram.ui.Components.j6 j6Var = this.F;
        j6Var.b();
