...
public final class y6 implements Runnable {
    ...
    public final void run() {
        ...
        TLObject tLObject = this.f13383f;
        Object obj = this.e;
        switch (i10) {
            case 0:
                t7 t7Var = (t7) obj;
                ...
                return;
            default:
                ((MessagesStorage) obj).lambda$loadPendingTasks$15(this.f13381b, this.f13382c, (TLRPC.InputPeer) tLObject, this.d);
                return;
        }
    }
