...
public final class v0 implements NativeInstance.PayloadCallback, RequestDelegateTimestamp, NativeInstance.VideoSourcesCallback, NativeInstance.RequestBroadcastPartCallback, NativeInstance.RequestCurrentTimeCallback {
    ...
    public void run(long j10, int[] iArr) {
        ...
        getgroupparticipants.call = d1Var.f15457f;
        getgroupparticipants.offset = "";
        int i10 = 0;
        while (i10 < iArr.length) {
            i10 = th.d(iArr[i10], i10, 1, getgroupparticipants.sources);
        }
        ConnectionsManager.getInstance(d1Var.f15456e).sendRequest(getgroupparticipants, new eg.d0(d1Var, iArr, j10));
    }
    ...
    public void run(final long j10, final long j11, final int i10, final int i11) {
        ...
        switch (this.f16307a) {
            case 3:
                ...
                tL_inputGroupCallStream.call = d1Var.f15457f;
                ...
                AndroidUtilities.runOnUIThread(new ag.v0(d1Var, str2, AccountInstance.getInstance(d1Var.f15456e).getConnectionsManager().sendRequest(tL_upload_getFile, new RequestDelegateTimestamp() {
                    @Override
                    public final void run(TLObject tLObject, TLRPC.TL_error tL_error, long j12) {
                        int i13;
                        String str3;
                        d1 d1Var2 = d1.this;
                        if (!d1Var2.f15461w && d1Var2.A != null) {
                            ...
                            if (tLObject != null) {
                                ...
                                d1Var2.A.onStreamPartAvailable(j14, null, -1, j12, i14, i15);
                                ...
                                d1Var2.A.onStreamPartAvailable(j14, null, i13, j12, i14, i15);
                            }
                        }
                    }
                }, 2, 2, d1Var.h()), 10));
            ...
            default:
                ...
                FileLog.d(sb3.toString());
                AndroidUtilities.runOnUIThread(new a1(i10, i11, 0, j10, this.f16308b));
                return;
        }
    }
    ...
    public void run(long j10) {
        ...
        if (groupCall != null && groupCall.rtmp_stream) {
            ...
            getgroupcallstreamchannels.call = d1Var.f15457f;
