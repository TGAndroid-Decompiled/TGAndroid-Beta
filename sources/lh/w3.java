...
public final class w3 extends org.telegram.ui.ActionBar.h3 {
    ...
    public w3(Context context, long j10, TL_stars.SavedStarGift savedStarGift, g6 g6Var, Utilities.Callback0Return callback0Return) {
        ...
        TextView b11 = k7.g6.b(context, 14.0f, k6.f22038y6, false, g6Var);
        ...
        h61 h61Var = new h61(context, this.currentAccount, 0, false, new eh.w(2, this, G), new c1.b(25, this, dVar), null, g6Var);
        h61Var.setSpanCount(3);
        h61Var.setOverScrollMode(2);
        h61Var.setScrollEnabled(false);
        linearLayout.addView(h61Var, k7.c6.k(11.0f, 0.0f, 11.0f, 0.0f, -1, -2));
