...
public final class e0 extends h0 {
    ...
    public e0(k0 k0Var, Context context) {
        ...
        this.f10694c.addView(k0Var.G, x5.g());
        this.f10694c.addView(this.d, 0, x5.c(-1.0f, -1));
        this.f10694c.addView(k0Var.I, x5.g());
        ...
        this.f10692a.setTitle(LocaleController.getString(R.string.CommunityAddAChatToCommunity));
        this.f10692a.getTitleTextView().setTranslationX(-AndroidUtilities.dp(18.0f));
        this.f10692a.setActionBarMenuOnItemClick(new ah.t(this, 7));
        this.f10694c.addView(this.f10692a, x5.e(-1, 56, 48));
        this.f10694c.addView(k0Var.E, x5.d(-1, 40.0f, 48, 11.0f, 0.0f, 11.0f, 0.0f));
        ...
        k0Var.f10714r = dVar;
        dVar.e();
        k0Var.f10714r.setText(LocaleController.getString(R.string.OK));
        k0Var.f10714r.setOnClickListener(new ah.h0(this, 19));
        if (z10) {
            k0Var.f10714r.setVisibility(8);
        }
        this.f10694c.addView(k0Var.f10714r, x5.f(48.0f, 80, AndroidUtilities.dp(12.0f), 0, AndroidUtilities.dp(12.0f), AndroidUtilities.dp(12.0f) + AndroidUtilities.navigationBarHeight));
        a();
    }

    @Override
    public final float b() {
        return yf.f0.b(this.h.f10710c.f15368e) * super.b();
    }
