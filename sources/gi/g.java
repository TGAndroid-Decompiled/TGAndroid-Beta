...
public final class g extends h51 {
    ...
    public final void bindView(View view, i51 i51Var, boolean z10, w51 w51Var, e61 e61Var) {
        ...
        h hVar = (h) view;
        f fVar = (f) i51Var.G;
        TLRPC.User user = fVar.f10024b;
        long j3 = fVar.f10023a;
        boolean z11 = fVar.f10025c;
        boolean z12 = !i51Var.f24898j;
        u9 u9Var = hVar.f10029c;
        TextView textView = hVar.f10031n;
        TextView textView2 = hVar.d;
        hVar.f10035x = (e) i51Var.H;
        hVar.f10036y = j3;
        hVar.E = user.f18256id;
        int i11 = hVar.f10028b;
        ...
        hVar.f10030f.setText(DialogObject.getName(j3));
        ...
        if (user2 != null) {
            ...
            spannableStringBuilder.setSpan(hVar.f10032r, 0, 1, 33);
    ...
    public final boolean equals(i51 i51Var, i51 i51Var2) {
        f fVar = (f) i51Var.G;
        f fVar2 = (f) i51Var2.G;
        if (fVar.f10023a == fVar2.f10023a && DialogObject.getDialogId(fVar.f10024b) == DialogObject.getDialogId(fVar2.f10024b)) {
            return true;
        }
        return false;
    }
