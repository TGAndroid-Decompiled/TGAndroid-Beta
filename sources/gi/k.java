        ...
        switch (this.f10702a) {
            ...
            case 1:
                ...
                if (inputFile3 == null && inputFile4 == null) {
                    ...
                    mdVar.f38665x = fileLocation2;
                    mdVar.f38666y = this.f10707n.location;
                    mdVar.f38641e.h(ImageLocation.getForLocal(fileLocation2), "50_50", mdVar.f38658s, null);
                    mdVar.e0(true, false);
                    return;
                }
                mdVar.f38650l0 = inputFile3;
                mdVar.m0 = inputFile4;
                mdVar.f38652n0 = this.d;
                mdVar.f38653o0 = this.f10705e;
                mdVar.f38654p0 = this.f10706f;
                if (mdVar.f38655q0) {
                    b2 b2Var = mdVar.f38661u0;
                    if (b2Var != null) {
                        try {
                            b2Var.dismiss();
                            mdVar.f38661u0 = null;
            ...
            case 2:
                ...
                if (inputFile5 == null && inputFile6 == null && videoSize2 == null) {
                    i5 i5Var = xoVar.f42775e;
                    ImageLocation forLocal = ImageLocation.getForLocal(fileLocation3);
                    i9 i9Var = xoVar.f42790r;
                    Object obj = xoVar.D0;
                    if (obj == null) {
                        obj = xoVar.f42800x0;
                    }
                    i5Var.h(forLocal, "50_50", i9Var, obj);
                    xoVar.f42771b0.m(R.drawable.msg_addphoto, LocaleController.getString("ChatSetNewPhoto", R.string.ChatSetNewPhoto), true);
                    if (xoVar.R0 == null) {
                ...
                if (xoVar.M0) {
                    ...
                    xoVar.N0 = z11;
                    xoVar.f42768a.performClick();
                }
                xoVar.n0(z11, true);
                return;
            case 3:
                q50 q50Var = (q50) this.f10708r;
                long j12 = q50Var.f39735e;
                j60 j60Var = q50Var.f39736f;
                ...
                if (inputFile7 == null && inputFile8 == null && videoSize3 == null) {
                    q50Var.f39734c = photoSize4.location;
                    TLRPC.FileLocation fileLocation6 = photoSize5.location;
                    q50Var.f39733b = fileLocation6;
                    ImageLocation forLocal2 = ImageLocation.getForLocal(fileLocation6);
                    q50Var.d = forLocal2;
                    j60Var.f37516b.A(forLocal2, ImageLocation.getForLocal(q50Var.f39734c));
            ...
            case 4:
                ...
                if (inputFile9 == null && inputFile10 == null && videoSize4 == null) {
                    ...
                    l70Var.f38218y = fileLocation7;
                    l70Var.E = this.f10707n.location;
                    l70Var.d.h(ImageLocation.getForLocal(fileLocation7), "50_50", l70Var.f38214r, null);
                    l70Var.Z(true, false);
                    return;
                }
                l70Var.F = inputFile9;
                ...
                if (l70Var.L) {
                    l70Var.getMessagesController().createChat(l70Var.f38210c.getText().toString(), l70Var.K, null, l70Var.P, l70Var.S, l70Var.U, l70Var.T, l70Var.W, l70Var);
                }
                l70Var.Z(false, true);
                l70Var.f38212f.setImageDrawable(null);
                return;
            case 5:
