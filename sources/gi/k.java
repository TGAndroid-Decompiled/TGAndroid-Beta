        ...
        switch (this.f10730a) {
            ...
            case 1:
                ...
                if (inputFile3 == null && inputFile4 == null) {
                    ...
                    mdVar.f38692x = fileLocation2;
                    mdVar.f38693y = this.f10735n.location;
                    mdVar.f38668e.h(ImageLocation.getForLocal(fileLocation2), "50_50", mdVar.f38685s, null);
                    mdVar.e0(true, false);
                    return;
                }
                mdVar.f38677l0 = inputFile3;
                mdVar.m0 = inputFile4;
                mdVar.f38679n0 = this.d;
                mdVar.f38680o0 = this.f10733e;
                mdVar.f38681p0 = this.f10734f;
                if (mdVar.f38682q0) {
                    b2 b2Var = mdVar.f38688u0;
                    if (b2Var != null) {
                        try {
                            b2Var.dismiss();
                            mdVar.f38688u0 = null;
            ...
            case 2:
                ...
                if (inputFile5 == null && inputFile6 == null && videoSize2 == null) {
                    i5 i5Var = xoVar.f42802e;
                    ImageLocation forLocal = ImageLocation.getForLocal(fileLocation3);
                    i9 i9Var = xoVar.f42817r;
                    Object obj = xoVar.D0;
                    if (obj == null) {
                        obj = xoVar.f42827x0;
                    }
                    i5Var.h(forLocal, "50_50", i9Var, obj);
                    xoVar.f42798b0.m(R.drawable.msg_addphoto, LocaleController.getString("ChatSetNewPhoto", R.string.ChatSetNewPhoto), true);
                    if (xoVar.R0 == null) {
                ...
                if (xoVar.M0) {
                    ...
                    xoVar.N0 = z11;
                    xoVar.f42795a.performClick();
                }
                xoVar.n0(z11, true);
                return;
            case 3:
                q50 q50Var = (q50) this.f10736r;
                long j12 = q50Var.f39762e;
                j60 j60Var = q50Var.f39763f;
                ...
                if (inputFile7 == null && inputFile8 == null && videoSize3 == null) {
                    q50Var.f39761c = photoSize4.location;
                    TLRPC.FileLocation fileLocation6 = photoSize5.location;
                    q50Var.f39760b = fileLocation6;
                    ImageLocation forLocal2 = ImageLocation.getForLocal(fileLocation6);
                    q50Var.d = forLocal2;
                    j60Var.f37543b.A(forLocal2, ImageLocation.getForLocal(q50Var.f39761c));
            ...
            case 4:
                ...
                if (inputFile9 == null && inputFile10 == null && videoSize4 == null) {
                    ...
                    l70Var.f38245y = fileLocation7;
                    l70Var.E = this.f10735n.location;
                    l70Var.d.h(ImageLocation.getForLocal(fileLocation7), "50_50", l70Var.f38241r, null);
                    l70Var.Z(true, false);
                    return;
                }
                l70Var.F = inputFile9;
                ...
                if (l70Var.L) {
                    l70Var.getMessagesController().createChat(l70Var.f38237c.getText().toString(), l70Var.K, null, l70Var.P, l70Var.S, l70Var.U, l70Var.T, l70Var.W, l70Var);
                }
                l70Var.Z(false, true);
                l70Var.f38239f.setImageDrawable(null);
                return;
            case 5:
