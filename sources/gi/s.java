...
public final class s extends n2 implements le.d {
    ...
    public final View createView(Context context) {
        ...
        this.f10792n = dVar;
        dVar.d();
        this.f10792n.setColor(i0.a.d(0.125f, getThemedColor(j6.f20691d6), getThemedColor(j6.G6)));
        ...
        this.f10793r.f32783e.setText(LocaleController.getString(R.string.NoCommunityJoinRequestsDescription));
