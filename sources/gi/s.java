...
public final class s extends n2 implements le.d {
    ...
    public final View createView(Context context) {
        ...
        this.f10764n = dVar;
        dVar.d();
        this.f10764n.setColor(i0.a.d(0.125f, getThemedColor(j6.f20664d6), getThemedColor(j6.G6)));
        ...
        this.f10765r.f32756e.setText(LocaleController.getString(R.string.NoCommunityJoinRequestsDescription));
