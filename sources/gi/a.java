...
public final class a extends View {
    public final int f10012a = 1;
    public final Paint f10013b;
    ...
    public a(Activity activity, e6 e6Var) {
        super(activity);
        this.f10014c = new le.b(this, qr.h, 380L);
        this.f10013b = new Paint(1);
        this.d = e6Var;
    ...
    public void onAttachedToWindow() {
        switch (this.f10012a) {
            ...
            case 2:
                super.onAttachedToWindow();
                ((ImageReceiver) this.f10014c).onAttachedToWindow();
    ...
    public void onDetachedFromWindow() {
        switch (this.f10012a) {
            ...
            case 2:
                super.onDetachedFromWindow();
                ((ImageReceiver) this.f10014c).onDetachedFromWindow();
    ...
    public final void onDraw(Canvas canvas) {
        switch (this.f10012a) {
            case 0:
                ...
                canvas.drawRoundRect(rectF, rectF.width() / 2.0f, rectF.height() / 2.0f, this.f10013b);
                ...
                canvas.drawRoundRect(rectF, rectF.height() / 2.0f, rectF.height() / 2.0f, (Paint) this.f10014c);
                return;
            case 1:
            ...
            default:
                ...
                ImageReceiver imageReceiver = (ImageReceiver) this.f10014c;
                float f11 = height2;
                ...
                canvas.drawPath((Path) this.e, this.f10013b);
                canvas.restore();
    ...
    public boolean verifyDrawable(Drawable drawable) {
        switch (this.f10012a) {
            case 1:
                if (!super.verifyDrawable(drawable) && (drawable != ((g51) this.e) || ((le.b) this.f10014c).f13973f)) {
                    return false;
                }
                return true;
            default:
    ...
    public a(Context context, e6 e6Var) {
        ...
        this.e = new RectF();
        paint2.setColor(-1);
        paint.setColor(i6.v0(i6.f18834d6, e6Var));
