...
public final class h extends FrameLayout implements a6 {
    ...
    public final u9 f10033c;
    public final TextView d;
    public final u9 e;
    public final TextView f10034f;
    public final TextView h;
    public final TextView f10035n;
    public final oq f10036r;
    public final fh.d f10037s;
    public final ch.d v;
    ...
    public h(Context context, int i10, f6 f6Var) {
            ...
            public final void onClick(View view) {
                switch (r2) {
                    case 0:
                        ...
                        return;
                    case 1:
                        h hVar2 = this.f10026b;
                        e eVar3 = hVar2.f10039x;
                        if (eVar3 != null) {
                            long j10 = hVar2.E;
                        ...
                        return;
                    case 2:
                        h hVar3 = this.f10026b;
                        e eVar4 = hVar3.f10039x;
                        if (eVar4 != null) {
                            ((t0) eVar4).g(hVar3.f10040y, false);
                            return;
                        }
                        return;
                    default:
                        h hVar4 = this.f10026b;
                        e eVar5 = hVar4.f10039x;
                        if (eVar5 != null) {
                            ((t0) eVar5).g(hVar4.f10040y, true);
                            return;
                        }
                        return;
                }
        ...
        dVar2.e();
        dVar2.d();
        dVar2.setColor(j6.l1(0.14f, j6.v0(j6.f19263z6, f6Var)));
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.f10038w) {
            canvas2 = canvas;
            canvas2.drawLine(AndroidUtilities.dp(76.0f), getHeight() - 1, getMeasuredWidth(), getHeight() - 1, j6.f18984k0);
        } else {
            canvas2 = canvas;
        }
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        fh.d dVar;
        u9 u9Var;
        if (Build.VERSION.SDK_INT >= 31 && (dVar = this.f10037s) != null && view == (u9Var = this.f10033c)) {
            ...
            a2.drawColor(j6.v0(j6.f18862d6, this.f10031a));
            a2.save();
            float f7 = dp2 / 2.0f;
