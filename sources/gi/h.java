...
public final class h extends FrameLayout implements a6 {
    ...
    public h(Context context, int i10, f6 f6Var) {
        ...
        dVar2.e();
        dVar2.d();
        dVar2.setColor(j6.l1(0.14f, j6.v0(j6.f19264z6, f6Var)));
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.f10038w) {
            canvas2 = canvas;
            canvas2.drawLine(AndroidUtilities.dp(76.0f), getHeight() - 1, getMeasuredWidth(), getHeight() - 1, j6.f18985k0);
        } else {
            canvas2 = canvas;
        }
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        if (Build.VERSION.SDK_INT >= 31 && (dVar = this.f10037s) != null && view == (u9Var = this.f10033c)) {
            ...
            a2.drawColor(j6.v0(j6.f18863d6, this.f10031a));
            a2.save();
            float f7 = dp2 / 2.0f;
