...
public final class k0 extends f3 implements NotificationCenter.NotificationCenterDelegate, le.d, n2 {
    ...
    public static void q(k0 k0Var, boolean z10, boolean z11, long j3) {
        ...
        if (textView != null) {
            textView.setTextColor(j6.w0(null, j6.f20899q7, false));
        }
    }
            ...
            if (i11 == 101) {
                ...
                if (b10 != 1 && b10 != 2) {
                    if (b10 == 3) {
                        ...
                        g80Var.f26326n = new yc((FrameLayout) k0Var.containerView, k0Var.resourcesProvider);
                        g80Var.show();
                        return;
                    } else if (b10 == 4) {
    ...
    public k0(org.telegram.ui.ActionBar.n2 n2Var, long j3, ArrayList arrayList, s4 s4Var) {
        ...
        x10Var.f42538b.setClipToPadding(false);
