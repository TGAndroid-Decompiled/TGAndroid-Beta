...
public final class e extends f implements Handler.Callback {
    ...
    public e(c0 c0Var, Looper looper) {
        ...
        this.f47916a0 = -9223372036854775807L;
    ...
    public final int z(s sVar) {
        ...
        if (!equals) {
            ...
            sVar2.getClass();
            if (!((rb.a) sVar2.f47751a).i0(sVar) && !Objects.equals(str, "application/cea-608") && !Objects.equals(str, "application/x-mp4-cea-608") && !Objects.equals(str, "application/cea-708")) {
                if (r0.l(str)) {
