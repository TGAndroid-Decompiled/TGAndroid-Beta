...
public abstract class g8 {
    ...
    public static String a(LaunchActivity launchActivity) {
        ...
        if (arrayList.isEmpty()) {
            ...
            f45005a = (String) arrayList.get(0);
        } else {
            ...
            if (arrayList.contains("com.android.chrome")) {
                f45005a = "com.android.chrome";
            } else if (arrayList.contains("com.chrome.beta")) {
                f45005a = "com.chrome.beta";
            } else if (arrayList.contains("com.chrome.dev")) {
                f45005a = "com.chrome.dev";
            } else if (arrayList.contains("com.google.android.apps.chrome")) {
                f45005a = "com.google.android.apps.chrome";
            }
        }
        try {
            if ("com.sec.android.app.sbrowser".equalsIgnoreCase(f45005a) && (applicationInfo = (packageManager = ApplicationLoader.applicationContext.getPackageManager()).getApplicationInfo("com.android.chrome", 0)) != null && applicationInfo.enabled) {
