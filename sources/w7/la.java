...
public final class la {
    public static ua f44777j;
    public static final za f44778k;
    public final String f44779a;
    public final String f44780b;
    public final ka f44781c;
    public final qb.k d;
    public final Task e;
    public final Task f44782f;
    public final String f44783g;
    public final int h;
    public final HashMap f44784i = new HashMap();

    static {
        Object[] objArr = {"optional-module-barcode", "com.google.android.gms.vision.barcode"};
        objArr[0].getClass();
        objArr[1].getClass();
        f44778k = new za(objArr);
    }
    ...
    public la(Context context, qb.k kVar, ka kaVar) {
        ...
        this.f44780b = qb.c.a(context);
        this.d = kVar;
        this.f44781c = kaVar;
        pa.b();
        this.f44783g = "vision-common";
        qb.f a2 = qb.f.a();
