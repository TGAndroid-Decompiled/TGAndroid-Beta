...
public abstract class d9 {
    public static com.google.android.gms.internal.clearcut.u0 a(Context context, GoogleSignInOptions googleSignInOptions) {
        ...
        return new com.google.android.gms.common.api.j(context, w5.a.f48067a, googleSignInOptions, new com.google.android.gms.common.api.i(new Object(), Looper.getMainLooper()));
    }
    ...
    public static Task b(Intent intent) {
        ...
        Status status3 = bVar.f50797a;
        if (status3.b() && (googleSignInAccount = bVar.f50798b) != null) {
