...
public final class ma implements ja {
    public final q9.n f44802a;
    public final ia f44803b;
    ...
    public ma(Context context, ia iaVar) {
        ...
        this.f44802a = new q9.n(new v7.a9(c10, 3));
    }
    ...
    public final void a(n7.a1 a1Var) {
        f fVar;
        ia.d dVar;
        ia iaVar = this.f44803b;
        iaVar.getClass();
        l5.s sVar = (l5.s) this.f44802a.get();
        iaVar.getClass();
        pa paVar = pa.f44830c;
        ...
        r1Var.f44101b = new l9(d8Var);
        try {
            pa.b();
            k7 k7Var = new k7(r1Var);
            v7.r1 r1Var2 = new v7.r1(4);
            paVar.a(r1Var2);
            HashMap hashMap = new HashMap((HashMap) r1Var2.f44101b);
            HashMap hashMap2 = new HashMap((HashMap) r1Var2.d);
            e eVar = (e) r1Var2.f44102c;
