...
public final class ma implements ja {
    public final q9.n f45061a;
    public final ia f45062b;
    ...
    public ma(Context context, ia iaVar) {
        ...
        this.f45061a = new q9.n(new v7.b9(c10, 3));
    }
    ...
    public final void a(n7.z0 z0Var) {
        f fVar;
        ia.d dVar;
        ia iaVar = this.f45062b;
        iaVar.getClass();
        l5.r rVar = (l5.r) this.f45061a.get();
        iaVar.getClass();
        pa paVar = pa.f45086c;
        ...
        lVar.f44312b = new l9(e8Var);
        try {
            pa.b();
            k7 k7Var = new k7(lVar);
            v7.l lVar2 = new v7.l(5);
            paVar.a(lVar2);
            HashMap hashMap = new HashMap((HashMap) lVar2.f44312b);
            HashMap hashMap2 = new HashMap((HashMap) lVar2.f44313c);
            e eVar = (e) lVar2.d;
