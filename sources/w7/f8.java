...
public abstract class f8 {
    ...
    public static String a(LaunchActivity launchActivity) {
        ...
        if (arrayList.isEmpty()) {
            ...
            f44923a = (String) arrayList.get(0);
        } else {
            ...
            if (arrayList.contains("com.android.chrome")) {
                f44923a = "com.android.chrome";
            } else if (arrayList.contains("com.chrome.beta")) {
                f44923a = "com.chrome.beta";
            } else if (arrayList.contains("com.chrome.dev")) {
                f44923a = "com.chrome.dev";
            } else if (arrayList.contains("com.google.android.apps.chrome")) {
                f44923a = "com.google.android.apps.chrome";
            }
        }
        try {
            if ("com.sec.android.app.sbrowser".equalsIgnoreCase(f44923a) && (applicationInfo = (packageManager = ApplicationLoader.applicationContext.getPackageManager()).getApplicationInfo("com.android.chrome", 0)) != null && applicationInfo.enabled) {
