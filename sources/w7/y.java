    ...
    public static void a(LaunchActivity launchActivity, boolean z10, boolean z11) {
        ...
        if (z10 != z12) {
            if (z10) {
                ...
                frameLayout.f15039r = new mg.c(frameLayout, 3);
                ...
                ((GestureDetector) eVar.f15101b).setIsLongpressEnabled(false);
                ci.m6 m6Var = new ci.m6(frameLayout, launchActivity, eVar, 2);
                frameLayout.f15034a = m6Var;
                ...
                frameLayout.f15041w = linearLayout;
                linearLayout.setOrientation(1);
                linearLayout.setVisibility(8);
                TextView textView = new TextView(launchActivity);
                frameLayout.f15042x = textView;
                ...
                f45137a = frameLayout;
                launchActivity.f31128w0.addView((View) frameLayout, new FrameLayout.LayoutParams(-1, -1));
                mg.i iVar2 = f45137a;
                iVar2.f15034a.setVisibility(0);
                o1.k kVar = new o1.k(new o1.j(0.0f));
                kVar.f15518u = org.telegram.ui.Cells.c1.l(1000.0f, 750.0f, 0.75f);
                kVar.b(new ai.qa(2, iVar2));
                kVar.f();
            } else {
                iVar.getClass();
                launchActivity.f31128w0.removeView(f45137a);
                f45137a = null;
            }
            if (z11) {
