...
public class ha implements Closeable {
    public static final HashMap f44994f = new HashMap();
    public int f44995a;
    public long f44996b;
    public long f44997c;
    ...
    public void a() {
        this.f44996b = SystemClock.elapsedRealtimeNanos() / 1000;
    }

    public void b(long j3) {
        long elapsedRealtimeNanos = SystemClock.elapsedRealtimeNanos() / 1000;
        long j10 = this.f44997c;
        ...
        this.f44997c = elapsedRealtimeNanos;
        this.f44995a++;
        this.d = Math.min(this.d, j3);
        this.e = Math.max(this.e, j3);
        if (this.f44995a % 50 == 0) {
            Locale locale = Locale.US;
            pa.b();
        }
        if (this.f44995a % 500 == 0) {
            this.f44995a = 0;
            this.f44996b = 0L;
            this.d = 2147483647L;
            this.e = -2147483648L;
