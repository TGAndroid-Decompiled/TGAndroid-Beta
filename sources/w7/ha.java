...
public class ha implements Closeable {
    public static final HashMap f44993f = new HashMap();
    public int f44994a;
    public long f44995b;
    public long f44996c;
    ...
    public void a() {
        this.f44995b = SystemClock.elapsedRealtimeNanos() / 1000;
    }
    ...
    public void b(long j3) {
        ...
        this.f44996c = elapsedRealtimeNanos;
        this.f44994a++;
        this.d = Math.min(this.d, j3);
        this.e = Math.max(this.e, j3);
        if (this.f44994a % 50 == 0) {
            Locale locale = Locale.US;
            pa.b();
        }
        if (this.f44994a % 500 == 0) {
            this.f44994a = 0;
            this.f44995b = 0L;
            this.d = 2147483647L;
            this.e = -2147483648L;
