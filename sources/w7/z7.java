...
public abstract class z7 {
    ...
    public static String a(LaunchActivity launchActivity) {
        ...
        if (arrayList.isEmpty()) {
            ...
            f43843a = (String) arrayList.get(0);
        } else {
            ...
            if (arrayList.contains("com.android.chrome")) {
                f43843a = "com.android.chrome";
            } else if (arrayList.contains("com.chrome.beta")) {
                f43843a = "com.chrome.beta";
            } else if (arrayList.contains("com.chrome.dev")) {
                f43843a = "com.chrome.dev";
            } else if (arrayList.contains("com.google.android.apps.chrome")) {
                f43843a = "com.google.android.apps.chrome";
            }
        }
        try {
            if ("com.sec.android.app.sbrowser".equalsIgnoreCase(f43843a) && (applicationInfo = (packageManager = ApplicationLoader.applicationContext.getPackageManager()).getApplicationInfo("com.android.chrome", 0)) != null && applicationInfo.enabled) {
