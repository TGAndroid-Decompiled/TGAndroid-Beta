...
public abstract class v6 {
    public static boolean f48340a = false;
    public static Method f48341b = null;
    public static boolean f48342c = false;
    ...
    public static boolean a(View view, KeyEvent keyEvent) {
        ...
        if (Build.VERSION.SDK_INT < 28) {
            ...
            WeakReference weakReference2 = h0Var2.f44723c;
            if (weakReference2 == null || weakReference2.get() != keyEvent) {
                h0Var2.f44723c = new WeakReference(keyEvent);
                if (h0Var2.f44722b == null) {
                    h0Var2.f44722b = new SparseArray();
                }
                SparseArray sparseArray = h0Var2.f44722b;
