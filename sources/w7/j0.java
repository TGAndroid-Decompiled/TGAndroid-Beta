...
public abstract class j0 {
    ...
    public static void a(Path path, RectF rectF, float f7) {
        ...
        float f10 = 2.0f * f7;
        path.rewind();
        f48202a.set(0.0f, -rectF.height(), f10, (-rectF.height()) + f10);
        path.arcTo(f48202a, 180.0f, 90.0f);
        f48202a.set(rectF.width() - f10, -rectF.height(), rectF.width(), (-rectF.height()) + f10);
        path.arcTo(f48202a, 270.0f, 90.0f);
        f48202a.set(rectF.width() - f10, -f10, rectF.width(), 0.0f);
        path.arcTo(f48202a, 0.0f, 90.0f);
