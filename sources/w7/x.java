    ...
    public static void a(LaunchActivity launchActivity, boolean z10, boolean z11) {
        ...
        if (z10 != z12) {
            if (z10) {
                ...
                frameLayout.f14829r = new mg.c(frameLayout, 3);
                ...
                ((GestureDetector) uVar.f13382b).setIsLongpressEnabled(false);
                ci.n6 n6Var = new ci.n6(frameLayout, launchActivity, uVar, 2);
                frameLayout.f14824a = n6Var;
                ...
                frameLayout.f14831w = linearLayout;
                linearLayout.setOrientation(1);
                linearLayout.setVisibility(8);
                TextView textView = new TextView(launchActivity);
                frameLayout.f14832x = textView;
                ...
                f44861a = frameLayout;
                launchActivity.f30856w0.addView((View) frameLayout, new FrameLayout.LayoutParams(-1, -1));
                mg.i iVar2 = f44861a;
                iVar2.f14824a.setVisibility(0);
                o1.k kVar = new o1.k(new o1.j(0.0f));
                kVar.f15351u = org.telegram.ui.Cells.p6.l(1000.0f, 750.0f, 0.75f);
                kVar.b(new ai.qa(2, iVar2));
                kVar.f();
            } else {
                iVar.getClass();
                launchActivity.f30856w0.removeView(f44861a);
                f44861a = null;
            }
            if (z11) {
