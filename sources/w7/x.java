    ...
    public static void a(LaunchActivity launchActivity, boolean z10, boolean z11) {
        ...
        if (z10 != z12) {
            if (z10) {
                ...
                frameLayout.f14804r = new mg.c(frameLayout, 3);
                ...
                ((GestureDetector) uVar.f13371b).setIsLongpressEnabled(false);
                ci.m6 m6Var = new ci.m6(frameLayout, launchActivity, uVar, 2);
                frameLayout.f14799a = m6Var;
                ...
                frameLayout.addView(m6Var, x5.c(56.0f, 56));
                LinearLayout linearLayout = new LinearLayout(launchActivity);
                frameLayout.f14806w = linearLayout;
                linearLayout.setOrientation(1);
                linearLayout.setVisibility(8);
                TextView textView = new TextView(launchActivity);
                frameLayout.f14807x = textView;
                ...
                f44811a = frameLayout;
                launchActivity.f30827w0.addView((View) frameLayout, new FrameLayout.LayoutParams(-1, -1));
                mg.i iVar2 = f44811a;
                iVar2.f14799a.setVisibility(0);
                o1.k kVar = new o1.k(new o1.j(0.0f));
                kVar.f15326u = org.telegram.ui.Cells.q3.l(1000.0f, 750.0f, 0.75f);
                kVar.b(new ai.qa(2, iVar2));
                kVar.f();
            } else {
                iVar.getClass();
                launchActivity.f30827w0.removeView(f44811a);
                f44811a = null;
            }
            if (z11) {
