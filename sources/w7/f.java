...
public final class f implements ia.e {
    public static final Charset f44666f = Charset.forName("UTF-8");
    public static final ia.c f44667g = new ia.c("key", hg.k0.o(w.f.i(d.class, new a(1))));
    public static final ia.c h = new ia.c("value", hg.k0.o(w.f.i(d.class, new a(2))));
    public static final e f44668i = e.f44652b;
    public OutputStream f44669a;
    public final HashMap f44670b;
    public final HashMap f44671c;
    public final ia.d d;
    ...
    public f(ByteArrayOutputStream byteArrayOutputStream, HashMap hashMap, HashMap hashMap2, ia.d dVar) {
        this.f44669a = byteArrayOutputStream;
        this.f44670b = hashMap;
        this.f44671c = hashMap2;
        this.d = dVar;
    }
    ...
    public final void b(ia.c cVar, double d, boolean z10) {
        ...
        k((i(cVar) << 3) | 1);
        this.f44669a.write(ByteBuffer.allocate(8).order(ByteOrder.LITTLE_ENDIAN).putDouble(d).array());
    }
        ...
        if (obj != null) {
            if (obj instanceof CharSequence) {
                ...
                if (!z10 || charSequence.length() != 0) {
                    k((i(cVar) << 3) | 2);
                    byte[] bytes = charSequence.toString().getBytes(f44666f);
                    k(bytes.length);
                ...
                if (!z10 || floatValue != 0.0f) {
                    k((i(cVar) << 3) | 5);
                    this.f44669a.write(ByteBuffer.allocate(4).order(ByteOrder.LITTLE_ENDIAN).putFloat(floatValue).array());
                }
                ...
                ia.d dVar2 = (ia.d) this.f44670b.get(obj.getClass());
                if (dVar2 != null) {
                    j(dVar2, cVar, obj, z10);
                    return;
                }
                ia.f fVar = (ia.f) this.f44671c.get(obj.getClass());
                if (fVar != null) {
                    la.h hVar = this.e;
                    hVar.f13955b = false;
                    hVar.d = cVar;
