...
public final class f implements ia.e {
    public static final Charset f44943f = Charset.forName("UTF-8");
    public static final ia.c f44944g = new ia.c("key", hg.k0.n(v7.j0.j(d.class, new a(1))));
    public static final ia.c h = new ia.c("value", hg.k0.n(v7.j0.j(d.class, new a(2))));
    public static final e f44945i = e.f44930b;
    public OutputStream f44946a;
    public final HashMap f44947b;
    public final HashMap f44948c;
    public final ia.d d;
    ...
    public f(ByteArrayOutputStream byteArrayOutputStream, HashMap hashMap, HashMap hashMap2, ia.d dVar) {
        this.f44946a = byteArrayOutputStream;
        this.f44947b = hashMap;
        this.f44948c = hashMap2;
        this.d = dVar;
    }
    ...
    public final void b(ia.c cVar, double d, boolean z10) {
        ...
        k((i(cVar) << 3) | 1);
        this.f44946a.write(ByteBuffer.allocate(8).order(ByteOrder.LITTLE_ENDIAN).putDouble(d).array());
    }
        ...
        if (obj != null) {
            if (obj instanceof CharSequence) {
                ...
                if (!z10 || charSequence.length() != 0) {
                    k((i(cVar) << 3) | 2);
                    byte[] bytes = charSequence.toString().getBytes(f44943f);
                    k(bytes.length);
                    this.f44946a.write(bytes);
                }
                ...
                if (!z10 || floatValue != 0.0f) {
                    k((i(cVar) << 3) | 5);
                    this.f44946a.write(ByteBuffer.allocate(4).order(ByteOrder.LITTLE_ENDIAN).putFloat(floatValue).array());
                }
                ...
                k((i(cVar) << 3) | 2);
                k(bArr.length);
                this.f44946a.write(bArr);
            } else {
                ia.d dVar2 = (ia.d) this.f44947b.get(obj.getClass());
                if (dVar2 != null) {
                    j(dVar2, cVar, obj, z10);
                    return;
                }
                ia.f fVar = (ia.f) this.f44948c.get(obj.getClass());
                if (fVar != null) {
                    la.h hVar = this.e;
                    hVar.f14140b = false;
                    hVar.d = cVar;
    ...
    public final void j(ia.d dVar, ia.c cVar, Object obj, boolean z10) {
        ...
        bVar.f14129b = 0L;
        try {
            OutputStream outputStream = this.f44946a;
            this.f44946a = bVar;
            dVar.a(obj, this);
            this.f44946a = outputStream;
