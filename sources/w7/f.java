...
public final class f implements ia.e {
    public static final Charset f48093f = Charset.forName("UTF-8");
    public static final ia.c f48094g = new ia.c("key", i2.g.n(w.f.i(d.class, new a(1))));
    public static final ia.c h = new ia.c("value", i2.g.n(w.f.i(d.class, new a(2))));
    public static final e f48095i = e.f48078b;
    public OutputStream f48096a;
    public final HashMap f48097b;
    public final HashMap f48098c;
    public final ia.d d;
    public final la.h f48099e = new la.h(this, 2);

    public f(ByteArrayOutputStream byteArrayOutputStream, HashMap hashMap, HashMap hashMap2, ia.d dVar) {
        this.f48096a = byteArrayOutputStream;
        this.f48097b = hashMap;
        this.f48098c = hashMap2;
        this.d = dVar;
    }
    ...
    public final void b(ia.c cVar, double d, boolean z10) {
        ...
        k((i(cVar) << 3) | 1);
        this.f48096a.write(ByteBuffer.allocate(8).order(ByteOrder.LITTLE_ENDIAN).putDouble(d).array());
    }
        ...
        if (obj != null) {
            if (obj instanceof CharSequence) {
                ...
                if (!z10 || charSequence.length() != 0) {
                    k((i(cVar) << 3) | 2);
                    byte[] bytes = charSequence.toString().getBytes(f48093f);
                    k(bytes.length);
                    this.f48096a.write(bytes);
                }
                ...
                if (!z10 || floatValue != 0.0f) {
                    k((i(cVar) << 3) | 5);
                    this.f48096a.write(ByteBuffer.allocate(4).order(ByteOrder.LITTLE_ENDIAN).putFloat(floatValue).array());
                }
                ...
                k((i(cVar) << 3) | 2);
                k(bArr.length);
                this.f48096a.write(bArr);
            } else {
                ia.d dVar2 = (ia.d) this.f48097b.get(obj.getClass());
                if (dVar2 != null) {
                    j(dVar2, cVar, obj, z10);
                    return;
                }
                ia.f fVar = (ia.f) this.f48098c.get(obj.getClass());
                if (fVar != null) {
                    la.h hVar = this.f48099e;
                    hVar.f15334b = false;
                    hVar.d = cVar;
                    hVar.f15335c = z10;
                    fVar.a(obj, hVar);
    ...
    public final void j(ia.d dVar, ia.c cVar, Object obj, boolean z10) {
        ...
        bVar.f15322b = 0L;
        try {
            OutputStream outputStream = this.f48096a;
            this.f48096a = bVar;
            dVar.a(obj, this);
            this.f48096a = outputStream;
