...
public final class f implements ia.e {
    public static final Charset f48121f = Charset.forName("UTF-8");
    public static final ia.c f48122g = new ia.c("key", i2.g.n(w.f.i(d.class, new a(1))));
    public static final ia.c h = new ia.c("value", i2.g.n(w.f.i(d.class, new a(2))));
    public static final e f48123i = e.f48106b;
    public OutputStream f48124a;
    public final HashMap f48125b;
    public final HashMap f48126c;
    public final ia.d d;
    public final la.h f48127e = new la.h(this, 2);

    public f(ByteArrayOutputStream byteArrayOutputStream, HashMap hashMap, HashMap hashMap2, ia.d dVar) {
        this.f48124a = byteArrayOutputStream;
        this.f48125b = hashMap;
        this.f48126c = hashMap2;
        this.d = dVar;
    }
    ...
    public final void b(ia.c cVar, double d, boolean z10) {
        ...
        k((i(cVar) << 3) | 1);
        this.f48124a.write(ByteBuffer.allocate(8).order(ByteOrder.LITTLE_ENDIAN).putDouble(d).array());
    }
        ...
        if (obj != null) {
            if (obj instanceof CharSequence) {
                ...
                if (!z10 || charSequence.length() != 0) {
                    k((i(cVar) << 3) | 2);
                    byte[] bytes = charSequence.toString().getBytes(f48121f);
                    k(bytes.length);
                    this.f48124a.write(bytes);
                }
                ...
                if (!z10 || floatValue != 0.0f) {
                    k((i(cVar) << 3) | 5);
                    this.f48124a.write(ByteBuffer.allocate(4).order(ByteOrder.LITTLE_ENDIAN).putFloat(floatValue).array());
                }
                ...
                k((i(cVar) << 3) | 2);
                k(bArr.length);
                this.f48124a.write(bArr);
            } else {
                ia.d dVar2 = (ia.d) this.f48125b.get(obj.getClass());
                if (dVar2 != null) {
                    j(dVar2, cVar, obj, z10);
                    return;
                }
                ia.f fVar = (ia.f) this.f48126c.get(obj.getClass());
                if (fVar != null) {
                    la.h hVar = this.f48127e;
                    hVar.f15361b = false;
                    hVar.d = cVar;
                    hVar.f15362c = z10;
                    fVar.a(obj, hVar);
    ...
    public final void j(ia.d dVar, ia.c cVar, Object obj, boolean z10) {
        ...
        bVar.f15349b = 0L;
        try {
            OutputStream outputStream = this.f48124a;
            this.f48124a = bVar;
            dVar.a(obj, this);
            this.f48124a = outputStream;
