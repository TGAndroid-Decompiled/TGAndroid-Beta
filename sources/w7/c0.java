    ...
    public static void a(LaunchActivity launchActivity, boolean z10, boolean z11) {
        ...
        if (z10 != z12) {
            if (z10) {
                ...
                frameLayout.f16751w = linearLayout;
                linearLayout.setOrientation(1);
                linearLayout.setVisibility(8);
                TextView textView = new TextView(launchActivity);
                frameLayout.f16752x = textView;
                ...
                f48063a = frameLayout;
                launchActivity.f33465w0.addView((View) frameLayout, new FrameLayout.LayoutParams(-1, -1));
                ng.i iVar2 = f48063a;
                iVar2.f16743a.setVisibility(0);
                o1.k kVar = new o1.k(new o1.j(0.0f));
                kVar.f16825u = org.telegram.ui.Cells.p6.l(1000.0f, 750.0f, 0.75f);
                kVar.b(new bi.x9(2, iVar2));
                kVar.f();
            } else {
                iVar.getClass();
                launchActivity.f33465w0.removeView(f48063a);
                f48063a = null;
            }
            if (z11) {
