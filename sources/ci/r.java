...
public abstract class r extends m {
    ...
    public Drawable Y0;
    public boolean Z0;
    public final q f5395a1;
    public final org.telegram.ui.Components.o6 f5396b1;
    public float f5397c1;
    public float f5398d1;
    public long f5399e1;
    public final Paint f5400f1;
    public final Paint f5401g1;
    public final org.telegram.ui.Components.ba f5402h1;
    public final org.telegram.ui.Components.ba f5403i1;
    public final Drawable f5404j1;
    public float f5405k1;
    public final org.telegram.ui.Components.e6 l1;
    public final Path f5406m1;
    public final Path f5407n1;
    public final Paint f5408o1;
    public final Paint f5409p1;
    public final Paint f5410q1;
    public final Paint f5411r1;
    public final org.telegram.ui.Components.e6 f5412s1;
    public final RectF f5413t1;
    ...
    public r(Context context, FrameLayout frameLayout, aw0 aw0Var, FrameLayout frameLayout2, ai.d dVar, org.telegram.ui.Components.ja jaVar) {
        ...
        baVar.f22925a = AndroidUtilities.dp(47.0f);
        baVar.f22926b = AndroidUtilities.dp(55.0f);
        baVar.b();
        baVar2.f22925a = AndroidUtilities.dp(47.0f);
        baVar2.f22926b = AndroidUtilities.dp(55.0f);
        baVar2.b();
        ...
        this.f5409p1 = new Paint(1);
        this.f5410q1 = new Paint(1);
    ...
    public final void B() {
        if (this.Z0) {
            ...
            alertDialog$Builder.f18647a.R = LocaleController.getString(R.string.StoryRemoveRoundTitle);
            alertDialog$Builder.f18647a.T = LocaleController.getString(R.string.StoryRemoveRoundMessage);
            alertDialog$Builder.k(LocaleController.getString(R.string.Remove), new a1.c(this, 14));
            alertDialog$Builder.h(LocaleController.getString(R.string.Cancel), null);
            TextView textView = (TextView) alertDialog$Builder.o().d(-1);
            if (textView != null) {
                textView.setTextColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19284q7, this.f5113a));
            }
        }
    }
    ...
    public final void j(Canvas canvas, RectF rectF) {
        ...
        if (this.D1 != null) {
            ...
            if (this.f5399e1 <= 0) {
                this.f5399e1 = System.currentTimeMillis();
            }
            float sin = (((float) Math.sin((((float) (System.currentTimeMillis() - this.f5399e1)) / 900.0f) * 3.141592653589793d)) + 1.0f) / 2.0f;
            ...
            org.telegram.ui.Components.o6 o6Var = this.f5396b1;
            ...
            o6Var.f26942w = (int) ((1.0f - e) * 255.0f);
            o6Var.draw(canvas3);
            float f14 = 1.0f - e7;
            ...
            if (f7 > 0.0f) {
                ...
                if (this.f5418y1 == null) {
                    ...
                    this.f5418y1.lineTo(0.0f, AndroidUtilities.dp(5.0f));
                    this.f5418y1.lineTo(AndroidUtilities.dp(3.83f), AndroidUtilities.dp(f10));
                    Paint paint2 = new Paint(1);
                    this.f5419z1 = paint2;
                    paint2.setStyle(Paint.Style.STROKE);
                    this.f5419z1.setStrokeCap(Paint.Cap.ROUND);
                    this.f5419z1.setStrokeJoin(Paint.Join.ROUND);
                }
                this.f5419z1.setStrokeWidth(AndroidUtilities.dp(1.33f));
                this.f5417x1.f28367p = (int) ((rectF.width() - AndroidUtilities.dp(116.0f)) - o6Var.d());
                ...
                int l1 = org.telegram.ui.ActionBar.h6.l1(f7, i10);
                canvas3.save();
                canvas3.translate(b11, rectF.centerY() - AndroidUtilities.dp(5.0f));
                this.f5419z1.setColor(l1);
                canvas3.drawPath(this.f5418y1, this.f5419z1);
                canvas3.restore();
                f12 = 15.0f;
                f13 = 0.0f;
                this.f5417x1.c(b11 + AndroidUtilities.dp(11.33f), rectF.centerY(), 1.0f, l1, canvas3);
            } else {
                f12 = 15.0f;
                f13 = 0.0f;
            }
            if (e7 > f13) {
                ...
                this.A1.f28367p = (int) ((rectF.width() - AndroidUtilities.dp(116.0f)) - o6Var.d());
                float width = ((rectF.width() / 4.0f) * f14) + (rectF.centerX() - (this.A1.l() / 2.0f));
                if (paint != null) {
                    i15 = -1;
                }
                canvas2 = canvas;
                this.A1.c(width, rectF.centerY(), 1.0f, org.telegram.ui.ActionBar.h6.l1(e7, i15), canvas2);
                this.f5414u1.set(width - AndroidUtilities.dp(f11), rectF.top, this.A1.l() + width + AndroidUtilities.dp(f11), rectF.bottom);
            } else {
                canvas2 = canvas;
            }
            if (paint != null) {
    ...
    public final void k(Canvas canvas, RectF rectF, float f7) {
        ...
        float d = this.l1.d(this.f5405k1, false);
        float z13 = com.google.android.gms.internal.vision.e2.z(1.0f, this.f5397c1, AndroidUtilities.dp(30.0f) * d, AndroidUtilities.dp(41.0f));
        float f18 = 1.0f - e;
        float f19 = z13 * f18 * f7;
        float lerp = AndroidUtilities.lerp(com.google.android.gms.internal.vision.e2.b(1.0f, e7, getWidth() * 0.35f * this.f5397c1, rectF.right - AndroidUtilities.dp(20.0f)), rectF.left + AndroidUtilities.dp(20.0f), e);
        ...
        if (isEnabled) {
            ...
            f12 = 0.0f;
            baVar.f22926b = (AndroidUtilities.dp(15.0f) * 0.6f) + AndroidUtilities.dp(47.0f);
            f10 = e7;
            org.telegram.ui.Components.ba baVar2 = this.f5403i1;
            baVar2.f22925a = AndroidUtilities.dp(50.0f);
            Paint paint3 = baVar2.d;
            f11 = f18;
            baVar2.f22926b = (AndroidUtilities.dp(12.0f) * 0.6f) + AndroidUtilities.dp(50.0f);
            baVar2.e(d, 1.01f);
            baVar.e(d, 1.02f);
            paint3.setColor(org.telegram.ui.ActionBar.h6.l1(0.15f * f7, paint.getColor()));
            canvas.save();
            float f20 = f19 / baVar2.f22925a;
        ...
        canvas.save();
        Path path = this.f5406m1;
        path.rewind();
        Path.Direction direction = Path.Direction.CW;
        path.addCircle(lerp, dp, min, direction);
        canvas.clipPath(path);
        Drawable drawable = this.f5404j1;
        ...
        canvas.restore();
        float f24 = e6Var.f23817c;
        float f25 = e6Var2.f23817c;
        if (this.f5397c1 < 0.4f) {
            z10 = true;
        } else {
            z10 = false;
        }
        float z14 = org.telegram.messenger.f0.z(1.0f, f24, AndroidUtilities.lerp(this.f5412s1.e(z10), 0.0f, f25), f7);
        ...
        float f26 = 1.0f - f25;
        float lerp3 = AndroidUtilities.lerp(((rectF.bottom - AndroidUtilities.dp(80.0f)) - lerp2) - ((AndroidUtilities.dp(120.0f) * this.f5398d1) * f26), rectF.bottom - AndroidUtilities.dp(20.0f), 1.0f - z14);
        float dp3 = (AndroidUtilities.dp(36.0f) * z14) / 2.0f;
        RectF rectF3 = this.f5413t1;
        ...
        int l1 = org.telegram.ui.ActionBar.h6.l1(z14, 536870912);
        Paint paint4 = this.f5409p1;
        ...
        int l12 = org.telegram.ui.ActionBar.h6.l1(z14, -1);
        Paint paint7 = this.f5410q1;
        paint7.setColor(l12);
        int l13 = org.telegram.ui.ActionBar.h6.l1(z14 * f26, -1);
        Paint paint8 = this.f5411r1;
        paint8.setColor(l13);
        float dp4 = (AndroidUtilities.dp(4.0f) * f26) + lerp3;
        canvas.rotate(this.f5398d1 * 12.0f * f26, dp2, dp4);
        ...
        if (f25 < 1.0f) {
            canvas.save();
            canvas.rotate(this.f5398d1 * 12.0f * f26, dp2, f27);
            canvas.translate(0.0f, lerp6 * f25);
            canvas.scale(f26, f26, dp2, f27);
            Path path2 = this.f5416w1;
            path2.rewind();
            ...
            path2.lineTo(f29, (AndroidUtilities.lerp(AndroidUtilities.lerp(0.4f, 0.0f, this.f5398d1), 1.0f, f25) * AndroidUtilities.dp(3.66f)) + dp6);
        ...
        if (this.K1) {
            ...
            if (visibility == 4 || imageView2.getVisibility() == 4 || e6Var3.f23817c > 0.0f) {
                ...
                if (imageView.getVisibility() == 4 || e6Var3.f23817c > 0.0f) {
                    canvas.save();
                    canvas.translate((AndroidUtilities.dp(180.0f) * f11) + imageView.getX(), imageView.getY());
                    imageView.draw(canvas);
                    canvas.restore();
                }
                if (imageView2.getVisibility() == 4 || e6Var3.f23817c > 0.0f) {
                    canvas.save();
    ...
    public void setAmplitude(double d) {
        this.f5405k1 = (float) (Math.min(1800.0d, d) / 1800.0d);
        invalidate();
    }
    ...
    public final void z(boolean z10, boolean z11) {
        ...
        this.O1 = false;
        this.K0 = false;
        this.L0 = (int) ((getBounds().right - AndroidUtilities.dp(20.0f)) - ((getWidth() * 0.35f) * this.f5397c1));
        invalidate();
        p pVar = this.D1;
        if (pVar != null) {
            if (!z10) {
                if (z11) {
                    ...
                    CameraController.getInstance().stopVideoRecording(pVar.f5243a.getCameraSessionRecording(), false, false);
                    pVar.a(false);
                } else {
                    pVar.c();
                }
