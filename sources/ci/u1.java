    ...
    public final void run() {
        ...
        switch (i21) {
            ...
            case 15:
                ...
                if (TextUtils.equals(maVar.f26119a, (String) obj4)) {
                    maVar.f26122f = null;
                    Bitmap bitmap4 = maVar.f26120b;
                    if (bitmap4 != null) {
                        bitmap4.recycle();
                    }
                    maVar.f26120b = bitmap2;
            ...
            case 17:
                ...
                syVar.f27957a.remove(str4);
                kz kzVar = syVar.f27958b;
                py pyVar = kzVar.f25737j0;
                HashMap hashMap = kzVar.f25743l0;
                boolean z13 = pyVar.v;
                boolean z14 = this.f5601b;
                if (z13 && pyVar.f27159w.equals(str3)) {
                    kzVar.f25737j0.E(str3, "", false, true, z14, str4, tLObject4);
                    return;
            ...
            case 19:
                ...
                if (tL_error == null) {
                    ...
                    if (closestPhotoSizeWithSize != null && wyVar.f39209b4 != null) {
                        ...
                        FileLoader.getInstance(i19).getPathToAttach(wyVar.f39209b4, true).renameTo(pathToAttach2);
                        StringBuilder sb2 = new StringBuilder();
                        sb2.append(wyVar.f39209b4.volume_id);
                        sb2.append("_");
                        String n10 = a4.a.n(wyVar.f39209b4.local_id, "@50_50", sb2);
                    ...
                    if (closestVideoSizeWithSize != null && str5 != null) {
                    ...
                    } else if (closestPhotoSizeWithSize2 != null && wyVar.f39215c4 != null) {
                        ...
                        FileLoader.getInstance(i16).getPathToAttach(wyVar.f39215c4, true).renameTo(pathToAttach3);
                    }
                ...
                if (ocVar2 != null) {
                    ...
                    org.telegram.ui.Components.oc ocVar3 = wyVar.f39220d4;
                    ocVar3.f26705j = 5000;
                    ocVar3.i(false);
                    wyVar.f39220d4.i(true);
                    return;
                }
                return;
            case 20:
