...
public abstract class q7 extends FrameLayout {
    public float E;
    public final p7 f5344a;
    public final File f5345b;
    public long f5346c;
    public long d;
    public final Paint e;
    public final Paint f5347f;
    public final m7 h;
    public ai.q0 f5348n;
    public n f5349r;
    public float f5350s;
    public qg.e2 v;
    public ValueAnimator f5351w;
    public boolean f5352x;
    public ValueAnimator f5353y;
    ...
    public q7(Context context) {
        ...
        this.f5345b = o8.x(UserConfig.selectedAccount, true);
    ...
    public final void a(boolean z10) {
        ...
        ValueAnimator valueAnimator = this.f5353y;
        ...
        this.f5353y.addListener(new ai.b(this, 17));
        this.f5353y.setInterpolator(qr.h);
        this.f5353y.setDuration(280L);
        this.f5353y.start();
    }
    ...
    public final long b() {
        ...
        return Math.min(59500L, j3 - this.f5346c);
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        int l1 = org.telegram.ui.ActionBar.i6.l1(this.f5350s, 536870912);
        Paint paint = this.e;
        paint.setShadowLayer(AndroidUtilities.dp(2.0f), 0.0f, AndroidUtilities.dp(0.66f), l1);
        paint.setAlpha((int) (this.f5350s * 255.0f));
        ...
        if (e2Var != null && e2Var.getWidth() > 0 && this.v.getHeight() > 0) {
            ...
            this.v.setDraw(true);
            this.v.setAlpha(1.0f - this.f5350s);
            this.v.draw(canvas);
        ...
        if (this.f5346c > 0) {
            ...
            Paint paint2 = this.f5347f;
            paint2.setStrokeWidth(AndroidUtilities.dp(3.33f));
            paint2.setColor(org.telegram.ui.ActionBar.i6.l1(this.f5350s, -1090519041));
            paint2.setShadowLayer(AndroidUtilities.dp(1.0f), 0.0f, AndroidUtilities.dp(0.33f), org.telegram.ui.ActionBar.i6.l1(this.f5350s, 536870912));
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f5344a.measure(View.MeasureSpec.makeMeasureSpec(min, 1073741824), View.MeasureSpec.makeMeasureSpec(min, 1073741824));
