...
public abstract class q7 extends FrameLayout {
    public float E;
    public final p7 f5348a;
    public final File f5349b;
    public long f5350c;
    public long d;
    ...
    public float f5354s;
    public qg.c2 v;
    public ValueAnimator f5355w;
    public boolean f5356x;
    public ValueAnimator f5357y;
    ...
    public q7(Context context) {
        ...
        this.f5349b = o8.x(UserConfig.selectedAccount, true);
    ...
    public final void a(boolean z10) {
        ...
        ValueAnimator valueAnimator = this.f5357y;
        ...
        this.f5357y.addListener(new ai.b(this, 17));
        this.f5357y.setInterpolator(qr.h);
        this.f5357y.setDuration(280L);
        this.f5357y.start();
    }
    ...
    public final long b() {
        ...
        return Math.min(59500L, j3 - this.f5350c);
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        int l1 = org.telegram.ui.ActionBar.j6.l1(this.f5354s, 536870912);
        Paint paint = this.e;
        paint.setShadowLayer(AndroidUtilities.dp(2.0f), 0.0f, AndroidUtilities.dp(0.66f), l1);
        paint.setAlpha((int) (this.f5354s * 255.0f));
        ...
        if (c2Var != null && c2Var.getWidth() > 0 && this.v.getHeight() > 0) {
            ...
            this.v.setDraw(true);
            this.v.setAlpha(1.0f - this.f5354s);
            this.v.draw(canvas);
        ...
        if (this.f5350c > 0) {
            ...
            Paint paint2 = this.f5351f;
            paint2.setStrokeWidth(AndroidUtilities.dp(3.33f));
            paint2.setColor(org.telegram.ui.ActionBar.j6.l1(this.f5354s, -1090519041));
            paint2.setShadowLayer(AndroidUtilities.dp(1.0f), 0.0f, AndroidUtilities.dp(0.33f), org.telegram.ui.ActionBar.j6.l1(this.f5354s, 536870912));
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f5348a.measure(View.MeasureSpec.makeMeasureSpec(min, 1073741824), View.MeasureSpec.makeMeasureSpec(min, 1073741824));
