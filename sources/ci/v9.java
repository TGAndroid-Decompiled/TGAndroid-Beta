        ...
        switch (this.f5665a) {
            ...
            case 2:
                ...
                if (i10 == 0) {
                    ...
                    if (((viVar.f28730b2[0] - backgroundPaddingTop) - i12) + backgroundPaddingTop < (viVar.O0.getAlpha() * viVar.O0.getMeasuredHeight()) + org.telegram.ui.ActionBar.k.getCurrentActionBarHeight() && (wk0Var = (wk0) tlVar.L(0)) != null) {
    ...
    public final void b(RecyclerView recyclerView, int i10, int i11) {
        ...
        switch (this.f5665a) {
            ...
            case 1:
                ...
                boolean z12 = false;
                if (!a7Var.f31734b.canScrollVertically(-1) && !org.telegram.ui.a7.i0(a7Var).s()) {
                    z10 = false;
                } else {
                    z10 = true;
                }
                ...
                org.telegram.ui.x6 x6Var = i6Var.f29663z0;
                if (x6Var != null && x6Var.isAttachedToWindow() && i6Var.f29663z0.getTop() <= i6Var.E0) {
                    z11 = true;
                } else {
                    z11 = false;
                }
                if (z13 != z11) {
                    ...
                    org.telegram.ui.x6 x6Var2 = i6Var2.f29663z0;
                    if (x6Var2 != null && x6Var2.isAttachedToWindow() && i6Var2.f29663z0.getTop() <= i6Var2.E0) {
                        z12 = true;
                    }
                    this.f5666b = z12;
                    a7Var.Z.invalidate();
