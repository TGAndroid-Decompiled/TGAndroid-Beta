...
public final class u6 extends View {
    public final Paint f5623a;
    public final Paint f5624b;
    public final StaticLayout f5625c;
    ...
    public u6(v6 v6Var, Context context, String str, boolean z10) {
        ...
        this.f5626f = dp;
        if (!z10) {
            this.f5626f = Math.max(AndroidUtilities.dp(80.0f), dp);
        }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float d = this.f5628r.d(f7, false);
        ...
        canvas.drawRect(AndroidUtilities.dp(25.0f), AndroidUtilities.dp(4.0f), getWidth() - AndroidUtilities.dp(25.0f), getHeight() - AndroidUtilities.dp(4.0f), this.f5624b);
        ...
        canvas.drawRoundRect(rectF, AndroidUtilities.dp(20.0f), AndroidUtilities.dp(20.0f), this.f5623a);
        canvas.save();
        float f13 = (this.f5626f - this.e) / 2.0f;
        if (this.f5627n) {
            f10 = 3.0f;
        }
        float dp = (f13 + AndroidUtilities.dp(f10)) - this.d;
        int height = getHeight();
        StaticLayout staticLayout = this.f5625c;
    ...
    public final void onMeasure(int i10, int i11) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(this.f5626f, 1073741824), View.MeasureSpec.makeMeasureSpec(this.h, 1073741824));
    }
    ...
    public final void setPressed(boolean z10) {
        ...
        if (isPressed() != z10) {
            ...
            invalidate();
            if (z10 && (valueAnimator = this.f5630w) != null) {
            ...
            if (!z10) {
                ...
                if (f7 != 0.0f) {
                    ...
                    this.f5630w.addListener(new ai.b(this, 16));
                    this.f5630w.setInterpolator(new OvershootInterpolator(1.5f));
                    this.f5630w.setDuration(350L);
                    this.f5630w.start();
                }
            }
        }
