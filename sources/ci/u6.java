...
public final class u6 extends View {
    ...
    public final Paint f5619b;
    public final StaticLayout f5620c;
    public final float d;
    public final float e;
    public final int f5621f;
    public final int h;
    public final boolean f5622n;
    public final org.telegram.ui.Components.c6 f5623r;
    public boolean f5624s;
    public float v;
    public ValueAnimator f5625w;
    public final v6 f5626x;
    ...
    public u6(v6 v6Var, Context context, String str, boolean z10) {
        ...
        this.f5619b = paint2;
        this.f5623r = new org.telegram.ui.Components.c6(this, 0L, 220L, qr.h);
        this.f5624s = true;
        this.f5622n = z10;
        ...
        this.f5621f = dp;
        if (!z10) {
            this.f5621f = Math.max(AndroidUtilities.dp(80.0f), dp);
        }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float d = this.f5623r.d(f7, false);
        ...
        canvas.drawRect(AndroidUtilities.dp(25.0f), AndroidUtilities.dp(4.0f), getWidth() - AndroidUtilities.dp(25.0f), getHeight() - AndroidUtilities.dp(4.0f), this.f5619b);
        ...
        canvas.drawRoundRect(rectF, AndroidUtilities.dp(20.0f), AndroidUtilities.dp(20.0f), this.f5618a);
        canvas.save();
        float f13 = (this.f5621f - this.e) / 2.0f;
        if (this.f5622n) {
            f10 = 3.0f;
        }
        float dp = (f13 + AndroidUtilities.dp(f10)) - this.d;
        int height = getHeight();
        StaticLayout staticLayout = this.f5620c;
    ...
    public final void onMeasure(int i10, int i11) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(this.f5621f, 1073741824), View.MeasureSpec.makeMeasureSpec(this.h, 1073741824));
    }
    ...
    public final void setPressed(boolean z10) {
        ...
        if (isPressed() != z10) {
            ...
            invalidate();
            if (z10 && (valueAnimator = this.f5625w) != null) {
            ...
            if (!z10) {
                ...
                if (f7 != 0.0f) {
                    ...
                    this.f5625w.addListener(new ai.b(this, 16));
                    this.f5625w.setInterpolator(new OvershootInterpolator(1.5f));
                    this.f5625w.setDuration(350L);
                    this.f5625w.start();
                }
            }
        }
