...
public final class cd extends View {
    public final xi0 f4438a;
    public final org.telegram.ui.Components.m6 f4439b;
    public final Paint f4440c;
    ...
    public final void a(boolean z10, boolean z11) {
        ...
        boolean z12 = true;
        this.f4439b.q(LocaleController.getString(i10), true, true);
        int i11 = 0;
        z12 = (!z10 || z11) ? false : false;
        this.f4441f = z12;
        xi0 xi0Var = this.f4438a;
        if (z12) {
            if (xi0Var.f29948b0 > 34) {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        float e = (this.h.e(this.f4441f) * AndroidUtilities.dp(3.0f)) + dp;
        canvas.drawCircle(width, height, e, this.d);
        canvas.drawCircle(width, height, e, this.f4440c);
        ...
        org.telegram.ui.Components.m6 m6Var = this.f4439b;
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        if (drawable != this.f4439b && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
