        ...
        switch (this.f5498a) {
            ...
            case 2:
                ...
                if (i10 == 0) {
                    ...
                    if (((wiVar.f29993b2[0] - backgroundPaddingTop) - i12) + backgroundPaddingTop < (wiVar.O0.getAlpha() * wiVar.O0.getMeasuredHeight()) + org.telegram.ui.ActionBar.k.getCurrentActionBarHeight() && (gl0Var = (gl0) ulVar.K(0)) != null) {
    ...
    public final void b(RecyclerView recyclerView, int i10, int i11) {
        ...
        switch (this.f5498a) {
            ...
            case 1:
                ...
                if (z6Var.f40350c.L0() <= 0 && !org.telegram.ui.z6.a0(z6Var).s()) {
                    z10 = false;
                } else {
                    z10 = true;
                }
