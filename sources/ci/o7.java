...
public final class o7 implements ValueAnimator.AnimatorUpdateListener {
    ...
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        switch (this.f5133a) {
            case 0:
                p pVar = (p) this.f5136f;
                float floatValue = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                p7 p7Var = pVar.f5344a;
                float f7 = this.f5134b;
                float f10 = this.f5135c;
                ...
                return;
            default:
                ig.j jVar = (ig.j) this.f5136f;
                float floatValue2 = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                float f12 = this.f5135c;
                float f13 = this.f5134b;
                jVar.f11184k = com.google.android.gms.internal.vision.e2.z(f12, f13, floatValue2, f13);
                float f14 = this.e;
                float f15 = this.d;
                jVar.f11185l = com.google.android.gms.internal.vision.e2.z(f14, f15, floatValue2, f15);
                jVar.f11177a.a(f12, f14, false);
                return;
        }
    }
}
