...
public final class b4 extends org.telegram.ui.ActionBar.f3 {
    public final a4 f4385b;
    public ValueAnimator f4386c;
    public o1.k d;
    public Boolean e;
    public Utilities.Callback f4387f;
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        if (motionEvent.getAction() == 0 && motionEvent.getY() < this.f4385b.g()) {
            dismiss();
            return true;
        }
    ...
    public final void n(boolean z10, y3 y3Var) {
        ...
        if (z10) {
            o1.k kVar = new o1.k(a4Var, o1.h.f15332n, height);
            this.d = kVar;
            kVar.f15349u.a(0.75f);
            this.d.f15349u.b(350.0f);
        ...
        this.f4386c.addListener(new ai.z(3, this, y3Var));
        this.f4386c.setDuration(450L);
        this.f4386c.setInterpolator(qr.h);
        this.f4386c.start();
    }
