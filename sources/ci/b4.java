...
public final class b4 extends org.telegram.ui.ActionBar.g3 {
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        if (motionEvent.getAction() == 0 && motionEvent.getY() < this.f4388b.g()) {
            dismiss();
            return true;
        }
    ...
    public final void n(boolean z10, y3 y3Var) {
        ...
        this.f4389c.addListener(new ai.z(3, this, y3Var));
        this.f4389c.setDuration(450L);
        this.f4389c.setInterpolator(qr.h);
        this.f4389c.start();
    }
