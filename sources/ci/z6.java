...
public final class z6 implements m8, org.telegram.ui.Components.c5, org.telegram.ui.ActionBar.a2, t5.b, r9.g, t40 {
    ...
    public void J(int i10, int i11, boolean z10) {
        zn.d0((zn) this.f5872c, (ArrayList) this.d, this.f5871b, (mm0) this.e, z10, i10);
    }
    ...
    public void Q(TLRPC.InputFile inputFile, TLRPC.InputFile inputFile2, double d, String str, TLRPC.PhotoSize photoSize, TLRPC.PhotoSize photoSize2, boolean z10, TLRPC.VideoSize videoSize) {
        ...
        znVar.getConnectionsManager().sendRequest(tL_photos_uploadProfilePhoto, new ai.fa(znVar, fileLocationArr, str, fileLocationArr2, this.f5871b));
    }
    ...
    public ScheduledFuture a(final n2.e eVar) {
        switch (this.f5870a) {
            case 5:
                r9.f fVar = (r9.f) this.f5872c;
                return fVar.f42465b.schedule(new r9.d(fVar, (Runnable) this.d, eVar, 1), this.f5871b, (TimeUnit) this.e);
            default:
                final r9.f fVar2 = (r9.f) this.f5872c;
                final Callable callable = (Callable) this.d;
                return fVar2.f42465b.schedule(new Callable() {
                    @Override
                    public final Object call() {
                        return f.this.f42464a.submit(new g1(17, callable, eVar));
                    }
                }, this.f5871b, (TimeUnit) this.e);
        }
    }
    ...
    public Object i() {
        ...
        hVar.c(new ai.z1(((u5.a) bVar.f7585g).q() + this.f5871b, iVar));
        return null;
    }
    ...
    public void k(org.telegram.ui.ActionBar.b2 b2Var, int i10) {
        switch (this.f5870a) {
            case 2:
                ChatObject.Call call = (ChatObject.Call) this.f5872c;
                ...
                i60.w1(call, z10, this.f5871b, runnable);
                return;
            default:
                TLRPC.User user = (TLRPC.User) this.e;
                ProfileActivity profileActivity = ((h01) this.f5872c).f34039b;
