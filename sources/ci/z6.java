    ...
    public ScheduledFuture a(final k2.u uVar) {
        switch (this.f5869a) {
            case 5:
                ...
                return fVar.f42193b.schedule(new r9.d(fVar, (Runnable) this.d, uVar, 1), this.f5870b, (TimeUnit) this.e);
            default:
                final r9.f fVar2 = (r9.f) this.f5871c;
                final Callable callable = (Callable) this.d;
                return fVar2.f42193b.schedule(new Callable() {
                    @Override
                    public final Object call() {
                        return f.this.f42192a.submit(new p2.b(11, callable, uVar));
                    }
    ...
    public void f(org.telegram.ui.ActionBar.c2 c2Var, int i10) {
        switch (this.f5869a) {
            ...
            default:
                ...
                ProfileActivity profileActivity = ((j01) this.f5871c).f34748b;
