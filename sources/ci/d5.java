    ...
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        ...
        switch (i10) {
            case 0:
                ...
                r6Var.A1.f40992a = i0.a.d(floatValue, i12, i11);
                r6Var.T0.invalidate();
                return;
            case 1:
            ...
            case 3:
                ...
                int i13 = ScrollSlidingTextTabStrip.f22175o0;
                float floatValue2 = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                scrollSlidingTextTabStrip.W = i12 * floatValue2;
                scrollSlidingTextTabStrip.f22177a0 = i11 * floatValue2;
                scrollSlidingTextTabStrip.f22176a.invalidate();
                scrollSlidingTextTabStrip.invalidate();
                return;
            case 4:
                float animatedFraction = valueAnimator.getAnimatedFraction();
                wx0 wx0Var = (wx0) ((fm0) obj).f23963b;
                wx0Var.f29769c.setAlpha(animatedFraction);
                wx0Var.h.setAlpha(animatedFraction);
                if (i12 != 0) {
                    int i14 = (int) ((1.0f - animatedFraction) * i12);
                    wx0Var.y0(i11 + i14);
                    wx0Var.f29769c.setTranslationY(i14);
                    return;
                }
                return;
            default:
                ...
                p0Var.K1.f40992a = i0.a.d(floatValue3, i12, i11);
