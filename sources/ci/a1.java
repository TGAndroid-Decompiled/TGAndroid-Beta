...
public final class a1 {
    ...
    public final l8 a() {
        ...
        if (str4 != null) {
            ...
            if (org.telegram.ui.ActionBar.h6.f19257o2 == null) {
                org.telegram.ui.ActionBar.h6.O();
            }
            CharSequence replaceEmoji = Emoji.replaceEmoji(spannableString, org.telegram.ui.ActionBar.h6.f19257o2.getFontMetricsInt(), true);
            MessageObject.addEntitiesToText(replaceEmoji, this.f4334w, true, false, true, false);
            l8Var.C0 = MessageObject.replaceAnimatedEmoji(replaceEmoji, this.f4334w, org.telegram.ui.ActionBar.h6.f19257o2.getFontMetricsInt());
        } else {
            l8Var.C0 = "";
        }
