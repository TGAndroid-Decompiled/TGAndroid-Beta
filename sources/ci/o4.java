    ...
    public final void onClick(View view) {
        ...
        switch (i11) {
            case 0:
                ...
                AndroidUtilities.forEachViews((RecyclerView) fbVar.f5610b, (e2.h) new ai.f3(fbVar, 3));
                return;
            case 1:
                v6 v6Var = ((t6) obj).f5569b;
                if (v6Var.f5660r && (callback = v6Var.f5658f) != null) {
            ...
            case 6:
                ...
                if (i12 != 0) {
                    if (i12 != 1) {
                        if (i12 == 2) {
                            g0Var.f24390f0 = !g0Var.f24390f0;
                        }
                    } else {
                        g0Var.f24389e0 = !g0Var.f24389e0;
                    }
                } else {
                    g0Var.f24388d0 = !g0Var.f24388d0;
                }
                g0Var.X.N(true);
                g0Var.s();
                return;
            ...
            case 8:
                ...
                chatAttachAlertPhotoLayout.f26786b.X0.getActionBarMenuOnItemClick().b(i12);
                chatAttachAlertPhotoLayout.f22179w.M(null, null);
                return;
            case 9:
                ((l30) obj).f25975b.x(i12, true);
                return;
            case 10:
                l30 l30Var = ((k30) obj).f25616c;
                l30Var.n(i12);
                l30Var.dismiss();
                return;
            case 11:
                ...
                if (pd0Var.e.getAdapter() instanceof nd0) {
                    kz kzVar = ((ey) ((nd0) pd0Var.e.getAdapter())).f24056c;
                    if ((i12 == 1 || i12 == 2) && kzVar.f25921w1) {
                        if (i12 == 1) {
                            z10 = true;
                        } else {
                            z10 = false;
            ...
            case 12:
                ...
                EditTextBoldCursor editTextBoldCursor = p4Var.f24857c;
            ...
            case 13:
                ...
                scrollSlidingTextTabStrip.h(view, i12, scrollSlidingTextTabStrip.f22403a.indexOfChild(view));
                return;
            case 14:
                b71 b71Var = (b71) obj;
                int i13 = b71Var.f22911b.f22367i.f23634q;
                if (i13 == 2) {
            ...
            case 15:
                ((org.telegram.ui.Components.voip.x0) obj).f29706b.x(i12, true);
                return;
            case 16:
                mi1 mi1Var = (mi1) obj;
            ...
            case 18:
                p80 p80Var = (p80) obj;
                p80Var.Q.dismiss();
                int i14 = p80Var.f36519c0;
                if (i14 >= 0) {
                    p80Var.f36520d0.setKeepMedia(i14, i12);
                    n80 n80Var = p80Var.f36521e0;
                    if (n80Var != null) {
                        n80Var.a(i12);
                        return;
                    }
            ...
            case 19:
                gh0 gh0Var = (gh0) obj;
                ValueAnimator valueAnimator = gh0Var.f32123c.R;
            ...
            case 20:
                ...
                pn0Var.S0 = i12;
                if (i12 == 1) {
                    pn0Var.f36644i0 = pn0Var.f36640g0;
                } else if (i12 == 4) {
                    pn0Var.f36644i0 = pn0Var.f36642h0;
                } else if (i12 == 2) {
                    pn0Var.f36644i0 = pn0Var.f36635e0;
                } else if (i12 == 3) {
                    pn0Var.f36644i0 = pn0Var.f36638f0;
                } else {
                    pn0Var.f36644i0 = pn0Var.f36633d0;
                }
                SecureDocument secureDocument = (SecureDocument) view.getTag();
                PhotoViewer.t1().J2(null, pn0Var, null);
                if (i12 == 1) {
                    ArrayList arrayList = new ArrayList();
                    arrayList.add(pn0Var.f36647j1);
            ...
            case 21:
                ...
                lq0Var.V(lq0Var.f35529b, lq0Var.f35530c, true, 0);
            ...
            case 24:
                ...
                if (i12 == 0) {
                    ...
                    if (!l01Var.C1) {
                        if (lv0.w0(l01Var.getClosestTab())) {
                            ...
                            E.f5277x = new k01(profileActivity);
                            E.R(null);
                            return;
                        }
                    }
                ...
                if (lv0.w0(profileActivity.O.getClosestTab())) {
                    ...
                    org.telegram.messenger.t8 t8Var = profileActivity.f31710x5;
                    if (t8Var != null) {
                        t8Var.run();
                        profileActivity.f31710x5 = null;
                    }
                ...
                org.telegram.messenger.t8 t8Var2 = profileActivity.f31710x5;
                if (t8Var2 != null) {
                    t8Var2.run();
                    profileActivity.f31710x5 = null;
                }
                ...
                if (!arrayList7.isEmpty()) {
                    ...
                    boolean[] zArr3 = {false};
                    boolean z14 = z11;
                    profileActivity.f31710x5 = new org.telegram.messenger.t8(profileActivity, clientUserId, arrayList7, z11, 9);
            ...
            case 25:
                bb1 bb1Var = (bb1) obj;
                bb1Var.f32343i0.E(i12);
                bb1Var.m0(i12, true);
                return;
            case 26:
                yh.r0 r0Var = ((yh.s0) obj).f48037j0;
                int i19 = yh.r0.f48001s;
                r0Var.a(i12);
                return;
            default:
                ((yh.r0) obj).a(i12);
