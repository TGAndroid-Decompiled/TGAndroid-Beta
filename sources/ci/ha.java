...
public final class ha extends FrameLayout {
    public Path E;
    public Paint F;
    public final org.telegram.ui.ActionBar.e6 f4753a;
    public final org.telegram.ui.Components.f9 f4754b;
    public final org.telegram.ui.Components.u9 f4755c;
    public final org.telegram.ui.ActionBar.j5 d;
    public final org.telegram.ui.ActionBar.j5 e;
    public final np f4756f;
    public final RadioButton h;
    public final Paint f4757n;
    ...
    public ha(Context context, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        this.f4754b = f9Var;
        this.f4757n = new Paint(1);
        this.f4758r = false;
        this.f4759s = true;
        this.v = true;
        this.f4760w = new boolean[1];
        this.f4753a = e6Var;
        f9Var.f23869r = AndroidUtilities.dp(40.0f);
        ...
        int i13 = org.telegram.ui.ActionBar.i6.f18945j7;
        npVar.b(i12, i13, org.telegram.ui.ActionBar.i6.C5);
    ...
    public final void a(int i10, TLRPC.Chat chat) {
        ...
        this.f4761x = j3;
        org.telegram.ui.Components.f9 f9Var = this.f4754b;
        f9Var.q(chat);
        ...
        if (zArr[0]) {
            i11 = org.telegram.ui.ActionBar.i6.f19020n5;
        } else {
            i11 = org.telegram.ui.ActionBar.i6.f19091r5;
        }
        this.e.setTextColor(org.telegram.ui.ActionBar.i6.v0(i11, this.f4753a));
        if (this.f4759s) {
            i12 = 0;
        } else {
            i12 = 8;
        }
        this.f4756f.setVisibility(i12);
    ...
    public final void d(boolean z10, boolean z11) {
        ...
        if (!this.f4762y && (this.f4759s || !this.f4758r)) {
            z12 = true;
        } else {
            z12 = false;
        }
    ...
    public final void e(int i10, TLRPC.User user, int i11) {
        org.telegram.ui.ActionBar.e6 e6Var = this.f4753a;
        org.telegram.ui.ActionBar.j5 j5Var = this.d;
        org.telegram.ui.ActionBar.j5 j5Var2 = this.e;
        org.telegram.ui.Components.f9 f9Var = this.f4754b;
        int i12 = 0;
        if (i10 == 4) {
            ...
            j5Var2.setTextColor(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f19020n5, e6Var));
            f9Var.g(7);
    ...
    public final void f() {
        ...
        this.f4755c.setLayoutParams(w7.x5.d(40, 40.0f, i18, f7, 0.0f, f10, 0.0f));
        ...
        this.f4756f.setLayoutParams(w7.x5.d(24, 24.0f, i15 | 16, 13.0f, 0.0f, 14.0f, 0.0f));
        if (LocaleController.isRTL) {
            i17 = 5;
        }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        super.onDraw(canvas);
        if (this.f4762y) {
            int v02 = org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f18837d7, this.f4753a);
            Paint paint2 = this.f4757n;
            paint2.setColor(v02);
            if (LocaleController.isRTL) {
                canvas2 = canvas;
        ...
        Path path = this.E;
        if (path != null && (paint = this.F) != null && !this.f4759s && this.f4758r && this.v) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (!this.f4759s && this.f4758r) {
            ...
            this.F.setColor(org.telegram.ui.ActionBar.i6.l1(0.3f, org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.G6, this.f4753a)));
        }
    }
    ...
    public void setDivider(boolean z10) {
        boolean z11;
        this.f4762y = z10;
        if (!z10 && (this.f4759s || !this.f4758r)) {
            z11 = true;
        } else {
            z11 = false;
        }
    ...
    public void setRedCheckbox(boolean z10) {
        ...
        this.f4756f.b(i10, org.telegram.ui.ActionBar.i6.f18945j7, org.telegram.ui.ActionBar.i6.C5);
    }
    ...
    public void setUser(TLRPC.User user) {
        ...
        boolean[] zArr = this.f4760w;
        zArr[0] = false;
        boolean z10 = this.f4758r;
        org.telegram.ui.ActionBar.e6 e6Var = this.f4753a;
        org.telegram.ui.ActionBar.j5 j5Var2 = this.e;
        if (z10) {
            setSubtitle(LocaleController.getString(R.string.VoipGroupPersonalAccount));
            j5Var2.setTextColor(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f19091r5, e6Var));
        } else {
            setSubtitle(LocaleController.formatUserStatus(UserConfig.selectedAccount, user, zArr));
            if (zArr[0]) {
                i10 = org.telegram.ui.ActionBar.i6.f19020n5;
            } else {
                i10 = org.telegram.ui.ActionBar.i6.f19091r5;
            }
