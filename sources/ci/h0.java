    ...
    public final boolean a() {
        ...
        switch (i10) {
            ...
            case 1:
                ...
                return m0Var.h.j();
            default:
                te0 te0Var = ((ue0) frameLayout).f28371a;
                if (te0Var != null) {
    ...
    public final void c() {
        switch (this.f4739a) {
            ...
            case 1:
                ...
                return;
            default:
                ((ue0) this.f4740b).f28372b.f14110a.g(1, true);
                return;
        }
    }
