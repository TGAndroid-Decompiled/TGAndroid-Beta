...
public abstract class x3 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    public static final MediaController.AlbumEntry f5727j0 = new MediaController.AlbumEntry(-1, null, null);
    ...
    public Utilities.Callback3 f5729a0;
    public final org.telegram.ui.ActionBar.e6 f5730b;
    public final ArrayList f5731b0;
    public final Paint f5732c;
    public boolean f5733c0;
    public final f3 d;
    public boolean f5734d0;
    public final g3 e;
    public MediaController.AlbumEntry f5735e0;
    public final p3 f5736f;
    public ArrayList f5737f0;
    public ArrayList f5738g0;
    public final FrameLayout h;
    public final ArrayList f5739h0;
    public ai.x5 f5740i0;
    public final ll0 f5741n;
    public final m3 f5742r;
    public final yw0 f5743s;
    public final j4 v;
    public boolean f5744w;
    public final org.telegram.ui.ActionBar.k f5745x;
    public final TextView f5746y;
    ...
    public x3(int i10, Context context, org.telegram.ui.ActionBar.e6 e6Var, MediaController.AlbumEntry albumEntry, boolean z10, float f7, boolean z11, boolean z12) {
        ...
        this.f5731b0 = arrayList;
        this.f5739h0 = new ArrayList();
        this.O = f7;
        this.f5728a = i10;
        this.f5730b = e6Var;
        this.L = z10;
        ...
        f3Var.setOnItemClickListener(new zk0(this) {
            ...
            public final void d(int i11, View view) {
                ...
                switch (r2) {
                    case 0:
                        x3 x3Var = this.f5857b;
                        ArrayList arrayList2 = x3Var.f5731b0;
                        ArrayList arrayList3 = x3Var.f5739h0;
                        if (i11 >= 2 && x3Var.W != null && (view instanceof s3)) {
                            ...
                            if (x3Var.f5733c0) {
                                if (i12 == 0) {
                                    x3Var.e(x3.f5727j0, true);
                                    return;
                                }
                                i12 = i11 - 3;
                            } else if (x3Var.f5734d0) {
                            ...
                            if (i12 >= 0 && i12 < x3Var.f5737f0.size()) {
                                MediaController.PhotoEntry photoEntry = (MediaController.PhotoEntry) x3Var.f5737f0.get(i12);
                        ...
                        return;
                    default:
                        x3 x3Var2 = this.f5857b;
                        m3 m3Var = x3Var2.f5742r;
                        org.telegram.ui.ActionBar.v0 v0Var = x3Var2.G;
                        if (v0Var != null) {
                            AndroidUtilities.hideKeyboard(v0Var.getSearchContainer());
                        }
                        if (i11 >= 0 && i11 < m3Var.f5682c.size() && (callback2 = x3Var2.W) != null) {
                            callback2.run(m3Var.f5682c.get(i11), null);
                            return;
                        }
                        return;
                }
        ...
        l3Var.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view) {
                switch (r2) {
                    case 0:
                        this.f4343b.F.M(null, null);
                        return;
                    case 1:
                        x3 x3Var = this.f4343b;
        ...
        oVar.setTextColor(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f19218y6, e6Var));
        ...
        ll0Var.setOnItemClickListener(new zk0(this) {
            ...
            public final void d(int i11, View view) {
                ...
                switch (r2) {
                    ...
                    default:
                        x3 x3Var2 = this.f5857b;
                        m3 m3Var2 = x3Var2.f5742r;
                        org.telegram.ui.ActionBar.v0 v0Var = x3Var2.G;
                        if (v0Var != null) {
                            AndroidUtilities.hideKeyboard(v0Var.getSearchContainer());
                        }
                        if (i11 >= 0 && i11 < m3Var2.f5682c.size() && (callback2 = x3Var2.W) != null) {
                            callback2.run(m3Var2.f5682c.get(i11), null);
                            return;
                        }
                        return;
                }
        ...
        arrayList.clear();
        if (!z10) {
            ArrayList arrayList2 = MessagesController.getInstance(i10).getStoriesController().f1206w.f4377b;
            ...
            while (i11 < size) {
                ...
                i11++;
                o8 o8Var = (o8) obj;
                if (!o8Var.f5152g && !o8Var.f5181w) {
                    this.f5731b0.add(o8Var);
                }
            }
        }
        if (z11) {
            ...
            linearLayout.setBackgroundColor(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f18907h5, e6Var));
            ...
            d g10 = wl.g(24, context, e6Var, true);
            this.J = g10;
            ...
            d g11 = wl.g(24, context, e6Var, z12);
        ...
        h();
        MediaController.AlbumEntry albumEntry2 = f5727j0;
        if (albumEntry != null && (albumEntry != albumEntry2 || this.f5731b0.size() > 0)) {
            this.f5735e0 = albumEntry;
        } else {
            ArrayList arrayList3 = this.f5738g0;
            if (arrayList3 != null && !arrayList3.isEmpty()) {
                this.f5735e0 = (MediaController.AlbumEntry) this.f5738g0.get(0);
            } else {
                this.f5735e0 = MediaController.allMediaAlbumEntry;
            }
        }
        this.f5737f0 = b(this.f5735e0);
        i();
        MediaController.AlbumEntry albumEntry3 = this.f5735e0;
        if (albumEntry3 == MediaController.allMediaAlbumEntry) {
            this.f5746y.setText(LocaleController.getString(R.string.ChatGallery));
        } else if (albumEntry3 == albumEntry2) {
            this.f5746y.setText(LocaleController.getString(R.string.StoryDraftsAlbum));
        } else {
            this.f5746y.setText(albumEntry3.bucketName);
        }
    }

    public static Bitmap d(s3 s3Var) {
        Bitmap bitmap;
        if (s3Var != null && (bitmap = s3Var.f5494a) != null && !bitmap.isRecycled()) {
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        p3 p3Var = this.f5736f;
        int i13 = 0;
        if (i10 == i12) {
            h();
            if (this.f5735e0 != null) {
                while (true) {
                    ...
                    MediaController.AlbumEntry albumEntry2 = this.f5735e0;
                ...
                ArrayList arrayList = this.f5738g0;
            ...
            ArrayList arrayList2 = this.f5731b0;
            arrayList2.clear();
            if (!this.L) {
                ArrayList arrayList3 = MessagesController.getInstance(this.f5728a).getStoriesController().f1206w.f4377b;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        float g10 = g();
        int i10 = 0;
        if (g10 <= hg.k0.f(32.0f, org.telegram.ui.ActionBar.k.getCurrentActionBarHeight() + AndroidUtilities.statusBarHeight, 0)) {
            z10 = true;
        } else {
            z10 = false;
        }
        ...
        org.telegram.ui.ActionBar.k kVar = this.f5745x;
        if (kVar != null) {
            kVar.setAlpha(e);
            if (e <= 0.0f) {
                i10 = 8;
        ...
        ai.x5 x5Var = this.f5740i0;
        if (x5Var != null) {
            x5Var.setAlpha(1.0f - e);
        }
        RectF rectF = AndroidUtilities.rectTmp;
        rectF.set(0.0f, lerp, getWidth(), AndroidUtilities.dp(14.0f) + getHeight());
        canvas.drawRoundRect(rectF, AndroidUtilities.dp(14.0f), AndroidUtilities.dp(14.0f), this.f5732c);
        canvas.save();
    ...
    public final void e(MediaController.AlbumEntry albumEntry, boolean z10) {
        ...
        if (z10) {
            ...
            oVar.f42825a = 1;
            oVar.f13102p = AndroidUtilities.dp(16.0f) + (-org.telegram.ui.ActionBar.k.getCurrentActionBarHeight());
            g3Var.w0(oVar);
            return;
        }
    ...
    public final void f(boolean z10) {
        Bitmap bitmap;
        s3 s3Var;
        if (this.f5729a0 != null) {
            ArrayList arrayList = this.f5739h0;
            if (!arrayList.isEmpty()) {
                ...
                while (true) {
                    ...
                    if (i10 < size) {
                        ...
                        this.f5729a0.run(Boolean.valueOf(z10), new ArrayList(arrayList), arrayList2);
                        arrayList.clear();
    ...
    public final void h() {
        a aVar;
        l3 l3Var = this.F;
        ActionBarPopupWindow$ActionBarPopupWindowLayout actionBarPopupWindow$ActionBarPopupWindowLayout = l3Var.f19578b;
        if (actionBarPopupWindow$ActionBarPopupWindowLayout != null) {
            actionBarPopupWindow$ActionBarPopupWindowLayout.d();
        }
        ArrayList<MediaController.AlbumEntry> arrayList = MediaController.allMediaAlbums;
        ArrayList arrayList2 = new ArrayList(arrayList);
        this.f5738g0 = arrayList2;
        Collections.sort(arrayList2, new ai.c8(arrayList, 1));
        ArrayList arrayList3 = this.f5731b0;
        boolean isEmpty = arrayList3.isEmpty();
        MediaController.AlbumEntry albumEntry = f5727j0;
        if (!isEmpty) {
            ArrayList arrayList4 = this.f5738g0;
            arrayList4.add(!arrayList4.isEmpty(), albumEntry);
        }
        boolean isEmpty2 = this.f5738g0.isEmpty();
        TextView textView = this.f5746y;
        if (isEmpty2) {
        ...
        int size = this.f5738g0.size();
        for (int i10 = 0; i10 < size; i10++) {
            MediaController.AlbumEntry albumEntry2 = (MediaController.AlbumEntry) this.f5738g0.get(i10);
            if (albumEntry2 == albumEntry) {
                aVar = new a(getContext(), albumEntry2.coverPhoto, LocaleController.getString("StoryDraftsAlbum"), arrayList3.size(), this.f5730b);
            } else {
                ArrayList b10 = b(albumEntry2);
                if (!b10.isEmpty()) {
                    aVar = new a(getContext(), albumEntry2.coverPhoto, albumEntry2.bucketName, b10.size(), this.f5730b);
                }
            }
    ...
    public final void i() {
        boolean z10;
        ArrayList arrayList;
        ArrayList arrayList2 = this.f5738g0;
        boolean z11 = true;
        if (arrayList2 != null && !arrayList2.isEmpty() && this.f5738g0.get(0) == this.f5735e0 && this.f5731b0.size() > 2) {
            z10 = true;
        } else {
            z10 = false;
        }
        this.f5733c0 = z10;
        if (z10 || (this.f5735e0 != f5727j0 && ((arrayList = this.f5738g0) == null || arrayList.isEmpty() || this.f5738g0.get(0) != this.f5735e0))) {
            z11 = false;
        }
        this.f5734d0 = z11;
    }
    ...
    public final void j() {
        ...
        if (imageView != null) {
            ...
            wl.q(scaleY.translationY(dp), qr.h, 320L);
        }
    ...
    public final void onAttachedToWindow() {
        ...
        NotificationCenter.getInstance(this.f5728a).addObserver(this, NotificationCenter.storiesDraftsUpdated);
    ...
    public final void onDetachedFromWindow() {
        ...
        NotificationCenter.getInstance(this.f5728a).removeObserver(this, NotificationCenter.storiesDraftsUpdated);
        s3.f5492e0.clear();
        s3.f5493f0.evictAll();
        int i10 = 0;
        while (true) {
            ArrayList arrayList = s3.f5490c0;
