...
public abstract class x3 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    public static final MediaController.AlbumEntry f5733j0 = new MediaController.AlbumEntry(-1, null, null);
    ...
    public Utilities.Callback3 f5735a0;
    public final org.telegram.ui.ActionBar.f6 f5736b;
    public final ArrayList f5737b0;
    public final Paint f5738c;
    public boolean f5739c0;
    public final f3 d;
    public boolean f5740d0;
    public final g3 e;
    public MediaController.AlbumEntry f5741e0;
    public final p3 f5742f;
    public ArrayList f5743f0;
    public ArrayList f5744g0;
    public final FrameLayout h;
    public final ArrayList f5745h0;
    public ai.x5 f5746i0;
    public final vl0 f5747n;
    public final m3 f5748r;
    public final jx0 f5749s;
    public final j4 v;
    public boolean f5750w;
    public final org.telegram.ui.ActionBar.k f5751x;
    public final TextView f5752y;
    ...
    public x3(int i10, Context context, org.telegram.ui.ActionBar.f6 f6Var, MediaController.AlbumEntry albumEntry, boolean z10, float f7, boolean z11, boolean z12) {
        ...
        this.f5737b0 = arrayList;
        this.f5745h0 = new ArrayList();
        this.O = f7;
        this.f5734a = i10;
        this.f5736b = f6Var;
        this.L = z10;
        ...
        f3Var.setOnItemClickListener(new jl0(this) {
            public final x3 f5863b;
            ...
            public final void d(int i11, View view) {
                ...
                switch (r2) {
                    case 0:
                        x3 x3Var = this.f5863b;
                        ArrayList arrayList2 = x3Var.f5737b0;
                        ArrayList arrayList3 = x3Var.f5745h0;
                        if (i11 >= 2 && x3Var.W != null && (view instanceof s3)) {
                            ...
                            if (i12 >= 0 && i12 < x3Var.f5743f0.size()) {
                                MediaController.PhotoEntry photoEntry = (MediaController.PhotoEntry) x3Var.f5743f0.get(i12);
                        ...
                        return;
                    default:
                        x3 x3Var2 = this.f5863b;
                        m3 m3Var = x3Var2.f5748r;
                        org.telegram.ui.ActionBar.v0 v0Var = x3Var2.G;
                        if (v0Var != null) {
                            AndroidUtilities.hideKeyboard(v0Var.getSearchContainer());
                        }
                        if (i11 >= 0 && i11 < m3Var.f5688c.size() && (callback2 = x3Var2.W) != null) {
                            callback2.run(m3Var.f5688c.get(i11), null);
                            return;
                        }
                        return;
                }
        ...
        l3Var.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view) {
                switch (r2) {
                    case 0:
                        this.f4349b.F.M(null, null);
                        return;
                    case 1:
                        x3 x3Var = this.f4349b;
        ...
        jx0 jx0Var = new jx0(context, t00Var, 11, f6Var);
        this.f5749s = jx0Var;
        vh.o oVar = jx0Var.d;
        oVar.setTextSize(1, 16.0f);
        oVar.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19477y6, f6Var));
        ...
        vl0Var.setOnItemClickListener(new jl0(this) {
            ...
            public final void d(int i11, View view) {
                ...
                switch (r2) {
                    ...
                    default:
                        x3 x3Var2 = this.f5863b;
                        m3 m3Var2 = x3Var2.f5748r;
                        org.telegram.ui.ActionBar.v0 v0Var = x3Var2.G;
                        if (v0Var != null) {
                            AndroidUtilities.hideKeyboard(v0Var.getSearchContainer());
                        }
                        if (i11 >= 0 && i11 < m3Var2.f5688c.size() && (callback2 = x3Var2.W) != null) {
                            callback2.run(m3Var2.f5688c.get(i11), null);
                            return;
                        }
                        return;
                }
        ...
        arrayList.clear();
        if (!z10) {
            ArrayList arrayList2 = MessagesController.getInstance(i10).getStoriesController().f1211w.f4383b;
            ...
            while (i11 < size) {
                ...
                i11++;
                o8 o8Var = (o8) obj;
                if (!o8Var.f5158g && !o8Var.f5187w) {
                    this.f5737b0.add(o8Var);
                }
            }
        }
        if (z11) {
            ...
            linearLayout.setBackgroundColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19165h5, f6Var));
        ...
        h();
        MediaController.AlbumEntry albumEntry2 = f5733j0;
        if (albumEntry != null && (albumEntry != albumEntry2 || this.f5737b0.size() > 0)) {
            this.f5741e0 = albumEntry;
        } else {
            ArrayList arrayList3 = this.f5744g0;
            if (arrayList3 != null && !arrayList3.isEmpty()) {
                this.f5741e0 = (MediaController.AlbumEntry) this.f5744g0.get(0);
            } else {
                this.f5741e0 = MediaController.allMediaAlbumEntry;
            }
        }
        this.f5743f0 = b(this.f5741e0);
        i();
        MediaController.AlbumEntry albumEntry3 = this.f5741e0;
        if (albumEntry3 == MediaController.allMediaAlbumEntry) {
            this.f5752y.setText(LocaleController.getString(R.string.ChatGallery));
        } else if (albumEntry3 == albumEntry2) {
            this.f5752y.setText(LocaleController.getString(R.string.StoryDraftsAlbum));
        } else {
            this.f5752y.setText(albumEntry3.bucketName);
        }
    }

    public static Bitmap d(s3 s3Var) {
        Bitmap bitmap;
        if (s3Var != null && (bitmap = s3Var.f5500a) != null && !bitmap.isRecycled()) {
        ...
        if (i10 == i12) {
            ...
            if (this.f5741e0 != null) {
                while (true) {
                    ...
                    MediaController.AlbumEntry albumEntry2 = this.f5741e0;
                ...
                ArrayList arrayList = this.f5744g0;
            ...
            ArrayList arrayList2 = this.f5737b0;
            arrayList2.clear();
            if (!this.L) {
                ArrayList arrayList3 = MessagesController.getInstance(this.f5734a).getStoriesController().f1211w.f4383b;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        org.telegram.ui.ActionBar.k kVar = this.f5751x;
        if (kVar != null) {
            kVar.setAlpha(e);
            if (e <= 0.0f) {
                i10 = 8;
        ...
        ai.x5 x5Var = this.f5746i0;
        if (x5Var != null) {
            x5Var.setAlpha(1.0f - e);
        }
        RectF rectF = AndroidUtilities.rectTmp;
        rectF.set(0.0f, lerp, getWidth(), AndroidUtilities.dp(14.0f) + getHeight());
        canvas.drawRoundRect(rectF, AndroidUtilities.dp(14.0f), AndroidUtilities.dp(14.0f), this.f5738c);
        canvas.save();
    ...
    public final void f(boolean z10) {
        ...
        if (this.f5735a0 != null) {
            ArrayList arrayList = this.f5745h0;
            if (!arrayList.isEmpty()) {
                ...
                while (true) {
                    ...
                    if (i10 < size) {
                        ...
                        this.f5735a0.run(Boolean.valueOf(z10), new ArrayList(arrayList), arrayList2);
                        arrayList.clear();
    ...
    public final void h() {
        a aVar;
        l3 l3Var = this.F;
        ActionBarPopupWindow$ActionBarPopupWindowLayout actionBarPopupWindow$ActionBarPopupWindowLayout = l3Var.f19797b;
        if (actionBarPopupWindow$ActionBarPopupWindowLayout != null) {
            actionBarPopupWindow$ActionBarPopupWindowLayout.d();
        }
        ArrayList<MediaController.AlbumEntry> arrayList = MediaController.allMediaAlbums;
        ArrayList arrayList2 = new ArrayList(arrayList);
        this.f5744g0 = arrayList2;
        Collections.sort(arrayList2, new ai.c8(arrayList, 1));
        ArrayList arrayList3 = this.f5737b0;
        boolean isEmpty = arrayList3.isEmpty();
        MediaController.AlbumEntry albumEntry = f5733j0;
        if (!isEmpty) {
            ArrayList arrayList4 = this.f5744g0;
            arrayList4.add(!arrayList4.isEmpty(), albumEntry);
        }
        boolean isEmpty2 = this.f5744g0.isEmpty();
        TextView textView = this.f5752y;
        if (isEmpty2) {
        ...
        int size = this.f5744g0.size();
        for (int i10 = 0; i10 < size; i10++) {
            MediaController.AlbumEntry albumEntry2 = (MediaController.AlbumEntry) this.f5744g0.get(i10);
            if (albumEntry2 == albumEntry) {
                aVar = new a(getContext(), albumEntry2.coverPhoto, LocaleController.getString("StoryDraftsAlbum"), arrayList3.size(), this.f5736b);
            } else {
                ArrayList b10 = b(albumEntry2);
                if (!b10.isEmpty()) {
                    aVar = new a(getContext(), albumEntry2.coverPhoto, albumEntry2.bucketName, b10.size(), this.f5736b);
                }
            }
    ...
    public final void i() {
        boolean z10;
        ArrayList arrayList;
        ArrayList arrayList2 = this.f5744g0;
        boolean z11 = true;
        if (arrayList2 != null && !arrayList2.isEmpty() && this.f5744g0.get(0) == this.f5741e0 && this.f5737b0.size() > 2) {
            z10 = true;
        } else {
            z10 = false;
        }
        this.f5739c0 = z10;
        if (z10 || (this.f5741e0 != f5733j0 && ((arrayList = this.f5744g0) == null || arrayList.isEmpty() || this.f5744g0.get(0) != this.f5741e0))) {
            z11 = false;
        }
        this.f5740d0 = z11;
    }
    ...
    public final void onAttachedToWindow() {
        ...
        NotificationCenter.getInstance(this.f5734a).addObserver(this, NotificationCenter.storiesDraftsUpdated);
    ...
    public final void onDetachedFromWindow() {
        ...
        NotificationCenter.getInstance(this.f5734a).removeObserver(this, NotificationCenter.storiesDraftsUpdated);
        s3.f5498e0.clear();
        s3.f5499f0.evictAll();
        int i10 = 0;
        while (true) {
            ArrayList arrayList = s3.f5496c0;
