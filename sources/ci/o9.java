...
public final class o9 implements View.OnClickListener {
    ...
    public final void onClick(View view) {
        ...
        switch (this.f5191a) {
            case 0:
                ba baVar = this.f5192b;
                HashMap hashMap = baVar.d;
                ArrayList arrayList = baVar.f4400c;
                ia iaVar = baVar.W;
                d dVar = baVar.v;
                if (!dVar.N) {
                    ...
                    HashMap hashMap3 = iaVar.f4809r;
                    ArrayList arrayList3 = iaVar.f4808n;
                    MessagesController messagesController = MessagesController.getInstance(i10);
                    int i19 = baVar.f4398a;
                    if (i19 == 5) {
                        q9 q9Var = iaVar.V;
                        if (q9Var != null) {
                            q9Var.run(arrayList);
                        ...
                        tL_editCloseFriends.f18159id.addAll(arrayList);
                        ...
                        if (iaVar.Z) {
                            ...
                            if (!l13.isEmpty()) {
                                ...
                                ArrayList arrayList6 = gaVar2.f4724c;
                                arrayList6.clear();
                        ...
                        while (it.hasNext()) {
                            ...
                            if (inputPeer != null && !(inputPeer instanceof TLRPC.TL_inputPeerEmpty)) {
                                hashSet.add(l4);
                                tL_contacts_setBlocked.f18156id.add(inputPeer);
                            }
                        }
            ...
            case 1:
                ...
                return;
            default:
                ba baVar3 = this.f5192b;
                HashMap hashMap7 = baVar3.d;
                a0.i iVar = baVar3.f4399b;
                ArrayList arrayList7 = baVar3.f4400c;
