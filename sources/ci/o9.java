...
public final class o9 implements View.OnClickListener {
    ...
    public final void onClick(View view) {
        ...
        switch (this.f5189a) {
            case 0:
                ba baVar = this.f5190b;
                HashMap hashMap = baVar.d;
                ArrayList arrayList = baVar.f4398c;
                ia iaVar = baVar.W;
                d dVar = baVar.v;
                if (!dVar.N) {
                    ...
                    HashMap hashMap3 = iaVar.f4807r;
                    ArrayList arrayList3 = iaVar.f4806n;
                    MessagesController messagesController = MessagesController.getInstance(i10);
                    int i19 = baVar.f4396a;
                    if (i19 == 5) {
                        q9 q9Var = iaVar.V;
                        if (q9Var != null) {
                            q9Var.run(arrayList);
                        ...
                        tL_editCloseFriends.f18162id.addAll(arrayList);
                        ...
                        if (i20 == 3) {
                            ...
                            ArrayList arrayList4 = gaVar.f4722c;
                            arrayList4.clear();
                            ...
                            ArrayList arrayList5 = gaVar.f4722c;
                            arrayList5.clear();
                        ...
                        if (iaVar.Z) {
                            ...
                            if (!l13.isEmpty()) {
                                ...
                                ArrayList arrayList6 = gaVar2.f4722c;
                                arrayList6.clear();
                        ...
                        int i23 = storiesController.f1188a;
                        ...
                        while (it.hasNext()) {
                            ...
                            if (inputPeer != null && !(inputPeer instanceof TLRPC.TL_inputPeerEmpty)) {
                                hashSet.add(l4);
                                tL_contacts_setBlocked.f18159id.add(inputPeer);
                            }
                        }
            ...
            case 1:
                ...
                return;
            default:
                ba baVar3 = this.f5190b;
                HashMap hashMap7 = baVar3.d;
                a0.i iVar = baVar3.f4397b;
                ArrayList arrayList7 = baVar3.f4398c;
