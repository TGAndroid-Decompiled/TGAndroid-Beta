...
public final class e8 implements TextWatcher {
    ...
    public final void afterTextChanged(Editable editable) {
        ...
        g8 g8Var = this.f4604a;
        g8Var.f4717s0 = obj;
        if (!g8Var.Z) {
            String str = g8Var.f4722x0;
            String str2 = "";
            if (obj == null) {
                obj = "";
            }
            ...
            String str5 = g8Var.f4717s0;
            if (str5 != null) {
                str2 = str5;
            }
            if (!TextUtils.equals(str4, str2)) {
                g8Var.Y();
                String str6 = g8Var.f4717s0;
