...
public final class qb extends r6 {
    ...
    public final void V0(boolean z10, boolean z11) {
        ...
        if (z10) {
            ...
            ocVar.f5252p1.animate().alpha(1.0f).setDuration(180L).setInterpolator(qr.f27381g).start();
            return;
        }
        ocVar.f5252p1.a(false, z11);
        ocVar.f5252p1.clearAnimation();
        ViewPropertyAnimator interpolator = ocVar.f5252p1.animate().alpha(0.0f).withEndAction(new androidx.fragment.app.a0(this, 25)).setDuration(180L).setInterpolator(qr.f27381g);
        if (z11) {
            j3 = 500;
        } else {
            j3 = 0;
