...
public final class qb extends r6 {
    ...
    public final void A(boolean z10) {
        oc ocVar = this.A2;
        ocVar.f5250o1.a(true, z10, ocVar.f5232i0);
    }

    @Override
    public final void B() {
        oc ocVar = this.A2;
        ocVar.f5273v1.O0(false);
        ocVar.f5214c1.clearAnimation();
        ViewPropertyAnimator duration = ocVar.f5214c1.animate().alpha(0.0f).setDuration(180L);
        qr qrVar = qr.f27643g;
    ...
    public final void V0(boolean z10, boolean z11) {
        ...
        oc ocVar = this.A2;
        if (z10) {
            ocVar.f5253p1.setVisibility(0);
            ocVar.f5253p1.setAlpha(0.0f);
            ocVar.f5253p1.clearAnimation();
            ocVar.f5253p1.animate().alpha(1.0f).setDuration(180L).setInterpolator(qr.f27643g).start();
            return;
        }
        ocVar.f5253p1.a(false, z11);
        ocVar.f5253p1.clearAnimation();
        ViewPropertyAnimator interpolator = ocVar.f5253p1.animate().alpha(0.0f).withEndAction(new androidx.fragment.app.a0(this, 25)).setDuration(180L).setInterpolator(qr.f27643g);
        if (z11) {
            j3 = 500;
        } else {
            j3 = 0;
    ...
    public final void i(boolean z10) {
        ...
        oc ocVar = this.A2;
        ocVar.f5214c1.clearAnimation();
        ViewPropertyAnimator animate = ocVar.f5214c1.animate();
        float f10 = 0.0f;
        if (ocVar.f5226g0 == -1) {
            f7 = 1.0f;
        } else {
    ...
    public final void k() {
        this.f5367z2 = false;
        V0(q(), false);
        this.A2.f5250o1.a(false, false, null);
    }

    @Override
    public final void l() {
        this.f5367z2 = true;
        this.A2.f5273v1.O0(false);
        V0(false, false);
    }

    @Override
    public final void n(boolean z10) {
        this.A2.f5253p1.a(z10, false);
    }
    ...
    public final void z0(boolean z10) {
        ...
        if (ccVar != null) {
            ccVar.x(6, z10);
            s6 s6Var = ocVar.f5236j1;
            if (s6Var != null) {
                ((pg0) s6Var.f5518c).a(ocVar.X0.k(), true);
            }
        }
