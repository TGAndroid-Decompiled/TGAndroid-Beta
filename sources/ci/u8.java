...
public final class u8 extends org.telegram.ui.Components.bb implements NotificationCenter.NotificationCenterDelegate {
    ...
    public u8(Context context, d6 d6Var, b7 b7Var, ai.g3 g3Var) {
        ...
        int themedColor = getThemedColor(org.telegram.ui.ActionBar.h6.f19246o6);
        ...
        org.telegram.ui.Cells.h3 h3Var2 = j3Var2.f20477b;
    ...
    public static void P(u8 u8Var, Context context, b7 b7Var, View view, int i10) {
        ...
        if (G != null) {
            if (G.G(s8.class) && (webPage = u8Var.f5623g0) != null && !W(webPage)) {
                ...
                o0Var.f41826c = j3Var2.f20477b.getText().toString();
                if (u8Var.m0) {
                    str = j3Var.f20477b.getText().toString();
                } else {
                    str = null;
                }
                o0Var.f41825b = str;
                ...
                ec0 ec0Var = t2Var.f41932x;
                ec0Var.setVisibility(i11);
                t2Var.f41927f.b(t2Var.f41924a, o0Var, false);
                t2Var.f41931w.a(!o0Var.f41827f, false);
    ...
    public static void Q(u8 u8Var) {
        ...
        getwebpagepreview.message = u8Var.Y.f20477b.getText().toString();
    ...
    public final void X() {
        ...
        if (this.f5621e0 != null) {
            qg.o0 o0Var = new qg.o0();
            o0Var.f41826c = this.Y.f20477b.getText().toString();
            if (this.m0) {
                str = this.Z.f20477b.getText().toString();
            } else {
                str = null;
            }
            o0Var.f41825b = str;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.didReceivedWebpagesInUpdates && this.f5622f0 != 0) {
            ...
            for (int i12 = 0; i12 < iVar.m(); i12++) {
                ...
                if (webPage != null && this.f5622f0 == webPage.f18474id) {
                    if (W(webPage)) {
                        webPage = null;
                    }
    ...
    public final void dismiss() {
        AndroidUtilities.hideKeyboard(this.Y.f20477b);
        AndroidUtilities.hideKeyboard(this.Z.f20477b);
        super.dismiss();
