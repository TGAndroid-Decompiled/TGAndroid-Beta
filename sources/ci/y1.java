...
public final class y1 extends nz {
    ...
    public final jv0 D1(int i10) {
        ...
        jv0Var.f25442c = false;
        if (document != null && (closestPhotoSizeWithSize = FileLoader.getClosestPhotoSizeWithSize(document.thumbs, 90)) != null && (i11 = closestPhotoSizeWithSize.f18134w) != 0 && (i12 = closestPhotoSizeWithSize.h) != 0) {
            jv0Var.f25440a = i11;
            jv0Var.f25441b = i12;
        }
        if (arrayList != null) {
