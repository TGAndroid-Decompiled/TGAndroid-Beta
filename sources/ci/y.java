...
public final class y extends FrameLayout {
    ...
    public t f5795b;
    public Utilities.Callback f5796c;
    public float d;
    public boolean e;
    public ValueAnimator f5797f;
    ...
    public final void a(boolean z10, boolean z11) {
        ValueAnimator valueAnimator = this.f5797f;
        ...
        if (z11) {
            ...
            this.f5797f.addListener(new ai.n(8, this, z10));
            this.f5797f.setInterpolator(qr.h);
            this.f5797f.setDuration(340L);
            this.f5797f.start();
            return;
        }
        if (z10) {
    ...
    public void setOnLayoutClick(Utilities.Callback<t> callback) {
        this.f5796c = callback;
    }

    public void setSelected(t tVar) {
        this.f5795b = tVar;
        AndroidUtilities.updateVisibleRows(this.f5794a);
    }
}
