...
public abstract class y extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public y(Context context, n2 n2Var, long j3) {
        ...
        this.d = j3;
        setBackgroundColor(j6.v(j6.v0(j6.f20691d6, resourceProvider), j6.l1(0.04f, j6.v0(j6.G6, resourceProvider))));
        if (F == null) {
    ...
    public final void a(String str) {
        ...
        if (n2Var != null && n2Var.getParentActivity() != null) {
            ...
            viVar.T0 = true;
            viVar.S0 = false;
            viVar.f31320j1.setText(LocaleController.getString(R.string.ChoosePhotoOrVideo));
            viVar.f31319j0.f0();
