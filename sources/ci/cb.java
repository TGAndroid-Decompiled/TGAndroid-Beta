...
public final class cb implements Utilities.Callback2 {
    ...
    public final NotificationCenter.NotificationCenterDelegate f4442c;

    public cb(boolean z10, NotificationCenter.NotificationCenterDelegate notificationCenterDelegate, int i10) {
        this.f4440a = i10;
        this.f4442c = notificationCenterDelegate;
        this.f4441b = z10;
    }
    ...
    public final void run(Object obj, Object obj2) {
        ...
        switch (this.f4440a) {
            case 0:
                oc ocVar = (oc) this.f4442c;
                Bitmap bitmap = (Bitmap) obj2;
                int i10 = ocVar.f5211c;
                if (obj != null && ocVar.f5253p2 == null && !ocVar.W && ocVar.J()) {
                    int i11 = 0;
                    if (this.f4441b) {
                        if (ocVar.K1 != null) {
                            ocVar.u();
                            ocVar.K1.f5162j = true;
                            if (obj instanceof MediaController.PhotoEntry) {
                                ...
                                if ((tLObject instanceof TLRPC.Photo) && (closestPhotoSizeWithSize = FileLoader.getClosestPhotoSizeWithSize(((TLRPC.Photo) tLObject).sizes, 1000)) != null) {
                                    f7 = closestPhotoSizeWithSize.f18321w / closestPhotoSizeWithSize.h;
                                } else {
                                    f7 = 1.0f;
                                }
                                if (f7 > 1.0f) {
                        ...
                        if (z11) {
                            ...
                            if (o8Var.L == null && !o8Var.v()) {
                                ocVar.f5219e1.c(R.raw.error, "Failed to load draft");
                                MessagesController.getInstance(i10).getStoriesController().f1211w.b(o8Var);
                                return;
                            }
                            o8Var.J0 = ocVar.f5271v0;
                            o8Var.K0 = ocVar.f5275w0;
            ...
            case 1:
                ...
                fi.k0.m((fi.k0) this.f4442c, this.f4441b, (TLRPC.TL_error) obj2);
                return;
            default:
                ProfileActivity profileActivity = (ProfileActivity) this.f4442c;
                Integer num = (Integer) obj;
                TLRPC.TL_error tL_error = (TLRPC.TL_error) obj2;
                if (!profileActivity.M3()) {
                    if (org.telegram.ui.Components.xc.a(profileActivity)) {
                        int intValue = num.intValue();
                        boolean z12 = this.f4441b;
                        if (intValue == 1) {
                            org.telegram.ui.Components.xc.l(null, profileActivity, z12).j();
                        } else if (num.intValue() == 2) {
                            org.telegram.ui.Components.xc.l(DialogObject.getShortName(profileActivity.f31513e1), profileActivity, z12).j();
