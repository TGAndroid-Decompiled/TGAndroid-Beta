...
public final class u extends Drawable {
    public final int f5587a = 1;
    public final Path f5588b;
    public final Paint f5589c;
    ...
    public u() {
        ...
        this.e = paint3;
        this.f5591g = new org.telegram.ui.Components.d6(new jc0(this, 1), 320L, qr.h, 0);
    ...
    public final void draw(Canvas canvas) {
        switch (this.f5587a) {
            case 0:
                ...
                canvas.drawPath(this.f5588b, this.f5589c);
                if (z10) {
            ...
            default:
                ...
                Paint paint = this.f5589c;
                paint.setStrokeWidth(dpf2);
                float dpf22 = AndroidUtilities.dpf2(3.32f);
                Paint paint2 = this.e;
                paint2.setStrokeWidth(dpf22);
                float e = ((org.telegram.ui.Components.d6) this.f5591g).e(this.f5590f);
                ...
                canvas.drawPath(this.f5588b, this.d);
                canvas.restore();
                if (i10 > 0) {
                    if (this.f5590f) {
    ...
    public u(t tVar, boolean z10) {
        ...
        while (i12 < size) {
            ...
            fArr[7] = f18;
            fArr[6] = f18;
            this.f5588b.addRoundRect(rectF2, fArr, Path.Direction.CW);
            tVar2 = tVar;
