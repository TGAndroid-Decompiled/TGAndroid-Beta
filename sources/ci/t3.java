...
public final class t3 extends View {
    ...
    public final void onMeasure(int i10, int i11) {
        int i12;
        int i13;
        x3 x3Var = this.f5556b;
        g3 g3Var = x3Var.e;
        ArrayList arrayList = x3Var.f5735b0;
        int size = View.MeasureSpec.getSize(i10);
        int i14 = this.f5555a;
        if (i14 == -1) {
            if (x3Var.f5739e0 == x3.f5731j0) {
                i12 = arrayList.size();
            } else {
                ArrayList arrayList2 = x3Var.f5741f0;
                if (arrayList2 != null) {
                    int size2 = arrayList2.size() + (x3Var.f5737c0 ? 1 : 0);
                    if (x3Var.f5738d0) {
                        i13 = arrayList.size();
                    } else {
                        i13 = 0;
