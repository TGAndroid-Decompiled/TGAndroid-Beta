...
public final class t3 extends View {
    ...
    public final void onMeasure(int i10, int i11) {
        int i12;
        int i13;
        x3 x3Var = this.f5558b;
        g3 g3Var = x3Var.e;
        ArrayList arrayList = x3Var.f5737b0;
        int size = View.MeasureSpec.getSize(i10);
        int i14 = this.f5557a;
        if (i14 == -1) {
            if (x3Var.f5741e0 == x3.f5733j0) {
                i12 = arrayList.size();
            } else {
                ArrayList arrayList2 = x3Var.f5743f0;
                if (arrayList2 != null) {
                    int size2 = arrayList2.size() + (x3Var.f5739c0 ? 1 : 0);
                    if (x3Var.f5740d0) {
                        i13 = arrayList.size();
                    } else {
                        i13 = 0;
