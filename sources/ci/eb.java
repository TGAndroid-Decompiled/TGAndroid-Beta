...
public final class eb extends View {
    ...
    public void onAttachedToWindow() {
        switch (this.f4612a) {
            ...
            case 7:
                super.onAttachedToWindow();
                ((CheckBoxBase) this.f4613b).f21980l = true;
                return;
            default:
                super.onAttachedToWindow();
                return;
    ...
    public void onDetachedFromWindow() {
        switch (this.f4612a) {
            ...
            case 7:
                super.onDetachedFromWindow();
                ((CheckBoxBase) this.f4613b).f21980l = false;
                return;
            default:
                super.onDetachedFromWindow();
                return;
    ...
    public void onDraw(Canvas canvas) {
        ...
        switch (this.f4612a) {
            ...
            case 11:
                ...
                r2Var.f20718j4.setBounds(0, 0, getWidth(), getHeight());
                r2Var.f20718j4.draw(canvas);
                return;
            case 16:
                gr grVar = (gr) this.f4613b;
                if (grVar.Z) {
                    canvas.drawRect(gr.R(grVar), 0.0f, getMeasuredWidth() - gr.S(grVar), 1.0f, org.telegram.ui.ActionBar.j6.f18985k0);
                    return;
                }
                return;
            case 20:
            ...
            case 24:
                ...
                if (qv0Var.f27416b != null && !qv0Var.J) {
                    Drawable newDrawable = qv0Var.getNewDrawable();
                    boolean newDrawableMotion = qv0Var.getNewDrawableMotion();
                    Drawable drawable3 = qv0Var.f27416b;
                    if (newDrawable != drawable3 && newDrawable != null) {
                        if (org.telegram.ui.ActionBar.j6.sl != null) {
                            qv0Var.d = drawable3;
                            qv0Var.e = qv0Var.f27418c;
                        }
                        if (newDrawable instanceof cc0) {
                            ((cc0) newDrawable).r(qv0Var.L);
                        }
                        qv0Var.f27416b = newDrawable;
                        if (qv0Var.M && (newDrawable instanceof fo)) {
                            ((fo) newDrawable).f(this);
                        }
                        if (qv0Var.M) {
                            Drawable drawable4 = qv0Var.f27416b;
                            if (drawable4 instanceof cc0) {
                                ((cc0) drawable4).k();
                            }
                        }
                        qv0Var.f27418c = newDrawableMotion;
                        qv0Var.f27429l0 = 0.0f;
                        qv0Var.U(qv0Var.f27416b);
                        qv0Var.I();
                    } else if (qv0Var.f27418c != newDrawableMotion) {
                        qv0Var.f27418c = newDrawableMotion;
                        qv0Var.I();
                    }
                    qv0Var.f27429l0 = Utilities.clamp((AndroidUtilities.screenRefreshTime / 200.0f) + qv0Var.f27429l0, 1.0f, 0.0f);
                    for (int i15 = 0; i15 < 2; i15++) {
                        if (i15 == 0) {
                            drawable = qv0Var.d;
                        } else {
                            drawable = qv0Var.f27416b;
                        }
                        if (drawable != null) {
                            boolean z11 = true;
                            if (i15 == 1 && qv0Var.d != null && qv0Var.G != null) {
                                drawable.setAlpha((int) (qv0Var.f27429l0 * 255.0f));
                            } else {
                            ...
                            if (i15 == 0 && (drawable2 = qv0Var.d) != null && qv0Var.f27429l0 >= f12) {
            ...
            case 26:
                ...
                Paint paint3 = gy0Var.f24418a;
                paint3.setColor(w02);
                Paint paint4 = gy0Var.f24419b;
                paint4.setColor(w02);
                Paint paint5 = gy0Var.f24420c;
                paint5.setColor(w02);
                paint4.setAlpha(255);
                paint5.setAlpha(82);
                paint3.setAlpha(46);
                Paint paint6 = gy0Var.d;
                paint6.setColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18863d6, false));
            ...
            case 27:
                if (getAlpha() != 0.0f) {
                    ...
                    ((org.telegram.ui.Components.voip.j1) this.f4613b).f28991n.a(AndroidUtilities.dp(10.0f), canvas, rectF3, null);
                    invalidate();
                    return;
                }
                return;
        ...
        switch (this.f4612a) {
            case 1:
                ...
                if (iVar.H) {
                    ...
                    if (AndroidUtilities.dp(24.0f) + iVar.f37635y.getMeasuredHeight() > dp) {
                        dp = AndroidUtilities.dp(24.0f) + iVar.f37635y.getMeasuredHeight();
                    }
                    i12 = dp;
                }
            ...
            case 2:
                ...
                if (lVar.H) {
                    ...
                    if (AndroidUtilities.dp(24.0f) + lVar.f37635y.getMeasuredHeight() > dp2) {
                        dp2 = AndroidUtilities.dp(24.0f) + lVar.f37635y.getMeasuredHeight();
                    }
                    i13 = dp2;
                }
            ...
            case 14:
                ...
                return;
            case 15:
                super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i10), 1073741824), View.MeasureSpec.makeMeasureSpec(((vn) ((org.telegram.ui.y7) this.f4613b).d).f28835w, 1073741824));
                return;
            case 17:
                ...
                return;
            case 18:
                super.onMeasure(i10, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(48.0f) + ((v60) this.f4613b).f28638c.f22638o0, 1073741824));
                return;
            case 19:
                int dp3 = AndroidUtilities.dp(48.0f);
                b70 b70Var = ((x60) this.f4613b).f29863n;
                super.onMeasure(i10, View.MeasureSpec.makeMeasureSpec(dp3 + b70Var.f22638o0 + b70Var.f22644u0, 1073741824));
                return;
            case 22:
            ...
            case 29:
                ...
                if (t20Var.H) {
                    ...
                    if (AndroidUtilities.dp(24.0f) + t20Var.f37635y.getMeasuredHeight() > dp4) {
                        dp4 = Math.max(dp4, (AndroidUtilities.dp(24.0f) + t20Var.f37635y.getMeasuredHeight()) - t20Var.L);
                    }
                    t20Var.J = dp4;
                }
    ...
    public void onSizeChanged(int i10, int i11, int i12, int i13) {
        switch (this.f4612a) {
            case 27:
                ...
                ((org.telegram.ui.Components.voip.j1) this.f4613b).f28991n.f28945f = i10;
                return;
            default:
                super.onSizeChanged(i10, i11, i12, i13);
                return;
    ...
    public void setAlpha(float f7) {
        switch (this.f4612a) {
            case 10:
                super.setAlpha(f7);
                View view = ((org.telegram.ui.e8) this.f4613b).f33326b.f33909x.fragmentView;
                if (view != null) {
                    view.invalidate();
                    return;
                }
