...
public final class eb extends View {
    ...
    public void dispatchDraw(Canvas canvas) {
        switch (this.f4612a) {
            ...
            case 5:
                ...
                return;
            case 8:
                canvas.drawRect(0.0f, 0.0f, getWidth(), getHeight(), ((org.telegram.ui.ActionBar.j3) this.f4613b).d);
                return;
            default:
                super.dispatchDraw(canvas);
                return;
    ...
    public void draw(Canvas canvas) {
        switch (this.f4612a) {
            case 17:
                super.draw(canvas);
                ((h01) this.f4613b).e(canvas, (getMeasuredWidth() - ((h01) this.f4613b).l()) / 2.0f, getMeasuredHeight() / 2.0f);
                return;
            case 21:
                super.draw(canvas);
                iq0 iq0Var = (iq0) this.f4613b;
    ...
    public void onAttachedToWindow() {
        switch (this.f4612a) {
            case 4:
                ...
                ((gg.q1) this.f4613b).f9903f = true;
                return;
            case 7:
                super.onAttachedToWindow();
                ((CheckBoxBase) this.f4613b).f21977l = true;
                return;
            default:
                super.onAttachedToWindow();
                return;
    ...
    public void onDetachedFromWindow() {
        switch (this.f4612a) {
            case 4:
                ...
                ((gg.q1) this.f4613b).f9903f = false;
                return;
            case 7:
                super.onDetachedFromWindow();
                ((CheckBoxBase) this.f4613b).f21977l = false;
                return;
            default:
                super.onDetachedFromWindow();
                return;
    ...
    public void onDraw(Canvas canvas) {
        ...
        switch (this.f4612a) {
            case 3:
                ...
                yf.y yVar2 = k0Var.J;
                yVar2.c(AndroidUtilities.dp(42.0f) + k0Var.U.f10592b, 0);
                yVar2.setBounds(0, 0, getWidth(), AndroidUtilities.dp(56.0f) + k0Var.U.f10592b);
            ...
            case 7:
                ...
                return;
            case 11:
                org.telegram.ui.Cells.r2 r2Var = (org.telegram.ui.Cells.r2) this.f4613b;
                r2Var.f20717j4.setBounds(0, 0, getWidth(), getHeight());
                r2Var.f20717j4.draw(canvas);
                return;
            case 16:
                gr grVar = (gr) this.f4613b;
                if (grVar.Z) {
                    canvas.drawRect(gr.R(grVar), 0.0f, getMeasuredWidth() - gr.S(grVar), 1.0f, org.telegram.ui.ActionBar.j6.f18984k0);
                    return;
                }
                return;
            case 20:
                super.onDraw(canvas);
                ((ku0) this.f4613b).j(canvas, getMeasuredWidth(), getMeasuredHeight());
                return;
            case 23:
                super.onDraw(canvas);
                int offsetColor = AndroidUtilities.getOffsetColor(-9057429, -10513163, getTranslationX() / getMeasuredWidth(), 1.0f);
                int offsetColor2 = AndroidUtilities.getOffsetColor(-11554882, -4629871, getTranslationX() / getMeasuredWidth(), 1.0f);
                up0 up0Var = (up0) this.f4613b;
                RectF rectF = up0Var.h;
                Paint paint2 = up0Var.f24718f;
                if (offsetColor != 0) {
                ...
                return;
            case 24:
                qv0 qv0Var = (qv0) this.f4613b;
                if (qv0Var.f27413b != null && !qv0Var.J) {
                    Drawable newDrawable = qv0Var.getNewDrawable();
                    boolean newDrawableMotion = qv0Var.getNewDrawableMotion();
                    Drawable drawable3 = qv0Var.f27413b;
                    if (newDrawable != drawable3 && newDrawable != null) {
                        if (org.telegram.ui.ActionBar.j6.sl != null) {
                            qv0Var.d = drawable3;
                            qv0Var.e = qv0Var.f27415c;
                        }
                        if (newDrawable instanceof cc0) {
                            ((cc0) newDrawable).r(qv0Var.L);
                        }
                        qv0Var.f27413b = newDrawable;
                        if (qv0Var.M && (newDrawable instanceof fo)) {
                            ((fo) newDrawable).f(this);
                        }
                        if (qv0Var.M) {
                            Drawable drawable4 = qv0Var.f27413b;
                            if (drawable4 instanceof cc0) {
                                ((cc0) drawable4).k();
                            }
                        }
                        qv0Var.f27415c = newDrawableMotion;
                        qv0Var.f27426l0 = 0.0f;
                        qv0Var.U(qv0Var.f27413b);
                        qv0Var.I();
                    } else if (qv0Var.f27415c != newDrawableMotion) {
                        qv0Var.f27415c = newDrawableMotion;
                        qv0Var.I();
                    }
                    qv0Var.f27426l0 = Utilities.clamp((AndroidUtilities.screenRefreshTime / 200.0f) + qv0Var.f27426l0, 1.0f, 0.0f);
                    for (int i15 = 0; i15 < 2; i15++) {
                        if (i15 == 0) {
                            drawable = qv0Var.d;
                        } else {
                            drawable = qv0Var.f27413b;
                        }
                        if (drawable != null) {
                            boolean z11 = true;
                            if (i15 == 1 && qv0Var.d != null && qv0Var.G != null) {
                                drawable.setAlpha((int) (qv0Var.f27426l0 * 255.0f));
                            } else {
                            ...
                            if (drawable instanceof cc0) {
                                ...
                                if (z11) {
                                    ...
                                    int i17 = ((height2 - ceil2) / 2) + qv0Var.E + i16 + ((int) f11);
                                    canvas.save();
                                    canvas.clipRect(0, i16, ceil, getMeasuredHeight() - qv0Var.h);
                                    ...
                                    cc0Var.f23002f = qv0Var.E;
                                    drawable.setBounds(0, 0, getMeasuredWidth(), (int) ((getRootView().getMeasuredHeight() - qv0Var.E) + f11));
                                    drawable.draw(canvas);
                                    if (qv0Var.h != 0) {
                                        canvas.restore();
                                    }
                                ...
                                if (drawable instanceof ColorDrawable) {
                                    ...
                                    drawable.setBounds(0, qv0Var.E, getMeasuredWidth(), getRootView().getMeasuredHeight() + qv0Var.E);
                                    drawable.draw(canvas);
                                    qv0.G(qv0Var, canvas);
                                    if (qv0Var.h != 0) {
                                        canvas.restore();
                                    ...
                                    if (((BitmapDrawable) drawable).getTileModeX() == Shader.TileMode.REPEAT) {
                                        ...
                                        int i19 = ((height - ceil4) / 2) + qv0Var.E + i18 + ((int) f11);
                                        canvas.save();
                                        canvas.clipRect(0, i18, ceil3, getMeasuredHeight() - qv0Var.h);
                                    ...
                                    drawable.setBounds((int) A, (int) (qv0Var.E + A2), (int) ((getMeasuredWidth() * f7) + A), (int) org.telegram.ui.Cells.p6.a(getRootView().getMeasuredHeight(), f7, qv0Var.E, A2));
                                    drawable.draw(canvas);
                                    qv0.G(qv0Var, canvas);
                                    if (qv0Var.h != 0) {
                                        canvas.restore();
                            ...
                            if (i15 == 0 && (drawable2 = qv0Var.d) != null && qv0Var.f27426l0 >= f12) {
                                if (qv0Var.M && (drawable2 instanceof fo)) {
                                    ((fo) drawable2).g(qv0Var.L);
                                }
                                if (qv0Var.M) {
            ...
            case 26:
                ...
                gy0 gy0Var = (gy0) this.f4613b;
                org.telegram.ui.Components.voip.h hVar = gy0Var.L;
                Paint paint3 = gy0Var.f24415a;
                paint3.setColor(w02);
                Paint paint4 = gy0Var.f24416b;
                paint4.setColor(w02);
                Paint paint5 = gy0Var.f24417c;
                paint5.setColor(w02);
                paint4.setAlpha(255);
                paint5.setAlpha(82);
                paint3.setAlpha(46);
                Paint paint6 = gy0Var.d;
                paint6.setColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18862d6, false));
                ...
                boolean z12 = gy0Var.e;
                if (z12 || gy0Var.J != 0.0f) {
                    if (z12) {
                        if (gy0Var.K) {
                            float f16 = gy0Var.J + 0.024615385f;
                            gy0Var.J = f16;
                            if (f16 > 1.0f) {
                                gy0Var.J = 1.0f;
                                gy0Var.K = false;
                        ...
                        float f18 = gy0Var.J - 0.10666667f;
                        gy0Var.J = f18;
                        if (f18 < 0.0f) {
                            gy0Var.J = 0.0f;
                        }
                ...
                if (!gy0Var.e) {
                    int A3 = (int) (wl.A(24.0f, 2, getMeasuredWidth()) * gy0Var.F);
                ...
                if (!gy0Var.e) {
                    int A4 = (int) (wl.A(24.0f, 2, getMeasuredWidth()) * gy0Var.E);
            ...
            case 27:
                if (getAlpha() != 0.0f) {
                    ...
                    ((org.telegram.ui.Components.voip.j1) this.f4613b).f28988n.a(AndroidUtilities.dp(10.0f), canvas, rectF3, null);
                    invalidate();
                    return;
                }
                return;
        ...
        switch (this.f4612a) {
            case 1:
                ...
                if (iVar.H) {
                    ...
                    if (AndroidUtilities.dp(24.0f) + iVar.f37630y.getMeasuredHeight() > dp) {
                        dp = AndroidUtilities.dp(24.0f) + iVar.f37630y.getMeasuredHeight();
                    }
                    i12 = dp;
                }
            ...
            case 2:
                ...
                if (lVar.H) {
                    ...
                    if (AndroidUtilities.dp(24.0f) + lVar.f37630y.getMeasuredHeight() > dp2) {
                        dp2 = AndroidUtilities.dp(24.0f) + lVar.f37630y.getMeasuredHeight();
                    }
                    i13 = dp2;
                }
            ...
            case 9:
                ...
                return;
            case 12:
                org.telegram.ui.Components.za zaVar = (org.telegram.ui.Components.za) this.f4613b;
                int i18 = zaVar.h;
                if (i18 == 0) {
            ...
            case 14:
                ...
                return;
            case 15:
                super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i10), 1073741824), View.MeasureSpec.makeMeasureSpec(((vn) ((org.telegram.ui.y7) this.f4613b).d).f28832w, 1073741824));
                return;
            case 17:
                super.onMeasure(View.MeasureSpec.makeMeasureSpec(getPaddingRight() + getPaddingLeft() + Math.round(((h01) this.f4613b).l()), 1073741824), View.MeasureSpec.makeMeasureSpec(Math.max(getPaddingBottom() + getPaddingTop() + Math.round(((h01) this.f4613b).j()), AndroidUtilities.dp(26.0f)), 1073741824));
                return;
            case 18:
                super.onMeasure(i10, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(48.0f) + ((v60) this.f4613b).f28635c.f22635o0, 1073741824));
                return;
            case 19:
                int dp3 = AndroidUtilities.dp(48.0f);
                b70 b70Var = ((x60) this.f4613b).f29860n;
                super.onMeasure(i10, View.MeasureSpec.makeMeasureSpec(dp3 + b70Var.f22635o0 + b70Var.f22641u0, 1073741824));
                return;
            case 22:
                super.onMeasure(i10, View.MeasureSpec.makeMeasureSpec(((eq0) this.f4613b).K.J.R, 1073741824));
                return;
            case 25:
                ow0 ow0Var = (ow0) this.f4613b;
                ...
                xw0 xw0Var = ow0Var.d;
                int i20 = xw0Var.f30007g3;
                if (i20 > 0) {
                    i17 = AndroidUtilities.dp(4.0f) + i20;
                } else {
                    i17 = 0;
                }
                int max = Math.max(i17, (int) (size - Math.min(AndroidUtilities.dp(4.0f) + ((ow0Var.h() - 1) * size2), ow0Var.d.X2 * size2)));
                xw0Var.f30006f3 = max;
            ...
            case 26:
                ...
                return;
            case 29:
                t20 t20Var = (t20) this.f4613b;
                if (t20Var.H) {
                    t20Var.J = (t20.U(t20Var).getMeasuredHeight() + t20Var.I) - AndroidUtilities.dp(16.0f);
                } else {
                    int dp4 = AndroidUtilities.dp(140.0f) + t20Var.I;
                    if (AndroidUtilities.dp(24.0f) + t20Var.f37630y.getMeasuredHeight() > dp4) {
                        dp4 = Math.max(dp4, (AndroidUtilities.dp(24.0f) + t20Var.f37630y.getMeasuredHeight()) - t20Var.L);
                    }
                    t20Var.J = dp4;
                }
                int i21 = (int) (t20Var.J - (0 * 2.5f));
                t20Var.J = i21;
    ...
    public void onSizeChanged(int i10, int i11, int i12, int i13) {
        switch (this.f4612a) {
            case 27:
                ...
                ((org.telegram.ui.Components.voip.j1) this.f4613b).f28988n.f28942f = i10;
                return;
            default:
                super.onSizeChanged(i10, i11, i12, i13);
                return;
    ...
    public void setAlpha(float f7) {
        switch (this.f4612a) {
            case 10:
                super.setAlpha(f7);
                View view = ((org.telegram.ui.e8) this.f4613b).f33322b.f33905x.fragmentView;
                if (view != null) {
                    view.invalidate();
                    return;
                }
            ...
            case 28:
                super.setAlpha(f7);
                View view2 = ((wy) this.f4613b).fragmentView;
                if (view2 != null) {
                    view2.invalidate();
                    return;
                }
    ...
    public void setTranslationY(float f7) {
        switch (this.f4612a) {
            case 12:
                ...
                org.telegram.ui.Components.za.r((org.telegram.ui.Components.za) this.f4613b).invalidate();
                return;
            default:
                super.setTranslationY(f7);
                return;
