            ...
            case 3:
                ...
                if (g71Var != null && d7Var.F != null) {
                    ...
                    if (d7Var.getDuration() > 1) {
                        ...
                        if (!d7Var.F.f5905m1) {
                            o8 o8Var = d7Var.d;
                            if ((duration < o8Var.Z || duration > o8Var.f5138a0) && System.currentTimeMillis() - d7Var.J > 500) {
                ...
                return;
            case 4:
                d7 d7Var2 = this.f4348b;
                a7 a7Var2 = d7Var2.L;
                if (d7Var2.f4531y != null && d7Var2.e == null && d7Var2.f4529x == null && d7Var2.F != null && !d7Var2.j()) {
                    long n11 = d7Var2.f4531y.n();
                    o8 o8Var2 = d7Var2.d;
                    if (o8Var2 != null) {
                        float f7 = (float) n11;
                        float f10 = o8Var2.E;
                ...
                return;
            case 5:
                d7 d7Var3 = this.f4348b;
                a7 a7Var3 = d7Var3.M;
                if (d7Var3.f4529x != null && d7Var3.e == null && !d7Var3.j() && d7Var3.F != null) {
                    long n12 = d7Var3.f4529x.n();
                    o8 o8Var4 = d7Var3.d;
                    if (o8Var4 != null) {
                        float f12 = (float) n12;
                        float f13 = o8Var4.f5175s0;
                        float f14 = (float) o8Var4.f5171q0;
                        if ((f12 < f13 * f14 || f12 > o8Var4.f5177t0 * f14) && System.currentTimeMillis() - d7Var3.J > 500) {
                            d7Var3.J = System.currentTimeMillis();
                            g71 g71Var4 = d7Var3.f4529x;
                            o8 o8Var5 = d7Var3.d;
                            long j10 = o8Var5.f5175s0 * ((float) o8Var5.f5171q0);
                            g71Var4.L(j10, false);
                            d7Var3.w(true);
                            n12 = j10;
                        }
                ...
                return;
            default:
                d7 d7Var4 = this.f4348b;
                u61 u61Var = d7Var4.f4515n;
                if (u61Var != null) {
                    vz vzVar = u61Var.f28300b;
                    if (vzVar != null) {
                        vzVar.postRunnable(new sz(vzVar, 0));
                    }
                    u61Var.f28299a = null;
                    d7Var4.removeView(d7Var4.f4515n);
                    d7Var4.f4515n = null;
                    return;
                }
                return;
