...
public abstract class w3 extends xl0 {
    ...
    public String h;
    public TLRPC.User f5688n;
    public boolean f5689r;
    public final x3 f5691w;
    public final ArrayList f5686c = new ArrayList();
    public int e = -1;
    public final ColorDrawable f5690s = new ColorDrawable(285212671);
        ...
        if (!this.d) {
            ...
            if (this.f5688n == null) {
                ...
                if (userOrChat instanceof TLRPC.User) {
                    this.f5688n = (TLRPC.User) userOrChat;
                }
            }
            TLRPC.User user = this.f5688n;
            if (user == null && !this.f5689r) {
                ...
                tL_messages_getInlineBotResults.bot = messagesController.getInputUser(this.f5688n);
    ...
    public final void v(s4.c1 c1Var, int i10) {
        org.telegram.ui.Components.v9 v9Var = (org.telegram.ui.Components.v9) c1Var.f42995a;
        TLObject tLObject = (TLObject) this.f5686c.get(i10);
        boolean z10 = tLObject instanceof TLRPC.Document;
        ColorDrawable colorDrawable = this.f5690s;
        if (z10) {
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        return new s4.c1(new v3(this.f5691w.getContext(), 0));
    }
}
