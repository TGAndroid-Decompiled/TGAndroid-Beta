    ...
    public final void run(Object obj, Object obj2) {
        ...
        switch (this.f5758a) {
            case 0:
                ...
                w51 w51Var = (w51) obj2;
                g8 g8Var = this.f5759b;
                MessagesController.SavedMusicList savedMusicList = g8Var.f4700e0;
                w51Var.E = 1;
                int dp = AndroidUtilities.dp(64.0f);
                arrayList.add(i51.C(AndroidUtilities.dp(64.0f)));
                if (g8Var.Z || g8Var.f4703h0) {
                    dp += g8Var.W(true, arrayList, LocaleController.getString(R.string.AudioSearchLocal), g8Var.f4697b0, false, false, -1);
                }
                if (!g8Var.Z) {
                    if (TextUtils.isEmpty(g8Var.f4713s0) && !g8Var.f4703h0) {
                        w51Var.U();
                    ...
                    if (!g8Var.f4703h0 && savedMusicList != null) {
                    ...
                    ArrayList arrayList2 = g8Var.f4698c0;
                    if (!g8Var.f4717w0 && !g8Var.f4716v0) {
                        z10 = false;
                    } else {
                        z10 = true;
                    }
                    int W = dp + g8Var.W(false, arrayList, string, arrayList2, z10, g8Var.f4715u0, 3);
                    String string2 = LocaleController.getString(R.string.AudioSearchGlobal);
                    ArrayList arrayList3 = g8Var.f4699d0;
                ...
                if (!g8Var.Z && TextUtils.isEmpty(g8Var.f4713s0) && !g8Var.f4703h0) {
                    i10 = 2;
                } else {
                    i10 = 1;
                }
                if (size <= i10) {
                    if (TextUtils.isEmpty(g8Var.f4713s0)) {
                        ...
                        if (g8Var.f4713s0.length() >= 3) {
                            i11 = R.string.NoAudioFoundInfo2;
                        } else {
                            i11 = R.string.NoAudioFoundInfo;
                        }
                        SpannableStringBuilder replaceTags = AndroidUtilities.replaceTags(LocaleController.formatString(i11, g8Var.f4713s0));
                        int i13 = ej.f23676a;
                        i51 J2 = i51.J(ej.class);
                        J2.f24900l = string5;
                        J2.f24901m = replaceTags;
                        arrayList.add(J2);
                    }
                }
            ...
            default:
                ...
                g8.Q(this.f5759b, (TLRPC.messages_BotResults) obj);
                return;
        }
    }
}
