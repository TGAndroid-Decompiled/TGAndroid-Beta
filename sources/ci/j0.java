...
public abstract class j0 extends FrameLayout {
    public final d7 f4822a;
    public final org.telegram.ui.Components.c6 f4823b;
    public final org.telegram.ui.Components.c6 f4824c;
    public final i0 d;
    public final FrameLayout e;
    public final g0 f4825f;
    public final lg.f h;
    public final FrameLayout f4826n;
    public float f4827r;
    public final int[] f4828s;
    public final int[] v;
    public final lg.g f4829w;
    public o8 f4830x;
    ...
    public j0(Context context, d7 d7Var) {
        super(context);
        this.f4827r = 0.0f;
        this.f4828s = new int[2];
        this.v = new int[2];
        this.f4829w = new Object();
        this.f4822a = d7Var;
        i0 i0Var = new i0(this, context);
        this.d = i0Var;
        qr qrVar = qr.h;
        this.f4823b = new org.telegram.ui.Components.c6(i0Var, 0L, 320L, qrVar);
        this.f4824c = new org.telegram.ui.Components.c6(this, 0L, 360L, qrVar);
        ...
        textView.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view) {
                switch (r2) {
                    case 0:
                        ((yb) this.f4616b).E.l0(-1, false, true);
                        return;
                    case 1:
                        j0 j0Var = this.f4616b;
                        j0Var.f4825f.l(true);
                        lg.f fVar2 = j0Var.h;
                        ...
                        return;
                    default:
                        j0 j0Var2 = this.f4616b;
                        o8 o8Var = j0Var2.f4830x;
                        if (o8Var != null) {
                            o8Var.m0 = new MediaController.CropState();
                            j0Var2.f4825f.b(j0Var2.f4830x.m0);
                            o8 o8Var2 = j0Var2.f4830x;
    ...
    public int getCurrentHeight() {
        o8 o8Var = this.f4830x;
        if (o8Var == null) {
            return 1;
        }
        int i10 = o8Var.Q;
        d7 d7Var = this.f4822a;
        if (i10 != 90 && i10 != 270) {
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        this.f4825f.setBottomPadding(AndroidUtilities.dp(116.0f) + this.e.getPaddingBottom());
        super.onLayout(z10, i10, i11, i12, i13);
    }

    public void setAppearProgress(float f7) {
        if (Math.abs(this.f4827r - f7) < 0.001f) {
            return;
        }
        this.f4827r = f7;
        i0 i0Var = this.d;
    ...
    public void setEntry(o8 o8Var) {
        ...
        g0 g0Var = this.f4825f;
        g0Var.J = true;
        getLocationOnScreen(this.f4828s);
        int[] iArr = this.v;
        d7 d7Var = this.f4822a;
        ...
        g0Var.r(false);
        this.f4824c.d(gVar.f14063i, true);
        i0 i0Var = this.d;
