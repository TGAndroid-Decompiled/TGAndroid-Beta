...
public abstract class j0 extends FrameLayout {
    public final d7 f4826a;
    public final org.telegram.ui.Components.d6 f4827b;
    public final org.telegram.ui.Components.d6 f4828c;
    public final i0 d;
    public final FrameLayout e;
    public final g0 f4829f;
    public final lg.f h;
    public final FrameLayout f4830n;
    public float f4831r;
    public final int[] f4832s;
    public final int[] v;
    public final lg.g f4833w;
    public o8 f4834x;
    ...
    public j0(Context context, d7 d7Var) {
        super(context);
        this.f4831r = 0.0f;
        this.f4832s = new int[2];
        this.v = new int[2];
        this.f4833w = new Object();
        this.f4826a = d7Var;
        i0 i0Var = new i0(this, context);
        this.d = i0Var;
        qr qrVar = qr.h;
        this.f4827b = new org.telegram.ui.Components.d6(i0Var, 0L, 320L, qrVar);
        this.f4828c = new org.telegram.ui.Components.d6(this, 0L, 360L, qrVar);
        ...
        textView.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view) {
                switch (r2) {
                    case 0:
                        ((yb) this.f4620b).E.l0(-1, false, true);
                        return;
                    case 1:
                        j0 j0Var = this.f4620b;
                        j0Var.f4829f.l(true);
                        lg.f fVar2 = j0Var.h;
                        ...
                        return;
                    default:
                        j0 j0Var2 = this.f4620b;
                        o8 o8Var = j0Var2.f4834x;
                        if (o8Var != null) {
                            o8Var.m0 = new MediaController.CropState();
                            j0Var2.f4829f.b(j0Var2.f4834x.m0);
                            o8 o8Var2 = j0Var2.f4834x;
    ...
    public int getCurrentHeight() {
        o8 o8Var = this.f4834x;
        if (o8Var == null) {
            return 1;
        }
        int i10 = o8Var.Q;
        d7 d7Var = this.f4826a;
        if (i10 != 90 && i10 != 270) {
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        this.f4829f.setBottomPadding(AndroidUtilities.dp(116.0f) + this.e.getPaddingBottom());
        super.onLayout(z10, i10, i11, i12, i13);
    }

    public void setAppearProgress(float f7) {
        if (Math.abs(this.f4831r - f7) < 0.001f) {
            return;
        }
        this.f4831r = f7;
        i0 i0Var = this.d;
    ...
    public void setEntry(o8 o8Var) {
        ...
        g0 g0Var = this.f4829f;
        g0Var.J = true;
        getLocationOnScreen(this.f4832s);
        int[] iArr = this.v;
        d7 d7Var = this.f4826a;
        ...
        g0Var.r(false);
        this.f4828c.d(gVar.f14257i, true);
        i0 i0Var = this.d;
