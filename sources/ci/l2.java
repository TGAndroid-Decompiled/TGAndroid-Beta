...
public final class l2 extends FrameLayout {
    public final org.telegram.ui.ActionBar.f6 f4917a;
    public final FrameLayout f4918b;
    public final mn0 f4919c;
    public final h2 d;
    public final int e;
    public k2 f4920f;
    public boolean h;
            ...
            public final void onClick(View view) {
                switch (r2) {
                    case 0:
                        ...
                        return;
                    default:
                        l2 l2Var = this.f4621b;
                        int i12 = l2Var.f4919c.f26480k;
                        if (i12 == 1) {
                            l2Var.b();
    ...
    public final void a(int i10, boolean z10) {
        int i11;
        if (this.e == i10 && this.f4920f != null) {
            return;
        }
        k2 k2Var = this.f4920f;
        FrameLayout frameLayout = this.f4918b;
        if (k2Var != null) {
        ...
        k2 k2Var2 = new k2(this, context, i11, this.f4917a, z10);
        this.f4920f = k2Var2;
        h2 h2Var = this.d;
        ...
        this.f4920f.setOnScrollIntoOccupiedWidth(new Utilities.Callback(this) {
            public final l2 f4686b;
            ...
            public final void run(Object obj) {
                switch (r2) {
                    ...
                    default:
                        fx0 fx0Var = (fx0) obj;
                        l2 l2Var2 = this.f4686b;
                        k2 k2Var3 = l2Var2.f4920f;
                        if (k2Var3 != null) {
                            if (k2Var3.getSelectedCategory() == fx0Var) {
                                l2Var2.f4920f.G1(null);
                            ...
                            l2Var2.f4920f.G1(fx0Var);
                            String str = fx0Var.f24370a;
                            int categoryIndex = l2Var2.f4920f.getCategoryIndex();
        ...
        this.f4920f.setOnCategoryClick(new Utilities.Callback(this) {
            public final l2 f4686b;
        ...
        frameLayout.addView(this.f4920f, Math.max(0, frameLayout.getChildCount() - 1), w7.y5.d(-1, 36.0f, 51, 36.0f, 0.0f, 0.0f, 0.0f));
    }
    ...
    public final void d(boolean z10) {
        ...
        k2 k2Var;
        k2 k2Var2;
        boolean z11 = this.f4923s;
        h2 h2Var = this.d;
        if (z11 && ((h2Var.length() != 0 || ((k2Var2 = this.f4920f) != null && k2Var2.getSelectedCategory() != null)) && !z10)) {
            return;
        }
        if (h2Var.length() <= 0 && ((k2Var = this.f4920f) == null || k2Var.f25504o3 <= 0.5f || ((k2Var == null || !k2Var.j3) && k2Var.getSelectedCategory() == null))) {
            i10 = 0;
        } else {
            i10 = 1;
        }
