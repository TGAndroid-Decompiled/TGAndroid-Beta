    ...
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        switch (this.f5752a) {
            case 0:
                ...
                r6Var.A1.f40992a = i0.a.d(floatValue, ((Integer) this.d).intValue(), this.f5753b);
                m6 m6Var = r6Var.T0;
                if (m6Var != null) {
                    m6Var.invalidate();
                    return;
            ...
            default:
                ...
                p0Var.K1.f40992a = i0.a.d(floatValue2, ((Integer) this.d).intValue(), this.f5753b);
                qg.m0 m0Var = p0Var.f41540c1;
                if (m0Var != null) {
                    m0Var.invalidate();
                    return;
                }
