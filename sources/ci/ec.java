...
public final class ec extends r {
    ...
    public final boolean e() {
        ...
        if (MessagesController.getInstance(this.U).premiumFeaturesBlocked() || ((ocVar = org.telegram.ui.Components.oc.f26695w) != null && ocVar.f26696a == 2)) {
            return false;
        }
            ...
            if (!ecVar.f5006p0) {
                ...
                for (int i10 = 0; i10 < ocVar.f5272v1.R0.getChildCount(); i10++) {
                    ...
                    if (childAt instanceof qg.j) {
                        ...
                        float f11 = selectionBounds.f24950a;
                        float f12 = selectionBounds.f24951b;
                        rectF.set(f11, f12, selectionBounds.f24952c + f11, selectionBounds.d + f12);
