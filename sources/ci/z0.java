...
public final class z0 implements Runnable {
    ...
    public final void run() {
        ...
        switch (this.f5850a) {
            case 0:
                MessagesStorage messagesStorage = this.f5851b;
                a1 a1Var = this.f5852c;
                ...
                if (database != null) {
                    ...
                    sQLitePreparedStatement.bindLong(1, a1Var.f4310a);
                    sQLitePreparedStatement.bindLong(2, a1Var.f4312b);
                ...
                return;
            default:
                MessagesStorage messagesStorage2 = this.f5851b;
                a1 a1Var2 = this.f5852c;
                ...
                try {
                    ...
                    if (database2 != null) {
                        ...
                        sQLitePreparedStatement2.bindLong(1, a1Var2.f4310a);
                        sQLitePreparedStatement2.bindLong(2, a1Var2.f4312b);
