    ...
    public final void onClick(View view) {
        ...
        switch (i13) {
            case 0:
                ...
                if (ocVar2.K1 != null && ocVar2.C2 == null && ocVar2.f5233i1 != null) {
                    ValueAnimator valueAnimator = ocVar2.E2;
                    if (valueAnimator == null || !valueAnimator.isRunning()) {
                        boolean z12 = ocVar2.K1.f5192y0;
                        Bitmap createBitmap = Bitmap.createBitmap(ocVar2.f5245n.getWidth(), ocVar2.f5245n.getHeight(), Bitmap.Config.ARGB_8888);
                        Canvas canvas = new Canvas(createBitmap);
                        ocVar2.f5233i1.setAlpha(0.0f);
                        cc ccVar = ocVar2.X0;
                        if (ccVar != null) {
                            ccVar.f4515g0 = true;
                        }
                        qb qbVar = ocVar2.f5273v1;
                        if (qbVar != null) {
                            qbVar.I0 = true;
                        }
                        ocVar2.f5245n.draw(canvas);
                        cc ccVar2 = ocVar2.X0;
                        if (ccVar2 != null) {
                            ccVar2.f4515g0 = false;
                        }
                        qb qbVar2 = ocVar2.f5273v1;
                        if (qbVar2 != null) {
                            qbVar2.I0 = false;
                        }
                        ocVar2.f5233i1.setAlpha(1.0f);
                        ...
                        int[] iArr = new int[2];
                        ocVar2.f5233i1.getLocationInWindow(iArr);
                        float f7 = iArr[0];
                        float f10 = iArr[1];
                        Shader.TileMode tileMode = Shader.TileMode.CLAMP;
                        paint2.setShader(new BitmapShader(createBitmap, tileMode, tileMode));
                        wb wbVar = new wb(ocVar2, ocVar2.f5208b, z12, canvas, (ocVar2.f5233i1.getMeasuredWidth() / 2.0f) + f7, (ocVar2.f5233i1.getMeasuredHeight() / 2.0f) + f10, Math.max(createBitmap.getHeight(), createBitmap.getWidth()) + AndroidUtilities.navigationBarHeight, paint, createBitmap, paint2, f7, f10, 0);
                        ocVar2.C2 = wbVar;
                        ...
                        ocVar2.E2.start();
                        ocVar2.f5245n.addView(ocVar2.C2, new ViewGroup.LayoutParams(-1, -1));
            ...
            case 2:
                ...
                if (o8Var != null && !ocVar.S1) {
                    ...
                    boolean isEmpty = TextUtils.isEmpty(ocVar.K1.f5191y);
                    o8 o8Var2 = ocVar.K1;
                    if (o8Var2.f5173o0 != null) {
                        z10 = true;
                    } else {
                        z10 = false;
                    }
                    if (ocVar.f5226g0 == -1) {
                        f4 f4Var = ocVar.f5239k1;
                        if (o8Var2.Y) {
                            if (isEmpty && !z10) {
            ...
            case 3:
                ...
                ocVar.X0.x(-9982, k10);
                ((pg0) ocVar.f5236j1.f5518c).a(!k10, true);
                return;
            case 4:
                    ...
                    if (C != null && !C.equals(F)) {
                        ...
                        if (rbVar != null && rbVar.getCameraSession() != null) {
                            if (ocVar.B0.isFrontface() && !ocVar.B0.getCameraSession().hasFlashModes()) {
                                int indexOf = ocVar.f5271u2.indexOf(F);
                                if (indexOf >= 0) {
                                    ocVar.f5268t2 = indexOf;
                                    MessagesController.getGlobalMainSettings().edit().putInt("frontflash", ocVar.f5268t2).apply();
                                }
                            } else {
            ...
            case 5:
                rb rbVar2 = ocVar.B0;
                if (rbVar2 != null && ocVar.f5223f0 == 0) {
                    rbVar2.toggleDual();
                    ...
                    ocVar.f5243m1.e(true);
                    return;
                }
                return;
            case 6:
                if (ocVar.f5223f0 == 0 && !ocVar.a2) {
                    rb rbVar3 = ocVar.B0;
                    if (rbVar3 != null && rbVar3.isDual()) {
                        ocVar.B0.toggleDual();
                    }
                    if (!ocVar.I0.e && !ocVar.A0.j()) {
                        ocVar.A0.o(ocVar.f5287z0);
                        ocVar.I0.setSelected(ocVar.f5287z0);
                        ocVar.G0.a(new u(ocVar.f5287z0, false), true);
            ...
            case 9:
                rb rbVar6 = ocVar.B0;
                if (rbVar6 != null && !ocVar.S1 && !ocVar.P1 && rbVar6.isInited() && ocVar.f5223f0 == 0) {
            ...
            case 11:
                ...
                if (o8Var3 != null) {
                    o8Var3.f5157f0 = true;
                    o8Var3.f5154e0 = ocVar.M1;
                    ocVar.X();
                    o8 o8Var4 = ocVar.K1;
                    if (o8Var4 != null && !o8Var4.f5147b0) {
