...
public class e4 extends View {
    ...
    public int f4600a;
    public org.telegram.ui.Cells.z f4601a0;
    public float f4602b;
    ...
    public int f4610g0;
    public int h;
    public boolean f4611h0;
    public float f4612i0;
    ...
    public final RectF f4624s0;
    public final Path f4625t0;
    public float f4626u0;
    public float v;
    public float f4627v0;
    public final RectF f4628w;
    public float f4629w0;
    public float f4630x;
    public float f4631x0;
    public float f4632y;
    ...
    public e4(Context context, int i10) {
        ...
        this.f4628w = new RectF(AndroidUtilities.dp(11.0f), AndroidUtilities.dp(6.0f), AndroidUtilities.dp(11.0f), AndroidUtilities.dp(7.0f));
        this.f4630x = AndroidUtilities.dp(2.0f);
        this.f4632y = AndroidUtilities.dp(7.0f);
    ...
    public static java.lang.CharSequence b(java.lang.CharSequence r12, android.text.TextPaint r13) {
        throw new UnsupportedOperationException("Method not decompiled: ci.e4.b(java.lang.CharSequence, android.text.TextPaint):java.lang.CharSequence");
    }
        ...
        if (t51VarArr != null && t51VarArr.length != 0) {
            ...
            for (int i13 = 0; i13 < t51VarArr.length; i13++) {
                ...
                if (i12 - max > 0) {
                    ...
                    textPaint3.setTypeface(t51VarArr[i13].f28468a);
    ...
    public void c(Canvas canvas, float f7) {
        int i10 = this.f4614k0;
        Paint paint = this.F;
        if (i10 != 0) {
            paint.setShadowLayer(this.f4612i0, 0.0f, this.f4613j0, org.telegram.ui.ActionBar.h6.l1(f7, i10));
        }
        ...
        if (this.A0) {
            ...
            this.G0.reset();
            this.G0.postTranslate(this.f4622r0.left + (((this.f4629w0 * 4.0f) + (dp * 2)) * (((float) ((System.currentTimeMillis() - this.I0) % 4000)) / 4000.0f)) + (-dp), 0.0f);
    ...
    public final void d(Path path, float f7, float f10, float f11, RectF rectF, Rect rect) {
        ...
        int i10 = this.f4600a;
        if (i10 != 1 && i10 != 3) {
            float clamp = Utilities.clamp(AndroidUtilities.lerp(getPaddingTop(), getMeasuredHeight() - getPaddingBottom(), this.f4602b) + this.f4604c, getMeasuredHeight() - getPaddingBottom(), getPaddingTop());
            float min2 = Math.min(Math.max(getPaddingTop(), clamp - f14) + f10, getMeasuredHeight() - getPaddingBottom());
            float f15 = min2 - f10;
            float f16 = this.f4632y;
            ...
            float clamp2 = Utilities.clamp(AndroidUtilities.lerp(getPaddingLeft(), getMeasuredWidth() - getPaddingRight(), this.f4602b) + this.f4604c, getMeasuredWidth() - getPaddingRight(), getPaddingLeft());
            float min3 = Math.min(Math.max(getPaddingLeft(), clamp2 - f13) + f7, getMeasuredWidth() - getPaddingRight());
            float f17 = min3 - f7;
            float f18 = this.f4632y;
        ...
        if (this.f4600a == 0) {
            path.lineTo(rectF.left, this.f4632y + f12 + AndroidUtilities.dp(2.0f));
            path.lineTo(rectF.left, this.f4632y + f12);
            ...
            path.lineTo(rectF.left, f12 - this.f4632y);
            path.lineTo(rectF.left, (f12 - this.f4632y) - AndroidUtilities.dp(2.0f));
            if (rect != null) {
        ...
        if (this.f4600a == 1) {
            path.lineTo((f12 - this.f4632y) - AndroidUtilities.dp(2.0f), rectF.top);
            path.lineTo(f12 - this.f4632y, rectF.top);
            path.lineTo(f12 - AndroidUtilities.dp(1.0f), rectF.top - this.E);
            this.f4626u0 = f12;
            this.f4627v0 = rectF.top - this.E;
            path.lineTo(AndroidUtilities.dp(1.0f) + f12, rectF.top - this.E);
            path.lineTo(this.f4632y + f12, rectF.top);
            path.lineTo(this.f4632y + f12 + AndroidUtilities.dp(2.0f), rectF.top);
            if (rect != null) {
        ...
        if (this.f4600a == 2) {
            path.lineTo(rectF.right, (f12 - this.f4632y) - AndroidUtilities.dp(2.0f));
            path.lineTo(rectF.right, f12 - this.f4632y);
            ...
            path.lineTo(rectF.right, this.f4632y + f12);
            path.lineTo(rectF.right, this.f4632y + f12 + AndroidUtilities.dp(2.0f));
            if (rect != null) {
        ...
        if (this.f4600a == 3) {
            path.lineTo(this.f4632y + f12 + AndroidUtilities.dp(2.0f), rectF.bottom);
            path.lineTo(this.f4632y + f12, rectF.bottom);
            path.lineTo(AndroidUtilities.dp(1.0f) + f12, rectF.bottom + this.E);
            this.f4626u0 = f12;
            this.f4627v0 = rectF.bottom + this.E;
            path.lineTo(f12 - AndroidUtilities.dp(1.0f), rectF.bottom + this.E);
            path.lineTo(f12 - this.f4632y, rectF.bottom);
            path.lineTo((f12 - this.f4632y) - AndroidUtilities.dp(2.0f), rectF.bottom);
            if (rect != null) {
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        if (!this.I || this.L != null) {
            ...
            if (this.f4621r) {
                ...
                d += this.f4630x + this.f4616n.getIntrinsicWidth();
                f7 = Math.max(this.f4616n.getIntrinsicHeight(), f7);
            }
            if (this.f4605c0 != null) {
                d += this.f4609f0 + this.f4607e0;
                f7 = Math.max(this.f4610g0, f7);
            }
            float f14 = d;
            RectF rectF2 = this.f4628w;
            float f15 = rectF2.left + f14 + rectF2.right;
            float f16 = rectF2.top + f7 + rectF2.bottom;
            boolean z12 = this.f4633y0;
            RectF rectF3 = this.f4622r0;
            if (z12 && Math.abs(f15 - this.f4629w0) <= 0.1f && Math.abs(f16 - this.f4631x0) <= 0.1f) {
                rectF = rectF3;
            } else {
                this.f4629w0 = f15;
                this.f4631x0 = f16;
                d(this.f4625t0, f15, f16, 0.0f, rectF3, this.f4620q0);
                rectF = rectF3;
                if (this.A0) {
                    d(this.B0, f15, f16, this.C0, this.f4624s0, null);
                }
            }
            if (this.f4608f) {
                f10 = e;
            ...
            if (e < 1.0f && this.e) {
                ...
                canvas.scale(lerp, lerp, this.f4626u0, this.f4627v0);
            }
            float a2 = this.f4619p0.a(0.025f);
            if (a2 != 1.0f) {
                canvas.scale(a2, a2, this.f4626u0, this.f4627v0);
            }
            if (this.f4618o0 != 1.0f) {
                int i10 = this.f4600a;
                int i11 = -1;
                if (i10 != 3 && i10 != 1) {
                    if (i10 == 0) {
                    ...
                    float max = (this.f4618o0 - 1.0f) * Math.max(paddingRight, AndroidUtilities.dp(24.0f));
                    if (this.f4600a != 0) {
                        i11 = 1;
                    }
                    ...
                    float max2 = (this.f4618o0 - 1.0f) * Math.max(paddingTop, AndroidUtilities.dp(24.0f));
                    if (this.f4600a != 1) {
                        i11 = 1;
                    }
            ...
            if (jj0Var != null) {
                if (this.f4611h0) {
                    ...
                    jj0Var.setBounds((int) f19, (int) (f20 - f21), (int) (f19 + this.f4609f0), (int) (f21 + f20));
                    ...
                    jj0Var.setBounds((int) (f22 - this.f4609f0), (int) (f23 - f24), (int) f22, (int) (f24 + f23));
                    f12 = 0.0f;
                }
                this.f4605c0.setAlpha((int) (f10 * f11));
                this.f4605c0.draw(canvas);
            } else {
                f11 = 255.0f;
                f12 = 0.0f;
            }
            if (this.I) {
                ...
                float f25 = ((f12 + rectF.left) + rectF2.left) - e4Var.N;
                e4Var.R = f25;
                ...
                o6Var.f26979w = (int) (f13 * f11);
                o6Var.draw(canvas2);
            }
            if (e4Var.f4621r) {
                if (e4Var.f4616n == null) {
                    Drawable mutate2 = e4Var.getContext().getResources().getDrawable(R.drawable.msg_mini_close_tooltip).mutate();
                    e4Var.f4616n = mutate2;
                    mutate2.setColorFilter(new PorterDuffColorFilter(2113929215, PorterDuff.Mode.MULTIPLY));
                }
                e4Var.f4616n.setAlpha((int) (f13 * f11));
                Drawable drawable = e4Var.f4616n;
                drawable.setBounds((int) ((rectF.right - (rectF2.right * 0.66f)) - drawable.getIntrinsicWidth()), (int) (rectF.centerY() - (e4Var.f4616n.getIntrinsicHeight() / 2.0f)), (int) (rectF.right - (rectF2.right * 0.66f)), (int) ((e4Var.f4616n.getIntrinsicHeight() / 2.0f) + rectF.centerY()));
                e4Var.f4616n.draw(canvas2);
            }
            canvas2.restore();
        }
    }
    ...
    public final void e(boolean z10) {
        ...
        if (runnable2 != null) {
            AndroidUtilities.runOnUIThread(runnable2, e6Var.f23850c * ((float) e6Var.f23852g));
        }
        this.Q.d(true);
    }
    ...
    public final void i() {
        ...
        if (!this.I) {
            ...
            this.f4628w.set(dp, dp2, AndroidUtilities.dp(f7), AndroidUtilities.dp(7.0f));
        }
    }

    public final void j(jj0 jj0Var) {
        jj0 jj0Var2 = this.f4605c0;
        if (jj0Var2 != null) {
            jj0Var2.setCallback(null);
        }
        this.f4605c0 = jj0Var;
        jj0Var.setCallback(this);
        jj0 jj0Var3 = this.f4605c0;
        if (com.google.android.gms.internal.vision.e2.u(jj0Var3)) {
            this.d = Math.max(this.d, jj0Var3.r());
        }
        jj0 jj0Var4 = this.f4605c0;
        this.f4609f0 = jj0Var4.f25423b;
        this.f4610g0 = jj0Var4.f25425c;
        this.f4611h0 = true;
    }

    public final void k(float f7, float f10, float f11, float f12) {
        this.f4628w.set(AndroidUtilities.dpf2(f7), AndroidUtilities.dpf2(f10), AndroidUtilities.dpf2(f11), AndroidUtilities.dpf2(f12));
    }

    public final void l(float f7, float f10) {
        if (Math.abs(this.f4602b - f7) >= 1.0f || Math.abs(this.f4604c - AndroidUtilities.dp(f10)) >= 1.0f) {
            this.f4633y0 = false;
            invalidate();
        }
        this.f4602b = f7;
        this.f4604c = AndroidUtilities.dp(f10);
    }

    public final void m(float f7, float f10) {
        if (Math.abs(this.f4602b - f7) >= 1.0f || Math.abs(this.f4604c - f10) >= 1.0f) {
            this.f4633y0 = false;
            invalidate();
        }
        this.f4602b = f7;
    ...
    public final boolean onTouchEvent(android.view.MotionEvent r15) {
        throw new UnsupportedOperationException("Method not decompiled: ci.e4.onTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    public final void p(boolean z10) {
        ...
        if (z10) {
            ...
            this.f4630x = AndroidUtilities.dp(6.0f);
            return;
        }
        float dp = AndroidUtilities.dp(11.0f);
        float dp2 = AndroidUtilities.dp(6.0f);
    ...
    public final void u() {
        if (this.V && this.U) {
            ValueAnimator valueAnimator = this.f4617n0;
            ...
            this.f4617n0.setInterpolator(sr.f28343k);
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        if (drawable != this.H && drawable != this.f4601a0 && drawable != this.f4605c0 && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
