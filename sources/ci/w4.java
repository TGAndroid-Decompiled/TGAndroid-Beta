    ...
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        switch (this.f5723a) {
            case 0:
                ...
                q6Var.A1.f41265a = i0.a.d(floatValue, ((Integer) this.d).intValue(), this.f5724b);
                l6 l6Var = q6Var.T0;
                if (l6Var != null) {
                    l6Var.invalidate();
                    return;
            ...
            default:
                ...
                n0Var.K1.f41265a = i0.a.d(floatValue2, ((Integer) this.d).intValue(), this.f5724b);
                qg.l0 l0Var = n0Var.f41773c1;
                if (l0Var != null) {
                    l0Var.invalidate();
                    return;
                }
