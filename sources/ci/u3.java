    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        switch (i10) {
            ...
            case 5:
                ...
                return;
            case 6:
                AndroidUtilities.runOnUIThread(new ai.s4((kp) obj, tL_error, tLObject, this.f5603b, 13));
                return;
            case 7:
                AndroidUtilities.runOnUIThread(new org.telegram.ui.ActionBar.p((ae0) obj, tL_error, tLObject, z10));
                return;
            case 8:
                AndroidUtilities.runOnUIThread(new ai.s4((n70) obj, tL_error, tLObject, this.f5603b, 22));
                return;
            case 9:
                AndroidUtilities.runOnUIThread(new ai.s4((an0) obj, tL_error, tLObject, this.f5603b, 23));
                return;
            case 10:
                AndroidUtilities.runOnUIThread(new ai.s4((wo0) obj, tL_error, tLObject, this.f5603b, 26));
                return;
            case 11:
                ar0 ar0Var = (ar0) obj;
                if (tLObject != null) {
                ...
                return;
            case 12:
                AndroidUtilities.runOnUIThread(new ai.s4((gh1) obj, tL_error, tLObject, this.f5603b, 28));
                return;
            default:
