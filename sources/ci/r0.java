...
public final class r0 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final File f5390b;
    public MessageObject f5391c;
    public final p0 d;
    public final q0 e;
    public final o0 f5392f;
    ...
    public r0(int i10, o8 o8Var, File file, p0 p0Var, q0 q0Var, o0 o0Var) {
        ...
        this.f5391c = new MessageObject(i10, (TLRPC.Message) tL_message, (MessageObject) null, false, false);
    ...
    public final void a(boolean z10) {
        ...
        if (z10) {
            MediaController.getInstance().cancelVideoConvert(this.f5391c);
        }
        this.f5391c = null;
    }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.filePreparingStarted) {
            ...
            if (((MessageObject) objArr[0]) == this.f5391c) {
        ...
        } else if (i10 == NotificationCenter.filePreparingFailed && ((MessageObject) objArr[0]) == this.f5391c) {
            a(false);
            try {
