...
public final class u9 extends og.b {
    ...
    public final int j(int i10) {
        ...
        if (arrayList != null && i10 >= 0 && i10 < arrayList.size()) {
            return ((k9) y9Var.L.get(i10)).f15508a;
        }
        return -1;
    }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (arrayList != null && i10 >= 0 && i10 < arrayList.size()) {
            ...
            if (k9Var != null && ((i14 = k9Var.f15508a) == i15 || (i14 == 9 && k9Var.f4915q == 1))) {
                z10 = true;
            } else {
                z10 = false;
            }
            if (i15 == 3) {
                ...
                if (i15 == 0) {
                    ...
                    f9Var.setText(k9Var2.e);
                } else if (i15 == 7) {
                    int i18 = k9Var2.f4904c;
                    if (i18 == 0) {
                        ((org.telegram.ui.Cells.s8) view).j(k9Var2.e, faVar.f4706x, z10);
                    } else if (i18 == 1) {
                        ((org.telegram.ui.Cells.s8) view).j(k9Var2.e, faVar.f4707y, z10);
                    } else if (i18 == 2) {
                        ((org.telegram.ui.Cells.s8) view).j(k9Var2.e, faVar.f4705w, z10);
                    }
                } else if (i15 == 9) {
                    Drawable drawable = k9Var2.d;
                    if (drawable != null) {
                        ((org.telegram.ui.Cells.s8) view).t(k9Var2.e, drawable, z10);
                    } else {
                        ((org.telegram.ui.Cells.s8) view).o(k9Var2.e, k9Var2.f4905f, false, z10);
                    }
                } else if (i15 == 8) {
        ...
        if (i10 == -1) {
            ...
            if (i10 == 3) {
                ...
                if (i10 == 4) {
                    ...
                    lnVar.setBackgroundColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f18859h5, d6Var));
                } else if (i10 == 5) {
                    ...
                    lnVar = new org.telegram.ui.Cells.f9(context, d6Var);
                    ...
                    if (i10 == 7) {
                        ...
                        lnVar = new org.telegram.ui.Cells.a8(context, d6Var);
                    } else {
