...
public final class q extends Drawable {
    ...
    public final kj0 h;
    public final ec f5326i;
    public final ec f5327j;
    ...
    public final void draw(Canvas canvas) {
        ...
        kj0 kj0Var = this.h;
        if (z10) {
            kj0Var.setAlpha((int) (this.f5322b * 255.0f * this.f5323c));
        }
        Paint paint = this.f5321a;
        paint.setAlpha((int) (this.f5322b * 255.0f * this.f5323c));
        long currentTimeMillis = System.currentTimeMillis() - this.d;
        if (!this.e && !this.f5325g) {
            float f7 = this.f5322b - (((float) currentTimeMillis) / 600.0f);
            this.f5322b = f7;
            if (f7 <= 0.0f) {
                this.f5322b = 0.0f;
                this.e = true;
            ...
            float f10 = (((float) currentTimeMillis) / 600.0f) + this.f5322b;
            this.f5322b = f10;
            if (f10 >= 1.0f) {
                this.f5322b = 1.0f;
                this.e = false;
