...
public final class q0 implements Utilities.Callback {
    ...
    public final void run(Object obj) {
        switch (this.f5324a) {
            ...
            case 1:
                Uri uri = (Uri) obj;
                u0 u0Var = this.f5325b;
                if (u0Var.f5588c && u0Var.f5591r != null) {
                    u0Var.f5590n.b(R.raw.ic_save_to_gallery, 3500, LocaleController.getString("VideoSavedHint"));
                    u0Var.f5588c = false;
                    u0Var.d();
                    u0Var.v = uri;
                    return;
