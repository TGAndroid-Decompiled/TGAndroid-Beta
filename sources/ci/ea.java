...
public final class ea extends ViewGroup {
    ...
    public void a() {
        ...
        this.f4605b = animatorSet;
        animatorSet.addListener(new da(this, arrayList2, 1));
        ArrayList arrayList4 = this.f4607f;
        arrayList4.clear();
    ...
    public final void c() {
        switch (this.f4604a) {
            case 0:
                AnimatorSet animatorSet = this.f4605b;
                if (animatorSet != null) {
                    animatorSet.cancel();
                }
                int i10 = 0;
            ...
            default:
                AnimatorSet animatorSet2 = this.f4605b;
