...
public final class ib implements Runnable {
    ...
    public final jb f4817b;
    public final Runnable f4818c;
    ...
    public final void run() {
        ...
        switch (this.f4816a) {
            case 0:
                boolean z10 = this.d;
                this.f4817b.f(this.f4818c, z10);
                return;
            default:
                this.f4818c.run();
                oc ocVar = this.f4817b.f4858a;
                c4 c4Var = ocVar.T0;
                if (this.d) {
                ...
                c4Var.f4426a.q(LocaleController.getString(i10), false, true);
                c4Var.invalidate();
                ocVar.h(true, true);
                ocVar.d0(true);
