...
public abstract class e0 extends FrameLayout implements m70 {
    public static final int f4550x0 = 0;
    ...
    public float V;
    public float W;
    public final FrameLayout f4551a;
    public float f4552a0;
    public final ai.d f4553b;
    public float f4554b0;
    public final g7 f4555c;
    public float f4556c0;
    public CameraView d;
    public float f4557d0;
    public Object e;
    public boolean f4558e0;
    public t f4559f;
    ...
    public a0 f4563i0;
    public d0 f4564j0;
    public boolean f4565k0;
    public Runnable f4566l0;
    public Runnable m0;
    public final ArrayList f4567n;
    public boolean f4568n0;
    public long f4569o0;
    public boolean f4570p0;
    ...
    public final Path f4579w;
    public final a0 f4580w0;
    ...
    public e0(Context context, org.telegram.ui.Components.ha haVar, FrameLayout frameLayout, ai.d dVar) {
        super(context);
        this.f4555c = new g7(new a0(this, 1));
        this.f4559f = new t(".");
        ...
        this.v = paint;
        this.f4579w = new Path();
        this.f4581x = new float[8];
        ...
        this.f4571q0 = true;
        this.f4576t0 = true;
        this.f4580w0 = new a0(this, 3);
        this.G = haVar;
        this.f4551a = frameLayout;
        this.f4553b = dVar;
        setBackgroundColor(-14737633);
        d0 d0Var = new d0(this);
        d0Var.b((s) this.f4559f.e.get(0), false);
        d0Var.f4470m = true;
        if (this.f4565k0) {
            d0Var.f4463c.onAttachedToWindow();
        }
        arrayList.add(d0Var);
        this.f4572r = d0Var;
        this.f4574s = null;
    ...
    public final void a(RectF rectF) {
        d0 d0Var = this.f4564j0;
        if (d0Var != null) {
            s sVar = d0Var.h;
            t tVar = sVar.f5477a;
            int i10 = sVar.f5478b;
            int i11 = sVar.f5479c;
            float f7 = tVar.f5530c;
    ...
    public final void b(Canvas canvas, float f7) {
        ...
        if (d0Var != null) {
            ...
            g(canvas, rectF, this.f4564j0);
        }
    }

    public final boolean d() {
        if (this.f4561g0 == null) {
            return false;
        }
        this.f4561g0 = null;
        this.f4558e0 = false;
        invalidate();
        a0 a0Var = this.f4563i0;
        if (a0Var != null) {
        ...
        if (j() && !this.f4568n0) {
            ...
            while (true) {
                ...
                if (i10 < size) {
                    ...
                    int i11 = sVar.f5479c;
                    int i12 = sVar.f5478b;
                    float f10 = c6VarArr[i11].f22951c;
            ...
            if (motionEvent.getAction() == 0) {
                ...
                if (v7.z6.a(motionEvent.getX(), motionEvent.getY(), this.V, this.W) > AndroidUtilities.touchSlop * 1.2f && (a0Var = this.f4563i0) != null) {
                    AndroidUtilities.cancelRunOnUIThread(a0Var);
                    this.f4563i0 = null;
                }
                if (!this.f4558e0 && getFilledProgress() >= 1.0f && this.f4561g0 != null && d0Var != null && v7.z6.a(motionEvent.getX(), motionEvent.getY(), this.V, this.W) > AndroidUtilities.touchSlop * 1.2f) {
                    this.f4558e0 = true;
                    this.f4562h0 = this.f4561g0;
                    this.f4556c0 = 0.0f;
                    this.f4552a0 = 0.0f;
                    this.f4557d0 = 0.0f;
                    this.f4554b0 = 0.0f;
                    invalidate();
                    a0 a0Var3 = this.f4563i0;
                    if (a0Var3 != null) {
                        AndroidUtilities.cancelRunOnUIThread(a0Var3);
                        this.f4563i0 = null;
                    }
                } else if (this.f4558e0 && this.f4562h0 != null) {
                    float x11 = motionEvent.getX();
                    float y10 = motionEvent.getY();
                    float f11 = c6Var.f22951c;
                    int i13 = 0;
                    while (true) {
                        if (i13 < arrayList.size()) {
                            s sVar2 = ((d0) arrayList.get(i13)).h;
                            int i14 = sVar2.f5479c;
                            int i15 = sVar2.f5478b;
                            float f12 = c6VarArr[i14].f22951c;
                    ...
                    int indexOf = arrayList.indexOf(this.f4562h0);
                    if (i13 >= 0 && indexOf >= 0 && i13 != indexOf) {
                        Collections.swap(arrayList, indexOf, i13);
                        o(this.f4559f);
                        this.f4560f0 = true;
                        invalidate();
                        float f13 = this.f4559f.f5530c;
                        s sVar3 = this.f4562h0.h;
                        int i16 = sVar3.f5479c;
                        int i17 = sVar3.f5478b;
                        float f14 = c6VarArr[i16].f22951c;
                        rectF.set((getMeasuredWidth() / f14) * i17, (getMeasuredHeight() / f13) * i16, (getMeasuredWidth() / f14) * (i17 + 1), (getMeasuredHeight() / f13) * (i16 + 1));
                        this.f4552a0 = this.f4556c0;
                        this.f4554b0 = this.f4557d0;
                        this.V = rectF.centerX();
                        this.W = rectF.centerY();
                    }
                    this.f4556c0 = motionEvent.getX() - this.V;
                    this.f4557d0 = motionEvent.getY() - this.W;
                    invalidate();
                } else if (this.f4561g0 != d0Var) {
                    this.f4561g0 = null;
                    a0 a0Var4 = this.f4563i0;
                    if (a0Var4 != null) {
            ...
            if (this.f4561g0 != null || super.dispatchTouchEvent(motionEvent)) {
                return true;
            }
            return false;
        }
    ...
    public long getDuration() {
        d0 mainPart;
        o8 o8Var;
        if (!this.f4568n0 || (mainPart = getMainPart()) == null || (o8Var = mainPart.f4471n) == null) {
            return 1L;
        }
        return Math.max(Math.min((o8Var.W - o8Var.V) * ((float) o8Var.f5156h0), 59500L), 1L);
    }
    ...
    public int getFilledCount() {
        ...
        while (true) {
            ...
            if (i10 < arrayList.size()) {
                if (((d0) arrayList.get(i10)).f4471n != null) {
                    i11++;
                }
                i10++;
            } else {
    ...
    public d0 getMainPart() {
        ...
        while (i10 < size) {
            ...
            i10++;
            d0 d0Var2 = (d0) obj;
            o8 o8Var = d0Var2.f4471n;
            if (o8Var != null && o8Var.K) {
                long j10 = o8Var.f5156h0;
                c0 c0Var = d0Var2.d;
    ...
    public ArrayList<Integer> getOrder() {
        ...
        while (true) {
            ...
            if (i10 < arrayList2.size()) {
                i10 = com.google.android.gms.internal.vision.e2.e(((d0) arrayList2.get(i10)).f4461a, i10, 1, arrayList);
            } else {
                return arrayList;
            }
        }
    ...
    public long getPosition() {
        ...
        long j3 = currentTimeMillis - this.f4569o0;
        if (j3 > getDuration()) {
            this.f4569o0 = currentTimeMillis - (j3 % getDuration());
        }
        return j3;
    }
    ...
    public long getPositionWithOffset() {
        ...
        if (mainPart != null) {
            o8 o8Var = mainPart.f4471n;
            j3 = o8Var.X + (o8Var.V * ((float) o8Var.f5156h0));
        }
    ...
    public final void h(float f7, Canvas canvas, RectF rectF, View view) {
        ...
        if (view != null) {
            ...
            canvas.restore();
            if (view == this.d && (g7Var = this.f4555c) != null) {
                Paint paint = (Paint) g7Var.f4694i;
                org.telegram.ui.Components.c6[] c6VarArr = (org.telegram.ui.Components.c6[]) g7Var.h;
                org.telegram.ui.Components.c6[] c6VarArr2 = (org.telegram.ui.Components.c6[]) g7Var.f4693g;
                Path path = (Path) g7Var.f4695j;
                f7 f7Var = (f7) g7Var.f4691c;
                if (f7Var != null && f7Var.f4660b.length > 0) {
                    float e = ((org.telegram.ui.Components.c6) g7Var.d).e(g7Var.f4689a);
                    float d = ((org.telegram.ui.Components.c6) g7Var.e).d(((f7) g7Var.f4691c).f4661c, false);
                    float width = (rectF2.width() * d) + rectF2.left;
                    float d10 = ((org.telegram.ui.Components.c6) g7Var.f4692f).d(((f7) g7Var.f4691c).d, false);
                    ...
                    if (e > 0.0f) {
                        path.rewind();
                        int min = Math.min(4, ((f7) g7Var.f4691c).f4660b.length);
                        int i11 = 0;
                        while (i11 < min) {
                            int i12 = i11 - 1;
                            if (i12 < 0) {
                            ...
                            f7 f7Var2 = (f7) g7Var.f4691c;
                            PointF[] pointFArr = f7Var2.f4660b;
                            ...
                            float f11 = e;
                            float width2 = (rectF2.width() * (c6VarArr4[i12].d(pointF.x - f7Var2.f4661c, false) + d)) + rectF2.left;
                            float height = (rectF2.height() * (c6VarArr3[i12].d(pointF.y - ((f7) g7Var.f4691c).d, false) + d10)) + rectF2.top;
                            float width3 = (rectF2.width() * (c6VarArr4[i11].d(pointF2.x - ((f7) g7Var.f4691c).f4661c, false) + d)) + rectF2.left;
                            float height2 = (rectF2.height() * (c6VarArr3[i11].d(pointF2.y - ((f7) g7Var.f4691c).d, false) + d10)) + rectF2.top;
                            ...
                            path.lineTo(((((width4 * (c6VarArr4[i10].d(pointF3.x - ((f7) g7Var.f4691c).f4661c, false) + d)) + f12) - width3) * 0.18f) + width3, ((((height3 * (c6VarArr3[i10].d(pointF3.y - ((f7) g7Var.f4691c).d, false) + d10)) + f13) - height2) * 0.18f) + height2);
                            rectF2 = rectF;
                            c6VarArr2 = c6VarArr4;
                            i11 = i13;
                            min = i14;
    ...
    public final void m(long j3, boolean z10) {
        if (this.f4568n0) {
            ...
            this.f4569o0 = System.currentTimeMillis() - clamp;
            this.f4570p0 = z10;
            if (this.f4568n0) {
                a0 a0Var = this.f4580w0;
                AndroidUtilities.cancelRunOnUIThread(a0Var);
                a0Var.run();
            }
        }
        ...
        while (true) {
            ...
            if (i10 < Math.max(size, arrayList2.size())) {
                ...
                if (d0Var == null && sVar != null) {
                    ...
                    if (this.f4565k0) {
                        d0Var2.f4463c.onAttachedToWindow();
                    }
                    d0Var2.b(sVar, true);
    ...
    public final void onAttachedToWindow() {
        ...
        while (true) {
            ArrayList arrayList = this.h;
            if (i10 < arrayList.size()) {
                ((d0) arrayList.get(i10)).f4463c.onAttachedToWindow();
                i10++;
            } else {
                this.f4565k0 = true;
                return;
    ...
    public final void onDetachedFromWindow() {
        ...
        while (true) {
            ArrayList arrayList = this.h;
            if (i10 < arrayList.size()) {
                ((d0) arrayList.get(i10)).f4463c.onDetachedFromWindow();
                i10++;
            } else {
                this.f4565k0 = false;
                AndroidUtilities.cancelRunOnUIThread(this.f4580w0);
                return;
            }
        }
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        for (int i14 = 0; i14 < getChildCount(); i14++) {
            ...
            if (childAt == this.d) {
                ...
                if (d0Var != null && (o8Var = d0Var.f4471n) != null && (i12 = o8Var.f5162k0) > 0 && (i13 = o8Var.f5164l0) > 0) {
                    if (o8Var.Q % 90 == 1) {
                        i13 = i12;
                        i12 = i13;
                    }
    ...
    public void setPlaying(boolean z10) {
        boolean z11 = this.f4576t0;
        this.f4576t0 = true;
        if (this.f4571q0 != z10) {
            this.f4571q0 = z10;
            if (!z10) {
                this.f4577u0 = getPosition();
            } else if (z11) {
                m(this.f4577u0, false);
            } else {
                this.f4570p0 = false;
            }
            if (this.f4568n0) {
    ...
    public void setPreview(boolean z10) {
        if (this.f4568n0 != z10) {
            ...
            if (z10) {
                ...
                for (int i11 = 0; i11 < arrayList.size(); i11++) {
                    ((d0) arrayList.get(i11)).f4461a = i11;
                }
            }
            this.f4570p0 = false;
            this.f4577u0 = 0L;
            ...
            AndroidUtilities.cancelRunOnUIThread(a0Var);
            if (z10) {
                this.f4569o0 = System.currentTimeMillis();
