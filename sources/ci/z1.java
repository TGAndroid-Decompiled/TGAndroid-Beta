...
public final class z1 extends a2 implements NotificationCenter.NotificationCenterDelegate {
    public final ai.w0 f5853b;
    public final w1 f5854c;
    public final l2 d;
    public final y1 e;
    public final s1 f5855f;
    public final ArrayList h;
    public final ArrayList f5856n;
    public final t2 f5857r;

    public z1(t2 t2Var, Context context) {
        super(context);
        org.telegram.ui.ActionBar.e6 e6Var;
        this.f5857r = t2Var;
        this.f5855f = new Object();
    ...
    public final void a(int i10) {
        w1 w1Var = this.f5854c;
        w1.E(w1Var, false);
        if (this.f5856n.isEmpty() && TextUtils.isEmpty(this.f5857r.f5544b)) {
            w1Var.G();
        }
        w1Var.H(null);
    }
    ...
    public final void onAttachedToWindow() {
        ...
        i10 = ((org.telegram.ui.ActionBar.f3) this.f5857r).currentAccount;
