    ...
    public final void run() {
        ...
        switch (this.f5877a) {
            ...
            case 22:
                ...
                org.telegram.ui.Components.qc Q2 = new org.telegram.ui.Components.xc(q4Var2.f27087b.getContainer(), q4Var2.f27086a).Q(R.raw.contact_check, 36, AndroidUtilities.replaceTags((String) this.f5879c));
                Q2.f27577j = 5000;
                Q2.k(true);
                return;
            case 23:
                ...
                sVar.getClass();
                sVar.presentFragment(wn.R9(((gi.f) this.f5879c).f10009b.f18482id));
                return;
            case 24:
                ((fi.k0) this.f5878b).f9112s.presentFragment(wn.R9(((gi.f) this.f5879c).f10009b.f18482id));
                return;
            case 25:
