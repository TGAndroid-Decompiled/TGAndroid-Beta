...
public final class f extends s4.v {
    ...
    public final int e(RecyclerView recyclerView, c1 c1Var) {
        switch (this.d) {
            case 0:
                ...
                return s4.v.l(0, 0);
            case 1:
                if (c1Var.f45771f == 1 && ((na) c1Var.f45767a).G) {
                    return s4.v.l(3, 0);
                }
                return s4.v.l(0, 0);
            case 2:
            ...
            case 3:
                ...
                if (b10 >= vm0Var.v && c1Var.b() < vm0Var.f31399w) {
                    return s4.v.l(3, 0);
                }
                return s4.v.l(0, 0);
            case 4:
                d61 d61Var = (d61) this.f4837e;
                if (d61Var.f25309c3 && d61Var.Y2.H(c1Var.b()) >= 0) {
                    int i10 = 15;
                    if (d61Var.X2.f45755o == 0) {
                        if (!d61Var.f25308b3) {
                            i10 = 12;
                        }
                    } else if (!d61Var.f25308b3) {
                        i10 = 3;
                    }
                    return s4.v.l(i10, 0);
                }
                return s4.v.l(0, 0);
            case 5:
                if (((g0) ((h81) this.f4837e).f26687y).i(c1Var.b())) {
                    return s4.v.l(12, 0);
                }
                return s4.v.l(0, 0);
            default:
                if (c1Var.f45771f == 5 && r(c1Var.b())) {
                    return s4.v.l(3, 0);
                }
                return s4.v.l(0, 0);
        }
    ...
    public boolean k() {
        switch (this.d) {
            ...
            case 4:
                d61 d61Var = (d61) this.f4837e;
                if (d61Var.f25309c3 && d61Var.f25311e3) {
                    return true;
                }
                return false;
            case 6:
    ...
    public final boolean n(RecyclerView recyclerView, c1 c1Var, c1 c1Var2) {
        ...
        switch (this.d) {
            case 0:
                ...
                return true;
            case 1:
                if (c1Var.f45771f == c1Var2.f45771f) {
            ...
            case 2:
                ...
                rn rnVar = ((tn) this.f4837e).f30680r;
                int b14 = c1Var.b();
                int b15 = c1Var2.b();
                tn tnVar = rnVar.d;
                int i16 = tnVar.f30684t0;
                rh.f fVar = tnVar.l1;
                int i17 = b14 - i16;
                int i18 = b15 - i16;
            ...
            case 3:
                int b17 = c1Var2.b();
                vm0 vm0Var = (vm0) this.f4837e;
                ArrayList arrayList4 = vm0Var.f31394e;
                if (b17 >= vm0Var.v && c1Var2.b() < vm0Var.f31399w) {
                    int b18 = c1Var.b();
                    int b19 = c1Var2.b();
                    int i19 = vm0Var.v;
                    int i20 = b18 - i19;
            ...
            case 4:
                ...
                if (v51Var.H(c1Var.b()) >= 0 && v51Var.H(c1Var.b()) == v51Var.H(c1Var2.b())) {
                    int b20 = c1Var.b();
                    int b21 = c1Var2.b();
                    ArrayList arrayList5 = v51Var.f31166x;
                    if (v51Var.L != null) {
                        int H = v51Var.H(b20);
                        int H2 = v51Var.H(b21);
                        if (H >= 0 && H == H2) {
            ...
            case 5:
                ...
                int i22 = 0;
                z11 = false;
                if (((g0) h81Var.f26687y).i(b22) && ((g0) h81Var.f26687y).i(b23)) {
                    Utilities.swapItems(arrayList6, b22, b23);
                    h81Var.f26686x.p(b22, b23);
                    ArrayList arrayList7 = new ArrayList();
                    int size2 = arrayList6.size();
                    while (i22 < size2) {
                        Object obj = arrayList6.get(i22);
                        i22++;
                        arrayList7.add(Integer.valueOf(((e81) obj).f25630a));
                    }
                    a81 a81Var = ((i81) ((g0) h81Var.f26687y).f14604b).L;
                    z11 = true;
                    z11 = true;
                    if (a81Var != null) {
                        a81Var.a(arrayList7);
                ...
                return z11;
            default:
                if (c1Var.f45771f == c1Var2.f45771f && r(c1Var.b()) && r(c1Var2.b())) {
                    xv0 xv0Var = ((zv0) this.f4837e).f43557b;
                    int b24 = c1Var.b();
                    int b25 = c1Var2.b();
                    zv0 zv0Var = xv0Var.d;
                    int i23 = zv0Var.f43573n0;
                    int i24 = b24 - i23;
                    int i25 = b25 - i23;
                    if (i24 >= 0 && i25 >= 0 && i24 < (i12 = zv0Var.f43588y) && i25 < i12) {
        ...
        switch (this.d) {
            ...
            case 2:
                ...
                if (i10 != 0) {
                    ...
                    ec1Var.I0(false);
                    c1Var.f45767a.setPressed(true);
                    c1Var.f45767a.setBackgroundColor(j6.v0(j6.f20762h5, tnVar.f28780a));
                    return;
                }
                return;
            case 3:
                if (i10 != 0) {
                    ((vm0) this.f4837e).f31392b.I0(false);
                    c1Var.f45767a.setPressed(true);
                    return;
                }
                return;
            case 4:
                ...
                if (i10 == 0) {
                    ...
                    if (d61Var.f25310d3 != null) {
                        d61Var.C1();
                        d61Var.f25310d3 = null;
                        return;
                    }
                    return;
                }
            ...
            case 6:
                if (i10 != 0) {
                    ((zv0) this.f4837e).f43559c.I0(false);
                    c1Var.f45767a.setPressed(true);
                    return;
                }
                return;
    ...
    public boolean r(int i10) {
        ...
        if (!zv0Var.I || i10 - zv0Var.f43573n0 >= zv0Var.f43586x) {
            return true;
        }
        return false;
    }
