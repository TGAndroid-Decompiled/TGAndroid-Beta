...
public final class p5 implements Utilities.CallbackReturn {
    ...
    public final Object run(Object obj) {
        switch (this.f5303a) {
            case 0:
                r6 r6Var = (r6) this.f5304b;
                boolean[] zArr = (boolean[]) this.f5305c;
                z5 z5Var = (z5) this.d;
            ...
            case 1:
                final org.telegram.ui.Components.e0 e0Var = (org.telegram.ui.Components.e0) this.f5304b;
                final org.telegram.ui.ActionBar.e6 e6Var2 = (org.telegram.ui.ActionBar.e6) this.f5305c;
                ...
                if (aiComposeTone instanceof TL_aicompose.TL_aiComposeTone) {
                    ...
                    F.W(org.telegram.ui.ActionBar.i6.b0(AndroidUtilities.dp(12.0f), org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f18834d6, e6Var2)));
                        ...
                        public final void run() {
                            ...
                            switch (r4) {
                                case 0:
                                    ...
                                    yVar.f30105j0 = tL_aiComposeTone2;
                                    yVar.f30103h0 = Long.valueOf(tL_aiComposeTone2.emoji_id);
                                    yVar.X();
                                    yVar.f30096a0.setText(yVar.f30105j0.title);
                                    yVar.f30097b0.setText(yVar.f30105j0.prompt);
                                    if (yVar.f30105j0.author_id != 0) {
                                        z10 = true;
                                    } else {
                                        z10 = false;
                                    }
                                    yVar.f30099d0.a(z10, false);
                                    yVar.e.setTitle(LocaleController.getString(R.string.AIEditorEditStyle));
                                    yVar.f30102g0.setText(LocaleController.getString(R.string.AIEditorStyleEdit));
                                    yVar.W();
                                    yVar.m0.N(false);
                                    yVar.f30107l0 = new e(e0Var2, 2);
                                    yVar.show();
                                    return;
                                default:
                                    e0 e0Var3 = e0Var;
                                    AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(e0Var3.getContext(), 0, e6Var2);
                                    alertDialog$Builder.f18435a.R = LocaleController.getString(R.string.AIEditorDeleteStyle);
                                    alertDialog$Builder.f18435a.T = LocaleController.getString(R.string.AIEditorDeleteStyleText);
            ...
            case 2:
                View view = (View) obj;
                MessageObject messageObject = ((rh.g) this.d).f42596b;
                return rh.c.d(view, (String) this.f5304b, (String) this.f5305c, messageObject.getDocument(), messageObject);
            default:
                ll0 ll0Var = (ll0) this.f5304b;
                Utilities.CallbackReturn callbackReturn = (Utilities.CallbackReturn) this.f5305c;
                ...
                try {
                    ...
                    if (T != null) {
                        sparseIntArray.put(T.f42674f, booleanValue ? 1 : 0);
                    }
                    return bool;
