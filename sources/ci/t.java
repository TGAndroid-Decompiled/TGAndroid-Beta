...
public final class t extends FrameLayout {
    ...
    public t(lr0 lr0Var, Context context) {
        ...
        xw0Var.e(true, false);
        xw0Var.f32781b.setVisibility(8);
        xw0Var.d.setText(LocaleController.getString(R.string.ProfileBotPreviewEmptyTitle));
        xw0Var.f32783e.setText(LocaleController.formatPluralString("ProfileBotPreviewEmptyText", MessagesController.getInstance(lr0Var.f4876b).botPreviewMediasMax, new Object[0]));
        String string = LocaleController.getString(R.string.ProfileBotPreviewEmptyButton);
        di.d dVar = xw0Var.f32784f;
        ...
        xw0Var.f32780a.addView(nVar, x5.t(165, -2, 17, 0, 17, 0, 12));
        di.d dVar2 = new di.d(context, f6Var, false);
        this.F = dVar2;
        dVar2.setMinWidth(AndroidUtilities.dp(200.0f));
        xw0Var.f32780a.addView(dVar2, x5.q(-2, 44, 17));
    ...
    public final void c() {
        ...
        if (z10) {
            ...
            xw0Var.d.setText(LocaleController.getString(R.string.ProfileBotPreviewEmptyTitle));
            xw0Var.f32783e.setText(LocaleController.formatPluralString("ProfileBotPreviewEmptyText", MessagesController.getInstance(i12).botPreviewMediasMax, new Object[0]));
            xw0Var.f32784f.g(LocaleController.getString(R.string.ProfileBotPreviewEmptyButton), false, true);
            nVar2.setVisibility(8);
            dVar2.setVisibility(8);
        } else {
            xw0Var.d.setVisibility(8);
            xw0Var.f32783e.setText(LocaleController.formatString(R.string.ProfileBotPreviewFooterLanguage, u31.D(this.f4858a.E, null, null)));
            xw0Var.f32784f.g(LocaleController.getString(R.string.ProfileBotPreviewEmptyButton), false, true);
