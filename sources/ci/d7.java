...
public abstract class d7 extends FrameLayout {
    ...
    public Bitmap f4501a;
    public final float[] f4502a0;
    public final Rect f4503b;
    public float f4504b0;
    public final Rect f4505c;
    public float f4506c0;
    public o8 d;
    public float f4507d0;
    public g71 e;
    public boolean f4508e0;
    public int f4509f;
    public final org.telegram.ui.Components.c6 f4510f0;
    public boolean f4511g0;
    public int h;
    public final Matrix f4512h0;
    public final Matrix f4513i0;
    public final Matrix f4514j0;
    public boolean f4515k0;
    public final PointF f4516l0;
    public final PointF m0;
    public u61 f4517n;
    public float f4518n0;
    public double f4519o0;
    public boolean f4520p0;
    public boolean f4521q0;
    public TextureView f4522r;
    public boolean f4523r0;
    public jf0 f4524s;
    public final Matrix f4525s0;
    public final Matrix f4526t0;
    public float f4527u0;
    public ka v;
    public boolean f4528v0;
    public qg.e2 f4529w;
    public boolean f4530w0;
    public g71 f4531x;
    public long f4532x0;
    public g71 f4533y;
    public Runnable f4534y0;
    public final HashSet f4535z0;
    ...
    public d7(Context context, org.telegram.ui.Components.ha haVar, c7 c7Var) {
        ...
        this.T = new Paint(1);
        this.W = new Matrix();
        this.f4502a0 = new float[2];
        this.f4508e0 = true;
        this.f4510f0 = new org.telegram.ui.Components.c6(this, 0L, 320L, qr.f27421g);
        this.f4511g0 = false;
        this.f4512h0 = new Matrix();
        this.f4513i0 = new Matrix();
        this.f4514j0 = new Matrix();
        this.f4515k0 = true;
        this.f4516l0 = new PointF();
        this.m0 = new PointF();
        this.f4525s0 = new Matrix();
        this.f4526t0 = new Matrix();
        this.f4535z0 = new HashSet();
        this.G = haVar;
        this.H = c7Var;
    ...
    public static Drawable g(int i10, final org.telegram.ui.ActionBar.d4 d4Var, final boolean z10) {
        if (d4Var.m()) {
            org.telegram.ui.ActionBar.i6.H(org.telegram.ui.ActionBar.d4.e(z10), d4Var.h(i10, z10 ? 1 : 0), ((org.telegram.ui.ActionBar.c4) d4Var.f18590f.get(z10 ? 1 : 0)).f18550g, 0, false);
        ...
        cc0Var.f23051g = false;
        cc0Var.t(cc0Var.f23064u, d4Var.k(z10 ? 1 : 0).settings.intensity);
    ...
    public final void d(Matrix matrix) {
        ...
        float[] fArr = this.f4502a0;
        fArr[0] = o8Var.f5162k0 / 2.0f;
        fArr[1] = o8Var.f5164l0 / 2.0f;
        matrix.mapPoints(fArr);
        this.f4504b0 = fArr[0];
        this.f4506c0 = fArr[1];
        o8 o8Var2 = this.d;
        fArr[0] = o8Var2.f5162k0;
        fArr[1] = o8Var2.f5164l0 / 2.0f;
        matrix.mapPoints(fArr);
        this.f4507d0 = (float) Math.toDegrees(Math.atan2(fArr[1] - this.f4506c0, fArr[0] - this.f4504b0));
        v7.z6.a(this.f4504b0, this.f4506c0, fArr[0], fArr[1]);
        o8 o8Var3 = this.d;
        fArr[0] = o8Var3.f5162k0 / 2.0f;
        fArr[1] = o8Var3.f5164l0;
        matrix.mapPoints(fArr);
        v7.z6.a(this.f4504b0, this.f4506c0, fArr[0], fArr[1]);
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.S != null) {
            ...
            if (!(drawable instanceof cc0) || ((cc0) drawable).f23064u != null) {
        ...
        } else if (this.f4508e0 && this.d != null && !j()) {
            if (this.f4501a == null) {
                z10 = true;
            } else {
                z10 = false;
            }
            float e = this.f4510f0.e(z10);
            if (this.f4501a != null) {
                canvas2.save();
                canvas2.scale(getWidth() / this.d.f5158i0, getHeight() / this.d.f5160j0);
                canvas2.concat(this.d.f5167n0);
                if (this.d.m0 != null) {
                    canvas2.translate(o8Var.f5162k0 / 2.0f, o8Var.f5164l0 / 2.0f);
                    canvas2.rotate(-this.d.Q);
                    o8 o8Var2 = this.d;
                    int i10 = o8Var2.f5162k0;
                    int i11 = o8Var2.f5164l0;
                    int i12 = o8Var2.Q;
                    ...
                    canvas2.rotate(this.d.Q);
                    o8 o8Var3 = this.d;
                    canvas2.translate((-o8Var3.f5162k0) / 2.0f, (-o8Var3.f5164l0) / 2.0f);
                }
                Paint paint = this.Q;
                paint.setAlpha((int) ((1.0f - e) * 255.0f));
                int width = this.f4501a.getWidth();
                int height = this.f4501a.getHeight();
                Rect rect = this.f4503b;
                rect.set(0, 0, width, height);
                o8 o8Var4 = this.d;
                int i13 = o8Var4.f5162k0;
                int i14 = o8Var4.f5164l0;
                Rect rect2 = this.f4505c;
                rect2.set(0, 0, i13, i14);
                canvas2.drawBitmap(this.f4501a, rect, rect2, paint);
                canvas2.restore();
            }
        }
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        o8 o8Var;
        o8 o8Var2;
        u61 u61Var = this.f4517n;
        if (view == u61Var && (o8Var2 = this.d) != null && o8Var2.f5180u) {
            return false;
        }
        if ((view == u61Var || view == this.f4522r) && (o8Var = this.d) != null && o8Var.m0 != null) {
            canvas.save();
            canvas.scale(getWidth() / this.d.f5158i0, getHeight() / this.d.f5160j0);
            canvas.concat(this.d.f5167n0);
            o8 o8Var3 = this.d;
            if (o8Var3.m0 != null) {
                canvas.translate(o8Var3.f5162k0 / 2.0f, o8Var3.f5164l0 / 2.0f);
                canvas.rotate(-this.d.Q);
                o8 o8Var4 = this.d;
                int i10 = o8Var4.f5162k0;
                int i11 = o8Var4.f5164l0;
                int i12 = o8Var4.Q;
                ...
                canvas.rotate(this.d.Q);
                o8 o8Var5 = this.d;
                canvas.translate((-o8Var5.f5162k0) / 2.0f, (-o8Var5.f5164l0) / 2.0f);
            }
            canvas.concat(this.f4512h0);
            canvas.scale(1.0f / (getWidth() / this.d.f5158i0), 1.0f / (getHeight() / this.d.f5160j0));
    ...
    public Pair<Integer, Integer> getPaintSize() {
        ...
        return new Pair<>(Integer.valueOf(this.d.f5158i0), Integer.valueOf(this.d.f5160j0));
    }
    ...
    public final void h(Utilities.Callback callback, View... viewArr) {
        ...
        for (int i10 = 0; i10 < viewArr.length; i10++) {
            ...
            if (view != null && view.getWidth() >= 0 && viewArr[i10].getHeight() > 0) {
                ...
                if (view2 == this && (u61Var = this.f4517n) != null) {
    ...
    public final boolean k() {
        return !this.f4535z0.contains(-9982);
    }
    ...
    public final void o(TextureView textureView, jf0 jf0Var) {
        TextureView textureView2 = this.f4522r;
        if (textureView2 != null) {
            removeView(textureView2);
            this.f4522r = null;
        }
        this.f4524s = jf0Var;
        this.f4522r = textureView;
        if (jf0Var != null) {
            int i10 = this.U;
            int i11 = this.V;
        ...
        TextureView textureView3 = this.f4522r;
    ...
    public final void p(o8 o8Var, boolean z10) {
        ...
        if (o8Var != null) {
            ...
            if (o8Var.f5187y != null) {
                g71 g71Var2 = new g71();
                this.f4533y = g71Var2;
                g71Var2.f24242y = z11;
                g71Var2.J = new a6.i(this, 12);
                g71Var2.D(Uri.fromFile(new File(o8Var.f5187y)), "other");
                c();
            ...
            if (qbVar != null) {
                o8 o8Var2 = ocVar.K1;
                if (o8Var2 != null && o8Var2.f5187y != null) {
                    z12 = true;
                }
    ...
    public final void q(MessageObject messageObject) {
        ...
        if (o8Var != null) {
            ...
            if (messageObject != null && messageObject.messageOwner != null) {
                ...
                if (document != null && document.f18115id != 0) {
                    this.d.f5189z = new TLRPC.TL_inputDocument();
                    TLRPC.InputDocument inputDocument = this.d.f5189z;
                ...
                if (!TextUtils.isEmpty(messageObject.messageOwner.attachPath)) {
                    this.d.f5187y = messageObject.messageOwner.attachPath;
                } else {
                    ...
                    if (pathToAttach == null || !pathToAttach.exists()) {
                        ...
                        if (pathToAttach != null && pathToAttach.exists()) {
                            this.d.f5187y = pathToAttach.getAbsolutePath();
                        } else {
                            o8 o8Var2 = this.d;
                            o8Var2.f5187y = null;
                            o8Var2.f5189z = null;
    ...
    public final void s(o8 o8Var, qg.e2 e2Var, boolean z10) {
        g71 g71Var;
        if (o8Var != null && o8Var.f5169o0 != null) {
            g71 g71Var2 = this.f4531x;
            if (g71Var2 != null) {
                g71Var2.H();
                this.f4531x = null;
            ...
            g71 g71Var3 = new g71();
            this.f4531x = g71Var3;
            g71Var3.f24242y = true;
            g71Var3.J = new a6.m(this, 12);
            this.f4531x.D(Uri.fromFile(o8Var.f5169o0), "other");
            c();
            this.f4529w = e2Var;
            if (e2Var != null && (g71Var = this.f4531x) != null) {
                g71Var.V(e2Var.f41343u0);
            }
            this.F.n(o8Var.f5169o0.getAbsolutePath(), o8Var.f5173q0, o8Var.f5175r0, o8Var.f5177s0, o8Var.f5179t0, o8Var.f5181u0, z10);
            y(true);
            return;
        }
        g71 g71Var4 = this.f4531x;
        if (g71Var4 != null) {
            g71Var4.B();
            this.f4531x.H();
            this.f4531x = null;
    ...
    public final void t(o8 o8Var, Runnable runnable, long j3) {
        ...
        if (o8Var != null && !o8Var.v()) {
            ...
            g71 g71Var2 = new g71();
            this.e = g71Var2;
            g71Var2.f24242y = true;
            g71Var2.J = new aa.a(this, o8Var, new Runnable[]{runnable});
            u61 u61Var = this.f4517n;
            if (u61Var != null) {
                u61Var.clearAnimation();
                u61 u61Var2 = this.f4517n;
                vz vzVar = u61Var2.f28297b;
                if (vzVar != null) {
                    vzVar.postRunnable(new sz(vzVar, 0));
                }
                u61Var2.f28296a = null;
                removeView(this.f4517n);
                this.f4517n = null;
            }
            this.f4517n = new u61(getContext(), this.e);
            this.G.e();
            u61 u61Var3 = this.f4517n;
            if (o8Var.f5180u) {
                haVar = null;
            } else {
                haVar = this.G;
            }
            u61Var3.f28302s = haVar;
            vz vzVar2 = u61Var3.f28297b;
            ...
            this.f4517n.setOpaque(false);
            b();
            c7 c7Var = this.H;
            if (c7Var != null && c7Var.f4431g) {
                c7Var.a(this.f4517n);
            } else {
                u61 u61Var4 = this.f4517n;
                if (runnable != null) {
                    f7 = 1.0f;
                }
                u61Var4.setAlpha(f7);
                addView(this.f4517n, w7.x5.e(-2, -2, 51));
            }
            ...
            this.e.P(this.f4535z0.isEmpty());
            this.e.N(true);
            if (o8Var.h) {
                j3 = (o8Var.Z * ((float) o8Var.f5156h0)) + ((float) j3);
            }
            ...
            c();
            w(true);
            if (o8Var.f5180u && (arrayList = o8Var.v) != null && arrayList.size() == 1 && ((MessageObject) o8Var.v.get(0)).type == 5) {
                z10 = true;
            } else {
                z10 = false;
            }
            ...
            this.F.setVideoRight(o8Var.f5140a0);
            zc zcVar2 = this.F;
        ...
        c7 c7Var2 = this.H;
        if (c7Var2 != null && c7Var2.f4431g) {
            c7Var2.a(null);
        } else {
            u61 u61Var5 = this.f4517n;
            if (u61Var5 != null) {
                u61Var5.clearAnimation();
                this.f4517n.animate().alpha(0.0f).withEndAction(new a7(this, 6)).start();
            }
        }
        zc zcVar3 = this.F;
        if (zcVar3 != null) {
    ...
    public final void u(o8 o8Var) {
        ...
        long j3 = o8Var.f5190z0;
        if (j3 != Long.MIN_VALUE) {
            Drawable e = e(this.S, o8Var.f5139a, j3, o8Var.f5188y0);
            o8Var.f5186x0 = e;
            this.S = e;
            if (this.R != e) {
                this.R = null;
    ...
    public final boolean v(MotionEvent motionEvent) {
        ...
        if (this.f4515k0) {
            ...
            boolean z13 = this.f4520p0;
            PointF pointF3 = this.f4516l0;
            if (z13 != z10) {
                pointF3.x = pointF2.x;
                pointF3.y = pointF2.y;
                this.f4518n0 = f7;
            ...
            o8 o8Var = this.d;
            if (o8Var != null) {
                float width = o8Var.f5158i0 / getWidth();
                int actionMasked = motionEvent.getActionMasked();
                Matrix matrix = this.f4525s0;
                if (actionMasked == 0) {
                    this.f4527u0 = 0.0f;
                    this.f4528v0 = false;
                    invalidate();
                    this.f4530w0 = true;
                    matrix.set(this.d.f5167n0);
                }
                if (motionEvent.getActionMasked() == 2 && this.f4530w0 && this.d != null) {
                    float f10 = pointF2.x * width;
                    float f11 = pointF2.y * width;
                    float f12 = pointF3.x * width;
                    float f13 = pointF3.y * width;
                    if (motionEvent.getPointerCount() > 1) {
                        float f14 = this.f4518n0;
                        if (f14 != 0.0f) {
                            float f15 = f7 / f14;
                            matrix.postScale(f15, f15, f10, f11);
                        }
                        pointF = pointF2;
                        float degrees = (float) Math.toDegrees(d - this.f4519o0);
                        float f16 = this.f4527u0 + degrees;
                        this.f4527u0 = f16;
                        if (!this.f4523r0) {
                            ...
                            if (!z11) {
                                d(matrix);
                                if ((Math.round(this.f4507d0 / 90.0f) * 90.0f) - this.f4507d0 > 20.0f) {
                                    z12 = true;
                                } else {
                                    z12 = false;
                                }
                    ...
                    if (motionEvent.getPointerCount() > 1 || this.f4521q0) {
                        matrix.postTranslate(f10 - f12, f11 - f13);
                    }
                    Matrix matrix2 = this.f4526t0;
                    matrix2.set(matrix);
                    Matrix matrix3 = this.W;
                    matrix3.set(matrix);
                    d(matrix3);
                    float round = (Math.round(this.f4507d0 / 90.0f) * 90.0f) - this.f4507d0;
                    if (this.f4523r0) {
                        if (Math.abs(round) < 3.5f) {
                            matrix2.postRotate(round, this.f4504b0, this.f4506c0);
                            if (!this.f4528v0) {
                                AndroidUtilities.vibrateCursor(this);
                                this.f4528v0 = true;
                            }
                ...
                if (motionEvent.getAction() == 1 || motionEvent.getAction() == 3) {
                    if (motionEvent.getPointerCount() <= 1) {
                        this.f4521q0 = false;
                        oc ocVar = ((cc) this).C0;
                        ocVar.f5246o1.a(true, false, ocVar.f5228i0);
    ...
    public final void y(boolean z10) {
        ...
        boolean z11;
        int i10;
        if (this.f4531x != null && this.d != null) {
            boolean z12 = true;
            if (this.e == null && !j()) {
                this.f4531x.P(this.f4535z0.isEmpty());
                this.f4531x.N(true);
                qg.e2 e2Var = this.f4529w;
                if (e2Var != null && !e2Var.B0) {
                    e2Var.B0 = true;
                    e2Var.C0.f(true, true);
                    e2Var.invalidate();
                }
                long n11 = this.f4531x.n();
                if (z10 && this.f4531x.p() != -9223372036854775807L) {
                    float p5 = ((float) n11) / ((float) this.f4531x.p());
                    o8 o8Var = this.d;
                    if ((p5 < o8Var.f5177s0 || p5 > o8Var.f5179t0) && System.currentTimeMillis() - this.J > 500) {
                        this.J = System.currentTimeMillis();
                        this.f4531x.L(-this.d.f5175r0, false);
                        return;
                    }
                    return;
                }
            ...
            o8 o8Var2 = this.d;
            float f10 = o8Var2.f5179t0;
            float f11 = o8Var2.f5177s0;
            long j3 = (f10 - f11) * ((float) o8Var2.f5173q0);
            long j10 = o8Var2.f5175r0;
            ...
            qg.e2 e2Var2 = this.f4529w;
            if (e2Var2 != null && e2Var2.B0 != z11) {
                e2Var2.B0 = z11;
                e2Var2.invalidate();
            }
            if (this.f4531x.y() != z12) {
                this.f4531x.P(z12);
                this.f4531x.L(j11, false);
            } else if (z10) {
                long abs = Math.abs(this.f4531x.n() - j11);
                if (j()) {
                    i10 = 300;
                } else {
                    i10 = 120;
