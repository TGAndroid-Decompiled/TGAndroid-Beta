...
public final class p9 implements Utilities.Callback {
    ...
    public p9(Object obj, long j3, int i10) {
        this.f5301a = i10;
        this.f5303c = obj;
        this.f5302b = j3;
    }
        ...
        switch (this.f5301a) {
            case 0:
                ...
                if (tL_channels_channelParticipants != null && !tL_channels_channelParticipants.participants.isEmpty()) {
                    ...
                    y9Var.d(this.f5302b, tL_chatParticipants);
                    return;
                }
                return;
            case 1:
                ResultCallback resultCallback = (ResultCallback) this.f5303c;
                dg.a aVar = (dg.a) obj;
                if (resultCallback != null) {
                    resultCallback.onComplete(new Pair(Long.valueOf(this.f5302b), aVar));
                    return;
                }
                return;
            default:
                hx0 hx0Var = (hx0) this.f5303c;
                TLRPC.TL_messages_emojiGroups tL_messages_emojiGroups = (TLRPC.TL_messages_emojiGroups) obj;
                if (tL_messages_emojiGroups != null) {
                    NotificationCenter.getInstance(UserConfig.selectedAccount).doOnIdle(new a3.h0(hx0Var, tL_messages_emojiGroups, this.f5302b, 23));
                    return;
                }
                return;
        }
