...
public final class l4 extends FrameLayout implements RendererCommon.RendererEvents, NotificationCenter.NotificationCenterDelegate {
    public int f4921a;
    public final k4 f4922b;
    public final SurfaceViewRenderer f4923c;
    public final TextureViewRenderer d;
    public final org.telegram.ui.Components.u9 e;
    public final TextureView f4924f;
    public View h;
    public Runnable f4925n;
    ...
    public final void b() {
        ...
        SurfaceViewRenderer surfaceViewRenderer = this.f4923c;
    ...
    public final void d(long j3, ai.e6 e6Var) {
        ...
        int width;
        if (e6Var == null) {
            long j10 = this.f4927s;
            if (j10 != 0 && this.f4926r && (textureViewRenderer = this.d) != null) {
        ...
        if (this.f4927s != j3) {
            ...
            if (i10 == 0) {
                ...
                if (i10 > 0) {
                    TLRPC.User user = MessagesController.getInstance(this.f4921a).getUser(Long.valueOf(j3));
                    ImageLocation forUser = ImageLocation.getForUser(this.f4921a, user, 1);
                    if (user != null) {
                        d10 = org.telegram.ui.Components.f9.d(user.f18259id);
                    } else {
                    ...
                    TLRPC.Chat chat = MessagesController.getInstance(this.f4921a).getChat(Long.valueOf(-j3));
                    ImageLocation forChat = ImageLocation.getForChat(this.f4921a, chat, 1);
                    if (chat != null) {
                        d = org.telegram.ui.Components.f9.d(chat.f18112id);
                    } else {
        ...
        this.f4927s = j3;
        this.v = e6Var;
        if (this.f4926r && e6Var != null && !e6Var.f759a) {
            e6Var.f759a = true;
            e6Var.b();
        }
        z10 = (e6Var == null || (d2Var2 = (ai.d2) e6Var.f760b) == null || !d2Var2.n()) ? false : false;
        if (e6Var != null && (d2Var = (ai.d2) e6Var.f760b) != null && d2Var.a()) {
            ai.d2 d2Var3 = (ai.d2) e6Var.f760b;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.liveStoryUpdated) {
            ...
            ai.e6 e6Var = this.v;
            if (e6Var != null && (d2Var = (ai.d2) e6Var.f760b) != null && d2Var.g() == longValue) {
                boolean n10 = ((ai.d2) this.v.f760b).n();
                if (((ai.d2) this.v.f760b).a()) {
                    ai.d2 d2Var2 = (ai.d2) this.v.f760b;
    ...
    public final void draw(Canvas canvas) {
        ...
        if (AndroidUtilities.makingGlobalBlurBitmap) {
            TextureView textureView = this.f4924f;
    ...
    public final void f() {
        ...
        if (isAttachedToWindow() && measuredWidth > 0 && measuredHeight > 0) {
            ...
            textureView.setTranslationY(((f11 - (f12 * max)) / 2.0f) - (this.f4929x / 2.0f));
            ...
            view.setTranslationY(((f11 - (measuredHeight3 * max2)) / 2.0f) - (this.f4929x / 2.0f));
        }
    }
    ...
    public final void onAttachedToWindow() {
        ...
        if (textureViewRenderer != null) {
            ...
            textureViewRenderer.setBackgroundRenderer(this.f4924f);
        }
        NotificationCenter.getInstance(this.f4921a).addObserver(this, NotificationCenter.liveStoryUpdated);
    }
    ...
    public final void onDetachedFromWindow() {
        ...
        NotificationCenter.getInstance(this.f4921a).removeObserver(this, NotificationCenter.liveStoryUpdated);
    }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        this.f4922b.layout(0, 0, i14, i15);
        View view = this.h;
        if (view != null) {
    ...
    public void setAccount(int i10) {
        ...
        if (isAttachedToWindow()) {
            NotificationCenter notificationCenter = NotificationCenter.getInstance(this.f4921a);
