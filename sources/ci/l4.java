...
public final class l4 extends FrameLayout implements RendererCommon.RendererEvents, NotificationCenter.NotificationCenterDelegate {
    public int f4927a;
    public final k4 f4928b;
    public final SurfaceViewRenderer f4929c;
    public final TextureViewRenderer d;
    public final org.telegram.ui.Components.v9 e;
    public final TextureView f4930f;
    public View h;
    public Runnable f4931n;
    ...
    public final void b() {
        ...
        SurfaceViewRenderer surfaceViewRenderer = this.f4929c;
    ...
    public final void c(Runnable runnable, boolean z10) {
        ...
        animate.alpha(f7).setInterpolator(qr.h).setDuration(320L).withEndAction(new bi.f(2, this, z10)).start();
    ...
    public final void d(long j3, ai.e6 e6Var) {
        ...
        int width;
        if (e6Var == null) {
            long j10 = this.f4933s;
            if (j10 != 0 && this.f4932r && (textureViewRenderer = this.d) != null) {
        ...
        if (this.f4933s != j3) {
            ...
            if (i10 == 0) {
                ...
                if (i10 > 0) {
                    TLRPC.User user = MessagesController.getInstance(this.f4927a).getUser(Long.valueOf(j3));
                    ImageLocation forUser = ImageLocation.getForUser(this.f4927a, user, 1);
                    if (user != null) {
                        d10 = org.telegram.ui.Components.g9.d(user.f18475id);
                    } else {
                    ...
                    TLRPC.Chat chat = MessagesController.getInstance(this.f4927a).getChat(Long.valueOf(-j3));
                    ImageLocation forChat = ImageLocation.getForChat(this.f4927a, chat, 1);
                    if (chat != null) {
                        d = org.telegram.ui.Components.g9.d(chat.f18328id);
                    } else {
        ...
        this.f4933s = j3;
        this.v = e6Var;
        if (this.f4932r && e6Var != null && !e6Var.f764a) {
            e6Var.f764a = true;
            e6Var.b();
        }
        z10 = (e6Var == null || (d2Var2 = (ai.d2) e6Var.f765b) == null || !d2Var2.n()) ? false : false;
        if (e6Var != null && (d2Var = (ai.d2) e6Var.f765b) != null && d2Var.a()) {
            ai.d2 d2Var3 = (ai.d2) e6Var.f765b;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.liveStoryUpdated) {
            ...
            ai.e6 e6Var = this.v;
            if (e6Var != null && (d2Var = (ai.d2) e6Var.f765b) != null && d2Var.g() == longValue) {
                boolean n10 = ((ai.d2) this.v.f765b).n();
                if (((ai.d2) this.v.f765b).a()) {
                    ai.d2 d2Var2 = (ai.d2) this.v.f765b;
    ...
    public final void draw(Canvas canvas) {
        ...
        if (AndroidUtilities.makingGlobalBlurBitmap) {
            TextureView textureView = this.f4930f;
    ...
    public final void f() {
        ...
        if (isAttachedToWindow() && measuredWidth > 0 && measuredHeight > 0) {
            ...
            textureView.setTranslationY(((f11 - (f12 * max)) / 2.0f) - (this.f4935x / 2.0f));
            ...
            view.setTranslationY(((f11 - (measuredHeight3 * max2)) / 2.0f) - (this.f4935x / 2.0f));
        }
    }
    ...
    public final void onAttachedToWindow() {
        ...
        if (textureViewRenderer != null) {
            ...
            textureViewRenderer.setBackgroundRenderer(this.f4930f);
        }
        NotificationCenter.getInstance(this.f4927a).addObserver(this, NotificationCenter.liveStoryUpdated);
    }
    ...
    public final void onDetachedFromWindow() {
        ...
        NotificationCenter.getInstance(this.f4927a).removeObserver(this, NotificationCenter.liveStoryUpdated);
    }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        this.f4928b.layout(0, 0, i14, i15);
        View view = this.h;
        if (view != null) {
    ...
    public void setAccount(int i10) {
        ...
        if (isAttachedToWindow()) {
            NotificationCenter notificationCenter = NotificationCenter.getInstance(this.f4927a);
