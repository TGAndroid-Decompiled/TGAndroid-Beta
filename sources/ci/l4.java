...
public final class l4 extends FrameLayout implements RendererCommon.RendererEvents, NotificationCenter.NotificationCenterDelegate {
    ...
    public final void b() {
        ...
        SurfaceViewRenderer surfaceViewRenderer = this.f4928c;
    ...
    public final void d(long j3, ai.e6 e6Var) {
        ...
        this.f4932s = j3;
        this.v = e6Var;
        if (this.f4931r && e6Var != null && !e6Var.f764a) {
            e6Var.f764a = true;
            e6Var.b();
        }
    ...
    public final void draw(Canvas canvas) {
        ...
        if (AndroidUtilities.makingGlobalBlurBitmap) {
            TextureView textureView = this.f4929f;
    ...
    public final void f() {
        ...
        if (isAttachedToWindow() && measuredWidth > 0 && measuredHeight > 0) {
            ...
            textureView.setTranslationY(((f11 - (f12 * max)) / 2.0f) - (this.f4934x / 2.0f));
            ...
            view.setTranslationY(((f11 - (measuredHeight3 * max2)) / 2.0f) - (this.f4934x / 2.0f));
        }
    }
    ...
    public final void onAttachedToWindow() {
        ...
        if (textureViewRenderer != null) {
            ...
            textureViewRenderer.setBackgroundRenderer(this.f4929f);
        }
        NotificationCenter.getInstance(this.f4926a).addObserver(this, NotificationCenter.liveStoryUpdated);
    }
    ...
    public final void onDetachedFromWindow() {
        ...
        NotificationCenter.getInstance(this.f4926a).removeObserver(this, NotificationCenter.liveStoryUpdated);
    }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        this.f4927b.layout(0, 0, i14, i15);
        View view = this.h;
        if (view != null) {
    ...
    public void setAccount(int i10) {
        ...
        if (isAttachedToWindow()) {
            NotificationCenter notificationCenter = NotificationCenter.getInstance(this.f4926a);
