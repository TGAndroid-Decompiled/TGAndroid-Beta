...
public final class w6 extends FrameLayout {
    ...
    public w6(Activity activity, int i10, ai.d dVar) {
        ...
        b6Var.f577a.getAvatarDrawable().m(i10, currentUser);
        ai.z5 z5Var = b6Var.f577a;
        z5Var.e(currentUser, z5Var.getAvatarDrawable());
        b6Var.f578b.l(Emoji.replaceEmoji(UserObject.getUserName(currentUser), b6Var.f578b.getPaint().getFontMetricsInt(), false), false);
    ...
    public final void b(CharSequence charSequence) {
        this.e.f1712b0.b(org.telegram.ui.Components.x5.cloneSpans(new SpannableString(charSequence)), null, null, false, false);
    }
