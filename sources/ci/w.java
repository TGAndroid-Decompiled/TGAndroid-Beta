...
public final class w extends s4.h0 {
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        xVar.b(tVar.equals(this.e.f5795b), z10);
        xVar.f5723s = i10;
    }

    @Override
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ad adVar = new ad(this.f5673c);
        adVar.setLayoutParams(new s4.p0(AndroidUtilities.dp(46.0f), AndroidUtilities.dp(56.0f)));
        adVar.setBackground(org.telegram.ui.ActionBar.i6.f0(553648127, 1, -1));
    ...
    public final void y(s4.c1 c1Var) {
        ...
        if (i10 >= 0 && i10 < t.a().size()) {
            t tVar = (t) t.a().get(xVar.f5723s);
            xVar.setDrawable(new u(tVar, false));
            xVar.b(tVar.equals(this.e.f5795b), false);
        }
    }

    @Override
    public final void z(s4.c1 c1Var) {
        this.d.d.remove((x) c1Var.f42675a);
    }
}
