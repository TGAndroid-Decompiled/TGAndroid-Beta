...
public final class p1 extends ll0 {
    ...
    public boolean Y2;
    public float Z2;
    public float f5291a3;
    public boolean f5292b3;
    public final SparseArray f5293c3;
    public final ArrayList f5294d3;
    public final ArrayList f5295e3;
    public final ArrayList f5296f3;
    public final ArrayList f5297g3;
    public final PorterDuffColorFilter f5298h3;

    public p1(Context context) {
        super(context, null);
        this.f5292b3 = false;
        this.f5293c3 = new SparseArray();
        this.f5294d3 = new ArrayList();
        this.f5295e3 = new ArrayList();
        this.f5296f3 = new ArrayList();
        this.f5297g3 = new ArrayList();
        this.f5298h3 = new PorterDuffColorFilter(-1, PorterDuff.Mode.SRC_IN);
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        canvas.save();
        canvas.clipRect(0.0f, this.Z2, getWidth(), this.f5291a3);
        if (!this.Y2) {
        ...
        int i11 = 0;
        while (true) {
            sparseArray = this.f5293c3;
            int size = sparseArray.size();
            arrayList = this.f5294d3;
            if (i11 >= size) {
                break;
            }
        ...
        for (int i12 = 0; i12 < getChildCount(); i12++) {
            ...
            if (childAt instanceof o1) {
                o1 o1Var = (o1) childAt;
                if (o1Var.getY() < this.f5291a3 && o1Var.getY() + o1Var.getHeight() > this.Z2) {
                    if (this.f5292b3) {
                        top = (int) o1Var.getY();
                    } else {
                        top = o1Var.getTop();
        ...
        ArrayList arrayList5 = this.f5297g3;
        arrayList5.clear();
        ArrayList arrayList6 = this.f5296f3;
