...
public final class cc extends d7 {
    ...
    public final void b() {
        ...
        if (o8Var != null && !o8Var.f5182u) {
            if (this.f4519n != null) {
                Matrix matrix = o8Var.f5169n0;
                Matrix matrix2 = this.W;
                matrix2.set(matrix);
                float width = 1.0f / getWidth();
                int i10 = this.d.f5164k0;
                if (i10 < 0) {
                    i10 = this.f4511f;
                }
                float f7 = width * i10;
                float height = 1.0f / getHeight();
                int i11 = this.d.f5166l0;
                if (i11 < 0) {
                    i11 = this.h;
                }
                matrix2.preScale(f7, height * i11);
                matrix2.postScale(getWidth() / this.d.f5160i0, getHeight() / this.d.f5162j0);
                Matrix matrix3 = this.f4516j0;
                matrix3.reset();
                this.f4515i0.invert(matrix3);
                this.f4519n.setTransform(matrix2);
                this.f4519n.invalidate();
            }
            invalidate();
        }
        this.C0.j();
    ...
    public final void i() {
        ...
        oc ocVar = this.C0;
        o8 o8Var = ocVar.K1;
        if (o8Var != null && o8Var.f5182u && o8Var.K && (qbVar = ocVar.f5271v1) != null && qbVar.R0 != null) {
