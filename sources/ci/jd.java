...
public final class jd implements Runnable {
    public final MessagesController f4859a;
    public final TLRPC.User[] f4860b;
    public final double f4861c;
    public final double d;
    public final int[] e;
    public final ConnectionsManager f4862f;
    public final hd h;
    ...
    public jd(MessagesController messagesController, TLRPC.User[] userArr, double d, double d10, int[] iArr, ConnectionsManager connectionsManager, hd hdVar, String str) {
        this.f4859a = messagesController;
        this.f4860b = userArr;
        this.f4861c = d;
        this.d = d10;
        this.e = iArr;
        this.f4862f = connectionsManager;
        this.h = hdVar;
        this.f4863n = str;
    }
    ...
    public final void run() {
        ...
        tL_messages_getInlineBotResults.bot = this.f4859a.getInputUser(this.f4860b[0]);
        tL_messages_getInlineBotResults.query = "";
        tL_messages_getInlineBotResults.offset = "";
        tL_messages_getInlineBotResults.flags |= 1;
        TLRPC.TL_inputGeoPoint tL_inputGeoPoint = new TLRPC.TL_inputGeoPoint();
        tL_messages_getInlineBotResults.geo_point = tL_inputGeoPoint;
        final double d = this.f4861c;
        ...
        iArr[0] = this.f4862f.sendRequest(tL_messages_getInlineBotResults, new RequestDelegate() {
            @Override
                        ...
                        if (z10) {
                            ...
                            if (!messages_botresults.results.isEmpty()) {
                                ...
                                try {
                                    ...
                                    tLObject3.f5097a = d11;
                                    tLObject3.f5098b = d12;
                                    tLObject3.f5099c = str3;
