...
public final class k4 extends FrameLayout {
    ...
    public final org.telegram.ui.Components.v9 f4879a;
    ...
    public final void setVisibility(int i10) {
        ...
        if (i10 == 0 && !this.f4881c) {
            this.f4879a.setImageDrawable(new kj0(R.raw.utyan_empty2, AndroidUtilities.dp(130.0f), AndroidUtilities.dp(130.0f)));
            this.f4881c = true;
        }
    }
}
