...
public final class k4 extends FrameLayout {
    ...
    public final org.telegram.ui.Components.w9 f4880a;
    ...
    public final void setVisibility(int i10) {
        ...
        if (i10 == 0 && !this.f4882c) {
            this.f4880a.setImageDrawable(new ij0(R.raw.utyan_empty2, AndroidUtilities.dp(130.0f), AndroidUtilities.dp(130.0f)));
            this.f4882c = true;
        }
    }
}
