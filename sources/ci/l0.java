...
public final class l0 extends View {
    ...
    public final Path f4914b;
    public final RectF f4915c;
    public final m0 d;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        m0 m0Var = this.d;
        g0 g0Var = m0Var.h;
        int[] iArr = m0Var.f5030x;
        d7 d7Var = m0Var.f5022a;
        if (m0Var.f5023b == null) {
            return;
        }
        canvas.save();
        Paint paint = this.f4913a;
        paint.setColor(-16777216);
        paint.setAlpha((int) (m0Var.f5028s * 255.0f));
        canvas.drawRect(0.0f, 0.0f, getWidth(), getHeight(), paint);
        if (m0Var.f5028s < 1.0f) {
            Path path = this.f4914b;
            path.rewind();
            RectF rectF = this.f4915c;
            rectF.set(0.0f, 0.0f, d7Var.getWidth(), d7Var.getHeight());
            int[] iArr2 = m0Var.f5029w;
            rectF.offset(iArr2[0], iArr2[1]);
            RectF rectF2 = AndroidUtilities.rectTmp;
            rectF2.set(0.0f, 0.0f, getWidth(), getHeight());
            AndroidUtilities.lerp(rectF, rectF2, m0Var.f5028s, rectF);
            float lerp3 = AndroidUtilities.lerp(AndroidUtilities.dp(12.0f), 0, m0Var.f5028s);
            path.addRoundRect(rectF, lerp3, lerp3, Path.Direction.CW);
            canvas.clipPath(path);
        }
        float f13 = m0Var.f5028s;
        float f14 = 1.0f - f13;
        int[] iArr3 = m0Var.v;
        ...
        if (i11 > 0) {
            if (m0Var.E) {
                m0Var.f5023b.getLocationOnScreen(iArr);
            }
            canvas.translate(iArr[0] * f14, iArr[1] * f14);
            MediaController.CropState cropState2 = m0Var.f5023b.G0;
            if (cropState2 != null) {
        ...
        if (i11 > 0) {
            float contentWidth = m0Var.f5023b.getContentWidth();
            float contentHeight = m0Var.f5023b.getContentHeight();
            MediaController.CropState cropState3 = m0Var.f5023b.G0;
            if (cropState3 != null) {
        ...
        if (cropState4 == null) {
            ...
            lerp2 = AndroidUtilities.lerp(cropState4.cropRotate + cropState4.transformRotation, d, m0Var.f5028s);
        }
        canvas.rotate(lerp2);
