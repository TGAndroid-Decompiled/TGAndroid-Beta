...
public final class v0 extends View {
    public final Paint f5637a;
    public final TextPaint f5638b;
    public final StaticLayout f5639c;
    public final float d;
    public final float e;
    public final Path f5640f;
    public androidx.fragment.app.a0 h;
    public boolean f5641n;
    public final org.telegram.ui.Components.c6 f5642r;
    ...
    public final void dispatchDraw(Canvas canvas) {
        float f7;
        float e = this.f5642r.e(this.f5641n);
        if (e <= 0.0f) {
            return;
        }
        canvas.save();
        if (this.f5641n) {
            f7 = qr.f27424k.getInterpolation(e);
        } else {
            f7 = 1.0f;
        }
        ...
        path.close();
        Paint paint = this.f5637a;
        paint.setAlpha((int) (204.0f * interpolation));
        canvas.drawPath(path, paint);
        canvas.save();
        StaticLayout staticLayout = this.f5639c;
        ...
        this.f5638b.setAlpha((int) (interpolation * 255.0f));
