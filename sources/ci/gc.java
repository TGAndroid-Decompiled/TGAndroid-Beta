...
public final class gc extends FrameLayout {
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        ocVar.f5223h0.layout(0, 0, ocVar.S, ocVar.T);
        ocVar.f5223h0.setPivotX(ocVar.S * 0.5f);
        FrameLayout frameLayout = ocVar.f5226i0;
        frameLayout.layout(0, i14, ocVar.S, frameLayout.getMeasuredHeight() + i14);
        FrameLayout frameLayout2 = ocVar.f5232k0;
        ...
        ocVar.f5235l0.layout(0, 0, ocVar.S, ocVar.T);
        eb ebVar = ocVar.f5260t0;
        if (ebVar != null) {
            ebVar.layout(0, 0, measuredWidth, measuredHeight);
        }
        ocVar.f5256s.f5803c.layout(0, 0, measuredWidth, measuredHeight);
        i iVar = ocVar.f5208c1.M;
        if (iVar != null) {
        ...
        if (qbVar != null) {
            qbVar.layout(0, 0, qbVar.getMeasuredWidth(), ocVar.f5267v1.getMeasuredHeight());
        }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        oc ocVar = this.e;
        a(ocVar.f5223h0, ocVar.S, ocVar.T);
        ocVar.j();
        a(ocVar.f5226i0, ocVar.S, AndroidUtilities.dp(150.0f));
        a(ocVar.f5232k0, ocVar.S, AndroidUtilities.dp(220.0f));
        a(ocVar.m0, ocVar.S, ocVar.U);
        a(ocVar.f5235l0, ocVar.S, ocVar.T);
        a(ocVar.f5256s.f5803c, size, size2);
        eb ebVar = ocVar.f5260t0;
        if (ebVar != null) {
            a(ebVar, size, size2);
        }
    ...
    public final void setTranslationY(float f7) {
        this.f4725a = f7;
        super.setTranslationY(this.f4726b + f7);
