...
public final class w1 extends kl0 {
    public String e;
    public TLRPC.User f5678f;
    public String h;
    public boolean f5679n;
    public final z1 f5681s;
    public final androidx.fragment.app.a0 f5677c = new androidx.fragment.app.a0(this, 11);
    public int d = -1;
    ...
    public static void E(w1 w1Var, boolean z10) {
        int i10;
        z1 z1Var = w1Var.f5681s;
        ArrayList arrayList = z1Var.h;
        arrayList.clear();
        i10 = ((org.telegram.ui.ActionBar.f3) z1Var.f5855r).currentAccount;
    ...
    public final Object F(int i10) {
        ...
        if (!z1Var.f5854n.isEmpty()) {
            if (!z1Var.h.isEmpty() && TextUtils.isEmpty(this.e)) {
                i11--;
            }
            if (i11 >= 0 && i11 < z1Var.f5854n.size()) {
                return z1Var.f5854n.get(i11);
            }
            return null;
        }
        return null;
        ...
        if (!this.f5680r) {
            ...
            if (this.f5678f == null) {
                ...
                if (userOrChat instanceof TLRPC.User) {
                    this.f5678f = (TLRPC.User) userOrChat;
                }
            }
            TLRPC.User user = this.f5678f;
            if (user == null && !this.f5679n) {
                ...
                tL_messages_getInlineBotResults.bot = MessagesController.getInstance(i10).getInputUser(this.f5678f);
                String str = this.e;
                String str2 = "";
                if (str == null) {
                    str = "";
    ...
    public final void H(String str) {
        ...
        this.e = str;
        androidx.fragment.app.a0 a0Var = this.f5677c;
    ...
    public final int j(int i10) {
        ...
        if (!z1Var.f5854n.isEmpty() && !z1Var.h.isEmpty() && TextUtils.isEmpty(this.e) && i11 == 0) {
            return 1;
        }
        return 2;
    }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i11 == 0) {
            view.setTag(34);
            view.setLayoutParams(new s4.p0(-1, (int) this.f5681s.f5855r.f5545n));
        } else if (i11 == 2) {
            ...
            if (F instanceof TLRPC.Document) {
                ...
                e2Var.e((TLRPC.BotInlineResult) F, this.f5678f, true, false, false, true);
            }
        }
    }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 == 0) {
            ...
            e6Var = ((org.telegram.ui.ActionBar.f3) z1Var.f5855r).resourcesProvider;
