...
public final class w1 extends ul0 {
    public String e;
    public TLRPC.User f5684f;
    public String h;
    public boolean f5685n;
    public final z1 f5687s;
    public final androidx.fragment.app.a0 f5683c = new androidx.fragment.app.a0(this, 11);
    public int d = -1;
    public boolean f5686r = false;
    ...
    public static void E(w1 w1Var, boolean z10) {
        int i10;
        z1 z1Var = w1Var.f5687s;
        ArrayList arrayList = z1Var.h;
        arrayList.clear();
        i10 = ((org.telegram.ui.ActionBar.f3) z1Var.f5861r).currentAccount;
    ...
    public final Object F(int i10) {
        ...
        if (!z1Var.f5860n.isEmpty()) {
            if (!z1Var.h.isEmpty() && TextUtils.isEmpty(this.e)) {
                i11--;
            }
            if (i11 >= 0 && i11 < z1Var.f5860n.size()) {
                return z1Var.f5860n.get(i11);
            }
            return null;
        }
        return null;
        ...
        if (!this.f5686r) {
            ...
            if (this.f5684f == null) {
                ...
                if (userOrChat instanceof TLRPC.User) {
                    this.f5684f = (TLRPC.User) userOrChat;
                }
            }
            TLRPC.User user = this.f5684f;
            if (user == null && !this.f5685n) {
                ...
                tL_messages_getInlineBotResults.bot = MessagesController.getInstance(i10).getInputUser(this.f5684f);
                String str = this.e;
                String str2 = "";
                if (str == null) {
                    str = "";
    ...
    public final void H(String str) {
        ...
        this.e = str;
        androidx.fragment.app.a0 a0Var = this.f5683c;
    ...
    public final int j(int i10) {
        ...
        if (!z1Var.f5860n.isEmpty() && !z1Var.h.isEmpty() && TextUtils.isEmpty(this.e) && i11 == 0) {
            return 1;
        }
        return 2;
    }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i11 == 0) {
            view.setTag(34);
            view.setLayoutParams(new s4.p0(-1, (int) this.f5687s.f5861r.f5551n));
        } else if (i11 == 2) {
            ...
            if (F instanceof TLRPC.Document) {
                ...
                f2Var.e((TLRPC.BotInlineResult) F, this.f5684f, true, false, false, true);
            }
        }
    }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 == 0) {
            ...
            f6Var = ((org.telegram.ui.ActionBar.f3) z1Var.f5861r).resourcesProvider;
