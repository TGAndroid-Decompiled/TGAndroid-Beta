...
public final class t0 extends View {
    ...
    public final TextPaint f5534b;
    public final TextPaint f5535c;
    public final Paint d;
    public final Paint e;
    public final Paint f5536f;
    public final org.telegram.ui.Components.yc h;
    public kj0 f5537n;
    public final StaticLayout f5538r;
    public final float f5539s;
    public final float v;
    public StaticLayout f5540w;
    public float f5541x;
    public float f5542y;
    ...
    public final void b(int i10, int i11, CharSequence charSequence) {
        ...
        this.f5537n.start();
        StaticLayout staticLayout = new StaticLayout(charSequence, this.f5535c, AndroidUtilities.displaySize.x, Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
        this.f5540w = staticLayout;
        float f10 = 0.0f;
        if (staticLayout.getLineCount() > 0) {
            f7 = this.f5540w.getLineWidth(0);
        } else {
            f7 = 0.0f;
        }
        this.f5541x = f7;
        if (this.f5540w.getLineCount() > 0) {
            f10 = this.f5540w.getLineLeft(0);
        }
        this.f5542y = f10;
        this.G = false;
        invalidate();
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float max = Math.max(this.f5539s, AndroidUtilities.dp(54.0f)) + AndroidUtilities.dp(42.0f);
        int dp = AndroidUtilities.dp(111.0f);
        StaticLayout staticLayout = this.f5538r;
        ...
        float dp2 = AndroidUtilities.dp(74.0f) + this.f5541x;
        ...
        if (d10 > 0.0f) {
            ...
            if (kj0Var != null) {
                ...
                this.f5537n.setBounds((int) (rectF.left + AndroidUtilities.dp(9.0f)), (int) (rectF.top + AndroidUtilities.dp(6.0f)), (int) (rectF.left + AndroidUtilities.dp(45.0f)), (int) (rectF.top + AndroidUtilities.dp(f11)));
                this.f5537n.draw(canvas2);
            }
            if (this.f5540w != null) {
                canvas2.save();
                canvas2.translate((rectF.left + AndroidUtilities.dp(52.0f)) - this.f5542y, rectF.centerY() - (this.f5540w.getHeight() / 2.0f));
                this.f5535c.setAlpha((int) (f15 * f12));
                this.f5540w.draw(canvas2);
                canvas2.restore();
            }
        }
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        if (drawable != this.f5537n && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
    ...
    public t0(Context context, String str) {
        ...
        this.f5534b = textPaint;
        TextPaint textPaint2 = new TextPaint(1);
        this.f5535c = textPaint2;
        ...
        this.f5538r = staticLayout;
        this.f5539s = staticLayout.getLineCount() > 0 ? staticLayout.getLineWidth(0) : 0.0f;
