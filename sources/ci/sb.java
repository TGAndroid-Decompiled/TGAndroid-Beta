...
public final class sb extends org.telegram.ui.ActionBar.n2 {
    ...
    public sb(oc ocVar, int i10) {
        ...
        switch (i10) {
            case 1:
                this.f5524b = ocVar;
                super(null);
                this.currentAccount = ocVar.f5206c;
                return;
            default:
                this.f5524b = ocVar;
                return;
    ...
    public final org.telegram.ui.ActionBar.e6 getResourceProvider() {
        switch (this.f5523a) {
            case 0:
                return new ai.x3(7, this.f5524b.f5199a);
            default:
                return new ai.x3(8, this.f5524b.f5199a);
        }
    }
