...
public final class zc extends View {
    ...
    public rc f5883a0;
    public long f5884a1;
    public Runnable f5885b;
    public int f5886b0;
    public final org.telegram.ui.Components.d6 f5887b1;
    public int f5888c;
    public final org.telegram.ui.Components.d6 f5889c0;
    public long f5890c1;
    public Runnable d;
    public final org.telegram.ui.Components.d6 f5891d0;
    public ai.j f5892d1;
    public long e;
    public final org.telegram.ui.Components.d6 f5893e0;
    public long f5894e1;
    public long f5895f;
    public final org.telegram.ui.Components.d6 f5896f0;
    public long f5897f1;
    public final org.telegram.ui.Components.d6 f5898g0;
    public float f5899g1;
    public tc h;
    public final org.telegram.ui.Components.d6 f5900h0;
    public int f5901h1;
    public final org.telegram.ui.Components.d6 f5902i0;
    public int f5903i1;
    public boolean f5904j0;
    public int f5905j1;
    public final org.telegram.ui.Components.ia f5906k0;
    public int f5907k1;
    public final org.telegram.ui.Components.ma f5908l0;
    public boolean l1;
    public final org.telegram.ui.Components.ma m0;
    public boolean f5909m1;
    public int f5910n;
    public final org.telegram.ui.Components.ma f5911n0;
    public float f5912n1;
    public final RectF f5913o0;
    public boolean f5914o1;
    public final Path f5915p0;
    public VelocityTracker f5916p1;
    public final w01 f5917q0;
    public boolean f5918q1;
    public final ArrayList f5919r;
    public final Drawable f5920r0;
    public boolean f5921r1;
    public final ArrayList f5922s;
    public final yc f5923s0;
    public int f5924s1;
    public final RectF f5925t0;
    public final float[] f5926t1;
    public final Paint f5927u0;
    public int f5928u1;
    public tc v;
    public final Path f5929v0;
    public int f5930v1;
    public final Paint f5931w;
    public final Path f5932w0;
    public int f5933w1;
    public final Path f5934x;
    public final RectF f5935x0;
    public int f5936x1;
    public final Path f5937y;
    public final Path f5938y0;
    public int f5939y1;
    public final Paint f5940z0;
    public int f5941z1;
    ...
    public zc(Context context, ViewGroup viewGroup, ac acVar, org.telegram.ui.ActionBar.f6 f6Var, org.telegram.ui.Components.ia iaVar) {
        ...
        this.f5931w = new Paint(3);
        this.f5934x = new Path();
        this.f5937y = new Path();
        this.f5886b0 = 1;
        qr qrVar = qr.h;
        this.f5889c0 = new org.telegram.ui.Components.d6(this, 0L, 360L, qrVar);
        this.f5891d0 = new org.telegram.ui.Components.d6(this, 360L, qrVar);
        this.f5893e0 = new org.telegram.ui.Components.d6(this, 0L, 360L, qrVar);
        this.f5896f0 = new org.telegram.ui.Components.d6(this, 360L, qrVar);
        this.f5898g0 = new org.telegram.ui.Components.d6(this, 0L, 360L, qrVar);
        this.f5900h0 = new org.telegram.ui.Components.d6(this, 0L, 360L, qrVar);
        this.f5902i0 = new org.telegram.ui.Components.d6(this, 0L, 320L, qrVar);
        this.f5904j0 = true;
        this.f5913o0 = new RectF();
        this.f5915p0 = new Path();
        this.f5923s0 = new yc();
        this.f5925t0 = new RectF();
        this.f5927u0 = new Paint(3);
        this.f5929v0 = new Path();
        this.f5932w0 = new Path();
        this.f5935x0 = new RectF();
        this.f5938y0 = new Path();
        ...
        this.Z0 = -1L;
        this.f5884a1 = -1L;
        this.f5887b1 = new org.telegram.ui.Components.d6(0.0f, this, 0L, 340L, qrVar);
        this.f5890c1 = -1L;
        this.f5901h1 = -1;
        this.f5903i1 = -1;
        this.f5905j1 = -1;
        ...
        this.f5917q0 = new w01(LocaleController.getString(R.string.StoryTimeline), 12.0f, AndroidUtilities.bold());
        ...
        this.f5906k0 = iaVar;
        this.f5908l0 = new org.telegram.ui.Components.ma(iaVar, this, 0, false);
        this.m0 = new org.telegram.ui.Components.ma(iaVar, this, 3, false);
        this.f5911n0 = new org.telegram.ui.Components.ma(iaVar, this, 4, false);
    ...
    public static void a(final zc zcVar, ViewGroup viewGroup, org.telegram.ui.ActionBar.f6 f6Var, org.telegram.ui.Components.ia iaVar, View view) {
        int i10;
        ArrayList arrayList = zcVar.f5922s;
        int i11 = zcVar.f5905j1;
        try {
            if (i11 == 2 && zcVar.N) {
                    ...
                    public final void run(Object obj) {
                        ...
                        switch (r2) {
                            case 0:
                                ...
                                zc zcVar2 = this.f5367b;
                                zcVar2.V = floatValue;
                                sc scVar = zcVar2.f5882a;
                                if (scVar != null) {
                            ...
                            case 1:
                                ...
                                zc zcVar3 = this.f5367b;
                                zcVar3.L = floatValue2;
                                sc scVar2 = zcVar3.f5882a;
                                if (scVar2 != null) {
                                ...
                                return;
                            default:
                                zc zcVar4 = this.f5367b;
                                zcVar4.h.f5581i = f7.floatValue();
                                sc scVar3 = zcVar4.f5882a;
                                if (scVar3 != null) {
                ...
                int i12 = zcVar.f5930v1;
                int i13 = zcVar.f5939y1;
                int i14 = zcVar.f5936x1;
                float min2 = Math.min((i12 - i13) - i14, ((((AndroidUtilities.lerp(zcVar.T, 1.0f, zcVar.f5896f0.f23570c) * ((float) zcVar.R)) + ((float) (zcVar.Q - zcVar.f5895f))) / ((float) min)) * zcVar.f5928u1) + i13 + i14);
                ...
                F.V(5);
                F.U = true;
                F.a0((-(zcVar.f5930v1 - min2)) + AndroidUtilities.dp(18.0f), zcVar.F0.top);
                F.Z();
                ...
                int i15 = zcVar.f5930v1;
                int i16 = zcVar.f5939y1;
                int i17 = zcVar.f5936x1;
                float min4 = Math.min((i15 - i16) - i17, ((((AndroidUtilities.lerp(zcVar.K, 1.0f, zcVar.f5891d0.f23570c) * ((float) zcVar.H)) + ((float) (zcVar.I - zcVar.f5895f))) / ((float) min3)) * zcVar.f5928u1) + i16 + i17);
                ...
                F2.V(5);
                F2.U = true;
                F2.a0((-(zcVar.f5930v1 - min4)) + AndroidUtilities.dp(18.0f), zcVar.f5935x0.top);
                F2.Z();
                ...
                F3.V(5);
                F3.U = true;
                F3.a0(AndroidUtilities.dp(18.0f), zcVar.f5925t0.top);
                F3.Z();
                F3.R(iaVar, -view.getX(), -view.getY());
                zcVar.performHapticFeedback(0, 1);
            } else if (i11 == 3 && (i10 = zcVar.f5907k1) >= 0 && i10 < arrayList.size()) {
                tc tcVar = (tc) arrayList.get(zcVar.f5907k1);
                i8 i8Var4 = new i8(zcVar.getContext(), 0);
                i8Var4.f4790b = 0.0f;
                i8Var4.f4791c = 1.5f;
                i8Var4.d(tcVar.f5581i);
                i8Var4.h = new m2(7, zcVar, tcVar);
                y70 F4 = y70.F(viewGroup, f6Var, zcVar);
                F4.q(i8Var4);
                F4.V(5);
                F4.U = true;
                F4.a0(AndroidUtilities.dp(18.0f), tcVar.f5582j.top);
                F4.Z();
    ...
    private float getAudioHeight() {
        return AndroidUtilities.lerp(AndroidUtilities.dp(28.0f), AndroidUtilities.dp(38.0f), this.f5896f0.e(this.P));
    }
    ...
    private float getCollageHeight() {
        ArrayList arrayList = this.f5922s;
        ...
        for (int i10 = 0; i10 < arrayList.size(); i10++) {
            ...
            f7 += AndroidUtilities.lerp(AndroidUtilities.dp(28.0f), AndroidUtilities.dp(38.0f), ((tc) arrayList.get(i10)).f5583k.f23570c);
        }
        return f7;
    }
    ...
    private float getRoundHeight() {
        ...
        return AndroidUtilities.lerp(AndroidUtilities.dp(28.0f), AndroidUtilities.dp(38.0f), this.f5891d0.e(this.G));
    }
    ...
    private float getVideoHeight() {
        ...
        return AndroidUtilities.lerp(AndroidUtilities.dp(28.0f), AndroidUtilities.dp(38.0f), tcVar.f5583k.f23570c);
    }
    ...
    public final void computeScroll() {
        bn0 bn0Var = this.W0;
        if (bn0Var.b()) {
            int i10 = bn0Var.f23052j;
            long min = Math.min(getBaseDuration(), getMaxScrollDuration());
            if (this.f5918q1) {
                this.f5895f = Math.max(0.0f, (((i10 - this.f5939y1) - this.f5936x1) / this.f5928u1) * ((float) min));
            } else if (!this.P) {
                bn0Var.a();
                return;
            } else {
                int i11 = this.f5939y1;
                int i12 = this.f5936x1;
                float f7 = this.f5928u1;
                float f10 = (float) min;
                h(((((i10 - i11) - i12) / f7) * f10) - ((((this.f5924s1 - i11) - i12) / f7) * f10));
            }
            invalidate();
            this.f5924s1 = i10;
        } else if (this.f5921r1) {
            this.f5921r1 = false;
            sc scVar = this.f5882a;
            if (scVar != null) {
                scVar.u(false);
            }
        }
    ...
    public final void d(Canvas canvas, float f7, float f10, long j3, float f11) {
        ...
        tc tcVar = this.v;
        if (tcVar != null) {
            f12 = (tcVar.f5580g * ((float) tcVar.e)) + ((float) tcVar.f5579f);
        } else {
            if (this.h == null) {
                j10 = this.Q;
            } else {
        ...
        float f13 = (this.f5928u1 * (((clamp + f12) - ((float) this.f5895f)) / ((float) min))) + this.f5939y1 + this.f5936x1;
    ...
    public final void e(Canvas canvas, Paint paint, float f7, float f10, float f11, float f12, float f13) {
        ...
        canvas.saveLayerAlpha(0.0f, 0.0f, this.f5930v1, this.f5933w1, 255, 31);
        int i10 = (int) (255.0f * f13);
        Paint paint3 = this.f5940z0;
        paint3.setAlpha(i10);
    ...
    public int getContentHeight() {
        ...
        return (int) (f15 + f12 + this.f5941z1);
    }
    ...
    public int getTimelineHeight() {
        return AndroidUtilities.lerp(AndroidUtilities.dp(28.0f) + this.f5941z1 + this.f5941z1, getContentHeight(), this.f5902i0.f23570c);
    }
    ...
    public final void h(float f7) {
        ...
        if (tcVar == null && !this.E) {
            ...
            sc scVar2 = this.f5882a;
            if (scVar2 != null) {
                scVar2.U(this.S);
                this.f5882a.Q(this.T);
            }
        } else if (this.P) {
            if (tcVar != null) {
                f10 = tcVar.f5580g;
            ...
            if (tcVar != null) {
                f12 = (tcVar.h - tcVar.f5580g) * ((float) tcVar.e);
            } else {
        ...
        invalidate();
        sc scVar5 = this.f5882a;
        if (scVar5 != null) {
            scVar5.h0(this.Q + (this.S * ((float) this.R)));
        }
        boolean z10 = this.f5909m1;
        if (!z10 && (scVar = this.f5882a) != null) {
            scVar.u(true);
            tc tcVar2 = this.h;
            if (tcVar2 != null) {
                ...
                clamp = Utilities.clamp(j27, f23 * f24, tcVar2.f5580g * f24);
            } else if (this.E) {
            ...
            if (this.h != null && Math.abs(this.e - clamp) > 400) {
                this.f5890c1 = this.e;
                this.f5887b1.d(1.0f, true);
            }
            sc scVar6 = this.f5882a;
            this.e = clamp;
            scVar6.m(clamp, false);
        } else if (z10 || this.f5921r1) {
            tc tcVar3 = this.h;
            if (tcVar3 != null) {
                long j29 = this.Q + (this.S * ((float) this.R));
                float f28 = tcVar3.h;
                float f29 = (float) tcVar3.e;
                this.e = Utilities.clamp(j29, f28 * f29, tcVar3.f5580g * f29);
    ...
    public final void i(tc tcVar, float f7) {
        ...
        if (tcVar != null) {
            ...
            if (tcVar2 != tcVar && tcVar2 != null) {
                if (this.f5910n == this.f5922s.indexOf(tcVar)) {
                    tc tcVar3 = this.v;
                    float f10 = (float) tcVar3.e;
                    float f11 = tcVar.h;
                    float f12 = (float) tcVar.e;
                    float f13 = tcVar.f5580g;
                    long j15 = (f10 * 0.0f) - (f13 * f12);
                    float min = Math.min(f11 - f13, ((tcVar3.h - tcVar3.f5580g) * f10) / f12);
                    long j16 = tcVar.f5579f;
                    long j17 = f7;
                    long j18 = j16 + j17;
                    if (j18 > (f10 * 1.0f) - (f11 * f12)) {
                        ...
                        long j20 = (tcVar5.f5580g * f15) - (clamp3 * f17);
                        if (j19 < j20) {
                            j14 = j20;
                            j13 = j19;
                        } else {
                        ...
                        tcVar.f5579f = Utilities.clamp(tcVar.f5579f + j17, j14, j13);
                        sc scVar2 = this.f5882a;
                        if (scVar2 != null) {
                            scVar2.O(tcVar.f5580g, tcVar.f5576a);
                            this.f5882a.W(tcVar.h, tcVar.f5576a);
                        }
                    } else if (j18 < j15) {
                        tc tcVar6 = this.v;
                        float clamp4 = Utilities.clamp((((tcVar6.f5580g * ((float) tcVar6.e)) - ((float) j16)) - ((float) j17)) / ((float) tcVar.e), 1.0f - min, 0.0f);
                        tcVar.f5580g = clamp4;
                        ...
                        long j22 = (tcVar7.f5580g * f19) - (tcVar.f5580g * f20);
                        if (j21 < j22) {
                            j12 = j22;
                            j11 = j21;
                        } else {
                        ...
                        tcVar.f5579f = Utilities.clamp(tcVar.f5579f + j17, j12, j11);
                        sc scVar3 = this.f5882a;
                        if (scVar3 != null) {
                            scVar3.O(tcVar.f5580g, tcVar.f5576a);
                            this.f5882a.W(tcVar.h, tcVar.f5576a);
                        }
                    } else {
                        tcVar.f5579f = j18;
                    ...
                    long j23 = tcVar.f5579f + f7;
                    float f21 = (float) tcVar.e;
                    tcVar.f5579f = Utilities.clamp(j23, ((float) getBaseDuration()) - (tcVar.h * f21), (-tcVar.f5580g) * f21);
                }
            }
            invalidate();
            sc scVar4 = this.f5882a;
            if (scVar4 != null) {
                scVar4.c0(tcVar.f5576a, tcVar.f5579f);
            }
            boolean z10 = this.f5909m1;
            if (!z10 && (scVar = this.f5882a) != null) {
                scVar.u(true);
                ...
                if (tcVar8 != tcVar && tcVar8 != null) {
                    long j24 = tcVar.f5579f + (tcVar.f5580g * ((float) tcVar.e));
                    float f22 = tcVar8.h;
                    float f23 = (float) tcVar8.e;
                    clamp = Utilities.clamp(j24, f22 * f23, tcVar8.f5580g * f23);
                } else {
                    float f24 = tcVar.f5580g;
                ...
                if (tcVar10 != tcVar && tcVar10 != null) {
                    long j25 = tcVar.f5579f + (tcVar.f5580g * ((float) tcVar.e));
                    float f25 = tcVar10.h;
                    float f26 = (float) tcVar10.e;
                    this.e = Utilities.clamp(j25, f25 * f26, tcVar10.f5580g * f26);
                } else {
                    float f27 = tcVar.f5580g;
    ...
    public final void j(float f7) {
        ...
        if (tcVar == null) {
            ...
            if (j20 > j16) {
                ...
                long j22 = (tcVar3.f5580g * f18) - (clamp4 * f20);
                if (j21 < j22) {
                    j12 = j22;
                    j11 = j21;
                } else {
                ...
                tc tcVar4 = this.h;
                float clamp5 = Utilities.clamp((((tcVar4.f5580g * ((float) tcVar4.e)) - ((float) j18)) - ((float) j19)) / ((float) this.H), 1.0f - min, 0.0f);
                this.J = clamp5;
                float clamp6 = Utilities.clamp(clamp5 + min, 1.0f, 0.0f);
                this.K = clamp6;
                tc tcVar5 = this.h;
                ...
                long j24 = (tcVar5.f5580g * f22) - (this.J * f23);
                if (j23 < j24) {
                    j10 = j24;
                    j3 = j23;
                } else {
        ...
        if (!z10 && (scVar = this.f5882a) != null) {
            ...
            if (tcVar6 != null) {
                ...
                clamp = Utilities.clamp(j26, f25 * f26, tcVar6.f5580g * f26);
            } else {
                float f27 = this.J;
            ...
            if (tcVar7 != null) {
                ...
                this.e = Utilities.clamp(j27, f28 * f29, tcVar7.f5580g * f29);
            } else {
                float f30 = this.J;
    ...
    public final void k() {
        ...
        tc tcVar = this.h;
        long j3 = tcVar.e;
        this.f5895f = Utilities.clamp((((tcVar.h + tcVar.f5580g) / 2.0f) * ((float) j3)) - (((float) min) / 2.0f), j3 - min, 0L);
        invalidate();
    }
    ...
    public final boolean m(float f7, boolean z10) {
        ...
        if (tcVar2 != null || this.N || !arrayList.isEmpty()) {
            long min = Math.min(getBaseDuration(), getMaxScrollDuration());
            float f10 = ((f7 - this.f5939y1) - this.f5936x1) / this.f5928u1;
            tc tcVar3 = this.v;
            if (tcVar3 != null) {
                j3 = (tcVar3.f5580g * ((float) tcVar3.e)) + ((float) tcVar3.f5579f);
            } else {
                j3 = 0;
            }
            ...
            long clamp = Utilities.clamp((f11 - ((float) j3)) + ((float) this.f5895f), (float) getBaseDuration(), 0.0f);
            tc tcVar4 = this.h;
            if (tcVar4 != null) {
                float f12 = ((float) clamp) / ((float) tcVar4.e);
                if (f12 < tcVar4.f5580g || f12 > tcVar4.h) {
                    return false;
                }
            }
            if (this.v == null || (clamp >= 0 && clamp < (tcVar.h - tcVar.f5580g) * ((float) tcVar.e))) {
    ...
    public final void n(String str, long j3, long j10, float f7, float f10, float f11, boolean z10) {
        ...
        this.E = z12;
        if (j11 != j3 && this.h == null && this.f5883a0 != null) {
            this.W = z11;
            p();
        }
        ...
        if (!z10) {
            this.f5891d0.f(this.G, z11);
            this.f5896f0.f(this.P, z11);
            this.f5889c0.f(this.E, z11);
        }
        invalidate();
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f5936x1 = dp4;
        this.f5928u1 = (this.f5930v1 - (dp4 * 2)) - (this.f5939y1 * 2);
        tc tcVar = this.h;
        if (tcVar != null && tcVar.d != null && tcVar.f5578c == null) {
            tc.a(tcVar, false);
        }
        ArrayList arrayList = this.f5922s;
        if (!arrayList.isEmpty()) {
            ...
            while (i12 < size2) {
                ...
                i12++;
                tc tcVar2 = (tc) obj;
                if (tcVar2.d != null && tcVar2.f5578c == null) {
                    tc.a(tcVar2, false);
                    tc.b(tcVar2);
                }
            }
        }
        if (this.O != null && this.f5883a0 == null) {
            p();
        }
    }
    ...
    public final void p() {
        if (getMeasuredWidth() > 0) {
            if (this.f5883a0 == null || this.W) {
                this.f5883a0 = new rc(this, this.O, (getMeasuredWidth() - getPaddingLeft()) - getPaddingRight());
                this.U = false;
                this.f5898g0.d(1.0f, true);
            }
        }
    }
    ...
    public void setCollage(ArrayList<o8> arrayList) {
        ...
        int i10 = 0;
        while (true) {
            arrayList2 = this.f5922s;
            if (i10 >= arrayList2.size()) {
                break;
            }
            tc tcVar = (tc) arrayList2.get(i10);
            if (tcVar != null && (xcVar = tcVar.f5578c) != null) {
                xcVar.b();
            }
            i10++;
        }
        ...
        if (arrayList != null) {
            for (int i12 = 0; i12 < arrayList.size(); i12++) {
                ...
                if (o8Var.K) {
                    ...
                    tcVar2.e = o8Var.f5158h0;
                    tcVar2.f5579f = o8Var.X;
                    tcVar2.f5581i = o8Var.P;
                    tcVar2.f5580g = o8Var.V;
                    tcVar2.h = o8Var.W;
                    tc.a(tcVar2, false);
                    tc.b(tcVar2);
