...
public final class e7 implements Runnable {
    ...
    public final void run() {
        ...
        switch (this.f4602a) {
            case 0:
                h7 h7Var = this.f4603b;
                if (h7Var.f4750a.get() != null && h7Var.f4753f != null && !h7Var.f4751b.get()) {
                    TextureView textureView = h7Var.f4753f.getTextureView();
                    if (textureView != null) {
                        ...
                        Bitmap bitmap = h7Var.f4754g;
                        if (bitmap == null || max != bitmap.getWidth() || max2 != h7Var.f4754g.getHeight()) {
                            h7Var.f4754g = Bitmap.createBitmap(max, max2, Bitmap.Config.ARGB_8888);
                        }
                        textureView.getBitmap(h7Var.f4754g);
                        Bitmap bitmap2 = h7Var.f4754g;
                        String str = h7Var.e;
                        f7 f7Var = null;
                        if (bitmap2 != null && (nVar = (r8.n) h7Var.f4750a.get()) != null && nVar.f42447b.k()) {
                        ...
                        if (z10 == z11) {
                            if (f7Var != null && f7Var2 != null) {
                                PointF[] pointFArr2 = f7Var.f4664b;
                                PointF[] pointFArr3 = f7Var2.f4664b;
                                if (TextUtils.equals(f7Var.f4663a, f7Var2.f4663a)) {
