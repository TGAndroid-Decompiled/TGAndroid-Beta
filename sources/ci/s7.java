...
public final class s7 implements e2.h {
    ...
    public final void accept(Object obj) {
        ...
        switch (this.f5513a) {
            case 0:
                r7 r7Var = (r7) this.f5514b;
                MessagesController messagesController = (MessagesController) this.f5515c;
            ...
            case 1:
                Utilities.Callback callback = (Utilities.Callback) this.f5515c;
                TLRPC.InputPeer inputPeer = (TLRPC.InputPeer) this.d;
                ((org.telegram.ui.ActionBar.b2) this.f5514b).dismiss();
                ...
                return;
            case 2:
                rg.j0 j0Var = (rg.j0) this.f5514b;
                TL_stories.TL_premium_myBoosts tL_premium_myBoosts = (TL_stories.TL_premium_myBoosts) this.d;
                TL_stories.TL_premium_boostsStatus tL_premium_boostsStatus = (TL_stories.TL_premium_boostsStatus) obj;
                j0Var.getClass();
                boolean z10 = false;
                ((f90) this.f5515c).setLoading(false);
                if (tL_premium_boostsStatus != null) {
                    j0Var.f42311b0.boosts++;
                    if (j0Var.f42317h0 == 32 && (t12 = j0Var.t1()) != null) {
                        t12.boosts_applied++;
                    }
                    j0Var.z1();
                    j0Var.F1(tL_premium_boostsStatus, j0Var.f42314e0);
                    ChannelBoostsController.CanApplyBoost canApplyBoost = j0Var.f42312c0;
                    if (j0Var.f42311b0.next_level_boosts <= 0) {
                        z10 = true;
                    }
                ...
                return;
            default:
                ((u2.k0) obj).c(((a5.a) this.f5514b).f275b, (u2.f0) this.f5515c, (u2.b0) this.d);
                return;
        }
    }
}
