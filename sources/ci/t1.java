...
public final class t1 implements RequestDelegate {
    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        switch (this.f5525a) {
            ...
            case 1:
                ...
                return;
            case 2:
                AndroidUtilities.runOnUIThread(new u1((Object) ((xn) this.f5527c), (Object) ((nf.e) this.d), tLObject, (Object) ((kg) this.e), this.f5526b, 14));
                return;
            case 3:
                AndroidUtilities.runOnUIThread(new i2.c1((dp) this.f5527c, (TLRPC.TL_channels_toggleUsername) this.d, tLObject, (TLRPC.TL_username) this.e, this.f5526b, tL_error, 8));
                return;
            case 4:
                AndroidUtilities.runOnUIThread(new u1((ty) this.f5527c, (String) this.e, this.f5526b, (String) this.d, tLObject));
                return;
            default:
                AndroidUtilities.runOnUIThread(new i2.c1((zt) this.f5527c, tLObject, (d) this.d, this.f5526b, (HashSet) this.e, tL_error, 10));
                return;
        }
    }
    ...
    public t1(zt ztVar, d dVar, boolean z10, HashSet hashSet) {
        this.f5525a = 5;
        this.f5527c = ztVar;
        this.d = dVar;
        this.f5526b = z10;
