...
public final class va implements o1.f {
    ...
    public final void a(o1.h hVar, boolean z10, float f7, float f10) {
        ...
        switch (this.f5663a) {
            case 0:
                oc ocVar = (oc) this.f5665c;
                if (!z10) {
                    ocVar.M0.setTranslationY(this.f5664b);
                    ocVar.M0.K = false;
                    ocVar.f5245o2 = null;
                    ocVar.f5248p2 = null;
                    return;
                ...
                return;
            case 1:
                ei.p4 p4Var = (ei.p4) this.f5665c;
                p4Var.v = null;
                float f11 = this.f5664b;
                if (!z10) {
                    p4Var.f8546f = f11;
                    p4Var.c();
                    return;
                ...
                return;
            default:
                cg0 cg0Var = (cg0) this.f5665c;
                if (!z10) {
                    eg0 eg0Var = cg0Var.d;
                    o1.l lVar = eg0Var.M.f15351u;
                    int i10 = eg0Var.H;
                    float f12 = (i10 / 2.0f) + this.f5664b;
