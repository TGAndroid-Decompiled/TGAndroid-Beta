...
public final class da {
    ...
    public final boolean b(TLRPC.User user) {
        ...
        int i10 = this.f4546a;
        if (i10 == 4) {
            return !arrayList.contains(Long.valueOf(user.f18483id));
        }
        if (i10 == 2) {
            if (arrayList.contains(Long.valueOf(user.f18483id)) || !user.contact) {
                return false;
            }
            return true;
        } else if (i10 == 1) {
            ...
            if (i10 == 3) {
                if (arrayList.contains(Long.valueOf(user.f18483id))) {
                    return true;
                }
                for (ArrayList arrayList2 : this.d.values()) {
                    if (arrayList2.contains(Long.valueOf(user.f18483id))) {
                        return true;
                    }
                }
            }
