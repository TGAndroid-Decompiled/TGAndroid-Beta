...
public abstract class fa extends ScrollView {
    ...
    public int J;
    public boolean K;
    public final h2 f4664a;
    public final int f4665b;
    public final ea f4666c;
    public final ArrayList d;
    public m30 e;
    public final p9 f4667f;
    public boolean h;
    public Utilities.Callback f4668n;
    public final org.telegram.ui.Components.c6 f4669r;
    public final LinearGradient f4670s;
    public final Paint v;
    public final Matrix f4671w;
    public final org.telegram.ui.Components.c6 f4672x;
    public final LinearGradient f4673y;
    ...
    public fa(Context context, org.telegram.ui.ActionBar.e6 e6Var, p9 p9Var) {
        ...
        qr qrVar = qr.h;
        this.f4669r = new org.telegram.ui.Components.c6(this, 0L, 300L, qrVar);
        Shader.TileMode tileMode = Shader.TileMode.CLAMP;
        LinearGradient linearGradient = new LinearGradient(0.0f, 0.0f, 0.0f, AndroidUtilities.dp(8.0f), new int[]{-16777216, 0}, new float[]{0.0f, 1.0f}, tileMode);
        this.f4670s = linearGradient;
        Paint paint = new Paint(1);
        this.v = paint;
        this.f4671w = new Matrix();
        this.f4672x = new org.telegram.ui.Components.c6(this, 0L, 300L, qrVar);
        LinearGradient linearGradient2 = new LinearGradient(0.0f, 0.0f, 0.0f, AndroidUtilities.dp(8.0f), new int[]{0, -16777216}, new float[]{0.0f, 1.0f}, tileMode);
        this.f4673y = linearGradient2;
        ...
        AndroidUtilities.setScrollViewEdgeEffectColor(this, org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18836d6, false));
        ...
        this.f4665b = (int) h2Var.getPaint().measureText(LocaleController.getString(R.string.Search));
    ...
    public void setOnSearchTextChange(Utilities.Callback<String> callback) {
        this.f4668n = callback;
    }

    public void setText(CharSequence charSequence) {
        this.h = true;
        this.f4664a.setText(charSequence);
        this.h = false;
    }
}
