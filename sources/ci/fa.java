...
public abstract class fa extends ScrollView {
    ...
    public int J;
    public boolean K;
    public final h2 f4668a;
    public final int f4669b;
    public final ea f4670c;
    public final ArrayList d;
    public m30 e;
    public final p9 f4671f;
    public boolean h;
    public Utilities.Callback f4672n;
    public final org.telegram.ui.Components.d6 f4673r;
    public final LinearGradient f4674s;
    public final Paint v;
    public final Matrix f4675w;
    public final org.telegram.ui.Components.d6 f4676x;
    public final LinearGradient f4677y;
    ...
    public fa(Context context, org.telegram.ui.ActionBar.f6 f6Var, p9 p9Var) {
        ...
        qr qrVar = qr.h;
        this.f4673r = new org.telegram.ui.Components.d6(this, 0L, 300L, qrVar);
        Shader.TileMode tileMode = Shader.TileMode.CLAMP;
        LinearGradient linearGradient = new LinearGradient(0.0f, 0.0f, 0.0f, AndroidUtilities.dp(8.0f), new int[]{-16777216, 0}, new float[]{0.0f, 1.0f}, tileMode);
        this.f4674s = linearGradient;
        Paint paint = new Paint(1);
        this.v = paint;
        this.f4675w = new Matrix();
        this.f4676x = new org.telegram.ui.Components.d6(this, 0L, 300L, qrVar);
        LinearGradient linearGradient2 = new LinearGradient(0.0f, 0.0f, 0.0f, AndroidUtilities.dp(8.0f), new int[]{0, -16777216}, new float[]{0.0f, 1.0f}, tileMode);
        this.f4677y = linearGradient2;
        ...
        AndroidUtilities.setScrollViewEdgeEffectColor(this, org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19109d6, false));
        ...
        this.f4669b = (int) h2Var.getPaint().measureText(LocaleController.getString(R.string.Search));
