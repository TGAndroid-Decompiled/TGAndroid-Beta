...
public abstract class jc {
    ...
    public ai.a5 f4860f;
    public int f4857a = 0;
    public final RectF f4859c = new RectF();
    ...
    public static hc b(org.telegram.ui.Cells.f7 f7Var) {
        ...
        hcVar.f4859c.set(iArr[0], iArr[1], imageView.getWidth() + i10, imageView.getHeight() + iArr[1]);
        hcVar.d = new org.telegram.ui.Cells.e7(imageView.getContext(), null, false, f7Var.f20080y);
        hcVar.f4858b = Math.max(hcVar.f4859c.width(), hcVar.f4859c.height()) / 2.0f;
        return hcVar;
    }
    ...
    public static ic c(ai.a0 a0Var) {
        if (a0Var != null) {
            ...
            if (a0Var.getRootView() != null) {
                ...
                icVar.f4859c.set(imageX, imageY, imageX + imageWidth, imageWidth + imageY);
                icVar.e = imageReceiver;
                icVar.f4858b = Math.max(icVar.f4859c.width(), icVar.f4859c.height()) / 2.0f;
                return icVar;
            }
            return null;
        }
