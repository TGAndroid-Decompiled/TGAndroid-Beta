...
public abstract class jc {
    ...
    public static hc b(org.telegram.ui.Cells.f7 f7Var) {
        ...
        hcVar.f4857c.set(iArr[0], iArr[1], imageView.getWidth() + i10, imageView.getHeight() + iArr[1]);
        hcVar.d = new org.telegram.ui.Cells.e7(imageView.getContext(), null, false, f7Var.f20099y);
        hcVar.f4856b = Math.max(hcVar.f4857c.width(), hcVar.f4857c.height()) / 2.0f;
        return hcVar;
    }

    public static ic c(ai.a0 a0Var) {
        if (a0Var != null) {
            ImageReceiver imageReceiver = a0Var.f497r;
            if (a0Var.getRootView() != null) {
                ...
                icVar.f4857c.set(imageX, imageY, imageX + imageWidth, imageWidth + imageY);
                icVar.e = imageReceiver;
                icVar.f4856b = Math.max(icVar.f4857c.width(), icVar.f4857c.height()) / 2.0f;
                return icVar;
            }
            return null;
        }
    ...
    public static hc d(ai.jc jcVar) {
        ...
        if (jcVar != null) {
            ...
            ai.zb zbVar = jcVar.f1091n0;
            if (zbVar != null && (currentPeerView = zbVar.getCurrentPeerView()) != null && (a5Var = currentPeerView.f798c1) != null) {
                ai.xb xbVar = jcVar.f1102s;
                float f7 = 0.0f;
                if (xbVar == null) {
                    x10 = 0.0f;
                } else {
                ...
                hcVar.f4855a = 1;
                hcVar.f4856b = AndroidUtilities.dp(8.0f);
                ai.f6 t10 = jcVar.t();
                if (t10 != null) {
                    hcVar.f4858f = t10.f798c1;
                }
                return hcVar;
            }
            return null;
