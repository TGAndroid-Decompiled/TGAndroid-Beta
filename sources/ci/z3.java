...
public final class z3 implements o1.f {
    ...
    public final void a(o1.h hVar, boolean z10, float f7, float f10) {
        switch (this.f5863a) {
            case 0:
                b4 b4Var = (b4) this.d;
                a4 a4Var = b4Var.f4388b;
                if (!z10) {
                    a4Var.setTranslationY(this.f5865c);
                    a4Var.K = false;
                    b4Var.d = null;
                    b4Var.e = null;
                    Runnable runnable = this.f5864b;
                    if (runnable != null) {
                        runnable.run();
                        return;
                    }
            ...
            default:
                ...
                AndroidUtilities.lambda$shakeViewSpring$14(this.f5864b, (View) this.d, f11, hVar, z10, f7, f10);
                return;
        }
    }
