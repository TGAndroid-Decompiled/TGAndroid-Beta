...
public class s extends tk0 {
    ...
    public final t f4856s;
    public final ArrayList d = new ArrayList();
    public final ArrayList f4854n = new ArrayList();
    ...
    public final String F(int i10) {
        ...
        if (l8Var == null || i10 < 0 || i10 >= l8Var.f3302i.size() || (messageObject = (MessageObject) this.f4852e.f3302i.get(i10)) == null || (storyItem = messageObject.storyItem) == null) {
            return null;
        }
    ...
    public final boolean L(int i10) {
        lr0 lr0Var = this.f4856s.W;
        l8 l8Var = this.f4852e;
        if (l8Var != null) {
            if (l8Var instanceof b8) {
                TLRPC.User user = MessagesController.getInstance(lr0Var.f4876b).getUser(Long.valueOf(lr0Var.d));
                if (user != null && user.bot && user.bot_has_main_app && user.bot_can_edit) {
                    return true;
                }
                return false;
            } else if (i10 >= 0 && i10 < l8Var.f3302i.size()) {
                return this.f4852e.m(((MessageObject) this.f4852e.f3302i.get(i10)).getId());
            } else {
                return false;
            }
        }
    ...
    public final int h() {
        ...
        return this.f4852e.g() + this.d.size();
    }
    ...
    public void l() {
        ...
        if (z10) {
            ...
            arrayList.clear();
            ArrayList E = MessagesController.getInstance(this.f4852e.f3298c).getStoriesController().E(tVar.W.d);
            if (E != null) {
                for (int i10 = 0; i10 < E.size(); i10++) {
                    t8 t8Var = (t8) E.get(i10);
                    o8 o8Var = t8Var.f3767c;
                    if (o8Var != null && !o8Var.f7784g && TextUtils.equals(o8Var.K0, b8Var.E)) {
                        arrayList.add(t8Var);
                    }
                }
            }
    ...
    public final void v(c1 c1Var, int i10) {
        ...
        if (this.f4852e != null) {
            ...
            if (i10 >= 0 && i10 < arrayList.size()) {
                ...
                t7Var.f23296f0 = false;
                if (t8Var.K == null) {
                    TL_stories.TL_storyItem tL_storyItem = new TL_stories.TL_storyItem();
                    long j3 = t8Var.f3765a;
                    int i14 = (int) (j3 ^ (j3 >>> 32));
                    tL_storyItem.messageId = i14;
                    tL_storyItem.f20133id = i14;
                    tL_storyItem.attachPath = t8Var.f3769f;
                    MessageObject messageObject = new MessageObject(this.f4852e.f3298c, tL_storyItem);
            ...
            if (size >= 0 && size < this.f4852e.f3302i.size()) {
                MessageObject messageObject3 = (MessageObject) this.f4852e.f3302i.get(size);
                if (messageObject3 != null && this.f4852e.m(messageObject3.getId())) {
                    z10 = true;
                } else {
                    z10 = false;
                }
    ...
    public final c1 x(ViewGroup viewGroup, int i10) {
        lr0 lr0Var = this.f4856s.W;
        if (this.h == null) {
            this.h = new s7(viewGroup.getContext(), lr0Var.f4877c);
        }
        t7 t7Var = new t7(this.f4851c, this.h, lr0Var.f4876b);
        t7Var.f23316w0 = true;
