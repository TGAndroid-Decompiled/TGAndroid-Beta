...
public final class ba extends FrameLayout implements View.OnClickListener, NotificationCenter.NotificationCenterDelegate {
    ...
    public final ia W;
    public int f4398a;
    public final a0.i f4399b;
    public final ArrayList f4400c;
    public final HashMap d;
    public final FrameLayout e;
    public final ll0 f4401f;
    public final s4.c0 h;
    public final x9 f4402n;
    public final z9 f4403r;
    public final View f4404s;
    public final d v;
    public final d f4405w;
    public final u9 f4406x;
    public final org.telegram.ui.Cells.v3 f4407y;
    ...
    public final void b(int i10) {
        ...
        if (i10 == 4) {
            ...
            for (int i12 = 0; i12 < J0.size(); i12 = com.google.android.gms.internal.vision.e2.g(((TLRPC.User) J0.get(i12)).f18256id, arrayList, i12, 1)) {
            }
        } else if (i10 == 2) {
            arrayList.addAll(iaVar.h);
        } else if (i10 == 3) {
            arrayList.addAll(iaVar.f4808n);
            hashMap.putAll(iaVar.f4809r);
        } else if (i10 == 6) {
            a(false);
        }
        this.f4402n.getClass();
        this.h.k1(false);
        i(false);
        u9 u9Var = this.f4406x;
        u9Var.setText("");
        if (i10 == 0) {
            i11 = 8;
        } else {
    ...
    public final float c() {
        int i10 = 0;
        float f7 = -hg.c.f(150.0f, Math.min(AndroidUtilities.dp(150.0f), this.f4406x.J), 0);
        while (true) {
            ll0 ll0Var = this.f4401f;
    ...
    public final void d(long j3, TLRPC.ChatParticipants chatParticipants) {
        ...
        if (chatParticipants != null && chatParticipants.participants != null) {
            for (int i13 = 0; i13 < chatParticipants.participants.size(); i13++) {
                ...
                if (user != null && !UserObject.isUserSelf(user) && !user.bot && user.f18256id != 777000 && j10 != 0) {
                    if (z10 && !user.contact) {
                        arrayList2.add(Long.valueOf(j10));
                    } else {
                        arrayList.add(Long.valueOf(j10));
                    }
                    this.f4400c.remove(Long.valueOf(j10));
                }
            }
        }
        if (!arrayList2.isEmpty()) {
            if (arrayList.isEmpty()) {
                ...
                alertDialog$Builder.f18435a.T = "All group members are not in your contact list.";
            ...
            alertDialog$Builder2.f18435a.T = arrayList2.size() + " members are not in your contact list";
        ...
        while (i12 < size) {
            ...
            i12++;
            this.f4399b.k(Boolean.TRUE, ((Long) obj).longValue());
        }
        i(true);
        e(true);
        f(true);
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.chatInfoDidLoad && (chatFull = (TLRPC.ChatFull) objArr[0]) != null && (b2Var = this.G) != null && this.H == chatFull.f18110id) {
            b2Var.c(350L);
            this.G = null;
            this.H = -1L;
            d(chatFull.f18110id, chatFull.participants);
        }
    }
    ...
    public final void f(boolean z10) {
        ...
        ArrayList arrayList6 = this.f4400c;
        if (i10 == 4) {
            arrayList5.clear();
            hashMap2.clear();
        ...
        if (this.f4398a == 3 && (iaVar.N != 3 || (arrayList6.isEmpty() && hashMap3.isEmpty()))) {
        ...
        while (true) {
            ...
            if (n9Var != null) {
                ...
                if (i13 > 0) {
                    ...
                    if (user != null) {
                        boolean contains = arrayList6.contains(Long.valueOf(user.f18256id));
                        n9Var.f5081k = contains;
                        n9Var.f5082l = (contains || !l1.contains(Long.valueOf(n9Var.f5078g.f18256id))) ? false : false;
                    } else {
                        TLRPC.Chat chat = n9Var.h;
                        if (chat != null) {
                            n9Var.f5081k = hashMap3.containsKey(Long.valueOf(chat.f18109id));
                            n9Var.f5082l = false;
                        }
                    }
                }
    ...
    public final void h(boolean z10) {
        org.telegram.ui.Cells.v3 v3Var = this.f4407y;
        if (v3Var == null) {
            return;
        }
        if (ia.l1(this.f4400c, this.d).size() > 0) {
    ...
    public final void i(boolean z10) {
        ...
        Object chat;
        org.telegram.ui.ActionBar.e6 e6Var;
        HashSet l1 = ia.l1(this.f4400c, this.d);
        int i11 = this.f4398a;
        ia iaVar = this.W;
        if (i11 == 3) {
            iaVar.f4810s = l1.size();
        } else if (i11 == 4) {
            iaVar.f4807f = l1.size();
        }
        i10 = ((org.telegram.ui.ActionBar.f3) iaVar).currentAccount;
    ...
    public final void j() {
        ...
        if (this.Q != z11) {
            this.Q = z11;
            ((org.telegram.ui.ActionBar.g2) m9Var.e).c((z11 || this.f4398a != 0) ? 0.0f : 0.0f, true);
        }
    ...
    public final void onClick(View view) {
        ...
        if (m30Var.f26054y) {
            ...
            while (true) {
                ...
                ArrayList arrayList4 = this.f4400c;
                if (hasNext) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (z17 != z10) {
            ...
            if (z11 && c10 + Math.min(AndroidUtilities.dp(150.0f), this.f4406x.J) > ll0Var.getPaddingTop()) {
                ji.o oVar = new ji.o(getContext(), 2, 0.7f);
                oVar.f42821a = 1;
                oVar.f13104p = -AndroidUtilities.dp(56.0f);
                this.h.w0(oVar);
            }
            int i17 = this.f4398a;
            View view = this.f4404s;
            float f10 = 0.0f;
            if (i17 == 0) {
                ...
                qr qrVar = org.telegram.ui.ActionBar.p1.f19476w;
