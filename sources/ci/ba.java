...
public final class ba extends FrameLayout implements View.OnClickListener, NotificationCenter.NotificationCenterDelegate {
    ...
    public final ia W;
    public int f4400a;
    public final a0.i f4401b;
    public final ArrayList f4402c;
    public final HashMap d;
    public final FrameLayout e;
    public final yl0 f4403f;
    public final s4.c0 h;
    public final x9 f4404n;
    public final z9 f4405r;
    public final View f4406s;
    public final d v;
    public final d f4407w;
    public final u9 f4408x;
    public final org.telegram.ui.Cells.w3 f4409y;
    ...
    public final void b(int i10) {
        ...
        if (i10 == 4) {
            ...
            for (int i12 = 0; i12 < J0.size(); i12 = com.google.android.gms.internal.vision.e2.g(((TLRPC.User) J0.get(i12)).f18490id, arrayList, i12, 1)) {
            }
        } else if (i10 == 2) {
            arrayList.addAll(iaVar.h);
        } else if (i10 == 3) {
            arrayList.addAll(iaVar.f4810n);
            hashMap.putAll(iaVar.f4811r);
        } else if (i10 == 6) {
            a(false);
        }
        this.f4404n.getClass();
        this.h.k1(false);
        i(false);
        u9 u9Var = this.f4408x;
        u9Var.setText("");
        if (i10 == 0) {
            i11 = 8;
        } else {
    ...
    public final float c() {
        int i10 = 0;
        float f7 = -org.telegram.messenger.l0.b(150.0f, Math.min(AndroidUtilities.dp(150.0f), this.f4408x.J), 0);
        while (true) {
            yl0 yl0Var = this.f4403f;
    ...
    public final void d(long j3, TLRPC.ChatParticipants chatParticipants) {
        ...
        if (chatParticipants != null && chatParticipants.participants != null) {
            for (int i13 = 0; i13 < chatParticipants.participants.size(); i13++) {
                ...
                if (user != null && !UserObject.isUserSelf(user) && !user.bot && user.f18490id != 777000 && j10 != 0) {
                    if (z10 && !user.contact) {
                        arrayList2.add(Long.valueOf(j10));
                    } else {
                        arrayList.add(Long.valueOf(j10));
                    }
                    this.f4402c.remove(Long.valueOf(j10));
                }
            }
        }
        if (!arrayList2.isEmpty()) {
            if (arrayList.isEmpty()) {
                ...
                alertDialog$Builder.f18669a.T = "All group members are not in your contact list.";
            ...
            alertDialog$Builder2.f18669a.T = arrayList2.size() + " members are not in your contact list";
        ...
        while (i12 < size) {
            ...
            i12++;
            this.f4401b.k(Boolean.TRUE, ((Long) obj).longValue());
        }
        i(true);
        e(true);
        f(true);
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.chatInfoDidLoad && (chatFull = (TLRPC.ChatFull) objArr[0]) != null && (b2Var = this.G) != null && this.H == chatFull.f18344id) {
            b2Var.c(350L);
            this.G = null;
            this.H = -1L;
            d(chatFull.f18344id, chatFull.participants);
        }
    }
    ...
    public final void f(boolean z10) {
        ...
        ArrayList arrayList6 = this.f4402c;
        if (i10 == 4) {
            arrayList5.clear();
            hashMap2.clear();
        ...
        if (this.f4400a == 3 && (iaVar.N != 3 || (arrayList6.isEmpty() && hashMap3.isEmpty()))) {
        ...
        while (true) {
            ...
            if (n9Var != null) {
                ...
                if (i13 > 0) {
                    ...
                    if (user != null) {
                        boolean contains = arrayList6.contains(Long.valueOf(user.f18490id));
                        n9Var.f5083k = contains;
                        n9Var.f5084l = (contains || !l1.contains(Long.valueOf(n9Var.f5080g.f18490id))) ? false : false;
                    } else {
                        TLRPC.Chat chat = n9Var.h;
                        if (chat != null) {
                            n9Var.f5083k = hashMap3.containsKey(Long.valueOf(chat.f18343id));
                            n9Var.f5084l = false;
                        }
                    }
                }
    ...
    public final void h(boolean z10) {
        org.telegram.ui.Cells.w3 w3Var = this.f4409y;
        if (w3Var == null) {
            return;
        }
        if (ia.l1(this.f4402c, this.d).size() > 0) {
            w3Var.b(LocaleController.getString(R.string.UsersDeselectAll), new o9(this, 2));
        } else if (z10) {
            w3Var.setRightText(null);
        } else {
            org.telegram.ui.Cells.v3 v3Var = w3Var.f21802b;
    ...
    public final void i(boolean z10) {
        ...
        Object chat;
        org.telegram.ui.ActionBar.f6 f6Var;
        HashSet l1 = ia.l1(this.f4402c, this.d);
        int i11 = this.f4400a;
        ia iaVar = this.W;
        if (i11 == 3) {
            iaVar.f4812s = l1.size();
        } else if (i11 == 4) {
            iaVar.f4809f = l1.size();
        }
        i10 = ((org.telegram.ui.ActionBar.f3) iaVar).currentAccount;
    ...
    public final void j() {
        ...
        if (this.Q != z11) {
            this.Q = z11;
            ((org.telegram.ui.ActionBar.g2) m9Var.e).c((z11 || this.f4400a != 0) ? 0.0f : 0.0f, true);
        }
    ...
    public final void onClick(View view) {
        ...
        if (m30Var.f26305y) {
            ...
            while (true) {
                ...
                ArrayList arrayList4 = this.f4402c;
                if (hasNext) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (z17 != z10) {
            ...
            if (z11 && c10 + Math.min(AndroidUtilities.dp(150.0f), this.f4408x.J) > yl0Var.getPaddingTop()) {
                ji.o oVar = new ji.o(getContext(), 2, 0.7f);
                oVar.f43145a = 1;
                oVar.f13106p = -AndroidUtilities.dp(56.0f);
                this.h.w0(oVar);
            }
            int i17 = this.f4400a;
            View view = this.f4406s;
            float f10 = 0.0f;
            if (i17 == 0) {
                ...
                qr qrVar = org.telegram.ui.ActionBar.p1.f19714w;
