...
public final class y2 {
    ...
    public final v2 f5808b;
    public final v2 f5809c;
    ...
    public y2(Context context, WindowManager windowManager, View view, WindowManager.LayoutParams layoutParams) {
        ...
        this.f5808b = new v2(this, context, 0);
        this.f5809c = new v2(this, context, 1);
        paint.setAlpha(0);
    }
    ...
    public final void e(float f7, long j3, Runnable runnable) {
        ...
        this.f5812i.setInterpolator(qr.f27644i);
        this.f5812i.start();
    }
    ...
    public final void g() {
        ...
        if (i10 != i11 || this.f5813j != v2Var.getMeasuredWidth() || this.f5814k != v2Var.getMeasuredHeight() || Math.abs(this.f5816m - this.h) > 0.005f) {
            this.f5815l = this.f5817n;
            this.f5813j = v2Var.getMeasuredWidth();
