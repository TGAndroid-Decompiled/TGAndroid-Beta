...
public final class v1 implements RequestDelegate {
    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        switch (this.f5645a) {
            case 0:
                AndroidUtilities.runOnUIThread(new ai.s4((w1) this.d, tLObject, (String) this.f5646b, this.f5647c, 1));
                return;
            case 1:
                gg.c2 c2Var = (gg.c2) this.d;
                String str = (String) this.f5646b;
                a0.i iVar = c2Var.h;
                ...
                if (tL_error == null) {
                    ...
                    for (int i11 = 0; i11 < size; i11++) {
                        ...
                        if (!this.f5647c && peerId == clientUserId) {
                ...
                return;
            case 2:
                AndroidUtilities.runOnUIThread(new u1((Object) ((ke) this.d), (Object) tL_error, tLObject, (Object) ((TwoStepVerificationActivity) this.f5646b), this.f5647c, 14));
                return;
            case 3:
                AndroidUtilities.runOnUIThread(new ai.s4((xx0) this.d, tLObject, this.f5647c, (org.telegram.ui.ActionBar.b2) this.f5646b, 20));
                return;
            case 4:
                AndroidUtilities.runOnUIThread(new u1((Object) ((iy) this.d), (Object) tL_error, tLObject, (Object) ((String) this.f5646b), this.f5647c, 20));
                return;
            case 5:
                AndroidUtilities.runOnUIThread(new ai.s4((i60) this.d, tLObject, (TLRPC.ChatFull) this.f5646b, this.f5647c, 22));
                return;
            case 6:
                ai0 ai0Var = (ai0) this.d;
                TLRPC.TL_chatInviteExported tL_chatInviteExported2 = (TLRPC.TL_chatInviteExported) this.f5646b;
                if (tL_error == null) {
                    ...
                    if (tL_messages_exportedChatInvites.invites.size() > 0 && tL_chatInviteExported2 != null) {
                        for (int i12 = 0; i12 < tL_messages_exportedChatInvites.invites.size(); i12++) {
                            if (((TLRPC.TL_chatInviteExported) tL_messages_exportedChatInvites.invites.get(i12)).link.equals(tL_chatInviteExported2.link)) {
                                ...
                                AndroidUtilities.runOnUIThread(new nh0(ai0Var, tL_chatInviteExported, tL_error, tLObject, this.f5647c, 0));
                                return;
                            }
                        }
                    }
                ...
                return;
            case 7:
                AndroidUtilities.runOnUIThread(new u1((NotificationCenter.NotificationCenterDelegate) ((xo0) this.d), (TLObject) tL_error, this.f5647c, tLObject, (Object) ((String) this.f5646b), 22));
                return;
            default:
                AndroidUtilities.runOnUIThread(new pg.l0((yh.l5) this.d, (int[]) this.f5646b, tLObject, this.f5647c, 2));
                return;
        }
    }
