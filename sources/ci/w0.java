...
public final class w0 implements Runnable {
    ...
    public final void run() {
        switch (this.f5676a) {
            case 0:
                MessagesStorage messagesStorage = this.f5677b;
                ArrayList arrayList = this.f5678c;
                try {
            ...
            case 1:
                MessagesStorage messagesStorage2 = this.f5677b;
                ArrayList arrayList2 = this.f5678c;
            ...
            default:
                MessagesStorage messagesStorage3 = this.f5677b;
                ArrayList arrayList3 = this.f5678c;
                try {
