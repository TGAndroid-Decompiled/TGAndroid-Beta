    ...
    public final void run() {
        ...
        switch (i12) {
            ...
            default:
                ...
                if (mVar.f5007p0 != z10) {
                    mVar.f5007p0 = z10;
                    ValueAnimator valueAnimator = mVar.f5008q0;
                    if (valueAnimator != null) {
                        valueAnimator.cancel();
                        mVar.f5008q0 = null;
                    }
                    Utilities.Callback callback = mVar.f5002k0;
                    if (callback != null) {
                    ...
                    mVar.f5008q0 = ofFloat;
                    ofFloat.addUpdateListener(new ai.a(mVar, 15));
                    if (!z10) {
                        gVar.getEditText().setAllowDrawCursor(false);
                    }
                    mVar.f5008q0.addListener(new ai.n(7, mVar, z10));
                    if (z10) {
                        mVar.f5008q0.setInterpolator(org.telegram.ui.ActionBar.p1.f19699w);
                        mVar.f5008q0.setDuration(250L);
                    } else {
                        mVar.f5008q0.setInterpolator(new u1.a());
                        mVar.f5008q0.setDuration(420L);
                    }
                    mVar.f5008q0.start();
                    ...
                    if (z10 && SharedConfig.getDevicePerformanceClass() >= 1 && !LiteMode.isPowerSaverApplied()) {
                        if (mVar.f5010r0 == null) {
                            mVar.f5010r0 = Bitmap.createBitmap((int) (frameLayout.getWidth() / 12.0f), (int) (frameLayout.getHeight() / 12.0f), Bitmap.Config.ARGB_8888);
                        }
                        mVar.f5021y0 = true;
                        mVar.i(mVar.f5010r0);
                        mVar.f5021y0 = false;
                        Bitmap bitmap = mVar.f5010r0;
                        if (bitmap != null && !bitmap.isRecycled()) {
                            Bitmap bitmap2 = mVar.f5010r0;
                            Shader.TileMode tileMode = Shader.TileMode.CLAMP;
                            mVar.f5012s0 = new BitmapShader(bitmap2, tileMode, tileMode);
                            Matrix matrix = mVar.f5013t0;
                            if (matrix == null) {
                                mVar.f5013t0 = new Matrix();
                            } else {
                                matrix.reset();
                            }
                            ...
                            mVar.f5014u0.setShader(mVar.f5012s0);
                            return;
                        }
                        mVar.f5010r0 = null;
                        return;
