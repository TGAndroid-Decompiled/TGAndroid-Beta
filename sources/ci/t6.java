...
public final class t6 extends View {
    ...
    public final StaticLayout f5549c;
    public final float d;
    public final float e;
    public final int f5550f;
    public final int h;
    public final boolean f5551n;
    public final org.telegram.ui.Components.e6 f5552r;
    public boolean f5553s;
    public float v;
    public ValueAnimator f5554w;
    public final u6 f5555x;
    ...
    public t6(u6 u6Var, Context context, String str, boolean z10) {
        ...
        this.f5550f = dp;
        if (!z10) {
            this.f5550f = Math.max(AndroidUtilities.dp(80.0f), dp);
        }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float d = this.f5552r.d(f7, false);
        ...
        canvas.drawRect(AndroidUtilities.dp(25.0f), AndroidUtilities.dp(4.0f), getWidth() - AndroidUtilities.dp(25.0f), getHeight() - AndroidUtilities.dp(4.0f), this.f5548b);
        ...
        canvas.drawRoundRect(rectF, AndroidUtilities.dp(20.0f), AndroidUtilities.dp(20.0f), this.f5547a);
        canvas.save();
        float f13 = (this.f5550f - this.e) / 2.0f;
        if (this.f5551n) {
            f10 = 3.0f;
        }
        float dp = (f13 + AndroidUtilities.dp(f10)) - this.d;
        int height = getHeight();
        StaticLayout staticLayout = this.f5549c;
    ...
    public final void onMeasure(int i10, int i11) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(this.f5550f, 1073741824), View.MeasureSpec.makeMeasureSpec(this.h, 1073741824));
    }
    ...
    public final void setPressed(boolean z10) {
        ...
        if (isPressed() != z10) {
            ...
            invalidate();
            if (z10 && (valueAnimator = this.f5554w) != null) {
            ...
            if (!z10) {
                ...
                if (f7 != 0.0f) {
                    ...
                    this.f5554w.addListener(new ai.b(this, 16));
                    this.f5554w.setInterpolator(new OvershootInterpolator(1.5f));
                    this.f5554w.setDuration(350L);
                    this.f5554w.start();
                }
            }
        }
