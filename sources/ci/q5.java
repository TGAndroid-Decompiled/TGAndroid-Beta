...
public final class q5 extends FrameLayout {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        paint.setAlpha((int) ((1.0f - qbVar.f5445t1) * r1Var.getAlpha() * 20.0f));
        ...
        float f7 = rectF.left;
        qg.w1 w1Var = qbVar.f5431m1;
        rectF.set(AndroidUtilities.lerp(f7, w1Var.getLeft(), qbVar.f5445t1), AndroidUtilities.lerp(rectF.top + translationY, w1Var.getTop() - w1Var.getTranslationY(), qbVar.f5445t1), AndroidUtilities.lerp(rectF.right, w1Var.getRight(), qbVar.f5445t1), AndroidUtilities.lerp(translationY + rectF.bottom, w1Var.getBottom() - w1Var.getTranslationY(), qbVar.f5445t1));
