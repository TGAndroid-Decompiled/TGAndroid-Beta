...
public abstract class m0 extends FrameLayout {
    public boolean E;
    public final d7 f5017a;
    public qg.a2 f5018b;
    public final org.telegram.ui.Components.c6 f5019c;
    public final org.telegram.ui.Components.c6 d;
    public final l0 e;
    public final FrameLayout f5020f;
    public final g0 h;
    public final lg.f f5021n;
    public final FrameLayout f5022r;
    public float f5023s;
    public final int[] v;
    public final int[] f5024w;
    public final int[] f5025x;
    public final lg.g f5026y;

    public m0(Context context, d7 d7Var) {
        super(context);
        this.f5023s = 0.0f;
        this.v = new int[2];
        this.f5024w = new int[2];
        this.f5025x = new int[2];
        this.f5026y = new Object();
        this.f5017a = d7Var;
        l0 l0Var = new l0(this, context);
        this.e = l0Var;
        qr qrVar = qr.h;
        this.f5019c = new org.telegram.ui.Components.c6(l0Var, 0L, 320L, qrVar);
        ...
        textView.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view) {
                switch (r2) {
                    case 0:
                        ((zb) this.f4865b).F.l0(-1, false, true);
                        return;
                    case 1:
                        m0 m0Var = this.f4865b;
                        m0Var.h.l(true);
                        lg.f fVar2 = m0Var.f5021n;
                        fVar2.setRotated(false);
                        fVar2.setMirrored(false);
                        fVar2.b(0.0f);
                        return;
                    default:
                        m0 m0Var2 = this.f4865b;
                        qg.a2 a2Var = m0Var2.f5018b;
                        if (a2Var != null) {
                            a2Var.G0 = new MediaController.CropState();
                            m0Var2.h.b(m0Var2.f5018b.G0);
                            qg.a2 a2Var2 = m0Var2.f5018b;
                            a2Var2.G0.orientation = a2Var2.getOrientation();
                            m0Var2.f5018b.k();
                            m0Var2.f5018b.requestLayout();
                            m0Var2.f5018b.f41296z0.requestLayout();
                            m0Var2.f5018b.f41296z0.invalidate();
                            m0Var2.f5018b.f41296z0.post(new androidx.fragment.app.a0(m0Var2, 8));
                        }
    ...
    public int getCurrentHeight() {
        qg.a2 a2Var = this.f5018b;
        if (a2Var == null) {
            return 1;
        }
        if (a2Var.getOrientation() != 90 && this.f5018b.getOrientation() != 270) {
            return this.f5018b.getContentHeight();
        }
        return this.f5018b.getContentWidth();
    }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        g0Var.setBottomPadding(AndroidUtilities.dp(116.0f) + this.f5020f.getPaddingBottom());
    ...
    public void set(qg.a2 a2Var) {
        ...
        this.f5017a.getLocationOnScreen(this.f5024w);
        a2Var.getLocationOnScreen(this.f5025x);
        MediaController.CropState cropState = a2Var.G0;
        if (cropState == null) {
            cropState = null;
        }
        g0Var.p(a2Var.getOrientation(), this.f5026y, cropState);
        float rotation = g0Var.getRotation();
        lg.f fVar = this.f5021n;
        fVar.setRotation(rotation);
        org.telegram.ui.Components.c6 c6Var = this.f5019c;
        if (cropState != null) {
    ...
    public void setAppearProgress(float f7) {
        if (Math.abs(this.f5023s - f7) < 0.001f) {
            return;
        }
        this.f5023s = f7;
        this.e.invalidate();
