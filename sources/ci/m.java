...
public abstract class m extends FrameLayout {
    ...
    public m(Context context, FrameLayout frameLayout, qv0 qv0Var, FrameLayout frameLayout2, org.telegram.ui.ActionBar.f6 f6Var, org.telegram.ui.Components.ha haVar) {
        ...
        mVar.f487j = true;
        int i17 = org.telegram.ui.ActionBar.j6.f18862d6;
        ...
        pq pqVar = new pq(org.telegram.ui.ActionBar.j6.K(AndroidUtilities.dp(18.0f), org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19272zf, f6Var)), mutate, 0, AndroidUtilities.dp(1.0f));
        this.f5003n = pqVar;
    ...
    public int getEditTextHeight() {
        return (int) this.f5014v0.f22937c;
    }
    ...
    public void x(int i10) {
        ...
        if (!(this instanceof et0)) {
            ...
            if (max > AndroidUtilities.dp(20.0f)) {
                this.f5002l0.setInterpolator(org.telegram.ui.ActionBar.q1.f19507w);
    ...
    public void y() {
        if (this.M != null) {
            float translationY = ((View) getParent()).getTranslationY() - this.f5014v0.f22937c;
