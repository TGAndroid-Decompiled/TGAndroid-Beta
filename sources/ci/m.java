...
public abstract class m extends FrameLayout {
    ...
    public boolean V;
    public boolean W;
    public org.telegram.ui.ActionBar.e6 f4987a;
    public int f4988a0;
    ...
    public final org.telegram.ui.Components.yc f4996f0;
    ...
    public final org.telegram.ui.Components.e6 f5014v0;
    public int f5015w;
    public int f5016w0;
    public long f5017x;
    ...
    public m(Context context, FrameLayout frameLayout, bw0 bw0Var, FrameLayout frameLayout2, org.telegram.ui.ActionBar.e6 e6Var, org.telegram.ui.Components.ja jaVar) {
        ...
        this.f4996f0 = new org.telegram.ui.Components.yc(this, 1.0f, 3.0f);
        this.f5004n0 = new e(this, 1);
        qr qrVar = qr.h;
        this.f5014v0 = new org.telegram.ui.Components.e6(this, 0L, 300L, qrVar);
        this.f5020y0 = false;
        ...
        mVar.a(new f(e6Var, i17, 0.0f, 0));
        mVar.f485g.setColor(0);
        mVar.invalidateSelf();
        mVar2.f487j = true;
        mVar2.a(new f(e6Var, i17, 0.0f, 1));
        ...
        pq pqVar = new pq(org.telegram.ui.ActionBar.j6.K(AndroidUtilities.dp(18.0f), org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19473zf, e6Var)), mutate, 0, AndroidUtilities.dp(1.0f));
        this.f5003n = pqVar;
        ...
        frameLayout3.addView(p6Var, w7.y5.e(52, 16, i13 | 5));
        if (z10) {
            i14 = 48;
        } else {
            i14 = 80;
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        if (!this.f4994e0 && (motionEvent.getAction() != 0 || !l(motionEvent.getX(), motionEvent.getY()))) {
            if (this.B0.contains(motionEvent.getX(), motionEvent.getY()) || this.f5006p0) {
                ...
                org.telegram.ui.Components.yc ycVar = this.f4996f0;
    ...
    public int getEditTextHeight() {
        return (int) this.f5014v0.f23794c;
    }
    ...
    public void x(int i10) {
        ...
        if (!(this instanceof ct0)) {
            ...
            if (max > AndroidUtilities.dp(20.0f)) {
                this.f5002l0.setInterpolator(org.telegram.ui.ActionBar.p1.f19667w);
    ...
    public void y() {
        if (this.M != null) {
            float translationY = ((View) getParent()).getTranslationY() - this.f5014v0.f23794c;
