...
public abstract class m extends FrameLayout {
    ...
    public boolean V;
    public boolean W;
    public org.telegram.ui.ActionBar.e6 f4984a;
    public int f4985a0;
    public final FrameLayout f4986b;
    public int f4987b0;
    public final ah.l f4988c;
    public final e f4989c0;
    public final ah.l d;
    public Utilities.CallbackVoidReturn f4990d0;
    public final Paint e;
    public boolean f4991e0;
    public final g f4992f;
    public final org.telegram.ui.Components.wc f4993f0;
    public ObjectAnimator f4994g0;
    public final Drawable h;
    public ah.c f4995h0;
    public ch.d f4996i0;
    public Utilities.Callback f4997j0;
    public Utilities.Callback f4998k0;
    public ObjectAnimator f4999l0;
    public boolean m0;
    public final pq f5000n;
    public final e f5001n0;
    public float f5002o0;
    public boolean f5003p0;
    public ValueAnimator f5004q0;
    public final j f5005r;
    public Bitmap f5006r0;
    public final FrameLayout f5007s;
    public BitmapShader f5008s0;
    public Matrix f5009t0;
    public Paint f5010u0;
    public final org.telegram.ui.Components.n6 v;
    public final org.telegram.ui.Components.c6 f5011v0;
    public int f5012w;
    public int f5013w0;
    public long f5014x;
    public float f5015x0;
    public final Paint f5016y;
    public boolean f5017y0;
    public final RectF f5018z0;
    ...
    public m(Context context, FrameLayout frameLayout, pv0 pv0Var, FrameLayout frameLayout2, org.telegram.ui.ActionBar.e6 e6Var, org.telegram.ui.Components.ha haVar) {
        ...
        this.f4989c0 = new e(this, 0);
        this.f4993f0 = new org.telegram.ui.Components.wc(this, 1.0f, 3.0f);
        this.f5001n0 = new e(this, 1);
        qr qrVar = qr.h;
        this.f5011v0 = new org.telegram.ui.Components.c6(this, 0L, 300L, qrVar);
        this.f5017y0 = false;
        this.f5018z0 = new RectF();
        this.A0 = new RectF();
        this.B0 = new RectF();
        this.J0 = new Path();
        ...
        lVar.f484j = true;
        int i17 = org.telegram.ui.ActionBar.i6.f18834d6;
        ...
        pq pqVar = new pq(org.telegram.ui.ActionBar.i6.K(AndroidUtilities.dp(18.0f), org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f19243zf, e6Var)), mutate, 0, AndroidUtilities.dp(1.0f));
        this.f5000n = pqVar;
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        if (!this.f4991e0 && (motionEvent.getAction() != 0 || !l(motionEvent.getX(), motionEvent.getY()))) {
            if (this.B0.contains(motionEvent.getX(), motionEvent.getY()) || this.f5003p0) {
                int action = motionEvent.getAction();
                org.telegram.ui.Components.wc wcVar = this.f4993f0;
                if (action == 0 && !this.f5003p0) {
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        if (view == gVar) {
            if (this instanceof ct0) {
                ...
                max = (1.0f - this.f5002o0) * Math.max(0, (gVar.getHeight() - AndroidUtilities.dp(82.0f)) - gVar.getScrollY());
            }
    ...
    public int getEditTextHeight() {
        return (int) this.f5011v0.f22951c;
    }

    public int getEditTextHeightClosedKeyboard() {
        return Math.min(AndroidUtilities.dp(82.0f), this.f4992f.getHeight());
    }
    ...
    public void x(int i10) {
        ...
        view.clearAnimation();
        if (!(this instanceof ct0)) {
            ObjectAnimator objectAnimator = this.f4999l0;
            if (objectAnimator != null) {
                objectAnimator.removeAllListeners();
                this.f4999l0.cancel();
                this.f4999l0 = null;
            }
            this.f4999l0 = ObjectAnimator.ofFloat(view, FrameLayout.TRANSLATION_Y, view.getTranslationY(), -max);
            if (max > AndroidUtilities.dp(20.0f)) {
                this.f4999l0.setInterpolator(org.telegram.ui.ActionBar.p1.f19476w);
                this.f4999l0.setDuration(250L);
            } else {
                this.f4999l0.setInterpolator(qr.h);
                this.f4999l0.setDuration(640L);
            }
            this.f4999l0.start();
        }
        if (max > AndroidUtilities.dp(20.0f)) {
    ...
    public void y() {
        if (this.M != null) {
            float translationY = ((View) getParent()).getTranslationY() - this.f5011v0.f22951c;
