...
public abstract class m extends FrameLayout {
    ...
    public boolean V;
    public boolean W;
    public org.telegram.ui.ActionBar.f6 f4986a;
    public int f4987a0;
    public final FrameLayout f4988b;
    public int f4989b0;
    public final ah.m f4990c;
    public final e f4991c0;
    public final ah.m d;
    public Utilities.CallbackVoidReturn f4992d0;
    public final Paint e;
    public boolean f4993e0;
    public final g f4994f;
    public final org.telegram.ui.Components.yc f4995f0;
    public ObjectAnimator f4996g0;
    public final Drawable h;
    public ah.c f4997h0;
    public ch.d f4998i0;
    public Utilities.Callback f4999j0;
    public Utilities.Callback f5000k0;
    public ObjectAnimator f5001l0;
    public boolean m0;
    public final pq f5002n;
    public final e f5003n0;
    public float f5004o0;
    public boolean f5005p0;
    public ValueAnimator f5006q0;
    public final j f5007r;
    public Bitmap f5008r0;
    public final FrameLayout f5009s;
    public BitmapShader f5010s0;
    public Matrix f5011t0;
    public Paint f5012u0;
    public final org.telegram.ui.Components.o6 v;
    public final org.telegram.ui.Components.d6 f5013v0;
    public int f5014w;
    public int f5015w0;
    public long f5016x;
    public float f5017x0;
    public final Paint f5018y;
    public boolean f5019y0;
    public final RectF f5020z0;
    ...
    public m(Context context, FrameLayout frameLayout, cw0 cw0Var, FrameLayout frameLayout2, org.telegram.ui.ActionBar.f6 f6Var, org.telegram.ui.Components.ia iaVar) {
        ...
        this.f4991c0 = new e(this, 0);
        this.f4995f0 = new org.telegram.ui.Components.yc(this, 1.0f, 3.0f);
        this.f5003n0 = new e(this, 1);
        qr qrVar = qr.h;
        this.f5013v0 = new org.telegram.ui.Components.d6(this, 0L, 300L, qrVar);
        this.f5019y0 = false;
        this.f5020z0 = new RectF();
        this.A0 = new RectF();
        this.B0 = new RectF();
        this.J0 = new Path();
        ...
        mVar.f484j = true;
        int i17 = org.telegram.ui.ActionBar.j6.f19109d6;
        mVar.a(new f(f6Var, i17, 0.0f, 0));
        mVar.f482g.setColor(0);
        mVar.invalidateSelf();
        mVar2.f484j = true;
        mVar2.a(new f(f6Var, i17, 0.0f, 1));
        mVar2.f482g.setColor(0);
        ...
        pq pqVar = new pq(org.telegram.ui.ActionBar.j6.K(AndroidUtilities.dp(18.0f), org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19520zf, f6Var)), mutate, 0, AndroidUtilities.dp(1.0f));
        this.f5002n = pqVar;
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        if (!this.f4993e0 && (motionEvent.getAction() != 0 || !l(motionEvent.getX(), motionEvent.getY()))) {
            if (this.B0.contains(motionEvent.getX(), motionEvent.getY()) || this.f5005p0) {
                int action = motionEvent.getAction();
                org.telegram.ui.Components.yc ycVar = this.f4995f0;
                if (action == 0 && !this.f5005p0) {
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        if (view == gVar) {
            if (this instanceof ct0) {
                ...
                max = (1.0f - this.f5004o0) * Math.max(0, (gVar.getHeight() - AndroidUtilities.dp(82.0f)) - gVar.getScrollY());
            }
    ...
    public int getEditTextHeight() {
        return (int) this.f5013v0.f23570c;
    }

    public int getEditTextHeightClosedKeyboard() {
        return Math.min(AndroidUtilities.dp(82.0f), this.f4994f.getHeight());
    }
    ...
    public void x(int i10) {
        ...
        view.clearAnimation();
        if (!(this instanceof ct0)) {
            ObjectAnimator objectAnimator = this.f5001l0;
            if (objectAnimator != null) {
                objectAnimator.removeAllListeners();
                this.f5001l0.cancel();
                this.f5001l0 = null;
            }
            this.f5001l0 = ObjectAnimator.ofFloat(view, FrameLayout.TRANSLATION_Y, view.getTranslationY(), -max);
            if (max > AndroidUtilities.dp(20.0f)) {
                this.f5001l0.setInterpolator(org.telegram.ui.ActionBar.p1.f19714w);
                this.f5001l0.setDuration(250L);
            } else {
                this.f5001l0.setInterpolator(qr.h);
                this.f5001l0.setDuration(640L);
            }
            this.f5001l0.start();
        }
        if (max > AndroidUtilities.dp(20.0f)) {
    ...
    public void y() {
        if (this.M != null) {
            float translationY = ((View) getParent()).getTranslationY() - this.f5013v0.f23570c;
