...
public final class m6 extends FrameLayout {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        Paint paint = qbVar.f5450y1;
        Paint paint2 = qbVar.f5448x1;
        Paint paint3 = qbVar.f5452z1;
        barView = qbVar.getBarView();
        RectF rectF = AndroidUtilities.rectTmp;
        int left = barView.getLeft();
        r5 r5Var = qbVar.f5446w1;
        ...
        if (barView.getChildCount() >= 1 && qbVar.D1 != 1.0f) {
            ...
            if (childAt.getAlpha() != 0.0f) {
                ...
                if (i11 != -1) {
                    ...
                    x10 = AndroidUtilities.lerp(x10, (((childAt2.getWidth() - childAt2.getPaddingLeft()) - childAt2.getPaddingRight()) / 2.0f) + childAt2.getX() + childAt2.getPaddingLeft(), qbVar.f5404a1);
                    y3 = AndroidUtilities.lerp(y3, (((childAt2.getHeight() - childAt2.getPaddingTop()) - childAt2.getPaddingBottom()) / 2.0f) + childAt2.getY() + childAt2.getPaddingTop(), qbVar.f5404a1);
                }
                if (r5Var != null && r5Var.getChildCount() > 0) {
                    ...
                    i10 = i0.a.d(qbVar.D1, q1Var.f40970a, this.f5040c.b(0));
                }
                float f7 = x10;
                float f10 = y3;
                if (f7 != this.f5038a || f10 != this.f5039b) {
                    this.f5038a = f7;
                    this.f5039b = f10;
