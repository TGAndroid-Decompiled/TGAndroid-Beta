    ...
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        ...
        switch (i10) {
            case 0:
                ...
                q6Var.A1.f41266a = i0.a.d(floatValue, i12, i11);
                q6Var.T0.invalidate();
                return;
            case 1:
            ...
            case 3:
                ...
                int i13 = ScrollSlidingTextTabStrip.f22388o0;
                float floatValue2 = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                scrollSlidingTextTabStrip.W = i12 * floatValue2;
                scrollSlidingTextTabStrip.f22390a0 = i11 * floatValue2;
                scrollSlidingTextTabStrip.f22389a.invalidate();
                scrollSlidingTextTabStrip.invalidate();
                return;
            case 4:
                float animatedFraction = valueAnimator.getAnimatedFraction();
                fy0 fy0Var = (fy0) ((qm0) obj).f27714b;
                fy0Var.f24289c.setAlpha(animatedFraction);
                fy0Var.h.setAlpha(animatedFraction);
                if (i12 != 0) {
                    int i14 = (int) ((1.0f - animatedFraction) * i12);
                    fy0Var.y0(i11 + i14);
                    fy0Var.f24289c.setTranslationY(i14);
                    return;
                }
                return;
            default:
                ...
                n0Var.K1.f41266a = i0.a.d(floatValue3, i12, i11);
