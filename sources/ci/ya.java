    ...
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        ...
        switch (i10) {
            ...
            case 2:
                ...
                ewVar.f30927b.invalidate();
                return;
            case 3:
                fi1 fi1Var = (fi1) obj;
                fi1Var.f29227y = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                float dp = f10 + AndroidUtilities.dp(28.0f);
                float dp2 = f7 + AndroidUtilities.dp(52.0f);
                float f11 = fi1Var.f29227y;
                fi1Var.G = dp - (dp * f11);
            ...
            default:
                ...
                float f12 = photoViewer.f31190a6;
                cropAreaView.f22242n0 = floatValue3;
                cropAreaView.f22243o0 = ((photoViewer.f31228e6 - f12) * photoViewer.f31287l6) + f12;
                cropAreaView.f22244p0 = 0.0f;
                cropAreaView.f22245q0 = 0.0f;
                cropAreaView.invalidate();
                photoViewer.C1.f24263c.b(AndroidUtilities.lerp(f7, 0.0f, ((Float) valueAnimator.getAnimatedValue()).floatValue()));
                return;
        }
    }
}
