...
public final class rc {
    public final org.telegram.ui.Components.c6 f5468a;
    public final int f5469b;
    public final short[] d;
    public short e;
    public final MediaExtractor f5471f;
    public final MediaFormat f5472g;
    public final long h;
    public final FfmpegAudioWaveformLoader f5475k;
    public final zc f5476l;
    public int f5470c = 0;
    ...
    public rc(zc zcVar, String str, int i10) {
        long j3;
        this.f5476l = zcVar;
        this.f5468a = new org.telegram.ui.Components.c6(zcVar, 0L, 600L, qr.h);
        int i11 = 0;
        MediaExtractor mediaExtractor = new MediaExtractor();
        this.f5471f = mediaExtractor;
        String str2 = null;
        try {
            ...
            while (true) {
                if (i11 < trackCount) {
                    MediaFormat trackFormat = this.f5471f.getTrackFormat(i11);
                    str2 = trackFormat.getString("mime");
                    if (str2 != null && str2.startsWith("audio/")) {
                        this.f5471f.selectTrack(i11);
                        this.f5472g = trackFormat;
                        break;
                    }
                    i11++;
                } else {
            ...
            MediaFormat mediaFormat = this.f5472g;
            if (mediaFormat != null) {
        ...
        if (this.h > 0 && this.f5472g != null) {
            if (!"audio/mpeg".equals(str2) && !"audio/mp3".equals(str2) && !"audio/mp4a".equals(str2) && !"audio/mp4a-latm".equals(str2)) {
                ...
                this.f5475k = new FfmpegAudioWaveformLoader(str, min, new bi.v(this, 9));
            }
        }
    }

    public final void a() {
        FfmpegAudioWaveformLoader ffmpegAudioWaveformLoader = this.f5475k;
