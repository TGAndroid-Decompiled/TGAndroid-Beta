...
public final class i9 extends org.telegram.ui.ActionBar.f3 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public ArrayList f4802c;
    public final TLRPC.InputPeer d;
    public final Utilities.Callback e;
    public final vl0 f4803f;
    public final h9 h;
    public final TextView f4804n;
    ...
    public i9(Context context, final int i10, boolean z10, TLRPC.InputPeer inputPeer, final Utilities.Callback callback, final org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.f4801b = i10;
        this.f4802c = MessagesController.getInstance(i10).getStoriesController().T;
        this.d = inputPeer;
        this.e = callback;
        ...
        vl0Var.setOnItemClickListener(new jl0() {
            ...
            public final void d(int i13, View view) {
                ...
                i9 i9Var = i9.this;
                TLRPC.InputPeer inputPeer2 = (TLRPC.InputPeer) i9Var.f4802c.get(i13 - 2);
        ...
        textView.setBackgroundColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19165h5, f6Var));
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.storiesSendAsUpdate) {
            this.f4802c = MessagesController.getInstance(this.f4801b).getStoriesController().T;
            this.h.l();
        }
    }
    ...
    public final void onAttachedToWindow() {
        ...
        NotificationCenter.getInstance(this.f4801b).addObserver(this, NotificationCenter.storiesSendAsUpdate);
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        NotificationCenter.getInstance(this.f4801b).removeObserver(this, NotificationCenter.storiesSendAsUpdate);
    }
