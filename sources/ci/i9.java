...
public final class i9 extends org.telegram.ui.ActionBar.f3 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public ArrayList f4796c;
    public final TLRPC.InputPeer d;
    public final Utilities.Callback e;
    public final ll0 f4797f;
    public final h9 h;
    public final TextView f4798n;
    ...
    public i9(Context context, final int i10, boolean z10, TLRPC.InputPeer inputPeer, final Utilities.Callback callback, final org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        this.f4795b = i10;
        this.f4796c = MessagesController.getInstance(i10).getStoriesController().T;
        this.d = inputPeer;
        this.e = callback;
        ...
        ll0Var.setOnItemClickListener(new zk0() {
            ...
            public final void d(int i13, View view) {
                ...
                i9 i9Var = i9.this;
                TLRPC.InputPeer inputPeer2 = (TLRPC.InputPeer) i9Var.f4796c.get(i13 - 2);
        ...
        this.f4798n = textView;
        wl.n(org.telegram.ui.ActionBar.i6.G6, e6Var, textView, 1, 20.0f);
        ...
        textView.setBackgroundColor(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f18907h5, e6Var));
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.storiesSendAsUpdate) {
            this.f4796c = MessagesController.getInstance(this.f4795b).getStoriesController().T;
            this.h.l();
        }
    }
    ...
    public final void onAttachedToWindow() {
        ...
        NotificationCenter.getInstance(this.f4795b).addObserver(this, NotificationCenter.storiesSendAsUpdate);
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        NotificationCenter.getInstance(this.f4795b).removeObserver(this, NotificationCenter.storiesSendAsUpdate);
    }
