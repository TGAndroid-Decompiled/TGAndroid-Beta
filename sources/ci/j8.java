...
public final class j8 implements Runnable {
    ...
    public final o8 f4853b;
    public final ai.y1 f4854c;
    ...
    public final void run() {
        ...
        switch (this.f4852a) {
            case 0:
                ai.y1 y1Var = this.f4854c;
                o8 o8Var = this.f4853b;
                o8Var.getClass();
                try {
                    try {
                        ...
                        if (trackFormat.containsKey("color-transfer")) {
                            n8Var2.f5078b = trackFormat.getInteger("color-transfer");
                        }
                        if (trackFormat.containsKey("color-standard")) {
                            n8Var2.f5077a = trackFormat.getInteger("color-standard");
                        }
                        if (trackFormat.containsKey("color-range")) {
                            trackFormat.getInteger("color-range");
                        }
                        o8Var.f5152d1 = o8Var.f5152d1;
            ...
            default:
                this.f4854c.run(this.f4853b.f5152d1);
                return;
        }
    }
}
