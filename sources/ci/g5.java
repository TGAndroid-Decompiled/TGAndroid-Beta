...
public final class g5 implements Runnable {
    ...
    public final void run() {
        ...
        switch (this.f4689a) {
            case 0:
                qg.x1 x1Var = this.f4690b.f5413d1;
                if (x1Var != null) {
                    x1Var.invalidate();
                    return;
                }
                return;
            case 1:
                new rg.x0((org.telegram.ui.ActionBar.n2) new ai.y3(this.f4690b, 3), 14, true).show();
                return;
            case 2:
                this.f4690b.z0(false);
                return;
            default:
                r6 r6Var = this.f4690b;
                boolean z10 = pg.u0.e(r6Var.F1).f41330k;
                int i10 = 0;
                while (true) {
