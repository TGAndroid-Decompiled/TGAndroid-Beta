...
public class d extends FrameLayout implements f90 {
    ...
    public float V;
    public boolean W;
    public org.telegram.ui.ActionBar.f6 f4447a;
    public ValueAnimator f4448a0;
    public int f4449b;
    public tp f4450b0;
    public final Paint f4451c;
    public int f4452c0;
    public final org.telegram.ui.Components.m6 d;
    public boolean f4453d0;
    public final org.telegram.ui.Components.m6 e;
    public int f4454e0;
    public final org.telegram.ui.Components.m6 f4455f;
    public boolean f4456f0;
    public int f4457g0;
    public float h;
    public final org.telegram.ui.Components.c6 f4458n;
    public final View f4459r;
    ...
    private int getWrapWidth() {
        float f7;
        float d = this.f4458n.d(this.h, false);
        if (this.T) {
            f7 = AndroidUtilities.dp(12.0f);
        } else {
            f7 = 0.0f;
        }
        return getPaddingRight() + getPaddingLeft() + ((int) (a(this.f4455f.d() + AndroidUtilities.dp(15.66f), d) + this.d.d() + f7));
    }
    ...
    public final void b(int i10, boolean z10) {
        float f7;
        int i11;
        org.telegram.ui.Components.m6 m6Var = this.f4455f;
        if (z10) {
            m6Var.b();
        }
    ...
    public final void d() {
        this.f4461w = true;
        setFilled(true);
        setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19232xa, this.f4447a));
        j();
    }
    ...
    public final void f(CharSequence charSequence, boolean z10) {
        ...
        if (this.J && !z11) {
            ...
            this.I.setInterpolator(qr.f27383f);
            this.I.start();
        } else {
    ...
    public final void j() {
        ...
        if (!this.f4462x) {
            if (this.f4461w) {
                i12 = org.telegram.ui.ActionBar.j6.f19232xa;
            } else {
                i12 = org.telegram.ui.ActionBar.j6.Oh;
            }
            this.f4463y = org.telegram.ui.ActionBar.j6.v0(i12, this.f4447a);
        }
        if (this.f4460s) {
            if (this.f4461w) {
                i10 = org.telegram.ui.ActionBar.j6.f19249ya;
            } else {
        ...
        int v02 = org.telegram.ui.ActionBar.j6.v0(i10, this.f4447a);
        org.telegram.ui.Components.m6 m6Var = this.d;
        m6Var.r(v02);
        boolean z10 = this.f4460s;
        View view = this.f4459r;
        if (z10) {
            int v03 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f18953i6, this.f4447a);
            int i13 = this.f4449b;
            view.setBackground(org.telegram.ui.ActionBar.j6.Y(v03, i13, i13));
        } else {
            int l1 = org.telegram.ui.ActionBar.j6.l1(0.1f, m6Var.f26069a.getColor());
            int i14 = this.f4449b;
            view.setBackground(org.telegram.ui.ActionBar.j6.Y(l1, i14, i14));
        }
        if (this.f4460s) {
            if (this.f4461w) {
                i11 = org.telegram.ui.ActionBar.j6.f19249ya;
            } else {
        ...
        this.e.r(org.telegram.ui.ActionBar.j6.v0(i11, this.f4447a));
        this.f4455f.r(this.f4463y);
        this.f4451c.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Sh, this.f4447a));
    }
    ...
    public final void k() {
        ...
        this.U = mutate;
        mutate.setColorFilter(new PorterDuffColorFilter(this.f4463y, PorterDuff.Mode.SRC_IN));
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        float f12;
        float f13;
        this.f4459r.draw(canvas);
        int i11 = 0;
        if (this.L) {
            if (this.N) {
                if (this.K == null) {
                    g90 g90Var = new g90(this.f4447a);
                    this.K = g90Var;
                    g90Var.setCallback(this);
                    g90 g90Var2 = this.K;
                    g90Var2.f24149t = 2.0f;
                    g90Var2.C = true;
                    g90Var2.f24151w.setStrokeWidth(0.0f);
        ...
        org.telegram.ui.Components.m6 m6Var = this.d;
        if (f14 > 0.0f) {
            if (this.f4450b0 == null) {
                this.f4450b0 = new tp(m6Var.f26069a.getColor());
            }
            int dp = (int) ((1.0f - this.M) * AndroidUtilities.dp(24.0f));
            this.f4450b0.setBounds(0, dp, getWidth(), getHeight() + dp);
            this.f4450b0.setAlpha((int) (this.M * 255.0f));
            this.f4450b0.draw(canvas);
            invalidate();
        }
        float f15 = this.M;
        if (f15 < 1.0f) {
            ...
            float d = m6Var.d();
            float d10 = this.f4458n.d(this.h, false);
            if (this.T) {
                f7 = AndroidUtilities.dp(12.0f);
            } else {
                f7 = 0.0f;
            }
            org.telegram.ui.Components.m6 m6Var2 = this.f4455f;
            ...
            m6Var.f26087w = (int) (AndroidUtilities.lerp(0.5f, 1.0f, this.V) * (1.0f - this.M) * this.f4452c0);
            ...
            if (this.J) {
                ...
                m6Var3.f26087w = (int) (AndroidUtilities.lerp(0.5f, 1.0f, this.V) * (1.0f - this.M) * 200.0f * this.H);
            ...
            if (this.E) {
                ...
                Paint paint = this.f4451c;
                paint.setAlpha((int) (lerp2 * f17 * this.f4452c0 * d10 * d10));
                if (this.T) {
                    f13 = 4.0f;
                } else {
                    f13 = 10.0f;
            ...
            CharSequence charSequence = m6Var2.f26073g;
            if (charSequence != null) {
            ...
            float A3 = org.telegram.messenger.w1.A(1.0f, this.M, this.f4452c0, d10);
            if (this.E) {
                f11 = 1.0f;
            }
            m6Var2.f26087w = (int) (A3 * f11);
            m6Var2.setBounds(rect);
            canvas.save();
            if (this.E && this.T) {
                this.U.setAlpha((int) ((1.0f - this.M) * this.f4452c0 * d10 * 1.0f));
        ...
        if (this.v && this.f4457g0 != (wrapWidth = getWrapWidth())) {
            this.f4457g0 = wrapWidth;
            requestLayout();
        }
    }
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        if (this.f4460s && isClickable() && getParent() != null) {
    ...
    public void onMeasure(int i10, int i11) {
        ...
        } else if (this.f4456f0) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec((int) Math.min(Math.max(this.d.d() + getPaddingLeft() + getPaddingRight(), this.f4454e0), View.MeasureSpec.getSize(i10)), 1073741824), i11);
        } else {
    ...
    public void setColor(int i10) {
        if (this.f4460s) {
            this.f4462x = true;
            int dp = AndroidUtilities.dp(this.f4449b);
            this.f4463y = i10;
        ...
        int i11 = this.f4449b;
        this.f4459r.setBackground(org.telegram.ui.ActionBar.j6.Y(l1, i11, i11));
    }
    ...
    public void setEnabled(boolean z10) {
        float f7;
        if (this.W != z10) {
            ValueAnimator valueAnimator = this.f4448a0;
            if (valueAnimator != null) {
                valueAnimator.cancel();
                this.f4448a0 = null;
            }
    ...
    public void setFilled(boolean z10) {
        ...
        org.telegram.ui.Components.m6 m6Var = this.d;
        if (z10) {
            setBackground(org.telegram.ui.ActionBar.j6.b0(AndroidUtilities.dp(this.f4449b), this.f4463y));
    ...
    public void setRoundRadius(int i10) {
        this.f4449b = i10;
        if (this.f4460s) {
            setBackground(org.telegram.ui.ActionBar.j6.b0(AndroidUtilities.dp(i10), this.f4463y));
        } else {
            setBackground(null);
        }
        j();
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        if (this.K != drawable && this.d != drawable && this.e != drawable && this.f4455f != drawable && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
    ...
    public d(Context context, org.telegram.ui.ActionBar.f6 f6Var, boolean z10) {
        ...
        this.f4449b = 8;
        qr qrVar = qr.h;
        this.f4458n = new org.telegram.ui.Components.c6(350L, qrVar);
        this.E = true;
        this.F = 0;
        this.H = 0.0f;
        this.M = 0.0f;
