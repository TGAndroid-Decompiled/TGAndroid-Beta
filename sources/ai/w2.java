...
public final class w2 extends View {
    ...
    public final RectF f1637b;
    public final org.telegram.ui.Components.m6 f1638c;
    public final s2 d;
    public final ArrayList e;
    public final int[] f1639f;
    public final ArrayList h;
    public float f1640n;
    public ValueAnimator f1641r;
    ...
    public w2(Context context, int i10) {
        ...
        this.f1639f = new int[]{R.raw.star_reaction_effect1, R.raw.star_reaction_effect2, R.raw.star_reaction_effect3, R.raw.star_reaction_effect4, R.raw.star_reaction_effect5};
    ...
    public final void a(float f7, s2 s2Var) {
        ValueAnimator valueAnimator = this.f1641r;
        if (valueAnimator != null) {
            this.f1641r = null;
            valueAnimator.cancel();
        }
        ValueAnimator ofFloat = ValueAnimator.ofFloat(this.f1640n, f7);
        this.f1641r = ofFloat;
        ofFloat.addUpdateListener(new a(this, 7));
        this.f1641r.addListener(new t2(this, f7, s2Var, 0));
        this.f1641r.setInterpolator(qr.h);
        this.f1641r.setDuration(320L);
        this.f1641r.start();
    }
    ...
    public final void b() {
        ...
        this.f1638c.q("", true, true);
        invalidate();
        a(0.0f, new s2(this, 1));
    }

    public final void c(x2 x2Var) {
        this.f1637b.set(x2Var.getX() - getX(), x2Var.getY() - getY(), (x2Var.getX() - getX()) + x2Var.getWidth(), (x2Var.getY() - getY()) + x2Var.getHeight());
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        float f7 = 1.0f;
        float lerp = AndroidUtilities.lerp(1.0f, 1.8f, w2Var.f1640n);
        ...
        while (true) {
            ...
            if (xi0Var.f29948b0 >= xi0Var.e[0]) {
                ...
                xi0Var.setAlpha((int) (w2Var.f1640n * 255.0f));
                xi0Var.draw(canvas2);
            }
            i11++;
        }
        ...
        while (true) {
            ...
            if (i12 < arrayList2.size()) {
                ...
                float dp2 = AndroidUtilities.dp(23.0f) + v2Var.f1601g.f24149c;
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        if (drawable != this.f1638c && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
