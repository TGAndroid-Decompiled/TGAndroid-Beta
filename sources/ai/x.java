    ...
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        ...
        switch (this.f1677a) {
            ...
            case 3:
                ...
                gVar.getClass();
                dVar.f13606f = (int) ((Float) valueAnimator.getAnimatedValue()).floatValue();
                ...
                while (i10 < size) {
                    ...
                    kg.d dVar2 = (kg.d) obj;
                    if (dVar2 != dVar) {
                        dVar2.f13606f = (int) ((dVar2.f13607g / 255.0f) * (255 - dVar.f13606f));
                    }
                }
                gVar.invalidate();
                return;
            ...
            case 5:
                ...
                nVar.getClass();
                ((ig.o) this.f1679c).f11193r = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                nVar.invalidate();
                return;
            case 6:
                ...
                return;
            case 7:
                ((org.telegram.ui.Cells.v0) this.f1678b).f21678c = ((Float) valueAnimator.getAnimatedValue()).floatValue();
            ...
            case 8:
                ...
                aVar.f15452b = linearGradient;
                linearGradient.setLocalMatrix(aVar.f15453c);
                paint.setShader(aVar.f15452b);
                aVar.f15451a.setPaint(paint, 0);
                aVar.f15455g.setColor(i0.a.d(0.1f, i0.a.d(floatValue4, iArr[1], aVar.h[1]), -1));
                aVar.f15454f.setColor(i0.a.d(0.1f, i0.a.d(floatValue4, iArr[0], aVar.h[0]), -16777216));
                aVar.invalidateSelf();
                return;
            case 9:
                zn znVar = (zn) this.f1678b;
                zn znVar2 = (zn) this.f1679c;
                ...
                znVar.f40264a1.setTranslationY(dp);
                znVar.f40264a1.getAvatarImageView().setTranslationY(-dp);
                float f11 = (-AndroidUtilities.dp(8.0f)) * floatValue5;
                znVar2.f40264a1.setTranslationY(f11);
                znVar2.f40264a1.getAvatarImageView().setTranslationY(-f11);
                float f12 = (floatValue5 * 0.2f) + 0.8f;
                znVar.f40264a1.getAvatarImageView().setScaleX(f12);
                znVar.f40264a1.getAvatarImageView().setScaleY(f12);
                znVar.f40264a1.getAvatarImageView().setAlpha(floatValue5);
                float f13 = (0.2f * f10) + 0.8f;
                znVar2.f40264a1.getAvatarImageView().setScaleX(f13);
                znVar2.f40264a1.getAvatarImageView().setScaleY(f13);
                znVar2.f40264a1.getAvatarImageView().setAlpha(f10);
                ch chVar = znVar2.M0;
                if (chVar != null) {
                    chVar.setAlpha(f10);
                    return;
            ...
            case 10:
                ...
                return;
            case 11:
                org.telegram.ui.Components.v9 v9Var = (org.telegram.ui.Components.v9) this.f1678b;
                org.telegram.ui.Components.v9 v9Var2 = (org.telegram.ui.Components.v9) this.f1679c;
                ...
                return;
            case 12:
                ((org.telegram.ui.Components.fb) this.f1678b).accept(Float.valueOf(((org.telegram.ui.Components.tb) this.f1679c).getTranslationY()));
                return;
            case 13:
                ((ml) this.f1678b).accept(Float.valueOf(((org.telegram.ui.Components.tb) this.f1679c).getTranslationY()));
                return;
            case 14:
                ai aiVar = (ai) this.f1678b;
                aiVar.getClass();
                ((bu) this.f1679c).setOffsetY(((Float) valueAnimator.getAnimatedValue()).floatValue());
                vi viVar = aiVar.f22663c0;
                viVar.U1();
                ...
                if (niVar == chatAttachAlertPhotoLayout) {
                    chatAttachAlertPhotoLayout.k(viVar.f29115l2);
                    return;
                }
                return;
            case 15:
                ...
                mVar.getClass();
                ((lu) this.f1679c).f26176b = ((Integer) valueAnimator.getAnimatedValue()).intValue();
                ...
                return;
            case 16:
                qy0 qy0Var = (qy0) this.f1678b;
                py0[] py0VarArr = (py0[]) this.f1679c;
                qy0Var.getClass();
                float floatValue8 = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                while (i10 < py0VarArr.length) {
                    qy0Var.f27699c[i10] = (qy0Var.d[i10] * floatValue8) + ((1.0f - floatValue8) * qy0Var.e[i10]);
                    i10++;
                }
                qy0Var.invalidate();
                return;
            ...
            case 18:
                ...
                return;
            case 19:
                org.telegram.ui.Components.voip.c3 c3Var = (org.telegram.ui.Components.voip.c3) this.f1678b;
                org.telegram.ui.Components.voip.q1 q1Var = (org.telegram.ui.Components.voip.q1) this.f1679c;
                ...
                return;
            case 20:
                org.telegram.ui.Components.voip.o3 o3Var = (org.telegram.ui.Components.voip.o3) this.f1678b;
                int i13 = o3Var.e;
                o3Var.f29491g = (int) ((((Float) valueAnimator.getAnimatedValue()).floatValue() * (o3Var.f29489c - i13)) + i13);
                int i14 = o3Var.f29490f;
                o3Var.h = (int) ((((Float) valueAnimator.getAnimatedValue()).floatValue() * (o3Var.d - i14)) + i14);
                ((org.telegram.ui.Components.voip.z2) this.f1679c).invalidate();
                return;
            case 21:
                uy.q1(((xw) this.f1678b).M, (ty) this.f1679c, ((Float) valueAnimator.getAnimatedValue()).floatValue());
                return;
            case 22:
            ...
            case 23:
                ...
                if (iArr2 != null) {
                    ...
                    z21 z21Var = f31Var.E;
                    z21Var.f40093a.n(d, d10, d11, d12);
                    z21Var.invalidate();
                }
                f31Var.f33499w.invalidate();
                return;
            case 24:
                ...
                int i15 = intValue2 - aVar2.f276b;
                ((yl0) aVar2.d).scrollBy(0, i15);
                iArr3[0] = iArr3[0] + i15;
                aVar2.f276b = intValue2;
                return;
            case 25:
                wi1 wi1Var = (wi1) this.f1678b;
                wi1Var.getClass();
                wi1Var.d = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                ((ui) this.f1679c).invalidate();
                return;
            case 26:
                qg.b2 b2Var = (qg.b2) this.f1678b;
                ...
                if (floatValue11 < 0.5f) {
                    ...
                    b2Var.f41632z0 = ((1.0f - f16) * 0.3f) + 0.7f;
                    b2Var.invalidate();
                    return;
                }
                if (!zArr2[0]) {
            ...
            case 27:
                ...
                View view4 = ((rg.k1) cl0Var.f23401c).A0;
