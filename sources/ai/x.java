    ...
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        ...
        switch (this.f1680a) {
            ...
            case 1:
                ...
                int i11 = ProfileStoriesView.f31531s0;
            ...
            case 6:
                ...
                return;
            case 7:
                ((org.telegram.ui.Cells.v0) this.f1681b).f21468c = ((Float) valueAnimator.getAnimatedValue()).floatValue();
            ...
            case 9:
                ...
                boVar.f32215a1.setTranslationY(dp);
                boVar.f32215a1.getAvatarImageView().setTranslationY(-dp);
                float f11 = (-AndroidUtilities.dp(8.0f)) * floatValue5;
                boVar2.f32215a1.setTranslationY(f11);
                boVar2.f32215a1.getAvatarImageView().setTranslationY(-f11);
                float f12 = (floatValue5 * 0.2f) + 0.8f;
                boVar.f32215a1.getAvatarImageView().setScaleX(f12);
                boVar.f32215a1.getAvatarImageView().setScaleY(f12);
                boVar.f32215a1.getAvatarImageView().setAlpha(floatValue5);
                float f13 = (0.2f * f10) + 0.8f;
                boVar2.f32215a1.getAvatarImageView().setScaleX(f13);
                boVar2.f32215a1.getAvatarImageView().setScaleY(f13);
                boVar2.f32215a1.getAvatarImageView().setAlpha(f10);
                bh bhVar = boVar2.M0;
                if (bhVar != null) {
                    bhVar.setAlpha(f10);
                    return;
            ...
            case 14:
                ...
                if (niVar == chatAttachAlertPhotoLayout) {
                    chatAttachAlertPhotoLayout.k(viVar.f28761l2);
                    return;
                }
                return;
            case 15:
                ...
                mVar.getClass();
                ((lu) this.f1682c).f25970b = ((Integer) valueAnimator.getAnimatedValue()).intValue();
            ...
            case 16:
                ...
                while (i10 < dy0VarArr.length) {
                    ey0Var.f23693c[i10] = (ey0Var.d[i10] * floatValue8) + ((1.0f - floatValue8) * ey0Var.e[i10]);
                    i10++;
                }
                ey0Var.invalidate();
                return;
            ...
            case 20:
                ...
                int i13 = o3Var.e;
                o3Var.f29103g = (int) ((((Float) valueAnimator.getAnimatedValue()).floatValue() * (o3Var.f29101c - i13)) + i13);
                int i14 = o3Var.f29102f;
            ...
            case 23:
                ...
                cc0 cc0Var = g31Var.f33832n;
                if (cc0Var != null) {
                    cc0Var.K = 1.0f;
                    cc0Var.i();
                    g31Var.f33832n.s(1.0f - floatValue10);
                }
                ...
                if (iArr2 != null) {
                    ...
                    a31 a31Var = g31Var.E;
                    a31Var.f31701a.n(d, d10, d11, d12);
                    a31Var.invalidate();
                }
                g31Var.f33835w.invalidate();
                return;
            case 24:
            ...
            case 26:
                ...
                if (floatValue11 < 0.5f) {
                    ...
                    d2Var.f41362z0 = ((1.0f - f16) * 0.3f) + 0.7f;
                    d2Var.invalidate();
                    return;
                }
                if (!zArr2[0]) {
            ...
            case 27:
                ...
                View view4 = ((rg.k1) qk0Var.f27338c).A0;
