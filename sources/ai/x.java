    ...
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        ...
        switch (this.f1677a) {
            ...
            case 1:
                ...
                int i11 = ProfileStoriesView.f31515s0;
            ...
            case 3:
                ...
                ArrayList arrayList = gVar.f11132b;
            ...
            case 4:
                ...
                ArrayList arrayList2 = gVar2.f11135c;
            ...
            case 5:
                ...
                nVar.getClass();
                ((ig.o) this.f1679c).f11191r = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                nVar.invalidate();
                return;
            case 6:
                ...
                b0Var.f11247a = intValue;
                ((ei.d5) this.f1679c).d(intValue);
                return;
            case 7:
                ((org.telegram.ui.Cells.v0) this.f1678b).f21449c = ((Float) valueAnimator.getAnimatedValue()).floatValue();
            ...
            case 8:
                ...
                aVar.f15218b = linearGradient;
                linearGradient.setLocalMatrix(aVar.f15219c);
                paint.setShader(aVar.f15218b);
                aVar.f15217a.setPaint(paint, 0);
                aVar.f15221g.setColor(i0.a.d(0.1f, i0.a.d(floatValue4, iArr[1], aVar.h[1]), -1));
                aVar.f15220f.setColor(i0.a.d(0.1f, i0.a.d(floatValue4, iArr[0], aVar.h[0]), -16777216));
                aVar.invalidateSelf();
                return;
            case 9:
                bo boVar = (bo) this.f1678b;
                bo boVar2 = (bo) this.f1679c;
                ...
                boVar.f32233a1.setTranslationY(dp);
                boVar.f32233a1.getAvatarImageView().setTranslationY(-dp);
                float f11 = (-AndroidUtilities.dp(8.0f)) * floatValue5;
                boVar2.f32233a1.setTranslationY(f11);
                boVar2.f32233a1.getAvatarImageView().setTranslationY(-f11);
                float f12 = (floatValue5 * 0.2f) + 0.8f;
                boVar.f32233a1.getAvatarImageView().setScaleX(f12);
                boVar.f32233a1.getAvatarImageView().setScaleY(f12);
                boVar.f32233a1.getAvatarImageView().setAlpha(floatValue5);
                float f13 = (0.2f * f10) + 0.8f;
                boVar2.f32233a1.getAvatarImageView().setScaleX(f13);
                boVar2.f32233a1.getAvatarImageView().setScaleY(f13);
                boVar2.f32233a1.getAvatarImageView().setAlpha(f10);
                bh bhVar = boVar2.M0;
                if (bhVar != null) {
                    bhVar.setAlpha(f10);
                    return;
            ...
            case 10:
                ...
                return;
            case 11:
                org.telegram.ui.Components.u9 u9Var = (org.telegram.ui.Components.u9) this.f1678b;
                org.telegram.ui.Components.u9 u9Var2 = (org.telegram.ui.Components.u9) this.f1679c;
                ...
                return;
            case 12:
                ((org.telegram.ui.Components.eb) this.f1678b).accept(Float.valueOf(((org.telegram.ui.Components.sb) this.f1679c).getTranslationY()));
                return;
            case 13:
                ((ml) this.f1678b).accept(Float.valueOf(((org.telegram.ui.Components.sb) this.f1679c).getTranslationY()));
                return;
            case 14:
                ai aiVar = (ai) this.f1678b;
                aiVar.getClass();
                ((bu) this.f1679c).setOffsetY(((Float) valueAnimator.getAnimatedValue()).floatValue());
                vi viVar = aiVar.f22416c0;
                viVar.U1();
                ...
                if (niVar == chatAttachAlertPhotoLayout) {
                    chatAttachAlertPhotoLayout.k(viVar.f28766l2);
                    return;
                }
                return;
            case 15:
                ...
                mVar.getClass();
                ((lu) this.f1679c).f26010b = ((Integer) valueAnimator.getAnimatedValue()).intValue();
                ...
                return;
            case 16:
                dy0 dy0Var = (dy0) this.f1678b;
                cy0[] cy0VarArr = (cy0[]) this.f1679c;
                dy0Var.getClass();
                float floatValue8 = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                while (i10 < cy0VarArr.length) {
                    dy0Var.f23417c[i10] = (dy0Var.d[i10] * floatValue8) + ((1.0f - floatValue8) * dy0Var.e[i10]);
                    i10++;
                }
                dy0Var.invalidate();
                return;
            ...
            case 20:
                ...
                int i13 = o3Var.e;
                o3Var.f29123g = (int) ((((Float) valueAnimator.getAnimatedValue()).floatValue() * (o3Var.f29121c - i13)) + i13);
                int i14 = o3Var.f29122f;
            ...
            case 23:
                ...
                cc0 cc0Var = f31Var.f33478n;
                if (cc0Var != null) {
                    cc0Var.K = 1.0f;
                    cc0Var.i();
                    f31Var.f33478n.s(1.0f - floatValue10);
                }
                ...
                if (iArr2 != null) {
                    ...
                    z21 z21Var = f31Var.E;
                    z21Var.f40024a.n(d, d10, d11, d12);
                    z21Var.invalidate();
                }
                f31Var.f33481w.invalidate();
                return;
            case 24:
            ...
            case 26:
                ...
                if (floatValue11 < 0.5f) {
                    ...
                    d2Var.f41336z0 = ((1.0f - f16) * 0.3f) + 0.7f;
                    d2Var.invalidate();
                    return;
                }
                if (!zArr2[0]) {
                ...
                d2Var.f41336z0 = (f17 * 0.3f) + 0.7f;
                d2Var.invalidate();
                return;
            case 27:
                pk0 pk0Var = (pk0) this.f1678b;
                pk0Var.getClass();
                ((Drawable) this.f1679c).setAlpha(((Integer) valueAnimator.getAnimatedValue()).intValue());
                View view4 = ((rg.k1) pk0Var.f27072c).A0;
