        ...
        switch (this.f1793a) {
            ...
            case 1:
                try {
                    ...
                    if (androidx.emoji2.text.l.f2334j == null) {
                        z10 = false;
                    }
                    if (z10) {
            ...
            case 2:
                return;
            case 3:
                org.telegram.ui.ActionBar.i6.f18935j = false;
                org.telegram.ui.ActionBar.i6.l(false);
                return;
            case 4:
                org.telegram.ui.ActionBar.i6.f18954k = false;
            ...
            case 6:
                ...
                if (m2Var != null) {
                    AndroidUtilities.cancelRunOnUIThread(m2Var.f29089b.f29050f.M);
                    return;
                }
                return;
            default:
