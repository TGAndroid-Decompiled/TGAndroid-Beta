...
public final class k8 implements Runnable {
    ...
    public final void run() {
        switch (this.f1134a) {
            case 0:
                l9 l9Var = (l9) this.e;
                TL_stories.PeerStories peerStories = (TL_stories.PeerStories) this.f1137f;
                TLObject tLObject = (TLObject) this.h;
                l9Var.D.remove(Long.valueOf(this.f1136c));
                    ...
                    if (tLObject instanceof TL_stories.TL_stories_stories) {
                        ...
                        for (int i10 = 0; i10 < tL_stories_stories.stories.size(); i10++) {
                            for (int i11 = 0; i11 < peerStories.stories.size(); i11++) {
                                if (peerStories.stories.get(i11).f18344id == tL_stories_stories.stories.get(i10).f18344id) {
                        ...
                        if (!z10) {
                            ...
                            y9Var.f1765b.getStorageQueue().postRunnable(new v9(y9Var, peerStories, 1));
                        }
                    }
                ...
                return;
            default:
                ((FileLoader) this.e).lambda$checkUploadNewDataAvailable$3(this.f1135b, (String) this.f1137f, this.f1136c, this.d, (Float) this.h);
                return;
        }
    }
