...
public abstract class k7 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public k7(jc jcVar, Context context, u6 u6Var, y1 y1Var) {
        ...
        this.h = textView;
        textView.setTextColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19165j5, dVar));
    ...
    public static void f(int i10, long j3, TL_stories.StoryItem storyItem) {
        ...
        if (storyItem != null) {
            ...
            if (sparseArray == null) {
                ...
                j7Var = (j7) sparseArray.get(storyItem.f18570id);
            }
            ...
            sparseArray.put(storyItem.f18570id, j7Var2);
        }
    }
    ...
    public final void g(long j3, r7 r7Var) {
        ...
        if (r7Var != null && r7Var.f1468a != null) {
            NotificationsController.getInstance(this.v).processSeenStoryReactions(j3, r7Var.f1468a.f18570id);
        }
    }
