...
public abstract class na extends z4.g {
                ...
                if (((Integer) getChildAt(i10).getTag()).intValue() == getCurrentItem() && getCurrentItem() == this.O0) {
                    ...
                    if (!maVar.d) {
                        ...
                        if (this.f1303x0 != null) {
                            ...
                            maVar.f1256a.U0(0, maVar.f1257b);
                        }
                    }
                }
            }
    ...
    public final boolean E(boolean z10) {
        ...
        if (z10) {
            ...
            ArrayList arrayList = this.f1303x0;
            if (arrayList == null) {
                arrayList = this.A0;
            }
            if (currentItem < arrayList.size() - 1) {
                int currentItem2 = getCurrentItem() + 1;
                if (jcVar.f1062a && Build.VERSION.SDK_INT < 33) {
                    z11 = true;
                }
                x(currentItem2, !z11);
                return true;
