...
public final class rc {
    public static final rc[] f1481f = new rc[4];
    public final int f1482a;
    public final LongSparseLongArray f1483b = new LongSparseLongArray();
    ...
    public final void a(org.telegram.ui.Components.ga gaVar) {
        ...
        for (int i10 = 0; i10 < gaVar.getChildCount(); i10++) {
            ...
            int i11 = this.f1482a;
            LongSparseLongArray longSparseLongArray = this.f1483b;
            if (j3 > 0) {
