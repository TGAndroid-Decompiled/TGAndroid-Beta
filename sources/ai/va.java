...
public final class va {
                ...
                while (true) {
                    ...
                    if (taVar != null) {
                        ...
                        if (f11 == f12) {
                            ...
                            float lerp2 = AndroidUtilities.lerp(taVar.d, taVar.f1560f, qr.f27381g.getInterpolation(waVar.f1675w));
    ...
    public final void g(CharSequence charSequence, sa saVar, sa saVar2) {
        ...
        if (saVar != null) {
            ...
            saVar.h.f22935a = waVar;
            saVar.f1518i.f29629a = waVar;
            saVar.c();
        }
        ...
        if (saVar3 != null) {
            ...
            saVar3.h.f22935a = waVar;
            saVar3.f1518i.f29629a = waVar;
            saVar3.c();
        }
        waVar.f1674s = 0;
        waVar.requestLayout();
