...
public final class q0 implements Utilities.Callback3 {
    ...
    public final void run(Object obj, Object obj2, Object obj3) {
        ...
        switch (this.f1406a) {
            case 0:
                r3 r3Var = (r3) this.f1407b;
                m1 m1Var = (m1) this.f1408c;
                ...
                if (((Boolean) obj2).booleanValue()) {
                    ...
                    deletegroupcallparticipantmessages.participant = MessagesController.getInstance(i10).getInputPeer(m1Var.f1224c);
                    ...
                    long j3 = m1Var.f1224c;
                    ArrayList arrayList = r3Var.f1333r;
                    ArrayList arrayList2 = r3Var.f1334s;
                    int i11 = 0;
                    boolean z10 = false;
                    while (i11 < arrayList.size()) {
                        if (((m1) arrayList.get(i11)).f1224c == j3) {
                            m1 m1Var2 = (m1) arrayList.get(i11);
                            int i12 = 0;
                            while (true) {
                                if (i12 < arrayList2.size()) {
                                    if (((n1) arrayList2.get(i12)).f1277f.contains(m1Var2)) {
                                        ((n1) arrayList2.get(i12)).f1277f.remove(m1Var2);
                                        if (((n1) arrayList2.get(i12)).f1277f.isEmpty()) {
                    ...
                    deletegroupcallmessages.messages.add(Integer.valueOf(m1Var.f1222a));
                    ConnectionsManager.getInstance(i10).sendRequest(deletegroupcallmessages, null);
                    r3Var.c(m1Var.f1222a);
                }
                if (bool2.booleanValue()) {
                    if (r3Var.M >= 0) {
                        ...
                        MessagesController.getInstance(i10).deleteParticipantFromChat(-r3Var.M, MessagesController.getInstance(i10).getInputPeer(m1Var.f1224c), false, true);
                        return;
                    }
                }
                return;
            case 1:
                ci.ec ecVar = (ci.ec) this.f1407b;
                ci.p pVar = (ci.p) this.f1408c;
                File file = (File) obj;
                ...
                if (o8Var != null) {
                    ...
                    o8Var2.f5179u0 = 1.0f;
                    ocVar.u();
                    if (ocVar.X0 != null && (qbVar = ocVar.f5267v1) != null) {
                        qg.e2 m0 = qbVar.m0(ocVar.K1.f5169p0, true);
                        ecVar.setHasRoundVideo(true);
                        ocVar.X0.s(ocVar.K1, m0, true);
                        AndroidUtilities.cancelRunOnUIThread(pVar.h);
                        pVar.f5344a.destroy(true, null);
                        m0.setDraw(false);
                ...
                return;
            default:
                ei.r rVar = (ei.r) this.f1407b;
                Utilities.Callback2 callback2 = (Utilities.Callback2) this.f1408c;
                ...
                if (sVar != null) {
                    try {
                        ...
                        if (i13 < 23) {
                            ...
                            if (tVar != null) {
                                str2 = !TextUtils.isEmpty(rVar.f8577g) ? new String(tVar.f2067b.doFinal(Utilities.hexToBytes(rVar.f8577g)), StandardCharsets.UTF_8) : rVar.f8577g;
                            } else if (!TextUtils.isEmpty(rVar.f8577g)) {
