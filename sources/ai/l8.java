    ...
    public final void run() {
        ...
        switch (i10) {
            case 0:
                ...
                hashSet.add(str2);
                l9Var.f1198l.edit().putStringSet("unsupported_stories_checked", hashSet).apply();
                return;
            case 1:
                ((BotForumHelper) obj3).lambda$beforeSendingFinalRequest$3((long[]) obj2, this.f1187b, this.f1188c, (Runnable) obj);
                return;
            case 2:
                ((MediaDataController) obj3).lambda$loadStickers$100((TLObject) obj2, this.f1188c, (Utilities.Callback) obj, this.f1187b);
                return;
            case 3:
                int i14 = this.f1188c;
                ((MessagesStorage) obj3).lambda$checkMessageId$154(this.f1187b, i14, (boolean[]) obj2, (CountDownLatch) obj);
                return;
            case 4:
                ((MessagesStorage) obj3).lambda$overwriteChannel$190(this.f1187b, this.f1188c, (TLRPC.TL_updates_channelDifferenceTooLong) obj2, (Runnable) obj);
                return;
            case 5:
                ((MessagesStorage) obj3).lambda$updateMessageVoiceTranscription$109(this.f1188c, this.f1187b, (TLRPC.Message) obj2, (String) obj);
                return;
            case 6:
                ((MessagesStorage) obj3).lambda$setDialogsFolderId$244((ArrayList) obj2, (ArrayList) obj, this.f1188c, this.f1187b);
                return;
            case 7:
                ((TopicsController) obj3).lambda$loadTopics$2((TLRPC.TL_messages_savedDialogs) obj2, this.f1187b, (a0.i) obj, this.f1188c);
                return;
            case 8:
