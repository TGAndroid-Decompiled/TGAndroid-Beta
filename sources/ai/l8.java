    ...
    public final void run() {
        ...
        switch (i10) {
                ...
                if (tLObject != null) {
                    ...
                    while (true) {
                        if (i11 < tL_stories_stories.stories.size()) {
                            if (tL_stories_stories.stories.get(i11).f18357id == i12) {
            ...
            case 11:
                ...
                int i16 = ((yh.o) obj3).f47564a;
                boolean[] zArr = nVar.d;
                boolean[] zArr2 = nVar.f47501b;
                ArrayList[] arrayListArr = nVar.f47500a;
                zArr[i12] = false;
            ...
            default:
                ...
                tL_fulfillStarsSubscription.subscription_id = ((TL_stars.StarsSubscription) obj2).f18348id;
