    ...
    public final void run() {
        ...
        switch (i10) {
                ...
                if (tLObject != null) {
                    ...
                    while (true) {
                        if (i11 < tL_stories_stories.stories.size()) {
                            if (tL_stories_stories.stories.get(i11).f18531id == i12) {
            ...
            default:
                ...
                tL_fulfillStarsSubscription.subscription_id = ((TL_stars.StarsSubscription) obj2).f18522id;
