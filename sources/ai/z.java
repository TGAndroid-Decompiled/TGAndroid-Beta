    ...
    public void onAnimationCancel(Animator animator) {
        ...
        switch (this.f1773a) {
            ...
            case 11:
                ...
                if (animator.equals(actionBarLayout.f18412k0)) {
                    actionBarLayout.f18406h0.clear();
                    actionBarLayout.f18392b0.clear();
                    actionBarLayout.f18395c0.clear();
                    actionBarLayout.f18410j0.clear();
                    org.telegram.ui.ActionBar.j6.sl = null;
                    actionBarLayout.f18408i0 = null;
                    actionBarLayout.f18404g0 = null;
                    actionBarLayout.f18412k0 = null;
                    un unVar = ((org.telegram.ui.ActionBar.d5) this.f1774b).f18593j;
                    if (unVar != null) {
                        unVar.run();
                        return;
                    }
            ...
            case 18:
                ...
                if (animator.equals(chatActivityEnterView.f21839q2)) {
                    chatActivityEnterView.f21839q2 = null;
                    return;
                }
                return;
            case 22:
    ...
    public final void onAnimationEnd(Animator animator) {
        ...
        switch (i10) {
            ...
            case 8:
                ...
                d2Var.v.f21887z1.setVisibility(0);
            ...
            case 10:
                ...
                if (animatorSet3 != null && animatorSet3.equals(animator)) {
                    kVar2.P = null;
                    org.telegram.ui.ActionBar.k5 k5Var = kVar2.f19304n[0];
                    if (k5Var != null) {
                        k5Var.setVisibility(4);
                    }
                    if (kVar2.f19313r != null && !TextUtils.isEmpty(kVar2.A0)) {
                        kVar2.f19313r.setVisibility(4);
                    }
            ...
            case 11:
                ...
                actionBarLayout.f18414l0.unlock();
                if (animator.equals(actionBarLayout.f18412k0)) {
                    actionBarLayout.f18406h0.clear();
                    actionBarLayout.f18392b0.clear();
                    actionBarLayout.f18395c0.clear();
                    ...
                    actionBarLayout.f18404g0 = null;
                    actionBarLayout.f18412k0 = null;
                    un unVar = ((org.telegram.ui.ActionBar.d5) obj).f18593j;
                    if (unVar != null) {
                        unVar.run();
                        return;
                    }
                ...
                return;
            case 12:
                ((ActionBarLayout) obj2).f18416n = false;
            ...
            case 18:
                ...
                if (animator.equals(chatActivityEnterView.f21839q2)) {
                    ...
                    chatActivityEnterView.f21839q2 = null;
                    chatActivityEnterView.f21861u2 = 0;
                    return;
                }
                return;
            case 19:
            ...
            case 22:
                ...
                if (animatorSet != null) {
                    animatorSet2 = ((org.telegram.ui.ActionBar.g3) viVar).currentSheetAnimation;
                    if (animatorSet2.equals(animator) && (kVar = viVar.f28776p2) != null && !kVar.f15354f) {
            ...
            case 23:
                ru ruVar = (ru) obj2;
                if (ruVar.f27694a.e.getVisibility() == 0) {
                    ruVar.f27694a.e.setAlpha(1.0f);
                    ruVar.f27694a.e.setVisibility(4);
                }
                ((Runnable) obj).run();
                return;
            case 24:
            ...
            case 27:
                ...
                a70Var.f22342a = false;
                return;
            case 28:
                mk0 mk0Var = (mk0) obj2;
                pk0 pk0Var = mk0Var.e;
                if (((ValueAnimator) pk0Var.f27067g) != null) {
                    ((ml0) pk0Var.e).X1 = false;
                    ArrayList arrayList2 = mk0Var.f26160b;
                    ...
                    while (i14 < size) {
                        ...
                        ((s4.c0) pk0Var.f27066f).getClass();
                        s4.o0.x0(view4);
                        ((ml0) pk0Var.e).removeView(view4);
                        w7.y5 y5Var = (w7.y5) pk0Var.f27068i;
                        if (y5Var != null) {
                            y5Var.d(view4);
                        }
                    }
                    ...
                    w7.y5 y5Var2 = (w7.y5) pk0Var.f27068i;
                    if (y5Var2 != null) {
                        y5Var2.a();
                    }
                    ((SparseArray) pk0Var.f27069j).clear();
                    pk0Var.f27067g = null;
                    return;
                }
                return;
            default:
                ...
                s4.o0.x0(t00Var);
                rk0 rk0Var = (rk0) obj2;
                rk0Var.f27638c.remove(t00Var);
                rk0Var.f27636a.removeView(t00Var);
                return;
        }
    }
