...
public final class p1 implements NativeInstance.PayloadCallback, RequestDelegateTimestamp, NativeInstance.VideoSourcesCallback, NativeInstance.RequestBroadcastPartCallback, NativeInstance.RequestCurrentTimeCallback {
    ...
    public void run(long j3, int[] iArr) {
        ...
        getgroupparticipants.call = d2Var.f686f;
    ...
    public void run(final long j3, final long j10, final int i10, final int i11) {
        ...
        switch (this.f1378a) {
            case 3:
                ...
                tL_inputGroupCallStream.call = d2Var.f686f;
                ...
                AndroidUtilities.runOnUIThread(new s1(d2Var, str2, AccountInstance.getInstance(d2Var.e).getConnectionsManager().sendRequest(tL_upload_getFile, new RequestDelegateTimestamp() {
                    @Override
                    public final void run(TLObject tLObject, TLRPC.TL_error tL_error, long j11) {
                        int i13;
                        String str3;
                        d2 d2Var2 = d2.this;
                        if (!d2Var2.f690w && d2Var2.E != null) {
                            ...
                            if (tLObject != null) {
                                ...
                                d2Var2.E.onStreamPartAvailable(j13, null, -1, j11, i14, i15);
                                ...
                                d2Var2.E.onStreamPartAvailable(j13, null, i13, j11, i14, i15);
                            }
                        }
                    }
                }, 2, 2, d2Var.h()), 0));
            ...
            default:
                ...
                FileLog.d(sb3.toString());
                AndroidUtilities.runOnUIThread(new a2(i10, i11, 0, j3, this.f1379b));
                return;
        }
    }
    ...
    public void run(long j3) {
        ...
        if (groupCall != null && groupCall.rtmp_stream) {
            ...
            getgroupcallstreamchannels.call = d2Var.f686f;
