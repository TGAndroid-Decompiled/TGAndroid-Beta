...
public final class j9 implements Utilities.Callback {
    ...
    public final void run(Object obj) {
        switch (this.f1055a) {
            case 0:
                k9 k9Var = this.f1056b;
                ci.o8 o8Var = k9Var.f1138c;
                o8Var.f5144c0 = (TLRPC.Document) obj;
                TLRPC.TL_inputFileStoryDocument tL_inputFileStoryDocument = new TLRPC.TL_inputFileStoryDocument();
                tL_inputFileStoryDocument.doc = MessagesController.toInputDocument(o8Var.f5144c0);
                k9Var.c(tL_inputFileStoryDocument);
                return;
            default:
                VideoEditedInfo videoEditedInfo = (VideoEditedInfo) obj;
                k9 k9Var2 = this.f1056b;
                k9Var2.F = videoEditedInfo;
                k9Var2.E.videoEditedInfo = videoEditedInfo;
                k9Var2.f1145y = videoEditedInfo.estimatedDuration / 1000;
                if (videoEditedInfo.needConvert()) {
                    ...
                    FileLoader.getInstance(k9Var2.M.f1188a).uploadFile(k9Var2.e, false, false, 33554432);
                    return;
                } else {
                    return;
                }
