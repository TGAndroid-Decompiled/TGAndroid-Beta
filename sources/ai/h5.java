...
public final class h5 extends xa {
    ...
    public final org.telegram.ui.ActionBar.e6 f942y0;
        ...
        if (x5Var != null) {
            ...
            if (f6Var.Q1 != null) {
                ...
                if (document != null) {
                    ...
                    org.telegram.ui.ActionBar.e6 e6Var = this.f942y0;
                    org.telegram.ui.Components.oc h = new vc(a5Var, e6Var).h(document, 2, new d5(this, this.f941x0, e6Var, 0));
                    if (h != null) {
                        h.f26745a = 1;
                        h.k(true);
                    }
    ...
    public final void G(CharacterStyle characterStyle, View view) {
        ...
        if (z10) {
            ...
            vl.p(R.string.TextCopied, new vc(f6Var.f800c1, this.f942y0));
    ...
    public final void H(final URLSpan uRLSpan, final View view, a3.d dVar) {
        ...
        final org.telegram.ui.ActionBar.e6 e6Var2 = this.f942y0;
        DialogInterface.OnClickListener onClickListener = new DialogInterface.OnClickListener() {
            ...
            public final void onClick(DialogInterface dialogInterface, int i10) {
                ...
                if (i10 == 0) {
                    ...
                    new vc(h5Var.f943z0.f800c1, e6Var2).k(false).j();
                }
            }
        };
        ...
        f3Var.fixNavigationBar(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f18904h5, e6Var));
        ((ac) f6Var.Q1).h(f3Var);
    }
    ...
    public final void I(sa saVar) {
        ...
        f6 f6Var = this.f943z0;
        jc jcVar = this.f941x0;
        final org.telegram.ui.ActionBar.e6 e6Var = this.f942y0;
        if (document != null) {
                ...
                public final void run() {
                    ...
                    switch (r4) {
                        case 0:
                            ...
                            new vc(f6Var2.f800c1, e6Var).Q(R.raw.saved_messages, 36, AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.StoryAudioAddToSavedMessagesToast), -1, 2, new f(25))).k(true);
                            return;
                        default:
                            ...
                            new vc(f6Var3.f800c1, e6Var).Q(R.raw.ic_save_to_music, 36, LocaleController.getString(R.string.StoryAudioAddToProfileToast)).k(true);
                            return;
                    }
                }
            ...
            MessagesController.getInstance(f6Var.C2).getStoriesController().d0(saVar.f1511b.longValue(), saVar.f1512c.intValue(), new c5(this, saVar, jcVar, e6Var, 0));
        } else {
            org.telegram.ui.Components.oc Q = new vc(f6Var.f800c1, e6Var).Q(R.raw.error, 36, LocaleController.getString(R.string.StoryHidAccount));
            Q.f26745a = 3;
            Q.k(true);
        }
    }
    ...
    public final void M(int i10, String str, CharacterStyle characterStyle, boolean z10) {
        ...
        if (i10 != 0 && i10 != 2) {
            if (i10 == 1) {
                org.telegram.ui.Components.c5.r0(jcVar.f1077f, str, true, true, false, false, null, null, this.f942y0);
                return;
            }
            return;
        }
        if ((characterStyle instanceof o51) && (o01Var = ((o51) characterStyle).f26695a) != null && (o01Var.f26642a & 1024) != 0) {
            z11 = true;
        } else {
            z11 = false;
        }
        org.telegram.ui.Components.c5.r0(jcVar.f1077f, str, true, true, true, z11, null, null, this.f942y0);
    }
}
