...
public final class h5 extends xa {
    public final jc f941x0;
    public final org.telegram.ui.ActionBar.f6 f942y0;
    public final f6 f943z0;
        ...
        if (y5Var != null) {
            ...
            if (f6Var.Q1 != null) {
                ...
                if (document != null) {
                    ...
                    org.telegram.ui.ActionBar.f6 f6Var2 = this.f942y0;
                    org.telegram.ui.Components.pc h = new xc(a5Var, f6Var2).h(document, 2, new d5(this, this.f941x0, f6Var2, 0));
                    if (h != null) {
                        h.f27305a = 1;
                        h.k(true);
                    }
    ...
    public final void G(CharacterStyle characterStyle, View view) {
        ...
        jc jcVar = this.f941x0;
        f6 f6Var = this.f943z0;
        if (z10) {
            TLRPC.User user = MessagesController.getInstance(f6Var.C2).getUser(Utilities.parseLong(((f61) characterStyle).getURL()));
            if (user != null) {
                MessagesController.getInstance(f6Var.C2).openChatOrProfileWith(user, null, jcVar.f1077f, 0, false);
            }
            ...
            if (b10 != null) {
                ...
                if (url.startsWith("@")) {
                    MessagesController.getInstance(f6Var.C2).openByUserName(lowerCase, jcVar.f1077f, 0, null);
                    return;
                } else {
            ...
            rk.o(R.string.TextCopied, new xc(f6Var.f800c1, this.f942y0));
    ...
    public final void H(final URLSpan uRLSpan, final View view, a3.d dVar) {
        ...
        org.telegram.ui.ActionBar.f6 f6Var = this.f942y0;
        ...
        final org.telegram.ui.ActionBar.f6 f6Var3 = this.f942y0;
        DialogInterface.OnClickListener onClickListener = new DialogInterface.OnClickListener() {
            ...
            public final void onClick(DialogInterface dialogInterface, int i10) {
                ...
                if (i10 == 0) {
                    ...
                    new xc(h5Var.f943z0.f800c1, f6Var3).k(false).j();
                }
            }
        };
        ...
        f3Var.fixNavigationBar(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19180h5, f6Var));
    ...
    public final void I(sa saVar) {
        ...
        final TLRPC.Document document = saVar.f1514g;
        f6 f6Var = this.f943z0;
        jc jcVar = this.f941x0;
        final org.telegram.ui.ActionBar.f6 f6Var2 = this.f942y0;
        if (document != null) {
                ...
                public final void run() {
                    ...
                    switch (r4) {
                        case 0:
                            ...
                            new xc(f6Var3.f800c1, f6Var2).Q(R.raw.saved_messages, 36, AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.StoryAudioAddToSavedMessagesToast), -1, 2, new f(25))).k(true);
                            return;
                        default:
                            f6 f6Var4 = this.f577b.f943z0;
                            ...
                            new xc(f6Var4.f800c1, f6Var2).Q(R.raw.ic_save_to_music, 36, LocaleController.getString(R.string.StoryAudioAddToProfileToast)).k(true);
                            return;
                    }
                }
            ...
            F.Z();
        } else if (saVar.e && saVar.f1511b != null && saVar.d != null) {
            Bundle bundle = new Bundle();
        ...
        } else if (saVar.f1511b != null && saVar.f1512c != null) {
            MessagesController.getInstance(f6Var.C2).getStoriesController().d0(saVar.f1511b.longValue(), saVar.f1512c.intValue(), new c5(this, saVar, jcVar, f6Var2, 0));
        } else {
            org.telegram.ui.Components.pc Q = new xc(f6Var.f800c1, f6Var2).Q(R.raw.error, 36, LocaleController.getString(R.string.StoryHidAccount));
            Q.f27305a = 3;
            Q.k(true);
        }
    }
    ...
    public final void M(int i10, String str, CharacterStyle characterStyle, boolean z10) {
        ...
        if (i10 != 0 && i10 != 2) {
            if (i10 == 1) {
                org.telegram.ui.Components.d5.r0(jcVar.f1077f, str, true, true, false, false, null, null, this.f942y0);
                return;
            }
            return;
        }
        if ((characterStyle instanceof e61) && (e11Var = ((e61) characterStyle).f23869a) != null && (e11Var.f23827a & 1024) != 0) {
            z11 = true;
        } else {
            z11 = false;
        }
        org.telegram.ui.Components.d5.r0(jcVar.f1077f, str, true, true, true, z11, null, null, this.f942y0);
    }
}
