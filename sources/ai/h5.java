...
public final class h5 extends xa {
        ...
        if (y5Var != null) {
            ...
            if (f6Var.Q1 != null) {
                ...
                if (document != null) {
                    ...
                    org.telegram.ui.Components.pc h = new xc(a5Var, f6Var2).h(document, 2, new d5(this, this.f944x0, f6Var2, 0));
                    if (h != null) {
                        h.f27246a = 1;
                        h.k(true);
                    }
    ...
    public final void G(CharacterStyle characterStyle, View view) {
        ...
        if (z10) {
            ...
            rk.o(R.string.TextCopied, new xc(f6Var.f803c1, this.f945y0));
        ...
        DialogInterface.OnClickListener onClickListener = new DialogInterface.OnClickListener() {
            ...
            public final void onClick(DialogInterface dialogInterface, int i10) {
                ...
                if (i10 == 0) {
                    ...
                    new xc(h5Var.f946z0.f803c1, f6Var3).k(false).j();
                }
            }
        };
    ...
    public final void I(sa saVar) {
        ...
        if (document != null) {
                ...
                public final void run() {
                    ...
                    switch (r4) {
                        case 0:
                            ...
                            new xc(f6Var3.f803c1, f6Var2).Q(R.raw.saved_messages, 36, AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.StoryAudioAddToSavedMessagesToast), -1, 2, new f(25))).k(true);
                            return;
                        default:
                            ...
                            new xc(f6Var4.f803c1, f6Var2).Q(R.raw.ic_save_to_music, 36, LocaleController.getString(R.string.StoryAudioAddToProfileToast)).k(true);
                            return;
                    }
                }
            ...
            org.telegram.ui.Components.pc Q = new xc(f6Var.f803c1, f6Var2).Q(R.raw.error, 36, LocaleController.getString(R.string.StoryHidAccount));
            Q.f27246a = 3;
            Q.k(true);
        }
    }
    ...
    public final void M(int i10, String str, CharacterStyle characterStyle, boolean z10) {
        ...
        if (i10 != 0 && i10 != 2) {
            if (i10 == 1) {
                org.telegram.ui.Components.d5.r0(jcVar.f1080f, str, true, true, false, false, null, null, this.f945y0);
                return;
            }
            return;
        }
        if ((characterStyle instanceof c61) && (c11Var = ((c61) characterStyle).f23179a) != null && (c11Var.f23124a & 1024) != 0) {
            z11 = true;
        } else {
            z11 = false;
        }
        org.telegram.ui.Components.d5.r0(jcVar.f1080f, str, true, true, true, z11, null, null, this.f945y0);
    }
}
