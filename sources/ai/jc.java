...
public final class jc implements NotificationCenter.NotificationCenterDelegate, org.telegram.ui.ActionBar.j2, rf.a {
    ...
    public static boolean f1061x1;
    public static TL_stories.StoryItem f1063z1;
    public d2 A0;
    public bc B0;
    ...
    public float Z;
    public boolean Z0;
    public boolean f1065a0;
    public boolean f1066a1;
    public float f1068b0;
    public final e5 f1069b1;
    public boolean f1071c0;
    public boolean f1072c1;
    public float f1073d0;
    public oa f1074d1;
    public float f1075e0;
    public final LongSparseIntArray f1076e1;
    public final org.telegram.ui.ActionBar.n2 f1077f;
    public boolean f1078f0;
    public boolean f1079f1;
    public boolean f1080g0;
    public boolean f1081g1;
    public int h;
    public boolean f1082h0;
    public boolean f1083h1;
    public GestureDetector f1084i0;
    public boolean f1085i1;
    public boolean f1086j0;
    public boolean f1087j1;
    public boolean f1088k0;
    public boolean f1089k1;
    public boolean f1090l0;
    public boolean l1;
    public boolean m0;
    public boolean f1091m1;
    public WindowManager f1092n;
    public zb f1093n0;
    public a3.d f1094n1;
    public e5 f1096o1;
    public int f1097p0;
    public boolean f1098p1;
    public boolean f1099q0;
    public float f1100q1;
    public WindowManager.LayoutParams f1101r;
    public float f1102r0;
    public boolean f1103r1;
    public xb f1104s;
    public final gc f1105s0;
    public boolean f1106s1;
    public fc f1107t0;
    public long f1108t1;
    public Dialog f1109u0;
    public p9 f1110u1;
    public yb v;
    public org.telegram.ui.ActionBar.j2 f1111v0;
    public ValueAnimator f1112v1;
    public r7 f1113w;
    public boolean f1114w0;
    public boolean f1115w1;
    public boolean f1116x;
    public final ArrayList f1117x0;
    public org.telegram.ui.k4 f1119y0;
    public ic f1120z0;
    public static final ArrayList f1062y1 = new ArrayList();
    public static float B1 = 1.0f;
    public static boolean C1 = true;
    public static final LongSparseArray E1 = new LongSparseArray();
    public boolean f1064a = SharedConfig.useSurfaceInStories;
    public boolean f1067b = true;
    public boolean f1070c = false;
    public boolean d = false;
    public boolean e = true;
    public final d f1118y = new d();
    public final RectF T = new RectF();
    public final float[] f1095o0 = new float[2];

    public jc(org.telegram.ui.ActionBar.n2 n2Var) {
        ?? obj = new Object();
        obj.f919k = 1.0f;
        this.f1105s0 = obj;
        this.f1117x0 = new ArrayList();
        this.H0 = true;
        this.J0 = new AnimationNotificationsLocker();
        this.M0 = new ArrayList();
        this.Z0 = false;
        this.f1069b1 = new e5(this, 4);
        this.f1076e1 = new LongSparseIntArray();
        new Paint(1);
        this.f1077f = n2Var;
    }
    ...
    public static void J(long j3, TL_stories.StoryItem storyItem, Editable editable) {
        if (j3 != 0 && storyItem != null) {
            E1.put(j3 + (j3 >> 16) + (storyItem.f18344id << 16), editable);
        }
    }
    ...
    public static boolean i(jc jcVar, xb xbVar, float f7, float f10, boolean z10) {
        ...
        if (xbVar != null) {
            if (!jcVar.X0) {
                if (jcVar.f1113w == null || jcVar.f1075e0 == 0.0f) {
                    f6 currentPeerView = jcVar.f1093n0.getCurrentPeerView();
                    if (currentPeerView != null) {
                        if (!currentPeerView.G0(currentPeerView, ((f7 - jcVar.v.getX()) - jcVar.f1093n0.getX()) - currentPeerView.getX(), ((f10 - jcVar.v.getY()) - jcVar.f1093n0.getY()) - currentPeerView.getY(), z10)) {
                            if (currentPeerView.f858v2) {
                                return false;
                            }
                        } else {
                            return true;
                    ...
                    if (currentPeerView != null && (a4Var2 = currentPeerView.f797b2) != null && a4Var2.getVisibility() == 0) {
                        if (f10 > currentPeerView.f797b2.getY() + currentPeerView.getY() + jcVar.f1093n0.getY() + jcVar.v.getY()) {
                            return true;
                        }
                    }
                    if ((currentPeerView != null && (a4Var = currentPeerView.f797b2) != null && a4Var.x0()) || jcVar.f1110u1 != null) {
                        return true;
                    }
    ...
    public static void j(jc jcVar) {
        ...
        bu editField;
        f6 currentPeerView = jcVar.f1093n0.getCurrentPeerView();
        if (currentPeerView != null && currentPeerView.f797b2 != null && (((p4Var = currentPeerView.f798b3) == null || p4Var.getVisibility() != 0) && (editField = currentPeerView.f797b2.getEditField()) != null)) {
    ...
    public static void k(jc jcVar) {
        ...
        if (jcVar.V != clamp01) {
            ...
            jcVar.o();
            f6 currentPeerView = jcVar.f1093n0.getCurrentPeerView();
            if (currentPeerView != null && currentPeerView.f866x2) {
    ...
    public static CharSequence u(long j3, TL_stories.StoryItem storyItem) {
        ...
        return (CharSequence) E1.get(j3 + (j3 >> 16) + (storyItem.f18344id << 16), "");
    }

    public static boolean x(MessageObject messageObject) {
        if (f1063z1 == null || ((messageObject.type != 23 && !messageObject.isWebpage()) || A1 || f1063z1.messageId != messageObject.getId() || f1063z1.messageType == 3)) {
            return false;
        }
        return true;
    }
    ...
    public final void B(int i10, Context context, TL_stories.StoryItem storyItem, ArrayList arrayList, int i11, d9 d9Var, TL_stories.PeerStories peerStories, fc fcVar, boolean z10) {
        ...
        ArrayList arrayList2 = this.f1117x0;
        if (!isContextSafe) {
            arrayList2.clear();
            return;
        }
        ...
        B1 = 1.0f;
        ic icVar = this.f1120z0;
        if (icVar != null) {
            icVar.setSpeed(1.0f);
        }
        boolean z15 = false;
        if (!AndroidUtilities.isTablet() && !this.f1103r1) {
            z11 = true;
        } else {
            z11 = false;
        }
        ...
        this.Z0 = false;
        this.f1076e1.clear();
        AndroidUtilities.cancelRunOnUIThread(this.f1069b1);
        WindowManager.LayoutParams layoutParams = new WindowManager.LayoutParams();
        this.f1101r = layoutParams;
        ...
        this.f1101r.flags = -2147417728;
        this.H0 = false;
        this.f1072c1 = false;
        org.telegram.ui.ActionBar.n2 R = LaunchActivity.R();
        if (this.f1104s == null) {
            this.f1084i0 = new GestureDetector(new tb(this));
            this.f1104s = new xb(this, context, R);
        }
        if (this.v == null) {
            this.v = new yb(this, context);
            zb zbVar2 = new zb(this, this.h, context, this, this.f1118y);
            this.f1093n0 = zbVar2;
            zbVar2.setDelegate(new ac(this, d9Var, arrayList, context));
            this.v.addView(this.f1093n0, w7.x5.e(-1, -1, 1));
            this.f1119y0 = new org.telegram.ui.k4(context);
            if (this.f1064a) {
                SurfaceView surfaceView = new SurfaceView(context);
                this.C0 = surfaceView;
                surfaceView.setZOrderMediaOverlay(false);
                this.C0.setZOrderOnTop(false);
                this.f1119y0.addView(this.C0);
            } else {
                bc bcVar = new bc(this, context);
                this.B0 = bcVar;
                this.f1119y0.addView(bcVar);
            }
            ci.l4 l4Var = new ci.l4(context, this.h);
            this.D0 = l4Var;
            l4Var.setVisibility(8);
            this.f1119y0.addView(this.D0);
            ?? view = new View(context);
            Paint paint = new Paint(1);
            view.f1362a = paint;
            view.f1364c = new q4((Object) view, 2);
        ...
        AndroidUtilities.removeFromParent(this.f1119y0);
        this.f1104s.addView(this.f1119y0);
        SurfaceView surfaceView2 = this.C0;
        if (surfaceView2 != null) {
            surfaceView2.setVisibility(4);
        }
        AndroidUtilities.removeFromParent(this.v);
        this.f1104s.addView(this.v);
        this.f1104s.setClipChildren(false);
        if (this.N0) {
            Q();
        }
        if (d9Var != null) {
            this.f1093n0.D(this.h, d9Var.d, d9Var.h());
        } else {
            zb zbVar3 = this.f1093n0;
            int i13 = this.h;
            zbVar3.A0 = arrayList;
            zbVar3.f1306y0 = i13;
            zbVar3.setAdapter(null);
            zbVar3.setAdapter(zbVar3.f1307z0);
            zbVar3.setCurrentItem(i11);
            zbVar3.C0 = true;
        }
        this.f1092n = (WindowManager) context.getSystemService("window");
        if (R == null || R.getLayoutContainer() == null || R.isSupportEdgeToEdge()) {
            this.f1067b = false;
        }
        if (this.f1067b && R != null && R.isSupportEdgeToEdge()) {
            z14 = true;
        } else {
            z14 = false;
        }
        ...
        r0.a0.j(ybVar, cVar);
        if (this.f1067b) {
            AndroidUtilities.removeFromParent(this.f1104s);
            this.f1104s.setTag(R.id.sheet_attached_to_fragment_tag, new Object());
            R.getLayoutContainer().addView(this.f1104s);
            if (!this.f1070c) {
                AndroidUtilities.requestAdjustResize(R.getParentActivity(), R.getClassGuid());
            }
        } else {
            this.f1104s.setFocusable(false);
            this.v.setFocusable(false);
            this.v.setSystemUiVisibility(1792);
            AndroidUtilities.setPreferredMaxRefreshRate(this.f1092n, this.f1104s, this.f1101r);
            this.f1092n.addView(this.f1104s, this.f1101r);
            if (Build.VERSION.SDK_INT >= 33 && (findOnBackInvokedDispatcher = this.f1104s.findOnBackInvokedDispatcher()) != null) {
                findOnBackInvokedDispatcher.registerOnBackInvokedCallback(0, new rb(this, 0));
            }
        }
        this.f1104s.requestLayout();
        A1 = true;
        Q();
        this.U = 0.0f;
        o();
        ...
        if (C1) {
            C1 = false;
            if (((AudioManager) this.f1104s.getContext().getSystemService("audio")).getRingerMode() != 2) {
                z15 = true;
            }
            D1 = z15;
        }
    ...
    public final void D(Context context, long j3, fc fcVar) {
        ...
        int i10 = storiesController.f1190a;
        ...
        if (y3 != null) {
            ...
            if (y3.stories.isEmpty() && !storiesController.J(j3)) {
                storiesController.f1194g.remove(y3);
    ...
    public final void I() {
        ...
        arrayList.clear();
        a0.i iVar = MessagesController.getInstance(this.h).getStoriesController().f1199m;
        ...
        org.telegram.ui.ActionBar.n2 n2Var = this.f1077f;
        if (n2Var != null) {
    ...
    public final void L(boolean z10) {
        ...
        if (this.f1066a1 != z10) {
            this.f1066a1 = z10;
            if (z10 && !this.f1079f1 && (currentPeerView2 = this.f1093n0.getCurrentPeerView()) != null && (d6Var = currentPeerView2.O1) != null && !d6Var.f706f && d6Var.f704b == null) {
                if (!this.f1088k0 && !this.f1086j0 && (e6Var = this.G0) != null && ((ic) e6Var.f763c) != null) {
                    currentPeerView2.f800c1.invalidate();
                    BotWebViewVibrationEffect.IMPACT_LIGHT.vibrate();
                }
                e6 e6Var2 = this.G0;
                if (e6Var2 != null && (icVar = (ic) e6Var2.f763c) != null && !this.f1088k0) {
            ...
            if (zbVar != null && (currentPeerView = zbVar.getCurrentPeerView()) != null) {
                currentPeerView.setLongpressed(this.f1066a1);
            }
        }
    }
    ...
    public final void M(boolean z10) {
        ...
        if (this.f1067b && launchActivity != null) {
            if (z10) {
                this.f1114w0 = AndroidUtilities.getLightNavigationBar(launchActivity.getWindow());
            }
            if (this.f1114w0) {
    ...
    public final void N() {
        ...
        if (this.A0 != null && (n2Var = this.f1077f) != null && this.D0 != null) {
    ...
    public final void O() {
        ...
        f6 currentPeerView = this.f1093n0.getCurrentPeerView();
        if (currentPeerView != null) {
            currentPeerView.f865x1.a(D1, true);
        }
        if (!D1) {
            this.f1074d1.b();
        }
    ...
    public final void P() {
        ...
        this.f1093n0.D0 = (this.f1116x || this.H0 || this.I0 || this.f1066a1 || this.f1079f1 || this.f1075e0 != 0.0f || this.f1087j1) ? false : false;
    }
    ...
    public final void a(com.google.android.gms.internal.cast.p pVar) {
        ...
        if (this.f1067b) {
            ...
            this.f1092n.removeView(this.f1104s);
        }
        this.f1104s.invalidate();
    }

    @Override
    public final boolean attachedToParent() {
        if (this.f1067b && this.f1104s != null) {
            return true;
        }
        return false;
    }
    ...
    public final void b(com.google.android.gms.internal.cast.p pVar) {
        ...
        if (this.f1067b) {
            AndroidUtilities.removeFromParent(this.f1104s);
            this.f1077f.getLayoutContainer().addView(this.f1104s);
        } else {
            this.f1092n.addView(this.f1104s, this.f1101r);
        }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.storiesListUpdated) {
            if (this.O0 == ((d9) objArr[0])) {
                ...
                r7 r7Var = this.f1113w;
                if (r7Var != null) {
                    TL_stories.StoryItem selectedStory = r7Var.getSelectedStory();
                    ArrayList arrayList2 = new ArrayList();
                    int i13 = 0;
                    while (i12 < this.O0.f718i.size()) {
                        if (selectedStory != null && selectedStory.f18344id == ((MessageObject) this.O0.f718i.get(i12)).storyItem.f18344id) {
                            i13 = i12;
                        }
                        arrayList2.add(((MessageObject) this.O0.f718i.get(i12)).storyItem);
                        i12++;
                    }
                    this.f1113w.b(i13, this.O0.d, arrayList2);
                }
            }
        } else if (i10 == NotificationCenter.storiesUpdated) {
            fc fcVar = this.f1107t0;
            if (fcVar instanceof u9) {
                ...
                if (u9Var.f1588r && !u9Var.f1587n) {
                    ...
                    ArrayList<Long> dialogIds = this.f1093n0.getDialogIds();
                    boolean z10 = false;
                    ...
                    if (z10) {
                        this.f1093n0.getAdapter().g();
                    }
                } else {
                    return;
                }
            }
            r7 r7Var2 = this.f1113w;
            if (r7Var2 != null) {
            ...
            if (i10 != i15 && i10 != NotificationCenter.articleClosed) {
                if (i10 == NotificationCenter.storyDeleted) {
                    ...
                    if (storyItem != null && storyItem.dialogId == longValue && storyItem.f18344id == intValue) {
                        this.S0 = true;
                        return;
                    }
                    return;
            ...
            if (i10 == i15) {
                ic icVar = this.f1120z0;
                if (icVar != null) {
                    this.f1108t1 = icVar.currentPosition;
                    this.f1120z0.release(null);
                    this.f1120z0 = null;
                    return;
                }
                this.f1108t1 = 0L;
            } else if (!this.f1106s1 && t() != null) {
                t().f1(false);
            }
        }
    }
    ...
    public final void l(boolean z10) {
        ...
        if (!BuildVars.DEBUG_PRIVATE_VERSION) {
            ...
            if (this.e != z11) {
                ...
                if (z11) {
                    this.f1101r.flags &= -8193;
                    AndroidUtilities.logFlagSecure();
                } else {
                    this.f1101r.flags |= 8192;
                    AndroidUtilities.logFlagSecure();
                }
                try {
                    this.f1092n.updateViewLayout(this.f1104s, this.f1101r);
                } catch (Exception e) {
                    FileLog.e(e);
                }
            }
    ...
    public final void m() {
        if (this.H == null) {
            ...
            this.H.setInterpolator(org.telegram.ui.ActionBar.p1.f19476w);
            this.H.start();
        }
    }

    public final void n(boolean z10) {
        if (this.f1112v1 == null) {
            if (this.f1097p0 != 0) {
                AndroidUtilities.hideKeyboard(this.f1113w);
                return;
            }
            float f7 = 0.0f;
            if (!this.f1071c0 && this.f1075e0 == 0.0f) {
                return;
            }
            this.J0.lock();
            if (!z10) {
                float f10 = this.f1075e0;
                r7 r7Var = this.f1113w;
                float f11 = r7Var.f1470c;
                if (f10 == f11) {
                    float f12 = f11 - 1.0f;
                    this.f1075e0 = f12;
                    r7Var.setOffset(f12);
            ...
            float f13 = this.f1075e0;
            if (z10) {
                f7 = this.f1113w.f1470c;
            }
            ValueAnimator ofFloat = ValueAnimator.ofFloat(f13, f7);
            this.f1112v1 = ofFloat;
            ofFloat.addUpdateListener(new qb(this, 3));
            this.f1112v1.addListener(new n(3, this, z10));
            if (z10) {
                this.f1112v1.setDuration(350L);
                this.f1112v1.setInterpolator(qr.h);
            } else {
                this.f1112v1.setDuration(350L);
                this.f1112v1.setInterpolator(qr.f27420f);
            }
            this.f1112v1.start();
        }
    }
    ...
    public final void o() {
        ...
        if (this.f1067b && (launchActivity = LaunchActivity.G1) != null) {
    ...
    public final boolean onAttachedBackPressed() {
        ...
        if (this.f1075e0 != 0.0f) {
            ...
            if (currentPage != null) {
                p6 p6Var = currentPage.f1049r;
                x6 x6Var = currentPage.f1047f;
                if (x6Var != null && x6Var.f30043b) {
                    x6Var.a();
                    return true;
                } else if (Math.abs(currentPage.f1046c.getTranslationY() - p6Var.getPaddingTop()) > AndroidUtilities.dp(2.0f)) {
    ...
    public final void p() {
        ...
        if (currentPeerView != null) {
            if (this.O0 != null) {
                ArrayList arrayList = new ArrayList();
                for (int i10 = 0; i10 < this.O0.f718i.size(); i10++) {
                    arrayList.add(((MessageObject) this.O0.f718i.get(i10)).storyItem);
                }
                this.f1113w.b(currentPeerView.getListPosition(), this.O0.d, arrayList);
                return;
            }
            this.f1113w.b(currentPeerView.getSelectedPosition(), currentPeerView.getCurrentPeer(), currentPeerView.getStoryItems());
        }
    }

    public final void q(boolean z10) {
        AndroidUtilities.hideKeyboard(this.f1104s);
        this.H0 = true;
        this.f1083h1 = true;
        P();
        M(false);
    ...
    public final void r(KeyEvent keyEvent) {
        ...
        this.f1074d1.onKeyDown(keyEvent.getKeyCode(), keyEvent);
    }

    public final void s(Runnable runnable) {
        if (runnable != null) {
            this.f1117x0.add(runnable);
        }
    }
    ...
    public final void setKeyboardHeightFromParent(int i10) {
        if (this.f1097p0 != i10) {
            this.f1097p0 = i10;
            this.f1093n0.setKeyboardHeight(i10);
            this.f1093n0.requestLayout();
            r7 r7Var = this.f1113w;
            if (r7Var != null) {
    ...
    public final boolean w() {
        org.telegram.ui.ActionBar.n2 n2Var;
        if (!this.X0 && !this.Z0 && !this.Y0 && !this.L0 && !this.f1099q0 && !this.f1116x && this.f1109u0 == null && this.f1111v0 == null && !this.H0 && !this.I0 && this.U == 1.0f && this.f1075e0 == 0.0f && !this.f1085i1) {
            if ((!this.l1 || !this.f1064a) && !this.f1089k1 && !this.f1087j1 && !this.f1098p1 && this.V == 0.0f && this.f1110u1 == null) {
                if (!this.f1067b || (n2Var = this.f1077f) == null || n2Var.getLastStoryViewer() == this) {
                    return false;
                }
                return true;
            }
    ...
    public final void z(boolean z10) {
        int i10;
        Activity findActivity = AndroidUtilities.findActivity(this.f1077f.getContext());
