...
public final class h4 implements ti {
    ...
    public final void B1(int i10, boolean z10, boolean z11, int i11, int i12, long j3, boolean z12, boolean z13, long j10) {
        ...
        String str2;
        f6 f6Var = this.f938a;
        if (f6Var.J0.m0 && (storyItem = f6Var.O1.f701a) != null && !(storyItem instanceof TL_stories.TL_storyItemSkipped)) {
            if (i10 != 8 && i10 != 7 && (i10 != 4 || f6Var.I2.f28762j0.getSelectedPhotos().isEmpty())) {
                g4 g4Var = f6Var.I2;
                if (g4Var != null) {
            ...
            HashMap<Object, Object> selectedPhotos = f6Var.I2.f28762j0.getSelectedPhotos();
            ArrayList<Object> selectedPhotosOrder = f6Var.I2.f28762j0.getSelectedPhotosOrder();
            if (!selectedPhotos.isEmpty()) {
                ...
                while (i14 < Math.ceil(selectedPhotos.size() / 10.0f)) {
                    ...
                    SendMessagesHelper.prepareSendingMedia(accountInstance, arrayList, j11, null, null, storyItem, null, z16, z10, null, z11, i11, i12, 0, z15, null, null, 0L, false, 0L, f6Var.f795b2.getSendMonoForumPeerId(), f6Var.f795b2.getSendMessageSuggestionParams());
                    i14++;
                    selectedPhotos = hashMap;
                    selectedPhotosOrder = arrayList2;
                    i13 = 0;
                }
                f6Var.f795b2.setFieldText("");
                if (j10 <= 0) {
                    z14 = true;
                } else {
                    z14 = false;
    ...
    public final void W1(ArrayList arrayList, CharSequence charSequence, boolean z10, int i10, int i11, long j3, boolean z11, long j10) {
        ...
        boolean z12;
        f6 f6Var = this.f938a;
        TL_stories.StoryItem storyItem = f6Var.O1.f701a;
    ...
    public final boolean c0() {
        return this.f938a.N0();
    }

    @Override
    public final void x0(fh fhVar) {
        NotificationCenter.getInstance(this.f938a.C2).doOnIdle(fhVar);
    }
