...
public final class db extends View {
    ...
    public db(Context context, int i10, TLObject tLObject, Object obj, boolean z10, ArrayList arrayList, org.telegram.ui.ActionBar.d6 d6Var) {
        ...
        s90Var.e(org.telegram.ui.ActionBar.h6.l1(0.2f, -1), org.telegram.ui.ActionBar.h6.l1(0.05f, -1));
        Path path = new Path();
        this.f749n = path;
        s90Var.f28221x = path;
        s90Var.j(4.0f);
    ...
    private void set(TLRPC.TL_messages_stickerSet tL_messages_stickerSet) {
        ...
        spannableString.setSpan(new ForegroundColorSpan(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.gc, this.h.f28202a)), 0, spannableString.length(), 33);
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (f7 < 1.0f) {
            s90 s90Var = this.h;
            s90Var.setAlpha((int) ((1.0f - f7) * 255.0f));
    ...
    private void set(int i10) {
        ...
        s90 s90Var = this.h;
        if (z10 && this.f752w) {
            setText(AndroidUtilities.replaceSingleTag(LocaleController.formatPluralString("StoryContainsStickersEmoji", i10, new Object[0]), 0, org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.gc, s90Var.f28202a), null));
        } else if (z10) {
            setText(AndroidUtilities.replaceSingleTag(LocaleController.formatPluralString("StoryContainsEmoji", i10, new Object[0]), 0, org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.gc, s90Var.f28202a), null));
        } else {
            setText(AndroidUtilities.replaceSingleTag(LocaleController.formatPluralString("StoryContainsStickers", i10, new Object[0]), 0, org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.gc, s90Var.f28202a), null));
        }
    }
}
