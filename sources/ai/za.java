    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        switch (i10) {
            ...
            case 3:
                ...
                if (tL_error == null) {
                    AndroidUtilities.runOnUIThread(new ei.l3(sharedPreferences, (TLRPC.TL_help_support) tLObject, b2Var, this.f1795b, n2Var, 20));
                    return;
                } else {
            ...
            case 4:
                AndroidUtilities.runOnUIThread(new ei.l3((fs) obj3, tLObject, (TLRPC.InputPeer) obj2, this.f1795b, (int[]) obj, 21));
                return;
            case 5:
                yu0 yu0Var = (yu0) obj3;
            ...
            case 6:
                ...
                AndroidUtilities.runOnUIThread(new ei.l3((LaunchActivity) obj3, tLObject, (Uri) obj2, this.f1795b, (org.telegram.ui.ActionBar.b2) obj, 23), 2L);
                return;
            case 7:
                qi0 qi0Var = (qi0) obj3;
