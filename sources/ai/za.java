...
public final class za implements RequestDelegate {
    ...
    public za(int i10, qi0 qi0Var, org.telegram.ui.ActionBar.n2 n2Var, TLRPC.TL_payments_assignPlayMarketTransaction tL_payments_assignPlayMarketTransaction) {
        this.f1792a = 7;
        this.f1793b = i10;
        this.f1794c = qi0Var;
        this.d = n2Var;
        ...
        switch (i10) {
            case 0:
                ...
                if (tL_error != null && FileRefController.isFileRefError(tL_error.text) && obj3 != null) {
                    FileRefController.getInstance(this.f1793b).requestReference(obj3, tL_messages_getAttachedStickers, yaVar);
                    return;
                } else {
            ...
            case 1:
                AndroidUtilities.runOnUIThread(new ei.l3(tLObject, (boolean[]) obj3, (Utilities.Callback) obj2, this.f1793b, (TL_account.updateEmojiStatus) obj, 1));
                return;
            case 2:
                AndroidUtilities.runOnUIThread(new cb((u70) obj3, (org.telegram.ui.f4) obj2, tL_error, tLObject, this.f1793b, (org.telegram.ui.c1) obj));
                return;
            case 3:
                ...
                if (tL_error == null) {
                    AndroidUtilities.runOnUIThread(new ei.l3(sharedPreferences, (TLRPC.TL_help_support) tLObject, b2Var, this.f1793b, n2Var, 20));
                    return;
                } else {
            ...
            case 4:
                AndroidUtilities.runOnUIThread(new ei.l3((fs) obj3, tLObject, (TLRPC.InputPeer) obj2, this.f1793b, (int[]) obj, 21));
                return;
            case 5:
                yu0 yu0Var = (yu0) obj3;
            ...
            case 6:
                ...
                AndroidUtilities.runOnUIThread(new ei.l3((LaunchActivity) obj3, tLObject, (Uri) obj2, this.f1793b, (org.telegram.ui.ActionBar.b2) obj, 23), 2L);
                return;
            case 7:
                qi0 qi0Var = (qi0) obj3;
            ...
            default:
                AndroidUtilities.runOnUIThread(new cb((org.telegram.ui.web.d1) obj3, tLObject, this.f1793b, (org.telegram.ui.web.z0) obj2, (da) obj, tL_error));
                return;
        }
    }
