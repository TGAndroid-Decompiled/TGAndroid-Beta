...
public final class za implements RequestDelegate {
    ...
    public za(int i10, li0 li0Var, org.telegram.ui.ActionBar.n2 n2Var, TLRPC.TL_payments_assignPlayMarketTransaction tL_payments_assignPlayMarketTransaction) {
        this.f1789a = 7;
        this.f1790b = i10;
        this.f1791c = li0Var;
        this.d = n2Var;
    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        switch (i10) {
            ...
            case 1:
                ...
                return;
            case 2:
                AndroidUtilities.runOnUIThread(new cb((r70) obj3, (org.telegram.ui.g4) obj2, tL_error, tLObject, this.f1790b, (org.telegram.ui.d1) obj));
                return;
            case 3:
                ...
                if (tL_error == null) {
                    AndroidUtilities.runOnUIThread(new ei.l3(sharedPreferences, (TLRPC.TL_help_support) tLObject, b2Var, this.f1790b, n2Var, 21));
                    return;
                } else {
            ...
            case 6:
                ...
                AndroidUtilities.runOnUIThread(new ei.l3((LaunchActivity) obj3, tLObject, (Uri) obj2, this.f1790b, (org.telegram.ui.ActionBar.b2) obj, 24), 2L);
                return;
            case 7:
                li0 li0Var = (li0) obj3;
