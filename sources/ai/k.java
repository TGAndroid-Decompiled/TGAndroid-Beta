...
public final class k implements t9, uh1, m4.f1, org.telegram.ui.ActionBar.a2, yf.m, MessagesController.ErrorDelegate, vh.l {
    ...
    public void a(int i10, ArrayList arrayList) {
        switch (this.f1119a) {
            case 1:
                hg.a0 a0Var = (hg.a0) this.f1121c;
                ArrayList arrayList2 = a0Var.f10211k;
                ArrayList arrayList3 = a0Var.f10210j;
                int i11 = 0;
                if (this.f1120b) {
                    a0Var.f10207f = i10;
                    arrayList3.clear();
    ...
    public void b(boolean z10) {
        b0 b0Var = (b0) this.f1121c;
        if (!this.f1120b && z10) {
            boolean z11 = true;
            if (b0Var.f537b != 1) {
                z11 = false;
            }
            l9 l9Var = b0Var.f558s;
            if (z11) {
                if (!l9Var.f1209z) {
                    return;
                }
    ...
    public void e(long j3) {
        org.telegram.ui.Components.m6 m6Var = ((org.telegram.ui.Cells.t1) this.f1121c).f21290w4;
        if (m6Var != null) {
            m6Var.q(LocaleController.formatPollEndTime((int) j3, this.f1120b), true, true);
        }
    }
    ...
    public void f(org.telegram.ui.ActionBar.b2 b2Var, int i10) {
        ...
        switch (this.f1119a) {
            case 4:
                org.telegram.ui.z6.V((org.telegram.ui.z6) this.f1121c, this.f1120b);
                return;
            case 5:
            default:
                i60 i60Var = ((l50) this.f1121c).f35341b;
                i60Var.f34410a1.toggleRecord(null, 0);
            ...
            case 6:
                ...
                return;
            case 7:
                Activity activity = (Activity) this.f1121c;
                if (activity != null && Build.VERSION.SDK_INT >= 23) {
                    if (this.f1120b && sf.c.a(activity) == -2) {
                        try {
    ...
    public Object h(m4.a0 a0Var, m4.r rVar, int i10) {
        ...
        switch (this.f1119a) {
            case 2:
                e9.a1 z10 = e9.i0.z((b2.k0) this.f1121c);
                boolean z11 = this.f1120b;
                if (z11) {
                    l02 = -1;
                } else {
                    l02 = a0Var.f14466t.l0();
                }
                if (z11) {
            ...
            default:
                List list = (List) this.f1121c;
                boolean z12 = this.f1120b;
                if (z12) {
                    l03 = -1;
                } else {
                    l03 = a0Var.f14466t.l0();
                }
                if (z12) {
                    J02 = -9223372036854775807L;
                } else {
                    J02 = a0Var.f14466t.J0();
                }
    ...
    public void j(vh.h hVar, float f7, float f10) {
        vh.o oVar = (vh.o) this.f1121c;
        if (!oVar.d && this.f1120b) {
            hVar.f44417q = new vh.n(oVar, 0);
            float sqrt = (float) Math.sqrt(Math.pow(oVar.getHeight(), 2.0d) + Math.pow(oVar.getWidth(), 2.0d));
            ArrayList arrayList = oVar.f44452b;
    ...
    public boolean run(TLRPC.TL_error tL_error) {
        g80 g80Var = (g80) this.f1121c;
        if (tL_error != null && "INVITE_REQUEST_SENT".equals(tL_error.text)) {
            g80Var.setOnDismissListener(new b80(0, g80Var, this.f1120b));
        }
        g80Var.dismiss();
        return false;
    }
