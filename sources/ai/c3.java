...
public final class c3 implements Runnable {
    ...
    public final void run() {
        ...
        switch (this.f617a) {
            case 0:
                this.f618b.f822j2.setVisibility(8);
                return;
            case 1:
                f6 f6Var = this.f618b;
                if (!f6Var.J0.H0) {
            ...
            case 2:
                ...
                return;
            case 3:
                ((ac) this.f618b.Q1).b(true);
                return;
            case 4:
                this.f618b.r0(true);
                return;
            case 5:
                jc jcVar = this.f618b.J0;
                if (jcVar != null) {
            ...
            case 8:
                ...
                return;
            case 9:
                jc jcVar3 = ((ac) this.f618b.Q1).d;
                jcVar3.f1083i1 = false;
                jcVar3.P();
                return;
            case 10:
                this.f618b.L0(null);
