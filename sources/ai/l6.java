        ...
        switch (this.f1184a) {
            ...
            case 9:
                ...
                if (j81Var.f25189x) {
                    ...
                    z71 z71Var = j81Var.M;
                    if (z71Var != null) {
                        z71Var.e(abs, j81Var.d, j81Var.f25182b);
                    }
                }
                j81Var.x(false);
                return;
            case 10:
                ...
                u1Var.J = floatValue;
                org.telegram.ui.Components.voip.t1 t1Var = u1Var.f29270i0;
                if (t1Var != null) {
                    ((bi1) t1Var).f32192b.f37770d0.d(floatValue, u1Var.P);
                }
                u1Var.invalidate();
                return;
            case 11:
                rg.p0 p0Var = (rg.p0) this.f1185b;
                p0Var.f42452n = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                p0Var.e();
                return;
            case 12:
                ...
                return;
            default:
                ((s4.u) this.f1185b).f42827x = valueAnimator.getAnimatedFraction();
                return;
        }
    }
}
