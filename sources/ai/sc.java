...
public class sc {
    public static long f1530g;
    public final l9 f1531a;
    public final int f1532b;
    public final long f1533c;
    public int d;
    public boolean e;
    public final a3.d f1534f = new a3.d(this, 24);
    ...
    public void a(ArrayList arrayList) {
        TL_stories.PeerStories y3 = this.f1531a.y(this.f1533c);
        if (y3 != null && y3.stories != null) {
            int i10 = 0;
            while (i10 < y3.stories.size()) {
                i10 = com.google.android.gms.internal.vision.e2.e(y3.stories.get(i10).f18348id, i10, 1, arrayList);
            }
        }
    }
    ...
    public final void b(boolean z10) {
        ...
        this.e = false;
        AndroidUtilities.cancelRunOnUIThread(this.f1534f);
        ConnectionsManager.getInstance(this.f1532b).cancelRequest(this.d, false);
        this.d = 0;
    }
    ...
    public final void c() {
        ...
        long currentTimeMillis = 10000 - (System.currentTimeMillis() - f1530g);
        if (currentTimeMillis > 0) {
            a3.d dVar = this.f1534f;
        ...
        if (this.d == 0) {
            ...
            a(tL_stories_getStoriesViews.f18356id);
            if (!tL_stories_getStoriesViews.f18356id.isEmpty()) {
                int i10 = this.f1532b;
                tL_stories_getStoriesViews.peer = MessagesController.getInstance(i10).getInputPeer(this.f1533c);
            ...
            if (y3 != null && !y3.stories.isEmpty()) {
                for (int i10 = 0; i10 < tL_stories_storyViews.views.size(); i10++) {
                    for (int i11 = 0; i11 < y3.stories.size(); i11++) {
                        if (y3.stories.get(i11).f18348id == ((Integer) arrayList.get(i10)).intValue()) {
                            y3.stories.get(i11).views = tL_stories_storyViews.views.get(i10);
                        }
                    }
                }
                y9 y9Var = l9Var.f1195k;
                y9Var.f1763b.getStorageQueue().postRunnable(new v9(y9Var, y3, 1));
                return true;
            }
        }
        return false;
