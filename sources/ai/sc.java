...
public class sc {
    ...
    public void a(ArrayList arrayList) {
        ...
        if (y3 != null && y3.stories != null) {
            ...
            while (i10 < y3.stories.size()) {
                i10 = com.google.android.gms.internal.vision.e2.e(y3.stories.get(i10).f18556id, i10, 1, arrayList);
            }
        }
    }
    ...
    public final void c() {
        ...
        if (this.d == 0) {
            ...
            a(tL_stories_getStoriesViews.f18564id);
            if (!tL_stories_getStoriesViews.f18564id.isEmpty()) {
                int i10 = this.f1536b;
            ...
            if (y3 != null && !y3.stories.isEmpty()) {
                for (int i10 = 0; i10 < tL_stories_storyViews.views.size(); i10++) {
                    for (int i11 = 0; i11 < y3.stories.size(); i11++) {
                        if (y3.stories.get(i11).f18556id == ((Integer) arrayList.get(i10)).intValue()) {
