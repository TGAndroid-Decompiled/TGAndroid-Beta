...
public final class y3 extends org.telegram.ui.ActionBar.n2 {
    ...
    public Context getContext() {
        switch (this.f1748a) {
            ...
            case 4:
                return ((hu) this.f1749b).f24759a.getContext();
            case 12:
    ...
    public int getCurrentAccount() {
        switch (this.f1748a) {
            ...
            case 5:
                return this.currentAccount;
            case 6:
                return ((cy) this.f1749b).E.f25898c1;
            case 9:
                return this.currentAccount;
            case 12:
                return this.currentAccount;
    ...
    public View getFragmentView() {
        ...
        switch (this.f1748a) {
            case 5:
                viewGroup = ((org.telegram.ui.ActionBar.f3) ((ov) this.f1749b).f27053x).containerView;
                return viewGroup;
            case 6:
                return ((cy) this.f1749b).E.f25942r;
            case 7:
            case 8:
            default:
    ...
    public Activity getParentActivity() {
        switch (this.f1748a) {
            ...
            case 9:
                org.telegram.ui.ActionBar.n2 n2Var = ((rg.k1) this.f1749b).f42660t0;
                if (n2Var == null) {
                    return null;
                }
    ...
    public org.telegram.ui.ActionBar.f6 getResourceProvider() {
        ...
        switch (this.f1748a) {
            ...
            case 2:
                f6Var = ((org.telegram.ui.ActionBar.f3) ((ci.z5) this.f1749b)).resourcesProvider;
            ...
            case 5:
                f6Var2 = ((org.telegram.ui.ActionBar.f3) ((ov) this.f1749b).f27053x).resourcesProvider;
                return f6Var2;
            case 6:
            ...
            case 11:
                f6Var3 = ((org.telegram.ui.ActionBar.f3) ((xh.z4) this.f1749b)).resourcesProvider;
                return f6Var3;
        }
    }
    ...
    public Dialog getVisibleDialog() {
        switch (this.f1748a) {
            case 4:
                return new gu(this, ((hu) this.f1749b).f24759a.getContext());
            default:
