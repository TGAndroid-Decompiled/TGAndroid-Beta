...
public final class y3 extends org.telegram.ui.ActionBar.o2 {
    ...
    public Context getContext() {
        switch (this.f1748a) {
            ...
            case 4:
                return ((hu) this.f1749b).f24741a.getContext();
            case 12:
    ...
    public int getCurrentAccount() {
        switch (this.f1748a) {
            ...
            case 5:
                return this.currentAccount;
            case 6:
                return ((ay) this.f1749b).E.f25716c1;
            case 9:
                return this.currentAccount;
            case 12:
                return this.currentAccount;
    ...
    public View getFragmentView() {
        ...
        switch (this.f1748a) {
            case 5:
                viewGroup = ((org.telegram.ui.ActionBar.g3) ((nv) this.f1749b).f26555x).containerView;
                return viewGroup;
            case 6:
                return ((ay) this.f1749b).E.f25760r;
            case 7:
            case 8:
            default:
    ...
    public Activity getParentActivity() {
        switch (this.f1748a) {
            ...
            case 9:
                org.telegram.ui.ActionBar.o2 o2Var = ((rg.k1) this.f1749b).f42389t0;
                if (o2Var == null) {
                    return null;
                }
    ...
    public org.telegram.ui.ActionBar.f6 getResourceProvider() {
        ...
        switch (this.f1748a) {
            ...
            case 5:
                f6Var2 = ((org.telegram.ui.ActionBar.g3) ((nv) this.f1749b).f26555x).resourcesProvider;
                return f6Var2;
            case 6:
    ...
    public Dialog getVisibleDialog() {
        switch (this.f1748a) {
            case 4:
                return new gu(this, ((hu) this.f1749b).f24741a.getContext());
            default:
