...
public final class y3 extends org.telegram.ui.ActionBar.n2 {
    ...
    public Context getContext() {
        switch (this.f1748a) {
            ...
            case 4:
                return ((hu) this.f1749b).f24737a.getContext();
            case 12:
                return ((yh.y3) this.f1749b).getContext();
            default:
    ...
    public int getCurrentAccount() {
        switch (this.f1748a) {
            ...
            case 5:
                return this.currentAccount;
            case 6:
                return ((cy) this.f1749b).E.f25892c1;
            case 9:
                return this.currentAccount;
            case 12:
                return this.currentAccount;
    ...
    public View getFragmentView() {
        ...
        switch (this.f1748a) {
            case 5:
                viewGroup = ((org.telegram.ui.ActionBar.f3) ((nv) this.f1749b).f26776x).containerView;
                return viewGroup;
            case 6:
                return ((cy) this.f1749b).E.f25936r;
            case 7:
            case 8:
            default:
                return super.getFragmentView();
            case 9:
                viewGroup2 = ((org.telegram.ui.ActionBar.f3) ((rg.k1) this.f1749b)).containerView;
                return viewGroup2;
        }
    }
    ...
    public Activity getParentActivity() {
        switch (this.f1748a) {
            ...
            case 9:
                org.telegram.ui.ActionBar.n2 n2Var = ((rg.k1) this.f1749b).f42616t0;
                if (n2Var == null) {
                    return null;
                }
                return n2Var.getParentActivity();
            case 10:
                return ((org.telegram.ui.ActionBar.n2) this.f1749b).getParentActivity();
            case 11:
                xh.z4 z4Var = (xh.z4) this.f1749b;
            ...
            case 12:
                for (Context context2 = ((yh.y3) this.f1749b).getContext(); context2 instanceof ContextWrapper; context2 = ((ContextWrapper) context2).getBaseContext()) {
    ...
    public org.telegram.ui.ActionBar.e6 getResourceProvider() {
        ...
        switch (this.f1748a) {
            ...
            case 2:
                e6Var = ((org.telegram.ui.ActionBar.f3) ((ci.z5) this.f1749b)).resourcesProvider;
            ...
            case 5:
                e6Var2 = ((org.telegram.ui.ActionBar.f3) ((nv) this.f1749b).f26776x).resourcesProvider;
                return e6Var2;
            case 6:
                return ((cy) this.f1749b).E.Z1;
            case 8:
                return new x3(9, ((org.telegram.ui.web.d1) this.f1749b).e);
            case 10:
                return new o0.a(new d());
            case 11:
                e6Var3 = ((org.telegram.ui.ActionBar.f3) ((xh.z4) this.f1749b)).resourcesProvider;
                return e6Var3;
        }
    }
    ...
    public Dialog getVisibleDialog() {
        switch (this.f1748a) {
            case 4:
                return new gu(this, ((hu) this.f1749b).f24737a.getContext());
            default:
