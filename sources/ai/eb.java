...
public final class eb extends TLObject {
    public final TL_stories.StoryItem f776a;
    public int f777b;
    ...
    public eb(TL_stories.StoryItem storyItem) {
        ...
        int i13 = i12 + i11;
        this.f777b = i13;
        this.f777b = i13 + (storyItem.translatedLng != null ? 8 : 0);
    }
    ...
    public final void readParams(InputSerializedData inputSerializedData, boolean z10) {
        ...
        this.f777b = readInt32;
        if ((readInt32 & 1) == 0) {
            z11 = false;
        }
        TL_stories.StoryItem storyItem = this.f776a;
    ...
    public final void serializeToStream(OutputSerializedData outputSerializedData) {
        ...
        outputSerializedData.writeInt32(this.f777b);
        int i10 = this.f777b & 2;
        TL_stories.StoryItem storyItem = this.f776a;
        if (i10 != 0) {
