...
public final class eb extends TLObject {
    public final TL_stories.StoryItem f778a;
    public int f779b;
    ...
    public eb(TL_stories.StoryItem storyItem) {
        ...
        int i13 = i12 + i11;
        this.f779b = i13;
        this.f779b = i13 + (storyItem.translatedLng != null ? 8 : 0);
    }
    ...
    public final void readParams(InputSerializedData inputSerializedData, boolean z10) {
        ...
        this.f779b = readInt32;
        if ((readInt32 & 1) == 0) {
            z11 = false;
        }
        TL_stories.StoryItem storyItem = this.f778a;
    ...
    public final void serializeToStream(OutputSerializedData outputSerializedData) {
        ...
        outputSerializedData.writeInt32(this.f779b);
        int i10 = this.f779b & 2;
        TL_stories.StoryItem storyItem = this.f778a;
        if (i10 != 0) {
