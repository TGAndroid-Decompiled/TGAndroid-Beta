...
public final class l4 extends ImageReceiver {
    ...
    public void invalidate() {
        switch (this.f1179a) {
            case 3:
                View view = ((fo) this.f1180b).f33730b;
                if (view != null) {
                    view.invalidate();
                    return;
                }
                return;
            case 4:
                ((org.telegram.ui.Components.o5) this.f1180b).k();
                super.invalidate();
                return;
            default:
                super.invalidate();
        ...
        switch (i12) {
            ...
            case 1:
                if (drawable != null && i10 != 1) {
                    wl.q(((hg.e1) ((z5) obj).H).f10270n.animate().alpha(1.0f).translationY(0.0f), qr.f27387k, 250L);
                }
            ...
            case 4:
                ...
                if (o5Var.f26641m && hasImageLoaded()) {
                    o5Var.f26641m = false;
    ...
    public void setRoundRadius(int[] iArr) {
        switch (this.f1179a) {
            case 2:
                ...
                org.telegram.ui.Cells.t1 t1Var = (org.telegram.ui.Cells.t1) this.f1180b;
                int[] iArr2 = t1Var.R0;
                iArr2[0] = iArr[0];
                iArr2[1] = iArr[1];
                ...
                iArr2[3] = dp;
                iArr2[2] = dp;
                qh.g gVar = t1Var.f21003b6;
                if (gVar != null) {
                    gVar.f41796b.setRoundRadius(t1Var.R0);
                    return;
                }
                return;
            default:
