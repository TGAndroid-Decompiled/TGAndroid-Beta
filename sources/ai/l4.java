...
public final class l4 extends ImageReceiver {
    ...
    public void invalidate() {
        switch (this.f1179a) {
            case 3:
                View view = ((zn) this.f1180b).f40542b;
                if (view != null) {
                    view.invalidate();
                    return;
                }
        ...
        switch (i12) {
            ...
            case 1:
                if (drawable != null && i10 != 1) {
                    ok.s(((hg.f1) ((y5) obj).H).f10261n.animate().alpha(1.0f).translationY(0.0f), rr.f28034k, 250L);
                }
            ...
            case 4:
                ...
                if (q5Var.f27506m && hasImageLoaded()) {
                    q5Var.f27506m = false;
    ...
    public void setRoundRadius(int[] iArr) {
        switch (this.f1179a) {
            case 2:
                ...
                if (gVar != null) {
                    gVar.f42054b.setRoundRadius(u1Var.R0);
                    return;
                }
                return;
            default:
