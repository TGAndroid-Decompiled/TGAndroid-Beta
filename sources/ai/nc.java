...
public final class nc extends kc {
    ...
    public final void a(Canvas canvas, float f7) {
        ...
        double d10 = (mediaAreaCoordinates.f18354x * d) / 100.0d;
        double d11 = ocVar.e;
        double d12 = (mediaAreaCoordinates.f18355y * d11) / 100.0d;
        float f10 = (float) ((d * mediaAreaCoordinates.f18353w) / 100.0d);
        canvas.save();
    ...
    public final void b(boolean z10) {
        ...
        if (z10) {
            mcVar.K = true;
            if (mcVar.L) {
                mcVar.f41702s.onAttachedToWindow();
                return;
            } else {
                mcVar.f41701r.onAttachedToWindow();
                return;
            }
        }
        mcVar.K = false;
        mcVar.f41701r.onDetachedFromWindow();
        mcVar.f41702s.onDetachedFromWindow();
    }
