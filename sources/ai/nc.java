...
public final class nc extends kc {
    public final mc f1315a;
    public final TL_stories.TL_mediaAreaWeather f1316b;
    public View f1317c;
    public final oc d;

    public nc(oc ocVar, TL_stories.TL_mediaAreaWeather tL_mediaAreaWeather) {
        this.d = ocVar;
        this.f1316b = tL_mediaAreaWeather;
        ...
        mcVar.d(UserConfig.selectedAccount, tLObject.f5099c);
    ...
    public final void a(Canvas canvas, float f7) {
        ...
        oc ocVar = this.d;
        double d = ocVar.d;
        TL_stories.TL_mediaAreaWeather tL_mediaAreaWeather = this.f1316b;
        TL_stories.MediaAreaCoordinates mediaAreaCoordinates = tL_mediaAreaWeather.coordinates;
        double d10 = (mediaAreaCoordinates.f18345x * d) / 100.0d;
        double d11 = ocVar.e;
        double d12 = (mediaAreaCoordinates.f18346y * d11) / 100.0d;
        float f10 = (float) ((d * mediaAreaCoordinates.f18344w) / 100.0d);
        canvas.save();
        canvas.translate((float) (d10 + ocVar.f1372b), (float) (d12 + ocVar.f1373c));
        mc mcVar = this.f1315a;
    ...
    public final void b(boolean z10) {
        ...
        if (z10) {
            mcVar.K = true;
            if (mcVar.L) {
                mcVar.f41680s.onAttachedToWindow();
                return;
            } else {
                mcVar.f41679r.onAttachedToWindow();
                return;
            }
        }
        mcVar.K = false;
        mcVar.f41679r.onDetachedFromWindow();
        mcVar.f41680s.onDetachedFromWindow();
    }
