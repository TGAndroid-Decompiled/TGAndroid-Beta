    ...
    public final void run(Object obj) {
        ...
        switch (this.f1744a) {
            ...
            case 8:
                ...
                return;
            case 9:
                ((ci.x3) this.f1745b).f5748s.animate().translationY(((-((Integer) obj).intValue()) / 2.0f) + AndroidUtilities.dp(80.0f)).setDuration(250L).setInterpolator(org.telegram.ui.ActionBar.q1.f19507w).start();
                return;
            case 10:
