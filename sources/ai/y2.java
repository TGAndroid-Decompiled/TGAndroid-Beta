            ...
            default:
                ...
                if (storyItem2 instanceof t8) {
                    ...
                    if (!(storyItem2 instanceof TL_stories.TL_storyItemDeleted)) {
                            ...
                            if (peerStories != null) {
                                ...
                                while (true) {
                                    if (i14 < peerStories.stories.size()) {
                                        if (peerStories.stories.get(i14).f18318id == storyItem2.f18318id) {
                        ...
                        tL_stories_deleteStories.f18321id.add(Integer.valueOf(storyItem2.f18318id));
                        ConnectionsManager.getInstance(i12).sendRequest(tL_stories_deleteStories, new y7(l9Var, 5));
                        y9 y9Var = l9Var.f1199k;
                        y9Var.f1762b.getStorageQueue().postRunnable(new v9(y9Var, j10, storyItem2.f18318id, 1));
