...
public final class e7 extends kl0 {
    public final ArrayList f766c = new ArrayList();
    public final j7 d;
    ...
    public final void E() {
        ...
        if (j7Var.Q) {
            ...
            arrayList.add(new z6(0));
            if (i7Var != null) {
                u6 u6Var = i7Var.f1007s;
                boolean z10 = i7Var.f998j;
                if (i7Var.b() <= 0 && (z10 || (!i7Var.e && !i7Var.f1001m))) {
            ...
            if (i7Var != null) {
                ArrayList arrayList2 = i7Var.f996g;
                ArrayList arrayList3 = i7Var.f997i;
                if (i7Var.f995f) {
            ...
            if (i7Var != null && (i7Var.e || i7Var.f1001m)) {
                if (i7Var.b() <= 0) {
                    arrayList.add(new z6(6));
                } else {
                    arrayList.add(new z6(4));
                }
            } else if (i7Var != null && i7Var.f999k) {
                arrayList.add(new z6(11));
            } else if (i7Var != null) {
                u6 u6Var2 = i7Var.f1007s;
                if (i7Var.b() < i7Var.f992a && TextUtils.isEmpty(u6Var2.f1577c) && !u6Var2.f1576b) {
    ...
    public final int j(int i10) {
        return ((z6) this.f766c.get(i10)).f1782a;
    }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        j7 j7Var = this.d;
        int i16 = j7Var.v;
        if (c1Var.f42674f == 1 && i10 >= 0) {
            ArrayList arrayList = this.f766c;
            if (i10 < arrayList.size()) {
                z6 z6Var = (z6) arrayList.get(i10);
                org.telegram.ui.Cells.o6 o6Var = (org.telegram.ui.Cells.o6) c1Var.f42671a;
                TL_stories.StoryView storyView = z6Var.f1783b;
                ...
                boolean remove = j7Var.F.f1004p.remove(Long.valueOf(j3));
                if (storyView != null) {
                    TLRPC.Reaction reaction3 = storyView.reaction;
                    if (reaction3 != null && (str2 = zg.p0.d(reaction3).f49120f) != null && str2.equals("❤")) {
                        j11 = 0;
                        z11 = true;
                    } else {
                        j11 = 0;
                    ...
                    if (storyView instanceof TL_stories.TL_storyViewPublicRepost) {
                        ...
                        if (storyView instanceof TL_stories.TL_storyViewPublicForward) {
                            ...
                            q7 q7Var = j7Var.f1053y;
                            if (q7Var == null) {
                                storyItem2 = null;
                            } else {
                                storyItem2 = q7Var.f1427a;
                            }
                    ...
                    if (i10 < arrayList.size() - 1) {
                        i15 = ((z6) arrayList.get(i10 + 1)).f1782a;
                    } else {
                        i15 = -1;
                    }
                ...
                if (storyReaction != null) {
                    if (storyReaction instanceof TL_stories.TL_storyReaction) {
                        ...
                        if (reaction4 != null && (str = zg.p0.d(reaction4).f49120f) != null && str.equals("❤")) {
                            z10 = true;
                        } else {
                            z10 = false;
                        }
                        ...
                        if (storyReaction instanceof TL_stories.TL_storyReactionPublicRepost) {
                            ...
                            q7 q7Var2 = j7Var.f1053y;
                            if (q7Var2 == null) {
                                storyItem = null;
                            } else {
                                storyItem = q7Var2.f1427a;
                            }
                    ...
                    boolean z13 = true;
                    if (i10 < arrayList.size() - 1) {
                        i12 = ((z6) arrayList.get(i10 + 1)).f1782a;
                    } else {
                        i12 = -1;
                    }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        switch (i10) {
            ...
            case 1:
                ...
                c90Var = new c7(i12, dVar, this, j7Var.getContext());
                break;
            case 2:
            case 9:
            default:
                c90Var = new b7(this, j7Var.getContext(), 1);
                break;
            case 3:
                c90Var = new org.telegram.ui.Cells.t3(j7Var.getContext(), 70);
                break;
            case 4:
            ...
            case 10:
                ...
                if (i10 == 7) {
                    ...
                    if (!premiumFeaturesBlocked) {
                        ...
                        org.telegram.ui.ActionBar.e6 e6Var = d7Var.f30419n;
            ...
            case 12:
                ...
                c90Var3.setTextColor(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f19215y6, dVar));
                ...
                c90Var3.setMaxLines(Integer.MAX_VALUE);
                c90Var3.setGravity(17);
                c90Var3.setDisablePaddingsOffsetY(true);
                if (i10 == 11) {
                    c90Var3.setText(AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.StoryViewsPremiumHint), new a3.d(this, 10)));
                } else {
                    c90Var3.setText(LocaleController.getString(R.string.ServerErrorViewersFull));
                }
                c90Var3.setLayoutParams(new s4.p0(-1, -2));
                c90Var = c90Var3;
                break;
        }
