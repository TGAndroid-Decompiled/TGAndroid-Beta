...
public final class x9 implements RequestDelegate {
    ...
    public final Timer.Task f1711b;
    public final long f1712c;
    public final boolean d;
    public final Timer e;
    public final Runnable f1713f;
    public final Object f1714g;
    public final Cloneable h;
    public final Serializable f1715i;
    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        switch (this.f1710a) {
            case 0:
                y9 y9Var = (y9) this.f1714g;
                ArrayList arrayList = (ArrayList) this.h;
                int[] iArr = (int[]) this.f1715i;
                int i10 = y9Var.f1767a;
                Timer.done(this.f1711b);
                if (tLObject != null) {
                    ...
                    for (int i11 = 0; i11 < arrayList.size(); i11++) {
                        ...
                        while (true) {
                            ...
                            long j3 = this.f1712c;
                            if (i12 < size) {
                                if (tL_stories_stories.stories.get(i12).f18563id == y9.e(messageObject)) {
                                ...
                                tL_storyItemDeleted.f18563id = y9.e(messageObject);
                                y9.b(i10, j3, messageObject, tL_storyItemDeleted);
                            }
                        }
                        if (this.d) {
                            y9Var.f1768b.getStorageQueue().postRunnable(new a1.e(26, y9Var, arrayList));
                        }
                    }
                ...
                return;
            default:
                ((MediaDataController) this.f1714g).lambda$loadReplyMessagesForMessages$176(this.f1711b, this.f1712c, (a0.i) this.h, this.d, this.e, (AtomicInteger) this.f1715i, this.f1713f, tLObject, tL_error);
                return;
        }
    }
    ...
    public x9(MediaDataController mediaDataController, Timer.Task task, long j3, a0.i iVar, boolean z10, Timer timer, AtomicInteger atomicInteger, Runnable runnable) {
        this.f1714g = mediaDataController;
        this.f1711b = task;
        this.f1712c = j3;
        this.h = iVar;
        this.d = z10;
        this.e = timer;
        this.f1715i = atomicInteger;
        this.f1713f = runnable;
    }
}
