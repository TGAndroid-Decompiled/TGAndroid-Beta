                ...
                if (tLObject != null) {
                    ...
                    for (int i11 = 0; i11 < arrayList.size(); i11++) {
                        ...
                        while (true) {
                            ...
                            long j3 = this.f1707c;
                            if (i12 < size) {
                                if (tL_stories_stories.stories.get(i12).f18348id == y9.e(messageObject)) {
                                ...
                                tL_storyItemDeleted.f18348id = y9.e(messageObject);
                                y9.b(i10, j3, messageObject, tL_storyItemDeleted);
                            }
                        }
                        if (this.d) {
                            y9Var.f1763b.getStorageQueue().postRunnable(new a1.e(26, y9Var, arrayList));
                        }
                    }
