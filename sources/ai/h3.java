...
public final class h3 implements Runnable {
    ...
    public final void run() {
        ...
        switch (i10) {
            case 0:
                ...
                final long j10 = this.f936c;
                final boolean z11 = this.f935b;
                storiesController.i0(j10, z11, false);
                o0.a aVar = new o0.a(3, (byte) 0);
                aVar.f15300b = new Runnable() {
                    @Override
                    public final void run() {
                        switch (r5) {
                            case 0:
                ...
                org.telegram.ui.Components.oc V = new vc(f6Var.f802d1, f6Var.B0).V(Arrays.asList(tLObject), replaceTags, null, aVar);
                V.f26748a = 2;
                V.k(true);
                return;
            case 1:
                ...
                if (tL_error != null) {
                    if (tL_error.text.contains("BOOSTS_REQUIRED")) {
                        if (z10) {
                            MessagesController messagesController2 = MessagesController.getInstance(l9Var.f1188a);
            ...
            case 2:
                ...
                ChatActivityEnterView chatActivityEnterView = ((fg) obj4).f23929a;
                ...
                return;
            case 3:
                i60.y((i60) obj4, (org.telegram.ui.ActionBar.b2[]) obj3, this.f935b, (TLRPC.TL_error) obj, this.f936c, (TL_phone.inviteToGroupCall) obj2);
                return;
            case 4:
                h01 h01Var = (h01) obj4;
                ProfileActivity profileActivity = h01Var.f34081b;
                pq pqVar = new pq(profileActivity.f31269e1, -j3, (TLRPC.TL_chatAdminRights) obj3, null, null, (String) obj, 2, true, !z10, null);
                pqVar.X0 = new g01(h01Var, (uy) obj2);
            ...
            default:
                ...
                if (((TLRPC.TL_error) obj3) == null) {
                    ...
                    gVar.h0(this.f935b, this.f936c, twoStepVerificationActivity.l0(), twoStepVerificationActivity);
                    return;
                }
                return;
        }
    ...
    public h3(yh.g gVar, TLRPC.TL_error tL_error, TLObject tLObject, TwoStepVerificationActivity twoStepVerificationActivity, boolean z10, long j3) {
        ...
        this.e = tL_error;
        this.h = tLObject;
        this.f937f = twoStepVerificationActivity;
        this.f935b = z10;
        this.f936c = j3;
    }
}
