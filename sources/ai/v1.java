    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        switch (this.f1594a) {
            case 0:
                ...
                return;
            case 1:
                w5 w5Var = (w5) this.f1595b;
                ci.ia iaVar = (ci.ia) this.f1596c;
                if (tLObject instanceof TLRPC.Updates) {
                    MessagesController.getInstance(w5Var.f1653l.C2).processUpdates((TLRPC.Updates) tLObject, false);
                }
                AndroidUtilities.runOnUIThread(new s5(iaVar, 0));
                return;
            case 2:
                AndroidUtilities.runOnUIThread(new a3.k0((t8) this.f1595b, tLObject, (Runnable) this.f1596c, 6));
                return;
            case 3:
                AndroidUtilities.runOnUIThread(new i5((x8) this.f1595b, tLObject, (Utilities.Callback) this.f1596c, tL_error));
                return;
            case 4:
            ...
            case 5:
                ...
                return;
            case 6:
                AndroidUtilities.runOnUIThread(new a3.k0((ci.w3) this.f1595b, tLObject, (MessagesController) this.f1596c, 15));
                return;
            case 7:
                AndroidUtilities.runOnUIThread(new a3.k0((ci.ba) this.f1595b, tLObject, (MessagesController) this.f1596c, 18));
                return;
            case 8:
            ...
            case 9:
                ...
                return;
            case 10:
                AndroidUtilities.runOnUIThread(new i5((gg.c) this.f1595b, tL_error, (String) this.f1596c, tLObject));
                return;
            case 11:
            ...
            case 12:
                ...
                return;
            case 13:
                AndroidUtilities.runOnUIThread(new gg.t((hg.y) this.f1595b, tLObject, (TL_account.TL_businessChatLink) this.f1596c, 7));
                return;
            case 14:
                AndroidUtilities.runOnUIThread(new gg.x1(3, (hg.l0) this.f1595b, (id) this.f1596c));
                return;
            case 15:
                AndroidUtilities.runOnUIThread(new gg.t((hg.f2) this.f1595b, tLObject, (SharedPreferences) this.f1596c, 12));
                return;
            case 16:
            ...
            case 19:
                ...
                return;
            case 20:
                org.telegram.ui.ActionBar.d6 d6Var = (org.telegram.ui.ActionBar.d6) this.f1595b;
                        ...
                        if (wallPaper instanceof TLRPC.TL_wallPaper) {
                            ...
                            if (tL_wallPaper.pattern) {
                                ...
                                while (i12 < size2) {
                                    ...
                                    if (g6Var.f18703o.equals(tL_wallPaper.slug)) {
                                        if (bool == null) {
                                        ...
                                        if (bitmap != null || bool.booleanValue()) {
                                            ...
                                            if (d6Var.f18596b == null) {
                                                d6Var.f18596b = new HashMap();
                                            }
                                            org.telegram.ui.ActionBar.c6 c6Var2 = (org.telegram.ui.ActionBar.c6) d6Var.f18596b.get(attachFileName);
                                            if (c6Var2 == null) {
                                                ?? obj = new Object();
                                                arrayList2 = arrayList3;
                                                obj.f18571b = new ArrayList();
                                                obj.f18570a = tL_wallPaper;
                                                d6Var.f18596b.put(attachFileName, obj);
                                                c6Var = obj;
                                            } else {
                                                arrayList2 = arrayList3;
                                                c6Var = c6Var2;
                                            }
                                            c6Var.f18571b.add(g6Var);
                                        }
                                    } else {
                                        arrayList2 = arrayList3;
                                    }
                ...
                return;
            case 21:
                AndroidUtilities.runOnUIThread(new org.telegram.ui.ActionBar.p((org.telegram.ui.ActionBar.h6) this.f1595b, tLObject, (org.telegram.ui.ActionBar.h6) this.f1596c, 3));
                return;
            case 22:
                AndroidUtilities.runOnUIThread(new org.telegram.ui.ActionBar.n5((Object) ((org.telegram.ui.h8) this.f1595b), (Object) tL_error, tLObject, (Object) ((Calendar) this.f1596c), 3));
                return;
            case 23:
                AndroidUtilities.runOnUIThread(new org.telegram.ui.q1((yc) this.f1595b, tLObject, (org.telegram.ui.ActionBar.h6) this.f1596c, 10));
                return;
            case 24:
                AndroidUtilities.runOnUIThread(new org.telegram.ui.q1((je) this.f1595b, tLObject, (Context) this.f1596c, 12));
                return;
            case 25:
                bo boVar = (bo) this.f1595b;
                ...
                return;
            case 26:
                AndroidUtilities.runOnUIThread(new org.telegram.ui.q1((bo) this.f1595b, tLObject, (TLRPC.User) this.f1596c, 20));
                return;
            case 27:
                bo boVar2 = (bo) this.f1595b;
            ...
            case 28:
                AndroidUtilities.runOnUIThread(new org.telegram.ui.ActionBar.n5((org.telegram.ui.ActionBar.n2) ((bo) this.f1595b), tLObject, (TLObject) tL_error, (Object) ((MessagesStorage) this.f1596c), 9));
                return;
            default:
                AndroidUtilities.runOnUIThread(new org.telegram.ui.q1((dm) this.f1595b, tLObject, (MessageObject) this.f1596c, 23));
                return;
        }
    }
}
