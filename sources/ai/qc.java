...
public final class qc implements Runnable {
    ...
    public final void run() {
        rc rcVar = this.f1441a;
        int i10 = rcVar.f1482a;
        ...
        if (!arrayList.isEmpty()) {
            ...
            for (int i11 = 0; i11 < arrayList2.size(); i11++) {
                tL_stories_getPeerMaxIDs.f18354id.add(MessagesController.getInstance(i10).getInputPeer(((Long) arrayList2.get(i11)).longValue()));
            }
