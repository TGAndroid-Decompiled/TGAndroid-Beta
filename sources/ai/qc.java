...
public final class qc implements Runnable {
    ...
    public final void run() {
        rc rcVar = this.f1443a;
        int i10 = rcVar.f1484a;
        ...
        if (!arrayList.isEmpty()) {
            ...
            for (int i11 = 0; i11 < arrayList2.size(); i11++) {
                tL_stories_getPeerMaxIDs.f18584id.add(MessagesController.getInstance(i10).getInputPeer(((Long) arrayList2.get(i11)).longValue()));
            }
