...
public final class d2 implements NotificationCenter.NotificationCenterDelegate, AudioManager.OnAudioFocusChangeListener {
    ...
    public ArrayList U;
    public ArrayList V;
    public final TL_stories.StoryItem f683a;
    public final long f684b;
    public final int f685c;
    public final Context d;
    public final int e;
    public final TLRPC.InputGroupCall f686f;
    ...
    public d2(Context context, int i10, TL_stories.StoryItem storyItem, long j3, int i11, boolean z10, TLRPC.InputGroupCall inputGroupCall, boolean z11, boolean z12) {
        ...
        this.d = context;
        this.e = i10;
        this.f686f = inputGroupCall;
        this.f683a = storyItem;
        this.f684b = j3;
        this.f685c = i11;
        this.h = z10;
        this.f687n = z11;
        ...
        this.H = b2Var;
        FileLog.d("[LivePlayer] setup to call " + inputGroupCall.f18129id);
    ...
    public final boolean a() {
        ...
        if (!this.f690w && !this.f687n && this.f689s && W == null && (groupCall = this.v) != null && !groupCall.rtmp_stream && groupCall.creator) {
            return true;
        }
        return false;
    }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.storyGroupCallUpdated) {
            ...
            if (this.f684b == longValue) {
                zf.d.a(this.v, groupCall);
                this.v = groupCall;
                NotificationCenter.getInstance(this.e).lambda$postNotificationNameOnUIThread$1(NotificationCenter.liveStoryUpdated, Long.valueOf(groupCall.f18122id));
            }
        }
    }
    ...
    public final void e() {
        if (!this.f690w) {
            ...
            if (this.f691x) {
                ...
                leavegroupcall.call = this.f686f;
    ...
    public final boolean f(TLRPC.InputGroupCall inputGroupCall) {
        TLRPC.InputGroupCall inputGroupCall2 = this.f686f;
        if (inputGroupCall2 != inputGroupCall && inputGroupCall2.f18129id != inputGroupCall.f18129id) {
            return false;
        }
        return true;
    }
    ...
    public final long g() {
        ...
        TLRPC.InputGroupCall inputGroupCall = this.f686f;
        if (inputGroupCall != null) {
            return inputGroupCall.f18129id;
        }
        return 0L;
    }
    ...
    public final void k() {
        ...
        NativeInstance makeGroup = NativeInstance.makeGroup(org.telegram.ui.Components.voip.f2.d("live_" + this.f686f.f18129id), 0L, false, SharedConfig.noiseSupression, new p1(this, 0), new w1(0), new p1(this, 2), new p1(this, 3), new p1(this, 4), new p1(this, 5), false);
        this.E = makeGroup;
    ...
    public final void p() {
        ...
        checkgroupcall.call = this.f686f;
    ...
    public final void w() {
        ...
        int i10 = this.e;
        tL_updateStory.peer = MessagesController.getInstance(i10).getPeer(this.f684b);
        TL_stories.TL_storyItemDeleted tL_storyItemDeleted = new TL_stories.TL_storyItemDeleted();
        tL_updateStory.story = tL_storyItemDeleted;
        tL_storyItemDeleted.f18348id = this.f685c;
        MessagesController.getInstance(i10).getStoriesController().Z(tL_updateStory);
        e();
    }

    public final void x() {
        if (!this.f690w && this.E != null) {
