...
public final class x5 extends FrameLayout {
    ...
    public void onMeasure(int i10, int i11) {
        switch (this.f1699a) {
            ...
            case 13:
                ...
                return;
            case 18:
                super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i10), 1073741824), rk.C(48.0f, 1, 1073741824));
                return;
            case 20:
    ...
    public x5(i41 i41Var, Context context, int i10, String str, CharSequence charSequence) {
        ...
        mutate.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(i11, i41.P(i41Var)), PorterDuff.Mode.MULTIPLY));
