...
public final class lc extends kc {
    ...
    public final void a(Canvas canvas, float f7) {
        ...
        if (imageReceiver != null && imageReceiver.hasImageSet() && imageReceiver.hasImageLoaded()) {
            ...
            float f10 = (float) (((mediaAreaCoordinates.f18567x * d) / 100.0d) + ocVar.f1375b);
            double d10 = ocVar.f1376c;
            double d11 = ocVar.e;
            float f11 = (float) (((mediaAreaCoordinates.f18568y * d11) / 100.0d) + d10);
            float f12 = ((float) ((d * mediaAreaCoordinates.f18566w) / 100.0d)) / 2.0f;
