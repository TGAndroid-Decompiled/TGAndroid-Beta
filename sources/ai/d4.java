    ...
    public final void run(Object obj) {
        ...
        switch (this.f700a) {
            case 0:
                ...
                TLRPC.User user = f6Var.f809d3.getAdapter().f9841w0;
                if (user != null) {
                    j3 = user.f18443id;
                } else {
                    j3 = 0;
                ...
                hashMap.put("bot", "" + j3);
                TLRPC.User user2 = f6Var.f809d3.getAdapter().f9841w0;
                if (user2 == null) {
                    str = "";
                } else {
                    str = user2.username;
                ...
                org.telegram.ui.ActionBar.n2 n2Var = f6Var.J0.f1080f;
                long j10 = j3;
                accountInstance = f6Var.getAccountInstance();
                SendMessagesHelper.prepareSendingBotContextResult(n2Var, accountInstance, botInlineResult, hashMap, f6Var.B1, null, null, f6Var.O1.f706a, null, this.f701b, this.f702c, 0, null, 0L, l4.longValue());
