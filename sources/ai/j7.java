...
public abstract class j7 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final View f1043b;
    public final FrameLayout f1044c;
    public final a5.a d;
    public int e;
    public x6 f1045f;
    public final TextView h;
    public int f1046n;
    public final p6 f1047r;
    public final d f1048s;
    public final int v;
    public final e7 f1049w;
    public final pz f1050x;
    public q7 f1051y;
    ...
    public static void a(j7 j7Var) {
        new rg.x0(j7Var.K.f1075f, 14, false).show();
    }

    public static void b(j7 j7Var) {
        i7 i7Var = j7Var.E;
        if (i7Var != null) {
            i7Var.f1004r.remove(j7Var);
        }
        i7 i7Var2 = j7Var.F;
        j7Var.E = i7Var2;
        if (i7Var2 == null) {
        ...
        j7Var.f1049w.E();
        j7Var.f1050x.h1(0, (int) (j7Var.getTopOffset() - j7Var.f1047r.getPaddingTop()));
    }
    ...
    public static void f(int i10, long j3, TL_stories.StoryItem storyItem) {
        ...
        int i11;
        if (storyItem != null) {
            SparseArray sparseArray = (SparseArray) MessagesController.getInstance(i10).storiesController.f1207x.f(storyItem.dialogId);
            if (sparseArray == null) {
                i7Var = null;
            } else {
                i7Var = (i7) sparseArray.get(storyItem.f18348id);
            }
            ...
            i7Var2.c();
            if (sparseArray == null) {
                a0.i iVar = MessagesController.getInstance(i10).storiesController.f1207x;
                long j10 = storyItem.dialogId;
                sparseArray = new SparseArray();
                iVar.k(sparseArray, j10);
            }
            sparseArray.put(storyItem.f18348id, i7Var2);
        }
    }

    public final void c() {
        if (this.E != null && this.f1050x.N0() > this.f1049w.f764c.size() - 10) {
            this.E.c();
        }
    }
    ...
    public final boolean d(TL_stories.StoryView storyView) {
        ...
        if (q7Var != null) {
            ...
            if (storyItem != null) {
                ...
                return this.f1051y.f1425a.parsedPrivacy.b(user);
            }
            k9 k9Var = q7Var.f1426b;
            if (k9Var != null && (o8Var = k9Var.f1138c) != null && (gaVar = o8Var.E0) != null) {
                return gaVar.b(user);
            }
        }
        return true;
            ...
            if (this.f1051y.f1426b != null) {
                ...
                if (y3 != null) {
                    while (i12 < y3.stories.size()) {
                        ...
                        if (str != null && str.equals(this.f1051y.f1426b.e)) {
                            q7 q7Var = this.f1051y;
                            q7Var.f1426b = null;
                            q7Var.f1425a = storyItem;
                            g(this.W, q7Var);
                            return;
                        }
                        i12++;
            ...
            while (true) {
                ...
                if (i12 < p6Var.getChildCount()) {
                    ...
                    if ((childAt instanceof org.telegram.ui.Cells.n6) && (R = RecyclerView.R(childAt)) >= 0) {
                        e7 e7Var = this.f1049w;
                        if (R < e7Var.f764c.size()) {
                            org.telegram.ui.Cells.n6 n6Var = (org.telegram.ui.Cells.n6) childAt;
                            if (d(((z6) e7Var.f764c.get(R)).f1781b)) {
                                f7 = 1.0f;
                            } else {
                                f7 = 0.5f;
                            }
    ...
    public final void e(i7 i7Var) {
        ...
        e7 e7Var = this.f1049w;
        int size = e7Var.f764c.size();
        u6 u6Var = this.O;
        if (TextUtils.isEmpty(u6Var.f1575c) && !u6Var.f1574b) {
            i();
        }
        e7Var.E();
        this.J.b(size - 1);
        c();
        if (this.G != null) {
            ArrayList arrayList = i7Var.f995i;
    ...
    public final void g(long j3, q7 q7Var) {
        ...
        i();
        h(false);
        if (q7Var != null && q7Var.f1425a != null) {
            NotificationsController.getInstance(this.v).processSeenStoryReactions(j3, q7Var.f1425a.f18348id);
        }
    }

    public float getTopOffset() {
        return this.f1044c.getTranslationY();
    }
    ...
    public final void h(boolean z10) {
        ...
        if (z11 != y6Var.f1754s || !z10) {
            ...
            if (!z10) {
                ...
                y6Var.f1755w.setInterpolator(qr.f27423f);
                y6Var.f1755w.start();
            }
        }
        boolean z12 = u6Var.f1573a;
        ql0 ql0Var = y6Var.v;
        if (z12) {
            i7 i7Var = this.E;
    ...
    public final void onAttachedToWindow() {
        ...
        i7 i7Var = this.E;
        if (i7Var != null) {
            ArrayList arrayList = i7Var.f1004r;
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        if (motionEvent.getY() < this.f1044c.getTranslationY()) {
            return false;
        }
