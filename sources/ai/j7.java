    ...
    public final void c() {
        if (!this.e && this.f1042m && !this.f1039j) {
            ...
            if (z10) {
                ...
                tL_getStoryReactionsList.f18571id = storyItem.f18570id;
                ...
                this.e = true;
                FileLog.d("SelfStoryViewsPage reactions load next " + storyItem.f18570id + " " + this.f1041l + " offset=" + tL_getStoryReactionsList.offset);
                                        ...
                                        switch (r5) {
                                            case 0:
                                                ...
                                                if (iArr[0] != j7Var2.f1044o) {
                                                    FileLog.d("SelfStoryViewsPage " + storyItem2.f18570id + " localId != reqId");
                                                    return;
                                                }
                                                j7Var2.e = false;
                                                j7Var2.f1044o = -1;
                                                ...
                                                if (tLObject2 != null) {
                                                    ...
                                                    if (i15 > storyViews.views_count) {
                                                        ...
                                                        for (int i16 = 0; i16 < Math.min(3, storyViewsList.users.size()); i16 = com.google.android.gms.internal.vision.e2.g(storyViewsList.users.get(i16).f18482id, storyItem2.views.recent_viewers, i16, 1)) {
                                                        }
                                                ...
                                                FileLog.d("SelfStoryViewsPage " + storyItem2.f18570id + " response  totalItems " + arrayList3.size() + " has next " + j7Var2.f1042m);
                                            ...
                                            default:
                                                ...
                                                if (iArr[0] != j7Var3.f1044o) {
                                                    FileLog.d("SelfStoryViewsPage reactions " + storyItem3.f18570id + " localId != reqId");
                                                    return;
                                                }
                                                j7Var3.e = false;
                                                j7Var3.f1044o = -1;
                                                ...
                                                FileLog.d("SelfStoryViewsPage reactions " + storyItem3.f18570id + " response  totalItems " + arrayList5.size() + " has next " + j7Var3.f1042m);
                                    ...
                                    public final void run() {
                                        ...
                                        switch (r5) {
                                            case 0:
                                                ...
                                                FileLog.d("SelfStoryViewsPage " + storyItem2.f18570id + " response  totalItems " + arrayList3.size() + " has next " + j7Var22.f1042m);
                                                for (int i19 = 0; i19 < arrayList.size(); i19++) {
            ...
            tL_stories_getStoryViewsList.f18579id = storyItem.f18570id;
            tL_stories_getStoryViewsList.peer = MessagesController.getInstance(i11).getInputPeer(j3);
            if (this.f1046q) {
                tL_stories_getStoryViewsList.f18580q = "";
                ...
                tL_stories_getStoryViewsList.f18580q = str2;
                if (!TextUtils.isEmpty(str2)) {
            ...
            this.e = true;
            FileLog.d("SelfStoryViewsPage load next " + storyItem.f18570id + " " + this.f1041l + " offset=" + tL_stories_getStoryViewsList.offset + " q" + tL_stories_getStoryViewsList.f18580q + " " + tL_stories_getStoryViewsList.just_contacts + " " + tL_stories_getStoryViewsList.reactions_first);
