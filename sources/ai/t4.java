        ...
        switch (i14) {
            case 0:
                ...
                if (p0Var.f49447f != null) {
                    f7 = MediaDataController.getInstance(f6Var.C2).getEmojiAnimatedSticker(p0Var.f49447f);
                    SendMessagesHelper.SendMessageParams of2 = SendMessagesHelper.SendMessageParams.of(p0Var.f49447f, f6Var.B1);
                    of2.replyToStoryItem = d6Var.f703a;
                    of2.payStars = l4.longValue();
                    SendMessagesHelper.getInstance(f6Var.C2).sendMessage(of2);
                } else {
                    f7 = org.telegram.ui.Components.p5.f(f6Var.C2, p0Var.f49448g);
                    ...
                    tL_messageEntityCustomEmoji.document_id = p0Var.f49448g;
                ...
                if (l4.longValue() <= 0) {
                    org.telegram.ui.Components.pc q6 = new xc(f6Var.f800c1, f6Var.B0).q(f7, LocaleController.getString(R.string.ReactionSent), LocaleController.getString(R.string.ViewInChat), new a3.d(u4Var, 6));
                    q6.f27311j = 5000;
                    q6.j();
                }
                if (f6Var.f812f2.getReactionsWindow() != null) {
            ...
            case 1:
                ...
                f6 f6Var3 = ((w5) obj4).f1655l;
                a5 a5Var = f6Var3.f800c1;
            ...
            default:
                ...
                xh.r1 r1Var = new xh.r1(chatActivityEnterView.getContext(), chatActivityEnterView.Q, ((TLRPC.User) obj2).f18490id, tg.s.c(tg.s.b(1, (List) obj)), null);
                r1Var.V(z10);
                r1Var.show();
                return;
        }
