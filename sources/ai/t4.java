        ...
        switch (i14) {
            case 0:
                ...
                if (o0Var.f49377f != null) {
                    f7 = MediaDataController.getInstance(f6Var.C2).getEmojiAnimatedSticker(o0Var.f49377f);
                    SendMessagesHelper.SendMessageParams of2 = SendMessagesHelper.SendMessageParams.of(o0Var.f49377f, f6Var.B1);
                    of2.replyToStoryItem = d6Var.f706a;
                    of2.payStars = l4.longValue();
                    SendMessagesHelper.getInstance(f6Var.C2).sendMessage(of2);
                } else {
                    f7 = org.telegram.ui.Components.q5.f(f6Var.C2, o0Var.f49378g);
                    ...
                    tL_messageEntityCustomEmoji.document_id = o0Var.f49378g;
                ...
                if (l4.longValue() <= 0) {
                    org.telegram.ui.Components.qc q6 = new xc(f6Var.f803c1, f6Var.B0).q(f7, LocaleController.getString(R.string.ReactionSent), LocaleController.getString(R.string.ViewInChat), new a3.d(u4Var, 6));
                    q6.f27550j = 5000;
                    q6.j();
                }
                if (f6Var.f815f2.getReactionsWindow() != null) {
            ...
            case 1:
                ...
                a5 a5Var = f6Var2.f803c1;
                if (((Boolean) obj).booleanValue()) {
                    storyItem.pinned = z10;
                    if (f6Var2.C1) {
                        xc xcVar2 = new xc(a5Var, e6Var);
                        if (z10) {
            ...
            default:
                ...
                xh.r1 r1Var = new xh.r1(chatActivityEnterView.getContext(), chatActivityEnterView.Q, ((TLRPC.User) obj2).f18443id, tg.s.c(tg.s.b(1, (List) obj)), null);
                r1Var.V(z10);
                r1Var.show();
                return;
        }
