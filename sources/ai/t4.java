        ...
        switch (i14) {
            case 0:
                ...
                if (o0Var.f49395f != null) {
                    f7 = MediaDataController.getInstance(e6Var.C2).getEmojiAnimatedSticker(o0Var.f49395f);
                    SendMessagesHelper.SendMessageParams of2 = SendMessagesHelper.SendMessageParams.of(o0Var.f49395f, e6Var.B1);
                    of2.replyToStoryItem = c6Var.f642a;
                    of2.payStars = l4.longValue();
                    SendMessagesHelper.getInstance(e6Var.C2).sendMessage(of2);
                } else {
                    f7 = org.telegram.ui.Components.q5.f(e6Var.C2, o0Var.f49396g);
                    ...
                    tL_messageEntityCustomEmoji.document_id = o0Var.f49396g;
