...
public final class t4 implements Utilities.Callback {
    ...
    public final void run(Object obj) {
        ...
        switch (i14) {
            case 0:
                ...
                if (z10 && p0Var.f49120f != null) {
                    try {
                        f6Var.performHapticFeedback(0);
                    } catch (Exception unused) {
                    }
                    l0Var = new zg.l0(view.getContext(), null, f6Var.f812f2, null, view, f6Var.getMeasuredWidth() / 2.0f, f6Var.getMeasuredHeight() / 2.0f, p0Var, f6Var.C2, 0, true);
                } else {
                    l0Var = new zg.l0(view.getContext(), null, f6Var.f812f2, null, view, f6Var.getMeasuredWidth() / 2.0f, f6Var.getMeasuredHeight() / 2.0f, p0Var, f6Var.C2, 2, true);
                }
                zg.l0.B = l0Var;
                int i15 = R.id.parent_tag;
                zg.i0 i0Var = l0Var.f49065i;
                i0Var.setTag(i15, 1);
                f6Var.addView(i0Var);
                d6 d6Var = f6Var.O1;
                l0Var.f49075s = true;
                ...
                if (p0Var.f49120f != null) {
                    f7 = MediaDataController.getInstance(f6Var.C2).getEmojiAnimatedSticker(p0Var.f49120f);
                    SendMessagesHelper.SendMessageParams of2 = SendMessagesHelper.SendMessageParams.of(p0Var.f49120f, f6Var.B1);
                    of2.replyToStoryItem = d6Var.f703a;
                    of2.payStars = l4.longValue();
                    SendMessagesHelper.getInstance(f6Var.C2).sendMessage(of2);
                } else {
                    f7 = org.telegram.ui.Components.o5.f(f6Var.C2, p0Var.f49121g);
                    String findAnimatedEmojiEmoticon = MessageObject.findAnimatedEmojiEmoticon(f7, null);
                    if (findAnimatedEmojiEmoticon == null) {
                        if (f6Var.f812f2.getReactionsWindow() != null) {
                            f6Var.f812f2.getReactionsWindow().e();
                        }
                        f6Var.s0();
                        return;
                    }
                    ...
                    tL_messageEntityCustomEmoji.document_id = p0Var.f49121g;
                    tL_messageEntityCustomEmoji.offset = 0;
                    tL_messageEntityCustomEmoji.length = findAnimatedEmojiEmoticon.length();
                    of3.entities.add(tL_messageEntityCustomEmoji);
                    of3.replyToStoryItem = d6Var.f703a;
                    of3.payStars = l4.longValue();
                    SendMessagesHelper.getInstance(f6Var.C2).sendMessage(of3);
                }
                if (l4.longValue() <= 0) {
                    org.telegram.ui.Components.oc q6 = new vc(f6Var.f800c1, f6Var.B0).q(f7, LocaleController.getString(R.string.ReactionSent), LocaleController.getString(R.string.ViewInChat), new a3.d(u4Var, 6));
                    q6.f26751j = 5000;
                    q6.j();
                }
                if (f6Var.f812f2.getReactionsWindow() != null) {
            ...
            default:
                ...
                xh.q1 q1Var = new xh.q1(chatActivityEnterView.getContext(), chatActivityEnterView.Q, ((TLRPC.User) obj2).f18256id, tg.t.c(tg.t.b(1, (List) obj)), null);
                q1Var.V(z10);
                q1Var.show();
                return;
        }
    ...
    public t4(ChatActivityEnterView chatActivityEnterView, org.telegram.ui.ActionBar.b2 b2Var, TLRPC.User user, boolean z10) {
        this.f1548c = chatActivityEnterView;
        this.d = b2Var;
        this.e = user;
        this.f1547b = z10;
    }
