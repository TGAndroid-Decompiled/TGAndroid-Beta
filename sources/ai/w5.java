...
public final class w5 extends xr {
    ...
    public final c6 f1651j;
    public final boolean[] f1652k;
    public final f6 f1653l;
    ...
    @Override
    public final void c() {
        if (!this.f1647c && !this.f1652k[0]) {
            AndroidUtilities.runOnUIThread(new n5(this, 0));
        }
        f6 f6Var = this.f1653l;
        f6Var.f849t1 = null;
        f6Var.f846s1 = null;
    }
    ...
    public final void d(ActionBarPopupWindow$ActionBarPopupWindowLayout actionBarPopupWindow$ActionBarPopupWindowLayout, boolean z10) {
        ...
        f6 f6Var = this.f1653l;
        if (z11 && ((d6Var = f6Var.O1) == null || d6Var.f702b == null)) {
            ...
            obj.f31941a = actionBarPopupWindow$ActionBarPopupWindowLayout2;
            ...
            int b10 = actionBarPopupWindow$ActionBarPopupWindowLayout.b(f6Var.C3.f31941a);
    ...
    public final void e(ActionBarPopupWindow$ActionBarPopupWindowLayout actionBarPopupWindow$ActionBarPopupWindowLayout, TL_stories.StoryItem storyItem) {
        ...
        if (f6Var.D1 && storyItem != null && !(storyItem.media instanceof TLRPC.TL_messageMediaVideoStream) && (chat = MessagesController.getInstance(f6Var.C2).getChat(Long.valueOf(-f6Var.B1))) != null) {
            TLRPC.ChatFull chatFull = MessagesController.getInstance(f6Var.C2).getChatFull(chat.f18112id);
            if (chatFull == null) {
                chatFull = MessagesStorage.getInstance(f6Var.C2).loadChatInfo(chat.f18112id, true, new CountDownLatch(1), false, false);
            }
