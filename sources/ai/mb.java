        ...
        if (arrayList != arrayList2 || (arrayList != null && arrayList2 != null && arrayList.size() != this.f1276r.size())) {
            ...
            for (int i11 = 0; i11 < arrayList.size(); i11++) {
                ...
                if (mediaArea != null && mediaArea.coordinates != null) {
                    ...
                    addView(pbVar);
                    double d = mediaArea.coordinates.f18566w;
                }
            }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        for (int i14 = 0; i14 < getChildCount(); i14++) {
            ...
            if (childAt == this.d) {
                ...
                kbVar.setTranslationX((float) ((mediaArea.coordinates.f18567x / 100.0d) * getMeasuredWidth()));
                kbVar.setTranslationY((float) ((mediaArea.coordinates.f18568y / 100.0d) * getMeasuredHeight()));
                ...
                lbVar.setTranslationX((float) ((mediaArea2.coordinates.f18567x / 100.0d) * getMeasuredWidth()));
                lbVar.setTranslationY((float) ((mediaArea2.coordinates.f18568y / 100.0d) * getMeasuredHeight()));
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        for (int i12 = 0; i12 < getChildCount(); i12++) {
            ...
            if (childAt == frameLayout) {
                ...
                kbVar.measure(View.MeasureSpec.makeMeasureSpec((int) Math.ceil((kbVar.f1155b.coordinates.f18566w / 100.0d) * size), 1073741824), View.MeasureSpec.makeMeasureSpec((int) Math.ceil((kbVar.f1155b.coordinates.h / 100.0d) * size2), 1073741824));
            } else if (childAt instanceof lb) {
                lb lbVar = (lb) getChildAt(i12);
                lbVar.measure(View.MeasureSpec.makeMeasureSpec((int) Math.ceil((lbVar.f1216a.coordinates.f18566w / 100.0d) * size), 1073741824), View.MeasureSpec.makeMeasureSpec((int) Math.ceil((lbVar.f1216a.coordinates.h / 100.0d) * size2), 1073741824));
            }
        }
