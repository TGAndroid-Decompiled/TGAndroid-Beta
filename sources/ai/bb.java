    ...
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        ...
        switch (this.f601a) {
            ...
            case 2:
                ...
                t1Var.f21121jd = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                t1Var.invalidate();
            ...
            case 5:
                ...
                if (this.f602b) {
                    org.telegram.ui.Components.v8 v8Var = c9Var.f22963a;
                    v8Var.f22666w = floatValue4;
                    v8Var.invalidate();
                    return;
                }
                return;
            ...
            case 8:
                ...
                v2Var.f29295s = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                v2Var.invalidate();
                if (this.f602b) {
                    textViewArr[0].setAlpha(1.0f - v2Var.f29295s);
                    textViewArr[0].setScaleX(1.0f - v2Var.f29295s);
                    textViewArr[0].setScaleY(1.0f - v2Var.f29295s);
                    textViewArr[1].setAlpha(v2Var.f29295s);
                    textViewArr[1].setScaleX(v2Var.f29295s);
                    textViewArr[1].setScaleY(v2Var.f29295s);
                    return;
                }
                return;
            case 9:
            ...
            case 10:
                ...
                k51Var.f35005s = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                k51Var.f34996b.invalidate();
                k51Var.f34998c.invalidate();
                if (k51Var.S) {
                    k51Var.N.invalidate();
                }
                k51Var.e();
                TextView textView = k51Var.f35008y;
                if (textView != null) {
                    textView.setAlpha(k51Var.f35005s);
                }
                if (!k51Var.S && (i51Var = k51Var.N) != null && i51Var.getSeekBarWaveform() != null) {
                    ...
                    seekBarWaveform.L = qrVar.getInterpolation(Utilities.clamp(k51Var.f35005s * 1.25f, 1.0f, 0.0f));
            ...
            case 11:
                ...
                o0Var.e = floatValue6;
                if (!this.f602b) {
                    o0Var.f41524c.setAlpha(1.0f - floatValue6);
                }
                o0Var.f41523b.invalidate();
                return;
            default:
                zg.c0 c0Var = (zg.c0) this.f603c;
                c0Var.f49025x = null;
                c0Var.f49012j = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                c0Var.k();
                c0Var.l();
                c0Var.f49016n.setCustomEmojiEnterProgress(Utilities.clamp(c0Var.f49012j, 1.0f, 0.0f));
                c0Var.f49006a.invalidate();
                c0Var.f49015m.invalidateOutline();
                if (c0Var.f49024w) {
                    c0Var.j(c0Var.f49012j, this.f602b);
                    return;
                }
                return;
        }
