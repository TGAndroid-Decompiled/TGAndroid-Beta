...
public final class j implements Runnable {
    ...
    public final void run() {
        ...
        switch (i10) {
            case 0:
                ((b0) obj).f558s.e0(j3, false);
                return;
            case 1:
                f6 f6Var = ((b4) obj).f573a;
                if (j3 <= 0) {
                    z10 = true;
                }
                f6Var.k0(z10);
            ...
            case 2:
                ...
                return;
            case 3:
                org.telegram.ui.ActionBar.n2 d02 = ya1.d0(MessagesController.getInstance(((l9) obj).f1188a).getChat(Long.valueOf(-j3)), true);
                ...
                return;
            case 4:
                MessagesStorage messagesStorage = ((y9) obj).f1763b;
            ...
            case 6:
                ...
                ocVar2.F = jcVar;
                if (jcVar != null) {
                    ocVar2.J = jcVar.f4855a;
                    ocVar2.f5252r.c();
                    ci.ac acVar = ocVar2.f5223h0;
                    int i12 = ocVar2.J;
                    if (i12 != 1 && i12 != 0) {
                        i11 = -14737633;
                    }
                    acVar.setBackgroundColor(i11);
                    ocVar2.H.set(ocVar2.F.f4857c);
                    ci.jc jcVar3 = ocVar2.F;
                    ocVar2.G = jcVar3.f4856b;
                    jcVar3.e();
                ...
                ocVar2.f5273x = null;
                Activity activity = ocVar2.f5202b;
                if (activity instanceof LaunchActivity) {
                    ((LaunchActivity) activity).f30862z0.post(new ci.ka(ocVar2, 5));
                    return;
                } else {
                    ocVar2.q(true);
                    return;
            ...
            case 10:
                ii.r rVar = (ii.r) obj;
                org.telegram.ui.Components.c5.M(rVar.f26462b.f28750f0.getParentActivity(), j3, new a6.m(rVar, 26), rVar.f26461a);
                return;
            case 11:
            ...
            case 12:
                ...
                j2.f fVar = ((i2.b0) ((k2.j) ((n4.y) obj).f14995c)).f10621a.f10671s;
                j2.a p5 = fVar.p();
            ...
            case 22:
                ...
                new yh.n7(activity2, e6Var, this.f1030b, 15, "", new vg0(yg0Var, 0), 0L).show();
                return;
            case 23:
                uy uyVar = (uy) obj;
                uyVar.A4(true, true);
