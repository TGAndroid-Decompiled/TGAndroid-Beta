    ...
    public final void c() {
        if (!this.e && this.f1004m && !this.f1001j) {
            ...
            if (z10) {
                ...
                tL_getStoryReactionsList.f18564id = storyItem.f18563id;
                ...
                this.e = true;
                FileLog.d("SelfStoryViewsPage reactions load next " + storyItem.f18563id + " " + this.f1003l + " offset=" + tL_getStoryReactionsList.offset);
                                        ...
                                        switch (r5) {
                                            case 0:
                                                ...
                                                if (iArr[0] != i7Var2.f1006o) {
                                                    FileLog.d("SelfStoryViewsPage " + storyItem2.f18563id + " localId != reqId");
                                                    return;
                                                }
                                                i7Var2.e = false;
                                                i7Var2.f1006o = -1;
                                                ...
                                                if (tLObject2 != null) {
                                                    ...
                                                    if (i15 > storyViews.views_count) {
                                                        ...
                                                        for (int i16 = 0; i16 < Math.min(3, storyViewsList.users.size()); i16 = com.google.android.gms.internal.vision.e2.g(storyViewsList.users.get(i16).f18475id, storyItem2.views.recent_viewers, i16, 1)) {
                                                        }
                                                ...
                                                FileLog.d("SelfStoryViewsPage " + storyItem2.f18563id + " response  totalItems " + arrayList3.size() + " has next " + i7Var2.f1004m);
                                            ...
                                            default:
                                                ...
                                                if (iArr[0] != i7Var3.f1006o) {
                                                    FileLog.d("SelfStoryViewsPage reactions " + storyItem3.f18563id + " localId != reqId");
                                                    return;
                                                }
                                                i7Var3.e = false;
                                                i7Var3.f1006o = -1;
                                                ...
                                                FileLog.d("SelfStoryViewsPage reactions " + storyItem3.f18563id + " response  totalItems " + arrayList5.size() + " has next " + i7Var3.f1004m);
                                    ...
                                    public final void run() {
                                        ...
                                        switch (r5) {
                                            case 0:
                                                ...
                                                FileLog.d("SelfStoryViewsPage " + storyItem2.f18563id + " response  totalItems " + arrayList3.size() + " has next " + i7Var22.f1004m);
                                                for (int i19 = 0; i19 < arrayList.size(); i19++) {
            ...
            tL_stories_getStoryViewsList.f18572id = storyItem.f18563id;
            tL_stories_getStoryViewsList.peer = MessagesController.getInstance(i11).getInputPeer(j3);
            if (this.f1008q) {
                tL_stories_getStoryViewsList.f18573q = "";
                ...
                tL_stories_getStoryViewsList.f18573q = str2;
                if (!TextUtils.isEmpty(str2)) {
            ...
            this.e = true;
            FileLog.d("SelfStoryViewsPage load next " + storyItem.f18563id + " " + this.f1003l + " offset=" + tL_stories_getStoryViewsList.offset + " q" + tL_stories_getStoryViewsList.f18573q + " " + tL_stories_getStoryViewsList.just_contacts + " " + tL_stories_getStoryViewsList.reactions_first);
