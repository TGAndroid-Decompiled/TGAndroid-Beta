    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        switch (i10) {
            ...
            case 17:
                ...
                return;
            case 18:
                AndroidUtilities.runOnUIThread(new qb1(28, (org.telegram.ui.web.g2) obj, tLObject));
                return;
            case 19:
                ...
                if (tLObject != null) {
                    ...
                    AndroidUtilities.runOnUIThread(new gr0(y0Var, hashMap, arrayList, 24));
                    return;
                }
                return;
            case 20:
            ...
            case 22:
                ...
                return;
            case 23:
                AndroidUtilities.runOnUIThread(new gr0((uf.d) obj, tLObject, tL_error, 28));
                return;
            case 24:
            ...
            default:
                ...
                if (tLObject instanceof TLRPC.TL_boolTrue) {
                    MessagesStorage.getInstance(q8Var.f47706c).putMessages(new ArrayList<>(Arrays.asList(q8Var.K.messageOwner)), true, true, true, 0, 0, 0L);
                    return;
                } else {
                    q8Var.getClass();
                    return;
