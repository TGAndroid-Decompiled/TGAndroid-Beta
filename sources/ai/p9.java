...
public final class p9 extends FrameLayout {
    public final ArrayList f1394a;
    public ValueAnimator f1395b;
    public int f1396c;
    public int d;
    public final a3.d e;
    ...
    public p9(Context context, xb xbVar) {
        ...
        while (i11 < size) {
            ...
            String str = o9Var.f1354a;
            int length = str.length();
            Rect rect = o9Var.f1359r;
            textPaint.getTextBounds(str, 0, length, rect);
            int width = rect.width();
            TextPaint textPaint2 = o9Var.f1357f;
            String str2 = o9Var.f1355b;
        ...
        ArrayList arrayList2 = this.f1394a;
    ...
    public final void a(boolean z10) {
        ValueAnimator valueAnimator = this.f1395b;
        ...
        this.f1395b.setDuration(350L);
        this.f1395b.setInterpolator(new AccelerateDecelerateInterpolator());
        this.f1395b.getCurrentPlayTime();
        this.f1395b.addListener(new b(this, 9));
        this.f1395b.addUpdateListener(new a(this, 12));
        this.f1395b.start();
        AndroidUtilities.runOnUIThread(this.e, (((o9) this.f1394a.get(this.d)).f1356c.r() * 2) + 100);
    }
    ...
    public final void b() {
        ...
        int i10 = this.f1396c;
        ArrayList arrayList = this.f1394a;
        if (i10 != -1) {
            o9 o9Var = (o9) arrayList.get(i10);
            xi0 xi0Var = o9Var.f1356c;
            xi0Var.M(0);
            xi0Var.stop();
            o9Var.f1358n = 0.0f;
            o9Var.invalidate();
