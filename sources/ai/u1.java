    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        switch (i10) {
            case 0:
                ...
                return;
            case 1:
                ((ConferenceCall) obj2).lambda$requestLastBlock$3(this.f1561b, (Runnable) obj, tLObject, tL_error);
                return;
            case 2:
                final fj0 fj0Var = (fj0) obj2;
                TLRPC.Chat chat = (TLRPC.Chat) obj;
                int i14 = fj0Var.f23960f;
                if (tLObject instanceof Vector) {
                    ...
                    if (ChatObject.isChannel(chat)) {
                        ...
                        tL_channels_getParticipants.channel = MessagesController.getInstance(i14).getInputChannel(chat.f18112id);
                                                    ...
                                                    case 0:
                                                        ...
                                                        if (tLObject3 != null) {
                                                            ...
                                                            for (int i17 = 0; i17 < tL_channels_channelParticipants.users.size(); i17++) {
                                                                ...
                                                                MessagesController.getInstance(fj0Var2.f23960f).putUser(user, false);
                                                                int indexOf = arrayList7.indexOf(Long.valueOf(user.f18259id));
                                                    ...
                                                    default:
                                                        ...
                                                        if (tLObject4 != null) {
                                                            ...
                                                            for (int i18 = 0; i18 < tL_messages_chatFull.users.size(); i18++) {
                                                                ...
                                                                MessagesController.getInstance(fj0Var2.f23960f).putUser(user2, false);
                                                                int indexOf2 = arrayList7.indexOf(Long.valueOf(user2.f18259id));
                                                ...
                                                switch (r7) {
                                                    case 0:
                                                        ...
                                                        if (tLObject3 != null) {
                                                            ...
                                                            for (int i17 = 0; i17 < tL_channels_channelParticipants.users.size(); i17++) {
                                                                TLRPC.User user = tL_channels_channelParticipants.users.get(i17);
                                                                MessagesController.getInstance(fj0Var3.f23960f).putUser(user, false);
                                                                int indexOf = arrayList10.indexOf(Long.valueOf(user.f18259id));
                                                                if (!user.self && indexOf >= 0) {
                                                    ...
                                                    default:
                                                        ...
                                                        if (tLObject4 != null) {
                                                            ...
                                                            for (int i18 = 0; i18 < tL_messages_chatFull.users.size(); i18++) {
                                                                TLRPC.User user2 = tL_messages_chatFull.users.get(i18);
                                                                MessagesController.getInstance(fj0Var3.f23960f).putUser(user2, false);
                                                                int indexOf2 = arrayList10.indexOf(Long.valueOf(user2.f18259id));
                                                                if (!user2.self && indexOf2 >= 0) {
            ...
            case 3:
                ...
                AndroidUtilities.runOnUIThread(new j21(tLObject, (MessagesController) obj2, this.f1561b, (xq) obj, 3));
                return;
            case 4:
                ...
                if (tLObject instanceof TLRPC.TL_contacts_found) {
                    ...
                    for (int i17 = 0; i17 < tL_contacts_found.chats.size(); i17++) {
                        ...
                        if (chat2.f18112id != j3 && ChatObject.isBoostSupported(chat2)) {
                ...
                return;
            case 5:
                AndroidUtilities.runOnUIThread(new j21((yh.v5) obj2, tLObject, this.f1561b, (Utilities.Callback) obj, 10));
                return;
            default:
                yh.u5 u5Var = (yh.u5) obj2;
                u5Var.getClass();
                AndroidUtilities.runOnUIThread(new org.telegram.messenger.voip.f(u5Var, tLObject, (MessagesController) obj, tL_error, this.f1561b));
                return;
        }
    }
