...
public final class s6 implements bl0 {
    public final jc f1501a;
    public final j7 f1502b;
    ...
    public final boolean d(int i10, View view) {
        ...
        j7 j7Var = this.f1502b;
        d dVar = j7Var.f1048s;
        int i11 = j7Var.v;
        if (view instanceof org.telegram.ui.Cells.n6) {
            final org.telegram.ui.Cells.n6 n6Var = (org.telegram.ui.Cells.n6) view;
            jc jcVar = this.f1501a;
            if (jcVar.v != null && (storyView = ((z6) j7Var.f1049w.f764c.get(i10)).f1781b) != null && (user = (messagesController = MessagesController.getInstance(i11)).getUser(Long.valueOf(storyView.user_id))) != null) {
                if (messagesController.blockePeers.indexOfKey(user.f18259id) >= 0) {
                    z10 = true;
                } else {
                    z10 = false;
                }
                if (!user.contact && ContactsController.getInstance(i11).contactsDict.get(Long.valueOf(user.f18259id)) == null) {
                    z11 = false;
                } else {
                    z11 = true;
                }
                ...
                F.f26350i = 3;
                F.f26352j = true;
                F.W(new ColorDrawable(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f18907h5, dVar)));
                F.f26368s = 133;
                ...
                F.l(R.drawable.msg_stories_myhide, LocaleController.formatString(R.string.StoryHideFrom, str), new Runnable(this) {
                    ...
                    public final void run() {
                        ...
                        s6 s6Var = this.f1422b;
                        switch (i12) {
                            case 0:
                                messagesController2.getStoriesController().j0(user2.f18259id, true, true);
                                j7 j7Var2 = s6Var.f1502b;
                                hg.k0.s(R.string.StoryHidFromToast, new Object[]{str3}, new vc(j7Var2, j7Var2.f1048s), R.raw.ic_ban, 36);
                                ...
                                return;
                            default:
                                messagesController2.getStoriesController().j0(user2.f18259id, false, true);
                                j7 j7Var3 = s6Var.f1502b;
                                hg.k0.s(R.string.StoryShownBackToToast, new Object[]{str3}, new vc(j7Var3, j7Var3.f1048s), R.raw.contact_check, 36);
                ...
                F.m(z14, R.drawable.msg_user_remove, LocaleController.getString(R.string.BlockUser), true, new Runnable(this) {
                    ...
                    public final void run() {
                        ...
                        switch (r6) {
                            case 0:
                                messagesController.blockPeer(user.f18259id);
                                j7 j7Var2 = this.f1463b.f1502b;
                                new vc(j7Var2, j7Var2.f1048s).e(true).j();
                            ...
                            default:
                                ...
                                TLRPC.User user2 = user;
                                storiesController.j0(user2.f18259id, false, true);
                                messagesController2.unblockPeer(user2.f18259id);
                                j7 j7Var3 = this.f1463b.f1502b;
                                new vc(j7Var3, j7Var3.f1048s).e(false).j();
