...
public final class xb extends qv0 {
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (jcVar.f1101p1 && currentPeerView != null && (gk0Var = currentPeerView.f850r3) != null) {
            ...
            if (currentPeerView.f850r3.getReactionsWindow() != null && currentPeerView.f850r3.getReactionsWindow().f49008c != null) {
                motionEvent.offsetLocation(-f7, (-f10) - currentPeerView.f850r3.getReactionsWindow().f49008c.getTranslationY());
                currentPeerView.f850r3.getReactionsWindow().f49008c.dispatchTouchEvent(motionEvent);
                return true;
            }
        ...
        if (motionEvent.getAction() != 1 && motionEvent.getAction() != 3) {
            ...
            if (f11 != 0.0f) {
                ...
                jcVar.G.setInterpolator(qr.f27380f);
                jcVar.G.start();
            }
            if (jcVar.V >= 0.3f) {
                jcVar.q(true);
