...
public final class nb extends View {
    ...
    public int h;
    public final Drawable[] f1310n;
    public final float[] f1311r;
    public boolean f1312s;
    public final Paint v;
    public final Path f1313w;
    public final wc f1314x;
    ...
    public nb(Context context) {
        ...
        this.f1310n = new Drawable[2];
        this.f1311r = new float[2];
        Paint paint = new Paint(1);
        this.v = paint;
        this.f1313w = new Path();
        this.f1314x = new wc(this, 0.6f, 5.0f);
    ...
    public final void a(boolean z10, k9 k9Var, boolean z11) {
        ...
        this.f1309f = true;
        int i10 = 0;
        if (k9Var != null && (gaVar = k9Var.f1138c.E0) != null) {
            int i11 = gaVar.f4720a;
    ...
    public final void c(float f7, int i10) {
        ...
        Drawable[] drawableArr = this.f1310n;
        Drawable drawable = drawableArr[0];
        drawableArr[1] = drawable;
        float[] fArr = this.f1311r;
        fArr[1] = fArr[0];
    ...
    public final void d(int i10, int i11) {
        ...
        if (this.f1306a == i10 && this.f1307b == i11) {
            return;
        }
        this.f1306a = i10;
        this.f1307b = i11;
