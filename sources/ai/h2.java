...
public final class h2 implements ScaleGestureDetector.OnScaleGestureListener {
    ...
    public final boolean onScale(ScaleGestureDetector scaleGestureDetector) {
        ...
        o1.k kVar3 = m2Var.Q;
        kVar3.f15342b = m2Var.O;
        kVar3.f15343c = true;
        kVar3.f15351u.f15357i = w7.p.a(scaleGestureDetector.getFocusY() - (m2Var.K / 2.0f), AndroidUtilities.dp(16.0f), (AndroidUtilities.displaySize.y - m2Var.K) - AndroidUtilities.dp(16.0f));
        o1.k kVar4 = m2Var.Q;
        if (!kVar4.f15344f) {
            kVar4.f();
        }
    ...
    public final boolean onScaleBegin(ScaleGestureDetector scaleGestureDetector) {
        ...
        m2Var.F = true;
        m2Var.f1229c.width = (int) (m2Var.n() * m2Var.f1227a);
        m2Var.f1229c.height = (int) (m2Var.m() * m2Var.f1227a);
        AndroidUtilities.updateViewLayout(m2Var.f1228b, m2Var.d, m2Var.f1229c);
        return true;
    }
    ...
    public final void onScaleEnd(ScaleGestureDetector scaleGestureDetector) {
        m2 m2Var = m2.Z;
        if (!m2Var.P.f15344f && !m2Var.Q.f15344f) {
            a();
            return;
        }
