...
public final class h2 implements ScaleGestureDetector.OnScaleGestureListener {
    ...
    public final boolean onScale(ScaleGestureDetector scaleGestureDetector) {
        ...
        o1.k kVar3 = m2Var.Q;
        kVar3.f15340b = m2Var.O;
        kVar3.f15341c = true;
        kVar3.f15349u.f15355i = w7.p.a(scaleGestureDetector.getFocusY() - (m2Var.K / 2.0f), AndroidUtilities.dp(16.0f), (AndroidUtilities.displaySize.y - m2Var.K) - AndroidUtilities.dp(16.0f));
        o1.k kVar4 = m2Var.Q;
        if (!kVar4.f15342f) {
            kVar4.f();
        }
    ...
    public final void onScaleEnd(ScaleGestureDetector scaleGestureDetector) {
        m2 m2Var = m2.Z;
        if (!m2Var.P.f15342f && !m2Var.Q.f15342f) {
            a();
            return;
        }
