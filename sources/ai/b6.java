...
public final class b6 {
    ...
    public final jj0 f602t;
    public final jj0 f603u;
    ...
    public b6(Context context) {
        ...
        this.f603u = new jj0(R.raw.media_mute_unmute, AndroidUtilities.dp(28.0f), AndroidUtilities.dp(28.0f), true, null);
        jj0 jj0Var = new jj0(R.raw.media_mute_unmute, AndroidUtilities.dp(28.0f), AndroidUtilities.dp(28.0f), true, null);
        this.f602t = jj0Var;
        jj0Var.N(20, false, true);
        jj0Var.stop();
    ...
    public final void a(boolean z10, boolean z11) {
        ...
        if (!z11) {
            ...
            jj0Var.N(i10, false, false);
            if (!z10) {
                i11 = 0;
            }
            jj0Var.P(i11);
        } else if (z10) {
            if (jj0Var.f25422a0 > 20) {
                jj0Var.N(0, false, false);
            }
            jj0Var.P(20);
            jj0Var.start();
        } else {
            int i12 = jj0Var.f25422a0;
            if (i12 != 0 && i12 < 43) {
                jj0Var.P(43);
                jj0Var.start();
            }
