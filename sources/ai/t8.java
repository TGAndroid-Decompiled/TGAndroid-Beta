...
public final class t8 extends d9 {
    ...
    public final void C(ArrayList arrayList, boolean z10) {
        ...
        ArrayList arrayList5 = this.f716i;
        arrayList5.clear();
    ...
    public final void F(ArrayList arrayList) {
        int i10 = 0;
        while (true) {
            ArrayList arrayList2 = this.f716i;
    ...
    public final void G(TLRPC.InputMedia inputMedia, TL_bots.botPreviewMedia botpreviewmedia) {
            ...
            if (i10 < arrayList.size()) {
                ...
                if (inputMedia != null && (storyItem = messageObject.storyItem) != null && (messageMedia = storyItem.media) != null) {
                    if (inputMedia instanceof TLRPC.TL_inputMediaPhoto) {
                        ...
                        if (photo != null && photo.f18136id == ((TLRPC.TL_inputMediaPhoto) inputMedia).f18175id.f18131id) {
                            break;
                        }
                    } else if ((inputMedia instanceof TLRPC.TL_inputMediaDocument) && (document = messageMedia.document) != null && document.f18118id == ((TLRPC.TL_inputMediaDocument) inputMedia).f18173id.f18124id) {
                        break;
                    }
                }
                i10++;
        ...
        MessageObject messageObject2 = new MessageObject(this.f713c, new s8(this, this.d, botpreviewmedia));
    ...
    public final void I(TL_bots.botPreviewMedia botpreviewmedia) {
        MessageObject messageObject = new MessageObject(this.f713c, new s8(this, this.d, botpreviewmedia));
        TL_stories.StoryItem storyItem = messageObject.storyItem;
        TLRPC.Message message = messageObject.messageOwner;
        int i10 = this.I;
        this.I = i10 + 1;
        message.f18133id = i10;
        storyItem.f18348id = i10;
        ...
        this.f716i.add(0, messageObject);
        y8 y8Var = this.f724q;
        AndroidUtilities.cancelRunOnUIThread(y8Var);
        AndroidUtilities.runOnUIThread(y8Var);
    }
