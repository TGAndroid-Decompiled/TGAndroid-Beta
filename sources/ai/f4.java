...
public final class f4 implements ka0 {
    ...
    public final void L(int i10, int i11, CharSequence charSequence, boolean z10) {
        this.f787a.f795b2.O0(i10, i11, charSequence, z10);
    }

    @Override
    public final void O(String str) {
        a4 a4Var = this.f787a.f795b2;
        a4Var.U();
        a4Var.U0.h(str);
    }
    ...
    public final Paint.FontMetricsInt w() {
        return this.f787a.f795b2.getEditField().getPaint().getFontMetricsInt();
    }
}
