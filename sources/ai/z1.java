...
public final class z1 implements RequestDelegateTimestamp, MessagesStorage.StringCallback, m4.f1, ImageReceiver.ImageReceiverDelegate, org.telegram.ui.Components.b5, fd0, MessagesStorage.BooleanCallback, g2.g, org.telegram.ui.ActionBar.b2, b70, s5.e {
    ...
    public void J(int i10, int i11, boolean z10) {
        ...
        long j3 = this.f1777b;
        if (niVar != chatAttachAlertPhotoLayout && niVar != viVar.f28777q0) {
    ...
    public void f(org.telegram.ui.ActionBar.c2 c2Var, int i10) {
        switch (this.f1776a) {
            case 8:
                sn0 sn0Var = ((wy) this.f1778c).C0.f30551c0;
                ...
                return;
            default:
                ((iy) this.f1778c).f34710a.getMediaDataController().removePeer(this.f1777b);
                return;
        }
    }
    ...
    public void j(int i10, ArrayList arrayList) {
        ...
        org.telegram.ui.ActionBar.o2 o2Var = pf1Var.f36625b;
