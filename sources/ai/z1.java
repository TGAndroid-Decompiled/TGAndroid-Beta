...
public final class z1 implements RequestDelegateTimestamp, MessagesStorage.StringCallback, m4.f1, ImageReceiver.ImageReceiverDelegate, org.telegram.ui.Components.b5, dd0, MessagesStorage.BooleanCallback, g2.g, org.telegram.ui.ActionBar.a2, z60, s5.e {
    ...
    public Object apply(Object obj) {
        l5.i iVar = (l5.i) this.f1773c;
        SQLiteDatabase sQLiteDatabase = (SQLiteDatabase) obj;
        ContentValues contentValues = new ContentValues();
        contentValues.put("next_request_ms", Long.valueOf(this.f1772b));
        ...
        if (sQLiteDatabase.update("transport_contexts", contentValues, "backend_name = ? and priority = ?", new String[]{str, String.valueOf(v5.a.a(dVar))}) < 1) {
            contentValues.put("backend_name", iVar.f13897a);
    ...
    public void b(TLRPC.MessageMedia messageMedia, int i10, boolean z10, int i11, long j3) {
        ...
        switch (i12) {
            case 5:
                ...
                SendMessagesHelper.getInstance(((LocationController.SharingLocationInfo) obj).messageObject.currentAccount).sendMessage(SendMessagesHelper.SendMessageParams.of(messageMedia, this.f1772b, (MessageObject) null, (MessageObject) null, (TLRPC.ReplyMarkup) null, (HashMap<String, String>) null, true, 0, 0));
                return;
            default:
                Pattern pattern = LaunchActivity.B1;
                SendMessagesHelper.getInstance(((int[]) obj)[0]).sendMessage(SendMessagesHelper.SendMessageParams.of(messageMedia, this.f1772b, (MessageObject) null, (MessageObject) null, (TLRPC.ReplyMarkup) null, (HashMap<String, String>) null, true, 0, 0));
                return;
        }
    }
    ...
    public g2.h createDataSource() {
        return new b71(((g71) this.f1773c).h.createDataSource(), this.f1772b);
    }

    @Override
    public void didSetImage(ImageReceiver imageReceiver, boolean z10, boolean z11, boolean z12) {
        org.telegram.ui.x5 x5Var = (org.telegram.ui.x5) this.f1773c;
        ...
        if (z10 && bitmapSafe != null) {
            ...
            x5Var.onComplete(new Pair(Long.valueOf(this.f1772b), bitmap));
        }
    }
    ...
    public void f(org.telegram.ui.ActionBar.b2 b2Var, int i10) {
        switch (this.f1771a) {
            case 8:
                rn0 rn0Var = ((uy) this.f1773c).C0.f30287b0;
                a0.i iVar = rn0Var.f9786x0;
                long j3 = this.f1772b;
                gg.h0 h0Var = (gg.h0) iVar.f(j3);
                if (h0Var != null) {
                    rn0Var.f9786x0.l(j3);
                    rn0Var.f9780t0.remove(h0Var);
                    rn0Var.f9782v0.remove(h0Var);
                    rn0Var.f9781u0.remove(h0Var);
                    rn0Var.l();
                    MessagesStorage.getInstance(rn0Var.f9779s0).getStorageQueue().postRunnable(new gg.q(rn0Var, j3, 0));
                    return;
                }
                return;
            default:
                ((gy) this.f1773c).f34036a.getMediaDataController().removePeer(this.f1772b);
                return;
        }
    }
    ...
    public Object h(m4.a0 a0Var, m4.r rVar, int i10) {
        return a0Var.q(rVar, e9.i0.z((b2.k0) this.f1773c), 0, this.f1772b);
    }

    @Override
    public void j(int i10, ArrayList arrayList) {
        nf1 nf1Var = (nf1) this.f1773c;
        org.telegram.ui.ActionBar.n2 n2Var = nf1Var.f35971b;
        ...
        while (i11 < size) {
            ...
            f fVar = new f(18);
            long j3 = this.f1772b;
            messagesController.addUserToChat(j3, (TLRPC.User) arrayList.get(i11), i10, null, n2Var, false, fVar, null, new ei.s3(nf1Var, tL_messages_invitedUsers, iArr, size, arrayList, j3));
            i11++;
            size = size;
            iArr = iArr;
    ...
    public void run(TLObject tLObject, TLRPC.TL_error tL_error, long j3) {
        d2 d2Var = (d2) this.f1773c;
        if (tL_error == null) {
            if (d2Var.E == null || d2Var.f690w) {
                return;
            }
            ...
            if (d2Var.G == null && !groupcallstreamchannels.channels.isEmpty()) {
                ...
                tL_groupCallParticipant.peer = MessagesController.getInstance(d2Var.e).getPeer(d2Var.f684b);
        ...
        if (nativeInstance2 != null) {
            nativeInstance2.onRequestTimeComplete(this.f1772b, r0);
        }
    }
    ...
    public void run(String str) {
        ci.ba baVar = (ci.ba) this.f1773c;
        baVar.W.i1().r(this.f1772b, str, new ci.q9(baVar, 2));
    }

    @Override
    public void run(boolean z10) {
        bo boVar = ((x21) this.f1773c).h;
        if (com.google.android.gms.internal.vision.e2.u(boVar)) {
            boVar.qa(this.f1772b, false);
        }
    }
