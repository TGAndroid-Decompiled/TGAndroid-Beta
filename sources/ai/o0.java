    ...
    public final void run() {
        switch (this.f1324a) {
            case 0:
                ...
                return;
            case 1:
                r3 r3Var2 = this.f1325b;
                AndroidUtilities.cancelRunOnUIThread(r3Var2.f1332d0);
                ...
                return;
            default:
                r3 r3Var3 = this.f1325b;
                r3Var3.e.N(true);
                r3Var3.f1337n.N(true);
                return;
        }
    }
}
