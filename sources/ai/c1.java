...
public final class c1 extends Drawable {
    ...
    public final void draw(Canvas canvas) {
        ...
        this.f635c.c(bounds.centerX() - (this.f635c.f28649c / 2.0f), AndroidUtilities.dp(0.15f) + centerY, drawable.getAlpha() / 255.0f, -1, canvas);
        canvas.restore();
    }
