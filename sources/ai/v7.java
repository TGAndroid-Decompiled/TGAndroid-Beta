...
public final class v7 extends FrameLayout {
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        switch (this.f1613a) {
            ...
            case 7:
                ...
                float max = Math.max(dp2 + dp2, x21Var.f29832f.d() + AndroidUtilities.dp(10.0f));
                if (z10) {
                    i11 = i13;
                    f10 = dp3;
                    f7 = width2;
                ...
                if (i11 > 0) {
                    ...
                    g6Var.setColor(org.telegram.ui.ActionBar.j6.l1(g10, g6Var.f24094b.a(org.telegram.ui.ActionBar.j6.v0(x21Var.E, g6Var.f24093a), false)));
                    canvas.drawRoundRect(rectF4, dp2, dp2, g6Var);
                    x21Var.f29832f.m(rectF4);
                    org.telegram.ui.Components.m6 m6Var = x21Var.f29832f;
            ...
            case 8:
                ...
                paint3.setColor(g70Var.getThemedColor(org.telegram.ui.ActionBar.j6.f18862d6));
                canvas.save();
    ...
    public boolean drawChild(Canvas canvas, View view, long j3) {
        switch (this.f1613a) {
            case 2:
                ...
                return drawChild;
            case 10:
                qg.t2 t2Var = ((qg.v2) this.d).f41709f;
                if (view == t2Var) {
                    canvas.save();
            ...
            case 12:
                ...
                if (((yh.s7) this.d).e > 1) {
                    paint.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f18862d6, (org.telegram.ui.ActionBar.f6) this.f1615c));
    ...
    public void onDraw(Canvas canvas) {
        switch (this.f1613a) {
            case 4:
                super.onDraw(canvas);
                Paint paint = (Paint) this.f1615c;
                paint.setColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19082p7, false));
                canvas.save();
    ...
    public boolean verifyDrawable(Drawable drawable) {
        switch (this.f1613a) {
            case 7:
                if (((x21) this.d).f29832f != drawable && !super.verifyDrawable(drawable)) {
                    return false;
                }
                return true;
            default:
    ...
    public v7(Context context, org.telegram.ui.ActionBar.f6 f6Var, boolean z10) {
        ...
        textView2.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19263z6, f6Var));
    ...
    public v7(x21 x21Var, Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        x21Var.f29832f.setCallback(this);
    }
