...
public abstract class o1 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public org.telegram.ui.Components.ic f1324a0;
    public final FrameLayout f1325b;
    public org.telegram.ui.Components.mc f1326b0;
    public final w0 f1327c;
    public org.telegram.ui.Components.hc f1328c0;
    public final s4.c0 d;
    public final o0 f1329d0;
    public final x0 e;
    public ValueAnimator f1330e0;
    public final ec1 f1331f;
    public boolean f1332f0;
    public final o0 f1333g0;
    public final s4.c0 h;
    public final w51 f1334n;
    ...
    public o1(Context context, jc jcVar, ViewGroup viewGroup, View view, FrameLayout frameLayout) {
        ...
        this.f1329d0 = new o0(r3Var, 1);
        this.f1332f0 = false;
        this.f1333g0 = new o0(r3Var, 2);
        this.f1323a = view;
        ...
        x0 x0Var = new x0(r3Var, w0Var, context, i10, new Utilities.Callback2() {
            ...
            public final void run(Object obj, Object obj2) {
                ...
                switch (i11) {
                    case 0:
                        ArrayList arrayList2 = r3Var2.f1335r;
                        d2 d2Var = r3Var2.P;
                        if (d2Var == null) {
                            j3 = 0;
                        } else {
                        ...
                        while (i12 < arrayList2.size()) {
                            ...
                            if (m1Var.f1225b || !m1Var.e || m1Var.f1228g >= j3) {
                                int i13 = g1.f888a;
                        ...
                        return;
                    default:
                        ArrayList arrayList3 = r3Var2.f1336s;
        ...
        w51 w51Var = new w51(ec1Var, context, i10, 0, false, new Utilities.Callback2() {
            @Override
            public final void run(Object obj, Object obj2) {
                long j3;
                int i11 = r2;
    ...
    public static Integer a(o1 o1Var, Long l4) {
        ...
        org.telegram.ui.Components.oc M = new vc(o1Var.f1325b, new d()).M(o1Var.getStarsToastTitle(), o1Var.getStarsToastSubtitle(), R.raw.stars_topup);
        boolean z10 = false;
        M.f26759r = false;
        M.k(true);
        long j3 = 0;
    ...
    public final void b() {
        this.R = 0L;
        h(getDefaultPeerId());
        x2 x2Var = ((r3) this).f1459i0.Z1;
        w2 w2Var = x2Var.f1683a;
        w2Var.c(x2Var);
        w2Var.b();
        j();
    }
    ...
    public final void c(int i10) {
        ...
        int i11 = 0;
        while (true) {
            arrayList = this.f1335r;
            if (i11 < arrayList.size()) {
                if (((m1) arrayList.get(i11)).f1224a == i10) {
        ...
        if (m1Var != null) {
            ...
            int i12 = 0;
            while (true) {
                arrayList2 = this.f1336s;
                if (i12 >= arrayList2.size()) {
                    break;
                } else if (((n1) arrayList2.get(i12)).f1279f.contains(m1Var)) {
                    ((n1) arrayList2.get(i12)).f1279f.remove(m1Var);
    ...
    public final h1 d(int i10) {
        ...
        while (true) {
            ...
            if (i11 < w0Var.getChildCount()) {
                ...
                if ((childAt instanceof h1) && (m1Var = (h1Var = (h1) childAt).K) != null && m1Var.f1224a == i10) {
                    return h1Var;
                }
                i11++;
            } else {
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.liveStoryMessageUpdate) {
            ...
            if (tLObject instanceof TL_update.TL_updateGroupCallMessage) {
                ...
                if (inputGroupCall2 != null && inputGroupCall2.f18126id == longValue) {
    ...
    public final boolean f() {
        ...
        if (getDefaultPeerId() >= 0 || getDefaultPeerId() == this.M) {
            ...
            d2 d2Var = this.P;
            if (d2Var != null && (inputGroupCall = this.O) != null && inputGroupCall.f18126id == d2Var.g() && (groupCall = this.P.v) != null && groupCall.creator) {
                return true;
            }
    ...
    public int getUnreadMessagesCount() {
        ...
        int i11 = 0;
        while (true) {
            ArrayList arrayList = this.f1335r;
            if (i10 < arrayList.size()) {
                m1 m1Var = (m1) arrayList.get(i10);
                int i12 = m1Var.f1224a;
                if (i12 >= 0 && i12 > this.F && (m1Var.f1225b || !m1Var.e || m1Var.f1228g >= j3)) {
                    i11++;
                }
                i10++;
            } else {
    ...
    public final void l(int i10, int i11, boolean z10, long j3, TLRPC.TL_textWithEntities tL_textWithEntities, long j10, boolean z11) {
        ...
        while (true) {
            ...
            if (i13 < arrayList.size()) {
                if (((m1) arrayList.get(i13)).f1224a != i11) {
                    i13++;
                } else {
                    return;
                }
                ...
                obj.f1225b = z10;
                obj.f1226c = j3;
                obj.f1227f = tL_textWithEntities;
                obj.f1228g = j10;
                obj.f1224a = i11;
                obj.e = TextUtils.isEmpty(tL_textWithEntities.text);
                int b10 = g0.b(i14, (int) obj.f1228g, 0);
                long j11 = obj.f1228g;
                ArrayList arrayList2 = this.f1336s;
                boolean z13 = true;
                if (j11 > 0 && b10 > 0 && currentTime - obj.d <= b10) {
                    int i15 = 0;
                    while (true) {
                        if (i15 < arrayList2.size()) {
                            if (((n1) arrayList2.get(i15)).f1277b == j3) {
                ...
                if (obj.f1224a >= 0) {
                    for (int size = arrayList.size() - 1; size >= 0; size--) {
                        if (obj.f1224a < ((m1) arrayList.get(size)).f1224a) {
                            i12 = size + 1;
                            break;
                        }
                    }
                ...
                if (i12 <= 0 && !z11 && (!this.f1327c.canScrollVertically(1) || obj.f1224a < 0)) {
                ...
                invalidate();
                r3 r3Var = (r3) this;
                c cVar = r3Var.f1459i0.X1;
                if (cVar != null) {
                    cVar.setCount(r3Var.getUnreadMessagesCount());
                }
                if (!z11 && i11 > 0 && obj.f1228g > 0) {
                    int i17 = 0;
                    while (true) {
                        if (i17 < this.T.size()) {
                            if (DialogObject.getPeerDialogId(((TL_phone.groupCallDonor) this.T.get(i17)).peer_id) == obj.f1226c) {
                    ...
                    if (groupcalldonor == null) {
                        ...
                        if (UserConfig.getInstance(i14).getClientUserId() != obj.f1226c) {
                            z13 = false;
                        }
                        groupcalldonor.my = z13;
                        groupcalldonor.peer_id = MessagesController.getInstance(i14).getPeer(obj.f1226c);
                        groupcalldonor.stars = 0L;
                        for (int i18 = 0; i18 < arrayList2.size(); i18++) {
                            if (((n1) arrayList2.get(i18)).f1277b == obj.f1226c) {
                    ...
                    i((int) j15, (int) j14, obj.f1226c);
                }
                t();
                if (z11) {
                    o0 o0Var = this.f1333g0;
    ...
    public final void m() {
        ...
        ArrayList arrayList = this.f1336s;
        int size = arrayList.size();
        ...
        while (i11 < size) {
            ...
            i11++;
            n1 n1Var = (n1) obj;
            ArrayList arrayList2 = n1Var.f1279f;
            ...
            while (i14 < size2) {
                ...
                if (m1Var.f1228g > 0) {
                    ...
                    i10 = i15;
                    i13 = Math.max(i13, g0.b(n1Var.f1276a, (int) m1Var.f1228g, 0) + m1Var.d);
                } else {
                    i10 = i15;
                }
                ...
                if (z11) {
                    ...
                    while (i14 < size) {
                        ...
                        if (sendgroupcallmessage.random_id == tL_updateMessageID.random_id) {
                            int i15 = tL_updateMessageID.f18362id;
                            ArrayList arrayList = o1Var.f1335r;
    ...
    public final void p() {
        ...
        if (ocVar == null || !ocVar.f26753l) {
            ...
            this.f1324a0.f24998b.setText(getStarsToastTitle());
            ...
            this.f1326b0.f26136a = new n0((r3) this, 0);
            ...
            this.f1326b0.addView(this.f1328c0, w7.x5.d(20, 20.0f, 21, 0.0f, 0.0f, 12.0f, 0.0f));
            this.f1326b0.d.setPadding(AndroidUtilities.dp(12.0f), AndroidUtilities.dp(8.0f), AndroidUtilities.dp(30.0f), AndroidUtilities.dp(8.0f));
            this.f1324a0.setButton(this.f1326b0);
            org.telegram.ui.Components.oc f7 = org.telegram.ui.Components.oc.f(this.f1325b, this.f1324a0, -1);
            this.W = f7;
            f7.f26759r = false;
            f7.k(true);
            this.W.v = o0Var;
        ...
        this.f1324a0.f24998b.setText(getStarsToastTitle());
        this.f1324a0.f24999c.setText(getStarsToastSubtitle());
        this.f1328c0.f24662b = 5000L;
        AndroidUtilities.cancelRunOnUIThread(o0Var);
        ...
        w2Var.invalidate();
        org.telegram.ui.Components.m6 m6Var = w2Var.f1640c;
        m6Var.b();
        ...
        long j10 = currentTimeMillis - x2Var.f1692y;
        if (j10 < 100) {
            x2Var.E += 0.5f;
        } else {
            ...
            x2Var.E = 0.0f;
            x2Var.f1692y = currentTimeMillis;
        }
        j();
    }
    ...
    public final boolean r(long j3, TLRPC.InputGroupCall inputGroupCall) {
        ...
        if (inputGroupCall2 == null) {
            ...
            j10 = inputGroupCall2.f18126id;
        }
        if (inputGroupCall != null) {
            j11 = inputGroupCall.f18126id;
        }
        if (j10 != j11) {
            this.f1335r.clear();
            z10 = true;
    ...
    public void setLivePlayer(d2 d2Var) {
        ...
        this.P = d2Var;
        if (z10 && d2Var != null && (arrayList = d2Var.U) != null && (arrayList2 = d2Var.V) != null && arrayList != (arrayList3 = this.f1335r) && arrayList2 != (arrayList4 = this.f1336s) && arrayList3.isEmpty() && arrayList4.isEmpty()) {
    ...
    public final void t() {
        ...
        int i16 = 0;
        while (true) {
            ArrayList arrayList3 = this.f1335r;
            if (i16 >= arrayList3.size()) {
                break;
            }
            m1 m1Var3 = (m1) arrayList3.get(i16);
            int e7 = e(m1Var3.f1226c);
            if (e7 != m1Var3.h) {
                m1Var3.h = e7;
            }
            i16++;
        ...
        int i17 = 0;
        while (true) {
            ec1 ec1Var = this.f1331f;
            if (i17 >= ec1Var.getChildCount()) {
                break;
            }
            View childAt2 = ec1Var.getChildAt(i17);
            if ((childAt2 instanceof l1) && (n1Var = (l1Var = (l1) childAt2).f1171f) != null) {
                int e10 = e(n1Var.f1277b);
        ...
        while (true) {
            ArrayList arrayList4 = this.f1336s;
            if (i10 < arrayList4.size()) {
                n1 n1Var3 = (n1) arrayList4.get(i10);
                int e11 = e(n1Var3.f1277b);
                if (e11 != n1Var3.e) {
                    n1Var3.e = e11;
                }
                i10++;
