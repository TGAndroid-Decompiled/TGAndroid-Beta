...
public abstract class o1 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
                ...
                if (z11) {
                    ...
                    while (i14 < size) {
                        ...
                        if (sendgroupcallmessage.random_id == tL_updateMessageID.random_id) {
                            int i15 = tL_updateMessageID.f18375id;
    ...
    public final void p() {
        ...
        if (ocVar == null || !ocVar.f26704l) {
            ...
            this.f1327a0.f24923b.setText(getStarsToastTitle());
            ...
            this.f1329b0.f26122a = new n0((r3) this, 0);
        ...
        this.f1327a0.f24923b.setText(getStarsToastTitle());
        this.f1327a0.f24924c.setText(getStarsToastSubtitle());
        this.f1331c0.f24623b = 5000L;
        AndroidUtilities.cancelRunOnUIThread(o0Var);
