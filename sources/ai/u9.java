                    ...
                    if (i11 < arrayList.size()) {
                        ...
                        if (z6Var != null) {
                            ...
                            if (storyReaction instanceof TL_stories.TL_storyReactionPublicRepost) {
                                ...
                                if (tL_storyReactionPublicRepost.story != null && DialogObject.getPeerDialogId(tL_storyReactionPublicRepost.peer_id) == j3 && tL_storyReactionPublicRepost.story.f18357id == i10) {
                                    break;
                                }
                            } else {
                                continue;
        ...
        if (viewGroup != null) {
            ...
            while (i13 < viewGroup.getChildCount()) {
                ...
                if (childAt instanceof a0) {
                    ...
                    org.telegram.ui.Cells.j2 j2Var = r2Var.f20768u0;
                    ...
                    if (n6Var.f20488x != j3) {
                        ...
                        if (n6Var.f20484n == i11 && z10) {
                            ...
                            if (alphaInternal < 1.0f) {
                                ...
                                gcVar.f921j = paint;
                                paint.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f18933h5, n6Var.getResourcesProvider()));
                            }
                            c(gcVar);
                            return true;
                        } else if (!z10) {
                            org.telegram.ui.Cells.m6 m6Var = n6Var.f20482c;
                            gcVar.f915a = m6Var;
                            gcVar.f924m = n6Var.f20489y;
                            ...
                            if (alphaInternal2 < 1.0f) {
                                ...
                                gcVar.f921j = paint2;
                                paint2.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f18933h5, n6Var.getResourcesProvider()));
                            }
                            c(gcVar);
                            return true;
                        }
                    ...
                    if (h6Var.getDialogId() == j3) {
                        gcVar.f915a = h6Var;
                        gcVar.f924m = h6Var.f20216u0;
                        gcVar.f916b = h6Var.f20211r;
