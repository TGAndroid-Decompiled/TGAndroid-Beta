...
public final class z8 implements Runnable {
    ...
    private final void a() {
        ...
        ConnectionsManager.getInstance(v5Var.f47923a).sendRequest(tL_payments_canPurchaseStore, new mh1(oVar, hVar, m0Var, activity, tL_inputStorePaymentStarsGiveaway, list, 3));
    }
