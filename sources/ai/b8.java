...
public final class b8 implements RequestDelegate {
    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        switch (this.f588a) {
            case 0:
                AndroidUtilities.runOnUIThread(new h3((l9) this.d, tL_error, this.f589b, this.f590c, (e2.h) this.e, (org.telegram.ui.ActionBar.e6) this.f591f));
                return;
            default:
                AndroidUtilities.runOnUIThread(new h21((yh.g) this.d, tL_error, (TwoStepVerificationActivity) this.e, (Activity) this.f591f, this.f589b, this.f590c, tLObject));
                return;
        }
    }
