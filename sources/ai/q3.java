    ...
    public final boolean onLongClick(View view) {
        switch (this.f1418a) {
            ...
            case 1:
                ...
                ci.p5 p5Var = ((org.telegram.ui.Components.d0) this.f1419b).f23167n;
                if (p5Var != null) {
            ...
            case 5:
                ...
                org.telegram.ui.ActionBar.o1 b10 = org.telegram.ui.Components.m9.b(profileActivity, imageView, profileActivity.a(), profileActivity.f31297g1, profileActivity.f31425z0);
                if (b10 != null) {
                    b10.setOnDismissListener(new org.telegram.ui.e0(profileActivity, 3));
                    profileActivity.f31406w0 = imageView;
            ...
            default:
                ...
                if (s00Var.f27731c) {
                    ...
                    for (int i10 = 0; i10 < size; i10++) {
                        ((ja1) arrayList.get(i10)).f34829a.setChecked(false);
                        ((ja1) arrayList.get(i10)).f34830b.f13631n = false;
                        if (ka1Var.f35178r.f35743c > 0 && i10 < gVar.d.size()) {
                    ...
                    fVar.f13631n = true;
                    ka1Var.f35174b.z();
                    if (ka1Var.f35178r.f35743c > 0) {
                        ((kg.f) gVar.d.get(ja1Var.f34831c)).f13631n = true;
                        gVar.z();
                    }
                }
                return z10;
