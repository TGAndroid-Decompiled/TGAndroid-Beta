...
public final class a0 extends FrameLayout {
    ...
    public final org.telegram.ui.Components.c6 f491a0;
    public int f492b;
    public final lx f493b0;
    public boolean f494c;
    public boolean d;
    public da e;
    public TLRPC.User f495f;
    public TLRPC.Chat h;
    public final org.telegram.ui.Components.f9 f496n;
    public final ImageReceiver f497r;
    public final ImageReceiver f498s;
    public final org.telegram.ui.Components.f9 v;
    public boolean f499w;
    public final FrameLayout f500x;
    public org.telegram.ui.ActionBar.j5 f501y;

    public a0(lx lxVar, Context context) {
        super(context);
        boolean z10;
        this.f493b0 = lxVar;
        this.f496n = new org.telegram.ui.Components.f9((org.telegram.ui.ActionBar.e6) null);
        ImageReceiver imageReceiver = new ImageReceiver(this);
        this.f497r = imageReceiver;
        ImageReceiver imageReceiver2 = new ImageReceiver(this);
        this.f498s = imageReceiver2;
        ...
        this.Q = 1.0f;
        this.T = 1.0f;
        this.f491a0 = new org.telegram.ui.Components.c6(this, 0L, 350L, qr.h);
        if (lxVar.f537b == 1) {
            z10 = true;
        } else {
            z10 = false;
    ...
    public final void b() {
        ...
        this.f501y.setGravity(17);
        this.f501y.setTextSize(11);
        this.f501y.setTextColor(b0.a(this.f493b0));
        NotificationCenter.listenEmojiLoading(this.f501y);
        this.f501y.setMaxLines(1);
        this.f500x.addView(this.f501y, w7.x5.d(-1, -2.0f, 0, 1.0f, 0.0f, 1.0f, 0.0f));
        this.f497r.setRoundRadius(AndroidUtilities.dp(48.0f) / 2);
        this.f498s.setRoundRadius(AndroidUtilities.dp(48.0f) / 2);
    }

    public final void c(Canvas canvas, float f7, float f10, float f11) {
        int i10;
        lx lxVar = this.f493b0;
        int i11 = lxVar.f537b;
        Paint paint = lxVar.G;
        l9 l9Var = lxVar.f558s;
        Paint paint2 = lxVar.H;
        Drawable drawable = lxVar.f539c;
        if (this.F && !l9Var.I(this.E) && Utilities.isNullOrEmpty(l9Var.E(this.E))) {
            ...
            if (i11 == 0) {
                paint2.setColor(org.telegram.ui.ActionBar.i6.l1(f11, lxVar.f(org.telegram.ui.ActionBar.i6.f19113s8)));
            } else {
    ...
    public final void d(float f7, float f10, float f11, boolean z10) {
        ...
        FrameLayout frameLayout = this.f500x;
    ...
    public float getCy() {
        ...
        return AndroidUtilities.lerp(AndroidUtilities.dp(5.0f), (org.telegram.ui.ActionBar.k.getCurrentActionBarHeight() - dp) / 2.0f, this.f493b0.f540c0) + (AndroidUtilities.lerp(AndroidUtilities.dp(48.0f), dp, this.J) / 2.0f);
    }

    @Override
    public final void invalidate() {
        if (this.N || (this.f490a && getParent() != null)) {
    ...
    public final void onAttachedToWindow() {
        ...
        this.f497r.onAttachedToWindow();
        this.f498s.onAttachedToWindow();
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        this.f497r.onDetachedFromWindow();
        this.f498s.onDetachedFromWindow();
        this.O.g();
        da daVar = this.e;
        if (daVar != null) {
            daVar.a();
    ...
    public void setCrossfadeTo(long j3) {
        ...
        if (this.I != j3) {
            ...
            this.H = z10;
            ImageReceiver imageReceiver = this.f498s;
            if (z10) {
                if (j3 > 0) {
