...
public class d9 {
    ...
    public final void A(List list) {
        ...
        if (list != null) {
            ...
            for (int i10 = 0; i10 < list.size(); i10++) {
                ...
                if (storyItem != null) {
                    Integer valueOf = Integer.valueOf(storyItem.f18318id);
                    AbstractSet abstractSet = this.f728l;
                    boolean contains = abstractSet.contains(valueOf);
                    AbstractSet abstractSet2 = this.f727k;
                    if (contains || abstractSet2.contains(Integer.valueOf(storyItem.f18318id))) {
                        abstractSet.remove(Integer.valueOf(storyItem.f18318id));
                        abstractSet2.remove(Integer.valueOf(storyItem.f18318id));
                        int i11 = this.f735s;
                        if (i11 != -1) {
                            this.f735s = i11 - 1;
                        }
    ...
    public void C(ArrayList arrayList, boolean z10) {
        ...
        if (z10) {
            ...
            tL_togglePinnedToTop.f18331id.addAll(arrayList3);
    ...
    public final void D(List list, boolean z10) {
        ...
        if (list != null) {
            ...
            while (true) {
                ...
                if (storyItem2 != null) {
                    Integer valueOf = Integer.valueOf(storyItem2.f18318id);
                    AbstractSet abstractSet = this.f728l;
                    boolean contains = abstractSet.contains(valueOf);
                    AbstractSet abstractSet2 = this.f727k;
                    if (!contains && !abstractSet2.contains(Integer.valueOf(storyItem2.f18318id))) {
                        z11 = false;
                    } else {
                        z11 = true;
                    }
                    ...
                    if (z11 != z12) {
                        if (!z12) {
                            org.telegram.messenger.z0.n(storyItem2.f18318id, new StringBuilder("StoriesList remove story "));
                            u(storyItem2.f18318id, true);
                            int i13 = this.f735s;
                            if (i13 != -1) {
                                this.f735s = i13 - 1;
                            }
                        } else if (this.f734r) {
                            FileLog.d("StoriesList put story " + storyItem2.f18318id);
                            t(y(storyItem2), false);
                            arrayList.add(Integer.valueOf(storyItem2.f18318id));
                            int i14 = this.f735s;
                            if (i14 != -1) {
                                this.f735s = i14 + 1;
                            }
                        } else if (!this.f737u) {
                            FileLog.d("StoriesList cannot put story " + storyItem2.f18318id + " -> reload");
                            if (this.A != -1) {
                    ...
                    } else if (z11 && z12 && ((messageObject = (MessageObject) hashMap.get(Integer.valueOf(storyItem2.f18318id))) == null || z10 || (storyItem = messageObject.storyItem) == null || (storyItem != storyItem2 && (storyItem.f18318id != storyItem2.f18318id || storyItem.media != storyItem2.media || !TextUtils.equals(storyItem.caption, storyItem2.caption))))) {
                        org.telegram.messenger.z0.n(storyItem2.f18318id, new StringBuilder("StoriesList update story "));
                        hashMap.put(Integer.valueOf(storyItem2.f18318id), y(storyItem2));
                    }
                    z13 = true;
                }
                i12++;
    ...
    public ArrayList h() {
        ...
        if (i11 == 0 && this.f723f > 0) {
            ...
            while (i10 < size) {
                ...
                i10++;
                arrayList3.add(Integer.valueOf(((MessageObject) obj).storyItem.f18318id));
            }
    ...
    public boolean q(int i10, List list, boolean z10) {
        ...
        if (i12 == 0 && (i11 = this.f723f) > 0) {
            ...
            tL_stories_getStoriesByID.f18325id.addAll(list);
            n10 = -1;
    ...
    public boolean r(int i10) {
        ...
        tL_stories_incrementStoryViews.f18329id.add(Integer.valueOf(i10));
