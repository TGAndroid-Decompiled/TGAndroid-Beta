...
public final class l9 {
    ...
    public final y9 f1195k;
    public final SharedPreferences f1196l;
    ...
    public final HashSet f1204t;
    public int f1205u;
    public int v;
    public final ci.b1 f1206w;
    public String f1208y;
    public final a0.i f1189b = new a0.i();
    public final a0.i f1190c = new a0.i();
    public int d = 0;
    public final a0.i e = new a0.i();
    public LongSparseIntArray f1191f = new LongSparseIntArray();
    public final ArrayList f1192g = new ArrayList();
    public final ArrayList h = new ArrayList();
    public final a0.i f1193i = new a0.i();
    public final LongSparseIntArray f1194j = new LongSparseIntArray();
    public final a0.i f1197m = new a0.i();
    public final a0.i f1207x = new a0.i();
    public boolean f1209z = true;
    ...
    public l9(int i10) {
        ...
        ?? obj = new Object();
        obj.f1762a = i10;
        obj.f1763b = MessagesStorage.getInstance(i10);
        this.f1195k = obj;
        SharedPreferences mainSettings = MessagesController.getInstance(i10).getMainSettings();
        this.f1196l = mainSettings;
        this.f1199o = mainSettings.getString("last_stories_state", "");
        this.f1208y = mainSettings.getString("last_stories_state_hidden", "");
        this.v = mainSettings.getInt("total_stores_hidden", 0);
        this.f1205u = mainSettings.getInt("total_stores", 0);
        this.f1203s = mainSettings.getBoolean("read_loaded", false);
        this.f1204t = new HashSet(mainSettings.getStringSet("unsupported_stories_checked", new HashSet()));
        ...
        y9 y9Var = this.f1195k;
        y9Var.f1763b.getStorageQueue().postRunnable(new a1.e(25, y9Var, new h8(this, 0)));
        this.K = new n8(this, i10, 0);
        this.f1206w = new ci.b1(i10);
    }
        ...
        for (int i10 = 0; i10 < arrayList.size(); i10++) {
            try {
                ...
                if (((MessageObject) arrayList.get(i10)).storyItem == null) {
                    ...
                    str = str + storyItem.f18348id + "@" + storyItem.dialogId;
                }
    ...
    public static String h0(List list) {
        ...
        for (int i10 = 0; i10 < list.size(); i10++) {
            try {
                ...
                str = str + ((TL_stories.StoryItem) list.get(i10)).f18348id + "@" + ((TL_stories.StoryItem) list.get(i10)).dialogId;
            } catch (Exception unused) {
                return "err";
            }
        }
    ...
    public final d9 A(long j3, int i10, int i11, boolean z10) {
        if (i10 == 0 && i11 > 0) {
            ...
            if (d9Var == null && z10) {
                d9 d9Var2 = new d9(this.f1188a, j3, i10, i11, new y1(this, 3));
        ...
        if (d9Var3 == null && z10) {
            if (i10 == 4) {
                ...
                t8 t8Var = new t8(this.f1188a, j3, null, new y1(this, 3));
                hashMap4.put(valueOf2, t8Var);
                return t8Var;
            }
            HashMap hashMap5 = hashMapArr[i10];
            Long valueOf3 = Long.valueOf(j3);
            d9 d9Var4 = new d9(this.f1188a, j3, i10, i11, new y1(this, 3));
    ...
    public final x8 B(long j3, boolean z10) {
        ...
        if (x8Var == null && z10) {
            x8 x8Var2 = new x8(this.f1188a, j3, this);
            iVar.k(x8Var2, j3);
            return x8Var2;
        }
        return x8Var;
    ...
    public final int C(boolean z10) {
        if (z10) {
            ...
            return Math.max(1, this.f1205u);
        } else {
            return this.f1192g.size();
        }
    }
    ...
    public final int D(int i10, long j3) {
        ...
        TL_stories.PeerStories peerStories = (TL_stories.PeerStories) this.f1193i.f(j3);
        if (peerStories == null) {
            peerStories = z(j3);
        }
        if (peerStories == null) {
        ...
        if (j3 == UserConfig.getInstance(this.f1188a).getClientUserId() && !Utilities.isNullOrEmpty((Collection) this.f1189b.f(j3))) {
            return 1;
        }
        int max = Math.max(peerStories.max_read_id, this.f1191f.get(j3, 0));
        boolean z10 = false;
        for (int i11 = 0; i11 < peerStories.stories.size(); i11++) {
            ...
            if ((i10 == 0 || peerStories.stories.get(i11).f18348id == i10) && peerStories.stories.get(i11).f18348id > max) {
    ...
    public final ArrayList E(long j3) {
        return (ArrayList) this.f1189b.f(j3);
    }
    ...
    public final boolean G() {
        if (H()) {
            ArrayList arrayList = this.f1192g;
            if (arrayList.isEmpty() || (arrayList.size() == 1 && DialogObject.getPeerDialogId(((TL_stories.PeerStories) arrayList.get(0)).peer) == UserConfig.getInstance(this.f1188a).clientUserId)) {
                return true;
            }
        }
        return false;
    ...
    public final boolean H() {
        long j3 = UserConfig.getInstance(this.f1188a).clientUserId;
        TL_stories.PeerStories peerStories = (TL_stories.PeerStories) this.f1193i.f(j3);
        if ((peerStories != null && !peerStories.stories.isEmpty()) || !Utilities.isNullOrEmpty((Collection) this.f1189b.f(j3))) {
            return true;
        }
        return false;
    }
    ...
    public final boolean J(long j3) {
        ...
        for (int i10 = 0; i10 < peerStories.stories.size(); i10++) {
            ...
            if (storyItem != null && storyItem.f18348id > peerStories.max_read_id) {
                return true;
            }
        }
        return false;
    ...
    public final boolean K(long j3) {
        ArrayList arrayList = (ArrayList) this.f1189b.f(j3);
    ...
    public final boolean M(TLRPC.User user) {
        if (user != null) {
            if (user.contact || user.f18259id == MessagesController.getInstance(this.f1188a).storiesChangelogUserId) {
                return true;
            }
            return false;
        }
    ...
    public final void P() {
        ...
        ConnectionsManager.getInstance(this.f1188a).sendRequest(tL_contacts_getBlocked, new x7(this, 3));
    }
    ...
    public final void Q(boolean z10) {
        ...
        boolean z11;
        if (!z10 || !this.f1202r) {
            if ((!z10 && this.f1201q) || this.f1198n) {
                return;
            }
            boolean z12 = true;
            if (z10) {
            ...
            ConnectionsManager.getInstance(this.f1188a).sendRequest(tL_stories_getAllStories, new o8(this, z10, tL_stories_getAllStories, z12));
        }
    }
    ...
    public final void R() {
        if (!this.U && !this.V) {
            this.U = true;
            ConnectionsManager.getInstance(this.f1188a).sendRequest(new TL_stories.TL_stories_getChatsToSend(), new x7(this, 2));
        }
    }
            ...
            if (!hashSet.contains(valueOf)) {
                ...
                for (int i11 = 0; i11 < peerStories.stories.size(); i11++) {
                    if (peerStories.stories.get(i11) instanceof TL_stories.TL_storyItemSkipped) {
                        ...
                        arrayList.add(Integer.valueOf(peerStories.stories.get(i11).f18348id));
                    }
                ...
                if (arrayList != null) {
                    ...
                    tL_stories_getStoriesByID.f18355id = arrayList;
                    int i12 = this.f1188a;
    ...
    public final void T() {
        if (this.A) {
            ...
            y9 y9Var = this.f1195k;
            y9Var.f1763b.getStorageQueue().postRunnable(new a1.e(22, y9Var, h8Var));
        } else {
            Q(false);
            Q(true);
        }
    ...
    public final boolean V(TL_stories.PeerStories peerStories, TL_stories.StoryItem storyItem, boolean z10) {
        if (storyItem != null && peerStories != null) {
            ...
            int i10 = this.f1191f.get(peerDialogId);
            int max = Math.max(peerStories.max_read_id, Math.max(i10, storyItem.f18348id));
            int i11 = this.f1188a;
            NotificationsController.getInstance(i11).processReadStories(peerDialogId, max);
            peerStories.max_read_id = max;
            this.f1191f.put(peerDialogId, max);
            if (max > i10) {
                if (!z10) {
                    this.f1195k.i(max, peerDialogId);
                }
                ...
                tL_stories_readStories.max_id = storyItem.f18348id;
                    ...
                    for (int i11 = 0; i11 < Math.min(2, storyItem.media_areas.size()); i11++) {
                        if (storyItem.media_areas.get(i11) instanceof TL_stories.TL_mediaAreaSuggestedReaction) {
                            ...
                            if (d.f49127f != null) {
                                ...
                                org.telegram.ui.Components.o5 o5Var = new org.telegram.ui.Components.o5(1, i10, d.f49128g);
                                o5Var.f26694m = true;
                                o5Var.v();
                            }
                        }
    ...
    public final void X(TL_stories.PeerStories peerStories) {
        ...
        while (true) {
            if (i11 >= peerStories.stories.size()) {
                break;
            } else if (peerStories.stories.get(i11).f18348id > peerStories.max_read_id) {
                i10 = i11;
                break;
            } else {
                i11++;
    ...
    public final void Y(TL_stories.TL_stories_allStories tL_stories_allStories, boolean z10, boolean z11, boolean z12) {
        ...
        ArrayList arrayList3 = this.f1192g;
        if (!z12) {
            if (!z10) {
                arrayList3.clear();
            } else {
        ...
        for (int i12 = 0; i12 < tL_stories_allStories.peer_stories.size(); i12++) {
            ...
            while (i13 < peerStories.stories.size()) {
                ...
                if ((storyItem instanceof TL_stories.TL_storyItemDeleted) || ((storyItem instanceof TL_stories.TL_storyItem) && currentTime > storyItem.expire_date && !(storyItem.media instanceof TLRPC.TL_messageMediaVideoStream))) {
                    NotificationsController.getInstance(i11).processDeleteStory(peerDialogId, storyItem.f18348id);
        ...
        if (!z11) {
            ...
            f fVar = new f(5);
            y9 y9Var = this.f1195k;
            y9Var.f1763b.getStorageQueue().postRunnable(new z7(y9Var, arrayList4, z12, z10, fVar, 1));
        }
        n8 n8Var = this.K;
    ...
    public final void Z(TL_stories.TL_updateStory tL_updateStory) {
        ...
        y9 y9Var = this.f1195k;
        if (i10 > 0) {
            user = MessagesController.getInstance(this.f1188a).getUser(Long.valueOf(peerDialogId));
            if (user != null && (M(user) || user.self)) {
                y9Var.f1763b.getStorageQueue().postRunnable(new a1.e(24, y9Var, tL_updateStory));
            }
        } else {
            y9Var.f1763b.getStorageQueue().postRunnable(new a1.e(24, y9Var, tL_updateStory));
            user = null;
    ...
    public final void a0(long j3, TL_stories.PeerStories peerStories) {
        ...
        if (j3 > 0) {
            ...
            if (M(user) || user.self) {
                y9Var.f1763b.getStorageQueue().postRunnable(new v9(y9Var, peerStories, 0));
            }
    ...
    public final void b(int i10, long j3, ArrayList arrayList) {
        ...
        while (i12 < size) {
            ...
            i12++;
            tL_updateAlbum.add_stories.add(Integer.valueOf(((TL_stories.StoryItem) obj).f18348id));
        }
        ...
        while (i14 < size3) {
            ...
            i14++;
            d9 A2 = l9Var.A(B.f1699b, 0, ((e9) obj3).f768a, false);
            if (A2 != null) {
        ...
        if (peerStories2 != null && (arrayList = peerStories2.stories) != null && !arrayList.isEmpty() && peerStories != null && (arrayList2 = peerStories.stories) != null && !arrayList2.isEmpty()) {
            for (int i10 = 0; i10 < peerStories.stories.size(); i10++) {
                if (peerStories.stories.get(i10) instanceof TL_stories.TL_storyItemSkipped) {
                    int i11 = peerStories.stories.get(i10).f18348id;
                    int i12 = 0;
                    while (true) {
                        if (i12 >= peerStories2.stories.size()) {
                            break;
                        }
                        if (peerStories2.stories.get(i12).f18348id == i11 && (peerStories2.stories.get(i12) instanceof TL_stories.TL_storyItem)) {
    ...
    public final void c0(int i10, long j3, ArrayList arrayList) {
        ...
        while (i13 < size) {
            ...
            i13++;
            tL_updateAlbum.delete_stories.add(Integer.valueOf(((TL_stories.StoryItem) obj).f18348id));
        }
        int size2 = arrayList.size();
        int i14 = 0;
        while (i14 < size2) {
    ...
    public final void d0(long j3, int i10, e2.h hVar) {
        ...
        if (y3 != null) {
            for (int i11 = 0; i11 < y3.stories.size(); i11++) {
                if (y3.stories.get(i11).f18348id == i10 && !(y3.stories.get(i11) instanceof TL_stories.TL_storyItemSkipped)) {
        ...
        TL_stories.TL_stories_getStoriesByID tL_stories_getStoriesByID = new TL_stories.TL_stories_getStoriesByID();
        tL_stories_getStoriesByID.f18355id.add(Integer.valueOf(i10));
        int i12 = this.f1188a;
    ...
    public final void e0(long j3, boolean z10) {
        LongSparseIntArray longSparseIntArray = this.f1194j;
        if (z10) {
    ...
    public final void g0(long j3, TL_stories.StoryItem storyItem, zg.p0 p0Var) {
        ...
        tL_stories_sendReaction.story_id = storyItem.f18348id;
        int i10 = this.f1188a;
    ...
    public final boolean h(long j3) {
        TLRPC.Chat chat;
        if (j3 >= 0 || (chat = MessagesController.getInstance(this.f1188a).getChat(Long.valueOf(-j3))) == null) {
            return false;
        }
        if (!chat.creator) {
    ...
    public final boolean i(long j3) {
        if (UserConfig.getInstance(this.f1188a).getClientUserId() != j3 && !h(j3)) {
            return false;
        }
        return true;
    }
    ...
    public final void i0(long j3, boolean z10, boolean z11) {
        ...
        ArrayList arrayList2 = this.f1192g;
        if (z10) {
        ...
        if (inputPeer != null && !(inputPeer instanceof TLRPC.TL_inputPeerEmpty)) {
            ...
            if (z11) {
                if (z10) {
                    ...
                    tL_contacts_block.f18155id = inputPeer;
                    ...
                    tL_contacts_unblock2.f18160id = inputPeer;
    ...
    public final void k0(long j3, List list) {
        ...
        if (B != null && (arrayList = B.h) != null) {
            ...
            while (i10 < size) {
                ...
                i10++;
                d9 A3 = l9Var.A(j3, 0, ((e9) obj).f768a, false);
                if (A3 != null) {
                    A3.A(list);
                }
                l9Var = this;
        ...
        for (int i11 = 0; i11 < list.size(); i11++) {
            ...
            while (true) {
                if (i12 < peerStories.stories.size()) {
                    if (peerStories.stories.get(i12).f18348id == storyItem.f18348id) {
                        z11 = true;
                        if (storyItem instanceof TL_stories.TL_storyItemDeleted) {
                            ...
                            hg.k0.p(storyItem.f18348id, new StringBuilder("StoriesController update story for full peer storyId="));
                        }
                    } else {
                        i12++;
                    }
            ...
            if (!z11) {
                if (storyItem instanceof TL_stories.TL_storyItemDeleted) {
                    hg.k0.p(storyItem.f18348id, new StringBuilder("StoriesController story is not found, but already deleted storyId="));
                } else if (z10) {
                    hg.k0.p(storyItem.f18348id, new StringBuilder("StoriesController add new story for full peer storyId="));
    ...
    public final void m(TL_stories.PeerStories peerStories) {
        if (peerStories != null && peerStories.stories != null) {
            ...
            while (i10 < peerStories.stories.size()) {
                if (ia.w(this.f1188a, peerStories.stories.get(i10))) {
    ...
    public final void m0(long j3, TL_stories.PeerStories peerStories) {
        ...
        if (peerStories != null && (peerStories2 = (TL_stories.PeerStories) this.f1193i.f(j3)) != null) {
            ...
            for (int i10 = 0; i10 < peerStories2.stories.size(); i10++) {
                if (peerStories2.stories.get(i10) instanceof TL_stories.TL_storyItemSkipped) {
                    int i11 = peerStories2.stories.get(i10).f18348id;
                    int i12 = 0;
                    while (true) {
                        if (i12 >= peerStories.stories.size()) {
                            break;
                        }
                        if (peerStories.stories.get(i12).f18348id == i11 && (peerStories.stories.get(i12) instanceof TL_stories.TL_storyItem)) {
    ...
    public final void n0(long j3, List list, boolean z10) {
        ...
        if (B != null && (arrayList = B.h) != null) {
            ...
            while (i10 < size2) {
                int i12 = i10 + 1;
                d9 A3 = l9Var.A(j3, 0, ((e9) arrayList.get(i10)).f768a, false);
                if (A3 != null) {
                    A3.D(list, z10);
                }
                l9Var = this;
    ...
    public final f9 o() {
        ...
        ArrayList arrayList2 = (ArrayList) this.f1190c.f(UserConfig.getInstance(i11).getClientUserId());
        if (arrayList2 == null) {
            size = 0;
        } else {
    ...
    public final void o0(long j3, ArrayList arrayList, boolean z10, t4 t4Var) {
        ...
        for (int i10 = 0; i10 < arrayList.size(); i10++) {
            ...
            if (!(storyItem instanceof TL_stories.TL_storyItemDeleted)) {
                ...
                togglepinned.f18362id.add(Integer.valueOf(storyItem.f18348id));
                if (y3 != null) {
                    for (int i11 = 0; i11 < y3.stories.size(); i11++) {
                        if (y3.stories.get(i11).f18348id == storyItem.f18348id) {
                            y3.stories.get(i11).pinned = z10;
                            this.f1195k.k(j3, storyItem);
                        }
                    }
                }
            }
    ...
    public final void p(int i10, long j3) {
        ...
        if (hashSet.contains(str) || this.f1204t.contains(str)) {
            return;
        }
        hashSet.add(str);
        TL_stories.TL_stories_getStoriesByID tL_stories_getStoriesByID = new TL_stories.TL_stories_getStoriesByID();
    ...
    public final void p0(long j3, TL_stories.StoryItem storyItem, boolean z10) {
        ...
        if (storyItem == null) {
            ...
            str = storyItem.f18348id + "@" + storyItem.dialogId;
        }
        t10.append(str);
        FileLog.d(t10.toString());
    ...
    public final void q() {
        ...
        this.f1208y = "";
        this.f1199o = "";
        this.f1196l.edit().putBoolean("stories_loaded", false).remove("last_stories_state").putBoolean("stories_loaded_hidden", false).remove("last_stories_state_hidden").putBoolean("read_loaded", false).apply();
        ci.b1 b1Var = this.f1206w;
        ...
        ConnectionsManager.getInstance(this.f1188a).sendRequest(new TL_stories.TL_stories_getAllReadPeerStories(), new x7(this, 0));
    }
    ...
    public final void s(long j3, ArrayList arrayList) {
            ...
            if (!(storyItem instanceof TL_stories.TL_storyItemDeleted)) {
                if (peerStories2 != null) {
                    ...
                    while (true) {
                        if (i12 >= peerStories2.stories.size()) {
                            break;
                        } else if (peerStories2.stories.get(i12).f18348id == storyItem.f18348id) {
                ...
                tL_stories_deleteStories.f18351id.add(Integer.valueOf(storyItem.f18348id));
            }
        }
            ...
            if (!(storyItem2 instanceof TL_stories.TL_storyItemDeleted) && peerStories2 != null) {
                ...
                while (true) {
                    if (i14 >= peerStories2.stories.size()) {
                        break;
                    } else if (peerStories2.stories.get(i14).f18348id == storyItem2.f18348id) {
        ...
        k0(j3, arrayList);
        ArrayList<Integer> arrayList2 = tL_stories_deleteStories.f18351id;
        y9 y9Var = this.f1195k;
        y9Var.f1763b.getStorageQueue().postRunnable(new a3.h0(y9Var, arrayList2, j3, 4));
        NotificationCenter.getInstance(i10).lambda$postNotificationNameOnUIThread$1(NotificationCenter.storiesUpdated, new Object[0]);
    }
    ...
    public final k9 t(long j3, TL_stories.StoryItem storyItem) {
        HashMap hashMap = (HashMap) this.e.f(j3);
        if (hashMap != null && !hashMap.isEmpty()) {
            return (k9) hashMap.get(Integer.valueOf(storyItem.f18348id));
        }
        return null;
    }
    ...
    public final TL_stories.StoryItem u(int i10, long j3) {
        ...
        if (peerStories != null) {
            for (int i11 = 0; i11 < peerStories.stories.size(); i11++) {
                if (peerStories.stories.get(i11).f18348id == i10) {
    ...
    public final void v(ArrayList arrayList) {
        ...
        while (i10 < arrayList.size()) {
            ...
            long peerDialogId = DialogObject.getPeerDialogId(peerStories.peer);
            if (peerDialogId > 0 && (user = MessagesController.getInstance(this.f1188a).getUser(Long.valueOf(peerDialogId))) != null && !M(user)) {
    ...
    public final int x(long j3) {
        ...
        if (y3 != null) {
            return Math.max(y3.max_read_id, this.f1191f.get(j3, 0));
        }
        return this.f1191f.get(j3, 0);
    }

    public final TL_stories.PeerStories y(long j3) {
        return (TL_stories.PeerStories) this.f1193i.f(j3);
    }
