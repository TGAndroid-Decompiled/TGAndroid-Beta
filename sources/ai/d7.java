    ...
    public void e(boolean z10, boolean z11) {
        switch (this.K) {
            case 2:
                ...
                float f7 = 1.0f;
                if (z11) {
                    ViewPropertyAnimator animate = dg1Var.f33040n.f37668a.animate();
                    if (z10) {
                        f7 = 0.0f;
                    }
                ...
                dg1Var.f33040n.f37668a.animate().cancel();
                TextView textView = dg1Var.f33040n.f37668a;
                if (z10) {
                    f7 = 0.0f;
                }
    ...
    public void onMeasure(int i10, int i11) {
        switch (this.K) {
            case 0:
                ...
                super.onMeasure(i10, wl.d(j7Var.e, j7Var.f1046n - j7Var.f1047r.getPaddingTop(), 1073741824));
                return;
            default:
