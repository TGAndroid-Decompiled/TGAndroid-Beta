...
public final class q9 extends View {
    ...
    public void setReaction(zg.p0 p0Var) {
        ...
        String str;
        String str2;
        if (p0Var != null && ((str2 = p0Var.f49155f) == null || !str2.equals("❤"))) {
            z10 = false;
        } else {
            z10 = true;
        }
        this.f1439n = z10;
        if (p0Var != null && (str = p0Var.f49155f) != null && str.equals("❤")) {
            this.f1436b = true;
        } else {
            this.f1436b = false;
        }
        ...
        if (p0Var != null) {
            if (p0Var.f49156g != 0) {
                org.telegram.ui.Components.o5 o5Var2 = new org.telegram.ui.Components.o5(3, UserConfig.selectedAccount, p0Var.f49156g);
                this.f1438f = o5Var2;
                if (this.f1441s) {
                    o5Var2.a(this);
                }
                ...
                if (tL_availableReaction != null) {
                    this.d.setImage(ImageLocation.getForDocument(tL_availableReaction.center_icon), "40_40_lastreactframe", DocumentObject.getSvgThumb(tL_availableReaction.static_icon, org.telegram.ui.ActionBar.j6.f18807a7, 1.0f), "webp", tL_availableReaction, 1);
                }
            }
        }
        invalidate();
