...
public final class d6 {
    public TL_stories.StoryItem f701a = null;
    public k9 f702b = null;
    public TL_stories.StoryItem f703c;
    public boolean d;
    public boolean e;
    ...
    public static String c(d6 d6Var) {
        ...
        if (storyItem != null && (messageMedia = storyItem.media) != null) {
            if (messageMedia.photo != null) {
                ...
                sb2.append(d6Var.f701a.media.photo.f18136id);
                sb2.append("at");
                return a4.a.n(d6Var.f701a.media.photo.dc_id, "dc", sb2);
            } else if (messageMedia.document != null) {
                StringBuilder sb3 = new StringBuilder("doc#");
                sb3.append(d6Var.f701a.media.document.f18118id);
                sb3.append("at");
                return a4.a.n(d6Var.f701a.media.document.dc_id, "dc", sb3);
            } else {
                return "unknown";
            }
        } else if (d6Var.f702b != null) {
            return "uploading from " + d6Var.f702b.e;
        } else {
            return "unknown";
        }
    }
    ...
    public final boolean d() {
        k9 k9Var = this.f702b;
        if (k9Var != null) {
            return k9Var.f1138c.H0;
        }
        TL_stories.StoryItem storyItem = this.f701a;
        if (storyItem != null) {
            if (storyItem.noforwards) {
                return false;
            }
            if (storyItem.pinned) {
                TLRPC.Chat chat = MessagesController.getInstance(this.f708k.C2).getChat(Long.valueOf(-storyItem.dialogId));
    ...
    public final String e() {
        ...
        if (f6Var.B1 > 0) {
            ...
            return String.format(Locale.US, "https://t.me/%1$s/s/%2$s", UserObject.getPublicUsername(user), Integer.valueOf(f6Var.O1.f701a.f18348id));
        }
        ...
        return String.format(Locale.US, "https://t.me/%1$s/s/%2$s", ChatObject.getPublicUsername(chat), Integer.valueOf(f6Var.O1.f701a.f18348id));
    }
    ...
    public final sa g() {
        ...
        if (this.f706i == null && (storyItem = this.f701a) != null) {
            ...
            if (document != null && (tL_documentAttributeAudio = (TLRPC.TL_documentAttributeAudio) AndroidUtilities.find(document.attributes, TLRPC.TL_documentAttributeAudio.class)) != null) {
                ...
                if (!TextUtils.isEmpty(str) || !TextUtils.isEmpty(str2)) {
                    saVar = new sa();
                    saVar.f1511f = true;
                    saVar.f1512g = document;
                    if (TextUtils.isEmpty(str)) {
                        saVar.f1515k = new SpannableStringBuilder(sa.d()).append((CharSequence) " ").append((CharSequence) str2);
                    } else if (TextUtils.isEmpty(str2)) {
                        saVar.f1515k = new SpannableStringBuilder(sa.d()).append((CharSequence) " ").append((CharSequence) str);
                    } else {
                        SpannableStringBuilder append = new SpannableStringBuilder(sa.d()).append((CharSequence) " ").append((CharSequence) str2);
                        saVar.f1515k = append;
                        int length = append.length();
                        saVar.f1515k.append((CharSequence) " ・ ");
                        saVar.f1515k.setSpan(new CharacterStyle(), length, saVar.f1515k.length(), 33);
                        saVar.f1515k.append((CharSequence) str);
                    }
                }
            }
            this.f706i = saVar;
    ...
    public final File h() {
        ...
        if (storyItem != null) {
            ...
            if (messageMedia != null && messageMedia.getDocument() != null) {
                return FileLoader.getInstance(f6Var.C2).getPathToAttach(this.f701a.media.getDocument());
            }
            TLRPC.MessageMedia messageMedia2 = this.f701a.media;
            ...
            if (storyItem != null) {
                ...
                if (storyItem.fwd_from != null) {
                    ...
                    if (peer != null) {
                        ...
                        saVar.f1509b = Long.valueOf(peerDialogId);
                        if (peerDialogId >= 0) {
                            saVar.f1515k = new SpannableStringBuilder(MessageObject.userSpan()).append((CharSequence) " ").append((CharSequence) UserObject.getUserName(MessagesController.getInstance(i11).getUser(Long.valueOf(peerDialogId))));
                        } else {
                            ...
                            saVar.f1515k = append.append((CharSequence) str);
                        }
                    } else if (storyFwdHeader.from_name != null) {
                        saVar.f1515k = new SpannableStringBuilder(MessageObject.userSpan()).append((CharSequence) " ").append((CharSequence) storyItem.fwd_from.from_name);
                    }
                    saVar.f1511f = true;
                    TL_stories.StoryFwdHeader storyFwdHeader2 = storyItem.fwd_from;
                    if ((storyFwdHeader2.flags & 4) != 0) {
                        saVar.f1510c = Integer.valueOf(storyFwdHeader2.story_id);
                    }
                    saVar.c();
                    ...
                    if (tL_mediaAreaChannelPost != null && (chat2 = MessagesController.getInstance(i11).getChat(Long.valueOf(tL_mediaAreaChannelPost.channel_id))) != null) {
                        saVar = new sa();
                        saVar.f1509b = Long.valueOf(-chat2.f18112id);
                        saVar.e = true;
                        saVar.f1508a = i11;
                        saVar.f1511f = true;
                        ...
                        saVar.f1515k = new SpannableStringBuilder(groupSpan2).append((CharSequence) " ").append((CharSequence) chat2.title);
                    }
                }
                this.f707j = saVar;
            } else {
                ...
                if (k9Var != null) {
                    ...
                    if (o8Var != null) {
                        if (o8Var.f5164n) {
                            saVar = new sa();
                            saVar.f1515k = o8Var.f5168p;
                            String str2 = o8Var.f5174s;
                            saVar.f1516l = str2;
                            saVar.f1511f = TextUtils.isEmpty(str2);
                        } else if (o8Var.f5178u && (arrayList = o8Var.v) != null && arrayList.size() > 0) {
                            ...
                            if (p5 < 0 && (chat = MessagesController.getInstance(messageObject.currentAccount).getChat(Long.valueOf(-p5))) != null) {
                                saVar = new sa();
                                saVar.f1509b = Long.valueOf(p5);
                                saVar.e = true;
                                saVar.f1508a = messageObject.currentAccount;
                                saVar.f1511f = true;
                                ...
                                saVar.f1515k = new SpannableStringBuilder(groupSpan).append((CharSequence) " ").append((CharSequence) chat.title);
                            }
                        }
                    }
                    this.f707j = saVar;
    ...
    public final boolean k(long j3) {
        ...
        if (storyItem != null) {
            TLRPC.MessageMedia messageMedia = storyItem.media;
            if ((messageMedia instanceof TLRPC.TL_messageMediaVideoStream) && j3 == ((TLRPC.TL_messageMediaVideoStream) messageMedia).call.f18129id) {
                return true;
            }
            return false;
        }
    ...
    public final boolean m() {
        ...
        if (storyItem != null && (messageMedia = storyItem.media) != null && messageMedia.getDocument() != null) {
            TLRPC.Document document = this.f701a.media.getDocument();
            if (!MessageObject.isVideoDocument(document) && !"video/mp4".equals(document.mime_type)) {
                return false;
            }
            return true;
        }
        TL_stories.StoryItem storyItem2 = this.f701a;
    ...
    public final void o() {
        ...
        h5 h5Var = f6Var.K0;
        d6 d6Var = f6Var.O1;
        k9 k9Var = d6Var.f702b;
        if (k9Var != null) {
            CharSequence charSequence = k9Var.f1138c.C0;
            this.h = charSequence;
            CharSequence replaceEmoji = Emoji.replaceEmoji(charSequence, h5Var.f1712b0.getPaint().getFontMetricsInt(), false);
            this.h = replaceEmoji;
        ...
        if (storyItem != null) {
            if (storyItem.translated && storyItem.translatedText != null && TextUtils.equals(storyItem.translatedLng, v31.A())) {
                this.f705g = true;
                TLRPC.TL_textWithEntities tL_textWithEntities = d6Var.f701a.translatedText;
                String str = tL_textWithEntities.text;
                this.h = str;
                CharSequence replaceEmoji2 = Emoji.replaceEmoji(str, h5Var.f1712b0.getPaint().getFontMetricsInt(), false);
                this.h = replaceEmoji2;
                if (replaceEmoji2 != null && tL_textWithEntities.entities != null) {
                    SpannableStringBuilder valueOf2 = SpannableStringBuilder.valueOf(MessageObject.replaceAnimatedEmoji(new SpannableStringBuilder(tL_textWithEntities.text), tL_textWithEntities.entities, h5Var.f1712b0.getPaint().getFontMetricsInt(), false));
                    SpannableStringBuilder.valueOf(Emoji.replaceEmoji(valueOf2, h5Var.f1712b0.getPaint().getFontMetricsInt(), false));
            ...
            String str2 = d6Var.f701a.caption;
            this.h = str2;
            CharSequence replaceEmoji3 = Emoji.replaceEmoji(str2, h5Var.f1712b0.getPaint().getFontMetricsInt(), false);
            this.h = replaceEmoji3;
            if (replaceEmoji3 != null && d6Var.f701a.entities != null) {
                SpannableStringBuilder valueOf3 = SpannableStringBuilder.valueOf(MessageObject.replaceAnimatedEmoji(new SpannableStringBuilder(d6Var.f701a.caption), d6Var.f701a.entities, h5Var.f1712b0.getPaint().getFontMetricsInt(), false));
                SpannableStringBuilder.valueOf(Emoji.replaceEmoji(valueOf3, h5Var.f1712b0.getPaint().getFontMetricsInt(), false));
                i10 = (f6Var.B1 < 0 || MessagesController.getInstance(f6Var.C2).storyEntitiesAllowed(MessagesController.getInstance(f6Var.C2).getUser(Long.valueOf(f6Var.B1)))) ? 1 : 1;
                if (i10 != 0) {
                    MessageObject.addLinks(true, valueOf3);
                }
                MessageObject.addEntitiesToText(valueOf3, d6Var.f701a.entities, false, true, true, false, i10 ^ 1);
                this.h = valueOf3;
            }
        }
    }
