...
public final class p0 implements Runnable {
    ...
    public final void run() {
        ...
        switch (this.f1374a) {
            case 0:
                o1 o1Var = (o1) this.e;
                TLRPC.TL_error tL_error = (TLRPC.TL_error) this.f1377f;
                ...
                if ("BALANCE_TOO_LOW".equalsIgnoreCase(tL_error.text)) {
                    ...
                    new vc(o1Var.f1323b, new d()).d0(tL_error, true);
                    return;
                }
            case 1:
                ((MessagesController) this.e).lambda$deleteSavedDialog$144(this.f1375b, this.f1376c, (TLRPC.InputPeer) this.f1377f, this.d, (int[]) this.h);
                return;
            case 2:
                org.telegram.ui.ActionBar.n2 n2Var = (org.telegram.ui.ActionBar.n2) this.f1377f;
                ...
                long j11 = this.f1375b;
                long j12 = this.f1376c;
            ...
            default:
                ...
                int i13 = this.d;
                yh.o g10 = yh.o.g(i13);
                long j13 = this.f1375b;
                g10.f(context2, j13, this.f1376c, new ei.q3((org.telegram.ui.ActionBar.f3[]) this.f1377f, context2, i13, j13, (org.telegram.ui.ActionBar.e6) this.h, 2));
                return;
        }
    }
