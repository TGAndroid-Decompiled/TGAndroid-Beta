    ...
    public final void run() {
        ...
        switch (this.f672a) {
            ...
            case 2:
                ...
                return;
            case 3:
                ((MediaDataController) this.e).lambda$removeMultipleStickerSets$111((boolean[]) this.h, (ArrayList) this.d, (Context) this.f674c, (org.telegram.ui.ActionBar.n2) this.f675f, this.f673b);
                return;
            case 4:
            ...
            case 5:
                ...
                if (z10) {
                    ...
                    if (groupCall != null) {
                        ...
                        org.telegram.ui.l9.o0(context, i12, tL_inputGroupCall, groupCall.invite_link, e6Var, true, true);
                    ...
                    ConnectionsManager.getInstance(i12).sendRequest(exportgroupcallinvite, new ji(b2Var, context, i12, exportgroupcallinvite, e6Var, u60Var));
                    return;
                } else {
                    b2Var.dismiss();
                    AndroidUtilities.runOnUIThread(u60Var);
            ...
            case 6:
                new q71((Context) this.e, (TLRPC.Chat) this.f674c, (TLRPC.User) this.f675f, new n8(this.f673b, (MessagesStorage.BooleanCallback) this.d, 29), (org.telegram.ui.ActionBar.e6) this.h).show();
                return;
            case 7:
                org.telegram.ui.Components.v9.a((org.telegram.ui.Components.v9) this.e, (Runnable[]) this.f674c, (Bitmap) this.f675f, (h60) this.d, this.f673b, (w7.j0[]) this.h);
                return;
            case 8:
                ah0.m((ah0) this.e, (Integer[]) this.f675f, this.f673b, (TLObject) this.f674c, (ArrayList) this.d, (TLRPC.PollAnswerVoters) this.h);
                return;
            case 9:
                ss.Y((ss) this.e, (TLRPC.FileLocation) this.f675f, (TLRPC.InputFile) this.d, (TLObject) this.f674c, (TLRPC.FileLocation) this.h, this.f673b);
                return;
            case 10:
                ...
                if (!tL_urlAuthResultRequest.match_codes.isEmpty() && TextUtils.isEmpty(strArr[0])) {
                    ll0.c(context2, this.f673b, tL_urlAuthResultRequest.match_codes, tL_urlAuthResultRequest.domain, new nj0(3, strArr, jl0Var), true, new f(18), n2Var.getResourceProvider());
                    return;
                }
                jl0Var.run();
                return;
            case 11:
                org.telegram.ui.ActionBar.n2 n2Var2 = (org.telegram.ui.ActionBar.n2) this.f674c;
                ...
                if (((c5.h) this.e).f3894a == 0) {
                    ...
                    if (list != null && !list.isEmpty() && !UserConfig.getInstance(i14).isPremium()) {
                        for (Purchase purchase : list) {
                            if (purchase.b().contains("telegram_premium")) {
                                ...
                                ConnectionsManager.getInstance(i14).sendRequest(tL_payments_assignPlayMarketTransaction, new za(i14, ri0Var, n2Var2, tL_payments_assignPlayMarketTransaction), 66);
                                return;
                            }
                        }
                    }
                    ...
                    ConnectionsManager.getInstance(i14).sendRequest(tL_payments_canPurchaseStore, new ji(i14, 5, n2Var2, lx0Var, fVar, tL_payments_canPurchaseStore, tL_inputStorePaymentPremiumSubscription2));
                    return;
                }
                return;
            case 12:
                ...
                if (z11) {
                    ...
                    alertDialog$Builder.f18622a.R = LocaleController.getString(R.string.BotWebViewRequestWriteTitle);
                    alertDialog$Builder.f18622a.T = LocaleController.getString(R.string.BotWebViewRequestWriteMessage);
                    ...
                    d1Var.Y(3, alertDialog$Builder.f18622a, new org.telegram.ui.web.x(strArr2, i15, z0Var, daVar, 1));
                    return;
                }
            case 13:
                ...
                if (tLObject3 instanceof TLRPC.TL_photos_photo) {
                    ...
                    if ((photo instanceof TLRPC.TL_photo) && user != null) {
                        ...
                        cjVar.run();
                        xc.a0(d5Var.getLastFragment()).V(Collections.singletonList(user), AndroidUtilities.replaceTags(LocaleController.getString(R.string.ApplyAvatarHintTitle)), AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.ApplyAvatarHint), new ai1(i16, d5Var)), null).j();
                        return;
                    }
                    return;
                }
            ...
            default:
                ...
                org.telegram.ui.ActionBar.f3[] f3VarArr = (org.telegram.ui.ActionBar.f3[]) this.f675f;
