...
public final class cb implements Runnable {
    ...
    public final void run() {
        ...
        switch (this.f672a) {
            ...
            case 6:
                new t71((Context) this.e, (TLRPC.Chat) this.f674c, (TLRPC.User) this.f675f, new n8(this.f673b, (MessagesStorage.BooleanCallback) this.d, 27), (org.telegram.ui.ActionBar.f6) this.h).show();
                return;
            case 7:
                org.telegram.ui.Components.u9.a((org.telegram.ui.Components.u9) this.e, (Runnable[]) this.f674c, (Bitmap) this.f675f, (g60) this.d, this.f673b, (w7.j0[]) this.h);
                return;
            case 8:
                zg0.m((zg0) this.e, (Integer[]) this.f675f, this.f673b, (TLObject) this.f674c, (ArrayList) this.d, (TLRPC.PollAnswerVoters) this.h);
                return;
            case 9:
            ...
            case 10:
                ...
                if (!tL_urlAuthResultRequest.match_codes.isEmpty() && TextUtils.isEmpty(strArr[0])) {
                    ll0.c(context2, this.f673b, tL_urlAuthResultRequest.match_codes, tL_urlAuthResultRequest.domain, new pj0(3, strArr, jl0Var), true, new f(18), n2Var.getResourceProvider());
                    return;
                }
                jl0Var.run();
                return;
                    ...
                    if (list != null && !list.isEmpty() && !UserConfig.getInstance(i14).isPremium()) {
                        for (Purchase purchase : list) {
                            if (purchase.b().contains("telegram_premium")) {
                                ...
                                tL_dataJSON.data = purchase.f5948a;
            ...
            case 12:
                ...
                if (z11) {
                    ...
                    alertDialog$Builder.f18654a.R = LocaleController.getString(R.string.BotWebViewRequestWriteTitle);
                    alertDialog$Builder.f18654a.T = LocaleController.getString(R.string.BotWebViewRequestWriteMessage);
                    ...
                    d1Var.Y(3, alertDialog$Builder.f18654a, new org.telegram.ui.web.x(strArr2, i15, z0Var, daVar, 1));
                    return;
                }
            case 13:
    ...
    public cb(zg0 zg0Var, Integer[] numArr, int i10, TLObject tLObject, ArrayList arrayList, TLRPC.PollAnswerVoters pollAnswerVoters) {
        this.f672a = 8;
        this.e = zg0Var;
        this.f675f = numArr;
        this.f673b = i10;
