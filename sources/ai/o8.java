...
public final class o8 implements RequestDelegate {
    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        switch (this.f1356a) {
            case 0:
                AndroidUtilities.runOnUIThread(new z7((l9) this.d, this.f1357b, (TL_stories.TL_stories_getAllStories) this.e, tLObject, this.f1358c));
                return;
            default:
                AndroidUtilities.runOnUIThread(new td((TwoStepVerificationActivity) this.d, tL_error, tLObject, this.f1357b, this.f1358c, (Runnable) this.e, 3));
                return;
        }
    }
