...
public final class r3 extends o1 {
    public final jc f1456h0;
    public final f6 f1457i0;
    ...
    public final void q(boolean z10, boolean z11) {
        float f7;
        if (!z11 || this.f1330f0 != z10) {
            this.f1330f0 = z10;
            ValueAnimator valueAnimator = this.f1328e0;
            ...
            if (z11) {
                ...
                this.f1328e0 = ofFloat;
                ofFloat.addUpdateListener(new a(this, 3));
                this.f1328e0.addListener(new n(1, this, z10));
                this.f1328e0.setDuration(420L);
                this.f1328e0.setInterpolator(qr.h);
                this.f1328e0.start();
            } else {
                if (z10) {
                    f7 = 0.0f;
    ...
    public final void setVisibility(int i10) {
        ...
        this.f1457i0.M0.setVisibility(i10);
    }
}
