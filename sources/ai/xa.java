...
public class xa extends NestedScrollView implements m70 {
    ...
    public xa(Context context, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        o1.k kVar = new o1.k(waVar, o1.h.f15334n, 0.0f);
        this.f1711a0 = kVar;
    ...
    public final void a(RectF rectF) {
        ...
        if (vaVarArr != null && (vaVar = vaVarArr[0]) != null && vaVar.f1626p != null) {
            int i10 = waVar.F;
            int i11 = waVar.F;
            va vaVar2 = waVar.f1668r[0];
            rectF.set(waVar.E, (AndroidUtilities.lerp(vaVar.f1623m, vaVar.f1622l, waVar.f1670w) + i10) - waVar.f1668r[0].f1626p.b(), getWidth() - waVar.E, AndroidUtilities.lerp(vaVar2.f1623m, vaVar2.f1622l, waVar.f1670w) + i11);
    ...
    public final void b(Canvas canvas, float f7) {
        ...
        if (vaVarArr != null && (vaVar = vaVarArr[0]) != null && vaVar.f1626p != null) {
            ...
            canvas.translate(x11, (y3 + AndroidUtilities.lerp(vaVar2.f1623m, vaVar2.f1622l, waVar.f1670w)) - vaVarArr2[0].f1626p.b());
            sa saVar = vaVarArr2[0].f1626p;
            int width = getWidth();
            int i10 = waVar.E;
