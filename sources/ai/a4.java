...
public final class a4 extends ChatActivityEnterView {
    ...
    public final boolean S0() {
        ...
        int i10;
        int i11;
        if (this.f21884z1.getAlpha() < 0.5f) {
            H0();
            return false;
        }
        f6 f6Var = this.f516r5;
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (!isEnabled()) {
            ...
            if (motionEvent.getAction() == 0) {
                if (contains && (textView2 = f6Var.f824i2) != null) {
                    textView2.setPressed(true);
                }
            } else if (motionEvent.getAction() == 1) {
                TextView textView3 = f6Var.f824i2;
                if (textView3 != null) {
                    if (contains && textView3.isPressed()) {
                        f6.h0(f6Var);
                    }
                    f6Var.f824i2.setPressed(false);
                }
            } else if (motionEvent.getAction() == 3 && (textView = f6Var.f824i2) != null) {
                textView.setPressed(false);
            }
            TextView textView4 = f6Var.f824i2;
    ...
    public final void h0(Menu menu) {
        bo.k8(menu, null, false, !this.f516r5.O1.f709f, true, true);
    }
