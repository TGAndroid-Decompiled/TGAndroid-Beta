...
public final class w7 extends FrameLayout {
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        switch (this.f1656a) {
            ...
            case 7:
                ...
                float max = Math.max(dp2 + dp2, k31Var.f25614f.d() + AndroidUtilities.dp(10.0f));
                if (z10) {
                    i11 = i13;
                    f10 = dp3;
                    f7 = width2;
                ...
                if (i11 > 0) {
                    ...
                    i6Var.setColor(org.telegram.ui.ActionBar.h6.l1(g10, i6Var.f24982b.a(org.telegram.ui.ActionBar.h6.v0(k31Var.E, i6Var.f24981a), false)));
                    canvas.drawRoundRect(rectF4, dp2, dp2, i6Var);
                    k31Var.f25614f.m(rectF4);
                    org.telegram.ui.Components.o6 o6Var = k31Var.f25614f;
            ...
            case 8:
                ...
                paint3.setColor(z60Var.getThemedColor(org.telegram.ui.ActionBar.h6.f19059d6));
                canvas.save();
    ...
    public boolean drawChild(Canvas canvas, View view, long j3) {
        switch (this.f1656a) {
            case 2:
                ...
                return drawChild;
            case 10:
                qg.r2 r2Var = ((qg.t2) this.d).f41940f;
                if (view == r2Var) {
                    canvas.save();
            ...
            case 12:
                ...
                if (((yh.q7) this.d).e > 1) {
                    paint.setColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19059d6, (org.telegram.ui.ActionBar.d6) this.f1658c));
    ...
    public void onDraw(Canvas canvas) {
        switch (this.f1656a) {
            case 4:
                super.onDraw(canvas);
                Paint paint = (Paint) this.f1658c;
                paint.setColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19279p7, false));
                canvas.save();
    ...
    public boolean verifyDrawable(Drawable drawable) {
        switch (this.f1656a) {
            case 7:
                if (((k31) this.d).f25614f != drawable && !super.verifyDrawable(drawable)) {
                    return false;
                }
                return true;
            default:
    ...
    public w7(h90 h90Var, Context context) {
        super(context);
        this.f1656a = 6;
        this.d = h90Var;
    ...
    public w7(k31 k31Var, Context context, org.telegram.ui.ActionBar.d6 d6Var) {
        super(context);
        this.f1656a = 7;
        this.d = k31Var;
        ...
        k31Var.f25614f.setCallback(this);
    }
