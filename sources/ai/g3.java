    ...
    public final void accept(Object obj) {
        ...
        switch (this.f892a) {
            ...
            case 1:
                ...
                if (!k0Var.isEmpty()) {
                    ...
                    while (it.hasNext()) {
                        ...
                        b2.l1 l1Var = (b2.l1) f1Var.d.f8150n.get(m1Var.f3117a.f3091b);
                        if (l1Var != null && m1Var.f3117a.f3090a == l1Var.f3090a) {
                            c10.a(new b2.m1(l1Var, m1Var.f3118b));
                        } else {
                            c10.a(m1Var);
                        }
                    }
            ...
            case 2:
                ...
                m4.a0 a0Var = (m4.a0) ((m4.f1) this.f893b).f14746a.get();
                ...
                return;
            case 3:
                bd bdVar = (bd) this.f893b;
                TLRPC.Chat chat = (TLRPC.Chat) this.f894c;
                TL_stories.TL_premium_boostsStatus tL_premium_boostsStatus = (TL_stories.TL_premium_boostsStatus) obj;
                bdVar.f32376c = tL_premium_boostsStatus;
                ...
                return;
            case 4:
                org.telegram.ui.sc scVar = (org.telegram.ui.sc) this.f893b;
                ...
                if (view instanceof org.telegram.ui.rc) {
                    ...
                    rcVar.setBackgroundColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19109d6, scVar.f37390a));
            ...
            case 5:
                ...
                ((ke) this.f893b).f35175w0.showDialog(j0Var);
                return;
            case 6:
                Boolean bool = (Boolean) obj;
                ((zn) this.f893b).f40374ib = true;
                ((org.telegram.ui.ActionBar.c6) this.f894c).run();
                return;
            case 7:
                ...
                int i11 = viVar.J1;
                tL_messages_toggleBotInAttachMenu.bot = MessagesController.getInstance(i11).getInputUser(oiVar.f27082c.bot_id);
            ...
            case 10:
                ...
                i91.V((i91) this.f893b, (TLRPC.TL_attachMenuBot) this.f894c);
                return;
            default:
                a5.a aVar = (a5.a) this.f893b;
                ((u2.l0) obj).d(aVar.f276b, (u2.f0) aVar.f277c, (u2.b0) this.f894c);
                return;
        }
    }
}
