...
public final class c extends b {
    ...
    @Override
    public final c a() {
        Parcel parcel = this.f49568e;
        int dataPosition = parcel.dataPosition();
        int i10 = this.f49572j;
        if (i10 == this.f49569f) {
            i10 = this.f49570g;
        }
        return new c(parcel, dataPosition, i10, a4.a.s(new StringBuilder(), this.h, "  "), this.f49565a, this.f49566b, this.f49567c);
    }

    @Override
    public final boolean e(int i10) {
        while (this.f49572j < this.f49570g) {
            ...
            if (i11 != i10) {
                if (String.valueOf(i11).compareTo(String.valueOf(i10)) <= 0) {
                    ...
                    this.f49573k = parcel.readInt();
                    this.f49572j += readInt;
                } else {
                    return false;
                }
            } else {
