...
public final class h implements b1, d1, y2.h, y2.k {
    ...
    public final s[] f43881c;
    public final boolean[] d;
    public final l2.k e;
    public final l2.b f43882f;
    public final a5.a h;
    public final qb.b f43883n;
    public final y2.m f43884r = new y2.m("ChunkSampleStream");
    public final p f43885s = new p(7);
    public final ArrayList v;
    public final List f43886w;
    public final a1 f43887x;
    public final a1[] f43888y;
    ...
    public h(int i10, int[] iArr, s[] sVarArr, l2.k kVar, l2.b bVar, y2.d dVar, long j3, n2.m mVar, n2.j jVar, qb.b bVar2, a5.a aVar, boolean z10) {
        ...
        this.v = arrayList;
        this.f43886w = DesugarCollections.unmodifiableList(arrayList);
        int length = iArr.length;
        this.f43888y = new a1[length];
        ...
        while (i12 < length) {
            ...
            this.f43888y[i12] = a1Var2;
            int i13 = i12 + 1;
            a1VarArr[i13] = a1Var2;
            iArr2[i13] = this.f43880b[i12];
            i12 = i13;
        }
    ...
    public final void V(y2.j jVar, long j3, long j10, boolean z10) {
        ...
        this.F = null;
        this.L = null;
        long j11 = eVar.f43870a;
        Uri uri = eVar.f43875r.f9352c;
        t tVar = new t(j10);
        this.f43883n.getClass();
        this.h.o(tVar, eVar.f43872c, this.f43879a, eVar.d, eVar.e, eVar.f43873f, eVar.h, eVar.f43874n);
        if (!z10) {
            if (y()) {
                this.f43887x.D(false);
                for (a1 a1Var : this.f43888y) {
                    a1Var.D(false);
                }
    ...
    public final void o(y2.j jVar, long j3, long j10, int i10) {
        ...
        if (i10 == 0) {
            long j11 = eVar.f43870a;
            tVar = new t(eVar.f43871b);
        } else {
            long j12 = eVar.f43870a;
            Uri uri = eVar.f43875r.f9352c;
            tVar = new t(j10);
        }
        t tVar2 = tVar;
        this.h.s(tVar2, eVar.f43872c, this.f43879a, eVar.d, eVar.e, eVar.f43873f, eVar.h, eVar.f43874n, i10);
    }
    ...
    public final void q(y2.j jVar, long j3, long j10) {
        ...
        if (nVar != null) {
            long j11 = nVar.d;
            if (j11 == -9223372036854775807L || eVar.f43874n > j11) {
                nVar.d = eVar.f43874n;
            }
            nVar.e.h = true;
        }
        ...
        t tVar = new t(j10);
        this.f43883n.getClass();
        this.h.p(tVar, eVar.f43872c, this.f43879a, eVar.d, eVar.e, eVar.f43873f, eVar.h, eVar.f43874n);
        this.f43882f.v(this);
    }
    ...
    public final long s() {
        ...
        if (w10 != null) {
            j3 = Math.max(j3, w10.f43874n);
        }
        return Math.max(j3, this.f43887x.q());
    }
    ...
    public final a v(int i10) {
        ...
        int i11 = 0;
        this.f43887x.n(aVar.d(0));
        while (true) {
            a1[] a1VarArr = this.f43888y;
    ...
    public final void z() {
        int A = A(this.f43887x.t(), this.K - 1);
        while (true) {
            int i10 = this.K;
            if (i10 <= A) {
                this.K = i10 + 1;
                ...
                if (!sVar.equals(this.G)) {
                    this.h.k(this.f43879a, sVar, aVar.e, aVar.f43873f, aVar.h);
                }
                this.G = sVar;
            } else {
                return;
