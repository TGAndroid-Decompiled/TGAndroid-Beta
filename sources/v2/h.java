...
public final class h implements b1, d1, y2.h, y2.k {
    ...
    public final s[] f47340c;
    public final boolean[] d;
    public final l2.k f47341e;
    public final l2.b f47342f;
    public final a5.a h;
    public final rb.a f47343n;
    public final y2.m f47344r = new y2.m("ChunkSampleStream");
    public final p f47345s = new p(7);
    public final ArrayList v;
    public final List f47346w;
    public final a1 f47347x;
    public final a1[] f47348y;
    ...
    public h(int i10, int[] iArr, s[] sVarArr, l2.k kVar, l2.b bVar, y2.d dVar, long j3, n2.m mVar, n2.j jVar, rb.a aVar, a5.a aVar2, boolean z10) {
        ...
        this.v = arrayList;
        this.f47346w = DesugarCollections.unmodifiableList(arrayList);
        int length = iArr.length;
        this.f47348y = new a1[length];
        ...
        while (i12 < length) {
            ...
            this.f47348y[i12] = a1Var2;
            int i13 = i12 + 1;
            a1VarArr[i13] = a1Var2;
            iArr2[i13] = this.f47339b[i12];
            i12 = i13;
        }
    ...
    public final void A() {
        int B = B(this.f47347x.t(), this.K - 1);
        while (true) {
            int i10 = this.K;
            if (i10 <= B) {
                this.K = i10 + 1;
                ...
                if (!sVar.equals(this.G)) {
                    this.h.j(this.f47338a, sVar, aVar.f47330e, aVar.f47331f, aVar.h);
                }
                this.G = sVar;
            } else {
                return;
    ...
    public final void C(l2.b bVar) {
        ...
        for (a1 a1Var2 : this.f47348y) {
            a1Var2.k();
            n2.g gVar2 = a1Var2.h;
            if (gVar2 != null) {
                gVar2.a(a1Var2.f46650e);
                a1Var2.h = null;
                a1Var2.f46652g = null;
            }
        }
    ...
    public final void a() {
        ...
        for (l2.i iVar : this.f47341e.f15260i) {
            d dVar = iVar.f15249a;
            if (dVar != null) {
                dVar.f47320a.release();
            }
        }
        g gVar3 = this.H;
        if (gVar3 != null) {
    ...
    @Override
    public final void b() {
        y2.m mVar = this.f47344r;
        mVar.b();
        this.f47347x.z();
        if (!mVar.d()) {
            l2.k kVar = this.f47341e;
    ...
    public final void h(y2.j jVar, long j3, long j10, int i10) {
        ...
        e eVar = (e) jVar;
        if (i10 == 0) {
            long j11 = eVar.f47327a;
            tVar = new t(eVar.f47328b);
        } else {
            long j12 = eVar.f47327a;
            Uri uri = eVar.f47333r.f10326c;
            tVar = new t(j10);
        }
        t tVar2 = tVar;
        this.h.r(tVar2, eVar.f47329c, this.f47338a, eVar.d, eVar.f47330e, eVar.f47331f, eVar.h, eVar.f47332n, i10);
    }
    ...
    public final void i(y2.j jVar, long j3, long j10) {
        ...
        if (nVar != null) {
            long j11 = nVar.d;
            if (j11 == -9223372036854775807L || eVar.f47332n > j11) {
                nVar.d = eVar.f47332n;
            }
            nVar.f15277e.h = true;
        }
        ...
        Uri uri = eVar.f47333r.f10326c;
        t tVar = new t(j10);
        this.f47343n.getClass();
        this.h.o(tVar, eVar.f47329c, this.f47338a, eVar.d, eVar.f47330e, eVar.f47331f, eVar.h, eVar.f47332n);
        this.f47342f.b(this);
    }
    ...
    public final long s() {
        ...
        if (x10 != null) {
            j3 = Math.max(j3, x10.f47332n);
        }
        return Math.max(j3, this.f47347x.q());
    }
    ...
    public final a v(int i10) {
        ...
        int i11 = 0;
        this.f47347x.n(aVar.d(0));
        while (true) {
            a1[] a1VarArr = this.f47348y;
    ...
    public final void w(y2.j jVar, long j3, long j10, boolean z10) {
        ...
        t tVar = new t(j10);
        this.f47343n.getClass();
        this.h.n(tVar, eVar.f47329c, this.f47338a, eVar.d, eVar.f47330e, eVar.f47331f, eVar.h, eVar.f47332n);
        if (!z10) {
            if (z()) {
                this.f47347x.D(false);
                for (a1 a1Var : this.f47348y) {
                    a1Var.D(false);
                }
