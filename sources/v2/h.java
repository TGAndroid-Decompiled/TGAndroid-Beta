...
public final class h implements b1, d1, y2.g, y2.j {
    ...
    public final s[] f44135c;
    public final boolean[] d;
    public final l2.k e;
    public final l2.b f44136f;
    public final a5.a h;
    public final qb.b f44137n;
    public final y2.l f44138r = new y2.l("ChunkSampleStream");
    public final p f44139s = new p(7);
    public final ArrayList v;
    public final List f44140w;
    public final a1 f44141x;
    public final a1[] f44142y;
    ...
    public h(int i10, int[] iArr, s[] sVarArr, l2.k kVar, l2.b bVar, y2.d dVar, long j3, n nVar, n2.k kVar2, qb.b bVar2, a5.a aVar, boolean z10) {
        ...
        this.v = arrayList;
        this.f44140w = DesugarCollections.unmodifiableList(arrayList);
        int length = iArr.length;
        this.f44142y = new a1[length];
        ...
        while (i12 < length) {
            ...
            this.f44142y[i12] = a1Var2;
            int i13 = i12 + 1;
            a1VarArr[i13] = a1Var2;
            iArr2[i13] = this.f44134b[i12];
            i12 = i13;
        }
    ...
    public final void E(y2.i iVar, long j3, long j10, boolean z10) {
        ...
        t tVar = new t(j10);
        this.f44137n.getClass();
        this.h.o(tVar, eVar.f44126c, this.f44133a, eVar.d, eVar.e, eVar.f44127f, eVar.h, eVar.f44128n);
        if (!z10) {
            if (y()) {
                this.f44141x.D(false);
                for (a1 a1Var : this.f44142y) {
                    a1Var.D(false);
                }
    ...
    public final void n(y2.i iVar, long j3, long j10, int i10) {
        ...
        t tVar2 = tVar;
        this.h.s(tVar2, eVar.f44126c, this.f44133a, eVar.d, eVar.e, eVar.f44127f, eVar.h, eVar.f44128n, i10);
    }
    ...
    public final void o(y2.i iVar, long j3, long j10) {
        ...
        if (nVar != null) {
            long j11 = nVar.d;
            if (j11 == -9223372036854775807L || eVar.f44128n > j11) {
                nVar.d = eVar.f44128n;
            }
            nVar.e.h = true;
        }
        ...
        t tVar = new t(j10);
        this.f44137n.getClass();
        this.h.p(tVar, eVar.f44126c, this.f44133a, eVar.d, eVar.e, eVar.f44127f, eVar.h, eVar.f44128n);
        this.f44136f.m(this);
    }
    ...
    public final long s() {
        ...
        if (w10 != null) {
            j3 = Math.max(j3, w10.f44128n);
        }
        return Math.max(j3, this.f44141x.q());
    }
    ...
    public final a v(int i10) {
        ...
        int i11 = 0;
        this.f44141x.n(aVar.d(0));
        while (true) {
            a1[] a1VarArr = this.f44142y;
    ...
    public final void z() {
        int A = A(this.f44141x.t(), this.K - 1);
        while (true) {
            int i10 = this.K;
            if (i10 <= A) {
                this.K = i10 + 1;
                ...
                if (!sVar.equals(this.G)) {
                    this.h.k(this.f44133a, sVar, aVar.e, aVar.f44127f, aVar.h);
                }
                this.G = sVar;
            } else {
                return;
