...
public final class i extends a {
    ...
    public final void a() {
        ...
        a1[] a1VarArr;
        long j3;
        o0.a aVar = this.f43826x;
        e2.d.h(aVar);
        if (this.H == 0) {
            long j10 = this.F;
            for (a1 a1Var : (a1[]) aVar.f15301c) {
                if (a1Var.F != j10) {
                    a1Var.F = j10;
                    a1Var.f43333z = true;
                }
        ...
        try {
            g2.m b10 = this.f43843b.b(this.H);
            b0 b0Var = this.f43847r;
            c3.l lVar = new c3.l(b0Var, b10.e, b0Var.open(b10));
            while (!this.I) {
                int m10 = this.G.f43836a.m(lVar, d.f43835s);
                if (m10 != 1) {
                    z10 = true;
                } else {
                    z10 = false;
            ...
            s sVar = this.d;
            String str = sVar.f3303q;
            int i10 = sVar.Q;
            int i11 = sVar.R;
            if (r0.k(str) && ((i10 > 1 || i11 > 1) && i10 != -1 && i11 != -1)) {
                h0 U = aVar.U(4);
                int i12 = i10 * i11;
                long j14 = (this.f43846n - this.h) / i12;
                for (int i13 = 1; i13 < i12; i13++) {
                    U.d(0, new v());
                    U.c(i13 * j14, 0, 0, 0, null);
                }
            }
            this.H = lVar.d - this.f43843b.e;
            m7.a(this.f43847r);
            this.J = !this.I;
        } catch (Throwable th2) {
            m7.a(this.f43847r);
