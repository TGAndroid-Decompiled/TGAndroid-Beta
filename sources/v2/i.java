...
public final class i extends a {
    ...
    public final void a() {
        ...
        a1[] a1VarArr;
        long j3;
        o0.a aVar = this.f47308x;
        e2.d.h(aVar);
        if (this.H == 0) {
            long j10 = this.F;
            for (a1 a1Var : (a1[]) aVar.f16797c) {
                if (a1Var.F != j10) {
                    a1Var.F = j10;
                    a1Var.f46668z = true;
                }
        ...
        try {
            ...
            s sVar = this.d;
            String str = sVar.f2396q;
            int i10 = sVar.Q;
            int i11 = sVar.R;
            if (r0.k(str) && ((i10 > 1 || i11 > 1) && i10 != -1 && i11 != -1)) {
                h0 U = aVar.U(4);
                int i12 = i10 * i11;
                long j14 = (this.f47331n - this.h) / i12;
                for (int i13 = 1; i13 < i12; i13++) {
                    U.d(0, new v());
                    U.c(i13 * j14, 0, 0, 0, null);
                }
            }
            this.H = lVar.d - this.f47327b.f10361e;
            m7.a(this.f47332r);
            this.J = !this.I;
        } catch (Throwable th2) {
            m7.a(this.f47332r);
