...
public final class j1 extends j {
    public final int f2332n = 2;
    public final Paint f2333r;
    public final Path f2334s;

    public j1(k1 k1Var, Context context) {
        super(k1Var, context);
        Paint paint = new Paint(1);
        this.f2333r = paint;
        this.f2334s = new Path();
    ...
    public final int a(float f9, float f10) {
        switch (this.f2332n) {
            case 0:
                ...
                if (f9 > f12 - dp && f10 > A - dp && f9 < f12 + dp && f10 < A + dp) {
                    return 2;
                }
                return 0;
            case 1:
                ...
                float A2 = com.google.android.recaptcha.internal.a.A(getMeasuredHeight(), f13, 2.0f, dp4);
                if (f9 > dp4 - dp3 && f10 > A2 - dp3 && f9 < dp4 + dp3 && f10 < A2 + dp3) {
                    return 1;
                }
                float f14 = dp4 + measuredWidth2;
                if (f9 > f14 - dp3 && f10 > A2 - dp3 && f9 < f14 + dp3 && f10 < A2 + dp3) {
                    return 2;
                }
                return 0;
            case 2:
                ...
                if (f9 > dp6 - dp5 && f10 > f16 - dp5 && f9 < dp6 + dp5 && f10 < f16 + dp5) {
                    return 1;
                }
                float f17 = dp6 + measuredWidth3;
                if (f9 > f17 - dp5 && f10 > f16 - dp5 && f9 < f17 + dp5 && f10 < f16 + dp5) {
                    return 2;
                }
                if (f9 > dp6 && f9 < measuredWidth3 && f10 > dp6 && f10 < measuredHeight) {
                    return 3;
                }
                return 0;
            case 3:
                ...
                if (f9 > dp8 - dp7 && f10 > f19 - dp7 && f9 < dp8 + dp7 && f10 < f19 + dp7) {
                    return 1;
                }
                float f20 = dp8 + measuredWidth4;
                if (f9 > f20 - dp7 && f10 > f19 - dp7 && f9 < f20 + dp7 && f10 < f19 + dp7) {
                    return 2;
                }
                if (f9 > dp8 && f9 < measuredWidth4 && f10 > dp8 && f10 < measuredHeight2) {
                    return 3;
                }
                return 0;
            case 4:
                ...
                float A3 = com.google.android.recaptcha.internal.a.A(getMeasuredHeight(), f21, 2.0f, dp10);
                if (f9 > dp10 - dp9 && f10 > A3 - dp9 && f9 < dp10 + dp9 && f10 < A3 + dp9) {
                    return 1;
                }
                float f22 = dp10 + measuredWidth5;
                if (f9 > f22 - dp9 && f10 > A3 - dp9 && f9 < f22 + dp9 && f10 < A3 + dp9) {
                    return 2;
                }
                return 0;
            default:
                ...
                float A4 = com.google.android.recaptcha.internal.a.A(getMeasuredHeight(), f23, 2.0f, dp12);
                if (f9 > dp12 - dp11 && f10 > A4 - dp11 && f9 < dp12 + dp11 && f10 < A4 + dp11) {
                    return 1;
                }
                float f24 = dp12 + measuredWidth6;
                if (f9 > f24 - dp11 && f10 > A4 - dp11 && f9 < f24 + dp11 && f10 < A4 + dp11) {
                    return 2;
                }
                return 0;
        }
        ...
        switch (this.f2332n) {
            ...
            case 1:
                ...
                if (showAlpha2 > 0.0f) {
                    ...
                    canvas.drawPath(path2, paint5);
                    float f32 = dp3 + f25;
                    Paint paint6 = this.f2326c;
                    canvas.drawCircle(dp3, f32, dpf22, paint6);
                    Paint paint7 = this.f2325b;
            ...
            case 2:
                ...
                if (showAlpha3 > 0.0f) {
                    ...
                    canvas.drawPath(path3, paint9);
                    float f45 = dp5 + f38;
                    Paint paint10 = this.f2326c;
                    canvas.drawCircle(dp5, f45, dpf23, paint10);
                    Paint paint11 = this.f2325b;
            ...
            case 3:
                ...
                if (showAlpha4 > 0.0f) {
                    ...
                    canvas.drawPath(path4, paint13);
                    float f58 = dp7 + f51;
                    Paint paint14 = this.f2326c;
                    canvas.drawCircle(dp7, f58, dpf24, paint14);
                    Paint paint15 = this.f2325b;
            ...
            case 4:
                ...
                if (showAlpha5 > 0.0f) {
                    ...
                    canvas.drawPath(path5, paint17);
                    float f71 = dp9 + f64;
                    Paint paint18 = this.f2326c;
                    canvas.drawCircle(dp9, f71, dpf25, paint18);
                    Paint paint19 = this.f2325b;
            ...
            default:
                ...
                if (showAlpha6 > 0.0f) {
                    ...
                    canvas2.drawPath(path6, paint21);
                    float f84 = dp11 + f77;
                    Paint paint22 = this.f2326c;
                    canvas2.drawCircle(dp11, f84, dpf26, paint22);
                    Paint paint23 = this.f2325b;
