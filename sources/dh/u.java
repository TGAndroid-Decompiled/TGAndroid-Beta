...
public final class u extends FrameLayout {
    public final f9 f4941a;
    public final TextView f4942b;
    public n f4943c;

    public u(Context context, int i10, f6 f6Var) {
        super(context);
        this.f4941a = new f9(i10, this, AndroidUtilities.dp(24.0f), AndroidUtilities.dp(10.0f), AndroidUtilities.dpf2(1.0f));
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        f9 f9Var = this.f4941a;
        f9Var.setBounds(width - ((int) f9Var.f24805c.d.f46906f.f46913a), AndroidUtilities.dp(12.0f), getWidth() - AndroidUtilities.dp(11.0f), AndroidUtilities.dp(24.0f) + AndroidUtilities.dp(12.0f));
        f9Var.c(canvas);
    }
