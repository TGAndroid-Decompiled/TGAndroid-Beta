...
public final class k {
    ...
    public final TLRPC.TL_messageMediaPoll f4927b;
    public final TLRPC.TL_inputMediaPoll f4928c;
    public final long d;
    public final String e;
    public final ArrayList f4929f;
        ...
        if (iVar != null) {
            ...
            for (int i11 = 0; i11 < size2; i11++) {
                ...
                if (hVar instanceof eh.e) {
                    ...
                    i.k(tL_inputMediaPoll, keyAt, lf.d.h(((eh.g) hVar).f5603b));
                } else if (hVar instanceof eh.i) {
                    TLRPC.TL_inputMediaDocument tL_inputMediaDocument = new TLRPC.TL_inputMediaDocument();
                    TLRPC.TL_inputDocument tL_inputDocument = new TLRPC.TL_inputDocument();
                    TLRPC.Document document = ((eh.i) hVar).f5606b;
