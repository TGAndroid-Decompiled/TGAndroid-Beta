...
public final class g extends View {
    public final Drawable f4907a;
    public final xd.a f4908b;
    public final int f4909c;
    public h d;

    public g(Context context, int i10) {
        super(context);
        this.f4908b = new xd.a(this, mr.h, 380L);
        this.f4909c = i10;
        Drawable mutate = context.getResources().getDrawable(R.drawable.outline_poll_attach_24).mutate();
        this.f4907a = mutate;
        mutate.setColorFilter(new PorterDuffColorFilter(j6.w0(null, j6.f20079o7, false), PorterDuff.Mode.SRC_IN));
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float f10 = this.f4908b.e;
        if (f10 < 1.0f) {
            canvas.save();
            float f11 = 1.0f - f10;
            canvas.scale(f11, f11, width, height);
            this.f4907a.draw(canvas);
            canvas.restore();
        }
        if (f10 > 0.0f) {
            float f12 = this.f4909c;
    ...
    public final void onSizeChanged(int i10, int i11, int i12, int i13) {
        ...
        int i14 = (i10 - dp) / 2;
        int i15 = (i11 - dp) / 2;
        this.f4907a.setBounds(i14, i15, i14 + dp, dp + i15);
    }
}
