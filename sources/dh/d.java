...
public final class d extends FrameLayout {
    ...
    public void onDraw(Canvas canvas) {
        switch (this.f4893a) {
            case 6:
                int intrinsicHeight = j6.f19968i3.getIntrinsicHeight();
                j6.f19968i3.setBounds(0, 0, getMeasuredWidth(), intrinsicHeight);
                j6.f19968i3.draw(canvas);
                canvas.drawRect(0.0f, intrinsicHeight, getMeasuredWidth(), getMeasuredHeight(), j6.f19984j2);
                return;
            case 8:
                canvas.drawRect(0.0f, 0.0f, getMeasuredWidth(), AndroidUtilities.getShadowHeight(), j6.f20000k0);
                return;
            case 18:
                canvas.drawLine(0.0f, AndroidUtilities.dp(40.0f), getMeasuredWidth(), AndroidUtilities.dp(40.0f), j6.f20000k0);
                return;
            case 26:
                int intrinsicHeight2 = j6.f19968i3.getIntrinsicHeight();
                j6.f19968i3.setBounds(0, 0, getMeasuredWidth(), intrinsicHeight2);
                j6.f19968i3.draw(canvas);
                canvas.drawRect(0.0f, intrinsicHeight2, getMeasuredWidth(), getMeasuredHeight(), j6.f19984j2);
                return;
            default:
                super.onDraw(canvas);
                return;
    ...
    public d(g41 g41Var, Context context, int i10, String str, CharSequence charSequence) {
        ...
        int i11 = j6.G6;
        mutate.setColorFilter(new PorterDuffColorFilter(j6.v0(i11, g41.Q(g41Var)), PorterDuff.Mode.MULTIPLY));
        imageView.setImageDrawable(mutate);
        addView(imageView, b6.d(24, 24.0f, z4 ? 5 : 3, z4 ? 0.0f : 27.0f, 6.0f, z4 ? 27.0f : 0.0f, 0.0f));
        TextView textView = new TextView(getContext());
        textView.setText(str);
        textView.setTextColor(j6.v0(i11, g41.R(g41Var)));
        ...
        f90Var.setTextColor(j6.v0(j6.Pi, g41.S(g41Var)));
        f90Var.setLinkTextColor(j6.v0(j6.f19941gc, g41.T(g41Var)));
    ...
    public d(w31 w31Var, Context context, int i10, String str, CharSequence charSequence) {
        ...
        Drawable mutate = getContext().getResources().getDrawable(i10).mutate();
        int i11 = j6.G6;
        mutate.setColorFilter(new PorterDuffColorFilter(j6.v0(i11, w31.P(w31Var)), PorterDuff.Mode.MULTIPLY));
        imageView.setImageDrawable(mutate);
        addView(imageView, b6.d(24, 24.0f, z4 ? 5 : 3, z4 ? 0.0f : 27.0f, 6.0f, z4 ? 27.0f : 0.0f, 0.0f));
        TextView textView = new TextView(getContext());
        textView.setText(str);
        textView.setTextColor(j6.v0(i11, w31.Q(w31Var)));
        ai.o(14.0f, 1, textView);
        addView(textView, b6.d(-2, -2.0f, z4 ? 5 : 3, z4 ? 27.0f : 68.0f, 0.0f, z4 ? 68.0f : 27.0f, 0.0f));
        f90 f90Var = new f90(getContext(), null);
        f90Var.setText(charSequence);
        f90Var.setTextSize(1, 14.0f);
        f90Var.setTextColor(j6.v0(j6.Pi, w31.R(w31Var)));
        f90Var.setLinkTextColor(j6.v0(j6.f19941gc, w31.S(w31Var)));
        f90Var.setLineSpacing(AndroidUtilities.dp(2.0f), 1.0f);
    ...
    public d(Context context, int i10, String str, CharSequence charSequence, f6 f6Var) {
        ...
        f90Var2.setTextColor(j6.v0(j6.f20256y6, f6Var));
