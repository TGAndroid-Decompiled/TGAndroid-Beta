...
public final class d extends FrameLayout {
    ...
    public void onDraw(Canvas canvas) {
        switch (this.f4887a) {
            case 6:
                int intrinsicHeight = j6.f19993i3.getIntrinsicHeight();
                j6.f19993i3.setBounds(0, 0, getMeasuredWidth(), intrinsicHeight);
                j6.f19993i3.draw(canvas);
                canvas.drawRect(0.0f, intrinsicHeight, getMeasuredWidth(), getMeasuredHeight(), j6.f20009j2);
                return;
            case 8:
                canvas.drawRect(0.0f, 0.0f, getMeasuredWidth(), AndroidUtilities.getShadowHeight(), j6.f20025k0);
                return;
            case 18:
                canvas.drawLine(0.0f, AndroidUtilities.dp(40.0f), getMeasuredWidth(), AndroidUtilities.dp(40.0f), j6.f20025k0);
                return;
            case 26:
                int intrinsicHeight2 = j6.f19993i3.getIntrinsicHeight();
                j6.f19993i3.setBounds(0, 0, getMeasuredWidth(), intrinsicHeight2);
                j6.f19993i3.draw(canvas);
                canvas.drawRect(0.0f, intrinsicHeight2, getMeasuredWidth(), getMeasuredHeight(), j6.f20009j2);
                return;
            default:
                super.onDraw(canvas);
                return;
    ...
    public d(z31 z31Var, Context context, int i10, String str, CharSequence charSequence) {
        ...
        int i11 = j6.G6;
        mutate.setColorFilter(new PorterDuffColorFilter(j6.v0(i11, z31.Q(z31Var)), PorterDuff.Mode.MULTIPLY));
        imageView.setImageDrawable(mutate);
        addView(imageView, b6.d(24, 24.0f, z4 ? 5 : 3, z4 ? 0.0f : 27.0f, 6.0f, z4 ? 27.0f : 0.0f, 0.0f));
        TextView textView = new TextView(getContext());
        textView.setText(str);
        textView.setTextColor(j6.v0(i11, z31.R(z31Var)));
        ...
        e90Var.setTextColor(j6.v0(j6.Pi, z31.S(z31Var)));
        e90Var.setLinkTextColor(j6.v0(j6.f19966gc, z31.T(z31Var)));
    ...
    public d(p31 p31Var, Context context, int i10, String str, CharSequence charSequence) {
        ...
        Drawable mutate = getContext().getResources().getDrawable(i10).mutate();
        int i11 = j6.G6;
        mutate.setColorFilter(new PorterDuffColorFilter(j6.v0(i11, p31.P(p31Var)), PorterDuff.Mode.MULTIPLY));
        imageView.setImageDrawable(mutate);
        addView(imageView, b6.d(24, 24.0f, z4 ? 5 : 3, z4 ? 0.0f : 27.0f, 6.0f, z4 ? 27.0f : 0.0f, 0.0f));
        TextView textView = new TextView(getContext());
        textView.setText(str);
        textView.setTextColor(j6.v0(i11, p31.Q(p31Var)));
        yh.p(14.0f, 1, textView);
        addView(textView, b6.d(-2, -2.0f, z4 ? 5 : 3, z4 ? 27.0f : 68.0f, 0.0f, z4 ? 68.0f : 27.0f, 0.0f));
        e90 e90Var = new e90(getContext(), null);
        e90Var.setText(charSequence);
        e90Var.setTextSize(1, 14.0f);
        e90Var.setTextColor(j6.v0(j6.Pi, p31.R(p31Var)));
        e90Var.setLinkTextColor(j6.v0(j6.f19966gc, p31.S(p31Var)));
        e90Var.setLineSpacing(AndroidUtilities.dp(2.0f), 1.0f);
    ...
    public d(Context context, int i10, String str, CharSequence charSequence, f6 f6Var) {
        ...
        e90Var2.setTextColor(j6.v0(j6.f20281y6, f6Var));
