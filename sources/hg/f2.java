...
public final class f2 {
    ...
    public static final Object[] f10286f = new Object[4];
    ...
    public final TLRPC.TL_timezone a(String str) {
        ...
        while (true) {
            ...
            if (TextUtils.equals(tL_timezone.f18250id, str)) {
                return tL_timezone;
            }
            i10++;
        }
