...
public final class p0 extends FrameLayout {
    public static final int f11205f = 0;
    public final f6 f11206a;
    public final x9 f11207b;
    ...
    public final void a() {
        ...
        int i10 = j6.f20656ci;
        f6 f6Var = this.f11206a;
        setBackground(j6.b0(dp, j6.v0(i10, f6Var)));
        this.f11208c.setTextColor(j6.v0(j6.G6, f6Var));
        oq oqVar = this.d;
        if (oqVar != null) {
            if (this.f11209e.d == 7) {
    ...
    public void setData(q0 q0Var) {
        ...
        oq L2 = j6.L(AndroidUtilities.dp(32.0f), q0Var.f11215a);
        this.d = L2;
        int i11 = j6.Oh;
