...
public final class v0 extends n2 {
    ...
    public static final int f10423a0 = -7;
    public static final int f10424b0 = -8;
    public static final int f10425c0 = -9;
    public static final int f10426d0 = -10;
    public static final int f10427e0 = -11;
    public static final int f10428f0 = -12;
    public static final int f10429g0 = -13;
    public static final int f10430h0 = -14;
    public static final int f10431i0 = -15;
    public static final int f10432j0 = -16;
    public static final int f10433k0 = -17;
    public static final int f10434l0 = -18;
    public static final int m0 = -19;
    public static final int f10435n0 = -20;
    public static final int f10436o0 = -21;
    public int E;
    public final o0 F;
    ...
    public boolean T;
    public pr f10437a;
    public org.telegram.ui.ActionBar.v0 f10438b;
    public e61 f10439c;
    public gg.c2 d;
    public FrameLayout e;
    public EditTextBoldCursor f10440f;
    public View h;
    public x5 f10441n;
    public TextView f10442r;
    public ImageView f10443s;
    public c0 v;
    public boolean f10444w;
    ...
    public static void W(v0 v0Var, i51 i51Var, final View view) {
        if (i51Var.f24896g && !v0Var.v.h(i51Var)) {
            int i10 = i51Var.d;
            if (i10 == U) {
                c0 c0Var = v0Var.v;
                v0Var.I = true;
                ...
                v0Var.f10439c.Y2.N(true);
                v0Var.Y(true);
            } else if (i51Var.f15531a == 13) {
                TLRPC.User user = (TLRPC.User) v0Var.N.get(i51Var.f24911x);
                if (user != null) {
                    if (!user.bot_business) {
                        ...
                        alertDialog$Builder.f18435a.R = LocaleController.getString(R.string.BusinessBotNotSupportedTitle);
                        alertDialog$Builder.f18435a.T = AndroidUtilities.replaceTags(LocaleController.getString(R.string.BusinessBotNotSupportedMessage));
                        alertDialog$Builder.k(LocaleController.getString(R.string.OK), null);
                        v0Var.showDialog(alertDialog$Builder.f18435a);
                        return;
                    }
                    v0Var.M = user;
                    AndroidUtilities.hideKeyboard(v0Var.f10440f);
                    v0Var.f10439c.Y2.N(true);
                    v0Var.Y(true);
                }
            } else if (i10 == X) {
                ...
                v0Var.f10439c.Y2.N(true);
                v0Var.Y(true);
            } else if (i10 == f10426d0) {
                boolean z15 = !v0Var.Q;
                v0Var.Q = z15;
                ((v8) view).setChecked(z15);
                v0Var.f10439c.Y2.N(true);
            } else if (i10 == f10427e0) {
                    ...
                    public final void run() {
                        switch (r3) {
                            ...
                            case 4:
                                ...
                                v0Var6.f10439c.Y2.N(true);
                                v0Var6.Y(true);
                                return;
                            default:
                                v0 v0Var7 = this.f10367b;
                                v0Var7.getClass();
                                ...
                                v0Var7.f10439c.Y2.N(true);
                                v0Var7.Y(true);
                                return;
                        }
                    }
                });
            } else if (i10 == f10431i0) {
                boolean z19 = !v0Var.R;
                v0Var.R = z19;
                ((v8) view).setChecked(z19);
                v0Var.f10439c.Y2.N(true);
            } else if (i10 == f10432j0) {
    ...
    public final void X(int i10, boolean z10, final Runnable runnable) {
        ...
        } else if (!this.L && z10 && (i10 == f10433k0 || i10 == f10434l0 || i10 == m0 || i10 == f10435n0)) {
    ...
    public final void Y(boolean z10) {
        ...
        boolean Z2 = Z();
        this.f10438b.setEnabled(Z2);
        float f13 = 0.0f;
        if (z10) {
            ViewPropertyAnimator animate = this.f10438b.animate();
            if (Z2) {
                f11 = 1.0f;
            } else {
                f11 = 0.0f;
        ...
        org.telegram.ui.ActionBar.v0 v0Var = this.f10438b;
        if (Z2) {
            f7 = 1.0f;
        } else {
            f7 = 0.0f;
        ...
        v0Var.setAlpha(f7);
        org.telegram.ui.ActionBar.v0 v0Var2 = this.f10438b;
        if (Z2) {
            f10 = 1.0f;
        } else {
            f10 = 0.0f;
        ...
        org.telegram.ui.ActionBar.v0 v0Var3 = this.f10438b;
        if (Z2) {
            f13 = 1.0f;
        }
    ...
    public final void a0() {
        ...
        if (this.f10437a.f27129c <= 0.0f) {
            if (!Z()) {
                finishFragment();
            } else if (this.v.k(this.f10439c)) {
                TLRPC.User user2 = this.M;
                if (user2 != null && ((tL_connectedBot = this.H) == null || tL_connectedBot.bot_id != user2.f18256id)) {
                    z10 = true;
                } else {
                    z10 = false;
                }
                ...
                if (tL_connectedBot2 != null && ((user = this.M) == null || tL_connectedBot2.bot_id != user.f18256id)) {
                ...
                if (this.M != null) {
                    ...
                    if (tL_connectedBot3 != null) {
                        tL_connectedBot3.bot_id = this.M.f18256id;
    ...
    public final void b0() {
        ...
        float f7;
        float f10;
        boolean z11 = this.f10444w;
        boolean e = this.d.e();
        boolean z12 = true;
        LongSparseArray longSparseArray = this.N;
        if (!e && !this.f10445x && longSparseArray.size() <= 0) {
            z10 = false;
        } else {
            z10 = true;
        }
        if (z11 != z10) {
            if (!this.d.e() && !this.f10445x && longSparseArray.size() <= 0) {
                z12 = false;
            }
            this.f10444w = z12;
            ViewPropertyAnimator animate = this.f10442r.animate();
            float f11 = 1.0f;
            float f12 = 0.0f;
            if (z12) {
                f7 = 0.0f;
            ...
            ViewPropertyAnimator animate2 = this.f10443s.animate();
            if (!z12) {
                f11 = 0.0f;
            }
    ...
    public final View createView(Context context) {
        ...
        this.f10437a = new pr(mutate, new tp(i6.w0(null, i12, false)));
        this.f10438b = this.actionBar.n().i(AndroidUtilities.dp(56.0f), LocaleController.getString(R.string.Done), this.f10437a);
        Y(false);
        ...
        this.f10440f = editTextBoldCursor;
        editTextBoldCursor.setTextSize(1, 17.0f);
        this.f10440f.setHintTextColor(i6.w0(null, i6.H6, false));
        EditTextBoldCursor editTextBoldCursor2 = this.f10440f;
        int i13 = i6.G6;
        editTextBoldCursor2.setTextColor(i6.w0(null, i13, false));
        this.f10440f.setBackgroundDrawable(null);
        this.f10440f.setMaxLines(1);
        this.f10440f.setLines(1);
        this.f10440f.setPadding(0, 0, 0, 0);
        this.f10440f.setSingleLine(true);
        EditTextBoldCursor editTextBoldCursor3 = this.f10440f;
        ...
        this.f10440f.setInputType(180224);
        this.f10440f.setImeOptions(6);
        this.f10440f.setHint(LocaleController.getString(R.string.BusinessBotLink));
        this.f10440f.setCursorColor(i6.w0(null, i13, false));
        this.f10440f.setCursorSize(AndroidUtilities.dp(19.0f));
        this.f10440f.setCursorWidth(1.5f);
        this.f10440f.setOnEditorActionListener(new u0(this, 0));
        this.f10440f.addTextChangedListener(new i2(this, 2));
        FrameLayout frameLayout2 = new FrameLayout(context);
        this.e = frameLayout2;
        frameLayout2.addView(this.f10440f, w7.x5.d(-1, -1.0f, 48, 21.0f, 15.0f, 21.0f, 15.0f));
        ...
        this.f10442r = textView;
        textView.setText(LocaleController.getString(R.string.BusinessBotNotFound));
        this.f10442r.setTextSize(1, 14.0f);
        TextView textView2 = this.f10442r;
        int i16 = i6.f19234z6;
        textView2.setTextColor(getThemedColor(i16));
        this.f10441n.addView(this.f10442r, w7.x5.e(-2, -2, 17));
        this.f10443s = new ImageView(context);
        u8 u8Var = new u8(getThemedColor(i16));
        this.f10443s.setScaleType(ImageView.ScaleType.CENTER);
        this.f10443s.setImageDrawable(u8Var);
        this.f10441n.addView(this.f10443s, w7.x5.e(-2, -2, 17));
        this.f10443s.setAlpha(0.0f);
        this.f10443s.setTranslationY(AndroidUtilities.dp(8.0f));
        gg.c2 c2Var = new gg.c2(true);
        this.d = c2Var;
        c2Var.f9686a = new a6.m(this, 24);
    ...
    public final boolean onBackPressed(boolean z10) {
        if (Z()) {
            if (z10) {
                ...
                alertDialog$Builder.f18435a.T = LocaleController.getString(R.string.BusinessBotUnsavedChanges);
            ...
            if (z10) {
                ...
                alertDialog$Builder2.f18435a.R = LocaleController.getString(R.string.BusinessBotNoAddedTitle);
                alertDialog$Builder2.f18435a.T = LocaleController.getString(R.string.BusinessBotNoAddedText);
    ...
    public final void onInsets(int i10, int i11, int i12, int i13) {
        this.f10439c.setPadding(0, 0, 0, i13);
        this.f10439c.setClipToPadding(false);
    }
}
