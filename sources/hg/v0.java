...
public final class v0 extends m2 {
            ...
            if (i10 == U) {
                ...
                if (user != null) {
                    if (!user.bot_business) {
                        ...
                        alertDialog$Builder.f18661a.R = LocaleController.getString(R.string.BusinessBotNotSupportedTitle);
                        alertDialog$Builder.f18661a.T = AndroidUtilities.replaceTags(LocaleController.getString(R.string.BusinessBotNotSupportedMessage));
                        alertDialog$Builder.k(LocaleController.getString(R.string.OK), null);
                        v0Var.showDialog(alertDialog$Builder.f18661a);
                        return;
                    }
                    v0Var.M = user;
    ...
    public final void X(int i10, boolean z10, final Runnable runnable) {
        if (!this.K && i10 == f10416h0 && z10) {
            ...
            alertDialog$Builder.k(LocaleController.getString(R.string.Allow), new org.telegram.ui.ActionBar.z1(this) {
            ...
            alertDialog$Builder2.k(LocaleController.getString(R.string.Allow), new org.telegram.ui.ActionBar.z1(this) {
                public final v0 f10397b;
                ...
                @Override
                public final void f(org.telegram.ui.ActionBar.a2 a2Var22, int i11) {
                    switch (r3) {
                        case 0:
                            this.f10397b.K = true;
                            runnable.run();
    ...
    public final void Y(boolean z10) {
        ...
        org.telegram.ui.ActionBar.u0 u0Var = this.f10424b;
        if (Z2) {
            f7 = 1.0f;
        } else {
            f7 = 0.0f;
        ...
        u0Var.setAlpha(f7);
        org.telegram.ui.ActionBar.u0 u0Var2 = this.f10424b;
        if (Z2) {
            f10 = 1.0f;
        } else {
            f10 = 0.0f;
        ...
        org.telegram.ui.ActionBar.u0 u0Var3 = this.f10424b;
        if (Z2) {
            f13 = 1.0f;
        }
    ...
    public final void a0() {
        ...
        if (this.f10423a.f28047c <= 0.0f) {
            if (!Z()) {
                ...
                if (user2 != null && ((tL_connectedBot = this.H) == null || tL_connectedBot.bot_id != user2.f18482id)) {
                    z10 = true;
                } else {
                    z10 = false;
                }
                ...
                if (tL_connectedBot2 != null && ((user = this.M) == null || tL_connectedBot2.bot_id != user.f18482id)) {
                ...
                if (this.M != null) {
                    ...
                    if (tL_connectedBot3 != null) {
                        tL_connectedBot3.bot_id = this.M.f18482id;
    ...
    public final boolean onBackPressed(boolean z10) {
        if (Z()) {
            if (z10) {
                ...
                alertDialog$Builder.f18661a.T = LocaleController.getString(R.string.BusinessBotUnsavedChanges);
            ...
            if (z10) {
                ...
                alertDialog$Builder2.f18661a.R = LocaleController.getString(R.string.BusinessBotNoAddedTitle);
                alertDialog$Builder2.f18661a.T = LocaleController.getString(R.string.BusinessBotNoAddedText);
