...
public abstract class j1 extends LinearLayout {
    public boolean E;
    public boolean F;
    public final e6 f10323a;
    public final TextView f10324b;
    public final TextView[] f10325c;
    public final ImageView d;
    public final FrameLayout e;
    public final ViewGroup[] f10326f;
    public final TextView[] h;
    public final TextView[][] f10327n;
    public final dq f10328r;
    public final FrameLayout f10329s;
    ...
    public j1(Context context, e6 e6Var) {
        ...
        int i15;
        int i16;
        this.f10325c = new TextView[2];
        this.f10326f = new ViewGroup[7];
        this.h = new TextView[7];
        this.f10327n = new TextView[7];
        this.f10330w = 1;
        this.f10331x = 0;
        this.f10332y = true;
        this.f10323a = e6Var;
        ...
        for (int i18 = 7; i17 < i18; i18 = 7) {
            if (i17 == 0) {
                ...
                this.h[i17].setTextColor(i6.v0(i6.f19237z6, e6Var));
                x5Var.addView(this.h[i17], w7.x5.i(-2.0f, -2.0f, 8388659, 0.0f, 33.0f, 0.0f, 10.0f));
                LinearLayout linearLayout = new LinearLayout(context);
                this.v = linearLayout;
                linearLayout.setOrientation(1);
                this.f10329s = new FrameLayout(context);
                this.f10327n[i17] = new TextView[2];
                for (int i19 = 0; i19 < 2; i19++) {
                    this.f10327n[i17][i19] = new TextView(context);
                    this.f10327n[i17][i19].setTextSize(1, 14.0f);
                    this.f10327n[i17][i19].setTextColor(i6.v0(i6.f19237z6, e6Var));
                    TextView textView3 = this.f10327n[i17][i19];
                    if (LocaleController.isRTL) {
                        i16 = 3;
                    } else {
                        i16 = 5;
                    ...
                    this.f10329s.addView(this.f10327n[i17][i19], w7.x5.i(-1.0f, -1.0f, 119, 0.0f, 0.0f, 20.0f, 0.0f));
                }
                for (int i20 = 0; i20 < 2; i20++) {
                    this.f10325c[i20] = new TextView(context);
                    this.f10325c[i20].setTextSize(1, 14.0f);
                    this.f10325c[i20].setTextColor(i6.v0(i6.f19237z6, e6Var));
                    TextView textView4 = this.f10325c[i20];
                    if (LocaleController.isRTL) {
                        i15 = 3;
                    } else {
                        i15 = 5;
                    ...
                    this.f10329s.addView(this.f10325c[i20], w7.x5.i(-1.0f, -1.0f, 119, 0.0f, 0.0f, 20.0f, 0.0f));
                }
                ...
                imageView.setColorFilter(new PorterDuffColorFilter(i6.v0(i6.f19237z6, e6Var), PorterDuff.Mode.SRC_IN));
                this.f10329s.addView(imageView, w7.x5.h(20.0f, 20.0f, 8388629));
                this.v.addView(this.f10329s, new LinearLayout.LayoutParams(w7.x5.z(-1.0f), w7.x5.z(-1.0f), Gravity.getAbsoluteGravity(119, LocaleController.isRTL ? 1 : 0)));
                ...
                for (int i22 = 0; i22 < 2; i22++) {
                    this.f10327n[i17][i22] = new TextView(context);
                    this.f10327n[i17][i22].setTextSize(1, 14.0f);
                    this.f10327n[i17][i22].setTextColor(i6.v0(i6.f19237z6, e6Var));
                    TextView textView6 = this.f10327n[i17][i22];
                    if (LocaleController.isRTL) {
                        i11 = 3;
                    } else {
                        i11 = 5;
                    ...
                    frameLayout2.addView(this.f10327n[i17][i22], w7.x5.e(-1, -1, 119));
                }
                if (LocaleController.isRTL) {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        super.onDraw(canvas);
        if (this.E) {
            Paint T0 = i6.T0("paintDivider", this.f10323a);
            if (T0 == null) {
                T0 = i6.f18958k0;
            }
            Paint paint = T0;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (!this.F) {
            ...
            dq dqVar = this.f10328r;
            if (i12 <= 2 && dqVar.getVisibility() != 0) {
                dp = 0;
            } else {
                int dp3 = AndroidUtilities.dp(15.0f) + this.f10331x;
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (dqVar != null && dqVar.getVisibility() == 0) {
            ...
            ViewGroup[] viewGroupArr = this.f10326f;
            float x11 = x10 - viewGroupArr[0].getX();
            FrameLayout frameLayout = this.e;
            float x12 = x11 - frameLayout.getX();
            FrameLayout frameLayout2 = this.f10329s;
