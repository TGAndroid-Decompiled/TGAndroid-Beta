...
public final class z0 implements Utilities.Callback5, org.telegram.ui.ActionBar.b2 {
    ...
    public void mo17run(Object obj, Object obj2, Object obj3, Object obj4, Object obj5) {
        ...
        ((Float) obj5).getClass();
        int i10 = j51Var.d;
        if (i10 != 1 && j51Var.f25118c != e1Var.h) {
            if (i10 == 2) {
                AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(e1Var.getParentActivity());
                alertDialog$Builder.f18446a.R = LocaleController.getString(R.string.BusinessLocationClearTitle);
                alertDialog$Builder.f18446a.T = LocaleController.getString(R.string.BusinessLocationClearMessage);
                alertDialog$Builder.k(LocaleController.getString(R.string.Remove), new z0(e1Var, 3));
                alertDialog$Builder.h(LocaleController.getString(R.string.Cancel), null);
                e1Var.showDialog(alertDialog$Builder.f18446a);
            }
        } else if (e1Var.f10274x != null && j51Var.f25118c != e1Var.h) {
            e1Var.f10274x = null;
