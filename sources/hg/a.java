...
public final class a extends Drawable {
    ...
    public final TextPaint f8924a;

    public final TextPaint f8925b;

    public final RectF f8926c;
    ...
    public a(Context context) {
        ...
        this.f8924a = textPaint;
        TextPaint textPaint2 = new TextPaint(1);
        this.f8925b = textPaint2;
    ...
    public final void draw(Canvas canvas) {
        ...
        RectF rectF = this.f8926c;
        rectF.set(f10, f11, f12, f13);
        canvas.drawRoundRect(rectF, AndroidUtilities.dp(12.0f), AndroidUtilities.dp(12.0f), this.f8925b);
        ...
        if (str != null) {
            canvas.drawText(str, AndroidUtilities.dp(16.5f) + bounds.left, AndroidUtilities.dp(13.0f) + bounds.top, this.f8924a);
        }
    }
    ...
    public final int getIntrinsicWidth() {
        return (int) (AndroidUtilities.dp(23.0f) + this.f8927e);
    }
