    ...
    public final void onAnimationEnd(Animator animator) {
        ...
        switch (this.f11124a) {
            ...
            case 1:
                ...
                return;
            case 2:
                ((s4.c1) this.f11125b).f45739a.setAlpha(1.0f);
                ((AnimatorSet) this.f11126c).removeAllListeners();
                zs zsVar = (zs) this.f11127e;
                xs xsVar = (xs) this.d;
                zsVar.d(xsVar.f32656a);
                zsVar.f33226y.remove(xsVar.f32656a);
                zsVar.A();
                zsVar.d(xsVar.f32657b);
                zsVar.f33226y.remove(xsVar.f32657b);
                zsVar.A();
                return;
            case 3:
            ...
            case 4:
                ...
                TextView[] textViewArr = n2Var.f31670a;
                ...
                n2Var.f31674f = false;
                CharSequence charSequence = n2Var.f31673e;
                if (charSequence != null) {
                    if (charSequence.equals("timer")) {
                        n2Var.e(true);
                    } else {
                        textViewArr[1].setText(n2Var.f31673e);
            ...
            default:
                ...
                profileActivity.f33888e0.setProgressToExpand(0.0f);
                profileActivity.f33857a.setLayerType(0, null);
                ...
                if (profileActivity.J1 == 2) {
                    ...
                    profileActivity.f33888e0.setForegroundAlpha(1.0f);
                    profileActivity.Y.setVisibility(8);
                    profileActivity.f33949n0.setAlpha(1.0f);
                    profileActivity.f33949n0.L();
                    profileActivity.f33949n0.setVisibility(0);
                }
                profileActivity.W4 = null;
                profileActivity.Z.invalidate();
                profileActivity.f33908g5 = null;
    ...
    public void onAnimationStart(Animator animator) {
        switch (this.f11124a) {
            ...
            case 2:
                zs zsVar = (zs) this.f11127e;
                xs xsVar = (xs) this.d;
                s4.c1 c1Var = xsVar.f32656a;
                zsVar.getClass();
                s4.c1 c1Var2 = xsVar.f32657b;
                zsVar.getClass();
                return;
            default:
