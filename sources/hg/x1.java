...
public final class x1 extends ReplacementSpan {
    ...
    public final void draw(Canvas canvas, CharSequence charSequence, int i10, int i11, float f7, int i12, int i13, int i14, Paint paint) {
        ...
        switch (this.f10456a) {
            case 0:
                ...
                float f11 = dpf2 / 2.0f;
                rectF.set(f7, f10 - f11, ((int) (((t01) this.f10458c).f28363c + AndroidUtilities.dp(10.0f))) + f7, f11 + f10);
            ...
            case 1:
                ...
                rectF2.set(f7, f12 - AndroidUtilities.dp(7.66f), ((t01) this.f10458c).f28363c + f7 + AndroidUtilities.dp(6.66f), AndroidUtilities.dp(7.66f) + f12);
                ...
                ((t01) this.f10458c).c(f7 + AndroidUtilities.dp(3.33f), f12, 1.0f, -1, canvas);
                canvas.restore();
                return;
            default:
    ...
    public final int getSize(Paint paint, CharSequence charSequence, int i10, int i11, Paint.FontMetricsInt fontMetricsInt) {
        switch (this.f10456a) {
            case 0:
                return (int) (((t01) this.f10458c).f28363c + AndroidUtilities.dp(10.0f));
            case 1:
                return (int) (((t01) this.f10458c).f28363c + AndroidUtilities.dp(6.66f));
            default:
    ...
    public x1(int i10) {
        ...
        this.f10458c = new t01(LocaleController.formatPluralString("BusinessRepliesMore", i10, new Object[0]), 9.33f, AndroidUtilities.bold());
    }
