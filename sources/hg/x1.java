...
public final class x1 extends ReplacementSpan {
    ...
    public x1(View[] viewArr) {
        this.f10470a = 2;
        this.f10471b = new qr(0.33d, 0.0d, 0.67d, 1.0d);
        this.f10472c = viewArr;
    }
    ...
    public final void draw(Canvas canvas, CharSequence charSequence, int i10, int i11, float f7, int i12, int i13, int i14, Paint paint) {
        ...
        switch (this.f10470a) {
            case 0:
                ...
                float f11 = dpf2 / 2.0f;
                rectF.set(f7, f10 - f11, ((int) (((g01) this.f10472c).f24146c + AndroidUtilities.dp(10.0f))) + f7, f11 + f10);
                Paint paint2 = (Paint) this.f10471b;
                int i15 = i6.f19234z6;
                paint2.setColor(i6.l1(0.15f, i6.w0(null, i15, false)));
                canvas.drawRoundRect(rectF, AndroidUtilities.dp(4.0f), AndroidUtilities.dp(4.0f), paint2);
                ((g01) this.f10472c).c(f7 + AndroidUtilities.dp(5.0f), f10, Utilities.clamp((paint.getAlpha() * 2) / 255.0f, 1.0f, 0.0f), i6.w0(null, i15, false), canvas);
                return;
            case 1:
                float f12 = (i12 + i14) / 2.0f;
                RectF rectF2 = AndroidUtilities.rectTmp;
                rectF2.set(f7, f12 - AndroidUtilities.dp(7.66f), ((g01) this.f10472c).f24146c + f7 + AndroidUtilities.dp(6.66f), AndroidUtilities.dp(7.66f) + f12);
                canvas.saveLayerAlpha(rectF2, 255, 31);
                Paint paint3 = (Paint) this.f10471b;
                paint3.setColor(paint.getColor());
                canvas.drawRoundRect(rectF2, AndroidUtilities.dp(5.0f), AndroidUtilities.dp(5.0f), paint3);
                ((g01) this.f10472c).c(f7 + AndroidUtilities.dp(3.33f), f12, 1.0f, -1, canvas);
                canvas.restore();
                return;
            default:
                qr qrVar = (qr) this.f10471b;
                canvas.save();
                ...
                canvas.restore();
                for (View view : (View[]) this.f10472c) {
                    view.invalidate();
                }
                return;
        }
    ...
    public final int getSize(Paint paint, CharSequence charSequence, int i10, int i11, Paint.FontMetricsInt fontMetricsInt) {
        switch (this.f10470a) {
            case 0:
                return (int) (((g01) this.f10472c).f24146c + AndroidUtilities.dp(10.0f));
            case 1:
                return (int) (((g01) this.f10472c).f24146c + AndroidUtilities.dp(6.66f));
            default:
    ...
    public x1(int i10) {
        this.f10470a = 0;
        this.f10471b = new Paint(1);
        this.f10472c = new g01(LocaleController.formatPluralString("BusinessRepliesMore", i10, new Object[0]), 9.33f, AndroidUtilities.bold());
    }
