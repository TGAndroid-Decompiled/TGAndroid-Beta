...
public final class r0 implements Runnable {
    ...
    public final void run() {
        ...
        boolean z10 = this.d;
        TLObject tLObject = this.f10402n;
        Object obj = this.e;
        Object obj2 = this.h;
        Object obj3 = this.f10400c;
        Object obj4 = this.f10399b;
        Object obj5 = this.f10401f;
        switch (i11) {
            case 0:
                u0.U((u0) obj5, (TLRPC.TL_error) obj4, (TLObject) obj3, (int[]) obj2, (ArrayList) obj, this.d, (TLRPC.User) tLObject);
                return;
            case 1:
                ((SendMessagesHelper) obj5).lambda$performSendMessageRequestMulti$73((TLRPC.TL_error) obj4, (TLObject) obj3, this.d, (ArrayList) obj, (ArrayList) obj2, this.f10402n);
                return;
            case 2:
            ...
            default:
                ...
                int i12 = nVar.f45413k;
                ArrayList arrayList3 = nVar.e;
                n2 n2Var2 = nVar.f45410g;
                if (n2Var2 != null && n2Var2.getParentActivity() != null) {
                    if (tL_error == null) {
                        ...
                        if (!tL_updates.chats.isEmpty()) {
                            MessagesController.getInstance(i12).loadFullChat(tL_updates.chats.get(0).f18328id, 0, true);
                        }
                        int i13 = 0;
                        while (true) {
                        ...
                        wh.g gVar = nVar.f45409f;
                        wh.n nVar2 = gVar.f45385c;
                        int i14 = 0;
                        while (true) {
                            arrayList = nVar2.f45408c;
                        ...
                        if (i14 >= 0) {
                            ...
                            gVar.u((!gVar.f45385c.B ? 1 : 0) + i14);
                            if (arrayList.isEmpty()) {
                                gVar.u(1);
                            }
                        }
                        nVar.f(nVar.f45422t, false, true);
                        if (z10) {
                            ...
                            bcVar.f22955b.setText(spannableStringBuilder);
                        ...
                        if (TextUtils.isEmpty(nVar.f45422t) && nVar.f45414l) {
                    ...
                    d5.f0(i12, tL_error, n2Var2, tL_messages_hideChatJoinRequest, new Object[0]);
                    return;
                }
                return;
        }
    ...
    public r0(File file, ArrayList arrayList, n2 n2Var, zn znVar, TLRPC.Document document, boolean z10, TLRPC.TL_messages_stickerSet tL_messages_stickerSet) {
        ...
        this.h = document;
        this.d = z10;
        this.f10402n = tL_messages_stickerSet;
    }
    ...
    public r0(SendMessagesHelper sendMessagesHelper, TLRPC.TL_error tL_error, TLObject tLObject, boolean z10, ArrayList arrayList, ArrayList arrayList2, TLObject tLObject2) {
        this.f10401f = sendMessagesHelper;
        this.f10399b = tL_error;
        this.f10400c = tLObject;
        this.d = z10;
        this.e = arrayList;
        this.h = arrayList2;
        this.f10402n = tLObject2;
    }
    ...
    public r0(ih1 ih1Var, TLRPC.TL_error tL_error, boolean z10, TLObject tLObject, byte[] bArr, String str, TL_account.passwordInputSettings passwordinputsettings) {
        ...
        this.h = bArr;
        this.e = str;
        this.f10402n = passwordinputsettings;
    }
