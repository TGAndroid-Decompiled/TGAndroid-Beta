    ...
    public void g(org.telegram.ui.ActionBar.b2 b2Var, int i10) {
        ...
        switch (this.f11035a) {
            ...
            case 5:
                ...
                coVar.getMessagesController().pinMessage(coVar.f35265e, coVar.f35277f, this.f11036b, false, !zArr[1], zArr[0]);
                qc B = yc.B(coVar, true, null, null, coVar.f35275ea);
                B.j();
                ub ubVar = B.f29703e;
            ...
            case 10:
                ...
                m50 m50Var = ((i50) this.f11037c).f37271n;
                ChatObject.Call call = m50Var.f38602b.f37541a1;
                String obj3 = editTextBoldCursor2.getText().toString();
                int i12 = this.f11036b;
                call.toggleRecord(obj3, i12);
                AndroidUtilities.hideKeyboard(editTextBoldCursor2);
                UndoView k12 = m50Var.f38602b.k1();
                if (i12 == 0) {
                    i11 = 39;
                } else {
                    i11 = 100;
