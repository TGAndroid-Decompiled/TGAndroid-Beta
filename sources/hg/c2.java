    ...
    public void g(org.telegram.ui.ActionBar.b2 b2Var, int i10) {
        ...
        switch (this.f11009a) {
            ...
            case 5:
                ...
                coVar.getMessagesController().pinMessage(coVar.f35238e, coVar.f35250f, this.f11010b, false, !zArr[1], zArr[0]);
                qc B = yc.B(coVar, true, null, null, coVar.f35248ea);
                B.j();
                ub ubVar = B.f29676e;
            ...
            case 10:
                ...
                m50 m50Var = ((i50) this.f11011c).f37244n;
                ChatObject.Call call = m50Var.f38575b.f37514a1;
                String obj3 = editTextBoldCursor2.getText().toString();
                int i12 = this.f11010b;
                call.toggleRecord(obj3, i12);
                AndroidUtilities.hideKeyboard(editTextBoldCursor2);
                UndoView k12 = m50Var.f38575b.k1();
                if (i12 == 0) {
                    i11 = 39;
                } else {
                    i11 = 100;
