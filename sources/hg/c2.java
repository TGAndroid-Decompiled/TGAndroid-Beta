...
public final class c2 {
    public static volatile c2[] f10237g = new c2[4];
    ...
    public final void a(String str) {
        ...
        while (true) {
            if (i10 < size) {
                ...
                i10++;
                b2Var = (b2) obj;
                if (TextUtils.equals(str, b2Var.f10220b)) {
                    break;
                }
            } else {
                b2Var = null;
        ...
        if (b2Var != null) {
            ...
            NotificationCenter.getInstance(this.f10238a).lambda$postNotificationNameOnUIThread$1(NotificationCenter.quickRepliesUpdated, new Object[0]);
        }
    }
    ...
    public final b2 c(long j3) {
        ArrayList arrayList = this.f10239b;
        int size = arrayList.size();
        int i10 = 0;
        while (i10 < size) {
            Object obj = arrayList.get(i10);
    ...
    public final ArrayList e() {
        ...
        int i10 = 0;
        while (true) {
            ArrayList arrayList2 = this.f10239b;
            if (i10 < arrayList2.size()) {
                if (!g(((b2) arrayList2.get(i10)).f10220b)) {
                ...
                public final void run() {
                    ...
                    switch (r3) {
                        case 0:
                            ...
                            c2 c2Var = this.f10212b;
                            ArrayList arrayList2 = c2Var.f10239b;
                            ...
                            for (int i12 = 0; i12 < arrayList.size(); i12++) {
                                ...
                                while (true) {
                                    if (i13 < arrayList3.size()) {
                                        if (((b2) arrayList3.get(i13)).f10219a == tL_quickReply.shortcut_id) {
                                ...
                                b2Var.f10219a = tL_quickReply.shortcut_id;
                                b2Var.f10220b = tL_quickReply.shortcut;
                                b2Var.f10222f = tL_quickReply.count;
                                b2Var.f10221c = i12;
                                ...
                                c2Var.a(b2Var.f10220b);
                            }
                            c2Var.l();
                            NotificationCenter.getInstance(c2Var.f10238a).lambda$postNotificationNameOnUIThread$1(NotificationCenter.quickRepliesUpdated, new Object[0]);
                            return;
                        case 1:
                            c2 c2Var2 = this.f10212b;
                            ArrayList arrayList4 = c2Var2.f10239b;
                            int i14 = c2Var2.f10238a;
                            ...
                            if (c10 != null) {
                                c10.f10220b = tL_quickReply2.shortcut;
                                c10.f10222f = tL_quickReply2.count;
                                ...
                                b2 b2Var2 = new b2();
                                b2Var2.f10219a = tL_quickReply2.shortcut_id;
                                b2Var2.f10220b = tL_quickReply2.shortcut;
                                b2Var2.f10222f = tL_quickReply2.count;
                                b2Var2.d = tL_quickReply2.top_message;
                                for (int i15 = 0; i15 < arrayList4.size(); i15++) {
                                    ((b2) arrayList4.get(i15)).f10221c = i15;
                                }
                                arrayList4.add(b2Var2);
                                c2Var2.a(b2Var2.f10220b);
                            }
                            c2Var2.l();
                            ...
                            return;
                        case 2:
                            c2 c2Var3 = this.f10212b;
                            int i16 = c2Var3.f10238a;
                            b2 c11 = c2Var3.c(((TL_update.TL_updateDeleteQuickReply) update).shortcut_id);
                            if (c11 != null) {
                                c2Var3.f10239b.remove(c11);
                                c2Var3.a(c11.f10220b);
                                int i17 = c11.f10219a;
                            ...
                            return;
                        default:
                            c2 c2Var4 = this.f10212b;
                            int i18 = c2Var4.f10238a;
                            ...
                            if (c12 != null) {
                                int size = c12.f10222f - tL_updateDeleteQuickReplyMessages.messages.size();
                                c12.f10222f = size;
                                if (size <= 0) {
                                    c2Var4.f10239b.remove(c12);
                                }
    ...
    public final void l() {
        MessagesStorage messagesStorage = MessagesStorage.getInstance(this.f10238a);
