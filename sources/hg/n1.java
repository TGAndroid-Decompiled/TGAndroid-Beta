...
public final class n1 extends FrameLayout {
    ...
    public n1(Context context, f6 f6Var) {
        ...
        this.f11210b = k9Var;
        k9Var.f27793l = true;
        k9Var.f27797p = AndroidUtilities.dp(75.0f);
        k9Var.f27796o = AndroidUtilities.dp(48.0f);
        k9Var.f27804x = true;
        k9Var.f27800s = AndroidUtilities.dp(22.0f);
        for (int i11 = 0; i11 < 2; i11++) {
            ...
            this.d[i11].setTextColor(j6.v0(j6.f21089z6, f6Var));
