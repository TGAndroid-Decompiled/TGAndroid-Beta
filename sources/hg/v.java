...
public final class v extends a61 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static void b0(Activity activity, int i10, TL_account.TL_businessChatLink tL_businessChatLink, f6 f6Var) {
        ...
        sVar.setLineColors(j6.v0(j6.f18991k6, f6Var), j6.v0(j6.f19009l6, f6Var), j6.v0(j6.f19083p7, f6Var));
        ...
        c2Var.f18491a = AndroidUtilities.dp(292.0f);
    ...
    public final boolean X(j51 j51Var, View view) {
        if (j51Var.f15543a == 29) {
            ...
            if (obj instanceof u) {
                    ...
                    public final void run() {
                        switch (r3) {
                            ...
                            default:
                                ...
                                alertDialog$Builder.f18447a.R = LocaleController.getString(R.string.BusinessLinksDeleteTitle);
                                alertDialog$Builder.f18447a.T = LocaleController.getString(R.string.BusinessLinksDeleteMessage);
                                ...
                                if (textView != null) {
                                    textView.setTextColor(vVar2.getThemedColor(j6.f19101q7));
                                    return;
                                }
                                return;
                        }
                ...
                H.W(this.f22336a.W0(view, false));
                H.Z();
                return true;
            }
        }
