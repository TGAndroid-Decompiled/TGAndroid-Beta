...
public final class v extends o61 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static void b0(Activity activity, int i10, TL_account.TL_businessChatLink tL_businessChatLink, e6 e6Var) {
        ...
        sVar.setLineColors(j6.v0(j6.f19190k6, e6Var), j6.v0(j6.f19208l6, e6Var), j6.v0(j6.f19283p7, e6Var));
    ...
    public final void W(x51 x51Var, View view) {
        ...
        } else if (x51Var.f15672a == 29) {
            Object obj = x51Var.G;
            if (obj instanceof u) {
                Bundle f7 = org.telegram.ui.Cells.c1.f(6, "chatMode");
                f7.putString("business_link", ((u) obj).f10417a.link);
    ...
    public final boolean X(x51 x51Var, View view) {
        if (x51Var.f15672a == 29) {
            ...
            if (obj instanceof u) {
                    ...
                    public final void run() {
                        switch (r3) {
                            ...
                            default:
                                ...
                                alertDialog$Builder.f18622a.R = LocaleController.getString(R.string.BusinessLinksDeleteTitle);
                                alertDialog$Builder.f18622a.T = LocaleController.getString(R.string.BusinessLinksDeleteMessage);
                                ...
                                if (textView != null) {
                                    textView.setTextColor(vVar2.getThemedColor(j6.f19301q7));
                                    return;
                                }
                                return;
                        }
                ...
                H.W(this.f26891a.W0(view, false));
                H.Z();
                return true;
            }
        }
