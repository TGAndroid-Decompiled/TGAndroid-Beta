    ...
    public final void run() {
        switch (this.f10369a) {
            ...
            case 2:
                ...
                return;
            case 3:
                u0 u0Var4 = this.f10370b;
                u0Var4.f10435c.Y2.N(true);
                u0Var4.Y(true);
                return;
            default:
                u0 u0Var5 = this.f10370b;
                String obj = u0Var5.f10436f.getText().toString();
                String str = u0Var5.f10442y;
                if (str == null || !TextUtils.equals(str, obj)) {
                    u0Var5.f10441x = false;
