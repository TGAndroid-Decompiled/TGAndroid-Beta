    ...
    public final void run() {
        switch (this.f10363a) {
            ...
            case 2:
                ...
                return;
            case 3:
                u0 u0Var4 = this.f10364b;
                u0Var4.f10429c.Y2.N(true);
                u0Var4.Y(true);
                return;
            default:
                u0 u0Var5 = this.f10364b;
                String obj = u0Var5.f10430f.getText().toString();
                String str = u0Var5.f10436y;
                if (str == null || !TextUtils.equals(str, obj)) {
                    u0Var5.f10435x = false;
