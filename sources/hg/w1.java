...
public final class w1 extends ReplacementSpan {
    ...
    public w1(View[] viewArr) {
        this.f10468a = 2;
        this.f10469b = new qr(0.33d, 0.0d, 0.67d, 1.0d);
        this.f10470c = viewArr;
    }
    ...
    public final void draw(Canvas canvas, CharSequence charSequence, int i10, int i11, float f7, int i12, int i13, int i14, Paint paint) {
        ...
        switch (this.f10468a) {
            case 0:
                ...
                float f11 = dpf2 / 2.0f;
                rectF.set(f7, f10 - f11, ((int) (((u01) this.f10470c).f28493c + AndroidUtilities.dp(10.0f))) + f7, f11 + f10);
                Paint paint2 = (Paint) this.f10469b;
                int i15 = j6.f19496z6;
                paint2.setColor(j6.l1(0.15f, j6.w0(null, i15, false)));
                canvas.drawRoundRect(rectF, AndroidUtilities.dp(4.0f), AndroidUtilities.dp(4.0f), paint2);
                ((u01) this.f10470c).c(f7 + AndroidUtilities.dp(5.0f), f10, Utilities.clamp((paint.getAlpha() * 2) / 255.0f, 1.0f, 0.0f), j6.w0(null, i15, false), canvas);
                return;
            case 1:
                float f12 = (i12 + i14) / 2.0f;
                RectF rectF2 = AndroidUtilities.rectTmp;
                rectF2.set(f7, f12 - AndroidUtilities.dp(7.66f), ((u01) this.f10470c).f28493c + f7 + AndroidUtilities.dp(6.66f), AndroidUtilities.dp(7.66f) + f12);
                canvas.saveLayerAlpha(rectF2, 255, 31);
                Paint paint3 = (Paint) this.f10469b;
                paint3.setColor(paint.getColor());
                canvas.drawRoundRect(rectF2, AndroidUtilities.dp(5.0f), AndroidUtilities.dp(5.0f), paint3);
                ((u01) this.f10470c).c(f7 + AndroidUtilities.dp(3.33f), f12, 1.0f, -1, canvas);
                canvas.restore();
                return;
            default:
                qr qrVar = (qr) this.f10469b;
                canvas.save();
                ...
                canvas.restore();
                for (View view : (View[]) this.f10470c) {
                    view.invalidate();
                }
                return;
        }
    ...
    public final int getSize(Paint paint, CharSequence charSequence, int i10, int i11, Paint.FontMetricsInt fontMetricsInt) {
        switch (this.f10468a) {
            case 0:
                return (int) (((u01) this.f10470c).f28493c + AndroidUtilities.dp(10.0f));
            case 1:
                return (int) (((u01) this.f10470c).f28493c + AndroidUtilities.dp(6.66f));
            default:
    ...
    public w1(int i10) {
        this.f10468a = 0;
        this.f10469b = new Paint(1);
        this.f10470c = new u01(LocaleController.formatPluralString("BusinessRepliesMore", i10, new Object[0]), 9.33f, AndroidUtilities.bold());
    }
