...
public final class w1 extends ReplacementSpan {
    ...
    public final void draw(Canvas canvas, CharSequence charSequence, int i10, int i11, float f7, int i12, int i13, int i14, Paint paint) {
        ...
        switch (this.f10467a) {
            case 0:
                ...
                float f11 = dpf2 / 2.0f;
                rectF.set(f7, f10 - f11, ((int) (((h01) this.f10469c).f24439c + AndroidUtilities.dp(10.0f))) + f7, f11 + f10);
                Paint paint2 = (Paint) this.f10468b;
                int i15 = j6.f19263z6;
                paint2.setColor(j6.l1(0.15f, j6.w0(null, i15, false)));
                canvas.drawRoundRect(rectF, AndroidUtilities.dp(4.0f), AndroidUtilities.dp(4.0f), paint2);
                ((h01) this.f10469c).c(f7 + AndroidUtilities.dp(5.0f), f10, Utilities.clamp((paint.getAlpha() * 2) / 255.0f, 1.0f, 0.0f), j6.w0(null, i15, false), canvas);
                return;
            case 1:
                float f12 = (i12 + i14) / 2.0f;
                RectF rectF2 = AndroidUtilities.rectTmp;
                rectF2.set(f7, f12 - AndroidUtilities.dp(7.66f), ((h01) this.f10469c).f24439c + f7 + AndroidUtilities.dp(6.66f), AndroidUtilities.dp(7.66f) + f12);
                ...
                ((h01) this.f10469c).c(f7 + AndroidUtilities.dp(3.33f), f12, 1.0f, -1, canvas);
                canvas.restore();
                return;
            default:
    ...
    public final int getSize(Paint paint, CharSequence charSequence, int i10, int i11, Paint.FontMetricsInt fontMetricsInt) {
        switch (this.f10467a) {
            case 0:
                return (int) (((h01) this.f10469c).f24439c + AndroidUtilities.dp(10.0f));
            case 1:
                return (int) (((h01) this.f10469c).f24439c + AndroidUtilities.dp(6.66f));
            default:
    ...
    public w1(int i10) {
        ...
        this.f10469c = new h01(LocaleController.formatPluralString("BusinessRepliesMore", i10, new Object[0]), 9.33f, AndroidUtilities.bold());
    }
