...
public final class f1 extends n2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public e61 f10271a;
    public pr f10272b;
    public org.telegram.ui.ActionBar.v0 f10273c;
    public boolean d;
    ...
    public final void U(boolean z10) {
        ...
        if (this.f10273c != null) {
            ...
            if (z10) {
                ...
                org.telegram.ui.ActionBar.v0 v0Var = this.f10273c;
                if (V) {
                    f7 = 1.0f;
                } else {
                    f7 = 0.0f;
                ...
                v0Var.setAlpha(f7);
                org.telegram.ui.ActionBar.v0 v0Var2 = this.f10273c;
                if (V) {
                    f10 = 1.0f;
                } else {
                    f10 = 0.0f;
                ...
                org.telegram.ui.ActionBar.v0 v0Var3 = this.f10273c;
                if (V) {
                    f13 = 1.0f;
                }
                v0Var3.setScaleY(f13);
            }
            e61 e61Var = this.f10271a;
    ...
    public final void Y() {
        ...
        if (e1Var != null && (z5Var = this.f10277s) != null) {
            if (this.f10279x != null) {
                e1Var.setAlpha(0.0f);
                ...
                z5 z5Var2 = this.f10277s;
                TLRPC.GeoPoint geoPoint = this.f10279x;
                z5Var2.n(ImageLocation.getForWebFile(WebFile.createWithGeoPoint(geoPoint.lat, geoPoint._long, 0L, min * i10, min * 240, 15, min)), a4.a.n(i10, "_240"), this.f10276r, null);
                return;
            }
    ...
    public final View createView(Context context) {
        ...
        this.f10272b = new pr(mutate, new tp(i6.w0(null, i10, false)));
        ...
        this.f10274f.setHintTextColor(i6.w0(null, i6.H6, false));
        c1 c1Var2 = this.f10274f;
        int i11 = i6.G6;
        c1Var2.setTextColor(i6.w0(null, i11, false));
        ...
        this.f10274f.setCursorColor(i6.w0(null, i11, false));
        ...
        this.e = frameLayout2;
        frameLayout2.addView(this.f10274f, x5.d(-1, -1.0f, 48, 21.0f, 15.0f, 21.0f, 15.0f));
        ...
        this.f10277s = new z5(this, context, 1);
        ...
        this.f10276r = eqVar;
        eqVar.setCallback(this.f10277s);
        this.f10277s.setBackgroundColor(getThemedColor(i13));
        this.f10275n = new e1(this, context);
        FrameLayout frameLayout4 = new FrameLayout(context);
        this.h = frameLayout4;
        frameLayout4.addView(this.f10277s, x5.c(-1.0f, -1));
        this.h.addView(this.f10275n, x5.d(-2, -2.0f, 17, 0.0f, -31.0f, 0.0f, 0.0f));
        Y();
        e61 e61Var = new e61(this, new bi.v(this, 26), new a1(this, 0), null);
        this.f10271a = e61Var;
        e61Var.p1();
        e61 e61Var2 = this.f10271a;
    ...
    public final boolean onBackPressed(boolean z10) {
        ...
        if (V() && !z11) {
            if (z10) {
                ...
                alertDialog$Builder.f18435a.T = LocaleController.getString(R.string.BusinessLocationUnsavedChanges);
