...
public final class h extends b3 {
    ...
    public h(m mVar, Context context) {
        super(context);
        this.f11087f = mVar;
        this.f21665a = UserConfig.selectedAccount;
        setOrientation(1);
        setBackgroundColor(j6.w0(null, j6.f20635a7, false));
        ...
        x9Var.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view) {
                switch (r2) {
                    case 0:
                        this.f21629b.f21666b.getImageReceiver().startAnimation();
                        return;
                    default:
                        this.f21629b.f11087f.K();
                        return;
                }
            }
        });
        ...
        textView2.setTextColor(j6.w0(null, j6.f21070y6, false));
        x5Var.addView(textView2, w7.x5.t(-1, -2, 49, 0, 7, 0, 0));
        TextView textView3 = new TextView(context);
        this.f21668e = textView3;
