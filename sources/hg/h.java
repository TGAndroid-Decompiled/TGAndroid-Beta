...
public final class h extends b3 {
    ...
    public h(m mVar, Context context) {
        super(context);
        this.f11061f = mVar;
        this.f21638a = UserConfig.selectedAccount;
        setOrientation(1);
        setBackgroundColor(j6.w0(null, j6.f20608a7, false));
        x5 x5Var = new x5(context, 3);
        x5Var.f8387c = new Path();
        Paint paint = new Paint(1);
        x5Var.f8386b = paint;
        paint.setColor(j6.w0(null, j6.f20664d6, false));
        ...
        x9Var.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view) {
                switch (r2) {
                    case 0:
                        this.f21602b.f21639b.getImageReceiver().startAnimation();
                        return;
                    default:
                        this.f21602b.f11061f.K();
                        return;
                }
            }
        });
        ...
        textView2.setTextColor(j6.w0(null, j6.f21043y6, false));
        x5Var.addView(textView2, w7.x5.t(-1, -2, 49, 0, 7, 0, 0));
        TextView textView3 = new TextView(context);
        this.f21641e = textView3;
