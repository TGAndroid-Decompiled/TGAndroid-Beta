...
public final class w {
    public TL_account.TL_businessChatLink f10452a;

    public final boolean equals(Object obj) {
        TL_account.TL_businessChatLink tL_businessChatLink = this.f10452a;
        if (this == obj) {
            return true;
        }
        if (obj != null && w.class == obj.getClass()) {
            TL_account.TL_businessChatLink tL_businessChatLink2 = ((w) obj).f10452a;
