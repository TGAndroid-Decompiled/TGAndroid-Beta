...
public final class b2 {
    public static volatile b2[] f10234g = new b2[4];
    ...
    public final void a(String str) {
        ...
        while (true) {
            if (i10 < size) {
                ...
                i10++;
                a2Var = (a2) obj;
                if (TextUtils.equals(str, a2Var.f10224b)) {
                    break;
                }
            } else {
                a2Var = null;
        ...
        if (a2Var != null) {
            ...
            NotificationCenter.getInstance(this.f10235a).lambda$postNotificationNameOnUIThread$1(NotificationCenter.quickRepliesUpdated, new Object[0]);
        }
    }
    ...
    public final ArrayList e() {
        ...
        int i10 = 0;
        while (true) {
            ArrayList arrayList2 = this.f10236b;
            if (i10 < arrayList2.size()) {
                if (!g(((a2) arrayList2.get(i10)).f10224b)) {
                ...
                public final void run() {
                    ...
                    switch (r3) {
                        case 0:
                            ...
                            b2 b2Var = this.f10496b;
                            ArrayList arrayList2 = b2Var.f10236b;
                            ...
                            for (int i12 = 0; i12 < arrayList.size(); i12++) {
                                ...
                                while (true) {
                                    if (i13 < arrayList3.size()) {
                                        if (((a2) arrayList3.get(i13)).f10223a == tL_quickReply.shortcut_id) {
                                ...
                                a2Var.f10223a = tL_quickReply.shortcut_id;
                                a2Var.f10224b = tL_quickReply.shortcut;
                                a2Var.f10226f = tL_quickReply.count;
                                a2Var.f10225c = i12;
                                ...
                                b2Var.a(a2Var.f10224b);
                            }
                            b2Var.l();
                            NotificationCenter.getInstance(b2Var.f10235a).lambda$postNotificationNameOnUIThread$1(NotificationCenter.quickRepliesUpdated, new Object[0]);
                            return;
                        case 1:
                            b2 b2Var2 = this.f10496b;
                            ArrayList arrayList4 = b2Var2.f10236b;
                            int i14 = b2Var2.f10235a;
                            ...
                            if (c10 != null) {
                                c10.f10224b = tL_quickReply2.shortcut;
                                c10.f10226f = tL_quickReply2.count;
                                ...
                                a2 a2Var2 = new a2();
                                a2Var2.f10223a = tL_quickReply2.shortcut_id;
                                a2Var2.f10224b = tL_quickReply2.shortcut;
                                a2Var2.f10226f = tL_quickReply2.count;
                                a2Var2.d = tL_quickReply2.top_message;
                                for (int i15 = 0; i15 < arrayList4.size(); i15++) {
                                    ((a2) arrayList4.get(i15)).f10225c = i15;
                                }
                                arrayList4.add(a2Var2);
                                b2Var2.a(a2Var2.f10224b);
                            }
                            b2Var2.l();
                            ...
                            return;
                        case 2:
                            b2 b2Var3 = this.f10496b;
                            int i16 = b2Var3.f10235a;
                            a2 c11 = b2Var3.c(((TL_update.TL_updateDeleteQuickReply) update).shortcut_id);
                            if (c11 != null) {
                                b2Var3.f10236b.remove(c11);
                                b2Var3.a(c11.f10224b);
                                int i17 = c11.f10223a;
                            ...
                            return;
                        default:
                            b2 b2Var4 = this.f10496b;
                            int i18 = b2Var4.f10235a;
                            ...
                            if (c12 != null) {
                                int size = c12.f10226f - tL_updateDeleteQuickReplyMessages.messages.size();
                                c12.f10226f = size;
                                if (size <= 0) {
                                    b2Var4.f10236b.remove(c12);
                                }
    ...
    public final void l() {
        MessagesStorage messagesStorage = MessagesStorage.getInstance(this.f10235a);
