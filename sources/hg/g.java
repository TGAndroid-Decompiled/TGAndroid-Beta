...
public final class g extends s4.o {
    ...
    public final boolean a(int i10, int i11) {
        switch (this.f11053b) {
            case 0:
                if (((k) ((m) this.d).N.get(i10)).f44072a == ((k) this.f11054c.get(i11)).f44072a) {
                    return true;
                }
                return false;
            case 1:
    ...
    public final boolean b(int i10, int i11) {
        ...
        switch (this.f11053b) {
            case 0:
                ...
                int i12 = kVar.f44072a;
                int i13 = kVar2.f44072a;
                ...
                return true;
            case 1:
                return ((Integer) this.f11054c.get(i10)).equals(((tx) this.d).f30728n.get(i11));
            case 2:
                return Objects.equals(this.f11054c.get(i10), ((hl0) this.d).f26752n.get(i11));
            case 3:
                return ((Long) this.f11054c.get(i10)).equals(((j71) this.d).f37676v0.get(i11));
            default:
                pg.a aVar = (pg.a) this.f11054c.get(i10);
                pg.a aVar2 = (pg.a) ((ArrayList) this.d).get(i11);
                if (aVar.f44072a != aVar2.f44072a) {
    ...
    public final int d() {
        switch (this.f11053b) {
            ...
            case 1:
                return ((tx) this.d).f30728n.size();
            case 2:
                return ((hl0) this.d).f26752n.size();
            case 3:
                return ((j71) this.d).f37676v0.size();
            default:
