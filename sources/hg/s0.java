...
public final class s0 implements Runnable {
    ...
    public final void run() {
        ...
        boolean z10 = this.d;
        TLObject tLObject = this.f10405n;
        Object obj = this.e;
        Object obj2 = this.h;
        Object obj3 = this.f10403c;
        Object obj4 = this.f10402b;
        Object obj5 = this.f10404f;
        switch (i11) {
            case 0:
                v0.U((v0) obj5, (TLRPC.TL_error) obj4, (TLObject) obj3, (int[]) obj2, (ArrayList) obj, this.d, (TLRPC.User) tLObject);
                return;
            case 1:
                ((SendMessagesHelper) obj5).lambda$performSendMessageRequestMulti$73((TLRPC.TL_error) obj4, (TLObject) obj3, this.d, (ArrayList) obj, (ArrayList) obj2, this.f10405n);
                return;
            case 2:
            ...
            default:
                ...
                int i12 = nVar.f45114k;
                ArrayList arrayList3 = nVar.e;
                n2 n2Var2 = nVar.f45111g;
                if (n2Var2 != null && n2Var2.getParentActivity() != null) {
                    if (tL_error == null) {
                        ...
                        if (!tL_updates.chats.isEmpty()) {
                            MessagesController.getInstance(i12).loadFullChat(tL_updates.chats.get(0).f18109id, 0, true);
                        }
                        int i13 = 0;
                        while (true) {
                        ...
                        wh.g gVar = nVar.f45110f;
                        wh.n nVar2 = gVar.f45086c;
                        int i14 = 0;
                        while (true) {
                            arrayList = nVar2.f45109c;
                        ...
                        if (i14 >= 0) {
                            ...
                            gVar.u((!gVar.f45086c.B ? 1 : 0) + i14);
                            if (arrayList.isEmpty()) {
                                gVar.u(1);
                            }
                        }
                        nVar.f(nVar.f45123t, false, true);
                        if (z10) {
                            ...
                            acVar.f22349b.setText(spannableStringBuilder);
                        ...
                        if (TextUtils.isEmpty(nVar.f45123t) && nVar.f45115l) {
    ...
    public s0(File file, ArrayList arrayList, n2 n2Var, bo boVar, TLRPC.Document document, boolean z10, TLRPC.TL_messages_stickerSet tL_messages_stickerSet) {
        this.f10404f = file;
        this.e = arrayList;
        this.f10402b = n2Var;
        this.f10403c = boVar;
        this.h = document;
        this.d = z10;
        this.f10405n = tL_messages_stickerSet;
    }
    ...
    public s0(SendMessagesHelper sendMessagesHelper, TLRPC.TL_error tL_error, TLObject tLObject, boolean z10, ArrayList arrayList, ArrayList arrayList2, TLObject tLObject2) {
        this.f10404f = sendMessagesHelper;
        this.f10402b = tL_error;
        this.f10403c = tLObject;
        this.d = z10;
        this.e = arrayList;
        this.h = arrayList2;
        this.f10405n = tLObject2;
    }

    public s0(hh1 hh1Var, TLRPC.TL_error tL_error, boolean z10, TLObject tLObject, byte[] bArr, String str, TL_account.passwordInputSettings passwordinputsettings) {
        this.f10404f = hh1Var;
        this.f10402b = tL_error;
        this.d = z10;
        this.f10403c = tLObject;
        this.h = bArr;
        this.e = str;
        this.f10405n = passwordinputsettings;
    }
