...
public final class s0 implements Runnable {
    ...
    public final void run() {
        ...
        switch (i10) {
            case 0:
                ...
                int i11 = b1Var.f7408g0;
                int i12 = jg.w.f10076s;
                if (i11 == 1) {
                    z4 = true;
                } else {
                    z4 = false;
                }
                b1Var.f7414n0.b(true);
                ArrayList arrayList = b1Var.Z;
                ArrayList arrayList2 = b1Var.f7403b0;
                TLRPC.Chat chat = b1Var.Y;
                boolean z10 = b1Var.f7421u0;
                boolean z11 = b1Var.f7420t0;
                int i13 = prepaidGiveaway.quantity;
                String str = b1Var.f7419s0;
                ArrayList arrayList3 = arrayList;
                x0 x0Var = new x0(b1Var, tL_prepaidStarsGiveaway, this.f7598b, this.f7599c, prepaidGiveaway);
                ...
                return;
            case 1:
                ((FileLoadOperation) obj3).lambda$getDownloadedLengthFromOffset$4((long[]) obj2, this.f7598b, this.f7599c, (CountDownLatch) obj);
                return;
            case 2:
                long j10 = this.f7599c;
                ((GiftAuctionController) obj3).lambda$sendBid$6((Utilities.Callback2) obj2, this.f7598b, (lh.r) obj, j10);
                return;
            case 3:
                ((MediaController) obj3).lambda$trimCurrentRecording$26((File) obj2, this.f7598b, this.f7599c, (Runnable) obj);
                return;
            case 4:
                ((MessagesStorage) obj3).lambda$getMessage$142(this.f7598b, this.f7599c, (AtomicReference) obj2, (CountDownLatch) obj);
                return;
            case 5:
                ((MessagesStorage) obj3).lambda$updateDialogsWithDeletedMessages$228(this.f7598b, this.f7599c, (ArrayList) obj2, (ArrayList) obj);
                return;
            case 6:
                ((TopicsController) obj3).lambda$getTopicRepliesCount$29((TLObject) obj2, (TLRPC.TL_forumTopic) obj, this.f7598b, this.f7599c);
                return;
            case 7:
                ((TopicsController) obj3).lambda$loadTopic$27(this.f7598b, (ArrayList) obj2, this.f7599c, (Runnable) obj);
                return;
            default:
                ((q70) obj3).u();
    ...
    public s0(Object obj, TLObject tLObject, TLObject tLObject2, long j10, long j11, int i10) {
        this.f7597a = i10;
        this.d = obj;
        this.f7600e = tLObject;
        this.f7601f = tLObject2;
        this.f7598b = j10;
        this.f7599c = j11;
    }

    public s0(GiftAuctionController giftAuctionController, Utilities.Callback2 callback2, long j10, lh.r rVar, long j11) {
        this.f7597a = 2;
        this.d = giftAuctionController;
        this.f7600e = callback2;
        this.f7598b = j10;
        this.f7601f = rVar;
        this.f7599c = j11;
    }
