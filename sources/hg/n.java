    ...
    public final void run() {
        switch (this.f11179a) {
                ...
                try {
                        ...
                        if (isEncryptedDialog) {
                            if (i11 == 0 || i11 == 3) {
                                ...
                                if (!arrayList3.contains(Integer.valueOf(encryptedChatId))) {
                                    ...
                                    ?? obj = new Object();
                                    obj.f11064c = longValue;
                                    obj.f11063b = queryFinalized.intValue(1);
                                    arrayList4.add(obj);
                                    iVar.k(obj, obj.f11064c);
                                }
                            }
                            ...
                            if (i11 != 2 && !arrayList.contains(Long.valueOf(longValue))) {
                                ...
                                ?? obj2 = new Object();
                                obj2.f11064c = longValue;
                                obj2.f11063b = queryFinalized.intValue(1);
                                arrayList4.add(obj2);
                                iVar.k(obj2, obj2.f11064c);
                            }
                        } else {
                            long j3 = -longValue;
                            if (!arrayList2.contains(Long.valueOf(j3))) {
                                ...
                                ?? obj22 = new Object();
                                obj22.f11064c = longValue;
                                obj22.f11063b = queryFinalized.intValue(1);
                                arrayList4.add(obj22);
                                iVar.k(obj22, obj22.f11064c);
                            }
                        }
                    }
                    ...
                    if (!arrayList3.isEmpty()) {
                        ...
                        for (int i12 = 0; i12 < arrayList6.size(); i12++) {
                            h0 h0Var = (h0) iVar.f(DialogObject.makeEncryptedDialogId(arrayList6.get(i12).f19877id));
                            if (h0Var != null) {
                                h0Var.f11062a = arrayList6.get(i12);
                            }
                        }
                    }
                    ...
                    if (!arrayList.isEmpty()) {
                        ...
                        for (int i14 = 0; i14 < arrayList5.size(); i14++) {
                            ...
                            h0 h0Var4 = (h0) iVar.f(user.f20016id);
                            if (h0Var4 != null) {
                                h0Var4.f11062a = user;
                            }
                        }
            ...
            case 1:
                ...
                e2.p pVar = f0Var.f11526m;
                int i15 = this.f11180b;
                int i16 = this.f11181c;
                pVar.e(24, new eh.c(i15, i16, 2));
                f0Var.p1(2, 14, new e2.w(i15, i16));
                return;
            case 2:
                ((i2.c0) this.d).f11471a.m1(this.f11180b, this.f11181c);
                return;
            case 3:
                VoIPGroupNotification.d((Context) this.d, this.f11180b, this.f11181c);
                return;
            case 4:
                ((VoIPService) this.d).lambda$initiateActualEncryptedCall$86(this.f11180b, this.f11181c);
                return;
            case 5:
                ((ConnectionsManager) this.d).lambda$discardConnection$0(this.f11180b, this.f11181c);
                return;
            case 6:
                org.telegram.ui.web.z0 z0Var = (org.telegram.ui.web.z0) this.d;
                for (int i17 = 0; i17 < this.f11180b - this.f11181c; i17++) {
                    z0Var.goBack();
                }
                return;
            case 7:
                Bundle bundle = new Bundle();
                bundle.putLong("user_id", UserConfig.getInstance(this.f11180b).getClientUserId());
                bundle.putInt("message_id", this.f11181c);
                ((n2) this.d).presentFragment(new co(bundle));
                return;
            case 8:
                no noVar = (no) this.d;
                int i18 = this.f11180b;
                if (i18 != 0) {
                    SharedPreferences notificationsSettings = MessagesController.getNotificationsSettings(this.f11181c);
            ...
            case 9:
                jo joVar = (jo) this.d;
                int i19 = this.f11180b;
                if (i19 != 0) {
                    SharedPreferences notificationsSettings2 = MessagesController.getNotificationsSettings(this.f11181c);
            ...
            case 10:
                ...
                if (d != null) {
                    int top = d.getTop() + this.f11180b;
                    int top2 = d.getTop() + this.f11181c;
                    int i20 = top2 - top;
                ...
                return;
            case 11:
                org.telegram.ui.Components.voip.h1 h1Var = ((org.telegram.ui.Components.voip.g1) this.d).f31496a;
                qf.e eVar = h1Var.O;
                if (eVar != null) {
                    eVar.d(this.f11180b, this.f11181c);
                }
                h1Var.i(false);
                return;
            case 12:
                ((SurfaceTextureHelper) this.d).lambda$setTextureSize$2(this.f11180b, this.f11181c);
                return;
            case 13:
                SurfaceViewRenderer.a((SurfaceViewRenderer) this.d, this.f11180b, this.f11181c);
                return;
            default:
                ((TextureViewRenderer) this.d).lambda$updateVideoSizes$1(this.f11180b, this.f11181c);
                return;
        }
    }
