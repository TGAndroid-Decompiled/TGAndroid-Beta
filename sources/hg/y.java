...
public final class y implements g0, bl0 {
    ...
    public boolean a(int i10, View view) {
        TLRPC.User user;
        gy gyVar = this.f11345a.U;
        if (gyVar != null) {
            Long l4 = (Long) view.getTag();
            long longValue = l4.longValue();
            uy uyVar = gyVar.f36837a;
            if (uyVar.getParentActivity() != null && (user = uyVar.getMessagesController().getUser(l4)) != null) {
                ...
                if (textView != null) {
                    textView.setTextColor(uyVar.getThemedColor(j6.f20925q7));
                }
            }
        }
        return true;
    ...
    public void b(a0.i iVar, ArrayList arrayList) {
        i0 i0Var = this.f11345a;
        int i10 = i0Var.f11119s0;
        i0Var.f11120t0 = arrayList;
        i0Var.f11126x0 = iVar;
        for (int i11 = 0; i11 < i0Var.f11120t0.size(); i11++) {
            h0 h0Var = (h0) i0Var.f11120t0.get(i11);
            TLObject tLObject = h0Var.f11088a;
            if (tLObject instanceof TLRPC.User) {
                MessagesController.getInstance(i10).putUser((TLRPC.User) h0Var.f11088a, true);
            } else if (tLObject instanceof TLRPC.Chat) {
                MessagesController.getInstance(i10).putChat((TLRPC.Chat) h0Var.f11088a, true);
