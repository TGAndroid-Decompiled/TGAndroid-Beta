...
public final class da implements Runnable {
    public final int f45668a = 0;
    public final long f45669b;
    public final Object f45670c;
    ...
    public final void run() {
        switch (this.f45668a) {
            case 0:
                fa faVar = (fa) this.f45670c;
                r0 r0Var = (r0) this.d;
                HashMap hashMap = faVar.f45705j;
                ...
                Long valueOf = Long.valueOf(this.f45669b);
                j jVar2 = fVar.f45685c;
                ...
                if (faVar.c(o7Var, elapsedRealtime)) {
                    faVar.f45704i.put(o7Var, Long.valueOf(elapsedRealtime));
                    qb.m.f41542a.execute(new pg.c1(faVar, 8));
                    return;
                }
                return;
            default:
                wf wfVar = (wf) this.f45670c;
                hb hbVar = hb.AGGREGATED_ON_DEVICE_SUBJECT_SEGMENTATION_INFERENCE;
                z7.i1 i1Var = (z7.i1) this.d;
                HashMap hashMap2 = wfVar.f48951j;
                ...
                Long valueOf2 = Long.valueOf(this.f45669b);
                z7.d dVar2 = ((lg) hashMap2.get(hbVar)).f48808c;
                ...
                if (wfVar.d(hbVar, elapsedRealtime2)) {
                    wfVar.f48950i.put(hbVar, Long.valueOf(elapsedRealtime2));
                    qb.m.f41542a.execute(new pg.c1(wfVar));
                    return;
                }
                return;
        }
