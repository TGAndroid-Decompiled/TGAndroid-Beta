...
public final class da implements Runnable {
    ...
    public final void run() {
        switch (this.f48989a) {
            case 0:
                fa faVar = (fa) this.f48991c;
                r0 r0Var = (r0) this.d;
                HashMap hashMap = faVar.f49029j;
                ...
                Long valueOf = Long.valueOf(this.f48990b);
                j jVar2 = fVar.f49007c;
                ...
                if (faVar.c(o7Var, elapsedRealtime)) {
                    faVar.f49028i.put(o7Var, Long.valueOf(elapsedRealtime));
                    qb.m.f44322a.execute(new rg.b0(faVar, 7));
                    return;
                }
                return;
            default:
                wf wfVar = (wf) this.f48991c;
                hb hbVar = hb.AGGREGATED_ON_DEVICE_SUBJECT_SEGMENTATION_INFERENCE;
                z7.i1 i1Var = (z7.i1) this.d;
                HashMap hashMap2 = wfVar.f51345j;
                ...
                Long valueOf2 = Long.valueOf(this.f48990b);
                z7.d dVar2 = ((lg) hashMap2.get(hbVar)).f51190c;
                ...
                if (wfVar.d(hbVar, elapsedRealtime2)) {
                    wfVar.f51344i.put(hbVar, Long.valueOf(elapsedRealtime2));
                    qb.m.f44322a.execute(new rg.b0(wfVar));
                    return;
                }
                return;
        }
