...
public final class da implements Runnable {
    ...
    public final void run() {
        switch (this.f45655a) {
            case 0:
                fa faVar = (fa) this.f45657c;
                r0 r0Var = (r0) this.d;
                HashMap hashMap = faVar.f45692j;
                ...
                Long valueOf = Long.valueOf(this.f45656b);
                j jVar2 = fVar.f45672c;
                ...
                if (faVar.c(o7Var, elapsedRealtime)) {
                    faVar.f45691i.put(o7Var, Long.valueOf(elapsedRealtime));
                    qb.m.f41529a.execute(new pg.c1(faVar, 8));
                    return;
                }
                return;
            default:
                wf wfVar = (wf) this.f45657c;
                hb hbVar = hb.AGGREGATED_ON_DEVICE_SUBJECT_SEGMENTATION_INFERENCE;
                z7.i1 i1Var = (z7.i1) this.d;
                HashMap hashMap2 = wfVar.f48941j;
                ...
                Long valueOf2 = Long.valueOf(this.f45656b);
                z7.d dVar2 = ((lg) hashMap2.get(hbVar)).f48798c;
                ...
                if (wfVar.d(hbVar, elapsedRealtime2)) {
                    wfVar.f48940i.put(hbVar, Long.valueOf(elapsedRealtime2));
                    qb.m.f41529a.execute(new pg.c1(wfVar));
                    return;
                }
                return;
        }
