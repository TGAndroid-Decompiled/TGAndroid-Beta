...
public final class da implements Runnable {
    public final int f45341a = 0;
    public final long f45342b;
    public final Object f45343c;
    ...
    public final void run() {
        switch (this.f45341a) {
            case 0:
                fa faVar = (fa) this.f45343c;
                r0 r0Var = (r0) this.d;
                HashMap hashMap = faVar.f45378j;
                ...
                Long valueOf = Long.valueOf(this.f45342b);
                j jVar2 = fVar.f45358c;
                ...
                if (faVar.c(o7Var, elapsedRealtime)) {
                    faVar.f45377i.put(o7Var, Long.valueOf(elapsedRealtime));
                    qb.m.f41206a.execute(new qg.b0(faVar, 7));
                    return;
                }
                return;
            default:
                wf wfVar = (wf) this.f45343c;
                hb hbVar = hb.AGGREGATED_ON_DEVICE_SUBJECT_SEGMENTATION_INFERENCE;
                z7.i1 i1Var = (z7.i1) this.d;
                HashMap hashMap2 = wfVar.f48624j;
                ...
                Long valueOf2 = Long.valueOf(this.f45342b);
                z7.d dVar2 = ((lg) hashMap2.get(hbVar)).f48481c;
                ...
                if (wfVar.d(hbVar, elapsedRealtime2)) {
                    wfVar.f48623i.put(hbVar, Long.valueOf(elapsedRealtime2));
                    qb.m.f41206a.execute(new qg.b0(wfVar));
                    return;
                }
                return;
        }
