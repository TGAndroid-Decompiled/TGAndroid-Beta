...
public final class da implements Runnable {
    public final int f45419a = 0;
    public final long f45420b;
    public final Object f45421c;
    ...
    public final void run() {
        switch (this.f45419a) {
            case 0:
                fa faVar = (fa) this.f45421c;
                r0 r0Var = (r0) this.d;
                HashMap hashMap = faVar.f45456j;
                ...
                Long valueOf = Long.valueOf(this.f45420b);
                j jVar2 = fVar.f45436c;
                ...
                if (faVar.c(o7Var, elapsedRealtime)) {
                    faVar.f45455i.put(o7Var, Long.valueOf(elapsedRealtime));
                    qb.m.f41281a.execute(new qg.b0(faVar, 7));
                    return;
                }
                return;
            default:
                wf wfVar = (wf) this.f45421c;
                hb hbVar = hb.AGGREGATED_ON_DEVICE_SUBJECT_SEGMENTATION_INFERENCE;
                z7.i1 i1Var = (z7.i1) this.d;
                HashMap hashMap2 = wfVar.f48709j;
                ...
                Long valueOf2 = Long.valueOf(this.f45420b);
                z7.d dVar2 = ((lg) hashMap2.get(hbVar)).f48566c;
                ...
                if (wfVar.d(hbVar, elapsedRealtime2)) {
                    wfVar.f48708i.put(hbVar, Long.valueOf(elapsedRealtime2));
                    qb.m.f41281a.execute(new qg.b0(wfVar));
                    return;
                }
                return;
        }
