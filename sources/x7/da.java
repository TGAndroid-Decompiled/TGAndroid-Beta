...
public final class da implements Runnable {
    public final int f45387a = 0;
    public final long f45388b;
    public final Object f45389c;
    ...
    public final void run() {
        switch (this.f45387a) {
            case 0:
                fa faVar = (fa) this.f45389c;
                r0 r0Var = (r0) this.d;
                HashMap hashMap = faVar.f45424j;
                ...
                Long valueOf = Long.valueOf(this.f45388b);
                j jVar2 = fVar.f45404c;
                ...
                if (faVar.c(o7Var, elapsedRealtime)) {
                    faVar.f45423i.put(o7Var, Long.valueOf(elapsedRealtime));
                    qb.m.f41250a.execute(new qg.b0(faVar, 7));
                    return;
                }
                return;
            default:
                wf wfVar = (wf) this.f45389c;
                hb hbVar = hb.AGGREGATED_ON_DEVICE_SUBJECT_SEGMENTATION_INFERENCE;
                z7.i1 i1Var = (z7.i1) this.d;
                HashMap hashMap2 = wfVar.f48674j;
                ...
                Long valueOf2 = Long.valueOf(this.f45388b);
                z7.d dVar2 = ((lg) hashMap2.get(hbVar)).f48531c;
                ...
                if (wfVar.d(hbVar, elapsedRealtime2)) {
                    wfVar.f48673i.put(hbVar, Long.valueOf(elapsedRealtime2));
                    qb.m.f41250a.execute(new qg.b0(wfVar));
                    return;
                }
                return;
        }
