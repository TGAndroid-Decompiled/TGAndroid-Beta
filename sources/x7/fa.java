...
public final class fa {
    public static s f45697k;
    public static final x f45698l;
    public final String f45699a;
    public final String f45700b;
    public final ca f45701c;
    public final qb.k d;
    public final Task e;
    public final Task f45702f;
    public final String f45703g;
    public final int h;
    public final HashMap f45704i = new HashMap();
    public final HashMap f45705j = new HashMap();

    static {
        Object[] objArr = {"optional-module-barcode", "com.google.android.gms.vision.barcode"};
        objArr[0].getClass();
        objArr[1].getClass();
        f45698l = new x(objArr);
    }

    public fa(Context context, qb.k kVar, ca caVar) {
        int i10;
        this.f45699a = context.getPackageName();
        this.f45700b = qb.c.a(context);
        this.d = kVar;
        this.f45701c = caVar;
        ia.b();
        this.f45703g = "play-services-mlkit-image-labeling";
        qb.f a2 = qb.f.a();
    ...
    public final String b() {
        ...
        return n6.i.f15276c.a(this.f45703g);
    }

    public final boolean c(o7 o7Var, long j3) {
        HashMap hashMap = this.f45704i;
