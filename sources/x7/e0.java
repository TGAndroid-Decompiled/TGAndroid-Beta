...
public final class e0 implements ia.e {
    public static final Charset f45424f = Charset.forName("UTF-8");
    public static final ia.c f45425g = new ia.c("key", hg.k0.o(w.f.j(c0.class, new z(1))));
    public static final ia.c h = new ia.c("value", hg.k0.o(w.f.j(c0.class, new z(2))));
    public static final d0 f45426i = d0.f45407b;
    public OutputStream f45427a;
    public final HashMap f45428b;
    public final HashMap f45429c;
    public final ia.d d;
    ...
    public e0(ByteArrayOutputStream byteArrayOutputStream, HashMap hashMap, HashMap hashMap2, ia.d dVar) {
        ...
        this.f45428b = hashMap;
        this.f45429c = hashMap2;
        this.d = dVar;
    }
    ...
    public final void b(ia.c cVar, double d, boolean z10) {
        ...
        k((i(cVar) << 3) | 1);
        this.f45427a.write(ByteBuffer.allocate(8).order(ByteOrder.LITTLE_ENDIAN).putDouble(d).array());
    }
        ...
        if (obj != null) {
            if (obj instanceof CharSequence) {
                ...
                if (!z10 || charSequence.length() != 0) {
                    k((i(cVar) << 3) | 2);
                    byte[] bytes = charSequence.toString().getBytes(f45424f);
                    k(bytes.length);
                ...
                ia.d dVar = (ia.d) this.f45428b.get(obj.getClass());
                if (dVar != null) {
                    j(dVar, cVar, obj, z10);
                    return;
                }
                ia.f fVar = (ia.f) this.f45429c.get(obj.getClass());
                if (fVar != null) {
                    la.h hVar = this.e;
                    hVar.f13955b = false;
                    hVar.d = cVar;
    ...
    public final void j(ia.d dVar, ia.c cVar, Object obj, boolean z10) {
        ...
        bVar.f13944b = 0L;
        try {
            OutputStream outputStream = this.f45427a;
            this.f45427a = bVar;
            dVar.a(obj, this);
