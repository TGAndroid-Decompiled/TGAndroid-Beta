...
public final class e0 implements ia.e {
    public static final Charset f45675f = Charset.forName("UTF-8");
    public static final ia.c f45676g = new ia.c("key", hg.c.m(v7.j.l(c0.class, new z(1))));
    public static final ia.c h = new ia.c("value", hg.c.m(v7.j.l(c0.class, new z(2))));
    public static final d0 f45677i = d0.f45658b;
    public OutputStream f45678a;
    public final HashMap f45679b;
    public final HashMap f45680c;
    public final ia.d d;
    ...
    public e0(ByteArrayOutputStream byteArrayOutputStream, HashMap hashMap, HashMap hashMap2, ia.d dVar) {
        this.f45678a = byteArrayOutputStream;
        this.f45679b = hashMap;
        this.f45680c = hashMap2;
        this.d = dVar;
    }
    ...
    public final void b(ia.c cVar, double d, boolean z10) {
        ...
        k((i(cVar) << 3) | 1);
        this.f45678a.write(ByteBuffer.allocate(8).order(ByteOrder.LITTLE_ENDIAN).putDouble(d).array());
    }
        ...
        if (obj != null) {
            if (obj instanceof CharSequence) {
                ...
                if (!z10 || charSequence.length() != 0) {
                    k((i(cVar) << 3) | 2);
                    byte[] bytes = charSequence.toString().getBytes(f45675f);
                    k(bytes.length);
                    this.f45678a.write(bytes);
                }
                ...
                if (!z10 || floatValue != 0.0f) {
                    k((i(cVar) << 3) | 5);
                    this.f45678a.write(ByteBuffer.allocate(4).order(ByteOrder.LITTLE_ENDIAN).putFloat(floatValue).array());
                }
                ...
                k((i(cVar) << 3) | 2);
                k(bArr.length);
                this.f45678a.write(bArr);
            } else {
                ia.d dVar = (ia.d) this.f45679b.get(obj.getClass());
                if (dVar != null) {
                    j(dVar, cVar, obj, z10);
                    return;
                }
                ia.f fVar = (ia.f) this.f45680c.get(obj.getClass());
                if (fVar != null) {
                    la.i iVar = this.e;
                    iVar.f14169b = false;
                    iVar.d = cVar;
    ...
    public final void j(ia.d dVar, ia.c cVar, Object obj, boolean z10) {
        ...
        bVar.f14155b = 0L;
        try {
            OutputStream outputStream = this.f45678a;
            this.f45678a = bVar;
            dVar.a(obj, this);
            this.f45678a = outputStream;
