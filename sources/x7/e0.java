...
public final class e0 implements ia.e {
    public static final Charset f48965f = Charset.forName("UTF-8");
    public static final ia.c f48966g = new ia.c("key", i2.g.n(w.f.j(c0.class, new z(1))));
    public static final ia.c h = new ia.c("value", i2.g.n(w.f.j(c0.class, new z(2))));
    public static final d0 f48967i = d0.f48947b;
    public OutputStream f48968a;
    public final HashMap f48969b;
    public final HashMap f48970c;
    public final ia.d d;
    public final la.h f48971e = new la.h(this, 3);

    public e0(ByteArrayOutputStream byteArrayOutputStream, HashMap hashMap, HashMap hashMap2, ia.d dVar) {
        this.f48968a = byteArrayOutputStream;
        this.f48969b = hashMap;
        this.f48970c = hashMap2;
        this.d = dVar;
    }
    ...
    public final void b(ia.c cVar, double d, boolean z10) {
        ...
        k((i(cVar) << 3) | 1);
        this.f48968a.write(ByteBuffer.allocate(8).order(ByteOrder.LITTLE_ENDIAN).putDouble(d).array());
    }
        ...
        if (obj != null) {
            if (obj instanceof CharSequence) {
                ...
                if (!z10 || charSequence.length() != 0) {
                    k((i(cVar) << 3) | 2);
                    byte[] bytes = charSequence.toString().getBytes(f48965f);
                    k(bytes.length);
                    this.f48968a.write(bytes);
                }
                ...
                if (!z10 || floatValue != 0.0f) {
                    k((i(cVar) << 3) | 5);
                    this.f48968a.write(ByteBuffer.allocate(4).order(ByteOrder.LITTLE_ENDIAN).putFloat(floatValue).array());
                }
                ...
                k((i(cVar) << 3) | 2);
                k(bArr.length);
                this.f48968a.write(bArr);
            } else {
                ia.d dVar = (ia.d) this.f48969b.get(obj.getClass());
                if (dVar != null) {
                    j(dVar, cVar, obj, z10);
                    return;
                }
                ia.f fVar = (ia.f) this.f48970c.get(obj.getClass());
                if (fVar != null) {
                    la.h hVar = this.f48971e;
                    hVar.f15334b = false;
                    hVar.d = cVar;
                    hVar.f15335c = z10;
                    fVar.a(obj, hVar);
    ...
    public final void j(ia.d dVar, ia.c cVar, Object obj, boolean z10) {
        ...
        bVar.f15322b = 0L;
        try {
            OutputStream outputStream = this.f48968a;
            this.f48968a = bVar;
            dVar.a(obj, this);
            this.f48968a = outputStream;
