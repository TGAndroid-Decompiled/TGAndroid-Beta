...
public final class e0 implements ia.e {
    public static final Charset f45673f = Charset.forName("UTF-8");
    public static final ia.c f45674g = new ia.c("key", hg.c.m(v7.j.l(c0.class, new z(1))));
    public static final ia.c h = new ia.c("value", hg.c.m(v7.j.l(c0.class, new z(2))));
    public static final d0 f45675i = d0.f45656b;
    public OutputStream f45676a;
    public final HashMap f45677b;
    public final HashMap f45678c;
    public final ia.d d;
    ...
    public e0(ByteArrayOutputStream byteArrayOutputStream, HashMap hashMap, HashMap hashMap2, ia.d dVar) {
        this.f45676a = byteArrayOutputStream;
        this.f45677b = hashMap;
        this.f45678c = hashMap2;
        this.d = dVar;
    }
    ...
    public final void b(ia.c cVar, double d, boolean z10) {
        ...
        k((i(cVar) << 3) | 1);
        this.f45676a.write(ByteBuffer.allocate(8).order(ByteOrder.LITTLE_ENDIAN).putDouble(d).array());
    }
        ...
        if (obj != null) {
            if (obj instanceof CharSequence) {
                ...
                if (!z10 || charSequence.length() != 0) {
                    k((i(cVar) << 3) | 2);
                    byte[] bytes = charSequence.toString().getBytes(f45673f);
                    k(bytes.length);
                    this.f45676a.write(bytes);
                }
                ...
                if (!z10 || floatValue != 0.0f) {
                    k((i(cVar) << 3) | 5);
                    this.f45676a.write(ByteBuffer.allocate(4).order(ByteOrder.LITTLE_ENDIAN).putFloat(floatValue).array());
                }
                ...
                k((i(cVar) << 3) | 2);
                k(bArr.length);
                this.f45676a.write(bArr);
            } else {
                ia.d dVar = (ia.d) this.f45677b.get(obj.getClass());
                if (dVar != null) {
                    j(dVar, cVar, obj, z10);
                    return;
                }
                ia.f fVar = (ia.f) this.f45678c.get(obj.getClass());
                if (fVar != null) {
                    la.i iVar = this.e;
                    iVar.f14169b = false;
                    iVar.d = cVar;
    ...
    public final void j(ia.d dVar, ia.c cVar, Object obj, boolean z10) {
        ...
        bVar.f14155b = 0L;
        try {
            OutputStream outputStream = this.f45676a;
            this.f45676a = bVar;
            dVar.a(obj, this);
            this.f45676a = outputStream;
