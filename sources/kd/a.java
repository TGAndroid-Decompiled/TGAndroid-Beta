...
public final class a implements Comparable {
    public static final long f10323b;
    public static final long f10324c;
    public static final int d = 0;
    public final long f10325a;

    static {
        int i10 = b.f10326a;
        f10323b = Long.MAX_VALUE;
        f10324c = -9223372036854775805L;
    }
    ...
    public static final long c(long j10, c unit) {
        ...
        long j11 = j10 >> 1;
        if ((((int) j10) & 1) == 0) {
            sourceUnit = c.f10327b;
        } else {
            sourceUnit = c.f10328c;
        }
        j.e(sourceUnit, "sourceUnit");
        return unit.f10331a.convert(j11, sourceUnit.f10331a);
    }

    @Override
    public final int compareTo(Object obj) {
        long j10 = ((a) obj).f10325a;
