...
public abstract class a implements id.c, d, Serializable {
    ...
    public StackTraceElement getStackTraceElement() {
        ...
        if (v <= 1) {
            ...
            if (fVar != fVar2 && (method = fVar.f13582a) != null && (invoke = method.invoke(getClass(), null)) != null && (method2 = fVar.f13583b) != null && (invoke2 = method2.invoke(invoke, null)) != null) {
                Method method3 = fVar.f13584c;
                if (method3 != null) {
