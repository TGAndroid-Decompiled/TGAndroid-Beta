...
public final class m extends o6.a {
    ...
    public final String toString() {
        ...
        HashMap hashMap = this.f46690b;
        int size = hashMap.size();
        sb2.append(", numAssets=" + size);
        sb2.append(", uri=".concat(String.valueOf(this.f46689a)));
        if (!isLoggable) {
            sb2.append("]");
            return sb2.toString();
        }
