...
public final class m extends o6.a {
    ...
    public final Uri f46341a;
    public final HashMap f46342b;
    public final byte[] f46343c;
    ...
    public final String toString() {
        ...
        HashMap hashMap = this.f46342b;
        int size = hashMap.size();
        sb2.append(", numAssets=" + size);
        sb2.append(", uri=".concat(String.valueOf(this.f46341a)));
        if (!isLoggable) {
            sb2.append("]");
            return sb2.toString();
        }
