...
public final class m extends o6.a {
    ...
    public final HashMap f46416b;
    public final byte[] f46417c;
    ...
    public final String toString() {
        ...
        HashMap hashMap = this.f46416b;
        int size = hashMap.size();
        sb2.append(", numAssets=" + size);
        sb2.append(", uri=".concat(String.valueOf(this.f46415a)));
        if (!isLoggable) {
            sb2.append("]");
            return sb2.toString();
        }
