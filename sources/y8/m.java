...
public final class m extends o6.a {
    ...
    public final Uri f46537a;
    public final HashMap f46538b;
    public final byte[] f46539c;
    ...
    public final String toString() {
        ...
        HashMap hashMap = this.f46538b;
        int size = hashMap.size();
        sb2.append(", numAssets=" + size);
        sb2.append(", uri=".concat(String.valueOf(this.f46537a)));
        if (!isLoggable) {
            sb2.append("]");
            return sb2.toString();
        }
