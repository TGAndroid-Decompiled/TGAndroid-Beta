...
public final class m extends o6.a {
    ...
    public final Uri f46410a;
    public final HashMap f46411b;
    public final byte[] f46412c;
    ...
    public final String toString() {
        ...
        HashMap hashMap = this.f46411b;
        int size = hashMap.size();
        sb2.append(", numAssets=" + size);
        sb2.append(", uri=".concat(String.valueOf(this.f46410a)));
        if (!isLoggable) {
            sb2.append("]");
            return sb2.toString();
        }
