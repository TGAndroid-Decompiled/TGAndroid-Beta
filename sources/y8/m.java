...
public final class m extends o6.a {
    ...
    public final Uri f49648a;
    public final HashMap f49649b;
    public final byte[] f49650c;
    ...
    public final String toString() {
        ...
        HashMap hashMap = this.f49649b;
        int size = hashMap.size();
        sb2.append(", numAssets=" + size);
        sb2.append(", uri=".concat(String.valueOf(this.f49648a)));
        if (!isLoggable) {
            sb2.append("]");
            return sb2.toString();
        }
    ...
    public final void writeToParcel(Parcel parcel, int i10) {
        ...
        w7.e0.k(parcel, 2, this.f49648a, i10);
