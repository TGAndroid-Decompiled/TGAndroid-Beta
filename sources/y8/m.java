...
public final class m extends o6.a {
    ...
    public final HashMap f46388b;
    public final byte[] f46389c;
    ...
    public final String toString() {
        ...
        HashMap hashMap = this.f46388b;
        int size = hashMap.size();
        sb2.append(", numAssets=" + size);
        sb2.append(", uri=".concat(String.valueOf(this.f46387a)));
        if (!isLoggable) {
            sb2.append("]");
            return sb2.toString();
        }
