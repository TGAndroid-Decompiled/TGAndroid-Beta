...
public final class d1 extends o6.a {
    ...
    public final List f46629b;
    public final a1 f46630c;

    public d1(int i10, ArrayList arrayList, a1 a1Var) {
        this.f46628a = i10;
        this.f46629b = arrayList;
        this.f46630c = a1Var;
    }
    ...
    public final void writeToParcel(Parcel parcel, int i10) {
        ...
        w7.f0.s(parcel, 1, 4);
        parcel.writeInt(this.f46628a);
        w7.f0.p(parcel, 2, this.f46629b);
        w7.f0.k(parcel, 3, this.f46630c, i10);
        w7.f0.r(parcel, q6);
    }
}
