...
public final class z0 {
    ...
    public z0(Context context) {
        this.f46448a = context.getApplicationContext();
    }
    ...
    public static final boolean c(PackageInfo packageInfo, boolean z10) {
        ...
        byte[] bArr = f46447c;
        if (z10) {
            return d(packageInfo, bArr, d);
        }
        return d(packageInfo, bArr);
    }
