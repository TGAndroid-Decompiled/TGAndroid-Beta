...
public final class e extends o6.a {
    ...
    public final String toString() {
        String str;
        String str2;
        String valueOf = String.valueOf(this.f46665a);
        int i10 = this.f46666b;
        if (i10 != 1) {
            if (i10 != 2) {
                if (i10 != 3) {
    ...
    public final void writeToParcel(Parcel parcel, int i10) {
        ...
        w7.f0.k(parcel, 2, this.f46665a, i10);
        w7.f0.s(parcel, 3, 4);
        parcel.writeInt(this.f46666b);
        w7.f0.s(parcel, 4, 4);
        parcel.writeInt(this.f46667c);
        w7.f0.s(parcel, 5, 4);
