...
public final class e extends o6.a {
    ...
    public final void b(x8.c cVar) {
        f fVar = this.f46618a;
        int i10 = this.f46619b;
        if (i10 != 1) {
            int i11 = this.d;
            int i12 = this.f46620c;
            if (i10 != 2) {
                if (i10 != 3) {
                    if (i10 != 4) {
    ...
    public final String toString() {
        String str;
        String str2;
        String valueOf = String.valueOf(this.f46618a);
        int i10 = this.f46619b;
        if (i10 != 1) {
            if (i10 != 2) {
                if (i10 != 3) {
    ...
    public final void writeToParcel(Parcel parcel, int i10) {
        ...
        w7.f0.k(parcel, 2, this.f46618a, i10);
        w7.f0.s(parcel, 3, 4);
        parcel.writeInt(this.f46619b);
        w7.f0.s(parcel, 4, 4);
        parcel.writeInt(this.f46620c);
        w7.f0.s(parcel, 5, 4);
