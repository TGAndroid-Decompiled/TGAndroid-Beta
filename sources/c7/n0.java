...
public final class n0 extends o6.a {
    ...
    public n0(boolean z10) {
        this.f4538a = Boolean.valueOf(z10).booleanValue();
    }

    public final boolean equals(Object obj) {
        if (!(obj instanceof n0) || this.f4538a != ((n0) obj).f4538a) {
            return false;
        }
        return true;
    }
    ...
    public final int hashCode() {
        return Arrays.hashCode(new Object[]{Boolean.valueOf(this.f4538a)});
    }
