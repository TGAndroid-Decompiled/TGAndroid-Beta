...
public final class n0 extends o6.a {
    ...
    public n0(boolean z10) {
        this.f4125a = Boolean.valueOf(z10).booleanValue();
    }

    public final boolean equals(Object obj) {
        if (!(obj instanceof n0) || this.f4125a != ((n0) obj).f4125a) {
            return false;
        }
        return true;
    }
    ...
    public final int hashCode() {
        return Arrays.hashCode(new Object[]{Boolean.valueOf(this.f4125a)});
    }
