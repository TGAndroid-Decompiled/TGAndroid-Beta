...
public final class z0 extends o6.a {
    ...
    public z0(boolean z10) {
        this.f4177a = Boolean.valueOf(z10).booleanValue();
    }

    public final boolean equals(Object obj) {
        if (!(obj instanceof z0) || this.f4177a != ((z0) obj).f4177a) {
            return false;
        }
        return true;
    }
    ...
    public final int hashCode() {
        return Arrays.hashCode(new Object[]{Boolean.valueOf(this.f4177a)});
    }
