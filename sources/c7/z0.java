...
public final class z0 extends o6.a {
    ...
    public z0(boolean z10) {
        this.f4170a = Boolean.valueOf(z10).booleanValue();
    }

    public final boolean equals(Object obj) {
        if (!(obj instanceof z0) || this.f4170a != ((z0) obj).f4170a) {
            return false;
        }
        return true;
    }
    ...
    public final int hashCode() {
        return Arrays.hashCode(new Object[]{Boolean.valueOf(this.f4170a)});
    }
