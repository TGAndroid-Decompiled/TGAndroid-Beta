...
public final class v0 extends o6.a {
    ...
    public final boolean equals(Object obj) {
        ...
        v0 v0Var = (v0) obj;
        if (this.f4159a != v0Var.f4159a || !n6.l.l(this.f4160b, v0Var.f4160b)) {
            return false;
        }
        return true;
    }
    ...
    public final int hashCode() {
        return Arrays.hashCode(new Object[]{Boolean.valueOf(this.f4159a), this.f4160b});
    }
    ...
    public final void writeToParcel(Parcel parcel, int i10) {
        ...
        w7.e0.s(parcel, 1, 4);
        parcel.writeInt(this.f4159a ? 1 : 0);
        n7.t0 t0Var = this.f4160b;
        if (t0Var == null) {
            u10 = null;
        } else {
