...
public final class v0 extends o6.a {
    ...
    public final boolean equals(Object obj) {
        ...
        v0 v0Var = (v0) obj;
        if (this.f4165a != v0Var.f4165a || !n6.l.l(this.f4166b, v0Var.f4166b)) {
            return false;
        }
        return true;
    }
    ...
    public final int hashCode() {
        return Arrays.hashCode(new Object[]{Boolean.valueOf(this.f4165a), this.f4166b});
    }
    ...
    public final void writeToParcel(Parcel parcel, int i10) {
        ...
        w7.f0.s(parcel, 1, 4);
        parcel.writeInt(this.f4165a ? 1 : 0);
        n7.s0 s0Var = this.f4166b;
        if (s0Var == null) {
            u10 = null;
        } else {
