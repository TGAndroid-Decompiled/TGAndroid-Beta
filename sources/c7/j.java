...
public final class j extends l {
    ...
    public final n7.t0 f4103a;
    public final n7.t0 f4104b;
    public final n7.t0 f4105c;
    ...
    public final boolean equals(Object obj) {
        if (obj instanceof j) {
            j jVar = (j) obj;
            if (n6.l.l(this.f4103a, jVar.f4103a) && n6.l.l(this.f4104b, jVar.f4104b) && n6.l.l(this.f4105c, jVar.f4105c)) {
                return true;
            }
            return false;
        }
    ...
    public final int hashCode() {
        return Arrays.hashCode(new Object[]{Integer.valueOf(Arrays.hashCode(new Object[]{this.f4103a})), Integer.valueOf(Arrays.hashCode(new Object[]{this.f4104b})), Integer.valueOf(Arrays.hashCode(new Object[]{this.f4105c}))});
    }

    public final String toString() {
        e3 e3Var = new e3(getClass().getSimpleName());
        n7.l0 l0Var = n7.n0.d;
        byte[] u10 = this.f4103a.u();
        e3Var.Y(l0Var.c(u10.length, u10), "keyHandle");
        byte[] u11 = this.f4104b.u();
        e3Var.Y(l0Var.c(u11.length, u11), "clientDataJSON");
        byte[] u12 = this.f4105c.u();
    ...
    public final void writeToParcel(Parcel parcel, int i10) {
        ...
        w7.e0.c(parcel, 2, this.f4103a.u());
        w7.e0.c(parcel, 3, this.f4104b.u());
        w7.e0.c(parcel, 4, this.f4105c.u());
