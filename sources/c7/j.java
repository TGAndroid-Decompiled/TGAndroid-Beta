...
public final class j extends l {
    ...
    public final n7.t0 f4105a;
    public final n7.t0 f4106b;
    public final n7.t0 f4107c;
    ...
    public final boolean equals(Object obj) {
        if (obj instanceof j) {
            j jVar = (j) obj;
            if (n6.l.l(this.f4105a, jVar.f4105a) && n6.l.l(this.f4106b, jVar.f4106b) && n6.l.l(this.f4107c, jVar.f4107c)) {
                return true;
            }
            return false;
        }
    ...
    public final int hashCode() {
        return Arrays.hashCode(new Object[]{Integer.valueOf(Arrays.hashCode(new Object[]{this.f4105a})), Integer.valueOf(Arrays.hashCode(new Object[]{this.f4106b})), Integer.valueOf(Arrays.hashCode(new Object[]{this.f4107c}))});
    }

    public final String toString() {
        lf.i iVar = new lf.i(getClass().getSimpleName());
        n7.l0 l0Var = n7.n0.d;
        byte[] u10 = this.f4105a.u();
        iVar.Z(l0Var.c(u10.length, u10), "keyHandle");
        byte[] u11 = this.f4106b.u();
        iVar.Z(l0Var.c(u11.length, u11), "clientDataJSON");
        byte[] u12 = this.f4107c.u();
    ...
    public final void writeToParcel(Parcel parcel, int i10) {
        ...
        w7.e0.c(parcel, 2, this.f4105a.u());
        w7.e0.c(parcel, 3, this.f4106b.u());
        w7.e0.c(parcel, 4, this.f4107c.u());
