...
public abstract class h {
    public static final Pattern f10984a = Pattern.compile("^(\\S+)\\s+-->\\s+(\\S+)((?:.|\\f)*)?$");
    public static final Pattern f10985b = Pattern.compile("(\\S+?):(\\S+)");
    public static final Map f10986c;
    ...
    static {
        ...
        f10986c = DesugarCollections.unmodifiableMap(hashMap);
    ...
    public static void a(String str, e eVar, List list, SpannableStringBuilder spannableStringBuilder, List list2) {
        ...
        switch (c10) {
            ...
            case 4:
                ...
                break;
            case 5:
                spannableStringBuilder.setSpan(new d2.i(eVar.f10973c), i15, length, 33);
                break;
            case 7:
                int c13 = c(list2, str, eVar);
                ArrayList arrayList = new ArrayList(list.size());
                arrayList.addAll(list);
                Collections.sort(arrayList, d.f10968c);
                int i17 = eVar.f10972b;
                int i18 = 0;
                int i19 = 0;
                while (i18 < arrayList.size()) {
                    if ("rt".equals(((d) arrayList.get(i18)).f10969a.f10971a)) {
                        d dVar = (d) arrayList.get(i18);
                        int c14 = c(list2, str, dVar.f10969a);
                        if (c14 == i16) {
                            if (c13 != i16) {
                                c14 = c13;
                            } else {
                        ...
                        int i20 = dVar.f10969a.f10972b - i19;
                        int i21 = dVar.f10970b - i19;
        ...
        for (int i22 = 0; i22 < b10.size(); i22++) {
            b bVar = ((f) b10.get(i22)).f10975b;
            int i23 = bVar.f10959l;
            if (i23 == -1 && bVar.f10960m == -1) {
                i10 = -1;
            } else {
                if (i23 == 1) {
                    c11 = 1;
            ...
            if (i10 != -1) {
                int i24 = bVar.f10959l;
                if (i24 == -1 && bVar.f10960m == -1) {
                    i14 = -1;
                    i11 = 1;
                } else {
                    i11 = 1;
            ...
            if (bVar.f10955g) {
                if (bVar.f10955g) {
                    p6.a(new ForegroundColorSpan(bVar.f10954f), spannableStringBuilder, i15, length);
                } else {
            ...
            int i25 = bVar.f10961n;
            if (i25 != 1) {
                if (i25 != 2) {
                    if (i25 == 3) {
                        p6.a(new RelativeSizeSpan(bVar.f10962o / 100.0f), spannableStringBuilder, i15, length);
                    }
                } else {
                    p6.a(new RelativeSizeSpan(bVar.f10962o), spannableStringBuilder, i15, length);
                }
            } else {
                p6.a(new AbsoluteSizeSpan((int) bVar.f10962o, true), spannableStringBuilder, i15, length);
            }
            if (bVar.f10964q) {
    ...
    public static ArrayList b(List list, String str, e eVar) {
        ...
        for (int i11 = 0; i11 < list.size(); i11++) {
            ...
            String str2 = eVar.f10971a;
            Set set = eVar.d;
            String str3 = eVar.f10973c;
            if (bVar.f10951a.isEmpty() && bVar.f10952b.isEmpty() && bVar.f10953c.isEmpty() && bVar.d.isEmpty()) {
                i10 = TextUtils.isEmpty(str2);
            } else {
                int a2 = b.a(b.a(b.a(0, 1073741824, bVar.f10951a, str), 2, bVar.f10952b, str2), 4, bVar.d, str3);
                if (a2 != -1 && set.containsAll(bVar.f10953c)) {
                    i10 = a2 + (bVar.f10953c.size() * 4);
                } else {
                    i10 = 0;
                }
            }
    ...
    public static int c(List list, String str, e eVar) {
        ...
        for (int i10 = 0; i10 < b10.size(); i10++) {
            int i11 = ((f) b10.get(i10)).f10975b.f10963p;
            if (i11 != -1) {
                return i11;
            }
        }
    ...
    public static c d(String str, Matcher matcher, v vVar, ArrayList arrayList) {
        ...
        try {
            ...
            group.getClass();
            gVar.f10976a = i.c(group);
            String group2 = matcher.group(2);
            group2.getClass();
            gVar.f10977b = i.c(group2);
            ...
            gVar.f10978c = f(str, sb2.toString(), arrayList);
            return new c(gVar.a().a(), gVar.f10976a, gVar.f10977b);
