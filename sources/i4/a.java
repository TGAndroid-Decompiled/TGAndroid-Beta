...
public final class a {
    public static final Pattern f10950c = Pattern.compile("\\[voice=\"([^\"]*)\"\\]");
    public static final Pattern d = Pattern.compile("^((?:[0-9]*\\.)?[0-9]+)(px|em|%)$");
    public final v f10951a = new v();
    public final StringBuilder f10952b = new StringBuilder();
