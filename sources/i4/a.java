...
public final class a {
    public static final Pattern f10948c = Pattern.compile("\\[voice=\"([^\"]*)\"\\]");
    public static final Pattern d = Pattern.compile("^((?:[0-9]*\\.)?[0-9]+)(px|em|%)$");
    public final v f10949a = new v();
    public final StringBuilder f10950b = new StringBuilder();
