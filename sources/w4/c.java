...
public final class c extends i {
    ...
    public final int f46394j;
    public List f46398n;
    public List f46399o;
    public int f46400p;
    public int f46401q;
    public boolean f46402r;
    public boolean f46403s;
    public byte f46404t;
    public byte f46405u;
    public boolean f46406w;
    public long f46407x;
    public static final int[] f46390y = {11, 1, 3, 12, 14, 5, 7, 9};
    public static final int[] f46391z = {0, 4, 8, 12, 16, 20, 24, 28};
    ...
    public final w f46392g = new w();
    public final ArrayList f46396l = new ArrayList();
    public b f46397m = new b(0, 4);
    public int v = 0;
    public final long f46395k = 16000000;
    ...
    public c(String str, int i10) {
        ...
        j();
        this.f46406w = true;
        this.f46407x = -9223372036854775807L;
    }

    @Override
    public final e5.b e() {
        List list = this.f46398n;
        this.f46399o = list;
        list.getClass();
    ...
    public final k b() {
        ...
        long j10 = this.f46395k;
        if (j10 != -9223372036854775807L) {
            long j11 = this.f46407x;
            if (j11 != -9223372036854775807L && this.e - j11 >= j10 && (kVar = (k) this.f46443b.pollFirst()) != null) {
                this.f46398n = Collections.EMPTY_LIST;
                this.f46407x = -9223372036854775807L;
    ...
    public final ArrayList i() {
        ArrayList arrayList = this.f46396l;
    ...
    public final void j() {
        b bVar = this.f46397m;
        bVar.f46389g = this.f46400p;
        bVar.f46385a.clear();
        bVar.f46386b.clear();
        bVar.f46387c.setLength(0);
        bVar.d = 15;
        bVar.e = 0;
        bVar.f46388f = 0;
        ArrayList arrayList = this.f46396l;
        arrayList.clear();
        arrayList.add(this.f46397m);
    }
            ...
            if (i10 == 3) {
                ...
                while (true) {
                    ...
                    if (i12 < arrayList.size()) {
                        ((b) arrayList.get(i12)).f46389g = i10;
                        i12++;
                    } else {
                        return;
                    }
