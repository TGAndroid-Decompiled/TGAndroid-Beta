...
public final class a {
    ...
    public final boolean equals(Object obj) {
        if (obj != this) {
            if (obj instanceof a) {
                a aVar = (a) obj;
                int i10 = aVar.f45970e;
                b bVar = aVar.d;
                String str = aVar.f45969c;
                String str2 = aVar.f45968b;
                String str3 = aVar.f45967a;
                String str4 = this.f45967a;
                if (str4 == null) {
                    if (str3 != null) {
                        return false;
                    }
