...
public final class b {
    ...
    public final boolean equals(Object obj) {
        if (obj != this) {
            if (obj instanceof b) {
                b bVar = (b) obj;
                int i10 = bVar.f43172c;
                String str = bVar.f43170a;
                String str2 = this.f43170a;
                if (str2 == null) {
                    if (str != null) {
                        return false;
                    }
                ...
                if (this.f43171b == bVar.f43171b) {
                    int i11 = this.f43172c;
                    if (i11 == 0) {
                        if (i10 == 0) {
                            return true;
                        }
