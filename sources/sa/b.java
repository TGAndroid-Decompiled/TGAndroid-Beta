...
public final class b {
    ...
    public final boolean equals(Object obj) {
        if (obj != this) {
            if (obj instanceof b) {
                b bVar = (b) obj;
                int i10 = bVar.f46001c;
                String str = bVar.f45999a;
                String str2 = this.f45999a;
                if (str2 == null) {
                    if (str != null) {
                        return false;
                    }
                ...
                if (this.f46000b == bVar.f46000b) {
                    int i11 = this.f46001c;
                    if (i11 == 0) {
                        if (i10 == 0) {
                            return true;
                        }
