...
public final class d implements Collection {
    ...
    public final Object[] toArray() {
        Object[] objArr = this.f10185a;
        kotlin.jvm.internal.i.e(objArr, "<this>");
        if (this.f10186b && objArr.getClass().equals(Object[].class)) {
            return objArr;
        }
