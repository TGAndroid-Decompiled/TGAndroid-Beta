...
public final class e extends AbstractList implements List {
    ...
    public final void add(int i10, Object obj) {
        ...
        if (i10 == i12) {
            ...
            s();
            n(this.f10174c + 1);
            int r10 = r(this.f10172a + i10);
            int i13 = this.f10174c;
            if (i10 < ((i13 + 1) >> 1)) {
                if (r10 == 0) {
                    Object[] objArr = this.f10173b;
                    kotlin.jvm.internal.i.e(objArr, "<this>");
                    r10 = objArr.length;
                }
                int i14 = r10 - 1;
                int i15 = this.f10172a;
                if (i15 == 0) {
    ...
    public final boolean addAll(int i10, Collection elements) {
        ...
        if (i10 >= 0 && i10 <= i11) {
            ...
            s();
            n(elements.size() + this.f10174c);
            int r10 = r(this.f10172a + this.f10174c);
            int r11 = r(this.f10172a + i10);
            int size = elements.size();
            if (i10 < ((this.f10174c + 1) >> 1)) {
                int i12 = this.f10172a;
                int i13 = i12 - size;
                if (r11 < i12) {
                    Object[] objArr = this.f10173b;
                    ...
                    if (length >= i14) {
                        ...
                        Object[] objArr7 = this.f10173b;
                        f.c(0, this.f10172a + length, r11, objArr7, objArr7);
                    }
                }
                this.f10172a = i13;
            ...
            if (r11 < r10) {
                ...
                if (i16 <= objArr8.length) {
                    ...
                    Object[] objArr9 = this.f10173b;
                    f.c(i15, r11, length2, objArr9, objArr9);
                }
            } else {
                Object[] objArr10 = this.f10173b;
                f.c(size, 0, r10, objArr10, objArr10);
                Object[] objArr11 = this.f10173b;
    ...
    public final void addLast(Object obj) {
        s();
        n(this.f10174c + 1);
        this.f10173b[r(this.f10172a + this.f10174c)] = obj;
        this.f10174c++;
    }
    ...
    public final void clear() {
        if (!isEmpty()) {
            s();
            q(this.f10172a, r(this.f10172a + this.f10174c));
        }
        this.f10172a = 0;
        this.f10174c = 0;
    }
    ...
    public final Object get(int i10) {
        int i11 = this.f10174c;
        if (i10 >= 0 && i10 < i11) {
            return this.f10173b[r(this.f10172a + i10)];
        }
        throw new IndexOutOfBoundsException(a4.a.m(i10, i11, "index: ", ", size: "));
    }
    ...
    public final void i(int i10, Collection collection) {
        ...
        while (i10 < length && it.hasNext()) {
            this.f10173b[i10] = it.next();
            i10++;
        }
        int i11 = this.f10172a;
        for (int i12 = 0; i12 < i11 && it.hasNext(); i12++) {
            this.f10173b[i12] = it.next();
        }
        this.f10174c = collection.size() + this.f10174c;
    }
    ...
    public final int indexOf(Object obj) {
        ...
        if (i11 < r10) {
            while (i11 < r10) {
                if (kotlin.jvm.internal.i.a(obj, this.f10173b[i11])) {
                    i10 = this.f10172a;
                } else {
                    i11++;
                }
            ...
            while (true) {
                if (i11 < length) {
                    ...
                    for (int i12 = 0; i12 < r10; i12++) {
                        if (kotlin.jvm.internal.i.a(obj, this.f10173b[i12])) {
                            i11 = i12 + this.f10173b.length;
                            i10 = this.f10172a;
                        }
                    }
                    return -1;
    ...
    public final int lastIndexOf(Object obj) {
        ...
        if (i11 < r10) {
            length = r10 - 1;
            if (i11 <= length) {
                while (!kotlin.jvm.internal.i.a(obj, this.f10173b[length])) {
                    if (length != i11) {
                        length--;
                    }
                }
        ...
        if (i11 > r10) {
            ...
            while (true) {
                if (-1 < i12) {
                    if (kotlin.jvm.internal.i.a(obj, this.f10173b[i12])) {
                        length = i12 + this.f10173b.length;
                        i10 = this.f10172a;
                        break;
                    }
                    i12--;
    ...
    public final void n(int i10) {
        if (i10 >= 0) {
            ...
            f.c(0, this.f10172a, objArr.length, objArr, objArr2);
            Object[] objArr3 = this.f10173b;
            int length2 = objArr3.length;
            int i12 = this.f10172a;
            f.c(length2 - i12, 0, i12, objArr3, objArr2);
            this.f10172a = 0;
            this.f10173b = objArr2;
            return;
        }
    ...
    public final int p(int i10) {
        if (i10 < 0) {
            return i10 + this.f10173b.length;
        }
        return i10;
    }
    ...
    public final void q(int i10, int i11) {
        if (i10 < i11) {
            f.e(i10, i11, this.f10173b);
            return;
        }
        Object[] objArr = this.f10173b;
        f.e(i10, objArr.length, objArr);
        f.e(0, i11, this.f10173b);
    }
    ...
    public final Object remove(int i10) {
        ...
        if (i10 >= 0 && i10 < i11) {
            ...
            if (i10 < (this.f10174c >> 1)) {
                ...
                Object[] objArr3 = this.f10173b;
                int i14 = this.f10172a;
                objArr3[i14] = null;
                this.f10172a = o(i14);
            } else {
                int r11 = r(h.a(this) + this.f10172a);
                if (r10 <= r11) {
                    Object[] objArr4 = this.f10173b;
    ...
    public final boolean removeAll(Collection elements) {
        ...
        z10 = false;
        z10 = false;
        if (!isEmpty() && this.f10173b.length != 0) {
            int r11 = r(this.f10172a + this.f10174c);
            int i10 = this.f10172a;
            if (i10 < r11) {
                r10 = i10;
                while (i10 < r11) {
                    Object obj = this.f10173b[i10];
            ...
            if (z10) {
                s();
                this.f10174c = p(r10 - this.f10172a);
            }
        }
        return z10;
    }
    ...
    public final Object removeLast() {
        if (!isEmpty()) {
            s();
            int r10 = r(h.a(this) + this.f10172a);
            Object[] objArr = this.f10173b;
            Object obj = objArr[r10];
            objArr[r10] = null;
            this.f10174c--;
    ...
    public final void removeRange(int i10, int i11) {
        ...
        if (i12 == this.f10174c) {
            ...
            s();
            if (i10 < this.f10174c - i11) {
                int r10 = r((i10 - 1) + this.f10172a);
                int r11 = r((i11 - 1) + this.f10172a);
                while (i10 > 0) {
                    int i13 = r10 + 1;
                ...
                int r12 = r(this.f10172a + i12);
                q(this.f10172a, r12);
                this.f10172a = r12;
            } else {
                int r13 = r(this.f10172a + i11);
                int r14 = r(this.f10172a + i10);
                int i16 = this.f10174c;
                while (true) {
                    i16 -= i11;
                    if (i16 <= 0) {
                        break;
                ...
                int r15 = r(this.f10172a + this.f10174c);
                q(p(r15 - i12), r15);
            }
            this.f10174c -= i12;
        }
    ...
    public final Object[] toArray() {
        return toArray(new Object[this.f10174c]);
    }
    ...
    public final Object[] toArray(Object[] array) {
        ...
        int i11 = this.f10172a;
        if (i11 < r10) {
            f.d(i11, r10, 2, this.f10173b, array);
        } else if (!isEmpty()) {
            Object[] objArr = this.f10173b;
            f.c(0, this.f10172a, objArr.length, objArr, array);
            Object[] objArr2 = this.f10173b;
            f.c(objArr2.length - this.f10172a, 0, r10, objArr2, array);
        }
        int i12 = this.f10174c;
        if (i12 < array.length) {
            array[i12] = null;
    ...
    public final boolean addAll(Collection elements) {
        ...
        s();
        n(elements.size() + this.f10174c);
        i(r(this.f10172a + this.f10174c), elements);
        return true;
    }
}
