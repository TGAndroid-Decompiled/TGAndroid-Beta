...
public final class e extends AbstractList implements List {
    ...
    public int f10191a;
    public Object[] f10192b = d;
    public int f10193c;

    @Override
    public final void add(int i10, Object obj) {
        int i11;
        int i12 = this.f10193c;
        if (i10 < 0 || i10 > i12) {
        ...
        if (i10 == i12) {
            ...
            s();
            n(this.f10193c + 1);
            int r10 = r(this.f10191a + i10);
            int i13 = this.f10193c;
            if (i10 < ((i13 + 1) >> 1)) {
                if (r10 == 0) {
    ...
    public final boolean addAll(int i10, Collection elements) {
        ...
        if (i10 >= 0 && i10 <= i11) {
            ...
            s();
            n(elements.size() + this.f10193c);
            int r10 = r(this.f10191a + this.f10193c);
            int r11 = r(this.f10191a + i10);
            int size = elements.size();
            if (i10 < ((this.f10193c + 1) >> 1)) {
                ...
                if (r11 < i12) {
                    ...
                    if (length >= i14) {
                        ...
                        Object[] objArr7 = this.f10192b;
                        f.c(0, this.f10191a + length, r11, objArr7, objArr7);
                    }
                }
                this.f10191a = i13;
            ...
            if (r11 < r10) {
                ...
                if (i16 <= objArr8.length) {
                    ...
                    Object[] objArr9 = this.f10192b;
                    f.c(i15, r11, length2, objArr9, objArr9);
                }
            } else {
                Object[] objArr10 = this.f10192b;
                f.c(size, 0, r10, objArr10, objArr10);
                Object[] objArr11 = this.f10192b;
    ...
    public final void addLast(Object obj) {
        s();
        n(this.f10193c + 1);
        this.f10192b[r(this.f10191a + this.f10193c)] = obj;
        this.f10193c++;
    }
    ...
    public final void clear() {
        if (!isEmpty()) {
            s();
            q(this.f10191a, r(this.f10191a + this.f10193c));
        }
        this.f10191a = 0;
        this.f10193c = 0;
    }
    ...
    public final Object get(int i10) {
        int i11 = this.f10193c;
        if (i10 >= 0 && i10 < i11) {
            return this.f10192b[r(this.f10191a + i10)];
        }
        throw new IndexOutOfBoundsException(a4.a.l(i10, i11, "index: ", ", size: "));
    }
    ...
    public final void i(int i10, Collection collection) {
        ...
        int length = this.f10192b.length;
        while (i10 < length && it.hasNext()) {
            this.f10192b[i10] = it.next();
            i10++;
        }
        int i11 = this.f10191a;
        for (int i12 = 0; i12 < i11 && it.hasNext(); i12++) {
            this.f10192b[i12] = it.next();
        }
        this.f10193c = collection.size() + this.f10193c;
    }
    ...
    public final int indexOf(Object obj) {
        ...
        if (i11 < r10) {
            while (i11 < r10) {
                if (kotlin.jvm.internal.i.a(obj, this.f10192b[i11])) {
                    i10 = this.f10191a;
                } else {
                    i11++;
                }
            ...
            while (true) {
                if (i11 < length) {
                    ...
                    for (int i12 = 0; i12 < r10; i12++) {
                        if (kotlin.jvm.internal.i.a(obj, this.f10192b[i12])) {
                            i11 = i12 + this.f10192b.length;
                            i10 = this.f10191a;
                        }
                    }
                    return -1;
    ...
    public final int lastIndexOf(Object obj) {
        ...
        if (i11 < r10) {
            length = r10 - 1;
            if (i11 <= length) {
                while (!kotlin.jvm.internal.i.a(obj, this.f10192b[length])) {
                    if (length != i11) {
                        length--;
                    }
                }
        ...
        if (i11 > r10) {
            ...
            while (true) {
                if (-1 < i12) {
                    if (kotlin.jvm.internal.i.a(obj, this.f10192b[i12])) {
                        length = i12 + this.f10192b.length;
                        i10 = this.f10191a;
                        break;
                    }
                    i12--;
    ...
    public final void n(int i10) {
        if (i10 >= 0) {
            ...
            f.c(0, this.f10191a, objArr.length, objArr, objArr2);
            Object[] objArr3 = this.f10192b;
    ...
    public final int p(int i10) {
        if (i10 < 0) {
            return i10 + this.f10192b.length;
        }
        return i10;
    }
    ...
    public final void q(int i10, int i11) {
        if (i10 < i11) {
            f.e(i10, i11, this.f10192b);
            return;
        }
        Object[] objArr = this.f10192b;
        f.e(i10, objArr.length, objArr);
        f.e(0, i11, this.f10192b);
    }
    ...
    public final Object remove(int i10) {
        ...
        if (i10 >= 0 && i10 < i11) {
            ...
            if (i10 < (this.f10193c >> 1)) {
                ...
                Object[] objArr3 = this.f10192b;
                int i14 = this.f10191a;
                objArr3[i14] = null;
                this.f10191a = o(i14);
            } else {
                int r11 = r(h.a(this) + this.f10191a);
                if (r10 <= r11) {
                    Object[] objArr4 = this.f10192b;
    ...
    public final boolean removeAll(Collection elements) {
        ...
        z10 = false;
        z10 = false;
        if (!isEmpty() && this.f10192b.length != 0) {
            int r11 = r(this.f10191a + this.f10193c);
            int i10 = this.f10191a;
            if (i10 < r11) {
                r10 = i10;
                while (i10 < r11) {
                    Object obj = this.f10192b[i10];
            ...
            if (z10) {
                s();
                this.f10193c = p(r10 - this.f10191a);
            }
        }
        return z10;
    }
    ...
    public final Object removeLast() {
        if (!isEmpty()) {
            s();
            int r10 = r(h.a(this) + this.f10191a);
            Object[] objArr = this.f10192b;
            Object obj = objArr[r10];
            objArr[r10] = null;
            this.f10193c--;
    ...
    public final void removeRange(int i10, int i11) {
        ...
        if (i12 == this.f10193c) {
            ...
            s();
            if (i10 < this.f10193c - i11) {
                int r10 = r((i10 - 1) + this.f10191a);
                int r11 = r((i11 - 1) + this.f10191a);
                while (i10 > 0) {
                    int i13 = r10 + 1;
                ...
                int r12 = r(this.f10191a + i12);
                q(this.f10191a, r12);
                this.f10191a = r12;
            } else {
                int r13 = r(this.f10191a + i11);
                int r14 = r(this.f10191a + i10);
                int i16 = this.f10193c;
                while (true) {
                    i16 -= i11;
                    if (i16 <= 0) {
                        break;
                ...
                int r15 = r(this.f10191a + this.f10193c);
                q(p(r15 - i12), r15);
            }
            this.f10193c -= i12;
        }
    ...
    public final Object[] toArray() {
        return toArray(new Object[this.f10193c]);
    }
    ...
    public final Object[] toArray(Object[] array) {
        ...
        int i11 = this.f10191a;
        if (i11 < r10) {
            f.d(i11, r10, 2, this.f10192b, array);
        } else if (!isEmpty()) {
            Object[] objArr = this.f10192b;
            f.c(0, this.f10191a, objArr.length, objArr, array);
            Object[] objArr2 = this.f10192b;
            f.c(objArr2.length - this.f10191a, 0, r10, objArr2, array);
        }
        int i12 = this.f10193c;
        if (i12 < array.length) {
            array[i12] = null;
    ...
    public final boolean addAll(Collection elements) {
        ...
        s();
        n(elements.size() + this.f10193c);
        i(r(this.f10191a + this.f10193c), elements);
        return true;
    }
}
