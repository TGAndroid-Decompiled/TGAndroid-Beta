...
public final class e extends AbstractList implements List {
    ...
    public final void add(int i10, Object obj) {
        ...
        if (i10 == i12) {
            ...
            s();
            n(this.f9306c + 1);
            int r10 = r(this.f9304a + i10);
            int i13 = this.f9306c;
            if (i10 < ((i13 + 1) >> 1)) {
                if (r10 == 0) {
                    Object[] objArr = this.f9305b;
                ...
                int r11 = r(this.f9304a + i13);
                if (r10 < r11) {
                    Object[] objArr6 = this.f9305b;
                    f.c(r10 + 1, r10, r11, objArr6, objArr6);
                } else {
                    Object[] objArr7 = this.f9305b;
                    f.c(1, 0, r11, objArr7, objArr7);
                    Object[] objArr8 = this.f9305b;
    ...
    public final boolean addAll(int i10, Collection elements) {
        ...
        if (i10 >= 0 && i10 <= i11) {
            ...
            s();
            n(elements.size() + this.f9306c);
            int r10 = r(this.f9304a + this.f9306c);
            int r11 = r(this.f9304a + i10);
            int size = elements.size();
            if (i10 < ((this.f9306c + 1) >> 1)) {
                int i12 = this.f9304a;
                int i13 = i12 - size;
                if (r11 < i12) {
                    Object[] objArr = this.f9305b;
                    ...
                    if (length >= i14) {
                        ...
                        Object[] objArr7 = this.f9305b;
                        f.c(0, this.f9304a + length, r11, objArr7, objArr7);
                    }
                }
                this.f9304a = i13;
            ...
            if (r11 < r10) {
                ...
                if (i16 <= objArr8.length) {
                    ...
                    Object[] objArr9 = this.f9305b;
                    f.c(i15, r11, length2, objArr9, objArr9);
                }
            } else {
                Object[] objArr10 = this.f9305b;
                f.c(size, 0, r10, objArr10, objArr10);
                Object[] objArr11 = this.f9305b;
    ...
    public final void addLast(Object obj) {
        s();
        n(this.f9306c + 1);
        this.f9305b[r(this.f9304a + this.f9306c)] = obj;
        this.f9306c++;
    }
    ...
    public final void clear() {
        if (!isEmpty()) {
            s();
            q(this.f9304a, r(this.f9304a + this.f9306c));
        }
        this.f9304a = 0;
        this.f9306c = 0;
    }
    ...
    public final Object get(int i10) {
        int i11 = this.f9306c;
        if (i10 >= 0 && i10 < i11) {
            return this.f9305b[r(this.f9304a + i10)];
        }
        throw new IndexOutOfBoundsException(a4.a.l(i10, i11, "index: ", ", size: "));
    }
    ...
    public final void i(int i10, Collection collection) {
        ...
        int length = this.f9305b.length;
        while (i10 < length && it.hasNext()) {
            this.f9305b[i10] = it.next();
            i10++;
        }
        int i11 = this.f9304a;
        for (int i12 = 0; i12 < i11 && it.hasNext(); i12++) {
            this.f9305b[i12] = it.next();
        }
        this.f9306c = collection.size() + this.f9306c;
    }
    ...
    public final int indexOf(Object obj) {
        ...
        if (i11 < r10) {
            while (i11 < r10) {
                if (kotlin.jvm.internal.i.a(obj, this.f9305b[i11])) {
                    i10 = this.f9304a;
                } else {
                    i11++;
                }
            ...
            while (true) {
                if (i11 < length) {
                    ...
                    for (int i12 = 0; i12 < r10; i12++) {
                        if (kotlin.jvm.internal.i.a(obj, this.f9305b[i12])) {
                            i11 = i12 + this.f9305b.length;
                            i10 = this.f9304a;
                        }
                    }
                    return -1;
    ...
    public final int lastIndexOf(Object obj) {
        ...
        if (i11 < r10) {
            length = r10 - 1;
            if (i11 <= length) {
                while (!kotlin.jvm.internal.i.a(obj, this.f9305b[length])) {
                    if (length != i11) {
                        length--;
                    }
                }
    ...
    public final void n(int i10) {
        if (i10 >= 0) {
            ...
            f.c(0, this.f9304a, objArr.length, objArr, objArr2);
            Object[] objArr3 = this.f9305b;
    ...
    public final void q(int i10, int i11) {
        if (i10 < i11) {
            f.e(i10, i11, this.f9305b);
            return;
        }
        Object[] objArr = this.f9305b;
        f.e(i10, objArr.length, objArr);
        f.e(0, i11, this.f9305b);
    }
    ...
    public final Object remove(int i10) {
        ...
        if (i10 >= 0 && i10 < i11) {
            ...
            if (i10 < (this.f9306c >> 1)) {
                ...
                int r11 = r(h.a(this) + this.f9304a);
                if (r10 <= r11) {
                    Object[] objArr4 = this.f9305b;
    ...
    public final boolean removeAll(Collection elements) {
        ...
        z10 = false;
        z10 = false;
        if (!isEmpty() && this.f9305b.length != 0) {
            int r11 = r(this.f9304a + this.f9306c);
            int i10 = this.f9304a;
            if (i10 < r11) {
                r10 = i10;
                while (i10 < r11) {
                    Object obj = this.f9305b[i10];
    ...
    public final Object removeLast() {
        if (!isEmpty()) {
            s();
            int r10 = r(h.a(this) + this.f9304a);
            Object[] objArr = this.f9305b;
            Object obj = objArr[r10];
            objArr[r10] = null;
            this.f9306c--;
    ...
    public final void removeRange(int i10, int i11) {
        ...
        if (i12 == this.f9306c) {
            ...
            s();
            if (i10 < this.f9306c - i11) {
                int r10 = r((i10 - 1) + this.f9304a);
                int r11 = r((i11 - 1) + this.f9304a);
                while (i10 > 0) {
                    int i13 = r10 + 1;
                ...
                int r12 = r(this.f9304a + i12);
                q(this.f9304a, r12);
                this.f9304a = r12;
            } else {
                int r13 = r(this.f9304a + i11);
                int r14 = r(this.f9304a + i10);
                int i16 = this.f9306c;
                while (true) {
                    i16 -= i11;
                    if (i16 <= 0) {
                ...
                int r15 = r(this.f9304a + this.f9306c);
                q(p(r15 - i12), r15);
            }
            this.f9306c -= i12;
        }
    ...
    public final Object[] toArray() {
        return toArray(new Object[this.f9306c]);
    }
    ...
    public final Object[] toArray(Object[] array) {
        ...
        int i11 = this.f9304a;
        if (i11 < r10) {
            f.d(i11, r10, 2, this.f9305b, array);
        } else if (!isEmpty()) {
            Object[] objArr = this.f9305b;
            f.c(0, this.f9304a, objArr.length, objArr, array);
            Object[] objArr2 = this.f9305b;
            f.c(objArr2.length - this.f9304a, 0, r10, objArr2, array);
        }
        int i12 = this.f9306c;
        if (i12 < array.length) {
            array[i12] = null;
    ...
    public final boolean addAll(Collection elements) {
        ...
        s();
        n(elements.size() + this.f9306c);
        i(r(this.f9304a + this.f9306c), elements);
        return true;
    }
}
