        ...
        switch (this.f198a) {
            case 0:
                ...
                if (R.getFragmentView() instanceof pv0) {
                    h3Var.f38540b = (pv0) R.getFragmentView();
                }
                Activity parentActivity = R.getParentActivity();
                LinearLayout h = l.d.h(parentActivity, 1);
                TextView textView = new TextView(parentActivity);
                textView.setText("Saturation " + (l5.f38538c * 5.0f));
                int i16 = k6.f21840n5;
                ...
                ko0Var2.setDelegate(new k5(h3Var, textView2, 1));
                ...
                ko0Var3.setDelegate(new org.telegram.ui.h(h3Var, 5));
