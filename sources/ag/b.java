...
public final class b extends Drawable {
    public static SvgHelper.SvgDrawable f174j;
    public static final int[] f175k = {7322096, 16766590, 13338331, 9367192, 16749490, 16478047};
    public static final SparseArray f176l;
    public final SvgHelper.SvgDrawable f177a;
    public LinearGradient f178b;
    public int e;
    public final Paint f180f;
    public final Paint f181g;
    public int[] h;
    public final Matrix f179c = new Matrix();
    ...
    public b(int i10) {
        if (f174j == null) {
            f174j = SvgHelper.getDrawable(R.raw.topic_bubble, -1);
        }
        SvgHelper.SvgDrawable clone = f174j.clone();
        this.f177a = clone;
    ...
    public final void b(int i10) {
        ...
        int[] iArr3 = (int[]) f176l.get(iArr2[this.e]);
        if (j6.I.q()) {
        ...
        this.f178b = linearGradient;
        linearGradient.setLocalMatrix(this.f179c);
        paint.setShader(this.f178b);
        this.f177a.setPaint(paint, 0);
        this.f181g.setColor(i0.a.d(0.1f, iArr[1], -1));
        this.f180f.setColor(i0.a.d(0.1f, iArr[0], -16777216));
    }

    @Override
    public final void draw(Canvas canvas) {
        Matrix matrix = this.f179c;
        matrix.reset();
        matrix.setScale(1.0f, getBounds().height() / 100.0f);
        this.f178b.setLocalMatrix(matrix);
        Rect bounds = getBounds();
        SvgHelper.SvgDrawable svgDrawable = this.f177a;
