...
public final class b extends Drawable {
    public static SvgHelper.SvgDrawable f186j;
    public static final int[] f187k = {7322096, 16766590, 13338331, 9367192, 16749490, 16478047};
    public static final SparseArray f188l;
    public final SvgHelper.SvgDrawable f189a;
    public LinearGradient f190b;
    public int e;
    public final Paint f192f;
    public final Paint f193g;
    public int[] h;
    public final Matrix f191c = new Matrix();
    ...
    public b(int i10) {
        if (f186j == null) {
            f186j = SvgHelper.getDrawable(R.raw.topic_bubble, -1);
        }
        SvgHelper.SvgDrawable clone = f186j.clone();
        this.f189a = clone;
    ...
    public final void b(int i10) {
        ...
        int[] iArr3 = (int[]) f188l.get(iArr2[this.e]);
        if (j6.I.q()) {
        ...
        this.f190b = linearGradient;
        linearGradient.setLocalMatrix(this.f191c);
        paint.setShader(this.f190b);
        this.f189a.setPaint(paint, 0);
        this.f193g.setColor(i0.a.d(0.1f, iArr[1], -1));
        this.f192f.setColor(i0.a.d(0.1f, iArr[0], -16777216));
    }

    @Override
    public final void draw(Canvas canvas) {
        Matrix matrix = this.f191c;
        matrix.reset();
        matrix.setScale(1.0f, getBounds().height() / 100.0f);
        this.f190b.setLocalMatrix(matrix);
        Rect bounds = getBounds();
        SvgHelper.SvgDrawable svgDrawable = this.f189a;
