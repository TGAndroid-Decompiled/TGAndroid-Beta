...
public final class b {
    public static volatile b f9652j;
    public final byte[] f9653a;
    public final boolean f9654b;
    public final ByteBuffer f9655c;
    public final String d;
    public final String e;
    public final HashMap f9656f;
    ...
    public b() {
        ...
        try {
            ...
            this.f9656f = new HashMap(255);
            this.f9657g = new HashMap(255);
            this.h = new HashMap(10);
            this.f9658i = new HashMap(255);
            int f7 = f(0);
            int i10 = 4;
            int i11 = (f7 * 12) + 4;
            for (int i12 = 0; i12 < f7; i12++) {
                ...
                this.f9658i.put(g11, g10);
                this.f9656f.put(g10, Integer.valueOf(f10));
                ArrayList arrayList = (ArrayList) this.f9657g.get(g10);
                if (arrayList == null) {
                    arrayList = new ArrayList();
                    this.f9657g.put(g10, arrayList);
                }
                arrayList.add(g11);
            }
            String str = this.e;
    ...
    public final a a(String str) {
        ...
        if (aVar == null && (num = (Integer) bVar.f9656f.get(str)) != null) {
            int intValue = num.intValue();
            ?? obj = new Object();
            new ArrayList();
            obj.f9649a = "";
            obj.f9650b = new ArrayList();
            obj.f9651c = new ArrayList();
            obj.d = new ArrayList();
            obj.f9649a = str;
            ArrayList arrayList = (ArrayList) bVar.f9657g.get(str);
            bVar.h.put(str, obj);
            ...
            while (i14 < e10) {
                ?? obj2 = new Object();
                obj2.f9664b = new ArrayList();
                obj2.f9663a = bVar.e(i13);
                ...
                while (i15 < e11) {
                    ?? obj3 = new Object();
                    obj3.f9659a = bVar.f(i13);
                    obj3.f9660b = bVar.f(i13 + 4);
                    byte[] bArr = bVar.f9653a;
                    byte b10 = bArr[i13 + 8];
                    obj3.f9661c = bArr[i13 + 9];
                    ...
                    if (indexOf != -1) {
                        obj3.e = p6.t(obj3.e.substring(0, indexOf), obj3.e.substring(obj3.e.indexOf("]]") + 2));
                    }
                    arrayList5.add(obj3);
                    i15++;
                    bVar = this;
                }
                obj2.f9664b = arrayList5;
                arrayList4.add(obj2);
                i14++;
                bVar = this;
            }
    ...
    public final short e(int i10) {
        if (i10 + 2 <= this.f9653a.length) {
            this.f9655c.position(i10);
            return this.f9655c.getShort();
        }
        return (short) 0;
    }

    public final int f(int i10) {
        if (i10 + 4 <= this.f9653a.length) {
            this.f9655c.position(i10);
            return this.f9655c.getInt();
        }
        return 0;
    }
