...
public final class b {
    public static volatile b f10629j;
    public final byte[] f10630a;
    public final boolean f10631b;
    public final ByteBuffer f10632c;
    public final String d;
    public final String f10633e;
    public final HashMap f10634f;
    public final HashMap f10635g;
    public final HashMap h;
    public final HashMap f10636i;
    ...
    public b() {
        ...
        try {
            ...
            this.f10634f = new HashMap(255);
            this.f10635g = new HashMap(255);
            this.h = new HashMap(10);
            this.f10636i = new HashMap(255);
            int f7 = f(0);
            int i10 = 4;
            int i11 = (f7 * 12) + 4;
            for (int i12 = 0; i12 < f7; i12++) {
                ...
                this.f10636i.put(g11, g10);
                this.f10634f.put(g10, Integer.valueOf(f10));
                ArrayList arrayList = (ArrayList) this.f10635g.get(g10);
                if (arrayList == null) {
                    arrayList = new ArrayList();
                    this.f10635g.put(g10, arrayList);
                }
                arrayList.add(g11);
            }
    ...
    public final a a(String str) {
        ...
        if (aVar == null && (num = (Integer) bVar.f10634f.get(str)) != null) {
            int intValue = num.intValue();
            ?? obj = new Object();
            new ArrayList();
            obj.f10626a = "";
            obj.f10627b = new ArrayList();
            obj.f10628c = new ArrayList();
            obj.d = new ArrayList();
            obj.f10626a = str;
            ArrayList arrayList = (ArrayList) bVar.f10635g.get(str);
            bVar.h.put(str, obj);
            ...
            while (i14 < e11) {
                ?? obj2 = new Object();
                obj2.f10643b = new ArrayList();
                obj2.f10642a = bVar.e(i13);
                ...
                while (i15 < e12) {
                    ?? obj3 = new Object();
                    obj3.f10637a = bVar.f(i13);
                    obj3.f10638b = bVar.f(i13 + 4);
                    byte[] bArr = bVar.f10630a;
                    byte b10 = bArr[i13 + 8];
                    obj3.f10639c = bArr[i13 + 9];
                    ...
                    if (indexOf != -1) {
                        obj3.f10640e = p6.t(obj3.f10640e.substring(0, indexOf), obj3.f10640e.substring(obj3.f10640e.indexOf("]]") + 2));
                    }
                    arrayList5.add(obj3);
                    i15++;
                    bVar = this;
                }
                obj2.f10643b = arrayList5;
                arrayList4.add(obj2);
                i14++;
                bVar = this;
            }
        ...
        if (this.f10631b) {
            try {
                ...
                if (sb3.startsWith("+")) {
                    ...
                    a a2 = a(this.f10633e);
                    if (a2 != null) {
                        ArrayList arrayList = a2.f10628c;
    ...
    public final short e(int i10) {
        if (i10 + 2 <= this.f10630a.length) {
            this.f10632c.position(i10);
            return this.f10632c.getShort();
        }
        return (short) 0;
    }

    public final int f(int i10) {
        if (i10 + 4 <= this.f10630a.length) {
            this.f10632c.position(i10);
            return this.f10632c.getInt();
        }
        return 0;
    }
