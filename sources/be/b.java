...
public class b {
    ...
    public final h b(long j3) {
        ...
        if (hVar.f8182c > ((h) obj2).f8182c) {
            obj2 = hVar;
        }
        h hVar2 = (h) f3505g.get(this);
        int i10 = (hVar2.f8182c > ((h) obj2).f8182c ? 1 : (hVar2.f8182c == ((h) obj2).f8182c ? 0 : -1));
        h hVar3 = obj2;
        if (i10 > 0) {
            hVar3 = hVar2;
        }
        ...
        loop0: while (true) {
            dVar.getClass();
            AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = ee.d.f8160a;
        ...
        loop2: while (hVar5 != null) {
            ...
            obj = obj;
            while (-1 < i11) {
                if ((hVar5.f8182c * d.f3511b) + i11 < j3) {
                    break loop2;
                }
                while (true) {
            ...
            hVar5 = (h) ((ee.d) ee.d.f8161b.get(hVar5));
            obj = obj;
        }
        if (obj != null) {
