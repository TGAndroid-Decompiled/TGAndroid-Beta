...
public final class h extends t {
    public final b f2620e;
    public final AtomicReferenceArray f2621f;

    public h(long j3, h hVar, b bVar, int i10) {
        super(j3, hVar, i10);
        this.f2620e = bVar;
        this.f2621f = new AtomicReferenceArray(d.f2603b * 2);
    }
    ...
    public final boolean k(int i10, Object obj, Object obj2) {
        ...
        int i11 = (i10 * 2) + 1;
        do {
            atomicReferenceArray = this.f2621f;
    ...
    public final Object l(int i10) {
        return this.f2621f.get((i10 * 2) + 1);
    }
    ...
    public final void m(int i10, boolean z10) {
        if (z10) {
            ...
            bVar.q((this.f9092c * d.f2603b) + i10);
        }
        i();
    }

    public final void n(int i10, k kVar) {
        this.f2621f.set(i10 * 2, kVar);
    }

    public final void o(int i10, Object obj) {
        this.f2621f.set((i10 * 2) + 1, obj);
    }
}
