...
public class RotateBox extends Box {
    ...
    private static Point2D.Float calculateShift(Box box, int i10) {
        ...
        switch (i10) {
            case 0:
                r02.f45696x = 0.0f;
                r02.f45697y = -box.depth;
                return r02;
            case 1:
                r02.f45696x = box.width / 2.0f;
                r02.f45697y = -box.depth;
                return r02;
            case 2:
                r02.f45696x = box.width;
                r02.f45697y = -box.depth;
                return r02;
            case 3:
                r02.f45696x = 0.0f;
                r02.f45697y = box.height;
                return r02;
            case 4:
                r02.f45696x = box.width / 2.0f;
                r02.f45697y = box.height;
            ...
            case 9:
                r02.f45696x = 0.0f;
                r02.f45697y = (box.height - box.depth) / 2.0f;
                return r02;
            case 10:
                r02.f45696x = box.width / 2.0f;
                r02.f45697y = (box.height - box.depth) / 2.0f;
    ...
    public RotateBox(Box box, double d, Point2D.Float r10) {
        this(box, d, r10.f45696x, r10.f45697y);
    }
