    ...
    public Box createBox(TeXEnvironment teXEnvironment) {
        ...
        if (this.vtop) {
            if (verticalBox.getSize() != 0) {
                f7 = verticalBox.children.getFirst().getHeight();
            }
            verticalBox.setHeight(f7);
            verticalBox.setDepth((verticalBox.getHeight() + verticalBox.getDepth()) - f7);
            return verticalBox;
        }
        if (verticalBox.getSize() != 0) {
            f7 = verticalBox.children.getLast().getDepth();
        }
        verticalBox.setHeight((verticalBox.getHeight() + verticalBox.getDepth()) - f7);
        verticalBox.setDepth(f7);
        return verticalBox;
    }
