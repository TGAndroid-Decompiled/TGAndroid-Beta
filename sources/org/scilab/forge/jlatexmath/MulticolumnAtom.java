...
public class MulticolumnAtom extends Atom {
    ...
    protected int col;
    protected Atom cols;
    protected int f15584n;
    protected int row;
    protected float f15585w = 0.0f;

    public MulticolumnAtom(int i10, String str, Atom atom) {
        this.f15584n = i10 < 1 ? 1 : i10;
        this.cols = atom;
    ...
    public Box createBox(TeXEnvironment teXEnvironment) {
        ...
        if (this.f15585w == 0.0f) {
            ...
            horizontalBox = new HorizontalBox(this.cols.createBox(teXEnvironment), this.f15585w, this.align);
        }
