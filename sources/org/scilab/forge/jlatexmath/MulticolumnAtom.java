...
public class MulticolumnAtom extends Atom {
    ...
    protected int col;
    protected Atom cols;
    protected int f15572n;
    protected int row;
    protected float f15573w = 0.0f;

    public MulticolumnAtom(int i10, String str, Atom atom) {
        this.f15572n = i10 < 1 ? 1 : i10;
        this.cols = atom;
    ...
    public Box createBox(TeXEnvironment teXEnvironment) {
        ...
        if (this.f15573w == 0.0f) {
            ...
            horizontalBox = new HorizontalBox(this.cols.createBox(teXEnvironment), this.f15573w, this.align);
        }
