...
public class MulticolumnAtom extends Atom {
    ...
    protected int col;
    protected Atom cols;
    protected int f17078n;
    protected int row;
    protected float f17079w = 0.0f;

    public MulticolumnAtom(int i10, String str, Atom atom) {
        this.f17078n = i10 < 1 ? 1 : i10;
        this.cols = atom;
    ...
    public Box createBox(TeXEnvironment teXEnvironment) {
        ...
        if (this.f17079w == 0.0f) {
            ...
            horizontalBox = new HorizontalBox(this.cols.createBox(teXEnvironment), this.f17079w, this.align);
        }
