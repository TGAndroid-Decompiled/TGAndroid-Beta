...
public class RotateAtom extends Atom {
    ...
    private Atom base;
    private int option;
    private float f15767x;
    private int xunit;
    private float f15768y;
    private int yunit;
    ...
    public Box createBox(TeXEnvironment teXEnvironment) {
        ...
        return new RotateBox(this.base.createBox(teXEnvironment), this.angle, SpaceAtom.getFactor(this.xunit, teXEnvironment) * this.f15767x, SpaceAtom.getFactor(this.yunit, teXEnvironment) * this.f15768y);
    }
