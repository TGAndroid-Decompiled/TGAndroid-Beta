...
public class RotateAtom extends Atom {
    ...
    public Box createBox(TeXEnvironment teXEnvironment) {
        ...
        return new RotateBox(this.base.createBox(teXEnvironment), this.angle, SpaceAtom.getFactor(this.xunit, teXEnvironment) * this.f16626x, SpaceAtom.getFactor(this.yunit, teXEnvironment) * this.f16627y);
    }
