...
public class RotateAtom extends Atom {
    ...
    private Atom base;
    private int option;
    private float f18034x;
    private int xunit;
    private float f18035y;
    private int yunit;
    ...
    public Box createBox(TeXEnvironment teXEnvironment) {
        ...
        return new RotateBox(this.base.createBox(teXEnvironment), this.angle, SpaceAtom.getFactor(this.xunit, teXEnvironment) * this.f18034x, SpaceAtom.getFactor(this.yunit, teXEnvironment) * this.f18035y);
    }
