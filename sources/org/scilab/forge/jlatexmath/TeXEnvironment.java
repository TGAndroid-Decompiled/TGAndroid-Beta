...
public class TeXEnvironment {
    ...
    public TeXEnvironment copy() {
        int i10 = this.depth;
        if (i10 <= 64) {
            return new TeXEnvironment(this.style, this.scaleFactor, this.f15814tf, this.background, this.color, this.textStyle, this.smallCap, i10 + 1);
        }
    ...
    public int getLastFontId() {
        ...
        if (i10 == -1) {
            return this.f15814tf.getMuFontId();
        }
        return i10;
    }
    ...
    public float getSpace() {
        return this.f15814tf.getScaleFactor() * this.f15814tf.getSpace(this.style);
    }
