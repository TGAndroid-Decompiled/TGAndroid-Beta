...
public class CharBox extends Box {
    ...
    private final CharFont f17042cf;
    private float italic;
    private final float size;

    public CharBox(Char r22) {
        this.f17042cf = r22.getCharFont();
    ...
    public void draw(Graphics2D graphics2D, float f7, float f10) {
        ...
        Font font = FontInfo.getFont(this.f17042cf.fontId);
    ...
    public int getLastFontId() {
        return this.f17042cf.fontId;
    }

    public String toString() {
        return super.toString() + "=" + this.f17042cf.f17043c;
    }
}
