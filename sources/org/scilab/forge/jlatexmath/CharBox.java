...
public class CharBox extends Box {
    ...
    private final CharFont f15563cf;
    private float italic;
    private final float size;

    public CharBox(Char r22) {
        this.f15563cf = r22.getCharFont();
    ...
    public void draw(Graphics2D graphics2D, float f7, float f10) {
        ...
        Font font = FontInfo.getFont(this.f15563cf.fontId);
    ...
    public int getLastFontId() {
        return this.f15563cf.fontId;
    }

    public String toString() {
        return super.toString() + "=" + this.f15563cf.f15564c;
    }
}
