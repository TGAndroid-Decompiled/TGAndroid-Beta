...
public class CharBox extends Box {
    ...
    private final CharFont f16631cf;
    private float italic;
    private final float size;

    public CharBox(Char r22) {
        this.f16631cf = r22.getCharFont();
    ...
    public void draw(Graphics2D graphics2D, float f10, float f11) {
        ...
        Font font = FontInfo.getFont(this.f16631cf.fontId);
    ...
    public int getLastFontId() {
        return this.f16631cf.fontId;
    }

    public String toString() {
        return super.toString() + "=" + this.f16631cf.f16632c;
    }
}
