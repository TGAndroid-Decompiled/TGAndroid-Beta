...
public class CharBox extends Box {
    ...
    private final CharFont f18019cf;
    private float italic;
    private final float size;

    public CharBox(Char r22) {
        this.f18019cf = r22.getCharFont();
    ...
    public void draw(Graphics2D graphics2D, float f10, float f11) {
        ...
        Font font = FontInfo.getFont(this.f18019cf.fontId);
    ...
    public int getLastFontId() {
        return this.f18019cf.fontId;
    }

    public String toString() {
        return super.toString() + "=" + this.f18019cf.f18020c;
    }
}
