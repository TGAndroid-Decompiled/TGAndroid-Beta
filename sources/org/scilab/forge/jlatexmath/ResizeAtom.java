...
public class ResizeAtom extends Atom {
    ...
    public Box createBox(TeXEnvironment teXEnvironment) {
        ...
        if (i10 != -1 && this.hunit != -1) {
            double factor2 = (SpaceAtom.getFactor(i10, teXEnvironment) * this.f18031w) / createBox.width;
            ...
            if (i10 != -1 && this.hunit == -1) {
                factor = SpaceAtom.getFactor(i10, teXEnvironment) * this.f18031w;
                f10 = createBox.width;
            } else {
