...
public class RuleAtom extends Atom {
    ...
    private float h;
    private int hunit;
    private float f15801r;
    private int runit;
    private float f15802w;
    private int wunit;
    ...
    public Box createBox(TeXEnvironment teXEnvironment) {
        float factor = SpaceAtom.getFactor(this.wunit, teXEnvironment) * this.f15802w;
        float factor2 = SpaceAtom.getFactor(this.hunit, teXEnvironment) * this.h;
        float factor3 = SpaceAtom.getFactor(this.runit, teXEnvironment) * this.f15801r;
