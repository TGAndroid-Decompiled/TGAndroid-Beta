...
public class JavaAudioDeviceModule implements AudioDeviceModule {
    ...
    public void setMicrophoneMute(boolean z4) {
        Logging.d("JavaAudioDeviceModule", "setMicrophoneMute: " + z4);
        this.audioInput.setMicrophoneMute(z4);
    }

    @Override
    public boolean setNoiseSuppressorEnabled(boolean z4) {
        Logging.d("JavaAudioDeviceModule", "setNoiseSuppressorEnabled: " + z4);
    ...
    public void setSpeakerMute(boolean z4) {
        Logging.d("JavaAudioDeviceModule", "setSpeakerMute: " + z4);
