...
public class C0832PhoneFormat {
    private static volatile C0832PhoneFormat Instance;
    ...
    public static C0832PhoneFormat getInstance() {
        C0832PhoneFormat phoneFormat = Instance;
        if (phoneFormat == null) {
            synchronized (C0832PhoneFormat.class) {
                phoneFormat = Instance;
                if (phoneFormat == null) {
                    phoneFormat = new C0832PhoneFormat();
    ...
    public java.lang.String valueString(int r5) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.PhoneFormat.C0832PhoneFormat.valueString(int):java.lang.String");
    }
    ...
    public CallingCodeInfo callingCodeInfo(String str) {
        ...
        int i;
        byte[] bArr;
        C0832PhoneFormat phoneFormat = this;
