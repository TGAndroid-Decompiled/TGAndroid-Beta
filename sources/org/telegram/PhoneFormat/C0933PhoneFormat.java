...
public class C0933PhoneFormat {
    private static volatile C0933PhoneFormat Instance;
    ...
    public static C0933PhoneFormat getInstance() {
        C0933PhoneFormat c0933PhoneFormat = Instance;
        if (c0933PhoneFormat == null) {
            synchronized (C0933PhoneFormat.class) {
                c0933PhoneFormat = Instance;
                if (c0933PhoneFormat == null) {
                    c0933PhoneFormat = new C0933PhoneFormat();
                    Instance = c0933PhoneFormat;
                }
            }
        }
        return c0933PhoneFormat;
    }
    ...
    public java.lang.String valueString(int r5) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.PhoneFormat.C0933PhoneFormat.valueString(int):java.lang.String");
    }
    ...
    public CallingCodeInfo callingCodeInfo(String str) {
        ...
        byte[] bArr;
        int i;
        C0933PhoneFormat c0933PhoneFormat = this;
        CallingCodeInfo callingCodeInfo = c0933PhoneFormat.callingCodeData.get(str);
        if (callingCodeInfo != null || (num = c0933PhoneFormat.callingCodeOffsets.get(str)) == null) {
            return callingCodeInfo;
        }
        byte[] bArr2 = c0933PhoneFormat.data;
        int intValue = num.intValue();
        CallingCodeInfo callingCodeInfo2 = new CallingCodeInfo();
        callingCodeInfo2.callingCode = str;
        c0933PhoneFormat.callingCodeCountries.get(str);
        c0933PhoneFormat.callingCodeData.put(str, callingCodeInfo2);
        short value16 = c0933PhoneFormat.value16(intValue);
        int i2 = 2;
        int i3 = intValue + 2 + 2;
        short value162 = c0933PhoneFormat.value16(i3);
        int i4 = i3 + 2 + 2;
        short value163 = c0933PhoneFormat.value16(i4);
        int i5 = i4 + 2 + 2;
        ArrayList<String> arrayList = new ArrayList<>(5);
        while (true) {
            String valueString = c0933PhoneFormat.valueString(i5);
        ...
        while (true) {
            String valueString2 = c0933PhoneFormat.valueString(i6);
        ...
        while (i9 < value163) {
            ...
            ruleSet.matchLen = c0933PhoneFormat.value16(i8);
            int i10 = i8 + i2;
            short value164 = c0933PhoneFormat.value16(i10);
            i8 = i10 + i2;
            ArrayList<PhoneRule> arrayList4 = new ArrayList<>(value164);
            int i11 = 0;
            while (i11 < value164) {
                PhoneRule phoneRule = new PhoneRule();
                phoneRule.minVal = c0933PhoneFormat.value32(i8);
                int i12 = i8 + 4;
                phoneRule.maxVal = c0933PhoneFormat.value32(i12);
                int i13 = i12 + 4;
                int i14 = i13 + 1;
                byte b = bArr2[i13];
                int i15 = i14 + 1;
                ...
                int i19 = i18 + 1;
                byte b4 = bArr2[i18];
                short value165 = c0933PhoneFormat.value16(i19);
                i8 = i19 + i2;
                String valueString3 = c0933PhoneFormat.valueString(i7 + value162 + value165);
