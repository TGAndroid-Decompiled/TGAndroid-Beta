...
public final class ub implements RequestDelegate {
    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        switch (this.f17464a) {
            case 0:
                ((MessagesController) this.f17465b).lambda$deleteDialog$142(this.f17466c, this.f17467f, this.d, this.e, this.f17468g, (TLRPC.InputPeer) this.h, tLObject, tL_error);
                return;
            case 1:
                ((MessagesController) this.f17465b).lambda$deleteMessagesRange$466(this.f17466c, this.d, this.e, this.f17467f, this.f17468g, (Runnable) this.h, tLObject, tL_error);
                return;
            default:
                VoIPGroupNotification.lambda$request$1(this.d, this.f17466c, this.f17467f, this.e, this.f17468g, (Context) this.f17465b, (String) this.h, tLObject, tL_error);
                return;
        }
    }
