...
public final class ub implements RequestDelegate {
    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        switch (this.f17453a) {
            case 0:
                ((MessagesController) this.f17454b).lambda$deleteDialog$142(this.f17455c, this.f17456f, this.d, this.e, this.f17457g, (TLRPC.InputPeer) this.h, tLObject, tL_error);
                return;
            case 1:
                ((MessagesController) this.f17454b).lambda$deleteMessagesRange$466(this.f17455c, this.d, this.e, this.f17456f, this.f17457g, (Runnable) this.h, tLObject, tL_error);
                return;
            default:
                VoIPGroupNotification.lambda$request$1(this.d, this.f17455c, this.f17456f, this.e, this.f17457g, (Context) this.f17454b, (String) this.h, tLObject, tL_error);
                return;
        }
    }
