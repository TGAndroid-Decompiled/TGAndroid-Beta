...
public final class qg implements Comparator {
    ...
    public final LongSparseIntArray f17385b;

    public qg(LongSparseIntArray longSparseIntArray, int i10) {
        this.f17384a = i10;
        this.f17385b = longSparseIntArray;
    }
    ...
    public final int compare(Object obj, Object obj2) {
        ...
        switch (this.f17384a) {
            case 0:
                lambda$checkLoadedRemoteFilters$68 = MessagesStorage.lambda$checkLoadedRemoteFilters$68(this.f17385b, l4, l10);
                return lambda$checkLoadedRemoteFilters$68;
            default:
                lambda$resetDialogs$94 = MessagesStorage.lambda$resetDialogs$94(this.f17385b, l4, l10);
