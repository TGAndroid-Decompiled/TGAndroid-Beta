...
public class GiftAuctionController extends BaseController {
    ...
    public void lambda$subscribeToGiftAuctionStateInternal$0(long j, TL_payments.TL_StarGiftAuctionState tL_StarGiftAuctionState, TLRPC.TL_error tL_error) {
    ...
    public void lambda$onGiftAuctionStateReceivedInternal$1(AuctionInternal auctionInternal, long j) {
        auctionInternal.resubscribe = null;
        subscribeToGiftAuctionStateInternal(j);
    }
    ...
    public void lambda$requestGiftAuctionInternal$2(Utilities.Callback2 callback2, TL_payments.TL_StarGiftAuctionState tL_StarGiftAuctionState, TLRPC.TL_error tL_error) {
    ...
    public void lambda$sendBid$3(Utilities.Callback2 callback2, long j, AuctionBidSheet.Params params, long j2) {
        if (StarsController.getInstance(this.currentAccount).balanceAvailable()) {
    ...
    public void lambda$sendBid$6(final Utilities.Callback2 callback2, final AuctionInternal auctionInternal, TLRPC.TL_payments_getPaymentForm tL_payments_getPaymentForm, TLRPC.PaymentForm paymentForm, TLRPC.TL_error tL_error) {
        if (tL_error != null) {
    ...
    public void lambda$sendBid$5(AuctionInternal auctionInternal, Utilities.Callback2 callback2, TLRPC.payments_PaymentResult payments_paymentresult, TLRPC.TL_error tL_error) {
        auctionInternal.pendingBid = false;
    ...
    public void lambda$sendBid$4(TLRPC.TL_payments_paymentResult tL_payments_paymentResult) {
    ...
    public void lambda$requestUserAuctions$7(TL_payments.StarGiftActiveAuctions starGiftActiveAuctions, TLRPC.TL_error tL_error) {
    ...
    public void lambda$getOrRequestAcquiredGifts$8(Utilities.Callback callback, AuctionInternal auctionInternal, TL_payments.TL_StarGiftAuctionAcquiredGifts tL_StarGiftAuctionAcquiredGifts, TLRPC.TL_error tL_error) {
    ...
    public void lambda$getOrRequestAuction$9(Utilities.Callback2 callback2, long j, TL_payments.TL_StarGiftAuctionState tL_StarGiftAuctionState, TLRPC.TL_error tL_error) {
    ...
    public static int lambda$updateActiveAuctions$10(Auction auction) {
