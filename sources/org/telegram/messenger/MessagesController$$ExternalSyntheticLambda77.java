...
public final class MessagesController$$ExternalSyntheticLambda77 implements RequestDelegate {
    ...
    public MessagesController$$ExternalSyntheticLambda77(MessagesController messagesController, long j, String str, Runnable runnable, BaseFragment baseFragment, TLRPC.TL_channels_updateUsername tL_channels_updateUsername, Runnable runnable2) {
    ...
    public MessagesController$$ExternalSyntheticLambda77(MessagesController messagesController, TLRPC.TL_inputChatPhoto tL_inputChatPhoto, TLRPC.FileLocation fileLocation, TLRPC.FileLocation fileLocation2, String str, long j, Runnable runnable) {
        this.f$0 = messagesController;
    ...
    public MessagesController$$ExternalSyntheticLambda77(TranslateController translateController, MessageObject messageObject, String str, TranslateController.MessageKey messageKey, Runnable runnable, long j, TLRPC.TL_textWithEntities tL_textWithEntities) {
