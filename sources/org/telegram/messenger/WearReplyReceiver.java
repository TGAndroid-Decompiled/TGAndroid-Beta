                    ...
                    if (DialogObject.isUserDialog(longExtra)) {
                        if (accountInstance.getMessagesController().getUser(Long.valueOf(longExtra)) == null) {
                            Utilities.globalQueue.postRunnable(new Runnable(this) {
                                public final WearReplyReceiver f17920b;
                                ...
                                public final void run() {
                                    switch (r10) {
                                        case 0:
                                            this.f17920b.lambda$onReceive$1(accountInstance, longExtra, charSequence, longExtra2, intExtra, intArrayExtra);
                                            return;
                                        default:
                                            this.f17920b.lambda$onReceive$3(accountInstance, longExtra, charSequence, longExtra2, intExtra, intArrayExtra);
                                            return;
                                    }
                                }
                            });
