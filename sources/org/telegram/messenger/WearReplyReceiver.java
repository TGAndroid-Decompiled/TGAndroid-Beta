        ...
        if (DialogObject.isUserDialog(longExtra)) {
            if (accountInstance.getMessagesController().getUser(Long.valueOf(longExtra)) == null) {
                ...
                Utilities.globalQueue.postRunnable(new Runnable(this) {
                    ...
                    public final WearReplyReceiver f21583b;
                    ...
                    public final void run() {
                        switch (i10) {
                            case 0:
                                this.f21583b.lambda$onReceive$1(accountInstance, longExtra, charSequence, longExtra2, intExtra, intArrayExtra);
                                break;
                            default:
                                this.f21583b.lambda$onReceive$3(accountInstance, longExtra, charSequence, longExtra2, intExtra, intArrayExtra);
                                break;
                        }
                    }
                });
