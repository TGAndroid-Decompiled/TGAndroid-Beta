...
public final class MessagesController$$ExternalSyntheticLambda219 implements Runnable {
    ...
    public MessagesController$$ExternalSyntheticLambda219(long j, Runnable runnable, MessagesController messagesController) {
        this.$r8$classId = 1;
    ...
    public MessagesController$$ExternalSyntheticLambda219(MessagesController messagesController, long j, Runnable runnable, int i) {
        this.$r8$classId = i;
        this.f$0 = messagesController;
        this.f$1 = j;
        this.f$2 = runnable;
