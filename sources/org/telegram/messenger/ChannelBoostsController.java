    ...
    public static void lambda$getBoostsStats$0(TLObject tLObject, e2.h hVar, TLRPC.TL_error tL_error) {
        ...
        if (tL_error != null && R != null && "CHANNEL_PRIVATE".equals(tL_error.text)) {
            ...
            if (launchActivity == null || !launchActivity.isFinishing()) {
                ...
                alertDialog$Builder.f20226a.W = true;
                alertDialog$Builder.f20226a.R = LocaleController.getString(R.string.ChannelPrivate);
                alertDialog$Builder.f20226a.T = LocaleController.getString(R.string.ChannelCantOpenPrivate2);
