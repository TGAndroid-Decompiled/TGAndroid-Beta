        ...
        switch (this.f15920a) {
            ...
            default:
                ...
                if (tLObject instanceof TLRPC.Updates) {
                    ...
                    tL_messages_getScheduledMessages.peer = MessagesController.getInstance(s5Var.f48010a).getInputPeer(j3);
                    tL_messages_getScheduledMessages.f18435id.add(Integer.valueOf(i10));
                    ConnectionsManager.getInstance(s5Var.f48010a).sendRequest(tL_messages_getScheduledMessages, new ja(s5Var, messageObject, j10, runnable, 8));
                    return;
                } else {
                    runnable.run();
                    return;
