        ...
        switch (this.f17188a) {
            ...
            default:
                ...
                if (tLObject instanceof TLRPC.Updates) {
                    ...
                    tL_messages_getScheduledMessages.peer = MessagesController.getInstance(s5Var.f52567a).getInputPeer(j3);
                    tL_messages_getScheduledMessages.f19969id.add(Integer.valueOf(i10));
                    ConnectionsManager.getInstance(s5Var.f52567a).sendRequest(tL_messages_getScheduledMessages, new ia(s5Var, messageObject, j10, runnable, 8));
                    return;
                } else {
                    runnable.run();
                    return;
