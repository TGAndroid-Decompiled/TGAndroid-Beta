...
public final class MessagesController$$ExternalSyntheticLambda120 implements Runnable {
    ...
    public MessagesController$$ExternalSyntheticLambda120(MessagesController messagesController, long j, ArrayList arrayList, int i) {
        this.$r8$classId = i;
    ...
    public MessagesController$$ExternalSyntheticLambda120(MessagesController messagesController, ArrayList arrayList, long j, int i) {
        this.$r8$classId = i;
        this.f$0 = messagesController;
        this.f$1 = arrayList;
        this.f$2 = j;
