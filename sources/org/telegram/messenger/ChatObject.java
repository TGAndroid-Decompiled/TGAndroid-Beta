...
public class ChatObject {
    ...
    public static class Call {
        ...
        private final Runnable updateCurrentSpeakingRunnable = new Runnable() {
            ...
            public void run() {
                ...
                if (z4) {
                    Call.this.currentAccount.getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.groupCallSpeakingUsersUpdated, Long.valueOf(Call.this.chatId), Long.valueOf(Call.this.call.f19169id), Boolean.FALSE);
                }
            }
        };
        ...
        public void lambda$createRtmpStreamParticipant$1() {
            this.currentAccount.getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.groupCallUpdated, Long.valueOf(this.chatId), Long.valueOf(this.call.f19169id), Boolean.FALSE);
        }
        ...
        public void lambda$loadMembers$2(boolean z4, TLObject tLObject, TL_phone.getGroupParticipants getgroupparticipants) {
        ...
        public void lambda$loadMembers$3(boolean z4, TL_phone.getGroupParticipants getgroupparticipants, TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        public int lambda$sortParticipants$12(long j10, boolean z4, TLRPC.GroupCallParticipant groupCallParticipant, TLRPC.GroupCallParticipant groupCallParticipant2) {
            boolean z10;
            int i10;
        ...
        private void loadUnknownParticipants(ArrayList<Long> arrayList, boolean z4, OnParticipantsLoad onParticipantsLoad) {
            ...
            this.currentAccount.getConnectionsManager().sendRequest(getgroupparticipants, new kf.i0(this, i11, onParticipantsLoad, arrayList, hashSet2, 4));
        }
        ...
        private void onParticipantsLoad(ArrayList<TLRPC.GroupCallParticipant> arrayList, boolean z4, String str, String str2, int i10, int i11) {
            ...
            for (int i12 = 0; i12 <= size; i12++) {
                if (i12 == size) {
                    if (z4 && groupCallParticipant3 != null && !z10) {
        ...
        private void setParticiapantsVolume() {
            ...
            if (sharedInstance != null && sharedInstance.getAccount() == this.currentAccount.getCurrentAccount() && sharedInstance.getChat() != null && sharedInstance.getChat().f19159id == (-this.chatId)) {
        ...
        public static boolean videoIsActive(TLRPC.GroupCallParticipant groupCallParticipant, boolean z4, Call call) {
            ...
            if (groupCallParticipant.self) {
                if (sharedInstance.getVideoState(z4) != 2) {
                    return false;
                }
                return true;
            }
        ...
        public void addSelfDummyParticipant(boolean z4) {
            ...
            if (this.participants.h(selfId) < 0) {
                ...
                tL_groupCallParticipant.can_self_unmute = z10;
        ...
        public void processVoiceLevelsUpdate(int[] iArr, float[] fArr, boolean[] zArr) {
            ...
            if (z15) {
                ...
                this.currentAccount.getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.groupCallSpeakingUsersUpdated, Long.valueOf(this.chatId), Long.valueOf(this.call.f19169id), Boolean.FALSE);
            }
        }
        ...
        public void sortParticipants() {
            ...
            if (this.sortedParticipants.isEmpty()) {
                ...
                groupCallParticipant = (TLRPC.GroupCallParticipant) kf.k0.i(1, this.sortedParticipants);
            }
        ...
        public void updateVisibleParticipants() {
            sortParticipants();
            this.currentAccount.getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.groupCallUpdated, Long.valueOf(this.chatId), Long.valueOf(this.call.f19169id), Boolean.FALSE, 0L);
        }
    ...
    public static boolean canDeleteTopic(int i10, TLRPC.Chat chat, long j10) {
        return (j10 == 1 || chat == null || !canDeleteTopic(i10, chat, MessagesController.getInstance(i10).getTopicsController().findTopic(chat.f19159id, j10))) ? false : true;
    }
    ...
    public static boolean hasStories(TLRPC.Chat chat) {
        if (chat != null && MessagesController.getInstance(UserConfig.selectedAccount).getStoriesController().I(-chat.f19159id)) {
            return true;
        }
        return false;
    }
    ...
    public static boolean isCollapsedInCommunity(int i10, long j10) {
        if (j10 > 0) {
            return isUserCollapsedInCommunity(i10, MessagesController.getInstance(i10).getUser(Long.valueOf(j10)));
        }
        return isChatCollapsedInCommunity(i10, MessagesController.getInstance(i10).getChat(Long.valueOf(-j10)));
    }
    ...
    public static boolean isCommunityPeerHidden(TL_communities.CommunityPeer communityPeer) {
        if (communityPeer != null && k7.w8.a(communityPeer.flags, 1) && !communityPeer.visible) {
            return true;
        }
        return false;
    }
    ...
    public static boolean isHiddenInCommunity(int i10, long j10) {
        if (j10 > 0) {
            return isHiddenInCommunity(i10, MessagesController.getInstance(i10).getUser(Long.valueOf(j10)));
        }
        return isHiddenInCommunity(i10, MessagesController.getInstance(i10).getChat(Long.valueOf(-j10)));
    }
    ...
    public static boolean isPossibleRemoveChatRestrictionsByBoosts(TLRPC.Chat chat) {
        if (chat != null) {
            return isPossibleRemoveChatRestrictionsByBoosts(MessagesController.getInstance(UserConfig.selectedAccount).getChatFull(chat.f19159id));
        }
        return false;
    }
        ...
        if (tL_forumTopic == null || tL_forumTopic.f19211id != 1) {
            if (!canUserDoAction(chat, 13)) {
                if (isMyTopic(i10, tL_forumTopic) && (message = tL_forumTopic.topMessage) != null && (message2 = tL_forumTopic.topicStartMessage) != null) {
                    int i11 = message.f19180id - message2.f19180id;
    ...
    public static boolean isIgnoredChatRestrictionsForBoosters(TLRPC.Chat chat) {
        if (chat != null) {
            return isIgnoredChatRestrictionsForBoosters(MessagesController.getInstance(UserConfig.selectedAccount).getChatFull(chat.f19159id));
        }
        return false;
    }
    ...
    public static boolean isMyTopic(int i10, TLRPC.Chat chat, long j10) {
        return chat != null && chat.forum && isMyTopic(i10, chat.f19159id, j10);
    }
    ...
    public static boolean isHiddenInCommunity(int i10, TLRPC.User user) {
        return user != null && isHiddenInCommunity(i10, user.linked_community_id, user.f19306id);
    }
    ...
    public static boolean isHiddenInCommunity(int i10, TLRPC.Chat chat) {
        return chat != null && isHiddenInCommunity(i10, chat.linked_community_id, -chat.f19159id);
    }
