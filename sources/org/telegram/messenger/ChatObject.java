...
public class ChatObject {
    ...
    public static class Call {
        ...
        public void sortParticipants() {
            ...
            if (this.sortedParticipants.isEmpty()) {
                ...
                groupCallParticipant = (TLRPC.GroupCallParticipant) l.d.i(1, this.sortedParticipants);
            }
    ...
    public static boolean isCommunityPeerHidden(TL_communities.CommunityPeer communityPeer) {
        if (communityPeer != null && k7.x8.a(communityPeer.flags, 1) && !communityPeer.visible) {
            return true;
        }
        return false;
    }
