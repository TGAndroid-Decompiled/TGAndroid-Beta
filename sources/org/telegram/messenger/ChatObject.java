...
public class ChatObject {
    ...
    public static class Call {
        ...
        private final Runnable updateCurrentSpeakingRunnable = new Runnable() {
            ...
            public void run() {
                ...
                if (z10) {
                    Call.this.currentAccount.getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.groupCallSpeakingUsersUpdated, Long.valueOf(Call.this.chatId), Long.valueOf(Call.this.call.f18122id), Boolean.FALSE);
                }
            }
        };
        ...
        public void lambda$createRtmpStreamParticipant$1() {
            this.currentAccount.getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.groupCallUpdated, Long.valueOf(this.chatId), Long.valueOf(this.call.f18122id), Boolean.FALSE);
        }
        ...
        private void setParticiapantsVolume() {
            ...
            if (sharedInstance != null && sharedInstance.getAccount() == this.currentAccount.getCurrentAccount() && sharedInstance.getChat() != null && sharedInstance.getChat().f18112id == (-this.chatId)) {
        ...
        public void processVoiceLevelsUpdate(int[] iArr, float[] fArr, boolean[] zArr) {
            ...
            if (z16) {
                ...
                this.currentAccount.getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.groupCallSpeakingUsersUpdated, Long.valueOf(this.chatId), Long.valueOf(this.call.f18122id), Boolean.FALSE);
            }
        }
        ...
        public void sortParticipants() {
            ...
            if (this.sortedParticipants.isEmpty()) {
                ...
                groupCallParticipant = (TLRPC.GroupCallParticipant) hg.k0.h(1, this.sortedParticipants);
            }
        ...
        public void updateVisibleParticipants() {
            sortParticipants();
            this.currentAccount.getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.groupCallUpdated, Long.valueOf(this.chatId), Long.valueOf(this.call.f18122id), Boolean.FALSE, 0L);
        }
    ...
    public static boolean canDeleteTopic(int i10, TLRPC.Chat chat, long j3) {
        return (j3 == 1 || chat == null || !canDeleteTopic(i10, chat, MessagesController.getInstance(i10).getTopicsController().findTopic(chat.f18112id, j3))) ? false : true;
    }
    ...
    public static boolean hasStories(TLRPC.Chat chat) {
        if (chat != null && MessagesController.getInstance(UserConfig.selectedAccount).getStoriesController().I(-chat.f18112id)) {
            return true;
        }
        return false;
    }
    ...
    public static boolean isPossibleRemoveChatRestrictionsByBoosts(TLRPC.Chat chat) {
        if (chat != null) {
            return isPossibleRemoveChatRestrictionsByBoosts(MessagesController.getInstance(UserConfig.selectedAccount).getChatFull(chat.f18112id));
        }
        return false;
    }
        ...
        if (tL_forumTopic == null || tL_forumTopic.f18164id != 1) {
            if (!canUserDoAction(chat, 13)) {
                if (isMyTopic(i10, tL_forumTopic) && (message = tL_forumTopic.topMessage) != null && (message2 = tL_forumTopic.topicStartMessage) != null) {
                    int i11 = message.f18133id - message2.f18133id;
    ...
    public static boolean isIgnoredChatRestrictionsForBoosters(TLRPC.Chat chat) {
        if (chat != null) {
            return isIgnoredChatRestrictionsForBoosters(MessagesController.getInstance(UserConfig.selectedAccount).getChatFull(chat.f18112id));
        }
        return false;
    }
    ...
    public static boolean isMyTopic(int i10, TLRPC.Chat chat, long j3) {
        return chat != null && chat.forum && isMyTopic(i10, chat.f18112id, j3);
    }
    ...
    public static boolean isHiddenInCommunity(int i10, TLRPC.User user) {
        return user != null && isHiddenInCommunity(i10, user.linked_community_id, user.f18259id);
    }
    ...
    public static boolean isHiddenInCommunity(int i10, TLRPC.Chat chat) {
        return chat != null && isHiddenInCommunity(i10, chat.linked_community_id, -chat.f18112id);
    }
