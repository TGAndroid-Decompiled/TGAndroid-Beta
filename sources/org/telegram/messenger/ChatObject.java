    ...
    public static class Call {
        ...
        private final Runnable updateCurrentSpeakingRunnable = new Runnable() {
            ...
            public void run() {
                ...
                while (i < Call.this.currentSpeakingPeers.size()) {
                    ...
                    if (uptimeMillis - Call.this.currentSpeakingPeers.get(keyAt).lastSpeakTime >= 500) {
                        ...
                        if (keyAt > 0) {
                            ...
                            sb.append(str);
                            Log.m667d("GroupCall", sb.toString());
                        } else {
                            ...
                            sb2.append(str);
                            Log.m667d("GroupCall", sb2.toString());
                        }
                        i--;
                        z = true;
                    }
                ...
                if (z) {
                    Call.this.currentAccount.getNotificationCenter().postNotificationName(NotificationCenter.groupCallSpeakingUsersUpdated, Long.valueOf(Call.this.chatId), Long.valueOf(Call.this.call.f857id), Boolean.FALSE);
                }
            }
        };
        ...
        public void lambda$createRtmpStreamParticipant$1() {
            this.currentAccount.getNotificationCenter().postNotificationName(NotificationCenter.groupCallUpdated, Long.valueOf(this.chatId), Long.valueOf(this.call.f857id), Boolean.FALSE);
        }
        ...
        public void migrateToChat(TLRPC$Chat tLRPC$Chat) {
            this.chatId = tLRPC$Chat.f843id;
            VoIPService sharedInstance = VoIPService.getSharedInstance();
            if (sharedInstance != null && sharedInstance.getAccount() == this.currentAccount.getCurrentAccount() && sharedInstance.getChat() != null && sharedInstance.getChat().f843id == (-this.chatId)) {
        ...
        private void onParticipantsLoad(ArrayList<TLRPC$TL_groupCallParticipant> arrayList, boolean z, String str, String str2, int i, int i2) {
            ...
            if (TextUtils.isEmpty(str)) {
                ...
                if (BuildVars.LOGS_ENABLED) {
                    FileLog.m33d("new participants count " + this.call.participants_count);
                }
            }
        ...
        public void processVoiceLevelsUpdate(int[] iArr, float[] fArr, boolean[] zArr) {
                    ...
                    if (fArr[i3] > 0.1f) {
                        ...
                        if (uptimeMillis - tLRPC$TL_groupCallParticipant.lastSpeakTime < 500 || this.currentSpeakingPeers.get(peerId, null) == null) {
                            ...
                            if (peerId > 0) {
                                ...
                                Log.m667d("GroupCall", sb3.toString());
                            } else {
                                ...
                                Log.m667d("GroupCall", sb4.toString());
                            }
                            z4 = true;
                        }
            ...
            if (z6) {
                ...
                this.currentAccount.getNotificationCenter().postNotificationName(NotificationCenter.groupCallSpeakingUsersUpdated, Long.valueOf(this.chatId), Long.valueOf(this.call.f857id), Boolean.FALSE);
            }
        }

        public void updateVisibleParticipants() {
            sortParticipants();
            this.currentAccount.getNotificationCenter().postNotificationName(NotificationCenter.groupCallUpdated, Long.valueOf(this.chatId), Long.valueOf(this.call.f857id), Boolean.FALSE, 0L);
        }
            ...
            if (arrayList != null && !arrayList.isEmpty()) {
                ...
                while (this.updatesQueue.size() > 0) {
                    ...
                    if (isValidUpdate == 0) {
                        ...
                        if (BuildVars.LOGS_ENABLED) {
                            FileLog.m33d("HOLE IN GROUP CALL UPDATES QUEUE - reload participants");
                        }
                        ...
                        if (BuildVars.LOGS_ENABLED) {
                            FileLog.m33d("HOLE IN GROUP CALL UPDATES QUEUE - will wait more time");
                        }
                        if (z) {
                ...
                this.updatesQueue.clear();
                if (BuildVars.LOGS_ENABLED) {
                    FileLog.m33d("GROUP CALL UPDATES QUEUE PROCEED - OK");
                }
            }
            this.updatesStartWaitTime = 0L;
        }
        ...
        public void checkQueue() {
            ...
            if (this.updatesStartWaitTime != 0 && System.currentTimeMillis() - this.updatesStartWaitTime >= 1500) {
                if (BuildVars.LOGS_ENABLED) {
                    FileLog.m33d("QUEUE GROUP CALL UPDATES WAIT TIMEOUT - CHECK QUEUE");
                }
                processUpdatesQueue();
            }
        ...
        public void lambda$loadGroupCall$10(TLObject tLObject) {
            ...
            if (tLObject != null) {
                ...
                if (i != i2) {
                    tLRPC$GroupCall.participants_count = i2;
                    if (BuildVars.LOGS_ENABLED) {
                        FileLog.m33d("new participants reload count " + this.call.participants_count);
                    }
                    this.currentAccount.getNotificationCenter().postNotificationName(NotificationCenter.groupCallUpdated, Long.valueOf(this.chatId), Long.valueOf(this.call.f857id), Boolean.FALSE);
                }
            }
        ...
        public TLRPC$TL_inputGroupCall getInputGroupCall() {
            ...
            TLRPC$GroupCall tLRPC$GroupCall = this.call;
            tLRPC$TL_inputGroupCall.f902id = tLRPC$GroupCall.f857id;
        ...
        public void sortParticipants() {
            ...
            for (int i2 = 0; i2 < size2; i2++) {
                ...
                if (videoIsActive || videoIsActive2) {
                    ...
                    } else if (tLRPC$TL_groupCallParticipant2.videoIndex == 0) {
                        if (z2) {
        ...
        public int lambda$sortParticipants$12(long j, boolean z, TLRPC$TL_groupCallParticipant tLRPC$TL_groupCallParticipant, TLRPC$TL_groupCallParticipant tLRPC$TL_groupCallParticipant2) {
            ...
            if (i4 != 0 && (i = tLRPC$TL_groupCallParticipant2.active_date) != 0) {
                return zzdp$$ExternalSyntheticBackport0.m651m(i, i4);
            }
            if (i4 != 0) {
                return -1;
            }
            ...
            if (this.call.join_date_asc) {
                return zzdp$$ExternalSyntheticBackport0.m651m(tLRPC$TL_groupCallParticipant.date, tLRPC$TL_groupCallParticipant2.date);
            }
            return zzdp$$ExternalSyntheticBackport0.m651m(tLRPC$TL_groupCallParticipant2.date, tLRPC$TL_groupCallParticipant.date);
        }
