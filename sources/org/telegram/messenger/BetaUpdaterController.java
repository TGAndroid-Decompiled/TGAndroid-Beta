...
public class BetaUpdaterController {
    ...
    public void checkForUpdate(boolean z10, Runnable runnable) {
        ...
        if (!this.checkingForUpdate) {
            ...
            new org.telegram.ui.web.k1(new v(0, this, runnable)).execute("https://telegram.org/dl/android/apk-public-beta.json");
        }
    }
    ...
    private void downloadUpdate(boolean z10) {
        ...
        if (!TextUtils.isEmpty(this.fileUrl)) {
            HttpGetFileTask overrideExtension = new HttpGetFileTask(new Utilities.Callback(this) {
                public final BetaUpdaterController f19118b;
                ...
                public final void run(Object obj) {
                    switch (r2) {
                        case 0:
                            this.f19118b.lambda$downloadUpdate$5((File) obj);
                            return;
                        default:
                            this.f19118b.lambda$downloadUpdate$6((Float) obj);
                            return;
                    }
                }
