...
public class VideoEditedInfo {
        ...
        if (this.avatarStartTime == -1 && this.filterState == null && this.paintPath == null && this.blurPath == null && (((arrayList = this.mediaEntities) == null || arrayList.isEmpty()) && this.cropState == null)) {
            ...
            if (this.filterState != null) {
                ...
                for (int i11 = 0; i11 < 4; i11++) {
                    if (i11 == 0) {
                        kf0Var = this.filterState.curvesToolValue.f25969a;
                    } else if (i11 == 1) {
                        kf0Var = this.filterState.curvesToolValue.f25970b;
                    } else if (i11 == 2) {
                        kf0Var = this.filterState.curvesToolValue.f25971c;
                    } else {
                        kf0Var = this.filterState.curvesToolValue.d;
                    }
                    serializedData.writeFloat(kf0Var.f26260a);
                    serializedData.writeFloat(kf0Var.f26261b);
                    serializedData.writeFloat(kf0Var.f26262c);
            ...
            if (rVar != null && this.collageParts != null && rVar.e.size() > 1 && !this.collageParts.isEmpty()) {
                ...
                serializedData.writeString(this.collage.f42230a);
                    ...
                    if (substring.length() > 0) {
                        ...
                        if (serializedData.readByte(false) != 0) {
                            ...
                            for (int i11 = 0; i11 < 4; i11++) {
                                ...
                                kf0Var.f26260a = serializedData.readFloat(false);
                                kf0Var.f26261b = serializedData.readFloat(false);
                                kf0Var.f26262c = serializedData.readFloat(false);
    ...
    public static class Part extends TLObject {
        ...
        public static ArrayList<ph.u6> toStoryEntries(ArrayList<Part> arrayList) {
            ...
            while (i10 < size) {
                ...
                u6Var.V = part2.left;
                u6Var.W = part2.right;
                u6Var.f42421k0 = part2.width;
                u6Var.f42423l0 = part2.height;
                u6Var.f42415h0 = part2.duration;
        ...
        public Part(ph.u6 u6Var) {
            ...
            this.left = u6Var.V;
            this.right = u6Var.W;
            this.width = u6Var.f42421k0;
            this.height = u6Var.f42423l0;
            this.duration = u6Var.f42415h0;
        }
    }
    ...
    public static class MediaEntity {
        ...
        public float width;
        public float f16693x;
        public float f16694y;
        ...
        public MediaEntity copy() {
            ...
            mediaEntity.f16693x = this.f16693x;
            mediaEntity.f16694y = this.f16694y;
        ...
        public void serializeTo(AbstractSerializedData abstractSerializedData, boolean z4) {
            ...
            abstractSerializedData.writeFloat(this.f16693x);
            abstractSerializedData.writeFloat(this.f16694y);
        ...
        public MediaEntity(AbstractSerializedData abstractSerializedData, boolean z4, boolean z10) {
            ...
            this.f16693x = abstractSerializedData.readFloat(z10);
            this.f16694y = abstractSerializedData.readFloat(z10);
            ...
            if (readString != null && !TextUtils.isEmpty(readString)) {
                ...
                for (int i11 = 0; i11 < c3.size(); i11++) {
                    ...
                    if (t0Var != null && TextUtils.equals(readString, t0Var.f2529a)) {
                        break;
                    }
                }
            }
            ...
            if (b10 == 3) {
                ...
                tLObject.f42673a = abstractSerializedData.readDouble(false);
                tLObject.f42674b = abstractSerializedData.readDouble(false);
                tLObject.f42675c = abstractSerializedData.readString(false);
