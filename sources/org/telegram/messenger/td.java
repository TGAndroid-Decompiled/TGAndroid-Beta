...
public final class td implements Runnable {
    ...
    public final void run() {
        ...
        Object obj = this.h;
        Object obj2 = this.f17609f;
        Object obj3 = this.e;
        Object obj4 = this.d;
        switch (i10) {
            case 0:
                ((MessagesController) obj4).lambda$setUserAdminRole$101((TLRPC.TL_error) obj3, (org.telegram.ui.ActionBar.n2) obj2, (TLRPC.TL_channels_editAdmin) obj, this.f17607b, this.f17608c);
                return;
            case 1:
                ((NotificationsController) obj4).lambda$processNewMessages$27((ArrayList) obj3, (ArrayList) obj2, this.f17607b, this.f17608c, (CountDownLatch) obj);
                return;
            case 2:
                ...
                if (this.f17607b) {
                    ...
                    actionBarLayout.f18596a0 = false;
                    actionBarLayout.f18632s.setScaleX(1.0f);
                    actionBarLayout.f18632s.setScaleY(1.0f);
                } else {
                    Drawable drawable = ActionBarLayout.f18592p1;
                    actionBarLayout.T(n2Var, this.f17608c);
                ...
                return;
            default:
                TwoStepVerificationActivity.a0((TwoStepVerificationActivity) obj4, (TLRPC.TL_error) obj3, (TLObject) obj2, this.f17607b, this.f17608c, (Runnable) obj);
                return;
        }
    }
