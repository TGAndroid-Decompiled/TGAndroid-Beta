...
public final class td implements Runnable {
    ...
    public final void run() {
        ...
        Object obj = this.h;
        Object obj2 = this.f19106f;
        Object obj3 = this.f19105e;
        Object obj4 = this.d;
        switch (i10) {
            case 0:
                ((MessagesController) obj4).lambda$setUserAdminRole$101((TLRPC.TL_error) obj3, (org.telegram.ui.ActionBar.n2) obj2, (TLRPC.TL_channels_editAdmin) obj, this.f19103b, this.f19104c);
                return;
            case 1:
                ((NotificationsController) obj4).lambda$processNewMessages$27((ArrayList) obj3, (ArrayList) obj2, this.f19103b, this.f19104c, (CountDownLatch) obj);
                return;
            case 2:
                ...
                if (this.f19103b) {
                    ...
                    actionBarLayout.f20165a0 = false;
                    actionBarLayout.f20202s.setScaleX(1.0f);
                    actionBarLayout.f20202s.setScaleY(1.0f);
                } else {
                    Drawable drawable = ActionBarLayout.f20161p1;
                    actionBarLayout.T(n2Var, this.f19104c);
                ...
                return;
            default:
                TwoStepVerificationActivity.a0((TwoStepVerificationActivity) obj4, (TLRPC.TL_error) obj3, (TLObject) obj2, this.f19103b, this.f19104c, (Runnable) obj);
                return;
        }
    }
    ...
    public td(ActionBarLayout actionBarLayout, boolean z10, ActionBarPopupWindow$ActionBarPopupWindowLayout actionBarPopupWindow$ActionBarPopupWindowLayout, boolean z11, org.telegram.ui.ActionBar.n2 n2Var, org.telegram.ui.ActionBar.n2 n2Var2) {
        ...
        this.f19103b = z10;
        this.f19105e = actionBarPopupWindow$ActionBarPopupWindowLayout;
        this.f19104c = z11;
        this.f19106f = n2Var;
        this.h = n2Var2;
    }
