...
public final class td implements Runnable {
    ...
    public final void run() {
        ...
        Object obj = this.h;
        Object obj2 = this.f17624f;
        Object obj3 = this.e;
        Object obj4 = this.d;
        switch (i10) {
            case 0:
                ((MessagesController) obj4).lambda$setUserAdminRole$101((TLRPC.TL_error) obj3, (org.telegram.ui.ActionBar.n2) obj2, (TLRPC.TL_channels_editAdmin) obj, this.f17622b, this.f17623c);
                return;
            case 1:
                ((NotificationsController) obj4).lambda$processNewMessages$27((ArrayList) obj3, (ArrayList) obj2, this.f17622b, this.f17623c, (CountDownLatch) obj);
                return;
            case 2:
                ...
                if (this.f17622b) {
                    ...
                    actionBarLayout.f18611a0 = false;
                    actionBarLayout.f18647s.setScaleX(1.0f);
                    actionBarLayout.f18647s.setScaleY(1.0f);
                } else {
                    Drawable drawable = ActionBarLayout.f18607p1;
                    actionBarLayout.T(n2Var, this.f17623c);
                ...
                return;
            default:
                TwoStepVerificationActivity.a0((TwoStepVerificationActivity) obj4, (TLRPC.TL_error) obj3, (TLObject) obj2, this.f17622b, this.f17623c, (Runnable) obj);
                return;
        }
    }
