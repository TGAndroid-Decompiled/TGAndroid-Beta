...
public class MessageObject {
    ...
    public static class TextLayoutBlock implements uj0 {
        ...
        public float collapsed(org.telegram.ui.Cells.s1 s1Var) {
            boolean collapsed;
            if (s1Var.f22757e3) {
                HashSet hashSet = s1Var.f22752d3;
                collapsed = true;
        ...
        public void drawCopyCodeButton(Canvas canvas, RectF rectF, int i10, int i11, float f7) {
            ...
            float min = Math.min(rectF.width() - AndroidUtilities.dp(12.0f), (this.copyIcon.getIntrinsicWidth() * 0.8f) + AndroidUtilities.dp(5.0f) + this.copyText.f25875c);
            ...
            f01Var.f25886p = AndroidUtilities.dp(12.0f) + ((int) (min - ((this.copyIcon.getIntrinsicWidth() * 0.8f) + AndroidUtilities.dp(5.0f))));
            f01Var.c(intrinsicWidth, dp, f7, i10, canvas);
        }
        ...
        public void layoutCode(String str, int i10, boolean z10) {
            ...
            this.languageHeight = AndroidUtilities.dp(4.0f) + ((int) (f01Var.f25873a.getTextSize() * 1.714f));
        }
    ...
    public MessageObject(int i10, TL_stories.StoryItem storyItem) {
        ...
        if (storyItem != null) {
            ...
            tL_message.f19917id = storyItem.messageId;
            tL_message.realId = storyItem.f20133id;
    ...
    private void createPathThumb() {
        ...
        this.pathThumb = DocumentObject.getSvgThumb(document, org.telegram.ui.ActionBar.j6.f20843lc, 1.0f);
    }
    ...
    public static void cutIntoRanges(CharSequence charSequence, ArrayList<TextRange> arrayList) {
        ...
        if (charSequence != null) {
            ...
            while (true) {
                ...
                if (ri0VarArr[i15].f30058a.f30339e) {
                    i16 = 16;
                }
                ...
                if (num != null) {
                    ...
                    if (stickerSet != null && stickerSet.packs != null) {
                        for (int i11 = 0; i11 < stickerSet.packs.size(); i11++) {
                            ...
                            if (tL_stickerPack.documents.contains(Long.valueOf(document.f19902id)) && Emoji.getEmojiDrawable(tL_stickerPack.emoticon) != null) {
                        ...
                        if (pageBlock instanceof TL_iv.pageBlockOrderedList) {
                            ...
                            while (true) {
                                if (i12 < richMessage.documents.size()) {
                                    if (richMessage.documents.get(i12).f19902id == pageblockaudio.audio_id) {
    ...
    private CharSequence formatTaskTitle(TLRPC.TodoItem todoItem) {
        ...
        ((Spannable) formatTextWithEntities).setSpan(new l51("task?" + todoItem.f20041id, 0), 0, formatTextWithEntities.length(), 33);
        ...
        for (int i11 = 0; i11 < tL_messageMediaToDo.completions.size(); i11++) {
            ...
            while (true) {
                if (i12 >= tL_messageMediaToDo.todo.list.size()) {
                    break;
                } else if (tL_messageMediaToDo.todo.list.get(i12).f20041id == todoCompletion.f20040id) {
                    i10++;
                    break;
                } else {
                    i12++;
    ...
    private MessageObject getMessageObjectForBlock(TLRPC.WebPage webPage, TL_iv.PageBlock pageBlock) {
        ...
        if (pageBlock instanceof TL_iv.pageBlockPhoto) {
            ...
            if (photoWithId != webPage.photo) {
                ...
                tL_message.f19917id = Utilities.random.nextInt();
                TLRPC.Message message = this.messageOwner;
    ...
    public static long getObjectPeerId(TLObject tLObject) {
        ...
        if (tLObject instanceof TLRPC.Chat) {
            return -((TLRPC.Chat) tLObject).f19896id;
        }
        if (!(tLObject instanceof TLRPC.User)) {
            return 0L;
        }
        return ((TLRPC.User) tLObject).f20043id;
    }
    ...
    public static int getVideoWidth(TLRPC.Document document) {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            TLRPC.DocumentAttribute documentAttribute = document.attributes.get(i10);
            if (documentAttribute instanceof TLRPC.TL_documentAttributeVideo) {
                return documentAttribute.f19903w;
            }
        }
        return 0;
    }
    ...
    public static int[] getWebDocumentWidthAndHeight(TLRPC.WebDocument webDocument) {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            ...
            if (documentAttribute instanceof TLRPC.TL_documentAttributeImageSize) {
                return new int[]{documentAttribute.f19903w, documentAttribute.h};
            }
            if (documentAttribute instanceof TLRPC.TL_documentAttributeVideo) {
                return new int[]{documentAttribute.f19903w, documentAttribute.h};
            }
    ...
    public static boolean isTextColorEmoji(TLRPC.Document document) {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            ...
            if (documentAttribute instanceof TLRPC.TL_documentAttributeCustomEmoji) {
                TLRPC.InputStickerSet inputStickerSet = documentAttribute.stickerset;
                if ((inputStickerSet instanceof TLRPC.TL_inputStickerSetID) && inputStickerSet.f19916id == 1269403972611866647L) {
                    return true;
                }
    ...
    public static void toggleTodo(int i10, long j3, TLRPC.TL_messageMediaToDo tL_messageMediaToDo, int i11, boolean z10, int i12) {
        ...
        while (i13 < tL_messageMediaToDo.completions.size()) {
            if (tL_messageMediaToDo.completions.get(i13).f20040id == i11) {
        ...
        if (z10) {
            ...
            tL_todoCompletion.f20040id = i11;
    ...
    public boolean checkLayout() {
        ...
        if ((i11 == 0 || i11 == 19 || i11 == 36) && this.messageOwner.peer_id != null && (charSequence = this.messageText) != null && (charSequence.length() != 0 || this.isBotPendingDraft)) {
            if (this.layoutCreated) {
                ...
                TextPaint textPaint2 = org.telegram.ui.ActionBar.j6.f20886o2;
                if (textPaint2 != null) {
            ...
            if (!this.layoutCreated) {
                ...
                if (getMedia(this.messageOwner) instanceof TLRPC.TL_messageMediaGame) {
                    textPaint = org.telegram.ui.ActionBar.j6.f21049x2;
                } else {
                    textPaint = org.telegram.ui.ActionBar.j6.f20886o2;
                }
                if (allowsBigEmoji()) {
                    iArr = new int[1];
                } else {
            ...
            if (this.type == 23) {
                ...
                if (messageMedia != null && (storyItem = messageMedia.storyItem) != null) {
                    ...
                    if (isMediaEmpty() && !(getMedia(this.messageOwner) instanceof TLRPC.TL_messageMediaGame) && !TextUtils.isEmpty(str)) {
                        CharSequence replaceEmoji = Emoji.replaceEmoji(str, org.telegram.ui.ActionBar.j6.f20886o2.getFontMetricsInt(), false);
                        this.caption = replaceEmoji;
                        this.caption = replaceAnimatedEmoji(replaceEmoji, arrayList, org.telegram.ui.ActionBar.j6.f20886o2.getFontMetricsInt(), false);
    ...
    public void generateExplanation() {
        ...
        if (str != null) {
            CharSequence replaceEmoji = Emoji.replaceEmoji(str, org.telegram.ui.ActionBar.j6.f20651b3.getFontMetricsInt(), false);
            this.quizExplanation = replaceEmoji;
            Spannable replaceAnimatedEmoji = replaceAnimatedEmoji(replaceEmoji, arrayList, org.telegram.ui.ActionBar.j6.f20651b3.getFontMetricsInt(), false);
    ...
    public void generateGameMessageText(TLRPC.User user) {
        ...
        if (tL_game == null) {
            if (user != null && user.f20043id == UserConfig.getInstance(this.currentAccount).getClientUserId()) {
        ...
        if (messageObject != null) {
            ...
            if (!(message instanceof TLRPC.TL_messageEmpty) && !(message.action instanceof TLRPC.TL_messageActionHistoryClear)) {
                if (messageObject.isMusic()) {
                    ...
                    this.messageText = Emoji.replaceEmoji(replaceWithLink, org.telegram.ui.ActionBar.j6.f20886o2.getFontMetricsInt(), false);
                    return;
                } else {
                    ...
                    if (charSequence != null && charSequence.length() > 0) {
                        ...
                        SpannableStringBuilder replaceEmoji = Emoji.replaceEmoji(cloneSpans, org.telegram.ui.ActionBar.j6.f20886o2.getFontMetricsInt(), true);
                        MessageObject messageObject2 = this.replyMessageObject;
                        if (messageObject2 != null && messageObject2.messageOwner != null) {
                            replaceEmoji = messageObject2.replaceAnimatedEmoji(replaceEmoji, org.telegram.ui.ActionBar.j6.f20886o2.getFontMetricsInt());
                        }
    ...
    public int getEphemeralId() {
        if (isEphemeral()) {
            return ephemeralMessageIdUnpack(this.messageOwner.f19917id);
        }
        return 0;
    }
    ...
    public long getPollId() {
        ...
        return ((TLRPC.TL_messageMediaPoll) media).poll.f19922id;
    }
    ...
    public long getSize() {
        ...
        if (e71Var != null) {
            return e71Var.f25612g.size;
        }
        e71 e71Var2 = this.thumbQuality;
        if (e71Var2 != null) {
            return e71Var2.f25612g.size;
        }
        e71 e71Var3 = this.cachedQuality;
        if (e71Var3 != null) {
            return e71Var3.f25612g.size;
        }
    ...
    public TLRPC.WebPage getStoryMentionWebpage() {
        ...
        tL_webPageAttributeStory.f20039id = this.messageOwner.media.f19918id;
    ...
    public TextPaint getTextPaint() {
        ...
        if (this.emojiOnlyCount >= 1 && this.messageOwner != null && !hasNonEmojiEntities()) {
            ...
            switch (Math.max(i10, i11)) {
                ...
                case 1:
                case 2:
                    TextPaint[] textPaintArr = org.telegram.ui.ActionBar.j6.f21067y2;
                    if (z10) {
                        return textPaintArr[0];
                    }
                    return textPaintArr[2];
                case 3:
                    TextPaint[] textPaintArr2 = org.telegram.ui.ActionBar.j6.f21067y2;
                    if (z10) {
                        return textPaintArr2[1];
                    }
                    return textPaintArr2[3];
                case 4:
                    TextPaint[] textPaintArr3 = org.telegram.ui.ActionBar.j6.f21067y2;
                    if (z10) {
                        return textPaintArr3[2];
                    }
                    return textPaintArr3[4];
                case 5:
                    TextPaint[] textPaintArr4 = org.telegram.ui.ActionBar.j6.f21067y2;
                    if (z10) {
                        return textPaintArr4[3];
                    }
                    return textPaintArr4[5];
                case 6:
                    TextPaint[] textPaintArr5 = org.telegram.ui.ActionBar.j6.f21067y2;
                    if (z10) {
                        return textPaintArr5[4];
                    }
                    return textPaintArr5[5];
                default:
                    return org.telegram.ui.ActionBar.j6.f21067y2[5];
            }
        }
        return org.telegram.ui.ActionBar.j6.f20886o2;
    }
    ...
    public float getVideoSavedProgress() {
        ...
        if (this.cachedSavedTimestamp != null) {
            ...
            if (!TextUtils.isEmpty(fileNameFast2) && duration >= 10) {
                gv0 gv0Var = (gv0) PhotoViewer.V8.get(fileNameFast2);
                if (this.forceSeekTo < 0.0f && gv0Var != null) {
                    float f10 = gv0Var.f36828a;
        ...
        if (!TextUtils.isEmpty(fileNameFast)) {
            if (duration2 >= 10) {
                gv0 gv0Var2 = (gv0) PhotoViewer.V8.get(fileNameFast);
                if (this.forceSeekTo < 0.0f && gv0Var2 != null) {
                    float f11 = gv0Var2.f36828a;
    ...
    public CharSequence getVoiceTranscription() {
        ...
        if (message != null && (str = message.voiceTranscription) != null) {
            ...
            if (!TextUtils.isEmpty(str2)) {
                return Emoji.replaceEmoji(str2, org.telegram.ui.ActionBar.j6.f20886o2.getFontMetricsInt(), false);
            }
            return str2;
        }
        return null;
    ...
    public boolean isEditing() {
        TLRPC.Message message = this.messageOwner;
        if (message.send_state == 3 && message.f19917id > 0) {
            return true;
        }
        return false;
    }
    ...
    public boolean isEditingMedia() {
        if (getMedia(this.messageOwner) instanceof TLRPC.TL_messageMediaPhoto) {
            if (getMedia(this.messageOwner).photo.f19920id == 0) {
                return true;
            }
            return false;
    ...
    public boolean isSendError() {
        int i10;
        TLRPC.Message message = this.messageOwner;
        if (message.send_state != 2 || message.f19917id >= 0) {
            if (this.scheduled && message.f19917id > 0) {
    ...
    public boolean isSending() {
        TLRPC.Message message = this.messageOwner;
        if (message.send_state == 1 && message.f19917id < 0) {
            return true;
        }
        return false;
    }
    ...
    public boolean isSent() {
        TLRPC.Message message = this.messageOwner;
        if (message.send_state != 0 && message.f19917id <= 0) {
            return false;
        }
        return true;
    }
    ...
    public void markReactionsAsRead() {
        ...
        if (tL_messageReactions != null && tL_messageReactions.recent_reactions != null) {
            ...
            if (z10) {
                ...
                TLRPC.Message message = this.messageOwner;
                messagesStorage.markMessageReactionsAsRead(message.dialog_id, getTopicId(this.currentAccount, message), this.messageOwner.f19917id);
            }
        }
    }
                ...
                for (int i10 = 0; i10 < source.getRowsCount(); i10++) {
                    ...
                    for (int i12 = 0; i12 < columnsCount; i12++) {
                        ...
                        if ((button instanceof BotInlineKeyboard.ButtonBot) && zf.c.c(((BotInlineKeyboard.ButtonBot) button).button, TL_keyboard.TL_inlineButtonTypeBuy.class) && (getMedia(this.messageOwner).flags & 4) != 0) {
                            ...
                            replaceEmoji = Emoji.replaceEmoji(text, org.telegram.ui.ActionBar.j6.f21032w2.getFontMetricsInt(), false);
                        }
                        StaticLayout staticLayout = new StaticLayout(replaceEmoji, org.telegram.ui.ActionBar.j6.f21032w2, AndroidUtilities.dp(2000.0f), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
    ...
    public float measureVoiceTranscriptionHeight() {
        ...
        if (Build.VERSION.SDK_INT >= 24) {
            staticLayout = StaticLayout.Builder.obtain(voiceTranscription, 0, voiceTranscription.length(), org.telegram.ui.ActionBar.j6.f20886o2, dp).setBreakStrategy(1).setHyphenationFrequency(0).setAlignment(Layout.Alignment.ALIGN_NORMAL).build();
        } else {
            staticLayout = new StaticLayout(voiceTranscription, org.telegram.ui.ActionBar.j6.f20886o2, dp, Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
        }
    ...
    public boolean probablyRingtone() {
        if (!isVoiceOnce() && getDocument() != null && uf.c.f47058i.contains(getDocument().mime_type) && getDocument().size < MessagesController.getInstance(this.currentAccount).ringtoneSizeMax * 2) {
        ...
        if (TextUtils.indexOf(charSequence, str) >= 0) {
            ...
            for (int i10 = 0; i10 < arrayList.size(); i10++) {
                ...
                if (user != null) {
                    ...
                    spannableStringBuilder.setSpan(new m51("" + user.f20043id), length, userName.length() + length, 33);
                }
            }
    ...
    public boolean selectReaction(ah.j1 j1Var, boolean z10, boolean z11) {
        ...
        if (message4.reactions.can_see_list || (message4.dialog_id > 0 && maxUserReactionsCount > 1)) {
            ...
            if (j1Var.f609f != null) {
                ...
                tL_reactionCustomEmoji.document_id = j1Var.f610g;
            }
        }
        this.reactionsChanged = true;
        return true;
                ...
                if (!(message instanceof TLRPC.TL_message) && !(message instanceof TLRPC.TL_messageForwarded_old2)) {
                    ...
                    if (tL_channelAdminLogEvent != null) {
                        ...
                        if (channelAdminLogEventAction instanceof TLRPC.TL_channelAdminLogEventActionChangeWallpaper) {
                            ...
                            if ((wallPaper instanceof TLRPC.TL_wallPaperNoFile) && wallPaper.f20048id == 0 && wallPaper.settings == null) {
                                this.type = 10;
                            } else {
                                this.type = 22;
                    ...
                    if (message2.rich_message != null) {
                        ...
                        if (message2.media instanceof TLRPC.TL_messageMediaPaidMedia) {
                            ...
                            if (getMedia(this.messageOwner).document == null) {
                                ...
                                getMedia(this.messageOwner).document.f19902id = -2147483648L;
                                TLRPC.TL_documentAttributeImageSize tL_documentAttributeImageSize = new TLRPC.TL_documentAttributeImageSize();
                                tL_documentAttributeImageSize.f19903w = 512;
            ...
            if ((isDocumentHasThumb(document) && (str.equalsIgnoreCase("image/png") || str.equalsIgnoreCase("image/jpg") || str.equalsIgnoreCase("image/jpeg"))) || (Build.VERSION.SDK_INT >= 26 && str.equalsIgnoreCase("image/heic"))) {
                for (int i10 = 0; i10 < document.attributes.size(); i10++) {
                    ...
                    if (documentAttribute instanceof TLRPC.TL_documentAttributeImageSize) {
                        ...
                        return tL_documentAttributeImageSize.f19903w < 6000 && tL_documentAttributeImageSize.h < 6000;
                    }
                }
    ...
    private void checkEmojiOnly(Integer num) {
            ...
            if (i10 != 0 && !z10) {
                ...
                switch (Math.max(i10, i11)) {
                    ...
                    default:
                        ...
                        textPaint = org.telegram.ui.ActionBar.j6.f21067y2[5];
                        i12 = i13;
                        break;
                }
                ...
                for (int i15 = 0; i15 < z5VarArr.length; i15++) {
                    z5VarArr[i15].replaceFontMetrics(org.telegram.ui.ActionBar.j6.f20886o2.getFontMetricsInt(), (int) (org.telegram.ui.ActionBar.j6.f20886o2.getTextSize() + AndroidUtilities.dp(4.0f)), -1);
        ...
        if (z5VarArr2 != null && z5VarArr2.length > 0) {
            ...
            for (int i16 = 0; i16 < z5VarArr2.length; i16++) {
                z5VarArr2[i16].replaceFontMetrics(org.telegram.ui.ActionBar.j6.f20886o2.getFontMetricsInt(), (int) (org.telegram.ui.ActionBar.j6.f20886o2.getTextSize() + AndroidUtilities.dp(4.0f)), -1);
    ...
    public static CharSequence formatTextWithEntities(TLRPC.TL_textWithEntities tL_textWithEntities, boolean z10) {
        ...
        TextPaint textPaint = org.telegram.ui.ActionBar.j6.f20959s2;
        if (textPaint == null) {
    ...
    public static boolean isEphemeral(TLRPC.Message message) {
        if (message != null) {
            return isEphemeralMessageId(message.f19917id) || message.ephemeralReceiverBotId != 0;
        }
        return false;
    }
        ...
        if (i12 == 0) {
            ...
            if (i12 != 19) {
                if (i12 != 13 && i12 != 15) {
                    ...
                    if (closestPhotoSizeWithSize != null) {
                        int i15 = (int) (closestPhotoSizeWithSize.h / (closestPhotoSizeWithSize.f19921w / i14));
                        if (i15 == 0) {
    ...
    public static boolean canDeleteMessage(int i10, boolean z10, TLRPC.Message message, TLRPC.Chat chat) {
        ...
        if (!ChatObject.isChannel(chat)) {
            ...
            return (z11 && (message instanceof TLRPC.TL_messageService)) ? message.f19917id != 1 && ChatObject.canUserDoAdminAction(chat, 13) : z10 || (message.f19917id != 1 && (chat.creator || (((tL_chatAdminRights = chat.admin_rights) != null && (tL_chatAdminRights.delete_messages || (z11 && (chat.megagroup || tL_chatAdminRights.post_messages)))) || (chat.megagroup && z11))));
        }
    }
                ...
                if ((documentAttribute instanceof TLRPC.TL_documentAttributeCustomEmoji) || (documentAttribute instanceof TLRPC.TL_documentAttributeSticker)) {
                    if (num != null) {
                        ...
                        if (stickerSet != null && stickerSet.packs != null) {
                            for (int i11 = 0; i11 < stickerSet.packs.size(); i11++) {
                                TLRPC.TL_stickerPack tL_stickerPack = stickerSet.packs.get(i11);
                                if (tL_stickerPack.documents.contains(Long.valueOf(document.f19902id))) {
    ...
    public static boolean isCompleted(TLRPC.TL_messageMediaToDo tL_messageMediaToDo, int i10) {
        for (int i11 = 0; i11 < tL_messageMediaToDo.completions.size(); i11++) {
            if (tL_messageMediaToDo.completions.get(i11).f20040id == i10) {
                return true;
            }
        }
        return false;
    ...
    public static boolean peersEqual(TLRPC.Chat chat, TLRPC.Peer peer) {
        ...
        if (chat != null && peer != null) {
            if (ChatObject.isChannel(chat) && (peer instanceof TLRPC.TL_peerChannel)) {
                return chat.f19896id == peer.channel_id;
            } else if (!ChatObject.isChannel(chat) && (peer instanceof TLRPC.TL_peerChat) && chat.f19896id == peer.chat_id) {
                return true;
            }
        }
        return false;
