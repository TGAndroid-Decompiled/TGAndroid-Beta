...
public final class AndroidUtilities$$ExternalSyntheticLambda57 implements Runnable {
    public final int $r8$classId;
    public final Intent f$0;

    public AndroidUtilities$$ExternalSyntheticLambda57(Intent intent, int i) {
        this.$r8$classId = i;
        this.f$0 = intent;
    }
