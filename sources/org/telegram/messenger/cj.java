    ...
    public final void run() {
        ...
        switch (this.f15920a) {
            ...
            default:
                ...
                org.telegram.ui.sa saVar = haVar.f34224a;
                ArrayList arrayList = saVar.f37441w;
                ...
                if (z10) {
                    ...
                    if (tL_error != null && "USERNAMES_ACTIVE_TOO_MUCH".equals(tL_error.text)) {
                        ...
                        alertDialog$Builder.f18447a.R = LocaleController.getString(R.string.UsernameActivateErrorTitle);
                        alertDialog$Builder.f18447a.T = LocaleController.getString(R.string.UsernameActivateErrorMessage);
                ...
                if (saVar.f37442x != 0 && arrayList2 != null) {
