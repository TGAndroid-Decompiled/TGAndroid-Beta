...
public final class cj implements Runnable {
    ...
    public final Object f17447e;
    public final Serializable f17448f;
    public final Object h;
    public final Object f17449n;
    public final TLObject f17450r;
    ...
    public cj(SendMessagesHelper sendMessagesHelper, ArrayList arrayList, boolean z10, boolean z11, TLRPC.Message message, ArrayList arrayList2, ArrayList arrayList3, int i10) {
        this.f17447e = sendMessagesHelper;
        this.f17448f = arrayList;
        this.f17446c = z10;
        this.d = z11;
        this.f17450r = message;
        this.h = arrayList2;
        this.f17449n = arrayList3;
        this.f17445b = i10;
    }
    ...
    public final void run() {
        ...
        switch (this.f17444a) {
            case 0:
                ...
                ((SendMessagesHelper) this.f17447e).lambda$performSendMessageRequest$96((ArrayList) this.f17448f, this.f17446c, this.d, (TLRPC.Message) this.f17450r, (ArrayList) this.h, (ArrayList) this.f17449n, i11);
                return;
            default:
                org.telegram.ui.fa faVar = (org.telegram.ui.fa) this.f17447e;
                TLRPC.TL_error tL_error = (TLRPC.TL_error) this.f17449n;
                TLRPC.TL_username tL_username2 = (TLRPC.TL_username) this.f17450r;
                org.telegram.ui.qa qaVar = faVar.f36382a;
                ArrayList arrayList = qaVar.f39834w;
                ArrayList arrayList2 = qaVar.v;
                arrayList.remove((String) this.f17448f);
                boolean z10 = ((TLObject) this.h) instanceof TLRPC.TL_boolTrue;
                int i12 = this.f17445b;
                boolean z11 = this.f17446c;
                if (z10) {
                    ...
                    if (tL_error != null && "USERNAMES_ACTIVE_TOO_MUCH".equals(tL_error.text)) {
                        ...
                        alertDialog$Builder.f20225a.R = LocaleController.getString(R.string.UsernameActivateErrorTitle);
                        alertDialog$Builder.f20225a.T = LocaleController.getString(R.string.UsernameActivateErrorMessage);
                ...
                if (qaVar.f39835x != 0 && arrayList2 != null) {
    ...
    public cj(org.telegram.ui.fa faVar, String str, TLObject tLObject, int i10, boolean z10, TLRPC.TL_error tL_error, TLRPC.TL_username tL_username, boolean z11) {
        ...
        this.f17445b = i10;
        this.f17446c = z10;
        this.f17449n = tL_error;
        this.f17450r = tL_username;
        this.d = z11;
    }
}
