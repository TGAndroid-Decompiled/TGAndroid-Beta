...
public final class SendMessagesHelper$$ExternalSyntheticLambda7 implements Runnable {
    ...
    public SendMessagesHelper$$ExternalSyntheticLambda7(Object obj, Object obj2, ActionBarMenuSubItem actionBarMenuSubItem, ActionBarMenuSubItem actionBarMenuSubItem2, ActionBarMenuSubItem actionBarMenuSubItem3, ActionBarMenuSubItem actionBarMenuSubItem4, boolean z, ActionBarMenuSubItem actionBarMenuSubItem5, ActionBarMenuSubItem actionBarMenuSubItem6, int i) {
        this.$r8$classId = i;
        this.f$0 = obj;
        this.f$1 = obj2;
        this.f$2 = actionBarMenuSubItem;
        this.f$3 = actionBarMenuSubItem2;
        this.f$4 = actionBarMenuSubItem3;
        this.f$5 = actionBarMenuSubItem4;
        this.f$7 = z;
        this.f$6 = actionBarMenuSubItem5;
        this.f$8 = actionBarMenuSubItem6;
    }
        ...
        switch (this.$r8$classId) {
            ...
            case 3:
                ...
                if (actionBarMenuSubItem != null) {
                    actionBarMenuSubItem.setTextAndIcon(LocaleController.getString(giftsList.sort_by_date ? R.string.Gift2FilterSortByValue : R.string.Gift2FilterSortByDate), giftsList.sort_by_date ? R.drawable.menu_sort_value : R.drawable.menu_sort_date, null);
                }
                ((ActionBarMenuSubItem) this.f$2).setChecked(TLObject.hasFlag(giftsList.includeFlags, 1));
            ...
            default:
                ...
                ActionBarMenuSubItem actionBarMenuSubItem2 = (ActionBarMenuSubItem) this.f$1;
                if (actionBarMenuSubItem2 != null) {
                    actionBarMenuSubItem2.setTextAndIcon(LocaleController.getString(selectGiftsBottomSheet.list.sort_by_date ? R.string.Gift2FilterSortByValue : R.string.Gift2FilterSortByDate), selectGiftsBottomSheet.list.sort_by_date ? R.drawable.menu_sort_value : R.drawable.menu_sort_date, null);
                }
                ...
                ((ActionBarMenuSubItem) this.f$3).setChecked(TLObject.hasFlag(giftsList2.includeFlags, 2));
                ((ActionBarMenuSubItem) this.f$4).setChecked(TLObject.hasFlag(giftsList2.includeFlags, 4));
                ((ActionBarMenuSubItem) this.f$5).setChecked(TLObject.hasFlag(giftsList2.includeFlags, 8));
                if (this.f$7) {
                    ((ActionBarMenuSubItem) this.f$6).setChecked(TLObject.hasFlag(giftsList2.includeFlags, 256));
                    ((ActionBarMenuSubItem) this.f$8).setChecked(TLObject.hasFlag(giftsList2.includeFlags, 512));
                }
                break;
        }
    }
