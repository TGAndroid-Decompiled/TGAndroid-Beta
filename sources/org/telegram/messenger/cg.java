...
public final class cg implements Runnable {
    ...
    public final MessagesStorage f16123b;
    ...
    public final void run() {
        switch (this.f16122a) {
            case 0:
                this.f16123b.lambda$loadPendingTasks$27(this.f16124c, this.d, this.e);
                return;
            case 1:
                this.f16123b.lambda$loadPendingTasks$28(this.f16124c, this.d, this.e);
                return;
            default:
                int i10 = this.f16124c;
                long j3 = this.e;
                SQLiteDatabase database = this.f16123b.getDatabase();
                    ...
                    try {
                        ...
                        if (arrayList != null) {
                            ...
                            for (int i11 = 0; i11 < arrayList.size(); i11++) {
                                ...
                                sQLitePreparedStatement.bindLong(1, starGift.f18553id);
