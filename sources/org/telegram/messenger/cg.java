...
public final class cg implements Runnable {
    ...
    public final MessagesStorage f16138b;
    ...
    public final void run() {
        switch (this.f16137a) {
            case 0:
                this.f16138b.lambda$loadPendingTasks$27(this.f16139c, this.d, this.e);
                return;
            case 1:
                this.f16138b.lambda$loadPendingTasks$28(this.f16139c, this.d, this.e);
                return;
            default:
                int i10 = this.f16139c;
                long j3 = this.e;
                SQLiteDatabase database = this.f16138b.getDatabase();
                    ...
                    try {
                        ...
                        if (arrayList != null) {
                            ...
                            for (int i11 = 0; i11 < arrayList.size(); i11++) {
                                ...
                                sQLitePreparedStatement.bindLong(1, starGift.f18568id);
