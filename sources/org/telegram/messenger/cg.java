...
public final class cg implements Runnable {
    ...
    public final MessagesStorage f15902b;
    ...
    public final void run() {
        switch (this.f15901a) {
            case 0:
                this.f15902b.lambda$loadPendingTasks$27(this.f15903c, this.d, this.e);
                return;
            case 1:
                this.f15902b.lambda$loadPendingTasks$28(this.f15903c, this.d, this.e);
                return;
            default:
                int i10 = this.f15903c;
                long j3 = this.e;
                SQLiteDatabase database = this.f15902b.getDatabase();
                    ...
                    try {
                        ...
                        if (arrayList != null) {
                            ...
                            for (int i11 = 0; i11 < arrayList.size(); i11++) {
                                ...
                                sQLitePreparedStatement.bindLong(1, starGift.f18338id);
