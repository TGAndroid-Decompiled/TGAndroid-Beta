...
public final class cg implements Runnable {
    ...
    public final MessagesStorage f15911b;
    ...
    public final void run() {
        switch (this.f15910a) {
            case 0:
                this.f15911b.lambda$loadPendingTasks$27(this.f15912c, this.d, this.e);
                return;
            case 1:
                this.f15911b.lambda$loadPendingTasks$28(this.f15912c, this.d, this.e);
                return;
            default:
                int i10 = this.f15912c;
                long j3 = this.e;
                SQLiteDatabase database = this.f15911b.getDatabase();
                    ...
                    try {
                        ...
                        if (arrayList != null) {
                            ...
                            for (int i11 = 0; i11 < arrayList.size(); i11++) {
                                ...
                                sQLitePreparedStatement.bindLong(1, starGift.f18347id);
