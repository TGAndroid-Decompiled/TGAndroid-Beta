        ...
        switch (this.f15779a) {
            ...
            default:
                ...
                if (tLObject instanceof TLRPC.Updates) {
                    ...
                    tL_messages_getScheduledMessages.peer = MessagesController.getInstance(v5Var.f47918a).getInputPeer(j3);
                    tL_messages_getScheduledMessages.f18221id.add(Integer.valueOf(i10));
                    ConnectionsManager.getInstance(v5Var.f47918a).sendRequest(tL_messages_getScheduledMessages, new ja(v5Var, messageObject, j10, runnable, 8));
                    return;
                } else {
                    runnable.run();
                    return;
