...
public final class mk implements Utilities.Callback {
    public final int f16790a = 0;
    public final boolean f16791b;
    public final NotificationCenter.NotificationCenterDelegate f16792c;
    ...
    public mk(SendMessagesHelper sendMessagesHelper, ArrayList arrayList, ArrayList arrayList2, ArrayList arrayList3, SendMessagesHelper.DelayedMessage delayedMessage, boolean z10) {
        this.f16792c = sendMessagesHelper;
        this.d = arrayList;
        this.e = arrayList2;
        this.f16793f = arrayList3;
        this.f16794g = delayedMessage;
        this.f16791b = z10;
    }
    ...
    public final void run(Object obj) {
        ...
        switch (this.f16790a) {
            case 0:
                ((SendMessagesHelper) this.f16792c).lambda$performSendMessageRequestMulti$64((ArrayList) this.d, (ArrayList) this.e, (ArrayList) this.f16793f, (SendMessagesHelper.DelayedMessage) this.f16794g, this.f16791b, (TLObject) obj);
                return;
            case 1:
                ProfileActivity profileActivity = (ProfileActivity) this.f16792c;
                TLRPC.ChannelParticipant channelParticipant = (TLRPC.ChannelParticipant) this.d;
                TLRPC.User user = (TLRPC.User) this.e;
                TLRPC.ChatParticipant chatParticipant = (TLRPC.ChatParticipant) this.f16793f;
                String str = (String) this.f16794g;
                Integer num = (Integer) obj;
                profileActivity.getClass();
                boolean z11 = this.f16791b;
            ...
            default:
                z61 z61Var = (z61) this.f16792c;
                LinkedHashSet linkedHashSet = (LinkedHashSet) this.e;
                String str2 = (String) this.f16793f;
                HashMap hashMap = (HashMap) this.f16794g;
                    ...
                    for (int i11 = 0; i11 < stickerSets.size(); i11++) {
                        if (stickerSets.get(i11).documents != null && (arrayList2 = stickerSets.get(i11).documents) != null) {
                            for (int i12 = 0; i12 < arrayList2.size(); i12++) {
                                ...
                                long j3 = arrayList2.get(i12).f18089id;
                    ...
                    for (int i13 = 0; i13 < featuredEmojiSets.size(); i13++) {
                        if ((featuredEmojiSets.get(i13) instanceof TLRPC.TL_stickerSetFullCovered) && ((TLRPC.TL_stickerSetFullCovered) featuredEmojiSets.get(i13)).keywords != null && (arrayList = ((TLRPC.TL_stickerSetFullCovered) featuredEmojiSets.get(i13)).documents) != null) {
                            for (int i14 = 0; i14 < arrayList.size(); i14++) {
                                ...
                                long j10 = arrayList.get(i14).f18089id;
                ...
                String[] strArr = z61.a2;
                ai.g6 g6Var = new ai.g6(z61Var, linkedHashSet, hashMap, arrayList3, runnable);
                if (z61Var.W == 3) {
                    z10 = true;
                } else {
                    z10 = false;
    ...
    public mk(ProfileActivity profileActivity, TLRPC.ChannelParticipant channelParticipant, TLRPC.User user, TLRPC.ChatParticipant chatParticipant, boolean z10, String str) {
        this.f16792c = profileActivity;
        this.d = channelParticipant;
        this.e = user;
        this.f16793f = chatParticipant;
        this.f16791b = z10;
        this.f16794g = str;
    }

    public mk(z61 z61Var, boolean z10, LinkedHashSet linkedHashSet, String str, HashMap hashMap, ArrayList arrayList) {
        this.f16792c = z61Var;
        this.f16791b = z10;
        this.e = linkedHashSet;
        this.f16793f = str;
        this.f16794g = hashMap;
        this.d = arrayList;
    }
}
