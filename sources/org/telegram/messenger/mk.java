...
public final class mk implements Utilities.Callback {
    ...
    public final NotificationCenter.NotificationCenterDelegate f17026c;
    public final Object d;
    public final Object e;
    public final Object f17027f;
    public final Object f17028g;
    ...
    public mk(SendMessagesHelper sendMessagesHelper, ArrayList arrayList, ArrayList arrayList2, ArrayList arrayList3, SendMessagesHelper.DelayedMessage delayedMessage, boolean z10) {
        this.f17026c = sendMessagesHelper;
        this.d = arrayList;
        this.e = arrayList2;
        this.f17027f = arrayList3;
        this.f17028g = delayedMessage;
        this.f17025b = z10;
    }
    ...
    public final void run(Object obj) {
        ...
        switch (this.f17024a) {
            case 0:
                ((SendMessagesHelper) this.f17026c).lambda$performSendMessageRequestMulti$64((ArrayList) this.d, (ArrayList) this.e, (ArrayList) this.f17027f, (SendMessagesHelper.DelayedMessage) this.f17028g, this.f17025b, (TLObject) obj);
                return;
            case 1:
                ProfileActivity profileActivity = (ProfileActivity) this.f17026c;
                TLRPC.ChannelParticipant channelParticipant = (TLRPC.ChannelParticipant) this.d;
                TLRPC.User user = (TLRPC.User) this.e;
                TLRPC.ChatParticipant chatParticipant = (TLRPC.ChatParticipant) this.f17027f;
                String str = (String) this.f17028g;
            ...
            default:
                j71 j71Var = (j71) this.f17026c;
                LinkedHashSet linkedHashSet = (LinkedHashSet) this.e;
                String str2 = (String) this.f17027f;
                HashMap hashMap = (HashMap) this.f17028g;
                    ...
                    for (int i11 = 0; i11 < stickerSets.size(); i11++) {
                        if (stickerSets.get(i11).documents != null && (arrayList2 = stickerSets.get(i11).documents) != null) {
                            for (int i12 = 0; i12 < arrayList2.size(); i12++) {
                                ...
                                long j3 = arrayList2.get(i12).f18334id;
                    ...
                    for (int i13 = 0; i13 < featuredEmojiSets.size(); i13++) {
                        if ((featuredEmojiSets.get(i13) instanceof TLRPC.TL_stickerSetFullCovered) && ((TLRPC.TL_stickerSetFullCovered) featuredEmojiSets.get(i13)).keywords != null && (arrayList = ((TLRPC.TL_stickerSetFullCovered) featuredEmojiSets.get(i13)).documents) != null) {
                            for (int i14 = 0; i14 < arrayList.size(); i14++) {
                                ...
                                long j10 = arrayList.get(i14).f18334id;
    ...
    public mk(ProfileActivity profileActivity, TLRPC.ChannelParticipant channelParticipant, TLRPC.User user, TLRPC.ChatParticipant chatParticipant, boolean z10, String str) {
        this.f17026c = profileActivity;
        this.d = channelParticipant;
        this.e = user;
        this.f17027f = chatParticipant;
        this.f17025b = z10;
        this.f17028g = str;
    }
