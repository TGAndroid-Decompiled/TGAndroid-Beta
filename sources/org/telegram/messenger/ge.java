...
public final class ge implements Runnable {
    ...
    public ge(MessagesController messagesController, TLRPC.updates_ChannelDifference updates_channeldifference, long j3, TLRPC.Chat chat, a0.i iVar, int i10, long j10) {
        this.f17828e = messagesController;
        this.f17829f = updates_channeldifference;
        this.f17827c = j3;
        this.h = chat;
        this.f17830n = iVar;
        this.f17826b = i10;
    ...
    public final void run() {
        switch (this.f17825a) {
            case 0:
                ...
                long j3 = this.d;
                ((MessagesController) this.f17828e).lambda$getChannelDifference$346((TLRPC.updates_ChannelDifference) this.f17829f, this.f17827c, (TLRPC.Chat) this.h, (a0.i) this.f17830n, i10, j3);
                return;
            default:
                org.telegram.ui.ActionBar.n2 n2Var = (org.telegram.ui.ActionBar.n2) this.h;
                org.telegram.ui.ActionBar.f6 f6Var = (org.telegram.ui.ActionBar.f6) this.f17830n;
                ((n70) this.f17828e).u();
                SharedPreferences notificationsSettings = MessagesController.getNotificationsSettings(this.f17826b);
