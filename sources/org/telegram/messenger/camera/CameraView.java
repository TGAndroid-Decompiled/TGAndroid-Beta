...
public class CameraView extends FrameLayout implements TextureView.SurfaceTextureListener, CameraController.ICameraView, CameraController.ErrorCallback {
    ...
    public class CameraGLThread extends DispatchQueue {
        ...
        public CameraGLThread(SurfaceTexture surfaceTexture) {
            ...
            CameraView$CameraGLThread$$ExternalSyntheticLambda0 cameraView$CameraGLThread$$ExternalSyntheticLambda0 = new CameraView$CameraGLThread$$ExternalSyntheticLambda0(this, 2);
            CubicBezierInterpolator cubicBezierInterpolator = CubicBezierInterpolator.EASE_OUT_QUINT;
            this.crossfade = new AnimatedFloat(cameraView$CameraGLThread$$ExternalSyntheticLambda0, 560L, cubicBezierInterpolator);
            this.camera1Appear = new AnimatedFloat(1.0f, new CameraView$CameraGLThread$$ExternalSyntheticLambda0(this, 3), 0L, 420L, cubicBezierInterpolator);
            this.dualAppear = new AnimatedFloat(new CameraView$CameraGLThread$$ExternalSyntheticLambda0(this, 4), 340L, cubicBezierInterpolator);
            this.shape = new AnimatedFloat(new CameraView$CameraGLThread$$ExternalSyntheticLambda0(this, 5), 340L, cubicBezierInterpolator);
        ...
        private boolean initBlurGL() {
            ...
            if (eGLContextEglCreateContext == null || eGLContextEglCreateContext == EGL10.EGL_NO_CONTEXT) {
                ...
                if (BuildVars.LOGS_ENABLED) {
                    CameraView$CameraGLThread$$ExternalSyntheticOutline0.m(this.egl10, new StringBuilder("eglCreateContext (blur) failed "));
                }
                return false;
            }
                                        ...
                                        synchronized (CameraView.this.layoutLock) {
                                            try {
                                                ...
                                                if (!cameraView3.firstFrameRendered && z4) {
                                                    ...
                                                    AndroidUtilities.runOnUIThread(new CameraView$CameraGLThread$$ExternalSyntheticLambda0(this, 0));
                                                }
                                                ...
                                                if (!cameraView4.firstFrame2Rendered && this.dualAppeared) {
                                                    ...
                                                    AndroidUtilities.runOnUIThread(new CameraView$CameraGLThread$$ExternalSyntheticLambda0(this, 1));
                                                }
                                            } catch (Throwable th3) {
                                                throw th3;
                                            }
        ...
        private void updateScale(int i) {
            if (CameraView.this.previewSize[i] != null) {
                ...
                if (i2 == i3) {
                    ...
                    CameraView cameraView = CameraView.this;
                    cameraView.scaleX = i3 / cameraView.surfaceWidth;
                    CameraView.this.scaleY = 1.0f;
                } else {
                    CameraView.this.scaleX = 1.0f;
                    CameraView cameraView2 = CameraView.this;
                    cameraView2.scaleY = i2 / cameraView2.surfaceHeight;
                }
    ...
    public class VideoRecorder implements Runnable {
        ...
        public void handleAudioFrameAvailable(InstantCameraView.AudioBufferInfo audioBufferInfo) {
            ...
            if (this.audioFirst == -1) {
                ...
                loop0: while (true) {
                    ...
                    if (BuildVars.LOGS_ENABLED) {
                        ChatObject$Call$$ExternalSyntheticOutline0.m(new StringBuilder("CameraView first audio frame not found, removing buffers "), audioBufferInfo2.results);
                    }
        ...
        public void handleStopRecording(int i) {
            ...
            this.fileWriteQueue.postRunnable(new CameraView$$ExternalSyntheticLambda14(1, this, countDownLatch));
            try {
            ...
            this.eglConfig = null;
            this.handler.exit();
            AndroidUtilities.runOnUIThread(new Camera2Session$1$$ExternalSyntheticLambda0(this, 1));
        }
                    ...
                    if (i > 1) {
                        ...
                        if ((i2 & 2) == 0) {
                            ...
                            this.fileWriteQueue.postRunnable(new Runnable(this) {
                                public final CameraView.VideoRecorder f$0;
                                ...
                                public final void run() {
                                    switch (i4) {
                                        case 0:
                                            ...
                                            break;
                                        default:
                                            this.f$0.lambda$drainEncoder$3(byteBufferCloneByteBuffer, bufferInfo2);
                                            break;
                                    }
                                }
                            });
                            ...
                            outputBuffer.limit(bufferInfo4.offset + i5);
                            ...
                            while (true) {
                                ...
                                if (bArr[i6] == b && bArr[i6 - 1] == 0 && bArr[i6 - 2] == 0) {
                                    int i7 = i6 - 3;
                                    if (bArr[i7] == 0) {
                                        byteBufferAllocate = ByteBuffer.allocate(i7);
                                        byteBufferAllocate2 = ByteBuffer.allocate(this.videoBufferInfo.size - i7);
                                        byteBufferAllocate.put(bArr, 0, i7).position(0);
                                        byteBufferAllocate2.put(bArr, i7, this.videoBufferInfo.size - i7).position(0);
                                        break;
                                    }
                                }
                                i6--;
                    ...
                    if (bufferInfo5.size != 0) {
                        ...
                        this.fileWriteQueue.postRunnable(new Runnable(this) {
                            ...
                            public final void run() {
                                switch (i8) {
                                    case 0:
                                        this.f$0.lambda$drainEncoder$2(byteBufferCloneByteBuffer2, bufferInfo6);
                                        break;
                                    default:
    ...
    private void enableDualInternal() {
        ...
        if (cameraSessionWrapper != null) {
            ...
            cameraSessionWrapper.destroy(false, null, new CameraView$$ExternalSyntheticLambda10(this, 3));
        ...
        this.cameraSession[0].destroy(false, null, new CameraView$$ExternalSyntheticLambda14(0, this, handler2));
    ...
    public void lambda$createCamera$11(int i, CameraSession cameraSession, CameraGLThread cameraGLThread) {
        ...
        if (this.dual && i == 1 && this.initFirstCameraAfterSecond) {
            ...
            AndroidUtilities.runOnUIThread(new CameraView$$ExternalSyntheticLambda7(this, cameraGLThread, 0));
        }
    }
    ...
    public void lambda$createCamera$13(int i, SurfaceTexture surfaceTexture) {
        boolean z;
        CameraGLThread cameraGLThread = this.cameraThread;
        if (cameraGLThread == null) {
            return;
        ...
        if (this.useCamera2) {
            ...
            cameraGLThread.setCurrentSession(this.cameraSession[i], i);
            camera2SessionCreate.whenDone(new CameraView$$ExternalSyntheticLambda15(this, i, cameraGLThread));
        ...
        CameraSession cameraSession = new CameraSession(this.info[i], this.previewSize[i], this.pictureSize[i], 256, false);
    ...
    public void lambda$createCamera$9(int i, CameraGLThread cameraGLThread) {
        requestLayout();
        if (this.dual && i == 1 && this.initFirstCameraAfterSecond) {
            this.initFirstCameraAfterSecond = false;
            AndroidUtilities.runOnUIThread(new CameraView$$ExternalSyntheticLambda7(this, cameraGLThread, 1));
        }
    }
    ...
    public void onSurfaceTextureUpdatedInternal() {
        ...
        if (obj == null || AndroidUtilities$$ExternalSyntheticApiModelOutline5.m(obj).hasDisplayList()) {
            return;
        }
        invalidate();
    }
    ...
    public boolean drawChild(Canvas canvas, View view, long j) {
        ...
        if (view == this.textureView && canvas.isHardwareAccelerated() && (obj2 = this.renderNode) != null) {
            RenderNode renderNodeM = AndroidUtilities$$ExternalSyntheticApiModelOutline5.m(obj2);
        ...
        if (view == this.textureView && canvas.isHardwareAccelerated() && (obj = this.renderNode) != null) {
            RenderNode renderNodeM2 = AndroidUtilities$$ExternalSyntheticApiModelOutline5.m(obj);
            renderNodeM2.endRecording();
            canvas.drawRenderNode(renderNodeM2);
            Object obj3 = this.blurRenderNode;
            if (obj3 != null) {
                RenderNode renderNodeM3 = AndroidUtilities$$ExternalSyntheticApiModelOutline5.m(obj3);
        ...
        if (this.focusProgress != 1.0f || this.innerAlpha != 0.0f || this.outerAlpha != 0.0f) {
            ...
            float f = iDp;
            canvas.drawCircle(this.cx, this.cy, DiffUtil.m(1.0f, interpolation, f, f), this.outerPaint);
            canvas.drawCircle(this.cx, this.cy, f * interpolation, this.innerPaint);
            float f2 = this.focusProgress;
            if (f2 < 1.0f) {
                float f3 = (j2 / 200.0f) + f2;
    ...
    public boolean onSurfaceTextureDestroyed(SurfaceTexture surfaceTexture) {
        ...
        if (cameraGLThread != null) {
            ...
            this.cameraThread.postRunnable(new CameraView$$ExternalSyntheticLambda10(this, 1));
        }
        CameraSessionWrapper cameraSessionWrapper = this.cameraSession[0];
        if (cameraSessionWrapper != null) {
    ...
    public void onSurfaceTextureUpdated(SurfaceTexture surfaceTexture) {
        Object obj;
        CameraSessionWrapper cameraSessionWrapper;
        if ((this.inited || (cameraSessionWrapper = this.cameraSession[0]) == null || !cameraSessionWrapper.isInitiated()) && ((obj = this.renderNode) == null || AndroidUtilities$$ExternalSyntheticApiModelOutline5.m(obj).hasDisplayList())) {
            return;
        }
        if (Looper.myLooper() != Looper.getMainLooper()) {
            AndroidUtilities.runOnUIThread(new CameraView$$ExternalSyntheticLambda10(this, 2));
        } else {
    ...
    public void resetCamera() {
        ...
        if (cameraSessionWrapper != null) {
            ...
            this.cameraSession[0].destroy(false, null, new CameraView$$ExternalSyntheticLambda10(this, 4));
            this.cameraSession[0] = null;
        }
    }
        ...
        if (System.currentTimeMillis() >= this.toggleDualUntil || this.dualCameraAppeared) {
            if (!this.dual) {
                ...
                if (cameraSessionWrapper != null) {
                    ...
                    cameraSessionWrapper.destroy(false, null, new CameraView$$ExternalSyntheticLambda10(this, 0));
                    this.cameraSession[0] = null;
                }
    ...
    public CameraView(Context context, boolean z, boolean z2) {
        ...
        this.lastWidth = -1;
        this.lastHeight = -1;
        this.updateRotationMatrix = new CameraView$$ExternalSyntheticLambda10(this, 5);
        this.takePictureProgress = 1.0f;
    ...
    public void toggleDual(boolean z) {
        ...
        if (z2) {
            ...
            if (cameraSessionWrapper2 != null) {
                ...
                cameraSessionWrapper2.destroy(false, null, new CameraView$$ExternalSyntheticLambda10(this, 6));
