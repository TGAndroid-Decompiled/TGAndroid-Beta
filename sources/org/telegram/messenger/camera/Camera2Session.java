...
public class Camera2Session {
    ...
    public void lambda$open$1(SurfaceTexture surfaceTexture) throws CameraAccessException {
    ...
    public void lambda$destroy$3(Runnable runnable) throws InterruptedException {
        try {
            this.thread.join();
        } catch (Exception e) {
            FileLog.e(e);
