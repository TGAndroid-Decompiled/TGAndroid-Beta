...
public class NotificationCenter {
    ...
    static {
        ...
        int i112 = i111 + 1;
        totalEvents = i112;
        messageTranslated = i111;
        int i113 = i112 + 1;
        totalEvents = i113;
        messageTranslating = i112;
        int i114 = i113 + 1;
        totalEvents = i114;
        dialogIsTranslatable = i113;
        int i115 = i114 + 1;
        totalEvents = i115;
        dialogTranslate = i114;
        int i116 = i115 + 1;
        totalEvents = i116;
        didGenerateFingerprintKeyPair = i115;
        int i117 = i116 + 1;
        totalEvents = i117;
        walletPendingTransactionsChanged = i116;
        int i118 = i117 + 1;
        totalEvents = i118;
        walletSyncProgressChanged = i117;
        int i119 = i118 + 1;
        totalEvents = i119;
        httpFileDidLoad = i118;
        int i120 = i119 + 1;
        totalEvents = i120;
        httpFileDidFailedLoad = i119;
        int i121 = i120 + 1;
        totalEvents = i121;
        didUpdateConnectionState = i120;
        int i122 = i121 + 1;
        totalEvents = i122;
        fileUploaded = i121;
        int i123 = i122 + 1;
        totalEvents = i123;
        fileUploadFailed = i122;
        int i124 = i123 + 1;
        totalEvents = i124;
        fileUploadProgressChanged = i123;
        int i125 = i124 + 1;
        totalEvents = i125;
        fileLoadProgressChanged = i124;
        int i126 = i125 + 1;
        totalEvents = i126;
        fileLoaded = i125;
        int i127 = i126 + 1;
        ...
        int i128 = i127 + 1;
        totalEvents = i128;
        filePreparingStarted = i127;
        int i129 = i128 + 1;
        totalEvents = i129;
        fileNewChunkAvailable = i128;
        int i130 = i129 + 1;
        totalEvents = i130;
        filePreparingFailed = i129;
        int i131 = i130 + 1;
        totalEvents = i131;
        dialogsUnreadCounterChanged = i130;
        int i132 = i131 + 1;
        totalEvents = i132;
        messagePlayingProgressDidChanged = i131;
        int i133 = i132 + 1;
        totalEvents = i133;
        messagePlayingDidReset = i132;
        int i134 = i133 + 1;
        totalEvents = i134;
        messagePlayingPlayStateChanged = i133;
        int i135 = i134 + 1;
        totalEvents = i135;
        messagePlayingDidStart = i134;
        int i136 = i135 + 1;
        totalEvents = i136;
        messagePlayingDidSeek = i135;
        int i137 = i136 + 1;
        totalEvents = i137;
        messagePlayingGoingToStop = i136;
        int i138 = i137 + 1;
        totalEvents = i138;
        recordProgressChanged = i137;
        int i139 = i138 + 1;
        totalEvents = i139;
        recordStarted = i138;
        int i140 = i139 + 1;
        totalEvents = i140;
        recordStartError = i139;
        int i141 = i140 + 1;
        totalEvents = i141;
        recordStopped = i140;
        int i142 = i141 + 1;
        ...
        int i145 = i144 + 1;
        totalEvents = i145;
        audioRecordTooShort = i144;
        int i146 = i145 + 1;
        totalEvents = i146;
        audioRouteChanged = i145;
        int i147 = i146 + 1;
        totalEvents = i147;
        didStartedCall = i146;
        int i148 = i147 + 1;
        totalEvents = i148;
        groupCallUpdated = i147;
        int i149 = i148 + 1;
        totalEvents = i149;
        groupCallSpeakingUsersUpdated = i148;
        int i150 = i149 + 1;
        totalEvents = i150;
        groupCallScreencastStateChanged = i149;
        int i151 = i150 + 1;
        totalEvents = i151;
        activeGroupCallsUpdated = i150;
        int i152 = i151 + 1;
        totalEvents = i152;
        applyGroupCallVisibleParticipants = i151;
        int i153 = i152 + 1;
        totalEvents = i153;
        groupCallTypingsUpdated = i152;
        int i154 = i153 + 1;
        totalEvents = i154;
        didEndCall = i153;
        int i155 = i154 + 1;
        totalEvents = i155;
        closeInCallActivity = i154;
        int i156 = i155 + 1;
        totalEvents = i156;
        groupCallVisibilityChanged = i155;
        int i157 = i156 + 1;
        totalEvents = i157;
        appDidLogout = i156;
        int i158 = i157 + 1;
        ...
        int i159 = i158 + 1;
        totalEvents = i159;
        needDeleteDialog = i158;
        int i160 = i159 + 1;
        totalEvents = i160;
        newEmojiSuggestionsAvailable = i159;
        int i161 = i160 + 1;
        totalEvents = i161;
        themeUploadedToServer = i160;
        int i162 = i161 + 1;
        totalEvents = i162;
        themeUploadError = i161;
        int i163 = i162 + 1;
        totalEvents = i163;
        dialogFiltersUpdated = i162;
        int i164 = i163 + 1;
        totalEvents = i164;
        filterSettingsUpdated = i163;
        int i165 = i164 + 1;
        totalEvents = i165;
        suggestedFiltersLoaded = i164;
        int i166 = i165 + 1;
        totalEvents = i166;
        updateBotMenuButton = i165;
        int i167 = i166 + 1;
        totalEvents = i167;
        boostedChannelByUser = i166;
        int i168 = i167 + 1;
        totalEvents = i168;
        boostByChannelCreated = i167;
        int i169 = i168 + 1;
        totalEvents = i169;
        didUpdatePremiumGiftStickers = i168;
        int i170 = i169 + 1;
        totalEvents = i170;
        didUpdatePremiumGiftFieldIcon = i169;
        int i171 = i170 + 1;
        totalEvents = i171;
        storiesEnabledUpdate = i170;
        int i172 = i171 + 1;
        totalEvents = i172;
        storiesBlocklistUpdate = i171;
        int i173 = i172 + 1;
        totalEvents = i173;
        storiesLimitUpdate = i172;
        int i174 = i173 + 1;
        totalEvents = i174;
        storiesSendAsUpdate = i173;
        int i175 = i174 + 1;
        totalEvents = i175;
        unconfirmedAuthUpdate = i174;
        int i176 = i175 + 1;
        totalEvents = i176;
        dialogPhotosUpdate = i175;
        int i177 = i176 + 1;
        totalEvents = i177;
        pushMessagesUpdated = i176;
        int i178 = i177 + 1;
        totalEvents = i178;
        wallpapersDidLoad = i177;
        int i179 = i178 + 1;
        totalEvents = i179;
        wallpapersNeedReload = i178;
        int i180 = i179 + 1;
        totalEvents = i180;
        didReceiveSmsCode = i179;
        int i181 = i180 + 1;
        totalEvents = i181;
        didReceiveCall = i180;
        int i182 = i181 + 1;
        ...
        int i183 = i182 + 1;
        totalEvents = i183;
        invalidateMotionBackground = i182;
        int i184 = i183 + 1;
        totalEvents = i184;
        closeOtherAppActivities = i183;
        int i185 = i184 + 1;
        totalEvents = i185;
        cameraInitied = i184;
        int i186 = i185 + 1;
        totalEvents = i186;
        didReplacedPhotoInMemCache = i185;
        int i187 = i186 + 1;
        totalEvents = i187;
        didSetNewTheme = i186;
        int i188 = i187 + 1;
        totalEvents = i188;
        themeListUpdated = i187;
        int i189 = i188 + 1;
        totalEvents = i189;
        didApplyNewTheme = i188;
        int i190 = i189 + 1;
        totalEvents = i190;
        themeAccentListUpdated = i189;
        int i191 = i190 + 1;
        totalEvents = i191;
        needCheckSystemBarColors = i190;
        int i192 = i191 + 1;
        totalEvents = i192;
        needShareTheme = i191;
        int i193 = i192 + 1;
        totalEvents = i193;
        needSetDayNightTheme = i192;
        int i194 = i193 + 1;
        totalEvents = i194;
        goingToPreviewTheme = i193;
        int i195 = i194 + 1;
        totalEvents = i195;
        locationPermissionGranted = i194;
        int i196 = i195 + 1;
        totalEvents = i196;
        locationPermissionDenied = i195;
        int i197 = i196 + 1;
        totalEvents = i197;
        reloadInterface = i196;
        int i198 = i197 + 1;
        totalEvents = i198;
        suggestedLangpack = i197;
        int i199 = i198 + 1;
        totalEvents = i199;
        didSetNewWallpapper = i198;
        int i200 = i199 + 1;
        totalEvents = i200;
        proxySettingsChanged = i199;
        int i201 = i200 + 1;
        totalEvents = i201;
        proxyCheckDone = i200;
        int i202 = i201 + 1;
        totalEvents = i202;
        proxyChangedByRotation = i201;
        int i203 = i202 + 1;
        totalEvents = i203;
        liveLocationsChanged = i202;
        int i204 = i203 + 1;
        totalEvents = i204;
        newLocationAvailable = i203;
        int i205 = i204 + 1;
        totalEvents = i205;
        liveLocationsCacheChanged = i204;
        int i206 = i205 + 1;
        totalEvents = i206;
        notificationsCountUpdated = i205;
        int i207 = i206 + 1;
        totalEvents = i207;
        playerDidStartPlaying = i206;
        int i208 = i207 + 1;
        totalEvents = i208;
        closeSearchByActiveAction = i207;
        int i209 = i208 + 1;
        totalEvents = i209;
        messagePlayingSpeedChanged = i208;
        int i210 = i209 + 1;
        totalEvents = i210;
        screenStateChanged = i209;
        int i211 = i210 + 1;
        totalEvents = i211;
        didClearDatabase = i210;
        int i212 = i211 + 1;
        totalEvents = i212;
        voipServiceCreated = i211;
        int i213 = i212 + 1;
        totalEvents = i213;
        webRtcMicAmplitudeEvent = i212;
        int i214 = i213 + 1;
        totalEvents = i214;
        webRtcSpeakerAmplitudeEvent = i213;
        int i215 = i214 + 1;
        totalEvents = i215;
        showBulletin = i214;
        int i216 = i215 + 1;
        totalEvents = i216;
        appUpdateAvailable = i215;
        int i217 = i216 + 1;
        totalEvents = i217;
        onDatabaseMigration = i216;
        int i218 = i217 + 1;
        totalEvents = i218;
        onEmojiInteractionsReceived = i217;
        int i219 = i218 + 1;
        totalEvents = i219;
        emojiPreviewThemesChanged = i218;
        int i220 = i219 + 1;
        totalEvents = i220;
        reactionsDidLoad = i219;
        int i221 = i220 + 1;
        totalEvents = i221;
        attachMenuBotsDidLoad = i220;
        int i222 = i221 + 1;
        totalEvents = i222;
        chatAvailableReactionsUpdated = i221;
        int i223 = i222 + 1;
        totalEvents = i223;
        dialogsUnreadReactionsCounterChanged = i222;
        int i224 = i223 + 1;
        totalEvents = i224;
        onDatabaseOpened = i223;
        int i225 = i224 + 1;
        totalEvents = i225;
        onDownloadingFilesChanged = i224;
        int i226 = i225 + 1;
        totalEvents = i226;
        onActivityResultReceived = i225;
        int i227 = i226 + 1;
        totalEvents = i227;
        onRequestPermissionResultReceived = i226;
        int i228 = i227 + 1;
        totalEvents = i228;
        onUserRingtonesUpdated = i227;
        int i229 = i228 + 1;
        totalEvents = i229;
        currentUserPremiumStatusChanged = i228;
        int i230 = i229 + 1;
        totalEvents = i230;
        premiumPromoUpdated = i229;
        int i231 = i230 + 1;
        totalEvents = i231;
        premiumStatusChangedGlobal = i230;
        int i232 = i231 + 1;
        totalEvents = i232;
        currentUserShowLimitReachedDialog = i231;
        int i233 = i232 + 1;
        totalEvents = i233;
        billingProductDetailsUpdated = i232;
        int i234 = i233 + 1;
        totalEvents = i234;
        billingConfirmPurchaseError = i233;
        int i235 = i234 + 1;
        totalEvents = i235;
        premiumStickersPreviewLoaded = i234;
        int i236 = i235 + 1;
        totalEvents = i236;
        userEmojiStatusUpdated = i235;
        int i237 = i236 + 1;
        totalEvents = i237;
        requestPermissions = i236;
        int i238 = i237 + 1;
        totalEvents = i238;
        permissionsGranted = i237;
        int i239 = i238 + 1;
        totalEvents = i239;
        topicsDidLoaded = i238;
        int i240 = i239 + 1;
        totalEvents = i240;
        chatSwithcedToForum = i239;
        int i241 = i240 + 1;
        totalEvents = i241;
        didUpdateGlobalAutoDeleteTimer = i240;
        int i242 = i241 + 1;
        totalEvents = i242;
        onDatabaseReset = i241;
        int i243 = i242 + 1;
        totalEvents = i243;
        wallpaperSettedToUser = i242;
        int i244 = i243 + 1;
        totalEvents = i244;
        storiesUpdated = i243;
        int i245 = i244 + 1;
        totalEvents = i245;
        storiesListUpdated = i244;
        int i246 = i245 + 1;
        totalEvents = i246;
        storiesDraftsUpdated = i245;
        int i247 = i246 + 1;
        totalEvents = i247;
        chatlistFolderUpdate = i246;
        int i248 = i247 + 1;
        totalEvents = i248;
        uploadStoryProgress = i247;
        int i249 = i248 + 1;
        totalEvents = i249;
        uploadStoryEnd = i248;
        int i250 = i249 + 1;
        totalEvents = i250;
        customTypefacesLoaded = i249;
        int i251 = i250 + 1;
        totalEvents = i251;
        stealthModeChanged = i250;
        int i252 = i251 + 1;
        totalEvents = i252;
        onReceivedChannelDifference = i251;
        totalEvents = i252 + 1;
        storiesReadUpdated = i252;
    }
