...
public class NotificationCenter {
    ...
    static {
        ...
        int i168 = i167 + 1;
        totalEvents = i168;
        giftsToUserSent = i167;
        int i169 = i168 + 1;
        totalEvents = i169;
        didStartedMultiGiftsSelector = i168;
        int i170 = i169 + 1;
        totalEvents = i170;
        boostedChannelByUser = i169;
        int i171 = i170 + 1;
        totalEvents = i171;
        boostByChannelCreated = i170;
        int i172 = i171 + 1;
        totalEvents = i172;
        didUpdatePremiumGiftStickers = i171;
        int i173 = i172 + 1;
        totalEvents = i173;
        didUpdatePremiumGiftFieldIcon = i172;
        int i174 = i173 + 1;
        totalEvents = i174;
        storiesEnabledUpdate = i173;
        int i175 = i174 + 1;
        totalEvents = i175;
        storiesBlocklistUpdate = i174;
        int i176 = i175 + 1;
        totalEvents = i176;
        storiesLimitUpdate = i175;
        int i177 = i176 + 1;
        totalEvents = i177;
        storiesSendAsUpdate = i176;
        int i178 = i177 + 1;
        totalEvents = i178;
        unconfirmedAuthUpdate = i177;
        int i179 = i178 + 1;
        totalEvents = i179;
        dialogPhotosUpdate = i178;
        int i180 = i179 + 1;
        totalEvents = i180;
        ...
        int i183 = i182 + 1;
        totalEvents = i183;
        wallpapersDidLoad = i182;
        int i184 = i183 + 1;
        totalEvents = i184;
        wallpapersNeedReload = i183;
        int i185 = i184 + 1;
        totalEvents = i185;
        didReceiveSmsCode = i184;
        int i186 = i185 + 1;
        totalEvents = i186;
        didReceiveCall = i185;
        int i187 = i186 + 1;
        ...
        int i188 = i187 + 1;
        totalEvents = i188;
        invalidateMotionBackground = i187;
        int i189 = i188 + 1;
        totalEvents = i189;
        closeOtherAppActivities = i188;
        int i190 = i189 + 1;
        totalEvents = i190;
        cameraInitied = i189;
        int i191 = i190 + 1;
        totalEvents = i191;
        didReplacedPhotoInMemCache = i190;
        int i192 = i191 + 1;
        totalEvents = i192;
        didSetNewTheme = i191;
        int i193 = i192 + 1;
        totalEvents = i193;
        themeListUpdated = i192;
        int i194 = i193 + 1;
        totalEvents = i194;
        didApplyNewTheme = i193;
        int i195 = i194 + 1;
        totalEvents = i195;
        themeAccentListUpdated = i194;
        int i196 = i195 + 1;
        totalEvents = i196;
        needCheckSystemBarColors = i195;
        int i197 = i196 + 1;
        totalEvents = i197;
        needShareTheme = i196;
        int i198 = i197 + 1;
        totalEvents = i198;
        needSetDayNightTheme = i197;
        int i199 = i198 + 1;
        totalEvents = i199;
        goingToPreviewTheme = i198;
        int i200 = i199 + 1;
        totalEvents = i200;
        locationPermissionGranted = i199;
        int i201 = i200 + 1;
        totalEvents = i201;
        locationPermissionDenied = i200;
        int i202 = i201 + 1;
        totalEvents = i202;
        reloadInterface = i201;
        int i203 = i202 + 1;
        totalEvents = i203;
        suggestedLangpack = i202;
        int i204 = i203 + 1;
        totalEvents = i204;
        didSetNewWallpapper = i203;
        int i205 = i204 + 1;
        totalEvents = i205;
        proxySettingsChanged = i204;
        int i206 = i205 + 1;
        totalEvents = i206;
        proxyCheckDone = i205;
        int i207 = i206 + 1;
        totalEvents = i207;
        proxyChangedByRotation = i206;
        int i208 = i207 + 1;
        totalEvents = i208;
        liveLocationsChanged = i207;
        int i209 = i208 + 1;
        totalEvents = i209;
        newLocationAvailable = i208;
        int i210 = i209 + 1;
        totalEvents = i210;
        liveLocationsCacheChanged = i209;
        int i211 = i210 + 1;
        totalEvents = i211;
        notificationsCountUpdated = i210;
        int i212 = i211 + 1;
        totalEvents = i212;
        playerDidStartPlaying = i211;
        int i213 = i212 + 1;
        totalEvents = i213;
        closeSearchByActiveAction = i212;
        int i214 = i213 + 1;
        totalEvents = i214;
        messagePlayingSpeedChanged = i213;
        int i215 = i214 + 1;
        totalEvents = i215;
        screenStateChanged = i214;
        int i216 = i215 + 1;
        totalEvents = i216;
        didClearDatabase = i215;
        int i217 = i216 + 1;
        totalEvents = i217;
        voipServiceCreated = i216;
        int i218 = i217 + 1;
        totalEvents = i218;
        webRtcMicAmplitudeEvent = i217;
        int i219 = i218 + 1;
        totalEvents = i219;
        webRtcSpeakerAmplitudeEvent = i218;
        int i220 = i219 + 1;
        totalEvents = i220;
        showBulletin = i219;
        int i221 = i220 + 1;
        totalEvents = i221;
        appUpdateAvailable = i220;
        int i222 = i221 + 1;
        totalEvents = i222;
        onDatabaseMigration = i221;
        int i223 = i222 + 1;
        totalEvents = i223;
        onEmojiInteractionsReceived = i222;
        int i224 = i223 + 1;
        totalEvents = i224;
        emojiPreviewThemesChanged = i223;
        int i225 = i224 + 1;
        totalEvents = i225;
        reactionsDidLoad = i224;
        int i226 = i225 + 1;
        totalEvents = i226;
        attachMenuBotsDidLoad = i225;
        int i227 = i226 + 1;
        totalEvents = i227;
        chatAvailableReactionsUpdated = i226;
        int i228 = i227 + 1;
        totalEvents = i228;
        dialogsUnreadReactionsCounterChanged = i227;
        int i229 = i228 + 1;
        totalEvents = i229;
        onDatabaseOpened = i228;
        int i230 = i229 + 1;
        totalEvents = i230;
        onDownloadingFilesChanged = i229;
        int i231 = i230 + 1;
        totalEvents = i231;
        onActivityResultReceived = i230;
        int i232 = i231 + 1;
        totalEvents = i232;
        onRequestPermissionResultReceived = i231;
        int i233 = i232 + 1;
        totalEvents = i233;
        onUserRingtonesUpdated = i232;
        int i234 = i233 + 1;
        totalEvents = i234;
        currentUserPremiumStatusChanged = i233;
        int i235 = i234 + 1;
        totalEvents = i235;
        premiumPromoUpdated = i234;
        int i236 = i235 + 1;
        totalEvents = i236;
        premiumStatusChangedGlobal = i235;
        int i237 = i236 + 1;
        totalEvents = i237;
        currentUserShowLimitReachedDialog = i236;
        int i238 = i237 + 1;
        totalEvents = i238;
        billingProductDetailsUpdated = i237;
        int i239 = i238 + 1;
        totalEvents = i239;
        billingConfirmPurchaseError = i238;
        int i240 = i239 + 1;
        totalEvents = i240;
        premiumStickersPreviewLoaded = i239;
        int i241 = i240 + 1;
        totalEvents = i241;
        userEmojiStatusUpdated = i240;
        int i242 = i241 + 1;
        totalEvents = i242;
        requestPermissions = i241;
        int i243 = i242 + 1;
        totalEvents = i243;
        permissionsGranted = i242;
        int i244 = i243 + 1;
        totalEvents = i244;
        topicsDidLoaded = i243;
        int i245 = i244 + 1;
        totalEvents = i245;
        chatSwithcedToForum = i244;
        int i246 = i245 + 1;
        totalEvents = i246;
        didUpdateGlobalAutoDeleteTimer = i245;
        int i247 = i246 + 1;
        totalEvents = i247;
        onDatabaseReset = i246;
        int i248 = i247 + 1;
        totalEvents = i248;
        wallpaperSettedToUser = i247;
        int i249 = i248 + 1;
        totalEvents = i249;
        storiesUpdated = i248;
        int i250 = i249 + 1;
        totalEvents = i250;
        storiesListUpdated = i249;
        int i251 = i250 + 1;
        totalEvents = i251;
        storiesDraftsUpdated = i250;
        int i252 = i251 + 1;
        totalEvents = i252;
        chatlistFolderUpdate = i251;
        int i253 = i252 + 1;
        totalEvents = i253;
        uploadStoryProgress = i252;
        int i254 = i253 + 1;
        totalEvents = i254;
        uploadStoryEnd = i253;
        int i255 = i254 + 1;
        totalEvents = i255;
        customTypefacesLoaded = i254;
        int i256 = i255 + 1;
        totalEvents = i256;
        stealthModeChanged = i255;
        int i257 = i256 + 1;
        totalEvents = i257;
