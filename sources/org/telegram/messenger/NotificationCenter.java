...
public class NotificationCenter {
    ...
    static {
        ...
        int i172 = i171 + 1;
        totalEvents = i172;
        pushMessagesUpdated = i171;
        int i173 = i172 + 1;
        totalEvents = i173;
        stopEncodingService = i172;
        int i174 = i173 + 1;
        totalEvents = i174;
        wallpapersDidLoad = i173;
        int i175 = i174 + 1;
        totalEvents = i175;
        wallpapersNeedReload = i174;
        int i176 = i175 + 1;
        totalEvents = i176;
        didReceiveSmsCode = i175;
        int i177 = i176 + 1;
        totalEvents = i177;
        didReceiveCall = i176;
        int i178 = i177 + 1;
        ...
        int i179 = i178 + 1;
        totalEvents = i179;
        invalidateMotionBackground = i178;
        int i180 = i179 + 1;
        totalEvents = i180;
        closeOtherAppActivities = i179;
        int i181 = i180 + 1;
        totalEvents = i181;
        cameraInitied = i180;
        int i182 = i181 + 1;
        totalEvents = i182;
        didReplacedPhotoInMemCache = i181;
        int i183 = i182 + 1;
        totalEvents = i183;
        didSetNewTheme = i182;
        int i184 = i183 + 1;
        totalEvents = i184;
        themeListUpdated = i183;
        int i185 = i184 + 1;
        totalEvents = i185;
        didApplyNewTheme = i184;
        int i186 = i185 + 1;
        totalEvents = i186;
        themeAccentListUpdated = i185;
        int i187 = i186 + 1;
        totalEvents = i187;
        needCheckSystemBarColors = i186;
        int i188 = i187 + 1;
        totalEvents = i188;
        needShareTheme = i187;
        int i189 = i188 + 1;
        totalEvents = i189;
        needSetDayNightTheme = i188;
        int i190 = i189 + 1;
        totalEvents = i190;
        goingToPreviewTheme = i189;
        int i191 = i190 + 1;
        totalEvents = i191;
        locationPermissionGranted = i190;
        int i192 = i191 + 1;
        totalEvents = i192;
        locationPermissionDenied = i191;
        int i193 = i192 + 1;
        totalEvents = i193;
        reloadInterface = i192;
        int i194 = i193 + 1;
        totalEvents = i194;
        suggestedLangpack = i193;
        int i195 = i194 + 1;
        totalEvents = i195;
        didSetNewWallpapper = i194;
        int i196 = i195 + 1;
        totalEvents = i196;
        proxySettingsChanged = i195;
        int i197 = i196 + 1;
        totalEvents = i197;
        proxyCheckDone = i196;
        int i198 = i197 + 1;
        totalEvents = i198;
        proxyChangedByRotation = i197;
        int i199 = i198 + 1;
        totalEvents = i199;
        liveLocationsChanged = i198;
        int i200 = i199 + 1;
        totalEvents = i200;
        newLocationAvailable = i199;
        int i201 = i200 + 1;
        totalEvents = i201;
        liveLocationsCacheChanged = i200;
        int i202 = i201 + 1;
        totalEvents = i202;
        notificationsCountUpdated = i201;
        int i203 = i202 + 1;
        totalEvents = i203;
        playerDidStartPlaying = i202;
        int i204 = i203 + 1;
        totalEvents = i204;
        closeSearchByActiveAction = i203;
        int i205 = i204 + 1;
        totalEvents = i205;
        messagePlayingSpeedChanged = i204;
        int i206 = i205 + 1;
        totalEvents = i206;
        screenStateChanged = i205;
        int i207 = i206 + 1;
        totalEvents = i207;
        didClearDatabase = i206;
        int i208 = i207 + 1;
        totalEvents = i208;
        voipServiceCreated = i207;
        int i209 = i208 + 1;
        totalEvents = i209;
        webRtcMicAmplitudeEvent = i208;
        int i210 = i209 + 1;
        totalEvents = i210;
        webRtcSpeakerAmplitudeEvent = i209;
        int i211 = i210 + 1;
        totalEvents = i211;
        showBulletin = i210;
        int i212 = i211 + 1;
        totalEvents = i212;
        appUpdateAvailable = i211;
        int i213 = i212 + 1;
        totalEvents = i213;
        onDatabaseMigration = i212;
        int i214 = i213 + 1;
        totalEvents = i214;
        onEmojiInteractionsReceived = i213;
        int i215 = i214 + 1;
        totalEvents = i215;
        emojiPreviewThemesChanged = i214;
        int i216 = i215 + 1;
        totalEvents = i216;
        reactionsDidLoad = i215;
        int i217 = i216 + 1;
        totalEvents = i217;
        attachMenuBotsDidLoad = i216;
        int i218 = i217 + 1;
        totalEvents = i218;
        chatAvailableReactionsUpdated = i217;
        int i219 = i218 + 1;
        totalEvents = i219;
        dialogsUnreadReactionsCounterChanged = i218;
        int i220 = i219 + 1;
        totalEvents = i220;
        onDatabaseOpened = i219;
        int i221 = i220 + 1;
        totalEvents = i221;
        onDownloadingFilesChanged = i220;
        int i222 = i221 + 1;
        totalEvents = i222;
        onActivityResultReceived = i221;
        int i223 = i222 + 1;
        totalEvents = i223;
        onRequestPermissionResultReceived = i222;
        int i224 = i223 + 1;
        totalEvents = i224;
        onUserRingtonesUpdated = i223;
        int i225 = i224 + 1;
        totalEvents = i225;
        currentUserPremiumStatusChanged = i224;
        int i226 = i225 + 1;
        totalEvents = i226;
        premiumPromoUpdated = i225;
        int i227 = i226 + 1;
        totalEvents = i227;
        premiumStatusChangedGlobal = i226;
        int i228 = i227 + 1;
        totalEvents = i228;
        currentUserShowLimitReachedDialog = i227;
        int i229 = i228 + 1;
        totalEvents = i229;
        billingProductDetailsUpdated = i228;
        int i230 = i229 + 1;
        totalEvents = i230;
        billingConfirmPurchaseError = i229;
        int i231 = i230 + 1;
        totalEvents = i231;
        premiumStickersPreviewLoaded = i230;
        int i232 = i231 + 1;
        totalEvents = i232;
        userEmojiStatusUpdated = i231;
        int i233 = i232 + 1;
        totalEvents = i233;
        requestPermissions = i232;
        int i234 = i233 + 1;
        totalEvents = i234;
        permissionsGranted = i233;
        int i235 = i234 + 1;
        totalEvents = i235;
        topicsDidLoaded = i234;
        int i236 = i235 + 1;
        totalEvents = i236;
        chatSwithcedToForum = i235;
        int i237 = i236 + 1;
        totalEvents = i237;
        didUpdateGlobalAutoDeleteTimer = i236;
        int i238 = i237 + 1;
        totalEvents = i238;
        onDatabaseReset = i237;
        int i239 = i238 + 1;
        totalEvents = i239;
        wallpaperSettedToUser = i238;
        int i240 = i239 + 1;
        totalEvents = i240;
        storiesUpdated = i239;
        int i241 = i240 + 1;
        totalEvents = i241;
        storiesListUpdated = i240;
        int i242 = i241 + 1;
        totalEvents = i242;
        storiesDraftsUpdated = i241;
        int i243 = i242 + 1;
        totalEvents = i243;
        chatlistFolderUpdate = i242;
        int i244 = i243 + 1;
        totalEvents = i244;
        uploadStoryProgress = i243;
        int i245 = i244 + 1;
        totalEvents = i245;
        uploadStoryEnd = i244;
        int i246 = i245 + 1;
        totalEvents = i246;
        customTypefacesLoaded = i245;
        int i247 = i246 + 1;
        totalEvents = i247;
        stealthModeChanged = i246;
        totalEvents = i247 + 1;
        onReceivedChannelDifference = i247;
    }
