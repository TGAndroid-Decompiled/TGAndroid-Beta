...
public class NotificationCenter {
    ...
    static {
        ...
        int i167 = i166 + 1;
        totalEvents = i167;
        didUpdatePremiumGiftStickers = i166;
        int i168 = i167 + 1;
        totalEvents = i168;
        didUpdatePremiumGiftFieldIcon = i167;
        int i169 = i168 + 1;
        totalEvents = i169;
        storiesEnabledUpdate = i168;
        int i170 = i169 + 1;
        totalEvents = i170;
        storiesBlocklistUpdate = i169;
        int i171 = i170 + 1;
        totalEvents = i171;
        storiesLimitUpdate = i170;
        int i172 = i171 + 1;
        totalEvents = i172;
        storiesSendAsUpdate = i171;
        int i173 = i172 + 1;
        totalEvents = i173;
        unconfirmedAuthUpdate = i172;
        int i174 = i173 + 1;
        totalEvents = i174;
        dialogPhotosUpdate = i173;
        int i175 = i174 + 1;
        totalEvents = i175;
        pushMessagesUpdated = i174;
        int i176 = i175 + 1;
        totalEvents = i176;
        stopEncodingService = i175;
        int i177 = i176 + 1;
        totalEvents = i177;
        wallpapersDidLoad = i176;
        int i178 = i177 + 1;
        totalEvents = i178;
        wallpapersNeedReload = i177;
        int i179 = i178 + 1;
        totalEvents = i179;
        didReceiveSmsCode = i178;
        int i180 = i179 + 1;
        totalEvents = i180;
        didReceiveCall = i179;
        int i181 = i180 + 1;
        ...
        int i182 = i181 + 1;
        totalEvents = i182;
        invalidateMotionBackground = i181;
        int i183 = i182 + 1;
        totalEvents = i183;
        closeOtherAppActivities = i182;
        int i184 = i183 + 1;
        totalEvents = i184;
        cameraInitied = i183;
        int i185 = i184 + 1;
        totalEvents = i185;
        didReplacedPhotoInMemCache = i184;
        int i186 = i185 + 1;
        totalEvents = i186;
        didSetNewTheme = i185;
        int i187 = i186 + 1;
        totalEvents = i187;
        themeListUpdated = i186;
        int i188 = i187 + 1;
        totalEvents = i188;
        didApplyNewTheme = i187;
        int i189 = i188 + 1;
        totalEvents = i189;
        themeAccentListUpdated = i188;
        int i190 = i189 + 1;
        totalEvents = i190;
        needCheckSystemBarColors = i189;
        int i191 = i190 + 1;
        totalEvents = i191;
        needShareTheme = i190;
        int i192 = i191 + 1;
        totalEvents = i192;
        needSetDayNightTheme = i191;
        int i193 = i192 + 1;
        totalEvents = i193;
        goingToPreviewTheme = i192;
        int i194 = i193 + 1;
        totalEvents = i194;
        locationPermissionGranted = i193;
        int i195 = i194 + 1;
        totalEvents = i195;
        locationPermissionDenied = i194;
        int i196 = i195 + 1;
        totalEvents = i196;
        reloadInterface = i195;
        int i197 = i196 + 1;
        totalEvents = i197;
        suggestedLangpack = i196;
        int i198 = i197 + 1;
        totalEvents = i198;
        didSetNewWallpapper = i197;
        int i199 = i198 + 1;
        totalEvents = i199;
        proxySettingsChanged = i198;
        int i200 = i199 + 1;
        totalEvents = i200;
        proxyCheckDone = i199;
        int i201 = i200 + 1;
        totalEvents = i201;
        proxyChangedByRotation = i200;
        int i202 = i201 + 1;
        totalEvents = i202;
        liveLocationsChanged = i201;
        int i203 = i202 + 1;
        totalEvents = i203;
        newLocationAvailable = i202;
        int i204 = i203 + 1;
        totalEvents = i204;
        liveLocationsCacheChanged = i203;
        int i205 = i204 + 1;
        totalEvents = i205;
        notificationsCountUpdated = i204;
        int i206 = i205 + 1;
        totalEvents = i206;
        playerDidStartPlaying = i205;
        int i207 = i206 + 1;
        totalEvents = i207;
        closeSearchByActiveAction = i206;
        int i208 = i207 + 1;
        totalEvents = i208;
        messagePlayingSpeedChanged = i207;
        int i209 = i208 + 1;
        totalEvents = i209;
        screenStateChanged = i208;
        int i210 = i209 + 1;
        totalEvents = i210;
        didClearDatabase = i209;
        int i211 = i210 + 1;
        totalEvents = i211;
        voipServiceCreated = i210;
        int i212 = i211 + 1;
        totalEvents = i212;
        webRtcMicAmplitudeEvent = i211;
        int i213 = i212 + 1;
        totalEvents = i213;
        webRtcSpeakerAmplitudeEvent = i212;
        int i214 = i213 + 1;
        totalEvents = i214;
        showBulletin = i213;
        int i215 = i214 + 1;
        totalEvents = i215;
        appUpdateAvailable = i214;
        int i216 = i215 + 1;
        totalEvents = i216;
        onDatabaseMigration = i215;
        int i217 = i216 + 1;
        totalEvents = i217;
        onEmojiInteractionsReceived = i216;
        int i218 = i217 + 1;
        totalEvents = i218;
        emojiPreviewThemesChanged = i217;
        int i219 = i218 + 1;
        totalEvents = i219;
        reactionsDidLoad = i218;
        int i220 = i219 + 1;
        totalEvents = i220;
        attachMenuBotsDidLoad = i219;
        int i221 = i220 + 1;
        totalEvents = i221;
        chatAvailableReactionsUpdated = i220;
        int i222 = i221 + 1;
        totalEvents = i222;
        dialogsUnreadReactionsCounterChanged = i221;
        int i223 = i222 + 1;
        totalEvents = i223;
        onDatabaseOpened = i222;
        int i224 = i223 + 1;
        totalEvents = i224;
        onDownloadingFilesChanged = i223;
        int i225 = i224 + 1;
        totalEvents = i225;
        onActivityResultReceived = i224;
        int i226 = i225 + 1;
        totalEvents = i226;
        onRequestPermissionResultReceived = i225;
        int i227 = i226 + 1;
        totalEvents = i227;
        onUserRingtonesUpdated = i226;
        int i228 = i227 + 1;
        totalEvents = i228;
        currentUserPremiumStatusChanged = i227;
        int i229 = i228 + 1;
        totalEvents = i229;
        premiumPromoUpdated = i228;
        int i230 = i229 + 1;
        totalEvents = i230;
        premiumStatusChangedGlobal = i229;
        int i231 = i230 + 1;
        totalEvents = i231;
        currentUserShowLimitReachedDialog = i230;
        int i232 = i231 + 1;
        totalEvents = i232;
        billingProductDetailsUpdated = i231;
        int i233 = i232 + 1;
        totalEvents = i233;
        billingConfirmPurchaseError = i232;
        int i234 = i233 + 1;
        totalEvents = i234;
        premiumStickersPreviewLoaded = i233;
        int i235 = i234 + 1;
        totalEvents = i235;
        userEmojiStatusUpdated = i234;
        int i236 = i235 + 1;
        totalEvents = i236;
        requestPermissions = i235;
        int i237 = i236 + 1;
        totalEvents = i237;
        permissionsGranted = i236;
        int i238 = i237 + 1;
        totalEvents = i238;
        topicsDidLoaded = i237;
        int i239 = i238 + 1;
        totalEvents = i239;
        chatSwithcedToForum = i238;
        int i240 = i239 + 1;
        totalEvents = i240;
        didUpdateGlobalAutoDeleteTimer = i239;
        int i241 = i240 + 1;
        totalEvents = i241;
        onDatabaseReset = i240;
        int i242 = i241 + 1;
        totalEvents = i242;
        wallpaperSettedToUser = i241;
        int i243 = i242 + 1;
        totalEvents = i243;
        storiesUpdated = i242;
        int i244 = i243 + 1;
        totalEvents = i244;
        storiesListUpdated = i243;
        int i245 = i244 + 1;
        totalEvents = i245;
        storiesDraftsUpdated = i244;
        int i246 = i245 + 1;
        totalEvents = i246;
        chatlistFolderUpdate = i245;
        int i247 = i246 + 1;
        totalEvents = i247;
        uploadStoryProgress = i246;
        int i248 = i247 + 1;
        totalEvents = i248;
        uploadStoryEnd = i247;
        int i249 = i248 + 1;
        totalEvents = i249;
        customTypefacesLoaded = i248;
        int i250 = i249 + 1;
        totalEvents = i250;
        stealthModeChanged = i249;
        totalEvents = i250 + 1;
        onReceivedChannelDifference = i250;
    }
