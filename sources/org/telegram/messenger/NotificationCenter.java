...
public class NotificationCenter {
    ...
    public static final int activityPermissionsGranted = 295;
    ...
    public static final int appUpdateAvailable = 271;
    public static final int appUpdateLoading = 272;
    ...
    public static final int attachMenuBotsDidLoad = 277;
    ...
    public static final int billingConfirmPurchaseError = 290;
    public static final int billingProductDetailsUpdated = 289;
    ...
    public static final int cameraInitied = 240;
    ...
    public static final int chatAvailableReactionsUpdated = 278;
    ...
    public static final int chatSwithcedToForum = 297;
    public static final int chatWasBoostedByUser = 203;
    public static final int chatlistFolderUpdate = 304;
    public static final int closeChats = 4;
    public static final int closeInCallActivity = 169;
    public static final int closeOtherAppActivities = 239;
    public static final int closeSearchByActiveAction = 263;
    ...
    public static final int currentUserPremiumStatusChanged = 285;
    public static final int currentUserShowLimitReachedDialog = 288;
    public static final int customStickerCreated = 206;
    public static final int customTypefacesLoaded = 307;
    ...
    public static final int dialogsUnreadReactionsCounterChanged = 279;
    public static final int diceStickersDidLoad = 58;
    public static final int didApplyNewTheme = 244;
    public static final int didClearDatabase = 266;
    ...
    public static final int didReceiveCall = 236;
    public static final int didReceiveNewMessages = 1;
    public static final int didReceiveSmsCode = 235;
    ...
    public static final int didReplacedPhotoInMemCache = 241;
    public static final int didSetNewTheme = 242;
    public static final int didSetNewWallpapper = 254;
    ...
    public static final int didUpdateGlobalAutoDeleteTimer = 298;
    ...
    public static final int emojiLoaded = 237;
    public static final int emojiPreviewThemesChanged = 275;
    ...
    public static final int goingToPreviewTheme = 249;
    ...
    public static final int invalidateMotionBackground = 238;
    public static final int liveLocationsCacheChanged = 260;
    public static final int liveLocationsChanged = 258;
    public static final int loadingMessagesFailed = 16;
    public static final int locationPermissionDenied = 251;
    public static final int locationPermissionGranted = 250;
    ...
    public static final int messagePlayingSpeedChanged = 264;
    ...
    public static final int nearEarEvent = 311;
    public static final int needAddArchivedStickers = 83;
    public static final int needCheckSystemBarColors = 246;
    ...
    public static final int needSetDayNightTheme = 248;
    public static final int needShareTheme = 247;
    ...
    public static final int newLocationAvailable = 259;
    ...
    public static final int notificationsCountUpdated = 261;
    public static final int notificationsSettingsUpdated = 39;
    public static final int onActivityResultReceived = 282;
    public static final int onDatabaseMigration = 273;
    public static final int onDatabaseOpened = 280;
    public static final int onDatabaseReset = 299;
    public static final int onDownloadingFilesChanged = 281;
    public static final int onEmojiInteractionsReceived = 274;
    public static final int onReceivedChannelDifference = 309;
    public static final int onRequestPermissionResultReceived = 283;
    public static final int onUserRingtonesUpdated = 284;
    ...
    public static final int permissionsGranted = 294;
    public static final int pinnedInfoDidLoad = 65;
    public static final int playerDidStartPlaying = 262;
    public static final int premiumFloodWaitReceived = 207;
    public static final int premiumPromoUpdated = 286;
    public static final int premiumStatusChangedGlobal = 287;
    public static final int premiumStickersPreviewLoaded = 291;
    public static final int privacyRulesUpdated = 44;
    public static final int proxyChangedByRotation = 257;
    public static final int proxyCheckDone = 256;
    public static final int proxySettingsChanged = 255;
    public static final int pushMessagesUpdated = 232;
    public static final int quickRepliesDeleted = 118;
    public static final int quickRepliesUpdated = 117;
    public static final int reactionsDidLoad = 276;
    ...
    public static final int reloadInterface = 252;
    ...
    public static final int requestPermissions = 293;
    ...
    public static final int stealthModeChanged = 308;
    ...
    public static final int storiesDraftsUpdated = 303;
    public static final int storiesEnabledUpdate = 187;
    public static final int storiesLimitUpdate = 189;
    public static final int storiesListUpdated = 302;
    public static final int storiesReadUpdated = 310;
    public static final int storiesSendAsUpdate = 190;
    public static final int storiesUpdated = 301;
    public static final int storyQualityUpdate = 200;
    public static final int suggestedFiltersLoaded = 179;
    public static final int suggestedLangpack = 253;
    public static final int themeAccentListUpdated = 245;
    public static final int themeListUpdated = 243;
    ...
    public static final int topicsDidLoaded = 296;
    private static int totalEvents = 312;
    ...
    public static final int uploadStoryEnd = 306;
    public static final int uploadStoryProgress = 305;
    public static final int userEmojiStatusUpdated = 292;
    ...
    public static final int voipServiceCreated = 267;
    public static final int walletPendingTransactionsChanged = 129;
    public static final int walletSyncProgressChanged = 130;
    public static final int wallpaperSettedToUser = 300;
    public static final int wallpapersDidLoad = 233;
    public static final int wallpapersNeedReload = 234;
    public static final int wasUnableToFindCurrentLocation = 77;
    public static final int webRtcMicAmplitudeEvent = 268;
    public static final int webRtcSpeakerAmplitudeEvent = 269;
