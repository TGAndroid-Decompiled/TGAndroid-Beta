...
public class NotificationCenter {
    ...
    public static final int activityPermissionsGranted = 283;
    ...
    public static final int appUpdateAvailable = 260;
    ...
    public static final int attachMenuBotsDidLoad = 265;
    ...
    public static final int billingConfirmPurchaseError = 278;
    public static final int billingProductDetailsUpdated = 277;
    ...
    public static final int cameraInitied = 229;
    ...
    public static final int chatAvailableReactionsUpdated = 266;
    ...
    public static final int chatSwithcedToForum = 285;
    public static final int chatWasBoostedByUser = 203;
    public static final int chatlistFolderUpdate = 292;
    public static final int closeChats = 4;
    public static final int closeInCallActivity = 169;
    public static final int closeOtherAppActivities = 228;
    public static final int closeSearchByActiveAction = 252;
    ...
    public static final int currentUserPremiumStatusChanged = 273;
    public static final int currentUserShowLimitReachedDialog = 276;
    public static final int customStickerCreated = 206;
    public static final int customTypefacesLoaded = 295;
    ...
    public static final int dialogsUnreadReactionsCounterChanged = 267;
    public static final int diceStickersDidLoad = 58;
    public static final int didApplyNewTheme = 233;
    public static final int didClearDatabase = 255;
    ...
    public static final int didReceiveCall = 225;
    public static final int didReceiveNewMessages = 1;
    public static final int didReceiveSmsCode = 224;
    ...
    public static final int didReplacedPhotoInMemCache = 230;
    public static final int didSetNewTheme = 231;
    public static final int didSetNewWallpapper = 243;
    ...
    public static final int didUpdateGlobalAutoDeleteTimer = 286;
    ...
    public static final int emojiLoaded = 226;
    public static final int emojiPreviewThemesChanged = 263;
    ...
    public static final int goingToPreviewTheme = 238;
    ...
    public static final int invalidateMotionBackground = 227;
    public static final int liveLocationsCacheChanged = 249;
    public static final int liveLocationsChanged = 247;
    public static final int loadingMessagesFailed = 16;
    public static final int locationPermissionDenied = 240;
    public static final int locationPermissionGranted = 239;
    ...
    public static final int messagePlayingSpeedChanged = 253;
    ...
    public static final int nearEarEvent = 299;
    public static final int needAddArchivedStickers = 83;
    public static final int needCheckSystemBarColors = 235;
    ...
    public static final int needSetDayNightTheme = 237;
    public static final int needShareTheme = 236;
    ...
    public static final int newLocationAvailable = 248;
    ...
    public static final int notificationsCountUpdated = 250;
    public static final int notificationsSettingsUpdated = 39;
    public static final int onActivityResultReceived = 270;
    public static final int onDatabaseMigration = 261;
    public static final int onDatabaseOpened = 268;
    public static final int onDatabaseReset = 287;
    public static final int onDownloadingFilesChanged = 269;
    public static final int onEmojiInteractionsReceived = 262;
    public static final int onReceivedChannelDifference = 297;
    public static final int onRequestPermissionResultReceived = 271;
    public static final int onUserRingtonesUpdated = 272;
    ...
    public static final int permissionsGranted = 282;
    public static final int pinnedInfoDidLoad = 65;
    public static final int playerDidStartPlaying = 251;
    public static final int premiumFloodWaitReceived = 207;
    public static final int premiumPromoUpdated = 274;
    public static final int premiumStatusChangedGlobal = 275;
    public static final int premiumStickersPreviewLoaded = 279;
    public static final int privacyRulesUpdated = 44;
    public static final int proxyChangedByRotation = 246;
    public static final int proxyCheckDone = 245;
    public static final int proxySettingsChanged = 244;
    public static final int pushMessagesUpdated = 221;
    public static final int quickRepliesDeleted = 118;
    public static final int quickRepliesUpdated = 117;
    public static final int reactionsDidLoad = 264;
    ...
    public static final int reloadInterface = 241;
    ...
    public static final int requestPermissions = 281;
    ...
    public static final int stealthModeChanged = 296;
    ...
    public static final int storiesDraftsUpdated = 291;
    public static final int storiesEnabledUpdate = 187;
    public static final int storiesLimitUpdate = 189;
    public static final int storiesListUpdated = 290;
    public static final int storiesReadUpdated = 298;
    public static final int storiesSendAsUpdate = 190;
    public static final int storiesUpdated = 289;
    public static final int storyQualityUpdate = 200;
    public static final int suggestedFiltersLoaded = 179;
    public static final int suggestedLangpack = 242;
    public static final int themeAccentListUpdated = 234;
    public static final int themeListUpdated = 232;
    ...
    public static final int topicsDidLoaded = 284;
    private static int totalEvents = 300;
    ...
    public static final int uploadStoryEnd = 294;
    public static final int uploadStoryProgress = 293;
    public static final int userEmojiStatusUpdated = 280;
    ...
    public static final int voipServiceCreated = 256;
    public static final int walletPendingTransactionsChanged = 129;
    public static final int walletSyncProgressChanged = 130;
    public static final int wallpaperSettedToUser = 288;
    public static final int wallpapersDidLoad = 222;
    public static final int wallpapersNeedReload = 223;
    public static final int wasUnableToFindCurrentLocation = 77;
    public static final int webRtcMicAmplitudeEvent = 257;
    public static final int webRtcSpeakerAmplitudeEvent = 258;
