...
public class NotificationCenter {
    ...
    static {
        ...
        int i113 = i112 + 1;
        totalEvents = i113;
        messageTranslated = i112;
        int i114 = i113 + 1;
        totalEvents = i114;
        messageTranslating = i113;
        int i115 = i114 + 1;
        totalEvents = i115;
        dialogIsTranslatable = i114;
        int i116 = i115 + 1;
        totalEvents = i116;
        dialogTranslate = i115;
        int i117 = i116 + 1;
        totalEvents = i117;
        didGenerateFingerprintKeyPair = i116;
        int i118 = i117 + 1;
        totalEvents = i118;
        walletPendingTransactionsChanged = i117;
        int i119 = i118 + 1;
        totalEvents = i119;
        walletSyncProgressChanged = i118;
        int i120 = i119 + 1;
        totalEvents = i120;
        httpFileDidLoad = i119;
        int i121 = i120 + 1;
        totalEvents = i121;
        httpFileDidFailedLoad = i120;
        int i122 = i121 + 1;
        totalEvents = i122;
        didUpdateConnectionState = i121;
        int i123 = i122 + 1;
        totalEvents = i123;
        fileUploaded = i122;
        int i124 = i123 + 1;
        totalEvents = i124;
        fileUploadFailed = i123;
        int i125 = i124 + 1;
        totalEvents = i125;
        fileUploadProgressChanged = i124;
        int i126 = i125 + 1;
        totalEvents = i126;
        fileLoadProgressChanged = i125;
        int i127 = i126 + 1;
        totalEvents = i127;
        fileLoaded = i126;
        int i128 = i127 + 1;
        ...
        int i129 = i128 + 1;
        totalEvents = i129;
        filePreparingStarted = i128;
        int i130 = i129 + 1;
        totalEvents = i130;
        fileNewChunkAvailable = i129;
        int i131 = i130 + 1;
        totalEvents = i131;
        filePreparingFailed = i130;
        int i132 = i131 + 1;
        totalEvents = i132;
        dialogsUnreadCounterChanged = i131;
        int i133 = i132 + 1;
        totalEvents = i133;
        messagePlayingProgressDidChanged = i132;
        int i134 = i133 + 1;
        totalEvents = i134;
        messagePlayingDidReset = i133;
        int i135 = i134 + 1;
        totalEvents = i135;
        messagePlayingPlayStateChanged = i134;
        int i136 = i135 + 1;
        totalEvents = i136;
        messagePlayingDidStart = i135;
        int i137 = i136 + 1;
        totalEvents = i137;
        messagePlayingDidSeek = i136;
        int i138 = i137 + 1;
        totalEvents = i138;
        messagePlayingGoingToStop = i137;
        int i139 = i138 + 1;
        totalEvents = i139;
        recordProgressChanged = i138;
        int i140 = i139 + 1;
        totalEvents = i140;
        recordStarted = i139;
        int i141 = i140 + 1;
        totalEvents = i141;
        recordStartError = i140;
        int i142 = i141 + 1;
        totalEvents = i142;
        recordStopped = i141;
        int i143 = i142 + 1;
        ...
        int i148 = i147 + 1;
        totalEvents = i148;
        audioRecordTooShort = i147;
        int i149 = i148 + 1;
        totalEvents = i149;
        audioRouteChanged = i148;
        int i150 = i149 + 1;
        totalEvents = i150;
        didStartedCall = i149;
        int i151 = i150 + 1;
        totalEvents = i151;
        groupCallUpdated = i150;
        int i152 = i151 + 1;
        totalEvents = i152;
        groupCallSpeakingUsersUpdated = i151;
        int i153 = i152 + 1;
        totalEvents = i153;
        groupCallScreencastStateChanged = i152;
        int i154 = i153 + 1;
        totalEvents = i154;
        activeGroupCallsUpdated = i153;
        int i155 = i154 + 1;
        totalEvents = i155;
        applyGroupCallVisibleParticipants = i154;
        int i156 = i155 + 1;
        totalEvents = i156;
        groupCallTypingsUpdated = i155;
        int i157 = i156 + 1;
        totalEvents = i157;
        didEndCall = i156;
        int i158 = i157 + 1;
        totalEvents = i158;
        closeInCallActivity = i157;
        int i159 = i158 + 1;
        totalEvents = i159;
        groupCallVisibilityChanged = i158;
        int i160 = i159 + 1;
        totalEvents = i160;
        appDidLogout = i159;
        int i161 = i160 + 1;
        ...
        int i162 = i161 + 1;
        totalEvents = i162;
        needDeleteDialog = i161;
        int i163 = i162 + 1;
        totalEvents = i163;
        newEmojiSuggestionsAvailable = i162;
        int i164 = i163 + 1;
        totalEvents = i164;
        themeUploadedToServer = i163;
        int i165 = i164 + 1;
        totalEvents = i165;
        themeUploadError = i164;
        int i166 = i165 + 1;
        totalEvents = i166;
        dialogFiltersUpdated = i165;
        int i167 = i166 + 1;
        totalEvents = i167;
        filterSettingsUpdated = i166;
        int i168 = i167 + 1;
        totalEvents = i168;
        suggestedFiltersLoaded = i167;
        int i169 = i168 + 1;
        totalEvents = i169;
        updateBotMenuButton = i168;
        int i170 = i169 + 1;
        totalEvents = i170;
        giftsToUserSent = i169;
        int i171 = i170 + 1;
        totalEvents = i171;
        didStartedMultiGiftsSelector = i170;
        int i172 = i171 + 1;
        totalEvents = i172;
        boostedChannelByUser = i171;
        int i173 = i172 + 1;
        totalEvents = i173;
        boostByChannelCreated = i172;
        int i174 = i173 + 1;
        totalEvents = i174;
        didUpdatePremiumGiftStickers = i173;
        int i175 = i174 + 1;
        totalEvents = i175;
        didUpdatePremiumGiftFieldIcon = i174;
        int i176 = i175 + 1;
        totalEvents = i176;
        storiesEnabledUpdate = i175;
        int i177 = i176 + 1;
        totalEvents = i177;
        storiesBlocklistUpdate = i176;
        int i178 = i177 + 1;
        totalEvents = i178;
        storiesLimitUpdate = i177;
        int i179 = i178 + 1;
        totalEvents = i179;
        storiesSendAsUpdate = i178;
        int i180 = i179 + 1;
        totalEvents = i180;
        unconfirmedAuthUpdate = i179;
        int i181 = i180 + 1;
        totalEvents = i181;
        dialogPhotosUpdate = i180;
        int i182 = i181 + 1;
        totalEvents = i182;
        channelRecommendationsLoaded = i181;
        int i183 = i182 + 1;
        totalEvents = i183;
        savedMessagesDialogsUpdate = i182;
        int i184 = i183 + 1;
        totalEvents = i184;
        ...
        int i186 = i185 + 1;
        totalEvents = i186;
        savedMessagesForwarded = i185;
        int i187 = i186 + 1;
        totalEvents = i187;
        emojiKeywordsLoaded = i186;
        int i188 = i187 + 1;
        totalEvents = i188;
        smsJobStatusUpdate = i187;
        int i189 = i188 + 1;
        totalEvents = i189;
        storyQualityUpdate = i188;
        int i190 = i189 + 1;
        totalEvents = i190;
        openBoostForUsersDialog = i189;
        int i191 = i190 + 1;
        totalEvents = i191;
        groupRestrictionsUnlockedByBoosts = i190;
        int i192 = i191 + 1;
        totalEvents = i192;
        chatWasBoostedByUser = i191;
        int i193 = i192 + 1;
        totalEvents = i193;
        groupPackUpdated = i192;
        int i194 = i193 + 1;
        totalEvents = i194;
        pushMessagesUpdated = i193;
        int i195 = i194 + 1;
        totalEvents = i195;
        wallpapersDidLoad = i194;
        int i196 = i195 + 1;
        totalEvents = i196;
        wallpapersNeedReload = i195;
        int i197 = i196 + 1;
        totalEvents = i197;
        didReceiveSmsCode = i196;
        int i198 = i197 + 1;
        totalEvents = i198;
        didReceiveCall = i197;
        int i199 = i198 + 1;
        ...
        int i200 = i199 + 1;
        totalEvents = i200;
        invalidateMotionBackground = i199;
        int i201 = i200 + 1;
        totalEvents = i201;
        closeOtherAppActivities = i200;
        int i202 = i201 + 1;
        totalEvents = i202;
        cameraInitied = i201;
        int i203 = i202 + 1;
        totalEvents = i203;
        didReplacedPhotoInMemCache = i202;
        int i204 = i203 + 1;
        totalEvents = i204;
        didSetNewTheme = i203;
        int i205 = i204 + 1;
        totalEvents = i205;
        themeListUpdated = i204;
        int i206 = i205 + 1;
        totalEvents = i206;
        didApplyNewTheme = i205;
        int i207 = i206 + 1;
        totalEvents = i207;
        themeAccentListUpdated = i206;
        int i208 = i207 + 1;
        totalEvents = i208;
        needCheckSystemBarColors = i207;
        int i209 = i208 + 1;
        totalEvents = i209;
        needShareTheme = i208;
        int i210 = i209 + 1;
        totalEvents = i210;
        needSetDayNightTheme = i209;
        int i211 = i210 + 1;
        totalEvents = i211;
        goingToPreviewTheme = i210;
        int i212 = i211 + 1;
        totalEvents = i212;
        locationPermissionGranted = i211;
        int i213 = i212 + 1;
        totalEvents = i213;
        locationPermissionDenied = i212;
        int i214 = i213 + 1;
        totalEvents = i214;
        reloadInterface = i213;
        int i215 = i214 + 1;
        totalEvents = i215;
        suggestedLangpack = i214;
        int i216 = i215 + 1;
        totalEvents = i216;
        didSetNewWallpapper = i215;
        int i217 = i216 + 1;
        totalEvents = i217;
        proxySettingsChanged = i216;
        int i218 = i217 + 1;
        totalEvents = i218;
        proxyCheckDone = i217;
        int i219 = i218 + 1;
        totalEvents = i219;
        proxyChangedByRotation = i218;
        int i220 = i219 + 1;
        totalEvents = i220;
        liveLocationsChanged = i219;
        int i221 = i220 + 1;
        totalEvents = i221;
        newLocationAvailable = i220;
        int i222 = i221 + 1;
        totalEvents = i222;
        liveLocationsCacheChanged = i221;
        int i223 = i222 + 1;
        totalEvents = i223;
        notificationsCountUpdated = i222;
        int i224 = i223 + 1;
        totalEvents = i224;
        playerDidStartPlaying = i223;
        int i225 = i224 + 1;
        totalEvents = i225;
        closeSearchByActiveAction = i224;
        int i226 = i225 + 1;
        totalEvents = i226;
        messagePlayingSpeedChanged = i225;
        int i227 = i226 + 1;
        totalEvents = i227;
        screenStateChanged = i226;
        int i228 = i227 + 1;
        totalEvents = i228;
        didClearDatabase = i227;
        int i229 = i228 + 1;
        totalEvents = i229;
        voipServiceCreated = i228;
        int i230 = i229 + 1;
        totalEvents = i230;
        webRtcMicAmplitudeEvent = i229;
        int i231 = i230 + 1;
        totalEvents = i231;
        webRtcSpeakerAmplitudeEvent = i230;
        int i232 = i231 + 1;
        totalEvents = i232;
        showBulletin = i231;
        int i233 = i232 + 1;
        totalEvents = i233;
        appUpdateAvailable = i232;
        int i234 = i233 + 1;
        totalEvents = i234;
        onDatabaseMigration = i233;
        int i235 = i234 + 1;
        totalEvents = i235;
        onEmojiInteractionsReceived = i234;
        int i236 = i235 + 1;
        totalEvents = i236;
        emojiPreviewThemesChanged = i235;
        int i237 = i236 + 1;
        totalEvents = i237;
        reactionsDidLoad = i236;
        int i238 = i237 + 1;
        totalEvents = i238;
        attachMenuBotsDidLoad = i237;
        int i239 = i238 + 1;
        totalEvents = i239;
        chatAvailableReactionsUpdated = i238;
        int i240 = i239 + 1;
        totalEvents = i240;
        dialogsUnreadReactionsCounterChanged = i239;
        int i241 = i240 + 1;
        totalEvents = i241;
        onDatabaseOpened = i240;
        int i242 = i241 + 1;
        totalEvents = i242;
        onDownloadingFilesChanged = i241;
        int i243 = i242 + 1;
        totalEvents = i243;
        onActivityResultReceived = i242;
        int i244 = i243 + 1;
        totalEvents = i244;
        onRequestPermissionResultReceived = i243;
        int i245 = i244 + 1;
        totalEvents = i245;
        onUserRingtonesUpdated = i244;
        int i246 = i245 + 1;
        totalEvents = i246;
        currentUserPremiumStatusChanged = i245;
        int i247 = i246 + 1;
        totalEvents = i247;
        premiumPromoUpdated = i246;
        int i248 = i247 + 1;
        totalEvents = i248;
        premiumStatusChangedGlobal = i247;
        int i249 = i248 + 1;
        totalEvents = i249;
        currentUserShowLimitReachedDialog = i248;
        int i250 = i249 + 1;
        totalEvents = i250;
        billingProductDetailsUpdated = i249;
        int i251 = i250 + 1;
        totalEvents = i251;
        billingConfirmPurchaseError = i250;
        int i252 = i251 + 1;
        totalEvents = i252;
        premiumStickersPreviewLoaded = i251;
        int i253 = i252 + 1;
        totalEvents = i253;
        userEmojiStatusUpdated = i252;
        int i254 = i253 + 1;
        totalEvents = i254;
        requestPermissions = i253;
        int i255 = i254 + 1;
        totalEvents = i255;
        permissionsGranted = i254;
        int i256 = i255 + 1;
        totalEvents = i256;
        topicsDidLoaded = i255;
        int i257 = i256 + 1;
        totalEvents = i257;
        chatSwithcedToForum = i256;
        int i258 = i257 + 1;
        totalEvents = i258;
        didUpdateGlobalAutoDeleteTimer = i257;
        int i259 = i258 + 1;
        totalEvents = i259;
        onDatabaseReset = i258;
        int i260 = i259 + 1;
        totalEvents = i260;
        wallpaperSettedToUser = i259;
        int i261 = i260 + 1;
        totalEvents = i261;
        storiesUpdated = i260;
        int i262 = i261 + 1;
        totalEvents = i262;
        storiesListUpdated = i261;
        int i263 = i262 + 1;
        totalEvents = i263;
        storiesDraftsUpdated = i262;
        int i264 = i263 + 1;
        totalEvents = i264;
        chatlistFolderUpdate = i263;
        int i265 = i264 + 1;
        totalEvents = i265;
        uploadStoryProgress = i264;
        int i266 = i265 + 1;
        totalEvents = i266;
        uploadStoryEnd = i265;
        int i267 = i266 + 1;
        totalEvents = i267;
        customTypefacesLoaded = i266;
        int i268 = i267 + 1;
        totalEvents = i268;
        stealthModeChanged = i267;
        int i269 = i268 + 1;
        totalEvents = i269;
        onReceivedChannelDifference = i268;
        int i270 = i269 + 1;
        totalEvents = i270;
        storiesReadUpdated = i269;
        totalEvents = i270 + 1;
        nearEarEvent = i270;
    }
