...
public class NotificationCenter {
    ...
    static {
        ...
        int i188 = i187 + 1;
        totalEvents = i188;
        storyQualityUpdate = i187;
        int i189 = i188 + 1;
        totalEvents = i189;
        openBoostForUsersDialog = i188;
        int i190 = i189 + 1;
        totalEvents = i190;
        groupRestrictionsUnlockedByBoosts = i189;
        int i191 = i190 + 1;
        totalEvents = i191;
        chatWasBoostedByUser = i190;
        int i192 = i191 + 1;
        totalEvents = i192;
        groupPackUpdated = i191;
        int i193 = i192 + 1;
        totalEvents = i193;
        pushMessagesUpdated = i192;
        int i194 = i193 + 1;
        totalEvents = i194;
        wallpapersDidLoad = i193;
        int i195 = i194 + 1;
        totalEvents = i195;
        wallpapersNeedReload = i194;
        int i196 = i195 + 1;
        totalEvents = i196;
        didReceiveSmsCode = i195;
        int i197 = i196 + 1;
        totalEvents = i197;
        didReceiveCall = i196;
        int i198 = i197 + 1;
        ...
        int i199 = i198 + 1;
        totalEvents = i199;
        invalidateMotionBackground = i198;
        int i200 = i199 + 1;
        totalEvents = i200;
        closeOtherAppActivities = i199;
        int i201 = i200 + 1;
        totalEvents = i201;
        cameraInitied = i200;
        int i202 = i201 + 1;
        totalEvents = i202;
        didReplacedPhotoInMemCache = i201;
        int i203 = i202 + 1;
        totalEvents = i203;
        didSetNewTheme = i202;
        int i204 = i203 + 1;
        totalEvents = i204;
        themeListUpdated = i203;
        int i205 = i204 + 1;
        totalEvents = i205;
        didApplyNewTheme = i204;
        int i206 = i205 + 1;
        totalEvents = i206;
        themeAccentListUpdated = i205;
        int i207 = i206 + 1;
        totalEvents = i207;
        needCheckSystemBarColors = i206;
        int i208 = i207 + 1;
        totalEvents = i208;
        needShareTheme = i207;
        int i209 = i208 + 1;
        totalEvents = i209;
        needSetDayNightTheme = i208;
        int i210 = i209 + 1;
        totalEvents = i210;
        goingToPreviewTheme = i209;
        int i211 = i210 + 1;
        totalEvents = i211;
        locationPermissionGranted = i210;
        int i212 = i211 + 1;
        totalEvents = i212;
        locationPermissionDenied = i211;
        int i213 = i212 + 1;
        totalEvents = i213;
        reloadInterface = i212;
        int i214 = i213 + 1;
        totalEvents = i214;
        suggestedLangpack = i213;
        int i215 = i214 + 1;
        totalEvents = i215;
        didSetNewWallpapper = i214;
        int i216 = i215 + 1;
        totalEvents = i216;
        proxySettingsChanged = i215;
        int i217 = i216 + 1;
        totalEvents = i217;
        proxyCheckDone = i216;
        int i218 = i217 + 1;
        totalEvents = i218;
        proxyChangedByRotation = i217;
        int i219 = i218 + 1;
        totalEvents = i219;
        liveLocationsChanged = i218;
        int i220 = i219 + 1;
        totalEvents = i220;
        newLocationAvailable = i219;
        int i221 = i220 + 1;
        totalEvents = i221;
        liveLocationsCacheChanged = i220;
        int i222 = i221 + 1;
        totalEvents = i222;
        notificationsCountUpdated = i221;
        int i223 = i222 + 1;
        totalEvents = i223;
        playerDidStartPlaying = i222;
        int i224 = i223 + 1;
        totalEvents = i224;
        closeSearchByActiveAction = i223;
        int i225 = i224 + 1;
        totalEvents = i225;
        messagePlayingSpeedChanged = i224;
        int i226 = i225 + 1;
        totalEvents = i226;
        screenStateChanged = i225;
        int i227 = i226 + 1;
        totalEvents = i227;
        didClearDatabase = i226;
        int i228 = i227 + 1;
        totalEvents = i228;
        voipServiceCreated = i227;
        int i229 = i228 + 1;
        totalEvents = i229;
        webRtcMicAmplitudeEvent = i228;
        int i230 = i229 + 1;
        totalEvents = i230;
        webRtcSpeakerAmplitudeEvent = i229;
        int i231 = i230 + 1;
        totalEvents = i231;
        showBulletin = i230;
        int i232 = i231 + 1;
        totalEvents = i232;
        appUpdateAvailable = i231;
        int i233 = i232 + 1;
        totalEvents = i233;
        onDatabaseMigration = i232;
        int i234 = i233 + 1;
        totalEvents = i234;
        onEmojiInteractionsReceived = i233;
        int i235 = i234 + 1;
        totalEvents = i235;
        emojiPreviewThemesChanged = i234;
        int i236 = i235 + 1;
        totalEvents = i236;
        reactionsDidLoad = i235;
        int i237 = i236 + 1;
        totalEvents = i237;
        attachMenuBotsDidLoad = i236;
        int i238 = i237 + 1;
        totalEvents = i238;
        chatAvailableReactionsUpdated = i237;
        int i239 = i238 + 1;
        totalEvents = i239;
        dialogsUnreadReactionsCounterChanged = i238;
        int i240 = i239 + 1;
        totalEvents = i240;
        onDatabaseOpened = i239;
        int i241 = i240 + 1;
        totalEvents = i241;
        onDownloadingFilesChanged = i240;
        int i242 = i241 + 1;
        totalEvents = i242;
        onActivityResultReceived = i241;
        int i243 = i242 + 1;
        totalEvents = i243;
        onRequestPermissionResultReceived = i242;
        int i244 = i243 + 1;
        totalEvents = i244;
        onUserRingtonesUpdated = i243;
        int i245 = i244 + 1;
        totalEvents = i245;
        currentUserPremiumStatusChanged = i244;
        int i246 = i245 + 1;
        totalEvents = i246;
        premiumPromoUpdated = i245;
        int i247 = i246 + 1;
        totalEvents = i247;
        premiumStatusChangedGlobal = i246;
        int i248 = i247 + 1;
        totalEvents = i248;
        currentUserShowLimitReachedDialog = i247;
        int i249 = i248 + 1;
        totalEvents = i249;
        billingProductDetailsUpdated = i248;
        int i250 = i249 + 1;
        totalEvents = i250;
        billingConfirmPurchaseError = i249;
        int i251 = i250 + 1;
        totalEvents = i251;
        premiumStickersPreviewLoaded = i250;
        int i252 = i251 + 1;
        totalEvents = i252;
        userEmojiStatusUpdated = i251;
        int i253 = i252 + 1;
        totalEvents = i253;
        requestPermissions = i252;
        int i254 = i253 + 1;
        totalEvents = i254;
        permissionsGranted = i253;
        int i255 = i254 + 1;
        totalEvents = i255;
        topicsDidLoaded = i254;
        int i256 = i255 + 1;
        totalEvents = i256;
        chatSwithcedToForum = i255;
        int i257 = i256 + 1;
        totalEvents = i257;
        didUpdateGlobalAutoDeleteTimer = i256;
        int i258 = i257 + 1;
        totalEvents = i258;
        onDatabaseReset = i257;
        int i259 = i258 + 1;
        totalEvents = i259;
        wallpaperSettedToUser = i258;
        int i260 = i259 + 1;
        totalEvents = i260;
        storiesUpdated = i259;
        int i261 = i260 + 1;
        totalEvents = i261;
        storiesListUpdated = i260;
        int i262 = i261 + 1;
        totalEvents = i262;
        storiesDraftsUpdated = i261;
        int i263 = i262 + 1;
        totalEvents = i263;
        chatlistFolderUpdate = i262;
        int i264 = i263 + 1;
        totalEvents = i264;
        uploadStoryProgress = i263;
        int i265 = i264 + 1;
        totalEvents = i265;
        uploadStoryEnd = i264;
        int i266 = i265 + 1;
        totalEvents = i266;
        customTypefacesLoaded = i265;
        int i267 = i266 + 1;
        totalEvents = i267;
        stealthModeChanged = i266;
        int i268 = i267 + 1;
        totalEvents = i268;
        onReceivedChannelDifference = i267;
        int i269 = i268 + 1;
        totalEvents = i269;
        storiesReadUpdated = i268;
        totalEvents = i269 + 1;
        nearEarEvent = i269;
    }
