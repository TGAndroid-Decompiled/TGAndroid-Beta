...
public class NotificationCenter {
    ...
    static {
        ...
        int i212 = i211 + 1;
        totalEvents = i212;
        starSubscriptionsLoaded = i211;
        int i213 = i212 + 1;
        totalEvents = i213;
        factCheckLoaded = i212;
        int i214 = i213 + 1;
        totalEvents = i214;
        botStarsUpdated = i213;
        int i215 = i214 + 1;
        totalEvents = i215;
        botStarsTransactionsLoaded = i214;
        int i216 = i215 + 1;
        totalEvents = i216;
        channelStarsUpdated = i215;
        int i217 = i216 + 1;
        totalEvents = i217;
        webViewResolved = i216;
        int i218 = i217 + 1;
        totalEvents = i218;
        updateAllMessages = i217;
        int i219 = i218 + 1;
        totalEvents = i219;
        pushMessagesUpdated = i218;
        int i220 = i219 + 1;
        totalEvents = i220;
        wallpapersDidLoad = i219;
        int i221 = i220 + 1;
        totalEvents = i221;
        wallpapersNeedReload = i220;
        int i222 = i221 + 1;
        totalEvents = i222;
        didReceiveSmsCode = i221;
        int i223 = i222 + 1;
        totalEvents = i223;
        didReceiveCall = i222;
        int i224 = i223 + 1;
        ...
        int i225 = i224 + 1;
        totalEvents = i225;
        invalidateMotionBackground = i224;
        int i226 = i225 + 1;
        totalEvents = i226;
        closeOtherAppActivities = i225;
        int i227 = i226 + 1;
        totalEvents = i227;
        cameraInitied = i226;
        int i228 = i227 + 1;
        totalEvents = i228;
        didReplacedPhotoInMemCache = i227;
        int i229 = i228 + 1;
        totalEvents = i229;
        didSetNewTheme = i228;
        int i230 = i229 + 1;
        totalEvents = i230;
        themeListUpdated = i229;
        int i231 = i230 + 1;
        totalEvents = i231;
        didApplyNewTheme = i230;
        int i232 = i231 + 1;
        totalEvents = i232;
        themeAccentListUpdated = i231;
        int i233 = i232 + 1;
        totalEvents = i233;
        needCheckSystemBarColors = i232;
        int i234 = i233 + 1;
        totalEvents = i234;
        needShareTheme = i233;
        int i235 = i234 + 1;
        totalEvents = i235;
        needSetDayNightTheme = i234;
        int i236 = i235 + 1;
        totalEvents = i236;
        goingToPreviewTheme = i235;
        int i237 = i236 + 1;
        totalEvents = i237;
        locationPermissionGranted = i236;
        int i238 = i237 + 1;
        totalEvents = i238;
        locationPermissionDenied = i237;
        int i239 = i238 + 1;
        totalEvents = i239;
        reloadInterface = i238;
        int i240 = i239 + 1;
        totalEvents = i240;
        suggestedLangpack = i239;
        int i241 = i240 + 1;
        totalEvents = i241;
        didSetNewWallpapper = i240;
        int i242 = i241 + 1;
        totalEvents = i242;
        proxySettingsChanged = i241;
        int i243 = i242 + 1;
        totalEvents = i243;
        proxyCheckDone = i242;
        int i244 = i243 + 1;
        totalEvents = i244;
        proxyChangedByRotation = i243;
        int i245 = i244 + 1;
        totalEvents = i245;
        liveLocationsChanged = i244;
        int i246 = i245 + 1;
        totalEvents = i246;
        newLocationAvailable = i245;
        int i247 = i246 + 1;
        totalEvents = i247;
        liveLocationsCacheChanged = i246;
        int i248 = i247 + 1;
        totalEvents = i248;
        notificationsCountUpdated = i247;
        int i249 = i248 + 1;
        totalEvents = i249;
        playerDidStartPlaying = i248;
        int i250 = i249 + 1;
        totalEvents = i250;
        closeSearchByActiveAction = i249;
        int i251 = i250 + 1;
        totalEvents = i251;
        messagePlayingSpeedChanged = i250;
        int i252 = i251 + 1;
        totalEvents = i252;
        screenStateChanged = i251;
        int i253 = i252 + 1;
        totalEvents = i253;
        didClearDatabase = i252;
        int i254 = i253 + 1;
        totalEvents = i254;
        voipServiceCreated = i253;
        int i255 = i254 + 1;
        totalEvents = i255;
        webRtcMicAmplitudeEvent = i254;
        int i256 = i255 + 1;
        totalEvents = i256;
        webRtcSpeakerAmplitudeEvent = i255;
        int i257 = i256 + 1;
        totalEvents = i257;
        showBulletin = i256;
        int i258 = i257 + 1;
        totalEvents = i258;
        appUpdateAvailable = i257;
        int i259 = i258 + 1;
        totalEvents = i259;
        onDatabaseMigration = i258;
        int i260 = i259 + 1;
        totalEvents = i260;
        onEmojiInteractionsReceived = i259;
        int i261 = i260 + 1;
        totalEvents = i261;
        emojiPreviewThemesChanged = i260;
        int i262 = i261 + 1;
        totalEvents = i262;
        reactionsDidLoad = i261;
        int i263 = i262 + 1;
        totalEvents = i263;
        attachMenuBotsDidLoad = i262;
        int i264 = i263 + 1;
        totalEvents = i264;
        chatAvailableReactionsUpdated = i263;
        int i265 = i264 + 1;
        totalEvents = i265;
        dialogsUnreadReactionsCounterChanged = i264;
        int i266 = i265 + 1;
        totalEvents = i266;
        onDatabaseOpened = i265;
        int i267 = i266 + 1;
        totalEvents = i267;
        onDownloadingFilesChanged = i266;
        int i268 = i267 + 1;
        totalEvents = i268;
        onActivityResultReceived = i267;
        int i269 = i268 + 1;
        totalEvents = i269;
        onRequestPermissionResultReceived = i268;
        int i270 = i269 + 1;
        totalEvents = i270;
        onUserRingtonesUpdated = i269;
        int i271 = i270 + 1;
        totalEvents = i271;
        currentUserPremiumStatusChanged = i270;
        int i272 = i271 + 1;
        totalEvents = i272;
        premiumPromoUpdated = i271;
        int i273 = i272 + 1;
        totalEvents = i273;
        premiumStatusChangedGlobal = i272;
        int i274 = i273 + 1;
        totalEvents = i274;
        currentUserShowLimitReachedDialog = i273;
        int i275 = i274 + 1;
        totalEvents = i275;
        billingProductDetailsUpdated = i274;
        int i276 = i275 + 1;
        totalEvents = i276;
        billingConfirmPurchaseError = i275;
        int i277 = i276 + 1;
        totalEvents = i277;
        premiumStickersPreviewLoaded = i276;
        int i278 = i277 + 1;
        totalEvents = i278;
        userEmojiStatusUpdated = i277;
        int i279 = i278 + 1;
        totalEvents = i279;
        requestPermissions = i278;
        int i280 = i279 + 1;
        totalEvents = i280;
        permissionsGranted = i279;
        int i281 = i280 + 1;
        totalEvents = i281;
        topicsDidLoaded = i280;
        int i282 = i281 + 1;
        totalEvents = i282;
        chatSwithcedToForum = i281;
        int i283 = i282 + 1;
        totalEvents = i283;
        didUpdateGlobalAutoDeleteTimer = i282;
        int i284 = i283 + 1;
        totalEvents = i284;
        onDatabaseReset = i283;
        int i285 = i284 + 1;
        totalEvents = i285;
        wallpaperSettedToUser = i284;
        int i286 = i285 + 1;
        totalEvents = i286;
        storiesUpdated = i285;
        int i287 = i286 + 1;
        totalEvents = i287;
        storiesListUpdated = i286;
        int i288 = i287 + 1;
        totalEvents = i288;
        storiesDraftsUpdated = i287;
        int i289 = i288 + 1;
        totalEvents = i289;
        chatlistFolderUpdate = i288;
        int i290 = i289 + 1;
        totalEvents = i290;
        uploadStoryProgress = i289;
        int i291 = i290 + 1;
        totalEvents = i291;
        uploadStoryEnd = i290;
        int i292 = i291 + 1;
        totalEvents = i292;
        customTypefacesLoaded = i291;
        int i293 = i292 + 1;
        totalEvents = i293;
        stealthModeChanged = i292;
        int i294 = i293 + 1;
        totalEvents = i294;
        onReceivedChannelDifference = i293;
        int i295 = i294 + 1;
        totalEvents = i295;
        storiesReadUpdated = i294;
        totalEvents = i295 + 1;
        nearEarEvent = i295;
    }
