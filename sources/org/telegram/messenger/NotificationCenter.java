...
public class NotificationCenter {
    ...
    static {
        ...
        int i104 = i103 + 1;
        totalEvents = i104;
        didGenerateFingerprintKeyPair = i103;
        int i105 = i104 + 1;
        totalEvents = i105;
        walletPendingTransactionsChanged = i104;
        int i106 = i105 + 1;
        totalEvents = i106;
        walletSyncProgressChanged = i105;
        int i107 = i106 + 1;
        totalEvents = i107;
        httpFileDidLoad = i106;
        int i108 = i107 + 1;
        totalEvents = i108;
        httpFileDidFailedLoad = i107;
        int i109 = i108 + 1;
        totalEvents = i109;
        didUpdateConnectionState = i108;
        int i110 = i109 + 1;
        totalEvents = i110;
        fileUploaded = i109;
        int i111 = i110 + 1;
        ...
        int i154 = i153 + 1;
        totalEvents = i154;
        updateBotMenuButton = i153;
        int i155 = i154 + 1;
        totalEvents = i155;
        pushMessagesUpdated = i154;
        int i156 = i155 + 1;
        totalEvents = i156;
        stopEncodingService = i155;
        int i157 = i156 + 1;
        totalEvents = i157;
        wallpapersDidLoad = i156;
        int i158 = i157 + 1;
        totalEvents = i158;
        wallpapersNeedReload = i157;
        int i159 = i158 + 1;
        totalEvents = i159;
        didReceiveSmsCode = i158;
        int i160 = i159 + 1;
        totalEvents = i160;
        didReceiveCall = i159;
        int i161 = i160 + 1;
        ...
        int i162 = i161 + 1;
        totalEvents = i162;
        invalidateMotionBackground = i161;
        int i163 = i162 + 1;
        totalEvents = i163;
        closeOtherAppActivities = i162;
        int i164 = i163 + 1;
        totalEvents = i164;
        cameraInitied = i163;
        int i165 = i164 + 1;
        totalEvents = i165;
        didReplacedPhotoInMemCache = i164;
        int i166 = i165 + 1;
        totalEvents = i166;
        didSetNewTheme = i165;
        int i167 = i166 + 1;
        totalEvents = i167;
        themeListUpdated = i166;
        int i168 = i167 + 1;
        totalEvents = i168;
        didApplyNewTheme = i167;
        int i169 = i168 + 1;
        totalEvents = i169;
        themeAccentListUpdated = i168;
        int i170 = i169 + 1;
        totalEvents = i170;
        needCheckSystemBarColors = i169;
        int i171 = i170 + 1;
        totalEvents = i171;
        needShareTheme = i170;
        int i172 = i171 + 1;
        totalEvents = i172;
        needSetDayNightTheme = i171;
        int i173 = i172 + 1;
        totalEvents = i173;
        goingToPreviewTheme = i172;
        int i174 = i173 + 1;
        totalEvents = i174;
        locationPermissionGranted = i173;
        int i175 = i174 + 1;
        totalEvents = i175;
        locationPermissionDenied = i174;
        int i176 = i175 + 1;
        totalEvents = i176;
        reloadInterface = i175;
        int i177 = i176 + 1;
        totalEvents = i177;
        suggestedLangpack = i176;
        int i178 = i177 + 1;
        totalEvents = i178;
        didSetNewWallpapper = i177;
        int i179 = i178 + 1;
        totalEvents = i179;
        proxySettingsChanged = i178;
        int i180 = i179 + 1;
        totalEvents = i180;
        proxyCheckDone = i179;
        int i181 = i180 + 1;
        totalEvents = i181;
        liveLocationsChanged = i180;
        int i182 = i181 + 1;
        totalEvents = i182;
        newLocationAvailable = i181;
        int i183 = i182 + 1;
        totalEvents = i183;
        liveLocationsCacheChanged = i182;
        int i184 = i183 + 1;
        totalEvents = i184;
        notificationsCountUpdated = i183;
        int i185 = i184 + 1;
        totalEvents = i185;
        playerDidStartPlaying = i184;
        int i186 = i185 + 1;
        totalEvents = i186;
        closeSearchByActiveAction = i185;
        int i187 = i186 + 1;
        totalEvents = i187;
        messagePlayingSpeedChanged = i186;
        int i188 = i187 + 1;
        totalEvents = i188;
        screenStateChanged = i187;
        int i189 = i188 + 1;
        totalEvents = i189;
        didClearDatabase = i188;
        int i190 = i189 + 1;
        totalEvents = i190;
        voipServiceCreated = i189;
        int i191 = i190 + 1;
        totalEvents = i191;
        webRtcMicAmplitudeEvent = i190;
        int i192 = i191 + 1;
        totalEvents = i192;
        webRtcSpeakerAmplitudeEvent = i191;
        int i193 = i192 + 1;
        totalEvents = i193;
        showBulletin = i192;
        int i194 = i193 + 1;
        totalEvents = i194;
        appUpdateAvailable = i193;
        int i195 = i194 + 1;
        totalEvents = i195;
        onDatabaseMigration = i194;
        int i196 = i195 + 1;
        totalEvents = i196;
        onEmojiInteractionsReceived = i195;
        int i197 = i196 + 1;
        totalEvents = i197;
        emojiPreviewThemesChanged = i196;
        int i198 = i197 + 1;
        totalEvents = i198;
        reactionsDidLoad = i197;
        int i199 = i198 + 1;
        totalEvents = i199;
        attachMenuBotsDidLoad = i198;
        int i200 = i199 + 1;
        totalEvents = i200;
        chatAvailableReactionsUpdated = i199;
        int i201 = i200 + 1;
        totalEvents = i201;
        dialogsUnreadReactionsCounterChanged = i200;
        int i202 = i201 + 1;
        totalEvents = i202;
        onDatabaseOpened = i201;
        int i203 = i202 + 1;
        totalEvents = i203;
        onDownloadingFilesChanged = i202;
        int i204 = i203 + 1;
        totalEvents = i204;
        onActivityResultReceived = i203;
        int i205 = i204 + 1;
        totalEvents = i205;
    ...
    public void runDelayedNotifications() {
        if (!this.delayedPosts.isEmpty()) {
            ...
            for (int i = 0; i < this.delayedPostsTmp.size(); i++) {
                ...
                postNotificationNameInternal(delayedPost.f810id, true, delayedPost.args);
            }
            this.delayedPostsTmp.clear();
        }
