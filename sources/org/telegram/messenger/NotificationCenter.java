...
public class NotificationCenter {
    ...
    static {
        ...
        int i174 = i173 + 1;
        totalEvents = i174;
        pushMessagesUpdated = i173;
        int i175 = i174 + 1;
        totalEvents = i175;
        stopEncodingService = i174;
        int i176 = i175 + 1;
        totalEvents = i176;
        wallpapersDidLoad = i175;
        int i177 = i176 + 1;
        totalEvents = i177;
        wallpapersNeedReload = i176;
        int i178 = i177 + 1;
        totalEvents = i178;
        didReceiveSmsCode = i177;
        int i179 = i178 + 1;
        totalEvents = i179;
        didReceiveCall = i178;
        int i180 = i179 + 1;
        ...
        int i181 = i180 + 1;
        totalEvents = i181;
        invalidateMotionBackground = i180;
        int i182 = i181 + 1;
        totalEvents = i182;
        closeOtherAppActivities = i181;
        int i183 = i182 + 1;
        totalEvents = i183;
        cameraInitied = i182;
        int i184 = i183 + 1;
        totalEvents = i184;
        didReplacedPhotoInMemCache = i183;
        int i185 = i184 + 1;
        totalEvents = i185;
        didSetNewTheme = i184;
        int i186 = i185 + 1;
        totalEvents = i186;
        themeListUpdated = i185;
        int i187 = i186 + 1;
        totalEvents = i187;
        didApplyNewTheme = i186;
        int i188 = i187 + 1;
        totalEvents = i188;
        themeAccentListUpdated = i187;
        int i189 = i188 + 1;
        totalEvents = i189;
        needCheckSystemBarColors = i188;
        int i190 = i189 + 1;
        totalEvents = i190;
        needShareTheme = i189;
        int i191 = i190 + 1;
        totalEvents = i191;
        needSetDayNightTheme = i190;
        int i192 = i191 + 1;
        totalEvents = i192;
        goingToPreviewTheme = i191;
        int i193 = i192 + 1;
        totalEvents = i193;
        locationPermissionGranted = i192;
        int i194 = i193 + 1;
        totalEvents = i194;
        locationPermissionDenied = i193;
        int i195 = i194 + 1;
        totalEvents = i195;
        reloadInterface = i194;
        int i196 = i195 + 1;
        totalEvents = i196;
        suggestedLangpack = i195;
        int i197 = i196 + 1;
        totalEvents = i197;
        didSetNewWallpapper = i196;
        int i198 = i197 + 1;
        totalEvents = i198;
        proxySettingsChanged = i197;
        int i199 = i198 + 1;
        totalEvents = i199;
        proxyCheckDone = i198;
        int i200 = i199 + 1;
        totalEvents = i200;
        proxyChangedByRotation = i199;
        int i201 = i200 + 1;
        totalEvents = i201;
        liveLocationsChanged = i200;
        int i202 = i201 + 1;
        totalEvents = i202;
        newLocationAvailable = i201;
        int i203 = i202 + 1;
        totalEvents = i203;
        liveLocationsCacheChanged = i202;
        int i204 = i203 + 1;
        totalEvents = i204;
        notificationsCountUpdated = i203;
        int i205 = i204 + 1;
        totalEvents = i205;
        playerDidStartPlaying = i204;
        int i206 = i205 + 1;
        totalEvents = i206;
        closeSearchByActiveAction = i205;
        int i207 = i206 + 1;
        totalEvents = i207;
        messagePlayingSpeedChanged = i206;
        int i208 = i207 + 1;
        totalEvents = i208;
        screenStateChanged = i207;
        int i209 = i208 + 1;
        totalEvents = i209;
        didClearDatabase = i208;
        int i210 = i209 + 1;
        totalEvents = i210;
        voipServiceCreated = i209;
        int i211 = i210 + 1;
        totalEvents = i211;
        webRtcMicAmplitudeEvent = i210;
        int i212 = i211 + 1;
        totalEvents = i212;
        webRtcSpeakerAmplitudeEvent = i211;
        int i213 = i212 + 1;
        totalEvents = i213;
        showBulletin = i212;
        int i214 = i213 + 1;
        totalEvents = i214;
        appUpdateAvailable = i213;
        int i215 = i214 + 1;
        totalEvents = i215;
        onDatabaseMigration = i214;
        int i216 = i215 + 1;
        totalEvents = i216;
        onEmojiInteractionsReceived = i215;
        int i217 = i216 + 1;
        totalEvents = i217;
        emojiPreviewThemesChanged = i216;
        int i218 = i217 + 1;
        totalEvents = i218;
        reactionsDidLoad = i217;
        int i219 = i218 + 1;
        totalEvents = i219;
        attachMenuBotsDidLoad = i218;
        int i220 = i219 + 1;
        totalEvents = i220;
        chatAvailableReactionsUpdated = i219;
        int i221 = i220 + 1;
        totalEvents = i221;
        dialogsUnreadReactionsCounterChanged = i220;
        int i222 = i221 + 1;
        totalEvents = i222;
        onDatabaseOpened = i221;
        int i223 = i222 + 1;
        totalEvents = i223;
        onDownloadingFilesChanged = i222;
        int i224 = i223 + 1;
        totalEvents = i224;
        onActivityResultReceived = i223;
        int i225 = i224 + 1;
        totalEvents = i225;
        onRequestPermissionResultReceived = i224;
        int i226 = i225 + 1;
        totalEvents = i226;
        onUserRingtonesUpdated = i225;
        int i227 = i226 + 1;
        totalEvents = i227;
        currentUserPremiumStatusChanged = i226;
        int i228 = i227 + 1;
        totalEvents = i228;
        premiumPromoUpdated = i227;
        int i229 = i228 + 1;
        totalEvents = i229;
        premiumStatusChangedGlobal = i228;
        int i230 = i229 + 1;
        totalEvents = i230;
        currentUserShowLimitReachedDialog = i229;
        int i231 = i230 + 1;
        totalEvents = i231;
        billingProductDetailsUpdated = i230;
        int i232 = i231 + 1;
        totalEvents = i232;
        billingConfirmPurchaseError = i231;
        int i233 = i232 + 1;
        totalEvents = i233;
        premiumStickersPreviewLoaded = i232;
        int i234 = i233 + 1;
        totalEvents = i234;
        userEmojiStatusUpdated = i233;
        int i235 = i234 + 1;
        totalEvents = i235;
        requestPermissions = i234;
        int i236 = i235 + 1;
        totalEvents = i236;
        permissionsGranted = i235;
        int i237 = i236 + 1;
        totalEvents = i237;
        topicsDidLoaded = i236;
        int i238 = i237 + 1;
        totalEvents = i238;
        chatSwithcedToForum = i237;
        int i239 = i238 + 1;
        totalEvents = i239;
        didUpdateGlobalAutoDeleteTimer = i238;
        int i240 = i239 + 1;
        totalEvents = i240;
        onDatabaseReset = i239;
        int i241 = i240 + 1;
        totalEvents = i241;
        wallpaperSettedToUser = i240;
        int i242 = i241 + 1;
        totalEvents = i242;
        storiesUpdated = i241;
        int i243 = i242 + 1;
        totalEvents = i243;
        storiesListUpdated = i242;
        int i244 = i243 + 1;
        totalEvents = i244;
        storiesDraftsUpdated = i243;
        int i245 = i244 + 1;
        totalEvents = i245;
        chatlistFolderUpdate = i244;
        int i246 = i245 + 1;
        totalEvents = i246;
        uploadStoryProgress = i245;
        int i247 = i246 + 1;
        totalEvents = i247;
        uploadStoryEnd = i246;
        int i248 = i247 + 1;
        totalEvents = i248;
        customTypefacesLoaded = i247;
        int i249 = i248 + 1;
        totalEvents = i249;
