...
public class NotificationCenter {
    ...
    public static final int activityPermissionsGranted = 285;
    ...
    public static final int appUpdateAvailable = 262;
    ...
    public static final int attachMenuBotsDidLoad = 267;
    ...
    public static final int billingConfirmPurchaseError = 280;
    public static final int billingProductDetailsUpdated = 279;
    ...
    public static final int cameraInitied = 231;
    ...
    public static final int chatAvailableReactionsUpdated = 268;
    ...
    public static final int chatSwithcedToForum = 287;
    public static final int chatWasBoostedByUser = 203;
    public static final int chatlistFolderUpdate = 294;
    public static final int closeChats = 4;
    public static final int closeInCallActivity = 169;
    public static final int closeOtherAppActivities = 230;
    public static final int closeSearchByActiveAction = 254;
    ...
    public static final int currentUserPremiumStatusChanged = 275;
    public static final int currentUserShowLimitReachedDialog = 278;
    public static final int customStickerCreated = 206;
    public static final int customTypefacesLoaded = 297;
    ...
    public static final int dialogsUnreadReactionsCounterChanged = 269;
    public static final int diceStickersDidLoad = 58;
    public static final int didApplyNewTheme = 235;
    public static final int didClearDatabase = 257;
    ...
    public static final int didReceiveCall = 227;
    public static final int didReceiveNewMessages = 1;
    public static final int didReceiveSmsCode = 226;
    ...
    public static final int didReplacedPhotoInMemCache = 232;
    public static final int didSetNewTheme = 233;
    public static final int didSetNewWallpapper = 245;
    ...
    public static final int didUpdateGlobalAutoDeleteTimer = 288;
    ...
    public static final int emojiLoaded = 228;
    public static final int emojiPreviewThemesChanged = 265;
    ...
    public static final int goingToPreviewTheme = 240;
    ...
    public static final int invalidateMotionBackground = 229;
    public static final int liveLocationsCacheChanged = 251;
    public static final int liveLocationsChanged = 249;
    public static final int loadingMessagesFailed = 16;
    public static final int locationPermissionDenied = 242;
    public static final int locationPermissionGranted = 241;
    ...
    public static final int messagePlayingSpeedChanged = 255;
    ...
    public static final int nearEarEvent = 301;
    public static final int needAddArchivedStickers = 83;
    public static final int needCheckSystemBarColors = 237;
    ...
    public static final int needSetDayNightTheme = 239;
    public static final int needShareTheme = 238;
    ...
    public static final int newLocationAvailable = 250;
    ...
    public static final int notificationsCountUpdated = 252;
    public static final int notificationsSettingsUpdated = 39;
    public static final int onActivityResultReceived = 272;
    public static final int onDatabaseMigration = 263;
    public static final int onDatabaseOpened = 270;
    public static final int onDatabaseReset = 289;
    public static final int onDownloadingFilesChanged = 271;
    public static final int onEmojiInteractionsReceived = 264;
    public static final int onReceivedChannelDifference = 299;
    public static final int onRequestPermissionResultReceived = 273;
    public static final int onUserRingtonesUpdated = 274;
    ...
    public static final int permissionsGranted = 284;
    public static final int pinnedInfoDidLoad = 65;
    public static final int playerDidStartPlaying = 253;
    public static final int premiumFloodWaitReceived = 207;
    public static final int premiumPromoUpdated = 276;
    public static final int premiumStatusChangedGlobal = 277;
    public static final int premiumStickersPreviewLoaded = 281;
    public static final int privacyRulesUpdated = 44;
    public static final int proxyChangedByRotation = 248;
    public static final int proxyCheckDone = 247;
    public static final int proxySettingsChanged = 246;
    public static final int pushMessagesUpdated = 223;
    public static final int quickRepliesDeleted = 118;
    public static final int quickRepliesUpdated = 117;
    public static final int reactionsDidLoad = 266;
    ...
    public static final int reloadInterface = 243;
    ...
    public static final int requestPermissions = 283;
    ...
    public static final int stealthModeChanged = 298;
    ...
    public static final int storiesDraftsUpdated = 293;
    public static final int storiesEnabledUpdate = 187;
    public static final int storiesLimitUpdate = 189;
    public static final int storiesListUpdated = 292;
    public static final int storiesReadUpdated = 300;
    public static final int storiesSendAsUpdate = 190;
    public static final int storiesUpdated = 291;
    public static final int storyQualityUpdate = 200;
    public static final int suggestedFiltersLoaded = 179;
    public static final int suggestedLangpack = 244;
    public static final int themeAccentListUpdated = 236;
    public static final int themeListUpdated = 234;
    ...
    public static final int topicsDidLoaded = 286;
    private static int totalEvents = 302;
    ...
    public static final int uploadStoryEnd = 296;
    public static final int uploadStoryProgress = 295;
    public static final int userEmojiStatusUpdated = 282;
    ...
    public static final int voipServiceCreated = 258;
    public static final int walletPendingTransactionsChanged = 129;
    public static final int walletSyncProgressChanged = 130;
    public static final int wallpaperSettedToUser = 290;
    public static final int wallpapersDidLoad = 224;
    public static final int wallpapersNeedReload = 225;
    public static final int wasUnableToFindCurrentLocation = 77;
    public static final int webRtcMicAmplitudeEvent = 259;
    public static final int webRtcSpeakerAmplitudeEvent = 260;
