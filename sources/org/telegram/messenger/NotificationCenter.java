...
public class NotificationCenter {
    ...
    static {
        ...
        int i169 = i168 + 1;
        totalEvents = i169;
        pushMessagesUpdated = i168;
        int i170 = i169 + 1;
        totalEvents = i170;
        stopEncodingService = i169;
        int i171 = i170 + 1;
        totalEvents = i171;
        wallpapersDidLoad = i170;
        int i172 = i171 + 1;
        totalEvents = i172;
        wallpapersNeedReload = i171;
        int i173 = i172 + 1;
        totalEvents = i173;
        didReceiveSmsCode = i172;
        int i174 = i173 + 1;
        totalEvents = i174;
        didReceiveCall = i173;
        int i175 = i174 + 1;
        ...
        int i176 = i175 + 1;
        totalEvents = i176;
        invalidateMotionBackground = i175;
        int i177 = i176 + 1;
        totalEvents = i177;
        closeOtherAppActivities = i176;
        int i178 = i177 + 1;
        totalEvents = i178;
        cameraInitied = i177;
        int i179 = i178 + 1;
        totalEvents = i179;
        didReplacedPhotoInMemCache = i178;
        int i180 = i179 + 1;
        totalEvents = i180;
        didSetNewTheme = i179;
        int i181 = i180 + 1;
        totalEvents = i181;
        themeListUpdated = i180;
        int i182 = i181 + 1;
        totalEvents = i182;
        didApplyNewTheme = i181;
        int i183 = i182 + 1;
        totalEvents = i183;
        themeAccentListUpdated = i182;
        int i184 = i183 + 1;
        totalEvents = i184;
        needCheckSystemBarColors = i183;
        int i185 = i184 + 1;
        totalEvents = i185;
        needShareTheme = i184;
        int i186 = i185 + 1;
        totalEvents = i186;
        needSetDayNightTheme = i185;
        int i187 = i186 + 1;
        totalEvents = i187;
        goingToPreviewTheme = i186;
        int i188 = i187 + 1;
        totalEvents = i188;
        locationPermissionGranted = i187;
        int i189 = i188 + 1;
        totalEvents = i189;
        locationPermissionDenied = i188;
        int i190 = i189 + 1;
        totalEvents = i190;
        reloadInterface = i189;
        int i191 = i190 + 1;
        totalEvents = i191;
        suggestedLangpack = i190;
        int i192 = i191 + 1;
        totalEvents = i192;
        didSetNewWallpapper = i191;
        int i193 = i192 + 1;
        totalEvents = i193;
        proxySettingsChanged = i192;
        int i194 = i193 + 1;
        totalEvents = i194;
        proxyCheckDone = i193;
        int i195 = i194 + 1;
        totalEvents = i195;
        proxyChangedByRotation = i194;
        int i196 = i195 + 1;
        totalEvents = i196;
        liveLocationsChanged = i195;
        int i197 = i196 + 1;
        totalEvents = i197;
        newLocationAvailable = i196;
        int i198 = i197 + 1;
        totalEvents = i198;
        liveLocationsCacheChanged = i197;
        int i199 = i198 + 1;
        totalEvents = i199;
        notificationsCountUpdated = i198;
        int i200 = i199 + 1;
        totalEvents = i200;
        playerDidStartPlaying = i199;
        int i201 = i200 + 1;
        totalEvents = i201;
        closeSearchByActiveAction = i200;
        int i202 = i201 + 1;
        totalEvents = i202;
        messagePlayingSpeedChanged = i201;
        int i203 = i202 + 1;
        totalEvents = i203;
        screenStateChanged = i202;
        int i204 = i203 + 1;
        totalEvents = i204;
        didClearDatabase = i203;
        int i205 = i204 + 1;
        totalEvents = i205;
        voipServiceCreated = i204;
        int i206 = i205 + 1;
        totalEvents = i206;
        webRtcMicAmplitudeEvent = i205;
        int i207 = i206 + 1;
        totalEvents = i207;
        webRtcSpeakerAmplitudeEvent = i206;
        int i208 = i207 + 1;
        totalEvents = i208;
        showBulletin = i207;
        int i209 = i208 + 1;
        totalEvents = i209;
        appUpdateAvailable = i208;
        int i210 = i209 + 1;
        totalEvents = i210;
        onDatabaseMigration = i209;
        int i211 = i210 + 1;
        totalEvents = i211;
        onEmojiInteractionsReceived = i210;
        int i212 = i211 + 1;
        totalEvents = i212;
        emojiPreviewThemesChanged = i211;
        int i213 = i212 + 1;
        totalEvents = i213;
        reactionsDidLoad = i212;
        int i214 = i213 + 1;
        totalEvents = i214;
        attachMenuBotsDidLoad = i213;
        int i215 = i214 + 1;
        totalEvents = i215;
        chatAvailableReactionsUpdated = i214;
        int i216 = i215 + 1;
        totalEvents = i216;
        dialogsUnreadReactionsCounterChanged = i215;
        int i217 = i216 + 1;
        totalEvents = i217;
        onDatabaseOpened = i216;
        int i218 = i217 + 1;
        totalEvents = i218;
        onDownloadingFilesChanged = i217;
        int i219 = i218 + 1;
        totalEvents = i219;
        onActivityResultReceived = i218;
        int i220 = i219 + 1;
        totalEvents = i220;
        onRequestPermissionResultReceived = i219;
        int i221 = i220 + 1;
        totalEvents = i221;
        onUserRingtonesUpdated = i220;
        int i222 = i221 + 1;
        totalEvents = i222;
        currentUserPremiumStatusChanged = i221;
        int i223 = i222 + 1;
        totalEvents = i223;
        premiumPromoUpdated = i222;
        int i224 = i223 + 1;
        totalEvents = i224;
        premiumStatusChangedGlobal = i223;
        int i225 = i224 + 1;
        totalEvents = i225;
        currentUserShowLimitReachedDialog = i224;
        int i226 = i225 + 1;
        totalEvents = i226;
        billingProductDetailsUpdated = i225;
        int i227 = i226 + 1;
        totalEvents = i227;
        billingConfirmPurchaseError = i226;
        int i228 = i227 + 1;
        totalEvents = i228;
        premiumStickersPreviewLoaded = i227;
        int i229 = i228 + 1;
        totalEvents = i229;
        userEmojiStatusUpdated = i228;
        int i230 = i229 + 1;
        totalEvents = i230;
        requestPermissions = i229;
        int i231 = i230 + 1;
        totalEvents = i231;
        permissionsGranted = i230;
        int i232 = i231 + 1;
        totalEvents = i232;
        topicsDidLoaded = i231;
        int i233 = i232 + 1;
        totalEvents = i233;
        chatSwithcedToForum = i232;
        int i234 = i233 + 1;
        totalEvents = i234;
        didUpdateGlobalAutoDeleteTimer = i233;
        int i235 = i234 + 1;
        totalEvents = i235;
        onDatabaseReset = i234;
        int i236 = i235 + 1;
        totalEvents = i236;
        wallpaperSettedToUser = i235;
        int i237 = i236 + 1;
        totalEvents = i237;
        storiesUpdated = i236;
        int i238 = i237 + 1;
        totalEvents = i238;
        storiesListUpdated = i237;
        int i239 = i238 + 1;
        totalEvents = i239;
        storiesDraftsUpdated = i238;
        int i240 = i239 + 1;
        totalEvents = i240;
        chatlistFolderUpdate = i239;
        int i241 = i240 + 1;
        totalEvents = i241;
        uploadStoryProgress = i240;
        int i242 = i241 + 1;
        totalEvents = i242;
        uploadStoryEnd = i241;
        totalEvents = i242 + 1;
