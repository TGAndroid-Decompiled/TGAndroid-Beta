...
public class NotificationCenter {
    ...
    static {
        ...
        int i146 = i145 + 1;
        totalEvents = i146;
        audioRecordTooShort = i145;
        int i147 = i146 + 1;
        totalEvents = i147;
        audioRouteChanged = i146;
        int i148 = i147 + 1;
        totalEvents = i148;
        didStartedCall = i147;
        int i149 = i148 + 1;
        totalEvents = i149;
        groupCallUpdated = i148;
        int i150 = i149 + 1;
        totalEvents = i150;
        groupCallSpeakingUsersUpdated = i149;
        int i151 = i150 + 1;
        totalEvents = i151;
        groupCallScreencastStateChanged = i150;
        int i152 = i151 + 1;
        totalEvents = i152;
        activeGroupCallsUpdated = i151;
        int i153 = i152 + 1;
        totalEvents = i153;
        applyGroupCallVisibleParticipants = i152;
        int i154 = i153 + 1;
        totalEvents = i154;
        groupCallTypingsUpdated = i153;
        int i155 = i154 + 1;
        totalEvents = i155;
        didEndCall = i154;
        int i156 = i155 + 1;
        totalEvents = i156;
        closeInCallActivity = i155;
        int i157 = i156 + 1;
        totalEvents = i157;
        groupCallVisibilityChanged = i156;
        int i158 = i157 + 1;
        totalEvents = i158;
        appDidLogout = i157;
        int i159 = i158 + 1;
        ...
        int i160 = i159 + 1;
        totalEvents = i160;
        needDeleteDialog = i159;
        int i161 = i160 + 1;
        totalEvents = i161;
        newEmojiSuggestionsAvailable = i160;
        int i162 = i161 + 1;
        totalEvents = i162;
        themeUploadedToServer = i161;
        int i163 = i162 + 1;
        totalEvents = i163;
        themeUploadError = i162;
        int i164 = i163 + 1;
        totalEvents = i164;
        dialogFiltersUpdated = i163;
        int i165 = i164 + 1;
        totalEvents = i165;
        filterSettingsUpdated = i164;
        int i166 = i165 + 1;
        totalEvents = i166;
        suggestedFiltersLoaded = i165;
        int i167 = i166 + 1;
        totalEvents = i167;
        updateBotMenuButton = i166;
        int i168 = i167 + 1;
        totalEvents = i168;
        boostedChannelByUser = i167;
        int i169 = i168 + 1;
        totalEvents = i169;
        boostByChannelCreated = i168;
        int i170 = i169 + 1;
        totalEvents = i170;
        didUpdatePremiumGiftStickers = i169;
        int i171 = i170 + 1;
        totalEvents = i171;
        didUpdatePremiumGiftFieldIcon = i170;
        int i172 = i171 + 1;
        totalEvents = i172;
        storiesEnabledUpdate = i171;
        int i173 = i172 + 1;
        totalEvents = i173;
        storiesBlocklistUpdate = i172;
        int i174 = i173 + 1;
        totalEvents = i174;
        storiesLimitUpdate = i173;
        int i175 = i174 + 1;
        totalEvents = i175;
        storiesSendAsUpdate = i174;
        int i176 = i175 + 1;
        totalEvents = i176;
        unconfirmedAuthUpdate = i175;
        int i177 = i176 + 1;
        totalEvents = i177;
        dialogPhotosUpdate = i176;
        int i178 = i177 + 1;
        totalEvents = i178;
        channelRecommendationsLoaded = i177;
        int i179 = i178 + 1;
        totalEvents = i179;
        pushMessagesUpdated = i178;
        int i180 = i179 + 1;
        totalEvents = i180;
        wallpapersDidLoad = i179;
        int i181 = i180 + 1;
        totalEvents = i181;
        wallpapersNeedReload = i180;
        int i182 = i181 + 1;
        totalEvents = i182;
        didReceiveSmsCode = i181;
        int i183 = i182 + 1;
        totalEvents = i183;
        didReceiveCall = i182;
        int i184 = i183 + 1;
        ...
        int i185 = i184 + 1;
        totalEvents = i185;
        invalidateMotionBackground = i184;
        int i186 = i185 + 1;
        totalEvents = i186;
        closeOtherAppActivities = i185;
        int i187 = i186 + 1;
        totalEvents = i187;
        cameraInitied = i186;
        int i188 = i187 + 1;
        totalEvents = i188;
        didReplacedPhotoInMemCache = i187;
        int i189 = i188 + 1;
        totalEvents = i189;
        didSetNewTheme = i188;
        int i190 = i189 + 1;
        totalEvents = i190;
        themeListUpdated = i189;
        int i191 = i190 + 1;
        totalEvents = i191;
        didApplyNewTheme = i190;
        int i192 = i191 + 1;
        totalEvents = i192;
        themeAccentListUpdated = i191;
        int i193 = i192 + 1;
        totalEvents = i193;
        needCheckSystemBarColors = i192;
        int i194 = i193 + 1;
        totalEvents = i194;
        needShareTheme = i193;
        int i195 = i194 + 1;
        totalEvents = i195;
        needSetDayNightTheme = i194;
        int i196 = i195 + 1;
        totalEvents = i196;
        goingToPreviewTheme = i195;
        int i197 = i196 + 1;
        totalEvents = i197;
        locationPermissionGranted = i196;
        int i198 = i197 + 1;
        totalEvents = i198;
        locationPermissionDenied = i197;
        int i199 = i198 + 1;
        totalEvents = i199;
        reloadInterface = i198;
        int i200 = i199 + 1;
        totalEvents = i200;
        suggestedLangpack = i199;
        int i201 = i200 + 1;
        totalEvents = i201;
        didSetNewWallpapper = i200;
        int i202 = i201 + 1;
        totalEvents = i202;
        proxySettingsChanged = i201;
        int i203 = i202 + 1;
        totalEvents = i203;
        proxyCheckDone = i202;
        int i204 = i203 + 1;
        totalEvents = i204;
        proxyChangedByRotation = i203;
        int i205 = i204 + 1;
        totalEvents = i205;
        liveLocationsChanged = i204;
        int i206 = i205 + 1;
        totalEvents = i206;
        newLocationAvailable = i205;
        int i207 = i206 + 1;
        totalEvents = i207;
        liveLocationsCacheChanged = i206;
        int i208 = i207 + 1;
        totalEvents = i208;
        notificationsCountUpdated = i207;
        int i209 = i208 + 1;
        totalEvents = i209;
        playerDidStartPlaying = i208;
        int i210 = i209 + 1;
        totalEvents = i210;
        closeSearchByActiveAction = i209;
        int i211 = i210 + 1;
        totalEvents = i211;
        messagePlayingSpeedChanged = i210;
        int i212 = i211 + 1;
        totalEvents = i212;
        screenStateChanged = i211;
        int i213 = i212 + 1;
        totalEvents = i213;
        didClearDatabase = i212;
        int i214 = i213 + 1;
        totalEvents = i214;
        voipServiceCreated = i213;
        int i215 = i214 + 1;
        totalEvents = i215;
        webRtcMicAmplitudeEvent = i214;
        int i216 = i215 + 1;
        totalEvents = i216;
        webRtcSpeakerAmplitudeEvent = i215;
        int i217 = i216 + 1;
        totalEvents = i217;
        showBulletin = i216;
        int i218 = i217 + 1;
        totalEvents = i218;
        appUpdateAvailable = i217;
        int i219 = i218 + 1;
        totalEvents = i219;
        onDatabaseMigration = i218;
        int i220 = i219 + 1;
        totalEvents = i220;
        onEmojiInteractionsReceived = i219;
        int i221 = i220 + 1;
        totalEvents = i221;
        emojiPreviewThemesChanged = i220;
        int i222 = i221 + 1;
        totalEvents = i222;
        reactionsDidLoad = i221;
        int i223 = i222 + 1;
        totalEvents = i223;
        attachMenuBotsDidLoad = i222;
        int i224 = i223 + 1;
        totalEvents = i224;
        chatAvailableReactionsUpdated = i223;
        int i225 = i224 + 1;
        totalEvents = i225;
        dialogsUnreadReactionsCounterChanged = i224;
        int i226 = i225 + 1;
        totalEvents = i226;
        onDatabaseOpened = i225;
        int i227 = i226 + 1;
        totalEvents = i227;
        onDownloadingFilesChanged = i226;
        int i228 = i227 + 1;
        totalEvents = i228;
        onActivityResultReceived = i227;
        int i229 = i228 + 1;
        totalEvents = i229;
        onRequestPermissionResultReceived = i228;
        int i230 = i229 + 1;
        totalEvents = i230;
        onUserRingtonesUpdated = i229;
        int i231 = i230 + 1;
        totalEvents = i231;
        currentUserPremiumStatusChanged = i230;
        int i232 = i231 + 1;
        totalEvents = i232;
        premiumPromoUpdated = i231;
        int i233 = i232 + 1;
        totalEvents = i233;
        premiumStatusChangedGlobal = i232;
        int i234 = i233 + 1;
        totalEvents = i234;
        currentUserShowLimitReachedDialog = i233;
        int i235 = i234 + 1;
        totalEvents = i235;
        billingProductDetailsUpdated = i234;
        int i236 = i235 + 1;
        totalEvents = i236;
        billingConfirmPurchaseError = i235;
        int i237 = i236 + 1;
        totalEvents = i237;
        premiumStickersPreviewLoaded = i236;
        int i238 = i237 + 1;
        totalEvents = i238;
        userEmojiStatusUpdated = i237;
        int i239 = i238 + 1;
        totalEvents = i239;
        requestPermissions = i238;
        int i240 = i239 + 1;
        totalEvents = i240;
        permissionsGranted = i239;
        int i241 = i240 + 1;
        totalEvents = i241;
        topicsDidLoaded = i240;
        int i242 = i241 + 1;
        totalEvents = i242;
        chatSwithcedToForum = i241;
        int i243 = i242 + 1;
        totalEvents = i243;
        didUpdateGlobalAutoDeleteTimer = i242;
        int i244 = i243 + 1;
        totalEvents = i244;
        onDatabaseReset = i243;
        int i245 = i244 + 1;
        totalEvents = i245;
        wallpaperSettedToUser = i244;
        int i246 = i245 + 1;
        totalEvents = i246;
        storiesUpdated = i245;
        int i247 = i246 + 1;
        totalEvents = i247;
        storiesListUpdated = i246;
        int i248 = i247 + 1;
        totalEvents = i248;
        storiesDraftsUpdated = i247;
        int i249 = i248 + 1;
        totalEvents = i249;
        chatlistFolderUpdate = i248;
        int i250 = i249 + 1;
        totalEvents = i250;
        uploadStoryProgress = i249;
        int i251 = i250 + 1;
        totalEvents = i251;
        uploadStoryEnd = i250;
        int i252 = i251 + 1;
        totalEvents = i252;
        customTypefacesLoaded = i251;
        int i253 = i252 + 1;
        totalEvents = i253;
        stealthModeChanged = i252;
        int i254 = i253 + 1;
        totalEvents = i254;
        onReceivedChannelDifference = i253;
        totalEvents = i254 + 1;
        storiesReadUpdated = i254;
    }
