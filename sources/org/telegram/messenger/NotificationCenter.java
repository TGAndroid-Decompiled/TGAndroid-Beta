...
public class NotificationCenter {
    ...
    static {
        ...
        int i116 = i115 + 1;
        totalEvents = i116;
        businessLinksUpdated = i115;
        int i117 = i116 + 1;
        totalEvents = i117;
        businessLinkCreated = i116;
        int i118 = i117 + 1;
        totalEvents = i118;
        needDeleteBusinessLink = i117;
        int i119 = i118 + 1;
        totalEvents = i119;
        messageTranslated = i118;
        int i120 = i119 + 1;
        totalEvents = i120;
        messageTranslating = i119;
        int i121 = i120 + 1;
        totalEvents = i121;
        dialogIsTranslatable = i120;
        int i122 = i121 + 1;
        totalEvents = i122;
        dialogTranslate = i121;
        int i123 = i122 + 1;
        totalEvents = i123;
        didGenerateFingerprintKeyPair = i122;
        int i124 = i123 + 1;
        totalEvents = i124;
        walletPendingTransactionsChanged = i123;
        int i125 = i124 + 1;
        totalEvents = i125;
        walletSyncProgressChanged = i124;
        int i126 = i125 + 1;
        totalEvents = i126;
        httpFileDidLoad = i125;
        int i127 = i126 + 1;
        totalEvents = i127;
        httpFileDidFailedLoad = i126;
        int i128 = i127 + 1;
        totalEvents = i128;
        didUpdateConnectionState = i127;
        int i129 = i128 + 1;
        totalEvents = i129;
        fileUploaded = i128;
        int i130 = i129 + 1;
        totalEvents = i130;
        fileUploadFailed = i129;
        int i131 = i130 + 1;
        totalEvents = i131;
        fileUploadProgressChanged = i130;
        int i132 = i131 + 1;
        totalEvents = i132;
        fileLoadProgressChanged = i131;
        int i133 = i132 + 1;
        totalEvents = i133;
        fileLoaded = i132;
        int i134 = i133 + 1;
        ...
        int i135 = i134 + 1;
        totalEvents = i135;
        filePreparingStarted = i134;
        int i136 = i135 + 1;
        totalEvents = i136;
        fileNewChunkAvailable = i135;
        int i137 = i136 + 1;
        totalEvents = i137;
        filePreparingFailed = i136;
        int i138 = i137 + 1;
        totalEvents = i138;
        dialogsUnreadCounterChanged = i137;
        int i139 = i138 + 1;
        totalEvents = i139;
        messagePlayingProgressDidChanged = i138;
        int i140 = i139 + 1;
        totalEvents = i140;
        messagePlayingDidReset = i139;
        int i141 = i140 + 1;
        totalEvents = i141;
        messagePlayingPlayStateChanged = i140;
        int i142 = i141 + 1;
        totalEvents = i142;
        messagePlayingDidStart = i141;
        int i143 = i142 + 1;
        totalEvents = i143;
        messagePlayingDidSeek = i142;
        int i144 = i143 + 1;
        totalEvents = i144;
        messagePlayingGoingToStop = i143;
        int i145 = i144 + 1;
        totalEvents = i145;
        recordProgressChanged = i144;
        int i146 = i145 + 1;
        totalEvents = i146;
        recordStarted = i145;
        int i147 = i146 + 1;
        totalEvents = i147;
        recordStartError = i146;
        int i148 = i147 + 1;
        totalEvents = i148;
        recordStopped = i147;
        int i149 = i148 + 1;
        ...
        int i154 = i153 + 1;
        totalEvents = i154;
        audioRecordTooShort = i153;
        int i155 = i154 + 1;
        totalEvents = i155;
        audioRouteChanged = i154;
        int i156 = i155 + 1;
        totalEvents = i156;
        didStartedCall = i155;
        int i157 = i156 + 1;
        totalEvents = i157;
        groupCallUpdated = i156;
        int i158 = i157 + 1;
        totalEvents = i158;
        groupCallSpeakingUsersUpdated = i157;
        int i159 = i158 + 1;
        totalEvents = i159;
        groupCallScreencastStateChanged = i158;
        int i160 = i159 + 1;
        totalEvents = i160;
        activeGroupCallsUpdated = i159;
        int i161 = i160 + 1;
        totalEvents = i161;
        applyGroupCallVisibleParticipants = i160;
        int i162 = i161 + 1;
        totalEvents = i162;
        groupCallTypingsUpdated = i161;
        int i163 = i162 + 1;
        totalEvents = i163;
        didEndCall = i162;
        int i164 = i163 + 1;
        totalEvents = i164;
        closeInCallActivity = i163;
        int i165 = i164 + 1;
        totalEvents = i165;
        groupCallVisibilityChanged = i164;
        int i166 = i165 + 1;
        totalEvents = i166;
        appDidLogout = i165;
        int i167 = i166 + 1;
        ...
        int i168 = i167 + 1;
        totalEvents = i168;
        needDeleteDialog = i167;
        int i169 = i168 + 1;
        totalEvents = i169;
        newEmojiSuggestionsAvailable = i168;
        int i170 = i169 + 1;
        totalEvents = i170;
        themeUploadedToServer = i169;
        int i171 = i170 + 1;
        totalEvents = i171;
        themeUploadError = i170;
        int i172 = i171 + 1;
        totalEvents = i172;
        dialogFiltersUpdated = i171;
        int i173 = i172 + 1;
        totalEvents = i173;
        filterSettingsUpdated = i172;
        int i174 = i173 + 1;
        totalEvents = i174;
        suggestedFiltersLoaded = i173;
        int i175 = i174 + 1;
        totalEvents = i175;
        updateBotMenuButton = i174;
        int i176 = i175 + 1;
        totalEvents = i176;
        giftsToUserSent = i175;
        int i177 = i176 + 1;
        totalEvents = i177;
        didStartedMultiGiftsSelector = i176;
        int i178 = i177 + 1;
        totalEvents = i178;
        boostedChannelByUser = i177;
        int i179 = i178 + 1;
        totalEvents = i179;
        boostByChannelCreated = i178;
        int i180 = i179 + 1;
        totalEvents = i180;
        didUpdatePremiumGiftStickers = i179;
        int i181 = i180 + 1;
        totalEvents = i181;
        didUpdatePremiumGiftFieldIcon = i180;
        int i182 = i181 + 1;
        totalEvents = i182;
        storiesEnabledUpdate = i181;
        int i183 = i182 + 1;
        totalEvents = i183;
        storiesBlocklistUpdate = i182;
        int i184 = i183 + 1;
        totalEvents = i184;
        storiesLimitUpdate = i183;
        int i185 = i184 + 1;
        totalEvents = i185;
        storiesSendAsUpdate = i184;
        int i186 = i185 + 1;
        totalEvents = i186;
        unconfirmedAuthUpdate = i185;
        int i187 = i186 + 1;
        totalEvents = i187;
        dialogPhotosUpdate = i186;
        int i188 = i187 + 1;
        totalEvents = i188;
        channelRecommendationsLoaded = i187;
        int i189 = i188 + 1;
        totalEvents = i189;
        savedMessagesDialogsUpdate = i188;
        int i190 = i189 + 1;
        totalEvents = i190;
        savedReactionTagsUpdate = i189;
        int i191 = i190 + 1;
        totalEvents = i191;
        userIsPremiumBlockedUpadted = i190;
        int i192 = i191 + 1;
        totalEvents = i192;
        savedMessagesForwarded = i191;
        int i193 = i192 + 1;
        totalEvents = i193;
        emojiKeywordsLoaded = i192;
        int i194 = i193 + 1;
        totalEvents = i194;
        smsJobStatusUpdate = i193;
        int i195 = i194 + 1;
        totalEvents = i195;
        storyQualityUpdate = i194;
        int i196 = i195 + 1;
        totalEvents = i196;
        openBoostForUsersDialog = i195;
        int i197 = i196 + 1;
        totalEvents = i197;
        groupRestrictionsUnlockedByBoosts = i196;
        int i198 = i197 + 1;
        totalEvents = i198;
        chatWasBoostedByUser = i197;
        int i199 = i198 + 1;
        totalEvents = i199;
        groupPackUpdated = i198;
        int i200 = i199 + 1;
        totalEvents = i200;
        timezonesUpdated = i199;
        int i201 = i200 + 1;
        totalEvents = i201;
        customStickerCreated = i200;
        int i202 = i201 + 1;
        totalEvents = i202;
        premiumFloodWaitReceived = i201;
        int i203 = i202 + 1;
        totalEvents = i203;
        pushMessagesUpdated = i202;
        int i204 = i203 + 1;
        totalEvents = i204;
        wallpapersDidLoad = i203;
        int i205 = i204 + 1;
        totalEvents = i205;
        wallpapersNeedReload = i204;
        int i206 = i205 + 1;
        totalEvents = i206;
        didReceiveSmsCode = i205;
        int i207 = i206 + 1;
        totalEvents = i207;
        didReceiveCall = i206;
        int i208 = i207 + 1;
        ...
        int i209 = i208 + 1;
        totalEvents = i209;
        invalidateMotionBackground = i208;
        int i210 = i209 + 1;
        totalEvents = i210;
        closeOtherAppActivities = i209;
        int i211 = i210 + 1;
        totalEvents = i211;
        cameraInitied = i210;
        int i212 = i211 + 1;
        totalEvents = i212;
        didReplacedPhotoInMemCache = i211;
        int i213 = i212 + 1;
        totalEvents = i213;
        didSetNewTheme = i212;
        int i214 = i213 + 1;
        totalEvents = i214;
        themeListUpdated = i213;
        int i215 = i214 + 1;
        totalEvents = i215;
        didApplyNewTheme = i214;
        int i216 = i215 + 1;
        totalEvents = i216;
        themeAccentListUpdated = i215;
        int i217 = i216 + 1;
        totalEvents = i217;
        needCheckSystemBarColors = i216;
        int i218 = i217 + 1;
        totalEvents = i218;
        needShareTheme = i217;
        int i219 = i218 + 1;
        totalEvents = i219;
        needSetDayNightTheme = i218;
        int i220 = i219 + 1;
        totalEvents = i220;
        goingToPreviewTheme = i219;
        int i221 = i220 + 1;
        totalEvents = i221;
        locationPermissionGranted = i220;
        int i222 = i221 + 1;
        totalEvents = i222;
        locationPermissionDenied = i221;
        int i223 = i222 + 1;
        totalEvents = i223;
        reloadInterface = i222;
        int i224 = i223 + 1;
        totalEvents = i224;
        suggestedLangpack = i223;
        int i225 = i224 + 1;
        totalEvents = i225;
        didSetNewWallpapper = i224;
        int i226 = i225 + 1;
        totalEvents = i226;
        proxySettingsChanged = i225;
        int i227 = i226 + 1;
        totalEvents = i227;
        proxyCheckDone = i226;
        int i228 = i227 + 1;
        totalEvents = i228;
        proxyChangedByRotation = i227;
        int i229 = i228 + 1;
        totalEvents = i229;
        liveLocationsChanged = i228;
        int i230 = i229 + 1;
        totalEvents = i230;
        newLocationAvailable = i229;
        int i231 = i230 + 1;
        totalEvents = i231;
        liveLocationsCacheChanged = i230;
        int i232 = i231 + 1;
        totalEvents = i232;
        notificationsCountUpdated = i231;
        int i233 = i232 + 1;
        totalEvents = i233;
        playerDidStartPlaying = i232;
        int i234 = i233 + 1;
        totalEvents = i234;
        closeSearchByActiveAction = i233;
        int i235 = i234 + 1;
        totalEvents = i235;
        messagePlayingSpeedChanged = i234;
        int i236 = i235 + 1;
        totalEvents = i236;
        screenStateChanged = i235;
        int i237 = i236 + 1;
        totalEvents = i237;
        didClearDatabase = i236;
        int i238 = i237 + 1;
        totalEvents = i238;
        voipServiceCreated = i237;
        int i239 = i238 + 1;
        totalEvents = i239;
        webRtcMicAmplitudeEvent = i238;
        int i240 = i239 + 1;
        totalEvents = i240;
        webRtcSpeakerAmplitudeEvent = i239;
        int i241 = i240 + 1;
        totalEvents = i241;
        showBulletin = i240;
        int i242 = i241 + 1;
        totalEvents = i242;
        appUpdateAvailable = i241;
        int i243 = i242 + 1;
        totalEvents = i243;
        onDatabaseMigration = i242;
        int i244 = i243 + 1;
        totalEvents = i244;
        onEmojiInteractionsReceived = i243;
        int i245 = i244 + 1;
        totalEvents = i245;
        emojiPreviewThemesChanged = i244;
        int i246 = i245 + 1;
        totalEvents = i246;
        reactionsDidLoad = i245;
        int i247 = i246 + 1;
        totalEvents = i247;
        attachMenuBotsDidLoad = i246;
        int i248 = i247 + 1;
        totalEvents = i248;
        chatAvailableReactionsUpdated = i247;
        int i249 = i248 + 1;
        totalEvents = i249;
        dialogsUnreadReactionsCounterChanged = i248;
        int i250 = i249 + 1;
        totalEvents = i250;
        onDatabaseOpened = i249;
        int i251 = i250 + 1;
        totalEvents = i251;
        onDownloadingFilesChanged = i250;
        int i252 = i251 + 1;
        totalEvents = i252;
        onActivityResultReceived = i251;
        int i253 = i252 + 1;
        totalEvents = i253;
        onRequestPermissionResultReceived = i252;
        int i254 = i253 + 1;
        totalEvents = i254;
        onUserRingtonesUpdated = i253;
        int i255 = i254 + 1;
        totalEvents = i255;
        currentUserPremiumStatusChanged = i254;
        int i256 = i255 + 1;
        totalEvents = i256;
        premiumPromoUpdated = i255;
        int i257 = i256 + 1;
        totalEvents = i257;
        premiumStatusChangedGlobal = i256;
        int i258 = i257 + 1;
        totalEvents = i258;
        currentUserShowLimitReachedDialog = i257;
        int i259 = i258 + 1;
        totalEvents = i259;
        billingProductDetailsUpdated = i258;
        int i260 = i259 + 1;
        totalEvents = i260;
        billingConfirmPurchaseError = i259;
        int i261 = i260 + 1;
        totalEvents = i261;
        premiumStickersPreviewLoaded = i260;
        int i262 = i261 + 1;
        totalEvents = i262;
        userEmojiStatusUpdated = i261;
        int i263 = i262 + 1;
        totalEvents = i263;
        requestPermissions = i262;
        int i264 = i263 + 1;
        totalEvents = i264;
        permissionsGranted = i263;
        int i265 = i264 + 1;
        totalEvents = i265;
        topicsDidLoaded = i264;
        int i266 = i265 + 1;
        totalEvents = i266;
        chatSwithcedToForum = i265;
        int i267 = i266 + 1;
        totalEvents = i267;
        didUpdateGlobalAutoDeleteTimer = i266;
        int i268 = i267 + 1;
        totalEvents = i268;
        onDatabaseReset = i267;
        int i269 = i268 + 1;
        totalEvents = i269;
        wallpaperSettedToUser = i268;
        int i270 = i269 + 1;
        totalEvents = i270;
        storiesUpdated = i269;
        int i271 = i270 + 1;
        totalEvents = i271;
        storiesListUpdated = i270;
        int i272 = i271 + 1;
        totalEvents = i272;
        storiesDraftsUpdated = i271;
        int i273 = i272 + 1;
        totalEvents = i273;
        chatlistFolderUpdate = i272;
        int i274 = i273 + 1;
        totalEvents = i274;
        uploadStoryProgress = i273;
        int i275 = i274 + 1;
        totalEvents = i275;
        uploadStoryEnd = i274;
        int i276 = i275 + 1;
        totalEvents = i276;
        customTypefacesLoaded = i275;
        int i277 = i276 + 1;
        totalEvents = i277;
        stealthModeChanged = i276;
        int i278 = i277 + 1;
        totalEvents = i278;
        onReceivedChannelDifference = i277;
        int i279 = i278 + 1;
        totalEvents = i279;
        storiesReadUpdated = i278;
        totalEvents = i279 + 1;
        nearEarEvent = i279;
    }
