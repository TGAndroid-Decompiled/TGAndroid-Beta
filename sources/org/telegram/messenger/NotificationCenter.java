...
public class NotificationCenter {
    ...
    static {
        ...
        int i189 = i188 + 1;
        totalEvents = i189;
        pushMessagesUpdated = i188;
        int i190 = i189 + 1;
        totalEvents = i190;
        wallpapersDidLoad = i189;
        int i191 = i190 + 1;
        totalEvents = i191;
        wallpapersNeedReload = i190;
        int i192 = i191 + 1;
        totalEvents = i192;
        didReceiveSmsCode = i191;
        int i193 = i192 + 1;
        totalEvents = i193;
        didReceiveCall = i192;
        int i194 = i193 + 1;
        ...
        int i195 = i194 + 1;
        totalEvents = i195;
        invalidateMotionBackground = i194;
        int i196 = i195 + 1;
        totalEvents = i196;
        closeOtherAppActivities = i195;
        int i197 = i196 + 1;
        totalEvents = i197;
        cameraInitied = i196;
        int i198 = i197 + 1;
        totalEvents = i198;
        didReplacedPhotoInMemCache = i197;
        int i199 = i198 + 1;
        totalEvents = i199;
        didSetNewTheme = i198;
        int i200 = i199 + 1;
        totalEvents = i200;
        themeListUpdated = i199;
        int i201 = i200 + 1;
        totalEvents = i201;
        didApplyNewTheme = i200;
        int i202 = i201 + 1;
        totalEvents = i202;
        themeAccentListUpdated = i201;
        int i203 = i202 + 1;
        totalEvents = i203;
        needCheckSystemBarColors = i202;
        int i204 = i203 + 1;
        totalEvents = i204;
        needShareTheme = i203;
        int i205 = i204 + 1;
        totalEvents = i205;
        needSetDayNightTheme = i204;
        int i206 = i205 + 1;
        totalEvents = i206;
        goingToPreviewTheme = i205;
        int i207 = i206 + 1;
        totalEvents = i207;
        locationPermissionGranted = i206;
        int i208 = i207 + 1;
        totalEvents = i208;
        locationPermissionDenied = i207;
        int i209 = i208 + 1;
        totalEvents = i209;
        reloadInterface = i208;
        int i210 = i209 + 1;
        totalEvents = i210;
        suggestedLangpack = i209;
        int i211 = i210 + 1;
        totalEvents = i211;
        didSetNewWallpapper = i210;
        int i212 = i211 + 1;
        totalEvents = i212;
        proxySettingsChanged = i211;
        int i213 = i212 + 1;
        totalEvents = i213;
        proxyCheckDone = i212;
        int i214 = i213 + 1;
        totalEvents = i214;
        proxyChangedByRotation = i213;
        int i215 = i214 + 1;
        totalEvents = i215;
        liveLocationsChanged = i214;
        int i216 = i215 + 1;
        totalEvents = i216;
        newLocationAvailable = i215;
        int i217 = i216 + 1;
        totalEvents = i217;
        liveLocationsCacheChanged = i216;
        int i218 = i217 + 1;
        totalEvents = i218;
        notificationsCountUpdated = i217;
        int i219 = i218 + 1;
        totalEvents = i219;
        playerDidStartPlaying = i218;
        int i220 = i219 + 1;
        totalEvents = i220;
        closeSearchByActiveAction = i219;
        int i221 = i220 + 1;
        totalEvents = i221;
        messagePlayingSpeedChanged = i220;
        int i222 = i221 + 1;
        totalEvents = i222;
        screenStateChanged = i221;
        int i223 = i222 + 1;
        totalEvents = i223;
        didClearDatabase = i222;
        int i224 = i223 + 1;
        totalEvents = i224;
        voipServiceCreated = i223;
        int i225 = i224 + 1;
        totalEvents = i225;
        webRtcMicAmplitudeEvent = i224;
        int i226 = i225 + 1;
        totalEvents = i226;
        webRtcSpeakerAmplitudeEvent = i225;
        int i227 = i226 + 1;
        totalEvents = i227;
        showBulletin = i226;
        int i228 = i227 + 1;
        totalEvents = i228;
        appUpdateAvailable = i227;
        int i229 = i228 + 1;
        totalEvents = i229;
        onDatabaseMigration = i228;
        int i230 = i229 + 1;
        totalEvents = i230;
        onEmojiInteractionsReceived = i229;
        int i231 = i230 + 1;
        totalEvents = i231;
        emojiPreviewThemesChanged = i230;
        int i232 = i231 + 1;
        totalEvents = i232;
        reactionsDidLoad = i231;
        int i233 = i232 + 1;
        totalEvents = i233;
        attachMenuBotsDidLoad = i232;
        int i234 = i233 + 1;
        totalEvents = i234;
        chatAvailableReactionsUpdated = i233;
        int i235 = i234 + 1;
        totalEvents = i235;
        dialogsUnreadReactionsCounterChanged = i234;
        int i236 = i235 + 1;
        totalEvents = i236;
        onDatabaseOpened = i235;
        int i237 = i236 + 1;
        totalEvents = i237;
        onDownloadingFilesChanged = i236;
        int i238 = i237 + 1;
        totalEvents = i238;
        onActivityResultReceived = i237;
        int i239 = i238 + 1;
        totalEvents = i239;
        onRequestPermissionResultReceived = i238;
        int i240 = i239 + 1;
        totalEvents = i240;
        onUserRingtonesUpdated = i239;
        int i241 = i240 + 1;
        totalEvents = i241;
        currentUserPremiumStatusChanged = i240;
        int i242 = i241 + 1;
        totalEvents = i242;
        premiumPromoUpdated = i241;
        int i243 = i242 + 1;
        totalEvents = i243;
        premiumStatusChangedGlobal = i242;
        int i244 = i243 + 1;
        totalEvents = i244;
        currentUserShowLimitReachedDialog = i243;
        int i245 = i244 + 1;
        totalEvents = i245;
        billingProductDetailsUpdated = i244;
        int i246 = i245 + 1;
        totalEvents = i246;
        billingConfirmPurchaseError = i245;
        int i247 = i246 + 1;
        totalEvents = i247;
        premiumStickersPreviewLoaded = i246;
        int i248 = i247 + 1;
        totalEvents = i248;
        userEmojiStatusUpdated = i247;
        int i249 = i248 + 1;
        totalEvents = i249;
        requestPermissions = i248;
        int i250 = i249 + 1;
        totalEvents = i250;
        permissionsGranted = i249;
        int i251 = i250 + 1;
        totalEvents = i251;
        topicsDidLoaded = i250;
        int i252 = i251 + 1;
        totalEvents = i252;
        chatSwithcedToForum = i251;
        int i253 = i252 + 1;
        totalEvents = i253;
        didUpdateGlobalAutoDeleteTimer = i252;
        int i254 = i253 + 1;
        totalEvents = i254;
        onDatabaseReset = i253;
        int i255 = i254 + 1;
        totalEvents = i255;
        wallpaperSettedToUser = i254;
        int i256 = i255 + 1;
        totalEvents = i256;
        storiesUpdated = i255;
        int i257 = i256 + 1;
        totalEvents = i257;
        storiesListUpdated = i256;
        int i258 = i257 + 1;
        totalEvents = i258;
        storiesDraftsUpdated = i257;
        int i259 = i258 + 1;
        totalEvents = i259;
        chatlistFolderUpdate = i258;
        int i260 = i259 + 1;
        totalEvents = i260;
        uploadStoryProgress = i259;
        int i261 = i260 + 1;
        totalEvents = i261;
        uploadStoryEnd = i260;
        int i262 = i261 + 1;
        totalEvents = i262;
        customTypefacesLoaded = i261;
        int i263 = i262 + 1;
        totalEvents = i263;
        stealthModeChanged = i262;
        int i264 = i263 + 1;
        totalEvents = i264;
        onReceivedChannelDifference = i263;
        int i265 = i264 + 1;
        totalEvents = i265;
        storiesReadUpdated = i264;
        totalEvents = i265 + 1;
        nearEarEvent = i265;
    }
