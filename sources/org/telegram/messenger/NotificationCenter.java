...
public class NotificationCenter {
    ...
    public static final int activityPermissionsGranted = 286;
    ...
    public static final int appUpdateAvailable = 263;
    ...
    public static final int attachMenuBotsDidLoad = 268;
    ...
    public static final int billingConfirmPurchaseError = 281;
    public static final int billingProductDetailsUpdated = 280;
    ...
    public static final int cameraInitied = 232;
    ...
    public static final int chatAvailableReactionsUpdated = 269;
    ...
    public static final int chatSwithcedToForum = 288;
    public static final int chatWasBoostedByUser = 203;
    public static final int chatlistFolderUpdate = 295;
    public static final int closeChats = 4;
    public static final int closeInCallActivity = 169;
    public static final int closeOtherAppActivities = 231;
    public static final int closeSearchByActiveAction = 255;
    ...
    public static final int currentUserPremiumStatusChanged = 276;
    public static final int currentUserShowLimitReachedDialog = 279;
    public static final int customStickerCreated = 206;
    public static final int customTypefacesLoaded = 298;
    ...
    public static final int dialogsUnreadReactionsCounterChanged = 270;
    public static final int diceStickersDidLoad = 58;
    public static final int didApplyNewTheme = 236;
    public static final int didClearDatabase = 258;
    ...
    public static final int didReceiveCall = 228;
    public static final int didReceiveNewMessages = 1;
    public static final int didReceiveSmsCode = 227;
    ...
    public static final int didReplacedPhotoInMemCache = 233;
    public static final int didSetNewTheme = 234;
    public static final int didSetNewWallpapper = 246;
    ...
    public static final int didUpdateGlobalAutoDeleteTimer = 289;
    ...
    public static final int emojiLoaded = 229;
    public static final int emojiPreviewThemesChanged = 266;
    ...
    public static final int goingToPreviewTheme = 241;
    ...
    public static final int invalidateMotionBackground = 230;
    public static final int liveLocationsCacheChanged = 252;
    public static final int liveLocationsChanged = 250;
    public static final int loadingMessagesFailed = 16;
    public static final int locationPermissionDenied = 243;
    public static final int locationPermissionGranted = 242;
    ...
    public static final int messagePlayingSpeedChanged = 256;
    ...
    public static final int nearEarEvent = 302;
    public static final int needAddArchivedStickers = 83;
    public static final int needCheckSystemBarColors = 238;
    ...
    public static final int needSetDayNightTheme = 240;
    public static final int needShareTheme = 239;
    ...
    public static final int newLocationAvailable = 251;
    ...
    public static final int notificationsCountUpdated = 253;
    public static final int notificationsSettingsUpdated = 39;
    public static final int onActivityResultReceived = 273;
    public static final int onDatabaseMigration = 264;
    public static final int onDatabaseOpened = 271;
    public static final int onDatabaseReset = 290;
    public static final int onDownloadingFilesChanged = 272;
    public static final int onEmojiInteractionsReceived = 265;
    public static final int onReceivedChannelDifference = 300;
    public static final int onRequestPermissionResultReceived = 274;
    public static final int onUserRingtonesUpdated = 275;
    ...
    public static final int permissionsGranted = 285;
    public static final int pinnedInfoDidLoad = 65;
    public static final int playerDidStartPlaying = 254;
    public static final int premiumFloodWaitReceived = 207;
    public static final int premiumPromoUpdated = 277;
    public static final int premiumStatusChangedGlobal = 278;
    public static final int premiumStickersPreviewLoaded = 282;
    public static final int privacyRulesUpdated = 44;
    public static final int proxyChangedByRotation = 249;
    public static final int proxyCheckDone = 248;
    public static final int proxySettingsChanged = 247;
    public static final int pushMessagesUpdated = 224;
    public static final int quickRepliesDeleted = 118;
    public static final int quickRepliesUpdated = 117;
    public static final int reactionsDidLoad = 267;
    ...
    public static final int reloadInterface = 244;
    ...
    public static final int requestPermissions = 284;
    ...
    public static final int stealthModeChanged = 299;
    ...
    public static final int storiesDraftsUpdated = 294;
    public static final int storiesEnabledUpdate = 187;
    public static final int storiesLimitUpdate = 189;
    public static final int storiesListUpdated = 293;
    public static final int storiesReadUpdated = 301;
    public static final int storiesSendAsUpdate = 190;
    public static final int storiesUpdated = 292;
    public static final int storyQualityUpdate = 200;
    public static final int suggestedFiltersLoaded = 179;
    public static final int suggestedLangpack = 245;
    public static final int themeAccentListUpdated = 237;
    public static final int themeListUpdated = 235;
    ...
    public static final int topicsDidLoaded = 287;
    private static int totalEvents = 303;
    ...
    public static final int uploadStoryEnd = 297;
    public static final int uploadStoryProgress = 296;
    public static final int userEmojiStatusUpdated = 283;
    ...
    public static final int voipServiceCreated = 259;
    public static final int walletPendingTransactionsChanged = 129;
    public static final int walletSyncProgressChanged = 130;
    public static final int wallpaperSettedToUser = 291;
    public static final int wallpapersDidLoad = 225;
    public static final int wallpapersNeedReload = 226;
    public static final int wasUnableToFindCurrentLocation = 77;
    public static final int webRtcMicAmplitudeEvent = 260;
    public static final int webRtcSpeakerAmplitudeEvent = 261;
