...
public class NotificationCenter {
    ...
    static {
        ...
        int i210 = i209 + 1;
        totalEvents = i210;
        pushMessagesUpdated = i209;
        int i211 = i210 + 1;
        totalEvents = i211;
        wallpapersDidLoad = i210;
        int i212 = i211 + 1;
        totalEvents = i212;
        wallpapersNeedReload = i211;
        int i213 = i212 + 1;
        totalEvents = i213;
        didReceiveSmsCode = i212;
        int i214 = i213 + 1;
        totalEvents = i214;
        didReceiveCall = i213;
        int i215 = i214 + 1;
        ...
        int i216 = i215 + 1;
        totalEvents = i216;
        invalidateMotionBackground = i215;
        int i217 = i216 + 1;
        totalEvents = i217;
        closeOtherAppActivities = i216;
        int i218 = i217 + 1;
        totalEvents = i218;
        cameraInitied = i217;
        int i219 = i218 + 1;
        totalEvents = i219;
        didReplacedPhotoInMemCache = i218;
        int i220 = i219 + 1;
        totalEvents = i220;
        didSetNewTheme = i219;
        int i221 = i220 + 1;
        totalEvents = i221;
        themeListUpdated = i220;
        int i222 = i221 + 1;
        totalEvents = i222;
        didApplyNewTheme = i221;
        int i223 = i222 + 1;
        totalEvents = i223;
        themeAccentListUpdated = i222;
        int i224 = i223 + 1;
        totalEvents = i224;
        needCheckSystemBarColors = i223;
        int i225 = i224 + 1;
        totalEvents = i225;
        needShareTheme = i224;
        int i226 = i225 + 1;
        totalEvents = i226;
        needSetDayNightTheme = i225;
        int i227 = i226 + 1;
        totalEvents = i227;
        goingToPreviewTheme = i226;
        int i228 = i227 + 1;
        totalEvents = i228;
        locationPermissionGranted = i227;
        int i229 = i228 + 1;
        totalEvents = i229;
        locationPermissionDenied = i228;
        int i230 = i229 + 1;
        totalEvents = i230;
        reloadInterface = i229;
        int i231 = i230 + 1;
        totalEvents = i231;
        suggestedLangpack = i230;
        int i232 = i231 + 1;
        totalEvents = i232;
        didSetNewWallpapper = i231;
        int i233 = i232 + 1;
        totalEvents = i233;
        proxySettingsChanged = i232;
        int i234 = i233 + 1;
        totalEvents = i234;
        proxyCheckDone = i233;
        int i235 = i234 + 1;
        totalEvents = i235;
        proxyChangedByRotation = i234;
        int i236 = i235 + 1;
        totalEvents = i236;
        liveLocationsChanged = i235;
        int i237 = i236 + 1;
        totalEvents = i237;
        newLocationAvailable = i236;
        int i238 = i237 + 1;
        totalEvents = i238;
        liveLocationsCacheChanged = i237;
        int i239 = i238 + 1;
        totalEvents = i239;
        notificationsCountUpdated = i238;
        int i240 = i239 + 1;
        totalEvents = i240;
        playerDidStartPlaying = i239;
        int i241 = i240 + 1;
        totalEvents = i241;
        closeSearchByActiveAction = i240;
        int i242 = i241 + 1;
        totalEvents = i242;
        messagePlayingSpeedChanged = i241;
        int i243 = i242 + 1;
        totalEvents = i243;
        screenStateChanged = i242;
        int i244 = i243 + 1;
        totalEvents = i244;
        didClearDatabase = i243;
        int i245 = i244 + 1;
        totalEvents = i245;
        voipServiceCreated = i244;
        int i246 = i245 + 1;
        totalEvents = i246;
        webRtcMicAmplitudeEvent = i245;
        int i247 = i246 + 1;
        totalEvents = i247;
        webRtcSpeakerAmplitudeEvent = i246;
        int i248 = i247 + 1;
        totalEvents = i248;
        showBulletin = i247;
        int i249 = i248 + 1;
        totalEvents = i249;
        appUpdateAvailable = i248;
        int i250 = i249 + 1;
        totalEvents = i250;
        onDatabaseMigration = i249;
        int i251 = i250 + 1;
        totalEvents = i251;
        onEmojiInteractionsReceived = i250;
        int i252 = i251 + 1;
        totalEvents = i252;
        emojiPreviewThemesChanged = i251;
        int i253 = i252 + 1;
        totalEvents = i253;
        reactionsDidLoad = i252;
        int i254 = i253 + 1;
        totalEvents = i254;
        attachMenuBotsDidLoad = i253;
        int i255 = i254 + 1;
        totalEvents = i255;
        chatAvailableReactionsUpdated = i254;
        int i256 = i255 + 1;
        totalEvents = i256;
        dialogsUnreadReactionsCounterChanged = i255;
        int i257 = i256 + 1;
        totalEvents = i257;
        onDatabaseOpened = i256;
        int i258 = i257 + 1;
        totalEvents = i258;
        onDownloadingFilesChanged = i257;
        int i259 = i258 + 1;
        totalEvents = i259;
        onActivityResultReceived = i258;
        int i260 = i259 + 1;
        totalEvents = i260;
        onRequestPermissionResultReceived = i259;
        int i261 = i260 + 1;
        totalEvents = i261;
        onUserRingtonesUpdated = i260;
        int i262 = i261 + 1;
        totalEvents = i262;
        currentUserPremiumStatusChanged = i261;
        int i263 = i262 + 1;
        totalEvents = i263;
        premiumPromoUpdated = i262;
        int i264 = i263 + 1;
        totalEvents = i264;
        premiumStatusChangedGlobal = i263;
        int i265 = i264 + 1;
        totalEvents = i265;
        currentUserShowLimitReachedDialog = i264;
        int i266 = i265 + 1;
        totalEvents = i266;
        billingProductDetailsUpdated = i265;
        int i267 = i266 + 1;
        totalEvents = i267;
        billingConfirmPurchaseError = i266;
        int i268 = i267 + 1;
        totalEvents = i268;
        premiumStickersPreviewLoaded = i267;
        int i269 = i268 + 1;
        totalEvents = i269;
        userEmojiStatusUpdated = i268;
        int i270 = i269 + 1;
        totalEvents = i270;
        requestPermissions = i269;
        int i271 = i270 + 1;
        totalEvents = i271;
        permissionsGranted = i270;
        int i272 = i271 + 1;
        totalEvents = i272;
        topicsDidLoaded = i271;
        int i273 = i272 + 1;
        totalEvents = i273;
        chatSwithcedToForum = i272;
        int i274 = i273 + 1;
        totalEvents = i274;
        didUpdateGlobalAutoDeleteTimer = i273;
        int i275 = i274 + 1;
        totalEvents = i275;
        onDatabaseReset = i274;
        int i276 = i275 + 1;
        totalEvents = i276;
        wallpaperSettedToUser = i275;
        int i277 = i276 + 1;
        totalEvents = i277;
        storiesUpdated = i276;
        int i278 = i277 + 1;
        totalEvents = i278;
        storiesListUpdated = i277;
        int i279 = i278 + 1;
        totalEvents = i279;
        storiesDraftsUpdated = i278;
        int i280 = i279 + 1;
        totalEvents = i280;
        chatlistFolderUpdate = i279;
        int i281 = i280 + 1;
        totalEvents = i281;
        uploadStoryProgress = i280;
        int i282 = i281 + 1;
        totalEvents = i282;
        uploadStoryEnd = i281;
        int i283 = i282 + 1;
        totalEvents = i283;
        customTypefacesLoaded = i282;
        int i284 = i283 + 1;
        totalEvents = i284;
        stealthModeChanged = i283;
        int i285 = i284 + 1;
        totalEvents = i285;
        onReceivedChannelDifference = i284;
        int i286 = i285 + 1;
        totalEvents = i286;
        storiesReadUpdated = i285;
        totalEvents = i286 + 1;
        nearEarEvent = i286;
    }
