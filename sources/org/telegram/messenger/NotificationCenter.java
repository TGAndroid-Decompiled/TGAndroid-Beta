...
public class NotificationCenter {
    ...
    static {
        ...
        int i212 = i211 + 1;
        totalEvents = i212;
        pushMessagesUpdated = i211;
        int i213 = i212 + 1;
        totalEvents = i213;
        wallpapersDidLoad = i212;
        int i214 = i213 + 1;
        totalEvents = i214;
        wallpapersNeedReload = i213;
        int i215 = i214 + 1;
        totalEvents = i215;
        didReceiveSmsCode = i214;
        int i216 = i215 + 1;
        totalEvents = i216;
        didReceiveCall = i215;
        int i217 = i216 + 1;
        ...
        int i218 = i217 + 1;
        totalEvents = i218;
        invalidateMotionBackground = i217;
        int i219 = i218 + 1;
        totalEvents = i219;
        closeOtherAppActivities = i218;
        int i220 = i219 + 1;
        totalEvents = i220;
        cameraInitied = i219;
        int i221 = i220 + 1;
        totalEvents = i221;
        didReplacedPhotoInMemCache = i220;
        int i222 = i221 + 1;
        totalEvents = i222;
        didSetNewTheme = i221;
        int i223 = i222 + 1;
        totalEvents = i223;
        themeListUpdated = i222;
        int i224 = i223 + 1;
        totalEvents = i224;
        didApplyNewTheme = i223;
        int i225 = i224 + 1;
        totalEvents = i225;
        themeAccentListUpdated = i224;
        int i226 = i225 + 1;
        totalEvents = i226;
        needCheckSystemBarColors = i225;
        int i227 = i226 + 1;
        totalEvents = i227;
        needShareTheme = i226;
        int i228 = i227 + 1;
        totalEvents = i228;
        needSetDayNightTheme = i227;
        int i229 = i228 + 1;
        totalEvents = i229;
        goingToPreviewTheme = i228;
        int i230 = i229 + 1;
        totalEvents = i230;
        locationPermissionGranted = i229;
        int i231 = i230 + 1;
        totalEvents = i231;
        locationPermissionDenied = i230;
        int i232 = i231 + 1;
        totalEvents = i232;
        reloadInterface = i231;
        int i233 = i232 + 1;
        totalEvents = i233;
        suggestedLangpack = i232;
        int i234 = i233 + 1;
        totalEvents = i234;
        didSetNewWallpapper = i233;
        int i235 = i234 + 1;
        totalEvents = i235;
        proxySettingsChanged = i234;
        int i236 = i235 + 1;
        totalEvents = i236;
        proxyCheckDone = i235;
        int i237 = i236 + 1;
        totalEvents = i237;
        proxyChangedByRotation = i236;
        int i238 = i237 + 1;
        totalEvents = i238;
        liveLocationsChanged = i237;
        int i239 = i238 + 1;
        totalEvents = i239;
        newLocationAvailable = i238;
        int i240 = i239 + 1;
        totalEvents = i240;
        liveLocationsCacheChanged = i239;
        int i241 = i240 + 1;
        totalEvents = i241;
        notificationsCountUpdated = i240;
        int i242 = i241 + 1;
        totalEvents = i242;
        playerDidStartPlaying = i241;
        int i243 = i242 + 1;
        totalEvents = i243;
        closeSearchByActiveAction = i242;
        int i244 = i243 + 1;
        totalEvents = i244;
        messagePlayingSpeedChanged = i243;
        int i245 = i244 + 1;
        totalEvents = i245;
        screenStateChanged = i244;
        int i246 = i245 + 1;
        totalEvents = i246;
        didClearDatabase = i245;
        int i247 = i246 + 1;
        totalEvents = i247;
        voipServiceCreated = i246;
        int i248 = i247 + 1;
        totalEvents = i248;
        webRtcMicAmplitudeEvent = i247;
        int i249 = i248 + 1;
        totalEvents = i249;
        webRtcSpeakerAmplitudeEvent = i248;
        int i250 = i249 + 1;
        totalEvents = i250;
        showBulletin = i249;
        int i251 = i250 + 1;
        totalEvents = i251;
        appUpdateAvailable = i250;
        int i252 = i251 + 1;
        totalEvents = i252;
        onDatabaseMigration = i251;
        int i253 = i252 + 1;
        totalEvents = i253;
        onEmojiInteractionsReceived = i252;
        int i254 = i253 + 1;
        totalEvents = i254;
        emojiPreviewThemesChanged = i253;
        int i255 = i254 + 1;
        totalEvents = i255;
        reactionsDidLoad = i254;
        int i256 = i255 + 1;
        totalEvents = i256;
        attachMenuBotsDidLoad = i255;
        int i257 = i256 + 1;
        totalEvents = i257;
        chatAvailableReactionsUpdated = i256;
        int i258 = i257 + 1;
        totalEvents = i258;
        dialogsUnreadReactionsCounterChanged = i257;
        int i259 = i258 + 1;
        totalEvents = i259;
        onDatabaseOpened = i258;
        int i260 = i259 + 1;
        totalEvents = i260;
        onDownloadingFilesChanged = i259;
        int i261 = i260 + 1;
        totalEvents = i261;
        onActivityResultReceived = i260;
        int i262 = i261 + 1;
        totalEvents = i262;
        onRequestPermissionResultReceived = i261;
        int i263 = i262 + 1;
        totalEvents = i263;
        onUserRingtonesUpdated = i262;
        int i264 = i263 + 1;
        totalEvents = i264;
        currentUserPremiumStatusChanged = i263;
        int i265 = i264 + 1;
        totalEvents = i265;
        premiumPromoUpdated = i264;
        int i266 = i265 + 1;
        totalEvents = i266;
        premiumStatusChangedGlobal = i265;
        int i267 = i266 + 1;
        totalEvents = i267;
        currentUserShowLimitReachedDialog = i266;
        int i268 = i267 + 1;
        totalEvents = i268;
        billingProductDetailsUpdated = i267;
        int i269 = i268 + 1;
        totalEvents = i269;
        billingConfirmPurchaseError = i268;
        int i270 = i269 + 1;
        totalEvents = i270;
        premiumStickersPreviewLoaded = i269;
        int i271 = i270 + 1;
        totalEvents = i271;
        userEmojiStatusUpdated = i270;
        int i272 = i271 + 1;
        totalEvents = i272;
        requestPermissions = i271;
        int i273 = i272 + 1;
        totalEvents = i273;
        permissionsGranted = i272;
        int i274 = i273 + 1;
        totalEvents = i274;
        topicsDidLoaded = i273;
        int i275 = i274 + 1;
        totalEvents = i275;
        chatSwithcedToForum = i274;
        int i276 = i275 + 1;
        totalEvents = i276;
        didUpdateGlobalAutoDeleteTimer = i275;
        int i277 = i276 + 1;
        totalEvents = i277;
        onDatabaseReset = i276;
        int i278 = i277 + 1;
        totalEvents = i278;
        wallpaperSettedToUser = i277;
        int i279 = i278 + 1;
        totalEvents = i279;
        storiesUpdated = i278;
        int i280 = i279 + 1;
        totalEvents = i280;
        storiesListUpdated = i279;
        int i281 = i280 + 1;
        totalEvents = i281;
        storiesDraftsUpdated = i280;
        int i282 = i281 + 1;
        totalEvents = i282;
        chatlistFolderUpdate = i281;
        int i283 = i282 + 1;
        totalEvents = i283;
        uploadStoryProgress = i282;
        int i284 = i283 + 1;
        totalEvents = i284;
        uploadStoryEnd = i283;
        int i285 = i284 + 1;
        totalEvents = i285;
        customTypefacesLoaded = i284;
        int i286 = i285 + 1;
        totalEvents = i286;
        stealthModeChanged = i285;
        int i287 = i286 + 1;
        totalEvents = i287;
        onReceivedChannelDifference = i286;
        int i288 = i287 + 1;
        totalEvents = i288;
        storiesReadUpdated = i287;
        totalEvents = i288 + 1;
        nearEarEvent = i288;
    }
