...
public class NotificationCenter {
    ...
    static {
        ...
        int i168 = i167 + 1;
        totalEvents = i168;
        pushMessagesUpdated = i167;
        int i169 = i168 + 1;
        totalEvents = i169;
        stopEncodingService = i168;
        int i170 = i169 + 1;
        totalEvents = i170;
        wallpapersDidLoad = i169;
        int i171 = i170 + 1;
        totalEvents = i171;
        wallpapersNeedReload = i170;
        int i172 = i171 + 1;
        totalEvents = i172;
        didReceiveSmsCode = i171;
        int i173 = i172 + 1;
        totalEvents = i173;
        didReceiveCall = i172;
        int i174 = i173 + 1;
        ...
        int i175 = i174 + 1;
        totalEvents = i175;
        invalidateMotionBackground = i174;
        int i176 = i175 + 1;
        totalEvents = i176;
        closeOtherAppActivities = i175;
        int i177 = i176 + 1;
        totalEvents = i177;
        cameraInitied = i176;
        int i178 = i177 + 1;
        totalEvents = i178;
        didReplacedPhotoInMemCache = i177;
        int i179 = i178 + 1;
        totalEvents = i179;
        didSetNewTheme = i178;
        int i180 = i179 + 1;
        totalEvents = i180;
        themeListUpdated = i179;
        int i181 = i180 + 1;
        totalEvents = i181;
        didApplyNewTheme = i180;
        int i182 = i181 + 1;
        totalEvents = i182;
        themeAccentListUpdated = i181;
        int i183 = i182 + 1;
        totalEvents = i183;
        needCheckSystemBarColors = i182;
        int i184 = i183 + 1;
        totalEvents = i184;
        needShareTheme = i183;
        int i185 = i184 + 1;
        totalEvents = i185;
        needSetDayNightTheme = i184;
        int i186 = i185 + 1;
        totalEvents = i186;
        goingToPreviewTheme = i185;
        int i187 = i186 + 1;
        totalEvents = i187;
        locationPermissionGranted = i186;
        int i188 = i187 + 1;
        totalEvents = i188;
        locationPermissionDenied = i187;
        int i189 = i188 + 1;
        totalEvents = i189;
        reloadInterface = i188;
        int i190 = i189 + 1;
        totalEvents = i190;
        suggestedLangpack = i189;
        int i191 = i190 + 1;
        totalEvents = i191;
        didSetNewWallpapper = i190;
        int i192 = i191 + 1;
        totalEvents = i192;
        proxySettingsChanged = i191;
        int i193 = i192 + 1;
        totalEvents = i193;
        proxyCheckDone = i192;
        int i194 = i193 + 1;
        totalEvents = i194;
        proxyChangedByRotation = i193;
        int i195 = i194 + 1;
        totalEvents = i195;
        liveLocationsChanged = i194;
        int i196 = i195 + 1;
        totalEvents = i196;
        newLocationAvailable = i195;
        int i197 = i196 + 1;
        totalEvents = i197;
        liveLocationsCacheChanged = i196;
        int i198 = i197 + 1;
        totalEvents = i198;
        notificationsCountUpdated = i197;
        int i199 = i198 + 1;
        totalEvents = i199;
        playerDidStartPlaying = i198;
        int i200 = i199 + 1;
        totalEvents = i200;
        closeSearchByActiveAction = i199;
        int i201 = i200 + 1;
        totalEvents = i201;
        messagePlayingSpeedChanged = i200;
        int i202 = i201 + 1;
        totalEvents = i202;
        screenStateChanged = i201;
        int i203 = i202 + 1;
        totalEvents = i203;
        didClearDatabase = i202;
        int i204 = i203 + 1;
        totalEvents = i204;
        voipServiceCreated = i203;
        int i205 = i204 + 1;
        totalEvents = i205;
        webRtcMicAmplitudeEvent = i204;
        int i206 = i205 + 1;
        totalEvents = i206;
        webRtcSpeakerAmplitudeEvent = i205;
        int i207 = i206 + 1;
        totalEvents = i207;
        showBulletin = i206;
        int i208 = i207 + 1;
        totalEvents = i208;
        appUpdateAvailable = i207;
        int i209 = i208 + 1;
        totalEvents = i209;
        onDatabaseMigration = i208;
        int i210 = i209 + 1;
        totalEvents = i210;
        onEmojiInteractionsReceived = i209;
        int i211 = i210 + 1;
        totalEvents = i211;
        emojiPreviewThemesChanged = i210;
        int i212 = i211 + 1;
        totalEvents = i212;
        reactionsDidLoad = i211;
        int i213 = i212 + 1;
        totalEvents = i213;
        attachMenuBotsDidLoad = i212;
        int i214 = i213 + 1;
        totalEvents = i214;
        chatAvailableReactionsUpdated = i213;
        int i215 = i214 + 1;
        totalEvents = i215;
        dialogsUnreadReactionsCounterChanged = i214;
        int i216 = i215 + 1;
        totalEvents = i216;
        onDatabaseOpened = i215;
        int i217 = i216 + 1;
        totalEvents = i217;
        onDownloadingFilesChanged = i216;
        int i218 = i217 + 1;
        totalEvents = i218;
        onActivityResultReceived = i217;
        int i219 = i218 + 1;
        totalEvents = i219;
        onRequestPermissionResultReceived = i218;
        int i220 = i219 + 1;
        totalEvents = i220;
        onUserRingtonesUpdated = i219;
        int i221 = i220 + 1;
        totalEvents = i221;
        currentUserPremiumStatusChanged = i220;
        int i222 = i221 + 1;
        totalEvents = i222;
        premiumPromoUpdated = i221;
        int i223 = i222 + 1;
        totalEvents = i223;
        premiumStatusChangedGlobal = i222;
        int i224 = i223 + 1;
        totalEvents = i224;
        currentUserShowLimitReachedDialog = i223;
        int i225 = i224 + 1;
        totalEvents = i225;
        billingProductDetailsUpdated = i224;
        int i226 = i225 + 1;
        totalEvents = i226;
        premiumStickersPreviewLoaded = i225;
        int i227 = i226 + 1;
        totalEvents = i227;
        userEmojiStatusUpdated = i226;
        int i228 = i227 + 1;
        totalEvents = i228;
        requestPermissions = i227;
        int i229 = i228 + 1;
        totalEvents = i229;
        permissionsGranted = i228;
        int i230 = i229 + 1;
        totalEvents = i230;
        topicsDidLoaded = i229;
        int i231 = i230 + 1;
        totalEvents = i231;
        chatSwithcedToForum = i230;
        int i232 = i231 + 1;
        totalEvents = i232;
