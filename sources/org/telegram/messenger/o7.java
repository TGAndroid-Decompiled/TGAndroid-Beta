...
public final class o7 implements Runnable {
    ...
    public final ArrayList f19536e;
    public final Object f19537f;
    public final Object h;
    public final Object f19538n;
    public final TLObject f19539r;
    ...
    public o7(MediaDataController mediaDataController, TLObject tLObject, ArrayList arrayList, int i10, a0.h hVar, TLRPC.StickerSet stickerSet, TLRPC.TL_messages_allStickers tL_messages_allStickers, int i11) {
        this.f19533a = 0;
        this.f19537f = mediaDataController;
        this.d = tLObject;
        this.f19536e = arrayList;
        this.f19534b = i10;
        this.h = hVar;
        this.f19538n = stickerSet;
        this.f19539r = tL_messages_allStickers;
        this.f19535c = i11;
    }
    ...
    public final void run() {
        ...
        boolean z13;
        int i12 = this.f19533a;
        ArrayList arrayList = this.f19536e;
        TLObject tLObject = this.d;
        int i13 = this.f19535c;
        int i14 = this.f19534b;
        TLObject tLObject2 = this.f19539r;
        Object obj = this.f19538n;
        Object obj2 = this.h;
        Object obj3 = this.f19537f;
        switch (i12) {
            case 0:
                ((MediaDataController) obj3).lambda$processLoadStickersResponse$73(this.d, this.f19536e, this.f19534b, (a0.h) obj2, (TLRPC.StickerSet) obj, (TLRPC.TL_messages_allStickers) tLObject2, this.f19535c);
                return;
            case 1:
                uf.z zVar = (uf.z) obj3;
                ...
                int i15 = zVar.f48769p0;
                if (i14 == zVar.Q && (i13 <= 0 || i13 == zVar.f48751a0)) {
                    zVar.A0--;
                    if (tL_error == null) {
                        zVar.Y = str;
                        ...
                        if (i13 > 0) {
                            zVar.f48755d0 = i13;
                            if (zVar.f48754c0 != i13) {
                                zVar.f48773s.clear();
                            }
                            if (zVar.f48752b0 != i13) {
                                sVar.b();
                            }
                        }
                        sVar.f(zVar.f48773s, zVar.f48774s0);
                        ay ayVar = zVar.R;
                        if (ayVar != null) {
                            if (zVar.A0 > 0) {
                                z10 = true;
            ...
            default:
                ...
                uf.s sVar2 = zVar2.f48760g0;
                ArrayList arrayList3 = zVar2.F;
                ArrayList arrayList4 = zVar2.E;
                int i18 = zVar2.f48769p0;
                if (i14 == zVar2.M && (i13 <= 0 || i13 == zVar2.f48751a0)) {
                    zVar2.A0--;
                    if (tL_error2 == null) {
                        zVar2.Y = str2;
                        ...
                        for (int i19 = 0; i19 < messages_messages2.messages.size(); i19++) {
                            ...
                            if (i20 == 0 || message2.f20864id > i20) {
                                ...
                                if (num != null) {
                                    if (num.intValue() < message2.f20864id) {
                                        z13 = true;
                                    } else {
                                        z13 = false;
                                    }
                        ...
                        if (i13 > 0) {
                            zVar2.f48755d0 = i13;
                            if (zVar2.f48754c0 != i13) {
                                zVar2.f48773s.clear();
                            }
                            if (zVar2.f48752b0 != i13) {
                                sVar2.b();
                            }
                        }
                        sVar2.f(zVar2.f48773s, zVar2.f48774s0);
                        ay ayVar2 = zVar2.R;
                        if (ayVar2 != null) {
                            if (zVar2.A0 > 0) {
                                z12 = true;
                        ...
                        if (vVar != null) {
                            String str3 = zVar2.W;
                            TextView textView = vVar.f48727a;
