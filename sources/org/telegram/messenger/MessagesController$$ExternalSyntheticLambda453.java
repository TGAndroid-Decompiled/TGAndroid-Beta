...
public final class MessagesController$$ExternalSyntheticLambda453 implements RequestDelegate {
    ...
    public MessagesController$$ExternalSyntheticLambda453(MessagesController messagesController, int i, int i2, int i3, int i4, int i5, long j, long j2, int i6, int i7, int i8, int i9, int i10, long j3, int i11, boolean z, int i12, boolean z2, boolean z3, TLRPC.TL_messages_getReplies tL_messages_getReplies) {
        this.$r8$classId = 0;
    ...
    public MessagesController$$ExternalSyntheticLambda453(MessagesController messagesController, long j, int i, int i2, int i3, long j2, int i4, int i5, int i6, int i7, int i8, int i9, int i10, long j3, int i11, boolean z, int i12, boolean z2, boolean z3, TLObject tLObject, int i13) {
        this.$r8$classId = i13;
        this.f$0 = messagesController;
        this.f$6 = j;
        this.f$1 = i;
