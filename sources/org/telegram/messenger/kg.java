...
public final class kg implements Runnable {
    ...
    public final void run() {
        ...
        TLObject tLObject = this.f16585f;
        Object obj = this.e;
        switch (i10) {
            case 0:
                ((MessagesStorage) obj).lambda$loadPendingTasks$15(this.f16583b, this.d, (TLRPC.InputPeer) tLObject, this.f16584c);
                return;
            default:
                yh.u5 u5Var = (yh.u5) obj;
                int i11 = u5Var.f47801a;
                if (tLObject instanceof TLRPC.TL_boolTrue) {
                    long j3 = this.f16583b;
