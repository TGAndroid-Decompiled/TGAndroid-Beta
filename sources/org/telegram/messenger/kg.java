...
public final class kg implements Runnable {
    ...
    public final void run() {
        ...
        TLObject tLObject = this.f16588f;
        Object obj = this.e;
        switch (i10) {
            case 0:
                ((MessagesStorage) obj).lambda$loadPendingTasks$15(this.f16586b, this.d, (TLRPC.InputPeer) tLObject, this.f16587c);
                return;
            default:
