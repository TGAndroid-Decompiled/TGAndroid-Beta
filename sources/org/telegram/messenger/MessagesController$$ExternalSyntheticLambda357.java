...
public final class MessagesController$$ExternalSyntheticLambda357 implements Utilities.Callback {
    public final int $r8$classId;
    public final MessagesController f$0;

    public MessagesController$$ExternalSyntheticLambda357(MessagesController messagesController, int i) {
        this.$r8$classId = i;
