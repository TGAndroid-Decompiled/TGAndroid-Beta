...
public final class kd implements Runnable {
    ...
    public final void run() {
        switch (this.f16806a) {
            case 0:
                ...
                ((MessagesController) this.d).lambda$getSendAsPeers$442((TLRPC.TL_channels_sendAsPeers) this.e, (a0.i) this.f16809f, this.f16807b, (MessagesController.SendAsPeersInfo) this.h, z10);
                return;
            case 1:
                ((TranslateController) this.d).lambda$pushToTranslate$24((HashMap) this.e, this.f16807b, (TranslateController.PendingTranslation) this.f16809f, this.f16808c, (Set) this.h);
                return;
            case 2:
                ((ChatThemeController) this.d).lambda$setWallpaperToPeer$16((TLObject) this.e, this.f16807b, this.f16808c, (String) this.f16809f, (Runnable) this.h);
                return;
            default:
                ((TopicsController) this.d).lambda$reloadTopics$15((TLObject) this.e, this.f16808c, this.f16807b, (HashSet) this.f16809f, (Runnable) this.h);
                return;
        }
    }
    ...
    public kd(TranslateController translateController, HashMap hashMap, long j3, TranslateController.PendingTranslation pendingTranslation, boolean z10, Set set) {
        ...
        this.e = hashMap;
        this.f16807b = j3;
        this.f16809f = pendingTranslation;
        this.f16808c = z10;
        this.h = set;
    }
}
