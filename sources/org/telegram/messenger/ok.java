...
public final class ok implements Utilities.Callback {
    public final int f18034a = 0;
    public final boolean f18035b;
    public final NotificationCenter.NotificationCenterDelegate f18036c;
    public final Object d;
    public final Object e;
    public final Object f18037f;
    ...
    public ok(SendMessagesHelper sendMessagesHelper, ArrayList arrayList, ArrayList arrayList2, ArrayList arrayList3, SendMessagesHelper.DelayedMessage delayedMessage, boolean z4) {
        this.f18036c = sendMessagesHelper;
        this.d = arrayList;
        this.e = arrayList2;
        this.f18037f = arrayList3;
        this.f18038g = delayedMessage;
        this.f18035b = z4;
    }
    ...
    public final void run(Object obj) {
        ...
        switch (this.f18034a) {
            case 0:
                ((SendMessagesHelper) this.f18036c).lambda$performSendMessageRequestMulti$64((ArrayList) this.d, (ArrayList) this.e, (ArrayList) this.f18037f, (SendMessagesHelper.DelayedMessage) this.f18038g, this.f18035b, (TLObject) obj);
                return;
            case 1:
                ProfileActivity profileActivity = (ProfileActivity) this.f18036c;
                TLRPC.ChannelParticipant channelParticipant = (TLRPC.ChannelParticipant) this.d;
                TLRPC.User user = (TLRPC.User) this.e;
                TLRPC.ChatParticipant chatParticipant = (TLRPC.ChatParticipant) this.f18037f;
                String str = (String) this.f18038g;
            ...
            default:
                x61 x61Var = (x61) this.f18036c;
                LinkedHashSet linkedHashSet = (LinkedHashSet) this.e;
                String str2 = (String) this.f18037f;
                HashMap hashMap = (HashMap) this.f18038g;
                    ...
                    for (int i11 = 0; i11 < stickerSets.size(); i11++) {
                        if (stickerSets.get(i11).documents != null && (arrayList2 = stickerSets.get(i11).documents) != null) {
                            for (int i12 = 0; i12 < arrayList2.size(); i12++) {
                                ...
                                long j10 = arrayList2.get(i12).f19165id;
                    ...
                    for (int i13 = 0; i13 < featuredEmojiSets.size(); i13++) {
                        if ((featuredEmojiSets.get(i13) instanceof TLRPC.TL_stickerSetFullCovered) && ((TLRPC.TL_stickerSetFullCovered) featuredEmojiSets.get(i13)).keywords != null && (arrayList = ((TLRPC.TL_stickerSetFullCovered) featuredEmojiSets.get(i13)).documents) != null) {
                            for (int i14 = 0; i14 < arrayList.size(); i14++) {
                                ...
                                long j11 = arrayList.get(i14).f19165id;
                ...
                String[] strArr = x61.X1;
                f1.a aVar = new f1.a(x61Var, linkedHashSet, hashMap, arrayList3, runnable);
                if (x61Var.T == 3) {
                    z4 = true;
                } else {
                    z4 = false;
    ...
    public ok(ProfileActivity profileActivity, TLRPC.ChannelParticipant channelParticipant, TLRPC.User user, TLRPC.ChatParticipant chatParticipant, boolean z4, String str) {
        this.f18036c = profileActivity;
        this.d = channelParticipant;
        this.e = user;
        this.f18037f = chatParticipant;
        this.f18035b = z4;
        this.f18038g = str;
    }

    public ok(x61 x61Var, boolean z4, LinkedHashSet linkedHashSet, String str, HashMap hashMap, ArrayList arrayList) {
        this.f18036c = x61Var;
        this.f18035b = z4;
        this.e = linkedHashSet;
        this.f18037f = str;
        this.f18038g = hashMap;
        this.d = arrayList;
    }
}
