    ...
    public final void run() {
        ...
        switch (this.f16621a) {
            ...
            case 3:
                ...
                g1Var2.setChecked(TLObject.hasFlag(n5Var.f47522g, 1));
                g1Var3.setChecked(TLObject.hasFlag(n5Var.f47522g, 2));
                g1Var4.setChecked(TLObject.hasFlag(n5Var.f47522g, 4));
                g1Var5.setChecked(TLObject.hasFlag(n5Var.f47522g, 8));
                if (this.f16626r) {
                    g1Var6.setChecked(TLObject.hasFlag(n5Var.f47522g, 256));
                    g1Var7.setChecked(TLObject.hasFlag(n5Var.f47522g, 512));
                    return;
                }
                return;
            default:
                ...
                yh.n5 n5Var2 = ((xh.i4) this.f16622b).f45957c.Y;
                if (n5Var2.e) {
                ...
                g1Var9.setChecked(TLObject.hasFlag(n5Var2.f47522g, 1));
                g1Var10.setChecked(TLObject.hasFlag(n5Var2.f47522g, 2));
                g1Var11.setChecked(TLObject.hasFlag(n5Var2.f47522g, 4));
                g1Var12.setChecked(TLObject.hasFlag(n5Var2.f47522g, 8));
                if (this.f16626r) {
                    g1Var13.setChecked(TLObject.hasFlag(n5Var2.f47522g, 256));
                    g1Var14.setChecked(TLObject.hasFlag(n5Var2.f47522g, 512));
                    return;
                }
                return;
        }
