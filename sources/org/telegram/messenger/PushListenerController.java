...
public class PushListenerController {
    ...
    public static final class GooglePushListenerServiceProvider implements IPushListenerServiceProvider {
        ...
        public void lambda$onRequestPushToken$1() {
            ...
            try {
                ...
                firebaseMessaging.f6046f.execute(new bi.af(6, firebaseMessaging, taskCompletionSource));
        ...
        public boolean hasServices() {
            ...
            if (this.hasServices == null) {
                try {
                    if (k6.d.d.d(ApplicationLoader.applicationContext, k6.e.f12354a) == 0) {
                        z10 = true;
                    } else {
                        z10 = false;
                    }
    ...
    public static void processRemoteMessage(int i10, String str, long j3) {
        ...
        AndroidUtilities.runOnUIThread(new bi(1, j3, str3, str));
        try {
