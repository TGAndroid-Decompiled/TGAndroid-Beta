...
public class EncryptedFileInputStream extends FileInputStream {
    ...
    public EncryptedFileInputStream(File file, File file2) throws Exception {
        ...
        this.f832iv = new byte[16];
        this.currentMode = 0;
        RandomAccessFile randomAccessFile = new RandomAccessFile(file2, "r");
        randomAccessFile.read(this.key, 0, 32);
        randomAccessFile.read(this.f832iv, 0, 16);
    ...
    public int read(byte[] bArr, int i, int i2) throws IOException {
        ...
        if (this.currentMode == 1 && this.fileOffset == 0) {
            ...
            Utilities.aesCbcEncryptionByteArraySafe(bArr, this.key, this.f832iv, i, i2, this.fileOffset, 0);
            this.fileOffset += 32;
            skip((bArr2[0] & 255) - 32);
        }
        ...
        if (i3 == 1) {
            ...
            Utilities.aesCtrDecryptionByteArray(bArr, this.key, this.f832iv, i, i2, this.fileOffset);
        }
        this.fileOffset += i2;
        return read;
    }
