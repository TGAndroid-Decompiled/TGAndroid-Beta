...
public class MessagesStorage extends BaseController {
        ...
        if (tL_messageReactions != null && tL_messageReactions.reactions_as_tags && (arrayList = tL_messageReactions.results) != null && !arrayList.isEmpty()) {
            ...
            while (i10 < size) {
                ...
                if ((reaction instanceof TLRPC.TL_reactionEmoji) || (reaction instanceof TLRPC.TL_reactionCustomEmoji)) {
                    ...
                    sQLitePreparedStatement.bindLong(1, message.f18349id);
    ...
    private void createOrEditTopic(long j3, TLRPC.Message message) {
        ...
        tL_forumTopic.top_message = message.f18349id;
        ...
        if (messageAction instanceof TLRPC.TL_messageActionTopicCreate) {
            ...
            tL_forumTopic.f18380id = message.f18349id;
            ...
            tL_forumTopic.f18380id = (int) MessageObject.getTopicId(this.currentAccount, message, true);
    ...
    public void lambda$deleteDialogFilter$72(MessagesController.DialogFilter dialogFilter) {
        try {
            ...
            this.dialogFiltersMap.remove(dialogFilter.f15822id);
            SQLiteDatabase sQLiteDatabase = this.database;
            sQLiteDatabase.executeFast("DELETE FROM dialog_filter WHERE id = " + dialogFilter.f15822id).stepThis().dispose();
            SQLiteDatabase sQLiteDatabase2 = this.database;
            sQLiteDatabase2.executeFast("DELETE FROM dialog_filter_ep WHERE id = " + dialogFilter.f15822id).stepThis().dispose();
            SQLiteDatabase sQLiteDatabase3 = this.database;
            sQLiteDatabase3.executeFast("DELETE FROM dialog_filter_pin_v2 WHERE id = " + dialogFilter.f15822id).stepThis().dispose();
        } catch (Exception e) {
            checkSQLException(e);
        }
    }
        ...
        for (int i10 = 0; i10 < deleteEphemeralMessagesInternal.m(); i10++) {
            ...
            while (i11 < size) {
                ...
                if (i12 != 0) {
                    ...
                    int i13 = ephemeralMessage.f18539id;
                    a0.i iVar3 = tVar.f47158a;
            ...
            try {
                ...
                while (queryFinalized.next()) {
                    try {
                        ...
                        downloadObject.f15811id = queryFinalized.longValue(0);
    ...
    public static int lambda$getMessagesInternal$159(TLRPC.Message message, TLRPC.Message message2) {
        ...
        int i12;
        int i13;
        if (!MessageObject.isEphemeralMessageId(message.f18349id) && !MessageObject.isEphemeralMessageId(message2.f18349id)) {
            int i14 = message.f18349id;
            if (i14 > 0 && (i13 = message2.f18349id) > 0) {
                if (i14 > i13) {
                    return -1;
                }
                if (i14 < i13) {
            ...
            } else if (i14 < 0 && (i12 = message2.f18349id) < 0) {
                if (i14 < i12) {
                    return -1;
                }
                if (i14 > i12) {
        ...
        if ((!MessageObject.isEphemeralMessageId(message.f18349id) && MessageObject.isEphemeralMessageId(message2.f18349id)) || (i10 = message.f18349id) > (i11 = message2.f18349id)) {
            return 1;
        }
        if (i10 >= i11) {
            return 0;
            ...
            try {
                ...
                while (queryFinalized.next()) {
                    ...
                    if (!DialogObject.isFolderDialogId(longValue3)) {
                        ...
                        iVar.k(tL_dialog, tL_dialog.f18332id);
                        ...
                        if (byteBufferValue != null) {
                            ...
                            TLdeserialize.f18349id = queryFinalized.intValue(6);
                ...
                if (!z10 && arrayList.size() > iVar.m()) {
                    ...
                    for (int i12 = 0; i12 < size; i12++) {
                        ...
                        if (iVar.f(((Long) arrayList.get(i12)).longValue()) == null) {
                            ...
                            tL_dialog2.f18332id = longValue4;
    ...
    public void lambda$saveDialogFiltersOrder$75(ArrayList arrayList) {
        ...
        for (int i10 = 0; i10 < arrayList.size(); i10++) {
            ...
            this.dialogFiltersMap.put(((MessagesController.DialogFilter) arrayList.get(i10)).f15822id, (MessagesController.DialogFilter) arrayList.get(i10));
        }
    ...
    public void lambda$updateChatParticipants$122(TLRPC.ChatParticipants chatParticipants) {
        ...
        try {
            ...
            if (chatFull instanceof TLRPC.TL_chatFull) {
                ...
                executeFast.bindLong(1, chatFull.f18329id);
                executeFast.bindByteBuffer(2, nativeByteBuffer);
    ...
    public void lambda$updateEncryptedChatLayer$173(TLRPC.EncryptedChat encryptedChat) {
        ...
        try {
            try {
                ...
                sQLitePreparedStatement.bindInteger(2, encryptedChat.f18336id);
                sQLitePreparedStatement.step();
                sQLitePreparedStatement.dispose();
            } catch (Exception e) {
                checkSQLException(e);
    ...
    public void lambda$updateEncryptedChatSeq$171(TLRPC.EncryptedChat encryptedChat, boolean z10) {
        ...
        try {
            try {
                ...
                sQLitePreparedStatement.bindInteger(6, encryptedChat.f18336id);
                sQLitePreparedStatement.step();
                if (z10 && encryptedChat.in_seq_no != 0) {
                    long encryptedChatId = DialogObject.getEncryptedChatId(encryptedChat.f18336id);
                    SQLiteDatabase sQLiteDatabase = this.database;
                    Locale locale = Locale.US;
    ...
    public void lambda$updateMessageCustomParams$110(TLRPC.Message message, long j3) {
        ...
        try {
            try {
                this.database.beginTransaction();
                TLRPC.Message messageWithCustomParamsOnlyInternal = getMessageWithCustomParamsOnlyInternal(message.f18349id, j3);
    ...
    private void processAnchoredEphemeralMessagesInternal(ArrayList<TL_ephemeral.EphemeralMessage> arrayList) {
        ...
        while (i10 < size) {
            ...
            yf.t tVar = this.ephemeralWelcomeAnchorsState;
            int i12 = ephemeralMessage2.f18539id;
            a0.i iVar = tVar.f47158a;
    ...
    private void processEphemeralEditedMessagesInternal(ArrayList<TL_ephemeral.EphemeralMessage> arrayList) {
        ...
        while (i11 < size) {
            ...
            i11++;
            TL_ephemeral.EphemeralMessage ephemeralMessage2 = ephemeralMessage;
            if (ephemeralMessage2.top_msg_id == 0 && (ephemeralMessageInternal = getEphemeralMessageInternal(DialogObject.getPeerDialogId(ephemeralMessage2.peer_id), ephemeralMessage2.f18539id)) != null && (i10 = ephemeralMessageInternal.top_msg_id) != 0) {
    ...
    public void lambda$processLoadedFilterPeers$71(TLRPC.messages_Dialogs messages_dialogs, TLRPC.messages_Dialogs messages_dialogs2, ArrayList<TLRPC.User> arrayList, ArrayList<TLRPC.Chat> arrayList2, ArrayList<MessagesController.DialogFilter> arrayList3, SparseArray<MessagesController.DialogFilter> sparseArray, ArrayList<Integer> arrayList4, HashMap<Integer, HashSet<Long>> hashMap, HashSet<Integer> hashSet, Runnable runnable) {
        ...
        for (int i13 = 0; i13 < size3; i13++) {
            ...
            int indexOf = arrayList4.indexOf(Integer.valueOf(dialogFilter3.f15822id));
        ...
        if (list != null && !list.isEmpty()) {
            ...
            for (int i10 = 0; i10 < list.size(); i10++) {
                ...
                if (chat.min) {
                    SQLiteDatabase sQLiteDatabase = this.database;
                    Locale locale = Locale.US;
                    SQLiteCursor queryFinalized = sQLiteDatabase.queryFinalized(a4.a.o(chat.f18328id, "SELECT data FROM chats WHERE uid = "), new Object[0]);
                    if (queryFinalized.next()) {
                        try {
                            NativeByteBuffer byteBufferValue = queryFinalized.byteBufferValue(0);
                            if (byteBufferValue != null) {
                ...
                executeFast.bindLong(1, chat.f18328id);
                ...
                executeFast.step();
                nativeByteBuffer.reuse();
                isForumCacheInvalidate(-chat.f18328id);
            }
            executeFast.dispose();
        }
    }
    ...
    public void lambda$putEphemeralMessages$204(ArrayList<TL_ephemeral.EphemeralMessage> arrayList, boolean z10) {
        ...
        while (i10 < size) {
            ...
            if (!ephemeralMessage2.welcome) {
                ...
                sQLitePreparedStatement.bindInteger(2, ephemeralMessage2.f18539id);
            ...
            for (int i13 = 0; i13 < list.size(); i13++) {
                ...
                if (user != null) {
                    if (user.min) {
                        SQLiteDatabase sQLiteDatabase = this.database;
                        Locale locale = Locale.US;
                        SQLiteCursor queryFinalized = sQLiteDatabase.queryFinalized(a4.a.o(user.f18475id, "SELECT data FROM users WHERE uid = "), new Object[0]);
                        if (queryFinalized.next()) {
                            try {
                                NativeByteBuffer byteBufferValue = queryFinalized.byteBufferValue(0);
                                if (byteBufferValue != null) {
                    ...
                    executeFast.bindLong(1, user.f18475id);
                    ...
                    executeFast.step();
                    nativeByteBuffer.reuse();
                    isForumCacheInvalidate(user.f18475id);
                }
            }
            executeFast.dispose();
        }
    ...
    private void saveDialogFilterInternal(MessagesController.DialogFilter dialogFilter, boolean z10, boolean z11) {
        ...
        try {
            try {
                if (!this.dialogFilters.contains(dialogFilter)) {
                    ...
                    this.dialogFiltersMap.put(dialogFilter.f15822id, dialogFilter);
                }
        ...
        try {
            executeFast.bindInteger(1, dialogFilter.f15822id);
            ...
            if (z11) {
                SQLiteDatabase sQLiteDatabase = this.database;
                sQLiteDatabase.executeFast("DELETE FROM dialog_filter_ep WHERE id = " + dialogFilter.f15822id).stepThis().dispose();
                SQLiteDatabase sQLiteDatabase2 = this.database;
                sQLiteDatabase2.executeFast("DELETE FROM dialog_filter_pin_v2 WHERE id = " + dialogFilter.f15822id).stepThis().dispose();
                this.database.beginTransaction();
                ...
                for (int i11 = 0; i11 < size; i11++) {
                    ...
                    executeFast2.bindInteger(1, dialogFilter.f15822id);
                ...
                for (i10 = 0; i10 < size3; i10++) {
                    ...
                    executeFast3.bindInteger(1, dialogFilter.f15822id);
                ...
                if (z10) {
                    ...
                    try {
                        ...
                        for (int i10 = 0; i10 < size; i10++) {
                            ...
                            executeFast.bindLong(2, user.f18475id);
                            executeFast.step();
                        }
                        executeFast.dispose();
                        if (z11) {
                    ...
                    for (int i11 = 0; i11 < size2; i11++) {
                        ...
                        arrayList2.add(Long.valueOf(user2.f18475id));
                        iVar.k(user2, user2.f18475id);
                    }
                    ...
                    for (int i12 = 0; i12 < size3; i12++) {
                        ...
                        TLRPC.User user4 = (TLRPC.User) iVar.f(user3.f18475id);
                        if (user4 != null) {
            ...
            try {
                ...
                while (sQLiteCursor.next()) {
                    ...
                    try {
                        ...
                        if (TLdeserialize != null && TLdeserialize.f18334id != 0) {
                            arrayList.add(TLdeserialize);
                        }
                    } catch (Exception e) {
                        checkSQLException(e);
        ...
        try {
            try {
                ...
                for (int i10 = 0; i10 < size; i10++) {
                    ...
                    sQLitePreparedStatement.bindInteger(3, dialogFilter.f15822id);
                    sQLitePreparedStatement.step();
                }
                sQLitePreparedStatement.dispose();
            } catch (Exception e) {
