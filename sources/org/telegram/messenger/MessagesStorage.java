...
public class MessagesStorage extends BaseController {
    ...
    public MessagesStorage(int i10) {
        ...
        DispatchQueue dispatchQueue = new DispatchQueue(l.d.j(i10, "storageQueue_"));
        ...
        if (tL_messageReactions != null && tL_messageReactions.reactions_as_tags && (arrayList = tL_messageReactions.results) != null && !arrayList.isEmpty()) {
            ...
            while (i10 < size) {
                ...
                if ((reaction instanceof TLRPC.TL_reactionEmoji) || (reaction instanceof TLRPC.TL_reactionCustomEmoji)) {
                    ...
                    sQLitePreparedStatement.bindLong(1, message.f20866id);
    ...
    private void createOrEditTopic(long j10, TLRPC.Message message) {
        ...
        tL_forumTopic.top_message = message.f20866id;
        ...
        if (messageAction instanceof TLRPC.TL_messageActionTopicCreate) {
            ...
            tL_forumTopic.f20897id = message.f20866id;
            ...
            tL_forumTopic.f20897id = (int) MessageObject.getTopicId(this.currentAccount, message, true);
    ...
    public void lambda$deleteDialogFilter$72(MessagesController.DialogFilter dialogFilter) {
        try {
            ...
            this.dialogFiltersMap.remove(dialogFilter.f18057id);
            SQLiteDatabase sQLiteDatabase = this.database;
            sQLiteDatabase.executeFast("DELETE FROM dialog_filter WHERE id = " + dialogFilter.f18057id).stepThis().dispose();
            SQLiteDatabase sQLiteDatabase2 = this.database;
            sQLiteDatabase2.executeFast("DELETE FROM dialog_filter_ep WHERE id = " + dialogFilter.f18057id).stepThis().dispose();
            SQLiteDatabase sQLiteDatabase3 = this.database;
            sQLiteDatabase3.executeFast("DELETE FROM dialog_filter_pin_v2 WHERE id = " + dialogFilter.f18057id).stepThis().dispose();
        } catch (Exception e6) {
            checkSQLException(e6);
        }
    }
        ...
        for (int i10 = 0; i10 < deleteEphemeralMessagesInternal.m(); i10++) {
            ...
            while (i11 < size) {
                ...
                if (i12 != 0) {
                    ...
                    int i13 = ephemeralMessage.f21058id;
                    a0.h hVar3 = vVar.f12522a;
            ...
            try {
                ...
                while (queryFinalized.next()) {
                    try {
                        ...
                        downloadObject.f18046id = queryFinalized.longValue(0);
    ...
    public static int lambda$getMessagesInternal$159(TLRPC.Message message, TLRPC.Message message2) {
        ...
        int i12;
        int i13;
        if (!MessageObject.isEphemeralMessageId(message.f20866id) && !MessageObject.isEphemeralMessageId(message2.f20866id)) {
            int i14 = message.f20866id;
            if (i14 > 0 && (i13 = message2.f20866id) > 0) {
                if (i14 > i13) {
                    return -1;
                }
                if (i14 < i13) {
            ...
            } else if (i14 < 0 && (i12 = message2.f20866id) < 0) {
                if (i14 < i12) {
                    return -1;
                }
                if (i14 > i12) {
        ...
        if ((!MessageObject.isEphemeralMessageId(message.f20866id) && MessageObject.isEphemeralMessageId(message2.f20866id)) || (i10 = message.f20866id) > (i11 = message2.f20866id)) {
            return 1;
        }
        if (i10 >= i11) {
            return 0;
            ...
            try {
                ...
                while (queryFinalized.next()) {
                    ...
                    if (!DialogObject.isFolderDialogId(longValue3)) {
                        ...
                        hVar.k(tL_dialog, tL_dialog.f20849id);
                        ...
                        if (byteBufferValue != null) {
                            ...
                            TLdeserialize.f20866id = queryFinalized.intValue(6);
                ...
                if (!z4 && arrayList.size() > hVar.m()) {
                    ...
                    for (int i12 = 0; i12 < size; i12++) {
                        ...
                        if (hVar.f(((Long) arrayList.get(i12)).longValue()) == null) {
                            ...
                            tL_dialog2.f20849id = longValue4;
    ...
    public void lambda$loadPendingTasks$24(org.telegram.ui.ActionBar.d6 d6Var, boolean z4, long j10) {
        getMessagesController().saveWallpaperToServer(null, d6Var, z4, j10);
    }
    ...
    public static int lambda$localSearch$260(uf.u uVar, uf.u uVar2) {
        int i10 = uVar.f48727b;
        int i11 = uVar2.f48727b;
        if (i10 < i11) {
            return 1;
        }
        if (i10 > i11) {
        ...
        for (int i10 = 0; i10 < arrayList.size(); i10++) {
            ...
            if (tL_messageReactions != null && tL_messageReactions.results != null && tL_messageReactions.reactions_as_tags) {
                for (int i11 = 0; i11 < tL_messageReactions.results.size(); i11++) {
                    ng.q0 d = ng.q0.d(tL_messageReactions.results.get(i11).reaction);
                    hVar.k(d, d.h);
                }
            }
            if (tL_messageReactions2 != null && tL_messageReactions2.results != null && tL_messageReactions2.reactions_as_tags) {
                for (int i12 = 0; i12 < tL_messageReactions2.results.size(); i12++) {
                    ng.q0 d10 = ng.q0.d(tL_messageReactions2.results.get(i12).reaction);
                    hVar2.k(d10, d10.h);
                }
            }
            for (int i13 = 0; i13 < hVar.m(); i13++) {
                long j10 = hVar.j(i13);
                ng.q0 q0Var = (ng.q0) hVar.n(i13);
            ...
            for (int i14 = 0; i14 < hVar2.m(); i14++) {
                ...
                ng.q0 q0Var2 = (ng.q0) hVar2.n(i14);
    ...
    public void lambda$onReactionsUpdate$106(TLRPC.TL_messageReactions tL_messageReactions, TLRPC.TL_messageReactions tL_messageReactions2, long j10) {
        ...
        if (tL_messageReactions != null && tL_messageReactions.results != null && tL_messageReactions.reactions_as_tags) {
            for (int i10 = 0; i10 < tL_messageReactions.results.size(); i10++) {
                ng.q0 d = ng.q0.d(tL_messageReactions.results.get(i10).reaction);
                hVar.k(d, d.h);
            }
        }
        if (tL_messageReactions2 != null && tL_messageReactions2.results != null && tL_messageReactions2.reactions_as_tags) {
            for (int i11 = 0; i11 < tL_messageReactions2.results.size(); i11++) {
                ng.q0 d10 = ng.q0.d(tL_messageReactions2.results.get(i11).reaction);
                hVar2.k(d10, d10.h);
            }
        }
        boolean z4 = false;
        ...
        for (int i13 = 0; i13 < hVar2.m(); i13++) {
            ...
            ng.q0 q0Var2 = (ng.q0) hVar2.n(i13);
            if (!hVar.d(j12)) {
    ...
    public void lambda$saveDialogFiltersOrder$75(ArrayList arrayList) {
        ...
        for (int i10 = 0; i10 < arrayList.size(); i10++) {
            ...
            this.dialogFiltersMap.put(((MessagesController.DialogFilter) arrayList.get(i10)).f18057id, (MessagesController.DialogFilter) arrayList.get(i10));
        }
    ...
    public void lambda$updateChatParticipants$122(TLRPC.ChatParticipants chatParticipants) {
        ...
        try {
            ...
            if (chatFull instanceof TLRPC.TL_chatFull) {
                ...
                executeFast.bindLong(1, chatFull.f20846id);
                executeFast.bindByteBuffer(2, nativeByteBuffer);
    ...
    public void lambda$updateEncryptedChatLayer$173(TLRPC.EncryptedChat encryptedChat) {
        ...
        try {
            try {
                ...
                sQLitePreparedStatement.bindInteger(2, encryptedChat.f20853id);
                sQLitePreparedStatement.step();
                sQLitePreparedStatement.dispose();
            } catch (Exception e6) {
                checkSQLException(e6);
    ...
    public void lambda$updateEncryptedChatSeq$171(TLRPC.EncryptedChat encryptedChat, boolean z4) {
        ...
        try {
            try {
                ...
                sQLitePreparedStatement.bindInteger(6, encryptedChat.f20853id);
                sQLitePreparedStatement.step();
                if (z4 && encryptedChat.in_seq_no != 0) {
                    long encryptedChatId = DialogObject.getEncryptedChatId(encryptedChat.f20853id);
                    SQLiteDatabase sQLiteDatabase = this.database;
                    Locale locale = Locale.US;
    ...
    public void lambda$updateMessageCustomParams$110(TLRPC.Message message, long j10) {
        ...
        try {
            try {
                this.database.beginTransaction();
                TLRPC.Message messageWithCustomParamsOnlyInternal = getMessageWithCustomParamsOnlyInternal(message.f20866id, j10);
                ...
                for (int i10 = 0; i10 < 2; i10++) {
                    ...
                    try {
                        ...
                        executeFast.bindInteger(2, message.f20866id);
                        executeFast.bindLong(3, j10);
                        executeFast.step();
                        executeFast.dispose();
                        if (writeLocalParams != null) {
    ...
    private void processAnchoredEphemeralMessagesInternal(ArrayList<TL_ephemeral.EphemeralMessage> arrayList) {
        ...
        while (i10 < size) {
            ...
            lf.v vVar = this.ephemeralWelcomeAnchorsState;
            int i12 = ephemeralMessage2.f21058id;
            a0.h hVar = vVar.f12522a;
    ...
    private void processEphemeralEditedMessagesInternal(ArrayList<TL_ephemeral.EphemeralMessage> arrayList) {
        ...
        while (i11 < size) {
            ...
            i11++;
            TL_ephemeral.EphemeralMessage ephemeralMessage2 = ephemeralMessage;
            if (ephemeralMessage2.top_msg_id == 0 && (ephemeralMessageInternal = getEphemeralMessageInternal(DialogObject.getPeerDialogId(ephemeralMessage2.peer_id), ephemeralMessage2.f21058id)) != null && (i10 = ephemeralMessageInternal.top_msg_id) != 0) {
    ...
    public void lambda$processLoadedFilterPeers$71(TLRPC.messages_Dialogs messages_dialogs, TLRPC.messages_Dialogs messages_dialogs2, ArrayList<TLRPC.User> arrayList, ArrayList<TLRPC.Chat> arrayList2, ArrayList<MessagesController.DialogFilter> arrayList3, SparseArray<MessagesController.DialogFilter> sparseArray, ArrayList<Integer> arrayList4, HashMap<Integer, HashSet<Long>> hashMap, HashSet<Integer> hashSet, Runnable runnable) {
        ...
        for (int i13 = 0; i13 < size3; i13++) {
            ...
            int indexOf = arrayList4.indexOf(Integer.valueOf(dialogFilter3.f18057id));
        ...
        if (list != null && !list.isEmpty()) {
            ...
            for (int i10 = 0; i10 < list.size(); i10++) {
                ...
                if (chat.min) {
                    SQLiteDatabase sQLiteDatabase = this.database;
                    Locale locale = Locale.US;
                    SQLiteCursor queryFinalized = sQLiteDatabase.queryFinalized(android.support.v4.media.a.n(chat.f20845id, "SELECT data FROM chats WHERE uid = "), new Object[0]);
                    if (queryFinalized.next()) {
                        try {
                            NativeByteBuffer byteBufferValue = queryFinalized.byteBufferValue(0);
                            if (byteBufferValue != null) {
                                ...
                                if (TLdeserialize != null) {
                                    ...
                                    if (k7.x8.a(chat.flags2, 1048576)) {
                ...
                executeFast.bindLong(1, chat.f20845id);
                ...
                executeFast.step();
                nativeByteBuffer.reuse();
                isForumCacheInvalidate(-chat.f20845id);
            }
            executeFast.dispose();
        }
    }
    ...
    public void lambda$putEphemeralMessages$204(ArrayList<TL_ephemeral.EphemeralMessage> arrayList, boolean z4) {
        ...
        while (i10 < size) {
            ...
            if (!ephemeralMessage2.welcome) {
                ...
                sQLitePreparedStatement.bindInteger(2, ephemeralMessage2.f21058id);
            ...
            for (int i13 = 0; i13 < list.size(); i13++) {
                ...
                if (user != null) {
                    if (user.min) {
                        SQLiteDatabase sQLiteDatabase = this.database;
                        Locale locale = Locale.US;
                        SQLiteCursor queryFinalized = sQLiteDatabase.queryFinalized(android.support.v4.media.a.n(user.f20992id, "SELECT data FROM users WHERE uid = "), new Object[0]);
                        if (queryFinalized.next()) {
                            try {
                                NativeByteBuffer byteBufferValue = queryFinalized.byteBufferValue(0);
                                if (byteBufferValue != null) {
                    ...
                    executeFast.bindLong(1, user.f20992id);
                    ...
                    executeFast.step();
                    nativeByteBuffer.reuse();
                    isForumCacheInvalidate(user.f20992id);
                }
            }
            executeFast.dispose();
        }
    ...
    private void saveDialogFilterInternal(MessagesController.DialogFilter dialogFilter, boolean z4, boolean z10) {
        ...
        try {
            try {
                if (!this.dialogFilters.contains(dialogFilter)) {
                    ...
                    this.dialogFiltersMap.put(dialogFilter.f18057id, dialogFilter);
                }
        ...
        try {
            executeFast.bindInteger(1, dialogFilter.f18057id);
            ...
            if (z10) {
                SQLiteDatabase sQLiteDatabase = this.database;
                sQLiteDatabase.executeFast("DELETE FROM dialog_filter_ep WHERE id = " + dialogFilter.f18057id).stepThis().dispose();
                SQLiteDatabase sQLiteDatabase2 = this.database;
                sQLiteDatabase2.executeFast("DELETE FROM dialog_filter_pin_v2 WHERE id = " + dialogFilter.f18057id).stepThis().dispose();
                this.database.beginTransaction();
                ...
                for (int i11 = 0; i11 < size; i11++) {
                    ...
                    executeFast2.bindInteger(1, dialogFilter.f18057id);
                ...
                for (i10 = 0; i10 < size3; i10++) {
                    ...
                    executeFast3.bindInteger(1, dialogFilter.f18057id);
    ...
    public void lambda$saveStoryAlbumsCache$269(long r6, java.util.List<oh.m6> r8) {
    ...
    private void updateUnreadReactionsCountInternal(String str, String str2, String str3, String str4, long j10, long j11, int i10, boolean z4) {
        this.storageQueue.postRunnable(new mh.f7(this, j11, z4, str4, j10, i10, str2, str3, str));
    }
                ...
                if (z4) {
                    ...
                    try {
                        ...
                        for (int i10 = 0; i10 < size; i10++) {
                            ...
                            executeFast.bindLong(2, user.f20992id);
                            executeFast.step();
                        }
                        executeFast.dispose();
                        if (z10) {
                    ...
                    for (int i11 = 0; i11 < size2; i11++) {
                        ...
                        arrayList2.add(Long.valueOf(user2.f20992id));
                        hVar.k(user2, user2.f20992id);
                    }
                    ...
                    for (int i12 = 0; i12 < size3; i12++) {
                        ...
                        TLRPC.User user4 = (TLRPC.User) hVar.f(user3.f20992id);
                        if (user4 != null) {
    ...
    public boolean checkMessageId(long j10, int i10) {
        boolean[] zArr = new boolean[1];
        CountDownLatch countDownLatch = new CountDownLatch(1);
        this.storageQueue.postRunnable(new lh.x(this, j10, i10, zArr, countDownLatch, 6));
        try {
            countDownLatch.await();
        } catch (Exception e6) {
            checkSQLException(e6);
    ...
    public boolean containsLocalDialog(long j10) {
        ...
        this.storageQueue.postRunnable(new mh.b2(this, j10, boolArr, countDownLatch, 25));
        try {
            countDownLatch.await();
        } catch (Exception e6) {
            checkSQLException(e6);
            ...
            try {
                ...
                while (sQLiteCursor.next()) {
                    ...
                    try {
                        ...
                        if (TLdeserialize != null && TLdeserialize.f20851id != 0) {
                            arrayList.add(TLdeserialize);
                        }
                    } catch (Exception e6) {
                        checkSQLException(e6);
    ...
    public int getChannelPtsSync(long j10) {
        CountDownLatch countDownLatch = new CountDownLatch(1);
        Integer[] numArr = {0};
        this.storageQueue.postRunnable(new mh.b2(this, j10, numArr, countDownLatch, 26));
        try {
            countDownLatch.await();
        } catch (Exception e6) {
            checkSQLException(e6);
    ...
    public TLRPC.Chat getChatSync(long j10) {
        ...
        this.storageQueue.postRunnable(new mh.b2(this, chatArr, j10, countDownLatch, 27));
        try {
            countDownLatch.await();
        } catch (Exception e6) {
            checkSQLException(e6);
    ...
    public void getEncryptedChat(long j10, CountDownLatch countDownLatch, ArrayList<TLObject> arrayList) {
        ...
        this.storageQueue.postRunnable(new mh.b2(this, j10, arrayList, countDownLatch, 29));
    }
    ...
    public TLRPC.Message getMessage(long j10, long j11) {
        ...
        this.storageQueue.postRunnable(new hg.s0(this, j10, j11, atomicReference, countDownLatch, 4));
        try {
            countDownLatch.await();
        } catch (Exception e6) {
            checkSQLException(e6);
    ...
    public Object[] getSentFile(String str, int i10) {
        ...
        CountDownLatch countDownLatch = new CountDownLatch(1);
        Object[] objArr = new Object[2];
        this.storageQueue.postRunnable(new eg.d3(this, str, i10, objArr, countDownLatch, 6));
        try {
            countDownLatch.await();
        } catch (Exception e6) {
            checkSQLException(e6);
    ...
    public TLRPC.User getUserSync(long j10) {
        ...
        this.storageQueue.postRunnable(new mh.b2(this, userArr, j10, countDownLatch, 24));
        try {
            countDownLatch.await();
        } catch (Exception e6) {
            checkSQLException(e6);
    ...
    public void loadStoryAlbumsCache(long j10, Consumer<List<oh.m6>> consumer) {
    ...
    public void overwriteChannel(long j10, TLRPC.TL_updates_channelDifferenceTooLong tL_updates_channelDifferenceTooLong, int i10, Runnable runnable) {
        this.storageQueue.postRunnable(new lh.x(this, j10, i10, tL_updates_channelDifferenceTooLong, runnable, 7));
    }
    ...
    public void putChannelViews(a0.h hVar, a0.h hVar2, a0.h hVar3, boolean z4) {
        ...
        this.storageQueue.postRunnable(new hg.j(this, hVar, hVar2, hVar3, z4, 4));
    }
    ...
    public void putSentFile(String str, TLObject tLObject, int i10, String str2) {
        if (str != null && tLObject != null && str2 != null) {
            this.storageQueue.postRunnable(new eg.d3(this, str, tLObject, i10, str2, 7));
        }
    }
    ...
    public void replaceMessageIfExists(TLRPC.Message message, ArrayList<TLRPC.User> arrayList, ArrayList<TLRPC.Chat> arrayList2, boolean z4) {
        ...
        this.storageQueue.postRunnable(new hg.j(this, message, z4, arrayList, arrayList2, 5));
    }
        ...
        try {
            try {
                ...
                for (int i10 = 0; i10 < size; i10++) {
                    ...
                    sQLitePreparedStatement.bindInteger(3, dialogFilter.f18057id);
                    sQLitePreparedStatement.step();
                }
                sQLitePreparedStatement.dispose();
            } catch (Exception e6) {
    ...
    public void saveStoryAlbumsCache(long j10, List<oh.m6> list) {
    ...
    public void setDialogsFolderId(ArrayList<TLRPC.TL_folderPeer> arrayList, ArrayList<TLRPC.TL_inputFolderPeer> arrayList2, long j10, int i10) {
        ...
        this.storageQueue.postRunnable(new lh.x(this, arrayList, arrayList2, i10, j10));
    }
    ...
    public void updateChatDefaultBannedRights(long j10, TLRPC.TL_chatBannedRights tL_chatBannedRights, int i10) {
        if (tL_chatBannedRights != null && j10 != 0) {
            this.storageQueue.postRunnable(new mh.y8(this, j10, i10, tL_chatBannedRights, 9));
        }
    }
    ...
    public void updateDialogsWithDeletedMessages(long j10, long j11, ArrayList<Integer> arrayList, ArrayList<Long> arrayList2) {
        executeInStorageQueue(new hg.s0(this, j10, j11, arrayList, arrayList2, 5));
    }
    ...
    public void updateMessagePollResults(long j10, TLRPC.Poll poll, TLRPC.PollResults pollResults) {
        this.storageQueue.postRunnable(new mh.b2(this, j10, poll, pollResults, 22));
    }

    public void updateMessageReactions(long j10, int i10, TLRPC.TL_messageReactions tL_messageReactions) {
        this.storageQueue.postRunnable(new mh.y8(this, i10, j10, tL_messageReactions, 8));
    }
    ...
    public void updateMessageVoiceTranscriptionOpen(long j10, int i10, TLRPC.Message message) {
        this.storageQueue.postRunnable(new mh.y8(this, i10, j10, message, 7));
    }
    ...
    public void updateMessageVoiceTranscription(long j10, int i10, String str, TLRPC.Message message) {
        this.storageQueue.postRunnable(new lh.x(this, i10, j10, message, str));
    }
    ...
    private void onReactionsUpdate(long j10, TLRPC.TL_messageReactions tL_messageReactions, TLRPC.TL_messageReactions tL_messageReactions2) {
        ...
        AndroidUtilities.runOnUIThread(new mh.b2(this, tL_messageReactions, tL_messageReactions2, j10, 23));
    }
