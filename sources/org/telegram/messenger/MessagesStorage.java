...
public class MessagesStorage extends BaseController {
    ...
    private void fixUnsupportedMedia(TLRPC.Message message) {
        ...
        if (messageMedia instanceof TLRPC.TL_messageMediaUnsupported_old) {
            if (messageMedia.bytes.length == 0) {
                messageMedia.bytes = Utilities.intToBytes(202);
            }
            ...
            tL_messageMediaUnsupported_old.bytes = Utilities.intToBytes(202);
            message.flags |= 512;
        }
    }
    ...
    public void lambda$replaceMessageIfExists$216(org.telegram.tgnet.TLRPC.Message r25, boolean r26, java.util.ArrayList r27, java.util.ArrayList r28) {
    ...
    private void saveDialogFilterInternal(MessagesController.DialogFilter dialogFilter, boolean z, boolean z2) {
        ...
        try {
            ...
            Vector vector = new Vector(new MessagesStorage$$ExternalSyntheticLambda43());
