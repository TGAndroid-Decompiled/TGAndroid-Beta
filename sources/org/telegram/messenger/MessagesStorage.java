...
public class MessagesStorage extends BaseController {
    ...
    private final kf.v ephemeralWelcomeAnchorsState;
    private int[][] groups;
    ...
    public MessagesStorage(int i10) {
        ...
        this.ephemeralWelcomeAnchorsState = new kf.v();
        DispatchQueue dispatchQueue = new DispatchQueue(kf.k0.j(i10, "storageQueue_"));
        ...
        if (tL_messageReactions != null && tL_messageReactions.reactions_as_tags && (arrayList = tL_messageReactions.results) != null && !arrayList.isEmpty()) {
            ...
            while (i10 < size) {
                ...
                if ((reaction instanceof TLRPC.TL_reactionEmoji) || (reaction instanceof TLRPC.TL_reactionCustomEmoji)) {
                    ...
                    sQLitePreparedStatement.bindLong(1, message.f19180id);
    ...
    private void createOrEditTopic(long j10, TLRPC.Message message) {
        ...
        tL_forumTopic.top_message = message.f19180id;
        ...
        if (messageAction instanceof TLRPC.TL_messageActionTopicCreate) {
            ...
            tL_forumTopic.f19211id = message.f19180id;
            ...
            AndroidUtilities.runOnUIThread(new d4(this, j10, tL_forumTopic, 21));
            ...
            tL_forumTopic.f19211id = (int) MessageObject.getTopicId(this.currentAccount, message, true);
    ...
    public void lambda$deleteDialogFilter$72(MessagesController.DialogFilter dialogFilter) {
        try {
            ...
            this.dialogFiltersMap.remove(dialogFilter.f16649id);
            SQLiteDatabase sQLiteDatabase = this.database;
            sQLiteDatabase.executeFast("DELETE FROM dialog_filter WHERE id = " + dialogFilter.f16649id).stepThis().dispose();
            SQLiteDatabase sQLiteDatabase2 = this.database;
            sQLiteDatabase2.executeFast("DELETE FROM dialog_filter_ep WHERE id = " + dialogFilter.f16649id).stepThis().dispose();
            SQLiteDatabase sQLiteDatabase3 = this.database;
            sQLiteDatabase3.executeFast("DELETE FROM dialog_filter_pin_v2 WHERE id = " + dialogFilter.f16649id).stepThis().dispose();
        } catch (Exception e) {
            checkSQLException(e);
        }
    }
    ...
    public void lambda$deleteEphemeralMessages$206(a0.h hVar, boolean z4) {
        ...
        for (int i10 = 0; i10 < deleteEphemeralMessagesInternal.m(); i10++) {
            ...
            while (i11 < size) {
                ...
                if (i12 != 0) {
                    kf.v vVar = this.ephemeralWelcomeAnchorsState;
                    int i13 = ephemeralMessage.f19370id;
                    a0.h hVar3 = vVar.f10511a;
            ...
            try {
                ...
                while (queryFinalized.next()) {
                    try {
                        ...
                        downloadObject.f16638id = queryFinalized.longValue(0);
    ...
    public void lambda$getMessages$162(Timer.Task task, Timer timer, long j10, long j11, int i10, int i11, int i12, int i13, int i14, int i15, int i16, long j12, int i17, boolean z4, boolean z10) {
        ...
        Timer.done(start);
        Utilities.stageQueue.postRunnable(new fc(22, Timer.start(timer, "MessagesStorage.getMessages: stageQueue.postRunnable"), messagesInternal));
    }
    ...
    public static int lambda$getMessagesInternal$159(TLRPC.Message message, TLRPC.Message message2) {
        ...
        int i12;
        int i13;
        if (!MessageObject.isEphemeralMessageId(message.f19180id) && !MessageObject.isEphemeralMessageId(message2.f19180id)) {
            int i14 = message.f19180id;
            if (i14 > 0 && (i13 = message2.f19180id) > 0) {
                if (i14 > i13) {
                    return -1;
                }
                if (i14 < i13) {
            ...
            } else if (i14 < 0 && (i12 = message2.f19180id) < 0) {
                if (i14 < i12) {
                    return -1;
                }
                if (i14 > i12) {
        ...
        if ((!MessageObject.isEphemeralMessageId(message.f19180id) && MessageObject.isEphemeralMessageId(message2.f19180id)) || (i10 = message.f19180id) > (i11 = message2.f19180id)) {
            return 1;
        }
        if (i10 >= i11) {
            return 0;
            ...
            try {
                ...
                while (queryFinalized.next()) {
                    ...
                    if (!DialogObject.isFolderDialogId(longValue3)) {
                        ...
                        hVar.k(tL_dialog, tL_dialog.f19163id);
                        ...
                        if (byteBufferValue != null) {
                            ...
                            TLdeserialize.f19180id = queryFinalized.intValue(6);
                ...
                if (!z4 && arrayList.size() > hVar.m()) {
                    ...
                    for (int i12 = 0; i12 < size; i12++) {
                        ...
                        if (hVar.f(((Long) arrayList.get(i12)).longValue()) == null) {
                            ...
                            tL_dialog2.f19163id = longValue4;
    ...
    public static int lambda$localSearch$260(tf.u uVar, tf.u uVar2) {
        int i10 = uVar.f44897b;
        int i11 = uVar2.f44897b;
        if (i10 < i11) {
            return 1;
        }
        if (i10 > i11) {
    ...
    public void lambda$saveDialogFiltersOrder$75(ArrayList arrayList) {
        ...
        for (int i10 = 0; i10 < arrayList.size(); i10++) {
            ...
            this.dialogFiltersMap.put(((MessagesController.DialogFilter) arrayList.get(i10)).f16649id, (MessagesController.DialogFilter) arrayList.get(i10));
        }
    ...
    public void lambda$updateChatParticipants$122(TLRPC.ChatParticipants chatParticipants) {
        ...
        try {
            ...
            if (chatFull instanceof TLRPC.TL_chatFull) {
                ...
                executeFast.bindLong(1, chatFull.f19160id);
                executeFast.bindByteBuffer(2, nativeByteBuffer);
    ...
    public void lambda$updateEncryptedChatLayer$173(TLRPC.EncryptedChat encryptedChat) {
        ...
        try {
            try {
                ...
                sQLitePreparedStatement.bindInteger(2, encryptedChat.f19167id);
                sQLitePreparedStatement.step();
                sQLitePreparedStatement.dispose();
            } catch (Exception e) {
                checkSQLException(e);
    ...
    public void lambda$updateEncryptedChatSeq$171(TLRPC.EncryptedChat encryptedChat, boolean z4) {
        ...
        try {
            try {
                ...
                sQLitePreparedStatement.bindInteger(6, encryptedChat.f19167id);
                sQLitePreparedStatement.step();
                if (z4 && encryptedChat.in_seq_no != 0) {
                    long encryptedChatId = DialogObject.getEncryptedChatId(encryptedChat.f19167id);
                    SQLiteDatabase sQLiteDatabase = this.database;
                    Locale locale = Locale.US;
    ...
    public void lambda$updateMessageCustomParams$110(TLRPC.Message message, long j10) {
        ...
        try {
            try {
                this.database.beginTransaction();
                TLRPC.Message messageWithCustomParamsOnlyInternal = getMessageWithCustomParamsOnlyInternal(message.f19180id, j10);
                ...
                for (int i10 = 0; i10 < 2; i10++) {
                    ...
                    try {
                        ...
                        executeFast.bindInteger(2, message.f19180id);
                        executeFast.bindLong(3, j10);
                        executeFast.step();
                        executeFast.dispose();
                        if (writeLocalParams != null) {
    ...
    private void processAnchoredEphemeralMessagesInternal(ArrayList<TL_ephemeral.EphemeralMessage> arrayList) {
        ...
        while (i10 < size) {
            ...
            kf.v vVar = this.ephemeralWelcomeAnchorsState;
            int i12 = ephemeralMessage2.f19370id;
            a0.h hVar = vVar.f10511a;
    ...
    private void processEphemeralEditedMessagesInternal(ArrayList<TL_ephemeral.EphemeralMessage> arrayList) {
        ...
        while (i11 < size) {
            ...
            i11++;
            TL_ephemeral.EphemeralMessage ephemeralMessage2 = ephemeralMessage;
            if (ephemeralMessage2.top_msg_id == 0 && (ephemeralMessageInternal = getEphemeralMessageInternal(DialogObject.getPeerDialogId(ephemeralMessage2.peer_id), ephemeralMessage2.f19370id)) != null && (i10 = ephemeralMessageInternal.top_msg_id) != 0) {
    ...
    public void lambda$processLoadedFilterPeers$71(TLRPC.messages_Dialogs messages_dialogs, TLRPC.messages_Dialogs messages_dialogs2, ArrayList<TLRPC.User> arrayList, ArrayList<TLRPC.Chat> arrayList2, ArrayList<MessagesController.DialogFilter> arrayList3, SparseArray<MessagesController.DialogFilter> sparseArray, ArrayList<Integer> arrayList4, HashMap<Integer, HashSet<Long>> hashMap, HashSet<Integer> hashSet, Runnable runnable) {
        ...
        for (int i13 = 0; i13 < size3; i13++) {
            ...
            int indexOf = arrayList4.indexOf(Integer.valueOf(dialogFilter3.f16649id));
        ...
        if (list != null && !list.isEmpty()) {
            ...
            for (int i10 = 0; i10 < list.size(); i10++) {
                ...
                if (chat.min) {
                    SQLiteDatabase sQLiteDatabase = this.database;
                    Locale locale = Locale.US;
                    SQLiteCursor queryFinalized = sQLiteDatabase.queryFinalized(android.support.v4.media.a.n(chat.f19159id, "SELECT data FROM chats WHERE uid = "), new Object[0]);
                    if (queryFinalized.next()) {
                        try {
                            NativeByteBuffer byteBufferValue = queryFinalized.byteBufferValue(0);
                            if (byteBufferValue != null) {
                ...
                executeFast.bindLong(1, chat.f19159id);
                ...
                executeFast.step();
                nativeByteBuffer.reuse();
                isForumCacheInvalidate(-chat.f19159id);
            }
            executeFast.dispose();
        }
    }
    ...
    public void lambda$putEphemeralMessages$204(ArrayList<TL_ephemeral.EphemeralMessage> arrayList, boolean z4) {
        ...
        while (i10 < size) {
            ...
            if (!ephemeralMessage2.welcome) {
                ...
                sQLitePreparedStatement.bindInteger(2, ephemeralMessage2.f19370id);
            ...
            for (int i13 = 0; i13 < list.size(); i13++) {
                ...
                if (user != null) {
                    if (user.min) {
                        SQLiteDatabase sQLiteDatabase = this.database;
                        Locale locale = Locale.US;
                        SQLiteCursor queryFinalized = sQLiteDatabase.queryFinalized(android.support.v4.media.a.n(user.f19306id, "SELECT data FROM users WHERE uid = "), new Object[0]);
                        if (queryFinalized.next()) {
                            try {
                                NativeByteBuffer byteBufferValue = queryFinalized.byteBufferValue(0);
                                if (byteBufferValue != null) {
                    ...
                    executeFast.bindLong(1, user.f19306id);
                    ...
                    executeFast.step();
                    nativeByteBuffer.reuse();
                    isForumCacheInvalidate(user.f19306id);
                }
            }
            executeFast.dispose();
        }
    ...
    private void saveDialogFilterInternal(MessagesController.DialogFilter dialogFilter, boolean z4, boolean z10) {
        ...
        try {
            try {
                if (!this.dialogFilters.contains(dialogFilter)) {
                    ...
                    this.dialogFiltersMap.put(dialogFilter.f16649id, dialogFilter);
                }
        ...
        try {
            executeFast.bindInteger(1, dialogFilter.f16649id);
            ...
            if (z10) {
                SQLiteDatabase sQLiteDatabase = this.database;
                sQLiteDatabase.executeFast("DELETE FROM dialog_filter_ep WHERE id = " + dialogFilter.f16649id).stepThis().dispose();
                SQLiteDatabase sQLiteDatabase2 = this.database;
                sQLiteDatabase2.executeFast("DELETE FROM dialog_filter_pin_v2 WHERE id = " + dialogFilter.f16649id).stepThis().dispose();
                this.database.beginTransaction();
                ...
                for (int i11 = 0; i11 < size; i11++) {
                    ...
                    executeFast2.bindInteger(1, dialogFilter.f16649id);
                ...
                for (i10 = 0; i10 < size3; i10++) {
                    ...
                    executeFast3.bindInteger(1, dialogFilter.f16649id);
                ...
                if (z4) {
                    ...
                    try {
                        ...
                        for (int i10 = 0; i10 < size; i10++) {
                            ...
                            executeFast.bindLong(2, user.f19306id);
                            executeFast.step();
                        }
                        executeFast.dispose();
                        if (z10) {
                    ...
                    for (int i11 = 0; i11 < size2; i11++) {
                        ...
                        arrayList2.add(Long.valueOf(user2.f19306id));
                        hVar.k(user2, user2.f19306id);
                    }
                    ...
                    for (int i12 = 0; i12 < size3; i12++) {
                        ...
                        TLRPC.User user4 = (TLRPC.User) hVar.f(user3.f19306id);
                        if (user4 != null) {
    ...
    public void addRecentLocalFile(String str, String str2, TLRPC.Document document) {
        if (str != null && str.length() != 0) {
            if ((str2 != null && str2.length() != 0) || document != null) {
                this.storageQueue.postRunnable(new sk(this, document, str, str2, 28));
            }
        }
    }
    ...
    public void applyPhoneBookUpdates(String str, String str2) {
        ...
        this.storageQueue.postRunnable(new d9(this, str, str2, 18));
    }
    ...
    public long createPendingTask(NativeByteBuffer nativeByteBuffer) {
        ...
        this.storageQueue.postRunnable(new d4(this, andAdd, nativeByteBuffer, 22));
        return andAdd;
    }
    ...
    public void deleteDialogFilter(MessagesController.DialogFilter dialogFilter) {
        this.storageQueue.postRunnable(new fc(24, this, dialogFilter));
    }
            ...
            try {
                ...
                while (sQLiteCursor.next()) {
                    ...
                    try {
                        ...
                        if (TLdeserialize != null && TLdeserialize.f19165id != 0) {
                            arrayList.add(TLdeserialize);
                        }
                    } catch (Exception e) {
                        checkSQLException(e);
    ...
    public void getNewTask(a0.h hVar, a0.h hVar2) {
        this.storageQueue.postRunnable(new d9(this, hVar, hVar2, 20));
    }
    ...
    public void getWidgetDialogs(int i10, int i11, ArrayList<Long> arrayList, a0.h hVar, a0.h hVar2, ArrayList<TLRPC.User> arrayList2, ArrayList<TLRPC.Chat> arrayList3) {
        CountDownLatch countDownLatch = new CountDownLatch(1);
        this.storageQueue.postRunnable(new kf.c(this, i10, arrayList, i11, hVar, hVar2, arrayList3, arrayList2, countDownLatch));
        try {
            countDownLatch.await();
        } catch (Exception e) {
            checkSQLException(e);
    ...
    public void isDialogHasTopMessage(long j10, Runnable runnable) {
        this.storageQueue.postRunnable(new d4(this, j10, runnable, 17));
    }
    ...
    public void loadGiftChatTheme(Utilities.Callback<List<TLRPC.TL_chatThemeUniqueGift>> callback) {
        executeInStorageQueue(new fc(25, this, callback));
    }
    ...
    public void markMessagesAsRead(LongSparseIntArray longSparseIntArray, LongSparseIntArray longSparseIntArray2, SparseIntArray sparseIntArray, boolean z4) {
        if (z4) {
            this.storageQueue.postRunnable(new sk(this, longSparseIntArray, longSparseIntArray2, sparseIntArray, 29));
        } else {
    ...
    public void markMessagesContentAsRead(long j10, ArrayList<Integer> arrayList, int i10, int i11) {
        ...
        this.storageQueue.postRunnable(new t(i11, i10, j10, arrayList, this));
    }
    ...
    public void putChannelAdmins(long j10, a0.h hVar) {
        this.storageQueue.postRunnable(new d4(this, j10, hVar, 23));
    }
    ...
    public void putEncryptedChat(TLRPC.EncryptedChat encryptedChat, TLRPC.User user, TLRPC.Dialog dialog) {
        ...
        this.storageQueue.postRunnable(new sk(this, encryptedChat, user, dialog, 27));
    }
    ...
    public void putGiftChatThemes(List<TLRPC.ChatTheme> list) {
        executeInStorageQueue(new fc(20, this, list));
    }
    ...
    public void putPushMessage(MessageObject messageObject) {
        this.storageQueue.postRunnable(new fc(21, this, messageObject));
    }
    ...
    public void putStoryPushMessage(NotificationsController.StoryNotification storyNotification) {
        this.storageQueue.postRunnable(new fc(26, this, storyNotification));
    }
    ...
    public void saveBotCache(String str, TLObject tLObject) {
        if (tLObject != null && !TextUtils.isEmpty(str)) {
            this.storageQueue.postRunnable(new d9(this, tLObject, str, 17));
        }
    }
        ...
        try {
            try {
                ...
                for (int i10 = 0; i10 < size; i10++) {
                    ...
                    sQLitePreparedStatement.bindInteger(3, dialogFilter.f16649id);
                    sQLitePreparedStatement.step();
                }
                sQLitePreparedStatement.dispose();
            } catch (Exception e) {
    ...
    public void saveStoryAlbumsCache(long j10, List<nh.m6> list) {
        this.storageQueue.postRunnable(new d4(this, j10, list, 19));
    }
    ...
    public void updateChatParticipants(TLRPC.ChatParticipants chatParticipants) {
        ...
        this.storageQueue.postRunnable(new fc(23, this, chatParticipants));
    }
    ...
    public void updateDialogData(TLRPC.Dialog dialog) {
        ...
        this.storageQueue.postRunnable(new fc(28, this, dialog));
    }
    ...
    public void updateTopicsWithReadMessages(HashMap<TopicKey, Integer> hashMap) {
        this.storageQueue.postRunnable(new fc(19, this, hashMap));
    }
    ...
    public void updateUserInfoContactBlocked(long j10, TL_account.RequirementToContact requirementToContact) {
        this.storageQueue.postRunnable(new d4(this, j10, requirementToContact, 16));
    }
    ...
    public void updateTopicData(long j10, TLRPC.TL_forumTopic tL_forumTopic, int i10, int i11) {
        ...
        this.storageQueue.postRunnable(new t(this, i10, tL_forumTopic, j10, i11));
    }
