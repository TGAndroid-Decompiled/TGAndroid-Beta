...
public final class o9 implements Runnable {
    ...
    public final void run() {
        ...
        switch (this.f17163a) {
            case 0:
                ...
                ((MediaDataController) this.e).lambda$loadBotInfo$199(this.f17164b, this.d, (Utilities.Callback) this.f17166f, i11);
                return;
            case 1:
                int i12 = this.f17165c;
                long j3 = this.d;
                ((MessagesController) this.e).lambda$loadFullChat$67(this.f17164b, (TLRPC.TL_messages_chatFull) this.f17166f, i12, j3);
                return;
            case 2:
                int i13 = this.f17165c;
                ((MessagesStorage) this.e).lambda$loadPendingTasks$20(this.f17164b, this.d, (TLMethod) this.f17166f, i13);
                return;
            default:
                org.telegram.ui.ActionBar.e1 e1Var = (org.telegram.ui.ActionBar.e1) this.e;
                org.telegram.ui.ActionBar.e1 e1Var2 = (org.telegram.ui.ActionBar.e1) this.f17166f;
                int i14 = this.f17165c;
    ...
    public o9(MessagesController messagesController, long j3, TLRPC.TL_messages_chatFull tL_messages_chatFull, int i10, long j10) {
        ...
        this.f17164b = j3;
        this.f17166f = tL_messages_chatFull;
        this.f17165c = i10;
        this.d = j10;
    }
}
