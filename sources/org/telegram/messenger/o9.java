...
public final class o9 implements Runnable {
    ...
    public final void run() {
        ...
        switch (this.f16922a) {
            case 0:
                ...
                ((MediaDataController) this.e).lambda$loadBotInfo$199(this.f16923b, this.d, (Utilities.Callback) this.f16925f, i11);
                return;
            case 1:
                int i12 = this.f16924c;
                long j3 = this.d;
                ((MessagesController) this.e).lambda$loadFullChat$67(this.f16923b, (TLRPC.TL_messages_chatFull) this.f16925f, i12, j3);
                return;
            case 2:
                int i13 = this.f16924c;
                ((MessagesStorage) this.e).lambda$loadPendingTasks$20(this.f16923b, this.d, (TLMethod) this.f16925f, i13);
                return;
            default:
                org.telegram.ui.ActionBar.f1 f1Var = (org.telegram.ui.ActionBar.f1) this.e;
                org.telegram.ui.ActionBar.f1 f1Var2 = (org.telegram.ui.ActionBar.f1) this.f16925f;
                int i14 = this.f16924c;
                MessagesController messagesController = MessagesController.getInstance(i14);
                long j10 = this.f16923b;
                long j11 = this.d;
    ...
    public o9(MessagesController messagesController, long j3, TLRPC.TL_messages_chatFull tL_messages_chatFull, int i10, long j10) {
        ...
        this.f16923b = j3;
        this.f16925f = tL_messages_chatFull;
        this.f16924c = i10;
        this.d = j10;
    }
}
