    ...
    public final void run() {
        ...
        switch (this.f16020a) {
            case 0:
                ...
                ((SendMessagesHelper) this.e).lambda$performSendMessageRequest$96((ArrayList) this.f16023f, this.f16022c, this.d, (TLRPC.Message) this.f16025r, (ArrayList) this.h, (ArrayList) this.f16024n, i10);
                return;
            default:
                ...
                org.telegram.ui.qa qaVar = faVar.f33588a;
                ArrayList arrayList = qaVar.f36836w;
                ...
                if (qaVar.f36837x != 0 && arrayList2 != null) {
