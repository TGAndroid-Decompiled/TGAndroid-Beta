...
public final class bj implements Runnable {
    public final int f15765a = 0;
    public final int f15766b;
    public final boolean f15767c;
    public final boolean d;
    public final Object e;
    public final Serializable f15768f;
    public final Object h;
    public final Object f15769n;
    public final TLObject f15770r;
    ...
    public bj(SendMessagesHelper sendMessagesHelper, ArrayList arrayList, boolean z10, boolean z11, TLRPC.Message message, ArrayList arrayList2, ArrayList arrayList3, int i10) {
        ...
        this.f15767c = z10;
        this.d = z11;
        this.f15770r = message;
        this.h = arrayList2;
        this.f15769n = arrayList3;
        this.f15766b = i10;
    }
    ...
    public final void run() {
        ...
        switch (this.f15765a) {
            case 0:
                ...
                ((SendMessagesHelper) this.e).lambda$performSendMessageRequest$96((ArrayList) this.f15768f, this.f15767c, this.d, (TLRPC.Message) this.f15770r, (ArrayList) this.h, (ArrayList) this.f15769n, i11);
                return;
            default:
                org.telegram.ui.fa faVar = (org.telegram.ui.fa) this.e;
                TLRPC.TL_error tL_error = (TLRPC.TL_error) this.f15769n;
                TLRPC.TL_username tL_username2 = (TLRPC.TL_username) this.f15770r;
                org.telegram.ui.qa qaVar = faVar.f33265a;
                ArrayList arrayList = qaVar.f36342w;
                ArrayList arrayList2 = qaVar.v;
                arrayList.remove((String) this.f15768f);
                ...
                if (z10) {
                    ...
                    if (tL_error != null && "USERNAMES_ACTIVE_TOO_MUCH".equals(tL_error.text)) {
                        ...
                        alertDialog$Builder.f18409a.R = LocaleController.getString(R.string.UsernameActivateErrorTitle);
                        alertDialog$Builder.f18409a.T = LocaleController.getString(R.string.UsernameActivateErrorMessage);
                ...
                if (qaVar.f36343x != 0 && arrayList2 != null) {
    ...
    public bj(org.telegram.ui.fa faVar, String str, TLObject tLObject, int i10, boolean z10, TLRPC.TL_error tL_error, TLRPC.TL_username tL_username, boolean z11) {
        ...
        this.f15766b = i10;
        this.f15767c = z10;
        this.f15769n = tL_error;
        this.f15770r = tL_username;
        this.d = z11;
    }
}
