...
public final class AiTonesController {
    ...
    public void add(TL_aicompose.AiComposeTone aiComposeTone) {
        if (aiComposeTone instanceof TL_aicompose.TL_aiComposeTone) {
            long j3 = ((TL_aicompose.TL_aiComposeTone) aiComposeTone).f18545id;
            for (int i10 = 0; i10 < this.tones.size(); i10++) {
                if ((this.tones.get(i10) instanceof TL_aicompose.TL_aiComposeTone) && ((TL_aicompose.TL_aiComposeTone) this.tones.get(i10)).f18545id == j3) {
                    return;
                }
            }
        }
    ...
    public void edit(TL_aicompose.TL_aiComposeTone tL_aiComposeTone) {
        for (int i10 = 0; i10 < this.tones.size(); i10++) {
            if ((this.tones.get(i10) instanceof TL_aicompose.TL_aiComposeTone) && ((TL_aicompose.TL_aiComposeTone) this.tones.get(i10)).f18545id == tL_aiComposeTone.f18545id) {
