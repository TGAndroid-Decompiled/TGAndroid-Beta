...
public class NativeInstance {
    ...
    public static void a(NativeInstance nativeInstance, int i10, String str) {
        nativeInstance.lambda$onEmitJoinPayload$3(i10, str);
    }
    ...
    public void lambda$onParticipantDescriptionsRequired$2(long j3, int[] iArr) {
    ...
    public static NativeInstance make(String str, Instance.Config config, String str2, Instance.Endpoint[] endpointArr, Instance.Proxy proxy, int i10, Instance.EncryptionKey encryptionKey, VideoSink videoSink, long j3, AudioLevelsCallback audioLevelsCallback) {
        ...
        nativeInstance.nativePtr = makeNativeInstance(str, nativeInstance, config, str2, endpointArr, proxy, i10, encryptionKey, videoSink, j3, Math.min(point.x, point.y) / Math.max(point2.x, point2.y));
