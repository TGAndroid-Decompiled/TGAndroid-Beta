...
public class ConferenceCall {
    ...
    private final Runnable pollRunnable = new ConferenceCall$$ExternalSyntheticLambda3(this, 2);
    ...
    public static final class CallVerificationState {
        ...
        public String toString() {
            ...
            return MediaSessionConnector$DefaultMediaMetadataProvider$$ExternalSyntheticOutline0.m(sb, str, "}");
        }
    }
    ...
    private void checkEmojiHash() {
        ...
        AndroidUtilities.runOnUIThread(new ConferenceCall$$ExternalSyntheticLambda3(this, 0));
    }
    ...
    private void checkParticipants() {
        ...
        AndroidUtilities.runOnUIThread(new ConferenceCall$$ExternalSyntheticLambda3(this, 1));
    }
    ...
    public void lambda$kick$13(long j, TLObject tLObject, TLRPC.TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new ConferenceCall$$ExternalSyntheticLambda0(this, j, tLObject, tL_error, 1));
    }
    ...
    public void lambda$pull_outbound$6(long j, TLObject tLObject, TLRPC.TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new ConferenceCall$$ExternalSyntheticLambda0(this, j, tLObject, tL_error, 0));
    }
    ...
    public void lambda$updateParticipants$11(long j, TLObject tLObject, TLRPC.TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new ConferenceCall$$ExternalSyntheticLambda0(this, j, tLObject, tL_error, 2));
    }
    ...
    public void poll() {
        ...
        for (int i = 0; i < 2; i++) {
            ...
            this.pollRequestId[i] = ConnectionsManager.getInstance(this.currentAccount).sendRequest(getgroupcallchainblocks, new PhotoUtilities$$ExternalSyntheticLambda2(this, getgroupcallchainblocks, System.currentTimeMillis(), atomicBoolean, atomicInteger));
        }
        if (this.call_id >= 0) {
            try {
            ...
            try {
                ...
                sb.append(TextUtils.join("\n ", (Iterable) DesugarArrays.stream(call_get_state(this.call_id).participants).map(new ConferenceCall$$ExternalSyntheticLambda14()).collect(Collectors.toSet())));
    ...
    private boolean processUpdates(Integer num, Long l, TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        try {
            ...
            while (i2 < bArrCall_pull_outbound_messages.length) {
                try {
                    ...
                    ConnectionsManager.getInstance(this.currentAccount).sendRequest(sendconferencecallbroadcast, new ConferenceCall$$ExternalSyntheticLambda1(this, System.currentTimeMillis(), 1), 64);
                    i2++;
                    i = 1;
                } catch (Exception e) {
                    e = e;
    ...
    public boolean applyUpdate(Integer num, TL_update.TL_updateGroupCallChainBlocks tL_updateGroupCallChainBlocks, boolean z, Long l) {
        ...
        sb2.append(num);
        SQLitePreparedStatement$$ExternalSyntheticOutline0.m(l != null ? " in " + (System.currentTimeMillis() - l.longValue()) + "ms" : "", sb2);
    ...
    public void kick(long j) {
        ...
        while (true) {
            ...
            if (i >= callParticipantArr.length) {
                ...
                ConnectionsManager.getInstance(this.currentAccount).sendRequest(deleteconferencecallparticipants, new ConferenceCall$$ExternalSyntheticLambda1(this, System.currentTimeMillis(), 2));
                return;
            }
    ...
    public void updateParticipants(ArrayList<TLRPC.GroupCallParticipant> arrayList, boolean z) {
        ...
        if (!shadyLeftParticipants.isEmpty()) {
            try {
                ...
                ConnectionsManager.getInstance(this.currentAccount).sendRequest(deleteconferencecallparticipants, new ConferenceCall$$ExternalSyntheticLambda1(this, System.currentTimeMillis(), 0));
            } catch (Exception e) {
                FileLog.e(e);
            }
        }
