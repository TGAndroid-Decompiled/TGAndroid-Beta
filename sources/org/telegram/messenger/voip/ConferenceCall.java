...
public class ConferenceCall {
    ...
    private void checkEmojiHash() {
        ...
        AndroidUtilities.runOnUIThread(new Runnable() {
            @Override
            public final void run() {
                NotificationCenter.getInstance(this.f$0.currentAccount).postNotificationName(NotificationCenter.conferenceEmojiUpdated, new Object[0]);
            }
        });
    }
    ...
    private void checkParticipants() {
        ...
        AndroidUtilities.runOnUIThread(new Runnable() {
            @Override
            public final void run() {
                ConferenceCall.$r8$lambda$y0fb25oZXbAi51DL2N_6og0kEEE(this.f$0);
            }
        });
    }

    public static void $r8$lambda$y0fb25oZXbAi51DL2N_6og0kEEE(ConferenceCall conferenceCall) {
    ...
    public void requestLastBlock(final Runnable runnable) {
        ...
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(getgroupcallchainblocks, new RequestDelegate() {
            ...
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                ConferenceCall.$r8$lambda$8W8yx8VEsf4K5SjkrLZpeEyEak8(this.f$0, jCurrentTimeMillis, runnable, tLObject, tL_error);
            }
        });
    }

    public static void $r8$lambda$8W8yx8VEsf4K5SjkrLZpeEyEak8(final ConferenceCall conferenceCall, final long j, final Runnable runnable, final TLObject tLObject, final TLRPC.TL_error tL_error) {
        conferenceCall.getClass();
        AndroidUtilities.runOnUIThread(new Runnable() {
            @Override
            public final void run() {
                ConferenceCall.$r8$lambda$9tfiVDXcPpvLParNztxZ83Pxag4(this.f$0, j, tLObject, tL_error, runnable);
            }
        });
    }

    public static void $r8$lambda$9tfiVDXcPpvLParNztxZ83Pxag4(ConferenceCall conferenceCall, long j, TLObject tLObject, TLRPC.TL_error tL_error, Runnable runnable) {
    ...
    public static void m1161$r8$lambda$WnB99vM_TB7yxPHV5mMfzIJEA(final ConferenceCall conferenceCall, final long j, final TLObject tLObject, final TLRPC.TL_error tL_error) {
        ...
        AndroidUtilities.runOnUIThread(new Runnable() {
            @Override
            public final void run() {
                this.f$0.processUpdates(null, Long.valueOf(j), tLObject, tL_error);
            }
        });
    }
    ...
    public void poll() {
        ...
        for (int i = 0; i < 2; i++) {
            ...
            this.pollRequestId[i] = ConnectionsManager.getInstance(this.currentAccount).sendRequest(getgroupcallchainblocks, new RequestDelegate() {
                @Override
                public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                    ConferenceCall.$r8$lambda$aj3xAiWbJiD4Dj302argOii4HBk(this.f$0, getgroupcallchainblocks, jCurrentTimeMillis, atomicBoolean, atomicInteger, tLObject, tL_error);
                }
            });
        }
        if (this.call_id >= 0) {
    ...
    public static void $r8$lambda$aj3xAiWbJiD4Dj302argOii4HBk(final ConferenceCall conferenceCall, final TL_phone.getGroupCallChainBlocks getgroupcallchainblocks, final long j, final AtomicBoolean atomicBoolean, final AtomicInteger atomicInteger, final TLObject tLObject, final TLRPC.TL_error tL_error) {
        conferenceCall.getClass();
        AndroidUtilities.runOnUIThread(new Runnable() {
            @Override
            public final void run() {
                ConferenceCall.$r8$lambda$jS1b5h3HViMGqWCFY0jh2fR5MgA(this.f$0, getgroupcallchainblocks, j, tLObject, tL_error, atomicBoolean, atomicInteger);
            }
        });
    }

    public static void $r8$lambda$jS1b5h3HViMGqWCFY0jh2fR5MgA(ConferenceCall conferenceCall, TL_phone.getGroupCallChainBlocks getgroupcallchainblocks, long j, TLObject tLObject, TLRPC.TL_error tL_error, AtomicBoolean atomicBoolean, AtomicInteger atomicInteger) {
        conferenceCall.getClass();
        ...
        while (true) {
            ...
            if (i >= callParticipantArr.length) {
                ...
                ConnectionsManager.getInstance(this.currentAccount).sendRequest(deleteconferencecallparticipants, new RequestDelegate() {
                    @Override
                    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                        ConferenceCall.$r8$lambda$I05kAKknWbjqB_n9TOIvrBq6pYY(this.f$0, jCurrentTimeMillis, tLObject, tL_error);
                    }
                });
                return;
            }
    ...
    public static void $r8$lambda$I05kAKknWbjqB_n9TOIvrBq6pYY(final ConferenceCall conferenceCall, final long j, final TLObject tLObject, final TLRPC.TL_error tL_error) {
        conferenceCall.getClass();
        AndroidUtilities.runOnUIThread(new Runnable() {
            @Override
            public final void run() {
