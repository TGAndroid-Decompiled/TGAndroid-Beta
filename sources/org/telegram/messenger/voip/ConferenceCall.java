...
public class ConferenceCall {
    ...
    public void lambda$checkParticipants$1() {
        ...
        if (this.groupCall != null && (sharedInstance = VoIPService.getSharedInstance()) != null && (call = sharedInstance.groupCall) != null && (groupCall = call.call) != null && groupCall.f18122id == this.groupCall.f18122id) {
            ...
            NotificationCenter.getInstance(this.currentAccount).lambda$postNotificationNameOnUIThread$1(NotificationCenter.groupCallUpdated, 0L, Long.valueOf(this.groupCall.f18122id), Boolean.FALSE);
        }
    }
    ...
    public boolean applyUpdate(Integer num, TL_update.TL_updateGroupCallChainBlocks tL_updateGroupCallChainBlocks, boolean z10, Long l4) {
        ...
        if (this.destroyed) {
            ...
            if (groupCall == null) {
                ...
                return false;
            } else if (tL_updateGroupCallChainBlocks.call.f18129id != groupCall.f18122id) {
                StringBuilder sb2 = new StringBuilder("[tde2e] received updateGroupCallChainBlocks for ");
                sb2.append(tL_updateGroupCallChainBlocks.call.f18129id);
                sb2.append(" but we have ");
                hg.k0.w(sb2, this.groupCall.f18122id);
                return false;
            } else {
