    ...
    private void calcTotalPartsCount() {
        if (this.uploadFirstPartLater) {
            if (this.isBigFile) {
                ...
                this.totalPartsCount = ((int) ((((j10 - i10) + i10) - 1) / i10)) + 1;
                return;
            }
        ...
        this.totalPartsCount = (int) (((j11 + i12) - 1) / i12);
    }
                ...
                if (this.state == 1) {
                    ...
                    if (this.isLastPart && i16 == 0 && this.state == 1) {
                        ...
                        if (this.key == null) {
                            ...
                            tL_inputFile.f20857id = this.currentFileId;
                            ...
                            tL_inputEncryptedFileUploaded.f20856id = this.currentFileId;
