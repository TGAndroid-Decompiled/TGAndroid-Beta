...
public final class jg implements Runnable {
    ...
    public final void run() {
        ...
        TLObject tLObject = this.f16746f;
        Object obj = this.e;
        switch (i10) {
            case 0:
                ((MessagesStorage) obj).lambda$loadPendingTasks$15(this.f16744b, this.d, (TLRPC.InputPeer) tLObject, this.f16745c);
                return;
            default:
