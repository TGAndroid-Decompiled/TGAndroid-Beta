...
public final class MessagesController$$ExternalSyntheticLambda208 implements Runnable {
    public final int $r8$classId;
    public final MessagesController f$0;
    public final TLRPC.Chat f$1;

    public MessagesController$$ExternalSyntheticLambda208(MessagesController messagesController, TLRPC.Chat chat, int i) {
        this.$r8$classId = i;
