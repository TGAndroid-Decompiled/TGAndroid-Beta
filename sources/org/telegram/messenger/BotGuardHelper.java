    ...
    public void closeGuardBotWebApp(long j3, long j10, TLRPC.JoinChatBotResult joinChatBotResult) {
        ...
        if (hashSet != null) {
            ...
            while (it.hasNext()) {
                ...
                ei.f5 f5Var = k3Var.f8448v0;
                if (f5Var != null && f5Var.f8339g == 5) {
                    long j11 = f5Var.f8336b;
                    if (j11 == j3 || j11 == 0) {
                        TLObject tLObject = f5Var.f8348q;
    ...
    private void openGuardBotWebApp(long j3, long j10, long j11, boolean z10) {
        ...
        if (!z10) {
            if (!SharedPrefsHelper.isWebViewConfirmShown(this.currentAccount, j10) && !getMessagesController().whitelistedBots.contains(Long.valueOf(j10))) {
                org.telegram.ui.Components.c5.o(R, user, new l0(this, j3, j10, j11, 0), new u1(6));
                return;
            } else {
                openGuardBotWebApp(j3, j10, j11, true);
                return;
        ...
        k3Var.w(false);
        k3Var.A0 = true;
        k3Var.f8435k0 = LaunchActivity.G1;
        k3Var.s(R2, b10);
        k3Var.show();
    }
