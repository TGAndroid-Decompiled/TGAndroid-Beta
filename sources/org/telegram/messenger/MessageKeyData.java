...
public class MessageKeyData {
    ...
    public static MessageKeyData generateMessageKeyData(byte[] bArr, byte[] bArr2, boolean z, int i) {
        ...
        if (i == 1) {
            ...
            byte[] bArrComputeSHA2 = Utilities.computeSHA1(serializedData2.toByteArray());
            serializedData2.cleanup();
            SerializedData serializedData3 = new SerializedData();
            serializedData3.writeBytes(bArr, i2 + 64, 32);
            serializedData3.writeBytes(bArr2);
            byte[] bArrComputeSHA3 = Utilities.computeSHA1(serializedData3.toByteArray());
            ...
            byte[] bArrComputeSHA4 = Utilities.computeSHA1(serializedData4.toByteArray());
            serializedData4.cleanup();
            SerializedData serializedData5 = new SerializedData();
            serializedData5.writeBytes(bArrComputeSHA1, 0, 8);
            serializedData5.writeBytes(bArrComputeSHA2, 8, 12);
            serializedData5.writeBytes(bArrComputeSHA3, 4, 12);
            ...
            serializedData6.writeBytes(bArrComputeSHA2, 0, 8);
            serializedData6.writeBytes(bArrComputeSHA3, 16, 4);
            serializedData6.writeBytes(bArrComputeSHA4, 0, 8);
            ...
            byte[] bArrComputeSHA257 = Utilities.computeSHA256(serializedData8.toByteArray());
            serializedData8.cleanup();
            SerializedData serializedData9 = new SerializedData();
            serializedData9.writeBytes(bArrComputeSHA256, 0, 8);
            serializedData9.writeBytes(bArrComputeSHA257, 8, 16);
            ...
            serializedData10.writeBytes(bArrComputeSHA257, 0, 8);
            serializedData10.writeBytes(bArrComputeSHA256, 8, 16);
            serializedData10.writeBytes(bArrComputeSHA257, 24, 8);
