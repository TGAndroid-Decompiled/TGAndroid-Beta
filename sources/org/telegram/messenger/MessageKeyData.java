...
public class MessageKeyData {
    ...
    public static MessageKeyData generateMessageKeyData(byte[] bArr, byte[] bArr2, boolean z, int i) throws IOException {
        ...
        if (i == 1) {
            ...
            byte[] bArrComputeSHA1 = Utilities.computeSHA1(serializedData.toByteArray());
            ...
            byte[] bArrComputeSHA12 = Utilities.computeSHA1(serializedData2.toByteArray());
            serializedData2.cleanup();
            SerializedData serializedData3 = new SerializedData();
            serializedData3.writeBytes(bArr, i2 + 64, 32);
            serializedData3.writeBytes(bArr2);
            byte[] bArrComputeSHA13 = Utilities.computeSHA1(serializedData3.toByteArray());
            ...
            byte[] bArrComputeSHA14 = Utilities.computeSHA1(serializedData4.toByteArray());
            serializedData4.cleanup();
            SerializedData serializedData5 = new SerializedData();
            serializedData5.writeBytes(bArrComputeSHA1, 0, 8);
            serializedData5.writeBytes(bArrComputeSHA12, 8, 12);
            serializedData5.writeBytes(bArrComputeSHA13, 4, 12);
            ...
            serializedData6.writeBytes(bArrComputeSHA1, 8, 12);
            serializedData6.writeBytes(bArrComputeSHA12, 0, 8);
            serializedData6.writeBytes(bArrComputeSHA13, 16, 4);
            serializedData6.writeBytes(bArrComputeSHA14, 0, 8);
            ...
            byte[] bArrComputeSHA256 = Utilities.computeSHA256(serializedData7.toByteArray());
            ...
            byte[] bArrComputeSHA2562 = Utilities.computeSHA256(serializedData8.toByteArray());
            serializedData8.cleanup();
            SerializedData serializedData9 = new SerializedData();
            serializedData9.writeBytes(bArrComputeSHA256, 0, 8);
            serializedData9.writeBytes(bArrComputeSHA2562, 8, 16);
            serializedData9.writeBytes(bArrComputeSHA256, 24, 8);
            ...
            serializedData10.writeBytes(bArrComputeSHA2562, 0, 8);
            serializedData10.writeBytes(bArrComputeSHA256, 8, 16);
            serializedData10.writeBytes(bArrComputeSHA2562, 24, 8);
