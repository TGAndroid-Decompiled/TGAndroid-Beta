...
public final class MessagesController$$ExternalSyntheticLambda83 implements Runnable {
    public final int $r8$classId;
    public final MessagesController f$0;
    public final LongSparseArray f$1;

    public MessagesController$$ExternalSyntheticLambda83(MessagesController messagesController, LongSparseArray longSparseArray, int i) {
        this.$r8$classId = i;
