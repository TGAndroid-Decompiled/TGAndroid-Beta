...
public class FeedRemoteViewsFactory implements RemoteViewsService.RemoteViewsFactory, NotificationCenter.NotificationCenterDelegate {
    ...
    public RemoteViews getViewAt(int i) {
        ...
        RemoteViews remoteViews = new RemoteViews(this.mContext.getPackageName(), (int) C0952R.layout.feed_widget_item);
        if (messageObject.type == 0) {
            remoteViews.setTextViewText(C0952R.C0954id.feed_widget_item_text, messageObject.messageText);
            remoteViews.setViewVisibility(C0952R.C0954id.feed_widget_item_text, 0);
        } else if (TextUtils.isEmpty(messageObject.caption)) {
            remoteViews.setViewVisibility(C0952R.C0954id.feed_widget_item_text, 8);
        } else {
            remoteViews.setTextViewText(C0952R.C0954id.feed_widget_item_text, messageObject.caption);
            remoteViews.setViewVisibility(C0952R.C0954id.feed_widget_item_text, 0);
        }
        ArrayList<TLRPC$PhotoSize> arrayList = messageObject.photoThumbs;
        if (arrayList == null || arrayList.isEmpty()) {
            remoteViews.setViewVisibility(C0952R.C0954id.feed_widget_item_image, 8);
        } else {
            ...
            if (pathToAttach.exists()) {
                remoteViews.setViewVisibility(C0952R.C0954id.feed_widget_item_image, 0);
                ...
                remoteViews.setImageViewUri(C0952R.C0954id.feed_widget_item_image, uriForFile);
            } else {
                remoteViews.setViewVisibility(C0952R.C0954id.feed_widget_item_image, 8);
            }
        }
        ...
        remoteViews.setOnClickFillInIntent(C0952R.C0954id.shortcut_widget_item, intent);
        return remoteViews;
    }
