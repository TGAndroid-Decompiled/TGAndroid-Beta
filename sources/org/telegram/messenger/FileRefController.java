...
public class FileRefController extends BaseController {
    ...
    public static String getKeyForParentObject(Object obj) {
        ...
        if (obj instanceof bi.a8) {
            ...
            if (messageMedia.document != null) {
                ...
                return "botstory_" + a8Var.f20133id;
            }
        }
        long j3 = 0;
        if (obj instanceof TL_stories.StoryItem) {
            ...
            return "story_" + storyItem.dialogId + "_" + storyItem.f20133id;
    ...
    private String getObjectString(Object obj) {
        ...
        if (obj instanceof TL_stories.StoryItem) {
            ...
            sb2.append(" id=");
            return a4.a.n(storyItem.f20133id, ")", sb2);
        ...
        if (obj instanceof bi.a8) {
            ...
            getConnectionsManager().sendRequest(tL_stories_getStoriesByID, new RequestDelegate(this) {
                ...
                public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                    switch (r4) {
                        case 0:
                            this.f18481b.lambda$requestReferenceFromServer$11(str, str2, tLObject, tL_error);
                            return;
                        case 1:
                            this.f18481b.lambda$requestReferenceFromServer$12(str, str2, tLObject, tL_error);
                            return;
                        case 2:
                            this.f18481b.lambda$requestReferenceFromServer$13(str, str2, tLObject, tL_error);
                            return;
                        case 3:
                            this.f18481b.lambda$requestReferenceFromServer$14(str, str2, tLObject, tL_error);
                            return;
                        case 4:
                            this.f18481b.lambda$requestReferenceFromServer$15(str, str2, tLObject, tL_error);
                            return;
                        case 5:
                            this.f18481b.lambda$requestReferenceFromServer$16(str, str2, tLObject, tL_error);
                            return;
                        case 6:
                            this.f18481b.lambda$requestReferenceFromServer$17(str, str2, tLObject, tL_error);
                            return;
                        case 7:
                            this.f18481b.lambda$requestReferenceFromServer$2(str, str2, tLObject, tL_error);
                            return;
                        case 8:
                            this.f18481b.lambda$requestReferenceFromServer$22(str, str2, tLObject, tL_error);
                            return;
                        case 9:
                            this.f18481b.lambda$requestReferenceFromServer$23(str, str2, tLObject, tL_error);
                            return;
                        case 10:
                            this.f18481b.lambda$requestReferenceFromServer$24(str, str2, tLObject, tL_error);
                            return;
                        case 11:
                            this.f18481b.lambda$requestReferenceFromServer$25(str, str2, tLObject, tL_error);
                            return;
                        case 12:
                            this.f18481b.lambda$requestReferenceFromServer$26(str, str2, tLObject, tL_error);
                            return;
                        case 13:
                            this.f18481b.lambda$requestReferenceFromServer$27(str, str2, tLObject, tL_error);
                            return;
                        case 14:
                            this.f18481b.lambda$requestReferenceFromServer$28(str, str2, tLObject, tL_error);
                            return;
                        case 15:
                            this.f18481b.lambda$requestReferenceFromServer$29(str, str2, tLObject, tL_error);
                            return;
                        case 16:
                            this.f18481b.lambda$requestReferenceFromServer$3(str, str2, tLObject, tL_error);
                            return;
                        case 17:
                            this.f18481b.lambda$requestReferenceFromServer$4(str, str2, tLObject, tL_error);
                            return;
                        case 18:
                            this.f18481b.lambda$requestReferenceFromServer$5(str, str2, tLObject, tL_error);
                            return;
                        case 19:
                            this.f18481b.lambda$requestReferenceFromServer$6(str, str2, tLObject, tL_error);
                            return;
                        case 20:
                            this.f18481b.lambda$requestReferenceFromServer$7(str, str2, tLObject, tL_error);
                            return;
                        case 21:
                            this.f18481b.lambda$requestReferenceFromServer$8(str, str2, tLObject, tL_error);
                            return;
                        case 22:
                            this.f18481b.lambda$requestReferenceFromServer$9(str, str2, tLObject, tL_error);
                            return;
                        default:
                            this.f18481b.lambda$requestReferenceFromServer$10(str, str2, tLObject, tL_error);
                            return;
                    }
                }
            });
            ...
            if (messageObject.scheduled) {
                ...
                if (message != null && message.rich_message != null && inputPeer != null) {
                    ...
                    getrichmessage.f20116id = messageObject.getRealId();
            ...
            if ("wallpaper".equals(str3)) {
                if (this.wallpaperWaiters.isEmpty()) {
                    getConnectionsManager().sendRequest(new TL_account.getWallPapers(), new RequestDelegate(this) {
                        public final FileRefController f18594b;
                        ...
                        public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                            switch (r2) {
                                case 0:
                                    this.f18594b.lambda$requestReferenceFromServer$18(tLObject, tL_error);
                                    return;
                                case 1:
                                    this.f18594b.lambda$requestReferenceFromServer$19(tLObject, tL_error);
                                    return;
                                case 2:
                                    this.f18594b.lambda$requestReferenceFromServer$20(tLObject, tL_error);
                                    return;
                                default:
                                    this.f18594b.lambda$requestReferenceFromServer$21(tLObject, tL_error);
                                    return;
                            }
                        }
                    });
    ...
    public Pair<TLRPC.InputFileLocation, String> getLocationAndKey(Object obj, Object... objArr) {
        ...
        if (obj2 instanceof bi.a8) {
            ...
            if (messageMedia.document != null) {
                ...
                return new Pair<>(tL_inputDocumentFileLocation2, "botstory_" + a8Var.f20133id);
            }
            ...
            return new Pair<>(tL_inputDocumentFileLocation3, "story_" + tL_storyItem.f20133id);
        } else {
