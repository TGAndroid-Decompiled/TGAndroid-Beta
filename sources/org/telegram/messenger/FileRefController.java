...
public class FileRefController extends BaseController {
    ...
    public static String getKeyForParentObject(Object obj) {
        ...
        if (obj instanceof bi.a8) {
            ...
            if (messageMedia.document != null) {
                ...
                return "botstory_" + a8Var.f20106id;
            }
        }
        long j3 = 0;
        if (obj instanceof TL_stories.StoryItem) {
            ...
            return "story_" + storyItem.dialogId + "_" + storyItem.f20106id;
    ...
    private String getObjectString(Object obj) {
        ...
        if (obj instanceof TL_stories.StoryItem) {
            ...
            sb2.append(" id=");
            return a4.a.n(storyItem.f20106id, ")", sb2);
        ...
        if (obj instanceof bi.a8) {
            ...
            if (messageObject.scheduled) {
                ...
                if (message != null && message.rich_message != null && inputPeer != null) {
                    ...
                    getrichmessage.f20089id = messageObject.getRealId();
    ...
    public Pair<TLRPC.InputFileLocation, String> getLocationAndKey(Object obj, Object... objArr) {
        ...
        if (obj2 instanceof bi.a8) {
            ...
            if (messageMedia.document != null) {
                ...
                return new Pair<>(tL_inputDocumentFileLocation2, "botstory_" + a8Var.f20106id);
            }
            ...
            return new Pair<>(tL_inputDocumentFileLocation3, "story_" + tL_storyItem.f20106id);
        } else {
