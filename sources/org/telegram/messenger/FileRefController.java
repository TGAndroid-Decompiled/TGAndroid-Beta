        ...
        if (obj instanceof TL_stories$StoryItem) {
            ...
            requestDelegate = new RequestDelegate() {
                ...
                public final void run(TLObject tLObject2, TLRPC$TL_error tLRPC$TL_error) {
                    FileRefController.this.lambda$requestReferenceFromServer$2(str, str2, tLObject2, tLRPC$TL_error);
                }
            };
            connectionsManager = connectionsManager2;
            ...
            requestDelegate = new RequestDelegate() {
                @Override
                public final void run(TLObject tLObject2, TLRPC$TL_error tLRPC$TL_error) {
                    FileRefController.this.lambda$requestReferenceFromServer$3(str, str2, tLObject2, tLRPC$TL_error);
                }
            };
            connectionsManager = connectionsManager3;
            tLObject = tLRPC$TL_help_getPremiumPromo;
            ...
            requestDelegate = new RequestDelegate() {
                @Override
                public final void run(TLObject tLObject2, TLRPC$TL_error tLRPC$TL_error) {
                    FileRefController.this.lambda$requestReferenceFromServer$4(str, str2, tLObject2, tLRPC$TL_error);
                }
            };
            connectionsManager = connectionsManager4;
            tLObject = tLRPC$TL_messages_getAvailableReactions;
            ...
            requestDelegate = new RequestDelegate() {
                @Override
                public final void run(TLObject tLObject2, TLRPC$TL_error tLRPC$TL_error) {
                    FileRefController.this.lambda$requestReferenceFromServer$5(str, str2, tLObject2, tLRPC$TL_error);
                }
            };
            connectionsManager = connectionsManager5;
            tLObject = tLRPC$TL_users_getFullUser;
            ...
            requestDelegate = new RequestDelegate() {
                @Override
                public final void run(TLObject tLObject2, TLRPC$TL_error tLRPC$TL_error) {
                    FileRefController.this.lambda$requestReferenceFromServer$6(str, str2, tLObject2, tLRPC$TL_error);
                }
            };
            connectionsManager = connectionsManager6;
            tLObject = tLRPC$TL_messages_getAttachMenuBot;
            ...
            if (messageObject.scheduled) {
                ...
                requestDelegate = new RequestDelegate() {
                    @Override
                    public final void run(TLObject tLObject2, TLRPC$TL_error tLRPC$TL_error) {
                        FileRefController.this.lambda$requestReferenceFromServer$7(str, str2, tLObject2, tLRPC$TL_error);
                    }
                };
                connectionsManager = connectionsManager7;
                tLObject = tLRPC$TL_messages_getScheduledMessages;
                ...
                requestDelegate = new RequestDelegate() {
                    @Override
                    public final void run(TLObject tLObject2, TLRPC$TL_error tLRPC$TL_error) {
                        FileRefController.this.lambda$requestReferenceFromServer$8(str, str2, tLObject2, tLRPC$TL_error);
                    }
                };
                connectionsManager = connectionsManager8;
                tLObject = tLRPC$TL_messages_getQuickReplyMessages;
            } else if (channelId != 0) {
                ...
                requestDelegate = new RequestDelegate() {
                    @Override
                    public final void run(TLObject tLObject2, TLRPC$TL_error tLRPC$TL_error) {
                        FileRefController.this.lambda$requestReferenceFromServer$9(str, str2, tLObject2, tLRPC$TL_error);
                    }
                };
                connectionsManager = connectionsManager9;
                tLObject = tLRPC$TL_channels_getMessages;
            } else {
                ...
                requestDelegate = new RequestDelegate() {
                    @Override
                    public final void run(TLObject tLObject2, TLRPC$TL_error tLRPC$TL_error) {
                        FileRefController.this.lambda$requestReferenceFromServer$10(str, str2, tLObject2, tLRPC$TL_error);
                    }
                };
            ...
            requestDelegate = new RequestDelegate() {
                @Override
                public final void run(TLObject tLObject2, TLRPC$TL_error tLRPC$TL_error) {
                    FileRefController.this.lambda$requestReferenceFromServer$11(str, str2, tLObject2, tLRPC$TL_error);
                }
            };
            connectionsManager = connectionsManager11;
            tLObject = tLRPC$TL_account_getWallPaper;
            ...
            requestDelegate = new RequestDelegate() {
                @Override
                public final void run(TLObject tLObject2, TLRPC$TL_error tLRPC$TL_error) {
                    FileRefController.this.lambda$requestReferenceFromServer$12(str, str2, tLObject2, tLRPC$TL_error);
                }
            };
            connectionsManager = connectionsManager12;
            tLObject = tLRPC$TL_account_getTheme;
            ...
            requestDelegate = new RequestDelegate() {
                @Override
                public final void run(TLObject tLObject2, TLRPC$TL_error tLRPC$TL_error) {
                    FileRefController.this.lambda$requestReferenceFromServer$13(str, str2, tLObject2, tLRPC$TL_error);
                }
            };
            connectionsManager = connectionsManager13;
            tLObject = tLRPC$TL_messages_getWebPage;
            ...
            requestDelegate = new RequestDelegate() {
                @Override
                public final void run(TLObject tLObject2, TLRPC$TL_error tLRPC$TL_error) {
                    FileRefController.this.lambda$requestReferenceFromServer$14(str, str2, tLObject2, tLRPC$TL_error);
                }
            };
            connectionsManager = connectionsManager14;
            tLObject = tLRPC$TL_users_getUsers;
            ...
            if (tLRPC$Chat instanceof TLRPC$TL_chat) {
                ...
                requestDelegate = new RequestDelegate() {
                    @Override
                    public final void run(TLObject tLObject2, TLRPC$TL_error tLRPC$TL_error) {
                        FileRefController.this.lambda$requestReferenceFromServer$15(str, str2, tLObject2, tLRPC$TL_error);
                    }
                };
                ...
                requestDelegate = new RequestDelegate() {
                    @Override
                    public final void run(TLObject tLObject2, TLRPC$TL_error tLRPC$TL_error) {
                        FileRefController.this.lambda$requestReferenceFromServer$16(str, str2, tLObject2, tLRPC$TL_error);
                    }
                };
                connectionsManager = connectionsManager16;
                tLObject = tLRPC$TL_channels_getChannels;
            }
        } else {
            if (obj instanceof String) {
                ...
                if ("wallpaper".equals(str3)) {
                    if (this.wallpaperWaiters.isEmpty()) {
                        getConnectionsManager().sendRequest(new TLRPC$TL_account_getWallPapers(), new RequestDelegate() {
                            @Override
                            public final void run(TLObject tLObject2, TLRPC$TL_error tLRPC$TL_error) {
                                FileRefController.this.lambda$requestReferenceFromServer$17(tLObject2, tLRPC$TL_error);
                            }
                        });
                    }
                    ...
                    if (this.savedGifsWaiters.isEmpty()) {
                        getConnectionsManager().sendRequest(new TLRPC$TL_messages_getSavedGifs(), new RequestDelegate() {
                            @Override
                            public final void run(TLObject tLObject2, TLRPC$TL_error tLRPC$TL_error) {
                                FileRefController.this.lambda$requestReferenceFromServer$18(tLObject2, tLRPC$TL_error);
                            }
                        });
                    }
                    ...
                    if (this.recentStickersWaiter.isEmpty()) {
                        getConnectionsManager().sendRequest(new TLRPC$TL_messages_getRecentStickers(), new RequestDelegate() {
                            @Override
                            public final void run(TLObject tLObject2, TLRPC$TL_error tLRPC$TL_error) {
                                FileRefController.this.lambda$requestReferenceFromServer$19(tLObject2, tLRPC$TL_error);
                            }
                        });
                    }
                    ...
                    if (this.favStickersWaiter.isEmpty()) {
                        getConnectionsManager().sendRequest(new TLRPC$TL_messages_getFavedStickers(), new RequestDelegate() {
                            @Override
                            public final void run(TLObject tLObject2, TLRPC$TL_error tLRPC$TL_error) {
                                FileRefController.this.lambda$requestReferenceFromServer$20(tLObject2, tLRPC$TL_error);
                            }
                        });
                    }
                    ...
                    requestDelegate = new RequestDelegate() {
                        @Override
                        public final void run(TLObject tLObject2, TLRPC$TL_error tLRPC$TL_error) {
                            FileRefController.this.lambda$requestReferenceFromServer$21(str, str2, tLObject2, tLRPC$TL_error);
                        }
                    };
                    connectionsManager = connectionsManager17;
                    tLObject = tLRPC$TL_help_getAppUpdate;
                } else {
                            ...
                            if (split.length >= 3) {
                                ...
                                if (longValue != 0) {
                                    ...
                                    requestDelegate = new RequestDelegate() {
                                        @Override
                                        public final void run(TLObject tLObject2, TLRPC$TL_error tLRPC$TL_error) {
                                            FileRefController.this.lambda$requestReferenceFromServer$24(str, str2, tLObject2, tLRPC$TL_error);
                                        }
                                    };
                                    tLObject = tLRPC$TL_channels_getMessages2;
                                    ...
                                    requestDelegate = new RequestDelegate() {
                                        @Override
                                        public final void run(TLObject tLObject2, TLRPC$TL_error tLRPC$TL_error) {
                                            FileRefController.this.lambda$requestReferenceFromServer$25(str, str2, tLObject2, tLRPC$TL_error);
                                        }
                                    };
                                    tLObject = tLRPC$TL_messages_getMessages2;
                    ...
                    if (longValue2 > 0) {
                        ...
                        requestDelegate = new RequestDelegate() {
                            @Override
                            public final void run(TLObject tLObject2, TLRPC$TL_error tLRPC$TL_error) {
                                FileRefController.this.lambda$requestReferenceFromServer$22(str, str2, tLObject2, tLRPC$TL_error);
                            }
                        };
                        connectionsManager = connectionsManager20;
                        tLObject = tLRPC$TL_photos_getUserPhotos;
                    } else {
                        ...
                        requestDelegate = new RequestDelegate() {
                            @Override
                            public final void run(TLObject tLObject2, TLRPC$TL_error tLRPC$TL_error) {
                                FileRefController.this.lambda$requestReferenceFromServer$23(str, str2, tLObject2, tLRPC$TL_error);
                            }
                        };
                        connectionsManager = connectionsManager21;
                        tLObject = tLRPC$TL_messages_search;
                    }
                }
            ...
            if (obj instanceof TLRPC$TL_messages_stickerSet) {
                ...
                requestDelegate = new RequestDelegate() {
                    @Override
                    public final void run(TLObject tLObject2, TLRPC$TL_error tLRPC$TL_error) {
                        FileRefController.this.lambda$requestReferenceFromServer$26(str, str2, tLObject2, tLRPC$TL_error);
                    }
                };
                connectionsManager = connectionsManager22;
                tLObject = tLRPC$TL_messages_getStickerSet;
            } else {
                if (!(obj instanceof TLRPC$StickerSetCovered)) {
                    if (obj instanceof TLRPC$InputStickerSet) {
                        ...
                        requestDelegate = new RequestDelegate() {
                            @Override
                            public final void run(TLObject tLObject2, TLRPC$TL_error tLRPC$TL_error) {
                                FileRefController.this.lambda$requestReferenceFromServer$28(str, str2, tLObject2, tLRPC$TL_error);
                            }
                        };
                        connectionsManager = connectionsManager23;
                        tLObject = tLRPC$TL_messages_getStickerSet2;
                    }
                    sendErrorToObject(objArr, 0);
                    return;
                }
                ...
                requestDelegate = new RequestDelegate() {
                    @Override
                    public final void run(TLObject tLObject2, TLRPC$TL_error tLRPC$TL_error) {
                        FileRefController.this.lambda$requestReferenceFromServer$27(str, str2, tLObject2, tLRPC$TL_error);
                    }
                };
                connectionsManager = connectionsManager24;
                tLObject = tLRPC$TL_messages_getStickerSet3;
            }
        }
