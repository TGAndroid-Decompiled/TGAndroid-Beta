...
public class FileRefController extends BaseController {
    ...
    private byte[] getFileReference(TLRPC.Document document, ArrayList<TLRPC.Document> arrayList, TLRPC.InputFileLocation inputFileLocation, boolean[] zArr, TLRPC.InputFileLocation[] inputFileLocationArr) {
        if (document != null && inputFileLocation != null) {
            ...
            if (inputFileLocation instanceof TLRPC.TL_inputDocumentFileLocation) {
                if (document.f19875id == inputFileLocation.f19884id) {
                ...
                for (int i11 = 0; i11 < size; i11++) {
                    ...
                    if (zArr != null && zArr[0]) {
                        ...
                        tL_inputDocumentFileLocation.f19884id = document.f19875id;
    ...
    public static String getKeyForParentObject(Object obj) {
        ...
        if (obj instanceof bi.a8) {
            ...
            if (a8Var.f2772a == null) {
                FileLog.d("failed request reference can't find list in botpreview");
                return null;
            }
            TLRPC.MessageMedia messageMedia = a8Var.media;
            if (messageMedia.document != null) {
                return "botstory_doc_" + a8Var.media.document.f19875id;
            } else if (messageMedia.photo != null) {
                return "botstory_photo_" + a8Var.media.photo.f19893id;
            } else {
                return "botstory_" + a8Var.f20107id;
            }
        }
        long j3 = 0;
        if (obj instanceof TL_stories.StoryItem) {
            ...
            return "story_" + storyItem.dialogId + "_" + storyItem.f20107id;
            ...
            if (obj instanceof TLRPC.TL_availableReaction) {
                ...
                if (obj instanceof MessageObject) {
                    ...
                    return "message" + message2.f19890id + "_" + j3 + "_" + message2.from_scheduled;
                } else if (obj instanceof TLRPC.WebPage) {
                    return "webpage" + ((TLRPC.WebPage) obj).f20022id;
                } else if (obj instanceof TLRPC.User) {
                    return "user" + ((TLRPC.User) obj).f20016id;
                } else if (obj instanceof TLRPC.Chat) {
                    return "chat" + ((TLRPC.Chat) obj).f19869id;
                } else if (obj instanceof String) {
                    return "str".concat((String) obj);
                } else {
                    if (obj instanceof TLRPC.TL_messages_stickerSet) {
                        return "set" + ((TLRPC.TL_messages_stickerSet) obj).set.f19896id;
                    } else if (obj instanceof TLRPC.StickerSetCovered) {
                        return "set" + ((TLRPC.StickerSetCovered) obj).set.f19896id;
                    } else if (obj instanceof TLRPC.InputStickerSet) {
                        return "set" + ((TLRPC.InputStickerSet) obj).f19889id;
                    } else if (obj instanceof TLRPC.TL_wallPaper) {
                        return "wallpaper" + ((TLRPC.TL_wallPaper) obj).f20021id;
                    } else if (obj instanceof TLRPC.TL_theme) {
                        return "theme" + ((TLRPC.TL_theme) obj).f20006id;
                    } else if (obj == null) {
                        return null;
                    } else {
                        return "" + obj;
    ...
    private String getObjectString(Object obj) {
        ...
        if (obj instanceof TL_stories.StoryItem) {
            ...
            sb2.append(" id=");
            return a4.a.n(storyItem.f20107id, ")", sb2);
    ...
    private boolean getPeerReferenceReplacement(TLRPC.User user, TLRPC.Chat chat, boolean z10, TLRPC.InputFileLocation inputFileLocation, TLRPC.InputFileLocation[] inputFileLocationArr, boolean[] zArr) {
        ...
        tL_inputPeerPhotoFileLocation.f19884id = j3;
        ...
        if (user != null) {
            if (user.access_hash == 0 && user.fromMessageId != 0 && user.fromMessageDialogId != 0) {
                ...
                inputPeer.user_id = user.f20016id;
    ...
    public static void lambda$onRequestComplete$46(TLRPC.TL_theme tL_theme) {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            ...
            if (tL_theme2 != null && tL_theme2.f20006id == tL_theme.f20006id) {
    ...
    private void requestReferenceFromServer(Object obj, final String str, final String str2, Object[] objArr) {
        if (obj instanceof bi.a8) {
            ...
            getConnectionsManager().sendRequest(tL_stories_getStoriesByID, new RequestDelegate(this) {
                public final FileRefController f18437b;
                ...
                public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                    switch (r4) {
                        case 0:
                            this.f18437b.lambda$requestReferenceFromServer$11(str, str2, tLObject, tL_error);
                            return;
                        case 1:
                            this.f18437b.lambda$requestReferenceFromServer$12(str, str2, tLObject, tL_error);
                            return;
                        case 2:
                            this.f18437b.lambda$requestReferenceFromServer$13(str, str2, tLObject, tL_error);
                            return;
                        case 3:
                            this.f18437b.lambda$requestReferenceFromServer$14(str, str2, tLObject, tL_error);
                            return;
                        case 4:
                            this.f18437b.lambda$requestReferenceFromServer$15(str, str2, tLObject, tL_error);
                            return;
                        case 5:
                            this.f18437b.lambda$requestReferenceFromServer$16(str, str2, tLObject, tL_error);
                            return;
                        case 6:
                            this.f18437b.lambda$requestReferenceFromServer$17(str, str2, tLObject, tL_error);
                            return;
                        case 7:
                            this.f18437b.lambda$requestReferenceFromServer$2(str, str2, tLObject, tL_error);
                            return;
                        case 8:
                            this.f18437b.lambda$requestReferenceFromServer$22(str, str2, tLObject, tL_error);
                            return;
                        case 9:
                            this.f18437b.lambda$requestReferenceFromServer$23(str, str2, tLObject, tL_error);
                            return;
                        case 10:
                            this.f18437b.lambda$requestReferenceFromServer$24(str, str2, tLObject, tL_error);
                            return;
                        case 11:
                            this.f18437b.lambda$requestReferenceFromServer$25(str, str2, tLObject, tL_error);
                            return;
                        case 12:
                            this.f18437b.lambda$requestReferenceFromServer$26(str, str2, tLObject, tL_error);
                            return;
                        case 13:
                            this.f18437b.lambda$requestReferenceFromServer$27(str, str2, tLObject, tL_error);
                            return;
                        case 14:
                            this.f18437b.lambda$requestReferenceFromServer$28(str, str2, tLObject, tL_error);
                            return;
                        case 15:
                            this.f18437b.lambda$requestReferenceFromServer$29(str, str2, tLObject, tL_error);
                            return;
                        case 16:
                            this.f18437b.lambda$requestReferenceFromServer$3(str, str2, tLObject, tL_error);
                            return;
                        case 17:
                            this.f18437b.lambda$requestReferenceFromServer$4(str, str2, tLObject, tL_error);
                            return;
                        case 18:
                            this.f18437b.lambda$requestReferenceFromServer$5(str, str2, tLObject, tL_error);
                            return;
                        case 19:
                            this.f18437b.lambda$requestReferenceFromServer$6(str, str2, tLObject, tL_error);
                            return;
                        case 20:
                            this.f18437b.lambda$requestReferenceFromServer$7(str, str2, tLObject, tL_error);
                            return;
                        case 21:
                            this.f18437b.lambda$requestReferenceFromServer$8(str, str2, tLObject, tL_error);
                            return;
                        case 22:
                            this.f18437b.lambda$requestReferenceFromServer$9(str, str2, tLObject, tL_error);
                            return;
                        default:
                            this.f18437b.lambda$requestReferenceFromServer$10(str, str2, tLObject, tL_error);
                            return;
                    }
                }
            });
            ...
            tL_users_getFullUser.f20009id = getMessagesController().getInputUser(((TL_bots.BotInfo) obj).user_id);
            ...
            if (messageObject.scheduled) {
                ...
                tL_messages_getScheduledMessages.f19969id.add(Integer.valueOf(messageObject.getRealId()));
                ...
                tL_messages_getQuickReplyMessages.f19968id.add(Integer.valueOf(messageObject.getRealId()));
                ...
                if (message != null && message.rich_message != null && inputPeer != null) {
                    ...
                    getrichmessage.f20090id = messageObject.getRealId();
                    ...
                    tL_channels_getMessages.f19907id.add(Integer.valueOf(messageObject.getRealId()));
                    ...
                    tL_messages_getMessages.f19963id.add(Integer.valueOf(messageObject.getRealId()));
            ...
            tL_inputWallPaper.f19941id = tL_wallPaper.f20021id;
            ...
            tL_users_getUsers.f20010id.add(getMessagesController().getInputUser((TLRPC.User) obj));
            ...
            if (chat instanceof TLRPC.TL_chat) {
                ...
                tL_messages_getChats.f19957id.add(Long.valueOf(chat.f19869id));
                ...
                tL_channels_getChannels.f19905id.add(MessagesController.getInputChannel(chat));
            ...
            if ("wallpaper".equals(str3)) {
                if (this.wallpaperWaiters.isEmpty()) {
                    getConnectionsManager().sendRequest(new TL_account.getWallPapers(), new RequestDelegate(this) {
                        public final FileRefController f18532b;
                        ...
                        public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                            switch (r2) {
                                case 0:
                                    this.f18532b.lambda$requestReferenceFromServer$18(tLObject, tL_error);
                                    return;
                                case 1:
                                    this.f18532b.lambda$requestReferenceFromServer$19(tLObject, tL_error);
                                    return;
                                case 2:
                                    this.f18532b.lambda$requestReferenceFromServer$20(tLObject, tL_error);
                                    return;
                                default:
                                    this.f18532b.lambda$requestReferenceFromServer$21(tLObject, tL_error);
                                    return;
                            }
                        }
                    });
                ...
                if (split.length >= 3) {
                    ...
                    if (longValue2 != 0) {
                        ...
                        tL_channels_getMessages2.f19907id.add(Utilities.parseInt((CharSequence) split[2]));
                    ...
                    tL_messages_getMessages2.f19963id.add(Utilities.parseInt((CharSequence) split[2]));
        ...
        if (obj instanceof TL_stories.TL_storyItem) {
            ...
            if (obj instanceof TLRPC.TL_messages_sendMedia) {
                ...
                if (inputMedia instanceof TLRPC.TL_inputMediaDocument) {
                    ...
                    if (isSameReference(tL_inputMediaDocument.f19930id.file_reference, bArr)) {
                        return false;
                    }
                    tL_inputMediaDocument.f19930id.file_reference = bArr;
                    ...
                    if (isSameReference(tL_inputMediaPhoto.f19932id.file_reference, bArr)) {
                        return false;
                    }
                    tL_inputMediaPhoto.f19932id.file_reference = bArr;
                }
                ...
                if (inputMedia2 instanceof TLRPC.TL_inputMediaDocument) {
                    ...
                    if (isSameReference(tL_inputMediaDocument2.f19930id.file_reference, bArr)) {
                        return false;
                    }
                    tL_inputMediaDocument2.f19930id.file_reference = bArr;
                    ...
                    if (isSameReference(tL_inputMediaPhoto2.f19932id.file_reference, bArr)) {
                        return false;
                    }
                    tL_inputMediaPhoto2.f19932id.file_reference = bArr;
                }
                ...
                if (inputMedia3 instanceof TLRPC.TL_inputMediaDocument) {
                    ...
                    if (isSameReference(tL_inputMediaDocument3.f19930id.file_reference, bArr)) {
                        return false;
                    }
                    tL_inputMediaDocument3.f19930id.file_reference = bArr;
                    ...
                    if (isSameReference(tL_inputMediaPhoto3.f19932id.file_reference, bArr)) {
                        return false;
                    }
                    tL_inputMediaPhoto3.f19932id.file_reference = bArr;
                }
                ...
                if (inputMedia4 instanceof TLRPC.TL_inputMediaDocument) {
                    ...
                    if (isSameReference(tL_inputMediaDocument4.f19930id.file_reference, bArr)) {
                        return false;
                    }
                    tL_inputMediaDocument4.f19930id.file_reference = bArr;
                    ...
                    if (isSameReference(tL_inputMediaPhoto4.f19932id.file_reference, bArr)) {
                        return false;
                    }
                    tL_inputMediaPhoto4.f19932id.file_reference = bArr;
                }
                ...
                if (isSameReference(tL_messages_saveGif.f19976id.file_reference, bArr)) {
                    return false;
                }
                tL_messages_saveGif.f19976id.file_reference = bArr;
                ...
                if (isSameReference(tL_messages_saveRecentSticker.f19977id.file_reference, bArr)) {
                    return false;
                }
                tL_messages_saveRecentSticker.f19977id.file_reference = bArr;
                ...
                if (isSameReference(tL_messages_faveSticker.f19953id.file_reference, bArr)) {
                    return false;
                }
                tL_messages_faveSticker.f19953id.file_reference = bArr;
                ...
                if (inputStickeredMedia instanceof TLRPC.TL_inputStickeredMediaDocument) {
                    ...
                    if (isSameReference(tL_inputStickeredMediaDocument.f19938id.file_reference, bArr)) {
                        return false;
                    }
                    tL_inputStickeredMediaDocument.f19938id.file_reference = bArr;
                    ...
                    if (isSameReference(tL_inputStickeredMediaPhoto.f19939id.file_reference, bArr)) {
                        return false;
                    }
                    tL_inputStickeredMediaPhoto.f19939id.file_reference = bArr;
                }
            } else {
    ...
    public Pair<TLRPC.InputFileLocation, String> getLocationAndKey(Object obj, Object... objArr) {
        ...
        if (obj2 instanceof bi.a8) {
            ...
            if (messageMedia.document != null) {
                TLRPC.TL_inputDocumentFileLocation tL_inputDocumentFileLocation = new TLRPC.TL_inputDocumentFileLocation();
                tL_inputDocumentFileLocation.f19884id = a8Var.media.document.f19875id;
                return new Pair<>(tL_inputDocumentFileLocation, "botstory_doc_" + a8Var.media.document.f19875id);
            } else if (messageMedia.photo != null) {
                TLRPC.TL_inputPhotoFileLocation tL_inputPhotoFileLocation = new TLRPC.TL_inputPhotoFileLocation();
                tL_inputPhotoFileLocation.f19884id = a8Var.media.photo.f19893id;
                return new Pair<>(tL_inputPhotoFileLocation, "botstory_photo_" + a8Var.media.photo.f19893id);
            } else {
                TLRPC.TL_inputDocumentFileLocation tL_inputDocumentFileLocation2 = new TLRPC.TL_inputDocumentFileLocation();
                return new Pair<>(tL_inputDocumentFileLocation2, "botstory_" + a8Var.f20107id);
            }
            ...
            tL_inputDocumentFileLocation3.f19884id = tL_storyItem.media.document.f19875id;
            return new Pair<>(tL_inputDocumentFileLocation3, "story_" + tL_storyItem.f20107id);
        } else {
            if (obj2 instanceof TLRPC.TL_inputSingleMedia) {
                ...
                if (inputMedia instanceof TLRPC.TL_inputMediaDocument) {
                    ...
                    tL_inputDocumentFileLocation4.f19884id = tL_inputMediaDocument.f19930id.f19881id;
                    return new Pair<>(tL_inputDocumentFileLocation4, "file_" + tL_inputMediaDocument.f19930id.f19881id);
                } else if (inputMedia instanceof TLRPC.TL_inputMediaPhoto) {
                    TLRPC.TL_inputMediaPhoto tL_inputMediaPhoto = (TLRPC.TL_inputMediaPhoto) inputMedia;
                    TLRPC.TL_inputPhotoFileLocation tL_inputPhotoFileLocation2 = new TLRPC.TL_inputPhotoFileLocation();
                    tL_inputPhotoFileLocation2.f19884id = tL_inputMediaPhoto.f19932id.f19888id;
                    return new Pair<>(tL_inputPhotoFileLocation2, "photo_" + tL_inputMediaPhoto.f19932id.f19888id);
                }
                ...
                tL_inputDocumentFileLocation5.f19884id = tL_inputMediaDocument2.f19930id.f19881id;
                return new Pair<>(tL_inputDocumentFileLocation5, "file_" + tL_inputMediaDocument2.f19930id.f19881id);
                ...
                tL_inputPhotoFileLocation3.f19884id = tL_inputMediaPhoto2.f19932id.f19888id;
                return new Pair<>(tL_inputPhotoFileLocation3, "photo_" + tL_inputMediaPhoto2.f19932id.f19888id);
                ...
                if (inputMedia2 instanceof TLRPC.TL_inputMediaDocument) {
                    ...
                    tL_inputDocumentFileLocation6.f19884id = tL_inputMediaDocument3.f19930id.f19881id;
                    return new Pair<>(tL_inputDocumentFileLocation6, "file_" + tL_inputMediaDocument3.f19930id.f19881id);
                } else if (inputMedia2 instanceof TLRPC.TL_inputMediaPhoto) {
                    ...
                    tL_inputPhotoFileLocation4.f19884id = tL_inputMediaPhoto3.f19932id.f19888id;
                    return new Pair<>(tL_inputPhotoFileLocation4, "photo_" + tL_inputMediaPhoto3.f19932id.f19888id);
                    ...
                    if (!(obj instanceof ArrayList) && tL_inputMediaPaidMedia.extended_media.size() == 1) {
                        ...
                        if (inputMedia3 instanceof TLRPC.TL_inputMediaDocument) {
                            ...
                            tL_inputDocumentFileLocation7.f19884id = tL_inputMediaDocument4.f19930id.f19881id;
                            return new Pair<>(tL_inputDocumentFileLocation7, "file_" + tL_inputMediaDocument4.f19930id.f19881id);
                        } else if (inputMedia3 instanceof TLRPC.TL_inputMediaPhoto) {
                            ...
                            tL_inputPhotoFileLocation5.f19884id = tL_inputMediaPhoto4.f19932id.f19888id;
                            return new Pair<>(tL_inputPhotoFileLocation5, "photo_" + tL_inputMediaPhoto4.f19932id.f19888id);
                        }
                    }
                }
                ...
                if (inputMedia4 instanceof TLRPC.TL_inputMediaDocument) {
                    ...
                    tL_inputDocumentFileLocation8.f19884id = tL_inputMediaDocument5.f19930id.f19881id;
                    return new Pair<>(tL_inputDocumentFileLocation8, "file_" + tL_inputMediaDocument5.f19930id.f19881id);
                } else if (inputMedia4 instanceof TLRPC.TL_inputMediaPhoto) {
                    ...
                    tL_inputPhotoFileLocation6.f19884id = tL_inputMediaPhoto5.f19932id.f19888id;
                    return new Pair<>(tL_inputPhotoFileLocation6, "photo_" + tL_inputMediaPhoto5.f19932id.f19888id);
                    ...
                    if (!(obj instanceof ArrayList) && tL_inputMediaPaidMedia2.extended_media.size() == 1) {
                        ...
                        if (inputMedia5 instanceof TLRPC.TL_inputMediaDocument) {
                            ...
                            tL_inputDocumentFileLocation9.f19884id = tL_inputMediaDocument6.f19930id.f19881id;
                            return new Pair<>(tL_inputDocumentFileLocation9, "file_" + tL_inputMediaDocument6.f19930id.f19881id);
                            ...
                            tL_inputPhotoFileLocation7.f19884id = tL_inputMediaPhoto6.f19932id.f19888id;
                            return new Pair<>(tL_inputPhotoFileLocation7, "photo_" + tL_inputMediaPhoto6.f19932id.f19888id);
                        }
                    }
                }
                ...
                if (inputMedia6 instanceof TLRPC.TL_inputMediaDocument) {
                    ...
                    tL_inputDocumentFileLocation10.f19884id = tL_inputMediaDocument7.f19930id.f19881id;
                    return new Pair<>(tL_inputDocumentFileLocation10, "file_" + tL_inputMediaDocument7.f19930id.f19881id);
                    ...
                    tL_inputPhotoFileLocation8.f19884id = tL_inputMediaPhoto7.f19932id.f19888id;
                    return new Pair<>(tL_inputPhotoFileLocation8, "photo_" + tL_inputMediaPhoto7.f19932id.f19888id);
                }
                ...
                tL_inputPhotoFileLocation9.f19884id = inputPhoto.f19888id;
                return new Pair<>(tL_inputPhotoFileLocation9, "photo_" + inputPhoto.f19888id);
                ...
                tL_inputDocumentFileLocation11.f19884id = inputDocument.f19881id;
                return new Pair<>(tL_inputDocumentFileLocation11, "file_" + inputDocument.f19881id);
                ...
                if (inputMedia7 instanceof TLRPC.TL_inputMediaDocument) {
                    ...
                    tL_inputDocumentFileLocation12.f19884id = tL_inputMediaDocument8.f19930id.f19881id;
                    return new Pair<>(tL_inputDocumentFileLocation12, "file_" + tL_inputMediaDocument8.f19930id.f19881id);
                    ...
                    tL_inputPhotoFileLocation10.f19884id = tL_inputMediaPhoto8.f19932id.f19888id;
                    return new Pair<>(tL_inputPhotoFileLocation10, "photo_" + tL_inputMediaPhoto8.f19932id.f19888id);
                }
                ...
                tL_inputDocumentFileLocation13.f19884id = tL_messages_saveGif.f19976id.f19881id;
                return new Pair<>(tL_inputDocumentFileLocation13, "file_" + tL_messages_saveGif.f19976id.f19881id);
                ...
                tL_inputDocumentFileLocation14.f19884id = tL_messages_saveRecentSticker.f19977id.f19881id;
                return new Pair<>(tL_inputDocumentFileLocation14, "file_" + tL_messages_saveRecentSticker.f19977id.f19881id);
                ...
                tL_inputDocumentFileLocation15.f19884id = tL_stickers_addStickerToSet.sticker.document.f19881id;
                return new Pair<>(tL_inputDocumentFileLocation15, "file_" + tL_stickers_addStickerToSet.sticker.document.f19881id);
                ...
                tL_inputDocumentFileLocation16.f19884id = tL_messages_faveSticker.f19953id.f19881id;
                return new Pair<>(tL_inputDocumentFileLocation16, "file_" + tL_messages_faveSticker.f19953id.f19881id);
                ...
                if (inputStickeredMedia instanceof TLRPC.TL_inputStickeredMediaDocument) {
                    ...
                    tL_inputDocumentFileLocation17.f19884id = tL_inputStickeredMediaDocument.f19938id.f19881id;
                    return new Pair<>(tL_inputDocumentFileLocation17, "file_" + tL_inputStickeredMediaDocument.f19938id.f19881id);
                } else if (inputStickeredMedia instanceof TLRPC.TL_inputStickeredMediaPhoto) {
                    TLRPC.TL_inputStickeredMediaPhoto tL_inputStickeredMediaPhoto = (TLRPC.TL_inputStickeredMediaPhoto) inputStickeredMedia;
                    TLRPC.TL_inputPhotoFileLocation tL_inputPhotoFileLocation11 = new TLRPC.TL_inputPhotoFileLocation();
                    tL_inputPhotoFileLocation11.f19884id = tL_inputStickeredMediaPhoto.f19939id.f19888id;
                    return new Pair<>(tL_inputPhotoFileLocation11, "photo_" + tL_inputStickeredMediaPhoto.f19939id.f19888id);
                }
                ...
                return new Pair<>(tL_inputDocumentFileLocation18, "file_" + tL_inputDocumentFileLocation18.f19884id);
                ...
                return new Pair<>(tL_inputPhotoFileLocation12, "photo_" + tL_inputPhotoFileLocation12.f19884id);
                ...
                return new Pair<>(tL_inputPeerPhotoFileLocation, "avatar_" + tL_inputPeerPhotoFileLocation.f19884id);
            }
            return null;
        }
    }
    ...
    private byte[] getFileReference(TLRPC.Photo photo, TLRPC.InputFileLocation inputFileLocation, boolean[] zArr, TLRPC.InputFileLocation[] inputFileLocationArr) {
        ...
        if (inputFileLocation instanceof TLRPC.TL_inputPhotoFileLocation) {
            if (photo.f19893id == inputFileLocation.f19884id) {
        ...
        if (inputFileLocation instanceof TLRPC.TL_inputFileLocation) {
            ...
            for (int i10 = 0; i10 < size; i10++) {
                ...
                if (zArr != null && zArr[0]) {
                    ...
                    tL_inputPhotoFileLocation.f19884id = photo.f19893id;
