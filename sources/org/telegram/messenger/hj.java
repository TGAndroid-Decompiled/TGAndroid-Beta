...
public final class hj implements Runnable {
    ...
    public hj(int i10, ci.d dVar, TLObject tLObject, TL_stars.StarsSubscription starsSubscription, boolean z10, boolean z11, org.telegram.ui.ActionBar.f3[] f3VarArr) {
        this.e = dVar;
        this.f16347f = f3VarArr;
        this.f16345b = i10;
        this.f16346c = z10;
        this.h = starsSubscription;
        this.d = z11;
        this.f16348n = tLObject;
    }
    ...
    public final void run() {
        ...
        Object obj = this.f16348n;
        Object obj2 = this.h;
        Object obj3 = this.f16347f;
        Object obj4 = this.e;
        switch (i10) {
            case 0:
                ((SendMessagesHelper) obj4).lambda$performSendMessageRequest$95(this.f16346c, (TLRPC.Message) obj3, (ArrayList) obj2, this.d, (ArrayList) obj, this.f16345b);
                return;
            default:
                ...
                yh.v5.y(this.f16345b, false).S();
                org.telegram.ui.ActionBar.n2 U = LaunchActivity.U();
                if (U != null) {
                    if (this.f16346c && !TextUtils.isEmpty(starsSubscription.title)) {
