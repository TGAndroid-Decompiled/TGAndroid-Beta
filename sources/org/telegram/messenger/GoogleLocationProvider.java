...
public class GoogleLocationProvider implements ILocationServiceProvider {
    ...
    public static final class GoogleLocationRequest implements ILocationServiceProvider.ILocationRequest {
        ...
        public void setInterval(long j3) {
            ...
            long j10 = locationRequest.f7080c;
            long j11 = locationRequest.f7079b;
            if (j10 == j11 / 6) {
                locationRequest.f7080c = j3 / 6;
            }
            if (locationRequest.f7083r == j11) {
                locationRequest.f7083r = j3;
            }
            locationRequest.f7079b = j3;
        }
    ...
    public void init(Context context) {
        com.google.android.gms.common.api.e eVar = g8.d.f9507a;
        com.google.android.gms.common.api.i iVar = com.google.android.gms.common.api.i.f6029c;
        com.google.android.gms.common.api.e eVar2 = r7.c.f42062k;
        com.google.android.gms.common.api.a aVar = com.google.android.gms.common.api.b.f6020t;
    ...
    public ILocationServiceProvider.IMapApiClient onCreateLocationServicesAPI(Context context, final ILocationServiceProvider.IAPIConnectionCallbacks iAPIConnectionCallbacks, final ILocationServiceProvider.IAPIOnConnectionFailedListener iAPIOnConnectionFailedListener) {
        ...
        n8.a aVar = n8.a.f15185a;
        com.google.android.gms.common.api.e eVar2 = n8.b.f15187b;
        if (lVar2.containsKey(eVar2)) {
            aVar = (n8.a) lVar2.get(eVar2);
        }
        m.q3 q3Var = new m.q3(hashSet, lVar, packageName, name, aVar);
        Map map = (Map) q3Var.f14290c;
        ...
        while (true) {
            ...
            if (bVar.hasNext()) {
                ...
                a0.l lVar7 = lVar3;
                a0.l lVar8 = lVar5;
                com.google.android.gms.common.api.c a2 = dVar3.a(context2, looper, q3Var2, obj2, p1Var, p1Var);
                lVar6.put(eVar4.f6022b, a2);
                if (a2.a()) {
                    if (eVar3 == null) {
                        mainLooper = looper;
                        q3Var = q3Var2;
                        ...
                        throw new IllegalStateException(a4.a.C(eVar4.f6023c, " cannot be used with ", eVar3.f6023c));
                    }
                } else {
                    mainLooper = looper;
                    q3Var = q3Var2;
                ...
                com.google.android.gms.common.api.internal.j0 j0Var = new com.google.android.gms.common.api.internal.j0(context2, new ReentrantLock(), looper2, q3Var3, fVar, arrayList, arrayList2, fVar2, com.google.android.gms.common.api.internal.j0.f(fVar2.values(), true), arrayList5);
                Set set = com.google.android.gms.common.api.m.f6211a;
                synchronized (set) {
                    set.add(j0Var);
                }
    ...
    public void removeLocationUpdates(final ILocationServiceProvider.ILocationListener iLocationListener) {
        ...
        g8.c cVar = new g8.c() {
            ...
            public void onLocationResult(LocationResult locationResult) {
                ...
                List list = locationResult.f7089a;
                int size = list.size();
                if (size == 0) {
                    location = null;
                } else {
        ...
        cVar2.c(new com.google.android.gms.common.api.internal.n(cVar, simpleName), 2418).continueWith(r7.b.f42061a, r7.a.f42059b);
    }
