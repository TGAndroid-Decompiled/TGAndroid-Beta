...
public class GoogleLocationProvider implements ILocationServiceProvider {
    ...
    public static final class GoogleLocationRequest implements ILocationServiceProvider.ILocationRequest {
        ...
        public void setInterval(long j10) {
            ...
            long j11 = locationRequest.f3808c;
            long j12 = locationRequest.f3807b;
            if (j11 == j12 / 6) {
                locationRequest.f3808c = j10 / 6;
            }
            if (locationRequest.f3812r == j12) {
                locationRequest.f3812r = j10;
            }
            locationRequest.f3807b = j10;
        }
    ...
    public void checkLocationSettings(ILocationServiceProvider.ILocationRequest iLocationRequest, q0.a aVar) {
        ...
        e6.f2824c = new androidx.biometric.f0(eVar, 12);
        e6.f2822a = 2426;
    ...
    public ILocationServiceProvider.IMapApiClient onCreateLocationServicesAPI(Context context, final ILocationServiceProvider.IAPIConnectionCallbacks iAPIConnectionCallbacks, final ILocationServiceProvider.IAPIOnConnectionFailedListener iAPIOnConnectionFailedListener) {
        ...
        b8.a aVar = b8.a.f1891a;
        com.google.android.gms.common.api.e eVar2 = b8.b.f1893b;
        ...
        while (true) {
            ...
            if (bVar.hasNext()) {
                ...
                a0.k kVar7 = kVar3;
                a0.k kVar8 = kVar5;
                com.google.android.gms.common.api.c a2 = jVar3.a(context2, looper, r3Var2, obj2, q1Var, q1Var);
                kVar6.put(eVar4.f2651b, a2);
                if (a2.a()) {
                    if (eVar3 == null) {
                        mainLooper = looper;
                        r3Var = r3Var2;
                        ...
                        throw new IllegalStateException(android.support.v4.media.a.z(eVar4.f2652c, " cannot be used with ", eVar3.f2652c));
                    }
                } else {
                    mainLooper = looper;
                    r3Var = r3Var2;
                ...
                Set set = com.google.android.gms.common.api.m.f2860a;
                synchronized (set) {
                    set.add(j0Var);
                }
    ...
    public void removeLocationUpdates(final ILocationServiceProvider.ILocationListener iLocationListener) {
        ...
        u7.c cVar = new u7.c() {
            ...
            public void onLocationResult(LocationResult locationResult) {
                ...
                List list = locationResult.f3818a;
                int size = list.size();
                if (size == 0) {
                    location = null;
                } else {
        ...
        dVar.c(new com.google.android.gms.common.api.internal.n(cVar, simpleName), 2418).continueWith(f7.c.f6122a, f7.a.f6117b);
    }
