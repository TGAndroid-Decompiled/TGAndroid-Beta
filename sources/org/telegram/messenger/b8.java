...
public final class b8 implements Runnable {
    ...
    public final void run() {
        ...
        gj0 gj0Var;
        float f10;
        int i13 = this.f16827a;
        boolean z4 = this.f16828b;
        int i14 = this.d;
        int i15 = this.f16829c;
        Window window = null;
        Object obj = this.h;
        Object obj2 = this.f16830f;
        Object obj3 = this.e;
        switch (i13) {
            case 0:
                ((MediaDataController) obj3).lambda$toggleStickerSets$118(this.f16829c, (TLObject) obj2, (org.telegram.ui.ActionBar.p2) obj, this.f16828b, this.d);
                return;
            case 1:
                ((SendMessagesHelper) obj3).lambda$performSendMessageRequest$99(this.f16828b, (TLRPC.Message) obj2, this.f16829c, (ArrayList) obj, this.d);
                return;
            case 2:
                ArrayList arrayList = (ArrayList) obj2;
                ArrayList arrayList2 = (ArrayList) obj;
                xn xnVar = ((org.telegram.ui.kl) obj3).f35765b;
                if (z4) {
            ...
            case 3:
                ...
                if (bitmap != null && !bitmap.isRecycled()) {
                    ...
                    AndroidUtilities.runOnUIThread(new gg.j(gaVar, str, createBitmap, this.f16828b, bitmap, 12));
                    return;
                }
                return;
            default:
                ...
                cv cvVar = bvVar.f33036c;
                cvVar.b();
                org.telegram.ui.Cells.o8 o8Var = cvVar.e;
                cvVar.d();
                int w02 = org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20140q6, false);
                gj0 gj0Var2 = cvVar.d;
                ...
                ofFloat.start();
                int w03 = org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19852a7, false);
                ...
                if (window != null) {
                    ...
                    gj0Var = gj0Var2;
                    ofFloat2.addUpdateListener(new av(bvVar, f10, i20, w03, activity));
                    cvVar.h.addListener(new org.telegram.ui.v0(activity, w03, 2));
    ...
    public b8(bv bvVar, int i10, Context context, int i11, boolean z4, org.telegram.ui.ActionBar.p2 p2Var) {
        this.e = bvVar;
        this.f16829c = i10;
