...
public class PasskeysController {
    ...
    public class AnonymousClass1 implements v0.i {
        ...
        public static void lambda$onResult$0(org.telegram.ui.ActionBar.d2 d2Var, Utilities.Callback3 callback3, long j3, TLRPC.auth_Authorization auth_authorization, TLRPC.TL_error tL_error) {
            d2Var.dismiss();
            if (tL_error != null) {
        ...
        public void onResult(v0.o oVar) {
            ...
            try {
                JSONObject jSONObject = new JSONObject(((Bundle) gVar.f1693a).getString("androidx.credentials.BUNDLE_KEY_AUTHENTICATION_RESPONSE_JSON"));
                finishpasskeylogin.credential.f17407id = jSONObject.getString("id");
                ...
                final int sendRequestTyped = ConnectionsManager.getInstance(this.val$currentAccount).sendRequestTyped(finishpasskeylogin, new Object(), new xh(d2Var, this.val$done, parseLong, 0), parseInt, 72);
    ...
    public static void create(Context context, int i10, Utilities.Callback2<TL_account.Passkey, String> callback2) {
        ...
        d2Var.q(500L);
        ConnectionsManager.getInstance(i10).sendRequestTyped(new TL_account.initPasskeyRegistration(), new Object(), new sh(d2Var, callback2, sVar, context, i10));
    }

    public static <T> id.c ktxCallback(Utilities.Callback2<T, Throwable> callback2) {
        return ktxCallback(id.i.f10565a, callback2);
    }
    ...
    public static void lambda$create$6(Context context, final int i10, TL_account.registerPasskey registerpasskey, final Utilities.Callback2 callback2) {
        org.telegram.ui.ActionBar.d2 d2Var = new org.telegram.ui.ActionBar.d2(context, 3, null);
        d2Var.q(500L);
        final int sendRequestTyped = ConnectionsManager.getInstance(i10).sendRequestTyped(registerpasskey, new Object(), new f1(3, d2Var, callback2));
        d2Var.setOnCancelListener(new DialogInterface.OnCancelListener() {
            @Override
            public final void onCancel(DialogInterface dialogInterface) {
    ...
    public static void lambda$create$7(final Utilities.Callback2 callback2, Context context, int i10, v0.c cVar, Throwable th2) {
        if (!(th2 instanceof w0.b) && !(th2 instanceof w0.e)) {
            if (th2 instanceof w0.f) {
                ...
                try {
                    JSONObject jSONObject = new JSONObject(cVar.f42832a.getString("androidx.credentials.BUNDLE_KEY_REGISTRATION_RESPONSE_JSON"));
                    ...
                    inputpasskeycredentialpublickey.f17407id = jSONObject.getString("id");
    ...
    public static Runnable login(final Context context, final int i10, final boolean z10, final Utilities.Callback3<Long, TLRPC.auth_Authorization, String> callback3) {
        ...
        final Runnable[] runnableArr = {new th(i10, ConnectionsManager.getInstance(i10).sendRequestTyped(initpasskeylogin, new Object(), new Utilities.Callback2() {
            @Override
        ...
        return new id.c() {
            ...
            public void resumeWith(Object obj) {
                if (obj instanceof gd.e) {
                    callback2.run(null, ((gd.e) obj).f8742a);
                } else {
