...
public class PasskeysController {
    ...
    public class AnonymousClass1 implements v0.i {
        ...
        public void onResult(v0.o oVar) {
            ...
            try {
                JSONObject jSONObject = new JSONObject(((Bundle) gVar.f3000a).getString("androidx.credentials.BUNDLE_KEY_AUTHENTICATION_RESPONSE_JSON"));
                finishpasskeylogin.credential.f18503id = jSONObject.getString("id");
                ...
                final int sendRequestTyped = ConnectionsManager.getInstance(this.val$currentAccount).sendRequestTyped(finishpasskeylogin, new Object(), new ph(b2Var, this.val$done, parseLong, 0), parseInt, 72);
    ...
    public static void create(Context context, int i10, Utilities.Callback2<TL_account.Passkey, String> callback2) {
        ...
        b2Var.q(500L);
        ConnectionsManager.getInstance(i10).sendRequestTyped(new TL_account.initPasskeyRegistration(), new Object(), new kh(b2Var, callback2, bVar, context, i10));
    }

    public static <T> id.c ktxCallback(Utilities.Callback2<T, Throwable> callback2) {
        return ktxCallback(id.i.f11084a, callback2);
    }
    ...
    public static void lambda$create$6(Context context, final int i10, TL_account.registerPasskey registerpasskey, final Utilities.Callback2 callback2) {
        org.telegram.ui.ActionBar.b2 b2Var = new org.telegram.ui.ActionBar.b2(context, 3, null);
        b2Var.q(500L);
        final int sendRequestTyped = ConnectionsManager.getInstance(i10).sendRequestTyped(registerpasskey, new Object(), new d1(3, b2Var, callback2));
        b2Var.setOnCancelListener(new DialogInterface.OnCancelListener() {
            @Override
            public final void onCancel(DialogInterface dialogInterface) {
    ...
    public static void lambda$create$7(final Utilities.Callback2 callback2, Context context, int i10, v0.c cVar, Throwable th2) {
        if (!(th2 instanceof w0.b) && !(th2 instanceof w0.e)) {
            if (th2 instanceof w0.f) {
                ...
                try {
                    JSONObject jSONObject = new JSONObject(cVar.f44066a.getString("androidx.credentials.BUNDLE_KEY_REGISTRATION_RESPONSE_JSON"));
                    ...
                    inputpasskeycredentialpublickey.f18503id = jSONObject.getString("id");
        ...
        try {
            ...
            try {
                ...
                if (c10 == null) {
                    ...
                    c10.onGetCredential(context, nVar, cancellationSignal, executor, anonymousClass1);
                }
    ...
    public static Runnable login(final Context context, final int i10, final boolean z10, final Utilities.Callback3<Long, TLRPC.auth_Authorization, String> callback3) {
        ...
        final Runnable[] runnableArr = {new lh(i10, ConnectionsManager.getInstance(i10).sendRequestTyped(initpasskeylogin, new Object(), new Utilities.Callback2() {
            @Override
        ...
        return new id.c() {
            ...
            public void resumeWith(Object obj) {
                if (obj instanceof gd.e) {
                    callback2.run(null, ((gd.e) obj).f9614a);
                } else {
