            ...
            if (!canvas.quickReject(bounds.left, bounds.top, bounds.right, bounds.bottom, Canvas.EdgeType.AA)) {
                if (this.newLeft != null) {
                    if (this.leftUpdateT == null) {
                        this.leftUpdateT = new org.telegram.ui.Components.e6(0.0f, new f1(this, 16), 0L, 320L, rr.f28032g);
                    }
                ...
                if (this.newRight != null) {
                    if (this.rightUpdateT == null) {
                        this.rightUpdateT = new org.telegram.ui.Components.e6(0.0f, new f1(this, 16), 0L, 320L, rr.f28032g);
                    }
