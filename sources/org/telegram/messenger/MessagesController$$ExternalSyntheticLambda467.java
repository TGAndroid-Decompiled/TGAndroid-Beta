...
public final class MessagesController$$ExternalSyntheticLambda467 implements Runnable {
    public final int $r8$classId;
    public final MessagesController f$0;
    public final TLRPC.Dialog f$1;

    public MessagesController$$ExternalSyntheticLambda467(MessagesController messagesController, TLRPC.Dialog dialog, int i) {
        this.$r8$classId = i;
