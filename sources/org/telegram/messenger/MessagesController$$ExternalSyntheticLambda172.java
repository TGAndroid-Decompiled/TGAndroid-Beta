...
public final class MessagesController$$ExternalSyntheticLambda172 implements Runnable {
    public final int $r8$classId;
    public final MessagesController f$0;
    public final EphemeralMessagesHelper.EphemeralUpdates.StructBuilder f$1;

    public MessagesController$$ExternalSyntheticLambda172(MessagesController messagesController, EphemeralMessagesHelper.EphemeralUpdates.StructBuilder structBuilder, int i) {
        this.$r8$classId = i;
