...
public class MediaDataController extends BaseController {
    ...
    public class AnonymousClass2 implements Runnable {
        ...
        public void run() {
            for (int i10 = 0; i10 < this.val$previewItems.size(); i10++) {
                if (this.val$previewItems.get(i10) != null && ((kp) this.val$previewItems.get(i10)).f27909a != null) {
                    ((kp) this.val$previewItems.get(i10)).f27909a.n(0);
                }
            }
    ...
    public class AnonymousClass3 implements Runnable {
        ...
        public void run() {
            for (int i10 = 0; i10 < this.val$previewItems.size(); i10++) {
                ((kp) this.val$previewItems.get(i10)).f27909a.n(this.val$currentAccount);
            }
    ...
    private static CharacterStyle createNewSpan(CharacterStyle characterStyle, n01 n01Var, n01 n01Var2, boolean z10) {
        ...
        if (n01Var2 != null) {
            if (z10) {
                ...
                n01Var3.f28618a = n01Var2.f28618a;
                n01Var3.d = n01Var2.d;
            }
        }
        ...
        for (int i12 = 0; i12 < size; i12++) {
            ...
            if (messageEntity != null && messageEntity.length > 0 && (i11 = messageEntity.offset) >= 0 && i11 < charSequence.length()) {
                ...
                if (!(messageEntity instanceof TLRPC.TL_messageEntityCustomEmoji)) {
                    ...
                    int i13 = messageEntity.offset;
                    obj.f28619b = i13;
                    obj.f28620c = i13 + messageEntity.length;
                    ...
                    while (i14 < size2) {
                        ...
                        int i15 = obj.f28619b;
                        int i16 = n01Var.f28619b;
                        if (i15 > i16) {
                            int i17 = n01Var.f28620c;
                            if (i15 < i17) {
                                if (obj.f28620c < i17) {
                                    ...
                                    n01Var4.b(n01Var);
                                    n01Var4.f28620c = n01Var.f28620c;
                                    i14++;
                                    size2++;
                                    arrayList2.add(i14, n01Var4);
                                }
                                int i18 = obj.f28619b;
                                obj.f28619b = n01Var.f28620c;
                                n01Var.f28620c = i18;
                            }
                        } else {
                            int i19 = obj.f28620c;
                            if (i16 < i19) {
                                int i20 = n01Var.f28620c;
                                if (i19 == i20) {
                                    n01Var.b(obj);
                                } else if (i19 < i20) {
                                    n01 n01Var5 = new n01(n01Var);
                                    n01Var5.b(obj);
                                    n01Var5.f28620c = obj.f28620c;
                                    i14++;
                                    size2++;
                                    arrayList2.add(i14, n01Var5);
                                    n01Var.f28619b = obj.f28620c;
                                } else {
                                    n01 n01Var6 = new n01(obj);
                                    n01Var6.f28619b = n01Var.f28620c;
                                    i14++;
                                    size2++;
    ...
    public void lambda$getStickerSet$34(TLRPC.InputStickerSet inputStickerSet, Integer num, String str, Utilities.Callback callback, boolean z10) {
        AndroidUtilities.runOnUIThread(new p8(this, getCachedStickerSetInternal(inputStickerSet.f19916id, num), str, callback, z10, inputStickerSet, 0));
    }
            ...
            if (message2 == null) {
                if (j10 != 0) {
                    ...
                    getConnectionsManager().sendRequest(tL_channels_getMessages, new RequestDelegate(this) {
                        public final MediaDataController f18799b;
                        ...
                        public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                            switch (r6) {
                                case 0:
                                    this.f18799b.lambda$saveDraft$189(j11, j12, tLObject, tL_error);
                                    return;
                                default:
                                    this.f18799b.lambda$saveDraft$190(j11, j12, tLObject, tL_error);
                                    return;
                            }
                        }
                    });
    ...
    public static void lambda$setPlaceholderImage$31(String str, org.telegram.ui.Components.x9 x9Var, String str2, TLRPC.TL_messages_stickerSet tL_messages_stickerSet) {
        ...
        if (tL_messages_stickerSet != null) {
            ...
            if (document != null) {
                x9Var.n(ImageLocation.getForDocument(document), str2, DocumentObject.getSvgThumb(document, org.telegram.ui.ActionBar.j6.f20854m6, 0.2f, 1.0f, null), document);
                x9Var.invalidate();
            }
        }
    }
    ...
    private static boolean suggestedPostEquals(TLRPC.SuggestedPost suggestedPost, TLRPC.SuggestedPost suggestedPost2) {
        ...
        if (suggestedPost != suggestedPost2) {
            ...
            if (z10 == z11) {
                ...
                if (l4 != l10 && ((l4 == null || l10 == null || l4.f51653a != l10.f51653a || l4.f51654b != l10.f51654b) && suggestedPost.schedule_date == suggestedPost2.schedule_date && suggestedPost.accepted == suggestedPost2.accepted && suggestedPost.rejected == suggestedPost2.rejected)) {
                }
            }
            return false;
        }
    ...
    public void loadHints(boolean z10) {
        if (!this.loading && getUserConfig().suggestContacts) {
            ...
            getConnectionsManager().sendRequestTyped(tL_contacts_getTopPeers, new Object(), new me(this, 4));
        }
    }
        ...
        if (!this.loadingRecentReactions) {
            if (!this.loadedRecentReactions || z10) {
                ...
                ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_getRecentReactions, new RequestDelegate(this) {
                    public final MediaDataController f17489b;
                    ...
                    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                        switch (r4) {
                            case 0:
                                this.f17489b.lambda$loadRecentAndTopReactions$236(sharedPreferences, zArr, tLObject, tL_error);
                                return;
                            default:
                                this.f17489b.lambda$loadRecentAndTopReactions$238(sharedPreferences, zArr, tLObject, tL_error);
                                return;
                        }
                    }
                });
                ...
                ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_getTopReactions, new RequestDelegate(this) {
                    ...
                    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                        switch (r4) {
                            case 0:
                                this.f17489b.lambda$loadRecentAndTopReactions$236(sharedPreferences2, zArr, tLObject, tL_error);
                                return;
                            default:
                                this.f17489b.lambda$loadRecentAndTopReactions$238(sharedPreferences2, zArr, tLObject, tL_error);
                                return;
                        }
                    }
                });
    ...
    public void onRingtoneUploaded(String str, TLRPC.Document document, boolean z10) {
        ...
        ArrayList arrayList = cVar.f47061e;
        boolean z11 = true;
        if (z10) {
            int i10 = 0;
            while (true) {
                if (i10 < arrayList.size()) {
                    if (((uf.b) arrayList.get(i10)).d && str.equals(((uf.b) arrayList.get(i10)).f47054b)) {
                        arrayList.remove(i10);
                        break;
                    }
                    i10++;
            ...
            while (true) {
                if (i11 < arrayList.size()) {
                    if (((uf.b) arrayList.get(i11)).d && str.equals(((uf.b) arrayList.get(i11)).f47054b)) {
                        ((uf.b) arrayList.get(i11)).d = false;
                        ((uf.b) arrayList.get(i11)).f47053a = document;
                        break;
                    }
                    i11++;
                } else {
    ...
    public void processStickerSetInstallResultArchive(org.telegram.ui.ActionBar.n2 n2Var, boolean z10, int i10, TLRPC.TL_messages_stickerSetInstallResultArchive tL_messages_stickerSetInstallResultArchive) {
        ...
        if (n2Var != null && n2Var.getParentActivity() != null) {
            ...
            alertDialog$Builder.f32391c = new ArrayList(arrayList);
            alertDialog$Builder.f32392e = n2Var2;
    ...
    public void removeMultipleStickerSets(Context context, org.telegram.ui.ActionBar.n2 n2Var, ArrayList<TLRPC.TL_messages_stickerSet> arrayList) {
        ...
        if (arrayList != null && !arrayList.isEmpty() && (tL_messages_stickerSet = (TLRPC.TL_messages_stickerSet) i2.g.h(1, arrayList)) != null) {
            ...
            ocVar.f29056a = new fi.l3(this, zArr, arrayList, i15, iArr, 7);
            ocVar.f29057b = new bi.ia(this, zArr, arrayList, context, n2Var, i15);
            ...
            if (charSequence5 instanceof Spanned) {
                ...
                if (o01VarArr != null && o01VarArr.length > 0) {
                    for (o01 o01Var : o01VarArr) {
                        ...
                        if (!checkInclusion(spanStart, arrayList, false) && !checkInclusion(spanEnd, arrayList, true) && !checkIntersection(spanStart, spanEnd, arrayList)) {
                            ...
                            addStyle(o01Var.f28939b.f28618a, spanStart, spanEnd, arrayList);
                        }
                    }
                }
                ...
                if (n51VarArr != null && n51VarArr.length > 0) {
                    ...
                    for (int i22 = 0; i22 < n51VarArr.length; i22++) {
                        ...
                        n01 n01Var = n51VarArr[i22].f28651a;
                        if (n01Var != null) {
                            int i23 = n01Var.f28618a;
                    ...
                    for (si0 si0Var : si0VarArr) {
                        if (si0Var != null) {
                            try {
                                ...
                                tL_messageEntityBlockquote.collapsed = si0Var.f30338e;
                    ...
                    for (h10 h10Var : h10VarArr) {
                        if (h10Var != null) {
                            try {
                                ...
                                TLRPC.TL_messageEntityFormattedDate tL_messageEntityFormattedDate2 = h10Var.f26586b;
    ...
    public void saveDraft(long j3, long j10, CharSequence charSequence, ArrayList<TLRPC.MessageEntity> arrayList, TLRPC.Message message, sn snVar, TLRPC.SuggestedPost suggestedPost, long j11, boolean z10, boolean z11, TL_iv.RichMessage richMessage) {
        ...
        if (message2 != null) {
            ...
            if (snVar != null) {
                ...
                ArrayList<TLRPC.MessageEntity> arrayList2 = snVar.f40511j;
                ...
                MessageObject messageObject = snVar.f40504a;
                if (messageObject != null && messageObject.messageOwner != null) {
                    TLRPC.Peer peer = getMessagesController().getPeer(j3);
                    TLRPC.Peer peer2 = snVar.f40504a.messageOwner.peer_id;
    ...
    public static void addTextStyleRuns(ArrayList<TLRPC.MessageEntity> arrayList, CharSequence charSequence, Spannable spannable, int i10) {
        ...
        for (int i11 = 0; i11 < Math.min(1000, textStyleRuns.size()); i11++) {
            ...
            addStyleToText(new o01(n01Var, 0), n01Var.f28619b, n01Var.f28620c, spannable, true);
        }
    }
            ...
            if (callback != null || !this.loadingStickerSetsKeys.contains(inputSetKey)) {
                ...
                if (z12) {
                    getMessagesStorage().getStorageQueue().postRunnable(new Runnable(this) {
                        public final MediaDataController f19719b;
                        ...
                        public final void run() {
                            switch (r7) {
                                case 0:
                                    this.f19719b.lambda$getStickerSet$34(inputStickerSet, num, inputSetKey, callback, z10);
                                    return;
                                default:
                                    this.f19719b.lambda$getStickerSet$37(inputStickerSet, num, inputSetKey, callback, z10);
                                    return;
                            }
                        }
                    });
