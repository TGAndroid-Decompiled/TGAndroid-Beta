...
public class MediaDataController extends BaseController {
                        ...
                        if (!DialogObject.isEncryptedDialog(anonymousClass14.val$uid)) {
                            ...
                            if (p0Var != null) {
                                if (!TextUtils.isEmpty(p0Var.f49155f)) {
                                    j11 = anonymousClass14.val$tag.f49155f.hashCode();
                                } else {
                                    j11 = anonymousClass14.val$tag.f49156g;
                                }
    ...
    public class AnonymousClass2 implements Runnable {
        ...
        public void run() {
            for (int i10 = 0; i10 < this.val$previewItems.size(); i10++) {
                if (this.val$previewItems.get(i10) != null && ((lp) this.val$previewItems.get(i10)).f25957a != null) {
                    ((lp) this.val$previewItems.get(i10)).f25957a.n(0);
                }
            }
    ...
    public class AnonymousClass3 implements Runnable {
        ...
        public void run() {
            for (int i10 = 0; i10 < this.val$previewItems.size(); i10++) {
                ((lp) this.val$previewItems.get(i10)).f25957a.n(this.val$currentAccount);
            }
    ...
    private static CharacterStyle createNewSpan(CharacterStyle characterStyle, p01 p01Var, p01 p01Var2, boolean z10) {
        ...
        if (p01Var2 != null) {
            if (z10) {
                ...
                p01Var3.f26908a = p01Var2.f26908a;
                p01Var3.d = p01Var2.d;
            }
        }
        ...
        for (int i12 = 0; i12 < size; i12++) {
            ...
            if (messageEntity != null && messageEntity.length > 0 && (i11 = messageEntity.offset) >= 0 && i11 < charSequence.length()) {
                ...
                if (!(messageEntity instanceof TLRPC.TL_messageEntityCustomEmoji)) {
                    ...
                    int i13 = messageEntity.offset;
                    obj.f26909b = i13;
                    obj.f26910c = i13 + messageEntity.length;
                    ...
                    while (i14 < size2) {
                        ...
                        int i15 = obj.f26909b;
                        int i16 = p01Var.f26909b;
                        if (i15 > i16) {
                            int i17 = p01Var.f26910c;
                            if (i15 < i17) {
                                if (obj.f26910c < i17) {
                                    ...
                                    p01Var4.b(p01Var);
                                    p01Var4.f26910c = p01Var.f26910c;
                                    i14++;
                                    size2++;
                                    arrayList2.add(i14, p01Var4);
                                }
                                int i18 = obj.f26909b;
                                obj.f26909b = p01Var.f26910c;
                                p01Var.f26910c = i18;
                            }
                        } else {
                            int i19 = obj.f26910c;
                            if (i16 < i19) {
                                int i20 = p01Var.f26910c;
                                if (i19 == i20) {
                                    p01Var.b(obj);
                                } else if (i19 < i20) {
                                    p01 p01Var5 = new p01(p01Var);
                                    p01Var5.b(obj);
                                    p01Var5.f26910c = obj.f26910c;
                                    i14++;
                                    size2++;
                                    arrayList2.add(i14, p01Var5);
                                    p01Var.f26909b = obj.f26910c;
                                } else {
                                    p01 p01Var6 = new p01(obj);
                                    p01Var6.f26909b = p01Var.f26910c;
                                    i14++;
                                    size2++;
    ...
    public static void lambda$setPlaceholderImage$31(String str, org.telegram.ui.Components.u9 u9Var, String str2, TLRPC.TL_messages_stickerSet tL_messages_stickerSet) {
        ...
        if (tL_messages_stickerSet != null) {
            ...
            if (document != null) {
                u9Var.n(ImageLocation.getForDocument(document), str2, DocumentObject.getSvgThumb(document, org.telegram.ui.ActionBar.j6.f19028m6, 0.2f, 1.0f, null), document);
                u9Var.invalidate();
            }
        }
    }
    ...
    private static boolean suggestedPostEquals(TLRPC.SuggestedPost suggestedPost, TLRPC.SuggestedPost suggestedPost2) {
        ...
        if (suggestedPost != suggestedPost2) {
            ...
            if (z10 == z11) {
                ...
                if (l4 != l10 && ((l4 == null || l10 == null || l4.f48980a != l10.f48980a || l4.f48981b != l10.f48981b) && suggestedPost.schedule_date == suggestedPost2.schedule_date && suggestedPost.accepted == suggestedPost2.accepted && suggestedPost.rejected == suggestedPost2.rejected)) {
                }
            }
            return false;
        }
    ...
    public void onRingtoneUploaded(String str, TLRPC.Document document, boolean z10) {
        ...
        if (z10) {
            ...
            while (true) {
                if (i10 < arrayList.size()) {
                    if (((uf.b) arrayList.get(i10)).d && str.equals(((uf.b) arrayList.get(i10)).f43719b)) {
                        arrayList.remove(i10);
                        break;
                    }
                    i10++;
            ...
            while (true) {
                if (i11 < arrayList.size()) {
                    if (((uf.b) arrayList.get(i11)).d && str.equals(((uf.b) arrayList.get(i11)).f43719b)) {
                        ((uf.b) arrayList.get(i11)).d = false;
                        ((uf.b) arrayList.get(i11)).f43718a = document;
                        break;
                    }
                    i11++;
                } else {
        ...
        if (z11) {
            NotificationCenter.getInstance(cVar.f43725c).lambda$postNotificationNameOnUIThread$1(NotificationCenter.onUserRingtonesUpdated, new Object[0]);
        }
    }
    ...
    public void processStickerSetInstallResultArchive(org.telegram.ui.ActionBar.o2 o2Var, boolean z10, int i10, TLRPC.TL_messages_stickerSetInstallResultArchive tL_messages_stickerSetInstallResultArchive) {
        ...
        if (o2Var != null && o2Var.getParentActivity() != null) {
            ...
            alertDialog$Builder.f30355c = new ArrayList(arrayList);
    ...
    public void removeMultipleStickerSets(Context context, org.telegram.ui.ActionBar.o2 o2Var, ArrayList<TLRPC.TL_messages_stickerSet> arrayList) {
        ...
        if (arrayList != null && !arrayList.isEmpty() && (tL_messages_stickerSet = (TLRPC.TL_messages_stickerSet) hg.k0.h(1, arrayList)) != null) {
            ...
            mcVar.f26125a = new ei.l3(this, zArr, arrayList, i15, iArr, 7);
            mcVar.f26126b = new ai.cb(this, zArr, arrayList, context, o2Var, i15);
            ...
            if (charSequence5 instanceof Spanned) {
                ...
                if (q01VarArr != null && q01VarArr.length > 0) {
                    for (q01 q01Var : q01VarArr) {
                        ...
                        if (!checkInclusion(spanStart, arrayList, false) && !checkInclusion(spanEnd, arrayList, true) && !checkIntersection(spanStart, spanEnd, arrayList)) {
                            ...
                            addStyle(q01Var.f27188b.f26908a, spanStart, spanEnd, arrayList);
                        }
                    }
                }
                ...
                if (p51VarArr != null && p51VarArr.length > 0) {
                    ...
                    for (int i22 = 0; i22 < p51VarArr.length; i22++) {
                        ...
                        p01 p01Var = p51VarArr[i22].f26936a;
                        if (p01Var != null) {
                            int i23 = p01Var.f26908a;
                    ...
                    for (h10 h10Var : h10VarArr) {
                        if (h10Var != null) {
                            try {
                                ...
                                TLRPC.TL_messageEntityFormattedDate tL_messageEntityFormattedDate2 = h10Var.f24460b;
    ...
    public void saveDraft(long j3, long j10, CharSequence charSequence, ArrayList<TLRPC.MessageEntity> arrayList, TLRPC.Message message, rn rnVar, TLRPC.SuggestedPost suggestedPost, long j11, boolean z10, boolean z11, TL_iv.RichMessage richMessage) {
        ...
        if (message2 != null) {
            ...
            if (rnVar != null) {
                ...
                ArrayList<TLRPC.MessageEntity> arrayList2 = rnVar.f37282j;
                ...
                MessageObject messageObject = rnVar.f37276a;
                if (messageObject != null && messageObject.messageOwner != null) {
                    TLRPC.Peer peer = getMessagesController().getPeer(j3);
                    TLRPC.Peer peer2 = rnVar.f37276a.messageOwner.peer_id;
    ...
    public static void addTextStyleRuns(ArrayList<TLRPC.MessageEntity> arrayList, CharSequence charSequence, Spannable spannable, int i10) {
        ...
        for (int i11 = 0; i11 < Math.min(1000, textStyleRuns.size()); i11++) {
            ...
            addStyleToText(new q01(p01Var, 0), p01Var.f26909b, p01Var.f26910c, spannable, true);
        }
    }
