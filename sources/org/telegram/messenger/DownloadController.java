...
public class DownloadController extends BaseController implements NotificationCenter.NotificationCenterDelegate {
    ...
    private void checkDownloadFinished(String str, int i10) {
        ...
        if (downloadObject != null) {
            ...
            this.downloadQueuePairs.remove(new Pair(Long.valueOf(downloadObject.f17096id), Integer.valueOf(downloadObject.type)));
            if (i10 == 0 || i10 == 2) {
                getMessagesStorage().removeFromDownloadQueue(downloadObject.f17096id, downloadObject.type, false);
            }
    ...
    public static float getProgress(long[] jArr) {
        if (jArr != null && jArr.length >= 2) {
            long j3 = jArr[1];
            if (j3 != 0) {
                return Math.min(1.0f, ((float) jArr[0]) / ((float) j3));
            }
            return 0.0f;
        }
        return 0.0f;
    ...
    public void lambda$deleteRecentFiles$13(ArrayList arrayList) {
        try {
            ...
            for (int i10 = 0; i10 < arrayList.size(); i10++) {
                ...
                executeFast.bindLong(2, ((MessageObject) arrayList.get(i10)).getDocument().f19902id);
                executeFast.step();
                try {
    ...
    public void lambda$onDownloadComplete$6(MessageObject messageObject) {
        ...
        try {
            ...
            long j3 = messageObject.getDocument().f19902id;
            ...
            if (i10 > 100) {
                ...
                while (queryFinalized3.next()) {
                    ...
                    downloadingDocumentEntry.f17095id = queryFinalized3.longValue(1);
                ...
                for (int i12 = 0; i12 < arrayList.size(); i12++) {
                    ...
                    executeFast.bindLong(2, ((DownloadingDocumentEntry) arrayList.get(i12)).f17095id);
                    executeFast.step();
                }
                executeFast.dispose();
            }
    ...
    public void lambda$onDownloadComplete$7(TLRPC.Document document, MessageObject messageObject) {
        for (int i10 = 0; i10 < this.downloadingFiles.size(); i10++) {
            if (this.downloadingFiles.get(i10).getDocument() != null && this.downloadingFiles.get(i10).getDocument().f19902id == document.f19902id) {
                this.downloadingFiles.remove(i10);
                int i11 = 0;
                while (true) {
                    if (i11 < this.recentDownloadingFiles.size()) {
                        if (this.recentDownloadingFiles.get(i11).getDocument() != null && this.recentDownloadingFiles.get(i11).getDocument().f19902id == document.f19902id) {
                            break;
                        }
                        i11++;
                    } else {
    ...
    public void lambda$onDownloadFail$8(MessageObject messageObject, int i10) {
        ...
        for (int i11 = 0; i11 < this.downloadingFiles.size(); i11++) {
            ...
            if (document2 == null || (document != null && document2.f19902id == document.f19902id)) {
    ...
    public void lambda$onDownloadFail$9(MessageObject messageObject) {
        try {
            ...
            executeFast.bindLong(2, messageObject.getDocument().f19902id);
            executeFast.step();
            executeFast.dispose();
        } catch (Exception e7) {
            FileLog.e(e7);
    ...
    public void lambda$startDownloadFile$4(MessageObject messageObject) {
        try {
            ...
            executeFast.bindLong(3, messageObject.getDocument().f19902id);
    ...
    public void lambda$startDownloadFile$5(TLRPC.Document document, MessageObject messageObject) {
        ...
        while (true) {
            ...
            if (i10 < this.recentDownloadingFiles.size()) {
                ...
                if (messageObject2 != null && (document3 = messageObject2.getDocument()) != null && document3.f19902id == document.f19902id) {
                    z11 = true;
                    break;
                }
                i10++;
        ...
        if (!z11) {
            for (int i11 = 0; i11 < this.downloadingFiles.size(); i11++) {
                ...
                if (messageObject3 != null && (document2 = messageObject3.getDocument()) != null && document2.f19902id == document.f19902id) {
                    break;
                }
            }
        }
                    ...
                    if (arrayList != null) {
                        ...
                        for (int i12 = 0; i12 < size; i12++) {
                            ...
                            if (weakReference.get() != null) {
                                weakReference.get().onProgressDownload(str, l4.longValue(), l10.longValue());
                            }
                        }
                    }
                    this.listenerInProgress = false;
                    ...
                    if (arrayList2 != null) {
                        ...
                        for (int i13 = 0; i13 < size2; i13++) {
                            ...
                            if (weakReference2.get() != null) {
                                weakReference2.get().onProgressUpload(str2, l11.longValue(), l12.longValue(), bool.booleanValue());
                            }
                        }
                    }
                    this.listenerInProgress = false;
                                ...
                                if (delayedMessage.encryptedChat == null) {
                                    ...
                                    if (delayedMessage.type == 4) {
                                        ...
                                        if (messageObject != null && messageObject.isVideo()) {
                                            getMessagesController().sendTyping(j3, i15, 5, 0);
                                        } else if (messageObject != null && messageObject.getDocument() != null) {
                                            getMessagesController().sendTyping(j3, i15, 3, 0);
                                        } else {
                                            getMessagesController().sendTyping(j3, i15, 4, 0);
                                        }
                                        ...
                                        if (l13 == null || l13.longValue() + 4000 < System.currentTimeMillis()) {
                                            if (delayedMessage.obj.isRoundVideo()) {
                                                getMessagesController().sendTyping(j3, i15, 8, 0);
                                            } else if (delayedMessage.obj.isVideo()) {
                                                getMessagesController().sendTyping(j3, i15, 5, 0);
                                            } else if (delayedMessage.obj.isVoice()) {
                                                getMessagesController().sendTyping(j3, i15, 9, 0);
    ...
    public boolean isDownloading(int i10) {
        for (int i11 = 0; i11 < this.downloadingFiles.size(); i11++) {
            if (this.downloadingFiles.get(i11).messageOwner.f19917id == i10) {
                return true;
            }
        }
        return false;
    ...
    public void savePresetToServer(int i10) {
        ...
        long j10 = 0;
        if (z12) {
            j3 = currentRoamingPreset.sizes[1];
        } else {
            j3 = 0;
        }
        tL_autoDownloadSettings2.video_size_max = j3;
        if (z13) {
