...
public class ChatThemeController extends BaseController {
    ...
    public List<org.telegram.ui.ActionBar.d4> getEmojiThemes(int i10) {
        ...
        int i11 = 0;
        if (hasFlag && (arrayList.isEmpty() || !((org.telegram.ui.ActionBar.d4) arrayList.get(0)).f20389a)) {
            ...
            c4Var.f20344a = org.telegram.ui.ActionBar.d4.e(true);
            d4Var.f20393f.add(c4Var);
            org.telegram.ui.ActionBar.c4 c4Var2 = new org.telegram.ui.ActionBar.c4();
            c4Var2.f20344a = org.telegram.ui.ActionBar.d4.e(false);
    ...
    public int setWallpaperToPeer(long j3, String str, org.telegram.ui.ActionBar.b6 b6Var, MessageObject messageObject, Runnable runnable) {
        ...
        tL_messages_setChatWallPaper.for_both = b6Var.f20314o;
        if (messageObject != null && (messageObject.messageOwner.action instanceof TLRPC.TL_messageActionSetChatWallPaper)) {
            ...
            tL_wallPaperSettings.intensity = (int) (b6Var.f20310k * 100.0f);
            tL_wallPaperSettings.motion = b6Var.f20309j;
            tL_wallPaperSettings.blur = b6Var.f20308i;
            tL_wallPaperSettings.background_color = b6Var.d;
            tL_wallPaperSettings.second_background_color = b6Var.f20305e;
            tL_wallPaperSettings.third_background_color = b6Var.f20306f;
            tL_wallPaperSettings.fourth_background_color = b6Var.f20307g;
