...
public class ChatThemeController extends BaseController {
    ...
    public static boolean equals(TLRPC.WallPaper wallPaper, TLRPC.WallPaper wallPaper2) {
        ...
        if (wallPaper != null && wallPaper2 != null) {
            ...
            if (wallPaper.f18473id == wallPaper2.f18473id && TextUtils.equals(zn.e(wallPaper.settings), zn.e(wallPaper2.settings)) && TextUtils.equals(getWallpaperEmoticon(wallPaper), getWallpaperEmoticon(wallPaper2))) {
                return true;
            }
        }
        return false;
    ...
    public static void lambda$saveWallpaperPatternBitmap$12(File file, List list, Bitmap bitmap) {
        ...
        try {
            ...
            if (bitmap.getConfig() == Bitmap.Config.ALPHA_8) {
                v7.c7.e(bitmap, gZIPOutputStream, list2);
            } else {
                Bitmap extractAlpha = bitmap.extractAlpha();
                v7.c7.e(extractAlpha, gZIPOutputStream, list2);
    ...
    public static boolean wallpaperEquals(TLRPC.WallPaper wallPaper, TLRPC.WallPaper wallPaper2) {
        ...
        if ((wallPaper instanceof TLRPC.TL_wallPaper) && (wallPaper2 instanceof TLRPC.TL_wallPaper)) {
            if (wallPaper.f18473id == wallPaper2.f18473id) {
                return true;
            }
            return false;
        }
    ...
    public List<org.telegram.ui.ActionBar.b4> getEmojiThemes(int i10) {
        ...
        int i11 = 0;
        if (hasFlag && (arrayList.isEmpty() || !((org.telegram.ui.ActionBar.b4) arrayList.get(0)).f18742a)) {
            ...
            a4Var.f18695a = org.telegram.ui.ActionBar.b4.e(true);
            b4Var.f18745f.add(a4Var);
            org.telegram.ui.ActionBar.a4 a4Var2 = new org.telegram.ui.ActionBar.a4();
            a4Var2.f18695a = org.telegram.ui.ActionBar.b4.e(false);
    ...
    public org.telegram.ui.ActionBar.b4 getTheme(fg.b bVar) {
        if (bVar != null) {
            String str = bVar.f9049b;
            if (!TextUtils.isEmpty(str)) {
                return this.allChatGiftThemes.get(str);
            }
            for (org.telegram.ui.ActionBar.b4 b4Var : this.allChatThemes) {
                if (bVar.equals(b4Var.f18744c)) {
                    return b4Var;
                }
            }
            return null;
    ...
    public void requestAllChatThemes(final ResultCallback<List<org.telegram.ui.ActionBar.b4>> resultCallback, final boolean z10) {
        ...
        if (list == null || list.isEmpty() || z11) {
            ...
            DispatchQueue dispatchQueue = chatThemeQueue;
            Objects.requireNonNull(dispatchQueue);
            connectionsManager.sendRequestTyped(getchatthemes, new d1(dispatchQueue), new Utilities.Callback2() {
                @Override
    ...
    public int setWallpaperToPeer(long j3, String str, org.telegram.ui.ActionBar.z5 z5Var, MessageObject messageObject, Runnable runnable) {
        ...
        tL_messages_setChatWallPaper.for_both = z5Var.f19955o;
        if (messageObject != null && (messageObject.messageOwner.action instanceof TLRPC.TL_messageActionSetChatWallPaper)) {
            ...
            tL_messages_setChatWallPaper.f18438id = messageObject.getId();
            if (i10 >= 0) {
                userFull = MessagesController.getInstance(this.currentAccount).getUserFull(j3);
                chatFull = null;
            } else {
            ...
            TLRPC.WallPaper wallPaper2 = tL_messageActionSetChatWallPaper.wallpaper;
            tL_wallPaper.f18473id = wallPaper2.f18473id;
            tL_wallPaper.document = wallPaper2.document;
            TLRPC.TL_wallPaperSettings tL_wallPaperSettings = new TLRPC.TL_wallPaperSettings();
            tL_wallPaper.settings = tL_wallPaperSettings;
            tL_wallPaperSettings.intensity = (int) (z5Var.f19951k * 100.0f);
            tL_wallPaperSettings.motion = z5Var.f19950j;
            tL_wallPaperSettings.blur = z5Var.f19949i;
            tL_wallPaperSettings.background_color = z5Var.d;
            tL_wallPaperSettings.second_background_color = z5Var.e;
            tL_wallPaperSettings.third_background_color = z5Var.f19947f;
            tL_wallPaperSettings.fourth_background_color = z5Var.f19948g;
            ...
            tL_wallPaper2.f18473id = wallPaper3.f18473id;
    ...
    public void saveWallpaperBitmap(dg.a aVar, long j3) {
        Bitmap bitmap = aVar.f7709b;
        int i10 = aVar.f7708a;
        if (i10 == 0) {
            saveWallpaperBitmap(bitmap, j3);
        } else if (i10 == 1) {
            saveWallpaperPatternBitmap(bitmap, aVar.f7710c, j3);
        }
    }
    ...
    private void setDialogTheme(long r6, fg.b r8, org.telegram.tgnet.TLRPC.ChatTheme r9, boolean r10) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.messenger.ChatThemeController.setDialogTheme(long, fg.b, org.telegram.tgnet.TLRPC$ChatTheme, boolean):void");
    }
