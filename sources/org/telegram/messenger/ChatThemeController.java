...
public class ChatThemeController extends BaseController {
    ...
    public static boolean equals(TLRPC.WallPaper wallPaper, TLRPC.WallPaper wallPaper2) {
        ...
        if (wallPaper != null && wallPaper2 != null) {
            ...
            if (wallPaper.f18495id == wallPaper2.f18495id && TextUtils.equals(co.e(wallPaper.settings), co.e(wallPaper2.settings)) && TextUtils.equals(getWallpaperEmoticon(wallPaper), getWallpaperEmoticon(wallPaper2))) {
                return true;
            }
        }
        return false;
    ...
    public static boolean wallpaperEquals(TLRPC.WallPaper wallPaper, TLRPC.WallPaper wallPaper2) {
        ...
        if ((wallPaper instanceof TLRPC.TL_wallPaper) && (wallPaper2 instanceof TLRPC.TL_wallPaper)) {
            if (wallPaper.f18495id == wallPaper2.f18495id) {
                return true;
            }
            return false;
        }
    ...
    public List<org.telegram.ui.ActionBar.d4> getEmojiThemes(int i10) {
        ...
        int i11 = 0;
        if (hasFlag && (arrayList.isEmpty() || !((org.telegram.ui.ActionBar.d4) arrayList.get(0)).f18822a)) {
            ...
            c4Var.f18780a = org.telegram.ui.ActionBar.d4.e(true);
            d4Var.f18825f.add(c4Var);
            org.telegram.ui.ActionBar.c4 c4Var2 = new org.telegram.ui.ActionBar.c4();
            c4Var2.f18780a = org.telegram.ui.ActionBar.d4.e(false);
    ...
    public int setWallpaperToPeer(long j3, String str, org.telegram.ui.ActionBar.b6 b6Var, MessageObject messageObject, Runnable runnable) {
        ...
        tL_messages_setChatWallPaper.for_both = b6Var.f18751o;
        if (messageObject != null && (messageObject.messageOwner.action instanceof TLRPC.TL_messageActionSetChatWallPaper)) {
            ...
            tL_messages_setChatWallPaper.f18460id = messageObject.getId();
            if (i10 >= 0) {
                userFull = MessagesController.getInstance(this.currentAccount).getUserFull(j3);
                chatFull = null;
            } else {
            ...
            TLRPC.WallPaper wallPaper2 = tL_messageActionSetChatWallPaper.wallpaper;
            tL_wallPaper.f18495id = wallPaper2.f18495id;
            tL_wallPaper.document = wallPaper2.document;
            TLRPC.TL_wallPaperSettings tL_wallPaperSettings = new TLRPC.TL_wallPaperSettings();
            tL_wallPaper.settings = tL_wallPaperSettings;
            tL_wallPaperSettings.intensity = (int) (b6Var.f18747k * 100.0f);
            tL_wallPaperSettings.motion = b6Var.f18746j;
            tL_wallPaperSettings.blur = b6Var.f18745i;
            tL_wallPaperSettings.background_color = b6Var.d;
            tL_wallPaperSettings.second_background_color = b6Var.e;
            tL_wallPaperSettings.third_background_color = b6Var.f18743f;
            tL_wallPaperSettings.fourth_background_color = b6Var.f18744g;
            ...
            tL_wallPaper2.f18495id = wallPaper3.f18495id;
    ...
    public void saveWallpaperBitmap(dg.a aVar, long j3) {
        Bitmap bitmap = aVar.f7726b;
        int i10 = aVar.f7725a;
        if (i10 == 0) {
            saveWallpaperBitmap(bitmap, j3);
        } else if (i10 == 1) {
            saveWallpaperPatternBitmap(bitmap, aVar.f7727c, j3);
        }
    }
