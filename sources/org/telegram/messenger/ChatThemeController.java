...
public class ChatThemeController extends BaseController {
    ...
    public List<org.telegram.ui.ActionBar.d4> getEmojiThemes(int i10) {
        ...
        int i11 = 0;
        if (hasFlag && (arrayList.isEmpty() || !((org.telegram.ui.ActionBar.d4) arrayList.get(0)).f20362a)) {
            ...
            c4Var.f20317a = org.telegram.ui.ActionBar.d4.e(true);
            d4Var.f20366f.add(c4Var);
            org.telegram.ui.ActionBar.c4 c4Var2 = new org.telegram.ui.ActionBar.c4();
            c4Var2.f20317a = org.telegram.ui.ActionBar.d4.e(false);
    ...
    public int setWallpaperToPeer(long j3, String str, org.telegram.ui.ActionBar.b6 b6Var, MessageObject messageObject, Runnable runnable) {
        ...
        tL_messages_setChatWallPaper.for_both = b6Var.f20287o;
        if (messageObject != null && (messageObject.messageOwner.action instanceof TLRPC.TL_messageActionSetChatWallPaper)) {
            ...
            tL_wallPaperSettings.intensity = (int) (b6Var.f20283k * 100.0f);
            tL_wallPaperSettings.motion = b6Var.f20282j;
            tL_wallPaperSettings.blur = b6Var.f20281i;
            tL_wallPaperSettings.background_color = b6Var.d;
            tL_wallPaperSettings.second_background_color = b6Var.f20278e;
            tL_wallPaperSettings.third_background_color = b6Var.f20279f;
            tL_wallPaperSettings.fourth_background_color = b6Var.f20280g;
