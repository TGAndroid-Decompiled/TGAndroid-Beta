...
public class ChatThemeController extends BaseController {
    ...
    public static boolean equals(TLRPC.WallPaper wallPaper, TLRPC.WallPaper wallPaper2) {
        ...
        if (wallPaper != null && wallPaper2 != null) {
            ...
            if (wallPaper.f18448id == wallPaper2.f18448id && TextUtils.equals(co.e(wallPaper.settings), co.e(wallPaper2.settings)) && TextUtils.equals(getWallpaperEmoticon(wallPaper), getWallpaperEmoticon(wallPaper2))) {
                return true;
            }
        }
        return false;
    ...
    public void lambda$requestNextChatThemes$19(TL_account.Tl_chatThemes tl_chatThemes, List list, List list2, ResultCallback resultCallback) {
        ...
        while (true) {
            ...
            fg.b bVar = d4Var.f18776c;
            if (bVar != null && (str = bVar.f9066b) == null) {
                str = bVar.f9065a;
            }
            map.put(str, d4Var);
        }
    ...
    public static boolean wallpaperEquals(TLRPC.WallPaper wallPaper, TLRPC.WallPaper wallPaper2) {
        ...
        if ((wallPaper instanceof TLRPC.TL_wallPaper) && (wallPaper2 instanceof TLRPC.TL_wallPaper)) {
            if (wallPaper.f18448id == wallPaper2.f18448id) {
                return true;
            }
            return false;
        }
    ...
    public List<org.telegram.ui.ActionBar.d4> getEmojiThemes(int i10) {
        ...
        int i11 = 0;
        if (hasFlag && (arrayList.isEmpty() || !((org.telegram.ui.ActionBar.d4) arrayList.get(0)).f18774a)) {
            ...
            c4Var.f18733a = org.telegram.ui.ActionBar.d4.e(true);
            d4Var.f18777f.add(c4Var);
            org.telegram.ui.ActionBar.c4 c4Var2 = new org.telegram.ui.ActionBar.c4();
            c4Var2.f18733a = org.telegram.ui.ActionBar.d4.e(false);
    ...
    public org.telegram.ui.ActionBar.d4 getTheme(fg.b bVar) {
        if (bVar != null) {
            String str = bVar.f9066b;
            if (!TextUtils.isEmpty(str)) {
                return this.allChatGiftThemes.get(str);
            }
            for (org.telegram.ui.ActionBar.d4 d4Var : this.allChatThemes) {
                if (bVar.equals(d4Var.f18776c)) {
                    return d4Var;
                }
            }
            return null;
    ...
    public int setWallpaperToPeer(long j3, String str, org.telegram.ui.ActionBar.b6 b6Var, MessageObject messageObject, Runnable runnable) {
        ...
        tL_messages_setChatWallPaper.for_both = b6Var.f18704o;
        if (messageObject != null && (messageObject.messageOwner.action instanceof TLRPC.TL_messageActionSetChatWallPaper)) {
            ...
            tL_messages_setChatWallPaper.f18413id = messageObject.getId();
            if (i10 >= 0) {
                userFull = MessagesController.getInstance(this.currentAccount).getUserFull(j3);
                chatFull = null;
            } else {
            ...
            TLRPC.WallPaper wallPaper2 = tL_messageActionSetChatWallPaper.wallpaper;
            tL_wallPaper.f18448id = wallPaper2.f18448id;
            tL_wallPaper.document = wallPaper2.document;
            TLRPC.TL_wallPaperSettings tL_wallPaperSettings = new TLRPC.TL_wallPaperSettings();
            tL_wallPaper.settings = tL_wallPaperSettings;
            tL_wallPaperSettings.intensity = (int) (b6Var.f18700k * 100.0f);
            tL_wallPaperSettings.motion = b6Var.f18699j;
            tL_wallPaperSettings.blur = b6Var.f18698i;
            tL_wallPaperSettings.background_color = b6Var.d;
            tL_wallPaperSettings.second_background_color = b6Var.e;
            tL_wallPaperSettings.third_background_color = b6Var.f18696f;
            tL_wallPaperSettings.fourth_background_color = b6Var.f18697g;
            ...
            tL_wallPaper2.f18448id = wallPaper3.f18448id;
