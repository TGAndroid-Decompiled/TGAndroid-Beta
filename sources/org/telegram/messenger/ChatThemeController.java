...
public class ChatThemeController extends BaseController {
    ...
    public static boolean equals(TLRPC.WallPaper wallPaper, TLRPC.WallPaper wallPaper2) {
        ...
        if (wallPaper != null && wallPaper2 != null) {
            ...
            if (wallPaper.f18273id == wallPaper2.f18273id && TextUtils.equals(fo.e(wallPaper.settings), fo.e(wallPaper2.settings)) && TextUtils.equals(getWallpaperEmoticon(wallPaper), getWallpaperEmoticon(wallPaper2))) {
                return true;
            }
        }
        return false;
    ...
    public static boolean wallpaperEquals(TLRPC.WallPaper wallPaper, TLRPC.WallPaper wallPaper2) {
        ...
        if ((wallPaper instanceof TLRPC.TL_wallPaper) && (wallPaper2 instanceof TLRPC.TL_wallPaper)) {
            if (wallPaper.f18273id == wallPaper2.f18273id) {
                return true;
            }
            return false;
        }
    ...
    public List<org.telegram.ui.ActionBar.e4> getEmojiThemes(int i10) {
        ...
        int i11 = 0;
        if (hasFlag && (arrayList.isEmpty() || !((org.telegram.ui.ActionBar.e4) arrayList.get(0)).f18617a)) {
            ...
            d4Var.f18574a = org.telegram.ui.ActionBar.e4.e(true);
            e4Var.f18620f.add(d4Var);
            org.telegram.ui.ActionBar.d4 d4Var2 = new org.telegram.ui.ActionBar.d4();
            d4Var2.f18574a = org.telegram.ui.ActionBar.e4.e(false);
    ...
    public org.telegram.ui.ActionBar.e4 getTheme(fg.b bVar) {
        if (bVar != null) {
            String str = bVar.f9067b;
            if (!TextUtils.isEmpty(str)) {
                return this.allChatGiftThemes.get(str);
            }
            for (org.telegram.ui.ActionBar.e4 e4Var : this.allChatThemes) {
                if (bVar.equals(e4Var.f18619c)) {
                    return e4Var;
                }
            }
            return null;
    ...
    public int setWallpaperToPeer(long j3, String str, org.telegram.ui.ActionBar.c6 c6Var, MessageObject messageObject, Runnable runnable) {
        ...
        tL_messages_setChatWallPaper.for_both = c6Var.f18548o;
        if (messageObject != null && (messageObject.messageOwner.action instanceof TLRPC.TL_messageActionSetChatWallPaper)) {
            ...
            tL_messages_setChatWallPaper.f18238id = messageObject.getId();
            if (i10 >= 0) {
                userFull = MessagesController.getInstance(this.currentAccount).getUserFull(j3);
                chatFull = null;
            } else {
            ...
            TLRPC.WallPaper wallPaper2 = tL_messageActionSetChatWallPaper.wallpaper;
            tL_wallPaper.f18273id = wallPaper2.f18273id;
            tL_wallPaper.document = wallPaper2.document;
            TLRPC.TL_wallPaperSettings tL_wallPaperSettings = new TLRPC.TL_wallPaperSettings();
            tL_wallPaper.settings = tL_wallPaperSettings;
            tL_wallPaperSettings.intensity = (int) (c6Var.f18544k * 100.0f);
            tL_wallPaperSettings.motion = c6Var.f18543j;
            tL_wallPaperSettings.blur = c6Var.f18542i;
            tL_wallPaperSettings.background_color = c6Var.d;
            tL_wallPaperSettings.second_background_color = c6Var.e;
            tL_wallPaperSettings.third_background_color = c6Var.f18540f;
            tL_wallPaperSettings.fourth_background_color = c6Var.f18541g;
            ...
            tL_wallPaper2.f18273id = wallPaper3.f18273id;
    ...
    public void saveWallpaperBitmap(dg.a aVar, long j3) {
        Bitmap bitmap = aVar.f7727b;
        int i10 = aVar.f7726a;
        if (i10 == 0) {
            saveWallpaperBitmap(bitmap, j3);
        } else if (i10 == 1) {
            saveWallpaperPatternBitmap(bitmap, aVar.f7728c, j3);
        }
    }
