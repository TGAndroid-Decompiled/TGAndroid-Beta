...
public final class gj implements Runnable {
    ...
    public gj(int i10, di.d dVar, TLObject tLObject, TL_stars.StarsSubscription starsSubscription, boolean z10, boolean z11, org.telegram.ui.ActionBar.f3[] f3VarArr) {
        this.f17843e = dVar;
        this.f17844f = f3VarArr;
        this.f17841b = i10;
        this.f17842c = z10;
        this.h = starsSubscription;
        this.d = z11;
        this.f17845n = tLObject;
    }
    ...
    public final void run() {
        ...
        Object obj = this.f17845n;
        Object obj2 = this.h;
        Object obj3 = this.f17844f;
        Object obj4 = this.f17843e;
        switch (i10) {
            case 0:
                ((SendMessagesHelper) obj4).lambda$performSendMessageRequest$95(this.f17842c, (TLRPC.Message) obj3, (ArrayList) obj2, this.d, (ArrayList) obj, this.f17841b);
                return;
            default:
                ...
                zh.s5.y(this.f17841b, false).S();
                org.telegram.ui.ActionBar.n2 U = LaunchActivity.U();
                if (U != null) {
                    if (this.f17842c && !TextUtils.isEmpty(starsSubscription.title)) {
    ...
    public gj(SendMessagesHelper sendMessagesHelper, boolean z10, TLRPC.Message message, ArrayList arrayList, boolean z11, ArrayList arrayList2, int i10) {
        this.f17843e = sendMessagesHelper;
        this.f17842c = z10;
        this.f17844f = message;
        this.h = arrayList;
        this.d = z11;
        this.f17845n = arrayList2;
        this.f17841b = i10;
    }
}
