...
public final class jb implements Runnable {
    ...
    public jb(MessagesController messagesController, TLRPC.messages_Dialogs messages_dialogs, ArrayList arrayList, TLRPC.messages_Dialogs messages_dialogs2, int i10, ArrayList arrayList2, ArrayList arrayList3, ArrayList arrayList4, Runnable runnable) {
        this.f16472a = 0;
        this.f16474c = messagesController;
        this.d = messages_dialogs;
        this.f16475f = arrayList;
        this.e = messages_dialogs2;
        this.f16473b = i10;
        this.h = arrayList2;
        this.f16476n = arrayList3;
        this.f16477r = arrayList4;
        this.f16478s = runnable;
    }
    ...
    public final void run() {
        ...
        Object obj2 = this.f16477r;
        Object obj3 = this.f16476n;
        Object obj4 = this.h;
        Object obj5 = this.f16475f;
        Object obj6 = this.e;
        Object obj7 = this.d;
        Object obj8 = this.f16474c;
        switch (i10) {
            case 0:
                ((MessagesController) obj8).lambda$processLoadedDialogFilters$23((TLRPC.messages_Dialogs) obj7, (ArrayList) obj5, (TLRPC.messages_Dialogs) obj6, this.f16473b, (ArrayList) obj4, (ArrayList) obj3, (ArrayList) obj2, (Runnable) obj);
                return;
            case 1:
                int[] iArr = (int[]) obj7;
                ...
                if (str.length() < 4) {
                    ...
                    e9Var.setTextColor(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f19071q7, e6Var));
                    int i12 = -iArr2[0];
                    iArr2[0] = i12;
                    ...
                    iArr[0] = ConnectionsManager.getInstance(i11).sendRequestTyped(checkusername, new Object(), new Utilities.Callback2() {
                        ...
                        public final void run(Object obj9, Object obj10) {
                            ...
                            if (z10) {
                                ...
                                e9Var2.setTextColor(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f19181w6, e6Var2));
                                return;
                            }
                            strArr3[0] = null;
                            dVar2.setEnabled(false);
                            e9Var2.setText(LocaleController.getString(R.string.UsernameInUse));
                            e9Var2.setTextColor(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f19071q7, e6Var2));
                            int[] iArr3 = iArr2;
                            int i14 = -iArr3[0];
                            iArr3[0] = i14;
            ...
            case 3:
                ...
                if (tLObject2 instanceof TLRPC.TL_messages_chats) {
                    ...
                    if (!tL_messages_chats.chats.isEmpty()) {
                        ...
                        iArr3[0] = launchActivity2.v0(this.f16473b, ma0Var2, num, num2, l4, num3, null, tL_messages_chats.chats.get(0), null, null, 0, -1);
                        return;
                    }
                }
                try {
            ...
            case 4:
                ...
                wg0 wg0Var = fg0Var.v;
                ci.d dVar2 = fg0Var.f33593b;
                FileLog.d("LoginBilling canPurchaseStore returned " + tLObject3 + " " + tL_error);
                if (tLObject3 instanceof TLRPC.TL_boolTrue) {
                    dVar2.g(LocaleController.formatString(R.string.SMSFeePurchaseTitle, kVar.f3901a), false, true);
                    if (i11 == 7) {
            ...
            default:
                ...
                ((boolean[]) obj7)[0] = true;
                u5Var.a0((MessageObject) obj6, (TLRPC.InputInvoice) obj5, (TLRPC.TL_payments_paymentFormStars) obj4, new yh.c5(u5Var, (boolean[]) obj3, this.f16473b, (Utilities.Callback) obj2, (Utilities.Callback) obj));
                return;
        }
    }
    ...
    public jb(fg0 fg0Var, TLObject tLObject, TLRPC.TL_error tL_error, c5.k kVar, int i10, c5.o oVar, TLRPC.TL_inputStorePaymentAuthCode tL_inputStorePaymentAuthCode, String str, TLRPC.TL_payments_canPurchaseStore tL_payments_canPurchaseStore) {
        ...
        this.f16473b = i10;
        this.h = oVar;
        this.f16476n = tL_inputStorePaymentAuthCode;
        this.f16477r = str;
        this.f16478s = tL_payments_canPurchaseStore;
    }
    ...
    public jb(yh.u5 u5Var, boolean[] zArr, MessageObject messageObject, TLRPC.InputInvoice inputInvoice, TLRPC.TL_payments_paymentFormStars tL_payments_paymentFormStars, boolean[] zArr2, int i10, Utilities.Callback callback, Utilities.Callback callback2) {
        ...
        this.f16475f = inputInvoice;
        this.h = tL_payments_paymentFormStars;
        this.f16476n = zArr2;
        this.f16473b = i10;
        this.f16477r = callback;
        this.f16478s = callback2;
    }
}
