...
public final class jb implements Runnable {
    ...
    public final Object f18055n;
    public final Object f18056r;
    public final Object f18057s;
    ...
    public jb(MessagesController messagesController, TLRPC.messages_Dialogs messages_dialogs, ArrayList arrayList, TLRPC.messages_Dialogs messages_dialogs2, int i10, ArrayList arrayList2, ArrayList arrayList3, ArrayList arrayList4, Runnable runnable) {
        this.f18050a = 0;
        this.f18052c = messagesController;
        this.d = messages_dialogs;
        this.f18054f = arrayList;
        this.f18053e = messages_dialogs2;
        this.f18051b = i10;
        this.h = arrayList2;
        this.f18055n = arrayList3;
        this.f18056r = arrayList4;
        this.f18057s = runnable;
    }
    ...
    public final void run() {
        ...
        Object obj = this.f18057s;
        Object obj2 = this.f18056r;
        Object obj3 = this.f18055n;
        Object obj4 = this.h;
        Object obj5 = this.f18054f;
        Object obj6 = this.f18053e;
        Object obj7 = this.d;
        Object obj8 = this.f18052c;
        switch (i10) {
            case 0:
                ((MessagesController) obj8).lambda$processLoadedDialogFilters$23((TLRPC.messages_Dialogs) obj7, (ArrayList) obj5, (TLRPC.messages_Dialogs) obj6, this.f18051b, (ArrayList) obj4, (ArrayList) obj3, (ArrayList) obj2, (Runnable) obj);
                return;
            case 1:
                int[] iArr = (int[]) obj7;
            ...
            case 3:
                ...
                if (tLObject2 instanceof TLRPC.TL_messages_chats) {
                    ...
                    if (!tL_messages_chats.chats.isEmpty()) {
                        ...
                        iArr3[0] = launchActivity2.v0(this.f18051b, r80Var2, num, num2, l4, num3, null, tL_messages_chats.chats.get(0), null, null, 0, -1);
                        return;
                    }
                }
                try {
            ...
            default:
                ...
                ((boolean[]) obj7)[0] = true;
                s5Var.a0((MessageObject) obj6, (TLRPC.InputInvoice) obj5, (TLRPC.TL_payments_paymentFormStars) obj4, new zh.z4(s5Var, (boolean[]) obj3, this.f18051b, (Utilities.Callback) obj2, (Utilities.Callback) obj));
                return;
        }
    }
    ...
    public jb(fg0 fg0Var, TLObject tLObject, TLRPC.TL_error tL_error, c5.k kVar, int i10, c5.o oVar, TLRPC.TL_inputStorePaymentAuthCode tL_inputStorePaymentAuthCode, String str, TLRPC.TL_payments_canPurchaseStore tL_payments_canPurchaseStore) {
        ...
        this.f18052c = fg0Var;
        this.d = tLObject;
        this.f18053e = tL_error;
        this.f18054f = kVar;
        this.f18051b = i10;
        this.h = oVar;
        this.f18055n = tL_inputStorePaymentAuthCode;
        this.f18056r = str;
        this.f18057s = tL_payments_canPurchaseStore;
    }
    ...
    public jb(zh.s5 s5Var, boolean[] zArr, MessageObject messageObject, TLRPC.InputInvoice inputInvoice, TLRPC.TL_payments_paymentFormStars tL_payments_paymentFormStars, boolean[] zArr2, int i10, Utilities.Callback callback, Utilities.Callback callback2) {
        ...
        this.f18052c = s5Var;
        this.d = zArr;
        this.f18053e = messageObject;
        this.f18054f = inputInvoice;
        this.h = tL_payments_paymentFormStars;
        this.f18055n = zArr2;
        this.f18051b = i10;
        this.f18056r = callback;
        this.f18057s = callback2;
    }
}
