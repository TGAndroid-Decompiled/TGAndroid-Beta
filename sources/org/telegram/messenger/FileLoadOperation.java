...
public class FileLoadOperation {
    ...
    public FileLoadOperation(ImageLocation imageLocation, Object obj, String str, long j3) {
        ...
        if (imageLocation.isEncrypted()) {
            ...
            tL_inputEncryptedFileLocation.f18351id = j10;
            ...
            tL_inputPeerPhotoFileLocation.f18351id = j11;
            ...
            tL_inputStickerSetThumb.f18351id = j12;
            ...
            if (imageLocation.photoId != 0) {
                ...
                tL_inputPhotoFileLocation.f18351id = imageLocation.photoId;
                ...
                tL_inputDocumentFileLocation.f18351id = j13;
                this.documentId = j13;
    ...
    public void lambda$addPart$2(ArrayList arrayList) {
        ...
        synchronized (this) {
            ...
            this.filePartsStream.write(filesQueueByteBuffer.f47155a, 0, i10);
    ...
    public FileLoadOperation(SecureDocument secureDocument) {
        ...
        tL_inputSecureFileLocation.f18351id = tL_secureFile.f18471id;
