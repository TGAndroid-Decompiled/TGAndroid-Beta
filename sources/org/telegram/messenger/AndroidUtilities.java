...
import org.telegram.p009ui.Components.PickerBottomLayout;
...
public class AndroidUtilities {
    ...
    public static String lambda$formatSpannableSimple$9(Integer num) {
        return "%s";
    }
    ...
    static {
        ...
        documentIcons = new int[]{C1010R.C1011drawable.media_doc_blue, C1010R.C1011drawable.media_doc_green, C1010R.C1011drawable.media_doc_red, C1010R.C1011drawable.media_doc_yellow};
        documentMediaIcons = new int[]{C1010R.C1011drawable.media_doc_blue_b, C1010R.C1011drawable.media_doc_green_b, C1010R.C1011drawable.media_doc_red_b, C1010R.C1011drawable.media_doc_yellow_b};
        sUrlMatchFilter = AndroidUtilities$$ExternalSyntheticLambda4.INSTANCE;
        hasCallPermissions = Build.VERSION.SDK_INT >= 23;
        numbersSignatureArray = new String[]{BuildConfig.APP_CENTER_HASH, "K", "M", "G", "T", "P"};
    ...
    public static void lambda$recycleBitmaps$1(final List list) {
    ...
    public static void lambda$recycleBitmaps$0(List list) {
        ...
        try {
            ...
            if (!needShowPasscode() && !SharedConfig.isWaitingForPasscodeEnter) {
                ...
                if (user != null) {
                    ...
                    SendMessagesHelper.getInstance(i).sendMessage(stringExtra, user.f986id, null, null, null, true, null, null, null, true, 0, null, false);
                }
            }
        } catch (Exception e) {
            FileLog.m31e(e);
    ...
    public static boolean lambda$static$3(CharSequence charSequence, int i, int i2) {
    ...
    public static int lambda$pruneOverlaps$4(LinkSpec linkSpec, LinkSpec linkSpec2) {
        int i;
        int i2;
    ...
    public static void lambda$isMapsInstalled$5(String str, BaseFragment baseFragment, DialogInterface dialogInterface, int i) {
        try {
    ...
    public static class VcardItem {
        ...
        public String getValue(boolean z) {
            ...
            if (z) {
                int i2 = this.type;
                if (i2 == 0) {
                    return C0933PhoneFormat.getInstance().format(sb.toString());
                }
                if (i2 == 5) {
    ...
    public static ArrayList<TLRPC$User> loadVCardFromStream(Uri uri, int i, boolean z, ArrayList<VcardItem> arrayList, String str) {
        ...
        for (int i5 = 0; i5 < arrayList4.size(); i5++) {
            ...
            if (vcardData2.name != null && !vcardData2.phones.isEmpty()) {
                ...
                tLRPC$TL_userContact_old2.f986id = 0L;
            ...
            if (!hashtable.containsKey(str)) {
                try {
                    ...
                    if (BuildVars.LOGS_ENABLED) {
                        FileLog.m33e("Could not get typeface '" + str + "' because " + e.getMessage());
                    }
                    return null;
                }
            }
    ...
    public static void lambda$setWaitingForSms$6(Void r0) {
        if (BuildVars.DEBUG_VERSION) {
            FileLog.m34d("sms listener registered");
        }
    }
    ...
    public static int m35dp(float f) {
        if (f == 0.0f) {
            return 0;
        }
        ...
        try {
            ...
            if (roundMessageSize == 0) {
                if (isTablet()) {
                    ...
                    roundPlayingMessageSize = getMinTabletSide() - m35dp(28.0f);
                } else {
                    Point point = displaySize;
                    roundMessageSize = (int) (Math.min(point.x, point.y) * 0.6f);
                    Point point2 = displaySize;
                    roundPlayingMessageSize = Math.min(point2.x, point2.y) - m35dp(28.0f);
                }
                roundMessageInset = m35dp(2.0f);
            }
            if (BuildVars.LOGS_ENABLED) {
                if (statusBarHeight == 0) {
                    fillStatusBarHeight(context);
                }
                FileLog.m33e("density = " + density + " display size = " + displaySize.x + " " + displaySize.y + " " + displayMetrics.xdpi + "x" + displayMetrics.ydpi + ", screen layout: " + configuration.screenLayout + ", statusbar height: " + statusBarHeight + ", navbar height: " + navigationBarHeight);
            }
    ...
    public static boolean isTabletForce() {
        return ApplicationLoader.applicationContext != null && ApplicationLoader.applicationContext.getResources().getBoolean(C1010R.bool.isTablet);
    }
    ...
    public static boolean checkPhonePattern(String str, String str2) {
        if (!TextUtils.isEmpty(str) && !str.equals("*")) {
            ...
            String stripExceptNumbers = C0933PhoneFormat.stripExceptNumbers(str2);
            int i = 0;
    ...
    public static boolean needShowPasscode(boolean z) {
        ...
        if (BuildVars.LOGS_ENABLED && z && SharedConfig.passcodeHash.length() > 0) {
            FileLog.m34d("wasInBackground = " + isWasInBackground + " appLocked = " + SharedConfig.appLocked + " autoLockIn = " + SharedConfig.autoLockIn + " lastPauseTime = " + SharedConfig.lastPauseTime + " uptime = " + elapsedRealtime);
        }
    ...
    public static void shakeView(final View view) {
        ...
        int i = C1010R.C1012id.shake_animation;
    ...
    public static void lambda$shakeView$7(View view, ValueAnimator valueAnimator) {
        ...
        Double.isNaN(d);
        double d3 = d * sin;
        double m35dp = m35dp(4.0f);
        Double.isNaN(m35dp);
        view.setTranslationX((float) (d3 * m35dp));
    }
    ...
    public static void shakeViewSpring(final View view, float f, final Runnable runnable) {
        ...
        int i2 = C1010R.C1012id.spring_was_translation_x_tag;
        ...
        SpringAnimation addEndListener = new SpringAnimation(view, DynamicAnimation.TRANSLATION_X, translationX).setSpring(new SpringForce(translationX).setStiffness(600.0f)).setStartVelocity((-m35dp) * 100).addEndListener(new DynamicAnimation.OnAnimationEndListener() {
            @Override
    ...
    public static void lambda$shakeViewSpring$8(Runnable runnable, View view, float f, DynamicAnimation dynamicAnimation, boolean z, float f2, float f3) {
        if (runnable != null) {
            runnable.run();
        }
        view.setTranslationX(f);
        view.setTag(C1010R.C1012id.spring_tag, null);
        view.setTag(C1010R.C1012id.spring_was_translation_x_tag, null);
    }
    ...
    private static File getAlbumDir(boolean z) {
        ...
        if ("mounted".equals(Environment.getExternalStorageState())) {
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m34d("failed to create directory");
            }
            return null;
        } else if (BuildVars.LOGS_ENABLED) {
            FileLog.m34d("External storage is not mounted READ/WRITE.");
            return null;
        } else {
            return null;
        }
    ...
    public static void openDocument(MessageObject messageObject, Activity activity, BaseFragment baseFragment) {
        ...
        if (baseFragment != null && file.getName().toLowerCase().endsWith("attheme")) {
            ...
            builder.setMessage(LocaleController.getString("IncorrectTheme", C1010R.string.IncorrectTheme));
        ...
        try {
            ...
            builder2.setTopAnimation(C1010R.raw.not_available, 52, false, baseFragment.getThemedColor("dialogTopBackground"), hashMap2);
            builder2.setTopAnimationIsNew(true);
            builder2.setPositiveButton(LocaleController.getString("OK", C1010R.string.OK), null);
            builder2.setMessage(LocaleController.formatString("NoHandleAppInstalled", C1010R.string.NoHandleAppInstalled, messageObject.getDocument().mime_type));
            baseFragment.showDialog(builder2.create());
        }
    }

    public static boolean openForView(java.io.File r6, java.lang.String r7, java.lang.String r8, android.app.Activity r9, org.telegram.p009ui.ActionBar.Theme.ResourcesProvider r10) {
    ...
    public static String lambda$formatSpannable$10(Integer num) {
    ...
    public static void showProxyAlert(Activity activity, final String str, final String str2, final String str3, final String str4, final String str5) {
        ...
        if (!TextUtils.isEmpty(str5)) {
            ...
            textView.setText(LocaleController.getString("UseProxyTelegramInfo2", C1010R.string.UseProxyTelegramInfo2));
        ...
        for (int i = 0; i < 5; i++) {
            String str7 = null;
            if (i == 0) {
                str6 = LocaleController.getString("UseProxyAddress", C1010R.string.UseProxyAddress);
                str7 = str;
            } else if (i == 1) {
                str7 = BuildConfig.APP_CENTER_HASH + str2;
                str6 = LocaleController.getString("UseProxyPort", C1010R.string.UseProxyPort);
            } else if (i == 2) {
                str6 = LocaleController.getString("UseProxySecret", C1010R.string.UseProxySecret);
                str7 = str5;
            } else if (i == 3) {
                str6 = LocaleController.getString("UseProxyUsername", C1010R.string.UseProxyUsername);
                str7 = str3;
            } else if (i == 4) {
                str6 = LocaleController.getString("UseProxyPassword", C1010R.string.UseProxyPassword);
                str7 = str4;
            } else {
                str6 = null;
            }
        ...
        pickerBottomLayout.cancelButton.setPadding(m35dp(18.0f), 0, m35dp(18.0f), 0);
        pickerBottomLayout.cancelButton.setTextColor(Theme.getColor("dialogTextBlue2"));
        pickerBottomLayout.cancelButton.setText(LocaleController.getString("Cancel", C1010R.string.Cancel).toUpperCase());
        ...
        pickerBottomLayout.doneButton.setPadding(m35dp(18.0f), 0, m35dp(18.0f), 0);
        pickerBottomLayout.doneButtonBadgeTextView.setVisibility(8);
        pickerBottomLayout.doneButtonTextView.setText(LocaleController.getString("ConnectingConnectProxy", C1010R.string.ConnectingConnectProxy).toUpperCase());
    ...
    public static void lambda$registerFlagSecure$13(ArrayList arrayList, long j, Window window) {
    ...
    public static void lambda$setNavigationBarColor$14(IntColorCallback intColorCallback, Window window, ValueAnimator valueAnimator) {
    ...
    public static int lambda$scrollToFragmentRow$15(BaseFragment baseFragment, String str, RecyclerListView recyclerListView) {
        int i = -1;
        try {
            Field declaredField = baseFragment.getClass().getDeclaredField(str);
            declaredField.setAccessible(true);
            i = declaredField.getInt(baseFragment);
            ((LinearLayoutManager) recyclerListView.getLayoutManager()).scrollToPositionWithOffset(i, m35dp(60.0f));
            declaredField.setAccessible(false);
            return i;
        } catch (Throwable unused) {
            return i;
    ...
    public static void lambda$updateImageViewImageAnimated$16(ImageView imageView, AtomicBoolean atomicBoolean, Drawable drawable, ValueAnimator valueAnimator) {
        float floatValue = ((Float) valueAnimator.getAnimatedValue()).floatValue();
    ...
    public static void updateViewShow(View view, boolean z, boolean z2, boolean z3, Runnable runnable) {
        ...
        if (!z3) {
            ...
            view.setScaleY((!z2 || z) ? 1.0f : 1.0f);
            if (runnable != null) {
                runnable.run();
            }
        } else if (!z) {
            view.animate().alpha(0.0f).scaleY(z2 ? 0.0f : 1.0f).scaleX(z2 ? 0.0f : 1.0f).setListener(new HideViewAfterAnimation(view)).setInterpolator(CubicBezierInterpolator.EASE_OUT_QUINT).setDuration(340L).withEndAction(runnable).start();
        } else {
            if (view.getVisibility() != 0) {
                view.setVisibility(0);
                view.setAlpha(0.0f);
