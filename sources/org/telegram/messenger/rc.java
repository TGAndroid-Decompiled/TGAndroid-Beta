...
public final class rc implements Runnable {
    ...
    public final MessagesController f17221b;
    ...
    public rc(int i10, long j3, long j10, MessagesController messagesController) {
        this.f17220a = 2;
        this.f17221b = messagesController;
        this.d = j3;
        this.e = j10;
        this.f17222c = i10;
    }
    ...
    public final void run() {
        switch (this.f17220a) {
            case 0:
                long j3 = this.d;
                long j10 = this.e;
                this.f17221b.lambda$sendTyping$173(this.f17222c, j3, j10);
                return;
            case 1:
                long j11 = this.d;
                long j12 = this.e;
                this.f17221b.lambda$sendTyping$171(this.f17222c, j11, j12);
                return;
            default:
                long j13 = this.e;
                int i10 = this.f17222c;
                this.f17221b.lambda$checkDeletingTask$84(this.d, j13, i10);
                return;
        }
    }
