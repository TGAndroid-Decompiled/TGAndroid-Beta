...
public final class sg implements Runnable {
    public final int f16318a = 0;
    public final long f16319b;
    public final long f16320c;
    public final boolean d;
    public final Object e;
    public final TLObject f16321f;

    public sg(MessagesStorage messagesStorage, long j3, boolean z10, TLRPC.InputPeer inputPeer, long j10) {
        this.e = messagesStorage;
        this.f16319b = j3;
        this.d = z10;
        this.f16321f = inputPeer;
        this.f16320c = j10;
    }
    ...
    public final void run() {
        ...
        TLObject tLObject = this.f16321f;
        Object obj = this.e;
        switch (i10) {
            case 0:
                ((MessagesStorage) obj).lambda$loadPendingTasks$15(this.f16319b, this.d, (TLRPC.InputPeer) tLObject, this.f16320c);
                return;
            default:
    ...
    public sg(xh.v5 v5Var, TLObject tLObject, long j3, long j10, boolean z10) {
        this.e = v5Var;
        this.f16321f = tLObject;
        this.f16319b = j3;
        this.f16320c = j10;
        this.d = z10;
    }
