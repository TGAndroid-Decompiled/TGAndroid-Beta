...
public class BotForumHelper extends BaseController {
    ...
    public void lambda$performSendBotTopicCreate$5(long j3, String str, TLRPC.Updates updates, TLRPC.TL_error tL_error) {
        ...
        int i11 = tL_updateMessageID.f17453id;
        tL_forumTopic.f17247id = i11;
        ...
        performSendBotTopicCreateComplete(j3, tL_updateMessageID.f17453id);
        getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.botForumTopicDidCreate, new BotForumTopicCreateNotification(j3, tL_updateMessageID.f17453id));
    }
    ...
    private void performSendBotTopicCreate(TLRPC.InputPeer inputPeer, String str, long j3, MessagesStorage.IntCallback intCallback) {
        ...
        getConnectionsManager().sendRequestTyped(tL_messages_createForumTopic, new Object(), new xh(this, peerDialogId, str));
    }
