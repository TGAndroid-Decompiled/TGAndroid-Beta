...
public class BotForumHelper extends BaseController {
    ...
    public static CharSequence applyTypingAnimationSpan(CharSequence charSequence) {
        ...
        typingBotSpan.setColorKey(org.telegram.ui.ActionBar.k6.f21685ec);
    ...
    public void lambda$performSendBotTopicCreate$5(long j10, String str, TLRPC.Updates updates, TLRPC.TL_error tL_error) {
        ...
        int i11 = tL_updateMessageID.f21100id;
        tL_forumTopic.f20897id = i11;
        ...
        performSendBotTopicCreateComplete(j10, tL_updateMessageID.f21100id);
        getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.botForumTopicDidCreate, new BotForumTopicCreateNotification(j10, tL_updateMessageID.f21100id));
    }
    ...
    private void performSendBotTopicCreate(TLRPC.InputPeer inputPeer, String str, long j10, MessagesStorage.IntCallback intCallback) {
        ...
        getConnectionsManager().sendRequestTyped(tL_messages_createForumTopic, new Object(), new rh(this, peerDialogId, str));
    }
    ...
    public void saveIsStreamingTopic(long j10, long j11, boolean z4) {
        ...
        edit.putBoolean(j10 + "_" + j11, z4).apply();
    }
