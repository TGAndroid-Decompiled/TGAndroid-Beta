...
public class BotForumHelper extends BaseController {
    ...
    public static CharSequence applyTypingAnimationSpan(CharSequence charSequence) {
        ...
        typingBotSpan.setColorKey(org.telegram.ui.ActionBar.j6.f19904ec);
    ...
    public void lambda$performSendBotTopicCreate$5(long j10, String str, TLRPC.Updates updates, TLRPC.TL_error tL_error) {
        ...
        tL_messageService.f19180id = tL_updateMessageID.f19412id;
        tL_messageService.date = (int) (System.currentTimeMillis() / 1000);
        int i11 = tL_updateMessageID.f19412id;
        tL_forumTopic.f19211id = i11;
        ...
        performSendBotTopicCreateComplete(j10, tL_updateMessageID.f19412id);
        getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.botForumTopicDidCreate, new BotForumTopicCreateNotification(j10, tL_updateMessageID.f19412id));
    }
