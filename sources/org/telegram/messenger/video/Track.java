...
public class Track {
    ...
    public Track(int i10, MediaFormat mediaFormat, boolean z10) {
        ...
        if (!z10) {
            ...
            if (string.equals("video/avc")) {
                ...
                if (mediaFormat.getByteBuffer("csd-0") != null) {
                    ...
                    aVar2.f42456a.f42460f = arrayList;
                    e2.q(re.a.c(rc.a.f42450n, aVar2, aVar2, arrayList2));
                    aVar2.f42456a.f42461g = arrayList2;
                }
                ...
                e2.q(re.a.c(rc.a.f42452s, aVar2, aVar2, new Integer(-1)));
                aVar2.f42456a.f42463j = -1;
                e2.q(re.a.c(rc.a.v, aVar2, aVar2, new Integer(-1)));
                aVar2.f42456a.f42464k = -1;
                e2.q(re.a.c(rc.a.f42451r, aVar2, aVar2, new Integer(-1)));
                aVar2.f42456a.f42462i = -1;
                e2.q(re.a.c(rc.a.f42447b, aVar2, aVar2, new Integer(1)));
                aVar2.f42456a.f42457a = 1;
                e2.q(re.a.c(rc.a.f42449f, aVar2, aVar2, new Integer(3)));
                aVar2.f42456a.e = 3;
                e2.q(re.a.c(rc.a.d, aVar2, aVar2, new Integer(0)));
                aVar2.f42456a.f42459c = 0;
                cVar.a(aVar2);
                ...
                try {
                    ...
                    parseFromCsd.f9421n = this.height;
        ...
        aVar3.f9420r = mediaFormat.getInteger("sample-rate");
        aVar3.f9418f = 1;
        aVar3.f9419n = 16;
        ?? aVar4 = new com.googlecode.mp4parser.a("esds");
        ?? obj2 = new Object();
        obj2.f14970i = 0;
        obj2.f14976o = new ArrayList();
        obj2.d = 0;
        ?? obj3 = new Object();
        obj3.d = 2;
        obj2.f14975n = obj3;
        ...
        obj4.f14963i = this.timeScale;
        ?? obj5 = new Object();
        obj5.e = 2;
        obj5.f14935f = samplingFrequencyIndexMap.get(Integer.valueOf((int) aVar3.f9420r)).intValue();
        obj5.h = aVar3.h;
        obj4.f14964j = obj5;
        obj2.f14974m = obj4;
        ...
        allocate.put((byte) (((obj2.e << 7) | (obj2.f14968f << 6) | (obj2.f14969g << 5) | (31 & obj2.h)) & 255));
        if (obj2.e > 0) {
            e5.b.p(obj2.f14972k, allocate);
        }
        if (obj2.f14968f > 0) {
            allocate.put((byte) (obj2.f14970i & 255));
            allocate.put(e5.b.b(obj2.f14971j));
            allocate.put((byte) 0);
        }
        if (obj2.f14969g > 0) {
            e5.b.p(obj2.f14973l, allocate);
        }
        mc.d dVar = obj2.f14974m;
        mc.a aVar5 = dVar.f14964j;
        if (aVar5 == null) {
            i12 = 0;
        } else if (aVar5.e == 2) {
            i12 = 4;
        ...
        allocate2.put((byte) (((dVar.e << 2) | (dVar.f14961f << 1) | 1) & 255));
        e5.b.q(dVar.f14962g, allocate2);
        allocate2.putInt((int) dVar.h);
        allocate2.putInt((int) dVar.f14963i);
        mc.a aVar7 = dVar.f14964j;
        if (aVar7 != null) {
            if (aVar7.e == 2) {
