...
public class Track {
    ...
    public Track(int i10, MediaFormat mediaFormat, boolean z10) {
        ...
        if (!z10) {
            ...
            if (string.equals("video/avc")) {
                ...
                if (mediaFormat.getByteBuffer("csd-0") != null) {
                    ...
                    aVar2.f42202a.f42206f = arrayList;
                    e2.q(re.a.c(rc.a.f42196n, aVar2, aVar2, arrayList2));
                    aVar2.f42202a.f42207g = arrayList2;
                }
                ...
                e2.q(re.a.c(rc.a.f42198s, aVar2, aVar2, new Integer(-1)));
                aVar2.f42202a.f42209j = -1;
                e2.q(re.a.c(rc.a.v, aVar2, aVar2, new Integer(-1)));
                aVar2.f42202a.f42210k = -1;
                e2.q(re.a.c(rc.a.f42197r, aVar2, aVar2, new Integer(-1)));
                aVar2.f42202a.f42208i = -1;
                e2.q(re.a.c(rc.a.f42193b, aVar2, aVar2, new Integer(1)));
                aVar2.f42202a.f42203a = 1;
                e2.q(re.a.c(rc.a.f42195f, aVar2, aVar2, new Integer(3)));
                aVar2.f42202a.e = 3;
                e2.q(re.a.c(rc.a.d, aVar2, aVar2, new Integer(0)));
                aVar2.f42202a.f42205c = 0;
                cVar.a(aVar2);
                ...
                try {
                    ...
                    parseFromCsd.f9417n = this.height;
        ...
        aVar3.f9416r = mediaFormat.getInteger("sample-rate");
        aVar3.f9414f = 1;
        aVar3.f9415n = 16;
        ?? aVar4 = new com.googlecode.mp4parser.a("esds");
        ?? obj2 = new Object();
        obj2.f14788i = 0;
        obj2.f14794o = new ArrayList();
        obj2.d = 0;
        ?? obj3 = new Object();
        obj3.d = 2;
        obj2.f14793n = obj3;
        ...
        obj4.f14781i = this.timeScale;
        ?? obj5 = new Object();
        obj5.e = 2;
        obj5.f14753f = samplingFrequencyIndexMap.get(Integer.valueOf((int) aVar3.f9416r)).intValue();
        obj5.h = aVar3.h;
        obj4.f14782j = obj5;
        obj2.f14792m = obj4;
        ...
        allocate.put((byte) (((obj2.e << 7) | (obj2.f14786f << 6) | (obj2.f14787g << 5) | (31 & obj2.h)) & 255));
        if (obj2.e > 0) {
            e5.b.p(obj2.f14790k, allocate);
        }
        if (obj2.f14786f > 0) {
            allocate.put((byte) (obj2.f14788i & 255));
            allocate.put(e5.b.b(obj2.f14789j));
            allocate.put((byte) 0);
        }
        if (obj2.f14787g > 0) {
            e5.b.p(obj2.f14791l, allocate);
        }
        mc.d dVar = obj2.f14792m;
        mc.a aVar5 = dVar.f14782j;
        if (aVar5 == null) {
            i12 = 0;
        } else if (aVar5.e == 2) {
            i12 = 4;
        ...
        allocate2.put((byte) (((dVar.e << 2) | (dVar.f14779f << 1) | 1) & 255));
        e5.b.q(dVar.f14780g, allocate2);
        allocate2.putInt((int) dVar.h);
        allocate2.putInt((int) dVar.f14781i);
        mc.a aVar7 = dVar.f14782j;
        if (aVar7 != null) {
            if (aVar7.e == 2) {
