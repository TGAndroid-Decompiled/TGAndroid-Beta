        ...
        if (!z10) {
            ...
            if (string.equals("video/avc")) {
                ...
                if (mediaFormat.getByteBuffer("csd-0") != null) {
                    ...
                    aVar2.f45089a.f45094f = arrayList;
                    e2.q(re.a.c(rc.a.f45083n, aVar2, aVar2, arrayList2));
                    aVar2.f45089a.f45095g = arrayList2;
                }
                ...
                e2.q(re.a.c(rc.a.f45085s, aVar2, aVar2, new Integer(-1)));
                aVar2.f45089a.f45097j = -1;
                e2.q(re.a.c(rc.a.v, aVar2, aVar2, new Integer(-1)));
                aVar2.f45089a.f45098k = -1;
                e2.q(re.a.c(rc.a.f45084r, aVar2, aVar2, new Integer(-1)));
                aVar2.f45089a.f45096i = -1;
                e2.q(re.a.c(rc.a.f45079b, aVar2, aVar2, new Integer(1)));
                aVar2.f45089a.f45090a = 1;
                e2.q(re.a.c(rc.a.f45082f, aVar2, aVar2, new Integer(3)));
                aVar2.f45089a.f45093e = 3;
                e2.q(re.a.c(rc.a.d, aVar2, aVar2, new Integer(0)));
                aVar2.f45089a.f45092c = 0;
                cVar.a(aVar2);
