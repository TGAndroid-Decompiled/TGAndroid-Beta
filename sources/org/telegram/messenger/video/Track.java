    ...
    public Track(int i10, MediaFormat mediaFormat, boolean z10) {
        ...
        if (!z10) {
            ...
            if (string.equals("video/avc")) {
                ...
                ?? obj = new Object();
                obj.f42228f = new ArrayList();
                obj.f42229g = new ArrayList();
                obj.h = true;
                obj.f42230i = 1;
                obj.f42231j = 0;
                obj.f42232k = 0;
                obj.f42233l = new ArrayList();
                obj.f42234m = 63;
                obj.f42235n = 7;
                obj.f42236o = 31;
                obj.f42237p = 31;
                ...
                if (mediaFormat.getByteBuffer("csd-0") != null) {
                    ...
                    aVar2.f42224a.f42228f = arrayList;
                    e2.q(re.a.c(rc.a.f42218n, aVar2, aVar2, arrayList2));
                    aVar2.f42224a.f42229g = arrayList2;
                }
                ...
                e2.q(re.a.c(rc.a.f42220s, aVar2, aVar2, new Integer(-1)));
                aVar2.f42224a.f42231j = -1;
                e2.q(re.a.c(rc.a.v, aVar2, aVar2, new Integer(-1)));
                aVar2.f42224a.f42232k = -1;
                e2.q(re.a.c(rc.a.f42219r, aVar2, aVar2, new Integer(-1)));
                aVar2.f42224a.f42230i = -1;
                e2.q(re.a.c(rc.a.f42215b, aVar2, aVar2, new Integer(1)));
                aVar2.f42224a.f42225a = 1;
                e2.q(re.a.c(rc.a.f42217f, aVar2, aVar2, new Integer(3)));
                aVar2.f42224a.e = 3;
                e2.q(re.a.c(rc.a.d, aVar2, aVar2, new Integer(0)));
                aVar2.f42224a.f42227c = 0;
                cVar.a(aVar2);
        ...
        obj4.f14791i = this.timeScale;
        ?? obj5 = new Object();
        obj5.e = 2;
        obj5.f14763f = samplingFrequencyIndexMap.get(Integer.valueOf((int) aVar3.f9421r)).intValue();
        obj5.h = aVar3.h;
        obj4.f14792j = obj5;
        obj2.f14802m = obj4;
        ...
        allocate.put((byte) (((obj2.e << 7) | (obj2.f14796f << 6) | (obj2.f14797g << 5) | (31 & obj2.h)) & 255));
        if (obj2.e > 0) {
            e5.b.p(obj2.f14800k, allocate);
        }
        if (obj2.f14796f > 0) {
            allocate.put((byte) (obj2.f14798i & 255));
            allocate.put(e5.b.b(obj2.f14799j));
            allocate.put((byte) 0);
        }
        if (obj2.f14797g > 0) {
            e5.b.p(obj2.f14801l, allocate);
        }
        mc.d dVar = obj2.f14802m;
        mc.a aVar5 = dVar.f14792j;
        if (aVar5 == null) {
            i12 = 0;
        } else if (aVar5.e == 2) {
            i12 = 4;
        ...
        allocate2.put((byte) (((dVar.e << 2) | (dVar.f14789f << 1) | 1) & 255));
        e5.b.q(dVar.f14790g, allocate2);
        allocate2.putInt((int) dVar.h);
        allocate2.putInt((int) dVar.f14791i);
        mc.a aVar7 = dVar.f14792j;
        if (aVar7 != null) {
            if (aVar7.e == 2) {
