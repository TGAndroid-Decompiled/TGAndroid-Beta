...
public class Track {
    ...
    public Track(int i10, MediaFormat mediaFormat, boolean z10) {
        ...
        if (!z10) {
            ...
            if (string.equals("video/avc")) {
                ...
                if (mediaFormat.getByteBuffer("csd-0") != null) {
                    ...
                    aVar2.f45116a.f45121f = arrayList;
                    e2.q(re.a.c(rc.a.f45110n, aVar2, aVar2, arrayList2));
                    aVar2.f45116a.f45122g = arrayList2;
                }
                ...
                e2.q(re.a.c(rc.a.f45112s, aVar2, aVar2, new Integer(-1)));
                aVar2.f45116a.f45124j = -1;
                e2.q(re.a.c(rc.a.v, aVar2, aVar2, new Integer(-1)));
                aVar2.f45116a.f45125k = -1;
                e2.q(re.a.c(rc.a.f45111r, aVar2, aVar2, new Integer(-1)));
                aVar2.f45116a.f45123i = -1;
                e2.q(re.a.c(rc.a.f45106b, aVar2, aVar2, new Integer(1)));
                aVar2.f45116a.f45117a = 1;
                e2.q(re.a.c(rc.a.f45109f, aVar2, aVar2, new Integer(3)));
                aVar2.f45116a.f45120e = 3;
                e2.q(re.a.c(rc.a.d, aVar2, aVar2, new Integer(0)));
                aVar2.f45116a.f45119c = 0;
                cVar.a(aVar2);
                ...
                try {
                    ...
                    parseFromCsd.f10406n = this.height;
        ...
        aVar3.f10405r = mediaFormat.getInteger("sample-rate");
        aVar3.f10403f = 1;
        aVar3.f10404n = 16;
        ?? aVar4 = new com.googlecode.mp4parser.a("esds");
        ?? obj2 = new Object();
        obj2.f16210i = 0;
        obj2.f16216o = new ArrayList();
        obj2.d = 0;
        ?? obj3 = new Object();
        obj3.d = 2;
        obj2.f16215n = obj3;
        ...
        obj4.f16202i = this.timeScale;
        ?? obj5 = new Object();
        obj5.f16172e = 2;
        obj5.f16173f = samplingFrequencyIndexMap.get(Integer.valueOf((int) aVar3.f10405r)).intValue();
        obj5.h = aVar3.h;
        obj4.f16203j = obj5;
        obj2.f16214m = obj4;
        ...
        allocate.put((byte) (((obj2.f16207e << 7) | (obj2.f16208f << 6) | (obj2.f16209g << 5) | (31 & obj2.h)) & 255));
        if (obj2.f16207e > 0) {
            e5.b.p(obj2.f16212k, allocate);
        }
        if (obj2.f16208f > 0) {
            allocate.put((byte) (obj2.f16210i & 255));
            allocate.put(e5.b.b(obj2.f16211j));
            allocate.put((byte) 0);
        }
        if (obj2.f16209g > 0) {
            e5.b.p(obj2.f16213l, allocate);
        }
        mc.d dVar = obj2.f16214m;
        mc.a aVar5 = dVar.f16203j;
        if (aVar5 == null) {
            i12 = 0;
        } else if (aVar5.f16172e == 2) {
            i12 = 4;
        } else {
        ...
        allocate2.put((byte) (((dVar.f16199e << 2) | (dVar.f16200f << 1) | 1) & 255));
        e5.b.q(dVar.f16201g, allocate2);
        allocate2.putInt((int) dVar.h);
        allocate2.putInt((int) dVar.f16202i);
        mc.a aVar7 = dVar.f16203j;
        if (aVar7 != null) {
            if (aVar7.f16172e == 2) {
                ...
                if (aVar7.f16172e == 2) {
                    ...
                    cVar3.c(aVar7.f16172e, 5);
                    cVar3.c(aVar7.f16173f, 4);
                    if (aVar7.f16173f != 15) {
                        cVar3.c(aVar7.h, 4);
