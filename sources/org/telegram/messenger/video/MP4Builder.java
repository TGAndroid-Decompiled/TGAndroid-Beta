...
public class MP4Builder {
    ...
    private FileChannel f20308fc = null;
    ...
    private void flushCurrentMdat() {
        long position = this.f20308fc.position();
        this.f20308fc.position(this.mdat.getOffset());
        this.mdat.getBox(this.f20308fc);
        this.f20308fc.position(position);
    ...
    public void createCtts(Track track, s2.p pVar) {
        ...
        aVar.f46889e = Collections.EMPTY_LIST;
        yh.x(de.a.c(s2.e.f46888f, aVar, aVar, arrayList));
        aVar.f46889e = arrayList;
        pVar.a(aVar);
    }
    ...
    public MP4Builder createMovie(Mp4Movie mp4Movie, boolean z4, boolean z10) {
        ...
        this.f20308fc = fileOutputStream.getChannel();
        s2.i createFileTypeBox = createFileTypeBox(z10);
        createFileTypeBox.getBox(this.f20308fc);
    ...
    public void createStco(Track track, s2.p pVar) {
        ...
        aVar.f46934f = new long[0];
        yh.x(de.a.c(t.f46933n, aVar, aVar, jArr));
        aVar.f46934f = jArr;
        pVar.a(aVar);
    }
    ...
    public void createStsc(Track track, s2.p pVar) {
        ...
        aVar.f46930e = Collections.EMPTY_LIST;
        LinkedList linkedList = new LinkedList();
        yh.x(de.a.c(s2.r.h, aVar, aVar, linkedList));
        aVar.f46930e = linkedList;
        ...
        for (int i13 = 0; i13 < size; i13++) {
            ...
            if (i13 == size - 1 || size2 != track.getSamples().get(i13 + 1).getOffset()) {
                if (i10 != i11) {
                    yh.x(de.a.b(s2.r.f46928f, aVar, aVar));
                    aVar.f46930e.add(new s2.q(i12, i11, 1L));
                    i10 = i11;
                }
                i12++;
                i11 = 0;
    ...
    public void createStsz(Track track, s2.p pVar) {
        ...
        aVar.f46924f = new long[0];
        long[] jArr = this.track2SampleSizes.get(track);
        yh.x(de.a.c(s2.o.f46922s, aVar, aVar, jArr));
        aVar.f46924f = jArr;
        pVar.a(aVar);
    }
    ...
    public void createStts(Track track, s2.p pVar) {
        ...
        aVar.f46940e = Collections.EMPTY_LIST;
        yh.x(de.a.c(w.f46939f, aVar, aVar, arrayList));
        aVar.f46940e = arrayList;
        pVar.a(aVar);
    }
    ...
    public x createTrackBox(Track track, Mp4Movie mp4Movie) {
        ...
        cc.d dVar = cc.d.f2448j;
        aVar.f46946w = dVar;
        sf.f c3 = de.a.c(y.W, aVar, aVar, new Boolean(true));
        com.googlecode.mp4parser.g.a().getClass();
        com.googlecode.mp4parser.g.b(c3);
        aVar.g(aVar.d() | 1);
        sf.f c10 = de.a.c(y.X, aVar, aVar, new Boolean(true));
        com.googlecode.mp4parser.g.a().getClass();
        com.googlecode.mp4parser.g.b(c10);
        aVar.g(aVar.d() | 2);
        sf.f c11 = de.a.c(y.Y, aVar, aVar, new Boolean(true));
        com.googlecode.mp4parser.g.a().getClass();
        ...
        yh.x(de.a.c(s2.j.f46897x, aVar3, aVar3, str));
        aVar3.f46900f = str;
        String handler = track.getHandler();
        yh.x(de.a.c(s2.j.f46898y, aVar3, aVar3, handler));
        aVar3.f46899e = handler;
        hVar.a(aVar3);
    ...
    public void finishMovie() {
        ...
        createMovieBox(this.currentMp4Movie).getBox(this.f20308fc);
        this.fos.flush();
        if (this.allowSyncFiles) {
            this.fos.getFD().sync();
        }
    ...
    public long writeSampleData(int i10, ByteBuffer byteBuffer, MediaCodec.BufferInfo bufferInfo, boolean z4) {
        ...
        if (z4) {
            ...
            this.sizeBuffer.position(0);
            this.f20308fc.write(this.sizeBuffer);
            byteBuffer.position(bufferInfo.offset + 4);
        } else {
            byteBuffer.position(bufferInfo.offset);
        }
        byteBuffer.limit(bufferInfo.offset + bufferInfo.size);
        this.f20308fc.write(byteBuffer);
