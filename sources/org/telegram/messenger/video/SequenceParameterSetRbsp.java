...
public class SequenceParameterSetRbsp {
    ...
    public SequenceParameterSetRbsp(InputStream inputStream) {
        ...
        obj.f44054e = b0Var;
        obj.f44051a = inputStream;
        obj.f44052b = inputStream.read();
        obj.f44053c = inputStream.read();
    ...
    private void profile_tier_level(int i10, pc.a aVar) {
        ...
        InputStream inputStream = aVar.f44051a;
        ...
        if (aVar.d > 0) {
            aVar.f44052b = aVar.f44053c;
            aVar.f44053c = inputStream.read();
            aVar.d = 0;
        }
