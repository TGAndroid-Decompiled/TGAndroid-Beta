...
public class SequenceParameterSetRbsp {
    ...
    public SequenceParameterSetRbsp(InputStream inputStream) {
        ...
        obj.e = b0Var;
        obj.f41019a = inputStream;
        obj.f41020b = inputStream.read();
        obj.f41021c = inputStream.read();
    ...
    private void profile_tier_level(int i10, pc.a aVar) {
        ...
        InputStream inputStream = aVar.f41019a;
        ...
        if (aVar.d > 0) {
            aVar.f41020b = aVar.f41021c;
            aVar.f41021c = inputStream.read();
            aVar.d = 0;
        }
        int i12 = aVar.f41020b;
        aVar.f41020b = aVar.f41021c;
        aVar.f41021c = inputStream.read();
        aVar.d = 0;
