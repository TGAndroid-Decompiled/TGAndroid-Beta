...
public class SequenceParameterSetRbsp {
    ...
    public SequenceParameterSetRbsp(InputStream inputStream) {
        ...
        b0Var.f3847c = new char[50];
        obj.e = b0Var;
        obj.f41007a = inputStream;
        obj.f41008b = inputStream.read();
        obj.f41009c = inputStream.read();
    ...
    private void profile_tier_level(int i10, pc.a aVar) {
        ...
        InputStream inputStream = aVar.f41007a;
        ...
        if (aVar.d > 0) {
            aVar.f41008b = aVar.f41009c;
            aVar.f41009c = inputStream.read();
            aVar.d = 0;
        }
        int i12 = aVar.f41008b;
        aVar.f41008b = aVar.f41009c;
        aVar.f41009c = inputStream.read();
        aVar.d = 0;
