...
public class SequenceParameterSetRbsp {
    ...
    public SequenceParameterSetRbsp(InputStream inputStream) {
        ...
        obj.e = b0Var;
        obj.f40774a = inputStream;
        obj.f40775b = inputStream.read();
        obj.f40776c = inputStream.read();
    ...
    private void profile_tier_level(int i10, pc.a aVar) {
        ...
        InputStream inputStream = aVar.f40774a;
        ...
        if (aVar.d > 0) {
            aVar.f40775b = aVar.f40776c;
            aVar.f40776c = inputStream.read();
            aVar.d = 0;
        }
        int i12 = aVar.f40775b;
        aVar.f40775b = aVar.f40776c;
        aVar.f40776c = inputStream.read();
        aVar.d = 0;
