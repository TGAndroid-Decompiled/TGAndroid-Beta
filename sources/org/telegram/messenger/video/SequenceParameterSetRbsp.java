...
public class SequenceParameterSetRbsp {
    ...
    public SequenceParameterSetRbsp(InputStream inputStream) {
        ...
        b0Var.f3842c = new char[50];
        obj.e = b0Var;
        obj.f40752a = inputStream;
        obj.f40753b = inputStream.read();
        obj.f40754c = inputStream.read();
    ...
    private void profile_tier_level(int i10, pc.a aVar) {
        ...
        InputStream inputStream = aVar.f40752a;
        ...
        if (aVar.d > 0) {
            aVar.f40753b = aVar.f40754c;
            aVar.f40754c = inputStream.read();
            aVar.d = 0;
        }
        int i12 = aVar.f40753b;
        aVar.f40753b = aVar.f40754c;
        aVar.f40754c = inputStream.read();
        aVar.d = 0;
