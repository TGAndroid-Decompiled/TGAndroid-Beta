...
public class SequenceParameterSetRbsp {
    ...
    public SequenceParameterSetRbsp(InputStream inputStream) {
        ...
        b0Var.f3839c = new char[50];
        obj.e = b0Var;
        obj.f41018a = inputStream;
        obj.f41019b = inputStream.read();
        obj.f41020c = inputStream.read();
    ...
    private void profile_tier_level(int i10, pc.a aVar) {
        ...
        InputStream inputStream = aVar.f41018a;
        ...
        if (aVar.d > 0) {
            aVar.f41019b = aVar.f41020c;
            aVar.f41020c = inputStream.read();
            aVar.d = 0;
        }
        int i12 = aVar.f41019b;
        aVar.f41019b = aVar.f41020c;
        aVar.f41020c = inputStream.read();
        aVar.d = 0;
