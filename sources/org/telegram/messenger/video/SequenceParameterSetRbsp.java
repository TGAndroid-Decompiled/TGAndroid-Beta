...
public class SequenceParameterSetRbsp {
    ...
    public SequenceParameterSetRbsp(InputStream inputStream) {
        ...
        obj.e = b0Var;
        obj.f41020a = inputStream;
        obj.f41021b = inputStream.read();
        obj.f41022c = inputStream.read();
    ...
    private void profile_tier_level(int i10, pc.a aVar) {
        ...
        InputStream inputStream = aVar.f41020a;
        ...
        if (aVar.d > 0) {
            aVar.f41021b = aVar.f41022c;
            aVar.f41022c = inputStream.read();
            aVar.d = 0;
        }
        int i12 = aVar.f41021b;
        aVar.f41021b = aVar.f41022c;
        aVar.f41022c = inputStream.read();
        aVar.d = 0;
