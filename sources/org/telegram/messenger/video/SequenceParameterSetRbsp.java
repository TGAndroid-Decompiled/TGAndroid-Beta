...
public class SequenceParameterSetRbsp {
    ...
    public SequenceParameterSetRbsp(InputStream inputStream) {
        ...
        a0Var.f3845c = new char[50];
        obj.e = a0Var;
        obj.f41068a = inputStream;
        obj.f41069b = inputStream.read();
        obj.f41070c = inputStream.read();
    ...
    private void profile_tier_level(int i10, pc.a aVar) {
        ...
        InputStream inputStream = aVar.f41068a;
        ...
        if (aVar.d > 0) {
            aVar.f41069b = aVar.f41070c;
            aVar.f41070c = inputStream.read();
            aVar.d = 0;
        }
        int i12 = aVar.f41069b;
        aVar.f41069b = aVar.f41070c;
        aVar.f41070c = inputStream.read();
        aVar.d = 0;
