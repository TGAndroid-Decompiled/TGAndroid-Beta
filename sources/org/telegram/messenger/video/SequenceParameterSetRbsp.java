...
public class SequenceParameterSetRbsp {
    ...
    public SequenceParameterSetRbsp(InputStream inputStream) {
        ...
        obj.e = b0Var;
        obj.f40779a = inputStream;
        obj.f40780b = inputStream.read();
        obj.f40781c = inputStream.read();
    ...
    private void profile_tier_level(int i10, pc.a aVar) {
        ...
        InputStream inputStream = aVar.f40779a;
        ...
        if (aVar.d > 0) {
            aVar.f40780b = aVar.f40781c;
            aVar.f40781c = inputStream.read();
            aVar.d = 0;
        }
        int i12 = aVar.f40780b;
        aVar.f40780b = aVar.f40781c;
        aVar.f40781c = inputStream.read();
        aVar.d = 0;
