...
public class SequenceParameterSetRbsp {
    ...
    public SequenceParameterSetRbsp(InputStream inputStream) {
        ...
        obj.e = b0Var;
        obj.f41005a = inputStream;
        obj.f41006b = inputStream.read();
        obj.f41007c = inputStream.read();
    ...
    private void profile_tier_level(int i10, pc.a aVar) {
        ...
        InputStream inputStream = aVar.f41005a;
        ...
        if (aVar.d > 0) {
            aVar.f41006b = aVar.f41007c;
            aVar.f41007c = inputStream.read();
            aVar.d = 0;
        }
        int i12 = aVar.f41006b;
        aVar.f41006b = aVar.f41007c;
        aVar.f41007c = inputStream.read();
        aVar.d = 0;
