...
public class SequenceParameterSetRbsp {
    ...
    public SequenceParameterSetRbsp(InputStream inputStream) {
        ...
        b0Var.f3848c = new char[50];
        obj.e = b0Var;
        obj.f41048a = inputStream;
        obj.f41049b = inputStream.read();
        obj.f41050c = inputStream.read();
    ...
    private void profile_tier_level(int i10, pc.a aVar) {
        ...
        InputStream inputStream = aVar.f41048a;
        ...
        if (aVar.d > 0) {
            aVar.f41049b = aVar.f41050c;
            aVar.f41050c = inputStream.read();
            aVar.d = 0;
        }
