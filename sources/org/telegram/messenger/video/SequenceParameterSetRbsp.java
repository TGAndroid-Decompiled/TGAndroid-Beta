...
public class SequenceParameterSetRbsp {
    ...
    public SequenceParameterSetRbsp(InputStream inputStream) {
        ...
        b0Var.f4261c = new char[50];
        obj.e = b0Var;
        obj.f39878a = inputStream;
        obj.f39879b = inputStream.read();
        obj.f39880c = inputStream.read();
        ...
        int e7 = obj.e("log2_max_pic_order_cnt_lsb_minus4");
        ...
        if (obj.b("long_term_ref_pics_present_flag")) {
            ...
            for (int i13 = 0; i13 < e10; i13++) {
                iArr4[i13] = (int) obj.d(e7 + 4, "lt_ref_pic_poc_lsb_sps[" + i13 + "]");
    ...
    private void profile_tier_level(int i10, pc.a aVar) {
        ...
        InputStream inputStream = aVar.f39878a;
        ...
        if (aVar.d > 0) {
            aVar.f39879b = aVar.f39880c;
            aVar.f39880c = inputStream.read();
            aVar.d = 0;
        }
        int i12 = aVar.f39879b;
        aVar.f39879b = aVar.f39880c;
        aVar.f39880c = inputStream.read();
        aVar.d = 0;
