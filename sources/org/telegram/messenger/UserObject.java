...
public class UserObject {
    ...
    public static boolean isAnonymous(TLRPC.User user) {
        if (user != null && user.f18483id == 2666000) {
            return true;
        }
        return false;
    }
    ...
    public static boolean areGiftsDisabled(TLRPC.UserFull userFull) {
        ...
        return (userFull == null || userFull.f18484id != UserConfig.getInstance(UserConfig.selectedAccount).getClientUserId()) && userFull != null && (disallowedGiftsSettings = userFull.disallowed_stargifts) != null && disallowedGiftsSettings.disallow_limited_stargifts && disallowedGiftsSettings.disallow_unlimited_stargifts && disallowedGiftsSettings.disallow_unique_stargifts && disallowedGiftsSettings.disallow_premium_gifts;
    }
