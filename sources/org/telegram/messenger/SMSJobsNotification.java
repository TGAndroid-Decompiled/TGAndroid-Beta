...
public class SMSJobsNotification extends Service {
    ...
    public static boolean check(int i) {
        ...
        z2 = (sMSJobsNotificationArr[i] == null || !sMSJobsNotificationArr[i].shown) ? false : false;
        if (z2 != z) {
            if (z) {
                service[i] = new Intent(ApplicationLoader.applicationContext, SMSJobsNotification.class);
    ...
    public int onStartCommand(Intent intent, int i, int i2) {
        ...
        if (this.builder == null) {
            ...
            this.builder.setContentIntent(PendingIntent.getActivity(getApplicationContext(), 0, intent2, ConnectionsManager.FileTypeFile));
        }
        this.builder.setContentTitle(LocaleController.getString((int) R.string.SmsNotificationTitle));
        ...
        this.builder.setContentText(LocaleController.formatString(R.string.SmsNotificationSubtitle, Integer.valueOf(i3), Integer.valueOf(i4)));
    ...
    public void update() {
        ...
        if (builder != null) {
            builder.setContentTitle(LocaleController.getString((int) R.string.SmsNotificationTitle));
            TL_smsjobs$TL_smsjobs_status tL_smsjobs$TL_smsjobs_status = SMSJobController.getInstance(this.currentAccount).currentStatus;
            ...
            this.builder.setContentText(LocaleController.formatString(R.string.SmsNotificationSubtitle, Integer.valueOf(i), Integer.valueOf(i2)));
