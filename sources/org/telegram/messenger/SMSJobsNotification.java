...
public class SMSJobsNotification extends Service {
    ...
    public int onStartCommand(Intent intent, int i, int i2) {
        ...
        this.builder.setContentTitle(LocaleController.getString(2131695994));
        ...
        this.builder.setContentText(LocaleController.formatString(2131695993, Integer.valueOf(i3), Integer.valueOf(i4)));
    ...
    public void update() {
        ...
        if (builder != null) {
            builder.setContentTitle(LocaleController.getString(2131695994));
            TL_smsjobs$TL_smsjobs_status tL_smsjobs$TL_smsjobs_status = SMSJobController.getInstance(this.currentAccount).currentStatus;
            ...
            this.builder.setContentText(LocaleController.formatString(2131695993, Integer.valueOf(i), Integer.valueOf(i2)));
