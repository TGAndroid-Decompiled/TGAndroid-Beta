...
public class SecretChatHelper extends BaseController {
    ...
    private TLRPC.Message createDeleteMessage(int i10, int i11, int i12, long j3, TLRPC.EncryptedChat encryptedChat) {
        ...
        tL_messageService.f18317id = i10;
        ...
        tL_messageService.dialog_id = DialogObject.makeEncryptedDialogId(encryptedChat.f18304id);
    ...
    public void lambda$acceptSecretChat$22(TLRPC.EncryptedChat encryptedChat, TLObject tLObject, TLRPC.TL_error tL_error) {
        this.acceptingChats.remove(encryptedChat.f18304id);
        if (tL_error == null) {
        ...
        if (tL_error == null) {
            ...
            if (tLObject instanceof TLRPC.TL_messages_dhConfig) {
                if (!Utilities.isGoodPrime(messages_dhconfig.f18451p, messages_dhconfig.f18450g)) {
                    this.acceptingChats.remove(encryptedChat.f18304id);
                    declineSecretChat(encryptedChat.f18304id, false);
                    return;
                }
                getMessagesStorage().setSecretPBytes(messages_dhconfig.f18451p);
                getMessagesStorage().setSecretG(messages_dhconfig.f18450g);
            ...
            if (byteArray2.length > 256) {
                ...
                tL_inputEncryptedChat.chat_id = encryptedChat.f18304id;
            ...
            tL_inputEncryptedChat2.chat_id = encryptedChat.f18304id;
    ...
    public void lambda$performSendEncryptedRequest$4(TLRPC.Message message, int i10) {
        ...
        Integer valueOf = Integer.valueOf(message.f18317id);
        Integer valueOf2 = Integer.valueOf(message.f18317id);
        ...
        getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.messageReceivedByServer2, Integer.valueOf(message.f18317id), Integer.valueOf(message.f18317id), message, Long.valueOf(message.dialog_id), 0L, Integer.valueOf(i10), bool);
        getSendMessagesHelper().processSentMessage(message.f18317id);
        getSendMessagesHelper().removeFromSendingMessages(message.f18317id, false);
    }
    ...
    public void lambda$performSendEncryptedRequest$5(TLRPC.Message message, TLRPC.messages_SentEncryptedMessage messages_sentencryptedmessage, int i10) {
        ...
        getMessagesStorage().updateMessageStateAndId(message.random_id, 0L, Integer.valueOf(message.f18317id), message.f18317id, messages_sentencryptedmessage.date, false, 0, 0);
    ...
    public void lambda$performSendEncryptedRequest$7(TLRPC.DecryptedMessage decryptedMessage, TLRPC.EncryptedChat encryptedChat, TLRPC.Message message, MessageObject messageObject, String str, TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        if (tL_error == null && (decryptedMessage.action instanceof TLRPC.TL_decryptedMessageActionNotifyLayer)) {
            TLRPC.EncryptedChat encryptedChat3 = getMessagesController().getEncryptedChat(Integer.valueOf(encryptedChat.f18304id));
            ...
            this.sendingNotifyLayer.remove(Integer.valueOf(encryptedChat2.f18304id));
    ...
    public void lambda$performSendEncryptedRequest$8(TLRPC.EncryptedChat encryptedChat, TLRPC.DecryptedMessage decryptedMessage, TLRPC.Message message, TLRPC.InputEncryptedFile inputEncryptedFile, MessageObject messageObject, String str) {
        ...
        try {
            ...
            if (i12 == 0 && message.seq_out == 0) {
                ...
                getMessagesStorage().setMessageSeq(message.f18317id, message.seq_in, message.seq_out);
            } else {
            ...
            if (inputEncryptedFile == null) {
                ...
                tL_inputEncryptedChat3.chat_id = encryptedChat.f18304id;
    ...
    public void lambda$processDecryptedObject$12(long j3) {
        ...
        if (dialog != null) {
            ...
            getMessagesController().dialogMessage.l(dialog.f18300id);
        }
    ...
    public void lambda$processUpdateEncryption$1(TLRPC.Dialog dialog, long j3) {
        ...
        getMessagesController().dialogs_dict.k(dialog, dialog.f18300id);
    ...
    public void lambda$resendMessages$15(long j3, TLRPC.EncryptedChat encryptedChat, long j10) {
        ...
        try {
            ...
            if (j11 <= j10) {
                ...
                int i12 = encryptedChat3.f18304id;
                ?? r13 = 0;
                ...
                long makeEncryptedDialogId = DialogObject.makeEncryptedDialogId(encryptedChat3.f18304id);
                ...
                Collections.sort(arrayList3, new ci(1));
                ArrayList<TLRPC.EncryptedChat> arrayList4 = new ArrayList<>();
                arrayList4.add(encryptedChat2);
                try {
                    AndroidUtilities.runOnUIThread(new ii(this, arrayList3, 0));
                    ...
                    int i14 = encryptedChat2.f18304id;
    ...
    public void lambda$startSecretChat$26(Context context, org.telegram.ui.ActionBar.b2 b2Var, TLObject tLObject, byte[] bArr, TLRPC.User user) {
        ...
        tL_dialog.f18300id = DialogObject.makeEncryptedDialogId(encryptedChat.f18304id);
        tL_dialog.unread_count = 0;
        tL_dialog.top_message = 0;
        tL_dialog.last_message_date = getConnectionsManager().getCurrentTime();
        getMessagesController().dialogs_dict.k(tL_dialog, tL_dialog.f18300id);
    ...
    public void lambda$startSecretChat$27(Context context, org.telegram.ui.ActionBar.b2 b2Var) {
        if (!((Activity) context).isFinishing()) {
            ...
            alertDialog$Builder.f18622a.T = LocaleController.getString(R.string.CreateEncryptedChatError);
    ...
    private void updateMediaPaths(MessageObject messageObject, TLRPC.EncryptedFile encryptedFile, TLRPC.DecryptedMessage decryptedMessage, String str) {
        ...
        if (encryptedFile != null) {
            ...
            if ((messageMedia instanceof TLRPC.TL_messageMediaPhoto) && (photo = messageMedia.photo) != null) {
                ...
                tL_fileEncryptedLocation.volume_id = encryptedFile.f18305id;
                ...
                document2.f18302id = encryptedFile.f18305id;
    ...
    public void acceptSecretChat(TLRPC.EncryptedChat encryptedChat) {
        if (this.acceptingChats.get(encryptedChat.f18304id) != null) {
            return;
        }
        this.acceptingChats.put(encryptedChat.f18304id, encryptedChat);
    ...
    public void checkSecretHoles(TLRPC.EncryptedChat encryptedChat, ArrayList<TLRPC.Message> arrayList) {
        ...
        int i10;
        int i11;
        ArrayList<TL_decryptedMessageHolder> arrayList2 = this.secretHolesQueue.get(encryptedChat.f18304id);
        if (arrayList2 != null) {
            ...
            TLRPC.EncryptedChat encryptedChat3 = encryptedChat;
            if (arrayList2.isEmpty()) {
                this.secretHolesQueue.remove(encryptedChat3.f18304id);
            }
            if (z10) {
    ...
    public void processUpdateEncryption(TL_update.TL_updateEncryption tL_updateEncryption, ConcurrentHashMap<Long, TLRPC.User> concurrentHashMap) {
        ...
        long makeEncryptedDialogId = DialogObject.makeEncryptedDialogId(encryptedChat.f18304id);
        TLRPC.EncryptedChat encryptedChatDB = getMessagesController().getEncryptedChatDB(encryptedChat.f18304id, false);
        if ((encryptedChat instanceof TLRPC.TL_encryptedChatRequested) && encryptedChatDB == null) {
            ...
            TLRPC.TL_dialog tL_dialog = new TLRPC.TL_dialog();
            tL_dialog.f18300id = makeEncryptedDialogId;
    ...
    public void sendNotifyLayerMessage(TLRPC.EncryptedChat encryptedChat, TLRPC.Message message) {
        if (!(encryptedChat instanceof TLRPC.TL_encryptedChat) || this.sendingNotifyLayer.contains(Integer.valueOf(encryptedChat.f18304id))) {
            return;
        }
        this.sendingNotifyLayer.add(Integer.valueOf(encryptedChat.f18304id));
        TLRPC.TL_decryptedMessageService tL_decryptedMessageService = new TLRPC.TL_decryptedMessageService();
        if (message != null) {
            tL_decryptedMessageService.action = message.action.encryptedAction;
        } else {
    ...
    public void sendResendMessage(TLRPC.EncryptedChat encryptedChat, int i10, int i11, TLRPC.Message message) {
        if (encryptedChat instanceof TLRPC.TL_encryptedChat) {
            SparseIntArray sparseIntArray = this.requestedHoles.get(encryptedChat.f18304id);
            if (sparseIntArray != null && sparseIntArray.indexOfKey(i10) >= 0) {
                return;
            }
            if (sparseIntArray == null) {
                sparseIntArray = new SparseIntArray();
                this.requestedHoles.put(encryptedChat.f18304id, sparseIntArray);
            }
