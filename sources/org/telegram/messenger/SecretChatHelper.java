...
public class SecretChatHelper extends BaseController {
    ...
    private TLRPC.Message createDeleteMessage(int i10, int i11, int i12, long j3, TLRPC.EncryptedChat encryptedChat) {
        ...
        tL_messageService.f18342id = i10;
        ...
        tL_messageService.dialog_id = DialogObject.makeEncryptedDialogId(encryptedChat.f18329id);
    ...
    private TLRPC.TL_messageService createServiceSecretMessage(TLRPC.EncryptedChat encryptedChat, TLRPC.DecryptedMessageAction decryptedMessageAction) {
        ...
        tL_messageService.f18342id = newMessageId;
    ...
    public void lambda$acceptSecretChat$22(TLRPC.EncryptedChat encryptedChat, TLObject tLObject, TLRPC.TL_error tL_error) {
        this.acceptingChats.remove(encryptedChat.f18329id);
        if (tL_error == null) {
        ...
        if (tL_error == null) {
            ...
            if (tLObject instanceof TLRPC.TL_messages_dhConfig) {
                if (!Utilities.isGoodPrime(messages_dhconfig.f18476p, messages_dhconfig.f18475g)) {
                    this.acceptingChats.remove(encryptedChat.f18329id);
                    declineSecretChat(encryptedChat.f18329id, false);
                    return;
                }
                getMessagesStorage().setSecretPBytes(messages_dhconfig.f18476p);
                getMessagesStorage().setSecretG(messages_dhconfig.f18475g);
            ...
            if (byteArray2.length > 256) {
                ...
                tL_inputEncryptedChat.chat_id = encryptedChat.f18329id;
            ...
            tL_inputEncryptedChat2.chat_id = encryptedChat.f18329id;
    ...
    public void lambda$performSendEncryptedRequest$4(TLRPC.Message message, int i10) {
        ...
        Integer valueOf = Integer.valueOf(message.f18342id);
        Integer valueOf2 = Integer.valueOf(message.f18342id);
        ...
        getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.messageReceivedByServer2, Integer.valueOf(message.f18342id), Integer.valueOf(message.f18342id), message, Long.valueOf(message.dialog_id), 0L, Integer.valueOf(i10), bool);
        getSendMessagesHelper().processSentMessage(message.f18342id);
        getSendMessagesHelper().removeFromSendingMessages(message.f18342id, false);
    }
    ...
    public void lambda$performSendEncryptedRequest$5(TLRPC.Message message, TLRPC.messages_SentEncryptedMessage messages_sentencryptedmessage, int i10) {
        ...
        getMessagesStorage().updateMessageStateAndId(message.random_id, 0L, Integer.valueOf(message.f18342id), message.f18342id, messages_sentencryptedmessage.date, false, 0, 0);
    ...
    public void lambda$performSendEncryptedRequest$7(TLRPC.DecryptedMessage decryptedMessage, TLRPC.EncryptedChat encryptedChat, TLRPC.Message message, MessageObject messageObject, String str, TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        if (tL_error == null && (decryptedMessage.action instanceof TLRPC.TL_decryptedMessageActionNotifyLayer)) {
            TLRPC.EncryptedChat encryptedChat3 = getMessagesController().getEncryptedChat(Integer.valueOf(encryptedChat.f18329id));
            ...
            this.sendingNotifyLayer.remove(Integer.valueOf(encryptedChat2.f18329id));
    ...
    public void lambda$performSendEncryptedRequest$8(TLRPC.EncryptedChat encryptedChat, TLRPC.DecryptedMessage decryptedMessage, TLRPC.Message message, TLRPC.InputEncryptedFile inputEncryptedFile, MessageObject messageObject, String str) {
        ...
        try {
            ...
            if (i12 == 0 && message.seq_out == 0) {
                ...
                getMessagesStorage().setMessageSeq(message.f18342id, message.seq_in, message.seq_out);
            } else {
            ...
            if (inputEncryptedFile == null) {
                ...
                tL_inputEncryptedChat3.chat_id = encryptedChat.f18329id;
    ...
    public void lambda$processDecryptedObject$12(long j3) {
        ...
        if (dialog != null) {
            ...
            getMessagesController().dialogMessage.l(dialog.f18325id);
        }
    ...
    public void lambda$processUpdateEncryption$1(TLRPC.Dialog dialog, long j3) {
        ...
        getMessagesController().dialogs_dict.k(dialog, dialog.f18325id);
    ...
    public void lambda$resendMessages$15(long j3, TLRPC.EncryptedChat encryptedChat, long j10) {
        ...
        try {
            ...
            if (j11 <= j10) {
                ...
                int i12 = encryptedChat3.f18329id;
                ?? r13 = 0;
                ...
                long makeEncryptedDialogId = DialogObject.makeEncryptedDialogId(encryptedChat3.f18329id);
                ...
                try {
                    ...
                    int i14 = encryptedChat2.f18329id;
    ...
    public void lambda$startSecretChat$26(Context context, org.telegram.ui.ActionBar.a2 a2Var, TLObject tLObject, byte[] bArr, TLRPC.User user) {
        ...
        tL_dialog.f18325id = DialogObject.makeEncryptedDialogId(encryptedChat.f18329id);
        tL_dialog.unread_count = 0;
        tL_dialog.top_message = 0;
        tL_dialog.last_message_date = getConnectionsManager().getCurrentTime();
        getMessagesController().dialogs_dict.k(tL_dialog, tL_dialog.f18325id);
    ...
    public void lambda$startSecretChat$27(Context context, org.telegram.ui.ActionBar.a2 a2Var) {
        if (!((Activity) context).isFinishing()) {
            ...
            alertDialog$Builder.f18647a.T = LocaleController.getString(R.string.CreateEncryptedChatError);
    ...
    private void updateMediaPaths(MessageObject messageObject, TLRPC.EncryptedFile encryptedFile, TLRPC.DecryptedMessage decryptedMessage, String str) {
        ...
        if (encryptedFile != null) {
            ...
            if ((messageMedia instanceof TLRPC.TL_messageMediaPhoto) && (photo = messageMedia.photo) != null) {
                ...
                tL_fileEncryptedLocation.volume_id = encryptedFile.f18330id;
                ...
                document2.f18327id = encryptedFile.f18330id;
    ...
    public void acceptSecretChat(TLRPC.EncryptedChat encryptedChat) {
        if (this.acceptingChats.get(encryptedChat.f18329id) != null) {
            return;
        }
        this.acceptingChats.put(encryptedChat.f18329id, encryptedChat);
    ...
    public void checkSecretHoles(TLRPC.EncryptedChat encryptedChat, ArrayList<TLRPC.Message> arrayList) {
        ...
        int i10;
        int i11;
        ArrayList<TL_decryptedMessageHolder> arrayList2 = this.secretHolesQueue.get(encryptedChat.f18329id);
        if (arrayList2 != null) {
            ...
            TLRPC.EncryptedChat encryptedChat3 = encryptedChat;
            if (arrayList2.isEmpty()) {
                this.secretHolesQueue.remove(encryptedChat3.f18329id);
            }
            if (z10) {
    ...
    public void processUpdateEncryption(TL_update.TL_updateEncryption tL_updateEncryption, ConcurrentHashMap<Long, TLRPC.User> concurrentHashMap) {
        ...
        long makeEncryptedDialogId = DialogObject.makeEncryptedDialogId(encryptedChat.f18329id);
        TLRPC.EncryptedChat encryptedChatDB = getMessagesController().getEncryptedChatDB(encryptedChat.f18329id, false);
        if ((encryptedChat instanceof TLRPC.TL_encryptedChatRequested) && encryptedChatDB == null) {
            ...
            TLRPC.TL_dialog tL_dialog = new TLRPC.TL_dialog();
            tL_dialog.f18325id = makeEncryptedDialogId;
    ...
    public void sendNotifyLayerMessage(TLRPC.EncryptedChat encryptedChat, TLRPC.Message message) {
        if (!(encryptedChat instanceof TLRPC.TL_encryptedChat) || this.sendingNotifyLayer.contains(Integer.valueOf(encryptedChat.f18329id))) {
            return;
        }
        this.sendingNotifyLayer.add(Integer.valueOf(encryptedChat.f18329id));
        TLRPC.TL_decryptedMessageService tL_decryptedMessageService = new TLRPC.TL_decryptedMessageService();
        if (message != null) {
            tL_decryptedMessageService.action = message.action.encryptedAction;
        } else {
    ...
    public void sendResendMessage(TLRPC.EncryptedChat encryptedChat, int i10, int i11, TLRPC.Message message) {
        if (encryptedChat instanceof TLRPC.TL_encryptedChat) {
            SparseIntArray sparseIntArray = this.requestedHoles.get(encryptedChat.f18329id);
            if (sparseIntArray != null && sparseIntArray.indexOfKey(i10) >= 0) {
                return;
            }
            if (sparseIntArray == null) {
                sparseIntArray = new SparseIntArray();
                this.requestedHoles.put(encryptedChat.f18329id, sparseIntArray);
            }
