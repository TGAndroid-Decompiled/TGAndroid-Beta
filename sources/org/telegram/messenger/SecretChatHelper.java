...
public class SecretChatHelper extends BaseController {
    ...
    public void lambda$performSendEncryptedRequest$4(TLRPC.Message message, int i9) {
        message.send_state = 0;
        NotificationCenter notificationCenter = getNotificationCenter();
        int i10 = NotificationCenter.messageReceivedByServer;
        Integer valueOf = Integer.valueOf(message.f22401id);
        Integer valueOf2 = Integer.valueOf(message.f22401id);
        ...
        getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.messageReceivedByServer2, Integer.valueOf(message.f22401id), Integer.valueOf(message.f22401id), message, Long.valueOf(message.dialog_id), 0L, Integer.valueOf(i9), bool);
    ...
    public void lambda$performSendEncryptedRequest$5(TLRPC.Message message, TLRPC.messages_SentEncryptedMessage messages_sentencryptedmessage, int i9) {
    ...
    public void lambda$performSendEncryptedRequest$7(TLRPC.DecryptedMessage decryptedMessage, TLRPC.EncryptedChat encryptedChat, TLRPC.Message message, MessageObject messageObject, String str, TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        if (tL_error == null && (decryptedMessage.action instanceof TLRPC.TL_decryptedMessageActionNotifyLayer)) {
            TLRPC.EncryptedChat encryptedChat3 = getMessagesController().getEncryptedChat(Integer.valueOf(encryptedChat.f22388id));
            ...
            this.sendingNotifyLayer.remove(Integer.valueOf(encryptedChat2.f22388id));
    ...
    public void lambda$performSendEncryptedRequest$8(TLRPC.EncryptedChat encryptedChat, TLRPC.DecryptedMessage decryptedMessage, TLRPC.Message message, TLRPC.InputEncryptedFile inputEncryptedFile, MessageObject messageObject, String str) {
        ...
        try {
            ...
            int i11 = message.seq_in;
            if (i11 == 0 && message.seq_out == 0) {
                int i12 = encryptedChat.seq_in;
                if (i12 <= 0) {
                    i12 += 2;
                }
                tL_decryptedMessageLayer.in_seq_no = i12;
                int i13 = encryptedChat.seq_out;
                tL_decryptedMessageLayer.out_seq_no = i13;
                encryptedChat.seq_out = i13 + 2;
            ...
            int nextInt = ((Utilities.random.nextInt(3) + 2) * 16) + i9;
            ...
            System.arraycopy(Utilities.computeSHA256(bArr4, 88 + i10, 32, byteBuffer, 0, byteBuffer.limit()), 8, bArr3, 0, 16);
    ...
    public void lambda$resendMessages$15(int i9, TLRPC.EncryptedChat encryptedChat, int i10) {
        int i11;
        TLRPC.EncryptedChat encryptedChat2;
        int i12;
        ...
        try {
            if (encryptedChat3.admin_id == getUserConfig().getClientUserId() && i9 % 2 == 0) {
                i11 = i9 + 1;
            } else {
                i11 = i9;
            }
            ...
            int i13 = encryptedChat3.f22388id;
            ?? r10 = 0;
            SQLiteCursor queryFinalized = database.queryFinalized("SELECT uid FROM requested_holes WHERE uid = " + i13 + " AND ((seq_out_start >= " + i11 + " AND " + i11 + " <= seq_out_end) OR (seq_out_start >= " + i10 + " AND " + i10 + " <= seq_out_end))", new Object[0]);
            boolean next = queryFinalized.next();
            queryFinalized.dispose();
            if (next) {
                return;
            }
            long makeEncryptedDialogId = DialogObject.makeEncryptedDialogId(encryptedChat3.f22388id);
            SparseArray sparseArray = new SparseArray();
            ArrayList<TLRPC.Message> arrayList = new ArrayList<>();
            for (int i14 = i11; i14 <= i10; i14 += 2) {
                sparseArray.put(i14, null);
            }
            SQLiteDatabase database2 = getMessagesStorage().getDatabase();
            Locale locale2 = Locale.US;
            SQLiteCursor queryFinalized2 = database2.queryFinalized("SELECT m.data, r.random_id, s.seq_in, s.seq_out, m.ttl, s.mid FROM messages_seq as s LEFT JOIN randoms_v2 as r ON r.mid = s.mid LEFT JOIN messages_v2 as m ON m.mid = s.mid WHERE m.uid = " + makeEncryptedDialogId + " AND m.out = 1 AND s.seq_out >= " + i11 + " AND s.seq_out <= " + i10 + " ORDER BY seq_out ASC", new Object[0]);
            ...
            try {
                ...
                int i17 = encryptedChat2.f22388id;
                database3.executeFast("REPLACE INTO requested_holes VALUES(" + i17 + ", " + i15 + ", " + i10 + ")").stepThis().dispose();
            } catch (Exception e10) {
                e = e10;
                FileLog.e(e);
            }
    ...
    public void lambda$startSecretChat$31(int i9, DialogInterface dialogInterface) {
    ...
    public void processUpdateEncryption(TL_update.TL_updateEncryption tL_updateEncryption, ConcurrentHashMap<Long, TLRPC.User> concurrentHashMap) {
        ...
        long makeEncryptedDialogId = DialogObject.makeEncryptedDialogId(encryptedChat.f22388id);
        ...
        if ((encryptedChat instanceof TLRPC.TL_encryptedChatRequested) && encryptedChatDB == null) {
            ...
            TLRPC.TL_dialog tL_dialog = new TLRPC.TL_dialog();
            tL_dialog.f22384id = makeEncryptedDialogId;
