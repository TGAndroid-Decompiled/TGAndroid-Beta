...
public final class MessagesController$$ExternalSyntheticLambda201 implements Runnable {
    public final int $r8$classId;
    public final Consumer f$0;
    public final int f$1;

    public MessagesController$$ExternalSyntheticLambda201(Consumer consumer, int i, int i2) {
        this.$r8$classId = i2;
        this.f$0 = consumer;
        this.f$1 = i;
    }
