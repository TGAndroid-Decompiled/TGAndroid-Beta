...
public final class y7 implements Runnable {
    ...
    public final void run() {
        ...
        xi0 xi0Var;
        float f7;
        int i13 = this.f17950a;
        boolean z10 = this.f17951b;
        int i14 = this.d;
        int i15 = this.f17952c;
        Window window = null;
        Object obj = this.h;
        Object obj2 = this.f17953f;
        Object obj3 = this.e;
        switch (i13) {
            case 0:
                ((MediaDataController) obj3).lambda$toggleStickerSets$118(this.f17952c, (TLObject) obj2, (org.telegram.ui.ActionBar.n2) obj, this.f17951b, this.d);
                return;
            case 1:
                ((SendMessagesHelper) obj3).lambda$performSendMessageRequest$99(this.f17951b, (TLRPC.Message) obj2, this.f17952c, (ArrayList) obj, this.d);
                return;
            case 2:
                ArrayList arrayList = (ArrayList) obj2;
                ArrayList arrayList2 = (ArrayList) obj;
                bo boVar = ((org.telegram.ui.nl) obj3).f36002b;
                if (z10) {
            ...
            case 3:
                ...
                if (bitmap != null && !bitmap.isRecycled()) {
                    ...
                    AndroidUtilities.runOnUIThread(new ci.u1(maVar, str, createBitmap, this.f17951b, bitmap));
                    return;
                }
                return;
            default:
                ...
                ofFloat.start();
                int w03 = org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18780a7, false);
