...
public class DialogObject {
    ...
    public static void initDialog(TLRPC.Dialog dialog) {
        if (dialog != null && dialog.f18340id == 0) {
            if (dialog instanceof TLRPC.TL_dialog) {
                ...
                if (peer != null) {
                    ...
                    if (j10 != 0) {
                        ...
                        dialog.f18340id = -peer.channel_id;
                    }
                }
            } else if (dialog instanceof TLRPC.TL_dialogFolder) {
                dialog.f18340id = makeFolderDialogId(((TLRPC.TL_dialogFolder) dialog).folder.f18387id);
            } else if (dialog instanceof TLRPC.TL_dialogCommunity) {
                dialog.f18340id = -dialog.community_id;
            }
        }
    }
