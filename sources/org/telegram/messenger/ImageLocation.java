...
public class ImageLocation {
    ...
    public static ImageLocation getForStickerSet(TLRPC.StickerSet stickerSet) {
        ...
        if (stickerSet.access_hash != 0) {
            ...
            tL_inputStickerSetShortName.f22412id = stickerSet.f22419id;
    ...
    public String getKey(Object obj, Object obj2, boolean z10) {
        ...
        if (this.secureDocument != null) {
            return this.secureDocument.secureFile.dc_id + "_" + this.secureDocument.secureFile.f22527id;
        }
        ...
        if (!(photoSize instanceof TLRPC.TL_photoStrippedSize) && !(photoSize instanceof TLRPC.TL_photoPathSize)) {
            ...
            if (e2Var != null) {
                return Utilities.MD5(e2Var.f44022b);
            }
            ...
            if (document != null) {
                if (!z10 && (document instanceof DocumentObject.ThemeDocument)) {
                    ...
                    sb2.append("_");
                    sb2.append(this.document.f22398id);
                    sb2.append("_");
                    ...
                    sb2.append(i11);
                    return sb2.toString();
                } else if (document.f22398id != 0 && document.dc_id != 0) {
                    return this.document.dc_id + "_" + this.document.f22398id;
                } else {
                    return null;
                }
            }
        ...
        if (fileLocation != null) {
            ...
            if (fileLocation instanceof TLRPC.TL_fileLocationToBeDeprecated) {
                ...
                if (photo != null) {
                    ...
                    imageLocation.photoId = photo.f22416id;
                ...
                if (document != null) {
                    ...
                    imageLocation.documentId = document.f22398id;
                    imageLocation.thumbSize = str;
                }
                return imageLocation;
            }
