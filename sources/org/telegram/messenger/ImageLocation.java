...
public class ImageLocation {
    ...
    public static ImageLocation getForStickerSet(TLRPC.StickerSet stickerSet) {
        ...
        if (stickerSet.access_hash != 0) {
            ...
            tL_inputStickerSetShortName.f17215id = stickerSet.f17222id;
    ...
    public String getKey(Object obj, Object obj2, boolean z10) {
        ...
        if (this.secureDocument != null) {
            return this.secureDocument.secureFile.dc_id + "_" + this.secureDocument.secureFile.f17330id;
        }
        ...
        if (!(photoSize instanceof TLRPC.TL_photoStrippedSize) && !(photoSize instanceof TLRPC.TL_photoPathSize)) {
            ...
            if (j2Var != null) {
                return Utilities.MD5(j2Var.f37984b);
            }
            ...
            if (document != null) {
                if (!z10 && (document instanceof DocumentObject.ThemeDocument)) {
                    ...
                    sb2.append("_");
                    sb2.append(this.document.f17201id);
                    sb2.append("_");
                    ...
                    sb2.append(i11);
                    return sb2.toString();
                } else if (document.f17201id != 0 && document.dc_id != 0) {
                    return this.document.dc_id + "_" + this.document.f17201id;
                } else {
                    return null;
                }
            }
        ...
        if (fileLocation != null) {
            ...
            if (fileLocation instanceof TLRPC.TL_fileLocationToBeDeprecated) {
                ...
                if (photo != null) {
                    ...
                    imageLocation.photoId = photo.f17219id;
                ...
                if (document != null) {
                    ...
                    imageLocation.documentId = document.f17201id;
                    imageLocation.thumbSize = str;
                }
                return imageLocation;
            }
