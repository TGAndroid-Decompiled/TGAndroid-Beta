...
public final class MessagesController$$ExternalSyntheticLambda22 implements Runnable {
    ...
    public MessagesController$$ExternalSyntheticLambda22(MessagesController messagesController, long j, int i, long j2, ArrayList arrayList, int i2) {
        this.$r8$classId = i2;
    ...
    public MessagesController$$ExternalSyntheticLambda22(MessagesController messagesController, long j, long j2, int i, ArrayList arrayList, int i2) {
        this.$r8$classId = i2;
        this.f$0 = messagesController;
        this.f$1 = j;
        this.f$2 = j2;
