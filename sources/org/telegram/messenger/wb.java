...
public final class wb implements RequestDelegate {
    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        switch (this.f18011a) {
            case 0:
                this.f18012b.lambda$loadUnknownDialog$208(this.f18013c, this.d, tLObject, tL_error);
                return;
            default:
                this.f18012b.lambda$deleteMessages$124(this.f18013c, this.d, tLObject, tL_error);
                return;
        }
    }
}
