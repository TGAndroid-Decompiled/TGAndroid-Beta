    ...
    public final void run() {
        switch (this.f17164a) {
            ...
            default:
                ...
                if (!eVar.f46835o.get() && !atomicBoolean.get()) {
                    Bitmap.CompressFormat compressFormat = Bitmap.CompressFormat.WEBP;
                    if (Build.VERSION.SDK_INT <= 28) {
                        compressFormat = Bitmap.CompressFormat.PNG;
                    }
                    bitmapArr[i10].compress(compressFormat, eVar.f46832l, zVarArr[i10]);
                    int i12 = zVarArr[i10].f46907b;
                    try {
                        synchronized (eVar.h) {
                            yf.d dVar = new yf.d(i11);
                            dVar.f46819c = (int) randomAccessFile.length();
                            arrayList.add(dVar);
                            randomAccessFile.write(zVarArr[i10].f46906a, 0, i12);
                            dVar.f46818b = i12;
                            zVarArr[i10].b();
                        }
                    } catch (IOException e) {
