...
public final class sl implements Runnable {
    ...
    public final UnconfirmedAuthController.UnconfirmedAuth f17554b;
    ...
    public final void run() {
        switch (this.f17553a) {
            case 0:
                this.f17554b.lambda$confirm$1(this.d, this.f17555c, this.e);
                return;
            case 1:
                this.f17554b.lambda$deny$3(this.f17555c, this.d, this.e);
                return;
            default:
                this.f17554b.lambda$deny$5(this.d, this.f17555c, this.e);
                return;
        }
    }
