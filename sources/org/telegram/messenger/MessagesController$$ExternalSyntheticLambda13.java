...
public final class MessagesController$$ExternalSyntheticLambda13 implements Runnable {
    public final int $r8$classId;
    public final MessagesController f$0;
    public final ArrayList f$1;

    public MessagesController$$ExternalSyntheticLambda13(MessagesController messagesController, ArrayList arrayList, int i) {
        this.$r8$classId = i;
