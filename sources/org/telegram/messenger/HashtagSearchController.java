...
public class HashtagSearchController {
    ...
    public static final class MessageCompositeID {
        ...
        public MessageCompositeID(TLRPC.Message message) {
            this(MessageObject.getDialogId(message), message.f20864id);
        }
        ...
        public boolean equals(Object obj) {
            ...
            if (obj != null && MessageCompositeID.class == obj.getClass()) {
                ...
                if (this.dialog_id == messageCompositeID.dialog_id && this.f18047id == messageCompositeID.f18047id) {
                    return true;
                }
            }
            return false;
        ...
        public int hashCode() {
            return Objects.hash(Long.valueOf(this.dialog_id), Integer.valueOf(this.f18047id));
        }
    ...
    public void lambda$searchHashtag$1(int[] iArr, SearchResult searchResult, TLRPC.messages_Messages messages_messages, ArrayList arrayList, int i10, int i11, int i12) {
        ...
        if (iArr[0] == searchResult.reqId) {
            ...
            while (i13 < size) {
                ...
                message.realId = message.f20864id;
                message.f20864id = num.intValue();
            }
    ...
    public void jumpToMessage(int i10, int i11, int i12) {
        ...
        if (i11 >= 0 && i11 < searchResult.messages.size()) {
            ...
            NotificationCenter.getInstance(this.currentAccount).lambda$postNotificationNameOnUIThread$1(NotificationCenter.hashtagSearchUpdated, Integer.valueOf(i10), Integer.valueOf(searchResult.count), Boolean.valueOf(searchResult.endReached), Integer.valueOf(searchResult.getMask()), Integer.valueOf(searchResult.selectedIndex), Integer.valueOf(searchResult.messages.get(i11).messageOwner.f20864id));
        }
    }
        ...
        if (searchResult.lastHashtag != null || str != null) {
            if (str == null || !str.isEmpty()) {
                ...
                if (!TextUtils.isEmpty(str2) && (tLObject = MessagesController.getInstance(this.currentAccount).getUserOrChat(str2)) == null) {
                    Runnable resolve = MessagesController.getInstance(this.currentAccount).getUserNameResolver().resolve(str2, new h5.d() {
                        @Override
                ...
                if (i11 == 1) {
                    ...
                    tL_messages_searchGlobal.f20954q = str4;
                    ...
                    tL_messages_search.f20952q = str3;
