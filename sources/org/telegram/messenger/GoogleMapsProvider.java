    ...
    public static final class GoogleMapImpl implements IMapsProvider.IMap {
        ...
        public IMapsProvider.IMarker addMarker(IMapsProvider.IMarkerOptions iMarkerOptions) {
            ...
            try {
                ...
                i8.f fVar2 = cVar.f10124a;
                Parcel O0 = fVar2.O0();
                s7.b.b(O0, gVar);
                Parcel N0 = fVar2.N0(O0, 11);
                IBinder readStrongBinder = N0.readStrongBinder();
                int i10 = s7.j.f43158b;
                if (readStrongBinder == null) {
                    aVar = 0;
                } else {
        ...
        public IMapsProvider.IUISettings getUiSettings() {
            ...
            cVar2.getClass();
            try {
                if (cVar2.f10125b == null) {
                    i8.f fVar = cVar2.f10124a;
                    ...
                    N0.recycle();
                    cVar2.f10125b = new h8.h(cVar);
                }
                return new GoogleUISettings(cVar2.f10125b);
            } catch (RemoteException e) {
                throw new RuntimeException(e);
            }
        }
