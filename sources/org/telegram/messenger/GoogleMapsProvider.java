...
public class GoogleMapsProvider implements IMapsProvider {
    ...
    public static final class GoogleCircleOptions implements IMapsProvider.ICircleOptions {
        ...
        public IMapsProvider.ICircleOptions strokePattern(List<IMapsProvider.PatternItem> list) {
            ...
            this.circleOptions.f12913r = arrayList;
            return this;
        }

        @Override
        public IMapsProvider.ICircleOptions strokeWidth(int i10) {
            this.circleOptions.f12910c = i10;
            return this;
        }
    ...
    public static final class GoogleLatLngBounds implements IMapsProvider.ILatLngBounds {
        ...
        public IMapsProvider.LatLng getCenter() {
            ...
            LatLng latLng = latLngBounds.f7083a;
            double d = latLng.f7081a;
            LatLng latLng2 = latLngBounds.f7084b;
            double d10 = (d + latLng2.f7081a) / 2.0d;
            double d11 = latLng2.f7082b;
            double d12 = latLng.f7082b;
            if (d12 > d11) {
                d11 += 360.0d;
            }
            LatLng latLng3 = new LatLng(d10, (d11 + d12) / 2.0d);
            return new IMapsProvider.LatLng(latLng3.f7081a, latLng3.f7082b);
        }
    ...
    public static final class GoogleLatLngBoundsBuilder implements IMapsProvider.ILatLngBoundsBuilder {
        ...
        public IMapsProvider.ILatLngBounds build() {
            ...
            n6.l.j("no included points", !Double.isNaN(dVar.f12917c));
            return new GoogleLatLngBounds(new LatLngBounds(new LatLng(dVar.f12915a, dVar.f12917c), new LatLng(dVar.f12916b, dVar.d)));
        }
        ...
        public IMapsProvider.ILatLngBoundsBuilder include(IMapsProvider.LatLng latLng) {
            ...
            LatLng latLng2 = new LatLng(latLng.latitude, latLng.longitude);
            dVar.getClass();
            double d = dVar.f12915a;
            double d10 = latLng2.f7081a;
            dVar.f12915a = Math.min(d, d10);
            dVar.f12916b = Math.max(dVar.f12916b, d10);
            boolean isNaN = Double.isNaN(dVar.f12917c);
            double d11 = latLng2.f7082b;
            if (isNaN) {
                dVar.f12917c = d11;
                dVar.d = d11;
        ...
        private GoogleLatLngBoundsBuilder() {
            ?? obj = new Object();
            obj.f12915a = Double.POSITIVE_INFINITY;
            obj.f12916b = Double.NEGATIVE_INFINITY;
            obj.f12917c = Double.NaN;
            obj.d = Double.NaN;
            this.builder = obj;
        }
    }
    ...
    public static final class GoogleMapImpl implements IMapsProvider.IMap {
        ...
        public final class GoogleMarker implements IMapsProvider.IMarker {
            ...
            public IMapsProvider.LatLng getPosition() {
                ...
                try {
                    ...
                    N0.recycle();
                    return new IMapsProvider.LatLng(latLng.f7081a, latLng.f7082b);
                } catch (RemoteException e) {
                    throw new RuntimeException(e);
                }
            }
        ...
        public IMapsProvider.ICircle addCircle(IMapsProvider.ICircleOptions iCircleOptions) {
            ...
            try {
                ...
                i8.f fVar = cVar.f10125a;
                Parcel O0 = fVar.O0();
                s7.b.b(O0, bVar);
                Parcel N0 = fVar.N0(O0, 35);
                IBinder readStrongBinder = N0.readStrongBinder();
                int i10 = s7.g.f42822b;
        ...
        public IMapsProvider.IMarker addMarker(IMapsProvider.IMarkerOptions iMarkerOptions) {
            ...
            try {
                ...
                i8.f fVar2 = cVar.f10125a;
                Parcel O0 = fVar2.O0();
                s7.b.b(O0, gVar);
                Parcel N0 = fVar2.N0(O0, 11);
                IBinder readStrongBinder = N0.readStrongBinder();
                int i10 = s7.j.f42823b;
                if (readStrongBinder == null) {
                    aVar = 0;
                } else {
        ...
        public IMapsProvider.CameraPosition getCameraPosition() {
            ...
            try {
                ...
                N0.recycle();
                LatLng latLng = cameraPosition.f7078a;
                return new IMapsProvider.CameraPosition(new IMapsProvider.LatLng(latLng.f7081a, latLng.f7082b), cameraPosition.f7079b);
            } catch (RemoteException e) {
                throw new RuntimeException(e);
            }
        }
        ...
        public IMapsProvider.IUISettings getUiSettings() {
            ...
            cVar2.getClass();
            try {
                if (cVar2.f10126b == null) {
                    i8.f fVar = cVar2.f10125a;
                    ...
                    N0.recycle();
                    cVar2.f10126b = new h8.h(cVar);
                }
                return new GoogleUISettings(cVar2.f10126b);
            } catch (RemoteException e) {
                throw new RuntimeException(e);
            }
        }
    ...
    public static final class GoogleMarkerOptions implements IMapsProvider.IMarkerOptions {
        ...
        public IMapsProvider.IMarkerOptions flat(boolean z10) {
            this.markerOptions.f12925r = z10;
            return this;
        }
        ...
        public IMapsProvider.IMarkerOptions position(IMapsProvider.LatLng latLng) {
            this.markerOptions.f12920a = new LatLng(latLng.latitude, latLng.longitude);
            return this;
        }

        @Override
        public IMapsProvider.IMarkerOptions snippet(String str) {
            this.markerOptions.f12922c = str;
            return this;
        }

        @Override
        public IMapsProvider.IMarkerOptions title(String str) {
            this.markerOptions.f12921b = str;
            return this;
        }
