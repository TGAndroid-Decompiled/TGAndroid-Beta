...
public final class MessagesController$$ExternalSyntheticLambda127 implements Runnable {
    public final int $r8$classId;
    public final MessagesController f$0;
    public final int f$1;

    public MessagesController$$ExternalSyntheticLambda127(MessagesController messagesController, int i, int i2) {
        this.$r8$classId = i2;
