...
public final class jh implements Utilities.Callback2 {
    ...
    public final void run(Object obj, Object obj2) {
        switch (this.f16487a) {
            case 0:
                PasskeysController.lambda$create$9((org.telegram.ui.ActionBar.b2) this.f16489c, (Utilities.Callback2) this.d, (l5.j) this.e, (Context) this.f16490f, this.f16488b, (TL_account.passkeyRegistrationOptions) obj, (TLRPC.TL_error) obj2);
                return;
            default:
                ci.d dVar = (ci.d) this.f16489c;
                org.telegram.ui.ActionBar.f3 f3Var = (org.telegram.ui.ActionBar.f3) this.d;
                View view = (View) this.e;
                cf.c cVar = (cf.c) this.f16490f;
                ...
                if (urlAuthResult instanceof TLRPC.TL_urlAuthResultAccepted) {
                    ...
                    try {
                        ...
                        n6.l.n(eVar, y8.j0.f46334a).addOnSuccessListener(new kv0(20, cVar, dVar)).addOnFailureListener(new cj1(dVar, 1));
                        f3Var.dismiss();
                        return;
                    } catch (Exception e) {
                        FileLog.e(e);
    ...
    public jh(org.telegram.ui.ActionBar.b2 b2Var, Utilities.Callback2 callback2, l5.j jVar, Context context, int i10) {
        this.f16489c = b2Var;
        this.d = callback2;
        this.e = jVar;
