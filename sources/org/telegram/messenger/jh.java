...
public final class jh implements Utilities.Callback2 {
    public final int f16747a = 1;
    public final int f16748b;
    public final Object f16749c;
    ...
    public final void run(Object obj, Object obj2) {
        switch (this.f16747a) {
            case 0:
                PasskeysController.lambda$create$9((org.telegram.ui.ActionBar.a2) this.f16749c, (Utilities.Callback2) this.d, (q2.b) this.e, (Context) this.f16750f, this.f16748b, (TL_account.passkeyRegistrationOptions) obj, (TLRPC.TL_error) obj2);
                return;
            default:
                ci.d dVar = (ci.d) this.f16749c;
                org.telegram.ui.ActionBar.e3 e3Var = (org.telegram.ui.ActionBar.e3) this.d;
                View view = (View) this.e;
                cf.c cVar = (cf.c) this.f16750f;
                ...
                if (urlAuthResult instanceof TLRPC.TL_urlAuthResultAccepted) {
                    ...
                    try {
                        ...
                        n6.l.n(eVar, y8.j0.f46658a).addOnSuccessListener(new ds0(21, cVar, dVar)).addOnFailureListener(new cj1(dVar, 1));
                        e3Var.dismiss();
                        return;
                    } catch (Exception e) {
                        FileLog.e(e);
