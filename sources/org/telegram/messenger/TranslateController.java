...
public class TranslateController extends BaseController {
    ...
    public static class StoryKey {
        ...
        public StoryKey(TL_stories.StoryItem storyItem) {
            ...
            this.storyId = storyItem.f20133id;
        }
    }
        ...
        if (tLObject instanceof TLRPC.TL_messages_translateResult) {
            ...
            if (arrayList.size() <= 0) {
                AndroidUtilities.runOnUIThread(new Runnable(this) {
                    public final TranslateController f18051b;
                    ...
                    public final void run() {
                        switch (r6) {
                            case 0:
                                this.f18051b.lambda$translateStory$35(storyItem, str, storyKey, runnable);
                                return;
                            default:
                                this.f18051b.lambda$translateStory$37(storyItem, str, storyKey, runnable);
                                return;
                        }
                    }
                });
