    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        switch (this.f18292a) {
            case 0:
                ...
                long j3 = this.f18295e;
                this.f18293b.lambda$getChannelDifference$349(this.d, i10, j3, tLObject, tL_error);
                return;
            case 1:
                long j10 = this.d;
                long j11 = this.f18295e;
                this.f18293b.lambda$sendTyping$172(this.f18294c, j10, j11, tLObject, tL_error);
                return;
            default:
                long j12 = this.d;
                long j13 = this.f18295e;
                this.f18293b.lambda$sendTyping$174(this.f18294c, j12, j13, tLObject, tL_error);
                return;
        }
    }
