...
public class SavedMessagesController {
    ...
    public static class SavedDialog {
        ...
        public static SavedDialog fromMessage(int i10, TLRPC.Message message, boolean z4) {
            ...
            savedDialog.top_message_id = message.f19180id;
        ...
        public static SavedDialog fromTL(int i10, TLRPC.savedDialog saveddialog, ArrayList<TLRPC.Message> arrayList, boolean z4) {
            ...
            while (true) {
                if (i11 < arrayList.size()) {
                    ...
                    if (savedDialog.top_message_id == message.f19180id) {
                        break;
                    }
                    i11++;
                } else {
    ...
    public void lambda$loadDialogs$2(TLObject tLObject, ArrayList arrayList, TLRPC.TL_error tL_error) {
        ...
        if (tLObject instanceof TLRPC.TL_messages_savedDialogs) {
            ...
            boolean z12 = this.dialogsEndReached;
            if (this.loadedDialogs.size() >= this.dialogsCount) {
                z4 = true;
            } else {
                z4 = false;
            }
            this.dialogsEndReached = z4;
            this.unsupported = false;
            if (z4 && !z12) {
                updateAllDialogs(true);
            }
        ...
        if (!this.dialogsLoading && !this.dialogsEndReached && !this.loadingCache) {
            if (!this.loadedCache) {
                ...
                if (this.loadedDialogs.isEmpty()) {
                    ...
                    savedDialog = (SavedDialog) kf.k0.i(1, this.loadedDialogs);
                }
                if (savedDialog != null) {
    ...
    public boolean updateSavedDialogs(ArrayList<TLRPC.Message> arrayList) {
        ...
        for (int i12 = 0; i12 < arrayList.size(); i12++) {
            ...
            if (savedDialogId == clientUserId || (message.f19180id >= 0 && (message.send_state == 0 || message.fwd_from == null))) {
                TLRPC.Message message2 = (TLRPC.Message) hVar.f(savedDialogId);
                if (message2 == null || message2.f19180id < message.f19180id) {
        ...
        for (int i13 = 0; i13 < hVar.m(); i13++) {
            long j10 = hVar.j(i13);
            TLRPC.Message message3 = (TLRPC.Message) hVar.n(i13);
            ...
            while (true) {
                if (i14 < this.cachedDialogs.size()) {
                    ...
                    if (savedDialog.dialogId == j10) {
                        ...
                        int i16 = message3.f19180id;
                        if (i15 < i16 || (i16 < 0 && message3.date > savedDialog.getDate())) {
                            if (savedDialog.top_message_id < message3.f19180id) {
                                int i17 = 0;
                                for (int i18 = 0; i18 < arrayList.size(); i18++) {
                                    if (arrayList.get(i18).f19180id > savedDialog.top_message_id) {
                                        i17++;
                                    }
                                }
            ...
            while (true) {
                if (i19 < this.loadedDialogs.size()) {
                    ...
                    if (savedDialog2.dialogId == j10) {
                        ...
                        int i21 = message3.f19180id;
                        if (i20 < i21 || (i21 < 0 && message3.date > savedDialog2.getDate())) {
                            if (savedDialog2.top_message_id < message3.f19180id) {
                                int i22 = 0;
                                for (int i23 = 0; i23 < arrayList.size(); i23++) {
                                    if (arrayList.get(i23).f19180id > savedDialog2.top_message_id) {
                                        i22++;
                                    }
                                }
