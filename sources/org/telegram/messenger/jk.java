    ...
    public final void run() {
        ...
        switch (this.f18129a) {
            ...
            case 3:
                ...
                f1Var2.setChecked(TLObject.hasFlag(j5Var.f52098g, 1));
                f1Var3.setChecked(TLObject.hasFlag(j5Var.f52098g, 2));
                f1Var4.setChecked(TLObject.hasFlag(j5Var.f52098g, 4));
                f1Var5.setChecked(TLObject.hasFlag(j5Var.f52098g, 8));
                if (this.f18135r) {
                    f1Var6.setChecked(TLObject.hasFlag(j5Var.f52098g, 256));
                    f1Var7.setChecked(TLObject.hasFlag(j5Var.f52098g, 512));
                    return;
                }
                return;
            default:
                ...
                zh.j5 j5Var2 = ((yh.h4) this.f18130b).f50332c.Y;
                if (j5Var2.f52096e) {
                ...
                f1Var9.setChecked(TLObject.hasFlag(j5Var2.f52098g, 1));
                f1Var10.setChecked(TLObject.hasFlag(j5Var2.f52098g, 2));
                f1Var11.setChecked(TLObject.hasFlag(j5Var2.f52098g, 4));
                f1Var12.setChecked(TLObject.hasFlag(j5Var2.f52098g, 8));
                if (this.f18135r) {
                    f1Var13.setChecked(TLObject.hasFlag(j5Var2.f52098g, 256));
                    f1Var14.setChecked(TLObject.hasFlag(j5Var2.f52098g, 512));
                    return;
                }
                return;
        }
