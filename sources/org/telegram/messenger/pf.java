    ...
    public final void run() {
        switch (this.f18725a) {
            ...
            default:
                ...
                if (!eVar.f50082o.get() && !atomicBoolean.get()) {
                    Bitmap.CompressFormat compressFormat = Bitmap.CompressFormat.WEBP;
                    if (Build.VERSION.SDK_INT <= 28) {
                        compressFormat = Bitmap.CompressFormat.PNG;
                    }
                    bitmapArr[i10].compress(compressFormat, eVar.f50079l, a0VarArr[i10]);
                    int i12 = a0VarArr[i10].f50051b;
                    try {
                        synchronized (eVar.h) {
                            yf.d dVar = new yf.d(i11);
                            dVar.f50057c = (int) randomAccessFile.length();
                            arrayList.add(dVar);
                            randomAccessFile.write(a0VarArr[i10].f50050a, 0, i12);
                            dVar.f50056b = i12;
                            a0VarArr[i10].b();
                        }
