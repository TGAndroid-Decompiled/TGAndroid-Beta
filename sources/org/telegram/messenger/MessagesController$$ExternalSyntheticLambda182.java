...
public final class MessagesController$$ExternalSyntheticLambda182 implements Runnable {
    public final int $r8$classId;
    public final MessagesController f$0;
    public final TLObject f$1;

    public MessagesController$$ExternalSyntheticLambda182(MessagesController messagesController, TLObject tLObject, int i) {
        this.$r8$classId = i;
