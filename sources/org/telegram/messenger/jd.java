...
public final class jd implements Runnable {
    ...
    public final void run() {
        switch (this.f16474a) {
            case 0:
                ...
                ((MessagesController) this.d).lambda$getSendAsPeers$442((TLRPC.TL_channels_sendAsPeers) this.e, (a0.i) this.f16477f, this.f16475b, (MessagesController.SendAsPeersInfo) this.h, z10);
                return;
            case 1:
                ((TranslateController) this.d).lambda$pushToTranslate$24((HashMap) this.e, this.f16475b, (TranslateController.PendingTranslation) this.f16477f, this.f16476c, (Set) this.h);
                return;
            case 2:
                ((ChatThemeController) this.d).lambda$setWallpaperToPeer$16((TLObject) this.e, this.f16475b, this.f16476c, (String) this.f16477f, (Runnable) this.h);
                return;
            default:
                ((TopicsController) this.d).lambda$reloadTopics$15((TLObject) this.e, this.f16476c, this.f16475b, (HashSet) this.f16477f, (Runnable) this.h);
                return;
        }
    }
    ...
    public jd(TranslateController translateController, HashMap hashMap, long j3, TranslateController.PendingTranslation pendingTranslation, boolean z10, Set set) {
        ...
        this.e = hashMap;
        this.f16475b = j3;
        this.f16477f = pendingTranslation;
        this.f16476c = z10;
        this.h = set;
    }
}
