...
public final class fg implements Runnable {
    ...
    public final void run() {
        ...
        switch (i10) {
            case 0:
                ((MessagesStorage) obj2).lambda$saveTopics$47(this.f16124b, (List) obj, this.f16125c, this.d);
                return;
            case 1:
                ((TopicsController) obj2).lambda$loadTopics$0(this.f16124b, (ArrayList) obj, this.f16125c, this.d);
                return;
            default:
                ...
                if (tLObject instanceof TL_stories.TL_stories_stories) {
                    ...
                    while (true) {
                        ...
                        if (i11 < tL_stories_stories.stories.size()) {
                            if (tL_stories_stories.stories.get(i11).f18318id == this.d) {
