...
public class WearAuthListenerService extends l8.k {
    ...
    public static void lambda$onMessageReceived$0(String str, String str2, byte[] bArr) {
        ...
        if (!str.equals("/tg-wear-auth/offer")) {
            ...
            BigInteger bigInteger = ri1.f38061a;
        ...
        BigInteger bigInteger2 = ri1.f38061a;
        if (bArr.length != 272) {
        ...
        if (context != null) {
            ...
            org.telegram.ui.ActionBar.g3 g3Var2 = ri1.f38063c;
            if (g3Var2 != null) {
                g3Var2.dismiss();
                ri1.f38063c = null;
            }
            ...
            imageView.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20157r5, f6Var), PorterDuff.Mode.SRC_IN));
    ...
    public void onMessageReceived(l8.g gVar) {
        ...
        String str = l0Var.f13825b;
        String str2 = l0Var.d;
        byte[] bArr = l0Var.f13826c;
