...
public class ContactsController extends BaseController {
    ...
    private void applyContactToPhoneBook(ArrayList<ContentProviderOperation> arrayList, TLRPC.User user) {
        ...
        newInsert.withValue("sync2", Long.valueOf(user.f20043id));
        ...
        newInsert3.withValue("data1", Long.valueOf(user.f20043id));
        ...
        newInsert3.withValue("data4", Long.valueOf(user.f20043id));
        ...
        newInsert4.withValue("data1", Long.valueOf(user.f20043id));
        ...
        newInsert4.withValue("data4", Long.valueOf(user.f20043id));
        ...
        newInsert5.withValue("data1", Long.valueOf(user.f20043id));
        ...
        newInsert5.withValue("data4", Long.valueOf(user.f20043id));
    ...
    private void applyContactsUpdates(ArrayList<Long> arrayList, ConcurrentHashMap<Long, TLRPC.User> concurrentHashMap, ArrayList<TLRPC.TL_contact> arrayList2, ArrayList<Long> arrayList3) {
        ...
        for (int i12 = 0; i12 < arrayList3.size(); i12++) {
            ...
            if (concurrentHashMap != null) {
                user = concurrentHashMap.get(l10);
            } else {
                user = null;
            }
            if (user == null) {
    ...
    private void deleteContactFromPhoneBook(long j3) {
        if (hasContactsPermission()) {
            ...
            try {
                ...
                contentResolver.delete(build, "sync2 = " + j3, null);
            } catch (Exception e7) {
    ...
    private long getContactsHash(ArrayList<TLRPC.TL_contact> arrayList) {
        ...
        for (int i10 = -1; i10 < size; i10++) {
            if (i10 == -1) {
                j3 = MediaDataController.calcHash(j3, getUserConfig().contactsSavedCount);
            } else {
                j3 = MediaDataController.calcHash(j3, ((TLRPC.TL_contact) arrayList2.get(i10)).user_id);
            }
        }
        return j3;
    }
    ...
    public void lambda$addContact$51(TLRPC.Updates updates, TLRPC.User user) {
        ...
        for (int i10 = 0; i10 < updates.users.size(); i10++) {
            ...
            if (user2.contact && this.contactsDict.get(Long.valueOf(user2.f20043id)) == null) {
                TLRPC.TL_contact tL_contact = new TLRPC.TL_contact();
                tL_contact.user_id = user2.f20043id;
    ...
    public void lambda$addContact$52(TLRPC.User user, TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        if (userProfilePhoto != null && userProfilePhoto.personal) {
            for (int i10 = 0; i10 < updates.users.size(); i10++) {
                if (updates.users.get(i10).f20043id == user.f20043id) {
        ...
        for (int i11 = 0; i11 < updates.users.size(); i11++) {
            ...
            if (user2.f20043id == user.f20043id) {
    ...
    public void lambda$applyContactsUpdates$46(Long l4) {
                ...
                while (true) {
                    if (i11 < 4) {
                        ...
                        if (currentUser != null) {
                            ...
                            if (str.equals("" + currentUser.f20043id)) {
            ...
            for (Account account : accountsByType) {
                ...
                while (true) {
                    ...
                    if (UserConfig.getInstance(i10).getCurrentUser() != null) {
                        if (account.name.equals("" + currentUser.f20043id)) {
    ...
    public void lambda$deleteContact$55(ArrayList arrayList) {
        ...
        while (i10 < size) {
            ...
            i10++;
            deleteContactFromPhoneBook(((TLRPC.User) obj).f20043id);
        }
    }
    ...
    public void lambda$deleteContact$56(ArrayList arrayList, boolean z10, String str) {
        ...
        while (i10 < size) {
            ...
            TLRPC.TL_contact tL_contact = this.contactsDict.get(Long.valueOf(user.f20043id));
            if (tL_contact != null) {
                this.contacts.remove(tL_contact);
                this.contactsDict.remove(Long.valueOf(user.f20043id));
                z11 = true;
            }
        }
        if (z11) {
    ...
    public void lambda$deleteContactsUndoable$53(HashMap hashMap) {
        for (Map.Entry entry : hashMap.entrySet()) {
            ...
            user.contact = true;
            this.contacts.add(tL_contact);
            this.contactsDict.put(Long.valueOf(user.f20043id), tL_contact);
        }
        buildContactsSectionsArrays(true);
        getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.updateInterfaces, Integer.valueOf(MessagesController.UPDATE_MASK_NAME));
        getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.contactsDidLoad, new Object[0]);
    ...
    public void lambda$loadContacts$28(long j3, TLObject tLObject, TLRPC.TL_error tL_error) {
        if (tL_error == null) {
    ...
    public void lambda$mergePhonebookAndTelegramContacts$41(boolean z10, ArrayList arrayList, HashMap hashMap, HashMap hashMap2, ArrayList arrayList2) {
        ...
        for (ArrayList arrayList4 : hashMap2.values()) {
            Collections.sort(arrayList4, new k1(localeCollator, 1));
        }
    ...
    public void lambda$performSyncPhoneBook$14(int i10, HashMap hashMap, boolean z10, boolean z11) {
    ...
    public void lambda$performSyncPhoneBook$16(HashMap hashMap, HashMap hashMap2, boolean z10, HashMap hashMap3, ArrayList arrayList, HashMap hashMap4) {
    ...
    public void lambda$performSyncPhoneBook$19(HashMap hashMap, HashMap hashMap2, boolean z10, HashMap hashMap3, ArrayList arrayList, HashMap hashMap4, boolean[] zArr) {
        this.contactsBookSPhones = hashMap;
        this.contactsBook = hashMap2;
        this.contactsSyncInProgress = false;
        this.contactsBookLoaded = true;
    ...
    public void lambda$performSyncPhoneBook$22(HashMap hashMap, HashMap hashMap2, boolean z10, HashMap hashMap3, ArrayList arrayList, HashMap hashMap4) {
        this.contactsBookSPhones = hashMap;
        this.contactsBook = hashMap2;
        this.contactsSyncInProgress = false;
        this.contactsBookLoaded = true;
    ...
    public void lambda$performSyncPhoneBook$24(HashMap hashMap, HashMap hashMap2, boolean z10, HashMap hashMap3, ArrayList arrayList, HashMap hashMap4) {
        this.contactsBookSPhones = hashMap;
        this.contactsBook = hashMap2;
        this.contactsSyncInProgress = false;
        this.contactsBookLoaded = true;
    ...
    public static int lambda$processLoadedContacts$30(a0.i iVar, Collator collator, TLRPC.TL_contact tL_contact, TLRPC.TL_contact tL_contact2) {
    ...
    public void lambda$processLoadedContacts$33(ArrayList arrayList, ConcurrentHashMap concurrentHashMap, HashMap hashMap, HashMap hashMap2, ArrayList arrayList2, ArrayList arrayList3, int i10, boolean z10, boolean z11) {
    ...
    public void lambda$processLoadedContacts$36(final int i10, final ArrayList arrayList, ArrayList arrayList2, a0.i iVar, final boolean z10) {
        HashMap hashMap;
        HashMap hashMap2;
        int i11;
        ...
        if (i10 != 1) {
            ...
            messagesStorage.putContacts(arrayList4, z11);
        }
        Collator localeCollator = getLocaleCollator();
        ...
        AndroidUtilities.runOnUIThread(new Runnable() {
            ...
            public final void run() {
                ContactsController.this.lambda$processLoadedContacts$33(arrayList, concurrentHashMap5, hashMap3, hashMap4, arrayList5, arrayList10, i10, z10, z12);
            }
        });
    ...
    public void lambda$processLoadedContacts$37(ArrayList arrayList, int i10, ArrayList arrayList2) {
        ...
        messagesController.putUsers(arrayList, z10);
        a0.i iVar = new a0.i();
    ...
    public void lambda$syncPhoneBookByAlert$7(HashMap hashMap, boolean z10, boolean z11, boolean z12) {
        if (BuildVars.LOGS_ENABLED) {
    ...
    public long addContactToPhoneBook(TLRPC.User user, boolean z10) {
        ...
        if (z10) {
            try {
                Uri build = ContactsContract.RawContacts.CONTENT_URI.buildUpon().appendQueryParameter("caller_is_syncadapter", "true").appendQueryParameter("account_name", this.systemAccount.name).appendQueryParameter("account_type", this.systemAccount.type).build();
                contentResolver.delete(build, "sync2 = " + user.f20043id, null);
            } catch (Exception unused) {
            }
        }
    ...
    public void deleteAllContacts(Runnable runnable) {
        ...
        int size = this.contacts.size();
        for (int i10 = 0; i10 < size; i10++) {
            tL_contacts_deleteContacts.f19940id.add(getMessagesController().getInputUser(this.contacts.get(i10).user_id));
        }
    ...
    public void deleteContact(ArrayList<TLRPC.User> arrayList, boolean z10) {
        if (arrayList != null && !arrayList.isEmpty()) {
            ...
            for (int i10 = 0; i10 < size; i10++) {
                ...
                int i11 = storiesController.f3832a;
                ArrayList arrayList3 = storiesController.h;
                ArrayList arrayList4 = storiesController.f3837g;
                int i12 = 0;
                while (true) {
                    if (i12 >= arrayList4.size()) {
                        break;
                    } else if (DialogObject.getPeerDialogId(((TL_stories.PeerStories) arrayList4.get(i12)).peer) == j3) {
                ...
                while (true) {
                    if (i13 >= arrayList3.size()) {
                        break;
                    } else if (DialogObject.getPeerDialogId(((TL_stories.PeerStories) arrayList3.get(i13)).peer) == j3) {
                ...
                bi.h9 h9Var = storiesController.f3840k;
                h9Var.f3101b.getStorageQueue().postRunnable(new bi.g(h9Var, j3, 4));
                ...
                if (inputUser != null) {
                    user.contact = false;
                    arrayList2.add(Long.valueOf(user.f20043id));
                    tL_contacts_deleteContacts.f19940id.add(inputUser);
                }
            }
    ...
    public void deleteContactsUndoable(Context context, org.telegram.ui.ActionBar.n2 n2Var, ArrayList<TLRPC.User> arrayList) {
        if (arrayList != null && !arrayList.isEmpty()) {
            ...
            icVar.setTimer();
            icVar.f27097b.setText(LocaleController.formatPluralString("ContactsDeletedUndo", hashMap.size(), new Object[0]));
            org.telegram.ui.Components.oc ocVar = new org.telegram.ui.Components.oc(context, n2Var.getResourceProvider(), true, true);
            ocVar.f29056a = new d3(27, this, hashMap);
            ocVar.f29057b = new o1(this, arrayList, 2);
    ...
    public boolean isContact(long j3) {
        if (this.contactsDict.get(Long.valueOf(j3)) != null) {
            return true;
        }
        return false;
    }
    ...
    public void addContact(TLRPC.User user, TLRPC.TL_textWithEntities tL_textWithEntities, boolean z10) {
        ...
        tL_contacts_addContact.f19938id = getMessagesController().getInputUser(user);
