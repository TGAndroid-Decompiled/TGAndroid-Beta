...
public class NotificationsController extends BaseController {
            ...
            try {
                ...
                for (int i = 0; i < size; i++) {
                    ...
                    if (id.startsWith(str)) {
                        ...
                        if (BuildVars.LOGS_ENABLED) {
                            FileLog.m33d("delete channel cleanup " + id);
                        }
                    }
                }
            } catch (Throwable th) {
    ...
    public void lambda$setOpenedDialogId$2(long j) {
    ...
    public void lambda$setLastOnlineFromOtherDevice$4(int i) {
        if (BuildVars.LOGS_ENABLED) {
            FileLog.m33d("set last online from other device = " + i);
        }
    ...
    public void lambda$removeDeletedMessagesFromNotifications$9(LongSparseArray longSparseArray, final ArrayList arrayList) {
        Integer num;
    ...
    public void lambda$processDialogsUpdateRead$21(LongSparseIntArray longSparseIntArray, final ArrayList arrayList) {
        boolean z;
        boolean z2;
        Integer num;
        TLRPC$Chat chat;
    ...
    private void scheduleNotificationDelay(boolean z) {
        try {
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m33d("delay notification start, onlineReason = " + z);
            }
            ...
            try {
                ...
                if (i == 0 || i == -1) {
                    ...
                    if (string != null) {
                        ...
                        if (BuildVars.LOGS_ENABLED) {
                            FileLog.m33d("delete channel internal " + string);
                        }
                    }
                }
                if (i == 1 || i == -1) {
                    ...
                    if (string2 != null) {
                        ...
                        if (BuildVars.LOGS_ENABLED) {
                            FileLog.m33d("delete channel internal " + string2);
                        }
                    }
                }
                edit.commit();
            ...
            try {
                ...
                if (i2 == 0 || i2 == -1) {
                    ...
                    if (string != null) {
                        ...
                        if (BuildVars.LOGS_ENABLED) {
                            FileLog.m33d("delete channel global internal " + string);
                        }
                    }
                }
                if (i2 == 1 || i2 == -1) {
                    ...
                    if (string2 != null) {
                        ...
                        if (BuildVars.LOGS_ENABLED) {
                            FileLog.m33d("delete channel global internal " + string2);
                        }
                    }
                }
            ...
            for (Map.Entry<String, ?> entry : all.entrySet()) {
                ...
                if (key.startsWith("org.telegram.key")) {
                    if (!key.endsWith("_s")) {
                        ...
                        if (BuildVars.LOGS_ENABLED) {
                            FileLog.m33d("delete all channel " + str);
                        }
                    }
                    edit.remove(key);
                }
