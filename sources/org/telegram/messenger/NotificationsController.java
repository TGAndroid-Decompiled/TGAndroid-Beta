...
public class NotificationsController extends BaseController implements NotificationCenter.NotificationCenterDelegate {
    ...
    public class C1NotificationHolder {
        ...
        public C1NotificationHolder(int i9, long j10, boolean z10, long j11, String str, TLRPC.User user, TLRPC.Chat chat, e0.t tVar, long j12, String str2, long[] jArr, int i10, Uri uri, int i11, boolean z11, boolean z12, boolean z13, int i12) {
        ...
        public void call() {
            if (BuildVars.LOGS_ENABLED) {
                FileLog.w("show dialog notification with id " + this.f19654id + " " + this.dialogId + " user=" + this.user + " chat=" + this.chat);
            }
            try {
                NotificationsController.notificationManager.d(this.f19654id, this.notification.b());
    ...
    private String getStringForMessage(MessageObject messageObject, boolean z10, boolean[] zArr, boolean[] zArr2) {
        ...
        if (!AndroidUtilities.needShowPasscode() && !SharedConfig.isWaitingForPasscodeEnter) {
            if (!messageObject.isStoryPush && !messageObject.isStoryMentionPush) {
                ...
                SharedPreferences notificationsSettings = getAccountInstance().getNotificationsSettings();
                boolean v = l0.v("content_preview_", j11, notificationsSettings, true);
                if (messageObject.isFcmMessage()) {
                    ...
                    } else if (i9 != 0 && (!v || ((!messageObject.localChannel && !notificationsSettings.getBoolean("EnablePreviewGroup", true)) || (messageObject.localChannel && !notificationsSettings.getBoolean("EnablePreviewChannel", true))))) {
                        if (zArr2 != null) {
                            zArr2[0] = false;
                        }
                    ...
                    if (message7 instanceof TLRPC.TL_messageService) {
                        ...
                        if (!(messageAction2 instanceof TLRPC.TL_messageActionChangeCreator) && !(messageAction2 instanceof TLRPC.TL_messageActionNewCreatorPending)) {
                            ...
                            if (messageAction2 instanceof TLRPC.TL_messageActionLoginUnknownLocation) {
                                ...
                                int i15 = R.string.NotificationUnrecognizedDevice;
                                String str = getUserConfig().getCurrentUser().first_name;
                                TLRPC.MessageAction messageAction3 = messageObject.messageOwner.action;
                                return LocaleController.formatString(i15, str, formatString8, messageAction3.title, messageAction3.address);
                                ...
                                if (!(messageAction2 instanceof TLRPC.TL_messageActionStarGift) && !(messageAction2 instanceof TLRPC.TL_messageActionGiftPremium) && !(messageAction2 instanceof TLRPC.TL_messageActionGiftTon)) {
                                    ...
                                    if (!(messageAction2 instanceof TLRPC.TL_messageActionPaidMessagesRefunded) && !(messageAction2 instanceof TLRPC.TL_messageActionPaidMessagesPrice)) {
                                        if (messageAction2 instanceof TLRPC.TL_messageActionPhoneCall) {
                                            ...
                                            String f11 = gf.d.f(((TLRPC.TL_messageActionSetChatTheme) messageAction2).theme);
    ...
    private String getTitle(TLRPC.Chat chat) {
        ...
        if (chat.monoforum) {
            return vf.c.i(chat, this.currentAccount, false);
        }
        return chat.title;
    }
    ...
    public static void lambda$playInChatSound$39(SoundPool soundPool, int i9, int i10) {
        if (i10 == 0) {
            try {
    ...
    public static void lambda$playOutChatSound$48(SoundPool soundPool, int i9, int i10) {
        if (i10 == 0) {
            try {
                soundPool.play(i9, 1.0f, 1.0f, 1, 0, 1.0f);
            } catch (Exception e10) {
    ...
    public void lambda$processDialogsUpdateRead$29(int i9) {
    ...
    public void lambda$processLoadedUnreadMessages$32(int i9) {
    ...
    public void lambda$processLoadedUnreadMessages$33(ArrayList arrayList, a0.h hVar, ArrayList arrayList2, Collection collection) {
        ...
        if (arrayList != null) {
            ...
            while (i15 < arrayList.size()) {
                TLRPC.Message message3 = (TLRPC.Message) arrayList.get(i15);
                if (message3 != null && ((messageFwdHeader = message3.fwd_from) == null || !messageFwdHeader.imported)) {
                    ...
                    if (!(messageAction instanceof TLRPC.TL_messageActionSetMessagesTTL) && (!message3.silent || (!(messageAction instanceof TLRPC.TL_messageActionContactSignUp) && !(messageAction instanceof TLRPC.TL_messageActionUserJoined)))) {
                        ...
                        if (sparseArray != null && sparseArray.indexOfKey(message3.f22401id) >= 0) {
                            ...
                            if (z14) {
                                ...
                                if (j18 != notificationsController.openedDialogId || !ApplicationLoader.isScreenOn) {
                                    ...
                                    sparseArray.put(message2.f22401id, messageObject2);
        ...
        while (i16 < hVar.m()) {
            ...
            if (z12) {
                Integer num2 = (Integer) hVar.n(i16);
                ...
                if (!notificationsController.getMessagesController().isCommunity(j20)) {
                    if (notificationsController.getMessagesController().isForum(j20)) {
                        ...
                        notificationsController.total_unread_count = i17 + i12;
                    } else {
            ...
            for (int i18 = 0; i18 < arrayList2.size(); i18++) {
                ...
                if (notificationsController.pushMessagesDict.h(id2) < 0) {
                    ...
                    if (z11 && (j10 != notificationsController.openedDialogId || !ApplicationLoader.isScreenOn)) {
                        ...
                        if (!notificationsController.getMessagesController().isCommunity(j10)) {
                            if (notificationsController.getMessagesController().isForum(j10)) {
                                if (num4 != null) {
                                    ...
                                    notificationsController.total_unread_count = i19 - i11;
                                }
                                ...
                                notificationsController.total_unread_count = i20 + i10;
                            } else {
                                if (num4 != null) {
                        ...
                        notificationsController.pushDialogs.k(Integer.valueOf(i9), j10);
                    }
                }
            }
        }
    ...
    public void lambda$processNewMessages$24(int i9) {
        a0.h hVar = new a0.h();
        hVar.k(o8.l.k(Integer.valueOf(i9)), 0L);
        removeDeletedMessagesFromNotifications(hVar, false);
    }

    public void lambda$processNewMessages$25(ArrayList arrayList, int i9) {
    ...
    public void lambda$processNewMessages$26(int i9) {
        NotificationCenter.getGlobalInstance().lambda$postNotificationNameOnUIThread$1(NotificationCenter.notificationsCountUpdated, Integer.valueOf(this.currentAccount));
        getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.dialogsUnreadCounterChanged, Integer.valueOf(i9));
    }
    ...
    public void lambda$processReadStories$16(long j10, int i9) {
        boolean z10;
    ...
    public void lambda$processSeenStoryReactions$14(int i9) {
        int i10 = 0;
        boolean z10 = false;
        while (i10 < this.pushMessages.size()) {
            MessageObject messageObject = this.pushMessages.get(i10);
    ...
    public void lambda$removeDeletedHisoryFromNotifications$12(int i9) {
        NotificationCenter.getGlobalInstance().lambda$postNotificationNameOnUIThread$1(NotificationCenter.notificationsCountUpdated, Integer.valueOf(this.currentAccount));
        getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.dialogsUnreadCounterChanged, Integer.valueOf(i9));
    }
    ...
    public void lambda$removeDeletedMessagesFromNotifications$10(a0.h hVar, boolean z10, ArrayList arrayList) {
        ...
        int i12;
        a0.h hVar2 = hVar;
        int i13 = this.total_unread_count;
        getAccountInstance().getNotificationsSettings();
        Integer num4 = 0;
        int i14 = 0;
        while (i14 < hVar2.m()) {
            long j10 = hVar2.j(i14);
            SparseArray sparseArray = (SparseArray) this.pushMessagesDict.f(j10);
            if (sparseArray == null) {
                num = num4;
                i9 = i14;
                            ...
                            if (!num3.equals(num5)) {
                                ...
                                if (!getMessagesController().isCommunity(dialogId)) {
                                    if (getMessagesController().isForum(dialogId)) {
                                        ...
                                        this.total_unread_count = i17 + i12;
                                    } else {
        ...
        if (i13 != this.total_unread_count) {
            if (!this.notifyCheck) {
                this.delayedPushMessages.clear();
                showOrUpdateNotification(this.notifyCheck);
            } else {
    ...
    public void lambda$removeDeletedMessagesFromNotifications$9(int i9) {
        NotificationCenter.getGlobalInstance().lambda$postNotificationNameOnUIThread$1(NotificationCenter.notificationsCountUpdated, Integer.valueOf(this.currentAccount));
        getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.dialogsUnreadCounterChanged, Integer.valueOf(i9));
    }
    ...
    public void lambda$setLastOnlineFromOtherDevice$5(int i9) {
        if (BuildVars.LOGS_ENABLED) {
        ...
        while (i10 < arrayList2.size()) {
            ...
            if (obj instanceof File) {
                ...
                if (obj instanceof TLRPC.User) {
                    ...
                    try {
                        paint2.setShader(new LinearGradient(size, size2, size, size2 + f12, new int[]{org.telegram.ui.ActionBar.f6.w0(null, org.telegram.ui.ActionBar.f6.f23213p8[org.telegram.ui.Components.z8.e(user.f22527id)], false), org.telegram.ui.ActionBar.f6.w0(null, org.telegram.ui.ActionBar.f6.f23231q8[org.telegram.ui.Components.z8.e(user.f22527id)], false)}, new float[]{0.0f, 1.0f}, Shader.TileMode.CLAMP));
                        canvas.drawCircle(f14, f15, f13, paint2);
                        if (textPaint == null) {
                            try {
                                try {
                        ...
                        try {
                            ...
                            canvas.drawText(sb3, (f14 - (rect.width() / 2.0f)) - rect.left, (f15 - (rect.height() / 2.0f)) - rect.top, textPaint);
    ...
    public static e0.o0 loadRoundAvatar(long j10, File file, e0.o0 o0Var) {
        if (j10 == 489001) {
            o0Var.f4748b = IconCompat.d(ApplicationLoader.applicationContext, R.drawable.ic_launcher_dr);
            return o0Var;
        }
        if (file != null && Build.VERSION.SDK_INT >= 28) {
            try {
                o0Var.f4748b = IconCompat.c(ImageDecoder.decodeBitmap(ImageDecoder.createSource(file), new Object()));
            } catch (Throwable unused) {
            }
        }
        return o0Var;
    ...
    private Pair<Integer, Boolean> parseStoryPushes(ArrayList<String> arrayList, ArrayList<Object> arrayList2) {
        ...
        return new Pair<>(Integer.valueOf(i9), Boolean.valueOf(z10));
    }
        ...
        for (int i9 = 0; i9 < messageObject.messageOwner.entities.size(); i9++) {
            if (messageObject.messageOwner.entities.get(i9) instanceof TLRPC.TL_messageEntitySpoiler) {
                ...
                for (int i10 = 0; i10 < tL_messageEntitySpoiler.length; i10++) {
                    ...
                    sb2.setCharAt(tL_messageEntitySpoiler.offset + i10, cArr[i10 % cArr.length]);
                }
            }
        }
        return sb2.toString();
    ...
    public void resetNotificationSound(e0.t tVar, long j10, long j11, String str, long[] jArr, int i9, Uri uri, int i10, boolean z10, boolean z11, boolean z12, int i11) {
        ...
        if (uri2 != null && uri != null && !TextUtils.equals(uri2.toString(), uri.toString())) {
            ...
            edit.commit();
            tVar.f4782y = validateChannelId(j10, j11, str, jArr, i9, uri2, i10, z10, z11, z12, i11);
    ...
    private void scheduleNotificationDelay(boolean z10) {
        ...
        try {
            ...
            dispatchQueue.postRunnable(runnable, i9);
        } catch (Exception e10) {
            FileLog.e(e10);
            showOrUpdateNotification(this.notifyCheck);
        }
    ...
    private void scheduleNotificationRepeat() {
        try {
            ...
            int i9 = getAccountInstance().getNotificationsSettings().getInt("repeat_messages", 60);
            if (i9 > 0 && this.personalCount > 0) {
                this.alarmManager.set(2, SystemClock.elapsedRealtime() + (i9 * 60000), service);
            } else {
    ...
    private void setNotificationChannel(Notification notification, e0.t tVar, boolean z10) {
        if (z10) {
            tVar.f4782y = OTHER_NOTIFICATIONS_CHANNEL;
        } else {
            tVar.f4782y = notification.getChannelId();
        }
    }
    ...
    private void updateStoryPushesRunnable() {
        ...
        for (int i9 = 0; i9 < this.storyPushMessages.size(); i9++) {
            for (Pair<Long, Long> pair : this.storyPushMessages.get(i9).dateByIds.values()) {
    ...
    public void muteDialog(long j10, long j11, boolean z10) {
        ...
        if (isGlobalNotificationsEnabled && !z11) {
            edit.remove(l0.i(j10, j11, new StringBuilder("notify2_")));
        } else {
            edit.putInt(l0.i(j10, j11, new StringBuilder("notify2_")), 0);
        }
        if (i9 == 0) {
            getMessagesStorage().setDialogFlags(j10, 0L);
            TLRPC.Dialog dialog = (TLRPC.Dialog) getMessagesController().dialogs_dict.f(j10);
    ...
    public void muteUntil(long j10, long j11, int i9) {
        ...
        if (j10 != 0) {
            ...
            if (i9 == Integer.MAX_VALUE) {
                ...
                edit.putInt("notifyuntil_" + sharedPrefKey, getConnectionsManager().getCurrentTime() + i9);
                j12 = (((long) i9) << 32) | 1;
            }
            edit.apply();
            if (i10 == 0) {
    ...
    public void setDialogNotificationsSettings(long j10, long j11, int i9) {
        ...
        if (i9 == 4) {
            ...
            long j12 = 1;
            if (i9 == 3) {
                edit.putInt(l0.i(j10, j11, new StringBuilder("notify2_")), 2);
            } else {
                edit.putInt(l0.i(j10, j11, new StringBuilder("notify2_")), 3);
                edit.putInt(l0.i(j10, j11, new StringBuilder("notifyuntil_")), currentTime);
    ...
    public void updateServerNotificationsSettings(long j10, long j11, boolean z10) {
        ...
        int i9 = notificationsSettings.getInt(l0.i(j10, j11, new StringBuilder("notify2_")), -1);
        if (i9 != -1) {
            ...
            if (i9 == 3) {
                tL_inputPeerNotifySettings4.mute_until = notificationsSettings.getInt(l0.i(j10, j11, new StringBuilder("notifyuntil_")), 0);
            } else {
                tL_inputPeerNotifySettings4.mute_until = i9 == 2 ? Integer.MAX_VALUE : 0;
            }
        }
