        ...
        while (i11 < arrayList2.size()) {
            ...
            if (obj instanceof File) {
                ...
                if (obj instanceof TLRPC.User) {
                    ...
                    try {
                        paint2.setShader(new LinearGradient(size, size2, size, size2 + f11, new int[]{org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19083p8[org.telegram.ui.Components.f9.e(user.f18268id)], false), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19101q8[org.telegram.ui.Components.f9.e(user.f18268id)], false)}, new float[]{0.0f, 1.0f}, Shader.TileMode.CLAMP));
                        canvas.drawCircle(f13, f14, f12, paint2);
                        if (textPaint == null) {
                            try {
                                try {
