...
public class ChatMessagesMetadataController {
    ...
    public void lambda$loadStoriesForMessages$0(ArrayList arrayList) {
        this.chatActivity.getMessagesController().getStoriesController().f48506k.j(arrayList);
    }
    ...
    private void loadStoriesForMessages(long j3, ArrayList<MessageObject> arrayList) {
        ...
        if (!arrayList.isEmpty()) {
            for (int i10 = 0; i10 < arrayList.size(); i10++) {
                ...
                this.extendedMediaRequests.add(Integer.valueOf(this.chatActivity.getConnectionsManager().sendRequest(tL_stories_getStoriesByID, new u0(this, storyItem.f17435id, messageObject, j10, 0))));
            }
    ...
    public void loadExtendedMediaForMessages(long j3, ArrayList<MessageObject> arrayList) {
        if (!arrayList.isEmpty()) {
            ...
            for (int i10 = 0; i10 < arrayList.size(); i10++) {
                tL_messages_getExtendedMedia.f17284id.add(Integer.valueOf(arrayList.get(i10).getId()));
            }
    ...
    public void loadReactionsForMessages(long j3, ArrayList<MessageObject> arrayList) {
        if (!arrayList.isEmpty()) {
            ...
            for (int i10 = 0; i10 < arrayList.size(); i10++) {
                tL_messages_getMessagesReactions.f17290id.add(Integer.valueOf(arrayList.get(i10).getId()));
            }
