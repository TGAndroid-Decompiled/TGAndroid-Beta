...
public final class j2 implements org.telegram.ui.ActionBar.z1, ResultCallback {
    ...
    public j2(FactCheckController factCheckController, cu cuVar, int i10, MessageObject messageObject, boolean z10) {
        this.f16682c = factCheckController;
        this.d = cuVar;
        this.f16681b = i10;
    ...
    public void f(org.telegram.ui.ActionBar.a2 a2Var, int i10) {
        ...
        ((FactCheckController) this.f16682c).lambda$openFactCheckEditor$8((cu) this.d, this.f16681b, (MessageObject) this.e, z10, a2Var, i10);
    }

    @Override
    public void onComplete(Object obj) {
        un unVar = (un) this.f16682c;
        ...
        if (pair != null) {
            ...
            org.telegram.ui.ActionBar.b4 b4Var2 = unVar.f38487f;
            if (b4Var2 != null && longValue == b4Var2.i(unVar.G ? 1 : 0) && bitmap != null) {
                ValueAnimator valueAnimator = unVar.f38489r;
                if (valueAnimator != null) {
                    valueAnimator.cancel();
                }
                int i10 = b4Var.k(this.f16680a ? 1 : 0).settings.intensity;
                ...
                mc0Var.t(bitmap, i10);
                mc0Var.u(this.f16681b);
                ValueAnimator ofFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
                unVar.f38489r = ofFloat;
                ofFloat.addUpdateListener(new qn(mc0Var, 2));
                unVar.f38489r.setDuration(250L);
                unVar.f38489r.start();
            }
        }
    }
