...
public final class j2 implements org.telegram.ui.ActionBar.z1, ResultCallback {
    ...
    public void f(org.telegram.ui.ActionBar.a2 a2Var, int i10) {
        ...
        ((FactCheckController) this.f16697c).lambda$openFactCheckEditor$8((du) this.d, this.f16696b, (MessageObject) this.e, z10, a2Var, i10);
    }
    ...
    public void onComplete(Object obj) {
        ...
        if (pair != null) {
            ...
            org.telegram.ui.ActionBar.b4 b4Var2 = unVar.f38505f;
            if (b4Var2 != null && longValue == b4Var2.i(unVar.G ? 1 : 0) && bitmap != null) {
                ValueAnimator valueAnimator = unVar.f38507r;
                ...
                nc0Var.t(bitmap, i10);
                nc0Var.u(this.f16696b);
                ValueAnimator ofFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
                unVar.f38507r = ofFloat;
                ofFloat.addUpdateListener(new qn(nc0Var, 2));
                unVar.f38507r.setDuration(250L);
                unVar.f38507r.start();
            }
        }
    }
    ...
    public j2(un unVar, org.telegram.ui.ActionBar.b4 b4Var, boolean z10, nc0 nc0Var, int i10) {
        this.f16697c = unVar;
        this.d = b4Var;
        this.f16695a = z10;
        this.e = nc0Var;
