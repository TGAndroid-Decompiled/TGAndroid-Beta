...
public final class q0 implements OnSuccessListener {
    ...
    public final void onSuccess(Object obj) {
        switch (this.f17088a) {
            case 0:
                CaptchaController.lambda$request$2(this.f17089b, this.f17090c, this.d, (RecaptchaTasksClient) obj);
                return;
            default:
                CaptchaController.lambda$request$0(this.f17089b, this.f17090c, this.d, (String) obj);
                return;
        }
    }
}
