...
public final class y5 implements Runnable {
    ...
    public final void run() {
        ...
        Object obj = this.f17942r;
        Object obj2 = this.f17941n;
        Object obj3 = this.h;
        Object obj4 = this.f17938b;
        Object obj5 = this.e;
        Object obj6 = this.d;
        Object obj7 = this.f17940f;
        switch (i10) {
            case 0:
                MediaController.lambda$saveFile$50(this.f17939c, (File) obj7, (String) obj6, (org.telegram.ui.ActionBar.b2) obj4, (boolean[]) obj3, (String) obj5, (Utilities.Callback) obj, (boolean[]) obj2);
                return;
            case 1:
                ...
                if (tLObject != null) {
                    ...
                    if (AndroidUtilities.isTablet()) {
                        ...
                        externalActionActivity.f30793c.c(-1, on0Var);
                    }
                    if (!AndroidUtilities.isTablet()) {
            ...
            default:
                ...
                if (((TLObject) obj7) instanceof TLRPC.TL_boolTrue) {
                    ...
                    lx0Var.a();
                    String str3 = lx0Var.f35575g.f3908a;
    ...
    public y5(TLObject tLObject, org.telegram.ui.ActionBar.n2 n2Var, TLRPC.TL_inputStorePaymentPremiumSubscription tL_inputStorePaymentPremiumSubscription, lx0 lx0Var, c5.f fVar, int i10, TLRPC.TL_error tL_error, TLRPC.TL_payments_canPurchaseStore tL_payments_canPurchaseStore) {
        this.f17940f = tLObject;
        this.d = n2Var;
        this.e = tL_inputStorePaymentPremiumSubscription;
        this.f17938b = lx0Var;
        this.h = fVar;
        this.f17939c = i10;
        this.f17941n = tL_error;
        this.f17942r = tL_payments_canPurchaseStore;
    }
    ...
    public y5(ExternalActionActivity externalActionActivity, org.telegram.ui.ActionBar.b2 b2Var, TLObject tLObject, int i10, TL_account.authorizationForm authorizationform, TL_account.getAuthorizationForm getauthorizationform, String str, String str2) {
        this.f17940f = externalActionActivity;
        this.f17938b = b2Var;
        this.h = tLObject;
        this.f17939c = i10;
        this.f17941n = authorizationform;
        this.f17942r = getauthorizationform;
        this.d = str;
        this.e = str2;
    }
}
