...
public class RichMessageLayout {
    ...
    public static class PreviewView extends View implements org.telegram.ui.Cells.p9 {
        ...
        public static final class Factory extends g51 {
            ...
            public void bindView(View view, h51 h51Var, boolean z10, v51 v51Var, d61 d61Var) {
                ...
                previewView.setTranslationLoading(h51Var.f26589e);
            }

            @Override
            public boolean contentsEquals(h51 h51Var, h51 h51Var2) {
                if (h51Var.d == h51Var2.d && h51Var.G == h51Var2.G && h51Var.f26589e == h51Var2.f26589e) {
                    return true;
                }
                return false;
            }
    ...
    public static abstract class RichBlock implements uj0 {
            ...
            if (w9VarArr != null && w9VarArr.length != 0) {
                ...
                for (org.telegram.ui.Cells.w9 w9Var : w9VarArr) {
                    ...
                    if (spanStart >= 0 && spanEnd >= 0 && spanStart <= spanEnd && spanEnd <= spannableStringBuilder.length()) {
                        CharSequence charSequence2 = w9Var.f23499a;
        ...
        public void draw(Canvas canvas, int i10, float f7) {
            ...
            if (this.numLayout != null) {
                this.root.numTextPaint.setTextSize(AndroidUtilities.dp(SharedConfig.fontSize));
                RichMessageLayout richMessageLayout = this.root;
                richMessageLayout.numTextPaint.setColor(richMessageLayout.getThemedColor(richMessageLayout.isOut() ? org.telegram.ui.ActionBar.j6.f20706fc : org.telegram.ui.ActionBar.j6.ec));
                canvas.save();
            ...
            if (this.checkbox != null) {
                ...
                if (view != null) {
                    CheckBoxBase checkBoxBase = this.checkbox;
                    if (checkBoxBase.f23894a == null) {
                        checkBoxBase.f23894a = view;
                    }
                }
                org.telegram.ui.Components.zc zcVar = this.checkboxBounce;
        ...
        public boolean drawOverlay(Canvas canvas, ColorFilter colorFilter) {
            ...
            boolean z10 = false;
            for (org.telegram.ui.Cells.ba baVar : text2) {
                if ((baVar instanceof Text) && (v5Var = (text = (Text) baVar).animatedEmojiStack) != null && !v5Var.f31094a.isEmpty()) {
                    canvas.save();
    ...
    public static class RichButton {
        ...
        private void drawLoading(Canvas canvas) {
            ...
            if (h90Var != null) {
                if (z10 || h90Var.c()) {
                    float strokeWidth = this.loadingDrawable.f26691w.getStrokeWidth();
        ...
        public void setLoading(boolean z10) {
            ...
            if (z10) {
                ...
                if (h90Var == null) {
                    ...
                    h90Var2.C = true;
                    h90Var2.f26691w.setStrokeWidth(AndroidUtilities.dpf2(1.25f));
                } else {
                    h90Var.f26673b = -1L;
                    h90Var.f26674c = -1L;
                }
    ...
    public static class RichDetailsBlock extends RichBlock {
        ...
        public void onDraw(Canvas canvas) {
            ...
            AnimatedArrowDrawable animatedArrowDrawable = this.arrow;
            animatedArrowDrawable.f23644a.setColor(themedColor);
    ...
    public static class RichMapBlock extends RichBlock {
        ...
        public void onDraw(Canvas canvas) {
            ...
            mapBgPaint.setColor(this.root.getThemedColor(org.telegram.ui.ActionBar.j6.f20888pe));
            boolean isInQuote = isInQuote();
            int i11 = 0;
            if (isInQuote) {
                i10 = 0;
    ...
    public static class RichMathBlock extends RichBlock {
        ...
        public void onDraw(Canvas canvas) {
            ...
            RichMessageLayout richMessageLayout = this.root;
            if (richMessageLayout.isOut()) {
                i10 = org.telegram.ui.ActionBar.j6.f20706fc;
            } else {
    ...
    public static class RichTableBlock extends RichBlock implements iz0 {
        ...
        public RichTableBlock(RichMessageLayout richMessageLayout, Rect rect, int i10, TL_iv.pageBlockTable pageblocktable) {
            ...
            if (pageblocktable.compact) {
                ...
                if (jz0Var.v != dp || jz0Var.f27596r != dp2 || jz0Var.f27597s != dp3) {
                    jz0Var.v = dp;
                    jz0Var.f27596r = dp2;
                    jz0Var.f27597s = dp3;
        ...
        private void drawCellsWithTyping(Canvas canvas, wj0 wj0Var, float f7) {
            ...
            while (i12 < childCount) {
                ...
                if (cellBlock == null) {
                    ...
                    d.a(canvas, this.view, false);
                    if (d.f25143b instanceof Text) {
                        canvas.save();
                        canvas.translate(d.b(), d.c());
                        Text text = (Text) d.f25143b;
                    ...
                    if (c10 >= 1.0f) {
                        d.a(canvas, this.view, true);
                    } else if (c10 > 0.0f && d.f25143b != null) {
                        d.a(canvas, this.view, false);
                        canvas.save();
                        canvas.translate(d.b(), d.c());
                        int saveLayerAlpha2 = canvas.saveLayerAlpha(0.0f, 0.0f, d.f25150k, d.f25151l, (int) (c10 * 255.0f), 31);
                        d.f25143b.draw(canvas, this.view);
        ...
        private cz0 findCellChildAt(float f7, float f10) {
            ...
            for (int i10 = 0; i10 < childCount; i10++) {
                ...
                if (d.f25143b instanceof Text) {
                    int i11 = d.f25155p;
                    if (f11 >= i11 && f11 < i11 + d.f25150k) {
                        int i12 = d.f25156q;
                        if (f12 >= i12 && f12 < i12 + d.f25151l) {
                            return d;
                        }
                    }
                }
        ...
        public boolean drawOverlay(Canvas canvas, ColorFilter colorFilter) {
            ...
            Text text2 = this.title;
            boolean z11 = true;
            if (text2 != null && (v5Var2 = text2.animatedEmojiStack) != null && !v5Var2.f31094a.isEmpty()) {
                canvas.save();
                canvas.translate(titleDrawX(), 0.0f);
                Text text3 = this.title;
            ...
            while (true) {
                if (i11 < size) {
                    ...
                    if (v5Var3 != null && !v5Var3.f31094a.isEmpty()) {
                        RichMessageLayout richMessageLayout = this.root;
                        int minWidth = richMessageLayout.getMinWidth() + this.root.padRight;
                        Rect rect2 = this.padding;
                        ...
                        while (i12 < childCount) {
                            cz0 d = this.tableLayout.d(i12);
                            bz0 bz0Var = d.f25143b;
                            if (!(bz0Var instanceof Text) || (v5Var = (text = (Text) bz0Var).animatedEmojiStack) == null || v5Var.f31094a.isEmpty()) {
                                i10 = i12;
                            } else {
                                canvas.save();
                                canvas.translate(d.b(), d.c());
        ...
        public boolean onTouchEvent(MotionEvent motionEvent) {
            ...
            if (actionMasked == 0) {
                ...
                if (!this.textHandlingTouch && (findCellChildAt = findCellChildAt(motionEvent.getX(), motionEvent.getY())) != null) {
                    this.pressedCellText = (Text) findCellChildAt.f25143b;
                    this.cellDx = findCellChildAt.b() - this.scrollX;
                    this.cellDy = findCellChildAt.c() + this.titleHeight;
                    this.pressedCellText.setSoleButtonHitBounds(findCellChildAt.f25155p - findCellChildAt.b(), findCellChildAt.f25156q - findCellChildAt.c(), (findCellChildAt.f25155p + findCellChildAt.f25150k) - findCellChildAt.b(), (findCellChildAt.f25156q + findCellChildAt.f25151l) - findCellChildAt.c());
    ...
    public static final class SpoilerReveal {
        ...
        public void start(final View view, float f7, float f10, float f11, float f12) {
            if (!this.revealed && this.animator == null) {
                ...
                this.animator.setInterpolator(pr.f29470j);
    ...
    public static class Text implements org.telegram.ui.Cells.ba, bz0 {
        ...
        private void drawTranslationLoading(Canvas canvas) {
            ...
            if (this.translationLoadingDrawable == null) {
                ...
                h90Var2.f26692x = x80Var;
                h90Var2.j(5.0f);
                this.translationLoadingDrawable.f26673b = -1L;
                this.translationLoadingPath.reset();
                this.translationLoadingPath.d(this.layout, 0, 0.0f);
                this.translationLoadingPath.f32458n = false;
            ...
            RichMessageLayout richMessageLayout2 = this.root;
            if (richMessageLayout2.isOut()) {
                i10 = org.telegram.ui.ActionBar.j6.f20741hc;
            } else {
        ...
        private void revealSpoilers(int i10, int i11) {
            if (this.pressedSpoiler != null) {
                ...
                View view = this.view;
                this.pressedSpoiler.f48628q = new xh(this, view, this.root);
        ...
        public void drawFade(Canvas canvas, int i10, float f7) {
            ...
            if (richMessageLayout2.isOut()) {
                i12 = org.telegram.ui.ActionBar.j6.f20741hc;
            } else {
        ...
        public void draw(Canvas canvas, View view) {
            ...
            canvas.translate(-drawLeft(), 0.0f);
            RichMessageLayout richMessageLayout = this.root;
            int themedColor = richMessageLayout.getThemedColor(richMessageLayout.isOut() ? org.telegram.ui.ActionBar.j6.f20706fc : org.telegram.ui.ActionBar.j6.ec);
            this.root.textPaint.setColor(themedColor);
            RichMessageLayout richMessageLayout2 = this.root;
            richMessageLayout2.textPaint.linkColor = richMessageLayout2.getThemedColor(richMessageLayout2.isOut() ? org.telegram.ui.ActionBar.j6.f20741hc : org.telegram.ui.ActionBar.j6.gc);
    ...
    private void drawInternal(Canvas canvas, org.telegram.ui.Cells.s1 s1Var) {
        ...
        boolean z10 = t1Var != null && t1Var.f22870ae > 0;
        if (z10) {
            float f11 = t1Var.Yd - t1Var.f23095r0;
            f10 = t1Var.f22870ae + f11;
            f7 = f11;
        } else {
            f7 = 0.0f;
            f10 = 0.0f;
    ...
    private void drawShowMoreButton(Canvas canvas, int i10) {
        ...
        float f7 = this.showMoreText.f25848c;
        ...
        if (h90Var2 == null && z10) {
            ...
            h90Var3.f26691w.setStrokeWidth(AndroidUtilities.dp(1.25f));
    ...
    private boolean scrollToPageBlockAnchor(int i10) {
        ...
        recyclerView.v0(0, (((this.cell.getTop() + this.cell.f23095r0) + getBlockTop(i10, null)) - recyclerView.getPaddingTop()) - AndroidUtilities.dp(8.0f), null);
        return true;
    }
    ...
    public void draw(Canvas canvas, int i10, int i11, org.telegram.ui.Cells.s1 s1Var) {
        ...
        this.textPaint.linkColor = getThemedColor(isOut() ? org.telegram.ui.ActionBar.j6.f20741hc : org.telegram.ui.ActionBar.j6.gc);
    ...
    public boolean hasOverlay() {
        ...
        for (int i10 = 0; i10 < this.textBlocks.size(); i10++) {
            ...
            if ((baVar instanceof Text) && (v5Var = ((Text) baVar).animatedEmojiStack) != null && !v5Var.f31094a.isEmpty()) {
                return true;
            }
        }
        return false;
    ...
    public static class RichUnsupportedBlock extends RichBlock implements Drawable.Callback {
        ...
        public RichUnsupportedBlock(RichMessageLayout richMessageLayout, Rect rect, int i10, int i11, int i12) {
            ...
            g61Var.f26278n = LocaleController.getString(R.string.UnsupportedBlockTitle);
            g61Var.f26279o = LocaleController.getString(R.string.UnsupportedBlockMessage);
            g61Var.f26280p = LocaleController.getString(R.string.UnsupportedUpdate);
            g61Var.f26274j = new ug(richMessageLayout, 9);
            int i13 = this.maxWidth;
        ...
        public boolean onTouchEvent(MotionEvent motionEvent) {
            View view = this.view;
            if (view != null) {
                return this.unsupportedBlockDrawable.f26273i.a(motionEvent, view);
            }
            return super.onTouchEvent(motionEvent);
        }
    ...
    public CharSequence formatText(TL_iv.RichText richText, SpannableStringBuilder spannableStringBuilder, int i10) {
        ...
        if (richText instanceof TL_iv.textDiff) {
            ...
            if (richText instanceof TL_iv.textMath) {
                ...
                spannableStringBuilder.setSpan(new g01(null, textmath.bitmap, textmath.f20094w, textmath.h, org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.G6, this.resourcesProvider), textmath.depth), length, length2, 33);
    ...
    public static class RichAudioBlock extends RichBlock implements DownloadController.FileDownloadProgressListener, NotificationCenter.NotificationCenterDelegate {
        ...
        public void onAttachedToWindow() {
            ...
            if (view != null) {
                ...
                this.seekBar.f24771s = this.view;
            }
            updateButtonState(false);
        ...
        public void onDraw(Canvas canvas) {
            ...
            if (this.currentMessageObject != null && this.currentDocument != null) {
                ...
                if (this.root.isOut()) {
                    ...
                    i11 = org.telegram.ui.ActionBar.j6.f20780je;
                }
                if (this.root.isOut()) {
                    i12 = org.telegram.ui.ActionBar.j6.Pa;
                } else {
                    i12 = org.telegram.ui.ActionBar.j6.f20979uc;
                }
                if (this.root.isOut()) {
                    i13 = org.telegram.ui.ActionBar.j6.Qa;
                } else {
                    i13 = org.telegram.ui.ActionBar.j6.f20996vc;
                }
                ...
                RichMessageLayout richMessageLayout3 = this.root;
                if (richMessageLayout3.isOut()) {
                    i15 = org.telegram.ui.ActionBar.j6.f21014wb;
                } else {
                    i15 = org.telegram.ui.ActionBar.j6.f20980ud;
                }
                ...
                if (richMessageLayout4.isOut()) {
                    i16 = org.telegram.ui.ActionBar.j6.f21031xb;
                } else {
                    i16 = org.telegram.ui.ActionBar.j6.f20997vd;
                }
                ...
                if (richMessageLayout5.isOut()) {
                    i17 = org.telegram.ui.ActionBar.j6.f21067zb;
                } else {
                    i17 = org.telegram.ui.ActionBar.j6.f21032xd;
                }
                ...
                if (richMessageLayout6.isOut()) {
                    i18 = org.telegram.ui.ActionBar.j6.f21067zb;
                } else {
                    i18 = org.telegram.ui.ActionBar.j6.f21032xd;
                }
                ...
                if (richMessageLayout7.isOut()) {
                    i19 = org.telegram.ui.ActionBar.j6.f21048yb;
                } else {
                    i19 = org.telegram.ui.ActionBar.j6.f21015wd;
                }
    ...
    public static class RichDocumentBlock extends RichBlock implements DownloadController.FileDownloadProgressListener {
        ...
        public void onDraw(Canvas canvas) {
            ...
            if (richMessageLayout3.isOut()) {
                ...
                i11 = org.telegram.ui.ActionBar.j6.f20852nd;
            }
            ...
            if (canShowOptions()) {
                if (this.root.isOut()) {
                    ...
                    drawable = org.telegram.ui.ActionBar.j6.f20644c4;
                }
                int menuX = getMenuX();
        ...
        public void updateButtonState(boolean z10) {
            ...
            int i14;
            if (this.hasPreview) {
                this.radialProgress.g(org.telegram.ui.ActionBar.j6.f20818le, org.telegram.ui.ActionBar.j6.f20836me, org.telegram.ui.ActionBar.j6.ne, org.telegram.ui.ActionBar.j6.f20870oe);
                this.radialProgress.d = this.root.getThemedColor(org.telegram.ui.ActionBar.j6.f20742hd);
            } else {
                RadialProgress2 radialProgress2 = this.radialProgress;
                if (this.root.isOut()) {
                    i10 = org.telegram.ui.ActionBar.j6.Nb;
