...
public class RichMessageLayout {
    ...
    public static class PreviewView extends View implements TextSelectionHelper.ArticleSelectableView {
        ...
        public static class PaddedTextLayoutBlock implements TextSelectionHelper.TextLayoutBlock {
            private final TextSelectionHelper.TextLayoutBlock inner;
            private final int px;
            private final int py;

            public PaddedTextLayoutBlock(TextSelectionHelper.TextLayoutBlock textLayoutBlock, int i, int i2) {
        ...
        public void lambda$onTouchEvent$0() {
            ...
            if (richMessageLayout == null || !richMessageLayout.isPressingLink()) {
                this.textSelectionHelper.trySelect();
            }
        }
    ...
    public static abstract class RichBlock implements MultiLayoutTypingAnimator.Block {
        ...
        private void toggleCheckbox() {
            if (canToggleCheckbox()) {
                if (!MessagesController.getInstance(this.root.currentAccount).richEditorAllowed()) {
                    new PremiumFeatureBottomSheet(this.root.cell.getContext(), 43, this.root.resourcesProvider).show();
                    return;
                }
                boolean z = !getCheckboxChecked();
        ...
        public static CharSequence withReplacements(CharSequence charSequence) {
            ...
            Arrays.sort(replaceCopyTextSpannableArr, new RichMessageLayout$Text$$ExternalSyntheticLambda3(spanned, 1));
        ...
        public void getBlockAccessibilityElementBounds(int i, Rect rect) {
            int i2 = this.padding.left;
            float f = this.currY;
            rect.set(i2, (int) f, this.maxWidth + i2, (int) (f + getHeight()));
        }
        ...
        public CharSequence getBlockAccessibilityElementStateDescription(int i) {
            return null;
        }

        public CharSequence getBlockAccessibilityElementText(int i) {
            return null;
        }
        ...
        public boolean isBlockAccessibilityElementText(int i) {
            return false;
        }
        ...
        public boolean onBlockAccessibilityElementClick(int i, View view) {
            return false;
        }
        ...
        public void draw(Canvas canvas, int i, float f) {
            ...
            if (this.numLayout != null) {
                ...
                if (!this.listOrdered && !this.listCheckbox) {
                    ...
                    canvas.drawCircle(zIsRtl ? ((AndroidUtilities.dp(18.0f) + f2) - AndroidUtilities.dpf2(5.66f)) - (fDpf2 / 2.0f) : ((fDpf2 / 2.0f) + AndroidUtilities.dpf2(5.66f)) - AndroidUtilities.dp(18.0f), (this.numLayoutY + this.numLayout.getLineBaseline(0)) - (AndroidUtilities.dp(SharedConfig.fontSize) * 0.35f), fDpf2 / 2.0f, this.root.numTextPaint);
                } else if (zIsRtl) {
    ...
    public static class RichButton {
        ...
        private void drawLoading(Canvas canvas) {
            ...
            if (loadingDrawable != null) {
                if (z || loadingDrawable.isDisappearing()) {
                    ...
                    this.loadingDrawable.setColors(Theme.multAlpha(0.07f, this.textColor), Theme.multAlpha(0.175f, this.textColor), Theme.multAlpha(0.175f, this.textColor), Theme.multAlpha(0.42f, this.textColor));
        ...
        private static int getButtonIcon(TL_keyboard.InlineButtonType inlineButtonType) {
            ...
            if (inlineButtonType instanceof TL_keyboard.TL_inlineButtonTypeUrl) {
                return LinkManager.isWebAppLink(((TL_keyboard.TL_inlineButtonTypeUrl) inlineButtonType).url) ? R.drawable.bot_webview : R.drawable.mini_inline_arrow_16;
            }
        ...
        public float getPressScale() {
            ...
            return DiffUtil.m(1.0f, this.pressT, f2, 1.0f - f2);
        }
        ...
        public void setTextColorKey(int i) {
            ...
            if (this.isDisabled) {
                themedColor = Theme.multAlpha(0.5f, themedColor);
            }
        ...
        public void updateColors() {
            ...
            boolean z2 = this.out;
            int i = z2 ? ivButtonColors.backgroundOut : ivButtonColors.backgroundIn;
            int i2 = z2 ? ivButtonColors.backgroundOutPressed : ivButtonColors.backgroundInPressed;
            int i3 = z2 ? ivButtonColors.textOut : ivButtonColors.textIn;
            int themedColor4 = this.layout.getThemedColor(i3);
            this.needSaveLayer = false;
            if (z && ivButtonColors == Theme.IvButtonColors.PRIMARY) {
                int themedColor5 = this.layout.getThemedColor(i3);
                this.backgroundPressedColor = themedColor5;
                this.backgroundColor = themedColor5;
                this.needSaveLayer = true;
            } else {
                if (Theme.hasThemeKey(i) || ivButtonColors == Theme.IvButtonColors.PRIMARY) {
                    this.backgroundColor = this.layout.getThemedColor(i);
                    if (Theme.hasThemeKey(i2)) {
                        this.backgroundPressedColor = this.layout.getThemedColor(i2);
                    } else {
                        this.backgroundPressedColor = ColorUtils.blendARGB(0.1f, this.backgroundColor, themedColor4);
                    }
                } else {
                    this.backgroundColor = Theme.multAlpha(ivButtonColors == Theme.IvButtonColors.DEFAULT ? 0.08f : 0.1f, this.layout.getThemedColor(i3));
                    this.backgroundPressedColor = Theme.multAlpha(0.16f, this.layout.getThemedColor(i3));
                }
            }
            setTextColorKey(i3);
        }
        ...
        public RichButton(RichMessageLayout richMessageLayout, int i, CharSequence charSequence, TL_keyboard.PageButton pageButton, TL_keyboard.InlineButtonType inlineButtonType, TL_keyboard.RichButtonStyle richButtonStyle, boolean z, boolean z2, boolean z3, boolean z4, boolean z5, boolean z6, Boolean bool, Runnable runnable) {
            ...
            if (richButtonStyle != null) {
                Theme.IvButtonColors ivButtonColors2 = Theme.IvButtonColors.DEFAULT;
                if (richButtonStyle.bg_primary) {
                    ivButtonColors = Theme.IvButtonColors.PRIMARY;
                } else if (richButtonStyle.bg_danger) {
                    ivButtonColors = Theme.IvButtonColors.DANGER;
                } else if (richButtonStyle.bg_success) {
                    ivButtonColors = Theme.IvButtonColors.SUCCESS;
                } else {
                    ivButtonColors = Theme.IvButtonColors.DEFAULT;
                }
            } else {
            ...
            if (ivButtonColors == Theme.IvButtonColors.DEFAULT && z6) {
    ...
    public static class RichButtonRowBlock extends RichBlock {
        ...
        public RichButtonRowBlock(RichMessageLayout richMessageLayout, Rect rect, int i, TL_iv.pageBlockButtonRow pageblockbuttonrow) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                this.buttons[i2] = new RichButton(richMessageLayout, i, pageblockbuttonrow.buttons.get(i2), new SecretChatHelper$$ExternalSyntheticLambda22(this, 8));
            }
        ...
        private void layout(int i) {
            ...
            for (RichButton richButton2 : this.buttons) {
                i2 += richButton2.width;
            }
            int iOrdinal = this.align.ordinal();
            int i4 = iOrdinal != 1 ? iOrdinal != 2 ? 0 : (i - i2) / 2 : i - i2;
            for (RichButton richButton3 : this.buttons) {
                richButton3.x = i4;
                i4 += richButton3.width + iDp;
            }
        }
    ...
    public static class RichButtonSpan extends ReplacementSpan {
        ...
        public void draw(Canvas canvas, CharSequence charSequence, int i, int i2, float f, int i3, int i4, int i5, Paint paint) {
            ...
            rectF.set(f3, f4, iRound + richButton.width, richButton.getHeight() + iCeil);
        ...
        private RichButtonSpan(RichMessageLayout richMessageLayout, int i, TL_iv.textButton textbutton, Boolean bool) {
            ...
            RichButton richButton = new RichButton(richMessageLayout, i, text, null, inlineButtonType, textbutton.style, inlineButtonType instanceof TL_keyboard.TL_inlineButtonTypeDisabled, true, z, z2, z4, true, bool, new SecretChatHelper$$ExternalSyntheticLambda22(this, 9));
    ...
    public static class RichCollageBlock extends RichBlock {
        ...
        private void updateRoundRadius(ImageReceiver imageReceiver, int i, boolean z) {
            ...
            int iDp2 = i7 > 2 ? AndroidUtilities.dp(i7 - 2) : AndroidUtilities.dp(i7);
            int iMin = Math.min(AndroidUtilities.dp(3.0f), iDp2);
            if (z2 && z4) {
                i2 = (!this.first || this.root.hasNameOffset() || (!this.root.isOut() && this.root.isPinnedTop())) ? iMin : iDp2;
            } else {
                i2 = 0;
            }
            if (!z2 || !z5) {
            ...
            imageReceiver.setRoundRadius(i2, iDp2, i8, i3);
        }
        ...
        public void onDraw(Canvas canvas) {
            ...
            while (i4 < this.cells.size()) {
                ...
                if (mediaCell.imageReceiver.hasBitmapImage() && mediaCell.imageReceiver.getCurrentAlpha() == 1.0f) {
                    ...
                    int i5 = mediaCell.y;
                    canvas2 = canvas;
                    canvas2.drawRect(f2, i5, iRound + iRound2, i5 + mediaCell.h, mediaBgPaint);
                }
        ...
        public boolean onTouchEvent(MotionEvent motionEvent) {
            ...
            try {
                if (actionMasked != 0) {
                    MediaCell mediaCell = this.pressedCell;
                    if (mediaCell == null) {
                        Rect rect2 = this.padding;
                        motionEvent.offsetLocation(rect2.left, rect2.top);
                        return false;
                    }
                    boolean zOnTouchEvent = mediaCell.onTouchEvent(motionEvent, this.view);
                    if (actionMasked == 1 || actionMasked == 3) {
                ...
                for (int i = 0; i < this.cells.size(); i++) {
                    MediaCell mediaCell2 = this.cells.get(i);
                    if (mediaCell2.isInside(motionEvent.getX(), motionEvent.getY()) && mediaCell2.onTouchEvent(motionEvent, this.view)) {
                        this.pressedCell = mediaCell2;
    ...
    public static class RichDetailsBlock extends RichBlock {
        ...
        public boolean findLink(CharacterStyle characterStyle, int i, FoundLink foundLink) {
            ...
            foundLink.x = (AndroidUtilities.dp(53.0f) + (this.padding.left - this.root.padLeft)) - this.title.left;
            foundLink.y = AndroidUtilities.dp(14.0f) + i + this.padding.top;
            return true;
        }
        ...
        public void onDraw(Canvas canvas) {
            ...
            this.linePaint.setColor(richMessageLayout3.getThemedColor(richMessageLayout3.isOut() ? Theme.key_chat_outArticleDetailsLine : Theme.key_chat_inArticleDetailsLine));
        ...
        public void placeTexts(int i, int i2, int i3) {
            ...
            this.layoutY = i2;
            this.layoutRow = i3;
            this.title.setX((AndroidUtilities.dp(53.0f) + (i - this.root.padLeft)) - this.title.left);
            this.title.setY(AndroidUtilities.dp(14.0f) + i2);
    ...
    public static class RichDetailsEndBlock extends RichBlock {
        ...
        public void onDraw(Canvas canvas) {
            ...
            RichMessageLayout richMessageLayout = this.root;
            paint.setColor(richMessageLayout.getThemedColor(richMessageLayout.isOut() ? Theme.key_chat_outArticleDetailsLine : Theme.key_chat_inArticleDetailsLine));
            RichMessageLayout richMessageLayout2 = this.root;
            float f = -richMessageLayout2.padLeft;
            int minWidth = richMessageLayout2.getMinWidth();
            RichMessageLayout richMessageLayout3 = this.root;
            int i = minWidth + richMessageLayout3.padRight;
            Rect rect = this.padding;
            float f2 = (i - rect.left) - rect.right;
            float fLerp = 0.0f;
            if (richMessageLayout3.detailsAnimating) {
    ...
    public static class RichDocumentBlock extends RichBlock implements DownloadController.FileDownloadProgressListener {
        ...
        private void rebuildLayouts() {
            ...
            CharSequence charSequenceEllipsize = TextUtils.ellipsize(document == null ? "" : FileLoader.getDocumentFileName(document), this.titlePaint, iM, TextUtils.TruncateAt.END);
            TextPaint textPaint = this.titlePaint;
            Layout.Alignment alignment = Layout.Alignment.ALIGN_NORMAL;
            this.titleLayout = new StaticLayout(charSequenceEllipsize, textPaint, iM, alignment, 1.0f, 0.0f, false);
            TLRPC.Document document2 = this.document;
            this.sizeLayout = new StaticLayout(document2 != null ? AndroidUtilities.formatFileSize(document2.size) : "", this.sizePaint, iM, alignment, 1.0f, 0.0f, false);
        }
        ...
        public void onDraw(Canvas canvas) {
            ...
            canvas2.save();
            float f = iDp;
            canvas2.translate(f, iDp2);
            this.titleLayout.draw(canvas2);
            canvas2.restore();
            canvas2.save();
            canvas2.translate(f, iDp3);
            this.sizeLayout.draw(canvas2);
            canvas2.restore();
            if (canShowOptions()) {
                Drawable themedDrawable = this.root.isOut() ? this.root.getThemedDrawable("drawableMsgOutMenu") : Theme.chat_msgInMenuDrawable;
                int menuX = getMenuX();
        ...
        public boolean onTouchEvent(MotionEvent motionEvent) {
            ...
            if (!this.optionsPressed) {
                ...
                if (x >= i || x > this.layoutWidth - AndroidUtilities.dp(12.0f) || y < AndroidUtilities.dp(10.0f)) {
                    z = false;
                } else {
    ...
    public static class RichMathBlock extends RichBlock {
        ...
        public void onDraw(Canvas canvas) {
            ...
            if (this.maxScrollX > 0) {
                ...
                Rect rect = this.padding;
                canvas2 = canvas;
                canvas2.saveLayerAlpha(f, 0.0f, (minWidth - rect.left) - rect.right, iM, 255, 31);
                canvas2.save();
            ...
            if (this.maxScrollX > 0) {
                ...
                float f2 = iM;
                rectF.set(i, 0.0f, AndroidUtilities.dp(12.0f) + i, f2);
    ...
    public static abstract class RichMediaBlock extends RichBlock implements DownloadController.FileDownloadProgressListener {
        ...
        public RichMediaBlock(RichMessageLayout richMessageLayout, Rect rect, int i, boolean z) {
            ...
            imageReceiver.setDelegate(new ImageReceiver.ImageReceiverDelegate() {
                ...
                @Override
                public final void didSetImageBitmap(int i2, String str, Drawable drawable) {
        ...
        private void drawMediaSpoiler(Canvas canvas) {
            ...
            if (mediaSpoilerEffect != null) {
                ...
                canvas2 = canvas;
                mediaSpoilerEffect.draw(canvas2, this.view, Math.round(imageWidth), Math.round(imageHeight), this.imageReceiver.getCurrentAlpha(), false);
            } else {
                canvas2 = canvas;
            }
            canvas2.restore();
        ...
        private void updateRoundRadius(ImageReceiver imageReceiver, boolean z) {
            ...
            int iDp = i > 2 ? AndroidUtilities.dp(i - 2) : AndroidUtilities.dp(i);
        ...
        public void updateButtonState(boolean z) {
            ...
            if (fileExists() || (isAnimatedContent() && z2)) {
                ...
                if (isRealVideo() && !z2) {
                    ...
                    RadialProgress2 radialProgress4 = this.radialProgress;
                    if (radialProgress4 != null) {
                        radialProgress4.setIcon(4, false, z);
                    }
                } else {
                    this.buttonState = 2;
                    RadialProgress2 radialProgress5 = this.radialProgress;
                    if (radialProgress5 != null) {
                        radialProgress5.setIcon(8, false, z);
                    }
                }
            } else {
    ...
    public static class RichPreformattedBlock extends RichBlock {
        ...
        private void drawBackground(Canvas canvas) {
            ...
            RichMessageLayout richMessageLayout = this.root;
            paint.setColor(richMessageLayout.getThemedColor(richMessageLayout.isOut() ? Theme.key_chat_outArticleCodeBackground : Theme.key_chat_inArticleCodeBackground));
        ...
        private void drawScrollbar(Canvas canvas) {
            ...
            Paint paint = this.bgPaint;
            RichMessageLayout richMessageLayout2 = this.root;
            paint.setColor(richMessageLayout2.getThemedColor(richMessageLayout2.isOut() ? Theme.key_chat_outArticleCodeScrollbarBackground : Theme.key_chat_inArticleCodeScrollbarBackground));
            ...
            float f3 = (((f2 - fMin) * this.scrollX) / this.maxScrollX) + fDp;
            Paint paint2 = this.bgPaint;
            RichMessageLayout richMessageLayout3 = this.root;
            paint2.setColor(richMessageLayout3.getThemedColor(richMessageLayout3.isOut() ? Theme.key_chat_outArticleCodeScrollbar : Theme.key_chat_inArticleCodeScrollbar));
            canvas.drawRoundRect(f3, fDp3, f3 + fMin, fDp4, fDp5, fDp5, this.bgPaint);
        }
        ...
        private void drawTextContent(Canvas canvas, boolean z, int i, float f) {
            ...
            rectF.set(i2, 0.0f, AndroidUtilities.dp(12.0f) + i2, f4);
            ...
            rectF.set(i3 - AndroidUtilities.dp(12.0f), 0.0f, i3, f4);
        ...
        public boolean findLink(CharacterStyle characterStyle, int i, FoundLink foundLink) {
            ...
            foundLink.y = AndroidUtilities.dp(15.0f) + i + this.padding.top;
            return true;
        }
        ...
        public void placeTexts(int i, int i2, int i3) {
            ...
            this.layoutY = i2;
            this.layoutRow = i3;
            this.text.setX(((AndroidUtilities.dp(0.0f) + i) - this.scrollX) - this.text.left);
            this.text.setY(AndroidUtilities.dp(15.0f) + i2);
            this.text.setRow(i3);
        }
    }
    ...
    public static class RichSlideshowBlock extends RichBlock {
        ...
        private void settle(float f) {
            ...
            this.settleAnimator.addListener(new AnimatorListenerAdapter() {
                @Override
                public void onAnimationEnd(Animator animator) {
                    RichSlideshowBlock.this.currentPage = i4;
        ...
        public void onDraw(Canvas canvas) {
            ...
            boolean zIsInQuote = isInQuote();
            int iDp = AndroidUtilities.dp(2.0f);
            int i5 = zIsInQuote ? 0 : this.root.padLeft - iDp;
            int i6 = zIsInQuote ? 0 : this.root.padRight - iDp;
            int i7 = this.slideWidth + i5 + i6;
            canvas.save();
            if (zIsInQuote) {
                ...
                int iDp3 = i8 > 2 ? AndroidUtilities.dp(i8 - 2) : AndroidUtilities.dp(i8);
                int iMin = Math.min(AndroidUtilities.dp(3.0f), iDp3);
                int i9 = ((this.root.isOut() || !this.root.isPinnedTop()) && !this.root.hasNameOffset()) ? iDp3 : iMin;
                ...
                this.clipPath.rewind();
                f2 = 3.0f;
                this.clipPath.addRoundRect(-i5, 0.0f, this.slideWidth + i6, this.slideHeight, new float[]{f5, f5, f6, f6, f7, f7, f7, f7}, Path.Direction.CW);
                canvas.clipPath(this.clipPath);
                i2 = iDp3;
                i3 = iMin;
                i4 = i3;
                ...
                f = 2.0f;
                f2 = 3.0f;
                canvas.clipRect(-i5, 0, this.root.getMinWidth() + i6, this.slideHeight);
                i = 0;
                i2 = 0;
                i3 = 0;
                i4 = 0;
            ...
            float f8 = 0.0f;
            if ((i10 == 0 && this.pageOffset < 0.0f) || (i10 == this.cells.size() - 1 && this.pageOffset > 0.0f)) {
                RichMessageLayout richMessageLayout = this.root;
                canvas.drawColor(Theme.multAlpha(0.2f, richMessageLayout.getThemedColor(richMessageLayout.isOut() ? Theme.key_chat_outReplyNameText : Theme.key_chat_inReplyNameText)));
            }
            float f9 = i7;
            float f10 = (-this.pageOffset) * f9;
            int i11 = this.currentPage - 1;
            for (int i12 = 1; i11 <= this.currentPage + i12; i12 = 1) {
                if (i11 < 0 || i11 >= this.cells.size()) {
                    i11 = i11;
                    f3 = f9;
                } else {
                    MediaCell mediaCell = this.cells.get(i11);
                    canvas.save();
                    canvas.translate(((i11 - this.currentPage) * i7) + f10, f8);
                    mediaCell.imageReceiver.setRoundRadius(i11 == 0 ? i : 0, i11 == this.cells.size() - i12 ? i2 : 0, i11 == this.cells.size() + (-1) ? i3 : 0, i11 == 0 ? i4 : 0);
                    mediaCell.blurImageReceiver.setRoundRadius(i11 == 0 ? i : 0, i11 == this.cells.size() + (-1) ? i2 : 0, i11 == this.cells.size() + (-1) ? i3 : 0, i11 == 0 ? i4 : 0);
                    float f11 = -i5;
                    mediaCell.imageReceiver.setImageCoords(f11, 0.0f, f9, this.slideHeight);
                    if (mediaCell.imageReceiver.hasBitmapImage() && mediaCell.imageReceiver.getCurrentAlpha() == 1.0f) {
                        f3 = f9;
                    } else {
                        f3 = f9;
                        canvas.drawRect(f11, 0.0f, i7 + i6, this.slideHeight, mediaBgPaint);
                    }
            ...
            if (size > 1) {
                ...
                if (iDp4 < i7) {
                    ...
                    int iDp6 = ((i7 - AndroidUtilities.dp(8.0f)) / 2) / iDp5;
                    fClamp = fDp2 - (Utilities.clamp(f12 - iDp6, Math.max(0, (size - (iDp6 * 2)) - 1), 0.0f) * iDp5);
                }
                canvas.save();
                canvas.clipRect(0, this.slideHeight - AndroidUtilities.dp(23.0f), i7, this.slideHeight);
                for (int i13 = 0; i13 < size; i13++) {
                    float fMax = Math.max(0.0f, 1.0f - Math.abs(i13 - f12));
                    float fDp3 = (AndroidUtilities.dp(1.0f) * fMax) + AndroidUtilities.dp(f);
        ...
        public boolean onTouchEvent(MotionEvent motionEvent) {
            ...
            try {
                ...
                if (actionMasked != 2) {
                    ...
                    boolean zOnTouchEvent = this.cells.get(this.currentPage).onTouchEvent(motionEvent, this.view);
                ...
                if (this.verticalDragging) {
                    ...
                    motionEvent.offsetLocation(rect8.left, rect8.top);
                    return true;
                }
                VelocityTracker velocityTracker4 = this.velocityTracker;
                if (velocityTracker4 != null) {
                ...
                if (!this.dragging && Math.abs(y) > this.touchSlop && Math.abs(y) > Math.abs(x)) {
                    ...
                    requestDisallowParentIntercept(false);
                    Rect rect9 = this.padding;
                    motionEvent.offsetLocation(rect9.left, rect9.top);
                    return true;
                }
                ...
                if (!this.dragging) {
                    ...
                    if (i5 < 0 || i5 >= this.cells.size()) {
                        Rect rect10 = this.padding;
                        motionEvent.offsetLocation(rect10.left, rect10.top);
                        return false;
                    }
                    boolean zOnTouchEvent2 = this.cells.get(this.currentPage).onTouchEvent(motionEvent, this.view);
                    Rect rect11 = this.padding;
                    motionEvent.offsetLocation(rect11.left, rect11.top);
                    return zOnTouchEvent2;
                }
                ...
                if (i6 == this.cells.size() - 1 && f2 > 0.0f) {
                    f2 *= 0.3f;
                }
                this.pageOffset = f2;
                View view2 = this.view;
                ...
                Rect rect12 = this.padding;
                motionEvent.offsetLocation(rect12.left, rect12.top);
                return true;
            } catch (Throwable th) {
                Rect rect13 = this.padding;
                motionEvent.offsetLocation(rect13.left, rect13.top);
                throw th;
            }
        }
    ...
    public static class RichTableBlock extends RichBlock implements TableLayout.TableLayoutDelegate {
        ...
        private void drawCellsWithTyping(Canvas canvas, MultiLayoutTypingAnimator multiLayoutTypingAnimator, float f) {
            ...
            rectF.set(i4, 0.0f, AndroidUtilities.dp(12.0f) + i4, this.contentHeight);
            this.root.clip.draw(canvas, rectF, 0, 1.0f);
        ...
        public boolean drawOverlay(Canvas canvas, ColorFilter colorFilter) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                ...
                if (emojiGroupedSpans3 != null && !emojiGroupedSpans3.holders.isEmpty()) {
                    ...
                    int i3 = 0;
                    while (i3 < childCount) {
                        TableLayout.Child childAt = this.tableLayout.getChildAt(i3);
                        TableLayout.CellText cellText = childAt.textLayout;
                    ...
                    int minWidth2 = this.root.getMinWidth() + this.root.padRight;
                    Rect rect3 = this.padding;
                    int i5 = (minWidth2 - rect3.left) - rect3.right;
                    rectF.set(i5 - AndroidUtilities.dp(12.0f), 0.0f, i5, this.contentHeight);
                    this.root.clip.draw(canvas, rectF, 2, 1.0f);
                    canvas.restoreToCount(iSaveLayerAlpha);
                    canvas.restore();
        ...
        public void onDraw(Canvas canvas) {
            ...
            RectF rectF = AndroidUtilities.rectTmp;
            int i2 = -this.root.padLeft;
            rectF.set(i2, 0.0f, AndroidUtilities.dp(12.0f) + i2, this.contentHeight);
            this.root.clip.draw(canvas, rectF, 0, 1.0f);
            int minWidth2 = this.root.getMinWidth() + this.root.padRight;
            Rect rect2 = this.padding;
    ...
    public static class RichTextBlockQuote extends RichTextBlock {
        ...
        public void onDraw(Canvas canvas) {
            ...
            if (z) {
                ...
                RectF rectF = AndroidUtilities.rectTmp;
                rectF.set(0.0f, i - AndroidUtilities.dp(24.0f), this.maxWidth, 1 + i);
            ...
            int minWidth = this.root.getMinWidth() - AndroidUtilities.dp(24.0f);
            int iDp = AndroidUtilities.dp(8.0f) + ((i - AndroidUtilities.dp(16.0f)) - AndroidUtilities.dp(2.0f));
            ...
            if (drawable2 != null) {
                ...
                DrawableUtils.setBounds(rect, f, f2, iDp2, iDp3, 17);
    ...
    public static class RichTextWithAuthorBlock extends RichBlock {
        ...
        public boolean findLink(CharacterStyle characterStyle, int i, FoundLink foundLink) {
            ...
            foundLink.y = this.text.getHeight() + i + this.padding.top + gap();
            return true;
        }
        ...
        public void placeTexts(int i, int i2, int i3) {
            ...
            if (text2 != null) {
                ...
                this.author.setY(this.text.getHeight() + i2 + gap());
    ...
    public static class RichThinkingBlock extends RichBlock {
        ...
        private void updateGradient() {
            ...
            if (this.gradient == null || this.gradientColor != themedColor) {
                ...
                LinearGradient linearGradient = new LinearGradient(0.0f, 0.0f, this.maxWidth, 0.0f, new int[]{Theme.multAlpha(0.7f, themedColor), Theme.multAlpha(0.25f, themedColor), Theme.multAlpha(0.7f, themedColor)}, new float[]{0.0f, 0.5f, 1.0f}, Shader.TileMode.REPEAT);
        ...
        public void onDrawFaded(Canvas canvas, int i, float f) {
            ...
            MultiLayoutTypingAnimator.drawLayoutWithLastLineFade(canvas, this.text.layout, i, f, new GoogleMapsProvider$GoogleMapImpl$$ExternalSyntheticLambda3(4, this, this.view));
            canvas.restore();
    ...
    public static final class SpoilerReveal {
        ...
        public void start(final View view, float f, float f2, float f3, float f4) {
            if (this.revealed || this.animator != null) {
                return;
            }
            this.cx = f;
            this.cy = f2;
            this.maxR = (float) Math.sqrt((f4 * f4) + (f3 * f3));
            ...
            this.animator.addUpdateListener(new MediaController$$ExternalSyntheticLambda20(1, this, view));
    ...
    public static class StyleSpan extends MetricAffectingSpan {
        ...
        public int getTextColor() {
            ...
            if (i == 10) {
                RichMessageLayout richMessageLayout2 = this.root;
                return Theme.multAlpha(0.5f, richMessageLayout2.getThemedColor(richMessageLayout2.isOut() ? Theme.key_chat_messageTextOut : Theme.key_chat_messageTextIn));
            }
            RichMessageLayout richMessageLayout3 = this.root;
        ...
        public Typeface getTypeface() {
            ...
            boolean z = true;
            if (i2 >= 1 && i2 <= 6) {
                return TLObject.hasFlag(i, 32) ? AndroidUtilities.getTypeface("fonts/mw_bolditalic.ttf") : AndroidUtilities.getTypeface("fonts/mw_bold.ttf");
            }
    ...
    public static class Text implements TextSelectionHelper.TextLayoutBlock, TableLayout.CellText {
        ...
        public static class EmojiLineMetrics {
            ...
            public static int access$1412(EmojiLineMetrics emojiLineMetrics, int i) {
            ...
            public static int access$1512(EmojiLineMetrics emojiLineMetrics, int i) {
        ...
        private void drawTranslationLoading(Canvas canvas) {
            ...
            this.translationLoadingDrawable.setColors(Theme.multAlpha(0.05f, themedColor), Theme.multAlpha(0.15f, themedColor), Theme.multAlpha(0.1f, themedColor), Theme.multAlpha(0.3f, themedColor));
        ...
        public void lambda$revealSpoilers$4(View view, RichMessageLayout richMessageLayout) {
            ...
            view.post(new RichMessageLayout$Text$$ExternalSyntheticLambda2(this, richMessageLayout, view));
        }
        ...
        private static EmojiLineMetrics measureEmojiLine(Spanned spanned, int i, int i2, TextPaint textPaint) {
            ...
            if (i3 > 0) {
                ...
                if (iArr != null || richButtonSpanArr != null) {
                    ...
                    while (iCharCount < i2) {
                        int i8 = iCharCount - i;
                        RichButtonSpan richButtonSpan2 = richButtonSpanArr == null ? null : richButtonSpanArr[i8];
        ...
        private void revealSpoilers(int i, int i2) {
            ...
            View view = this.view;
            this.pressedSpoiler.onRippleEndCallback = new RichMessageLayout$Text$$ExternalSyntheticLambda2(this, view, this.root);
            Iterator<SpoilerEffect> it = this.spoilers.iterator();
            while (it.hasNext()) {
                it.next().startRipple(i, i2, fSqrt, false);
            }
            if (view != null) {
                view.playSoundEffect(0);
            }
        ...
        private void scheduleLongPress() {
            cancelLongPress();
            SecretChatHelper$$ExternalSyntheticLambda22 secretChatHelper$$ExternalSyntheticLambda22 = new SecretChatHelper$$ExternalSyntheticLambda22(this, 11);
            this.longPressRunnable = secretChatHelper$$ExternalSyntheticLambda22;
            AndroidUtilities.runOnUIThread(secretChatHelper$$ExternalSyntheticLambda22, ViewConfiguration.getLongPressTimeout());
        }
        ...
        public boolean onTouchEvent(MotionEvent motionEvent) {
            ...
            if (actionMasked != 0) {
                if (actionMasked == 2) {
                    ...
                    if (!buttonContains(richButtonSpan, iDrawLeft, y)) {
                        cancelLongPress();
            ...
            for (SpoilerEffect spoilerEffect : this.spoilers) {
                if (spoilerEffect.getBounds().contains(iDrawLeft, y)) {
            ...
            if (buttonSpans != null) {
                for (RichButtonSpan richButtonSpan3 : buttonSpans) {
                    if (buttonContains(richButtonSpan3, iDrawLeft, y)) {
        ...
        public Text(RichMessageLayout richMessageLayout, CharSequence charSequence, int i, Layout.Alignment alignment, float f) {
            ...
            if (iEmojiOnlyCount == 0 && (charSequenceConfigureEmojiLineHeights instanceof Spanned)) {
                ...
                if (richButtonSpanArr.length > 0) {
                    Arrays.sort(richButtonSpanArr, new RichMessageLayout$Text$$ExternalSyntheticLambda3(spanned, 0));
            ...
            SpoilerEffect.addSpoilers(null, this.layout, this.spoilersPool, this.spoilers);
            if (this.layout.getText() instanceof Spanned) {
    ...
    private void appendSelectionPiece(StringBuilder sb, CharSequence charSequence, int i, int i2, boolean z) {
        ...
        SpannableStringBuilder richHtmlSpannable = toRichHtmlSpannable(charSequence.subSequence(i, i2));
        StringBuilder sb2 = new StringBuilder();
        RichHtml.appendInline(sb2, richHtmlSpannable);
    ...
    public static MessageObject.GroupedMessagePosition[] computeGrouped(float[] fArr) {
        ...
        if (length != 0) {
            ...
            for (int i2 = 0; i2 < length; i2++) {
                ...
                groupedMessagePositionArr[i2] = groupedMessagePosition;
            ...
            Point point = AndroidUtilities.displaySize;
            float f5 = 1000;
            int iMin = (int) (fDp / (Math.min(point.x, point.y) / f5));
            float fDp2 = AndroidUtilities.dp(40.0f);
            Point point2 = AndroidUtilities.displaySize;
            int iMin2 = (int) (fDp2 / (Math.min(point2.x, point2.y) / f5));
            float f6 = f5 / 814.0f;
            ...
            if (length == 1) {
                ...
                groupedMessagePosition2.set(0, 0, 0, 0, 1000, Math.round(Math.min(f5 / groupedMessagePosition2.aspectRatio, 407.0f)) / 814.0f, 15);
            ...
            if (!z && (length == 2 || length == 3 || length == 4)) {
                if (length == 2) {
                    ...
                    if (string.equals("ww") && f4 > f6 * 1.4f) {
                        float f7 = groupedMessagePosition3.aspectRatio;
                        float f8 = groupedMessagePosition4.aspectRatio;
                        if (f7 - f8 < 0.2f) {
                            float fRound = Math.round(Math.min(f5 / f7, Math.min(f5 / f8, 407.0f))) / 814.0f;
                    ...
                    if (string.equals("ww") || string.equals("qq")) {
                        float f9 = 500;
                        float fRound2 = Math.round(Math.min(f9 / groupedMessagePosition3.aspectRatio, Math.min(f9 / groupedMessagePosition4.aspectRatio, 814.0f))) / 814.0f;
                    ...
                    int iMax = (int) Math.max(0.4f * f5, Math.round((f5 / f10) / ((1.0f / groupedMessagePosition4.aspectRatio) + (1.0f / f10))));
                    int i3 = 1000 - iMax;
                    if (i3 < iMin) {
                        iMax -= iMin - i3;
                    } else {
                ...
                if (length == 3) {
                    ...
                    if (sb.charAt(0) == 'n') {
                        ...
                        float fMin2 = Math.min(407.0f, Math.round((f11 * f5) / (groupedMessagePosition7.aspectRatio + f11)));
                        float f12 = 814.0f - fMin2;
                        int iMax2 = (int) Math.max(iMin, Math.min(f5 * 0.5f, Math.round(Math.min(groupedMessagePosition7.aspectRatio * fMin2, groupedMessagePosition6.aspectRatio * f12))));
                        ...
                        groupedMessagePosition6.set(1, 1, 0, 0, iMax2, f12 / 814.0f, 6);
                        groupedMessagePosition7.set(1, 1, 1, 1, iMax2, fMin2 / 814.0f, 10);
                        return groupedMessagePositionArr;
                    }
                    float fRound3 = Math.round(Math.min(f5 / groupedMessagePosition5.aspectRatio, 537.24005f)) / 814.0f;
                    groupedMessagePosition5.set(0, 1, 0, 0, 1000, fRound3, 7);
                    float f13 = 500;
                    float fMin3 = Math.min(814.0f - fRound3, Math.round(Math.min(f13 / groupedMessagePosition6.aspectRatio, f13 / groupedMessagePosition7.aspectRatio))) / 814.0f;
                    float f14 = fMin3 < fDp3 ? fDp3 : fMin3;
                    groupedMessagePosition6.set(0, 0, 1, 1, 500, f14, 9);
                    groupedMessagePosition7.set(1, 1, 1, 1, 500, f14, 10);
                    return groupedMessagePositionArr;
                }
                ...
                if (sb.charAt(0) != 'w') {
                    ...
                    float f15 = iDp;
                    float f16 = iMax3;
                    float fMin4 = Math.min(0.33f, Math.max(f15, f16 / groupedMessagePosition9.aspectRatio) / 814.0f);
                    float fMin5 = Math.min(0.33f, Math.max(f15, f16 / groupedMessagePosition10.aspectRatio) / 814.0f);
                    float f17 = (1.0f - fMin4) - fMin5;
                    groupedMessagePosition8.set(0, 0, 0, 2, Math.round(Math.min((groupedMessagePosition8.aspectRatio * 814.0f) + iMin2, 1000 - iMax3)), fMin4 + fMin5 + f17, 13);
                    groupedMessagePosition9.set(1, 1, 0, 0, iMax3, fMin4, 6);
                    groupedMessagePosition10.set(1, 1, 1, 1, iMax3, fMin5, 2);
                    groupedMessagePosition11.set(1, 1, 2, 2, iMax3, f17, 10);
                    return groupedMessagePositionArr;
                }
                float fRound4 = Math.round(Math.min(f5 / groupedMessagePosition8.aspectRatio, 537.24005f)) / 814.0f;
                groupedMessagePosition8.set(0, 2, 0, 0, 1000, fRound4, 7);
                float fRound5 = Math.round(f5 / ((groupedMessagePosition9.aspectRatio + groupedMessagePosition10.aspectRatio) + groupedMessagePosition11.aspectRatio));
                float f18 = iMin;
                int iMax4 = (int) Math.max(f18, Math.min(0.4f * f5, groupedMessagePosition9.aspectRatio * fRound5));
                int iMax5 = (int) Math.max(Math.max(f18, f5 * 0.33f), groupedMessagePosition11.aspectRatio * fRound5);
                ...
                float f19 = fMin6 < fDp3 ? fDp3 : fMin6;
                groupedMessagePosition9.set(0, 0, 1, 1, i5, f19, 9);
                groupedMessagePosition10.set(1, 1, 1, 1, iDp2, f19, 8);
                groupedMessagePosition11.set(2, 2, 1, 1, iMax5, f19, 10);
                return groupedMessagePositionArr;
            }
            int i6 = 1000;
            float[] fArr2 = new float[length];
            for (int i7 = 0; i7 < length; i7++) {
                float f20 = groupedMessagePositionArr[i7].aspectRatio;
                if (f4 > 1.1f) {
                    fArr2[i7] = Math.max(1.0f, f20);
                } else {
                    fArr2[i7] = Math.min(1.0f, f20);
                }
                fArr2[i7] = Math.max(0.66667f, Math.min(1.7f, fArr2[i7]));
            }
            ArrayList arrayList = new ArrayList();
            ...
            for (int i8 = 1; i8 < length; i8++) {
                ...
                if (i8 <= 3 && i9 <= 3) {
                    ...
                    arrayList2.add(new float[]{multiHeight(fArr2, 0, i8, 1000), multiHeight(fArr2, i8, length, 1000)});
                }
            }
            for (int i10 = 1; i10 < length - 1; i10++) {
                ...
                while (true) {
                    ...
                    if (i11 < i12) {
                        int i13 = i12 - i11;
                        if (i10 <= 3) {
                            if (i11 <= (f4 < 0.85f ? 4 : 3) && i13 <= 3) {
                                arrayList.add(new int[]{i10, i11, i13});
                                int i14 = i10 + i11;
                                arrayList2.add(new float[]{multiHeight(fArr2, 0, i10, 1000), multiHeight(fArr2, i10, i14, 1000), multiHeight(fArr2, i14, length, 1000)});
                            }
                        }
                        i11++;
                    }
                ...
                while (true) {
                    ...
                    if (i16 < i17) {
                        ...
                        while (true) {
                            ...
                            if (i18 < i19) {
                                int i20 = i19 - i18;
                                if (i15 <= i && i16 <= i && i18 <= i && i20 <= i) {
                                    arrayList.add(new int[]{i15, i16, i18, i20});
                                    int i21 = i15 + i16;
                                    int i22 = i21 + i18;
                                    arrayList2.add(new float[]{multiHeight(fArr2, 0, i15, i6), multiHeight(fArr2, i15, i21, i6), multiHeight(fArr2, i21, i22, i6), multiHeight(fArr2, i22, length, i6)});
                                }
                                i18++;
                                i15 = i15;
                                i = 3;
            ...
            float f21 = (f5 / 3.0f) * 4.0f;
            int i23 = -1;
            float f22 = 0.0f;
            for (int i24 = 0; i24 < arrayList.size(); i24++) {
                float[] fArr3 = (float[]) arrayList2.get(i24);
                int[] iArr = (int[]) arrayList.get(i24);
                ...
                float fAbs = Math.abs(f24 - f21);
                if (iArr.length > 1) {
                    int i25 = iArr[0];
                    int i26 = iArr[1];
                    if (i25 <= i26 && (iArr.length <= 2 || i26 <= iArr[2])) {
            ...
            if (i23 == -1) {
                ...
                while (i27 < length) {
                    int i28 = i27;
                    groupedMessagePositionArr[i27].set(0, 0, i28, i27, 1000, 0.4f, 3);
                    i27 = i28 + 1;
                }
            } else {
                int[] iArr2 = (int[]) arrayList.get(i23);
                ...
                while (i30 < iArr2.length) {
                    ...
                    int i33 = 1000;
                    while (i32 < i31) {
                        int i34 = (int) (fArr2[i29] * f26);
                        int i35 = i33 - i34;
                        MessageObject.GroupedMessagePosition groupedMessagePosition13 = groupedMessagePositionArr[i29];
                        int i36 = i30 == 0 ? 4 : 0;
                        ...
                        groupedMessagePosition13.set(i32, i32, i30, i30, i34, Math.max(fDp3, f26 / 814.0f), i36);
                        i29++;
                        i32++;
                        i33 = i35;
                    }
                    if (groupedMessagePosition12 != null) {
                        groupedMessagePosition12.pw += i33;
                        groupedMessagePosition12.spanSize += i33;
                    }
                    i30++;
                }
            }
    ...
    private void drawBackground(Canvas canvas, ChatMessageCell.TransitionParams transitionParams) {
        if (!this.quotes.isEmpty()) {
            ...
            while (i < size) {
                ...
                int i3 = quoteBackground.outerTopVpad + iDp;
                int i4 = iDp + quoteBackground.outerBottomVpad;
    ...
    private RichBlock emitBlock(TL_iv.PageBlock pageBlock, int i, Rect rect, int i2, boolean z) {
        ...
        if (pageBlock instanceof TL_iv.pageBlockList) {
            ...
            for (int i7 = 0; i7 < pageblocklist.items.size(); i7++) {
                iDp = Math.max(iDp, pageblocklist.items.get(i7).checkbox ? AndroidUtilities.dp(26.0f) : AndroidUtilities.dp(18.0f));
            }
            ...
            int i8 = 0;
            while (i8 < pageblocklist.items.size()) {
                ...
                if (pageListItem instanceof TL_iv.TL_pageListItemText) {
                    ...
                    RichTextBlock richTextBlock2 = new RichTextBlock(this, new Rect(rect2), this.maxWidth, formatText(tL_pageListItemText.text, i5));
                    ...
                    markListItem(richTextBlock2, i6, false, tL_pageListItemText.checkbox, tL_pageListItemText.checked);
                    ...
                    if (pageListItem instanceof TL_iv.TL_pageListItemBlocks) {
                        ...
                        if (!tL_pageListItemBlocks.blocks.isEmpty()) {
                            ...
                            while (i9 < tL_pageListItemBlocks.blocks.size()) {
                                int i10 = i9;
                                RichBlock richBlockEmitBlock = emitBlock(tL_pageListItemBlocks.blocks.get(i9), i6, new Rect(rect2), i5, previousBlockIsParagraph(tL_pageListItemBlocks.blocks, i9));
                                if (richBlockEmitBlock != null && !z2) {
        ...
        if (pageBlock instanceof TL_iv.pageBlockOrderedList) {
            ...
            for (int i12 = 0; i12 < pageblockorderedlist.items.size(); i12++) {
                ...
                iDp2 = Math.max(iDp2, AndroidUtilities.dp(10.0f) + ((int) Math.ceil(textPaint.measureText(orderedListMarker(pageblockorderedlist, pageListOrderedItem, i12)))) + (pageListOrderedItem.checkbox ? AndroidUtilities.dp(26.0f) : 0));
            }
            ...
            int i13 = 0;
            while (i13 < pageblockorderedlist.items.size()) {
                TL_iv.PageListOrderedItem pageListOrderedItem2 = pageblockorderedlist.items.get(i13);
                if (pageListOrderedItem2 instanceof TL_iv.TL_pageListOrderedItemText) {
                    ...
                    RichTextBlock richTextBlock3 = new RichTextBlock(this, new Rect(rect3), this.maxWidth, formatText(tL_pageListOrderedItemText.text, i5));
                    richTextBlock3.setListMarkerWidth(iDp2);
                    richTextBlock3.setNum(orderedListMarker(pageblockorderedlist, tL_pageListOrderedItemText, i13));
                    ...
                    markListItem(richTextBlock3, i11, true, tL_pageListOrderedItemText.checkbox, tL_pageListOrderedItemText.checked);
                    ...
                    if (pageListOrderedItem2 instanceof TL_iv.TL_pageListOrderedItemBlocks) {
                        ...
                        if (!tL_pageListOrderedItemBlocks.blocks.isEmpty()) {
                            ...
                            boolean z3 = false;
                            int i14 = 0;
                            while (i14 < tL_pageListOrderedItemBlocks.blocks.size()) {
                                RichBlock richBlockEmitBlock2 = emitBlock(tL_pageListOrderedItemBlocks.blocks.get(i14), i11, new Rect(rect3), i5, previousBlockIsParagraph(tL_pageListOrderedItemBlocks.blocks, i14));
                                int i15 = i5;
                                if (richBlockEmitBlock2 != null && !z3) {
                                    ...
                                    richBlockEmitBlock2.setNum(orderedListMarker(pageblockorderedlist, tL_pageListOrderedItemBlocks, i13));
                                    if (tL_pageListOrderedItemBlocks.checkbox) {
                                        richBlockEmitBlock2.setCheckbox(tL_pageListOrderedItemBlocks.checked, tL_pageListOrderedItemBlocks);
                                    }
                                    markListItem(richBlockEmitBlock2, i11, true, tL_pageListOrderedItemBlocks.checkbox, tL_pageListOrderedItemBlocks.checked);
                                    z3 = true;
                                }
                                i14++;
                                i5 = i15;
                            ...
                            i4 = i5;
                            markListMembership(size2, this.blocks.size(), i11, true);
                        }
                    }
                    i13++;
                    i5 = i4;
        ...
        if (pageBlock instanceof TL_iv.pageBlockBlockquoteBlocks) {
            ...
            while (i21 < pageblockblockquoteblocks.blocks.size()) {
                emitBlock(pageblockblockquoteblocks.blocks.get(i21), i20, new Rect(AndroidUtilities.dp(12.0f) + rect.left, rect.top + (i21 == 0 ? AndroidUtilities.dp(4.0f) : 0), AndroidUtilities.dp(12.0f) + rect.right, rect.bottom + ((!(i21 == pageblockblockquoteblocks.blocks.size() + (-1)) || z4) ? 0 : AndroidUtilities.dp(4.0f))), setBlockFlags(i16, i18), previousBlockIsParagraph(pageblockblockquoteblocks.blocks, i21));
                i21++;
                size4 = size4;
                i18 = 9;
            }
            ...
            if (z4) {
                RichTextBlock richTextBlock4 = new RichTextBlock(this, new Rect(AndroidUtilities.dp(12.0f) + rect.left, rect.top, AndroidUtilities.dp(12.0f) + rect.right, AndroidUtilities.dp(6.0f) + rect.bottom), this.maxWidth, new SpannableStringBuilder(formatText(pageblockblockquoteblocks.caption, setBlockFlags(i16, 11))));
        ...
        if (pageBlock instanceof TL_iv.pageBlockUnsupported) {
            int iDp3 = BitwiseUtils.hasFlag(i16, 9) ? AndroidUtilities.dp(6.0f) : i > 0 ? AndroidUtilities.dp(4.0f) : 0;
            RichUnsupportedBlock richUnsupportedBlock = new RichUnsupportedBlock(this, new Rect((rect.left + iDp3) - AndroidUtilities.dp(7.0f), Math.max(AndroidUtilities.dp(14.0f), rect.top), (rect.right + iDp3) - AndroidUtilities.dp(7.0f), Math.max(AndroidUtilities.dp(14.0f), rect.bottom)), this.maxWidth, this.blocks.size(), i);
    ...
    private int getBlockTop(int i, ChatMessageCell.TransitionParams transitionParams) {
        ...
        for (int i2 = 0; i2 < this.blocks.size(); i2++) {
            ...
            if (zIsVisible) {
                height = ((transitionParams == null || !(this.detailsAnimating || this.blockquoteAnimating)) ? richBlock2.getHeight() : AndroidUtilities.lerp(richBlock2.prevH, richBlock2.currH, Math.max(0.0f, Math.min(1.0f, transitionParams.animateChangeProgress)))) + height;
                z = true;
            }
        }
        return this.height;
    ...
    private static boolean isDescendantOf(RichBlock richBlock, RichDetailsBlock richDetailsBlock) {
        for (RichDetailsBlock richDetailsBlock2 = richBlock.parentDetails; richDetailsBlock2 != null; richDetailsBlock2 = richDetailsBlock2.parentDetails) {
            if (richDetailsBlock2 == richDetailsBlock) {
                return true;
            }
        }
        return false;
    ...
    private ArrayList<QuoteBackground> quotesFor(int i) {
        ...
        if (i >= 0) {
            ...
            Collections.sort(arrayList, new Emoji$$ExternalSyntheticLambda0(27));
        }
        return arrayList;
    }
    ...
    private boolean showFootnoteSheet(TL_iv.textAnchor textanchor) {
        ...
        textViewM.setText(LocaleController.getString(R.string.InstantViewReference));
        textViewM.setGravity((LocaleController.isRTL ? 5 : 3) | 16);
        int i = Theme.key_dialogTextBlack;
        textViewM.setTextColor(getThemedColor(i));
        textViewM.setPadding(AndroidUtilities.dp(22.0f), 0, AndroidUtilities.dp(22.0f), 0);
        linearLayout.addView(textViewM, new LinearLayout.LayoutParams(-1, AndroidUtilities.dp(48.0f)));
    ...
    public SpoilerEffect2 getMediaSpoilerEffect() {
        ...
        if (this.spoilerEffect2 == null) {
            this.spoilerEffect2 = SpoilerEffect2.getInstance(view);
        }
    ...
    public String getSelectionHtml(int i, int i2) {
        ...
        String str2 = null;
        if (richMessageLayout.textBlocks.isEmpty() || (iMax = Math.max(i, i2)) <= (iMin = Math.min(i, i2))) {
            return null;
        }
        StringBuilder sb = new StringBuilder();
        ArrayList<QuoteBackground> arrayList = new ArrayList<>();
        ...
        while (i3 < richMessageLayout.textBlocks.size()) {
            ...
            if (layout == null || layout.getText() == null) {
                ...
                int iIntValue = i3 < richMessageLayout.textBlockCharOffsets.size() ? richMessageLayout.textBlockCharOffsets.get(i3).intValue() : 0;
                ...
                if (iMin2 <= iMax2) {
                    ...
                    int iIntValue2 = i3 < richMessageLayout.textBlockBlockIndex.size() ? richMessageLayout.textBlockBlockIndex.get(i3).intValue() : -1;
                    str = str2;
                    ?? r6 = (iIntValue2 < 0 || iIntValue2 >= richMessageLayout.blocks.size()) ? str : richMessageLayout.blocks.get(iIntValue2);
                    String strM = "";
                    if (!(r6 instanceof RichTableBlock)) {
                        ...
                        if (!sameQuotes(arrayList, arrayListQuotesFor)) {
                            ...
                            richMessageLayout.syncQuotes(sb, arrayList, arrayListQuotesFor);
                        }
                        int i5 = iMax2 - iIntValue;
                        int i6 = iMin2 - iIntValue;
                        int i7 = r6 instanceof RichTextBlock ? ((RichTextBlock) r6).quoteAuthorStart : -1;
                        boolean z = (r6 instanceof RichTextWithAuthorBlock) && ((RichTextWithAuthorBlock) r6).author == richMessageLayout.textBlocks.get(i3);
                        int i8 = r6 != 0 ? r6.listLevel : 0;
                        if (i8 <= 0 || i7 >= 0) {
                            richMessageLayout.closeLists(sb, arrayList2);
                            if (r6 instanceof RichPreformattedBlock) {
                                SpannableStringBuilder richHtmlSpannable = richMessageLayout.toRichHtmlSpannable(text.subSequence(i5, i6));
                                String str3 = ((RichPreformattedBlock) r6).language;
                                StringBuilder sb2 = new StringBuilder();
                                RichHtml.appendInline(sb2, richHtmlSpannable);
                                String string = sb2.toString();
                                if (!string.isEmpty()) {
                            ...
                            richMessageLayout.syncLists(sb, arrayList2, i8, r6.listOrdered);
                            sb.append("<li");
                            if (r6.listCheckbox) {
                            ...
                            sb.append('>');
                            SpannableStringBuilder richHtmlSpannable2 = richMessageLayout.toRichHtmlSpannable(text.subSequence(i5, i6));
                            StringBuilder sb4 = new StringBuilder();
                            RichHtml.appendInline(sb4, richHtmlSpannable2);
                            sb.append(sb4.toString());
                            sb.append("</li>");
                        }
                    } else if (iIntValue2 != i4) {
                        richMessageLayout.closeLists(sb, arrayList2);
                        richMessageLayout.syncQuotes(sb, arrayList, richMessageLayout.quotesFor(iIntValue2));
                        TL_iv.pageBlockTable pageblocktable = ((RichTableBlock) r6).pageBlock;
                        if (pageblocktable != null) {
                            StringBuilder sb5 = new StringBuilder();
                            RichHtml.serializeTable(sb5, pageblocktable);
                            strM = sb5.toString();
                        }
                        sb.append(strM);
                        i4 = iIntValue2;
    ...
    public CharSequence formatText(TL_iv.RichText richText, int i) {
        return i == 0 ? formatText(richText, new SpannableStringBuilder(), 0) : formatTextAndSetSpan(richText, new SpannableStringBuilder(), i, new StyleSpan(this, i));
    }
    ...
    public static class RichUnsupportedBlock extends RichBlock implements Drawable.Callback {
        ...
        public RichUnsupportedBlock(RichMessageLayout richMessageLayout, Rect rect, int i, int i2, int i3) {
            super(richMessageLayout, rect, i);
            this.index = i2;
            this.level = i3;
    ...
    public CharSequence formatText(TL_iv.RichText richText, SpannableStringBuilder spannableStringBuilder, int i) {
        ...
        if (richText instanceof TL_iv.textDiff) {
            ...
            if (richText instanceof TL_iv.textEmail) {
                formatTextAndSetSpan(richText.text, spannableStringBuilder, i, new URLSpanReplacement("mailto:" + ((TL_iv.textEmail) richText).email, getTextStyleRun(1024)));
                return spannableStringBuilder;
            }
            if (richText instanceof TL_iv.textConcat) {
                ...
                if (richText instanceof TL_iv.textMath) {
                    ...
                    spannableStringBuilder.setSpan(new TextPaintImageReceiverSpan((View) null, textmath.bitmap, textmath.w, textmath.h, Theme.getColor(Theme.key_windowBackgroundWhiteBlackText, this.resourcesProvider), textmath.depth), length, length2, 33);
    ...
    public static class MediaCell implements DownloadController.FileDownloadProgressListener {
        ...
        private void drawSpoiler(Canvas canvas) {
            ...
            if (mediaSpoilerEffect != null) {
                canvas.translate(imageX, imageY);
                canvas2 = canvas;
                mediaSpoilerEffect.draw(canvas2, this.parentView, Math.round(imageWidth), Math.round(imageHeight), this.imageReceiver.getCurrentAlpha(), false);
            } else {
                canvas2 = canvas;
            }
            canvas2.restore();
        ...
        private boolean isOnButton(float f, float f2) {
            ...
            int i3 = this.buttonY;
            return f2 >= ((float) i3) && f2 <= ((float) (i3 + i2));
        }
        ...
        public boolean isInside(float f, float f2) {
            ...
            int i2 = this.y;
            return f2 >= ((float) i2) && f2 <= ((float) (i2 + this.h));
        }
        ...
        public void setRect(int i, int i2, int i3, int i4) {
            ...
            int iM = RichMessageLayout$MediaCell$$ExternalSyntheticOutline0.m(i3, i5, 2, i);
            this.buttonX = iM;
            int iM2 = RichMessageLayout$MediaCell$$ExternalSyntheticOutline0.m(i4, i5, 2, i2);
            this.buttonY = iM2;
            RadialProgress2 radialProgress2 = this.radialProgress;
            if (radialProgress2 != null) {
                radialProgress2.setProgressRect(iM, iM2, iM + i5, i5 + iM2);
            }
            boolean zComputeAutoDownload = computeAutoDownload();
            this.autoDownload = zComputeAutoDownload;
            applyImage(zComputeAutoDownload || fileExists());
        ...
        private MediaCell(RichMessageLayout richMessageLayout, TL_iv.pageBlockVideo pageblockvideo) {
            ...
            this.imageReceiver.setDelegate(new ImageReceiver.ImageReceiverDelegate() {
                ...
                @Override
                public final void didSetImageBitmap(int i3, String str, Drawable drawable) {
