...
public final class c6 implements RequestDelegate {
    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        switch (this.f15820a) {
            case 0:
                ((MediaController) this.d).lambda$loadMoreMusic$12(this.f15821b, this.f15822c, tLObject, tL_error);
                return;
            default:
                ((MessagesController) this.d).lambda$getDifference$359(this.f15821b, this.f15822c, tLObject, tL_error);
                return;
        }
    }
}
