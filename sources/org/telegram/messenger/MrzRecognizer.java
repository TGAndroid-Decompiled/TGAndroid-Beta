...
public class MrzRecognizer {
    ...
    private static String cyrillicToLatin(String str) {
        ...
        while (i10 < 33) {
            int i11 = i10 + 1;
            strReplace = strReplace.replace("АБВГДЕЁЖЗИЙКЛМНОПРСТУФХЦЧШЩЪЫЬЭЮЯ".substring(i10, i11), strArr[i10]);
            i10 = i11;
        }
        return strReplace;
    }
    ...
    private static void parseBirthDate(String str, Result result) {
        try {
            ...
            result.birthYear = i10 < (Calendar.getInstance().get(1) % 100) + (-5) ? result.birthYear + 2000 : result.birthYear + 1900;
    ...
    public static Result recognize(Bitmap bitmap, boolean z10) {
        ...
        if (z10 && (resultRecognizeBarcode2 = recognizeBarcode(bitmap)) != null) {
        ...
        if (z10 || (resultRecognizeBarcode = recognizeBarcode(bitmap)) == null) {
            return null;
        }
    ...
    private static Result recognizeBarcode(Bitmap bitmap) {
        ...
        int i10 = 0;
        for (int i11 = 0; i11 < sparseArrayQ.size(); i11++) {
            c8.m mVar = (c8.m) sparseArrayQ.valueAt(i11);
            int i12 = mVar.d;
            int i13 = 6;
            int i14 = 4;
            if (i12 == 12 && mVar.f2559y != null) {
                Result result = new Result();
                result.type = "ID".equals(mVar.f2559y.f2519a) ? 2 : 4;
                String str = mVar.f2559y.f2529y;
                str.getClass();
                if (str.equals("CAN")) {
                ...
                result.firstName = capitalize(mVar.f2559y.f2520b);
                result.lastName = capitalize(mVar.f2559y.d);
                result.middleName = capitalize(mVar.f2559y.f2521c);
                c8.e eVar = mVar.f2559y;
                result.number = eVar.f2526s;
                String str2 = eVar.f2522e;
                if (str2 != null) {
                    if (str2.equals("1")) {
                        result.gender = 1;
                ...
                try {
                    String str3 = mVar.f2559y.f2528x;
                    if (str3 != null && str3.length() == 8) {
                        result.birthYear = Integer.parseInt(mVar.f2559y.f2528x.substring(i10, i10 + 4));
                        result.birthMonth = Integer.parseInt(mVar.f2559y.f2528x.substring(i14, i14 + 2));
                        result.birthDay = Integer.parseInt(mVar.f2559y.f2528x.substring(i13, i13 + 2));
                    }
                    String str4 = mVar.f2559y.f2527w;
                    if (str4 != null && str4.length() == 8) {
                        result.expiryYear = Integer.parseInt(mVar.f2559y.f2527w.substring(i10, i10 + 4));
                        result.expiryMonth = Integer.parseInt(mVar.f2559y.f2527w.substring(i14, i14 + 2));
                        result.expiryDay = Integer.parseInt(mVar.f2559y.f2527w.substring(i13, i13 + 2));
                    }
                } catch (NumberFormatException unused) {
                }
                return result;
            }
            if (i12 == 7 && mVar.f2549a == 2048 && mVar.f2550b.matches("^[A-Za-z0-9=]+$")) {
                try {
                    String[] strArrSplit = new String(Base64.decode(mVar.f2550b, 0), "windows-1251").split("\\|");
    ...
    private static Result recognizeMRZ(Bitmap bitmap) {
        ...
        if (iArrFindCornerPoints == null) {
            ...
            Bitmap bitmapCreateBitmap3 = Bitmap.createBitmap(rectArrBinarizeAndFindCharacters[c10].length * 10, rectArrBinarizeAndFindCharacters.length * 15, Bitmap.Config.ALPHA_8);
            ...
            int i17 = 0;
            while (i16 < length) {
                Rect[] rectArr2 = rectArrBinarizeAndFindCharacters[i16];
                Result result2 = result;
                int i18 = 0;
                int i19 = 0;
                for (int length2 = rectArr2.length; i18 < length2; length2 = length2) {
            ...
            if (cCharAt == 'P') {
                ...
                if (strArrSplit[0].length() == 44) {
                    ...
                    String strTrim2 = strArrSplit[1].substring(i14, 9).replace('<', ' ').replace('O', '0').trim();
        ...
        double d10 = dHypot / dHypot4;
        double d11 = dHypot2 / dHypot3;
        double d12 = dHypot2 / dHypot4;
        if (d >= 1.35d && d <= 1.75d && d11 >= 1.35d && d11 <= 1.75d && d10 >= 1.35d && d10 <= 1.75d && d12 >= 1.35d && d12 <= 1.75d) {
            Bitmap bitmapCreateBitmap4 = Bitmap.createBitmap(1024, (int) Math.round(1024.0d / ((((d + d10) + d11) + d12) / 4.0d)), Bitmap.Config.ARGB_8888);
            ...
            float[] fArr2 = {point2.x * f10, point2.y * f10, point.x * f10, point.y * f10, point3.x * f10, point3.y * f10, point4.x * f10, point4.y * f10};
    ...
    private static String russianPassportTranslit(String str) {
        char[] charArray = str.toCharArray();
        for (int i10 = 0; i10 < charArray.length; i10++) {
            int iIndexOf = "ABVGDE2JZIQKLMNOPRSTUFHC34WXY9678".indexOf(charArray[i10]);
            if (iIndexOf != -1) {
                charArray[i10] = "АБВГДЕЁЖЗИЙКЛМНОПРСТУФХЦЧШЩЪЫЬЭЮЯ".charAt(iIndexOf);
            }
        }
        return new String(charArray);
    }
    ...
    public static Result recognize(byte[] bArr, int i10, int i11, int i12) {
        ...
        return recognize(Bitmap.createBitmap(bitmapCreateBitmap, z10 ? (i10 / 2) - (iRound / 2) : 0, z10 ? 0 : (i11 / 2) - (iRound / 2), z10 ? iRound : iMin, z10 ? iMin : iRound, matrix, false), false);
    }
}
