...
public final class pg implements Comparator {
    ...
    public final LongSparseIntArray f18761b;

    public pg(LongSparseIntArray longSparseIntArray, int i10) {
        this.f18760a = i10;
        this.f18761b = longSparseIntArray;
    }
    ...
    public final int compare(Object obj, Object obj2) {
        ...
        switch (this.f18760a) {
            case 0:
                lambda$checkLoadedRemoteFilters$68 = MessagesStorage.lambda$checkLoadedRemoteFilters$68(this.f18761b, l4, l10);
                return lambda$checkLoadedRemoteFilters$68;
            default:
                lambda$resetDialogs$94 = MessagesStorage.lambda$resetDialogs$94(this.f18761b, l4, l10);
