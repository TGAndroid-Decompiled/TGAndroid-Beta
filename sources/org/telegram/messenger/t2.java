...
public final class t2 implements Runnable {
    ...
    public final void run() {
        ...
        int i10;
        int i11;
        int i12 = this.f19030a;
        Object obj = this.f19034f;
        Object obj2 = this.f19033e;
        Object obj3 = this.d;
        switch (i12) {
            case 0:
                ((FileLoadOperation) obj3).lambda$getDownloadedLengthFromOffset$4((long[]) obj2, this.f19031b, this.f19032c, (CountDownLatch) obj);
                return;
            case 1:
                long j3 = this.f19032c;
                ((GiftAuctionController) obj3).lambda$sendBid$6((Utilities.Callback2) obj2, this.f19031b, (yh.l) obj, j3);
                return;
            case 2:
                ((MediaController) obj3).lambda$trimCurrentRecording$26((File) obj2, this.f19031b, this.f19032c, (Runnable) obj);
                return;
            case 3:
                ((MessagesStorage) obj3).lambda$getMessage$142(this.f19031b, this.f19032c, (AtomicReference) obj2, (CountDownLatch) obj);
                return;
            case 4:
                ((MessagesStorage) obj3).lambda$updateDialogsWithDeletedMessages$228(this.f19031b, this.f19032c, (ArrayList) obj2, (ArrayList) obj);
                return;
            case 5:
                ((TopicsController) obj3).lambda$getTopicRepliesCount$29((TLObject) obj2, (TLRPC.TL_forumTopic) obj, this.f19031b, this.f19032c);
                return;
            case 6:
                ((TopicsController) obj3).lambda$loadTopic$27(this.f19031b, (ArrayList) obj2, this.f19032c, (Runnable) obj);
                return;
            case 7:
                ((n70) obj3).u();
                Bundle bundle = new Bundle();
                bundle.putLong("dialog_id", this.f19031b);
                bundle.putLong("topic_id", this.f19032c);
            ...
            default:
                ...
                int i13 = b0Var.f47078j0;
                int i14 = wg.u.f48560s;
                if (i13 == 1) {
                    z10 = true;
                } else {
                    z10 = false;
                }
                b0Var.f47084q0.b(true);
                ArrayList arrayList = b0Var.f47071c0;
                ArrayList arrayList2 = b0Var.f47073e0;
                TLRPC.Chat chat = b0Var.f47070b0;
                boolean z11 = b0Var.f47091x0;
                boolean z12 = b0Var.f47090w0;
                int i15 = prepaidGiveaway.quantity;
                String str = b0Var.f47089v0;
                ug.z zVar = new ug.z(b0Var, tL_prepaidStarsGiveaway, this.f19031b, this.f19032c, prepaidGiveaway);
                ...
                tL_payments_launchPrepaidGiveaway.giveaway_id = prepaidGiveaway.f20105id;
    ...
    public t2(Object obj, TLObject tLObject, TLObject tLObject2, long j3, long j10, int i10) {
        this.f19030a = i10;
        this.d = obj;
        this.f19033e = tLObject;
        this.f19034f = tLObject2;
        this.f19031b = j3;
        this.f19032c = j10;
    }
