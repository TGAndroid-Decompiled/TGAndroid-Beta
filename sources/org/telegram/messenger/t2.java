...
public final class t2 implements Runnable {
    ...
    public final void run() {
        ...
        switch (i12) {
            case 0:
                ((FileLoadOperation) obj3).lambda$getDownloadedLengthFromOffset$4((long[]) obj2, this.f17350b, this.f17351c, (CountDownLatch) obj);
                return;
            case 1:
                long j3 = this.f17351c;
                ((GiftAuctionController) obj3).lambda$sendBid$6((Utilities.Callback2) obj2, this.f17350b, (xh.l) obj, j3);
                return;
            case 2:
                ((MediaController) obj3).lambda$trimCurrentRecording$26((File) obj2, this.f17350b, this.f17351c, (Runnable) obj);
                return;
            case 3:
                ((MessagesStorage) obj3).lambda$getMessage$142(this.f17350b, this.f17351c, (AtomicReference) obj2, (CountDownLatch) obj);
                return;
            case 4:
                ((MessagesStorage) obj3).lambda$updateDialogsWithDeletedMessages$228(this.f17350b, this.f17351c, (ArrayList) obj2, (ArrayList) obj);
                return;
            case 5:
                ((TopicsController) obj3).lambda$getTopicRepliesCount$29((TLObject) obj2, (TLRPC.TL_forumTopic) obj, this.f17350b, this.f17351c);
                return;
            case 6:
                ((TopicsController) obj3).lambda$loadTopic$27(this.f17350b, (ArrayList) obj2, this.f17351c, (Runnable) obj);
                return;
            case 7:
                ((n70) obj3).u();
                Bundle bundle = new Bundle();
                bundle.putLong("dialog_id", this.f17350b);
                bundle.putLong("topic_id", this.f17351c);
            ...
            default:
                ...
                b0Var.f43103q0.b(true);
                ArrayList arrayList = b0Var.f43090c0;
                ArrayList arrayList2 = b0Var.f43092e0;
                TLRPC.Chat chat = b0Var.f43089b0;
                boolean z11 = b0Var.f43110x0;
                boolean z12 = b0Var.f43109w0;
                int i15 = prepaidGiveaway.quantity;
                String str = b0Var.f43108v0;
                tg.z zVar = new tg.z(b0Var, tL_prepaidStarsGiveaway, this.f17350b, this.f17351c, prepaidGiveaway);
                ...
                if (prepaidGiveaway instanceof TL_stories.TL_prepaidGiveaway) {
                    ...
                    tL_inputStorePaymentStarsGiveaway.boost_peer = messagesController.getInputPeer(-chat.f18112id);
                    ...
                    while (i18 < size2) {
                        ...
                        if (tLObject instanceof TLRPC.Chat) {
                            i11 = size2;
                            tL_inputStorePaymentStarsGiveaway.additional_peers.add(messagesController.getInputPeer(-((TLRPC.Chat) tLObject).f18112id));
                        } else {
                            i11 = size2;
                        }
                        size2 = i11;
                    ...
                    while (i21 < size4) {
                        ...
                        if (tLObject2 instanceof TLRPC.Chat) {
                            i10 = size4;
                            tL_inputStorePaymentStarsGiveaway.additional_peers.add(messagesController.getInputPeer(-((TLRPC.Chat) tLObject2).f18112id));
                        } else {
                            i10 = size4;
                        }
                        size4 = i10;
                ...
                tL_payments_launchPrepaidGiveaway.giveaway_id = prepaidGiveaway.f18347id;
                tL_payments_launchPrepaidGiveaway.peer = messagesController.getInputPeer(-chat.f18112id);
