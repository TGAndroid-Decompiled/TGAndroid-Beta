...
public final class Emoji$$ExternalSyntheticLambda0 implements Comparator {
    public final int $r8$classId;

    public Emoji$$ExternalSyntheticLambda0(int i) {
        this.$r8$classId = i;
    }
    ...
    public final int compare(Object obj, Object obj2) {
        switch (this.$r8$classId) {
            ...
            case 25:
                return MessagesStorage.lambda$localSearch$260((DialogsSearchAdapter.DialogSearchResult) obj, (DialogsSearchAdapter.DialogSearchResult) obj2);
            case 26:
