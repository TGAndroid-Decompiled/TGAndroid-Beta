...
public final class ii implements RequestDelegate {
    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        Object obj2 = this.f17985g;
        Object obj3 = this.f17984f;
        Object obj4 = this.f17983e;
        Object obj5 = this.d;
        switch (i10) {
            case 0:
                ((SendMessagesHelper) obj5).lambda$performSendDelayedMessage$54((TLRPC.InputFile) obj4, (TLRPC.InputMedia) obj3, (SendMessagesHelper.DelayedMessage) obj2, this.f17981b, (String) obj, tLObject, tL_error);
                return;
            case 1:
                AndroidUtilities.runOnUIThread(new hg.e1((org.telegram.ui.i4) obj5, this.f17981b, (of.e) obj4, tLObject, (String) obj, (org.telegram.ui.f0) obj3, (TLRPC.TL_messages_getWebPage) obj2));
                return;
            case 2:
                AndroidUtilities.runOnUIThread(new hg.e1(tLObject, (org.telegram.ui.ActionBar.b2) obj5, (Context) obj4, this.f17981b, (TL_phone.exportGroupCallInvite) obj3, (org.telegram.ui.ActionBar.f6) obj2, (v60) obj));
                return;
            case 3:
            ...
            case 4:
                ...
                AndroidUtilities.runOnUIThread(new hg.e1((LaunchActivity) obj5, tLObject, this.f17981b, (uy) obj4, (org.telegram.ui.ActionBar.n2) obj3, (TLRPC.User) obj2, str));
                return;
            case 5:
                AndroidUtilities.runOnUIThread(new y5(tLObject, (org.telegram.ui.ActionBar.n2) obj5, (TLRPC.TL_inputStorePaymentPremiumSubscription) obj4, (lx0) obj3, (c5.f) obj2, this.f17981b, tL_error, (TLRPC.TL_payments_canPurchaseStore) obj));
                return;
            default:
    ...
    public ii(org.telegram.ui.ActionBar.b2 b2Var, Context context, int i10, TL_phone.exportGroupCallInvite exportgroupcallinvite, org.telegram.ui.ActionBar.f6 f6Var, v60 v60Var) {
        ...
        this.f17981b = i10;
        this.f17984f = exportgroupcallinvite;
        this.f17985g = f6Var;
        this.f17982c = v60Var;
    }
    ...
    public ii(org.telegram.ui.i4 i4Var, int i10, of.e eVar, String str, org.telegram.ui.f0 f0Var, TLRPC.TL_messages_getWebPage tL_messages_getWebPage) {
        ...
        this.f17982c = str;
        this.f17984f = f0Var;
        this.f17985g = tL_messages_getWebPage;
    }
