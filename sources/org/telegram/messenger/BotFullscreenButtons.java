...
public class BotFullscreenButtons extends View {
    ...
    public void onDraw(Canvas canvas) {
        ...
        this.leftMenu.set(this.insets.left + AndroidUtilities.dp(8.0f), this.insets.top + AndroidUtilities.dp(8.0f), this.insets.left + AndroidUtilities.dp(38.0f) + AndroidUtilities.lerp(AndroidUtilities.lerp(this.closeText.f24146c, this.backText.f24146c, e) + AndroidUtilities.dp(12.0f), min, e7), this.insets.top + AndroidUtilities.dp(38.0f));
        ...
        if (e7 > 0.0f && this.previewText != null) {
            ...
            g01Var2.f24156p = ((f22 - AndroidUtilities.dp(f15)) - (this.leftMenu.left + AndroidUtilities.dp(30.0f))) + 2.0f;
            f14 = 1.0f;
