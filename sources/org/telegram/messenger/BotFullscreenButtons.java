...
public class BotFullscreenButtons extends View {
    ...
    public void onDraw(Canvas canvas) {
        ...
        this.leftMenu.set(this.insets.left + AndroidUtilities.dp(8.0f), this.insets.top + AndroidUtilities.dp(8.0f), this.insets.left + AndroidUtilities.dp(38.0f) + AndroidUtilities.lerp(AndroidUtilities.lerp(this.closeText.f28521c, this.backText.f28521c, e6) + AndroidUtilities.dp(12.0f), min, e10), this.insets.top + AndroidUtilities.dp(38.0f));
        ...
        if (e10 > 0.0f && this.previewText != null) {
            ...
            l01Var2.f28532p = ((f23 - AndroidUtilities.dp(f16)) - (this.leftMenu.left + AndroidUtilities.dp(30.0f))) + 2.0f;
            f15 = 1.0f;
