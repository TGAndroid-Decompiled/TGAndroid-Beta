...
public final class u2 implements RequestDelegate {
    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        switch (this.f18548a) {
            case 0:
                ((FileLoadOperation) this.d).lambda$startDownloadRequest$29((FileLoadOperation.RequestInfo) this.e, this.f18549b, this.f18550c, this.f18551f, tLObject, tL_error);
                return;
            case 1:
                tf.z zVar = (tf.z) this.d;
                String str = (String) this.e;
                TLRPC.TL_messages_search tL_messages_search = (TLRPC.TL_messages_search) this.f18551f;
                ...
                if (tL_error == null) {
                    ...
                    for (int i12 = 0; i12 < messages_messages.messages.size(); i12++) {
                        MessageObject messageObject = new MessageObject(zVar.f44908p0, messages_messages.messages.get(i12), hVar2, hVar, false, true);
                        arrayList.add(messageObject);
                        messageObject.setQuery(str);
                    }
                }
                AndroidUtilities.runOnUIThread(new o7(zVar, this.f18549b, this.f18550c, tL_error, str, tLObject, tL_messages_search, arrayList, 1));
                return;
            default:
                tf.z zVar2 = (tf.z) this.d;
                String str2 = (String) this.e;
                TLRPC.TL_messages_searchGlobal tL_messages_searchGlobal = (TLRPC.TL_messages_searchGlobal) this.f18551f;
                int i13 = zVar2.f44908p0;
                ...
                if (tL_error == null) {
                    ...
                    for (int i14 = 0; i14 < messages_messages2.chats.size(); i14++) {
                        ...
                        hVar3.k(chat2, chat2.f19184id);
                    }
                    for (int i15 = 0; i15 < messages_messages2.users.size(); i15++) {
                        TLRPC.User user2 = messages_messages2.users.get(i15);
                        hVar4.k(user2, user2.f19331id);
                    }
                    for (int i16 = 0; i16 < messages_messages2.messages.size(); i16++) {
                        MessageObject messageObject2 = new MessageObject(zVar2.f44908p0, messages_messages2.messages.get(i16), hVar4, hVar3, false, true);
                ...
                o7 o7Var = new o7(zVar2, this.f18549b, this.f18550c, tL_error, str2, tLObject, tL_messages_searchGlobal, arrayList2, 2);
                if (hashSet.isEmpty()) {
