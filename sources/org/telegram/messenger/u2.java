...
public final class u2 implements RequestDelegate {
    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        switch (this.f20153a) {
            case 0:
                ((FileLoadOperation) this.d).lambda$startDownloadRequest$29((FileLoadOperation.RequestInfo) this.f20156e, this.f20154b, this.f20155c, this.f20157f, tLObject, tL_error);
                return;
            case 1:
                uf.z zVar = (uf.z) this.d;
                String str = (String) this.f20156e;
                TLRPC.TL_messages_search tL_messages_search = (TLRPC.TL_messages_search) this.f20157f;
                ...
                if (tL_error == null) {
                    ...
                    for (int i12 = 0; i12 < messages_messages.messages.size(); i12++) {
                        MessageObject messageObject = new MessageObject(zVar.f48805p0, messages_messages.messages.get(i12), hVar2, hVar, false, true);
                        arrayList.add(messageObject);
                        messageObject.setQuery(str);
                    }
                }
                AndroidUtilities.runOnUIThread(new o7(zVar, this.f20154b, this.f20155c, tL_error, str, tLObject, tL_messages_search, arrayList, 1));
                return;
            default:
                uf.z zVar2 = (uf.z) this.d;
                String str2 = (String) this.f20156e;
                TLRPC.TL_messages_searchGlobal tL_messages_searchGlobal = (TLRPC.TL_messages_searchGlobal) this.f20157f;
                int i13 = zVar2.f48805p0;
                ...
                if (tL_error == null) {
                    ...
                    for (int i14 = 0; i14 < messages_messages2.chats.size(); i14++) {
                        ...
                        hVar3.k(chat2, chat2.f20845id);
                    }
                    for (int i15 = 0; i15 < messages_messages2.users.size(); i15++) {
                        TLRPC.User user2 = messages_messages2.users.get(i15);
                        hVar4.k(user2, user2.f20992id);
                    }
                    for (int i16 = 0; i16 < messages_messages2.messages.size(); i16++) {
                        MessageObject messageObject2 = new MessageObject(zVar2.f48805p0, messages_messages2.messages.get(i16), hVar4, hVar3, false, true);
                ...
                o7 o7Var = new o7(zVar2, this.f20154b, this.f20155c, tL_error, str2, tLObject, tL_messages_searchGlobal, arrayList2, 2);
                if (hashSet.isEmpty()) {
