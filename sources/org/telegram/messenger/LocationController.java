...
public class LocationController extends BaseController implements NotificationCenter.NotificationCenterDelegate, ILocationServiceProvider.IAPIConnectionCallbacks, ILocationServiceProvider.IAPIOnConnectionFailedListener {
    ...
    public void lambda$loadLiveLocations$25(long j3, TLObject tLObject) {
    ...
    public void lambda$loadLiveLocations$26(long j3, TLObject tLObject, TLRPC.TL_error tL_error) {
        if (tL_error != null) {
            return;
        }
    ...
    public void lambda$removeSharingLocation$21(long j3) {
    ...
    public void lambda$setProximityLocation$12(int i10, long j3) {
        try {
    ...
    public void addSharingLocation(TLRPC.Message message) {
        ...
        sharingLocationInfo.mid = message.f19917id;
        TLRPC.MessageMedia messageMedia = message.media;
            ...
            if (!((Boolean) objArr[2]).booleanValue() && !this.sharingLocationsUI.isEmpty()) {
                ...
                for (int i14 = 0; i14 < this.sharingLocationsUI.size(); i14++) {
                    ...
                    if (messageObject2 != null) {
                        j3 = messageObject2.getChannelId();
                    } else {
                        j3 = 0;
                    }
                    if (longValue2 == j3 && arrayList4.contains(Integer.valueOf(sharingLocationInfo.mid))) {
                        if (arrayList5 == null) {
    ...
    public boolean isSharingLocation(long j3) {
        if (this.sharingLocationsMapUI.h(j3) >= 0) {
            return true;
        }
        return false;
    }
            ...
            if (num == null || num.intValue() + 60 <= elapsedRealtime) {
                ...
                if (DialogObject.isChatDialog(j3)) {
                    ...
                    if (ChatObject.isChannel(j10, this.currentAccount)) {
                        ...
                        while (i10 < size) {
                            i10 = com.google.android.gms.internal.vision.e2.e(((TLRPC.Message) arrayList.get(i10)).f19917id, i10, 1, tL_messages_readMessageContents.f19935id);
                        }
                ...
                while (i10 < size2) {
                    i10 = com.google.android.gms.internal.vision.e2.e(((TLRPC.Message) arrayList.get(i10)).f19917id, i10, 1, tL_messages_readMessageContents.f19999id);
                }
                getConnectionsManager().sendRequest(tL_messages_readMessageContents, new r5(this, 2));
            }
        }
