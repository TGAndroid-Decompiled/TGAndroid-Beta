...
public class LocationController extends BaseController implements NotificationCenter.NotificationCenterDelegate, ILocationServiceProvider.IAPIConnectionCallbacks, ILocationServiceProvider.IAPIOnConnectionFailedListener {
        ...
        if (this.lastKnownLocation != null) {
            ...
            if (!this.sharingLocations.isEmpty()) {
                ...
                for (int i11 = 0; i11 < this.sharingLocations.size(); i11++) {
                    ...
                    tL_messages_editMessage.f19242id = sharingLocationInfo.mid;
    ...
    public void addSharingLocation(TLRPC.Message message) {
        ...
        sharingLocationInfo.mid = message.f19180id;
        TLRPC.MessageMedia messageMedia = message.media;
            ...
            if (num == null || num.intValue() + 60 <= elapsedRealtime) {
                ...
                if (DialogObject.isChatDialog(j10)) {
                    ...
                    if (ChatObject.isChannel(j11, this.currentAccount)) {
                        ...
                        while (i10 < size) {
                            i10 = org.telegram.ui.ai.d(((TLRPC.Message) arrayList.get(i10)).f19180id, i10, 1, tL_messages_readMessageContents.f19198id);
                        }
                ...
                while (i10 < size2) {
                    i10 = org.telegram.ui.ai.d(((TLRPC.Message) arrayList.get(i10)).f19180id, i10, 1, tL_messages_readMessageContents.f19262id);
                }
                getConnectionsManager().sendRequest(tL_messages_readMessageContents, new t5(this, 2));
            }
        }
