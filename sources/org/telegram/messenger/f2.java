...
public final class f2 implements Utilities.Callback {
    ...
    public final void run(Object obj) {
        ...
        long j3 = this.f17647b;
        Object obj2 = this.f17649e;
        Object obj3 = this.d;
        Object obj4 = this.f17648c;
        switch (i10) {
            case 0:
                ((FactCheckController) obj4).lambda$loadMissing$3(this.f17647b, (ArrayList) obj3, (HashMap) obj2, (ArrayList) obj);
                return;
            case 1:
                ((MessagesController) obj4).lambda$checkSensitive$448(this.f17647b, (boolean[]) obj3, (Runnable) obj2, (Boolean) obj);
                return;
            case 2:
                ((TranslateController) obj4).lambda$checkTranslation$6((MessageObject) obj3, (String) obj2, this.f17647b, (TLRPC.TL_textWithEntities) obj);
                return;
            case 3:
                tx txVar = (tx) obj4;
            ...
            case 4:
                ...
                try {
                    ...
                    AndroidUtilities.runOnUIThread(new org.telegram.messenger.voip.f(photoViewer, photoEntry, this.f17647b, str, createBitmap, 6));
                    return;
                } catch (Exception e7) {
                    FileLog.e(e7);
