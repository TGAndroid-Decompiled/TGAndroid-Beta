...
public final class f2 implements Utilities.Callback {
    ...
    public final void run(Object obj) {
        ...
        Object obj2 = this.e;
        Object obj3 = this.d;
        Object obj4 = this.f16087c;
        switch (i10) {
            case 0:
                ((FactCheckController) obj4).lambda$loadMissing$3(this.f16086b, (ArrayList) obj3, (HashMap) obj2, (ArrayList) obj);
                return;
            case 1:
                ((MessagesController) obj4).lambda$checkSensitive$448(this.f16086b, (boolean[]) obj3, (Runnable) obj2, (Boolean) obj);
                return;
            case 2:
                ((TranslateController) obj4).lambda$checkTranslation$6((MessageObject) obj3, (String) obj2, this.f16086b, (TLRPC.TL_textWithEntities) obj);
                return;
            case 3:
                tx txVar = (tx) obj4;
            ...
            case 4:
                ...
                try {
                    ...
                    AndroidUtilities.runOnUIThread(new org.telegram.messenger.voip.f(photoViewer, photoEntry, this.f16086b, str, createBitmap, 6));
                    return;
                } catch (Exception e) {
                    FileLog.e(e);
