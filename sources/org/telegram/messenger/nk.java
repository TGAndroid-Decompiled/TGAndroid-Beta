...
public final class nk implements Utilities.Callback {
    public final int f18535a = 0;
    public final boolean f18536b;
    public final NotificationCenter.NotificationCenterDelegate f18537c;
    ...
    public nk(SendMessagesHelper sendMessagesHelper, ArrayList arrayList, ArrayList arrayList2, ArrayList arrayList3, SendMessagesHelper.DelayedMessage delayedMessage, boolean z10) {
        this.f18537c = sendMessagesHelper;
        this.d = arrayList;
        this.f18538e = arrayList2;
        this.f18539f = arrayList3;
        this.f18540g = delayedMessage;
        this.f18536b = z10;
    }
    ...
    public final void run(Object obj) {
        ...
        switch (this.f18535a) {
            case 0:
                ((SendMessagesHelper) this.f18537c).lambda$performSendMessageRequestMulti$64((ArrayList) this.d, (ArrayList) this.f18538e, (ArrayList) this.f18539f, (SendMessagesHelper.DelayedMessage) this.f18540g, this.f18536b, (TLObject) obj);
                return;
            case 1:
                ProfileActivity profileActivity = (ProfileActivity) this.f18537c;
                TLRPC.ChannelParticipant channelParticipant = (TLRPC.ChannelParticipant) this.d;
                TLRPC.User user = (TLRPC.User) this.f18538e;
                TLRPC.ChatParticipant chatParticipant = (TLRPC.ChatParticipant) this.f18539f;
                String str = (String) this.f18540g;
            ...
            default:
                j71 j71Var = (j71) this.f18537c;
                LinkedHashSet linkedHashSet = (LinkedHashSet) this.f18538e;
                String str2 = (String) this.f18539f;
                HashMap hashMap = (HashMap) this.f18540g;
    ...
    public nk(ProfileActivity profileActivity, TLRPC.ChannelParticipant channelParticipant, TLRPC.User user, TLRPC.ChatParticipant chatParticipant, boolean z10, String str) {
        this.f18537c = profileActivity;
        this.d = channelParticipant;
        this.f18538e = user;
        this.f18539f = chatParticipant;
        this.f18536b = z10;
        this.f18540g = str;
    }
    ...
    public nk(j71 j71Var, boolean z10, LinkedHashSet linkedHashSet, String str, HashMap hashMap, ArrayList arrayList) {
        this.f18537c = j71Var;
        this.f18536b = z10;
        this.f18538e = linkedHashSet;
        this.f18539f = str;
        this.f18540g = hashMap;
        this.d = arrayList;
    }
}
