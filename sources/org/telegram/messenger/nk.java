...
public final class nk implements Utilities.Callback {
    ...
    public final NotificationCenter.NotificationCenterDelegate f17064c;
    public final Object d;
    public final Object e;
    public final Object f17065f;
    public final Object f17066g;
    ...
    public nk(SendMessagesHelper sendMessagesHelper, ArrayList arrayList, ArrayList arrayList2, ArrayList arrayList3, SendMessagesHelper.DelayedMessage delayedMessage, boolean z10) {
        this.f17064c = sendMessagesHelper;
        this.d = arrayList;
        this.e = arrayList2;
        this.f17065f = arrayList3;
        this.f17066g = delayedMessage;
        this.f17063b = z10;
    }
    ...
    public final void run(Object obj) {
        ...
        switch (this.f17062a) {
            case 0:
                ((SendMessagesHelper) this.f17064c).lambda$performSendMessageRequestMulti$64((ArrayList) this.d, (ArrayList) this.e, (ArrayList) this.f17065f, (SendMessagesHelper.DelayedMessage) this.f17066g, this.f17063b, (TLObject) obj);
                return;
            case 1:
                ProfileActivity profileActivity = (ProfileActivity) this.f17064c;
                TLRPC.ChannelParticipant channelParticipant = (TLRPC.ChannelParticipant) this.d;
                TLRPC.User user = (TLRPC.User) this.e;
                TLRPC.ChatParticipant chatParticipant = (TLRPC.ChatParticipant) this.f17065f;
                String str = (String) this.f17066g;
            ...
            default:
                g71 g71Var = (g71) this.f17064c;
                LinkedHashSet linkedHashSet = (LinkedHashSet) this.e;
                String str2 = (String) this.f17065f;
                HashMap hashMap = (HashMap) this.f17066g;
                    ...
                    for (int i11 = 0; i11 < stickerSets.size(); i11++) {
                        if (stickerSets.get(i11).documents != null && (arrayList2 = stickerSets.get(i11).documents) != null) {
                            for (int i12 = 0; i12 < arrayList2.size(); i12++) {
                                ...
                                long j3 = arrayList2.get(i12).f18302id;
                    ...
                    for (int i13 = 0; i13 < featuredEmojiSets.size(); i13++) {
                        if ((featuredEmojiSets.get(i13) instanceof TLRPC.TL_stickerSetFullCovered) && ((TLRPC.TL_stickerSetFullCovered) featuredEmojiSets.get(i13)).keywords != null && (arrayList = ((TLRPC.TL_stickerSetFullCovered) featuredEmojiSets.get(i13)).documents) != null) {
                            for (int i14 = 0; i14 < arrayList.size(); i14++) {
                                ...
                                long j10 = arrayList.get(i14).f18302id;
    ...
    public nk(ProfileActivity profileActivity, TLRPC.ChannelParticipant channelParticipant, TLRPC.User user, TLRPC.ChatParticipant chatParticipant, boolean z10, String str) {
        this.f17064c = profileActivity;
        this.d = channelParticipant;
        this.e = user;
        this.f17065f = chatParticipant;
        this.f17063b = z10;
        this.f17066g = str;
    }
