...
public class LocaleController {
                ...
                if (localeInfo2.baseVersion != 0 && !z10) {
                    if (localeInfo2.hasBaseLang()) {
                        ...
                        ConnectionsManager.getInstance(i10).sendRequest(tL_langpack_getDifference, new RequestDelegate(this) {
                            public final LocaleController f16986b;
                            ...
                            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                                switch (r5) {
                                    case 0:
                                        this.f16986b.lambda$applyRemoteLanguage$15(localeInfo2, i10, g0Var, tLObject, tL_error);
                                        return;
                                    case 1:
                                        this.f16986b.lambda$applyRemoteLanguage$17(localeInfo2, i10, g0Var, tLObject, tL_error);
                                        return;
                                    case 2:
                                        this.f16986b.lambda$applyRemoteLanguage$19(localeInfo2, i10, g0Var, tLObject, tL_error);
                                        return;
                                    default:
                                        this.f16986b.lambda$applyRemoteLanguage$21(localeInfo2, i10, g0Var, tLObject, tL_error);
                                        return;
                                }
                            }
                        }, 8);
            ...
            if (str == null || str.equals(localeInfo2.shortName)) {
                ...
                return ConnectionsManager.getInstance(i10).sendRequest(tL_langpack_getLangPack2, new RequestDelegate(this) {
                    ...
                    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                        switch (r5) {
                            case 0:
                                this.f16986b.lambda$applyRemoteLanguage$15(localeInfo, i10, g0Var, tLObject, tL_error);
                                return;
                            case 1:
                                this.f16986b.lambda$applyRemoteLanguage$17(localeInfo, i10, g0Var, tLObject, tL_error);
                                return;
                            case 2:
                                this.f16986b.lambda$applyRemoteLanguage$19(localeInfo, i10, g0Var, tLObject, tL_error);
                                return;
                            default:
                                this.f16986b.lambda$applyRemoteLanguage$21(localeInfo, i10, g0Var, tLObject, tL_error);
                                return;
                        }
                    }
                }, 8);
    ...
    public static String formatUserStatus(int i10, TLRPC.User user, boolean[] zArr, boolean[] zArr2) {
        ...
        if (user != null && (userStatus2 = user.status) != null && userStatus2.expires <= 0 && MessagesController.getInstance(i10).onlinePrivacy.containsKey(Long.valueOf(user.f18483id))) {
            if (zArr != null) {
                zArr[0] = true;
            }
