...
public abstract class MessagesController$$ExternalSyntheticBackport8 {
    public static long m(CharSequence charSequence, int i, int i2, int i3) {
        ...
        long j = i3;
        long jM = MessagesController$$ExternalSyntheticBackport9.m(-1L, j);
        ...
        while (i5 < i2) {
            ...
            if (j3 < j2 || j3 > jM || (j3 == jM && iDigit > ((int) MessagesController$$ExternalSyntheticBackport10.m(-1L, j)))) {
