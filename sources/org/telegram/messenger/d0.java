...
public final class d0 implements BillingController.ProductDetailsResponseListenerLegacy, c5.p {
    public final BillingController f15928a;

    public d0(BillingController billingController) {
        this.f15928a = billingController;
    }

    @Override
    public void a(c5.h hVar, List list) {
        this.f15928a.onPurchasesUpdated(hVar, list);
    }

    @Override
    public void onProductDetailsResponse(c5.h hVar, List list) {
        this.f15928a.onQueriedPremiumProductDetails(hVar, list);
    }
}
