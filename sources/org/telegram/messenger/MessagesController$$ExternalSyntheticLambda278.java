...
public final class MessagesController$$ExternalSyntheticLambda278 implements Runnable {
    ...
    public MessagesController$$ExternalSyntheticLambda278(MessagesController messagesController, LongSparseIntArray longSparseIntArray, LongSparseIntArray longSparseIntArray2, SparseIntArray sparseIntArray, LongSparseArray longSparseArray, LongSparseArray longSparseArray2, LongSparseArray longSparseArray3, LongSparseArray longSparseArray4, LongSparseArray longSparseArray5, LongSparseIntArray longSparseIntArray3, int i) {
        this.$r8$classId = i;
    ...
    public final void run() {
        switch (this.$r8$classId) {
            ...
            case 1:
                ...
                break;
            default:
                ArrayList arrayList = (ArrayList) this.f$7;
                ((NotificationsSettingsActivity) this.f$0).lambda$loadExceptions$1((ArrayList) this.f$1, (ArrayList) this.f$2, (ArrayList) this.f$9, (ArrayList) this.f$3, (ArrayList) this.f$4, (ArrayList) this.f$5, (ArrayList) this.f$6, arrayList, (OAuthSheet$$ExternalSyntheticLambda2) this.f$8);
                break;
        }
    }

    public MessagesController$$ExternalSyntheticLambda278(NotificationsSettingsActivity notificationsSettingsActivity, ArrayList arrayList, ArrayList arrayList2, ArrayList arrayList3, ArrayList arrayList4, ArrayList arrayList5, ArrayList arrayList6, ArrayList arrayList7, ArrayList arrayList8, OAuthSheet$$ExternalSyntheticLambda2 oAuthSheet$$ExternalSyntheticLambda2) {
        this.$r8$classId = 2;
        ...
        this.f$6 = arrayList7;
        this.f$7 = arrayList8;
        this.f$8 = oAuthSheet$$ExternalSyntheticLambda2;
    }
}
