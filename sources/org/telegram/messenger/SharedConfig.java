...
public class SharedConfig {
    ...
    public static void lambda$checkSdCard$2() {
        ...
        if (!readOnlyStorageDirAlertShowed && (R = LaunchActivity.R()) != null && R.getParentActivity() != null) {
            ...
            alertDialog$Builder.f20199a.R = LocaleController.getString(R.string.SdCardError);
            alertDialog$Builder.f20199a.S = LocaleController.getString(R.string.SdCardErrorDescription);
