...
public final class MessagesController$$ExternalSyntheticLambda377 implements Utilities.Callback {
    ...
    public MessagesController$$ExternalSyntheticLambda377(MessagesController messagesController, TLRPC.TL_messages_invitedUsers tL_messages_invitedUsers, int[] iArr, int i, TLRPC.Chat chat, Runnable runnable) {
    ...
    public MessagesController$$ExternalSyntheticLambda377(MessagesController messagesController, boolean[] zArr, TL_bots.BotInfo[] botInfoArr, TLRPC.User user, int i, FileLoader$1$$ExternalSyntheticLambda1 fileLoader$1$$ExternalSyntheticLambda1) {
        this.f$0 = messagesController;
        this.f$1 = zArr;
        this.f$2 = botInfoArr;
        this.f$3 = user;
