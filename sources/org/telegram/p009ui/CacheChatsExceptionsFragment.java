...
public class CacheChatsExceptionsFragment extends BaseFragment {
    ...
    public void lambda$createView$3(View view, int i, float f, float f2) {
        if (this.items.get(i).viewType == 1) {
            ...
            AlertDialog create = AlertsCreator.createSimpleAlert(getContext(), LocaleController.getString("NotificationsDeleteAllExceptionTitle", C1072R.string.NotificationsDeleteAllExceptionTitle), LocaleController.getString("NotificationsDeleteAllExceptionAlert", C1072R.string.NotificationsDeleteAllExceptionAlert), LocaleController.getString("Delete", C1072R.string.Delete), new Runnable() {
                @Override
    ...
    public void lambda$createView$0(DialogsActivity dialogsActivity, DialogsActivity dialogsActivity2, ArrayList arrayList, CharSequence charSequence, boolean z) {
        boolean z2;
