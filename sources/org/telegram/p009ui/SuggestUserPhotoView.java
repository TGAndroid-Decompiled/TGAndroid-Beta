...
public class SuggestUserPhotoView extends View {
    ...
    public void draw(Canvas canvas) {
        ...
        int measuredHeight = getMeasuredHeight() - AndroidUtilities.m35dp(30.0f);
        int m35dp = AndroidUtilities.m35dp(46.0f) + measuredWidth;
        setImageCoords(this.currentPhoto, measuredWidth - AndroidUtilities.m35dp(46.0f), measuredHeight);
        setImageCoords(this.newPhoto, m35dp, measuredHeight);
        ...
        this.path.reset();
        this.path.addCircle(m35dp, measuredHeight, AndroidUtilities.m35dp(30.0f), Path.Direction.CW);
        this.currentPhoto.draw(canvas);
        if (this.containterView != null) {
            CropAreaView cropAreaView = this.photoCropView.cropView.areaView;
            float m35dp2 = AndroidUtilities.m35dp(60.0f) / cropAreaView.size;
            float left = (0.0f - this.photoCropView.getLeft()) - cropAreaView.left;
            canvas.save();
            canvas.clipPath(this.path);
            canvas.scale(m35dp2, m35dp2, 0.0f, 0.0f);
            canvas.translate(left, (0.0f - this.photoCropView.getTop()) - cropAreaView.top);
            canvas.translate((m35dp - AndroidUtilities.m35dp(30.0f)) / m35dp2, (measuredHeight - AndroidUtilities.m35dp(30.0f)) / m35dp2);
    ...
    private void setImageCoords(ImageReceiver imageReceiver, int i, int i2) {
        imageReceiver.setImageCoords(i - AndroidUtilities.m35dp(30.0f), i2 - AndroidUtilities.m35dp(30.0f), AndroidUtilities.m35dp(60.0f), AndroidUtilities.m35dp(60.0f));
    }

    @Override
    protected void onMeasure(int i, int i2) {
        this.currentPhoto.setRoundRadius(AndroidUtilities.m35dp(30.0f));
        this.newPhoto.setRoundRadius(AndroidUtilities.m35dp(30.0f));
        super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m35dp(86.0f), 1073741824));
    }
