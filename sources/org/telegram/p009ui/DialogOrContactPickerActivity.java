...
public class DialogOrContactPickerActivity extends BaseFragment {
    ...
    public void lambda$new$1(DialogsActivity dialogsActivity, ArrayList arrayList, CharSequence charSequence, boolean z) {
    ...
    public void lambda$new$2(TLRPC$User tLRPC$User, String str, ContactsActivity contactsActivity) {
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString("BlockUserMultiTitle", C1010R.string.BlockUserMultiTitle));
                    ...
                    if (this.startedTracking) {
                        ...
                        DialogOrContactPickerActivity.this.tabsAnimation.addListener(new AnimatorListenerAdapter() {
                            ...
                            public void onAnimationEnd(Animator animator) {
                                ...
                                DialogOrContactPickerActivity.this.tabsAnimationInProgress = false;
                                C30164.this.maybeStartTracking = false;
                                C30164.this.startedTracking = false;
                    ...
                    recyclerListView.setOnScrollListener(new RecyclerView.OnScrollListener() {
                        ...
                        public void onScrolled(RecyclerView recyclerView, int i3, int i4) {
                            ...
                            if (recyclerView == DialogOrContactPickerActivity.this.viewPages[0].listView || recyclerView == DialogOrContactPickerActivity.this.viewPages[0].listView2) {
                                ...
                                if (f < (-C1069ActionBar.getCurrentActionBarHeight())) {
                                    f = -C1069ActionBar.getCurrentActionBarHeight();
                                } else if (f > 0.0f) {
                                    f = 0.0f;
                                }
                                if (f != translationY) {
    ...
    private void showBlockAlert(final TLRPC$User tLRPC$User) {
        ...
        builder.setMessage(AndroidUtilities.replaceTags(LocaleController.formatString("AreYouSureBlockContact2", C1010R.string.AreYouSureBlockContact2, ContactsController.formatName(tLRPC$User.first_name, tLRPC$User.last_name))));
    ...
    public void lambda$showBlockAlert$3(TLRPC$User tLRPC$User, DialogInterface dialogInterface, int i) {
        if (MessagesController.isSupportUser(tLRPC$User)) {
            AlertsCreator.showSimpleToast(this, LocaleController.getString("ErrorOccurred", C1010R.string.ErrorOccurred));
        } else {
            MessagesController.getInstance(this.currentAccount).blockPeer(tLRPC$User.f986id);
            AlertsCreator.showSimpleToast(this, LocaleController.getString("UserBlocked", C1010R.string.UserBlocked));
        }
        finishFragment();
    }
    ...
    private void updateTabs() {
        ...
        scrollSlidingTextTabStrip.addTextTab(0, LocaleController.getString("BlockUserChatsTitle", C1010R.string.BlockUserChatsTitle));
        this.scrollSlidingTextTabStrip.addTextTab(1, LocaleController.getString("BlockUserContactsTitle", C1010R.string.BlockUserContactsTitle));
