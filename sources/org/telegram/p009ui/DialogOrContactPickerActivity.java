...
public class DialogOrContactPickerActivity extends BaseFragment {
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString("BlockUserMultiTitle", C1072R.string.BlockUserMultiTitle));
                    ...
                    if (this.startedTracking) {
                        ...
                        DialogOrContactPickerActivity.this.tabsAnimation.addListener(new AnimatorListenerAdapter() {
                            ...
                            public void onAnimationEnd(Animator animator) {
                                ...
                                DialogOrContactPickerActivity.this.tabsAnimationInProgress = false;
                                C31694.this.maybeStartTracking = false;
                                C31694.this.startedTracking = false;
    ...
    private void showBlockAlert(final TLRPC$User tLRPC$User) {
        ...
        builder.setMessage(AndroidUtilities.replaceTags(LocaleController.formatString("AreYouSureBlockContact2", C1072R.string.AreYouSureBlockContact2, ContactsController.formatName(tLRPC$User.first_name, tLRPC$User.last_name))));
    ...
    public void lambda$showBlockAlert$3(TLRPC$User tLRPC$User, DialogInterface dialogInterface, int i) {
        if (MessagesController.isSupportUser(tLRPC$User)) {
            AlertsCreator.showSimpleToast(this, LocaleController.getString("ErrorOccurred", C1072R.string.ErrorOccurred));
        } else {
            MessagesController.getInstance(this.currentAccount).blockPeer(tLRPC$User.f995id);
            AlertsCreator.showSimpleToast(this, LocaleController.getString("UserBlocked", C1072R.string.UserBlocked));
        }
        finishFragment();
    }
