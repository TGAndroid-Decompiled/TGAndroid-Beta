    ...
    public View createView(Context context) {
        ...
        FrameLayout frameLayout = new FrameLayout(context) {
            ...
            public boolean checkTabsAnimationInProgress() {
                throw new UnsupportedOperationException("Method not decompiled: org.telegram.p009ui.DialogOrContactPickerActivity.C27484.checkTabsAnimationInProgress():boolean");
            }
                    ...
                    if (this.startedTracking) {
                        ...
                        DialogOrContactPickerActivity.this.tabsAnimation.addListener(new AnimatorListenerAdapter() {
                            ...
                            public void onAnimationEnd(Animator animator) {
                                ...
                                C27484.this.maybeStartTracking = false;
                                C27484.this.startedTracking = false;
