...
public class ChooseSpeedLayout {
    ...
    public ChooseSpeedLayout(Context context, final PopupSwipeBackLayout popupSwipeBackLayout, final Callback callback) {
        ...
        ActionBarMenuSubItem addItem = ActionBarMenuItem.addItem(this.speedSwipeBackLayout, C0890R.C0891drawable.msg_arrow_back, LocaleController.getString("Back", C0890R.string.Back), false, null);
        ...
        ActionBarMenuSubItem addItem2 = ActionBarMenuItem.addItem(this.speedSwipeBackLayout, C0890R.C0891drawable.msg_speed_0_2, LocaleController.getString("SpeedVerySlow", C0890R.string.SpeedVerySlow), false, null);
        ...
        ActionBarMenuSubItem addItem3 = ActionBarMenuItem.addItem(this.speedSwipeBackLayout, C0890R.C0891drawable.msg_speed_0_5, LocaleController.getString("SpeedSlow", C0890R.string.SpeedSlow), false, null);
        ...
        ActionBarMenuSubItem addItem4 = ActionBarMenuItem.addItem(this.speedSwipeBackLayout, C0890R.C0891drawable.msg_speed_1, LocaleController.getString("SpeedNormal", C0890R.string.SpeedNormal), false, null);
        ...
        ActionBarMenuSubItem addItem5 = ActionBarMenuItem.addItem(this.speedSwipeBackLayout, C0890R.C0891drawable.msg_speed_1_5, LocaleController.getString("SpeedFast", C0890R.string.SpeedFast), false, null);
        ...
        ActionBarMenuSubItem addItem6 = ActionBarMenuItem.addItem(this.speedSwipeBackLayout, C0890R.C0891drawable.msg_speed_2, LocaleController.getString("SpeedVeryFast", C0890R.string.SpeedVeryFast), false, null);
