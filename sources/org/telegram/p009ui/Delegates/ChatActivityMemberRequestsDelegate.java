...
public class ChatActivityMemberRequestsDelegate {
    ...
    public View getView() {
        if (this.root == null) {
            ...
            frameLayout.setBackgroundResource(C1010R.C1011drawable.blockpanel);
            ...
            this.closeView.setContentDescription(LocaleController.getString("Close", C1010R.string.Close));
            this.closeView.setImageResource(C1010R.C1011drawable.miniplayer_close);
    ...
    public void lambda$getView$1(View view) {
        this.fragment.getMessagesController().setChatPendingRequestsOnClose(this.currentChat.f848id, this.pendingRequestsCount);
    ...
    private void showBottomSheet() {
        if (this.bottomSheet == null) {
            this.bottomSheet = new MemberRequestsBottomSheet(this.fragment, this.currentChat.f848id) {
                @Override
                public void dismiss() {
    ...
    private void setPendingRequests(int i, List<Long> list, boolean z) {
        ...
        if (i <= 0) {
            if (this.currentChat != null) {
                this.fragment.getMessagesController().setChatPendingRequestsOnClose(this.currentChat.f848id, 0);
    ...
    private void animatePendingRequests(final boolean z, boolean z2) {
        ...
        if (z) {
            if (this.closePendingRequestsCount == -1 && this.currentChat != null) {
                this.closePendingRequestsCount = this.fragment.getMessagesController().getChatPendingRequestsOnClosed(this.currentChat.f848id);
            }
