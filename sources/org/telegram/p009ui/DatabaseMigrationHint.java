...
public class DatabaseMigrationHint extends FrameLayout {
    ...
    public DatabaseMigrationHint(Context context, int i) {
        ...
        rLottieImageView.setAnimation(C1072R.raw.db_migration_placeholder, ImageReceiver.DEFAULT_CROSSFADE_DURATION, ImageReceiver.DEFAULT_CROSSFADE_DURATION);
        ...
        this.title.setText(LocaleController.getString("OptimizingTelegram", C1072R.string.OptimizingTelegram));
        ...
        this.description2.setText(LocaleController.getString("OptimizingTelegramDescription2", C1072R.string.OptimizingTelegramDescription2));
