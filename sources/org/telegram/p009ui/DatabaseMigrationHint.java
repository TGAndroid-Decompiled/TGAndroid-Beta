...
public class DatabaseMigrationHint extends FrameLayout {
    ...
    public DatabaseMigrationHint(Context context, int i) {
        ...
        rLottieImageView.setAnimation(C1010R.raw.db_migration_placeholder, ImageReceiver.DEFAULT_CROSSFADE_DURATION, ImageReceiver.DEFAULT_CROSSFADE_DURATION);
        ...
        this.title.setText(LocaleController.getString("OptimizingTelegram", C1010R.string.OptimizingTelegram));
        ...
        this.description1.setText(LocaleController.getString("OptimizingTelegramDescription1", C1010R.string.OptimizingTelegramDescription1));
        ...
        this.description2.setText(LocaleController.getString("OptimizingTelegramDescription2", C1010R.string.OptimizingTelegramDescription2));
