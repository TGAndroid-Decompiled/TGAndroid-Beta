...
import org.telegram.p009ui.DefaultThemesPreviewCell;
...
public class DefaultThemesPreviewCell extends LinearLayout {
    ...
    public DefaultThemesPreviewCell(Context context, final BaseFragment baseFragment, int i) {
        ...
        if (this.currentType == 0) {
            ...
            this.dayNightCell.setOnClickListener(new View$OnClickListenerC31511(context));
    ...
    public class View$OnClickListenerC31511 implements View.OnClickListener {
        final Context val$context;

        View$OnClickListenerC31511(Context context) {
        ...
        public void onClick(android.view.View r13) {
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p009ui.DefaultThemesPreviewCell.View$OnClickListenerC31511.onClick(android.view.View):void");
        }
        ...
        public void lambda$onClick$1(final int i, final Context context, final int i2, final boolean z) {
            AndroidUtilities.runOnUIThread(new Runnable() {
                ...
                public final void run() {
                    DefaultThemesPreviewCell.View$OnClickListenerC31511.this.lambda$onClick$0(i, context, i2, z);
                }
            });
        }

        public void lambda$onClick$0(final int i, Context context, int i2, boolean z) {
