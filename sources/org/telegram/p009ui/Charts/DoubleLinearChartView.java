...
import org.telegram.p009ui.Charts.data.DoubleLinearChartData;
...
public class DoubleLinearChartView extends BaseChartView<DoubleLinearChartData, LineViewData> {
    ...
    protected void drawChart(Canvas canvas) {
        ...
        if (this.chartData != 0) {
            ...
            if (i == 2) {
                ...
                canvas.scale((f10 * 2.0f) + 1.0f, 1.0f, transitionParams.f1015pX, transitionParams.f1016pY);
            } else if (i == 1) {
                ...
                canvas.scale(f12, f12, transitionParams2.f1015pX, transitionParams2.f1016pY);
            } else {
            ...
            while (i5 < this.lines.size()) {
                ...
                if (lineViewData.enabled || lineViewData.alpha != f9) {
                    int[] iArr = lineViewData.line.f1014y;
        ...
        if (i >= 0 && this.legendShowing) {
            ...
            while (true) {
                ...
                if (i3 < this.tmpN) {
                    LineViewData lineViewData = (LineViewData) this.lines.get(i3);
                    if (lineViewData.enabled || lineViewData.alpha != 0.0f) {
                        float f6 = lineViewData.line.f1014y[this.selectedIndex] * ((DoubleLinearChartData) this.chartData).linesK[this.tmpI];
    ...
    @Override
    public void drawSignaturesToHorizontalLines(android.graphics.Canvas r18, org.telegram.p009ui.Charts.view_data.ChartHorizontalLinesData r19) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p009ui.Charts.DoubleLinearChartView.drawSignaturesToHorizontalLines(android.graphics.Canvas, org.telegram.ui.Charts.view_data.ChartHorizontalLinesData):void");
    }
