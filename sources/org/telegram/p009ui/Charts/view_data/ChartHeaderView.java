...
public class ChartHeaderView extends FrameLayout {
    ...
    public ChartHeaderView(Context context) {
        ...
        this.back.setText(LocaleController.getString("ZoomOut", C0952R.string.ZoomOut));
        Drawable drawable = ContextCompat.getDrawable(getContext(), C0952R.C0953drawable.stats_zoom);
        ...
        this.back.setCompoundDrawablePadding(AndroidUtilities.m34dp(4.0f));
        this.back.setPadding(AndroidUtilities.m34dp(8.0f), AndroidUtilities.m34dp(4.0f), AndroidUtilities.m34dp(8.0f), AndroidUtilities.m34dp(4.0f));
    ...
    public void zoomTo(BaseChartView baseChartView, long j, boolean z) {
        ...
        if (z) {
            ...
            this.back.setPivotY(AndroidUtilities.m34dp(40.0f));
