...
public class ChartHeaderView extends FrameLayout {
    ...
    public ChartHeaderView(Context context) {
        ...
        this.back.setText(LocaleController.getString("ZoomOut", C0890R.string.ZoomOut));
        Drawable drawable = ContextCompat.getDrawable(getContext(), C0890R.C0891drawable.stats_zoom);
