...
public class ChartHeaderView extends FrameLayout {
    ...
    public ChartHeaderView(Context context) {
        ...
        this.back.setText(LocaleController.getString("ZoomOut", C1010R.string.ZoomOut));
        Drawable drawable = ContextCompat.getDrawable(getContext(), C1010R.C1011drawable.msg_zoomout_stats);
