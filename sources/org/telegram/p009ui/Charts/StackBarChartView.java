...
public class StackBarChartView extends BaseChartView<StackBarChartData, StackBarViewData> {
    ...
    protected void drawChart(Canvas canvas) {
        ...
        if (t != 0) {
            ...
            if (i4 == 2) {
                ...
                f3 = 1.0f - f14;
                canvas.scale((f14 * 2.0f) + 1.0f, 1.0f, transitionParams.f1015pX, transitionParams.f1016pY);
            } else if (i4 == 1) {
                TransitionParams transitionParams2 = this.transitionParams;
                f3 = transitionParams2.progress;
                canvas.scale(f3, 1.0f, transitionParams2.f1015pX, transitionParams2.f1016pY);
            } else {
            ...
            if (z) {
                ...
                for (int i11 = 0; i11 < this.lines.size(); i11++) {
                    ...
                    int[] iArr2 = lineViewData2.line.f1014y;
    ...
    protected void selectXOnChart(int i, int i2) {
        ...
        if (t != 0) {
            ...
            if (f3 < 0.0f) {
                ...
                this.selectedIndex = ((StackBarChartData) t).f1012x.length - 1;
            } else {
            ...
            for (int i2 = 0; i2 < length; i2++) {
                ...
                while (true) {
                    ...
                    if (lineViewData.enabled || lineViewData.alpha != 0.0f) {
                        int i4 = lineViewData.line.f1014y[i2];
    ...
    public void onCheckChanged() {
        int length = ((StackBarChartData) this.chartData).lines.get(0).f1014y.length;
        ...
        for (int i = 0; i < length; i++) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                if (((StackBarViewData) this.lines.get(i2)).enabled) {
                    ...
                    iArr[i] = iArr[i] + ((StackBarChartData) t).lines.get(i2).f1014y[i];
                }
            }
        }
        T t2 = this.chartData;
    ...
    public void updatePickerMinMaxHeight() {
        if (BaseChartView.ANIMATE_PICKER_SIZES) {
            int length = ((StackBarChartData) this.chartData).f1012x.length;
            int size = this.lines.size();
            int i = 0;
            for (int i2 = 0; i2 < length; i2++) {
                int i3 = 0;
                for (int i4 = 0; i4 < size; i4++) {
                    ...
                    if (stackBarViewData.enabled) {
                        i3 += stackBarViewData.line.f1014y[i2];
                    }
                }
                if (i3 > i) {
                    i = i3;
    ...
    public void initPickerMaxHeight() {
        ...
        for (int i = 0; i < length; i++) {
            ...
            for (int i3 = 0; i3 < size; i3++) {
                ...
                if (stackBarViewData.enabled) {
                    i2 += stackBarViewData.line.f1014y[i];
                }
            }
            float f = i2;
