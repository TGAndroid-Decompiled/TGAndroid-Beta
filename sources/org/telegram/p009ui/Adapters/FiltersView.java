...
public class FiltersView extends RecyclerListView {
    ...
    public static final MediaFilterData[] filters = {new MediaFilterData(C0952R.C0953drawable.search_media, C0952R.C0953drawable.search_media_filled, LocaleController.getString("SharedMediaTab2", C0952R.string.SharedMediaTab2), new TLRPC$TL_inputMessagesFilterPhotoVideo(), 0), new MediaFilterData(C0952R.C0953drawable.search_links, C0952R.C0953drawable.search_links_filled, LocaleController.getString("SharedLinksTab2", C0952R.string.SharedLinksTab2), new TLRPC$TL_inputMessagesFilterUrl(), 2), new MediaFilterData(C0952R.C0953drawable.search_files, C0952R.C0953drawable.search_files_filled, LocaleController.getString("SharedFilesTab2", C0952R.string.SharedFilesTab2), new TLRPC$TL_inputMessagesFilterDocument(), 1), new MediaFilterData(C0952R.C0953drawable.search_music, C0952R.C0953drawable.search_music_filled, LocaleController.getString("SharedMusicTab2", C0952R.string.SharedMusicTab2), new TLRPC$TL_inputMessagesFilterMusic(), 3), new MediaFilterData(C0952R.C0953drawable.search_voice, C0952R.C0953drawable.search_voice_filled, LocaleController.getString("SharedVoiceTab2", C0952R.string.SharedVoiceTab2), new TLRPC$TL_inputMessagesFilterRoundVoice(), 5)};
                ...
                if (i3 == 4) {
                    ...
                    if (tLObject instanceof TLRPC$User) {
                        ...
                        if (tLObject2 instanceof TLRPC$User) {
                            return ((TLRPC$User) tLObject).f985id == ((TLRPC$User) tLObject2).f985id;
                        }
                    }
                    if (tLObject instanceof TLRPC$Chat) {
                        TLObject tLObject3 = mediaFilterData2.chat;
                        return (tLObject3 instanceof TLRPC$Chat) && ((TLRPC$Chat) tLObject).f854id == ((TLRPC$Chat) tLObject3).f854id;
                    }
                } else if (i3 == 6) {
    ...
    public FiltersView(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        addItemDecoration(new RecyclerView.ItemDecoration(this) {
            ...
            public void getItemOffsets(Rect rect, View view, RecyclerView recyclerView, RecyclerView.State state) {
                ...
                rect.left = AndroidUtilities.m34dp(8.0f);
                if (childAdapterPosition == state.getItemCount() - 1) {
                    rect.right = AndroidUtilities.m34dp(10.0f);
                }
                if (childAdapterPosition == 0) {
                    rect.left = AndroidUtilities.m34dp(10.0f);
                }
            }
        });
            ...
            public void animateAddImpl(final RecyclerView.ViewHolder viewHolder) {
                ...
                animate.alpha(1.0f).scaleX(1.0f).scaleY(1.0f).setDuration(getAddDuration()).setListener(new AnimatorListenerAdapter() {
                    ...
                    public void onAnimationEnd(Animator animator) {
                        ...
                        ((DefaultItemAnimator) C11143.this).mAddAnimations.remove(viewHolder);
            ...
            protected void animateRemoveImpl(final RecyclerView.ViewHolder viewHolder) {
                ...
                animate.setDuration(getRemoveDuration()).alpha(0.0f).scaleX(0.0f).scaleY(0.0f).setListener(new AnimatorListenerAdapter() {
                    ...
                    public void onAnimationEnd(Animator animator) {
                        ...
                        ((DefaultItemAnimator) C11143.this).mRemoveAnimations.remove(viewHolder);
                        dispatchFinishedWhenDone();
                    }
                }).start();
            }
        ...
        setSelectorRadius(AndroidUtilities.m34dp(28.0f));
    ...
    public void setUsersAndDates(ArrayList<Object> arrayList, ArrayList<DateData> arrayList2, boolean z) {
        ...
        if (arrayList != null) {
            for (int i = 0; i < arrayList.size(); i++) {
                ...
                if (obj instanceof TLRPC$User) {
                    ...
                    if (UserConfig.getInstance(UserConfig.selectedAccount).getCurrentUser().f985id == tLRPC$User.f985id) {
                    ...
                    MediaFilterData mediaFilterData = new MediaFilterData(C0952R.C0953drawable.search_users, C0952R.C0953drawable.search_users_filled, str, null, 4);
                    ...
                    MediaFilterData mediaFilterData2 = new MediaFilterData(C0952R.C0953drawable.search_users, C0952R.C0953drawable.search_users_filled, str2, null, 4);
        ...
        if (arrayList2 != null) {
            for (int i2 = 0; i2 < arrayList2.size(); i2++) {
                ...
                MediaFilterData mediaFilterData3 = new MediaFilterData(C0952R.C0953drawable.search_date, C0952R.C0953drawable.search_date_filled, dateData.title, null, 6);
                mediaFilterData3.setDate(dateData);
                this.usersFilters.add(mediaFilterData3);
            }
        }
        if (z) {
            this.usersFilters.add(new MediaFilterData(C0952R.C0953drawable.chats_archive, C0952R.C0953drawable.chats_archive, LocaleController.getString("ArchiveSearchFilter", C0952R.string.ArchiveSearchFilter), null, 7));
        }
        if (getAdapter() != null) {
    ...
    public static void fillTipDates(String str, ArrayList<DateData> arrayList) {
        ...
        if (str != null) {
            ...
            if (trim.length() >= 3) {
                if (LocaleController.getString("SearchTipToday", C0952R.string.SearchTipToday).toLowerCase().startsWith(trim) || "today".startsWith(trim)) {
                    ...
                    arrayList.add(new DateData(LocaleController.getString("SearchTipToday", C0952R.string.SearchTipToday), timeInMillis, calendar.getTimeInMillis() - 1));
                } else if (LocaleController.getString("SearchTipYesterday", C0952R.string.SearchTipYesterday).toLowerCase().startsWith(trim) || "yesterday".startsWith(trim)) {
                    ...
                    arrayList.add(new DateData(LocaleController.getString("SearchTipYesterday", C0952R.string.SearchTipYesterday), calendar2.getTimeInMillis() - 86400000, calendar2.getTimeInMillis() - 86400001));
                } else {
    ...
    public static int getMonth(String str) {
        String[] strArr = {LocaleController.getString("January", C0952R.string.January).toLowerCase(), LocaleController.getString("February", C0952R.string.February).toLowerCase(), LocaleController.getString("March", C0952R.string.March).toLowerCase(), LocaleController.getString("April", C0952R.string.April).toLowerCase(), LocaleController.getString("May", C0952R.string.May).toLowerCase(), LocaleController.getString("June", C0952R.string.June).toLowerCase(), LocaleController.getString("July", C0952R.string.July).toLowerCase(), LocaleController.getString("August", C0952R.string.August).toLowerCase(), LocaleController.getString("September", C0952R.string.September).toLowerCase(), LocaleController.getString("October", C0952R.string.October).toLowerCase(), LocaleController.getString("November", C0952R.string.November).toLowerCase(), LocaleController.getString("December", C0952R.string.December).toLowerCase()};
    ...
    private class Adapter extends RecyclerListView.SelectionAdapter {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            RecyclerView.LayoutParams layoutParams = new RecyclerView.LayoutParams(-2, AndroidUtilities.m34dp(32.0f));
            ((ViewGroup.MarginLayoutParams) layoutParams).topMargin = AndroidUtilities.m34dp(6.0f);
    ...
    public static class FilterView extends FrameLayout {
        ...
        public void updateColors() {
            setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m34dp(28.0f), getThemedColor("groupcreate_spanBackground")));
        ...
        public void setData(MediaFilterData mediaFilterData) {
            ...
            if (mediaFilterData.filterType == 7) {
                CombinedDrawable createCircleDrawableWithIcon = Theme.createCircleDrawableWithIcon(AndroidUtilities.m34dp(32.0f), C0952R.C0953drawable.chats_archive);
                this.thumbDrawable = createCircleDrawableWithIcon;
                createCircleDrawableWithIcon.setIconSize(AndroidUtilities.m34dp(16.0f), AndroidUtilities.m34dp(16.0f));
            ...
            CombinedDrawable createCircleDrawableWithIcon2 = Theme.createCircleDrawableWithIcon(AndroidUtilities.m34dp(32.0f), mediaFilterData.iconResFilled);
            ...
            if (mediaFilterData.filterType == 4) {
                ...
                if (tLObject instanceof TLRPC$User) {
                    ...
                    if (UserConfig.getInstance(UserConfig.selectedAccount).getCurrentUser().f985id == tLRPC$User.f985id) {
                        CombinedDrawable createCircleDrawableWithIcon3 = Theme.createCircleDrawableWithIcon(AndroidUtilities.m34dp(32.0f), C0952R.C0953drawable.chats_saved);
                        createCircleDrawableWithIcon3.setIconSize(AndroidUtilities.m34dp(16.0f), AndroidUtilities.m34dp(16.0f));
                        ...
                        this.avatarImageView.getImageReceiver().setRoundRadius(AndroidUtilities.m34dp(16.0f));
