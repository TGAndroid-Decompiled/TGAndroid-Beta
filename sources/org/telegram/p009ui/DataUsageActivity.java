    ...
    public View createView(Context context) {
        ...
        FrameLayout frameLayout = new FrameLayout(context) {
            ...
            public boolean checkTabsAnimationInProgress() {
                throw new UnsupportedOperationException("Method not decompiled: org.telegram.p009ui.DataUsageActivity.C27233.checkTabsAnimationInProgress():boolean");
            }
                    ...
                    if (this.startedTracking) {
                        ...
                        DataUsageActivity.this.tabsAnimation.addListener(new AnimatorListenerAdapter() {
                            ...
                            public void onAnimationEnd(Animator animator) {
                                ...
                                C27233.this.maybeStartTracking = false;
                                C27233.this.startedTracking = false;
