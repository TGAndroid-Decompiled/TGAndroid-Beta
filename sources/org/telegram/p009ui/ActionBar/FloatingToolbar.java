...
public final class FloatingToolbar {
    ...
    private boolean isCurrentlyShowing(List<MenuItem> list) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (menuItem.getItemId() != menuItem2.getItemId() || !TextUtils.equals(menuItem.getTitle(), menuItem2.getTitle()) || !ObjectsCompat$$ExternalSyntheticBackport0.m677m(menuItem.getIcon(), menuItem2.getIcon()) || menuItem.getGroupId() != menuItem2.getGroupId()) {
                return false;
            }
        }
        return true;
    ...
    public final class FloatingToolbarPopup {
        ...
        private final int mMarginHorizontal = AndroidUtilities.m34dp(16.0f);
        private final int mMarginVertical = AndroidUtilities.m34dp(8.0f);
        private final int mLineHeight = AndroidUtilities.m34dp(48.0f);
        ...
        private int getAdjustedToolbarWidth(int i) {
            refreshViewPort();
            int width = this.mViewPortOnScreen.width() - (AndroidUtilities.m34dp(16.0f) * 2);
            if (i <= 0) {
                i = AndroidUtilities.m34dp(400.0f);
            }
        ...
        private ImageButton createOverflowButton() {
            ...
            imageButton.setLayoutParams(new ViewGroup.LayoutParams(AndroidUtilities.m34dp(56.0f), AndroidUtilities.m34dp(48.0f)));
            imageButton.setPaddingRelative(AndroidUtilities.m34dp(16.0f), AndroidUtilities.m34dp(12.0f), AndroidUtilities.m34dp(16.0f), AndroidUtilities.m34dp(12.0f));
        ...
        public final class OverflowPanelViewHelper {
            private final Context mContext;
            private final int mIconTextSpacing;
            private final int mSidePadding = AndroidUtilities.m34dp(18.0f);
    ...
    public View createMenuItemButton(Context context, MenuItem menuItem, int i, boolean z, boolean z2) {
        ...
        linearLayout.setMinimumWidth(AndroidUtilities.m34dp(48.0f));
        linearLayout.setMinimumHeight(AndroidUtilities.m34dp(48.0f));
        linearLayout.setPaddingRelative(AndroidUtilities.m34dp(16.0f), 0, AndroidUtilities.m34dp(16.0f), 0);
        ...
        textView.setPaddingRelative(AndroidUtilities.m34dp(11.0f), 0, 0, 0);
        linearLayout.addView(textView, new LinearLayout.LayoutParams(-2, AndroidUtilities.m34dp(48.0f)));
        if (menuItem != null) {
    ...
    public ViewGroup createContentContainer(Context context) {
        ...
        relativeLayout.setElevation(AndroidUtilities.m34dp(2.0f));
