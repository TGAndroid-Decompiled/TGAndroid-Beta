...
public class ActionBarPopupWindow extends PopupWindow {
    ...
    public static class ActionBarPopupWindowLayout extends FrameLayout {
                            ...
                            if (childAt.getVisibility() != 8) {
                                ...
                                if (tag3 == null) {
                                    ...
                                    if (!z && tag2 == null) {
                                        ...
                                        actionBarPopupWindowLayout.gapEndY = actionBarPopupWindowLayout.gapStartY + AndroidUtilities.m34dp(6.0f);
                                    }
                                }
                                if (arrayList == null) {
        ...
        public void setBackScaleY(float f) {
            ...
            if (this.backScaleY != f) {
                ...
                if (this.animationEnabled && this.updateAnimation) {
                    int measuredHeight = getMeasuredHeight() - AndroidUtilities.m34dp(16.0f);
                    if (this.shownFromBotton) {
                        for (int i = this.lastStartedChild; i >= 0; i--) {
                            ...
                            if (itemAt.getVisibility() == 0 && !(itemAt instanceof GapView)) {
                                if (this.positions.get(itemAt) != null && measuredHeight - ((num.intValue() * AndroidUtilities.m34dp(48.0f)) + AndroidUtilities.m34dp(32.0f)) > measuredHeight * f) {
                                    break;
                                }
                        ...
                        for (int i3 = 0; i3 < itemsCount; i3++) {
                            ...
                            if (itemAt2.getVisibility() == 0) {
                                ...
                                if (i3 >= this.lastStartedChild) {
                                    if (this.positions.get(itemAt2) != null && i2 - AndroidUtilities.m34dp(24.0f) > measuredHeight * f) {
                                        break;
                                    }
        ...
        private void startChildAnimation(View view) {
            if (this.animationEnabled) {
                ...
                fArr2[0] = AndroidUtilities.m34dp(this.shownFromBotton ? 6.0f : -6.0f);
                fArr2[1] = 0.0f;
        ...
        protected void dispatchDraw(Canvas canvas) {
            if (this.swipeBackGravityRight) {
                ...
                if (view != null) {
                    ...
                    float f = (-(this.topView.getMeasuredHeight() - AndroidUtilities.m34dp(16.0f))) * this.swipeBackLayout.transitionProgress;
    ...
    public void dismiss(boolean z) {
        ...
        if (this.outEmptyTime > 0) {
            ...
            fArr[0] = AndroidUtilities.m34dp((actionBarPopupWindowLayout == null || !actionBarPopupWindowLayout.shownFromBotton) ? -5.0f : 5.0f);
