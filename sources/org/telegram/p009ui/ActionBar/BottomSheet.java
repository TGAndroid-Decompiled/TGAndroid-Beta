...
public class BottomSheet extends Dialog {
    ...
    public class ContainerView extends FrameLayout implements NestedScrollingParent {
        ...
        public boolean processTouchEvent(MotionEvent motionEvent, boolean z) {
            ...
            if (BottomSheet.this.canDismissWithTouchOutside() && motionEvent != null && ((motionEvent.getAction() == 0 || motionEvent.getAction() == 2) && !this.startedTracking && !this.maybeStartTracking && motionEvent.getPointerCount() == 1)) {
                ...
                BottomSheet.this.onScrollUpBegin(this.f986y);
                ...
                boolean onScrollUp = BottomSheet.this.onScrollUp(this.f986y + y2);
                ...
                if (!BottomSheet.this.disableScroll && this.maybeStartTracking && !this.startedTracking && y2 > 0.0f && y2 / 3.0f > Math.abs(abs) && Math.abs(y2) >= BottomSheet.this.touchSlop) {
                    ...
                    float f = this.f986y + y2;
                    this.f986y = f;
                    if (!onScrollUp) {
                        this.f986y = Math.max(f, 0.0f);
                    }
                    BottomSheet.this.containerView.setTranslationY(Math.max(this.f986y, 0.0f));
                    this.startedTrackingY = (int) motionEvent.getY();
                    BottomSheet.this.container.invalidate();
                }
                ...
                BottomSheet.this.onScrollUpEnd(this.f986y);
                if (this.startedTracking || this.f986y > 0.0f) {
        ...
        protected void onMeasure(int r14, int r15) {
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p009ui.ActionBar.BottomSheet.ContainerView.onMeasure(int, int):void");
        }
        ...
        protected void onLayout(boolean r17, int r18, int r19, int r20, int r21) {
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p009ui.ActionBar.BottomSheet.ContainerView.onLayout(boolean, int, int, int, int):void");
        }

        public void lambda$onLayout$0(ValueAnimator valueAnimator) {
        ...
        protected void dispatchDraw(android.graphics.Canvas r11) {
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p009ui.ActionBar.BottomSheet.ContainerView.dispatchDraw(android.graphics.Canvas):void");
        }
        ...
        protected void onDraw(android.graphics.Canvas r11) {
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p009ui.ActionBar.BottomSheet.ContainerView.onDraw(android.graphics.Canvas):void");
        }
    ...
    public static class BottomSheetCell extends FrameLayout {
        ...
        public BottomSheetCell(Context context, int i, Theme.ResourcesProvider resourcesProvider) {
            ...
            if (i == 0) {
                ...
                this.textView.setTextSize(1, 14.0f);
                this.textView.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf"));
                this.textView.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m34dp(4.0f), getThemedColor("featuredStickers_addButton"), getThemedColor("featuredStickers_addButtonPressed")));
        ...
        protected void onMeasure(int i, int i2) {
            ...
            super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m34dp(i4), 1073741824));
        }
        ...
        public void setTextAndIcon(CharSequence charSequence, int i, Drawable drawable, boolean z) {
            ...
            if (i == 0 && drawable == null) {
                ...
                int dp = AndroidUtilities.m34dp(z ? 21.0f : 16.0f);
                if (!z) {
                    f = 16.0f;
                }
                textView.setPadding(dp, 0, AndroidUtilities.m34dp(f), 0);
                return;
            }
            if (drawable != null) {
            ...
            if (z) {
                ...
                int dp2 = AndroidUtilities.m34dp(LocaleController.isRTL ? 21.0f : 72.0f);
                if (LocaleController.isRTL) {
                    f = 72.0f;
                }
                textView2.setPadding(dp2, 0, AndroidUtilities.m34dp(f), 0);
                this.imageView.setPadding(LocaleController.isRTL ? 0 : AndroidUtilities.m34dp(5.0f), 0, LocaleController.isRTL ? AndroidUtilities.m34dp(5.0f) : 5, 0);
                return;
            }
            TextView textView3 = this.textView;
            int dp3 = AndroidUtilities.m34dp(LocaleController.isRTL ? 16.0f : 72.0f);
            if (LocaleController.isRTL) {
                f2 = 72.0f;
            }
            textView3.setPadding(dp3, 0, AndroidUtilities.m34dp(f2), 0);
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (this.containerView == null) {
            ...
            this.containerView.setPadding(this.backgroundPaddingLeft, ((this.applyTopPadding ? AndroidUtilities.m34dp(8.0f) : 0) + this.backgroundPaddingTop) - 1, this.backgroundPaddingLeft, this.applyBottomPadding ? AndroidUtilities.m34dp(8.0f) : 0);
        }
        ...
        if (this.title != null) {
            ...
            if (this.bigTitle) {
                ...
                this.titleView.setPadding(AndroidUtilities.m34dp(21.0f), AndroidUtilities.m34dp(6.0f), AndroidUtilities.m34dp(21.0f), AndroidUtilities.m34dp(8.0f));
            } else {
                this.titleView.setTextColor(getThemedColor("dialogTextGray2"));
                this.titleView.setTextSize(1, 16.0f);
                this.titleView.setPadding(AndroidUtilities.m34dp(16.0f), 0, AndroidUtilities.m34dp(16.0f), AndroidUtilities.m34dp(8.0f));
            }
    ...
    public void startOpenAnimation() {
        if (!this.dismissed) {
            ...
            if (!onCustomOpenAnimation()) {
                ...
                ViewGroup viewGroup = this.containerView;
                viewGroup.setTranslationY(viewGroup.getMeasuredHeight() + (this.scrollNavBar ? getBottomInset() : 0));
    ...
    public void dismissWithButtonClick(int i) {
        if (!this.dismissed) {
            ...
            fArr[0] = viewGroup.getMeasuredHeight() + AndroidUtilities.m34dp(10.0f) + (this.scrollNavBar ? getBottomInset() : 0);
            ...
            this.currentSheetAnimation.addListener(new C10006(i));
            NotificationCenter.getGlobalInstance().postNotificationName(NotificationCenter.stopAllHeavyOperations, 512);
            this.currentSheetAnimation.start();
        }
    }

    public class C10006 extends AnimatorListenerAdapter {
        final int val$item;
        ...
        public void onAnimationEnd(Animator animator) {
            ...
            if (animatorSet != null && animatorSet.equals(animator)) {
                ...
                AndroidUtilities.runOnUIThread(new Runnable() {
                    @Override
                    public final void run() {
                        BottomSheet.C10006.this.lambda$onAnimationEnd$0();
                    }
                });
            }
            NotificationCenter.getGlobalInstance().postNotificationName(NotificationCenter.startAllHeavyOperations, 512);
    ...
    public void dismiss() {
        ...
        if ((bottomSheetDelegateInterface == null || bottomSheetDelegateInterface.canDismiss()) && !this.dismissed) {
            ...
            if (!this.allowCustomAnimation || !onCustomCloseAnimation()) {
                ...
                Property property = View.TRANSLATION_Y;
                float[] fArr = new float[1];
                fArr[0] = viewGroup.getMeasuredHeight() + this.container.keyboardHeight + AndroidUtilities.m34dp(10.0f) + (this.scrollNavBar ? getBottomInset() : 0);
                animatorArr[0] = ObjectAnimator.ofFloat(viewGroup, property, fArr);
                animatorArr[1] = ObjectAnimator.ofInt(this.backDrawable, AnimationProperties.COLOR_DRAWABLE_ALPHA, 0);
                animatorSet.playTogether(animatorArr);
                ...
                this.currentSheetAnimation.addListener(new C10017());
                NotificationCenter.getGlobalInstance().postNotificationName(NotificationCenter.stopAllHeavyOperations, 512);
                this.currentSheetAnimation.start();
            } else {
                j = 0;
    ...
    public class C10017 extends AnimatorListenerAdapter {
        C10017() {
        }
        ...
        public void onAnimationEnd(Animator animator) {
            ...
            if (animatorSet != null && animatorSet.equals(animator)) {
                ...
                AndroidUtilities.runOnUIThread(new Runnable() {
                    @Override
                    public final void run() {
                        BottomSheet.C10017.this.lambda$onAnimationEnd$0();
                    }
                });
            }
            NotificationCenter.getGlobalInstance().postNotificationName(NotificationCenter.startAllHeavyOperations, 512);
