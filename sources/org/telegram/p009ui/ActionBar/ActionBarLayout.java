...
public class ActionBarLayout extends FrameLayout {
    ...
    protected boolean drawChild(Canvas canvas, View view, long j) {
        ...
        if (view == this.containerViewBack) {
            paddingLeft2 = AndroidUtilities.m34dp(1.0f) + paddingRight;
        ...
        if (!(paddingRight == 0 && this.overrideWidthOffset == -1)) {
            ...
            if (view == this.containerView) {
                float clamp = MathUtils.clamp(i / AndroidUtilities.m34dp(20.0f), 0.0f, 1.0f);
    ...
    private void drawPreviewDrawables(Canvas canvas, ViewGroup viewGroup) {
        ...
        if (childAt != null) {
            ...
            if (this.previewMenu == null) {
                int measuredWidth = (getMeasuredWidth() - AndroidUtilities.m34dp(24.0f)) / 2;
                float top = childAt.getTop() + viewGroup.getTranslationY();
                if (Build.VERSION.SDK_INT < 21) {
                    i = 20;
                }
                int dp = (int) (top - AndroidUtilities.m34dp(i + 12));
                Theme.moveUpDrawable.setBounds(measuredWidth, dp, AndroidUtilities.m34dp(24.0f) + measuredWidth, AndroidUtilities.m34dp(24.0f) + dp);
        ...
        Runnable runnable = new Runnable() {
            ...
            public void run() {
                if (ActionBarLayout.this.animationRunnable == this) {
                    ...
                    ActionBarLayout.access$1116(ActionBarLayout.this, ((float) j) / 150.0f);
                    ...
                    if (z) {
                        ...
                        if (z3) {
                            ...
                            ActionBarLayout.this.containerView.setTranslationX(AndroidUtilities.m34dp(48.0f) * (1.0f - interpolation));
                        }
                    } else {
                        ...
                        if (z3) {
                            ...
                            ActionBarLayout.this.containerViewBack.setTranslationX(AndroidUtilities.m34dp(48.0f) * interpolation);
                        }
                    }
                    if (ActionBarLayout.this.animationProgress < 1.0f) {
    ...
    public boolean presentFragment(final BaseFragment baseFragment, final boolean z, boolean z2, boolean z3, final boolean z4, final View view) {
        ...
        baseFragment.setInMenuMode(view != null);
        ...
        if (view != null) {
            ...
            i = view.getMeasuredHeight() + AndroidUtilities.m34dp(24.0f);
            FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) view.getLayoutParams();
            layoutParams.width = -2;
            layoutParams.height = -2;
            layoutParams.topMargin = (getMeasuredHeight() - i) - AndroidUtilities.m34dp(6.0f);
            view.setLayoutParams(layoutParams);
        } else {
            i = 0;
        }
        ...
        if (z4) {
            ...
            if (previewHeight <= 0 || previewHeight >= getMeasuredHeight() - i2) {
                int dp = AndroidUtilities.m34dp(view != null ? 0.0f : 46.0f);
            ...
            if (view != null) {
                layoutParams2.bottomMargin += i + AndroidUtilities.m34dp(8.0f);
            }
        ...
        if (z4) {
            if (Build.VERSION.SDK_INT >= 21) {
                ...
                view2.setElevation(AndroidUtilities.m34dp(4.0f));
            }
            ...
            if (!this.useAlphaAnimations || this.fragmentsStack.size() != 1) {
                ...
                this.onOpenAnimationEndRunnable = new Runnable() {
                    ...
                    public final void run() {
                        ActionBarLayout.this.lambda$presentFragment$1(z4, view, z, baseFragment3, baseFragment);
                    }
                };
    ...
    public void lambda$presentFragment$1(boolean z, View view, boolean z2, BaseFragment baseFragment, BaseFragment baseFragment2) {
        if (z) {
