...
public class DrawerLayoutContainer extends FrameLayout {
    ...
    public boolean onTouchEvent(android.view.MotionEvent r9) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p009ui.ActionBar.DrawerLayoutContainer.onTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    protected boolean drawChild(Canvas canvas, View view, long j) {
        ...
        if (z) {
            ...
            if (i != 0) {
                canvas.clipRect(i - AndroidUtilities.m34dp(1.0f), 0, width, getHeight());
            }
            i2 = i3;
        } else {
            i = 0;
        ...
        if (this.scrimOpacity <= 0.0f || !z) {
            if (this.shadowLeft != null) {
                float max = Math.max(0.0f, Math.min(this.drawerPosition / AndroidUtilities.m34dp(20.0f), 1.0f));
                if (max != 0.0f) {
    ...
    private static class PreviewForegroundDrawable extends Drawable {
        ...
        public PreviewForegroundDrawable() {
            ...
            gradientDrawable.setStroke(AndroidUtilities.m34dp(1.0f), Theme.getColor("actionBarDefault"));
            ...
            gradientDrawable2.setCornerRadius(AndroidUtilities.m34dp(6.0f));
        }
