...
public class AdjustPanLayoutHelper {
    ...
    ViewTreeObserver.OnPreDrawListener onPreDrawListener = new ViewTreeObserver.OnPreDrawListener() {
        ...
        public boolean onPreDraw() {
            ...
            if (startOffset == i - adjustPanLayoutHelper.previousStartOffset || height == i || adjustPanLayoutHelper.animator != null) {
                ...
                return true;
            } else if (!adjustPanLayoutHelper.heightAnimationEnabled() || Math.abs(AdjustPanLayoutHelper.this.previousHeight - height) < AndroidUtilities.m34dp(20.0f)) {
    ...
    public void animateHeight(int r6, int r7, final boolean r8) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p009ui.ActionBar.AdjustPanLayoutHelper.animateHeight(int, int, boolean):void");
    }
