...
public class SimpleTextView extends View {
    ...
    private int drawablePadding = AndroidUtilities.m34dp(4.0f);
    ...
    public void setTextSize(int i) {
        float dp = AndroidUtilities.m34dp(i);
    ...
    public void setScrollNonFitText(boolean z) {
        if (this.scrollNonFitText != z) {
            ...
            if (z) {
                ...
                this.fadePaint.setShader(new LinearGradient(0.0f, 0.0f, AndroidUtilities.m34dp(6.0f), 0.0f, new int[]{-1, 0}, new float[]{0.0f, 1.0f}, Shader.TileMode.CLAMP));
                this.fadePaint.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.DST_OUT));
                this.fadePaintBack = new Paint();
                this.fadePaintBack.setShader(new LinearGradient(0.0f, 0.0f, AndroidUtilities.m34dp(6.0f), 0.0f, new int[]{0, -1}, new float[]{0.0f, 1.0f}, Shader.TileMode.CLAMP));
    ...
    private void calcOffset(int i) {
        if (this.layout.getLineCount() > 0) {
            ...
            if ((i2 & 7) == 1) {
                ...
                this.offsetX = -AndroidUtilities.m34dp(8.0f);
            }
        ...
        if (charSequence3 != null) {
            try {
                ...
                if (this.rightDrawable != null) {
                    intrinsicWidth = (intrinsicWidth - ((int) (drawable.getIntrinsicWidth() * this.rightDrawableScale))) - this.drawablePadding;
                }
                ...
                if (this.buildFullLayout) {
                    ...
                    if (!ellipsize.equals(spannableStringBuilder)) {
                        ...
                        if (createStaticLayout != null) {
                            ...
                            this.firstLineLayout = new StaticLayout(charSequence, 0, charSequence.length(), this.textPaint, this.scrollNonFitText ? AndroidUtilities.m34dp(2000.0f) : AndroidUtilities.m34dp(8.0f) + intrinsicWidth, Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
                            StaticLayout staticLayout = new StaticLayout(subSequence, 0, subSequence.length(), this.textPaint, this.scrollNonFitText ? AndroidUtilities.m34dp(2000.0f) : AndroidUtilities.m34dp(8.0f) + intrinsicWidth, Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
                            ...
                            this.partLayout = new StaticLayout(charSequence4, 0, charSequence4.length(), this.textPaint, this.scrollNonFitText ? AndroidUtilities.m34dp(2000.0f) : AndroidUtilities.m34dp(8.0f) + intrinsicWidth, Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
                            int length = valueOf2.length();
                            TextPaint textPaint = this.textPaint;
                            int i3 = this.fullLayoutAdditionalWidth;
                            this.fullLayout = StaticLayoutEx.createStaticLayout(valueOf2, 0, length, textPaint, AndroidUtilities.m34dp(8.0f) + intrinsicWidth + i3, Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false, TextUtils.TruncateAt.END, intrinsicWidth + i3, this.fullTextMaxLines, false);
                        }
                    } else {
                        this.layout = new StaticLayout(ellipsize, 0, ellipsize.length(), this.textPaint, this.scrollNonFitText ? AndroidUtilities.m34dp(2000.0f) : AndroidUtilities.m34dp(8.0f) + intrinsicWidth, Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
                    ...
                    if (!this.scrollNonFitText) {
                        charSequence5 = TextUtils.ellipsize(spannableStringBuilder, this.textPaint, intrinsicWidth, TextUtils.TruncateAt.END);
                    }
                    CharSequence charSequence6 = charSequence5;
                    this.layout = new StaticLayout(charSequence6, 0, charSequence6.length(), this.textPaint, this.scrollNonFitText ? AndroidUtilities.m34dp(2000.0f) : AndroidUtilities.m34dp(8.0f) + intrinsicWidth, Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
                }
    ...
    public void onDraw(Canvas canvas) {
        ...
        int dp = this.totalWidth + AndroidUtilities.m34dp(16.0f);
        ...
        if (this.layout != null) {
            ...
            if (this.partLayout != null && this.fullAlpha < 1.0f) {
                ...
                if (this.partLayout.getText().length() == 1) {
                    f = AndroidUtilities.m34dp(this.fullTextMaxLines == 1 ? 0.5f : 4.0f);
                } else {
                    f = 0.0f;
                }
            ...
            if (z) {
                if (this.scrollingOffset < AndroidUtilities.m34dp(10.0f)) {
                    this.fadePaint.setAlpha((int) ((this.scrollingOffset / AndroidUtilities.m34dp(10.0f)) * 255.0f));
                } else if (this.scrollingOffset > (this.totalWidth + AndroidUtilities.m34dp(16.0f)) - AndroidUtilities.m34dp(10.0f)) {
                    this.fadePaint.setAlpha((int) ((1.0f - ((this.scrollingOffset - ((this.totalWidth + AndroidUtilities.m34dp(16.0f)) - AndroidUtilities.m34dp(10.0f))) / AndroidUtilities.m34dp(10.0f))) * 255.0f));
                } else {
                    this.fadePaint.setAlpha(255);
                }
                canvas.drawRect(0.0f, 0.0f, AndroidUtilities.m34dp(6.0f), getMeasuredHeight(), this.fadePaint);
                canvas.save();
                canvas.translate(getMeasuredWidth() - AndroidUtilities.m34dp(6.0f), 0.0f);
                canvas.drawRect(0.0f, 0.0f, AndroidUtilities.m34dp(6.0f), getMeasuredHeight(), this.fadePaintBack);
                canvas.restore();
            }
    ...
    private void updateScrollAnimation() {
        ...
        if (this.textDoesNotFit || this.scrollingOffset != 0.0f) {
            ...
            if (i > 0) {
                ...
                int dp = this.totalWidth + AndroidUtilities.m34dp(16.0f);
                float f = 50.0f;
                if (this.scrollingOffset < AndroidUtilities.m34dp(100.0f)) {
                    f = ((this.scrollingOffset / AndroidUtilities.m34dp(100.0f)) * 20.0f) + 30.0f;
                } else if (this.scrollingOffset >= dp - AndroidUtilities.m34dp(100.0f)) {
                    f = 50.0f - (((this.scrollingOffset - (dp - AndroidUtilities.m34dp(100.0f))) / AndroidUtilities.m34dp(100.0f)) * 20.0f);
                }
                float dp2 = this.scrollingOffset + ((((float) j) / 1000.0f) * AndroidUtilities.m34dp(f));
