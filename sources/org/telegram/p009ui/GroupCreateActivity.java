...
public class GroupCreateActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, View.OnClickListener {
    ...
    public class SpansContainer extends ViewGroup {
        ...
        protected void onMeasure(int i, int i2) {
            ...
            GroupCreateActivity.this.editText.measure(View.MeasureSpec.makeMeasureSpec(dp - i4, 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m34dp(32.0f), 1073741824));
            if (!this.animationStarted) {
    ...
    public View createView(final Context context) {
        ...
        ViewGroup viewGroup = new ViewGroup(context) {
            ...
            protected void onMeasure(int i5, int i6) {
                ...
                if (AndroidUtilities.isTablet() || size2 > size) {
                    GroupCreateActivity.this.maxSize = AndroidUtilities.m34dp(144.0f);
                } else {
                    GroupCreateActivity.this.maxSize = AndroidUtilities.m34dp(56.0f);
                }
            ...
            protected void onLayout(boolean z, int i5, int i6, int i7, int i8) {
                ...
                if (GroupCreateActivity.this.floatingButton != null) {
                    int dp = LocaleController.isRTL ? AndroidUtilities.m34dp(14.0f) : ((i7 - i5) - AndroidUtilities.m34dp(14.0f)) - GroupCreateActivity.this.floatingButton.getMeasuredWidth();
                    int dp2 = ((i8 - i6) - AndroidUtilities.m34dp(14.0f)) - GroupCreateActivity.this.floatingButton.getMeasuredHeight();
        ...
        ScrollView scrollView = new ScrollView(context) {
            ...
            public boolean requestChildRectangleOnScreen(View view, Rect rect, boolean z) {
                ...
                rect.top += GroupCreateActivity.this.fieldY + AndroidUtilities.m34dp(20.0f);
                rect.bottom += GroupCreateActivity.this.fieldY + AndroidUtilities.m34dp(50.0f);
