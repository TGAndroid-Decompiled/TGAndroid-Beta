...
public class EditWidgetActivity extends BaseFragment {
    ...
    public class WidgetPreviewCell extends FrameLayout {
        ...
        public WidgetPreviewCell(Context context) {
            ...
            chatActionCell.setCustomText(LocaleController.getString("WidgetPreview", C0952R.string.WidgetPreview));
            linearLayout.addView(chatActionCell, LayoutHelper.createLinear(-2, -2, 17, 0, 0, 0, 4));
            LinearLayout linearLayout2 = new LinearLayout(context);
            linearLayout2.setOrientation(1);
            linearLayout2.setBackgroundResource(C0952R.C0953drawable.widget_bg);
            ...
            if (EditWidgetActivity.this.widgetType == 0) {
                while (i < 2) {
                    this.cells[i] = (ViewGroup) EditWidgetActivity.this.getParentActivity().getLayoutInflater().inflate(C0952R.layout.shortcut_widget_item, (ViewGroup) null);
                ...
                EditWidgetActivity.this.previewImageView.setImageResource(C0952R.C0953drawable.chats_widget_preview);
            } else if (EditWidgetActivity.this.widgetType == 1) {
                while (i < 2) {
                    this.cells[i] = (ViewGroup) EditWidgetActivity.this.getParentActivity().getLayoutInflater().inflate(C0952R.layout.contacts_widget_item, (ViewGroup) null);
                ...
                EditWidgetActivity.this.previewImageView.setImageResource(C0952R.C0953drawable.contacts_widget_preview);
            }
            updateDialogs();
    ...
    public View createView(final Context context) {
        ...
        if (this.widgetType == 0) {
            this.actionBar.setTitle(LocaleController.getString("WidgetChats", C0952R.string.WidgetChats));
        } else {
            this.actionBar.setTitle(LocaleController.getString("WidgetShortcuts", C0952R.string.WidgetShortcuts));
        }
        ...
        this.listView.setOnItemLongClickListener(new C28012());
    ...
    public class C28012 implements RecyclerListView.OnItemLongClickListenerExtended {
        ...
        public boolean onItemClick(View view, final int i, float f, float f2) {
            if (EditWidgetActivity.this.getParentActivity() != null && (view instanceof GroupCreateUserCell)) {
                ((ImageView) view.getTag(C0952R.C0954id.object_tag)).getHitRect(this.rect);
                if (!this.rect.contains((int) f, (int) f2)) {
                    AlertDialog.Builder builder = new AlertDialog.Builder(EditWidgetActivity.this.getParentActivity());
                    builder.setItems(new CharSequence[]{LocaleController.getString("Delete", C0952R.string.Delete)}, new DialogInterface.OnClickListener() {
                        @Override
                        public final void onClick(DialogInterface dialogInterface, int i2) {
                            EditWidgetActivity.C28012.this.lambda$onItemClick$0(i, dialogInterface, i2);
                        }
                    });
    ...
    public class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 0) {
                ...
                imageView.setImageResource(C0952R.C0953drawable.list_reorder);
                imageView.setScaleType(ImageView.ScaleType.CENTER);
                groupCreateUserCell2.setTag(C0952R.C0954id.object_tag, imageView);
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (itemViewType == 0) {
                ...
                if (i == EditWidgetActivity.this.infoRow) {
                    ...
                    if (EditWidgetActivity.this.widgetType == 0) {
                        spannableStringBuilder.append((CharSequence) LocaleController.getString("EditWidgetChatsInfo", C0952R.string.EditWidgetChatsInfo));
                    } else if (EditWidgetActivity.this.widgetType == 1) {
                        spannableStringBuilder.append((CharSequence) LocaleController.getString("EditWidgetContactsInfo", C0952R.string.EditWidgetContactsInfo));
                    }
                    if (SharedConfig.passcodeHash.length() > 0) {
                        spannableStringBuilder.append((CharSequence) "\n\n").append((CharSequence) AndroidUtilities.replaceTags(LocaleController.getString("WidgetPasscode2", C0952R.string.WidgetPasscode2)));
                    }
                ...
                String string = LocaleController.getString("SelectChats", C0952R.string.SelectChats);
