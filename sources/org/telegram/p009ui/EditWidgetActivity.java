...
public class EditWidgetActivity extends BaseFragment {
    ...
    public class WidgetPreviewCell extends FrameLayout {
        ...
        public WidgetPreviewCell(Context context) {
            ...
            setPadding(0, AndroidUtilities.m34dp(24.0f), 0, AndroidUtilities.m34dp(24.0f));
            LinearLayout linearLayout = new LinearLayout(context);
            linearLayout.setOrientation(1);
            addView(linearLayout, LayoutHelper.createFrame(-2, -2, 17));
            ChatActionCell chatActionCell = new ChatActionCell(context);
            chatActionCell.setCustomText(LocaleController.getString("WidgetPreview", C0890R.string.WidgetPreview));
            linearLayout.addView(chatActionCell, LayoutHelper.createLinear(-2, -2, 17, 0, 0, 0, 4));
            LinearLayout linearLayout2 = new LinearLayout(context);
            linearLayout2.setOrientation(1);
            linearLayout2.setBackgroundResource(C0890R.C0891drawable.widget_bg);
            ...
            if (EditWidgetActivity.this.widgetType == 0) {
                while (i < 2) {
                    this.cells[i] = (ViewGroup) EditWidgetActivity.this.getParentActivity().getLayoutInflater().inflate(C0890R.layout.shortcut_widget_item, (ViewGroup) null);
                ...
                EditWidgetActivity.this.previewImageView.setImageResource(C0890R.C0891drawable.chats_widget_preview);
            } else if (EditWidgetActivity.this.widgetType == 1) {
                while (i < 2) {
                    this.cells[i] = (ViewGroup) EditWidgetActivity.this.getParentActivity().getLayoutInflater().inflate(C0890R.layout.contacts_widget_item, (ViewGroup) null);
                ...
                EditWidgetActivity.this.previewImageView.setImageResource(C0890R.C0891drawable.contacts_widget_preview);
            }
            updateDialogs();
        ...
        public void updateDialogs() {
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p009ui.EditWidgetActivity.WidgetPreviewCell.updateDialogs():void");
        }

        @Override
        protected void onMeasure(int i, int i2) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m34dp(264.0f), 1073741824));
        }
    ...
    public View createView(final Context context) {
        ...
        if (this.widgetType == 0) {
            this.actionBar.setTitle(LocaleController.getString("WidgetChats", C0890R.string.WidgetChats));
        } else {
            this.actionBar.setTitle(LocaleController.getString("WidgetShortcuts", C0890R.string.WidgetShortcuts));
        }
        ...
        this.listView.setOnItemLongClickListener(new C27162());
    ...
    public class C27162 implements RecyclerListView.OnItemLongClickListenerExtended {
        ...
        public boolean onItemClick(View view, final int i, float f, float f2) {
            if (EditWidgetActivity.this.getParentActivity() != null && (view instanceof GroupCreateUserCell)) {
                ((ImageView) view.getTag(C0890R.C0892id.object_tag)).getHitRect(this.rect);
                if (!this.rect.contains((int) f, (int) f2)) {
                    AlertDialog.Builder builder = new AlertDialog.Builder(EditWidgetActivity.this.getParentActivity());
                    builder.setItems(new CharSequence[]{LocaleController.getString("Delete", C0890R.string.Delete)}, new DialogInterface.OnClickListener() {
                        @Override
                        public final void onClick(DialogInterface dialogInterface, int i2) {
                            EditWidgetActivity.C27162.this.lambda$onItemClick$0(i, dialogInterface, i2);
                        }
                    });
    ...
    public class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 0) {
                ...
                imageView.setImageResource(C0890R.C0891drawable.list_reorder);
                imageView.setScaleType(ImageView.ScaleType.CENTER);
                groupCreateUserCell2.setTag(C0890R.C0892id.object_tag, imageView);
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (itemViewType == 0) {
                ...
                if (i == EditWidgetActivity.this.infoRow) {
                    ...
                    if (EditWidgetActivity.this.widgetType == 0) {
                        spannableStringBuilder.append((CharSequence) LocaleController.getString("EditWidgetChatsInfo", C0890R.string.EditWidgetChatsInfo));
                    } else if (EditWidgetActivity.this.widgetType == 1) {
                        spannableStringBuilder.append((CharSequence) LocaleController.getString("EditWidgetContactsInfo", C0890R.string.EditWidgetContactsInfo));
                    }
                    if (SharedConfig.passcodeHash.length() > 0) {
                        spannableStringBuilder.append((CharSequence) "\n\n").append((CharSequence) AndroidUtilities.replaceTags(LocaleController.getString("WidgetPasscode2", C0890R.string.WidgetPasscode2)));
                    }
                ...
                String string = LocaleController.getString("SelectChats", C0890R.string.SelectChats);
                if (EditWidgetActivity.this.chatsStartRow == -1) {
                    z = false;
                }
                textCell.setTextAndIcon(string, combinedDrawable, z);
                textCell.getImageView().setPadding(0, AndroidUtilities.m34dp(7.0f), 0, 0);
