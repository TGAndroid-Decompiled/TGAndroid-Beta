...
public class SessionsActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public class C35012 extends UndoView {
        C35012(Context context) {
            super(context);
        }
        ...
        public void hide(boolean z, int i) {
            if (!z) {
                ...
                ConnectionsManager.getInstance(((BaseFragment) SessionsActivity.this).currentAccount).sendRequest(tLRPC$TL_account_resetAuthorization, new RequestDelegate() {
                    @Override
                    public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                        SessionsActivity.C35012.this.lambda$hide$1(tLRPC$TL_authorization, tLObject, tLRPC$TL_error);
                    }
                });
            }
            super.hide(z, i);
        ...
        public void lambda$hide$1(final TLRPC$TL_authorization tLRPC$TL_authorization, TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
            AndroidUtilities.runOnUIThread(new Runnable() {
                @Override
                public final void run() {
                    SessionsActivity.C35012.this.lambda$hide$0(tLRPC$TL_error, tLRPC$TL_authorization);
                }
            });
        }
    ...
    public class C35034 implements SessionBottomSheet.Callback {
    ...
    private void showSessionBottomSheet(TLRPC$TL_authorization tLRPC$TL_authorization, boolean z) {
        if (tLRPC$TL_authorization != null) {
            new SessionBottomSheet(this, tLRPC$TL_authorization, z, new C35034()).show();
        }
    }
    ...
    public class C35045 implements CameraScanActivity.CameraScanActivityDelegate {
        ...
        public void didFindQr(String str) {
            ...
            if (tLObject instanceof TLRPC$TL_authorization) {
                ...
                AndroidUtilities.runOnUIThread(new Runnable() {
                    @Override
                    public final void run() {
                        SessionsActivity.C35045.this.lambda$didFindQr$0();
                    }
                });
            }
        }
        ...
        public boolean processQr(final String str, final Runnable runnable) {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() {
                @Override
                public final void run() {
                    SessionsActivity.C35045.this.lambda$processQr$4(str, runnable);
                }
            }, 750L);
            return true;
        }
        ...
        public void lambda$processQr$4(String str, final Runnable runnable) {
            try {
                ...
                SessionsActivity.this.getConnectionsManager().sendRequest(tLRPC$TL_auth_acceptLoginToken, new RequestDelegate() {
                    @Override
                    public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                        SessionsActivity.C35045.this.lambda$processQr$2(runnable, tLObject, tLRPC$TL_error);
                    }
                });
            } catch (Exception e) {
                ...
                AndroidUtilities.runOnUIThread(new Runnable() {
                    @Override
                    public final void run() {
                        SessionsActivity.C35045.this.lambda$processQr$3();
                    }
                });
                runnable.run();
            }
        ...
        public void lambda$processQr$2(final Runnable runnable, final TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
            AndroidUtilities.runOnUIThread(new Runnable() {
                @Override
                public final void run() {
                    SessionsActivity.C35045.this.lambda$processQr$1(tLObject, tLRPC$TL_error, runnable);
                }
            });
        }
    ...
    public void openCameraScanActivity() {
        CameraScanActivity.showAsSheet(this, false, 2, new C35045());
    }
