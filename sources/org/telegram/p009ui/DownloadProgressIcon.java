...
public class DownloadProgressIcon extends View implements NotificationCenter.NotificationCenterDelegate {
    ...
    public DownloadProgressIcon(int i, Context context) {
        ...
        RLottieDrawable rLottieDrawable = new RLottieDrawable(C1010R.raw.download_progress, "download_progress", AndroidUtilities.m35dp(28.0f), AndroidUtilities.m35dp(28.0f), true, null);
        ...
        RLottieDrawable rLottieDrawable2 = new RLottieDrawable(C1010R.raw.download_finish, "download_finish", AndroidUtilities.m35dp(28.0f), AndroidUtilities.m35dp(28.0f), true, null);
