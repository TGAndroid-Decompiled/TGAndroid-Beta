...
public class SessionBottomSheet extends BottomSheet {
    ...
    public SessionBottomSheet(BaseFragment baseFragment, final TLRPC$TL_authorization tLRPC$TL_authorization, boolean z, Callback callback) {
        ...
        if ((tLRPC$TL_authorization.flags & 1) != 0) {
            formatDateTime = LocaleController.getString("Online", C1010R.string.Online);
        } else {
        ...
        Drawable mutate = ContextCompat.getDrawable(parentActivity, C1010R.C1011drawable.menu_devices).mutate();
        ...
        itemView.descriptionText.setText(LocaleController.getString("Application", C1010R.string.Application));
        ...
        if (tLRPC$TL_authorization.country.length() != 0) {
            ...
            Drawable mutate2 = ContextCompat.getDrawable(parentActivity, C1010R.C1011drawable.msg_location).mutate();
            ...
            itemView2.descriptionText.setText(LocaleController.getString("Location", C1010R.string.Location));
        ...
        if (tLRPC$TL_authorization.f883ip.length() != 0) {
            ItemView itemView3 = new ItemView(parentActivity, false);
            itemView3.valueText.setText(tLRPC$TL_authorization.f883ip);
            Drawable mutate3 = ContextCompat.getDrawable(parentActivity, C1010R.C1011drawable.msg_language).mutate();
            ...
            itemView3.descriptionText.setText(LocaleController.getString("IpAddress", C1010R.string.IpAddress));
            itemView3.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    SessionBottomSheet.this.copyText(tLRPC$TL_authorization.f883ip);
                }
            });
        ...
        if (secretChatsEnabled(tLRPC$TL_authorization)) {
            ...
            itemView4.valueText.setText(LocaleController.getString("AcceptSecretChats", C1010R.string.AcceptSecretChats));
            Drawable mutate4 = ContextCompat.getDrawable(parentActivity, C1010R.C1011drawable.msg_secret).mutate();
            ...
            itemView.needDivider = true;
            itemView4.descriptionText.setText(LocaleController.getString("AcceptSecretChatsDescription", C1010R.string.AcceptSecretChatsDescription));
            linearLayout.addView(itemView4);
            itemView = itemView4;
        }
        final ItemView itemView5 = new ItemView(parentActivity, true);
        itemView5.valueText.setText(LocaleController.getString("AcceptCalls", C1010R.string.AcceptCalls));
        Drawable mutate5 = ContextCompat.getDrawable(parentActivity, C1010R.C1011drawable.msg_calls).mutate();
        ...
        itemView.needDivider = true;
        itemView5.descriptionText.setText(LocaleController.getString("AcceptCallsChatsDescription", C1010R.string.AcceptCallsChatsDescription));
        ...
        if (!z) {
            ...
            textView3.setText(LocaleController.getString("TerminateSession", C1010R.string.TerminateSession));
            ...
            textView3.setOnClickListener(new View$OnClickListenerC39088(callback, tLRPC$TL_authorization, baseFragment));
        }
    ...
    public class View$OnClickListenerC39088 implements View.OnClickListener {
        final Callback val$callback;
        final BaseFragment val$fragment;
        final TLRPC$TL_authorization val$session;

        View$OnClickListenerC39088(Callback callback, TLRPC$TL_authorization tLRPC$TL_authorization, BaseFragment baseFragment) {
        ...
        public void onClick(View view) {
            ...
            builder.setMessage(LocaleController.getString("TerminateSessionText", C1010R.string.TerminateSessionText));
            builder.setTitle(LocaleController.getString("AreYouSureSessionTitle", C1010R.string.AreYouSureSessionTitle));
            String string = LocaleController.getString("Terminate", C1010R.string.Terminate);
            ...
            builder.setPositiveButton(string, new DialogInterface.OnClickListener() {
                ...
                public final void onClick(DialogInterface dialogInterface, int i) {
                    SessionBottomSheet.View$OnClickListenerC39088.this.lambda$onClick$0(callback, tLRPC$TL_authorization, dialogInterface, i);
                }
            });
    ...
    public void copyText(final String str) {
        ...
        builder.setItems(new CharSequence[]{LocaleController.getString("Copy", C1010R.string.Copy)}, new DialogInterface.OnClickListener() {
            @Override
            public final void onClick(DialogInterface dialogInterface, int i) {
    ...
    public void lambda$copyText$1(String str, DialogInterface dialogInterface, int i) {
        ...
        BulletinFactory.m14of(getContainer(), null).createCopyBulletin(LocaleController.getString("TextCopied", C1010R.string.TextCopied)).show();
    }
