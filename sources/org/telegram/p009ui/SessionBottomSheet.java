...
public class SessionBottomSheet extends BottomSheet {
    ...
    public SessionBottomSheet(BaseFragment baseFragment, final TLRPC$TL_authorization tLRPC$TL_authorization, boolean z, Callback callback) {
        ...
        Drawable mutate = ContextCompat.getDrawable(parentActivity, C0952R.C0953drawable.menu_devices).mutate();
        ...
        itemView.descriptionText.setText(LocaleController.getString("Application", C0952R.string.Application));
        ...
        if (tLRPC$TL_authorization.country.length() != 0) {
            ...
            Drawable mutate2 = ContextCompat.getDrawable(parentActivity, C0952R.C0953drawable.menu_location).mutate();
            ...
            itemView2.descriptionText.setText(LocaleController.getString("Location", C0952R.string.Location));
        ...
        if (tLRPC$TL_authorization.f888ip.length() != 0) {
            ItemView itemView3 = new ItemView(parentActivity, false);
            itemView3.valueText.setText(tLRPC$TL_authorization.f888ip);
            Drawable mutate3 = ContextCompat.getDrawable(parentActivity, C0952R.C0953drawable.menu_language).mutate();
            ...
            itemView3.descriptionText.setText(LocaleController.getString("IpAddress", C0952R.string.IpAddress));
            itemView3.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    SessionBottomSheet.this.copyText(tLRPC$TL_authorization.f888ip);
                }
            });
        ...
        if (secretChatsEnabled(tLRPC$TL_authorization)) {
            ...
            itemView4.valueText.setText(LocaleController.getString("AcceptSecretChats", C0952R.string.AcceptSecretChats));
            Drawable mutate4 = ContextCompat.getDrawable(parentActivity, C0952R.C0953drawable.menu_secret).mutate();
            ...
            itemView.needDivider = true;
            itemView4.descriptionText.setText(LocaleController.getString("AcceptSecretChatsDescription", C0952R.string.AcceptSecretChatsDescription));
            linearLayout.addView(itemView4);
            itemView = itemView4;
        }
        final ItemView itemView5 = new ItemView(parentActivity, true);
        itemView5.valueText.setText(LocaleController.getString("AcceptCalls", C0952R.string.AcceptCalls));
        Drawable mutate5 = ContextCompat.getDrawable(parentActivity, C0952R.C0953drawable.menu_calls).mutate();
        ...
        itemView.needDivider = true;
        itemView5.descriptionText.setText(LocaleController.getString("AcceptCallsChatsDescription", C0952R.string.AcceptCallsChatsDescription));
        ...
        if (!z) {
            ...
            textView3.setText(LocaleController.getString("TerminateSession", C0952R.string.TerminateSession));
            textView3.setTextColor(Theme.getColor("featuredStickers_buttonText"));
            textView3.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m34dp(6.0f), Theme.getColor("chat_attachAudioBackground"), ColorUtils.setAlphaComponent(Theme.getColor("windowBackgroundWhite"), 120)));
            linearLayout.addView(textView3, LayoutHelper.createFrame(-1, 48.0f, 0, 16.0f, 15.0f, 16.0f, 16.0f));
            textView3.setOnClickListener(new View$OnClickListenerC34998(callback, tLRPC$TL_authorization, baseFragment));
        }
    ...
    public class View$OnClickListenerC34998 implements View.OnClickListener {
        final Callback val$callback;
        final BaseFragment val$fragment;
        final TLRPC$TL_authorization val$session;

        View$OnClickListenerC34998(Callback callback, TLRPC$TL_authorization tLRPC$TL_authorization, BaseFragment baseFragment) {
        ...
        public void onClick(View view) {
            ...
            builder.setMessage(LocaleController.getString("TerminateSessionText", C0952R.string.TerminateSessionText));
            builder.setTitle(LocaleController.getString("AreYouSureSessionTitle", C0952R.string.AreYouSureSessionTitle));
            String string = LocaleController.getString("Terminate", C0952R.string.Terminate);
            ...
            builder.setPositiveButton(string, new DialogInterface.OnClickListener() {
                ...
                public final void onClick(DialogInterface dialogInterface, int i) {
                    SessionBottomSheet.View$OnClickListenerC34998.this.lambda$onClick$0(callback, tLRPC$TL_authorization, dialogInterface, i);
                }
            });
    ...
    public void lambda$copyText$1(String str, DialogInterface dialogInterface, int i) {
        ...
        BulletinFactory.m14of(getContainer(), null).createCopyBulletin(LocaleController.getString("TextCopied", C0952R.string.TextCopied)).show();
    }
