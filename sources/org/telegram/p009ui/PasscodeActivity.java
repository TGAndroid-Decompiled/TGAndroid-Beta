...
public class PasscodeActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public void lambda$createView$5(View view, final int i) {
        if (view.isEnabled()) {
            if (i == this.disablePasscodeRow) {
                AlertDialog create = new AlertDialog.Builder(getParentActivity()).setTitle(LocaleController.getString(C1010R.string.DisablePasscode)).setMessage(LocaleController.getString(C1010R.string.DisablePasscodeConfirmMessage)).setNegativeButton(LocaleController.getString(C1010R.string.Cancel), null).setPositiveButton(LocaleController.getString(C1010R.string.DisablePasscodeTurnOff), new DialogInterface.OnClickListener() {
                    @Override
                ...
                builder.setTitle(LocaleController.getString("AutoLock", C1010R.string.AutoLock));
                ...
                AlertsCreator.showSimpleAlert(this, LocaleController.getString("ScreenCaptureAlert", C1010R.string.ScreenCaptureAlert));
            }
        }
    }
    ...
    public static String lambda$createView$3(int i) {
        if (i == 0) {
            return LocaleController.getString("AutoLockDisabled", C1010R.string.AutoLockDisabled);
        }
        return i == 1 ? LocaleController.formatString("AutoLockInTime", C1010R.string.AutoLockInTime, LocaleController.formatPluralString("Minutes", 1, new Object[0])) : i == 2 ? LocaleController.formatString("AutoLockInTime", C1010R.string.AutoLockInTime, LocaleController.formatPluralString("Minutes", 5, new Object[0])) : i == 3 ? LocaleController.formatString("AutoLockInTime", C1010R.string.AutoLockInTime, LocaleController.formatPluralString("Hours", 1, new Object[0])) : i == 4 ? LocaleController.formatString("AutoLockInTime", C1010R.string.AutoLockInTime, LocaleController.formatPluralString("Hours", 5, new Object[0])) : BuildConfig.APP_CENTER_HASH;
    }
    ...
    public class C34834 extends C1069ActionBar.ActionBarMenuOnItemClick {
        final ActionBarMenuSubItem val$switchItem;

        C34834(ActionBarMenuSubItem actionBarMenuSubItem) {
        ...
        public void onItemClick(int i) {
            ...
            if (i == 1) {
                ...
                AndroidUtilities.runOnUIThread(new Runnable() {
                    @Override
                    public final void run() {
                        PasscodeActivity.C34834.this.lambda$onItemClick$0(actionBarMenuSubItem);
                    }
                }, 150L);
        ...
        public void lambda$onItemClick$0(ActionBarMenuSubItem actionBarMenuSubItem) {
            actionBarMenuSubItem.setText(LocaleController.getString(PasscodeActivity.this.currentPasswordType == 0 ? C1010R.string.PasscodeSwitchToPassword : C1010R.string.PasscodeSwitchToPIN));
            actionBarMenuSubItem.setIcon(PasscodeActivity.this.currentPasswordType == 0 ? C1010R.C1011drawable.msg_permissions : C1010R.C1011drawable.msg_pin_code);
    ...
    public class C34878 extends CodeFieldContainer {
        C34878(Context context) {
            super(context);
        }
        ...
        protected void processNextPressed() {
            if (PasscodeActivity.this.passcodeSetStep != 0) {
                ...
                postDelayed(new Runnable() {
                    @Override
                    public final void run() {
                        PasscodeActivity.C34878.this.lambda$processNextPressed$0();
                    }
                }, 260L);
            }
        }
    ...
    public void updateFields() {
        String charSequence;
        if (this.type == 2) {
            charSequence = LocaleController.getString(C1010R.string.EnterYourPasscodeInfo);
        } else if (this.passcodeSetStep == 0) {
            charSequence = LocaleController.getString(this.currentPasswordType == 0 ? C1010R.string.CreatePasscodeInfoPIN : C1010R.string.CreatePasscodeInfoPassword);
        } else {
        ...
        if (this.type == 2) {
            this.descriptionTextSwitcher.setText(LocaleController.getString(C1010R.string.EnterYourPasscodeInfo), z);
        } else if (this.passcodeSetStep == 0) {
            this.descriptionTextSwitcher.setText(LocaleController.getString(this.currentPasswordType == 0 ? C1010R.string.CreatePasscodeInfoPIN : C1010R.string.CreatePasscodeInfoPassword), z);
        }
        if (isPinCode()) {
    ...
    public void processNext() {
        ...
        this.titleTextView.setText(LocaleController.getString("ConfirmCreatePasscode", C1010R.string.ConfirmCreatePasscode));
        this.descriptionTextSwitcher.setText(AndroidUtilities.replaceTags(LocaleController.getString("PasscodeReinstallNotice", C1010R.string.PasscodeReinstallNotice)));
    ...
    public void processDone() {
        ...
        if (i == 1) {
            ...
            if (j > 0) {
                double d = j;
                Double.isNaN(d);
                Toast.makeText(getParentActivity(), LocaleController.formatString("TooManyTries", C1010R.string.TooManyTries, LocaleController.formatPluralString("Seconds", Math.max(1, (int) Math.ceil(d / 1000.0d)), new Object[0])), 0).show();
            ...
            if (itemViewType == 0) {
                ...
                if (i != PasscodeActivity.this.fingerprintRow) {
                    if (i == PasscodeActivity.this.captureRow) {
                        textCheckCell.setTextAndCheck(LocaleController.getString(C1010R.string.ScreenCaptureShowContent), SharedConfig.allowScreenCapture, false);
                        return;
                    }
                    return;
                }
                textCheckCell.setTextAndCheck(LocaleController.getString("UnlockFingerprint", C1010R.string.UnlockFingerprint), SharedConfig.useFingerprint, true);
                ...
                if (i != PasscodeActivity.this.changePasscodeRow) {
                    if (i != PasscodeActivity.this.autoLockRow) {
                        if (i == PasscodeActivity.this.disablePasscodeRow) {
                            textSettingsCell.setText(LocaleController.getString(C1010R.string.DisablePasscode), false);
                    ...
                    int i2 = SharedConfig.autoLockIn;
                    if (i2 == 0) {
                        formatString = LocaleController.formatString("AutoLockDisabled", C1010R.string.AutoLockDisabled, new Object[0]);
                    } else if (i2 < 3600) {
                        formatString = LocaleController.formatString("AutoLockInTime", C1010R.string.AutoLockInTime, LocaleController.formatPluralString("Minutes", i2 / 60, new Object[0]));
                    } else if (i2 < 86400) {
                        formatString = LocaleController.formatString("AutoLockInTime", C1010R.string.AutoLockInTime, LocaleController.formatPluralString("Hours", (int) Math.ceil((i2 / 60.0f) / 60.0f), new Object[0]));
                    } else {
                        formatString = LocaleController.formatString("AutoLockInTime", C1010R.string.AutoLockInTime, LocaleController.formatPluralString("Days", (int) Math.ceil(((i2 / 60.0f) / 60.0f) / 24.0f), new Object[0]));
                    }
                    textSettingsCell.setTextAndValue(LocaleController.getString("AutoLock", C1010R.string.AutoLock), formatString, true);
                    textSettingsCell.setTag("windowBackgroundWhiteBlackText");
                    textSettingsCell.setTextColor(Theme.getColor("windowBackgroundWhiteBlackText"));
                    return;
                }
                textSettingsCell.setText(LocaleController.getString("ChangePasscode", C1010R.string.ChangePasscode), true);
                if (SharedConfig.passcodeHash.length() == 0) {
                ...
                if (itemViewType != 2) {
                    if (itemViewType != 3) {
                        ...
                        rLottieImageHolderView.imageView.setAnimation(C1010R.raw.utyan_passcode, 100, 100);
                    ...
                    if (i == PasscodeActivity.this.captureHeaderRow) {
                        headerCell.setText(LocaleController.getString(C1010R.string.ScreenCaptureHeader));
                        return;
                    }
                    return;
                }
                ...
                if (i != PasscodeActivity.this.hintRow) {
                    if (i != PasscodeActivity.this.autoLockDetailRow) {
                        if (i == PasscodeActivity.this.captureDetailRow) {
                            textInfoPrivacyCell.setText(LocaleController.getString(C1010R.string.ScreenCaptureInfo));
                    ...
                    textInfoPrivacyCell.setText(LocaleController.getString(C1010R.string.AutoLockInfo));
                ...
                textInfoPrivacyCell.setText(LocaleController.getString(C1010R.string.PasscodeScreenHint));
