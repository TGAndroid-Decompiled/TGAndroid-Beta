...
public class SponsoredMessageInfoView extends FrameLayout {
    public SponsoredMessageInfoView(final Activity activity, Theme.ResourcesProvider resourcesProvider) {
        ...
        textView.setText(LocaleController.getString("SponsoredMessageInfo", C1010R.string.SponsoredMessageInfo));
        textView.setTypeface(AndroidUtilities.getTypeface(AndroidUtilities.TYPEFACE_ROBOTO_MEDIUM));
        textView.setTextColor(Theme.getColor("windowBackgroundWhiteBlackText", resourcesProvider));
        textView.setTextSize(1, 20.0f);
        TextView textView2 = new TextView(activity);
        textView2.setText(LocaleController.getString("SponsoredMessageInfoDescription1", C1010R.string.SponsoredMessageInfoDescription1));
        ...
        textView3.setText(LocaleController.getString("SponsoredMessageInfoDescription2", C1010R.string.SponsoredMessageInfoDescription2));
        ...
        textView4.setText(LocaleController.getString("SponsoredMessageInfoDescription3", C1010R.string.SponsoredMessageInfoDescription3));
        ...
        textView5.setOnClickListener(new View.OnClickListener(this) {
            ...
            public void onClick(View view) {
                Browser.openUrl(activity, LocaleController.getString("SponsoredMessageAlertLearnMoreUrl", C1010R.string.SponsoredMessageAlertLearnMoreUrl));
            }
        });
        textView5.setPadding(AndroidUtilities.m35dp(12.0f), 0, AndroidUtilities.m35dp(12.0f), 0);
        textView5.setText(LocaleController.getString("SponsoredMessageAlertLearnMoreUrl", C1010R.string.SponsoredMessageAlertLearnMoreUrl));
        ...
        textView6.setText(LocaleController.getString("SponsoredMessageInfoDescription4", C1010R.string.SponsoredMessageInfoDescription4));
