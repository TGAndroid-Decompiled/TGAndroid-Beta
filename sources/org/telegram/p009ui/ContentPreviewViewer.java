...
public class ContentPreviewViewer {
    ...
    private Runnable showSheetRunnable = new RunnableC26221();
    ...
    public class RunnableC26221 implements Runnable {
        RunnableC26221() {
            ContentPreviewViewer.this = r1;
        }
                ...
                if (ContentPreviewViewer.this.currentContentType == 0) {
                    ...
                    if (ContentPreviewViewer.this.delegate != null) {
                        if (ContentPreviewViewer.this.delegate.needSend() && !ContentPreviewViewer.this.delegate.isInScheduleMode()) {
                            arrayList.add(LocaleController.getString("SendStickerPreview", C0890R.string.SendStickerPreview));
                            arrayList3.add(Integer.valueOf((int) C0890R.C0891drawable.outline_send));
                            arrayList2.add(0);
                        }
                        if (!ContentPreviewViewer.this.delegate.isInScheduleMode()) {
                            arrayList.add(LocaleController.getString("SendWithoutSound", C0890R.string.SendWithoutSound));
                            arrayList3.add(Integer.valueOf((int) C0890R.C0891drawable.input_notify_off));
                            arrayList2.add(6);
                        }
                        if (ContentPreviewViewer.this.delegate.canSchedule()) {
                            arrayList.add(LocaleController.getString("Schedule", C0890R.string.Schedule));
                            arrayList3.add(Integer.valueOf((int) C0890R.C0891drawable.msg_timer));
                            arrayList2.add(3);
                        }
                        if (ContentPreviewViewer.this.currentStickerSet != null && ContentPreviewViewer.this.delegate.needOpen()) {
                            arrayList.add(LocaleController.formatString("ViewPackPreview", C0890R.string.ViewPackPreview, new Object[0]));
                            arrayList3.add(Integer.valueOf((int) C0890R.C0891drawable.outline_pack));
                            arrayList2.add(1);
                        }
                        if (ContentPreviewViewer.this.delegate.needRemove()) {
                            arrayList.add(LocaleController.getString("ImportStickersRemoveMenu", C0890R.string.ImportStickersRemoveMenu));
                            arrayList3.add(Integer.valueOf((int) C0890R.C0891drawable.msg_delete));
                            arrayList2.add(5);
                        }
                    }
                    if (!MessageObject.isMaskDocument(ContentPreviewViewer.this.currentDocument) && (isStickerInFavorites || (MediaDataController.getInstance(ContentPreviewViewer.this.currentAccount).canAddStickerToFavorites() && MessageObject.isStickerHasSet(ContentPreviewViewer.this.currentDocument)))) {
                        if (isStickerInFavorites) {
                            i = C0890R.string.DeleteFromFavorites;
                            str = "DeleteFromFavorites";
                        } else {
                            i = C0890R.string.AddToFavorites;
                            str = "AddToFavorites";
                        }
                        arrayList.add(LocaleController.getString(str, i));
                        arrayList3.add(Integer.valueOf(isStickerInFavorites ? C0890R.C0891drawable.outline_unfave : C0890R.C0891drawable.outline_fave));
                        arrayList2.add(2);
                    }
                    if (ContentPreviewViewer.this.isRecentSticker) {
                        arrayList.add(LocaleController.getString("DeleteFromRecent", C0890R.string.DeleteFromRecent));
                        arrayList3.add(Integer.valueOf((int) C0890R.C0891drawable.msg_delete));
                        arrayList2.add(4);
                    }
                    if (!arrayList.isEmpty()) {
                        ...
                        builder.setItems((CharSequence[]) arrayList.toArray(new CharSequence[0]), iArr, new DialogInterface.OnClickListener() {
                            ...
                            public final void onClick(DialogInterface dialogInterface, int i3) {
                                ContentPreviewViewer.RunnableC26221.this.lambda$run$1(arrayList2, isStickerInFavorites, dialogInterface, i3);
                            }
                        });
                        ...
                        ContentPreviewViewer.this.visibleDialog.setOnDismissListener(new DialogInterface.OnDismissListener() {
                            ...
                            public final void onDismiss(DialogInterface dialogInterface) {
                                ContentPreviewViewer.RunnableC26221.this.lambda$run$2(dialogInterface);
                            }
                        });
                    ...
                    if (ContentPreviewViewer.this.delegate.needSend() && !ContentPreviewViewer.this.delegate.isInScheduleMode()) {
                        arrayList4.add(LocaleController.getString("SendGifPreview", C0890R.string.SendGifPreview));
                        arrayList6.add(Integer.valueOf((int) C0890R.C0891drawable.outline_send));
                        arrayList5.add(0);
                    }
                    if (ContentPreviewViewer.this.delegate.canSchedule()) {
                        arrayList4.add(LocaleController.getString("Schedule", C0890R.string.Schedule));
                        arrayList6.add(Integer.valueOf((int) C0890R.C0891drawable.msg_timer));
                        arrayList5.add(3);
                    }
                    if (ContentPreviewViewer.this.currentDocument != null) {
                        ...
                        if (z) {
                            arrayList4.add(LocaleController.formatString("Delete", C0890R.string.Delete, new Object[0]));
                            arrayList6.add(Integer.valueOf((int) C0890R.C0891drawable.msg_delete));
                            arrayList5.add(1);
                        } else {
                            arrayList4.add(LocaleController.formatString("SaveToGIFs", C0890R.string.SaveToGIFs, new Object[0]));
                            arrayList6.add(Integer.valueOf((int) C0890R.C0891drawable.outline_add_gif));
                            arrayList5.add(2);
                        }
                    } else {
                        z = false;
                    ...
                    ContentPreviewViewer.this.visibleDialog.setItems((CharSequence[]) arrayList4.toArray(new CharSequence[0]), iArr2, new DialogInterface.OnClickListener() {
                        ...
                        public final void onClick(DialogInterface dialogInterface, int i4) {
                            ContentPreviewViewer.RunnableC26221.this.lambda$run$4(arrayList5, dialogInterface, i4);
                        }
                    });
                    ...
                    ContentPreviewViewer.this.visibleDialog.setOnDismissListener(new DialogInterface.OnDismissListener() {
                        @Override
                        public final void onDismiss(DialogInterface dialogInterface) {
                            ContentPreviewViewer.RunnableC26221.this.lambda$run$5(dialogInterface);
                        }
                    });
                    ContentPreviewViewer.this.visibleDialog.show();
                    ContentPreviewViewer.this.containerView.performHapticFeedback(0);
                ...
                if (((Integer) arrayList.get(i)).intValue() == 0) {
                    ...
                    AlertsCreator.createScheduleDatePickerDialog(ContentPreviewViewer.this.parentActivity, contentPreviewViewerDelegate.getDialogId(), new AlertsCreator.ScheduleDatePickerDelegate() {
                        ...
                        public final void didSelectDate(boolean z, int i2) {
                            ContentPreviewViewer.RunnableC26221.lambda$run$3(ContentPreviewViewer.ContentPreviewViewerDelegate.this, tLRPC$Document, tLRPC$BotInlineResult, obj, z, i2);
                        }
    ...
    public void setParentActivity(Activity activity) {
        ...
        if (this.parentActivity != activity) {
            ...
            this.slideUpDrawable = activity.getResources().getDrawable(C0890R.C0891drawable.preview_arrow);
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.containerView != null && (colorDrawable = this.backgroundDrawable) != null) {
            ...
            if (this.stickerEmojiLayout != null) {
                i4 = AndroidUtilities.m34dp(40.0f);
            }
