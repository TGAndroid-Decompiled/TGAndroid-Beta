...
public class ContentPreviewViewer {
    ...
    private int keyboardHeight = AndroidUtilities.m34dp(200.0f);
    private Paint paint = new Paint(1);
    private Runnable showSheetRunnable = new RunnableC26971();
    ...
    public class RunnableC26971 implements Runnable {
        RunnableC26971() {
            ContentPreviewViewer.this = r1;
        }
        ...
        public void run() {
            ...
            if (ContentPreviewViewer.this.parentActivity != null) {
                ...
                if (ContentPreviewViewer.this.currentContentType == 0) {
                    if (!MessageObject.isPremiumSticker(ContentPreviewViewer.this.currentDocument) || AccountInstance.getInstance(ContentPreviewViewer.this.currentAccount).getUserConfig().isPremium()) {
                        ...
                        if (ContentPreviewViewer.this.delegate != null) {
                            if (ContentPreviewViewer.this.delegate.needSend() && !ContentPreviewViewer.this.delegate.isInScheduleMode()) {
                                arrayList.add(LocaleController.getString("SendStickerPreview", C0952R.string.SendStickerPreview));
                                arrayList3.add(Integer.valueOf((int) C0952R.C0953drawable.outline_send));
                                arrayList2.add(0);
                            }
                            if (!ContentPreviewViewer.this.delegate.isInScheduleMode()) {
                                arrayList.add(LocaleController.getString("SendWithoutSound", C0952R.string.SendWithoutSound));
                                arrayList3.add(Integer.valueOf((int) C0952R.C0953drawable.input_notify_off));
                                arrayList2.add(6);
                            }
                            if (ContentPreviewViewer.this.delegate.canSchedule()) {
                                arrayList.add(LocaleController.getString("Schedule", C0952R.string.Schedule));
                                arrayList3.add(Integer.valueOf((int) C0952R.C0953drawable.msg_timer));
                                arrayList2.add(3);
                            }
                            if (ContentPreviewViewer.this.currentStickerSet != null && ContentPreviewViewer.this.delegate.needOpen()) {
                                arrayList.add(LocaleController.formatString("ViewPackPreview", C0952R.string.ViewPackPreview, new Object[0]));
                                arrayList3.add(Integer.valueOf((int) C0952R.C0953drawable.outline_pack));
                                arrayList2.add(1);
                            }
                            if (ContentPreviewViewer.this.delegate.needRemove()) {
                                arrayList.add(LocaleController.getString("ImportStickersRemoveMenu", C0952R.string.ImportStickersRemoveMenu));
                                arrayList3.add(Integer.valueOf((int) C0952R.C0953drawable.msg_delete));
                                arrayList2.add(5);
                            }
                        }
                        if (!MessageObject.isMaskDocument(ContentPreviewViewer.this.currentDocument) && (isStickerInFavorites || (MediaDataController.getInstance(ContentPreviewViewer.this.currentAccount).canAddStickerToFavorites() && MessageObject.isStickerHasSet(ContentPreviewViewer.this.currentDocument)))) {
                            if (isStickerInFavorites) {
                                i3 = C0952R.string.DeleteFromFavorites;
                                str = "DeleteFromFavorites";
                            } else {
                                i3 = C0952R.string.AddToFavorites;
                                str = "AddToFavorites";
                            }
                            arrayList.add(LocaleController.getString(str, i3));
                            arrayList3.add(Integer.valueOf(isStickerInFavorites ? C0952R.C0953drawable.outline_unfave : C0952R.C0953drawable.outline_fave));
                            arrayList2.add(2);
                        }
                        if (ContentPreviewViewer.this.isRecentSticker) {
                            arrayList.add(LocaleController.getString("DeleteFromRecent", C0952R.string.DeleteFromRecent));
                            arrayList3.add(Integer.valueOf((int) C0952R.C0953drawable.msg_delete));
                            arrayList2.add(4);
                        }
                        if (!arrayList.isEmpty()) {
                            ...
                            View$OnClickListenerC26981 r2 = new View$OnClickListenerC26981(arrayList2, isStickerInFavorites);
                            ActionBarPopupWindow.ActionBarPopupWindowLayout actionBarPopupWindowLayout = new ActionBarPopupWindow.ActionBarPopupWindowLayout(ContentPreviewViewer.this.containerView.getContext(), C0952R.C0953drawable.popup_fixed_alert2, ContentPreviewViewer.this.resourcesProvider);
                            ...
                            ContentPreviewViewer.this.popupWindow.setAnimationStyle(C0952R.style.PopupContextAnimation);
                            ...
                            int min = (ContentPreviewViewer.this.currentContentType == 1 ? Math.min(ContentPreviewViewer.this.containerView.getWidth(), ContentPreviewViewer.this.containerView.getHeight() - i2) - AndroidUtilities.m34dp(40.0f) : (int) (Math.min(ContentPreviewViewer.this.containerView.getWidth(), ContentPreviewViewer.this.containerView.getHeight() - i2) / 1.8f)) / 2;
                            int max = ((int) (ContentPreviewViewer.this.moveY + Math.max(i + min + (ContentPreviewViewer.this.stickerEmojiLayout != null ? AndroidUtilities.m34dp(40.0f) : 0), ((ContentPreviewViewer.this.containerView.getHeight() - i2) - ContentPreviewViewer.this.keyboardHeight) / 2) + min)) + AndroidUtilities.m34dp(24.0f);
                            ContentPreviewViewer contentPreviewViewer = ContentPreviewViewer.this;
                    ...
                    if (ContentPreviewViewer.this.delegate.needSend() && !ContentPreviewViewer.this.delegate.isInScheduleMode()) {
                        arrayList4.add(LocaleController.getString("SendGifPreview", C0952R.string.SendGifPreview));
                        arrayList6.add(Integer.valueOf((int) C0952R.C0953drawable.outline_send));
                        arrayList5.add(0);
                    }
                    if (ContentPreviewViewer.this.delegate.canSchedule()) {
                        arrayList4.add(LocaleController.getString("Schedule", C0952R.string.Schedule));
                        arrayList6.add(Integer.valueOf((int) C0952R.C0953drawable.msg_timer));
                        arrayList5.add(3);
                    }
                    if (ContentPreviewViewer.this.currentDocument != null) {
                        ...
                        if (z) {
                            arrayList4.add(LocaleController.formatString("Delete", C0952R.string.Delete, new Object[0]));
                            arrayList6.add(Integer.valueOf((int) C0952R.C0953drawable.msg_delete));
                            arrayList5.add(1);
                        } else {
                            arrayList4.add(LocaleController.formatString("SaveToGIFs", C0952R.string.SaveToGIFs, new Object[0]));
                            arrayList6.add(Integer.valueOf((int) C0952R.C0953drawable.outline_add_gif));
                            arrayList5.add(2);
                        }
                    } else {
                        z = false;
                    ...
                    ContentPreviewViewer.this.visibleDialog.setItems((CharSequence[]) arrayList4.toArray(new CharSequence[0]), iArr2, new DialogInterface.OnClickListener() {
                        ...
                        public final void onClick(DialogInterface dialogInterface, int i7) {
                            ContentPreviewViewer.RunnableC26971.this.lambda$run$1(arrayList5, dialogInterface, i7);
                        }
                    });
                    ...
                    ContentPreviewViewer.this.visibleDialog.setOnDismissListener(new DialogInterface.OnDismissListener() {
                        ...
                        public final void onDismiss(DialogInterface dialogInterface) {
                            ContentPreviewViewer.RunnableC26971.this.lambda$run$2(dialogInterface);
                        }
                    });
        ...
        class View$OnClickListenerC26981 implements View.OnClickListener {
            final ArrayList val$actions;
            final boolean val$inFavs;

            View$OnClickListenerC26981(ArrayList arrayList, boolean z) {
                RunnableC26971.this = r1;
                ...
                if (((Integer) arrayList.get(i)).intValue() == 0) {
                    ...
                    AlertsCreator.createScheduleDatePickerDialog(ContentPreviewViewer.this.parentActivity, contentPreviewViewerDelegate.getDialogId(), new AlertsCreator.ScheduleDatePickerDelegate() {
                        ...
                        public final void didSelectDate(boolean z, int i2) {
                            ContentPreviewViewer.RunnableC26971.lambda$run$0(ContentPreviewViewer.ContentPreviewViewerDelegate.this, tLRPC$Document, tLRPC$BotInlineResult, obj, z, i2);
                        }
    ...
    public boolean onTouch(android.view.MotionEvent r16, final org.telegram.p009ui.Components.RecyclerListView r17, int r18, final java.lang.Object r19, org.telegram.p009ui.ContentPreviewViewer.ContentPreviewViewerDelegate r20, org.telegram.p009ui.ActionBar.Theme.ResourcesProvider r21) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p009ui.ContentPreviewViewer.onTouch(android.view.MotionEvent, org.telegram.ui.Components.RecyclerListView, int, java.lang.Object, org.telegram.ui.ContentPreviewViewer$ContentPreviewViewerDelegate, org.telegram.ui.ActionBar.Theme$ResourcesProvider):boolean");
    }
                        ...
                        if (childAt instanceof ContextLinkCell) {
                            ...
                            if (contextLinkCell.showingBitmap()) {
                                if (contextLinkCell.isSticker()) {
                                    ...
                                    this.centerImage.setRoundRadius(AndroidUtilities.m34dp(6.0f));
                                    i2 = 1;
                                }
                            }
                        }
    ...
    public void setParentActivity(Activity activity) {
        ...
        if (this.parentActivity != activity) {
            ...
            this.slideUpDrawable = activity.getResources().getDrawable(C0952R.C0953drawable.preview_arrow);
        ...
        if (this.parentActivity != null && this.windowView != null) {
            ...
            if (i != 0) {
                ...
                if (textPaint == null) {
                    ...
                    textPaint2.setTextSize(AndroidUtilities.m34dp(24.0f));
                }
                ...
                if (tLRPC$Document != null) {
                    ...
                    while (true) {
                        ...
                        if ((tLRPC$DocumentAttribute2 instanceof TLRPC$TL_documentAttributeSticker) && !TextUtils.isEmpty(tLRPC$DocumentAttribute2.alt)) {
                            this.stickerEmojiLayout = new StaticLayout(Emoji.replaceEmoji(tLRPC$DocumentAttribute2.alt, textPaint.getFontMetricsInt(), AndroidUtilities.m34dp(24.0f), false), textPaint, AndroidUtilities.m34dp(100.0f), Layout.Alignment.ALIGN_CENTER, 1.0f, 0.0f, false);
                            break;
                        }
                        i3++;
                    }
                    ...
                    if (str != null) {
                        this.stickerEmojiLayout = new StaticLayout(Emoji.replaceEmoji(str, textPaint.getFontMetricsInt(), AndroidUtilities.m34dp(24.0f), false), textPaint, AndroidUtilities.m34dp(100.0f), Layout.Alignment.ALIGN_CENTER, 1.0f, 0.0f, false);
                    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.containerView != null && this.backgroundDrawable != null) {
            ...
            if (this.currentContentType == 1) {
                i3 = Math.min(this.containerView.getWidth(), this.containerView.getHeight() - i2) - AndroidUtilities.m34dp(40.0f);
            } else {
                if (this.drawEffect) {
            ...
            float max = Math.max((i3 / 2) + i + (this.stickerEmojiLayout != null ? AndroidUtilities.m34dp(40.0f) : 0), ((this.containerView.getHeight() - i2) - this.keyboardHeight) / 2);
            if (this.drawEffect) {
                max += AndroidUtilities.m34dp(40.0f);
            }
            ...
            if (this.drawEffect) {
                ...
                float f10 = f8 - f9;
                this.centerImage.setImageCoords(f10 - f9, (f10 / 2.0f) - f9, f9, f9);
                this.centerImage.draw(canvas);
                this.effectImage.setAlpha(this.showProgress);
                float f11 = (-i4) / 2.0f;
                this.effectImage.setImageCoords(f11, f11, f8, f8);
            ...
            if (this.currentContentType == 1 && (drawable = this.slideUpDrawable) != null) {
                ...
                int dp = (int) (this.centerImage.getDrawRegion().top - AndroidUtilities.m34dp(((this.currentMoveY / AndroidUtilities.m34dp(60.0f)) * 6.0f) + 17.0f));
            ...
            if (this.stickerEmojiLayout != null) {
                if (this.drawEffect) {
                    canvas.translate(-AndroidUtilities.m34dp(50.0f), ((-this.effectImage.getImageHeight()) / 2.0f) - AndroidUtilities.m34dp(30.0f));
                } else {
                    canvas.translate(-AndroidUtilities.m34dp(50.0f), ((-this.centerImage.getImageHeight()) / 2.0f) - AndroidUtilities.m34dp(30.0f));
                }
