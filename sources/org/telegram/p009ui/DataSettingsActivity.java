...
public class DataSettingsActivity extends BaseFragment {
    ...
    public View createView(final Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString("DataSettings", C0952R.string.DataSettings));
    ...
    public void lambda$createView$6(Context context, View view, final int i, float f, float f2) {
        ...
        if (i == i3 || i == this.saveToGalleryChannelsRow || i == this.saveToGalleryPeerRow) {
            ...
            if (getParentActivity() != null && view.isEnabled()) {
                ...
                builder.setTitle(LocaleController.getString("ResetAutomaticMediaDownloadAlertTitle", C0952R.string.ResetAutomaticMediaDownloadAlertTitle));
                builder.setMessage(LocaleController.getString("ResetAutomaticMediaDownloadAlert", C0952R.string.ResetAutomaticMediaDownloadAlert));
            ...
            if (i7 != 0) {
                ...
                Dialog createSingleChoiceDialog = AlertsCreator.createSingleChoiceDialog(getParentActivity(), new String[]{LocaleController.getString("UseLessDataNever", C0952R.string.UseLessDataNever), LocaleController.getString("UseLessDataOnRoaming", C0952R.string.UseLessDataOnRoaming), LocaleController.getString("UseLessDataOnMobile", C0952R.string.UseLessDataOnMobile), LocaleController.getString("UseLessDataAlways", C0952R.string.UseLessDataAlways)}, LocaleController.getString("VoipUseLessData", C0952R.string.VoipUseLessData), i2, new DialogInterface.OnClickListener() {
                    @Override
            ...
            i2 = 0;
            Dialog createSingleChoiceDialog2 = AlertsCreator.createSingleChoiceDialog(getParentActivity(), new String[]{LocaleController.getString("UseLessDataNever", C0952R.string.UseLessDataNever), LocaleController.getString("UseLessDataOnRoaming", C0952R.string.UseLessDataOnRoaming), LocaleController.getString("UseLessDataOnMobile", C0952R.string.UseLessDataOnMobile), LocaleController.getString("UseLessDataAlways", C0952R.string.UseLessDataAlways)}, LocaleController.getString("VoipUseLessData", C0952R.string.VoipUseLessData), i2, new DialogInterface.OnClickListener() {
                @Override
                public final void onClick(DialogInterface dialogInterface, int i8) {
                    DataSettingsActivity.this.lambda$createView$1(globalMainSettings, i, dialogInterface, i8);
                }
            ...
            builder2.setTitle(LocaleController.getString("StoragePath", C0952R.string.StoragePath));
            ...
            builder3.setTitle(LocaleController.getString("AreYouSureClearDraftsTitle", C0952R.string.AreYouSureClearDraftsTitle));
            builder3.setMessage(LocaleController.getString("AreYouSureClearDrafts", C0952R.string.AreYouSureClearDrafts));
            builder3.setPositiveButton(LocaleController.getString("Delete", C0952R.string.Delete), new DialogInterface.OnClickListener() {
                @Override
    ...
    public class ListAdapter extends RecyclerListView.SelectionAdapter {
            ...
            if (itemViewType != 0) {
                ...
                if (itemViewType == 1) {
                    ...
                    if (i == DataSettingsActivity.this.storageUsageRow) {
                        textSettingsCell.setText(LocaleController.getString("StorageUsage", C0952R.string.StorageUsage), true);
                        ...
                        if (i2 == 0) {
                            str = LocaleController.getString("UseLessDataNever", C0952R.string.UseLessDataNever);
                        } else if (i2 == 1) {
                            str = LocaleController.getString("UseLessDataOnMobile", C0952R.string.UseLessDataOnMobile);
                        } else if (i2 == 2) {
                            str = LocaleController.getString("UseLessDataAlways", C0952R.string.UseLessDataAlways);
                        } else if (i2 == 3) {
                            str = LocaleController.getString("UseLessDataOnRoaming", C0952R.string.UseLessDataOnRoaming);
                        }
                        textSettingsCell.setTextAndValue(LocaleController.getString("VoipUseLessData", C0952R.string.VoipUseLessData), str, true);
                    } else if (i == DataSettingsActivity.this.dataUsageRow) {
                        String string2 = LocaleController.getString("NetworkUsage", C0952R.string.NetworkUsage);
                        ...
                        textSettingsCell.setTextAndValue(LocaleController.getString("StoragePath", C0952R.string.StoragePath), absolutePath, false);
                    } else if (i == DataSettingsActivity.this.proxyRow) {
                        textSettingsCell.setText(LocaleController.getString("ProxySettings", C0952R.string.ProxySettings), false);
                        ...
                        textSettingsCell.setText(LocaleController.getString("ResetAutomaticMediaDownload", C0952R.string.ResetAutomaticMediaDownload), false);
                    } else if (i == DataSettingsActivity.this.quickRepliesRow) {
                        textSettingsCell.setText(LocaleController.getString("VoipQuickReplies", C0952R.string.VoipQuickReplies), false);
                    } else if (i == DataSettingsActivity.this.clearDraftsRow) {
                        textSettingsCell.setText(LocaleController.getString("PrivacyDeleteCloudDrafts", C0952R.string.PrivacyDeleteCloudDrafts), false);
                    }
                } else if (itemViewType == 2) {
                    HeaderCell headerCell = (HeaderCell) viewHolder.itemView;
                    if (i == DataSettingsActivity.this.mediaDownloadSectionRow) {
                        headerCell.setText(LocaleController.getString("AutomaticMediaDownload", C0952R.string.AutomaticMediaDownload));
                    } else if (i == DataSettingsActivity.this.usageSectionRow) {
                        headerCell.setText(LocaleController.getString("DataUsage", C0952R.string.DataUsage));
                    } else if (i == DataSettingsActivity.this.callsSectionRow) {
                        headerCell.setText(LocaleController.getString("Calls", C0952R.string.Calls));
                    } else if (i == DataSettingsActivity.this.proxySectionRow) {
                        headerCell.setText(LocaleController.getString("Proxy", C0952R.string.Proxy));
                    } else if (i == DataSettingsActivity.this.streamSectionRow) {
                        headerCell.setText(LocaleController.getString("Streaming", C0952R.string.Streaming));
                    } else if (i == DataSettingsActivity.this.autoplayHeaderRow) {
                        headerCell.setText(LocaleController.getString("AutoplayMedia", C0952R.string.AutoplayMedia));
                    } else if (i == DataSettingsActivity.this.saveToGallerySectionRow) {
                        headerCell.setText(LocaleController.getString("SaveToGallery", C0952R.string.SaveToGallery));
                    }
                } else if (itemViewType == 3) {
                    TextCheckCell textCheckCell = (TextCheckCell) viewHolder.itemView;
                    if (i == DataSettingsActivity.this.enableStreamRow) {
                        String string3 = LocaleController.getString("EnableStreaming", C0952R.string.EnableStreaming);
                        ...
                        if (i == DataSettingsActivity.this.enableMkvRow) {
                            ...
                            textCheckCell.setTextAndCheck(LocaleController.getString("AutoplayGIF", C0952R.string.AutoplayGIF), SharedConfig.autoplayGifs, true);
                        } else if (i == DataSettingsActivity.this.autoplayVideoRow) {
                            textCheckCell.setTextAndCheck(LocaleController.getString("AutoplayVideo", C0952R.string.AutoplayVideo), SharedConfig.autoplayVideo, false);
                        } else if (i == DataSettingsActivity.this.saveToGalleryPeerRow) {
                            String string4 = LocaleController.getString("SaveToGalleryPrivate", C0952R.string.SaveToGalleryPrivate);
                            ...
                            String string5 = LocaleController.getString("SaveToGalleryGroups", C0952R.string.SaveToGalleryGroups);
                            ...
                            String string6 = LocaleController.getString("SaveToGalleryChannels", C0952R.string.SaveToGalleryChannels);
                    ...
                    if (i == DataSettingsActivity.this.enableAllStreamInfoRow) {
                        textInfoPrivacyCell.setText(LocaleController.getString("EnableAllStreamingInfo", C0952R.string.EnableAllStreamingInfo));
                    }
                    ...
                    if (i == DataSettingsActivity.this.mobileRow) {
                        string = LocaleController.getString("WhenUsingMobileData", C0952R.string.WhenUsingMobileData);
                        ...
                        string = LocaleController.getString("WhenConnectedOnWiFi", C0952R.string.WhenConnectedOnWiFi);
                        ...
                        string = LocaleController.getString("WhenRoaming", C0952R.string.WhenRoaming);
                    ...
                    if (!currentRoamingPreset.enabled || i5 == 0) {
                        ...
                        sb.append(LocaleController.getString("NoMediaAutoDownload", C0952R.string.NoMediaAutoDownload));
                    } else {
                        if (z5) {
                            sb.append(LocaleController.getString("AutoDownloadPhotosOn", C0952R.string.AutoDownloadPhotosOn));
                        }
                        if (z6) {
                            if (sb.length() > 0) {
                                sb.append(", ");
                            }
                            sb.append(LocaleController.getString("AutoDownloadVideosOn", C0952R.string.AutoDownloadVideosOn));
                            notificationsCheckCell = notificationsCheckCell2;
                        ...
                        if (z7) {
                            ...
                            sb.append(LocaleController.getString("AutoDownloadFilesOn", C0952R.string.AutoDownloadFilesOn));
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 0) {
                ...
                view.setBackgroundDrawable(Theme.getThemedDrawable(this.mContext, (int) C0952R.C0953drawable.greydivider, "windowBackgroundGrayShadow"));
            }
