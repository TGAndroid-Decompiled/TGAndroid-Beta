...
public class PhotoCropActivity extends BaseFragment {
    ...
    public class PhotoCropView extends FrameLayout {
        ...
        private void init() {
            ...
            this.rectPaint.setStrokeWidth(AndroidUtilities.m34dp(2.0f));
        ...
        private void updateBitmapSize() {
            ...
            if (this.viewWidth != 0 && this.viewHeight != 0 && PhotoCropActivity.this.imageToCrop != null) {
                ...
                this.bitmapX = ((this.viewWidth - this.bitmapWidth) / 2) + AndroidUtilities.m34dp(14.0f);
                int dp = ((this.viewHeight - this.bitmapHeight) / 2) + AndroidUtilities.m34dp(14.0f);
                this.bitmapY = dp;
                if (this.rectX != -1.0f || this.rectY != -1.0f) {
                    ...
                    if (this.bitmapWidth > this.bitmapHeight) {
                        this.rectY = dp;
                        this.rectX = ((this.viewWidth - i2) / 2) + AndroidUtilities.m34dp(14.0f);
                        int i9 = this.bitmapHeight;
                        this.rectSizeX = i9;
                        this.rectSizeY = i9;
                    } else {
                        this.rectX = this.bitmapX;
                        this.rectY = ((this.viewHeight - i) / 2) + AndroidUtilities.m34dp(14.0f);
        ...
        protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
            ...
            this.viewWidth = (i3 - i) - AndroidUtilities.m34dp(28.0f);
            this.viewHeight = (i4 - i2) - AndroidUtilities.m34dp(28.0f);
            updateBitmapSize();
        }
    ...
    public boolean onFragmentCreate() {
        ...
        if (this.imageToCrop == null) {
            ...
            if (AndroidUtilities.isTablet()) {
                i = AndroidUtilities.m34dp(520.0f);
            } else {
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString("CropImage", C0952R.string.CropImage));
        ...
        this.actionBar.createMenu().addItemWithWidth(1, C0952R.C0953drawable.ic_done, AndroidUtilities.m34dp(56.0f), LocaleController.getString("Done", C0952R.string.Done));
