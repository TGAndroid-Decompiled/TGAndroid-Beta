...
import org.telegram.p009ui.ChannelCreateActivity;
...
public class ChannelCreateActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, ImageUpdater.ImageUpdaterDelegate {
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C12901());
        ...
        if (i == 0) {
            this.actionBar.setTitle(LocaleController.getString("NewChannel", C0890R.string.NewChannel));
            SizeNotifierFrameLayout sizeNotifierFrameLayout = new SizeNotifierFrameLayout(context) {
                    ...
                    for (int i4 = 0; i4 < childCount; i4++) {
                        ...
                        if (!(childAt == null || childAt.getVisibility() == 8 || childAt == ((BaseFragment) ChannelCreateActivity.this).actionBar)) {
                            if (ChannelCreateActivity.this.nameTextView == null || !ChannelCreateActivity.this.nameTextView.isPopupView(childAt)) {
                                ...
                                childAt.measure(View.MeasureSpec.makeMeasureSpec(size, 1073741824), View.MeasureSpec.makeMeasureSpec(Math.min(AndroidUtilities.m34dp(AndroidUtilities.isTablet() ? 200.0f : 320.0f), (paddingTop - AndroidUtilities.statusBarHeight) + getPaddingTop()), 1073741824));
                            } else {
                ...
                public void onLayout(boolean r11, int r12, int r13, int r14, int r15) {
                    throw new UnsupportedOperationException("Method not decompiled: org.telegram.p009ui.ChannelCreateActivity.C12912.onLayout(boolean, int, int, int, int):void");
                }
            ...
            sizeNotifierFrameLayout.setOnTouchListener(ChannelCreateActivity$$ExternalSyntheticLambda6.INSTANCE);
            ...
            this.avatarOverlay.setOnClickListener(new View.OnClickListener() {
                ...
                public final void onClick(View view2) {
                    ChannelCreateActivity.this.lambda$createView$5(view2);
                }
            });
            this.cameraDrawable = new RLottieDrawable(C0890R.raw.camera, "2131558412", AndroidUtilities.m34dp(60.0f), AndroidUtilities.m34dp(60.0f), false, null);
            ...
            this.avatarEditor.setPadding(AndroidUtilities.m34dp(2.0f), 0, 0, AndroidUtilities.m34dp(1.0f));
            ...
            editTextEmoji2.setHint(LocaleController.getString("EnterChannelName", C0890R.string.EnterChannelName));
            ...
            this.nameTextView.getEditText().setOnEditorActionListener(new TextView.OnEditorActionListener() {
                ...
                public final boolean onEditorAction(TextView textView, int i2, KeyEvent keyEvent) {
                    ...
                    lambda$createView$6 = ChannelCreateActivity.this.lambda$createView$6(textView, i2, keyEvent);
            ...
            this.descriptionTextView.setPadding(0, 0, 0, AndroidUtilities.m34dp(6.0f));
            ...
            this.descriptionTextView.setHint(LocaleController.getString("DescriptionPlaceholder", C0890R.string.DescriptionPlaceholder));
            this.descriptionTextView.setCursorColor(Theme.getColor("windowBackgroundWhiteBlackText"));
            this.descriptionTextView.setCursorSize(AndroidUtilities.m34dp(20.0f));
            ...
            this.descriptionTextView.setOnEditorActionListener(new TextView.OnEditorActionListener() {
                ...
                public final boolean onEditorAction(TextView textView, int i2, KeyEvent keyEvent) {
                    ...
                    lambda$createView$7 = ChannelCreateActivity.this.lambda$createView$7(textView, i2, keyEvent);
            ...
            this.helpTextView.setText(LocaleController.getString("DescriptionInfo", C0890R.string.DescriptionInfo));
            ...
            this.actionBar.setTitle(LocaleController.getString("ChannelSettingsTitle", C0890R.string.ChannelSettingsTitle));
            ...
            this.headerCell2.setText(LocaleController.getString("ChannelTypeHeader", C0890R.string.ChannelTypeHeader));
            ...
            this.radioButtonCell1.setTextAndValue(LocaleController.getString("ChannelPublic", C0890R.string.ChannelPublic), LocaleController.getString("ChannelPublicInfo", C0890R.string.ChannelPublicInfo), false, !this.isPrivate);
            ...
            this.radioButtonCell1.setOnClickListener(new View.OnClickListener() {
                @Override
                public final void onClick(View view2) {
                    ChannelCreateActivity.this.lambda$createView$8(view2);
                }
            });
            ...
            this.radioButtonCell2.setTextAndValue(LocaleController.getString("ChannelPrivate", C0890R.string.ChannelPrivate), LocaleController.getString("ChannelPrivateInfo", C0890R.string.ChannelPrivateInfo), false, this.isPrivate);
            ...
            this.radioButtonCell2.setOnClickListener(new View.OnClickListener() {
                @Override
                public final void onClick(View view2) {
                    ChannelCreateActivity.this.lambda$createView$9(view2);
                }
            });
            ...
            this.descriptionTextView.setImeOptions(6);
            this.descriptionTextView.setHint(LocaleController.getString("ChannelUsernamePlaceholder", C0890R.string.ChannelUsernamePlaceholder));
            this.descriptionTextView.setCursorColor(Theme.getColor("windowBackgroundWhiteBlackText"));
            this.descriptionTextView.setCursorSize(AndroidUtilities.m34dp(20.0f));
            this.descriptionTextView.setCursorWidth(1.5f);
    ...
    public class C12901 extends C0945ActionBar.ActionBarMenuOnItemClick {
        C12901() {
        }
                ...
                if (ChannelCreateActivity.this.currentStep == 0) {
                        ...
                        if (ChannelCreateActivity.this.imageUpdater.isUploadingImage()) {
                            ...
                            ChannelCreateActivity.this.progressDialog.setOnCancelListener(new DialogInterface.OnCancelListener() {
                                ...
                                public final void onCancel(DialogInterface dialogInterface) {
                                    ChannelCreateActivity.C12901.this.lambda$onItemClick$0(dialogInterface);
                                }
                            });
                            ChannelCreateActivity.this.progressDialog.show();
                            return;
                        }
                        final int createChat = MessagesController.getInstance(((BaseFragment) ChannelCreateActivity.this).currentAccount).createChat(ChannelCreateActivity.this.nameTextView.getText().toString(), new ArrayList<>(), ChannelCreateActivity.this.descriptionTextView.getText().toString(), 2, false, null, null, ChannelCreateActivity.this);
                        ChannelCreateActivity.this.progressDialog = new AlertDialog(ChannelCreateActivity.this.getParentActivity(), 3);
                        ChannelCreateActivity.this.progressDialog.setOnCancelListener(new DialogInterface.OnCancelListener() {
                            @Override
                            public final void onCancel(DialogInterface dialogInterface) {
                                ChannelCreateActivity.C12901.this.lambda$onItemClick$1(createChat, dialogInterface);
                            }
                        });
                        ChannelCreateActivity.this.progressDialog.show();
                    }
                    ...
                    if (!ChannelCreateActivity.this.isPrivate) {
                        if (ChannelCreateActivity.this.descriptionTextView.length() == 0) {
                            ...
                            builder.setTitle(LocaleController.getString("ChannelPublicEmptyUsernameTitle", C0890R.string.ChannelPublicEmptyUsernameTitle));
                            builder.setMessage(LocaleController.getString("ChannelPublicEmptyUsername", C0890R.string.ChannelPublicEmptyUsername));
                            builder.setPositiveButton(LocaleController.getString("Close", C0890R.string.Close), null);
        ...
        public void lambda$onItemClick$1(int i, DialogInterface dialogInterface) {
    ...
    public void lambda$createView$5(View view) {
        this.imageUpdater.openMenu(this.avatar != null, new Runnable() {
            @Override
            public final void run() {
                ChannelCreateActivity.this.lambda$createView$3();
            }
        }, new DialogInterface.OnDismissListener() {
            @Override
            public final void onDismiss(DialogInterface dialogInterface) {
                ChannelCreateActivity.this.lambda$createView$4(dialogInterface);
            }
        });
    ...
    public void lambda$createView$4(DialogInterface dialogInterface) {
        ...
        if (!this.loadingInvite && this.invite == null) {
            ...
            if (this.invite == null) {
                ...
                ConnectionsManager.getInstance(this.currentAccount).sendRequest(tLRPC$TL_messages_getExportedChatInvites, new RequestDelegate() {
                    @Override
                    public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                        ChannelCreateActivity.this.lambda$generateLink$11(tLObject, tLRPC$TL_error);
                    }
                });
            }
        }
    ...
    public void lambda$generateLink$11(final TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
        AndroidUtilities.runOnUIThread(new Runnable() {
            @Override
            public final void run() {
                ChannelCreateActivity.this.lambda$generateLink$10(tLRPC$TL_error, tLObject);
            }
        });
    }

    public void lambda$generateLink$10(TLRPC$TL_error tLRPC$TL_error, TLObject tLObject) {
    ...
    private void updatePrivatePublic() {
        ...
        if (this.sectionCell != null) {
            ...
            if (this.isPrivate || this.canCreatePublic) {
                ...
                textInfoPrivacyCell.setBackgroundDrawable(Theme.getThemedDrawable(textInfoPrivacyCell.getContext(), (int) C0890R.C0891drawable.greydivider_bottom, "windowBackgroundGrayShadow"));
                this.linkContainer.setVisibility(0);
                this.loadingAdminedCell.setVisibility(8);
                TextInfoPrivacyCell textInfoPrivacyCell2 = this.typeInfoCell;
                if (this.isPrivate) {
                    i = C0890R.string.ChannelPrivateLinkHelp;
                    str = "ChannelPrivateLinkHelp";
                } else {
                    i = C0890R.string.ChannelUsernameHelp;
                    str = "ChannelUsernameHelp";
                }
                textInfoPrivacyCell2.setText(LocaleController.getString(str, i));
                HeaderCell headerCell = this.headerCell;
                if (this.isPrivate) {
                    i2 = C0890R.string.ChannelInviteLinkTitle;
                    str2 = "ChannelInviteLinkTitle";
                } else {
                    i2 = C0890R.string.ChannelLinkTitle;
                    str2 = "ChannelLinkTitle";
                }
                headerCell.setText(LocaleController.getString(str2, i2));
                this.publicContainer.setVisibility(this.isPrivate ? 8 : 0);
                this.privateContainer.setVisibility(this.isPrivate ? 0 : 8);
                this.linkContainer.setPadding(0, 0, 0, this.isPrivate ? 0 : AndroidUtilities.m34dp(7.0f));
                LinkActionView linkActionView = this.permanentLinkView;
                TLRPC$TL_chatInviteExported tLRPC$TL_chatInviteExported = this.invite;
                linkActionView.setLink(tLRPC$TL_chatInviteExported != null ? tLRPC$TL_chatInviteExported.link : null);
                ...
                this.typeInfoCell.setText(LocaleController.getString("ChangePublicLimitReached", C0890R.string.ChangePublicLimitReached));
                ...
                if (this.loadingAdminedChannels) {
                    ...
                    textInfoPrivacyCell3.setBackgroundDrawable(Theme.getThemedDrawable(textInfoPrivacyCell3.getContext(), (int) C0890R.C0891drawable.greydivider_bottom, "windowBackgroundGrayShadow"));
                    this.adminedInfoCell.setVisibility(8);
                } else {
                    TextInfoPrivacyCell textInfoPrivacyCell4 = this.typeInfoCell;
                    textInfoPrivacyCell4.setBackgroundDrawable(Theme.getThemedDrawable(textInfoPrivacyCell4.getContext(), (int) C0890R.C0891drawable.greydivider, "windowBackgroundGrayShadow"));
                    this.loadingAdminedCell.setVisibility(8);
    ...
    public void didUploadPhoto(final TLRPC$InputFile tLRPC$InputFile, final TLRPC$InputFile tLRPC$InputFile2, final double d, final String str, final TLRPC$PhotoSize tLRPC$PhotoSize, final TLRPC$PhotoSize tLRPC$PhotoSize2) {
        AndroidUtilities.runOnUIThread(new Runnable() {
            @Override
            public final void run() {
                ChannelCreateActivity.this.lambda$didUploadPhoto$12(tLRPC$InputFile, tLRPC$InputFile2, str, d, tLRPC$PhotoSize2, tLRPC$PhotoSize);
            }
        });
    }

    public void lambda$didUploadPhoto$12(TLRPC$InputFile tLRPC$InputFile, TLRPC$InputFile tLRPC$InputFile2, String str, double d, TLRPC$PhotoSize tLRPC$PhotoSize, TLRPC$PhotoSize tLRPC$PhotoSize2) {
    ...
    private void loadAdminedChannels() {
        if (!this.loadingAdminedChannels) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(new TLRPC$TL_channels_getAdminedPublicChannels(), new RequestDelegate() {
                @Override
                public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                    ChannelCreateActivity.this.lambda$loadAdminedChannels$18(tLObject, tLRPC$TL_error);
                }
            });
        }
    }
    ...
    public void lambda$loadAdminedChannels$18(final TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        AndroidUtilities.runOnUIThread(new Runnable() {
            @Override
            public final void run() {
                ChannelCreateActivity.this.lambda$loadAdminedChannels$17(tLObject);
            }
        });
    }
    ...
    public void lambda$loadAdminedChannels$16(View view) {
        ...
        if (currentChannel.megagroup) {
            builder.setMessage(AndroidUtilities.replaceTags(LocaleController.formatString("RevokeLinkAlert", C0890R.string.RevokeLinkAlert, MessagesController.getInstance(this.currentAccount).linkPrefix + "/" + currentChannel.username, currentChannel.title)));
        } else {
            builder.setMessage(AndroidUtilities.replaceTags(LocaleController.formatString("RevokeLinkAlertChannel", C0890R.string.RevokeLinkAlertChannel, MessagesController.getInstance(this.currentAccount).linkPrefix + "/" + currentChannel.username, currentChannel.title)));
        }
        builder.setNegativeButton(LocaleController.getString("Cancel", C0890R.string.Cancel), null);
        builder.setPositiveButton(LocaleController.getString("RevokeButton", C0890R.string.RevokeButton), new DialogInterface.OnClickListener() {
            @Override
            public final void onClick(DialogInterface dialogInterface, int i) {
                ChannelCreateActivity.this.lambda$loadAdminedChannels$15(currentChannel, dialogInterface, i);
            }
        });
        showDialog(builder.create());
    }

    public void lambda$loadAdminedChannels$15(TLRPC$Chat tLRPC$Chat, DialogInterface dialogInterface, int i) {
        ...
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(tLRPC$TL_channels_updateUsername, new RequestDelegate() {
            @Override
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                ChannelCreateActivity.this.lambda$loadAdminedChannels$14(tLObject, tLRPC$TL_error);
            }
        }, 64);
    }

    public void lambda$loadAdminedChannels$14(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        if (tLObject instanceof TLRPC$TL_boolTrue) {
            AndroidUtilities.runOnUIThread(new Runnable() {
                @Override
                public final void run() {
                    ChannelCreateActivity.this.lambda$loadAdminedChannels$13();
                }
            });
        }
    }

    public void lambda$loadAdminedChannels$13() {
        this.canCreatePublic = true;
    ...
    public boolean checkUserName(final String str) {
        ...
        if (str != null) {
            if (str.startsWith("_") || str.endsWith("_")) {
                this.checkTextView.setText(LocaleController.getString("LinkInvalid", C0890R.string.LinkInvalid));
            ...
            for (int i = 0; i < str.length(); i++) {
                ...
                if (i == 0 && charAt >= '0' && charAt <= '9') {
                    this.checkTextView.setText(LocaleController.getString("LinkInvalidStartNumber", C0890R.string.LinkInvalidStartNumber));
                    this.checkTextView.setTag("windowBackgroundWhiteRedText4");
                    this.checkTextView.setTextColor(Theme.getColor("windowBackgroundWhiteRedText4"));
                    return false;
        ...
        if (str == null || str.length() < 5) {
            this.checkTextView.setText(LocaleController.getString("LinkInvalidShort", C0890R.string.LinkInvalidShort));
            this.checkTextView.setTag("windowBackgroundWhiteRedText4");
            this.checkTextView.setTextColor(Theme.getColor("windowBackgroundWhiteRedText4"));
            return false;
        } else if (str.length() > 32) {
            this.checkTextView.setText(LocaleController.getString("LinkInvalidLong", C0890R.string.LinkInvalidLong));
            this.checkTextView.setTag("windowBackgroundWhiteRedText4");
            this.checkTextView.setTextColor(Theme.getColor("windowBackgroundWhiteRedText4"));
            return false;
        } else {
            this.checkTextView.setText(LocaleController.getString("LinkChecking", C0890R.string.LinkChecking));
            ...
            Runnable channelCreateActivity$$ExternalSyntheticLambda11 = new Runnable() {
                @Override
                public final void run() {
                    ChannelCreateActivity.this.lambda$checkUserName$21(str);
                }
            };
            this.checkRunnable = channelCreateActivity$$ExternalSyntheticLambda11;
            AndroidUtilities.runOnUIThread(channelCreateActivity$$ExternalSyntheticLambda11, 300L);
            return true;
        }
    }

    public void lambda$checkUserName$21(final String str) {
        TLRPC$TL_channels_checkUsername tLRPC$TL_channels_checkUsername = new TLRPC$TL_channels_checkUsername();
        ...
        this.checkReqId = ConnectionsManager.getInstance(this.currentAccount).sendRequest(tLRPC$TL_channels_checkUsername, new RequestDelegate() {
            @Override
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                ChannelCreateActivity.this.lambda$checkUserName$20(str, tLObject, tLRPC$TL_error);
            }
        }, 2);
    }

    public void lambda$checkUserName$20(final String str, final TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
        AndroidUtilities.runOnUIThread(new Runnable() {
            @Override
            public final void run() {
                ChannelCreateActivity.this.lambda$checkUserName$19(str, tLRPC$TL_error, tLObject);
            }
        });
    }

    public void lambda$checkUserName$19(String str, TLRPC$TL_error tLRPC$TL_error, TLObject tLObject) {
        this.checkReqId = 0;
        String str2 = this.lastCheckName;
        if (str2 != null && str2.equals(str)) {
            if (tLRPC$TL_error != null || !(tLObject instanceof TLRPC$TL_boolTrue)) {
                if (tLRPC$TL_error == null || !tLRPC$TL_error.text.equals("CHANNELS_ADMIN_PUBLIC_TOO_MUCH")) {
                    this.checkTextView.setText(LocaleController.getString("LinkInUse", C0890R.string.LinkInUse));
                } else {
            ...
            this.checkTextView.setText(LocaleController.formatString("LinkAvailable", C0890R.string.LinkAvailable, str));
    ...
    public ArrayList<ThemeDescription> getThemeDescriptions() {
        ...
        ThemeDescription.ThemeDescriptionDelegate channelCreateActivity$$ExternalSyntheticLambda22 = new ThemeDescription.ThemeDescriptionDelegate() {
            @Override
            public final void didSetColor() {
                ChannelCreateActivity.this.lambda$getThemeDescriptions$22();
            }
        ...
        arrayList.add(new ThemeDescription(null, 0, null, null, Theme.avatarDrawables, channelCreateActivity$$ExternalSyntheticLambda22, "avatar_text"));
        arrayList.add(new ThemeDescription(null, 0, null, null, null, channelCreateActivity$$ExternalSyntheticLambda22, "avatar_backgroundRed"));
        arrayList.add(new ThemeDescription(null, 0, null, null, null, channelCreateActivity$$ExternalSyntheticLambda22, "avatar_backgroundOrange"));
        arrayList.add(new ThemeDescription(null, 0, null, null, null, channelCreateActivity$$ExternalSyntheticLambda22, "avatar_backgroundViolet"));
        arrayList.add(new ThemeDescription(null, 0, null, null, null, channelCreateActivity$$ExternalSyntheticLambda22, "avatar_backgroundGreen"));
        arrayList.add(new ThemeDescription(null, 0, null, null, null, channelCreateActivity$$ExternalSyntheticLambda22, "avatar_backgroundCyan"));
        arrayList.add(new ThemeDescription(null, 0, null, null, null, channelCreateActivity$$ExternalSyntheticLambda22, "avatar_backgroundBlue"));
        arrayList.add(new ThemeDescription(null, 0, null, null, null, channelCreateActivity$$ExternalSyntheticLambda22, "avatar_backgroundPink"));
        return arrayList;
    }
