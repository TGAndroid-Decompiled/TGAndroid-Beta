...
public class NewContactActivity extends BaseFragment implements AdapterView.OnItemSelectedListener {
    ...
    public class C34571 extends C1069ActionBar.ActionBarMenuOnItemClick {
        C34571() {
        }
                        ...
                        if (NewContactActivity.this.phoneField.length() != 0) {
                            ...
                            ConnectionsManager.getInstance(((BaseFragment) NewContactActivity.this).currentAccount).bindRequestToGuid(ConnectionsManager.getInstance(((BaseFragment) NewContactActivity.this).currentAccount).sendRequest(tLRPC$TL_contacts_importContacts, new RequestDelegate() {
                                ...
                                public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                                    NewContactActivity.C34571.this.lambda$onItemClick$2(tLRPC$TL_inputPhoneContact, tLRPC$TL_contacts_importContacts, tLObject, tLRPC$TL_error);
                                }
        ...
        public void lambda$onItemClick$2(final TLRPC$TL_inputPhoneContact tLRPC$TL_inputPhoneContact, final TLRPC$TL_contacts_importContacts tLRPC$TL_contacts_importContacts, TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() {
                ...
                public final void run() {
                    NewContactActivity.C34571.this.lambda$onItemClick$1(tLRPC$TL_contacts_importedContacts, tLRPC$TL_inputPhoneContact, tLRPC$TL_error, tLRPC$TL_contacts_importContacts);
                }
            });
        }
        ...
        public void lambda$onItemClick$1(TLRPC$TL_contacts_importedContacts tLRPC$TL_contacts_importedContacts, final TLRPC$TL_inputPhoneContact tLRPC$TL_inputPhoneContact, TLRPC$TL_error tLRPC$TL_error, TLRPC$TL_contacts_importContacts tLRPC$TL_contacts_importContacts) {
            ...
            if (tLRPC$TL_contacts_importedContacts == null) {
                ...
                builder.setTitle(LocaleController.getString("ContactNotRegisteredTitle", C1010R.string.ContactNotRegisteredTitle));
                builder.setMessage(LocaleController.formatString("ContactNotRegistered", C1010R.string.ContactNotRegistered, ContactsController.formatName(tLRPC$TL_inputPhoneContact.first_name, tLRPC$TL_inputPhoneContact.last_name)));
                builder.setNegativeButton(LocaleController.getString("Cancel", C1010R.string.Cancel), null);
                builder.setPositiveButton(LocaleController.getString("Invite", C1010R.string.Invite), new DialogInterface.OnClickListener() {
                    @Override
                    public final void onClick(DialogInterface dialogInterface, int i) {
                        NewContactActivity.C34571.this.lambda$onItemClick$0(tLRPC$TL_inputPhoneContact, dialogInterface, i);
                    }
                });
