...
public class IdenticonActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString("EncryptionKey", C0890R.string.EncryptionKey));
        ...
        frameLayout3.setPadding(AndroidUtilities.m34dp(20.0f), AndroidUtilities.m34dp(20.0f), AndroidUtilities.m34dp(20.0f), AndroidUtilities.m34dp(20.0f));
        ...
        FrameLayout frameLayout4 = new FrameLayout(context) {
            ...
            protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
                ...
                if (IdenticonActivity.this.codeTextView != null) {
                    ...
                    int measuredHeight = (((IdenticonActivity.this.codeTextView.getMeasuredHeight() - IdenticonActivity.this.emojiTextView.getMeasuredHeight()) / 2) + IdenticonActivity.this.linearLayout1.getTop()) - AndroidUtilities.m34dp(16.0f);
        ...
        this.linearLayout1.setPadding(AndroidUtilities.m34dp(10.0f), 0, AndroidUtilities.m34dp(10.0f), 0);
        ...
        if (encryptedChat != null) {
            ...
            spannableStringBuilder.append((CharSequence) AndroidUtilities.replaceTags(LocaleController.formatString("EncryptionKeyDescription", C0890R.string.EncryptionKeyDescription, str, str)));
            int indexOf = spannableStringBuilder.toString().indexOf("telegram.org");
            if (indexOf != -1) {
                spannableStringBuilder.setSpan(new URLSpanReplacement(LocaleController.getString("EncryptionKeyLink", C0890R.string.EncryptionKeyLink)), indexOf, indexOf + 12, 33);
            }
    ...
    public void onTransitionAnimationEnd(boolean z, boolean z2) {
        ...
        if (z && !z2 && (str = this.emojiText) != null) {
            TextView textView = this.emojiTextView;
            textView.setText(Emoji.replaceEmoji(str, textView.getPaint().getFontMetricsInt(), AndroidUtilities.m34dp(32.0f), false));
        }
    }
