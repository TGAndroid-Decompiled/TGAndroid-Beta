...
public class PatternCell extends BackupImageView implements DownloadController.FileDownloadProgressListener {
    ...
    public PatternCell(Context context, int i, PatternCellDelegate patternCellDelegate) {
        super(context);
        setRoundRadius(AndroidUtilities.m34dp(6.0f));
        this.maxWallpaperSize = i;
        this.delegate = patternCellDelegate;
        RadialProgress2 radialProgress2 = new RadialProgress2(this);
        this.radialProgress = radialProgress2;
        radialProgress2.setProgressRect(AndroidUtilities.m34dp(30.0f), AndroidUtilities.m34dp(30.0f), AndroidUtilities.m34dp(70.0f), AndroidUtilities.m34dp(70.0f));
        if (Build.VERSION.SDK_INT >= 21) {
            setOutlineProvider(new ViewOutlineProvider(this) {
                @Override
                public void getOutline(View view, Outline outline) {
                    outline.setRoundRect(AndroidUtilities.m34dp(1.0f), AndroidUtilities.m34dp(1.0f), view.getMeasuredWidth() - AndroidUtilities.m34dp(1.0f), view.getMeasuredHeight() - AndroidUtilities.m34dp(1.0f), AndroidUtilities.m34dp(6.0f));
                }
            });
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (backgroundGradientColor1 == 0) {
            ...
            if (backgroundGradientColor2 != 0) {
                ...
                if (motionBackgroundDrawable != null) {
                    ...
                    motionBackgroundDrawable2.setRoundRadius(AndroidUtilities.m34dp(6.0f));
        ...
        if (motionBackgroundDrawable3 != null) {
            ...
            canvas.drawRoundRect(this.rect, AndroidUtilities.m34dp(6.0f), AndroidUtilities.m34dp(6.0f), this.backgroundPaint);
        }
        super.onDraw(canvas);
    ...
    protected void onMeasure(int i, int i2) {
        setMeasuredDimension(AndroidUtilities.m34dp(100.0f), AndroidUtilities.m34dp(100.0f));
    }
