...
public class CreationTextCell extends FrameLayout {
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (LocaleController.isRTL) {
            m36dp = (getMeasuredWidth() - this.textView.getMeasuredWidth()) - AndroidUtilities.m36dp(this.imageView.getVisibility() == 0 ? this.startPadding : 25.0f);
        } else {
            m36dp = AndroidUtilities.m36dp(this.imageView.getVisibility() == 0 ? this.startPadding : 25.0f);
        }
        ...
        int m36dp2 = !LocaleController.isRTL ? (AndroidUtilities.m36dp(this.startPadding) - this.imageView.getMeasuredWidth()) / 2 : (i5 - this.imageView.getMeasuredWidth()) - AndroidUtilities.m36dp(25.0f);
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        if (this.divider) {
            canvas.drawLine(AndroidUtilities.m36dp(this.startPadding), getMeasuredHeight() - 1, getMeasuredWidth() + AndroidUtilities.m36dp(23.0f), getMeasuredHeight(), Theme.dividerPaint);
        }
    }
