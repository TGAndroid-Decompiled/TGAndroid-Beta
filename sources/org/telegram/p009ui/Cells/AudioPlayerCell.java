...
public class AudioPlayerCell extends View implements DownloadController.FileDownloadProgressListener {
    ...
    private int titleY = AndroidUtilities.m34dp(9.0f);
    private int descriptionY = AndroidUtilities.m34dp(29.0f);
    ...
    protected void onMeasure(int i, int i2) {
        ...
        try {
            ...
            this.titleLayout = new StaticLayout(TextUtils.ellipsize(musicTitle.replace('\n', ' '), Theme.chat_contextResult_titleTextPaint, Math.min((int) Math.ceil(Theme.chat_contextResult_titleTextPaint.measureText(musicTitle)), size), TextUtils.TruncateAt.END), Theme.chat_contextResult_titleTextPaint, size + AndroidUtilities.m34dp(4.0f), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
        } catch (Exception e) {
            FileLog.m30e(e);
        }
        try {
            ...
            this.descriptionLayout = new StaticLayout(TextUtils.ellipsize(replace, Theme.chat_contextResult_descriptionTextPaint, size, TextUtils.TruncateAt.END), Theme.chat_contextResult_descriptionTextPaint, size + AndroidUtilities.m34dp(4.0f), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
        } catch (Exception e2) {
            FileLog.m30e(e2);
        }
        setMeasuredDimension(View.MeasureSpec.getSize(i), AndroidUtilities.m34dp(56.0f));
        int size2 = LocaleController.isRTL ? (View.MeasureSpec.getSize(i) - AndroidUtilities.m34dp(8.0f)) - AndroidUtilities.m34dp(52.0f) : AndroidUtilities.m34dp(8.0f);
        RadialProgress2 radialProgress2 = this.radialProgress;
        int dp = AndroidUtilities.m34dp(4.0f) + size2;
        this.buttonX = dp;
        int dp2 = AndroidUtilities.m34dp(6.0f);
        this.buttonY = dp2;
        radialProgress2.setProgressRect(dp, dp2, size2 + AndroidUtilities.m34dp(48.0f), AndroidUtilities.m34dp(50.0f));
    }
