...
public class StickerCell extends FrameLayout {
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m34dp(76.0f) + getPaddingLeft() + getPaddingRight(), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m34dp(78.0f), 1073741824));
    }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (this.sticker != null) {
            ...
            if (str != null) {
                accessibilityNodeInfo.setText(str + " " + LocaleController.getString("AttachSticker", C0952R.string.AttachSticker));
            } else {
                accessibilityNodeInfo.setText(LocaleController.getString("AttachSticker", C0952R.string.AttachSticker));
            }
