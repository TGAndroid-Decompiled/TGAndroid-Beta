...
public class HeaderCell extends FrameLayout {
    ...
    public HeaderCell(Context context, String str, int i, int i2, boolean z, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.textView.setMinHeight(AndroidUtilities.m34dp(this.height - i2));
    ...
    public void setHeight(int i) {
        ...
        this.height = i;
        textView.setMinHeight(AndroidUtilities.m34dp(i) - ((FrameLayout.LayoutParams) this.textView.getLayoutParams()).topMargin);
    }
