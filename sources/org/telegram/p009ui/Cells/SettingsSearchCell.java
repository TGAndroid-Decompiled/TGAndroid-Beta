...
public class SettingsSearchCell extends FrameLayout {
    ...
    public void setTextAndValueAndIcon(CharSequence charSequence, String[] strArr, int i, boolean z) {
        ...
        float f = 16.0f;
        layoutParams.leftMargin = AndroidUtilities.m34dp(LocaleController.isRTL ? 16.0f : 71.0f);
        layoutParams.rightMargin = AndroidUtilities.m34dp(LocaleController.isRTL ? 71.0f : 16.0f);
        if (strArr != null) {
            SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder();
            for (int i2 = 0; i2 < strArr.length; i2++) {
                if (i2 != 0) {
                    spannableStringBuilder.append((CharSequence) " > ");
                    Drawable mutate = getContext().getResources().getDrawable(C0952R.C0953drawable.settings_arrow).mutate();
            ...
            layoutParams2.leftMargin = AndroidUtilities.m34dp(LocaleController.isRTL ? 16.0f : 71.0f);
            if (LocaleController.isRTL) {
                f = 71.0f;
            }
            layoutParams2.rightMargin = AndroidUtilities.m34dp(f);
        } else {
            layoutParams.topMargin = AndroidUtilities.m34dp(21.0f);
            ...
            if (strArr != null) {
                ...
                for (int i2 = 0; i2 < strArr.length; i2++) {
                    if (i2 != 0) {
                        ...
                        Drawable mutate2 = getContext().getResources().getDrawable(C0952R.C0953drawable.settings_arrow).mutate();
    ...
    protected void onDraw(Canvas canvas) {
        if (this.needDivider) {
            canvas.drawLine(LocaleController.isRTL ? 0.0f : AndroidUtilities.m34dp(this.left), getMeasuredHeight() - 1, getMeasuredWidth() - (LocaleController.isRTL ? AndroidUtilities.m34dp(this.left) : 0), getMeasuredHeight() - 1, Theme.dividerPaint);
        }
    }
}
