...
public class MemberRequestCell extends FrameLayout {
    ...
    public MemberRequestCell(Context context, final OnClickListener onClickListener, boolean z) {
        ...
        backupImageView.setRoundRadius(AndroidUtilities.m34dp(23.0f));
        int i2 = 5;
        ...
        int dp = AndroidUtilities.m34dp(17.0f);
        TextView textView = new TextView(getContext());
        textView.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m34dp(4.0f), Theme.getColor("featuredStickers_addButton"), Theme.getColor("featuredStickers_addButtonPressed")));
        ...
        textView2.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m34dp(4.0f), 0, Theme.getColor("listSelectorSDK21"), -16777216));
        textView2.setGravity((LocaleController.isRTL ? 5 : 3) | 16);
        textView2.setMaxLines(1);
        textView2.setPadding(dp, 0, dp, 0);
        textView2.setText(LocaleController.getString("Dismiss", C0890R.string.Dismiss));
        ...
        FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams(-2, AndroidUtilities.m34dp(32.0f), !LocaleController.isRTL ? 3 : i2);
        layoutParams.topMargin = AndroidUtilities.m34dp(62.0f);
        layoutParams.leftMargin = LocaleController.isRTL ? 0 : (int) (AndroidUtilities.m34dp(79.0f) + measureText);
        layoutParams.rightMargin = LocaleController.isRTL ? (int) (measureText + AndroidUtilities.m34dp(79.0f)) : i3;
    ...
    public void setData(LongSparseArray<TLRPC$User> longSparseArray, TLRPC$TL_chatInviteImporter tLRPC$TL_chatInviteImporter, boolean z) {
        ...
        if (j == 0) {
            this.statusTextView.setText(LocaleController.formatString("RequestedToJoinAt", C0890R.string.RequestedToJoinAt, formatDateAudio));
            return;
        }
        TLRPC$User tLRPC$User2 = longSparseArray.get(j);
        if (tLRPC$User2 != null) {
            this.statusTextView.setText(LocaleController.formatString("AddedBy", C0890R.string.AddedBy, UserObject.getFirstName(tLRPC$User2), formatDateAudio));
        } else {
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m34dp(107.0f), 1073741824));
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.isNeedDivider) {
            canvas.drawLine(LocaleController.isRTL ? 0.0f : AndroidUtilities.m34dp(72.0f), getMeasuredHeight() - 1, getMeasuredWidth() - (LocaleController.isRTL ? AndroidUtilities.m34dp(72.0f) : 0), getMeasuredHeight() - 1, Theme.dividerPaint);
        }
    }
}
