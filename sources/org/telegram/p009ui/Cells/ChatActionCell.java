...
public class ChatActionCell extends BaseCell implements DownloadController.FileDownloadProgressListener, NotificationCenter.NotificationCenterDelegate {
    ...
    private void createLayout(CharSequence charSequence, int i) {
        int dp = i - AndroidUtilities.m34dp(30.0f);
        this.invalidatePath = true;
        ...
        this.textY = AndroidUtilities.m34dp(7.0f);
    ...
    protected void onMeasure(int i, int i2) {
        if (this.currentMessageObject == null && this.customText == null) {
            setMeasuredDimension(View.MeasureSpec.getSize(i), this.textHeight + AndroidUtilities.m34dp(14.0f));
            return;
        }
        int max = Math.max(AndroidUtilities.m34dp(30.0f), View.MeasureSpec.getSize(i));
        ...
        setMeasuredDimension(max, i3 + ((messageObject == null || messageObject.type != 11) ? 0 : AndroidUtilities.roundMessageSize + AndroidUtilities.m34dp(10.0f)) + AndroidUtilities.m34dp(14.0f));
    }
    ...
    private void buildLayout() {
        ...
        if (messageObject2 != null && messageObject2.type == 11) {
            ...
            this.imageReceiver.setImageCoords((this.previousWidth - AndroidUtilities.roundMessageSize) / 2, this.textHeight + AndroidUtilities.m34dp(19.0f), i, i);
        }
    }
    ...
    public void drawBackground(Canvas canvas, boolean z) {
        ...
        if (str != null) {
            ...
            if (this.overrideBackgroundPaint == null) {
                ...
                this.overrideTextPaint.setTextSize(AndroidUtilities.m34dp(Math.max(16, SharedConfig.fontSize) - 2));
        ...
        if (this.invalidatePath) {
            ...
            int lineCount = this.textLayout.getLineCount();
            int dp = AndroidUtilities.m34dp(11.0f);
            ...
            int dp3 = AndroidUtilities.m34dp(4.0f);
            int measuredWidth = getMeasuredWidth() / 2;
            int dp4 = AndroidUtilities.m34dp(3.0f);
            ...
            while (i17 < lineCount) {
                ...
                if (i17 == 0 || intValue2 > i12) {
                    f = 3.0f;
                    i22 += AndroidUtilities.m34dp(3.0f);
                } else {
                    f = 3.0f;
                }
                if (i17 == i21 || intValue2 > i4) {
                    i22 += AndroidUtilities.m34dp(f);
                }
                ...
                if (i17 == i21 || intValue2 >= i4) {
                    ...
                    f3 = 3.0f;
                    dp3 -= AndroidUtilities.m34dp(3.0f);
                    i22 -= AndroidUtilities.m34dp(3.0f);
                }
                if (i17 != 0 && intValue2 < i5) {
                    dp3 -= AndroidUtilities.m34dp(f3);
                    i22 -= AndroidUtilities.m34dp(f3);
                }
        ...
        if (themeDelegate != null) {
            themeDelegate.applyServiceShaderMatrix(getMeasuredWidth(), this.backgroundHeight, 0.0f, this.viewTop + AndroidUtilities.m34dp(4.0f));
        } else {
            Theme.applyServiceShaderMatrix(getMeasuredWidth(), this.backgroundHeight, 0.0f, this.viewTop + AndroidUtilities.m34dp(4.0f));
        }
        int i28 = -1;
        if (!z || getAlpha() == 1.0f) {
            paint2 = paint;
