...
public class ManageChatTextCell extends FrameLayout {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        this.valueTextView.measure(View.MeasureSpec.makeMeasureSpec(size - AndroidUtilities.m34dp(24.0f), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m34dp(20.0f), 1073741824));
        ...
        setMeasuredDimension(size, AndroidUtilities.m34dp(56.0f) + (this.divider ? 1 : 0));
    }
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        int dp = LocaleController.isRTL ? AndroidUtilities.m34dp(24.0f) : 0;
        ...
        int dp2 = !LocaleController.isRTL ? AndroidUtilities.m34dp(71.0f) : AndroidUtilities.m34dp(24.0f);
        ...
        int dp4 = !LocaleController.isRTL ? AndroidUtilities.m34dp(21.0f) : (i6 - this.imageView.getMeasuredWidth()) - AndroidUtilities.m34dp(21.0f);
    ...
    public void setText(String str, String str2, int i, int i2, boolean z) {
        ...
        this.imageView.setPadding(0, AndroidUtilities.m34dp(i2), 0, 0);
    ...
    protected void onDraw(Canvas canvas) {
        if (this.divider) {
            ...
            canvas.drawLine(AndroidUtilities.m34dp(71.0f), getMeasuredHeight() - 1, getMeasuredWidth(), getMeasuredHeight() - 1, this.dividerColor != null ? Theme.dividerExtraPaint : Theme.dividerPaint);
        }
    }
}
