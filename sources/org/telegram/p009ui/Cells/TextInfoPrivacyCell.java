...
public class TextInfoPrivacyCell extends FrameLayout {
    ...
    public TextInfoPrivacyCell(Context context, int i, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.textView.setPadding(0, AndroidUtilities.m34dp(10.0f), 0, AndroidUtilities.m34dp(17.0f));
    ...
    protected void onMeasure(int i, int i2) {
        if (this.fixedSize != 0) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m34dp(this.fixedSize), 1073741824));
        } else {
    ...
    public void setText(CharSequence charSequence) {
        if (!TextUtils.equals(charSequence, this.text)) {
            ...
            if (charSequence == null) {
                this.textView.setPadding(0, AndroidUtilities.m34dp(2.0f), 0, 0);
            } else {
                this.textView.setPadding(0, AndroidUtilities.m34dp(this.topPadding), 0, AndroidUtilities.m34dp(this.bottomPadding));
            }
