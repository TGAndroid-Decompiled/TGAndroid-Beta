...
public class PollEditTextCell extends FrameLayout {
    ...
    public PollEditTextCell(Context context, boolean z, View.OnClickListener onClickListener) {
        ...
        if (onClickListener != null) {
            ...
            this.moveImageView.setImageResource(C1010R.C1011drawable.poll_reorder);
            ...
            this.deleteImageView.setImageResource(C1010R.C1011drawable.poll_remove);
            ...
            this.deleteImageView.setContentDescription(LocaleController.getString("Delete", C1010R.string.Delete));
            ...
            this.checkBox.setContentDescription(LocaleController.getString("AccDescrQuizCorrectAnswer", C1010R.string.AccDescrQuizCorrectAnswer));
