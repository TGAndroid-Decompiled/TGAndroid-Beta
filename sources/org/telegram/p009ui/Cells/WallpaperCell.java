...
public class WallpaperCell extends FrameLayout {
            ...
            BackupImageView backupImageView = new BackupImageView(context, WallpaperCell.this) {
                ...
                public void onDraw(Canvas canvas) {
                    ...
                    if (WallpaperView.this.isSelected) {
                        ...
                        canvas.drawCircle(measuredWidth, measuredHeight, AndroidUtilities.m34dp(20.0f), WallpaperCell.this.circlePaint);
            ...
            if (obj instanceof TLRPC$TL_wallPaper) {
                ...
                if (tLRPC$TL_wallPaper.pattern) {
                    ...
                    if (tLRPC$PhotoSize != null) {
                        this.imageView.setImage(ImageLocation.getForDocument(tLRPC$PhotoSize, tLRPC$TL_wallPaper.document), "100_100", ImageLocation.getForDocument(closestPhotoSizeWithSize, tLRPC$TL_wallPaper.document), null, "jpg", i3, 1, tLRPC$TL_wallPaper);
                    } else {
                        this.imageView.setImage(ImageLocation.getForDocument(closestPhotoSizeWithSize, tLRPC$TL_wallPaper.document), "100_100", null, null, "jpg", i3, 1, tLRPC$TL_wallPaper);
                    }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        int dp = size - AndroidUtilities.m34dp(((this.spanCount - 1) * 6) + 28);
        int i3 = dp / this.spanCount;
        int dp2 = this.currentType == 0 ? AndroidUtilities.m34dp(180.0f) : i3;
        float f = 14.0f;
        int i4 = 0;
        int dp3 = (this.isTop ? AndroidUtilities.m34dp(14.0f) : 0) + dp2;
        if (!this.isBottom) {
            f = 6.0f;
        }
        setMeasuredDimension(size, dp3 + AndroidUtilities.m34dp(f));
        while (true) {
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        int dp2 = this.isTop ? AndroidUtilities.m34dp(14.0f) : 0;
        for (int i5 = 0; i5 < this.spanCount; i5++) {
            ...
            dp += measuredWidth + AndroidUtilities.m34dp(6.0f);
        }
    }
