...
public class PhotoPickerPhotoCell extends FrameLayout {
    ...
    public PhotoPickerPhotoCell(Context context) {
        ...
        backupImageView.setRoundRadius(AndroidUtilities.m34dp(4.0f));
        ...
        this.videoInfoContainer.setPadding(AndroidUtilities.m34dp(3.0f), 0, AndroidUtilities.m34dp(3.0f), 0);
        addView(this.videoInfoContainer, LayoutHelper.createFrame(-1, 16, 83));
        ImageView imageView = new ImageView(context);
        imageView.setImageResource(C0952R.C0953drawable.ic_video);
    ...
    public void setImage(MediaController.PhotoEntry photoEntry) {
        Drawable drawable = getResources().getDrawable(C0952R.C0953drawable.nophotos);
        ...
        if (str != null) {
            ...
            if (photoEntry.isVideo) {
                ...
                setContentDescription(LocaleController.getString("AttachVideo", C0952R.string.AttachVideo) + ", " + LocaleController.formatDuration(photoEntry.duration));
                BackupImageView backupImageView = this.imageView;
                backupImageView.setImage("vthumb://" + photoEntry.imageId + ":" + photoEntry.path, null, drawable);
                return;
            }
            this.videoInfoContainer.setVisibility(4);
            setContentDescription(LocaleController.getString("AttachPhoto", C0952R.string.AttachPhoto));
