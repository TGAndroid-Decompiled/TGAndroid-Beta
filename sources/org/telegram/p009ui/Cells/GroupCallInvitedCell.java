...
public class GroupCallInvitedCell extends FrameLayout {
    ...
    public GroupCallInvitedCell(Context context) {
        ...
        this.statusTextView.setText(LocaleController.getString("Invited", C0890R.string.Invited));
        ...
        this.muteButton.setImageResource(C0890R.C0891drawable.msg_invited);
        this.muteButton.setImportantForAccessibility(2);
        this.muteButton.setPadding(0, 0, AndroidUtilities.m34dp(4.0f), 0);
