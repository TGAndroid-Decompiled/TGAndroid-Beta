...
public class SendLocationCell extends FrameLayout {
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m34dp(66.0f), 1073741824));
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (sharingLocationInfo != null && (i = sharingLocationInfo.stopTime) >= (currentTime = ConnectionsManager.getInstance(this.currentAccount).getCurrentTime())) {
            ...
            if (LocaleController.isRTL) {
                this.rect.set(AndroidUtilities.m34dp(13.0f), AndroidUtilities.m34dp(18.0f), AndroidUtilities.m34dp(43.0f), AndroidUtilities.m34dp(48.0f));
            } else {
                this.rect.set(getMeasuredWidth() - AndroidUtilities.m34dp(43.0f), AndroidUtilities.m34dp(18.0f), getMeasuredWidth() - AndroidUtilities.m34dp(13.0f), AndroidUtilities.m34dp(48.0f));
            }
            ...
            canvas.drawText(formatLocationLeftTime, this.rect.centerX() - (Theme.chat_livePaint.measureText(formatLocationLeftTime) / 2.0f), AndroidUtilities.m34dp(37.0f), Theme.chat_livePaint);
        }
    }
