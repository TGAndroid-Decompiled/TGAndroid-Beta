...
public class AvailableReactionCell extends FrameLayout {
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec((int) (AndroidUtilities.m34dp(58.0f) + Theme.dividerPaint.getStrokeWidth()), 1073741824));
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int dp = AndroidUtilities.m34dp(81.0f);
        int i = 0;
