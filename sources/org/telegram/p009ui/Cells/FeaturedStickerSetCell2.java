...
public class FeaturedStickerSetCell2 extends FrameLayout {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (measuredWidth2 < measuredWidth) {
            layoutParams.rightMargin = AndroidUtilities.m34dp(14.0f) + ((measuredWidth - measuredWidth2) / 2);
        } else {
            layoutParams.rightMargin = AndroidUtilities.m34dp(14.0f);
        }
    ...
    protected void onDraw(Canvas canvas) {
        if (this.needDivider) {
            canvas.drawLine(LocaleController.isRTL ? 0.0f : AndroidUtilities.m34dp(71.0f), getHeight() - 1, getWidth() - (LocaleController.isRTL ? AndroidUtilities.m34dp(71.0f) : 0), getHeight() - 1, Theme.dividerPaint);
        }
    }
