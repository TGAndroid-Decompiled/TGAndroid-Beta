...
import org.telegram.p009ui.Components.ColorSpanUnderline;
...
public class FeaturedStickerSetInfoCell extends FrameLayout {
    ...
    public FeaturedStickerSetInfoCell(Context context, int i, boolean z, boolean z2, Theme.ResourcesProvider resourcesProvider) {
        ...
        if (z2) {
            ...
            this.delButton.setText(LocaleController.getString("StickersRemove", C0952R.string.StickersRemove));
            if (z) {
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m34dp(60.0f), 1073741824));
    ...
    public void setStickerSet(TLRPC$StickerSetCovered tLRPC$StickerSetCovered, boolean z, boolean z2, int i, int i2, boolean z3) {
        ...
        if (this.hasOnClick) {
            ...
            boolean z4 = z3 || MediaDataController.getInstance(this.currentAccount).isStickerPackInstalled(tLRPC$StickerSetCovered.set.f886id);
            this.isInstalled = z4;
            if (z2) {
                if (z4) {
        ...
        if (z || this.unreadProgress != 0.0f) {
            if (z) {
                ...
                if (f != 1.0f) {
                    ...
                    canvas.drawCircle(this.nameTextView.getRight() + AndroidUtilities.m34dp(12.0f), AndroidUtilities.m34dp(20.0f), AndroidUtilities.m34dp(4.0f) * this.unreadProgress, this.paint);
                }
            }
            if (!z) {
