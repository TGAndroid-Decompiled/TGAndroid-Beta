...
public class ManageChatUserCell extends FrameLayout {
    ...
    public ManageChatUserCell(Context context, int i, int i2, boolean z) {
        ...
        if (z) {
            ...
            this.optionsButton.setImageResource(C0952R.C0953drawable.ic_ab_other);
            ...
            this.optionsButton.setContentDescription(LocaleController.getString("AccDescrUserOptions", C0952R.string.AccDescrUserOptions));
        }
    }
    ...
    protected void onDraw(Canvas canvas) {
        if (this.needDivider) {
            ...
            canvas.drawLine(LocaleController.isRTL ? 0.0f : AndroidUtilities.m34dp(68.0f), getMeasuredHeight() - 1, getMeasuredWidth() - (LocaleController.isRTL ? AndroidUtilities.m34dp(68.0f) : 0), getMeasuredHeight() - 1, this.dividerColor != null ? Theme.dividerExtraPaint : Theme.dividerPaint);
        }
    }
}
