...
public class TextColorCell extends FrameLayout {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (i != 0) {
            ...
            canvas.drawCircle(LocaleController.isRTL ? AndroidUtilities.m34dp(33.0f) : getMeasuredWidth() - AndroidUtilities.m34dp(33.0f), getMeasuredHeight() / 2, AndroidUtilities.m34dp(10.0f), colorPaint);
        }
    }
}
