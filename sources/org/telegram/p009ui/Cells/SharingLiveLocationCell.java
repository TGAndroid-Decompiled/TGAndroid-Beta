...
public class SharingLiveLocationCell extends FrameLayout {
    ...
    public SharingLiveLocationCell(Context context, boolean z, int i, Theme.ResourcesProvider resourcesProvider) {
        ...
        backupImageView.setRoundRadius(AndroidUtilities.m34dp(21.0f));
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m34dp(this.distanceTextView != null ? 66.0f : 54.0f), 1073741824));
    }
    ...
    public void setDialog(MessageObject messageObject, Location location, boolean z) {
        ...
        if (!TextUtils.isEmpty(messageObject.messageOwner.media.title)) {
            ...
            CombinedDrawable combinedDrawable = new CombinedDrawable(Theme.createSimpleSelectorCircleDrawable(AndroidUtilities.m34dp(42.0f), themedColor, themedColor), drawable);
            combinedDrawable.setCustomSize(AndroidUtilities.m34dp(42.0f), AndroidUtilities.m34dp(42.0f));
            combinedDrawable.setIconSize(AndroidUtilities.m34dp(24.0f), AndroidUtilities.m34dp(24.0f));
        ...
        if (location != null) {
            ...
            this.distanceTextView.setText(LocaleController.getString("Loading", C0890R.string.Loading));
        } else {
    ...
    public void setDialog(LocationActivity.LiveLocation liveLocation, Location location) {
        ...
        if (DialogObject.isUserDialog(liveLocation.f1094id)) {
            TLRPC$User user = MessagesController.getInstance(this.currentAccount).getUser(Long.valueOf(liveLocation.f1094id));
            if (user != null) {
            ...
            TLRPC$Chat chat = MessagesController.getInstance(this.currentAccount).getChat(Long.valueOf(-liveLocation.f1094id));
            if (chat != null) {
        ...
        if (sharingLocationInfo != null || this.liveLocation != null) {
            ...
            if (i >= currentTime) {
                ...
                if (LocaleController.isRTL) {
                    ...
                    float dp = AndroidUtilities.m34dp(13.0f);
                    if (this.distanceTextView == null) {
                        f2 = 12.0f;
                    }
                    float dp2 = AndroidUtilities.m34dp(f2);
                    float dp3 = AndroidUtilities.m34dp(43.0f);
                    if (this.distanceTextView == null) {
                        f = 42.0f;
                    }
                    rectF.set(dp, dp2, dp3, AndroidUtilities.m34dp(f));
                } else {
                    RectF rectF2 = this.rect;
                    float measuredWidth = getMeasuredWidth() - AndroidUtilities.m34dp(43.0f);
                    if (this.distanceTextView == null) {
                        f2 = 12.0f;
                    }
                    float dp4 = AndroidUtilities.m34dp(f2);
                    float measuredWidth2 = getMeasuredWidth() - AndroidUtilities.m34dp(13.0f);
                    if (this.distanceTextView == null) {
                        f = 42.0f;
                    }
                    rectF2.set(measuredWidth, dp4, measuredWidth2, AndroidUtilities.m34dp(f));
                }
                if (this.distanceTextView == null) {
                ...
                canvas.drawText(formatLocationLeftTime, this.rect.centerX() - (Theme.chat_livePaint.measureText(formatLocationLeftTime) / 2.0f), AndroidUtilities.m34dp(this.distanceTextView != null ? 37.0f : 31.0f), Theme.chat_livePaint);
            }
        }
    }
