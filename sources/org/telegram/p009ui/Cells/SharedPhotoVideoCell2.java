...
public class SharedPhotoVideoCell2 extends View {
    ...
    public void drawCrossafadeImage(Canvas canvas) {
        if (this.crossfadeView != null) {
            ...
            this.crossfadeView.setImageScale(((getMeasuredWidth() - AndroidUtilities.m34dp(2.0f)) * this.imageScale) / (this.crossfadeView.getMeasuredWidth() - AndroidUtilities.m34dp(2.0f)), false);
    ...
    public void setChecked(final boolean z, boolean z2) {
        ...
        if ((checkBoxBase != null && checkBoxBase.isChecked()) != z) {
            if (this.checkBoxBase == null) {
                ...
                this.checkBoxBase.setBounds(0, 0, AndroidUtilities.m34dp(24.0f), AndroidUtilities.m34dp(24.0f));
                if (this.attached) {
    ...
    public static class SharedResources {
        ...
        public SharedResources(Context context) {
            ...
            Drawable drawable = ContextCompat.getDrawable(context, C0890R.C0891drawable.play_mini_video);
