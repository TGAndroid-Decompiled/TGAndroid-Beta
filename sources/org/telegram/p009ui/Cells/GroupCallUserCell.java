...
public class GroupCallUserCell extends FrameLayout {
    ...
    public void setProgressToAvatarPreview(float f) {
        ...
        this.nameTextView.setTranslationX((LocaleController.isRTL ? AndroidUtilities.m34dp(53.0f) : -AndroidUtilities.m34dp(53.0f)) * f);
        boolean z = true;
        if (!isSelfUser() || f <= 0.0f) {
            ...
            while (true) {
                ...
                if (TextUtils.isEmpty(simpleTextViewArr[4].getText()) || this.statusTextView[4].getLineCount() <= 1) {
                    this.statusTextView[i].setTranslationX((LocaleController.isRTL ? AndroidUtilities.m34dp(53.0f) : -AndroidUtilities.m34dp(53.0f)) * f);
                    this.statusTextView[i].setFullLayoutAdditionalWidth(0, 0);
                } else {
                    this.statusTextView[i].setFullLayoutAdditionalWidth(AndroidUtilities.m34dp(92.0f), LocaleController.isRTL ? AndroidUtilities.m34dp(48.0f) : AndroidUtilities.m34dp(53.0f));
            ...
            float f2 = 1.0f - f;
            this.fullAboutTextView.setTranslationX((LocaleController.isRTL ? -AndroidUtilities.m34dp(53.0f) : AndroidUtilities.m34dp(53.0f)) * f2);
            ...
            int dp = AndroidUtilities.m34dp(53.0f);
            if (!z2) {
                dp = -dp;
            }
    ...
    public static class VerifiedDrawable extends Drawable {
        ...
        public VerifiedDrawable(Context context) {
            ...
            drawableArr[0] = context.getResources().getDrawable(C0890R.C0891drawable.verified_area).mutate();
            this.drawables[0].setColorFilter(new PorterDuffColorFilter(-9063442, PorterDuff.Mode.MULTIPLY));
            this.drawables[1] = context.getResources().getDrawable(C0890R.C0891drawable.verified_check).mutate();
        }
    ...
    public GroupCallUserCell(Context context) {
        ...
        this.nameTextView.setDrawablePadding(AndroidUtilities.m34dp(6.0f));
        ...
        Drawable drawable = context.getResources().getDrawable(C0890R.C0891drawable.voice_volume_mini);
        ...
        while (true) {
            ...
            if (i2 == 4) {
                ...
                if (i2 == 0) {
                    ...
                    this.statusTextView[i2].setText(LocaleController.getString("Listening", C0890R.string.Listening));
                } else if (i2 == 1) {
                    this.statusTextView[i2].setTextColor(Theme.getColor("voipgroup_speakingText"));
                    this.statusTextView[i2].setText(LocaleController.getString("Speaking", C0890R.string.Speaking));
                    this.statusTextView[i2].setDrawablePadding(AndroidUtilities.m34dp(2.0f));
                } else if (i2 == 2) {
                    this.statusTextView[i2].setTextColor(Theme.getColor("voipgroup_mutedByAdminIcon"));
                    this.statusTextView[i2].setText(LocaleController.getString("VoipGroupMutedForMe", C0890R.string.VoipGroupMutedForMe));
                } else if (i2 == 3) {
                    this.statusTextView[i2].setTextColor(Theme.getColor("voipgroup_listeningText"));
                    this.statusTextView[i2].setText(LocaleController.getString("WantsToSpeak", C0890R.string.WantsToSpeak));
                }
        ...
        this.muteDrawable = new RLottieDrawable(C0890R.raw.voice_outlined2, "2131558559", AndroidUtilities.m34dp(34.0f), AndroidUtilities.m34dp(32.0f), true, null);
        this.shakeHandDrawable = new RLottieDrawable(C0890R.raw.hand_1, "2131558455", AndroidUtilities.m34dp(34.0f), AndroidUtilities.m34dp(32.0f), true, null);
        ...
        this.avatarWavesDrawable = new AvatarWavesDrawable(AndroidUtilities.m34dp(26.0f), AndroidUtilities.m34dp(29.0f));
    ...
    public int getClipHeight() {
        ...
        return simpleTextView.getTop() + simpleTextView.getTextHeight() + AndroidUtilities.m34dp(8.0f);
    }
    ...
    public boolean isSelfUser() {
        ...
        if (j > 0) {
            ...
            return tLRPC$User != null && tLRPC$User.f974id == j;
        }
        TLRPC$Chat tLRPC$Chat = this.currentChat;
        return tLRPC$Chat != null && tLRPC$Chat.f843id == (-j);
    }
    ...
    public void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m34dp(58.0f), 1073741824));
    }
    ...
    private void applyParticipantChanges(boolean r21, boolean r22) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p009ui.Cells.GroupCallUserCell.applyParticipantChanges(boolean, boolean):void");
    }
    ...
    public void applyStatus(int i) {
        ...
        if (i == 0) {
            while (true) {
                SimpleTextView[] simpleTextViewArr = this.statusTextView;
                if (i2 < simpleTextViewArr.length) {
                    simpleTextViewArr[i2].setTranslationY(i2 == i ? 0.0f : AndroidUtilities.m34dp(-2.0f));
            ...
            while (true) {
                ...
                if (i2 < simpleTextViewArr2.length) {
                    ...
                    if (i2 == i) {
                        ...
                        f = AndroidUtilities.m34dp(i2 == 0 ? 2.0f : -2.0f);
                    }
    ...
    protected void dispatchDraw(Canvas canvas) {
        if (this.needDivider) {
            ...
            canvas.drawLine(LocaleController.isRTL ? 0.0f : AndroidUtilities.m34dp(68.0f), getMeasuredHeight() - 1, getMeasuredWidth() - (LocaleController.isRTL ? AndroidUtilities.m34dp(68.0f) : 0), getMeasuredHeight() - 1, this.dividerPaint);
        }
    ...
    public static class AvatarWavesDrawable {
        ...
        public void draw(android.graphics.Canvas r8, float r9, float r10, android.view.View r11) {
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p009ui.Cells.GroupCallUserCell.AvatarWavesDrawable.draw(android.graphics.Canvas, float, float, android.view.View):void");
        }
