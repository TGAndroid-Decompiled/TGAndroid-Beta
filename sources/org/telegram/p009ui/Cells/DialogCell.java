...
public class DialogCell extends BaseCell {
    ...
    public DialogCell(DialogsActivity dialogsActivity, Context context, boolean z, boolean z2, int i, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.thumbImage.setRoundRadius(AndroidUtilities.m34dp(2.0f));
    ...
    protected void onMeasure(int i, int i2) {
        ...
        setMeasuredDimension(View.MeasureSpec.getSize(i), AndroidUtilities.m34dp((this.useForceThreeLines || SharedConfig.useThreeLinesLayout) ? 78.0f : 72.0f) + (this.useSeparator ? 1 : 0));
        this.topClip = 0;
        ...
        if (this.currentDialogId != 0 || this.customDialog != null) {
            if (this.checkBox != null) {
                ...
                if (LocaleController.isRTL) {
                    ...
                    i5 = i6 - AndroidUtilities.m34dp(f);
                } else {
                    if (this.useForceThreeLines || SharedConfig.useThreeLinesLayout) {
                        f = 43.0f;
                    }
                ...
                int dp = AndroidUtilities.m34dp((this.useForceThreeLines || SharedConfig.useThreeLinesLayout) ? 48.0f : 42.0f);
                CheckBox2 checkBox2 = this.checkBox;
    ...
    private CharSequence formatArchivedDialogNames() {
        ...
        return Emoji.replaceEmoji(spannableStringBuilder, Theme.dialogs_messagePaint[this.paintIndex].getFontMetricsInt(), AndroidUtilities.m34dp(17.0f), false);
    }
            ...
            if (z) {
                ...
                if (z2) {
                    ...
                    if (z4) {
                        canvas.restore();
                        canvas.save();
                        canvas.translate(AndroidUtilities.m34dp(4.0f) * (1.0f - f), 0.0f);
                    }
    ...
    public boolean isPointInsideAvatar(float f, float f2) {
        return !LocaleController.isRTL ? f >= 0.0f && f < ((float) AndroidUtilities.m34dp(60.0f)) : f >= ((float) (getMeasuredWidth() - AndroidUtilities.m34dp(60.0f))) && f < ((float) getMeasuredWidth());
    }
    ...
    public void update(int r24, boolean r25) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p009ui.Cells.DialogCell.update(int, boolean):void");
    }
