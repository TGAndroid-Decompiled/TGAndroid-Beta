...
import org.telegram.p009ui.Cells.TextSelectionHelper.SelectableView;
import org.telegram.p009ui.Components.LayoutHelper;
import org.telegram.p009ui.Components.RecyclerListView;
import org.telegram.p009ui.RestrictedLanguagesSelectActivity;
...
public abstract class TextSelectionHelper<Cell extends SelectableView> {
        ...
        public void run() {
            ...
            if (cell != null && textSelectionHelper.textSelectionOverlay != null) {
                ...
                if (charOffsetFromCord >= text.length()) {
                    ...
                    if (f < textSelectionHelper6.layoutBlock.layout.getLineRight(lineCount) + AndroidUtilities.m34dp(4.0f) && f > TextSelectionHelper.this.layoutBlock.layout.getLineLeft(lineCount)) {
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        this.tryCapture = false;
        this.textArea.inset(-AndroidUtilities.m34dp(8.0f), -AndroidUtilities.m34dp(8.0f));
        if (this.textArea.contains(this.capturedX, this.capturedY)) {
            ...
            if (charOffsetFromCord >= text.length()) {
                ...
                if (f < this.layoutBlock.layout.getLineRight(lineCount) + AndroidUtilities.m34dp(4.0f) && f > this.layoutBlock.layout.getLineLeft(lineCount)) {
                    charOffsetFromCord = text.length() - 1;
                }
            }
            if (charOffsetFromCord >= 0 && charOffsetFromCord < text.length() && text.charAt(charOffsetFromCord) != '\n') {
    ...
    public void showMagnifier(int i) {
        ...
        if (Build.VERSION.SDK_INT >= 28 && this.selectedView != null && !this.isOneTouch && this.movingHandle && this.textSelectionOverlay != null) {
            ...
            if (staticLayout != null) {
                ...
                int lineTop = (int) (((((int) ((staticLayout.getLineTop(lineForOffset) + this.textY) + this.selectedView.getY())) - lineBottom) - AndroidUtilities.m34dp(8.0f)) + this.layoutBlock.yOffset);
                ...
                this.magnifier.show(this.magnifierXanimated, this.magnifierYanimated + (lineBottom * 1.5f) + AndroidUtilities.m34dp(8.0f));
        ...
        if (this.textSelectionOverlay != null) {
            if (Build.VERSION.SDK_INT >= 23) {
                ...
                if (this.popupLayout == null) {
                    ...
                    this.popupLayout.setBackgroundDrawable(this.textSelectionOverlay.getContext().getResources().getDrawable(C0952R.C0953drawable.menu_copy));
                ...
                if (this.selectedView == null || (i = (((int) ((offsetToCord(this.selectionStart)[1] + this.textY) + this.selectedView.getY())) + ((-getLineHeight()) / 2)) - AndroidUtilities.m34dp(4.0f)) < 0) {
                    i = 0;
                }
                this.popupWindow.showAtLocation(this.textSelectionOverlay, 48, 0, i - AndroidUtilities.m34dp(48.0f));
    ...
    public class TextSelectionOverlay extends View {
        ...
        public boolean onTouchEvent(android.view.MotionEvent r22) {
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p009ui.Cells.TextSelectionHelper.TextSelectionOverlay.onTouchEvent(android.view.MotionEvent):boolean");
        }
                    ...
                    if (i3 >= 0 && i3 <= length) {
                        ...
                        if (staticLayout != null) {
                            ...
                            if (f3 <= textSelectionHelper4.keyboardSize + i2 || f3 >= textSelectionHelper4.parentView.getMeasuredHeight()) {
                                ...
                                TextSelectionHelper.this.endArea.inset(-AndroidUtilities.m34dp(8.0f), -AndroidUtilities.m34dp(8.0f));
                                i = 1;
                                canvas.restore();
                            } else {
                                canvas.save();
                    ...
                    if (i5 >= 0 && i5 <= length3) {
                        ...
                        if (staticLayout2 != null) {
                            ...
                            if (f12 <= i2 + textSelectionHelper2.keyboardSize || f12 >= textSelectionHelper2.parentView.getMeasuredHeight()) {
                                ...
                                TextSelectionHelper.this.startArea.inset(-AndroidUtilities.m34dp(8.0f), -AndroidUtilities.m34dp(8.0f));
                                i++;
                            } else {
                                canvas.save();
    ...
    public class ActionMode$CallbackC12814 implements ActionMode.Callback {
        private String translateFromLanguage = null;

        ActionMode$CallbackC12814() {
        }
        ...
        public boolean onCreateActionMode(ActionMode actionMode, Menu menu) {
            ...
            menu.add(0, 3, 2, LocaleController.getString("TranslateMessage", C0952R.string.TranslateMessage));
            return true;
        }
            ...
            if (TextSelectionHelper.this.onTranslateListener == null || !LanguageDetector.hasSupport() || TextSelectionHelper.this.getSelectedText() == null) {
                ...
                LanguageDetector.detectLanguage(TextSelectionHelper.this.getSelectedText().toString(), new LanguageDetector.StringCallback() {
                    ...
                    public final void run(String str) {
                        TextSelectionHelper.ActionMode$CallbackC12814.this.lambda$onPrepareActionMode$0(menu, str);
                    }
                }, new LanguageDetector.ExceptionCallback() {
                    @Override
                    public final void run(Exception exc) {
                        TextSelectionHelper.ActionMode$CallbackC12814.this.lambda$onPrepareActionMode$1(menu, exc);
                    }
                });
            }
            return true;
        ...
        public void lambda$onPrepareActionMode$1(Menu menu, Exception exc) {
            FileLog.m32e("mlkit: failed to detect language in selection");
            FileLog.m30e(exc);
            this.translateFromLanguage = null;
            updateTranslateButton(menu);
        }
                ...
                if (TextSelectionHelper.this.onTranslateListener != null) {
                    TextSelectionHelper.this.onTranslateListener.run(TextSelectionHelper.this.getSelectedText(), this.translateFromLanguage, LocaleController.getInstance().getCurrentLocale().getLanguage(), new Runnable() {
                        ...
                        public final void run() {
                            TextSelectionHelper.ActionMode$CallbackC12814.this.lambda$onActionItemClicked$2();
                        }
                    });
                }
                TextSelectionHelper.this.hideActions();
    ...
    private ActionMode.Callback createActionCallback() {
        final ActionMode$CallbackC12814 r0 = new ActionMode$CallbackC12814();
            ...
            public void onGetContentRect(ActionMode actionMode, View view, Rect rect) {
                ...
                if (TextSelectionHelper.this.isSelectionMode()) {
                    ...
                    if (textSelectionHelper.selectedView != null) {
                        ...
                        int y = (((int) ((offsetToCord[1] + textSelectionHelper3.textY) + textSelectionHelper3.selectedView.getY())) + ((-textSelectionHelper.getLineHeight()) / 2)) - AndroidUtilities.m34dp(4.0f);
                        if (y >= 1) {
                            i2 = y;
                        }
                    } else {
    ...
    public static class ChatListTextSelectionHelper extends TextSelectionHelper<ChatMessageCell> {
        ...
        public void draw(org.telegram.messenger.MessageObject r12, org.telegram.messenger.MessageObject.TextLayoutBlock r13, android.graphics.Canvas r14) {
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p009ui.Cells.TextSelectionHelper.ChatListTextSelectionHelper.draw(org.telegram.messenger.MessageObject, org.telegram.messenger.MessageObject$TextLayoutBlock, android.graphics.Canvas):void");
        }
    ...
    public static class ArticleTextSelectionHelper extends TextSelectionHelper<ArticleSelectableView> {
        ...
        private int findClosestLayoutIndex(int i, int i2, ArticleSelectableView articleSelectableView) {
            ...
            if (row > 0 && i3 < AndroidUtilities.m34dp(24.0f)) {
