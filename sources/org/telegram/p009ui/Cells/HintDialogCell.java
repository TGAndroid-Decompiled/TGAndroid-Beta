...
public class HintDialogCell extends FrameLayout {
    ...
    public HintDialogCell(Context context, boolean z) {
        ...
        backupImageView.setRoundRadius(AndroidUtilities.m34dp(27.0f));
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m34dp(86.0f), 1073741824));
        this.counterView.counterDrawable.horizontalPadding = AndroidUtilities.m34dp(13.0f);
    }

    public void update(int i) {
        int i2;
        if (!((MessagesController.UPDATE_MASK_STATUS & i) == 0 || this.currentUser == null)) {
            this.currentUser = MessagesController.getInstance(this.currentAccount).getUser(Long.valueOf(this.currentUser.f974id));
    ...
    protected void onDraw(Canvas canvas) {
        if (this.drawCheckbox) {
            ...
            canvas.drawCircle(left, top, AndroidUtilities.m34dp(28.0f), Theme.checkboxSquare_checkPaint);
        }
    }
