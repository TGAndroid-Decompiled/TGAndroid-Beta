...
public class TextSettingsCell extends FrameLayout {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (this.valueTextView.getVisibility() == 0) {
            ...
            measuredWidth = (measuredWidth - this.valueTextView.getMeasuredWidth()) - AndroidUtilities.m34dp(8.0f);
        }
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (this.drawLoading || this.drawLoadingProgress != 0.0f) {
            ...
            rectF.set((getMeasuredWidth() - AndroidUtilities.m34dp(this.padding)) - AndroidUtilities.m34dp(this.loadingSize), measuredHeight - AndroidUtilities.m34dp(3.0f), getMeasuredWidth() - AndroidUtilities.m34dp(this.padding), measuredHeight + AndroidUtilities.m34dp(3.0f));
            if (LocaleController.isRTL) {
                rectF.left = getMeasuredWidth() - rectF.left;
                rectF.right = getMeasuredWidth() - rectF.right;
            }
            canvas.drawRoundRect(rectF, AndroidUtilities.m34dp(3.0f), AndroidUtilities.m34dp(3.0f), this.paint);
            invalidate();
        }
        this.valueTextView.setAlpha(1.0f - this.drawLoadingProgress);
        super.dispatchDraw(canvas);
        if (this.needDivider) {
            float dp = LocaleController.isRTL ? 0.0f : AndroidUtilities.m34dp(20.0f);
            float measuredHeight2 = getMeasuredHeight() - 1;
            int measuredWidth = getMeasuredWidth();
            if (LocaleController.isRTL) {
                i = AndroidUtilities.m34dp(20.0f);
            }
