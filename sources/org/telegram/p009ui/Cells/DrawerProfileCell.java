...
public class DrawerProfileCell extends FrameLayout {
    ...
    public DrawerProfileCell(Context context, final DrawerLayoutContainer drawerLayoutContainer) {
        ...
        backupImageView.getImageReceiver().setRoundRadius(AndroidUtilities.m34dp(32.0f));
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            rLottieImageView2.setBackgroundDrawable(Theme.createSelectorDrawable(color2, 1, AndroidUtilities.m34dp(17.0f)));
    ...
    public void lambda$new$0(android.view.View r7) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p009ui.Cells.DrawerProfileCell.lambda$new$0(android.view.View):void");
    }
    ...
    protected void onMeasure(int i, int i2) {
        if (Build.VERSION.SDK_INT >= 21) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m34dp(148.0f) + AndroidUtilities.statusBarHeight, 1073741824));
            return;
        }
        try {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m34dp(148.0f), 1073741824));
        } catch (Exception e) {
            setMeasuredDimension(View.MeasureSpec.getSize(i), AndroidUtilities.m34dp(148.0f));
            FileLog.m30e(e);
        }
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (i2 != 0) {
            ...
            if (z2 && (cachedWallpaper instanceof BitmapDrawable)) {
                canvas.drawCircle(this.darkThemeView.getX() + (this.darkThemeView.getMeasuredWidth() / 2), this.darkThemeView.getY() + (this.darkThemeView.getMeasuredHeight() / 2), AndroidUtilities.m34dp(17.0f), this.backPaint);
            }
        }
