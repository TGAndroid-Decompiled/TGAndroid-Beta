...
public class PaymentInfoCell extends FrameLayout {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (this.imageView.getVisibility() != 8) {
            i3 = View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m34dp(120.0f), 1073741824);
        } else {
            int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(0, 0);
            measureChildWithMargins(this.detailTextView, i, 0, i2, 0);
            ((FrameLayout.LayoutParams) this.detailExTextView.getLayoutParams()).topMargin = AndroidUtilities.m34dp(33.0f) + this.detailTextView.getMeasuredHeight() + AndroidUtilities.m34dp(3.0f);
            i3 = makeMeasureSpec;
        }
    ...
    public void setInvoice(TLRPC$TL_messageMediaInvoice tLRPC$TL_messageMediaInvoice, String str) {
        ...
        float f = 640;
        float dp = f / (((int) (i * 0.7f)) - AndroidUtilities.m34dp(2.0f));
        int i2 = (int) (f / dp);
        int i3 = (int) (360 / dp);
