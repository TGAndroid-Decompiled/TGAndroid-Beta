...
public class PhotoAttachCameraCell extends FrameLayout {
    ...
    private int itemSize = AndroidUtilities.m34dp(0.0f);
    ...
    public PhotoAttachCameraCell(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.imageView.setImageResource(C0890R.C0891drawable.instant_camera);
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(this.itemSize + AndroidUtilities.m34dp(5.0f), 1073741824), View.MeasureSpec.makeMeasureSpec(this.itemSize + AndroidUtilities.m34dp(5.0f), 1073741824));
    }
    ...
    public void updateBitmap() {
        ...
        if (bitmap != null) {
            ...
            this.backgroundView.setImageResource(C0890R.C0891drawable.icplaceholder);
        }
    }
