...
public class SharedLinkCell extends FrameLayout {
    ...
    public SharedLinkCell(Context context, int i) {
        ...
        this.titleY = AndroidUtilities.m34dp(10.0f);
        this.descriptionY = AndroidUtilities.m34dp(30.0f);
        this.patchedDescriptionLayout = new AtomicReference<>();
        this.description2Y = AndroidUtilities.m34dp(30.0f);
        this.patchedDescriptionLayout2 = new AtomicReference<>();
        this.captionY = AndroidUtilities.m34dp(30.0f);
        this.fromInfoLayoutY = AndroidUtilities.m34dp(30.0f);
        this.viewType = i;
        setFocusable(true);
        ...
        this.titleTextPaint.setTextSize(AndroidUtilities.m34dp(14.0f));
        this.descriptionTextPaint.setTextSize(AndroidUtilities.m34dp(14.0f));
        setWillNotDraw(false);
        ImageReceiver imageReceiver = new ImageReceiver(this);
        this.linkImageView = imageReceiver;
        imageReceiver.setRoundRadius(AndroidUtilities.m34dp(4.0f));
        ...
        textPaint3.setTextSize(AndroidUtilities.m34dp(13.0f));
    }

    @Override
    @android.annotation.SuppressLint({"DrawAllocation"})
    protected void onMeasure(int r27, int r28) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p009ui.Cells.SharedLinkCell.onMeasure(int, int):void");
    }
    ...
    public boolean onTouchEvent(android.view.MotionEvent r15) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p009ui.Cells.SharedLinkCell.onTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.titleLayout != null) {
            canvas.save();
            float dp = AndroidUtilities.m34dp(LocaleController.isRTL ? 8.0f : AndroidUtilities.leftBaseline);
            if (LocaleController.isRTL) {
                dp += this.dateLayout == null ? 0.0f : staticLayout.getWidth() + AndroidUtilities.m34dp(4.0f);
            }
        ...
        if (this.descriptionLayout != null) {
            ...
            SpoilerEffect.renderWithRipple(this, false, this.descriptionTextPaint.getColor(), -AndroidUtilities.m34dp(2.0f), this.patchedDescriptionLayout, this.descriptionLayout, this.descriptionLayoutSpoilers, canvas);
            canvas.restore();
        }
        if (this.descriptionLayout2 != null) {
            this.descriptionTextPaint.setColor(Theme.getColor("windowBackgroundWhiteBlackText"));
            canvas.save();
            canvas.translate(AndroidUtilities.m34dp(LocaleController.isRTL ? 8.0f : AndroidUtilities.leftBaseline), this.description2Y);
            SpoilerEffect.renderWithRipple(this, false, this.descriptionTextPaint.getColor(), -AndroidUtilities.m34dp(2.0f), this.patchedDescriptionLayout2, this.descriptionLayout2, this.descriptionLayout2Spoilers, canvas);
            canvas.restore();
        }
        if (!this.linkLayout.isEmpty()) {
            ...
            for (int i2 = 0; i2 < this.linkLayout.size(); i2++) {
                ...
                if (staticLayout2.getLineCount() > 0) {
                    canvas.save();
                    canvas.translate(AndroidUtilities.m34dp(LocaleController.isRTL ? 8.0f : AndroidUtilities.leftBaseline), this.linkY + i);
                    this.path.rewind();
                    if (list != null) {
        ...
        if (this.fromInfoLayout != null) {
            ...
            canvas.translate(AndroidUtilities.m34dp(f), this.fromInfoLayoutY);
