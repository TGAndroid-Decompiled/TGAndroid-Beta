...
public class DrawerActionCell extends FrameLayout {
    ...
    public DrawerActionCell(Context context) {
        ...
        this.textView.setCompoundDrawablePadding(AndroidUtilities.m34dp(29.0f));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.currentId == 8) {
            ...
            if (set.contains("VALIDATE_PHONE_NUMBER") || set.contains("VALIDATE_PASSWORD")) {
                int dp2 = AndroidUtilities.m34dp(12.5f);
                this.rect.set(((getMeasuredWidth() - AndroidUtilities.m34dp(9.0f)) - AndroidUtilities.m34dp(25.0f)) - AndroidUtilities.m34dp(5.5f), dp2, measuredWidth + dp + AndroidUtilities.m34dp(14.0f), dp2 + AndroidUtilities.m34dp(23.0f));
