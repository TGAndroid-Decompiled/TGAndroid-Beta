    ...
    public View createView(Context context) {
        ...
        SizeNotifierFrameLayout sizeNotifierFrameLayout = new SizeNotifierFrameLayout(context) {
            ...
            protected void onMeasure(int i, int i2) {
                ...
                for (int i3 = 0; i3 < PhotoPickerSearchActivity.this.viewPages.length; i3++) {
                    if (!(PhotoPickerSearchActivity.this.viewPages[i3] == null || PhotoPickerSearchActivity.this.viewPages[i3].listView == null)) {
                        PhotoPickerSearchActivity.this.viewPages[i3].listView.setPadding(AndroidUtilities.m34dp(4.0f), AndroidUtilities.m34dp(4.0f) + measuredHeight, AndroidUtilities.m34dp(4.0f), AndroidUtilities.m34dp(4.0f));
                    }
                }
                this.globalIgnoreLayout = false;
            ...
            public void onLayout(boolean r11, int r12, int r13, int r14, int r15) {
                throw new UnsupportedOperationException("Method not decompiled: org.telegram.p009ui.PhotoPickerSearchActivity.C32784.onLayout(boolean, int, int, int, int):void");
            }
            ...
            public boolean checkTabsAnimationInProgress() {
                throw new UnsupportedOperationException("Method not decompiled: org.telegram.p009ui.PhotoPickerSearchActivity.C32784.checkTabsAnimationInProgress():boolean");
            }
                    ...
                    if (this.startedTracking) {
                        ...
                        PhotoPickerSearchActivity.this.tabsAnimation.addListener(new AnimatorListenerAdapter() {
                            ...
                            public void onAnimationEnd(Animator animator) {
                                ...
                                C32784.this.maybeStartTracking = false;
                                C32784.this.startedTracking = false;
