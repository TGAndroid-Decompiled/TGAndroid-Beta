    ...
    public View createView(Context context) {
        ...
        SizeNotifierFrameLayout sizeNotifierFrameLayout = new SizeNotifierFrameLayout(context) {
            ...
            public void onLayout(boolean r11, int r12, int r13, int r14, int r15) {
                throw new UnsupportedOperationException("Method not decompiled: org.telegram.p009ui.PhotoPickerSearchActivity.C37614.onLayout(boolean, int, int, int, int):void");
            }
                    ...
                    if (this.startedTracking) {
                        ...
                        PhotoPickerSearchActivity.this.tabsAnimation.addListener(new AnimatorListenerAdapter() {
                            ...
                            public void onAnimationEnd(Animator animator) {
                                ...
                                PhotoPickerSearchActivity.this.tabsAnimationInProgress = false;
                                C37614.this.maybeStartTracking = false;
                                C37614.this.startedTracking = false;
