...
public class ChatPullingDownDrawable implements NotificationCenter.NotificationCenterDelegate {
    ...
    public ChatPullingDownDrawable(int i, View view, long j, int i2, int i3, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.textPaint2.setTextSize(AndroidUtilities.m34dp(14.0f));
    ...
    public void updateDialog() {
        ...
        if (nextUnreadDialog != null) {
            this.nextDialogId = nextUnreadDialog.f860id;
            int[] iArr = this.params;
            this.drawFolderBackground = iArr[0] == 1;
            this.dialogFolderId = iArr[1];
            this.dialogFilterId = iArr[2];
            this.emptyStub = false;
            TLRPC$Chat chat = MessagesController.getInstance(this.currentAccount).getChat(Long.valueOf(-nextUnreadDialog.f860id));
            this.nextChat = chat;
            if (chat == null) {
                MessagesController.getInstance(this.currentAccount).getChat(Long.valueOf(nextUnreadDialog.f860id));
            }
            ...
            MessagesController.getInstance(this.currentAccount).ensureMessagesLoaded(nextUnreadDialog.f860id, 0, null);
    ...
    public void setWidth(int i) {
        ...
        int i2;
        if (i != this.lastWidth) {
            this.circleRadius = AndroidUtilities.m34dp(56.0f) / 2.0f;
            this.lastWidth = i;
            TLRPC$Chat tLRPC$Chat = this.nextChat;
            String string = tLRPC$Chat != null ? tLRPC$Chat.title : LocaleController.getString("SwipeToGoNextChannelEnd", C0952R.string.SwipeToGoNextChannelEnd);
            int measureText = (int) this.textPaint.measureText(string);
            this.chatNameWidth = measureText;
            this.chatNameWidth = Math.min(measureText, this.lastWidth - AndroidUtilities.m34dp(60.0f));
            ...
            if (z && (i2 = this.dialogFolderId) != this.folderId && i2 != 0) {
                str2 = LocaleController.getString("SwipeToGoNextArchive", C0952R.string.SwipeToGoNextArchive);
                str = LocaleController.getString("ReleaseToGoNextArchive", C0952R.string.ReleaseToGoNextArchive);
            } else if (z) {
                str2 = LocaleController.getString("SwipeToGoNextFolder", C0952R.string.SwipeToGoNextFolder);
                str = LocaleController.getString("ReleaseToGoNextFolder", C0952R.string.ReleaseToGoNextFolder);
            } else {
                str2 = LocaleController.getString("SwipeToGoNextChannel", C0952R.string.SwipeToGoNextChannel);
                str = LocaleController.getString("ReleaseToGoNextChannel", C0952R.string.ReleaseToGoNextChannel);
            }
            String str3 = str2;
            String str4 = str;
            int measureText2 = (int) this.textPaint2.measureText(str3);
            this.layout1Width = measureText2;
            this.layout1Width = Math.min(measureText2, this.lastWidth - AndroidUtilities.m34dp(60.0f));
            ...
            this.layout2Width = Math.min(measureText3, this.lastWidth - AndroidUtilities.m34dp(60.0f));
            this.layout2 = new StaticLayout(str4, this.textPaint2, this.layout2Width, Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
            this.imageReceiver.setImageCoords((this.lastWidth / 2.0f) - (AndroidUtilities.m34dp(40.0f) / 2.0f), (AndroidUtilities.m34dp(12.0f) + this.circleRadius) - (AndroidUtilities.m34dp(40.0f) / 2.0f), AndroidUtilities.m34dp(40.0f), AndroidUtilities.m34dp(40.0f));
            this.imageReceiver.setRoundRadius((int) (AndroidUtilities.m34dp(40.0f) / 2.0f));
            this.counterDrawable.setSize(AndroidUtilities.m34dp(28.0f), AndroidUtilities.m34dp(100.0f));
        }
    }
    ...
    public void draw(Canvas canvas, View view, float f, float f2) {
        ...
        float dp = AndroidUtilities.m34dp(110.0f) * f;
        if (dp >= AndroidUtilities.m34dp(8.0f)) {
            ...
            float f7 = this.bounceProgress * (-AndroidUtilities.m34dp(4.0f));
            if (this.emptyStub) {
                dp -= f7;
            }
            float f8 = dp / 2.0f;
            float max = Math.max(0.0f, Math.min(this.circleRadius, (f8 - (AndroidUtilities.m34dp(16.0f) * f)) - AndroidUtilities.m34dp(4.0f)));
            float max2 = ((Math.max(0.0f, Math.min(this.circleRadius * f, f8 - (AndroidUtilities.m34dp(8.0f) * f))) * 2.0f) - AndroidUtilities.dp2(16.0f)) * (1.0f - this.swipeToReleaseProgress);
            float f9 = this.swipeToReleaseProgress;
            float dp2 = max2 + (AndroidUtilities.m34dp(56.0f) * f9);
            if (f9 < 1.0f || this.emptyStub) {
                float f10 = -dp;
                i2 = alpha3;
                i3 = alpha2;
                float dp3 = ((-AndroidUtilities.m34dp(8.0f)) * (1.0f - this.swipeToReleaseProgress)) + ((AndroidUtilities.m34dp(56.0f) + f10) * this.swipeToReleaseProgress);
                RectF rectF = AndroidUtilities.rectTmp;
                rectF.set(f6 - max, f10, max + f6, dp3);
                if (this.swipeToReleaseProgress > 0.0f && !this.emptyStub) {
                    float dp4 = AndroidUtilities.m34dp(16.0f) * this.swipeToReleaseProgress;
                    rectF.inset(dp4, dp4);
                }
                drawBackground(canvas, rectF);
                float dp5 = ((AndroidUtilities.m34dp(24.0f) + f10) + (AndroidUtilities.m34dp(8.0f) * (1.0f - f))) - (AndroidUtilities.m34dp(36.0f) * this.swipeToReleaseProgress);
                canvas.save();
                f3 = dp;
                ...
                drawArrow(canvas, f6, dp5, AndroidUtilities.m34dp(24.0f) * f);
                if (this.emptyStub) {
                    float dp22 = ((((-AndroidUtilities.m34dp(8.0f)) - (AndroidUtilities.dp2(8.0f) * f)) - dp2) * (1.0f - this.swipeToReleaseProgress)) + ((f10 - AndroidUtilities.m34dp(2.0f)) * this.swipeToReleaseProgress) + f7;
                    this.arrowPaint.setAlpha(alpha4);
                    canvas.save();
                    canvas.scale(f, f, f6, AndroidUtilities.m34dp(28.0f) + dp22);
                    drawCheck(canvas, f6, dp22 + AndroidUtilities.m34dp(28.0f));
                    canvas.restore();
                }
                canvas.restore();
            } else {
            ...
            if (this.chatNameLayout != null && this.swipeToReleaseProgress > 0.0f) {
                getThemedPaint("paintChatActionBackground").setAlpha(i4);
                this.textPaint.setAlpha(i5);
                float dp6 = ((AndroidUtilities.m34dp(20.0f) * (1.0f - this.swipeToReleaseProgress)) - (AndroidUtilities.m34dp(36.0f) * this.swipeToReleaseProgress)) + f7;
                ...
                rectF2.inset(-AndroidUtilities.m34dp(8.0f), -AndroidUtilities.m34dp(4.0f));
                canvas.drawRoundRect(rectF2, AndroidUtilities.m34dp(15.0f), AndroidUtilities.m34dp(15.0f), getThemedPaint("paintChatActionBackground"));
                if (hasGradientService()) {
                    canvas.drawRoundRect(rectF2, AndroidUtilities.m34dp(15.0f), AndroidUtilities.m34dp(15.0f), Theme.chat_actionBackgroundGradientDarkenPaint);
                }
                canvas.save();
            ...
            if (this.emptyStub || dp2 <= 0.0f) {
                ...
                float dp23 = ((((-AndroidUtilities.m34dp(8.0f)) - (AndroidUtilities.dp2(8.0f) * f)) - dp2) * (1.0f - this.swipeToReleaseProgress)) + (((-f3) + AndroidUtilities.m34dp(4.0f)) * this.swipeToReleaseProgress) + f7;
                float f12 = dp2 / 2.0f;
                ...
                if (this.swipeToReleaseProgress > 0.0f) {
                    ...
                    canvas.scale(f13, f13, AndroidUtilities.m34dp(12.0f) + f6 + this.counterDrawable.getCenterX(), (dp23 - AndroidUtilities.m34dp(6.0f)) + AndroidUtilities.m34dp(14.0f));
                    canvas.translate(AndroidUtilities.m34dp(12.0f) + f6, dp23 - AndroidUtilities.m34dp(6.0f));
                    this.counterDrawable.updateBackgroundRect();
                    this.counterDrawable.rectF.inset(-AndroidUtilities.m34dp(2.0f), -AndroidUtilities.m34dp(2.0f));
                    ...
                    canvas.scale(f14, f14, AndroidUtilities.m34dp(12.0f) + f6 + this.counterDrawable.getCenterX(), (dp23 - AndroidUtilities.m34dp(6.0f)) + AndroidUtilities.m34dp(14.0f));
                    canvas.translate(f6 + AndroidUtilities.m34dp(12.0f), dp23 - AndroidUtilities.m34dp(6.0f));
    ...
    private void drawCheck(Canvas canvas, float f, float f2) {
        if (this.animateCheck) {
            ...
            canvas.translate(f - AndroidUtilities.m34dp(24.0f), f2 - AndroidUtilities.m34dp(24.0f));
            float dp = AndroidUtilities.m34dp(16.0f);
            float dp2 = AndroidUtilities.m34dp(26.0f);
            float dp3 = AndroidUtilities.m34dp(22.0f);
            float dp4 = AndroidUtilities.m34dp(32.0f);
            float dp5 = AndroidUtilities.m34dp(32.0f);
            float dp6 = AndroidUtilities.m34dp(20.0f);
            float f8 = 1.0f - f6;
    ...
    private void drawArrow(Canvas canvas, float f, float f2, float f3) {
        ...
        canvas.scale(dpf2, dpf2, f, f2 - AndroidUtilities.m34dp(20.0f));
        canvas.translate(f - AndroidUtilities.dp2(12.0f), f2 - AndroidUtilities.m34dp(12.0f));
    ...
    public static TLRPC$Dialog getNextUnreadDialog(long j, int i, int i2, boolean z, int[] iArr) {
        ...
        for (int i3 = 0; i3 < arrayList.size(); i3++) {
            ...
            TLRPC$Chat chat = messagesController.getChat(Long.valueOf(-tLRPC$Dialog.f860id));
            if (!(chat == null || tLRPC$Dialog.f860id == j || tLRPC$Dialog.unread_count <= 0 || !DialogObject.isChannel(tLRPC$Dialog) || chat.megagroup || messagesController.isPromoDialog(tLRPC$Dialog.f860id, false) || MessagesController.getRestrictionReason(chat.restriction_reason) != null)) {
                return tLRPC$Dialog;
            }
        }
        if (z) {
    ...
    public long getChatId() {
        return this.nextChat.f854id;
    }

    public void drawBottomPanel(android.graphics.Canvas r12, int r13, int r14, int r15) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p009ui.ChatPullingDownDrawable.drawBottomPanel(android.graphics.Canvas, int, int, int):void");
    }
