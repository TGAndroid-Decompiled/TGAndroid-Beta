...
public class FilterCreateActivity extends BaseFragment {
    ...
    public static class HintInnerCell extends FrameLayout {
        ...
        protected void onMeasure(int i, int i2) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m34dp(156.0f), 1073741824));
        }
    }
        ...
        if (getParentActivity() != null) {
            ...
            if (i == this.includeShowMoreRow) {
                ...
                if (i == i2 || i == this.excludeAddRow) {
                    ...
                    filterUsersActivity.setDelegate(new FilterUsersActivity.FilterUsersActivityDelegate() {
                        @Override
    ...
    private void fillFilterName() {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p009ui.FilterCreateActivity.fillFilterName():void");
    }
    ...
    public ArrayList<ThemeDescription> getThemeDescriptions() {
        ...
        ThemeDescription.ThemeDescriptionDelegate filterCreateActivity$$ExternalSyntheticLambda11 = new ThemeDescription.ThemeDescriptionDelegate() {
            @Override
