...
public class MediaActionDrawable extends Drawable {
    ...
    public void setMini(boolean z) {
        this.isMini = z;
        this.paint.setStrokeWidth(AndroidUtilities.m34dp(z ? 2.0f : 3.0f));
    }
    ...
    public void draw(android.graphics.Canvas r34) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p009ui.Components.MediaActionDrawable.draw(android.graphics.Canvas):void");
    }
