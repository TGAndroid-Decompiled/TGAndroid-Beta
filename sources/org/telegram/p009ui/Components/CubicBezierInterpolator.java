...
public class CubicBezierInterpolator implements Interpolator {
    protected PointF f1021a;
    protected PointF f1022b;
    protected PointF f1023c;
    ...
    public CubicBezierInterpolator(PointF pointF, PointF pointF2) throws IllegalArgumentException {
        this.f1021a = new PointF();
        this.f1022b = new PointF();
        this.f1023c = new PointF();
        float f = pointF.x;
        if (f < 0.0f || f > 1.0f) {
    ...
    protected float getBezierCoordinateY(float f) {
        PointF pointF = this.f1023c;
        PointF pointF2 = this.start;
        float f2 = pointF2.y * 3.0f;
        pointF.y = f2;
        PointF pointF3 = this.f1022b;
        float f3 = ((this.end.y - pointF2.y) * 3.0f) - f2;
        pointF3.y = f3;
        PointF pointF4 = this.f1021a;
    ...
    private float getXDerivate(float f) {
        return this.f1023c.x + (f * ((this.f1022b.x * 2.0f) + (this.f1021a.x * 3.0f * f)));
    }
