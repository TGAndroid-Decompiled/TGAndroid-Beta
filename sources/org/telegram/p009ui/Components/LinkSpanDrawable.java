...
public class LinkSpanDrawable<S extends CharacterStyle> {
    ...
    public boolean draw(Canvas canvas) {
        float f;
        boolean z = this.cornerRadius != AndroidUtilities.m34dp(4.0f);
        ...
        float f3 = 1.0f - f;
        this.mSelectionPaint.setStrokeWidth(Math.min(1.0f, f3) * AndroidUtilities.m34dp(5.0f));
        ...
        this.mRipplePaint.setStrokeWidth(Math.min(1.0f, f3) * AndroidUtilities.m34dp(5.0f));
