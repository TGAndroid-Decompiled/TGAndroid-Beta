    ...
    public void makeSelectedUrl() {
        ...
        final EditTextBoldCursor editTextBoldCursor = new EditTextBoldCursor(this, getContext()) {
            ...
            public void onMeasure(int i2, int i3) {
                super.onMeasure(i2, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m34dp(64.0f), 1073741824));
            }
        };
        ...
        if (str != null && str.length() > 0) {
            ...
            if (text.length() > 1 && text.charAt(0) == '@' && (indexOf = TextUtils.indexOf((CharSequence) text, ' ')) != -1) {
                ...
                try {
                    ...
                    this.yOffset = ((getMeasuredHeight() - this.captionLayout.getLineBottom(0)) / 2) + AndroidUtilities.m34dp(0.5f);
                } catch (Exception e2) {
                    FileLog.m30e(e2);
                }
            }
