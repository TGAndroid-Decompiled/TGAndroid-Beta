...
public class Switch extends View {
    ...
    public void setDrawRipple(boolean z) {
        ...
        if (i >= 21 && z != this.drawRipple) {
            ...
            if (this.rippleDrawable == null) {
                ...
                RippleDrawable rippleDrawable = new RippleDrawable(new ColorStateList(new int[][]{StateSet.WILD_CARD}, new int[]{0}), null, i >= 23 ? null : new Drawable() {
                    ...
                    public void draw(Canvas canvas) {
                        ...
                        canvas.drawCircle(bounds.centerX(), bounds.centerY(), AndroidUtilities.m34dp(18.0f), Switch.this.ripplePaint);
                    }
                });
                this.rippleDrawable = rippleDrawable;
                if (i >= 23) {
                    rippleDrawable.setRadius(AndroidUtilities.m34dp(18.0f));
                }
            ...
            if (i >= 28 && z) {
                this.rippleDrawable.setHotspot(this.isChecked ? 0.0f : AndroidUtilities.m34dp(100.0f), AndroidUtilities.m34dp(18.0f));
            }
