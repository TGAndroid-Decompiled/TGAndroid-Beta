...
public class AppIconBulletinLayout extends Bulletin.ButtonLayout {
    ...
    public AppIconBulletinLayout(Context context, LauncherIconController.LauncherIcon launcherIcon, Theme.ResourcesProvider resourcesProvider) {
        ...
        adaptiveIconImageView.setOuterPadding(AndroidUtilities.m36dp(8.0f));
        adaptiveIconImageView.setBackgroundOuterPadding(AndroidUtilities.m36dp(24.0f));
        adaptiveIconImageView.setForeground(launcherIcon.foreground);
        textView.setText(AndroidUtilities.replaceTags(LocaleController.formatString(C1072R.string.AppIconChangedTo, LocaleController.getString(launcherIcon.title))));
    }
}
