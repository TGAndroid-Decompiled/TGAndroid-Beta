...
public class VideoForwardDrawable extends Drawable {
    ...
    public VideoForwardDrawable(boolean z) {
        ...
        while (true) {
            ...
            if (i < iArr.length / 2) {
                if (i == 0) {
                    int i2 = i * 2;
                    this.path1.moveTo(AndroidUtilities.m34dp(iArr[i2]), AndroidUtilities.m34dp(iArr[i2 + 1]));
                } else {
                    int i3 = i * 2;
                    this.path1.lineTo(AndroidUtilities.m34dp(iArr[i3]), AndroidUtilities.m34dp(iArr[i3 + 1]));
                }
                i++;
            } else {
                this.path1.close();
    ...
    public int getIntrinsicWidth() {
        return AndroidUtilities.m34dp(32.0f);
    }
