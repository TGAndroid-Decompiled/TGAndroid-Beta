...
public class JoinGroupAlert extends BottomSheet {
    ...
    public JoinGroupAlert(Context context, TLObject tLObject, String str, BaseFragment baseFragment) {
        ...
        imageView.setImageResource(C0952R.C0953drawable.ic_layer_close);
        ...
        if (tLRPC$ChatInvite != null) {
            ...
            TLRPC$ChatFull chatFull = MessagesController.getInstance(this.currentAccount).getChatFull(this.currentChat.f854id);
        ...
        if (tLRPC$ChatInvite5 == null || tLRPC$ChatInvite5.request_needed) {
            ...
            if (z) {
                i2 = C0952R.string.RequestToJoinChannel;
                str3 = "RequestToJoinChannel";
            } else {
                i2 = C0952R.string.RequestToJoinGroup;
            ...
            if (z) {
                i3 = C0952R.string.RequestToJoinChannelDescription;
                str4 = "RequestToJoinChannelDescription";
            } else {
                i3 = C0952R.string.RequestToJoinGroupDescription;
            ...
            if ((!tLRPC$ChatInvite6.channel || tLRPC$ChatInvite6.megagroup) && (!ChatObject.isChannel(tLRPC$ChatInvite6.chat) || this.chatInvite.chat.megagroup)) {
                pickerBottomLayout.doneButtonTextView.setText(LocaleController.getString("JoinGroup", C0952R.string.JoinGroup));
            } else {
                pickerBottomLayout.doneButtonTextView.setText(LocaleController.getString("ProfileJoinChannel", C0952R.string.ProfileJoinChannel).toUpperCase());
            }
    ...
    public void lambda$new$7(final boolean z, View view) {
        ...
        MessagesController.getInstance(this.currentAccount).addUserToChat(this.currentChat.f854id, UserConfig.getInstance(this.currentAccount).getCurrentUser(), 0, null, null, true, new Runnable() {
            @Override
            public final void run() {
    ...
    public static void showBulletin(Context context, BaseFragment baseFragment, boolean z) {
        ...
        twoLineLottieLayout.imageView.setAnimation(C0952R.raw.timer_3, 28, 28);
        twoLineLottieLayout.titleTextView.setText(LocaleController.getString("RequestToJoinSent", C0952R.string.RequestToJoinSent));
        if (z) {
            str = LocaleController.getString("RequestToJoinChannelSentDescription", C0952R.string.RequestToJoinChannelSentDescription);
        } else {
            str = LocaleController.getString("RequestToJoinGroupSentDescription", C0952R.string.RequestToJoinGroupSentDescription);
        }
