...
public class PollVotesAlert extends BottomSheet {
    ...
    public class SectionCell extends FrameLayout {
        ...
        protected void onMeasure(int i, int i2) {
            int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m34dp(32.0f), 1073741824);
            ...
            measureChildWithMargins(this.textView, i, this.middleTextView.getMeasuredWidth() + this.righTextView.getMeasuredWidth() + AndroidUtilities.m34dp(32.0f), makeMeasureSpec, 0);
            setMeasuredDimension(View.MeasureSpec.getSize(i), AndroidUtilities.m34dp(32.0f));
        }
        ...
        public void setText(String str, int i, int i2, int i3) {
            ...
            if (i3 == 0) {
                ...
                this.righTextView.setText(LocaleController.getString("PollExpand", C0890R.string.PollExpand));
            } else {
                this.righTextView.setText(LocaleController.getString("PollCollapse", C0890R.string.PollCollapse));
            }
        }
    }
    ...
    public class UserCell extends FrameLayout {
        ...
        @Override
        protected void onMeasure(int i, int i2) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m34dp(48.0f) + (this.needDivider ? 1 : 0), 1073741824));
        }
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (this.drawPlaceholder || this.placeholderAlpha != 0.0f) {
                ...
                if (this.placeholderNum % 2 == 0) {
                    i2 = AndroidUtilities.m34dp(65.0f);
                ...
                PollVotesAlert.this.rect.set(i2, top - AndroidUtilities.m34dp(4.0f), i2 + i, AndroidUtilities.m34dp(4.0f) + top);
                canvas.drawRoundRect(PollVotesAlert.this.rect, AndroidUtilities.m34dp(4.0f), AndroidUtilities.m34dp(4.0f), PollVotesAlert.this.placeholderPaint);
                if (this.placeholderNum % 2 == 0) {
                    i4 = AndroidUtilities.m34dp(119.0f);
                    i3 = AndroidUtilities.m34dp(60.0f);
                } else {
                    i4 = AndroidUtilities.m34dp(131.0f);
                    i3 = AndroidUtilities.m34dp(80.0f);
                }
                if (LocaleController.isRTL) {
                    i4 = (getMeasuredWidth() - i4) - i3;
                }
                PollVotesAlert.this.rect.set(i4, top - AndroidUtilities.m34dp(4.0f), i4 + i3, top + AndroidUtilities.m34dp(4.0f));
                canvas.drawRoundRect(PollVotesAlert.this.rect, AndroidUtilities.m34dp(4.0f), AndroidUtilities.m34dp(4.0f), PollVotesAlert.this.placeholderPaint);
            }
            if (this.needDivider) {
    ...
    public PollVotesAlert(final ChatActivity chatActivity, MessageObject messageObject) {
        ...
        while (i4 < size) {
            ...
            if (tLRPC$TL_pollAnswerVoters.voters == 0) {
                ...
                tLRPC$TL_messages_getPollVotes.f931id = this.messageObject.getId();
        ...
        FrameLayout frameLayout = new FrameLayout(parentActivity) {
            ...
            protected void onMeasure(int i9, int i10) {
                ...
                ((FrameLayout.LayoutParams) PollVotesAlert.this.listView.getLayoutParams()).topMargin = C0945ActionBar.getCurrentActionBarHeight();
                ((FrameLayout.LayoutParams) PollVotesAlert.this.actionBarShadow.getLayoutParams()).topMargin = C0945ActionBar.getCurrentActionBarHeight();
                int dp = ((BottomSheet) PollVotesAlert.this).backgroundPaddingTop + AndroidUtilities.m34dp(15.0f) + AndroidUtilities.statusBarHeight;
                ...
                for (int i11 = 0; i11 < sectionCount; i11++) {
                    if (i11 == 0) {
                        ...
                        dp += AndroidUtilities.m34dp(32.0f) + (AndroidUtilities.m34dp(50.0f) * (PollVotesAlert.this.listAdapter.getCountForSection(i11) - 1));
                    }
                }
                int dp2 = (dp < paddingTop ? paddingTop - dp : paddingTop - ((paddingTop / 5) * 3)) + AndroidUtilities.m34dp(8.0f);
            ...
            public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
                if (motionEvent.getAction() != 0 || PollVotesAlert.this.scrollOffsetY == 0 || motionEvent.getY() >= PollVotesAlert.this.scrollOffsetY + AndroidUtilities.m34dp(12.0f) || PollVotesAlert.this.actionBar.getAlpha() != 0.0f) {
            ...
            protected void onDraw(Canvas canvas) {
                ...
                int dp2 = AndroidUtilities.m34dp(20.0f) + i9;
                int measuredHeight = getMeasuredHeight() + AndroidUtilities.m34dp(15.0f) + ((BottomSheet) PollVotesAlert.this).backgroundPaddingTop;
                if (((BottomSheet) PollVotesAlert.this).backgroundPaddingTop + i9 < C0945ActionBar.getCurrentActionBarHeight()) {
                    float dp3 = dp + AndroidUtilities.m34dp(4.0f);
                    float min = Math.min(1.0f, ((C0945ActionBar.getCurrentActionBarHeight() - i9) - ((BottomSheet) PollVotesAlert.this).backgroundPaddingTop) / dp3);
                ...
                if (f != 1.0f) {
                    ...
                    this.rect.set(((BottomSheet) PollVotesAlert.this).backgroundPaddingLeft, ((BottomSheet) PollVotesAlert.this).backgroundPaddingTop + i9, getMeasuredWidth() - ((BottomSheet) PollVotesAlert.this).backgroundPaddingLeft, ((BottomSheet) PollVotesAlert.this).backgroundPaddingTop + i9 + AndroidUtilities.m34dp(24.0f));
        ...
        this.listView.setOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int i10) {
                if (i10 == 0) {
                    if (((PollVotesAlert.this.scrollOffsetY - ((BottomSheet) PollVotesAlert.this).backgroundPaddingTop) - AndroidUtilities.m34dp(13.0f)) + ((BottomSheet) PollVotesAlert.this).backgroundPaddingTop < C0945ActionBar.getCurrentActionBarHeight() && PollVotesAlert.this.listView.canScrollVertically(1)) {
                        ...
                        if (holder != null && holder.itemView.getTop() > AndroidUtilities.m34dp(7.0f)) {
                            PollVotesAlert.this.listView.smoothScrollBy(0, holder.itemView.getTop() - AndroidUtilities.m34dp(7.0f));
                        }
                    }
                }
            }
        ...
        this.titleTextView.setPadding(AndroidUtilities.m34dp(21.0f), AndroidUtilities.m34dp(5.0f), AndroidUtilities.m34dp(14.0f), AndroidUtilities.m34dp(21.0f));
        ...
        textView2.setText(Emoji.replaceEmoji(this.poll.question, textView2.getPaint().getFontMetricsInt(), AndroidUtilities.m34dp(18.0f), false));
        C0945ActionBar actionBar = new C0945ActionBar(parentActivity) {
            @Override
        ...
        this.actionBar.setTitle(LocaleController.getString("PollResults", C0890R.string.PollResults));
        if (this.poll.quiz) {
            ...
            if (arrayList == null || arrayList.isEmpty()) {
                ...
                if (view instanceof TextCell) {
                    ...
                    if (userCell.currentUser != null) {
                        ...
                        bundle.putLong("user_id", userCell.currentUser.f974id);
                        dismiss();
                        ProfileActivity profileActivity = new ProfileActivity(bundle);
                        if (currentUser != null && currentUser.f974id == userCell.currentUser.f974id) {
                            i2 = 1;
                        }
    ...
    public void updateLayout(boolean z) {
        ...
        boolean z2 = top <= AndroidUtilities.m34dp(12.0f);
    ...
    public void updatePlaceholder() {
        if (this.placeholderPaint != null) {
            ...
            float dp = AndroidUtilities.m34dp(500.0f);
    ...
    public class Adapter extends RecyclerListView.SectionsAdapter {
        ...
        private SectionCell createSectionCell() {
            return new SectionCell(this.mContext) {
                ...
                @Override
                protected void onCollapseClick() {
                    VotesList votesList = (VotesList) getTag(C0890R.C0892id.object_tag);
            ...
            if (i != 0) {
                ...
                while (true) {
                    ...
                    if (Arrays.equals(tLRPC$TL_pollAnswer.option, votesList.option)) {
                        ...
                        sectionCell.setTag(C0890R.C0892id.object_tag, votesList);
                        break;
                    }
                    i2++;
                }
        ...
        public void onBindViewHolder(int i, int i2, RecyclerView.ViewHolder viewHolder) {
            ...
            if (itemViewType == 2) {
                ...
                ((TextCell) viewHolder.itemView).setTextAndIcon(LocaleController.formatPluralString("ShowVotes", votesList2.count - votesList2.getCount()), C0890R.C0891drawable.arrow_more, false);
            }
        }
