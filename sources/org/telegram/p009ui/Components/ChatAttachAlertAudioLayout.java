...
public class ChatAttachAlertAudioLayout extends ChatAttachAlert.AttachAlertLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public ChatAttachAlertAudioLayout(ChatAttachAlert chatAttachAlert, Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        SearchField searchField = new SearchField(context, false, resourcesProvider) {
            ...
            public void processTouchEvent(MotionEvent motionEvent) {
                ...
                obtain.setLocation(obtain.getRawX(), (obtain.getRawY() - ChatAttachAlertAudioLayout.this.parentAlert.getSheetContainer().getTranslationY()) - AndroidUtilities.m34dp(58.0f));
        ...
        this.emptyTitleTextView.setPadding(AndroidUtilities.m34dp(40.0f), 0, AndroidUtilities.m34dp(40.0f), 0);
        ...
        RecyclerListView recyclerListView = new RecyclerListView(context, resourcesProvider) {
            ...
            protected boolean allowSelectChildAtPosition(float f, float f2) {
                return f2 >= ((float) ((ChatAttachAlertAudioLayout.this.parentAlert.scrollOffsetY[0] + AndroidUtilities.m34dp(30.0f)) + ((Build.VERSION.SDK_INT < 21 || ChatAttachAlertAudioLayout.this.parentAlert.inBubbleMode) ? 0 : AndroidUtilities.statusBarHeight)));
            }
        };
        this.listView = recyclerListView;
        recyclerListView.setClipToPadding(false);
        RecyclerListView recyclerListView2 = this.listView;
        FillLastLinearLayoutManager fillLastLinearLayoutManager = new FillLastLinearLayoutManager(getContext(), 1, false, AndroidUtilities.m34dp(9.0f), this.listView) {
            @Override
            public void smoothScrollToPosition(RecyclerView recyclerView, RecyclerView.State state, int i) {
                LinearSmoothScroller linearSmoothScroller = new LinearSmoothScroller(recyclerView.getContext()) {
                    @Override
                    public int calculateDyToMakeVisible(View view, int i2) {
                        return super.calculateDyToMakeVisible(view, i2) - (ChatAttachAlertAudioLayout.this.listView.getPaddingTop() - AndroidUtilities.m34dp(7.0f));
                    }
    ...
    public int getCurrentItemTop() {
        ...
        int top = childAt.getTop() - AndroidUtilities.m34dp(8.0f);
        ...
        return top + AndroidUtilities.m34dp(12.0f);
    }

    @Override
    int getFirstOffset() {
        return getListTopPadding() + AndroidUtilities.m34dp(4.0f);
    }
    ...
    void onPreMeasure(int i, int i2) {
        int i3;
        if (this.parentAlert.sizeNotifierFrameLayout.measureKeyboardHeight() > AndroidUtilities.m34dp(20.0f)) {
        ...
        if (this.listView.getPaddingTop() != i3) {
            ...
            this.listView.setPadding(0, i3, 0, AndroidUtilities.m34dp(48.0f));
    ...
    public class SearchAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public void search(final String str) {
            ...
            this.lastSearchId = i;
            Runnable chatAttachAlertAudioLayout$SearchAdapter$$ExternalSyntheticLambda1 = new Runnable() {
                @Override
                public final void run() {
