...
public class GigagroupConvertAlert extends BottomSheet {
    ...
    public GigagroupConvertAlert(final Context context, final BaseFragment baseFragment) {
        ...
        rLottieImageView.setAnimation(C1072R.raw.utyan_gigagroup, 120, 120);
        ...
        textView.setText(LocaleController.getString("GigagroupConvertTitle", C1072R.string.GigagroupConvertTitle));
        ...
        while (true) {
            if (i < 3) {
                ...
                if (i == 0) {
                    ...
                    textView2.setText(LocaleController.getString("GigagroupConvertInfo2", C1072R.string.GigagroupConvertInfo2));
                } else if (i == 2) {
                    textView2.setText(LocaleController.getString("GigagroupConvertInfo3", C1072R.string.GigagroupConvertInfo3));
                }
                ...
                bottomSheetCell.setText(LocaleController.getString("GigagroupConvertProcessButton", C1072R.string.GigagroupConvertProcessButton));
                ...
                textView3.setText(LocaleController.getString("GigagroupConvertCancelButton", C1072R.string.GigagroupConvertCancelButton));
    ...
    public void lambda$new$1(Context context, BaseFragment baseFragment, View view) {
        ...
        builder.setTitle(LocaleController.getString("GigagroupConvertAlertTitle", C1072R.string.GigagroupConvertAlertTitle));
        builder.setMessage(AndroidUtilities.replaceTags(LocaleController.getString("GigagroupConvertAlertText", C1072R.string.GigagroupConvertAlertText)));
        builder.setPositiveButton(LocaleController.getString("GigagroupConvertAlertConver", C1072R.string.GigagroupConvertAlertConver), new DialogInterface.OnClickListener() {
            @Override
