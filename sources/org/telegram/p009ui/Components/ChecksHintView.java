...
public class ChecksHintView extends FrameLayout {
    ...
    public ChecksHintView(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        frameLayout.setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m34dp(6.0f), getThemedColor("chat_gifSaveHintBackground")));
        int i = 0;
        frameLayout.setPadding(AndroidUtilities.m34dp(8.0f), AndroidUtilities.m34dp(8.0f), 0, AndroidUtilities.m34dp(8.0f));
        ...
        while (i < 2) {
            ...
            this.textView[i].setMaxWidth(AndroidUtilities.m34dp(250.0f));
    ...
    public boolean showForMessageCell(ChatMessageCell chatMessageCell, boolean z) {
        ...
        final int i3 = 0;
        if (i2 <= getMeasuredHeight() + AndroidUtilities.m34dp(10.0f)) {
            return false;
        }
        int checksY = i2 + chatMessageCell.getChecksY() + AndroidUtilities.m34dp(6.0f);
        int checksX = chatMessageCell.getChecksX() + AndroidUtilities.m34dp(5.0f);
        ...
        int dp = AndroidUtilities.m34dp(15.0f);
        if (left > view.getMeasuredWidth() / 2) {
            int measuredWidth2 = (measuredWidth - getMeasuredWidth()) - AndroidUtilities.m34dp(20.0f);
        ...
        if (left > view.getMeasuredWidth() / 2) {
            if (left2 < AndroidUtilities.m34dp(10.0f)) {
                float dp2 = left2 - AndroidUtilities.m34dp(10.0f);
            ...
            float dp3 = left2 - AndroidUtilities.m34dp(10.0f);
        ...
        if (z) {
            ...
            this.animatorSet.addListener(new C19171());
    ...
    public class C19171 extends AnimatorListenerAdapter {
        C19171() {
        }
        ...
        public void onAnimationEnd(Animator animator) {
            ...
            AndroidUtilities.runOnUIThread(ChecksHintView.this.hideRunnable = new Runnable() {
                ...
                public final void run() {
                    ChecksHintView.C19171.this.lambda$onAnimationEnd$0();
                }
            }, 3000L);
        }
