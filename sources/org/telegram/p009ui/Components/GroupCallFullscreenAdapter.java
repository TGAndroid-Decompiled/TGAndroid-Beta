...
public class GroupCallFullscreenAdapter extends RecyclerListView.SelectionAdapter {
        ...
        if (linearLayoutManager != null) {
            for (int i = 0; i < this.videoParticipants.size(); i++) {
                if (this.videoParticipants.get(i).equals(videoParticipant)) {
                    linearLayoutManager.scrollToPositionWithOffset(i, AndroidUtilities.m34dp(13.0f));
                    return;
                }
            }
        }
    ...
    public class GroupCallUserCell extends FrameLayout implements GroupCallStatusIcon.Callback {
        ...
        GroupCallUserCell.AvatarWavesDrawable avatarWavesDrawable = new GroupCallUserCell.AvatarWavesDrawable(AndroidUtilities.m34dp(26.0f), AndroidUtilities.m34dp(29.0f));

        public GroupCallUserCell(Context context) {
            super(context);
            this.avatarDrawable.setTextSize((int) (AndroidUtilities.m34dp(18.0f) / 1.15f));
            ...
            this.selectionPaint.setStrokeWidth(AndroidUtilities.m34dp(2.0f));
        ...
        protected void onMeasure(int i, int i2) {
            ...
            if (this.name != null) {
                int min = (int) Math.min(AndroidUtilities.m34dp(46.0f), this.textPaint.measureText(this.name));
                this.nameWidth = min;
                this.drawingName = TextUtils.ellipsize(this.name, this.textPaint, min, TextUtils.TruncateAt.END).toString();
            }
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m34dp(80.0f), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m34dp(80.0f), 1073741824));
        }
        ...
        public void setProgressToFullscreen(float f) {
            if (this.progress != f) {
                ...
                float f2 = 1.0f - f;
                float dp = ((AndroidUtilities.m34dp(46.0f) / AndroidUtilities.m34dp(40.0f)) * f2) + (1.0f * f);
        ...
        protected void dispatchDraw(Canvas canvas) {
            ...
            if (groupCallMiniTextureView == null || !groupCallMiniTextureView.isFullyVisible() || GroupCallFullscreenAdapter.this.activity.drawingForBlur) {
                if (this.progress > 0.0f) {
                    ...
                    canvas.drawRoundRect(rectF, AndroidUtilities.m34dp(13.0f), AndroidUtilities.m34dp(13.0f), this.backgroundPaint);
                ...
                float dp = AndroidUtilities.m34dp(46.0f) / AndroidUtilities.m34dp(40.0f);
        ...
        private void drawSelection(android.graphics.Canvas r7) {
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p009ui.Components.GroupCallFullscreenAdapter.GroupCallUserCell.drawSelection(android.graphics.Canvas):void");
        }
        ...
        public void drawOverlays(Canvas canvas) {
            if (this.drawingName != null) {
                canvas.save();
                int measuredWidth = ((getMeasuredWidth() - this.nameWidth) - AndroidUtilities.m34dp(24.0f)) / 2;
                this.textPaint.setAlpha((int) (this.progress * 255.0f * getAlpha()));
                canvas.drawText(this.drawingName, AndroidUtilities.m34dp(22.0f) + measuredWidth, AndroidUtilities.m34dp(69.0f), this.textPaint);
                canvas.restore();
                canvas.save();
                canvas.translate(measuredWidth, AndroidUtilities.m34dp(53.0f));
        ...
        public void updateState(boolean r10) {
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p009ui.Components.GroupCallFullscreenAdapter.GroupCallUserCell.updateState(boolean):void");
        }
