...
public class OtherDocumentPlaceholderDrawable extends RecyclableDrawable implements DownloadController.FileDownloadProgressListener {
    ...
    public OtherDocumentPlaceholderDrawable(Context context, View view, MessageObject messageObject) {
        docPaint.setTextSize(AndroidUtilities.m34dp(14.0f));
        namePaint.setTextSize(AndroidUtilities.m34dp(19.0f));
        sizePaint.setTextSize(AndroidUtilities.m34dp(15.0f));
        buttonPaint.setTextSize(AndroidUtilities.m34dp(15.0f));
        percentPaint.setTextSize(AndroidUtilities.m34dp(15.0f));
        openPaint.setTextSize(AndroidUtilities.m34dp(15.0f));
        progressPaint.setStrokeWidth(AndroidUtilities.m34dp(2.0f));
        ...
        if (document != null) {
            ...
            this.ext = upperCase;
            if (((int) Math.ceil(docPaint.measureText(upperCase))) > AndroidUtilities.m34dp(40.0f)) {
                this.ext = TextUtils.ellipsize(this.ext, docPaint, AndroidUtilities.m34dp(40.0f), TextUtils.TruncateAt.END).toString();
            }
            ...
            if (((int) Math.ceil(namePaint.measureText(this.fileName))) > AndroidUtilities.m34dp(320.0f)) {
                this.fileName = TextUtils.ellipsize(this.fileName, namePaint, AndroidUtilities.m34dp(320.0f), TextUtils.TruncateAt.END).toString();
            }
        }
        checkFileExist();
    }
    ...
    public void draw(Canvas canvas) {
        ...
        int dp = (height - AndroidUtilities.m34dp(240.0f)) / 2;
        int dp2 = (width - AndroidUtilities.m34dp(48.0f)) / 2;
        this.thumbDrawable.setBounds(dp2, dp, AndroidUtilities.m34dp(48.0f) + dp2, AndroidUtilities.m34dp(48.0f) + dp);
        this.thumbDrawable.draw(canvas);
        canvas.drawText(this.ext, (width - ((int) Math.ceil(docPaint.measureText(this.ext)))) / 2, AndroidUtilities.m34dp(31.0f) + dp, docPaint);
        ...
        canvas.drawText(str, (width - ((int) Math.ceil(textPaint.measureText(str)))) / 2, AndroidUtilities.m34dp(235.0f) + dp + i, textPaint);
        if (this.progressVisible) {
            if (this.progress != null) {
                canvas.drawText(this.progress, (width - ((int) Math.ceil(percentPaint.measureText(str2)))) / 2, AndroidUtilities.m34dp(210.0f) + dp, percentPaint);
            }
            int dp3 = (width - AndroidUtilities.m34dp(240.0f)) / 2;
            int dp4 = dp + AndroidUtilities.m34dp(232.0f);
            progressPaint.setColor(-10327179);
            progressPaint.setAlpha((int) (this.animatedAlphaValue * 255.0f));
            float f = dp4;
            canvas.drawRect(((int) (AndroidUtilities.m34dp(240.0f) * this.animatedProgressValue)) + dp3, f, AndroidUtilities.m34dp(240.0f) + dp3, AndroidUtilities.m34dp(2.0f) + dp4, progressPaint);
            progressPaint.setColor(-1);
            progressPaint.setAlpha((int) (this.animatedAlphaValue * 255.0f));
            float f2 = dp3;
            canvas.drawRect(f2, f, f2 + (AndroidUtilities.m34dp(240.0f) * this.animatedProgressValue), dp4 + AndroidUtilities.m34dp(2.0f), progressPaint);
            updateAnimation();
        }
        canvas.restore();
    }
