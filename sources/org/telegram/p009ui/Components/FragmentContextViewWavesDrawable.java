...
public class FragmentContextViewWavesDrawable {
    ...
    public void draw(float r21, float r22, float r23, float r24, android.graphics.Canvas r25, org.telegram.p009ui.Components.FragmentContextView r26, float r27) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p009ui.Components.FragmentContextViewWavesDrawable.draw(float, float, float, float, android.graphics.Canvas, org.telegram.ui.Components.FragmentContextView, float):void");
    }
