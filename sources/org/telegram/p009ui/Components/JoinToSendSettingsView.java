...
public class JoinToSendSettingsView extends LinearLayout {
    ...
    public JoinToSendSettingsView(Context context, TLRPC$Chat tLRPC$Chat) {
        ...
        headerCell.setText(LocaleController.getString("ChannelSettingsJoinTitle", C0952R.string.ChannelSettingsJoinTitle));
        ...
        String string = LocaleController.getString("ChannelSettingsJoinToSend", C0952R.string.ChannelSettingsJoinToSend);
        ...
        this.joinRequestCell.setTextAndCheck(LocaleController.getString("ChannelSettingsJoinRequest", C0952R.string.ChannelSettingsJoinRequest), this.isJoinRequest, false);
        float f = 0.0f;
        ...
        textInfoPrivacyCell.setText(LocaleController.getString("ChannelSettingsJoinToSendInfo", C0952R.string.ChannelSettingsJoinToSendInfo));
        addView(this.joinToSendInfoCell);
        TextInfoPrivacyCell textInfoPrivacyCell2 = new TextInfoPrivacyCell(context);
        this.joinRequestInfoCell = textInfoPrivacyCell2;
        textInfoPrivacyCell2.setText(LocaleController.getString("ChannelSettingsJoinRequestInfo", C0952R.string.ChannelSettingsJoinRequestInfo));
    ...
    private void updateToggleValue(float f) {
        ...
        float f2 = 1.0f - f;
        this.joinRequestCell.setTranslationY((-AndroidUtilities.m34dp(16.0f)) * f2);
        this.joinRequestCell.setScaleY(1.0f - (0.1f * f2));
        int dp = this.joinRequestCell.getMeasuredHeight() <= 0 ? AndroidUtilities.m34dp(50.0f) : this.joinRequestCell.getMeasuredHeight();
        this.joinToSendInfoCell.setAlpha(f2);
        float f3 = (-dp) * f2;
        this.joinToSendInfoCell.setTranslationY(((-AndroidUtilities.m34dp(4.0f)) * f) + f3);
        this.joinRequestInfoCell.setAlpha(f);
        this.joinRequestInfoCell.setTranslationY(f3 + (AndroidUtilities.m34dp(4.0f) * f2));
        requestLayout();
    }
