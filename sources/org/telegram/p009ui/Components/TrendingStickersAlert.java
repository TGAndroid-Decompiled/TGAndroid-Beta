...
public class TrendingStickersAlert extends BottomSheet {
    ...
    private final int topOffset = AndroidUtilities.m34dp(12.0f);
    ...
    public TrendingStickersAlert(Context context, BaseFragment baseFragment, TrendingStickersLayout trendingStickersLayout, Theme.ResourcesProvider resourcesProvider) {
        ...
        trendingStickersLayout.setOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrolled(RecyclerView recyclerView, int i, int i2) {
                this.scrolledY += i2;
                if (recyclerView.getScrollState() == 1 && Math.abs(this.scrolledY) > AndroidUtilities.m34dp(96.0f)) {
    ...
    public class AlertContainerView extends SizeNotifierFrameLayout {
            ...
            setDelegate(new SizeNotifierFrameLayout.SizeNotifierFrameLayoutDelegate(TrendingStickersAlert.this) {
                ...
                public void onSizeChanged(int i, boolean z) {
                    if (this.lastKeyboardHeight != i || this.lastIsWidthGreater != z) {
                        ...
                        if (i > AndroidUtilities.m34dp(20.0f) && !AlertContainerView.this.gluedToTop) {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (fraction > 0.0f && fraction < 1.0f) {
                float dp = AndroidUtilities.m34dp(12.0f) * fraction;
                ...
                TrendingStickersAlert.this.shapeDrawable.setBounds(((BottomSheet) TrendingStickersAlert.this).backgroundPaddingLeft, TrendingStickersAlert.this.scrollOffsetY + i, getWidth() - ((BottomSheet) TrendingStickersAlert.this).backgroundPaddingLeft, TrendingStickersAlert.this.scrollOffsetY + i + AndroidUtilities.m34dp(24.0f));
        ...
        public void dispatchDraw(Canvas canvas) {
            ...
            TrendingStickersAlert.this.shapeDrawable.setCornerRadius(AndroidUtilities.m34dp(2.0f));
            ...
            TrendingStickersAlert.this.shapeDrawable.setBounds((getWidth() - dp) / 2, TrendingStickersAlert.this.scrollOffsetY + AndroidUtilities.m34dp(10.0f) + i2, (getWidth() + dp) / 2, TrendingStickersAlert.this.scrollOffsetY + AndroidUtilities.m34dp(10.0f) + i2 + dp2);
            TrendingStickersAlert.this.shapeDrawable.draw(canvas);
            canvas.restore();
