...
public class FilterTabsView extends FrameLayout {
    ...
    public class Tab {
        ...
        public int getWidth(boolean z) {
            ...
            if (z) {
                i = FilterTabsView.this.delegate.getTabCounter(this.f1039id);
                if (i < 0) {
                    i = 0;
                }
                if (z) {
            ...
            if (i > 0) {
                ceil += Math.max(AndroidUtilities.m34dp(10.0f), (int) Math.ceil(FilterTabsView.this.textCounterPaint.measureText(String.format("%d", Integer.valueOf(i))))) + AndroidUtilities.m34dp(10.0f) + AndroidUtilities.m34dp(6.0f);
            }
    ...
    public class TabView extends View {
        ...
        @Override
        public int getId() {
            return this.currentTab.f1039id;
        }
        ...
        protected void onMeasure(int i, int i2) {
            setMeasuredDimension(this.currentTab.getWidth(false) + AndroidUtilities.m34dp(32.0f) + FilterTabsView.this.additionalTabWidth, View.MeasureSpec.getSize(i2));
        }
        ...
        public boolean animateChange() {
            ...
            if (i6 > 0) {
                ...
                i = Math.max(AndroidUtilities.m34dp(10.0f), (int) Math.ceil(FilterTabsView.this.textCounterPaint.measureText(str))) + AndroidUtilities.m34dp(10.0f);
            } else {
                str = null;
                i = 0;
            }
            int dp = this.currentTab.titleWidth + (i != 0 ? i + AndroidUtilities.m34dp((str != null ? 1.0f : FilterTabsView.this.editingStartAnimationProgress) * 6.0f) : 0);
            ...
            if (str4 != null && !this.currentTab.title.equals(str4)) {
                ...
                float f2 = 0.0f;
                if (indexOf >= 0) {
                    CharSequence replaceEmoji = Emoji.replaceEmoji(str3, FilterTabsView.this.textPaint.getFontMetricsInt(), AndroidUtilities.m34dp(15.0f), false);
                    ...
                    this.titleAnimateInLayout = new StaticLayout(spannableStringBuilder4, FilterTabsView.this.textPaint, AndroidUtilities.m34dp(400.0f), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
                    StaticLayout staticLayout = new StaticLayout(spannableStringBuilder5, FilterTabsView.this.textPaint, AndroidUtilities.m34dp(400.0f), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
                    ...
                    this.titleAnimateInLayout = new StaticLayout(this.currentTab.title, FilterTabsView.this.textPaint, AndroidUtilities.m34dp(400.0f), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
                    this.titleAnimateOutLayout = new StaticLayout(this.lastTitle, FilterTabsView.this.textPaint, AndroidUtilities.m34dp(400.0f), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
        ...
        public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
            ...
            accessibilityNodeInfo.setSelected((this.currentTab == null || FilterTabsView.this.selectedTabId == -1 || this.currentTab.f1039id != FilterTabsView.this.selectedTabId) ? false : true);
            accessibilityNodeInfo.addAction(16);
            if (Build.VERSION.SDK_INT >= 21) {
                accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(32, LocaleController.getString("AccDescrOpenMenu2", C0952R.string.AccDescrOpenMenu2)));
            } else {
            ...
            public void smoothScrollToPosition(RecyclerView recyclerView, RecyclerView.State state, int i) {
                LinearSmoothScroller linearSmoothScroller = new LinearSmoothScroller(recyclerView.getContext()) {
                    ...
                    protected void onTargetFound(View view, RecyclerView.State state2, RecyclerView.SmoothScroller.Action action) {
                        ...
                        } else if (calculateDxToMakeVisible < 0 || (calculateDxToMakeVisible == 0 && view.getRight() + AndroidUtilities.m34dp(21.0f) > FilterTabsView.this.getMeasuredWidth())) {
                            calculateDxToMakeVisible -= AndroidUtilities.m34dp(60.0f);
                        }
    ...
    public class C20384 extends DefaultItemAnimator {
        C20384() {
        }
            ...
            if (z || z2 || z4 || z3) {
                ...
                ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                    ...
                    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                        FilterTabsView.C20384.this.lambda$runPendingAnimations$0(valueAnimator);
                    }
                });
                ...
                if (tabView.animateChange) {
                    ...
                    ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                        ...
                        public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                            FilterTabsView.C20384.lambda$animateMoveImpl$1(FilterTabsView.TabView.this, valueAnimator2);
                        }
                    });
        ...
        if (this.delegate.canPerformActions()) {
            ...
            if (this.isEditing) {
                if (i != 0) {
                    float dp = AndroidUtilities.m34dp(6.0f);
                    if (tabView.rect.left - dp < f && tabView.rect.right + dp > f) {
                        this.delegate.onDeletePressed(tabView.currentTab.f1039id);
                    }
                }
            } else if (i != this.currentPosition || (filterTabsViewDelegate = this.delegate) == null) {
                scrollToTab(tabView.currentTab.f1039id, i);
            } else {
    ...
    public void addTab(int i, int i2, String str) {
        ...
        this.allTabsWidth += tab.getWidth(true) + AndroidUtilities.m34dp(32.0f);
        this.tabs.add(tab);
    }
    ...
    protected void onMeasure(int i, int i2) {
        if (!this.tabs.isEmpty()) {
            ...
            tab.setTitle(LocaleController.getString("FilterAllChats", C0952R.string.FilterAllChats));
            int width = tab.getWidth(false);
            tab.setTitle(this.allTabsWidth > size ? LocaleController.getString("FilterAllChatsShort", C0952R.string.FilterAllChatsShort) : LocaleController.getString("FilterAllChats", C0952R.string.FilterAllChats));
    ...
    public void notifyTabCounterChanged(int i) {
        ...
        if (i2 >= 0 && i2 < this.tabs.size()) {
            ...
            if (tab.counter != this.delegate.getTabCounter(tab.f1039id) && this.delegate.getTabCounter(tab.f1039id) >= 0) {
                this.listView.invalidateViews();
                if (this.positionToWidth.get(i2) != tab.getWidth(true) || this.invalidated) {
                    ...
                    this.adapter.notifyDataSetChanged();
                    this.allTabsWidth = 0;
                    this.tabs.get(0).setTitle(LocaleController.getString("FilterAllChats", C0952R.string.FilterAllChats));
                    int size = this.tabs.size();
                    for (int i3 = 0; i3 < size; i3++) {
                        this.allTabsWidth += this.tabs.get(i3).getWidth(true) + AndroidUtilities.m34dp(32.0f);
                    }
                }
            }
        }
