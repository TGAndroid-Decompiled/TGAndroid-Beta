...
public class FilterTabsView extends FrameLayout {
    ...
    public class Tab {
        ...
        public int getWidth(boolean z) {
            ...
            if (z) {
                i = FilterTabsView.this.delegate.getTabCounter(this.f1062id);
                if (i < 0) {
                    i = 0;
                }
                if (z) {
            ...
            if (i > 0) {
                ceil += Math.max(AndroidUtilities.m36dp(10.0f), (int) Math.ceil(FilterTabsView.this.textCounterPaint.measureText(String.format("%d", Integer.valueOf(i))))) + AndroidUtilities.m36dp(10.0f) + AndroidUtilities.m36dp(6.0f);
            }
            return Math.max(AndroidUtilities.m36dp(40.0f), ceil);
        }
    ...
    public class TabView extends View {
        ...
        @Override
        public int getId() {
            return this.currentTab.f1062id;
        }
        ...
        protected void onMeasure(int i, int i2) {
            setMeasuredDimension(this.currentTab.getWidth(false) + AndroidUtilities.m36dp(32.0f) + FilterTabsView.this.additionalTabWidth, View.MeasureSpec.getSize(i2));
        }

        @Override
        @android.annotation.SuppressLint({"DrawAllocation"})
        protected void onDraw(android.graphics.Canvas r33) {
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p009ui.Components.FilterTabsView.TabView.onDraw(android.graphics.Canvas):void");
        }
        ...
        public boolean animateChange() {
            ...
            if (i6 > 0) {
                ...
                i = Math.max(AndroidUtilities.m36dp(10.0f), (int) Math.ceil(FilterTabsView.this.textCounterPaint.measureText(str))) + AndroidUtilities.m36dp(10.0f);
            } else {
                str = null;
                i = 0;
            }
            int m36dp = this.currentTab.titleWidth + (i != 0 ? i + AndroidUtilities.m36dp((str != null ? 1.0f : FilterTabsView.this.editingStartAnimationProgress) * 6.0f) : 0);
            float f = this.lastTextX;
            if ((getMeasuredWidth() - m36dp) / 2 != f) {
            ...
            if (str4 != null && !this.currentTab.title.equals(str4)) {
                ...
                if (indexOf >= 0) {
                    CharSequence replaceEmoji = Emoji.replaceEmoji(str2, FilterTabsView.this.textPaint.getFontMetricsInt(), AndroidUtilities.m36dp(15.0f), false);
                    ...
                    this.titleAnimateInLayout = new StaticLayout(spannableStringBuilder4, FilterTabsView.this.textPaint, AndroidUtilities.m36dp(400.0f), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
                    StaticLayout staticLayout = new StaticLayout(spannableStringBuilder5, FilterTabsView.this.textPaint, AndroidUtilities.m36dp(400.0f), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
                    ...
                    this.titleAnimateInLayout = new StaticLayout(this.currentTab.title, FilterTabsView.this.textPaint, AndroidUtilities.m36dp(400.0f), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
                    this.titleAnimateOutLayout = new StaticLayout(this.lastTitle, FilterTabsView.this.textPaint, AndroidUtilities.m36dp(400.0f), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
            ...
            if (m36dp == this.lastTabWidth && getMeasuredWidth() == this.lastWidth) {
                return z;
            }
        ...
        public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
            ...
            accessibilityNodeInfo.setSelected((this.currentTab == null || FilterTabsView.this.selectedTabId == -1 || this.currentTab.f1062id != FilterTabsView.this.selectedTabId) ? false : true);
            accessibilityNodeInfo.addAction(16);
            if (Build.VERSION.SDK_INT >= 21) {
                accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(32, LocaleController.getString("AccDescrOpenMenu2", C1072R.string.AccDescrOpenMenu2)));
            } else {
        ...
        public void shakeLockIcon(final float f, final int i) {
            ...
            ValueAnimator ofFloat = ValueAnimator.ofFloat(0.0f, AndroidUtilities.m36dp(f));
    ...
    public FilterTabsView(Context context) {
        ...
        this.textCounterPaint.setTextSize(AndroidUtilities.m36dp(13.0f));
        ...
        this.deletePaint.setStrokeWidth(AndroidUtilities.m36dp(1.5f));
        ...
        RecyclerListView recyclerListView = new RecyclerListView(context) {
            ...
            public boolean canHighlightChildAt(View view, float f, float f2) {
                if (FilterTabsView.this.isEditing) {
                    ...
                    if (tabView.rect.left - m36dp < f && tabView.rect.right + m36dp > f) {
                        return false;
                    }
                }
        ...
        C23024 c23024 = new C23024();
        this.itemAnimator = c23024;
        c23024.setDelayAnimations(false);
            ...
            public void smoothScrollToPosition(RecyclerView recyclerView, RecyclerView.State state, int i) {
                LinearSmoothScroller linearSmoothScroller = new LinearSmoothScroller(recyclerView.getContext()) {
                    ...
                    protected void onTargetFound(View view, RecyclerView.State state2, RecyclerView.SmoothScroller.Action action) {
                        ...
                        if (calculateDxToMakeVisible > 0 || (calculateDxToMakeVisible == 0 && view.getLeft() - AndroidUtilities.m36dp(21.0f) < 0)) {
                            calculateDxToMakeVisible += AndroidUtilities.m36dp(60.0f);
                        } else if (calculateDxToMakeVisible < 0 || (calculateDxToMakeVisible == 0 && view.getRight() + AndroidUtilities.m36dp(21.0f) > FilterTabsView.this.getMeasuredWidth())) {
                            calculateDxToMakeVisible -= AndroidUtilities.m36dp(60.0f);
                        }
        ...
        this.listView.setPadding(AndroidUtilities.m36dp(7.0f), 0, AndroidUtilities.m36dp(7.0f), 0);
    ...
    public class C23024 extends DefaultItemAnimator {
        C23024() {
        }
        ...
        public void runPendingAnimations() {
            ...
            if (z || z2 || z4 || z3) {
                ...
                ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                    @Override
                    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                        FilterTabsView.C23024.this.lambda$runPendingAnimations$0(valueAnimator);
                    }
                });
                ...
                if (tabView.animateChange) {
                    ...
                    ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                        ...
                        public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                            FilterTabsView.C23024.lambda$animateMoveImpl$1(FilterTabsView.TabView.this, valueAnimator2);
                        }
                    });
    ...
    public void lambda$new$0(View view, int i, float f, float f2) {
        ...
        if (this.delegate.canPerformActions()) {
            ...
            if (!this.isEditing) {
                ...
                this.delegate.onDeletePressed(tabView.currentTab.f1062id);
            }
        }
    }
    ...
    private void scrollToTab(Tab tab, int i) {
        ...
        this.currentPosition = i;
        this.selectedTabId = tab.f1062id;
    ...
    public void addTab(int i, int i2, String str, boolean z, boolean z2) {
        ...
        tab.isDefault = z;
        tab.isLocked = z2;
        this.allTabsWidth += tab.getWidth(true) + AndroidUtilities.m36dp(32.0f);
        this.tabs.add(tab);
    }
    ...
    public void updateTabsWidths() {
        ...
        for (int i = 0; i < size; i++) {
            ...
            this.positionToX.put(i, (this.additionalTabWidth / 2) + m36dp);
            m36dp += width + AndroidUtilities.m36dp(32.0f) + this.additionalTabWidth;
        }
    }

    @Override
    protected boolean drawChild(android.graphics.Canvas r10, android.view.View r11, long r12) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p009ui.Components.FilterTabsView.drawChild(android.graphics.Canvas, android.view.View, long):boolean");
    }

    @Override
    protected void onMeasure(int i, int i2) {
        if (!this.tabs.isEmpty()) {
            int size = (View.MeasureSpec.getSize(i) - AndroidUtilities.m36dp(7.0f)) - AndroidUtilities.m36dp(7.0f);
            Tab findDefaultTab = findDefaultTab();
            int i3 = C1072R.string.FilterAllChats;
            ...
            if (this.allTabsWidth > size) {
                i3 = C1072R.string.FilterAllChatsShort;
    ...
    public void setIsEditing(boolean z) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (dialogFilter.isDefault()) {
                ...
                tLRPC$TL_messages_updateDialogFiltersOrder.order.add(Integer.valueOf(dialogFilter.f819id));
            }
        }
    ...
    public void checkTabsCounter() {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p009ui.Components.FilterTabsView.checkTabsCounter():void");
    }
    ...
    public void notifyTabCounterChanged(int i) {
        ...
        if (tab.counter == this.delegate.getTabCounter(tab.f1062id) || this.delegate.getTabCounter(tab.f1062id) < 0) {
            return;
        }
        this.listView.invalidateViews();
        if (this.positionToWidth.get(i2) != tab.getWidth(true) || this.invalidated) {
            ...
            this.adapter.notifyDataSetChanged();
            this.allTabsWidth = 0;
            findDefaultTab().setTitle(LocaleController.getString("FilterAllChats", C1072R.string.FilterAllChats));
            int size = this.tabs.size();
            for (int i3 = 0; i3 < size; i3++) {
                this.allTabsWidth += this.tabs.get(i3).getWidth(true) + AndroidUtilities.m36dp(32.0f);
            }
        }
    }
    ...
    public class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public void moveElementToStart(int i) {
            ...
            int i3 = ((Tab) FilterTabsView.this.tabs.get(i)).f1062id;
            ...
            ((Tab) FilterTabsView.this.tabs.get(0)).f1062id = i3;
            for (int i5 = 0; i5 <= i; i5++) {
                ((Tab) FilterTabsView.this.tabs.get(i5)).f1062id = i5;
            ...
            notifyItemMoved(i, 0);
            FilterTabsView.this.delegate.onPageReorder(((Tab) FilterTabsView.this.tabs.get(i)).f1062id, i3);
            FilterTabsView.this.updateTabsWidths();
            FilterTabsView.this.orderChanged = true;
            FilterTabsView.this.listView.setItemAnimator(FilterTabsView.this.itemAnimator);
        }
    ...
    public boolean currentTabIsDefault() {
        Tab findDefaultTab = findDefaultTab();
        return findDefaultTab != null && findDefaultTab.f1062id == this.selectedTabId;
    }
    ...
    public boolean isFirstTabSelected() {
        return this.tabs.isEmpty() || this.selectedTabId == this.tabs.get(0).f1062id;
    }

    public boolean isLocked(int i) {
        for (int i2 = 0; i2 < this.tabs.size(); i2++) {
            if (this.tabs.get(i2).f1062id == i) {
    ...
    public void shakeLock(int i) {
        for (int i2 = 0; i2 < this.listView.getChildCount(); i2++) {
            if (this.listView.getChildAt(i2) instanceof TabView) {
                ...
                if (tabView.currentTab.f1062id == i) {
