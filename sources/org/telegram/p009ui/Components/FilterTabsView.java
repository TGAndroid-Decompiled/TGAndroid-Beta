...
public class FilterTabsView extends FrameLayout {
    ...
    public class Tab {
        ...
        public int getWidth(boolean z) {
            ...
            if (z) {
                i = FilterTabsView.this.delegate.getTabCounter(this.f1052id);
                if (i < 0) {
                    i = 0;
                }
                if (z) {
            ...
            if (i > 0) {
                ceil += Math.max(AndroidUtilities.m35dp(10.0f), (int) Math.ceil(FilterTabsView.this.textCounterPaint.measureText(String.format("%d", Integer.valueOf(i))))) + AndroidUtilities.m35dp(10.0f) + AndroidUtilities.m35dp(6.0f);
            }
    ...
    public class TabView extends View {
        ...
        @Override
        public int getId() {
            return this.currentTab.f1052id;
        }
        ...
        protected void onMeasure(int i, int i2) {
            setMeasuredDimension(this.currentTab.getWidth(false) + AndroidUtilities.m35dp(32.0f) + FilterTabsView.this.additionalTabWidth, View.MeasureSpec.getSize(i2));
        }
        ...
        public boolean animateChange() {
            ...
            if (i6 > 0) {
                ...
                i = Math.max(AndroidUtilities.m35dp(10.0f), (int) Math.ceil(FilterTabsView.this.textCounterPaint.measureText(str))) + AndroidUtilities.m35dp(10.0f);
            } else {
                str = null;
                i = 0;
            }
            int m35dp = this.currentTab.titleWidth + (i != 0 ? i + AndroidUtilities.m35dp((str != null ? 1.0f : FilterTabsView.this.editingStartAnimationProgress) * 6.0f) : 0);
            float f = this.lastTextX;
            if ((getMeasuredWidth() - m35dp) / 2 != f) {
            ...
            if (str4 != null && !this.currentTab.title.equals(str4)) {
                ...
                if (indexOf >= 0) {
                    CharSequence replaceEmoji = Emoji.replaceEmoji(str2, FilterTabsView.this.textPaint.getFontMetricsInt(), AndroidUtilities.m35dp(15.0f), false);
                    ...
                    this.titleAnimateInLayout = new StaticLayout(spannableStringBuilder4, FilterTabsView.this.textPaint, AndroidUtilities.m35dp(400.0f), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
                    StaticLayout staticLayout = new StaticLayout(spannableStringBuilder5, FilterTabsView.this.textPaint, AndroidUtilities.m35dp(400.0f), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
                    ...
                    this.titleAnimateInLayout = new StaticLayout(this.currentTab.title, FilterTabsView.this.textPaint, AndroidUtilities.m35dp(400.0f), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
                    this.titleAnimateOutLayout = new StaticLayout(this.lastTitle, FilterTabsView.this.textPaint, AndroidUtilities.m35dp(400.0f), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
            ...
            if (m35dp == this.lastTabWidth && getMeasuredWidth() == this.lastWidth) {
                return z;
            }
        ...
        public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
            ...
            accessibilityNodeInfo.setSelected((this.currentTab == null || FilterTabsView.this.selectedTabId == -1 || this.currentTab.f1052id != FilterTabsView.this.selectedTabId) ? false : true);
            accessibilityNodeInfo.addAction(16);
            if (Build.VERSION.SDK_INT >= 21) {
                accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(32, LocaleController.getString("AccDescrOpenMenu2", C1010R.string.AccDescrOpenMenu2)));
            } else {
        ...
        public void shakeLockIcon(final float f, final int i) {
            ...
            ValueAnimator ofFloat = ValueAnimator.ofFloat(0.0f, AndroidUtilities.m35dp(f));
    ...
    public FilterTabsView(Context context) {
        ...
        C22034 c22034 = new C22034();
        this.itemAnimator = c22034;
        c22034.setDelayAnimations(false);
            ...
            public void smoothScrollToPosition(RecyclerView recyclerView, RecyclerView.State state, int i) {
                LinearSmoothScroller linearSmoothScroller = new LinearSmoothScroller(recyclerView.getContext()) {
                    ...
                    protected void onTargetFound(View view, RecyclerView.State state2, RecyclerView.SmoothScroller.Action action) {
                        ...
                        } else if (calculateDxToMakeVisible < 0 || (calculateDxToMakeVisible == 0 && view.getRight() + AndroidUtilities.m35dp(21.0f) > FilterTabsView.this.getMeasuredWidth())) {
                            calculateDxToMakeVisible -= AndroidUtilities.m35dp(60.0f);
                        }
    ...
    public class C22034 extends DefaultItemAnimator {
        C22034() {
        }
        ...
        public void runPendingAnimations() {
            ...
            if (z || z2 || z4 || z3) {
                ...
                ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                    @Override
                    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                        FilterTabsView.C22034.this.lambda$runPendingAnimations$0(valueAnimator);
                    }
                });
                ...
                if (tabView.animateChange) {
                    ...
                    ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                        ...
                        public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                            FilterTabsView.C22034.lambda$animateMoveImpl$1(FilterTabsView.TabView.this, valueAnimator2);
                        }
                    });
    ...
    public void lambda$new$0(View view, int i, float f, float f2) {
        ...
        if (this.delegate.canPerformActions()) {
            ...
            if (!this.isEditing) {
                ...
                this.delegate.onDeletePressed(tabView.currentTab.f1052id);
            }
        }
    }
    ...
    private void scrollToTab(Tab tab, int i) {
        ...
        this.currentPosition = i;
        this.selectedTabId = tab.f1052id;
    ...
    public void addTab(int i, int i2, String str, boolean z, boolean z2) {
        ...
        tab.isDefault = z;
        tab.isLocked = z2;
        this.allTabsWidth += tab.getWidth(true) + AndroidUtilities.m35dp(32.0f);
        this.tabs.add(tab);
    }
    ...
    public void updateTabsWidths() {
        ...
        for (int i = 0; i < size; i++) {
            ...
            m35dp += width + AndroidUtilities.m35dp(32.0f) + this.additionalTabWidth;
        }
    }
    ...
    protected void onMeasure(int i, int i2) {
        if (!this.tabs.isEmpty()) {
            ...
            int i3 = C1010R.string.FilterAllChats;
            ...
            if (this.allTabsWidth > size) {
                i3 = C1010R.string.FilterAllChatsShort;
    ...
    public void setIsEditing(boolean z) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (dialogFilter.isDefault()) {
                ...
                tLRPC$TL_messages_updateDialogFiltersOrder.order.add(Integer.valueOf(dialogFilter.f810id));
            }
        }
    ...
    public void notifyTabCounterChanged(int i) {
        ...
        if (tab.counter == this.delegate.getTabCounter(tab.f1052id) || this.delegate.getTabCounter(tab.f1052id) < 0) {
            return;
        }
        this.listView.invalidateViews();
        if (this.positionToWidth.get(i2) != tab.getWidth(true) || this.invalidated) {
            ...
            this.adapter.notifyDataSetChanged();
            this.allTabsWidth = 0;
            findDefaultTab().setTitle(LocaleController.getString("FilterAllChats", C1010R.string.FilterAllChats));
            int size = this.tabs.size();
            for (int i3 = 0; i3 < size; i3++) {
                this.allTabsWidth += this.tabs.get(i3).getWidth(true) + AndroidUtilities.m35dp(32.0f);
            }
        }
    }
    ...
    public class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public void moveElementToStart(int i) {
            ...
            int i3 = ((Tab) FilterTabsView.this.tabs.get(i)).f1052id;
            ...
            ((Tab) FilterTabsView.this.tabs.get(0)).f1052id = i3;
            for (int i5 = 0; i5 <= i; i5++) {
                ((Tab) FilterTabsView.this.tabs.get(i5)).f1052id = i5;
            ...
            notifyItemMoved(i, 0);
            FilterTabsView.this.delegate.onPageReorder(((Tab) FilterTabsView.this.tabs.get(i)).f1052id, i3);
            FilterTabsView.this.updateTabsWidths();
            FilterTabsView.this.orderChanged = true;
            FilterTabsView.this.listView.setItemAnimator(FilterTabsView.this.itemAnimator);
        }
    ...
    public boolean currentTabIsDefault() {
        Tab findDefaultTab = findDefaultTab();
        return findDefaultTab != null && findDefaultTab.f1052id == this.selectedTabId;
    }
    ...
    public boolean isFirstTabSelected() {
        return this.tabs.isEmpty() || this.selectedTabId == this.tabs.get(0).f1052id;
    }

    public boolean isLocked(int i) {
        for (int i2 = 0; i2 < this.tabs.size(); i2++) {
            if (this.tabs.get(i2).f1052id == i) {
    ...
    public void shakeLock(int i) {
        for (int i2 = 0; i2 < this.listView.getChildCount(); i2++) {
            if (this.listView.getChildAt(i2) instanceof TabView) {
                ...
                if (tabView.currentTab.f1052id == i) {
