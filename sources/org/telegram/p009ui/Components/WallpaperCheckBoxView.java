...
public class WallpaperCheckBoxView extends View {
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(this.maxTextSize + AndroidUtilities.m35dp(56.0f), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m35dp(32.0f), 1073741824));
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int measuredWidth = ((getMeasuredWidth() - this.currentTextSize) - AndroidUtilities.m35dp(28.0f)) / 2;
        canvas.drawText(this.currentText, AndroidUtilities.m35dp(28.0f) + measuredWidth, AndroidUtilities.m35dp(21.0f), this.textPaint);
        canvas.save();
        canvas.translate(measuredWidth, AndroidUtilities.m35dp(7.0f));
        int i = 0;
        if (this.drawBitmap != null) {
            ...
            this.rect.set(m35dp, m35dp, AndroidUtilities.m35dp(18.0f) - m35dp, AndroidUtilities.m35dp(18.0f) - m35dp);
            ...
            if (f2 != 1.0f) {
                ...
                this.rect.set(AndroidUtilities.m35dp(2.0f) + min, AndroidUtilities.m35dp(2.0f) + min, AndroidUtilities.m35dp(16.0f) - min, AndroidUtilities.m35dp(16.0f) - min);
            ...
            if (this.progress > 0.5f) {
                float f4 = 1.0f - f;
                this.drawCanvas.drawLine(AndroidUtilities.m35dp(7.3f), AndroidUtilities.m35dp(13.0f), (int) (AndroidUtilities.m35dp(7.3f) - (AndroidUtilities.m35dp(2.5f) * f4)), (int) (AndroidUtilities.m35dp(13.0f) - (AndroidUtilities.m35dp(2.5f) * f4)), this.checkPaint);
                this.drawCanvas.drawLine(AndroidUtilities.m35dp(7.3f), AndroidUtilities.m35dp(13.0f), (int) (AndroidUtilities.m35dp(7.3f) + (AndroidUtilities.m35dp(6.0f) * f4)), (int) (AndroidUtilities.m35dp(13.0f) - (AndroidUtilities.m35dp(6.0f) * f4)), this.checkPaint);
            }
            canvas.drawBitmap(this.drawBitmap, 0.0f, 0.0f, (Paint) null);
        } else {
            this.rect.set(0.0f, 0.0f, AndroidUtilities.m35dp(18.0f), AndroidUtilities.m35dp(18.0f));
