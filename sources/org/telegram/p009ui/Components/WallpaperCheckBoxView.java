...
public class WallpaperCheckBoxView extends View {
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(this.maxTextSize + AndroidUtilities.m34dp(56.0f), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m34dp(32.0f), 1073741824));
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int measuredWidth = ((getMeasuredWidth() - this.currentTextSize) - AndroidUtilities.m34dp(28.0f)) / 2;
        canvas.drawText(this.currentText, AndroidUtilities.m34dp(28.0f) + measuredWidth, AndroidUtilities.m34dp(21.0f), this.textPaint);
        canvas.save();
        canvas.translate(measuredWidth, AndroidUtilities.m34dp(7.0f));
        int i = 0;
        if (this.drawBitmap != null) {
            ...
            this.rect.set(dp, dp, AndroidUtilities.m34dp(18.0f) - dp, AndroidUtilities.m34dp(18.0f) - dp);
            ...
            if (f != 1.0f) {
                ...
                this.rect.set(AndroidUtilities.m34dp(2.0f) + min, AndroidUtilities.m34dp(2.0f) + min, AndroidUtilities.m34dp(16.0f) - min, AndroidUtilities.m34dp(16.0f) - min);
            ...
            if (this.progress > 0.5f) {
                float f4 = 1.0f - f2;
                this.drawCanvas.drawLine(AndroidUtilities.m34dp(7.3f), AndroidUtilities.m34dp(13.0f), (int) (AndroidUtilities.m34dp(7.3f) - (AndroidUtilities.m34dp(2.5f) * f4)), (int) (AndroidUtilities.m34dp(13.0f) - (AndroidUtilities.m34dp(2.5f) * f4)), this.checkPaint);
                this.drawCanvas.drawLine(AndroidUtilities.m34dp(7.3f), AndroidUtilities.m34dp(13.0f), (int) (AndroidUtilities.m34dp(7.3f) + (AndroidUtilities.m34dp(6.0f) * f4)), (int) (AndroidUtilities.m34dp(13.0f) - (AndroidUtilities.m34dp(6.0f) * f4)), this.checkPaint);
            }
            canvas.drawBitmap(this.drawBitmap, 0.0f, 0.0f, (Paint) null);
        } else {
            this.rect.set(0.0f, 0.0f, AndroidUtilities.m34dp(18.0f), AndroidUtilities.m34dp(18.0f));
