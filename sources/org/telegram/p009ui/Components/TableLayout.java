...
public class TableLayout extends View {
    ...
    public class Child {
        ...
        public int getTextX() {
            return this.f1094x + this.textX;
        }

        public int getTextY() {
            return this.f1095y + this.textY;
        }
        ...
        public void draw(Canvas canvas, View view) {
            ...
            if (this.cell != null) {
                boolean z = false;
                boolean z2 = true;
                boolean z3 = this.f1094x + this.measuredWidth == TableLayout.this.getMeasuredWidth();
                boolean z4 = this.f1095y + this.measuredHeight == TableLayout.this.getMeasuredHeight();
                int dp = AndroidUtilities.m34dp(3.0f);
                if (this.cell.header || (TableLayout.this.isStriped && this.layoutParams.rowSpec.span.min % 2 == 0)) {
                    if (this.f1094x == 0 && this.f1095y == 0) {
                    ...
                    if (z2) {
                        TableLayout.this.rect.set(this.f1094x, this.f1095y, i8 + this.measuredWidth, i9 + this.measuredHeight);
                        ...
                        canvas.drawRect(this.f1094x, this.f1095y, i6 + this.measuredWidth, i7 + this.measuredHeight, TableLayout.this.delegate.getHeaderPaint());
                    } else {
                        canvas.drawRect(this.f1094x, this.f1095y, i4 + this.measuredWidth, i5 + this.measuredHeight, TableLayout.this.delegate.getStripPaint());
                    }
                }
                ...
                if (TableLayout.this.drawLines) {
                    ...
                    if (i10 == 0) {
                        ...
                        canvas.drawLine(i10 - strokeWidth2, this.f1095y, i10 - strokeWidth2, i3 + this.measuredHeight, linePaint2);
                    }
                    int i13 = this.f1095y;
                    if (i13 == 0) {
                        int i14 = this.f1094x;
                        ...
                        canvas.drawLine(this.f1094x, i13 - strokeWidth2, i2 + this.measuredWidth, i13 - strokeWidth2, linePaint2);
                    }
                    float f13 = (!z3 || (i = this.f1095y) != 0) ? this.f1095y - strokeWidth : i + dp;
                    if (!z3 || !z4) {
                        f = (this.f1095y + this.measuredHeight) - strokeWidth;
                    } else {
                        f = (this.f1095y + this.measuredHeight) - dp;
                    }
                    float f14 = f;
                    int i16 = this.f1094x;
