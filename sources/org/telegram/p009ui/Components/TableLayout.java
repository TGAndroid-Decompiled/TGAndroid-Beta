...
public class TableLayout extends View {
    ...
    private int itemPaddingTop = AndroidUtilities.m34dp(7.0f);
    private int itemPaddingLeft = AndroidUtilities.m34dp(8.0f);
    ...
    public class Child {
        ...
        public void measure(int r2, int r3, boolean r4) {
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p009ui.Components.TableLayout.Child.measure(int, int, boolean):void");
        }
        ...
        public int getTextX() {
            return this.f1077x + this.textX;
        }

        public int getTextY() {
            return this.f1078y + this.textY;
        }
        ...
        public void draw(Canvas canvas, View view) {
            ...
            if (this.cell != null) {
                boolean z = false;
                boolean z2 = true;
                boolean z3 = this.f1077x + this.measuredWidth == TableLayout.this.getMeasuredWidth();
                boolean z4 = this.f1078y + this.measuredHeight == TableLayout.this.getMeasuredHeight();
                int dp = AndroidUtilities.m34dp(3.0f);
                if (this.cell.header || (TableLayout.this.isStriped && this.layoutParams.rowSpec.span.min % 2 == 0)) {
                    if (this.f1077x == 0 && this.f1078y == 0) {
                    ...
                    if (z2) {
                        TableLayout.this.rect.set(this.f1077x, this.f1078y, i8 + this.measuredWidth, i9 + this.measuredHeight);
                        ...
                        canvas.drawRect(this.f1077x, this.f1078y, i6 + this.measuredWidth, i7 + this.measuredHeight, TableLayout.this.delegate.getHeaderPaint());
                    } else {
                        canvas.drawRect(this.f1077x, this.f1078y, i4 + this.measuredWidth, i5 + this.measuredHeight, TableLayout.this.delegate.getStripPaint());
                    }
                }
                ...
                if (TableLayout.this.drawLines) {
                    ...
                    if (i10 == 0) {
                        ...
                        canvas.drawLine(i10 - strokeWidth2, this.f1078y, i10 - strokeWidth2, i3 + this.measuredHeight, linePaint2);
                    }
                    int i13 = this.f1078y;
                    if (i13 == 0) {
                        int i14 = this.f1077x;
                        ...
                        canvas.drawLine(this.f1077x, i13 - strokeWidth2, i2 + this.measuredWidth, i13 - strokeWidth2, linePaint2);
                    }
                    float f13 = (!z3 || (i = this.f1078y) != 0) ? this.f1078y - strokeWidth : i + dp;
                    if (!z3 || !z4) {
                        f = (this.f1078y + this.measuredHeight) - strokeWidth;
                    } else {
                        f = (this.f1078y + this.measuredHeight) - dp;
                    }
                    float f14 = f;
                    int i16 = this.f1077x;
    ...
    protected void onMeasure(int i, int i2) {
        ...
        while (i7 < childCount2) {
            ...
            int i14 = !this.isRtl ? margin + i13 : ((i6 - sizeInCell) - margin3) - i13;
            ...
            if (childAt.cell != null) {
                ...
                if (!(childAt.fixedHeight == 0 || childAt.fixedHeight == sizeInCell2 || childAt.layoutParams.rowSpec.span.max - childAt.layoutParams.rowSpec.span.min > 1)) {
                    ...
                    while (true) {
                        ...
                        if (point.f1058x <= childAt.layoutParams.rowSpec.span.min && point.f1059y > childAt.layoutParams.rowSpec.span.min) {
                            z2 = true;
                            break;
                        }
                        i16++;
    ...
    public final class Axis {
        ...
        private PackedMap<Spec, Bounds> createGroupBounds() {
            Assoc of = Assoc.m12of(Spec.class, Bounds.class);
            int childCount = TableLayout.this.getChildCount();
            for (int i = 0; i < childCount; i++) {
        ...
        private PackedMap<Interval, MutableInt> createLinks(boolean z) {
            Assoc of = Assoc.m12of(Interval.class, MutableInt.class);
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        public LayoutParams() {
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p009ui.Components.TableLayout.LayoutParams.<init>():void");
        }
    ...
    public static final class Assoc<K, V> extends ArrayList<Pair<K, V>> {
        ...
        public static <K, V> Assoc<K, V> m12of(Class<K> cls, Class<V> cls2) {
