...
public class EmptyTextProgressView extends FrameLayout {
    ...
    public EmptyTextProgressView(Context context, View view, Theme.ResourcesProvider resourcesProvider) {
        ...
        linearLayout.setPadding(AndroidUtilities.m34dp(20.0f), 0, AndroidUtilities.m34dp(20.0f), 0);
        ...
        this.textView.setText(LocaleController.getString("NoResult", C0890R.string.NoResult));
    ...
    public void setTopImage(int i) {
        ...
        this.textView.setCompoundDrawablePadding(AndroidUtilities.m34dp(1.0f));
    }
        ...
        for (int i9 = 0; i9 < childCount; i9++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (childAt != view || !(view instanceof FlickerLoadingView)) {
                    ...
                    if (i10 == 2) {
                        i5 = (AndroidUtilities.m34dp(100.0f) - childAt.getMeasuredHeight()) / 2;
                        i6 = getPaddingTop();
                    } else if (i10 == 1) {
