...
public class LayoutHelper {
    ...
    public static FrameLayout.LayoutParams createFrame(int i, float f, int i2, float f2, float f3, float f4, float f5) {
        ...
        layoutParams.setMargins(AndroidUtilities.m34dp(f2), AndroidUtilities.m34dp(f3), AndroidUtilities.m34dp(f4), AndroidUtilities.m34dp(f5));
        return layoutParams;
    }
    ...
    public static FrameLayout.LayoutParams createFrameRelatively(float f, float f2, int i, float f3, float f4, float f5, float f6) {
        ...
        layoutParams.leftMargin = AndroidUtilities.m34dp(LocaleController.isRTL ? f5 : f3);
        layoutParams.topMargin = AndroidUtilities.m34dp(f4);
        if (!LocaleController.isRTL) {
            f3 = f5;
        }
        layoutParams.rightMargin = AndroidUtilities.m34dp(f3);
        layoutParams.bottomMargin = AndroidUtilities.m34dp(f6);
        return layoutParams;
    }
    ...
    public static RelativeLayout.LayoutParams createRelative(float f, float f2, int i, int i2, int i3, int i4, int i5, int i6, int i7) {
        ...
        layoutParams.leftMargin = AndroidUtilities.m34dp(i);
        layoutParams.topMargin = AndroidUtilities.m34dp(i2);
        layoutParams.rightMargin = AndroidUtilities.m34dp(i3);
        layoutParams.bottomMargin = AndroidUtilities.m34dp(i4);
        return layoutParams;
    }
    ...
    public static LinearLayout.LayoutParams createLinear(int i, int i2, float f, int i3, int i4, int i5, int i6, int i7) {
        ...
        layoutParams.setMargins(AndroidUtilities.m34dp(i4), AndroidUtilities.m34dp(i5), AndroidUtilities.m34dp(i6), AndroidUtilities.m34dp(i7));
    ...
    public static LinearLayout.LayoutParams createLinear(int i, int i2, float f, int i3, int i4, int i5, int i6) {
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(getSize(i), getSize(i2), f);
        layoutParams.setMargins(AndroidUtilities.m34dp(i3), AndroidUtilities.m34dp(i4), AndroidUtilities.m34dp(i5), AndroidUtilities.m34dp(i6));
        return layoutParams;
    }
    ...
    public static LinearLayout.LayoutParams createLinear(int i, int i2, float f, float f2, float f3, float f4) {
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(getSize(i), getSize(i2));
        layoutParams.setMargins(AndroidUtilities.m34dp(f), AndroidUtilities.m34dp(f2), AndroidUtilities.m34dp(f3), AndroidUtilities.m34dp(f4));
        return layoutParams;
    }
