    ...
    public void updateExpandProgress(float f) {
        ...
        if (i != 2) {
            if (this.expanded) {
                ...
                float f5 = 86.0f - f3;
                float f6 = 1.0f - f;
                this.visibleView.setTranslationY((((AndroidUtilities.m34dp(f4) / 2.0f) - (AndroidUtilities.m34dp(f5) / 2.0f)) * f6) - (AndroidUtilities.m34dp(8.0f) * f));
                this.visibleView.setTranslationX(((AndroidUtilities.m34dp(f4) / 2.0f) - (AndroidUtilities.m34dp(f5) / 2.0f)) * f6);
                this.textView.setAlpha(Math.max(0.0f, (f - 0.5f) / 0.5f));
                this.textView.setTranslationY((-AndroidUtilities.m34dp(40.0f)) * f6);
                this.textView.setTranslationX((-AndroidUtilities.m34dp(12.0f)) * f6);
