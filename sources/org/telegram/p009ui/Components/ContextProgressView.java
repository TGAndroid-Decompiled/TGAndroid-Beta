...
public class ContextProgressView extends View {
    ...
    public ContextProgressView(Context context, int i) {
        ...
        this.innerPaint.setStrokeWidth(AndroidUtilities.m34dp(2.0f));
    ...
    protected void onDraw(Canvas canvas) {
        if (getVisibility() == 0) {
            ...
            int measuredWidth = (getMeasuredWidth() / 2) - AndroidUtilities.m34dp(9.0f);
            int measuredHeight = (getMeasuredHeight() / 2) - AndroidUtilities.m34dp(9.0f);
            this.cicleRect.set(measuredWidth, measuredHeight, measuredWidth + AndroidUtilities.m34dp(18.0f), measuredHeight + AndroidUtilities.m34dp(18.0f));
            canvas.drawCircle(getMeasuredWidth() / 2, getMeasuredHeight() / 2, AndroidUtilities.m34dp(9.0f), this.innerPaint);
