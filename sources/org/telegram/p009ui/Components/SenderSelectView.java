...
public class SenderSelectView extends View {
    ...
    public SenderSelectView(Context context) {
        ...
        updateColors();
        setContentDescription(LocaleController.formatString("AccDescrSendAsPeer", C1072R.string.AccDescrSendAsPeer, ""));
    }
    ...
    public void setAvatar(TLObject tLObject) {
        ...
        setContentDescription(LocaleController.formatString("AccDescrSendAsPeer", C1072R.string.AccDescrSendAsPeer, str));
