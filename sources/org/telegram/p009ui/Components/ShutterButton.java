...
public class ShutterButton extends View {
    ...
    private Drawable shadowDrawable = getResources().getDrawable(C0952R.C0953drawable.camera_btn);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        this.shadowDrawable.setBounds(measuredWidth - AndroidUtilities.m34dp(36.0f), measuredHeight - AndroidUtilities.m34dp(36.0f), AndroidUtilities.m34dp(36.0f) + measuredWidth, AndroidUtilities.m34dp(36.0f) + measuredHeight);
        ...
        if (this.pressed || getScaleX() != 1.0f) {
            ...
            canvas.drawCircle(f, f2, AndroidUtilities.m34dp(26.0f), this.whitePaint);
            if (this.state == State.RECORDING) {
                ...
                canvas.drawCircle(f, f2, AndroidUtilities.m34dp(26.5f) * scaleX * this.redProgress, this.redPaint);
            } else if (this.redProgress != 0.0f) {
                canvas.drawCircle(f, f2, AndroidUtilities.m34dp(26.5f) * scaleX, this.redPaint);
            }
        } else if (this.redProgress != 0.0f) {
    ...
    protected void onMeasure(int i, int i2) {
        setMeasuredDimension(AndroidUtilities.m34dp(84.0f), AndroidUtilities.m34dp(84.0f));
    }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(AccessibilityNodeInfo.AccessibilityAction.ACTION_CLICK.getId(), LocaleController.getString("AccActionTakePicture", C0952R.string.AccActionTakePicture)));
            accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(AccessibilityNodeInfo.AccessibilityAction.ACTION_LONG_CLICK.getId(), LocaleController.getString("AccActionRecordVideo", C0952R.string.AccActionRecordVideo)));
        }
    }
}
