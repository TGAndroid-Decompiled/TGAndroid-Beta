...
public class RecordStatusDrawable extends StatusDrawable {
    ...
    public void draw(Canvas canvas) {
        ...
        float f = 2.0f;
        if (paint.getStrokeWidth() != AndroidUtilities.m34dp(2.0f)) {
        ...
        canvas.translate(0.0f, intrinsicHeight + AndroidUtilities.m34dp(f));
        for (int i = 0; i < 4; i++) {
            if (i == 0) {
            ...
            float dp = (AndroidUtilities.m34dp(4.0f) * i) + (AndroidUtilities.m34dp(4.0f) * this.progress);
            float f2 = -dp;
