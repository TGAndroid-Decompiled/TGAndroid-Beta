...
public class BotWebViewMenuContainer extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public BotWebViewMenuContainer(Context context, ChatActivityEnterView chatActivityEnterView) {
        ...
        C16451 r2 = new C16451(chatActivityEnterView);
        ...
        ChatAttachAlertBotWebViewLayout.WebViewSwipeContainer webViewSwipeContainer = new ChatAttachAlertBotWebViewLayout.WebViewSwipeContainer(context) {
            ...
            protected void onMeasure(int r5, int r6) {
                throw new UnsupportedOperationException("Method not decompiled: org.telegram.p009ui.Components.BotWebViewMenuContainer.C16462.onMeasure(int, int):void");
            }
    ...
    public class C16451 implements BotWebViewContainer.Delegate {
        ...
        C16451(ChatActivityEnterView chatActivityEnterView) {
        ...
        public void onSetupMainButton(boolean z, boolean z2, String str, int i, int i2, boolean z3) {
            ...
            botWebViewButton.setOnClickListener(new View.OnClickListener() {
                ...
                public final void onClick(View view) {
                    BotWebViewMenuContainer.C16451.this.lambda$onSetupMainButton$0(view);
                }
            });
    ...
    public void lambda$animateBotButton$9(DynamicAnimation dynamicAnimation, float f, float f2) {
        ...
        this.parentEnterView.setBotWebViewButtonOffsetX(AndroidUtilities.m34dp(64.0f) * multiplier);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float dp = AndroidUtilities.m34dp(16.0f) * (1.0f - this.actionBarTransitionProgress);
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        if (motionEvent.getAction() != 0 || motionEvent.getY() > AndroidUtilities.lerp(this.swipeContainer.getTranslationY() + AndroidUtilities.m34dp(24.0f), 0.0f, this.actionBarTransitionProgress)) {
    ...
    public void show(int i, long j, String str) {
        ...
        if (!(this.currentAccount == i && this.botId == j && ObjectsCompat$$ExternalSyntheticBackport0.m677m(this.botUrl, str))) {
            this.isLoaded = false;
        }
        ...
        setVisibility(0);
        setAlpha(0.0f);
        addOnLayoutChangeListener(new View$OnLayoutChangeListenerC16506());
    }

    public class View$OnLayoutChangeListenerC16506 implements View.OnLayoutChangeListener {
        View$OnLayoutChangeListenerC16506() {
        }
        ...
        public void onLayoutChange(View view, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
            ...
            new SpringAnimation(BotWebViewMenuContainer.this.swipeContainer, ChatAttachAlertBotWebViewLayout.WebViewSwipeContainer.SWIPE_OFFSET_Y, 0.0f).setSpring(new SpringForce(0.0f).setDampingRatio(0.75f).setStiffness(500.0f)).addEndListener(new DynamicAnimation.OnAnimationEndListener() {
                @Override
                public final void onAnimationEnd(DynamicAnimation dynamicAnimation, boolean z, float f, float f2) {
                    BotWebViewMenuContainer.View$OnLayoutChangeListenerC16506.this.lambda$onLayoutChange$0(dynamicAnimation, z, f, f2);
                }
            }).start();
        }
