...
public class ProxyDrawable extends Drawable {
    ...
    public ProxyDrawable(Context context) {
        this.emptyDrawable = context.getResources().getDrawable(C1010R.C1011drawable.proxy_off);
        this.fullDrawable = context.getResources().getDrawable(C1010R.C1011drawable.proxy_on);
