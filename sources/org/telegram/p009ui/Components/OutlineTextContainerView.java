...
public class OutlineTextContainerView extends FrameLayout {
    ...
    private float strokeWidthRegular = Math.max(2, AndroidUtilities.m34dp(0.5f));
    private float strokeWidthSelected = AndroidUtilities.m34dp(1.5f);
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        float paddingTop = getPaddingTop() + ((this.textPaint.getTextSize() / 2.0f) - AndroidUtilities.m34dp(1.75f));
        ...
        canvas.save();
        this.rect.set(getPaddingLeft() + AndroidUtilities.m34dp(10.0f), getPaddingTop(), (getWidth() - AndroidUtilities.m34dp(18.0f)) - getPaddingRight(), getPaddingTop() + (strokeWidth * 2.0f));
        ...
        canvas.drawRoundRect(this.rect, AndroidUtilities.m34dp(6.0f), AndroidUtilities.m34dp(6.0f), this.outlinePaint);
        canvas.restore();
        float paddingLeft = getPaddingLeft() + AndroidUtilities.m34dp(10.0f);
        float paddingTop2 = getPaddingTop() + strokeWidth;
        float f3 = paddingLeft + (measureText / 2.0f);
        canvas.drawLine(f3 + ((((paddingLeft + measureText) + AndroidUtilities.m34dp(10.0f)) - f3) * (z ? this.selectionProgress : 1.0f)), paddingTop2, ((getWidth() - strokeWidth) - getPaddingRight()) - AndroidUtilities.m34dp(6.0f), paddingTop2, this.outlinePaint);
        float dp = f3 + AndroidUtilities.m34dp(4.0f);
        canvas.drawLine(paddingLeft, paddingTop2, dp + ((paddingLeft - dp) * (z ? this.selectionProgress : 1.0f)), paddingTop2, this.outlinePaint);
        canvas.save();
        canvas.scale(f2, f2, getPaddingLeft() + AndroidUtilities.m34dp(18.0f), f);
        canvas.drawText(this.mText, getPaddingLeft() + AndroidUtilities.m34dp(14.0f), f, this.textPaint);
        canvas.restore();
    }
}
