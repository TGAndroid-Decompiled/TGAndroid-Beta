...
public class GroupCallPipButton extends FrameLayout implements NotificationCenter.NotificationCenterDelegate, VoIPService.StateListener {
    ...
    public GroupCallPipButton(Context context, int i, boolean z) {
        ...
        this.blobDrawable.maxRadius = AndroidUtilities.m34dp(37.0f);
        this.blobDrawable.minRadius = AndroidUtilities.m34dp(32.0f);
        this.blobDrawable2.maxRadius = AndroidUtilities.m34dp(37.0f);
        this.blobDrawable2.minRadius = AndroidUtilities.m34dp(32.0f);
        this.blobDrawable.generateBlob();
        this.blobDrawable2.generateBlob();
        this.bigMicDrawable = new RLottieDrawable(C0952R.raw.voice_outlined, "2131558558", AndroidUtilities.m34dp(22.0f), AndroidUtilities.m34dp(30.0f), true, null);
        ...
        this.prepareToRemoveShader = new LinearGradient(0.0f, 0.0f, AndroidUtilities.m34dp(350.0f), 0.0f, new int[]{-2801343, -561538, 0}, new float[]{0.0f, 0.4f, 1.0f}, Shader.TileMode.CLAMP);
        if (z) {
            setState(0);
        }
    }
    ...
    public static class WeavingState {
        ...
        public void update(long j, float f) {
            ...
            int dp = AndroidUtilities.m34dp(130.0f);
    ...
    protected void onDraw(android.graphics.Canvas r19) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p009ui.Components.GroupCallPipButton.onDraw(android.graphics.Canvas):void");
    }
    ...
    public void setState(int i) {
        ...
        if (weavingState == null || weavingState.currentState != i) {
            ...
            if (sharedInstance == null || !ChatObject.isChannelOrGiga(sharedInstance.getChat())) {
                str = LocaleController.getString("VoipGroupVoiceChat", C0952R.string.VoipGroupVoiceChat);
            } else {
                str = LocaleController.getString("VoipChannelVoiceChat", C0952R.string.VoipChannelVoiceChat);
            }
            if (i == 0) {
                str = str + ", " + LocaleController.getString("VoipTapToMute", C0952R.string.VoipTapToMute);
            } else if (i == 2) {
                str = str + ", " + LocaleController.getString("Connecting", C0952R.string.Connecting);
            } else if (i == 3) {
                str = str + ", " + LocaleController.getString("VoipMutedByAdmin", C0952R.string.VoipMutedByAdmin);
            }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (Build.VERSION.SDK_INT >= 21 && GroupCallPip.getInstance() != null) {
            if (GroupCallPip.getInstance().showAlert) {
                i = C0952R.string.AccDescrCloseMenu;
                str = "AccDescrCloseMenu";
            } else {
                i = C0952R.string.AccDescrOpenMenu2;
