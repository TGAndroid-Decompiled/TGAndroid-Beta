...
public class PickerBottomLayout extends FrameLayout {
    ...
    public PickerBottomLayout(Context context, boolean z) {
        ...
        this.cancelButton.setPadding(AndroidUtilities.m34dp(33.0f), 0, AndroidUtilities.m34dp(33.0f), 0);
        ...
        this.doneButton.setPadding(AndroidUtilities.m34dp(33.0f), 0, AndroidUtilities.m34dp(33.0f), 0);
        ...
        this.doneButtonBadgeTextView.setBackgroundDrawable(Theme.createRoundRectDrawable(AndroidUtilities.m34dp(11.0f), Theme.getColor("picker_badge")));
        ...
        this.doneButtonTextView.setCompoundDrawablePadding(AndroidUtilities.m34dp(8.0f));
        this.doneButtonTextView.setText(LocaleController.getString("Send", C0890R.string.Send).toUpperCase());
