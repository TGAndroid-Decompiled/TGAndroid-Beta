...
public class ChatAttachAlertLocationLayout extends ChatAttachAlert.AttachAlertLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public class MapOverlayView extends FrameLayout {
        ...
        public void addInfoView(IMapsProvider.IMarker iMarker) {
            ...
            ChatAttachAlertLocationLayout.this.lastPressedMarkerView.setBackgroundResource(C1010R.C1011drawable.venue_tooltip);
            ...
            textView2.setText(LocaleController.getString("TapToSendLocation", C1010R.string.TapToSendLocation));
    ...
    public ChatAttachAlertLocationLayout(ChatAttachAlert chatAttachAlert, Context context, final Theme.ResourcesProvider resourcesProvider) {
        ...
        int currentActionBarHeight = (AndroidUtilities.displaySize.x - C1069ActionBar.getCurrentActionBarHeight()) - AndroidUtilities.m35dp(66.0f);
        ...
        new FrameLayout.LayoutParams(-1, AndroidUtilities.m35dp(21.0f)).gravity = 83;
        FrameLayout frameLayout = new FrameLayout(context) {
            @Override
        ...
        Drawable createSimpleSelectorRoundRectDrawable = Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m35dp(40.0f), getThemedColor("location_actionBackground"), getThemedColor("location_actionPressedBackground"));
        if (i < 21) {
            Drawable mutate = context.getResources().getDrawable(C1010R.C1011drawable.places_btn).mutate();
            mutate.setColorFilter(new PorterDuffColorFilter(-16777216, PorterDuff.Mode.MULTIPLY));
            CombinedDrawable combinedDrawable = new CombinedDrawable(mutate, createSimpleSelectorRoundRectDrawable, AndroidUtilities.m35dp(2.0f), AndroidUtilities.m35dp(2.0f));
        ...
        this.searchAreaButton.setText(LocaleController.getString("PlacesInThisArea", C1010R.string.PlacesInThisArea));
        ...
        this.mapTypeButton.addSubItem(2, C1010R.C1011drawable.msg_map, LocaleController.getString("Map", C1010R.string.Map), resourcesProvider);
        this.mapTypeButton.addSubItem(3, C1010R.C1011drawable.msg_satellite, LocaleController.getString("Satellite", C1010R.string.Satellite), resourcesProvider);
        this.mapTypeButton.addSubItem(4, C1010R.C1011drawable.msg_hybrid, LocaleController.getString("Hybrid", C1010R.string.Hybrid), resourcesProvider);
        this.mapTypeButton.setContentDescription(LocaleController.getString("AccDescrMoreOptions", C1010R.string.AccDescrMoreOptions));
        Drawable createSimpleSelectorCircleDrawable = Theme.createSimpleSelectorCircleDrawable(AndroidUtilities.m35dp(40.0f), getThemedColor("location_actionBackground"), getThemedColor("location_actionPressedBackground"));
        if (i < 21) {
            Drawable mutate2 = context.getResources().getDrawable(C1010R.C1011drawable.floating_shadow_profile).mutate();
            ...
            chatActivity = chatActivity2;
            stateListAnimator2.addState(new int[]{16842919}, ObjectAnimator.ofFloat(actionBarMenuItem3, property2, AndroidUtilities.m35dp(2.0f), AndroidUtilities.m35dp(4.0f)).setDuration(200L));
        ...
        this.mapTypeButton.setIcon(C1010R.C1011drawable.msg_map_type);
        ...
        Drawable createSimpleSelectorCircleDrawable2 = Theme.createSimpleSelectorCircleDrawable(AndroidUtilities.m35dp(40.0f), getThemedColor("location_actionBackground"), getThemedColor("location_actionPressedBackground"));
        if (i < 21) {
            Drawable mutate3 = context.getResources().getDrawable(C1010R.C1011drawable.floating_shadow_profile).mutate();
        ...
        this.locationButton.setImageResource(C1010R.C1011drawable.msg_current_location);
        ...
        this.locationButton.setContentDescription(LocaleController.getString("AccDescrMyLocation", C1010R.string.AccDescrMyLocation));
        ...
        imageView2.setImageResource(C1010R.C1011drawable.location_empty);
        ...
        this.emptyTitleTextView.setText(LocaleController.getString("NoPlacesFound", C1010R.string.NoPlacesFound));
        ...
        imageView3.setImageResource(C1010R.C1011drawable.map_pin2);
        ...
        LocationActivitySearchAdapter locationActivitySearchAdapter2 = new LocationActivitySearchAdapter(context) {
            ...
            public void notifyDataSetChanged() {
                ...
                if (ChatAttachAlertLocationLayout.this.emptySubtitleTextView != null) {
                    ChatAttachAlertLocationLayout.this.emptySubtitleTextView.setText(AndroidUtilities.replaceTags(LocaleController.formatString("NoPlacesFoundInfo", C1010R.string.NoPlacesFoundInfo, ChatAttachAlertLocationLayout.this.searchAdapter.getLastSearchString())));
                }
    ...
    public void lambda$new$12(IMapsProvider.IMap iMap) {
        ...
        if (isActiveThemeDark()) {
            ...
            this.map.setMapStyle(ApplicationLoader.getMapsProvider().loadRawResourceStyle(ApplicationLoader.applicationContext, C1010R.raw.mapstyle_night));
        }
        onMapInit();
    }
    ...
    public int getCurrentItemTop() {
        ...
        return (holder != null ? Math.max(((int) holder.itemView.getY()) - this.nonClipSize, 0) : 0) + AndroidUtilities.m35dp(56.0f);
    }
        ...
        if (this.checkGpsEnabled && getParentActivity() != null) {
            ...
            try {
                if (!((LocationManager) ApplicationLoader.applicationContext.getSystemService("location")).isProviderEnabled("gps")) {
                    ...
                    builder.setTopAnimation(C1010R.raw.permission_request_location, 72, false, Theme.getColor("dialogTopBackground"));
                    builder.setMessage(LocaleController.getString("GpsDisabledAlertText", C1010R.string.GpsDisabledAlertText));
                    builder.setPositiveButton(LocaleController.getString("ConnectingToProxyEnable", C1010R.string.ConnectingToProxyEnable), new DialogInterface.OnClickListener() {
                        @Override
    ...
    public void updateClipView() {
        ...
        if (((FrameLayout.LayoutParams) this.mapViewClip.getLayoutParams()) != null) {
            ...
            if (iMap2 != null) {
                iMap2.setPadding(0, AndroidUtilities.m35dp(6.0f), 0, this.clipSize + AndroidUtilities.m35dp(6.0f));
            }
            MapOverlayView mapOverlayView3 = this.overlayView;
            if (mapOverlayView3 != null) {
                mapOverlayView3.setTranslationY(f);
            }
            float min = Math.min(Math.max(this.nonClipSize - i, 0), (this.mapHeight - this.mapTypeButton.getMeasuredHeight()) - AndroidUtilities.m35dp(80.0f));
            ...
            int m35dp = (((this.mapHeight - this.clipSize) / 2) - AndroidUtilities.m35dp(48.0f)) + max;
            this.markerTop = m35dp;
            imageView.setTranslationY(m35dp);
            if (i4 != this.clipSize) {
    ...
    private int buttonsHeight() {
        int m35dp = AndroidUtilities.m35dp(66.0f);
        return this.locationType == 1 ? m35dp + AndroidUtilities.m35dp(66.0f) : m35dp;
    }
    ...
    private void fixLayoutInternal(boolean z) {
        ...
        int buttonsHeight = ((AndroidUtilities.displaySize.y - currentActionBarHeight) - buttonsHeight()) - AndroidUtilities.m35dp(90.0f);
        int m35dp = AndroidUtilities.m35dp(189.0f);
        this.overScrollHeight = m35dp;
        if (!this.locationDenied || !isTypeSend()) {
            buttonsHeight = Math.min(AndroidUtilities.m35dp(310.0f), buttonsHeight);
        }
        this.mapHeight = Math.max(m35dp, buttonsHeight);
        if (this.locationDenied && isTypeSend()) {
        ...
        if (layoutParams5 != null) {
            layoutParams5.height = this.mapHeight + AndroidUtilities.m35dp(10.0f);
        ...
        if (mapOverlayView != null && (layoutParams = (FrameLayout.LayoutParams) mapOverlayView.getLayoutParams()) != null) {
            layoutParams.height = this.mapHeight + AndroidUtilities.m35dp(10.0f);
    ...
    void onShow(ChatAttachAlert.AttachAlertLayout attachAlertLayout) {
        this.parentAlert.actionBar.setTitle(LocaleController.getString("ShareLocation", C1010R.string.ShareLocation));
        if (this.mapView.getView().getParent() == null) {
            this.mapViewClip.addView(this.mapView.getView(), 0, LayoutHelper.createFrame(-1, this.overScrollHeight + AndroidUtilities.m35dp(10.0f), 51));
