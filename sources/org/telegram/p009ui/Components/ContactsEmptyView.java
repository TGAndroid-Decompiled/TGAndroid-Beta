...
public class ContactsEmptyView extends LinearLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public ContactsEmptyView(Context context) {
        ...
        this.titleTextView.setText(LocaleController.getString("NoContactsYet", C0952R.string.NoContactsYet));
        this.titleTextView.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf"));
        this.titleTextView.setMaxWidth(AndroidUtilities.m34dp(260.0f));
        ...
        while (true) {
            ...
            if (i < 3) {
                ...
                if (i == 0) {
                    textView2.setText(LocaleController.getString("NoContactsYetLine1", C0952R.string.NoContactsYetLine1));
                } else if (i == 1) {
                    textView2.setText(LocaleController.getString("NoContactsYetLine2", C0952R.string.NoContactsYetLine2));
                } else if (i == 2) {
                    textView2.setText(LocaleController.getString("NoContactsYetLine3", C0952R.string.NoContactsYetLine3));
                }
