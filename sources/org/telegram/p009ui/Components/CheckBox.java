...
public class CheckBox extends View {
    ...
    public CheckBox(Context context, int i) {
        ...
        backgroundPaint.setStrokeWidth(AndroidUtilities.m34dp(2.0f));
        TextPaint textPaint = new TextPaint(1);
        this.textPaint = textPaint;
        textPaint.setTextSize(AndroidUtilities.m34dp(18.0f));
    ...
    public void setVisibility(int i) {
        ...
        if (i == 0 && this.drawBitmap == null) {
            try {
                ...
                this.checkBitmap = Bitmap.createBitmap(AndroidUtilities.m34dp(this.size), AndroidUtilities.m34dp(this.size), Bitmap.Config.ARGB_4444);
    ...
    protected void onDraw(android.graphics.Canvas r12) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p009ui.Components.CheckBox.onDraw(android.graphics.Canvas):void");
    }
