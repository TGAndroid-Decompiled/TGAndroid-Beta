...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private int indicatorHeight = AndroidUtilities.m34dp(8.0f);
    private int underlineHeight = AndroidUtilities.m34dp(2.0f);
    private int dividerPadding = AndroidUtilities.m34dp(12.0f);
    private int tabPadding = AndroidUtilities.m34dp(24.0f);
