...
public class TextSelectionHint extends View {
    ...
    int padding = AndroidUtilities.m34dp(24.0f);
    ...
    public TextSelectionHint(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m34dp(6.0f), getThemedColor("undo_background")));
    }
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (getMeasuredWidth() != this.lastW || this.textLayout == null) {
            Animator animator = this.f1079a;
            if (animator != null) {
                animator.removeAllListeners();
                this.f1079a.cancel();
            }
            String string = LocaleController.getString("TextSelectionHit", C0890R.string.TextSelectionHit);
        ...
        int height = this.textLayout.getHeight() + (AndroidUtilities.m34dp(8.0f) * 2);
        if (height < AndroidUtilities.m34dp(56.0f)) {
            height = AndroidUtilities.m34dp(56.0f);
        }
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.textLayout != null) {
            ...
            if (this.currentStart == this.animateToStart) {
                i = lineBottom2;
                f = f3;
                roundedRect(this.path, -AndroidUtilities.m34dp(4.0f), this.textLayout.getLineTop(lineForOffset2), 0.0f, this.textLayout.getLineBottom(lineForOffset2), AndroidUtilities.m34dp(4.0f), AndroidUtilities.m34dp(4.0f), true, false);
                canvas.drawPath(this.path, this.selectionPaint);
            } else {
                i = lineBottom2;
                f = f3;
            ...
            canvas.save();
            canvas.translate(((int) ((this.textLayout.getPrimaryHorizontal(this.animateToStart) - (AndroidUtilities.m34dp(4.0f) * (1.0f - this.startOffsetValue))) + ((this.textLayout.getPrimaryHorizontal(this.start) - this.textLayout.getPrimaryHorizontal(this.animateToStart)) * this.startOffsetValue))) - dp, i);
            float f4 = f;
