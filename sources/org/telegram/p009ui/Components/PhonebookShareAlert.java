...
public class PhonebookShareAlert extends BottomSheet {
    ...
    public class UserCell extends LinearLayout {
        public UserCell(PhonebookShareAlert phonebookShareAlert, Context context) {
            ...
            avatarDrawable.setTextSize(AndroidUtilities.m34dp(30.0f));
            avatarDrawable.setInfo(phonebookShareAlert.currentUser);
            BackupImageView backupImageView = new BackupImageView(context);
            backupImageView.setRoundRadius(AndroidUtilities.m34dp(40.0f));
    ...
    public class TextCheckBoxCell extends FrameLayout {
        ...
        protected void onMeasure(int i, int i2) {
            ...
            setMeasuredDimension(View.MeasureSpec.getSize(i), Math.max(AndroidUtilities.m34dp(64.0f), this.textView.getMeasuredHeight() + this.valueTextView.getMeasuredHeight() + AndroidUtilities.m34dp(20.0f)) + (this.needDivider ? 1 : 0));
        }

        @Override
        protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
            super.onLayout(z, i, i2, i3, i4);
            int measuredHeight = this.textView.getMeasuredHeight() + AndroidUtilities.m34dp(13.0f);
        ...
        protected void onDraw(Canvas canvas) {
            if (this.needDivider) {
                canvas.drawLine(LocaleController.isRTL ? 0.0f : AndroidUtilities.m34dp(70.0f), getMeasuredHeight() - 1, getMeasuredWidth() - (LocaleController.isRTL ? AndroidUtilities.m34dp(70.0f) : 0), getMeasuredHeight() - 1, Theme.dividerPaint);
            }
        }
    }
    ...
    public PhonebookShareAlert(org.telegram.p009ui.ActionBar.BaseFragment r20, org.telegram.messenger.ContactsController.Contact r21, org.telegram.tgnet.TLRPC$User r22, android.net.Uri r23, java.io.File r24, java.lang.String r25, java.lang.String r26, final org.telegram.p009ui.ActionBar.Theme.ResourcesProvider r27) {
        ...
        if (i == 0) {
            try {
                ...
                if (Build.VERSION.SDK_INT < 31) {
                    Toast.makeText(this.parentFragment.getParentActivity(), LocaleController.getString("TextCopied", C0952R.string.TextCopied), 0).show();
                }
            } catch (Exception e) {
                FileLog.m30e(e);
            }
    ...
    public boolean lambda$new$3(int i, Theme.ResourcesProvider resourcesProvider, Context context, View view) {
        ...
        if (BulletinFactory.canShowBulletin(this.parentFragment)) {
            if (vcardItem.type == 3) {
                ...
                int i4 = vcardItem.type;
                if (i4 == 0) {
                    simpleLayout.textView.setText(LocaleController.getString("PhoneCopied", C0952R.string.PhoneCopied));
                    simpleLayout.imageView.setImageResource(C0952R.C0953drawable.menu_calls);
                } else if (i4 == 1) {
                    simpleLayout.textView.setText(LocaleController.getString("EmailCopied", C0952R.string.EmailCopied));
                    simpleLayout.imageView.setImageResource(C0952R.C0953drawable.menu_mail);
                } else {
                    simpleLayout.textView.setText(LocaleController.getString("TextCopied", C0952R.string.TextCopied));
                    simpleLayout.imageView.setImageResource(C0952R.C0953drawable.menu_info);
                }
                if (Build.VERSION.SDK_INT < 31) {
    ...
    public void lambda$new$5(Theme.ResourcesProvider resourcesProvider, View view) {
        ...
        if (this.isImport) {
            ...
            builder.setTitle(LocaleController.getString("AddContactTitle", C0952R.string.AddContactTitle));
            builder.setNegativeButton(LocaleController.getString("Cancel", C0952R.string.Cancel), null);
            builder.setItems(new CharSequence[]{LocaleController.getString("CreateNewContact", C0952R.string.CreateNewContact), LocaleController.getString("AddToExistingContact", C0952R.string.AddToExistingContact)}, new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialogInterface, int i) {
                    ...
                    Intent intent2;
                    boolean z;
                    DialogInterface$OnClickListenerC22115 r1 = this;
                    int i3 = 1;
                    if (i == 0) {
        ...
        public void onBindViewHolder(View view, int i, int i2) {
            ...
            if (i2 == 1) {
                ...
                if (i < PhonebookShareAlert.this.phoneStartRow || i >= PhonebookShareAlert.this.phoneEndRow) {
                    ...
                    int i4 = vcardItem.type;
                    if (i4 == 1) {
                        i3 = C0952R.C0953drawable.menu_mail;
                    } else if (i4 == 2) {
                        i3 = C0952R.C0953drawable.menu_location;
                    } else if (i4 == 3) {
                        i3 = C0952R.C0953drawable.msg_link;
                    } else if (i4 == 4) {
                        i3 = C0952R.C0953drawable.profile_info;
                    } else if (i4 == 5) {
                        i3 = C0952R.C0953drawable.menu_date;
                    } else if (i4 == 6) {
                        i3 = "ORG".equalsIgnoreCase(vcardItem.getRawType(true)) ? C0952R.C0953drawable.menu_work : C0952R.C0953drawable.menu_jobtitle;
                    } else {
                        i3 = C0952R.C0953drawable.menu_info;
                    }
                } else {
                    vcardItem = (AndroidUtilities.VcardItem) PhonebookShareAlert.this.phones.get(i - PhonebookShareAlert.this.phoneStartRow);
                    i3 = C0952R.C0953drawable.menu_calls;
                }
                if (i == getItemCount() - 1) {
                    z = false;
                }
