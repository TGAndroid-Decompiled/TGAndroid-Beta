...
public class PhonebookShareAlert extends BottomSheet {
    ...
    public class UserCell extends LinearLayout {
        public UserCell(PhonebookShareAlert phonebookShareAlert, Context context) {
            ...
            avatarDrawable.setTextSize(AndroidUtilities.m36dp(30.0f));
            avatarDrawable.setInfo(phonebookShareAlert.currentUser);
            BackupImageView backupImageView = new BackupImageView(context);
            backupImageView.setRoundRadius(AndroidUtilities.m36dp(40.0f));
    ...
    public class TextCheckBoxCell extends FrameLayout {
        ...
        protected void onMeasure(int i, int i2) {
            ...
            setMeasuredDimension(View.MeasureSpec.getSize(i), Math.max(AndroidUtilities.m36dp(64.0f), this.textView.getMeasuredHeight() + this.valueTextView.getMeasuredHeight() + AndroidUtilities.m36dp(20.0f)) + (this.needDivider ? 1 : 0));
        }

        @Override
        protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
            super.onLayout(z, i, i2, i3, i4);
            int measuredHeight = this.textView.getMeasuredHeight() + AndroidUtilities.m36dp(13.0f);
        ...
        if (i == 0) {
            try {
                ...
                if (AndroidUtilities.shouldShowClipboardToast()) {
                    Toast.makeText(this.parentFragment.getParentActivity(), LocaleController.getString("TextCopied", C1072R.string.TextCopied), 0).show();
                }
            } catch (Exception e) {
                FileLog.m32e(e);
            }
    ...
    public boolean lambda$new$3(int i, Theme.ResourcesProvider resourcesProvider, Context context, View view) {
        ...
        if (BulletinFactory.canShowBulletin(this.parentFragment)) {
            if (vcardItem.type == 3) {
                BulletinFactory.m15of((FrameLayout) this.containerView, resourcesProvider).createCopyLinkBulletin().show();
            } else {
                Bulletin.SimpleLayout simpleLayout = new Bulletin.SimpleLayout(context, resourcesProvider);
                int i4 = vcardItem.type;
                if (i4 == 0) {
                    simpleLayout.textView.setText(LocaleController.getString("PhoneCopied", C1072R.string.PhoneCopied));
                    simpleLayout.imageView.setImageResource(C1072R.C1073drawable.msg_calls);
                } else if (i4 == 1) {
                    simpleLayout.textView.setText(LocaleController.getString("EmailCopied", C1072R.string.EmailCopied));
                    simpleLayout.imageView.setImageResource(C1072R.C1073drawable.msg_mention);
                } else {
                    simpleLayout.textView.setText(LocaleController.getString("TextCopied", C1072R.string.TextCopied));
                    simpleLayout.imageView.setImageResource(C1072R.C1073drawable.msg_info);
                }
                if (AndroidUtilities.shouldShowClipboardToast()) {
    ...
    public void lambda$new$5(Theme.ResourcesProvider resourcesProvider, View view) {
        ...
        if (this.isImport) {
            ...
            builder.setTitle(LocaleController.getString("AddContactTitle", C1072R.string.AddContactTitle));
            builder.setNegativeButton(LocaleController.getString("Cancel", C1072R.string.Cancel), null);
            builder.setItems(new CharSequence[]{LocaleController.getString("CreateNewContact", C1072R.string.CreateNewContact), LocaleController.getString("AddToExistingContact", C1072R.string.AddToExistingContact)}, new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialogInterface, int i) {
                    ...
                    int i2;
                    boolean z;
                    DialogInterface$OnClickListenerC25465 dialogInterface$OnClickListenerC25465 = this;
                    int i3 = 1;
                    if (i == 0) {
                    ...
                    for (int i4 = 0; i4 < PhonebookShareAlert.this.phones.size(); i4++) {
                        ...
                        dialogInterface$OnClickListenerC25465.fillRowWithType(vcardItem.getRawType(false), contentValues);
                    ...
                    while (i5 < PhonebookShareAlert.this.other.size()) {
                        ...
                        if (i6 == i3) {
                            ...
                            dialogInterface$OnClickListenerC25465.fillRowWithType(vcardItem2.getRawType(z2), contentValues2);
                            arrayList.add(contentValues2);
                        } else if (i6 == 3) {
                            ContentValues contentValues3 = new ContentValues();
                            contentValues3.put("mimetype", "vnd.android.cursor.item/website");
                            contentValues3.put("data1", vcardItem2.getValue(z2));
                            dialogInterface$OnClickListenerC25465.fillUrlRowWithType(vcardItem2.getRawType(z2), contentValues3);
                            ...
                            if (i6 == 2) {
                                ...
                                if (i6 == 20) {
                                    ...
                                    dialogInterface$OnClickListenerC25465 = this;
        ...
        public void onBindViewHolder(View view, int i, int i2) {
            ...
            if (i2 == 1) {
                ...
                if (i < PhonebookShareAlert.this.phoneStartRow || i >= PhonebookShareAlert.this.phoneEndRow) {
                    ...
                    int i4 = vcardItem.type;
                    if (i4 == 1) {
                        i3 = C1072R.C1073drawable.msg_mention;
                    } else if (i4 == 2) {
                        i3 = C1072R.C1073drawable.msg_location;
                    } else if (i4 == 3) {
                        i3 = C1072R.C1073drawable.msg_link;
                    } else if (i4 == 4) {
                        i3 = C1072R.C1073drawable.msg_info;
                    } else if (i4 == 5) {
                        i3 = C1072R.C1073drawable.msg_calendar2;
                    } else if (i4 == 6) {
                        if ("ORG".equalsIgnoreCase(vcardItem.getRawType(true))) {
                            i3 = C1072R.C1073drawable.msg_work;
                        } else {
                            i3 = C1072R.C1073drawable.msg_jobtitle;
                        }
                    } else if (i4 == 20) {
                        i3 = C1072R.C1073drawable.msg_info;
                    } else {
