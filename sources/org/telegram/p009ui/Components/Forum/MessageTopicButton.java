...
import org.telegram.p009ui.Components.AnimatedColor;
...
public class MessageTopicButton {
    ...
    public int set(org.telegram.p009ui.Cells.ChatMessageCell r29, org.telegram.messenger.MessageObject r30, org.telegram.tgnet.TLRPC$TL_forumTopic r31, int r32) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p009ui.Components.Forum.MessageTopicButton.set(org.telegram.ui.Cells.ChatMessageCell, org.telegram.messenger.MessageObject, org.telegram.tgnet.TLRPC$TL_forumTopic, int):int");
    }
    ...
    public void draw(Canvas canvas, float f, float f2, float f3) {
        ...
        if (this.topicNameLayout != null) {
            canvas.save();
            canvas.translate((AndroidUtilities.m35dp(this.isGeneralTopic ? 13.0f : 17.0f) + Theme.chat_topicTextPaint.getTextSize()) - this.topicNameLeft, AndroidUtilities.m35dp(4.5f));
