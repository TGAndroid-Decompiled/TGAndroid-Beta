...
public class NumberTextView extends View {
    ...
    public void setTextSize(int i) {
        this.textPaint.setTextSize(AndroidUtilities.m34dp(i));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (!this.letters.isEmpty()) {
            ...
            float dp = this.addNumber ? AndroidUtilities.m34dp(4.0f) : height;
            if (this.center) {
            ...
            while (i < max) {
                ...
                canvas.restore();
                canvas.translate(staticLayout != null ? staticLayout.getLineWidth(0) : staticLayout2.getLineWidth(0) + AndroidUtilities.m34dp(1.0f), 0.0f);
