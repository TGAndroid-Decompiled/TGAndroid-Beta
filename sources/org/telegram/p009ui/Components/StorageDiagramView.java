...
public class StorageDiagramView extends View {
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m34dp(110.0f), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m34dp(110.0f), 1073741824));
        this.rectF.set(AndroidUtilities.m34dp(3.0f), AndroidUtilities.m34dp(3.0f), getMeasuredWidth() - AndroidUtilities.m34dp(3.0f), getMeasuredHeight() - AndroidUtilities.m34dp(3.0f));
        updateDescription();
        this.textPaint.setTextSize(AndroidUtilities.m34dp(24.0f));
        this.textPaint.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf"));
        this.textPaint2.setTextSize(AndroidUtilities.m34dp(13.0f));
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.data != null) {
            ...
            if (this.layout1 != null) {
                canvas.save();
                canvas4.translate((getMeasuredWidth() - this.layout1.getWidth()) >> 1, (((getMeasuredHeight() - this.layout1.getHeight()) - this.layout2.getHeight()) >> 1) + AndroidUtilities.m34dp(2.0f));
    ...
    public static class ClearViewData {
        ...
        public ClearViewData(StorageDiagramView storageDiagramView) {
            ...
            this.paint.setStrokeWidth(AndroidUtilities.m34dp(5.0f));
