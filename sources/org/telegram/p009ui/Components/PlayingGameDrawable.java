...
public class PlayingGameDrawable extends StatusDrawable {
    ...
    public void draw(Canvas canvas) {
        ...
        if (!this.isChat) {
            intrinsicHeight += AndroidUtilities.m34dp(1.0f);
        }
        ...
        for (int i3 = 0; i3 < 3; i3++) {
            ...
            float dp2 = ((AndroidUtilities.m34dp(5.0f) * i3) + AndroidUtilities.m34dp(9.2f)) - (AndroidUtilities.m34dp(5.0f) * f2);
            if (i3 == 2) {
            ...
            canvas.drawCircle(dp2, (dp / 2) + i, AndroidUtilities.m34dp(1.2f), this.paint);
        }
        this.paint.setAlpha(255);
        ...
        canvas.drawCircle(AndroidUtilities.m34dp(4.0f), (i + (dp / 2)) - AndroidUtilities.m34dp(2.0f), AndroidUtilities.m34dp(1.0f), this.paint);
        checkUpdate();
    }
    ...
    public int getIntrinsicWidth() {
        return AndroidUtilities.m34dp(20.0f);
    }
