...
public class AutoDeletePopupWrapper {
    ...
    public AutoDeletePopupWrapper(final Context context, final PopupSwipeBackLayout popupSwipeBackLayout, final Callback callback, boolean z, final int i, final Theme.ResourcesProvider resourcesProvider) {
        ActionBarPopupWindow.ActionBarPopupWindowLayout actionBarPopupWindowLayout = new ActionBarPopupWindow.ActionBarPopupWindowLayout(context, z ? C1010R.C1011drawable.popup_fixed_alert : 0, resourcesProvider);
        this.windowLayout = actionBarPopupWindowLayout;
        actionBarPopupWindowLayout.setFitItems(true);
        this.callback = callback;
        if (popupSwipeBackLayout != null) {
            ActionBarMenuSubItem addItem = ActionBarMenuItem.addItem(this.windowLayout, C1010R.C1011drawable.msg_arrow_back, LocaleController.getString("Back", C1010R.string.Back), false, resourcesProvider);
        ...
        ActionBarMenuItem.addItem(this.windowLayout, C1010R.C1011drawable.msg_autodelete_1d, LocaleController.getString("AutoDelete1Day", C1010R.string.AutoDelete1Day), false, resourcesProvider).setOnClickListener(new View.OnClickListener() {
            @Override
            public final void onClick(View view) {
                AutoDeletePopupWrapper.this.lambda$new$1(callback, view);
            }
        });
        ActionBarMenuItem.addItem(this.windowLayout, C1010R.C1011drawable.msg_autodelete_1w, LocaleController.getString("AutoDelete7Days", C1010R.string.AutoDelete7Days), false, resourcesProvider).setOnClickListener(new View.OnClickListener() {
            @Override
            public final void onClick(View view) {
                AutoDeletePopupWrapper.this.lambda$new$2(callback, view);
            }
        });
        ActionBarMenuItem.addItem(this.windowLayout, C1010R.C1011drawable.msg_autodelete_1m, LocaleController.getString("AutoDelete1Month", C1010R.string.AutoDelete1Month), false, resourcesProvider).setOnClickListener(new View.OnClickListener() {
            @Override
            public final void onClick(View view) {
                AutoDeletePopupWrapper.this.lambda$new$3(callback, view);
            }
        });
        ActionBarMenuItem.addItem(this.windowLayout, C1010R.C1011drawable.msg_customize, i == 1 ? LocaleController.getString("AutoDeleteCustom2", C1010R.string.AutoDeleteCustom2) : LocaleController.getString("AutoDeleteCustom", C1010R.string.AutoDeleteCustom), false, resourcesProvider).setOnClickListener(new View.OnClickListener() {
            @Override
            public final void onClick(View view) {
                AutoDeletePopupWrapper.this.lambda$new$5(context, i, resourcesProvider, callback, view);
            }
        });
        ActionBarMenuSubItem addItem2 = ActionBarMenuItem.addItem(this.windowLayout, C1010R.C1011drawable.msg_disable, LocaleController.getString("AutoDeleteDisable", C1010R.string.AutoDeleteDisable), false, resourcesProvider);
        ...
        if (i != 1) {
            ...
            view.setBackground(Theme.getThemedDrawable(context, C1010R.C1011drawable.greydivider, "windowBackgroundGrayShadow", resourcesProvider));
            frameLayout.addView(view, LayoutHelper.createFrame(-1, -1.0f));
            int i2 = C1010R.C1012id.fit_width_tag;
            ...
            this.textView.setText(LocaleController.getString("AutoDeletePopupDescription", C1010R.string.AutoDeletePopupDescription));
    ...
    public void allowExtenededHint() {
        ...
        spannableStringBuilder.append((CharSequence) LocaleController.getString("AutoDeletePopupDescription", C1010R.string.AutoDeletePopupDescription));
        spannableStringBuilder.append((CharSequence) "\n\n");
        spannableStringBuilder.append(AndroidUtilities.replaceSingleTag(LocaleController.getString("AutoDeletePopupDescription2", C1010R.string.AutoDeletePopupDescription2), new Runnable() {
            @Override
            public final void run() {
