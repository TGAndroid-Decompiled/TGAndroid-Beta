...
public class HintView extends FrameLayout {
    ...
    public HintView(Context context, int i, boolean z, Theme.ResourcesProvider resourcesProvider) {
        ...
        if (i == 7 || i == 8 || i == 9) {
            this.textView.setMaxWidth(AndroidUtilities.m34dp(310.0f));
        } else if (i == 4) {
            this.textView.setMaxWidth(AndroidUtilities.m34dp(280.0f));
        } else {
            this.textView.setMaxWidth(AndroidUtilities.m34dp(250.0f));
        }
        if (this.currentType == 3) {
            this.textView.setGravity(19);
            this.textView.setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m34dp(5.0f), getThemedColor("chat_gifSaveHintBackground")));
            this.textView.setPadding(AndroidUtilities.m34dp(10.0f), 0, AndroidUtilities.m34dp(10.0f), 0);
    ...
    public void setBackgroundColor(int i, int i2) {
        ...
        textView.setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m34dp((i3 == 7 || i3 == 8) ? 6.0f : 3.0f), i));
    }
    ...
    public boolean showForMessageCell(ChatMessageCell chatMessageCell, Object obj, int i, int i2, boolean z) {
        ...
        if (i7 == 0) {
            ...
            if (i6 <= getMeasuredHeight() + AndroidUtilities.m34dp(10.0f) || i8 > measuredHeight + (imageHeight / 4)) {
                return false;
            }
            ...
            if (currentUser == null || currentUser.f985id != 0) {
                ...
                if (this.isTopArrow && i6 <= getMeasuredHeight() + AndroidUtilities.m34dp(10.0f)) {
                    return false;
                }
                i3 = chatMessageCell.getForwardNameCenterX();
            } else {
                dp = (chatMessageCell.getMeasuredHeight() - Math.max(0, chatMessageCell.getBottom() - view.getMeasuredHeight())) - AndroidUtilities.m34dp(50.0f);
            }
            i6 += dp;
            if (this.isTopArrow) {
            }
        ...
        if (this.isTopArrow) {
            ...
            float dp2 = AndroidUtilities.m34dp(44.0f);
        ...
        int dp3 = AndroidUtilities.m34dp(19.0f);
        if (this.currentType == 5) {
            int max = Math.max(0, (i3 - (getMeasuredWidth() / 2)) - AndroidUtilities.m34dp(19.1f));
            setTranslationX(max);
            dp3 += max;
        } else if (left > view.getMeasuredWidth() / 2) {
            int measuredWidth2 = (measuredWidth - getMeasuredWidth()) - AndroidUtilities.m34dp(38.0f);
        ...
        if (left > view.getMeasuredWidth() / 2) {
            if (left2 < AndroidUtilities.m34dp(10.0f)) {
                float dp4 = left2 - AndroidUtilities.m34dp(10.0f);
                setTranslationX(getTranslationX() + dp4);
                this.arrowImageView.setTranslationX(left2 - dp4);
            }
        } else if (left2 > getMeasuredWidth() - AndroidUtilities.m34dp(24.0f)) {
            float measuredWidth3 = (left2 - getMeasuredWidth()) + AndroidUtilities.m34dp(24.0f);
            setTranslationX(measuredWidth3);
            this.arrowImageView.setTranslationX(left2 - measuredWidth3);
        } else if (left2 < AndroidUtilities.m34dp(10.0f)) {
            float dp5 = left2 - AndroidUtilities.m34dp(10.0f);
        ...
        if (z) {
            ...
            this.animatorSet.addListener(new C21051());
    ...
    public class C21051 extends AnimatorListenerAdapter {
        C21051() {
        }
        ...
        public void onAnimationEnd(Animator animator) {
            ...
            AndroidUtilities.runOnUIThread(HintView.this.hideRunnable = new Runnable() {
                ...
                public final void run() {
                    HintView.C21051.this.lambda$onAnimationEnd$0();
                }
    ...
    public boolean showForView(View view, boolean z) {
        ...
        if (z) {
            ...
            this.animatorSet = animatorSet2;
            animatorSet2.playTogether(ObjectAnimator.ofFloat(this, View.ALPHA, 0.0f, 1.0f));
            this.animatorSet.addListener(new C21062());
            this.animatorSet.setDuration(300L);
            this.animatorSet.start();
        } else {
            setAlpha(1.0f);
    ...
    public class C21062 extends AnimatorListenerAdapter {
        C21062() {
        }
        ...
        public void onAnimationEnd(Animator animator) {
            ...
            AndroidUtilities.runOnUIThread(HintView.this.hideRunnable = new Runnable() {
                @Override
                public final void run() {
                    HintView.C21062.this.lambda$onAnimationEnd$0();
                }
