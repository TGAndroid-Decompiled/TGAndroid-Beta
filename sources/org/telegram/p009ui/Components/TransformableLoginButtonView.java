...
public class TransformableLoginButtonView extends View {
    ...
    public TransformableLoginButtonView(Context context) {
        ...
        this.outlinePaint.setStrokeWidth(AndroidUtilities.m34dp(2.0f));
    ...
    protected void onDraw(Canvas canvas) {
        if (this.drawBackground) {
            float dp = AndroidUtilities.m34dp(((this.transformType == 0 ? this.progress : 1.0f) * 26.0f) + 6.0f);
        ...
        if (i == 0) {
            ...
            if (!(textPaint == null || this.buttonText == null)) {
                ...
                canvas.drawText(this.buttonText, (getWidth() - this.buttonWidth) / 2.0f, ((getHeight() / 2.0f) + (this.textPaint.getTextSize() / 2.0f)) - AndroidUtilities.m34dp(1.75f), this.textPaint);
                this.textPaint.setAlpha(alpha);
            }
            float max = (Math.max(0.4f, this.progress) - 0.4f) / 0.6f;
            if (max != 0.0f) {
                float dp2 = AndroidUtilities.m34dp(21.0f) + ((getWidth() - (AndroidUtilities.m34dp(21.0f) * 2)) * max);
                float height = getHeight() / 2.0f;
                canvas.drawLine(AndroidUtilities.m34dp(21.0f), height, dp2, height, this.outlinePaint);
                double d = dp2;
                double cos = Math.cos(0.7853981633974483d);
                double dp3 = AndroidUtilities.m34dp(9.0f) * max;
                Double.isNaN(dp3);
                Double.isNaN(d);
            ...
            float dp4 = AndroidUtilities.m34dp(21.0f);
            float width = getWidth() - AndroidUtilities.m34dp(21.0f);
            float height2 = getHeight() / 2.0f;
            canvas.save();
            canvas.translate((-AndroidUtilities.m34dp(2.0f)) * this.progress, 0.0f);
            ...
            int dp5 = AndroidUtilities.m34dp((this.progress * (-1.0f)) + 9.0f);
            int dp6 = AndroidUtilities.m34dp((this.progress * 7.0f) + 9.0f);
            double d2 = width;
            double d3 = dp5;
