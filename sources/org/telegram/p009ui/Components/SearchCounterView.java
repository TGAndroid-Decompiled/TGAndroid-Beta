...
public class SearchCounterView extends View {
        ...
        if (str3 == null || !str3.equals(str2)) {
            ...
            if (!z2) {
                ...
                if (str2 == null) {
                    ...
                    this.countWidth = Math.max(AndroidUtilities.m34dp(12.0f), (int) Math.ceil(this.textPaint.measureText(str2)));
            ...
            if (z2) {
                ...
                if (this.countLayout != null) {
                    ...
                    int max = Math.max(AndroidUtilities.m34dp(12.0f), (int) Math.ceil(this.textPaint.measureText(str4)));
                    int max2 = Math.max(AndroidUtilities.m34dp(12.0f), (int) Math.ceil(this.textPaint.measureText(str2)));
                    ...
                    this.f1068dx = this.countOldLayout.getPrimaryHorizontal(i2) - this.countAnimationStableLayout.getPrimaryHorizontal(i3);
                }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.countChangeProgress != 1.0f) {
            float measuredHeight = (getMeasuredHeight() - AndroidUtilities.m34dp(23.0f)) / 2.0f;
            ...
            float f3 = this.f1069x;
            rectF.set(f3, measuredHeight, f + f3 + AndroidUtilities.m34dp(11.0f), AndroidUtilities.m34dp(23.0f) + measuredHeight);
            boolean z = this.countAnimationIncrement;
            if (this.countAnimationInLayout != null) {
                canvas.save();
                float f4 = this.countLeft;
                float dp = AndroidUtilities.m34dp(2.0f) + measuredHeight;
                ...
                float dp3 = AndroidUtilities.m34dp(2.0f) + measuredHeight;
                int dp4 = AndroidUtilities.m34dp(13.0f);
                if (!z) {
                    dp4 = -dp4;
                }
            ...
            if (this.countOldLayout != null) {
                canvas.save();
                canvas.translate(this.countLeft, AndroidUtilities.m34dp(2.0f) + measuredHeight + ((z ? -AndroidUtilities.m34dp(13.0f) : AndroidUtilities.m34dp(13.0f)) * this.countChangeProgress));
            ...
            if (this.countAnimationStableLayout != null) {
                canvas.save();
                canvas.translate(this.countLeft + (this.f1068dx * (1.0f - this.countChangeProgress)), AndroidUtilities.m34dp(2.0f) + measuredHeight);
            ...
            if (this.countAnimationStableLayout2 != null) {
                canvas.save();
                canvas.translate(this.countLeft, measuredHeight + AndroidUtilities.m34dp(2.0f));
                this.textPaint.setAlpha(255);
    ...
    private void updateX(float f) {
        int i = this.gravity;
        if (i == 5) {
            float measuredWidth = getMeasuredWidth() - AndroidUtilities.m34dp(5.5f);
            ...
            this.countLeft = AndroidUtilities.m34dp(5.5f);
        } else {
            this.countLeft = (int) ((getMeasuredWidth() - f) / 2.0f);
        }
        this.f1069x = this.countLeft - AndroidUtilities.m34dp(5.5f);
    }
