...
public class SearchCounterView extends View {
        ...
        if (str3 == null || !str3.equals(str2)) {
            ...
            if (z2) {
                ...
                if (this.countLayout != null) {
                    ...
                    this.f1086dx = this.countOldLayout.getPrimaryHorizontal(i2) - this.countAnimationStableLayout.getPrimaryHorizontal(i3);
                }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.countChangeProgress != 1.0f) {
            ...
            if (this.countAnimationStableLayout != null) {
                canvas.save();
                canvas.translate(this.countLeft + (this.f1086dx * (1.0f - this.countChangeProgress)), AndroidUtilities.m34dp(2.0f) + measuredHeight);
    ...
    private void updateX(float f) {
        ...
        this.f1087x = this.countLeft - AndroidUtilities.m34dp(5.5f);
    }
