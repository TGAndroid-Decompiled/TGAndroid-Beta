...
public class SearchCounterView extends View {
        ...
        if (str3 == null || !str3.equals(str2)) {
            ...
            if (!z2) {
                ...
                if (str2 == null) {
                    ...
                    this.countWidth = Math.max(AndroidUtilities.m36dp(12.0f), (int) Math.ceil(this.textPaint.measureText(str2)));
            ...
            if (z2) {
                ...
                if (this.countLayout != null) {
                    ...
                    int max = Math.max(AndroidUtilities.m36dp(12.0f), (int) Math.ceil(this.textPaint.measureText(str4)));
                    int max2 = Math.max(AndroidUtilities.m36dp(12.0f), (int) Math.ceil(this.textPaint.measureText(str2)));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.countChangeProgress != 1.0f) {
            float measuredHeight = (getMeasuredHeight() - AndroidUtilities.m36dp(23.0f)) / 2.0f;
            ...
            rectF.set(f3, measuredHeight, f + f3 + AndroidUtilities.m36dp(11.0f), AndroidUtilities.m36dp(23.0f) + measuredHeight);
            boolean z = this.countAnimationIncrement;
            if (this.countAnimationInLayout != null) {
                canvas.save();
                float f4 = this.countLeft;
                float m36dp = AndroidUtilities.m36dp(2.0f) + measuredHeight;
                int m36dp2 = AndroidUtilities.m36dp(13.0f);
                if (!z) {
                    m36dp2 = -m36dp2;
                }
                canvas.translate(f4, m36dp + (m36dp2 * (1.0f - this.countChangeProgress)));
                ...
                float m36dp3 = AndroidUtilities.m36dp(2.0f) + measuredHeight;
                int m36dp4 = AndroidUtilities.m36dp(13.0f);
                if (!z) {
                    m36dp4 = -m36dp4;
                }
                canvas.translate(f5, m36dp3 + (m36dp4 * (1.0f - this.countChangeProgress)));
                this.textPaint.setAlpha((int) (this.countChangeProgress * 255.0f));
            ...
            if (this.countOldLayout != null) {
                canvas.save();
                canvas.translate(this.countLeft, AndroidUtilities.m36dp(2.0f) + measuredHeight + ((z ? -AndroidUtilities.m36dp(13.0f) : AndroidUtilities.m36dp(13.0f)) * this.countChangeProgress));
            ...
            if (this.countAnimationStableLayout != null) {
                canvas.save();
                canvas.translate(this.countLeft + (this.f1139dx * (1.0f - this.countChangeProgress)), AndroidUtilities.m36dp(2.0f) + measuredHeight);
            ...
            if (this.countAnimationStableLayout2 != null) {
                canvas.save();
                canvas.translate(this.countLeft, measuredHeight + AndroidUtilities.m36dp(2.0f));
                this.textPaint.setAlpha(255);
    ...
    private void updateX(float f) {
        int i = this.gravity;
        if (i == 5) {
            float measuredWidth = getMeasuredWidth() - AndroidUtilities.m36dp(5.5f);
            ...
            this.countLeft = AndroidUtilities.m36dp(5.5f);
        } else {
            this.countLeft = (int) ((getMeasuredWidth() - f) / 2.0f);
        }
        this.f1140x = this.countLeft - AndroidUtilities.m36dp(5.5f);
    }
