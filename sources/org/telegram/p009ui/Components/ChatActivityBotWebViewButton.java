...
public class ChatActivityBotWebViewButton extends FrameLayout {
    ...
    public void draw(Canvas canvas) {
        canvas.save();
        float height = (getHeight() - AndroidUtilities.m34dp(32.0f)) / 2.0f;
        float max = Math.max((getWidth() - this.menuButtonWidth) - AndroidUtilities.m34dp(4.0f), getHeight()) * this.progress;
        float dp = AndroidUtilities.m34dp(16.0f) + max;
        RectF rectF = AndroidUtilities.rectTmp;
        rectF.set(AndroidUtilities.m34dp(14.0f) - max, (AndroidUtilities.m34dp(4.0f) + height) - max, AndroidUtilities.m34dp(6.0f) + this.menuButtonWidth + max, (getHeight() - AndroidUtilities.m34dp(12.0f)) + max);
        this.path.rewind();
        ...
        canvas.translate(AndroidUtilities.m34dp(10.0f), height);
        ...
        canvas.restore();
        canvas.translate((-AndroidUtilities.m34dp(8.0f)) * (1.0f - this.progress), 0.0f);
        super.draw(canvas);
        canvas.restore();
    }
}
