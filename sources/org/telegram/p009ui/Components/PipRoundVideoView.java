...
public class PipRoundVideoView implements NotificationCenter.NotificationCenterDelegate {
            ...
            FrameLayout frameLayout = new FrameLayout(activity) {
                ...
                protected void onDraw(Canvas canvas) {
                    ...
                    if (drawable != null) {
                        ...
                        Theme.chat_roundVideoShadow.setBounds(AndroidUtilities.m34dp(1.0f), AndroidUtilities.m34dp(2.0f), AndroidUtilities.m34dp(125.0f), AndroidUtilities.m34dp(125.0f));
                        Theme.chat_roundVideoShadow.draw(canvas);
                        Theme.chat_docBackPaint.setColor(Theme.getColor("chat_inBubble"));
                        Theme.chat_docBackPaint.setAlpha((int) (getAlpha() * 255.0f));
                        canvas.drawCircle(AndroidUtilities.m34dp(63.0f), AndroidUtilities.m34dp(63.0f), AndroidUtilities.m34dp(59.5f), Theme.chat_docBackPaint);
                    }
                }
            };
            this.windowView = frameLayout;
            frameLayout.setWillNotDraw(false);
            this.videoWidth = AndroidUtilities.m34dp(126.0f);
            this.videoHeight = AndroidUtilities.m34dp(126.0f);
    ...
    public void animateToBoundsMaybe() {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p009ui.Components.PipRoundVideoView.animateToBoundsMaybe():void");
    }
