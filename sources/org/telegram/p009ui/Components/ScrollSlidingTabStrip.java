...
public class ScrollSlidingTabStrip extends HorizontalScrollView {
    ...
    private int scrollOffset = AndroidUtilities.m34dp(36.0f);
    ...
    private float stickerTabWidth = AndroidUtilities.m34dp(36.0f);
    ...
    public void expandStickers(final float f, final boolean z) {
        if (this.expanded != z) {
                ...
                public void onAnimationEnd(Animator animator) {
                    ...
                    if (!z) {
                        ...
                        for (int i2 = 0; i2 < ScrollSlidingTabStrip.this.tabsContainer.getChildCount(); i2++) {
                            ...
                            childAt.getLayoutParams().width = AndroidUtilities.m34dp(36.0f);
                        }
                        ScrollSlidingTabStrip scrollSlidingTabStrip3 = ScrollSlidingTabStrip.this;
                        scrollSlidingTabStrip3.animateToExpanded = false;
                        scrollSlidingTabStrip3.getLayoutParams().height = AndroidUtilities.m34dp(36.0f);
            ...
            if (z) {
                ...
                getLayoutParams().height = AndroidUtilities.m34dp(86.0f);
            }
            if (z) {
    ...
    public void setImages() {
        ...
        int scrollX = (int) ((getScrollX() - (this.animateToExpanded ? this.expandOffset * (1.0f - f) : 0.0f)) / (AndroidUtilities.m34dp(36.0f) + (AndroidUtilities.m34dp(50.0f) * f)));
    ...
    public int getTabSize() {
        return AndroidUtilities.m34dp(this.animateToExpanded ? 86.0f : 36.0f);
    }
