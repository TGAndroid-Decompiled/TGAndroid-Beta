...
public class ReorderingHintDrawable extends Drawable {
    ...
    private final int intrinsicWidth = AndroidUtilities.m36dp(24.0f);
    private final int intrinsicHeight = AndroidUtilities.m36dp(24.0f);
    ...
    private void drawStage1(Canvas canvas, float f) {
        ...
        this.tempRect.left = (int) (AndroidUtilities.m36dp(2.0f) * this.scaleX);
        this.tempRect.bottom = bounds.bottom - ((int) (AndroidUtilities.m36dp(6.0f) * this.scaleY));
        Rect rect = this.tempRect;
        rect.right = bounds.right - rect.left;
        rect.top = rect.bottom - ((int) (AndroidUtilities.m36dp(4.0f) * this.scaleY));
        this.secondaryRectDrawable.setBounds(this.tempRect);
        this.secondaryRectDrawable.draw(canvas);
        Rect rect2 = this.tempRect;
        int m36dp = AndroidUtilities.m36dp(12.0f);
        rect2.right = m36dp;
        rect2.left = m36dp;
        ...
        rect3.bottom = m36dp2;
        rect3.top = m36dp2;
        this.tempRect.inset(-AndroidUtilities.m36dp(AndroidUtilities.lerp(10, 11, interpolation)), -AndroidUtilities.m36dp(AndroidUtilities.lerp(2, 3, interpolation)));
    ...
    private void drawStage2(Canvas canvas, float f) {
        ...
        rect.right = bounds.right - rect.left;
        rect.top = rect.bottom - ((int) (AndroidUtilities.m36dp(4.0f) * this.scaleY));
        this.tempRect.offset(0, AndroidUtilities.m36dp(AndroidUtilities.lerp(0, -8, interpolation)));
        this.secondaryRectDrawable.setBounds(this.tempRect);
        this.secondaryRectDrawable.draw(canvas);
    ...
    private void drawStage3(Canvas canvas, float f) {
        ...
        rect.right = bounds.right - rect.left;
        rect.top = rect.bottom - ((int) (AndroidUtilities.m36dp(4.0f) * this.scaleY));
        this.tempRect.offset(0, AndroidUtilities.m36dp(-8.0f));
        this.secondaryRectDrawable.setBounds(this.tempRect);
        this.secondaryRectDrawable.draw(canvas);
