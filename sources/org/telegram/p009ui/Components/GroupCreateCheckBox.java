...
public class GroupCreateCheckBox extends View {
    ...
    public GroupCreateCheckBox(Context context) {
        ...
        this.innerRadDiff = AndroidUtilities.m34dp(2.0f);
        this.checkPaint.setStrokeWidth(AndroidUtilities.m34dp(1.5f));
        eraser2.setStrokeWidth(AndroidUtilities.m34dp(28.0f));
        this.drawBitmap = Bitmap.createBitmap(AndroidUtilities.m34dp(24.0f), AndroidUtilities.m34dp(24.0f), Bitmap.Config.ARGB_4444);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (getVisibility() == 0 && this.progress != 0.0f) {
            ...
            eraser2.setStrokeWidth(AndroidUtilities.m34dp(30.0f));
            ...
            if (f2 < 0.2f) {
                f = (AndroidUtilities.m34dp(2.0f) * f2) / 0.2f;
            } else {
                f = f2 < 0.4f ? AndroidUtilities.m34dp(2.0f) - ((AndroidUtilities.m34dp(2.0f) * (f2 - 0.2f)) / 0.2f) : 0.0f;
            }
            if (f4 != 0.0f) {
                canvas.drawCircle(measuredWidth, measuredHeight, ((measuredWidth - AndroidUtilities.m34dp(2.0f)) + (AndroidUtilities.m34dp(2.0f) * f4)) - f, this.backgroundPaint);
            }
            ...
            float dp = AndroidUtilities.m34dp(10.0f) * f4 * this.checkScale;
            float dp2 = AndroidUtilities.m34dp(5.0f) * f4 * this.checkScale;
            int dp3 = measuredWidth - AndroidUtilities.m34dp(1.0f);
            int dp4 = measuredHeight + AndroidUtilities.m34dp(4.0f);
            ...
            float dp5 = dp3 - AndroidUtilities.m34dp(1.2f);
