...
public class SpoilerEffectBitmapFactory {
    ...
    private SpoilerEffectBitmapFactory() {
        new Matrix();
        int dp = AndroidUtilities.m34dp(SharedConfig.getDevicePerformanceClass() == 2 ? 200.0f : 150.0f);
        Point point = AndroidUtilities.displaySize;
        int min = (int) Math.min(Math.min(point.x, point.y) * 0.5f, dp);
        this.size = min;
        if (min < AndroidUtilities.m34dp(100.0f)) {
            this.size = AndroidUtilities.m34dp(100.0f);
        }
    }
    ...
    public Paint getPaint() {
        if (this.shaderBitmap == null) {
            ...
            int i2 = this.size;
            int i3 = (int) (i2 / 10.0f);
            int dp = (int) ((i2 / AndroidUtilities.m34dp(200.0f)) * 60.0f);
            for (int i4 = 0; i4 < 10; i4++) {
                for (int i5 = 0; i5 < 10; i5++) {
                    SpoilerEffect spoilerEffect = new SpoilerEffect();
                    int i6 = i3 * i4;
                    int i7 = i3 * i5;
                    spoilerEffect.setBounds(i6, i7 - AndroidUtilities.m34dp(5.0f), i6 + i3 + AndroidUtilities.m34dp(3.0f), i7 + i3 + AndroidUtilities.m34dp(5.0f));
