...
public class RoundStatusDrawable extends StatusDrawable {
    ...
    public void draw(Canvas canvas) {
        ...
        canvas.drawCircle(AndroidUtilities.m34dp(6.0f), AndroidUtilities.m34dp(this.isChat ? 8.0f : 9.0f), AndroidUtilities.m34dp(4.0f), paint);
        if (this.started) {
            update();
        }
    }
    ...
    public int getIntrinsicHeight() {
        return AndroidUtilities.m34dp(10.0f);
    }
}
