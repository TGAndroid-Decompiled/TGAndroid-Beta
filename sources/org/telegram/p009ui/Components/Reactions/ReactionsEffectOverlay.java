...
public class ReactionsEffectOverlay {
    ...
    private ReactionsEffectOverlay(android.content.Context r33, org.telegram.p009ui.ActionBar.BaseFragment r34, org.telegram.p009ui.Components.ReactionsContainerLayout r35, org.telegram.p009ui.Cells.ChatMessageCell r36, float r37, float r38, java.lang.String r39, int r40, int r41) {
    ...
    public class C23001 extends FrameLayout {
        ...
        C23001(Context context, BaseFragment baseFragment, ChatMessageCell chatMessageCell, String str, ChatActivity chatActivity, int i, int i2, boolean z, float f, float f2, float f3) {
            super(context);
        ...
        protected void dispatchDraw(android.graphics.Canvas r20) {
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p009ui.Components.Reactions.ReactionsEffectOverlay.C23001.dispatchDraw(android.graphics.Canvas):void");
        }
    ...
    private class AvatarParticle {
        ...
        AvatarParticle(ReactionsEffectOverlay reactionsEffectOverlay, C23001 r2) {
