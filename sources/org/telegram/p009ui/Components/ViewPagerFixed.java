...
public class ViewPagerFixed extends FrameLayout {
    ...
    public static class TabsView extends FrameLayout {
        ...
        public class TabView extends View {
            ...
            @Override
            public int getId() {
                return this.currentTab.f1103id;
            }
            ...
            protected void onDraw(Canvas canvas) {
                ...
                int i6;
                int i7;
                if (!(this.currentTab.f1103id == Integer.MAX_VALUE || TabsView.this.editingAnimationProgress == 0.0f)) {
                    canvas.save();
                ...
                if ((TabsView.this.animatingIndicator || TabsView.this.manualScrollingToId != -1) && ((i7 = this.currentTab.f1103id) == i2 || i7 == i)) {
                ...
                if (this.currentTab.f1103id != Integer.MAX_VALUE && (TabsView.this.isEditing || TabsView.this.editingStartAnimationProgress != 0.0f)) {
                ...
                if (str3 != null || (this.currentTab.f1103id != Integer.MAX_VALUE && (TabsView.this.isEditing || TabsView.this.editingStartAnimationProgress != 0.0f))) {
                    ...
                    if (!Theme.hasThemeKey(str4) || !Theme.hasThemeKey(str5)) {
                        ...
                        if ((TabsView.this.animatingIndicator || TabsView.this.manualScrollingToPosition != -1) && ((i6 = this.currentTab.f1103id) == i2 || i6 == i)) {
                    ...
                    if (this.currentTab.f1103id == Integer.MAX_VALUE || ((!TabsView.this.isEditing && TabsView.this.editingStartAnimationProgress == 0.0f) || str3 != null)) {
                    ...
                    if (str3 != null) {
                        if (this.currentTab.f1103id != Integer.MAX_VALUE) {
            ...
            public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
                ...
                accessibilityNodeInfo.setSelected((this.currentTab == null || TabsView.this.selectedTabId == -1 || this.currentTab.f1103id != TabsView.this.selectedTabId) ? false : true);
            }
        }
        ...
        public void lambda$new$0(View view, int i, float f, float f2) {
            ...
            if (this.delegate.canPerformActions()) {
                ...
                if (i != this.currentPosition || (tabsViewDelegate = this.delegate) == null) {
                    scrollToTab(tabView.currentTab.f1103id, i);
                } else {
