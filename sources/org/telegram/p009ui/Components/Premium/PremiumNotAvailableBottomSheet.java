...
public class PremiumNotAvailableBottomSheet extends BottomSheet {
    public PremiumNotAvailableBottomSheet(BaseFragment baseFragment) {
        ...
        textView3.setText(LocaleController.getString(C1072R.string.InstallOfficialApp));
        ...
        textView.setText(AndroidUtilities.replaceTags(LocaleController.getString(C1072R.string.SubscribeToPremiumOfficialAppNeeded)));
        textView2.setText(AndroidUtilities.replaceTags(LocaleController.getString(C1072R.string.SubscribeToPremiumOfficialAppNeededDescription)));
