...
public class PremiumLockIconView extends ImageView {
    ...
    public PremiumLockIconView(Context context) {
        super(context);
        setImageResource(C0952R.C0953drawable.msg_premium_lock);
    }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        rectF.set((getMeasuredWidth() / 2.0f) + AndroidUtilities.m34dp(1.5f), (getMeasuredHeight() / 2.0f) + AndroidUtilities.dpf2(4.7f), getMeasuredWidth() - AndroidUtilities.dpf2(0.2f), getMeasuredHeight());
        this.path.addRoundRect(rectF, AndroidUtilities.m34dp(2.0f), AndroidUtilities.m34dp(2.0f), Path.Direction.CW);
        this.path.close();
        updateGradient();
    }
