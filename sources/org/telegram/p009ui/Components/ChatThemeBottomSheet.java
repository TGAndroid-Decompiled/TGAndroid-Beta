...
public class ChatThemeBottomSheet extends BottomSheet implements NotificationCenter.NotificationCenterDelegate {
    ...
    private final LinearSmoothScroller scroller = new LinearSmoothScroller(this, getContext()) {
        @Override
    ...
    public ChatThemeBottomSheet(ChatActivity chatActivity, final ChatActivity.ThemeDelegate themeDelegate) {
        ...
        textView.setText(LocaleController.getString("SelectTheme", C0952R.string.SelectTheme));
        textView.setTextColor(getThemedColor("dialogTextBlack"));
        textView.setTextSize(1, 20.0f);
        textView.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf"));
        textView.setPadding(AndroidUtilities.m34dp(21.0f), AndroidUtilities.m34dp(6.0f), AndroidUtilities.m34dp(21.0f), AndroidUtilities.m34dp(8.0f));
        ...
        recyclerListView.setPadding(AndroidUtilities.m34dp(12.0f), 0, AndroidUtilities.m34dp(12.0f), 0);
        ...
        view.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m34dp(6.0f), getThemedColor("featuredStickers_addButton"), getThemedColor("featuredStickers_addButtonPressed")));
        ...
        if (themeDelegate.getCurrentTheme() == null) {
            i = C0952R.string.DoNoSetTheme;
            str = "DoNoSetTheme";
        } else {
            i = C0952R.string.ChatResetTheme;
            str = "ChatResetTheme";
        }
        ...
        this.applyTextView.setText(LocaleController.getString("ChatApplyTheme", C0952R.string.ChatApplyTheme));
    ...
    public void lambda$new$1(ChatActivity.ThemeDelegate themeDelegate, View view, final int i) {
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (this.chatActivity.getCurrentUser() != null && SharedConfig.dayNightThemeSwitchHintCount > 0 && !this.chatActivity.getCurrentUser().self) {
            ...
            this.hintView.setBottomOffset(-AndroidUtilities.m34dp(8.0f));
            this.hintView.setText(AndroidUtilities.replaceTags(LocaleController.formatString("ChatThemeDayNightSwitchTooltip", C0952R.string.ChatThemeDayNightSwitchTooltip, this.chatActivity.getCurrentUser().first_name)));
    ...
    public void close() {
        if (hasChanges()) {
            ...
            builder.setTitle(LocaleController.getString("ChatThemeSaveDialogTitle", C0952R.string.ChatThemeSaveDialogTitle));
            builder.setSubtitle(LocaleController.getString("ChatThemeSaveDialogText", C0952R.string.ChatThemeSaveDialogText));
            builder.setPositiveButton(LocaleController.getString("ChatThemeSaveDialogApply", C0952R.string.ChatThemeSaveDialogApply), new DialogInterface.OnClickListener() {
                @Override
                public final void onClick(DialogInterface dialogInterface, int i) {
                    ChatThemeBottomSheet.this.lambda$close$4(dialogInterface, i);
                }
            });
            builder.setNegativeButton(LocaleController.getString("ChatThemeSaveDialogDiscard", C0952R.string.ChatThemeSaveDialogDiscard), new DialogInterface.OnClickListener() {
                @Override
                public final void onClick(DialogInterface dialogInterface, int i) {
    ...
    public void lambda$close$4(DialogInterface dialogInterface, int i) {
        applySelectedTheme();
    }

    public void lambda$close$5(DialogInterface dialogInterface, int i) {
        dismiss();
    }
    ...
    private void applySelectedTheme() {
        ...
        if (!(chatThemeItem == null || emojiThemes2 == this.originalTheme)) {
            ...
            if (currentUser != null && !currentUser.self) {
                ...
                if (z) {
                    stickerSetBulletinLayout.titleTextView.setText(AndroidUtilities.replaceTags(LocaleController.formatString("ThemeAlsoDisabledForHint", C0952R.string.ThemeAlsoDisabledForHint, currentUser.first_name)));
                } else {
                    stickerSetBulletinLayout.titleTextView.setText(AndroidUtilities.replaceTags(LocaleController.formatString("ThemeAlsoAppliedForHint", C0952R.string.ThemeAlsoAppliedForHint, currentUser.first_name)));
                }
    ...
    private boolean hasChanges() {
        ...
        return !ObjectsCompat$$ExternalSyntheticBackport0.m677m(emoticon, str2);
    }
    ...
    public static class Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        private boolean parseTheme(final org.telegram.p009ui.ActionBar.Theme.ThemeInfo r21) {
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p009ui.Components.ChatThemeBottomSheet.Adapter.parseTheme(org.telegram.ui.ActionBar.Theme$ThemeInfo):boolean");
        }
