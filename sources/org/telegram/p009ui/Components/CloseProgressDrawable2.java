...
public class CloseProgressDrawable2 extends Drawable {
    ...
    public CloseProgressDrawable2(float f) {
        ...
        this.paint.setStrokeWidth(AndroidUtilities.m36dp(f));
        this.paint.setStrokeCap(Paint.Cap.ROUND);
        this.paint.setStyle(Paint.Style.STROKE);
        this.side = AndroidUtilities.m36dp(8.0f);
    }
    ...
    public void draw(android.graphics.Canvas r18) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p009ui.Components.CloseProgressDrawable2.draw(android.graphics.Canvas):void");
    }
