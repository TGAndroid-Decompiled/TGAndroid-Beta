...
public class ChatActivityEnterView extends BlurredFrameLayout implements NotificationCenter.NotificationCenterDelegate, SizeNotifierFrameLayout.SizeNotifierFrameLayoutDelegate, StickersAlert.StickersAlertDelegate {
    ...
    public class RecordDot extends View {
        ...
        public RecordDot(Context context) {
            ...
            int i = C1010R.raw.chat_audio_record_delete;
            RLottieDrawable rLottieDrawable = new RLottieDrawable(i, BuildConfig.APP_CENTER_HASH + i, AndroidUtilities.m35dp(28.0f), AndroidUtilities.m35dp(28.0f), false, null);
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (!this.playing || !this.drawable.hasBitmap()) {
                canvas.drawCircle(getMeasuredWidth() >> 1, getMeasuredHeight() >> 1, AndroidUtilities.m35dp(5.0f), ChatActivityEnterView.this.redDotPaint);
            }
            invalidate();
        }
    ...
    public class RecordCircle extends View {
        ...
        public RecordCircle(Context context) {
            ...
            this.circleRadiusAmplitude = AndroidUtilities.m35dp(30.0f);
            ...
            this.showWaves = true;
            this.f1031p = new Paint(1);
            r6.micDrawable = getResources().getDrawable(C1010R.C1011drawable.input_mic_pressed).mutate();
            ...
            r6.cameraDrawable = getResources().getDrawable(C1010R.C1011drawable.input_video_pressed).mutate();
            ...
            r6.sendDrawable = getResources().getDrawable(C1010R.C1011drawable.attach_send).mutate();
            ...
            r6.micOutline = getResources().getDrawable(C1010R.C1011drawable.input_mic).mutate();
            r6.micOutline.setColorFilter(new PorterDuffColorFilter(r6.getThemedColor("chat_messagePanelIcons"), PorterDuff.Mode.MULTIPLY));
            r6.cameraOutline = getResources().getDrawable(C1010R.C1011drawable.input_video).mutate();
            ...
            this.tinyWaveDrawable.minRadius = AndroidUtilities.m35dp(47.0f);
            this.tinyWaveDrawable.maxRadius = AndroidUtilities.m35dp(55.0f);
            this.tinyWaveDrawable.generateBlob();
            this.bigWaveDrawable.minRadius = AndroidUtilities.m35dp(47.0f);
            this.bigWaveDrawable.maxRadius = AndroidUtilities.m35dp(55.0f);
            ...
            r6.lockShadowDrawable = getResources().getDrawable(C1010R.C1011drawable.lock_round_shadow);
            ...
            this.tooltipBackground = Theme.createRoundRectDrawable(AndroidUtilities.m35dp(5.0f), r6.getThemedColor("chat_gifSaveHintBackground"));
            this.tooltipPaint.setTextSize(AndroidUtilities.m35dp(14.0f));
            this.tooltipBackgroundArrow = ContextCompat.getDrawable(context, C1010R.C1011drawable.tooltip_arrow);
            this.tooltipMessage = LocaleController.getString("SlideUpToLock", C1010R.string.SlideUpToLock);
        ...
        public int setLockTranslation(float f) {
            if (f == 10000.0f) {
                ...
                this.lockAnimatedTranslation = f;
                invalidate();
                if (this.canceledByGesture || this.slideToCancelProgress < 0.7f || this.startTranslation - this.lockAnimatedTranslation < AndroidUtilities.m35dp(57.0f)) {
                    return 1;
                }
        ...
        protected void onMeasure(int i, int i2) {
            ...
            int m35dp = AndroidUtilities.m35dp(194.0f);
            if (this.lastSize != size) {
                this.lastSize = size;
                StaticLayout staticLayout = new StaticLayout(this.tooltipMessage, this.tooltipPaint, AndroidUtilities.m35dp(220.0f), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, true);
            ...
            if (staticLayout2 != null && staticLayout2.getLineCount() > 1) {
                m35dp += this.tooltipLayout.getHeight() - this.tooltipLayout.getLineBottom(0);
            }
            super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(m35dp, 1073741824));
            float measuredWidth = getMeasuredWidth() * 0.35f;
            if (measuredWidth > AndroidUtilities.m35dp(140.0f)) {
                measuredWidth = AndroidUtilities.m35dp(140.0f);
            }
        ...
        public void updateColors() {
            ...
            this.tooltipBackground = Theme.createRoundRectDrawable(AndroidUtilities.m35dp(5.0f), ChatActivityEnterView.this.getThemedColor("chat_gifSaveHintBackground"));
        ...
        public class VirtualViewHelper extends ExploreByTouchHelper {
            ...
            protected void onPopulateNodeForVirtualView(int i, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
                if (i == 1) {
                    ...
                    accessibilityNodeInfoCompat.setText(LocaleController.getString("Send", C1010R.string.Send));
                } else if (i == 2) {
                    ...
                    accessibilityNodeInfoCompat.setText(LocaleController.getString("Stop", C1010R.string.Stop));
                } else if (i == 3) {
                    if (ChatActivityEnterView.this.slideText != null && ChatActivityEnterView.this.slideText.cancelRect != null) {
                    ...
                    accessibilityNodeInfoCompat.setText(LocaleController.getString("Cancel", C1010R.string.Cancel));
                }
            }
        }
    }
    ...
    public ChatActivityEnterView(final Activity activity, SizeNotifierFrameLayout sizeNotifierFrameLayout, final ChatActivity chatActivity, boolean z, final Theme.ResourcesProvider resourcesProvider) {
        ...
        this.distCanMove = AndroidUtilities.m35dp(80.0f);
        ...
        this.textFieldContainer.setPadding(0, AndroidUtilities.m35dp(1.0f), 0, 0);
        ...
        FrameLayout frameLayout2 = new FrameLayout(activity) {
            ...
            protected void onLayout(boolean z2, int i3, int i4, int i5, int i6) {
                ...
                if (ChatActivityEnterView.this.scheduledButton != null) {
                    int measuredWidth = (getMeasuredWidth() - AndroidUtilities.m35dp((ChatActivityEnterView.this.botButton == null || ChatActivityEnterView.this.botButton.getVisibility() != 0) ? 48.0f : 96.0f)) - AndroidUtilities.m35dp(48.0f);
            ...
            protected boolean drawChild(Canvas canvas, View view, long j) {
                if (view == ChatActivityEnterView.this.messageEditText) {
                    canvas.save();
                    canvas.clipRect(0, ((-getTop()) - ChatActivityEnterView.this.textFieldContainer.getTop()) - ChatActivityEnterView.this.getTop(), getMeasuredWidth(), getMeasuredHeight() - AndroidUtilities.m35dp(6.0f));
        ...
        ChatActivityEnterViewAnimatedIconView chatActivityEnterViewAnimatedIconView = new ChatActivityEnterViewAnimatedIconView(activity) {
            ...
            protected void onDraw(Canvas canvas) {
                ...
                canvas.drawCircle((getWidth() / 2) + AndroidUtilities.m35dp(9.0f), (getHeight() / 2) - AndroidUtilities.m35dp(8.0f), AndroidUtilities.m35dp(5.0f), ChatActivityEnterView.this.dotPaint);
            }
        };
        this.emojiButton = chatActivityEnterViewAnimatedIconView;
        chatActivityEnterViewAnimatedIconView.setContentDescription(LocaleController.getString(C1010R.string.AccDescrEmojiButton));
        this.emojiButton.setFocusable(true);
        int m35dp = AndroidUtilities.m35dp(9.5f);
        this.emojiButton.setPadding(m35dp, m35dp, m35dp, m35dp);
        ...
        C180612 c180612 = new C180612(activity, resourcesProvider, resourcesProvider, chatActivity, activity);
        this.messageEditText = c180612;
        if (i3 >= 28) {
            c180612.setFallbackLineSpacing(false);
        }
        ...
        this.messageEditText.addTextChangedListener(new C181115());
        if (z) {
            if (this.parentFragment != null) {
                Drawable mutate = activity.getResources().getDrawable(C1010R.C1011drawable.input_calendar1).mutate();
                Drawable mutate2 = activity.getResources().getDrawable(C1010R.C1011drawable.input_calendar2).mutate();
                ...
                this.scheduledButton.setContentDescription(LocaleController.getString("ScheduledMessages", C1010R.string.ScheduledMessages));
            ...
            this.attachLayout.setPivotX(AndroidUtilities.m35dp(48.0f));
            ...
            this.botCommandsMenuContainer.listView.setOnItemClickListener(new C181417(resourcesProvider, chatActivity));
            ...
            this.botButtonDrawable.setIcon(C1010R.C1011drawable.input_bot2, false);
            ...
            CrossOutDrawable crossOutDrawable = new CrossOutDrawable(activity, C1010R.C1011drawable.input_notify_on, "chat_messagePanelIcons");
            ...
            if (this.silent) {
                i = C1010R.string.AccDescrChanSilentOn;
                str2 = "AccDescrChanSilentOn";
            } else {
                i = C1010R.string.AccDescrChanSilentOff;
            ...
            this.notifyButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (ChatActivityEnterView.this.notifySilentDrawable == null) {
                        ChatActivityEnterView.this.notifySilentDrawable = new CrossOutDrawable(activity, C1010R.C1011drawable.input_notify_on, "chat_messagePanelIcons");
                    }
                    ...
                    if (ChatActivityEnterView.this.silent) {
                        i4 = C1010R.string.AccDescrChanSilentOn;
                        str3 = "AccDescrChanSilentOn";
                    } else {
                        i4 = C1010R.string.AccDescrChanSilentOff;
            ...
            this.attachButton.setImageResource(C1010R.C1011drawable.input_attach);
            ...
            this.attachButton.setContentDescription(LocaleController.getString("AccDescrAttachButton", C1010R.string.AccDescrAttachButton));
        } else {
            str = "listSelectorSDK21";
        }
        ...
        this.recordDeleteImageView.setAnimation(C1010R.raw.chat_audio_record_delete_2, 28, 28);
        this.recordDeleteImageView.getAnimatedDrawable().setInvalidateOnProgressSet(true);
        updateRecordedDeleteIconColors();
        this.recordDeleteImageView.setContentDescription(LocaleController.getString("Delete", C1010R.string.Delete));
        if (i3 >= 21) {
        ...
        view.setBackgroundDrawable(Theme.createRoundRectDrawable(AndroidUtilities.m35dp(18.0f), getThemedColor("chat_recordedVoiceBackground")));
        ...
        this.recordedAudioPlayButton.setContentDescription(LocaleController.getString("AccActionPlay", C1010R.string.AccActionPlay));
        ...
        this.recordTimeContainer.setPadding(AndroidUtilities.m35dp(13.0f), 0, 0, 0);
        ...
        int m35dp2 = AndroidUtilities.m35dp(9.5f);
        this.audioVideoSendButton.setPadding(m35dp2, m35dp2, m35dp2, m35dp2);
        ...
        this.cancelBotButton.setContentDescription(LocaleController.getString("Cancel", C1010R.string.Cancel));
        ...
        if (isInScheduleMode()) {
            ...
            int i4 = C1010R.C1011drawable.input_schedule;
            ...
            int i5 = C1010R.C1011drawable.ic_send;
        ...
        View view2 = new View(activity) {
            ...
            protected void onDraw(Canvas canvas) {
                ...
                if (ChatActivityEnterView.this.isInScheduleMode()) {
                    measuredHeight -= AndroidUtilities.m35dp(1.0f);
                } else {
                    measuredWidth += AndroidUtilities.m35dp(2.0f);
                }
                int i6 = 1;
                ...
                if (z2 || this.animationProgress != 1.0f) {
                    ...
                    int m35dp5 = AndroidUtilities.m35dp(20.0f);
                    if (z2) {
                        ChatActivityEnterView.this.sendButtonInverseDrawable.setAlpha(255);
                        float f3 = this.animationProgress;
                        if (f3 <= 0.25f) {
                            f = m35dp5;
                            m35dp4 = AndroidUtilities.m35dp(2.0f) * CubicBezierInterpolator.EASE_IN.getInterpolation(f3 / 0.25f);
                        } else {
                            float f4 = f3 - 0.25f;
                            if (f4 <= 0.5f) {
                                f = m35dp5;
                                m35dp4 = AndroidUtilities.m35dp(2.0f) - (AndroidUtilities.m35dp(3.0f) * CubicBezierInterpolator.EASE_IN.getInterpolation(f4 / 0.5f));
                            } else {
                                m35dp3 = (int) (m35dp5 + (-AndroidUtilities.m35dp(1.0f)) + (AndroidUtilities.m35dp(1.0f) * CubicBezierInterpolator.EASE_IN.getInterpolation((f4 - 0.5f) / 0.25f)));
                                m35dp5 = m35dp3;
                            }
                        }
                        m35dp3 = (int) (f + m35dp4);
                    ...
                    canvas.drawCircle(getMeasuredWidth() / 2, getMeasuredHeight() / 2, m35dp5, Theme.dialogs_onlineCirclePaint);
        ...
        this.sendButton.setContentDescription(LocaleController.getString("Send", C1010R.string.Send));
        ...
        this.slowModeButton.setPadding(0, 0, AndroidUtilities.m35dp(13.0f), 0);
        ...
        this.expandStickersButton.setContentDescription(LocaleController.getString("AccDescrExpandPanel", C1010R.string.AccDescrExpandPanel));
        ...
        ShapeDrawable createCircleDrawable = Theme.createCircleDrawable(AndroidUtilities.m35dp(16.0f), getThemedColor("chat_messagePanelSend"));
        Drawable mutate3 = activity.getResources().getDrawable(C1010R.C1011drawable.input_done).mutate();
        ...
        CombinedDrawable combinedDrawable2 = new CombinedDrawable(createCircleDrawable, mutate3, 0, AndroidUtilities.m35dp(1.0f));
        combinedDrawable2.setCustomSize(AndroidUtilities.m35dp(32.0f), AndroidUtilities.m35dp(32.0f));
        ...
        this.doneButtonImage.setContentDescription(LocaleController.getString("Done", C1010R.string.Done));
        ...
        this.keyboardHeight = globalEmojiSettings.getInt("kbd_height", AndroidUtilities.m35dp(200.0f));
        this.keyboardHeightLand = globalEmojiSettings.getInt("kbd_height_land3", AndroidUtilities.m35dp(200.0f));
    ...
    public class C180612 extends EditTextCaption {
        final Activity val$context;
        final ChatActivity val$fragment;
        final Theme.ResourcesProvider val$resourcesProvider;

        C180612(Context context, Theme.ResourcesProvider resourcesProvider, Theme.ResourcesProvider resourcesProvider2, ChatActivity chatActivity, Activity activity) {
            ...
            try {
                ...
                return InputConnectionCompat.createWrapper(onCreateInputConnection, editorInfo, new InputConnectionCompat.OnCommitContentListener() {
                    ...
                    public final boolean onCommitContent(InputContentInfoCompat inputContentInfoCompat, int i, Bundle bundle) {
                        ...
                        lambda$onCreateInputConnection$1 = ChatActivityEnterView.C180612.this.lambda$onCreateInputConnection$1(resourcesProvider, inputContentInfoCompat, i, bundle);
                ...
                if (ChatActivityEnterView.this.isInScheduleMode()) {
                    AlertsCreator.createScheduleDatePickerDialog(ChatActivityEnterView.this.parentActivity, ChatActivityEnterView.this.parentFragment.getDialogId(), new AlertsCreator.ScheduleDatePickerDelegate() {
                        ...
                        public final void didSelectDate(boolean z, int i2) {
                            ChatActivityEnterView.C180612.this.lambda$onCreateInputConnection$0(inputContentInfoCompat, z, i2);
                        }
                    }, resourcesProvider);
                } else {
                ...
                if (ChatActivityEnterView.this.isPopupShowing() && motionEvent.getAction() == 0) {
                    ...
                    if (!ChatActivityEnterView.this.stickersExpanded) {
                        ...
                        AndroidUtilities.runOnUIThread(new Runnable() {
                            @Override
                            public final void run() {
                                ChatActivityEnterView.C180612.this.lambda$onTouchEvent$2();
                            }
                        }, 200L);
                    }
                    return true;
        ...
        private void editPhoto(final Uri uri, String str) {
            ...
            dispatchQueue.postRunnable(new Runnable() {
                @Override
                public final void run() {
                    ChatActivityEnterView.C180612.this.lambda$editPhoto$4(activity, uri, generatePicturePath);
                }
            });
        }
                ...
                while (true) {
                    ...
                    if (read > 0) {
                        ...
                        AndroidUtilities.runOnUIThread(new Runnable() {
                            @Override
                            public final void run() {
                                ChatActivityEnterView.C180612.this.lambda$editPhoto$3(arrayList, file);
                            }
                        });
                        return;
                    }
        ...
        public void lambda$editPhoto$3(final ArrayList<Object> arrayList, final File file) {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() {
                ...
                @Override
                public void run() {
                    C180612.this.lambda$editPhoto$3(arrayList, file);
                }
            }, 100L);
        }
    ...
    public class C181115 implements TextWatcher {
        ...
        public void afterTextChanged(android.text.Editable r11) {
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p009ui.Components.ChatActivityEnterView.C181115.afterTextChanged(android.text.Editable):void");
        }
    ...
    public class C181417 implements RecyclerListView.OnItemClickListener {
        final ChatActivity val$fragment;
        final Theme.ResourcesProvider val$resourcesProvider;

        C181417(Theme.ResourcesProvider resourcesProvider, ChatActivity chatActivity) {
            ChatActivityEnterView.this = r1;
            ...
            if (view instanceof BotCommandsMenuView.BotCommandView) {
                ...
                if (ChatActivityEnterView.this.isInScheduleMode()) {
                    AlertsCreator.createScheduleDatePickerDialog(ChatActivityEnterView.this.parentActivity, ChatActivityEnterView.this.dialog_id, new AlertsCreator.ScheduleDatePickerDelegate() {
                        @Override
                        public final void didSelectDate(boolean z, int i2) {
                            ChatActivityEnterView.C181417.this.lambda$onItemClick$0(command, z, i2);
                        }
    ...
    public void lambda$new$14(Activity activity, View view) {
        ...
        if (this.delegate.measureKeyboardHeight() > AndroidUtilities.m35dp(20.0f)) {
            ...
            if (contentViewHeight < AndroidUtilities.m35dp(200.0f)) {
        ...
        if (this.delegate.getSendAsPeers() != null) {
            ...
            this.senderSelectPopupWindow.getContentView().measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m35dp(1000.0f), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m35dp(1000.0f), Integer.MIN_VALUE));
            ...
            int i3 = -AndroidUtilities.m35dp(4.0f);
            int[] iArr = new int[2];
            ...
            if (measureKeyboardHeight2 <= AndroidUtilities.m35dp(20.0f)) {
            ...
            if (measuredHeight < (((i3 * 2) + contentViewHeight2) - (this.parentFragment.isInBubbleMode() ? 0 : AndroidUtilities.statusBarHeight)) - this.senderSelectPopupWindow.headerText.getMeasuredHeight()) {
                ...
                i2 = ((iArr[1] - measuredHeight) - i3) - AndroidUtilities.m35dp(2.0f);
                overlayContainerView.addView(this.senderSelectPopupWindow.dimView, new FrameLayout.LayoutParams(-1, i3 + i2 + measuredHeight + m35dp + AndroidUtilities.m35dp(2.0f)));
            } else {
                int i4 = this.parentFragment.isInBubbleMode() ? 0 : AndroidUtilities.statusBarHeight;
                int m35dp2 = AndroidUtilities.m35dp(14.0f);
                this.senderSelectPopupWindow.recyclerContainer.getLayoutParams().height = ((contentViewHeight2 - i4) - m35dp2) - getHeightWithTopView();
                overlayContainerView.addView(this.senderSelectPopupWindow.dimView, new FrameLayout.LayoutParams(-1, m35dp2 + i4 + this.senderSelectPopupWindow.recyclerContainer.getLayoutParams().height + m35dp));
                i2 = i4;
            }
    ...
    public void lambda$new$12(final SimpleAvatarView simpleAvatarView, int[] iArr, SenderSelectPopup.SenderView senderView) {
        ...
        final Dialog dialog = new Dialog(getContext(), C1010R.style.TransparentDialogNoAnimation);
        ...
        float m35dp2 = iArr[0] + this.popupX + m35dp + AndroidUtilities.m35dp(4.0f) + 0.0f;
        float f3 = iArr[1] + this.popupY + m35dp + 0.0f;
        simpleAvatarView.setTranslationX(m35dp2);
        simpleAvatarView.setTranslationY(f3);
        float m35dp3 = this.senderSelectView.getLayoutParams().width / AndroidUtilities.m35dp(40.0f);
        ...
        simpleAvatarView.getViewTreeObserver().addOnDrawListener(new ViewTreeObserver$OnDrawListenerC182022(this, simpleAvatarView, senderView));
        dialog.show();
        ...
        }), new SpringAnimation(simpleAvatarView, DynamicAnimation.TRANSLATION_X).setStartValue(MathUtils.clamp(m35dp2, f - AndroidUtilities.m35dp(6.0f), m35dp2)).setSpring(new SpringForce(f).setStiffness(700.0f).setDampingRatio(0.75f)).setMinValue(f - AndroidUtilities.m35dp(6.0f)), new SpringAnimation(simpleAvatarView, DynamicAnimation.TRANSLATION_Y).setStartValue(MathUtils.clamp(f3, f3, AndroidUtilities.m35dp(6.0f) + f2)).setSpring(new SpringForce(f2).setStiffness(700.0f).setDampingRatio(0.75f)).setMaxValue(AndroidUtilities.m35dp(6.0f) + f2).addUpdateListener(new DynamicAnimation.OnAnimationUpdateListener(this) {
        ...
        }), new SpringAnimation(simpleAvatarView, viewProperty).setSpring(new SpringForce(m35dp3).setStiffness(1000.0f).setDampingRatio(1.0f)), new SpringAnimation(simpleAvatarView, viewProperty2).setSpring(new SpringForce(m35dp3).setStiffness(1000.0f).setDampingRatio(1.0f)));
    }

    public class ViewTreeObserver$OnDrawListenerC182022 implements ViewTreeObserver.OnDrawListener {
        final SimpleAvatarView val$avatar;
        final SenderSelectPopup.SenderView val$senderView;

        ViewTreeObserver$OnDrawListenerC182022(ChatActivityEnterView chatActivityEnterView, SimpleAvatarView simpleAvatarView, SenderSelectPopup.SenderView senderView) {
        ...
        public void onDraw() {
            ...
            simpleAvatarView.post(new Runnable() {
                @Override
                public final void run() {
                    ChatActivityEnterView.ViewTreeObserver$OnDrawListenerC182022.this.lambda$onDraw$0(simpleAvatarView, senderView);
                }
            });
        }
    ...
    public void lambda$new$16(View view) {
        ...
        this.recordedAudioPlayButton.setContentDescription(LocaleController.getString("AccActionPause", C1010R.string.AccActionPause));
    }
    ...
    public boolean lambda$new$24(Theme.ResourcesProvider resourcesProvider, View view, MotionEvent motionEvent) {
        ...
        if (motionEvent.getAction() == 1 || motionEvent.getAction() == 3) {
            ...
            if (this.startedDraggingX == -1.0f) {
                ...
                this.distCanMove = f;
                if (f > AndroidUtilities.m35dp(140.0f)) {
                    this.distCanMove = AndroidUtilities.m35dp(140.0f);
                }
            }
    ...
    public void openWebViewMenu() {
        ...
        if (SharedPrefsHelper.isWebViewConfirmShown(this.currentAccount, this.dialog_id)) {
            ...
            new AlertDialog.Builder(this.parentFragment.getParentActivity()).setTitle(LocaleController.getString(C1010R.string.BotOpenPageTitle)).setMessage(AndroidUtilities.replaceTags(LocaleController.formatString(C1010R.string.BotOpenPageMessage, UserObject.getUserName(MessagesController.getInstance(this.currentAccount).getUser(Long.valueOf(this.dialog_id)))))).setPositiveButton(LocaleController.getString(C1010R.string.OK), new DialogInterface.OnClickListener() {
                @Override
    ...
    protected boolean drawChild(Canvas canvas, View view, long j) {
        ...
        if (z) {
            ...
            if (view == this.textFieldContainer) {
                int m35dp = (int) (this.animatedTop + AndroidUtilities.m35dp(2.0f) + this.chatSearchExpandOffset);
                View view2 = this.topView;
                if (view2 != null && view2.getVisibility() == 0) {
                    m35dp += this.topView.getHeight();
                }
                canvas.clipRect(0, m35dp, getMeasuredWidth(), getMeasuredHeight());
            } else {
                canvas.clipRect(0, this.animatedTop, getMeasuredWidth(), this.animatedTop + view.getLayoutParams().height + AndroidUtilities.m35dp(2.0f));
            }
        }
        boolean drawChild = super.drawChild(canvas, view, j);
        if (z) {
    ...
    public void updateSlowModeText() {
        ...
        if (tLRPC$ChatFull != null && tLRPC$ChatFull.slowmode_seconds != 0 && tLRPC$ChatFull.slowmode_next_send_date <= currentTime && ((isUploadingMessageIdDialog = SendMessagesHelper.getInstance(this.currentAccount).isUploadingMessageIdDialog(this.dialog_id)) || SendMessagesHelper.getInstance(this.currentAccount).isSendingMessageIdDialog(this.dialog_id))) {
            if (!ChatObject.hasAdminRights(this.accountInstance.getMessagesController().getChat(Long.valueOf(this.info.f849id)))) {
            ...
            if (i2 >= 2147483646) {
                if (this.info != null) {
                    this.accountInstance.getMessagesController().loadFullChat(this.info.f849id, 0, true);
                }
                i = 0;
            } else {
                i = i2 - currentTime;
    ...
    private void onWindowSizeChanged() {
        ...
        if (this.topView != null) {
            if (height < AndroidUtilities.m35dp(72.0f) + C1069ActionBar.getCurrentActionBarHeight()) {
                if (this.allowShowTopView) {
    ...
    public void resizeForTopView(boolean z) {
        ...
        layoutParams.topMargin = AndroidUtilities.m35dp(2.0f) + (z ? this.topView.getLayoutParams().height : 0);
        this.textFieldContainer.setLayoutParams(layoutParams);
        setMinimumHeight(AndroidUtilities.m35dp(51.0f) + (z ? this.topView.getLayoutParams().height : 0));
        if (this.stickersExpanded) {
            if (this.searchingType == 0) {
                setStickersExpanded(false, true, false);
            } else {
    ...
    public void checkChannelRights() {
        ...
        EmojiView emojiView = this.emojiView;
        if (emojiView != null) {
            emojiView.setStickersBanned(!ChatObject.canSendStickers(currentChat), currentChat.f848id);
        }
    }
    ...
    public void updateFieldHint(boolean z) {
        ...
        if (this.editingMessageObject != null) {
            ...
            if (this.editingCaption) {
                i = C1010R.string.Caption;
                str = "Caption";
            } else {
                i = C1010R.string.TypeMessage;
            }
            ...
            if (DialogObject.isChatDialog(this.dialog_id)) {
                ...
                if (ChatObject.getSendAsPeerId(chat, chatFull) == chat.f848id) {
                    z3 = true;
                }
            } else {
                z2 = false;
            ...
            if (z3) {
                this.messageEditText.setHintText(LocaleController.getString("SendAnonymously", C1010R.string.SendAnonymously));
                return;
            }
            ChatActivity chatActivity = this.parentFragment;
            if (chatActivity != null && chatActivity.isThreadChat()) {
                ...
                if (!chatActivity2.isTopic) {
                    if (chatActivity2.isReplyChatComment()) {
                        this.messageEditText.setHintText(LocaleController.getString("Comment", C1010R.string.Comment));
                        return;
                    } else {
                        this.messageEditText.setHintText(LocaleController.getString("Reply", C1010R.string.Reply));
                        return;
                    }
                }
            }
            if (z2) {
                if (this.silent) {
                    this.messageEditText.setHintText(LocaleController.getString("ChannelSilentBroadcast", C1010R.string.ChannelSilentBroadcast), z);
                    return;
                } else {
                    this.messageEditText.setHintText(LocaleController.getString("ChannelBroadcast", C1010R.string.ChannelBroadcast), z);
                    return;
                }
            }
            this.messageEditText.setHintText(LocaleController.getString("TypeMessage", C1010R.string.TypeMessage));
        }
    }
        ...
        if (this.videoToSendMessageObject != null) {
            ...
            if (chatActivity2 != null && (currentChat = chatActivity2.getCurrentChat()) != null && currentChat.slowmode_enabled && !ChatObject.hasAdminRights(currentChat)) {
                if (text.length() > this.accountInstance.getMessagesController().maxMessageLength) {
                    AlertsCreator.showSimpleAlert(this.parentFragment, LocaleController.getString("Slowmode", C1010R.string.Slowmode), LocaleController.getString("SlowmodeSendErrorTooLong", C1010R.string.SlowmodeSendErrorTooLong), this.resourcesProvider);
                    return;
                } else if (this.forceShowSendButton && text.length() > 0) {
                    AlertsCreator.showSimpleAlert(this.parentFragment, LocaleController.getString("Slowmode", C1010R.string.Slowmode), LocaleController.getString("SlowmodeSendError", C1010R.string.SlowmodeSendError), this.resourcesProvider);
                    return;
                }
            }
            ...
            if (processSendingText(text, z, i)) {
                if (this.delegate.hasForwardingMessages() || ((i != 0 && !isInScheduleMode()) || isInScheduleMode())) {
                    this.messageEditText.setText(BuildConfig.APP_CENTER_HASH);
                ...
                for (int i2 = 0; i2 < animatedEmojiSpanArr.length; i2++) {
                    if (animatedEmojiSpanArr[i2] != null) {
                        ...
                        if (tLRPC$Document != null && !MessageObject.isFreeEmoji(tLRPC$Document)) {
                            BulletinFactory.m14of(frameLayout, baseFragment.getResourceProvider()).createEmojiBulletin(tLRPC$Document, AndroidUtilities.replaceTags(LocaleController.getString("UnlockPremiumEmojiHint", C1010R.string.UnlockPremiumEmojiHint)), LocaleController.getString("PremiumMore", C1010R.string.PremiumMore), new Runnable() {
                                @Override
                                public final void run() {
    ...
    public void showCaptionLimitBulletin() {
        ...
        BulletinFactory.m13of(this.parentFragment).createCaptionLimitBulletin(MessagesController.getInstance(this.currentAccount).captionLengthLimitPremium, new Runnable() {
            @Override
            public final void run() {
    ...
    public boolean processSendingText(CharSequence charSequence, boolean z, int i) {
        ...
        while (true) {
            ...
            if (!this.delegate.hasForwardingMessages()) {
                ...
                sendAnimationData.height = m35dp;
                sendAnimationData.width = m35dp;
                this.messageEditText.getLocationInWindow(this.location);
                sendAnimationData.f808x = this.location[0] + AndroidUtilities.m35dp(11.0f);
                sendAnimationData.f809y = this.location[1] + AndroidUtilities.m35dp(19.0f);
            }
        ...
        if (i2 > 0 && i2 != Integer.MAX_VALUE && !isInScheduleMode()) {
            if (this.slowModeButton.getVisibility() != 0) {
                    ...
                    if (this.attachLayout != null) {
                        ...
                        if (imageView != null) {
                            ...
                            if (z3) {
                                ...
                                this.scheduledButton.setPivotX(AndroidUtilities.m35dp(48.0f));
                                ImageView imageView2 = this.scheduledButton;
                                Property property = View.TRANSLATION_X;
                                float[] fArr = new float[1];
                                ImageView imageView3 = this.botButton;
                                fArr[0] = AndroidUtilities.m35dp((imageView3 == null || imageView3.getVisibility() != 0) ? 48.0f : 96.0f);
                                ...
                                imageView4.setTranslationX(AndroidUtilities.m35dp((imageView5 == null || imageView5.getVisibility() != 0) ? 48.0f : 96.0f));
                ...
                if (this.scheduledButton != null) {
                    ...
                    imageView6.setTranslationX(AndroidUtilities.m35dp((imageView7 == null || imageView7.getVisibility() != 0) ? 48.0f : 96.0f));
                    this.scheduledButton.setAlpha(1.0f);
                    this.scheduledButton.setScaleX(1.0f);
            ...
            if (this.audioVideoButtonContainer.getVisibility() == 0 || this.slowModeButton.getVisibility() == 0 || z4 || z5) {
                        ...
                        if (this.attachLayout != null) {
                            ...
                            if (imageView8 != null) {
                                ...
                                if (z6) {
                                    ...
                                    fArr2[0] = AndroidUtilities.m35dp((imageView10 == null || imageView10.getVisibility() == 8) ? 48.0f : 96.0f);
                                    ...
                                    imageView11.setTranslationX(AndroidUtilities.m35dp((imageView12 == null || imageView12.getVisibility() == 8) ? 48.0f : 96.0f));
                                }
                            }
                ...
                if (this.scheduledButton != null) {
                    ...
                    imageView13.setTranslationX(AndroidUtilities.m35dp((imageView14 == null || imageView14.getVisibility() == 8) ? 48.0f : 96.0f));
                }
            }
    ...
    public void setSlowModeButtonVisible(boolean z) {
        ...
        int m35dp = z ? AndroidUtilities.m35dp(16.0f) : 0;
        if (this.messageEditText.getPaddingRight() != m35dp) {
            this.messageEditText.setPadding(0, AndroidUtilities.m35dp(11.0f), m35dp, AndroidUtilities.m35dp(12.0f));
        }
    }
    ...
    private void updateFieldRight(int i) {
        ...
        if (i == 1) {
            ...
            if (imageView7 != null && imageView7.getVisibility() == 0 && (imageView6 = this.scheduledButton) != null && imageView6.getVisibility() == 0 && (linearLayout2 = this.attachLayout) != null && linearLayout2.getVisibility() == 0) {
                layoutParams.rightMargin = AndroidUtilities.m35dp(146.0f);
            } else {
                ...
                if ((imageView8 != null && imageView8.getVisibility() == 0) || (((imageView4 = this.notifyButton) != null && imageView4.getVisibility() == 0) || ((imageView5 = this.scheduledButton) != null && imageView5.getTag() != null))) {
                    layoutParams.rightMargin = AndroidUtilities.m35dp(98.0f);
                } else {
                    layoutParams.rightMargin = AndroidUtilities.m35dp(50.0f);
                }
            }
        } else if (i == 2) {
            if (i2 != AndroidUtilities.m35dp(2.0f)) {
            ...
            if (imageView11 != null && imageView11.getTag() != null) {
                ...
                layoutParams.rightMargin = AndroidUtilities.m35dp(2.0f);
            }
        }
        ...
        if (this.audioToSend == null && this.videoToSendMessageObject == null && (messageObject2 = this.editingMessageObject) != messageObject) {
            ...
            if (messageObject != null) {
                ...
                if (charSequence != null) {
                            ...
                            try {
                                ...
                                if (tLRPC$MessageEntity.offset + tLRPC$MessageEntity.length > spannableStringBuilder.length()) {
                                    ...
                                    if (tLRPC$MessageEntity instanceof TLRPC$TL_messageEntityMentionName) {
                                        ...
                                        URLSpanUserMention uRLSpanUserMention2 = new URLSpanUserMention(BuildConfig.APP_CENTER_HASH + ((TLRPC$TL_messageEntityMentionName) tLRPC$MessageEntity).user_id, 3);
                    ...
                    charSequence2 = Emoji.replaceEmoji(new SpannableStringBuilder(spannableStringBuilder), this.messageEditText.getPaint().getFontMetricsInt(), AndroidUtilities.m35dp(20.0f), false, null, true);
                }
                ...
                layoutParams.rightMargin = AndroidUtilities.m35dp(4.0f);
                this.messageEditText.setLayoutParams(layoutParams);
                this.sendButton.setVisibility(8);
                setSlowModeButtonVisible(false);
                this.cancelBotButton.setVisibility(8);
    ...
    public void updateScheduleButton(boolean z) {
        ...
        if (DialogObject.isChatDialog(this.dialog_id)) {
            ...
            if (this.notifyButton != null) {
                if (this.notifySilentDrawable == null) {
                    this.notifySilentDrawable = new CrossOutDrawable(getContext(), C1010R.C1011drawable.input_notify_on, "chat_messagePanelIcons");
                }
                this.notifySilentDrawable.setCrossOut(this.silent, false);
                ...
                if (this.notifyButton != null) {
                    ...
                    if (i != this.notifyButton.getVisibility()) {
                        ...
                        if (linearLayout2 != null) {
                            ...
                            linearLayout2.setPivotX(AndroidUtilities.m35dp(f));
                            return;
                        }
                        return;
                    }
        ...
        if (!z || z2) {
            ...
            if (imageView7 != null) {
                ...
                this.scheduledButton.setPivotX(AndroidUtilities.m35dp(24.0f));
        ...
        if (linearLayout3 != null) {
            ...
            linearLayout3.setPivotX(AndroidUtilities.m35dp(f));
        }
    }
    ...
    public void updateSendAsButton(boolean z) {
        ...
        float f2 = z3 ? ((-this.senderSelectView.getLayoutParams().width) - marginLayoutParams.leftMargin) - m35dp : 0.0f;
        float f3 = z3 ? 1.0f : 0.0f;
        float f4 = z3 ? 0.0f : ((-this.senderSelectView.getLayoutParams().width) - marginLayoutParams.leftMargin) - m35dp;
        if (z2 != z3) {
    ...
    private void updateBotButton(boolean z) {
        ...
        if (hasBotWebView || this.hasBotCommands || this.botReplyMarkup != null) {
            if (this.botReplyMarkup != null) {
                if (isPopupShowing() && this.currentPopupContentType == 1) {
                    ...
                    this.botButtonDrawable.setIcon(C1010R.C1011drawable.input_bot2, true);
                    this.botButton.setContentDescription(LocaleController.getString("AccDescrBotKeyboard", C1010R.string.AccDescrBotKeyboard));
                }
            } else if (!z2) {
                this.botButtonDrawable.setIcon(C1010R.C1011drawable.input_bot1, true);
                this.botButton.setContentDescription(LocaleController.getString("AccDescrBotCommands", C1010R.string.AccDescrBotCommands));
                this.botButton.setVisibility(0);
            } else {
                this.botButton.setVisibility(8);
            }
        ...
        boolean menuText = this.botCommandsMenuButton.setMenuText(this.botMenuButtonType == BotMenuButtonType.COMMANDS ? LocaleController.getString(C1010R.string.BotsMenuTitle) : this.botMenuWebViewTitle);
        ...
        linearLayout.setPivotX(AndroidUtilities.m35dp(((imageView2 == null || imageView2.getVisibility() == 8) && ((imageView = this.notifyButton) == null || imageView.getVisibility() == 8)) ? 48.0f : 96.0f));
    }
        ...
        if (tLRPC$KeyboardButton instanceof TLRPC$TL_keyboardButton) {
            ...
            if (tLRPC$KeyboardButton instanceof TLRPC$TL_keyboardButtonRequestPoll) {
                ...
                final Runnable runnable = new Runnable() {
                    ...
                    @Override
                    public void run() {
                        if (ChatActivityEnterView.this.sizeNotifierLayout.measureKeyboardHeight() > AndroidUtilities.m35dp(20.0f)) {
                        ...
                        botWebViewSheet.requestWebView(i, j3, j4, str, str2, z ? 1 : 0, messageObject3 != null ? messageObject3.messageOwner.f872id : 0, false);
                        botWebViewSheet.show();
                    }
                };
                if (SharedPrefsHelper.isWebViewConfirmShown(this.currentAccount, j)) {
                    ...
                    new AlertDialog.Builder(this.parentFragment.getParentActivity()).setTitle(LocaleController.getString(C1010R.string.BotOpenPageTitle)).setMessage(AndroidUtilities.replaceTags(LocaleController.formatString("BotOpenPageMessage", C1010R.string.BotOpenPageMessage, UserObject.getUserName(user)))).setPositiveButton(LocaleController.getString(C1010R.string.OK), new DialogInterface.OnClickListener() {
                        @Override
                        public final void onClick(DialogInterface dialogInterface, int i) {
                ...
                builder.setMessage(LocaleController.getString("ShareYouLocationInfo", C1010R.string.ShareYouLocationInfo));
    ...
    private void createEmojiView() {
        ...
        this.emojiView.setDelegate(new C185857());
        this.emojiView.setDragListener(new EmojiView.DragListener() {
            ...
            public void onDragStart() {
                if (allowDragging()) {
                    ...
                    ChatActivityEnterView chatActivityEnterView = ChatActivityEnterView.this;
                    chatActivityEnterView.stickersExpandedHeight = (((chatActivityEnterView.sizeNotifierLayout.getHeight() - (Build.VERSION.SDK_INT >= 21 ? AndroidUtilities.statusBarHeight : 0)) - C1069ActionBar.getCurrentActionBarHeight()) - ChatActivityEnterView.this.getHeight()) + Theme.chat_composeShadowDrawable.getIntrinsicHeight();
                    if (ChatActivityEnterView.this.searchingType == 2) {
                        ...
                        chatActivityEnterView2.stickersExpandedHeight = Math.min(i, m35dp + (point.x > point.y ? ChatActivityEnterView.this.keyboardHeightLand : ChatActivityEnterView.this.keyboardHeight));
                    }
            ...
            public void onDragEnd(float f) {
                if (allowDragging()) {
                    ...
                    if ((this.wasExpanded && f >= AndroidUtilities.m35dp(200.0f)) || ((!this.wasExpanded && f <= AndroidUtilities.m35dp(-200.0f)) || ((this.wasExpanded && ChatActivityEnterView.this.stickersExpansionProgress <= 0.6f) || (!this.wasExpanded && ChatActivityEnterView.this.stickersExpansionProgress >= 0.4f)))) {
    ...
    public class C185857 implements EmojiView.EmojiViewDelegate {
        C185857() {
            ChatActivityEnterView.this = r1;
        }
        ...
        public void onEmojiSelected(String str) {
            ...
            try {
                try {
                    ...
                    CharSequence replaceEmoji = Emoji.replaceEmoji(str, ChatActivityEnterView.this.messageEditText.getPaint().getFontMetricsInt(), AndroidUtilities.m35dp(20.0f), false);
        ...
        public void onCustomEmojiSelected(final long j, final TLRPC$Document tLRPC$Document, final String str, final boolean z) {
            AndroidUtilities.runOnUIThread(new Runnable() {
                @Override
                public final void run() {
                    ChatActivityEnterView.C185857.this.lambda$onCustomEmojiSelected$0(str, tLRPC$Document, j, z);
                }
            });
        }
        ...
        public void lambda$onGifSelected$1(final View view, final Object obj, final String str, final Object obj2, boolean z, int i) {
            if (!isInScheduleMode() || i != 0) {
                if (ChatActivityEnterView.this.slowModeTimer <= 0 || isInScheduleMode()) {
                    ...
                    if (obj instanceof TLRPC$Document) {
                        ...
                        hashMap.put("id", tLRPC$BotInlineResult.f846id);
            ...
            AlertsCreator.createScheduleDatePickerDialog(ChatActivityEnterView.this.parentActivity, ChatActivityEnterView.this.parentFragment.getDialogId(), new AlertsCreator.ScheduleDatePickerDelegate() {
                ...
                public final void didSelectDate(boolean z2, int i2) {
                    ChatActivityEnterView.C185857.this.lambda$onGifSelected$1(view, obj, str, obj2, z2, i2);
                }
        ...
        public void onClearEmojiRecent() {
            ...
            builder.setTitle(LocaleController.getString("ClearRecentEmojiTitle", C1010R.string.ClearRecentEmojiTitle));
            builder.setMessage(LocaleController.getString("ClearRecentEmojiText", C1010R.string.ClearRecentEmojiText));
            builder.setPositiveButton(LocaleController.getString("ClearButton", C1010R.string.ClearForAll), new DialogInterface.OnClickListener() {
                @Override
                public final void onClick(DialogInterface dialogInterface, int i) {
                    ChatActivityEnterView.C185857.this.lambda$onClearEmojiRecent$2(dialogInterface, i);
                }
            });
            builder.setNegativeButton(LocaleController.getString("Cancel", C1010R.string.Cancel), null);
    ...
    public void onSizeChanged(int i, boolean z) {
        ...
        if (i > AndroidUtilities.m35dp(50.0f) && this.keyboardVisible && !AndroidUtilities.isInMultiwindow) {
            if (z) {
    ...
    public void didReceivedNotification(int i, int i2, Object... objArr) {
        ...
        if (i == NotificationCenter.recordProgressChanged) {
            ...
            if (i == NotificationCenter.recordStartError || i == NotificationCenter.recordStopped) {
                ...
                if (((Boolean) objArr[6]).booleanValue() || ((Long) objArr[3]).longValue() != this.dialog_id || (tLRPC$ChatFull = this.info) == null || tLRPC$ChatFull.slowmode_seconds == 0 || (chat = this.accountInstance.getMessagesController().getChat(Long.valueOf(this.info.f849id))) == null || ChatObject.hasAdminRights(chat)) {
                    return;
                }
    ...
    public void checkStickresExpandHeight() {
        ...
        int currentActionBarHeight = (((this.originalViewHeight - (Build.VERSION.SDK_INT >= 21 ? AndroidUtilities.statusBarHeight : 0)) - C1069ActionBar.getCurrentActionBarHeight()) - getHeight()) + Theme.chat_composeShadowDrawable.getIntrinsicHeight();
        if (this.searchingType == 2) {
            currentActionBarHeight = Math.min(currentActionBarHeight, AndroidUtilities.m35dp(120.0f) + i);
        }
    ...
    public void setStickersExpanded(boolean z, boolean z2, boolean z3, boolean z4) {
        ...
        if (z3 || this.stickersExpanded != z) {
            ...
            if (this.stickersExpanded) {
                ...
                int currentActionBarHeight = (((height - (Build.VERSION.SDK_INT >= 21 ? AndroidUtilities.statusBarHeight : 0)) - C1069ActionBar.getCurrentActionBarHeight()) - getHeight()) + Theme.chat_composeShadowDrawable.getIntrinsicHeight();
                this.stickersExpandedHeight = currentActionBarHeight;
                if (this.searchingType == 2) {
                    this.stickersExpandedHeight = Math.min(currentActionBarHeight, AndroidUtilities.m35dp(120.0f) + i);
                }
                this.emojiView.getLayoutParams().height = this.stickersExpandedHeight;
                this.sizeNotifierLayout.requestLayout();
            ...
            if (z) {
                this.expandStickersButton.setContentDescription(LocaleController.getString("AccDescrCollapsePanel", C1010R.string.AccDescrCollapsePanel));
            } else {
                this.expandStickersButton.setContentDescription(LocaleController.getString("AccDescrExpandPanel", C1010R.string.AccDescrExpandPanel));
            }
        }
    ...
    public class SlideTextView extends View {
        ...
        public SlideTextView(Context context) {
            ...
            this.smallSize = AndroidUtilities.displaySize.x <= AndroidUtilities.m35dp(320.0f);
            TextPaint textPaint = new TextPaint(1);
            this.grayPaint = textPaint;
            textPaint.setTextSize(AndroidUtilities.m35dp(this.smallSize ? 13.0f : 15.0f));
            ...
            this.slideToCancelString = LocaleController.getString("SlideToCancel", C1010R.string.SlideToCancel);
            this.slideToCancelString = this.slideToCancelString.charAt(0) + this.slideToCancelString.substring(1).toLowerCase();
            String upperCase = LocaleController.getString("Cancel", C1010R.string.Cancel).toUpperCase();
        ...
        public void updateColors() {
            ...
            Drawable createSimpleSelectorCircleDrawable = Theme.createSimpleSelectorCircleDrawable(AndroidUtilities.m35dp(60.0f), 0, ColorUtils.setAlphaComponent(ChatActivityEnterView.this.getThemedColor("chat_recordVoiceCancel"), 26));
        ...
        protected void onDraw(Canvas canvas) {
            ...
            int width = staticLayout.getWidth() + AndroidUtilities.m35dp(16.0f);
            this.grayPaint.setColor(ChatActivityEnterView.this.getThemedColor("chat_recordTime"));
            ...
            if (this.smallSize) {
                this.xOffset = AndroidUtilities.m35dp(16.0f);
            } else {
                long currentTimeMillis = System.currentTimeMillis() - this.lastUpdateTime;
                this.lastUpdateTime = System.currentTimeMillis();
                if (this.cancelToProgress == 0.0f && this.slideProgress > 0.8f) {
                    if (this.moveForward) {
                        float m35dp = this.xOffset + ((AndroidUtilities.m35dp(3.0f) / 250.0f) * ((float) currentTimeMillis));
                        this.xOffset = m35dp;
                        if (m35dp > AndroidUtilities.m35dp(6.0f)) {
                            this.xOffset = AndroidUtilities.m35dp(6.0f);
                            this.moveForward = false;
                        }
                    } else {
                        float m35dp2 = this.xOffset - ((AndroidUtilities.m35dp(3.0f) / 250.0f) * ((float) currentTimeMillis));
                        this.xOffset = m35dp2;
                        if (m35dp2 < (-AndroidUtilities.m35dp(6.0f))) {
                            this.xOffset = -AndroidUtilities.m35dp(6.0f);
            ...
            int measuredWidth = ((int) ((getMeasuredWidth() - this.slideToCancelWidth) / 2.0f)) + AndroidUtilities.m35dp(5.0f);
            ...
            float m35dp3 = ((measuredWidth + ((f2 * (1.0f - f3)) * this.slideProgress)) - (f * f3)) + AndroidUtilities.m35dp(16.0f);
            float m35dp4 = z ? 0.0f : this.cancelToProgress * AndroidUtilities.m35dp(12.0f);
            if (this.cancelToProgress != 1.0f) {
                int i = (int) (((-getMeasuredWidth()) / 4) * (1.0f - this.slideProgress));
                canvas.save();
                canvas.clipRect(ChatActivityEnterView.this.recordTimerView.getLeftProperty() + AndroidUtilities.m35dp(4.0f), 0.0f, getMeasuredWidth(), getMeasuredHeight());
                canvas.save();
                int i2 = (int) m35dp3;
                canvas.translate((i2 - AndroidUtilities.m35dp(this.smallSize ? 7.0f : 10.0f)) + i, m35dp4);
                canvas.drawPath(this.arrowPath, this.arrowPaint);
                canvas.restore();
                canvas.save();
                canvas.translate(i2 + i, ((getMeasuredHeight() - this.slideToLayout.getHeight()) / 2.0f) + m35dp4);
            ...
            if (!z) {
                measuredHeight -= AndroidUtilities.m35dp(12.0f) - m35dp4;
            }
            float f4 = z ? m35dp3 + primaryHorizontal : measuredWidth2;
            ...
            this.cancelRect.inset(-AndroidUtilities.m35dp(16.0f), -AndroidUtilities.m35dp(16.0f));
    ...
    public class TimerView extends View {
        ...
        public TimerView(Context context) {
            ...
            this.replaceDistance = AndroidUtilities.m35dp(15.0f);
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (botCommandsMenuView != null && botCommandsMenuView.getTag() != null) {
            ...
            ((ViewGroup.MarginLayoutParams) this.emojiButton.getLayoutParams()).leftMargin = AndroidUtilities.m35dp(10.0f) + this.botCommandsMenuButton.getMeasuredWidth();
            ((ViewGroup.MarginLayoutParams) this.messageEditText.getLayoutParams()).leftMargin = AndroidUtilities.m35dp(57.0f) + this.botCommandsMenuButton.getMeasuredWidth();
        } else {
            SenderSelectView senderSelectView = this.senderSelectView;
            if (senderSelectView != null && senderSelectView.getVisibility() == 0) {
                ...
                ((ViewGroup.MarginLayoutParams) this.emojiButton.getLayoutParams()).leftMargin = AndroidUtilities.m35dp(16.0f) + i3;
                ((ViewGroup.MarginLayoutParams) this.messageEditText.getLayoutParams()).leftMargin = AndroidUtilities.m35dp(63.0f) + i3;
            } else {
                ((ViewGroup.MarginLayoutParams) this.emojiButton.getLayoutParams()).leftMargin = AndroidUtilities.m35dp(3.0f);
                ((ViewGroup.MarginLayoutParams) this.messageEditText.getLayoutParams()).leftMargin = AndroidUtilities.m35dp(50.0f);
            }
        }
        if (this.botCommandsMenuContainer != null) {
            if (this.botCommandsAdapter.getItemCount() > 4) {
                max = Math.max(0, this.sizeNotifierLayout.getMeasuredHeight() - AndroidUtilities.m35dp(162.8f));
            } else {
                max = Math.max(0, this.sizeNotifierLayout.getMeasuredHeight() - AndroidUtilities.m35dp((Math.max(1, Math.min(4, this.botCommandsAdapter.getItemCount())) * 36) + 8));
            }
            if (this.botCommandsMenuContainer.listView.getPaddingTop() != max) {
                ...
                this.botCommandsMenuContainer.listView.setPadding(0, max, 0, AndroidUtilities.m35dp(8.0f));
            }
        }
        super.onMeasure(i, i2);
        ...
        if (chatActivityBotWebViewButton != null) {
            ...
            this.botWebViewButton.getLayoutParams().height = getMeasuredHeight() - AndroidUtilities.m35dp(2.0f);
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        canvas.save();
        canvas.clipRect(0, AndroidUtilities.m35dp(2.0f), getMeasuredWidth(), getMeasuredHeight());
