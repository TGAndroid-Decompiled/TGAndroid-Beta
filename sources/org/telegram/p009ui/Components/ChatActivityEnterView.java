...
public class ChatActivityEnterView extends BlurredFrameLayout implements NotificationCenter.NotificationCenterDelegate, SizeNotifierFrameLayout.SizeNotifierFrameLayoutDelegate, StickersAlert.StickersAlertDelegate {
    ...
    public class RecordDot extends View {
        ...
        public RecordDot(Context context) {
            ...
            RLottieDrawable rLottieDrawable = new RLottieDrawable(C0952R.raw.chat_audio_record_delete, "" + C0952R.raw.chat_audio_record_delete, AndroidUtilities.m34dp(28.0f), AndroidUtilities.m34dp(28.0f), false, null);
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (!this.playing || !this.drawable.hasBitmap()) {
                canvas.drawCircle(getMeasuredWidth() >> 1, getMeasuredHeight() >> 1, AndroidUtilities.m34dp(5.0f), ChatActivityEnterView.this.redDotPaint);
            }
            invalidate();
        }
    ...
    public class RecordCircle extends View {
        ...
        private float circleRadiusAmplitude = AndroidUtilities.m34dp(30.0f);
        ...
        private Paint f1024p = new Paint(1);
        private String tooltipMessage = LocaleController.getString("SlideUpToLock", C0952R.string.SlideUpToLock);

        public RecordCircle(Context context) {
            super(context);
            ChatActivityEnterView.this = r6;
            r6.micDrawable = getResources().getDrawable(C0952R.C0953drawable.input_mic_pressed).mutate();
            ...
            r6.cameraDrawable = getResources().getDrawable(C0952R.C0953drawable.input_video_pressed).mutate();
            ...
            r6.sendDrawable = getResources().getDrawable(C0952R.C0953drawable.attach_send).mutate();
            ...
            r6.micOutline = getResources().getDrawable(C0952R.C0953drawable.input_mic).mutate();
            r6.micOutline.setColorFilter(new PorterDuffColorFilter(r6.getThemedColor("chat_messagePanelIcons"), PorterDuff.Mode.MULTIPLY));
            r6.cameraOutline = getResources().getDrawable(C0952R.C0953drawable.input_video).mutate();
            ...
            this.tinyWaveDrawable.minRadius = AndroidUtilities.m34dp(47.0f);
            this.tinyWaveDrawable.maxRadius = AndroidUtilities.m34dp(55.0f);
            this.tinyWaveDrawable.generateBlob();
            this.bigWaveDrawable.minRadius = AndroidUtilities.m34dp(47.0f);
            this.bigWaveDrawable.maxRadius = AndroidUtilities.m34dp(55.0f);
            ...
            r6.lockShadowDrawable = getResources().getDrawable(C0952R.C0953drawable.lock_round_shadow);
            ...
            this.tooltipBackground = Theme.createRoundRectDrawable(AndroidUtilities.m34dp(5.0f), r6.getThemedColor("chat_gifSaveHintBackground"));
            this.tooltipPaint.setTextSize(AndroidUtilities.m34dp(14.0f));
        ...
        public int setLockTranslation(float f) {
            if (f == 10000.0f) {
                ...
                this.lockAnimatedTranslation = f;
                invalidate();
                if (this.canceledByGesture || this.slideToCancelProgress < 0.7f || this.startTranslation - this.lockAnimatedTranslation < AndroidUtilities.m34dp(57.0f)) {
                    return 1;
                }
        ...
        protected void onMeasure(int i, int i2) {
            ...
            int dp = AndroidUtilities.m34dp(194.0f);
            if (this.lastSize != size) {
                this.lastSize = size;
                StaticLayout staticLayout = new StaticLayout(this.tooltipMessage, this.tooltipPaint, AndroidUtilities.m34dp(220.0f), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, true);
            ...
            if (measuredWidth > AndroidUtilities.m34dp(140.0f)) {
                measuredWidth = AndroidUtilities.m34dp(140.0f);
            }
        ...
        public void updateColors() {
            ...
            this.tooltipBackground = Theme.createRoundRectDrawable(AndroidUtilities.m34dp(5.0f), ChatActivityEnterView.this.getThemedColor("chat_gifSaveHintBackground"));
        ...
        public class VirtualViewHelper extends ExploreByTouchHelper {
            ...
            protected void onPopulateNodeForVirtualView(int i, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
                if (i == 1) {
                    ...
                    accessibilityNodeInfoCompat.setText(LocaleController.getString("Send", C0952R.string.Send));
                } else if (i == 2) {
                    ...
                    accessibilityNodeInfoCompat.setText(LocaleController.getString("Stop", C0952R.string.Stop));
                }
            }
        }
    }
    ...
    public ChatActivityEnterView(final Activity activity, SizeNotifierFrameLayout sizeNotifierFrameLayout, final ChatActivity chatActivity, boolean z, final Theme.ResourcesProvider resourcesProvider) {
        ...
        this.distCanMove = AndroidUtilities.m34dp(80.0f);
        ...
        this.topViewUpdateListener = new ValueAnimator.AnimatorUpdateListener() {
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                ChatActivityEnterView.this.lambda$new$36(valueAnimator);
            }
        };
        ...
        this.textFieldContainer.setPadding(0, AndroidUtilities.m34dp(1.0f), 0, 0);
        ...
        FrameLayout frameLayout2 = new FrameLayout(activity) {
            ...
            protected void onLayout(boolean z3, int i4, int i5, int i6, int i7) {
                ...
                if (ChatActivityEnterView.this.scheduledButton != null) {
                    int measuredWidth = (getMeasuredWidth() - AndroidUtilities.m34dp((ChatActivityEnterView.this.botButton == null || ChatActivityEnterView.this.botButton.getVisibility() != 0) ? 48.0f : 96.0f)) - AndroidUtilities.m34dp(48.0f);
            ...
            protected boolean drawChild(Canvas canvas, View view, long j) {
                ...
                canvas.save();
                canvas.clipRect(0, ((-getTop()) - ChatActivityEnterView.this.textFieldContainer.getTop()) - ChatActivityEnterView.this.getTop(), getMeasuredWidth(), getMeasuredHeight() - AndroidUtilities.m34dp(6.0f));
        ...
        while (i4 < i3) {
            this.emojiButton[i4] = new ImageView(activity) {
                ...
                protected void onDraw(Canvas canvas) {
                    ...
                    if (getTag() != null && ChatActivityEnterView.this.attachLayout != null && !ChatActivityEnterView.this.emojiViewVisible && !MediaDataController.getInstance(ChatActivityEnterView.this.currentAccount).getUnreadStickerSets().isEmpty() && ChatActivityEnterView.this.dotPaint != null) {
                        canvas.drawCircle((getWidth() / 2) + AndroidUtilities.m34dp(9.0f), (getHeight() / 2) - AndroidUtilities.m34dp(8.0f), AndroidUtilities.m34dp(5.0f), ChatActivityEnterView.this.dotPaint);
                    }
                }
            };
            ...
            this.emojiButton[i4].setContentDescription(LocaleController.getString("AccDescrEmojiButton", C0952R.string.AccDescrEmojiButton));
            if (i4 == 1) {
        ...
        C167212 r1 = new C167212(activity, resourcesProvider, resourcesProvider, chatActivity, activity);
        ...
        try {
            if (Build.VERSION.SDK_INT >= 29) {
                Drawable mutate = this.messageEditText.getTextSelectHandle().mutate();
                mutate.setColorFilter(themedColor, PorterDuff.Mode.SRC_IN);
                this.messageEditText.setTextSelectHandle(mutate);
                Drawable mutate2 = this.messageEditText.getTextSelectHandleLeft().mutate();
                mutate2.setColorFilter(themedColor, PorterDuff.Mode.SRC_IN);
                this.messageEditText.setTextSelectHandleLeft(mutate2);
                Drawable mutate3 = this.messageEditText.getTextSelectHandleRight().mutate();
                mutate3.setColorFilter(themedColor, PorterDuff.Mode.SRC_IN);
                this.messageEditText.setTextSelectHandleRight(mutate3);
            }
        ...
        this.messageEditText.addTextChangedListener(new C167715());
        if (z) {
            if (this.parentFragment != null) {
                Drawable mutate4 = activity.getResources().getDrawable(C0952R.C0953drawable.input_calendar1).mutate();
                Drawable mutate5 = activity.getResources().getDrawable(C0952R.C0953drawable.input_calendar2).mutate();
                mutate4.setColorFilter(new PorterDuffColorFilter(getThemedColor("chat_messagePanelIcons"), PorterDuff.Mode.MULTIPLY));
                mutate5.setColorFilter(new PorterDuffColorFilter(getThemedColor("chat_recordedVoiceDot"), PorterDuff.Mode.MULTIPLY));
                CombinedDrawable combinedDrawable = new CombinedDrawable(mutate4, mutate5);
                ImageView imageView = new ImageView(activity);
                this.scheduledButton = imageView;
                imageView.setImageDrawable(combinedDrawable);
                this.scheduledButton.setVisibility(8);
                this.scheduledButton.setContentDescription(LocaleController.getString("ScheduledMessages", C0952R.string.ScheduledMessages));
            ...
            this.attachLayout.setPivotX(AndroidUtilities.m34dp(48.0f));
            ...
            this.botCommandsMenuContainer.listView.setOnItemClickListener(new C168017(resourcesProvider, chatActivity));
            ...
            this.botButtonDrawable.setIcon(C0952R.C0953drawable.input_bot2, false);
            ...
            CrossOutDrawable crossOutDrawable = new CrossOutDrawable(activity, C0952R.C0953drawable.input_notify_on, "chat_messagePanelIcons");
            ...
            if (this.silent) {
                i = C0952R.string.AccDescrChanSilentOn;
                str2 = "AccDescrChanSilentOn";
            } else {
                i = C0952R.string.AccDescrChanSilentOff;
            ...
            this.notifyButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (ChatActivityEnterView.this.notifySilentDrawable == null) {
                        ChatActivityEnterView.this.notifySilentDrawable = new CrossOutDrawable(activity, C0952R.C0953drawable.input_notify_on, "chat_messagePanelIcons");
                    }
                    ...
                    if (ChatActivityEnterView.this.silent) {
                        i6 = C0952R.string.AccDescrChanSilentOn;
                        str3 = "AccDescrChanSilentOn";
                    } else {
                        i6 = C0952R.string.AccDescrChanSilentOff;
            ...
            this.attachButton.setImageResource(C0952R.C0953drawable.input_attach);
            ...
            this.attachButton.setContentDescription(LocaleController.getString("AccDescrAttachButton", C0952R.string.AccDescrAttachButton));
        } else {
            str = "listSelectorSDK21";
        }
        ...
        senderSelectView.setOnClickListener(new View.OnClickListener() {
            @Override
            public final void onClick(View view) {
                ChatActivityEnterView.this.lambda$new$13(activity, view);
            }
        });
        ...
        this.recordDeleteImageView.setAnimation(C0952R.raw.chat_audio_record_delete_2, 28, 28);
        this.recordDeleteImageView.getAnimatedDrawable().setInvalidateOnProgressSet(true);
        updateRecordedDeleteIconColors();
        this.recordDeleteImageView.setContentDescription(LocaleController.getString("Delete", C0952R.string.Delete));
        ...
        this.recordDeleteImageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public final void onClick(View view) {
                ChatActivityEnterView.this.lambda$new$14(view);
            }
        });
        ...
        view.setBackgroundDrawable(Theme.createRoundRectDrawable(AndroidUtilities.m34dp(18.0f), getThemedColor("chat_recordedVoiceBackground")));
        ...
        this.recordedAudioPlayButton.setContentDescription(LocaleController.getString("AccActionPlay", C0952R.string.AccActionPlay));
        ...
        this.recordTimeContainer.setPadding(AndroidUtilities.m34dp(13.0f), 0, 0, 0);
        ...
        this.audioVideoButtonContainer.setOnTouchListener(new View.OnTouchListener() {
            ...
            public final boolean onTouch(View view2, MotionEvent motionEvent) {
                ...
                lambda$new$23 = ChatActivityEnterView.this.lambda$new$23(resourcesProvider, view2, motionEvent);
        ...
        this.audioSendButton.setImageResource(C0952R.C0953drawable.input_mic);
        this.audioSendButton.setPadding(0, 0, AndroidUtilities.m34dp(4.0f), 0);
        this.audioSendButton.setContentDescription(LocaleController.getString("AccDescrVoiceMessage", C0952R.string.AccDescrVoiceMessage));
        ...
        if (z) {
            ...
            this.videoSendButton.setImageResource(C0952R.C0953drawable.input_video);
            this.videoSendButton.setPadding(0, 0, AndroidUtilities.m34dp(4.0f), 0);
            this.videoSendButton.setContentDescription(LocaleController.getString("AccDescrVideoMessage", C0952R.string.AccDescrVideoMessage));
        ...
        this.cancelBotButton.setContentDescription(LocaleController.getString("Cancel", C0952R.string.Cancel));
        ...
        this.cancelBotButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public final void onClick(View view2) {
                ChatActivityEnterView.this.lambda$new$24(view2);
            }
        });
        if (isInScheduleMode()) {
            this.sendButtonDrawable = activity.getResources().getDrawable(C0952R.C0953drawable.input_schedule).mutate();
            this.sendButtonInverseDrawable = activity.getResources().getDrawable(C0952R.C0953drawable.input_schedule).mutate();
            this.inactinveSendButtonDrawable = activity.getResources().getDrawable(C0952R.C0953drawable.input_schedule).mutate();
        } else {
            this.sendButtonDrawable = activity.getResources().getDrawable(C0952R.C0953drawable.ic_send).mutate();
            this.sendButtonInverseDrawable = activity.getResources().getDrawable(C0952R.C0953drawable.ic_send).mutate();
            this.inactinveSendButtonDrawable = activity.getResources().getDrawable(C0952R.C0953drawable.ic_send).mutate();
        }
        View view2 = new View(activity) {
            ...
            protected void onDraw(Canvas canvas) {
                ...
                if (ChatActivityEnterView.this.isInScheduleMode()) {
                    measuredHeight -= AndroidUtilities.m34dp(1.0f);
                } else {
                    measuredWidth += AndroidUtilities.m34dp(2.0f);
                }
                int i8 = 1;
                ...
                if (z3 || this.animationProgress != 1.0f) {
                    ...
                    int dp3 = AndroidUtilities.m34dp(20.0f);
                    if (z3) {
                        ChatActivityEnterView.this.sendButtonInverseDrawable.setAlpha(255);
                        float f3 = this.animationProgress;
                        if (f3 <= 0.25f) {
                            f = dp3;
                            dp2 = AndroidUtilities.m34dp(2.0f) * CubicBezierInterpolator.EASE_IN.getInterpolation(f3 / 0.25f);
                        } else {
                            float f4 = f3 - 0.25f;
                            if (f4 <= 0.5f) {
                                f = dp3;
                                dp2 = AndroidUtilities.m34dp(2.0f) - (AndroidUtilities.m34dp(3.0f) * CubicBezierInterpolator.EASE_IN.getInterpolation(f4 / 0.5f));
                            } else {
                                dp = (int) (dp3 + (-AndroidUtilities.m34dp(1.0f)) + (AndroidUtilities.m34dp(1.0f) * CubicBezierInterpolator.EASE_IN.getInterpolation((f4 - 0.5f) / 0.25f)));
                                dp3 = dp;
                            }
                        }
                        dp = (int) (f + dp2);
        ...
        int themedColor2 = getThemedColor("chat_messagePanelSend");
        this.sendButton.setContentDescription(LocaleController.getString("Send", C0952R.string.Send));
        this.sendButton.setSoundEffectsEnabled(false);
        this.sendButton.setScaleX(0.1f);
        this.sendButton.setScaleY(0.1f);
        this.sendButton.setAlpha(0.0f);
        if (i6 >= 21) {
            this.sendButton.setBackgroundDrawable(Theme.createSelectorDrawable(Color.argb(24, Color.red(themedColor2), Color.green(themedColor2), Color.blue(themedColor2)), 1));
        }
        ...
        this.slowModeButton.setPadding(0, 0, AndroidUtilities.m34dp(13.0f), 0);
        ...
        this.slowModeButton.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public final boolean onLongClick(View view3) {
                ...
                lambda$new$27 = ChatActivityEnterView.this.lambda$new$27(view3);
        ...
        this.expandStickersButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public final void onClick(View view3) {
                ChatActivityEnterView.this.lambda$new$28(view3);
            }
        });
        this.expandStickersButton.setContentDescription(LocaleController.getString("AccDescrExpandPanel", C0952R.string.AccDescrExpandPanel));
        ...
        ShapeDrawable createCircleDrawable = Theme.createCircleDrawable(AndroidUtilities.m34dp(16.0f), getThemedColor("chat_messagePanelSend"));
        Drawable mutate6 = activity.getResources().getDrawable(C0952R.C0953drawable.input_done).mutate();
        this.doneCheckDrawable = mutate6;
        mutate6.setColorFilter(new PorterDuffColorFilter(getThemedColor("chat_messagePanelVoicePressed"), PorterDuff.Mode.MULTIPLY));
        CombinedDrawable combinedDrawable2 = new CombinedDrawable(createCircleDrawable, mutate6, 0, AndroidUtilities.m34dp(1.0f));
        combinedDrawable2.setCustomSize(AndroidUtilities.m34dp(32.0f), AndroidUtilities.m34dp(32.0f));
        ...
        this.doneButtonImage.setContentDescription(LocaleController.getString("Done", C0952R.string.Done));
        ...
        this.keyboardHeight = globalEmojiSettings.getInt("kbd_height", AndroidUtilities.m34dp(200.0f));
        this.keyboardHeightLand = globalEmojiSettings.getInt("kbd_height_land3", AndroidUtilities.m34dp(200.0f));
    ...
    public class C167212 extends EditTextCaption {
        final Activity val$context;
        final ChatActivity val$fragment;
        final Theme.ResourcesProvider val$resourcesProvider;

        C167212(Context context, Theme.ResourcesProvider resourcesProvider, Theme.ResourcesProvider resourcesProvider2, ChatActivity chatActivity, Activity activity) {
            ...
            try {
                ...
                return InputConnectionCompat.createWrapper(onCreateInputConnection, editorInfo, new InputConnectionCompat.OnCommitContentListener() {
                    ...
                    public final boolean onCommitContent(InputContentInfoCompat inputContentInfoCompat, int i, Bundle bundle) {
                        ...
                        lambda$onCreateInputConnection$1 = ChatActivityEnterView.C167212.this.lambda$onCreateInputConnection$1(resourcesProvider, inputContentInfoCompat, i, bundle);
            ...
            if (!inputContentInfoCompat.getDescription().hasMimeType("image/gif") && !SendMessagesHelper.shouldSendWebPAsSticker(null, inputContentInfoCompat.getContentUri())) {
                ...
                AlertsCreator.createScheduleDatePickerDialog(ChatActivityEnterView.this.parentActivity, ChatActivityEnterView.this.parentFragment.getDialogId(), new AlertsCreator.ScheduleDatePickerDelegate() {
                    ...
                    public final void didSelectDate(boolean z, int i2) {
                        ChatActivityEnterView.C167212.this.lambda$onCreateInputConnection$0(inputContentInfoCompat, z, i2);
                    }
                }, resourcesProvider);
            } else {
                ...
                if (!ChatActivityEnterView.this.isPopupShowing() || motionEvent.getAction() != 0) {
                    ...
                    if (ChatActivityEnterView.this.stickersExpanded) {
                        ...
                        AndroidUtilities.runOnUIThread(new Runnable() {
                            @Override
                            public final void run() {
                                ChatActivityEnterView.C167212.this.lambda$onTouchEvent$2();
                            }
                        }, 200L);
                    } else {
        ...
        private void editPhoto(final Uri uri, String str) {
            ...
            dispatchQueue.postRunnable(new Runnable() {
                @Override
                public final void run() {
                    ChatActivityEnterView.C167212.this.lambda$editPhoto$4(activity, uri, generatePicturePath);
                }
            });
        }
                ...
                while (true) {
                    ...
                    if (read > 0) {
                        ...
                        AndroidUtilities.runOnUIThread(new Runnable() {
                            @Override
                            public final void run() {
                                ChatActivityEnterView.C167212.this.lambda$editPhoto$3(arrayList, file);
                            }
                        });
                        return;
                    }
        ...
        public void lambda$editPhoto$3(final ArrayList<Object> arrayList, final File file) {
            ...
            if (ChatActivityEnterView.this.keyboardVisible) {
                ...
                AndroidUtilities.runOnUIThread(new Runnable() {
                    ...
                    @Override
                    public void run() {
                        C167212.this.lambda$editPhoto$3(arrayList, file);
                    }
                }, 100L);
                return;
            }
    ...
    public class C167715 implements TextWatcher {
        ...
        public void afterTextChanged(android.text.Editable r11) {
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p009ui.Components.ChatActivityEnterView.C167715.afterTextChanged(android.text.Editable):void");
        }
    ...
    public class C168017 implements RecyclerListView.OnItemClickListener {
        final ChatActivity val$fragment;
        final Theme.ResourcesProvider val$resourcesProvider;

        C168017(Theme.ResourcesProvider resourcesProvider, ChatActivity chatActivity) {
            ChatActivityEnterView.this = r1;
                ...
                if (!TextUtils.isEmpty(command)) {
                    if (ChatActivityEnterView.this.isInScheduleMode()) {
                        AlertsCreator.createScheduleDatePickerDialog(ChatActivityEnterView.this.parentActivity, ChatActivityEnterView.this.dialog_id, new AlertsCreator.ScheduleDatePickerDelegate() {
                            @Override
                            public final void didSelectDate(boolean z, int i2) {
                                ChatActivityEnterView.C168017.this.lambda$onItemClick$0(command, z, i2);
                            }
    ...
    public void lambda$new$13(Activity activity, View view) {
        int i;
        int i2;
        ...
        if (this.delegate.measureKeyboardHeight() > AndroidUtilities.m34dp(20.0f)) {
            ...
            if (contentViewHeight < AndroidUtilities.m34dp(200.0f)) {
        ...
        if (this.delegate.getSendAsPeers() != null) {
            ...
            if (chatFull != null) {
                ...
                this.senderSelectPopupWindow.getContentView().measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m34dp(1000.0f), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m34dp(1000.0f), Integer.MIN_VALUE));
                ...
                int i4 = -AndroidUtilities.m34dp(4.0f);
                int[] iArr = new int[2];
                ...
                if (measureKeyboardHeight2 <= AndroidUtilities.m34dp(20.0f)) {
                ...
                if (measuredHeight < (((i4 * 2) + contentViewHeight2) - (this.parentFragment.isInBubbleMode() ? 0 : AndroidUtilities.statusBarHeight)) - this.senderSelectPopupWindow.headerText.getMeasuredHeight()) {
                    ...
                    i2 = ((iArr[1] - measuredHeight) - i4) - AndroidUtilities.m34dp(2.0f);
                    parentLayout.addView(this.senderSelectPopupWindow.dimView, new FrameLayout.LayoutParams(-1, i4 + i2 + measuredHeight + dp + AndroidUtilities.m34dp(2.0f)));
                } else {
                    if (!this.parentFragment.isInBubbleMode()) {
                        i3 = AndroidUtilities.statusBarHeight;
                    }
                    int dp2 = AndroidUtilities.m34dp(14.0f);
    ...
    public void lambda$new$12(TLRPC$ChatFull tLRPC$ChatFull, MessagesController messagesController, RecyclerView recyclerView, final SenderSelectPopup.SenderView senderView, TLRPC$Peer tLRPC$Peer) {
        TLRPC$User user;
        if (this.senderSelectPopupWindow != null) {
            ...
            Runnable chatActivityEnterView$$ExternalSyntheticLambda48 = new Runnable() {
                @Override
                public final void run() {
                    ChatActivityEnterView.this.lambda$new$11(simpleAvatarView, iArr, senderView);
                }
            };
            if (!isSelected) {
                j3 = 200;
            }
            AndroidUtilities.runOnUIThread(chatActivityEnterView$$ExternalSyntheticLambda48, j3);
        }
    }

    public void lambda$new$11(final SimpleAvatarView simpleAvatarView, int[] iArr, SenderSelectPopup.SenderView senderView) {
        if (this.senderSelectPopupWindow != null) {
            final Dialog dialog = new Dialog(getContext(), C0952R.style.TransparentDialogNoAnimation);
            ...
            float dp2 = iArr[0] + this.popupX + dp + AndroidUtilities.m34dp(4.0f) + 0.0f;
            float f3 = iArr[1] + this.popupY + dp + 0.0f;
            simpleAvatarView.setTranslationX(dp2);
            simpleAvatarView.setTranslationY(f3);
            float dp3 = this.senderSelectView.getLayoutParams().width / AndroidUtilities.m34dp(40.0f);
            ...
            simpleAvatarView.getViewTreeObserver().addOnDrawListener(new ViewTreeObserver$OnDrawListenerC168622(this, simpleAvatarView, senderView));
            dialog.show();
            ...
            senderSelectPopup.startDismissAnimation(new SpringAnimation(senderSelectView, viewProperty).setSpring(new SpringForce(0.5f).setStiffness(750.0f).setDampingRatio(1.0f)), new SpringAnimation(senderSelectView2, viewProperty2).setSpring(new SpringForce(0.5f).setStiffness(750.0f).setDampingRatio(1.0f)), new SpringAnimation(this.senderSelectView, DynamicAnimation.ALPHA).setSpring(new SpringForce(0.0f).setStiffness(750.0f).setDampingRatio(1.0f)).addEndListener(new DynamicAnimation.OnAnimationEndListener() {
                ...
                public final void onAnimationEnd(DynamicAnimation dynamicAnimation, boolean z, float f4, float f5) {
                    ChatActivityEnterView.this.lambda$new$9(dialog, simpleAvatarView, f, f2, dynamicAnimation, z, f4, f5);
                }
            }), new SpringAnimation(simpleAvatarView, DynamicAnimation.TRANSLATION_X).setStartValue(MathUtils.clamp(dp2, f - AndroidUtilities.m34dp(6.0f), dp2)).setSpring(new SpringForce(f).setStiffness(700.0f).setDampingRatio(0.75f)).setMinValue(f - AndroidUtilities.m34dp(6.0f)), new SpringAnimation(simpleAvatarView, DynamicAnimation.TRANSLATION_Y).setStartValue(MathUtils.clamp(f3, f3, AndroidUtilities.m34dp(6.0f) + f2)).setSpring(new SpringForce(f2).setStiffness(700.0f).setDampingRatio(0.75f)).setMaxValue(AndroidUtilities.m34dp(6.0f) + f2).addUpdateListener(new DynamicAnimation.OnAnimationUpdateListener(this) {
    ...
    public class ViewTreeObserver$OnDrawListenerC168622 implements ViewTreeObserver.OnDrawListener {
        final SimpleAvatarView val$avatar;
        final SenderSelectPopup.SenderView val$senderView;

        ViewTreeObserver$OnDrawListenerC168622(ChatActivityEnterView chatActivityEnterView, SimpleAvatarView simpleAvatarView, SenderSelectPopup.SenderView senderView) {
        ...
        public void onDraw() {
            ...
            simpleAvatarView.post(new Runnable() {
                @Override
                public final void run() {
                    ChatActivityEnterView.ViewTreeObserver$OnDrawListenerC168622.this.lambda$onDraw$0(simpleAvatarView, senderView);
                }
            });
        }
    ...
    public void lambda$new$9(final Dialog dialog, SimpleAvatarView simpleAvatarView, float f, float f2, DynamicAnimation dynamicAnimation, boolean z, float f3, float f4) {
        if (dialog.isShowing()) {
    ...
    public void lambda$new$15(View view) {
        if (this.audioToSend != null) {
            if (!MediaController.getInstance().isPlayingMessage(this.audioToSendMessageObject) || MediaController.getInstance().isMessagePaused()) {
                ...
                this.recordedAudioPlayButton.setContentDescription(LocaleController.getString("AccActionPause", C0952R.string.AccActionPause));
                return;
            }
    ...
    public boolean lambda$new$23(Theme.ResourcesProvider resourcesProvider, View view, MotionEvent motionEvent) {
        ...
        if (motionEvent.getAction() != 0) {
            ...
            if (motionEvent.getAction() == 1 || motionEvent.getAction() == 3) {
                if (motionEvent.getAction() == 3 && this.recordingAudioVideo) {
                    ...
                    return false;
                } else if ((((motionEvent.getX() + this.audioVideoButtonContainer.getX()) - this.startedDraggingX) / this.distCanMove) + 1.0f < 0.45d) {
                    if (!this.hasRecordVideo || this.videoSendButton.getTag() == null) {
                        this.delegate.needStartRecordAudio(0);
                        MediaController.getInstance().stopRecording(0, false, 0);
                    } else {
                    ...
                    if (!z2 || this.calledRecordRunnable) {
                        ...
                        if (!z2 || this.videoSendButton.getTag() == null) {
                            if (this.recordingAudioVideo && isInScheduleMode()) {
                                AlertsCreator.createScheduleDatePickerDialog(this.parentActivity, this.parentFragment.getDialogId(), ChatActivityEnterView$$ExternalSyntheticLambda55.INSTANCE, ChatActivityEnterView$$ExternalSyntheticLambda49.INSTANCE, resourcesProvider);
                            }
                            this.delegate.needStartRecordAudio(0);
                        ...
                        Runnable chatActivityEnterView$$ExternalSyntheticLambda35 = new Runnable() {
                            @Override
                            public final void run() {
                                ChatActivityEnterView.this.lambda$new$22();
                            }
                        };
                        this.moveToSendStateRunnable = chatActivityEnterView$$ExternalSyntheticLambda35;
                        AndroidUtilities.runOnUIThread(chatActivityEnterView$$ExternalSyntheticLambda35, 500L);
                    }
                }
                ...
                if (this.startedDraggingX == -1.0f) {
                    ...
                    this.distCanMove = f2;
                    if (f2 > AndroidUtilities.m34dp(140.0f)) {
                        this.distCanMove = AndroidUtilities.m34dp(140.0f);
                    }
                }
            ...
            if (!z3 || this.calledRecordRunnable) {
                ...
                if (!z3 || this.videoSendButton.getTag() == null) {
                    if (this.recordingAudioVideo && isInScheduleMode()) {
                        AlertsCreator.createScheduleDatePickerDialog(this.parentActivity, this.parentFragment.getDialogId(), ChatActivityEnterView$$ExternalSyntheticLambda54.INSTANCE, ChatActivityEnterView$$ExternalSyntheticLambda50.INSTANCE, resourcesProvider);
                    }
                ...
                Runnable chatActivityEnterView$$ExternalSyntheticLambda43 = new Runnable() {
                    @Override
                    public final void run() {
                        ChatActivityEnterView.this.lambda$new$19();
                    }
                };
                this.moveToSendStateRunnable = chatActivityEnterView$$ExternalSyntheticLambda43;
                AndroidUtilities.runOnUIThread(chatActivityEnterView$$ExternalSyntheticLambda43, 200L);
            }
            return false;
        } else {
    ...
    public static void lambda$new$17(boolean z, int i) {
        MediaController.getInstance().stopRecording(1, z, i);
    }

    public static void lambda$new$18() {
        MediaController.getInstance().stopRecording(0, false, 0);
    }
    ...
    public static void lambda$new$20(boolean z, int i) {
        MediaController.getInstance().stopRecording(1, z, i);
    }

    public static void lambda$new$21() {
        MediaController.getInstance().stopRecording(0, false, 0);
    }
    ...
    public void lambda$new$24(View view) {
    ...
    public boolean lambda$new$27(View view) {
        if (this.messageEditText.length() == 0) {
            return false;
        }
    ...
    public void openWebViewMenu() {
        final Runnable chatActivityEnterView$$ExternalSyntheticLambda45 = new Runnable() {
            @Override
            public final void run() {
        ...
        if (SharedPrefsHelper.isWebViewConfirmShown(this.currentAccount, this.dialog_id)) {
            chatActivityEnterView$$ExternalSyntheticLambda45.run();
        } else {
            new AlertDialog.Builder(this.parentFragment.getParentActivity()).setTitle(LocaleController.getString((int) C0952R.string.BotOpenPageTitle)).setMessage(AndroidUtilities.replaceTags(LocaleController.formatString(C0952R.string.BotOpenPageMessage, UserObject.getUserName(MessagesController.getInstance(this.currentAccount).getUser(Long.valueOf(this.dialog_id)))))).setPositiveButton(LocaleController.getString((int) C0952R.string.OK), new DialogInterface.OnClickListener() {
                @Override
                public final void onClick(DialogInterface dialogInterface, int i) {
                    ChatActivityEnterView.this.lambda$openWebViewMenu$31(chatActivityEnterView$$ExternalSyntheticLambda45, dialogInterface, i);
                }
            }).setNegativeButton(LocaleController.getString((int) C0952R.string.Cancel), null).setOnDismissListener(new DialogInterface.OnDismissListener() {
                @Override
                public final void onDismiss(DialogInterface dialogInterface) {
                    ChatActivityEnterView.this.lambda$openWebViewMenu$32(dialogInterface);
                }
            }).show();
        }
    }
    ...
    public void lambda$openWebViewMenu$31(Runnable runnable, DialogInterface dialogInterface, int i) {
        runnable.run();
        SharedPrefsHelper.setWebViewConfirmShown(this.currentAccount, this.dialog_id, true);
    }

    public void lambda$openWebViewMenu$32(DialogInterface dialogInterface) {
        if (!SharedPrefsHelper.isWebViewConfirmShown(this.currentAccount, this.dialog_id)) {
    ...
    protected boolean drawChild(Canvas canvas, View view, long j) {
        ...
        if (z) {
            ...
            if (view == this.textFieldContainer) {
                int dp = this.animatedTop + AndroidUtilities.m34dp(2.0f);
                ...
                canvas.clipRect(0, this.animatedTop, getMeasuredWidth(), this.animatedTop + view.getLayoutParams().height + AndroidUtilities.m34dp(2.0f));
            }
        }
        boolean drawChild = super.drawChild(canvas, view, j);
        if (z) {
    ...
    public void lambda$onSendLongClick$33(KeyEvent keyEvent) {
    ...
    public void lambda$onSendLongClick$34(View view) {
        ActionBarPopupWindow actionBarPopupWindow = this.sendPopupWindow;
        if (actionBarPopupWindow != null && actionBarPopupWindow.isShowing()) {
            this.sendPopupWindow.dismiss();
        }
    ...
    private void setRecordVideoButtonVisible(boolean r12, boolean r13) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p009ui.Components.ChatActivityEnterView.setRecordVideoButtonVisible(boolean, boolean):void");
    }
    ...
    public void updateSlowModeText() {
        ...
        if (tLRPC$ChatFull == null || tLRPC$ChatFull.slowmode_seconds == 0 || tLRPC$ChatFull.slowmode_next_send_date > currentTime || (!(isUploadingMessageIdDialog = SendMessagesHelper.getInstance(this.currentAccount).isUploadingMessageIdDialog(this.dialog_id)) && !SendMessagesHelper.getInstance(this.currentAccount).isSendingMessageIdDialog(this.dialog_id))) {
            ...
            if (i3 >= 2147483646) {
                if (this.info != null) {
                    this.accountInstance.getMessagesController().loadFullChat(this.info.f855id, 0, true);
                }
                i = 0;
            } else {
                i = i3 - currentTime;
            ...
            if (!ChatObject.hasAdminRights(this.accountInstance.getMessagesController().getChat(Long.valueOf(this.info.f855id)))) {
    ...
    public void lambda$new$36(ValueAnimator valueAnimator) {
    ...
    private void showTopView(boolean z, boolean z2, boolean z3) {
        if (this.topView != null && !this.topViewShowed && getVisibility() == 0) {
            ...
            Runnable chatActivityEnterView$$ExternalSyntheticLambda44 = new Runnable() {
                @Override
                public final void run() {
                    ChatActivityEnterView.this.lambda$showTopView$37();
                }
            };
            this.showTopViewRunnable = chatActivityEnterView$$ExternalSyntheticLambda44;
            AndroidUtilities.runOnUIThread(chatActivityEnterView$$ExternalSyntheticLambda44, 200L);
    ...
    public void lambda$showTopView$37() {
    ...
    private void onWindowSizeChanged() {
        ...
        if (height < AndroidUtilities.m34dp(72.0f) + C1006ActionBar.getCurrentActionBarHeight()) {
            if (this.allowShowTopView) {
    ...
    public void resizeForTopView(boolean z) {
        ...
        layoutParams.topMargin = AndroidUtilities.m34dp(2.0f) + (z ? this.topView.getLayoutParams().height : 0);
        this.textFieldContainer.setLayoutParams(layoutParams);
        setMinimumHeight(AndroidUtilities.m34dp(51.0f) + (z ? this.topView.getLayoutParams().height : 0));
        if (!this.stickersExpanded) {
            return;
        }
        if (this.searchingType == 0) {
    ...
    public void checkChannelRights() {
        ...
        if (chatActivity != null && (currentChat = chatActivity.getCurrentChat()) != null) {
            ...
            EmojiView emojiView = this.emojiView;
            if (emojiView != null) {
                emojiView.setStickersBanned(!ChatObject.canSendStickers(currentChat), currentChat.f854id);
            }
        }
    }
    ...
    public void onPause() {
        ...
        Runnable chatActivityEnterView$$ExternalSyntheticLambda36 = new Runnable() {
            @Override
            public final void run() {
                ChatActivityEnterView.this.lambda$onPause$38();
            }
        };
        this.hideKeyboardRunnable = chatActivityEnterView$$ExternalSyntheticLambda36;
        AndroidUtilities.runOnUIThread(chatActivityEnterView$$ExternalSyntheticLambda36, 500L);
    }

    public void lambda$onPause$38() {
        ChatActivity chatActivity = this.parentFragment;
    ...
    public void updateFieldHint(boolean z) {
        ...
        if (messageObject2 != null && (tLRPC$ReplyMarkup2 = messageObject2.messageOwner.reply_markup) != null && !TextUtils.isEmpty(tLRPC$ReplyMarkup2.placeholder)) {
            ...
            this.messageEditText.setHintText(this.editingCaption ? LocaleController.getString("Caption", C0952R.string.Caption) : LocaleController.getString("TypeMessage", C0952R.string.TypeMessage));
            ...
            if (DialogObject.isChatDialog(this.dialog_id)) {
                ...
                if (ChatObject.getSendAsPeerId(chat, chatFull) == chat.f854id) {
                    z3 = true;
                }
            } else {
                z2 = false;
            ...
            if (z3) {
                this.messageEditText.setHintText(LocaleController.getString("SendAnonymously", C0952R.string.SendAnonymously));
                return;
            }
            ChatActivity chatActivity = this.parentFragment;
            if (chatActivity == null || !chatActivity.isThreadChat()) {
                if (!z2) {
                    this.messageEditText.setHintText(LocaleController.getString("TypeMessage", C0952R.string.TypeMessage));
                } else if (this.silent) {
                    this.messageEditText.setHintText(LocaleController.getString("ChannelSilentBroadcast", C0952R.string.ChannelSilentBroadcast), z);
                } else {
                    this.messageEditText.setHintText(LocaleController.getString("ChannelBroadcast", C0952R.string.ChannelBroadcast), z);
                }
            } else if (this.parentFragment.isReplyChatComment()) {
                this.messageEditText.setHintText(LocaleController.getString("Comment", C0952R.string.Comment));
            } else {
                this.messageEditText.setHintText(LocaleController.getString("Reply", C0952R.string.Reply));
            }
        } else {
            ...
            if (this.videoToSendMessageObject != null) {
                ...
                if (chatActivity2 != null && (currentChat = chatActivity2.getCurrentChat()) != null && currentChat.slowmode_enabled && !ChatObject.hasAdminRights(currentChat)) {
                    if (text.length() > this.accountInstance.getMessagesController().maxMessageLength) {
                        AlertsCreator.showSimpleAlert(this.parentFragment, LocaleController.getString("Slowmode", C0952R.string.Slowmode), LocaleController.getString("SlowmodeSendErrorTooLong", C0952R.string.SlowmodeSendErrorTooLong), this.resourcesProvider);
                        return;
                    } else if (this.forceShowSendButton && text.length() > 0) {
                        AlertsCreator.showSimpleAlert(this.parentFragment, LocaleController.getString("Slowmode", C0952R.string.Slowmode), LocaleController.getString("SlowmodeSendError", C0952R.string.SlowmodeSendError), this.resourcesProvider);
                        return;
                    }
                }
                if (processSendingText(text, z, i)) {
                    if (this.delegate.hasForwardingMessages() || ((i != 0 && !isInScheduleMode()) || isInScheduleMode())) {
                        ...
                        Runnable chatActivityEnterView$$ExternalSyntheticLambda47 = new Runnable() {
                            @Override
                            public final void run() {
                                ChatActivityEnterView.this.lambda$sendMessageInternal$39(text, z, i);
                            }
                        };
                        this.moveToSendStateRunnable = chatActivityEnterView$$ExternalSyntheticLambda47;
    ...
    public void lambda$sendMessageInternal$39(CharSequence charSequence, boolean z, int i) {
        this.moveToSendStateRunnable = null;
        hideTopView(true);
        this.messageEditText.setText("");
        ChatActivityEnterViewDelegate chatActivityEnterViewDelegate = this.delegate;
    ...
    public void lambda$doneEditingMessage$40() {
        this.waitingForKeyboardOpenAfterAnimation = false;
        openKeyboardInternal();
    }
    ...
    public boolean processSendingText(CharSequence charSequence, boolean z, int i) {
        ...
        while (true) {
            ...
            if (!this.delegate.hasForwardingMessages()) {
                ...
                float dp = AndroidUtilities.m34dp(22.0f);
                sendAnimationData.height = dp;
                sendAnimationData.width = dp;
                this.messageEditText.getLocationInWindow(this.location);
                sendAnimationData.f817x = this.location[c] + AndroidUtilities.m34dp(11.0f);
                sendAnimationData.f818y = this.location[1] + AndroidUtilities.m34dp(19.0f);
            }
            int i12 = i11;
            ...
            if (i3 <= 0 || i3 == Integer.MAX_VALUE || isInScheduleMode()) {
                if (trimmedString.length() > 0 || this.forceShowSendButton || this.audioToSend != null || this.videoToSendMessageObject != null || (this.slowModeTimer == Integer.MAX_VALUE && !isInScheduleMode())) {
                    ...
                    if (!z2) {
                        ...
                        if (this.scheduledButton != null) {
                            ...
                            ImageView imageView2 = this.botButton;
                            imageView.setTranslationX(AndroidUtilities.m34dp((imageView2 == null || imageView2.getVisibility() == 8) ? 48.0f : 96.0f));
                        }
                            ...
                            if (this.attachLayout != null) {
                                ...
                                if (imageView3 != null) {
                                    ...
                                    if (z5) {
                                        ...
                                        fArr[0] = AndroidUtilities.m34dp((imageView5 == null || imageView5.getVisibility() == 8) ? 48.0f : 96.0f);
                                        ...
                                        imageView6.setTranslationX(AndroidUtilities.m34dp((imageView7 == null || imageView7.getVisibility() == 8) ? 48.0f : 96.0f));
                                    }
                                }
                        ...
                        if (linearLayout2 != null) {
                            ...
                            if (imageView8 != null) {
                                if (z6) {
                                    ...
                                    this.scheduledButton.setTag(1);
                                    this.scheduledButton.setPivotX(AndroidUtilities.m34dp(48.0f));
                ...
                if (!z2) {
                    ...
                    if (this.scheduledButton != null) {
                        ...
                        imageView10.setTranslationX(AndroidUtilities.m34dp((imageView11 == null || imageView11.getVisibility() != 0) ? 48.0f : 96.0f));
                        this.scheduledButton.setAlpha(1.0f);
                        this.scheduledButton.setScaleX(1.0f);
                        this.scheduledButton.setScaleY(1.0f);
                    }
                    ...
                    if (this.attachLayout != null) {
                        ...
                        if (imageView12 != null) {
                            ...
                            if (z8) {
                                ...
                                fArr2[0] = AndroidUtilities.m34dp((imageView14 == null || imageView14.getVisibility() != 0) ? 48.0f : 96.0f);
                                ...
                                imageView15.setTranslationX(AndroidUtilities.m34dp((imageView16 == null || imageView16.getVisibility() != 0) ? 48.0f : 96.0f));
                                this.scheduledButton.setAlpha(1.0f);
                                this.scheduledButton.setScaleX(1.0f);
                            }
                        }
    ...
    public void setSlowModeButtonVisible(boolean z) {
        ...
        int dp = z ? AndroidUtilities.m34dp(16.0f) : 0;
        if (this.messageEditText.getPaddingRight() != dp) {
            this.messageEditText.setPadding(0, AndroidUtilities.m34dp(11.0f), dp, AndroidUtilities.m34dp(12.0f));
        }
    }
            ...
            if (i == 1) {
                ...
                if (imageView7 == null || imageView7.getVisibility() != 0 || (imageView6 = this.scheduledButton) == null || imageView6.getVisibility() != 0 || (linearLayout2 = this.attachLayout) == null || linearLayout2.getVisibility() != 0) {
                    ...
                    if ((imageView8 == null || imageView8.getVisibility() != 0) && (((imageView4 = this.notifyButton) == null || imageView4.getVisibility() != 0) && ((imageView5 = this.scheduledButton) == null || imageView5.getTag() == null))) {
                        layoutParams.rightMargin = AndroidUtilities.m34dp(50.0f);
                    } else {
                        layoutParams.rightMargin = AndroidUtilities.m34dp(98.0f);
                    }
                } else {
                    layoutParams.rightMargin = AndroidUtilities.m34dp(146.0f);
                }
            } else if (i != 2) {
                ImageView imageView9 = this.scheduledButton;
                if (imageView9 == null || imageView9.getTag() == null) {
                    layoutParams.rightMargin = AndroidUtilities.m34dp(2.0f);
                } else {
                    layoutParams.rightMargin = AndroidUtilities.m34dp(50.0f);
                }
            } else if (i2 != AndroidUtilities.m34dp(2.0f)) {
    ...
    public void lambda$updateRecordInterface$41(ValueAnimator valueAnimator) {
        float floatValue = ((Float) valueAnimator.getAnimatedValue()).floatValue();
        if (!isInVideoMode()) {
        ...
        if (this.audioToSend == null && this.videoToSendMessageObject == null && (messageObject2 = this.editingMessageObject) != messageObject) {
            ...
            if (messageObject != null) {
                ...
                if (charSequence != null) {
                    ...
                    str2 = Emoji.replaceEmoji(new SpannableStringBuilder(spannableStringBuilder), this.messageEditText.getPaint().getFontMetricsInt(), AndroidUtilities.m34dp(20.0f), false);
                }
                ...
                if (!this.keyboardVisible) {
                    Runnable chatActivityEnterView$$ExternalSyntheticLambda46 = new Runnable() {
                        @Override
                        public final void run() {
                            ChatActivityEnterView.this.lambda$setEditingMessageObject$42(str2);
                        }
                    };
                    this.setTextFieldRunnable = chatActivityEnterView$$ExternalSyntheticLambda46;
                    AndroidUtilities.runOnUIThread(chatActivityEnterView$$ExternalSyntheticLambda46, 200L);
                } else {
                ...
                layoutParams.rightMargin = AndroidUtilities.m34dp(4.0f);
                this.messageEditText.setLayoutParams(layoutParams);
                this.sendButton.setVisibility(8);
                setSlowModeButtonVisible(false);
                this.cancelBotButton.setVisibility(8);
    ...
    public void lambda$setEditingMessageObject$42(CharSequence charSequence) {
    ...
    public void setFieldFocused(boolean z) {
        ...
        if (this.messageEditText != null && !accessibilityManager.isTouchExplorationEnabled()) {
            if (!z) {
                ...
                Runnable chatActivityEnterView$$ExternalSyntheticLambda42 = new Runnable() {
                    @Override
                    public final void run() {
                        ChatActivityEnterView.this.lambda$setFieldFocused$43();
                    }
                };
                this.focusRunnable = chatActivityEnterView$$ExternalSyntheticLambda42;
                AndroidUtilities.runOnUIThread(chatActivityEnterView$$ExternalSyntheticLambda42, 600L);
            }
        }
    }

    public void lambda$setFieldFocused$43() {
    ...
    public void updateScheduleButton(boolean z) {
        ...
        if (DialogObject.isChatDialog(this.dialog_id)) {
            ...
            if (this.notifyButton != null) {
                if (this.notifySilentDrawable == null) {
                    this.notifySilentDrawable = new CrossOutDrawable(getContext(), C0952R.C0953drawable.input_notify_on, "chat_messagePanelIcons");
                }
                this.notifySilentDrawable.setCrossOut(this.silent, false);
            ...
            if ((imageView3.getTag() == null || !z4) && (this.scheduledButton.getTag() != null || z4)) {
                ...
                if (i != this.notifyButton.getVisibility()) {
                    ...
                    if (linearLayout2 != null) {
                        ...
                        linearLayout2.setPivotX(AndroidUtilities.m34dp(f));
                        return;
                    }
                    return;
                }
        ...
        if (!z || z2) {
            ...
            if (imageView9 != null) {
                ...
                this.scheduledButton.setPivotX(AndroidUtilities.m34dp(24.0f));
        ...
        if (linearLayout3 != null) {
            ...
            linearLayout3.setPivotX(AndroidUtilities.m34dp(f));
        }
    }
            ...
            if (z2 != z3) {
                ...
                duration.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                    ...
                    public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                        ChatActivityEnterView.this.lambda$updateSendAsButton$44(f5, f6, f7, f8, valueAnimator2);
                    }
                });
                final boolean z4 = z3;
                final float f9 = f2;
    ...
    public void lambda$updateSendAsButton$44(float f, float f2, float f3, float f4, ValueAnimator valueAnimator) {
        float floatValue = ((Float) valueAnimator.getAnimatedValue()).floatValue();
    ...
    private void updateBotButton(boolean z) {
        ...
        if (this.botButton != null) {
            ...
            boolean z3 = this.botMenuButtonType != BotMenuButtonType.NO_BUTTON && this.dialog_id > 0;
            ...
            if (!hasBotWebView && !this.hasBotCommands && this.botReplyMarkup == null) {
                ...
                if (!isPopupShowing() || this.currentPopupContentType != 1) {
                    this.botButtonDrawable.setIcon(C0952R.C0953drawable.input_bot2, true);
                    this.botButton.setContentDescription(LocaleController.getString("AccDescrBotKeyboard", C0952R.string.AccDescrBotKeyboard));
                } else {
                    this.botButtonDrawable.setIcon(C0952R.C0953drawable.input_keyboard, true);
                    this.botButton.setContentDescription(LocaleController.getString("AccDescrShowKeyboard", C0952R.string.AccDescrShowKeyboard));
                }
            } else if (!z3) {
                this.botButtonDrawable.setIcon(C0952R.C0953drawable.input_bot1, true);
                this.botButton.setContentDescription(LocaleController.getString("AccDescrBotCommands", C0952R.string.AccDescrBotCommands));
                this.botButton.setVisibility(0);
            } else {
                this.botButton.setVisibility(8);
            }
            ...
            boolean menuText = this.botCommandsMenuButton.setMenuText(this.botMenuButtonType == BotMenuButtonType.COMMANDS ? LocaleController.getString((int) C0952R.string.BotsMenuTitle) : this.botMenuWebViewTitle);
            AndroidUtilities.updateViewVisibilityAnimated(this.botCommandsMenuButton, z3, 0.5f, z);
            if (!((this.botButton.getVisibility() == 0) == z4 && !menuText && z5 == this.botCommandsMenuButton.isWebView)) {
                z2 = true;
            }
            if (z2 && z) {
                beginDelayedTransition();
            ...
            LinearLayout linearLayout = this.attachLayout;
            ImageView imageView2 = this.botButton;
            linearLayout.setPivotX(AndroidUtilities.m34dp(((imageView2 == null || imageView2.getVisibility() == 8) && ((imageView = this.notifyButton) == null || imageView.getVisibility() == 8)) ? 48.0f : 96.0f));
        }
    }
    ...
    public void lambda$setButtons$45(TLRPC$KeyboardButton tLRPC$KeyboardButton) {
        ...
        if (tLRPC$KeyboardButton instanceof TLRPC$TL_keyboardButton) {
            ...
            if (tLRPC$KeyboardButton instanceof TLRPC$TL_keyboardButtonRequestPoll) {
                ...
                final Runnable runnable = new Runnable() {
                    ...
                    @Override
                    public void run() {
                        if (ChatActivityEnterView.this.sizeNotifierLayout.measureKeyboardHeight() > AndroidUtilities.m34dp(20.0f)) {
                        ...
                        botWebViewSheet.requestWebView(i, j3, j4, str, str2, z, messageObject3 != null ? messageObject3.messageOwner.f877id : 0, false);
                ...
                if (SharedPrefsHelper.isWebViewConfirmShown(this.currentAccount, j)) {
                    ...
                    new AlertDialog.Builder(this.parentFragment.getParentActivity()).setTitle(LocaleController.getString((int) C0952R.string.BotOpenPageTitle)).setMessage(AndroidUtilities.replaceTags(LocaleController.formatString("BotOpenPageMessage", C0952R.string.BotOpenPageMessage, UserObject.getUserName(user)))).setPositiveButton(LocaleController.getString((int) C0952R.string.OK), new DialogInterface.OnClickListener() {
                        @Override
                        public final void onClick(DialogInterface dialogInterface, int i) {
                            ChatActivityEnterView.this.lambda$didPressedBotButton$46(runnable, j, dialogInterface, i);
                        }
                ...
                builder.setMessage(LocaleController.getString("ShareYouLocationInfo", C0952R.string.ShareYouLocationInfo));
                builder.setPositiveButton(LocaleController.getString("OK", C0952R.string.OK), new DialogInterface.OnClickListener() {
                    @Override
                    public final void onClick(DialogInterface dialogInterface, int i) {
                        ChatActivityEnterView.this.lambda$didPressedBotButton$47(messageObject2, tLRPC$KeyboardButton, dialogInterface, i);
                    }
                });
                ...
                if (tLRPC$KeyboardButton.same_peer) {
                    ...
                    dialogsActivity.setDelegate(new DialogsActivity.DialogsActivityDelegate() {
                        ...
                        public final void didSelectDialogs(DialogsActivity dialogsActivity2, ArrayList arrayList, CharSequence charSequence, boolean z) {
                            ChatActivityEnterView.this.lambda$didPressedBotButton$48(messageObject2, tLRPC$KeyboardButton, dialogsActivity2, arrayList, charSequence, z);
                        }
                    });
    ...
    public void lambda$didPressedBotButton$46(Runnable runnable, long j, DialogInterface dialogInterface, int i) {
        runnable.run();
        SharedPrefsHelper.setWebViewConfirmShown(this.currentAccount, j, true);
    }

    public void lambda$didPressedBotButton$47(MessageObject messageObject, TLRPC$KeyboardButton tLRPC$KeyboardButton, DialogInterface dialogInterface, int i) {
    ...
    public void lambda$didPressedBotButton$48(MessageObject messageObject, TLRPC$KeyboardButton tLRPC$KeyboardButton, DialogsActivity dialogsActivity, ArrayList arrayList, CharSequence charSequence, boolean z) {
    ...
    private void createEmojiView() {
        if (this.emojiView == null) {
            ...
            this.emojiView.setDelegate(new C172558());
            this.emojiView.setDragListener(new EmojiView.DragListener() {
                ...
                public void onDragStart() {
                    if (allowDragging()) {
                        ...
                        chatActivityEnterView.stickersExpandedHeight = (((height - i) - C1006ActionBar.getCurrentActionBarHeight()) - ChatActivityEnterView.this.getHeight()) + Theme.chat_composeShadowDrawable.getIntrinsicHeight();
                ...
                public void onDragEnd(float f) {
                    if (allowDragging()) {
                        ...
                        if ((!this.wasExpanded || f < AndroidUtilities.m34dp(200.0f)) && ((this.wasExpanded || f > AndroidUtilities.m34dp(-200.0f)) && ((!this.wasExpanded || ChatActivityEnterView.this.stickersExpansionProgress > 0.6f) && (this.wasExpanded || ChatActivityEnterView.this.stickersExpansionProgress < 0.4f)))) {
    ...
    public class C172558 implements EmojiView.EmojiViewDelegate {
        C172558() {
            ChatActivityEnterView.this = r1;
        }
        ...
        public void onEmojiSelected(String str) {
            ...
            try {
                try {
                    ...
                    CharSequence replaceEmoji = Emoji.replaceEmoji(str, ChatActivityEnterView.this.messageEditText.getPaint().getFontMetricsInt(), AndroidUtilities.m34dp(20.0f), false);
        ...
        public void onStickerSelected(View view, TLRPC$Document tLRPC$Document, String str, Object obj, MessageObject.SendAnimationData sendAnimationData, boolean z, int i) {
            ...
            if (ChatActivityEnterView.this.slowModeTimer <= 0 || isInScheduleMode()) {
                ...
                ChatActivityEnterView.this.lambda$onStickerSelected$49(tLRPC$Document, str, obj, sendAnimationData, false, z, i);
            ...
            if (isInScheduleMode() && i == 0) {
                AlertsCreator.createScheduleDatePickerDialog(ChatActivityEnterView.this.parentActivity, ChatActivityEnterView.this.parentFragment.getDialogId(), new AlertsCreator.ScheduleDatePickerDelegate() {
                    ...
                    public final void didSelectDate(boolean z2, int i2) {
                        ChatActivityEnterView.C172558.this.lambda$onGifSelected$0(view, obj, str, obj2, z2, i2);
                    }
                ...
                if (obj instanceof TLRPC$Document) {
                    ...
                    hashMap.put("id", tLRPC$BotInlineResult.f852id);
        ...
        public void onClearEmojiRecent() {
            if (ChatActivityEnterView.this.parentFragment != null && ChatActivityEnterView.this.parentActivity != null) {
                ...
                builder.setPositiveButton(LocaleController.getString("ClearButton", C0952R.string.ClearButton).toUpperCase(), new DialogInterface.OnClickListener() {
                    @Override
                    public final void onClick(DialogInterface dialogInterface, int i) {
                        ChatActivityEnterView.C172558.this.lambda$onClearEmojiRecent$1(dialogInterface, i);
                    }
                });
                builder.setNegativeButton(LocaleController.getString("Cancel", C0952R.string.Cancel), null);
    ...
    @Override
    public void lambda$onStickerSelected$49(final TLRPC$Document tLRPC$Document, final String str, final Object obj, final MessageObject.SendAnimationData sendAnimationData, final boolean z, boolean z2, int i) {
        if (isInScheduleMode() && i == 0) {
            AlertsCreator.createScheduleDatePickerDialog(this.parentActivity, this.parentFragment.getDialogId(), new AlertsCreator.ScheduleDatePickerDelegate() {
                ...
                public final void didSelectDate(boolean z3, int i2) {
                    ChatActivityEnterView.this.lambda$onStickerSelected$49(tLRPC$Document, str, obj, sendAnimationData, z, z3, i2);
                }
        ...
        if (i != 2) {
            if (i == 1) {
                ...
                if (sizeNotifierFrameLayout2 != null) {
                    ...
                    onWindowSizeChanged();
                    if (this.smoothKeyboard && !this.keyboardVisible && i4 != i3) {
    ...
    private void setEmojiButtonImage(boolean z, boolean z2) {
        ...
        if (this.currentEmojiIcon != i) {
            ...
            if (i == 0) {
                this.emojiButton[r12].setImageResource(C0952R.C0953drawable.input_keyboard);
            } else if (i == 1) {
                this.emojiButton[r12].setImageResource(C0952R.C0953drawable.input_smile);
            } else if (i == 2) {
                this.emojiButton[r12].setImageResource(C0952R.C0953drawable.input_sticker);
            } else if (i == 3) {
                this.emojiButton[r12].setImageResource(C0952R.C0953drawable.input_gif);
            }
        ...
        if (z2 != (this.searchingType != 0)) {
            ...
            if (!z) {
                ...
                ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                    @Override
                    public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                        ChatActivityEnterView.this.lambda$setSearchingTypeInternal$50(valueAnimator2);
                    }
                });
    ...
    public void lambda$setSearchingTypeInternal$50(ValueAnimator valueAnimator) {
    ...
    public void onSizeChanged(int i, boolean z) {
        ...
        if (i > AndroidUtilities.m34dp(50.0f) && this.keyboardVisible && !AndroidUtilities.isInMultiwindow) {
            if (z) {
        ...
        if (i == NotificationCenter.recordProgressChanged) {
            ...
            if (i != NotificationCenter.recordStartError && i != NotificationCenter.recordStopped) {
                ...
                if (i == NotificationCenter.recordStarted) {
                    ...
                    if (!((Boolean) objArr[6]).booleanValue() && ((Long) objArr[3]).longValue() == this.dialog_id && (tLRPC$ChatFull = this.info) != null && tLRPC$ChatFull.slowmode_seconds != 0 && (chat = this.accountInstance.getMessagesController().getChat(Long.valueOf(this.info.f855id))) != null && !ChatObject.hasAdminRights(chat)) {
    ...
    public void checkStickresExpandHeight() {
        if (this.emojiView != null) {
            ...
            int currentActionBarHeight = (((this.originalViewHeight - (Build.VERSION.SDK_INT >= 21 ? AndroidUtilities.statusBarHeight : 0)) - C1006ActionBar.getCurrentActionBarHeight()) - getHeight()) + Theme.chat_composeShadowDrawable.getIntrinsicHeight();
            if (this.searchingType == 2) {
                currentActionBarHeight = Math.min(currentActionBarHeight, AndroidUtilities.m34dp(120.0f) + i);
            }
    ...
    public void lambda$checkStickresExpandHeight$51(ValueAnimator valueAnimator) {
    ...
    public void setStickersExpanded(boolean z, boolean z2, boolean z3) {
        ...
        if (z3 || this.stickersExpanded != z) {
            ...
            if (this.stickersExpanded) {
                ...
                int currentActionBarHeight = (((height - (Build.VERSION.SDK_INT >= 21 ? AndroidUtilities.statusBarHeight : 0)) - C1006ActionBar.getCurrentActionBarHeight()) - getHeight()) + Theme.chat_composeShadowDrawable.getIntrinsicHeight();
                this.stickersExpandedHeight = currentActionBarHeight;
                if (this.searchingType == 2) {
                    this.stickersExpandedHeight = Math.min(currentActionBarHeight, AndroidUtilities.m34dp(120.0f) + i);
                }
                this.emojiView.getLayoutParams().height = this.stickersExpandedHeight;
                this.sizeNotifierLayout.requestLayout();
            ...
            if (z) {
                this.expandStickersButton.setContentDescription(LocaleController.getString("AccDescrCollapsePanel", C0952R.string.AccDescrCollapsePanel));
            } else {
                this.expandStickersButton.setContentDescription(LocaleController.getString("AccDescrExpandPanel", C0952R.string.AccDescrExpandPanel));
            }
        }
    ...
    public void lambda$setStickersExpanded$53(int i, ValueAnimator valueAnimator) {
    ...
    public class SlideTextView extends View {
        ...
        public SlideTextView(Context context) {
            ...
            this.smallSize = AndroidUtilities.displaySize.x <= AndroidUtilities.m34dp(320.0f);
            TextPaint textPaint = new TextPaint(1);
            this.grayPaint = textPaint;
            textPaint.setTextSize(AndroidUtilities.m34dp(this.smallSize ? 13.0f : 15.0f));
            ...
            this.slideToCancelString = LocaleController.getString("SlideToCancel", C0952R.string.SlideToCancel);
            this.slideToCancelString = this.slideToCancelString.charAt(0) + this.slideToCancelString.substring(1).toLowerCase();
            String upperCase = LocaleController.getString("Cancel", C0952R.string.Cancel).toUpperCase();
        ...
        public void updateColors() {
            ...
            Drawable createSimpleSelectorCircleDrawable = Theme.createSimpleSelectorCircleDrawable(AndroidUtilities.m34dp(60.0f), 0, ColorUtils.setAlphaComponent(ChatActivityEnterView.this.getThemedColor("chat_recordVoiceCancel"), 26));
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (this.slideToLayout != null && (staticLayout = this.cancelLayout) != null) {
                int width = staticLayout.getWidth() + AndroidUtilities.m34dp(16.0f);
                this.grayPaint.setColor(ChatActivityEnterView.this.getThemedColor("chat_recordTime"));
                ...
                boolean z = true;
                if (this.smallSize) {
                    this.xOffset = AndroidUtilities.m34dp(16.0f);
                } else {
                    long currentTimeMillis = System.currentTimeMillis() - this.lastUpdateTime;
                    this.lastUpdateTime = System.currentTimeMillis();
                    if (this.cancelToProgress == 0.0f && this.slideProgress > 0.8f) {
                        if (this.moveForward) {
                            float dp = this.xOffset + ((AndroidUtilities.m34dp(3.0f) / 250.0f) * ((float) currentTimeMillis));
                            this.xOffset = dp;
                            if (dp > AndroidUtilities.m34dp(6.0f)) {
                                this.xOffset = AndroidUtilities.m34dp(6.0f);
                                this.moveForward = false;
                            }
                        } else {
                            float dp2 = this.xOffset - ((AndroidUtilities.m34dp(3.0f) / 250.0f) * ((float) currentTimeMillis));
                            this.xOffset = dp2;
                            if (dp2 < (-AndroidUtilities.m34dp(6.0f))) {
                                this.xOffset = -AndroidUtilities.m34dp(6.0f);
                ...
                int measuredWidth = ((int) ((getMeasuredWidth() - this.slideToCancelWidth) / 2.0f)) + AndroidUtilities.m34dp(5.0f);
                ...
                float dp3 = ((measuredWidth + ((f2 * (1.0f - f3)) * this.slideProgress)) - (f * f3)) + AndroidUtilities.m34dp(16.0f);
                float dp4 = z ? 0.0f : this.cancelToProgress * AndroidUtilities.m34dp(12.0f);
                if (this.cancelToProgress != 1.0f) {
                    int i = (int) (((-getMeasuredWidth()) / 4) * (1.0f - this.slideProgress));
                    canvas.save();
                    canvas.clipRect(ChatActivityEnterView.this.recordTimerView.getLeftProperty() + AndroidUtilities.m34dp(4.0f), 0.0f, getMeasuredWidth(), getMeasuredHeight());
                    canvas.save();
                    int i2 = (int) dp3;
                    canvas.translate((i2 - AndroidUtilities.m34dp(this.smallSize ? 7.0f : 10.0f)) + i, dp4);
                ...
                if (this.cancelToProgress > 0.0f) {
                    ...
                    if (!z) {
                        measuredHeight -= AndroidUtilities.m34dp(12.0f) - dp4;
                    }
                    ...
                    this.cancelRect.inset(-AndroidUtilities.m34dp(16.0f), -AndroidUtilities.m34dp(16.0f));
    ...
    public class TimerView extends View {
        ...
        final float replaceDistance = AndroidUtilities.m34dp(15.0f);
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (botCommandsMenuView == null || botCommandsMenuView.getTag() == null) {
            ...
            if (senderSelectView == null || senderSelectView.getVisibility() != 0) {
                ...
                while (true) {
                    ...
                    ((ViewGroup.MarginLayoutParams) imageViewArr[i4].getLayoutParams()).leftMargin = AndroidUtilities.m34dp(3.0f);
                    i4++;
                }
                ((ViewGroup.MarginLayoutParams) this.messageEditText.getLayoutParams()).leftMargin = AndroidUtilities.m34dp(50.0f);
            } else {
                ...
                while (true) {
                    ...
                    ((ViewGroup.MarginLayoutParams) imageViewArr2[i6].getLayoutParams()).leftMargin = AndroidUtilities.m34dp(16.0f) + i5;
                    i6++;
                }
                ((ViewGroup.MarginLayoutParams) this.messageEditText.getLayoutParams()).leftMargin = AndroidUtilities.m34dp(63.0f) + i5;
            }
        } else {
            ...
            while (true) {
                ...
                ((ViewGroup.MarginLayoutParams) imageViewArr3[i7].getLayoutParams()).leftMargin = AndroidUtilities.m34dp(10.0f) + this.botCommandsMenuButton.getMeasuredWidth();
                i7++;
            }
            ((ViewGroup.MarginLayoutParams) this.messageEditText.getLayoutParams()).leftMargin = AndroidUtilities.m34dp(57.0f) + this.botCommandsMenuButton.getMeasuredWidth();
        }
        if (this.botCommandsMenuContainer != null) {
            if (this.botCommandsAdapter.getItemCount() > 4) {
                i3 = Math.max(0, this.sizeNotifierLayout.getMeasuredHeight() - AndroidUtilities.m34dp(162.8f));
            } else {
                i3 = Math.max(0, this.sizeNotifierLayout.getMeasuredHeight() - AndroidUtilities.m34dp((Math.max(1, Math.min(4, this.botCommandsAdapter.getItemCount())) * 36) + 8));
            }
            if (this.botCommandsMenuContainer.listView.getPaddingTop() != i3) {
                ...
                this.botCommandsMenuContainer.listView.setPadding(0, i3, 0, AndroidUtilities.m34dp(8.0f));
            }
        }
        super.onMeasure(i, i2);
        ...
        if (chatActivityBotWebViewButton != null) {
            ...
            this.botWebViewButton.getLayoutParams().height = getMeasuredHeight() - AndroidUtilities.m34dp(2.0f);
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        canvas.save();
        canvas.clipRect(0, AndroidUtilities.m34dp(2.0f), getMeasuredWidth(), getMeasuredHeight());
