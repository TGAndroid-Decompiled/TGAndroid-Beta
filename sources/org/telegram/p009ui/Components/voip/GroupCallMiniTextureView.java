...
public class GroupCallMiniTextureView extends FrameLayout implements GroupCallStatusIcon.Callback {
    ...
    public GroupCallMiniTextureView(final GroupCallRenderersContainer groupCallRenderersContainer, ArrayList<GroupCallMiniTextureView> arrayList, final ChatObject.Call call, final GroupCallActivity groupCallActivity) {
        ...
        CrossOutDrawable crossOutDrawable = new CrossOutDrawable(groupCallRenderersContainer.getContext(), C0952R.C0953drawable.calls_video, null);
        this.pausedVideoDrawable = crossOutDrawable;
        crossOutDrawable.setCrossOut(true, false);
        this.pausedVideoDrawable.setOffsets(-AndroidUtilities.m34dp(4.0f), AndroidUtilities.m34dp(6.0f), AndroidUtilities.m34dp(6.0f));
        this.pausedVideoDrawable.setStrokeWidth(AndroidUtilities.dpf2(3.4f));
        this.castingScreenDrawable = groupCallRenderersContainer.getContext().getResources().getDrawable(C0952R.C0953drawable.screencast_big).mutate();
        ...
        textPaint2.setTextSize(AndroidUtilities.m34dp(15.0f));
        textPaint2.setColor(-1);
        final String string = LocaleController.getString("VoipVideoOnPause", C0952R.string.VoipVideoOnPause);
        final StaticLayout staticLayout = new StaticLayout(LocaleController.getString("VoipVideoScreenSharingTwoLines", C0952R.string.VoipVideoScreenSharingTwoLines), textPaint, AndroidUtilities.m34dp(400.0f), Layout.Alignment.ALIGN_CENTER, 1.0f, 0.0f, false);
        TLRPC$Chat chat = MessagesController.getInstance(this.currentAccount).getChat(Long.valueOf(call.chatId));
        final StaticLayout staticLayout2 = new StaticLayout(LocaleController.formatString("VoipVideoNotAvailable", C0952R.string.VoipVideoNotAvailable, LocaleController.formatPluralString("Participants", MessagesController.getInstance(this.currentAccount).groupCallVideoMaxParticipants)), textPaint, AndroidUtilities.m34dp(400.0f), Layout.Alignment.ALIGN_CENTER, 1.0f, 0.0f, false);
        final String string2 = LocaleController.getString("VoipVideoScreenSharing", C0952R.string.VoipVideoScreenSharing);
        ...
        VoIPTextureView voIPTextureView = new VoIPTextureView(groupCallRenderersContainer.getContext(), false, false, true, true) {
            ...
            public void dispatchDraw(Canvas canvas) {
                ...
                if (!this.renderer.isFirstFrameRendered() || (!(this.renderer.getAlpha() == 1.0f || this.blurRenderer.getAlpha() == 1.0f) || GroupCallMiniTextureView.this.videoIsPaused)) {
                    ...
                    if (videoParticipant == call.videoNotAvailableParticipant) {
                        if (groupCallMiniTextureView4.showingInFullscreen || !groupCallRenderersContainer.inFullscreenMode) {
                            float dp = AndroidUtilities.m34dp(48.0f);
                            textPaint.setAlpha(255);
                            canvas.save();
                            canvas.translate((((getMeasuredWidth() - dp) / 2.0f) - (AndroidUtilities.m34dp(400.0f) / 2.0f)) + (dp / 2.0f), ((getMeasuredHeight() / 2) - dp) + dp + AndroidUtilities.m34dp(10.0f));
                        ...
                        int dp2 = AndroidUtilities.m34dp(33.0f);
                        ...
                        if (groupCallMiniTextureView5.animateToFullscreen || groupCallMiniTextureView5.showingInFullscreen) {
                            f3 = dp2;
                            f2 = AndroidUtilities.m34dp(10.0f) + (AndroidUtilities.m34dp(39.0f) * groupCallRenderersContainer.progressToFullscreenMode);
                        } else {
                            f3 = dp2;
                            f2 = AndroidUtilities.m34dp(10.0f) * Math.max(1.0f - groupCallRenderersContainer.progressToFullscreenMode, (GroupCallMiniTextureView.this.showingAsScrimView || GroupCallMiniTextureView.this.animateToScrimView) ? groupCallRenderersContainer.progressToScrimView : 0.0f);
                        }
                        int i2 = (int) (f3 + f2);
                        ...
                        float measuredHeight = ((getMeasuredHeight() - i2) / 2) - AndroidUtilities.m34dp(28.0f);
                        float dp3 = AndroidUtilities.m34dp(17.0f);
                        float dp4 = AndroidUtilities.m34dp(74.0f);
                        GroupCallMiniTextureView groupCallMiniTextureView7 = GroupCallMiniTextureView.this;
                        int dp5 = (int) ((measuredHeight - ((dp3 + (dp4 * ((groupCallMiniTextureView7.showingInFullscreen || groupCallMiniTextureView7.animateToFullscreen) ? groupCallRenderersContainer.progressToFullscreenMode : 0.0f))) * f6)) + (AndroidUtilities.m34dp(17.0f) * f4));
                        ...
                        if (f8 > 0.0f || f7 > 0.0f) {
                            ...
                            canvas.drawText(string2, (measuredWidth - (measureText2 / 2.0f)) + (i2 / 2.0f), AndroidUtilities.m34dp(32.0f) + i, textPaint2);
                        } else {
                            GroupCallMiniTextureView.this.stopSharingTextView.setAlpha(0.0f);
                        }
                        GroupCallMiniTextureView.this.stopSharingTextView.setTranslationY(((AndroidUtilities.m34dp(72.0f) + i) + GroupCallMiniTextureView.this.swipeToBackDy) - this.currentClipVertical);
                        ...
                        if (f9 < 1.0f && f7 < 1.0f) {
                            ...
                            canvas.save();
                            canvas.translate((measuredWidth - (AndroidUtilities.m34dp(400.0f) / 2.0f)) + (i2 / 2.0f), i + AndroidUtilities.m34dp(10.0f));
                ...
                float measuredHeight2 = (getMeasuredHeight() - this.currentClipVertical) - AndroidUtilities.m34dp(80.0f);
                if (GroupCallMiniTextureView.this.participant != call.videoNotAvailableParticipant) {
                    ...
                    if ((groupCallMiniTextureView11.showingInFullscreen || groupCallMiniTextureView11.animateToFullscreen) && !GroupCallActivity.isLandscapeMode && !GroupCallActivity.isTabletMode) {
                        ...
                        measuredHeight2 -= (AndroidUtilities.m34dp(90.0f) * groupCallRenderersContainer2.progressToFullscreenMode) * (1.0f - groupCallRenderersContainer2.progressToHideUi);
                    }
                ...
                if (GroupCallMiniTextureView.this.videoIsPaused || GroupCallMiniTextureView.this.videoIsPausedProgress != 0.0f) {
                    ...
                    float f13 = f10 * f;
                    if (f13 > 0.0f) {
                        float dp6 = AndroidUtilities.m34dp(48.0f);
                        ...
                        if (f15 > 0.0f && GroupCallMiniTextureView.this.participant != call.videoNotAvailableParticipant) {
                            ...
                            canvas.drawText(string, (measuredWidth2 - (measureText / 2.0f)) + (dp6 / 2.0f), f14 + AndroidUtilities.m34dp(16.0f), textPaint);
                        }
                    }
                }
            }
        ...
        this.speakingPaint.setStrokeWidth(AndroidUtilities.m34dp(2.0f));
        ...
        imageView.setPadding(AndroidUtilities.m34dp(4.0f), AndroidUtilities.m34dp(4.0f), AndroidUtilities.m34dp(4.0f), AndroidUtilities.m34dp(4.0f));
        imageView.setImageDrawable(ContextCompat.getDrawable(groupCallRenderersContainer.getContext(), C0952R.C0953drawable.voicechat_screencast));
        imageView.setColorFilter(new PorterDuffColorFilter(-1, PorterDuff.Mode.MULTIPLY));
        Drawable createSimpleSelectorRoundRectDrawable = Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m34dp(19.0f), 0, ColorUtils.setAlphaComponent(-1, 100));
        ...
        textView.setText(LocaleController.getString("VoipVideoScreenStopSharing", C0952R.string.VoipVideoScreenStopSharing));
        ...
        this.stopSharingTextView.setPadding(AndroidUtilities.m34dp(21.0f), 0, AndroidUtilities.m34dp(21.0f), 0);
        ...
        this.noRtmpStreamTextView.setPadding(AndroidUtilities.m34dp(21.0f), 0, AndroidUtilities.m34dp(21.0f), 0);
        ...
        if (ChatObject.canManageCalls(chat)) {
            this.noRtmpStreamTextView.setText(AndroidUtilities.replaceTags(LocaleController.getString((int) C0952R.string.NoRtmpStreamFromAppOwner)));
        } else {
            this.noRtmpStreamTextView.setText(AndroidUtilities.replaceTags(LocaleController.formatString("NoRtmpStreamFromAppViewer", C0952R.string.NoRtmpStreamFromAppViewer, chat.title)));
        }
        ...
        if (this.attached) {
            ...
            if (this.showingAsScrimView || this.animateToScrimView) {
                ...
                if (!GroupCallActivity.isLandscapeMode && !GroupCallActivity.isTabletMode) {
                    ...
                    y -= (AndroidUtilities.m34dp(90.0f) * groupCallRenderersContainer.progressToFullscreenMode) * (1.0f - groupCallRenderersContainer.progressToHideUi);
                }
            ...
            this.micIconView.setTranslationY(y - AndroidUtilities.m34dp(2.0f));
            if (this.screencastIcon.getVisibility() == 0) {
                this.screencastIcon.setTranslationX((this.textureView.getMeasuredWidth() - (this.textureView.currentClipHorizontal * 2.0f)) - AndroidUtilities.m34dp(32.0f));
                this.screencastIcon.setTranslationY(y - AndroidUtilities.m34dp(2.0f));
            ...
            this.infoContainer.setTranslationX(this.drawFirst ? 0.0f : AndroidUtilities.m34dp(6.0f) * this.parentContainer.progressToFullscreenMode);
        }
        super.dispatchDraw(canvas);
        if (this.attached) {
            ...
            if (f5 > 0.0f) {
                ...
                float max = (Math.max(0.0f, 1.0f - (Math.abs(this.swipeToBackDy) / AndroidUtilities.m34dp(300.0f))) * 0.1f) + 0.9f;
                canvas.save();
                RectF rectF = AndroidUtilities.rectTmp;
        ...
        if (this.thumb == null) {
            ...
            if (this.thumb == null) {
                ...
                if (videoParticipant2.participant.self && videoParticipant2.presentation) {
                    ...
                    int colorForId = user != null ? AvatarDrawable.getColorForId(user.f985id) : ColorUtils.blendARGB(-16777216, -1, 0.2f);
                    ...
                    int colorForId2 = chat != null ? AvatarDrawable.getColorForId(chat.f854id) : ColorUtils.blendARGB(-16777216, -1, 0.2f);
    ...
    public void updateSize(int i) {
        int measuredWidth = this.parentContainer.getMeasuredWidth() - AndroidUtilities.m34dp(6.0f);
    ...
    public class NoVideoStubLayout extends View {
        ...
        public NoVideoStubLayout(Context context) {
            super(context);
            this.tinyWaveDrawable.minRadius = AndroidUtilities.m34dp(76.0f);
            this.tinyWaveDrawable.maxRadius = AndroidUtilities.m34dp(92.0f);
            this.tinyWaveDrawable.generateBlob();
            this.bigWaveDrawable.minRadius = AndroidUtilities.m34dp(80.0f);
            this.bigWaveDrawable.maxRadius = AndroidUtilities.m34dp(95.0f);
        ...
        protected void onMeasure(int i, int i2) {
            ...
            float dp = AndroidUtilities.m34dp(157.0f);
            this.f1107cx = getMeasuredWidth() >> 1;
            this.f1108cy = (getMeasuredHeight() >> 1) + (GroupCallActivity.isLandscapeMode ? 0.0f : (-getMeasuredHeight()) * 0.12f);
            float f = dp / 2.0f;
            this.avatarImageReceiver.setRoundRadius((int) f);
            this.avatarImageReceiver.setImageCoords(this.f1107cx - f, this.f1108cy - f, dp, dp);
        }
        ...
        protected void onDraw(Canvas canvas) {
            ...
            canvas.save();
            canvas.scale(f10, f10, this.f1107cx, this.f1108cy);
            GroupCallActivity.WeavingState weavingState3 = this.currentState;
            if (weavingState3 != null) {
                weavingState3.update((int) (this.f1108cy - AndroidUtilities.m34dp(100.0f)), (int) (this.f1107cx - AndroidUtilities.m34dp(100.0f)), AndroidUtilities.m34dp(200.0f), 16L, this.amplitude);
            }
            ...
            for (int i = 0; i < 2; i++) {
                ...
                this.bigWaveDrawable.draw(this.f1107cx, this.f1108cy, canvas, this.paint);
                this.tinyWaveDrawable.draw(this.f1107cx, this.f1108cy, canvas, this.paint);
            }
            canvas.restore();
            float f11 = (this.amplitude * 0.2f) + 1.0f;
            canvas.save();
            canvas.scale(f11, f11, this.f1107cx, this.f1108cy);
