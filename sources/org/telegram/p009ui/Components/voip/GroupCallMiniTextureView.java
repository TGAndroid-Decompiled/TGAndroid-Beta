...
public class GroupCallMiniTextureView extends FrameLayout implements GroupCallStatusIcon.Callback {
    ...
    public class NoVideoStubLayout extends View {
        ...
        protected void onMeasure(int i, int i2) {
            ...
            this.f1103cx = getMeasuredWidth() >> 1;
            this.f1104cy = (getMeasuredHeight() >> 1) + (GroupCallActivity.isLandscapeMode ? 0.0f : (-getMeasuredHeight()) * 0.12f);
            float f = dp / 2.0f;
            this.avatarImageReceiver.setRoundRadius((int) f);
            this.avatarImageReceiver.setImageCoords(this.f1103cx - f, this.f1104cy - f, dp, dp);
        }
        ...
        protected void onDraw(Canvas canvas) {
            ...
            canvas.save();
            canvas.scale(f10, f10, this.f1103cx, this.f1104cy);
            GroupCallActivity.WeavingState weavingState3 = this.currentState;
            if (weavingState3 != null) {
                weavingState3.update((int) (this.f1104cy - AndroidUtilities.m34dp(100.0f)), (int) (this.f1103cx - AndroidUtilities.m34dp(100.0f)), AndroidUtilities.m34dp(200.0f), 16L, this.amplitude);
            }
            ...
            for (int i = 0; i < 2; i++) {
                ...
                this.bigWaveDrawable.draw(this.f1103cx, this.f1104cy, canvas, this.paint);
                this.tinyWaveDrawable.draw(this.f1103cx, this.f1104cy, canvas, this.paint);
            }
            canvas.restore();
            float f11 = (this.amplitude * 0.2f) + 1.0f;
            canvas.save();
            canvas.scale(f11, f11, this.f1103cx, this.f1104cy);
