...
public class VoIPPiPView implements VoIPService.StateListener, NotificationCenter.NotificationCenterDelegate {
    ...
    private void setRelativePosition(float f, float f2) {
        ...
        float dp3 = AndroidUtilities.m34dp(60.0f);
    ...
    public VoIPPiPView(final Context context, int i, int i2, boolean z) {
        ...
        final Drawable drawable = ContextCompat.getDrawable(context, C0952R.C0953drawable.calls_pip_outershadow);
        FrameLayout frameLayout = new FrameLayout(context) {
            ...
            protected void onDraw(Canvas canvas) {
                ...
                drawable.setBounds(VoIPPiPView.this.floatingView.getLeft() - AndroidUtilities.m34dp(2.0f), VoIPPiPView.this.floatingView.getTop() - AndroidUtilities.m34dp(2.0f), VoIPPiPView.this.floatingView.getRight() + AndroidUtilities.m34dp(2.0f), VoIPPiPView.this.floatingView.getBottom() + AndroidUtilities.m34dp(2.0f));
        ...
        if (z) {
            ...
            this.floatingView.addView(this.topShadow, -1, AndroidUtilities.m34dp(60.0f));
            ImageView imageView = new ImageView(context);
            this.closeIcon = imageView;
            imageView.setImageResource(C0952R.C0953drawable.pip_close);
            this.closeIcon.setPadding(AndroidUtilities.m34dp(8.0f), AndroidUtilities.m34dp(8.0f), AndroidUtilities.m34dp(8.0f), AndroidUtilities.m34dp(8.0f));
            this.closeIcon.setContentDescription(LocaleController.getString("Close", C0952R.string.Close));
            ...
            imageView2.setImageResource(C0952R.C0953drawable.pip_enlarge);
            this.enlargeIcon.setPadding(AndroidUtilities.m34dp(8.0f), AndroidUtilities.m34dp(8.0f), AndroidUtilities.m34dp(8.0f), AndroidUtilities.m34dp(8.0f));
            this.enlargeIcon.setContentDescription(LocaleController.getString("Open", C0952R.string.Open));
    ...
    public class FloatingView extends FrameLayout {
            ...
            if (Build.VERSION.SDK_INT >= 21) {
                setOutlineProvider(new ViewOutlineProvider(this, VoIPPiPView.this) {
                    ...
                    public void getOutline(View view, Outline outline) {
                        outline.setRoundRect(0, 0, view.getMeasuredWidth(), view.getMeasuredHeight(), (1.0f / view.getScaleX()) * AndroidUtilities.m34dp(4.0f));
                    }
                });
        ...
        protected void onMeasure(int i, int i2) {
            ...
            this.topPadding = AndroidUtilities.m34dp(60.0f);
            this.bottomPadding = AndroidUtilities.m34dp(16.0f);
        }
        ...
        protected void dispatchDraw(Canvas canvas) {
            ...
            VoIPPiPView.this.currentUserTextureView.setTranslationX((-AndroidUtilities.m34dp(4.0f)) * (1.0f / getScaleX()) * VoIPPiPView.this.progressToCameraMini);
            VoIPPiPView.this.currentUserTextureView.setTranslationY((-AndroidUtilities.m34dp(4.0f)) * (1.0f / getScaleY()) * VoIPPiPView.this.progressToCameraMini);
            VoIPPiPView.this.currentUserTextureView.setRoundCorners(AndroidUtilities.m34dp(8.0f) * (1.0f / getScaleY()) * VoIPPiPView.this.progressToCameraMini);
        ...
        public boolean onTouchEvent(android.view.MotionEvent r15) {
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p009ui.Components.voip.VoIPPiPView.FloatingView.onTouchEvent(android.view.MotionEvent):boolean");
        }
        ...
        public void expand(boolean z) {
            ...
            if (VoIPPiPView.instance != null && !VoIPPiPView.this.expandedAnimationInProgress && VoIPPiPView.instance.expanded != z) {
                ...
                if (z) {
                    ...
                    ofFloat.addListener(new C26733(z));
                    ofFloat.start();
        ...
        public class C26733 extends AnimatorListenerAdapter {
            ...
            public void onAnimationEnd(Animator animator) {
                if (VoIPPiPView.expandedInstance != null) {
                    ...
                    AndroidUtilities.runOnUIThread(new Runnable() {
                        @Override
                        public final void run() {
                            VoIPPiPView.FloatingView.C26733.this.lambda$onAnimationEnd$0(z);
                        }
                    }, 64L);
                }
            }
