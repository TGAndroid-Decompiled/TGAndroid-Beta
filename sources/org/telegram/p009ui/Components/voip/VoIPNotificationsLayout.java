...
public class VoIPNotificationsLayout extends LinearLayout {
    ...
    public int getChildsHight() {
        ...
        return (childCount > 0 ? AndroidUtilities.m34dp(16.0f) : 0) + (childCount * AndroidUtilities.m34dp(32.0f));
    }
    ...
    public static class NotificationView extends FrameLayout {
        ...
        public NotificationView(Context context) {
            ...
            setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m34dp(16.0f), ColorUtils.setAlphaComponent(-16777216, 102)));
