...
public class VoIPTimerView extends View {
    ...
    public VoIPTimerView(Context context) {
        ...
        this.textPaint.setShadowLayer(AndroidUtilities.m34dp(3.0f), 0.0f, AndroidUtilities.m34dp(0.6666667f), 1275068416);
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (staticLayout != null) {
            ...
            setMeasuredDimension(View.MeasureSpec.getSize(i), AndroidUtilities.m34dp(15.0f));
        }
    }
    ...
    protected void onDraw(Canvas canvas) {
        StaticLayout staticLayout = this.timerLayout;
        int i = 0;
        int width = staticLayout == null ? 0 : staticLayout.getWidth() + AndroidUtilities.m34dp(21.0f);
        canvas.save();
        canvas.translate((getMeasuredWidth() - width) / 2.0f, 0.0f);
        canvas.save();
        canvas.translate(0.0f, (getMeasuredHeight() - AndroidUtilities.m34dp(11.0f)) / 2.0f);
        while (i < 4) {
            int i2 = i + 1;
            Paint paint = i2 > this.signalBarCount ? this.inactivePaint : this.activePaint;
            float f = i;
            this.rectF.set(AndroidUtilities.dpf2(4.16f) * f, AndroidUtilities.dpf2(2.75f) * (3 - i), (AndroidUtilities.dpf2(4.16f) * f) + AndroidUtilities.dpf2(2.75f), AndroidUtilities.m34dp(11.0f));
            canvas.drawRoundRect(this.rectF, AndroidUtilities.dpf2(0.7f), AndroidUtilities.dpf2(0.7f), paint);
            i = i2;
        }
        canvas.restore();
        if (staticLayout != null) {
            canvas.translate(AndroidUtilities.m34dp(21.0f), 0.0f);
