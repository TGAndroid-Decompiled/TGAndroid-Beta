...
public class VoIPFloatingLayout extends FrameLayout {
            ...
            setOutlineProvider(new ViewOutlineProvider() {
                ...
                public void getOutline(View view, Outline outline) {
                    if (VoIPFloatingLayout.this.overrideCornerRadius >= 0.0f) {
                        ...
                        outline.setRoundRect(0, 0, view.getMeasuredWidth(), view.getMeasuredHeight(), VoIPFloatingLayout.this.floatingMode ? AndroidUtilities.m34dp(4.0f) : 0.0f);
                    }
                }
            });
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (!(getMeasuredHeight() == this.lastH || getMeasuredWidth() == this.lastW)) {
            ...
            this.path.addRoundRect(this.rectF, AndroidUtilities.m34dp(4.0f), AndroidUtilities.m34dp(4.0f), Path.Direction.CW);
    ...
    private void updatePadding() {
        float f = 16.0f;
        this.leftPadding = AndroidUtilities.m34dp(16.0f);
        this.rightPadding = AndroidUtilities.m34dp(16.0f);
        this.topPadding = this.uiVisible ? AndroidUtilities.m34dp(60.0f) : AndroidUtilities.m34dp(16.0f);
        if (this.uiVisible) {
            f = 100.0f;
        }
        this.bottomPadding = AndroidUtilities.m34dp(f) + this.bottomOffset;
    }
    ...
    public boolean onTouchEvent(android.view.MotionEvent r10) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p009ui.Components.voip.VoIPFloatingLayout.onTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        int measuredHeight = getMeasuredHeight() - ((int) ((AndroidUtilities.m34dp(18.0f) * 1.0f) / getScaleY()));
        canvas.save();
        ...
        canvas.drawCircle(f, f2, AndroidUtilities.m34dp(14.0f), this.mutedPaint);
