...
public class VoIPStatusTextView extends FrameLayout {
    ...
    public VoIPStatusTextView(Context context) {
        ...
        for (int i = 0; i < 2; i++) {
            ...
            this.textView[i].setShadowLayer(AndroidUtilities.m34dp(3.0f), 0.0f, AndroidUtilities.m34dp(0.6666667f), 1275068416);
        ...
        this.reconnectTextView.setShadowLayer(AndroidUtilities.m34dp(3.0f), 0.0f, AndroidUtilities.m34dp(0.6666667f), 1275068416);
        ...
        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(LocaleController.getString("VoipReconnecting", C0952R.string.VoipReconnecting));
    ...
    public void replaceViews(final View view, final View view2, Runnable runnable) {
        ...
        view2.setTranslationY(AndroidUtilities.m34dp(15.0f));
        view2.setAlpha(0.0f);
        ...
        this.animator.addListener(new C26801(view, view2, runnable));
    ...
    public static void lambda$replaceViews$1(View view, View view2, ValueAnimator valueAnimator) {
        ...
        view.setTranslationY(AndroidUtilities.m34dp(10.0f) * f2);
        view.setAlpha(floatValue);
        view.setScaleX(f);
        view.setScaleY(f);
        view2.setTranslationY((-AndroidUtilities.m34dp(10.0f)) * floatValue);
        view2.setAlpha(f2);
        view2.setScaleX(f3);
        view2.setScaleY(f3);
    }

    public class C26801 extends AnimatorListenerAdapter {
        final View val$in;
        final Runnable val$onEnd;
        final View val$out;

        C26801(View view, View view2, Runnable runnable) {
            this.val$out = view;
            this.val$in = view2;
            ...
            if (charSequence != null) {
                if (charSequence.equals("timer")) {
                    ...
                    voIPStatusTextView3.replaceViews(textViewArr[0], textViewArr[1], new Runnable() {
                        @Override
                        public final void run() {
                            VoIPStatusTextView.C26801.this.lambda$onAnimationEnd$0();
                        }
                    });
                }
