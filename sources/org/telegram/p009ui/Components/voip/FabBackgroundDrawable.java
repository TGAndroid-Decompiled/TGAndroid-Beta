...
public class FabBackgroundDrawable extends Drawable {
    ...
    public void draw(Canvas canvas) {
        ...
        float f = min / 2;
        canvas.drawCircle(f, f, i - AndroidUtilities.m34dp(4.0f), this.bgPaint);
    }
    ...
    protected void onBoundsChange(Rect rect) {
        ...
        paint.setShadowLayer(AndroidUtilities.m34dp(3.33333f), 0.0f, AndroidUtilities.m34dp(0.666f), -1);
        float f = min / 2;
        canvas.drawCircle(f, f, i - AndroidUtilities.m34dp(4.0f), paint);
    }
