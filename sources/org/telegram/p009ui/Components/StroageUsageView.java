...
public class StroageUsageView extends FrameLayout {
    ...
    public StroageUsageView(Context context) {
        ...
        this.paintFill.setStrokeWidth(AndroidUtilities.m34dp(6.0f));
        this.paintCalculcating.setStrokeWidth(AndroidUtilities.m34dp(6.0f));
        this.paintProgress.setStrokeWidth(AndroidUtilities.m34dp(6.0f));
        this.paintProgress2.setStrokeWidth(AndroidUtilities.m34dp(6.0f));
                ...
                for (int i6 = 0; i6 < childCount; i6++) {
                    if (getChildAt(i6).getVisibility() != 8) {
                        if (getChildAt(i6).getMeasuredWidth() + i4 > View.MeasureSpec.getSize(i)) {
                            i5 += getChildAt(i6).getMeasuredHeight() + AndroidUtilities.m34dp(8.0f);
                            i4 = 0;
                        }
                        i4 += getChildAt(i6).getMeasuredWidth() + AndroidUtilities.m34dp(16.0f);
                ...
                for (int i7 = 0; i7 < childCount; i7++) {
                    if (getChildAt(i7).getVisibility() != 8) {
                        if (getChildAt(i7).getMeasuredWidth() + i5 > getMeasuredWidth()) {
                            i6 += getChildAt(i7).getMeasuredHeight() + AndroidUtilities.m34dp(8.0f);
                            i5 = 0;
                        }
                        getChildAt(i7).layout(i5, i6, getChildAt(i7).getMeasuredWidth() + i5, getChildAt(i7).getMeasuredHeight() + i6);
                        i5 += getChildAt(i7).getMeasuredWidth() + AndroidUtilities.m34dp(16.0f);
                    }
                }
            }
        };
        ...
        String string = LocaleController.getString("CalculatingSize", C0890R.string.CalculatingSize);
        ...
        textView2.setCompoundDrawablePadding(AndroidUtilities.m34dp(6.0f));
        ...
        textView3.setCompoundDrawablePadding(AndroidUtilities.m34dp(6.0f));
        ...
        textView4.setCompoundDrawablePadding(AndroidUtilities.m34dp(6.0f));
        this.freeSizeTextView.setTextColor(Theme.getColor("windowBackgroundWhiteGrayText"));
        TextView textView5 = new TextView(context);
        this.totlaSizeTextView = textView5;
        textView5.setCompoundDrawablePadding(AndroidUtilities.m34dp(6.0f));
        ...
        this.telegramCacheTextView.setCompoundDrawablesWithIntrinsicBounds(Theme.createCircleDrawable(AndroidUtilities.m34dp(10.0f), this.lastProgressColor), (Drawable) null, (Drawable) null, (Drawable) null);
        this.telegramCacheTextView.setCompoundDrawablePadding(AndroidUtilities.m34dp(6.0f));
        this.freeSizeTextView.setCompoundDrawablesWithIntrinsicBounds(Theme.createCircleDrawable(AndroidUtilities.m34dp(10.0f), ColorUtils.setAlphaComponent(this.lastProgressColor, 64)), (Drawable) null, (Drawable) null, (Drawable) null);
        this.freeSizeTextView.setCompoundDrawablePadding(AndroidUtilities.m34dp(6.0f));
        this.totlaSizeTextView.setCompoundDrawablesWithIntrinsicBounds(Theme.createCircleDrawable(AndroidUtilities.m34dp(10.0f), ColorUtils.setAlphaComponent(this.lastProgressColor, 127)), (Drawable) null, (Drawable) null, (Drawable) null);
        this.totlaSizeTextView.setCompoundDrawablePadding(AndroidUtilities.m34dp(6.0f));
        this.telegramDatabaseTextView.setCompoundDrawablesWithIntrinsicBounds(Theme.createCircleDrawable(AndroidUtilities.m34dp(10.0f), this.lastProgressColor), (Drawable) null, (Drawable) null, (Drawable) null);
        this.telegramDatabaseTextView.setCompoundDrawablePadding(AndroidUtilities.m34dp(6.0f));
    ...
    public void setStorageUsage(boolean z, long j, long j2, long j3, long j4) {
        this.calculating = z;
        this.freeSizeTextView.setText(LocaleController.formatString("TotalDeviceFreeSize", C0890R.string.TotalDeviceFreeSize, AndroidUtilities.formatFileSize(j3)));
        long j5 = j4 - j3;
        this.totlaSizeTextView.setText(LocaleController.formatString("TotalDeviceSize", C0890R.string.TotalDeviceSize, AndroidUtilities.formatFileSize(j5)));
        if (z) {
            ...
            if (j2 > 0) {
                ...
                this.telegramDatabaseTextView.setVisibility(8);
                this.textSettingsCell.setText(LocaleController.getString("ClearTelegramCache", C0890R.string.ClearTelegramCache), false);
                this.telegramCacheTextView.setText(LocaleController.formatString("TelegramCacheSize", C0890R.string.TelegramCacheSize, AndroidUtilities.formatFileSize(j2 + j)));
            } else {
                this.telegramCacheTextView.setVisibility(8);
                this.telegramDatabaseTextView.setVisibility(0);
                this.telegramDatabaseTextView.setText(LocaleController.formatString("LocalDatabaseSize", C0890R.string.LocalDatabaseSize, AndroidUtilities.formatFileSize(j)));
                this.divider.setVisibility(8);
                this.textSettingsCell.setVisibility(8);
            }
    ...
    public class ProgressView extends View {
        ...
        @Override
        protected void onMeasure(int i, int i2) {
            super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m34dp(40.0f), 1073741824));
        }
        ...
        protected void onDraw(Canvas canvas) {
            ...
            canvas.drawLine(AndroidUtilities.m34dp(24.0f), AndroidUtilities.m34dp(20.0f), getMeasuredWidth() - AndroidUtilities.m34dp(24.0f), AndroidUtilities.m34dp(20.0f), StroageUsageView.this.paintFill);
            if (StroageUsageView.this.calculating || StroageUsageView.this.calculatingProgress != 0.0f) {
                ...
                rectF.set(AndroidUtilities.m34dp(24.0f), AndroidUtilities.m34dp(17.0f), getMeasuredWidth() - AndroidUtilities.m34dp(24.0f), AndroidUtilities.m34dp(23.0f));
                StroageUsageView.this.cellFlickerDrawable.setParentWidth(getMeasuredWidth());
                StroageUsageView.this.cellFlickerDrawable.draw(canvas, rectF, AndroidUtilities.m34dp(3.0f));
            }
            int dp = AndroidUtilities.m34dp(24.0f);
            if (!StroageUsageView.this.calculating) {
                int measuredWidth = (int) ((getMeasuredWidth() - (AndroidUtilities.m34dp(24.0f) * 2)) * StroageUsageView.this.progress2);
                int dp2 = AndroidUtilities.m34dp(24.0f) + measuredWidth;
                canvas.drawLine(dp, AndroidUtilities.m34dp(20.0f), AndroidUtilities.m34dp(24.0f) + measuredWidth, AndroidUtilities.m34dp(20.0f), StroageUsageView.this.paintProgress2);
                canvas.drawRect(dp2, AndroidUtilities.m34dp(20.0f) - AndroidUtilities.m34dp(3.0f), dp2 + AndroidUtilities.m34dp(3.0f), AndroidUtilities.m34dp(20.0f) + AndroidUtilities.m34dp(3.0f), StroageUsageView.this.bgPaint);
            }
            if (!StroageUsageView.this.calculating) {
                int measuredWidth2 = (int) ((getMeasuredWidth() - (AndroidUtilities.m34dp(24.0f) * 2)) * StroageUsageView.this.progress);
                if (measuredWidth2 < AndroidUtilities.m34dp(1.0f)) {
                    measuredWidth2 = AndroidUtilities.m34dp(1.0f);
                }
                int dp3 = AndroidUtilities.m34dp(24.0f) + measuredWidth2;
                canvas.drawLine(dp, AndroidUtilities.m34dp(20.0f), AndroidUtilities.m34dp(24.0f) + measuredWidth2, AndroidUtilities.m34dp(20.0f), StroageUsageView.this.paintProgress);
                canvas.drawRect(dp3, AndroidUtilities.m34dp(20.0f) - AndroidUtilities.m34dp(3.0f), dp3 + AndroidUtilities.m34dp(3.0f), AndroidUtilities.m34dp(20.0f) + AndroidUtilities.m34dp(3.0f), StroageUsageView.this.bgPaint);
            }
        }
    }
