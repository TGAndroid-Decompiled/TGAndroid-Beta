...
public class WallpaperParallaxEffect implements SensorEventListener {
    ...
    public WallpaperParallaxEffect(Context context) {
        this.f1159wm = (WindowManager) context.getSystemService("window");
    ...
    public float getScale(int i, int i2) {
        float f = i;
        float m36dp = AndroidUtilities.m36dp(16.0f) * 2;
        float f2 = (f + m36dp) / f;
        float f3 = i2;
        return Math.max(f2, (m36dp + f3) / f3);
    }
