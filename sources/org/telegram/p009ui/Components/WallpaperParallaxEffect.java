...
public class WallpaperParallaxEffect implements SensorEventListener {
    ...
    public WallpaperParallaxEffect(Context context) {
        this.f1143wm = (WindowManager) context.getSystemService("window");
    ...
    public float getScale(int i, int i2) {
        float f = i;
        float m35dp = AndroidUtilities.m35dp(16.0f) * 2;
        float f2 = (f + m35dp) / f;
        float f3 = i2;
        return Math.max(f2, (m35dp + f3) / f3);
    }
