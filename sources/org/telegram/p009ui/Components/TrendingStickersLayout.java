...
public class TrendingStickersLayout extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public TrendingStickersLayout(Context context, final Delegate delegate, TLRPC$StickerSetCovered[] tLRPC$StickerSetCoveredArr, LongSparseArray<TLRPC$StickerSetCovered> longSparseArray, LongSparseArray<TLRPC$StickerSetCovered> longSparseArray2, TLRPC$StickerSetCovered tLRPC$StickerSetCovered, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.searchAdapter = new StickersSearchAdapter(context, new StickersSearchAdapter.Delegate() {
            ...
            public void setAdapterVisible(boolean z) {
                ...
                if (z2 && TrendingStickersLayout.this.listView.getAdapter().getItemCount() > 0) {
                    TrendingStickersLayout.this.layoutManager.scrollToPositionWithOffset(0, (-TrendingStickersLayout.this.listView.getPaddingTop()) + AndroidUtilities.m34dp(58.0f) + TrendingStickersLayout.this.topOffset, false);
                }
            }
        ...
        searchField.setHint(LocaleController.getString("SearchTrendingStickersHint", C0952R.string.SearchTrendingStickersHint));
        ...
        RecyclerListView recyclerListView = new RecyclerListView(context) {
            ...
            protected boolean allowSelectChildAtPosition(float f, float f2) {
                return f2 >= ((float) (TrendingStickersLayout.this.topOffset + AndroidUtilities.m34dp(58.0f)));
            }
        };
        this.listView = recyclerListView;
        final RecyclerListView.OnItemClickListener trendingStickersLayout$$ExternalSyntheticLambda1 = new RecyclerListView.OnItemClickListener() {
            @Override
        ...
        recyclerListView.setOnTouchListener(new View.OnTouchListener() {
            ...
            public final boolean onTouch(View view, MotionEvent motionEvent) {
                ...
                lambda$new$1 = TrendingStickersLayout.this.lambda$new$1(delegate, trendingStickersLayout$$ExternalSyntheticLambda1, view, motionEvent);
                return lambda$new$1;
            }
        });
        ...
        FillLastGridLayoutManager fillLastGridLayoutManager = new FillLastGridLayoutManager(context, 5, AndroidUtilities.m34dp(58.0f), recyclerListView) {
            @Override
            ...
            public int scrollVerticallyBy(int i2, RecyclerView.Recycler recycler, RecyclerView.State state) {
                ...
                if (trendingStickersLayout.gluedToTop) {
                    ...
                    if (i3 == 0 && (findViewByPosition = TrendingStickersLayout.this.layoutManager.findViewByPosition(i3)) != null && findViewByPosition.getTop() - i2 > AndroidUtilities.m34dp(58.0f)) {
                        i2 = findViewByPosition.getTop() - AndroidUtilities.m34dp(58.0f);
                    }
                }
                return super.scrollVerticallyBy(i2, recycler, state);
            }
        ...
        recyclerListView.setOnItemClickListener(trendingStickersLayout$$ExternalSyntheticLambda1);
        ...
        layoutParams.topMargin = AndroidUtilities.m34dp(58.0f);
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (!this.wasLayout) {
            ...
            if (this.scrollToSet != null && (num = (Integer) this.adapter.setsToPosition.get(this.scrollToSet)) != null) {
                this.layoutManager.scrollToPositionWithOffset(num.intValue(), (-this.listView.getPaddingTop()) + AndroidUtilities.m34dp(58.0f));
            }
        }
    }
    ...
    public void showStickerSet(TLRPC$StickerSet tLRPC$StickerSet, TLRPC$InputStickerSet tLRPC$InputStickerSet) {
        if (tLRPC$StickerSet != null) {
            ...
            tLRPC$InputStickerSet.f876id = tLRPC$StickerSet.f886id;
        }
    ...
    public void setContentViewPaddingTop(int i) {
        int dp = i + AndroidUtilities.m34dp(58.0f);
    ...
    public boolean update() {
        ...
        int top = childAt.getTop() - AndroidUtilities.m34dp(58.0f);
        ...
        this.topOffset = i2;
        this.listView.setTopGlowOffset(i2 + AndroidUtilities.m34dp(58.0f));
        this.searchLayout.setTranslationY(this.topOffset);
        this.shadowView.setTranslationY(this.topOffset);
        return true;
    }
    ...
    public class TrendingStickersAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public void lambda$onCreateViewHolder$0(View view) {
            ...
            if (TrendingStickersLayout.this.installingStickerSets.indexOfKey(stickerSet.set.f886id) < 0 && TrendingStickersLayout.this.removingStickerSets.indexOfKey(stickerSet.set.f886id) < 0) {
                if (featuredStickerSetInfoCell.isInstalled()) {
                    TrendingStickersLayout.this.removingStickerSets.put(stickerSet.set.f886id, stickerSet);
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            StickerEmojiCell stickerEmojiCell2 = new StickerEmojiCell(this, this.context, false) {
                @Override
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (itemViewType == 0) {
                ...
                if (itemViewType != 2) {
                    if (itemViewType == 4) {
                        ((GraySectionCell) viewHolder.itemView).setText(LocaleController.getString("OtherStickers", C0952R.string.OtherStickers));
                        return;
        ...
        private void bindStickerSetCell(android.view.View r12, int r13, boolean r14) {
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p009ui.Components.TrendingStickersLayout.TrendingStickersAdapter.bindStickerSetCell(android.view.View, int, boolean):void");
        }
        ...
        public void installStickerSet(TLRPC$StickerSetCovered tLRPC$StickerSetCovered, View view) {
            ...
            while (true) {
                ...
                if (TrendingStickersLayout.this.primaryInstallingStickerSets[i] != null) {
                    TLRPC$TL_messages_stickerSet stickerSetById = MediaDataController.getInstance(TrendingStickersLayout.this.currentAccount).getStickerSetById(TrendingStickersLayout.this.primaryInstallingStickerSets[i].set.f886id);
                    if (stickerSetById != null && !stickerSetById.set.archived) {
                        TrendingStickersLayout.this.primaryInstallingStickerSets[i] = null;
                        break;
                    } else if (TrendingStickersLayout.this.primaryInstallingStickerSets[i].set.f886id == tLRPC$StickerSetCovered.set.f886id) {
                        return;
                    }
                }
                i++;
            ...
            TrendingStickersLayout.this.installingStickerSets.put(tLRPC$StickerSetCovered.set.f886id, tLRPC$StickerSetCovered);
            if (view != null) {
            ...
            for (int i3 = 0; i3 < size; i3++) {
                ...
                if (tLRPC$StickerSetCovered2 != null && tLRPC$StickerSetCovered2.set.f886id == tLRPC$StickerSetCovered.set.f886id) {
        ...
        public void refreshStickerSets() {
            ...
            if (measuredWidth != 0) {
                this.stickersPerRow = Math.max(5, measuredWidth / AndroidUtilities.m34dp(72.0f));
        ...
        public void lambda$loadMoreStickerSets$3(final TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
        ...
        public void lambda$loadMoreStickerSets$2(TLRPC$TL_error tLRPC$TL_error, TLObject tLObject) {
            int i;
            int i2;
