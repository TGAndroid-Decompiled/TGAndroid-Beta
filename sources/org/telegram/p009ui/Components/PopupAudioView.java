...
public class PopupAudioView extends BaseCell implements SeekBar.SeekBarDelegate, DownloadController.FileDownloadProgressListener {
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        if (this.currentMessageObject != null) {
            this.seekBarX = AndroidUtilities.m34dp(54.0f);
            this.buttonX = AndroidUtilities.m34dp(10.0f);
            this.timeX = (getMeasuredWidth() - this.timeWidth) - AndroidUtilities.m34dp(16.0f);
            this.seekBar.setSize((getMeasuredWidth() - AndroidUtilities.m34dp(70.0f)) - this.timeWidth, AndroidUtilities.m34dp(30.0f));
            this.progressView.width = (getMeasuredWidth() - AndroidUtilities.m34dp(94.0f)) - this.timeWidth;
            this.progressView.height = AndroidUtilities.m34dp(30.0f);
            this.seekBarY = AndroidUtilities.m34dp(13.0f);
            this.buttonY = AndroidUtilities.m34dp(10.0f);
            updateProgress();
            if (z || !this.wasLayout) {
                this.wasLayout = true;
            }
        ...
        if (this.currentMessageObject != null) {
            ...
            if (this.currentMessageObject != null) {
                ...
                if (i4 == 0 || i4 == 1) {
                    ...
                    canvas.translate(this.seekBarX + AndroidUtilities.m34dp(12.0f), this.seekBarY);
                ...
                canvas.save();
                canvas.translate(this.timeX, AndroidUtilities.m34dp(18.0f));
