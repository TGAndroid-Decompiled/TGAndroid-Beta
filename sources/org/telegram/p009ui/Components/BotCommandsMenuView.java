...
public class BotCommandsMenuView extends View {
    ...
    public BotCommandsMenuView(Context context) {
        ...
        Drawable createSimpleSelectorRoundRectDrawable = Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m34dp(16.0f), 0, Theme.getColor("featuredStickers_addButtonPressed"));
    ...
    protected void onMeasure(int i, int i2) {
        ...
        onTranslationChanged((this.menuTextLayout.getWidth() + AndroidUtilities.m34dp(4.0f)) * this.expandProgress);
        int dp = AndroidUtilities.m34dp(40.0f);
        if (this.expanded) {
            dp += this.menuTextLayout.getWidth() + AndroidUtilities.m34dp(4.0f);
        }
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(dp, 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m34dp(32.0f), 1073741824));
    }
    ...
    public static class BotCommandView extends LinearLayout {
        ...
        public BotCommandView(Context context) {
            ...
            addView(this.description, LayoutHelper.createLinear(-1, -2, 1.0f, 16, 0, 0, AndroidUtilities.m34dp(8.0f), 0));
        ...
        @Override
        protected void onMeasure(int i, int i2) {
            super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m34dp(36.0f), 1073741824));
        }
