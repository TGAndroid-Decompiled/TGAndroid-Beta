...
public class CheckBoxSquare extends View {
    ...
    public CheckBoxSquare(Context context, boolean z, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.drawBitmap = Bitmap.createBitmap(AndroidUtilities.m34dp(18.0f), AndroidUtilities.m34dp(18.0f), Bitmap.Config.ARGB_4444);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (getVisibility() == 0) {
            ...
            float dp = AndroidUtilities.m34dp(1.0f) * f2;
            this.rectF.set(dp, dp, AndroidUtilities.m34dp(18.0f) - dp, AndroidUtilities.m34dp(18.0f) - dp);
            this.drawBitmap.eraseColor(0);
            this.drawCanvas.drawRoundRect(this.rectF, AndroidUtilities.m34dp(2.0f), AndroidUtilities.m34dp(2.0f), Theme.checkboxSquare_backgroundPaint);
            if (f != 1.0f) {
                float min = Math.min(AndroidUtilities.m34dp(7.0f), (AndroidUtilities.m34dp(7.0f) * f) + dp);
                this.rectF.set(AndroidUtilities.m34dp(2.0f) + min, AndroidUtilities.m34dp(2.0f) + min, AndroidUtilities.m34dp(16.0f) - min, AndroidUtilities.m34dp(16.0f) - min);
            ...
            if (this.progress > 0.5f) {
                ...
                float f4 = 1.0f - f2;
                this.drawCanvas.drawLine(AndroidUtilities.m34dp(7.0f), (int) AndroidUtilities.dpf2(13.0f), (int) (AndroidUtilities.m34dp(7.0f) - (AndroidUtilities.m34dp(3.0f) * f4)), (int) (AndroidUtilities.dpf2(13.0f) - (AndroidUtilities.m34dp(3.0f) * f4)), Theme.checkboxSquare_checkPaint);
                this.drawCanvas.drawLine((int) AndroidUtilities.dpf2(7.0f), (int) AndroidUtilities.dpf2(13.0f), (int) (AndroidUtilities.dpf2(7.0f) + (AndroidUtilities.m34dp(7.0f) * f4)), (int) (AndroidUtilities.dpf2(13.0f) - (AndroidUtilities.m34dp(7.0f) * f4)), Theme.checkboxSquare_checkPaint);
            }
