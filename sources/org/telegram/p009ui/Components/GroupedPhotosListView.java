...
public class GroupedPhotosListView extends View implements GestureDetector.OnGestureListener {
    ...
    private int itemWidth = AndroidUtilities.m34dp(42.0f);
    private int itemHeight = AndroidUtilities.m34dp(56.0f);
    private int itemSpacing = AndroidUtilities.m34dp(1.0f);
