...
public class AvatarDrawable extends Drawable {
    ...
    public AvatarDrawable(Theme.ResourcesProvider resourcesProvider) {
        ...
        this.namePaint.setTextSize(AndroidUtilities.m34dp(18.0f));
    }
    ...
    public void setInfo(long j, String str, String str2, String str3) {
        ...
        if (this.stringBuilder.length() > 0) {
            try {
                StaticLayout staticLayout = new StaticLayout(this.stringBuilder.toString().toUpperCase(), this.namePaint, AndroidUtilities.m34dp(100.0f), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
            ...
            if (i == 2) {
                ...
                if (this.drawDeleted) {
                    ...
                    if (drawableArr[1] != null) {
                        ...
                        if (intrinsicWidth3 > width - AndroidUtilities.m34dp(6.0f) || intrinsicHeight3 > width - AndroidUtilities.m34dp(6.0f)) {
                            float dp = f / AndroidUtilities.m34dp(50.0f);
                ...
                if (this.textLayout != null) {
                    float dp2 = f / AndroidUtilities.m34dp(50.0f);
