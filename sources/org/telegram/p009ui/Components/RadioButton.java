...
public class RadioButton extends View {
    ...
    private int size = AndroidUtilities.m34dp(16.0f);
    ...
    public RadioButton(Context context) {
        ...
        if (paint == null) {
            ...
            paint = paint2;
            paint2.setStrokeWidth(AndroidUtilities.m34dp(2.0f));
        ...
        try {
            this.bitmap = Bitmap.createBitmap(AndroidUtilities.m34dp(this.size), AndroidUtilities.m34dp(this.size), Bitmap.Config.ARGB_4444);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (bitmap3 != null) {
            ...
            if (this.progress <= 0.5f) {
                this.bitmapCanvas.drawCircle(getMeasuredWidth() / 2, getMeasuredHeight() / 2, f4 - AndroidUtilities.m34dp(1.0f), checkedPaint);
                this.bitmapCanvas.drawCircle(getMeasuredWidth() / 2, getMeasuredHeight() / 2, (f4 - AndroidUtilities.m34dp(1.0f)) * (1.0f - f), eraser);
            } else {
                this.bitmapCanvas.drawCircle(getMeasuredWidth() / 2, getMeasuredHeight() / 2, (this.size / 4) + (((f4 - AndroidUtilities.m34dp(1.0f)) - (this.size / 4)) * f), checkedPaint);
            }
