...
public abstract class Brush {
    ...
    public int getStampResId() {
        return C1072R.C1073drawable.paint_radial_brush;
    }
    ...
    public static class Elliptical extends Brush {
        ...
        @Override
        public int getStampResId() {
            return C1072R.C1073drawable.paint_elliptical_brush;
        }

        @Override
        public int getIconRes() {
            return C1072R.raw.photo_marker;
        }
    }
    ...
    public static class Neon extends Brush {
        ...
        @Override
        public int getStampResId() {
            return C1072R.C1073drawable.paint_neon_brush;
        }

        @Override
        public int getIconRes() {
            return C1072R.raw.photo_neon;
        }
    }
    ...
    public static class Eraser extends Brush {
        ...
        @Override
        public int getIconRes() {
            return C1072R.raw.photo_eraser;
        }
    }
    ...
    public static abstract class Shape extends Brush {
        ...
        public static class Circle extends Shape {
            ...
            @Override
            public String getShapeName() {
                return LocaleController.getString(C1072R.string.PaintCircle);
            }

            @Override
            public int getIconRes() {
                return C1072R.C1073drawable.photo_circle;
            }

            @Override
            public int getFilledIconRes() {
                return C1072R.C1073drawable.photo_circle_fill;
            }
        }
        ...
        public static class Rectangle extends Shape {
            ...
            @Override
            public String getShapeName() {
                return LocaleController.getString(C1072R.string.PaintRectangle);
            }

            @Override
            public int getIconRes() {
                return C1072R.C1073drawable.photo_rectangle;
            }

            @Override
            public int getFilledIconRes() {
                return C1072R.C1073drawable.photo_rectangle_fill;
            }
        }
        ...
        public static class Star extends Shape {
            ...
            @Override
            public String getShapeName() {
                return LocaleController.getString(C1072R.string.PaintStar);
            }

            @Override
            public int getIconRes() {
                return C1072R.C1073drawable.photo_star;
            }

            @Override
            public int getFilledIconRes() {
                return C1072R.C1073drawable.photo_star_fill;
            }
        }
        ...
        public static class Bubble extends Shape {
            ...
            @Override
            public String getShapeName() {
                return LocaleController.getString(C1072R.string.PaintBubble);
            }

            @Override
            public int getIconRes() {
                return C1072R.C1073drawable.msg_msgbubble;
            }

            @Override
            public int getFilledIconRes() {
                return C1072R.C1073drawable.msg_msgbubble2;
            }
        }
        ...
        public static class Arrow extends Shape {
            ...
            @Override
            public String getShapeName() {
                return LocaleController.getString(C1072R.string.PaintArrow);
            }

            @Override
            public int getIconRes() {
                return C1072R.C1073drawable.photo_arrowshape;
            }
