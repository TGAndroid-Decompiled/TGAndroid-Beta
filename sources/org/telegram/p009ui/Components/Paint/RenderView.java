...
public class RenderView extends TextureView {
    ...
    public RenderView(Context context, Painting painting, Bitmap bitmap) {
        ...
        setSurfaceTextureListener(new TextureView$SurfaceTextureListenerC21831());
    ...
    public class TextureView$SurfaceTextureListenerC21831 implements TextureView.SurfaceTextureListener {
        @Override
        public void onSurfaceTextureUpdated(SurfaceTexture surfaceTexture) {
        }

        TextureView$SurfaceTextureListenerC21831() {
        }
            ...
            if (RenderView.this.internal != null) {
                ...
                RenderView.this.internal.postRunnable(new Runnable() {
                    ...
                    public final void run() {
                        RenderView.TextureView$SurfaceTextureListenerC21831.this.lambda$onSurfaceTextureSizeChanged$0();
                    }
                });
            }
        }
        ...
        public boolean onSurfaceTextureDestroyed(SurfaceTexture surfaceTexture) {
            if (RenderView.this.internal != null && !RenderView.this.shuttingDown) {
                RenderView.this.painting.onPause(new Runnable() {
                    @Override
                    public final void run() {
                        RenderView.TextureView$SurfaceTextureListenerC21831.this.lambda$onSurfaceTextureDestroyed$1();
                    }
                });
            }
            return true;
    ...
    public class CanvasInternal extends DispatchQueue {
        ...
        private Runnable drawRunnable = new RunnableC21851();
        private EGL10 egl10;
        ...
        public class RunnableC21851 implements Runnable {
            RunnableC21851() {
            }
                ...
                if (CanvasInternal.this.initialized && !RenderView.this.shuttingDown) {
                    ...
                    if (!RenderView.this.firstDrawSent) {
                        ...
                        AndroidUtilities.runOnUIThread(new Runnable() {
                            @Override
                            public final void run() {
                                RenderView.CanvasInternal.RunnableC21851.this.lambda$run$0();
                            }
                        });
                    }
