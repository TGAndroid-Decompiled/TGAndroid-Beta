...
public class EditTextOutline extends EditTextBoldCursor {
    ...
    public void setFrameColor(int i) {
        ...
        if (i2 == 0 && i != 0) {
            setPadding(AndroidUtilities.m34dp(19.0f), AndroidUtilities.m34dp(7.0f), AndroidUtilities.m34dp(19.0f), AndroidUtilities.m34dp(7.0f));
            setCursorColor(-16777216);
        } else if (i2 != 0 && i == 0) {
            setPadding(AndroidUtilities.m34dp(7.0f), AndroidUtilities.m34dp(7.0f), AndroidUtilities.m34dp(7.0f), AndroidUtilities.m34dp(7.0f));
            setCursorColor(-1);
        }
        this.mFrameColor = i;
        if (i != 0) {
