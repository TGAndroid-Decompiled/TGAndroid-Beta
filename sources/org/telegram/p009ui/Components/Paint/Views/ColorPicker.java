...
public class ColorPicker extends FrameLayout {
    ...
    public ColorPicker(Context context) {
        ...
        this.swatchStrokePaint.setStrokeWidth(AndroidUtilities.m34dp(1.0f));
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (!this.interacting && y < (-AndroidUtilities.m34dp(10.0f))) {
            return false;
        }
        ...
        if (actionMasked == 3 || actionMasked == 1 || actionMasked == 6) {
            ...
            if (y < (-AndroidUtilities.m34dp(10.0f))) {
                this.changingWeight = true;
                setWeight(Math.max(0.0f, Math.min(1.0f, ((-y) - AndroidUtilities.m34dp(10.0f)) / AndroidUtilities.m34dp(190.0f))));
            }
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        int i5 = i3 - i;
        int i6 = i4 - i2;
        this.gradientPaint.setShader(new LinearGradient(AndroidUtilities.m34dp(56.0f), 0.0f, i5 - AndroidUtilities.m34dp(56.0f), 0.0f, COLORS, LOCATIONS, Shader.TileMode.REPEAT));
        int dp = i6 - AndroidUtilities.m34dp(32.0f);
        this.rectF.set(AndroidUtilities.m34dp(56.0f), dp, i5 - AndroidUtilities.m34dp(56.0f), dp + AndroidUtilities.m34dp(12.0f));
        ImageView imageView = this.settingsButton;
        imageView.layout(i5 - imageView.getMeasuredWidth(), i6 - AndroidUtilities.m34dp(52.0f), i5, i6);
        this.undoButton.layout(0, i6 - AndroidUtilities.m34dp(52.0f), this.settingsButton.getMeasuredWidth(), i6);
    }

    @Override
    protected void onDraw(Canvas canvas) {
        canvas.drawRoundRect(this.rectF, AndroidUtilities.m34dp(6.0f), AndroidUtilities.m34dp(6.0f), this.gradientPaint);
        RectF rectF = this.rectF;
        int width = (int) (rectF.left + (rectF.width() * this.location));
        int centerY = (int) ((this.rectF.centerY() + (this.draggingFactor * (-AndroidUtilities.m34dp(70.0f)))) - (this.changingWeight ? this.weight * AndroidUtilities.m34dp(190.0f) : 0.0f));
        int dp = (int) (AndroidUtilities.m34dp(24.0f) * (this.draggingFactor + 1.0f) * 0.5f);
        this.shadowDrawable.setBounds(width - dp, centerY - dp, width + dp, dp + centerY);
        this.shadowDrawable.draw(canvas);
        float floor = (((int) Math.floor(AndroidUtilities.m34dp(4.0f) + ((AndroidUtilities.m34dp(19.0f) - AndroidUtilities.m34dp(4.0f)) * this.weight))) * (this.draggingFactor + 1.0f)) / 2.0f;
        float f = width;
        float f2 = centerY;
        canvas.drawCircle(f, f2, (AndroidUtilities.m34dp(22.0f) / 2) * (this.draggingFactor + 1.0f), this.backgroundPaint);
        canvas.drawCircle(f, f2, floor, this.swatchPaint);
        canvas.drawCircle(f, f2, floor - AndroidUtilities.m34dp(0.5f), this.swatchStrokePaint);
    }
