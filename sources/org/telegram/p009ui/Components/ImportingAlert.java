...
public class ImportingAlert extends BottomSheet implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static class BottomSheetCell extends FrameLayout {
        ...
        public BottomSheetCell(Context context, Theme.ResourcesProvider resourcesProvider) {
            ...
            this.imageView.setAnimation(C0952R.raw.import_check, 26, 26);
    ...
    public ImportingAlert(Context context, String str, ChatActivity chatActivity, Theme.ResourcesProvider resourcesProvider) {
        ...
        RLottieDrawable rLottieDrawable = new RLottieDrawable(C0952R.raw.import_finish, "2131558470", AndroidUtilities.m34dp(120.0f), AndroidUtilities.m34dp(120.0f), false, null);
        this.completedDrawable = rLottieDrawable;
        rLottieDrawable.setAllowDecodeSingleFrame(true);
        RLottieImageView rLottieImageView = new RLottieImageView(context);
        this.imageView = rLottieImageView;
        rLottieImageView.setAutoRepeat(true);
        this.imageView.setAnimation(C0952R.raw.import_loop, 120, 120);
        this.imageView.playAnimation();
        ...
        this.cell.setText(LocaleController.getString("ImportDone", C0952R.string.ImportDone));
        ...
        for (int i = 0; i < 2; i++) {
            ...
            if (i == 0) {
                this.infoTextView[i].setText(LocaleController.getString("ImportImportingInfo", C0952R.string.ImportImportingInfo));
            } else {
        ...
        if (this.parentFragment != null) {
            textView.setText(LocaleController.getString("ImportImportingTitle", C0952R.string.ImportImportingTitle));
            ...
            this.importCountTextView[0].setText(LocaleController.formatString("ImportCount", C0952R.string.ImportCount, AndroidUtilities.formatFileSize(importingHistory.getUploadedCount()), AndroidUtilities.formatFileSize(importingHistory.getTotalCount())));
            this.infoTextView[1].setText(LocaleController.getString("ImportDoneInfo", C0952R.string.ImportDoneInfo));
            this.importCountTextView[1].setText(LocaleController.getString("ImportDoneTitle", C0952R.string.ImportDoneTitle));
            this.parentFragment.getNotificationCenter().addObserver(this, NotificationCenter.historyImportProgressChanged);
            return;
        }
        textView.setText(LocaleController.getString("ImportStickersImportingTitle", C0952R.string.ImportStickersImportingTitle));
        ...
        this.importCountTextView[0].setText(LocaleController.formatString("ImportCount", C0952R.string.ImportCount, AndroidUtilities.formatFileSize(importingStickers.getUploadedCount()), AndroidUtilities.formatFileSize(importingStickers.getTotalCount())));
        this.infoTextView[1].setText(LocaleController.getString("ImportStickersDoneInfo", C0952R.string.ImportStickersDoneInfo));
        this.importCountTextView[1].setText(LocaleController.getString("ImportStickersDoneTitle", C0952R.string.ImportStickersDoneTitle));
