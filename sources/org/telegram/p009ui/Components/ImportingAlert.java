...
public class ImportingAlert extends BottomSheet implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static class BottomSheetCell extends FrameLayout {
        ...
        public BottomSheetCell(Context context, Theme.ResourcesProvider resourcesProvider) {
            ...
            rLottieImageView.setBackground(Theme.createCircleDrawable(AndroidUtilities.m34dp(20.0f), getThemedColor("featuredStickers_buttonText")));
            ...
            this.imageView.setAnimation(C0890R.raw.import_check, 26, 26);
    ...
    public ImportingAlert(Context context, String str, ChatActivity chatActivity, Theme.ResourcesProvider resourcesProvider) {
        ...
        RLottieDrawable rLottieDrawable = new RLottieDrawable(C0890R.raw.import_finish, "2131558470", AndroidUtilities.m34dp(120.0f), AndroidUtilities.m34dp(120.0f), false, null);
        this.completedDrawable = rLottieDrawable;
        rLottieDrawable.setAllowDecodeSingleFrame(true);
        RLottieImageView rLottieImageView = new RLottieImageView(context);
        this.imageView = rLottieImageView;
        rLottieImageView.setAutoRepeat(true);
        this.imageView.setAnimation(C0890R.raw.import_loop, 120, 120);
        this.imageView.playAnimation();
        ...
        this.cell.setText(LocaleController.getString("ImportDone", C0890R.string.ImportDone));
        ...
        this.cell.background.setPivotY(AndroidUtilities.m34dp(48.0f));
        ...
        for (int i = 0; i < 2; i++) {
            ...
            if (i == 0) {
                this.infoTextView[i].setText(LocaleController.getString("ImportImportingInfo", C0890R.string.ImportImportingInfo));
            } else {
                this.infoTextView[i].setAlpha(0.0f);
                this.infoTextView[i].setTranslationY(AndroidUtilities.m34dp(10.0f));
                this.importCountTextView[i].setAlpha(0.0f);
                this.importCountTextView[i].setTranslationY(AndroidUtilities.m34dp(10.0f));
            }
        }
        if (this.parentFragment != null) {
            textView.setText(LocaleController.getString("ImportImportingTitle", C0890R.string.ImportImportingTitle));
            ...
            this.importCountTextView[0].setText(LocaleController.formatString("ImportCount", C0890R.string.ImportCount, AndroidUtilities.formatFileSize(importingHistory.getUploadedCount()), AndroidUtilities.formatFileSize(importingHistory.getTotalCount())));
            this.infoTextView[1].setText(LocaleController.getString("ImportDoneInfo", C0890R.string.ImportDoneInfo));
            this.importCountTextView[1].setText(LocaleController.getString("ImportDoneTitle", C0890R.string.ImportDoneTitle));
            this.parentFragment.getNotificationCenter().addObserver(this, NotificationCenter.historyImportProgressChanged);
            return;
        }
        textView.setText(LocaleController.getString("ImportStickersImportingTitle", C0890R.string.ImportStickersImportingTitle));
        ...
        this.importCountTextView[0].setText(LocaleController.formatString("ImportCount", C0890R.string.ImportCount, AndroidUtilities.formatFileSize(importingStickers.getUploadedCount()), AndroidUtilities.formatFileSize(importingStickers.getTotalCount())));
        this.infoTextView[1].setText(LocaleController.getString("ImportStickersDoneInfo", C0890R.string.ImportStickersDoneInfo));
        this.importCountTextView[1].setText(LocaleController.getString("ImportStickersDoneTitle", C0890R.string.ImportStickersDoneTitle));
    ...
    public void setCompleted() {
        ...
        animatorSet.playTogether(ObjectAnimator.ofFloat(this.percentTextView, View.ALPHA, 0.0f), ObjectAnimator.ofFloat(this.percentTextView, View.TRANSLATION_Y, -AndroidUtilities.m34dp(10.0f)), ObjectAnimator.ofFloat(this.infoTextView[0], View.ALPHA, 0.0f), ObjectAnimator.ofFloat(this.infoTextView[0], View.TRANSLATION_Y, -AndroidUtilities.m34dp(10.0f)), ObjectAnimator.ofFloat(this.importCountTextView[0], View.ALPHA, 0.0f), ObjectAnimator.ofFloat(this.importCountTextView[0], View.TRANSLATION_Y, -AndroidUtilities.m34dp(10.0f)), ObjectAnimator.ofFloat(this.infoTextView[1], View.ALPHA, 1.0f), ObjectAnimator.ofFloat(this.infoTextView[1], View.TRANSLATION_Y, 0.0f), ObjectAnimator.ofFloat(this.importCountTextView[1], View.ALPHA, 1.0f), ObjectAnimator.ofFloat(this.importCountTextView[1], View.TRANSLATION_Y, 0.0f), ObjectAnimator.ofFloat(this.lineProgressView, View.ALPHA, 0.0f), ObjectAnimator.ofFloat(this.cell.linearLayout, View.TRANSLATION_Y, AndroidUtilities.m34dp(8.0f), 0.0f));
