...
public class WebPlayerView extends ViewGroup implements VideoPlayer.VideoPlayerDelegate, AudioManager.OnAudioFocusChangeListener {
        ...
        public void onPostExecute(String[] strArr) {
            if (strArr[0] != null) {
                if (BuildVars.LOGS_ENABLED) {
                    FileLog.m33d("start play youtube video " + strArr[1] + " " + strArr[0]);
                }
    ...
    public class ControlsView extends FrameLayout {
        ...
        public void setDuration(int i) {
            if (this.duration != i && i >= 0 && !WebPlayerView.this.isStream) {
                this.duration = i;
                StaticLayout staticLayout = new StaticLayout(AndroidUtilities.formatShortDuration(this.duration), this.textPaint, AndroidUtilities.m34dp(1000.0f), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
        ...
        public void setProgress(int i) {
            if (!this.progressPressed && i >= 0 && !WebPlayerView.this.isStream) {
                this.progress = i;
                this.progressLayout = new StaticLayout(AndroidUtilities.formatShortDuration(this.progress), this.textPaint, AndroidUtilities.m34dp(1000.0f), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
                invalidate();
            }
        }
        ...
        public boolean onTouchEvent(MotionEvent motionEvent) {
            ...
            if (WebPlayerView.this.inFullscreen) {
                i3 = AndroidUtilities.m34dp(36.0f) + this.durationWidth;
                i2 = (getMeasuredWidth() - AndroidUtilities.m34dp(76.0f)) - this.durationWidth;
                i = getMeasuredHeight() - AndroidUtilities.m34dp(28.0f);
            } else {
                i2 = getMeasuredWidth();
                i = getMeasuredHeight() - AndroidUtilities.m34dp(12.0f);
                i3 = 0;
            }
            ...
            if (motionEvent.getAction() == 0) {
                if (!this.isVisible || WebPlayerView.this.isInline || WebPlayerView.this.isStream) {
                    ...
                    if (x >= i5 - AndroidUtilities.m34dp(10.0f) && x <= AndroidUtilities.m34dp(10.0f) + i5 && y >= i - AndroidUtilities.m34dp(10.0f) && y <= i + AndroidUtilities.m34dp(10.0f)) {
    ...
    public WebPlayerView(Context context, boolean z, boolean z2, WebPlayerViewDelegate webPlayerViewDelegate) {
        ...
        this.surfaceTextureListener = new TextureView.SurfaceTextureListener() {
            ...
            public class ViewTreeObserver$OnPreDrawListenerC26121 implements ViewTreeObserver.OnPreDrawListener {
                ViewTreeObserver$OnPreDrawListenerC26121() {
                }
                ...
                public boolean onPreDraw() {
                    ...
                    AndroidUtilities.runOnUIThread(new Runnable() {
                        @Override
                        public final void run() {
                            WebPlayerView.TextureView$SurfaceTextureListenerC26112.ViewTreeObserver$OnPreDrawListenerC26121.this.lambda$onPreDraw$0();
                        }
                    });
            ...
            public void onSurfaceTextureUpdated(SurfaceTexture surfaceTexture) {
                if (WebPlayerView.this.waitingForFirstTextureUpload == 1) {
                    WebPlayerView.this.changedTextureView.getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver$OnPreDrawListenerC26121());
    ...
    public void lambda$new$3(View view) {
        if (this.textureView != null && this.delegate.checkInlinePermissions() && !this.changingTextureView && !this.switchingInlineMode && this.firstFrameRendered) {
            ...
            if (viewGroup != this) {
                ...
                this.aspectRatioFrameLayout.measure(View.MeasureSpec.makeMeasureSpec(getMeasuredWidth(), 1073741824), View.MeasureSpec.makeMeasureSpec(getMeasuredHeight() - AndroidUtilities.m34dp(10.0f), 1073741824));
            }
    ...
    protected void onDraw(Canvas canvas) {
        canvas.drawRect(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight() - AndroidUtilities.m34dp(10.0f), this.backgroundPaint);
    }
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        int i6 = i4 - i2;
        int dp = ((i6 - AndroidUtilities.m34dp(10.0f)) - this.aspectRatioFrameLayout.getMeasuredHeight()) / 2;
        AspectRatioFrameLayout aspectRatioFrameLayout = this.aspectRatioFrameLayout;
        ...
        this.controlsView.imageReceiver.setImageCoords(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight() - AndroidUtilities.m34dp(10.0f));
    }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        this.aspectRatioFrameLayout.measure(View.MeasureSpec.makeMeasureSpec(size, 1073741824), View.MeasureSpec.makeMeasureSpec(size2 - AndroidUtilities.m34dp(10.0f), 1073741824));
        if (this.controlsView.getParent() == this) {
        ...
        this.progressView.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m34dp(44.0f), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m34dp(44.0f), 1073741824));
