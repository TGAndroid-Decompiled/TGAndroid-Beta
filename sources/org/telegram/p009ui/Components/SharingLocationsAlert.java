    ...
    public SharingLocationsAlert(Context context, SharingLocationsAlertDelegate sharingLocationsAlertDelegate, Theme.ResourcesProvider resourcesProvider) {
        ...
        FrameLayout frameLayout = new FrameLayout(context) {
            ...
            protected void onMeasure(int i, int i2) {
                ...
                getMeasuredWidth();
                int dp = AndroidUtilities.m34dp(56.0f) + AndroidUtilities.m34dp(56.0f) + 1 + (LocationController.getLocationsCount() * AndroidUtilities.m34dp(54.0f));
                int i4 = size / 5;
                if (dp < i4 * 3) {
                ...
                if (SharingLocationsAlert.this.listView.getPaddingTop() != i3) {
                    ...
                    SharingLocationsAlert.this.listView.setPadding(0, i3, 0, AndroidUtilities.m34dp(8.0f));
        ...
        pickerBottomLayout.cancelButton.setText(LocaleController.getString("StopAllLocationSharings", C0952R.string.StopAllLocationSharings));
        ...
        pickerBottomLayout.doneButtonTextView.setText(LocaleController.getString("Close", C0952R.string.Close).toUpperCase());
    ...
    private class ListAdapter extends RecyclerListView.SelectionAdapter {
            ...
            if (i != 0) {
                frameLayout = new FrameLayout(this, this.context) {
                    ...
                    protected void onMeasure(int i2, int i3) {
                        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i2), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m34dp(48.0f) + 1, 1073741824));
                    }

                    @Override
                    protected void onDraw(Canvas canvas) {
                        canvas.drawLine(0.0f, AndroidUtilities.m34dp(40.0f), getMeasuredWidth(), AndroidUtilities.m34dp(40.0f), Theme.dividerPaint);
                    }
                };
                frameLayout.setWillNotDraw(false);
                ...
                SharingLocationsAlert.this.textView.setPadding(0, 0, 0, AndroidUtilities.m34dp(8.0f));
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (itemViewType == 0) {
                ...
                SharingLocationsAlert.this.textView.setText(LocaleController.formatString("SharingLiveLocationTitle", C0952R.string.SharingLiveLocationTitle, LocaleController.formatPluralString("Chats", LocationController.getLocationsCount())));
            }
        }
    }
}
