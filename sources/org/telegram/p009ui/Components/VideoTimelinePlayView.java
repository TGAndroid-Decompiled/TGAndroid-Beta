...
public class VideoTimelinePlayView extends View {
    ...
    public VideoTimelinePlayView(Context context) {
        ...
        Drawable drawable = context.getResources().getDrawable(C1010R.C1011drawable.video_cropleft);
        this.drawableLeft = drawable;
        drawable.setColorFilter(new PorterDuffColorFilter(-16777216, PorterDuff.Mode.MULTIPLY));
        Drawable drawable2 = context.getResources().getDrawable(C1010R.C1011drawable.video_cropright);
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        int measuredWidth = getMeasuredWidth() - AndroidUtilities.m35dp(32.0f);
        float f = measuredWidth;
        int m35dp = ((int) (this.progressLeft * f)) + AndroidUtilities.m35dp(16.0f);
        int m35dp2 = ((int) (this.playProgress * f)) + AndroidUtilities.m35dp(16.0f);
        int m35dp3 = ((int) (this.progressRight * f)) + AndroidUtilities.m35dp(16.0f);
        if (motionEvent.getAction() == 0) {
            ...
            int m35dp5 = AndroidUtilities.m35dp(8.0f);
            if (m35dp3 != m35dp && m35dp2 - m35dp5 <= x && x <= m35dp5 + m35dp2 && y >= 0.0f && y <= getMeasuredHeight()) {
                ...
                this.pressDx = (int) (x - m35dp2);
                invalidate();
                return true;
            } else if (m35dp - m35dp4 <= x && x <= Math.min(m35dp + m35dp4, m35dp3) && y >= 0.0f && y <= getMeasuredHeight()) {
                ...
                this.pressDx = (int) (x - m35dp);
                invalidate();
                return true;
            } else if (m35dp3 - m35dp4 <= x && x <= m35dp4 + m35dp3 && y >= 0.0f && y <= getMeasuredHeight()) {
                ...
                this.pressDx = (int) (x - m35dp3);
                invalidate();
                return true;
            } else if (m35dp <= x && x <= m35dp3 && y >= 0.0f && y <= getMeasuredHeight()) {
                ...
                this.pressedPlay = true;
                float m35dp6 = (x - AndroidUtilities.m35dp(16.0f)) / f;
                this.playProgress = m35dp6;
                VideoTimelineViewDelegate videoTimelineViewDelegate5 = this.delegate;
                if (videoTimelineViewDelegate5 != null) {
                    videoTimelineViewDelegate5.onPlayProgressChanged(m35dp6);
                }
                this.pressDx = 0.0f;
                invalidate();
                return true;
            ...
            if (this.pressedPlay) {
                float m35dp7 = (((int) (x - this.pressDx)) - AndroidUtilities.m35dp(16.0f)) / f;
                this.playProgress = m35dp7;
                ...
                if (i < AndroidUtilities.m35dp(16.0f)) {
                    m35dp3 = AndroidUtilities.m35dp(16.0f);
                } else if (i <= m35dp3) {
                    m35dp3 = i;
                }
                float m35dp8 = (m35dp3 - AndroidUtilities.m35dp(16.0f)) / f;
                this.progressLeft = m35dp8;
                float f4 = this.progressRight;
                float f5 = this.maxProgressDiff;
                if (f4 - m35dp8 > f5) {
                    this.progressRight = m35dp8 + f5;
                } else {
                    float f6 = this.minProgressDiff;
                    if (f6 != 0.0f && f4 - m35dp8 < f6) {
                        float f7 = f4 - f6;
                ...
                if (i2 >= m35dp) {
                    m35dp = i2 > AndroidUtilities.m35dp(16.0f) + measuredWidth ? measuredWidth + AndroidUtilities.m35dp(16.0f) : i2;
                }
                float m35dp9 = (m35dp - AndroidUtilities.m35dp(16.0f)) / f;
                this.progressRight = m35dp9;
                float f11 = this.progressLeft;
                float f12 = this.maxProgressDiff;
                if (m35dp9 - f11 > f12) {
                    this.progressLeft = m35dp9 - f12;
                } else {
                    float f13 = this.minProgressDiff;
                    if (f13 != 0.0f && m35dp9 - f11 < f13) {
                        float f14 = f11 + f13;
    ...
    public void reloadFrames(int i) {
        ...
        if (i == 0) {
            this.frameHeight = AndroidUtilities.m35dp(40.0f);
            this.framesToLoad = Math.max(1, (getMeasuredWidth() - AndroidUtilities.m35dp(16.0f)) / this.frameHeight);
            this.frameWidth = (int) Math.ceil((getMeasuredWidth() - AndroidUtilities.m35dp(16.0f)) / this.framesToLoad);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float f = measuredWidth;
        int m35dp = ((int) (this.progressLeft * f)) + AndroidUtilities.m35dp(16.0f);
        int m35dp2 = ((int) (this.progressRight * f)) + AndroidUtilities.m35dp(16.0f);
        canvas.save();
        canvas.clipRect(AndroidUtilities.m35dp(16.0f), AndroidUtilities.m35dp(4.0f), AndroidUtilities.m35dp(20.0f) + measuredWidth, AndroidUtilities.m35dp(48.0f));
        int i = 0;
        float f2 = 1.0f;
        if (this.frames.isEmpty() && this.currentTask == null) {
            ...
            while (i < this.frames.size()) {
                ...
                if (bitmapFrame.bitmap != null) {
                    int m35dp3 = AndroidUtilities.m35dp(16.0f) + (this.frameWidth * i2);
                    int m35dp4 = AndroidUtilities.m35dp(6.0f);
                    ...
                    if (f3 != f2) {
                        ...
                        canvas.drawBitmap(bitmapFrame.bitmap, m35dp3, m35dp4, this.bitmapPaint);
                    } else {
                        canvas.drawBitmap(bitmapFrame.bitmap, m35dp3, m35dp4, (Paint) null);
                    }
                }
                i2++;
                i++;
        ...
        int m35dp6 = AndroidUtilities.m35dp(48.0f);
        float f5 = m35dp5;
        float f6 = m35dp;
        canvas.drawRect(AndroidUtilities.m35dp(16.0f), f5, f6, AndroidUtilities.m35dp(46.0f), this.paint2);
        canvas.drawRect(AndroidUtilities.m35dp(4.0f) + m35dp2, f5, AndroidUtilities.m35dp(16.0f) + measuredWidth + AndroidUtilities.m35dp(4.0f), AndroidUtilities.m35dp(46.0f), this.paint2);
        float f7 = m35dp6;
        canvas.drawRect(f6, AndroidUtilities.m35dp(4.0f), AndroidUtilities.m35dp(2.0f) + m35dp, f7, this.paint);
        canvas.drawRect(AndroidUtilities.m35dp(2.0f) + m35dp2, AndroidUtilities.m35dp(4.0f), AndroidUtilities.m35dp(4.0f) + m35dp2, f7, this.paint);
        canvas.drawRect(AndroidUtilities.m35dp(2.0f) + m35dp, AndroidUtilities.m35dp(4.0f), AndroidUtilities.m35dp(4.0f) + m35dp2, f5, this.paint);
        canvas.drawRect(AndroidUtilities.m35dp(2.0f) + m35dp, m35dp6 - AndroidUtilities.m35dp(2.0f), AndroidUtilities.m35dp(4.0f) + m35dp2, f7, this.paint);
        canvas.restore();
        this.rect3.set(m35dp - AndroidUtilities.m35dp(8.0f), AndroidUtilities.m35dp(4.0f), AndroidUtilities.m35dp(2.0f) + m35dp, f7);
        canvas.drawRoundRect(this.rect3, AndroidUtilities.m35dp(2.0f), AndroidUtilities.m35dp(2.0f), this.paint);
        this.drawableLeft.setBounds(m35dp - AndroidUtilities.m35dp(8.0f), AndroidUtilities.m35dp(4.0f) + ((AndroidUtilities.m35dp(44.0f) - AndroidUtilities.m35dp(18.0f)) / 2), m35dp + AndroidUtilities.m35dp(2.0f), ((AndroidUtilities.m35dp(44.0f) - AndroidUtilities.m35dp(18.0f)) / 2) + AndroidUtilities.m35dp(22.0f));
        this.drawableLeft.draw(canvas);
        this.rect3.set(AndroidUtilities.m35dp(2.0f) + m35dp2, AndroidUtilities.m35dp(4.0f), AndroidUtilities.m35dp(12.0f) + m35dp2, f7);
        canvas.drawRoundRect(this.rect3, AndroidUtilities.m35dp(2.0f), AndroidUtilities.m35dp(2.0f), this.paint);
        this.drawableRight.setBounds(AndroidUtilities.m35dp(2.0f) + m35dp2, AndroidUtilities.m35dp(4.0f) + ((AndroidUtilities.m35dp(44.0f) - AndroidUtilities.m35dp(18.0f)) / 2), m35dp2 + AndroidUtilities.m35dp(12.0f), ((AndroidUtilities.m35dp(44.0f) - AndroidUtilities.m35dp(18.0f)) / 2) + AndroidUtilities.m35dp(22.0f));
        this.drawableRight.draw(canvas);
        float m35dp7 = AndroidUtilities.m35dp(18.0f) + (f * this.playProgress);
        this.rect3.set(m35dp7 - AndroidUtilities.m35dp(1.5f), AndroidUtilities.m35dp(2.0f), AndroidUtilities.m35dp(1.5f) + m35dp7, AndroidUtilities.m35dp(50.0f));
        canvas.drawRoundRect(this.rect3, AndroidUtilities.m35dp(1.0f), AndroidUtilities.m35dp(1.0f), this.paint2);
        canvas.drawCircle(m35dp7, AndroidUtilities.m35dp(52.0f), AndroidUtilities.m35dp(3.5f), this.paint2);
        this.rect3.set(m35dp7 - AndroidUtilities.m35dp(1.0f), AndroidUtilities.m35dp(2.0f), AndroidUtilities.m35dp(1.0f) + m35dp7, AndroidUtilities.m35dp(50.0f));
        canvas.drawRoundRect(this.rect3, AndroidUtilities.m35dp(1.0f), AndroidUtilities.m35dp(1.0f), this.paint);
        canvas.drawCircle(m35dp7, AndroidUtilities.m35dp(52.0f), AndroidUtilities.m35dp(3.0f), this.paint);
    }
