...
public class VideoTimelinePlayView extends View {
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        int measuredWidth = getMeasuredWidth() - AndroidUtilities.m36dp(32.0f);
        float f = measuredWidth;
        int m36dp = ((int) (this.progressLeft * f)) + AndroidUtilities.m36dp(16.0f);
        int m36dp2 = ((int) (this.playProgress * f)) + AndroidUtilities.m36dp(16.0f);
        int m36dp3 = ((int) (this.progressRight * f)) + AndroidUtilities.m36dp(16.0f);
        if (motionEvent.getAction() == 0) {
            ...
            int m36dp5 = AndroidUtilities.m36dp(8.0f);
            if (m36dp3 != m36dp && m36dp2 - m36dp5 <= x && x <= m36dp5 + m36dp2 && y >= 0.0f && y <= getMeasuredHeight()) {
                ...
                this.pressDx = (int) (x - m36dp2);
                invalidate();
                return true;
            } else if (m36dp - m36dp4 <= x && x <= Math.min(m36dp + m36dp4, m36dp3) && y >= 0.0f && y <= getMeasuredHeight()) {
                ...
                this.pressDx = (int) (x - m36dp);
                invalidate();
                return true;
            } else if (m36dp3 - m36dp4 <= x && x <= m36dp4 + m36dp3 && y >= 0.0f && y <= getMeasuredHeight()) {
                ...
                this.pressDx = (int) (x - m36dp3);
                invalidate();
                return true;
            } else if (m36dp <= x && x <= m36dp3 && y >= 0.0f && y <= getMeasuredHeight()) {
                ...
                this.pressedPlay = true;
                float m36dp6 = (x - AndroidUtilities.m36dp(16.0f)) / f;
                this.playProgress = m36dp6;
                VideoTimelineViewDelegate videoTimelineViewDelegate5 = this.delegate;
                if (videoTimelineViewDelegate5 != null) {
                    videoTimelineViewDelegate5.onPlayProgressChanged(m36dp6);
                }
                this.pressDx = 0.0f;
                invalidate();
                return true;
            ...
            if (this.pressedPlay) {
                float m36dp7 = (((int) (x - this.pressDx)) - AndroidUtilities.m36dp(16.0f)) / f;
                this.playProgress = m36dp7;
                ...
                if (i < AndroidUtilities.m36dp(16.0f)) {
                    m36dp3 = AndroidUtilities.m36dp(16.0f);
                } else if (i <= m36dp3) {
                    m36dp3 = i;
                }
                float m36dp8 = (m36dp3 - AndroidUtilities.m36dp(16.0f)) / f;
                this.progressLeft = m36dp8;
                float f4 = this.progressRight;
                float f5 = this.maxProgressDiff;
                if (f4 - m36dp8 > f5) {
                    this.progressRight = m36dp8 + f5;
                } else {
                    float f6 = this.minProgressDiff;
                    if (f6 != 0.0f && f4 - m36dp8 < f6) {
                        float f7 = f4 - f6;
                ...
                if (i2 >= m36dp) {
                    m36dp = i2 > AndroidUtilities.m36dp(16.0f) + measuredWidth ? measuredWidth + AndroidUtilities.m36dp(16.0f) : i2;
                }
                float m36dp9 = (m36dp - AndroidUtilities.m36dp(16.0f)) / f;
                this.progressRight = m36dp9;
                float f11 = this.progressLeft;
                float f12 = this.maxProgressDiff;
                if (m36dp9 - f11 > f12) {
                    this.progressLeft = m36dp9 - f12;
                } else {
                    float f13 = this.minProgressDiff;
                    if (f13 != 0.0f && m36dp9 - f11 < f13) {
                        float f14 = f11 + f13;
    ...
    public void reloadFrames(int i) {
        ...
        if (i == 0) {
            this.frameHeight = AndroidUtilities.m36dp(40.0f);
            this.framesToLoad = Math.max(1, (getMeasuredWidth() - AndroidUtilities.m36dp(16.0f)) / this.frameHeight);
            this.frameWidth = (int) Math.ceil((getMeasuredWidth() - AndroidUtilities.m36dp(16.0f)) / this.framesToLoad);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float f = measuredWidth;
        int m36dp = ((int) (this.progressLeft * f)) + AndroidUtilities.m36dp(16.0f);
        int m36dp2 = ((int) (this.progressRight * f)) + AndroidUtilities.m36dp(16.0f);
        canvas.save();
        canvas.clipRect(AndroidUtilities.m36dp(16.0f), AndroidUtilities.m36dp(4.0f), AndroidUtilities.m36dp(20.0f) + measuredWidth, AndroidUtilities.m36dp(48.0f));
        int i = 0;
        float f2 = 1.0f;
        if (this.frames.isEmpty() && this.currentTask == null) {
            ...
            while (i < this.frames.size()) {
                ...
                if (bitmapFrame.bitmap != null) {
                    int m36dp3 = AndroidUtilities.m36dp(16.0f) + (this.frameWidth * i2);
                    int m36dp4 = AndroidUtilities.m36dp(6.0f);
                    ...
                    if (f3 != f2) {
                        ...
                        canvas.drawBitmap(bitmapFrame.bitmap, m36dp3, m36dp4, this.bitmapPaint);
                    } else {
                        canvas.drawBitmap(bitmapFrame.bitmap, m36dp3, m36dp4, (Paint) null);
                    }
                }
                i2++;
                i++;
        ...
        int m36dp6 = AndroidUtilities.m36dp(48.0f);
        float f5 = m36dp5;
        float f6 = m36dp;
        canvas.drawRect(AndroidUtilities.m36dp(16.0f), f5, f6, AndroidUtilities.m36dp(46.0f), this.paint2);
        canvas.drawRect(AndroidUtilities.m36dp(4.0f) + m36dp2, f5, AndroidUtilities.m36dp(16.0f) + measuredWidth + AndroidUtilities.m36dp(4.0f), AndroidUtilities.m36dp(46.0f), this.paint2);
        float f7 = m36dp6;
        canvas.drawRect(f6, AndroidUtilities.m36dp(4.0f), AndroidUtilities.m36dp(2.0f) + m36dp, f7, this.paint);
        canvas.drawRect(AndroidUtilities.m36dp(2.0f) + m36dp2, AndroidUtilities.m36dp(4.0f), AndroidUtilities.m36dp(4.0f) + m36dp2, f7, this.paint);
        canvas.drawRect(AndroidUtilities.m36dp(2.0f) + m36dp, AndroidUtilities.m36dp(4.0f), AndroidUtilities.m36dp(4.0f) + m36dp2, f5, this.paint);
        canvas.drawRect(AndroidUtilities.m36dp(2.0f) + m36dp, m36dp6 - AndroidUtilities.m36dp(2.0f), AndroidUtilities.m36dp(4.0f) + m36dp2, f7, this.paint);
        canvas.restore();
        this.rect3.set(m36dp - AndroidUtilities.m36dp(8.0f), AndroidUtilities.m36dp(4.0f), AndroidUtilities.m36dp(2.0f) + m36dp, f7);
        canvas.drawRoundRect(this.rect3, AndroidUtilities.m36dp(2.0f), AndroidUtilities.m36dp(2.0f), this.paint);
        this.drawableLeft.setBounds(m36dp - AndroidUtilities.m36dp(8.0f), AndroidUtilities.m36dp(4.0f) + ((AndroidUtilities.m36dp(44.0f) - AndroidUtilities.m36dp(18.0f)) / 2), m36dp + AndroidUtilities.m36dp(2.0f), ((AndroidUtilities.m36dp(44.0f) - AndroidUtilities.m36dp(18.0f)) / 2) + AndroidUtilities.m36dp(22.0f));
        this.drawableLeft.draw(canvas);
        this.rect3.set(AndroidUtilities.m36dp(2.0f) + m36dp2, AndroidUtilities.m36dp(4.0f), AndroidUtilities.m36dp(12.0f) + m36dp2, f7);
        canvas.drawRoundRect(this.rect3, AndroidUtilities.m36dp(2.0f), AndroidUtilities.m36dp(2.0f), this.paint);
        this.drawableRight.setBounds(AndroidUtilities.m36dp(2.0f) + m36dp2, AndroidUtilities.m36dp(4.0f) + ((AndroidUtilities.m36dp(44.0f) - AndroidUtilities.m36dp(18.0f)) / 2), m36dp2 + AndroidUtilities.m36dp(12.0f), ((AndroidUtilities.m36dp(44.0f) - AndroidUtilities.m36dp(18.0f)) / 2) + AndroidUtilities.m36dp(22.0f));
        this.drawableRight.draw(canvas);
        float m36dp7 = AndroidUtilities.m36dp(18.0f) + (f * this.playProgress);
        this.rect3.set(m36dp7 - AndroidUtilities.m36dp(1.5f), AndroidUtilities.m36dp(2.0f), AndroidUtilities.m36dp(1.5f) + m36dp7, AndroidUtilities.m36dp(50.0f));
        canvas.drawRoundRect(this.rect3, AndroidUtilities.m36dp(1.0f), AndroidUtilities.m36dp(1.0f), this.paint2);
        canvas.drawCircle(m36dp7, AndroidUtilities.m36dp(52.0f), AndroidUtilities.m36dp(3.5f), this.paint2);
        this.rect3.set(m36dp7 - AndroidUtilities.m36dp(1.0f), AndroidUtilities.m36dp(2.0f), AndroidUtilities.m36dp(1.0f) + m36dp7, AndroidUtilities.m36dp(50.0f));
        canvas.drawRoundRect(this.rect3, AndroidUtilities.m36dp(1.0f), AndroidUtilities.m36dp(1.0f), this.paint);
        canvas.drawCircle(m36dp7, AndroidUtilities.m36dp(52.0f), AndroidUtilities.m36dp(3.0f), this.paint);
    }
