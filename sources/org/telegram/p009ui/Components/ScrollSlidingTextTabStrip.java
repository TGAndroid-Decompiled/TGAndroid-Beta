...
public class ScrollSlidingTextTabStrip extends HorizontalScrollView {
    ...
    public ScrollSlidingTextTabStrip(Context context) {
        ...
        this.tabsContainer.setPadding(AndroidUtilities.m34dp(7.0f), 0, AndroidUtilities.m34dp(7.0f), 0);
    ...
    protected void onMeasure(int i, int i2) {
        int size = View.MeasureSpec.getSize(i) - AndroidUtilities.m34dp(22.0f);
        int childCount = this.tabsContainer.getChildCount();
    ...
    private void scrollToChild(int i) {
        if (this.tabCount != 0 && this.scrollingToChild != i) {
            ...
            if (textView != null) {
                ...
                if (left - AndroidUtilities.m34dp(50.0f) < scrollX) {
                    smoothScrollTo(left - AndroidUtilities.m34dp(50.0f), 0);
                    return;
                }
                int i2 = left + measuredWidth;
                if (AndroidUtilities.m34dp(21.0f) + i2 > scrollX + getWidth()) {
                    smoothScrollTo(i2, 0);
                }
            }
        }
    ...
    private int getChildWidth(TextView textView) {
        ...
        if (layout != null) {
            return ((int) Math.ceil(layout.getLineWidth(0))) + AndroidUtilities.m34dp(2.0f);
        }
