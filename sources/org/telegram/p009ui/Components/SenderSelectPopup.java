...
public class SenderSelectPopup extends ActionBarPopupWindow {
    ...
    public SenderSelectPopup(Context context, ChatActivity chatActivity, final MessagesController messagesController, final TLRPC$ChatFull tLRPC$ChatFull, TLRPC$TL_channels_sendAsPeers tLRPC$TL_channels_sendAsPeers, final OnSelectCallback onSelectCallback) {
        ...
        final int dp = AndroidUtilities.m34dp(450.0f);
        ...
        LinearLayout linearLayout = new LinearLayout(this, context) {
            ...
            protected int getSuggestedMinimumWidth() {
                return AndroidUtilities.m34dp(260.0f);
            }
        };
    ...
    public void startShowAnimation() {
        ...
        this.scrimPopupContainerLayout.setPivotX(AndroidUtilities.m34dp(8.0f));
        FrameLayout frameLayout = this.scrimPopupContainerLayout;
        frameLayout.setPivotY(frameLayout.getMeasuredHeight() - AndroidUtilities.m34dp(8.0f));
        ...
        if (tLRPC$Peer != null) {
            ...
            while (i < arrayList.size()) {
                ...
                this.layoutManager.scrollToPositionWithOffset(i, ((i == arrayList.size() - 1 || this.recyclerView.getMeasuredHeight() >= size) ? 0 : this.recyclerView.getMeasuredHeight() % dp) + AndroidUtilities.m34dp(7.0f) + (size - ((arrayList.size() - 2) * dp)));
