...
public abstract class TLRPC$Message extends TLObject {
            ...
            case -2082087340:
                tLRPC$Message = new TLRPC$TL_messageEmpty() {
                    ...
                    public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                        this.f877id = abstractSerializedData2.readInt32(z2);
                    ...
                    public void serializeToStream(AbstractSerializedData abstractSerializedData2) {
                        ...
                        abstractSerializedData2.writeInt32(this.f877id);
                    }
                };
                break;
            case -2049520670:
    ...
    public void writeAttachPath(AbstractSerializedData abstractSerializedData) {
        ...
        if (this.legacy) {
            ...
            this.layer = 141;
            this.params.put("legacy_layer", "141");
        }
        if ((this.f877id < 0 || this.send_state == 3 || this.legacy) && (hashMap2 = this.params) != null && hashMap2.size() > 0) {
        ...
        if ((this.flags & 4) != 0 && this.f877id < 0) {
