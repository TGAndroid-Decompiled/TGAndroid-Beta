...
public class SerializedData extends AbstractSerializedData {
    private DataInputStream f849in;
    ...
    public SerializedData(byte[] bArr) {
        ...
        this.f849in = new DataInputStream(this.inbuf);
        this.len = 0;
    }
    ...
    public void cleanup() {
        ...
        try {
            DataInputStream dataInputStream = this.f849in;
        ...
        for (int i2 = 0; i2 < 4; i2++) {
            try {
                ...
                if (BuildVars.LOGS_ENABLED) {
                    FileLog.m32e("write int32 error");
                    FileLog.m30e(e);
                    return;
                }
                return;
    ...
    private void writeInt64(long j, DataOutputStream dataOutputStream) {
        for (int i = 0; i < 8; i++) {
            try {
                ...
                if (BuildVars.LOGS_ENABLED) {
                    FileLog.m32e("write int64 error");
                    FileLog.m30e(e);
                    return;
                }
                return;
    ...
    public void writeBytes(byte[] bArr, int i, int i2) {
        try {
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m32e("write bytes error");
                FileLog.m30e(e);
            }
        }
    }
    ...
    public void writeByteArray(byte[] bArr) {
        try {
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m32e("write byte array error");
                FileLog.m30e(e);
            }
        }
    }
    ...
    public void writeString(String str) {
        try {
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m32e("write string error");
                FileLog.m30e(e);
            }
        }
    }
    ...
    public void writeDouble(double d) {
        try {
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m32e("write double error");
                FileLog.m30e(e);
            }
        }
    }
    ...
    public void writeFloat(float f) {
        try {
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m32e("write float error");
                FileLog.m30e(e);
            }
        }
    }
    ...
    public byte readByte(boolean z) {
        try {
            byte readByte = this.f849in.readByte();
            this.len++;
            return readByte;
        } catch (Exception e) {
            if (z) {
    ...
    public void readBytes(byte[] bArr, boolean z) {
        try {
            this.f849in.read(bArr);
            this.len += bArr.length;
        } catch (Exception e) {
            if (z) {
                throw new RuntimeException("read bytes error", e);
            } else if (BuildVars.LOGS_ENABLED) {
                FileLog.m32e("read bytes error");
                FileLog.m30e(e);
            }
        }
    }
    ...
    public String readString(boolean z) {
        int i;
        try {
            int read = this.f849in.read();
            this.len++;
            if (read >= 254) {
                read = this.f849in.read() | (this.f849in.read() << 8) | (this.f849in.read() << 16);
                this.len += 3;
                i = 4;
            } else {
                i = 1;
            ...
            if (z) {
                ...
                FileLog.m32e("read string error");
                FileLog.m30e(e);
                return null;
            }
        }
    ...
    public byte[] readByteArray(boolean z) {
        ...
        try {
            ...
            if (z) {
                ...
                FileLog.m32e("read byte array error");
                FileLog.m30e(e);
                return null;
            }
        }
    ...
    public double readDouble(boolean z) {
        try {
            ...
            if (z) {
                ...
                FileLog.m32e("read double error");
                FileLog.m30e(e);
                return 0.0d;
            }
        }
    ...
    public int readInt32(boolean z) {
        ...
        for (int i2 = 0; i2 < 4; i2++) {
            try {
                i |= this.f849in.read() << (i2 * 8);
                this.len++;
            } catch (Exception e) {
                if (!z) {
                    if (BuildVars.LOGS_ENABLED) {
                        FileLog.m32e("read int32 error");
                        FileLog.m30e(e);
                    }
                    return 0;
                }
    ...
    public long readInt64(boolean z) {
        ...
        for (int i = 0; i < 8; i++) {
            try {
                j |= this.f849in.read() << (i * 8);
                this.len++;
            } catch (Exception e) {
                if (!z) {
                    if (BuildVars.LOGS_ENABLED) {
                        FileLog.m32e("read int64 error");
                        FileLog.m30e(e);
                    }
                    return 0L;
                }
