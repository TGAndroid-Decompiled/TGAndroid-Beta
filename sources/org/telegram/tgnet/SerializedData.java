...
public class SerializedData extends AbstractSerializedData {
        ...
        for (int i2 = 0; i2 < 4; i2++) {
            try {
                ...
                if (BuildVars.LOGS_ENABLED) {
                    FileLog.m34e("write int32 error");
                    FileLog.m32e(e);
                    return;
                }
                return;
    ...
    private void writeInt64(long j, DataOutputStream dataOutputStream) {
        for (int i = 0; i < 8; i++) {
            try {
                ...
                if (BuildVars.LOGS_ENABLED) {
                    FileLog.m34e("write int64 error");
                    FileLog.m32e(e);
                    return;
                }
                return;
    ...
    public void writeBytes(byte[] bArr, int i, int i2) {
        try {
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m34e("write bytes error");
                FileLog.m32e(e);
            }
        }
    }
    ...
    public void writeByteArray(byte[] bArr) {
        try {
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m34e("write byte array error");
                FileLog.m32e(e);
            }
        }
    }
    ...
    public void writeString(String str) {
        try {
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m34e("write string error");
                FileLog.m32e(e);
            }
        }
    }
    ...
    public void writeDouble(double d) {
        try {
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m34e("write double error");
                FileLog.m32e(e);
            }
        }
    }
    ...
    public void writeFloat(float f) {
        try {
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m34e("write float error");
                FileLog.m32e(e);
            }
        }
    }
    ...
    public String readString(boolean z) {
        ...
        try {
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m34e("read string error");
                FileLog.m32e(e);
                return null;
            }
            return null;
    ...
    public byte[] readByteArray(boolean z) {
        ...
        try {
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m34e("read byte array error");
                FileLog.m32e(e);
                return null;
            }
            return null;
    ...
    public double readDouble(boolean z) {
        try {
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m34e("read double error");
                FileLog.m32e(e);
                return 0.0d;
            }
            return 0.0d;
