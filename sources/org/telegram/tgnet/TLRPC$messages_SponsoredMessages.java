...
public abstract class TLRPC$messages_SponsoredMessages extends TLObject {
    ...
    public static TLRPC$messages_SponsoredMessages TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        TLRPC$messages_SponsoredMessages tLRPC$messages_SponsoredMessages = i != -907141753 ? i != 406407439 ? null : new TLRPC$messages_SponsoredMessages() {
            @Override
            public void serializeToStream(AbstractSerializedData abstractSerializedData2) {
                abstractSerializedData2.writeInt32(406407439);
            }
        } : new TLRPC$messages_SponsoredMessages() {
            @Override
            ...
            public void serializeToStream(AbstractSerializedData abstractSerializedData2) {
                ...
                for (int i2 = 0; i2 < size; i2++) {
                    ((TLRPC$TL_sponsoredMessage) this.messages.get(i2)).serializeToStream(abstractSerializedData2);
                }
                abstractSerializedData2.writeInt32(481674261);
