...
public class TL_aicompose {
            ...
            if (inputAiComposeTone != null && inputAiComposeTone2 != null) {
                if (inputAiComposeTone instanceof inputAiComposeToneDefault) {
                    ...
                    if (inputAiComposeTone2 instanceof inputAiComposeToneID) {
                        ...
                        if (inputaicomposetoneid.f21057id == inputaicomposetoneid2.f21057id && inputaicomposetoneid.access_hash == inputaicomposetoneid2.access_hash) {
                            return true;
                        }
                    }
                    return false;
    ...
    public static class TL_aiComposeTone extends AiComposeTone {
        ...
        public void readParams(InputSerializedData inputSerializedData, boolean z4) {
            ...
            this.f21056id = inputSerializedData.readInt64(z4);
        ...
        public void serializeToStream(OutputSerializedData outputSerializedData) {
            ...
            outputSerializedData.writeInt64(this.f21056id);
    ...
    public static class aiComposeToneExample extends TLObject {
        ...
        public static aiComposeToneExample TLdeserialize(InputSerializedData inputSerializedData, int i10, boolean z4) {
            ...
            return (aiComposeToneExample) TLObject.TLdeserialize(aiComposeToneExample.class, aicomposetoneexample, inputSerializedData, i10, z4);
        }
    ...
    public static class inputAiComposeToneID extends InputAiComposeTone {
        ...
        public long access_hash;
        public long f21057id;

        @Override
        public void readParams(InputSerializedData inputSerializedData, boolean z4) {
            this.f21057id = inputSerializedData.readInt64(z4);
            this.access_hash = inputSerializedData.readInt64(z4);
        }
        ...
        public void serializeToStream(OutputSerializedData outputSerializedData) {
            ...
            outputSerializedData.writeInt64(this.f21057id);
            outputSerializedData.writeInt64(this.access_hash);
        }
    }
