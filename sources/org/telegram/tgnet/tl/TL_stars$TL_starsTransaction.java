...
public class TL_stars$TL_starsTransaction extends TL_stars$StarsTransaction {
    ...
    public void readParams(AbstractSerializedData abstractSerializedData, boolean z) {
        ...
        this.peer = TL_stars$StarsTransactionPeer.TLdeserialize(abstractSerializedData, abstractSerializedData.readInt32(z), z);
        if ((this.flags & 1) != 0) {
        ...
        if ((this.flags & 16384) != 0) {
            this.stargift = TL_stars$StarGift.TLdeserialize(abstractSerializedData, abstractSerializedData.readInt32(z), z);
        }
    }
