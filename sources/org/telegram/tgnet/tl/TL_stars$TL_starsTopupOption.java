...
public class TL_stars$TL_starsTopupOption extends TLObject {
    public long amount;
    ...
    public static TL_stars$TL_starsTopupOption TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        if (198776256 != i) {
            if (z) {
        ...
        tL_stars$TL_starsTopupOption.readParams(abstractSerializedData, z);
