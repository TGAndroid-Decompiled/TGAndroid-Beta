...
public class TL_stories {
    ...
    public static class MediaAreaCoordinates extends TLObject {
        ...
        public double f22625w;
        public double f22626x;
        public double f22627y;
    ...
    public static class TL_boost extends Boost {
        ...
        public void readParams(InputSerializedData inputSerializedData, boolean z10) {
            ...
            this.f22624id = inputSerializedData.readString(z10);
        ...
        public void serializeToStream(OutputSerializedData outputSerializedData) {
            ...
            outputSerializedData.writeString(this.f22624id);
            if (TLObject.hasFlag(this.flags, 1)) {
    ...
    public static class TL_geoPointAddress extends TLObject {
        ...
        public String toString() {
            ...
            if (this.state == null) {
                ...
                str = w.q(new StringBuilder("state="), this.state, ", ");
            }
            sb2.append(str);
            if (this.city == null) {
                str2 = "";
            } else {
                str2 = w.q(new StringBuilder("city="), this.city, ", ");
            }
            sb2.append(str2);
            if (this.street != null) {
    ...
    public static class TL_getStoryReactionsList extends TLObject {
        ...
        public void serializeToStream(OutputSerializedData outputSerializedData) {
            ...
            this.peer.serializeToStream(outputSerializedData);
            outputSerializedData.writeInt32(this.f22630id);
            if (TLObject.hasFlag(this.flags, 1)) {
    ...
    public static class TL_mediaAreaCoordinates extends MediaAreaCoordinates {
        ...
        public void readParams(InputSerializedData inputSerializedData, boolean z10) {
            this.flags = inputSerializedData.readInt32(z10);
            this.f22626x = inputSerializedData.readDouble(z10);
            this.f22627y = inputSerializedData.readDouble(z10);
            this.f22625w = inputSerializedData.readDouble(z10);
        ...
        public void serializeToStream(OutputSerializedData outputSerializedData) {
            ...
            outputSerializedData.writeInt32(this.flags);
            outputSerializedData.writeDouble(this.f22626x);
            outputSerializedData.writeDouble(this.f22627y);
            outputSerializedData.writeDouble(this.f22625w);
    ...
    public static class TL_prepaidGiveaway extends PrepaidGiveaway {
        ...
        @Override
        public void readParams(InputSerializedData inputSerializedData, boolean z10) {
            this.f22628id = inputSerializedData.readInt64(z10);
        ...
        public void serializeToStream(OutputSerializedData outputSerializedData) {
            ...
            outputSerializedData.writeInt64(this.f22628id);
    ...
    public static class TL_stats_getStoryStats extends TLObject {
        ...
        public void serializeToStream(OutputSerializedData outputSerializedData) {
            ...
            this.peer.serializeToStream(outputSerializedData);
            outputSerializedData.writeInt32(this.f22631id);
        }
    }
    ...
    public static class TL_stories_deleteStories extends TLObject {
        ...
        public ArrayList<Integer> f22632id = new ArrayList<>();
        public TLRPC.InputPeer peer;
        ...
        public void serializeToStream(OutputSerializedData outputSerializedData) {
            ...
            this.peer.serializeToStream(outputSerializedData);
            Vector.serializeInt(outputSerializedData, this.f22632id);
        }
    }
    ...
    public static class TL_stories_getPeerMaxIDs extends TLMethod<Vector<TLRPC.TL_recentStory>> {
        ...
        public ArrayList<TLRPC.InputPeer> f22635id = new ArrayList<>();

        @Override
        public void serializeToStream(OutputSerializedData outputSerializedData) {
            outputSerializedData.writeInt32(2018087280);
            Vector.serialize(outputSerializedData, this.f22635id);
        }
    ...
    public static class TL_stories_getStoriesByID extends TLObject {
        ...
        public ArrayList<Integer> f22636id = new ArrayList<>();
        public TLRPC.InputPeer peer;
    ...
    public static class TL_stories_getStoriesViews extends TLObject {
        ...
        public void serializeToStream(OutputSerializedData outputSerializedData) {
            ...
            this.peer.serializeToStream(outputSerializedData);
            Vector.serializeInt(outputSerializedData, this.f22637id);
        }
    }
    ...
    public static class TL_stories_getStoryViewsList extends TLObject {
        ...
        public void serializeToStream(OutputSerializedData outputSerializedData) {
            ...
            this.peer.serializeToStream(outputSerializedData);
            if (TLObject.hasFlag(this.flags, 2)) {
                outputSerializedData.writeString(this.f22639q);
            }
            outputSerializedData.writeInt32(this.f22638id);
            outputSerializedData.writeString(this.offset);
            outputSerializedData.writeInt32(this.limit);
        }
    }
    ...
    public static class TL_stories_incrementStoryViews extends TLObject {
        ...
        public ArrayList<Integer> f22640id = new ArrayList<>();
        public TLRPC.InputPeer peer;
        ...
        public void serializeToStream(OutputSerializedData outputSerializedData) {
            ...
            this.peer.serializeToStream(outputSerializedData);
            Vector.serializeInt(outputSerializedData, this.f22640id);
        }
    }
    ...
    public static class TL_stories_report extends TLMethod<TLRPC.ReportResult> {
        ...
        public ArrayList<Integer> f22641id = new ArrayList<>();
        ...
        public void serializeToStream(OutputSerializedData outputSerializedData) {
            ...
            this.peer.serializeToStream(outputSerializedData);
            Vector.serialize(outputSerializedData, new u(outputSerializedData, 1), this.f22641id);
    ...
    public static class TL_storyItem extends StoryItem {
        ...
        public void readParams(InputSerializedData inputSerializedData, boolean z10) {
            ...
            this.f22629id = inputSerializedData.readInt32(z10);
            this.date = inputSerializedData.readInt32(z10);
        ...
        public void serializeToStream(OutputSerializedData outputSerializedData) {
            ...
            outputSerializedData.writeInt32(this.f22629id);
            outputSerializedData.writeInt32(this.date);
            if (TLObject.hasFlag(this.flags, 262144)) {
    ...
    public static class TL_togglePinnedToTop extends TLObject {
        ...
        public ArrayList<Integer> f22642id = new ArrayList<>();
        public TLRPC.InputPeer peer;
        ...
        public void serializeToStream(OutputSerializedData outputSerializedData) {
            ...
            this.peer.serializeToStream(outputSerializedData);
            Vector.serializeInt(outputSerializedData, this.f22642id);
        }
    }
    ...
    public static class togglePinned extends TLObject {
        ...
        public ArrayList<Integer> f22643id = new ArrayList<>();
        public TLRPC.InputPeer peer;
        public boolean pinned;
        ...
        public void serializeToStream(OutputSerializedData outputSerializedData) {
            ...
            this.peer.serializeToStream(outputSerializedData);
            Vector.serializeInt(outputSerializedData, this.f22643id);
