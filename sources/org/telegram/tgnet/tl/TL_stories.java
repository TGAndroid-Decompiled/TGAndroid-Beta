...
public class TL_stories {
    ...
    public static class MediaAreaCoordinates extends TLObject {
        ...
        public double f18559w;
        public double f18560x;
        public double f18561y;
    ...
    public static class TL_boost extends Boost {
        ...
        public void readParams(InputSerializedData inputSerializedData, boolean z10) {
            ...
            this.f18558id = inputSerializedData.readString(z10);
        ...
        public void serializeToStream(OutputSerializedData outputSerializedData) {
            ...
            outputSerializedData.writeString(this.f18558id);
            if (TLObject.hasFlag(this.flags, 1)) {
    ...
    public static class TL_getStoryReactionsList extends TLObject {
        ...
        public void serializeToStream(OutputSerializedData outputSerializedData) {
            ...
            this.peer.serializeToStream(outputSerializedData);
            outputSerializedData.writeInt32(this.f18564id);
            if (TLObject.hasFlag(this.flags, 1)) {
    ...
    public static class TL_mediaAreaCoordinates extends MediaAreaCoordinates {
        ...
        public void readParams(InputSerializedData inputSerializedData, boolean z10) {
            this.flags = inputSerializedData.readInt32(z10);
            this.f18560x = inputSerializedData.readDouble(z10);
            this.f18561y = inputSerializedData.readDouble(z10);
            this.f18559w = inputSerializedData.readDouble(z10);
        ...
        public void serializeToStream(OutputSerializedData outputSerializedData) {
            ...
            outputSerializedData.writeInt32(this.flags);
            outputSerializedData.writeDouble(this.f18560x);
            outputSerializedData.writeDouble(this.f18561y);
            outputSerializedData.writeDouble(this.f18559w);
    ...
    public static class TL_prepaidGiveaway extends PrepaidGiveaway {
        ...
        @Override
        public void readParams(InputSerializedData inputSerializedData, boolean z10) {
            this.f18562id = inputSerializedData.readInt64(z10);
        ...
        public void serializeToStream(OutputSerializedData outputSerializedData) {
            ...
            outputSerializedData.writeInt64(this.f18562id);
    ...
    public static class TL_stats_getStoryStats extends TLObject {
        ...
        public void serializeToStream(OutputSerializedData outputSerializedData) {
            ...
            this.peer.serializeToStream(outputSerializedData);
            outputSerializedData.writeInt32(this.f18565id);
        }
    }
    ...
    public static class TL_stories_deleteStories extends TLObject {
        ...
        public ArrayList<Integer> f18566id = new ArrayList<>();
        public TLRPC.InputPeer peer;
        ...
        public void serializeToStream(OutputSerializedData outputSerializedData) {
            ...
            this.peer.serializeToStream(outputSerializedData);
            Vector.serializeInt(outputSerializedData, this.f18566id);
        }
    }
    ...
    public static class TL_stories_editStory extends TLObject {
        ...
        public void serializeToStream(OutputSerializedData outputSerializedData) {
            ...
            outputSerializedData.writeInt32(this.flags);
            this.peer.serializeToStream(outputSerializedData);
            outputSerializedData.writeInt32(this.f18567id);
            if (TLObject.hasFlag(this.flags, 1)) {
    ...
    public static class TL_stories_exportStoryLink extends TLObject {
        ...
        public void serializeToStream(OutputSerializedData outputSerializedData) {
            ...
            this.peer.serializeToStream(outputSerializedData);
            outputSerializedData.writeInt32(this.f18568id);
        }
    }
    ...
    public static class TL_stories_getPeerMaxIDs extends TLMethod<Vector<TLRPC.TL_recentStory>> {
        ...
        public ArrayList<TLRPC.InputPeer> f18569id = new ArrayList<>();

        @Override
        public void serializeToStream(OutputSerializedData outputSerializedData) {
            outputSerializedData.writeInt32(2018087280);
            Vector.serialize(outputSerializedData, this.f18569id);
        }
    ...
    public static class TL_stories_getStoriesByID extends TLObject {
        ...
        public ArrayList<Integer> f18570id = new ArrayList<>();
        public TLRPC.InputPeer peer;
    ...
    public static class TL_stories_getStoriesViews extends TLObject {
        ...
        public void serializeToStream(OutputSerializedData outputSerializedData) {
            ...
            this.peer.serializeToStream(outputSerializedData);
            Vector.serializeInt(outputSerializedData, this.f18571id);
        }
    }
    ...
    public static class TL_stories_getStoryViewsList extends TLObject {
        ...
        public void serializeToStream(OutputSerializedData outputSerializedData) {
            ...
            this.peer.serializeToStream(outputSerializedData);
            if (TLObject.hasFlag(this.flags, 2)) {
                outputSerializedData.writeString(this.f18573q);
            }
            outputSerializedData.writeInt32(this.f18572id);
            outputSerializedData.writeString(this.offset);
            outputSerializedData.writeInt32(this.limit);
        }
    }
    ...
    public static class TL_stories_incrementStoryViews extends TLObject {
        ...
        public ArrayList<Integer> f18574id = new ArrayList<>();
        public TLRPC.InputPeer peer;
        ...
        public void serializeToStream(OutputSerializedData outputSerializedData) {
            ...
            this.peer.serializeToStream(outputSerializedData);
            Vector.serializeInt(outputSerializedData, this.f18574id);
        }
    }
    ...
    public static class TL_stories_report extends TLMethod<TLRPC.ReportResult> {
        ...
        public ArrayList<Integer> f18575id = new ArrayList<>();
        ...
        public void serializeToStream(OutputSerializedData outputSerializedData) {
            ...
            this.peer.serializeToStream(outputSerializedData);
            Vector.serialize(outputSerializedData, new w(outputSerializedData, 1), this.f18575id);
    ...
    public static class TL_storyItem extends StoryItem {
        ...
        public void readParams(InputSerializedData inputSerializedData, boolean z10) {
            ...
            this.f18563id = inputSerializedData.readInt32(z10);
            this.date = inputSerializedData.readInt32(z10);
        ...
        public void serializeToStream(OutputSerializedData outputSerializedData) {
            ...
            outputSerializedData.writeInt32(this.f18563id);
            outputSerializedData.writeInt32(this.date);
            if (TLObject.hasFlag(this.flags, 262144)) {
    ...
    public static class TL_togglePinnedToTop extends TLObject {
        ...
        public ArrayList<Integer> f18576id = new ArrayList<>();
        public TLRPC.InputPeer peer;
        ...
        public void serializeToStream(OutputSerializedData outputSerializedData) {
            ...
            this.peer.serializeToStream(outputSerializedData);
            Vector.serializeInt(outputSerializedData, this.f18576id);
        }
    }
    ...
    public static class togglePinned extends TLObject {
        ...
        public ArrayList<Integer> f18577id = new ArrayList<>();
        public TLRPC.InputPeer peer;
        public boolean pinned;
        ...
        public void serializeToStream(OutputSerializedData outputSerializedData) {
            ...
            this.peer.serializeToStream(outputSerializedData);
            Vector.serializeInt(outputSerializedData, this.f18577id);
