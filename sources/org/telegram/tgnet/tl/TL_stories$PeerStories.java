...
public abstract class TL_stories$PeerStories extends TLObject {
    ...
    public static TL_stories$PeerStories TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        TL_stories$TL_peerStories tL_stories$TL_peerStories = i != -2045664768 ? i != -1707742823 ? null : new TL_stories$TL_peerStories() : new TL_stories$TL_peerStories() {
            @Override
            ...
            public void serializeToStream(AbstractSerializedData abstractSerializedData2) {
                ...
                for (int i2 = 0; i2 < size; i2++) {
                    ((TL_stories$StoryItem) this.stories.get(i2)).serializeToStream(abstractSerializedData2);
                }
            }
        };
