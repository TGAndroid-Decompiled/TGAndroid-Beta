...
public class TL_account {
    ...
    public static class Passkey extends TLObject {
        ...
        public void readParams(InputSerializedData inputSerializedData, boolean z10) {
            ...
            this.f18539id = inputSerializedData.readString(z10);
    ...
    public static class deletePasskey extends TLMethod<TLRPC.Bool> {
        ...
        public String f18540id;

        @Override
        public void serializeToStream(OutputSerializedData outputSerializedData) {
            outputSerializedData.writeInt32(-172665281);
            outputSerializedData.writeString(this.f18540id);
        }
    ...
    public static class getRequirementsToContact extends TLObject {
        ...
        public ArrayList<TLRPC.InputUser> f18541id = new ArrayList<>();
        ...
        @Override
        public void readParams(InputSerializedData inputSerializedData, boolean z10) {
            this.f18541id = Vector.deserialize(inputSerializedData, new q(11), z10);
        }

        @Override
        public void serializeToStream(OutputSerializedData outputSerializedData) {
            outputSerializedData.writeInt32(-660962397);
            Vector.serialize(outputSerializedData, this.f18541id);
        }
    }
    ...
    public static class getSavedMusicByID extends TLObject {
        ...
        public TLRPC.InputUser f18542id;
        ...
        public void serializeToStream(OutputSerializedData outputSerializedData) {
            ...
            this.f18542id.serializeToStream(outputSerializedData);
    ...
    public static class inputPasskeyCredentialPublicKey extends TLObject {
        ...
        @Override
        public void readParams(InputSerializedData inputSerializedData, boolean z10) {
            this.f18543id = inputSerializedData.readString(z10);
        ...
        public void serializeToStream(OutputSerializedData outputSerializedData) {
            ...
            outputSerializedData.writeString(this.f18543id);
    ...
    public static class saveRingtone extends TLObject {
        ...
        public TLRPC.InputDocument f18544id;
        ...
        public void serializeToStream(OutputSerializedData outputSerializedData) {
            ...
            this.f18544id.serializeToStream(outputSerializedData);
