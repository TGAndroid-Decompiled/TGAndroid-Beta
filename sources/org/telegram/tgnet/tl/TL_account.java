...
public class TL_account {
    ...
    public static class deletePasskey extends TLMethod<TLRPC.Bool> {
        ...
        public String f18317id;

        @Override
        public void serializeToStream(OutputSerializedData outputSerializedData) {
            outputSerializedData.writeInt32(-172665281);
            outputSerializedData.writeString(this.f18317id);
        }
    ...
    public static class getRequirementsToContact extends TLObject {
        ...
        public ArrayList<TLRPC.InputUser> f18318id = new ArrayList<>();
        ...
        @Override
        public void readParams(InputSerializedData inputSerializedData, boolean z10) {
            this.f18318id = Vector.deserialize(inputSerializedData, new p(11), z10);
        }

        @Override
        public void serializeToStream(OutputSerializedData outputSerializedData) {
            outputSerializedData.writeInt32(-660962397);
            Vector.serialize(outputSerializedData, this.f18318id);
        }
    }
    ...
    public static class getSavedMusicByID extends TLObject {
        ...
        public TLRPC.InputUser f18319id;
        ...
        public void serializeToStream(OutputSerializedData outputSerializedData) {
            ...
            this.f18319id.serializeToStream(outputSerializedData);
    ...
    public static class inputPasskeyCredentialPublicKey extends TLObject {
        ...
        @Override
        public void readParams(InputSerializedData inputSerializedData, boolean z10) {
            this.f18320id = inputSerializedData.readString(z10);
        ...
        public void serializeToStream(OutputSerializedData outputSerializedData) {
            ...
            outputSerializedData.writeString(this.f18320id);
    ...
    public static class saveRingtone extends TLObject {
        ...
        public TLRPC.InputDocument f18321id;
        ...
        public void serializeToStream(OutputSerializedData outputSerializedData) {
            ...
            this.f18321id.serializeToStream(outputSerializedData);
