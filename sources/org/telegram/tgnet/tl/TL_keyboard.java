...
public class TL_keyboard {
    ...
    public static class KeyboardButtonRow extends TLObject {
        ...
        public static KeyboardButtonRow TLdeserialize(InputSerializedData inputSerializedData, int i10, boolean z4) {
            ...
            if (2002815875 != i10) {
                ...
                keyboardButtonRow = new KeyboardButtonRow();
            }
            return (KeyboardButtonRow) TLObject.TLdeserialize(KeyboardButtonRow.class, keyboardButtonRow, inputSerializedData, i10, z4);
        }
    ...
    public static class KeyboardButtonStyle extends TLObject {
        ...
        public static KeyboardButtonStyle TLdeserialize(InputSerializedData inputSerializedData, int i10, boolean z4) {
            ...
            if (i10 != 1339896880) {
                keyboardButtonStyle = null;
            } else {
                keyboardButtonStyle = new KeyboardButtonStyle();
            }
            return (KeyboardButtonStyle) TLObject.TLdeserialize(KeyboardButtonStyle.class, keyboardButtonStyle, inputSerializedData, i10, z4);
        }
    ...
    public static abstract class KeyboardInlineButton extends TLObject implements KeyboardButtonProto {
        ...
        public static KeyboardInlineButton fromConstructor(int i10) {
            ...
            return fromConstructorLegacy(i10);
        }
    ...
    public static class PageButton extends TLObject implements KeyboardButtonProto {
        ...
        public static PageButton TLdeserialize(InputSerializedData inputSerializedData, int i10, boolean z4) {
            ...
            return (PageButton) TLObject.TLdeserialize(PageButton.class, pageButton, inputSerializedData, i10, z4);
        }
    ...
    public static class RichButtonStyle extends TLObject {
        ...
        public static RichButtonStyle TLdeserialize(InputSerializedData inputSerializedData, int i10, boolean z4) {
            ...
            if (i10 != 63312061) {
                richButtonStyle = null;
            } else {
                richButtonStyle = new RichButtonStyle();
            }
            return (RichButtonStyle) TLObject.TLdeserialize(RichButtonStyle.class, richButtonStyle, inputSerializedData, i10, z4);
        }
    ...
    public static class TL_inputKeyboardButtonRequestPeer_layer228 extends TL_keyboardButton {
        ...
        public void serializeToStream(OutputSerializedData outputSerializedData) {
            ...
            int flag4 = TLObject.setFlag(flag3, 1024, z4);
            this.flags = flag4;
            outputSerializedData.writeInt32(flag4);
            if (TLObject.hasFlag(this.flags, 1024)) {
                this.style.serializeToStream(outputSerializedData);
    ...
    public static class TL_inputKeyboardButtonUrlAuth_layer223 extends TL_inputKeyboardButtonUrlAuth_layer228 {
        ...
        public void readParams(InputSerializedData inputSerializedData, boolean z4) {
            ...
            int i10 = tL_inputInlineButtonTypeUrlAuth2.flags;
            if (tL_inputInlineButtonTypeUrlAuth2.fwd_text != null) {
                z10 = true;
            } else {
                z10 = false;
            }
            tL_inputInlineButtonTypeUrlAuth2.flags = TLObject.setFlag(i10, 2, z10);
            TL_inputInlineButtonTypeUrlAuth tL_inputInlineButtonTypeUrlAuth3 = this.mType;
            int i11 = tL_inputInlineButtonTypeUrlAuth3.flags;
            if (tL_inputInlineButtonTypeUrlAuth3.bot == null) {
                z11 = false;
            }
            tL_inputInlineButtonTypeUrlAuth3.flags = TLObject.setFlag(i11, 4, z11);
        }
    ...
    public static class TL_inputKeyboardButtonUrlAuth_layer228 extends TL_keyboardInlineButton {
        ...
        public void serializeToStream(OutputSerializedData outputSerializedData) {
            ...
            int flag2 = TLObject.setFlag(flag, 1024, z4);
            this.flags = flag2;
            outputSerializedData.writeInt32(flag2);
            if (TLObject.hasFlag(this.flags, 1024)) {
                this.style.serializeToStream(outputSerializedData);
    ...
    public static class TL_inputKeyboardButtonUserProfile_layer228 extends TL_keyboardInlineButton {
        ...
        public void serializeToStream(OutputSerializedData outputSerializedData) {
            ...
            int flag = TLObject.setFlag(i10, 1024, z4);
            this.flags = flag;
            outputSerializedData.writeInt32(flag);
            if (TLObject.hasFlag(this.flags, 1024)) {
                this.style.serializeToStream(outputSerializedData);
    ...
    public static class TL_keyboardButtonSwitchInline_layer223 extends TL_keyboardButtonSwitchInline_layer228 {
        ...
        public void readParams(InputSerializedData inputSerializedData, boolean z4) {
            ...
            int i10 = tL_inlineButtonTypeSwitchInline2.flags;
            if (tL_inlineButtonTypeSwitchInline2.peer_types == null) {
                z10 = false;
            }
            tL_inlineButtonTypeSwitchInline2.flags = TLObject.setFlag(i10, 2, z10);
        }
    ...
    public static class TL_keyboardButtonUrlAuth_layer228 extends TL_keyboardInlineButton {
        ...
        public void serializeToStream(OutputSerializedData outputSerializedData) {
            ...
            int flag2 = TLObject.setFlag(flag, 1024, z10);
            this.flags = flag2;
            outputSerializedData.writeInt32(flag2);
            if (TLObject.hasFlag(this.flags, 1024)) {
                this.style.serializeToStream(outputSerializedData);
    ...
    public static TLObject access$400(InputSerializedData inputSerializedData, int i10, boolean z4) {
