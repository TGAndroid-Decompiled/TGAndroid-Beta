...
public class TL_stars$TL_payments_starsStatus extends TLObject {
    public long balance;
    public int flags;
    ...
    public static TL_stars$TL_payments_starsStatus TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        if (-1141231252 != i) {
            if (z) {
        ...
        TL_stars$TL_payments_starsStatus tL_stars$TL_payments_starsStatus = new TL_stars$TL_payments_starsStatus();
        tL_stars$TL_payments_starsStatus.readParams(abstractSerializedData, z);
    ...
    public void readParams(AbstractSerializedData abstractSerializedData, boolean z) {
        ...
        if ((this.flags & 2) != 0) {
            ...
            for (int i = 0; i < readInt322; i++) {
                TL_stars$StarsSubscription TLdeserialize = TL_stars$StarsSubscription.TLdeserialize(abstractSerializedData, abstractSerializedData.readInt32(z), z);
        ...
        if ((this.flags & 8) != 0) {
            ...
            for (int i2 = 0; i2 < readInt324; i2++) {
                TL_stars$StarsTransaction TLdeserialize2 = TL_stars$StarsTransaction.TLdeserialize(abstractSerializedData, abstractSerializedData.readInt32(z), z);
    ...
    public void serializeToStream(AbstractSerializedData abstractSerializedData) {
        ...
        if ((this.flags & 2) != 0) {
            ...
            for (int i = 0; i < size; i++) {
                ((TL_stars$StarsSubscription) this.subscriptions.get(i)).serializeToStream(abstractSerializedData);
            }
        }
        if ((this.flags & 4) != 0) {
        ...
        for (int i2 = 0; i2 < size2; i2++) {
            ((TL_stars$StarsTransaction) this.history.get(i2)).serializeToStream(abstractSerializedData);
        }
        if ((this.flags & 1) != 0) {
