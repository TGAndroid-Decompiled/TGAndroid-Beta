...
public abstract class TL_stories$StoryReaction extends TLObject {
    ...
    public static TL_stories$StoryReaction TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        TL_stories$StoryReaction tL_stories$TL_storyReaction = i != -1146411453 ? i != -808644845 ? i != 1620104917 ? null : new TL_stories$TL_storyReaction() : new TL_stories$StoryReaction() {
            @Override
