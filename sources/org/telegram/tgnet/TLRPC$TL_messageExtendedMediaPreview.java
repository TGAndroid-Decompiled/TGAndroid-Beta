...
public class TLRPC$TL_messageExtendedMediaPreview extends TLRPC$MessageExtendedMedia {
    ...
    public void readParams(AbstractSerializedData abstractSerializedData, boolean z) {
        ...
        if ((readInt32 & 1) != 0) {
            this.f928w = abstractSerializedData.readInt32(z);
        }
        if ((this.flags & 1) != 0) {
            this.f927h = abstractSerializedData.readInt32(z);
        }
        if ((this.flags & 2) != 0) {
    ...
    public void serializeToStream(AbstractSerializedData abstractSerializedData) {
        ...
        if ((this.flags & 1) != 0) {
            abstractSerializedData.writeInt32(this.f928w);
        }
        if ((this.flags & 1) != 0) {
            abstractSerializedData.writeInt32(this.f927h);
        }
        if ((this.flags & 2) != 0) {
