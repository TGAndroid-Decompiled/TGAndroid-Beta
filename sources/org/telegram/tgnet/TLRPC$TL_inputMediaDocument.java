...
public class TLRPC$TL_inputMediaDocument extends TLRPC$InputMedia {
    ...
    public TLRPC$InputDocument f911id;
    public String query;

    @Override
    public void readParams(AbstractSerializedData abstractSerializedData, boolean z) {
        this.flags = abstractSerializedData.readInt32(z);
        this.f911id = TLRPC$InputDocument.TLdeserialize(abstractSerializedData, abstractSerializedData.readInt32(z), z);
        if ((this.flags & 1) != 0) {
    ...
    public void serializeToStream(AbstractSerializedData abstractSerializedData) {
        ...
        this.f911id.serializeToStream(abstractSerializedData);
        if ((this.flags & 1) != 0) {
