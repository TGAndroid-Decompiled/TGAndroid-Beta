            ...
            case -374917894:
                tLRPC$PhotoSize = new TLRPC$TL_photoCachedSize() {
                    ...
                    public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                        ...
                        this.f888w = abstractSerializedData2.readInt32(z2);
                        this.f887h = abstractSerializedData2.readInt32(z2);
                        this.bytes = abstractSerializedData2.readByteArray(z2);
                    }
                    ...
                    public void serializeToStream(AbstractSerializedData abstractSerializedData2) {
                        ...
                        abstractSerializedData2.writeInt32(this.f888w);
                        abstractSerializedData2.writeInt32(this.f887h);
                        abstractSerializedData2.writeByteArray(this.bytes);
                    }
                };
                break;
