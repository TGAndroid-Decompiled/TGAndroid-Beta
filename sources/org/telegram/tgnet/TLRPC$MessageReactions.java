...
public abstract class TLRPC$MessageReactions extends TLObject {
    ...
    public static TLRPC$TL_messageReactions TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        TLRPC$TL_messageReactions tLRPC$TL_messageReactions = i != -1199954735 ? i != 142306870 ? i != 171155211 ? i != 1328256121 ? null : new TLRPC$TL_messageReactions() {
            @Override
        ...
        } : new TLRPC$TL_messageReactions() : new TLRPC$TL_messageReactions() {
            @Override
            public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                int readInt32 = abstractSerializedData2.readInt32(z2);
                this.flags = readInt32;
