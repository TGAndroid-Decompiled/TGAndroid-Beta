...
public class TLRPC$TL_invoice extends TLObject {
    ...
    public static TLRPC$TL_invoice TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        TLRPC$TL_invoice tLRPC$TL_invoice = i != 1048946971 ? i != 1572428309 ? null : new TLRPC$TL_invoice() : new TLRPC$TL_invoice() {
            @Override
            ...
            public void serializeToStream(AbstractSerializedData abstractSerializedData2) {
                ...
                for (int i11 = 0; i11 < size; i11++) {
                    ((TLRPC$TL_labeledPrice) this.prices.get(i11)).serializeToStream(abstractSerializedData2);
                }
                if ((this.flags & 256) != 0) {
                ...
                if ((this.flags & 256) != 0) {
                    ...
                    for (int i12 = 0; i12 < size2; i12++) {
                        abstractSerializedData2.writeInt64(((Long) this.suggested_tip_amounts.get(i12)).longValue());
                    }
                }
                if ((this.flags & 512) != 0) {
    ...
    public void serializeToStream(AbstractSerializedData abstractSerializedData) {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            ((TLRPC$TL_labeledPrice) this.prices.get(i10)).serializeToStream(abstractSerializedData);
        }
        if ((this.flags & 256) != 0) {
        ...
        if ((this.flags & 256) != 0) {
            ...
            for (int i11 = 0; i11 < size2; i11++) {
                abstractSerializedData.writeInt64(((Long) this.suggested_tip_amounts.get(i11)).longValue());
            }
        }
        if ((this.flags & 1024) != 0) {
