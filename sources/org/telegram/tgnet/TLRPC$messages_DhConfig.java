    ...
    public static TLRPC$messages_DhConfig TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        ...
        if (i == -1058912715) {
            ...
            tLRPC$messages_DhConfig = i != 740433629 ? null : new TLRPC$messages_DhConfig() {
                ...
                @Override
                public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                    this.f996g = abstractSerializedData2.readInt32(z2);
                    this.f997p = abstractSerializedData2.readByteArray(z2);
                ...
                public void serializeToStream(AbstractSerializedData abstractSerializedData2) {
                    abstractSerializedData2.writeInt32(constructor);
                    abstractSerializedData2.writeInt32(this.f996g);
                    abstractSerializedData2.writeByteArray(this.f997p);
