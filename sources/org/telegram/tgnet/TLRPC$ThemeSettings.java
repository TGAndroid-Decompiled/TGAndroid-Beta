...
public abstract class TLRPC$ThemeSettings extends TLObject {
    ...
    public static TLRPC$ThemeSettings TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        TLRPC$ThemeSettings tLRPC$TL_themeSettings = i != -1917524116 ? i != -1676371894 ? i != -94849324 ? null : new TLRPC$TL_themeSettings() : new TLRPC$ThemeSettings() {
            @Override
            ...
            public void serializeToStream(AbstractSerializedData abstractSerializedData2) {
                ...
                if ((this.flags & 1) != 0) {
                    abstractSerializedData2.writeInt32(this.message_colors.size() > 1 ? ((Integer) this.message_colors.get(1)).intValue() : 0);
                }
                if ((this.flags & 1) != 0) {
                    abstractSerializedData2.writeInt32(this.message_colors.size() > 0 ? ((Integer) this.message_colors.get(0)).intValue() : 0);
                }
                if ((this.flags & 2) != 0) {
                    this.wallpaper.serializeToStream(abstractSerializedData2);
                }
            }
        } : new TLRPC$ThemeSettings() {
            @Override
            public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
            ...
            public void serializeToStream(AbstractSerializedData abstractSerializedData2) {
                ...
                if ((this.flags & 1) != 0) {
                    ...
                    for (int i3 = 0; i3 < size; i3++) {
                        abstractSerializedData2.writeInt32(((Integer) this.message_colors.get(i3)).intValue());
                    }
                }
                if ((this.flags & 2) != 0) {
                    this.wallpaper.serializeToStream(abstractSerializedData2);
