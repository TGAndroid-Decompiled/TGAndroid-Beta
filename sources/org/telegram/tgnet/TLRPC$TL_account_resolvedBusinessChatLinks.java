...
public class TLRPC$TL_account_resolvedBusinessChatLinks extends TLObject {
    public int flags;
    ...
    public static TLRPC$TL_account_resolvedBusinessChatLinks TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        ...
        TLRPC$TL_account_resolvedBusinessChatLinks tLRPC$TL_account_resolvedBusinessChatLinks = new TLRPC$TL_account_resolvedBusinessChatLinks();
        tLRPC$TL_account_resolvedBusinessChatLinks.readParams(abstractSerializedData, z);
        return tLRPC$TL_account_resolvedBusinessChatLinks;
    }
