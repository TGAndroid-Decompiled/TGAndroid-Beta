...
public abstract class TLRPC$MessageReplies extends TLObject {
    ...
    public static TLRPC$MessageReplies TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        TLRPC$TL_messageReplies tLRPC$TL_messageReplies = i != -2083123262 ? i != 1093204652 ? null : new TLRPC$TL_messageReplies() {
            @Override
            ...
            public void serializeToStream(AbstractSerializedData abstractSerializedData2) {
                ...
                if ((this.flags & 2) != 0) {
                    ...
                    for (int i3 = 0; i3 < size; i3++) {
                        ((TLRPC$Peer) this.recent_repliers.get(i3)).serializeToStream(abstractSerializedData2);
                    }
                }
                if ((this.flags & 1) != 0) {
