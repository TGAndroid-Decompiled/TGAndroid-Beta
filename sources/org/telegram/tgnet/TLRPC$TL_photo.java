    ...
    public void readParams(AbstractSerializedData abstractSerializedData, boolean z) {
        ...
        if (readInt322 == 481674261) {
            ...
            for (int i = 0; i < readInt323; i++) {
                TLRPC$PhotoSize TLdeserialize = TLRPC$PhotoSize.TLdeserialize(this.f871id, 0L, 0L, abstractSerializedData, abstractSerializedData.readInt32(z), z);
            ...
            if ((this.flags & 2) != 0) {
                ...
                if (readInt324 == 481674261) {
                    ...
                    for (int i2 = 0; i2 < readInt325; i2++) {
                        TLRPC$VideoSize TLdeserialize2 = TLRPC$VideoSize.TLdeserialize(this.f871id, 0L, abstractSerializedData, abstractSerializedData.readInt32(z), z);
