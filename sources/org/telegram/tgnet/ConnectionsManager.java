...
public class ConnectionsManager extends BaseController {
    ...
    public ConnectionsManager(int i) throws PackageManager.NameNotFoundException, NumberFormatException {
        String str;
        String str2;
        String str3;
        String str4;
        ...
        init(SharedConfig.buildVersion(), 222, BuildVars.APP_ID, str3, str8, str2, str4, str7, string, FileLog.getNetworkLogPath(), regId, certificateSHA256Fingerprint, rawOffset, getUserConfig().getClientUserId(), getUserConfig().getCurrentUser() != null ? getUserConfig().getCurrentUser().premium : false, zIsPushConnectionEnabled);
    }
    ...
    public boolean isPushConnectionEnabled() throws NumberFormatException {
    ...
    public static void lambda$onUpdate$11(int i) throws InterruptedException, NumberFormatException {
