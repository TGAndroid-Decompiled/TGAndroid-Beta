...
public final class f implements OnSuccessListener, OnFailureListener, ImageReceiver.ImageReceiverDelegate {
    ...
    public void onFailure(Exception exc) {
        ConnectionsManager.lambda$onIntegrityCheckClassic$26(this.f21023a, this.f21024b, this.f21025c, (String) this.d, exc);
    }

    @Override
    public void onSuccess(Object obj) {
        ConnectionsManager.lambda$onIntegrityCheckClassic$25(this.f21023a, this.f21024b, this.f21025c, (String) this.d, (IntegrityTokenResponse) obj);
    }
