...
public abstract class TLRPC$WallPaper extends TLObject {
    ...
    public static TLRPC$WallPaper TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        TLRPC$WallPaper tLRPC$TL_wallPaperNoFile = i != -1963717851 ? i != -1539849235 ? i != -528465642 ? i != -263220756 ? null : new TLRPC$TL_wallPaper() {
            @Override
        ...
        } : new TLRPC$TL_wallPaperNoFile() : new TLRPC$TL_wallPaper() : new TLRPC$TL_wallPaperNoFile() {
            @Override
            public void readParams(AbstractSerializedData abstractSerializedData2, boolean z2) {
                int readInt32 = abstractSerializedData2.readInt32(z2);
                this.flags = readInt32;
