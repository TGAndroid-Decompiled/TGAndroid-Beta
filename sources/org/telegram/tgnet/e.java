...
public final class e implements Utilities.Callback2 {
    ...
    public final void run(Object obj, Object obj2) {
        ...
        switch (this.f18280a) {
            case 0:
                ((ConnectionsManager) this.f18281b).lambda$sendRequestTypedAndProcessUpdates$5((Executor) this.f18282c, (Utilities.Callback2) this.d, (TLRPC.Updates) obj, (TLRPC.TL_error) obj2);
                return;
            case 1:
                TLRPC.Bool bool = (TLRPC.Bool) obj;
                TLRPC.TL_error tL_error = (TLRPC.TL_error) obj2;
                e0.W((e0) this.f18281b, (nf.e) this.f18282c, (TL_aicompose.TL_aiComposeTone) this.d);
                return;
            case 2:
                TLRPC.Bool bool2 = (TLRPC.Bool) obj;
                org.telegram.ui.Components.q.S((org.telegram.ui.Components.q) this.f18281b, (e6) this.f18282c, (TL_aicompose.AiComposeTone) this.d, (TLRPC.TL_error) obj2);
                return;
            case 3:
                TLRPC.Bool bool3 = (TLRPC.Bool) obj;
                TLRPC.TL_error tL_error2 = (TLRPC.TL_error) obj2;
                y.P((y) this.f18281b, (nf.e) this.f18282c, (b2) this.d);
                return;
            case 4:
                d1 d1Var = (d1) this.f18281b;
                da daVar = (da) this.f18282c;
                ...
                return;
            case 5:
                xh.v vVar = (xh.v) this.f18281b;
                f4[] f4VarArr = (f4[]) this.f18282c;
                ...
                if (view instanceof xc) {
                    ...
                    if (text instanceof Spanned) {
                        ...
                        if (ycVarArr.length > 0 && (ycVar = ycVarArr[0]) != null) {
                            int spanStart = spanned.getSpanStart(ycVar);
                            x10 += layout.getPrimaryHorizontal(spanStart) + (ycVarArr[0].a() / 2);
                ...
                f4Var2.f4635l0 = new d4(f4Var2, 1);
            ...
            case 6:
                ...
                return;
            case 7:
                a0.R((a0) this.f18281b, (nf.e) this.f18282c, (b2) this.d, (TLRPC.Updates) obj, (TLRPC.TL_error) obj2);
                return;
            default:
                z3 z3Var = (z3) this.f18281b;
                f4[] f4VarArr2 = (f4[]) this.f18282c;
                ...
                if (view2 instanceof xc) {
                    ...
                    if (text2 instanceof Spanned) {
                        ...
                        if (ycVarArr2.length > 0 && (ycVar2 = ycVarArr2[0]) != null) {
                            int spanStart2 = spanned2.getSpanStart(ycVar2);
                            x11 += layout2.getPrimaryHorizontal(spanStart2) + (ycVarArr2[0].a() / 2);
                ...
                f4Var4.f4635l0 = new d4(f4Var4, 3);
