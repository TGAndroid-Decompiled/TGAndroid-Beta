...
public abstract class TLRPC$Poll extends TLObject {
    ...
    public static TLRPC$Poll TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        TLRPC$TL_poll tLRPC$TL_poll = i != -2032041631 ? i != -1351325818 ? i != -716006138 ? i != 1484026161 ? null : new TLRPC$TL_poll() : new TLRPC$TL_poll() {
            @Override
            ...
            public void serializeToStream(AbstractSerializedData abstractSerializedData2) {
                ...
                for (int i6 = 0; i6 < size; i6++) {
                    ((TLRPC$PollAnswer) this.answers.get(i6)).serializeToStream(abstractSerializedData2);
                }
            }
        } : new TLRPC$TL_poll() {
            @Override
