...
public final class ox extends o41 {
    ...
    public ox(uy uyVar, Context context, ny nyVar, Context context2) {
        ...
        this.V = context2;
        this.f39104e = 0.0f;
        this.f39106n = new AnimationNotificationsLocker();
        this.M = true;
    }
    ...
    public final void d(boolean z10) {
        ty tyVar = this.T;
        tyVar.f40861c.G = true;
        tyVar.d.O(this.T.f40859a, c());
        ty tyVar2 = this.T;
        tyVar2.d.G = false;
        tyVar2.G.G = false;
        uy uyVar = this.W;
        uyVar.A4(false, true);
        this.T.f40859a.setClipChildren(true);
        this.T.f40859a.invalidate();
        this.T.d.l();
        this.T.G.l();
        this.T.f40859a.x1(null, 0.0f, z10);
        uyVar.f41361y = false;
    ...
    public final void e(boolean z10) {
        ...
        if (tyVar.F == null) {
            ...
            ty tyVar2 = this.T;
            int i11 = this.T.f40866s;
            int i12 = uyVar.V2;
            boolean z11 = uyVar.f41296l2;
        ...
        ty tyVar5 = this.T;
        hg.m mVar2 = tyVar5.G;
        mVar2.h = tyVar5.f40866s;
        mVar2.l();
        ty tyVar6 = this.T;
        tyVar6.d.O(tyVar6.f40859a, false);
        ty tyVar7 = this.T;
        tyVar7.d.G = true;
        tyVar7.G.G = true;
        tyVar7.f40861c.H = false;
        uyVar.A4(true, true);
        uyVar.c4(this.S);
        this.T.d.l();
        this.T.G.l();
        ...
        ty tyVar8 = this.T;
        tyVar8.f40859a.x1(tyVar8.F, f7, false);
        this.T.f40859a.setClipChildren(false);
        this.T.f40859a.B0();
        uyVar.D3();
        uyVar.U4();
    }
    ...
    public final void setOpenProgress(float f7) {
        ...
        if (tyVar2 != null && (qyVar = tyVar2.f40859a) != null) {
            qyVar.requestLayout();
        }
