...
public final class ox extends m41 {
    ...
    public ox(uy uyVar, Context context, ny nyVar, Context context2) {
        ...
        this.V = context2;
        this.e = 0.0f;
        this.f35599n = new AnimationNotificationsLocker();
        this.M = true;
    }
    ...
    public final void d(boolean z10) {
        ty tyVar = this.T;
        tyVar.f37906c.G = true;
        tyVar.d.O(this.T.f37904a, c());
        ty tyVar2 = this.T;
        tyVar2.d.G = false;
        tyVar2.G.G = false;
        uy uyVar = this.W;
        uyVar.A4(false, true);
        this.T.f37904a.setClipChildren(true);
        this.T.f37904a.invalidate();
        this.T.d.l();
        this.T.G.l();
        this.T.f37904a.z1(null, 0.0f, z10);
        uyVar.f38356y = false;
    ...
    public final void e(boolean z10) {
        ...
        this.T = tyVar;
        if (tyVar.F == null) {
            tyVar.F = new org.telegram.ui.Components.vl0(this.V, null);
            this.T.F.setLayoutManager(new nx(this, this.T));
            ty tyVar2 = this.T;
            int i11 = this.T.f37910s;
            int i12 = uyVar.V2;
            boolean z11 = uyVar.f38292l2;
        ...
        ty tyVar5 = this.T;
        gg.m mVar2 = tyVar5.G;
        mVar2.h = tyVar5.f37910s;
        mVar2.l();
        ty tyVar6 = this.T;
        tyVar6.d.O(tyVar6.f37904a, false);
        ty tyVar7 = this.T;
        tyVar7.d.G = true;
        tyVar7.G.G = true;
        tyVar7.f37906c.H = false;
        uyVar.A4(true, true);
        uyVar.c4(this.S);
        this.T.d.l();
        this.T.G.l();
        ...
        ty tyVar8 = this.T;
        tyVar8.f37904a.z1(tyVar8.F, f7, false);
        this.T.f37904a.setClipChildren(false);
        this.T.f37904a.C0();
        uyVar.D3();
        uyVar.U4();
    }
    ...
    public final void setOpenProgress(float f7) {
        ...
        if (tyVar2 != null && (qyVar = tyVar2.f37904a) != null) {
            qyVar.requestLayout();
        }
