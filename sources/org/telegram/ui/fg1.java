...
public class fg1 extends org.telegram.ui.ActionBar.o2 implements NotificationCenter.NotificationCenterDelegate, org.telegram.ui.Components.ah, fh0 {
    public static final HashSet f33639n1 = new HashSet();
    public HashSet A0;
    public boolean B0;
    public boolean C0;
    public ai.d7 D0;
    ...
    public final HashSet f33641a0;
    public org.telegram.ui.Components.i81 f33642a1;
    public final ArrayList f33643b;
    public boolean f33644b0;
    public View f33645b1;
    public int f33646c;
    public NumberTextView f33647c0;
    public int f33648c1;
    public mf1 d;
    public org.telegram.ui.ActionBar.w0 f33649d0;
    public int f33650d1;
    public j0 e;
    public org.telegram.ui.ActionBar.w0 f33651e0;
    public int f33652e1;
    public org.telegram.ui.Components.eo f33653f;
    public org.telegram.ui.ActionBar.w0 f33654f0;
    public final ah.i f33655f1;
    public org.telegram.ui.ActionBar.w0 f33656g0;
    public final fh.d f33657g1;
    public org.telegram.ui.Components.y10 h;
    public org.telegram.ui.ActionBar.w0 f33658h0;
    public final fh.d f33659h1;
    public org.telegram.ui.ActionBar.w0 f33660i0;
    public final ah.c f33661i1;
    public org.telegram.ui.ActionBar.g1 f33662j0;
    public ah.o f33663j1;
    public org.telegram.ui.ActionBar.g1 f33664k0;
    public final ArrayList f33665k1;
    public org.telegram.ui.ActionBar.g1 f33666l0;
    public final RectF l1;
    public org.telegram.ui.ActionBar.w0 m0;
    public final RectF f33667m1;
    public vf1 f33668n;
    public RadialProgressView f33669n0;
    public t41 f33670o0;
    public org.telegram.ui.ActionBar.w0 f33671p0;
    public org.telegram.ui.ActionBar.w0 f33672q0;
    public final uf1 f33673r;
    public bg1 f33674r0;
    public final TopicsController f33675s;
    public boolean f33676s0;
    public final boolean f33677t0;
    public final boolean f33678u0;
    public gg1 v;
    public final boolean f33679v0;
    public cx f33680w;
    public final boolean f33681w0;
    public int f33682x;
    public final boolean f33683x0;
    public int f33684y;
    public String f33685y0;
    public boolean f33686z0;

    public fg1(Bundle bundle) {
        super(bundle);
        this.f33643b = new ArrayList();
        new ArrayList();
        this.f33673r = new uf1(this);
        this.f33682x = 0;
        this.E = true;
        this.G = true;
        this.V = true;
        this.W = 0.0f;
        this.f33641a0 = new HashSet();
        this.B0 = false;
        this.O0 = new AnimationNotificationsLocker(new int[]{NotificationCenter.topicsDidLoaded});
        this.S0 = 1.0f;
        new ArrayList();
        ArrayList arrayList = new ArrayList();
        this.f33665k1 = arrayList;
        RectF rectF = new RectF();
        this.l1 = rectF;
        RectF rectF2 = new RectF();
        this.f33667m1 = rectF2;
        arrayList.add(rectF);
        arrayList.add(rectF2);
        long j3 = this.arguments.getLong("chat_id", 0L);
        this.f33640a = j3;
        this.f33677t0 = this.arguments.getBoolean("for_select", false);
        this.f33678u0 = this.arguments.getBoolean("forward_to", false);
        this.f33683x0 = this.arguments.getBoolean("bot_share_to", false);
        this.f33679v0 = this.arguments.getBoolean("quote", false);
        this.f33681w0 = this.arguments.getBoolean("reply_to", false);
        this.f33685y0 = this.arguments.getString("voicechat", null);
        this.f33686z0 = this.arguments.getBoolean("videochat", false);
        this.f33675s = getMessagesController().getTopicsController();
        ...
        if (Build.VERSION.SDK_INT >= 31) {
            this.f33655f1 = new ah.i(false);
            this.f33657g1 = new fh.d(null);
    ...
    public static boolean U(fg1 fg1Var, TLRPC.TL_error tL_error) {
        ...
        edit.putLong("dialog_join_requested_time_" + (-fg1Var.f33640a), System.currentTimeMillis()).commit();
    ...
    public static void V(fg1 fg1Var, View view) {
        ...
        if (fg1Var.getParentLayout() != null && !((ActionBarLayout) fg1Var.getParentLayout()).y() && (view instanceof cg1)) {
            ...
            if (fg1Var.f33677t0) {
                gg1 gg1Var = fg1Var.v;
                if (gg1Var != null) {
                    ig1 ig1Var = gg1Var.f33973a;
                    Bundle bundle = new Bundle();
                    lg1 lg1Var = ig1Var.f34569a;
                    bundle.putLong("dialog_id", lg1Var.f35551c);
                    bundle.putLong("topic_id", tL_forumTopic.f18173id);
                    bundle.putBoolean("exception", true);
                    y11 y11Var = new y11(bundle, null);
                    y11Var.f39773r = new tv0(16, ig1Var, tL_forumTopic);
            ...
            } else if (fg1Var.f33641a0.size() > 0) {
                fg1Var.N0(view);
            } else {
                if (fg1Var.inPreviewMode && AndroidUtilities.isTablet()) {
                    for (org.telegram.ui.ActionBar.o2 o2Var : fg1Var.getParentLayout().getFragmentStack()) {
                        if (o2Var instanceof wy) {
                            wy wyVar2 = (wy) o2Var;
                            if (wyVar2.h4()) {
                                MessagesStorage.TopicKey topicKey = wyVar2.f39276p2;
    ...
    public static boolean W(fg1 fg1Var, View view, float f7) {
        if (fg1Var.f33677t0 || fg1Var.getParentLayout() == null || ((ActionBarLayout) fg1Var.getParentLayout()).y()) {
            return false;
        }
    ...
    public static void X(fg1 fg1Var) {
        ...
        if (u50Var != null && Build.VERSION.SDK_INT >= 23) {
            u50Var.setForeground(new ColorDrawable(i0.a.k(fg1Var.getThemedColor(org.telegram.ui.ActionBar.j6.f18863d6), 100)));
        }
        fg1Var.P0();
    }
    ...
    public static void b0(fg1 fg1Var, boolean z10) {
        ...
        if (fg1Var.f33642a1 == null) {
            org.telegram.ui.Components.i81 n10 = fg1Var.f33674r0.n(8, false);
            fg1Var.f33642a1 = n10;
            if (fg1Var.M0 != null) {
                n10.setBackgroundColor(fg1Var.getThemedColor(org.telegram.ui.ActionBar.j6.f18863d6));
            }
            fg1Var.e.addView(fg1Var.f33642a1, w7.x5.c(44.0f, -1));
        }
        float f10 = fg1Var.W;
        if (z10) {
            f7 = 1.0f;
        ...
        AndroidUtilities.updateViewVisibilityAnimated(fg1Var.f33674r0, false, 1.0f, true);
        wy wyVar = fg1Var.M0;
        if (wyVar != null && (qxVar = wyVar.F3) != null) {
            qxVar.M = !z10;
        }
        if (!z10 && fg1Var.f33674r0.getVisibility() == 0 && fg1Var.f33674r0.getAlpha() == 1.0f) {
            z11 = true;
        } else {
            z11 = false;
        }
        ...
        fg1Var.f33674r0.setVisibility(0);
        if (!z10) {
            fg1Var.f33672q0.setVisibility(0);
        } else {
        ...
        fg1Var.Y0.setInterpolator(org.telegram.ui.Components.qr.f27383f);
        fg1Var.Y0.start();
        NotificationCenter.getGlobalInstance().lambda$postNotificationNameOnUIThread$1(NotificationCenter.needCheckSystemBarColors, Boolean.TRUE);
    }

    public final void A0() {
        this.J0 = this.f33675s.isLoading(this.f33640a);
        if (this.D0 != null) {
            ArrayList arrayList = this.f33643b;
            if (arrayList.size() == 0 || (arrayList.size() == 1 && ((wf1) arrayList.get(0)).f39031c != null && ((wf1) arrayList.get(0)).f39031c.f18173id == 1)) {
    ...
    public final void B0() {
        ...
        int i11 = this.f33652e1 + this.f33648c1;
        if (this.V) {
    ...
    public final void D0(HashSet hashSet, Runnable runnable) {
        ...
        if (hashSet.size() == 1) {
            c2Var.T = LocaleController.formatString(R.string.DeleteSelectedTopic, this.f33675s.findTopic(this.f33640a, ((Integer) arrayList.get(0)).intValue()).title);
        } else {
    ...
    public final void H0(boolean z10) {
        ...
        Bundle bundle = new Bundle();
        bundle.putLong("chat_id", this.f33640a);
        ProfileActivity profileActivity = new ProfileActivity(bundle, this.f33653f.getSharedMediaPreloader());
        profileActivity.K4(this.J);
        if (this.fragmentView.getMeasuredHeight() > this.fragmentView.getMeasuredWidth() && this.f33653f.getAvatarImageView().getImageReceiver().hasImageLoaded() && z10) {
            i10 = 2;
        } else {
            i10 = 1;
        }
    ...
    public final void M0(org.telegram.ui.Cells.r2 r2Var) {
        ...
        if (ChatObject.canDeleteTopic(this.currentAccount, g(), tL_forumTopic)) {
            ...
            g1Var4.setIconColor(getThemedColor(org.telegram.ui.ActionBar.j6.f19083p7));
            g1Var4.setTextColor(getThemedColor(org.telegram.ui.ActionBar.j6.f19101q7));
        ...
        if ((view instanceof cg1) && (tL_forumTopic = (cg1Var = (cg1) view).N) != null) {
            ...
            if (!hashSet.isEmpty()) {
                if (!this.actionBar.a(null)) {
                    ...
                    this.f33647c0 = numberTextView;
                    numberTextView.setTextSize(18);
                    this.f33647c0.setTypeface(AndroidUtilities.bold());
                    this.f33647c0.setTextColor(getThemedColor(org.telegram.ui.ActionBar.j6.f19247y8));
                    j10.addView(this.f33647c0, w7.x5.m(1.0f, 0, -1, 72, 0, 0));
                    this.f33647c0.setOnTouchListener(new gf1(0));
                    this.f33649d0 = j10.g(4, R.drawable.msg_pin, AndroidUtilities.dp(54.0f));
                    this.f33651e0 = j10.g(5, R.drawable.msg_unpin, AndroidUtilities.dp(54.0f));
                    this.f33654f0 = j10.g(6, R.drawable.msg_mute, AndroidUtilities.dp(54.0f));
                    this.f33656g0 = j10.h(7, R.drawable.msg_delete, LocaleController.getString(R.string.Delete), AndroidUtilities.dp(54.0f));
                    ...
                    this.m0 = h11;
                    this.f33662j0 = h11.e(8, R.drawable.msg_markread, LocaleController.getString(R.string.MarkAsRead));
                    this.f33664k0 = this.m0.e(9, R.drawable.msg_topic_close, LocaleController.getString(R.string.CloseTopic));
                    this.f33666l0 = this.m0.e(10, R.drawable.msg_topic_restart, LocaleController.getString(R.string.RestartTopic));
                }
                if (this.inPreviewMode) {
                ...
                if (i20 > 0) {
                    this.f33662j0.setVisibility(0);
                    this.f33662j0.g(LocaleController.getString(R.string.MarkAsRead), R.drawable.msg_markread, null);
                } else {
                    this.f33662j0.setVisibility(8);
                }
                if (i21 != 0) {
                    this.B0 = false;
                    this.f33654f0.setIcon(R.drawable.msg_unmute);
                    this.f33654f0.setContentDescription(LocaleController.getString(R.string.ChatsUnmute));
                    z10 = true;
                } else {
                    z10 = true;
                    this.B0 = true;
                    this.f33654f0.setIcon(R.drawable.msg_mute);
                    this.f33654f0.setContentDescription(LocaleController.getString(R.string.ChatsMute));
                }
                org.telegram.ui.ActionBar.w0 w0Var = this.f33649d0;
                if (i22 == z10 && i23 == 0) {
                    i10 = 0;
                } else {
                    i10 = 8;
                ...
                org.telegram.ui.ActionBar.w0 w0Var2 = this.f33651e0;
                if (i23 == z10 && i22 == 0) {
                    i11 = 0;
                } else {
                    i11 = 8;
                ...
                this.f33647c0.a(hashSet3.size(), z10);
                ...
                org.telegram.ui.ActionBar.g1 g1Var = this.f33664k0;
                if (i24 == 0 && i25 > 0) {
                    i12 = 0;
                } else {
                    i12 = 8;
                ...
                org.telegram.ui.ActionBar.g1 g1Var2 = this.f33664k0;
                if (i25 > 1) {
                ...
                org.telegram.ui.ActionBar.g1 g1Var3 = this.f33666l0;
                if (i25 == 0 && i24 > 0) {
                    i14 = 0;
                } else {
                    i14 = 8;
                ...
                org.telegram.ui.ActionBar.g1 g1Var4 = this.f33666l0;
                if (i24 > 1) {
                ...
                org.telegram.ui.ActionBar.w0 w0Var3 = this.f33656g0;
                ...
                org.telegram.ui.ActionBar.w0 w0Var4 = this.f33658h0;
                ...
                org.telegram.ui.ActionBar.w0 w0Var5 = this.f33660i0;
    ...
    public final void P0() {
        ...
        this.f33674r0.setBackgroundColor(getThemedColor(i10));
    }
    ...
    public final void Q0(boolean z10) {
        ...
        TLRPC.Chat chat = messagesController.getChat(Long.valueOf(j3));
        int i10 = 0;
        if (!ChatObject.isNotInChat(getMessagesController().getChat(Long.valueOf(j3))) && ChatObject.canCreateTopic(chat) && !this.f33676s0 && !this.f33677t0 && !this.J0) {
            z11 = true;
        } else {
            z11 = false;
        }
    ...
    public final void R0() {
        boolean z10;
        if (ChatObject.canManageTopics(g()) && !this.f33641a0.isEmpty()) {
            z10 = true;
        } else {
            z10 = false;
        }
        if (this.f33644b0 != z10) {
            this.f33644b0 = z10;
            uf1 uf1Var = this.f33673r;
            uf1Var.q(0, uf1Var.h());
        }
    }
    ...
    public final void S0(float f7) {
        this.W = f7;
        int themedColor = getThemedColor(org.telegram.ui.ActionBar.j6.f19195v8);
        ...
        this.actionBar.A(i0.a.d(this.W, getThemedColor(org.telegram.ui.ActionBar.j6.f19159t8), getThemedColor(org.telegram.ui.ActionBar.j6.f19266z8)), false);
        if (!this.inPreviewMode) {
            this.actionBar.setBackgroundColor(i0.a.d(this.W, getThemedColor(org.telegram.ui.ActionBar.j6.f19140s8), getThemedColor(org.telegram.ui.ActionBar.j6.f18863d6)));
        }
        float f10 = 1.0f - f7;
        this.f33653f.getTitleTextView().setAlpha(f10);
        this.f33653f.getSubtitleTextView().setAlpha(f10);
        org.telegram.ui.Components.i81 i81Var = this.f33642a1;
        if (i81Var != null) {
            i81Var.setTranslationY((-AndroidUtilities.dp(16.0f)) * f10);
            this.f33642a1.setAlpha(f7);
        }
        this.f33674r0.setTranslationY((-AndroidUtilities.dp(16.0f)) * f10);
        this.f33674r0.setAlpha(f7);
        if (isInPreviewMode()) {
            this.e.invalidate();
        }
        this.d.invalidate();
    ...
    public final void T0() {
        ...
        if (d7Var != null && d7Var.e != null) {
            ...
            TLRPC.TL_forumTopic findTopic = getMessagesController().getTopicsController().findTopic(this.f33640a, 1L);
            if (findTopic != null) {
    ...
    public final void U0(boolean z10, boolean z11) {
        ...
        this.N0 = false;
        TopicsController topicsController = this.f33675s;
        long j3 = this.f33640a;
        ...
        if (topics != null) {
            ...
            arrayList.clear();
            sf1 sf1Var2 = null;
            if (UserObject.isBotForum(this.currentAccount, -j3) && this.f33678u0) {
            ...
            for (int i11 = 0; i11 < arrayList.size(); i11++) {
                ...
                if (wf1Var != null && (tL_forumTopic = wf1Var.f39031c) != null && tL_forumTopic.hidden) {
                    this.f33682x++;
                }
            }
            qf1 qf1Var = this.N;
    ...
    public final View createView(Context context) {
        ...
        mf1Var.setBackgroundColor(getThemedColor(org.telegram.ui.ActionBar.j6.f18863d6));
        ...
        this.actionBar.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view) {
                ...
                switch (r2) {
                    case 0:
                        fg1 fg1Var = this.f32791b;
                        fg1Var.presentFragment(bf1.a0(fg1Var.f33640a, 0L));
                        return;
                    case 1:
                        fg1 fg1Var2 = this.f32791b;
                        fg1Var2.getMessagesController().hidePeerSettingsBar(-fg1Var2.f33640a, null, fg1Var2.g());
                        fg1Var2.O0(false);
                        return;
                    case 2:
                        fg1 fg1Var3 = this.f32791b;
                        if (!fg1Var3.f33676s0) {
                            fg1Var3.H0(false);
                            return;
                        }
                        return;
                    case 3:
                        this.f32791b.finishPreviewFragment();
                        return;
                    default:
                        wy wyVar3 = this.f32791b.M0;
                        if (wyVar3 != null && (w0Var = wyVar3.f39247j0) != null) {
                            w0Var.performClick();
                            return;
                        }
                        return;
        ...
        if (this.M0 != null) {
            ...
            this.f33671p0.setSearchPaddingStart(56);
            this.f33671p0.setSearchFieldHint(LocaleController.getString(R.string.Search));
            EditTextBoldCursor searchField = this.f33671p0.getSearchField();
        ...
        this.f33672q0.e(1, R.drawable.msg_discussion, LocaleController.getString(R.string.TopicViewAsMessages));
        this.R = this.f33672q0.e(2, R.drawable.msg_addcontact, LocaleController.getString(R.string.AddMember));
        org.telegram.ui.ActionBar.w0 w0Var = this.f33672q0;
        ...
        this.Q = this.f33672q0.e(3, R.drawable.msg_topic_create, LocaleController.getString(R.string.CreateTopic));
        this.U = this.f33672q0.e(15, R.drawable.msg_report, LocaleController.getString(R.string.ReportChat));
        this.S = this.f33672q0.f(11, R.drawable.msg_leave, LocaleController.getString(R.string.LeaveMegaMenu), null);
        ...
        org.telegram.ui.Components.eo eoVar2 = this.f33653f;
        if (!AndroidUtilities.isTablet() && !this.inPreviewMode) {
            z11 = true;
        } else {
            z11 = false;
        ...
        org.telegram.ui.Components.eo eoVar3 = this.f33653f;
        long j3 = -this.f33640a;
        if (j3 < 0) {
            z12 = true;
        } else {
        ...
        this.actionBar.addView(this.f33653f, 0, w7.x5.d(-2, -1.0f, 51, 56.0f, 0.0f, 86.0f, 0.0f));
        if (!this.f33677t0) {
            this.f33653f.getAvatarImageView().setOnClickListener(new a8(this, 3));
        }
        this.N = new qf1(this, context);
        hh.k kVar2 = new hh.k(this.d);
        ViewGroup viewGroup = this.d;
        ah.c cVar = this.f33661i1;
        cVar.f425f = kVar2;
        ...
        this.f33663j1 = new ah.o(qf1Var, viewGroup, new x8(qf1Var2, 2));
        ...
        new SparseArray();
        new HashMap();
        this.N.setAdapter(this.f33673r);
            ...
            public final void onClick(View view) {
                ...
                switch (r2) {
                    ...
                    case 3:
                        ...
                        return;
                    default:
                        wy wyVar32 = this.f32791b.M0;
                        if (wyVar32 != null && (w0Var2 = wyVar32.f39247j0) != null) {
                            w0Var2.performClick();
                            return;
                        }
                        return;
        ...
        this.h.f30078c.setImageResource(R.drawable.ic_chatlist_add_2);
        this.h.f30078c.setScaleType(ImageView.ScaleType.CENTER_INSIDE);
        this.h.f30078c.setPadding(AndroidUtilities.dp(12.0f), AndroidUtilities.dp(12.0f), AndroidUtilities.dp(12.0f), AndroidUtilities.dp(12.0f));
        ...
        textView.setTextColor(getThemedColor(org.telegram.ui.ActionBar.j6.f19245y6));
        ...
        this.f33668n = frameLayout;
        textView.setAlpha(0.0f);
        ai.d7 d7Var = new ai.d7(this, context, t00Var);
        this.D0 = d7Var;
        try {
            d7Var.f30676b.getImageReceiver().setAutoRepeat(2);
        } catch (Exception unused) {
        }
        this.D0.e(this.J0, this.fragmentBeginToShow);
        this.D0.d.setText(LocaleController.getString(R.string.NoTopics));
        T0();
        this.f33668n.addView(t00Var);
        this.f33668n.addView(this.D0);
        this.d.addView(this.f33668n);
        this.N.setEmptyView(this.f33668n);
        this.f33670o0 = new t41(context, 7);
        org.telegram.ui.Components.h61 h61Var = new org.telegram.ui.Components.h61(context);
        this.L = h61Var;
        this.f33670o0.addView(h61Var);
        this.d.addView(this.f33670o0, w7.x5.e(-1, 51, 80));
        this.L.setOnClickListener(new kf1(this));
        RadialProgressView radialProgressView = new RadialProgressView(context, null);
        this.f33669n0 = radialProgressView;
        radialProgressView.setSize(AndroidUtilities.dp(22.0f));
        this.f33669n0.setVisibility(4);
        this.f33670o0.addView(this.f33669n0, w7.x5.e(30, 30, 17));
        ImageView imageView = new ImageView(context);
        this.W0 = imageView;
        imageView.setImageResource(R.drawable.miniplayer_close);
        this.W0.setContentDescription(LocaleController.getString(R.string.Close));
        ImageView imageView2 = this.W0;
        int i13 = org.telegram.ui.ActionBar.j6.f18871de;
        ...
        this.f33670o0.addView(this.W0, w7.x5.d(36, 36.0f, 53, 0.0f, 6.0f, 2.0f, 0.0f));
        ...
        this.f33674r0 = bg1Var;
        bg1Var.setVisibility(8);
        this.e.addView(this.f33674r0, w7.x5.d(-1, -1.0f, 119, 0.0f, 44.0f, 0.0f, 0.0f));
        bg1 bg1Var2 = this.f33674r0;
        ...
        getMessagesStorage().loadChatInfo(this.f33640a, true, null, true, false, 0);
        ...
        if (g10 != null) {
            ...
            this.U0.g(this.R0.c());
            wh.d dVar2 = this.R0;
            dVar2.f45111m = new ef1(this);
            TLRPC.ChatFull chatFull = this.J;
            dVar2.f45108j = chatFull;
            if (chatFull != null) {
        ...
        if (this.inPreviewMode && AndroidUtilities.isTablet()) {
            ...
            while (true) {
                ...
                if (o2Var instanceof wy) {
                    wy wyVar4 = (wy) o2Var;
                    if (wyVar4.h4()) {
                        MessagesStorage.TopicKey topicKey = wyVar4.f39276p2;
    ...
    public final TLRPC.Chat g() {
        return getMessagesController().getChat(Long.valueOf(this.f33640a));
    }
    ...
    public final boolean isLightStatusBar() {
        ...
        if (this.actionBar.s()) {
            themedColor = getThemedColor(org.telegram.ui.ActionBar.j6.f19213w8);
        }
    ...
    public final boolean onBackPressed(boolean z10) {
        if (!this.f33641a0.isEmpty()) {
            if (z10) {
                C0();
                return false;
            }
        } else if (this.f33676s0) {
            if (z10) {
                this.actionBar.v(this.f33671p0.L(false));
            }
        } else {
    ...
    public final void onFragmentDestroy() {
        ...
        TLRPC.Chat chat = getMessagesController().getChat(Long.valueOf(this.f33640a));
        if (ChatObject.isChannel(chat)) {
    ...
    public final void onPause() {
        super.onPause();
        getMessagesController().getTopicsController().onTopicFragmentPause(this.f33640a);
    ...
    public final void setPreviewOpenedProgress(float f7) {
        org.telegram.ui.Components.eo eoVar = this.f33653f;
        if (eoVar != null) {
            eoVar.setAlpha(f7);
            this.f33672q0.setAlpha(f7);
            org.telegram.ui.ActionBar.w0 w0Var = this.f33671p0;
            if (w0Var != null) {
                w0Var.setAlpha(f7);
            }
    ...
    public final void setPreviewReplaceProgress(float f7) {
        ...
        if (eoVar != null) {
            eoVar.setAlpha(f7);
            this.f33653f.setTranslationX((1.0f - f7) * AndroidUtilities.dp(40.0f));
        }
    }

    @Override
    public final fh.d x() {
        return this.f33659h1;
    }
    ...
    public final void x0() {
        ...
        float f7;
        int i10;
        if (Build.VERSION.SDK_INT >= 31 && (iVar = this.f33655f1) != null) {
            ...
            int measuredHeight = (view.getMeasuredHeight() - this.f33652e1) - AndroidUtilities.dp(8.0f);
            this.l1.set(0.0f, -dp, view.getMeasuredWidth(), kVar.getMeasuredHeight() + dp + dp2);
            RectF rectF = this.f33667m1;
            ...
            iVar.g(i10, this.f33665k1);
            iVar.e(this.f33663j1, view.getMeasuredWidth(), view.getMeasuredHeight());
        }
    }
    ...
    public final void y0() {
        ...
        if (!topicsController.endIsReached(j3) && (hf1Var = this.F) != null) {
            int N0 = hf1Var.N0();
            if (this.f33643b.isEmpty() || N0 >= this.f33673r.h() - 5) {
    ...
    public final void z0(boolean z10) {
        ...
        ChatObject.Call call = this.H0;
        if (call != null && ((str = this.f33685y0) != null || this.f33686z0)) {
            ...
            this.f33685y0 = null;
            this.f33686z0 = false;
        } else if (this.f33685y0 != null && z10 && chatFull != null && chatFull.call == null && this.fragmentView != null && getParentActivity() != null) {
