...
public class fg1 extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate, org.telegram.ui.Components.bh, fh0 {
    public static final HashSet f33595n1 = new HashSet();
    public HashSet A0;
    public boolean B0;
    public boolean C0;
    public ai.d7 D0;
    ...
    public final HashSet f33597a0;
    public org.telegram.ui.Components.w81 f33598a1;
    public final ArrayList f33599b;
    public boolean f33600b0;
    public View f33601b1;
    public int f33602c;
    public NumberTextView f33603c0;
    public int f33604c1;
    public mf1 d;
    public org.telegram.ui.ActionBar.v0 f33605d0;
    public int f33606d1;
    public j0 e;
    public org.telegram.ui.ActionBar.v0 f33607e0;
    public int f33608e1;
    public org.telegram.ui.Components.eo f33609f;
    public org.telegram.ui.ActionBar.v0 f33610f0;
    public final ah.i f33611f1;
    public org.telegram.ui.ActionBar.v0 f33612g0;
    public final fh.d f33613g1;
    public org.telegram.ui.Components.y10 h;
    public org.telegram.ui.ActionBar.v0 f33614h0;
    public final fh.d f33615h1;
    public org.telegram.ui.ActionBar.v0 f33616i0;
    public final ah.c f33617i1;
    public org.telegram.ui.ActionBar.f1 f33618j0;
    public ah.o f33619j1;
    public org.telegram.ui.ActionBar.f1 f33620k0;
    public final ArrayList f33621k1;
    public org.telegram.ui.ActionBar.f1 f33622l0;
    public final RectF l1;
    public org.telegram.ui.ActionBar.v0 m0;
    public final RectF f33623m1;
    public vf1 f33624n;
    public RadialProgressView f33625n0;
    public u41 f33626o0;
    public org.telegram.ui.ActionBar.v0 f33627p0;
    public org.telegram.ui.ActionBar.v0 f33628q0;
    public final uf1 f33629r;
    public bg1 f33630r0;
    public final TopicsController f33631s;
    public boolean f33632s0;
    public final boolean f33633t0;
    public final boolean f33634u0;
    public gg1 v;
    public final boolean f33635v0;
    public ax f33636w;
    public final boolean f33637w0;
    public int f33638x;
    public final boolean f33639x0;
    public int f33640y;
    public String f33641y0;
    public boolean f33642z0;

    public fg1(Bundle bundle) {
        super(bundle);
        this.f33599b = new ArrayList();
        new ArrayList();
        this.f33629r = new uf1(this);
        this.f33638x = 0;
        this.E = true;
        this.G = true;
        this.V = true;
        this.W = 0.0f;
        this.f33597a0 = new HashSet();
        this.B0 = false;
        this.O0 = new AnimationNotificationsLocker(new int[]{NotificationCenter.topicsDidLoaded});
        this.S0 = 1.0f;
        new ArrayList();
        ArrayList arrayList = new ArrayList();
        this.f33621k1 = arrayList;
        RectF rectF = new RectF();
        this.l1 = rectF;
        RectF rectF2 = new RectF();
        this.f33623m1 = rectF2;
        arrayList.add(rectF);
        arrayList.add(rectF2);
        long j3 = this.arguments.getLong("chat_id", 0L);
        this.f33596a = j3;
        this.f33633t0 = this.arguments.getBoolean("for_select", false);
        this.f33634u0 = this.arguments.getBoolean("forward_to", false);
        this.f33639x0 = this.arguments.getBoolean("bot_share_to", false);
        this.f33635v0 = this.arguments.getBoolean("quote", false);
        this.f33637w0 = this.arguments.getBoolean("reply_to", false);
        this.f33641y0 = this.arguments.getString("voicechat", null);
        this.f33642z0 = this.arguments.getBoolean("videochat", false);
        this.f33631s = getMessagesController().getTopicsController();
        ...
        if (Build.VERSION.SDK_INT >= 31) {
            this.f33611f1 = new ah.i(false);
            this.f33613g1 = new fh.d(null);
    ...
    public static boolean U(fg1 fg1Var, TLRPC.TL_error tL_error) {
        ...
        edit.putLong("dialog_join_requested_time_" + (-fg1Var.f33596a), System.currentTimeMillis()).commit();
    ...
    public static void V(fg1 fg1Var, View view) {
        ...
        if (fg1Var.getParentLayout() != null && !((ActionBarLayout) fg1Var.getParentLayout()).y() && (view instanceof cg1)) {
            ...
            if (tL_forumTopic == null) {
                ...
                j3 = tL_forumTopic.f18380id;
            }
            long j12 = j3;
            if (fg1Var.f33633t0) {
                gg1 gg1Var = fg1Var.v;
                if (gg1Var != null) {
                    ig1 ig1Var = gg1Var.f33885a;
                    Bundle bundle = new Bundle();
                    lg1 lg1Var = ig1Var.f34562a;
                    bundle.putLong("dialog_id", lg1Var.f35444c);
                    bundle.putLong("topic_id", tL_forumTopic.f18380id);
                    bundle.putBoolean("exception", true);
                    w11 w11Var = new w11(bundle, null);
                    w11Var.f38651r = new rv0(17, ig1Var, tL_forumTopic);
            ...
            } else if (fg1Var.f33597a0.size() > 0) {
                fg1Var.N0(view);
            } else {
                if (fg1Var.inPreviewMode && AndroidUtilities.isTablet()) {
                    for (org.telegram.ui.ActionBar.n2 n2Var : fg1Var.getParentLayout().getFragmentStack()) {
                        if (n2Var instanceof uy) {
                            uy uyVar2 = (uy) n2Var;
                            if (uyVar2.h4()) {
                                MessagesStorage.TopicKey topicKey = uyVar2.f38311p2;
    ...
    public static boolean W(fg1 fg1Var, View view, float f7) {
        if (fg1Var.f33633t0 || fg1Var.getParentLayout() == null || ((ActionBarLayout) fg1Var.getParentLayout()).y()) {
            return false;
        }
    ...
    public static void X(fg1 fg1Var) {
        ...
        if (s50Var != null && Build.VERSION.SDK_INT >= 23) {
            s50Var.setForeground(new ColorDrawable(i0.a.k(fg1Var.getThemedColor(org.telegram.ui.ActionBar.j6.f19094d6), 100)));
        }
        fg1Var.P0();
    }
    ...
    public static void b0(fg1 fg1Var, boolean z10) {
        ...
        if (fg1Var.f33598a1 == null) {
            org.telegram.ui.Components.w81 n10 = fg1Var.f33630r0.n(8, false);
            fg1Var.f33598a1 = n10;
            if (fg1Var.M0 != null) {
                n10.setBackgroundColor(fg1Var.getThemedColor(org.telegram.ui.ActionBar.j6.f19094d6));
            }
            fg1Var.e.addView(fg1Var.f33598a1, w7.y5.c(44.0f, -1));
        }
        float f10 = fg1Var.W;
        if (z10) {
            f7 = 1.0f;
        ...
        AndroidUtilities.updateViewVisibilityAnimated(fg1Var.f33630r0, false, 1.0f, true);
        uy uyVar = fg1Var.M0;
        if (uyVar != null && (oxVar = uyVar.F3) != null) {
            oxVar.M = !z10;
        }
        if (!z10 && fg1Var.f33630r0.getVisibility() == 0 && fg1Var.f33630r0.getAlpha() == 1.0f) {
            z11 = true;
        } else {
            z11 = false;
        }
        ...
        fg1Var.f33630r0.setVisibility(0);
        if (!z10) {
            fg1Var.f33628q0.setVisibility(0);
        } else {
        ...
        fg1Var.Y0.setInterpolator(org.telegram.ui.Components.qr.f27642f);
        fg1Var.Y0.start();
        NotificationCenter.getGlobalInstance().lambda$postNotificationNameOnUIThread$1(NotificationCenter.needCheckSystemBarColors, Boolean.TRUE);
    }

    public final void A0() {
        this.J0 = this.f33631s.isLoading(this.f33596a);
        if (this.D0 != null) {
            ArrayList arrayList = this.f33599b;
            if (arrayList.size() == 0 || (arrayList.size() == 1 && ((wf1) arrayList.get(0)).f39142c != null && ((wf1) arrayList.get(0)).f39142c.f18380id == 1)) {
    ...
    public final void B0() {
        ...
        if (uyVar != null) {
            ...
            if (ksVar2 != null) {
                ...
                if (ksVar3 != null) {
                    f10 = ksVar3.getMetadata().f14185c.f14193a;
                } else {
                    f10 = 0.0f;
                }
                ...
                if (ksVar5 != null) {
                    f11 = ksVar5.getMetadata().f14185c.f14193a;
                }
        ...
        int i11 = this.f33608e1 + this.f33604c1;
        if (this.V) {
    ...
    public final void D0(HashSet hashSet, Runnable runnable) {
        ...
        if (hashSet.size() == 1) {
            b2Var.T = LocaleController.formatString(R.string.DeleteSelectedTopic, this.f33631s.findTopic(this.f33596a, ((Integer) arrayList.get(0)).intValue()).title);
        } else {
    ...
    public final void H0(boolean z10) {
        ...
        Bundle bundle = new Bundle();
        bundle.putLong("chat_id", this.f33596a);
        ProfileActivity profileActivity = new ProfileActivity(bundle, this.f33609f.getSharedMediaPreloader());
        profileActivity.K4(this.J);
        if (this.fragmentView.getMeasuredHeight() > this.fragmentView.getMeasuredWidth() && this.f33609f.getAvatarImageView().getImageReceiver().hasImageLoaded() && z10) {
            i10 = 2;
        } else {
            i10 = 1;
        }
    ...
    public final void M0(org.telegram.ui.Cells.s2 s2Var) {
        ...
        int b10 = r32[0].b(poVar.f27403f);
        poVar.f27411o = 1;
        long j10 = this.f33596a;
        long j11 = -j10;
        poVar.d(j11, tL_forumTopic.f18380id, null);
        if (ChatObject.canManageTopics(g())) {
            ...
            f1Var.setOnClickListener(new View.OnClickListener(this) {
                ...
                public final void onClick(View view) {
                    switch (r3) {
                        case 0:
                            fg1 fg1Var = this.f33589b;
                            fg1Var.C0 = true;
                            fg1Var.N0 = true;
                            TopicsController topicsController = fg1Var.f33631s;
                            long j12 = fg1Var.f33596a;
                            TLRPC.TL_forumTopic tL_forumTopic2 = tL_forumTopic;
                            topicsController.pinTopic(j12, tL_forumTopic2.f18380id, !tL_forumTopic2.pinned, fg1Var);
                            fg1Var.finishPreviewFragment();
                            return;
                        case 1:
                            fg1 fg1Var2 = this.f33589b;
                            fg1Var2.N0 = true;
                            TopicsController topicsController2 = fg1Var2.f33631s;
                            long j13 = fg1Var2.f33596a;
                            TLRPC.TL_forumTopic tL_forumTopic3 = tL_forumTopic;
                            topicsController2.toggleCloseTopic(j13, tL_forumTopic3.f18380id, true ^ tL_forumTopic3.closed);
                            fg1Var2.finishPreviewFragment();
                            return;
                        default:
                            HashSet hashSet = new HashSet();
                            hashSet.add(Integer.valueOf(tL_forumTopic.f18380id));
                            fg1 fg1Var3 = this.f33589b;
        ...
        if (getMessagesController().isDialogMuted(j11, tL_forumTopic.f18380id)) {
        ...
        if (ChatObject.canDeleteTopic(this.currentAccount, g(), tL_forumTopic)) {
            ...
            f1Var4.setIconColor(getThemedColor(org.telegram.ui.ActionBar.j6.f19315p7));
            f1Var4.setTextColor(getThemedColor(org.telegram.ui.ActionBar.j6.f19333q7));
        ...
        if ((view instanceof cg1) && (tL_forumTopic = (cg1Var = (cg1) view).N) != null) {
            ...
            if (!hashSet.isEmpty()) {
                if (!this.actionBar.a(null)) {
                    ...
                    this.f33603c0 = numberTextView;
                    numberTextView.setTextSize(18);
                    this.f33603c0.setTypeface(AndroidUtilities.bold());
                    this.f33603c0.setTextColor(getThemedColor(org.telegram.ui.ActionBar.j6.f19479y8));
                    j10.addView(this.f33603c0, w7.y5.m(1.0f, 0, -1, 72, 0, 0));
                    this.f33603c0.setOnTouchListener(new gf1(0));
                    this.f33605d0 = j10.g(4, R.drawable.msg_pin, AndroidUtilities.dp(54.0f));
                    this.f33607e0 = j10.g(5, R.drawable.msg_unpin, AndroidUtilities.dp(54.0f));
                    this.f33610f0 = j10.g(6, R.drawable.msg_mute, AndroidUtilities.dp(54.0f));
                    this.f33612g0 = j10.h(7, R.drawable.msg_delete, LocaleController.getString(R.string.Delete), AndroidUtilities.dp(54.0f));
                    ...
                    this.m0 = h11;
                    this.f33618j0 = h11.e(8, R.drawable.msg_markread, LocaleController.getString(R.string.MarkAsRead));
                    this.f33620k0 = this.m0.e(9, R.drawable.msg_topic_close, LocaleController.getString(R.string.CloseTopic));
                    this.f33622l0 = this.m0.e(10, R.drawable.msg_topic_restart, LocaleController.getString(R.string.RestartTopic));
                }
                if (this.inPreviewMode) {
                ...
                if (i20 > 0) {
                    this.f33618j0.setVisibility(0);
                    this.f33618j0.g(LocaleController.getString(R.string.MarkAsRead), R.drawable.msg_markread, null);
                } else {
                    this.f33618j0.setVisibility(8);
                }
                if (i21 != 0) {
                    this.B0 = false;
                    this.f33610f0.setIcon(R.drawable.msg_unmute);
                    this.f33610f0.setContentDescription(LocaleController.getString(R.string.ChatsUnmute));
                    z10 = true;
                } else {
                    z10 = true;
                    this.B0 = true;
                    this.f33610f0.setIcon(R.drawable.msg_mute);
                    this.f33610f0.setContentDescription(LocaleController.getString(R.string.ChatsMute));
                }
                org.telegram.ui.ActionBar.v0 v0Var = this.f33605d0;
                if (i22 == z10 && i23 == 0) {
                    i10 = 0;
                } else {
                    i10 = 8;
                ...
                org.telegram.ui.ActionBar.v0 v0Var2 = this.f33607e0;
                if (i23 == z10 && i22 == 0) {
                    i11 = 0;
                } else {
                    i11 = 8;
                ...
                this.f33603c0.a(hashSet3.size(), z10);
                ...
                org.telegram.ui.ActionBar.f1 f1Var = this.f33620k0;
                if (i24 == 0 && i25 > 0) {
                    i12 = 0;
                } else {
                    i12 = 8;
                ...
                org.telegram.ui.ActionBar.f1 f1Var2 = this.f33620k0;
                if (i25 > 1) {
                ...
                org.telegram.ui.ActionBar.f1 f1Var3 = this.f33622l0;
                if (i25 == 0 && i24 > 0) {
                    i14 = 0;
                } else {
                    i14 = 8;
                ...
                org.telegram.ui.ActionBar.f1 f1Var4 = this.f33622l0;
                if (i24 > 1) {
                ...
                org.telegram.ui.ActionBar.v0 v0Var3 = this.f33612g0;
                ...
                org.telegram.ui.ActionBar.v0 v0Var4 = this.f33614h0;
                ...
                org.telegram.ui.ActionBar.v0 v0Var5 = this.f33616i0;
    ...
    public final void P0() {
        ...
        this.f33630r0.setBackgroundColor(getThemedColor(i10));
    }
    ...
    public final void Q0(boolean z10) {
        ...
        TLRPC.Chat chat = messagesController.getChat(Long.valueOf(j3));
        int i10 = 0;
        if (!ChatObject.isNotInChat(getMessagesController().getChat(Long.valueOf(j3))) && ChatObject.canCreateTopic(chat) && !this.f33632s0 && !this.f33633t0 && !this.J0) {
            z11 = true;
        } else {
            z11 = false;
        }
    ...
    public final void R0() {
        boolean z10;
        if (ChatObject.canManageTopics(g()) && !this.f33597a0.isEmpty()) {
            z10 = true;
        } else {
            z10 = false;
        }
        if (this.f33600b0 != z10) {
            this.f33600b0 = z10;
            uf1 uf1Var = this.f33629r;
            uf1Var.q(0, uf1Var.h());
        }
    }
    ...
    public final void S0(float f7) {
        this.W = f7;
        int themedColor = getThemedColor(org.telegram.ui.ActionBar.j6.f19427v8);
        ...
        this.actionBar.A(i0.a.d(this.W, getThemedColor(org.telegram.ui.ActionBar.j6.f19391t8), getThemedColor(org.telegram.ui.ActionBar.j6.f19498z8)), false);
        if (!this.inPreviewMode) {
            this.actionBar.setBackgroundColor(i0.a.d(this.W, getThemedColor(org.telegram.ui.ActionBar.j6.f19372s8), getThemedColor(org.telegram.ui.ActionBar.j6.f19094d6)));
        }
        float f10 = 1.0f - f7;
        this.f33609f.getTitleTextView().setAlpha(f10);
        this.f33609f.getSubtitleTextView().setAlpha(f10);
        org.telegram.ui.Components.w81 w81Var = this.f33598a1;
        if (w81Var != null) {
            w81Var.setTranslationY((-AndroidUtilities.dp(16.0f)) * f10);
            this.f33598a1.setAlpha(f7);
        }
        this.f33630r0.setTranslationY((-AndroidUtilities.dp(16.0f)) * f10);
        this.f33630r0.setAlpha(f7);
        if (isInPreviewMode()) {
            this.e.invalidate();
        }
        this.d.invalidate();
    ...
    public final void T0() {
        ...
        if (d7Var != null && d7Var.e != null) {
            ...
            TLRPC.TL_forumTopic findTopic = getMessagesController().getTopicsController().findTopic(this.f33596a, 1L);
            if (findTopic != null) {
    ...
    public final void U0(boolean z10, boolean z11) {
        ...
        this.N0 = false;
        TopicsController topicsController = this.f33631s;
        long j3 = this.f33596a;
        ...
        if (topics != null) {
            ...
            arrayList.clear();
            sf1 sf1Var2 = null;
            if (UserObject.isBotForum(this.currentAccount, -j3) && this.f33634u0) {
                arrayList.add(new wf1(3, null));
            }
            for (int i10 = 0; i10 < topics.size(); i10++) {
                HashSet hashSet = this.A0;
                if (hashSet == null || !hashSet.contains(Integer.valueOf(topics.get(i10).f18380id))) {
            ...
            for (int i11 = 0; i11 < arrayList.size(); i11++) {
                ...
                if (wf1Var != null && (tL_forumTopic = wf1Var.f39142c) != null && tL_forumTopic.hidden) {
                    this.f33638x++;
                }
            }
            qf1 qf1Var = this.N;
    ...
    public final View createView(Context context) {
        ...
        mf1Var.setBackgroundColor(getThemedColor(org.telegram.ui.ActionBar.j6.f19094d6));
        ...
        this.actionBar.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view) {
                ...
                switch (r2) {
                    case 0:
                        fg1 fg1Var = this.f32745b;
                        fg1Var.presentFragment(bf1.a0(fg1Var.f33596a, 0L));
                        return;
                    case 1:
                        fg1 fg1Var2 = this.f32745b;
                        fg1Var2.getMessagesController().hidePeerSettingsBar(-fg1Var2.f33596a, null, fg1Var2.g());
                        fg1Var2.O0(false);
                        return;
                    case 2:
                        fg1 fg1Var3 = this.f32745b;
                        if (!fg1Var3.f33632s0) {
                            fg1Var3.H0(false);
                            return;
                        }
                        return;
                    case 3:
                        this.f32745b.finishPreviewFragment();
                        return;
                    default:
                        uy uyVar3 = this.f32745b.M0;
                        if (uyVar3 != null && (v0Var = uyVar3.f38282j0) != null) {
                            v0Var.performClick();
                            return;
                        }
                        return;
        ...
        if (this.M0 != null) {
            ...
            this.f33627p0.setSearchPaddingStart(56);
            this.f33627p0.setSearchFieldHint(LocaleController.getString(R.string.Search));
            EditTextBoldCursor searchField = this.f33627p0.getSearchField();
        ...
        this.f33628q0.e(1, R.drawable.msg_discussion, LocaleController.getString(R.string.TopicViewAsMessages));
        this.R = this.f33628q0.e(2, R.drawable.msg_addcontact, LocaleController.getString(R.string.AddMember));
        org.telegram.ui.ActionBar.v0 v0Var = this.f33628q0;
        ...
        this.Q = this.f33628q0.e(3, R.drawable.msg_topic_create, LocaleController.getString(R.string.CreateTopic));
        this.U = this.f33628q0.e(15, R.drawable.msg_report, LocaleController.getString(R.string.ReportChat));
        this.S = this.f33628q0.f(11, R.drawable.msg_leave, LocaleController.getString(R.string.LeaveMegaMenu), null);
        ...
        org.telegram.ui.Components.eo eoVar2 = this.f33609f;
        if (!AndroidUtilities.isTablet() && !this.inPreviewMode) {
            z11 = true;
        } else {
            z11 = false;
        ...
        org.telegram.ui.Components.eo eoVar3 = this.f33609f;
        long j3 = -this.f33596a;
        if (j3 < 0) {
            z12 = true;
        } else {
        ...
        this.actionBar.addView(this.f33609f, 0, w7.y5.d(-2, -1.0f, 51, 56.0f, 0.0f, 86.0f, 0.0f));
        if (!this.f33633t0) {
            this.f33609f.getAvatarImageView().setOnClickListener(new z7(this, 3));
        }
        this.N = new qf1(this, context);
        hh.k kVar2 = new hh.k(this.d);
        ViewGroup viewGroup = this.d;
        ah.c cVar = this.f33617i1;
        cVar.f425f = kVar2;
        ...
        this.f33619j1 = new ah.o(qf1Var, viewGroup, new w8(qf1Var2, 2));
        ...
        new SparseArray();
        new HashMap();
        this.N.setAdapter(this.f33629r);
            ...
            public final void onClick(View view) {
                ...
                switch (r2) {
                    ...
                    case 3:
                        ...
                        return;
                    default:
                        uy uyVar32 = this.f32745b.M0;
                        if (uyVar32 != null && (v0Var2 = uyVar32.f38282j0) != null) {
                            v0Var2.performClick();
                            return;
                        }
                        return;
        ...
        this.h.f30430c.setImageResource(R.drawable.ic_chatlist_add_2);
        this.h.f30430c.setScaleType(ImageView.ScaleType.CENTER_INSIDE);
        this.h.f30430c.setPadding(AndroidUtilities.dp(12.0f), AndroidUtilities.dp(12.0f), AndroidUtilities.dp(12.0f), AndroidUtilities.dp(12.0f));
        ...
        textView.setTextColor(getThemedColor(org.telegram.ui.ActionBar.j6.f19477y6));
        ...
        this.f33624n = frameLayout;
        textView.setAlpha(0.0f);
        ai.d7 d7Var = new ai.d7(this, context, t00Var);
        this.D0 = d7Var;
        try {
            d7Var.f25549b.getImageReceiver().setAutoRepeat(2);
        } catch (Exception unused) {
        }
        this.D0.e(this.J0, this.fragmentBeginToShow);
        this.D0.d.setText(LocaleController.getString(R.string.NoTopics));
        T0();
        this.f33624n.addView(t00Var);
        this.f33624n.addView(this.D0);
        this.d.addView(this.f33624n);
        this.N.setEmptyView(this.f33624n);
        this.f33626o0 = new u41(context, 7);
        org.telegram.ui.Components.u61 u61Var = new org.telegram.ui.Components.u61(context);
        this.L = u61Var;
        this.f33626o0.addView(u61Var);
        this.d.addView(this.f33626o0, w7.y5.e(-1, 51, 80));
        this.L.setOnClickListener(new kf1(this));
        RadialProgressView radialProgressView = new RadialProgressView(context, null);
        this.f33625n0 = radialProgressView;
        radialProgressView.setSize(AndroidUtilities.dp(22.0f));
        this.f33625n0.setVisibility(4);
        this.f33626o0.addView(this.f33625n0, w7.y5.e(30, 30, 17));
        ImageView imageView = new ImageView(context);
        this.W0 = imageView;
        imageView.setImageResource(R.drawable.miniplayer_close);
        this.W0.setContentDescription(LocaleController.getString(R.string.Close));
        ImageView imageView2 = this.W0;
        int i13 = org.telegram.ui.ActionBar.j6.f19102de;
        ...
        this.f33626o0.addView(this.W0, w7.y5.d(36, 36.0f, 53, 0.0f, 6.0f, 2.0f, 0.0f));
        ...
        this.f33630r0 = bg1Var;
        bg1Var.setVisibility(8);
        this.e.addView(this.f33630r0, w7.y5.d(-1, -1.0f, 119, 0.0f, 44.0f, 0.0f, 0.0f));
        bg1 bg1Var2 = this.f33630r0;
        ...
        getMessagesStorage().loadChatInfo(this.f33596a, true, null, true, false, 0);
        ...
        if (g10 != null) {
            ...
            this.U0.g(this.R0.c());
            wh.d dVar2 = this.R0;
            dVar2.f45378m = new ef1(this);
            TLRPC.ChatFull chatFull = this.J;
            dVar2.f45375j = chatFull;
            if (chatFull != null) {
        ...
        if (this.inPreviewMode && AndroidUtilities.isTablet()) {
            ...
            while (true) {
                ...
                if (n2Var instanceof uy) {
                    uy uyVar4 = (uy) n2Var;
                    if (uyVar4.h4()) {
                        MessagesStorage.TopicKey topicKey = uyVar4.f38311p2;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == i12) {
            ...
            if (chatFull2.f18329id == j3) {
                O0(false);
                wh.d dVar = this.R0;
                if (dVar != null) {
                    dVar.f45375j = chatFull2;
    ...
    public final TLRPC.Chat g() {
        return getMessagesController().getChat(Long.valueOf(this.f33596a));
    }
    ...
    public final boolean isLightStatusBar() {
        ...
        if (this.actionBar.s()) {
            themedColor = getThemedColor(org.telegram.ui.ActionBar.j6.f19445w8);
        }
    ...
    public final boolean onBackPressed(boolean z10) {
        if (!this.f33597a0.isEmpty()) {
            if (z10) {
                C0();
                return false;
            }
        } else if (this.f33632s0) {
            if (z10) {
                this.actionBar.v(this.f33627p0.L(false));
            }
        } else {
    ...
    public final void onFragmentDestroy() {
        ...
        TLRPC.Chat chat = getMessagesController().getChat(Long.valueOf(this.f33596a));
        if (ChatObject.isChannel(chat)) {
    ...
    public final void onPause() {
        super.onPause();
        getMessagesController().getTopicsController().onTopicFragmentPause(this.f33596a);
    ...
    public final void setPreviewOpenedProgress(float f7) {
        org.telegram.ui.Components.eo eoVar = this.f33609f;
        if (eoVar != null) {
            eoVar.setAlpha(f7);
            this.f33628q0.setAlpha(f7);
            org.telegram.ui.ActionBar.v0 v0Var = this.f33627p0;
            if (v0Var != null) {
                v0Var.setAlpha(f7);
            }
    ...
    public final void setPreviewReplaceProgress(float f7) {
        ...
        if (eoVar != null) {
            eoVar.setAlpha(f7);
            this.f33609f.setTranslationX((1.0f - f7) * AndroidUtilities.dp(40.0f));
        }
    }

    @Override
    public final fh.d x() {
        return this.f33615h1;
    }
    ...
    public final void x0() {
        ...
        float f7;
        int i10;
        if (Build.VERSION.SDK_INT >= 31 && (iVar = this.f33611f1) != null) {
            ...
            int measuredHeight = (view.getMeasuredHeight() - this.f33608e1) - AndroidUtilities.dp(8.0f);
            this.l1.set(0.0f, -dp, view.getMeasuredWidth(), kVar.getMeasuredHeight() + dp + dp2);
            RectF rectF = this.f33623m1;
            ...
            iVar.g(i10, this.f33621k1);
            iVar.e(this.f33619j1, view.getMeasuredWidth(), view.getMeasuredHeight());
        }
    }
    ...
    public final void y0() {
        ...
        if (!topicsController.endIsReached(j3) && (hf1Var = this.F) != null) {
            int N0 = hf1Var.N0();
            if (this.f33599b.isEmpty() || N0 >= this.f33629r.h() - 5) {
    ...
    public final void z0(boolean z10) {
        ...
        ChatObject.Call call = this.H0;
        if (call != null && ((str = this.f33641y0) != null || this.f33642z0)) {
            ...
            this.f33641y0 = null;
            this.f33642z0 = false;
        } else if (this.f33641y0 != null && z10 && chatFull != null && chatFull.call == null && this.fragmentView != null && getParentActivity() != null) {
