...
public final class d71 implements RequestDelegate {
    public final int f37390a;
    public final SessionsActivity f37391b;

    public d71(SessionsActivity sessionsActivity, int i10) {
        this.f37390a = i10;
        this.f37391b = sessionsActivity;
    }
    ...
    public final void run(final TLObject tLObject, final TLRPC.TL_error tL_error) {
        switch (this.f37390a) {
            case 0:
                AndroidUtilities.runOnUIThread(new ky0(this.f37391b, 19));
                return;
            case 1:
                final SessionsActivity sessionsActivity = this.f37391b;
                ...
                return;
            case 2:
                final SessionsActivity sessionsActivity2 = this.f37391b;
                AndroidUtilities.runOnUIThread(new Runnable() {
                    @Override
                    public final void run() {
                        org.telegram.ui.Components.tc a02;
                ...
                return;
            default:
                final SessionsActivity sessionsActivity3 = this.f37391b;
                AndroidUtilities.runOnUIThread(new Runnable() {
                    @Override
                    public final void run() {
                        org.telegram.ui.Components.tc a02;
