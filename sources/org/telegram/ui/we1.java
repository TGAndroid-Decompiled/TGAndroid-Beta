...
public final class we1 extends org.telegram.ui.ActionBar.j {
    ...
    public final void b(int i10) {
        ...
        String str = null;
        if (i10 == 1) {
            if (af1Var.f34413e.getText() == null) {
                obj = null;
            } else {
                obj = af1Var.f34413e.getText().toString();
            }
            if (TextUtils.isEmpty(obj)) {
                ...
                AndroidUtilities.shakeView(af1Var.f34413e);
            } else if (!af1Var.f34416r) {
                ...
                tL_messages_createForumTopic.peer = af1Var.getMessagesController().getInputPeer(af1Var.f34410a);
            ...
            if (af1Var.f34413e.getText() != null) {
                str = af1Var.f34413e.getText().toString();
            }
            ...
            if (!af1Var.f34418w.title.equals(str) || af1Var.f34418w.icon_emoji_id != af1Var.f34411b) {
                TL_forum.TL_messages_editForumTopic tL_messages_editForumTopic = new TL_forum.TL_messages_editForumTopic();
                tL_messages_editForumTopic.peer = af1Var.getMessagesController().getInputPeer(af1Var.f34410a);
                TLRPC.TL_forumTopic tL_forumTopic = af1Var.f34418w;
                tL_messages_editForumTopic.topic_id = tL_forumTopic.f19921id;
                if (!tL_forumTopic.title.equals(str)) {
                    tL_messages_editForumTopic.title = str;
                    tL_messages_editForumTopic.flags |= 1;
                }
                long j10 = af1Var.f34418w.icon_emoji_id;
                long j11 = af1Var.f34411b;
                if (j10 != j11) {
            ...
            if (af1Var.d != null) {
                TLRPC.TL_forumTopic tL_forumTopic2 = af1Var.f34418w;
                if (tL_forumTopic2.f19921id == 1 && (!v8Var.d.h) != tL_forumTopic2.hidden) {
                    TL_forum.TL_messages_editForumTopic tL_messages_editForumTopic2 = new TL_forum.TL_messages_editForumTopic();
                    tL_messages_editForumTopic2.peer = af1Var.getMessagesController().getInputPeer(af1Var.f34410a);
                    tL_messages_editForumTopic2.topic_id = af1Var.f34418w.f19921id;
            ...
            TLRPC.TL_forumTopic tL_forumTopic3 = af1Var.f34418w;
            long j12 = af1Var.f34411b;
            ...
            af1Var.getMessagesController().getTopicsController().onTopicEdited(af1Var.f34410a, af1Var.f34418w);
            af1Var.finishFragment();
        }
    }
}
