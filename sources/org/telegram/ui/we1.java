...
public final class we1 extends org.telegram.ui.ActionBar.j {
    ...
    public final void b(int i10) {
        ...
        String str = null;
        if (i10 == 1) {
            if (af1Var.f34414e.getText() == null) {
                obj = null;
            } else {
                obj = af1Var.f34414e.getText().toString();
            }
            if (TextUtils.isEmpty(obj)) {
                ...
                AndroidUtilities.shakeView(af1Var.f34414e);
            } else if (!af1Var.f34417r) {
                ...
                tL_messages_createForumTopic.peer = af1Var.getMessagesController().getInputPeer(af1Var.f34411a);
            ...
            if (af1Var.f34414e.getText() != null) {
                str = af1Var.f34414e.getText().toString();
            }
            ...
            if (!af1Var.f34419w.title.equals(str) || af1Var.f34419w.icon_emoji_id != af1Var.f34412b) {
                TL_forum.TL_messages_editForumTopic tL_messages_editForumTopic = new TL_forum.TL_messages_editForumTopic();
                tL_messages_editForumTopic.peer = af1Var.getMessagesController().getInputPeer(af1Var.f34411a);
                TLRPC.TL_forumTopic tL_forumTopic = af1Var.f34419w;
                ...
                long j10 = af1Var.f34419w.icon_emoji_id;
                long j11 = af1Var.f34412b;
                if (j10 != j11) {
            ...
            if (af1Var.d != null) {
                TLRPC.TL_forumTopic tL_forumTopic2 = af1Var.f34419w;
                if (tL_forumTopic2.f19921id == 1 && (!v8Var.d.h) != tL_forumTopic2.hidden) {
                    ...
                    tL_messages_editForumTopic2.peer = af1Var.getMessagesController().getInputPeer(af1Var.f34411a);
                    tL_messages_editForumTopic2.topic_id = af1Var.f34419w.f19921id;
            ...
            TLRPC.TL_forumTopic tL_forumTopic3 = af1Var.f34419w;
            long j12 = af1Var.f34412b;
            ...
            af1Var.getMessagesController().getTopicsController().onTopicEdited(af1Var.f34411a, af1Var.f34419w);
            af1Var.finishFragment();
        }
    }
}
