...
public final class r91 extends org.telegram.ui.Components.za {
    public static final int f37077d0 = 0;
    public final yh.a X;
    public final LinearLayout Y;
    public final LinearLayout Z;
    public boolean f37078a0;
    public boolean f37079b0;
    public org.telegram.ui.Components.w51 f37080c0;
    ...
    public r91(final Context context, final int i10, final org.telegram.ui.ActionBar.e6 e6Var, final nf nfVar) {
        ...
        yh.a aVar = new yh.a(context, i10, zf.b.f48948b, e6Var);
        this.X = aVar;
        aVar.setScaleX(0.6f);
        aVar.setScaleY(0.6f);
        aVar.setAlpha(0.0f);
        ...
        TextView b13 = w7.b6.b(context, 14.0f, org.telegram.ui.ActionBar.i6.f19215y6, false, null);
        b13.setGravity(17);
        ...
        dVar2.setOnClickListener(new View.OnClickListener() {
            ...
            public final void onClick(View view2) {
                ...
                try {
                    ...
                    } else if (yh.u5.y(i23, true).f47804f.toDouble() < parseDouble) {
                        new di.h(context, e6Var, zf.a.i((long) (parseDouble * 1.0E9d), zf.b.f48948b), true, new o91(0));
                    } else {
        ...
        this.f37080c0.N(false);
    }

    public final void P() {
        boolean z10;
        float f7;
        if (this.f37078a0 && !isDismissed() && !isKeyboardVisible()) {
            z10 = true;
        } else {
            z10 = false;
        }
        if (this.f37079b0 != z10) {
            this.f37079b0 = z10;
            yh.a aVar = this.X;
            if (aVar != null) {
                aVar.setEnabled(z10);
