...
public final class q41 extends og.b {
    ...
    @Override
    public final int h() {
        return this.d.f31447s.size();
    }

    @Override
    public final int j(int i10) {
        return ((r41) this.d.f31447s.get(i10)).f15543a;
    }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (((r41) arrayList.get(i10)).f15543a == 1) {
            ...
            if (i10 == saveToGallerySettingsActivity.h) {
                ...
                if (saveToGallerySettingsActivity.f31443c != null) {
                ...
                int i12 = saveToGallerySettingsActivity.f31441a;
                if (i12 == 1) {
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        switch (i10) {
            ...
            case 8:
                ...
                go0Var.f24373w.X(go0Var.getProgress(), false);
                linearLayout2.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18862d6, false));
            ...
            case 9:
                ...
                if (DialogObject.isUserDialog(saveToGallerySettingsActivity.f31442b)) {
                    i12 = ((org.telegram.ui.ActionBar.o2) saveToGallerySettingsActivity).currentAccount;
                    chat = MessagesController.getInstance(i12).getUser(Long.valueOf(saveToGallerySettingsActivity.f31442b));
                } else {
                    i11 = ((org.telegram.ui.ActionBar.o2) saveToGallerySettingsActivity).currentAccount;
                    chat = MessagesController.getInstance(i11).getChat(Long.valueOf(-saveToGallerySettingsActivity.f31442b));
                }
                zaVar2.a(chat, null);
                zaVar2.setBackgroundColor(saveToGallerySettingsActivity.getThemedColor(org.telegram.ui.ActionBar.j6.f18862d6));
                zaVar = zaVar2;
                view = zaVar;
                break;
            case 10:
                View a7Var = new org.telegram.ui.Cells.a7(viewGroup.getContext(), (org.telegram.ui.Cells.p6) null);
                a7Var.setBackgroundDrawable(org.telegram.ui.ActionBar.j6.U0(saveToGallerySettingsActivity.getParentActivity(), R.drawable.greydivider_bottom, org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f18826b7, saveToGallerySettingsActivity.getResourceProvider())));
                zaVar = a7Var;
                view = zaVar;
                break;
        }
