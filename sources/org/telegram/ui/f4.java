...
public final class f4 extends org.telegram.ui.Components.ll0 {
    ...
    public final ArrayList f33538f = new ArrayList();
    public final HashMap h = new HashMap();
    public final HashMap f33539n = new HashMap();
    public final HashMap f33540r = new HashMap();
    public final HashMap f33541s = new HashMap();
    public final ArrayList v = new ArrayList();
    public final HashMap f33542w = new HashMap();
    public final ArrayList f33543x = new ArrayList();
    public final HashMap f33544y = new HashMap();
    ...
    public final void E(TL_iv.PageBlock pageBlock, f4 f4Var) {
        ...
        ArrayList arrayList = this.f33538f;
        if (z10) {
    ...
    public final void G(Object obj, TL_iv.PageBlock pageBlock) {
        if (!(obj instanceof TL_iv.textEmpty)) {
            HashMap hashMap = this.f33542w;
            if (hashMap.containsKey(obj)) {
                return;
            }
            hashMap.put(obj, pageBlock);
            this.f33543x.add(obj);
        }
    }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i11 >= 0) {
            ...
            if (i11 < arrayList.size()) {
                H(c1Var.f42700f, c1Var, (TL_iv.PageBlock) arrayList.get(i11), i11, arrayList.size(), false);
            }
        }
    }
    ...
    public final void y(s4.c1 c1Var) {
        ...
        h4 h4Var = o3Var.e;
        TextView textView = o3Var.f36217a;
        TextView textView2 = o3Var.f36218b;
        if (i10 == 0) {
            o3Var.f36219c = false;
