...
public final class f4 extends org.telegram.ui.Components.kl0 {
    ...
    public int J;
    public final h4 L;
    public final Context f33469c;
    public final ArrayList d = new ArrayList();
    public final ArrayList e = new ArrayList();
    public final ArrayList f33470f = new ArrayList();
    public final HashMap h = new HashMap();
    public final HashMap f33471n = new HashMap();
    public final HashMap f33472r = new HashMap();
    public final HashMap f33473s = new HashMap();
    public final ArrayList v = new ArrayList();
    public final HashMap f33474w = new HashMap();
    public final ArrayList f33475x = new ArrayList();
    public final HashMap f33476y = new HashMap();
    ...
    public final void E(TL_iv.PageBlock pageBlock, f4 f4Var) {
        ...
        ArrayList arrayList = this.f33470f;
        if (z10) {
        ...
        } else if ((pageBlock instanceof TL_iv.pageBlockVideo) && e4.g(f4Var.E, pageBlock)) {
    ...
    public final void G(Object obj, TL_iv.PageBlock pageBlock) {
        if (!(obj instanceof TL_iv.textEmpty)) {
            HashMap hashMap = this.f33474w;
            if (hashMap.containsKey(obj)) {
                return;
            }
            hashMap.put(obj, pageBlock);
            this.f33475x.add(obj);
        }
    }

    public final void H(int r32, s4.c1 r33, org.telegram.tgnet.tl.TL_iv.PageBlock r34, int r35, int r36, boolean r37) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.f4.H(int, s4.c1, org.telegram.tgnet.tl.TL_iv$PageBlock, int, int, boolean):void");
    }

    public final boolean J(v3 v3Var) {
        TL_iv.PageBlock z10 = h4.z(v3Var.f38337a);
        if (z10 instanceof TL_iv.pageBlockDetails) {
            return ((TL_iv.pageBlockDetails) z10).open;
        }
        if (z10 instanceof v3) {
            v3 v3Var2 = (v3) z10;
            TL_iv.PageBlock z11 = h4.z(v3Var2.f38338b);
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i11 >= 0) {
            ...
            if (i11 < arrayList.size()) {
                H(c1Var.f42678f, c1Var, (TL_iv.PageBlock) arrayList.get(i11), i11, arrayList.size(), false);
            }
        }
    }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        TextView textView;
        View w2Var;
        Context context = this.f33469c;
        if (i10 != 2147483646) {
            h4 h4Var = this.L;
            switch (i10) {
                case 0:
                    textView = new b2(context, h4Var, this);
                    break;
                case 1:
                    textView = new v1(context, h4Var, this);
                    break;
                case 2:
                    textView = new m1(context);
                    break;
                case 3:
                    textView = new s1(h4Var, context, this);
                    break;
                case 4:
                    textView = new r2(context, h4Var, this);
                    break;
                case 5:
                    ...
                    break;
                case 6:
                    textView = new g2(context, h4Var, this);
                    break;
                case 7:
                    textView = new b1(context, h4Var, this);
                    break;
                case 8:
                    textView = new p2(h4Var, context, this);
                    break;
                case 9:
                    ...
                    break;
                case 10:
                    textView = new a1(context, h4Var, this);
                    break;
                case 11:
                    textView = new u2(context, h4Var, this);
                    break;
                case 12:
                    textView = new x1(context, h4Var, this);
                    break;
                case 13:
                    textView = new u1(context, h4Var, this);
                    break;
                case 14:
                    textView = new f2(context, h4Var, this);
                    break;
                case 15:
                    textView = new q2(context, h4Var, this);
                    break;
                case 16:
                    textView = new t1(context, h4Var, this);
                    break;
                case 17:
                    textView = new j1(h4Var, context, this);
                    break;
                case 18:
                    ...
                    break;
                case 19:
                    textView = new z0(context, h4Var, this);
                    break;
                case 20:
                    textView = new w1(context, h4Var, this);
                    break;
                case 21:
                    textView = new a2(context, h4Var, this);
                    break;
                case 22:
                    textView = new y1(context, h4Var, this);
                    break;
                case 23:
                    textView = new h2(context, h4Var, this);
                    break;
                case 24:
                    textView = new l1(context, h4Var, this);
                    break;
                case 25:
                    textView = new t2(context, h4Var, this);
                    break;
                case 26:
                    textView = new i2(context, h4Var, this);
                    break;
                case 27:
                ...
                default:
                    switch (i10) {
                        case 90:
                            ...
                            break;
                        case 91:
                            textView = new o3(h4Var, context, true);
                            break;
                        case 92:
                            textView = new z1(context, h4Var);
                            break;
                        default:
    ...
    public final void y(s4.c1 c1Var) {
        ...
        h4 h4Var = o3Var.e;
        TextView textView = o3Var.f36098a;
        TextView textView2 = o3Var.f36099b;
        if (i10 == 0) {
            o3Var.f36100c = false;
