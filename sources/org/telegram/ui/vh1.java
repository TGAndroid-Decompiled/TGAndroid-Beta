...
public final class vh1 extends ViewGroup {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        UsersSelectActivity usersSelectActivity = this.f38560f;
        usersSelectActivity.f31854c.measure(View.MeasureSpec.makeMeasureSpec(dp - i14, 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(32.0f), 1073741824));
        if (!this.f38558b) {
            ...
            if (this.f38557a != null) {
                ...
                if (usersSelectActivity.f31861y != dp7) {
                    arrayList.add(ObjectAnimator.ofInt(usersSelectActivity, "containerHeight", dp7));
                }
                float f11 = dp6;
                if (usersSelectActivity.f31854c.getTranslationX() != f11) {
                    arrayList.add(ObjectAnimator.ofFloat(usersSelectActivity.f31854c, property2, f11));
                }
                float translationY = usersSelectActivity.f31854c.getTranslationY();
                float f12 = usersSelectActivity.Q;
                if (translationY != f12) {
                    arrayList.add(ObjectAnimator.ofFloat(usersSelectActivity.f31854c, property, f12));
                }
                usersSelectActivity.f31854c.setAllowDrawCursor(false);
                this.f38557a.playTogether(arrayList);
                this.f38557a.start();
                this.f38558b = true;
            } else {
                usersSelectActivity.f31861y = dp5;
                usersSelectActivity.f31854c.setTranslationX(dp6);
                usersSelectActivity.f31854c.setTranslationY(usersSelectActivity.Q);
            }
        } else if (this.f38557a != null && !usersSelectActivity.v && this.e == null) {
            ci.h2 h2Var = usersSelectActivity.f31854c;
            h2Var.bringPointIntoView(h2Var.getSelectionStart());
        }
        setMeasuredDimension(size, usersSelectActivity.f31861y);
    }
}
