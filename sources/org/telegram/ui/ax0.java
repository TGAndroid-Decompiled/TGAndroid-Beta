...
public final class ax0 extends LinearLayout {
    public final TextView f32248a;
    public final TextView f32249b;
    public final FrameLayout f32250c;
    public final ww0 d;
    public final xw0 e;
    public boolean f32251f;
    public boolean h;
    public final PremiumPreviewFragment f32252n;
    ...
    public ax0(PremiumPreviewFragment premiumPreviewFragment, Context context) {
        ...
        int i11;
        int i12;
        this.f32252n = premiumPreviewFragment;
        setOrientation(1);
        FrameLayout frameLayout = new FrameLayout(context);
        this.f32250c = frameLayout;
        int i13 = premiumPreviewFragment.f31450g0;
        if (i13 == 1) {
            i10 = 175;
        } else {
            i10 = 190;
        ...
        ww0 ww0Var = new ww0(this, context, z10 ? 1 : 0, i11, context);
        this.d = ww0Var;
        frameLayout.addView(ww0Var, w7.y5.c(-1.0f, -1));
        frameLayout.setClipChildren(false);
        setClipChildren(false);
        TextView textView = new TextView(context);
        this.f32248a = textView;
        ...
        xw0Var.setSelectorTransformer(new q0.a() {
            @Override
            public final void accept(Object obj) {
                ...
                if (pressedChildView == null) {
                    ...
                    b10 = xw0Var2.T(pressedChildView).b();
                }
                Path path2 = path;
                path2.rewind();
    ...
    public final void a() {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.ax0.a():void");
    }
    ...
    public final void b() {
        ...
        int i12;
        int i13;
        PremiumPreviewFragment premiumPreviewFragment = this.f32252n;
        int i14 = premiumPreviewFragment.f31450g0;
        TextView textView = this.f32248a;
        TextView textView2 = this.f32249b;
        if (i14 == 0) {
            if (premiumPreviewFragment.f31459p0) {
                i12 = R.string.TelegramPremiumSubscribedTitle;
            } else {
                i12 = R.string.TelegramPremium;
            }
            textView.setText(LocaleController.getString(i12));
            if (!premiumPreviewFragment.getUserConfig().isPremium() && !premiumPreviewFragment.f31459p0) {
                i13 = R.string.TelegramPremiumSubtitle;
            } else {
                i13 = R.string.TelegramPremiumSubscribedSubtitle;
            }
            org.telegram.messenger.f0.m(i13, textView2);
        } else if (i14 == 1) {
            if (premiumPreviewFragment.f31459p0) {
            ...
            org.telegram.messenger.f0.m(i11, textView2);
        }
        ...
        int i15 = 0;
        if (!premiumPreviewFragment.f31459p0 && !BuildVars.IS_BILLING_UNAVAILABLE && premiumPreviewFragment.d.size() > 1) {
            z10 = false;
        } else {
            z10 = true;
        }
        boolean z11 = this.f32251f;
        xw0 xw0Var = this.e;
        if (z11 && z10) {
            if (xw0Var.getVisibility() == 0 && z10 && this.h == z10) {
                ValueAnimator duration = ValueAnimator.ofFloat(1.0f, 0.0f).setDuration(250L);
                duration.addUpdateListener(new vw0(this, xw0Var, duration, 0));
                duration.addListener(new org.telegram.ui.Components.bl0(10, this, xw0Var));
