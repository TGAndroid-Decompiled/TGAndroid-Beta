...
public final class sj implements org.telegram.ui.Components.oo {
    ...
    public final void dismiss() {
        this.f37507a.f32302h0.M(null, null);
    }

    @Override
    public final void n() {
        bo boVar = this.f37507a;
        boVar.bc(true);
        org.telegram.ui.Components.vc.A(boVar, boVar.getMessagesController().isDialogMuted(boVar.T5, boVar.d()), boVar.f32275ea).j();
    }
    ...
    public final void o() {
        ...
        if (boVar.T5 != 0 && boVar.R3 != 3) {
            if (boVar.f32277f != null) {
                boVar.getMessagesController().putUser(boVar.f32277f, true);
            }
            ...
            boVar.presentFragment(new y11(bundle, boVar.f32275ea));
        }
    }
