...
public final class gj1 {
    ...
    public int f36702f;
    public TLRPC.TL_wallPaper f36703g;
    public float h;
    public final File f36704i;
    public final boolean f36705j;
    public final boolean f36706k;
    public TLRPC.WallPaper f36707l;
    public Bitmap f36708m;

    public gj1(int i10, int i11, String str, int i12) {
        this.f36698a = str;
        this.f36699b = i10 | (-16777216);
        int i13 = i11 == 0 ? 0 : i11 | (-16777216);
        this.f36700c = i13;
        this.f36702f = i13 == 0 ? 0 : i12;
        this.h = 1.0f;
    }

    public final String a() {
        StringBuilder sb2 = new StringBuilder();
        sb2.append(String.valueOf(this.f36699b));
    ...
    public final String b() {
        ...
        if (str != null && str2 != null) {
            ...
            if (this.f36703g != null) {
                ...
                g10.append(AndroidUtilities.getWallpaperRotation(this.f36702f, true));
                lowerCase = g10.toString();
            } else {
                StringBuilder g11 = w.f.g(C, "?rotation=");
                g11.append(AndroidUtilities.getWallpaperRotation(this.f36702f, true));
                lowerCase = g11.toString();
            }
        }
        if (this.f36703g != null) {
            String str4 = "https://" + MessagesController.getInstance(UserConfig.selectedAccount).linkPrefix + "/bg/" + this.f36703g.slug + "?intensity=" + ((int) (this.h * 100.0f)) + "&bg_color=" + lowerCase;
            if (this.f36705j) {
    ...
    public gj1(String str, int i10, int i11, int i12, int i13) {
        this.f36698a = str;
        this.f36699b = i10 | (-16777216);
        this.f36700c = i11 == 0 ? 0 : i11 | (-16777216);
        this.d = i12 == 0 ? 0 : i12 | (-16777216);
        this.f36701e = i13 != 0 ? i13 | (-16777216) : 0;
        this.h = 1.0f;
        this.f36706k = true;
    }
