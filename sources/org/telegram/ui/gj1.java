...
public final class gj1 {
    ...
    public final int e;
    public int f33870f;
    public TLRPC.TL_wallPaper f33871g;
    public float h;
    public final File f33872i;
    public final boolean f33873j;
    public final boolean f33874k;
    public TLRPC.WallPaper f33875l;
    public Bitmap f33876m;

    public gj1(int i10, int i11, String str, int i12) {
        this.f33867a = str;
        this.f33868b = i10 | (-16777216);
        int i13 = i11 == 0 ? 0 : i11 | (-16777216);
        this.f33869c = i13;
        this.f33870f = i13 == 0 ? 0 : i12;
        this.h = 1.0f;
    }

    public final String a() {
        StringBuilder sb2 = new StringBuilder();
        sb2.append(String.valueOf(this.f33868b));
    ...
    public final String b() {
        ...
        if (str != null && str2 != null) {
            ...
            if (this.f33871g != null) {
                ...
                h.append(AndroidUtilities.getWallpaperRotation(this.f33870f, true));
                lowerCase = h.toString();
            } else {
                StringBuilder h10 = w.c.h(D, "?rotation=");
                h10.append(AndroidUtilities.getWallpaperRotation(this.f33870f, true));
                lowerCase = h10.toString();
            }
        }
        if (this.f33871g != null) {
            String str4 = "https://" + MessagesController.getInstance(UserConfig.selectedAccount).linkPrefix + "/bg/" + this.f33871g.slug + "?intensity=" + ((int) (this.h * 100.0f)) + "&bg_color=" + lowerCase;
            if (this.f33873j) {
    ...
    public gj1(String str, int i10, int i11, int i12, int i13) {
        this.f33867a = str;
        this.f33868b = i10 | (-16777216);
        this.f33869c = i11 == 0 ? 0 : i11 | (-16777216);
