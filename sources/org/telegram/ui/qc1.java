...
public final class qc1 extends org.telegram.ui.Components.ll0 {
    public boolean X2;
    public float Y2;
    public final vd1 Z2;
    ...
    public final boolean F0(View view) {
        s4.c1 T;
        qc1 qc1Var = this.Z2.f38567u0;
        View F = qc1Var.F(view);
        if (F == null) {
            T = null;
        } else {
            T = qc1Var.T(F);
        }
        if (T != null && T.f42678f == 2) {
            return false;
        }
        return true;
    }
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        if (view instanceof org.telegram.ui.Cells.t1) {
            ...
            if (avatarImage != null) {
                ...
                vd1 vd1Var = this.Z2;
                if (m32 && (T = vd1Var.f38567u0.T(view)) != null) {
                    if (vd1Var.f38567u0.K(T.b() - 1) != null) {
                ...
                int measuredHeight = vd1Var.f38567u0.getMeasuredHeight() - vd1Var.f38567u0.getPaddingBottom();
                if (layoutHeight > measuredHeight) {
                    layoutHeight = measuredHeight;
                }
                if (t1Var.n3() && (r11 = vd1Var.f38567u0.T(view)) != null) {
                    int i10 = 0;
                    while (i10 < 20) {
                        i10++;
                        s4.c1 T2 = vd1Var.f38567u0.K(T2.b() + 1);
                        if (T2 == null) {
                            break;
                        }
                        View view2 = T2.f42675a;
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        vd1 vd1Var = this.Z2;
        if (action == 1) {
            if (!vd1Var.f38560r0 && (vd1Var.B1 instanceof fj1) && vd1Var.L0[0].getVisibility() == 0) {
                vd1Var.f1(0, false, true);
            }
            vd1Var.f38560r0 = false;
        }
        if (vd1Var.a2) {
