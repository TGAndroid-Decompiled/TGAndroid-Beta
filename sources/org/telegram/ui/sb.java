...
public final class sb extends s4.h0 {
    ...
    public final void D(boolean z10) {
        this.d = 0;
        wb wbVar = this.f37447n;
        ArrayList arrayList = wbVar.f38662o0;
    ...
    public final long i(int i10) {
        if (i10 >= this.f37446f && i10 < this.h) {
            ArrayList arrayList = this.f37447n.f38662o0;
            return ((MessageObject) arrayList.get((arrayList.size() - (i10 - this.f37446f)) - 1)).stableId;
        } else if (i10 == this.e) {
            return 2L;
        } else {
            return 5L;
    ...
    public final int j(int i10) {
        if (i10 >= this.f37446f && i10 < this.h) {
            ArrayList arrayList = this.f37447n.f38662o0;
            return ((MessageObject) arrayList.get((arrayList.size() - (i10 - this.f37446f)) - 1)).contentType;
        }
        return 4;
    }
