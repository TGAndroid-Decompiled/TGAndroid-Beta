...
public final class k61 extends org.telegram.ui.Components.gt {
            ...
            if (i10 < arrayList.size()) {
                ...
                if (!s61Var.f40343b) {
                    if (s61Var.f40342a) {
                        ...
                        ImageReceiver imageReceiver = s61Var.f40348r;
                        if (imageReceiver != null) {
                            imageReceiver.draw(canvas, s61Var.f40346f[this.K]);
                        }
                    }
                }
                i10++;
        ...
        if (this.O != null) {
            ...
            while (i11 < this.O.size()) {
                ...
                if (!s61Var.f40343b) {
                    ...
                    } else if (!s61Var.f40349s && !s61Var.Q) {
                        if ((s61Var.f40345e != null || j71Var.W == 13) && !s61Var.f40343b && (drawable = s61Var.E) != null) {
                            drawable.setAlpha(255);
                            drawable.setBounds(rect);
                        }
                    } else {
                    ...
                    PorterDuffColorFilter porterDuffColorFilter = j71Var.f37680k1;
    ...
    public final void g() {
        ...
        while (true) {
            ArrayList arrayList = this.P;
            if (i10 < arrayList.size()) {
                ImageReceiver.BackgroundThreadDrawHolder backgroundThreadDrawHolder = ((s61) arrayList.get(i10)).f40346f[this.K];
                if (backgroundThreadDrawHolder != null) {
                    backgroundThreadDrawHolder.release();
                }
                i10++;
            } else {
                this.T.f38231e3.f37673h0.invalidate();
                return;
            }
        }
    }
    ...
    public final void m(Canvas canvas, Drawable drawable, s61 s61Var, float f7) {
        if (drawable != null) {
            ...
            drawable.setColorFilter(this.T.f38231e3.f37680k1);
        } else if ((s61Var.f40349s || s61Var.Q) && s61Var.h != null) {
            canvas.save();
