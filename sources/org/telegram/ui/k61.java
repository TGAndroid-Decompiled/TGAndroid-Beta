...
public final class k61 extends org.telegram.ui.Components.vl0 {
    ...
    public int d;
    public int h;
    public final a71 f34955s;
    public int e = -1;
    public int f34952f = -1;
    public int f34953n = 1;
    public final ArrayList f34954r = new ArrayList();
    ...
    public final void E(boolean z10) {
        a71 a71Var = this.f34955s;
        int i10 = a71Var.W;
        boolean z11 = a71Var.I;
        ArrayList arrayList = this.f34954r;
        ...
        if (i10 == 14) {
            ...
            if (arrayList3 != null && !arrayList3.isEmpty()) {
                int i13 = this.f34953n;
                this.f34953n = i13 + 1;
                this.f34952f = i13;
                arrayList.add(2);
                this.f34951c = this.f34953n;
        ...
        if (arrayList5 != null) {
            int i17 = this.f34953n;
            this.h = i17;
            this.f34953n = arrayList5.size() + i17;
        }
        l();
        if (a71Var.f32067y1 && this.f34953n == 0) {
            z12 = true;
        }
        if (a71Var.G1 != z12) {
            a71Var.G1 = z12;
            ...
            a71Var.H1.start();
            if (z12) {
                a71.D(a71Var.V, a71Var.f32036l0);
            }
        }
    }
    ...
    public final int j(int i10) {
        int i11;
        if (i10 == this.e || i10 == this.f34952f) {
            return 6;
        }
        a71 a71Var = this.f34955s;
        if (a71Var.W == 14) {
            ArrayList arrayList = a71Var.B1;
            if (arrayList != null && i10 >= (i11 = this.f34951c) && i10 - i11 < arrayList.size()) {
                return 4;
            }
        } else {
        ...
        int i13 = this.d;
        if (i10 > i13 && (i10 - i13) - 1 < arrayList2.size() && (a71Var.W == 13 || ((zg.o0) a71Var.A1.get((i10 - this.d) - 1)).f49398g != 0)) {
            return 3;
        }
        int i14 = this.h;
        ...
        if (i16 == 6) {
            ...
            if (arrayList != null && (i13 = i10 - this.h) >= 0 && i13 < arrayList.size()) {
                ...
                if (document2 instanceof x61) {
                    CharSequence charSequence = ((x61) document2).f39850a;
                    String str = a71Var.f32069z1;
                    f61Var.getClass();
                    if (charSequence != null && str != null && (indexOf = charSequence.toString().toLowerCase().indexOf(str.toLowerCase())) >= 0) {
                        SpannableString spannableString = new SpannableString(charSequence);
                        spannableString.setSpan(new ForegroundColorSpan(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.Ue, f61Var.f33564f.Z0)), indexOf, str.length() + indexOf, 33);
                        charSequence = spannableString;
                    }
                    f61Var.f33561a.setText(charSequence);
                    f61Var.b(false);
                }
            } else if (i10 == this.e) {
            ...
            f61Var.f33563c.setVisibility(8);
        } else if (i16 == 5) {
            TLRPC.Document document3 = (TLRPC.Document) a71Var.C1.get((i10 - this.f34951c) - 1);
            j61 j61Var = (j61) view;
            j61Var.a(n51Var);
            j61Var.h.setImage(ImageLocation.getForDocument(document3), "100_100_firstframe", null, null, DocumentObject.getSvgThumb(document3, org.telegram.ui.ActionBar.h6.f19224m6, 0.2f), 0L, "tgs", document3, 0);
            j61Var.Q = true;
            j61Var.d = document3;
            j61Var.e = null;
        } else if (i16 == 4) {
            ...
            j61Var2.f34665c = i10;
            ImageReceiver imageReceiver = j61Var2.f34667n;
            ArrayList arrayList2 = a71Var.A1;
            if (arrayList2 != null && i10 >= 0 && i10 < arrayList2.size()) {
                o0Var = (zg.o0) a71Var.A1.get(i10);
            } else {
                ArrayList arrayList3 = a71Var.B1;
                if (arrayList3 != null && i10 >= (i12 = this.f34951c) && i10 - i12 < arrayList3.size()) {
                    o0Var = (zg.o0) a71Var.B1.get(i10 - this.f34951c);
                } else {
                    return;
                }
            }
            ...
            j61Var2.f34671x = o0Var;
            j61Var2.f34672y = false;
            j61Var2.d(a71Var.J.contains(o0Var), false);
            j61Var2.f34664b = false;
            j61Var2.invalidate();
            if (i14 == 13) {
                j61Var2.setDrawable(Emoji.getEmojiDrawable(o0Var.f49397f));
            } else if (!o0Var.f49395b && o0Var.f49397f != null) {
                j61Var2.f34669s = true;
                TLRPC.TL_availableReaction tL_availableReaction = MediaDataController.getInstance(i15).getReactionsMap().get(o0Var.f49397f);
                if (tL_availableReaction != null) {
                    SvgHelper.SvgDrawable svgThumb = DocumentObject.getSvgThumb(tL_availableReaction.activate_animation, org.telegram.ui.ActionBar.h6.f19224m6, 0.2f);
                ...
                if (tL_availableReaction == null && o0Var.f49395b) {
                    j61Var2.setDrawable(Emoji.getEmojiDrawable(o0Var.f49397f));
                }
            } else {
                j61Var2.f34669s = false;
                j61Var2.e = new org.telegram.ui.Components.z5(o0Var.f49398g, (Paint.FontMetricsInt) null);
                j61Var2.d = null;
                j61Var2.h.clearImage();
                imageReceiver.clearImage();
                org.telegram.ui.Components.q5 q5Var = (org.telegram.ui.Components.q5) n51Var.f32585d3.get(j61Var2.e.getDocumentId());
                if (q5Var == null) {
                    cacheType2 = a71Var.getCacheType();
                    q5Var = org.telegram.ui.Components.q5.n(i15, j61Var2.e.getDocumentId(), null, cacheType2);
                    n51Var.f32585d3.put(j61Var2.e.getDocumentId(), q5Var);
                }
                j61Var2.setDrawable(q5Var);
            }
            if (!UserConfig.getInstance(i15).isPremium() && i14 == 14 && o0Var.f49395b && o0Var.d) {
                j61Var2.b();
            ...
            if (o0Var.e) {
                j61Var2.setEmojicon(o0Var.f49397f);
            } else {
                j61Var2.setEmojicon(null);
            }
            ...
            if (arrayList4 != null && i10 >= 0 && i10 < arrayList4.size()) {
                ...
                j61Var3.f34671x = o0Var3;
                long j3 = o0Var3.f49398g;
                if (j3 == 0) {
                    boolean contains2 = a71Var.J.contains(o0Var3);
                    j61Var3.f34672y = true;
                    j61Var3.setDrawable(Emoji.getEmojiDrawable(o0Var3.f49397f));
                    j61Var3.d(contains2, false);
                    return;
                }
                l4 = Long.valueOf(j3);
                if (i14 == 14 && !UserConfig.getInstance(i15).isPremium() && o0Var3.f49395b && o0Var3.d) {
                    j61Var3.b();
            ...
            if (l4 == null && document == null) {
                ...
                if (document != null) {
                    ...
                    j61Var3.d = document;
                    contains = hashSet.contains(Long.valueOf(document.f18342id));
                } else {
                ...
                org.telegram.ui.Components.q5 q5Var2 = (org.telegram.ui.Components.q5) n51Var.f32585d3.get(j61Var3.e.getDocumentId());
                if (q5Var2 == null) {
                    cacheType = a71Var.getCacheType();
                    q5Var2 = org.telegram.ui.Components.q5.n(i15, j61Var3.e.getDocumentId(), null, cacheType);
                    n51Var.f32585d3.put(j61Var3.e.getDocumentId(), q5Var2);
                }
