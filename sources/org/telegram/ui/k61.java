...
public abstract class k61 extends org.telegram.ui.Components.ml0 {
    ...
    public final ArrayList f35124a3;
    public final ArrayList f35125b3;
    public boolean f35126c3;
    public final LongSparseArray f35127d3;
    public final i71 f35128e3;

    public k61(i71 i71Var, Context context) {
        super(context, null);
        this.f35128e3 = i71Var;
        this.X2 = new SparseArray();
        this.Y2 = new ArrayList();
        this.Z2 = new ArrayList();
        this.f35124a3 = new ArrayList();
        this.f35125b3 = new ArrayList();
        this.f35127d3 = new LongSparseArray();
        setDrawSelectorBehind(true);
        setClipToPadding(false);
        setSelectorRadius(AndroidUtilities.dp(4.0f));
        setSelectorDrawableColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f18953i6, this.f26194p2));
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (getVisibility() == 0) {
                ...
                while (i14 < getChildCount()) {
                    ...
                    if (childAt instanceof r61) {
                        ...
                        if (r61Var.f37105w != null) {
                            ...
                            collectionParticles.a(canvas2, r61Var.f37105w.intValue());
                            canvas2.restore();
                            z12 = z14;
                        } else {
                            i10 = i14;
                        ...
                        if ((z15 || r61Var.M || r61Var.S > 0.0f) && !r61Var.f37099b) {
                            if (z15 || r61Var.M) {
                                float f14 = r61Var.R;
                                if (f14 < 1.0f) {
                        ...
                        q61 q61Var = r61Var.J;
                        if (q61Var != null && q61Var.getVisibility() == 0 && r61Var.J.getImageReceiver() == null && (imageReceiver2 = r61Var.f37103r) != null) {
                    ...
                    if (z10 && view != null) {
                        ...
                        List list = i71.Z1;
                        if (S == i18 - 1) {
                            float interpolation2 = org.telegram.ui.Components.qr.f27384g.getInterpolation(w7.p.a(((float) (SystemClock.elapsedRealtime() - i71Var.P1)) / 200.0f, 0.0f, 1.0f));
            ...
            ArrayList arrayList6 = this.f35125b3;
            arrayList6.clear();
            ArrayList arrayList7 = this.f35124a3;
                ...
                if (childAt2 instanceof r61) {
                    ...
                    if (q61Var2 != null && q61Var2.getVisibility() == 0) {
                        ...
                        if (drawable2 instanceof org.telegram.ui.Components.o5) {
                            imageReceiver = ((org.telegram.ui.Components.o5) drawable2).f26639k;
                        } else {
            ...
            Runnable runnable = zg.f0.f49052c;
            if (runnable != null) {
                runnable.run();
                zg.f0.f49052c = null;
            }
