...
public class ww0 extends FrameLayout {
    public final org.telegram.ui.ActionBar.k5 f39180a;
    ...
    public ww0(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        textView.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19244y6, f6Var));
    ...
    public final void a(mx0 mx0Var, boolean z10) {
        ...
        if (isPremium && mx0Var.f35903a == 12 && mx0Var.f35904b == R.drawable.filled_premium_status2) {
        ...
        this.f39183f = mx0Var;
        this.f39180a.l(mx0Var.f35905c, false);
        this.f39181b.setText(mx0Var.d);
        this.f39182c.setImageResource(mx0Var.f35904b);
        this.e = z10;
    }
    ...
    public final void b(long j3, boolean z10) {
        ...
        if (j3 == 0) {
            if (this.f39184n == null) {
                ...
                this.f39184n = mutate;
                mutate.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19192v6, false), PorterDuff.Mode.SRC_IN));
            }
            this.h.g(this.f39184n, z10);
            return;
        }
        this.h.j(j3, z10);
    }
    ...
    public final void c() {
        this.h.setBounds((getWidth() - this.h.f26057s) - AndroidUtilities.dp(21.0f), (getHeight() - this.h.f26057s) / 2, getWidth() - AndroidUtilities.dp(21.0f), (getHeight() + this.h.f26057s) / 2);
    }
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        if (this.h != null) {
            c();
            this.h.k(Integer.valueOf(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19192v6, false)));
            this.h.draw(canvas);
        }
        if (this.e) {
            canvas.drawRect(AndroidUtilities.dp(62.0f), getMeasuredHeight() - 1, getMeasuredWidth(), getMeasuredHeight(), org.telegram.ui.ActionBar.j6.f18984k0);
        }
    }
