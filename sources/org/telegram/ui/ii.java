...
public final class ii implements View.OnClickListener {
    public final zh0 f34514a;
    public final org.telegram.ui.Components.wl0 f34515b;
    public final LinearLayout f34516c;
    public final ActionBarPopupWindow$ActionBarPopupWindowLayout d;
    public final int[] e;
    public final wn f34517f;
    ...
    public final void onClick(View view) {
        ...
        if (wnVar.Q8 != null && !arrayList2.isEmpty()) {
            ...
            if (SharedConfig.messageSeenHintCount > 0 && wnVar.X0.getKeyboardHeight() < AndroidUtilities.dp(20.0f)) {
                org.telegram.ui.Components.qc t10 = new org.telegram.ui.Components.yc(org.telegram.ui.Components.lb.a(wnVar.getParentActivity()), wnVar.f39454ea).t(AndroidUtilities.replaceTags(LocaleController.getString(R.string.MessageSeenTooltipMessage)), null);
                wnVar.f39555n1 = t10;
                t10.f27571j = 4000;
                t10.j();
                SharedConfig.updateMessageSeenHintCount(SharedConfig.messageSeenHintCount - 1);
            }
            org.telegram.ui.Components.wl0 wl0Var = this.f34515b;
            wl0Var.requestLayout();
            this.f34516c.requestLayout();
            wl0Var.getAdapter().l();
