...
public final class jd1 extends tu0 {
    public final MediaController.PhotoEntry f34866a;
    public final kd1 f34867b;

    public jd1(kd1 kd1Var, MediaController.PhotoEntry photoEntry) {
        this.f34867b = kd1Var;
        this.f34866a = photoEntry;
    }

    @Override
    public final void o(int i10, VideoEditedInfo videoEditedInfo, boolean z10, int i11, int i12, boolean z11) {
        wd1 wd1Var = this.f34867b.f35129a;
        MediaController.PhotoEntry photoEntry = this.f34866a;
        if (photoEntry.imagePath != null) {
            ...
            wd1Var.f38792b2 = 0;
            wd1Var.f38848x0.requestLayout();
            wd1Var.b1(false);
            wd1Var.f38846w1 = null;
            wd1Var.i1();
        }
    }
