...
public final class mc extends org.telegram.ui.Components.rl0 {
    ...
    @Override
    public final int h() {
        return this.f38947c.O;
    }

    @Override
    public final int j(int i10) {
        bd bdVar = this.f38947c;
        if (i10 == bdVar.P) {
            return 0;
        }
        if (i10 == bdVar.T) {
        ...
        if (i10 != bdVar.R && i10 != bdVar.Z && i10 != bdVar.f35441c0 && i10 != bdVar.f35444e0 && i10 != bdVar.f35447g0) {
            if (i10 != bdVar.U && i10 != bdVar.f35439b0) {
                return 7;
            }
            return 5;
        }
    ...
    public final void v(f2.m1 m1Var, int i10) {
        ...
        if (i16 != 1) {
            if (i16 != 3) {
                if (i16 != 4) {
                    if (i16 != 5) {
                        ...
                        if (i10 == bdVar.R) {
                            ...
                            if (bdVar.f35438b < bdVar.J0()) {
                                ncVar.e(bdVar.J0());
                            } else {
                                ncVar.e(0);
                            }
                            ncVar.c(bdVar.f35465w, false, false);
                            return;
                        } else if (i10 == bdVar.f35441c0) {
                            i13 = ((org.telegram.ui.ActionBar.p2) bdVar).currentAccount;
                            ncVar.a(i13, bdVar.f35460s, false);
                            l5Var.l(LocaleController.getString(bdVar.G0()), false);
                            if (bdVar.f35438b < bdVar.F0()) {
                                ncVar.e(bdVar.F0());
                            } else {
                                ncVar.e(0);
                            }
                            ncVar.c(DialogObject.getEmojiStatusDocumentId(bdVar.f35467y), DialogObject.isEmojiStatusCollectible(bdVar.f35467y), false);
                            return;
                        } else if (i10 == bdVar.f35444e0) {
                            i12 = ((org.telegram.ui.ActionBar.p2) bdVar).currentAccount;
                            ncVar.a(i12, bdVar.f35460s, false);
                            l5Var.l(LocaleController.getString(bdVar.B0()), false);
                            if (bdVar.f35438b < bdVar.H0()) {
                                ncVar.e(bdVar.H0());
                            } else {
                                ncVar.e(0);
                            }
                ...
                ((kp0) view).a(bdVar.f35460s, false);
                return;
            }
            ((rc) view).a(bdVar.f35445f, false);
            return;
        }
        tc tcVar = (tc) view;
        to0 to0Var = tcVar.f41502a;
        sc scVar = tcVar.f41503b;
        i11 = ((org.telegram.ui.ActionBar.p2) bdVar).currentAccount;
        to0Var.b(i11, bdVar.f35460s, false);
        scVar.b(bdVar.f35460s, false);
        scVar.d(bdVar.f35465w, false, false);
        scVar.setForum(bdVar.R0());
        scVar.e(DialogObject.getEmojiStatusDocumentId(bdVar.f35467y), false, false);
        scVar.a(bdVar.f35445f);
    }
    ...
    public final f2.m1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 == 0) {
                ...
                public final void run(Object obj) {
                    switch (r2) {
                        case 0:
                            ...
                            bd bdVar2 = this.f38609b.f38947c;
                            if (str == null) {
                                bdVar2.C = bdVar2.D;
                            } else if (str.equals("❌")) {
                                bdVar2.C = null;
                                ...
                                tL_wallPaperNoFile.f20997id = 0L;
                            ...
                            return;
                        default:
                            bd bdVar3 = this.f38609b.f38947c;
                            bdVar3.f35460s = ((Integer) obj).intValue();
                            if (bdVar3.f35467y instanceof TLRPC.TL_emojiStatusCollectible) {
                                bdVar3.f35467y = null;
                            }
                            bdVar3.X0(true);
                            bdVar3.b1();
            ...
            frameLayout.f39290c = new org.telegram.ui.Components.j5(AndroidUtilities.dp(24.0f), 13, frameLayout, false);
            zcVar = frameLayout;
        } else if (i10 == 3) {
            ...
            rcVar.f40810b.setOnItemClickListener(new hg.v0(5, this, rcVar));
            zcVar = rcVar;
        } else if (i10 == 4) {
            ...
            zcVar = new vo0(parentActivity7, g6Var2, false);
        } else if (i10 == 10) {
    ...
    public final void y(f2.m1 m1Var) {
        ...
        bd bdVar = this.f38947c;
        if (z4) {
            sc scVar = ((tc) view).f41503b;
            TLRPC.EmojiStatus emojiStatus = bdVar.f35467y;
            if (emojiStatus instanceof TLRPC.TL_emojiStatusCollectible) {
                scVar.c(MessagesController.PeerColor.fromCollectible(emojiStatus), false);
                scVar.d(((TLRPC.TL_emojiStatusCollectible) bdVar.f35467y).pattern_document_id, true, false);
            } else {
                scVar.b(bdVar.f35460s, false);
                scVar.d(bdVar.f35465w, false, false);
            }
            scVar.e(DialogObject.getEmojiStatusDocumentId(bdVar.f35467y), DialogObject.isEmojiStatusCollectible(bdVar.f35467y), false);
            scVar.setForum(bdVar.R0());
            scVar.a(bdVar.f35445f);
