...
public final class rw0 implements Utilities.Callback {
    public final int f42214a;
    public final tw0 f42215b;
    ...
    public final void run(Object obj) {
        ...
        switch (this.f42214a) {
            case 0:
                PrivacyControlActivity privacyControlActivity = this.f42215b.d;
                privacyControlActivity.H = ((Integer) obj).intValue();
                AndroidUtilities.updateVisibleRow(privacyControlActivity.d, privacyControlActivity.f35947f0);
            ...
            default:
                ...
                privacyControlActivity2.getConnectionsManager().sendRequest(updatebirthday, new jr0(tw0Var, userFull, tL_birthday, 1), 1024);
