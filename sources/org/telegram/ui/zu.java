...
public final class zu extends org.telegram.ui.ActionBar.n2 {
    ...
    public static final int[] f40297f = {R.drawable.msg_filled_data_videos, R.drawable.msg_filled_data_files, R.drawable.msg_filled_data_photos, R.drawable.msg_filled_data_messages, R.drawable.msg_filled_data_music, R.drawable.msg_filled_data_voice, R.drawable.msg_filled_data_calls};
    ...
    public static final int[] f40298n = {2, 5, 4, 1, 7, 3, 0};
    public org.telegram.ui.Components.i81 f40299a;
    public org.telegram.ui.Components.h81 f40300b;
    ...
    public final View createView(Context context) {
        ...
        int i10 = org.telegram.ui.ActionBar.i6.f19186w8;
        kVar.setBackgroundColor(getThemedColor(i10));
        org.telegram.ui.ActionBar.k kVar2 = this.actionBar;
        int i11 = org.telegram.ui.ActionBar.i6.G6;
        kVar2.setTitleColor(getThemedColor(i11));
        this.actionBar.B(getThemedColor(i11), false);
        this.actionBar.A(getThemedColor(org.telegram.ui.ActionBar.i6.f18926i6), false);
        this.actionBar.setCastShadows(false);
        this.actionBar.setActionBarMenuOnItemClick(new to(this, 19));
        j0 j0Var = new j0(this, context, 6);
        j0Var.setBackgroundColor(getThemedColor(org.telegram.ui.ActionBar.i6.f18780a7));
        org.telegram.ui.Components.i81 i81Var = new org.telegram.ui.Components.i81(context, null);
        this.f40299a = i81Var;
        i81Var.setAdapter(new wu(this));
        org.telegram.ui.Components.h81 n10 = this.f40299a.n(8, true);
        this.f40300b = n10;
        n10.setBackgroundColor(getThemedColor(i10));
        j0Var.addView(this.f40300b, w7.x5.e(-1, 48, 55));
        j0Var.addView(this.f40299a, w7.x5.d(-1, -1.0f, 119, 0.0f, 48.0f, 0.0f, 0.0f));
    ...
    public final boolean isLightStatusBar() {
        ...
        if (AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f19186w8, false)) <= 0.721f) {
            return false;
        }
        return true;
    }
    ...
    public final boolean isSwipeBackEnabled(MotionEvent motionEvent) {
        ...
        if (this.f40299a.getCurrentPosition() == 0) {
            return true;
        }
        return false;
    }
    ...
    public final void r0() {
        View currentView = this.f40299a.getCurrentView();
