            ...
            case 0:
                ...
                if (starGift == null) {
                    ...
                    if (v3Var2 == null || v3Var2.f46450b != starGift.f18560id) {
                        ...
                        xh.v3 v3Var3 = new xh.v3(np0Var3.K.f18560id, i10, new fp0(gp0Var, 2));
                        np0Var3.J = v3Var3;
                        v3Var3.g(false);
                    }
                }
                ...
                return;
            case 1:
                np0 np0Var4 = this.f33738b.e;
                np0Var4.h = ((Integer) obj).intValue();
                np0Var4.f35955r = null;
                np0Var4.f35956s = null;
                np0Var4.I = null;
                np0Var4.j(true);
                np0Var4.i();
                np0Var4.f(true);
                mp0 mp0Var = np0Var4.f35959y;
                if (mp0Var != null) {
                    mp0Var.invalidate();
                }
                tp0 tp0Var2 = np0Var4.f35954p0;
                np0 np0Var5 = tp0Var2.f38178n;
                if (np0Var5 != null && (rp0Var = np0Var5.f35935a) != null && (np0Var2 = tp0Var2.h) != null) {
                    rp0Var.a(np0Var2.h);
                    return;
                }
                return;
