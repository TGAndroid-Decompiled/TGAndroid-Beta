...
public final class q51 implements org.telegram.ui.Components.ol0 {
    public final int f36798a;
    public final Context f36799b;
    public final org.telegram.ui.ActionBar.d6 f36800c;
    ...
    public final boolean mo18c(float f7, float f10, int i10, View view) {
        ...
        if (i12 != 11 && i12 != 13 && a71Var.f32027h1) {
            ...
            if (z10 && (i12 == 1 || i12 == 8)) {
                ...
                j61 j61Var = (j61) view;
                if (!j61Var.f34667s && !UserConfig.getInstance(i11).isPremium()) {
                ...
                if (j61Var.f34667s) {
                    ...
                    TLRPC.TL_availableReaction tL_availableReaction = MediaDataController.getInstance(i11).getReactionsMap().get(a71Var.S0.f34669x.f49395f);
                    if (tL_availableReaction != null) {
                        a71Var.V0.setImage(ImageLocation.getForDocument(tL_availableReaction.select_animation), "60_60_pcache", null, null, null, 0L, "tgs", a71Var.S0.f34669x, 0);
                    }
                } else {
                ...
                if (j61Var2.e != null && (i12 == 0 || i12 == 12 || i12 == 9 || i12 == 10)) {
                    ...
                    p51 p51Var = new p51(this, this.f36799b, a71Var.T1, a71Var, j61Var2, this.f36800c, view, tL_starGiftUnique);
                    a71Var.X0 = p51Var;
                    p51Var.show();
                    try {
    ...
    public final void g() {
        ...
        if (a71Var.S0 != null) {
            ...
            ofFloat.setInterpolator(org.telegram.ui.Components.sr.f28339f);
            ofFloat.start();
        }
    }
