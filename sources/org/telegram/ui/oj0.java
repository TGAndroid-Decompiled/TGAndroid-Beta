...
public final class oj0 implements Utilities.Callback {
    ...
    public final void run(Object obj) {
        ...
        Object obj2 = this.f36370c;
        Object obj3 = this.f36369b;
        switch (i10) {
            case 0:
                tj0 tj0Var = (tj0) obj3;
            ...
            case 1:
                ...
                if (user2 == null) {
                    ...
                    mutate.setColorFilter(new PorterDuffColorFilter(ek0Var.getThemedColor(org.telegram.ui.ActionBar.j6.f19193v6), PorterDuff.Mode.SRC_IN));
            ...
            case 6:
                ...
                p11Var.f36492c = imageReceiver;
                p11Var.e.add(imageReceiver);
                int f11 = iz.f();
                p11Var.f36492c.setAutoRepeat(0);
                r11 r11Var = p11Var.f36492c;
                ...
                p11Var.f36492c.onAttachedToWindow();
                p11Var.f36494g[1] = true;
                p11Var.a();
                return;
            case 7:
            ...
            case 8:
                ...
                k51Var.f35007f = bitmap;
                Paint paint = new Paint(1);
                k51Var.f35008n = paint;
                Bitmap bitmap2 = k51Var.f35007f;
                ...
                k51Var.f35008n.setColorFilter(new ColorMatrixColorFilter(colorMatrix));
                k51Var.f35009r = new Matrix();
                return;
            case 9:
                ...
                if (!((Boolean) obj).booleanValue()) {
                    ...
                    if (ml0Var != null && ml0Var.G && (L = ml0Var.L(themeActivity.M)) != null) {
                        themeActivity.f31566a.v(L, themeActivity.M);
                        return;
                    }
                    return;
                }
            ...
            case 11:
                ...
                Utilities.Callback callback = z1Var.f39024f;
                if (callback != null) {
                    z1Var.finishFragment();
                    callback.run(e1Var);
                    return;
                }
                nf.f.s(z1Var.getParentActivity(), e1Var.f38786c);
                return;
            case 12:
            ...
            case 15:
                ...
                int i15 = m5Var.f47485a;
                updatestargiftcollection.peer = MessagesController.getInstance(i15).getInputPeer(m5Var.f47486b);
            ...
            case 16:
                ...
                Void r15 = (Void) obj;
                long j3 = y4Var.Z;
                Runnable runnable2 = y4Var.f46246g0;
                if (runnable2 != null) {
                    runnable2.run();
                }
                y4Var.dismiss();
            ...
            case 17:
                ...
                if (stargiftupgradepreview != null) {
                    ...
                    a4Var.f47007u0.setVisibility(8);
                    a4Var.f47006t0.setVisibility(8);
                    dVar.setFilled(true);
            ...
            case 20:
                ...
                if (eVar != null && bVar == f3Var.f47187q) {
                    eVar.c(false);
                }
                f3Var.f47186p.remove(bVar);
                if (tL_payments_paymentFormStarGift != null) {
                    f3Var.f47185o.put(bVar, new yh.d3(bVar, tL_payments_paymentFormStarGift));
                    f3Var.a(true);
                    return;
                }
                return;
