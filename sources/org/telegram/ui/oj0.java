...
public final class oj0 implements Utilities.Callback {
    ...
    public final void run(Object obj) {
        ...
        Object obj2 = this.f39298c;
        Object obj3 = this.f39297b;
        switch (i10) {
            case 0:
                tj0 tj0Var = (tj0) obj3;
            ...
            case 1:
                ...
                if (user2 == null) {
                    ...
                    mutate.setColorFilter(new PorterDuffColorFilter(ek0Var.getThemedColor(org.telegram.ui.ActionBar.j6.f21018v6), PorterDuff.Mode.SRC_IN));
            ...
            case 6:
                ...
                p11Var.f39413c = imageReceiver;
                p11Var.f39414e.add(imageReceiver);
                int f11 = gz.f();
                p11Var.f39413c.setAutoRepeat(0);
                r11 r11Var = p11Var.f39413c;
                ...
                p11Var.f39413c.onAttachedToWindow();
                p11Var.f39416g[1] = true;
                p11Var.a();
                return;
            case 7:
            ...
            case 8:
                ...
                k51Var.f37954f = bitmap;
                Paint paint = new Paint(1);
                k51Var.f37955n = paint;
                Bitmap bitmap2 = k51Var.f37954f;
                ...
                k51Var.f37955n.setColorFilter(new ColorMatrixColorFilter(colorMatrix));
                k51Var.f37956r = new Matrix();
                return;
            case 9:
                ...
                if (!((Boolean) obj).booleanValue()) {
                    ...
                    if (ll0Var != null && ll0Var.G && (K = ll0Var.K(themeActivity.M)) != null) {
                        themeActivity.f34202a.v(K, themeActivity.M);
                        return;
                    }
                    return;
                }
            ...
            case 11:
                ...
                Utilities.Callback callback = a2Var.f42029e;
                if (callback != null) {
                    a2Var.finishFragment();
                    callback.run(e1Var);
                    return;
                }
                of.f.s(a2Var.getParentActivity(), e1Var.f42106c);
                return;
            case 12:
            ...
            case 15:
                ...
                int i15 = i5Var.f52065a;
                updatestargiftcollection.peer = MessagesController.getInstance(i15).getInputPeer(i5Var.f52066b);
            ...
            case 16:
                ...
                Void r12 = (Void) obj;
                long j3 = x4Var.Z;
                Runnable runnable2 = x4Var.f50664g0;
                if (runnable2 != null) {
                    runnable2.run();
                }
                x4Var.dismiss();
            ...
            case 17:
                ...
                if (stargiftupgradepreview != null) {
                    ...
                    w3Var.f52821u0.setVisibility(8);
                    w3Var.f52820t0.setVisibility(8);
                    dVar.setFilled(true);
            ...
            case 20:
                ...
                if (eVar != null && bVar == c3Var.f51781q) {
                    eVar.c(false);
                }
                c3Var.f51780p.remove(bVar);
                if (tL_payments_paymentFormStarGift != null) {
                    c3Var.f51779o.put(bVar, new zh.a3(bVar, tL_payments_paymentFormStarGift));
                    c3Var.a(true);
                    return;
                }
                return;
