...
public final class nh1 extends org.telegram.ui.Cells.i3 {
    public final int f38987x;
    public final UserInfoActivity f38988y;
    ...
    public final void b(Editable editable) {
        switch (this.f38987x) {
            case 0:
                this.f38988y.b0(true);
                return;
            case 1:
                this.f38988y.b0(true);
                return;
            default:
                UserInfoActivity userInfoActivity = this.f38988y;
