...
public final class nh1 implements Utilities.Callback {
    ...
    public final UserInfoActivity f36112b;

    public nh1(UserInfoActivity userInfoActivity, int i10) {
        this.f36111a = i10;
        this.f36112b = userInfoActivity;
    }
    ...
    public final void run(Object obj) {
        switch (this.f36111a) {
            case 0:
                UserInfoActivity userInfoActivity = this.f36112b;
                userInfoActivity.K = (TL_account.TL_birthday) obj;
                org.telegram.ui.Components.z51 z51Var = userInfoActivity.f31620y;
                if (z51Var != null) {
                    z51Var.Y2.N(true);
                }
            ...
            default:
                ...
                UserInfoActivity userInfoActivity2 = this.f36112b;
                if (userInfoActivity2.L != chat) {
                    ...
                    org.telegram.ui.Components.z51 z51Var2 = userInfoActivity2.f31620y;
                    if (z51Var2 != null) {
                        z51Var2.Y2.N(true);
                        return;
                    }
