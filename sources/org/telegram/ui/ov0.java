...
public class ov0 {
    ...
    public final ViewGroup f39327a;
    public final ViewGroup f39328b;
    public final boolean f39329c;
    public nv0 d;
    public View f39330e;
    public ImageReceiver f39331f;
    public ImageReceiver f39332g;
    public ImageReceiver h;
    public boolean f39333i;
    public final wh.h f39334j;
    public wh.g f39335k;
    public final Path f39336l;
    public final float[] f39337m;
    ...
    public float v;
    public float f39346w;
    public float f39347x;
    public float f39348y;
    public float f39349z;

    public ov0(ViewGroup viewGroup, ViewGroup viewGroup2) {
        this.f39332g = new ImageReceiver();
        this.h = new ImageReceiver();
        this.f39334j = new wh.h();
        this.f39336l = new Path();
        this.f39337m = new float[8];
        this.Q = new float[2];
        this.f39327a = viewGroup;
        this.f39328b = viewGroup2;
        this.f39329c = false;
    }
            ...
            if (motionEvent.getActionMasked() == 2 && this.L) {
                ...
                if (i15 != -1 && i16 != -1) {
                    ...
                    if (hypot > 1.005f && !this.f39338n) {
                        ...
                        this.f39330e = viewGroup;
                        this.D = messageObject;
                        nv0 nv0Var = this.d;
                        ViewGroup viewGroup2 = this.f39327a;
                        ...
                        if (this.f39332g == null) {
                            ...
                            this.f39332g = imageReceiver2;
                            imageReceiver2.setCrossfadeAlpha((byte) 2);
                            this.f39332g.setCrossfadeWithOldImage(false);
                            this.f39332g.onAttachedToWindow();
                        ...
                        if (!z11) {
                            ...
                            this.f39333i = z10;
                            if (z10 && this.f39335k == null) {
                                wh.g e7 = wh.g.e(this.d);
                                this.f39335k = e7;
                                if (e7 != null) {
                                    e7.f48611k.put(this.d, Integer.valueOf(i10));
                                }
                            }
                            ...
                            if (imageReceiver.getBitmap() != null && !imageReceiver.getBitmap().isRecycled() && this.f39333i) {
                            ...
                            if (messageObject == null || !messageObject.isPhoto()) {
                                ...
                                if (imageLocation != null) {
                                    i11 = i16;
                                    i14 = i15;
                                    this.f39332g.setImage(imageLocation, null, null, null, null, iArr[0], null, messageObject, messageObject.isWebpage() ? 1 : 0);
                                    this.f39332g.setCrossfadeAlpha((byte) 2);
                                } else {
                                    i14 = i15;
                                    i11 = i16;
                                }
                            ...
                            this.f39345u = imageReceiver.getImageX();
                            this.v = imageReceiver.getImageY() + viewGroup.getPaddingTop();
                            this.f39346w = imageReceiver.getImageHeight();
                            this.f39347x = imageReceiver.getImageWidth();
                            this.f39348y = imageReceiver.getBitmapHeight();
                            float bitmapWidth = imageReceiver.getBitmapWidth();
                            this.f39349z = bitmapWidth;
                            float f7 = this.f39348y;
                            float f10 = f7 / bitmapWidth;
                            float f11 = this.f39346w;
                            float f12 = this.f39347x;
                            float f13 = f11 / f12;
                            if (f10 != f13) {
                                if (f10 < f13) {
                                    this.f39349z = (bitmapWidth / f7) * f11;
                                    this.f39348y = f11;
                                } else {
                                    this.f39348y = f10 * f12;
                                    this.f39349z = f12;
                                }
                            } else {
                                this.f39348y = f11;
                            ...
                            if (messageObject != null && messageObject.isVideo() && MediaController.getInstance().isPlayingMessage(messageObject)) {
                                ...
                                nv0 nv0Var3 = this.d;
                                mediaController.setTextureView(nv0Var3.f39042b, nv0Var3.f39043c, nv0Var3.f39041a, true);
                                FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) this.d.f39041a.getLayoutParams();
                                this.d.f39041a.setTag(R.id.parent_tag, imageReceiver);
                                if (layoutParams.width != imageReceiver.getImageWidth() || layoutParams.height != imageReceiver.getImageHeight()) {
                                    this.d.f39043c.setResizeMode(3);
                                    layoutParams.width = (int) imageReceiver.getImageWidth();
                                    layoutParams.height = (int) imageReceiver.getImageHeight();
                                    this.d.f39041a.setLayoutParams(layoutParams);
                                }
                                this.d.f39042b.setScaleX(1.0f);
                                this.d.f39042b.setScaleY(1.0f);
                                kv0 kv0Var = this.E;
                                if (kv0Var != null) {
                                    this.d.d.setImageBitmap(kv0Var.i0().getBitmap((int) this.f39349z, (int) this.f39348y));
                                    this.d.d.s((int) this.f39349z, (int) this.f39348y);
                                    this.d.d.getImageReceiver().setRoundRadius(imageReceiver.getRoundRadius(true));
                                }
                                this.d.f39041a.setVisibility(0);
                            } else {
                                this.R = false;
                                ImageReceiver imageReceiver5 = new ImageReceiver();
                                this.f39331f = imageReceiver5;
                                imageReceiver5.onAttachedToWindow();
                                Drawable drawable = imageReceiver.getDrawable();
                                this.f39331f.setImageBitmap(drawable);
                                ...
                                this.f39331f.setImageCoords(this.f39345u, this.v, this.f39347x, this.f39346w);
                                this.f39331f.setAspectFit(imageReceiver.isAspectFit());
                                this.f39331f.setRoundRadius(imageReceiver.getRoundRadius(true));
                                this.f39332g.setRoundRadius(imageReceiver.getRoundRadius(true));
                                this.f39332g.setAspectFit(imageReceiver.isAspectFit());
                                this.d.f39041a.setVisibility(8);
                            }
                        } else {
                            i14 = i15;
                            i11 = i16;
    ...
    public final void b() {
        ...
        if (nv0Var != null && nv0Var.getParent() != null) {
            this.f39327a.removeView(this.d);
            this.d.d.getImageReceiver().clearImage();
            wh.g gVar = this.f39335k;
            if (gVar != null) {
                gVar.b(this.d);
                this.f39335k = null;
            }
            ImageReceiver imageReceiver = this.f39331f;
        ...
        View view = this.f39330e;
        if (view != null) {
            view.invalidate();
            this.f39330e = null;
        }
        ImageReceiver imageReceiver2 = this.f39331f;
        if (imageReceiver2 != null) {
            imageReceiver2.onDetachedFromWindow();
            this.f39331f.clearImage();
            this.f39331f = null;
        }
        ImageReceiver imageReceiver3 = this.f39332g;
        if (imageReceiver3 != null) {
            imageReceiver3.onDetachedFromWindow();
            this.f39332g.clearImage();
            this.f39332g = null;
        }
        ImageReceiver imageReceiver4 = this.h;
    ...
    public final void d() {
        if (this.C == null && this.f39338n) {
            ...
            this.C.setInterpolator(org.telegram.ui.Components.pr.f29467f);
            this.C.start();
        }
    }
    ...
    public void e() {
        View view;
        if (this.f39329c && (view = this.f39330e) != null) {
            view.invalidate();
        }
        nv0 nv0Var = this.d;
        if (nv0Var != null) {
    ...
    public final boolean f(View view) {
        if (this.f39338n && view == this.f39330e) {
            return true;
        }
        return false;
    }
    ...
    public final boolean g(MotionEvent motionEvent) {
        if (i() && this.f39330e != null) {
            motionEvent.offsetLocation(-this.f39341q, -this.f39342r);
            return this.f39330e.onTouchEvent(motionEvent);
        }
        return false;
    }
    ...
    public final boolean i() {
        ...
        float f10 = 0.0f;
        float f11 = 0.0f;
        for (View view = this.f39330e; view != this.f39327a; view = (View) view.getParent()) {
            if (view == null) {
                return false;
            }
            f10 += view.getLeft();
        ...
        float f12 = 0.0f;
        for (View view2 = this.f39330e; view2 != this.f39328b; view2 = (View) view2.getParent()) {
            if (view2 == null) {
                return false;
            }
            f7 += view2.getLeft();
    ...
    public boolean j(View view, ImageReceiver imageReceiver) {
        if (!this.f39329c) {
            if (imageReceiver.getDrawable() instanceof org.telegram.ui.Components.d6) {
                AnimatedFileDrawableStream animatedFileDrawableStream = ((org.telegram.ui.Components.d6) imageReceiver.getDrawable()).f25268u0;
