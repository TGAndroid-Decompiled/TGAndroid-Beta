...
public final class ov0 extends org.telegram.ui.Cells.d6 {
    ...
    public final boolean e() {
        ...
        if (T != null) {
            int b10 = T.b();
            int i10 = rv0Var.f37527y;
            if (i10 == rv0Var.f37511n && b10 == (rv0Var.f37512n0 + i10) - 1) {
                return false;
            }
        }
        return true;
    ...
    public final boolean f(org.telegram.ui.Cells.d6 d6Var) {
        ...
        if (T != null && (b10 = T.b()) != -1) {
            return rv0Var.f37523w[b10 - rv0Var.f37512n0];
        }
        return false;
    }
    ...
    public final void h(org.telegram.ui.Cells.d6 d6Var, boolean z10) {
        ...
        rv0 rv0Var = this.F.d;
        if (z10 && rv0Var.L) {
            Arrays.fill(rv0Var.f37523w, false);
            rv0Var.f37499c.getChildCount();
            for (int i10 = rv0Var.f37512n0; i10 < rv0Var.f37512n0 + rv0Var.f37527y; i10++) {
                s4.c1 K = rv0Var.f37499c.K(i10);
                if (K != null) {
                    View view = K.f42959a;
        ...
        if (T != null && (b10 = T.b()) != -1) {
            rv0Var.f37523w[b10 - rv0Var.f37512n0] = z10;
        }
        rv0Var.i0();
    }
    ...
    public final boolean l(ArrayList arrayList) {
        ...
        if (!arrayList.isEmpty()) {
            rv0Var.f37499c.getClass();
            int R = RecyclerView.R(this) - rv0Var.f37512n0;
            if (R >= 0) {
                org.telegram.ui.Cells.c6 c6Var = this.d;
                c6Var.getText().replace(c6Var.getSelectionStart(), c6Var.getSelectionEnd(), (CharSequence) arrayList.remove(0));
                int i10 = R + 1;
                while (!arrayList.isEmpty() && i10 < rv0Var.f37511n) {
                ...
                rv0Var.r0();
                rv0Var.f37505g0 = (rv0Var.f37512n0 + i10) - 1;
                rv0Var.f37497b.l();
                return true;
            }
        }
