...
public final class km implements ViewTreeObserver.OnPreDrawListener {
    public final org.telegram.ui.Cells.u1 f35227a;
    public final lm f35228b;
    ...
    public final boolean onPreDraw() {
        float f7;
        float centerX;
        zn znVar = this.f35228b.Q;
        org.telegram.ui.Cells.u1 u1Var = this.f35227a;
        ...
        float f10 = sendAnimationData.f15835x;
        float f11 = iArr[0];
        if (sendAnimationData.fromPreview) {
            centerX = 0.0f;
        } else {
