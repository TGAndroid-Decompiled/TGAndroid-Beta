...
public final class tu0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final ai.w5 f37759b;
    public final org.telegram.ui.ActionBar.i5[] f37760c;
    public final org.telegram.ui.Components.p6 d;
    public AnimatorSet e;
    public AnimatorSet f37761f;
    public boolean h;
    public ValueAnimator f37762n;
    ...
    public tu0(Activity activity) {
        ...
        this.f37760c = new org.telegram.ui.ActionBar.i5[2];
        for (int i10 = 0; i10 < 2; i10++) {
            this.f37760c[i10] = new org.telegram.ui.ActionBar.i5(activity);
            this.f37760c[i10].setGravity(19);
            this.f37760c[i10].setTextColor(-1);
            this.f37760c[i10].setTextSize(20);
            this.f37760c[i10].setTypeface(AndroidUtilities.bold());
            this.f37760c[i10].setDrawablePadding(AndroidUtilities.dp(4.0f));
            this.f37760c[i10].setScrollNonFitText(true);
            this.f37759b.addView(this.f37760c[i10], w7.x5.e(-1, -2, 19));
        }
        ...
        this.f37758a.addView(p6Var, w7.x5.d(-1, 20.0f, 51, 16.0f, 0.0f, 0.0f, 0.0f));
    }
    ...
    public final void a(CharSequence charSequence, boolean z10) {
        ...
        if (z12 != z13) {
            this.h = z12;
            AnimatorSet animatorSet = this.f37761f;
            if (animatorSet != null) {
                animatorSet.cancel();
            }
            ...
            if (z10) {
                ...
                this.f37761f = animatorSet2;
                animatorSet2.playTogether(arrayList);
                this.f37761f.setInterpolator(org.telegram.ui.Components.rr.h);
                this.f37761f.start();
            } else {
                if (!isEmpty) {
                    f7 = 1.0f;
    ...
    public final void b(boolean z10) {
        int i10;
        int i11;
        org.telegram.ui.ActionBar.i5[] i5VarArr = this.f37760c;
        int i12 = 0;
    ...
    public final void d(CharSequence charSequence, boolean z10, boolean z11) {
        ...
        i5VarArr[1].setRightPadding((int) this.f37763r);
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        this.f37758a.layout(0, AndroidUtilities.statusBarHeight, i12 - i10, i13 - i11);
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f37758a.measure(View.MeasureSpec.makeMeasureSpec(size, 1073741824), View.MeasureSpec.makeMeasureSpec(size2 - i12, 1073741824));
