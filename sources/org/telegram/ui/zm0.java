...
public final class zm0 extends org.telegram.ui.Components.vv0 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final LinearLayout f40829c;
    public EditTextBoldCursor[] d;
    public final TextView e;
    public final TextView f40830f;
    public final ImageView h;
    public final gg.q f40831n;
    public final wm0 f40832r;
    public final an0 f40833s;
    public Timer v;
    public Timer f40834w;
    public final Object f40835x;
    public int f40836y;
    ...
    public zm0(dn0 dn0Var, Context context, int i10) {
        ...
        this.f40832r = wm0Var;
        wm0Var.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20140q6, false));
    ...
    public final boolean c(boolean z4) {
        ...
        if (!z4) {
            ...
            alertDialog$Builder.f19503a.Q = LocaleController.getString(R.string.StopVerification);
        ...
        tL_auth_cancelCode.phone_number = this.f40827a;
        tL_auth_cancelCode.phone_code_hash = this.f40828b;
    ...
    public final void h(String str) {
        ...
        if (TextUtils.isEmpty(code)) {
            AndroidUtilities.shakeView(this.f40829c);
            return;
        }
        this.G = true;
        int i11 = this.I;
        ...
        verifyphone.phone_number = this.f40827a;
        verifyphone.phone_code = code;
        verifyphone.phone_code_hash = this.f40828b;
        s();
        dn0Var.y1();
        i10 = ((org.telegram.ui.ActionBar.p2) dn0Var).currentAccount;
    ...
    @Override
    public final void j() {
        LinearLayout linearLayout = this.f40829c;
    ...
    public final void m(Bundle bundle, boolean z4) {
        ...
        if (bundle != null) {
            ...
            this.f40827a = bundle.getString("phone");
            this.f40828b = bundle.getString("phoneHash");
            ...
            if (editTextBoldCursorArr != null && editTextBoldCursorArr.length == this.L) {
                ...
                for (final int i21 = 0; i21 < this.L; i21++) {
                    ...
                    mutate.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20049l6, false), PorterDuff.Mode.MULTIPLY));
                    ...
                    this.f40829c.addView(editTextBoldCursor2, k7.b6.t(34, 36, 1, 0, 0, i10, 0));
                    this.d[i21].addTextChangedListener(new xm0(this, i21));
                        ...
                        public final boolean onKey(View view, int i23, KeyEvent keyEvent) {
                            ...
                            if (i23 == 67) {
                                ...
                                if (editTextBoldCursorArr3[i24].length() == 0 && i24 > 0) {
                                    int i25 = i24 - 1;
                                    EditTextBoldCursor editTextBoldCursor3 = zm0Var.d[i25];
                                    editTextBoldCursor3.setSelection(editTextBoldCursor3.length());
                                    zm0Var.d[i25].requestFocus();
                                    zm0Var.d[i25].dispatchKeyEvent(keyEvent);
                                    return true;
                                }
                                return false;
                            }
            ...
            if (an0Var != null) {
                ...
                an0Var.setVisibility(i15);
            }
            if (this.f40827a == null) {
                return;
            }
            String j10 = org.telegram.messenger.y3.j(new StringBuilder("+"), this.f40827a, se.b.c());
            if (i17 == 2) {
            ...
            wm0 wm0Var = this.f40832r;
            gg.q qVar = this.f40831n;
            if (i17 == 3) {
                int i23 = this.J;
                i11 = 2;
                if (i23 == 4 || i23 == 2) {
            ...
            if (i17 == i11 && ((i13 = this.J) == 4 || i13 == 3)) {
                ...
                if (this.f40836y < 1000) {
                    i14 = 0;
                } else {
                    i14 = 8;
                }
                wm0Var.setVisibility(i14);
                if (this.f40836y < 1000) {
                    i16 = 8;
                }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.I != 3 && (imageView = this.h) != null) {
            int dp = AndroidUtilities.dp(35.0f) + this.e.getMeasuredHeight() + this.f40830f.getMeasuredHeight() + imageView.getMeasuredHeight();
            int dp2 = AndroidUtilities.dp(80.0f);
            int dp3 = AndroidUtilities.dp(291.0f);
            dn0 dn0Var = this.N;
            if (dn0Var.f33715p0 - dp < dp2) {
                setMeasuredDimension(getMeasuredWidth(), dp + dp2);
            } else {
                setMeasuredDimension(getMeasuredWidth(), Math.min(dn0Var.f33715p0, dp3));
            }
        }
    }

    public final void p() {
        if (this.f40834w != null) {
            return;
        }
        this.B = 15000;
        this.f40834w = new Timer();
        this.D = System.currentTimeMillis();
        this.f40834w.schedule(new org.telegram.ui.Components.g50(this, 2), 0L, 1000L);
    }
    ...
    public final void r() {
        try {
            synchronized (this.f40835x) {
                Timer timer = this.f40834w;
                if (timer != null) {
                    timer.cancel();
                    this.f40834w = null;
                }
    ...
    public final void t() {
        ...
        bundle.putString("phone", this.f40827a);
        this.G = true;
        dn0 dn0Var = this.N;
        dn0Var.y1();
        TLRPC.TL_auth_resendCode tL_auth_resendCode = new TLRPC.TL_auth_resendCode();
        tL_auth_resendCode.phone_number = this.f40827a;
        tL_auth_resendCode.phone_code_hash = this.f40828b;
        i10 = ((org.telegram.ui.ActionBar.p2) dn0Var).currentAccount;
