...
public final class zm0 implements RequestDelegate {
    ...
    public final void run(TLObject tLObject, final TLRPC.TL_error tL_error) {
        switch (this.f43465a) {
            case 0:
                AndroidUtilities.runOnUIThread(new an0(this.f43466b, tLObject, tL_error));
                return;
            case 1:
                final bn0 bn0Var = this.f43466b;
                        ...
                        switch (r3) {
                            ...
                            default:
                                ...
                                if (tL_error3 != null && "SRP_ID_INVALID".equals(tL_error3.text)) {
                                    ...
                                    i11 = ((org.telegram.ui.ActionBar.n2) bn0Var3.f34850e).currentAccount;
                ...
                return;
            case 2:
                final bn0 bn0Var2 = this.f43466b;
                AndroidUtilities.runOnUIThread(new Runnable() {
                    @Override
                    public final void run() {
                        int i10;
                ...
                return;
            case 3:
                AndroidUtilities.runOnUIThread(new an0(this.f43466b, tL_error, tLObject, 1));
                return;
            default:
                AndroidUtilities.runOnUIThread(new an0(this.f43466b, tL_error, tLObject, 2));
                return;
        }
    }
}
