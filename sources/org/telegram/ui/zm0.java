...
public final class zm0 implements RequestDelegate {
    ...
    public final void run(TLObject tLObject, final TLRPC.TL_error tL_error) {
        switch (this.f43492a) {
            case 0:
                AndroidUtilities.runOnUIThread(new an0(this.f43493b, tLObject, tL_error));
                return;
            case 1:
                final bn0 bn0Var = this.f43493b;
                    ...
                    public final void run() {
                        ...
                        switch (r3) {
                            case 0:
                                ...
                                if (pn0Var.f39632y == null) {
                                    pn0Var.f39632y = new TL_account.authorizationForm();
                                }
                                bn0Var2.a();
                                return;
                            default:
                                ...
                                if (tL_error3 != null && "SRP_ID_INVALID".equals(tL_error3.text)) {
                                    ...
                                    i11 = ((org.telegram.ui.ActionBar.n2) bn0Var3.f34877e).currentAccount;
                                    ConnectionsManager.getInstance(i11).sendRequest(getpassword2, new zm0(bn0Var3, 3), 8);
                                    return;
                                }
                                Utilities.globalQueue.postRunnable(new pf0(bn0Var3, bn0Var3.f34875b, bn0Var3.d, 12));
                                return;
                        }
                    }
                });
                return;
            case 2:
                final bn0 bn0Var2 = this.f43493b;
                AndroidUtilities.runOnUIThread(new Runnable() {
                    @Override
                    public final void run() {
                        int i10;
                ...
                return;
            case 3:
                AndroidUtilities.runOnUIThread(new an0(this.f43493b, tL_error, tLObject, 1));
                return;
            default:
                AndroidUtilities.runOnUIThread(new an0(this.f43493b, tL_error, tLObject, 2));
                return;
        }
    }
}
