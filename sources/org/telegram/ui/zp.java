...
public final class zp implements NotificationCenter.NotificationCenterDelegate {
    ...
    public long Z;
    public int f40251a;
    public View f40252a0;
    public int f40253b;
    public boolean f40254b0;
    public int f40255c;
    public final org.telegram.ui.Components.vq f40256c0;
    public float d;
    public final int[] f40257d0;
    public final Paint e;
    public final int f40258e0;
    public final TextPaint f40259f;
    public final int f40260f0;
    public final int f40261g0;
    public final TextPaint h;
    public final long f40262h0;
    public final long f40263i0;
    public final org.telegram.ui.ActionBar.e6 f40264j0;
    public org.telegram.ui.Components.o5 f40265k0;
    public final Paint f40266n;
    public final Path f40267r;
    public StaticLayout f40268s;
    public StaticLayout v;
    public StaticLayout f40269w;
    public int f40270x;
    public int f40271y;
    ...
    public static TLRPC.Dialog c(long j3, int i10, int i11, boolean z10, int[] iArr) {
        ...
        if (dialogs != null) {
            for (int i13 = 0; i13 < dialogs.size(); i13++) {
                ...
                TLRPC.Chat chat = messagesController.getChat(Long.valueOf(-dialog.f18113id));
                if (chat != null && dialog.f18113id != j3 && dialog.unread_count > 0 && DialogObject.isChannel(dialog) && !chat.megagroup && !messagesController.isPromoDialog(dialog.f18113id, false) && messagesController.getRestrictionReason(chat.restriction_reason) == null) {
                    return dialog;
                }
            }
            if (z10) {
                if (i11 != 0) {
                    ...
                    while (i14 < messagesController.dialogFilters.size()) {
                        int i15 = messagesController.dialogFilters.get(i14).f15601id;
                        if (i11 != i15) {
                            long j11 = j3;
                            int i16 = i10;
                            int[] iArr3 = iArr;
    ...
    public final void a(Canvas canvas, uj ujVar, float f7, float f10) {
        ...
        if (this.f40252a0 != ujVar) {
            this.f40252a0 = ujVar;
            org.telegram.ui.Components.o5 o5Var = this.f40265k0;
            if (o5Var != null) {
                o5Var.a(ujVar);
            }
        }
        org.telegram.ui.Components.vq vqVar2 = this.f40256c0;
        vqVar2.H = ujVar;
        RectF rectF3 = vqVar2.f29393f;
        ...
        org.telegram.ui.ActionBar.i6.q(0.0f, ujVar.getMeasuredHeight() - dp, this.f40255c, ujVar.getMeasuredHeight());
        int i17 = org.telegram.ui.ActionBar.i6.f18929ic;
        org.telegram.ui.ActionBar.e6 e6Var = this.f40264j0;
        int v02 = org.telegram.ui.ActionBar.i6.v0(i17, e6Var);
        TextPaint textPaint3 = this.f40259f;
        textPaint3.setColor(v02);
        int v03 = org.telegram.ui.ActionBar.i6.v0(i17, e6Var);
        Paint paint2 = this.e;
        paint2.setColor(v03);
        ...
        org.telegram.ui.ActionBar.i6.f18901h2.setAlpha((int) (alpha2 * f11));
        ...
        if (f28 >= 1.0f && !this.R) {
            ...
            if (this.W) {
                ...
                if (a12) {
                    int alpha6 = org.telegram.ui.ActionBar.i6.f18901h2.getAlpha();
                    org.telegram.ui.ActionBar.i6.f18901h2.setAlpha((int) (alpha6 * f14));
                    float f40 = this.d;
                    canvas2.drawRoundRect(rectF4, f40, f40, org.telegram.ui.ActionBar.i6.f18901h2);
                    org.telegram.ui.ActionBar.i6.f18901h2.setAlpha(alpha6);
                }
            }
            ...
            canvas2.restore();
            if (this.R) {
                float a2 = org.telegram.ui.Cells.q3.a(f15 - AndroidUtilities.dp(2.0f), this.K, (1.0f - this.K) * (((-AndroidUtilities.dp(8.0f)) - (AndroidUtilities.dp2(8.0f) * f7)) - f16), f19);
        ...
        if (this.f40268s != null && this.K > 0.0f) {
            ...
            float f49 = (i16 - this.f40270x) / 2.0f;
            rectF5.set(f49, dp13, this.f40255c - f49, this.f40268s.getHeight() + dp13);
            ...
            if (a14) {
                canvas2.drawRoundRect(rectF5, AndroidUtilities.dp(15.0f), AndroidUtilities.dp(15.0f), org.telegram.ui.ActionBar.i6.f18901h2);
            }
            canvas2.save();
            canvas2.translate((this.f40255c - this.f40270x) / 2.0f, dp13);
            this.f40268s.draw(canvas2);
            canvas2.restore();
        } else {
            textPaint2 = textPaint;
        }
        if (!this.R && f16 > 0.0f) {
            float a10 = org.telegram.ui.Cells.q3.a((-f20) + AndroidUtilities.dp(4.0f), this.K, (1.0f - this.K) * (((-AndroidUtilities.dp(8.0f)) - (AndroidUtilities.dp2(8.0f) * f7)) - f16), f19);
            org.telegram.ui.Components.o5 o5Var2 = this.f40265k0;
            if (o5Var2 == null || (imageReceiver = o5Var2.f26689k) == null) {
            ...
            if (this.X && imageReceiver2.getDrawable() != null && (imageReceiver2.getDrawable() instanceof org.telegram.ui.Components.pq) && (((org.telegram.ui.Components.pq) imageReceiver2.getDrawable()).f27116b instanceof org.telegram.ui.Components.l80)) {
                ((org.telegram.ui.Components.l80) ((org.telegram.ui.Components.pq) imageReceiver2.getDrawable()).f27116b).f25871i = f7;
            }
            if (this.K > 0.0f && this.f40254b0) {
                ...
                vqVar3.e(vqVar3.f29405s);
                canvas2.scale(f52, f52, (vqVar3.f29405s / 2.0f) + vqVar3.A + AndroidUtilities.dp(12.0f) + f18, (a10 - AndroidUtilities.dp(6.0f)) + AndroidUtilities.dp(14.0f));
                canvas2.translate(AndroidUtilities.dp(12.0f) + f18, a10 - AndroidUtilities.dp(6.0f));
                float f53 = vqVar3.C;
                float f54 = vqVar3.f29398l;
                if (f54 != 1.0f) {
                    f23 = 6.0f;
                    int i22 = vqVar3.f29392c;
                    if (i22 == 0 || i22 == 1) {
                        rectF2 = rectF;
                        f24 = 14.0f;
                        vqVar3.e(vqVar3.f29405s);
                        float dp14 = (vqVar3.f29409x - AndroidUtilities.dp(f53 * 2.0f)) / 2.0f;
                        float f55 = vqVar3.B;
                        rectF2.set(f55, dp14, vqVar3.f29405s + f55 + AndroidUtilities.dp(11.0f), AndroidUtilities.dp(23.0f) + dp14);
                    } else {
                        float f56 = f54 * 2.0f;
                        if (f56 > 1.0f) {
                            f56 = 1.0f;
                        }
                        float dp15 = (vqVar3.f29409x - AndroidUtilities.dp(f53 * 2.0f)) / 2.0f;
                        int i23 = vqVar3.f29405s;
                        int i24 = vqVar3.f29404r;
                        if (i23 == i24) {
                            z10 = i23;
                            f24 = 14.0f;
                        } else {
                    ...
                    f24 = 14.0f;
                    vqVar3.e(vqVar3.f29405s);
                    float dp16 = (vqVar3.f29409x - AndroidUtilities.dp(f53 * 2.0f)) / 2.0f;
                    float f58 = vqVar3.B;
                    rectF2.set(f58, dp16, vqVar3.f29405s + f58 + AndroidUtilities.dp(11.0f), AndroidUtilities.dp(23.0f) + dp16);
                }
                rectF2.inset(-AndroidUtilities.dp(2.0f), -AndroidUtilities.dp(2.0f));
                canvas2.drawRoundRect(rectF2, rectF2.height() / 2.0f, rectF2.height() / 2.0f, this.f40266n);
                canvas2.restore();
                canvas2.save();
                float f59 = this.K;
                vqVar3.e(vqVar3.f29405s);
                canvas2.scale(f59, f59, (vqVar3.f29405s / 2.0f) + vqVar3.A + AndroidUtilities.dp(12.0f) + f18, (a10 - AndroidUtilities.dp(f23)) + AndroidUtilities.dp(f24));
        ...
        org.telegram.ui.ActionBar.i6.f18901h2.setAlpha(i12);
        textPaint2.setAlpha(alpha3);
        paint.setAlpha(alpha4);
    }

    public final void b(Canvas canvas, int i10, int i11) {
        int v02 = org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.Xk, this.f40264j0);
        ...
        if (this.v != null) {
            ...
            if (f7 < 1.0f) {
                ...
                canvas.save();
                canvas.translate((this.f40255c - this.f40271y) / 2.0f, height);
                this.v.draw(canvas);
                canvas.restore();
            }
        }
        if (this.f40269w != null) {
            float f10 = this.K;
            if (f10 > 0.0f) {
                textPaint.setAlpha((int) (alpha2 * f10 * this.S));
                float dp = ((1.0f - this.K) * AndroidUtilities.dp(10.0f)) + (((i11 - i10) - this.f40269w.getHeight()) / 2.0f) + i10;
                canvas.save();
                canvas.translate((this.f40255c - this.E) / 2.0f, dp);
                this.f40269w.draw(canvas);
                canvas.restore();
            }
        }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        TLRPC.Dialog dialog;
        if (this.Z != 0 && (dialog = (TLRPC.Dialog) MessagesController.getInstance(this.f40258e0).dialogs_dict.f(this.Z)) != null) {
            int i12 = dialog.unread_count;
            boolean z10 = true;
            this.f40256c0.c(i12, true);
            if (i12 <= 0) {
                z10 = false;
            }
            this.f40254b0 = z10;
            View view = this.f40252a0;
            if (view != null) {
                view.invalidate();
            }
        }
    ...
    public final void f() {
        ...
        org.telegram.ui.Components.o5 o5Var = this.f40265k0;
        if (o5Var != null && (view = this.f40252a0) != null) {
            o5Var.a(view);
        }
        NotificationCenter.getInstance(this.f40258e0).addObserver(this, NotificationCenter.updateInterfaces);
    }
    ...
    public final void g(final View view, boolean z10) {
        ...
        if (z10) {
            ...
            org.telegram.ui.Components.qr qrVar = org.telegram.ui.Components.qr.f27423j;
        ...
        ofFloat5.setInterpolator(org.telegram.ui.Components.qr.f27420f);
    ...
    public final void h() {
        ...
        this.V = false;
        this.H = null;
        TLRPC.Dialog c10 = c(this.f40263i0, this.f40260f0, this.f40261g0, true, this.f40257d0);
        if (c10 != null) {
            this.Z = c10.f18113id;
            int[] iArr = this.f40257d0;
            if (iArr[0] == 1) {
                z10 = true;
            } else {
                z10 = false;
            ...
            this.f40253b = iArr[2];
            this.R = false;
            int i10 = this.f40258e0;
            TLRPC.Chat chat = MessagesController.getInstance(i10).getChat(Long.valueOf(-c10.f18113id));
            this.G = chat;
            if (chat == null) {
                this.G = MessagesController.getInstance(i10).getChat(Long.valueOf(c10.f18113id));
            }
            ...
            MessagesController.getInstance(i10).ensureMessagesLoaded(c10.f18113id, 0, null);
            int i11 = c10.unread_count;
            this.f40256c0.c(i11, false);
            if (i11 > 0) {
                z11 = true;
            }
            this.f40254b0 = z11;
    ...
    public final void i(TLRPC.Chat chat) {
        ...
        int i11 = this.f40258e0;
        f9Var.k(i11, chat2);
        this.F.setImage(ImageLocation.getForChat(this.G, 1), "50_50", f9Var, null, UserConfig.getInstance(0).getCurrentUser(), 0);
        MessagesController.getInstance(i11).ensureMessagesLoaded(-chat.f18109id, 0, null);
        TLRPC.Dialog dialog = MessagesController.getInstance(i11).getDialog(-chat.f18109id);
        if (dialog == null) {
            i10 = 0;
        } else {
            i10 = dialog.unread_count;
        }
        this.f40256c0.c(i10, false);
        if (i10 > 0) {
            z11 = true;
        }
        this.f40254b0 = z11;
    ...
    public final void j() {
        ...
        int i10 = this.f40258e0;
        ArrayList<TLRPC.TL_forumTopic> topics = MessagesController.getInstance(i10).getTopicsController().getTopics(-this.f40263i0);
        if (topics != null && topics.size() > 1) {
            tL_forumTopic = null;
            for (int i11 = 0; i11 < topics.size(); i11++) {
                TLRPC.TL_forumTopic tL_forumTopic2 = topics.get(i11);
                if (tL_forumTopic2.f18161id != this.f40262h0 && !tL_forumTopic2.hidden && tL_forumTopic2.unread_count > 0 && (tL_forumTopic == null || ((message = tL_forumTopic2.topMessage) != null && (message2 = tL_forumTopic.topMessage) != null && message.date > message2.date))) {
        ...
        if (tL_forumTopic != null) {
            ...
            int i12 = tL_forumTopic.f18161id;
            org.telegram.ui.ActionBar.e6 e6Var = this.f40264j0;
            if (i12 == 1) {
                View view3 = this.f40252a0;
                if (view3 != null && (o5Var2 = this.f40265k0) != null) {
                    o5Var2.o(view3);
                }
                this.f40265k0 = null;
                ...
                org.telegram.ui.Components.o5 o5Var3 = this.f40265k0;
                if (o5Var3 == null || o5Var3.i() != tL_forumTopic.icon_emoji_id) {
                    org.telegram.ui.Components.o5 o5Var4 = this.f40265k0;
                    if (o5Var4 != null && (view = this.f40252a0) != null) {
                        o5Var4.o(view);
                    }
                    org.telegram.ui.Components.o5 o5Var5 = new org.telegram.ui.Components.o5(22, i10, tL_forumTopic.icon_emoji_id);
                    this.f40265k0 = o5Var5;
                    o5Var5.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f18929ic, e6Var), PorterDuff.Mode.SRC_IN));
                }
                org.telegram.ui.Components.o5 o5Var6 = this.f40265k0;
                if (o5Var6 != null && (view2 = this.f40252a0) != null) {
                    o5Var6.a(view2);
                }
                imageReceiver.setImageBitmap((Bitmap) null);
            } else {
                View view4 = this.f40252a0;
                if (view4 != null && (o5Var = this.f40265k0) != null) {
                    o5Var.o(view4);
                }
                this.f40265k0 = null;
