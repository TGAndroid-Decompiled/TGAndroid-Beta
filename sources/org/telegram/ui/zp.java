...
public final class zp implements org.telegram.ui.ActionBar.c2, MessagesController.ErrorDelegate, MessagesStorage.LongCallback {
    ...
    public void j(org.telegram.ui.ActionBar.d2 d2Var, int i10) {
        ...
        switch (this.f43995a) {
            case 0:
                this.f43996b.r0(true);
                return;
            case 1:
                kq kqVar = this.f43996b;
                kqVar.t0(true);
                cq cqVar = new cq(kqVar, 0);
                if (!kqVar.H && !kqVar.I) {
                    kqVar.getMessagesController().addUserToChat(kqVar.f38394w.f20845id, kqVar.v, 0, kqVar.V0, kqVar, true, cqVar, new zp(kqVar, 3));
                    return;
                }
                MessagesController messagesController = kqVar.getMessagesController();
                long j10 = kqVar.f38394w.f20845id;
            ...
            case 3:
            default:
                kq kqVar2 = this.f43996b;
                kqVar2.getClass();
                kqVar2.presentFragment(new vg1(6, null));
                return;
            case 4:
                this.f43996b.finishFragment();
                return;
            case 5:
                TwoStepVerificationActivity twoStepVerificationActivity = new TwoStepVerificationActivity();
                kq kqVar3 = this.f43996b;
    ...
    public boolean run(TLRPC.TL_error tL_error) {
        switch (this.f43995a) {
            case 2:
                this.f43996b.t0(false);
                return true;
            case 3:
                this.f43996b.t0(false);
                return true;
            default:
                return kq.W(this.f43996b, tL_error);
        }
    }
}
