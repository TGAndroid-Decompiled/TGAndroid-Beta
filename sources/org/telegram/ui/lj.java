...
public final class lj implements MessagesStorage.IntCallback {
    ...
    public final void run(int i10) {
        ...
        switch (this.f38404a) {
            case 0:
                co coVar = ((nj) this.f38406c).f38995b;
                if (i10 > 0 && coVar.getParentActivity() != null) {
                    ...
                    a02.m(xcVar, i10, 0, 0, coVar.f35275ea).j();
                    return;
                }
                return;
            default:
                mj mjVar = (mj) this.f38406c;
                co coVar2 = mjVar.f38749b.f38995b;
                if (i10 >= 50) {
                    TLRPC.Chat chat = coVar2.f35265e;
                    TLRPC.User user = coVar2.f35277f;
                    boolean z10 = this.f38405b;
                    org.telegram.ui.Components.e5.s(coVar2, true, chat, user, false, false, false, z10, new z0(mjVar, z10));
                    return;
                }
                coVar2.qa(coVar2.f35256d4, true);
                return;
        }
    }
}
