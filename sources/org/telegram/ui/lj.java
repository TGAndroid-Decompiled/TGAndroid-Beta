...
public final class lj extends org.telegram.ui.Components.ao {
    ...
    public final boolean d() {
        ...
        if (user != null && user.linked_community_id != 0) {
            xnVar.showDialog(new th.i0(xnVar, xnVar.f43156f.linked_community_id, null, null));
            return true;
        }
        TLRPC.Chat chat = xnVar.f43143e;
        if (chat != null && chat.linked_community_id != 0) {
            xnVar.showDialog(new th.i0(xnVar, xnVar.f43143e.linked_community_id, null, null));
            return true;
        }
        return false;
    }
