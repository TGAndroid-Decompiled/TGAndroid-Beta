...
public final class j8 implements Runnable {
    ...
    public final void run() {
        ...
        switch (this.f37716a) {
            case 0:
                k9 k9Var = this.f37717b;
                k9Var.f0();
                k9Var.i0();
                return;
            case 1:
                k9 k9Var2 = this.f37717b;
                k9Var2.n0(false);
                if (k9Var2.f38003w) {
                ...
                return;
            case 2:
                this.f37717b.p0(true);
                return;
            case 3:
                k9 k9Var3 = this.f37717b;
                k9Var3.h0();
                k9Var3.f0();
                return;
            case 4:
                this.f37717b.n0(false);
                return;
            case 5:
                this.f37717b.n0(true);
                return;
            default:
                k9 k9Var4 = this.f37717b;
