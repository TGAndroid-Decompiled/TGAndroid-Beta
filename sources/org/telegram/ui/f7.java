...
public final class f7 extends org.telegram.ui.Components.b81 {
    public org.telegram.ui.ActionBar.o1 f33565a;
    public final Context f33566b;
    public final ki.i f33567c;
    ...
    public final void b(View view, int i10, int i11) {
        ...
        ml0Var.setAdapter(((t7) arrayList.get(i10)).f37674c);
        if (((t7) arrayList.get(i10)).f37673b != 1 && ((t7) arrayList.get(i10)).f37673b != 4) {
            view.getContext();
        ...
        ml0Var.setTag(Integer.valueOf(((t7) arrayList.get(i10)).f37673b));
    }

    @Override
    public final View d(int i10) {
        org.telegram.ui.Components.ml0 ml0Var = new org.telegram.ui.Components.ml0(this.f33566b, null);
        ki.i iVar = this.f33567c;
        if (iVar != null) {
            iVar.a(ml0Var);
        }
        ...
        u7 u7Var = this.e;
        if (i10 == 1) {
            ml0Var.setPadding(AndroidUtilities.dp(2.0f), u7Var.f37954s, 0, u7Var.v);
        } else {
            ml0Var.setPadding(0, u7Var.f37954s, 0, u7Var.v);
        }
    ...
    public final int f(int i10) {
        return ((t7) this.e.e.get(i10)).f37673b;
    }

    @Override
    public final CharSequence g(int i10) {
        return ((t7) this.e.e.get(i10)).f37672a;
    }
