        ...
        if (i11 == 0) {
            ...
            while (true) {
                ...
                if (tLObject instanceof TLRPC.ChannelParticipant) {
                    ...
                    int indexOf = prVar.f36650s.participants.participants.indexOf(chatParticipant);
                    if (indexOf >= 0) {
                        prVar.f36650s.participants.participants.set(indexOf, tL_chatParticipant);
                    }
                    prVar.r0();
                }
                i12++;
