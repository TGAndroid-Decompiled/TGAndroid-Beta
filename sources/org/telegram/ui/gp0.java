...
public final class gp0 extends org.telegram.ui.Components.vl0 {
    ...
    @Override
    public final int h() {
        return this.e.f35927k0;
    }

    @Override
    public final int j(int i10) {
        np0 np0Var = this.e;
        if (i10 == np0Var.R || i10 == np0Var.f35923g0 || i10 == np0Var.T || i10 == np0Var.W) {
            return 2;
        }
        if (i10 == np0Var.Q) {
            return 1;
        ...
        if (i10 == np0Var.f35924h0) {
            return 10;
        }
        if (i10 == np0Var.f35925i0) {
            return 11;
        }
        if (i10 == np0Var.f35914a0) {
            return 7;
        }
        if (i10 >= np0Var.f35916b0 && i10 < np0Var.f35918c0) {
            ...
            return 12;
        } else if (i10 >= np0Var.f35919d0 && i10 < np0Var.f35920e0) {
            return 9;
        } else {
            if (i10 != np0Var.f35927k0 - 1 && i10 != np0Var.f35926j0) {
                return 2;
            }
            return 4;
        }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        ArrayList arrayList = np0Var.f35928l0;
        ...
        switch (j3) {
            case 1:
                view.setBackgroundColor(tp0Var.getThemedColor(org.telegram.ui.ActionBar.h6.f19045d6));
                ((qp0) view).b();
                return;
            case 2:
            ...
            case 3:
                mp0 mp0Var = (mp0) view;
                tp0 tp0Var2 = mp0Var.d.f35932p0;
                mp0Var.setBackgroundColor(tp0Var2.getThemedColor(org.telegram.ui.ActionBar.h6.f19045d6));
                mp0Var.f35628a.setTextColor(tp0Var2.getThemedColor(org.telegram.ui.ActionBar.h6.G6));
                return;
            case 4:
            case 5:
            case 9:
            ...
            case 6:
                ...
                r8Var.v();
                r8Var.setBackgroundColor(tp0Var.getThemedColor(org.telegram.ui.ActionBar.h6.f19045d6));
                r8Var.v();
                if (i10 == np0Var.V) {
                    if (tp0Var.f38147a) {
            ...
            case 7:
                ...
                m4Var.setBackgroundColor(tp0Var.getThemedColor(org.telegram.ui.ActionBar.h6.f19045d6));
                return;
            case 8:
                bp0 bp0Var = (bp0) view;
                int i17 = i10 - np0Var.f35916b0;
                if (i17 >= 0 && i17 < arrayList.size()) {
                    ...
                    TLRPC.TL_emojiStatusCollectible tL_emojiStatusCollectible = np0Var.f35933r;
                    if ((tL_emojiStatusCollectible != null && tL_emojiStatusCollectible.collectible_id == tL_starGiftUnique.f18546id) || ((tL_peerColorCollectible = np0Var.f35934s) != null && tL_peerColorCollectible.collectible_id == tL_starGiftUnique.f18546id)) {
                        z10 = true;
                    } else {
                        z10 = false;
                    }
            ...
            case 10:
                ...
                ArrayList arrayList4 = sp0Var.f37826f;
                if (sp0Var.K == 0) {
                    z11 = true;
                } else {
                    z11 = false;
            ...
            case 12:
                ...
                if (np0Var.J != null && i20 >= 0 && i20 < arrayList.size()) {
                    ...
                    TLRPC.TL_emojiStatusCollectible tL_emojiStatusCollectible2 = np0Var.f35933r;
                    if ((tL_emojiStatusCollectible2 == null || tL_emojiStatusCollectible2.collectible_id != tL_starGiftUnique2.f18546id) && ((tL_peerColorCollectible2 = np0Var.f35934s) == null || tL_peerColorCollectible2.collectible_id != tL_starGiftUnique2.f18546id)) {
                        z12 = false;
                    }
                    j1Var.e(z12, false);
                    return;
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        switch (i10) {
            case 1:
                ...
                np0Var.f35921f = qp0Var;
                qp0Var.setBackgroundColor(tp0Var.getThemedColor(org.telegram.ui.ActionBar.h6.f19045d6));
    ...
    public final void y(s4.c1 c1Var) {
        ...
        if (i10 == 8) {
            bp0 bp0Var = (bp0) view;
            int b10 = c1Var.b() - np0Var.f35916b0;
            if (b10 >= 0 && b10 < arrayList.size()) {
                ...
                TLRPC.TL_emojiStatusCollectible tL_emojiStatusCollectible = np0Var.f35933r;
                if ((tL_emojiStatusCollectible == null || tL_emojiStatusCollectible.collectible_id != tL_starGiftUnique.f18546id) && ((tL_peerColorCollectible2 = np0Var.f35934s) == null || tL_peerColorCollectible2.collectible_id != tL_starGiftUnique.f18546id)) {
                    z10 = false;
                }
                bp0Var.b(z10, false);
            }
            ...
            xh.j1 j1Var = (xh.j1) view;
            int b11 = c1Var.b() - np0Var.f35916b0;
            if (np0Var.J != null && b11 >= 0 && b11 < arrayList.size()) {
                ...
                j1Var.g(tL_starGiftUnique2, false, false, false, true, false);
                TLRPC.TL_emojiStatusCollectible tL_emojiStatusCollectible2 = np0Var.f35933r;
                if ((tL_emojiStatusCollectible2 == null || tL_emojiStatusCollectible2.collectible_id != tL_starGiftUnique2.f18546id) && ((tL_peerColorCollectible = np0Var.f35934s) == null || tL_peerColorCollectible.collectible_id != tL_starGiftUnique2.f18546id)) {
                    z10 = false;
                }
                j1Var.e(z10, false);
            }
