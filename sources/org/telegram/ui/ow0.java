...
public final class ow0 extends Dialog {
    ...
    public float f36436a0;
    public final org.telegram.ui.ActionBar.f6 f36437b;
    public boolean f36438b0;
    public final jw0 f36439c;
    public boolean f36440c0;
    public final jw0 d;
    public boolean f36441d0;
    public final jw0 e;
    public ym f36442e0;
    public final ci.i1 f36443f;
    public ValueAnimator f36444f0;
    public ValueAnimator f36445g0;
    public final TextView h;
    public final org.telegram.ui.Components.tb0 f36446n;
    public i0.b f36447r;
    public Bitmap f36448s;
    public BitmapShader v;
    public Paint f36449w;
    public Matrix f36450x;
    ...
    public final void b(boolean z10, dw0 dw0Var) {
        float f7;
        long j3;
        ValueAnimator valueAnimator = this.f36444f0;
        if (valueAnimator != null) {
            valueAnimator.cancel();
        }
        ValueAnimator valueAnimator2 = this.f36445g0;
        if (valueAnimator2 != null) {
            valueAnimator2.cancel();
        }
        d();
        float f10 = this.f36451y;
        float f11 = 0.0f;
        if (z10) {
            f7 = 1.0f;
        } else {
        ...
        this.f36444f0 = ofFloat;
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) {
            public final ow0 f33486b;
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator3) {
                switch (r2) {
                    case 0:
                        ...
                        ow0 ow0Var = this.f33486b;
                        ow0Var.f36451y = floatValue;
                        ow0Var.f36439c.invalidate();
                        ow0Var.d.invalidate();
                        mw0 mw0Var = ow0Var.J;
                        if (mw0Var != null) {
                            mw0Var.invalidate();
        ...
        this.f36444f0.addListener(new androidx.fragment.app.g(this, z10, dw0Var, 9));
        if (!z10) {
            j3 = 330;
        } else {
            j3 = 520;
        }
        ValueAnimator valueAnimator3 = this.f36444f0;
        org.telegram.ui.Components.qr qrVar = org.telegram.ui.Components.qr.h;
        valueAnimator3.setInterpolator(qrVar);
        this.f36444f0.setDuration(j3);
        this.f36444f0.start();
        float f12 = this.E;
        if (z10) {
            f11 = 1.0f;
        ...
        this.f36445g0.addListener(new j70(4, this, z10));
        this.f36445g0.setDuration(((float) j3) * 1.5f);
        this.f36445g0.setInterpolator(qrVar);
        this.f36445g0.start();
    }
    ...
    public final void c(boolean z10) {
        ...
        if (z10 && (gk0Var = this.Q) != null && gk0Var.getReactionsWindow() != null && !this.Q.getReactionsWindow().f49019q) {
            this.Q.e();
        } else if (this.f36440c0) {
        } else {
            this.f36440c0 = true;
            this.Y = false;
            ci.i1 i1Var = this.f36443f;
            i1Var.l();
                ...
                if (t1Var != null) {
                    ...
                    if (!this.f36438b0) {
                        ...
                        if (f10 + f11 > dp - textView.getHeight()) {
                            ...
                            i0.b bVar5 = this.f36447r;
                            this.f36436a0 = ((((height5 - bVar5.f10592b) - bVar5.d) - AndroidUtilities.dp(78.0f)) - textView.getHeight()) - i10;
                        }
                        if (this.R != null) {
                            float height6 = this.f36436a0 + f11 + viewGroup.getHeight();
                            int height7 = jw0Var.getHeight();
                            i0.b bVar6 = this.f36447r;
                            if (height6 > (((height7 - bVar6.f10592b) - bVar6.d) - AndroidUtilities.dp(78.0f)) - textView.getHeight()) {
                                int height8 = jw0Var.getHeight();
                                i0.b bVar7 = this.f36447r;
                                this.f36436a0 = (((((height8 - bVar7.f10592b) - bVar7.d) - AndroidUtilities.dp(78.0f)) - textView.getHeight()) - i10) - this.R.getHeight();
                            }
                        }
                    }
                    e();
    ...
    public final void e() {
        ...
        if (viewGroup2 != null) {
            ...
            this.T.setAlpha(this.f36451y);
            float lerp3 = AndroidUtilities.lerp(0.75f, 1.0f, this.f36451y);
        ...
        if (this.R != null) {
            ...
            this.R.setAlpha(this.f36451y);
            float lerp4 = AndroidUtilities.lerp(0.75f, 1.0f, this.f36451y);
            this.R.setScaleX(lerp4);
            this.R.setScaleY(lerp4);
        }
        if (this.f36441d0) {
            this.K.setAlpha(this.f36451y);
            this.J.setAlpha(this.f36451y);
        }
        if (this.Q != null) {
            ...
            this.Q.setAlpha(this.f36451y);
            View windowView = this.Q.getWindowView();
            if (windowView != null) {
                windowView.setTranslationX(max);
                windowView.setAlpha(this.f36451y);
            }
        }
        TextView textView = this.h;
        textView.setTranslationX(lerp);
        textView.setAlpha(this.f36451y);
        org.telegram.ui.Components.tb0 tb0Var = this.f36446n;
        tb0Var.setSelectedTab(positionAnimated);
        tb0Var.setAlpha(this.f36451y);
    }
