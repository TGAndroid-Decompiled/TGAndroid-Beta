...
public final class bx extends hg.m {
    public final ty f34940d0;
    public final uy f34941e0;
    ...
    @Override
    public final void J() {
        this.f34941e0.presentFragment(new l());
    }

    @Override
    public final void K() {
        int i10;
        uy uyVar = this.f34941e0;
        ...
        if (requestPeerType instanceof TLRPC.TL_requestPeerTypeBroadcast) {
            ...
            md mdVar = new md(e7);
            mdVar.f38660t0 = new m6(uyVar, mdVar, b2Var, 2);
    ...
    public final void L(TLRPC.User user) {
        int i10;
        i10 = ((org.telegram.ui.ActionBar.n2) this.f34941e0).currentAccount;
        MessagesController.getInstance(i10).openApp(user, 0);
    }

    @Override
    public final boolean S() {
        if (this.f34941e0.R0 == 0) {
            return true;
        }
        return false;
    }
    ...
    public final void a(org.telegram.ui.Cells.r2 r2Var) {
        ty tyVar = this.f34940d0;
        tyVar.f40859a.getClass();
        this.f34941e0.o4(r2Var, RecyclerView.R(r2Var), 0.0f, tyVar.d);
    }
    ...
    public final void l() {
        ...
        uy uyVar = this.f34941e0;
        if (uyVar.R0 == 15) {
            org.telegram.ui.ActionBar.v0 v0Var = uyVar.f41286j0;
            if (this.U) {
                i10 = 8;
            } else {
                i10 = 0;
