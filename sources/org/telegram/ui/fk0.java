...
public final class fk0 extends org.telegram.ui.ActionBar.f3 implements NotificationCenter.NotificationCenterDelegate {
    public final ek0 f33618b;
    public final org.telegram.ui.Components.aj0 f33619c;
    ...
    public fk0(Context context, boolean z10, Utilities.Callback callback) {
        ...
        frameLayout.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view) {
                switch (r2) {
                    case 0:
                        org.telegram.ui.Components.aj0 aj0Var = this.f33042b.f33619c;
                        if (!aj0Var.b()) {
        ...
        textView3.setBackground(org.telegram.ui.ActionBar.y5.e(new float[]{24.0f}, org.telegram.ui.ActionBar.i6.w0(null, i11, false)));
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.updateInterfaces) {
            if ((((Integer) objArr[0]).intValue() & MessagesController.UPDATE_MASK_READ_DIALOG_MESSAGE) >= 0) {
                ...
                if (this.f33618b.a(i12)) {
                    org.telegram.ui.Components.aj0 aj0Var = this.f33619c;
                    if (!aj0Var.b()) {
                        aj0Var.setProgress(0.0f);
                        aj0Var.d();
                    }
