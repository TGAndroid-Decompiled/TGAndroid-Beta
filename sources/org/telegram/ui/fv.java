...
public final class fv extends LinearLayout {
    public final ec1 f33691a;
    public s4.c0 f33692b;
    public final org.telegram.ui.Components.kp f33693c;
    public final org.telegram.ui.Components.xi0 d;
    public final org.telegram.ui.Cells.r8 e;
    public final org.telegram.ui.Cells.r8 f33694f;
    public ValueAnimator h;
    public int f33695n;
    public int f33696r;
    public final int f33697s;
    public int v;
    public Boolean f33698w;
    ...
    public fv(int i10, Context context, org.telegram.ui.ActionBar.n2 n2Var) {
        ...
        if (i10 == 0) {
            ...
            this.e = r8Var;
            r8Var.setBackground(org.telegram.ui.ActionBar.i6.f0(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18923i6, false), 2, -1));
            r8Var.f20800w = 21;
        ...
        if (!MediaDataController.getInstance(n2Var.getCurrentAccount()).defaultEmojiThemes.isEmpty()) {
            ...
            if (i10 == 0) {
                ...
                if (string != null && org.telegram.ui.ActionBar.i6.N0(string) != null) {
                    if (i12 == -1) {
                        i12 = org.telegram.ui.ActionBar.i6.N0(string).f18736f0;
                    }
                } else {
                ...
                if (string2 != null && org.telegram.ui.ActionBar.i6.N0(string2) != null) {
                    if (i14 == -1) {
                        i14 = org.telegram.ui.ActionBar.i6.N0(str).f18736f0;
                    }
                } else {
                ...
                c4Var.f18546a = org.telegram.ui.ActionBar.i6.N0(str);
                c4Var.e = i13;
                d4Var.f18590f.add(c4Var);
                d4Var.f18590f.add(null);
                org.telegram.ui.ActionBar.c4 c4Var2 = new org.telegram.ui.ActionBar.c4();
                c4Var2.f18546a = org.telegram.ui.ActionBar.i6.N0(str2);
                c4Var2.e = i14;
                ...
                lpVar.f25999c = org.telegram.ui.ActionBar.i6.f1() ? 0 : 2;
                arrayList.add(lpVar);
            }
            kpVar.d = arrayList;
            kpVar.l();
        ...
        d();
        a();
        int i15 = this.f33696r;
        if (i15 >= 0 && (c0Var = this.f33692b) != null) {
    ...
    public final void a() {
        ...
        if (i10 == 0 || i10 == -1) {
            ...
            if (r8Var != null) {
                org.telegram.ui.ActionBar.i6.B1(r8Var.getBackground(), org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18923i6, false), true);
                r8Var.e(-1, org.telegram.ui.ActionBar.i6.q6);
            }
            org.telegram.ui.Cells.r8 r8Var2 = this.f33694f;
            if (r8Var2 != null) {
                r8Var2.setBackground(org.telegram.ui.ActionBar.i6.g0(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18834d6, false), org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18923i6, false)));
    ...
    public final void b() {
        ...
        org.telegram.ui.Components.kp kpVar = this.f33693c;
        if (kpVar.d != null) {
            for (int i14 = 0; i14 < kpVar.d.size(); i14++) {
                ((org.telegram.ui.Components.lp) kpVar.d.get(i14)).f25999c = this.v;
            }
    ...
    public final void c() {
        ...
        Boolean bool = this.f33698w;
        if (bool != null && bool.booleanValue() == z10) {
            return;
        }
        ec1 ec1Var = this.f33691a;
        int i11 = this.f33697s;
        if (i11 != 0 && i11 != -1) {
            if (z10) {
                i10 = 3;
            } else {
    ...
    public final void d() {
        ...
        while (true) {
            ...
            org.telegram.ui.ActionBar.d4 d4Var = ((org.telegram.ui.Components.lp) kpVar.d.get(i10)).f25997a;
            TLRPC.TL_theme tL_theme = ((org.telegram.ui.ActionBar.c4) d4Var.f18590f.get(this.v)).f18547b;
            org.telegram.ui.ActionBar.h6 j3 = ((org.telegram.ui.Components.lp) kpVar.d.get(i10)).f25997a.j(this.v);
            if (tL_theme != null) {
                org.telegram.ui.ActionBar.d4 d4Var2 = ((org.telegram.ui.Components.lp) kpVar.d.get(i10)).f25997a;
                if (org.telegram.ui.ActionBar.i6.I.f18727a.equals(org.telegram.ui.ActionBar.i6.q0(tL_theme.settings.get(((org.telegram.ui.ActionBar.c4) d4Var2.f18590f.get(this.v)).d)))) {
                    LongSparseArray longSparseArray = org.telegram.ui.ActionBar.i6.I.f18732c0;
                    if (longSparseArray == null) {
                        this.f33696r = i10;
                        break;
                    }
                    org.telegram.ui.ActionBar.g6 g6Var = (org.telegram.ui.ActionBar.g6) longSparseArray.get(tL_theme.f18246id);
                    if (g6Var != null && g6Var.f18690a == org.telegram.ui.ActionBar.i6.I.Y) {
                        this.f33696r = i10;
                        break;
                    }
                } else {
                ...
                if (j3 != null) {
                    if (org.telegram.ui.ActionBar.i6.I.f18727a.equals(j3.m())) {
                        org.telegram.ui.ActionBar.d4 d4Var3 = ((org.telegram.ui.Components.lp) kpVar.d.get(i10)).f25997a;
                        if (((org.telegram.ui.ActionBar.c4) d4Var3.f18590f.get(this.v)).e == org.telegram.ui.ActionBar.i6.I.Y) {
                            this.f33696r = i10;
                            break;
                        }
                    } else {
        ...
        if (this.f33696r == -1 && this.f33697s != 3) {
            this.f33696r = kpVar.d.size() - 1;
        }
