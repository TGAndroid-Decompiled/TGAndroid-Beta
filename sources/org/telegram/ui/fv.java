...
public final class fv extends LinearLayout {
    public final dc1 f33673a;
    public s4.c0 f33674b;
    public final org.telegram.ui.Components.kp f33675c;
    public final org.telegram.ui.Components.xi0 d;
    public final org.telegram.ui.Cells.r8 e;
    public final org.telegram.ui.Cells.r8 f33676f;
    public ValueAnimator h;
    public int f33677n;
    public int f33678r;
    public final int f33679s;
    public int v;
    public Boolean f33680w;
    ...
    public fv(int i10, Context context, org.telegram.ui.ActionBar.n2 n2Var) {
        ...
        if (i10 != 0 && i10 != -1) {
            ...
            frameLayout.addView(dc1Var, w7.x5.d(-1, -2.0f, 8388611, 0.0f, 8.0f, 0.0f, 8.0f));
        } else {
            frameLayout.addView(t00Var, w7.x5.d(-1, 104.0f, 8388611, 0.0f, 8.0f, 0.0f, 8.0f));
            frameLayout.addView(dc1Var, w7.x5.d(-1, 104.0f, 8388611, 0.0f, 8.0f, 0.0f, 8.0f));
        }
        ...
        if (i10 == 0) {
            ...
            this.e = r8Var;
            r8Var.setBackground(org.telegram.ui.ActionBar.i6.f0(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18926i6, false), 2, -1));
            r8Var.f20811w = 21;
        ...
        if (!MediaDataController.getInstance(n2Var.getCurrentAccount()).defaultEmojiThemes.isEmpty()) {
            ...
            if (i10 == 0) {
                ...
                if (string != null && org.telegram.ui.ActionBar.i6.N0(string) != null) {
                    if (i12 == -1) {
                        i12 = org.telegram.ui.ActionBar.i6.N0(string).f18738f0;
                    }
                } else {
                ...
                if (string2 != null && org.telegram.ui.ActionBar.i6.N0(string2) != null) {
                    if (i14 == -1) {
                        i14 = org.telegram.ui.ActionBar.i6.N0(str).f18738f0;
                    }
                } else {
                ...
                c4Var.f18548a = org.telegram.ui.ActionBar.i6.N0(str);
                c4Var.e = i13;
                d4Var.f18592f.add(c4Var);
                d4Var.f18592f.add(null);
                org.telegram.ui.ActionBar.c4 c4Var2 = new org.telegram.ui.ActionBar.c4();
                c4Var2.f18548a = org.telegram.ui.ActionBar.i6.N0(str2);
                c4Var2.e = i14;
                ...
                lpVar.f25996c = org.telegram.ui.ActionBar.i6.f1() ? 0 : 2;
                arrayList.add(lpVar);
            }
            kpVar.d = arrayList;
            kpVar.l();
        ...
        d();
        a();
        int i15 = this.f33678r;
        if (i15 >= 0 && (c0Var = this.f33674b) != null) {
            c0Var.h1(i15, AndroidUtilities.dp(16.0f));
        }
    }

    public final void a() {
        int i10 = this.f33679s;
        if (i10 == 0 || i10 == -1) {
            ...
            if (r8Var != null) {
                org.telegram.ui.ActionBar.i6.B1(r8Var.getBackground(), org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18926i6, false), true);
                r8Var.e(-1, org.telegram.ui.ActionBar.i6.q6);
            }
            org.telegram.ui.Cells.r8 r8Var2 = this.f33676f;
            if (r8Var2 != null) {
                r8Var2.setBackground(org.telegram.ui.ActionBar.i6.g0(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18836d6, false), org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18926i6, false)));
    ...
    public final void b() {
        ...
        org.telegram.ui.Components.kp kpVar = this.f33675c;
        if (kpVar.d != null) {
            for (int i14 = 0; i14 < kpVar.d.size(); i14++) {
                ((org.telegram.ui.Components.lp) kpVar.d.get(i14)).f25996c = this.v;
            }
    ...
    public final void c() {
        ...
        Boolean bool = this.f33680w;
        if (bool != null && bool.booleanValue() == z10) {
            return;
        }
        dc1 dc1Var = this.f33673a;
        int i11 = this.f33679s;
        if (i11 != 0 && i11 != -1) {
            if (z10) {
                i10 = 3;
            } else {
    ...
    public final void d() {
        ...
        while (true) {
            ...
            org.telegram.ui.ActionBar.d4 d4Var = ((org.telegram.ui.Components.lp) kpVar.d.get(i10)).f25994a;
            TLRPC.TL_theme tL_theme = ((org.telegram.ui.ActionBar.c4) d4Var.f18592f.get(this.v)).f18549b;
            org.telegram.ui.ActionBar.h6 j3 = ((org.telegram.ui.Components.lp) kpVar.d.get(i10)).f25994a.j(this.v);
            if (tL_theme != null) {
                org.telegram.ui.ActionBar.d4 d4Var2 = ((org.telegram.ui.Components.lp) kpVar.d.get(i10)).f25994a;
                if (org.telegram.ui.ActionBar.i6.I.f18729a.equals(org.telegram.ui.ActionBar.i6.q0(tL_theme.settings.get(((org.telegram.ui.ActionBar.c4) d4Var2.f18592f.get(this.v)).d)))) {
                    LongSparseArray longSparseArray = org.telegram.ui.ActionBar.i6.I.f18734c0;
                    if (longSparseArray == null) {
                        this.f33678r = i10;
                        break;
                    }
                    org.telegram.ui.ActionBar.g6 g6Var = (org.telegram.ui.ActionBar.g6) longSparseArray.get(tL_theme.f18249id);
                    if (g6Var != null && g6Var.f18692a == org.telegram.ui.ActionBar.i6.I.Y) {
                        this.f33678r = i10;
                        break;
                    }
                } else {
                ...
                if (j3 != null) {
                    if (org.telegram.ui.ActionBar.i6.I.f18729a.equals(j3.m())) {
                        org.telegram.ui.ActionBar.d4 d4Var3 = ((org.telegram.ui.Components.lp) kpVar.d.get(i10)).f25994a;
                        if (((org.telegram.ui.ActionBar.c4) d4Var3.f18592f.get(this.v)).e == org.telegram.ui.ActionBar.i6.I.Y) {
                            this.f33678r = i10;
                            break;
                        }
                    } else {
        ...
        if (this.f33678r == -1 && this.f33679s != 3) {
            this.f33678r = kpVar.d.size() - 1;
        }
