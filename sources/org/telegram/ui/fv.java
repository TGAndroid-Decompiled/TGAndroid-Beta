...
public final class fv extends org.telegram.ui.Components.bb {
    ...
    public final o0.a Z;
    public k6 f33764a0;
    public final org.telegram.ui.Components.my0[] f33765b0;
    public final org.telegram.ui.Cells.a2[] f33766c0;
    public final LinearLayout f33767d0;
    public final w6 f33768e0;
    public final long f33769f0;
    public final zh.b f33770g0;
    ...
    public fv(z6 z6Var, r6 r6Var, zh.b bVar, o0.a aVar) {
        ...
        long j3;
        long j10;
        this.f33765b0 = new org.telegram.ui.Components.my0[8];
        this.f33766c0 = new org.telegram.ui.Cells.a2[8];
        this.Z = aVar;
        this.Y = r6Var;
        this.f33770g0 = bVar;
        this.f33769f0 = r6Var.f37186a;
        ...
        this.f33767d0 = linearLayout;
        linearLayout.setOrientation(1);
        ev evVar = new ev(getContext(), r6Var.f37186a, aVar);
        this.X = evVar;
        ...
        for (int i12 = 8; i11 < i12; i12 = 8) {
            ...
            if (j10 > j3) {
                org.telegram.ui.Components.my0[] my0VarArr = this.f33765b0;
                ?? obj = new Object();
                ...
                my0VarArr[i11] = obj;
                org.telegram.ui.Components.my0 my0Var = this.f33765b0[i11];
                my0Var.e = j10;
                my0Var.f26592a = i13;
                ...
                this.f33767d0.addView(a2Var2, w7.y5.n(-1, 50));
                ...
                org.telegram.ui.Components.op opVar = a2Var2.f20010r;
                if (opVar != null) {
                    opVar.b(i13, i13, i14);
                }
                a2Var2.setOnClickListener(new org.telegram.ui.Components.et(29, this, bVar));
                this.f33766c0[i11] = a2Var2;
                a2Var = a2Var2;
            } else {
                this.f33765b0[i11] = null;
                this.f33766c0[i11] = null;
            }
            i11++;
        }
        if (a2Var != null) {
        ...
        ev evVar2 = this.X;
        org.telegram.ui.Components.my0[] my0VarArr2 = this.f33765b0;
        evVar2.f26825b = my0VarArr2;
        evVar2.F = bVar;
        evVar2.invalidate();
        evVar2.f26826c = new float[my0VarArr2.length];
        ...
        org.telegram.ui.Components.va vaVar = this.f22959s;
        if (vaVar != null) {
            vaVar.setChildLayout(w6Var);
        } else {
            R();
            this.f33767d0.addView(this.f33764a0, w7.y5.q(-1, 72, 80));
        }
        if (this.f33764a0 != null) {
            this.f33764a0.a(this.X.a(), true);
        }
    }
    ...
    public final void G(org.telegram.ui.Components.aw0 aw0Var) {
        ...
        if (this.f22959s != null) {
            R();
            aw0Var.addView(this.f33764a0, w7.y5.e(-1, 72, 80));
        }
    }
    ...
    public final void R() {
        ...
        this.f33764a0 = k6Var;
        k6Var.f34945a.setOnClickListener(new a(this, 19));
        ev evVar = this.X;
        if (evVar != null) {
            this.f33764a0.a(evVar.a(), true);
        }
    }
    ...
    public final CharSequence y() {
        return this.f22957n.getMessagesController().getFullName(this.f33769f0);
    }
}
