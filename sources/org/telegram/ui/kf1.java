...
public final class kf1 extends org.telegram.ui.Components.pv0 {
    public boolean f35144w0;
    public final Paint f35145x0;
    public final dg1 f35146y0;

    public kf1(dg1 dg1Var, Context context) {
        super(context, null);
        this.f35146y0 = dg1Var;
        setWillNotDraw(false);
        this.f35145x0 = new Paint();
    }
    ...
    public final void J(Canvas canvas, float f7, Rect rect, Paint paint, boolean z10) {
        if (Build.VERSION.SDK_INT >= 29 && SharedConfig.chatBlurEnabled()) {
            dg1 dg1Var = this.f35146y0;
            if (dg1Var.f33029g1 != null) {
                canvas.save();
                canvas.translate(0.0f, -f7);
                dg1Var.f33029g1.y(canvas, rect.left, rect.top + f7, rect.right, rect.bottom + f7);
                canvas.restore();
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        int measuredHeight;
        dg1 dg1Var = this.f35146y0;
        fh.d dVar = dg1Var.f33031h1;
        fh.d dVar2 = dg1Var.f33029g1;
        ah.h hVar = dg1Var.f33027f1;
        if (Build.VERSION.SDK_INT >= 31 && hVar != null) {
            ...
            if (dVar2 != null && !dVar2.f9073n && dVar2.f(measuredWidth, measuredHeight)) {
                hVar.b(dVar2.a(measuredWidth, measuredHeight), -3);
                dVar2.b();
            }
            if (dVar != null && !dVar.f9073n && dVar.f(measuredWidth, measuredHeight)) {
        ...
        if (dg1Var.isInPreviewMode()) {
            int themedColor = dg1Var.getThemedColor(org.telegram.ui.ActionBar.i6.f18836d6);
            Paint paint = this.f35145x0;
            paint.setColor(themedColor);
            paint.setAlpha((int) (dg1Var.W * 255.0f));
            canvas2 = canvas;
            canvas2.drawRect(0.0f, 0.0f, getWidth(), AndroidUtilities.statusBarHeight, paint);
            canvas2.drawLine(0.0f, 0.0f, 0.0f, getHeight(), org.telegram.ui.ActionBar.i6.f18958k0);
        } else {
            canvas2 = canvas;
        }
        if (dg1Var.M0 == null) {
            AndroidUtilities.drawNavigationBarProtection(canvas2, this, dg1Var.getThemedColor(org.telegram.ui.ActionBar.i6.f18836d6), dg1Var.f33024e1);
        }
    }
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        if (view == kVar && !dg1Var.isInPreviewMode()) {
            ...
            org.telegram.ui.Components.h81 h81Var = dg1Var.f33014a1;
            if (h81Var != null && h81Var.getVisibility() != 8) {
                f7 = dg1Var.f33014a1.getMeasuredHeight();
            } else {
                f7 = 0.0f;
            }
            ...
            if (f10 > 0.0f) {
                if (f10 < 1.0f) {
                    ...
                    org.telegram.ui.ActionBar.i6.f18958k0.setAlpha((int) (alpha * dg1Var.W));
                    float f11 = i10;
                    canvas.drawLine(0.0f, f11, getMeasuredWidth(), f11, org.telegram.ui.ActionBar.i6.f18958k0);
                    org.telegram.ui.ActionBar.i6.f18958k0.setAlpha(alpha);
                } else {
                    float f12 = i10;
                    canvas.drawLine(0.0f, f12, getMeasuredWidth(), f12, org.telegram.ui.ActionBar.i6.f18958k0);
                }
            }
        }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (s51Var != null) {
            this.f35144w0 = true;
            ViewGroup.LayoutParams layoutParams = s51Var.getLayoutParams();
            int dp = AndroidUtilities.dp(51.0f);
            int i13 = dg1Var.f33024e1;
            layoutParams.height = dp + i13;
            dg1Var.f33042o0.setPadding(0, 0, 0, i13);
            this.f35144w0 = false;
        }
        int i14 = 0;
