...
public final class kf1 extends View {
    public final HashMap f35039a;
    public final lf1 f35040b;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        for (int i18 = 0; i18 < lf1Var.F().size(); i18++) {
            if (lf1Var.F().get(i18) != null && ((nf1) lf1Var.F().get(i18)).f35860c != null) {
                String str = ((nf1) lf1Var.F().get(i18)).f35860c.title;
                HashMap hashMap = this.f35039a;
                ...
                if (((nf1) lf1Var.F().get(i18)).f35860c.f18373id == 1) {
                    dp2 = dp4;
                }
                if (((nf1) lf1Var.F().get(i18)).f35860c.hidden) {
                    i16++;
                }
                i17 += dp4;
            }
