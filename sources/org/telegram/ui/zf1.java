...
public final class zf1 implements org.telegram.ui.Components.kl0 {
    ...
    public final void d(int i10, View view) {
        cg1 cg1Var = this.f40451a;
        ArrayList arrayList = cg1Var.d;
        if (((bg1) arrayList.get(i10)).f15700a == 1) {
            Bundle bundle = new Bundle();
            bundle.putLong("chat_id", -cg1Var.f32704c);
        ...
        if (((bg1) arrayList.get(i10)).f15700a == 2) {
            TLRPC.TL_forumTopic tL_forumTopic = ((bg1) arrayList.get(i10)).f32405c;
            Bundle bundle2 = new Bundle();
            bundle2.putLong("dialog_id", cg1Var.f32704c);
            bundle2.putLong("topic_id", tL_forumTopic.f18373id);
            bundle2.putBoolean("exception", false);
            n11 n11Var = new n11(bundle2, null);
            n11Var.f35717r = new yf1(this, tL_forumTopic);
            cg1Var.presentFragment(n11Var);
        }
        if (((bg1) arrayList.get(i10)).f15700a == 4) {
            AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(cg1Var.getParentActivity());
            alertDialog$Builder.f18647a.R = LocaleController.getString(R.string.NotificationsDeleteAllExceptionTitle);
            alertDialog$Builder.f18647a.T = LocaleController.getString(R.string.NotificationsDeleteAllExceptionAlert);
