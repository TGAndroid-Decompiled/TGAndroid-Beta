...
public final class zf1 implements org.telegram.ui.Components.kl0 {
    ...
    public final void d(int i10, View view) {
        ...
        if (((bg1) arrayList.get(i10)).f15715a == 2) {
            ...
            bundle2.putLong("dialog_id", cg1Var.f32719c);
            bundle2.putLong("topic_id", tL_forumTopic.f18388id);
            bundle2.putBoolean("exception", false);
            n11 n11Var = new n11(bundle2, null);
            n11Var.f35731r = new yf1(this, tL_forumTopic);
        ...
        if (((bg1) arrayList.get(i10)).f15715a == 4) {
            ...
            alertDialog$Builder.f18662a.R = LocaleController.getString(R.string.NotificationsDeleteAllExceptionTitle);
            alertDialog$Builder.f18662a.T = LocaleController.getString(R.string.NotificationsDeleteAllExceptionAlert);
