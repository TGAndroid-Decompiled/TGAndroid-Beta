...
public final class hc0 extends org.telegram.ui.ActionBar.m2 {
    public FrameLayout f34183a;
    public org.telegram.ui.Components.xl0 f34184b;
    public s4.c0 f34185c;
    public pu d;
    public org.telegram.ui.Components.qc e;
    public int f34186f;
    public final t3 h;
    public final boolean[] f34187n;
    public final ArrayList f34188r;
    public final ArrayList f34189s;

    public hc0() {
        super(null);
        this.h = new t3(this, 9);
        this.f34187n = new boolean[3];
        this.f34188r = new ArrayList();
        this.f34189s = new ArrayList();
    }
    ...
    public final void V(int i10) {
        int i11 = 0;
        while (true) {
            ArrayList arrayList = this.f34189s;
            if (i11 < arrayList.size()) {
                if (((bc0) arrayList.get(i11)).e == i10) {
                    this.f34184b.e1(new i2.s(this, i11, 13), 700, true);
                    return;
                }
                i11++;
            } else {
    ...
    public final void X() {
        ...
        arrayList.clear();
        ArrayList arrayList2 = this.f34189s;
        ...
        arrayList2.add(bc0.c(R.drawable.msg2_ask_question, this.f34186f, LocaleController.getString(R.string.LiteOptionsChat)));
        if (zArr[2]) {
    ...
    public final void Y() {
        ...
        if (this.f34184b != null) {
            for (int i10 = 0; i10 < this.f34184b.getChildCount(); i10++) {
                View childAt = this.f34184b.getChildAt(i10);
                if (childAt != null) {
                        ...
                        if (R < arrayList.size()) {
                            ...
                            if (i11 != 3 && i11 != 4) {
                                ...
                                if (i11 == 3) {
                                    ...
                                    gc0Var.f33891f.c(LiteMode.isEnabled(i12), true);
                                } else {
    ...
    public final View createView(Context context) {
        ...
        this.f34184b = xl0Var;
        xl0Var.p1();
        this.actionBar.setAdaptiveBackground(this.f34184b);
        org.telegram.ui.Components.xl0 xl0Var2 = this.f34184b;
        s4.c0 c0Var = new s4.c0();
        this.f34185c = c0Var;
        xl0Var2.setLayoutManager(c0Var);
        org.telegram.ui.Components.xl0 xl0Var3 = this.f34184b;
        pu puVar = new pu(this, 1);
        this.d = puVar;
        xl0Var3.setAdapter(puVar);
        s4.j jVar = new s4.j();
        jVar.n(350L);
        jVar.o(org.telegram.ui.Components.sr.h);
        jVar.C = false;
        jVar.f42994m = false;
        this.f34184b.setItemAnimator(jVar);
        this.f34183a.addView(this.f34184b, w7.y5.c(-1.0f, -1));
        this.f34184b.setOnItemClickListener(new du(this, 16));
        this.fragmentView = this.f34183a;
        if (AndroidUtilities.isTablet()) {
            i10 = 360864;
        } else {
            i10 = 360928;
    ...
    public final void onInsets(int i10, int i11, int i12, int i13) {
        this.f34184b.setPadding(0, 0, 0, i13);
        this.f34184b.setClipToPadding(false);
    }
}
