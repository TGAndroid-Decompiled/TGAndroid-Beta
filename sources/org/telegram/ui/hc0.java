...
public final class hc0 extends org.telegram.ui.ActionBar.m2 {
    public FrameLayout f34171a;
    public org.telegram.ui.Components.wl0 f34172b;
    public s4.c0 f34173c;
    public pu d;
    public org.telegram.ui.Components.qc e;
    public int f34174f;
    public final t3 h;
    public final boolean[] f34175n;
    public final ArrayList f34176r;
    public final ArrayList f34177s;

    public hc0() {
        super(null);
        this.h = new t3(this, 9);
        this.f34175n = new boolean[3];
        this.f34176r = new ArrayList();
    ...
    public final void V(int i10) {
        int i11 = 0;
        while (true) {
            ArrayList arrayList = this.f34177s;
            if (i11 < arrayList.size()) {
                if (((bc0) arrayList.get(i11)).e == i10) {
                    this.f34172b.e1(new i2.s(this, i11, 13), 700, true);
                    return;
                }
                i11++;
            } else {
    ...
    public final void X() {
        String formatString;
        ArrayList arrayList = this.f34176r;
        arrayList.clear();
        ArrayList arrayList2 = this.f34177s;
        ...
        arrayList2.add(bc0.c(R.drawable.msg2_ask_question, this.f34174f, LocaleController.getString(R.string.LiteOptionsChat)));
        if (zArr[2]) {
    ...
    public final void Y() {
        ...
        if (this.f34172b != null) {
            for (int i10 = 0; i10 < this.f34172b.getChildCount(); i10++) {
                View childAt = this.f34172b.getChildAt(i10);
                if (childAt != null) {
                        ...
                        if (R < arrayList.size()) {
                            ...
                            if (i11 != 3 && i11 != 4) {
                                ...
                                if (i11 == 3) {
                                    ...
                                    gc0Var.f33877f.c(LiteMode.isEnabled(i12), true);
                                } else {
    ...
    public final View createView(Context context) {
        ...
        this.f34172b = wl0Var;
        wl0Var.p1();
        this.actionBar.setAdaptiveBackground(this.f34172b);
        org.telegram.ui.Components.wl0 wl0Var2 = this.f34172b;
        s4.c0 c0Var = new s4.c0();
        this.f34173c = c0Var;
        wl0Var2.setLayoutManager(c0Var);
        org.telegram.ui.Components.wl0 wl0Var3 = this.f34172b;
        ...
        jVar.C = false;
        jVar.f42981m = false;
        this.f34172b.setItemAnimator(jVar);
        this.f34171a.addView(this.f34172b, w7.y5.c(-1.0f, -1));
        this.f34172b.setOnItemClickListener(new du(this, 16));
        this.fragmentView = this.f34171a;
        if (AndroidUtilities.isTablet()) {
            i10 = 360864;
        } else {
            i10 = 360928;
    ...
    public final void onInsets(int i10, int i11, int i12, int i13) {
        this.f34172b.setPadding(0, 0, 0, i13);
        this.f34172b.setClipToPadding(false);
    }
}
