...
public final class hc0 {
    public final LaunchActivity f34235a;
    public final int f34236b;
    public final nf.e f34237c;
    ...
    public static boolean l(java.lang.String r7) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.hc0.l(java.lang.String):boolean");
    }
    ...
    public final org.telegram.ui.ActionBar.e5 c() {
        return this.f34235a.O();
    }

    public final UserConfig d() {
        return UserConfig.getInstance(this.f34236b);
    }
    ...
    public final boolean e(Uri uri) {
        ...
        if (uri != null) {
            ...
            LaunchActivity launchActivity = this.f34235a;
            if (equalsIgnoreCase) {
                        ...
                        if (!arrayList.isEmpty()) {
                            ...
                            if ("newbot".equalsIgnoreCase(str4)) {
                                ...
                                if ("new".equalsIgnoreCase(str4)) {
                                    ...
                                    ci.oc E = ci.oc.E(launchActivity, this.f34236b);
                                    if (E.O1 != r15) {
                                        E.O1 = r15;
                                        ?? r22 = E.Q0;
                                        if (r22 != 0) {
    ...
    public final boolean f(String str) {
        ...
        k();
        ConnectionsManager.getInstance(this.f34236b).sendRequestTyped(gettone, new Object(), new b5(this, 14));
        return true;
    }
    ...
    public final boolean g(String str) {
        ...
        this.h = ConnectionsManager.getInstance(this.f34236b).sendRequest(tL_payments_getPaymentForm, new ca((Object) this, (TLObject) tL_inputInvoiceSlug, str, 18));
        return true;
    }
    ...
    public final void h(String str, String str2, String str3) {
        ...
        if (U != null && U.getContext() != null) {
            ...
            MessagesController.getInstance(this.f34236b).getUserNameResolver().resolve(str, new rh(this, userArr, new org.telegram.ui.Components.kn0(this, U, userArr, tL_requestPeerTypeCreateBot, 15), 3));
        }
    }
    ...
    public final boolean i(Uri uri, String str) {
        ...
        ConnectionsManager.getInstance(this.f34236b).sendRequestTyped(tL_messages_requestUrlAuth, new Object(), new ai.m0(16, this, tL_messages_requestUrlAuth));
        return true;
    }

    public final boolean j(java.util.List r28) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.hc0.j(java.util.List):boolean");
    }

    public final void k() {
        if (!this.f34238f && !this.f34239g) {
            nf.e eVar = this.f34237c;
            if (eVar == null) {
                if (this.e == null) {
                    this.e = new org.telegram.ui.ActionBar.c2(this.f34235a, 3, null);
                }
                this.e.setOnCancelListener(new rg(this, 3));
                this.e.q(300L);
            } else {
                eVar.f15220b = new bc0(this, 0);
                eVar.d();
            }
            this.f34238f = true;
        }
    ...
    public final void o(String str) {
        AndroidUtilities.scrollToFragmentRow(this.f34235a.O(), str);
    }
}
