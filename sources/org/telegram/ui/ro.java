...
public final class ro implements Runnable {
    ...
    public final void run() {
        ...
        switch (this.f37283a) {
            case 0:
                MessagesController.getInstance(r0.currentAccount).unlinkCommunity(this.f37284b, this.f37285c, new b5((wo) this.d, 4));
                return;
            default:
                org.telegram.ui.web.z1 z1Var = (org.telegram.ui.web.z1) this.d;
                z1Var.h = this.f37284b;
                z1Var.f39020n = this.f37285c;
                org.telegram.ui.Components.z51 z51Var = z1Var.f22333a;
