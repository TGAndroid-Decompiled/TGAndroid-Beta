...
public final class u41 implements Runnable {
    ...
    public final SecretMediaViewer f37806b;

    public u41(SecretMediaViewer secretMediaViewer, int i10) {
        this.f37805a = i10;
        this.f37806b = secretMediaViewer;
    }
    ...
    public final void run() {
        ...
        SecretMediaViewer secretMediaViewer = this.f37806b;
        switch (i10) {
            case 0:
                ...
                secretMediaViewer.f31473s = false;
            ...
            case 2:
                ...
                if (a51Var != null) {
                    ...
                    int[] iArr = secretMediaViewer.f31456j1;
                    Arrays.fill(iArr, 0);
                    int[] iArr2 = secretMediaViewer.f31458k1;
                    Arrays.fill(iArr2, 0);
                    a51 a51Var2 = secretMediaViewer.f31487y;
                    if (a51Var2 != null) {
                        long max = Math.max(0L, a51Var2.n()) / 1000;
                        long max2 = Math.max(0L, secretMediaViewer.f31487y.p()) / 1000;
                        iArr[0] = (int) (max / 60);
                        iArr[1] = (int) (max % 60);
                        iArr2[0] = (int) (max2 / 60);
                        iArr2[1] = (int) (max2 % 60);
                    ...
                    if (secretMediaViewer.f31487y.y()) {
                        AndroidUtilities.runOnUIThread(secretMediaViewer.f31454i1, 17L);
                        return;
                    }
                    return;
                }
            ...
            case 3:
                ...
                return;
            default:
                ImageReceiver.BitmapHolder bitmapHolder = secretMediaViewer.f31453i0;
                if (bitmapHolder != null) {
                    bitmapHolder.release();
                    secretMediaViewer.f31453i0 = null;
                }
                secretMediaViewer.h.setImageBitmap((Bitmap) null);
                try {
                    if (secretMediaViewer.d.getParent() != null) {
                        ((WindowManager) secretMediaViewer.f31436b.getSystemService("window")).removeView(secretMediaViewer.d);
                    }
                } catch (Exception e) {
                    FileLog.e(e);
                }
                secretMediaViewer.f31455j0 = false;
                return;
        }
    }
