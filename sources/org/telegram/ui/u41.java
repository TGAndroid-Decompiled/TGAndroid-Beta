...
public final class u41 extends FrameLayout {
    public final Paint f38313a;
    public final Paint f38314b;
    public final RectF f38315c;
    public final org.telegram.ui.Components.k21 d;
    public boolean e;
    public long f38316f;
    public long h;
    public final org.telegram.ui.Components.ij0 f38317n;
    public final TextPaint f38318r;
    public StaticLayout f38319s;
    public float v;
    public float f38320w;
    public final SecretMediaViewer f38321x;

    public u41(SecretMediaViewer secretMediaViewer, Activity activity) {
        super(activity);
        this.f38321x = secretMediaViewer;
        this.f38315c = new RectF();
        this.d = new org.telegram.ui.Components.k21();
        this.f38318r = new TextPaint(1);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float max;
        MessageObject messageObject = this.f38321x.f31740h0;
        if (messageObject != null) {
            ...
            if (message.destroyTime != 0 || message.ttl == Integer.MAX_VALUE) {
                if (this.f38316f == 0) {
                    ...
                    max = ((float) Math.max(0L, this.f38316f - (System.currentTimeMillis() + (ConnectionsManager.getInstance(secretMediaViewer.f31722a).getTimeDifference() * 1000)))) / (((float) this.h) * 1000.0f);
                }
                boolean z10 = this.e;
                Paint paint = this.f38314b;
                Paint paint2 = this.f38313a;
                float f7 = max;
                RectF rectF = this.f38315c;
                if (z10) {
                    canvas.save();
                    canvas.translate(rectF.centerX() - (this.v / 2.0f), rectF.centerY() - (this.f38320w / 2.0f));
                    this.f38319s.draw(canvas);
                    canvas.restore();
                    ...
                    org.telegram.ui.Components.ij0 ij0Var = this.f38317n;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f38315c.set(measuredWidth - dpf2, measuredHeight - dpf2, measuredWidth + dpf2, dpf2 + measuredHeight);
