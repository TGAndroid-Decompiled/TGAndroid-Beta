...
public final class u41 extends FrameLayout {
    public final Paint f38314a;
    public final Paint f38315b;
    public final RectF f38316c;
    public final org.telegram.ui.Components.k21 d;
    public boolean e;
    public long f38317f;
    public long h;
    public final org.telegram.ui.Components.ij0 f38318n;
    public final TextPaint f38319r;
    public StaticLayout f38320s;
    public float v;
    public float f38321w;
    public final SecretMediaViewer f38322x;

    public u41(SecretMediaViewer secretMediaViewer, Activity activity) {
        super(activity);
        this.f38322x = secretMediaViewer;
        this.f38316c = new RectF();
        this.d = new org.telegram.ui.Components.k21();
        this.f38319r = new TextPaint(1);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float max;
        MessageObject messageObject = this.f38322x.f31741h0;
        if (messageObject != null) {
            ...
            if (message.destroyTime != 0 || message.ttl == Integer.MAX_VALUE) {
                if (this.f38317f == 0) {
                    ...
                    max = ((float) Math.max(0L, this.f38317f - (System.currentTimeMillis() + (ConnectionsManager.getInstance(secretMediaViewer.f31723a).getTimeDifference() * 1000)))) / (((float) this.h) * 1000.0f);
                }
                boolean z10 = this.e;
                Paint paint = this.f38315b;
                Paint paint2 = this.f38314a;
                float f7 = max;
                RectF rectF = this.f38316c;
                if (z10) {
                    canvas.save();
                    canvas.translate(rectF.centerX() - (this.v / 2.0f), rectF.centerY() - (this.f38321w / 2.0f));
                    this.f38320s.draw(canvas);
                    canvas.restore();
                    ...
                    org.telegram.ui.Components.ij0 ij0Var = this.f38318n;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f38316c.set(measuredWidth - dpf2, measuredHeight - dpf2, measuredWidth + dpf2, dpf2 + measuredHeight);
