...
public final class yd1 implements Runnable {
    ...
    public final void run() {
        ...
        snVar = null;
        boolean z10 = false;
        Object obj = this.f43115c;
        Object obj2 = this.d;
        Object obj3 = this.f43114b;
        switch (i11) {
            case 0:
                be1 be1Var = (be1) obj3;
                ...
                if (str2 != null && str2.equals(str)) {
                    if (tL_error != null && ("THEME_SLUG_INVALID".equals(tL_error.text) || "THEME_SLUG_OCCUPIED".equals(tL_error.text))) {
                        be1Var.a0(org.telegram.ui.ActionBar.j6.f20908p7, LocaleController.getString(R.string.SetUrlInUse));
                        return;
                    } else {
                        be1Var.a0(org.telegram.ui.ActionBar.j6.f21036w6, LocaleController.formatString("SetUrlAvailable", R.string.SetUrlAvailable, str));
                        return;
                    }
                }
                return;
            ...
            case 3:
                ...
                arrayList.clear();
                ArrayList arrayList2 = te1Var.f40760f;
                arrayList2.clear();
                arrayList.addAll((ArrayList) obj2);
                arrayList2.addAll(((TLRPC.TL_messages_inactiveChats) obj).chats);
                te1Var.d.l();
                if (te1Var.f40756a.getMeasuredHeight() > 0) {
                    ValueAnimator ofFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
                    te1Var.f40766y = ofFloat;
                    ofFloat.addUpdateListener(new b21(te1Var, 15));
                    te1Var.f40766y.setDuration(100L);
                    te1Var.f40766y.start();
                } else {
                    te1Var.E = 1.0f;
                }
            ...
            case 4:
                eg1 eg1Var = (eg1) obj3;
                eg1Var.f36089s.deleteTopics(eg1Var.f36053a, (ArrayList) obj2);
                ((Runnable) obj).run();
                return;
            case 5:
                ag1 ag1Var = (ag1) obj3;
                ...
                ArrayList arrayList3 = ag1Var.f34458d0;
                if (str3.equals(ag1Var.f34456b0)) {
                    int i13 = ag1Var.f34465k0;
                    ag1Var.f34469p0 = false;
                    ag1Var.f34466l0 = false;
                    if (tLObject instanceof TLRPC.messages_Messages) {
                        TLRPC.messages_Messages messages_messages = (TLRPC.messages_Messages) tLObject;
                        for (int i14 = 0; i14 < messages_messages.messages.size(); i14++) {
                            i10 = ((org.telegram.ui.ActionBar.n2) ag1Var.f34473t0).currentAccount;
                    ...
                    if (ag1Var.f34465k0 == 0) {
                        ag1Var.f34467n0.e(ag1Var.f34466l0, true);
                    }
                    ag1Var.f34468o0.b(i13);
                    return;
                }
                return;
            default:
                ...
                hg.b2 b2Var = xh1Var.f42760f;
                if (xh1Var.f42761n) {
                    xh1Var.h = null;
                    xh1Var.d = arrayList4;
                    xh1Var.f42759e = arrayList5;
                    b2Var.f(arrayList4, null);
                    if (xh1Var.f42761n && !b2Var.e()) {
