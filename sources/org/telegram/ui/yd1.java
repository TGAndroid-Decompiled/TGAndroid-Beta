...
public final class yd1 implements Runnable {
    ...
    public final Object f43087b;
    public final Object f43088c;
    ...
    public final void run() {
        ...
        switch (i11) {
            case 0:
                ...
                if (str2 != null && str2.equals(str)) {
                    if (tL_error != null && ("THEME_SLUG_INVALID".equals(tL_error.text) || "THEME_SLUG_OCCUPIED".equals(tL_error.text))) {
                        be1Var.a0(org.telegram.ui.ActionBar.j6.f20881p7, LocaleController.getString(R.string.SetUrlInUse));
                        return;
                    } else {
                        be1Var.a0(org.telegram.ui.ActionBar.j6.f21009w6, LocaleController.formatString("SetUrlAvailable", R.string.SetUrlAvailable, str));
                        return;
                    }
                }
                return;
            ...
            case 3:
                ...
                arrayList.clear();
                ArrayList arrayList2 = te1Var.f40733f;
                arrayList2.clear();
                arrayList.addAll((ArrayList) obj2);
                arrayList2.addAll(((TLRPC.TL_messages_inactiveChats) obj).chats);
                te1Var.d.l();
                if (te1Var.f40729a.getMeasuredHeight() > 0) {
                    ValueAnimator ofFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
                    te1Var.f40739y = ofFloat;
                    ofFloat.addUpdateListener(new b21(te1Var, 15));
                    te1Var.f40739y.setDuration(100L);
                    te1Var.f40739y.start();
                } else {
                    te1Var.E = 1.0f;
                }
            ...
            case 4:
                eg1 eg1Var = (eg1) obj3;
                eg1Var.f36062s.deleteTopics(eg1Var.f36026a, (ArrayList) obj2);
                ((Runnable) obj).run();
                return;
            case 5:
                ag1 ag1Var = (ag1) obj3;
                ...
                ArrayList arrayList3 = ag1Var.f34431d0;
                if (str3.equals(ag1Var.f34429b0)) {
                    int i13 = ag1Var.f34438k0;
                    ag1Var.f34442p0 = false;
                    ag1Var.f34439l0 = false;
                    if (tLObject instanceof TLRPC.messages_Messages) {
                        TLRPC.messages_Messages messages_messages = (TLRPC.messages_Messages) tLObject;
                        for (int i14 = 0; i14 < messages_messages.messages.size(); i14++) {
                            i10 = ((org.telegram.ui.ActionBar.n2) ag1Var.f34446t0).currentAccount;
                    ...
                    if (ag1Var.f34438k0 == 0) {
                        ag1Var.f34440n0.e(ag1Var.f34439l0, true);
                    }
                    ag1Var.f34441o0.b(i13);
                    return;
                }
                return;
            default:
                ...
                hg.b2 b2Var = xh1Var.f42733f;
                if (xh1Var.f42734n) {
                    xh1Var.h = null;
                    xh1Var.d = arrayList4;
                    xh1Var.f42732e = arrayList5;
                    b2Var.f(arrayList4, null);
                    if (xh1Var.f42734n && !b2Var.e()) {
