...
public final class cn0 implements RequestDelegate {
    ...
    public final TL_account.getPasswordSettings f32846c;
    ...
    public cn0(qn0 qn0Var, boolean z10, byte[] bArr, TL_account.getPasswordSettings getpasswordsettings, String str) {
        ...
        this.f32844a = z10;
        this.f32845b = bArr;
        this.f32846c = getpasswordsettings;
        this.d = str;
    }
    ...
    public final void a() {
        ...
        if (!this.f32844a) {
            ...
            UserConfig.getInstance(i12).savePassword(this.f32845b, qn0Var.f36959e1);
        }
        AndroidUtilities.hideKeyboard(qn0Var.Y[0]);
        qn0Var.f36962f1 = true;
        long j3 = qn0Var.f36953c;
        if (j3 == 0) {
            i10 = 8;
        } else {
            i10 = 0;
        }
        qn0 qn0Var2 = new qn0(i10, j3, qn0Var.h, qn0Var.f36984r, qn0Var.d, qn0Var.e, qn0Var.f36975n, qn0Var.f37002y, qn0Var.J);
        qn0Var2.f36957d1 = qn0Var.f36957d1;
        ...
        qn0Var2.f36952b1 = qn0Var.f36952b1;
    ...
    public final void b() {
        ...
        if (passwordKdfAlgo instanceof TLRPC.TL_passwordKdfAlgoSHA256SHA256PBKDF2HMACSHA512iter100000SHA256ModPow) {
            updatepasswordsettings.password = SRPHelper.startCheck(this.f32845b, password.srp_id, password.srp_B, (TLRPC.TL_passwordKdfAlgoSHA256SHA256PBKDF2HMACSHA512iter100000SHA256ModPow) passwordKdfAlgo);
        }
        ...
        ConnectionsManager.getInstance(i10).sendRequest(this.f32846c, new an0(this, 1));
    }
    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        if (tL_error != null && "SRP_ID_INVALID".equals(tL_error.text)) {
            ...
            ConnectionsManager.getInstance(i10).sendRequest(getpassword, new ci.u3(9, this, this.f32844a), 8);
        } else if (tL_error == null) {
            Utilities.globalQueue.postRunnable(new ai.s4(this, tLObject, this.d, this.f32844a, 24));
        } else {
            AndroidUtilities.runOnUIThread(new dm0(this, this.f32844a, tL_error, 1));
        }
    }
}
