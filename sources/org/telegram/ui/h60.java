...
public final class h60 extends FrameLayout {
    ...
    public boolean J;
    public final k60 K;
    public final org.telegram.ui.Components.bj0 f34182a;
    public final TextView f34183b;
    public final TLRPC.GroupCallParticipant f34184c;
    public final org.telegram.ui.Components.yi0 d;
    public boolean e;
    public float f34185f;
    public float h;
    public int f34186n;
    public double f34187r;
    public final Paint f34188s;
    public final Paint v;
    public final Path f34189w;
    public final float[] f34190x;
    public final RectF f34191y;
    ...
    public h60(k60 k60Var, Context context, TLRPC.GroupCallParticipant groupCallParticipant) {
        ...
        int i13;
        this.K = k60Var;
        this.f34188s = new Paint(1);
        Paint paint = new Paint(1);
        this.v = paint;
        this.f34189w = new Path();
        this.f34190x = new float[8];
        this.f34191y = new RectF();
        this.I = new float[3];
        setWillNotDraw(false);
        this.f34184c = groupCallParticipant;
        this.f34187r = ChatObject.getParticipantVolume(groupCallParticipant) / 20000.0f;
        this.G = 1.0f;
        ...
        this.f34182a = imageView;
        imageView.setScaleType(ImageView.ScaleType.CENTER);
        imageView.setAnimation(yi0Var);
        if (this.f34187r == 0.0d) {
            num = 1;
        } else {
            num = null;
        }
        ...
        yi0Var.P(i11);
        yi0Var.N(yi0Var.f30226f - 1, false, true);
    ...
    public final void a(double d, boolean z10) {
        ...
        if (VoIPService.getSharedInstance() != null) {
            this.f34187r = d;
            TLRPC.GroupCallParticipant groupCallParticipant = this.f34184c;
            ...
            org.telegram.ui.Components.bj0 bj0Var = this.f34182a;
        ...
        if (motionEvent.getAction() != 1 && motionEvent.getAction() != 3) {
            if (motionEvent.getAction() == 2) {
                if (!this.e) {
                    ...
                    if (Math.abs(motionEvent.getY() - this.h) <= viewConfiguration.getScaledTouchSlop() && Math.abs(motionEvent.getX() - this.f34185f) > viewConfiguration.getScaledTouchSlop()) {
                        this.e = true;
                    ...
                    a(this.f34186n / getMeasuredWidth(), false);
                    invalidate();
                    return true;
                }
            }
            ...
            if (this.J) {
                if (motionEvent.getAction() == 1) {
                    a(this.f34186n / getMeasuredWidth(), true);
                }
                this.J = false;
                invalidate();
                return true;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        Path path = h60Var.f34189w;
        path.reset();
        float f12 = 6.0f;
        float dp2 = AndroidUtilities.dp(6.0f);
        float[] fArr = h60Var.f34190x;
        fArr[7] = dp2;
        fArr[6] = dp2;
        int i13 = 1;
        fArr[1] = dp2;
        fArr[0] = dp2;
        if (h60Var.f34186n < AndroidUtilities.dp(12.0f)) {
            f7 = Math.max(0.0f, (h60Var.f34186n - AndroidUtilities.dp(6.0f)) / AndroidUtilities.dp(6.0f));
        } else {
            f7 = 1.0f;
        }
        ...
        fArr[3] = dp3;
        fArr[2] = dp3;
        RectF rectF = h60Var.f34191y;
        rectF.set(0.0f, 0.0f, h60Var.f34186n, h60Var.getMeasuredHeight());
        path.addRoundRect(rectF, fArr, Path.Direction.CW);
        path.close();
        Canvas canvas2 = canvas;
        canvas2.drawPath(path, paint);
        int participantVolume = (int) (ChatObject.getParticipantVolume(h60Var.f34184c) / 100.0d);
        org.telegram.ui.Components.bj0 bj0Var = h60Var.f34182a;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f34186n = (int) (View.MeasureSpec.getSize(i10) * this.f34187r);
    }
