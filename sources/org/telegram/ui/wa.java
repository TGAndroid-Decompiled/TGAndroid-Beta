    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        switch (this.f38943a) {
            ...
            case 1:
                ...
                return;
            case 2:
                AndroidUtilities.runOnUIThread(new org.telegram.ui.ActionBar.a6(16, this.f38944b, tLObject));
                return;
            case 3:
                if (tLObject != null) {
                    final TLRPC.TL_channels_adminLogResults tL_channels_adminLogResults2 = (TLRPC.TL_channels_adminLogResults) tLObject;
                    final ub ubVar3 = this.f38944b;
                    AndroidUtilities.runOnUIThread(new Runnable() {
                        @Override
                        public final void run() {
                            switch (r3) {
                ...
                return;
            default:
                AndroidUtilities.runOnUIThread(new r1(this.f38944b, tL_error, tLObject, 9));
                return;
        }
    }
}
