                                            ...
                                            if (i24 != 21) {
                                                switch (i24) {
                                                    ...
                                                    case 12:
                                                        ...
                                                        if (indexOf != -1) {
                                                            ((s4.c0) wl0Var.getLayoutManager()).h1(indexOf, (themeActivity.f31838b.getMeasuredWidth() / 2) - AndroidUtilities.dp(42.0f));
                                                            return;
                                                        }
                                                        return;
                                                    default:
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        switch (i10) {
            ...
            case 15:
                ...
                frameLayout3.f23766a = paint;
                frameLayout3.f23767b = new Paint(1);
                Paint paint2 = new Paint(1);
                frameLayout3.f23768c = paint2;
                Paint paint3 = new Paint(1);
                frameLayout3.d = paint3;
                frameLayout3.e = new RectF();
                int i22 = 6;
                frameLayout3.h = r14;
                frameLayout3.f23770n = r15;
                frameLayout3.f23771r = new org.telegram.ui.Components.ij0[6];
                frameLayout3.v = new org.telegram.ui.Components.lj0[2];
                float f11 = 1.0f;
                frameLayout3.f23774x = 1.0f;
                ...
                org.telegram.ui.Components.ij0 a2 = frameLayout3.a(frameLayout3.f23769f.getValue());
                if (a2 != null) {
                ...
                if (frameLayout3.f23769f.getValue() != 5) {
                    f11 = 0.0f;
                }
                frameLayout3.f23773w = f11;
                frameLayout3.F = frameLayout3.f23769f.getValue();
                j5Var = frameLayout3;
                break;
            case 16:
