...
public final class yb1 implements org.telegram.ui.Components.zk0 {
    ...
    public final void d(int i10, View view) {
        ...
        boolean z12;
        boolean z13;
        int i11 = this.f39834a;
        Object obj = this.d;
        Object obj2 = this.f39836c;
        Object obj3 = this.f39835b;
        switch (i11) {
            case 0:
                hc1 hc1Var = (hc1) obj2;
                dc1 dc1Var = (dc1) obj;
                ThemeActivity themeActivity = ((fc1) obj3).e;
                int i12 = themeActivity.f31557f;
                if (i12 == 1) {
                ...
                if (i10 == hc1Var.h() - 1) {
                    ...
                    themeActivity.presentFragment(new vd1(h6Var, false, 1, false, z13));
                } else {
                    interpolator = null;
                    org.telegram.ui.ActionBar.g6 g6Var = (org.telegram.ui.ActionBar.g6) hc1Var.e.get(i10);
                    if (!TextUtils.isEmpty(g6Var.f18703o) && g6Var.f18692a != org.telegram.ui.ActionBar.i6.f19014n) {
                        org.telegram.ui.ActionBar.d6.a(false);
                    }
                    int i13 = h6Var.Y;
                    int i14 = g6Var.f18692a;
                    if (i13 != i14) {
                        ...
                        globalInstance.lambda$postNotificationNameOnUIThread$1(i15, h6Var, Boolean.valueOf(z12), null, Integer.valueOf(g6Var.f18692a));
                        org.telegram.ui.ActionBar.d4.q(h6Var, g6Var.f18692a);
                        ...
                        themeActivity.presentFragment(new vd1(h6Var, false, 1, z10, z11));
                    }
                }
                ...
                int i16 = left - dp;
                if (i16 < 0) {
                    dc1Var.v0(i16, 0, interpolator);
                } else {
                    int i17 = right + dp;
                    if (i17 > dc1Var.getMeasuredWidth()) {
                        dc1Var.v0(i17 - dc1Var.getMeasuredWidth(), 0, interpolator);
                    }
                }
