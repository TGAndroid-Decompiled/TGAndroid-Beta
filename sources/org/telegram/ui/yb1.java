...
public final class yb1 extends org.telegram.ui.Components.vl0 {
    ...
    public final int j(int i10) {
        ...
        if (i10 != themeActivity.f31822a0 && i10 != themeActivity.K && i10 != themeActivity.f31824b0 && i10 != themeActivity.Y && i10 != themeActivity.P && i10 != themeActivity.Q && i10 != themeActivity.M && i10 != themeActivity.L) {
            if (i10 != themeActivity.f31830f0 && i10 != themeActivity.Z && i10 != themeActivity.f31848v0 && i10 != themeActivity.A0 && i10 != themeActivity.G0) {
                if (i10 != themeActivity.f31843r0 && i10 != themeActivity.V && i10 != themeActivity.f31826c0 && i10 != themeActivity.O && i10 != themeActivity.f31832h0 && i10 != themeActivity.f31838n0 && i10 != themeActivity.f31835k0 && i10 != themeActivity.J && i10 != themeActivity.I0 && i10 != themeActivity.f31855z0 && i10 != themeActivity.B0 && i10 != themeActivity.C0 && i10 != themeActivity.D0) {
                    if (i10 != themeActivity.R && i10 != themeActivity.S && i10 != themeActivity.T && i10 != themeActivity.U) {
                        if (i10 != themeActivity.W && i10 != themeActivity.f31827d0 && i10 != themeActivity.f31831g0 && i10 != themeActivity.f31851x && i10 != themeActivity.f31833i0 && i10 != themeActivity.f31849w && i10 != themeActivity.f31836l0 && i10 != themeActivity.f31834j0 && i10 != themeActivity.f31846t0 && i10 != themeActivity.f31850w0 && i10 != themeActivity.H0 && i10 != themeActivity.E0 && i10 != themeActivity.F0) {
                            if (i10 == themeActivity.f31828e0) {
                                return 6;
                            }
                            if (i10 != themeActivity.X && i10 != themeActivity.G && i10 != themeActivity.E) {
                                ...
                                if (i10 != i11) {
                                    ...
                                    if (i10 != i12 && i10 != themeActivity.f31853y && i10 != themeActivity.f31845s0) {
                                            ...
                                            if (i10 != i14) {
                                                ...
                                                if (i10 != themeActivity.m0) {
                                                    ...
                                                    if (i10 != i16) {
                                                        ...
                                                        if (i10 != i17) {
                                                            if (i10 == themeActivity.f31839o0) {
                                                                return 11;
                                                            }
                                                            if (i10 != themeActivity.f31841q0) {
                                                                i18 = themeActivity.bubbleRadiusRow;
                                                                if (i10 != i18) {
                                                                    i19 = themeActivity.backgroundRow;
                                                                    if (i10 != i19 && i10 != themeActivity.f31854y0) {
                                                                        ...
                                                                        if (i10 != i20) {
                                                                            ...
                                                                            if (i10 != i21) {
                                                                                ...
                                                                                if (i10 != i22) {
                                                                                    if (i10 == themeActivity.f31847u0) {
                                                                                        return 15;
                                                                                    }
                                                                                    if (i10 == themeActivity.f31852x0) {
                                                                                        return 16;
                                                                                    }
                                                                                    if (i10 == themeActivity.f31840p0) {
                                                                                        return 17;
                                                                                    }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i24 != 1) {
                    ...
                    if (i24 != 5) {
                        if (i24 != 6) {
                                            ...
                                            if (i24 != 21) {
                                                switch (i24) {
                                                    case 10:
                                                        ...
                                                        if (z11) {
                                                            int i25 = org.telegram.ui.ActionBar.h6.f19239o;
                                                            if (i25 == 1) {
                                                    ...
                                                    case 11:
                                                        if (this.d) {
                                                            themeActivity.f31825c.x1(themeActivity.f31823b.getMeasuredWidth());
                                                            this.d = false;
                                                            return;
                                                        }
                                                        return;
                                                    case 12:
                                                        ...
                                                        if (indexOf != -1) {
                                                            ((s4.c0) wl0Var.getLayoutManager()).h1(indexOf, (themeActivity.f31823b.getMeasuredWidth() / 2) - AndroidUtilities.dp(42.0f));
                                                            return;
                                                        }
                                                        return;
                                                    default:
                            ...
                            if (i10 == themeActivity.X) {
                                w8Var.f(LocaleController.getString("AutoNightLocation", R.string.AutoNightLocation), org.telegram.ui.ActionBar.h6.f19258p, true);
                                return;
                        ...
                        ((org.telegram.ui.Cells.k0) view).setProgress(org.telegram.ui.ActionBar.h6.f19277q);
                        return;
                    }
            ...
            if (i10 == themeActivity.f31830f0) {
                e9Var.setText(LocaleController.formatString("AutoNightBrightnessInfo", R.string.AutoNightBrightnessInfo, Integer.valueOf((int) (org.telegram.ui.ActionBar.h6.f19277q * 100.0f))));
                return;
            } else if (i10 == themeActivity.Z) {
                e9Var.setText(ThemeActivity.y0());
                return;
            } else if (i10 == themeActivity.f31848v0) {
        ...
        if (i10 == i11) {
            if (org.telegram.ui.ActionBar.h6.f19239o != 0 && org.telegram.ui.ActionBar.h6.J != null) {
        ...
        } else if (i10 == themeActivity.f31822a0) {
            int i30 = org.telegram.ui.ActionBar.h6.f19295r;
            int i31 = i30 / 60;
        ...
        } else if (i10 == themeActivity.f31824b0) {
            int i32 = org.telegram.ui.ActionBar.h6.f19314s;
            int i33 = i32 / 60;
            ...
            eaVar.c(LocaleController.getString("AutoNightUpdateLocation", R.string.AutoNightUpdateLocation), org.telegram.ui.ActionBar.h6.f19387w, false, false);
            ...
            eaVar.c(LocaleController.getString(R.string.SearchEngine), org.telegram.ui.web.o1.a().f39154a, themeActivity.P0, false);
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        switch (i10) {
            ...
            case 9:
                ...
                frameLayout.f38407b = new org.telegram.ui.Cells.y0[2];
                ...
                int i21 = 0;
                while (true) {
                    ?? r32 = (org.telegram.ui.Cells.y0[]) frameLayout.f38407b;
                    if (i21 >= r32.length) {
                        j5Var = frameLayout;
                        break;
                    } else {
                        ...
                        frameLayout2.f21850c = new RectF();
                        TextPaint textPaint = new TextPaint(1);
                        frameLayout2.d = textPaint;
                        frameLayout2.setWillNotDraw(false);
                        frameLayout2.f21849b = z10;
                        if (z10) {
                        ...
                        org.telegram.ui.Cells.y0 y0Var = ((org.telegram.ui.Cells.y0[]) frameLayout.f38407b)[i21];
                        if (i21 == 1) {
                            i14 = 10;
                        } else {
                            i14 = 0;
                        ...
                        ((org.telegram.ui.Cells.y0[]) frameLayout.f38407b)[i21].setOnClickListener(new ai.j3(3, frameLayout, z10));
                        i21++;
                    }
                }
                break;
            case 10:
                j5Var = new org.telegram.ui.Cells.j5(21, 60, this.f40096c, null, true);
                break;
            case 11:
                this.d = true;
                vb1 vb1Var = new vb1(this, this.f40096c, themeActivity, themeActivity.f31829f, themeActivity.e, themeActivity.d);
                themeActivity.f31825c = vb1Var;
                vb1Var.setDrawDivider(themeActivity.v);
                themeActivity.f31825c.setFocusable(false);
                View view = themeActivity.f31825c;
            ...
            case 15:
                ...
                frameLayout3.f23738a = paint;
                frameLayout3.f23739b = new Paint(1);
                Paint paint2 = new Paint(1);
                frameLayout3.f23740c = paint2;
                Paint paint3 = new Paint(1);
                frameLayout3.d = paint3;
                frameLayout3.e = new RectF();
                int i22 = 6;
                frameLayout3.h = r14;
                frameLayout3.f23742n = r15;
                frameLayout3.f23743r = new org.telegram.ui.Components.ij0[6];
                frameLayout3.v = new org.telegram.ui.Components.lj0[2];
                float f11 = 1.0f;
                frameLayout3.f23746x = 1.0f;
                ...
                int i23 = org.telegram.ui.ActionBar.h6.f19030c9;
                int[] iArr = {i23, i23, i23, i23, org.telegram.ui.ActionBar.h6.Y5, org.telegram.ui.ActionBar.h6.f19048d9};
                ...
                org.telegram.ui.Components.ij0 a2 = frameLayout3.a(frameLayout3.f23741f.getValue());
                if (a2 != null) {
                ...
                if (frameLayout3.f23741f.getValue() != 5) {
                    f11 = 0.0f;
                }
                frameLayout3.f23745w = f11;
                frameLayout3.F = frameLayout3.f23741f.getValue();
                j5Var = frameLayout3;
                break;
            case 16:
                ...
                break;
            case 17:
                View bvVar = new bv(themeActivity.f31829f, context, themeActivity);
            ...
            case 21:
                ...
                frameLayout = new yo0(i17, 0L, this.f40096c, themeActivity.getResourceProvider());
                j5Var = frameLayout;
                break;
        }
    ...
    public final void y(s4.c1 c1Var) {
        boolean z10;
        if (c1Var.f42949f == 4) {
            org.telegram.ui.Cells.ja jaVar = (org.telegram.ui.Cells.ja) c1Var.f42946a;
            if (c1Var.b() == org.telegram.ui.ActionBar.h6.f19239o) {
                z10 = true;
            } else {
                z10 = false;
            }
