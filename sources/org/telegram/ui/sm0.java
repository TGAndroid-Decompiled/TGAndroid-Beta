...
public final class sm0 implements RequestDelegate {
    ...
    public final byte[] f37829b;
    public final TL_account.getPasswordSettings f37830c;
    ...
    public sm0(gn0 gn0Var, boolean z10, byte[] bArr, TL_account.getPasswordSettings getpasswordsettings, String str) {
        ...
        this.f37828a = z10;
        this.f37829b = bArr;
        this.f37830c = getpasswordsettings;
        this.d = str;
    }
    ...
    public final void a() {
        ...
        if (!this.f37828a) {
            ...
            UserConfig.getInstance(i12).savePassword(this.f37829b, gn0Var.f33982e1);
        }
        AndroidUtilities.hideKeyboard(gn0Var.Y[0]);
        gn0Var.f33985f1 = true;
        long j3 = gn0Var.f33976c;
        if (j3 == 0) {
            i10 = 8;
        } else {
            i10 = 0;
        }
        gn0 gn0Var2 = new gn0(i10, j3, gn0Var.h, gn0Var.f34007r, gn0Var.d, gn0Var.e, gn0Var.f33998n, gn0Var.f34025y, gn0Var.J);
        gn0Var2.f33980d1 = gn0Var.f33980d1;
        ...
        gn0Var2.f33975b1 = gn0Var.f33975b1;
    ...
    public final void b() {
        ...
        if (passwordKdfAlgo instanceof TLRPC.TL_passwordKdfAlgoSHA256SHA256PBKDF2HMACSHA512iter100000SHA256ModPow) {
            updatepasswordsettings.password = SRPHelper.startCheck(this.f37829b, password.srp_id, password.srp_B, (TLRPC.TL_passwordKdfAlgoSHA256SHA256PBKDF2HMACSHA512iter100000SHA256ModPow) passwordKdfAlgo);
        }
        ...
        ConnectionsManager.getInstance(i10).sendRequest(this.f37830c, new qm0(this, 1));
    }
    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        if (tL_error != null && "SRP_ID_INVALID".equals(tL_error.text)) {
            ...
            ConnectionsManager.getInstance(i10).sendRequest(getpassword, new ci.t3(9, this, this.f37828a), 8);
        } else if (tL_error == null) {
            Utilities.globalQueue.postRunnable(new ai.s4(this, tLObject, this.d, this.f37828a, 25));
        } else {
            AndroidUtilities.runOnUIThread(new da0(this, this.f37828a, tL_error, 2));
        }
    }
}
