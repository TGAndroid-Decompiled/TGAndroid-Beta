...
public final class p41 implements org.telegram.ui.Components.nl0, org.telegram.ui.Components.pl0, oy {
    public final SaveToGallerySettingsActivity f36495a;

    public p41(SaveToGallerySettingsActivity saveToGallerySettingsActivity) {
        this.f36495a = saveToGallerySettingsActivity;
    }
    ...
    public void c(float f7, float f10, int i10, View view) {
        SaveToGallerySettingsActivity saveToGallerySettingsActivity = this.f36495a;
        ArrayList arrayList = saveToGallerySettingsActivity.f31739s;
        ...
        } else if (i10 == saveToGallerySettingsActivity.f31736f) {
            SaveToGallerySettingsHelper.Settings X2 = saveToGallerySettingsActivity.X();
            X2.saveVideo = !X2.saveVideo;
            saveToGallerySettingsActivity.Y();
            saveToGallerySettingsActivity.Z();
        } else if (((s41) arrayList.get(i10)).f15719a == 1) {
            Bundle bundle = new Bundle();
            bundle.putBoolean("onlySelect", true);
            bundle.putBoolean("checkCanWrite", false);
            int i11 = saveToGallerySettingsActivity.f31733a;
            if (i11 == 2) {
    ...
    public boolean mo18c(float f7, float f10, int i10, View view) {
        SaveToGallerySettingsActivity saveToGallerySettingsActivity = this.f36495a;
        ArrayList arrayList = saveToGallerySettingsActivity.f31739s;
        if (((s41) arrayList.get(i10)).f15719a == 2) {
            SaveToGallerySettingsHelper.DialogException dialogException = ((s41) arrayList.get(i10)).f37317c;
