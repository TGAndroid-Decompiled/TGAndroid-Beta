...
public final class p41 implements org.telegram.ui.Components.al0, org.telegram.ui.Components.cl0, oy {
    public final SaveToGallerySettingsActivity f39407a;

    public p41(SaveToGallerySettingsActivity saveToGallerySettingsActivity) {
        this.f39407a = saveToGallerySettingsActivity;
    }
    ...
    public void d(float f7, float f10, int i10, View view) {
        SaveToGallerySettingsActivity saveToGallerySettingsActivity = this.f39407a;
        ArrayList arrayList = saveToGallerySettingsActivity.f34056s;
        if (i10 == saveToGallerySettingsActivity.f34052e) {
            SaveToGallerySettingsHelper.Settings X = saveToGallerySettingsActivity.X();
            X.savePhoto = !X.savePhoto;
            saveToGallerySettingsActivity.Y();
            saveToGallerySettingsActivity.Z();
        } else if (i10 == saveToGallerySettingsActivity.f34053f) {
            SaveToGallerySettingsHelper.Settings X2 = saveToGallerySettingsActivity.X();
            X2.saveVideo = !X2.saveVideo;
            saveToGallerySettingsActivity.Y();
            saveToGallerySettingsActivity.Z();
        } else if (((s41) arrayList.get(i10)).f44072a == 1) {
            Bundle bundle = new Bundle();
            bundle.putBoolean("onlySelect", true);
            bundle.putBoolean("checkCanWrite", false);
            int i11 = saveToGallerySettingsActivity.f34049a;
            if (i11 == 2) {
    ...
    public boolean u(uy uyVar, ArrayList arrayList, CharSequence charSequence, boolean z10, boolean z11, int i10, int i11, eg1 eg1Var) {
        ...
        SaveToGallerySettingsActivity saveToGallerySettingsActivity = this.f39407a;
        bundle.putInt("type", saveToGallerySettingsActivity.f34049a);
    ...
    public boolean mo18d(float f7, float f10, int i10, View view) {
        SaveToGallerySettingsActivity saveToGallerySettingsActivity = this.f39407a;
        ArrayList arrayList = saveToGallerySettingsActivity.f34056s;
        if (((s41) arrayList.get(i10)).f44072a == 2) {
            SaveToGallerySettingsHelper.DialogException dialogException = ((s41) arrayList.get(i10)).f40301c;
            ...
            int i11 = org.telegram.ui.ActionBar.j6.f20881p7;
