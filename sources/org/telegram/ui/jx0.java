...
public final class jx0 extends LinearLayout {
    ...
    public final fx0 d;
    public final gx0 f37863e;
    public boolean f37864f;
    public boolean h;
    public final PremiumPreviewFragment f37865n;
    ...
    public jx0(PremiumPreviewFragment premiumPreviewFragment, Context context) {
        ...
        int i11;
        int i12;
        this.f37865n = premiumPreviewFragment;
        setOrientation(1);
        FrameLayout frameLayout = new FrameLayout(context);
        this.f37862c = frameLayout;
        int i13 = premiumPreviewFragment.f33782g0;
        if (i13 == 1) {
            i10 = 175;
        } else {
            i10 = 190;
    ...
    public final void b() {
        ...
        int i12;
        int i13;
        PremiumPreviewFragment premiumPreviewFragment = this.f37865n;
        int i14 = premiumPreviewFragment.f33782g0;
        TextView textView = this.f37860a;
        TextView textView2 = this.f37861b;
        if (i14 == 0) {
            if (premiumPreviewFragment.f33791p0) {
                i12 = R.string.TelegramPremiumSubscribedTitle;
            } else {
                i12 = R.string.TelegramPremium;
            }
            textView.setText(LocaleController.getString(i12));
            if (!premiumPreviewFragment.getUserConfig().isPremium() && !premiumPreviewFragment.f33791p0) {
        ...
        int i15 = 0;
        if (!premiumPreviewFragment.f33791p0 && !BuildVars.IS_BILLING_UNAVAILABLE && premiumPreviewFragment.d.size() > 1) {
            z10 = false;
        } else {
            z10 = true;
        }
        boolean z11 = this.f37864f;
        gx0 gx0Var = this.f37863e;
        if (z11 && z10) {
