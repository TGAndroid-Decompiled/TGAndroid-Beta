...
public final class jx0 extends LinearLayout {
    ...
    public final FrameLayout f34957c;
    public final fx0 d;
    public final gx0 e;
    public boolean f34958f;
    public boolean h;
    public final PremiumPreviewFragment f34959n;
    ...
    public jx0(PremiumPreviewFragment premiumPreviewFragment, Context context) {
        ...
        int i11;
        int i12;
        this.f34959n = premiumPreviewFragment;
        setOrientation(1);
        FrameLayout frameLayout = new FrameLayout(context);
        this.f34957c = frameLayout;
        int i13 = premiumPreviewFragment.f31409g0;
        if (i13 == 1) {
            i10 = 175;
        } else {
            i10 = 190;
    ...
    public final void b() {
        ...
        int i12;
        int i13;
        PremiumPreviewFragment premiumPreviewFragment = this.f34959n;
        int i14 = premiumPreviewFragment.f31409g0;
        TextView textView = this.f34955a;
        TextView textView2 = this.f34956b;
        if (i14 == 0) {
            if (premiumPreviewFragment.f31418p0) {
                i12 = R.string.TelegramPremiumSubscribedTitle;
            } else {
                i12 = R.string.TelegramPremium;
            }
            textView.setText(LocaleController.getString(i12));
            if (!premiumPreviewFragment.getUserConfig().isPremium() && !premiumPreviewFragment.f31418p0) {
        ...
        int i15 = 0;
        if (!premiumPreviewFragment.f31418p0 && !BuildVars.IS_BILLING_UNAVAILABLE && premiumPreviewFragment.d.size() > 1) {
            z10 = false;
        } else {
            z10 = true;
        }
        boolean z11 = this.f34958f;
        gx0 gx0Var = this.e;
        if (z11 && z10) {
