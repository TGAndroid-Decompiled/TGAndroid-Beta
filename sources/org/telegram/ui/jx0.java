...
public final class jx0 extends LinearLayout {
    public final TextView f35000a;
    public final TextView f35001b;
    public final FrameLayout f35002c;
    public final fx0 d;
    public final gx0 e;
    public boolean f35003f;
    public boolean h;
    public final PremiumPreviewFragment f35004n;
    ...
    public jx0(PremiumPreviewFragment premiumPreviewFragment, Context context) {
        ...
        int i11;
        int i12;
        this.f35004n = premiumPreviewFragment;
        setOrientation(1);
        FrameLayout frameLayout = new FrameLayout(context);
        this.f35002c = frameLayout;
        int i13 = premiumPreviewFragment.f31449g0;
        if (i13 == 1) {
            i10 = 175;
        } else {
            i10 = 190;
    ...
    public final void b() {
        ...
        int i12;
        int i13;
        PremiumPreviewFragment premiumPreviewFragment = this.f35004n;
        int i14 = premiumPreviewFragment.f31449g0;
        TextView textView = this.f35000a;
        TextView textView2 = this.f35001b;
        if (i14 == 0) {
            if (premiumPreviewFragment.f31458p0) {
                i12 = R.string.TelegramPremiumSubscribedTitle;
            } else {
                i12 = R.string.TelegramPremium;
            }
            textView.setText(LocaleController.getString(i12));
            if (!premiumPreviewFragment.getUserConfig().isPremium() && !premiumPreviewFragment.f31458p0) {
        ...
        int i15 = 0;
        if (!premiumPreviewFragment.f31458p0 && !BuildVars.IS_BILLING_UNAVAILABLE && premiumPreviewFragment.d.size() > 1) {
            z10 = false;
        } else {
            z10 = true;
        }
        boolean z11 = this.f35003f;
        gx0 gx0Var = this.e;
        if (z11 && z10) {
