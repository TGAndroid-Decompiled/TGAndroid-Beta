...
public final class jx0 extends LinearLayout {
    public final TextView f37887a;
    public final TextView f37888b;
    public final FrameLayout f37889c;
    public final fx0 d;
    public final gx0 f37890e;
    public boolean f37891f;
    public boolean h;
    public final PremiumPreviewFragment f37892n;
    ...
    public jx0(PremiumPreviewFragment premiumPreviewFragment, Context context) {
        ...
        int i11;
        int i12;
        this.f37892n = premiumPreviewFragment;
        setOrientation(1);
        FrameLayout frameLayout = new FrameLayout(context);
        this.f37889c = frameLayout;
        int i13 = premiumPreviewFragment.f33809g0;
        if (i13 == 1) {
            i10 = 175;
        } else {
            i10 = 190;
    ...
    public final void b() {
        ...
        int i12;
        int i13;
        PremiumPreviewFragment premiumPreviewFragment = this.f37892n;
        int i14 = premiumPreviewFragment.f33809g0;
        TextView textView = this.f37887a;
        TextView textView2 = this.f37888b;
        if (i14 == 0) {
            if (premiumPreviewFragment.f33818p0) {
                i12 = R.string.TelegramPremiumSubscribedTitle;
            } else {
                i12 = R.string.TelegramPremium;
            }
            textView.setText(LocaleController.getString(i12));
            if (!premiumPreviewFragment.getUserConfig().isPremium() && !premiumPreviewFragment.f33818p0) {
        ...
        int i15 = 0;
        if (!premiumPreviewFragment.f33818p0 && !BuildVars.IS_BILLING_UNAVAILABLE && premiumPreviewFragment.d.size() > 1) {
            z10 = false;
        } else {
            z10 = true;
        }
        boolean z11 = this.f37891f;
        gx0 gx0Var = this.f37890e;
        if (z11 && z10) {
