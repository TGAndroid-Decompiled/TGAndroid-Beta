...
public class DataUsage2Activity extends BaseFragment {
    ...
    public class Cell extends FrameLayout {
        ...
        public void set(int i, int i2, int i3, CharSequence charSequence, CharSequence charSequence2, boolean z) {
            if (i3 == 0) {
                ...
                boolean zIsDark = DataUsage2Activity.this.resourcesProvider != null ? DataUsage2Activity.this.resourcesProvider.isDark() : Theme.currentTheme.isDark();
    ...
    public static class ItemInner extends AdapterWithDiffUtils.Item {
        ...
        public static ItemInner asCell(String str, CharSequence charSequence) {
            return new ItemInner(2, str, charSequence);
        }
        ...
        private ItemInner(int i, CharSequence charSequence, CharSequence charSequence2) {
            super(i, false);
            this.text = charSequence;
            this.valueText = charSequence2;
        }

        private ItemInner(int i, int i2, CharSequence charSequence, CharSequence charSequence2) {
            super(i, false);
            this.index = i2;
            this.text = charSequence;
            this.valueText = charSequence2;
    ...
    public class ListView extends RecyclerListView {
        ...
        public class Adapter extends AdapterWithDiffUtils {
            ...
            public class AnonymousClass1 extends CacheChart {
                public AnonymousClass1(Context context, int i, int[] iArr, int i2, int[] iArr2) {
                ...
                public void onSectionDown(int i, boolean z) {
                    ...
                    if (i2 >= 0) {
                        ListView.this.highlightRow(new LogoutActivity$$ExternalSyntheticLambda1(i2, 2), 0);
                    } else {
                        ListView.this.removeHighlightRow();
                    }
                }
            ...
            public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
                ...
                if (i != 0) {
                    if (i != 1) {
                        if (i == 3) {
                            textInfoPrivacyCell = new TextInfoPrivacyCell(ListView.this.getContext(), 24, null);
                        } else if (i == 4) {
        ...
        public ListView(Context context) {
            ...
            setAdapter(adapter);
            setSections();
            setOnItemClickListener(new PhotoViewer$$ExternalSyntheticLambda100(this, 2));
        ...
        private CharSequence bold(CharSequence charSequence) {
        ...
        private long getReceivedBytesCount(int i) {
            ...
            if (i2 == 1 || i2 == 2 || i2 == 3) {
                return StatsController.getInstance(((BaseFragment) DataUsage2Activity.this).currentAccount).getReceivedBytesCount(this.currentType - 1, i);
            }
            return StatsController.getInstance(((BaseFragment) DataUsage2Activity.this).currentAccount).getReceivedBytesCount(2, i) + StatsController.getInstance(((BaseFragment) DataUsage2Activity.this).currentAccount).getReceivedBytesCount(1, i) + StatsController.getInstance(((BaseFragment) DataUsage2Activity.this).currentAccount).getReceivedBytesCount(0, i);
        }

        private int getReceivedItemsCount(int i) {
            int i2 = this.currentType;
            if (i2 == 1 || i2 == 2 || i2 == 3) {
                return StatsController.getInstance(((BaseFragment) DataUsage2Activity.this).currentAccount).getRecivedItemsCount(this.currentType - 1, i);
            }
            return StatsController.getInstance(((BaseFragment) DataUsage2Activity.this).currentAccount).getRecivedItemsCount(2, i) + StatsController.getInstance(((BaseFragment) DataUsage2Activity.this).currentAccount).getRecivedItemsCount(1, i) + StatsController.getInstance(((BaseFragment) DataUsage2Activity.this).currentAccount).getRecivedItemsCount(0, i);
        }
        ...
        private long getSentBytesCount(int i) {
            int i2 = this.currentType;
            if (i2 == 1 || i2 == 2 || i2 == 3) {
                return StatsController.getInstance(((BaseFragment) DataUsage2Activity.this).currentAccount).getSentBytesCount(this.currentType - 1, i);
            }
            return StatsController.getInstance(((BaseFragment) DataUsage2Activity.this).currentAccount).getSentBytesCount(2, i) + StatsController.getInstance(((BaseFragment) DataUsage2Activity.this).currentAccount).getSentBytesCount(1, i) + StatsController.getInstance(((BaseFragment) DataUsage2Activity.this).currentAccount).getSentBytesCount(0, i);
        }

        private int getSentItemsCount(int i) {
            int i2 = this.currentType;
            if (i2 == 1 || i2 == 2 || i2 == 3) {
                return StatsController.getInstance(((BaseFragment) DataUsage2Activity.this).currentAccount).getSentItemsCount(this.currentType - 1, i);
            }
            return StatsController.getInstance(((BaseFragment) DataUsage2Activity.this).currentAccount).getSentItemsCount(2, i) + StatsController.getInstance(((BaseFragment) DataUsage2Activity.this).currentAccount).getSentItemsCount(1, i) + StatsController.getInstance(((BaseFragment) DataUsage2Activity.this).currentAccount).getSentItemsCount(0, i);
        }
        ...
        public void lambda$new$1(View view, int i) {
            ...
            if (view instanceof TextCell) {
                AlertDialog.Builder builder = new AlertDialog.Builder(DataUsage2Activity.this.getParentActivity(), 0, null);
                ...
                builder.setPositiveButton(LocaleController.getString(R.string.Reset), new PhotoViewer$55$$ExternalSyntheticLambda2(this, 11));
        ...
        private void setup() {
            ...
            Arrays.sort(this.segments, new OAuthSheet$$ExternalSyntheticLambda10(1));
        ...
        private void updateRows(boolean z) {
            ...
            this.itemInners.add(ItemInner.asSubtitle(string2));
            ...
            if (this.currentType != 0) {
                ...
                if (i6 != 1) {
                    string = i6 != 3 ? LocaleController.getString(R.string.AutomaticDownloadSettingsInfoWiFi) : LocaleController.getString(R.string.AutomaticDownloadSettingsInfoRoaming);
                } else {
        ...
        public void scrollTo(int i) {
            highlightRow(new LaunchActivity$$ExternalSyntheticLambda23(this, i, 1));
        }
