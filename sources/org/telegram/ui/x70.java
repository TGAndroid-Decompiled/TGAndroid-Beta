        ...
        switch (i11) {
            ...
            case 9:
                ...
                if (i10 == -1) {
                    ...
                    bundle.putLong("chat_id", lj0Var.f35563b);
            ...
            case 14:
                ...
                if (i10 == -1) {
                    ...
                    if (oq0Var.f36401c != null && !oq0Var.f36402f) {
                        mq0 mq0Var = oq0Var.d;
                        float f7 = mq0Var.f35865f - mq0Var.f35870x;
                        float f10 = mq0Var.v;
                        float f11 = (mq0Var.h - mq0Var.f35871y) / mq0Var.f35869w;
                        float f12 = mq0Var.d / f10;
                        float f13 = mq0Var.e / f10;
                        oq0 oq0Var2 = mq0Var.H;
                        int width = (int) ((f7 / f10) * oq0Var2.f36399a.getWidth());
                        int height = (int) (f11 * oq0Var2.f36399a.getHeight());
                        int width2 = (int) (f12 * oq0Var2.f36399a.getWidth());
                        int width3 = (int) (f13 * oq0Var2.f36399a.getWidth());
                        if (width < 0) {
                            width = 0;
                        }
                        if (height < 0) {
                        ...
                        if (width + width2 > oq0Var2.f36399a.getWidth()) {
                            width2 = oq0Var2.f36399a.getWidth() - width;
                        }
                        if (height + width3 > oq0Var2.f36399a.getHeight()) {
                            width3 = oq0Var2.f36399a.getHeight() - height;
                        }
                        try {
                            bitmap = Bitmaps.createBitmap(oq0Var2.f36399a, width, height, width2, width3);
                        } catch (Throwable th2) {
                            FileLog.e(th2);
                            System.gc();
                            try {
                        ...
                        if (bitmap == oq0Var.f36399a) {
                            oq0Var.e = true;
                        }
                        ((org.telegram.ui.Components.u40) oq0Var.f36401c).s(false, bitmap, null);
                        oq0Var.f36402f = true;
                    }
                    oq0Var.finishFragment();
                    return;
            ...
            case 17:
                ...
                if (i10 == -1) {
                    ...
                    int i12 = PopupNotificationActivity.f31156b0;
                    popupNotificationActivity.k();
                    return;
                } else if (i10 == 2) {
                    int i13 = PopupNotificationActivity.f31156b0;
