...
public final class vx implements ah.j, org.telegram.ui.Components.ho0, org.telegram.ui.Components.nl0, ci.cc, org.telegram.ui.Components.b20 {
    ...
    public boolean mo18c(float f7, float f10, int i10, View view) {
        ...
        zx zxVar = qyVar.C0;
        ai.w0 w0Var = zxVar.V;
        return qyVar.o4(view, i10, f7, zxVar.f26152b0);
    }
    ...
    public void d(Canvas canvas) {
        ...
        switch (this.f38845a) {
            case 0:
                ...
                canvas.drawColor(qyVar.getThemedColor(org.telegram.ui.ActionBar.h6.f19060d6));
                if (SharedConfig.chatBlurEnabled()) {
                    kx kxVar = qyVar.F3;
                    if (kxVar != null && (kxVar.getFragment() instanceof wf1)) {
                        wf1Var = (wf1) qyVar.F3.getFragment();
                    ...
                    if (wf1Var != null && wf1Var.getFragmentView() != null && !qyVar.f37062j2 && (dVar = wf1Var.f39326g1) != null) {
                        canvas.save();
            ...
            default:
                ...
                canvas.drawColor(qyVar2.getThemedColor(org.telegram.ui.ActionBar.h6.f19060d6));
                if (SharedConfig.chatBlurEnabled()) {
                    kx kxVar2 = qyVar2.F3;
                    if (kxVar2 != null && (kxVar2.getFragment() instanceof wf1)) {
                        wf1Var2 = (wf1) qyVar2.F3.getFragment();
                    ...
                    if (wf1Var2 != null && wf1Var2.getFragmentView() != null && !qyVar2.f37062j2 && (dVar2 = wf1Var2.f39328h1) != null) {
                        canvas.save();
    ...
    public void e(float f7) {
        ...
        if (point.x > point.y) {
            this.f38846b.movePreviewFragment(f7);
        }
    }

    @Override
    public void f(org.telegram.ui.Cells.s2 s2Var) {
        this.f38846b.H4(s2Var);
    }
    ...
    public void finish() {
        Point point = AndroidUtilities.displaySize;
        if (point.x > point.y) {
            this.f38846b.finishPreviewFragment();
        }
    }
    ...
    public void h(gg.q0 q0Var) {
        ...
        qyVar.Y.f47100a.q(qyVar.X.f23161r);
    }
