...
public final class tp0 extends org.telegram.ui.ActionBar.m2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public boolean f38165a0;
    public final yh.k5 f38166b;
    public i0.b f38167b0;
    public final yh.k5 f38168c;
    public yf.b0 f38169c0;
    public k0 d;
    public final pe.b f38170d0;
    public vo0 e;
    public final pe.b f38171e0;
    public final int f38172f;
    public final ah.h f38173f0;
    public final fh.d f38174g0;
    public np0 h;
    public final ah.c f38175h0;
    public final va f38176i0;
    public final ArrayList f38177j0;
    public final ArrayList f38178k0;
    public np0 f38179n;
    public boolean f38180r;
    public org.telegram.ui.ActionBar.d6 f38181s;
    public final SparseIntArray v;
    public final org.telegram.ui.ActionBar.d5 f38182w;
    public final org.telegram.ui.ActionBar.d5 f38183x;
    public final fh.c f38184y;

    public tp0() {
        super(null);
        this.f38172f = AndroidUtilities.dp(6.0f);
        this.v = new SparseIntArray();
        boolean q6 = org.telegram.ui.ActionBar.h6.I.q();
        this.S = q6;
        this.f38165a0 = q6;
        this.f38167b0 = i0.b.e;
        pe.b bVar = new pe.b();
        this.f38170d0 = bVar;
        pe.b bVar2 = new pe.b();
        this.f38171e0 = bVar2;
        this.f38176i0 = new va(this, 1);
        this.f38177j0 = new ArrayList();
        this.f38178k0 = new ArrayList();
        fh.c cVar = new fh.c();
        this.f38184y = cVar;
        ...
        if (Build.VERSION.SDK_INT >= 31 && SharedConfig.chatBlurEnabled()) {
            ...
            this.f38173f0 = null;
            this.f38174g0 = null;
            this.f38175h0 = new ah.c(cVar);
        }
        cVar2.e = bVar;
        cVar2.d = bVar2;
        cVar4.e = bVar;
        cVar4.d = bVar2;
        ah.c cVar6 = this.f38175h0;
        cVar6.e = bVar;
        cVar6.d = bVar2;
        this.f38164a = false;
        ...
        this.f38182w = new org.telegram.ui.ActionBar.d5(0, false, false, this.resourceProvider);
        this.f38183x = new org.telegram.ui.ActionBar.d5(0, false, true, this.resourceProvider);
    }
    ...
    public static void U(tp0 tp0Var, boolean[] zArr, TL_stars.TL_starGiftUnique tL_starGiftUnique, long j3, qo0 qo0Var, yh.a3 a3Var, nf.e eVar) {
        zArr[0] = true;
        eVar.d();
        yh.s5.x(tp0Var.currentAccount, a3Var.f47200a).h(a3Var.f47201b, tL_starGiftUnique, j3, null, true, new ai.m0(18, eVar, qo0Var));
    }
    ...
    public final void A0() {
        ...
        if (cVar.f9055a.getColor() != themedColor) {
            cVar.a(themedColor);
            Iterator it = this.f38171e0.iterator();
            while (it.hasNext()) {
                ((ch.d) it.next()).v();
            }
            Iterator it2 = this.f38170d0.iterator();
            while (it2.hasNext()) {
    ...
    public final void D0(int i10) {
        if (Build.VERSION.SDK_INT >= 31 && this.f38173f0 != null) {
            yf.b0 b0Var = this.f38169c0;
            if (b0Var.f47060c == 0) {
                b0Var.invalidate();
            }
    ...
    public final void F0() {
        ...
        vo0 vo0Var = this.e;
        if (vo0Var != null) {
            vo0Var.f40551a = org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19003a7, vo0Var.f40552b);
            vo0Var.a();
            vo0Var.invalidate();
        }
        G0();
    ...
    public final void G0() {
        ...
        if (this.e != null) {
            ...
            if (this.M != null) {
                ...
                rzVar.f28070a.setColor(d);
                rzVar.f28071b.setColor(d10);
                rzVar.d = d11;
                rzVar.e = d12;
                rzVar.invalidate();
            }
    ...
    public final View createView(Context context) {
        ...
        this.f38169c0 = new yf.b0(context, new po0(this, 0));
        hh.k kVar = new hh.k(this.d);
        k0 k0Var2 = this.d;
        ah.c cVar = this.f38175h0;
        cVar.f425f = kVar;
        cVar.f426g = k0Var2;
        this.h = new np0(this, context, 1);
        this.f38179n = new np0(this, context, 0);
        vo0 vo0Var = new vo0(this, context, this.resourceProvider);
        this.e = vo0Var;
        vo0Var.E = true;
        this.f38179n.j(false);
        this.f38179n.addView(this.e, 2, w7.y5.e(-1, -2, 55));
        ...
        vo0 vo0Var3 = this.e;
        vo0Var3.getClass();
        vo0Var3.f40551a = org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19003a7, vo0Var3.f40552b);
        vo0Var3.a();
        vo0Var3.invalidate();
        z0();
        this.d.addView(this.f38169c0);
        A0();
    ...
    public final boolean isSwipeBackEnabled(MotionEvent motionEvent) {
        if (!this.f38164a && ((this.h.b() || this.f38179n.b()) && getUserConfig().isPremium())) {
            return false;
        }
    ...
    public final boolean onBackPressed(boolean z10) {
        int i10;
        int i11;
        boolean z11 = this.f38164a;
        if (!z11 && ((this.h.b() || this.f38179n.b()) && getUserConfig().isPremium())) {
    ...
    public final void z0() {
        this.f38184y.a(getThemedColor(org.telegram.ui.ActionBar.h6.f19059d6));
        this.O.invalidate();
        this.P.invalidate();
        this.h.f35958w.invalidate();
        this.h.f35959x.invalidate();
        this.f38179n.f35958w.invalidate();
        this.h.f35938b.invalidate();
        this.f38179n.f35938b.invalidate();
