...
public final class au0 extends nu0 {
    public final int f34550p0;
    public final NotificationCenter.NotificationCenterDelegate f34551q0;
    ...
    public au0(NotificationCenter.NotificationCenterDelegate notificationCenterDelegate, Context context, qu0 qu0Var, FrameLayout frameLayout, int i10) {
        ...
        this.f34550p0 = i10;
        this.f34551q0 = notificationCenterDelegate;
    }

    @Override
    public boolean C() {
        switch (this.f34550p0) {
            case 0:
                return !((PhotoViewer) this.f34551q0).f33671s;
            default:
                return super.C();
        }
    }
    ...
    public void D() {
        switch (this.f34550p0) {
            case 1:
                SecretMediaViewer secretMediaViewer = (SecretMediaViewer) this.f34551q0;
                if (secretMediaViewer.J && getScrollY() <= 0) {
                    AndroidUtilities.runOnUIThread(secretMediaViewer.f34098r1, 3000L);
                    return;
                }
                return;
            default:
    ...
    public void F() {
        switch (this.f34550p0) {
            case 1:
                AndroidUtilities.cancelRunOnUIThread(((SecretMediaViewer) this.f34551q0).f34098r1);
                return;
            default:
                return;
        }
        ...
        switch (this.f34550p0) {
            case 1:
                ...
                if (secretMediaViewer.K0 == null) {
                    if (getScrollY() < getMeasuredHeight() / 3.0f && secretMediaViewer.f34083k0) {
                        z10 = true;
                    } else {
                        z10 = false;
                    }
    ...
    public void invalidate() {
        ...
        switch (this.f34550p0) {
            case 0:
                super.invalidate();
                PhotoViewer photoViewer = (PhotoViewer) this.f34551q0;
                ...
                if (photoViewer.J) {
                    ...
                    if (!z10) {
                        int b10 = yu0VarArr[0].b() + yu0VarArr[0].f43216j;
                        if (C()) {
