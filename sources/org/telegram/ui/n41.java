...
public final class n41 implements Runnable {
    ...
    public final SecretMediaViewer f35735b;

    public n41(SecretMediaViewer secretMediaViewer, int i10) {
        this.f35734a = i10;
        this.f35735b = secretMediaViewer;
    }
    ...
    public final void run() {
        String format;
        String format2;
        int i10 = this.f35734a;
        SecretMediaViewer secretMediaViewer = this.f35735b;
        switch (i10) {
            case 0:
                ...
                secretMediaViewer.f31748s = false;
            ...
            case 2:
                ...
                if (t41Var != null) {
                    ...
                    int[] iArr = secretMediaViewer.f31731j1;
                    Arrays.fill(iArr, 0);
                    int[] iArr2 = secretMediaViewer.f31733k1;
                    Arrays.fill(iArr2, 0);
                    t41 t41Var2 = secretMediaViewer.f31762y;
                    if (t41Var2 != null) {
                        long max = Math.max(0L, t41Var2.n()) / 1000;
                        long max2 = Math.max(0L, secretMediaViewer.f31762y.p()) / 1000;
                        iArr[0] = (int) (max / 60);
                        iArr[1] = (int) (max % 60);
                        iArr2[0] = (int) (max2 / 60);
                        iArr2[1] = (int) (max2 % 60);
                    ...
                    if (secretMediaViewer.f31762y.y()) {
                        AndroidUtilities.runOnUIThread(secretMediaViewer.f31729i1, 17L);
                        return;
                    }
                    return;
                }
            ...
            case 3:
                ...
                return;
            default:
                ImageReceiver.BitmapHolder bitmapHolder = secretMediaViewer.f31728i0;
                if (bitmapHolder != null) {
                    bitmapHolder.release();
                    secretMediaViewer.f31728i0 = null;
                }
                secretMediaViewer.h.setImageBitmap((Bitmap) null);
                try {
                    if (secretMediaViewer.d.getParent() != null) {
                        ((WindowManager) secretMediaViewer.f31711b.getSystemService("window")).removeView(secretMediaViewer.d);
                    }
                } catch (Exception e) {
                    FileLog.e(e);
                }
                secretMediaViewer.f31730j0 = false;
                return;
        }
    }
