...
public abstract class n41 extends FrameLayout {
    ...
    public AnimationNotificationsLocker f35942n;
    public boolean f35943r;
    public int f35944s;
    public boolean v;
    public org.telegram.ui.ActionBar.e5 f35945w;
    public o1.k f35946x;
    public float f35947y;
    ...
    public final void b() {
        ...
        if (!SharedConfig.animationsEnabled()) {
            this.e = 0.0f;
            g();
            xx xxVar = this.f35938a;
            if (xxVar != null) {
                xxVar.onPause();
                this.f35938a.onFragmentDestroy();
                removeAllViews();
                this.f35938a = null;
        ...
        this.h.addListener(new m41(this, 0));
        this.h.setDuration(250L);
        this.h.setInterpolator(org.telegram.ui.Components.qr.f27383f);
        this.h.start();
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        float f10;
        if (this.v) {
            f(this.E, this.f35938a, this.f35947y);
            invalidate();
        }
        ...
        if (this.f35938a != null && this.d != null && max > 0.0f) {
            if (this.P == null) {
                this.P = new Paint();
            }
            this.P.setColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19213w8, false));
            if (max == 1.0f) {
                canvas.save();
            } else {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (view != null) {
            ...
            layoutParams.topMargin = org.telegram.ui.ActionBar.k.getCurrentActionBarHeight() + i12 + this.f35944s;
        }
        org.telegram.ui.ActionBar.k kVar = this.d;
        if (kVar != null) {
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        org.telegram.ui.ActionBar.e5 e5Var = this.f35945w;
        ...
        if (motionEvent != null && motionEvent.getAction() == 0) {
            ...
            if (this.I) {
                ...
                if (f10 < getMeasuredWidth() / 3.0f && (xVelocity < 3500.0f || xVelocity < yVelocity)) {
                    ...
                    this.h.addListener(new m41(this, 1));
                    this.h.setDuration(250L);
                    this.h.setInterpolator(org.telegram.ui.Components.qr.f27383f);
                    this.h.start();
                } else {
    ...
    public void setCurrentTop(int i10) {
        ...
        View view = this.f35939b;
        if (view != null) {
            view.setTranslationY((i10 - view.getTop()) + this.f35944s);
        }
        j0 j0Var = this.f35940c;
        if (j0Var != null) {
    ...
    public void setTransitionPaddingBottom(int i10) {
        ...
        if (com.google.android.gms.internal.vision.e2.u(xxVar)) {
            float f7 = i10;
            xxVar.X0 = f7;
            xxVar.h.setTranslationY(((-f7) - xxVar.f33652e1) - xxVar.f33650d1);
        }
    }
