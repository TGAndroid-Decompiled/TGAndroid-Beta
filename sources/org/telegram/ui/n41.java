...
public final class n41 extends org.telegram.ui.Cells.t1 {
        ...
        if (paint != null) {
            ...
            if (f10 > 0.0f) {
                if (p41Var.N) {
                    ...
                    getPhotoImage().setAlpha(Math.max(1.0f - this.Me.e(p41Var.N), 1.0f - p41Var.f37179s));
    ...
    public final void d2(Canvas canvas, float f10, Integer num) {
        ...
        mg.r0 r0Var = this.K;
        p41 p41Var = this.Pe;
        canvas.translate(AndroidUtilities.lerp(0, -r0Var.f14115c, p41Var.f37179s), AndroidUtilities.lerp(p41Var.L.getBackgroundDrawableBottom() - getBackgroundDrawableBottom(), r0Var.f14125p, p41Var.f37179s));
        super.d2(canvas, (1.0f - p41Var.f37179s) * f10, num);
        canvas.restore();
    }
    ...
    public final void m2(float f10, Canvas canvas, boolean z4) {
        ...
        if (p41Var.P) {
            ...
            canvas.translate(((this.Ee.right - (AndroidUtilities.dp(8 + i11) + i10)) - this.f22178ob) * p41Var.f37179s, 0.0f);
        }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (z4) {
            ...
            AndroidUtilities.lerp(rectF3, rectF2, p41Var.f37179s, rectF);
            U3(rectF.left, rectF.top, rectF.width(), rectF.height());
            getPhotoImage().setRoundRadius((int) rectF.width());
            if (p41Var.f37179s > 0.0f && p41Var.N) {
                canvas2 = canvas;
                canvas2.saveLayerAlpha(0.0f, 0.0f, getWidth(), getHeight(), 255, 31);
            } else {
                canvas2 = canvas;
            }
            this.f22238se = 1.0f - p41Var.f37179s;
        } else {
            canvas2 = canvas;
        }
        S1(canvas2);
        if (p41Var.P && p41Var.f37179s > 0.0f && p41Var.N) {
            canvas2.restore();
        }
    }
