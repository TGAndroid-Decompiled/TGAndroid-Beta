...
public abstract class n41 extends FrameLayout {
    ...
    public AnimationNotificationsLocker f35937n;
    public boolean f35938r;
    public int f35939s;
    public boolean v;
    public org.telegram.ui.ActionBar.e5 f35940w;
    public o1.k f35941x;
    public float f35942y;
    ...
    public final void b() {
        ...
        if (!SharedConfig.animationsEnabled()) {
            this.e = 0.0f;
            g();
            xx xxVar = this.f35933a;
            if (xxVar != null) {
                xxVar.onPause();
                this.f35933a.onFragmentDestroy();
                removeAllViews();
                this.f35933a = null;
        ...
        this.h.setInterpolator(org.telegram.ui.Components.qr.f27380f);
        this.h.start();
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        float f10;
        if (this.v) {
            f(this.E, this.f35933a, this.f35942y);
            invalidate();
        }
        ...
        if (this.f35933a != null && this.d != null && max > 0.0f) {
            if (this.P == null) {
                this.P = new Paint();
            }
            this.P.setColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19212w8, false));
            if (max == 1.0f) {
                canvas.save();
            } else {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (view != null) {
            ...
            layoutParams.topMargin = org.telegram.ui.ActionBar.k.getCurrentActionBarHeight() + i12 + this.f35939s;
        }
        org.telegram.ui.ActionBar.k kVar = this.d;
        if (kVar != null) {
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        org.telegram.ui.ActionBar.e5 e5Var = this.f35940w;
    ...
    public void setCurrentTop(int i10) {
        ...
        View view = this.f35934b;
        if (view != null) {
            view.setTranslationY((i10 - view.getTop()) + this.f35939s);
        }
        j0 j0Var = this.f35935c;
        if (j0Var != null) {
    ...
    public void setTransitionPaddingBottom(int i10) {
        ...
        if (com.google.android.gms.internal.vision.e2.u(xxVar)) {
            float f7 = i10;
            xxVar.X0 = f7;
            xxVar.h.setTranslationY(((-f7) - xxVar.f33648e1) - xxVar.f33646d1);
        }
    }
