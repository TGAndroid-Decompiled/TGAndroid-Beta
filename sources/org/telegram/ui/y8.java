...
public final class y8 extends s4.s0 {
    ...
    public final void b(RecyclerView recyclerView, int i10, int i11) {
        ...
        ah.i iVar;
        boolean z10;
        l9 l9Var = this.f39724b;
        ArrayList arrayList = l9Var.G;
        int L0 = l9Var.f35293c.L0();
        boolean z11 = false;
        if (L0 == -1) {
            abs = 0;
        } else {
            abs = Math.abs(l9Var.f35293c.N0() - L0) + 1;
        }
        if (abs > 0) {
            int size = l9Var.d.Y2.f26045x.size();
        ...
        if (i11 != 0 && this.f39723a) {
            org.telegram.ui.Components.y10 y10Var = l9Var.f35297f;
            if (i11 < 0) {
                z10 = true;
            } else {
                z10 = false;
        ...
        this.f39723a = true;
        l9Var.f35300r.b((L0 != 0 || i12 < l9Var.d.getPaddingTop()) ? true : true, true);
