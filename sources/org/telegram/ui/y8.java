...
public final class y8 extends org.telegram.ui.Components.qv0 {
    public final int f39808w0;
    public final Object f39809x0;
    ...
    public void J(Canvas canvas, float f7, Rect rect, Paint paint, boolean z10) {
        switch (this.f39808w0) {
            case 0:
                m9 m9Var = (m9) this.f39809x0;
                ...
                return;
            case 3:
                ContactsActivity contactsActivity = (ContactsActivity) this.f39809x0;
                if (Build.VERSION.SDK_INT >= 29 && SharedConfig.chatBlurEnabled() && contactsActivity.f30774u0 != null) {
                    canvas.save();
                    canvas.translate(0.0f, -f7);
                    contactsActivity.f30774u0.y(canvas, rect.left, rect.top + f7, rect.right, rect.bottom + f7);
                    canvas.restore();
    ...
    public void dispatchDraw(Canvas canvas) {
        switch (this.f39808w0) {
            case 0:
                ...
                if (Build.VERSION.SDK_INT >= 31 && iVar != null) {
                    ...
                    if (dVar2 != null && !dVar2.f9078n) {
                        ...
                        a2.drawColor(m9Var.getThemedColor(org.telegram.ui.ActionBar.j6.f18806a7));
                    ...
                    if (dVar != null && !dVar.f9078n) {
                        ...
                        a10.drawColor(m9Var.getThemedColor(org.telegram.ui.ActionBar.j6.f18806a7));
                        if (SharedConfig.chatBlurEnabled()) {
                            iVar.b(a10, -2);
                        }
                        dVar.b();
            ...
            case 3:
                ContactsActivity contactsActivity = (ContactsActivity) this.f39809x0;
                fh.d dVar3 = contactsActivity.f30775v0;
                fh.d dVar4 = contactsActivity.f30774u0;
                ah.i iVar2 = contactsActivity.f30773t0;
                if (Build.VERSION.SDK_INT >= 31 && iVar2 != null) {
                    ...
                    if (dVar4 != null && !dVar4.f9078n) {
                        ...
                        a11.drawColor(contactsActivity.getThemedColor(org.telegram.ui.ActionBar.j6.f18862d6));
                        if (SharedConfig.chatBlurEnabled()) {
                            iVar2.b(a11, -3);
                        }
                        dVar4.b();
                    ...
                    if (dVar3 != null && !dVar3.f9078n) {
                        ...
                        a12.drawColor(contactsActivity.getThemedColor(org.telegram.ui.ActionBar.j6.f18862d6));
                        if (SharedConfig.chatBlurEnabled()) {
                            iVar2.b(a12, -2);
                        }
                        dVar3.b();
            ...
            case 7:
                ...
                if (Build.VERSION.SDK_INT >= 31 && iVar3 != null) {
                    ...
                    if (dVar6 != null && !dVar6.f9078n) {
                        ...
                        a13.drawColor(g91Var.getThemedColor(org.telegram.ui.ActionBar.j6.f18862d6));
                        if (SharedConfig.chatBlurEnabled()) {
                            iVar3.b(a13, -3);
                        }
                        dVar6.b();
                    ...
                    if (dVar5 != null && !dVar5.f9078n) {
                        ...
                        a14.drawColor(g91Var.getThemedColor(org.telegram.ui.ActionBar.j6.f18862d6));
                        if (SharedConfig.chatBlurEnabled()) {
                            iVar3.b(a14, -2);
                        }
                        dVar5.b();
                ...
                super.dispatchDraw(canvas);
                if (!g91Var.M) {
                    AndroidUtilities.drawNavigationBarProtection(canvas, this, g91Var.getThemedColor(org.telegram.ui.ActionBar.j6.f18862d6), g91Var.S);
                    return;
                }
                return;
            case 8:
                ...
                if (Build.VERSION.SDK_INT >= 31 && iVar4 != null) {
                    ...
                    if (dVar8 != null && !dVar8.f9078n) {
                        ...
                        a15.drawColor(ab1Var.getThemedColor(org.telegram.ui.ActionBar.j6.f18862d6));
                        if (SharedConfig.chatBlurEnabled()) {
                            iVar4.b(a15, -3);
                        }
                        dVar8.b();
                    ...
                    if (dVar7 != null && !dVar7.f9078n) {
                        ...
                        a16.drawColor(ab1Var.getThemedColor(org.telegram.ui.ActionBar.j6.f18862d6));
                        if (SharedConfig.chatBlurEnabled()) {
                            iVar4.b(a16, -2);
                        }
                        dVar7.b();
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        switch (this.f39808w0) {
            case 1:
                if (motionEvent.getY() < ((org.telegram.ui.Components.pb0) this.f39809x0).T) {
                    return false;
                }
    ...
    public Drawable getNewDrawable() {
        switch (this.f39808w0) {
            case 1:
                Drawable d = ((zn) ((org.telegram.ui.Components.pb0) this.f39809x0).f26988c0.F).d();
                if (d == null) {
    ...
    public org.telegram.ui.ActionBar.f6 getResourceProvider() {
        switch (this.f39808w0) {
            case 2:
                return ((org.telegram.ui.Components.c01) this.f39809x0).f22859c;
            default:
    ...
    public void onMeasure(int i10, int i11) {
        ...
        switch (this.f39808w0) {
            case 0:
                ...
                ((ViewGroup.MarginLayoutParams) m9Var.f35709b.getLayoutParams()).topMargin = m9.d0(m9Var).getMeasuredHeight();
                ((ViewGroup.MarginLayoutParams) m9Var.f35718r.getLayoutParams()).topMargin = m9.a0(m9Var).getMeasuredHeight();
                m9Var.i0();
            ...
            case 2:
                super.onMeasure(i10, i11);
                setMeasuredDimension(View.MeasureSpec.getSize(i10), ((org.telegram.ui.Components.c01) this.f39809x0).d.getMeasuredHeight() + AndroidUtilities.dp(24.0f));
                return;
            case 3:
                ContactsActivity contactsActivity = (ContactsActivity) this.f39809x0;
                ...
                return;
            case 4:
                zb0 zb0Var = (zb0) this.f39809x0;
                super.onMeasure(i10, i11);
                R();
                int i17 = this.f27419f;
                if (i17 != 0 && i17 < AndroidUtilities.dp(20.0f)) {
                    zb0Var.F.clearFocus();
                    zb0Var.K.clearFocus();
                }
                FrameLayout frameLayout = zb0Var.H;
                if (this.f27419f > AndroidUtilities.dp(20.0f)) {
                    i12 = 8;
                } else {
                    i12 = 0;
                }
            ...
            case 5:
                ...
                if (ocVar != null && ocVar.f26704l) {
                    super.onMeasure(i10, i11);
                    marginLayoutParams.bottomMargin = org.telegram.messenger.wl.D(10.0f, org.telegram.ui.Components.oc.f26695w.e.getMeasuredHeight() + AndroidUtilities.dp(14.0f), i13);
                } else {
                ...
                TextView textView = yg0Var.f39892f0;
                if (textView != null) {
                    ((ViewGroup.MarginLayoutParams) textView.getLayoutParams()).topMargin = AndroidUtilities.dp(16.0f) + i18;
                }
                if (R() > AndroidUtilities.dp(20.0f) && yg0Var.f39887c.getVisibility() != 8 && !AndroidUtilities.isAccessibilityTouchExplorationEnabled() && !yg0Var.f39884a0) {
                    ValueAnimator valueAnimator = yg0Var.d;
                    if (valueAnimator != null) {
                        valueAnimator.cancel();
                    }
                    yg0Var.f39887c.setVisibility(8);
                }
                super.onMeasure(i10, i11);
                return;
            case 6:
                PopupNotificationActivity popupNotificationActivity = (PopupNotificationActivity) this.f39809x0;
                ...
                if (R() <= AndroidUtilities.dp(20.0f)) {
                    size2 -= popupNotificationActivity.f31159b.getEmojiPadding();
                }
                int i19 = size2;
                ...
                for (int i20 = 0; i20 < childCount; i20++) {
                    ...
                    if (childAt.getVisibility() != 8) {
                        if (popupNotificationActivity.f31159b.u0(childAt)) {
                            childAt.measure(View.MeasureSpec.makeMeasureSpec(size, 1073741824), View.MeasureSpec.makeMeasureSpec(childAt.getLayoutParams().height, 1073741824));
                        } else if (childAt == popupNotificationActivity.f31159b.M1) {
                ...
                return;
            case 9:
                xh.h4 h4Var = (xh.h4) this.f39809x0;
                FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) h4Var.f45926y.getLayoutParams();
                ...
                FrameLayout.LayoutParams layoutParams3 = (FrameLayout.LayoutParams) h4Var.f45921n.getLayoutParams();
                ...
                FrameLayout.LayoutParams layoutParams4 = (FrameLayout.LayoutParams) h4Var.f45924w.getLayoutParams();
