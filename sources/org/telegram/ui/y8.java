...
public final class y8 extends f2.a1 {
    ...
    public final void b(RecyclerView recyclerView, int i10, int i11) {
        ...
        og.e eVar;
        boolean z4;
        l9 l9Var = this.f43573b;
        ArrayList arrayList = l9Var.D;
        int L0 = l9Var.f38575c.L0();
        boolean z10 = false;
        if (L0 == -1) {
            abs = 0;
        } else {
            abs = Math.abs(l9Var.f38575c.N0() - L0) + 1;
        }
        if (abs > 0) {
            int size = l9Var.d.V2.f32654x.size();
        ...
        if (i11 != 0 && this.f43572a) {
            org.telegram.ui.Components.a20 a20Var = l9Var.f38578f;
            if (i11 < 0) {
                z4 = true;
            } else {
                z4 = false;
        ...
        this.f43572a = true;
        l9Var.f38580r.b((L0 != 0 || i12 < l9Var.d.getPaddingTop()) ? true : true, true);
