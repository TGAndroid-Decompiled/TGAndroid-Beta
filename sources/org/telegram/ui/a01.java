...
public final class a01 extends org.telegram.ui.Components.aw0 implements r0.m {
    ...
    public final b2.q0 f31936w0;
    public final ProfileActivity f31937x0;
    public boolean f31938y0;
    public final Paint f31939z0;

    public a01(ProfileActivity profileActivity, Context context) {
        super(context, null);
        this.D0 = profileActivity;
        this.f31937x0 = profileActivity;
        this.f31936w0 = new Object();
        this.f31939z0 = new Paint();
    ...
    public final void E(ViewGroup viewGroup, int i10, int i11, int[] iArr, int i12) {
        ...
        int L0;
        int max;
        ProfileActivity profileActivity = this.f31937x0;
        if (viewGroup == profileActivity.f31525a) {
            int i14 = -1;
    ...
    public final void L(Canvas canvas, ArrayList arrayList) {
        canvas.save();
        ProfileActivity profileActivity = this.f31937x0;
        canvas.translate(0.0f, profileActivity.f31525a.getY());
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        org.telegram.ui.Components.g50 g50Var = profileActivity.f31687x0;
        Paint paint = profileActivity.f31638q2;
        fh.d dVar = profileActivity.f31622n6;
        ah.h hVar = profileActivity.f31614m6;
        Paint paint2 = profileActivity.f31694y0;
        if (Build.VERSION.SDK_INT >= 31 && hVar != null) {
            ...
            if (dVar != null && !dVar.f9060n) {
                ...
                a2.drawColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19004a7, profileActivity.f31699z0));
        ...
        paint.setColor(org.telegram.ui.ActionBar.h6.v0(i10, profileActivity.f31699z0));
        if (profileActivity.f31525a.getVisibility() == 0) {
            int v02 = org.telegram.ui.ActionBar.h6.v0(i10, profileActivity.f31699z0);
            Paint paint3 = this.f31939z0;
            paint3.setColor(v02);
            if (profileActivity.H1) {
                paint.setAlpha((int) (profileActivity.f31525a.getAlpha() * 255.0f));
            }
            if (profileActivity.H1) {
                paint3.setAlpha((int) (profileActivity.f31525a.getAlpha() * 255.0f));
            }
            ...
            for (int i11 = 0; i11 < childCount; i11++) {
                View childAt = profileActivity.f31525a.getChildAt(i11);
                profileActivity.f31525a.getClass();
                if (RecyclerView.R(childAt) != -1) {
                    arrayList.add(profileActivity.f31525a.getChildAt(i11));
                } else {
                    z11 = true;
                }
            }
            Collections.sort(arrayList, this.C0);
            profileActivity.f31525a.getY();
        ...
        if (g50Var.getAlpha() > 0) {
            canvas.drawRect(0.0f, 0.0f, getWidth(), getHeight(), profileActivity.f31687x0);
        }
        if (profileActivity.f31680w0 != null) {
            int save = canvas.save();
            canvas.translate(profileActivity.f31680w0.getLeft(), profileActivity.f31680w0.getTop());
            View view2 = profileActivity.f31680w0;
            kVar = ((org.telegram.ui.ActionBar.m2) profileActivity).actionBar;
            if (view2 == kVar.getBackButton()) {
                int alpha = paint2.getAlpha();
                paint2.setAlpha((int) (((g50Var.getAlpha() / 255.0f) * alpha) / 0.3f));
                float max = Math.max(profileActivity.f31680w0.getMeasuredWidth(), profileActivity.f31680w0.getMeasuredHeight()) / 2;
                canvas.drawCircle(max, max, 0.7f * max, paint2);
                paint2.setAlpha(alpha);
            }
            profileActivity.f31680w0.draw(canvas);
        ...
        if (!profileActivity.I0) {
            ...
            int v03 = org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19060d6, profileActivity.f31699z0);
            int i13 = profileActivity.f31608l6;
            wy0 wy0Var2 = profileActivity.f31525a;
            if (wy0Var2 != null) {
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (c01Var != null && (cu0Var = (cu0VarArr = c01Var.f25536k0)[0]) != null && cu0Var.h.getFastScroll() != null && cu0VarArr[0].h.getFastScroll().f23667n) {
    ...
    public final void j(ViewGroup viewGroup, int i10, int i11, int i12, int i13, int i14, int[] iArr) {
        ProfileActivity profileActivity = this.f31937x0;
        try {
            if (viewGroup == profileActivity.f31525a && profileActivity.Q) {
    ...
    public final void onSizeChanged(int i10, int i11, int i12, int i13) {
        ...
        ProfileActivity profileActivity = this.D0;
        gh.d.c(profileActivity.f31635p6, profileActivity.fragmentView);
        profileActivity.q6.d();
    }

    @Override
    public final boolean p(View view, View view2, int i10, int i11) {
        if (this.f31937x0.J4 != -1 && i10 == 2) {
            return true;
        }
        return false;
    }
