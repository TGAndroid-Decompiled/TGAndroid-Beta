...
public final class un0 implements OnCompleteListener, org.telegram.ui.ActionBar.a2, zt {
    ...
    public void a1(vt vtVar) {
        switch (this.f38058a) {
            case 2:
                wo0 wo0Var = this.f38059b;
                wo0Var.A0 = vtVar;
                wo0Var.f39319f[4].setText(vtVar.f38680a);
                return;
            default:
                wo0 wo0Var2 = this.f38059b;
                wo0Var2.A0 = vtVar;
                wo0Var2.f39319f[4].setText(vtVar.f38680a);
                wo0Var2.B0 = vtVar.d;
                return;
        }
    }
