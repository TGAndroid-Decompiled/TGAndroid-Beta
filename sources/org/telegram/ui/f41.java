...
public final class f41 extends org.telegram.ui.ActionBar.m2 {
    public static final int[] f33544c = {750000, 1000000, 1200000, 2000000};
    public org.telegram.ui.Components.wl0 f33545a;
    public e41 f33546b;
    ...
    public final View createView(Context context) {
        ...
        this.f33545a = wl0Var;
        wl0Var.p1();
        this.actionBar.setAdaptiveBackground(this.f33545a);
        this.f33545a.setLayoutManager(new s4.c0());
        this.f33545a.setVerticalScrollBarEnabled(false);
        org.telegram.ui.Components.wl0 wl0Var2 = this.f33545a;
        e41 e41Var = new e41(context);
        this.f33546b = e41Var;
        wl0Var2.setAdapter(e41Var);
        this.f33545a.setOnItemClickListener(new r21(this, 3));
        frameLayout.addView(this.f33545a, w7.y5.c(-1.0f, -1));
