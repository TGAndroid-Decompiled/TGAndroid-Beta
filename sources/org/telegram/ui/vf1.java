...
public final class vf1 extends s4.v {
    ...
    public final int e(RecyclerView recyclerView, s4.c1 c1Var) {
        ...
        if (b10 >= 0) {
            wf1 wf1Var = this.e;
            if (b10 < wf1Var.f39311b.size() && ((nf1) wf1Var.f39311b.get(b10)).f35873c != null && ChatObject.canManageTopics(wf1Var.g())) {
                TLRPC.TL_forumTopic tL_forumTopic = ((nf1) wf1Var.f39311b.get(b10)).f35873c;
                if (wf1Var.f39309a0.isEmpty()) {
    ...
    public final boolean k() {
        return !this.e.f39309a0.isEmpty();
    }
    ...
    public final boolean n(RecyclerView recyclerView, s4.c1 c1Var, s4.c1 c1Var2) {
        ...
        if (c1Var.f42963f == c1Var2.f42963f && (b10 = c1Var2.b()) >= 0 && b10 < arrayList.size() && ((nf1) arrayList.get(b10)).f35873c != null && ((nf1) arrayList.get(b10)).f35873c.pinned) {
            lf1 lf1Var = wf1Var.f39341r;
            int b11 = c1Var.b();
            int b12 = c1Var2.b();
            wf1 wf1Var2 = lf1Var.d;
            ArrayList arrayList2 = wf1Var2.f39311b;
    ...
    public final void p(s4.c1 c1Var, int i10) {
        ...
        if (i10 == 0) {
            ...
            for (int i11 = 0; i11 < arrayList.size(); i11++) {
                TLRPC.TL_forumTopic tL_forumTopic = ((nf1) arrayList.get(i11)).f35873c;
                if (tL_forumTopic != null && tL_forumTopic.pinned) {
                    arrayList2.add(Integer.valueOf(tL_forumTopic.f18387id));
                }
            }
            wf1Var.getMessagesController().getTopicsController().reorderPinnedTopics(wf1Var.f39308a, arrayList2);
            return;
        }
        wf1Var.N.I0(false);
