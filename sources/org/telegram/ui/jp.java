...
public final class jp extends LinearLayout implements NotificationCenter.NotificationCenterDelegate {
    public org.telegram.ui.Components.p9 f38090a;
    public org.telegram.ui.Components.m90 f38091b;
    public int f38092c;

    public final void a() {
        boolean z4;
        org.telegram.ui.Components.p9 p9Var = this.f38090a;
        int i10 = this.f38092c;
        ...
        if (tL_messages_stickerSet != null && tL_messages_stickerSet.documents.size() >= 3) {
            p9Var.i(ImageLocation.getForDocument(tL_messages_stickerSet.documents.get(2)), "104_104", "tgs", this.f38091b, tL_messages_stickerSet);
            return;
        }
        ...
        p9Var.setImageDrawable(this.f38091b);
    }
    ...
    public final void onAttachedToWindow() {
        ...
        a();
        NotificationCenter.getInstance(this.f38092c).addObserver(this, NotificationCenter.diceStickersDidLoad);
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        NotificationCenter.getInstance(this.f38092c).removeObserver(this, NotificationCenter.diceStickersDidLoad);
    }
}
