...
public final class jp extends LinearLayout implements NotificationCenter.NotificationCenterDelegate {
    public org.telegram.ui.Components.p9 f35426a;
    public org.telegram.ui.Components.k90 f35427b;
    public int f35428c;

    public final void a() {
        boolean z4;
        org.telegram.ui.Components.p9 p9Var = this.f35426a;
        ...
        if (tL_messages_stickerSet != null && tL_messages_stickerSet.documents.size() >= 3) {
            p9Var.i(ImageLocation.getForDocument(tL_messages_stickerSet.documents.get(2)), "104_104", "tgs", this.f35427b, tL_messages_stickerSet);
            return;
        }
        ...
        p9Var.setImageDrawable(this.f35427b);
    }
    ...
    public final void onAttachedToWindow() {
        ...
        a();
        NotificationCenter.getInstance(this.f35428c).addObserver(this, NotificationCenter.diceStickersDidLoad);
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        NotificationCenter.getInstance(this.f35428c).removeObserver(this, NotificationCenter.diceStickersDidLoad);
    }
}
