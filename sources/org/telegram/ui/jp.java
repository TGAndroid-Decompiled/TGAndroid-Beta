...
public final class jp extends org.telegram.ui.Components.ll0 {
    public static final int f34959b3 = 0;
    public final ip X2;
    public boolean Y2;
    public final Paint Z2;
    public final kp f34960a3;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (i10 < i11) {
            int v02 = org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f18834d6, this.f25969p2);
            Paint paint = this.Z2;
            paint.setColor(v02);
            canvas2 = canvas;
            ...
            if (arrayList.get(i11) == tL_username) {
                ...
                if (i11 >= 0 && i11 < arrayList.size() && (tL_username2 = (TLRPC.TL_username) arrayList.get(i11)) != null) {
                        ...
                        if (RecyclerView.R(childAt) == i12) {
                            ...
                            if (childAt instanceof na) {
                                ...
                                if (tL_username3 != null) {
                                    naVar.a(tL_username3, naVar.f35937w, true, naVar.f35938x);
                                }
                            }
                        } else {
                            i17++;
                    ...
                    if (i13 >= 0 && i12 != i13) {
                        int i18 = i13 - 1;
                        ip ipVar = this.X2;
                        ArrayList arrayList2 = ipVar.f34703c.f34960a3.N;
