...
public final class hx0 extends sg.e {
    public final Context f34377b0;
    public final lx0 f34378c0;

    public hx0(lx0 lx0Var, Context context, int i10, int i11, Context context2) {
        super(context, i10, i11);
        this.f34378c0 = lx0Var;
        this.f34377b0 = context2;
    }
    ...
    public final void g() {
        ...
        int i18;
        int i19;
        lx0 lx0Var = this.f34378c0;
        PremiumPreviewFragment premiumPreviewFragment = lx0Var.f35647n;
        if (premiumPreviewFragment.f31190r0 == null && BuildVars.DEBUG_PRIVATE_VERSION) {
            Context context = this.f34377b0;
            premiumPreviewFragment.f31190r0 = new FrameLayout(context);
            ScrollView scrollView = new ScrollView(context);
            sg.a aVar = lx0Var.d.f42959b;
            zd zdVar = new zd(context, 5);
            zdVar.setOrientation(1);
            TextView textView = new TextView(context);
            textView.setText("Spectral top ");
            int i20 = org.telegram.ui.ActionBar.j6.f19046n5;
            ...
            sg.f fVar2 = aVar.f42931c;
            if (fVar2 == null) {
                f10 = 0.0f;
            } else {
                f10 = fVar2.f42990w / 2.0f;
            }
            ...
            go0Var5.setProgress(zd.f40216b / 2.0f);
            go0Var5.setReportChanges(true);
            zdVar.addView(go0Var5, w7.x5.d(-1, 38.0f, 0, 5.0f, 4.0f, 5.0f, 0.0f));
            scrollView.addView(zdVar);
            premiumPreviewFragment.f31190r0.addView(scrollView);
            premiumPreviewFragment.f31190r0.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18933h5, false));
            premiumPreviewFragment.f31174d0.addView(premiumPreviewFragment.f31190r0, w7.x5.e(-1, -1, 80));
            ((ViewGroup.MarginLayoutParams) premiumPreviewFragment.f31190r0.getLayoutParams()).topMargin = premiumPreviewFragment.f31173c0;
            premiumPreviewFragment.f31190r0.setTranslationY(AndroidUtilities.dp(1000.0f));
            premiumPreviewFragment.f31190r0.animate().translationY(1.0f).setDuration(300L);
        }
    }
}
