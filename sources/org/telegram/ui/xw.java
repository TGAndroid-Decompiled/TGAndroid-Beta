...
public final class xw extends gg.m {
    public final py f39988d0;
    public final qy f39989e0;
    ...
    @Override
    public final void J() {
        this.f39989e0.presentFragment(new l());
    }

    @Override
    public final void K() {
        int i10;
        qy qyVar = this.f39989e0;
        ...
        if (requestPeerType instanceof TLRPC.TL_requestPeerTypeBroadcast) {
            ...
            ld ldVar = new ld(g10);
            ldVar.f35292t0 = new l6(qyVar, ldVar, a2Var, 2);
    ...
    public final void L(TLRPC.User user) {
        int i10;
        i10 = ((org.telegram.ui.ActionBar.m2) this.f39989e0).currentAccount;
        MessagesController.getInstance(i10).openApp(user, 0);
    }

    @Override
    public final boolean S() {
        if (this.f39989e0.R0 == 0) {
            return true;
        }
        return false;
    }
    ...
    public final void a(org.telegram.ui.Cells.s2 s2Var) {
        py pyVar = this.f39988d0;
        pyVar.f36679a.getClass();
        this.f39989e0.o4(s2Var, RecyclerView.R(s2Var), 0.0f, pyVar.d);
    }
    ...
    public final void d(org.telegram.ui.Cells.s2 s2Var) {
        ...
        if (s2Var.getMessage() != null) {
            ...
            if (findTopic != null) {
                if (qyVar.f37057l2) {
                    qyVar.O3(s2Var.getDialogId(), findTopic.f18373id, false, null);
                } else {
    ...
    public final void l() {
        ...
        qy qyVar = this.f39989e0;
        if (qyVar.R0 == 15) {
            org.telegram.ui.ActionBar.u0 u0Var = qyVar.f37047j0;
            if (this.U) {
                i10 = 8;
            } else {
                i10 = 0;
