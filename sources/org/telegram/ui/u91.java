...
public final class u91 implements Runnable {
    ...
    public final ab1 f37996b;
    public final ArrayList f37997c;
    ...
    public final void run() {
        ...
        switch (this.f37995a) {
            case 0:
                ab1 ab1Var = this.f37996b;
                ArrayList arrayList = ab1Var.f31806s0;
                ArrayList arrayList2 = ab1Var.f31804r0;
                int i10 = 0;
                ab1Var.f31811w0 = false;
                ArrayList arrayList3 = this.f37997c;
                if (!arrayList3.isEmpty()) {
                    int size = arrayList3.size();
                    for (int i11 = 0; i11 < size; i11++) {
                        MessageObject messageObject = (MessageObject) arrayList3.get(i11);
                        int i12 = ab1Var.f31801p0.get(messageObject.getId(), -1);
                        if (i12 >= 0 && ((xa1) arrayList2.get(i12)).b() == messageObject.getId()) {
                            ((xa1) arrayList2.get(i12)).f39506b = messageObject;
                        }
                    }
                    arrayList.clear();
                ...
                return;
            default:
                ab1 ab1Var2 = this.f37996b;
                ai.d9 d9Var = ab1Var2.f31816z0;
                d9Var.getClass();
                ArrayList arrayList4 = this.f37997c;
