...
public class LiteModeSettingsActivity extends BaseFragment {
    ...
    private Utilities.Callback<Boolean> onPowerAppliedChange;
    ...
    public class Adapter extends AdapterWithDiffUtils {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 0) {
                ...
                switchCell = i == 5 ? new TextCell(23, context, null, false, true) : null;
            }
    ...
    public class PowerSaverSlider extends FrameLayout {
        ...
        public PowerSaverSlider(Context context) {
            ...
            AnimatedTextView animatedTextView = new AnimatedTextView(context, true, false, false) {
                Drawable backgroundDrawable = Theme.createRoundRectDrawable(AndroidUtilities.dp(4.0f), Theme.multAlpha(0.15f, Theme.getColor(null, Theme.key_windowBackgroundWhiteBlueHeader, false)));

                @Override
                public void onDraw(Canvas canvas) {
                    this.backgroundDrawable.setBounds(0, 0, (int) (getDrawable().getCurrentWidth() + getPaddingLeft() + getPaddingRight()), getMeasuredHeight());
            ...
            this.headerOnView.setTextColor(Theme.getColor(null, i, false));
            ...
            this.middleTextView.setTextColor(Theme.getColor(null, Theme.key_windowBackgroundWhiteBlueText, false));
            ...
            this.rightTextView.setTextColor(Theme.getColor(null, i2, false));
        ...
        private void updateHeaderOnVisibility(boolean z) {
            if (z != this.headerOnVisible) {
                ...
                OKLCH.m(this.headerOnView.animate().alpha(z ? 1.0f : 0.0f), CubicBezierInterpolator.EASE_OUT_QUINT, 220L);
            }
        }
        ...
        private void updateOffActive(boolean z) {
            ...
            if (this.offActiveT != f) {
                ...
                valueAnimatorOfFloat.addUpdateListener(new LiteModeSettingsActivity$PowerSaverSlider$$ExternalSyntheticLambda0(this, i));
                this.offActiveAnimator.addListener(new AnimatorListenerAdapter() {
                    @Override
                    public void onAnimationEnd(Animator animator) {
                        PowerSaverSlider.this.leftTextView.setTextColor(ColorUtils.blendARGB(PowerSaverSlider.this.offActiveT = f, Theme.getColor(null, Theme.key_windowBackgroundWhiteGrayText, false), Theme.getColor(null, Theme.key_windowBackgroundWhiteBlueText, false)));
                    }
                });
        ...
        private void updateOnActive(boolean z) {
            ...
            if (this.onActiveT != f) {
                ...
                this.onActiveAnimator.addListener(new AnimatorListenerAdapter() {
                    @Override
                    public void onAnimationEnd(Animator animator) {
                        PowerSaverSlider.this.rightTextView.setTextColor(ColorUtils.blendARGB(PowerSaverSlider.this.onActiveT = f, Theme.getColor(null, Theme.key_windowBackgroundWhiteGrayText, false), Theme.getColor(null, Theme.key_windowBackgroundWhiteBlueText, false)));
                    }
                });
    ...
    public class SwitchCell extends FrameLayout {
        ...
        public SwitchCell(Context context) {
            ...
            TextView textView = new TextView(context) {
                ...
                public void onMeasure(int i, int i2) {
                    if (View.MeasureSpec.getMode(i) == Integer.MIN_VALUE) {
                        i = OKLCH.m(52.0f, View.MeasureSpec.getSize(i), Integer.MIN_VALUE);
                    }
            ...
            this.countTextView.setTextColor(Theme.getColor(null, i, false));
            this.countTextView.setImportantForAccessibility(2);
            ImageView imageView2 = new ImageView(context);
            this.arrowView = imageView2;
            imageView2.setVisibility(8);
            this.arrowView.setColorFilter(new PorterDuffColorFilter(Theme.getColor(null, i, false), mode));
        ...
        public void onDraw(Canvas canvas) {
            ...
            if (this.needDivider) {
                canvas.drawLine(this.textView.getTranslationX() + AndroidUtilities.dp(64.0f), getMeasuredHeight() - 1, getMeasuredWidth(), getMeasuredHeight() - 1, Theme.dividerPaint);
            }
        }
        ...
        public void setDisabled(boolean z, boolean z2) {
            if (this.disabled != z) {
                this.disabled = z;
                if (z2) {
                    OKLCH.m(this.imageView.animate(), z ? 0.5f : 1.0f, 220L);
                    OKLCH.m(this.textViewLayout.animate(), z ? 0.5f : 1.0f, 220L);
                    OKLCH.m(this.switchView.animate(), z ? 0.5f : 1.0f, 220L);
                    OKLCH.m(this.checkBoxView.animate(), z ? 0.5f : 1.0f, 220L);
                } else {
        ...
        public void update(Item item) {
            if (item.viewType == 3) {
                ...
                if (z) {
                    ...
                    OKLCH.m(this.arrowView.animate().rotation((expandedIndex < 0 || !LiteModeSettingsActivity.this.expanded[expandedIndex]) ? 0.0f : 180.0f), CubicBezierInterpolator.EASE_OUT_QUINT, 240L);
                }
    ...
    public LiteModeSettingsActivity() {
        super(null);
        this.onPowerAppliedChange = new PollItemMenu$$ExternalSyntheticLambda15(this, 10);
    ...
    private void highlightRow(int i) {
        this.listView.highlightRow(new LaunchActivity$$ExternalSyntheticLambda23(this, i, 5));
    }
    ...
    public void lambda$createView$0(View view, int i, float f, float f2) {
        ...
        if (LiteMode.isPowerSaverApplied()) {
            this.restrictBulletin = BulletinFactory.of(this).createSimpleBulletin(new BatteryDrawable(0.1f, -1, Theme.getColor(null, Theme.key_dialogSwipeRemove, false), 1.3f), LocaleController.getString(R.string.LiteBatteryRestricted)).show();
            return;
        }
    ...
    public void updateInfo() {
        ...
        if (this.items.size() >= 2) {
            ...
            this.adapter.lambda$onBindViewHolder$31(1);
        }
    }
    ...
    public View createView(Context context) {
        ...
        this.listView.setOnItemClickListener(new BoostsActivity$$ExternalSyntheticLambda4(this, 29));
