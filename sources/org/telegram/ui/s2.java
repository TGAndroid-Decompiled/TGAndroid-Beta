...
public final class s2 extends HorizontalScrollView {
    public final u70 f37237a;
    public final t2 f37238b;
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        this.f37238b.e.getMeasuredWidth();
        getMeasuredWidth();
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        if (this.f37238b.e.getMeasuredWidth() <= getMeasuredWidth() - AndroidUtilities.dp(36.0f)) {
            return false;
        }
