...
public final class s2 extends HorizontalScrollView {
    public final w70 f37372a;
    public final t2 f37373b;
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        this.f37373b.e.getMeasuredWidth();
        getMeasuredWidth();
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        if (this.f37373b.e.getMeasuredWidth() <= getMeasuredWidth() - AndroidUtilities.dp(36.0f)) {
            return false;
        }
