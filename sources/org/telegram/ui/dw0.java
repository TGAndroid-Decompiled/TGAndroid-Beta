...
public final class dw0 extends Dialog {
    ...
    public float f33204a0;
    public final org.telegram.ui.ActionBar.d6 f33205b;
    public boolean f33206b0;
    public final yv0 f33207c;
    public boolean f33208c0;
    public final yv0 d;
    public boolean f33209d0;
    public final yv0 e;
    public tm f33210e0;
    public final ci.i1 f33211f;
    public ValueAnimator f33212f0;
    public ValueAnimator f33213g0;
    public final TextView h;
    public final org.telegram.ui.Components.dc0 f33214n;
    public i0.b f33215r;
    public Bitmap f33216s;
    public BitmapShader v;
    public Paint f33217w;
    public Matrix f33218x;
    public float f33219y;
    ...
    public final void b(boolean z10, sv0 sv0Var) {
        float f7;
        long j3;
        ValueAnimator valueAnimator = this.f33212f0;
        if (valueAnimator != null) {
            valueAnimator.cancel();
        }
        ValueAnimator valueAnimator2 = this.f33213g0;
        if (valueAnimator2 != null) {
            valueAnimator2.cancel();
        }
        d();
        float f10 = this.f33219y;
        float f11 = 0.0f;
        if (z10) {
            f7 = 1.0f;
        } else {
        ...
        this.f33212f0 = ofFloat;
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) {
            public final dw0 f38248b;
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator3) {
                switch (r2) {
                    case 0:
                        ...
                        dw0 dw0Var = this.f38248b;
                        dw0Var.f33219y = floatValue;
                        dw0Var.f33207c.invalidate();
                        dw0Var.d.invalidate();
                        bw0 bw0Var = dw0Var.J;
                        if (bw0Var != null) {
                            bw0Var.invalidate();
        ...
        this.f33212f0.addListener(new androidx.fragment.app.g(this, z10, sv0Var, 9));
        if (!z10) {
            j3 = 330;
        } else {
            j3 = 520;
        }
        ValueAnimator valueAnimator3 = this.f33212f0;
        org.telegram.ui.Components.rr rrVar = org.telegram.ui.Components.rr.h;
        valueAnimator3.setInterpolator(rrVar);
        this.f33212f0.setDuration(j3);
        this.f33212f0.start();
        float f12 = this.E;
        if (z10) {
            f11 = 1.0f;
        ...
        this.f33213g0.addListener(new c70(4, this, z10));
        this.f33213g0.setDuration(((float) j3) * 1.5f);
        this.f33213g0.setInterpolator(rrVar);
        this.f33213g0.start();
    }
    ...
    public final void c(boolean z10) {
        ...
        if (z10 && (qk0Var = this.Q) != null && qk0Var.getReactionsWindow() != null && !this.Q.getReactionsWindow().f49259q) {
            this.Q.e();
        } else if (this.f33208c0) {
        } else {
            this.f33208c0 = true;
            this.Y = false;
            ci.i1 i1Var = this.f33211f;
            i1Var.l();
                ...
                if (u1Var != null) {
                    ...
                    if (!this.f33206b0) {
                        ...
                        if (f10 + f11 > dp - textView.getHeight()) {
                            ...
                            i0.b bVar5 = this.f33215r;
                            this.f33204a0 = ((((height5 - bVar5.f10577b) - bVar5.d) - AndroidUtilities.dp(78.0f)) - textView.getHeight()) - i10;
                        }
                        if (this.R != null) {
                            float height6 = this.f33204a0 + f11 + viewGroup.getHeight();
                            int height7 = yv0Var.getHeight();
                            i0.b bVar6 = this.f33215r;
                            if (height6 > (((height7 - bVar6.f10577b) - bVar6.d) - AndroidUtilities.dp(78.0f)) - textView.getHeight()) {
                                int height8 = yv0Var.getHeight();
                                i0.b bVar7 = this.f33215r;
                                this.f33204a0 = (((((height8 - bVar7.f10577b) - bVar7.d) - AndroidUtilities.dp(78.0f)) - textView.getHeight()) - i10) - this.R.getHeight();
                            }
                        }
                    }
                    e();
    ...
    public final void e() {
        ...
        if (viewGroup2 != null) {
            ...
            this.T.setAlpha(this.f33219y);
            float lerp3 = AndroidUtilities.lerp(0.75f, 1.0f, this.f33219y);
        ...
        if (this.R != null) {
            ...
            this.R.setAlpha(this.f33219y);
            float lerp4 = AndroidUtilities.lerp(0.75f, 1.0f, this.f33219y);
            this.R.setScaleX(lerp4);
            this.R.setScaleY(lerp4);
        }
        if (this.f33209d0) {
            this.K.setAlpha(this.f33219y);
            this.J.setAlpha(this.f33219y);
        }
        if (this.Q != null) {
            ...
            this.Q.setAlpha(this.f33219y);
            View windowView = this.Q.getWindowView();
            if (windowView != null) {
                windowView.setTranslationX(max);
                windowView.setAlpha(this.f33219y);
            }
        }
        TextView textView = this.h;
        textView.setTranslationX(lerp);
        textView.setAlpha(this.f33219y);
        org.telegram.ui.Components.dc0 dc0Var = this.f33214n;
        dc0Var.setSelectedTab(positionAnimated);
        dc0Var.setAlpha(this.f33219y);
    }
