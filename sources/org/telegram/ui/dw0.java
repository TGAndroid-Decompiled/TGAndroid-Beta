        ...
        switch (this.f33114a) {
            case 0:
                ...
                if (!z10) {
                    ...
                    ArrayList<TLRPC.PollAnswer> arrayList = this.f33117f;
            ...
            default:
                ...
                if (!z11) {
                    ...
                    ArrayList<TLRPC.PollAnswer> arrayList3 = this.f33117f;
