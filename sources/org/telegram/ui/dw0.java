        ...
        switch (this.f33112a) {
            case 0:
                ...
                if (!z10) {
                    ...
                    ArrayList<TLRPC.PollAnswer> arrayList = this.f33115f;
                ...
                return;
            default:
                mw0 mw0Var2 = this.f33113b;
                mw0Var2.getClass();
                boolean z11 = this.f33114c;
                ...
                if (!z11) {
                    ...
                    ArrayList<TLRPC.PollAnswer> arrayList3 = this.f33115f;
