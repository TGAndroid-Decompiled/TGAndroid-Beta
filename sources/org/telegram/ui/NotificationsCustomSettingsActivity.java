...
public class NotificationsCustomSettingsActivity extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public org.telegram.ui.Components.ml0 f30835a;
    public int addExceptionRow;
    public ik0 f30836b;
    public org.telegram.ui.Components.nz f30837c;
    public kk0 d;
    ...
    public ArrayList f30842w;
    public final HashMap f30843x;
    ...
    public NotificationsCustomSettingsActivity(int i10, ArrayList arrayList, ArrayList arrayList2, boolean z10) {
        super(null);
        this.h = true;
        this.f30843x = new HashMap();
        this.f30844y = new int[]{R.string.VibrationDefault, R.string.Short, R.string.VibrationDisabled, R.string.Long, R.string.OnlyIfSilent};
        ...
        this.f30841s = i10;
        this.v = arrayList2;
        this.f30842w = arrayList;
        if (arrayList != null) {
            int size = arrayList.size();
            for (int i14 = 0; i14 < size; i14++) {
                nk0 nk0Var = (nk0) this.f30842w.get(i14);
                this.f30843x.put(Long.valueOf(nk0Var.d), nk0Var);
            }
        }
        ...
        if (arrayList3 != null) {
            ...
            for (int i15 = 0; i15 < size2; i15++) {
                ...
                this.f30843x.put(Long.valueOf(nk0Var2.d), nk0Var2);
            }
        }
        if (z10) {
            j0();
    ...
    public static boolean c0(int i10, long j3) {
        ...
        if (notificationsSettings.contains("stories_" + j3)) {
            return org.telegram.messenger.z0.v("stories_", j3, notificationsSettings, true);
        }
    ...
    public final View createView(Context context) {
        ...
        ArrayList arrayList = this.f30842w;
        ...
        this.f30837c.setText(LocaleController.getString("NoExceptions", R.string.NoExceptions));
        this.f30837c.c();
        frameLayout.addView(this.f30837c, w7.x5.c(-1.0f, -1));
        org.telegram.ui.Components.ml0 ml0Var = new org.telegram.ui.Components.ml0(context, null);
        this.f30835a = ml0Var;
        ml0Var.p1();
        this.actionBar.setAdaptiveBackground(this.f30835a);
        this.f30835a.setEmptyView(this.f30837c);
        this.f30835a.setLayoutManager(new s4.c0(1, false));
        this.f30835a.setVerticalScrollBarEnabled(false);
        frameLayout.addView(this.f30835a, w7.x5.c(-1.0f, -1));
        org.telegram.ui.Components.ml0 ml0Var2 = this.f30835a;
        ik0 ik0Var = new ik0(this, context);
        this.f30836b = ik0Var;
        ml0Var2.setAdapter(ik0Var);
        this.f30835a.setOnItemClickListener(new w10(20, this, context));
        ...
        fk0Var.d = 0L;
        fk0Var.C = false;
        fk0Var.f42711i = new OvershootInterpolator(1.1f);
        fk0Var.f42684o = org.telegram.ui.Components.rr.h;
        fk0Var.f42662m = false;
        this.f30835a.setItemAnimator(fk0Var);
        this.f30835a.setOnScrollListener(new i3(this, 22));
    ...
    public final void e0(nk0 nk0Var, View view) {
        ...
        ArrayList arrayList2 = this.f30842w;
        if (arrayList2 != null) {
    ...
    public final int f0() {
        ...
        for (int i12 = 0; i12 < 9; i12++) {
            if (org.telegram.ui.Cells.z8.f21681f[i12] == i10) {
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f30835a, 16, new Class[]{org.telegram.ui.Cells.m4.class, org.telegram.ui.Cells.x8.class, org.telegram.ui.Cells.z8.class, org.telegram.ui.Cells.fa.class, org.telegram.ui.Cells.bb.class, org.telegram.ui.Cells.j5.class}, null, null, null, org.telegram.ui.ActionBar.h6.f18789d6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f30835a, 32768, null, null, null, null, org.telegram.ui.ActionBar.h6.f19065s8));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f30835a, 4096, null, null, null, null, org.telegram.ui.ActionBar.h6.f18878i6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f30835a, 0, new Class[]{View.class}, org.telegram.ui.ActionBar.h6.f18910k0, null, null, org.telegram.ui.ActionBar.h6.f18790d7));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f30835a, 0, new Class[]{org.telegram.ui.Cells.m4.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.L6));
        int i10 = org.telegram.ui.ActionBar.h6.G6;
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f30835a, 0, new Class[]{org.telegram.ui.Cells.x8.class}, new String[]{"textView"}, null, null, -1, null, i10));
        int i11 = org.telegram.ui.ActionBar.h6.f19189z6;
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f30835a, 0, new Class[]{org.telegram.ui.Cells.x8.class}, new String[]{"valueTextView"}, null, null, -1, null, i11));
        int i12 = org.telegram.ui.ActionBar.h6.M6;
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f30835a, 0, new Class[]{org.telegram.ui.Cells.x8.class}, new String[]{"checkBox"}, null, null, -1, null, i12));
        int i13 = org.telegram.ui.ActionBar.h6.N6;
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f30835a, 0, new Class[]{org.telegram.ui.Cells.x8.class}, new String[]{"checkBox"}, null, null, -1, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f30835a, 0, new Class[]{org.telegram.ui.Cells.bb.class}, new String[]{"imageView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.f18953m6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f30835a, 0, new Class[]{org.telegram.ui.Cells.bb.class}, new String[]{"nameTextView"}, null, null, -1, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f30835a, 0, new Class[]{org.telegram.ui.Cells.bb.class}, new String[]{"statusColor"}, null, null, -1, eVar, org.telegram.ui.ActionBar.h6.f19170y6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f30835a, 0, new Class[]{org.telegram.ui.Cells.bb.class}, new String[]{"statusOnlineColor"}, null, null, -1, eVar, org.telegram.ui.ActionBar.h6.f18973n6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f30835a, 0, new Class[]{org.telegram.ui.Cells.bb.class}, null, org.telegram.ui.ActionBar.h6.f19038r0, null, org.telegram.ui.ActionBar.h6.J7));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f30835a, 0, new Class[]{org.telegram.ui.Cells.v3.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.f7));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f30835a, 0, new Class[]{org.telegram.ui.Cells.j5.class}, new String[]{"textView"}, null, null, -1, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f30835a, 0, new Class[]{org.telegram.ui.Cells.j5.class}, new String[]{"valueTextView"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f30835a, 0, new Class[]{org.telegram.ui.Cells.j5.class}, new String[]{"checkBox"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f30835a, 0, new Class[]{org.telegram.ui.Cells.j5.class}, new String[]{"checkBox"}, null, null, -1, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f30835a, 0, new Class[]{org.telegram.ui.Cells.z8.class}, new String[]{"textView"}, null, null, -1, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f30835a, 0, new Class[]{org.telegram.ui.Cells.fa.class}, new String[]{"textView"}, null, null, -1, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f30835a, 0, new Class[]{org.telegram.ui.Cells.fa.class}, new String[]{"valueTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.I6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f30835a, 262144, new Class[]{org.telegram.ui.Cells.s8.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.f19100u6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f30835a, 262144, new Class[]{org.telegram.ui.Cells.s8.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.f19008p7));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f30835a, 262144, new Class[]{org.telegram.ui.Cells.s8.class}, new String[]{"imageView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.f19118v6));
        return arrayList;
    }
    ...
    public final void k0(nk0 nk0Var, View view, boolean z10) {
        ...
        if (nk0Var.f35549f) {
            ...
            if (this.f30842w == null) {
                this.f30842w = new ArrayList();
            }
            this.f30842w.add(0, nk0Var);
        } else if (i02) {
            edit.putBoolean(org.telegram.ui.Cells.q3.i("stories_", sharedPrefKey), !z10).commit();
        } else {
            Boolean bool = this.f30839n;
        ...
        if (i14 != -1) {
            ...
            if (i14 == 3) {
                ...
                if (!notificationsSettings.getBoolean("EnableAllStories", false)) {
                    ...
                    if (this.f30840r && ((bool = this.f30839n) == null || !bool.booleanValue())) {
                        z12 = true;
                    } else {
                        z12 = false;
                    }
        ...
        if (i14 != 4 && i14 != 5) {
            ...
            if (this.v != null && this.h) {
                for (int i18 = 0; i18 < this.v.size(); i18++) {
                    ...
                    aVar9.f33878g = (nk0) this.v.get(i18);
                    arrayList3.add(aVar9);
                }
            }
            if (this.f30842w != null) {
                for (int i19 = 0; i19 < this.f30842w.size(); i19++) {
                    ?? aVar10 = new og.a(2, true);
                    aVar10.f33878g = (nk0) this.f30842w.get(i19);
                    arrayList3.add(aVar10);
                }
            }
            arrayList3.size();
            if (i14 != -1 || ((arrayList = this.f30842w) != null && !arrayList.isEmpty())) {
                arrayList3.add(hk0.d(-3, null));
            }
            ArrayList arrayList4 = this.f30842w;
    ...
    public final void onActivityResultFragment(int i10, int i11, Intent intent) {
        ...
        if (i11 == -1) {
            ...
            s4.c1 K = this.f30835a.K(i10);
            if (K != null) {
                this.f30836b.v(K, i10);
            }
        }
    }
    ...
    public final boolean onFragmentCreate() {
        if (this.f30841s == 3) {
            if (getNotificationsSettings().contains("EnableAllStories")) {
                this.f30839n = Boolean.valueOf(getNotificationsSettings().getBoolean("EnableAllStories", true));
                this.f30840r = false;
                this.h = false;
            } else {
                this.f30839n = null;
    ...
    public final void onInsets(int i10, int i11, int i12, int i13) {
        this.f30835a.setPadding(0, 0, 0, i13);
        this.f30835a.setClipToPadding(false);
    }
