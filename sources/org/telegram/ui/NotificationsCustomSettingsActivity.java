...
public class NotificationsCustomSettingsActivity extends org.telegram.ui.ActionBar.m2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public org.telegram.ui.Components.xl0 f31149a;
    public int addExceptionRow;
    public ik0 f31150b;
    public org.telegram.ui.Components.oz f31151c;
    public kk0 d;
    ...
    public ArrayList f31156w;
    public final HashMap f31157x;
    public final int[] f31158y;

    public NotificationsCustomSettingsActivity(int i10, ArrayList arrayList, ArrayList arrayList2, boolean z10) {
        super(null);
        this.h = true;
        this.f31157x = new HashMap();
        this.f31158y = new int[]{R.string.VibrationDefault, R.string.Short, R.string.VibrationDisabled, R.string.Long, R.string.OnlyIfSilent};
        ...
        this.f31155s = i10;
        this.v = arrayList2;
        this.f31156w = arrayList;
        if (arrayList != null) {
            int size = arrayList.size();
            for (int i14 = 0; i14 < size; i14++) {
                nk0 nk0Var = (nk0) this.f31156w.get(i14);
                this.f31157x.put(Long.valueOf(nk0Var.d), nk0Var);
            }
        }
        ...
        if (arrayList3 != null) {
            ...
            for (int i15 = 0; i15 < size2; i15++) {
                ...
                this.f31157x.put(Long.valueOf(nk0Var2.d), nk0Var2);
            }
        }
        if (z10) {
            j0();
    ...
    public final View createView(Context context) {
        ...
        ArrayList arrayList = this.f31156w;
        ...
        this.f31151c.setText(LocaleController.getString("NoExceptions", R.string.NoExceptions));
        this.f31151c.c();
        frameLayout.addView(this.f31151c, w7.y5.c(-1.0f, -1));
        org.telegram.ui.Components.xl0 xl0Var = new org.telegram.ui.Components.xl0(context, null);
        this.f31149a = xl0Var;
        xl0Var.p1();
        this.actionBar.setAdaptiveBackground(this.f31149a);
        this.f31149a.setEmptyView(this.f31151c);
        this.f31149a.setLayoutManager(new s4.c0(1, false));
        this.f31149a.setVerticalScrollBarEnabled(false);
        frameLayout.addView(this.f31149a, w7.y5.c(-1.0f, -1));
        org.telegram.ui.Components.xl0 xl0Var2 = this.f31149a;
        ik0 ik0Var = new ik0(this, context);
        this.f31150b = ik0Var;
        xl0Var2.setAdapter(ik0Var);
        this.f31149a.setOnItemClickListener(new ow(21, this, context));
        ...
        fk0Var.d = 0L;
        fk0Var.C = false;
        fk0Var.f43043i = new OvershootInterpolator(1.1f);
        fk0Var.f43016o = org.telegram.ui.Components.sr.h;
        fk0Var.f42994m = false;
        this.f31149a.setItemAnimator(fk0Var);
        this.f31149a.setOnScrollListener(new i3(this, 22));
    ...
    public final void e0(nk0 nk0Var, View view) {
        ...
        ArrayList arrayList2 = this.f31156w;
        if (arrayList2 != null) {
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31149a, 16, new Class[]{org.telegram.ui.Cells.m4.class, org.telegram.ui.Cells.w8.class, org.telegram.ui.Cells.y8.class, org.telegram.ui.Cells.ea.class, org.telegram.ui.Cells.za.class, org.telegram.ui.Cells.j5.class}, null, null, null, org.telegram.ui.ActionBar.h6.f19059d6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31149a, 32768, null, null, null, null, org.telegram.ui.ActionBar.h6.f19337s8));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31149a, 4096, null, null, null, null, org.telegram.ui.ActionBar.h6.f19148i6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31149a, 0, new Class[]{View.class}, org.telegram.ui.ActionBar.h6.f19180k0, null, null, org.telegram.ui.ActionBar.h6.f19060d7));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31149a, 0, new Class[]{org.telegram.ui.Cells.m4.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.L6));
        int i10 = org.telegram.ui.ActionBar.h6.G6;
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31149a, 0, new Class[]{org.telegram.ui.Cells.w8.class}, new String[]{"textView"}, null, null, -1, null, i10));
        int i11 = org.telegram.ui.ActionBar.h6.f19461z6;
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31149a, 0, new Class[]{org.telegram.ui.Cells.w8.class}, new String[]{"valueTextView"}, null, null, -1, null, i11));
        int i12 = org.telegram.ui.ActionBar.h6.M6;
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31149a, 0, new Class[]{org.telegram.ui.Cells.w8.class}, new String[]{"checkBox"}, null, null, -1, null, i12));
        int i13 = org.telegram.ui.ActionBar.h6.N6;
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31149a, 0, new Class[]{org.telegram.ui.Cells.w8.class}, new String[]{"checkBox"}, null, null, -1, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31149a, 0, new Class[]{org.telegram.ui.Cells.za.class}, new String[]{"imageView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.f19223m6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31149a, 0, new Class[]{org.telegram.ui.Cells.za.class}, new String[]{"nameTextView"}, null, null, -1, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31149a, 0, new Class[]{org.telegram.ui.Cells.za.class}, new String[]{"statusColor"}, null, null, -1, eVar, org.telegram.ui.ActionBar.h6.f19442y6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31149a, 0, new Class[]{org.telegram.ui.Cells.za.class}, new String[]{"statusOnlineColor"}, null, null, -1, eVar, org.telegram.ui.ActionBar.h6.f19243n6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31149a, 0, new Class[]{org.telegram.ui.Cells.za.class}, null, org.telegram.ui.ActionBar.h6.f19310r0, null, org.telegram.ui.ActionBar.h6.J7));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31149a, 0, new Class[]{org.telegram.ui.Cells.v3.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.f7));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31149a, 0, new Class[]{org.telegram.ui.Cells.j5.class}, new String[]{"textView"}, null, null, -1, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31149a, 0, new Class[]{org.telegram.ui.Cells.j5.class}, new String[]{"valueTextView"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31149a, 0, new Class[]{org.telegram.ui.Cells.j5.class}, new String[]{"checkBox"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31149a, 0, new Class[]{org.telegram.ui.Cells.j5.class}, new String[]{"checkBox"}, null, null, -1, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31149a, 0, new Class[]{org.telegram.ui.Cells.y8.class}, new String[]{"textView"}, null, null, -1, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31149a, 0, new Class[]{org.telegram.ui.Cells.ea.class}, new String[]{"textView"}, null, null, -1, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31149a, 0, new Class[]{org.telegram.ui.Cells.ea.class}, new String[]{"valueTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.I6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31149a, 262144, new Class[]{org.telegram.ui.Cells.r8.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.f19372u6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31149a, 262144, new Class[]{org.telegram.ui.Cells.r8.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.f19279p7));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31149a, 262144, new Class[]{org.telegram.ui.Cells.r8.class}, new String[]{"imageView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.f19390v6));
        return arrayList;
    }
    ...
    public final void k0(nk0 nk0Var, View view, boolean z10) {
        ...
        if (nk0Var.f35919f) {
            ...
            if (this.f31156w == null) {
                this.f31156w = new ArrayList();
            }
            this.f31156w.add(0, nk0Var);
        } else if (i02) {
            edit.putBoolean(v7.j.g("stories_", sharedPrefKey), !z10).commit();
        } else {
            Boolean bool = this.f31153n;
        ...
        if (i14 != -1) {
            ...
            if (i14 == 3) {
                ...
                if (!notificationsSettings.getBoolean("EnableAllStories", false)) {
                    ...
                    if (this.f31154r && ((bool = this.f31153n) == null || !bool.booleanValue())) {
                        z12 = true;
                    } else {
                        z12 = false;
                    }
        ...
        if (i14 != 4 && i14 != 5) {
            ...
            if (this.v != null && this.h) {
                for (int i18 = 0; i18 < this.v.size(); i18++) {
                    ...
                    aVar9.f34244g = (nk0) this.v.get(i18);
                    arrayList3.add(aVar9);
                }
            }
            if (this.f31156w != null) {
                for (int i19 = 0; i19 < this.f31156w.size(); i19++) {
                    ?? aVar10 = new og.a(2, true);
                    aVar10.f34244g = (nk0) this.f31156w.get(i19);
                    arrayList3.add(aVar10);
                }
            }
            arrayList3.size();
            if (i14 != -1 || ((arrayList = this.f31156w) != null && !arrayList.isEmpty())) {
                arrayList3.add(hk0.d(-3, null));
            }
            ArrayList arrayList4 = this.f31156w;
    ...
    public final void onActivityResultFragment(int i10, int i11, Intent intent) {
        ...
        if (i11 == -1) {
            ...
            s4.c1 K = this.f31149a.K(i10);
            if (K != null) {
                this.f31150b.v(K, i10);
            }
        }
    }
    ...
    public final boolean onFragmentCreate() {
        if (this.f31155s == 3) {
            if (getNotificationsSettings().contains("EnableAllStories")) {
                this.f31153n = Boolean.valueOf(getNotificationsSettings().getBoolean("EnableAllStories", true));
                this.f31154r = false;
                this.h = false;
            } else {
                this.f31153n = null;
    ...
    public final void onInsets(int i10, int i11, int i12, int i13) {
        this.f31149a.setPadding(0, 0, 0, i13);
        this.f31149a.setClipToPadding(false);
    }
