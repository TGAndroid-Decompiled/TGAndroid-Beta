...
public class NotificationsCustomSettingsActivity extends org.telegram.ui.ActionBar.o2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public org.telegram.ui.Components.ml0 f30881a;
    public int addExceptionRow;
    public qk0 f30882b;
    public org.telegram.ui.Components.mz f30883c;
    public sk0 d;
    ...
    public ArrayList f30888w;
    public final HashMap f30889x;
    ...
    public NotificationsCustomSettingsActivity(int i10, ArrayList arrayList, ArrayList arrayList2, boolean z10) {
        super(null);
        this.h = true;
        this.f30889x = new HashMap();
        this.f30890y = new int[]{R.string.VibrationDefault, R.string.Short, R.string.VibrationDisabled, R.string.Long, R.string.OnlyIfSilent};
        ...
        this.f30887s = i10;
        this.v = arrayList2;
        this.f30888w = arrayList;
        if (arrayList != null) {
            int size = arrayList.size();
            for (int i14 = 0; i14 < size; i14++) {
                vk0 vk0Var = (vk0) this.f30888w.get(i14);
                this.f30889x.put(Long.valueOf(vk0Var.d), vk0Var);
            }
        }
        ...
        if (arrayList3 != null) {
            ...
            for (int i15 = 0; i15 < size2; i15++) {
                ...
                this.f30889x.put(Long.valueOf(vk0Var2.d), vk0Var2);
            }
        }
        if (z10) {
            j0();
    ...
    public final View createView(Context context) {
        ...
        ArrayList arrayList = this.f30888w;
        ...
        this.f30883c.setText(LocaleController.getString("NoExceptions", R.string.NoExceptions));
        this.f30883c.c();
        frameLayout.addView(this.f30883c, w7.x5.c(-1.0f, -1));
        org.telegram.ui.Components.ml0 ml0Var = new org.telegram.ui.Components.ml0(context, null);
        this.f30881a = ml0Var;
        ml0Var.q1();
        this.f30881a.setEmptyView(this.f30883c);
        this.f30881a.setLayoutManager(new s4.c0(1, false));
        this.f30881a.setVerticalScrollBarEnabled(false);
        frameLayout.addView(this.f30881a, w7.x5.c(-1.0f, -1));
        org.telegram.ui.Components.ml0 ml0Var2 = this.f30881a;
        qk0 qk0Var = new qk0(this, context);
        this.f30882b = qk0Var;
        ml0Var2.setAdapter(qk0Var);
        this.f30881a.setOnItemClickListener(new f20(19, this, context));
        ...
        nk0Var.d = 0L;
        nk0Var.C = false;
        nk0Var.f42786i = new OvershootInterpolator(1.1f);
        nk0Var.f42759o = org.telegram.ui.Components.qr.h;
        nk0Var.f42737m = false;
        this.f30881a.setItemAnimator(nk0Var);
        this.f30881a.setOnScrollListener(new h3(this, 22));
    ...
    public final void e0(vk0 vk0Var, View view) {
        ...
        ArrayList arrayList2 = this.f30888w;
        if (arrayList2 != null) {
    ...
    public final int f0() {
        ...
        for (int i12 = 0; i12 < 9; i12++) {
            if (org.telegram.ui.Cells.y8.f21676f[i12] == i10) {
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f30881a, 16, new Class[]{org.telegram.ui.Cells.l4.class, org.telegram.ui.Cells.w8.class, org.telegram.ui.Cells.y8.class, org.telegram.ui.Cells.ea.class, org.telegram.ui.Cells.ab.class, org.telegram.ui.Cells.i5.class}, null, null, null, org.telegram.ui.ActionBar.j6.f18863d6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f30881a, 32768, null, null, null, null, org.telegram.ui.ActionBar.j6.f19140s8));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f30881a, 4096, null, null, null, null, org.telegram.ui.ActionBar.j6.f18953i6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f30881a, 0, new Class[]{View.class}, org.telegram.ui.ActionBar.j6.f18985k0, null, null, org.telegram.ui.ActionBar.j6.f18864d7));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f30881a, 0, new Class[]{org.telegram.ui.Cells.l4.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.L6));
        int i10 = org.telegram.ui.ActionBar.j6.G6;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f30881a, 0, new Class[]{org.telegram.ui.Cells.w8.class}, new String[]{"textView"}, null, null, -1, null, i10));
        int i11 = org.telegram.ui.ActionBar.j6.f19264z6;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f30881a, 0, new Class[]{org.telegram.ui.Cells.w8.class}, new String[]{"valueTextView"}, null, null, -1, null, i11));
        int i12 = org.telegram.ui.ActionBar.j6.M6;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f30881a, 0, new Class[]{org.telegram.ui.Cells.w8.class}, new String[]{"checkBox"}, null, null, -1, null, i12));
        int i13 = org.telegram.ui.ActionBar.j6.N6;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f30881a, 0, new Class[]{org.telegram.ui.Cells.w8.class}, new String[]{"checkBox"}, null, null, -1, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f30881a, 0, new Class[]{org.telegram.ui.Cells.ab.class}, new String[]{"imageView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f19028m6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f30881a, 0, new Class[]{org.telegram.ui.Cells.ab.class}, new String[]{"nameTextView"}, null, null, -1, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f30881a, 0, new Class[]{org.telegram.ui.Cells.ab.class}, new String[]{"statusColor"}, null, null, -1, eVar, org.telegram.ui.ActionBar.j6.f19245y6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f30881a, 0, new Class[]{org.telegram.ui.Cells.ab.class}, new String[]{"statusOnlineColor"}, null, null, -1, eVar, org.telegram.ui.ActionBar.j6.f19048n6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f30881a, 0, new Class[]{org.telegram.ui.Cells.ab.class}, null, org.telegram.ui.ActionBar.j6.f19113r0, null, org.telegram.ui.ActionBar.j6.J7));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f30881a, 0, new Class[]{org.telegram.ui.Cells.u3.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f7));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f30881a, 0, new Class[]{org.telegram.ui.Cells.i5.class}, new String[]{"textView"}, null, null, -1, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f30881a, 0, new Class[]{org.telegram.ui.Cells.i5.class}, new String[]{"valueTextView"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f30881a, 0, new Class[]{org.telegram.ui.Cells.i5.class}, new String[]{"checkBox"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f30881a, 0, new Class[]{org.telegram.ui.Cells.i5.class}, new String[]{"checkBox"}, null, null, -1, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f30881a, 0, new Class[]{org.telegram.ui.Cells.y8.class}, new String[]{"textView"}, null, null, -1, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f30881a, 0, new Class[]{org.telegram.ui.Cells.ea.class}, new String[]{"textView"}, null, null, -1, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f30881a, 0, new Class[]{org.telegram.ui.Cells.ea.class}, new String[]{"valueTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.I6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f30881a, 262144, new Class[]{org.telegram.ui.Cells.r8.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f19175u6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f30881a, 262144, new Class[]{org.telegram.ui.Cells.r8.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f19083p7));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f30881a, 262144, new Class[]{org.telegram.ui.Cells.r8.class}, new String[]{"imageView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f19193v6));
        return arrayList;
    }
    ...
    public final void k0(vk0 vk0Var, View view, boolean z10) {
        ...
        if (vk0Var.f38472f) {
            ...
            if (this.f30888w == null) {
                this.f30888w = new ArrayList();
            }
            this.f30888w.add(0, vk0Var);
        } else if (i02) {
            edit.putBoolean(org.telegram.ui.Cells.p6.i("stories_", sharedPrefKey), !z10).commit();
        } else {
            Boolean bool = this.f30885n;
        ...
        if (i14 != -1) {
            ...
            if (i14 == 3) {
                ...
                if (!notificationsSettings.getBoolean("EnableAllStories", false)) {
                    ...
                    if (this.f30886r && ((bool = this.f30885n) == null || !bool.booleanValue())) {
                        z12 = true;
                    } else {
                        z12 = false;
                    }
        ...
        if (i14 != 4 && i14 != 5) {
            ...
            if (this.v != null && this.h) {
                for (int i18 = 0; i18 < this.v.size(); i18++) {
                    ...
                    aVar9.f36655g = (vk0) this.v.get(i18);
                    arrayList3.add(aVar9);
                }
            }
            if (this.f30888w != null) {
                for (int i19 = 0; i19 < this.f30888w.size(); i19++) {
                    ?? aVar10 = new og.a(2, true);
                    aVar10.f36655g = (vk0) this.f30888w.get(i19);
                    arrayList3.add(aVar10);
                }
            }
            arrayList3.size();
            if (i14 != -1 || ((arrayList = this.f30888w) != null && !arrayList.isEmpty())) {
                arrayList3.add(pk0.d(-3, null));
            }
            ArrayList arrayList4 = this.f30888w;
    ...
    public final void onActivityResultFragment(int i10, int i11, Intent intent) {
        ...
        if (i11 == -1) {
            ...
            s4.c1 L = this.f30881a.L(i10);
            if (L != null) {
                this.f30882b.v(L, i10);
            }
        }
    }
    ...
    public final boolean onFragmentCreate() {
        if (this.f30887s == 3) {
            if (getNotificationsSettings().contains("EnableAllStories")) {
                this.f30885n = Boolean.valueOf(getNotificationsSettings().getBoolean("EnableAllStories", true));
                this.f30886r = false;
                this.h = false;
            } else {
                this.f30885n = null;
