...
public final class vi0 extends org.telegram.ui.Components.ll0 {
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        cj0 cj0Var = this.f41574b3;
        if (cj0Var.f35157w && ((view == (t1Var = cj0Var.Q) && t1Var != null && t1Var.getCurrentPosition() == null) || view == cj0Var.X)) {
            return false;
        }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        super.onMeasure(i10, View.MeasureSpec.makeMeasureSpec(Math.max(0, ((AndroidUtilities.displaySize.y - (dp + measuredHeight)) - AndroidUtilities.dp(8.0f)) - cj0Var.f35135e.f11426b), Integer.MIN_VALUE));
        if (cj0Var.m0) {
            l4 = cj0Var.Y;
        } else {
            l4 = cj0Var.W.l();
        }
        int max = Math.max(AndroidUtilities.dp(12.0f) + l4, -((AndroidUtilities.dp(7.0f) + cj0Var.f35147o0[0]) - getMeasuredWidth()));
        int i13 = cj0Var.O;
