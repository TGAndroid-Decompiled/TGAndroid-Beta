...
public final class af1 extends org.telegram.ui.ActionBar.n2 {
    ...
    public final void b0(Long l4, boolean z10) {
        ...
        if (this.f34415f != null && this.v != null) {
            if (l4 == null) {
                longValue = 0;
            } else {
                longValue = l4.longValue();
            }
            this.f34415f.setSelected(Long.valueOf(longValue));
            if (this.f34412b != longValue) {
                ...
                if (longValue != 0) {
                    ...
                    l80Var.a(this.f34416n);
                    this.v.b(l80Var, false);
                    x9VarArr[1].setImageDrawable(this.f34418s);
    ...
    public final View createView(Context context) {
        ...
        TLRPC.TL_forumTopic tL_forumTopic = this.f34419w;
        ...
        this.f34414e = editTextBoldCursor;
        editTextBoldCursor.setHintText(LocaleController.getString(R.string.EnterTopicName));
        this.f34414e.setHintColor(getThemedColor(org.telegram.ui.ActionBar.j6.Vd));
        this.f34414e.setTextColor(getThemedColor(org.telegram.ui.ActionBar.j6.Ud));
        this.f34414e.setPadding(AndroidUtilities.dp(0.0f), this.f34414e.getPaddingTop(), AndroidUtilities.dp(0.0f), this.f34414e.getPaddingBottom());
        this.f34414e.setBackground(null);
        this.f34414e.setSingleLine(true);
        EditTextBoldCursor editTextBoldCursor2 = this.f34414e;
        editTextBoldCursor2.setInputType(editTextBoldCursor2.getInputType() | 16384);
        frameLayout.addView(this.f34414e, w7.x5.d(-1, -1.0f, 0, 51.0f, 4.0f, 21.0f, 4.0f));
        this.f34414e.addTextChangedListener(new l0(this, 16));
        FrameLayout frameLayout2 = new FrameLayout(context);
        frameLayout2.setOnClickListener(new View.OnClickListener(this) {
            public final af1 f41081b;
            ...
            public final void onClick(View view) {
                int i11 = r2;
                af1 af1Var = this.f41081b;
                switch (i11) {
                    case 0:
                        if (af1Var.f34412b == 0 && af1Var.f34419w == null) {
                            og.a aVar = af1Var.f34420x;
        ...
        TLRPC.TL_forumTopic tL_forumTopic2 = this.f34419w;
        if (tL_forumTopic2 != null && tL_forumTopic2.f19921id == 1) {
            ...
            this.d.d(LocaleController.getString(R.string.EditTopicHide), !this.f34419w.hidden, false, false);
            this.d.setBackground(org.telegram.ui.ActionBar.j6.Z(getThemedColor(i12), getThemedColor(org.telegram.ui.ActionBar.j6.f20754i6), 16, 16));
            ...
            this.f34415f.setClipChildren(false);
            frameLayout3.addView(this.f34415f, w7.x5.d(-1, -1.0f, 0, 12.0f, 12.0f, 12.0f, 12.0f));
            org.telegram.ui.Components.oq d = og.d.d(this.E, "");
            this.f34420x = (og.a) d.f29160a;
            ...
            ArrayList arrayList2 = ql0Var2.f29767n;
            if (!arrayList2.contains(x9Var3)) {
                arrayList2.add(x9Var3);
            }
            x9VarArr[0].setImageDrawable(this.f34418s);
            ...
            og.a aVar = this.f34420x;
            aVar.d.add(x9VarArr[0]);
            og.a aVar2 = this.f34420x;
            aVar2.d.add(x9VarArr[1]);
        }
        linearLayout.addView(frameLayout3, w7.x5.c(-1.0f, -1));
        TLRPC.TL_forumTopic tL_forumTopic3 = this.f34419w;
        if (tL_forumTopic3 != null) {
            this.f34414e.setText(tL_forumTopic3.title);
            b0(Long.valueOf(this.f34419w.icon_emoji_id), true);
        } else {
            b0(0L, true);
        }
    ...
    public final boolean onFragmentCreate() {
        this.f34411a = -this.arguments.getLong("chat_id");
        long j3 = this.arguments.getLong("topic_id", 0L);
        this.f34413c = j3;
        if (j3 != 0) {
            TLRPC.TL_forumTopic findTopic = getMessagesController().getTopicsController().findTopic(-this.f34411a, this.f34413c);
            this.f34419w = findTopic;
            if (findTopic == null) {
                return false;
            }
    ...
    public final void onResume() {
        super.onResume();
        this.f34414e.requestFocus();
        AndroidUtilities.showKeyboard(this.f34414e);
    }
