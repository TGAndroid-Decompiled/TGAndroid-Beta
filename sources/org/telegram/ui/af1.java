...
public final class af1 extends org.telegram.ui.ActionBar.n2 {
    ...
    public EditTextBoldCursor f34441e;
    public ze1 f34442f;
    public org.telegram.ui.Components.x9[] h;
    public String f34443n;
    public boolean f34444r;
    public org.telegram.ui.Components.oq f34445s;
    public org.telegram.ui.Components.ql0 v;
    public TLRPC.TL_forumTopic f34446w;
    public og.a f34447x;
    public co f34448y;
    ...
    public final void b0(Long l4, boolean z10) {
        ...
        if (this.f34442f != null && this.v != null) {
            if (l4 == null) {
                longValue = 0;
            } else {
                longValue = l4.longValue();
            }
            this.f34442f.setSelected(Long.valueOf(longValue));
            if (this.f34439b != longValue) {
                ...
                if (longValue != 0) {
                    ...
                    l80Var.a(this.f34443n);
                    this.v.b(l80Var, false);
                    x9VarArr[1].setImageDrawable(this.f34445s);
    ...
    public final View createView(Context context) {
        ...
        TLRPC.TL_forumTopic tL_forumTopic = this.f34446w;
        ...
        this.f34441e = editTextBoldCursor;
        editTextBoldCursor.setHintText(LocaleController.getString(R.string.EnterTopicName));
        this.f34441e.setHintColor(getThemedColor(org.telegram.ui.ActionBar.j6.Vd));
        this.f34441e.setTextColor(getThemedColor(org.telegram.ui.ActionBar.j6.Ud));
        this.f34441e.setPadding(AndroidUtilities.dp(0.0f), this.f34441e.getPaddingTop(), AndroidUtilities.dp(0.0f), this.f34441e.getPaddingBottom());
        this.f34441e.setBackground(null);
        this.f34441e.setSingleLine(true);
        EditTextBoldCursor editTextBoldCursor2 = this.f34441e;
        editTextBoldCursor2.setInputType(editTextBoldCursor2.getInputType() | 16384);
        frameLayout.addView(this.f34441e, w7.x5.d(-1, -1.0f, 0, 51.0f, 4.0f, 21.0f, 4.0f));
        this.f34441e.addTextChangedListener(new l0(this, 16));
        FrameLayout frameLayout2 = new FrameLayout(context);
        frameLayout2.setOnClickListener(new View.OnClickListener(this) {
            public final af1 f41108b;
            ...
            public final void onClick(View view) {
                int i11 = r2;
                af1 af1Var = this.f41108b;
                switch (i11) {
                    case 0:
                        if (af1Var.f34439b == 0 && af1Var.f34446w == null) {
                            og.a aVar = af1Var.f34447x;
        ...
        TLRPC.TL_forumTopic tL_forumTopic2 = this.f34446w;
        if (tL_forumTopic2 != null && tL_forumTopic2.f19948id == 1) {
            ...
            this.d.d(LocaleController.getString(R.string.EditTopicHide), !this.f34446w.hidden, false, false);
            this.d.setBackground(org.telegram.ui.ActionBar.j6.Z(getThemedColor(i12), getThemedColor(org.telegram.ui.ActionBar.j6.f20781i6), 16, 16));
            ...
            this.f34442f.setClipChildren(false);
            frameLayout3.addView(this.f34442f, w7.x5.d(-1, -1.0f, 0, 12.0f, 12.0f, 12.0f, 12.0f));
            org.telegram.ui.Components.oq d = og.d.d(this.E, "");
            this.f34447x = (og.a) d.f29187a;
            ...
            ArrayList arrayList2 = ql0Var2.f29794n;
            if (!arrayList2.contains(x9Var3)) {
                arrayList2.add(x9Var3);
            }
            x9VarArr[0].setImageDrawable(this.f34445s);
            ...
            og.a aVar = this.f34447x;
            aVar.d.add(x9VarArr[0]);
            og.a aVar2 = this.f34447x;
            aVar2.d.add(x9VarArr[1]);
        }
        linearLayout.addView(frameLayout3, w7.x5.c(-1.0f, -1));
        TLRPC.TL_forumTopic tL_forumTopic3 = this.f34446w;
        if (tL_forumTopic3 != null) {
            this.f34441e.setText(tL_forumTopic3.title);
            b0(Long.valueOf(this.f34446w.icon_emoji_id), true);
        } else {
            b0(0L, true);
        }
    ...
    public final boolean onFragmentCreate() {
        this.f34438a = -this.arguments.getLong("chat_id");
        long j3 = this.arguments.getLong("topic_id", 0L);
        this.f34440c = j3;
        if (j3 != 0) {
            TLRPC.TL_forumTopic findTopic = getMessagesController().getTopicsController().findTopic(-this.f34438a, this.f34440c);
            this.f34446w = findTopic;
            if (findTopic == null) {
                return false;
            }
    ...
    public final void onResume() {
        super.onResume();
        this.f34441e.requestFocus();
        AndroidUtilities.showKeyboard(this.f34441e);
    }
