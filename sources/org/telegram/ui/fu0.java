...
public final class fu0 implements ViewTreeObserver.OnPreDrawListener {
    public final ClippingImageView[] f33667a;
    public final ViewGroup.LayoutParams f33668b;
    public final float f33669c;
    public final dv0 d;
    public final float e;
    public final bv0 f33670f;
    public final ArrayList h;
    public final Integer f33671n;
    public final PhotoViewer f33672r;
    ...
    public fu0(PhotoViewer photoViewer, ClippingImageView[] clippingImageViewArr, ViewGroup.LayoutParams layoutParams, float f7, dv0 dv0Var, float f10, bv0 bv0Var, ArrayList arrayList, Integer num) {
        this.f33672r = photoViewer;
        this.f33667a = clippingImageViewArr;
        this.f33668b = layoutParams;
        this.f33669c = f7;
        this.d = dv0Var;
        this.e = f10;
        this.f33670f = bv0Var;
    ...
    public final boolean onPreDraw() {
        ...
        int i14;
        int i15;
        PhotoViewer photoViewer = this.f33672r;
        Rect rect = photoViewer.f31060s2;
        PhotoViewer.BackgroundDrawable backgroundDrawable = photoViewer.L0;
        float[][] fArr = photoViewer.f30992k4;
        ClippingImageView[] clippingImageViewArr = this.f33667a;
        ...
        ViewGroup.LayoutParams layoutParams = this.f33668b;
        if (i16 == 1) {
            ...
            int measuredWidth2 = photoViewer.f30953g0.getMeasuredWidth();
            v9 = com.google.android.gms.internal.vision.e2.v(layoutParams.width, f7, (measuredWidth2 - i15) - rect.right, 2.0f) + rect.left;
        } else {
            c10 = 0;
            float measuredWidth3 = photoViewer.f30953g0.getMeasuredWidth() / layoutParams.width;
            ...
            v9 = com.google.android.gms.internal.vision.e2.v(layoutParams.width, f7, photoViewer.f30953g0.getMeasuredWidth(), 2.0f);
            photoViewer.f30914b6 = 0.0f;
            photoViewer.f30951f6 = 0.0f;
        }
        dv0 dv0Var = this.d;
        int abs = (int) Math.abs(this.f33669c - dv0Var.f33134a.getImageX());
        float imageY = dv0Var.f33134a.getImageY();
        float f16 = this.e;
        int abs2 = (int) Math.abs(f16 - imageY);
        if (dv0Var.f33134a.isAspectFit()) {
            abs = 0;
        }
        int[] iArr = new int[2];
        dv0Var.d.getLocationInWindow(iArr);
        float f17 = dv0Var.f33136c + f16;
        int i19 = (int) ((iArr[1] - f17) + dv0Var.f33140j);
        if (i19 < 0) {
            i19 = 0;
        }
        int height = (int) (((f17 + layoutParams.height) - (dv0Var.d.getHeight() + i12)) + dv0Var.f33139i);
        if (height < 0) {
            height = 0;
        }
        int max = Math.max(i19, abs2);
        int max2 = Math.max(height, abs2);
        fArr[c10][c10] = photoViewer.f30962h0.getScaleX();
        fArr[c10][1] = photoViewer.f30962h0.getScaleY();
        fArr[c10][2] = photoViewer.f30962h0.getTranslationX();
        fArr[c10][3] = photoViewer.f30962h0.getTranslationY();
        float[] fArr2 = fArr[c10];
        float f18 = abs;
        float f19 = dv0Var.f33141k;
        int i20 = 3;
        fArr2[4] = f18 * f19;
        fArr2[5] = max * f19;
        fArr2[6] = max2 * f19;
        int[] radius = photoViewer.f30962h0.getRadius();
        ...
        g90 g90Var = new g90(this, clippingImageViewArr, this.h, this.f33671n, this.f33670f, 15);
        photoViewer.f31035p4 = g90Var;
        if (!photoViewer.f30998l2) {
            ...
            for (int i23 = 0; i23 < clippingImageViewArr.length; i23++) {
                ObjectAnimator ofFloat = ObjectAnimator.ofFloat(clippingImageViewArr[i23], org.telegram.ui.Components.q6.f27262f, 0.0f, 1.0f);
                if (i23 == 0) {
            ...
            if (clippingImageViewArr.length > 1) {
                arrayList.add(ObjectAnimator.ofFloat(photoViewer.f30962h0, View.ALPHA, 0.0f, 1.0f));
            }
            ...
            arrayList.add(ObjectAnimator.ofFloat(photoViewer.f30980j0, property, 0.0f, 1.0f));
            if (photoViewer.f30920c2 == 1) {
            ...
            photoViewer.f30936e0.setLayerType(2, null);
            photoViewer.y2(false);
            photoViewer.f31026o4 = System.currentTimeMillis();
