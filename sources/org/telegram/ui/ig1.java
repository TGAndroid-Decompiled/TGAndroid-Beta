...
public final class ig1 implements org.telegram.ui.Components.al0 {
    ...
    public final void d(int i10, View view) {
        ...
        if (((kg1) arrayList.get(i10)).f15543a == 4) {
            ...
            alertDialog$Builder.f18446a.R = LocaleController.getString(R.string.NotificationsDeleteAllExceptionTitle);
            alertDialog$Builder.f18446a.T = LocaleController.getString(R.string.NotificationsDeleteAllExceptionAlert);
