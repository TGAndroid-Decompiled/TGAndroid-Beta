...
public final class zy extends org.telegram.ui.ActionBar.j {
    ...
    public final void b(int i10) {
        int i11;
        fz fzVar = this.f40354a;
        int i12 = fzVar.f33799w;
        ArrayList arrayList = fzVar.e;
        int i13 = fzVar.f33800x;
        if (i10 == -1) {
            if (fzVar.f33801y == null) {
                fzVar.Y();
            } else {
            ...
            y0 y0Var = fzVar.f33801y;
            if (y0Var != null) {
                int i15 = y0Var.f39740a;
                Object obj = y0Var.f39741b;
                switch (i15) {
                    case 26:
