...
public final class zy extends org.telegram.ui.ActionBar.m2 {
    public wy f40593a;
    public org.telegram.ui.Components.xl0 f40594b;
    public s4.y f40595c;
    public ImageView d;
    ...
    public static void U(zy zyVar, Context context, int i10) {
        ...
        if (i10 == zyVar.h) {
            org.telegram.ui.Components.n70 n70Var = new org.telegram.ui.Components.n70(context, zyVar.currentAccount, null, 0L, zyVar, null);
            n70Var.Y(new du(zyVar, 5));
            n70Var.Z(arrayList);
            zyVar.showDialog(n70Var);
        }
    }
    ...
    public final View createView(Context context) {
        ...
        this.f40593a = new wy(this, context);
        ...
        this.f40594b.setVerticalScrollBarEnabled(false);
        this.f40594b.setAdapter(this.f40593a);
        ((s4.j) this.f40594b.getItemAnimator()).C = false;
        frameLayout.addView(this.f40594b, w7.y5.c(-1.0f, -1));
        s4.y yVar = new s4.y(new xy(this));
        this.f40595c = yVar;
        yVar.e(this.f40594b);
        this.f40594b.setOnItemClickListener(new ai.n6(16, this, context));
        this.f40594b.setOnItemLongClickListener(new vy(this));
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f40594b, 16, new Class[]{org.telegram.ui.Cells.r8.class}, null, null, null, org.telegram.ui.ActionBar.h6.f19059d6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f40594b, 32768, null, null, null, null, i10));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f40594b, 4096, null, null, null, null, org.telegram.ui.ActionBar.h6.f19148i6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f40594b, 0, new Class[]{View.class}, org.telegram.ui.ActionBar.h6.f19180k0, null, null, org.telegram.ui.ActionBar.h6.f19060d7));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f40594b, 32, new Class[]{org.telegram.ui.Cells.e9.class}, null, null, null, org.telegram.ui.ActionBar.h6.f19023b7));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f40594b, 0, new Class[]{org.telegram.ui.Cells.e9.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.B6));
        int i11 = org.telegram.ui.ActionBar.h6.q6;
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f40594b, 0, new Class[]{org.telegram.ui.Cells.r8.class}, new String[]{"textView"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f40594b, 0, new Class[]{org.telegram.ui.Cells.r8.class}, new String[]{"imageView"}, null, null, -1, null, i11));
        return arrayList;
    }
