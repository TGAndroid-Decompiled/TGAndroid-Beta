        ...
        switch (this.f39258a) {
            case 0:
                ...
                if (uyVar.a4() && (arrayList = uyVar.D2) != null && !arrayList.isEmpty() && uyVar.getParentActivity() != null) {
                    ...
                    PhotoViewer.t1().f31282p7 = true;
                    PhotoViewer.t1().f31290q7 = charSequence;
            ...
            case 5:
                ...
                return;
            case 6:
                this.f39259b.b4(true);
                return;
            case 7:
                this.f39259b.finishPreviewFragment();
                return;
            case 8:
                uy uyVar7 = this.f39259b;
                uyVar7.f38253z0.setIsEditing(false);
                uyVar7.I4(false);
                return;
            case 9:
                uy uyVar8 = this.f39259b;
                uyVar8.getClass();
                uyVar8.showDialog(new rg.x0((org.telegram.ui.ActionBar.n2) uyVar8, 2, true));
                return;
            case 10:
                uy uyVar9 = this.f39259b;
                uyVar9.getContactsController().loadGlobalPrivacySetting();
                uyVar9.K4();
                return;
            case 11:
                this.f39259b.p4(view);
                return;
            case 12:
                uy.t0(this.f39259b);
                return;
            ...
            case 14:
                ...
                return;
            case 15:
                uy uyVar10 = this.f39259b;
                uyVar10.showDialog(org.telegram.ui.Components.e5.m(uyVar10.getParentActivity(), LocaleController.getString(R.string.EditProfileBirthdayTitle), LocaleController.getString(R.string.EditProfileBirthdayButton), null, new zv(uyVar10, 1), new qv(uyVar10, 17), false, false, uyVar10.getResourceProvider()).f18627a);
                return;
            case 16:
                uy.C0(this.f39259b);
                return;
            ...
            case 18:
                ...
                premiumPreviewFragment.f31412j0 = true;
                uy uyVar11 = this.f39259b;
