...
public final class wv implements DialogInterface.OnClickListener {
    ...
    public final NotificationCenter.NotificationCenterDelegate f39182b;

    public wv(NotificationCenter.NotificationCenterDelegate notificationCenterDelegate, int i10) {
        this.f39181a = i10;
        this.f39182b = notificationCenterDelegate;
    }
    ...
    public final void onClick(DialogInterface dialogInterface, int i10) {
        ...
        switch (this.f39181a) {
            case 0:
                wy wyVar = (wy) this.f39182b;
                if (i10 == 0) {
                    wyVar.getMessagesStorage().readAllDialogs(1);
                    return;
                } else if (i10 != 1 || wyVar.f39221e0 == null) {
                    return;
                } else {
                    while (true) {
                        ...
                        if (i11 < vyVarArr.length) {
                            ...
                            if (vyVar.f38533s == 0 && vyVar.getVisibility() == 0) {
                                org.telegram.ui.Cells.r2 Q3 = wy.Q3(wyVar.f39221e0[i11]);
                                sy syVar = wyVar.f39221e0[i11].f38527a;
                                int i12 = sy.f37572v3;
                                syVar.A1(true, Q3);
                            }
                            i11++;
