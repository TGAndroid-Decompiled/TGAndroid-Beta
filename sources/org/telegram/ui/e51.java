...
public final class e51 extends FrameLayout {
    public final Paint f33243a;
    public final Paint f33244b;
    public final RectF f33245c;
    public final org.telegram.ui.Components.n21 d;
    public boolean e;
    public long f33246f;
    public long h;
    public final org.telegram.ui.Components.kj0 f33247n;
    public final TextPaint f33248r;
    public StaticLayout f33249s;
    public float v;
    public float f33250w;
    public final SecretMediaViewer f33251x;

    public e51(SecretMediaViewer secretMediaViewer, Activity activity) {
        super(activity);
        this.f33251x = secretMediaViewer;
        this.f33245c = new RectF();
        this.d = new org.telegram.ui.Components.n21();
        this.f33248r = new TextPaint(1);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float max;
        MessageObject messageObject = this.f33251x.f31759h0;
        if (messageObject != null) {
            ...
            if (message.destroyTime != 0 || message.ttl == Integer.MAX_VALUE) {
                if (this.f33246f == 0) {
                    ...
                    max = ((float) Math.max(0L, this.f33246f - (System.currentTimeMillis() + (ConnectionsManager.getInstance(secretMediaViewer.f31741a).getTimeDifference() * 1000)))) / (((float) this.h) * 1000.0f);
                }
                boolean z10 = this.e;
                Paint paint = this.f33244b;
                Paint paint2 = this.f33243a;
                float f7 = max;
                RectF rectF = this.f33245c;
                if (z10) {
                    canvas.save();
                    canvas.translate(rectF.centerX() - (this.v / 2.0f), rectF.centerY() - (this.f33250w / 2.0f));
                    this.f33249s.draw(canvas);
                    canvas.restore();
                    ...
                    org.telegram.ui.Components.kj0 kj0Var = this.f33247n;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f33245c.set(measuredWidth - dpf2, measuredHeight - dpf2, measuredWidth + dpf2, dpf2 + measuredHeight);
