...
public final class e51 extends FrameLayout {
    ...
    public boolean d;
    public int e;
    public final o1.j f33286f;
    public final o1.k h;
    public final s0 f33287n;
    public final SecretMediaViewer f33288r;

    public e51(SecretMediaViewer secretMediaViewer, Activity activity) {
        super(activity);
        this.f33288r = secretMediaViewer;
        this.f33283a = 1.0f;
        this.f33284b = true;
        this.f33285c = true;
        ...
        this.h = kVar;
        this.f33287n = new s0("progress", 6);
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        SecretMediaViewer secretMediaViewer = this.f33288r;
        c51 c51Var = secretMediaViewer.f31503y;
        if (c51Var != null) {
            f7 = ((float) c51Var.n()) / ((float) secretMediaViewer.f31503y.p());
        } else {
            f7 = 0.0f;
        }
