...
public final class e51 extends FrameLayout {
    public final Paint f33223a;
    public final Paint f33224b;
    public final RectF f33225c;
    public final org.telegram.ui.Components.l21 d;
    public boolean e;
    public long f33226f;
    public long h;
    public final org.telegram.ui.Components.hj0 f33227n;
    public final TextPaint f33228r;
    public StaticLayout f33229s;
    public float v;
    public float f33230w;
    public final SecretMediaViewer f33231x;

    public e51(SecretMediaViewer secretMediaViewer, Activity activity) {
        super(activity);
        this.f33231x = secretMediaViewer;
        this.f33225c = new RectF();
        this.d = new org.telegram.ui.Components.l21();
        this.f33228r = new TextPaint(1);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float max;
        MessageObject messageObject = this.f33231x.f31738h0;
        if (messageObject != null) {
            ...
            if (message.destroyTime != 0 || message.ttl == Integer.MAX_VALUE) {
                if (this.f33226f == 0) {
                    ...
                    max = ((float) Math.max(0L, this.f33226f - (System.currentTimeMillis() + (ConnectionsManager.getInstance(secretMediaViewer.f31720a).getTimeDifference() * 1000)))) / (((float) this.h) * 1000.0f);
                }
                boolean z10 = this.e;
                Paint paint = this.f33224b;
                Paint paint2 = this.f33223a;
                float f7 = max;
                RectF rectF = this.f33225c;
                if (z10) {
                    canvas.save();
                    canvas.translate(rectF.centerX() - (this.v / 2.0f), rectF.centerY() - (this.f33230w / 2.0f));
                    this.f33229s.draw(canvas);
                    canvas.restore();
                    ...
                    org.telegram.ui.Components.hj0 hj0Var = this.f33227n;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f33225c.set(measuredWidth - dpf2, measuredHeight - dpf2, measuredWidth + dpf2, dpf2 + measuredHeight);
