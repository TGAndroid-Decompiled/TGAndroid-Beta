...
public final class kc0 implements org.telegram.ui.ActionBar.q0, org.telegram.ui.ActionBar.z1, IMapsProvider.OnCameraMoveStartedListener, gg.b, IMapsProvider.ITouchInterceptor {
    ...
    public void a(ArrayList arrayList) {
        switch (this.f35032a) {
            case 5:
                cd0 cd0Var = this.f35033b;
                ArrayList arrayList2 = cd0Var.f32670k0;
                if (arrayList != null) {
                    int size = arrayList2.size();
                    for (int i10 = 0; i10 < size; i10++) {
                        ((bd0) arrayList2.get(i10)).f32392b.remove();
                    }
                    arrayList2.clear();
                    ...
                    for (int i11 = 0; i11 < size2; i11++) {
                        ...
                        try {
                            ...
                            obj.f32392b = addMarker;
                            obj.f32393c = tL_messageMediaVenue;
                ...
                return;
            default:
                cd0 cd0Var2 = this.f35033b;
                cd0Var2.f32681t0 = false;
                cd0Var2.B0();
                return;
        }
    }
    ...
    public void m(int i10) {
        IMapsProvider.IMap iMap = this.f35033b.I;
        if (iMap != null) {
            if (i10 == 2) {
                iMap.setMapType(0);
            } else if (i10 == 3) {
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent, IMapsProvider.ICallableMethod iCallableMethod) {
        ...
        switch (i10) {
            case 6:
                ...
                return booleanValue;
            default:
                if (cd0Var.B0 == null && cd0Var.f32690z0 == null) {
                    if (motionEvent.getAction() == 0) {
                        AnimatorSet animatorSet = cd0Var.f32671l0;
                        if (animatorSet != null) {
                            animatorSet.cancel();
                        }
                        AnimatorSet animatorSet2 = new AnimatorSet();
                        cd0Var.f32671l0 = animatorSet2;
                        animatorSet2.setDuration(200L);
                        cd0Var.f32671l0.playTogether(ObjectAnimator.ofFloat(cd0Var.X, View.TRANSLATION_Y, cd0Var.f32689y0 - AndroidUtilities.dp(10.0f)));
                        cd0Var.f32671l0.start();
                    } else if (motionEvent.getAction() == 1) {
                        AnimatorSet animatorSet3 = cd0Var.f32671l0;
                        if (animatorSet3 != null) {
                            animatorSet3.cancel();
                        }
                        cd0Var.N = 0.0f;
                        AnimatorSet animatorSet4 = new AnimatorSet();
                        cd0Var.f32671l0 = animatorSet4;
                        animatorSet4.setDuration(200L);
                        cd0Var.f32671l0.playTogether(ObjectAnimator.ofFloat(cd0Var.X, View.TRANSLATION_Y, cd0Var.f32689y0));
                        cd0Var.f32671l0.start();
                        cd0Var.T.I();
                    }
                    if (motionEvent.getAction() == 2) {
                        ...
                        if (iMap != null && (location = cd0Var.f32687x0) != null) {
                            location.setLatitude(iMap.getCameraPosition().target.latitude);
                            cd0Var.f32687x0.setLongitude(cd0Var.I.getCameraPosition().target.longitude);
                        }
