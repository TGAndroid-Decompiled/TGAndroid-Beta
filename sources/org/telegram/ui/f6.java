...
public final class f6 implements Runnable {
    ...
    public final void run() {
        ...
        switch (this.f33554a) {
            case 0:
                a7 a7Var = this.f33555b;
                ArrayList<Long> arrayList = this.f33556c;
                ArrayList arrayList2 = this.d;
                ArrayList arrayList3 = this.e;
                zh.b bVar = this.f33557f;
                ...
                while (i10 < arrayList3.size()) {
                    if (((t6) arrayList3.get(i10)).f37669c <= 0) {
                ...
                return;
            default:
                a7 a7Var2 = this.f33555b;
                ArrayList<TLRPC.User> arrayList6 = this.f33556c;
                ArrayList<TLRPC.Chat> arrayList7 = this.d;
                ArrayList arrayList8 = this.e;
                zh.b bVar2 = this.f33557f;
                ...
                while (i11 < arrayList8.size()) {
                    ...
                    if (a7Var2.getMessagesController().getUserOrChat(t6Var2.f37667a) == null) {
                        t6Var2.f37667a = Long.MAX_VALUE;
                        if (t6Var != null) {
                            ...
                            while (true) {
                                ...
                                if (i12 < sparseArray2.size()) {
                                    ...
                                    u6Var.getClass();
                                    t6 t6Var3 = t6Var;
                                    u6Var2.f37943a += u6Var.f37943a;
                                    t6Var3.f37669c += u6Var.f37943a;
                                    u6Var2.f37944b.addAll(u6Var.f37944b);
                                    i12++;
                                    t6Var = t6Var3;
                                    z12 = false;
                                } else {
                                    t6Var.f37668b += t6Var2.f37668b;
                ...
                bVar2.f49223b = arrayList8;
                LongSparseArray longSparseArray = bVar2.f49224c;
                ...
                while (i13 < size) {
                    ...
                    i13++;
                    t6 t6Var4 = (t6) obj;
                    longSparseArray.put(t6Var4.f37667a, t6Var4);
                }
                if (!a7.f31728l0) {
                    a7Var2.f31737c0 = bVar2;
                    x6 x6Var = a7Var2.M;
                    if (x6Var != null) {
