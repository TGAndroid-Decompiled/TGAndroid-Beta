...
public final class uy0 implements org.telegram.ui.Components.ll0 {
    public int f42065a = 0;
    public final Context f42066b;
    public final ProfileActivity f42067c;

    public uy0(ProfileActivity profileActivity, Context context) {
        this.f42067c = profileActivity;
    ...
    public static void a(uy0 uy0Var, Context context, int i10) {
        ...
        int i20 = 0;
        if (i10 == 0) {
            uy0Var.f42067c.getUserConfig().syncContacts = true;
            uy0Var.f42067c.getUserConfig().saveConfig(false);
            uy0Var.f42067c.getContactsController().forceImportContacts();
            return;
        }
        long j11 = 0;
        if (i10 == 1) {
            uy0Var.f42067c.getContactsController().loadContacts(false, 0L);
        } else if (i10 == 2) {
            uy0Var.f42067c.getContactsController().resetImportedContacts();
        } else if (i10 == 3) {
            uy0Var.f42067c.getMessagesController().forceResetDialogs();
        } else if (i10 == 4) {
            ...
            uy0Var.f42067c.getMessagesStorage().clearSentMedia();
            ...
            k7.b6.a();
            i15 = ((org.telegram.ui.ActionBar.p2) uy0Var.f42067c).currentAccount;
            ...
            i16 = ((org.telegram.ui.ActionBar.p2) uy0Var.f42067c).currentAccount;
            ChatThemeController.getInstance(i16).clearCache();
            uy0Var.f42067c.getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.newSuggestionsAvailable, new Object[0]);
            p31.W();
            i17 = ((org.telegram.ui.ActionBar.p2) uy0Var.f42067c).currentAccount;
            dg.e1.e(i17).a();
            SharedPreferences mainSettings = uy0Var.f42067c.getMessagesController().getMainSettings();
            ...
            edit.apply();
            i18 = ((org.telegram.ui.ActionBar.p2) uy0Var.f42067c).currentAccount;
            SharedPreferences.Editor edit2 = MessagesController.getNotificationsSettings(i18).edit();
            i19 = ((org.telegram.ui.ActionBar.p2) uy0Var.f42067c).currentAccount;
            ...
            org.telegram.ui.Components.voip.g2.j(uy0Var.f42067c.getParentActivity());
        } else if (i10 == 8) {
            SharedConfig.toggleRoundCamera16to9();
        } else if (i10 == 9) {
            ((LaunchActivity) uy0Var.f42067c.getParentActivity()).z(true);
        } else if (i10 == 10) {
            uy0Var.f42067c.getMessagesStorage().readAllDialogs(-1);
        } else if (i10 == 11) {
            ...
            Set<String> set = uy0Var.f42067c.getMessagesController().pendingSuggestions;
            ...
            try {
                if (i10 == 14) {
                    ...
                    Activity parentActivity = uy0Var.f42067c.getParentActivity();
                    ...
                    bb.a.a((LaunchActivity) uy0Var.f42067c.getParentActivity(), !SharedConfig.isFloatingDebugActive, true);
                } else if (i10 == 19) {
                    uy0Var.f42067c.getMessagesController().loadAppConfig();
                    TLRPC.TL_help_dismissSuggestion tL_help_dismissSuggestion = new TLRPC.TL_help_dismissSuggestion();
                    tL_help_dismissSuggestion.suggestion = "VALIDATE_PHONE_NUMBER";
                    tL_help_dismissSuggestion.peer = new TLRPC.TL_inputPeerEmpty();
                    uy0Var.f42067c.getConnectionsManager().sendRequest(tL_help_dismissSuggestion, new ry0(uy0Var, 0));
                } else if (i10 == 20) {
                    ...
                    ProfileActivity.S0(uy0Var.f42067c, "video/avc", sb2);
                    ProfileActivity.S0(uy0Var.f42067c, "video/hevc", sb2);
                    ProfileActivity.S0(uy0Var.f42067c, "video/x-vnd.on2.vp8", sb2);
                    ProfileActivity.S0(uy0Var.f42067c, "video/x-vnd.on2.vp9", sb2);
                    uy0Var.f42067c.showDialog(new ty0(uy0Var, uy0Var.f42067c.getParentActivity(), sb2.toString()));
                } else if (i10 == 21) {
                    AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(uy0Var.f42067c.getParentActivity(), 0, uy0Var.f42067c.f34714w0);
                    ...
                    alertDialog$Builder.f(new CharSequence[]{replaceTags, replaceTags2, AndroidUtilities.replaceTags(str5.concat(str8))}, new sy0(measureDevicePerformanceClass, 0));
                    alertDialog$Builder.h(LocaleController.getString("Cancel", R.string.Cancel), null);
                    alertDialog$Builder.o();
                } else if (i10 == 22) {
                    SharedConfig.toggleRoundCamera();
                } else if (i10 == 23) {
                    boolean q10 = qh.v0.q(uy0Var.f42067c.getParentActivity());
                    MessagesController.getGlobalMainSettings().edit().putBoolean("dual_available", !q10).apply();
                    Activity parentActivity2 = uy0Var.f42067c.getParentActivity();
                    if (!q10) {
                    ...
                    while (i20 < uy0Var.f42067c.getParentLayout().getFragmentStack().size()) {
                        ((org.telegram.ui.ActionBar.p2) uy0Var.f42067c.getParentLayout().getFragmentStack().get(i20)).clearSheets();
                        i20++;
                    }
                } else if (i10 == 25) {
                    ...
                    uy0Var.f42067c.getMediaDataController().loadAttachMenuBots(false, true);
                } else if (i10 == 28) {
                    i12 = ((org.telegram.ui.ActionBar.p2) uy0Var.f42067c).currentAccount;
                    ...
                    i11 = ((org.telegram.ui.ActionBar.p2) uy0Var.f42067c).currentAccount;
    ...
    public final boolean f(int r46, android.view.View r47) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.uy0.f(int, android.view.View):boolean");
    }
}
