...
public final class uy0 implements e2.h {
    ...
    public final ProfileActivity f38249b;

    public uy0(ProfileActivity profileActivity, int i10) {
        this.f38248a = i10;
        this.f38249b = profileActivity;
    }
        ...
        switch (this.f38248a) {
            case 0:
                if (view instanceof org.telegram.ui.Cells.c9) {
                    ...
                    vh.o oVar = c9Var.f19891a;
                    ProfileActivity profileActivity = this.f38249b;
                    oVar.setLoading(profileActivity.f31319i5);
                    c9Var.f19892b.setLoading(profileActivity.f31319i5);
                    return;
                }
                return;
            default:
                boolean z10 = view instanceof org.telegram.ui.Cells.l4;
                ProfileActivity profileActivity2 = this.f38249b;
                if (z10) {
                    ((org.telegram.ui.Cells.l4) view).setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.L6, profileActivity2.f31429z0));
                    ...
                    int i10 = org.telegram.ui.ActionBar.j6.f19065o6;
                ...
                profileActivity2.f31255a.getClass();
                RecyclerView.S(view);
                b11Var.getClass();
