...
public final class ag0 extends org.telegram.ui.Components.uv0 {
    ...
    public final ci.d f31786b;
    public final yh.r[] f31787c;
    public Bundle d;
    public String e;
    ...
    public ag0(rg0 rg0Var, Context context) {
        ...
        canvas.drawColor(i0.a.d(0.5f, org.telegram.ui.ActionBar.h6.w0(null, i11, false), org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f18859h5, false)));
        zf0Var.setBackgroundBitmap(createBitmap);
        sg.a aVar = zf0Var.f42889b;
        aVar.f42877w = i11;
        aVar.f42878x = org.telegram.ui.ActionBar.h6.Lj;
        aVar.b();
    ...
    public static void o(ag0 ag0Var, String str, String str2, String str3) {
        String str4;
        ...
        try {
            ...
            if (Build.VERSION.SDK_INT >= 29) {
                try {
                    ConnectivityManager connectivityManager = (ConnectivityManager) ag0Var.getContext().getSystemService(ConnectivityManager.class);
                    SignalStrength signalStrength = ((TelephonyManager) ag0Var.getContext().getSystemService(TelephonyManager.class)).getSignalStrength();
    ...
    public final void g() {
        ...
        if (this.f31791s >= 0) {
            ...
            ConnectionsManager.getInstance(i10).cancelRequest(this.f31791s, true);
            this.f31791s = -1;
        }
        this.f31788f = false;
        this.f31786b.setLoading(false);
    }
    ...
    public final void m(Bundle bundle, boolean z10) {
        ...
        yh.r[] rVarArr = this.f31787c;
        if (isEmpty) {
            rVarArr[0].f47626c.setText(LocaleController.getString(R.string.SMSFee1Text));
        } else {
            rVarArr[0].f47626c.setText(LocaleController.formatString(R.string.SMSFee1TextCountry, countryName));
        }
        yh.r rVar = rVarArr[2];
        if (i10 == 7) {
        ...
        this.f31785a.setOnClickListener(new ai.o5(this, string5, string6, string3, 14));
        ci.d dVar = this.f31786b;
    ...
    public final void p() {
        ...
        tL_checkPaidAuth.form_id = this.f31790r;
        tL_checkPaidAuth.phone_number = this.h;
        tL_checkPaidAuth.phone_code_hash = this.f31789n;
        i10 = ((org.telegram.ui.ActionBar.n2) this.v).currentAccount;
        this.f31791s = ConnectionsManager.getInstance(i10).sendRequest(tL_checkPaidAuth, new m(this, 14), 1096);
    }
}
