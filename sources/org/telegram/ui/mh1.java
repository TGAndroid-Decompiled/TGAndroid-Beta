...
public final class mh1 implements Utilities.Callback {
    ...
    public final UserInfoActivity f38741b;

    public mh1(UserInfoActivity userInfoActivity, int i10) {
        this.f38740a = i10;
        this.f38741b = userInfoActivity;
    }
    ...
    public final void run(Object obj) {
        switch (this.f38740a) {
            case 0:
                UserInfoActivity userInfoActivity = this.f38741b;
                userInfoActivity.J = (TL_account.TL_birthday) obj;
                org.telegram.ui.Components.x51 x51Var = userInfoActivity.f34262x;
                if (x51Var != null) {
                    x51Var.Y2.N(true);
                }
            ...
            default:
                ...
                UserInfoActivity userInfoActivity2 = this.f38741b;
                if (userInfoActivity2.K != chat) {
                    ...
                    org.telegram.ui.Components.x51 x51Var2 = userInfoActivity2.f34262x;
                    if (x51Var2 != null) {
                        x51Var2.Y2.N(true);
                        return;
                    }
