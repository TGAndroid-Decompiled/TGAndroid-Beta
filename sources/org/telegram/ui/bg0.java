...
public final class bg0 extends org.telegram.ui.Components.vv0 implements NotificationCenter.NotificationCenterDelegate {
    public static final int f32128t0 = 0;
    ...
    public int V;
    public int W;
    public final org.telegram.ui.Components.yi0 f32129a;
    public double f32130a0;
    public String f32131b;
    public double f32132b0;
    public String f32133c;
    public boolean f32134c0;
    public String d;
    public boolean f32135d0;
    public String e;
    public String f32136e0;
    public final fs f32137f;
    public final int f32138f0;
    public int f32139g0;
    public final org.telegram.ui.Components.voip.n2 h;
    public int f32140h0;
    public boolean f32141i0;
    public String f32142j0;
    public String f32143k0;
    public String f32144l0;
    public int m0;
    public final TextView f32145n;
    public String f32146n0;
    public Bundle f32147o0;
    public TLRPC.TL_auth_sentCode f32148p0;
    public boolean f32149q0;
    public final TextView f32150r;
    public final of0 f32151r0;
    public final org.telegram.ui.Components.bj0 f32152s;
    public final yg0 f32153s0;
    public final zf0 v;
    public final he0 f32154w;
    public final zf0 f32155x;
    public final FrameLayout f32156y;
    ...
    public static void o(bg0 bg0Var, Context context) {
        ...
        try {
            ...
            sb3.append(str3);
            sb3.append("\n");
            if (!TextUtils.isEmpty(bg0Var.f32136e0)) {
                sb3.append("Error: ");
                sb3.append(bg0Var.f32136e0);
                sb3.append("\n");
            }
            sb3.append("\n\n================================================\n");
            ...
            bg0Var.f32153s0.l1(LocaleController.getString(R.string.AppName), LocaleController.getString("NoMailInstalled", R.string.NoMailInstalled));
        }
    }
    ...
    public final void A(int i10) {
        ...
        if (yi0Var != null) {
            ...
            this.Q = true;
            org.telegram.ui.Components.yi0 yi0Var2 = this.f32129a;
            if (yi0Var2.f30221b0 != yi0Var2.e[0] - 1) {
                yi0Var2.f30244u0 = new uf0(this, i10, 0);
                return;
            }
            yi0Var.f30244u0 = new of0(this, 3);
            org.telegram.ui.Components.bj0 bj0Var = this.f32152s;
    ...
    public final boolean c(boolean z10) {
        int i10;
        yg0 yg0Var = this.f32153s0;
        if (yg0Var.F != 0) {
            yg0Var.finishFragment();
            return false;
        }
        int i11 = this.f32140h0;
        if (i11 != 0) {
            ...
            c2Var.R = string;
            c2Var.T = AndroidUtilities.replaceTags(LocaleController.formatString("EditNumberInfo", R.string.EditNumberInfo, this.f32131b));
            ...
            tL_auth_cancelCode.phone_code_hash = this.f32133c;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (this.f32134c0) {
            fs fsVar = this.f32137f;
            if (fsVar.f33749f != null) {
                if (i10 == NotificationCenter.didReceiveSmsCode) {
                    fsVar.setText("" + objArr[0]);
                    h(null);
                } else if (i10 == NotificationCenter.didReceiveCall) {
                    String str = "" + objArr[0];
                    if (AndroidUtilities.checkPhonePattern(this.f32142j0, str)) {
                        if (!this.f32142j0.equals("*")) {
                            this.f32144l0 = str;
    ...
    public final void g() {
        ...
        this.f32141i0 = false;
        this.f32135d0 = false;
        if (this.f32140h0 != 0 && (bundle = this.H) != null) {
    ...
    public final void h(String str) {
        ...
        int i12;
        yg0 yg0Var = this.f32153s0;
        int i13 = yg0Var.f39883a;
        if (i13 == 11) {
            if (this.f32135d0) {
                return;
            }
        } else if (!this.f32135d0) {
        ...
        int i15 = yg0Var.f39883a;
        if (i15 < 1 || i15 > 4 || !fsVar.e) {
            this.f32135d0 = true;
            int i16 = this.f32138f0;
            if (i16 == 15) {
                NotificationCenter.getGlobalInstance().removeObserver(this, NotificationCenter.didReceiveSmsCode);
            } else if (i16 == 2) {
                AndroidUtilities.setWaitingForSms(false);
            ...
            if (i17 != 1) {
                if (i17 != 2) {
                    ...
                    tL_auth_signIn.phone_code_hash = this.f32133c;
                ...
                changephone.phone_code_hash = this.f32133c;
                w();
                fsVar.e = true;
            ...
            confirmphone.phone_code_hash = this.f32133c;
            w();
            fsVar.e = true;
            is[] isVarArr3 = fsVar.f33749f;
    ...
    @Override
    public final void j() {
        org.telegram.ui.Components.yi0 yi0Var = this.f32129a;
        if (yi0Var != null) {
            yi0Var.M(0);
        }
        AndroidUtilities.runOnUIThread(new of0(this, 0), yg0.f39882t0);
    }
    ...
    public final void l(Bundle bundle) {
        String code = this.f32137f.getCode();
        int length = code.length();
        int i10 = this.f32138f0;
        if (length != 0) {
            bundle.putString("smsview_code_" + i10, code);
        }
        String str = this.f32144l0;
        if (str != null) {
    ...
    public final void n() {
        ...
        if (i12 == 11) {
            ...
            int w03 = org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19008l6, false);
        ...
        if (i12 != 15) {
            this.f32155x.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.q6, false));
        }
        this.E.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19100q7, false));
    }
    ...
    public final void onConfigurationChanged(Configuration configuration) {
        ...
        fs fsVar = this.f32137f;
        if (fsVar != null && (isVarArr = fsVar.f33749f) != null) {
            for (is isVar : isVarArr) {
                ...
                isVar.setShowSoftInputOnFocusCompat(z10);
            }
        }
    }
    ...
    public final void q(Runnable runnable) {
        ...
        while (true) {
            ...
            if (i10 < isVarArr.length) {
                ...
                fsVar.postDelayed(new oa0(20, this, runnable), (isVarArr.length * 75) + 400);
                return;
            }
        }
    }
    ...
    public final void s() {
        ...
        this.S = new Timer();
        this.f32132b0 = System.currentTimeMillis();
    ...
    public final void x() {
        int i10;
        if (!this.f32135d0 && !this.f32141i0) {
            yg0 yg0Var = this.f32153s0;
            if (!yg0Var.f39901o0) {
                this.f32141i0 = true;
                this.v.invalidate();
                this.f32155x.invalidate();
                Bundle bundle = new Bundle();
                bundle.putString("phone", this.f32131b);
                bundle.putString("ephone", this.e);
                bundle.putString("phoneFormated", this.d);
                bundle.putInt("prevType", this.f32138f0);
                this.f32135d0 = true;
                TLRPC.TL_auth_resendCode tL_auth_resendCode = new TLRPC.TL_auth_resendCode();
                tL_auth_resendCode.phone_number = this.d;
                tL_auth_resendCode.phone_code_hash = this.f32133c;
                i10 = ((org.telegram.ui.ActionBar.o2) yg0Var).currentAccount;
    ...
    public final void y() {
        ...
        while (true) {
            ...
            fsVar.f33749f[i10].i(1.0f);
            i10++;
        }
        he0 he0Var = this.f32154w;
        if (he0Var.getCurrentView() != this.E) {
            he0Var.showNext();
        }
        fsVar.f33749f[0].requestFocus();
        if (this.f32138f0 == 11) {
            f7 = 3.5f;
        } else {
            f7 = 10.0f;
        }
        AndroidUtilities.shakeViewSpring(fsVar, f7, new of0(this, 7));
        of0 of0Var = this.f32151r0;
    ...
    public final void z(boolean z10) {
        if (this.N != null) {
            ...
            this.Q = false;
            this.f32152s.setAutoRepeat(false);
            org.telegram.ui.Components.yi0 yi0Var = this.O;
            yi0Var.K(0);
            yi0Var.R(yi0Var.e[0] - 1, new of0(this, 1));
            return;
        }
        this.f32153s0.k1(z10, true);
    }
}
