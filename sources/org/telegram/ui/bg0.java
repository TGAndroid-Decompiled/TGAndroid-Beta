...
public final class bg0 extends org.telegram.ui.Components.vv0 implements NotificationCenter.NotificationCenterDelegate {
    public static final int f32132t0 = 0;
    ...
    public int V;
    public int W;
    public final org.telegram.ui.Components.yi0 f32133a;
    public double f32134a0;
    public String f32135b;
    public double f32136b0;
    public String f32137c;
    public boolean f32138c0;
    public String d;
    public boolean f32139d0;
    public String e;
    public String f32140e0;
    public final fs f32141f;
    public final int f32142f0;
    public int f32143g0;
    public final org.telegram.ui.Components.voip.n2 h;
    public int f32144h0;
    public boolean f32145i0;
    public String f32146j0;
    public String f32147k0;
    public String f32148l0;
    public int m0;
    public final TextView f32149n;
    public String f32150n0;
    public Bundle f32151o0;
    public TLRPC.TL_auth_sentCode f32152p0;
    public boolean f32153q0;
    public final TextView f32154r;
    public final of0 f32155r0;
    public final org.telegram.ui.Components.bj0 f32156s;
    public final yg0 f32157s0;
    public final zf0 v;
    public final he0 f32158w;
    public final zf0 f32159x;
    public final FrameLayout f32160y;
    ...
    public static void o(bg0 bg0Var, Context context) {
        ...
        try {
            ...
            sb3.append(str3);
            sb3.append("\n");
            if (!TextUtils.isEmpty(bg0Var.f32140e0)) {
                sb3.append("Error: ");
                sb3.append(bg0Var.f32140e0);
                sb3.append("\n");
            }
            sb3.append("\n\n================================================\n");
            ...
            bg0Var.f32157s0.l1(LocaleController.getString(R.string.AppName), LocaleController.getString("NoMailInstalled", R.string.NoMailInstalled));
        }
    }
    ...
    public final void A(int i10) {
        ...
        if (yi0Var != null) {
            ...
            this.Q = true;
            org.telegram.ui.Components.yi0 yi0Var2 = this.f32133a;
            if (yi0Var2.f30222a0 != yi0Var2.e[0] - 1) {
                yi0Var2.f30246t0 = new uf0(this, i10, 0);
                return;
            }
            yi0Var.f30246t0 = new of0(this, 3);
            org.telegram.ui.Components.bj0 bj0Var = this.f32156s;
    ...
    public final boolean c(boolean z10) {
        int i10;
        yg0 yg0Var = this.f32157s0;
        if (yg0Var.F != 0) {
            yg0Var.finishFragment();
            return false;
        }
        int i11 = this.f32144h0;
        if (i11 != 0) {
            ...
            c2Var.R = string;
            c2Var.T = AndroidUtilities.replaceTags(LocaleController.formatString("EditNumberInfo", R.string.EditNumberInfo, this.f32135b));
            ...
            tL_auth_cancelCode.phone_code_hash = this.f32137c;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (this.f32138c0) {
            fs fsVar = this.f32141f;
            if (fsVar.f33753f != null) {
                if (i10 == NotificationCenter.didReceiveSmsCode) {
                    fsVar.setText("" + objArr[0]);
                    h(null);
                } else if (i10 == NotificationCenter.didReceiveCall) {
                    String str = "" + objArr[0];
                    if (AndroidUtilities.checkPhonePattern(this.f32146j0, str)) {
                        if (!this.f32146j0.equals("*")) {
                            this.f32148l0 = str;
    ...
    public final void g() {
        ...
        this.f32145i0 = false;
        this.f32139d0 = false;
        if (this.f32144h0 != 0 && (bundle = this.H) != null) {
    ...
    public final void h(String str) {
        ...
        int i12;
        yg0 yg0Var = this.f32157s0;
        int i13 = yg0Var.f39888a;
        if (i13 == 11) {
            if (this.f32139d0) {
                return;
            }
        } else if (!this.f32139d0) {
        ...
        int i15 = yg0Var.f39888a;
        if (i15 < 1 || i15 > 4 || !fsVar.e) {
            this.f32139d0 = true;
            int i16 = this.f32142f0;
            if (i16 == 15) {
                NotificationCenter.getGlobalInstance().removeObserver(this, NotificationCenter.didReceiveSmsCode);
            } else if (i16 == 2) {
                AndroidUtilities.setWaitingForSms(false);
            ...
            if (i17 != 1) {
                if (i17 != 2) {
                    ...
                    tL_auth_signIn.phone_code_hash = this.f32137c;
                ...
                changephone.phone_code_hash = this.f32137c;
                w();
                fsVar.e = true;
            ...
            confirmphone.phone_code_hash = this.f32137c;
            w();
            fsVar.e = true;
            is[] isVarArr3 = fsVar.f33753f;
    ...
    @Override
    public final void j() {
        org.telegram.ui.Components.yi0 yi0Var = this.f32133a;
        if (yi0Var != null) {
            yi0Var.M(0);
        }
        AndroidUtilities.runOnUIThread(new of0(this, 0), yg0.f39887t0);
    }
    ...
    public final void l(Bundle bundle) {
        String code = this.f32141f.getCode();
        int length = code.length();
        int i10 = this.f32142f0;
        if (length != 0) {
            bundle.putString("smsview_code_" + i10, code);
        }
        String str = this.f32148l0;
        if (str != null) {
    ...
    public final void n() {
        ...
        this.f32154r.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i11, false));
        int i12 = this.f32142f0;
        if (i12 == 11) {
            ...
            int w03 = org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19009l6, false);
        ...
        if (i12 != 15) {
            this.f32159x.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.q6, false));
        }
        this.E.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19101q7, false));
    }
    ...
    public final void onConfigurationChanged(Configuration configuration) {
        ...
        fs fsVar = this.f32141f;
        if (fsVar != null && (isVarArr = fsVar.f33753f) != null) {
    ...
    public final void s() {
        ...
        this.S = new Timer();
        this.f32136b0 = System.currentTimeMillis();
    ...
    public final void x() {
        int i10;
        if (!this.f32139d0 && !this.f32145i0) {
            yg0 yg0Var = this.f32157s0;
            if (!yg0Var.f39906o0) {
                this.f32145i0 = true;
                this.v.invalidate();
                this.f32159x.invalidate();
                Bundle bundle = new Bundle();
                bundle.putString("phone", this.f32135b);
                bundle.putString("ephone", this.e);
                bundle.putString("phoneFormated", this.d);
                bundle.putInt("prevType", this.f32142f0);
                this.f32139d0 = true;
                TLRPC.TL_auth_resendCode tL_auth_resendCode = new TLRPC.TL_auth_resendCode();
                tL_auth_resendCode.phone_number = this.d;
                tL_auth_resendCode.phone_code_hash = this.f32137c;
                i10 = ((org.telegram.ui.ActionBar.o2) yg0Var).currentAccount;
    ...
    public final void y() {
        ...
        while (true) {
            ...
            fsVar.f33753f[i10].i(1.0f);
            i10++;
        }
        he0 he0Var = this.f32158w;
        if (he0Var.getCurrentView() != this.E) {
            he0Var.showNext();
        }
        fsVar.f33753f[0].requestFocus();
        if (this.f32142f0 == 11) {
            f7 = 3.5f;
        } else {
            f7 = 10.0f;
