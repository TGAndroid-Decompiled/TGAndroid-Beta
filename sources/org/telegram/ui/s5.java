    ...
    public s5(v5 v5Var, Activity activity) {
        ...
        t5Var.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view) {
                ...
                int i10 = r2;
                s5 s5Var = this.f39758b;
                switch (i10) {
                    case 0:
                        v5 v5Var2 = s5Var.f40329a;
                        long j3 = v5Var2.P;
                        ...
                        return;
                    case 1:
                        v5 v5Var3 = s5Var.f40329a;
                        v5Var3.w0(true);
                        long j10 = v5Var3.P;
                        f6Var = ((org.telegram.ui.ActionBar.n2) v5Var3).resourceProvider;
                        ug.n.m(v5Var3, f6Var, j10, null);
                        ug.n.f47182e.setOnHideListener(new r5(s5Var, 0));
                        return;
                    default:
                        v5 v5Var4 = s5Var.f40329a;
        ...
        if (MessagesController.getInstance(v5Var.Q).giveawayGiftsPurchaseAvailable && ChatObject.hasAdminRights(v5Var.f41446g0)) {
