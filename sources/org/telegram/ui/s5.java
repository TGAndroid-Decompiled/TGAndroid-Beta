    ...
    public s5(v5 v5Var, Activity activity) {
        ...
        t5Var.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view) {
                ...
                int i10 = r2;
                s5 s5Var = this.f36808b;
                switch (i10) {
                    case 0:
                        v5 v5Var2 = s5Var.f37383a;
                        long j3 = v5Var2.P;
        ...
        if (MessagesController.getInstance(v5Var.Q).giveawayGiftsPurchaseAvailable && ChatObject.hasAdminRights(v5Var.f38282g0)) {
