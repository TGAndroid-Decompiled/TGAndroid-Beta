...
public final class it0 extends AnimatorListenerAdapter {
    ...
    public final PhotoViewer f34623b;

    public it0(PhotoViewer photoViewer, int i10) {
        this.f34622a = i10;
        this.f34623b = photoViewer;
    }
    ...
    public final void onAnimationEnd(Animator animator) {
        ...
        PhotoViewer photoViewer = this.f34623b;
        switch (i10) {
            case 0:
                ...
                if (df0Var != null) {
                    if (df0Var.f23571b.j()) {
                        photoViewer.f31145a1.setColorFilter(new PorterDuffColorFilter(photoViewer.z1(org.telegram.ui.ActionBar.j6.f19473zf), PorterDuff.Mode.MULTIPLY));
                    } else {
                        photoViewer.f31145a1.setColorFilter((ColorFilter) null);
                    }
            ...
            case 5:
                ...
                return;
            case 6:
                photoViewer.f31254m6 = 1.0f;
                Runnable runnable = photoViewer.f31280p4;
                if (runnable != null) {
