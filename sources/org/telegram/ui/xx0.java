...
public final class xx0 extends org.telegram.ui.Components.wl0 {
    public final Context f40005c;
    public final yx0 d;
    ...
    public final int j(int i10) {
        ...
        if (i10 == yx0Var.f40271n) {
            return 3;
        }
        if (i10 == yx0Var.f40270f) {
            return 2;
        }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i11 == 1) {
            long keyAt = yx0Var.getMessagesController().blockePeers.keyAt(i10 - yx0Var.f40272r);
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        FrameLayout e9Var;
        if (i10 != 0) {
            Context context = this.f40005c;
            if (i10 != 1) {
                if (i10 != 2) {
                    if (i10 != 4) {
                        org.telegram.ui.Cells.m4 m4Var2 = new org.telegram.ui.Cells.m4(this.f40005c, org.telegram.ui.ActionBar.h6.L6, 21, 11, false, null);
                        m4Var2.setHeight(43);
                        m4Var = m4Var2;
                    } else {
            ...
            org.telegram.ui.Cells.b5 b5Var = new org.telegram.ui.Cells.b5(7, 6, this.f40005c, null, true);
