...
public final class xx0 implements Utilities.Callback {
    ...
    public final void run(Object obj) {
        ...
        switch (this.f42939a) {
            case 0:
                PrivacyControlActivity privacyControlActivity = this.f42940b.d;
                privacyControlActivity.L = ((Integer) obj).intValue();
                AndroidUtilities.updateVisibleRow(privacyControlActivity.d, privacyControlActivity.f33848j0);
