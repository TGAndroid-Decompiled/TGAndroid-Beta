...
public final class xx0 implements Utilities.Callback {
    ...
    public final void run(Object obj) {
        ...
        switch (this.f39763a) {
            case 0:
                PrivacyControlActivity privacyControlActivity = this.f39764b.d;
                privacyControlActivity.L = ((Integer) obj).intValue();
                AndroidUtilities.updateVisibleRow(privacyControlActivity.d, privacyControlActivity.f31508j0);
