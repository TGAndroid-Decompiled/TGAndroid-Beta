...
public final class o41 extends og.b {
    ...
    @Override
    public final int h() {
        return this.d.f31678s.size();
    }

    @Override
    public final int j(int i10) {
        return ((p41) this.d.f31678s.get(i10)).f15672a;
    }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        ArrayList arrayList = saveToGallerySettingsActivity.f31678s;
        boolean z10 = false;
        if (((p41) arrayList.get(i10)).f15672a == 1) {
            org.telegram.ui.Cells.r8 r8Var = (org.telegram.ui.Cells.r8) view;
            if (saveToGallerySettingsActivity.v.size() > 0) {
                z10 = true;
            }
            r8Var.setNeedDivider(z10);
        } else if (((p41) arrayList.get(i10)).f15672a == 6) {
            ...
            if (i10 == saveToGallerySettingsActivity.h) {
                ...
                int i12 = saveToGallerySettingsActivity.f31672a;
                if (i12 == 1) {
        ...
        } else if (((p41) arrayList.get(i10)).f15672a == 5) {
            ((org.telegram.ui.Cells.m4) view).setText(((p41) arrayList.get(i10)).d);
        } else if (((p41) arrayList.get(i10)).f15672a == 2) {
            org.telegram.ui.Cells.za zaVar = (org.telegram.ui.Cells.za) view;
            SaveToGallerySettingsHelper.DialogException dialogException = ((p41) arrayList.get(i10)).f36341c;
            ...
            zaVar.d(userOrChat, str, dialogException.createDescription(i11), (i10 == arrayList.size() - 1 || ((p41) arrayList.get(i10 + 1)).f15672a == 2) ? true : true);
        }
    }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        switch (i10) {
            case 1:
                ...
                r8Var.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19062d6, false));
                view = r8Var;
                break;
            case 2:
                View zaVar = new org.telegram.ui.Cells.za(4, 0, viewGroup.getContext(), null, false, false);
                zaVar.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19062d6, false));
                linearLayout = zaVar;
                view = linearLayout;
                break;
            case 3:
            ...
            case 4:
                ...
                r8Var2.e(-1, org.telegram.ui.ActionBar.j6.f19283p7);
                r8Var2.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19062d6, false));
                yaVar = r8Var2;
                view = yaVar;
                break;
            case 5:
            ...
            case 6:
                ...
                w8Var.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19062d6, false));
                yaVar = w8Var;
                view = yaVar;
                break;
            case 7:
            ...
            case 8:
                ...
                to0Var.f28453w.X(to0Var.getProgress(), false);
                linearLayout2.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19062d6, false));
            ...
            case 9:
                ...
                if (DialogObject.isUserDialog(saveToGallerySettingsActivity.f31673b)) {
                    i12 = ((org.telegram.ui.ActionBar.n2) saveToGallerySettingsActivity).currentAccount;
                    chat = MessagesController.getInstance(i12).getUser(Long.valueOf(saveToGallerySettingsActivity.f31673b));
                } else {
                    i11 = ((org.telegram.ui.ActionBar.n2) saveToGallerySettingsActivity).currentAccount;
                    chat = MessagesController.getInstance(i11).getChat(Long.valueOf(-saveToGallerySettingsActivity.f31673b));
                }
                yaVar2.a(chat, null);
                yaVar2.setBackgroundColor(saveToGallerySettingsActivity.getThemedColor(org.telegram.ui.ActionBar.j6.f19062d6));
                yaVar = yaVar2;
                view = yaVar;
                break;
            case 10:
                View b7Var = new org.telegram.ui.Cells.b7(viewGroup.getContext(), (org.telegram.ui.Cells.c1) null);
                b7Var.setBackgroundDrawable(org.telegram.ui.ActionBar.j6.U0(saveToGallerySettingsActivity.getParentActivity(), R.drawable.greydivider_bottom, org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19026b7, saveToGallerySettingsActivity.getResourceProvider())));
                yaVar = b7Var;
                view = yaVar;
                break;
        }
