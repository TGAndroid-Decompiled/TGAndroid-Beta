...
public final class o41 implements org.telegram.ui.Components.bl0, org.telegram.ui.Components.dl0, qy {
    public final SaveToGallerySettingsActivity f36230a;

    public o41(SaveToGallerySettingsActivity saveToGallerySettingsActivity) {
        this.f36230a = saveToGallerySettingsActivity;
    }
    ...
    public void c(float f7, float f10, int i10, View view) {
        SaveToGallerySettingsActivity saveToGallerySettingsActivity = this.f36230a;
        ...
        if (i10 == saveToGallerySettingsActivity.e) {
        ...
        } else if (i10 == saveToGallerySettingsActivity.f31448f) {
            ...
            int i11 = saveToGallerySettingsActivity.f31445a;
            if (i11 == 2) {
            ...
            bundle2.putLong("dialog_id", ((r41) arrayList.get(i10)).f37083c.dialogId);
            bundle2.putInt("type", saveToGallerySettingsActivity.f31445a);
