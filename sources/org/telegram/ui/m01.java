...
public class m01 extends org.telegram.ui.Components.u9 implements org.telegram.ui.Components.mv0 {
    public static final s0 f35596g0 = new s0("crossfadeProgress", 3);
    public boolean G;
    public float H;
    public float I;
    public int J;
    ...
    public boolean f35597a0;
    public float f35598b0;
    public org.telegram.ui.Components.oh0 f35599c0;
    public boolean f35600d0;
    public float f35601e0;
    public Runnable f35602f0;
    ...
    public final void invalidate() {
        super.invalidate();
        org.telegram.ui.Components.oh0 oh0Var = this.f35599c0;
        if (oh0Var != null) {
            oh0Var.invalidate();
        }
        Runnable runnable = this.f35602f0;
        if (runnable != null) {
            runnable.run();
        }
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (z10) {
            org.telegram.ui.Components.fh0 blurDrawer = this.f35599c0.getBlurDrawer();
            if (blurDrawer == null) {
                z12 = false;
            }
            boolean z13 = z12;
        ...
        float A = org.telegram.messenger.w1.A(1.0f, this.V, this.f35601e0, (1.0f - this.f35598b0) * f7);
        ...
        if (imageReceiver != null && f12 > f11 && (this.V < 1.0f || !this.f35597a0)) {
            float f22 = A * f10;
        ...
        if (this.V > f11 && this.f35597a0 && f12 > f11) {
        ...
        if (z11) {
            ...
            if (!this.G && !fh0Var.f23937a && this.f35599c0.getRealPosition() != 0) {
                f13 = 1.0f;
            } else {
                f13 = 1.0f - this.H;
            }
