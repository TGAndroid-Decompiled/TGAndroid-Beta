...
public final class hr0 implements ValueAnimator.AnimatorUpdateListener {
    ...
    public final PhotoViewer f34329b;

    public hr0(PhotoViewer photoViewer, int i10) {
        this.f34328a = i10;
        this.f34329b = photoViewer;
    }

    @Override
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        int i10 = this.f34328a;
        PhotoViewer photoViewer = this.f34329b;
        switch (i10) {
            case 0:
                Drawable[] drawableArr = PhotoViewer.T8;
                photoViewer.getClass();
                photoViewer.f30974i3.setAlpha(((Float) valueAnimator.getAnimatedValue()).floatValue());
                return;
            case 1:
                CropAreaView cropAreaView = photoViewer.C1.f28382b.f14097a;
                float lerp = AndroidUtilities.lerp(photoViewer.f30904a6, photoViewer.f30942e6, photoViewer.f31001l6);
                float lerp2 = AndroidUtilities.lerp(photoViewer.X5, photoViewer.f30924c6, photoViewer.f31001l6);
                float lerp3 = AndroidUtilities.lerp(photoViewer.Y5, photoViewer.f30933d6, photoViewer.f31001l6);
                cropAreaView.f22020n0 = 0.0f;
                cropAreaView.f22021o0 = lerp;
                cropAreaView.f22022p0 = lerp2;
                cropAreaView.f22023q0 = lerp3;
            ...
            case 4:
                ...
                photoViewer.getClass();
                photoViewer.f31009m6 = 1.0f - ((Float) valueAnimator.getAnimatedValue()).floatValue();
                return;
            case 5:
            ...
            case 10:
                ...
                photoViewer.getClass();
                photoViewer.f31009m6 = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                photoViewer.F1();
                return;
            case 11:
