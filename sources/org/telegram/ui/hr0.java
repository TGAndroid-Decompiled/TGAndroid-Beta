...
public final class hr0 implements ValueAnimator.AnimatorUpdateListener {
    ...
    public final PhotoViewer f37098b;

    public hr0(PhotoViewer photoViewer, int i10) {
        this.f37097a = i10;
        this.f37098b = photoViewer;
    }

    @Override
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        int i10 = this.f37097a;
        PhotoViewer photoViewer = this.f37098b;
        switch (i10) {
            case 0:
                Drawable[] drawableArr = PhotoViewer.T8;
                photoViewer.getClass();
                photoViewer.f33587i3.setAlpha(((Float) valueAnimator.getAnimatedValue()).floatValue());
                return;
            case 1:
                CropAreaView cropAreaView = photoViewer.C1.f30869b.f16303a;
                float lerp = AndroidUtilities.lerp(photoViewer.f33516a6, photoViewer.f33555e6, photoViewer.f33614l6);
                float lerp2 = AndroidUtilities.lerp(photoViewer.X5, photoViewer.f33536c6, photoViewer.f33614l6);
                float lerp3 = AndroidUtilities.lerp(photoViewer.Y5, photoViewer.f33545d6, photoViewer.f33614l6);
                cropAreaView.f23959n0 = 0.0f;
                cropAreaView.f23960o0 = lerp;
                cropAreaView.f23961p0 = lerp2;
                cropAreaView.f23962q0 = lerp3;
            ...
            case 4:
                ...
                photoViewer.getClass();
                photoViewer.f33622m6 = 1.0f - ((Float) valueAnimator.getAnimatedValue()).floatValue();
                return;
            case 5:
            ...
            case 10:
                ...
                photoViewer.getClass();
                photoViewer.f33622m6 = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                photoViewer.F1();
                return;
            case 11:
