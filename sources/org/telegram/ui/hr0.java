...
public final class hr0 extends org.telegram.ui.ActionBar.n2 {
    public static final org.telegram.ui.Components.ur0 f34262y = new org.telegram.ui.Components.ur0(4);
    public final cr0 f34263a;
    public final cr0 f34264b;
    public org.telegram.ui.ActionBar.v0 f34265c;
    public org.telegram.ui.Components.ju d;
    public boolean e;
    public final Paint f34266f;
    public ScrollSlidingTextTabStrip h;
    public final fr0[] f34267n;
    public AnimatorSet f34268r;
    public boolean f34269s;
    public boolean v;
    public boolean f34270w;
    public int f34271x;

    public hr0(HashMap hashMap, ArrayList arrayList, int i10, boolean z10, zn znVar) {
        super(null);
        this.e = true;
        this.f34266f = new Paint();
        this.f34267n = new fr0[2];
        this.f34263a = new cr0(0, null, hashMap, arrayList, i10, z10, znVar, false);
        this.f34264b = new cr0(1, null, hashMap, arrayList, i10, z10, znVar, false);
    }
    ...
    public static void h0(hr0 hr0Var, String str) {
        hr0Var.f34265c.getSearchField().setText(str);
        hr0Var.f34265c.getSearchField().setSelection(str.length());
        hr0Var.actionBar.w();
    }
    ...
    public final View createView(Context context) {
        fr0[] fr0VarArr;
        View view;
        this.actionBar.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19165h5, false));
        ...
        EditTextBoldCursor searchField = this.f34265c.getSearchField();
        ...
        this.f34271x = ViewConfiguration.get(context).getScaledMaximumFlingVelocity();
        er0 er0Var = new er0(this, context);
        this.fragmentView = er0Var;
        er0Var.setWillNotDraw(false);
        cr0 cr0Var = this.f34263a;
        cr0Var.setParentFragment(this);
        org.telegram.ui.Components.ju juVar = cr0Var.f32838d0;
        this.d = juVar;
        ...
        for (int i13 = 0; i13 < 4; i13++) {
            if (i13 != 0) {
                if (i13 != 1) {
                    if (i13 != 2) {
                        view = cr0Var.f32837c0;
                    } else {
                        view = cr0Var.f32835b0;
                    }
                } else {
                    view = cr0Var.f32833a0;
                }
            } else {
                view = cr0Var.Z;
            }
        ...
        j0 j0Var = cr0Var.f32833a0;
        s50 s50Var = cr0Var.f32835b0;
        View view2 = cr0Var.f32837c0;
        org.telegram.ui.Components.ju juVar2 = cr0Var.f32838d0;
        cr0 cr0Var2 = this.f34264b;
        cr0Var2.Z = frameLayout;
        cr0Var2.f32833a0 = j0Var;
        cr0Var2.f32838d0 = juVar2;
        cr0Var2.f32835b0 = s50Var;
        cr0Var2.f32837c0 = view2;
        cr0Var2.f32852q0 = false;
        cr0Var2.setParentFragment(this);
        int i14 = 0;
        while (true) {
            fr0VarArr = this.f34267n;
            ...
            if (i14 == 0) {
                ...
                fr0Var2.f33707a = cr0Var;
                fr0Var2.d = cr0Var.K;
            } else if (i14 == 1) {
                fr0 fr0Var3 = fr0VarArr[i14];
                fr0Var3.f33707a = cr0Var2;
                fr0Var3.d = cr0Var2.K;
                fr0Var3.setVisibility(8);
            }
            fr0VarArr[i14].d.setScrollingTouchSlop(1);
            fr0 fr0Var4 = fr0VarArr[i14];
            fr0Var4.f33708b = (FrameLayout) fr0Var4.f33707a.getFragmentView();
            fr0VarArr[i14].d.setClipToPadding(false);
            fr0 fr0Var5 = fr0VarArr[i14];
            fr0Var5.f33709c = fr0Var5.f33707a.getActionBar();
            fr0 fr0Var6 = fr0VarArr[i14];
            fr0Var6.addView(fr0Var6.f33708b, w7.y5.c(-1.0f, -1));
            fr0 fr0Var7 = fr0VarArr[i14];
            fr0Var7.addView(fr0Var7.f33709c, w7.y5.c(-2.0f, -1));
            fr0VarArr[i14].f33709c.setVisibility(8);
        ...
        er0Var.addView(cr0Var.f32833a0, w7.y5.d(60, 60.0f, 85, 0.0f, 0.0f, 12.0f, 10.0f));
        er0Var.addView(cr0Var.f32835b0, w7.y5.d(42, 24.0f, 85, 0.0f, 0.0f, -2.0f, 9.0f));
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f34265c.getSearchField(), 16777216, null, null, null, null, i11));
        ...
        arrayList.addAll(this.f34263a.getThemeDescriptions());
        arrayList.addAll(this.f34264b.getThemeDescriptions());
        return arrayList;
    }
    ...
    public final void onResume() {
        super.onResume();
        org.telegram.ui.ActionBar.v0 v0Var = this.f34265c;
        if (v0Var != null) {
            v0Var.z(true);
