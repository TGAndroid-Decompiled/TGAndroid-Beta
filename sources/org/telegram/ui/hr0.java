...
public final class hr0 implements ValueAnimator.AnimatorUpdateListener {
    ...
    public final PhotoViewer f37099b;

    public hr0(PhotoViewer photoViewer, int i10) {
        this.f37098a = i10;
        this.f37099b = photoViewer;
    }

    @Override
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        int i10 = this.f37098a;
        PhotoViewer photoViewer = this.f37099b;
        switch (i10) {
            case 0:
                Drawable[] drawableArr = PhotoViewer.T8;
                photoViewer.getClass();
                photoViewer.f33588i3.setAlpha(((Float) valueAnimator.getAnimatedValue()).floatValue());
                return;
            case 1:
                CropAreaView cropAreaView = photoViewer.C1.f30870b.f16303a;
                float lerp = AndroidUtilities.lerp(photoViewer.f33517a6, photoViewer.f33556e6, photoViewer.f33615l6);
                float lerp2 = AndroidUtilities.lerp(photoViewer.X5, photoViewer.f33537c6, photoViewer.f33615l6);
                float lerp3 = AndroidUtilities.lerp(photoViewer.Y5, photoViewer.f33546d6, photoViewer.f33615l6);
                cropAreaView.f23960n0 = 0.0f;
                cropAreaView.f23961o0 = lerp;
                cropAreaView.f23962p0 = lerp2;
                cropAreaView.f23963q0 = lerp3;
            ...
            case 4:
                ...
                photoViewer.getClass();
                photoViewer.f33623m6 = 1.0f - ((Float) valueAnimator.getAnimatedValue()).floatValue();
                return;
            case 5:
            ...
            case 10:
                ...
                photoViewer.getClass();
                photoViewer.f33623m6 = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                photoViewer.F1();
                return;
            case 11:
