...
public final class hr0 extends org.telegram.ui.ActionBar.n2 {
    public static final org.telegram.ui.Components.vr0 f34214y = new org.telegram.ui.Components.vr0(4);
    public final cr0 f34215a;
    public final cr0 f34216b;
    public org.telegram.ui.ActionBar.v0 f34217c;
    public org.telegram.ui.Components.ju d;
    public boolean e;
    public final Paint f34218f;
    public ScrollSlidingTextTabStrip h;
    public final fr0[] f34219n;
    public AnimatorSet f34220r;
    ...
    public hr0(HashMap hashMap, ArrayList arrayList, int i10, boolean z10, zn znVar) {
        super(null);
        this.e = true;
        this.f34218f = new Paint();
        this.f34219n = new fr0[2];
        this.f34215a = new cr0(0, null, hashMap, arrayList, i10, z10, znVar, false);
        this.f34216b = new cr0(1, null, hashMap, arrayList, i10, z10, znVar, false);
    }
    ...
    public static void h0(hr0 hr0Var, String str) {
        hr0Var.f34217c.getSearchField().setText(str);
        hr0Var.f34217c.getSearchField().setSelection(str.length());
        hr0Var.actionBar.w();
    }
    ...
    public final View createView(Context context) {
        fr0[] fr0VarArr;
        View view;
        this.actionBar.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19133h5, false));
        ...
        EditTextBoldCursor searchField = this.f34217c.getSearchField();
        ...
        this.f34223x = ViewConfiguration.get(context).getScaledMaximumFlingVelocity();
        er0 er0Var = new er0(this, context);
        this.fragmentView = er0Var;
        er0Var.setWillNotDraw(false);
        cr0 cr0Var = this.f34215a;
        cr0Var.setParentFragment(this);
        org.telegram.ui.Components.ju juVar = cr0Var.f32766d0;
        this.d = juVar;
        ...
        for (int i13 = 0; i13 < 4; i13++) {
            if (i13 != 0) {
                if (i13 != 1) {
                    if (i13 != 2) {
                        view = cr0Var.f32765c0;
                    } else {
                        view = cr0Var.f32763b0;
                    }
                } else {
                    view = cr0Var.f32761a0;
                }
            } else {
                view = cr0Var.Z;
            }
        ...
        j0 j0Var = cr0Var.f32761a0;
        s50 s50Var = cr0Var.f32763b0;
        View view2 = cr0Var.f32765c0;
        org.telegram.ui.Components.ju juVar2 = cr0Var.f32766d0;
        cr0 cr0Var2 = this.f34216b;
        cr0Var2.Z = frameLayout;
        cr0Var2.f32761a0 = j0Var;
        cr0Var2.f32766d0 = juVar2;
        cr0Var2.f32763b0 = s50Var;
        cr0Var2.f32765c0 = view2;
        cr0Var2.f32780q0 = false;
        cr0Var2.setParentFragment(this);
        int i14 = 0;
        while (true) {
            fr0VarArr = this.f34219n;
            ...
            if (i14 == 0) {
                ...
                fr0Var2.f33596a = cr0Var;
                fr0Var2.d = cr0Var.K;
            } else if (i14 == 1) {
                fr0 fr0Var3 = fr0VarArr[i14];
                fr0Var3.f33596a = cr0Var2;
                fr0Var3.d = cr0Var2.K;
                fr0Var3.setVisibility(8);
            }
            fr0VarArr[i14].d.setScrollingTouchSlop(1);
            fr0 fr0Var4 = fr0VarArr[i14];
            fr0Var4.f33597b = (FrameLayout) fr0Var4.f33596a.getFragmentView();
            fr0VarArr[i14].d.setClipToPadding(false);
            fr0 fr0Var5 = fr0VarArr[i14];
            fr0Var5.f33598c = fr0Var5.f33596a.getActionBar();
            fr0 fr0Var6 = fr0VarArr[i14];
            fr0Var6.addView(fr0Var6.f33597b, w7.y5.c(-1.0f, -1));
            fr0 fr0Var7 = fr0VarArr[i14];
            fr0Var7.addView(fr0Var7.f33598c, w7.y5.c(-2.0f, -1));
            fr0VarArr[i14].f33598c.setVisibility(8);
        ...
        er0Var.addView(cr0Var.f32761a0, w7.y5.d(60, 60.0f, 85, 0.0f, 0.0f, 12.0f, 10.0f));
        er0Var.addView(cr0Var.f32763b0, w7.y5.d(42, 24.0f, 85, 0.0f, 0.0f, -2.0f, 9.0f));
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f34217c.getSearchField(), 16777216, null, null, null, null, i11));
        ...
        arrayList.addAll(this.f34215a.getThemeDescriptions());
        arrayList.addAll(this.f34216b.getThemeDescriptions());
        return arrayList;
    }
    ...
    public final void onResume() {
        super.onResume();
        org.telegram.ui.ActionBar.v0 v0Var = this.f34217c;
        if (v0Var != null) {
            v0Var.z(true);
