...
public final class pt0 implements org.telegram.ui.Components.d71 {
    public boolean f39633a = true;
    public final PhotoViewer f39634b;

    public pt0(PhotoViewer photoViewer) {
        this.f39634b = photoViewer;
    }

    @Override
    public final void onError(org.telegram.ui.Components.g71 g71Var, Exception exc) {
        View findViewWithTag;
        PhotoViewer photoViewer = this.f39634b;
        if (photoViewer.F2 == g71Var) {
            FileLog.e(exc);
            ActionBarPopupWindow$ActionBarPopupWindowLayout actionBarPopupWindow$ActionBarPopupWindowLayout = photoViewer.f33636o0.f21379b;
            if (actionBarPopupWindow$ActionBarPopupWindowLayout != null && (findViewWithTag = actionBarPopupWindow$ActionBarPopupWindowLayout.findViewWithTag(10)) != null && findViewWithTag.getVisibility() == 0) {
                AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(photoViewer.f33728y, 0, photoViewer.f33701v2);
                alertDialog$Builder.f20199a.R = LocaleController.getString("AppName", R.string.AppName);
                alertDialog$Builder.f20199a.T = LocaleController.getString(R.string.CantPlayVideo);
    ...
    public final void onStateChanged(boolean z10, int i10) {
        ...
        boolean z11;
        PhotoViewer photoViewer = this.f39634b;
        ArrayList arrayList = photoViewer.f33574g7;
        org.telegram.ui.Components.g71 g71Var2 = photoViewer.F2;
        if (g71Var2 != null) {
            if (!b5.d.u() && !photoViewer.f33661r) {
                z11 = false;
            } else {
                z11 = true;
            }
        ...
        if (this.f39633a && (g71Var = photoViewer.F2) != null && g71Var.p() != -9223372036854775807L) {
            this.f39633a = false;
            if (photoViewer.Y6.isEmpty() && photoViewer.e7.isEmpty() && photoViewer.f33518a7.isEmpty() && !arrayList.isEmpty() && (i11 = photoViewer.Q4) >= 0 && i11 < arrayList.size()) {
    ...
    public final boolean onSurfaceDestroyed(SurfaceTexture surfaceTexture) {
        ...
        PhotoViewer photoViewer = this.f39634b;
        if (p5 != null && org.telegram.ui.Components.eg0.p().f44355b.f45997a != 0 && (textureView = photoViewer.f33712w3) != null && textureView.getSurfaceTexture() == surfaceTexture) {
            org.telegram.ui.Components.eg0 eg0Var = org.telegram.ui.Components.eg0.f25676p0;
            TextureView textureView3 = null;
            if (eg0Var != null) {
                textureView2 = eg0Var.f25693l0;
            } else {
                textureView2 = null;
            }
            textureView2.setSurfaceTexture(surfaceTexture);
            if (eg0Var != null) {
                textureView3 = eg0Var.f25693l0;
            }
        ...
        if (photoViewer.F3) {
            ...
            if (photoViewer.J3) {
                photoViewer.G3 = 1;
                photoViewer.f33712w3.setSurfaceTexture(surfaceTexture);
                photoViewer.f33712w3.setSurfaceTextureListener(photoViewer.f33597j4);
                photoViewer.f33712w3.setVisibility(0);
                return true;
            }
        }
        return false;
    ...
    public final void onVideoSizeChanged(int i10, int i11, int i12, float f7) {
        ...
        if (photoViewer.f33731y2 != null) {
            ...
            rt0 rt0Var = photoViewer.f33731y2;
            if (i11 == 0) {
                f10 = 1.0f;
            } else {
                f10 = f11 / f12;
