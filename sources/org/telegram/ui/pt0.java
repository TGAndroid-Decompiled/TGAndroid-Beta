...
public final class pt0 implements org.telegram.ui.Components.d71 {
    public boolean f39660a = true;
    public final PhotoViewer f39661b;

    public pt0(PhotoViewer photoViewer) {
        this.f39661b = photoViewer;
    }

    @Override
    public final void onError(org.telegram.ui.Components.g71 g71Var, Exception exc) {
        View findViewWithTag;
        PhotoViewer photoViewer = this.f39661b;
        if (photoViewer.F2 == g71Var) {
            FileLog.e(exc);
            ActionBarPopupWindow$ActionBarPopupWindowLayout actionBarPopupWindow$ActionBarPopupWindowLayout = photoViewer.f33663o0.f21406b;
            if (actionBarPopupWindow$ActionBarPopupWindowLayout != null && (findViewWithTag = actionBarPopupWindow$ActionBarPopupWindowLayout.findViewWithTag(10)) != null && findViewWithTag.getVisibility() == 0) {
                AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(photoViewer.f33755y, 0, photoViewer.f33728v2);
                alertDialog$Builder.f20226a.R = LocaleController.getString("AppName", R.string.AppName);
                alertDialog$Builder.f20226a.T = LocaleController.getString(R.string.CantPlayVideo);
    ...
    public final void onStateChanged(boolean z10, int i10) {
        ...
        boolean z11;
        PhotoViewer photoViewer = this.f39661b;
        ArrayList arrayList = photoViewer.f33601g7;
        ...
        if (this.f39660a && (g71Var = photoViewer.F2) != null && g71Var.p() != -9223372036854775807L) {
            this.f39660a = false;
            if (photoViewer.Y6.isEmpty() && photoViewer.e7.isEmpty() && photoViewer.f33545a7.isEmpty() && !arrayList.isEmpty() && (i11 = photoViewer.Q4) >= 0 && i11 < arrayList.size()) {
    ...
    public final boolean onSurfaceDestroyed(SurfaceTexture surfaceTexture) {
        ...
        PhotoViewer photoViewer = this.f39661b;
        if (p5 != null && org.telegram.ui.Components.eg0.p().f44383b.f46025a != 0 && (textureView = photoViewer.f33739w3) != null && textureView.getSurfaceTexture() == surfaceTexture) {
        ...
        if (photoViewer.F3) {
            ...
            if (photoViewer.J3) {
                photoViewer.G3 = 1;
                photoViewer.f33739w3.setSurfaceTexture(surfaceTexture);
                photoViewer.f33739w3.setSurfaceTextureListener(photoViewer.f33624j4);
                photoViewer.f33739w3.setVisibility(0);
                return true;
            }
        }
        return false;
    ...
    public final void onVideoSizeChanged(int i10, int i11, int i12, float f7) {
        ...
        if (photoViewer.f33758y2 != null) {
            ...
            rt0 rt0Var = photoViewer.f33758y2;
            if (i11 == 0) {
                f10 = 1.0f;
            } else {
                f10 = f11 / f12;
