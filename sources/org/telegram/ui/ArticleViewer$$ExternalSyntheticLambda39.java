...
public final class ArticleViewer$$ExternalSyntheticLambda39 implements RequestDelegate {
    ...
    public ArticleViewer$$ExternalSyntheticLambda39(BaseController baseController, long j, int i, int i2) {
        this.$r8$classId = i2;
    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        switch (this.$r8$classId) {
            case 0:
                ...
                AndroidUtilities.runOnUIThread(new ArticleViewer$$ExternalSyntheticLambda48(articleViewer, tLObject, this.f$1, this.f$2, 0));
                break;
            case 1:
    ...
    public ArticleViewer$$ExternalSyntheticLambda39(ArticleViewer articleViewer, int i, long j) {
        this.$r8$classId = 0;
