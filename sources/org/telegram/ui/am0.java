...
public final class am0 implements org.telegram.ui.ActionBar.a2, zt, cn0 {
    ...
    public void a1(vt vtVar) {
        ...
        switch (this.f31855a) {
            case 2:
                on0 on0Var = this.f31856b;
                on0Var.Y[5].setText(vtVar.f38616a);
                on0Var.f36296s = vtVar.d;
                return;
            default:
                on0 on0Var2 = this.f31856b;
                on0Var2.Y[0].setText(vtVar.f38616a);
                if (on0Var2.U0.indexOf(vtVar.f38616a) != -1) {
                    on0Var2.Z0 = true;
                    String str2 = (String) on0Var2.V0.get(vtVar.f38616a);
