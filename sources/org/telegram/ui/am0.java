    ...
    public final void onClick(View view) {
        switch (this.f34479a) {
            ...
            case 1:
                ...
                return;
            case 2:
                pn0 pn0Var2 = this.f34480b;
                pn0Var2.S0 = 3;
                pn0Var2.D1();
                return;
            case 3:
                pn0 pn0Var3 = this.f34480b;
                pn0Var3.S0 = 1;
                pn0Var3.D1();
                return;
            case 4:
                pn0 pn0Var4 = this.f34480b;
                pn0Var4.S0 = 4;
                pn0Var4.D1();
                return;
            case 5:
                ...
                return;
            case 6:
                pn0 pn0Var5 = this.f34480b;
                pn0Var5.f39563f = true;
                pn0Var5.L.callOnClick();
                pn0Var5.f39563f = false;
                return;
            case 7:
                pn0 pn0Var6 = this.f34480b;
                pn0Var6.S0 = 0;
                pn0Var6.D1();
                return;
            case 8:
                pn0 pn0Var7 = this.f34480b;
                pn0Var7.S0 = 4;
                pn0Var7.D1();
                return;
            case 9:
            ...
            case 12:
                ...
                return;
            case 13:
                pn0 pn0Var8 = this.f34480b;
                AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(pn0Var8.getParentActivity());
                alertDialog$Builder.f20199a.R = LocaleController.getString(R.string.TelegramPassportDeleteTitle);
                alertDialog$Builder.f20199a.T = LocaleController.getString(R.string.TelegramPassportDeleteAlert);
            ...
            case 15:
                ...
                return;
            default:
                pn0 pn0Var9 = this.f34480b;
                pn0Var9.f39563f = true;
                pn0Var9.L.callOnClick();
                pn0Var9.f39563f = false;
                return;
        }
    }
}
