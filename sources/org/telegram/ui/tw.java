...
public final class tw implements org.telegram.ui.Components.e00 {
    ...
    public final int a(int i10) {
        uy uyVar = this.f40868b;
        if (uyVar.R0 != 3) {
            if (i10 == uyVar.f41391z0.getDefaultTabId()) {
    ...
    public final void b(float f7) {
        ...
        if (i10 != 0 || uyVar.f41286e0[1].getVisibility() == 0 || uyVar.f41314j2) {
            if (uyVar.f41305h3) {
                ty tyVar = uyVar.f41286e0[0];
                tyVar.setTranslationX((-f7) * tyVar.getMeasuredWidth());
                ty[] tyVarArr = uyVar.f41286e0;
                tyVarArr[1].setTranslationX(tyVarArr[0].getMeasuredWidth() - (f7 * uyVar.f41286e0[0].getMeasuredWidth()));
            } else {
                ty tyVar2 = uyVar.f41286e0[0];
                tyVar2.setTranslationX(tyVar2.getMeasuredWidth() * f7);
                ty[] tyVarArr2 = uyVar.f41286e0;
                tyVarArr2[1].setTranslationX((f7 * tyVarArr2[0].getMeasuredWidth()) - uyVar.f41286e0[0].getMeasuredWidth());
            }
            if (i10 == 0) {
                ty[] tyVarArr3 = uyVar.f41286e0;
                ...
                uy.f1(uyVar, true);
                uyVar.T4(false);
                uyVar.f41391z0.O = false;
                uyVar.r3(uyVar.f41286e0[0]);
                uyVar.f41286e0[0].d.getClass();
                uyVar.f41286e0[1].d.getClass();
            }
        }
    }
    ...
    public final void c(org.telegram.ui.Components.g00 g00Var, boolean z10) {
        ...
        int i11;
        uy uyVar = this.f40868b;
        int i12 = uyVar.f41286e0[0].h;
        int i13 = g00Var.f26244a;
        if (i12 != i13) {
            if (g00Var.f26248f) {
                uyVar.f41391z0.i(i13);
                i11 = ((org.telegram.ui.ActionBar.n2) uyVar).currentAccount;
                uyVar.showDialog(new sg.k0(3, i11, this.f40867a, uyVar, null));
                return;
            }
            ArrayList<MessagesController.DialogFilter> dialogFilters = uyVar.getMessagesController().getDialogFilters();
            if (!g00Var.f26247e && ((i10 = g00Var.f26244a) < 0 || i10 >= dialogFilters.size())) {
                return;
            }
            ty tyVar = uyVar.f41286e0[1];
            tyVar.h = g00Var.f26244a;
