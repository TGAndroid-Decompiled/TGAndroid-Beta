...
public final class tw implements org.telegram.ui.Components.e00 {
    ...
    public final int a(int i10) {
        uy uyVar = this.f37889b;
        if (uyVar.R0 != 3) {
            if (i10 == uyVar.f38360z0.getDefaultTabId()) {
    ...
    public final void b(float f7) {
        ...
        if (i10 != 0 || uyVar.f38256e0[1].getVisibility() == 0 || uyVar.f38284j2) {
            if (uyVar.f38275h3) {
                ty tyVar = uyVar.f38256e0[0];
                tyVar.setTranslationX((-f7) * tyVar.getMeasuredWidth());
                ty[] tyVarArr = uyVar.f38256e0;
                tyVarArr[1].setTranslationX(tyVarArr[0].getMeasuredWidth() - (f7 * uyVar.f38256e0[0].getMeasuredWidth()));
            } else {
                ty tyVar2 = uyVar.f38256e0[0];
                tyVar2.setTranslationX(tyVar2.getMeasuredWidth() * f7);
                ty[] tyVarArr2 = uyVar.f38256e0;
                tyVarArr2[1].setTranslationX((f7 * tyVarArr2[0].getMeasuredWidth()) - uyVar.f38256e0[0].getMeasuredWidth());
            }
            if (i10 == 0) {
                ty[] tyVarArr3 = uyVar.f38256e0;
                ...
                uy.f1(uyVar, true);
                uyVar.T4(false);
                uyVar.f38360z0.O = false;
                uyVar.r3(uyVar.f38256e0[0]);
                uyVar.f38256e0[0].d.getClass();
                uyVar.f38256e0[1].d.getClass();
            }
        }
    }
    ...
    public final void c(org.telegram.ui.Components.g00 g00Var, boolean z10) {
        ...
        int i11;
        uy uyVar = this.f37889b;
        int i12 = uyVar.f38256e0[0].h;
        int i13 = g00Var.f24220a;
        if (i12 != i13) {
            if (g00Var.f24223f) {
                uyVar.f38360z0.i(i13);
                i11 = ((org.telegram.ui.ActionBar.n2) uyVar).currentAccount;
                uyVar.showDialog(new rg.j0(3, i11, this.f37888a, uyVar, null));
                return;
            }
            ArrayList<MessagesController.DialogFilter> dialogFilters = uyVar.getMessagesController().getDialogFilters();
            if (!g00Var.e && ((i10 = g00Var.f24220a) < 0 || i10 >= dialogFilters.size())) {
                return;
            }
            ty tyVar = uyVar.f38256e0[1];
            tyVar.h = g00Var.f24220a;
    ...
    public final void d(MessagesController.DialogFilter dialogFilter) {
        ...
        uy uyVar = this.f37889b;
        if (isChatlist) {
            org.telegram.ui.Components.c10.T(uyVar, dialogFilter.f15822id, null);
            return;
        }
        AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(uyVar.getParentActivity());
        alertDialog$Builder.f18654a.R = LocaleController.getString(R.string.FilterDelete);
        alertDialog$Builder.f18654a.T = LocaleController.getString(R.string.FilterDeleteAlert);
