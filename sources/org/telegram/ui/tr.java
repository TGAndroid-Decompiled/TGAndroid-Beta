...
public final class tr extends Drawable {
    public final org.telegram.ui.ActionBar.d6 f38204a;
    public final Paint f38205b = new Paint(1);
    public final Paint f38206c;
    public final Drawable d;
    public final RectF e;
    public final org.telegram.ui.Components.o6 f38207f;
    public final org.telegram.ui.Components.o6 f38208g;
    public final Paint h;
    public final Path f38209i;
    public final Drawable f38210j;
    public int f38211k;
    public boolean f38212l;
    public final org.telegram.ui.Components.e6 f38213m;
    ...
    public tr(Context context, int i10, org.telegram.ui.ActionBar.d6 d6Var) {
        ...
        Path path = new Path();
        this.f38209i = path;
        this.f38213m = new org.telegram.ui.Components.e6(new aj(this, 12), 320L, org.telegram.ui.Components.rr.h, 0);
        sr srVar = new sr(0, this);
        this.f38204a = d6Var;
        this.d = context.getResources().getDrawable(i10).mutate();
        this.f38210j = context.getResources().getDrawable(R.drawable.mini_casting_fill).mutate();
        paint.setColor(-1);
    ...
    public final void draw(Canvas canvas) {
        ...
        int i10;
        float f12;
        float e = this.f38213m.e(this.f38212l);
        org.telegram.ui.Components.o6 o6Var = this.f38207f;
        float d = o6Var.d() + (o6Var.g() * AndroidUtilities.dp(5.0f));
        org.telegram.ui.Components.o6 o6Var2 = this.f38208g;
        ...
        if (d * f15 > 0.0f) {
            ...
            o6Var.f26942w = (int) (o6Var.g() * 255.0f * f15);
            float f16 = f7 / 2.0f;
        ...
        if (e > 0.0f) {
            canvas2.save();
            int v02 = org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.Oh, this.f38204a);
            int i13 = this.f38211k;
            Drawable drawable2 = this.f38210j;
            if (i13 != v02) {
                this.f38211k = v02;
            ...
            if (e > 0.5f) {
                ...
                canvas2.drawPath(this.f38209i, this.h);
                canvas2.restore();
            }
        ...
        if (i10 > 0) {
            ...
            o6Var2.f26942w = (int) (o6Var2.g() * f12);
            float f17 = f7 / 2.0f;
