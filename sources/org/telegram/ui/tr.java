...
public final class tr extends Drawable {
    public final org.telegram.ui.ActionBar.d6 f38220a;
    public final Paint f38221b = new Paint(1);
    public final Paint f38222c;
    public final Drawable d;
    public final RectF e;
    public final org.telegram.ui.Components.o6 f38223f;
    public final org.telegram.ui.Components.o6 f38224g;
    public final Paint h;
    public final Path f38225i;
    public final Drawable f38226j;
    public int f38227k;
    public boolean f38228l;
    public final org.telegram.ui.Components.e6 f38229m;
    ...
    public tr(Context context, int i10, org.telegram.ui.ActionBar.d6 d6Var) {
        ...
        Path path = new Path();
        this.f38225i = path;
        this.f38229m = new org.telegram.ui.Components.e6(new aj(this, 12), 320L, org.telegram.ui.Components.sr.h, 0);
        sr srVar = new sr(0, this);
        this.f38220a = d6Var;
        this.d = context.getResources().getDrawable(i10).mutate();
        this.f38226j = context.getResources().getDrawable(R.drawable.mini_casting_fill).mutate();
        paint.setColor(-1);
    ...
    public final void draw(Canvas canvas) {
        ...
        int i10;
        float f12;
        float e = this.f38229m.e(this.f38228l);
        org.telegram.ui.Components.o6 o6Var = this.f38223f;
        float d = o6Var.d() + (o6Var.g() * AndroidUtilities.dp(5.0f));
        org.telegram.ui.Components.o6 o6Var2 = this.f38224g;
        ...
        if (d * f15 > 0.0f) {
            ...
            o6Var.f26979w = (int) (o6Var.g() * 255.0f * f15);
            float f16 = f7 / 2.0f;
        ...
        if (e > 0.0f) {
            canvas2.save();
            int v02 = org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.Oh, this.f38220a);
            int i13 = this.f38227k;
            Drawable drawable2 = this.f38226j;
            if (i13 != v02) {
                this.f38227k = v02;
            ...
            if (e > 0.5f) {
                ...
                canvas2.drawPath(this.f38225i, this.h);
                canvas2.restore();
            }
        ...
        if (i10 > 0) {
            ...
            o6Var2.f26979w = (int) (o6Var2.g() * f12);
            float f17 = f7 / 2.0f;
