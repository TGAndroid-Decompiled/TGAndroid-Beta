...
public final class lv extends FrameLayout {
    ...
    public int d;
    public int e;
    public VelocityTracker f35549f;
    public boolean h;
    public final nv f35550n;
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        if (!a() && !this.f35550n.e.H && !onTouchEvent(motionEvent)) {
            return false;
        }
        return true;
    }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent != null) {
            if (this.f35549f == null) {
                this.f35549f = VelocityTracker.obtain();
            }
            this.f35549f.addMovement(motionEvent);
        }
        if (motionEvent != null && motionEvent.getAction() == 0 && !this.f35547b && !this.f35548c) {
            this.f35546a = motionEvent.getPointerId(0);
            this.f35548c = true;
            this.d = (int) motionEvent.getX();
            this.e = (int) motionEvent.getY();
            this.f35549f.clear();
        } else if (motionEvent != null && motionEvent.getAction() == 2 && motionEvent.getPointerId(0) == this.f35546a) {
            int x10 = (int) (motionEvent.getX() - this.d);
            int abs = Math.abs(((int) motionEvent.getY()) - this.e);
            if (this.f35547b && (((z12 = nvVar.f36057r) && x10 > 0) || (!z12 && x10 < 0))) {
                if (x10 < 0) {
                    z13 = true;
                } else {
                    z13 = false;
                ...
                if (!b(motionEvent, z13)) {
                    ...
                    nvVar.e.j(0.0f, mvVarArr[1].f35815f);
                }
            }
            if (this.f35548c && !this.f35547b) {
                ...
                nvVar.e.j(Math.abs(x10) / mvVarArr[0].getMeasuredWidth(), mvVarArr[1].f35815f);
            }
        } else if (motionEvent == null || (motionEvent.getPointerId(0) == this.f35546a && (motionEvent.getAction() == 3 || motionEvent.getAction() == 1 || motionEvent.getAction() == 6))) {
            this.f35549f.computeCurrentVelocity(1000, nvVar.v);
            if (motionEvent != null && motionEvent.getAction() != 3) {
                f7 = this.f35549f.getXVelocity();
                f10 = this.f35549f.getYVelocity();
                if (!this.f35547b && Math.abs(f7) >= 3000.0f && Math.abs(f7) > Math.abs(f10)) {
                    if (f7 < 0.0f) {
                        z11 = true;
                    } else {
                        z11 = false;
            ...
            if (this.f35547b) {
                ...
                nvVar.h.setInterpolator(nv.f36051x);
            ...
            VelocityTracker velocityTracker = this.f35549f;
