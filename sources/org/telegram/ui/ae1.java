...
public final class ae1 implements TextWatcher {
    ...
    public final void afterTextChanged(Editable editable) {
        be1 be1Var = this.f34423a;
        if (be1Var.I) {
            return;
        }
        if (be1Var.f34800a.length() > 0) {
            String str = "https://" + be1Var.getMessagesController().linkPrefix + "/addtheme/" + ((Object) be1Var.f34800a.getText());
    ...
    public final void onTextChanged(CharSequence charSequence, int i10, int i11, int i12) {
        ...
        be1Var.Z(be1Var.f34800a.getText().toString(), false);
    }
