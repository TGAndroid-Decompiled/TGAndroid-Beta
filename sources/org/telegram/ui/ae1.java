...
public final class ae1 extends FrameLayout {
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        switch (this.f32146a) {
            case 0:
                de1 de1Var = this.f32147b;
                if (de1Var.f33101x > 0.0f && de1Var.v != null) {
                    de1Var.f33100w.reset();
                    float width = getWidth() / de1Var.f33098r.getWidth();
                    de1Var.f33100w.postScale(width, width);
                    de1Var.f33099s.setLocalMatrix(de1Var.f33100w);
                    de1Var.v.setAlpha((int) (de1Var.f33101x * 255.0f));
                    canvas2 = canvas;
    ...
    public boolean drawChild(Canvas canvas, View view, long j3) {
        switch (this.f32146a) {
            case 1:
                ...
                canvas.save();
                canvas.clipRect(0.0f, AndroidUtilities.lerp(de1Var.L, 0.0f, de1Var.f33101x), getWidth(), AndroidUtilities.lerp(de1Var.M, getHeight(), de1Var.f33101x));
        ...
        switch (this.f32146a) {
            case 2:
                ...
                for (int i12 = 0; i12 < getChildCount(); i12++) {
                    ...
                    org.telegram.ui.Components.rk0 rk0Var = de1Var.P;
                    if (childAt == rk0Var) {
    ...
    public void onSizeChanged(int i10, int i11, int i12, int i13) {
        switch (this.f32146a) {
            case 0:
                ...
                de1 de1Var = this.f32147b;
                gh.d.c(de1Var.E, de1Var.f33090b);
                de1Var.F.d();
                return;
            default:
                super.onSizeChanged(i10, i11, i12, i13);
