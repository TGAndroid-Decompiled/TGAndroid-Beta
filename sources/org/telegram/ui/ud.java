        ...
        switch (this.f38059a) {
            case 0:
                if (tL_error != null) {
                    ...
                    ke keVar = this.f38060b;
                    AndroidUtilities.runOnUIThread(new od(keVar, 4));
                    MessagesController.getInstance(keVar.f35178y0).processUpdates((TLRPC.Updates) tLObject, false);
                    return;
                } else {
                    return;
                }
            case 1:
                final ke keVar2 = this.f38060b;
                        ...
                        switch (r3) {
                            case 0:
                                ...
                                if (tLObject2 instanceof TLRPC.TL_payments_starsRevenueStats) {
                                    ...
                                    keVar3.f35168p1 = bb1.f0(statsGraph, LocaleController.getString(R.string.MonetizationGraphRevenue), 2, false);
                                    na1 na1Var = keVar3.f35167o1;
                                    if (na1Var != null) {
                                        na1Var.f35979n = true;
                                    }
                                    keVar3.f35163j1 = tL_payments_starsRevenueStats.usd_rate;
                                    keVar3.g0(true, tL_payments_starsRevenueStats.status);
                                    keVar3.f35156c1.animate().alpha(0.0f).setDuration(380L).setInterpolator(org.telegram.ui.Components.qr.h).withEndAction(new od(keVar3, 6)).start();
                                    keVar3.a0();
                                    return;
                                }
                                return;
                        ...
                        switch (r3) {
                            case 0:
                                ...
                                if (tLObject2 instanceof TLRPC.TL_payments_starsRevenueStats) {
                                    ...
                                    na1 f02 = bb1.f0(tL_payments_starsRevenueStats.top_hours_graph, LocaleController.getString(R.string.MonetizationGraphImpressions), 0, false);
                                    ke keVar32 = keVar3;
                                    keVar32.f35167o1 = f02;
                                    TL_stats.StatsGraph statsGraph = tL_payments_starsRevenueStats.revenue_graph;
                                    if (statsGraph != null) {
                                        statsGraph.rate = (float) (1.0E7d / tL_payments_starsRevenueStats.usd_rate);
                                    }
                                    keVar32.f35168p1 = bb1.f0(statsGraph, LocaleController.getString(R.string.MonetizationGraphRevenue), 2, false);
                                    na1 na1Var = keVar32.f35167o1;
                                    if (na1Var != null) {
                                        na1Var.f35979n = true;
                                    }
                                    keVar32.f35163j1 = tL_payments_starsRevenueStats.usd_rate;
                                    keVar32.g0(true, tL_payments_starsRevenueStats.status);
                                    keVar32.f35156c1.animate().alpha(0.0f).setDuration(380L).setInterpolator(org.telegram.ui.Components.qr.h).withEndAction(new od(keVar32, 6)).start();
                                    keVar32.a0();
                                    return;
                                }
                                return;
