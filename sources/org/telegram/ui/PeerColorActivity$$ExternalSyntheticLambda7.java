...
public final class PeerColorActivity$$ExternalSyntheticLambda7 implements Utilities.Callback2 {
    ...
    public PeerColorActivity$$ExternalSyntheticLambda7(NotificationCenter.NotificationCenterDelegate notificationCenterDelegate, Object obj, TL_stars.TL_starGiftUnique tL_starGiftUnique, long j, Object obj2, int i) {
        this.$r8$classId = i;
    ...
    public final void run(Object obj, Object obj2) {
        switch (this.$r8$classId) {
            case 0:
                ((PeerColorActivity) this.f$0).lambda$buy$7((boolean[]) this.f$1, this.f$2, this.f$3, (Utilities.Callback) this.f$4, (StarGiftSheet.PaymentFormState) obj, (Browser.Progress) obj2);
                break;
            default:
                ...
                if (((Boolean) obj).booleanValue()) {
                    ...
                    if (giftMessageBottomSheet != null) {
                        AndroidUtilities.runOnUIThread(new StarGiftSheet$$ExternalSyntheticLambda182(giftMessageBottomSheet, 0));
