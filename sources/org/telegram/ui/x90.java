...
public final class x90 implements Runnable {
    public final LaunchActivity f39220a;
    public final org.telegram.ui.ActionBar.n2 f39221b;
    public final int f39222c;
    public final TLRPC.User d;
    public final TLRPC.TL_messages_botApp e;
    public final AtomicBoolean f39223f;
    public final String h;
    public final boolean f39224n;
    public final boolean f39225r;
    public final boolean f39226s;
    public final boolean v;

    public x90(LaunchActivity launchActivity, org.telegram.ui.ActionBar.n2 n2Var, int i10, TLRPC.User user, TLRPC.TL_messages_botApp tL_messages_botApp, AtomicBoolean atomicBoolean, String str, boolean z10, boolean z11, boolean z12, boolean z13) {
        this.f39220a = launchActivity;
        this.f39221b = n2Var;
        this.f39222c = i10;
        this.d = user;
        this.e = tL_messages_botApp;
        this.f39223f = atomicBoolean;
        this.h = str;
        this.f39224n = z10;
        this.f39225r = z11;
        this.f39226s = z12;
    ...
    public final void run() {
        ...
        org.telegram.ui.ActionBar.n2 n2Var = this.f39221b;
        if (n2Var != null && LaunchActivity.C1) {
            LaunchActivity launchActivity = this.f39220a;
            if (!launchActivity.isFinishing() && !launchActivity.isDestroyed()) {
                ...
                boolean z10 = this.f39223f.get();
                int i10 = this.f39222c;
                String str = this.h;
                boolean z11 = this.f39224n;
                boolean z12 = this.f39225r;
                ...
                if (launchActivity.P() == null || launchActivity.P().k(b10) == null) {
                    SharedPrefsHelper.setWebViewConfirmShown(launchActivity.O, user.f18230id, true);
                    ei.k3 k3Var = new ei.k3(launchActivity, n2Var.getResourceProvider());
                    ei.b3 b3Var = k3Var.f8439x;
                    if (b3Var != null) {
                        b3Var.setWasOpenedByLinkIntent(this.f39226s);
                    }
                    k3Var.w(!z11);
                    if (z12) {
                        k3Var.x(true, false, k3Var.f8416e0);
                    }
                    k3Var.A0 = false;
                    k3Var.f8423k0 = launchActivity;
                    k3Var.s(n2Var, b10);
                    k3Var.show();
