...
public final class eg implements ch.a {
    ...
    public final void f(Canvas canvas, RectF rectF) {
        ...
        switch (this.f36049a) {
            case 0:
                um umVar2 = this.f36050b;
                co coVar = umVar2.J0;
                co coVar2 = coVar.f35262da;
                if (coVar2 != null) {
                    umVar = coVar2.X0;
                } else {
                    umVar = coVar.X0;
                ...
                um umVar3 = umVar;
                float f7 = coVar.f35525yc.f15395e;
                int i10 = (int) ((1.0f - f7) * 255.0f);
                int i11 = (int) (255.0f * f7);
                if (f7 > 0.0f) {
                    canvas.drawColor(org.telegram.ui.ActionBar.j6.l1(f7 * 0.85f, coVar.getThemedColor(org.telegram.ui.ActionBar.j6.f20691d6)));
                }
                hh.d.a(new eg(umVar2, 1), canvas, rectF, coVar.f35501x0, umVar3, i10);
                bi.o0 o0Var = coVar.L3;
                if (o0Var != null) {
                    hh.d.a(o0Var, canvas, rectF, o0Var, umVar3, i11);
                }
                di.i1 i1Var = coVar.f35411q1;
                if (i1Var != null && i1Var.getVisibility() == 0) {
                    int childCount = coVar.f35411q1.getChildCount();
                    for (int i12 = 0; i12 < childCount; i12++) {
                        View childAt = coVar.f35411q1.getChildAt(i12);
                        if ((childAt instanceof fo) && childAt.getVisibility() == 0) {
                            fo foVar = (fo) childAt;
                            eo eoVar = foVar.f36465a;
                            um umVar4 = eoVar.X0;
            ...
            default:
                ...
                co coVar3 = this.f36050b.J0;
                if (coVar3.f35501x0.Y0()) {
                    coVar3.f35501x0.f(canvas, rectF);
                    return;
                }
                coVar3.f35501x0.v1(canvas, rectF);
                for (int i13 = 0; i13 < coVar3.f35501x0.getChildCount(); i13++) {
                    View childAt2 = coVar3.f35501x0.getChildAt(i13);
                    if (!co.d2(coVar3, childAt2, rectF)) {
                        if (childAt2 instanceof org.telegram.ui.Cells.t1) {
                            ...
                            canvas.restore();
                            coVar3.f35501x0.drawChild(canvas, childAt2, uptimeMillis);
                            if (t1Var.U2()) {
                                canvas.save();
                ...
                coVar3.f35501x0.w1(canvas, rectF);
                return;
        }
    }
}
