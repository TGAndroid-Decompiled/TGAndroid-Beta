    ...
    public final void f(Canvas canvas, RectF rectF) {
        ...
        switch (this.f36022a) {
            case 0:
                ...
                um umVar3 = umVar;
                float f7 = coVar.f35498yc.f15368e;
                int i10 = (int) ((1.0f - f7) * 255.0f);
                int i11 = (int) (255.0f * f7);
                if (f7 > 0.0f) {
                    canvas.drawColor(org.telegram.ui.ActionBar.j6.l1(f7 * 0.85f, coVar.getThemedColor(org.telegram.ui.ActionBar.j6.f20664d6)));
                }
                hh.d.a(new eg(umVar2, 1), canvas, rectF, coVar.f35474x0, umVar3, i10);
                bi.o0 o0Var = coVar.L3;
                if (o0Var != null) {
                    hh.d.a(o0Var, canvas, rectF, o0Var, umVar3, i11);
                }
                di.i1 i1Var = coVar.f35384q1;
                if (i1Var != null && i1Var.getVisibility() == 0) {
                    int childCount = coVar.f35384q1.getChildCount();
                    for (int i12 = 0; i12 < childCount; i12++) {
                        View childAt = coVar.f35384q1.getChildAt(i12);
                        if ((childAt instanceof fo) && childAt.getVisibility() == 0) {
                            fo foVar = (fo) childAt;
                            eo eoVar = foVar.f36438a;
                            um umVar4 = eoVar.X0;
            ...
            default:
                ...
                co coVar3 = this.f36023b.J0;
                if (coVar3.f35474x0.Y0()) {
                    coVar3.f35474x0.f(canvas, rectF);
                    return;
                }
                coVar3.f35474x0.v1(canvas, rectF);
                for (int i13 = 0; i13 < coVar3.f35474x0.getChildCount(); i13++) {
                    View childAt2 = coVar3.f35474x0.getChildAt(i13);
                    if (!co.d2(coVar3, childAt2, rectF)) {
                        if (childAt2 instanceof org.telegram.ui.Cells.t1) {
                            ...
                            canvas.restore();
                            coVar3.f35474x0.drawChild(canvas, childAt2, uptimeMillis);
                            if (t1Var.U2()) {
                                canvas.save();
                ...
                coVar3.f35474x0.w1(canvas, rectF);
                return;
        }
    }
}
