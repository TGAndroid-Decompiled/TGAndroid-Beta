...
public final class eg implements Utilities.Callback2 {
    ...
    public final void run(Object obj, Object obj2) {
        ...
        Object obj3 = this.d;
        Object obj4 = this.f36588c;
        switch (i10) {
            case 0:
                AndroidUtilities.runOnUIThread(new eg.d3((xn) obj4, this.f36587b, (Boolean) obj, (TLRPC.WebPage) obj2, (TL_account.getWebPagePreview) obj3, 12));
                return;
            case 1:
                ...
                AndroidUtilities.runOnUIThread(new eg.d3(launchActivity, v10Var, tL_error, updates, this.f36587b, 22));
                return;
            default:
    ...
    public eg(LaunchActivity launchActivity, v10 v10Var, int i10) {
        this.f36586a = 1;
        this.f36588c = launchActivity;
        this.d = v10Var;
        this.f36587b = i10;
    }
}
