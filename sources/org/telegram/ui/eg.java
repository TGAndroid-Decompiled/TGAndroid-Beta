    ...
    public final void f(Canvas canvas, RectF rectF) {
        ...
        switch (this.f33330a) {
            case 0:
                ...
                tm tmVar3 = tmVar;
                float f7 = boVar.f32548yc.e;
                int i10 = (int) ((1.0f - f7) * 255.0f);
                int i11 = (int) (255.0f * f7);
                if (f7 > 0.0f) {
                    canvas.drawColor(org.telegram.ui.ActionBar.i6.l1(f7 * 0.85f, boVar.getThemedColor(org.telegram.ui.ActionBar.i6.f18836d6)));
                }
                gh.d.b(new eg(tmVar2, 1), canvas, rectF, boVar.f32524x0, tmVar3, i10);
                ...
                if (i1Var != null && i1Var.getVisibility() == 0) {
                    int childCount = boVar.f32434q1.getChildCount();
                    for (int i12 = 0; i12 < childCount; i12++) {
                        View childAt = boVar.f32434q1.getChildAt(i12);
                        if ((childAt instanceof eo) && childAt.getVisibility() == 0) {
                            eo eoVar = (eo) childAt;
                            co coVar = eoVar.f33375a;
                            tm tmVar4 = coVar.X0;
            ...
            default:
                ...
                bo boVar3 = this.f33331b.J0;
                if (boVar3.f32524x0.Z0()) {
                    boVar3.f32524x0.f(canvas, rectF);
                    return;
                }
                boVar3.f32524x0.w1(canvas, rectF);
                for (int i13 = 0; i13 < boVar3.f32524x0.getChildCount(); i13++) {
                    View childAt2 = boVar3.f32524x0.getChildAt(i13);
                    if (!bo.d2(boVar3, childAt2, rectF)) {
                        if (childAt2 instanceof org.telegram.ui.Cells.t1) {
                            ...
                            canvas.restore();
                            boVar3.f32524x0.drawChild(canvas, childAt2, uptimeMillis);
                            if (t1Var.U2()) {
                                canvas.save();
                ...
                boVar3.f32524x0.x1(canvas, rectF);
                return;
        }
    }
}
