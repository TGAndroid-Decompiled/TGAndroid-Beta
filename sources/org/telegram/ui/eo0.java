...
public final class eo0 extends WebViewClient {
    ...
    public final boolean onRenderProcessGone(WebView webView, RenderProcessGoneDetail renderProcessGoneDetail) {
        ...
        try {
            ...
            alertDialog$Builder.f19478a.Q = AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.ChromeCrashMessage), new gl0(this, 9));
    ...
    public final boolean shouldOverrideUrlLoading(WebView webView, String str) {
        ...
        boolean z4;
        lo0 lo0Var = this.f33836b;
        lo0Var.f35850y = !str.equals(lo0Var.f35848x);
        try {
            parse = Uri.parse(str);
        ...
        if (!lo0.f35814e1.contains(parse.getScheme())) {
            if (!lo0.f35813d1.contains(parse.getScheme())) {
                try {
                    ...
                    AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(this.f33835a);
