...
public final class on extends org.telegram.ui.ActionBar.e5 {
    ...
    public final boolean b() {
        ...
        if (!wnVar2.f39732zc.f14201f) {
            if (wnVar2.f39659u3 != null && wnVar2.f39593p1 != null) {
                ...
                int currentPosition = wnVar2.f39593p1.f28850a.getCurrentPosition();
                int i10 = wnVar2.f39618r1;
                if (currentPosition != i10) {
                    wnVar2.f39593p1.f28850a.d(i10, i10);
                    return false;
                }
    ...
    public final void m() {
        ...
        if (wnVar.f39605q1 != null) {
            if (wnVar.f39593p1.f28850a.getCurrentPosition() != 0) {
                wnVar.f39593p1.f28850a.d(0, 0);
                wnVar.f39632s1 = true;
            } else {
        ...
        wnVar.yc(0, true);
        wnVar.Wc(false);
        ValueAnimator ofFloat = ValueAnimator.ofFloat(this.f36270f, 0.0f);
    ...
    public final void n() {
        ...
        if (wnVar.W4) {
            ...
            org.telegram.ui.Components.j40 j40Var = wnVar.f39509i2;
            if (j40Var != null) {
                j40Var.b(true);
            }
        }
        ValueAnimator ofFloat = ValueAnimator.ofFloat(this.f36270f, 1.0f);
        ...
        if (wnVar.f39659u3 != null && (hkVar = wnVar.f39593p1) != null) {
            int currentPosition = hkVar.f28850a.getCurrentPosition();
            int i11 = wnVar.f39618r1;
            if (currentPosition != i11) {
                wnVar.f39593p1.f28850a.d(i11, i11);
            }
        }
    }
    ...
    public final void p(ci.h2 h2Var) {
        ...
        if (!TextUtils.isEmpty(str) && (wnVar.f39647t3.startsWith("$") || wnVar.f39647t3.startsWith("#"))) {
            ...
            if (hkVar2 != null && hkVar2.f28850a.getCurrentPosition() != 0) {
                wnVar.f39593p1.f28850a.d(0, 0);
            }
        }
