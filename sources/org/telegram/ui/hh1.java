...
public final class hh1 extends ScrollView {
    ...
    public hh1(ih1 ih1Var, Context context) {
        super(context);
        this.e = ih1Var;
        this.f34279a = new int[2];
        this.f34280b = new Rect();
        this.f34281c = true;
    }
    ...
    public final void onScrollChanged(int i10, int i11, int i12, int i13) {
        ...
        ih1 ih1Var = this.e;
        TextView textView = ih1Var.f34580c;
        if (textView != null) {
            int[] iArr = this.f34279a;
            textView.getLocationOnScreen(iArr);
            int measuredHeight = ih1Var.f34580c.getMeasuredHeight() + iArr[1];
            ...
            if (ih1Var.f34580c.getTag() == null) {
                z11 = true;
            } else {
                z11 = false;
            }
            if (z10 != z11) {
                TextView textView2 = ih1Var.f34580c;
                if (z10) {
                    num = null;
                } else {
                    num = 1;
    ...
    public final void requestChildFocus(View view, View view2) {
        if (Build.VERSION.SDK_INT < 29 && view2 != null && !this.f34281c) {
