...
public final class kb extends tb {
    public final hh.l f35185x0;
    public final wb f35186y0;

    public kb(wb wbVar, Context context) {
        super(wbVar, context);
        this.f35186y0 = wbVar;
        this.f35185x0 = new hh.l();
    }
    ...
    public final void onAttachedToWindow() {
        ...
        if (playingMessageObject != null && playingMessageObject.isRoundVideo() && playingMessageObject.eventId != 0) {
            ...
            if (dialogId == (-wbVar.f38657f.f18121id)) {
                MediaController.getInstance().setTextureView(wbVar.Q0(false), wbVar.f38656e0, wbVar.f38655d0, true);
            }
        }
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        wb wbVar = this.f35186y0;
        fh.a aVar = wbVar.f38649a.f9081a;
        ...
        for (int i12 = 0; i12 < childCount; i12++) {
            ...
            if (childAt != null && childAt.getVisibility() != 8) {
                ...
                if (childAt != kVar4) {
                    if (childAt != wbVar.v && childAt != wbVar.f38665n) {
                        if (childAt == wbVar.H) {
