...
public final class f2 extends FrameLayout implements org.telegram.ui.Cells.q9, d3 {
    public final u70 f33472a;
    public final f4 f33473b;
    public a3 f33474c;
    public final ii.a4 d;
    public final e2 e;
    public TL_iv.pageBlockPreformatted f33475f;
    ...
    public int getBoundLeft() {
        ...
        int a2 = this.f33474c.a() + AndroidUtilities.dp(16.0f);
    ...
    public int getBoundRight() {
        ...
        int b10 = this.f33474c.b() + AndroidUtilities.dp(16.0f);
        this.f33472a.getClass();
    ...
    public int getLastLineBoundRight() {
        ...
        int c10 = this.f33474c.c() + AndroidUtilities.dp(16.0f);
        this.f33472a.getClass();
    ...
    public final void onDraw(Canvas canvas) {
        ...
        canvas.drawRect(0.0f, AndroidUtilities.dp(8.0f), getMeasuredWidth(), getMeasuredHeight() - AndroidUtilities.dp(8.0f), h4.f34099p1);
    }
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        accessibilityNodeInfo.setText(h4.i(R.string.AccDescrIVCode, h4.j(this.f33472a, this.f33473b, a3Var)));
    }
    ...
    public void setBlock(TL_iv.pageBlockPreformatted pageblockpreformatted) {
        this.h = null;
        this.f33475f = pageblockpreformatted;
        this.d.setScrollX(0);
