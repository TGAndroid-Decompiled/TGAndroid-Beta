...
public final class hn0 implements Runnable {
    ...
    public final oo0 f34260b;
    public final TLObject f34261c;

    public hn0(oo0 oo0Var, TLObject tLObject, int i10) {
        this.f34259a = i10;
        this.f34260b = oo0Var;
        this.f34261c = tLObject;
    }
    ...
    public final void run() {
        switch (this.f34259a) {
            case 0:
                oo0.e0(this.f34260b, this.f34261c);
                return;
            case 1:
                oo0 oo0Var = this.f34260b;
                Utilities.Callback callback = oo0Var.f36286d1;
                TLObject tLObject = this.f34261c;
                if (callback != null) {
                    callback.run((TLRPC.TL_payments_paymentVerificationNeeded) tLObject);
                }
                oo0Var.D0(false);
                oo0Var.f36316z0 = true;
                oo0Var.H0(true, true);
                org.telegram.ui.Components.vq vqVar = oo0Var.f36303r;
                if (vqVar != null) {
                    vqVar.setVisibility(0);
                }
                org.telegram.ui.ActionBar.u0 u0Var = oo0Var.f36298n;
                if (u0Var != null) {
                ...
                WebView webView = oo0Var.f36310w;
                if (webView != null) {
                    webView.setVisibility(0);
                    WebView webView2 = oo0Var.f36310w;
                ...
                return;
            default:
                oo0.c0(this.f34260b, this.f34261c);
                return;
        }
    }
}
