    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            if (velocityTracker3 != null) {
                ...
                profileActivity.f33919i2 = this.Y2.getYVelocity(motionEvent.getPointerId(motionEvent.getActionIndex()));
            }
        ...
        if (action == 2) {
            ...
            if (profileActivity.f33951n2 && !profileActivity.I0) {
                O3 = profileActivity.T3();
            } else {
                i12 = profileActivity.f33857a.getMeasuredWidth();
        ...
        if ((action == 1 || action == 3) && (m10 = profileActivity.f33872c.m(0)) != null) {
            if (profileActivity.O1) {
                profileActivity.O1 = false;
                profileActivity.f33857a.N0 = true;
            }
            if (profileActivity.f33958o2) {
                if (profileActivity.f33965p2) {
                    ...
                    profileActivity.f33857a.v0(0, ((m10.getTop() - profileActivity.f33857a.getMeasuredWidth()) - profileActivity.O3()) + currentActionBarHeight2 + i10, org.telegram.ui.Components.pr.h);
                    return onTouchEvent;
                }
                profileActivity.f33857a.v0(0, m10.getTop() - profileActivity.T3(), org.telegram.ui.Components.pr.h);
                return onTouchEvent;
            }
            ...
            if (z10) {
                ...
                if (f7 > 0.0f && ((f7 < profileActivity.T3() * 0.6f || profileActivity.f33919i2 < -1000.0f) && profileActivity.Q1 > profileActivity.O3() * 0.6f)) {
                    profileActivity.f33857a.v0(0, (int) (profileActivity.Q1 - profileActivity.O3()), org.telegram.ui.Components.pr.h);
                    return onTouchEvent;
                }
            }
            if (z10) {
                ...
                if (f10 > 0.0f && f10 < profileActivity.O3() * 0.6f) {
                    profileActivity.f33857a.v0(0, (int) (profileActivity.O3() - profileActivity.Q1), org.telegram.ui.Components.pr.h);
                    return onTouchEvent;
                }
            }
            if (!z10) {
                float f11 = profileActivity.Q1;
                if (f11 > 0.0f && profileActivity.f33919i2 < -1000.0f) {
                    profileActivity.f33857a.v0(0, (int) f11, org.telegram.ui.Components.pr.h);
                    return onTouchEvent;
                }
            }
