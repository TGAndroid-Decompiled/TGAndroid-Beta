...
public final class od0 implements RequestDelegate {
    ...
    public final wg0 f36193b;
    public final TLRPC.auth_SentCode f36194c;
    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        switch (this.f36192a) {
            case 0:
                ...
                final wg0 wg0Var = this.f36193b;
                final TLRPC.auth_SentCode auth_sentcode = this.f36194c;
            ...
            default:
                ...
                final wg0 wg0Var2 = this.f36193b;
                final TLRPC.auth_SentCode auth_sentcode2 = this.f36194c;
                final Bundle bundle2 = this.d;
                if (z12) {
                    wg0Var2.k1(false, true);
                    wg0Var2.f39211o0 = false;
