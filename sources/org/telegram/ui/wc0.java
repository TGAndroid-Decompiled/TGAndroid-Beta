        ...
        switch (this.f38682a) {
            case 0:
                ...
                if (kd0Var.I != null) {
                    ...
                    TLRPC.TL_channelLocation tL_channelLocation = kd0Var.f35248z0;
                    if (tL_channelLocation != null) {
                        ...
                        if (DialogObject.isUserDialog(kd0Var.f35221e0)) {
                            obj2.f33368c = kd0Var.getMessagesController().getUser(Long.valueOf(kd0Var.f35221e0));
                        } else {
                            obj2.d = kd0Var.getMessagesController().getChat(Long.valueOf(-kd0Var.f35221e0));
                        }
                        obj2.f33366a = kd0Var.f35221e0;
                        kd0Var.v0(obj2);
                        try {
                            ...
                            if (g02 != null) {
                                ...
                                if (!UserObject.isUserSelf(obj2.f33368c)) {
                                    IMapsProvider.IMarkerOptions flat = ApplicationLoader.getMapsProvider().onCreateMarkerOptions().position(latLng).flat(true);
                                    flat.icon(R.drawable.map_pin_circle);
                                    flat.anchor(0.5f, 0.5f);
                                    obj2.f33369f = kd0Var.I.addMarker(flat);
                                }
                                kd0Var.f35224g0.add(obj2);
                                kd0Var.f35225h0.k(obj2, obj2.f33366a);
                            }
                        } catch (Exception e) {
                            FileLog.e(e);
                        }
                        ...
                        if (messageObject != null) {
                            if (messageObject.isLiveLocation()) {
                                ...
                                IMapsProvider.LatLng latLng2 = new IMapsProvider.LatLng(kd0Var.f35245x0.getLatitude(), kd0Var.f35245x0.getLongitude());
                                try {
                                ...
                                kd0Var.f35223f0 = false;
                                kd0Var.l0();
                            }
                        } else {
                            Location location = new Location("network");
                            kd0Var.f35245x0 = location;
                            ...
                            if (tL_channelLocation2 != null) {
                                ...
                                kd0Var.f35245x0.setLatitude(kd0Var.A0.geo_point.lat);
                                kd0Var.f35245x0.setLongitude(kd0Var.A0.geo_point._long);
                                kd0Var.f35245x0.setAccuracy(kd0Var.A0.geo_point.accuracy_radius);
                                kd0Var.T.L(kd0Var.f35245x0);
                            } else {
                                location.setLatitude(20.659322d);
                                kd0Var.f35245x0.setLongitude(-11.40625d);
                            }
                        }
                    }
                    try {
                    ...
                    for (int size = providers.size() - 1; size >= 0; size--) {
                        ...
                        if (location2 != null) {
                            kd0Var.f35243w0 = location2;
                            kd0Var.t0(location2);
                            if (kd0Var.f35217b0 && kd0Var.getParentActivity() != null) {
                                kd0Var.f35217b0 = false;
                                kd0Var.d0();
                            }
                            imageView = kd0Var.f35218c;
                            if (imageView == null && imageView.getVisibility() == 0 && (sharingLocationInfo = kd0Var.getLocationController().getSharingLocationInfo(kd0Var.f35221e0)) != null && (i11 = sharingLocationInfo.proximityMeters) > 0) {
                                kd0Var.e0(i11);
                                return;
                            }
                            return;
                ...
                return;
            default:
                kd0 kd0Var2 = this.f38683b;
                Location location3 = (Location) obj;
                kd0Var2.t0(location3);
                kd0Var2.getLocationController().setMapLocation(location3, kd0Var2.f35220d0);
                kd0Var2.f35220d0 = false;
                return;
        }
    }
}
