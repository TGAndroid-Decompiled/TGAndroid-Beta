...
public final class wc0 extends fg.t0 {
    ...
    public wc0(id0 id0Var, Context context, int i10, long j3, org.telegram.ui.ActionBar.f6 f6Var, boolean z10, boolean z11) {
        ...
        this.f37829n0 = id0Var;
        this.m0 = true;
    }

    @Override
    public final void K() {
        this.f37829n0.r0(null);
    }

    @Override
    public final void N(ArrayList arrayList) {
        int i10;
        id0 id0Var = this.f37829n0;
        ...
        if (messageObject != null && messageObject.isLiveLocation()) {
            ...
            if (arrayList != null) {
                ...
                for (int i12 = 0; i12 < arrayList.size(); i12++) {
                    ...
                    if (cd0Var != null && !UserObject.isUserSelf(cd0Var.f31644c)) {
                        i10++;
                    }
                }
            } else {
            ...
            if (this.m0 && i10 == 1) {
                id0Var.f33626i0 = ((cd0) arrayList.get(0)).f31642a;
            }
            this.m0 = false;
