        ...
        switch (this.f38794a) {
            case 0:
                ...
                if (kd0Var.I != null) {
                    ...
                    TLRPC.TL_channelLocation tL_channelLocation = kd0Var.f35127z0;
                    if (tL_channelLocation != null) {
                        ...
                        if (DialogObject.isUserDialog(kd0Var.f35100e0)) {
                            obj2.f33313c = kd0Var.getMessagesController().getUser(Long.valueOf(kd0Var.f35100e0));
                        } else {
                            obj2.d = kd0Var.getMessagesController().getChat(Long.valueOf(-kd0Var.f35100e0));
                        }
                        obj2.f33311a = kd0Var.f35100e0;
                        kd0Var.v0(obj2);
                        try {
                            ...
                            if (g02 != null) {
                                ...
                                if (!UserObject.isUserSelf(obj2.f33313c)) {
                                    IMapsProvider.IMarkerOptions flat = ApplicationLoader.getMapsProvider().onCreateMarkerOptions().position(latLng).flat(true);
                                    flat.icon(R.drawable.map_pin_circle);
                                    flat.anchor(0.5f, 0.5f);
                                    obj2.f33314f = kd0Var.I.addMarker(flat);
                                }
                                kd0Var.f35103g0.add(obj2);
                                kd0Var.f35104h0.k(obj2, obj2.f33311a);
                            }
                        } catch (Exception e) {
                            FileLog.e(e);
                        }
                        ...
                        if (messageObject != null) {
                            if (messageObject.isLiveLocation()) {
                                ...
                                IMapsProvider.LatLng latLng2 = new IMapsProvider.LatLng(kd0Var.f35124x0.getLatitude(), kd0Var.f35124x0.getLongitude());
                                try {
                                ...
                                kd0Var.f35102f0 = false;
                                kd0Var.l0();
                            }
                        } else {
                            Location location = new Location("network");
                            kd0Var.f35124x0 = location;
                            ...
                            if (tL_channelLocation2 != null) {
                                ...
                                kd0Var.f35124x0.setLatitude(kd0Var.A0.geo_point.lat);
                                kd0Var.f35124x0.setLongitude(kd0Var.A0.geo_point._long);
                                kd0Var.f35124x0.setAccuracy(kd0Var.A0.geo_point.accuracy_radius);
                                kd0Var.T.L(kd0Var.f35124x0);
                            } else {
                                location.setLatitude(20.659322d);
                                kd0Var.f35124x0.setLongitude(-11.40625d);
                            }
                        }
                    }
                    try {
                    ...
                    for (int size = providers.size() - 1; size >= 0; size--) {
                        ...
                        if (location2 != null) {
                            kd0Var.f35122w0 = location2;
                            kd0Var.t0(location2);
                            if (kd0Var.f35096b0 && kd0Var.getParentActivity() != null) {
                                kd0Var.f35096b0 = false;
                                kd0Var.d0();
                            }
                            imageView = kd0Var.f35097c;
                            if (imageView == null && imageView.getVisibility() == 0 && (sharingLocationInfo = kd0Var.getLocationController().getSharingLocationInfo(kd0Var.f35100e0)) != null && (i11 = sharingLocationInfo.proximityMeters) > 0) {
                                kd0Var.e0(i11);
                                return;
                            }
                            return;
                ...
                return;
            default:
                kd0 kd0Var2 = this.f38795b;
                Location location3 = (Location) obj;
                kd0Var2.t0(location3);
                kd0Var2.getLocationController().setMapLocation(location3, kd0Var2.f35099d0);
                kd0Var2.f35099d0 = false;
                return;
        }
    }
}
