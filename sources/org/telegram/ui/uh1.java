...
public final class uh1 implements TextWatcher {
    public final UsersSelectActivity f41101a;

    public uh1(UsersSelectActivity usersSelectActivity) {
        this.f41101a = usersSelectActivity;
    }

    @Override
    public final void afterTextChanged(Editable editable) {
        UsersSelectActivity usersSelectActivity = this.f41101a;
        if (usersSelectActivity.f34240c.length() != 0) {
            xh1 xh1Var = usersSelectActivity.h;
            boolean z10 = xh1Var.f42734n;
            if (!z10) {
                ...
                usersSelectActivity.f34242f.d.setText(LocaleController.getString(R.string.NoResult));
            }
            usersSelectActivity.f34242f.e(true, true);
            usersSelectActivity.h.L(usersSelectActivity.f34240c.getText().toString());
            return;
        }
        ...
        usersSelectActivity.f34242f.d.setText(LocaleController.getString(R.string.NoContacts));
    }
