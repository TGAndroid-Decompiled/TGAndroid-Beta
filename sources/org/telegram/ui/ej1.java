...
public final class ej1 extends org.telegram.ui.ActionBar.g5 {
    public final WallpapersListActivity f36102f;

    public ej1(WallpapersListActivity wallpapersListActivity) {
        this.f36102f = wallpapersListActivity;
    }

    @Override
    public final void k() {
        WallpapersListActivity wallpapersListActivity = this.f36102f;
    ...
    public final void q(EditText editText) {
        this.f36102f.J.E(editText.getText().toString(), false);
    }
}
