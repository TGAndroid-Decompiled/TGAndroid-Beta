...
public final class y30 extends FrameLayout {
    public final Rect f40045a;
    public final RectF f40046b;
    public final Path f40047c;
    public final d60 d;

    public y30(d60 d60Var, LaunchActivity launchActivity) {
        super(launchActivity);
        this.d = d60Var;
        this.f40045a = new Rect();
        this.f40046b = new RectF();
        this.f40047c = new Path();
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (d60Var.f32948d2 != 1.0f) {
            if (d60Var.X2 != null && d60Var.f32940b3) {
                canvas.save();
                ...
                float f7 = d60Var.f32948d2;
                int dp = (int) ((AndroidUtilities.dp(13.0f) * f7) + ((1.0f - d60Var.f32948d2) * measuredHeight));
                ...
                canvas.restore();
            } else if (d60Var.f32935a3 != null && d60Var.Z2 == null && d60Var.O2) {
                canvas.save();
                float measuredHeight2 = (d60Var.f32935a3.getAvatarImageView().getMeasuredHeight() / 2.0f) * (getMeasuredHeight() / d60Var.f32935a3.getAvatarImageView().getMeasuredHeight());
                float f10 = d60Var.f32948d2;
                int dp2 = (int) ((AndroidUtilities.dp(13.0f) * f10) + ((1.0f - d60Var.f32948d2) * measuredHeight2));
                int i11 = (int) ((1.0f - f10) * measuredHeight2);
                d60Var.f32935a3.getAvatarImageView().getImageReceiver().setImageCoords(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight());
                d60Var.f32935a3.getAvatarImageView().r(dp2, dp2, i11, i11);
                d60Var.f32935a3.getAvatarImageView().getImageReceiver().draw(canvas);
                d60Var.f32935a3.getAvatarImageView().setRoundRadius(d60Var.f32935a3.getAvatarImageView().getMeasuredHeight() / 2);
                canvas.restore();
            }
        }
        x30Var.setAlpha(d60Var.f32948d2);
        Path path = this.f40047c;
        path.reset();
        RectF rectF = this.f40046b;
        ...
        if (x30Var.f22659i1) {
            for (int i12 = 0; i12 < x30Var.getChildCount(); i12++) {
                ...
                if (childAt instanceof org.telegram.ui.Components.xh0) {
                    break;
                }
            }
        }
