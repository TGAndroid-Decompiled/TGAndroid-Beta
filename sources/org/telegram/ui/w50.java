...
public final class w50 {
    ...
    public Emoji.EmojiDrawable f41793c;
    public org.telegram.ui.Components.q5 d;
    public boolean f41794e;
    public boolean f41795f;
    public long f41796g;
    public String f41800l;
    public final Drawable[] f41792b = new Drawable[6];
    public final l20 h = new l20();
    public final HashSet f41797i = new HashSet();
    public boolean f41798j = false;
    public final v50 f41799k = new v50(this, 0);
    public final RectF f41801m = new RectF();

    public w50(int i10) {
        int i11 = 0;
        this.f41791a = i10;
        while (true) {
            Drawable[] drawableArr = this.f41792b;
            if (i11 < drawableArr.length) {
                drawableArr[i11] = Emoji.getEmojiDrawable(j60.A0());
                i11++;
            } else {
                this.f41796g = System.currentTimeMillis();
                return;
            }
        }
    }
    ...
    public final void a() {
        boolean isEmpty = this.f41797i.isEmpty();
        boolean z10 = !isEmpty;
        if (this.f41798j != z10) {
            this.f41798j = z10;
            v50 v50Var = this.f41799k;
            if (!isEmpty) {
    ...
    public final boolean b(Canvas canvas, RectF rectF, float f7) {
        ...
        RectF rectF2 = this.f41801m;
        rectF2.set(rectF);
        float f12 = -dp;
        rectF2.inset(f12, f12);
        canvas.saveLayerAlpha(rectF2.left, rectF2.top, rectF2.right, rectF2.bottom, 255, 31);
        long currentTimeMillis = (this.f41791a * 45) + System.currentTimeMillis();
        long j10 = currentTimeMillis - this.f41796g;
        float f13 = ((float) j10) / 180.0f;
        float min = Math.min(1.0f, f13);
        boolean z10 = this.f41795f;
        Drawable[] drawableArr = this.f41792b;
        boolean z11 = false;
        if (z10 && this.d != null && this.f41793c != null && this.f41794e) {
            rectF2.set(rectF);
            ...
            if (f7 < 1.0f) {
                ...
                f11 = 0.0f;
                j3 = j10;
                this.f41793c.setBounds(0, 0, (int) rectF2.width(), (int) rectF2.height());
                canvas.translate(rectF2.left, rectF2.top);
                this.f41793c.setAlpha((int) ((1.0f - f7) * 255.0f));
                this.f41793c.draw(canvas);
                this.f41793c.setAlpha(255);
                canvas.restore();
            } else {
                j3 = j10;
                f10 = 255.0f;
        ...
        canvas.restore();
        if (f13 >= 1.0f) {
            if (this.f41795f && this.f41794e) {
                z11 = true;
            } else {
                this.f41796g = currentTimeMillis - (j3 % 180);
                int i10 = 0;
    ...
    public final void c() {
        ...
        if (this.d != null && this.f41800l != null) {
            ...
            if (stickerSet != null) {
                String replace = this.f41800l.replace("️", "");
                ...
                FileLog.e("emoji \"" + this.f41800l + "\" not found in addemoji/" + tL_inputStickerSetShortName.short_name);
            }
        }
    }
}
