...
public final class k81 extends org.telegram.ui.Components.vl0 {
        ...
        if (b10 != i10) {
            if (b10 < sessionsActivity.K || b10 >= sessionsActivity.L) {
                if (b10 < sessionsActivity.M || b10 >= sessionsActivity.N) {
                    if ((b10 < sessionsActivity.G || b10 >= sessionsActivity.H) && b10 != sessionsActivity.f31777y) {
    ...
    public final long i(int i10) {
        ...
        } else if (i10 == sessionsActivity.f31776x) {
        ...
        } else if (i10 == sessionsActivity.f31777y) {
            ...
            if (i10 >= i13 && i10 < sessionsActivity.L) {
                ...
                if (i10 >= i14 && i10 < sessionsActivity.N) {
                    ...
                    if (i10 >= i15 && i10 < sessionsActivity.H) {
                        TLObject tLObject2 = (TLObject) sessionsActivity.f31771f.get(i10 - i15);
    ...
    public final int j(int i10) {
        ...
        if (i10 != i11) {
            if (i10 != sessionsActivity.E && i10 != sessionsActivity.O && i10 != sessionsActivity.I && i10 != sessionsActivity.R && i10 != sessionsActivity.U && i10 != sessionsActivity.P) {
                if (i10 != sessionsActivity.f31776x && i10 != sessionsActivity.J && i10 != sessionsActivity.F && i10 != sessionsActivity.T) {
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i13 != 0) {
            if (i13 != 1) {
                if (i13 != 2) {
                    if (i13 != 5) {
                        if (i13 != 6) {
                            org.telegram.ui.Cells.v6 v6Var = (org.telegram.ui.Cells.v6) c1Var.f42946a;
                            SessionsActivity sessionsActivity = this.d;
                            if (i10 == sessionsActivity.f31777y) {
                                TLRPC.TL_authorization tL_authorization = sessionsActivity.f31772n;
                                if (tL_authorization == null) {
                                    v6Var.f21679w = sessionsActivity.d;
                                    v6Var.f21678s = true;
                                    ...
                                    org.telegram.ui.Components.w9 w9Var = v6Var.f21675f;
                                    if (w9Var != null) {
                                ...
                                v6Var.c(tL_authorization, (sessionsActivity.e.isEmpty() && this.d.f31771f.isEmpty() && this.d.Q == -1) ? true : true);
                                return;
                            }
                            ...
                            if (i10 >= i17 && i10 < sessionsActivity.H) {
                                TLObject tLObject2 = (TLObject) sessionsActivity.f31771f.get(i10 - i17);
                                if (i10 != this.d.H - 1) {
                                    z10 = true;
                                }
            ...
            org.telegram.ui.Cells.e9 e9Var = (org.telegram.ui.Cells.e9) c1Var.f42946a;
            e9Var.setFixedSize(0);
            SessionsActivity sessionsActivity4 = this.d;
            if (i10 == sessionsActivity4.E) {
                if (sessionsActivity4.f31775w == 0) {
        ...
        org.telegram.ui.Cells.r8 r8Var = (org.telegram.ui.Cells.r8) c1Var.f42946a;
        i11 = this.d.terminateAllSessionsRow;
        if (i10 == i11) {
            int i19 = org.telegram.ui.ActionBar.h6.f19265p7;
            r8Var.e(i19, i19);
