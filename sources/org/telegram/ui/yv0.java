...
public final class yv0 extends org.telegram.ui.Components.kl0 {
    ...
    public final boolean D(s4.c1 c1Var) {
        ...
        int b10 = c1Var.b();
        aw0 aw0Var = this.d;
        if (b10 != aw0Var.f31979i0 && b10 != aw0Var.f31993u0 && b10 != aw0Var.f31994v0) {
            if (aw0Var.I && b10 >= (i10 = aw0Var.f31984n0) && b10 < aw0Var.f31999y + i10) {
                if (b10 - i10 < aw0Var.f31997x) {
                    return false;
                }
            } else if (b10 != aw0Var.f31985o0 && b10 != aw0Var.f31989r0 && b10 != aw0Var.f31991s0 && (aw0Var.N != 0 || b10 != aw0Var.f31992t0)) {
                return false;
            }
            return true;
        }
    ...
    @Override
    public final int h() {
        return this.d.f31998x0;
    }

    @Override
    public final int j(int i10) {
        aw0 aw0Var = this.d;
        if (i10 != aw0Var.f31978h0 && i10 != aw0Var.m0 && i10 != aw0Var.f31987q0) {
            if (i10 == aw0Var.f31982l0) {
                return 1;
            }
            if (i10 != aw0Var.f31986p0 && i10 != aw0Var.f31996w0 && i10 != aw0Var.f31981k0) {
                ...
                if (i10 == aw0Var.f31980j0) {
                    return 7;
                }
                if (i10 != aw0Var.f31989r0 && i10 != aw0Var.f31991s0 && i10 != aw0Var.f31992t0 && i10 != aw0Var.f31993u0 && i10 != aw0Var.f31994v0) {
                    return 5;
                }
                return 6;
            }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i16 != 0) {
            ...
            if (i16 != 6) {
                ...
                if (i10 == aw0Var.f31981k0) {
                    e9Var.setText(LocaleController.getString(R.string.AddAnExplanationInfo));
                    return;
                } else if (i10 == aw0Var.f31996w0) {
                    e9Var.setFixedSize(12);
                    e9Var.setText(null);
                    return;
                } else {
                    int i17 = aw0Var.f31983n - aw0Var.f31999y;
                    if (i17 <= 0) {
                        if (z10) {
            ...
            if (i10 == aw0Var.f31993u0) {
                ...
                w8Var.e(null, true);
                return;
            } else if (i10 == aw0Var.f31989r0) {
                w8Var.f(LocaleController.getString(R.string.PollAnonymous), aw0Var.G, (aw0Var.f31991s0 == -1 && aw0Var.f31992t0 == -1) ? true : true);
                w8Var.e(null, true);
                return;
            } else if (i10 == aw0Var.f31991s0) {
                String string = LocaleController.getString(R.string.PollMultiple);
                boolean z13 = aw0Var.K;
                if (aw0Var.f31992t0 != -1) {
                    z12 = true;
                }
                w8Var.f(string, z13, z12);
                w8Var.e(null, true);
                return;
            } else if (i10 == aw0Var.f31992t0) {
        ...
        if (i10 == aw0Var.f31978h0) {
            if (z10) {
                if (aw0Var.f32001z0 != null) {
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 != 0) {
            ...
            if (i10 != 1) {
                        ...
                        if (i10 != 4) {
                            if (i10 != 6) {
                                if (i10 != 7) {
                                    ...
                                    xv0Var2.setBackgroundColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18836d6, false));
                                    ...
                                    wv0Var.d();
                                    wv0Var.setBackgroundColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18836d6, false));
                            ...
                            vv0Var.d();
                            vv0Var.setBackgroundColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18836d6, false));
                ...
                xv0Var = new org.telegram.ui.Cells.a7(context, (org.telegram.ui.Cells.p6) null);
            }
        } else {
            View l4Var = new org.telegram.ui.Cells.l4(this.f40001c, org.telegram.ui.ActionBar.i6.L6, 21, 15, false, null);
    ...
    public final void y(s4.c1 c1Var) {
        ...
        if (i13 == 4) {
            ...
            c6Var.setTag(null);
            c6Var.setEnabled(!aw0Var.I);
            b6Var.setEnabled(true ^ aw0Var.I);
            int themedColor = aw0Var.getThemedColor(org.telegram.ui.ActionBar.i6.G6);
            if (!aw0Var.I) {
                f7 = 1.0f;
            }
            b6Var.setTextColor(org.telegram.ui.ActionBar.i6.l1(f7, themedColor));
            ...
            int i14 = b10 - aw0Var.f31984n0;
            if (aw0Var.I && i14 < aw0Var.f31997x) {
                z10 = false;
            } else {
                z10 = true;
            }
            ...
            b6Var2.setTextColor(org.telegram.ui.ActionBar.i6.l1(f7, themedColor2));
            ...
            c6Var2.setTag(null);
            ImageView imageView = c6Var2.f19863f;
            if (imageView != null) {
                if (z10) {
                    i11 = 0;
                } else {
            ...
            if (!aw0Var.f31976f0 && aw0Var.f31977g0 == b10) {
                EditTextBoldCursor textView = c6Var2.getTextView();
                textView.requestFocus();
                AndroidUtilities.showKeyboard(textView);
                aw0Var.f31976f0 = false;
                aw0Var.f31977g0 = -1;
            }
