...
public final class yv0 extends org.telegram.ui.ActionBar.p2 {
    ...
    public org.telegram.ui.Cells.x7 f40585b;
    public org.telegram.ui.Components.x80 f40586c;
    public org.telegram.ui.Components.g61 d;
    public org.telegram.ui.Components.mr e;
    public org.telegram.ui.ActionBar.w0 f40587f;
    public final boolean h;
    public final long f40588n;
    public boolean f40589r;
    public long f40590s;
    public io v;
    public boolean f40591w;
    ...
    public static void U(yv0 yv0Var, TLRPC.TL_error tL_error, TLObject tLObject, TL_stars.updatePaidMessagesPrice updatepaidmessagesprice) {
        long j10;
        if (tL_error != null) {
            yv0Var.e.a(0.0f);
    ...
    public final void V(boolean z4) {
        ...
        float f12;
        float f13;
        if (this.f40587f == null || this.f40591w == (X = X())) {
            return;
        }
        this.f40591w = X;
        this.f40587f.setEnabled(X);
        float f14 = 0.0f;
        if (z4) {
            ViewPropertyAnimator animate = this.f40587f.animate();
            if (X) {
                f12 = 1.0f;
            } else {
                f12 = 0.0f;
        ...
        org.telegram.ui.ActionBar.w0 w0Var = this.f40587f;
        if (X) {
            f10 = 1.0f;
        } else {
            f10 = 0.0f;
        ...
        w0Var.setAlpha(f10);
        org.telegram.ui.ActionBar.w0 w0Var2 = this.f40587f;
        if (X) {
            f11 = 1.0f;
        } else {
            f11 = 0.0f;
        ...
        org.telegram.ui.ActionBar.w0 w0Var3 = this.f40587f;
        if (X) {
            f14 = 1.0f;
        }
    ...
    public final String W() {
        ...
        return LocaleController.formatString(R.string.PostSuggestionsPriceInfo2, rh.k.G0(i10), String.valueOf(((int) (((((float) this.f40590s) * (i10 / 1000.0f)) / 1000.0d) * getMessagesController().starsUsdWithdrawRate1000)) / 100.0d));
    }

    public final boolean X() {
        if (this.f40590s == this.f40588n && this.f40589r == this.h) {
            return false;
        }
        return true;
    }
        ...
        if (this.e.f27111c <= 0.0f) {
            ...
            if (chat != null) {
                ...
                if (chat2 != null) {
                    if (this.f40589r) {
                        chat2.flags2 |= 16384;
                        chat2.send_paid_messages_stars = this.f40590s;
                    } else {
                        chat2.flags2 &= -16385;
    ...
    public final View createView(Context context) {
        ...
        this.f40587f = this.actionBar.n().i(AndroidUtilities.dp(56.0f), LocaleController.getString(R.string.Done), this.e);
        V(false);
        ...
        this.f40586c.setBackgroundColor(getThemedColor(i11));
        this.f40586c.b(true);
        this.f40586c.d(0, null, false);
    ...
    public final boolean onBackPressed(boolean z4) {
        if (X()) {
            if (z4) {
                ...
                alertDialog$Builder.f19503a.Q = LocaleController.getString(R.string.MessageSuggestionsUnsavedChanges);
