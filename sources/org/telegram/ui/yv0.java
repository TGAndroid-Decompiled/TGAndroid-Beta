...
public final class yv0 extends org.telegram.ui.Components.vl0 {
    ...
    public final boolean D(s4.c1 c1Var) {
        ...
        int b10 = c1Var.b();
        aw0 aw0Var = this.d;
        if (b10 != aw0Var.f32173i0 && b10 != aw0Var.f32187u0 && b10 != aw0Var.f32188v0) {
            if (aw0Var.I && b10 >= (i10 = aw0Var.f32178n0) && b10 < aw0Var.f32193y + i10) {
                if (b10 - i10 < aw0Var.f32191x) {
                    return false;
                }
            } else if (b10 != aw0Var.f32179o0 && b10 != aw0Var.f32183r0 && b10 != aw0Var.f32185s0 && (aw0Var.N != 0 || b10 != aw0Var.f32186t0)) {
                return false;
            }
            return true;
        }
    ...
    @Override
    public final int h() {
        return this.d.f32192x0;
    }

    @Override
    public final int j(int i10) {
        aw0 aw0Var = this.d;
        if (i10 != aw0Var.f32172h0 && i10 != aw0Var.m0 && i10 != aw0Var.f32181q0) {
            if (i10 == aw0Var.f32176l0) {
                return 1;
            }
            if (i10 != aw0Var.f32180p0 && i10 != aw0Var.f32190w0 && i10 != aw0Var.f32175k0) {
                ...
                if (i10 == aw0Var.f32174j0) {
                    return 7;
                }
                if (i10 != aw0Var.f32183r0 && i10 != aw0Var.f32185s0 && i10 != aw0Var.f32186t0 && i10 != aw0Var.f32187u0 && i10 != aw0Var.f32188v0) {
                    return 5;
                }
                return 6;
            }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i16 != 0) {
            ...
            if (i16 != 6) {
                ...
                if (i10 == aw0Var.f32175k0) {
                    e9Var.setText(LocaleController.getString(R.string.AddAnExplanationInfo));
                    return;
                } else if (i10 == aw0Var.f32190w0) {
                    e9Var.setFixedSize(12);
                    e9Var.setText(null);
                    return;
                } else {
                    int i17 = aw0Var.f32177n - aw0Var.f32193y;
                    if (i17 <= 0) {
                        if (z10) {
            ...
            if (i10 == aw0Var.f32187u0) {
                ...
                w8Var.e(null, true);
                return;
            } else if (i10 == aw0Var.f32183r0) {
                w8Var.f(LocaleController.getString(R.string.PollAnonymous), aw0Var.G, (aw0Var.f32185s0 == -1 && aw0Var.f32186t0 == -1) ? true : true);
                w8Var.e(null, true);
                return;
            } else if (i10 == aw0Var.f32185s0) {
                String string = LocaleController.getString(R.string.PollMultiple);
                boolean z13 = aw0Var.K;
                if (aw0Var.f32186t0 != -1) {
                    z12 = true;
                }
                w8Var.f(string, z13, z12);
                w8Var.e(null, true);
                return;
            } else if (i10 == aw0Var.f32186t0) {
        ...
        if (i10 == aw0Var.f32172h0) {
            if (z10) {
                if (aw0Var.f32195z0 != null) {
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 != 0) {
                        ...
                        if (i10 != 4) {
                            if (i10 != 6) {
                                if (i10 != 7) {
                                    ...
                                    xv0Var2.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19062d6, false));
                                    ...
                                    wv0Var.d();
                                    wv0Var.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19062d6, false));
                            ...
                            vv0Var.d();
                            vv0Var.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19062d6, false));
            ...
            View m4Var = new org.telegram.ui.Cells.m4(this.f39913c, org.telegram.ui.ActionBar.j6.L6, 21, 15, false, null);
    ...
    public final void y(s4.c1 c1Var) {
        ...
        if (i13 == 4) {
            ...
            c6Var.setTextColor(org.telegram.ui.ActionBar.j6.l1(f7, themedColor));
            ...
            int i14 = b10 - aw0Var.f32178n0;
            if (aw0Var.I && i14 < aw0Var.f32191x) {
                z10 = false;
            } else {
                z10 = true;
            }
            ...
            c6Var2.setTextColor(org.telegram.ui.ActionBar.j6.l1(f7, themedColor2));
            ...
            d6Var2.setTag(null);
            ImageView imageView = d6Var2.f20101f;
            if (imageView != null) {
                if (z10) {
                    i11 = 0;
                } else {
            ...
            if (!aw0Var.f32170f0 && aw0Var.f32171g0 == b10) {
                EditTextBoldCursor textView = d6Var2.getTextView();
                textView.requestFocus();
                AndroidUtilities.showKeyboard(textView);
                aw0Var.f32170f0 = false;
                aw0Var.f32171g0 = -1;
            }
