...
public final class yv0 extends org.telegram.ui.Components.xl0 {
    public final Context f40050c;
    public final aw0 d;

    public yv0(aw0 aw0Var, Context context) {
        this.d = aw0Var;
        this.f40050c = context;
    }
    ...
    public final boolean D(s4.c1 c1Var) {
        ...
        int b10 = c1Var.b();
        aw0 aw0Var = this.d;
        if (b10 != aw0Var.f32208i0 && b10 != aw0Var.f32222u0 && b10 != aw0Var.f32223v0) {
            if (aw0Var.I && b10 >= (i10 = aw0Var.f32213n0) && b10 < aw0Var.f32228y + i10) {
                if (b10 - i10 < aw0Var.f32226x) {
                    return false;
                }
            } else if (b10 != aw0Var.f32214o0 && b10 != aw0Var.f32218r0 && b10 != aw0Var.f32220s0 && (aw0Var.N != 0 || b10 != aw0Var.f32221t0)) {
                return false;
            }
            return true;
        }
    ...
    @Override
    public final int h() {
        return this.d.f32227x0;
    }

    @Override
    public final int j(int i10) {
        aw0 aw0Var = this.d;
        if (i10 != aw0Var.f32207h0 && i10 != aw0Var.m0 && i10 != aw0Var.f32216q0) {
            if (i10 == aw0Var.f32211l0) {
                return 1;
            }
            if (i10 != aw0Var.f32215p0 && i10 != aw0Var.f32225w0 && i10 != aw0Var.f32210k0) {
                ...
                if (i10 == aw0Var.f32209j0) {
                    return 7;
                }
                if (i10 != aw0Var.f32218r0 && i10 != aw0Var.f32220s0 && i10 != aw0Var.f32221t0 && i10 != aw0Var.f32222u0 && i10 != aw0Var.f32223v0) {
                    return 5;
                }
                return 6;
            }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i16 != 0) {
            ...
            if (i16 != 6) {
                ...
                if (i10 == aw0Var.f32210k0) {
                    f9Var.setText(LocaleController.getString(R.string.AddAnExplanationInfo));
                    return;
                } else if (i10 == aw0Var.f32225w0) {
                    f9Var.setFixedSize(12);
                    f9Var.setText(null);
                    return;
                } else {
                    int i17 = aw0Var.f32212n - aw0Var.f32228y;
                    if (i17 <= 0) {
                        if (z10) {
            ...
            if (i10 == aw0Var.f32222u0) {
                ...
                x8Var.e(null, true);
                return;
            } else if (i10 == aw0Var.f32218r0) {
                x8Var.f(LocaleController.getString(R.string.PollAnonymous), aw0Var.G, (aw0Var.f32220s0 == -1 && aw0Var.f32221t0 == -1) ? true : true);
                x8Var.e(null, true);
                return;
            } else if (i10 == aw0Var.f32220s0) {
                String string = LocaleController.getString(R.string.PollMultiple);
                boolean z13 = aw0Var.K;
                if (aw0Var.f32221t0 != -1) {
                    z12 = true;
                }
                x8Var.f(string, z13, z12);
                x8Var.e(null, true);
                return;
            } else if (i10 == aw0Var.f32221t0) {
        ...
        if (i10 == aw0Var.f32207h0) {
            if (z10) {
                if (aw0Var.f32230z0 != null) {
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 != 0) {
                        ...
                        if (i10 != 4) {
                            if (i10 != 6) {
                                if (i10 != 7) {
                                    ...
                                    xv0Var2.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19109d6, false));
                                    ...
                                    wv0Var.d();
                                    wv0Var.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19109d6, false));
                                    wv0Var.c(new org.telegram.ui.Components.qn(5, this, wv0Var));
                                    xv0Var = wv0Var;
                                }
                            } else {
                                View x8Var = new org.telegram.ui.Cells.x8(context);
                                x8Var.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19109d6, false));
                                xv0Var = x8Var;
                            }
                        } else {
                            vv0 vv0Var = new vv0(this, context, z10 ? 1 : 0);
                            vv0Var.d();
                            vv0Var.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19109d6, false));
            ...
            View n4Var = new org.telegram.ui.Cells.n4(this.f40050c, org.telegram.ui.ActionBar.j6.L6, 21, 15, false, null);
    ...
    public final void y(s4.c1 c1Var) {
        ...
        if (i13 == 4) {
            ...
            int i14 = b10 - aw0Var.f32213n0;
            if (aw0Var.I && i14 < aw0Var.f32226x) {
                z10 = false;
            } else {
                z10 = true;
            }
            ...
            e6Var2.setTag(null);
            ImageView imageView = e6Var2.f20200f;
            if (imageView != null) {
                if (z10) {
                    i11 = 0;
                } else {
            ...
            if (!aw0Var.f32205f0 && aw0Var.f32206g0 == b10) {
                EditTextBoldCursor textView = e6Var2.getTextView();
                textView.requestFocus();
                AndroidUtilities.showKeyboard(textView);
                aw0Var.f32205f0 = false;
                aw0Var.f32206g0 = -1;
            }
