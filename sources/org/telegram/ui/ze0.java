...
public final class ze0 extends org.telegram.ui.Components.vv0 {
    ...
    public final yg0 f40228a0;
    public final org.telegram.ui.Components.yc0 f40229b;
    public final ci.h2 f40230c;
    ...
    public final TextView f40232n;
    public final TextView f40233r;
    public final TextView f40234s;
    public final zf0 v;
    public boolean f40235w;
    public boolean f40236x;
    public boolean f40237y;
    ...
    public final void h(String str) {
        ...
        String obj = this.f40230c.getText().toString();
        if (obj.length() == 0) {
            s(false);
        } else if (!p(obj)) {
            s(true);
    ...
    @Override
    public final void j() {
        AndroidUtilities.runOnUIThread(new we0(this, 3), yg0.f39882t0);
    }

    @Override
    public final void k(Bundle bundle) {
        Bundle bundle2 = bundle.getBundle("recoveryview_word" + this.f40227a);
        this.L = bundle2;
        if (bundle2 != null) {
            m(bundle2, true);
        }
    ...
    public final void l(Bundle bundle) {
        if (this.L != null) {
            bundle.putBundle("recoveryview_word" + this.f40227a, this.L);
        }
    }
    ...
    public final void m(Bundle bundle, boolean z10) {
        ...
        String str2 = this.K;
        TextView textView = this.f40233r;
        if (str2 == null) {
            if (!z11) {
    ...
    public final void n() {
        ...
        yg0 yg0Var = this.f40228a0;
        this.f40232n.setTextColor(yg0Var.getThemedColor(i10));
        this.f40233r.setTextColor(yg0Var.getThemedColor(org.telegram.ui.ActionBar.j6.D6));
        int themedColor = yg0Var.getThemedColor(i10);
        ci.h2 h2Var = this.f40230c;
        h2Var.setTextColor(themedColor);
        h2Var.setCursorColor(yg0Var.getThemedColor(org.telegram.ui.ActionBar.j6.f19008l6));
    ...
    public final void o(boolean z10) {
        ...
        if (this.f40235w && !this.f40236x) {
            f10 = 1.0f;
        }
        float f13 = (0.1f * f10) + 0.9f;
        ViewPropertyAnimator alpha = this.f40231f.animate().scaleX(f13).scaleY(f13).alpha(f10);
        float f14 = 1.0f - f10;
        if (this.f40236x) {
            f12 = 5.0f;
        }
    ...
    public final void q(boolean z10) {
        ...
        if (TextUtils.isEmpty(this.f40230c.getText()) && clipboardManager != null && clipboardManager.hasPrimaryClip()) {
            z11 = true;
        } else {
            z11 = false;
        }
        if (this.f40235w != z11) {
            ...
            float f16 = 0.9f;
            float f17 = 0.7f;
            TextView textView = this.f40234s;
            TextView textView2 = this.f40231f;
            float f18 = 0.0f;
            float f19 = 1.0f;
            if (z10) {
                ...
                ViewPropertyAnimator alpha2 = scaleX2.scaleY(f16).alpha((!this.f40235w || this.f40236x) ? 0.0f : 0.0f);
                if (!this.f40235w || this.f40236x) {
                    if (this.f40236x) {
                        f15 = 5.0f;
                    }
                ...
                textView2.setAlpha((!this.f40235w || this.f40236x) ? 0.0f : 0.0f);
                if (!this.f40235w || this.f40236x) {
                    if (this.f40236x) {
                        f15 = 5.0f;
                    }
    ...
    public final void s(boolean z10) {
        ...
        int i11;
        ci.h2 h2Var = this.f40230c;
        if (this.f40228a0.getParentActivity() == null) {
            return;
        }
        try {
