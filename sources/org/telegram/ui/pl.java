...
public final class pl implements org.telegram.ui.Components.ti {
    ...
    public final void B1(int i10, boolean z10, boolean z11, int i11, int i12, long j3, boolean z12, boolean z13, long j10) {
        ...
        if (boVar.getParentActivity() != null && (g4Var = boVar.J1) != null) {
            ...
            if (i10 != 8 && i10 != 7 && (i10 != 4 || g4Var.f28757j0.getSelectedPhotos().isEmpty())) {
            ...
            HashMap<Object, Object> selectedPhotos = boVar.J1.f28757j0.getSelectedPhotos();
            ArrayList<Object> selectedPhotosOrder = boVar.J1.f28757j0.getSelectedPhotosOrder();
            if (!selectedPhotos.isEmpty()) {
                ...
                while (i15 < ceil) {
                    ...
                    if (messageObject2 != null && messageObject2.needResendWhenEdit()) {
                        ...
                        i14 = i20;
                        i13 = i19;
                        SendMessagesHelper.prepareSendingMedia(accountInstance, arrayList, j11, messageObject3, messageObject4, null, rnVar, z16, z10, null, z11, i11, i12, boVar.R3, z14, null, boVar.C8(), j3, z12, j10, boVar.N8(), messageSuggestionParams2);
                    } else {
                        i13 = ceil;
                        i14 = i15;
                        AccountInstance accountInstance2 = boVar.getAccountInstance();
                        long j12 = boVar.T5;
                        MessageObject messageObject5 = boVar.f32385n5;
                        MessageObject messageObject6 = boVar.X3;
                        rn rnVar2 = boVar.f32359l5;
                        if (i10 != 4 && !z13) {
                            z15 = false;
                        } else {
                            z15 = true;
                        }
                        SendMessagesHelper.prepareSendingMedia(accountInstance2, arrayList2, j12, messageObject5, messageObject6, null, rnVar2, z15, z10, boVar.p5, z11, i11, i12, boVar.R3, z14, null, boVar.C8(), j3, z12, j10, boVar.N8(), boVar.f32299g5);
                    }
                    i15 = i14 + 1;
                    ceil = i13;
