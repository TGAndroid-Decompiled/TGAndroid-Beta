...
public final class vq implements org.telegram.ui.ActionBar.a2, org.telegram.ui.Components.b5 {
    ...
    public vq(ur urVar, TLRPC.User user, TLObject tLObject, TLRPC.TL_chatAdminRights tL_chatAdminRights, TLRPC.TL_chatBannedRights tL_chatBannedRights, String str, boolean z10) {
        ...
        this.d = user;
        this.e = tLObject;
        this.f38673f = tL_chatAdminRights;
    ...
    public void J(int i10, int i11, boolean z10) {
        boolean z11 = this.f38671b;
        ((org.telegram.ui.Components.fg) this.f38672c).B((View) this.d, this.e, this.f38670a, this.f38673f, z10, i10, i11, (MediaController.PhotoEntry) this.h, z11);
    }

    @Override
    public void f(org.telegram.ui.ActionBar.b2 b2Var, int i10) {
        int i11;
        ur urVar = (ur) this.f38672c;
        TLObject tLObject = (TLObject) this.e;
        TLRPC.TL_chatAdminRights tL_chatAdminRights = (TLRPC.TL_chatAdminRights) this.f38673f;
        TLRPC.TL_chatBannedRights tL_chatBannedRights = (TLRPC.TL_chatBannedRights) this.h;
        urVar.getClass();
        long j3 = ((TLRPC.User) this.d).f18259id;
        if (urVar.f38105e1 == 1) {
            i11 = 0;
        } else {
            i11 = 1;
        }
        urVar.t0(j3, tLObject, tL_chatAdminRights, tL_chatBannedRights, this.f38670a, this.f38671b, i11, false);
    }
