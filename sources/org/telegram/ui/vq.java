...
public final class vq implements Utilities.Callback {
    public final int f38465a = 1;
    public final int f38466b;
    public final long f38467c;
    public final Object d;
    public final Object e;
    public final Object f38468f;
    public final Object f38469g;
    public final Serializable h;

    public vq(int i10, long j3, Activity activity, ArrayList arrayList, HashMap hashMap, Utilities.Callback callback, org.telegram.ui.ActionBar.d6 d6Var) {
        this.f38466b = i10;
        this.d = arrayList;
        this.f38467c = j3;
        this.e = activity;
        this.f38468f = d6Var;
        this.f38469g = callback;
        this.h = hashMap;
    }
    ...
    public final void run(Object obj) {
        ...
        Object obj2 = this.f38469g;
        Object obj3 = this.f38468f;
        Object obj4 = this.e;
        Object obj5 = this.d;
        switch (i10) {
            case 0:
                ...
                yqVar.X0 = new zq(qrVar, intValue, j10, this.f38466b, z10, zArr);
            ...
            default:
                ...
                int i13 = this.f38466b;
                tL_messages_toggleBotInAttachMenu.bot = MessagesController.getInstance(i13).getInputUser(this.f38467c);
    ...
    public vq(qr qrVar, long j3, int i10, TLObject tLObject, TLRPC.TL_chatAdminRights tL_chatAdminRights, TLRPC.TL_chatBannedRights tL_chatBannedRights, String str, boolean z10) {
        this.d = qrVar;
        this.f38467c = j3;
        this.f38466b = i10;
        this.e = tLObject;
        this.f38468f = tL_chatAdminRights;
        this.f38469g = tL_chatBannedRights;
        this.h = str;
    }

    public vq(LaunchActivity launchActivity, int i10, long j3, ry ryVar, org.telegram.ui.ActionBar.n2 n2Var, TLRPC.User user, String str) {
