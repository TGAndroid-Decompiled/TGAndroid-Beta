...
public final class c80 extends z4.a {
    ...
    public final Object e(z4.g gVar, int i10) {
        ...
        switch (this.f35050c) {
            case 0:
                ...
                textView.setTag(d80Var.f35739a);
                TextView textView2 = new TextView(gVar.getContext());
                textView2.setTag(d80Var.f35740b);
            ...
            default:
                ...
                int i13 = kx0Var.f38175a;
                String str = kx0Var.d;
                CharSequence charSequence = kx0Var.f38177c;
                int i14 = 8;
                TextView textView3 = z0Var.f46400b;
                org.telegram.ui.Components.d90 d90Var = z0Var.f46401c;
                if (i13 != 0 && i13 != 14 && i13 != 28) {
                    if (a1Var.E) {
                        int i15 = a1Var.f46049y;
                        if (i15 == 4) {
    ...
    public void h(int i10) {
        switch (this.f35050c) {
            case 0:
                d80 d80Var = (d80) this.d;
                d80Var.f35742e.setCurrentPage(i10);
                d80Var.H = i10;
                return;
            default:
                return;
