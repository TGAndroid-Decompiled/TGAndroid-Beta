...
public final class c80 extends z4.a {
    ...
    public final Object e(z4.g gVar, int i10) {
        ...
        switch (this.f35023c) {
            case 0:
                ...
                textView.setTag(d80Var.f35712a);
                TextView textView2 = new TextView(gVar.getContext());
                textView2.setTag(d80Var.f35713b);
            ...
            default:
                ...
                int i13 = kx0Var.f38148a;
                String str = kx0Var.d;
                CharSequence charSequence = kx0Var.f38150c;
                int i14 = 8;
                TextView textView3 = z0Var.f46372b;
                org.telegram.ui.Components.d90 d90Var = z0Var.f46373c;
                if (i13 != 0 && i13 != 14 && i13 != 28) {
                    if (a1Var.E) {
                        int i15 = a1Var.f46021y;
                        if (i15 == 4) {
    ...
    public void h(int i10) {
        switch (this.f35023c) {
            case 0:
                d80 d80Var = (d80) this.d;
                d80Var.f35715e.setCurrentPage(i10);
                d80Var.H = i10;
                return;
            default:
                return;
