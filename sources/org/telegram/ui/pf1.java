...
public final class pf1 extends org.telegram.ui.ActionBar.j {
    ...
    public final void b(int i10) {
        ...
        fg1 fg1Var = this.f36625b;
        TopicsController topicsController = fg1Var.f33675s;
        ArrayList arrayList = fg1Var.f33643b;
        HashSet hashSet = fg1Var.f33641a0;
        ...
        switch (i10) {
            ...
            case 2:
                ...
                if (chatFull != null) {
                    ...
                    nf1 nf1Var = new nf1(this, this.f36624a, i11, iVar, chatFull.f18122id, fg1Var, j10);
                    nf1Var.f22636l0 = new ai.z1(this, j10, 11);
                    nf1Var.show();
                    return;
                }
                return;
            ...
            case 5:
                if (hashSet.size() > 0) {
                    fg1Var.C0 = true;
                    fg1Var.N0 = true;
                    TopicsController topicsController2 = fg1Var.f33675s;
                    long j11 = fg1Var.f33640a;
            ...
            case 8:
                ...
                for (int i14 = 0; i14 < arrayList2.size(); i14++) {
                    ...
                    if (findTopic != null) {
                        ...
                        fg1Var.getMessagesStorage().updateRepliesMaxReadId(fg1Var.f33640a, findTopic.f18173id, findTopic.top_message, 0, true);
                    }
                }
                fg1Var.C0();
                return;
                ...
                if (tL_forumTopic2 == null) {
                    while (true) {
                        if (i13 < arrayList.size()) {
                            if (arrayList.get(i13) != null && ((wf1) arrayList.get(i13)).f39031c != null && ((wf1) arrayList.get(i13)).f39031c.f18173id == 1) {
                                tL_forumTopic2 = ((wf1) arrayList.get(i13)).f39031c;
                            } else {
                                i13++;
                            }
                        }
