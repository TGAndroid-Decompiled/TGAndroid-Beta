    ...
    public final void run() {
        ...
        switch (i11) {
            case 0:
                ...
                if (i14 == 1) {
                    if (i13 == 0) {
                        ...
                        wd1Var.f41970u0.e1();
                        wd1Var.V.setHasChanges(wd1Var.T0(wd1Var.f41953n));
                        wd1Var.m1(true);
                    }
                } else if (i14 == 2) {
                    if (i13 == 0) {
                ...
                int size = wd1Var.f41943i0.size();
                for (int i17 = 0; i17 < size; i17++) {
                    org.telegram.ui.ActionBar.l6 l6Var = (org.telegram.ui.ActionBar.l6) wd1Var.f41943i0.get(i17);
                    l6Var.d(wd1Var.getThemedColor(l6Var.f21178f), false, false);
                }
                wd1Var.f41954n0.e1();
                wd1Var.f41970u0.e1();
                di.r6 r6Var = wd1Var.f41916a0;
                if (r6Var != null) {
                    r6Var.invalidate();
                }
                wd1Var.X = -1;
            ...
            case 2:
                ...
                wd1Var.V0();
                wd1Var.i1();
                if (wd1Var.f41943i0 != null) {
                    for (int i18 = 0; i18 < wd1Var.f41943i0.size(); i18++) {
                        ((org.telegram.ui.ActionBar.l6) wd1Var.f41943i0.get(i18)).d(wd1Var.getThemedColor(((org.telegram.ui.ActionBar.l6) wd1Var.f41943i0.get(i18)).f21178f), false, false);
                    }
                }
                if (wd1Var.M1) {
            ...
            default:
                if (wd1Var.getParentActivity() != null && wd1Var.getParentActivity() != null) {
                    ...
                    wd1Var.f41949k0.addView(i40Var, w7.x5.d(-2, -2.0f, 51, 4.0f, 0.0f, 4.0f, 0.0f));
                    if (wd1Var.f41959p1.a()) {
