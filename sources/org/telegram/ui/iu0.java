...
public final class iu0 extends vh.n {
    ...
    public boolean W;
    public org.telegram.ui.Components.r90 f34566a0;
    public Layout f34567b0;
    public Path f34568c0;
    ...
    public iu0(Context context, gu0 gu0Var, org.telegram.ui.Cells.aa aaVar, final Utilities.Callback2 callback2, final Utilities.Callback3 callback3) {
        ...
        this.f44725x = new org.telegram.ui.Components.m90(this) {
            public final iu0 f34275b;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.W) {
            ...
            Path path = this.f34568c0;
            if (path == null || this.f34567b0 != layout) {
                if (path == null) {
                    this.f34568c0 = new Path();
                } else {
                    path.rewind();
                }
                if (layout != null) {
                    ...
                    while (i11 < layout.getLineCount()) {
                        ...
                        this.f34568c0.addRect(getPaddingLeft() + lineLeft, getPaddingTop() + f10, getPaddingLeft() + lineRight, getPaddingTop() + f7, Path.Direction.CW);
                        i11++;
                        f10 = f7;
                    }
                }
                this.f34567b0 = layout;
            }
            if (this.f34566a0 == null) {
                org.telegram.ui.Components.r90 r90Var = new org.telegram.ui.Components.r90();
                this.f34566a0 = r90Var;
                r90Var.f27922x = this.f34568c0;
                r90Var.j(4.0f);
                this.f34566a0.f(org.telegram.ui.ActionBar.h6.l1(0.3f, -1), org.telegram.ui.ActionBar.h6.l1(0.1f, -1), org.telegram.ui.ActionBar.h6.l1(0.2f, -1), org.telegram.ui.ActionBar.h6.l1(0.7f, -1));
                this.f34566a0.setCallback(this);
            }
            this.f34566a0.setBounds(0, 0, getWidth(), getHeight());
            this.f34566a0.draw(canvas);
        }
        if (this.W) {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (aaVar != null && aaVar.y()) {
            canvas.save();
            canvas.translate(getPaddingLeft(), getPaddingTop());
            if (aaVar != null && getStaticTextLayout() != null && aaVar.f20017u0 == this) {
                aaVar.X(canvas);
            }
            canvas.restore();
        }
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        if (drawable != this.f34566a0 && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
