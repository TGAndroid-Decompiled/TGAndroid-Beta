...
public final class um0 implements org.telegram.ui.Components.ti {
    ...
    @Override
    public final void H() {
        AndroidUtilities.hideKeyboard(this.f41217a.fragmentView.findFocus());
    }
    ...
    public final void l0(int i10, boolean z10, boolean z11, int i11, int i12, long j3, boolean z12, boolean z13, long j10) {
        ...
        if (pn0Var.getParentActivity() != null && (viVar = pn0Var.R0) != null) {
            ...
            HashMap<Object, Object> selectedPhotos = pn0Var.R0.f31319j0.getSelectedPhotos();
            ArrayList<Object> selectedPhotosOrder = pn0Var.R0.f31319j0.getSelectedPhotosOrder();
