        ...
        switch (i10) {
            case 0:
                ...
                if (list != null) {
                    for (TLRPC.User user : list) {
                        if (user != null && !hashSet.contains(Long.valueOf(user.f18443id)) && sj0Var.R(user)) {
                            sj0Var.f37350f0.add(user);
                            hashSet.add(Long.valueOf(user.f18443id));
                        }
                    }
                }
                sj0Var.U(true, true);
            ...
            case 1:
                ...
                if (user2 == null) {
                    ...
                    mutate.setColorFilter(new PorterDuffColorFilter(ek0Var.getThemedColor(org.telegram.ui.ActionBar.j6.f19393v6), PorterDuff.Mode.SRC_IN));
                    ek0Var.R.setImageDrawable(mutate);
                    if (user2.contact) {
                        ek0Var.v.setText(AndroidUtilities.replaceArrows(AndroidUtilities.replaceSingleTag("This phone number is already in your contacts. **View >**", new ak0(0, ek0Var, user2)), true, AndroidUtilities.dp(2.6666667f), AndroidUtilities.dp(1.0f)));
                    } else {
                            ...
                            if (i12 < tL_messages_stickerSet.packs.size()) {
                                if (!tL_messages_stickerSet.packs.get(i12).documents.isEmpty() && TextUtils.equals(tL_messages_stickerSet.packs.get(i12).emoticon, str2)) {
                                    ...
                                    for (int i13 = 0; i13 < tL_messages_stickerSet.documents.size(); i13++) {
                                        if (tL_messages_stickerSet.documents.get(i13).f18302id == longValue) {
            ...
            case 6:
                ...
                n11Var.f35800c = imageReceiver;
                n11Var.e.add(imageReceiver);
                int f11 = gz.f();
                n11Var.f35800c.setAutoRepeat(0);
                p11 p11Var = n11Var.f35800c;
                ...
                n11Var.f35800c.onAttachedToWindow();
                n11Var.f35802g[1] = true;
                n11Var.a();
                return;
            case 7:
            ...
            case 8:
                ...
                i51Var.f34321f = bitmap;
                Paint paint = new Paint(1);
                i51Var.f34322n = paint;
                Bitmap bitmap2 = i51Var.f34321f;
                ...
                i51Var.f34322n.setColorFilter(new ColorMatrixColorFilter(colorMatrix));
                i51Var.f34323r = new Matrix();
                return;
            case 9:
                ...
                if (!((Boolean) obj).booleanValue()) {
                    ...
                    if (wl0Var != null && wl0Var.G && (L = wl0Var.L(themeActivity.M)) != null) {
                        themeActivity.f31793a.v(L, themeActivity.M);
                        return;
                    }
                    return;
                }
            ...
            case 15:
                ...
                int i15 = k5Var.f47606a;
                updatestargiftcollection.peer = MessagesController.getInstance(i15).getInputPeer(k5Var.f47607b);
            ...
            case 16:
                ...
                Void r15 = (Void) obj;
                long j3 = z4Var.Z;
                Runnable runnable2 = z4Var.f46485g0;
                if (runnable2 != null) {
                    runnable2.run();
                }
                z4Var.dismiss();
            ...
            case 17:
                ...
                if (stargiftupgradepreview != null) {
                    ...
                    y3Var.f48290u0.setVisibility(8);
                    y3Var.f48289t0.setVisibility(8);
                    dVar.setFilled(true);
            ...
            case 20:
                ...
                if (eVar != null && bVar == d3Var.f47294q) {
                    eVar.c(false);
                }
                d3Var.f47293p.remove(bVar);
                if (tL_payments_paymentFormStarGift != null) {
                    d3Var.f47292o.put(bVar, new yh.b3(bVar, tL_payments_paymentFormStarGift));
                    d3Var.a(true);
                    return;
                }
                return;
            default:
                ((Utilities.Callback2) obj3).run((zf.a) obj, new yh.w2((yh.i0[]) obj2, 4));
                return;
        }
    }
}
