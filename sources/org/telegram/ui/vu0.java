...
public final class vu0 extends org.telegram.ui.Components.qv0 {
    ...
    public final void Z() {
        if (Build.VERSION.SDK_INT >= 29) {
            ...
            this.D0.clear();
            PhotoViewer photoViewer = this.E0;
            if (photoViewer.f31080u4 == 1 || photoViewer.f31028o6 == 1) {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        PhotoViewer photoViewer = this.E0;
        photoViewer.Q.o(photoViewer.f30953g0.getContext()).draw(canvas);
    }
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        org.telegram.ui.Cells.da daVar = o9.f19890r;
        if (motionEvent.getAction() == 0) {
            o9.h = motionEvent.getX();
            o9.f19889n = motionEvent.getY();
            daVar.e = daVar.y();
        } else if (daVar.e && Math.abs(motionEvent.getX() - o9.h) < AndroidUtilities.touchSlop && Math.abs(motionEvent.getY() - o9.f19889n) < AndroidUtilities.touchSlop && (motionEvent.getAction() == 3 || motionEvent.getAction() == 1)) {
            motionEvent.getX();
            motionEvent.getY();
            org.telegram.ui.Cells.da daVar2 = o9.f19890r;
            if (!daVar2.f19952i && daVar2.e) {
                daVar2.f(false);
            }
        }
        if (photoViewer.Q.y()) {
    ...
    public final void draw(Canvas canvas) {
        ...
        if (iu0Var != null && iu0Var.f27330x) {
            int measuredHeight = ((int) ((photoViewer.f30904a6 - 1.0f) * iu0Var.getWebView().getMeasuredHeight())) / 2;
            org.telegram.ui.Components.w61 w61Var = photoViewer.f31124z1;
            if (w61Var != null && w61Var.f29630j) {
                w61Var.setBounds(photoViewer.f30945f0.getLeft(), (photoViewer.f30945f0.getWebView().getTop() - measuredHeight) + ((int) (photoViewer.Y5 / photoViewer.f30904a6)), photoViewer.f30945f0.getRight(), photoViewer.f30945f0.getWebView().getBottom() + measuredHeight + ((int) (photoViewer.Y5 / photoViewer.f30904a6)));
                photoViewer.f31124z1.draw(canvas);
            }
            org.telegram.ui.Components.ko0 ko0Var = photoViewer.A1;
            if (ko0Var != null && ko0Var.a()) {
                photoViewer.A1.setBounds(photoViewer.f30945f0.getLeft(), (int) ((photoViewer.F.getAlpha() * AndroidUtilities.dp(90.0f)) + AndroidUtilities.statusBarHeight), photoViewer.f30945f0.getRight(), photoViewer.f30945f0.getWebView().getBottom() + measuredHeight + ((int) (photoViewer.Y5 / photoViewer.f30904a6)));
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        PhotoViewer photoViewer = this.E0;
        if (view != photoViewer.Q.o(photoViewer.f30953g0.getContext()) && view != photoViewer.f31063s5 && view != photoViewer.f31127z4 && view != photoViewer.A4 && view != photoViewer.X0) {
            ...
            try {
                if (view != photoViewer.f31117y2 && view != photoViewer.f31118y4) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (photoViewer.f30971i0.getVisibility() != 8) {
        ...
        kv0 kv0Var = photoViewer.f30974i3;
        if (kv0Var != null) {
            kv0Var.e = size;
            kv0Var.f35274f = i17;
        }
        ...
        while (i18 < childCount) {
            ...
            if (childAt.getVisibility() != 8 && childAt != photoViewer.l1) {
                ...
                if (childAt == st0Var) {
                ...
                } else if (childAt == photoViewer.f31118y4) {
                    ...
                    photoViewer.f31118y4.measure(View.MeasureSpec.makeMeasureSpec(bitmapWidth, 1073741824), View.MeasureSpec.makeMeasureSpec(bitmapHeight, 1073741824));
                } else if (!photoViewer.U1.f4990f.l(childAt) && !photoViewer.V1.f4990f.l(childAt)) {
                    if (childAt == photoViewer.T1) {
                        if (photoViewer.f31005m2) {
                            if (vu0Var.C0) {
                                i15 = i12 + i14;
