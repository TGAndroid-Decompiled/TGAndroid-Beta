    ...
    public final void run() {
        ...
        switch (i11) {
            ...
            case 3:
                ...
                arrayList.clear();
                ArrayList arrayList2 = le1Var.f35341f;
                arrayList2.clear();
                arrayList.addAll((ArrayList) obj2);
                arrayList2.addAll(((TLRPC.TL_messages_inactiveChats) obj).chats);
                le1Var.d.l();
                if (le1Var.f35338a.getMeasuredHeight() > 0) {
                    ValueAnimator ofFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
                    le1Var.f35347y = ofFloat;
                    ofFloat.addUpdateListener(new q11(le1Var, 15));
                    le1Var.f35347y.setDuration(100L);
                    le1Var.f35347y.start();
                } else {
                    le1Var.E = 1.0f;
                }
            ...
            case 4:
                wf1 wf1Var = (wf1) obj3;
                wf1Var.f39342s.deleteTopics(wf1Var.f39307a, (ArrayList) obj2);
                ((Runnable) obj).run();
                return;
            case 5:
                sf1 sf1Var = (sf1) obj3;
                ...
                ArrayList arrayList3 = sf1Var.f37737d0;
                if (str3.equals(sf1Var.f37735b0)) {
                    int i13 = sf1Var.f37744k0;
                    sf1Var.f37748p0 = false;
                    sf1Var.f37745l0 = false;
                    if (tLObject instanceof TLRPC.messages_Messages) {
                        TLRPC.messages_Messages messages_messages = (TLRPC.messages_Messages) tLObject;
                        for (int i14 = 0; i14 < messages_messages.messages.size(); i14++) {
                            i10 = ((org.telegram.ui.ActionBar.m2) sf1Var.f37752t0).currentAccount;
                    ...
                    if (sf1Var.f37744k0 == 0) {
                        sf1Var.f37746n0.e(sf1Var.f37745l0, true);
                    }
                    sf1Var.f37747o0.b(i13);
                    return;
                }
                return;
            default:
                ...
                gg.c2 c2Var = ph1Var.f36549f;
                if (ph1Var.f36550n) {
                    ph1Var.h = null;
                    ph1Var.d = arrayList4;
                    ph1Var.e = arrayList5;
                    c2Var.f(arrayList4, null);
                    if (ph1Var.f36550n && !c2Var.e()) {
