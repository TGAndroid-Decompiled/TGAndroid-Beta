...
public final class c51 extends FrameLayout {
    ...
    public c51(Context context, int i10) {
        super(context);
        this.f35682a = i10;
    }
    ...
    public void dispatchDraw(Canvas canvas) {
        switch (this.f35682a) {
            case 6:
                org.telegram.ui.ActionBar.k6.f21747i3.setBounds(0, 0, getMeasuredWidth(), org.telegram.ui.ActionBar.k6.f21747i3.getIntrinsicHeight());
    ...
    public void onDraw(Canvas canvas) {
        switch (this.f35682a) {
            case 5:
                super.onDraw(canvas);
                canvas.drawRect(0.0f, 0.0f, getMeasuredWidth(), 1.0f, org.telegram.ui.ActionBar.k6.f21779k0);
                return;
            default:
                super.onDraw(canvas);
                return;
