...
public final class lr extends org.telegram.ui.Components.wl0 {
    public final Context f35403c;
    public final pr d;

    public lr(pr prVar, Context context) {
        this.d = prVar;
        this.f35403c = context;
    }
    ...
    @Override
    public final int h() {
        return this.d.f36618d1;
    }

    @Override
    public final int j(int i10) {
        pr prVar = this.d;
        if (i10 != prVar.f36666z0 && i10 != prVar.A0 && i10 != prVar.f36655v0 && i10 != prVar.f36651t0) {
            ...
            if (i10 != prVar.C0 && i10 != prVar.G0 && i10 != prVar.H0) {
                if (i10 != prVar.D0 && i10 != prVar.S && i10 != prVar.N0 && i10 != prVar.f36649s0 && i10 != prVar.f36641p0) {
                    if (i10 != prVar.f36613b1 && i10 != prVar.P0 && i10 != prVar.R0 && i10 != prVar.f36653u0 && i10 != prVar.f36664y0 && i10 != prVar.K0 && i10 != prVar.M0 && i10 != prVar.f36631j1 && i10 != prVar.f36639o0 && i10 != prVar.f36646r0) {
                        if (i10 == prVar.f36616c1) {
                            return 4;
                        }
                        if (i10 == prVar.B0) {
                            return 6;
                        }
                        if (i10 != prVar.f36624g0 && i10 != prVar.f36626h0 && i10 != prVar.m0 && i10 != prVar.f36628i0 && i10 != prVar.f36630j0 && i10 != prVar.T && i10 != prVar.f36619e0 && i10 != prVar.f36622f0 && i10 != prVar.f36634l0 && i10 != prVar.Q0) {
                            if (i10 != prVar.Z0 && i10 != prVar.T0 && i10 != prVar.W0 && i10 != prVar.f36625g1) {
                                if (i10 == prVar.O0) {
                                    return 9;
                                }
                                if (i10 == prVar.f36610a1) {
                                    return 10;
                                }
                                if (i10 == prVar.f36623f1) {
                                    return 11;
                                }
                                if (i10 != prVar.f36661x0 && i10 != prVar.J0 && i10 != prVar.L0) {
                                    if (prVar.p0(i10)) {
                                        return 13;
                                    }
                                    if (i10 == prVar.U) {
                                    ...
                                    if (i10 != prVar.f36627h1 && i10 != prVar.f36629i1 && i10 != prVar.f36637n0) {
                                        if (i10 != prVar.f36643q0) {
                                            return 0;
                                        }
                                        return 17;
                                    }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        org.telegram.ui.Components.fw0 fw0Var2;
        int i12 = 2;
        int i13 = 0;
        Context context = this.f35403c;
        pr prVar = this.d;
        switch (i10) {
            case 0:
                int i14 = prVar.O;
                ...
                org.telegram.ui.Cells.b5 b5Var = new org.telegram.ui.Cells.b5(i11, i12, this.f35403c, null, z10);
                b5Var.setDelegate(new kr(this, 0));
                fw0Var2 = b5Var;
                fw0Var = fw0Var2;
                break;
            case 1:
                fw0Var = new org.telegram.ui.Cells.e9(context);
                break;
            case 2:
                fw0Var = new org.telegram.ui.Cells.y4(context);
                break;
            case 3:
                fw0Var = new org.telegram.ui.Cells.b7(context, (org.telegram.ui.Cells.c1) null);
                break;
            case 4:
            ...
            case 5:
                org.telegram.ui.Cells.m4 m4Var = new org.telegram.ui.Cells.m4(this.f35403c, org.telegram.ui.ActionBar.h6.L6, 21, 11, false, null);
                m4Var.setHeight(43);
                fw0Var2 = m4Var;
                fw0Var = fw0Var2;
                break;
            case 6:
                fw0Var = new org.telegram.ui.Cells.ea(context);
                break;
            case 7:
            case 14:
                fw0Var = new org.telegram.ui.Cells.v8(context);
                break;
            case 8:
            ...
            case 11:
                ...
                break;
            case 12:
                org.telegram.ui.Cells.r8 r8Var = new org.telegram.ui.Cells.r8(23, this.f35403c, prVar.getResourceProvider(), false, true);
                r8Var.v = 50;
                fw0Var = r8Var;
                break;
            case 13:
                org.telegram.ui.Cells.a2 a2Var = new org.telegram.ui.Cells.a2(4, 21, this.f35403c, prVar.getResourceProvider(), false);
                ...
                break;
            case 15:
                org.telegram.ui.Components.fw0 fw0Var4 = new org.telegram.ui.Components.fw0(context, null);
                ...
                int i15 = prVar.f36650s1;
                if (i15 > 0) {
                    i13 = i15 - 1;
                }
                fw0Var4.b(i13, drawableArr, "1", "2", "3", "4", "5");
                fw0Var4.setCallback(new kr(this, 2));
                fw0Var2 = fw0Var4;
                fw0Var = fw0Var2;
                break;
            case 16:
                fw0Var = new org.telegram.ui.Cells.w8(context, prVar.getResourceProvider());
                break;
            case 17:
                fw0Var = new org.telegram.ui.Cells.z7(context, prVar.getResourceProvider());
                break;
        }
        return new s4.c1(fw0Var);
    }
}
