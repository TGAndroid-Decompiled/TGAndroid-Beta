...
public final class qr extends org.telegram.ui.Components.kl0 {
    ...
    @Override
    public final int h() {
        return this.d.f38117d1;
    }

    @Override
    public final int j(int i10) {
        ur urVar = this.d;
        if (i10 != urVar.f38165z0 && i10 != urVar.A0 && i10 != urVar.f38154v0 && i10 != urVar.f38150t0) {
            ...
            if (i10 != urVar.C0 && i10 != urVar.G0 && i10 != urVar.H0) {
                if (i10 != urVar.D0 && i10 != urVar.S && i10 != urVar.N0 && i10 != urVar.f38148s0 && i10 != urVar.f38140p0) {
                    if (i10 != urVar.f38112b1 && i10 != urVar.P0 && i10 != urVar.R0 && i10 != urVar.f38152u0 && i10 != urVar.f38163y0 && i10 != urVar.K0 && i10 != urVar.M0 && i10 != urVar.f38130j1 && i10 != urVar.f38138o0 && i10 != urVar.f38145r0) {
                        if (i10 == urVar.f38115c1) {
                            return 4;
                        }
                        if (i10 == urVar.B0) {
                            return 6;
                        }
                        if (i10 != urVar.f38123g0 && i10 != urVar.f38125h0 && i10 != urVar.m0 && i10 != urVar.f38127i0 && i10 != urVar.f38129j0 && i10 != urVar.T && i10 != urVar.f38118e0 && i10 != urVar.f38121f0 && i10 != urVar.f38133l0 && i10 != urVar.Q0) {
                            if (i10 != urVar.Z0 && i10 != urVar.T0 && i10 != urVar.W0 && i10 != urVar.f38124g1) {
                                if (i10 == urVar.O0) {
                                    return 9;
                                }
                                if (i10 == urVar.f38109a1) {
                                    return 10;
                                }
                                if (i10 == urVar.f38122f1) {
                                    return 11;
                                }
                                if (i10 != urVar.f38160x0 && i10 != urVar.J0 && i10 != urVar.L0) {
                                    if (urVar.p0(i10)) {
                                        return 13;
                                    }
                                    if (i10 == urVar.U) {
                                    ...
                                    if (i10 != urVar.f38126h1 && i10 != urVar.f38128i1 && i10 != urVar.f38136n0) {
                                        if (i10 != urVar.f38142q0) {
                                            return 0;
                                        }
                                        return 17;
                                    }
    ...
    @Override
    public final void v(s4.c1 r26, int r27) {
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        switch (i10) {
            case 0:
                ...
                org.telegram.ui.Cells.b5 b5Var = new org.telegram.ui.Cells.b5(i11, i12, this.f36935c, null, z10);
            ...
            case 5:
                org.telegram.ui.Cells.m4 m4Var = new org.telegram.ui.Cells.m4(this.f36935c, org.telegram.ui.ActionBar.i6.L6, 21, 11, false, null);
                m4Var.setHeight(43);
                tv0Var2 = m4Var;
                tv0Var = tv0Var2;
                break;
            ...
            case 11:
                ...
                break;
            case 12:
                org.telegram.ui.Cells.r8 r8Var = new org.telegram.ui.Cells.r8(23, this.f36935c, urVar.getResourceProvider(), false, true);
                r8Var.v = 50;
                tv0Var = r8Var;
                break;
            case 13:
                org.telegram.ui.Cells.z1 z1Var = new org.telegram.ui.Cells.z1(4, 21, this.f36935c, urVar.getResourceProvider(), false);
                z1Var.getCheckBoxRound().setDrawBackgroundAsArc(14);
                z1Var.getCheckBoxRound().b(org.telegram.ui.ActionBar.i6.V6, org.telegram.ui.ActionBar.i6.f18889g7, org.telegram.ui.ActionBar.i6.f18962k7);
