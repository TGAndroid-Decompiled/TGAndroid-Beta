...
public final class qr extends org.telegram.ui.Components.ll0 {
    ...
    @Override
    public final int h() {
        return this.d.f38132d1;
    }

    @Override
    public final int j(int i10) {
        ur urVar = this.d;
        if (i10 != urVar.f38180z0 && i10 != urVar.A0 && i10 != urVar.f38169v0 && i10 != urVar.f38165t0) {
            ...
            if (i10 != urVar.C0 && i10 != urVar.G0 && i10 != urVar.H0) {
                if (i10 != urVar.D0 && i10 != urVar.S && i10 != urVar.N0 && i10 != urVar.f38163s0 && i10 != urVar.f38155p0) {
                    if (i10 != urVar.f38127b1 && i10 != urVar.P0 && i10 != urVar.R0 && i10 != urVar.f38167u0 && i10 != urVar.f38178y0 && i10 != urVar.K0 && i10 != urVar.M0 && i10 != urVar.f38145j1 && i10 != urVar.f38153o0 && i10 != urVar.f38160r0) {
                        if (i10 == urVar.f38130c1) {
                            return 4;
                        }
                        if (i10 == urVar.B0) {
                            return 6;
                        }
                        if (i10 != urVar.f38138g0 && i10 != urVar.f38140h0 && i10 != urVar.m0 && i10 != urVar.f38142i0 && i10 != urVar.f38144j0 && i10 != urVar.T && i10 != urVar.f38133e0 && i10 != urVar.f38136f0 && i10 != urVar.f38148l0 && i10 != urVar.Q0) {
                            if (i10 != urVar.Z0 && i10 != urVar.T0 && i10 != urVar.W0 && i10 != urVar.f38139g1) {
                                if (i10 == urVar.O0) {
                                    return 9;
                                }
                                if (i10 == urVar.f38124a1) {
                                    return 10;
                                }
                                if (i10 == urVar.f38137f1) {
                                    return 11;
                                }
                                if (i10 != urVar.f38175x0 && i10 != urVar.J0 && i10 != urVar.L0) {
                                    if (urVar.p0(i10)) {
                                        return 13;
                                    }
                                    if (i10 == urVar.U) {
                                    ...
                                    if (i10 != urVar.f38141h1 && i10 != urVar.f38143i1 && i10 != urVar.f38151n0) {
                                        if (i10 != urVar.f38157q0) {
                                            return 0;
                                        }
                                        return 17;
                                    }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        switch (i10) {
            case 0:
                ...
                org.telegram.ui.Cells.a5 a5Var = new org.telegram.ui.Cells.a5(i11, i12, this.f37016c, null, z10);
            ...
            case 5:
                org.telegram.ui.Cells.l4 l4Var = new org.telegram.ui.Cells.l4(this.f37016c, org.telegram.ui.ActionBar.j6.L6, 21, 11, false, null);
                l4Var.setHeight(43);
                uv0Var2 = l4Var;
                uv0Var = uv0Var2;
                break;
            ...
            case 11:
                ...
                break;
            case 12:
                org.telegram.ui.Cells.r8 r8Var = new org.telegram.ui.Cells.r8(23, this.f37016c, urVar.getResourceProvider(), false, true);
                r8Var.v = 50;
                uv0Var = r8Var;
                break;
            case 13:
                org.telegram.ui.Cells.z1 z1Var = new org.telegram.ui.Cells.z1(4, 21, this.f37016c, urVar.getResourceProvider(), false);
                z1Var.getCheckBoxRound().setDrawBackgroundAsArc(14);
                z1Var.getCheckBoxRound().b(org.telegram.ui.ActionBar.j6.V6, org.telegram.ui.ActionBar.j6.f18918g7, org.telegram.ui.ActionBar.j6.f18992k7);
