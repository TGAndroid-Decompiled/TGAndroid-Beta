...
public final class j61 extends org.telegram.ui.Components.ht {
            ...
            if (i10 < arrayList.size()) {
                ...
                if (!r61Var.f37099b) {
                    if (r61Var.f37098a) {
                        ...
                        ImageReceiver imageReceiver = r61Var.f37103r;
                        if (imageReceiver != null) {
                            imageReceiver.draw(canvas, r61Var.f37101f[this.K]);
                        }
                    }
                }
                i10++;
        ...
        if (this.O != null) {
            ...
            while (i11 < this.O.size()) {
                ...
                if (!r61Var.f37099b) {
                    ...
                    } else if (!r61Var.f37104s && !r61Var.Q) {
                        if ((r61Var.e != null || i71Var.W == 13) && !r61Var.f37099b && (drawable = r61Var.E) != null) {
                            drawable.setAlpha(255);
                            drawable.setBounds(rect);
                        }
                    } else {
                    ...
                    PorterDuffColorFilter porterDuffColorFilter = i71Var.f34473k1;
    ...
    public final void g() {
        ...
        while (true) {
            ArrayList arrayList = this.P;
            if (i10 < arrayList.size()) {
                ImageReceiver.BackgroundThreadDrawHolder backgroundThreadDrawHolder = ((r61) arrayList.get(i10)).f37101f[this.K];
                if (backgroundThreadDrawHolder != null) {
                    backgroundThreadDrawHolder.release();
                }
                i10++;
            } else {
                this.T.f35128e3.f34466h0.invalidate();
                return;
            }
        }
    }
    ...
    public final void m(Canvas canvas, Drawable drawable, r61 r61Var, float f7) {
        if (drawable != null) {
            ...
            drawable.setColorFilter(this.T.f35128e3.f34473k1);
        } else if ((r61Var.f37104s || r61Var.Q) && r61Var.h != null) {
            canvas.save();
