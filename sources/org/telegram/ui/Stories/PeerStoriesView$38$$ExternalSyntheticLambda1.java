    ...
    public final void run(Object obj) {
        ...
        switch (this.$r8$classId) {
            case 0:
                ...
                if (l.longValue() <= 0) {
                    BulletinFactory.of(peerStoriesView.storyContainer, peerStoriesView.resourcesProvider).createEmojiBulletin(documentFindDocument, LocaleController.getString(R.string.ReactionSent), LocaleController.getString(R.string.ViewInChat), new BalanceCloud$$ExternalSyntheticLambda1(anonymousClass38, 24)).setDuration(5000).show();
                }
                if (peerStoriesView.reactionsContainerLayout.getReactionsWindow() != null) {
                    peerStoriesView.reactionsContainerLayout.getReactionsWindow().dismissWithAlpha();
                }
            ...
            default:
                ...
                if (!zBooleanValue) {
                    FactCheckController$$ExternalSyntheticOutline0.m(R.string.UnknownError, BulletinFactory.of(anonymousClass4, darkThemeResourceProvider), R.raw.error);
                } else {
                    TL_stories.StoryItem storyItem = (TL_stories.StoryItem) this.f$2;
                    boolean z2 = this.f$1;
                    storyItem.pinned = z2;
                    if (anonymousClass2.isSelf) {
                        BulletinFactory.of(anonymousClass4, darkThemeResourceProvider).createSimpleBulletin(z2 ? R.raw.contact_check : R.raw.chats_archived, LocaleController.getString(z2 ? R.string.StoryPinnedToProfile : R.string.StoryArchivedFromProfile)).show();
                    } else if (!z2) {
                        FactCheckController$$ExternalSyntheticOutline0.m(R.string.StoryUnpinnedFromPosts, BulletinFactory.of(anonymousClass4, darkThemeResourceProvider), R.raw.chats_archived);
                    } else {
                        BulletinFactory.of(anonymousClass4, darkThemeResourceProvider).createSimpleBulletin(R.raw.contact_check, LocaleController.getString(R.string.StoryPinnedToPosts), LocaleController.getString(R.string.StoryPinnedToPostsDescription)).show();
                    }
                }
                break;
        }
