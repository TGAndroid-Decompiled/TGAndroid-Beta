...
public final class StoriesStorage$$ExternalSyntheticLambda6 implements Runnable {
    public final int $r8$classId;
    public final StoriesStorage f$0;
    public final long f$1;
    public final int f$2;

    public StoriesStorage$$ExternalSyntheticLambda6(StoriesStorage storiesStorage, long j, int i, int i2) {
        this.$r8$classId = i2;
