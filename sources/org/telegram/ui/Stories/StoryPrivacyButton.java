    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.draw) {
            ...
            if (this.icon[1] == null || f2 <= 0.5f) {
                ...
                float f3 = (this.iconSize[1] / 2.0f) * fAbs;
                f = 0.5f;
                drawable.setBounds(i, (int) (fCenterY - f3), (int) (fDpf5 + f3), (int) (rectF.centerY() + ((this.iconSize[1] / 2.0f) * fAbs)));
            ...
            if (this.icon[0] != null && f2 <= f) {
                ...
                float f4 = (this.iconSize[0] / 2.0f) * fAbs;
                drawable2.setBounds(i2, (int) (fCenterY2 - f4), (int) (fDpf6 + f4), (int) (rectF.centerY() + ((this.iconSize[0] / 2.0f) * fAbs)));
