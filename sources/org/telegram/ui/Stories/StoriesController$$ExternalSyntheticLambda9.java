...
public final class StoriesController$$ExternalSyntheticLambda9 implements Runnable {
    public final int $r8$classId;
    public final StoriesController f$0;

    public StoriesController$$ExternalSyntheticLambda9(StoriesController storiesController, int i) {
        this.$r8$classId = i;
