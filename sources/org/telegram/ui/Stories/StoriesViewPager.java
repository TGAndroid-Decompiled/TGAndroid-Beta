...
public abstract class StoriesViewPager extends ViewPager {
    ...
    public StoriesViewPager(int i, final Context context, final StoryViewer storyViewer, final Theme.ResourcesProvider resourcesProvider) throws Resources.NotFoundException {
        ...
        PagerAdapter pagerAdapter = new PagerAdapter() {
            ...
            @Override
            public Object instantiateItem(ViewGroup viewGroup, int i2) throws NumberFormatException {
        ...
        setPageTransformer(false, new ViewPager.PageTransformer() {
            @Override
            public final void transformPage(View view, float f) throws NumberFormatException {
    ...
    public void lambda$new$1(View view, float f) throws NumberFormatException {
    ...
    public static void lambda$new$0(PageLayout pageLayout) throws NumberFormatException {
    ...
    class PageLayout extends FrameLayout {
        ...
        public void setVisible(boolean z) throws NumberFormatException {
            if (this.isVisible != z) {
                this.isVisible = z;
                invalidate();
    ...
    public void setCurrentDate(long j, int i) throws NumberFormatException {
