...
public class DarkThemeResourceProvider implements Theme.ResourcesProvider {
    ...
    public DarkThemeResourceProvider() {
        ...
        this.sparseIntArray.put(Theme.key_chat_gifSaveHintBackground, ColorUtils.blendARGB(0.2f, -16777216, -1));
        ...
        this.sparseIntArray.put(Theme.key_dialogSearchIcon, ColorUtils.blendARGB(0.5f, -16777216, -1));
        ...
        this.sparseIntArray.put(Theme.key_windowBackgroundWhiteHintText, ColorUtils.blendARGB(0.5f, -16777216, -1));
        this.sparseIntArray.put(Theme.key_dialogTextHint, ColorUtils.blendARGB(0.5f, -16777216, -1));
        this.sparseIntArray.put(Theme.key_sheet_scrollUp, ColorUtils.blendARGB(0.2f, -16777216, -1));
        ...
        this.sparseIntArray.put(i, ColorUtils.blendARGB(0.5f, -16777216, -1));
        ...
        this.sparseIntArray.put(Theme.key_chat_messagePanelHint, Theme.multAlpha(0.6f, -1));
        ...
        this.sparseIntArray.put(Theme.key_chat_messagePanelIcons, Theme.multAlpha(0.9f, -1));
        this.sparseIntArray.put(Theme.key_glass_defaultIcon, Theme.multAlpha(0.8f, -1));
        ...
        this.sparseIntArray.put(Theme.key_windowBackgroundWhiteGrayText3, ColorUtils.blendARGB(0.3f, -1, -16777216));
        ...
        this.sparseIntArray.put(Theme.key_chat_outBubble, ColorUtils.blendARGB(0.4f, -16777216, -1));
