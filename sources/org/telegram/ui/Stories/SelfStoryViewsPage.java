    ...
    public class AnonymousClass4 implements RecyclerListView.OnItemLongClickListener {
        ...
        public boolean onItemClick(View view, int i) {
            ...
            if (view instanceof ReactedUserHolderView) {
                ...
                }).makeMultiline(false).cutTextInFancyHalf().addIf(isBlocked && !z, R.drawable.msg_save_story, LocaleController.formatString(R.string.StoryShowBackTo, str2), new Runnable() {
                    @Override
                    public final void run() {
    ...
    public class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            switch (i) {
                ...
                case 8:
                case 10:
                    StickerEmptyView stickerEmptyView = new StickerEmptyView(SelfStoryViewsPage.this.getContext(), null, SelfStoryViewsPage.this.defaultModel.isExpiredViews ? 12 : (i == 7 || i == 8 || i == 5) ? 1 : 0, SelfStoryViewsPage.this.resourcesProvider) {
                        @Override
                        protected void onMeasure(int i3, int i4) {
