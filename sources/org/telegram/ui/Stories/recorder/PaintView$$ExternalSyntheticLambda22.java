...
public final class PaintView$$ExternalSyntheticLambda22 implements DynamicAnimation.OnAnimationEndListener {
    public final int $r8$classId;
    public final PaintView f$0;
    public final boolean f$1;

    public PaintView$$ExternalSyntheticLambda22(PaintView paintView, boolean z, int i) {
        this.$r8$classId = i;
        this.f$0 = paintView;
        this.f$1 = z;
    }
