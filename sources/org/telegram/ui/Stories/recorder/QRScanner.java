...
public class QRScanner {
    ...
    public QRScanner(final Context context, Utilities.Callback callback) {
        ...
        Utilities.globalQueue.postRunnable(new Runnable() {
            @Override
            public final void run() {
                QRScanner.m4568$r8$lambda$MIkoa3N5R7Md9nU4Klkrz42HSY(this.f$0, context);
            }
        });
    }

    public static void m4568$r8$lambda$MIkoa3N5R7Md9nU4Klkrz42HSY(QRScanner qRScanner, Context context) {
