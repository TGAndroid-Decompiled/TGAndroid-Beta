...
public class StoryUploadingService extends Service implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.uploadStoryProgress) {
            ...
            if (str2 != null && str2.equals((String) objArr[0])) {
                ...
                tVar.f7847p = z10;
                try {
                    new n0(ApplicationLoader.applicationContext).d(33, this.f31830a.b());
                } catch (Throwable th2) {
                    FileLog.e(th2);
                }
            }
        } else if (i10 == NotificationCenter.uploadStoryEnd && (str = this.f31831b) != null && str.equals((String) objArr[0])) {
            stopSelf();
        }
    }
    ...
    public final int onStartCommand(Intent intent, int i10, int i11) {
        this.f31831b = intent.getStringExtra("path");
        int i12 = this.d;
        ...
        if (this.f31830a == null) {
            ...
            t tVar2 = this.f31830a;
            tVar2.f7855y = NotificationsController.OTHER_NOTIFICATIONS_CHANNEL;
            tVar2.g(LocaleController.getString(R.string.AppName));
            this.f31830a.p(LocaleController.getString(R.string.StoryUploading));
            this.f31830a.f(LocaleController.getString(R.string.StoryUploading));
        }
        this.f31832c = 0.0f;
        t tVar3 = this.f31830a;
        int round = Math.round(0.0f);
        tVar3.f7845n = 100;
        tVar3.f7846o = round;
        tVar3.f7847p = false;
        startForeground(33, this.f31830a.b());
        try {
            new n0(ApplicationLoader.applicationContext).d(33, this.f31830a.b());
            return 2;
        } catch (Throwable th2) {
