...
public final class PaintView$$ExternalSyntheticLambda23 implements ValueAnimator.AnimatorUpdateListener {
    public final int $r8$classId;
    public final PaintView f$0;

    public PaintView$$ExternalSyntheticLambda23(PaintView paintView, int i) {
        this.$r8$classId = i;
        this.f$0 = paintView;
    }
