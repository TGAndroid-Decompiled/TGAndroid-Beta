...
public final class PaintView$$ExternalSyntheticLambda30 implements Runnable {
    public final int $r8$classId;
    public final PaintView f$0;
    public final EntityView f$1;

    public PaintView$$ExternalSyntheticLambda30(PaintView paintView, EntityView entityView, int i) {
        this.$r8$classId = i;
        this.f$0 = paintView;
        this.f$1 = entityView;
    }
                        ...
                        public final void onClick(View view) {
                            ...
                            switch (i) {
                                ...
                                case 3:
                                    ...
                                    paintView5.showLocationAlert((LocationView) entityView5, new BotBiometry$$ExternalSyntheticLambda10(11, paintView5, entityView5));
                                ...
                                default:
                                    ...
                                    if (entityView7 != null) {
                                        ...
                                        if (z3) {
                                            ...
                                            textPaintView.setDelegate(paintView9);
                                            textPaintView.setMaxWidth(paintView9.w - AndroidUtilities.dp(32.0f));
                                            anonymousClass9.addView(textPaintView, LayoutHelper.createFrame(-2, -2.0f));
                                            paintView9.checkEntitiesIsVideo();
                                            entityView2 = textPaintView;
                                        }
                                        paintView9.registerRemovalUndo$1(entityView2);
