...
public final class StoryRecorder$$ExternalSyntheticLambda113 implements Runnable {
    ...
    public StoryRecorder$$ExternalSyntheticLambda113(StoryRecorder storyRecorder, PaintView paintView, int i, int i2, StoryEntry storyEntry, boolean z, boolean z2, Runnable runnable, int i3) {
        this.$r8$classId = i3;
    ...
    public final void run() {
        ...
        switch (this.$r8$classId) {
            case 0:
                ...
                arrayList.add(new EmojiThemes$$ExternalSyntheticLambda3(bitmap, fileMakeCacheFile6, 1));
                if (storyEntry3.isRepostMessage) {
                    ...
                    if (j == Long.MIN_VALUE) {
                        ...
                        if (backgroundDrawable != null) {
                            ...
                            arrayList.add(new EmojiThemes$$ExternalSyntheticLambda3(bitmapCreateBitmap, fileMakeCacheFile, 2));
                        } else {
                            fileMakeCacheFile = null;
                        }
                    }
                ...
                if (storyEntry3.isRepostMessage && storyEntry3.isVideo) {
                    ...
                    if (photoImage == null || ((int) photoImage.getImageWidth()) <= 0 || ((int) photoImage.getImageHeight()) <= 0) {
                        ...
                        arrayList.add(new EmojiThemes$$ExternalSyntheticLambda3(bitmapCreateBitmap2, fileMakeCacheFile2, 3));
                    }
                } else {
                    fileMakeCacheFile2 = null;
                }
                if (paintView3.hasChanges()) {
                    if (zWouldBeVideo) {
                        ...
                        arrayList.add(new EmojiThemes$$ExternalSyntheticLambda3(bitmap2, fileMakeCacheFile3, 4));
                    }
                    if (this.f$5) {
                        Bitmap blurBitmap = paintView.getBlurBitmap();
                        fileMakeCacheFile4 = StoryEntry.makeCacheFile(i3, "png");
                        arrayList.add(new EmojiThemes$$ExternalSyntheticLambda3(blurBitmap, fileMakeCacheFile4, 5));
                        storyEntry3 = storyEntry;
                    } else {
                        storyEntry3 = storyEntry;
                        file = null;
                    }
                    final VoIPFragment$$ExternalSyntheticLambda9 voIPFragment$$ExternalSyntheticLambda9 = (VoIPFragment$$ExternalSyntheticLambda9) this.f$7;
                        ...
                        public final void run() {
                            switch (i11) {
                                case 0:
                                    ...
                                    ((StoryRecorder$$ExternalSyntheticLambda7) voIPFragment$$ExternalSyntheticLambda9).run();
                                    break;
                                default:
                                    ...
                                    ((VoIPFragment$$ExternalSyntheticLambda9) voIPFragment$$ExternalSyntheticLambda9).run();
                                    break;
                            }
                        }
                    });
                ...
                file = fileMakeCacheFile4;
                final Runnable voIPFragment$$ExternalSyntheticLambda10 = (VoIPFragment$$ExternalSyntheticLambda9) this.f$7;
                    ...
                    public final void run() {
                        switch (i12) {
                            case 0:
                                ...
                                storyEntry6.paintBlurFile = file;
                                storyEntry6.stickers = arrayList3;
                                ((StoryRecorder$$ExternalSyntheticLambda7) voIPFragment$$ExternalSyntheticLambda10).run();
                                break;
                            default:
                                ...
                                ((VoIPFragment$$ExternalSyntheticLambda9) voIPFragment$$ExternalSyntheticLambda10).run();
                                break;
                        }
                    }
                });
            ...
            default:
                ...
                final StoryRecorder$$ExternalSyntheticLambda7 storyRecorder$$ExternalSyntheticLambda7 = (StoryRecorder$$ExternalSyntheticLambda7) this.f$7;
                    ...
                    public final void run() {
                        switch (i23) {
                            case 0:
                                ...
                                ((StoryRecorder$$ExternalSyntheticLambda7) storyRecorder$$ExternalSyntheticLambda7).run();
                                break;
                            default:
                                ...
                                ((VoIPFragment$$ExternalSyntheticLambda9) storyRecorder$$ExternalSyntheticLambda7).run();
                                break;
                        }
                    }
                });
