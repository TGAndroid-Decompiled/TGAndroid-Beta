...
public final class StoryRecorder$$ExternalSyntheticLambda19 implements View.OnClickListener {
    ...
    public final void onClick(View view) {
        ...
        switch (this.$r8$classId) {
            ...
            case 1:
                ...
                if (storyRecorder2.outputEntry != null && storyRecorder2.changeDayNightView == null && storyRecorder2.themeButton != null) {
                    ...
                    if (valueAnimator == null || !valueAnimator.isRunning()) {
                        final boolean z = storyRecorder2.outputEntry.isDark;
                        final Bitmap bitmapCreateBitmap = Bitmap.createBitmap(storyRecorder2.windowView.getWidth(), storyRecorder2.windowView.getHeight(), Bitmap.Config.ARGB_8888);
                        ...
                        ?? r10 = new View(storyRecorder2.activity) {
                            ...
                            public final void onDraw(Canvas canvas2) {
                                ...
                                if (z2) {
                                    ...
                                    if (f6 > 0.0f) {
                                        canvas.drawCircle(f5, f4, f3 * f6, paint);
                                    }
                        ...
                        storyRecorder2.changeDayNightView = r10;
                        r10.setOnTouchListener(new BottomSheet$$ExternalSyntheticLambda6(1));
                        ...
                        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                            ...
                            public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                                ...
                                StoryRecorder storyRecorder3 = StoryRecorder.this;
                                storyRecorder3.changeDayNightViewProgress = fFloatValue;
                        ...
                        storyRecorder2.changeDayNightViewAnimator.setDuration(z ? 320L : 450L);
                        storyRecorder2.changeDayNightViewAnimator.setInterpolator(z ? CubicBezierInterpolator.EASE_IN : CubicBezierInterpolator.EASE_OUT_QUINT);
                        ...
                        AndroidUtilities.runOnUIThread(new StoryRecorder$$ExternalSyntheticLambda5(storyRecorder2, 5));
                    }
                    break;
                }
                break;
            case 2:
                ...
                if (storyEntry != null && !storyRecorder.awaitingPlayer) {
                    ...
                    if (storyRecorder.currentEditMode == -1) {
                        storyRecorder.muteHint.setText(storyEntry2.muted ? LocaleController.getString((!zIsEmpty || z2) ? R.string.StoryOriginalSoundMuted : R.string.StorySoundMuted) : LocaleController.getString((!zIsEmpty || z2) ? R.string.StoryOriginalSoundNotMuted : R.string.StorySoundNotMuted), storyRecorder.muteHint.shown());
            ...
            case 3:
                ...
                ((PlayPauseDrawable) storyRecorder.playButton.drawable).setPause(zContains, true);
                break;
            case 4:
            ...
            case 6:
                if (storyRecorder.currentPage == 0 && !storyRecorder.animatedRecording) {
                    ...
                    if (!storyRecorder.collageListView.visible && !storyRecorder.collageLayoutView.hasLayout()) {
                        ...
                        storyRecorder.collageButton.setIcon(new CollageLayoutButton.CollageLayoutDrawable(storyRecorder.lastCollageLayout, false), true);
            ...
            case 11:
                ...
                if (storyEntry3 != null) {
                    ...
                    storyRecorder.processDone$6();
                    StoryEntry storyEntry4 = storyRecorder.outputEntry;
                    if (storyEntry4 != null && !storyEntry4.isEditingCover) {
                        AndroidUtilities.runOnUIThread(new StoryRecorder$$ExternalSyntheticLambda5(storyRecorder, 22), 400L);
                        break;
                    }
                }
                break;
