    ...
    public final void run() {
        switch (this.$r8$classId) {
            case 0:
                ...
                break;
            case 1:
                StoryCaptionView.StoryCaptionTextView storyCaptionTextView2 = StoryCaptionView.StoryCaptionTextView.this;
                storyCaptionTextView2.sizeCached = 0;
                storyCaptionTextView2.requestLayout();
                StoryCaptionView storyCaptionView2 = StoryCaptionView.this;
            ...
            case 2:
                ...
                textState.getClass();
                StoryCaptionView.StoryCaptionTextView.this.post(new StoryCaptionView$StoryCaptionTextView$TextState$$ExternalSyntheticLambda2(textState, 3));
                break;
            default:
