    ...
    private boolean requestInternal() {
        ...
        this.currentReqId = ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_stories_getStoriesViews, new RequestDelegate() {
            ...
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                ViewsForPeerStoriesRequester.m4463$r8$lambda$Ro741gksRp0n0clrr1WHUZUJks(this.f$0, tL_stories_getStoriesViews, tLObject, tL_error);
            }
        });
        return true;
    }

    public static void m4463$r8$lambda$Ro741gksRp0n0clrr1WHUZUJks(final ViewsForPeerStoriesRequester viewsForPeerStoriesRequester, final TL_stories.TL_stories_getStoriesViews tL_stories_getStoriesViews, final TLObject tLObject, TLRPC.TL_error tL_error) {
