...
public final class StoriesStorage$$ExternalSyntheticLambda1 implements RequestDelegate {
    ...
    public StoriesStorage$$ExternalSyntheticLambda1(MediaDataController mediaDataController, Timer.Task task, long j, LongSparseArray longSparseArray, boolean z, Timer timer, AtomicInteger atomicInteger, Runnable runnable) {
                ...
                if (tLObject != null) {
                    ...
                    while (true) {
                        ...
                        if (i < arrayList.size()) {
                            ...
                            if (this.f$4) {
                                storiesStorage.storage.getStorageQueue().postRunnable(new StoryViewer$5$$ExternalSyntheticLambda0(7, storiesStorage, arrayList));
                            }
                            i++;
                        }
                    }
    ...
    public StoriesStorage$$ExternalSyntheticLambda1(StoriesStorage storiesStorage, Timer.Task task, ArrayList arrayList, long j, boolean z, Timer timer, int[] iArr, Runnable runnable) {
