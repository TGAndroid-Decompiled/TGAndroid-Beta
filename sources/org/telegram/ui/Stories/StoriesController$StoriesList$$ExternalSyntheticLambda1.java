...
public final class StoriesController$StoriesList$$ExternalSyntheticLambda1 implements Runnable {
    public final int $r8$classId;
    public final StoriesController.StoriesList f$0;

    public StoriesController$StoriesList$$ExternalSyntheticLambda1(StoriesController.StoriesList storiesList, int i) {
        this.$r8$classId = i;
