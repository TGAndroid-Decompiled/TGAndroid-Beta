...
public final class PeerStoriesView$8$$ExternalSyntheticLambda31 implements Runnable {
    public final int $r8$classId;
    public final ActionBarPopupWindow.ActionBarPopupWindowLayout f$0;
    public final int f$1;

    public PeerStoriesView$8$$ExternalSyntheticLambda31(ActionBarPopupWindow.ActionBarPopupWindowLayout actionBarPopupWindowLayout, int i, int i2) {
        this.$r8$classId = i2;
