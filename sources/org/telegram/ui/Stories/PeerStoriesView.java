...
public class PeerStoriesView extends SizeNotifierFrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public void toggleArchiveForStory(final long j) {
        ...
        AndroidUtilities.runOnUIThread(new Runnable() {
            @Override
            public final void run() {
                PeerStoriesView.this.lambda$toggleArchiveForStory$19(messagesController, j, z2, str2, tLRPC$Chat2);
            }
        }, 200L);
    }
    ...
    private void createChatAttachView() {
        if (this.chatAttachAlert == null) {
            ...
            chatAttachAlert.setDelegate(new ChatAttachAlert.ChatAttachViewDelegate() {
                ...
                @Override
                public void sendAudio(ArrayList<MessageObject> arrayList, CharSequence charSequence, boolean z2, int i, long j, boolean z3) {
                    PeerStoriesView peerStoriesView = PeerStoriesView.this;
                    TL_stories$StoryItem tL_stories$StoryItem = peerStoriesView.currentStory.storyItem;
                    if (tL_stories$StoryItem == null || (tL_stories$StoryItem instanceof TL_stories$TL_storyItemSkipped)) {
                        return;
            ...
            this.chatAttachAlert.setDocumentsDelegate(new ChatAttachAlertDocumentLayout.DocumentSelectActivityDelegate() {
                ...
                @Override
                public void didSelectFiles(ArrayList<String> arrayList, String str, ArrayList<MessageObject> arrayList2, boolean z2, int i, long j, boolean z3) {
                    PeerStoriesView peerStoriesView = PeerStoriesView.this;
                    TL_stories$StoryItem tL_stories$StoryItem = peerStoriesView.currentStory.storyItem;
                    if (tL_stories$StoryItem == null || (tL_stories$StoryItem instanceof TL_stories$TL_storyItemSkipped)) {
                        return;
                    ...
                    if (of != null) {
                        if (longSparseArray.size() == 1) {
                            ...
                            if (keyAt == UserConfig.getInstance(this.currentAccount).clientUserId) {
                                ...
                                of.createSimpleBulletin(R.raw.forward, AndroidUtilities.replaceTags(LocaleController.formatString("StorySharedTo", R.string.StorySharedTo, tLRPC$TL_forumTopic != null ? tLRPC$TL_forumTopic.title : MessagesController.getInstance(this.currentAccount).getChat(Long.valueOf(-keyAt)).title)), 5000).hideAfterBottomSheet(false).show();
                            } else {
        ...
        if (this.day != null) {
            ...
            if (i3 == -1 && !this.storyViewer.isSingleStory && (tL_stories$PeerStories = this.userStories) != null && tL_stories$PeerStories.max_read_id > 0) {
                ...
                while (true) {
                    ...
                    if (this.storyItems.get(i4).id > this.userStories.max_read_id) {
                        this.selectedPosition = i4;
                        break;
                    }
                    i4++;
    ...
    private void setStoryImage(TL_stories$StoryItem tL_stories$StoryItem, ImageReceiver imageReceiver, String str) {
        ...
        if (str2 != null) {
            ...
            if (z) {
                imageReceiver.setImage(ImageLocation.getForPath(tL_stories$StoryItem.attachPath), str + "_pframe", ImageLocation.getForPath(tL_stories$StoryItem.firstFramePath), str, null, null, null, 0L, null, null, 0);
                return;
            }
        ...
        if (z) {
            ...
            imageReceiver.setImage(ImageLocation.getForDocument(tL_stories$StoryItem.media.getDocument()), str + "_pframe", ImageLocation.getForDocument(closestPhotoSizeWithSize, tL_stories$StoryItem.media.getDocument()), str, null, null, null, 0L, null, tL_stories$StoryItem, 0);
            return;
        }
    ...
    public class AnonymousClass35 implements ReactionsContainerLayout.ReactionsContainerDelegate {
        ...
        void onReactionClickedInternal(final View view, final ReactionsLayoutInBubble.VisibleReaction visibleReaction, final boolean z, final boolean z2, boolean z3) {
            ...
            PeerStoriesView peerStoriesView3 = PeerStoriesView.this;
            BulletinFactory.of(peerStoriesView3.storyContainer, peerStoriesView3.resourcesProvider).createEmojiBulletin(tLRPC$Document, LocaleController.getString("ReactionSent", R.string.ReactionSent), LocaleController.getString("ViewInChat", R.string.ViewInChat), new Runnable() {
                @Override
                public final void run() {
