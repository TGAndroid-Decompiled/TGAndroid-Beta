...
public final class StoriesController$StoriesList$$ExternalSyntheticLambda4 implements Runnable {
    public final int $r8$classId;
    public final StoriesController.StoriesList f$0;
    public final MessagesStorage f$1;

    public StoriesController$StoriesList$$ExternalSyntheticLambda4(StoriesController.StoriesList storiesList, MessagesStorage messagesStorage, int i) {
        this.$r8$classId = i;
    ...
    public final void run() {
        ...
        switch (i) {
                        ...
                        if (nativeByteBufferByteBufferValue != null) {
                            ...
                            try {
                                ...
                                try {
                                    ...
                                    AndroidUtilities.runOnUIThread(new ChatActivity$$ExternalSyntheticLambda375(storiesList, arrayList2, arrayList, arrayList3, arrayList4, hashSet, 19));
                                    return;
                                } catch (Throwable th2) {
                                    if (sQLiteCursorCreateLoadStoriesCursor != null) {
                                        sQLiteCursorCreateLoadStoriesCursor.dispose();
            ...
            default:
                ...
                AndroidUtilities.runOnUIThread(new StoriesController$StoriesList$$ExternalSyntheticLambda0(storiesList3, 3));
                return;
        }
    }
}
