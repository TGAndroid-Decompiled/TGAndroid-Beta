...
public final class StoriesStorage$$ExternalSyntheticLambda13 implements Runnable {
    public final int $r8$classId;
    public final StoriesStorage f$0;
    public final TL_stories.PeerStories f$1;

    public StoriesStorage$$ExternalSyntheticLambda13(StoriesStorage storiesStorage, TL_stories.PeerStories peerStories, int i) {
        this.$r8$classId = i;
