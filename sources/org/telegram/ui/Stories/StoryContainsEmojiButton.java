...
public final class StoryContainsEmojiButton extends View {
    ...
    public static Vector lastResponse;
    public final PorterDuffColorFilter colorFilter;
    public boolean emoji;
    public final ArrayList inputSets;
    public int lastContentWidth;
    ...
    public StoryContainsEmojiButton(Context context, int i, TLObject tLObject, Object obj, boolean z, ArrayList arrayList, DarkThemeResourceProvider darkThemeResourceProvider) {
        Vector vector;
        super(context);
        this.shiftDp = -12;
        ...
        setBackground(Theme.createRadSelectorDrawable(Theme.getColor(Theme.key_listSelector, darkThemeResourceProvider), 0, 8));
        setClickable(true);
        ...
        if (!z) {
            ...
            if (this.inputSets.size() == 1) {
                MediaDataController.getInstance(i).getStickerSet((TLRPC.InputStickerSet) this.inputSets.get(0), 0, false, new StoryContainsEmojiButton$$ExternalSyntheticLambda2(this, 0));
                return;
            } else {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (f < 1.0f) {
            ...
            loadingDrawable.setAlpha((int) ((1.0f - f) * 255.0f));
    ...
    public final void lambda$load$0(TLRPC.TL_messages_stickerSet tL_messages_stickerSet) {
        set(tL_messages_stickerSet);
        animateLoad(false);
    }

    public final void lambda$load$1(TLObject tLObject, Object obj, ArrayList arrayList, boolean[] zArr, int i) {
        if (tLObject instanceof Vector) {
            ...
            if (size2 != 1) {
                ...
                if (arrayList != null && arrayList.size() >= 1) {
                    zArr[0] = false;
                    MediaDataController.getInstance(i).getStickerSet((TLRPC.InputStickerSet) arrayList.get(0), 0, false, new StoryContainsEmojiButton$$ExternalSyntheticLambda2(this, 1));
                    return;
                }
                set(0);
            }
    ...
    public final void lambda$load$4(TLRPC.TL_messages_stickerSet tL_messages_stickerSet) {
        set(tL_messages_stickerSet);
        animateLoad(true);
    }
    ...
    public final void onMeasure(int i, int i2) {
        ...
        setMeasuredDimension(z ? View.MeasureSpec.getSize(i) : getMinimumWidth(), getPaddingBottom() + AndroidUtilities.lerp(iDp, staticLayout == null ? AndroidUtilities.dp(29.0f) : staticLayout.getHeight(), this.loadT) + paddingTop);
    ...
    private void set(int i) {
        ...
        LoadingDrawable loadingDrawable = this.loadingDrawable;
        if (z && this.stickers) {
            setText(AndroidUtilities.replaceSingleTag(LocaleController.formatPluralString("StoryContainsStickersEmoji", i, new Object[0]), 0, Theme.getColor(Theme.key_chat_messageLinkIn, loadingDrawable.resourcesProvider), null));
        } else if (z) {
            setText(AndroidUtilities.replaceSingleTag(LocaleController.formatPluralString("StoryContainsEmoji", i, new Object[0]), 0, Theme.getColor(Theme.key_chat_messageLinkIn, loadingDrawable.resourcesProvider), null));
        } else {
            setText(AndroidUtilities.replaceSingleTag(LocaleController.formatPluralString("StoryContainsStickers", i, new Object[0]), 0, Theme.getColor(Theme.key_chat_messageLinkIn, loadingDrawable.resourcesProvider), null));
        }
    }
}
