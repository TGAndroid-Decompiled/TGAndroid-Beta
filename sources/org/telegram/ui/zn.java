...
public final class zn extends Drawable {
    ...
    public View f40528b;
    public int f40529c = 255;
    public final float d;
    public final ai.l4 e;
    public final org.telegram.ui.Components.mc0 f40530f;
    public final TLRPC.WallPaper f40531g;
    public boolean h;
    public boolean f40532i;
    public final ArrayList f40533j;
        ...
        if (wallPaper.document != null) {
            ...
            if (wallPaperSettings != null && wallPaperSettings.intensity >= 0) {
                if (wallPaperSettings.second_background_color == 0) {
                    ...
                    a2 = new BitmapDrawable(mc0Var.f26435k);
                }
            } else {
    ...
    public final Drawable c(boolean z10) {
        org.telegram.ui.Components.mc0 mc0Var = this.f40530f;
        if (mc0Var != null) {
            return mc0Var;
        }
        ai.l4 l4Var = this.e;
    ...
    public final void draw(Canvas canvas) {
        ...
        l4Var.setAlpha(this.f40529c / 255.0f);
        l4Var.draw(canvas);
        if (z10 && f7 != 0.0f) {
    ...
    public final void f(View view) {
        ArrayList arrayList = this.f40533j;
        if (!arrayList.contains(view)) {
            arrayList.add(view);
        }
        int size = arrayList.size();
        ai.l4 l4Var = this.e;
        if (size > 0 && !this.f40532i) {
            this.f40532i = true;
            l4Var.onAttachedToWindow();
        } else if (arrayList.size() <= 0 && this.f40532i) {
            this.f40532i = false;
