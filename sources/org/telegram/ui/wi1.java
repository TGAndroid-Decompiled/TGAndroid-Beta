...
public final class wi1 implements di0 {
    public final org.telegram.ui.Cells.t1 f39053a;
    public final org.telegram.ui.Components.ml0 f39054b;
    public final float f39055c;
    public float d;
    public final Paint e = new Paint(1);
    public final ValueAnimator f39056f;
    public final ChatActivityEnterView.RecordCircle f39057g;
    public final int h;
    public final org.telegram.ui.Components.ui f39058i;
    public final org.telegram.ui.ActionBar.f6 f39059j;
    public float f39060k;
    public float f39061l;
    ...
    public wi1(org.telegram.ui.Cells.t1 t1Var, nk nkVar, org.telegram.ui.Components.ml0 ml0Var, org.telegram.ui.Components.ui uiVar, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.f39057g = recordCircle;
        if (recordCircle != null) {
            this.f39055c = recordCircle.L;
            recordCircle.M = true;
            recordCircle.N = true;
        }
        new Matrix();
        ...
        ((ArrayList) uiVar.f28396c).add(this);
        uiVar.a();
        ((ViewGroup) uiVar.d).invalidate();
        ValueAnimator ofFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
        this.f39056f = ofFloat;
    ...
    public final void a(final Canvas canvas) {
        ...
        ChatActivityEnterView.RecordCircle recordCircle = this.f39057g;
        org.telegram.ui.Components.ui uiVar = this.f39058i;
        if (recordCircle == null) {
            x10 = 0.0f;
        } else {
        ...
        org.telegram.ui.Cells.t1 t1Var = this.f39053a;
        int i10 = t1Var.getMessageObject().stableId;
        int i11 = this.h;
        org.telegram.ui.Components.ml0 ml0Var = this.f39054b;
        if (i10 != i11) {
            x11 = this.f39060k;
            y10 = this.f39061l;
        } else {
            y10 = (ml0Var.getY() + (t1Var.getY() + t1Var.getRadialProgress().f22138a.centerY())) - uiVar.getY();
            x11 = (ml0Var.getX() + (t1Var.getX() + t1Var.getRadialProgress().f22138a.centerX())) - uiVar.getX();
        }
        this.f39060k = x11;
        this.f39061l = y10;
        float interpolation = org.telegram.ui.Components.qr.f27383f.getInterpolation(f12);
        ...
        float height = t1Var.getRadialProgress().f22138a.height() / 2.0f;
        float f16 = (height * interpolation) + (this.f39055c * f14);
        ml0Var.getY();
        uiVar.getY();
        ...
        int i12 = t1Var.getRadialProgress().f22150p;
        int i13 = org.telegram.ui.ActionBar.j6.f18853cf;
        org.telegram.ui.ActionBar.f6 f6Var = this.f39059j;
        float f17 = f7;
        ...
        if (recordCircle != null) {
            ...
            org.telegram.ui.Components.z9 z9Var2 = recordCircle.f21895n;
            f10 = x10;
            float interpolation3 = org.telegram.ui.Components.qr.f27384g.getInterpolation(recordCircle.H);
            ChatActivityEnterView chatActivityEnterView = ChatActivityEnterView.this;
            float f19 = chatActivityEnterView.f21799i4;
            if (f19 > 0.7f) {
                f11 = 1.0f;
            } else {
                f11 = f19 / 0.7f;
            ...
            canvas.save();
            float f20 = ((z9Var2.f30446t * 1.4f) + 0.878f) * chatActivityEnterView.f21787g4 * f11 * interpolation3 * f18;
            canvas.scale(f20, f20, f13, f15);
            z9Var2.a(f13, f15, canvas, z9Var2.d);
            canvas.restore();
            float f21 = ((z9Var.f30446t * 1.4f) + 0.926f) * chatActivityEnterView.f21787g4 * f11 * interpolation3 * f18;
            canvas.save();
        ...
        final float centerX = f13 - t1Var.getRadialProgress().f22138a.centerX();
        final float centerY = f15 - t1Var.getRadialProgress().f22138a.centerY();
        ...
        t1Var.q2(canvas, interpolation, new Runnable() {
            ...
            public final void run() {
                ...
                Drawable drawable3;
                wi1 wi1Var = wi1.this;
                RadialProgress2 radialProgress = wi1Var.f39053a.getRadialProgress();
                ...
                ChatActivityEnterView.RecordCircle recordCircle2 = wi1Var.f39057g;
                if (recordCircle2 != null) {
                    ...
                    boolean z10 = chatActivityEnterView2.f21847r4;
                    Rect rect = chatActivityEnterView2.S3;
                    Drawable drawable4 = null;
                    if (z10) {
                        if (recordCircle2.f21894f != 1.0f) {
                            if (chatActivityEnterView2.f21759c1) {
                    ...
                    canvas3 = canvas2;
                    recordCircle2.b(canvas3, drawable5, drawable6, recordCircle2.f21894f, (int) (255.0f * f24));
                }
