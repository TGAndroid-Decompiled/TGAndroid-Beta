...
public final class wi1 implements di0 {
    public final org.telegram.ui.Cells.u1 f39162a;
    public final org.telegram.ui.Components.vl0 f39163b;
    public final float f39164c;
    public float d;
    public final Paint e = new Paint(1);
    public final ValueAnimator f39165f;
    public final ChatActivityEnterView.RecordCircle f39166g;
    public final int h;
    public final org.telegram.ui.Components.ui f39167i;
    public final org.telegram.ui.ActionBar.f6 f39168j;
    public float f39169k;
    public float f39170l;
    ...
    public wi1(org.telegram.ui.Cells.u1 u1Var, lk lkVar, org.telegram.ui.Components.vl0 vl0Var, org.telegram.ui.Components.ui uiVar, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.f39166g = recordCircle;
        if (recordCircle != null) {
            this.f39164c = recordCircle.L;
            recordCircle.M = true;
            recordCircle.N = true;
        }
        new Matrix();
        ...
        ((ArrayList) uiVar.f28686c).add(this);
        uiVar.a();
        ((ViewGroup) uiVar.d).invalidate();
        ValueAnimator ofFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
        this.f39165f = ofFloat;
    ...
    public final void a(final Canvas canvas) {
        ...
        ChatActivityEnterView.RecordCircle recordCircle = this.f39166g;
        org.telegram.ui.Components.ui uiVar = this.f39167i;
        if (recordCircle == null) {
            x10 = 0.0f;
        } else {
        ...
        org.telegram.ui.Cells.u1 u1Var = this.f39162a;
        int i10 = u1Var.getMessageObject().stableId;
        int i11 = this.h;
        org.telegram.ui.Components.vl0 vl0Var = this.f39163b;
        if (i10 != i11) {
            x11 = this.f39169k;
            y10 = this.f39170l;
        } else {
            y10 = (vl0Var.getY() + (u1Var.getY() + u1Var.getRadialProgress().f22346a.centerY())) - uiVar.getY();
            x11 = (vl0Var.getX() + (u1Var.getX() + u1Var.getRadialProgress().f22346a.centerX())) - uiVar.getX();
        }
        this.f39169k = x11;
        this.f39170l = y10;
        float interpolation = org.telegram.ui.Components.qr.f27642f.getInterpolation(f12);
        ...
        float height = u1Var.getRadialProgress().f22346a.height() / 2.0f;
        float f16 = (height * interpolation) + (this.f39164c * f14);
        vl0Var.getY();
        uiVar.getY();
        ...
        int i12 = u1Var.getRadialProgress().f22358p;
        int i13 = org.telegram.ui.ActionBar.j6.f19084cf;
        org.telegram.ui.ActionBar.f6 f6Var = this.f39168j;
        float f17 = f7;
        ...
        if (recordCircle != null) {
            ...
            org.telegram.ui.Components.aa aaVar2 = recordCircle.f22103n;
            f10 = x10;
            float interpolation3 = org.telegram.ui.Components.qr.f27643g.getInterpolation(recordCircle.H);
            ChatActivityEnterView chatActivityEnterView = ChatActivityEnterView.this;
            float f19 = chatActivityEnterView.f22008i4;
            if (f19 > 0.7f) {
                f11 = 1.0f;
            } else {
                f11 = f19 / 0.7f;
            ...
            canvas.save();
            float f20 = ((aaVar2.f22611t * 1.4f) + 0.878f) * chatActivityEnterView.f21996g4 * f11 * interpolation3 * f18;
            canvas.scale(f20, f20, f13, f15);
            aaVar2.a(f13, f15, canvas, aaVar2.d);
            canvas.restore();
            float f21 = ((aaVar.f22611t * 1.4f) + 0.926f) * chatActivityEnterView.f21996g4 * f11 * interpolation3 * f18;
            canvas.save();
        ...
        final float centerX = f13 - u1Var.getRadialProgress().f22346a.centerX();
        final float centerY = f15 - u1Var.getRadialProgress().f22346a.centerY();
        ...
        u1Var.q2(canvas, interpolation, new Runnable() {
            ...
            public final void run() {
                ...
                Drawable drawable3;
                wi1 wi1Var = wi1.this;
                RadialProgress2 radialProgress = wi1Var.f39162a.getRadialProgress();
                ...
                ChatActivityEnterView.RecordCircle recordCircle2 = wi1Var.f39166g;
                if (recordCircle2 != null) {
                    ...
                    boolean z10 = chatActivityEnterView2.f22055r4;
                    Rect rect = chatActivityEnterView2.S3;
                    Drawable drawable4 = null;
                    if (z10) {
                        if (recordCircle2.f22102f != 1.0f) {
                    ...
                    canvas3 = canvas2;
                    recordCircle2.b(canvas3, drawable5, drawable6, recordCircle2.f22102f, (int) (255.0f * f24));
                }
