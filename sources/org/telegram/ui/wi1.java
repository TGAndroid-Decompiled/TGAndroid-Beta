...
public final class wi1 implements bi0 {
    public final org.telegram.ui.Cells.t1 f39240a;
    public final org.telegram.ui.Components.ll0 f39241b;
    public final float f39242c;
    public float d;
    public final Paint e = new Paint(1);
    public final ValueAnimator f39243f;
    public final ChatActivityEnterView.RecordCircle f39244g;
    public final int h;
    public final org.telegram.ui.Components.ui f39245i;
    public final org.telegram.ui.ActionBar.e6 f39246j;
    public float f39247k;
    public float f39248l;

    public wi1(org.telegram.ui.Cells.t1 t1Var, mk mkVar, org.telegram.ui.Components.ll0 ll0Var, org.telegram.ui.Components.ui uiVar, org.telegram.ui.ActionBar.e6 e6Var) {
        this.f39246j = e6Var;
        this.f39240a = t1Var;
        this.f39245i = uiVar;
        this.f39241b = ll0Var;
        ...
        this.f39244g = recordCircle;
        if (recordCircle != null) {
            this.f39242c = recordCircle.L;
            recordCircle.M = true;
            recordCircle.N = true;
        }
        new Matrix();
        ...
        ((ArrayList) uiVar.f28413c).add(this);
        uiVar.a();
        ((ViewGroup) uiVar.d).invalidate();
        ValueAnimator ofFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
        this.f39243f = ofFloat;
    ...
    public final void a(final Canvas canvas) {
        ...
        ChatActivityEnterView.RecordCircle recordCircle = this.f39244g;
        org.telegram.ui.Components.ui uiVar = this.f39245i;
        if (recordCircle == null) {
            x10 = 0.0f;
        } else {
        ...
        org.telegram.ui.Cells.t1 t1Var = this.f39240a;
        int i10 = t1Var.getMessageObject().stableId;
        int i11 = this.h;
        org.telegram.ui.Components.ll0 ll0Var = this.f39241b;
        if (i10 != i11) {
            x11 = this.f39247k;
            y10 = this.f39248l;
        } else {
            y10 = (ll0Var.getY() + (t1Var.getY() + t1Var.getRadialProgress().f22125a.centerY())) - uiVar.getY();
            x11 = (ll0Var.getX() + (t1Var.getX() + t1Var.getRadialProgress().f22125a.centerX())) - uiVar.getX();
        }
        this.f39247k = x11;
        this.f39248l = y10;
        float interpolation = org.telegram.ui.Components.qr.f27423f.getInterpolation(f12);
        ...
        float height = t1Var.getRadialProgress().f22125a.height() / 2.0f;
        float f16 = (height * interpolation) + (this.f39242c * f14);
        ll0Var.getY();
        uiVar.getY();
        ...
        int i12 = t1Var.getRadialProgress().f22137p;
        int i13 = org.telegram.ui.ActionBar.i6.f18826cf;
        org.telegram.ui.ActionBar.e6 e6Var = this.f39246j;
        float f17 = f7;
        ...
        if (recordCircle != null) {
            ...
            org.telegram.ui.Components.z9 z9Var2 = recordCircle.f21882n;
            f10 = x10;
            float interpolation3 = org.telegram.ui.Components.qr.f27424g.getInterpolation(recordCircle.H);
            ChatActivityEnterView chatActivityEnterView = ChatActivityEnterView.this;
            float f19 = chatActivityEnterView.f21787i4;
            if (f19 > 0.7f) {
                f11 = 1.0f;
            } else {
                f11 = f19 / 0.7f;
            ...
            canvas.save();
            float f20 = ((z9Var2.f30520t * 1.4f) + 0.878f) * chatActivityEnterView.f21775g4 * f11 * interpolation3 * f18;
            canvas.scale(f20, f20, f13, f15);
            z9Var2.a(f13, f15, canvas, z9Var2.d);
            canvas.restore();
            float f21 = ((z9Var.f30520t * 1.4f) + 0.926f) * chatActivityEnterView.f21775g4 * f11 * interpolation3 * f18;
            canvas.save();
        ...
        final float centerX = f13 - t1Var.getRadialProgress().f22125a.centerX();
        final float centerY = f15 - t1Var.getRadialProgress().f22125a.centerY();
        ...
        t1Var.q2(canvas, interpolation, new Runnable() {
            ...
            public final void run() {
                ...
                Drawable drawable3;
                wi1 wi1Var = wi1.this;
                RadialProgress2 radialProgress = wi1Var.f39240a.getRadialProgress();
                ...
                ChatActivityEnterView.RecordCircle recordCircle2 = wi1Var.f39244g;
                if (recordCircle2 != null) {
                    ...
                    boolean z10 = chatActivityEnterView2.f21834r4;
                    Rect rect = chatActivityEnterView2.S3;
                    Drawable drawable4 = null;
                    if (z10) {
                        if (recordCircle2.f21881f != 1.0f) {
                            if (chatActivityEnterView2.f21747c1) {
                    ...
                    canvas3 = canvas2;
                    recordCircle2.b(canvas3, drawable5, drawable6, recordCircle2.f21881f, (int) (255.0f * f24));
                }
