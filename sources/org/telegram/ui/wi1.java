...
public final class wi1 extends org.telegram.ui.ActionBar.e5 {
    public final WallpapersListActivity f39377f;

    public wi1(WallpapersListActivity wallpapersListActivity) {
        this.f39377f = wallpapersListActivity;
    }

    @Override
    public final void k() {
        WallpapersListActivity wallpapersListActivity = this.f39377f;
    ...
    public final void q(EditText editText) {
        this.f39377f.J.E(editText.getText().toString(), false);
    }
}
