...
public final class vz0 extends h71 {
    public final y61[] f38658d2;
    public final ProfileActivity f38659e2;
    ...
    public vz0(ProfileActivity profileActivity, ProfileActivity profileActivity2, Activity activity, Integer num, int i10, org.telegram.ui.ActionBar.e6 e6Var, int i11, y61[] y61VarArr) {
        ...
        this.f38659e2 = profileActivity;
        this.f38658d2 = y61VarArr;
    }
    ...
    public final boolean F(TL_stars.TL_starGiftUnique tL_starGiftUnique) {
        ...
        if (tL_starGiftUnique != null) {
            i10 = ((org.telegram.ui.ActionBar.n2) this.f38659e2).currentAccount;
    ...
    public final void p(View view, Long l4, TLRPC.Document document, TL_stars.TL_starGiftUnique tL_starGiftUnique, Integer num) {
        ...
        int i11;
        int i12;
        ProfileActivity profileActivity = this.f38659e2;
        org.telegram.ui.Components.m5[] m5VarArr = profileActivity.G;
        y61[] y61VarArr = this.f38658d2;
        if (tL_starGiftUnique != null) {
            ...
            if (n10 != null && MessagesController.getGlobalMainSettings().getInt("statusgiftpage", 0) < 2) {
                ...
                yh.z3 z3Var = new yh.z3(context, i11, UserConfig.getInstance(i12).getClientUserId(), profileActivity.f31409z0, null);
                z3Var.j2(n10, null);
                z3Var.m2();
                z3Var.show();
            ...
            tL_inputEmojiStatusCollectible2.collectible_id = tL_starGiftUnique.f18334id;
        ...
        if (tL_starGiftUnique != null) {
            l10 = Long.valueOf(tL_starGiftUnique.f18334id);
        } else {
            l10 = null;
        }
        ...
        if (l4 != null) {
            org.telegram.ui.Cells.o oVar = profileActivity.f31258d0;
            ?? obj = new Object();
