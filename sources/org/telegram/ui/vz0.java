...
public final class vz0 extends rv0 {
    ...
    public final void c(Canvas canvas, float f7, float f10, float f11, float f12, float f13) {
        ...
        if (f7 > 0.0f) {
            ...
            rectF.set(0.0f, 0.0f, profileActivity.f31346n0.getMeasuredWidth(), AndroidUtilities.dp(30.0f) + profileActivity.f31346n0.getMeasuredHeight());
    ...
    public final void e() {
        ...
        for (int i10 = 0; i10 < profileActivity.f31346n0.getChildCount(); i10++) {
            profileActivity.f31346n0.getChildAt(i10).invalidate();
        }
        org.telegram.ui.Components.bj0 bj0Var = profileActivity.v;
        if (bj0Var != null) {
            bj0Var.invalidate();
    ...
    public final boolean j(View view, ImageReceiver imageReceiver) {
        if (super.j(view, imageReceiver) && this.T.f31255a.getScrollState() != 1) {
            return true;
        }
        return false;
    }
