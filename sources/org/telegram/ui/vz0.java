...
public final class vz0 extends j71 {
    public final a71[] f41727d2;
    public final ProfileActivity f41728e2;
    ...
    public vz0(ProfileActivity profileActivity, ProfileActivity profileActivity2, Activity activity, Integer num, int i10, org.telegram.ui.ActionBar.f6 f6Var, int i11, a71[] a71VarArr) {
        ...
        this.f41728e2 = profileActivity;
        this.f41727d2 = a71VarArr;
    }
    ...
    public final boolean F(TL_stars.TL_starGiftUnique tL_starGiftUnique) {
        ...
        if (tL_starGiftUnique != null) {
            i10 = ((org.telegram.ui.ActionBar.n2) this.f41728e2).currentAccount;
    ...
    public final void p(View view, Long l4, TLRPC.Document document, TL_stars.TL_starGiftUnique tL_starGiftUnique, Integer num) {
        ...
        int i11;
        int i12;
        ProfileActivity profileActivity = this.f41728e2;
        org.telegram.ui.Components.o5[] o5VarArr = profileActivity.G;
        a71[] a71VarArr = this.f41727d2;
        if (tL_starGiftUnique != null) {
            ...
            if (n10 != null && MessagesController.getGlobalMainSettings().getInt("statusgiftpage", 0) < 2) {
                ...
                zh.w3 w3Var = new zh.w3(context, i11, UserConfig.getInstance(i12).getClientUserId(), profileActivity.f34032z0, null);
                w3Var.j2(n10, null);
                w3Var.m2();
                w3Var.show();
            ...
            tL_inputEmojiStatusCollectible2.collectible_id = tL_starGiftUnique.f20096id;
        ...
        if (tL_starGiftUnique != null) {
            l10 = Long.valueOf(tL_starGiftUnique.f20096id);
        } else {
            l10 = null;
        }
        ...
        if (l4 != null) {
            org.telegram.ui.Cells.o oVar = profileActivity.f33880d0;
            ?? obj = new Object();
