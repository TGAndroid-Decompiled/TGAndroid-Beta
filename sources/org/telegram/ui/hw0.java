...
public final class hw0 implements org.telegram.ui.Components.og {
    public final PopupNotificationActivity f34319a;

    public hw0(PopupNotificationActivity popupNotificationActivity) {
        this.f34319a = popupNotificationActivity;
    }
    ...
    public final void E1() {
        PopupNotificationActivity popupNotificationActivity = this.f34319a;
    ...
    public final void H(CharSequence charSequence, boolean z10, int i10, int i11, long j3) {
        ...
        if (i12 >= 0 && i12 < popupNotificationActivity.f31430a0.size()) {
            popupNotificationActivity.f31430a0.remove(popupNotificationActivity.S);
        }
