...
public final class pw0 extends RelativeLayout {
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        for (int i14 = 0; i14 < getChildCount(); i14++) {
            ...
            if (childAt.getTag() instanceof String) {
                ...
                childAt.layout(left, AndroidUtilities.dp(3.0f) + popupNotificationActivity.f31145b.getTop(), childAt.getRight(), popupNotificationActivity.f31145b.getBottom());
            }
        }
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        PopupNotificationActivity popupNotificationActivity = this.f36710a;
        int measuredWidth = popupNotificationActivity.f31145b.getMeasuredWidth();
        int measuredHeight = popupNotificationActivity.f31145b.getMeasuredHeight();
