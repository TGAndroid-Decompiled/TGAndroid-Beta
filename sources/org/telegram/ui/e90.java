...
public final class e90 implements RequestDelegate {
    ...
    public final LaunchActivity f33333b;
    public final int f33334c;
    public final oa0 d;
    public final Object e;
    public final Object f33335f;
    public final Object f33336g;
    public final Object h;
    public final Object f33337i;
    ...
    public e90(LaunchActivity launchActivity, oa0 oa0Var, int i10, TL_account.authorizationForm authorizationform, TL_account.getAuthorizationForm getauthorizationform, String str, String str2, String str3) {
        this.f33332a = 0;
        this.f33333b = launchActivity;
        this.d = oa0Var;
        this.f33334c = i10;
        this.f33337i = authorizationform;
    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        Object obj3 = this.f33335f;
        Object obj4 = this.e;
        Object obj5 = this.f33337i;
        switch (i10) {
            case 0:
                Pattern pattern = LaunchActivity.B1;
                AndroidUtilities.runOnUIThread(new org.telegram.messenger.jb(this.f33333b, this.d, tLObject, this.f33334c, (TL_account.authorizationForm) obj5, (TL_account.getAuthorizationForm) obj4, (String) obj3, (String) obj2, (String) obj, 2));
                return;
            case 1:
                int[] iArr = (int[]) obj5;
                ...
                LaunchActivity launchActivity = this.f33333b;
                oa0 oa0Var = this.d;
            ...
            default:
                ...
                AndroidUtilities.runOnUIThread(new org.telegram.messenger.jb(this.f33333b, tLObject, (int[]) obj5, this.f33334c, this.d, (Integer) obj4, (Integer) obj3, (Long) obj2, (Integer) obj, 3));
                return;
        }
    }
