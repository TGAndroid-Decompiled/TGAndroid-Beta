...
public final class u20 implements View.OnClickListener {
    ...
    public final j60 f37088b;

    public u20(j60 j60Var, int i10) {
        this.f37087a = i10;
        this.f37088b = j60Var;
    }
    ...
    public final void onClick(View view) {
        ...
        int i11;
        String string;
        int i12 = this.f37087a;
        int i13 = 0;
        j60 j60Var = this.f37088b;
        switch (i12) {
            case 0:
                org.telegram.ui.ActionBar.w0 w0Var = j60Var.f33977k1;
                org.telegram.ui.ActionBar.g1 g1Var = j60Var.f34022v1;
                org.telegram.ui.ActionBar.g1 g1Var2 = j60Var.f34018u1;
                org.telegram.ui.ActionBar.g1 g1Var3 = j60Var.f33996p1;
                ChatObject.Call call = j60Var.f33936a1;
                if (call != null && !j60Var.a2.f28241b) {
                    if (call.call.join_muted) {
                        int i14 = org.telegram.ui.ActionBar.j6.f18007hg;
                        ...
                        int i15 = org.telegram.ui.ActionBar.j6.f18280wg;
                        ...
                        int i16 = org.telegram.ui.ActionBar.j6.f18280wg;
                        ...
                        int i17 = org.telegram.ui.ActionBar.j6.f18007hg;
            ...
            case 1:
                if (j60Var.r1()) {
                    if (sf.c.a(j60Var.f33969i0) > 0) {
                        org.telegram.ui.Components.voip.i1.n(j60Var.f33969i0);
                        j60Var.dismiss();
                        return;
                    }
                    org.telegram.ui.Components.d5.B(j60Var.f33969i0, null, true).o();
                    return;
                } else if (AndroidUtilities.checkInlinePermissions(j60Var.f33969i0)) {
            ...
            case 2:
                ...
                if (sharedInstance != null) {
                    ...
                    LaunchActivity launchActivity = j60Var.f33969i0;
                    if (launchActivity != null) {
                        j60Var.f33969i0.startActivityForResult(((MediaProjectionManager) launchActivity.getSystemService("media_projection")).createScreenCaptureIntent(), 520);
                        return;
                    }
                    return;
                }
            ...
            case 6:
                ...
                org.telegram.ui.Components.iu iuVar = j60Var.H.f25595a;
                iuVar.requestFocus();
            ...
            case 8:
                ...
                return;
            case 9:
                ChatObject.Call call5 = j60Var.f33936a1;
                ...
                if (sharedInstance2 != null && sharedInstance2.getVideoState(false) == 2) {
                    ...
                    for (int i18 = 0; i18 < arrayList.size(); i18++) {
                        ...
                        if (videoParticipant.participant.self && !videoParticipant.presentation) {
                            org.telegram.ui.Components.voip.o oVar = tVar.f28409a;
                            if (tVar.J0 == null) {
                                tVar.K0 = false;
                                ImageView imageView = tVar.f28440x0;
                                if (imageView == null) {
                                    tVar.f28440x0 = new ImageView(tVar.getContext());
                                } else {
                                ...
                                if (oVar.d.isFirstFrameRendered()) {
                                    ...
                                    if (bitmap != null) {
                                        ...
                                        tVar.f28440x0.setBackground(new BitmapDrawable(bitmap));
                                    }
                                    tVar.f28440x0.setAlpha(0.0f);
                                } else {
                                    tVar.f28440x0.setAlpha(1.0f);
                                }
                                if (tVar.f28440x0.getParent() == null) {
                                    oVar.addView(tVar.f28440x0);
                                }
                                ((FrameLayout.LayoutParams) tVar.f28440x0.getLayoutParams()).gravity = 17;
                                ...
                                tVar.J0.setInterpolator(org.telegram.ui.Components.wr.f28819f);
                                tVar.J0.start();
                            }
                        }
                    }
            ...
            default:
                ...
                j60Var.N1(true, true);
                j60Var.y3 = null;
                AndroidUtilities.runOnUIThread(new org.telegram.ui.Components.zd(j60Var, i13, 13));
                return;
        }
    }
}
