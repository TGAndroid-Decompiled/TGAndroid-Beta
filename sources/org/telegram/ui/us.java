...
public final class us extends org.telegram.ui.ActionBar.o2 implements NotificationCenter.NotificationCenterDelegate, org.telegram.ui.Components.t40 {
    ...
    public org.telegram.ui.ActionBar.w0 f38181a;
    public org.telegram.ui.Cells.i3 f38182b;
    public org.telegram.ui.Cells.i3 f38183c;
    public org.telegram.ui.Cells.i3 d;
    public org.telegram.ui.Components.u9 e;
    public TextView f38184f;
    public TextView h;
    public org.telegram.ui.Components.f9 f38185n;
    public final org.telegram.ui.ActionBar.f6 f38186r;
    public RadialProgressView f38187s;
    public ci.s6 v;
    public AnimatorSet f38188w;
    public org.telegram.ui.Cells.r8 f38189x;
    public org.telegram.ui.Cells.r8 f38190y;
    ...
    public static void W(us usVar) {
        ...
        if (usVar.e != null && (user = usVar.getMessagesController().getUser(Long.valueOf(usVar.H))) != null) {
            usVar.f38185n.m(usVar.currentAccount, user);
            usVar.e.invalidate();
        }
    }
    ...
    public static void X(us usVar, TLRPC.PhotoSize photoSize, TLRPC.InputFile inputFile, TLRPC.InputFile inputFile2, TLRPC.PhotoSize photoSize2, TLRPC.VideoSize videoSize, double d, boolean z10) {
        ...
        if (inputFile == null && inputFile2 == null) {
            usVar.e.h(ImageLocation.getForLocal(usVar.Q), "50_50", usVar.f38185n, usVar.getMessagesController().getUser(Long.valueOf(usVar.H)));
            if (usVar.S == 2) {
                usVar.e0(true, false);
            } else {
    ...
    public final void B(float f7) {
        RadialProgressView radialProgressView = this.f38187s;
    ...
    public final View createView(Context context) {
        ...
        int i16 = org.telegram.ui.ActionBar.j6.f18899f8;
        org.telegram.ui.ActionBar.f6 f6Var = this.f38186r;
        ...
        this.f38181a = this.actionBar.n().e(1, LocaleController.getString(R.string.Done).toUpperCase());
        FrameLayout frameLayout = new FrameLayout(context);
        int i17 = org.telegram.ui.ActionBar.j6.f18806a7;
        frameLayout.setBackgroundColor(getThemedColor(i17));
        FrameLayout frameLayout2 = new FrameLayout(context);
        this.V = frameLayout2;
        int i18 = org.telegram.ui.ActionBar.j6.f18862d6;
        ...
        this.f38187s = radialProgressView;
        radialProgressView.setSize(AndroidUtilities.dp(30.0f));
        this.f38187s.setProgressColor(-1);
        this.f38187s.setNoProgress(false);
        FrameLayout frameLayout5 = this.V;
        RadialProgressView radialProgressView2 = this.f38187s;
        if (LocaleController.isRTL) {
            i12 = 5;
        } else {
            i12 = 3;
        ...
        this.f38184f = textView;
        textView.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.G6, f6Var));
        this.f38184f.setTextSize(1, 18.0f);
        this.f38184f.setLines(1);
        this.f38184f.setMaxLines(1);
        this.f38184f.setSingleLine(true);
        TextView textView2 = this.f38184f;
        TextUtils.TruncateAt truncateAt = TextUtils.TruncateAt.END;
        textView2.setEllipsize(truncateAt);
        TextView textView3 = this.f38184f;
        if (LocaleController.isRTL) {
            i13 = 5;
        } else {
            i13 = 3;
        ...
        this.f38184f.setTypeface(AndroidUtilities.bold());
        FrameLayout frameLayout6 = this.V;
        TextView textView4 = this.f38184f;
        ...
        org.telegram.ui.Cells.i3 i3Var = new org.telegram.ui.Cells.i3(context, LocaleController.getString(R.string.FirstName), false, false, -1, this.f38186r);
        this.f38182b = i3Var;
        i3Var.f20239b.setImeOptions(5);
        this.f38182b.setBackgroundColor(getThemedColor(i18));
        this.f38182b.setDivider(true);
        this.f38182b.f20239b.setOnEditorActionListener(new TextView.OnEditorActionListener(this) {
            public final us f36417b;
            ...
            public final boolean onEditorAction(TextView textView7, int i22, KeyEvent keyEvent) {
                switch (r2) {
                    case 0:
                        if (i22 == 5) {
                            us usVar = this.f36417b;
                            usVar.f38183c.f20239b.requestFocus();
                            org.telegram.ui.Cells.g3 g3Var = usVar.f38183c.f20239b;
                            g3Var.setSelection(g3Var.length());
                            return true;
                        }
                        return false;
                    case 1:
                        us usVar2 = this.f36417b;
                        if (i22 == 6) {
                            usVar2.f38181a.performClick();
                            return true;
                        } else if (i22 == 5) {
                            usVar2.d.f20239b.requestFocus();
                            usVar2.d.f20239b.setSelection(usVar2.f38183c.f20239b.length());
                            return true;
                        } else {
                            return false;
                        }
                    default:
                        if (i22 == 6) {
                            this.f36417b.f38181a.performClick();
                            return true;
                        }
                        return false;
                }
        ...
        this.f38182b.f20239b.setOnFocusChangeListener(new Object());
        this.f38182b.setText(this.M);
        org.telegram.ui.Cells.i3 i3Var2 = new org.telegram.ui.Cells.i3(context, LocaleController.getString(R.string.LastName), false, false, -1, this.f38186r);
        this.f38183c = i3Var2;
        i3Var2.f20239b.setImeOptions(5);
        this.f38183c.setBackgroundColor(getThemedColor(i18));
        this.f38183c.f20239b.setOnEditorActionListener(new TextView.OnEditorActionListener(this) {
            public final us f36417b;
        ...
        this.f38183c.setText(this.N);
        org.telegram.ui.Cells.i3 i3Var3 = new org.telegram.ui.Cells.i3(context, LocaleController.getString(R.string.AddNotes), true, true, getMessagesController().config.contactNoteLengthLimit.get(), this.f38186r);
        this.d = i3Var3;
        i3Var3.f20239b.setLinkTextColor(getThemedColor(org.telegram.ui.ActionBar.j6.gc));
        this.d.f20239b.setImeOptions(6);
        this.d.setBackgroundColor(getThemedColor(i18));
        this.d.f20239b.setOnEditorActionListener(new TextView.OnEditorActionListener(this) {
            public final us f36417b;
        ...
        if (!this.I) {
            ...
            this.f38189x.setBackground(org.telegram.ui.ActionBar.j6.J0(f6Var, true));
            org.telegram.ui.Cells.r8 r8Var2 = this.f38189x;
            int i22 = org.telegram.ui.ActionBar.j6.f19192v6;
            int i23 = org.telegram.ui.ActionBar.j6.f19174u6;
            r8Var2.e(i22, i23);
            ...
            this.f38189x.e.setTranslationX(-AndroidUtilities.dp(8.0f));
            this.f38189x.e.setAnimation(yi0Var);
            this.f38189x.setOnClickListener(new View.OnClickListener(this) {
                public final us f36721b;
            ...
            this.f38190y.setBackground(org.telegram.ui.ActionBar.j6.J0(f6Var, true));
            this.f38190y.e(i22, i23);
            ...
            this.f38190y.e.setTranslationX(-AndroidUtilities.dp(8.0f));
            this.f38190y.e.setAnimation(yi0Var2);
            this.f38190y.setOnClickListener(new View.OnClickListener(this) {
                public final us f36721b;
            ...
            if (this.f38185n == null) {
                this.f38185n = new org.telegram.ui.Components.f9(0, user);
            }
            this.U.e(user.photo, this.f38185n);
    ...
    public final void e0(boolean z10, boolean z11) {
        ...
        AnimatorSet animatorSet = this.f38188w;
        if (animatorSet != null) {
            animatorSet.cancel();
            this.f38188w = null;
        }
        if (z11) {
            ...
            this.f38188w = animatorSet2;
            if (z10) {
                this.f38187s.setVisibility(0);
                this.v.setVisibility(0);
                AnimatorSet animatorSet3 = this.f38188w;
                RadialProgressView radialProgressView = this.f38187s;
            ...
            this.f38188w.setDuration(180L);
            this.f38188w.addListener(new org.telegram.ui.Components.aa(26, this, z10));
            this.f38188w.start();
        } else if (z10) {
            this.f38187s.setAlpha(1.0f);
            this.f38187s.setVisibility(0);
            this.v.setAlpha(1.0f);
            this.v.setVisibility(0);
        } else {
            this.f38187s.setAlpha(0.0f);
            this.f38187s.setVisibility(4);
    ...
    public final void f0() {
        TLRPC.User user;
        if (this.f38184f != null && (user = getMessagesController().getUser(Long.valueOf(this.H))) != null) {
            if (TextUtils.isEmpty(c0())) {
                this.f38184f.setText(LocaleController.getString(R.string.MobileHidden));
            } else {
                TextView textView = this.f38184f;
                gf.b c10 = gf.b.c();
    ...
    public final void g0() {
        ...
        if (userProfilePhoto != null && userProfilePhoto.personal && (photo = this.T) != null) {
            this.U.h(ImageLocation.getForPhoto(FileLoader.getClosestPhotoSizeWithSize(photo.sizes, 1000), this.T), "50_50", this.f38185n, null);
        }
        if (this.f38185n == null) {
            this.f38185n = new org.telegram.ui.Components.f9(0, user);
        }
        ...
        if (fileLocation == null) {
            this.e.e(user, this.f38185n);
        } else {
            this.e.h(ImageLocation.getForLocal(fileLocation), "50_50", this.f38185n, getMessagesController().getUser(Long.valueOf(this.H)));
        }
    }
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f38182b, 4, null, null, null, null, i10));
        org.telegram.ui.Cells.i3 i3Var = this.f38182b;
        ...
        org.telegram.ui.Cells.i3 i3Var2 = this.f38182b;
        ...
        org.telegram.ui.Cells.i3 i3Var3 = this.f38182b;
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f38183c, 4, null, null, null, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f38183c, 8388608, null, null, null, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f38183c, 32, null, null, null, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f38183c, 65568, null, null, null, null, i13));
