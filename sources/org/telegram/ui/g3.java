...
public final class g3 implements q0.a {
    ...
    public final void accept(Object obj) {
        ...
        switch (this.f33824a) {
            case 0:
                l3 l3Var = (l3) this.f33825b;
                Float f7 = (Float) obj;
                h4 h4Var = l3Var.K;
                if (l3Var == h4Var.f34168u0[0]) {
                    if (h4Var.f34156h0.f38955d0.getCurrentProgress() > f7.floatValue()) {
                        h4Var.f34156h0.f38955d0.a(0.0f, false);
                    }
                    h4Var.f34156h0.f38955d0.a(f7.floatValue(), true);
                    return;
                }
                return;
            case 1:
                ((org.telegram.ui.Components.qj0) this.f33825b).h((List) obj);
                return;
            case 2:
                TLRPC.User user = (TLRPC.User) obj;
                ur urVar = ((lr) this.f33825b).f35611b;
                or w02 = urVar.w0();
            ...
            case 4:
                ...
                return;
            case 5:
                ((ArrayList) this.f33825b).add((TLRPC.User) obj);
                return;
            case 6:
                ProfileActivity profileActivity = (ProfileActivity) this.f33825b;
                TLRPC.User user2 = (TLRPC.User) obj;
                for (int i11 = 0; i11 < profileActivity.f31393u2.participants.participants.size(); i11++) {
                    if (profileActivity.f31393u2.participants.participants.get(i11).user_id == user2.f18268id) {
                ...
                return;
            default:
                View view = ((ProxyListActivity) this.f33825b).f31432b.U((View) obj).f42697a;
