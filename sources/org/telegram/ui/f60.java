...
public final class f60 extends Drawable {
    ...
    public final Paint f36299a = new Paint(1);
    public float f36301c = 1.0f;
    ...
    public final void draw(Canvas canvas) {
        ...
        Paint paint = this.f36299a;
        paint.setColor(-1147527);
        paint.setAlpha((int) (this.f36301c * 255.0f));
        canvas.drawCircle(centerX, dp, AndroidUtilities.dp(4.0f), paint);
        long elapsedRealtime = SystemClock.elapsedRealtime();
        long j3 = elapsedRealtime - this.f36300b;
        if (j3 > 17) {
            j3 = 17;
        }
        this.f36300b = elapsedRealtime;
        int i10 = this.d;
        if (i10 == 0) {
            float f7 = (((float) j3) / 2000.0f) + this.f36301c;
            this.f36301c = f7;
            if (f7 >= 1.0f) {
                this.f36301c = 1.0f;
                this.d = 1;
            ...
            float f10 = this.f36301c - (((float) j3) / 2000.0f);
            this.f36301c = f10;
            if (f10 < 0.5f) {
                this.f36301c = 0.5f;
                this.d = 0;
