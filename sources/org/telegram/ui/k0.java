...
public final class k0 extends org.telegram.ui.web.w1 {
    ...
    public final org.telegram.ui.web.h2 getInstantViewLoader() {
        l3 l3Var = this.B0.f34114u0[0];
        if (!l3Var.f()) {
            org.telegram.ui.web.h2 h2Var = l3Var.f35295y;
            if (h2Var != null) {
                h2Var.a();
                org.telegram.ui.web.h2 h2Var2 = l3Var.f35295y;
            ...
            org.telegram.ui.web.h2 h2Var3 = l3Var.f35295y;
            if (h2Var3 != null) {
                h2Var3.a();
                org.telegram.ui.web.h2 h2Var4 = l3Var.f35295y;
                TLRPC.TL_webPage tL_webPage2 = h2Var4.f38924j;
                if (tL_webPage2 != null) {
            ...
            org.telegram.ui.web.h2 h2Var5 = l3Var.f35295y;
            if (h2Var5 != null && (h2Var5.f38921f != l3Var.getWebView().f39124b || l3Var.f35295y.e != l3Var.getWebView().getProgress())) {
                l3Var.f35295y.d(l3Var.getWebView());
                return l3Var.f35295y;
            } else if (l3Var.f35295y != null && TextUtils.equals(l3Var.getWebView().getUrl(), l3Var.f35295y.d)) {
                return l3Var.f35295y;
            } else {
                org.telegram.ui.web.h2 h2Var6 = l3Var.f35295y;
                if (h2Var6 != null) {
                    h2Var6.a();
                    org.telegram.ui.web.h2 h2Var7 = l3Var.f35295y;
                    TLRPC.TL_webPage tL_webPage3 = h2Var7.f38924j;
                    if (tL_webPage3 != null) {
                ...
                l3Var.f35295y = h2Var8;
                org.telegram.ui.web.z0 webView = l3Var.getWebView();
                if (!h2Var8.f38919b) {
                    h2Var8.f38919b = true;
                    h2Var8.d = webView.getUrl();
                    h2Var8.e = webView.getProgress();
                    h2Var8.f38921f = webView.f39124b;
                    h2Var8.f38926l = org.telegram.ui.web.j2.e(webView, new org.telegram.ui.web.g2(h2Var8, 0));
                    TLRPC.TL_messages_getWebPage tL_messages_getWebPage = new TLRPC.TL_messages_getWebPage();
                    tL_messages_getWebPage.url = h2Var8.d;
                    tL_messages_getWebPage.hash = 0;
                    h2Var8.f38925k = ConnectionsManager.getInstance(h2Var8.f38918a).sendRequest(tL_messages_getWebPage, new ai.m8(h2Var8, 18));
                }
                return l3Var.f35295y;
            }
        }
    ...
    public final void k(boolean z10) {
        ...
        if (this.W != z10) {
            ...
            if (z10) {
                ...
                if (i10 != i11) {
                    this.f39079c0 = i11;
                    oVar.setHint(LocaleController.formatString(R.string.AddressPlaceholder, org.telegram.ui.web.p1.a().f39017a));
                }
            }
        ...
        org.telegram.ui.web.k kVar = this.B0.f34103i0;
        if (kVar != null) {
            kVar.setOpened(z10);
        }
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        ((ViewGroup.MarginLayoutParams) this.B0.f34103i0.getLayoutParams()).topMargin = getMeasuredHeight();
    }
}
