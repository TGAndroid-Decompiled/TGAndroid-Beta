...
public final class fk implements Runnable {
    ...
    public final void run() {
        ...
        bo boVar = this.f33714a;
        MessageObject messageObject = boVar.f32258d5;
        if (messageObject != null && boVar.T8 != null) {
            int max = Math.max(0, messageObject.messageOwner.ttl_period - (boVar.getConnectionsManager().getCurrentTime() - boVar.f32258d5.messageOwner.date));
            if (max < 86400) {
