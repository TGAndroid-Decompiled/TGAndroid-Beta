...
public class z00 extends ReplacementSpan {
    public final TextPaint f40285a;
    public final Paint f40286b;
    public StaticLayout f40287c;
    public float d;
    public float e;
    public int f40288f;
    public final int h;
    public CharSequence f40289n;

    public z00(int i10) {
        TextPaint textPaint = new TextPaint(1);
        this.f40285a = textPaint;
    ...
    public final void a() {
        if (this.f40287c == null) {
            StaticLayout staticLayout = new StaticLayout(this.f40289n, this.f40285a, AndroidUtilities.displaySize.x, Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
            this.f40287c = staticLayout;
            this.d = staticLayout.getLineWidth(0);
            this.e = this.f40287c.getHeight();
        }
    }
    ...
    public void draw(Canvas canvas, CharSequence charSequence, int i10, int i11, float f7, int i12, int i13, int i14, Paint paint) {
        ...
        float f10;
        a();
        int i16 = this.f40288f;
        if (i16 == 0) {
            i16 = paint.getColor();
        }
        Paint paint2 = this.f40286b;
        paint2.setColor(i16);
        ...
        TextPaint textPaint = this.f40285a;
