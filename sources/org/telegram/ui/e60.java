...
public final class e60 extends Drawable {
    ...
    public int d;
    public final View e;
    public final Paint f33184a = new Paint(1);
    public float f33186c = 1.0f;
    ...
    public final void draw(Canvas canvas) {
        ...
        Paint paint = this.f33184a;
        paint.setColor(-1147527);
        paint.setAlpha((int) (this.f33186c * 255.0f));
        canvas.drawCircle(centerX, dp, AndroidUtilities.dp(4.0f), paint);
        long elapsedRealtime = SystemClock.elapsedRealtime();
        long j3 = elapsedRealtime - this.f33185b;
        if (j3 > 17) {
            j3 = 17;
        }
        this.f33185b = elapsedRealtime;
        int i10 = this.d;
        if (i10 == 0) {
            float f7 = (((float) j3) / 2000.0f) + this.f33186c;
            this.f33186c = f7;
            if (f7 >= 1.0f) {
                this.f33186c = 1.0f;
                this.d = 1;
            ...
            float f10 = this.f33186c - (((float) j3) / 2000.0f);
            this.f33186c = f10;
            if (f10 < 0.5f) {
                this.f33186c = 0.5f;
                this.d = 0;
