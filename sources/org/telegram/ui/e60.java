...
public final class e60 extends org.telegram.ui.Components.ll0 {
    ...
    public final void E() {
        ...
        TLRPC.Chat chat2;
        k60 k60Var = this.M;
        ArrayList arrayList = k60Var.f35080q0;
        ChatObject.Call call = k60Var.f35017a1;
        if (call != null && !call.isScheduled() && !k60Var.f35090s0) {
            this.f33300w = -1;
            this.f33301x = -1;
            this.f33302y = -1;
            this.I = -1;
            ...
            boolean z10 = false;
            this.F = 0;
            if (k60Var.f35017a1.participants.h(MessageObject.getPeerId(k60Var.A0)) >= 0) {
                z10 = true;
            }
            this.L = z10;
            if (k60Var.o1()) {
            ...
            if (!arrayList.isEmpty() && k60Var.Q0() && k60Var.f35017a1.call.participants_count > k60Var.d.getMessagesController().groupCallVideoMaxParticipants) {
                int i13 = this.F;
                this.F = i13 + 1;
                this.J = i13;
            }
            this.d = this.F;
            if (!k60Var.r1()) {
                this.F = k60Var.f35017a1.visibleParticipants.size() + this.F;
            }
            this.e = this.F;
            if (!k60Var.f35017a1.invitedUsers.isEmpty() && !k60Var.r1()) {
                int i14 = this.F;
                this.f33296f = i14;
                int size2 = k60Var.f35017a1.invitedUsers.size() + i14;
                this.F = size2;
                this.h = size2;
            } else {
                this.f33296f = -1;
            ...
            if (!k60Var.f35017a1.shadyJoinParticipants.isEmpty() && !k60Var.r1()) {
                int i15 = this.F;
                this.f33297n = i15;
                int size3 = k60Var.f35017a1.shadyJoinParticipants.size() + i15;
                this.F = size3;
                this.f33298r = size3;
            } else {
                this.f33297n = -1;
            ...
            if (!k60Var.f35017a1.shadyLeftParticipants.isEmpty() && !k60Var.r1()) {
                int i16 = this.F;
                this.f33299s = i16;
                int size4 = k60Var.f35017a1.shadyLeftParticipants.size() + i16;
                this.F = size4;
                this.v = size4;
            } else {
                this.f33299s = -1;
    ...
    public final int j(int i10) {
        ...
        if (i10 != this.f33300w && i10 != this.f33301x && i10 != this.f33302y) {
            if (i10 == this.I) {
                return 5;
            }
        ...
        if (i10 != 0) {
            if (i10 != 1) {
                if (i10 != 2) {
                        ...
                        if (i10 != 5) {
                            if (i10 != 6) {
                                if (i10 != 7) {
                                    ...
                                    if (k60Var.f35076p0 == null) {
                                        k60Var.f35076p0 = new v50();
                                    }
                                    u50Var = new u50(context, k60Var.f35076p0);
                                }
                            } else {
                    ...
                    frameLayout.f21479n = org.telegram.ui.ActionBar.j6.f19129rg;
                    ...
                    k5Var2.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, frameLayout.f21479n, false));
                    ...
                    imageView.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.w0(null, frameLayout.f21479n, false), PorterDuff.Mode.MULTIPLY));
                    if (!LocaleController.isRTL) {
                        i17 = 5;
                    }
            ...
            frameLayout2.h = 67;
            frameLayout2.f21583n = 18;
            Paint paint2 = new Paint();
            frameLayout2.f21584r = paint2;
            paint2.setColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18926gg, false));
            frameLayout2.e = 23;
            org.telegram.ui.ActionBar.k5 k5Var3 = new org.telegram.ui.ActionBar.k5(context);
            frameLayout2.f21579a = k5Var3;
            ...
            frameLayout2.f21581c = imageView2;
            ImageView.ScaleType scaleType = ImageView.ScaleType.CENTER;
            imageView2.setScaleType(scaleType);
            imageView2.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19028m6, false), PorterDuff.Mode.MULTIPLY));
