...
public final class e60 extends Drawable {
    public final Paint f35945a;
    public final Paint f35946b;
    public long f35947c;
    public float d;
    public int f35948e;
    ...
    public final void draw(Canvas canvas) {
        ...
        canvas.drawCircle(centerX, centerY, AndroidUtilities.dp(10.0f), this.f35945a);
        if (this.f35949f) {
            i10 = -1147527;
        } else {
            i10 = -1;
        }
        Paint paint = this.f35946b;
        paint.setColor(i10);
        paint.setAlpha((int) (this.d * 255.0f));
        canvas.drawCircle(centerX, centerY, AndroidUtilities.dp(5.0f), paint);
        if (this.f35949f) {
            long elapsedRealtime = SystemClock.elapsedRealtime();
            long j3 = elapsedRealtime - this.f35947c;
            if (j3 > 17) {
                j3 = 17;
            }
