...
public final class e60 extends Drawable {
    ...
    public final void draw(Canvas canvas) {
        ...
        canvas.drawCircle(centerX, centerY, AndroidUtilities.dp(10.0f), this.f35972a);
        if (this.f35976f) {
            i10 = -1147527;
        } else {
            i10 = -1;
        }
        Paint paint = this.f35973b;
        paint.setColor(i10);
        paint.setAlpha((int) (this.d * 255.0f));
        canvas.drawCircle(centerX, centerY, AndroidUtilities.dp(5.0f), paint);
        if (this.f35976f) {
            long elapsedRealtime = SystemClock.elapsedRealtime();
            long j3 = elapsedRealtime - this.f35974c;
            if (j3 > 17) {
                j3 = 17;
            }
            this.f35974c = elapsedRealtime;
