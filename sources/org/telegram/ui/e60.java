...
public final class e60 extends Drawable {
    ...
    public int d;
    public final View e;
    public final Paint f33236a = new Paint(1);
    ...
    public final void draw(Canvas canvas) {
        ...
        Paint paint = this.f33236a;
        paint.setColor(-1147527);
        paint.setAlpha((int) (this.f33238c * 255.0f));
        canvas.drawCircle(centerX, dp, AndroidUtilities.dp(4.0f), paint);
        long elapsedRealtime = SystemClock.elapsedRealtime();
        long j3 = elapsedRealtime - this.f33237b;
        if (j3 > 17) {
            j3 = 17;
        }
        this.f33237b = elapsedRealtime;
        int i10 = this.d;
        if (i10 == 0) {
            float f7 = (((float) j3) / 2000.0f) + this.f33238c;
            this.f33238c = f7;
            if (f7 >= 1.0f) {
                this.f33238c = 1.0f;
                this.d = 1;
            ...
            float f10 = this.f33238c - (((float) j3) / 2000.0f);
            this.f33238c = f10;
            if (f10 < 0.5f) {
                this.f33238c = 0.5f;
                this.d = 0;
