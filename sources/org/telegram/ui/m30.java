...
public final class m30 implements View.OnClickListener {
    public final z5 f38847a = new z5(this, 5);
    public final d60 f38848b;
    ...
    public final void onClick(View view) {
        ...
        d60 d60Var = this.f38848b;
        k30 k30Var = d60Var.f36086x;
        ArrayList arrayList = d60Var.f36043n0;
        org.telegram.ui.Components.voip.w2 w2Var = d60Var.f36081w;
        ...
        if (d60Var.X0 != null && d60Var.C1 != 3) {
            ...
            if (d60Var.r1() && !d60Var.X0.isScheduled()) {
                ...
                if (w30Var != null && w30Var.f32145b && (AndroidUtilities.isTablet() || d60.C3 == d60Var.q1())) {
                    d60Var.e1(null);
                    if (d60.C3) {
                        AndroidUtilities.runOnUIThread(new c10(this, 5), 200L);
                    }
                    d60Var.f36012f0.setRequestedOrientation(-1);
                    return;
                    ...
                    if (d60Var.q1()) {
                        d60Var.f36012f0.setRequestedOrientation(6);
                        return;
                    } else {
                        d60Var.f36012f0.setRequestedOrientation(1);
                        return;
            ...
            if (i13 == 5) {
                if (!d60Var.E1) {
                    ...
                    accountInstance.getConnectionsManager().sendRequest(startscheduledgroupcall, new RequestDelegate(this) {
                        ...
                        public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                            switch (r2) {
                                case 0:
                                    m30 m30Var = this.f38479b;
                                    if (tLObject != null) {
                                        m30Var.f38848b.d.getMessagesController().processUpdates((TLRPC.Updates) tLObject, false);
                                        return;
                                    } else {
                                        m30Var.getClass();
                                        return;
                                ...
                                default:
                                    m30 m30Var2 = this.f38479b;
                                    if (tLObject != null) {
                                        m30Var2.f38848b.d.getMessagesController().processUpdates((TLRPC.Updates) tLObject, false);
                                        return;
                                    } else {
                                        m30Var2.getClass();
                                        return;
                ...
                if (VoIPService.getSharedInstance() != null && (i10 = d60Var.Q1) != 1 && i10 != 2 && i10 != 6 && i10 != 5) {
                    ...
                    if (i14 != 2 && i14 != 4) {
                        try {
                            if (i14 == 0) {
                                if (Build.VERSION.SDK_INT >= 23 && (launchActivity = d60Var.f36012f0) != null && launchActivity.checkSelfPermission("android.permission.RECORD_AUDIO") != 0) {
                        ...
                        hj0Var.N(i15);
                        hj0Var.P(i15 - 1, this.f38847a);
                        k30Var.setAnimation(hj0Var);
                        hj0Var.K(i12);
                        k30Var.d();
                        if (d60Var.C1 == 2) {
                            long peerId = MessageObject.getPeerId(((TLRPC.GroupCallParticipant) d60Var.X0.participants.f(MessageObject.getPeerId(d60Var.f36087x0))).peer);
                ...
                if (i13 == 6 && (m40Var = d60Var.f36032k0) != null) {
                    m40Var.b(true);
                }
