...
public final class se1 extends org.telegram.ui.ActionBar.n2 {
    ...
    public org.telegram.ui.Components.qq f37269s;
    public org.telegram.ui.Components.rl0 v;
    public TLRPC.TL_forumTopic f37270w;
    public ng.a f37271x;
    public xn f37272y;
    ...
    public final void b0(Long l4, boolean z10) {
        ...
        if (this.f37266f != null && this.v != null) {
            if (l4 == null) {
                longValue = 0;
            } else {
                longValue = l4.longValue();
            }
            this.f37266f.setSelected(Long.valueOf(longValue));
            if (this.f37264b != longValue) {
                ...
                if (longValue != 0) {
                    ...
                    m80Var.a(this.f37267n);
                    this.v.b(m80Var, false);
                    w9VarArr[1].setImageDrawable(this.f37269s);
    ...
    public final View createView(Context context) {
        ...
        TLRPC.TL_forumTopic tL_forumTopic = this.f37270w;
        ...
        frameLayout2.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view) {
                int i11 = r2;
                se1 se1Var = this.f35278b;
                switch (i11) {
                    case 0:
                        if (se1Var.f37264b == 0 && se1Var.f37270w == null) {
                            ng.a aVar = se1Var.f37271x;
                            int i12 = aVar.e + 1;
                            aVar.e = i12;
                            int[] iArr = ng.a.f15192k;
                            if (i12 > 5) {
                                aVar.e = 0;
                            }
                            int[] iArr2 = aVar.h;
                            int i13 = iArr[aVar.e];
                            aVar.f15199i = i13;
                            aVar.h = (int[]) ng.a.f15193l.get(i13);
        ...
        for (int i11 = 0; i11 < 2; i11++) {
            ...
            w9VarArr[i11] = w9Var;
            frameLayout2.addView(w9Var, w7.x5.e(28, 28, 17));
        }
        ...
        TLRPC.TL_forumTopic tL_forumTopic2 = this.f37270w;
        if (tL_forumTopic2 != null && tL_forumTopic2.f18135id == 1) {
            ...
            this.d.d(LocaleController.getString(R.string.EditTopicHide), !this.f37270w.hidden, false, false);
            this.d.setBackground(org.telegram.ui.ActionBar.h6.Z(getThemedColor(i12), getThemedColor(org.telegram.ui.ActionBar.h6.f18878i6), 16, 16));
            ...
            frameLayout3.addView(f9Var, w7.x5.d(-1, -2.0f, 48, 0.0f, 58.0f, 0.0f, 0.0f));
        } else {
            re1 re1Var = new re1(this, this, getParentActivity());
            this.f37266f = re1Var;
            re1Var.setAnimationsEnabled(this.fragmentBeginToShow);
            this.f37266f.setClipChildren(false);
            frameLayout3.addView(this.f37266f, w7.x5.d(-1, -1.0f, 0, 12.0f, 12.0f, 12.0f, 12.0f));
            org.telegram.ui.Components.qq d = ng.d.d(this.E, "");
            this.f37271x = (ng.a) d.f27424a;
            ...
            ArrayList arrayList2 = rl0Var2.f27668n;
            if (!arrayList2.contains(w9Var3)) {
                arrayList2.add(w9Var3);
            }
            w9VarArr[0].setImageDrawable(this.f37269s);
            ...
            ng.a aVar = this.f37271x;
            aVar.d.add(w9VarArr[0]);
            ng.a aVar2 = this.f37271x;
            aVar2.d.add(w9VarArr[1]);
        }
        linearLayout.addView(frameLayout3, w7.x5.c(-1.0f, -1));
        TLRPC.TL_forumTopic tL_forumTopic3 = this.f37270w;
        if (tL_forumTopic3 != null) {
            this.e.setText(tL_forumTopic3.title);
            b0(Long.valueOf(this.f37270w.icon_emoji_id), true);
        } else {
            b0(0L, true);
        }
    ...
    public final boolean onFragmentCreate() {
        this.f37263a = -this.arguments.getLong("chat_id");
        long j3 = this.arguments.getLong("topic_id", 0L);
        this.f37265c = j3;
        if (j3 != 0) {
            TLRPC.TL_forumTopic findTopic = getMessagesController().getTopicsController().findTopic(-this.f37263a, this.f37265c);
            this.f37270w = findTopic;
            if (findTopic == null) {
                return false;
            }
            this.E = findTopic.icon_color;
        } else {
            this.E = ng.a.f15192k[Math.abs(Utilities.random.nextInt() % 6)];
        }
