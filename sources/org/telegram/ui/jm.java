...
public final class jm implements ViewTreeObserver.OnPreDrawListener {
    public final org.telegram.ui.Cells.t1 f34475a;
    public final km f34476b;
    ...
    public final boolean onPreDraw() {
        float f7;
        float centerX;
        xn xnVar = this.f34476b.Q;
        org.telegram.ui.Cells.t1 t1Var = this.f34475a;
        ...
        animatorSet2.playTogether(ObjectAnimator.ofFloat(sendAnimationData, r6Var, f7, 1.0f), ObjectAnimator.ofFloat(sendAnimationData, new hm(this), 0.0f, 1.0f));
        float f10 = sendAnimationData.f15575x;
        float f11 = iArr[0];
        if (sendAnimationData.fromPreview) {
            centerX = 0.0f;
        } else {
        ...
        animatorSet.playTogether(ObjectAnimator.ofFloat(sendAnimationData, gmVar, f10, f11 + centerX), animatorSet2);
