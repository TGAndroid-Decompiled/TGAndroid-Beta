...
public final class gf1 extends org.telegram.ui.ActionBar.j {
    ...
    public final void b(int i10) {
        ...
        wf1 wf1Var = this.f33917b;
        TopicsController topicsController = wf1Var.f39328s;
        ArrayList arrayList = wf1Var.f39296b;
        HashSet hashSet = wf1Var.f39294a0;
        ...
        switch (i10) {
            ...
            case 2:
                ...
                if (chatFull != null) {
                    ...
                    ef1 ef1Var = new ef1(this, this.f33916a, i11, iVar, chatFull.f18322id, wf1Var, j10);
                    ef1Var.f26379l0 = new ai.z1(this, j10, 11);
                    ef1Var.show();
                    return;
                }
                return;
            ...
            case 5:
                if (hashSet.size() > 0) {
                    wf1Var.C0 = true;
                    wf1Var.N0 = true;
                    TopicsController topicsController2 = wf1Var.f39328s;
                    long j11 = wf1Var.f39293a;
            ...
            case 8:
                ...
                for (int i14 = 0; i14 < arrayList2.size(); i14++) {
                    ...
                    if (findTopic != null) {
                        wf1Var.getMessagesController().markMentionsAsRead(-j3, findTopic.f18373id);
                        ...
                        messagesController.markDialogAsRead(j12, i15, 0, i12, false, findTopic.f18373id, 0, true, 0);
                        wf1Var.getMessagesStorage().updateRepliesMaxReadId(wf1Var.f39293a, findTopic.f18373id, findTopic.top_message, 0, true);
                    }
                }
                wf1Var.C0();
                return;
            ...
            case 13:
                ...
                while (true) {
                    if (i17 < wf1Var.N.getChildCount()) {
                        ...
                        if ((childAt instanceof tf1) && (tL_forumTopic = (tf1Var = (tf1) childAt).N) != null && tL_forumTopic.f18373id == 1) {
                ...
                if (tL_forumTopic2 == null) {
                    while (true) {
                        if (i13 < arrayList.size()) {
                            if (arrayList.get(i13) != null && ((nf1) arrayList.get(i13)).f35860c != null && ((nf1) arrayList.get(i13)).f35860c.f18373id == 1) {
                                tL_forumTopic2 = ((nf1) arrayList.get(i13)).f35860c;
                            } else {
                                i13++;
                            }
                        }
