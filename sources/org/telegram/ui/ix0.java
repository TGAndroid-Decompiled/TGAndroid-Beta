...
public final class ix0 extends org.telegram.ui.Components.kl0 {
    ...
    public final boolean D(s4.c1 c1Var) {
        return !((lx0) this.d.f37891n.d.get(c1Var.b())).f38535a.current;
    }

    @Override
    public final int h() {
        return this.d.f37891n.d.size();
    }

    @Override
    public final void v(s4.c1 c1Var, int i10) {
        boolean z10;
        sg.t1 t1Var = (sg.t1) c1Var.f45766a;
        PremiumPreviewFragment premiumPreviewFragment = this.d.f37891n;
        ...
        t1Var.a(lx0Var, z10);
        if (premiumPreviewFragment.f33804e != i10) {
            z11 = false;
        }
        t1Var.c(z11, false);
    }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        hx0 hx0Var = new hx0(this, this.f37479c);
