        ...
        if (b10 != i10) {
            ...
            if (b10 != i11) {
                ...
                if (b10 != i12) {
                    ...
                    if (b10 != i13 && b10 != privacySettingsActivity.f32024s) {
                        i14 = privacySettingsActivity.secretWebpageRow;
                        if (b10 != i14) {
                            i15 = privacySettingsActivity.webSessionsRow;
                            if (b10 != i15 && (b10 != privacySettingsActivity.f32022n || privacySettingsActivity.getContactsController().getLoadingPrivacyInfo(1))) {
            ...
            if (i10 != i11) {
                ...
                if (i10 != i12) {
                    ...
                    if (i10 != i13) {
                        ...
                        if (i10 != i14 && i10 != privacySettingsActivity.f32022n) {
                            ...
                            if (i10 != i15) {
                                ...
                                if (i10 != i16) {
                                    ...
                                    if (i10 != i17 && i10 != privacySettingsActivity.E) {
                                        if (i10 != privacySettingsActivity.h && i10 != privacySettingsActivity.B && i10 != privacySettingsActivity.f32023r && i10 != privacySettingsActivity.v && i10 != privacySettingsActivity.K && i10 != privacySettingsActivity.F && i10 != privacySettingsActivity.I && i10 != privacySettingsActivity.f32026x) {
                                            if (i10 != 0 && i10 != privacySettingsActivity.f32027y && i10 != privacySettingsActivity.f32021f && i10 != privacySettingsActivity.J && i10 != privacySettingsActivity.C && i10 != privacySettingsActivity.H && i10 != privacySettingsActivity.f32025w) {
                                                        ...
                                                        if (i10 != i20) {
                                                            ...
                                                            if (i10 != i21) {
                                                                if (i10 != privacySettingsActivity.G) {
                                                                    ...
                                                                    if (i10 != i22 && i10 != privacySettingsActivity.f32024s) {
    ...
    public final void v(f2.l1 l1Var, int i10) {
        ...
        if (i42 != 0) {
            if (i42 != 1) {
                if (i42 != 2) {
                    if (i42 != 3) {
                        if (i42 == 5) {
                            ...
                            org.telegram.ui.Components.k6 k6Var = o8Var.f21529c;
                            ...
                            if (i10 == i34) {
                                ...
                                String str8 = "";
                                if (i10 != privacySettingsActivity.f32024s) {
                                    ...
                                    if (i10 != i35) {
                                        ...
                                        o8Var.f21534w = 16;
                                        o8Var.f21533s = 58;
                                        org.telegram.ui.ActionBar.k5 k5Var = o8Var.f21527a;
                ...
                if (i10 == privacySettingsActivity.f32021f) {
                    ...
                    return;
                } else if (i10 == privacySettingsActivity.f32027y) {
                    ...
                    return;
                } else if (i10 == privacySettingsActivity.f32025w) {
            ...
            if (i10 == privacySettingsActivity.B) {
                ...
                return;
            } else if (i10 == privacySettingsActivity.f32023r) {
                ...
                return;
            } else if (i10 == privacySettingsActivity.f32026x) {
                                        ...
                                        if (i10 != i19) {
                                            ...
                                            if (i10 != i20) {
                                                ...
                                                if (i10 != i21) {
                                                    ...
                                                    aaVar.getValueImageView().setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20067m6, false), PorterDuff.Mode.MULTIPLY));
                                                    z16 = z12;
                                                }
                                            } else {
