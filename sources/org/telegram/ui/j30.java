...
public final class j30 extends org.telegram.ui.Components.lj0 {
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        d60 d60Var = this.f34620r;
        q20 q20Var = d60Var.f33021y2;
        ArrayList arrayList = d60Var.Z1;
        if (d60Var.r1()) {
            return super.onTouchEvent(motionEvent);
        }
        if (motionEvent.getAction() == 0 && d60Var.F1 == 0 && d60Var.f32919a1 != null) {
            ...
            if (d60Var.R1) {
                ...
                AndroidUtilities.cancelRunOnUIThread(d60Var.f33016x2);
                d60Var.J1(0, true);
                if (VoIPService.getSharedInstance() != null) {
                    VoIPService.getSharedInstance().setMicMute(true, true, false);
                    try {
                        d60Var.f33008w.performHapticFeedback(3, 2);
