...
public final class av0 extends View {
    ...
    public final org.telegram.ui.Components.m6 f31986b;
    public final TextPaint f31987c;
    public StaticLayout d;
    public float e;
    public float f31988f;
    public final org.telegram.ui.Components.m6 h;
    public String f31989n;
    public boolean f31990r;
    public final org.telegram.ui.Components.c6 f31991s;
    public boolean v;
    public int f31992w;
    ...
    public av0(Activity activity) {
        ...
        this.f31987c = textPaint;
        this.f31990r = false;
        org.telegram.ui.Components.qr qrVar = org.telegram.ui.Components.qr.h;
        this.f31991s = new org.telegram.ui.Components.c6(this, 0L, 350L, qrVar);
    ...
    public final void b(int i10, int i11, boolean z10) {
        ...
        if (LocaleController.getInstance().getCurrentLocaleInfo() != null && !TextUtils.equals(this.f31989n, LocaleController.getInstance().getCurrentLocaleInfo().shortName)) {
            c();
        }
        ...
        this.f31986b.q(format, z11, true);
        if (!LocaleController.isRTL) {
            max = max2;
        }
    ...
    public final void c() {
        this.f31989n = LocaleController.getInstance().getCurrentLocaleInfo().shortName;
        StaticLayout staticLayout = new StaticLayout(LocaleController.getString(R.string.Of).replace("%1$d", "").replace("%2$d", ""), this.f31987c, AndroidUtilities.dp(200.0f), Layout.Alignment.ALIGN_CENTER, 1.0f, 0.0f, false);
        this.d = staticLayout;
        if (staticLayout.getLineCount() >= 1) {
            this.e = this.d.getLineWidth(0);
            this.f31988f = this.d.getLineDescent(0);
            return;
        }
        this.e = 0.0f;
        this.f31988f = 0.0f;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float d = this.f31991s.d(f7, false);
        if (d <= 0.0f) {
            return;
        }
        org.telegram.ui.Components.m6 m6Var = this.f31986b;
        float d10 = m6Var.d() + this.e;
        org.telegram.ui.Components.m6 m6Var2 = this.h;
        float d11 = m6Var2.d() + d10 + AndroidUtilities.dp(18.0f);
        float f10 = ((1.0f - d) * (-AndroidUtilities.dp(8.0f))) + this.f31992w;
        ...
        canvas.save();
        canvas.translate((-(this.d.getWidth() - this.e)) / 2.0f, ((this.f31988f / 2.0f) + (AndroidUtilities.dp(23.0f) - this.d.getHeight())) / 2.0f);
        this.f31987c.setAlpha(i10);
        this.d.draw(canvas);
        canvas.restore();
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f31992w = org.telegram.ui.ActionBar.k.getCurrentActionBarHeight() + AndroidUtilities.statusBarHeight;
        this.f31986b.G = size;
        this.h.G = size;
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(size, 1073741824), org.telegram.messenger.wl.C(43.0f, this.f31992w, 1073741824));
    }

    @Override
    public final boolean verifyDrawable(Drawable drawable) {
        if (this.f31986b != drawable && this.h != drawable && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
