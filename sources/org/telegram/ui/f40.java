...
public final class f40 extends FrameLayout {
    ...
    public f40(k60 k60Var, LaunchActivity launchActivity) {
        ...
        this.f33546b = new RectF();
        this.f33547c = new Path();
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (k60Var.f35026d2 != 1.0f) {
            if (k60Var.X2 != null && k60Var.f35018b3) {
                canvas.save();
                ...
                float f7 = k60Var.f35026d2;
                int dp = (int) ((AndroidUtilities.dp(13.0f) * f7) + ((1.0f - k60Var.f35026d2) * measuredHeight));
                ...
                canvas.restore();
            } else if (k60Var.f35013a3 != null && k60Var.Z2 == null && k60Var.O2) {
                canvas.save();
                float measuredHeight2 = (k60Var.f35013a3.getAvatarImageView().getMeasuredHeight() / 2.0f) * (getMeasuredHeight() / k60Var.f35013a3.getAvatarImageView().getMeasuredHeight());
                float f10 = k60Var.f35026d2;
                int dp2 = (int) ((AndroidUtilities.dp(13.0f) * f10) + ((1.0f - k60Var.f35026d2) * measuredHeight2));
                int i11 = (int) ((1.0f - f10) * measuredHeight2);
                k60Var.f35013a3.getAvatarImageView().getImageReceiver().setImageCoords(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight());
                k60Var.f35013a3.getAvatarImageView().r(dp2, dp2, i11, i11);
                k60Var.f35013a3.getAvatarImageView().getImageReceiver().draw(canvas);
                k60Var.f35013a3.getAvatarImageView().setRoundRadius(k60Var.f35013a3.getAvatarImageView().getMeasuredHeight() / 2);
                canvas.restore();
            }
        }
        e40Var.setAlpha(k60Var.f35026d2);
        Path path = this.f33547c;
        path.reset();
        RectF rectF = this.f33546b;
