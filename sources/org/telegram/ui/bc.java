...
public final class bc implements RequestDelegate {
    ...
    public final ec f32100b;
    public final CountDownLatch f32101c;
    public final Runnable d;

    public bc(ec ecVar, CountDownLatch countDownLatch, Runnable runnable, int i10) {
        this.f32099a = i10;
        this.f32100b = ecVar;
        this.f32101c = countDownLatch;
        this.d = runnable;
    }
    ...
    public final void run(final TLObject tLObject, TLRPC.TL_error tL_error) {
        switch (this.f32099a) {
            case 0:
                final ec ecVar = this.f32100b;
                final CountDownLatch countDownLatch = this.f32101c;
                        ...
                        switch (r5) {
                            case 0:
                                ...
                                if (tLObject2 != null) {
                                    ...
                                    boolean z10 = false;
                                    MessagesController.getInstance(ecVar2.f33358b).putUsers(tL_premium_boostsList.users, false);
                                    ...
                                    while (true) {
                                        ...
                                        if (i11 < size) {
                                            ...
                                            ecVar2.f33363s = Math.max(0, tL_premium_boostsList.count - i10);
                                            if (!TextUtils.isEmpty(tL_premium_boostsList.next_offset) && ecVar2.f33363s > 0) {
                                                z10 = true;
                                            }
                                            ecVar2.f33362r = z10;
                            ...
                            default:
                                ec ecVar3 = ecVar;
                                ArrayList arrayList2 = ecVar3.f33361n;
                                ...
                                if (tLObject3 != null) {
                                    ...
                                    boolean z11 = false;
                                    MessagesController.getInstance(ecVar3.f33358b).putUsers(tL_premium_boostsList2.users, false);
                                    ...
                                    while (true) {
                                        ...
                                        if (i15 < size2) {
                                            ...
                                            ecVar3.f33364w = Math.max(0, tL_premium_boostsList2.count - i14);
                                            if (!TextUtils.isEmpty(tL_premium_boostsList2.next_offset) && ecVar3.f33364w > 0) {
                                                z11 = true;
                                            }
                                            ecVar3.v = z11;
                ...
                return;
            default:
                final ec ecVar2 = this.f32100b;
                final CountDownLatch countDownLatch2 = this.f32101c;
                        ...
                        switch (r5) {
                            case 0:
                                ...
                                if (tLObject2 != null) {
                                    ...
                                    TL_stories.TL_premium_boostsList tL_premium_boostsList = (TL_stories.TL_premium_boostsList) tLObject2;
                                    boolean z10 = false;
                                    MessagesController.getInstance(ecVar22.f33358b).putUsers(tL_premium_boostsList.users, false);
                                    ...
                                    while (true) {
                                        ...
                                        if (i11 < size) {
                                            ...
                                            ecVar22.f33363s = Math.max(0, tL_premium_boostsList.count - i10);
                                            if (!TextUtils.isEmpty(tL_premium_boostsList.next_offset) && ecVar22.f33363s > 0) {
                                                z10 = true;
                                            }
                                            ecVar22.f33362r = z10;
