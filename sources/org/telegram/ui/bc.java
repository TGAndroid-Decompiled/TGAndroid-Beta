...
public final class bc extends og.b {
    ...
    public final boolean D(s4.c1 c1Var) {
        return ((cc) this.f32304f.f32936x.get(c1Var.b())).f15673b;
    }

    @Override
    public final int h() {
        return this.f32304f.f32936x.size();
    }

    @Override
    public final int j(int i10) {
        return ((cc) this.f32304f.f32936x.get(i10)).f15672a;
    }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        int i12;
        int i13;
        dc dcVar = this.f32304f;
        int i14 = dcVar.f32929b;
        TLRPC.Chat chat = dcVar.J;
        ArrayList arrayList = dcVar.f32936x;
        ...
        if (i15 != 4) {
                ...
                if (i15 == 0) {
                    ...
                    if (tL_statsPercentValue != null) {
                        ...
                        if (d != 0.0d) {
                            ...
                            ta1Var.a(str, 1, concat, LocaleController.getString(i13));
                    ...
                    ta1Var.a("≈0", 1, "0%", LocaleController.getString(i12));
                    ta1Var.a(String.valueOf(dcVar.d.boosts), 2, null, LocaleController.getString(R.string.BoostsExisting));
                    ...
                    bVar.d(user, ContactsController.formatName(user), formatString, !((cc) arrayList.get(i10)).f32628f);
                    bVar.setStatus(boost);
                    bVar.setAvatarPadding(5);
                    return;
                } else if (i15 == 6) {
                    ((org.telegram.ui.Cells.e9) view).setText(((cc) arrayList.get(i10)).f32627c);
                    return;
                } else if (i15 == 9) {
                    org.telegram.ui.Cells.y4 y4Var = (org.telegram.ui.Cells.y4) view;
                    if (dcVar.f32937y == 0) {
                        y4Var.b(LocaleController.formatPluralString("BoostingShowMoreBoosts", dcVar.f32934s, new Object[0]), R.drawable.arrow_more, 5, false);
                        return;
                    } else {
                        y4Var.b(LocaleController.formatPluralString("BoostingShowMoreGifts", dcVar.f32935w, new Object[0]), R.drawable.arrow_more, 5, false);
                        return;
                    }
                } else if (i15 == 3) {
                    ((org.telegram.ui.Components.e90) view).setLink(((cc) arrayList.get(i10)).f32627c);
                    return;
                } else if (i15 == 11) {
                    cc ccVar = (cc) arrayList.get(i10);
                    TL_stories.PrepaidGiveaway prepaidGiveaway = ccVar.e;
                    boolean z10 = ccVar.f32628f;
                    yg.c cVar = (yg.c) view;
                    ...
                    if (i16 != i17 || this.e != dcVar.O) {
                        ...
                        this.e = dcVar.O;
                        dcVar.f32931f.g();
                        dcVar.f32931f.a(0, LocaleController.formatPluralString("BoostingBoostsCount", dcVar.P, new Object[0]), null);
                        if (MessagesController.getInstance(i14).giveawayGiftsPurchaseAvailable && (i11 = dcVar.O) > 0 && i11 != dcVar.P) {
                            dcVar.f32931f.a(1, LocaleController.formatPluralString("BoostingGiftsCount", i11, new Object[0]), null);
                        }
                        dcVar.f32931f.setInitialTabId(dcVar.f32937y);
                        dcVar.f32931f.c();
                        return;
                    }
                    return;
            ...
            cVar2.setTitle(((cc) arrayList.get(i10)).f32627c);
            cVar2.c(false);
            if (c1Var.f42932f == 12) {
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        za1 za1Var = dcVar.f32930c;
        switch (i10) {
            case 0:
                n6Var = new ta1(dcVar.getContext(), 2);
                break;
            case 1:
                ...
                break;
            case 2:
                n6Var = new org.telegram.ui.Cells.b7(viewGroup.getContext(), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19006a7, false), 0);
                break;
            case 3:
                org.telegram.ui.Components.e90 e90Var = new org.telegram.ui.Components.e90(dcVar.getContext(), dcVar.f32930c, null, false, false);
                e90Var.d.setVisibility(8);
                e90Var.f23823a.setGravity(17);
            ...
            case 4:
                ...
                limitPreviewView.f22292c0 = true;
            ...
            case 6:
                ...
                break;
            case 7:
                n6Var = new org.telegram.ui.Cells.t3(dcVar.getContext(), 8);
                break;
            case 8:
                ...
                com.google.android.gms.internal.vision.e2.p(org.telegram.ui.ActionBar.j6.f19445y6, null, false, textView, 17);
                x5Var.addView(textView, w7.y5.d(-1, -2.0f, 0, 0.0f, 16.0f, 0.0f, 0.0f));
                n6Var = x5Var;
                break;
            case 9:
                n5 n5Var = new n5(dcVar.getContext(), 1);
                n5Var.a(org.telegram.ui.ActionBar.j6.f19393v6, org.telegram.ui.ActionBar.j6.f19375u6);
                n6Var = n5Var;
                break;
            case 10:
            ...
            case 13:
                ...
                dcVar.f32931f = scrollSlidingTextTabStrip;
                ...
                ci.n6 n6Var2 = new ci.n6(this, za1Var.getParentActivity());
                dcVar.f32931f.setDelegate(new g(this, 11));
                n6Var2.addView(dcVar.f32931f, w7.y5.c(48.0f, -2));
                n6Var = n6Var2;
                break;
            default:
