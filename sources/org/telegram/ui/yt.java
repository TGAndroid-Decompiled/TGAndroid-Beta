...
public final class yt implements Comparator {
    ...
    public final int compare(Object obj, Object obj2) {
        switch (this.f40023a) {
            case 0:
                return ((Comparator) this.f40024b).compare(((xt) obj).f39700a, ((xt) obj2).f39700a);
            case 1:
                LongSparseIntArray longSparseIntArray = (LongSparseIntArray) this.f40024b;
                ...
                return 0;
            case 2:
                LocaleController.LocaleInfo localeInfo = (LocaleController.LocaleInfo) this.f40024b;
                ...
                return -1;
            default:
                StickersActivity stickersActivity = (StickersActivity) this.f40024b;
