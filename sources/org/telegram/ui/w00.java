...
public final class w00 extends og.a {
    public View.OnClickListener f38650c;
    public CharSequence d;
    public String e;
    public boolean f38651f;
    public boolean f38652g;
    public long h;
    public String f38653i;
    public int f38654j;
    public int f38655k;
    public boolean f38656l;
    public TL_chatlists.TL_exportedChatlistInvite f38657m;
            ...
            if (obj != null && w00.class == obj.getClass()) {
                ...
                if (i10 == w00Var.f15672a) {
                    if (i10 == 11) {
                        ...
                        if (i11 == 0) {
                            if (this.f38651f != w00Var.f38651f) {
                                return false;
                            }
                        } else if (i11 == 1) {
                            if (this.h != w00Var.h || !TextUtils.equals(this.f38653i, w00Var.f38653i) || this.f38654j != w00Var.f38654j) {
                                return false;
                            }
                        } else if (i11 == 7 && (tL_exportedChatlistInvite = this.f38657m) != (tL_exportedChatlistInvite2 = w00Var.f38657m)) {
                            if (TextUtils.equals(tL_exportedChatlistInvite.url, tL_exportedChatlistInvite2.url)) {
                                TL_chatlists.TL_exportedChatlistInvite tL_exportedChatlistInvite3 = this.f38657m;
                                boolean z10 = tL_exportedChatlistInvite3.revoked;
                                TL_chatlists.TL_exportedChatlistInvite tL_exportedChatlistInvite4 = w00Var.f38657m;
                                if (z10 != tL_exportedChatlistInvite4.revoked || !TextUtils.equals(tL_exportedChatlistInvite3.title, tL_exportedChatlistInvite4.title) || this.f38657m.peers.size() != w00Var.f38657m.peers.size()) {
                                    return false;
                                }
                            } else {
                                return false;
