...
public final class w00 extends og.a {
    public View.OnClickListener f38630c;
    ...
    public TL_chatlists.TL_exportedChatlistInvite f38637m;
            ...
            if (obj != null && w00.class == obj.getClass()) {
                ...
                if (i10 == w00Var.f15704a) {
                    if (i10 == 11) {
                        ...
                        if (i11 == 0) {
                            if (this.f38631f != w00Var.f38631f) {
                                return false;
                            }
                        } else if (i11 == 1) {
                            if (this.h != w00Var.h || !TextUtils.equals(this.f38633i, w00Var.f38633i) || this.f38634j != w00Var.f38634j) {
                                return false;
                            }
                        } else if (i11 == 7 && (tL_exportedChatlistInvite = this.f38637m) != (tL_exportedChatlistInvite2 = w00Var.f38637m)) {
                            if (TextUtils.equals(tL_exportedChatlistInvite.url, tL_exportedChatlistInvite2.url)) {
                                TL_chatlists.TL_exportedChatlistInvite tL_exportedChatlistInvite3 = this.f38637m;
                                boolean z10 = tL_exportedChatlistInvite3.revoked;
                                TL_chatlists.TL_exportedChatlistInvite tL_exportedChatlistInvite4 = w00Var.f38637m;
                                if (z10 != tL_exportedChatlistInvite4.revoked || !TextUtils.equals(tL_exportedChatlistInvite3.title, tL_exportedChatlistInvite4.title) || this.f38637m.peers.size() != w00Var.f38637m.peers.size()) {
                                    return false;
                                }
                            } else {
                                return false;
