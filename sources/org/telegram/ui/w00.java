...
public final class w00 implements TextWatcher {
    ...
    public final void afterTextChanged(Editable editable) {
        ...
        String str;
        int i10;
        b10 b10Var = this.f42239a.f43497e;
        if (!TextUtils.equals(editable, b10Var.f35312w)) {
            b10Var.f35309n = !TextUtils.isEmpty(editable);
            b10Var.f35312w = org.telegram.ui.Components.u5.onlyEmojiSpans(editable);
            p00 p00Var = b10Var.F;
            if (p00Var != null) {
                p00Var.e(org.telegram.ui.Components.u5.cloneSpans(b10Var.f35312w, -1, p00Var.f39845s.getPaint().getFontMetricsInt(), 0.5f), true);
            }
            q00 q00Var = b10Var.G;
            if (q00Var != null) {
                org.telegram.ui.Cells.t3 t3Var = q00Var.f40286r;
                if (b10.k0(b10Var.f35312w)) {
                    if (b10Var.f35313x) {
            ...
            CharSequence charSequence = b10Var.f35312w;
