...
public final class w00 implements TextWatcher {
    ...
    public final void afterTextChanged(Editable editable) {
        ...
        if (!TextUtils.equals(editable, b10Var.f32280w)) {
            b10Var.f32277n = !TextUtils.isEmpty(editable);
            b10Var.f32280w = org.telegram.ui.Components.z5.onlyEmojiSpans(editable);
            p00 p00Var = b10Var.I;
            if (p00Var != null) {
                p00Var.e(org.telegram.ui.Components.z5.cloneSpans(b10Var.f32280w, -1, p00Var.f36373s.getPaint().getFontMetricsInt(), 0.5f), true);
            }
            q00 q00Var = b10Var.J;
            if (q00Var != null) {
                org.telegram.ui.Cells.u3 u3Var = q00Var.f36719r;
                if (b10.k0(b10Var.f32280w)) {
                    if (b10Var.f32281x) {
            ...
            CharSequence charSequence = b10Var.f32280w;
