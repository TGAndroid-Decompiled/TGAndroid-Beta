...
public final class qd0 implements RequestDelegate {
    ...
    public final yg0 f36905b;
    public final TLRPC.auth_SentCode f36906c;
    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        switch (this.f36904a) {
            case 0:
                ...
                final yg0 yg0Var = this.f36905b;
                final TLRPC.auth_SentCode auth_sentcode = this.f36906c;
            ...
            default:
                ...
                final yg0 yg0Var2 = this.f36905b;
                final TLRPC.auth_SentCode auth_sentcode2 = this.f36906c;
                final Bundle bundle2 = this.d;
                if (z12) {
                    yg0Var2.k1(false, true);
                    yg0Var2.f39906o0 = false;
