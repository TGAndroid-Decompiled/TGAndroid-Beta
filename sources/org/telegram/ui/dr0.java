...
public final class dr0 extends org.telegram.ui.Components.aw0 {
    ...
    public final boolean a0(MotionEvent motionEvent, boolean z10) {
        ...
        this.f31965y0 = false;
        this.f31964x0 = true;
        this.f31966z0 = (int) motionEvent.getX();
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        canvas.drawLine(0.0f, translationY, getWidth(), translationY, org.telegram.ui.ActionBar.j6.f18049k0);
    }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent != null && motionEvent.getAction() == 0 && !this.f31964x0 && !this.f31965y0) {
            this.f31963w0 = motionEvent.getPointerId(0);
            this.f31965y0 = true;
            this.f31966z0 = (int) motionEvent.getX();
            this.A0 = (int) motionEvent.getY();
            this.B0.clear();
        } else if (motionEvent != null && motionEvent.getAction() == 2 && motionEvent.getPointerId(0) == this.f31963w0) {
            int x10 = (int) (motionEvent.getX() - this.f31966z0);
            int abs = Math.abs(((int) motionEvent.getY()) - this.A0);
            if (this.f31964x0 && (((z12 = gr0Var.v) && x10 > 0) || (!z12 && x10 < 0))) {
                if (x10 < 0) {
                    z13 = true;
                } else {
                    z13 = false;
            ...
            if (this.f31965y0 && !this.f31964x0) {
        ...
        } else if (motionEvent == null || (motionEvent.getPointerId(0) == this.f31963w0 && (motionEvent.getAction() == 3 || motionEvent.getAction() == 1 || motionEvent.getAction() == 6))) {
            this.B0.computeCurrentVelocity(1000, gr0Var.f33174x);
            if (motionEvent != null && motionEvent.getAction() != 3) {
                f7 = this.B0.getXVelocity();
                f10 = this.B0.getYVelocity();
                if (!this.f31964x0 && Math.abs(f7) >= 3000.0f && Math.abs(f7) > Math.abs(f10)) {
                    if (f7 < 0.0f) {
                        z11 = true;
                    } else {
                        z11 = false;
            ...
            if (this.f31964x0) {
                ...
                gr0Var.f33171r = new AnimatorSet();
                ...
                if (z10) {
                    ...
                    if (gr0Var.v) {
                        gr0Var.f33171r.playTogether(ObjectAnimator.ofFloat(er0VarArr[0], property, 0.0f), ObjectAnimator.ofFloat(er0VarArr[1], property, er0Var4.getMeasuredWidth()));
                    } else {
                        gr0Var.f33171r.playTogether(ObjectAnimator.ofFloat(er0VarArr[0], property, 0.0f), ObjectAnimator.ofFloat(er0VarArr[1], property, -er0Var3.getMeasuredWidth()));
                    }
                } else {
                    measuredWidth = er0VarArr[0].getMeasuredWidth() - Math.abs(x11);
                    if (gr0Var.v) {
                        gr0Var.f33171r.playTogether(ObjectAnimator.ofFloat(er0VarArr[0], property, -er0Var2.getMeasuredWidth()), ObjectAnimator.ofFloat(er0VarArr[1], property, 0.0f));
                    } else {
                        gr0Var.f33171r.playTogether(ObjectAnimator.ofFloat(er0VarArr[0], property, er0Var.getMeasuredWidth()), ObjectAnimator.ofFloat(er0VarArr[1], property, 0.0f));
                    }
                }
                gr0Var.f33171r.setInterpolator(gr0.f33165y);
                ...
                gr0Var.f33171r.setDuration(Math.max(150, Math.min(measuredWidth2, 600)));
                gr0Var.f33171r.addListener(new org.telegram.ui.Components.voip.v2(this, 20));
                gr0Var.f33171r.start();
                gr0Var.f33172s = true;
                this.f31964x0 = false;
            } else {
                this.f31965y0 = false;
