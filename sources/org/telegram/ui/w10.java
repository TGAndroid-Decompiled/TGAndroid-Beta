...
public final class w10 extends org.telegram.ui.Components.il0 {
    public final Context f38550r;
    public final v10 f38551s = new v10(this);
    public final z10 v;

    public w10(z10 z10Var, Context context) {
        this.v = z10Var;
        this.f38550r = context;
    }
    ...
    public final int R() {
        ...
        int i10 = 0;
        if (z10Var.f40082f.isEmpty() || (arrayList.isEmpty() && z10Var.M)) {
            return 0;
        }
    ...
    public final View T(int i10, View view) {
        if (view == null) {
            view = new org.telegram.ui.Cells.u3(this.f38550r, null);
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 != 0) {
            if (i10 != 1) {
                ...
                n7Var.setDelegate(this.f38551s);
                u3Var = n7Var;
            }
        } else {
