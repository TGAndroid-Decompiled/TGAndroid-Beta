...
public final class zq implements iq {
    ...
    public final void b(int i10, TLRPC.TL_chatAdminRights tL_chatAdminRights, TLRPC.TL_chatBannedRights tL_chatBannedRights, String str) {
        ...
        qr qrVar = this.f40224f;
        ArrayList arrayList = qrVar.F;
        long j3 = this.f40222b;
            ...
            while (true) {
                ...
                if (tLObject instanceof TLRPC.ChannelParticipant) {
                    if (MessageObject.getPeerId(((TLRPC.ChannelParticipant) tLObject).peer) == j3) {
                        ...
                        tL_channelParticipant.date = this.f40223c;
                    ...
                    int indexOf = qrVar.f36585s.participants.participants.indexOf(chatParticipant);
                    if (indexOf >= 0) {
                        qrVar.f36585s.participants.participants.set(indexOf, tL_chatParticipant);
                    }
                    qrVar.r0();
                }
                i12++;
