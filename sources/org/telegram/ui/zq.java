...
public final class zq implements Utilities.Callback {
    public final int f40282a = 1;
    public final int f40283b;
    public final long f40284c;
    public final Object d;
    public final Object e;
    public final Object f40285f;
    public final Object f40286g;
    ...
    public final void run(Object obj) {
        ...
        switch (this.f40282a) {
            case 0:
                ...
                TLRPC.TL_chatAdminRights tL_chatAdminRights = (TLRPC.TL_chatAdminRights) this.f40285f;
                TLRPC.TL_chatBannedRights tL_chatBannedRights = (TLRPC.TL_chatBannedRights) this.f40286g;
                ...
                crVar.X0 = new dr(urVar, intValue, j10, this.f40283b, z10, zArr);
                urVar.presentFragment(crVar);
                return;
            default:
                final ArrayList arrayList = (ArrayList) this.d;
                final Activity activity = (Activity) this.e;
                final org.telegram.ui.ActionBar.e6 e6Var = (org.telegram.ui.ActionBar.e6) this.f40285f;
                final Utilities.Callback callback = (Utilities.Callback) this.f40286g;
                final HashMap hashMap = (HashMap) this.h;
                boolean booleanValue = ((Boolean) obj).booleanValue();
                final int i10 = this.f40283b;
                if (booleanValue) {
    ...
    public zq(ur urVar, long j3, int i10, TLObject tLObject, TLRPC.TL_chatAdminRights tL_chatAdminRights, TLRPC.TL_chatBannedRights tL_chatBannedRights, String str, boolean z10) {
        ...
        this.f40283b = i10;
        this.e = tLObject;
        this.f40285f = tL_chatAdminRights;
        this.f40286g = tL_chatBannedRights;
        this.h = str;
    }
}
