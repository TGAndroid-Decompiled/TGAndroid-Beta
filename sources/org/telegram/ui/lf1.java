...
public final class lf1 extends org.telegram.ui.Components.ov0 {
    public boolean f38344w0;
    public final Paint f38345x0;
    public final eg1 f38346y0;

    public lf1(eg1 eg1Var, Context context) {
        super(context, null);
        this.f38346y0 = eg1Var;
        setWillNotDraw(false);
        this.f38345x0 = new Paint();
    }
    ...
    public final void J(Canvas canvas, float f7, Rect rect, Paint paint, boolean z10) {
        if (Build.VERSION.SDK_INT >= 29 && SharedConfig.chatBlurEnabled()) {
            eg1 eg1Var = this.f38346y0;
            if (eg1Var.f36043g1 != null) {
                canvas.save();
                canvas.translate(0.0f, -f7);
                eg1Var.f36043g1.v(canvas, rect.left, rect.top + f7, rect.right, rect.bottom + f7);
                canvas.restore();
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        int measuredHeight;
        eg1 eg1Var = this.f38346y0;
        gh.d dVar = eg1Var.f36045h1;
        gh.d dVar2 = eg1Var.f36043g1;
        bh.f fVar = eg1Var.f36041f1;
        if (Build.VERSION.SDK_INT >= 31 && fVar != null) {
            ...
            if (dVar2 != null && !dVar2.f10658n && dVar2.f(measuredWidth, measuredHeight)) {
                fVar.b(dVar2.a(measuredWidth, measuredHeight), -3);
                dVar2.b();
            }
            if (dVar != null && !dVar.f10658n && dVar.f(measuredWidth, measuredHeight)) {
        ...
        if (eg1Var.isInPreviewMode()) {
            int themedColor = eg1Var.getThemedColor(org.telegram.ui.ActionBar.j6.f20663d6);
            Paint paint = this.f38345x0;
            paint.setColor(themedColor);
            paint.setAlpha((int) (eg1Var.W * 255.0f));
            canvas2 = canvas;
            canvas2.drawRect(0.0f, 0.0f, getWidth(), AndroidUtilities.statusBarHeight, paint);
            canvas2.drawLine(0.0f, 0.0f, 0.0f, getHeight(), org.telegram.ui.ActionBar.j6.f20785k0);
        } else {
            canvas2 = canvas;
        }
        if (eg1Var.M0 == null) {
            AndroidUtilities.drawNavigationBarProtection(canvas2, this, eg1Var.getThemedColor(org.telegram.ui.ActionBar.j6.f20663d6), eg1Var.f36038e1);
        }
    }
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        if (view == kVar && !eg1Var.isInPreviewMode()) {
            ...
            org.telegram.ui.Components.h81 h81Var = eg1Var.f36027a1;
            if (h81Var != null && h81Var.getVisibility() != 8) {
                f7 = eg1Var.f36027a1.getMeasuredHeight();
            } else {
                f7 = 0.0f;
            }
            ...
            if (f10 > 0.0f) {
                if (f10 < 1.0f) {
                    ...
                    org.telegram.ui.ActionBar.j6.f20785k0.setAlpha((int) (alpha * eg1Var.W));
                    float f11 = i10;
                    canvas.drawLine(0.0f, f11, getMeasuredWidth(), f11, org.telegram.ui.ActionBar.j6.f20785k0);
                    org.telegram.ui.ActionBar.j6.f20785k0.setAlpha(alpha);
                } else {
                    float f12 = i10;
                    canvas.drawLine(0.0f, f12, getMeasuredWidth(), f12, org.telegram.ui.ActionBar.j6.f20785k0);
                }
            }
        }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (v51Var != null) {
            ...
            int i13 = eg1Var.f36038e1;
            layoutParams.height = dp + i13;
            eg1Var.f36056o0.setPadding(0, 0, 0, i13);
            this.f38344w0 = false;
        }
        int i14 = 0;
