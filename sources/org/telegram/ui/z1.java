...
public final class z1 extends HorizontalScrollView implements org.telegram.ui.ActionBar.z5, d3 {
    ...
    @Override
    public final void e() {
        this.f40006c.setColorFilter(new PorterDuffColorFilter(this.f40004a.b(), PorterDuff.Mode.SRC_IN));
    }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        FrameLayout frameLayout = this.f40005b;
    ...
    public void setBlock(TL_iv.pageBlockMath pageblockmath) {
        ii.s a2;
        ImageView imageView = this.f40006c;
        imageView.setImageBitmap(null);
        u70 u70Var = this.f40004a;
        u70Var.getClass();
        float f7 = 18;
        ...
        if (pageblockmath != null && (a2 = ii.s.a(pageblockmath.source, AndroidUtilities.dp(20.0f), false)) != null) {
            imageView.setImageBitmap(a2.f11607a);
            int i10 = a2.f11608b;
            u70Var.getClass();
            int dp2 = AndroidUtilities.dp(f10) + i10;
            this.d = dp2;
            imageView.setLayoutParams(new FrameLayout.LayoutParams(dp2, a2.f11609c));
        }
    }
}
