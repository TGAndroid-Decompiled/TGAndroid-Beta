...
public final class ds0 implements org.telegram.ui.ActionBar.z1, org.telegram.ui.Components.d5, GenericProvider, MediaDataController.KeywordResultCallback, org.telegram.ui.Components.ll0, org.telegram.ui.Components.ml0, qv0, MessagesStorage.BooleanCallback, m11, OnSuccessListener, pa.a, OnFailureListener, t5.b {
    ...
    public void J(int i10, int i11, boolean z10) {
        switch (this.f33189a) {
            case 1:
                rv0 rv0Var = ((jv0) this.f33190b).f34883a;
                rv0Var.f37504e0.a((TLRPC.TL_messageMediaToDo) this.f33191c);
                rv0Var.finishFragment();
                return;
            default:
                rv0 rv0Var2 = ((jv0) this.f33190b).f34883a;
                rv0Var2.f37504e0.a((TLRPC.TL_messageMediaPoll) this.f33191c);
    ...
    public void a(TLRPC.MessageMedia messageMedia) {
        de1 de1Var = (de1) this.f33190b;
        wn wnVar = (wn) this.f33191c;
    ...
    public void c(float f7, float f10, int i10, View view) {
        ThemeActivity.W((ThemeActivity) this.f33190b, (Context) this.f33191c, view, i10, f7);
    }

    @Override
    public boolean d(int i10, View view) {
        String str;
        final yb1 yb1Var = (yb1) this.f33190b;
        final ac1 ac1Var = (ac1) this.f33191c;
        ...
        if (i10 >= 0 && i10 < ac1Var.e.size()) {
            ...
            if (f6Var.f18886a >= 100 && !f6Var.f18907z) {
                    ...
                    public final void onClick(DialogInterface dialogInterface, int i11) {
                        ...
                        if (themeActivity2.getParentActivity() != null) {
                            ...
                            if (i11 == 0) {
                                ...
                                org.telegram.ui.Components.e5.W(themeActivity2, i12, f6Var2.f18887b, f6Var2);
                            } else if (i11 == 1) {
                                if (f6Var2.f18900r == null) {
                                    themeActivity2.getMessagesController().saveThemeToServer(f6Var2.f18887b, f6Var2);
                                    NotificationCenter.getGlobalInstance().lambda$postNotificationNameOnUIThread$1(NotificationCenter.needShareTheme, f6Var2.f18887b, f6Var2);
                                    return;
                                }
                                String str2 = "https://" + themeActivity2.getMessagesController().linkPrefix + "/addtheme/" + f6Var2.f18900r.slug;
                                ...
                                themeActivity2.presentFragment(new td1(f6Var2.f18887b, f6Var2, false));
                ...
                a2Var.l(a2Var.N0.size() - 1, org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19299q7, false), org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19280p7, false));
                return true;
            }
        }
        return false;
    ...
    public void f(org.telegram.ui.ActionBar.a2 a2Var, int i10) {
        ...
        switch (this.f33189a) {
            case 0:
                boolean[] zArr = (boolean[]) this.f33191c;
                PhotoViewer photoViewer = ((ks0) this.f33190b).f35168b;
                tu0 tu0Var = photoViewer.d;
                ArrayList arrayList2 = photoViewer.f31193a7;
                ArrayList arrayList3 = photoViewer.f31222d7;
                ...
                if (!tu0Var.M()) {
                    ...
                    if (i13 >= 0 && i13 < arrayList6.size()) {
                        ...
                        if (message != null) {
                            ...
                            arrayList9.add(Integer.valueOf(message.f18357id));
                        ...
                        if (photoViewer.I1()) {
                            if (photoViewer.f31416z5 > 0) {
                                MessagesController.getInstance(photoViewer.T).deleteUserPhoto(null);
                            } else {
                                MessagesController.getInstance(photoViewer.T).changeChatAvatar(-photoViewer.f31416z5, null, null, null, null, 0.0d, null, null, null, null);
                            }
                            photoViewer.G0(false, false);
                            return;
                        }
                        ...
                        if (photo != null) {
                            ...
                            MessagesStorage.getInstance(photoViewer.T).clearUserPhoto(photoViewer.f31416z5, photo.f18360id);
                            arrayList2.remove(photoViewer.P4);
                            photoViewer.f31213c7.remove(photoViewer.P4);
                            photoViewer.f31203b7.remove(photoViewer.P4);
            ...
            case 21:
            default:
                rg.j0.Q((rg.j0) this.f33190b, (ArrayList) this.f33191c);
                return;
            case 4:
                ((PrivacyControlActivity) this.f33190b).t0();
                ((SharedPreferences) this.f33191c).edit().putBoolean("privacyAlertShowed", true).commit();
                return;
            case 5:
                PrivacySettingsActivity privacySettingsActivity = (PrivacySettingsActivity) this.f33190b;
                ...
                privacySettingsActivity.getConnectionsManager().sendRequest(tL_payments_clearSavedInfo, new vb0(14, privacySettingsActivity, (org.telegram.ui.Cells.w8) this.f33191c));
                return;
            case 6:
                ProfileActivity.c0((ProfileActivity) this.f33190b, (org.telegram.ui.Cells.a2[]) this.f33191c);
                return;
            case 7:
                yz0 yz0Var = (yz0) this.f33190b;
                TLRPC.User user = (TLRPC.User) this.f33191c;
                yz0Var.getClass();
                ...
                return;
            case 10:
                k71 k71Var = (k71) this.f33190b;
                TLRPC.User user2 = (TLRPC.User) this.f33191c;
                ...
                if (U != null) {
                    ...
                    twoStepVerificationActivity.f31878b0 = b7Var;
                    U.presentFragment(twoStepVerificationActivity);
                    return;
                }
                return;
            case 11:
                ab1.m((ab1) this.f33190b, (qy) this.f33191c);
                return;
            case 12:
                ThemeActivity.X((ThemeActivity) this.f33190b, (p81) this.f33191c);
                return;
            case 15:
                yb1 yb1Var = (yb1) this.f33190b;
                org.telegram.ui.ActionBar.g6 g6Var = (org.telegram.ui.ActionBar.g6) this.f33191c;
                yb1Var.getClass();
                ...
                if (g6Var.f18935b == null) {
                    ...
                    hashMap.remove(g6Var.f18933a);
                    org.telegram.ui.ActionBar.z5 z5Var = g6Var.f18945i0;
                    if (z5Var != null) {
                        org.telegram.ui.ActionBar.z5.a(z5Var);
                    }
                    org.telegram.ui.ActionBar.h6.F.remove(g6Var);
                    new File(g6Var.f18935b).delete();
                ...
                return;
            case 19:
                zg1.W((zg1) this.f33190b, (byte[]) this.f33191c);
                return;
            case 20:
                mi1 mi1Var = (mi1) this.f33190b;
                mi1Var.getClass();
                ((boolean[]) this.f33191c)[0] = true;
                mi1Var.f35599p0 = 17;
            ...
            case 22:
                org.telegram.ui.web.o.Y((org.telegram.ui.web.o) this.f33190b, (HashSet) this.f33191c);
                return;
            case 23:
                org.telegram.ui.web.b1 b1Var = (org.telegram.ui.web.b1) this.f33190b;
                ...
                ConnectionsManager.getInstance(b1Var.M).sendRequest(allowsendmessage, new ai.s5(b1Var, (String[]) this.f33191c, a2Var, 15));
                return;
            case 24:
                boolean[] zArr3 = (boolean[]) this.f33191c;
                JsPromptResult jsPromptResult = (JsPromptResult) this.f33190b;
                if (!zArr3[0]) {
                    zArr3[0] = true;
    ...
    public void g(pa.b bVar) {
        ((pa.a) this.f33190b).g(bVar);
        ((pa.a) this.f33191c).g(bVar);
    }
    ...
    public Object i() {
        switch (this.f33189a) {
            case 27:
                Iterable iterable = (Iterable) this.f33191c;
                s5.h hVar = (s5.h) ((s5.d) ((da.b) this.f33190b).f7565c);
                hVar.getClass();
                ...
                return null;
            default:
                da.b bVar = (da.b) this.f33190b;
                for (Map.Entry entry : ((HashMap) this.f33191c).entrySet()) {
    ...
    public void onFailure(Exception exc) {
        qg.y1 y1Var = (qg.y1) this.f33190b;
        Bitmap bitmap = (Bitmap) this.f33191c;
        y1Var.B0 = false;
        FileLog.e(exc);
    ...
    public void onSuccess(Object obj) {
        ...
        FileLog.d("wear-auth: /token delivered to " + ((String) ((cf.c) this.f33190b).d));
        ((ci.d) this.f33191c).setLoading(false);
        dj1.d = null;
        org.telegram.ui.ActionBar.e3 e3Var = dj1.f33150c;
        if (e3Var != null) {
            e3Var.dismiss();
            dj1.f33150c = null;
        }
    ...
    public Object provide(Object obj) {
        yw0 yw0Var = (yw0) this.f33191c;
        Void r10 = (Void) obj;
        PremiumPreviewFragment premiumPreviewFragment = ((zw0) this.f33190b).d.f32254n;
        premiumPreviewFragment.f31459n0.d(0, 0.0f, 0, yw0Var.getMeasuredWidth(), -yw0Var.getTier().h, premiumPreviewFragment.O);
        return premiumPreviewFragment.f31459n0.f42841f;
    }

    @Override
    public void run(boolean z10) {
        TLRPC.Chat chat = (TLRPC.Chat) this.f33191c;
        wf1 wf1Var = ((gf1) this.f33190b).f33933b;
        ...
        wf1Var.getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.needDeleteDialog, Long.valueOf(-chat.f18336id), null, chat, Boolean.valueOf(z10));
    }

    @Override
    public void v(nk0 nk0Var) {
        cg1 cg1Var = ((zf1) this.f33190b).f40468a;
        cg1Var.e.add(Integer.valueOf(((TLRPC.TL_forumTopic) this.f33191c).f18388id));
        cg1Var.V();
    }
    ...
    public ds0(jv0 jv0Var, TLRPC.TL_messageMediaPoll tL_messageMediaPoll, ArrayList arrayList) {
        this.f33189a = 2;
        this.f33190b = jv0Var;
        this.f33191c = tL_messageMediaPoll;
    }

    public ds0(boolean[] zArr, JsPromptResult jsPromptResult) {
        this.f33189a = 24;
        this.f33191c = zArr;
        this.f33190b = jsPromptResult;
    }

    @Override
    public void run(ArrayList arrayList, String str) {
        LinkedHashSet linkedHashSet = (LinkedHashSet) this.f33190b;
        Runnable runnable = (Runnable) this.f33191c;
