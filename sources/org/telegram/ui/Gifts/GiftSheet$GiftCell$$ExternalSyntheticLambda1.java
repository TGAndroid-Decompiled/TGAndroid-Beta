...
public final class GiftSheet$GiftCell$$ExternalSyntheticLambda1 implements Runnable {
    public final int $r8$classId;
    public final GiftSheet.GiftCell f$0;
    public final boolean f$1;

    public GiftSheet$GiftCell$$ExternalSyntheticLambda1(GiftSheet.GiftCell giftCell, boolean z, int i) {
        this.$r8$classId = i;
        this.f$0 = giftCell;
        this.f$1 = z;
    }
