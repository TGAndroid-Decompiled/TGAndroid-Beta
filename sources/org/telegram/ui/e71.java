...
public abstract class e71 extends Dialog {
    ...
    public boolean O;
    public final i71 P;
    public final r61 f33311a;
    public final ImageReceiver f33312b;
    public final Rect f33313c;
    public final Rect d;
    public final Rect e;
    public final Runnable f33314f;
    public final View h;
    public Bitmap f33315n;
    public Paint f33316r;
    public final j0 f33317s;
    public final ActionBarPopupWindow$ActionBarPopupWindowLayout v;
    public org.telegram.ui.ActionBar.g3 f33318w;
    public boolean f33319x;
    public final int f33320y;
        ...
        if (document != null) {
            ...
            if ((r61Var.E instanceof org.telegram.ui.Components.o5) && (MessageObject.isTextColorEmoji(document2) || ((org.telegram.ui.Components.o5) r61Var.E).c())) {
                if (!MessageObject.isTextColorEmoji(document2)) {
                    ...
                    SparseArray sparseArray = org.telegram.ui.Components.o5.f26623q;
                    if (o5Var == null || !o5Var.l()) {
                        colorFilter = org.telegram.ui.ActionBar.j6.n0(f6Var);
                        imageReceiver.setColorFilter(colorFilter);
                    }
                }
                colorFilter = i71Var.f34468k1;
                imageReceiver.setColorFilter(colorFilter);
            }
        }
    ...
    public final void c(boolean z10) {
        ...
        if (z10) {
            ...
            this.N.setInterpolator(org.telegram.ui.Components.qr.f27381g);
        }
        this.N.start();
    }
    ...
    public final void d(final boolean z10, a71 a71Var, final a71 a71Var2, final boolean z11) {
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                ...
                e71 e71Var = e71.this;
                e71Var.I = floatValue;
                AndroidUtilities.lerp(e71Var.f33313c, e71Var.d, floatValue, e71Var.e);
                e71Var.f33317s.invalidate();
                boolean z12 = z10;
                if (!z12) {
    ...
    public final void f() {
        ...
        this.f33316r = new Paint(1);
        this.f33315n = createBitmap;
    }
