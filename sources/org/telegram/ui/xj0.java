...
public final class xj0 implements Choreographer.FrameCallback {
    ...
    public static final Paint f39600x;
    public static final LinearGradient f39601y;
    public final Choreographer f39602a = Choreographer.getInstance();
    public List f39603b = new ArrayList();
    public final ArrayList f39604c = new ArrayList();
    public int d = 0;
    public int e = 0;
    public float f39605f = 0.0f;
    public boolean h = false;
    public boolean f39606n = true;
    public long f39607r = 0;
    public float f39608s = AndroidUtilities.dp(40.0f);
    public View v;
    public ai.y7 f39609w;
            ...
            if (i10 >= 0 && i10 < lineCount) {
                ...
                if (max > min) {
                    ...
                    if (a2 > 0.0f) {
                        ...
                        f39601y.setLocalMatrix(matrix);
                        canvas.drawRect(min, f12, max, f13, f39600x);
    ...
    public final void a(float f7) {
        float f10;
        float f11;
        int size = this.f39603b.size();
        View view = null;
        for (int i10 = 0; i10 < size; i10++) {
            vj0 vj0Var = (vj0) this.f39603b.get(i10);
            if (!this.f39606n && i10 > this.d) {
                f10 = 0.0f;
            } else {
                f10 = 1.0f;
            }
            ArrayList arrayList = this.f39604c;
    ...
    public final int d(vj0 vj0Var) {
        int size = this.f39603b.size();
        for (int i10 = 0; i10 < size; i10++) {
            if (this.f39603b.get(i10) == vj0Var) {
                return i10;
            }
        }
        return -1;
    ...
    public final void doFrame(long j3) {
        if (this.h) {
            long j10 = this.f39607r;
            float f7 = 0.0f;
            if (j10 != 0) {
                float f10 = ((float) (j3 - j10)) * 1.0E-9f;
                if (!this.f39603b.isEmpty() && f10 > 0.0f) {
                    float f11 = this.f39608s * f10;
                    while (true) {
                        if (f11 <= 0.0f) {
                            break;
                        } else if (this.d >= this.f39603b.size()) {
                            this.f39606n = true;
                            break;
                        } else {
                            Layout layout = ((vj0) this.f39603b.get(this.d)).getLayout();
                            if (layout != null && layout.getLineCount() != 0) {
                                if (this.e >= layout.getLineCount()) {
                                    int lineCount = layout.getLineCount() - 1;
                                    this.e = lineCount;
                                    this.f39605f = i(layout, lineCount);
                                }
                    ...
                    this.f39606n = this.f39603b.isEmpty();
                }
                f7 = f10;
            }
            this.f39607r = j3;
            ...
            if (this.f39606n) {
                ...
                int size2 = this.f39603b.size();
                View view = null;
                for (int i12 = 0; i12 < size2; i12++) {
                    View parentView = ((vj0) this.f39603b.get(i12)).getParentView();
                    if (parentView != null && parentView != view) {
            ...
            this.f39602a.postFrameCallback(this);
        }
    }
    ...
    public final void e() {
        ...
        vj0 vj0Var;
        int i10 = this.d;
        if (i10 >= 0 && i10 < this.f39603b.size() && (vj0Var = (vj0) this.f39603b.get(this.d)) != null) {
    ...
    public final boolean f() {
        if (!this.f39603b.isEmpty()) {
            int size = this.f39603b.size() - 1;
            Layout layout = null;
            while (size >= 0) {
                layout = ((vj0) this.f39603b.get(size)).getLayout();
                if (layout != null && layout.getLineCount() > 0) {
                    break;
                }
                size--;
            ...
            if (size >= 0 && layout != null) {
                ...
                if (i10 >= size) {
                    if (i10 <= size) {
                        ...
                        if (this.e < lineCount || this.f39605f < i11 - 0.001f) {
                            return false;
                        }
                    }
                } else {
    ...
    public final void l(List list) {
        ...
        int lineCount;
        float lineWidth;
        if (!this.f39603b.isEmpty() && this.d >= this.f39603b.size()) {
            int size = this.f39603b.size() - 1;
            this.d = size;
            Layout layout = ((vj0) this.f39603b.get(size)).getLayout();
            if (layout == null) {
                lineCount = 0;
            } else {
        ...
        if (list.isEmpty()) {
            ...
            f7 = 0.0f;
            for (int i11 = this.d; i11 < this.f39603b.size(); i11++) {
                Layout layout2 = ((vj0) this.f39603b.get(i11)).getLayout();
                if (layout2 != null) {
                    if (i11 == this.d) {
        ...
        if (f7 <= 0.001f) {
            ...
            this.f39608s = Math.max(dp, f7 / 1.05f);
        }
        this.f39606n = f();
        while (true) {
            arrayList = this.f39604c;
            if (arrayList.size() <= this.f39603b.size()) {
                break;
            }
            a4.a.x(1, arrayList);
        }
        for (int size2 = arrayList.size(); size2 < this.f39603b.size(); size2++) {
            if (!this.f39606n && size2 > this.d) {
                f10 = 0.0f;
            } else {
                f10 = 1.0f;
            }
        ...
        if (!this.f39606n && !(z10 = this.h) && !z10) {
            this.h = true;
            if (f()) {
                this.f39606n = true;
            }
