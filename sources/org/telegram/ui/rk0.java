...
public final class rk0 extends pg.b {
    ...
    public final NotificationsCustomSettingsActivity f40212e;

    public rk0(NotificationsCustomSettingsActivity notificationsCustomSettingsActivity, Context context) {
        this.f40212e = notificationsCustomSettingsActivity;
        this.d = context;
    }
    ...
    @Override
    public final int h() {
        return this.f40212e.I.size();
    }

    @Override
    public final int j(int i10) {
        if (i10 >= 0) {
            NotificationsCustomSettingsActivity notificationsCustomSettingsActivity = this.f40212e;
            if (i10 < notificationsCustomSettingsActivity.I.size()) {
                return ((qk0) notificationsCustomSettingsActivity.I.get(i10)).f44098a;
            }
            return 5;
        }
        return 5;
    ...
    public final void v(s4.c1 c1Var, int i10) {
        boolean z10;
        float f7;
        ArrayList arrayList = this.f40212e.I;
        if (i10 >= 0 && i10 < arrayList.size()) {
            qk0 qk0Var = (qk0) arrayList.get(i10);
            boolean z11 = true;
            int i11 = i10 + 1;
            if (i11 < arrayList.size() && ((qk0) arrayList.get(i11)).f44098a != 4) {
                z10 = true;
            } else {
                z10 = false;
            }
            ...
            switch (i12) {
                case 0:
                    ((org.telegram.ui.Cells.l4) view).setText(qk0Var.f39925e);
                    return;
                case 1:
                    ((org.telegram.ui.Cells.w8) view).f("" + ((Object) qk0Var.f39925e), qk0Var.f39928i, z10);
                    return;
                case 2:
                    ((org.telegram.ui.Cells.za) view).g(qk0Var.f39927g, null, z10);
                    return;
                case 3:
                    ((org.telegram.ui.Cells.y8) view).b(qk0Var.h, "" + ((Object) qk0Var.f39925e), z10);
                    return;
                case 4:
                    org.telegram.ui.Cells.e9 e9Var = (org.telegram.ui.Cells.e9) view;
                    if (qk0Var.f39925e == null) {
                        e9Var.setFixedSize(12);
                        e9Var.setText(null);
                        return;
                    }
                    e9Var.setFixedSize(0);
                    e9Var.setText(qk0Var.f39925e);
                    return;
                case 5:
                    ((org.telegram.ui.Cells.ea) view).c(qk0Var.f39925e, qk0Var.f39926f, false, z10);
                    return;
                case 6:
                    org.telegram.ui.Cells.i5 i5Var = (org.telegram.ui.Cells.i5) view;
                    i5Var.setDrawLine(true);
                    i5Var.setChecked(qk0Var.f39928i);
                    i5Var.b(qk0Var.f39925e, qk0Var.f39926f, qk0Var.d, qk0Var.f39928i, 0, false, z10, true);
                    return;
                case 7:
                    org.telegram.ui.Cells.r8 r8Var = (org.telegram.ui.Cells.r8) view;
                    if (qk0Var.d == 0) {
                        r8Var.e(-1, org.telegram.ui.ActionBar.j6.f20907p7);
                        r8Var.i("" + ((Object) qk0Var.f39925e), z10);
                        return;
                    }
                    r8Var.e(org.telegram.ui.ActionBar.j6.f21017v6, org.telegram.ui.ActionBar.j6.f20999u6);
                    r8Var.m(qk0Var.d, "" + ((Object) qk0Var.f39925e), z10);
                    return;
                case 8:
                    pk0 pk0Var = (pk0) view;
                    pk0Var.e(org.telegram.ui.ActionBar.j6.f21017v6, org.telegram.ui.ActionBar.j6.f20999u6);
                    CharSequence charSequence = qk0Var.f39925e;
                    if (qk0Var.d != 1) {
                        z11 = false;
                    }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        switch (i10) {
            ...
            case 8:
                ...
                imageView.setColorFilter(new PorterDuffColorFilter(notificationsCustomSettingsActivity.getThemedColor(org.telegram.ui.ActionBar.j6.f21017v6), PorterDuff.Mode.SRC_IN));
    ...
    public final void y(s4.c1 c1Var) {
        ...
        int i10 = notificationsCustomSettingsActivity.f33507s;
        if (i10 == 3 || ((arrayList2 = notificationsCustomSettingsActivity.f33508w) != null && arrayList2.isEmpty())) {
            if (i10 == 3) {
                Boolean bool = notificationsCustomSettingsActivity.f33505n;
                if (bool != null && !bool.booleanValue() && ((arrayList = notificationsCustomSettingsActivity.f33508w) == null || arrayList.isEmpty())) {
            ...
            if (qk0Var == null || qk0Var.f39924c != 102) {
