...
public abstract class t7 extends FrameLayout implements org.telegram.ui.Components.uc0 {
    public j7 E;
    public final ArrayList f37586a;
    public final FrameLayout f37587b;
    public final org.telegram.ui.Components.w81 f37588c;
    public final org.telegram.ui.ActionBar.n2 d;
    public final ArrayList e;
    public zh.b f37589f;
    public final org.telegram.ui.Components.x81 h;
    public final s7[] f37590n;
    public i7 f37591r;
    public int f37592s;
    public int v;
    public int f37593w;
    public boolean f37594x;
    public final f7 f37595y;

    public t7(Context context, org.telegram.ui.ActionBar.n2 n2Var, li.i iVar) {
        super(context);
        float f7;
        this.f37586a = new ArrayList();
        this.e = new ArrayList();
        s7[] s7VarArr = new s7[5];
        this.f37590n = s7VarArr;
        this.f37595y = new f7(this, 0);
        this.d = n2Var;
        ...
        int i12 = org.telegram.ui.ActionBar.j6.f19466z8;
        ...
        this.f37586a.add(imageView);
        imageView.setOnClickListener(new View.OnClickListener(this) {
            public final t7 f31964b;
    ...
    public static void a(t7 t7Var, n7 n7Var, p7 p7Var, org.telegram.ui.Components.wl0 wl0Var) {
        ...
        if (t7Var.f37591r == null) {
            t7Var.f37591r = new i7(t7Var);
        }
        t7Var.f37591r.f34441a = wl0Var;
        if (arrayList.indexOf(n7Var) >= 0) {
            PhotoViewer.t1().f2(p7Var.f36362r, arrayList.indexOf(n7Var), -1, false, t7Var.f37591r, null);
        }
    }
    ...
    public static void b(t7 t7Var, zh.a aVar, l7 l7Var) {
        ...
        if (l7Var.e == 2) {
            if (wl0Var.getAdapter() instanceof m7) {
                ...
                if (!file.getName().endsWith("mp4") && !file.getName().endsWith(".jpg") && !lowerCase.endsWith(".jpeg") && !lowerCase.endsWith(".png") && !lowerCase.endsWith(".gif")) {
                    ...
                    PhotoViewer.t1().f2(arrayList, 0, -1, false, t7Var.f37591r, null);
                }
            } else {
                return;
            }
        ...
        if (l7Var.e == 3) {
            if (MediaController.getInstance().isPlayingMessage(aVar.f49448f)) {
                if (!MediaController.getInstance().isMessagePaused()) {
                    MediaController.getInstance().lambda$startAudioAgain$7(aVar.f49448f);
                    return;
                } else {
                    MediaController.getInstance().playMessage(aVar.f49448f);
                    return;
                }
            }
            MediaController.getInstance().playMessage(aVar.f49448f);
    ...
    public final void onAttachedToWindow() {
        ...
        getViewTreeObserver().addOnPreDrawListener(this.f37595y);
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        getViewTreeObserver().removeOnPreDrawListener(this.f37595y);
    }
