...
public final class tm extends org.telegram.ui.Components.qv0 {
    ...
    public final void a0(Canvas canvas, float f7, org.telegram.ui.Cells.t1 t1Var, int i10) {
        ...
        bo boVar = this.J0;
        float x10 = t1Var.getX() + boVar.f32506x0.getLeft();
        float y3 = t1Var.getY() + boVar.f32506x0.getY() + t1Var.getPaddingTop();
        if (t1Var.a()) {
            f10 = t1Var.getAlpha();
        } else {
            f10 = 1.0f;
        }
        canvas.clipRect(boVar.f32506x0.getLeft(), f7, boVar.f32506x0.getRight(), ((((boVar.f32506x0.getY() + boVar.f32506x0.getMeasuredHeight()) - boVar.Aa) - boVar.v.d()) - boVar.f32440rc) - AndroidUtilities.dp(9.0f));
    ...
    public final void addView(View view, int i10, ViewGroup.LayoutParams layoutParams) {
        ...
        if (nkVar2 != null && view == nkVar2.m0) {
            ei.y yVar = (ei.y) view;
            yVar.setBackgroundDrawable(cVar.c(yVar.f8740c, boVar.f32505x, false));
        }
        nk nkVar3 = boVar.Y;
    ...
    public final boolean b0(View view) {
        if (view != this.L) {
            bo boVar = this.J0;
            if (view != boVar.f32521y2 && view != boVar.f32416q1 && view != boVar.f32375m9 && view != boVar.X && view != boVar.K3) {
                return false;
            }
            return true;
        }
    ...
    public final boolean dispatchKeyEvent(KeyEvent keyEvent) {
        il ilVar;
        if (keyEvent.getKeyCode() == 4 && keyEvent.getAction() == 1 && (ilVar = this.J0.Ea) != null && ilVar.f28680s) {
            ilVar.a(true);
            return true;
        }
    ...
    public float getBottomOffset() {
        return this.J0.f32506x0.getBottom();
    }
    ...
    public float getListTranslationY() {
        return this.J0.f32506x0.getTranslationY();
    }

    @Override
    public Drawable getNewDrawable() {
        Drawable d = this.J0.f32279ea.d();
        if (d != null) {
            return d;
        }
    ...
    public boolean getNewDrawableMotion() {
        TLRPC.WallPaper wallPaper = this.J0.f32279ea.h;
        if (wallPaper == null) {
    ...
    public int getScrollOffset() {
        return this.J0.f32506x0.computeVerticalScrollOffset();
    }
    ...
    public final void onAttachedToWindow() {
        ...
        if (!boVar.Oa) {
            ...
            if (e5Var != null) {
                ...
                if (((ActionBarLayout) e5Var2).f18391b) {
                    org.telegram.ui.ActionBar.q1 q1Var = this.H;
                    e5Var3 = ((org.telegram.ui.ActionBar.o2) boVar).parentLayout;
                    q1Var.f19510b = (FrameLayout) e5Var3.getView().getParent().getParent().getParent().getParent();
                }
            }
        } else {
            this.H.f19510b = boVar.X0;
        }
        this.H.c();
        ...
        if (playingMessageObject != null && ((playingMessageObject.isRoundVideo() || playingMessageObject.isVideo()) && playingMessageObject.eventId == 0 && playingMessageObject.getDialogId() == boVar.T5)) {
            MediaController.getInstance().setTextureView(boVar.N7(false), boVar.f32488v8, boVar.f32463t8, true);
        }
        zp zpVar = boVar.P9;
        if (zpVar != null) {
            zpVar.f();
    ...
    public final void onDetachedFromWindow() {
        ...
        zp zpVar = boVar.P9;
        if (zpVar != null) {
            NotificationCenter.getInstance(zpVar.f40305e0).removeObserver(zpVar, NotificationCenter.updateInterfaces);
            zpVar.F.onDetachedFromWindow();
            org.telegram.ui.Components.o5 o5Var = zpVar.f40312k0;
            if (o5Var != null && (view = zpVar.f40299a0) != null) {
                o5Var.o(view);
            }
            zpVar.Q = 0.0f;
            zpVar.P = 0L;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (getTag(67108867) == null) {
            if (getTag(67108867) == null && (s6Var = (boVar = this.J0).f32521y2) != null && s6Var.a() && boVar.f32521y2.getTag() != null) {
                return;
            }
            super.onDraw(canvas);
        }
    ...
    public final void onSizeChanged(int i10, int i11, int i12, int i13) {
        ...
        bo boVar = this.J0;
        gh.d.c(boVar.f32539z8, boVar.fragmentView);
        boVar.A8.d();
    }
