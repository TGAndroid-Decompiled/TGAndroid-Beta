...
public final class mh0 extends FrameLayout {
    ...
    public final int a(float f10, int i10) {
        TLRPC.TL_chatInviteExported tL_chatInviteExported = this.f36311n;
        ...
        if (i10 == 3) {
            return org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20035ka, false);
        }
        if (i10 == 1) {
            if (f10 > 0.5f) {
                return i0.a.d(1.0f - ((f10 - 0.5f) / 0.5f), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20089na, false), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.oa, false));
            }
            return i0.a.d(1.0f - (f10 / 0.5f), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.oa, false), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20035ka, false));
        } else if (i10 == 2) {
    ...
    public final void b(TLRPC.TL_chatInviteExported tL_chatInviteExported, int i10) {
        ...
        ImageView imageView = this.f36315x;
        ...
        if (tL_starsSubscriptionPricing != null) {
            ...
            TextView textView = this.f36310f;
            textView.setText(X0);
        ...
        ((ViewGroup.MarginLayoutParams) this.f36308b.getLayoutParams()).rightMargin = dp;
        boolean isEmpty = TextUtils.isEmpty(tL_chatInviteExported.title);
        ph0 ph0Var = this.H;
        TextView textView3 = this.f36309c;
        if (!isEmpty) {
        ...
        if (tL_chatInviteExported.permanent && !tL_chatInviteExported.revoked) {
            ...
            if (tL_chatInviteExported.expire_date > 0) {
                ...
                zsVar2.f31437b = AndroidUtilities.dp(1.5f);
                ...
                long currentTimeMillis = (tL_chatInviteExported.expire_date * 1000) - ((ph0Var.f37331k0 * 1000) + System.currentTimeMillis());
            ...
            zsVar3.f31437b = AndroidUtilities.dp(1.5f);
        ...
        if (tL_chatInviteExported.request_needed) {
            ...
            zsVar4.f31437b = AndroidUtilities.dp(1.5f);
    ...
    public final void onDraw(android.graphics.Canvas r20) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.mh0.onDraw(android.graphics.Canvas):void");
    }
