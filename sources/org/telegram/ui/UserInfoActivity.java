...
public class UserInfoActivity extends org.telegram.ui.Components.m61 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public org.telegram.ui.Components.l61 f31892x;
    ...
    public final void U(ArrayList arrayList, org.telegram.ui.Components.j61 j61Var) {
        ...
        arrayList.add(org.telegram.ui.Components.v51.k(this.f31887f));
        arrayList.add(org.telegram.ui.Components.v51.B(this.f31888n));
        ...
        arrayList.add(org.telegram.ui.Components.v51.B(this.f31889r));
    ...
    public final void W(org.telegram.ui.Components.v51 v51Var, View view) {
        ...
        if (v51Var.d == 10) {
            ...
            if (i13 != 1 && i13 != 9) {
                if (i13 == 2) {
                    this.J = null;
                    org.telegram.ui.Components.l61 l61Var = this.f31892x;
                    if (l61Var != null) {
                        l61Var.Y2.N(true);
                    }
                    b0(true);
                    ...
                    m61Var.f34526r = false;
                    gh1 gh1Var = this.N;
                    m61Var.d = gh1Var;
                    m61Var.e = j3;
                    m61Var.f34524f = eh1Var;
    ...
    public final View createView(Context context) {
        ...
        org.telegram.ui.Components.l61 l61Var = this.f26371a;
        this.f31892x = l61Var;
        l61Var.p1();
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.userInfoDidLoad) {
            ...
            e0();
            org.telegram.ui.Components.l61 l61Var2 = this.f31892x;
            if (l61Var2 != null) {
                l61Var2.Y2.N(true);
            }
            ...
            org.telegram.ui.Components.l61 l61Var3 = this.f31892x;
            if (l61Var3 != null) {
                l61Var3.Y2.N(true);
            }
        }
    ...
    public final void e0() {
        ...
        if (i10 != this.h && (l61Var = this.f31892x) != null) {
            l61Var.Y2.N(true);
        }
    }
