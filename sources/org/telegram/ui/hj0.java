...
public final class hj0 extends org.telegram.ui.Components.co {
    public final lj0 f37051v0;

    public hj0(lj0 lj0Var, Context context) {
        super(context, null, false, null);
        this.f37051v0 = lj0Var;
    }

    @Override
    public final void dispatchDraw(Canvas canvas) {
        super.dispatchDraw(canvas);
        lj0 lj0Var = this.f37051v0;
        lj0Var.W.setImageCoords(lj0Var.f38383b0.getAvatarImageView().getX(), lj0Var.f38383b0.getAvatarImageView().getY(), lj0Var.f38383b0.getAvatarImageView().getWidth(), lj0Var.f38383b0.getAvatarImageView().getHeight());
        if (lj0Var.Y) {
            canvas.save();
    ...
    public final void onAttachedToWindow() {
        ...
        this.f37051v0.W.onAttachedToWindow();
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        this.f37051v0.W.onDetachedFromWindow();
    }
}
