...
public final class hj0 extends org.telegram.ui.Components.kl0 {
    ...
    public final boolean D(s4.c1 c1Var) {
        if (c1Var.f42674f == 0) {
            return ((org.telegram.ui.Cells.b5) c1Var.f42671a).getCurrentObject() instanceof TLObject;
        }
        return false;
    }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i16 != 0) {
            if (i16 != 1) {
                if (i16 != 2) {
                    if (i16 != 4) {
                        ...
                        ij0 ij0Var = (ij0) view;
                        TextView[] textViewArr = ij0Var.f34681a;
                        TextView[] textViewArr2 = ij0Var.f34682b;
                        jj0 jj0Var2 = ij0Var.f34683c;
                        wa1 wa1Var = jj0Var2.f34929e0;
                        MessageObject messageObject2 = jj0Var2.f34931n;
                        if (wa1Var != null) {
                            i14 = wa1Var.d();
                            i13 = wa1Var.a();
                            i15 = wa1Var.c();
                        ...
                        TLRPC.ChatFull chatFull = jj0Var2.f34922a;
                    ...
                    ja1Var2.e(jj0Var.f34932r, false);
            ...
            view.setBackgroundDrawable(org.telegram.ui.ActionBar.i6.V0(this.f34314c, R.drawable.greydivider_bottom, org.telegram.ui.ActionBar.i6.f18798b7));
            return;
        }
        org.telegram.ui.Cells.b5 b5Var = (org.telegram.ui.Cells.b5) view;
        int i20 = jj0Var.I;
        if (i10 >= i20 && i10 < jj0Var.J) {
            messageObject = (MessageObject) jj0Var.f34935x.get(i10 - i20);
        } else {
            messageObject = null;
        }
        ...
        if (messageObject.isStory()) {
            ...
            b5Var.f19822r = storyItem;
            b5Var.f19817a.setOnClickListener(svVar);
            return;
        }
        b5Var.f19822r = null;
        b5Var.f19817a.setOnClickListener(null);
        if (DialogObject.isUserDialog(dialogId)) {
        ...
        if (i10 != 0) {
            ...
            if (i10 != 1) {
                if (i10 != 2) {
                    ...
                    jj0Var.f34927c0 = fVar;
                    view = new gj0(this, this.f34314c, i11, fVar, jj0Var.getResourceProvider());
                } else {
                    org.telegram.ui.Cells.m4 m4Var = new org.telegram.ui.Cells.m4(this.f34314c, org.telegram.ui.ActionBar.i6.G6, 16, 11, false, jj0Var.getResourceProvider());
                    m4Var.setHeight(43);
                    a7Var = m4Var;
                }
            } else {
            ...
            org.telegram.ui.Cells.b5 b5Var = new org.telegram.ui.Cells.b5(6, 2, this.f34314c, jj0Var.getResourceProvider(), false);
            b5Var.setDividerColor(org.telegram.ui.ActionBar.i6.f18835d7);
            view = b5Var;
        }
