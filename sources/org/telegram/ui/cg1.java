...
public abstract class cg1 extends org.telegram.ui.Components.ga {
    public static final int f32785h3 = 0;
    public boolean f32786d3;
    public boolean f32787e3;
    public float f32788f3;
    public final eg1 f32789g3;

    public cg1(eg1 eg1Var, Context context) {
        super(context, null);
        this.f32789g3 = eg1Var;
        this.f32786d3 = true;
        new Paint();
        new RectF();
        this.f25953h1 = true;
    ...
    public final void addView(View view, int i10, ViewGroup.LayoutParams layoutParams) {
        ...
        view.setTranslationY(this.f32788f3);
    ...
    public final void dispatchDraw(Canvas canvas) {
        eg1 eg1Var = this.f32789g3;
        if (eg1Var.f33296b1 != null) {
            canvas.save();
            canvas.translate(eg1Var.f33296b1.getLeft(), eg1Var.f33296b1.getY());
            eg1Var.f33296b1.draw(canvas);
            canvas.restore();
        }
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        y1();
        if (this.f32789g3.f33296b1 == view) {
            return true;
        }
    ...
    public final void onDraw(Canvas canvas) {
        eg1 eg1Var = this.f32789g3;
        if (eg1Var.f33331w != null && this.f32788f3 != 0.0f) {
            int paddingTop = getPaddingTop();
            if (paddingTop != 0) {
                canvas.save();
                canvas.translate(0.0f, paddingTop);
            }
            eg1Var.f33331w.c(canvas, true);
            if (paddingTop != 0) {
                canvas.restore();
            }
        }
        ...
        if (!this.X1) {
            ...
            if (eg1Var.getParentLayout() == null || !((ActionBarLayout) eg1Var.getParentLayout()).y()) {
                ...
                if (action == 1 || action == 3) {
                    if1 if1Var = eg1Var.O;
                    if (if1Var.f42820y != 0 && eg1Var.P.d && if1Var.g(null, 4) != 0) {
                        eg1Var.P.getClass();
                    }
                }
                boolean onTouchEvent = super.onTouchEvent(motionEvent);
                if ((action == 1 || action == 3) && eg1Var.f33335y == 2 && eg1Var.f33333x > 0 && (L0 = (c0Var = (s4.c0) getLayoutManager()).L0()) == 0) {
                    int paddingTop = getPaddingTop();
                    View m10 = c0Var.m(L0);
                    ...
                    float f10 = this.f32788f3;
                    if (f10 != 0.0f) {
                        ValueAnimator ofFloat = ValueAnimator.ofFloat(f10, 0.0f);
                        ofFloat.addUpdateListener(new a21(this, 19));
                        ofFloat.setDuration(Math.max(100L, org.telegram.messenger.vl.c(this.f32788f3, AndroidUtilities.dp(72.0f), 120.0f, 350.0f)));
