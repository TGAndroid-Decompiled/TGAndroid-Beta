...
public final class ho0 extends WebViewClient {
    ...
    public final void onPageFinished(WebView webView, String str) {
        ...
        oo0 oo0Var = this.f34265b;
        oo0Var.f36316z0 = false;
    ...
    public final boolean shouldOverrideUrlLoading(WebView webView, String str) {
        ...
        boolean z10;
        oo0 oo0Var = this.f34265b;
        oo0Var.f36314y = !str.equals(oo0Var.f36312x);
        try {
            parse = Uri.parse(str);
        ...
        if (!oo0.f36275h1.contains(parse.getScheme())) {
            if (!oo0.f36274g1.contains(parse.getScheme())) {
                try {
                    ...
                    AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(this.f34264a);
                    alertDialog$Builder.f18661a.R = oo0Var.f36301p0;
