...
public final class ho0 extends FrameLayout {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        canvas.drawCircle(dp, -AndroidUtilities.dp(28.0f), Math.max(getWidth(), getHeight()) * this.f37555b, paint);
    }
}
