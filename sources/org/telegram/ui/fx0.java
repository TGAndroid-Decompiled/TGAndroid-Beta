...
public final class fx0 extends sg.e {
    public final Context f33776b0;
    public final jx0 f33777c0;

    public fx0(jx0 jx0Var, Context context, int i10, int i11, Context context2) {
        super(context, i10, i11);
        this.f33777c0 = jx0Var;
        this.f33776b0 = context2;
    }
    ...
    public final void g() {
        ...
        int i18;
        int i19;
        jx0 jx0Var = this.f33777c0;
        PremiumPreviewFragment premiumPreviewFragment = jx0Var.f35026n;
        if (premiumPreviewFragment.f31482r0 == null && BuildVars.DEBUG_PRIVATE_VERSION) {
            Context context = this.f33776b0;
            premiumPreviewFragment.f31482r0 = new FrameLayout(context);
            ScrollView scrollView = new ScrollView(context);
            sg.a aVar = jx0Var.d.f43260b;
            yd ydVar = new yd(context, 5);
            ydVar.setOrientation(1);
            TextView textView = new TextView(context);
            textView.setText("Spectral top ");
            int i20 = org.telegram.ui.ActionBar.j6.f19293n5;
            ...
            sg.f fVar2 = aVar.f43232c;
            if (fVar2 == null) {
                f10 = 0.0f;
            } else {
                f10 = fVar2.f43291w / 2.0f;
            }
            uo0Var2.setProgress(f10);
            ...
            sg.f fVar3 = aVar.f43232c;
            if (fVar3 == null) {
                f11 = 0.0f;
            } else {
                f11 = fVar3.f43292x;
            }
            uo0Var3.setProgress(f11);
            ...
            sg.f fVar4 = aVar.f43232c;
            if (fVar4 == null) {
                f12 = 0.0f;
            } else {
                f12 = fVar4.A / 2.0f;
            }
            uo0Var4.setProgress(f12);
            ...
            uo0Var5.setDelegate(new Object());
            uo0Var5.setProgress(yd.f39906b / 2.0f);
            uo0Var5.setReportChanges(true);
            ydVar.addView(uo0Var5, w7.y5.d(-1, 38.0f, 0, 5.0f, 4.0f, 5.0f, 0.0f));
            scrollView.addView(ydVar);
            premiumPreviewFragment.f31482r0.addView(scrollView);
            premiumPreviewFragment.f31482r0.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19180h5, false));
            premiumPreviewFragment.f31466d0.addView(premiumPreviewFragment.f31482r0, w7.y5.e(-1, -1, 80));
            ((ViewGroup.MarginLayoutParams) premiumPreviewFragment.f31482r0.getLayoutParams()).topMargin = premiumPreviewFragment.f31465c0;
            premiumPreviewFragment.f31482r0.setTranslationY(AndroidUtilities.dp(1000.0f));
            premiumPreviewFragment.f31482r0.animate().translationY(1.0f).setDuration(300L);
        }
    }
}
