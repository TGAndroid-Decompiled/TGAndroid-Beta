...
public final class fx0 extends sg.e {
    public final Context f33715b0;
    public final jx0 f33716c0;

    public fx0(jx0 jx0Var, Context context, int i10, int i11, Context context2) {
        super(context, i10, i11);
        this.f33716c0 = jx0Var;
        this.f33715b0 = context2;
    }
    ...
    public final void g() {
        ...
        int i18;
        int i19;
        jx0 jx0Var = this.f33716c0;
        PremiumPreviewFragment premiumPreviewFragment = jx0Var.f35009n;
        if (premiumPreviewFragment.f31174r0 == null && BuildVars.DEBUG_PRIVATE_VERSION) {
            Context context = this.f33715b0;
            premiumPreviewFragment.f31174r0 = new FrameLayout(context);
            ScrollView scrollView = new ScrollView(context);
            sg.a aVar = jx0Var.d.f42933b;
            xd xdVar = new xd(context, 5);
            xdVar.setOrientation(1);
            TextView textView = new TextView(context);
            textView.setText("Spectral top ");
            int i20 = org.telegram.ui.ActionBar.i6.f19017n5;
            org.telegram.messenger.vl.s(textView, org.telegram.ui.ActionBar.i6.w0(null, i20, false), 1, 16.0f, 1);
            ...
            org.telegram.messenger.vl.s(textView2, org.telegram.ui.ActionBar.i6.w0(null, i20, false), 1, 16.0f, 1);
            ...
            sg.f fVar2 = aVar.f42905c;
            if (fVar2 == null) {
                f10 = 0.0f;
            } else {
                f10 = fVar2.f42964w / 2.0f;
            }
            ...
            org.telegram.messenger.vl.s(textView4, org.telegram.ui.ActionBar.i6.w0(null, i20, false), 1, 16.0f, 1);
            ...
            org.telegram.messenger.vl.s(textView5, org.telegram.ui.ActionBar.i6.w0(null, i20, false), 1, 16.0f, 1);
            ...
            org.telegram.messenger.vl.s(textView7, org.telegram.ui.ActionBar.i6.w0(null, i20, false), 1, 16.0f, 1);
            ...
            fo0Var5.setProgress(xd.f39593b / 2.0f);
            fo0Var5.setReportChanges(true);
            xdVar.addView(fo0Var5, w7.x5.d(-1, 38.0f, 0, 5.0f, 4.0f, 5.0f, 0.0f));
            scrollView.addView(xdVar);
            premiumPreviewFragment.f31174r0.addView(scrollView);
            premiumPreviewFragment.f31174r0.setBackgroundColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18904h5, false));
            premiumPreviewFragment.f31158d0.addView(premiumPreviewFragment.f31174r0, w7.x5.e(-1, -1, 80));
            ((ViewGroup.MarginLayoutParams) premiumPreviewFragment.f31174r0.getLayoutParams()).topMargin = premiumPreviewFragment.f31157c0;
            premiumPreviewFragment.f31174r0.setTranslationY(AndroidUtilities.dp(1000.0f));
            premiumPreviewFragment.f31174r0.animate().translationY(1.0f).setDuration(300L);
        }
    }
}
