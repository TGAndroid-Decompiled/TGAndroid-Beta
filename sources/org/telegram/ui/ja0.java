...
public final class ja0 implements org.telegram.ui.Components.rd0, org.telegram.ui.ActionBar.a2 {
    public final LaunchActivity f34397a;

    public ja0(LaunchActivity launchActivity) {
        this.f34397a = launchActivity;
    }

    @Override
    public void f(org.telegram.ui.ActionBar.b2 b2Var, int i10) {
        Pattern pattern = LaunchActivity.B1;
        MessagesController.getInstance(this.f34397a.O).performLogout(2);
    }
    ...
    public void i(org.telegram.ui.Components.sd0 sd0Var) {
        ...
        LaunchActivity launchActivity = this.f34397a;
        ...
        launchActivity.f30815q0.getView().setVisibility(0);
        ...
        if (AndroidUtilities.isTablet()) {
            launchActivity.f30817r0.U(true, true);
            launchActivity.f30819s0.U(true, true);
            if (launchActivity.f30817r0.getView().getVisibility() == 4) {
                launchActivity.f30817r0.getView().setVisibility(0);
            }
            launchActivity.f30819s0.getView().setVisibility(0);
        }
