...
public final class y1 extends FrameLayout {
    public final ImageView f39007a;
    public final TextView f39008b;
    public final tk f39009c;
    public o5 d;
    public String e;
    ...
    public y1(Context context) {
        ...
        this.f39009c = tkVar;
        tkVar.setTextColor(j6.w0(null, j6.f19245y6, false));
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.f39010f) {
            canvas.drawRect(AndroidUtilities.dp(64.0f), getHeight() - 1, getWidth(), getHeight(), j6.f18985k0);
        }
    }
