...
public final class y1 extends FrameLayout {
    public final ImageView f39270a;
    public final TextView f39271b;
    public final pk f39272c;
    public q5 d;
    public String e;
    ...
    public y1(Context context) {
        ...
        this.f39272c = pkVar;
        pkVar.setTextColor(h6.w0(null, h6.f19428y6, false));
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.f39273f) {
            canvas.drawRect(AndroidUtilities.dp(64.0f), getHeight() - 1, getWidth(), getHeight(), h6.f19166k0);
        }
    }
