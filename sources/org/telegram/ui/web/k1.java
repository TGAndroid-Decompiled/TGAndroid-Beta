...
public final class k1 {
    public final HashMap f39128a = new HashMap();
    public File f39129b;
    public long f39130c;
    public long d;
    ...
    public final FilterInputStream a() {
        String str;
        BufferedInputStream bufferedInputStream = new BufferedInputStream(new j1(this.f39130c, this.d, this.f39129b));
        HashMap hashMap = this.f39128a;
