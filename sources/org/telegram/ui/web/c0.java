...
public final class c0 implements DialogInterface.OnDismissListener {
    ...
    public final void onDismiss(DialogInterface dialogInterface) {
        switch (this.f39037a) {
            case 0:
                b1 b1Var = (b1) this.f39039c;
                da daVar = (da) this.d;
                String str = (String) this.e;
                b1Var.getClass();
                boolean[] zArr = this.f39038b;
                if (!zArr[0]) {
                    zArr[0] = true;
                ...
                return;
            case 1:
                Utilities.Callback callback = (Utilities.Callback) this.f39039c;
                boolean[] zArr2 = (boolean[]) this.d;
                Utilities.Callback2 callback2 = (Utilities.Callback2) this.e;
                if (callback != null && !this.f39038b[0]) {
                ...
                return;
            default:
                Utilities.Callback callback3 = (Utilities.Callback) this.f39039c;
                boolean[] zArr3 = (boolean[]) this.d;
                Utilities.Callback callback4 = (Utilities.Callback) this.e;
                if (callback3 != null && !this.f39038b[0]) {
