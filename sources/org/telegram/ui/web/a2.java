...
public final class a2 extends y51 implements NotificationCenter.NotificationCenterDelegate {
    public g3 d;
    public final Utilities.Callback f42028e;
    public long f42029f;
    public long h;
    public long f42030n;
    ...
    public final void U(ArrayList arrayList, v51 v51Var) {
        ...
        if (this.f42030n > 0) {
            ...
            arrayList.size();
            arrayList.add(h51.d(7, R.drawable.menu_clear_cache, LocaleController.getString(R.string.BrowserSettingsHistoryClear), LocaleController.formatPluralStringComma("BrowserSettingsHistoryPages", (int) this.f42030n, ',')));
            arrayList.add(h51.B(null));
        }
        ...
        arrayList.size();
        arrayList.add(h51.d(6, R.drawable.msg_search, LocaleController.getString(R.string.SearchEngine), p1.a().f42235a));
        ...
        if (i13 == 12) {
            ...
            if (i13 == 1) {
                ...
                if (i13 == 2) {
                    ...
                    if (this.f42029f != 0) {
                        str = " (" + AndroidUtilities.formatFileSize(this.f42029f) + ")";
                    }
                        ...
                        public final void g(org.telegram.ui.ActionBar.b2 b2Var2, int i15) {
                            switch (r2) {
                                ...
                                case 2:
                                    ...
                                    a2Var3.f42030n = 0L;
                                    a2Var3.f32876a.Y2.N(true);
                                    return;
                                default:
                                    a2 a2Var4 = this.f42344b;
                                    a2Var4.getMessagesController().clearAllWebBrowserExceptions();
                                    a2Var4.f32876a.Y2.N(true);
                                    return;
                            }
                        }
                    });
                    ...
                    if (i17 == 6) {
                        if (getParentActivity() != null) {
                            ...
                            for (int i18 = 0; i18 < size2; i18++) {
                                ...
                                k6Var.setBackground(j6.f0(j6.w0(null, j6.f20780i6, false), 2, -1));
                        ...
                        org.telegram.ui.ActionBar.b2 b2Var6 = alertDialog$Builder6.f20225a;
                        b2Var6.R = string6;
                        if (isWebBrowserInAppEnabled2) {
                        ...
                        b2Var6.f20251a = Math.min(AndroidUtilities.dp(320.0f), (AndroidUtilities.displaySize.x * 85) / 100);
    ...
    public final View createView(Context context) {
        ...
        mutate2.setColorFilter(new PorterDuffColorFilter(getThemedColor(j6.f20819k7), mode));
        g3 g3Var = new g3(mutate, mutate2, 4);
        g3Var.f29195x = AndroidUtilities.dp(2.0f);
        this.d = g3Var;
        this.fragmentView = super.createView(context);
        this.f32876a.o1();
        this.actionBar.setAdaptiveBackground(this.f32876a);
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        x51 x51Var;
        if (i10 == NotificationCenter.webBrowserSettingsUpdate && (x51Var = this.f32876a) != null) {
            x51Var.Y2.N(true);
        }
    }
