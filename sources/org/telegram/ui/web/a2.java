...
public final class a2 extends FrameLayout {
    public final ImageView f37858a;
    public final TextView f37859b;
    public final uk f37860c;
    public p5 d;
    public String e;
    ...
    public a2(Context context) {
        ...
        this.f37860c = ukVar;
        ukVar.setTextColor(j6.w0(null, j6.f18306y6, false));
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.f37861f) {
            canvas.drawRect(AndroidUtilities.dp(64.0f), getHeight() - 1, getWidth(), getHeight(), j6.f18049k0);
        }
    }
