...
public final class z0 extends WebView {
    ...
    public z0 f39173f;
    public boolean h;
    public String f39174n;
    public String f39175r;
    public boolean f39176s;
    public boolean v;
    public int f39177w;
    public int f39178x;
    ...
    public static void a(z0 z0Var) {
        if (!z0Var.f39172c) {
            ...
            if (a2 == null) {
                ...
                if (!TextUtils.isEmpty(a2.f39035b)) {
                    b10.f39044a.put(a2.f39035b, a2);
                    b10.c();
                    b10.d();
                }
            }
    ...
    public final void b(m2 m2Var) {
        ...
        if (m2Var != null) {
            ...
            if (d1Var != null && (h0Var = d1Var.f38903c) != null) {
                ...
                int i11 = m2Var.f39037f;
                if (i11 != 0) {
                    this.Q.f38903c.o(i11, false);
                    this.v = true;
                } else {
                    i11 = -1;
                }
                Bitmap bitmap = m2Var.f39038i;
                if (bitmap != null) {
                    d1 d1Var2 = this.Q;
                    this.O = bitmap;
                    d1Var2.getClass();
    ...
    public final void c(String str) {
        FileLog.d("[webview] #" + this.f39170a + " " + str);
    }
    ...
    public final void onScrollChanged(int i10, int i11, int i12, int i13) {
        ...
        if (c1Var != null) {
            getScrollX();
            getScrollY();
            ((l3) ((org.telegram.ui.g) c1Var).f33738b).K.f0();
        }
        getScrollX();
        getScrollY();
    }
