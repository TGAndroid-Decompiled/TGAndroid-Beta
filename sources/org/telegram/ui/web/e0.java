...
public final class e0 implements NotificationCenter.NotificationCenterDelegate {
    public final da f38777a;
    public final d1 f38778b;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == i12) {
            ...
            if (intValue == 5000) {
                ...
                int i13 = iArr[0];
                d1 d1Var = this.f38778b;
                if (i13 == 0) {
                    Activity activity = d1Var.W;
                    if (activity != null) {
                        d1Var.f38746g0 = w9.e0(activity, 3, new k2.u(d1Var, 16));
                        return;
                    }
                    return;
                }
                d1Var.y(this.f38777a, "scan_qr_popup_closed", new JSONObject());
            }
        }
    }
}
