...
public final class i extends FrameLayout implements z5 {
    public final f6 f42114a;
    public final x9 f42115b;
    public final LinearLayout f42116c;
    public final FrameLayout.LayoutParams d;
    public final TextView f42117e;
    public final TextView f42118f;
    public final TextView h;
    public final ImageView f42119n;
    public final q3 f42120r;
    public int f42121s;
    ...
    public i(Context context, f6 f6Var) {
        ...
        this.f42116c = linearLayout;
        linearLayout.setOrientation(1);
        TextView textView = new TextView(context);
        this.f42117e = textView;
    ...
    public final void d() {
        int i10 = j6.f20664d6;
        f6 f6Var = this.f42114a;
        int v02 = j6.v0(i10, f6Var);
        int v03 = j6.v0(j6.G6, f6Var);
        this.f42121s = v03;
        this.f42117e.setTextColor(v03);
        this.f42118f.setTextColor(j6.v(v02, j6.l1(0.55f, v03)));
        this.h.setTextColor(j6.l1(0.55f, v03));
        this.f42119n.setColorFilter(new PorterDuffColorFilter(j6.l1(0.6f, v03), PorterDuff.Mode.SRC_IN));
        this.v.setColor(j6.l1(0.1f, v03));
        this.f42115b.invalidate();
    }
