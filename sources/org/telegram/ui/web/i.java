...
public final class i implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final void b(ArrayList arrayList) {
        int i10 = 0;
        while (true) {
            ArrayList arrayList2 = this.f38931a;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        ArrayList arrayList = this.f38931a;
        if (i10 == i12) {
            if (((Integer) objArr[3]).intValue() == this.e) {
                this.f38935n = false;
                this.f38934f = ((Boolean) objArr[5]).booleanValue();
