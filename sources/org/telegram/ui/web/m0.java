...
public final class m0 extends WebViewClient {
    public boolean f39142a = true;
    public final l0 f39143b = new l0(this, 0);
    ...
    public final void doUpdateVisitedHistory(WebView webView, String str, boolean z10) {
        ...
        y0 y0Var = this.e;
        if (!z11 && ((c1Var = y0Var.e) == null || !TextUtils.equals(c1Var.f39042c, str))) {
            ?? tLObject = new TLObject();
            y0Var.e = tLObject;
            tLObject.f39040a = Utilities.fastRandom.nextLong();
            y0Var.e.f39041b = System.currentTimeMillis();
            y0Var.e.f39042c = b1.v(y0Var.getUrl());
    ...
    public final void onReceivedError(WebView webView, WebResourceRequest webResourceRequest, WebResourceError webResourceError) {
        if (Build.VERSION.SDK_INT >= 23) {
            ...
            if (y0Var.Q != null && (webResourceRequest == null || webResourceRequest.isForMainFrame())) {
                AndroidUtilities.cancelRunOnUIThread(this.f39143b);
                y0Var.f39281r = null;
                y0Var.f39282s = false;
                y0Var.v = false;
                y0Var.M = false;
                y0Var.J = false;
                y0Var.f39280n = (webResourceRequest == null || webResourceRequest.getUrl() == null) ? y0Var.getUrl() : webResourceRequest.getUrl().toString();
                b1 b1Var = y0Var.Q;
                y0Var.K = null;
                b1Var.I();
                b1 b1Var2 = y0Var.Q;
    ...
    public final boolean onRenderProcessGone(WebView webView, RenderProcessGoneDetail renderProcessGoneDetail) {
        ...
        try {
            ...
            alertDialog$Builder.f18662a.T = AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.ChromeCrashMessage), new l0(this, 2));
            alertDialog$Builder.k(LocaleController.getString(R.string.OK), null);
            alertDialog$Builder.f18662a.setOnDismissListener(new f5(this, 7));
    ...
    public final WebResourceResponse shouldInterceptRequest(WebView webView, WebResourceRequest webResourceRequest) {
        ...
        if (!this.f39144c && y0Var.f39279f != null && this.f39142a) {
            try {
    ...
    public final boolean shouldOverrideUrlLoading(WebView webView, String str) {
        ...
        if (str != null && !str.trim().startsWith("sms:")) {
            ...
            y0 y0Var = this.e;
            if (startsWith) {
                if (y0Var.f39279f != null) {
                    g0 g0Var2 = y0Var.Q.f39002c;
                    if (g0Var2 != null) {
                        g0Var2.j();
                    } else {
            ...
            if (!z10) {
                if (nf.f.l(context, str, true)) {
                    ...
                    if (!y0Var.f39277b && !y0Var.canGoBack()) {
                        g0 g0Var3 = y0Var.Q.f39002c;
                        if (g0Var3 != null) {
                            g0Var3.j();
                            return true;
                        }
                ...
                if (z10 || !"1".equals(parse.getQueryParameter("embed")) || !"t.me".equals(parse.getAuthority())) {
                    if (MessagesController.getInstance(y0Var.Q.M).webAppAllowedProtocols != null && MessagesController.getInstance(y0Var.Q.M).webAppAllowedProtocols.contains(parse.getScheme())) {
                        ...
                        if (y0Var.f39279f != null) {
                            ...
                            b1 b1Var2 = y0Var.f39279f.Q;
                            if (b1Var2 != null && (g0Var = b1Var2.f39002c) != null) {
                                g0Var.b();
                            }
                        }
                        b1Var.H(parse, null, !b1Var.f39016o0, false, false);
                    }
