...
public final class n0 implements q0.a {
    ...
    public final v0 f39153b;
    public final PermissionRequest f39154c;
    public final String d;

    public n0(v0 v0Var, PermissionRequest permissionRequest, String str, int i10) {
        this.f39152a = i10;
        this.f39153b = v0Var;
        this.f39154c = permissionRequest;
        this.d = str;
    }
    ...
    public final void accept(Object obj) {
        ...
        switch (this.f39152a) {
            case 0:
                v0 v0Var = this.f39153b;
                if (v0Var.f39224a != null) {
                    v0Var.f39224a = null;
                    boolean booleanValue = bool.booleanValue();
                    PermissionRequest permissionRequest = this.f39154c;
                    if (booleanValue) {
                ...
                return;
            case 1:
                v0 v0Var2 = this.f39153b;
                if (v0Var2.f39224a != null) {
                    v0Var2.f39224a = null;
                    boolean booleanValue2 = bool.booleanValue();
                    PermissionRequest permissionRequest2 = this.f39154c;
                    if (booleanValue2) {
                ...
                return;
            case 2:
                v0 v0Var3 = this.f39153b;
                v0Var3.getClass();
                boolean booleanValue3 = bool.booleanValue();
                PermissionRequest permissionRequest3 = this.f39154c;
                if (booleanValue3) {
                ...
                return;
            default:
                v0 v0Var4 = this.f39153b;
                v0Var4.getClass();
                boolean booleanValue4 = bool.booleanValue();
                PermissionRequest permissionRequest4 = this.f39154c;
                if (booleanValue4) {
