...
public final class n0 implements q0.a {
    ...
    public final void accept(Object obj) {
        ...
        switch (this.f38783a) {
            case 0:
                v0 v0Var = this.f38784b;
                if (v0Var.f38884a != null) {
                    v0Var.f38884a = null;
                    boolean booleanValue = bool.booleanValue();
                    PermissionRequest permissionRequest = this.f38785c;
                    if (booleanValue) {
                ...
                return;
            case 1:
                v0 v0Var2 = this.f38784b;
                if (v0Var2.f38884a != null) {
                    v0Var2.f38884a = null;
                    boolean booleanValue2 = bool.booleanValue();
                    PermissionRequest permissionRequest2 = this.f38785c;
                    if (booleanValue2) {
                ...
                return;
            case 2:
                v0 v0Var3 = this.f38784b;
                v0Var3.getClass();
                boolean booleanValue3 = bool.booleanValue();
                PermissionRequest permissionRequest3 = this.f38785c;
                if (booleanValue3) {
                ...
                return;
            default:
                v0 v0Var4 = this.f38784b;
                v0Var4.getClass();
                boolean booleanValue4 = bool.booleanValue();
                PermissionRequest permissionRequest4 = this.f38785c;
                if (booleanValue4) {
