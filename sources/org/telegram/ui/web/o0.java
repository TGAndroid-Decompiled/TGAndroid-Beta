...
public final class o0 implements q0.a {
    ...
    public final w0 f38892b;
    public final PermissionRequest f38893c;
    public final String d;

    public o0(w0 w0Var, PermissionRequest permissionRequest, String str, int i10) {
        this.f38891a = i10;
        this.f38892b = w0Var;
        this.f38893c = permissionRequest;
        this.d = str;
    }
    ...
    public final void accept(Object obj) {
        ...
        switch (this.f38891a) {
            case 0:
                w0 w0Var = this.f38892b;
                if (w0Var.f38993a != null) {
                    w0Var.f38993a = null;
                    boolean booleanValue = bool.booleanValue();
                    PermissionRequest permissionRequest = this.f38893c;
                    if (booleanValue) {
                ...
                return;
            case 1:
                w0 w0Var2 = this.f38892b;
                if (w0Var2.f38993a != null) {
                    w0Var2.f38993a = null;
                    boolean booleanValue2 = bool.booleanValue();
                    PermissionRequest permissionRequest2 = this.f38893c;
                    if (booleanValue2) {
                ...
                return;
            case 2:
                w0 w0Var3 = this.f38892b;
                w0Var3.getClass();
                boolean booleanValue3 = bool.booleanValue();
                PermissionRequest permissionRequest3 = this.f38893c;
                if (booleanValue3) {
                ...
                return;
            default:
                w0 w0Var4 = this.f38892b;
                w0Var4.getClass();
                boolean booleanValue4 = bool.booleanValue();
                PermissionRequest permissionRequest4 = this.f38893c;
                if (booleanValue4) {
