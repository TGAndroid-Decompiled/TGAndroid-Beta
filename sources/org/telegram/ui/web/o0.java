...
public final class o0 implements q0.a {
    ...
    public final w0 f38999b;
    public final PermissionRequest f39000c;
    public final String d;

    public o0(w0 w0Var, PermissionRequest permissionRequest, String str, int i10) {
        this.f38998a = i10;
        this.f38999b = w0Var;
        this.f39000c = permissionRequest;
        this.d = str;
    }
    ...
    public final void accept(Object obj) {
        ...
        switch (this.f38998a) {
            case 0:
                w0 w0Var = this.f38999b;
                if (w0Var.f39071a != null) {
                    w0Var.f39071a = null;
                    boolean booleanValue = bool.booleanValue();
                    PermissionRequest permissionRequest = this.f39000c;
                    if (booleanValue) {
                ...
                return;
            case 1:
                w0 w0Var2 = this.f38999b;
                if (w0Var2.f39071a != null) {
                    w0Var2.f39071a = null;
                    boolean booleanValue2 = bool.booleanValue();
                    PermissionRequest permissionRequest2 = this.f39000c;
                    if (booleanValue2) {
                ...
                return;
            case 2:
                w0 w0Var3 = this.f38999b;
                w0Var3.getClass();
                boolean booleanValue3 = bool.booleanValue();
                PermissionRequest permissionRequest3 = this.f39000c;
                if (booleanValue3) {
                ...
                return;
            default:
                w0 w0Var4 = this.f38999b;
                w0Var4.getClass();
                boolean booleanValue4 = bool.booleanValue();
                PermissionRequest permissionRequest4 = this.f39000c;
                if (booleanValue4) {
