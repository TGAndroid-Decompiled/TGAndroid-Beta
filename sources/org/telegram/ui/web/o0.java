...
public final class o0 extends WebViewClient {
    public boolean f42224a = true;
    public final n0 f42225b = new n0(this, 0);
    public final boolean f42226c;
    public final Context d;
    public final z0 f42227e;
    ...
    public final void doUpdateVisitedHistory(WebView webView, String str, boolean z10) {
        ...
        z0 z0Var = this.f42227e;
        if (!z11 && ((e1Var = z0Var.f42358e) == null || !TextUtils.equals(e1Var.f42106c, str))) {
            ?? tLObject = new TLObject();
            z0Var.f42358e = tLObject;
            tLObject.f42104a = Utilities.fastRandom.nextLong();
            z0Var.f42358e.f42105b = System.currentTimeMillis();
            z0Var.f42358e.f42106c = d1.v(z0Var.getUrl());
            z0Var.f42358e.d = n2.a(z0Var);
            f1.c(z0Var.f42358e);
        }
    ...
    public final void onReceivedError(WebView webView, WebResourceRequest webResourceRequest, WebResourceError webResourceError) {
        if (Build.VERSION.SDK_INT >= 23) {
            ...
            if (z0Var.Q != null && (webResourceRequest == null || webResourceRequest.isForMainFrame())) {
                AndroidUtilities.cancelRunOnUIThread(this.f42225b);
                z0Var.f42361r = null;
                z0Var.f42362s = false;
                z0Var.v = false;
                z0Var.M = false;
                z0Var.J = false;
                z0Var.f42360n = (webResourceRequest == null || webResourceRequest.getUrl() == null) ? z0Var.getUrl() : webResourceRequest.getUrl().toString();
                d1 d1Var = z0Var.Q;
                z0Var.K = null;
                d1Var.I();
                d1 d1Var2 = z0Var.Q;
    ...
    public final boolean onRenderProcessGone(WebView webView, RenderProcessGoneDetail renderProcessGoneDetail) {
        ...
        try {
            ...
            alertDialog$Builder.f20226a.T = AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.ChromeCrashMessage), new n0(this, 2));
            alertDialog$Builder.k(LocaleController.getString(R.string.OK), null);
            alertDialog$Builder.f20226a.setOnDismissListener(new r4(this, 7));
    ...
    public final WebResourceResponse shouldInterceptRequest(WebView webView, WebResourceRequest webResourceRequest) {
        ...
        if (!this.f42226c && z0Var.f42359f != null && this.f42224a) {
            try {
    ...
    public final boolean shouldOverrideUrlLoading(WebView webView, String str) {
        ...
        if (str != null && !str.trim().startsWith("sms:")) {
            ...
            z0 z0Var = this.f42227e;
            if (startsWith) {
                if (z0Var.f42359f != null) {
                    i0 i0Var2 = z0Var.Q.f42067c;
                    if (i0Var2 != null) {
                        i0Var2.j();
                    } else {
            ...
            if (!z10) {
                if (of.f.l(context, str, true)) {
                    ...
                    if (!z0Var.f42356b && !z0Var.canGoBack()) {
                        i0 i0Var3 = z0Var.Q.f42067c;
                        if (i0Var3 != null) {
                            i0Var3.j();
                            return true;
                        }
                ...
                if (z10 || !"1".equals(parse.getQueryParameter("embed")) || !"t.me".equals(parse.getAuthority())) {
                    if (MessagesController.getInstance(z0Var.Q.M).webAppAllowedProtocols != null && MessagesController.getInstance(z0Var.Q.M).webAppAllowedProtocols.contains(parse.getScheme())) {
                        if (z0Var.f42359f != null) {
                            ...
                            d1 d1Var = z0Var.f42359f.Q;
                            if (d1Var != null && (i0Var = d1Var.f42067c) != null) {
                                i0Var.b();
                            }
                        }
                        d1 d1Var2 = z0Var.Q;
                        d1Var2.H(parse, null, !d1Var2.f42082o0, false, false);
                    }
