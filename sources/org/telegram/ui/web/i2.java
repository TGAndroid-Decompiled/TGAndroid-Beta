...
public final class i2 implements Runnable {
    ...
    public final void run() {
        switch (this.f39484a) {
            case 0:
                final m2 m2Var = this.f39485b;
                if (!m2Var.d) {
                    m2Var.d = true;
                    long currentTimeMillis = System.currentTimeMillis();
                    final ArrayList arrayList = new ArrayList();
                    for (l2 l2Var : m2Var.f39529a.values()) {
                        if (!TextUtils.isEmpty(l2Var.f39518b) && currentTimeMillis - l2Var.f39517a <= 604800000) {
                                            ...
                                            case 0:
                                                ...
                                                while (true) {
                                                    ...
                                                    if (i10 < arrayList2.size()) {
                                                        ...
                                                        m2Var2.f39529a.put(l2Var2.f39518b, l2Var2);
                                                        i10++;
                                                    } else {
                                                        m2Var2.f39530b = true;
                                                        m2Var2.f39531c = false;
                                                        return;
                                                    }
                                                }
                                            default:
                                                ...
                                                k2 k2Var = new k2();
                                                k2Var.f39510a.addAll(arrayList);
            ...
            case 1:
                ...
                try {
                    ...
                    arrayList2.addAll(k2Var.f39510a);
                } catch (Exception e) {
                    FileLog.e(e);
                }
                            ...
                            case 0:
                                ...
                                while (true) {
                                    ...
                                    if (i10 < arrayList22.size()) {
                                        ...
                                        m2Var22.f39529a.put(l2Var2.f39518b, l2Var2);
                                        i10++;
                                    } else {
                                        m2Var22.f39530b = true;
                                        m2Var22.f39531c = false;
                                        return;
                                    }
                                }
                            default:
                                ...
                                k2 k2Var2 = new k2();
                                k2Var2.f39510a.addAll(arrayList2);
