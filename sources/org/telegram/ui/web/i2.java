...
public final class i2 implements Runnable {
    ...
    public final void run() {
        switch (this.f38736a) {
            case 0:
                final m2 m2Var = this.f38737b;
                if (!m2Var.d) {
                    m2Var.d = true;
                    long currentTimeMillis = System.currentTimeMillis();
                    final ArrayList arrayList = new ArrayList();
                    for (l2 l2Var : m2Var.f38779a.values()) {
                        if (!TextUtils.isEmpty(l2Var.f38770b) && currentTimeMillis - l2Var.f38769a <= 604800000) {
                                            ...
                                            case 0:
                                                ...
                                                while (true) {
                                                    ...
                                                    if (i10 < arrayList2.size()) {
                                                        ...
                                                        m2Var2.f38779a.put(l2Var2.f38770b, l2Var2);
                                                        i10++;
                                                    } else {
                                                        m2Var2.f38780b = true;
                                                        m2Var2.f38781c = false;
                                                        return;
                                                    }
                                                }
                                            default:
                                                ...
                                                k2 k2Var = new k2();
                                                k2Var.f38762a.addAll(arrayList);
            ...
            case 1:
                ...
                try {
                    ...
                    arrayList2.addAll(k2Var.f38762a);
                } catch (Exception e) {
                    FileLog.e(e);
                }
                            ...
                            case 0:
                                ...
                                while (true) {
                                    ...
                                    if (i10 < arrayList22.size()) {
                                        ...
                                        m2Var22.f38779a.put(l2Var2.f38770b, l2Var2);
                                        i10++;
                                    } else {
                                        m2Var22.f38780b = true;
                                        m2Var22.f38781c = false;
                                        return;
                                    }
                                }
                            default:
                                ...
                                k2 k2Var2 = new k2();
                                k2Var2.f38762a.addAll(arrayList2);
