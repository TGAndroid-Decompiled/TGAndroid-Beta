...
public final class i2 {
    ...
    public static HashMap f38990f;
    public String f38991a;
    public ni.f f38992b;
    public TLRPC.TL_webPage f38993c;
    ...
    public static void g(h2 h2Var, ImageReceiver imageReceiver, Runnable runnable) {
        ...
        String str;
        Bitmap decodeStream;
        if (h2Var != null && (i2Var = h2Var.f38978a) != null) {
            HashMap hashMap = i2Var.d;
            try {
                if (i2Var.f38992b != null) {
                    Iterator it = h2Var.f38980c.iterator();
                    l1Var = null;
                    while (it.hasNext()) {
                        l1Var = (l1) ((HashMap) i2Var.f38992b.f15257c).get((String) it.next());
                        if (l1Var != null) {
                            break;
                        }
                    }
                ...
                if (l1Var != null) {
                ...
                } else if (hashMap.containsKey(h2Var.f38979b)) {
                    imageReceiver.setImageBitmap((Bitmap) hashMap.get(h2Var.f38979b));
                } else {
                    if (f38990f == null) {
                        f38990f = new HashMap();
                    }
                    ArrayList arrayList = (ArrayList) f38990f.get(h2Var.f38979b);
                    if (arrayList != null) {
                    ...
                    f38990f.put(h2Var.f38979b, new ArrayList());
                    new i1(new mj0(12, i2Var, h2Var)).execute(h2Var.f38979b);
                }
            } catch (Exception e7) {
                FileLog.e(e7);
            }
            ...
            if (tL_webPage != null && (page = tL_webPage.cached_page) != null && (arrayList = page.photos) != null) {
                ...
                while (i10 < size) {
                    ...
                    if (photo2 instanceof h2) {
                        h2 h2Var = (h2) photo2;
                        HashMap hashMap3 = f38990f;
                        if (hashMap3 != null) {
                            hashMap3.remove(h2Var.f38979b);
                        }
                    }
                }
            }
    ...
    public final TL_iv.pageBlockPhoto h(JSONObject jSONObject, TL_iv.TL_page tL_page) {
        ...
        h2 h2Var = new h2();
        h2Var.f38978a = this;
        h2Var.f18133id = (-1) - tL_page.photos.size();
        h2Var.f38979b = optString2;
        h2Var.f38980c.add(optString2);
        try {
        ...
        pageblockphoto.photo_id = h2Var.f18133id;
                        ...
                        if (pageblockphoto2 == null) {
                            ...
                            while (true) {
                                if (i12 < tL_page.photos.size()) {
                                    if ((tL_page.photos.get(i12) instanceof h2) && tL_page.photos.get(i12).f18133id == pageblockphoto2.photo_id) {
                            ...
                            if (h2Var != null) {
                                h2Var.f38980c.addAll(arrayList2);
                            }
                ...
                switch (c10) {
                    ...
                    case 7:
                        ...
                        if (optString3 != null) {
                            ...
                            h2Var.f38978a = this;
                            h2Var.f18133id = (-1) - tL_page.photos.size();
                            h2Var.f38979b = optString3;
                            h2Var.f38980c.add(optString3);
                            try {
                                h2Var.d = Integer.parseInt(jSONObject.optString("width"));
                            } catch (Exception unused) {
                            }
                            ...
                            try {
                                textimage.f18331w = Integer.parseInt(jSONObject.optString("width"));
                            ...
                            if (textimage.f18331w == 0) {
                                textimage.f18331w = textimage.h;
                            }
                            if (textimage.h == 0) {
                                textimage.h = textimage.f18331w;
                            }
                            textimage.photo_id = h2Var.f18133id;
