...
public final class v1 {
    public final n6 f39083a;
    public final n6 f39084b;
    public final d6 f39085c;
    public int d;
    public boolean e;
    public int f39086f;
    public final Drawable f39087g;
    ...
    public v1(org.telegram.ui.k0 k0Var) {
        ...
        this.f39084b = n6Var2;
        this.f39085c = new d6(k0Var, 0L, 300L, qr.h);
        this.e = false;
        n6Var.E = true;
        ...
        n6Var2.G = 9999999;
        this.f39087g = k0Var.getContext().getResources().getDrawable(R.drawable.warning_sign).mutate();
    }

    public final void a(Canvas canvas, float f7, float f10, float f11) {
        org.telegram.ui.k0 k0Var = this.h;
        RectF rectF = k0Var.f39095a;
        rectF.set(0.0f, 0.0f, f7, f10);
        canvas.saveLayerAlpha(rectF, (int) (f11 * 255.0f), 31);
        n6 n6Var = this.f39083a;
        float g10 = n6Var.g();
        n6 n6Var2 = this.f39084b;
        float g11 = n6Var2.g();
        TextPaint textPaint = n6Var2.f26642a;
        float f12 = g11 * g10;
        canvas.save();
        float f13 = 0.82f * f10;
        ...
        n6Var2.r(i0.a.d(e, this.d, j6.w0(null, j6.f19348q7, false)));
        if (e > 0.0f) {
            int i10 = this.f39086f;
        ...
        k0Var.f39117r0.b(canvas, rectF, 2, 1.0f);
        canvas.restore();
    }
}
