...
public final class p extends g5 {
    public final b f42205f = new b(this, 1);
    public final q h;
    ...
    public final void m() {
        ...
        x51 x51Var = qVar.f32850a;
        if (x51Var != null) {
            x51Var.Y2.N(true);
            qVar.f32850a.X2.h1(0, 0);
        }
    }
    ...
    public final void q(EditText editText) {
        int i10;
        q qVar = this.h;
        boolean z10 = !TextUtils.isEmpty(qVar.f42216s);
        String obj = editText.getText().toString();
        if (!TextUtils.equals(qVar.f42216s, obj)) {
            qVar.f42216s = obj;
            j jVar = qVar.f42212e;
            if (jVar != null) {
                jVar.c();
