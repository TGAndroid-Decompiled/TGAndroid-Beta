...
public final class h extends FrameLayout implements a6 {
    public final f6 f38807a;
    public final u9 f38808b;
    public final LinearLayout f38809c;
    public final FrameLayout.LayoutParams d;
    public final TextView e;
    public final TextView f38810f;
    public final TextView h;
    public final ImageView f38811n;
    public final q3 f38812r;
    public int f38813s;
    public final Paint v;
    public boolean f38814w;
    ...
    public final void e() {
        int i10 = j6.f18863d6;
        f6 f6Var = this.f38807a;
        int v02 = j6.v0(i10, f6Var);
        int v03 = j6.v0(j6.G6, f6Var);
        this.f38813s = v03;
        this.e.setTextColor(v03);
        this.f38810f.setTextColor(j6.v(v02, j6.l1(0.55f, v03)));
        this.h.setTextColor(j6.l1(0.55f, v03));
        this.f38811n.setColorFilter(new PorterDuffColorFilter(j6.l1(0.6f, v03), PorterDuff.Mode.SRC_IN));
        this.v.setColor(j6.l1(0.1f, v03));
        this.f38808b.invalidate();
    }
