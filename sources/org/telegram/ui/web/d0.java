...
public final class d0 implements NotificationCenter.NotificationCenterDelegate {
    public final da f39042a;
    public final b1 f39043b;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == i12) {
            ...
            if (intValue == 5000) {
                ...
                int i13 = iArr[0];
                b1 b1Var = this.f39043b;
                if (i13 == 0) {
                    Activity activity = b1Var.W;
                    if (activity != null) {
                        b1Var.f39006g0 = u9.e0(activity, 3, new n2.e(b1Var, 11));
                        return;
                    }
                    return;
                }
                b1Var.y(this.f39042a, "scan_qr_popup_closed", new JSONObject());
            }
        }
    }
}
