    ...
    public final void run() {
        ...
        switch (this.f39065a) {
            case 0:
                ...
                return;
            case 1:
                d1 d1Var = this.f39066b;
                da daVar = d1Var.I0;
                ei.w0 w0Var = d1Var.f38886k0;
                w0Var.getClass();
                ...
                return;
            default:
                d1 d1Var2 = this.f39066b;
                if (d1Var2.S) {
                    d1Var2.S = false;
                    h0 h0Var2 = d1Var2.f38876c;
                    if (h0Var2 != null) {
                        h0Var2.t(false);
                    }
                }
                ...
                d1Var2.P = 0L;
                d1Var2.T = false;
                z0 z0Var = d1Var2.f38872a;
                if (z0Var != null) {
                    z0Var.onResume();
                    d1Var2.f38872a.reload();
                    return;
                }
                return;
        }
