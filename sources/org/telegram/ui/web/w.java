            ...
            case 0:
                ...
                if (tL_buttonTypeRequestPeer != null) {
                    ...
                    if (requestPeerType instanceof TLRPC.TL_requestPeerTypeCreateBot) {
                        ...
                        ij0 ij0Var2 = ij0.f37718r0;
                        p2 R = LaunchActivity.R();
                        if (R == null) {
                            ij0Var = null;
                        } else {
                            ij0 ij0Var3 = ij0.f37718r0;
                            if (ij0Var3 != null) {
                                ij0Var = ij0Var3;
                            } else {
                                ij0 ij0Var4 = new ij0(R, i10, bool, bool2, yVar);
                                ij0Var4.show();
                                ij0.f37718r0 = ij0Var4;
                                ij0Var = ij0Var4;
                            }
                        }
                        if (ij0Var != null) {
                        ...
                        e6.putLong("requestPeerBotId", a1Var.R.f20992id);
                        try {
                        ...
                        d0Var.f40278z2 = new y(a1Var, zArr2, str, tL_buttonTypeRequestPeer);
