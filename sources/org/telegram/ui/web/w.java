...
public final class w implements Utilities.Callback2 {
    ...
    public final d1 f42296b;
    public final k9 f42297c;
    ...
    public final void run(Object obj, Object obj2) {
        ...
        String str = this.d;
        k9 k9Var = this.f42297c;
        d1 d1Var = this.f42296b;
        switch (i11) {
            case 0:
                TLRPC.TL_error tL_error = (TLRPC.TL_error) obj2;
                d1 d1Var2 = this.f42296b;
                ...
                if (tL_buttonTypeRequestPeer != null) {
                    ...
                    if (requestPeerType instanceof TLRPC.TL_requestPeerTypeCreateBot) {
                        ...
                        e7.putLong("requestPeerBotId", d1Var2.U.f20043id);
                        try {
