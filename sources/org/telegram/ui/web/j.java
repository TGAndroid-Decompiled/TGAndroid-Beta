...
public final class j implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final Runnable f42162c;
    public final String d;
    public boolean f42164f;
    public boolean h;
    public boolean f42165n;
    public final ArrayList f42160a = new ArrayList();
    public final int f42163e = ConnectionsManager.generateClassGuid();

    public j(String str, int i10, Runnable runnable) {
        this.f42161b = i10;
        this.d = str;
        this.f42162c = runnable;
    }

    public final void a() {
        if (!this.h) {
            this.h = true;
            int i10 = this.f42161b;
    ...
    public final void b(ArrayList arrayList) {
        int i10 = 0;
        while (true) {
            ArrayList arrayList2 = this.f42160a;
    ...
    public final void c() {
        ...
        ConnectionsManager.getInstance(i10).cancelRequestsForGuid(this.f42163e);
        this.f42165n = false;
    }
    ...
    public final void d() {
        ...
        if (!this.f42165n && !this.f42164f) {
            ...
            mediaDataController.loadMedia(clientUserId, i10, i13, 0, 3, 0L, 1, this.f42163e, 0, null, this.d);
        }
    }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == i12) {
            if (((Integer) objArr[3]).intValue() == this.f42163e) {
                this.f42165n = false;
                this.f42164f = ((Boolean) objArr[5]).booleanValue();
