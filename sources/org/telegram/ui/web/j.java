...
public final class j implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final void b(ArrayList arrayList) {
        int i10 = 0;
        while (true) {
            ArrayList arrayList2 = this.f37972a;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        ArrayList arrayList = this.f37972a;
        if (i10 == i12) {
            if (((Integer) objArr[3]).intValue() == this.e) {
                this.f37976n = false;
                this.f37975f = ((Boolean) objArr[5]).booleanValue();
