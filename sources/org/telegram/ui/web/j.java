...
public final class j implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final Runnable f42135c;
    public final String d;
    public boolean f42137f;
    public boolean h;
    public boolean f42138n;
    public final ArrayList f42133a = new ArrayList();
    public final int f42136e = ConnectionsManager.generateClassGuid();

    public j(String str, int i10, Runnable runnable) {
        this.f42134b = i10;
        this.d = str;
        this.f42135c = runnable;
    }
    ...
    public final void b(ArrayList arrayList) {
        int i10 = 0;
        while (true) {
            ArrayList arrayList2 = this.f42133a;
    ...
    public final void c() {
        ...
        ConnectionsManager.getInstance(i10).cancelRequestsForGuid(this.f42136e);
        this.f42138n = false;
    }
    ...
    public final void d() {
        ArrayList arrayList;
        int i10;
        if (!this.f42138n && !this.f42137f) {
            this.f42138n = true;
            int i11 = this.f42134b;
            long clientUserId = UserConfig.getInstance(i11).getClientUserId();
            int i12 = 0;
            int i13 = Integer.MAX_VALUE;
            while (true) {
                arrayList = this.f42133a;
            ...
            mediaDataController.loadMedia(clientUserId, i10, i13, 0, 3, 0L, 1, this.f42136e, 0, null, this.d);
        }
    }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        ArrayList arrayList = this.f42133a;
        if (i10 == i12) {
            if (((Integer) objArr[3]).intValue() == this.f42136e) {
                this.f42138n = false;
                this.f42137f = ((Boolean) objArr[5]).booleanValue();
