...
public final class j implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final Runnable f42134c;
    public final String d;
    public boolean f42136f;
    public boolean h;
    public boolean f42137n;
    public final ArrayList f42132a = new ArrayList();
    public final int f42135e = ConnectionsManager.generateClassGuid();

    public j(String str, int i10, Runnable runnable) {
        this.f42133b = i10;
        this.d = str;
        this.f42134c = runnable;
    }

    public final void a() {
        if (!this.h) {
            this.h = true;
            int i10 = this.f42133b;
    ...
    public final void b(ArrayList arrayList) {
        int i10 = 0;
        while (true) {
            ArrayList arrayList2 = this.f42132a;
    ...
    public final void c() {
        ...
        ConnectionsManager.getInstance(i10).cancelRequestsForGuid(this.f42135e);
        this.f42137n = false;
    }
    ...
    public final void d() {
        ...
        if (!this.f42137n && !this.f42136f) {
            ...
            mediaDataController.loadMedia(clientUserId, i10, i13, 0, 3, 0L, 1, this.f42135e, 0, null, this.d);
        }
    }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        ArrayList arrayList = this.f42132a;
        if (i10 == i12) {
            if (((Integer) objArr[3]).intValue() == this.f42135e) {
                this.f42137n = false;
                this.f42136f = ((Boolean) objArr[5]).booleanValue();
