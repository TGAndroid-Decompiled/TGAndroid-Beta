...
public final class g extends h51 {
    public static final int f38953a = 0;
    ...
    public final boolean contentsEquals(i51 i51Var, i51 i51Var2) {
        if (i51Var.H == i51Var2.H && TextUtils.equals(i51Var.f24901m, i51Var2.f24901m)) {
            return true;
        }
        return false;
    }
    ...
    public final boolean equals(i51 i51Var, i51 i51Var2) {
        if (i51Var.H == i51Var2.H && TextUtils.isEmpty(i51Var.f24901m) == TextUtils.isEmpty(i51Var2.f24901m)) {
            return true;
        }
        return false;
    }
