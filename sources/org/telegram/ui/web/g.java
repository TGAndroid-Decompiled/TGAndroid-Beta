...
public final class g extends i51 {
    public static final int f38795a = 0;
    ...
    public final boolean contentsEquals(j51 j51Var, j51 j51Var2) {
        if (j51Var.H == j51Var2.H && TextUtils.equals(j51Var.f25128m, j51Var2.f25128m)) {
            return true;
        }
        return false;
    }
    ...
    public final boolean equals(j51 j51Var, j51 j51Var2) {
        if (j51Var.H == j51Var2.H && TextUtils.isEmpty(j51Var.f25128m) == TextUtils.isEmpty(j51Var2.f25128m)) {
            return true;
        }
        return false;
    }
