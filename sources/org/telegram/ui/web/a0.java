...
public final class a0 implements Utilities.Callback {
    public final int f38705a = 0;
    public final d1 f38706b;
    ...
    public final void run(Object obj) {
        switch (this.f38705a) {
            case 0:
                da daVar = (da) this.e;
                ei.t1 t1Var = (ei.t1) this.f38708f;
                String str = this.d;
                String str2 = (String) obj;
                d1 d1Var = this.f38706b;
                String str3 = this.f38707c;
                if (str2 == null) {
            ...
            default:
                d1 d1Var2 = this.f38706b;
                AndroidUtilities.runOnUIThread(new z8(d1Var2, (File) obj, (org.telegram.ui.ActionBar.c2) this.e, this.f38707c, this.d, (String) this.f38708f, 14));
                return;
        }
    }
