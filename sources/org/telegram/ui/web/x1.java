...
public final class x1 extends FrameLayout {
    public final ImageView f42768a;
    public final TextView f42769b;
    public final pk f42770c;
    public l5 d;
    ...
    public x1(Context context) {
        ...
        this.f42770c = pkVar;
        pkVar.setTextColor(k6.w0(null, k6.f22036y6, false));
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.f42772f) {
            canvas.drawRect(AndroidUtilities.dp(64.0f), getHeight() - 1, getWidth(), getHeight(), k6.f21779k0);
        }
    }
