...
public final class m1 {
    public final HashMap f42207a = new HashMap();
    public File f42208b;
    public long f42209c;
    public long d;
    ...
    public final FilterInputStream a() {
        String str;
        BufferedInputStream bufferedInputStream = new BufferedInputStream(new l1(this.f42208b, this.f42209c, this.d));
        HashMap hashMap = this.f42207a;
