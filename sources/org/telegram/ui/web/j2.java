...
public final class j2 implements Runnable {
    ...
    public final void run() {
        switch (this.f38841a) {
            case 0:
                final n2 n2Var = this.f38842b;
                if (!n2Var.d) {
                    n2Var.d = true;
                    long currentTimeMillis = System.currentTimeMillis();
                    final ArrayList arrayList = new ArrayList();
                    for (m2 m2Var : n2Var.f38882a.values()) {
                        if (!TextUtils.isEmpty(m2Var.f38873b) && currentTimeMillis - m2Var.f38872a <= 604800000) {
                                            ...
                                            case 0:
                                                ...
                                                while (true) {
                                                    ...
                                                    if (i10 < arrayList2.size()) {
                                                        ...
                                                        n2Var2.f38882a.put(m2Var2.f38873b, m2Var2);
                                                        i10++;
                                                    } else {
                                                        n2Var2.f38883b = true;
                                                        n2Var2.f38884c = false;
                                                        return;
                                                    }
                                                }
                                            default:
                                                ...
                                                l2 l2Var = new l2();
                                                l2Var.f38866a.addAll(arrayList);
            ...
            case 1:
                ...
                try {
                    ...
                    arrayList2.addAll(l2Var.f38866a);
                } catch (Exception e) {
                    FileLog.e(e);
                }
                            ...
                            case 0:
                                ...
                                while (true) {
                                    ...
                                    if (i10 < arrayList22.size()) {
                                        ...
                                        n2Var22.f38882a.put(m2Var2.f38873b, m2Var2);
                                        i10++;
                                    } else {
                                        n2Var22.f38883b = true;
                                        n2Var22.f38884c = false;
                                        return;
                                    }
                                }
                            default:
                                ...
                                l2 l2Var2 = new l2();
                                l2Var2.f38866a.addAll(arrayList2);
