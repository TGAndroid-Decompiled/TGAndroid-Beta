...
public final class j2 implements Runnable {
    ...
    public final void run() {
        switch (this.f39003a) {
            case 0:
                final n2 n2Var = this.f39004b;
                if (!n2Var.d) {
                    n2Var.d = true;
                    long currentTimeMillis = System.currentTimeMillis();
                    final ArrayList arrayList = new ArrayList();
                    for (m2 m2Var : n2Var.f39044a.values()) {
                        if (!TextUtils.isEmpty(m2Var.f39035b) && currentTimeMillis - m2Var.f39034a <= 604800000) {
                                            ...
                                            case 0:
                                                ...
                                                while (true) {
                                                    ...
                                                    if (i10 < arrayList2.size()) {
                                                        ...
                                                        n2Var2.f39044a.put(m2Var2.f39035b, m2Var2);
                                                        i10++;
                                                    } else {
                                                        n2Var2.f39045b = true;
                                                        n2Var2.f39046c = false;
                                                        return;
                                                    }
                                                }
                                            default:
                                                ...
                                                l2 l2Var = new l2();
                                                l2Var.f39028a.addAll(arrayList);
            ...
            case 1:
                ...
                try {
                    ...
                    arrayList2.addAll(l2Var.f39028a);
                } catch (Exception e) {
                    FileLog.e(e);
                }
                            ...
                            case 0:
                                ...
                                while (true) {
                                    ...
                                    if (i10 < arrayList22.size()) {
                                        ...
                                        n2Var22.f39044a.put(m2Var2.f39035b, m2Var2);
                                        i10++;
                                    } else {
                                        n2Var22.f39045b = true;
                                        n2Var22.f39046c = false;
                                        return;
                                    }
                                }
                            default:
                                ...
                                l2 l2Var2 = new l2();
                                l2Var2.f39028a.addAll(arrayList2);
