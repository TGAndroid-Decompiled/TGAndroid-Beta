...
public final class z1 extends FrameLayout {
    public final ImageView f42366a;
    public final TextView f42367b;
    public final sk f42368c;
    public q5 d;
    ...
    public z1(Context context) {
        ...
        this.f42368c = skVar;
        skVar.setTextColor(j6.w0(null, j6.f21070y6, false));
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.f42370f) {
            canvas.drawRect(AndroidUtilities.dp(64.0f), getHeight() - 1, getWidth(), getHeight(), j6.f20813k0);
        }
    }
