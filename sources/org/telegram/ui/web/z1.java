...
public final class z1 extends FrameLayout {
    public final ImageView f42339a;
    public final TextView f42340b;
    public final sk f42341c;
    public q5 d;
    ...
    public z1(Context context) {
        ...
        this.f42341c = skVar;
        skVar.setTextColor(j6.w0(null, j6.f21043y6, false));
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.f42343f) {
            canvas.drawRect(AndroidUtilities.dp(64.0f), getHeight() - 1, getWidth(), getHeight(), j6.f20786k0);
        }
    }
