...
public final class z1 extends z51 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final void U(ArrayList arrayList, w51 w51Var) {
        ...
        if (this.f39181n > 0) {
            ...
            arrayList.size();
            arrayList.add(i51.d(7, R.drawable.menu_clear_cache, LocaleController.getString(R.string.BrowserSettingsHistoryClear), LocaleController.formatPluralStringComma("BrowserSettingsHistoryPages", (int) this.f39181n, ',')));
            arrayList.add(i51.B(null));
        }
        ...
        i51Var3.d = 15;
        i51Var3.G = t3Var2;
        i51Var3.f24900l = string5;
        i51Var3.f24905q = true;
        ...
        arrayList.size();
        arrayList.add(i51.d(6, R.drawable.msg_search, LocaleController.getString(R.string.SearchEngine), o1.a().f39051a));
        ...
        if (i13 == 12) {
            ...
            if (i13 == 1) {
                ...
                if (i13 == 2) {
                    ...
                    if (this.f39180f != 0) {
                        str = " (" + AndroidUtilities.formatFileSize(this.f39180f) + ")";
                    }
                        ...
                        public final void f(org.telegram.ui.ActionBar.b2 b2Var2, int i15) {
                            switch (r2) {
                                case 0:
                                    ...
                                    n2 b10 = n2.b();
                                    HashMap hashMap = b10.f39044a;
                                    if (hashMap == null) {
                                        b10.f39046c = false;
                                        b10.f39045b = true;
                                        b10.f39044a = new HashMap();
                                    } else {
                                        hashMap.clear();
                                    }
                                    b10.d();
                                ...
                                case 2:
                                    ...
                                    z1Var3.f39181n = 0L;
                                    z1Var3.f30482a.Y2.N(true);
                                    return;
                                default:
                                    z1 z1Var4 = this.f39153b;
                                    z1Var4.getMessagesController().clearAllWebBrowserExceptions();
                                    z1Var4.f30482a.Y2.N(true);
                                    return;
                            }
                        }
                    });
                    ...
                    if (i17 == 6) {
                        if (getParentActivity() != null) {
                            ...
                            for (int i18 = 0; i18 < size2; i18++) {
                                ...
                                l6Var.setBackground(i6.f0(i6.w0(null, i6.f18923i6, false), 2, -1));
                                linearLayout.addView(l6Var);
                                l6Var.setOnClickListener(new va(i18, view, atomicReference));
                            }
                        ...
                        org.telegram.ui.ActionBar.b2 b2Var6 = alertDialog$Builder6.f18435a;
                        b2Var6.R = string6;
                        if (isWebBrowserInAppEnabled2) {
                        ...
                        b2Var6.f18459a = Math.min(AndroidUtilities.dp(320.0f), (AndroidUtilities.displaySize.x * 85) / 100);
    ...
    public final View createView(Context context) {
        ...
        mutate2.setColorFilter(new PorterDuffColorFilter(getThemedColor(i6.f18962k7), mode));
        t3 t3Var = new t3(mutate, mutate2, 4);
        t3Var.f27123x = AndroidUtilities.dp(2.0f);
        this.d = t3Var;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        y51 y51Var;
        if (i10 == NotificationCenter.webBrowserSettingsUpdate && (y51Var = this.f30482a) != null) {
            y51Var.Y2.N(true);
        }
    }
