...
public final class l0 extends WebViewClient {
    public boolean f42621a = true;
    public final k0 f42622b = new k0(this, 0);
    public final boolean f42623c;
    public final Context d;
    public final x0 f42624e;
    ...
    public final void doUpdateVisitedHistory(WebView webView, String str, boolean z4) {
        b1 b1Var;
        boolean z10 = this.f42623c;
        x0 x0Var = this.f42624e;
        if (!z10 && ((b1Var = x0Var.f42760e) == null || !TextUtils.equals(b1Var.f42511c, str))) {
            ?? tLObject = new TLObject();
            x0Var.f42760e = tLObject;
            tLObject.f42509a = Utilities.fastRandom.nextLong();
            x0Var.f42760e.f42510b = System.currentTimeMillis();
            x0Var.f42760e.f42511c = a1.s(x0Var.getUrl());
            x0Var.f42760e.d = l2.a(x0Var);
            c1.c(x0Var.f42760e);
        }
    ...
    public final void onReceivedError(WebView webView, WebResourceRequest webResourceRequest, WebResourceError webResourceError) {
        if (Build.VERSION.SDK_INT >= 23) {
            ...
            if (x0Var.N != null && (webResourceRequest == null || webResourceRequest.isForMainFrame())) {
                AndroidUtilities.cancelRunOnUIThread(this.f42622b);
                x0Var.f42763r = null;
                x0Var.f42764s = false;
                x0Var.v = false;
                x0Var.J = false;
                x0Var.G = false;
                x0Var.f42762n = (webResourceRequest == null || webResourceRequest.getUrl() == null) ? x0Var.getUrl() : webResourceRequest.getUrl().toString();
                a1 a1Var = x0Var.N;
                x0Var.H = null;
                a1Var.E();
                a1 a1Var2 = x0Var.N;
    ...
    public final boolean onRenderProcessGone(WebView webView, RenderProcessGoneDetail renderProcessGoneDetail) {
        ...
        try {
            ...
            alertDialog$Builder.f21166a.Q = AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.ChromeCrashMessage), new k0(this, 2));
            alertDialog$Builder.k(LocaleController.getString(R.string.OK), null);
            alertDialog$Builder.f21166a.setOnDismissListener(new fg.d0(this, 9));
    ...
    public final WebResourceResponse shouldInterceptRequest(WebView webView, WebResourceRequest webResourceRequest) {
        ...
        if (!this.f42623c && x0Var.f42761f != null && this.f42621a) {
            try {
    ...
    public final boolean shouldOverrideUrlLoading(WebView webView, String str) {
        ...
        if (str != null && !str.trim().startsWith("sms:")) {
            ...
            x0 x0Var = this.f42624e;
            if (startsWith) {
                if (x0Var.f42761f != null) {
                    f0 f0Var2 = x0Var.N.f42469c;
                    if (f0Var2 != null) {
                        f0Var2.j();
                    } else {
                ...
                if (z4 || !"1".equals(parse.getQueryParameter("embed")) || !"t.me".equals(parse.getAuthority())) {
                    if (MessagesController.getInstance(x0Var.N.J).webAppAllowedProtocols != null && MessagesController.getInstance(x0Var.N.J).webAppAllowedProtocols.contains(parse.getScheme())) {
                        if (x0Var.f42761f != null) {
                            ...
                            a1 a1Var = x0Var.f42761f.N;
                            if (a1Var != null && (f0Var = a1Var.f42469c) != null) {
                                f0Var.b();
                            }
                        }
                        a1 a1Var2 = x0Var.N;
                        a1Var2.D(parse, null, !a1Var2.f42481l0, false, false);
                    }
