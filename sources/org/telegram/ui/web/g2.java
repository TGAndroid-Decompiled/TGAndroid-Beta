...
public final class g2 {
    ...
    public static HashMap f39508f;
    public String f39509a;
    public com.google.firebase.messaging.r f39510b;
    public TLRPC.TL_webPage f39511c;
    ...
    public static void g(f2 f2Var, ImageReceiver imageReceiver, Runnable runnable) {
        ...
        String str;
        Bitmap decodeStream;
        if (f2Var != null && (g2Var = f2Var.f39498a) != null) {
            HashMap hashMap = g2Var.d;
            try {
                if (g2Var.f39510b != null) {
                    Iterator it = f2Var.f39500c.iterator();
                    i1Var = null;
                    while (it.hasNext()) {
                        i1Var = (i1) ((HashMap) g2Var.f39510b.d).get((String) it.next());
                        if (i1Var != null) {
                            break;
                        }
                    }
                ...
                if (i1Var != null) {
                    ...
                    if (f2Var.d <= 0 || f2Var.e <= 0) {
                        ...
                        if (i10 == 0 && f2Var.e == 0) {
                            ...
                            f2Var.e = (int) ((options.outHeight / options.outWidth) * i10);
                        }
                        runnable.run();
                    }
                    decodeStream = BitmapFactory.decodeStream(i1Var.a());
                    imageReceiver.setImageBitmap(decodeStream);
                } else if (hashMap.containsKey(f2Var.f39499b)) {
                    imageReceiver.setImageBitmap((Bitmap) hashMap.get(f2Var.f39499b));
                } else {
                    if (f39508f == null) {
                        f39508f = new HashMap();
                    }
                    ArrayList arrayList = (ArrayList) f39508f.get(f2Var.f39499b);
                    if (arrayList != null) {
                    ...
                    f39508f.put(f2Var.f39499b, new ArrayList());
                    new f1(new u1(1, g2Var, f2Var)).execute(f2Var.f39499b);
                }
            } catch (Exception e6) {
                FileLog.e(e6);
            }
            ...
            if (tL_webPage != null && (page = tL_webPage.cached_page) != null && (arrayList = page.photos) != null) {
                ...
                while (i10 < size) {
                    ...
                    if (photo2 instanceof f2) {
                        f2 f2Var = (f2) photo2;
                        HashMap hashMap3 = f39508f;
                        if (hashMap3 != null) {
                            hashMap3.remove(f2Var.f39499b);
                        }
                    }
                }
            }
    ...
    public final TL_iv.pageBlockPhoto h(JSONObject jSONObject, TL_iv.TL_page tL_page) {
        ...
        f2 f2Var = new f2();
        f2Var.f39498a = this;
        f2Var.f19208id = (-1) - tL_page.photos.size();
        f2Var.f39499b = optString2;
        f2Var.f39500c.add(optString2);
        try {
        ...
        pageblockphoto.photo_id = f2Var.f19208id;
                        ...
                        if (pageblockphoto2 == null) {
                            ...
                            while (true) {
                                if (i12 < tL_page.photos.size()) {
                                    if ((tL_page.photos.get(i12) instanceof f2) && tL_page.photos.get(i12).f19208id == pageblockphoto2.photo_id) {
                            ...
                            if (f2Var != null) {
                                f2Var.f39500c.addAll(arrayList2);
                            }
                ...
                switch (c3) {
                    ...
                    case 7:
                        ...
                        if (optString3 != null) {
                            ...
                            f2Var.f39498a = this;
                            f2Var.f19208id = (-1) - tL_page.photos.size();
                            f2Var.f39499b = optString3;
                            f2Var.f39500c.add(optString3);
                            try {
                                f2Var.d = Integer.parseInt(jSONObject.optString("width"));
                            } catch (Exception unused) {
                            }
                            ...
                            try {
                                textimage.f19406w = Integer.parseInt(jSONObject.optString("width"));
                            ...
                            if (textimage.f19406w == 0) {
                                textimage.f19406w = textimage.h;
                            }
                            if (textimage.h == 0) {
                                textimage.h = textimage.f19406w;
                            }
                            textimage.photo_id = f2Var.f19208id;
