...
public final class u1 {
    public final m6 f39100a;
    public final m6 f39101b;
    public final c6 f39102c;
    public int d;
    public boolean e;
    public int f39103f;
    public final Drawable f39104g;
    ...
    public u1(org.telegram.ui.k0 k0Var) {
        ...
        this.f39101b = m6Var2;
        this.f39102c = new c6(k0Var, 0L, 300L, qr.h);
        this.e = false;
        m6Var.E = true;
        ...
        m6Var2.G = 9999999;
        this.f39104g = k0Var.getContext().getResources().getDrawable(R.drawable.warning_sign).mutate();
    }

    public final void a(Canvas canvas, float f7, float f10, float f11) {
        org.telegram.ui.k0 k0Var = this.h;
        RectF rectF = k0Var.f39110a;
        rectF.set(0.0f, 0.0f, f7, f10);
        canvas.saveLayerAlpha(rectF, (int) (f11 * 255.0f), 31);
        m6 m6Var = this.f39100a;
        float g10 = m6Var.g();
        m6 m6Var2 = this.f39101b;
        float g11 = m6Var2.g();
        TextPaint textPaint = m6Var2.f26084a;
        float f12 = g11 * g10;
        canvas.save();
        float f13 = 0.82f * f10;
        ...
        m6Var2.r(i0.a.d(e, this.d, i6.w0(null, i6.f19071q7, false)));
        if (e > 0.0f) {
            int i10 = this.f39103f;
            int color = textPaint.getColor();
            Drawable drawable = this.f39104g;
            if (i10 != color) {
        ...
        k0Var.f39132r0.b(canvas, rectF, 2, 1.0f);
        canvas.restore();
    }
}
