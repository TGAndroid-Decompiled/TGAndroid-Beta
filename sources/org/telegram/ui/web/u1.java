...
public final class u1 {
    public final m6 f38944a;
    public final m6 f38945b;
    public final c6 f38946c;
    public int d;
    public boolean e;
    public int f38947f;
    public final Drawable f38948g;
    ...
    public u1(org.telegram.ui.k0 k0Var) {
        ...
        this.f38945b = m6Var2;
        this.f38946c = new c6(k0Var, 0L, 300L, qr.h);
        this.e = false;
        m6Var.E = true;
        ...
        m6Var2.G = 9999999;
        this.f38948g = k0Var.getContext().getResources().getDrawable(R.drawable.warning_sign).mutate();
    }

    public final void a(Canvas canvas, float f7, float f10, float f11) {
        org.telegram.ui.k0 k0Var = this.h;
        RectF rectF = k0Var.f38954a;
        rectF.set(0.0f, 0.0f, f7, f10);
        canvas.saveLayerAlpha(rectF, (int) (f11 * 255.0f), 31);
        m6 m6Var = this.f38944a;
        float g10 = m6Var.g();
        m6 m6Var2 = this.f38945b;
        float g11 = m6Var2.g();
        TextPaint textPaint = m6Var2.f26069a;
        float f12 = g11 * g10;
        canvas.save();
        float f13 = 0.82f * f10;
        ...
        m6Var2.r(i0.a.d(e, this.d, j6.w0(null, j6.f19101q7, false)));
        if (e > 0.0f) {
            int i10 = this.f38947f;
            int color = textPaint.getColor();
            Drawable drawable = this.f38948g;
            if (i10 != color) {
        ...
        k0Var.f38976r0.b(canvas, rectF, 2, 1.0f);
        canvas.restore();
    }
}
