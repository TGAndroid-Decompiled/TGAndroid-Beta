...
public final class u1 {
    public final o6 f39213a;
    public final o6 f39214b;
    public final e6 f39215c;
    public int d;
    public boolean e;
    public int f39216f;
    public final Drawable f39217g;
    ...
    public u1(org.telegram.ui.l0 l0Var) {
        ...
        this.f39214b = o6Var2;
        this.f39215c = new e6(l0Var, 0L, 300L, sr.h);
        this.e = false;
        o6Var.E = true;
        ...
        o6Var2.G = 9999999;
        this.f39217g = l0Var.getContext().getResources().getDrawable(R.drawable.warning_sign).mutate();
    }

    public final void a(Canvas canvas, float f7, float f10, float f11) {
        org.telegram.ui.l0 l0Var = this.h;
        RectF rectF = l0Var.f39225a;
        rectF.set(0.0f, 0.0f, f7, f10);
        canvas.saveLayerAlpha(rectF, (int) (f11 * 255.0f), 31);
        o6 o6Var = this.f39213a;
        float g10 = o6Var.g();
        o6 o6Var2 = this.f39214b;
        float g11 = o6Var2.g();
        TextPaint textPaint = o6Var2.f26961a;
        float f12 = g11 * g10;
        canvas.save();
        float f13 = 0.82f * f10;
        ...
        if (e > 0.0f) {
            ...
            Drawable drawable = this.f39217g;
            if (i10 != color) {
        ...
        l0Var.f39247r0.b(canvas, rectF, 2, 1.0f);
        canvas.restore();
    }
}
