...
public final class u1 {
    public final o6 f39199a;
    public final o6 f39200b;
    public final e6 f39201c;
    public int d;
    public boolean e;
    public int f39202f;
    public final Drawable f39203g;
    ...
    public u1(org.telegram.ui.l0 l0Var) {
        ...
        this.f39200b = o6Var2;
        this.f39201c = new e6(l0Var, 0L, 300L, rr.h);
        this.e = false;
        o6Var.E = true;
        ...
        o6Var2.G = 9999999;
        this.f39203g = l0Var.getContext().getResources().getDrawable(R.drawable.warning_sign).mutate();
    }

    public final void a(Canvas canvas, float f7, float f10, float f11) {
        org.telegram.ui.l0 l0Var = this.h;
        RectF rectF = l0Var.f39211a;
        rectF.set(0.0f, 0.0f, f7, f10);
        canvas.saveLayerAlpha(rectF, (int) (f11 * 255.0f), 31);
        o6 o6Var = this.f39199a;
        float g10 = o6Var.g();
        o6 o6Var2 = this.f39200b;
        float g11 = o6Var2.g();
        TextPaint textPaint = o6Var2.f26924a;
        float f12 = g11 * g10;
        canvas.save();
        float f13 = 0.82f * f10;
        ...
        o6Var2.r(i0.a.d(e, this.d, h6.w0(null, h6.f19284q7, false)));
        if (e > 0.0f) {
            int i10 = this.f39202f;
            int color = textPaint.getColor();
            Drawable drawable = this.f39203g;
            if (i10 != color) {
        ...
        l0Var.f39233r0.b(canvas, rectF, 2, 1.0f);
        canvas.restore();
    }
}
