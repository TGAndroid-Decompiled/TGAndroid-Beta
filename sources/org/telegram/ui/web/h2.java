...
public final class h2 {
    ...
    public static HashMap f38721f;
    public String f38722a;
    public ni.f f38723b;
    public TLRPC.TL_webPage f38724c;
    ...
    public static void g(g2 g2Var, ImageReceiver imageReceiver, Runnable runnable) {
        ...
        String str;
        Bitmap decodeStream;
        if (g2Var != null && (h2Var = g2Var.f38706a) != null) {
            HashMap hashMap = h2Var.d;
            try {
                if (h2Var.f38723b != null) {
                    Iterator it = g2Var.f38708c.iterator();
                    k1Var = null;
                    while (it.hasNext()) {
                        k1Var = (k1) ((HashMap) h2Var.f38723b.f15234c).get((String) it.next());
                        if (k1Var != null) {
                            break;
                        }
                    }
                ...
                if (k1Var != null) {
                ...
                } else if (hashMap.containsKey(g2Var.f38707b)) {
                    imageReceiver.setImageBitmap((Bitmap) hashMap.get(g2Var.f38707b));
                } else {
                    if (f38721f == null) {
                        f38721f = new HashMap();
                    }
                    ArrayList arrayList = (ArrayList) f38721f.get(g2Var.f38707b);
                    if (arrayList != null) {
                    ...
                    f38721f.put(g2Var.f38707b, new ArrayList());
                    new h1(new dt(21, h2Var, g2Var)).execute(g2Var.f38707b);
                }
            } catch (Exception e7) {
                FileLog.e(e7);
            }
            ...
            if (tL_webPage != null && (page = tL_webPage.cached_page) != null && (arrayList = page.photos) != null) {
                ...
                while (i10 < size) {
                    ...
                    if (photo2 instanceof g2) {
                        g2 g2Var = (g2) photo2;
                        HashMap hashMap3 = f38721f;
                        if (hashMap3 != null) {
                            hashMap3.remove(g2Var.f38707b);
                        }
                    }
                }
            }
    ...
    public final TL_iv.pageBlockPhoto h(JSONObject jSONObject, TL_iv.TL_page tL_page) {
        ...
        g2 g2Var = new g2();
        g2Var.f38706a = this;
        g2Var.f18107id = (-1) - tL_page.photos.size();
        g2Var.f38707b = optString2;
        g2Var.f38708c.add(optString2);
        try {
        ...
        pageblockphoto.photo_id = g2Var.f18107id;
                        ...
                        if (pageblockphoto2 == null) {
                            ...
                            while (true) {
                                if (i12 < tL_page.photos.size()) {
                                    if ((tL_page.photos.get(i12) instanceof g2) && tL_page.photos.get(i12).f18107id == pageblockphoto2.photo_id) {
                            ...
                            if (g2Var != null) {
                                g2Var.f38708c.addAll(arrayList2);
                            }
                ...
                switch (c10) {
                    ...
                    case 7:
                        ...
                        if (optString3 != null) {
                            ...
                            g2Var.f38706a = this;
                            g2Var.f18107id = (-1) - tL_page.photos.size();
                            g2Var.f38707b = optString3;
                            g2Var.f38708c.add(optString3);
                            try {
                                g2Var.d = Integer.parseInt(jSONObject.optString("width"));
                            } catch (Exception unused) {
                            }
                            ...
                            try {
                                textimage.f18305w = Integer.parseInt(jSONObject.optString("width"));
                            ...
                            if (textimage.f18305w == 0) {
                                textimage.f18305w = textimage.h;
                            }
                            if (textimage.h == 0) {
                                textimage.h = textimage.f18305w;
                            }
                            textimage.photo_id = g2Var.f18107id;
