...
public final class d2 extends WebViewClient {
    ...
    public final InputStream f38930c;
    public final i2 d;
    ...
    public final WebResourceResponse shouldInterceptRequest(WebView webView, String str) {
        ...
        if (str != null && str.endsWith("/index.html")) {
            ...
            if (this.f38929b) {
                ni.f fVar = i2Var.f38987b;
                if (fVar != null) {
                    l1Var2 = (l1) ((ArrayList) fVar.f15258b).get(0);
                } else {
                    l1Var2 = null;
                }
                if (l1Var2 == null) {
            ...
            ni.f fVar2 = i2Var.f38987b;
            if (fVar2 != null) {
                l1Var = (l1) ((HashMap) fVar2.f15259c).get(str);
            } else {
                l1Var = null;
            }
            if (l1Var == null) {
            ...
            m1 m1Var = (m1) l1Var.f39020a.get("content-type");
            if (m1Var == null) {
                str2 = null;
            } else {
                str2 = m1Var.f39027a;
