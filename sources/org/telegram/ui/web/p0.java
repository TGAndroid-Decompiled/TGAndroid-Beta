...
public final class p0 implements q0.a {
    ...
    public final w0 f39057b;
    public final PermissionRequest f39058c;
    public final String[] d;

    public p0(w0 w0Var, PermissionRequest permissionRequest, String[] strArr, int i10) {
        this.f39056a = i10;
        this.f39057b = w0Var;
        this.f39058c = permissionRequest;
        this.d = strArr;
    }
    ...
    public final void accept(Object obj) {
        ...
        switch (this.f39056a) {
            case 0:
                w0 w0Var = this.f39057b;
                if (w0Var.f39145a != null) {
                    w0Var.f39145a = null;
                    boolean booleanValue = bool.booleanValue();
                    PermissionRequest permissionRequest = this.f39058c;
                    if (booleanValue) {
                ...
                return;
            default:
                w0 w0Var2 = this.f39057b;
                w0Var2.getClass();
                boolean booleanValue2 = bool.booleanValue();
                PermissionRequest permissionRequest2 = this.f39058c;
                if (booleanValue2) {
