...
public final class n2 {
    ...
    public final m2 a(String str) {
        c();
        m2 m2Var = (m2) this.f39142a.get(str);
        if (m2Var == null) {
            return null;
        }
        m2Var.f39132a = Math.max(m2Var.f39132a, System.currentTimeMillis());
        d();
        return m2Var;
    }

    public final void c() {
        if (!this.f39143b && !this.f39144c) {
            this.f39144c = true;
            if (this.f39142a == null) {
                this.f39142a = new HashMap();
            }
