...
public final class s1 {
    public final j6 f42688a;
    public final j6 f42689b;
    public final z5 f42690c;
    public int d;
    public boolean f42691e;
    public int f42692f;
    public final Drawable f42693g;
    ...
    public s1(org.telegram.ui.m0 m0Var) {
        ...
        this.f42689b = j6Var2;
        this.f42690c = new z5(m0Var, 0L, 300L, pr.h);
        this.f42691e = false;
        j6Var.E = true;
        ...
        j6Var2.G = 9999999;
        this.f42693g = m0Var.getContext().getResources().getDrawable(R.drawable.warning_sign).mutate();
    }

    public final void a(Canvas canvas, float f10, float f11, float f12) {
        org.telegram.ui.m0 m0Var = this.h;
        RectF rectF = m0Var.f42699a;
        rectF.set(0.0f, 0.0f, f10, f11);
        canvas.saveLayerAlpha(rectF, (int) (f12 * 255.0f), 31);
        j6 j6Var = this.f42688a;
        float g10 = j6Var.g();
        j6 j6Var2 = this.f42689b;
        float g11 = j6Var2.g();
        TextPaint textPaint = j6Var2.f28028a;
        float f13 = g11 * g10;
        canvas.save();
        float f14 = 0.82f * f11;
        ...
        j6Var.draw(canvas);
        canvas.restore();
        float e6 = this.f42690c.e(this.f42691e);
        canvas.save();
        ...
        j6Var2.r(i0.a.d(e6, this.d, k6.w0(null, k6.f21895q7, false)));
        if (e6 > 0.0f) {
            int i10 = this.f42692f;
            int color = textPaint.getColor();
            Drawable drawable = this.f42693g;
            if (i10 != color) {
        ...
        m0Var.f42718o0.b(canvas, rectF, 2, 1.0f);
        canvas.restore();
    }
}
