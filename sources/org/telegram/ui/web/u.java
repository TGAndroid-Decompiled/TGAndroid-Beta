    ...
    public final void run() {
        ...
        switch (this.f42277a) {
            case 0:
                ...
                return;
            case 1:
                d1 d1Var = this.f42278b;
                k9 k9Var = d1Var.I0;
                fi.w0 w0Var = d1Var.f42078k0;
                w0Var.getClass();
                ...
                return;
            default:
                d1 d1Var2 = this.f42278b;
                if (d1Var2.S) {
                    d1Var2.S = false;
                    i0 i0Var2 = d1Var2.f42067c;
                    if (i0Var2 != null) {
                        i0Var2.t(false);
                    }
                }
                ...
                d1Var2.P = 0L;
                d1Var2.T = false;
                z0 z0Var = d1Var2.f42063a;
                if (z0Var != null) {
                    z0Var.onResume();
                    d1Var2.f42063a.reload();
                    return;
                }
                return;
        }
