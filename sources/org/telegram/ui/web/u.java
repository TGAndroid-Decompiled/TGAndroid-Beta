...
public final class u implements Utilities.Callback2 {
    ...
    public final b1 f38841b;
    public final da f38842c;
    ...
    public final void run(Object obj, Object obj2) {
        ...
        String str = this.d;
        da daVar = this.f38842c;
        b1 b1Var = this.f38841b;
        switch (i11) {
            case 0:
                TLRPC.TL_error tL_error = (TLRPC.TL_error) obj2;
                b1 b1Var2 = this.f38841b;
                d6 d6Var = b1Var2.e;
                ...
                if (tL_buttonTypeRequestPeer != null) {
                    ...
                    if (requestPeerType instanceof TLRPC.TL_requestPeerTypeCreateBot) {
                        ...
                        e.putLong("requestPeerBotId", b1Var2.U.f18230id);
                        try {
