...
public final class b2 implements Utilities.Callback {
    ...
    public final Timer.Task f42042b;
    public final boolean[] f42043c;
    public final Timer d;
    public final j2 f42044e;
    public final Utilities.Callback f42045f;
    ...
    public final void run(Object obj) {
        switch (this.f42041a) {
            case 0:
                Timer.Task task = this.f42042b;
                boolean[] zArr = this.f42043c;
                Timer timer = this.d;
                j2 j2Var = this.f42044e;
                Utilities.Callback callback = this.f42045f;
                InputStream inputStream = (InputStream) obj;
                Timer.done(task);
                if (!zArr[0]) {
                    Timer.Task start = Timer.start(timer, "readHTML");
                    String str = j2Var.f42172a;
                ...
                return;
            default:
                Timer.Task task2 = this.f42042b;
                boolean[] zArr3 = this.f42043c;
                Timer timer2 = this.d;
                j2 j2Var2 = this.f42044e;
                Utilities.Callback callback2 = this.f42045f;
                JSONObject jSONObject = (JSONObject) obj;
                Timer.done(task2);
                if (!zArr3[0]) {
                    Timer.Task start2 = Timer.start(timer2, "parseJSON");
                    try {
                        j2Var2.f42174c = j2Var2.i(j2Var2.f42172a, jSONObject);
                    } catch (Exception e7) {
                    ...
                    TLRPC.TL_webPage tL_webPage = j2Var2.f42174c;
                    if (tL_webPage != null) {
                        j2.f42170e.put(tL_webPage, j2Var2);
                    }
                    Timer.finish(timer2);
                    return;
                }
