...
public final class b2 implements Utilities.Callback {
    ...
    public final Timer.Task f42014b;
    public final boolean[] f42015c;
    public final Timer d;
    public final j2 f42016e;
    public final Utilities.Callback f42017f;
    ...
    public final void run(Object obj) {
        switch (this.f42013a) {
            case 0:
                Timer.Task task = this.f42014b;
                boolean[] zArr = this.f42015c;
                Timer timer = this.d;
                j2 j2Var = this.f42016e;
                Utilities.Callback callback = this.f42017f;
                InputStream inputStream = (InputStream) obj;
                Timer.done(task);
                if (!zArr[0]) {
                    Timer.Task start = Timer.start(timer, "readHTML");
                    String str = j2Var.f42144a;
                ...
                return;
            default:
                Timer.Task task2 = this.f42014b;
                boolean[] zArr3 = this.f42015c;
                Timer timer2 = this.d;
                j2 j2Var2 = this.f42016e;
                Utilities.Callback callback2 = this.f42017f;
                JSONObject jSONObject = (JSONObject) obj;
                Timer.done(task2);
                if (!zArr3[0]) {
                    Timer.Task start2 = Timer.start(timer2, "parseJSON");
                    try {
                        j2Var2.f42146c = j2Var2.i(j2Var2.f42144a, jSONObject);
                    } catch (Exception e7) {
                    ...
                    TLRPC.TL_webPage tL_webPage = j2Var2.f42146c;
                    if (tL_webPage != null) {
                        j2.f42142e.put(tL_webPage, j2Var2);
                    }
                    Timer.finish(timer2);
                    return;
                }
