...
public final class t1 {
    public final o6 f38835a;
    public final o6 f38836b;
    public final e6 f38837c;
    public int d;
    public boolean e;
    public int f38838f;
    public final Drawable f38839g;
    ...
    public t1(org.telegram.ui.l0 l0Var) {
        ...
        this.f38836b = o6Var2;
        this.f38837c = new e6(l0Var, 0L, 300L, rr.h);
        this.e = false;
        o6Var.E = true;
        ...
        o6Var2.G = 9999999;
        this.f38839g = l0Var.getContext().getResources().getDrawable(R.drawable.warning_sign).mutate();
    }

    public final void a(Canvas canvas, float f7, float f10, float f11) {
        org.telegram.ui.l0 l0Var = this.h;
        RectF rectF = l0Var.f38845a;
        rectF.set(0.0f, 0.0f, f7, f10);
        canvas.saveLayerAlpha(rectF, (int) (f11 * 255.0f), 31);
        o6 o6Var = this.f38835a;
        float g10 = o6Var.g();
        o6 o6Var2 = this.f38836b;
        float g11 = o6Var2.g();
        TextPaint textPaint = o6Var2.f26613a;
        float f12 = g11 * g10;
        canvas.save();
        float f13 = 0.82f * f10;
        ...
        o6Var2.r(i0.a.d(e, this.d, h6.w0(null, h6.f19026q7, false)));
        if (e > 0.0f) {
            int i10 = this.f38838f;
            int color = textPaint.getColor();
            Drawable drawable = this.f38839g;
            if (i10 != color) {
        ...
        l0Var.f38867r0.b(canvas, rectF, 2, 1.0f);
        canvas.restore();
    }
}
