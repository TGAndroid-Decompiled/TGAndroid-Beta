...
public final class hd0 extends FrameLayout {
    public final HashMap f34243a;
    public final kd0 f34244b;

    public hd0(kd0 kd0Var, Context context) {
        super(context);
        this.f34244b = kd0Var;
        this.f34243a = new HashMap();
    }

    public final void a() {
        IMapsProvider.IMap iMap = this.f34244b.I;
        if (iMap != null) {
            IMapsProvider.IProjection projection = iMap.getProjection();
            for (Map.Entry entry : this.f34243a.entrySet()) {
