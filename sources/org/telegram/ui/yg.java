...
public final class yg implements Runnable {
    ...
    public final bo f39880b;
    public final org.telegram.ui.ActionBar.c2[] f39881c;
    public final int d;

    public yg(bo boVar, org.telegram.ui.ActionBar.c2[] c2VarArr, int i10, int i11) {
        this.f39879a = i11;
        this.f39880b = boVar;
        this.f39881c = c2VarArr;
        this.d = i10;
    }
    ...
    public final void run() {
        switch (this.f39879a) {
            case 0:
                org.telegram.ui.ActionBar.c2[] c2VarArr = this.f39881c;
                org.telegram.ui.ActionBar.c2 c2Var = c2VarArr[0];
                if (c2Var != null) {
                    final bo boVar = this.f39880b;
                ...
                return;
            case 1:
                org.telegram.ui.ActionBar.c2[] c2VarArr2 = this.f39881c;
                org.telegram.ui.ActionBar.c2 c2Var2 = c2VarArr2[0];
                if (c2Var2 != null) {
                    final bo boVar2 = this.f39880b;
                ...
                return;
            default:
                org.telegram.ui.ActionBar.c2[] c2VarArr3 = this.f39881c;
                org.telegram.ui.ActionBar.c2 c2Var3 = c2VarArr3[0];
                if (c2Var3 != null) {
                    final bo boVar3 = this.f39880b;
