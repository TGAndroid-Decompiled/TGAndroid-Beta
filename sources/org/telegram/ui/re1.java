...
public final class re1 extends org.telegram.ui.Components.ul0 {
    ...
    public final boolean D(s4.c1 c1Var) {
        if (c1Var.b() >= this.f37137f && c1Var.b() < this.h) {
            return true;
        }
        return false;
    }
    ...
    public final void E() {
        ...
        this.f37136c = 2;
        this.d = 1;
        ArrayList arrayList = this.f37139r.f38072f;
        if (!arrayList.isEmpty()) {
            int i10 = this.f37136c;
            int i11 = i10 + 1;
            this.e = i10;
            int i12 = i10 + 2;
            this.f37136c = i12;
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (j(i10) == 4) {
            ...
            TLRPC.Chat chat = (TLRPC.Chat) ue1Var.f38072f.get(i10 - this.f37137f);
            String str = (String) ue1Var.h.get(i10 - this.f37137f);
            ...
            h4Var.c(ue1Var.f38076w.contains(Long.valueOf(chat.f18328id)), false);
        }
    }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 != 1) {
            if (i10 != 2) {
                ...
                org.telegram.ui.Components.pq pqVar = new org.telegram.ui.Components.pq(new ColorDrawable(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19038a7, false)), org.telegram.ui.ActionBar.j6.V0(viewGroup.getContext(), R.drawable.greydivider, org.telegram.ui.ActionBar.j6.f19058b7));
                pqVar.f27426w = true;
            ...
            ue1Var.f38077x.setMessageText(string);
            ...
            ue1Var.f38077x.setLayoutParams(p0Var);
            n4Var = frameLayout;
        }
