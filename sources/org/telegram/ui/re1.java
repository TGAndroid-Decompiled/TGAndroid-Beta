...
public final class re1 extends org.telegram.ui.Components.ll0 {
    ...
    public final boolean D(s4.c1 c1Var) {
        if (c1Var.b() >= this.f37210f && c1Var.b() < this.h) {
            return true;
        }
        return false;
    }
    ...
    public final void E() {
        ...
        this.f37209c = 2;
        this.d = 1;
        ArrayList arrayList = this.f37212r.f38055f;
        if (!arrayList.isEmpty()) {
            int i10 = this.f37209c;
            int i11 = i10 + 1;
            this.e = i10;
            int i12 = i10 + 2;
            this.f37209c = i12;
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (j(i10) == 4) {
            ...
            TLRPC.Chat chat = (TLRPC.Chat) ue1Var.f38055f.get(i10 - this.f37210f);
            String str = (String) ue1Var.h.get(i10 - this.f37210f);
            ...
            f4Var.c(ue1Var.f38059w.contains(Long.valueOf(chat.f18121id)), false);
        }
    }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 != 1) {
            if (i10 != 2) {
                ...
                org.telegram.ui.Components.pq pqVar = new org.telegram.ui.Components.pq(new ColorDrawable(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18806a7, false)), org.telegram.ui.ActionBar.j6.V0(viewGroup.getContext(), R.drawable.greydivider, org.telegram.ui.ActionBar.j6.f18826b7));
                pqVar.f27113w = true;
            ...
            ue1Var.f38060x.setMessageText(string);
            ...
            ue1Var.f38060x.setLayoutParams(p0Var);
            l4Var = frameLayout;
        }
