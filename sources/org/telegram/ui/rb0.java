...
public final class rb0 extends org.telegram.ui.ActionBar.m2 {
    ...
    public org.telegram.ui.Components.ew0 f37271c;
    public org.telegram.ui.Components.ew0 d;
    public TLRPC.TL_chatInviteExported e;
    public ob0 f37272f;
    public org.telegram.ui.Cells.e9 h;
    public org.telegram.ui.Cells.w8 f37273n;
    public pb0 f37274r;
    public TextView f37275s;
    public org.telegram.ui.Cells.e9 v;
    public TextView f37276w;
    public org.telegram.ui.Cells.m4 f37277x;
    public org.telegram.ui.Cells.e9 f37278y;
    ...
    public final void V(int i10) {
        int[] iArr;
        long j3 = i10;
        this.f37276w.setText(LocaleController.formatDateAudio(j3, false));
    ...
    public final void W(int i10) {
        ...
        this.f37271c.b(i13, null, strArr);
    }
    ...
    public final void X() {
        ...
        while (true) {
            ...
            if (i10 < iArr.length) {
                ...
                this.f37271c.b(3, null, "1", "10", "100", LocaleController.getString(R.string.NoLimit));
                return;
            }
        }
    }
    ...
    public final void Y(TLRPC.TL_chatInviteExported tL_chatInviteExported) {
        ...
        if (this.fragmentView != null && tL_chatInviteExported != null) {
            ...
            ob0 ob0Var = this.f37272f;
            if (ob0Var != null) {
                ob0Var.setBackgroundColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19045d6, false));
                this.f37272f.setChecked(tL_chatInviteExported.request_needed);
            }
            boolean z10 = true;
            ...
            org.telegram.ui.Cells.w8 w8Var = this.f37273n;
            if (w8Var != null) {
            ...
            if (tL_chatInviteExported.subscription_pricing != null) {
                ob0 ob0Var2 = this.f37272f;
                if (ob0Var2 != null) {
                    ob0Var2.setChecked(false);
                    this.f37272f.setCheckBoxIcon(R.drawable.permission_locked);
                }
            ...
            if (pb0Var != null) {
                ...
                this.f37274r.setText(Long.toString(tL_chatInviteExported.subscription_pricing.amount));
                this.f37274r.f20477b.setClickable(false);
                this.f37274r.f20477b.setFocusable(false);
                this.f37274r.f20477b.setFocusableInTouchMode(false);
                this.f37274r.f20477b.setLongClickable(false);
            }
        }
    }
    ...
    public final void Z(boolean z10) {
        ...
        org.telegram.ui.Components.ew0 ew0Var = this.f37271c;
        if (z10) {
            i11 = 0;
        } else {
            i11 = 8;
    ...
    public final View createView(Context context) {
        ...
        mb0Var.addView(this.f37277x);
        org.telegram.ui.Components.ew0 ew0Var = new org.telegram.ui.Components.ew0(context, null);
        this.d = ew0Var;
        mb0Var.addView(ew0Var);
        TextView textView2 = new TextView(context);
        this.f37276w = textView2;
        textView2.setPadding(AndroidUtilities.dp(22.0f), 0, AndroidUtilities.dp(22.0f), 0);
        this.f37276w.setGravity(16);
        this.f37276w.setTextSize(1, 16.0f);
        this.f37276w.setHint(LocaleController.getString(R.string.TimeLimitHint));
        this.f37276w.setOnClickListener(new ov(14, this, context));
        ...
        mb0Var.addView(this.f37276w, w7.y5.n(-1, 50));
        ...
        this.f37271c = ew0Var2;
        ew0Var2.setCallback(new hb0(this, 3));
        X();
        mb0Var.addView(this.f37271c);
        ...
        this.f37272f.setTag(Integer.valueOf(i13));
        this.f37272f.f(LocaleController.getString(R.string.ApproveNewMembers2), false, false);
        this.f37272f.setOnClickListener(new ai.j3(7, this, z10));
        mb0Var.addView(this.f37272f, w7.y5.n(-1, 56));
        ...
        if (chat == null || chat.username == null) {
            ...
            if ((this.e == null && ChatObject.isChannelAndNotMegaGroup(MessagesController.getInstance(this.currentAccount).getChat(Long.valueOf(j3))) && chatFull != null && chatFull.paid_media_allowed) || ((tL_chatInviteExported = this.e) != null && tL_chatInviteExported.subscription_pricing != null)) {
                ...
                this.f37273n.setDrawCheckRipple(true);
                this.f37273n.f(LocaleController.getString(R.string.RequireMonthlyFee), false, true);
                if (this.e != null) {
                    this.f37273n.setCheckBoxIcon(R.drawable.permission_locked);
                    this.f37273n.setEnabled(false);
                }
                this.f37273n.setOnClickListener(new ov(15, this, new Runnable[1]));
                mb0Var.addView(this.f37273n, w7.y5.n(-1, 48));
                TextView textView3 = new TextView(context);
                this.f37275s = textView3;
                textView3.setTextSize(1, 16.0f);
                this.f37275s.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.A6, false));
                ...
                this.f37274r = pb0Var;
                pb0Var.f20477b.setInputType(2);
                this.f37274r.f20477b.setRawInputType(2);
                this.f37274r.setBackgroundColor(getThemedColor(i13));
                pb0 pb0Var2 = this.f37274r;
                pb0Var2.getClass();
                org.telegram.ui.Cells.g gVar = new org.telegram.ui.Cells.g(pb0Var2, 4);
                org.telegram.ui.Cells.h3 h3Var = pb0Var2.f20477b;
                h3Var.setImeOptions(6);
                h3Var.setOnEditorActionListener(new m.s2(gVar, 2));
                this.f37274r.addView(this.f37275s, w7.y5.d(-2, -2.0f, 21, 0.0f, 0.0f, 19.0f, 0.0f));
                pb0 pb0Var3 = this.f37274r;
                ...
                org.telegram.ui.Cells.h3 h3Var2 = pb0Var3.f20477b;
                ...
                mb0Var.addView(this.f37274r, w7.y5.n(-1, 48));
                this.f37274r.setVisibility(8);
        ...
        if (i11 == 1) {
            ...
            this.I.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19265p7, false));
        ...
        this.H = frameLayout;
        int i16 = org.telegram.ui.ActionBar.h6.f18989a7;
        frameLayout.setBackgroundColor(getThemedColor(i16));
        new ci.i4(w8Var, false, new ai.i(17));
        w8Var.addView(this.H, w7.y5.e(-1, -2, 80));
        this.f37277x.setBackgroundColor(org.telegram.ui.ActionBar.h6.w0(null, i13, false));
        this.d.setBackgroundColor(org.telegram.ui.ActionBar.h6.w0(null, i13, false));
        this.f37276w.setBackgroundColor(org.telegram.ui.ActionBar.h6.w0(null, i13, false));
        this.E.setBackgroundColor(org.telegram.ui.ActionBar.h6.w0(null, i13, false));
        this.f37271c.setBackgroundColor(org.telegram.ui.ActionBar.h6.w0(null, i13, false));
        ...
        this.f37276w.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, i15, false));
        this.f37276w.setHintTextColor(org.telegram.ui.ActionBar.h6.w0(null, i14, false));
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f37277x, 0, new Class[]{org.telegram.ui.Cells.m4.class}, new String[]{"textView"}, null, null, -1, null, i10));
        ...
        org.telegram.ui.Cells.m4 m4Var = this.f37277x;
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f37271c, 1, null, null, null, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f37276w, 1, null, null, null, null, i11));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f37278y, 0, new Class[]{org.telegram.ui.Cells.e9.class}, new String[]{"textView"}, null, null, -1, null, i12));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(null, 0, null, null, null, eVar, org.telegram.ui.ActionBar.h6.f19428y6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(null, 0, null, null, null, eVar, org.telegram.ui.ActionBar.h6.Sh));
        arrayList.add(new org.telegram.ui.ActionBar.j6(null, 0, null, null, null, eVar, org.telegram.ui.ActionBar.h6.f19265p7));
        return arrayList;
    }
}
