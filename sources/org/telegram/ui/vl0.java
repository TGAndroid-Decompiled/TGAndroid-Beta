...
public final class vl0 extends FrameLayout {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        super.onDraw(canvas);
        if (this.f38648n) {
            Paint T0 = org.telegram.ui.ActionBar.i6.T0("paintDivider", this.f38645b);
            if (T0 == null) {
