...
public final class vl0 implements Utilities.Callback5, org.telegram.ui.Cells.w5, org.telegram.ui.Components.t61, org.telegram.ui.ActionBar.a2, org.telegram.ui.ActionBar.m1, r0.n, Utilities.Callback2Return, org.telegram.ui.Cells.z4, LanguageDetector.ExceptionCallback, RequestTimeDelegate, org.telegram.ui.ActionBar.m2, org.telegram.ui.Components.bl0, jg.e, hg.a2 {
    ...
    public r0.l1 T0(View view, r0.l1 l1Var) {
        ...
        switch (this.f41615a) {
            case 8:
                PremiumPreviewFragment premiumPreviewFragment = (PremiumPreviewFragment) this.f41616b;
                i0.c defaultWindowInsets = AndroidUtilities.getDefaultWindowInsets(l1Var, false);
                premiumPreviewFragment.f33816o0 = defaultWindowInsets;
                premiumPreviewFragment.f33797a.setPadding(0, defaultWindowInsets.f11452b, 0, AndroidUtilities.dp(48.0f) + premiumPreviewFragment.f33816o0.d);
                org.telegram.ui.Components.ll0 ll0Var = premiumPreviewFragment.f33797a;
                i0.c cVar = premiumPreviewFragment.f33816o0;
                AndroidUtilities.setViewLayoutMargins(ll0Var, cVar.f11451a, 0, cVar.f11453c, 0);
                jx0 jx0Var = premiumPreviewFragment.U;
                i0.c cVar2 = premiumPreviewFragment.f33816o0;
                jx0Var.setPadding(cVar2.f11451a, 0, cVar2.f11453c, 0);
                FrameLayout frameLayout = premiumPreviewFragment.J;
                if (frameLayout != null) {
                    int i12 = premiumPreviewFragment.f33816o0.f11451a;
                    int dp = AndroidUtilities.dp(14.0f);
                    i0.c cVar3 = premiumPreviewFragment.f33816o0;
                    frameLayout.setPadding(i12, dp, cVar3.f11453c, cVar3.d);
                }
                return r0.l1.f44738b;
            default:
                eh0 eh0Var = (eh0) ((bi1) this.f41616b);
                i0.c defaultWindowInsets2 = AndroidUtilities.getDefaultWindowInsets(l1Var, false);
                int i13 = defaultWindowInsets2.f11451a;
                eh0Var.M = i13;
                int i14 = defaultWindowInsets2.f11453c;
                eh0Var.N = i14;
                eh0Var.L = defaultWindowInsets2.d;
                View view2 = eh0Var.f36109y.f37805b;
                ...
                eh0Var.f36109y.setPadding(0, 0, 0, eh0Var.L);
                ...
                ViewGroup.MarginLayoutParams marginLayoutParams2 = (ViewGroup.MarginLayoutParams) eh0Var.f34843c.getLayoutParams();
                if (marginLayoutParams2.bottomMargin != i11 || marginLayoutParams2.leftMargin != i13 || marginLayoutParams2.rightMargin != i14) {
                    ...
                    eh0Var.f34843c.setLayoutParams(marginLayoutParams2);
                }
                eh0Var.E.setPadding(i13, 0, i14, eh0Var.L);
                if (z10) {
                    l1Var = l1Var.f44739a.m(0, 0, 0, eh0Var.L);
                }
                eh0Var.i0();
                eh0Var.h0();
                SparseArray sparseArray = eh0Var.f34841a;
                int size = sparseArray.size();
                for (int i15 = 0; i15 < size; i15++) {
                    zh1 zh1Var = (zh1) sparseArray.valueAt(i15);
                    if (zh1Var != null && (fragmentView = zh1Var.f43465a.getFragmentView()) != null) {
    ...
    public boolean a(int i10, View view) {
        switch (this.f41615a) {
            case 17:
                return ((w71) this.f41616b).Q(i10, view);
            case 18:
                final bb1 bb1Var = (bb1) this.f41616b;
                org.telegram.ui.ActionBar.b2[] b2VarArr = bb1Var.f34729h0;
                ga1 ga1Var = bb1Var.X;
                int i11 = ga1Var.I;
                if (i10 >= i11 && i10 <= ga1Var.J) {
                    final MessageObject messageObject = ((ya1) bb1Var.f34745v0.get(i10 - i11)).f43094b;
                        ...
                        public final void run() {
                            switch (r3) {
                                ...
                                default:
                                    ...
                                    bundle.putLong("chat_id", bb1Var3.f34719b);
                    ...
                    if (i10 >= i12 && i10 <= ga1Var.V) {
                        ((ua1) bb1Var.Q.get(i10 - i12)).c(bb1Var.f34717a, bb1Var, b2VarArr, true);
                    } else {
                        int i13 = ga1Var.R;
                        if (i10 >= i13 && i10 <= ga1Var.S) {
                            ((ua1) bb1Var.O.get(i10 - i13)).c(bb1Var.f34717a, bb1Var, b2VarArr, true);
                        } else {
                            int i14 = ga1Var.X;
                            if (i10 < i14 || i10 > ga1Var.Y) {
                                return false;
                            }
                            ((ua1) bb1Var.P.get(i10 - i14)).c(bb1Var.f34717a, bb1Var, b2VarArr, true);
                        }
                    }
                }
                return true;
            default:
                ((te1) this.f41616b).J.a(i10, view);
                return true;
        }
    }
    ...
    public void c(org.telegram.ui.Components.vz vzVar) {
        ...
        vzVar.f(new org.telegram.ui.Components.wz((MediaController.SavedFilterState) this.f41616b));
    }

    @Override
    public boolean d(org.telegram.ui.Cells.a5 a5Var, boolean z10) {
        gy0 gy0Var = (gy0) this.f41616b;
        if (z10) {
    ...
    public void f(int i10) {
        xh1 xh1Var = (xh1) this.f41616b;
        if (xh1Var.h == null && !xh1Var.f42759f.e()) {
    ...
    public void g(org.telegram.ui.ActionBar.b2 b2Var, int i10) {
        ...
        switch (this.f41615a) {
            case 3:
                PhotoViewer photoViewer = ((pt0) this.f41616b).f39660b;
                try {
                    AndroidUtilities.openForView(photoViewer.T4, photoViewer.f33754y, photoViewer.f33727v2, true);
            ...
            case 4:
                ((zv0) this.f41616b).finishFragment();
                return;
            case 5:
                ((tv0) this.f41616b).f40866a.R.r();
                return;
            case 7:
                PopupNotificationActivity popupNotificationActivity = (PopupNotificationActivity) this.f41616b;
            ...
            case 11:
                ((org.telegram.messenger.nk) this.f41616b).run(1);
                return;
            case 14:
                ProxyListActivity proxyListActivity = ((g21) this.f41616b).f36561b;
                ...
                if (h21Var != null) {
                    if (SharedConfig.currentProxy == null) {
                        ...
                        proxyListActivity.f34064a.n(ProxyListActivity.b0(proxyListActivity), 0);
                    }
                ...
                return;
            case 20:
                ThemeActivity themeActivity = ((vb1) this.f41616b).f41537a;
                ...
                if (k02) {
                    ...
                    gc1 gc1Var2 = themeActivity.f34201a;
                    i13 = themeActivity.bubbleRadiusRow;
                    gc1Var2.n(i13, new Object());
                }
                if (themeActivity.f34205c != null) {
                    ...
                    SparseArray sparseArray = N0.f20568a0;
                    int i17 = org.telegram.ui.ActionBar.j6.f20866n;
                    ...
                    if (h6Var != null) {
                        ...
                        b6Var.f20303c = "d";
                        b6Var.f20301a = "Blue_99_wp.jpg";
                        b6Var.f20302b = "Blue_99_wp.jpg";
                        h6Var.f20538y = b6Var;
                        N0.v(b6Var);
                    }
                    if (N0 != A0) {
                ...
                return;
            case 21:
                wd1 wd1Var = ((zc1) this.f41616b).f43406a;
                org.telegram.ui.ActionBar.j6.j0(wd1Var.f41956e0, wd1Var.f41991s, true);
                org.telegram.ui.ActionBar.j6.o();
                org.telegram.ui.ActionBar.j6.n1(false, false);
                NotificationCenter.getGlobalInstance().lambda$postNotificationNameOnUIThread$1(NotificationCenter.needSetDayNightTheme, wd1Var.f41956e0, Boolean.valueOf(wd1Var.f41960f0), null, -1);
                wd1Var.finishFragment();
                return;
            default:
                ((fh1) this.f41616b).f36434a.E0(true);
                return;
        }
    }
    ...
    public void mo17run(Object obj, Object obj2, Object obj3, Object obj4, Object obj5) {
        switch (this.f41615a) {
            case 0:
                ...
                ((Float) obj4).getClass();
                ((Float) obj5).getClass();
                PasskeysActivity.W((PasskeysActivity) this.f41616b, (org.telegram.ui.Components.h51) obj, (View) obj2);
                return;
            default:
                d41 d41Var = (d41) this.f41616b;
                ...
                e41 e41Var = d41Var.v;
                if (h51Var.f44098a == 30) {
                    TLRPC.TL_channels_sponsoredMessageReportResultChooseOption tL_channels_sponsoredMessageReportResultChooseOption = d41Var.f35673b;
                    ...
                    TLRPC.TL_reportResultChooseOption tL_reportResultChooseOption = d41Var.f35674c;
                    ...
                    e41.H(e41Var, h51Var.f26621l, null, null);
                    return;
                }
                return;
        }
    ...
    public void run(long j3) {
        AndroidUtilities.runOnUIThread(new org.telegram.messenger.rh((SharedConfig.ProxyInfo) this.f41616b, j3, 1));
    }

    @Override
    public Object run(Object obj, Object obj2) {
        Integer num = (Integer) obj2;
        PrivacyControlActivity privacyControlActivity = ((zx0) this.f41616b).d;
        if (((Integer) obj).intValue() == 0) {
            if (!privacyControlActivity.getUserConfig().isPremium()) {
                if (privacyControlActivity.f33868z0 == null) {
                    ...
                    privacyControlActivity.f33868z0 = spannableString;
                }
                SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder();
                spannableStringBuilder.append((CharSequence) privacyControlActivity.f33868z0);
