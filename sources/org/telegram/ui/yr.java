...
public abstract class yr extends LinearLayout {
    public final Paint f40233a;
    public final Paint f40234b;
    public float f40235c;
    public boolean d;
    public boolean e;
    public as[] f40236f;
    ...
    public final void b(int i10, int i11) {
        ...
        if (asVarArr == null || asVarArr.length != i10) {
            ...
            this.f40236f = new as[i10];
            for (int i16 = 0; i16 < i10; i16++) {
                this.f40236f[i16] = new wr(this, getContext(), i16, i10);
                this.f40236f[i16].setImeOptions(268435461);
                this.f40236f[i16].setTextSize(1, 20.0f);
                this.f40236f[i16].setMaxLines(1);
                this.f40236f[i16].setTypeface(AndroidUtilities.bold());
                this.f40236f[i16].setPadding(0, 0, 0, 0);
                this.f40236f[i16].setGravity(17);
                if (i11 == 3) {
                    this.f40236f[i16].setEnabled(false);
                    this.f40236f[i16].setInputType(0);
                    this.f40236f[i16].setVisibility(8);
                } else {
                    this.f40236f[i16].setInputType(3);
                }
                int i17 = 10;
                if (i11 == 10) {
                    i12 = 42;
                ...
                this.f40236f[i16].addTextChangedListener(new xr(this, i16, i10));
                this.f40236f[i16].setOnEditorActionListener(new ia(this, 3));
            }
            return;
        }
        while (true) {
            as[] asVarArr2 = this.f40236f;
    ...
    public final void c(String str, boolean z10) {
        if (this.f40236f != null) {
            ...
            for (int i12 = i10; i12 < Math.min(this.f40236f.length, str.length() + i10); i12++) {
                this.f40236f[i12].setText(Character.toString(str.charAt(i12 - i10)));
            }
        }
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        for (int i10 = 0; i10 < getChildCount(); i10++) {
            ...
            if (childAt instanceof as) {
                ...
                Paint paint = this.f40233a;
                paint.setColor(d);
                RectF rectF = AndroidUtilities.rectTmp;
                rectF.set(childAt.getLeft(), childAt.getTop(), childAt.getRight(), childAt.getBottom());
                float f7 = this.f40235c;
                rectF.inset(f7, f7);
                if (successProgress != 0.0f) {
                    float f10 = -Math.max(0.0f, (asVar.getSuccessScaleProgress() - 1.0f) * this.f40235c);
                    rectF.inset(f10, f10);
                }
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        if (view instanceof as) {
            ...
            if (f12 < 1.0f) {
                ...
                Paint paint = this.f40234b;
                paint.setAlpha((int) (f13 * 255.0f));
                canvas.drawBitmap(asVar.f32226y, asVar.getX(), asVar.getY(), paint);
                canvas.restore();
                return true;
            }
            return true;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f40235c = dp;
        this.f40233a.setStrokeWidth(dp);
    }

    public void setCode(String str) {
        this.f40236f[0].setText(str);
    }
