...
public final class yr extends Drawable {
    public final org.telegram.ui.ActionBar.e6 f39966a;
    public final Paint f39967b = new Paint(1);
    public final Paint f39968c;
    public final Drawable d;
    public final RectF e;
    public final org.telegram.ui.Components.m6 f39969f;
    public final org.telegram.ui.Components.m6 f39970g;
    public final Paint h;
    public final Path f39971i;
    public final Drawable f39972j;
    public int f39973k;
    public boolean f39974l;
    public final org.telegram.ui.Components.c6 f39975m;
    ...
    public yr(Context context, int i10, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        Path path = new Path();
        this.f39971i = path;
        this.f39975m = new org.telegram.ui.Components.c6(new dj(this, 12), 320L, org.telegram.ui.Components.qr.h, 0);
        xr xrVar = new xr(0, this);
        this.f39966a = e6Var;
        this.d = context.getResources().getDrawable(i10).mutate();
        this.f39972j = context.getResources().getDrawable(R.drawable.mini_casting_fill).mutate();
        paint.setColor(-1);
    ...
    public final void draw(Canvas canvas) {
        ...
        int i10;
        float f12;
        float e = this.f39975m.e(this.f39974l);
        org.telegram.ui.Components.m6 m6Var = this.f39969f;
        float d = m6Var.d() + (m6Var.g() * AndroidUtilities.dp(5.0f));
        org.telegram.ui.Components.m6 m6Var2 = this.f39970g;
        ...
        if (d * f15 > 0.0f) {
            ...
            m6Var.f26103w = (int) (m6Var.g() * 255.0f * f15);
            float f16 = f7 / 2.0f;
        ...
        if (e > 0.0f) {
            canvas2.save();
            int v02 = org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.Oh, this.f39966a);
            int i13 = this.f39973k;
            Drawable drawable2 = this.f39972j;
            if (i13 != v02) {
                this.f39973k = v02;
            ...
            if (e > 0.5f) {
                ...
                canvas2.drawPath(this.f39971i, this.h);
                canvas2.restore();
            }
        ...
        if (i10 > 0) {
            ...
            m6Var2.f26103w = (int) (m6Var2.g() * f12);
            float f17 = f7 / 2.0f;
