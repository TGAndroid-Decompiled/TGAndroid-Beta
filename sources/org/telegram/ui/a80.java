...
public final class a80 extends DispatchQueue {
    public static final int f30824y = 0;
    public final SurfaceTexture f30825a;
    public EGL10 f30826b;
    public EGLDisplay f30827c;
    public EGLConfig d;
    public EGLContext e;
    public EGLSurface f30828f;
    public boolean h;
    public final int[] f30829n;
    public float f30830r;
    public long f30831s;
    public final org.telegram.ui.Components.gp0 v;
    public final x5 f30832w;
    public final c80 f30833x;

    public a80(c80 c80Var, SurfaceTexture surfaceTexture) {
        super("EGLThread");
        this.f30833x = c80Var;
        this.f30829n = new int[24];
        this.v = new org.telegram.ui.Components.gp0(21);
        this.f30832w = new x5(this, 7);
        this.f30825a = surfaceTexture;
    }

    public final void b(int i10, int i11, int i12, boolean z10) {
        Drawable drawable = this.f30833x.getParentActivity().getResources().getDrawable(i10);
        if (drawable instanceof BitmapDrawable) {
            int[] iArr = this.f30829n;
            if (z10) {
    ...
    public final void finish() {
        if (this.f30828f != null) {
            EGL10 egl10 = this.f30826b;
            EGLDisplay eGLDisplay = this.f30827c;
            EGLSurface eGLSurface = EGL10.EGL_NO_SURFACE;
            egl10.eglMakeCurrent(eGLDisplay, eGLSurface, eGLSurface, EGL10.EGL_NO_CONTEXT);
            this.f30826b.eglDestroySurface(this.f30827c, this.f30828f);
            this.f30828f = null;
        }
        EGLContext eGLContext = this.e;
        if (eGLContext != null) {
            this.f30826b.eglDestroyContext(this.f30827c, eGLContext);
            this.e = null;
        }
        EGLDisplay eGLDisplay2 = this.f30827c;
        if (eGLDisplay2 != null) {
            this.f30826b.eglTerminate(eGLDisplay2);
            this.f30827c = null;
        }
    }
    ...
    public final void run() {
        ...
        this.f30827c = eglGetDisplay;
        boolean z10 = false;
        if (eglGetDisplay == EGL10.EGL_NO_DISPLAY) {
            if (BuildVars.LOGS_ENABLED) {
                org.telegram.messenger.em.s(this.f30826b, new StringBuilder("eglGetDisplay failed "));
            }
            finish();
        } else if (!this.f30826b.eglInitialize(eglGetDisplay, new int[2])) {
            if (BuildVars.LOGS_ENABLED) {
                org.telegram.messenger.em.s(this.f30826b, new StringBuilder("eglInitialize failed "));
            }
            finish();
        } else {
            int[] iArr = new int[1];
            EGLConfig[] eGLConfigArr = new EGLConfig[1];
            c80 c80Var = this.f30833x;
            if (!this.f30826b.eglChooseConfig(this.f30827c, EmuDetector.with(c80Var.getParentActivity()).detect() ? new int[]{12324, 8, 12323, 8, 12322, 8, 12321, 8, 12325, 24, 12344} : new int[]{12352, 4, 12324, 8, 12323, 8, 12322, 8, 12321, 8, 12325, 24, 12326, 0, 12338, 1, 12337, 2, 12344}, eGLConfigArr, 1, iArr)) {
                if (BuildVars.LOGS_ENABLED) {
                    org.telegram.messenger.em.s(this.f30826b, new StringBuilder("eglChooseConfig failed "));
                }
                finish();
            } else if (iArr[0] > 0) {
                EGLConfig eGLConfig = eGLConfigArr[0];
                this.d = eGLConfig;
                EGLContext eglCreateContext = this.f30826b.eglCreateContext(this.f30827c, eGLConfig, EGL10.EGL_NO_CONTEXT, new int[]{12440, 2, 12344});
                this.e = eglCreateContext;
                if (eglCreateContext == null) {
                    if (BuildVars.LOGS_ENABLED) {
                        org.telegram.messenger.em.s(this.f30826b, new StringBuilder("eglCreateContext failed "));
                    }
                    finish();
                } else {
                    SurfaceTexture surfaceTexture = this.f30825a;
                    if (surfaceTexture != null) {
                        EGLSurface eglCreateWindowSurface = this.f30826b.eglCreateWindowSurface(this.f30827c, this.d, surfaceTexture, null);
                        this.f30828f = eglCreateWindowSurface;
                        if (eglCreateWindowSurface != null && eglCreateWindowSurface != EGL10.EGL_NO_SURFACE) {
                            if (!this.f30826b.eglMakeCurrent(this.f30827c, eglCreateWindowSurface, eglCreateWindowSurface, this.e)) {
                                if (BuildVars.LOGS_ENABLED) {
                                    org.telegram.messenger.em.s(this.f30826b, new StringBuilder("eglMakeCurrent failed "));
                                }
                                finish();
                            } else {
                                int[] iArr2 = this.f30829n;
                                ...
                                b(R.drawable.intro_powerful_mask, 17, org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f17928d6, false), false);
                            ...
                            if (BuildVars.LOGS_ENABLED) {
                                org.telegram.messenger.em.s(this.f30826b, new StringBuilder("createWindowSurface failed "));
                            }
                            finish();
                        }
                    } else {
