...
public final class oe0 extends org.telegram.ui.Components.vv0 {
    public final yg0 E;
    public final org.telegram.ui.Components.yc0[] f36321a;
    public final EditTextBoldCursor[] f36322b;
    public final TextView f36323c;
    public final TextView d;
    public final TextView e;
    public final ImageView f36324f;
    public String h;
    public String f36325n;
    public String f36326r;
    public TL_account.Password f36327s;
    public Bundle v;
    public boolean f36328w;
    public final int f36329x;
    ...
    public oe0(yg0 yg0Var, Context context, int i10) {
        ...
        this.f36322b = new EditTextBoldCursor[i11];
        this.f36321a = new org.telegram.ui.Components.yc0[i11];
        TextView textView = new TextView(context);
        this.f36323c = textView;
        float f7 = 18.0f;
        ...
        while (i15 < this.f36322b.length) {
            ...
            this.f36322b[i15] = new EditTextBoldCursor(context);
            this.f36322b[i15].setCursorSize(AndroidUtilities.dp(20.0f));
            this.f36322b[i15].setCursorWidth(1.5f);
            this.f36322b[i15].setImeOptions(268435461);
            this.f36322b[i15].setTextSize(1, f7);
            this.f36322b[i15].setMaxLines(1);
            this.f36322b[i15].setBackground(null);
            int dp = AndroidUtilities.dp(16.0f);
            this.f36322b[i15].setPadding(dp, dp, dp, dp);
            if (i10 == 0) {
                this.f36322b[i15].setInputType(129);
                this.f36322b[i15].setTransformationMethod(PasswordTransformationMethod.getInstance());
            }
            this.f36322b[i15].setTypeface(Typeface.DEFAULT);
            EditTextBoldCursor editTextBoldCursor = this.f36322b[i15];
            ...
            EditTextBoldCursor editTextBoldCursor2 = this.f36322b[i15];
            if (i15 == 0 && i10 == 0) {
                z10 = true;
            } else {
                z10 = false;
            ...
            this.f36322b[i15].setOnFocusChangeListener(new qd(yc0Var, 3));
            if (z10) {
                LinearLayout linearLayout = new LinearLayout(context);
                linearLayout.setOrientation(0);
                linearLayout.setGravity(16);
                linearLayout.addView(this.f36322b[i15], w7.x5.l(1.0f, 0, -2));
                ImageView imageView = new ImageView(context);
                this.f36324f = imageView;
                imageView.setImageResource(R.drawable.msg_message);
                AndroidUtilities.updateViewVisibilityAnimated(imageView, true, 0.1f, false);
                imageView.setOnClickListener(new View.OnClickListener(this) {
                    public final oe0 f35261b;
                    ...
                    public final void onClick(View view) {
                        ...
                        switch (r2) {
                            case 0:
                                oe0 oe0Var = this.f35261b;
                                ImageView imageView2 = oe0Var.f36324f;
                                EditTextBoldCursor[] editTextBoldCursorArr = oe0Var.f36322b;
                                oe0Var.f36330y = !oe0Var.f36330y;
                                ...
                                imageView2.setTag(Boolean.valueOf(oe0Var.f36330y));
                                if (oe0Var.f36330y) {
                                    i16 = org.telegram.ui.ActionBar.j6.f19009l6;
                                } else {
                                ...
                                return;
                            default:
                                oe0 oe0Var2 = this.f35261b;
                                if (oe0Var2.f36329x == 0) {
                                    oe0Var2.o(null, null);
                                    return;
                                } else {
                                    oe0Var2.o(oe0Var2.f36325n, null);
                                    return;
                                }
                        }
                    }
                ...
                yc0Var.addView(this.f36322b[i15], w7.x5.c(-2.0f, -1));
            }
            yc0Var.e(this.f36322b[i15]);
            addView(yc0Var, w7.x5.t(-1, -2, 1, 16, 16, 16, 0));
            this.f36322b[i15].setOnEditorActionListener(new TextView.OnEditorActionListener() {
                @Override
    ...
    public final void h(String str) {
        if (!this.f36328w) {
            EditTextBoldCursor[] editTextBoldCursorArr = this.f36322b;
            ...
            if (length == 0) {
                ...
                bundle.putString("password", this.f36326r);
    ...
    @Override
    public final void j() {
        AndroidUtilities.runOnUIThread(new i10(this, 18), yg0.f39887t0);
    }

    @Override
    public final void k(Bundle bundle) {
        Bundle bundle2 = bundle.getBundle("recoveryview_params" + this.f36329x);
        this.v = bundle2;
        if (bundle2 != null) {
            m(bundle2, true);
        }
    ...
    public final void l(Bundle bundle) {
        if (this.v != null) {
            bundle.putBundle("recoveryview_params" + this.f36329x, this.v);
        }
    }
    ...
    public final void m(Bundle bundle, boolean z10) {
        ...
        int i10 = 0;
        while (true) {
            editTextBoldCursorArr = this.f36322b;
        ...
        if (string != null) {
            ...
            this.f36327s = TLdeserialize;
            TwoStepVerificationActivity.m0(TLdeserialize);
        }
        this.f36325n = this.v.getString("new_password");
    ...
    public final void n() {
        EditTextBoldCursor[] editTextBoldCursorArr;
        int i10;
        this.f36323c.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.G6, false));
        this.d.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.D6, false));
        for (EditTextBoldCursor editTextBoldCursor : this.f36322b) {
            editTextBoldCursor.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.G6, false));
            editTextBoldCursor.setCursorColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19009l6, false));
        }
        for (org.telegram.ui.Components.yc0 yc0Var : this.f36321a) {
            yc0Var.f();
        }
        this.e.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.q6, false));
        ImageView imageView = this.f36324f;
        if (imageView != null) {
            if (this.f36330y) {
                i10 = org.telegram.ui.ActionBar.j6.f19009l6;
            } else {
                i10 = org.telegram.ui.ActionBar.j6.H6;
            }
            imageView.setColorFilter(org.telegram.ui.ActionBar.j6.w0(null, i10, false));
            imageView.setBackground(org.telegram.ui.ActionBar.j6.f0(this.E.getThemedColor(org.telegram.ui.ActionBar.j6.f18953i6), 1, -1));
        }
    }
    ...
    public final void o(String str, String str2) {
        ...
        if (!TextUtils.isEmpty(str)) {
            ...
            passwordinputsettings.new_algo = this.f36327s.new_algo;
        }
