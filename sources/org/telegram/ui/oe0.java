...
public final class oe0 implements RequestDelegate {
    ...
    public final qe0 f36181b;

    public oe0(qe0 qe0Var, int i10) {
        this.f36180a = i10;
        this.f36181b = qe0Var;
    }
    ...
    public final void run(final TLObject tLObject, final TLRPC.TL_error tL_error) {
        switch (this.f36180a) {
            case 0:
                    ...
                    public final void run() {
                        ...
                        switch (i11) {
                            case 0:
                                qe0Var2.getClass();
                                if (tL_error2 == null) {
                                    qe0Var2.f36803n = (TL_account.Password) tLObject2;
                                    qe0Var2.h(null);
                                    return;
                                }
                                return;
                            case 1:
                                xg0 xg0Var = qe0Var2.f36808y;
                            ...
                            default:
                                xg0 xg0Var2 = qe0Var2.f36808y;
                                qe0Var2.h = false;
                                if (tL_error2 != null && "SRP_ID_INVALID".equals(tL_error2.text)) {
                                    TL_account.getPassword getpassword = new TL_account.getPassword();
                                    i10 = ((org.telegram.ui.ActionBar.n2) xg0Var2).currentAccount;
                                    ConnectionsManager.getInstance(i10).sendRequest(getpassword, new oe0(qe0Var2, 0), 8);
                                    return;
                                    ...
                                    if (tL_error2.text.equals("PASSWORD_HASH_INVALID")) {
                                        if (xg0Var2.getParentActivity() != null) {
                                            qe0Var2.f36799a.setText("");
                                            xg0.U0(xg0Var2, qe0Var2.f36807x, true);
                                            return;
                                        }
                                        return;
                                    } else if (tL_error2.text.startsWith("FLOOD_WAIT")) {
                ...
                return;
            case 1:
                final qe0 qe0Var2 = this.f36181b;
                AndroidUtilities.runOnUIThread(new Runnable() {
                    @Override
                    public final void run() {
                        String formatPluralString;
                        ...
                        switch (i11) {
                            case 0:
                                qe0Var22.getClass();
                                if (tL_error2 == null) {
                                    qe0Var22.f36803n = (TL_account.Password) tLObject2;
                                    qe0Var22.h(null);
                                    return;
                                }
                                return;
                            case 1:
                                xg0 xg0Var = qe0Var22.f36808y;
                                xg0Var.k1(false, true);
                                if (tL_error2 == null) {
                                    TLRPC.TL_auth_passwordRecovery tL_auth_passwordRecovery = (TLRPC.TL_auth_passwordRecovery) tLObject2;
                                    if (xg0Var.getParentActivity() != null) {
                            ...
                            default:
                                xg0 xg0Var2 = qe0Var22.f36808y;
                                qe0Var22.h = false;
                                if (tL_error2 != null && "SRP_ID_INVALID".equals(tL_error2.text)) {
                                    TL_account.getPassword getpassword = new TL_account.getPassword();
                                    i10 = ((org.telegram.ui.ActionBar.n2) xg0Var2).currentAccount;
                                    ConnectionsManager.getInstance(i10).sendRequest(getpassword, new oe0(qe0Var22, 0), 8);
                                    return;
                                } else if (tLObject2 instanceof TLRPC.TL_auth_authorization) {
                                    xg0Var2.v1(false, true);
                                    ...
                                    if (tL_error2.text.equals("PASSWORD_HASH_INVALID")) {
                                        if (xg0Var2.getParentActivity() != null) {
                                            qe0Var22.f36799a.setText("");
                                            xg0.U0(xg0Var2, qe0Var22.f36807x, true);
                                            return;
                                        }
                                        return;
                                    } else if (tL_error2.text.startsWith("FLOOD_WAIT")) {
                ...
                return;
            default:
                final qe0 qe0Var3 = this.f36181b;
                AndroidUtilities.runOnUIThread(new Runnable() {
                    @Override
                    public final void run() {
                        String formatPluralString;
