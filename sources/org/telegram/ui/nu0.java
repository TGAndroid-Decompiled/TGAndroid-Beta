...
public final class nu0 extends org.telegram.ui.Components.bw0 {
    ...
    public final void Z() {
        if (Build.VERSION.SDK_INT >= 29) {
            ...
            this.D0.clear();
            PhotoViewer photoViewer = this.E0;
            if (photoViewer.f31353u4 == 1 || photoViewer.f31301o6 == 1) {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        PhotoViewer photoViewer = this.E0;
        photoViewer.Q.o(photoViewer.f31226g0.getContext()).draw(canvas);
    }
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        org.telegram.ui.Cells.da daVar = o9.f20102r;
        if (motionEvent.getAction() == 0) {
            o9.h = motionEvent.getX();
            o9.f20101n = motionEvent.getY();
            daVar.e = daVar.y();
        } else if (daVar.e && Math.abs(motionEvent.getX() - o9.h) < AndroidUtilities.touchSlop && Math.abs(motionEvent.getY() - o9.f20101n) < AndroidUtilities.touchSlop && (motionEvent.getAction() == 3 || motionEvent.getAction() == 1)) {
            motionEvent.getX();
            motionEvent.getY();
            org.telegram.ui.Cells.da daVar2 = o9.f20102r;
            if (!daVar2.f20154i && daVar2.e) {
                daVar2.f(false);
            }
        }
        if (photoViewer.Q.y()) {
    ...
    public final void draw(Canvas canvas) {
        ...
        if (au0Var != null && au0Var.f22665x) {
            int measuredHeight = ((int) ((photoViewer.f31177a6 - 1.0f) * au0Var.getWebView().getMeasuredHeight())) / 2;
            org.telegram.ui.Components.k71 k71Var = photoViewer.f31397z1;
            if (k71Var != null && k71Var.f25666j) {
                k71Var.setBounds(photoViewer.f31218f0.getLeft(), (photoViewer.f31218f0.getWebView().getTop() - measuredHeight) + ((int) (photoViewer.Y5 / photoViewer.f31177a6)), photoViewer.f31218f0.getRight(), photoViewer.f31218f0.getWebView().getBottom() + measuredHeight + ((int) (photoViewer.Y5 / photoViewer.f31177a6)));
                photoViewer.f31397z1.draw(canvas);
            }
            org.telegram.ui.Components.xo0 xo0Var = photoViewer.A1;
            if (xo0Var != null && xo0Var.a()) {
                photoViewer.A1.setBounds(photoViewer.f31218f0.getLeft(), (int) ((photoViewer.F.getAlpha() * AndroidUtilities.dp(90.0f)) + AndroidUtilities.statusBarHeight), photoViewer.f31218f0.getRight(), photoViewer.f31218f0.getWebView().getBottom() + measuredHeight + ((int) (photoViewer.Y5 / photoViewer.f31177a6)));
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        PhotoViewer photoViewer = this.E0;
        if (view != photoViewer.Q.o(photoViewer.f31226g0.getContext()) && view != photoViewer.f31336s5 && view != photoViewer.f31400z4 && view != photoViewer.A4 && view != photoViewer.X0) {
            ...
            try {
                if (view != photoViewer.f31390y2 && view != photoViewer.f31391y4) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (photoViewer.f31244i0.getVisibility() != 8) {
        ...
        cv0 cv0Var = photoViewer.f31247i3;
        if (cv0Var != null) {
            cv0Var.e = size;
            cv0Var.f32788f = i17;
        }
        ...
        while (i18 < childCount) {
            ...
            if (childAt.getVisibility() != 8 && childAt != photoViewer.l1) {
                ...
                if (childAt == kt0Var) {
                ...
                } else if (childAt == photoViewer.f31391y4) {
                    ...
                    photoViewer.f31391y4.measure(View.MeasureSpec.makeMeasureSpec(bitmapWidth, 1073741824), View.MeasureSpec.makeMeasureSpec(bitmapHeight, 1073741824));
                } else if (!photoViewer.U1.f5121f.l(childAt) && !photoViewer.V1.f5121f.l(childAt)) {
                    if (childAt == photoViewer.T1) {
                        if (photoViewer.f31278m2) {
                            if (nu0Var.C0) {
                                i15 = i12 + i14;
