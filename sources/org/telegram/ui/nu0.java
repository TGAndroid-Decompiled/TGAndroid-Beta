...
public final class nu0 extends org.telegram.ui.Components.bw0 {
    ...
    public final void Z() {
        if (Build.VERSION.SDK_INT >= 29) {
            ...
            this.D0.clear();
            PhotoViewer photoViewer = this.E0;
            if (photoViewer.f31368u4 == 1 || photoViewer.f31316o6 == 1) {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        PhotoViewer photoViewer = this.E0;
        photoViewer.Q.o(photoViewer.f31241g0.getContext()).draw(canvas);
    }
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        org.telegram.ui.Cells.da daVar = o9.f20117r;
        if (motionEvent.getAction() == 0) {
            o9.h = motionEvent.getX();
            o9.f20116n = motionEvent.getY();
            daVar.e = daVar.y();
        } else if (daVar.e && Math.abs(motionEvent.getX() - o9.h) < AndroidUtilities.touchSlop && Math.abs(motionEvent.getY() - o9.f20116n) < AndroidUtilities.touchSlop && (motionEvent.getAction() == 3 || motionEvent.getAction() == 1)) {
            motionEvent.getX();
            motionEvent.getY();
            org.telegram.ui.Cells.da daVar2 = o9.f20117r;
            if (!daVar2.f20169i && daVar2.e) {
                daVar2.f(false);
            }
        }
        if (photoViewer.Q.y()) {
    ...
    public final void draw(Canvas canvas) {
        ...
        if (au0Var != null && au0Var.f22684x) {
            int measuredHeight = ((int) ((photoViewer.f31192a6 - 1.0f) * au0Var.getWebView().getMeasuredHeight())) / 2;
            org.telegram.ui.Components.k71 k71Var = photoViewer.f31412z1;
            if (k71Var != null && k71Var.f25685j) {
                k71Var.setBounds(photoViewer.f31233f0.getLeft(), (photoViewer.f31233f0.getWebView().getTop() - measuredHeight) + ((int) (photoViewer.Y5 / photoViewer.f31192a6)), photoViewer.f31233f0.getRight(), photoViewer.f31233f0.getWebView().getBottom() + measuredHeight + ((int) (photoViewer.Y5 / photoViewer.f31192a6)));
                photoViewer.f31412z1.draw(canvas);
            }
            org.telegram.ui.Components.xo0 xo0Var = photoViewer.A1;
            if (xo0Var != null && xo0Var.a()) {
                photoViewer.A1.setBounds(photoViewer.f31233f0.getLeft(), (int) ((photoViewer.F.getAlpha() * AndroidUtilities.dp(90.0f)) + AndroidUtilities.statusBarHeight), photoViewer.f31233f0.getRight(), photoViewer.f31233f0.getWebView().getBottom() + measuredHeight + ((int) (photoViewer.Y5 / photoViewer.f31192a6)));
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        PhotoViewer photoViewer = this.E0;
        if (view != photoViewer.Q.o(photoViewer.f31241g0.getContext()) && view != photoViewer.f31351s5 && view != photoViewer.f31415z4 && view != photoViewer.A4 && view != photoViewer.X0) {
            ...
            try {
                if (view != photoViewer.f31405y2 && view != photoViewer.f31406y4) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (photoViewer.f31259i0.getVisibility() != 8) {
        ...
        cv0 cv0Var = photoViewer.f31262i3;
        if (cv0Var != null) {
            cv0Var.e = size;
            cv0Var.f32805f = i17;
        }
        ...
        while (i18 < childCount) {
            ...
            if (childAt.getVisibility() != 8 && childAt != photoViewer.l1) {
                ...
                if (childAt == kt0Var) {
                ...
                } else if (childAt == photoViewer.f31406y4) {
                    ...
                    photoViewer.f31406y4.measure(View.MeasureSpec.makeMeasureSpec(bitmapWidth, 1073741824), View.MeasureSpec.makeMeasureSpec(bitmapHeight, 1073741824));
                } else if (!photoViewer.U1.f5121f.l(childAt) && !photoViewer.V1.f5121f.l(childAt)) {
                    if (childAt == photoViewer.T1) {
                        if (photoViewer.f31293m2) {
                            if (nu0Var.C0) {
                                i15 = i12 + i14;
