...
public final class wu0 extends org.telegram.ui.Components.bw0 {
    ...
    public final void Z() {
        if (Build.VERSION.SDK_INT >= 29) {
            ...
            this.D0.clear();
            PhotoViewer photoViewer = this.E0;
            if (photoViewer.f30193u4 == 1 || photoViewer.f30141o6 == 1) {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        PhotoViewer photoViewer = this.E0;
        photoViewer.Q.o(photoViewer.f30066g0.getContext()).draw(canvas);
    }
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        org.telegram.ui.Cells.fa faVar = o9.f19099r;
        if (motionEvent.getAction() == 0) {
            o9.h = motionEvent.getX();
            o9.f19098n = motionEvent.getY();
            faVar.e = faVar.y();
        } else if (faVar.e && Math.abs(motionEvent.getX() - o9.h) < AndroidUtilities.touchSlop && Math.abs(motionEvent.getY() - o9.f19098n) < AndroidUtilities.touchSlop && (motionEvent.getAction() == 3 || motionEvent.getAction() == 1)) {
            motionEvent.getX();
            motionEvent.getY();
            org.telegram.ui.Cells.fa faVar2 = o9.f19099r;
            if (!faVar2.f19141i && faVar2.e) {
                faVar2.f(false);
            }
        }
        if (photoViewer.Q.y()) {
    ...
    public final void draw(Canvas canvas) {
        ...
        if (hu0Var != null && hu0Var.f29666x) {
            int measuredHeight = ((int) ((photoViewer.f30017a6 - 1.0f) * hu0Var.getWebView().getMeasuredHeight())) / 2;
            org.telegram.ui.Components.j71 j71Var = photoViewer.f30237z1;
            if (j71Var != null && j71Var.f24268j) {
                j71Var.setBounds(photoViewer.f30058f0.getLeft(), (photoViewer.f30058f0.getWebView().getTop() - measuredHeight) + ((int) (photoViewer.Y5 / photoViewer.f30017a6)), photoViewer.f30058f0.getRight(), photoViewer.f30058f0.getWebView().getBottom() + measuredHeight + ((int) (photoViewer.Y5 / photoViewer.f30017a6)));
                photoViewer.f30237z1.draw(canvas);
            }
            org.telegram.ui.Components.to0 to0Var = photoViewer.A1;
            if (to0Var != null && to0Var.a()) {
                photoViewer.A1.setBounds(photoViewer.f30058f0.getLeft(), (int) ((photoViewer.F.getAlpha() * AndroidUtilities.dp(90.0f)) + AndroidUtilities.statusBarHeight), photoViewer.f30058f0.getRight(), photoViewer.f30058f0.getWebView().getBottom() + measuredHeight + ((int) (photoViewer.Y5 / photoViewer.f30017a6)));
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        PhotoViewer photoViewer = this.E0;
        if (view != photoViewer.Q.o(photoViewer.f30066g0.getContext()) && view != photoViewer.f30176s5 && view != photoViewer.f30240z4 && view != photoViewer.A4 && view != photoViewer.X0) {
            ...
            try {
                if (view != photoViewer.f30230y2 && view != photoViewer.f30231y4) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (photoViewer.f30084i0.getVisibility() != 8) {
        ...
        lv0 lv0Var = photoViewer.f30087i3;
        if (lv0Var != null) {
            lv0Var.e = size;
            lv0Var.f34789f = i17;
        }
        ...
        while (i18 < childCount) {
            ...
            if (childAt.getVisibility() != 8 && childAt != photoViewer.l1) {
                ...
                if (childAt == rt0Var) {
                ...
                } else if (childAt == photoViewer.f30231y4) {
                    ...
                    photoViewer.f30231y4.measure(View.MeasureSpec.makeMeasureSpec(bitmapWidth, 1073741824), View.MeasureSpec.makeMeasureSpec(bitmapHeight, 1073741824));
                } else if (!photoViewer.U1.f3268f.l(childAt) && !photoViewer.V1.f3268f.l(childAt)) {
                    if (childAt == photoViewer.T1) {
                        if (photoViewer.f30118m2) {
                            if (wu0Var.C0) {
                                i15 = i12 + i14;
