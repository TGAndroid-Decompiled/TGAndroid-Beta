...
public final class lp0 extends LinearLayout {
    public final org.telegram.ui.Components.n90 f35396a;
    public final org.telegram.ui.Components.n90 f35397b;
    public final np0 f35398c;
    ...
    public final void a() {
        tp0 tp0Var = this.f35398c.f35956p0;
        setBackgroundColor(tp0Var.getThemedColor(org.telegram.ui.ActionBar.h6.f19060d6));
        this.f35396a.setTextColor(tp0Var.getThemedColor(org.telegram.ui.ActionBar.h6.f19443y6));
        int i10 = org.telegram.ui.ActionBar.h6.gc;
        int themedColor = tp0Var.getThemedColor(i10);
        org.telegram.ui.Components.n90 n90Var = this.f35397b;
