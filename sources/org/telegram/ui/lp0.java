...
public final class lp0 extends LinearLayout {
    public final org.telegram.ui.Components.o90 f35394a;
    public final org.telegram.ui.Components.o90 f35395b;
    public final np0 f35396c;
    ...
    public lp0(np0 np0Var, Context context) {
        ...
        w9Var.setImageDrawable(new org.telegram.ui.Components.jj0(R.raw.utyan_draw, AndroidUtilities.dp(120.0f), AndroidUtilities.dp(120.0f)));
        ...
        org.telegram.ui.Components.o90 a2 = w7.c6.a(context2, 14.0f, i11, false, d6Var);
        this.f35394a = a2;
        a2.setGravity(17);
        if (np0Var.m0 == 0) {
        ...
        org.telegram.ui.Components.o90 a10 = w7.c6.a(context3, 14.0f, i12, false, d6Var2);
        this.f35395b = a10;
        a10.setGravity(17);
    ...
    public final void a() {
        tp0 tp0Var = this.f35396c.f35954p0;
        setBackgroundColor(tp0Var.getThemedColor(org.telegram.ui.ActionBar.h6.f19059d6));
        this.f35394a.setTextColor(tp0Var.getThemedColor(org.telegram.ui.ActionBar.h6.f19442y6));
        int i10 = org.telegram.ui.ActionBar.h6.gc;
        int themedColor = tp0Var.getThemedColor(i10);
        org.telegram.ui.Components.o90 o90Var = this.f35395b;
        o90Var.setTextColor(themedColor);
        o90Var.setLinkTextColor(tp0Var.getThemedColor(i10));
    }
}
