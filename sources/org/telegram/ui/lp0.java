...
public final class lp0 extends LinearLayout {
    public final org.telegram.ui.Components.n90 f35383a;
    public final org.telegram.ui.Components.n90 f35384b;
    public final np0 f35385c;
    ...
    public final void a() {
        tp0 tp0Var = this.f35385c.f35932p0;
        setBackgroundColor(tp0Var.getThemedColor(org.telegram.ui.ActionBar.h6.f19045d6));
        this.f35383a.setTextColor(tp0Var.getThemedColor(org.telegram.ui.ActionBar.h6.f19428y6));
        int i10 = org.telegram.ui.ActionBar.h6.gc;
        int themedColor = tp0Var.getThemedColor(i10);
        org.telegram.ui.Components.n90 n90Var = this.f35384b;
