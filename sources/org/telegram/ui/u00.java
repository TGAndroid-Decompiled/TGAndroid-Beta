...
public abstract class u00 extends FrameLayout {
    public final org.telegram.ui.ActionBar.m2 f38265a;
    public final int f38266b;
    public final int f38267c;
    public final Drawable d;
    public final Drawable e;
    public final org.telegram.ui.Components.p6 f38268f;
    public final org.telegram.ui.Components.p6 h;
    public final Paint f38269n;
    public final Paint f38270r;
    public float f38271s;
    public boolean v;
    public ValueAnimator f38272w;
    public String f38273x;
    public TL_chatlists.TL_exportedChatlistInvite f38274y;
    ...
    public final void a() {
        ...
        tL_inputChatlistDialogFilter.filter_id = this.f38267c;
        tL_chatlists_deleteExportedInvite.slug = substring;
        t00 t00Var = new t00(this, 2);
        ConnectionsManager.getInstance(this.f38266b).sendRequest(tL_chatlists_deleteExportedInvite, new lo(21, this, t00Var));
    ...
    public void c() {
        org.telegram.ui.ActionBar.m2 m2Var = this.f38265a;
        if (!(m2Var instanceof b10)) {
            return;
        }
        ai.w0 w0Var = ((b10) m2Var).f32273a;
    ...
    public final void d() {
        if (this.f38273x == null) {
            return;
        }
        org.telegram.ui.Components.ui0 ui0Var = new org.telegram.ui.Components.ui0(getContext(), LocaleController.getString(R.string.InviteByQRCode), this.f38273x, LocaleController.getString(R.string.QRCodeLinkHelpFolder), false);
    ...
    public final void e(TL_chatlists.TL_exportedChatlistInvite tL_exportedChatlistInvite, boolean z10) {
        boolean z11;
        if (this.f38274y == tL_exportedChatlistInvite) {
            z11 = true;
        } else {
            z11 = false;
        }
        this.f38274y = tL_exportedChatlistInvite;
        ...
        org.telegram.ui.Components.p6 p6Var = this.f38268f;
        if (isEmpty) {
        ...
        if ((z12 ? 1.0f : 0.0f) != this.f38271s) {
            ValueAnimator valueAnimator = this.f38272w;
            ...
            float f7 = 0.0f;
            if (z11) {
                float f10 = this.f38271s;
                if (z12) {
                    f7 = 1.0f;
                }
                ValueAnimator ofFloat = ValueAnimator.ofFloat(f10, f7);
                this.f38272w = ofFloat;
                ofFloat.addUpdateListener(new c3(this, 13));
                this.f38272w.addListener(new org.telegram.ui.Components.ca(28, this, z12));
                this.f38272w.setInterpolator(org.telegram.ui.Components.rr.h);
                this.f38272w.setDuration(350L);
                this.f38272w.start();
                return;
            }
            if (z12) {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float f7 = dp;
        canvas.drawCircle(f7, getMeasuredHeight() / 2.0f, AndroidUtilities.dp(16.0f), this.f38269n);
        if (this.f38271s > 0.0f) {
            canvas.drawCircle(f7, getMeasuredHeight() / 2.0f, AndroidUtilities.dp(16.0f) * this.f38271s, this.f38270r);
        }
        float f10 = this.f38271s;
        if (f10 < 1.0f) {
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        TL_chatlists.TL_exportedChatlistInvite tL_exportedChatlistInvite = this.f38274y;
        String str2 = "";
        if (tL_exportedChatlistInvite == null || TextUtils.isEmpty(tL_exportedChatlistInvite.title)) {
            str = "";
        } else {
            str = a4.a.t(new StringBuilder(), this.f38274y.title, "\n ");
        }
        sb2.append(str);
        org.telegram.ui.Cells.c1.n(R.string.InviteLink, ", ", sb2);
        sb2.append((Object) this.h.getText());
        TL_chatlists.TL_exportedChatlistInvite tL_exportedChatlistInvite2 = this.f38274y;
