...
public abstract class u00 extends FrameLayout {
    public final org.telegram.ui.ActionBar.m2 f38266a;
    public final int f38267b;
    public final int f38268c;
    public final Drawable d;
    public final Drawable e;
    public final org.telegram.ui.Components.p6 f38269f;
    public final org.telegram.ui.Components.p6 h;
    public final Paint f38270n;
    public final Paint f38271r;
    public float f38272s;
    public boolean v;
    public ValueAnimator f38273w;
    public String f38274x;
    public TL_chatlists.TL_exportedChatlistInvite f38275y;
    ...
    public u00(Context context, org.telegram.ui.ActionBar.m2 m2Var, int i10, int i11) {
        ...
        p6Var2.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19462z6, false));
        if (LocaleController.isRTL) {
            i13 = 5;
        } else {
            i13 = 3;
    ...
    public final void a() {
        ...
        tL_inputChatlistDialogFilter.filter_id = this.f38268c;
        tL_chatlists_deleteExportedInvite.slug = substring;
        t00 t00Var = new t00(this, 2);
        ConnectionsManager.getInstance(this.f38267b).sendRequest(tL_chatlists_deleteExportedInvite, new lo(21, this, t00Var));
    ...
    public void c() {
        org.telegram.ui.ActionBar.m2 m2Var = this.f38266a;
        if (!(m2Var instanceof b10)) {
            return;
        }
        ai.w0 w0Var = ((b10) m2Var).f32274a;
    ...
    public final void d() {
        ...
        org.telegram.ui.Components.ui0 ui0Var = new org.telegram.ui.Components.ui0(getContext(), LocaleController.getString(R.string.InviteByQRCode), this.f38274x, LocaleController.getString(R.string.QRCodeLinkHelpFolder), false);
    ...
    public final void e(TL_chatlists.TL_exportedChatlistInvite tL_exportedChatlistInvite, boolean z10) {
        boolean z11;
        if (this.f38275y == tL_exportedChatlistInvite) {
            z11 = true;
        } else {
            z11 = false;
        }
        this.f38275y = tL_exportedChatlistInvite;
        ...
        org.telegram.ui.Components.p6 p6Var = this.f38269f;
        if (isEmpty) {
        ...
        if ((z12 ? 1.0f : 0.0f) != this.f38272s) {
            ValueAnimator valueAnimator = this.f38273w;
            ...
            float f7 = 0.0f;
            if (z11) {
                float f10 = this.f38272s;
                if (z12) {
                    f7 = 1.0f;
                }
                ValueAnimator ofFloat = ValueAnimator.ofFloat(f10, f7);
                this.f38273w = ofFloat;
                ofFloat.addUpdateListener(new c3(this, 13));
                this.f38273w.addListener(new org.telegram.ui.Components.ca(28, this, z12));
                this.f38273w.setInterpolator(org.telegram.ui.Components.rr.h);
                this.f38273w.setDuration(350L);
                this.f38273w.start();
                return;
            }
            if (z12) {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float f7 = dp;
        canvas.drawCircle(f7, getMeasuredHeight() / 2.0f, AndroidUtilities.dp(16.0f), this.f38270n);
        if (this.f38272s > 0.0f) {
            canvas.drawCircle(f7, getMeasuredHeight() / 2.0f, AndroidUtilities.dp(16.0f) * this.f38272s, this.f38271r);
        }
        float f10 = this.f38272s;
        if (f10 < 1.0f) {
        ...
        if (this.v) {
            ...
            canvas.drawRect(dp2, measuredHeight, measuredWidth - i10, getMeasuredHeight(), org.telegram.ui.ActionBar.h6.f19181k0);
        }
    }
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        TL_chatlists.TL_exportedChatlistInvite tL_exportedChatlistInvite = this.f38275y;
        String str2 = "";
        if (tL_exportedChatlistInvite == null || TextUtils.isEmpty(tL_exportedChatlistInvite.title)) {
            str = "";
        } else {
            str = a4.a.t(new StringBuilder(), this.f38275y.title, "\n ");
        }
        sb2.append(str);
        org.telegram.ui.Cells.c1.n(R.string.InviteLink, ", ", sb2);
        sb2.append((Object) this.h.getText());
        TL_chatlists.TL_exportedChatlistInvite tL_exportedChatlistInvite2 = this.f38275y;
