    ...
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        switch (this.f32551a) {
            ...
            case 1:
                ...
                return;
            case 2:
                z6.X((z6) this.f32552b, valueAnimator);
                return;
            case 3:
                h8 h8Var = (h8) this.f32552b;
                float floatValue2 = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                for (int i11 = 0; i11 < h8Var.f34140b.getChildCount(); i11++) {
                    e8.b((e8) h8Var.f34140b.getChildAt(i11), floatValue2);
                }
                return;
            case 4:
                ld ldVar = (ld) this.f32552b;
                ldVar.f35302b.b(((Float) valueAnimator.getAnimatedValue()).floatValue());
                ldVar.f35302b.invalidateSelf();
                return;
            case 5:
                ((org.telegram.ui.Components.qr) this.f32552b).b(((Float) valueAnimator.getAnimatedValue()).floatValue());
                return;
            case 6:
                al alVar = (al) this.f32552b;
                alVar.getClass();
                alVar.setBubbleOffset(((Float) valueAnimator.getAnimatedValue()).floatValue());
                alVar.invalidate();
                return;
            case 7:
                fp fpVar = (fp) this.f32552b;
                fpVar.f33731r.b(((Float) valueAnimator.getAnimatedValue()).floatValue());
                fpVar.f33731r.invalidateSelf();
                return;
            case 8:
                as asVar = (as) this.f32552b;
                asVar.getClass();
                asVar.f32226w = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                asVar.invalidate();
            ...
            case 9:
                ...
                return;
            case 10:
                my myVar = (my) this.f32552b;
                myVar.getClass();
                myVar.setViewsOffset(((Float) valueAnimator.getAnimatedValue()).floatValue());
                return;
            case 11:
                hz hzVar = (hz) this.f32552b;
                hzVar.getClass();
                hzVar.f34333r = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                org.telegram.ui.Components.w9 w9Var = hzVar.f34330c;
                int i12 = org.telegram.ui.ActionBar.h6.C6;
                org.telegram.ui.ActionBar.d6 d6Var = hzVar.f34328a;
                int v02 = org.telegram.ui.ActionBar.h6.v0(i12, d6Var);
                int i13 = org.telegram.ui.ActionBar.h6.Oh;
                int d = i0.a.d(hzVar.f34333r, v02, org.telegram.ui.ActionBar.h6.v0(i13, d6Var));
                PorterDuff.Mode mode = PorterDuff.Mode.SRC_IN;
                w9Var.setColorFilter(new PorterDuffColorFilter(d, mode));
                w9Var.invalidate();
                org.telegram.ui.Components.w9 w9Var2 = hzVar.f34331f;
                w9Var2.setColorFilter(new PorterDuffColorFilter(i0.a.d(1.0f - hzVar.f34333r, org.telegram.ui.ActionBar.h6.v0(i12, d6Var), org.telegram.ui.ActionBar.h6.v0(i13, d6Var)), mode));
                w9Var2.invalidate();
                return;
            case 12:
                yz yzVar = (yz) this.f32552b;
                yzVar.f40289n.b(((Float) valueAnimator.getAnimatedValue()).floatValue());
                yzVar.f40289n.invalidateSelf();
                return;
            case 13:
                u00 u00Var = (u00) this.f32552b;
                u00Var.getClass();
                u00Var.f38272s = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                u00Var.invalidate();
                return;
            case 14:
                v10 v10Var = (v10) this.f32552b;
                v10Var.getClass();
                float floatValue3 = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                ImageView imageView = v10Var.f38592c;
                imageView.setAlpha(floatValue3);
                float f7 = (floatValue3 * 0.5f) + 0.5f;
                imageView.setScaleX(f7);
                imageView.setScaleY(f7);
                View view = v10Var.f38593f;
            ...
            case 17:
                ...
                return;
            case 18:
                yj0 yj0Var = (yj0) this.f32552b;
                yj0Var.getClass();
                yj0Var.f40184f = Math.max(1.0f, ((Float) valueAnimator.getAnimatedValue()).floatValue());
                yj0Var.invalidate();
                return;
            case 19:
                PasscodeActivity passcodeActivity = (PasscodeActivity) this.f32552b;
                ...
                return;
            case 20:
                PhotoViewer photoViewer = ((ut0) this.f32552b).d;
                photoViewer.T1.f34062k0 = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                photoViewer.T1.invalidate();
                return;
            case 21:
                PhotoViewer photoViewer2 = ((ut0) this.f32552b).d;
                photoViewer2.T1.f34062k0 = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                photoViewer2.T1.invalidate();
                return;
            case 22:
                ((PhotoViewer) ((org.telegram.ui.Components.qm0) this.f32552b).f27714b).T1.scrollTo(0, ((Integer) valueAnimator.getAnimatedValue()).intValue());
                return;
            case 23:
                PhotoViewer photoViewer3 = ((xt0) this.f32552b).f39990r;
                photoViewer3.f31297m6 = 1.0f - ((Float) valueAnimator.getAnimatedValue()).floatValue();
                photoViewer3.F1();
                return;
            case 24:
                mu0 mu0Var = (mu0) this.f32552b;
                mu0Var.getClass();
                mu0Var.setAlpha(((Float) valueAnimator.getAnimatedValue()).floatValue());
                return;
            case 25:
                hv0 hv0Var = (hv0) this.f32552b;
                hv0Var.getClass();
                hv0Var.A = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                hv0Var.e();
                return;
            case 26:
                ((xy0) this.f32552b).G.f31525a.invalidate();
                return;
            case 27:
                ((c01) this.f32552b).f32538g2.U4();
                return;
            case 28:
                r01 r01Var = (r01) this.f32552b;
            ...
            default:
                ...
                if (u0Var != null && !profileActivity.f31632p2) {
