...
public final class xq0 implements org.telegram.ui.Cells.r5 {
    public final yq0 f39665a;
    ...
    public final void b(org.telegram.ui.Cells.s5 s5Var) {
        ...
        if (albumEntry != null) {
            ...
            boolean containsKey = ar0Var.f31910b.containsKey(Integer.valueOf(photoEntry.imageId));
            z10 = !containsKey;
            if (!containsKey && ar0Var.H > 0 && ar0Var.f31910b.size() >= ar0Var.H) {
                a();
                return;
            }
            if (ar0Var.e && !containsKey) {
                i10 = ar0Var.f31912c.size();
            }
            s5Var.b(i10, z10, true);
            ar0Var.Y(intValue, photoEntry);
        } else {
            AndroidUtilities.hideKeyboard(ar0Var.getParentActivity().getCurrentFocus());
            MediaController.SearchImage searchImage = (MediaController.SearchImage) ar0Var.f31916f.get(intValue);
            boolean containsKey2 = ar0Var.f31910b.containsKey(searchImage.f15597id);
            z10 = !containsKey2;
            if (!containsKey2 && ar0Var.H > 0 && ar0Var.f31910b.size() >= ar0Var.H) {
                a();
                return;
            }
