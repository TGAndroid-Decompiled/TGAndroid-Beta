...
public final class ad1 implements org.telegram.ui.Components.lq {
    ...
    public final int K0(int i10) {
        ...
        xd1 xd1Var = this.f31834a;
        if (xd1Var.f39568n == 3) {
            org.telegram.ui.ActionBar.i6 i6Var = xd1Var.f39545e0;
            if (i6Var.S && i10 == 0 && (h6Var = (org.telegram.ui.ActionBar.h6) i6Var.f18757a0.get(org.telegram.ui.ActionBar.j6.f19040n)) != null) {
                return h6Var.e;
            }
            return 0;
        }
    ...
    public final void l(boolean z10) {
        ...
        if (z10) {
            if (h6Var.f18734r == null) {
                ...
                MessagesController.getInstance(i11).saveThemeToServer(h6Var.f18721b, h6Var);
                NotificationCenter.getGlobalInstance().lambda$postNotificationNameOnUIThread$1(NotificationCenter.needShareTheme, h6Var.f18721b, h6Var);
                return;
            }
    ...
    public final void y() {
        ...
        if (xd1Var.getParentActivity() != null) {
            ...
            alertDialog$Builder.f18446a.R = LocaleController.getString(R.string.DeleteThemeTitle);
            alertDialog$Builder.f18446a.T = LocaleController.getString(R.string.DeleteThemeAlert);
            ...
            if (textView != null) {
                textView.setTextColor(xd1Var.getThemedColor(org.telegram.ui.ActionBar.j6.f19100q7));
            }
        }
    }
}
