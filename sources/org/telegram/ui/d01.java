...
public class d01 extends org.telegram.ui.Components.w9 implements org.telegram.ui.Components.xv0 {
    public static final t0 f32835g0 = new t0("crossfadeProgress", 3);
    public boolean G;
    public float H;
    public float I;
    public int J;
    ...
    public boolean f32836a0;
    public float f32837b0;
    public org.telegram.ui.Components.zh0 f32838c0;
    public boolean f32839d0;
    public float f32840e0;
    public Runnable f32841f0;
    ...
    public final void invalidate() {
        super.invalidate();
        org.telegram.ui.Components.zh0 zh0Var = this.f32838c0;
        if (zh0Var != null) {
            zh0Var.invalidate();
        }
        Runnable runnable = this.f32841f0;
        if (runnable != null) {
            runnable.run();
        }
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (z10) {
            org.telegram.ui.Components.qh0 blurDrawer = this.f32838c0.getBlurDrawer();
            if (blurDrawer == null) {
                z12 = false;
            }
            boolean z13 = z12;
        ...
        float z14 = org.telegram.messenger.f0.z(1.0f, this.V, this.f32840e0, (1.0f - this.f32837b0) * f7);
        ...
        if (imageReceiver != null && f12 > f11 && (this.V < 1.0f || !this.f32836a0)) {
            float f22 = z14 * f10;
        ...
        if (this.V > f11 && this.f32836a0 && f12 > f11) {
        ...
        if (z11) {
            ...
            if (!this.G && !qh0Var.f27615a && this.f32838c0.getRealPosition() != 0) {
                f13 = 1.0f;
            } else {
                f13 = 1.0f - this.H;
            }
