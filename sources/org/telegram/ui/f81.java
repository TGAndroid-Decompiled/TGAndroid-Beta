...
public final class f81 extends FrameLayout {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.f36365e) {
            canvas.drawRect(AndroidUtilities.dp(64.0f), getMeasuredHeight() - 1, getMeasuredWidth(), getMeasuredHeight(), org.telegram.ui.ActionBar.j6.f20812k0);
        }
    }
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (r02 != null) {
            ...
            sb2.append((Object) this.f36363b.getText());
            sb2.append("\n");
            sb2.append((Object) this.f36364c.getText());
            sb2.append("\n");
            if (r02.h) {
