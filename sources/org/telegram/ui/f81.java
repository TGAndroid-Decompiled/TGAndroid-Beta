...
public final class f81 extends FrameLayout {
    ...
    public final TextView f36364b;
    public final TextView f36365c;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.f36366e) {
            canvas.drawRect(AndroidUtilities.dp(64.0f), getMeasuredHeight() - 1, getMeasuredWidth(), getMeasuredHeight(), org.telegram.ui.ActionBar.j6.f20813k0);
        }
    }
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (r02 != null) {
            ...
            sb2.append((Object) this.f36364b.getText());
            sb2.append("\n");
            sb2.append((Object) this.f36365c.getText());
            sb2.append("\n");
            if (r02.h) {
