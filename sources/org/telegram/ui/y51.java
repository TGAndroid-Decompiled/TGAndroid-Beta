...
public final class y51 implements org.telegram.ui.Components.dl0 {
    ...
    public final Context f39794b;
    public final org.telegram.ui.ActionBar.f6 f39795c;
    ...
    public final boolean mo18c(float f7, float f10, int i10, View view) {
        ...
        if (i12 != 11 && i12 != 13 && i71Var.f34462h1) {
            ...
            if (z10 && (i12 == 1 || i12 == 8)) {
                ...
                r61 r61Var = (r61) view;
                if (!r61Var.f37099s && !UserConfig.getInstance(i11).isPremium()) {
                ...
                if (r61Var.f37099s) {
                    ...
                    TLRPC.TL_availableReaction tL_availableReaction = MediaDataController.getInstance(i11).getReactionsMap().get(i71Var.S0.f37101x.f49150f);
                    if (tL_availableReaction != null) {
                        i71Var.V0.setImage(ImageLocation.getForDocument(tL_availableReaction.select_animation), "60_60_pcache", null, null, null, 0L, "tgs", i71Var.S0.f37101x, 0);
                    }
                } else {
                ...
                if (r61Var2.e != null && (i12 == 0 || i12 == 12 || i12 == 9 || i12 == 10)) {
                    ...
                    x51 x51Var = new x51(this, this.f39794b, i71Var.T1, i71Var, r61Var2, this.f39795c, view, tL_starGiftUnique);
                    i71Var.X0 = x51Var;
                    x51Var.show();
                    try {
