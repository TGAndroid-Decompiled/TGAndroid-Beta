...
public final class um extends org.telegram.ui.Components.ov0 {
    ...
    public void setNonNoveTranslation(float f7) {
        ...
        di.f4 f4Var = coVar.f35489w1;
        if (f4Var != null) {
            f4Var.setTranslationY(0.0f);
        }
        di.f4 f4Var2 = coVar.f35476v1;
        if (f4Var2 != null) {
    ...
    public final void a0(Canvas canvas, float f7, org.telegram.ui.Cells.t1 t1Var, int i10) {
        ...
        co coVar = this.J0;
        float x10 = t1Var.getX() + coVar.f35501x0.getLeft();
        float y3 = t1Var.getY() + coVar.f35501x0.getY() + t1Var.getPaddingTop();
        if (t1Var.a()) {
            f10 = t1Var.getAlpha();
        } else {
            f10 = 1.0f;
        }
        canvas.clipRect(coVar.f35501x0.getLeft(), f7, coVar.f35501x0.getRight(), ((((coVar.f35501x0.getY() + coVar.f35501x0.getMeasuredHeight()) - coVar.Aa) - coVar.v.d()) - coVar.f35449sc) - AndroidUtilities.dp(9.0f));
    ...
    public final void addView(View view, int i10, ViewGroup.LayoutParams layoutParams) {
        ...
        if (mkVar2 != null && view == mkVar2.m0) {
            ...
            yVar.setBackgroundDrawable(bVar.c(yVar.f10128c, coVar.f35500x, false));
        }
        mk mkVar3 = coVar.Y;
    ...
    public final boolean b0(View view) {
        if (view != this.L) {
            co coVar = this.J0;
            if (view != coVar.f35516y2 && view != coVar.f35411q1 && view != coVar.f35370m9 && view != coVar.X && view != coVar.K3) {
                return false;
            }
            return true;
        }
    ...
    public final boolean dispatchKeyEvent(KeyEvent keyEvent) {
        il ilVar;
        if (keyEvent.getKeyCode() == 4 && keyEvent.getAction() == 1 && (ilVar = this.J0.Ea) != null && ilVar.f32259s) {
            ilVar.a(true);
            return true;
        }
    ...
    public float getBottomOffset() {
        return this.J0.f35501x0.getBottom();
    }
    ...
    public float getListTranslationY() {
        return this.J0.f35501x0.getTranslationY();
    }

    @Override
    public Drawable getNewDrawable() {
        Drawable d = this.J0.f35275ea.d();
        if (d != null) {
            return d;
        }
    ...
    public boolean getNewDrawableMotion() {
        TLRPC.WallPaper wallPaper = this.J0.f35275ea.h;
        if (wallPaper == null) {
    ...
    public int getScrollOffset() {
        return this.J0.f35501x0.computeVerticalScrollOffset();
    }
    ...
    public final void onAttachedToWindow() {
        ...
        if (!coVar.Oa) {
            ...
            if (d5Var != null) {
                ...
                if (((ActionBarLayout) d5Var2).f20168b) {
                    org.telegram.ui.ActionBar.p1 p1Var = this.H;
                    d5Var3 = ((org.telegram.ui.ActionBar.n2) coVar).parentLayout;
                    p1Var.f21305b = (FrameLayout) d5Var3.getView().getParent().getParent().getParent().getParent();
                }
            }
        } else {
            this.H.f21305b = coVar.X0;
        }
        this.H.c();
        ...
        if (playingMessageObject != null && ((playingMessageObject.isRoundVideo() || playingMessageObject.isVideo()) && playingMessageObject.eventId == 0 && playingMessageObject.getDialogId() == coVar.T5)) {
            MediaController.getInstance().setTextureView(coVar.N7(false), coVar.f35483v8, coVar.f35458t8, true);
        }
        aq aqVar = coVar.P9;
        if (aqVar != null) {
            aqVar.f();
    ...
    public final void onDetachedFromWindow() {
        ...
        aq aqVar = coVar.P9;
        if (aqVar != null) {
            NotificationCenter.getInstance(aqVar.f34540e0).removeObserver(aqVar, NotificationCenter.updateInterfaces);
            aqVar.F.onDetachedFromWindow();
            org.telegram.ui.Components.q5 q5Var = aqVar.f34547k0;
            if (q5Var != null && (view = aqVar.f34533a0) != null) {
                q5Var.o(view);
            }
            aqVar.Q = 0.0f;
            aqVar.P = 0L;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (getTag(67108867) == null) {
            if (getTag(67108867) == null && (r6Var = (coVar = this.J0).f35516y2) != null && r6Var.a() && coVar.f35516y2.getTag() != null) {
                return;
            }
            super.onDraw(canvas);
        }
    ...
    public final void onSizeChanged(int i10, int i11, int i12, int i13) {
        ...
        co coVar = this.J0;
        hh.d.c(coVar.f35534z8, coVar.fragmentView);
        coVar.A8.d();
    }
