...
public final class pc extends org.telegram.ui.Components.ll0 {
    ...
    @Override
    public final int h() {
        return this.f36596c.R;
    }

    @Override
    public final int j(int i10) {
        cd cdVar = this.f36596c;
        if (i10 == cdVar.S) {
            return 0;
        }
        if (i10 == cdVar.W) {
        ...
        if (i10 == cdVar.f32731b0) {
            return 4;
        }
        if (i10 != cdVar.U && i10 != cdVar.f32733c0 && i10 != cdVar.f32737f0 && i10 != cdVar.f32739h0 && i10 != cdVar.f32741j0) {
            if (i10 != cdVar.X && i10 != cdVar.f32735e0) {
                return 7;
            }
            return 5;
        }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i16 != 1) {
            if (i16 != 3) {
                if (i16 != 4) {
                    if (i16 != 5) {
                        ...
                        if (i10 == cdVar.U) {
                            ...
                            if (cdVar.f32730b < cdVar.J0()) {
                                qcVar.e(cdVar.J0());
                            } else {
                                qcVar.e(0);
                            }
                            qcVar.c(cdVar.f32756w, false, false);
                            return;
                        } else if (i10 == cdVar.f32737f0) {
                            i13 = ((org.telegram.ui.ActionBar.o2) cdVar).currentAccount;
                            qcVar.a(i13, cdVar.f32751s, false);
                            k5Var.l(LocaleController.getString(cdVar.G0()), false);
                            if (cdVar.f32730b < cdVar.F0()) {
                                qcVar.e(cdVar.F0());
                            } else {
                                qcVar.e(0);
                            }
                            qcVar.c(DialogObject.getEmojiStatusDocumentId(cdVar.f32760y), DialogObject.isEmojiStatusCollectible(cdVar.f32760y), false);
                            return;
                        } else if (i10 == cdVar.f32739h0) {
                            i12 = ((org.telegram.ui.ActionBar.o2) cdVar).currentAccount;
                            qcVar.a(i12, cdVar.f32751s, false);
                            k5Var.l(LocaleController.getString(cdVar.B0()), false);
                            if (cdVar.f32730b < cdVar.H0()) {
                                qcVar.e(cdVar.H0());
                            } else {
                                qcVar.e(0);
                            }
                ...
                ((zp0) view).a(cdVar.f32751s, false);
                return;
            }
            ((tc) view).a(cdVar.f32736f, false);
            return;
        }
        vc vcVar = (vc) view;
        ip0 ip0Var = vcVar.f38387a;
        uc ucVar = vcVar.f38388b;
        i11 = ((org.telegram.ui.ActionBar.o2) cdVar).currentAccount;
        ip0Var.b(i11, cdVar.f32751s, false);
        ucVar.b(cdVar.f32751s, false);
        ucVar.d(cdVar.f32756w, false, false);
        ucVar.setForum(cdVar.R0());
        ucVar.e(DialogObject.getEmojiStatusDocumentId(cdVar.f32760y), false, false);
        ucVar.a(cdVar.f32736f);
    }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 == 0) {
                ...
                public final void run(Object obj) {
                    switch (r2) {
                        case 0:
                            ...
                            cd cdVar2 = this.f36298b.f36596c;
                            if (str == null) {
                                cdVar2.F = cdVar2.G;
                            } else if (str.equals("❌")) {
                                cdVar2.F = null;
                            ...
                            return;
                        default:
                            cd cdVar3 = this.f36298b.f36596c;
                            cdVar3.f32751s = ((Integer) obj).intValue();
                            if (cdVar3.f32760y instanceof TLRPC.TL_emojiStatusCollectible) {
                                cdVar3.f32760y = null;
                            }
                            cdVar3.X0(true);
                            cdVar3.b1();
            ...
            frameLayout.f36895c = new org.telegram.ui.Components.m5(AndroidUtilities.dp(24.0f), 13, frameLayout, false);
            adVar = frameLayout;
        } else if (i10 == 3) {
            ...
            tcVar.f37716b.setOnItemClickListener(new ai.o6(5, this, tcVar));
            adVar = tcVar;
        } else if (i10 == 4) {
    ...
    public final void y(s4.c1 c1Var) {
        ...
        cd cdVar = this.f36596c;
        if (z10) {
            uc ucVar = ((vc) view).f38388b;
            TLRPC.EmojiStatus emojiStatus = cdVar.f32760y;
            if (emojiStatus instanceof TLRPC.TL_emojiStatusCollectible) {
                ucVar.c(MessagesController.PeerColor.fromCollectible(emojiStatus), false);
                ucVar.d(((TLRPC.TL_emojiStatusCollectible) cdVar.f32760y).pattern_document_id, true, false);
            } else {
                ucVar.b(cdVar.f32751s, false);
                ucVar.d(cdVar.f32756w, false, false);
            }
            ucVar.e(DialogObject.getEmojiStatusDocumentId(cdVar.f32760y), DialogObject.isEmojiStatusCollectible(cdVar.f32760y), false);
            ucVar.setForum(cdVar.R0());
            ucVar.a(cdVar.f32736f);
