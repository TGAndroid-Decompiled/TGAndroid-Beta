...
public final class vp0 extends FrameLayout {
    ...
    public org.telegram.ui.Components.h01 f38491b;
    public final org.telegram.ui.Components.m5 f38492c;
    public final wp0 d;
    ...
    public vp0(wp0 wp0Var, Context context) {
        ...
        setBackgroundColor(cq0Var.getThemedColor(org.telegram.ui.ActionBar.j6.f18863d6));
        TextView textView = new TextView(context);
        this.f38490a = textView;
        textView.setTextSize(1, 16.0f);
        boolean z10 = cq0Var.f32851a;
        ...
        this.f38492c = new org.telegram.ui.Components.m5(AndroidUtilities.dp(24.0f), 13, this, false);
    }
    ...
    public final int a() {
        ...
        int i12 = wp0Var.h;
        if (i12 < 0) {
            int i13 = org.telegram.ui.ActionBar.j6.f19140s8;
            if (AndroidUtilities.computePerceivedBrightness(cq0Var.getThemedColor(i13)) > 0.8f) {
                int i14 = org.telegram.ui.ActionBar.j6.f19048n6;
                ...
                int i16 = org.telegram.ui.ActionBar.j6.f18863d6;
            ...
            return cq0Var.getThemedColor(org.telegram.ui.ActionBar.j6.f19121r8[i12]);
        } else {
            if (wp0Var.m0 == 1) {
            ...
            return cq0Var.getThemedColor(org.telegram.ui.ActionBar.j6.f19121r8[0]);
        }
    }
    ...
    public final void b(boolean z10) {
        int i10;
        wp0 wp0Var = this.d;
        long j3 = wp0Var.f39149n;
        org.telegram.ui.Components.m5 m5Var = this.f38492c;
        if (j3 != 0) {
            m5Var.j(j3, z10);
            this.f38491b = null;
            return;
        ...
        if (this.f38491b == null) {
            if (wp0Var.f39152p0.f32851a) {
                i10 = R.string.ChannelReplyIconOff;
            } else {
                i10 = R.string.UserReplyIconOff;
            }
            this.f38491b = new org.telegram.ui.Components.h01(LocaleController.getString(i10), 16.0f, null);
        }
    }
    ...
    public final void c() {
        ...
        if (z10) {
            ...
            width = (getWidth() - m5Var.f26060s) - AndroidUtilities.dp(21.0f);
        }
        int height = (getHeight() - m5Var.f26060s) / 2;
        if (LocaleController.isRTL) {
            width2 = AndroidUtilities.dp(21.0f) + m5Var.f26060s;
        } else {
            width2 = getWidth() - AndroidUtilities.dp(21.0f);
        }
        m5Var.setBounds(width, height, width2, (getHeight() + m5Var.f26060s) / 2);
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        org.telegram.ui.Components.m5 m5Var = this.f38492c;
        m5Var.k(valueOf);
        org.telegram.ui.Components.h01 h01Var = this.f38491b;
        if (h01Var != null) {
            h01Var.c((getMeasuredWidth() - this.f38491b.l()) - AndroidUtilities.dp(19.0f), getMeasuredHeight() / 2.0f, 1.0f, this.d.f39152p0.getThemedColor(org.telegram.ui.ActionBar.j6.q6), canvas);
        } else {
            m5Var.draw(canvas);
        }
    }
