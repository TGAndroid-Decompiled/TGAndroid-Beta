...
public final class vp0 extends FrameLayout {
    public final TextView f38585a;
    public org.telegram.ui.Components.u01 f38586b;
    public final org.telegram.ui.Components.n5 f38587c;
    public final wp0 d;
    ...
    public vp0(wp0 wp0Var, Context context) {
        ...
        this.f38585a = textView;
        textView.setTextSize(1, 16.0f);
        boolean z10 = cq0Var.f32808a;
        ...
        this.f38587c = new org.telegram.ui.Components.n5(AndroidUtilities.dp(24.0f), 13, this, false);
    }
    ...
    public final int a() {
        ...
        int i12 = wp0Var.h;
        if (i12 < 0) {
            int i13 = org.telegram.ui.ActionBar.j6.f19372s8;
            if (AndroidUtilities.computePerceivedBrightness(cq0Var.getThemedColor(i13)) > 0.8f) {
                int i14 = org.telegram.ui.ActionBar.j6.f19279n6;
            ...
            return cq0Var.getThemedColor(org.telegram.ui.ActionBar.j6.f19353r8[i12]);
        } else {
            if (wp0Var.m0 == 1) {
            ...
            return cq0Var.getThemedColor(org.telegram.ui.ActionBar.j6.f19353r8[0]);
        }
    }
    ...
    public final void b(boolean z10) {
        int i10;
        wp0 wp0Var = this.d;
        long j3 = wp0Var.f39208n;
        org.telegram.ui.Components.n5 n5Var = this.f38587c;
        if (j3 != 0) {
            n5Var.j(j3, z10);
            this.f38586b = null;
            return;
        ...
        if (this.f38586b == null) {
            if (wp0Var.f39211p0.f32808a) {
                i10 = R.string.ChannelReplyIconOff;
            } else {
                i10 = R.string.UserReplyIconOff;
            }
            this.f38586b = new org.telegram.ui.Components.u01(LocaleController.getString(i10), 16.0f, null);
        }
    }
    ...
    public final void c() {
        ...
        if (z10) {
            ...
            width = (getWidth() - n5Var.f26568s) - AndroidUtilities.dp(21.0f);
        }
        int height = (getHeight() - n5Var.f26568s) / 2;
        if (LocaleController.isRTL) {
            width2 = AndroidUtilities.dp(21.0f) + n5Var.f26568s;
        } else {
            width2 = getWidth() - AndroidUtilities.dp(21.0f);
        }
        n5Var.setBounds(width, height, width2, (getHeight() + n5Var.f26568s) / 2);
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        org.telegram.ui.Components.n5 n5Var = this.f38587c;
        n5Var.k(valueOf);
        org.telegram.ui.Components.u01 u01Var = this.f38586b;
        if (u01Var != null) {
            u01Var.c((getMeasuredWidth() - this.f38586b.l()) - AndroidUtilities.dp(19.0f), getMeasuredHeight() / 2.0f, 1.0f, this.d.f39211p0.getThemedColor(org.telegram.ui.ActionBar.j6.q6), canvas);
        } else {
            n5Var.draw(canvas);
        }
    }
