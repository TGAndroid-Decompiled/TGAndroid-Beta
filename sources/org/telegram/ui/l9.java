...
public final class l9 extends org.telegram.ui.ActionBar.p2 implements NotificationCenter.NotificationCenterDelegate, vg0 {
    ...
    public final ArrayList f38572a0;
    public i9 f38573b;
    public final RectF f38574b0;
    public f2.j0 f38575c;
    public final RectF f38576c0;
    public org.telegram.ui.Components.h61 d;
    public c2.y f38577e;
    public org.telegram.ui.Components.a20 f38578f;
    public org.telegram.ui.Components.u00 h;
    public lh.j4 f38579n;
    public fg.i0 f38580r;
    public qh.e3 f38581s;
    public boolean v;
    public boolean f38582w;
    public ImageView f38583x;
    public NumberTextView f38584y;
    ...
    public static void U(l9 l9Var) {
        ...
        ImageView imageView = l9Var.f38583x;
        if (imageView != null) {
            imageView.setColorFilter(new PorterDuffColorFilter(l9Var.getThemedColor(org.telegram.ui.ActionBar.k6.f22040y8), PorterDuff.Mode.MULTIPLY));
            l9Var.f38583x.setBackground(org.telegram.ui.ActionBar.k6.f0(l9Var.getThemedColor(org.telegram.ui.ActionBar.k6.f22057z8), 1, -1));
        }
    ...
    public static void X(l9 l9Var, org.telegram.ui.Components.h51 h51Var, View view) {
        ...
        if (i10 == 2) {
            ...
            if (obj instanceof h9) {
                h9 h9Var = (h9) obj;
                ArrayList arrayList = h9Var.f37269c;
                if (l9Var.actionBar.s()) {
                    l9Var.e0(arrayList, (g9) view);
                } else if (h9Var.f37267a != 0 && !arrayList.isEmpty()) {
                    boolean z4 = h9Var.f37270e;
                    HashSet hashSet = new HashSet();
                    ArrayList arrayList2 = h9Var.f37268b;
                    int size = arrayList2.size();
                    int i11 = 0;
                    while (i11 < size) {
                        Object obj2 = arrayList2.get(i11);
                        i11++;
                        hashSet.add(Long.valueOf(((TLRPC.User) obj2).f20992id));
                    }
                    TLRPC.TL_inputGroupCallInviteMessage tL_inputGroupCallInviteMessage = new TLRPC.TL_inputGroupCallInviteMessage();
                    tL_inputGroupCallInviteMessage.msg_id = ((TLRPC.Message) arrayList.get(0)).f20866id;
                    ...
                    bundle.putInt("message_id", ((TLRPC.Message) arrayList.get(0)).f20866id);
                ...
                bundle2.putLong("chat_id", ((k9) view).f38211c.f20845id);
                l9Var.getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.closeChats, new Object[0]);
    ...
    public static void o0(final Context context, int i10, TLRPC.InputGroupCall inputGroupCall, String str, final org.telegram.ui.ActionBar.g6 g6Var, boolean z4, final boolean z10) {
        String str2;
        int i11;
        int v02 = org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.f21733h5, g6Var);
        ...
        int v03 = org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.f22038y6, g6Var);
        ...
        int i14 = org.telegram.ui.ActionBar.k6.f21607a7;
        ...
        imageView3.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.f21913r5, g6Var), mode));
        ...
        if (z4) {
            ...
            b9Var.setGravity(17);
            b9Var.setTextColor(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.f22055z6, g6Var));
    ...
    public final View createView(Context context) {
        ...
        org.telegram.ui.Components.h61 h61Var = new org.telegram.ui.Components.h61(this, new d5(this, 1), new m8(this), new m8(this));
        this.d = h61Var;
        int i11 = org.telegram.ui.ActionBar.k6.f21607a7;
        h61Var.setBackgroundColor(org.telegram.ui.ActionBar.k6.v0(i11, this.resourceProvider));
        this.d.o1();
        this.d.V2.f32651r = false;
        this.f38579n = new lh.j4(this, context, 1);
        vg.i iVar = new vg.i(this.f38579n);
        lh.j4 j4Var = this.f38579n;
        og.a aVar = this.Y;
        aVar.d = iVar;
        aVar.f16756e = j4Var;
        org.telegram.ui.Components.h61 h61Var2 = this.d;
        Objects.requireNonNull(h61Var2);
        this.Z = new og.k(h61Var2, j4Var, new x8(h61Var2, 0));
        this.d.C0(new l8(this, 6));
        lh.j4 j4Var2 = this.f38579n;
        ...
        this.h.f31465w = false;
        i9 i9Var = new i9(this, context, this.h);
        this.f38573b = i9Var;
        this.f38579n.addView(i9Var, k7.c6.c(-1.0f, -1));
        this.d.setClipToPadding(false);
        this.d.setEmptyView(this.f38573b);
        ...
        h61Var4.setVerticalScrollbarPosition(i10);
        c2.y yVar = new c2.y(this.d, this.f38575c);
        this.f38577e = yVar;
        yVar.h = new m8(this);
        lh.j4 j4Var3 = this.f38579n;
        org.telegram.ui.Components.h61 h61Var5 = this.d;
        float f10 = -this.f38571a;
        j4Var3.addView(h61Var5, k7.c6.d(-1, -1.0f, 3, 0.0f, f10, 0.0f, f10));
        ...
        this.f38578f = a20Var;
        a20Var.f25132c.setImageResource(R.drawable.filled_calls_plus);
        this.f38578f.setContentDescription(LocaleController.getString(R.string.Call));
        this.f38578f.setOnClickListener(new p8(this, 3));
        this.f38579n.addView(this.f38578f, org.telegram.ui.Components.a20.b());
        ...
        z8 z8Var = new z8(this, context, this, this.f38579n, this.resourceProvider, 0);
        this.L = z8Var;
        this.K.addView(z8Var);
        this.J.setCallFragmentContextView(this.L);
        this.f38579n.addView(this.J, k7.c6.d(-1, -2.0f, 48, 0.0f, -14.0f, 0.0f, 0.0f));
        this.f38579n.addView(this.actionBar);
        fg.i0 i0Var = new fg.i0(context, this.parentLayout);
        this.f38580r = i0Var;
        i0Var.b(false, false);
        this.f38579n.addView(this.f38580r, k7.c6.e(-1, 5, 48));
        this.actionBar.setDrawBlurBackground(this.f38579n);
    ...
    public final void e0(ArrayList arrayList, g9 g9Var) {
        ...
        if (l02) {
            ...
            for (int i10 = 0; i10 < size; i10++) {
                arrayList2.remove(Integer.valueOf(((TLRPC.Message) arrayList.get(i10)).f20866id));
            }
            org.telegram.ui.Components.np npVar = g9Var.f37030e;
            if (npVar != null) {
                npVar.a(false, true);
            }
            q0();
        ...
        for (int i11 = 0; i11 < size2; i11++) {
            Integer valueOf = Integer.valueOf(((TLRPC.Message) arrayList.get(i11)).f20866id);
            if (!arrayList2.contains(valueOf)) {
                arrayList2.add(valueOf);
            }
        }
        org.telegram.ui.Components.np npVar2 = g9Var.f37030e;
        if (npVar2 != null) {
            npVar2.a(true, true);
        }
        q0();
    ...
    public final void f0() {
        ...
        if (Build.VERSION.SDK_INT >= 31 && (eVar = this.V) != null) {
            ...
            this.f38574b0.set(0.0f, -dp, this.fragmentView.getMeasuredWidth(), this.actionBar.getMeasuredHeight() + dp);
            RectF rectF = this.f38576c0;
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.m6(this.f38573b, 4, new Class[]{i9.class}, new String[]{"emptyTextView1"}, null, null, -1, null, org.telegram.ui.ActionBar.k6.G6));
        arrayList.add(new org.telegram.ui.ActionBar.m6(this.f38573b, 4, new Class[]{i9.class}, new String[]{"emptyTextView2"}, null, null, -1, null, org.telegram.ui.ActionBar.k6.f21644c7));
        arrayList.add(new org.telegram.ui.ActionBar.m6(this.d, 0, new Class[]{org.telegram.ui.Cells.s4.class}, new String[]{"progressBar"}, null, null, -1, null, org.telegram.ui.ActionBar.k6.f21734h6));
        ...
        org.telegram.ui.Components.a20 a20Var = this.f38578f;
        if (a20Var != null) {
            arrayList.add(new org.telegram.ui.ActionBar.m6(a20Var.f25132c, 8, null, null, null, null, org.telegram.ui.ActionBar.k6.O9));
            arrayList.add(new org.telegram.ui.ActionBar.m6(this.f38578f.f25132c, 32, null, null, null, null, org.telegram.ui.ActionBar.k6.P9));
            arrayList.add(new org.telegram.ui.ActionBar.m6(this.f38578f.f25132c, 65568, null, null, null, null, org.telegram.ui.ActionBar.k6.Q9));
        }
        ...
        arrayList.add(new org.telegram.ui.ActionBar.m6(this.d, 0, new Class[]{g9.class}, null, new Drawable[]{org.telegram.ui.ActionBar.k6.f21747i1}, null, org.telegram.ui.ActionBar.k6.A9));
        arrayList.add(new org.telegram.ui.ActionBar.m6(this.d, 0, new Class[]{g9.class}, null, new Drawable[]{org.telegram.ui.ActionBar.k6.f21693f1}, null, org.telegram.ui.ActionBar.k6.f22058z9));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.m6(this.d, 0, new Class[]{g9.class}, org.telegram.ui.ActionBar.k6.P0, null, null, org.telegram.ui.ActionBar.k6.f21877p6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.m6(this.d, 0, new Class[]{g9.class}, null, org.telegram.ui.ActionBar.k6.f21908r0, null, org.telegram.ui.ActionBar.k6.J7));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.m6(this.d, 0, new Class[]{View.class}, null, new Drawable[]{null, null, org.telegram.ui.ActionBar.k6.W4, org.telegram.ui.ActionBar.k6.Y4}, null, org.telegram.ui.ActionBar.k6.f21915r7));
    ...
    public final void i0() {
        ...
        this.f38573b.setPadding(0, 0, 0, this.T + this.Q);
    }
    ...
    public final void k0(boolean z4) {
        ...
        for (int i10 = 0; i10 < childCount; i10++) {
            ...
            if ((childAt instanceof g9) && (npVar = ((g9) childAt).f37030e) != null) {
                npVar.a(false, z4);
            }
        }
        this.d.V2.N(true);
    ...
    public final boolean l0(ArrayList arrayList) {
        int size = arrayList.size();
        for (int i10 = 0; i10 < size; i10++) {
            if (this.I.contains(Integer.valueOf(((TLRPC.Message) arrayList.get(i10)).f20866id))) {
                return true;
            }
        }
        return false;
    ...
    public final void onBecomeFullyVisible() {
        ...
        if (!this.P && getUserConfig().showCallsTab && MessagesController.getGlobalMainSettings().getInt("hidecallshint", 0) < 2) {
            ...
            e3Var.d = 3000L;
            e3Var.l(1.0f, -25.0f);
            this.f38581s.setPadding(0, AndroidUtilities.dp(4.0f), 0, 0);
            this.f38581s.s(AndroidUtilities.replaceTags(LocaleController.getString(R.string.TapToHideCallsTab)));
            this.f38579n.addView(this.f38581s, k7.c6.e(-1, 80, 48));
            this.f38581s.setTranslationY((org.telegram.ui.ActionBar.k.getCurrentActionBarHeight() + AndroidUtilities.statusBarHeight) - AndroidUtilities.dp(16.0f));
            this.f38581s.u();
            this.P = true;
    ...
    public final boolean onFragmentCreate() {
        ...
        if (bundle != null) {
            ...
            this.f38582w = this.arguments.getBoolean("hasMainTabs", false);
        }
        if (this.f38582w) {
    ...
    public final void onRequestPermissionsResultFragment(int i10, String[] strArr, int[] iArr) {
        ...
        if (iArr.length > 0 && z4) {
            ...
            if (this.M != null) {
                userFull = getMessagesController().getUserFull(this.M.f20992id);
            }
            ...
            org.telegram.ui.Components.voip.g2.m(user, z10, z11, getParentActivity(), null, getAccountInstance());
            return;
        }
    ...
    public final void q0() {
        ...
        if (s6) {
            ...
            if (!a2) {
                ...
                if (this.f38582w) {
                    ...
                    this.f38583x = imageView;
                    imageView.setScaleType(ImageView.ScaleType.CENTER);
                    this.f38583x.setImageDrawable(new org.telegram.ui.ActionBar.i2(true));
                    this.f38583x.setColorFilter(new PorterDuffColorFilter(getThemedColor(org.telegram.ui.ActionBar.k6.f22040y8), PorterDuff.Mode.MULTIPLY));
                    this.f38583x.setBackground(org.telegram.ui.ActionBar.k6.f0(getThemedColor(org.telegram.ui.ActionBar.k6.f22057z8), 1, -1));
                    this.f38583x.setOnClickListener(new p8(this, 1));
                    j10.addView(this.f38583x, k7.c6.q(54, 54, 16));
                    arrayList2.add(this.f38583x);
                }
                NumberTextView numberTextView = new NumberTextView(j10.getContext());
                this.f38584y = numberTextView;
                numberTextView.setTextSize(18);
                this.f38584y.setTypeface(AndroidUtilities.bold());
                this.f38584y.setTextColor(org.telegram.ui.ActionBar.k6.w0(null, org.telegram.ui.ActionBar.k6.f22040y8, false));
                NumberTextView numberTextView2 = this.f38584y;
                if (this.f38582w) {
                    i10 = 18;
                } else {
                    i10 = 72;
                ...
                this.f38584y.setOnTouchListener(new org.telegram.ui.ActionBar.s2(1));
        ...
        this.f38584y.a(arrayList.size(), z4);
    }

    @Override
    public final void s() {
        if (this.f38575c.L0() < 15) {
            this.d.x0(0);
            return;
        }
        c2.y yVar = this.f38577e;
        yVar.f2206b = 1;
    ...
    public l9(Bundle bundle) {
        ...
        this.U = new Rect();
        ArrayList arrayList = new ArrayList();
        this.f38572a0 = arrayList;
        RectF rectF = new RectF();
        this.f38574b0 = rectF;
        RectF rectF2 = new RectF();
        this.f38576c0 = rectF2;
        arrayList.add(rectF);
        arrayList.add(rectF2);
        tg.c cVar = new tg.c();
        cVar.a(getThemedColor(org.telegram.ui.ActionBar.k6.f21607a7));
        if (i10 >= 31) {
