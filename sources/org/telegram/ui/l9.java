...
public final class l9 extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate, eh0 {
    ...
    public final fh.d f35290a0;
    public i9 f35291b;
    public final ah.c f35292b0;
    public s4.c0 f35293c;
    public ah.o f35294c0;
    public org.telegram.ui.Components.t61 d;
    public final ArrayList f35295d0;
    public org.telegram.ui.Components.zk0 e;
    public final RectF f35296e0;
    public org.telegram.ui.Components.y10 f35297f;
    public final RectF f35298f0;
    public org.telegram.ui.Components.t00 h;
    public x8 f35299n;
    public ci.s6 f35300r;
    public ci.f4 f35301s;
    public boolean v;
    public boolean f35302w;
    public ImageView f35303x;
    public NumberTextView f35304y;
    ...
    public static void U(l9 l9Var) {
        ...
        ImageView imageView = l9Var.f35303x;
        if (imageView != null) {
            imageView.setColorFilter(new PorterDuffColorFilter(l9Var.getThemedColor(org.telegram.ui.ActionBar.j6.f19447y8), PorterDuff.Mode.MULTIPLY));
            l9Var.f35303x.setBackground(org.telegram.ui.ActionBar.j6.f0(l9Var.getThemedColor(org.telegram.ui.ActionBar.j6.f19466z8), 1, -1));
        }
    ...
    public static void X(l9 l9Var, org.telegram.ui.Components.x51 x51Var, View view) {
        ...
        if (i10 == 2) {
            ...
            if (obj instanceof h9) {
                ...
                if (l9Var.actionBar.s()) {
                ...
                } else if (h9Var.f34104a != 0 && !arrayList.isEmpty()) {
                    boolean z10 = h9Var.e;
                    ...
                    while (i11 < size) {
                        ...
                        i11++;
                        hashSet.add(Long.valueOf(((TLRPC.User) obj2).f18443id));
                    }
                    TLRPC.TL_inputGroupCallInviteMessage tL_inputGroupCallInviteMessage = new TLRPC.TL_inputGroupCallInviteMessage();
                    tL_inputGroupCallInviteMessage.msg_id = ((TLRPC.Message) arrayList.get(0)).f18317id;
                    ...
                    bundle.putInt("message_id", ((TLRPC.Message) arrayList.get(0)).f18317id);
                ...
                bundle2.putLong("chat_id", ((k9) view).f35022c.f18296id);
                l9Var.getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.closeChats, new Object[0]);
    ...
    public static void o0(final Context context, int i10, TLRPC.InputGroupCall inputGroupCall, String str, final org.telegram.ui.ActionBar.e6 e6Var, boolean z10, final boolean z11) {
        String str2;
        int i11;
        int v02 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19133h5, e6Var);
        ...
        int v03 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19445y6, e6Var);
        ...
        imageView3.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19318r5, e6Var), mode));
        ...
        if (z10) {
            ...
            b9Var.setGravity(17);
            b9Var.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19464z6, e6Var));
        ...
        frameLayout3.setOnClickListener(new View.OnClickListener() {
            ...
            public final void onClick(View view) {
                ...
                org.telegram.messenger.wh.n(i15, xcVar);
            }
        });
    ...
    public final View createView(Context context) {
        ...
        this.d.q1();
        this.d.Y2.f26042r = false;
        this.f35299n = new x8(this, context, 0);
        hh.k kVar = new hh.k(this.f35299n);
        x8 x8Var = this.f35299n;
        ah.c cVar = this.f35292b0;
        cVar.f425f = kVar;
        cVar.f426g = x8Var;
        org.telegram.ui.Components.t61 t61Var2 = this.d;
        Objects.requireNonNull(t61Var2);
        this.f35294c0 = new ah.o(t61Var2, x8Var, new w8(t61Var2, 0));
        this.d.D0(new k8(this, 6));
        x8 x8Var2 = this.f35299n;
        ...
        this.h.f28272w = false;
        i9 i9Var = new i9(this, context, this.h);
        this.f35291b = i9Var;
        this.f35299n.addView(i9Var, w7.y5.c(-1.0f, -1));
        this.d.setClipToPadding(false);
        this.d.setEmptyView(this.f35291b);
        ...
        org.telegram.ui.Components.zk0 zk0Var = new org.telegram.ui.Components.zk0(this.d, this.f35293c);
        this.e = zk0Var;
        zk0Var.h = new l8(this);
        x8 x8Var3 = this.f35299n;
        org.telegram.ui.Components.t61 t61Var5 = this.d;
        float f7 = -this.f35289a;
        x8Var3.addView(t61Var5, w7.y5.d(-1, -1.0f, 3, 0.0f, f7, 0.0f, f7));
        ...
        this.f35297f = y10Var;
        y10Var.f30441c.setImageResource(R.drawable.filled_calls_plus);
        this.f35297f.setContentDescription(LocaleController.getString(R.string.Call));
        this.f35297f.setOnClickListener(new o8(this, 3));
        this.f35299n.addView(this.f35297f, org.telegram.ui.Components.y10.b());
        ...
        z8 z8Var = new z8(this, context, this, this.f35299n, this.resourceProvider, 0);
        this.O = z8Var;
        this.N.addView(z8Var);
        this.M.setCallFragmentContextView(this.O);
        this.f35299n.addView(this.M, w7.y5.d(-1, -2.0f, 48, 0.0f, -14.0f, 0.0f, 0.0f));
        this.f35299n.addView(this.actionBar);
        ci.s6 s6Var = new ci.s6(context, this.parentLayout);
        this.f35300r = s6Var;
        s6Var.b(false, false);
        this.f35299n.addView(this.f35300r, w7.y5.e(-1, 5, 48));
        this.actionBar.setDrawBlurBackground(this.f35299n);
    ...
    public final void e0(ArrayList arrayList, g9 g9Var) {
        ...
        if (l02) {
            ...
            for (int i10 = 0; i10 < size; i10++) {
                arrayList2.remove(Integer.valueOf(((TLRPC.Message) arrayList.get(i10)).f18317id));
            }
        ...
        for (int i11 = 0; i11 < size2; i11++) {
            Integer valueOf = Integer.valueOf(((TLRPC.Message) arrayList.get(i11)).f18317id);
    ...
    public final void f0() {
        ...
        if (Build.VERSION.SDK_INT >= 31 && (iVar = this.Y) != null) {
            ...
            this.f35296e0.set(0.0f, -dp, this.fragmentView.getMeasuredWidth(), this.actionBar.getMeasuredHeight() + dp);
            RectF rectF = this.f35298f0;
            ...
            iVar.g(i10, this.f35295d0);
            iVar.e(this.f35294c0, this.fragmentView.getMeasuredWidth(), this.fragmentView.getMeasuredHeight());
        }
    }

    public final void g0() {
        this.f35297f.setTranslationY(((-this.W) - this.U) - this.V);
    }
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35291b, 4, new Class[]{i9.class}, new String[]{"emptyTextView1"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.G6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35291b, 4, new Class[]{i9.class}, new String[]{"emptyTextView2"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f19045c7));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.d, 0, new Class[]{org.telegram.ui.Cells.s4.class}, new String[]{"progressBar"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f19134h6));
        ...
        org.telegram.ui.Components.y10 y10Var = this.f35297f;
        if (y10Var != null) {
            arrayList.add(new org.telegram.ui.ActionBar.l6(y10Var.f30441c, 8, null, null, null, null, org.telegram.ui.ActionBar.j6.O9));
            arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35297f.f30441c, 32, null, null, null, null, org.telegram.ui.ActionBar.j6.P9));
            arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35297f.f30441c, 65568, null, null, null, null, org.telegram.ui.ActionBar.j6.Q9));
        }
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.d, 0, new Class[]{g9.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.f19147i1}, null, org.telegram.ui.ActionBar.j6.A9));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.d, 0, new Class[]{g9.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.f19093f1}, null, org.telegram.ui.ActionBar.j6.f19467z9));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.d, 0, new Class[]{g9.class}, org.telegram.ui.ActionBar.j6.P0, null, null, org.telegram.ui.ActionBar.j6.f19282p6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.d, 0, new Class[]{g9.class}, null, org.telegram.ui.ActionBar.j6.f19313r0, null, org.telegram.ui.ActionBar.j6.J7));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.d, 0, new Class[]{View.class}, null, new Drawable[]{null, null, org.telegram.ui.ActionBar.j6.W4, org.telegram.ui.ActionBar.j6.Y4}, null, org.telegram.ui.ActionBar.j6.f19320r7));
    ...
    public final void i0() {
        ...
        this.f35291b.setPadding(0, 0, 0, this.W + this.T);
    }
    ...
    public final boolean l0(ArrayList arrayList) {
        int size = arrayList.size();
        for (int i10 = 0; i10 < size; i10++) {
            if (this.L.contains(Integer.valueOf(((TLRPC.Message) arrayList.get(i10)).f18317id))) {
                return true;
            }
        }
        return false;
    ...
    public final void onBecomeFullyVisible() {
        ...
        if (!this.S && getUserConfig().showCallsTab && MessagesController.getGlobalMainSettings().getInt("hidecallshint", 0) < 2) {
            ...
            f4Var.d = 3000L;
            f4Var.l(1.0f, -25.0f);
            this.f35301s.setPadding(0, AndroidUtilities.dp(4.0f), 0, 0);
            this.f35301s.s(AndroidUtilities.replaceTags(LocaleController.getString(R.string.TapToHideCallsTab)));
            this.f35299n.addView(this.f35301s, w7.y5.e(-1, 80, 48));
            this.f35301s.setTranslationY((org.telegram.ui.ActionBar.k.getCurrentActionBarHeight() + AndroidUtilities.statusBarHeight) - AndroidUtilities.dp(16.0f));
            this.f35301s.u();
            this.S = true;
    ...
    public final boolean onFragmentCreate() {
        ...
        if (bundle != null) {
            ...
            this.f35302w = this.arguments.getBoolean("hasMainTabs", false);
        }
        if (this.f35302w) {
    ...
    public final void onRequestPermissionsResultFragment(int i10, String[] strArr, int[] iArr) {
        ...
        if (iArr.length > 0 && z10) {
            ...
            if (this.P != null) {
                userFull = getMessagesController().getUserFull(this.P.f18443id);
            }
    ...
    public final void q0() {
        ...
        if (s10) {
            ...
            if (!a2) {
                ...
                if (this.f35302w) {
                    ...
                    this.f35303x = imageView;
                    imageView.setScaleType(ImageView.ScaleType.CENTER);
                    this.f35303x.setImageDrawable(new org.telegram.ui.ActionBar.g2(true));
                    this.f35303x.setColorFilter(new PorterDuffColorFilter(getThemedColor(org.telegram.ui.ActionBar.j6.f19447y8), PorterDuff.Mode.MULTIPLY));
                    this.f35303x.setBackground(org.telegram.ui.ActionBar.j6.f0(getThemedColor(org.telegram.ui.ActionBar.j6.f19466z8), 1, -1));
                    this.f35303x.setOnClickListener(new o8(this, 1));
                    j3.addView(this.f35303x, w7.y5.q(54, 54, 16));
                    arrayList2.add(this.f35303x);
                }
                NumberTextView numberTextView = new NumberTextView(j3.getContext());
                this.f35304y = numberTextView;
                numberTextView.setTextSize(18);
                this.f35304y.setTypeface(AndroidUtilities.bold());
                this.f35304y.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19447y8, false));
                NumberTextView numberTextView2 = this.f35304y;
                if (this.f35302w) {
                    i10 = 18;
                } else {
                    i10 = 72;
                ...
                this.f35304y.setOnTouchListener(new bi.d(2));
        ...
        this.f35304y.a(arrayList.size(), z10);
    }

    @Override
    public final void r() {
        if (this.f35293c.L0() < 15) {
            this.d.y0(0);
            return;
        }
    ...
    public l9(Bundle bundle) {
        ...
        this.X = new Rect();
        ArrayList arrayList = new ArrayList();
        this.f35295d0 = arrayList;
        RectF rectF = new RectF();
        this.f35296e0 = rectF;
        RectF rectF2 = new RectF();
        this.f35298f0 = rectF2;
        arrayList.add(rectF);
        arrayList.add(rectF2);
        fh.c cVar = new fh.c();
        cVar.a(getThemedColor(org.telegram.ui.ActionBar.j6.f19006a7));
        if (i10 >= 31) {
