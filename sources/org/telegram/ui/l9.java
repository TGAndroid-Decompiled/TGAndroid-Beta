...
public final class l9 extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate, fh0 {
    ...
    public final fh.d f35359a0;
    public i9 f35360b;
    public final ah.c f35361b0;
    public s4.c0 f35362c;
    public ah.o f35363c0;
    public org.telegram.ui.Components.s61 d;
    public final ArrayList f35364d0;
    public org.telegram.ui.Components.yk0 e;
    public final RectF f35365e0;
    public org.telegram.ui.Components.y10 f35366f;
    public final RectF f35367f0;
    public org.telegram.ui.Components.t00 h;
    public x8 f35368n;
    public ci.s6 f35369r;
    public ci.f4 f35370s;
    public boolean v;
    public boolean f35371w;
    public ImageView f35372x;
    public NumberTextView f35373y;
    ...
    public static void U(l9 l9Var) {
        ...
        ImageView imageView = l9Var.f35372x;
        if (imageView != null) {
            imageView.setColorFilter(new PorterDuffColorFilter(l9Var.getThemedColor(org.telegram.ui.ActionBar.j6.f19479y8), PorterDuff.Mode.MULTIPLY));
            l9Var.f35372x.setBackground(org.telegram.ui.ActionBar.j6.f0(l9Var.getThemedColor(org.telegram.ui.ActionBar.j6.f19498z8), 1, -1));
        }
    ...
    public static void X(l9 l9Var, org.telegram.ui.Components.w51 w51Var, View view) {
        ...
        if (i10 == 2) {
            ...
            if (obj instanceof h9) {
                ...
                if (l9Var.actionBar.s()) {
                ...
                } else if (h9Var.f34145a != 0 && !arrayList.isEmpty()) {
                    boolean z10 = h9Var.e;
                    ...
                    while (i11 < size) {
                        ...
                        i11++;
                        hashSet.add(Long.valueOf(((TLRPC.User) obj2).f18475id));
                    }
                    TLRPC.TL_inputGroupCallInviteMessage tL_inputGroupCallInviteMessage = new TLRPC.TL_inputGroupCallInviteMessage();
                    tL_inputGroupCallInviteMessage.msg_id = ((TLRPC.Message) arrayList.get(0)).f18349id;
                    ...
                    bundle.putInt("message_id", ((TLRPC.Message) arrayList.get(0)).f18349id);
                ...
                bundle2.putLong("chat_id", ((k9) view).f35067c.f18328id);
                l9Var.getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.closeChats, new Object[0]);
    ...
    public static void o0(final Context context, int i10, TLRPC.InputGroupCall inputGroupCall, String str, final org.telegram.ui.ActionBar.f6 f6Var, boolean z10, final boolean z11) {
        String str2;
        int i11;
        int v02 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19165h5, f6Var);
        ...
        int v03 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19477y6, f6Var);
        ...
        imageView3.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19350r5, f6Var), mode));
        ...
        if (z10) {
            ...
            b9Var.setGravity(17);
            b9Var.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19496z6, f6Var));
    ...
    public final View createView(Context context) {
        ...
        this.d.q1();
        this.d.Y2.f25678r = false;
        this.f35368n = new x8(this, context, 0);
        hh.k kVar = new hh.k(this.f35368n);
        x8 x8Var = this.f35368n;
        ah.c cVar = this.f35361b0;
        cVar.f425f = kVar;
        cVar.f426g = x8Var;
        org.telegram.ui.Components.s61 s61Var2 = this.d;
        Objects.requireNonNull(s61Var2);
        this.f35363c0 = new ah.o(s61Var2, x8Var, new w8(s61Var2, 0));
        this.d.D0(new k8(this, 6));
        x8 x8Var2 = this.f35368n;
        ...
        this.h.f28252w = false;
        i9 i9Var = new i9(this, context, this.h);
        this.f35360b = i9Var;
        this.f35368n.addView(i9Var, w7.y5.c(-1.0f, -1));
        this.d.setClipToPadding(false);
        this.d.setEmptyView(this.f35360b);
        ...
        org.telegram.ui.Components.yk0 yk0Var = new org.telegram.ui.Components.yk0(this.d, this.f35362c);
        this.e = yk0Var;
        yk0Var.h = new l8(this);
        x8 x8Var3 = this.f35368n;
        org.telegram.ui.Components.s61 s61Var5 = this.d;
        float f7 = -this.f35358a;
        x8Var3.addView(s61Var5, w7.y5.d(-1, -1.0f, 3, 0.0f, f7, 0.0f, f7));
        ...
        this.f35366f = y10Var;
        y10Var.f30430c.setImageResource(R.drawable.filled_calls_plus);
        this.f35366f.setContentDescription(LocaleController.getString(R.string.Call));
        this.f35366f.setOnClickListener(new o8(this, 3));
        this.f35368n.addView(this.f35366f, org.telegram.ui.Components.y10.b());
        ...
        z8 z8Var = new z8(this, context, this, this.f35368n, this.resourceProvider, 0);
        this.O = z8Var;
        this.N.addView(z8Var);
        this.M.setCallFragmentContextView(this.O);
        this.f35368n.addView(this.M, w7.y5.d(-1, -2.0f, 48, 0.0f, -14.0f, 0.0f, 0.0f));
        this.f35368n.addView(this.actionBar);
        ci.s6 s6Var = new ci.s6(context, this.parentLayout);
        this.f35369r = s6Var;
        s6Var.b(false, false);
        this.f35368n.addView(this.f35369r, w7.y5.e(-1, 5, 48));
        this.actionBar.setDrawBlurBackground(this.f35368n);
    ...
    public final void e0(ArrayList arrayList, g9 g9Var) {
        ...
        if (l02) {
            ...
            for (int i10 = 0; i10 < size; i10++) {
                arrayList2.remove(Integer.valueOf(((TLRPC.Message) arrayList.get(i10)).f18349id));
            }
        ...
        for (int i11 = 0; i11 < size2; i11++) {
            Integer valueOf = Integer.valueOf(((TLRPC.Message) arrayList.get(i11)).f18349id);
    ...
    public final void f0() {
        ...
        if (Build.VERSION.SDK_INT >= 31 && (iVar = this.Y) != null) {
            ...
            this.f35365e0.set(0.0f, -dp, this.fragmentView.getMeasuredWidth(), this.actionBar.getMeasuredHeight() + dp);
            RectF rectF = this.f35367f0;
            ...
            iVar.g(i10, this.f35364d0);
            iVar.e(this.f35363c0, this.fragmentView.getMeasuredWidth(), this.fragmentView.getMeasuredHeight());
        }
    }

    public final void g0() {
        this.f35366f.setTranslationY(((-this.W) - this.U) - this.V);
    }
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35360b, 4, new Class[]{i9.class}, new String[]{"emptyTextView1"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.G6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35360b, 4, new Class[]{i9.class}, new String[]{"emptyTextView2"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f19077c7));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.d, 0, new Class[]{org.telegram.ui.Cells.t4.class}, new String[]{"progressBar"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f19166h6));
        ...
        org.telegram.ui.Components.y10 y10Var = this.f35366f;
        if (y10Var != null) {
            arrayList.add(new org.telegram.ui.ActionBar.l6(y10Var.f30430c, 8, null, null, null, null, org.telegram.ui.ActionBar.j6.O9));
            arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35366f.f30430c, 32, null, null, null, null, org.telegram.ui.ActionBar.j6.P9));
            arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35366f.f30430c, 65568, null, null, null, null, org.telegram.ui.ActionBar.j6.Q9));
        }
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.d, 0, new Class[]{g9.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.f19179i1}, null, org.telegram.ui.ActionBar.j6.A9));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.d, 0, new Class[]{g9.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.f19125f1}, null, org.telegram.ui.ActionBar.j6.f19499z9));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.d, 0, new Class[]{g9.class}, org.telegram.ui.ActionBar.j6.P0, null, null, org.telegram.ui.ActionBar.j6.f19314p6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.d, 0, new Class[]{g9.class}, null, org.telegram.ui.ActionBar.j6.f19345r0, null, org.telegram.ui.ActionBar.j6.J7));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.d, 0, new Class[]{View.class}, null, new Drawable[]{null, null, org.telegram.ui.ActionBar.j6.W4, org.telegram.ui.ActionBar.j6.Y4}, null, org.telegram.ui.ActionBar.j6.f19352r7));
    ...
    public final void i0() {
        ...
        this.f35360b.setPadding(0, 0, 0, this.W + this.T);
    }
    ...
    public final boolean l0(ArrayList arrayList) {
        int size = arrayList.size();
        for (int i10 = 0; i10 < size; i10++) {
            if (this.L.contains(Integer.valueOf(((TLRPC.Message) arrayList.get(i10)).f18349id))) {
                return true;
            }
        }
        return false;
    ...
    public final void onBecomeFullyVisible() {
        ...
        if (!this.S && getUserConfig().showCallsTab && MessagesController.getGlobalMainSettings().getInt("hidecallshint", 0) < 2) {
            ...
            f4Var.d = 3000L;
            f4Var.l(1.0f, -25.0f);
            this.f35370s.setPadding(0, AndroidUtilities.dp(4.0f), 0, 0);
            this.f35370s.s(AndroidUtilities.replaceTags(LocaleController.getString(R.string.TapToHideCallsTab)));
            this.f35368n.addView(this.f35370s, w7.y5.e(-1, 80, 48));
            this.f35370s.setTranslationY((org.telegram.ui.ActionBar.k.getCurrentActionBarHeight() + AndroidUtilities.statusBarHeight) - AndroidUtilities.dp(16.0f));
            this.f35370s.u();
            this.S = true;
    ...
    public final boolean onFragmentCreate() {
        ...
        if (bundle != null) {
            ...
            this.f35371w = this.arguments.getBoolean("hasMainTabs", false);
        }
        if (this.f35371w) {
    ...
    public final void onRequestPermissionsResultFragment(int i10, String[] strArr, int[] iArr) {
        ...
        if (iArr.length > 0 && z10) {
            ...
            if (this.P != null) {
                userFull = getMessagesController().getUserFull(this.P.f18475id);
            }
    ...
    public final void q0() {
        ...
        if (s10) {
            ...
            if (!a2) {
                ...
                if (this.f35371w) {
                    ...
                    this.f35372x = imageView;
                    imageView.setScaleType(ImageView.ScaleType.CENTER);
                    this.f35372x.setImageDrawable(new org.telegram.ui.ActionBar.g2(true));
                    this.f35372x.setColorFilter(new PorterDuffColorFilter(getThemedColor(org.telegram.ui.ActionBar.j6.f19479y8), PorterDuff.Mode.MULTIPLY));
                    this.f35372x.setBackground(org.telegram.ui.ActionBar.j6.f0(getThemedColor(org.telegram.ui.ActionBar.j6.f19498z8), 1, -1));
                    this.f35372x.setOnClickListener(new o8(this, 1));
                    j3.addView(this.f35372x, w7.y5.q(54, 54, 16));
                    arrayList2.add(this.f35372x);
                }
                NumberTextView numberTextView = new NumberTextView(j3.getContext());
                this.f35373y = numberTextView;
                numberTextView.setTextSize(18);
                this.f35373y.setTypeface(AndroidUtilities.bold());
                this.f35373y.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19479y8, false));
                NumberTextView numberTextView2 = this.f35373y;
                if (this.f35371w) {
                    i10 = 18;
                } else {
                    i10 = 72;
                ...
                this.f35373y.setOnTouchListener(new bi.d(2));
        ...
        this.f35373y.a(arrayList.size(), z10);
    }

    @Override
    public final void r() {
        if (this.f35362c.L0() < 15) {
            this.d.y0(0);
            return;
        }
    ...
    public l9(Bundle bundle) {
        ...
        this.X = new Rect();
        ArrayList arrayList = new ArrayList();
        this.f35364d0 = arrayList;
        RectF rectF = new RectF();
        this.f35365e0 = rectF;
        RectF rectF2 = new RectF();
        this.f35367f0 = rectF2;
        arrayList.add(rectF);
        arrayList.add(rectF2);
        fh.c cVar = new fh.c();
        cVar.a(getThemedColor(org.telegram.ui.ActionBar.j6.f19038a7));
        if (i10 >= 31) {
