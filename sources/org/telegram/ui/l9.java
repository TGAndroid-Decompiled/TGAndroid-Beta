    ...
    public final void run() {
        ...
        switch (this.f34885a) {
            ...
            case 1:
                ...
                return;
            case 2:
                u9 u9Var2 = this.f34886b;
                CameraView cameraView = u9Var2.f37959c;
                if (cameraView != null) {
            ...
            case 5:
                ...
                return;
            case 6:
                u9 u9Var5 = this.f34886b;
                if (u9Var5.f37963f.getTag() != null) {
                    u9Var5.f37963f.setTag(null);
                    u9Var5.f37963f.animate().setDuration(200L).alpha(0.0f).setInterpolator(org.telegram.ui.Components.rr.f27701f).start();
                    return;
                }
                return;
            case 7:
                u9 u9Var6 = this.f34886b;
                CameraView cameraView2 = u9Var6.f37959c;
                if (cameraView2 != null && cameraView2.getCameraSession() != null) {
                    CameraController.getInstance().stopPreview(u9Var6.f37959c.getCameraSession());
                }
                AndroidUtilities.runOnUIThread(new l9(u9Var6, 4));
                return;
            default:
                u9 u9Var7 = this.f34886b;
                float f11 = u9Var7.X;
                if (u9Var7.M) {
                    f10 = 1.0f;
                }
                ...
                if (f11 != f10) {
                    ...
                    u9Var7.W.setInterpolator(org.telegram.ui.Components.rr.f27701f);
                    u9Var7.W.start();
                    o1.k kVar = u9Var7.Z;
                    if (kVar != null) {
                        kVar.c();
                    ...
                    if (u9Var7.M) {
                        ...
                        f7 = 1.0f - u9Var7.f37956a0;
                    }
                    o1.k kVar2 = new o1.k(new o1.j(f7 * 500.0f));
                    u9Var7.Z = kVar2;
                    kVar2.b(new m9(u9Var7, 1));
                    u9Var7.Z.f15326u = new o1.l(500.0f);
                    u9Var7.Z.f15326u.a(1.0f);
                    u9Var7.Z.f15326u.b(500.0f);
                    u9Var7.Z.f();
                    return;
                }
                return;
