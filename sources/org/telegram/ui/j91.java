...
public final class j91 extends org.telegram.ui.Components.bb {
    public static final int f34392d0 = 0;
    public final yh.a X;
    public final LinearLayout Y;
    public final LinearLayout Z;
    public boolean f34393a0;
    public boolean f34394b0;
    public org.telegram.ui.Components.v51 f34395c0;
    ...
    public j91(final Context context, final int i10, final org.telegram.ui.ActionBar.d6 d6Var, final oc ocVar) {
        ...
        yh.a aVar = new yh.a(context, i10, zf.b.f48899b, d6Var);
        this.X = aVar;
        aVar.setScaleX(0.6f);
        aVar.setScaleY(0.6f);
        aVar.setAlpha(0.0f);
        ...
        a1.d dVar = new a1.d(context, new int[]{i14, i15, i16, i17, i18, i19, i19}, d6Var, oz0Var, 18);
        ...
        TextView b13 = w7.b6.b(context, 14.0f, org.telegram.ui.ActionBar.h6.f19170y6, false, null);
        b13.setGravity(17);
        ...
        dVar2.setOnClickListener(new View.OnClickListener() {
            ...
            public final void onClick(View view2) {
                ...
                try {
                    ...
                    } else if (yh.t5.y(i23, true).f47735f.toDouble() < parseDouble) {
                        new di.h(context, d6Var, zf.a.i((long) (parseDouble * 1.0E9d), zf.b.f48899b), true, new g91(0));
                    } else {
        ...
        this.f34395c0.N(false);
    }

    public final void P() {
        boolean z10;
        float f7;
        if (this.f34393a0 && !isDismissed() && !isKeyboardVisible()) {
            z10 = true;
        } else {
            z10 = false;
        }
        if (this.f34394b0 != z10) {
            this.f34394b0 = z10;
            yh.a aVar = this.X;
            if (aVar != null) {
                aVar.setEnabled(z10);
