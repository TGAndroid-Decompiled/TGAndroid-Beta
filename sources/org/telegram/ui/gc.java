...
public final class gc implements Utilities.Callback3 {
    public final cd f33944a;
    public final int f33945b;
    public final View f33946c;
    ...
    public final void run(Object obj, Object obj2, Object obj3) {
        ...
        cd cdVar = this.f33944a;
        int i10 = cdVar.U;
        int i11 = this.f33945b;
        if (i11 == i10) {
            cdVar.f32740n = l4.longValue();
            cdVar.a1(true);
        } else if (i11 == cdVar.f32729c0) {
            cdVar.f32752w = l4.longValue();
            cdVar.b1();
        } else if (i11 == cdVar.f32733f0) {
            if (l4.longValue() == 0) {
                cdVar.f32756y = null;
                ...
                cdVar.f32756y = emojiStatusCollectibleFromGift;
                cdVar.f32747s = -1;
                cdVar.f32752w = 0L;
            } else {
                ...
                cdVar.f32756y = tL_emojiStatus;
            }
            cdVar.b1();
        }
        cdVar.X0(true);
        qc qcVar = (qc) this.f33946c;
