...
public final class gc implements Utilities.Callback3 {
    public final cd f33948a;
    public final int f33949b;
    public final View f33950c;
    ...
    public final void run(Object obj, Object obj2, Object obj3) {
        ...
        cd cdVar = this.f33948a;
        int i10 = cdVar.U;
        int i11 = this.f33949b;
        if (i11 == i10) {
            cdVar.f32744n = l4.longValue();
            cdVar.a1(true);
        } else if (i11 == cdVar.f32733c0) {
            cdVar.f32756w = l4.longValue();
            cdVar.b1();
        } else if (i11 == cdVar.f32737f0) {
            if (l4.longValue() == 0) {
                cdVar.f32760y = null;
                ...
                cdVar.f32760y = emojiStatusCollectibleFromGift;
                cdVar.f32751s = -1;
                cdVar.f32756w = 0L;
            } else {
                ...
                cdVar.f32760y = tL_emojiStatus;
            }
            cdVar.b1();
        }
        cdVar.X0(true);
        qc qcVar = (qc) this.f33950c;
