...
public final class co extends Drawable {
    ...
    public View f32721b;
    public int f32722c = 255;
    public final float d;
    public final ai.l4 e;
    public final org.telegram.ui.Components.lc0 f32723f;
    public final TLRPC.WallPaper f32724g;
    public boolean h;
    public boolean f32725i;
    public final ArrayList f32726j;
        ...
        if (wallPaper.document != null) {
            ...
            if (wallPaperSettings != null && wallPaperSettings.intensity >= 0) {
                if (wallPaperSettings.second_background_color == 0) {
                    ...
                    a2 = new BitmapDrawable(lc0Var.f26109k);
                }
            } else {
    ...
    public final Drawable c(boolean z10) {
        org.telegram.ui.Components.lc0 lc0Var = this.f32723f;
        if (lc0Var != null) {
            return lc0Var;
        }
        ai.l4 l4Var = this.e;
    ...
    public final void draw(Canvas canvas) {
        ...
        l4Var.setAlpha(this.f32722c / 255.0f);
        l4Var.draw(canvas);
        if (z10 && f7 != 0.0f) {
    ...
    public final void f(View view) {
        ArrayList arrayList = this.f32726j;
        if (!arrayList.contains(view)) {
            arrayList.add(view);
        }
        int size = arrayList.size();
        ai.l4 l4Var = this.e;
        if (size > 0 && !this.f32725i) {
            this.f32725i = true;
            l4Var.onAttachedToWindow();
        } else if (arrayList.size() <= 0 && this.f32725i) {
            this.f32725i = false;
