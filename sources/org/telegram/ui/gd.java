...
public final class gd extends org.telegram.ui.ActionBar.j {
    ...
    public final void b(int i10) {
        int i11;
        int i12;
        ld ldVar = this.f33901a;
        long j3 = ldVar.f35310i0;
        cd cdVar = ldVar.f35325v0;
        if (i10 == -1) {
            if (ldVar.f35320r0) {
                ld.Y(ldVar);
            } else {
            ...
            int i13 = ldVar.f35309h0;
            if (i13 == 0) {
                if (ldVar.getParentActivity() != null) {
                    if (ldVar.f35320r0) {
                        ld.Y(ldVar);
                    } else if (ldVar.f35302c.f26172a.length() == 0) {
                        Vibrator vibrator = (Vibrator) ldVar.getParentActivity().getSystemService("vibrator");
                        if (vibrator != null) {
                            vibrator.vibrate(200L);
                        }
                        AndroidUtilities.shakeView(ldVar.f35302c);
                    } else {
                        ldVar.f35320r0 = true;
                        AndroidUtilities.runOnUIThread(cdVar, 200L);
                        if (!ldVar.v.h()) {
                            i12 = ((org.telegram.ui.ActionBar.m2) ldVar).currentAccount;
                            ldVar.f35322s0 = Integer.valueOf(MessagesController.getInstance(i12).createChat(ldVar.f35302c.getText().toString(), new ArrayList<>(), ldVar.f35326w.getText().toString(), 2, false, null, null, -1, ldVar));
                            return;
                        }
                        ldVar.f35318q0 = true;
                    }
                ...
                if (!ldVar.f35299a0) {
                    if (ldVar.f35326w.length() == 0) {
                        ...
                        MessagesController.getInstance(i11).updateChannelUserName(ldVar, ldVar.f35310i0, ldVar.X, new Runnable(this) {
                            public final gd f33637b;
                            ...
                            public final void run() {
                                switch (r2) {
                                    case 0:
                                        ld ldVar2 = this.f33637b.f33901a;
                                        ldVar2.g0(false);
                                        Utilities.Callback2 callback2 = ldVar2.f35323t0;
                                        if (callback2 != null) {
                                            callback2.run(ldVar2, Long.valueOf(ldVar2.f35310i0));
                                            return;
                                        }
                                        return;
                                    default:
                                        ld ldVar3 = this.f33637b.f33901a;
                                        ldVar3.g0(false);
                                        Utilities.Callback2 callback22 = ldVar3.f35323t0;
                                        if (callback22 != null) {
                                            callback22.run(ldVar3, Long.valueOf(ldVar3.f35310i0));
                                            return;
                                        }
                                        return;
                                }
                    ...
                    Utilities.Callback2 callback2 = ldVar.f35323t0;
                    if (callback2 != null) {
                        callback2.run(ldVar, Long.valueOf(j3));
                    }
                }
                if (ldVar.f35323t0 == null) {
