...
public final class m5 implements RequestDelegate {
    ...
    public final y5 f38853b;
    public final CountDownLatch f38854c;
    public final Runnable d;

    public m5(y5 y5Var, CountDownLatch countDownLatch, Runnable runnable, int i10) {
        this.f38852a = i10;
        this.f38853b = y5Var;
        this.f38854c = countDownLatch;
        this.d = runnable;
    }
    ...
    public final void run(final TLObject tLObject, TLRPC.TL_error tL_error) {
        switch (this.f38852a) {
            case 0:
                final y5 y5Var = this.f38853b;
                final CountDownLatch countDownLatch = this.f38854c;
                        ...
                        switch (r5) {
                            case 0:
                                ...
                                if (tLObject2 != null) {
                                    ...
                                    y5Var2.f43545f0 = tL_premium_boostsList.next_offset;
                                    ...
                                    while (true) {
                                        ...
                                        if (i11 < size) {
                                            ...
                                            y5Var2.V = z4;
                                            y5Var2.f43548i0 = tL_premium_boostsList.count;
                            ...
                            default:
                                ...
                                if (tLObject3 != null) {
                                    ...
                                    y5Var3.f43544e0 = tL_premium_boostsList2.next_offset;
                                    ...
                                    while (true) {
                                        ...
                                        if (i15 < size2) {
                                            ...
                                            y5Var3.T = z10;
                                            y5Var3.f43549j0 = tL_premium_boostsList2.count;
                ...
                return;
            default:
                final y5 y5Var2 = this.f38853b;
                final CountDownLatch countDownLatch2 = this.f38854c;
                        ...
                        switch (r5) {
                            case 0:
                                ...
                                if (tLObject2 != null) {
                                    ...
                                    y5Var22.f43545f0 = tL_premium_boostsList.next_offset;
                                    arrayList.addAll(tL_premium_boostsList.boosts);
                                    int size = arrayList.size();
                                    int i10 = 0;
                                    int i11 = 0;
                                    while (true) {
                                        ...
                                        if (i11 < size) {
                                            ...
                                            y5Var22.V = z4;
                                            y5Var22.f43548i0 = tL_premium_boostsList.count;
