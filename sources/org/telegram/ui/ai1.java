...
public abstract class ai1 extends org.telegram.ui.ActionBar.o2 {
    public final SparseArray f31898a;
    public j0 f31899b;
    public zh1 f31900c;
    public int d;
    public float e;
    ...
    public int f31903r;
    public Runnable f31904s;

    public ai1() {
        super(null);
        this.f31898a = new SparseArray();
        this.d = -1;
        this.e = 0.0f;
    }
    ...
    public final void U() {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            ...
            if (yh1Var != null) {
                org.telegram.ui.ActionBar.o2 o2Var = yh1Var.f39918a;
                if (o2Var.fragmentView != null) {
                    float r10 = this.f31900c.r(keyAt);
                    ...
                    if (!yh1Var.f39920c && f12 >= 1.0f) {
                        o2Var.onBecomeFullyVisible();
                        yh1Var.f39920c = true;
                    }
                    if (yh1Var.f39920c && ((f12 == 0.0f && !z12) || r10 == 0.0f)) {
                        o2Var.onBecomeFullyHidden();
                        yh1Var.f39920c = false;
                    }
    ...
    public final org.telegram.ui.ActionBar.o2 X() {
        ...
        yh1 yh1Var = (yh1) this.f31898a.get(zh1Var.getCurrentPosition());
        if (yh1Var == null) {
            return null;
        }
        return yh1Var.f39918a;
    }
    ...
    public View createView(Context context) {
        ...
        this.f31899b = new j0((gh0) this, context, 12);
        ...
        this.f31900c.setAdapter(new kw0(this, context, 3));
        this.f31899b.addView(this.f31900c, w7.x5.c(-1.0f, -1));
    ...
    public final void setTitleOverlayText(String str, int i10, Runnable runnable) {
        ...
        this.f31902n = str;
        this.f31903r = i10;
        this.f31904s = runnable;
        SparseArray sparseArray = this.f31898a;
        int size = sparseArray.size();
        for (int i11 = 0; i11 < size; i11++) {
            yh1 yh1Var = (yh1) sparseArray.valueAt(i11);
            if (yh1Var != null) {
                yh1Var.f39918a.setTitleOverlayText(str, i10, runnable);
            }
        }
    }
