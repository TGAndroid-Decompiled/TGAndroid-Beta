...
public final class rx extends i71 {
    public final z61[] f37341d2;
    public final wy f37342e2;
    ...
    public final boolean F(TL_stars.TL_starGiftUnique tL_starGiftUnique) {
        ...
        if (tL_starGiftUnique != null) {
            i10 = ((org.telegram.ui.ActionBar.o2) this.f37342e2).currentAccount;
    ...
    public final void p(View view, Long l4, TLRPC.Document document, TL_stars.TL_starGiftUnique tL_starGiftUnique, Integer num) {
        ...
        z61[] z61VarArr = this.f37341d2;
        wy wyVar = this.f37342e2;
        if (l4 == null) {
            ...
            if (tL_starGiftUnique != null) {
                ...
                tL_inputEmojiStatusCollectible.collectible_id = tL_starGiftUnique.f18346id;
