    ...
    public final void onClick(View view) {
        switch (this.f39934a) {
            ...
            case 1:
                ...
                return;
            case 2:
                on0 on0Var2 = this.f39935b;
                on0Var2.S0 = 3;
                on0Var2.D1();
                return;
            case 3:
                on0 on0Var3 = this.f39935b;
                on0Var3.S0 = 1;
                on0Var3.D1();
                return;
            case 4:
                on0 on0Var4 = this.f39935b;
                on0Var4.S0 = 4;
                on0Var4.D1();
                return;
            case 5:
                ...
                return;
            case 6:
                on0 on0Var5 = this.f39935b;
                on0Var5.f36266f = true;
                on0Var5.L.callOnClick();
                on0Var5.f36266f = false;
                return;
            case 7:
                on0 on0Var6 = this.f39935b;
                on0Var6.S0 = 0;
                on0Var6.D1();
                return;
            case 8:
                on0 on0Var7 = this.f39935b;
                on0Var7.S0 = 4;
                on0Var7.D1();
                return;
            case 9:
            ...
            case 12:
                ...
                return;
            case 13:
                on0 on0Var8 = this.f39935b;
                AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(on0Var8.getParentActivity());
                alertDialog$Builder.f18437a.R = LocaleController.getString(R.string.TelegramPassportDeleteTitle);
                alertDialog$Builder.f18437a.T = LocaleController.getString(R.string.TelegramPassportDeleteAlert);
            ...
            case 15:
                ...
                return;
            default:
                on0 on0Var9 = this.f39935b;
                on0Var9.f36266f = true;
                on0Var9.L.callOnClick();
                on0Var9.f36266f = false;
                return;
        }
    }
}
