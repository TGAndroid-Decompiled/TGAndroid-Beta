...
public final class yl0 implements lm0 {
    public final TLRPC.SecureValueType f44904a;
    ...
    public static void a(yl0 yl0Var, SecureDocument secureDocument, TLRPC.TL_secureFile tL_secureFile) {
        ...
        ImageLoader.getInstance().replaceImageInCache(secureDocument.secureFile.dc_id + "_" + secureDocument.secureFile.f22527id, tL_secureFile.dc_id + "_" + tL_secureFile.f22527id, null, false);
    }
    ...
    public static TLRPC.InputSecureFile b(SecureDocument secureDocument) {
        if (secureDocument.inputFile != null) {
            ...
            tL_inputSecureFileUploaded.f22460id = tL_inputFile.f22406id;
        ...
        tL_inputSecureFile.f22459id = tL_secureFile.f22527id;
    ...
    public final void c(TLRPC.TL_secureRequiredType tL_secureRequiredType, String str, String str2, TLRPC.TL_secureRequiredType tL_secureRequiredType2, String str3, ArrayList arrayList, SecureDocument secureDocument, ArrayList arrayList2, SecureDocument secureDocument2, SecureDocument secureDocument3, Runnable runnable, oc.i iVar) {
        ...
        if (!isEmpty) {
            ...
            tL_secureData.data = (byte[]) k12.f213c;
            tL_secureData.data_hash = (byte[]) k12.d;
            tL_secureData.secret = (byte[]) k12.f211a;
        } else if (!TextUtils.isEmpty(str)) {
            TLRPC.SecureValueType secureValueType = this.f44904a;
        ...
        if (tL_secureRequiredType2 != null) {
            ...
            if (!TextUtils.isEmpty(str3)) {
                ...
                tL_secureData2.data = (byte[]) k13.f213c;
                tL_secureData2.data_hash = (byte[]) k13.d;
                tL_secureData2.secret = (byte[]) k13.f211a;
            }
