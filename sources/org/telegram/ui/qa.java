...
public final class qa extends org.telegram.ui.ActionBar.m2 {
    ...
    public org.telegram.ui.ActionBar.u0 f36815a;
    public org.telegram.ui.Components.wl0 f36816b;
    public ha f36817c;
    public boolean d;
    public int e;
    ...
    public final ArrayList f36821s;
    public final ArrayList v;
    public final ArrayList f36822w;
    public final long f36823x;
    public ka f36824y;
    ...
    public qa(Bundle bundle) {
        ...
        this.f36822w = new ArrayList();
        if (bundle != null) {
            this.f36823x = bundle.getLong("bot_id");
        }
    }
    ...
    public static void Y(qa qaVar) {
        ...
        ArrayList arrayList2 = qaVar.f36821s;
        if (!qaVar.d) {
            return;
        }
        qaVar.d = false;
    ...
    public static void Z(qa qaVar) {
        ...
        if (!qaVar.f36820r.isEmpty() && !qaVar.d0(qaVar.f36820r)) {
            qaVar.h0();
            return;
        }
        ...
        if (qaVar.getParentActivity() != null && f02 != null) {
            ...
            if (publicUsername.equals(qaVar.f36820r)) {
                qaVar.finishFragment();
                return;
            }
            ...
            updateusername.username = qaVar.f36820r;
    ...
    public final View createView(Context context) {
        ...
        this.f36815a = this.actionBar.n().h(1, R.drawable.ic_ab_done, LocaleController.getString(R.string.Done), AndroidUtilities.dp(56.0f));
            ...
            if (user.usernames != null) {
                ...
                while (true) {
                    ...
                    if (tL_username != null && tL_username.editable) {
                        this.f36820r = tL_username.username;
                        break;
                    }
                    i10++;
                }
            }
            if (this.f36820r == null && (str = user.username) != null) {
                this.f36820r = str;
            }
            if (this.f36820r == null) {
                this.f36820r = "";
            }
            this.f36821s.clear();
        ...
        this.f36816b = wl0Var;
        wl0Var.p1();
        this.actionBar.setAdaptiveBackground(this.f36816b);
        this.fragmentView.setBackgroundColor(getThemedColor(org.telegram.ui.ActionBar.h6.f18989a7));
        this.f36816b.setLayoutManager(new s4.c0());
        org.telegram.ui.Components.wl0 wl0Var2 = this.f36816b;
        ha haVar = new ha(this);
        this.f36817c = haVar;
        wl0Var2.setAdapter(haVar);
        this.f36816b.setSelectorDrawableColor(getThemedColor(org.telegram.ui.ActionBar.h6.f19134i6));
        new s4.y(new la(this)).e(this.f36816b);
        ((FrameLayout) this.fragmentView).addView(this.f36816b, w7.y5.c(-1.0f, -1));
        this.fragmentView.setOnTouchListener(new bi.d(6));
        this.f36816b.setOnItemClickListener(new fa(this));
        ...
        if (str != null && str.length() >= 4) {
            if (str.length() > 32) {
                ...
                if (y1Var8 != null) {
                    ...
                    int i15 = org.telegram.ui.ActionBar.h6.f19265p7;
                ...
                if (str.equals(str2)) {
                    ...
                    if (y1Var10 != null) {
                        ...
                        int i16 = org.telegram.ui.ActionBar.h6.f19394w6;
    ...
    public final void e0(boolean z10) {
        ka kaVar = this.f36824y;
        if (kaVar != null) {
            if (!kaVar.f34997a.isFocused()) {
                EditTextBoldCursor editTextBoldCursor = this.f36824y.f34997a;
                editTextBoldCursor.setSelection(editTextBoldCursor.length());
            }
            this.f36824y.f34997a.requestFocus();
            if (z10) {
                AndroidUtilities.showKeyboard(this.f36824y.f34997a);
            }
        }
    }

    public final TLRPC.User f0() {
        long j3 = this.f36823x;
    ...
    public final void h0() {
        ...
        for (int i10 = 0; i10 < this.f36816b.getChildCount(); i10++) {
            View childAt = this.f36816b.getChildAt(i10);
            if ((childAt instanceof org.telegram.ui.Cells.m4) && i10 == 0) {
                ...
                ka kaVar = (ka) childAt;
                AndroidUtilities.shakeViewSpring(kaVar.f34997a);
                AndroidUtilities.shakeViewSpring(kaVar.f34998b);
            }
        }
