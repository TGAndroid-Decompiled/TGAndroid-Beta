...
public final class qa extends org.telegram.ui.ActionBar.n2 {
    ...
    public org.telegram.ui.ActionBar.v0 f36335a;
    public org.telegram.ui.Components.ml0 f36336b;
    public ha f36337c;
    public boolean d;
    public int e;
    ...
    public String f36340r;
    public final ArrayList f36341s;
    public final ArrayList v;
    public final ArrayList f36342w;
    public final long f36343x;
    public ka f36344y;
    ...
    public qa(Bundle bundle) {
        ...
        this.f36342w = new ArrayList();
        if (bundle != null) {
            this.f36343x = bundle.getLong("bot_id");
        }
    }
    ...
    public static void Y(qa qaVar) {
        ...
        ArrayList arrayList2 = qaVar.f36341s;
        if (!qaVar.d) {
            return;
        }
        qaVar.d = false;
    ...
    public static void Z(qa qaVar) {
        ...
        if (!qaVar.f36340r.isEmpty() && !qaVar.d0(qaVar.f36340r)) {
            qaVar.h0();
            return;
        }
        ...
        if (qaVar.getParentActivity() != null && f02 != null) {
            ...
            if (publicUsername.equals(qaVar.f36340r)) {
                qaVar.finishFragment();
                return;
            }
            ...
            updateusername.username = qaVar.f36340r;
    ...
    public final View createView(Context context) {
        ...
        this.f36335a = this.actionBar.n().h(1, R.drawable.ic_ab_done, LocaleController.getString(R.string.Done), AndroidUtilities.dp(56.0f));
            ...
            if (user.usernames != null) {
                ...
                while (true) {
                    ...
                    if (tL_username != null && tL_username.editable) {
                        this.f36340r = tL_username.username;
                        break;
                    }
                    i10++;
                }
            }
            if (this.f36340r == null && (str = user.username) != null) {
                this.f36340r = str;
            }
        ...
        this.f36336b = ml0Var;
        ml0Var.p1();
        this.actionBar.setAdaptiveBackground(this.f36336b);
        this.fragmentView.setBackgroundColor(getThemedColor(org.telegram.ui.ActionBar.h6.f18733a7));
        this.f36336b.setLayoutManager(new s4.c0());
        org.telegram.ui.Components.ml0 ml0Var2 = this.f36336b;
        ha haVar = new ha(this);
        this.f36337c = haVar;
        ml0Var2.setAdapter(haVar);
        this.f36336b.setSelectorDrawableColor(getThemedColor(org.telegram.ui.ActionBar.h6.f18878i6));
        new s4.y(new la(this)).e(this.f36336b);
        ((FrameLayout) this.fragmentView).addView(this.f36336b, w7.x5.c(-1.0f, -1));
        this.fragmentView.setOnTouchListener(new bi.d(6));
        this.f36336b.setOnItemClickListener(new fa(this));
        ...
        if (str != null && str.length() >= 4) {
            if (str.length() > 32) {
                ...
                if (x1Var8 != null) {
                    ...
                    int i15 = org.telegram.ui.ActionBar.h6.f19008p7;
                ...
                if (str.equals(str2)) {
                    ...
                    if (x1Var10 != null) {
                        ...
                        int i16 = org.telegram.ui.ActionBar.h6.f19136w6;
    ...
    public final void e0(boolean z10) {
        ka kaVar = this.f36344y;
        if (kaVar != null) {
            if (!kaVar.f34633a.isFocused()) {
                EditTextBoldCursor editTextBoldCursor = this.f36344y.f34633a;
                editTextBoldCursor.setSelection(editTextBoldCursor.length());
            }
            this.f36344y.f34633a.requestFocus();
            if (z10) {
                AndroidUtilities.showKeyboard(this.f36344y.f34633a);
            }
        }
    }

    public final TLRPC.User f0() {
        long j3 = this.f36343x;
    ...
    public final void h0() {
        ...
        for (int i10 = 0; i10 < this.f36336b.getChildCount(); i10++) {
            View childAt = this.f36336b.getChildAt(i10);
            if ((childAt instanceof org.telegram.ui.Cells.m4) && i10 == 0) {
                ...
                ka kaVar = (ka) childAt;
                AndroidUtilities.shakeViewSpring(kaVar.f34633a);
                AndroidUtilities.shakeViewSpring(kaVar.f34634b);
            }
        }
