...
public final class qa extends org.telegram.ui.ActionBar.n2 {
    ...
    public org.telegram.ui.ActionBar.v0 f36806a;
    public org.telegram.ui.Components.ll0 f36807b;
    public ha f36808c;
    public boolean d;
    public int e;
    ...
    public String f36811r;
    public final ArrayList f36812s;
    public final ArrayList v;
    public final ArrayList f36813w;
    public final long f36814x;
    public ka f36815y;

    public qa(Bundle bundle) {
        super(bundle);
        this.f36811r = "";
        this.f36812s = new ArrayList();
        this.v = new ArrayList();
        this.f36813w = new ArrayList();
        if (bundle != null) {
            this.f36814x = bundle.getLong("bot_id");
        }
    }
    ...
    public static void Y(qa qaVar) {
        ...
        ArrayList arrayList2 = qaVar.f36812s;
        if (!qaVar.d) {
            return;
        }
        qaVar.d = false;
    ...
    public static void Z(qa qaVar) {
        ...
        if (!qaVar.f36811r.isEmpty() && !qaVar.d0(qaVar.f36811r)) {
            qaVar.h0();
            return;
        }
        ...
        if (qaVar.getParentActivity() != null && f02 != null) {
            ...
            if (publicUsername.equals(qaVar.f36811r)) {
                qaVar.finishFragment();
                return;
            }
            ...
            updateusername.username = qaVar.f36811r;
    ...
    public final View createView(Context context) {
        ...
        this.f36806a = this.actionBar.n().h(1, R.drawable.ic_ab_done, LocaleController.getString(R.string.Done), AndroidUtilities.dp(56.0f));
            ...
            if (user.usernames != null) {
                ...
                while (true) {
                    ...
                    if (tL_username != null && tL_username.editable) {
                        this.f36811r = tL_username.username;
                        break;
                    }
                    i10++;
                }
            }
            if (this.f36811r == null && (str = user.username) != null) {
                this.f36811r = str;
            }
        ...
        this.f36807b = ll0Var;
        ll0Var.p1();
        this.actionBar.setAdaptiveBackground(this.f36807b);
        this.fragmentView.setBackgroundColor(getThemedColor(org.telegram.ui.ActionBar.i6.f18778a7));
        this.f36807b.setLayoutManager(new s4.c0());
        org.telegram.ui.Components.ll0 ll0Var2 = this.f36807b;
        ha haVar = new ha(this);
        this.f36808c = haVar;
        ll0Var2.setAdapter(haVar);
        this.f36807b.setSelectorDrawableColor(getThemedColor(org.telegram.ui.ActionBar.i6.f18923i6));
        new s4.y(new la(this)).e(this.f36807b);
        ((FrameLayout) this.fragmentView).addView(this.f36807b, w7.x5.c(-1.0f, -1));
        this.fragmentView.setOnTouchListener(new bi.d(6));
        this.f36807b.setOnItemClickListener(new fa(this));
        ...
        if (str != null && str.length() >= 4) {
            if (str.length() > 32) {
                ...
                if (x1Var8 != null) {
                    ...
                    int i15 = org.telegram.ui.ActionBar.i6.f19053p7;
                ...
                if (str.equals(str2)) {
                    ...
                    if (x1Var10 != null) {
                        ...
                        int i16 = org.telegram.ui.ActionBar.i6.f19181w6;
    ...
    public final void e0(boolean z10) {
        ka kaVar = this.f36815y;
        if (kaVar != null) {
            if (!kaVar.f35108a.isFocused()) {
                EditTextBoldCursor editTextBoldCursor = this.f36815y.f35108a;
                editTextBoldCursor.setSelection(editTextBoldCursor.length());
            }
            this.f36815y.f35108a.requestFocus();
            if (z10) {
                AndroidUtilities.showKeyboard(this.f36815y.f35108a);
            }
        }
    }

    public final TLRPC.User f0() {
        long j3 = this.f36814x;
    ...
    public final void h0() {
        ...
        for (int i10 = 0; i10 < this.f36807b.getChildCount(); i10++) {
            View childAt = this.f36807b.getChildAt(i10);
            if ((childAt instanceof org.telegram.ui.Cells.m4) && i10 == 0) {
                ...
                ka kaVar = (ka) childAt;
                AndroidUtilities.shakeViewSpring(kaVar.f35108a);
                AndroidUtilities.shakeViewSpring(kaVar.f35109b);
            }
        }
