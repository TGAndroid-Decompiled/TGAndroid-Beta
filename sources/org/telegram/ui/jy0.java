...
public final class jy0 implements Utilities.Callback {
    ...
    public final ProfileActivity f34896b;

    public jy0(ProfileActivity profileActivity, int i10) {
        this.f34895a = i10;
        this.f34896b = profileActivity;
    }
        ...
        switch (this.f34895a) {
            case 0:
                ...
                if (view instanceof org.telegram.ui.Cells.c9) {
                    ...
                    ProfileActivity profileActivity = this.f34896b;
                    nVar.setLoading(profileActivity.f31588i5);
                    c9Var.f20107b.setLoading(profileActivity.f31588i5);
                    return;
                }
                return;
            case 1:
                ProfileActivity profileActivity2 = this.f34896b;
                profileActivity2.getClass();
                ArrayList arrayList = new ArrayList(1);
                arrayList.add((TLRPC.InputStickerSet) obj);
                profileActivity2.showDialog(new org.telegram.ui.Components.tv(profileActivity2, profileActivity2.getParentActivity(), profileActivity2.f31698z0, arrayList));
                return;
            case 2:
                View view2 = (View) obj;
                boolean z10 = view2 instanceof org.telegram.ui.Cells.m4;
                ProfileActivity profileActivity3 = this.f34896b;
                if (z10) {
                    ((org.telegram.ui.Cells.m4) view2).setTextColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.L6, profileActivity3.f31698z0));
                ...
                profileActivity3.f31524a.getClass();
                RecyclerView.R(view2);
                q01Var.getClass();
                profileActivity3.d.getClass();
                return;
            default:
                ProfileActivity.e0(this.f34896b, (Boolean) obj);
                return;
        }
    }
}
