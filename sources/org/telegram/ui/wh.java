        ...
        switch (i10) {
            ...
            case 2:
                ...
                if (boVar.getParentActivity() != null) {
                    ...
                    boVar.K0.setTranslationY(AndroidUtilities.dp(10.0f) + ((view.getTop() - boVar.f32541za) - boVar.X0.getHeight()));
                    boVar.X0.addView(boVar.K0, w7.x5.e(-1, 100, 87));
                    ci.f4 f4Var = boVar.K0;
                    f4Var.f4638l0 = new sf(boVar, 7);
                    f4Var.u();
            ...
            case 4:
                ...
                bo boVar2 = ((xi) obj2).f39656s;
                MessageObject messageObject3 = (MessageObject) boVar2.f32397o6[0].get(messageObject2.getId());
                if (messageObject3 != null && messageObject3 != messageObject2) {
                    MessageObject messageObject4 = (MessageObject) boVar2.f32397o6[0].get(messageObject2.getId());
            ...
            case 5:
                ...
                bo boVar3 = ((em) ((gn) obj2).f34021f).f33445a.Q;
                int i12 = bo.Gc;
                boVar3.Ma();
            ...
            case 7:
                Long l4 = (Long) obj;
                bo boVar5 = ((hn) obj2).f34316c1.f36139a;
            ...
            case 9:
                ...
                kpVar.f35333h0 = kpVar.getConnectionsManager().sendRequest(tL_channels_checkUsername, new ca(kpVar, str2, tL_channels_checkUsername, 6), 2);
                return;
            case 10:
                kp kpVar2 = (kp) obj2;
                ...
                kpVar2.f35327c0 = z10;
                if (!z10 && kpVar2.getUserConfig().isPremium() && !kpVar2.f35328d0 && kpVar2.f35349x != null) {
                    kpVar2.f35328d0 = true;
                    kpVar2.b0();
            ...
            case 12:
                ...
                return;
            case 13:
                ((sp) obj2).f37543x.d.P = false;
                ((org.telegram.ui.Components.i80) obj).run();
                return;
            case 14:
                ((sp) obj2).f37543x.d.O = false;
                ((org.telegram.ui.Components.j80) obj).run();
                return;
            case 15:
                wp wpVar2 = ((sp) obj2).f37543x.d;
                wpVar2.O = false;
                wpVar2.P = false;
                ((Runnable) obj).run();
                return;
            case 16:
                ...
                spVar.h = true;
                spVar.f25583c.setChecked(true);
                return;
            case 17:
                ur urVar = (ur) obj2;
                urVar.getClass();
                urVar.getMessagesController().loadFullChat(((TLRPC.Updates) obj).chats.get(0).f18121id, 0, true);
                return;
            case 18:
                TLRPC.User user = (TLRPC.User) obj;
                ur urVar2 = ((jr) obj2).f34924a;
                ...
                return;
            case 19:
                ((org.telegram.ui.Components.e0) obj2).f23437u0.unsave((TL_aicompose.TL_aiComposeTone) obj);
                return;
            case 20:
            ...
            case 23:
                ...
                if (sbVar instanceof org.telegram.ui.Components.tb) {
                    ...
                    ubVar.f29626b.setText(charSequence);
                    AndroidUtilities.updateViewShow(ubVar.d, false, false, true);
                    AndroidUtilities.updateViewShow(ubVar.f29626b, true, false, true);
                }
                ocVar.i(true);
                return;
            case 24:
            ...
            case 27:
                ...
                int i15 = ChatActivityEnterView.f21743n5;
            ...
            default:
                ...
                chatActivityEnterView3.f21796i1 = chatActivityEnterView3.f21790h1.getAudioRightMs() - chatActivityEnterView3.f21790h1.getAudioLeftMs();
                MediaController.getInstance().trimCurrentRecording(chatActivityEnterView3.f21790h1.getAudioLeftMs(), chatActivityEnterView3.f21790h1.getAudioRightMs(), (org.telegram.ui.Components.ng) obj);
                return;
        }
    }

    public wh(n6 n6Var, TLRPC.WebPage webPage) {
        this.f39037a = 1;
        this.f39038b = n6Var;
        this.f39039c = webPage;
    }
}
