...
public final class wh implements Runnable {
    ...
    public final void run() {
        ...
        boolean z10 = false;
        Object obj = this.f39033b;
        Object obj2 = this.f39034c;
        switch (i10) {
            case 0:
                a0.i iVar = (a0.i) obj2;
                n6 n6Var = (n6) obj;
            ...
            case 2:
                ...
                if (boVar.getParentActivity() != null) {
                    ...
                    boVar.K0.setTranslationY(AndroidUtilities.dp(10.0f) + ((view.getTop() - boVar.f32537za) - boVar.X0.getHeight()));
            ...
            case 4:
                ...
                bo boVar2 = ((xi) obj2).f39651s;
                MessageObject messageObject3 = (MessageObject) boVar2.f32393o6[0].get(messageObject2.getId());
                if (messageObject3 != null && messageObject3 != messageObject2) {
                    MessageObject messageObject4 = (MessageObject) boVar2.f32393o6[0].get(messageObject2.getId());
            ...
            case 5:
                ...
                bo boVar3 = ((em) ((gn) obj2).f34017f).f33441a.Q;
                int i12 = bo.Hc;
                boVar3.Ma();
            ...
            case 7:
                Long l4 = (Long) obj;
                bo boVar5 = ((hn) obj2).f34311c1.f36134a;
            ...
            case 9:
                ...
                kpVar.f35328h0 = kpVar.getConnectionsManager().sendRequest(tL_channels_checkUsername, new ca(kpVar, str2, tL_channels_checkUsername, 6), 2);
                return;
            case 10:
                kp kpVar2 = (kp) obj2;
                ...
                kpVar2.f35322c0 = z10;
                if (!z10 && kpVar2.getUserConfig().isPremium() && !kpVar2.f35323d0 && kpVar2.f35344x != null) {
                    kpVar2.f35323d0 = true;
                    kpVar2.b0();
            ...
            case 12:
                ...
                return;
            case 13:
                ((sp) obj2).f37538x.d.P = false;
                ((org.telegram.ui.Components.i80) obj).run();
                return;
            case 14:
                ((sp) obj2).f37538x.d.O = false;
                ((org.telegram.ui.Components.j80) obj).run();
                return;
            case 15:
                wp wpVar2 = ((sp) obj2).f37538x.d;
                wpVar2.O = false;
                wpVar2.P = false;
                ((Runnable) obj).run();
                return;
            ...
            case 18:
                ...
                return;
            case 19:
                ((org.telegram.ui.Components.e0) obj2).f23434u0.unsave((TL_aicompose.TL_aiComposeTone) obj);
                return;
            case 20:
            ...
            case 23:
                ...
                if (sbVar instanceof org.telegram.ui.Components.tb) {
                    ...
                    ubVar.f29623b.setText(charSequence);
                    AndroidUtilities.updateViewShow(ubVar.d, false, false, true);
                    AndroidUtilities.updateViewShow(ubVar.f29623b, true, false, true);
                }
                ocVar.i(true);
                return;
            case 24:
            ...
            default:
                ...
                chatActivityEnterView3.f21794i1 = chatActivityEnterView3.f21788h1.getAudioRightMs() - chatActivityEnterView3.f21788h1.getAudioLeftMs();
                MediaController.getInstance().trimCurrentRecording(chatActivityEnterView3.f21788h1.getAudioLeftMs(), chatActivityEnterView3.f21788h1.getAudioRightMs(), (org.telegram.ui.Components.ng) obj);
                return;
        }
    }
