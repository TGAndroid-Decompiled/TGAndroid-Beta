...
public final class wu extends org.telegram.ui.Components.yl0 {
    public static final int f39256p3 = 0;
    public boolean X2;
    public int Y2;
    public final s4.c0 Z2;
    public final uu f39257a3;
    public final ArrayList f39258b3;
    public final ArrayList f39259c3;
    public final float[] f39260d3;
    public final int[] f39261e3;
    public final ArrayList f39262f3;
    public vu[] f39263g3;
    public vu[] f39264h3;
    public final boolean[] f39265i3;
    public long j3;
    public long f39266k3;
    public long f39267l3;
    public boolean f39268m3;
    public tu f39269n3;
    public final av f39270o3;
    ...
    public wu(av avVar, Activity activity) {
        ...
        this.X2 = false;
        this.Y2 = 0;
        this.f39258b3 = new ArrayList();
        this.f39259c3 = new ArrayList();
        this.f39260d3 = new float[7];
        this.f39261e3 = new int[7];
        this.f39262f3 = new ArrayList();
        this.f39265i3 = new boolean[7];
        ...
        li.b.a(this, avVar.h, avVar.f32186n, AndroidUtilities.dp(42.0f) + org.telegram.ui.ActionBar.k.getCurrentActionBarHeight());
    }
    ...
    public final void A1() {
        ...
        if (this.f39263g3 == null) {
            this.f39263g3 = new vu[7];
        }
        if (this.f39264h3 == null) {
            this.f39264h3 = new vu[7];
        }
        int i19 = 0;
        while (true) {
            int[] iArr = av.f32181x;
            int length = iArr.length;
            float[] fArr = this.f39260d3;
            if (i19 < length) {
                int i20 = iArr[i19];
                long x12 = x1(i20) + z1(i20);
                vu[] vuVarArr = this.f39264h3;
                vu[] vuVarArr2 = this.f39263g3;
                long x13 = x1(iArr[i19]);
                long z12 = z1(iArr[i19]);
                int i21 = iArr[i19];
                int i22 = this.Y2;
                av avVar = this.f39270o3;
                ...
                Arrays.sort(this.f39263g3, new df(20));
                AndroidUtilities.roundPercents(fArr, this.f39261e3);
                Arrays.fill(this.f39265i3, true);
                return;
            }
        }
    }
    ...
    public final void B1(boolean z10) {
        ...
        String format;
        CharSequence concat;
        ArrayList arrayList = this.f39258b3;
        arrayList.clear();
        ArrayList arrayList2 = this.f39259c3;
        ...
        int i14 = 0;
        while (true) {
            vu[] vuVarArr = this.f39263g3;
            if (i14 >= vuVarArr.length) {
                break;
            }
            vu vuVar = vuVarArr[i14];
            long j10 = j3;
            long j11 = vuVar.f23346c;
            int i15 = vuVar.d;
            if (!this.f39268m3 && !this.f39262f3.contains(Integer.valueOf(i15))) {
                z11 = false;
            } else {
                z11 = true;
            }
            ...
            if (i16 > 0 || z11) {
                ...
                metricAffectingSpan.f36988a = 0.1d;
                spannableString3.setSpan(metricAffectingSpan, 0, spannableString3.length(), 33);
                int i18 = av.v[i15];
                int[] iArr = av.f32178r[i15];
                int i19 = iArr[0];
                int i20 = iArr[1];
                if (i16 == 0) {
                    concat = LocaleController.getString(av.f32180w[i15]);
                } else {
                    concat = TextUtils.concat(LocaleController.getString(av.f32180w[i15]), "  ", spannableString3);
                }
        ...
        if (!arrayList3.isEmpty()) {
            ...
            while (i22 < arrayList3.size()) {
                ...
                if (i23 >= 0 && !this.f39265i3[i23]) {
                    vu vuVar2 = this.f39263g3[i23];
                    int[] iArr2 = av.f32181x;
                    int i24 = vuVar2.d;
                    int i25 = vuVar2.f38624g;
                    int i26 = vuVar2.h;
                    long j13 = vuVar2.e;
                    spannableString = spannableString4;
                    spannableString2 = spannableString5;
                    long j14 = vuVar2.f38623f;
                    int i27 = iArr2[i24];
                    if (i27 == 0) {
                        if (j14 > j12 || i26 > 0) {
                            i22++;
        ...
        if (!this.f39268m3) {
            ...
            arrayList2.add(new ru(-1, R.drawable.msg_filled_data_sent, -11565578, -13276952, LocaleController.getString(R.string.BytesSent), AndroidUtilities.formatFileSize(this.f39267l3)));
            arrayList2.add(new ru(-1, R.drawable.msg_filled_data_received, -11154873, -14175180, LocaleController.getString(R.string.BytesReceived), AndroidUtilities.formatFileSize(this.f39266k3)));
        }
        if (!arrayList3.isEmpty()) {
            i10 = 3;
