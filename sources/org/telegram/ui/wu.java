...
public final class wu extends org.telegram.ui.Components.ll0 {
    public static final int f42480p3 = 0;
    public boolean X2;
    public int Y2;
    public final s4.c0 Z2;
    public final uu f42481a3;
    public final ArrayList f42482b3;
    public final ArrayList f42483c3;
    public final float[] f42484d3;
    public final int[] f42485e3;
    public final ArrayList f42486f3;
    public vu[] f42487g3;
    public vu[] f42488h3;
    public final boolean[] f42489i3;
    public long j3;
    public long f42490k3;
    public long f42491l3;
    public boolean f42492m3;
    public tu f42493n3;
    public final av f42494o3;
    ...
    public wu(av avVar, Activity activity) {
        ...
        this.X2 = false;
        this.Y2 = 0;
        this.f42482b3 = new ArrayList();
        this.f42483c3 = new ArrayList();
        this.f42484d3 = new float[7];
        this.f42485e3 = new int[7];
        this.f42486f3 = new ArrayList();
        this.f42489i3 = new boolean[7];
    ...
    public final void y1() {
        ...
        this.f42490k3 = v1(6);
        this.f42491l3 = x1(6);
        if (this.f42487g3 == null) {
            this.f42487g3 = new vu[7];
        }
        if (this.f42488h3 == null) {
            this.f42488h3 = new vu[7];
        }
        int i19 = 0;
        while (true) {
            int[] iArr = av.f34554n;
            int length = iArr.length;
            float[] fArr = this.f42484d3;
            if (i19 < length) {
                int i20 = iArr[i19];
                long v12 = v1(i20) + x1(i20);
                vu[] vuVarArr = this.f42488h3;
                vu[] vuVarArr2 = this.f42487g3;
                ...
                Arrays.sort(this.f42487g3, new f6(22));
                AndroidUtilities.roundPercents(fArr, this.f42485e3);
                Arrays.fill(this.f42489i3, true);
                return;
            }
        }
    }
    ...
    public final void z1(boolean z10) {
        ...
        String format;
        CharSequence concat;
        ArrayList arrayList = this.f42482b3;
        arrayList.clear();
        ArrayList arrayList2 = this.f42483c3;
        ...
        int i14 = 0;
        while (true) {
            vu[] vuVarArr = this.f42487g3;
            if (i14 >= vuVarArr.length) {
                break;
            }
            vu vuVar = vuVarArr[i14];
            long j10 = j3;
            long j11 = vuVar.f25371c;
            int i15 = vuVar.d;
            if (!this.f42492m3 && !this.f42486f3.contains(Integer.valueOf(i15))) {
                z11 = false;
            } else {
                z11 = true;
            }
        ...
        if (!arrayList3.isEmpty()) {
            ...
            while (i22 < arrayList3.size()) {
                ...
                if (i23 >= 0 && !this.f42489i3[i23]) {
                    vu vuVar2 = this.f42487g3[i23];
                    int[] iArr2 = av.f34554n;
                    int i24 = vuVar2.d;
                    int i25 = vuVar2.f41701g;
                    int i26 = vuVar2.h;
                    long j13 = vuVar2.f41699e;
                    spannableString = spannableString4;
                    spannableString2 = spannableString5;
                    long j14 = vuVar2.f41700f;
                    int i27 = iArr2[i24];
                    if (i27 == 0) {
                        if (j14 > j12 || i26 > 0) {
                            i22++;
        ...
        if (!this.f42492m3) {
            ...
            arrayList2.add(new ru(-1, R.drawable.msg_filled_data_sent, -11565578, -13276952, LocaleController.getString(R.string.BytesSent), AndroidUtilities.formatFileSize(this.f42491l3)));
            arrayList2.add(new ru(-1, R.drawable.msg_filled_data_received, -11154873, -14175180, LocaleController.getString(R.string.BytesReceived), AndroidUtilities.formatFileSize(this.f42490k3)));
        }
        if (!arrayList3.isEmpty()) {
            i10 = 3;
