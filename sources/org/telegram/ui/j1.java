...
public final class j1 extends FrameLayout implements org.telegram.ui.Cells.p9 {
    public final ai.w0 f34749a;
    public final g1 f34750b;
    public a3 f34751c;
    public a3 d;
    public int e;
    public int f34752f;
    public int h;
    public int f34753n;
    public boolean f34754r;
    public TL_iv.pageBlockCollage f34755s;
    public final i1 v;
    public final f4 f34756w;
    public final h4 f34757x;
    ...
    public final void onDraw(Canvas canvas) {
        if (this.f34755s != null) {
            a3 a3Var = this.f34751c;
            h4 h4Var = this.f34757x;
            int i10 = 0;
            if (a3Var != null) {
                canvas.save();
                canvas.translate(this.f34752f, this.h);
                h4.v(h4Var, canvas, this, 0);
                this.f34751c.draw(canvas, this);
                canvas.restore();
                i10 = 1;
            }
            if (this.d != null) {
                canvas.save();
                canvas.translate(this.f34752f, this.h + this.f34753n);
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (this.f34751c != null) {
            sb2.append(", ");
            sb2.append(this.f34751c.d.getText());
        }
        if (this.d != null) {
            sb2.append(", ");
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        TL_iv.pageBlockCollage pageblockcollage = this.f34755s;
        if (pageblockcollage != null) {
            ...
            if (i14 > 0) {
                ...
                this.e = 0;
                this.f34752f = AndroidUtilities.dp(18.0f);
            ...
            this.h = dp3;
            TL_iv.pageBlockCollage pageblockcollage2 = this.f34755s;
            TL_iv.RichText richText = pageblockcollage2.caption.text;
            HashSet hashSet = h4.f34129b1;
            Layout.Alignment alignment = Layout.Alignment.ALIGN_NORMAL;
            h4 h4Var = this.f34757x;
            j1Var = this;
            a3 p5 = h4.p(h4Var, j1Var, null, richText, dp, dp3, pageblockcollage2, alignment, 0, this.f34756w);
            j1Var.f34751c = p5;
            if (p5 != null) {
                int height = j1Var.f34751c.d.getHeight() + AndroidUtilities.dp(4.0f);
                j1Var.f34753n = height;
                measuredHeight = org.telegram.messenger.w1.C(4.0f, height, measuredHeight);
                a3 a3Var = j1Var.f34751c;
                a3Var.f31698s = j1Var.f34752f;
                a3Var.v = j1Var.h;
            } else {
                j1Var.f34753n = 0;
            }
            TL_iv.pageBlockCollage pageblockcollage3 = j1Var.f34755s;
            TL_iv.RichText richText2 = pageblockcollage3.caption.credit;
            if (j1Var.f34756w.G) {
                alignment = org.telegram.ui.Components.kw0.a();
            }
            a3 p10 = h4.p(h4Var, j1Var, null, richText2, dp, 0, pageblockcollage3, alignment, 0, j1Var.f34756w);
            j1Var.d = p10;
            if (p10 != null) {
                measuredHeight += j1Var.d.d.getHeight() + AndroidUtilities.dp(4.0f);
                a3 a3Var2 = j1Var.d;
                a3Var2.f31698s = j1Var.f34752f;
                a3Var2.v = j1Var.h + j1Var.f34753n;
            }
            int dp4 = AndroidUtilities.dp(16.0f) + measuredHeight;
            TL_iv.pageBlockCollage pageblockcollage4 = j1Var.f34755s;
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        int i11 = this.h;
        h4 h4Var = this.f34757x;
        if (!h4.l(h4Var, this.f34756w, motionEvent, this, a3Var, i10, i11)) {
            if (!h4.l(h4Var, this.f34756w, motionEvent, this, this.d, this.f34752f, this.h + this.f34753n) && !super.onTouchEvent(motionEvent)) {
                return false;
            }
            return true;
        }
