...
public final class hv extends LinearLayout {
    public final fc1 f34358a;
    public s4.c0 f34359b;
    public final org.telegram.ui.Components.kp f34360c;
    public final org.telegram.ui.Components.yi0 d;
    public final org.telegram.ui.Cells.r8 e;
    public final org.telegram.ui.Cells.r8 f34361f;
    public ValueAnimator h;
    public int f34362n;
    public int f34363r;
    public final int f34364s;
    public int v;
    public Boolean f34365w;
    ...
    public hv(int i10, Context context, org.telegram.ui.ActionBar.o2 o2Var) {
        ...
        if (i10 == 0) {
            ...
            this.e = r8Var;
            r8Var.setBackground(org.telegram.ui.ActionBar.j6.f0(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18953i6, false), 2, -1));
            r8Var.f20822w = 21;
        ...
        if (!MediaDataController.getInstance(o2Var.getCurrentAccount()).defaultEmojiThemes.isEmpty()) {
            ...
            if (i10 == 0) {
                ...
                if (string != null && org.telegram.ui.ActionBar.j6.N0(string) != null) {
                    if (i12 == -1) {
                        i12 = org.telegram.ui.ActionBar.j6.N0(string).f18766f0;
                    }
                } else {
                ...
                if (string2 != null && org.telegram.ui.ActionBar.j6.N0(string2) != null) {
                    if (i14 == -1) {
                        i14 = org.telegram.ui.ActionBar.j6.N0(str).f18766f0;
                    }
                } else {
                ...
                d4Var.f18575a = org.telegram.ui.ActionBar.j6.N0(str);
                d4Var.e = i13;
                e4Var.f18621f.add(d4Var);
                e4Var.f18621f.add(null);
                org.telegram.ui.ActionBar.d4 d4Var2 = new org.telegram.ui.ActionBar.d4();
                d4Var2.f18575a = org.telegram.ui.ActionBar.j6.N0(str2);
                d4Var2.e = i14;
                ...
                lpVar.f25959c = org.telegram.ui.ActionBar.j6.f1() ? 0 : 2;
                arrayList.add(lpVar);
            }
            kpVar.d = arrayList;
            kpVar.l();
        ...
        d();
        a();
        int i15 = this.f34363r;
        if (i15 >= 0 && (c0Var = this.f34359b) != null) {
            c0Var.h1(i15, AndroidUtilities.dp(16.0f));
        }
    }

    public final void a() {
        int i10 = this.f34364s;
        if (i10 == 0 || i10 == -1) {
            ...
            if (r8Var != null) {
                org.telegram.ui.ActionBar.j6.B1(r8Var.getBackground(), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18953i6, false), true);
                r8Var.e(-1, org.telegram.ui.ActionBar.j6.q6);
            }
            org.telegram.ui.Cells.r8 r8Var2 = this.f34361f;
            if (r8Var2 != null) {
                r8Var2.setBackground(org.telegram.ui.ActionBar.j6.g0(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18863d6, false), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18953i6, false)));
    ...
    public final void b() {
        ...
        org.telegram.ui.Components.kp kpVar = this.f34360c;
        if (kpVar.d != null) {
            for (int i14 = 0; i14 < kpVar.d.size(); i14++) {
                ((org.telegram.ui.Components.lp) kpVar.d.get(i14)).f25959c = this.v;
            }
    ...
    public final void c() {
        ...
        Boolean bool = this.f34365w;
        if (bool != null && bool.booleanValue() == z10) {
            return;
        }
        fc1 fc1Var = this.f34358a;
        int i11 = this.f34364s;
        if (i11 != 0 && i11 != -1) {
            if (z10) {
                i10 = 3;
            } else {
    ...
    public final void d() {
        ...
        while (true) {
            ...
            org.telegram.ui.ActionBar.e4 e4Var = ((org.telegram.ui.Components.lp) kpVar.d.get(i10)).f25957a;
            TLRPC.TL_theme tL_theme = ((org.telegram.ui.ActionBar.d4) e4Var.f18621f.get(this.v)).f18576b;
            org.telegram.ui.ActionBar.i6 j3 = ((org.telegram.ui.Components.lp) kpVar.d.get(i10)).f25957a.j(this.v);
            if (tL_theme != null) {
                org.telegram.ui.ActionBar.e4 e4Var2 = ((org.telegram.ui.Components.lp) kpVar.d.get(i10)).f25957a;
                if (org.telegram.ui.ActionBar.j6.I.f18757a.equals(org.telegram.ui.ActionBar.j6.q0(tL_theme.settings.get(((org.telegram.ui.ActionBar.d4) e4Var2.f18621f.get(this.v)).d)))) {
                    LongSparseArray longSparseArray = org.telegram.ui.ActionBar.j6.I.f18762c0;
                    if (longSparseArray == null) {
                        this.f34363r = i10;
                        break;
                    }
                    org.telegram.ui.ActionBar.h6 h6Var = (org.telegram.ui.ActionBar.h6) longSparseArray.get(tL_theme.f18258id);
                    if (h6Var != null && h6Var.f18721a == org.telegram.ui.ActionBar.j6.I.Y) {
                        this.f34363r = i10;
                        break;
                    }
                } else {
                ...
                if (j3 != null) {
                    if (org.telegram.ui.ActionBar.j6.I.f18757a.equals(j3.m())) {
                        org.telegram.ui.ActionBar.e4 e4Var3 = ((org.telegram.ui.Components.lp) kpVar.d.get(i10)).f25957a;
                        if (((org.telegram.ui.ActionBar.d4) e4Var3.f18621f.get(this.v)).e == org.telegram.ui.ActionBar.j6.I.Y) {
                            this.f34363r = i10;
                            break;
                        }
                    } else {
        ...
        if (this.f34363r == -1 && this.f34364s != 3) {
            this.f34363r = kpVar.d.size() - 1;
        }
