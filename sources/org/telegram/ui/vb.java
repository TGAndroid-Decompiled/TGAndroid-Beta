...
public final class vb extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final fh.e f38411a;
    public FrameLayout f38412a0;
    public final ah.c f38413b;
    public ImageView f38414b0;
    public final ah.c f38415c;
    public org.telegram.ui.ActionBar.j5 f38416c0;
    public final ah.i d;
    public j0 f38417d0;
    public final int e;
    public k4 f38418e0;
    public final TLRPC.Chat f38419f;
    public TextureView f38420f0;
    public int f38421g0;
    public final ArrayList h;
    public int f38422h0;
    public boolean f38423i0;
    public boolean f38424j0;
    public final a0.i f38425k0;
    public final a0.i f38426l0;
    public final HashMap m0;
    public FrameLayout f38427n;
    public final ArrayList f38428n0;
    public final ArrayList f38429o0;
    public final HashSet f38430p0;
    public boolean f38431q0;
    public View f38432r;
    public boolean f38433r0;
    public RadialProgressView f38434s;
    public boolean f38435s0;
    public ArrayList f38436t0;
    public TLRPC.TL_channelAdminLogEventsFilter f38437u0;
    public kb v;
    public String f38438v0;
    public UndoView f38439w;
    public a0.i f38440w0;
    public gg.b0 f38441x;
    public final AnimationNotificationsLocker f38442x0;
    public org.telegram.ui.Components.zk0 f38443y;
    public final HashMap f38444y0;
    public HashMap f38445z0;
    ...
    public vb(TLRPC.Chat chat) {
        ...
        this.f38423i0 = true;
        this.f38424j0 = false;
        this.f38425k0 = new a0.i();
        this.f38426l0 = new a0.i();
        this.m0 = new HashMap();
        this.f38428n0 = new ArrayList();
        this.f38429o0 = new ArrayList();
        this.f38430p0 = new HashSet();
        this.f38437u0 = null;
        this.f38438v0 = "";
        this.f38442x0 = new AnimationNotificationsLocker(R0);
        this.f38444y0 = new HashMap();
        this.B0 = new hb(this);
        ...
        if (Build.VERSION.SDK_INT >= 31 && SharedConfig.chatBlurEnabled()) {
            ...
            this.d = iVar2;
            this.glassEngine.f14305i.add(iVar2);
    ...
    public static void A0(vb vbVar, TLRPC.TL_messages_exportedChatInvite tL_messages_exportedChatInvite, HashMap hashMap) {
        ...
        TLRPC.Chat chat = vbVar.f38419f;
        TLRPC.ChatFull chatFull = messagesController.getChatFull(chat.f18296id);
        org.telegram.ui.Components.a70 a70Var = new org.telegram.ui.Components.a70(vbVar.X.getContext(), (TLRPC.TL_chatInviteExported) tL_messages_exportedChatInvite.invite, chatFull, hashMap, vbVar, chatFull.f18297id, false, ChatObject.isChannel(chat));
        a70Var.f22547j0 = new ib(vbVar);
        a70Var.show();
    }
    ...
    public static void K0(vb vbVar) {
        if (vbVar.v != null && !vbVar.f38428n0.isEmpty()) {
            vbVar.f38441x.h1(vbVar.f38429o0.size() - 1, (-100000) - vbVar.v.getPaddingTop());
        }
    }
    ...
    public static void U(vb vbVar, TLRPC.TL_channels_adminLogResults tL_channels_adminLogResults) {
        ...
        ArrayList arrayList = vbVar.f38428n0;
        boolean z10 = false;
        for (int i11 = 0; i11 < tL_channels_adminLogResults.events.size(); i11++) {
            ...
            if (iVar.h(tL_channelAdminLogEvent.f18328id) < 0) {
                ...
                vbVar.O = Math.min(vbVar.O, tL_channelAdminLogEvent.f18328id);
                MessageObject messageObject2 = new MessageObject(vbVar.currentAccount, tL_channelAdminLogEvent, (ArrayList<MessageObject>) arrayList, (HashMap<String, ArrayList<MessageObject>>) vbVar.m0, vbVar.f38419f, vbVar.T, false);
                if (messageObject2.contentType >= 0) {
                    iVar.k(messageObject2, tL_channelAdminLogEvent.f18328id);
                }
                z10 = true;
            }
        }
        ...
        for (int size = arrayList.size(); size < arrayList.size(); size++) {
            ...
            if (messageObject3 != null && messageObject3.contentType != 0 && messageObject3.getRealId() >= 0) {
                vbVar.f38426l0.k(messageObject3, messageObject3.getRealId());
            }
        ...
        if (!arrayList2.isEmpty()) {
            MediaDataController.getInstance(vbVar.currentAccount).loadReplyMessagesForMessages(arrayList2, -vbVar.f38419f.f18296id, 0, 0L, new ya(vbVar, 1), vbVar.getClassGuid(), null);
        }
        vbVar.R0();
        vbVar.f38433r0 = false;
        if (!z10) {
            vbVar.f38431q0 = true;
        }
        AndroidUtilities.updateViewVisibilityAnimated(vbVar.f38427n, false, 0.3f, true);
        ...
        if (v0Var != null) {
            if (vbVar.f38429o0.isEmpty() && TextUtils.isEmpty(vbVar.f38438v0)) {
                i10 = 8;
            }
            ...
            while (i11 < size) {
                if (arrayList4.get(i11) == null) {
                    ...
                    if (((Integer) arrayList4.get(i11)).intValue() == 35) {
                        f1Var.c(vbVar.getThemedColor(org.telegram.ui.ActionBar.j6.f19301q7), vbVar.getThemedColor(org.telegram.ui.ActionBar.j6.f19283p7));
                    }
    ...
    public static void Y(vb vbVar, TLRPC.TL_channels_adminLogResults tL_channels_adminLogResults) {
        ...
        for (int i10 = 0; i10 < tL_channels_adminLogResults.events.size(); i10++) {
            ...
            if (iVar.h(tL_channelAdminLogEvent2.f18328id) < 0) {
                ...
                vbVar.O = Math.min(vbVar.O, tL_channelAdminLogEvent2.f18328id);
                MessageObject messageObject = new MessageObject(vbVar.currentAccount, tL_channelAdminLogEvent2, (ArrayList<MessageObject>) arrayList, (HashMap<String, ArrayList<MessageObject>>) hashMap, vbVar.f38419f, vbVar.T, false);
                if (messageObject.contentType >= 0 && (((tL_channelAdminLogEvent = messageObject.currentEvent) == null || !(tL_channelAdminLogEvent.action instanceof TLRPC.TL_channelAdminLogEventActionDeleteMessage)) && !iVar.d(tL_channelAdminLogEvent2.f18328id))) {
                    vbVar.f38428n0.add(0, messageObject);
                    iVar.k(messageObject, tL_channelAdminLogEvent2.f18328id);
                    z10 = true;
                }
            }
        }
    ...
    public static void Z(vb vbVar, TLRPC.TL_error tL_error, TLObject tLObject) {
        ...
        if (tL_error == null) {
            ...
            vbVar.f38436t0 = tL_channels_channelParticipants.participants;
            if (chat != null && (chatFull = vbVar.getMessagesController().getChatFull(chat.f18296id)) != null && chatFull.antispam) {
    ...
    public final MessageObject N0(long j3, long j10, ArrayList arrayList, boolean z10, boolean z11) {
        ...
        int i12 = 0;
        while (true) {
            ArrayList arrayList2 = this.f38429o0;
            messageObject = null;
        ...
        if (messageObject2 == null) {
            ...
            tL_message.dialog_id = -this.f38419f.f18296id;
        ...
        if (z11 && arrayList.size() > 1) {
            ...
            if (S0 == null) {
                ...
                org.telegram.ui.Components.o6 o6Var = S0.f34969a;
                o6Var.u(bold);
                ...
                org.telegram.ui.Components.o6 o6Var2 = S0.f34969a;
                if (z10) {
    ...
    public final void O0(boolean z10) {
        int abs;
        gg.b0 b0Var = this.f38441x;
        if (b0Var != null && !this.f38423i0) {
            int L0 = b0Var.L0();
            int i10 = 1;
            if (L0 == -1) {
                abs = 0;
            } else {
                abs = Math.abs(this.f38441x.N0() - L0) + 1;
            }
            if (abs > 0) {
                this.E.getClass();
                if (z10) {
                ...
                if (L0 <= i10 && !this.f38433r0 && !this.f38431q0) {
                    U0(false);
                }
            }
        }
    ...
    public final TextureView Q0(boolean z10) {
        ...
        if (this.f38417d0 == null) {
            j0 j0Var = new j0(this, getParentActivity(), 4);
            this.f38417d0 = j0Var;
            j0Var.setOutlineProvider(new ai.k2(8));
            this.f38417d0.setClipToOutline(true);
            this.f38417d0.setWillNotDraw(false);
            this.f38417d0.setVisibility(4);
            k4 k4Var = new k4(getParentActivity());
            this.f38418e0 = k4Var;
            k4Var.setBackgroundColor(0);
            if (z10) {
                this.f38417d0.addView(this.f38418e0, w7.y5.c(-1.0f, -1));
            }
            TextureView textureView = new TextureView(getParentActivity());
            this.f38420f0 = textureView;
            textureView.setOpaque(false);
            this.f38418e0.addView(this.f38420f0, w7.y5.c(-1.0f, -1));
        }
        if (this.f38417d0.getParent() == null) {
            sb sbVar = this.X;
            j0 j0Var2 = this.f38417d0;
            int i10 = AndroidUtilities.roundMessageSize;
            sbVar.addView(j0Var2, 1, new FrameLayout.LayoutParams(i10, i10));
        }
        this.f38417d0.setVisibility(4);
        this.f38418e0.setDrawingReady(false);
    ...
    public final void R0() {
        ...
        int i12 = 0;
        while (true) {
            ArrayList arrayList4 = this.f38428n0;
            if (i12 < arrayList4.size()) {
                ...
                if (j3 != j10 && !arrayList3.isEmpty()) {
                    ...
                    if (!arrayList3.isEmpty()) {
                        ...
                        if (TextUtils.isEmpty(this.f38438v0) && arrayList3.size() > 3) {
                            z11 = true;
                        } else {
                            z11 = false;
                        }
                        Long valueOf = Long.valueOf(messageObject3.eventId);
                        HashSet hashSet = this.f38430p0;
                ...
                ArrayList arrayList6 = this.f38429o0;
                arrayList6.clear();
    ...
    public final void U0(boolean z10) {
        rb rbVar;
        if (!this.f38433r0) {
            ArrayList arrayList = this.f38428n0;
            if (z10) {
                this.O = Long.MAX_VALUE;
                FrameLayout frameLayout = this.f38427n;
                if (frameLayout != null) {
            ...
            tL_channels_getAdminLog.channel = MessagesController.getInputChannel(this.f38419f);
            tL_channels_getAdminLog.f18331q = this.f38438v0;
            ...
            TLRPC.TL_channelAdminLogEventsFilter tL_channelAdminLogEventsFilter = this.f38437u0;
            ...
            if (this.f38440w0 != null) {
                tL_channels_getAdminLog.flags |= 2;
                for (int i10 = 0; i10 < this.f38440w0.m(); i10++) {
                    tL_channels_getAdminLog.admins.add(MessagesController.getInstance(this.currentAccount).getInputUser((TLRPC.User) this.f38440w0.n(i10)));
                }
            }
            b1();
    ...
    public final void W0(boolean z10) {
        ...
        long j3;
        kb kbVar = this.v;
        if (kbVar != null && this.f38441x != null && kbVar.getChildCount() > 0) {
            if (z10) {
    ...
    public final int X0(MessageObject messageObject) {
        ...
        if (!TextUtils.isEmpty(null)) {
            if (!TextUtils.isEmpty(messageObject.caption) && (u1Var = this.J0) != null && (textLayoutBlocks = u1Var.f21254c4) != null) {
                ...
                if (u1Var2 != null && u1Var2.f21493t1) {
                    i10 = u1Var2.f21392m2 + AndroidUtilities.dp(10.0f);
    ...
    public final void b1() {
        ...
        if (!TextUtils.isEmpty(this.f38438v0)) {
        ...
        } else if (this.f38440w0 == null && this.f38437u0 == null) {
    ...
    public final void c1() {
        ...
        for (int i13 = 0; i13 < childCount; i13++) {
            ...
            if (childAt instanceof org.telegram.ui.Cells.v1) {
                ...
                if (this.f38417d0 != null && messageObject2.isRoundVideo() && MediaController.getInstance().isPlayingMessage(messageObject2)) {
                    ImageReceiver photoImage = u1Var2.getPhotoImage();
                    this.f38417d0.setTranslationX(photoImage.getImageX());
                    this.f38417d0.setTranslationY(photoImage.getImageY() + this.fragmentView.getPaddingTop() + top);
                    this.fragmentView.invalidate();
                    this.f38417d0.invalidate();
                    z11 = true;
                }
    ...
    public final View createView(Context context) {
        ...
        this.J = linearLayout;
        linearLayout.setBackground(new org.telegram.ui.ActionBar.v5(this.L, this.X, AndroidUtilities.dp(12.0f), org.telegram.ui.ActionBar.j6.f19094f2));
        ...
        ai.p4 p4Var2 = this.L;
        int i11 = org.telegram.ui.ActionBar.j6.f19158ic;
        ...
        this.f38441x = b0Var;
        b0Var.j1(1);
        this.f38441x.l1(true);
        this.v.setLayoutManager(this.f38441x);
        org.telegram.ui.Components.zk0 zk0Var = new org.telegram.ui.Components.zk0(this.v, this.f38441x);
        this.f38443y = zk0Var;
        zk0Var.h = new za(this);
        zk0Var.f30837i = this.L0;
        this.X.addView(this.v, w7.y5.c(-1.0f, -1));
        this.v.setOnScrollListener(new h3(this));
        this.glassEngine.a(this.v);
        int i14 = this.f38421g0;
        if (i14 != -1) {
            this.f38441x.h1(i14, this.f38422h0);
            this.f38421g0 = -1;
        }
        ?? view = new View(context);
        this.W = view;
        view.setup(this.f38413b);
        ...
        this.f38427n = frameLayout2;
        frameLayout2.setVisibility(4);
        this.X.addView(this.f38427n, w7.y5.e(-1, -1, 51));
        View view2 = new View(context);
        this.f38432r = view2;
        view2.setBackground(new org.telegram.ui.ActionBar.v5(this.f38432r, this.X, AndroidUtilities.dp(18.0f), org.telegram.ui.ActionBar.j6.f19094f2));
        this.f38427n.addView(this.f38432r, w7.y5.e(36, 36, 17));
        RadialProgressView radialProgressView = new RadialProgressView(context, null);
        this.f38434s = radialProgressView;
        radialProgressView.setSize(AndroidUtilities.dp(28.0f));
        this.f38434s.setProgressColor(org.telegram.ui.ActionBar.j6.w0(null, i11, false));
        this.f38427n.addView(this.f38434s, w7.y5.e(32, 32, 17));
        ...
        textView.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view3) {
                switch (r2) {
                    case 0:
                        vb vbVar = this.f32620b;
                        if (vbVar.getParentActivity() != null) {
                            org.telegram.ui.Components.g0 g0Var = new org.telegram.ui.Components.g0(vbVar, vbVar.f38437u0, vbVar.f38440w0, vbVar.f38419f.megagroup);
                            g0Var.S(vbVar.f38436t0);
                            g0Var.f24279g0 = new za(vbVar);
                            vbVar.showDialog(g0Var);
                            return;
                        }
                        return;
                    case 1:
                        vb vbVar2 = this.f32620b;
                        AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(vbVar2.getParentActivity());
                        if (vbVar2.f38419f.megagroup) {
                            alertDialog$Builder.f18622a.T = AndroidUtilities.replaceTags(LocaleController.getString(R.string.EventLogInfoDetail));
                        } else {
                            alertDialog$Builder.f18622a.T = AndroidUtilities.replaceTags(LocaleController.getString(R.string.EventLogInfoDetailChannel));
                        }
                        alertDialog$Builder.k(LocaleController.getString(R.string.OK), null);
                        ...
                        return;
                    default:
                        vb vbVar3 = this.f32620b;
                        if (vbVar3.getParentActivity() != null) {
                            AndroidUtilities.hideKeyboard(vbVar3.N.getSearchField());
                            vbVar3.showDialog(org.telegram.ui.Components.e5.p(vbVar3.getParentActivity(), new va(vbVar3, 0), null).f18627a);
                            return;
                        }
                        return;
                }
        ...
        this.f38412a0 = frameLayout3;
        frameLayout3.setWillNotDraw(false);
        this.f38412a0.setVisibility(4);
        this.f38412a0.setFocusable(true);
        this.f38412a0.setFocusableInTouchMode(true);
        this.f38412a0.setClickable(true);
        this.f38412a0.setPadding(0, AndroidUtilities.dp(3.0f), 0, 0);
        this.X.addView(this.f38412a0, w7.y5.e(-1, 51, 80));
        ImageView imageView2 = new ImageView(context);
        this.f38414b0 = imageView2;
        imageView2.setScaleType(scaleType);
        this.f38414b0.setImageResource(R.drawable.msg_calendar);
        this.f38414b0.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19435xe, false), PorterDuff.Mode.MULTIPLY));
        this.f38412a0.addView(this.f38414b0, w7.y5.e(48, 48, 53));
        this.f38414b0.setOnClickListener(new View.OnClickListener(this) {
            public final vb f32620b;
        ...
        this.f38416c0 = j5Var;
        j5Var.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19453ye, false));
        this.f38416c0.setTextSize(15);
        this.f38416c0.setTypeface(AndroidUtilities.bold());
        this.f38412a0.addView(this.f38416c0, w7.y5.d(-1, -2.0f, 19, 108.0f, 0.0f, 0.0f, 0.0f));
        this.E.D(true);
        if (this.f38433r0 && this.f38428n0.isEmpty()) {
            AndroidUtilities.updateViewVisibilityAnimated(this.f38427n, true, 0.3f, true);
            this.v.setEmptyView(null);
        } else {
            AndroidUtilities.updateViewVisibilityAnimated(this.f38427n, false, 0.3f, true);
        ...
        this.f38439w = undoView;
        undoView.setAdditionalTranslationY(AndroidUtilities.dp(51.0f));
        this.X.addView(this.f38439w, w7.y5.d(-1, -2.0f, 83, 8.0f, 0.0f, 8.0f, 8.0f));
        b1();
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.messagePlayingDidStart) {
            if (((MessageObject) objArr[0]).isRoundVideo()) {
                MediaController.getInstance().setTextureView(Q0(true), this.f38418e0, this.f38417d0, true);
                ...
                while (true) {
                    if (i12 < childCount) {
                        ...
                        if (childAt instanceof org.telegram.ui.Cells.u1) {
                            ...
                            if (this.f38417d0 != null && messageObject4.isRoundVideo() && MediaController.getInstance().isPlayingMessage(messageObject4)) {
                                ImageReceiver photoImage = u1Var4.getPhotoImage();
                                this.f38417d0.setTranslationX(photoImage.getImageX());
                                this.f38417d0.setTranslationY(photoImage.getImageY() + u1Var4.getTop() + this.fragmentView.getPaddingTop());
                                this.fragmentView.invalidate();
                                this.f38417d0.invalidate();
                                z10 = true;
                                break;
                ...
                if (this.f38417d0 != null) {
                    MessageObject playingMessageObject = MediaController.getInstance().getPlayingMessageObject();
                    if (!z10) {
                        this.f38417d0.setTranslationY((-AndroidUtilities.roundMessageSize) - 100);
                        this.fragmentView.invalidate();
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.I.getSubtitleTextView(), 4, (Class[]) null, new Paint[]{org.telegram.ui.ActionBar.j6.f19040c2, org.telegram.ui.ActionBar.j6.f19058d2}, org.telegram.ui.ActionBar.j6.B8));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.actionBar, 256, null, null, null, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, org.telegram.ui.ActionBar.j6.f19313r0, null, org.telegram.ui.ActionBar.j6.J7));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19154i8));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19172j8));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19192k8));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19210l8));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19229m8));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19249n8));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19266o8));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.f19224m3, org.telegram.ui.ActionBar.j6.f19298q3}, null, org.telegram.ui.ActionBar.j6.f19323ra));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.f19244n3, org.telegram.ui.ActionBar.j6.f19316r3}, null, org.telegram.ui.ActionBar.j6.f19068dc));
        Drawable[] k10 = org.telegram.ui.ActionBar.j6.f19224m3.k();
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, org.telegram.ui.ActionBar.j6.f19298q3.k(), null, i13));
        Drawable[] k11 = org.telegram.ui.ActionBar.j6.f19261o3.k();
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, org.telegram.ui.ActionBar.j6.f19335s3.k(), null, i14));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.f19261o3, org.telegram.ui.ActionBar.j6.f19335s3}, null, org.telegram.ui.ActionBar.j6.Aa));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.f19261o3, org.telegram.ui.ActionBar.j6.f19335s3}, null, org.telegram.ui.ActionBar.j6.Da));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.f19261o3, org.telegram.ui.ActionBar.j6.f19335s3}, null, org.telegram.ui.ActionBar.j6.Ea));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.f19261o3, org.telegram.ui.ActionBar.j6.f19335s3}, null, org.telegram.ui.ActionBar.j6.Fa));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.f19280p3, org.telegram.ui.ActionBar.j6.f19354t3}, null, org.telegram.ui.ActionBar.j6.Ba));
        TextPaint textPaint = org.telegram.ui.ActionBar.j6.f19334s2;
        int i15 = org.telegram.ui.ActionBar.j6.f19158ic;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 4, new Class[]{org.telegram.ui.Cells.w0.class}, textPaint, null, null, i15));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 2, new Class[]{org.telegram.ui.Cells.w0.class}, org.telegram.ui.ActionBar.j6.f19334s2, null, null, org.telegram.ui.ActionBar.j6.f19176jc));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.f19409w4, org.telegram.ui.ActionBar.j6.f19299q4, org.telegram.ui.ActionBar.j6.f19426x4, org.telegram.ui.ActionBar.j6.f19391v4, org.telegram.ui.ActionBar.j6.f19373u4, org.telegram.ui.ActionBar.j6.C4}, null, org.telegram.ui.ActionBar.j6.f19196kc));
        int i16 = org.telegram.ui.ActionBar.j6.f19214lc;
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class, org.telegram.ui.Cells.w0.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19233mc));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19103fc));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 2, new Class[]{org.telegram.ui.Cells.u1.class}, (Paint[]) null, org.telegram.ui.ActionBar.j6.f19139hc));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.f19461z3}, null, org.telegram.ui.ActionBar.j6.Ka));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.F3, org.telegram.ui.ActionBar.j6.G3}, null, org.telegram.ui.ActionBar.j6.f19344sc));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.N3, org.telegram.ui.ActionBar.j6.R3, org.telegram.ui.ActionBar.j6.V3}, null, org.telegram.ui.ActionBar.j6.f19451yc));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.f19003a4, org.telegram.ui.ActionBar.j6.f19023b4, org.telegram.ui.ActionBar.j6.Z3}, null, org.telegram.ui.ActionBar.j6.f19470zc));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.f19079e4}, null, org.telegram.ui.ActionBar.j6.Ta));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.f19096f4}, null, org.telegram.ui.ActionBar.j6.Ua));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.f19042c4}, null, org.telegram.ui.ActionBar.j6.Ac));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.f19060d4}, null, org.telegram.ui.ActionBar.j6.Bc));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.f19114g4}, null, org.telegram.ui.ActionBar.j6.Cc));
        Drawable[] drawableArr = {org.telegram.ui.ActionBar.j6.f19150i4};
        ...
        Drawable[] drawableArr2 = {org.telegram.ui.ActionBar.j6.f19132h4, org.telegram.ui.ActionBar.j6.B4, org.telegram.ui.ActionBar.j6.D4};
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.P4}, null, org.telegram.ui.ActionBar.j6.f19320r7));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.Q4}, null, org.telegram.ui.ActionBar.j6.f19304qa));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, org.telegram.ui.ActionBar.j6.f19021b2, null, null, org.telegram.ui.ActionBar.j6.Fc));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.f19168j4}, null, org.telegram.ui.ActionBar.j6.Gc));
        ...
        int i20 = org.telegram.ui.ActionBar.j6.f19010ab;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, null, null, i20));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19030bb));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19067db));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19085eb));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19012ad));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19102fb));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19050cd));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19121gb));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19069dd));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19138hb));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19086ed));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19157ib));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19104fd));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19175jb));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19140hd));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19159id));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19305qb));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19177jd));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19324rb));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19197kd));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19252nd));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19343sb));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19270od));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19289pd));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19213lb));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19326rd));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19361tb));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19345sd));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19380ub));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19363td));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19397vb));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19382ud));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19416wb));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19417wd));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19450yb));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19434xd));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19399vd));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19469zb));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19433xb));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19452yd));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19471zd));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19160ie));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19381uc));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19178je));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19398vc));
        Drawable[] drawableArr3 = org.telegram.ui.ActionBar.j6.T4;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 32, new Class[]{org.telegram.ui.Cells.u1.class}, null, new Drawable[]{drawableArr3[0]}, null, org.telegram.ui.ActionBar.j6.f19327re));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, new Drawable[]{drawableArr3[0]}, null, org.telegram.ui.ActionBar.j6.f19346se));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19290pe));
        Drawable[] drawableArr4 = org.telegram.ui.ActionBar.j6.S4;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.u1.class}, null, new Drawable[]{drawableArr4[0]}, null, org.telegram.ui.ActionBar.j6.f19308qe));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f38434s, 2048, null, null, null, null, i15));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f38432r, 536870912, null, null, null, null, i16));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.L, 536870912, null, null, null, null, i16));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f38439w, 32, null, null, null, null, org.telegram.ui.ActionBar.j6.Fi));
        int i21 = org.telegram.ui.ActionBar.j6.Gi;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f38439w, 0, new Class[]{UndoView.class}, new String[]{"undoImageView"}, null, null, null, i21));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f38439w, 0, new Class[]{UndoView.class}, new String[]{"undoTextView"}, null, null, null, i21));
        int i22 = org.telegram.ui.ActionBar.j6.Hi;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f38439w, 0, new Class[]{UndoView.class}, new String[]{"infoTextView"}, null, null, null, i22));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f38439w, 0, new Class[]{UndoView.class}, new String[]{"textPaint"}, null, null, null, i22));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f38439w, 0, new Class[]{UndoView.class}, new String[]{"progressPaint"}, null, null, null, i22));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f38439w, 8, new Class[]{UndoView.class}, new String[]{"leftImageView"}, null, null, null, i22));
        return arrayList;
    }
    ...
    public final void onBecomeFullyHidden() {
        UndoView undoView = this.f38439w;
        if (undoView != null) {
            undoView.e(0, true);
        }
    }
    ...
    public final boolean onFragmentCreate() {
        ...
        tL_channels_getParticipants.channel = MessagesController.getInputChannel(this.f38419f);
    ...
    public final void onRemoveFromParent() {
        MediaController.getInstance().setTextureView(this.f38420f0, null, null, false);
