...
public final class n50 extends org.telegram.ui.ActionBar.j {
    public final Activity f35944a;
    public final k60 f35945b;
    ...
    public final void b(int i10) {
        ...
        int i13;
        String str;
        k60 k60Var = this.f35945b;
        if (i10 == -1) {
            k60Var.onBackPressed();
        } else if (i10 == 1) {
            k60Var.f35012a1.call.join_muted = false;
            k60.F0(k60Var);
        } else if (i10 == 2) {
            k60Var.f35012a1.call.join_muted = true;
            k60.F0(k60Var);
        } else if (i10 == 3) {
            k60Var.j1(false);
        } else if (i10 == 12) {
            ...
            if (ChatObject.isChannelOrGiga(k60Var.Z0)) {
                alertDialog$Builder.f18446a.R = LocaleController.getString(R.string.VoipChannelEndAlertTitle);
                alertDialog$Builder.f18446a.T = LocaleController.getString(R.string.VoipChannelEndAlertText);
            } else {
                alertDialog$Builder.f18446a.R = LocaleController.getString(R.string.VoipGroupEndAlertTitle);
                alertDialog$Builder.f18446a.T = LocaleController.getString(R.string.VoipGroupEndAlertText);
            }
            ...
            if (call.recording) {
                ...
                alertDialog$Builder2.f18446a.I = org.telegram.ui.ActionBar.j6.f19091pg;
                alertDialog$Builder2.f18446a.R = LocaleController.getString(R.string.VoipGroupStopRecordingTitle);
                if (ChatObject.isChannelOrGiga(k60Var.Z0)) {
                    alertDialog$Builder2.f18446a.T = LocaleController.getString(R.string.VoipChannelStopRecordingText);
                } else {
                    alertDialog$Builder2.f18446a.T = LocaleController.getString(R.string.VoipGroupStopRecordingText);
                }
                alertDialog$Builder2.k(LocaleController.getString(R.string.Stop), new ai.k(10, this, z10));
                alertDialog$Builder2.h(LocaleController.getString(R.string.Cancel), null);
                int w04 = org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19184ug, false);
                org.telegram.ui.ActionBar.c2 c2Var2 = alertDialog$Builder2.f18446a;
                c2Var2.i(w04);
                c2Var2.show();
                c2Var2.o(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19054ng, false));
                return;
            }
            ...
            k60Var.f35056l0 = true;
            k60Var.f35094u1.setVisibility(0);
            k60Var.f35098v1.setVisibility(0);
            k60Var.f35064n1.setVisibility(8);
            k60Var.f35108x1.setVisibility(8);
            k60Var.f35113y1.setVisibility(8);
            k60Var.f35103w1.setVisibility(8);
            k60Var.f35081r1.setVisibility(8);
            k60Var.f35068o1.setVisibility(8);
            k60Var.f35086s1.setVisibility(8);
            k60Var.f35090t1.setVisibility(8);
            k60Var.f35052k0.setVisibility(8);
            k60Var.f35072p1.setVisibility(8);
            k60Var.f35076q1.setVisibility(8);
            org.telegram.ui.ActionBar.w0 w0Var = k60Var.f35053k1;
            org.telegram.ui.ActionBar.o1 o1Var = w0Var.d;
            if (o1Var != null && o1Var.isShowing()) {
                w0Var.f19605b.measure(org.telegram.messenger.wl.d(40.0f, AndroidUtilities.displaySize.x, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.displaySize.y, Integer.MIN_VALUE));
                w0Var.O(true, true);
            }
        } else if (i10 == 6) {
            ...
            alertDialog$Builder3.f18446a.I = org.telegram.ui.ActionBar.j6.f19091pg;
            if (ChatObject.isChannelOrGiga(k60Var.Z0)) {
                alertDialog$Builder3.f18446a.R = LocaleController.getString(R.string.VoipChannelTitle);
            } else {
                alertDialog$Builder3.f18446a.R = LocaleController.getString(R.string.VoipGroupTitle);
            }
            alertDialog$Builder3.f18446a.f18525y0 = false;
            ...
            if (!TextUtils.isEmpty(k60Var.f35012a1.call.title)) {
                editTextBoldCursor.setText(k60Var.f35012a1.call.title);
            ...
            int w05 = org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18906fg, false);
            ...
            org.telegram.ui.ActionBar.g3 g3Var = new org.telegram.ui.ActionBar.g3(1, (Context) this.f35944a, (org.telegram.ui.ActionBar.f6) null, false);
            ...
            int i16 = org.telegram.ui.ActionBar.j6.f19000kg;
            ...
            g3Var.show();
            g3Var.setTitleColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19054ng, false));
            for (int i17 = 0; i17 < g3Var.getItemViews().size(); i17++) {
                org.telegram.ui.ActionBar.z2 z2Var = g3Var.getItemViews().get(i17);
                if (i17 == i11) {
                    w02 = org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19091pg, false);
                    z2Var.f19758f = true;
                } else {
                    w02 = org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19054ng, false);
                }
                z2Var.setTextColor(w02);
                z2Var.setIconColor(w02);
                z2Var.setBackground(org.telegram.ui.ActionBar.j6.f0(i0.a.k(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18942hg, false), 12), 2, -1));
            }
        }
    }
}
