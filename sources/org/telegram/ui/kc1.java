    ...
    public final void run() {
        ...
        switch (i11) {
            case 0:
                ...
                if (i14 == 1) {
                    if (i13 == 0) {
                        ...
                        xd1Var.f39585u0.g1();
                        xd1Var.V.setHasChanges(xd1Var.T0(xd1Var.f39568n));
                        xd1Var.m1(true);
                    }
                } else if (i14 == 2) {
                    if (i13 == 0) {
                ...
                int size = xd1Var.f39558i0.size();
                for (int i17 = 0; i17 < size; i17++) {
                    org.telegram.ui.ActionBar.l6 l6Var = (org.telegram.ui.ActionBar.l6) xd1Var.f39558i0.get(i17);
                    l6Var.d(xd1Var.getThemedColor(l6Var.f19383f), false, false);
                }
                xd1Var.f39569n0.g1();
                xd1Var.f39585u0.g1();
                ci.s6 s6Var = xd1Var.f39532a0;
                if (s6Var != null) {
                    s6Var.invalidate();
                }
                xd1Var.X = -1;
            ...
            case 2:
                ...
                xd1Var.V0();
                xd1Var.i1();
                if (xd1Var.f39558i0 != null) {
                    for (int i18 = 0; i18 < xd1Var.f39558i0.size(); i18++) {
                        ((org.telegram.ui.ActionBar.l6) xd1Var.f39558i0.get(i18)).d(xd1Var.getThemedColor(((org.telegram.ui.ActionBar.l6) xd1Var.f39558i0.get(i18)).f19383f), false, false);
                    }
                }
                if (xd1Var.M1) {
            ...
            default:
                if (xd1Var.getParentActivity() != null && xd1Var.getParentActivity() != null) {
                    ...
                    xd1Var.f39564k0.addView(i40Var, w7.x5.d(-2, -2.0f, 51, 4.0f, 0.0f, 4.0f, 0.0f));
                    if (xd1Var.f39574p1.a()) {
