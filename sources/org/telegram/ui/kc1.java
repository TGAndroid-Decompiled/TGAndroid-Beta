...
public final class kc1 implements Runnable {
    ...
    public final void run() {
        int i10;
        int i11 = this.f35113a;
        float f7 = 0.0f;
        xd1 xd1Var = this.f35114b;
        switch (i11) {
            case 0:
                xd1Var.Z = false;
                int i12 = xd1Var.W;
                ...
                if (i14 == 1) {
                    if (i13 == 0) {
                        ...
                        xd1Var.f39548u0.g1();
                        xd1Var.V.setHasChanges(xd1Var.T0(xd1Var.f39531n));
                        xd1Var.m1(true);
                    }
                } else if (i14 == 2) {
                    if (i13 == 0) {
                ...
                int size = xd1Var.f39521i0.size();
                for (int i17 = 0; i17 < size; i17++) {
                    org.telegram.ui.ActionBar.l6 l6Var = (org.telegram.ui.ActionBar.l6) xd1Var.f39521i0.get(i17);
                    l6Var.d(xd1Var.getThemedColor(l6Var.f19624f), false, false);
                }
                xd1Var.f39532n0.g1();
                xd1Var.f39548u0.g1();
                ci.s6 s6Var = xd1Var.f39495a0;
                if (s6Var != null) {
                    s6Var.invalidate();
                }
                xd1Var.X = -1;
            ...
            case 2:
                ...
                xd1Var.V0();
                xd1Var.i1();
                if (xd1Var.f39521i0 != null) {
                    for (int i18 = 0; i18 < xd1Var.f39521i0.size(); i18++) {
                        ((org.telegram.ui.ActionBar.l6) xd1Var.f39521i0.get(i18)).d(xd1Var.getThemedColor(((org.telegram.ui.ActionBar.l6) xd1Var.f39521i0.get(i18)).f19624f), false, false);
                    }
                }
                if (xd1Var.M1) {
            ...
            default:
                if (xd1Var.getParentActivity() != null && xd1Var.getParentActivity() != null) {
                    ...
                    xd1Var.f39527k0.addView(i40Var, w7.y5.d(-2, -2.0f, 51, 4.0f, 0.0f, 4.0f, 0.0f));
                    if (xd1Var.f39537p1.a()) {
