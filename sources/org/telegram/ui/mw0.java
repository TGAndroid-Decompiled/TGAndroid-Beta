...
public final class mw0 extends Dialog {
    ...
    public float f35818a0;
    public final org.telegram.ui.ActionBar.e6 f35819b;
    public boolean f35820b0;
    public final hw0 f35821c;
    public boolean f35822c0;
    public final hw0 d;
    public boolean f35823d0;
    public final hw0 e;
    public ym f35824e0;
    public final ci.i1 f35825f;
    public ValueAnimator f35826f0;
    public ValueAnimator f35827g0;
    public final TextView h;
    public final org.telegram.ui.Components.tb0 f35828n;
    public i0.b f35829r;
    public Bitmap f35830s;
    public BitmapShader v;
    public Paint f35831w;
    public Matrix f35832x;
    public float f35833y;
    ...
    public final void b(boolean z10, bw0 bw0Var) {
        float f7;
        long j3;
        ValueAnimator valueAnimator = this.f35826f0;
        if (valueAnimator != null) {
            valueAnimator.cancel();
        }
        ValueAnimator valueAnimator2 = this.f35827g0;
        if (valueAnimator2 != null) {
            valueAnimator2.cancel();
        }
        d();
        float f10 = this.f35833y;
        float f11 = 0.0f;
        if (z10) {
            f7 = 1.0f;
        } else {
        ...
        this.f35826f0 = ofFloat;
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) {
            public final mw0 f32871b;
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator3) {
                switch (r2) {
                    case 0:
                        ...
                        mw0 mw0Var = this.f32871b;
                        mw0Var.f35833y = floatValue;
                        mw0Var.f35821c.invalidate();
                        mw0Var.d.invalidate();
                        kw0 kw0Var = mw0Var.J;
                        if (kw0Var != null) {
                            kw0Var.invalidate();
        ...
        this.f35826f0.addListener(new androidx.fragment.app.g(this, z10, bw0Var, 9));
        if (!z10) {
            j3 = 330;
        } else {
            j3 = 520;
        }
        ValueAnimator valueAnimator3 = this.f35826f0;
        org.telegram.ui.Components.qr qrVar = org.telegram.ui.Components.qr.h;
        valueAnimator3.setInterpolator(qrVar);
        this.f35826f0.setDuration(j3);
        this.f35826f0.start();
        float f12 = this.E;
        if (z10) {
            f11 = 1.0f;
        ...
        this.f35827g0.addListener(new h70(4, this, z10));
        this.f35827g0.setDuration(((float) j3) * 1.5f);
        this.f35827g0.setInterpolator(qrVar);
        this.f35827g0.start();
    }
    ...
    public final void c(boolean z10) {
        ...
        if (z10 && (fk0Var = this.Q) != null && fk0Var.getReactionsWindow() != null && !this.Q.getReactionsWindow().f48996q) {
            this.Q.e();
        } else if (this.f35822c0) {
        } else {
            this.f35822c0 = true;
            this.Y = false;
            ci.i1 i1Var = this.f35825f;
            i1Var.l();
        ...
        if (!this.Y) {
            ...
            if (hw0Var.getWidth() > 0) {
                ...
                if (t1Var != null) {
                    ...
                    int i11 = iArr[0];
                    i0.b bVar = this.f35829r;
                    this.W = i11 - bVar.f10588a;
                    float f7 = iArr[1] - bVar.f10589b;
                    this.X = f7;
                    if (!this.f35820b0) {
                        this.f35820b0 = true;
                        this.Z = f7;
                        if (this.T != null) {
                            ...
                            i0.b bVar2 = this.f35829r;
                            if (height > ((height2 - bVar2.f10589b) - bVar2.d) - AndroidUtilities.dp(66.0f)) {
                                int height3 = hw0Var.getHeight();
                                i0.b bVar3 = this.f35829r;
                                this.Z = ((((height3 - bVar3.f10589b) - bVar3.d) - AndroidUtilities.dp(66.0f)) - this.L.getHeight()) - this.T.getHeight();
                            }
                        }
                        ...
                        i0.b bVar4 = this.f35829r;
                        int dp = ((height4 - bVar4.f10589b) - bVar4.d) - AndroidUtilities.dp(78.0f);
                        TextView textView = this.h;
                        if (f10 + f11 > dp - textView.getHeight()) {
                            int height5 = hw0Var.getHeight();
                            i0.b bVar5 = this.f35829r;
                            this.f35818a0 = ((((height5 - bVar5.f10589b) - bVar5.d) - AndroidUtilities.dp(78.0f)) - textView.getHeight()) - i10;
                        }
                        if (this.R != null) {
                            float height6 = this.f35818a0 + f11 + viewGroup.getHeight();
                            int height7 = hw0Var.getHeight();
                            i0.b bVar6 = this.f35829r;
                            if (height6 > (((height7 - bVar6.f10589b) - bVar6.d) - AndroidUtilities.dp(78.0f)) - textView.getHeight()) {
                                int height8 = hw0Var.getHeight();
                                i0.b bVar7 = this.f35829r;
                                this.f35818a0 = (((((height8 - bVar7.f10589b) - bVar7.d) - AndroidUtilities.dp(78.0f)) - textView.getHeight()) - i10) - this.R.getHeight();
                            }
                        }
                    }
                    e();
    ...
    public final void e() {
        ...
        if (this.Y) {
            ...
            if (viewGroup instanceof ActionBarPopupWindow$ActionBarPopupWindowLayout) {
                ...
                int height2 = hw0Var.getHeight();
                i0.b bVar = this.f35829r;
                if (height > ((height2 - bVar.f10589b) - bVar.d) - AndroidUtilities.dp(66.0f)) {
                    int height3 = hw0Var.getHeight();
                    i0.b bVar2 = this.f35829r;
                    this.Z = ((((height3 - bVar2.f10589b) - bVar2.d) - AndroidUtilities.dp(66.0f)) - this.L.getHeight()) - actionBarPopupWindow$ActionBarPopupWindowLayout.getVisibleHeight();
                }
            }
        }
        lw0 lw0Var = this.K;
        ...
        if (viewGroup2 != null) {
            ...
            this.T.setAlpha(this.f35833y);
            float lerp3 = AndroidUtilities.lerp(0.75f, 1.0f, this.f35833y);
        ...
        if (this.R != null) {
            ...
            this.R.setAlpha(this.f35833y);
            float lerp4 = AndroidUtilities.lerp(0.75f, 1.0f, this.f35833y);
            this.R.setScaleX(lerp4);
            this.R.setScaleY(lerp4);
        }
        if (this.f35823d0) {
            this.K.setAlpha(this.f35833y);
            this.J.setAlpha(this.f35833y);
        }
        if (this.Q != null) {
            ...
            this.Q.setAlpha(this.f35833y);
            View windowView = this.Q.getWindowView();
            if (windowView != null) {
                windowView.setTranslationX(max);
                windowView.setAlpha(this.f35833y);
            }
        }
        TextView textView = this.h;
        textView.setTranslationX(lerp);
        textView.setAlpha(this.f35833y);
        org.telegram.ui.Components.tb0 tb0Var = this.f35828n;
        tb0Var.setSelectedTab(positionAnimated);
        tb0Var.setAlpha(this.f35833y);
    }
