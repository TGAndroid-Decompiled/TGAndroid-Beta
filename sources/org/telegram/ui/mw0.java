...
public final class mw0 extends org.telegram.ui.ActionBar.n2 {
    ...
    public org.telegram.ui.Cells.a8 f35397b;
    public org.telegram.ui.Components.w80 f35398c;
    public org.telegram.ui.Components.d61 d;
    public org.telegram.ui.Components.qr e;
    public org.telegram.ui.ActionBar.v0 f35399f;
    public final boolean h;
    public final long f35400n;
    public boolean f35401r;
    public long f35402s;
    public jo v;
    ...
    public static void U(mw0 mw0Var, TLRPC.TL_error tL_error, TLObject tLObject, TL_stars.updatePaidMessagesPrice updatepaidmessagesprice) {
        long j3;
        if (tL_error != null) {
            mw0Var.e.a(0.0f);
    ...
    public final void V(boolean z10) {
        ...
        float f11;
        float f12;
        if (this.f35399f == null || this.f35403w == (X = X())) {
            return;
        }
        this.f35403w = X;
        this.f35399f.setEnabled(X);
        float f13 = 0.0f;
        if (z10) {
            ViewPropertyAnimator animate = this.f35399f.animate();
            if (X) {
                f11 = 1.0f;
            } else {
                f11 = 0.0f;
        ...
        org.telegram.ui.ActionBar.v0 v0Var = this.f35399f;
        if (X) {
            f7 = 1.0f;
        } else {
            f7 = 0.0f;
        ...
        v0Var.setAlpha(f7);
        org.telegram.ui.ActionBar.v0 v0Var2 = this.f35399f;
        if (X) {
            f10 = 1.0f;
        } else {
            f10 = 0.0f;
        ...
        org.telegram.ui.ActionBar.v0 v0Var3 = this.f35399f;
        if (X) {
            f13 = 1.0f;
        }
    ...
    public final String W() {
        ...
        return LocaleController.formatString(R.string.PostSuggestionsPriceInfo2, ei.l.G0(i10), String.valueOf(((int) (((((float) this.f35402s) * (i10 / 1000.0f)) / 1000.0d) * getMessagesController().starsUsdWithdrawRate1000)) / 100.0d));
    }

    public final boolean X() {
        if (this.f35402s == this.f35400n && this.f35401r == this.h) {
            return false;
        }
        return true;
    }
        ...
        if (this.e.f27437c <= 0.0f) {
            ...
            if (chat != null) {
                ...
                if (chat2 != null) {
                    if (this.f35401r) {
                        chat2.flags2 |= 16384;
                        chat2.send_paid_messages_stars = this.f35402s;
                    } else {
                        chat2.flags2 &= -16385;
    ...
    public final View createView(Context context) {
        ...
        this.f35399f = this.actionBar.n().i(AndroidUtilities.dp(56.0f), LocaleController.getString(R.string.Done), this.e);
        V(false);
        ...
        this.f35398c.setBackgroundColor(getThemedColor(i11));
        this.f35398c.b(true);
        this.f35398c.d(0, null, false);
    ...
    public final boolean onBackPressed(boolean z10) {
        if (X()) {
            if (z10) {
                ...
                alertDialog$Builder.f18409a.T = LocaleController.getString(R.string.MessageSuggestionsUnsavedChanges);
