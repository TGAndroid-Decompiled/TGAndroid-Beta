...
public final class mw0 extends Dialog {
    ...
    public float f35849a0;
    public final org.telegram.ui.ActionBar.f6 f35850b;
    public boolean f35851b0;
    public final hw0 f35852c;
    public boolean f35853c0;
    public final hw0 d;
    public boolean f35854d0;
    public final hw0 e;
    public wm f35855e0;
    public final ci.i1 f35856f;
    public ValueAnimator f35857f0;
    public ValueAnimator f35858g0;
    public final TextView h;
    public final org.telegram.ui.Components.ec0 f35859n;
    public i0.b f35860r;
    public Bitmap f35861s;
    public BitmapShader v;
    public Paint f35862w;
    public Matrix f35863x;
    ...
    public final void b(boolean z10, bw0 bw0Var) {
        float f7;
        long j3;
        ValueAnimator valueAnimator = this.f35857f0;
        if (valueAnimator != null) {
            valueAnimator.cancel();
        }
        ValueAnimator valueAnimator2 = this.f35858g0;
        if (valueAnimator2 != null) {
            valueAnimator2.cancel();
        }
        d();
        float f10 = this.f35864y;
        float f11 = 0.0f;
        if (z10) {
            f7 = 1.0f;
        } else {
        ...
        this.f35857f0 = ofFloat;
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) {
            public final mw0 f32902b;
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator3) {
                switch (r2) {
                    case 0:
                        ...
                        mw0 mw0Var = this.f32902b;
                        mw0Var.f35864y = floatValue;
                        mw0Var.f35852c.invalidate();
                        mw0Var.d.invalidate();
                        kw0 kw0Var = mw0Var.J;
                        if (kw0Var != null) {
                            kw0Var.invalidate();
        ...
        this.f35857f0.addListener(new androidx.fragment.app.g(this, z10, bw0Var, 9));
        if (!z10) {
            j3 = 330;
        } else {
            j3 = 520;
        }
        ValueAnimator valueAnimator3 = this.f35857f0;
        org.telegram.ui.Components.qr qrVar = org.telegram.ui.Components.qr.h;
        valueAnimator3.setInterpolator(qrVar);
        this.f35857f0.setDuration(j3);
        this.f35857f0.start();
        float f12 = this.E;
        if (z10) {
            f11 = 1.0f;
        ...
        this.f35858g0.addListener(new h70(4, this, z10));
        this.f35858g0.setDuration(((float) j3) * 1.5f);
        this.f35858g0.setInterpolator(qrVar);
        this.f35858g0.start();
    }
    ...
    public final void c(boolean z10) {
        ...
        if (z10 && (sk0Var = this.Q) != null && sk0Var.getReactionsWindow() != null && !this.Q.getReactionsWindow().f49316q) {
            this.Q.e();
        } else if (this.f35853c0) {
        } else {
            this.f35853c0 = true;
            this.Y = false;
            ci.i1 i1Var = this.f35856f;
            i1Var.l();
                ...
                if (u1Var != null) {
                    ...
                    if (!this.f35851b0) {
                        ...
                        if (f10 + f11 > dp - textView.getHeight()) {
                            ...
                            i0.b bVar5 = this.f35860r;
                            this.f35849a0 = ((((height5 - bVar5.f10593b) - bVar5.d) - AndroidUtilities.dp(78.0f)) - textView.getHeight()) - i10;
                        }
                        if (this.R != null) {
                            float height6 = this.f35849a0 + f11 + viewGroup.getHeight();
                            int height7 = hw0Var.getHeight();
                            i0.b bVar6 = this.f35860r;
                            if (height6 > (((height7 - bVar6.f10593b) - bVar6.d) - AndroidUtilities.dp(78.0f)) - textView.getHeight()) {
                                int height8 = hw0Var.getHeight();
                                i0.b bVar7 = this.f35860r;
                                this.f35849a0 = (((((height8 - bVar7.f10593b) - bVar7.d) - AndroidUtilities.dp(78.0f)) - textView.getHeight()) - i10) - this.R.getHeight();
                            }
                        }
                    }
                    e();
    ...
    public final void e() {
        ...
        if (viewGroup2 != null) {
            ...
            this.T.setAlpha(this.f35864y);
            float lerp3 = AndroidUtilities.lerp(0.75f, 1.0f, this.f35864y);
        ...
        if (this.R != null) {
            ...
            this.R.setAlpha(this.f35864y);
            float lerp4 = AndroidUtilities.lerp(0.75f, 1.0f, this.f35864y);
            this.R.setScaleX(lerp4);
            this.R.setScaleY(lerp4);
        }
        if (this.f35854d0) {
            this.K.setAlpha(this.f35864y);
            this.J.setAlpha(this.f35864y);
        }
        if (this.Q != null) {
            ...
            this.Q.setAlpha(this.f35864y);
            View windowView = this.Q.getWindowView();
            if (windowView != null) {
                windowView.setTranslationX(max);
                windowView.setAlpha(this.f35864y);
            }
        }
        TextView textView = this.h;
        textView.setTranslationX(lerp);
        textView.setAlpha(this.f35864y);
        org.telegram.ui.Components.ec0 ec0Var = this.f35859n;
        ec0Var.setSelectedTab(positionAnimated);
        ec0Var.setAlpha(this.f35864y);
    }
