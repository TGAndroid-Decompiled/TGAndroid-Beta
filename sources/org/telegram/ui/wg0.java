...
public final class wg0 {
    ...
    public final void a(mg0 mg0Var) {
        ...
        if (i11 >= 23 && AndroidUtilities.isSimAvailable()) {
            ...
            if (yg0Var.v) {
                yg0Var.f39904r.clear();
                if (!z10) {
                    yg0Var.f39904r.add("android.permission.READ_PHONE_STATE");
                }
                if (!z11) {
                    yg0Var.f39904r.add("android.permission.CALL_PHONE");
                }
                if (!z12) {
                    yg0Var.f39904r.add("android.permission.READ_CALL_LOG");
                }
                if (!z13 && i11 >= 26) {
                    yg0Var.f39904r.add("android.permission.READ_PHONE_NUMBERS");
                }
                if (!yg0Var.f39904r.isEmpty()) {
                    ...
                    if (!globalMainSettings.getBoolean("firstlogin", true) && !yg0Var.getParentActivity().shouldShowRequestPermissionRationale("android.permission.READ_PHONE_STATE") && !yg0Var.getParentActivity().shouldShowRequestPermissionRationale("android.permission.READ_CALL_LOG")) {
                        try {
                            yg0Var.getParentActivity().requestPermissions((String[]) yg0Var.f39904r.toArray(new String[0]), 6);
                            return;
                        } catch (Exception e) {
                            FileLog.e(e);
                            return;
                    ...
                    yg0Var.h = yg0Var.showDialog(alertDialog$Builder.f18446a);
                    xg0Var.L = true;
                    return;
                }
            }
