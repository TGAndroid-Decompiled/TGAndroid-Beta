...
public final class o extends org.telegram.ui.Components.kl0 {
    ...
    public final int j(int i10) {
        p pVar = this.d;
        if (i10 >= pVar.f36381x && i10 < pVar.f36382y) {
            return 0;
        }
        if (i10 == pVar.E) {
            return 1;
        }
        if (i10 != pVar.F && i10 != pVar.f36380w) {
            return 0;
        }
        return 2;
    }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        p pVar = this.d;
        a0.i iVar = pVar.f36373a;
        ArrayList arrayList = pVar.h;
        if (j(i10) == 0) {
            int i12 = i10 - pVar.f36381x;
            ...
            boolean isStickerPackInstalled = MediaDataController.getInstance(p.V(pVar)).isStickerPackInstalled(stickerSetCovered.set.f18139id);
            wVar.a(isStickerPackInstalled, false, false);
            if (isStickerPackInstalled) {
                iVar.l(stickerSetCovered.set.f18139id);
                if (xh0Var != null) {
                    xh0Var.a(false, false);
                }
            } else {
                if (iVar.h(stickerSetCovered.set.f18139id) < 0) {
                    z11 = false;
                }
                if (xh0Var != null) {
                    xh0Var.a(z11, false);
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 != 0) {
            ...
            wVar.setBackgroundColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18836d6, false));
            view = wVar;
        }
