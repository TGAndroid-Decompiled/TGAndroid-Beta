...
public final class o extends org.telegram.ui.Components.kl0 {
    ...
    public final int j(int i10) {
        p pVar = this.d;
        if (i10 >= pVar.f39375x && i10 < pVar.f39376y) {
            return 0;
        }
        if (i10 == pVar.E) {
            return 1;
        }
        if (i10 != pVar.F && i10 != pVar.f39374w) {
            return 0;
        }
        return 2;
    }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 != 0) {
            ...
            wVar.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20663d6, false));
            view = wVar;
        }
