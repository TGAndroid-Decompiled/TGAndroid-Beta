...
public final class o implements org.telegram.ui.Cells.v, org.telegram.ui.Components.ml0, org.telegram.ui.ActionBar.z1, ky, v4, org.telegram.ui.Components.d5, MessagesController.ErrorDelegate, LanguageDetector.ExceptionCallback, org.telegram.ui.Components.ak0, MessagesStorage.BooleanCallback, ResultCallback, MessagesStorage.LongCallback, mg1 {
    public final int f36020a;
    public final Object f36021b;
    public final Object f36022c;
    ...
    public void J(int i10, int i11, boolean z10) {
        switch (this.f36020a) {
            case 7:
                wn wnVar = (wn) this.f36021b;
                wnVar.l8(null, null);
                SendMessagesHelper.prepareSendingPhoto(wnVar.getAccountInstance(), null, (Uri) this.f36022c, wnVar.T5, wnVar.f39573n5, wnVar.X3, wnVar.f39547l5, null, null, null, null, 0, wnVar.p5, z10, i10, wnVar.R3, wnVar.C8());
                return;
            case 8:
            default:
                in inVar = (in) this.f36021b;
                MessageObject messageObject = (MessageObject) this.f36022c;
                if (z10) {
                    inVar.f34556a.getMessagesController().approveSuggestedMessage(DialogObject.getPeerDialogId(messageObject.messageOwner.peer_id), messageObject.messageOwner.f18356id, i10);
                    return;
                } else {
                    inVar.getClass();
                    return;
            ...
            case 9:
                wn wnVar2 = (wn) this.f36021b;
                wnVar2.getSendMessagesHelper().sendMessage(SendMessagesHelper.SendMessageParams.of((String) this.f36022c, wnVar2.T5, wnVar2.f39573n5, wnVar2.X3, null, false, null, null, null, z10, i10, 0, null, false));
    ...
    public void a(long j3, TLRPC.MessagePeerReaction messagePeerReaction) {
        MessageObject messageObject = (MessageObject) this.f36022c;
        wn wnVar = ((ei) this.f36021b).f33423p;
    ...
    public void b(d5 d5Var) {
        lb lbVar = (lb) this.f36021b;
        TLRPC.User user = (TLRPC.User) this.f36022c;
        int ordinal = d5Var.ordinal();
        if (ordinal != 0) {
            if (ordinal == 3) {
                qb qbVar = lbVar.f35288a;
                if (user != null) {
                    Bundle bundle = new Bundle();
                    bundle.putLong("user_id", user.f18482id);
                    org.telegram.ui.ActionBar.m2 m2Var = qbVar.f36847n;
    ...
    public void c(float f7, float f10, int i10, View view) {
        float f11;
        i4 i4Var = (i4) this.f36021b;
        m3 m3Var = (m3) this.f36022c;
        if (i4Var.K == null || i10 - 1 >= 0) {
            ...
            if ((view instanceof p3) && adapter.E != null) {
                p3 p3Var = (p3) view;
                if (i4Var.G0 == 0) {
                    if ((!p3Var.f36390c || f7 >= view.getMeasuredWidth() / 2) && !p3Var.d) {
                ...
                if (z10 instanceof TL_iv.pageBlockChannel) {
                    ...
                    c4 c4Var = (c4) z10;
                    i4Var.Q(c4Var.f32554a.articles.get(c4Var.f32555b).url, null, null);
                    ...
                    if (y3 instanceof m1) {
                        ...
                        if (adapter.e.indexOf(pageBlock) >= 0) {
                            ...
                            m1 m1Var = (m1) y3;
                            AnimatedArrowDrawable animatedArrowDrawable = m1Var.f35442f;
    ...
    public void e(TLRPC.TL_inputCheckPasswordSRP tL_inputCheckPasswordSRP) {
        ((kq) this.f36021b).p0(tL_inputCheckPasswordSRP, (TwoStepVerificationActivity) this.f36022c);
    }
    ...
    public void f(org.telegram.ui.ActionBar.a2 a2Var, int i10) {
        ...
        switch (this.f36020a) {
            case 2:
                p4 p4Var = (p4) this.f36021b;
                p4Var.getClass();
                a2Var.dismiss();
                p4Var.W((View) this.f36022c, true);
                return;
            case 4:
                nf.f.o(((ub) this.f36021b).getParentActivity(), (String) this.f36022c, true);
                return;
            case 6:
                ld.V((ld) this.f36021b, (TLRPC.Chat) this.f36022c);
                return;
            case 16:
                fp fpVar = (fp) this.f36021b;
                TLRPC.TL_channels_updateUsername tL_channels_updateUsername = new TLRPC.TL_channels_updateUsername();
                tL_channels_updateUsername.channel = MessagesController.getInputChannel((TLRPC.Chat) this.f36022c);
                tL_channels_updateUsername.username = "";
                fpVar.getConnectionsManager().sendRequest(tL_channels_updateUsername, new so(fpVar, 0), 64);
                return;
            case 20:
                org.telegram.ui.Components.e0.P((org.telegram.ui.Components.e0) this.f36021b, (TL_aicompose.TL_aiComposeTone) this.f36022c, a2Var);
                return;
            case 21:
                ((AtomicBoolean) this.f36021b).set(true);
                ((q0.a) this.f36022c).accept(Boolean.FALSE);
                return;
            case 22:
                MessagesStorage.IntCallback intCallback = (MessagesStorage.IntCallback) this.f36022c;
                int i12 = ((int[]) this.f36021b)[0];
                if (i12 == 0) {
                    i11 = 900;
                } else if (i12 == 1) {
                    i11 = 3600;
                ...
                return;
            case 23:
                TLRPC.TL_langPackLanguage tL_langPackLanguage = (TLRPC.TL_langPackLanguage) this.f36021b;
                LaunchActivity launchActivity = (LaunchActivity) this.f36022c;
            ...
            case 24:
                a2Var.dismiss();
                ((oc) this.f36021b).run(((EditText) this.f36022c).getText().toString());
                return;
            case 25:
                org.telegram.ui.Components.f4 f4Var = (org.telegram.ui.Components.f4) this.f36021b;
                Utilities.Callback callback = (Utilities.Callback) this.f36022c;
                ...
                return;
            case 26:
                String str2 = (String) this.f36021b;
                org.telegram.ui.ActionBar.m2 m2Var = (org.telegram.ui.ActionBar.m2) this.f36022c;
                try {
            ...
            case 27:
                TLRPC.EncryptedChat encryptedChat = (TLRPC.EncryptedChat) this.f36021b;
                int i13 = encryptedChat.ttl;
                int value = ((org.telegram.ui.Components.fd0) this.f36022c).getValue();
                if (value >= 0 && value < 16) {
                ...
                return;
            case 28:
                ((da) this.f36021b).run(((boolean[]) this.f36022c)[0]);
                return;
            default:
                Runnable runnable = (Runnable) this.f36022c;
                SharedPreferences.Editor edit = MessagesController.getNotificationsSettings(UserConfig.selectedAccount).edit();
                edit.remove("color_" + ((String) this.f36021b));
                edit.commit();
                if (runnable != null) {
                    runnable.run();
                    return;
    ...
    public void onComplete(Object obj) {
        un unVar = (un) this.f36021b;
        org.telegram.ui.Components.nc0 nc0Var = (org.telegram.ui.Components.nc0) this.f36022c;
        Pair pair = (Pair) obj;
        unVar.getClass();
        if (pair != null) {
            long longValue = ((Long) pair.first).longValue();
            Bitmap bitmap = (Bitmap) pair.second;
            org.telegram.ui.ActionBar.b4 b4Var = unVar.f38505f;
            if (b4Var != null && longValue == b4Var.i(unVar.G ? 1 : 0) && bitmap != null) {
                nc0Var.f26775x = bitmap;
                nc0Var.i();
            }
        }
    }
    ...
    public boolean run(TLRPC.TL_error tL_error) {
        wn.e0((wn) this.f36021b, (Context) this.f36022c, tL_error);
        return false;
    }
    ...
    public boolean u(qy qyVar, ArrayList arrayList, CharSequence charSequence, boolean z10, boolean z11, int i10, int i11, wf1 wf1Var) {
        a6 a6Var = (a6) this.f36021b;
        ArrayList arrayList2 = a6Var.f31991c;
        ((qy) this.f36022c).finishFragment();
        ...
        if (keepMediaException != null) {
            ...
            while (true) {
                if (i16 < arrayList2.size()) {
                    if (((z5) arrayList2.get(i16)).f40336c != null && ((z5) arrayList2.get(i16)).f40336c.dialogId == keepMediaException.dialogId) {
                        i12 = i16;
                        break;
                    }
                    i16++;
    ...
    public void run(long j3) {
        switch (this.f36020a) {
            case 15:
                ro roVar = (ro) this.f36021b;
                roVar.getClass();
                ((org.telegram.ui.ActionBar.a2) this.f36022c).dismiss();
                roVar.N0 = false;
                if (j3 == 0) {
                    return;
                }
                ...
                roVar.getMessagesController().toggleChannelForum(roVar.f37417w0, roVar.F0, roVar.H0);
                TLRPC.Chat chat2 = roVar.f37419x0;
            ...
            case 16:
            default:
                np npVar = (np) this.f36021b;
                Runnable runnable = (Runnable) this.f36022c;
                if (j3 != 0) {
                    rp rpVar = npVar.f35933x.d;
                    if (rpVar.f37431s) {
                        rpVar.v.set(0, rpVar.getMessagesController().getChat(Long.valueOf(j3)));
                    } else {
                        rpVar.E = j3;
                        rpVar.f37428f = rpVar.getMessagesController().getChat(Long.valueOf(j3));
                    }
                    runnable.run();
                    return;
                }
    ...
    public void run(boolean z10) {
        long j3 = ((TLRPC.User) this.f36022c).f18482id;
        wn wnVar = ((kj) this.f36021b).f35076b;
        long j10 = wnVar.f39450d4;
        if (j3 != j10) {
            return;
        }
        wnVar.qa(j10, false);
    ...
    public void run(Exception exc) {
        AtomicReference atomicReference = (AtomicReference) this.f36022c;
        FileLog.e("mlkit: failed to detect language in message");
        ((AtomicBoolean) this.f36021b).set(false);
