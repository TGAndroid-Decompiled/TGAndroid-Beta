...
public final class qw0 implements org.telegram.ui.Components.mg {
    public final PopupNotificationActivity f36952a;

    public qw0(PopupNotificationActivity popupNotificationActivity) {
        this.f36952a = popupNotificationActivity;
    }
    ...
    public final void E1() {
        PopupNotificationActivity popupNotificationActivity = this.f36952a;
    ...
    public final void H(CharSequence charSequence, boolean z10, int i10, int i11, long j3) {
        ...
        if (i12 >= 0 && i12 < popupNotificationActivity.f31144a0.size()) {
            popupNotificationActivity.f31144a0.remove(popupNotificationActivity.S);
        }
