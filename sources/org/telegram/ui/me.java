...
public final class me implements Runnable {
    ...
    public final void run() {
        ...
        int i11;
        int i12 = this.f38703a;
        TLRPC.ChatTheme chatTheme = null;
        int i13 = 0;
        co coVar = this.f38704b;
        switch (i12) {
            case 0:
                coVar.L5 = null;
                if (coVar.getParentActivity() != null) {
                    ...
                    boolean isChannel = ChatObject.isChannel(coVar.f35264e);
                    org.telegram.ui.ActionBar.b2 b2Var = alertDialog$Builder.f20225a;
                    if (isChannel && !coVar.f35264e.megagroup) {
            ...
            case 5:
                coVar.o9();
                AndroidUtilities.forEachViews((RecyclerView) coVar.f35500x0, (e2.h) new hg(coVar, 1));
                coVar.u7();
                dk dkVar = coVar.X2;
                if (dkVar != null) {
            ...
            case 21:
                ...
                if (glVar != null) {
                    ...
                    animatorSet.playTogether(ofFloat, ofFloat2, ObjectAnimator.ofFloat(cameraContainer, property, 0.0f), ObjectAnimator.ofFloat(coVar.f35228b3.getButtonsLayout(), property, 0.0f), ObjectAnimator.ofInt(coVar.f35228b3.getPaint(), org.telegram.ui.Components.t6.f30563b, 0), ObjectAnimator.ofFloat(coVar.f35228b3.getMuteImageView(), property, 0.0f));
                ...
                return;
            case 22:
                AndroidUtilities.forEachViews((RecyclerView) coVar.f35500x0, (e2.h) new bi.f(22));
                om omVar = coVar.A0;
                if (omVar != null) {
                    omVar.O(true);
                    return;
                ...
                return;
            case 23:
                co coVar2 = this.f38704b;
                int i14 = coVar2.f35419qb;
                if (i14 != 0) {
                    coVar2.F(i14, coVar2.f35433rb, coVar2.f35459tb, coVar2.f35484vb, coVar2.f35447sb, coVar2.f35472ub);
                    coVar2.f35419qb = 0;
                    return;
                }
                return;
            case 24:
                if (!coVar.f35352l3 && coVar.f35500x0 != null && coVar.getParentActivity() != null && coVar.fragmentView != null) {
                    org.telegram.ui.Components.pp ppVar = coVar.f35476v2;
                    if (ppVar == null || ppVar.getTag() == null) {
                        if (coVar.f35476v2 == null) {
                            um umVar = coVar.X0;
                            int indexOfChild = umVar.indexOfChild(coVar.S);
                            if (indexOfChild != -1) {
                                i10 = 1;
                                org.telegram.ui.Components.pp ppVar2 = new org.telegram.ui.Components.pp(coVar.getParentActivity(), coVar.f35274ea);
                                coVar.f35476v2 = ppVar2;
                                umVar.addView(ppVar2, indexOfChild + 1, w7.x5.d(-2, -2.0f, 51, 10.0f, 0.0f, 10.0f, 0.0f));
                                coVar.f35476v2.setAlpha(0.0f);
                                coVar.f35476v2.setVisibility(4);
                            } else {
                                return;
                            }
                        } else {
                        ...
                        int childCount2 = coVar.f35500x0.getChildCount();
                        for (int i15 = 0; i15 < childCount2; i15++) {
                            View childAt2 = coVar.f35500x0.getChildAt(i15);
                            if ((childAt2 instanceof org.telegram.ui.Cells.t1) && (messageObject = (t1Var = (org.telegram.ui.Cells.t1) childAt2).getMessageObject()) != null && messageObject.isOutOwner() && messageObject.isSent()) {
                                org.telegram.ui.Components.pp ppVar3 = coVar.f35476v2;
                                ImageView imageView = ppVar3.f29481c;
                                org.telegram.ui.Components.pg pgVar = ppVar3.f29482e;
                                if (pgVar != null) {
                                ...
                                if (i17 > AndroidUtilities.dp(10.0f) + ppVar3.getMeasuredHeight()) {
                                    ...
                                    ppVar3.d.start();
                                    while (i13 < 2) {
                                        ViewPropertyAnimator interpolator = ppVar3.f29479a[i13].animate().scaleX(1.04f).scaleY(1.04f).setInterpolator(org.telegram.ui.Components.pr.f29495i);
                                        if (i13 == 0) {
                                            i11 = 132;
                                        } else {
                                            i11 = 500;
                ...
                return;
            case 25:
                AndroidUtilities.forEachViews((RecyclerView) coVar.f35500x0, (e2.h) new bi.f(21));
                om omVar2 = coVar.A0;
                if (omVar2 != null) {
                    omVar2.O(false);
                    return;
            ...
            case 27:
                mk mkVar2 = coVar.Y;
                if (mkVar2 != null && coVar.f35395ob != 5) {
                    mkVar2.H0();
                    return;
                }
                return;
            case 28:
                org.telegram.ui.Components.po poVar = ((org.telegram.ui.Components.po[]) coVar.f35212a0.f730b)[0];
                org.telegram.ui.ActionBar.j5 j5Var = poVar.d;
                org.telegram.ui.ActionBar.j5 j5Var2 = poVar.f29474e;
                coVar.F1 = !coVar.F1;
