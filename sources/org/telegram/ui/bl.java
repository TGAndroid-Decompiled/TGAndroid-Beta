...
public final class bl extends org.telegram.ui.Components.qk0 {
    public final int[] l1;
    public ValueAnimator f32397m1;
    public boolean f32398n1;
    public final zn f32399o1;
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        kVar = ((org.telegram.ui.ActionBar.n2) this.f32399o1).actionBar;
        ...
        if (k10 != null) {
            ...
            if (z11) {
                s(f7 - x10, !this.f32398n1);
            } else {
                s(f7 - width, !this.f32398n1);
            }
            this.f32398n1 = false;
        }
    }
    ...
    public final void s(float f7, boolean z10) {
        ValueAnimator valueAnimator = this.f32397m1;
        ...
        this.f32397m1 = ofFloat;
        ofFloat.addUpdateListener(new b3(this, 5));
        this.f32397m1.setInterpolator(org.telegram.ui.Components.qr.h);
        this.f32397m1.setDuration(420L);
        this.f32397m1.start();
    }
}
