...
public final class c20 extends s4.v {
    ...
    public final boolean n(RecyclerView recyclerView, s4.c1 c1Var, s4.c1 c1Var2) {
        ...
        z10 z10Var = this.d.f31085b;
        int b10 = c1Var.b();
        int b11 = c1Var2.b();
        FiltersSetupActivity filtersSetupActivity = z10Var.e;
        int i10 = filtersSetupActivity.f31089r;
        ArrayList arrayList = filtersSetupActivity.f31088n;
        if (b10 >= i10 && b11 >= i10) {
            ...
            if (x10Var != null && x10Var2 != null && (dialogFilter = x10Var.d) != null && (dialogFilter2 = x10Var2.d) != null) {
                ...
                try {
                    arrayList2.set(b10 - filtersSetupActivity.f31089r, x10Var2.d);
                    arrayList2.set(b11 - filtersSetupActivity.f31089r, x10Var.d);
