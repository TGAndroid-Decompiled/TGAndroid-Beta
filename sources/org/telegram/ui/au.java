...
public final class au extends org.telegram.ui.Components.sa {
    ...
    public boolean Z;
    public org.telegram.ui.Components.w51 f32701a0;
    ...
    public au(Activity activity, HashSet hashSet) {
        ...
        imageView.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view) {
                switch (r2) {
                    case 0:
                        this.f40860b.dismiss();
                        return;
                    case 1:
                        this.f40860b.S(false);
                        return;
                    default:
                        this.f40860b.S(true);
                        return;
        ...
        org.telegram.ui.Components.e90 a2 = k7.f6.a(activity, 20.0f, i10, true, this.resourcesProvider);
        a2.setText(LocaleController.getString(R.string.GroupCallCreateTitle));
        a2.setGravity(17);
        h.addView(a2, k7.b6.t(-1, -2, 1, 2, 0, 2, 4));
        org.telegram.ui.Components.e90 a10 = k7.f6.a(activity, 14.0f, i10, false, this.resourcesProvider);
        ...
        org.telegram.ui.Components.w51 w51Var = this.f32701a0;
        if (w51Var != null) {
            w51Var.N(false);
        }
        f2.l lVar = new f2.l();
    ...
    public static void Q(au auVar, TLObject tLObject, ph.d dVar, boolean z4, HashSet hashSet, TLRPC.TL_error tL_error) {
        if (tLObject instanceof TLRPC.Updates) {
            ...
            if (groupCall != null && LaunchActivity.D1 != null) {
                ...
                auVar.dismiss();
                org.telegram.ui.Components.voip.f2.h(LaunchActivity.D1, auVar.currentAccount, tL_inputGroupCall, z4, groupCall, hashSet);
                return;
            }
            auVar.Z = false;
            ...
            auVar.dismiss();
            org.telegram.ui.Components.voip.f2.h(LaunchActivity.D1, auVar.currentAccount, tL_inputGroupCall2, z4, groupcall.call, hashSet);
