...
public final class gn0 extends org.telegram.ui.ActionBar.m2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public EditTextBoldCursor[] f33969a0;
    public boolean f33970a1;
    public final int f33971b;
    public ScrollView f33972b0;
    public long f33973b1;
    public long f33974c;
    public LinearLayout f33975c0;
    public byte[] f33976c1;
    public final String d;
    public LinearLayout f33977d0;
    public String f33978d1;
    public final String e;
    public LinearLayout f33979e0;
    public byte[] f33980e1;
    public boolean f33981f;
    public LinearLayout f33982f0;
    public boolean f33983f1;
    public LinearLayout f33984g0;
    public boolean f33985g1;
    public final String h;
    public LinearLayout f33986h0;
    public gn0 f33987h1;
    public LinearLayout f33988i0;
    public final ArrayList f33989i1;
    public org.telegram.ui.Cells.m4 f33990j0;
    public SecureDocument f33991j1;
    public final ArrayList f33992k0;
    public final ArrayList f33993k1;
    public org.telegram.ui.Cells.b7 f33994l0;
    public SecureDocument l1;
    public org.telegram.ui.Cells.b7 m0;
    public SecureDocument f33995m1;
    public final String f33996n;
    public org.telegram.ui.Cells.e9 f33997n0;
    public final HashMap f33998n1;
    public org.telegram.ui.Cells.e9 f33999o0;
    public final HashMap f34000o1;
    public org.telegram.ui.Cells.e9 f34001p0;
    public final HashMap f34002p1;
    public org.telegram.ui.Cells.e9 f34003q0;
    public final HashMap f34004q1;
    public final String f34005r;
    public org.telegram.ui.Cells.ea f34006r0;
    public final HashMap f34007r1;
    public String f34008s;
    public int f34009s0;
    public final HashMap f34010s1;
    public final boolean[] f34011t0;
    public final HashMap f34012t1;
    public boolean f34013u0;
    public final HashMap f34014u1;
    public String v;
    public boolean f34015v0;
    public final HashMap f34016v1;
    public String f34017w;
    public TextView f34018w0;
    public HashMap f34019w1;
    public final int[] f34020x;
    public org.telegram.ui.Cells.ea f34021x0;
    public HashMap f34022x1;
    public TL_account.authorizationForm f34023y;
    public org.telegram.ui.Cells.ea f34024y0;
    public final HashMap f34025y1;
    public org.telegram.ui.Cells.b7 f34026z0;
    public String f34027z1;
    ...
    public gn0(int i10, TL_account.authorizationForm authorizationform, TL_account.Password password, TLRPC.TL_secureRequiredType tL_secureRequiredType, TLRPC.TL_secureValue tL_secureValue, TLRPC.TL_secureRequiredType tL_secureRequiredType2, TLRPC.TL_secureValue tL_secureValue2, HashMap hashMap, HashMap hashMap2) {
        ...
        this.f34008s = "";
        this.v = "";
        this.f34020x = new int[3];
        this.f33992k0 = new ArrayList();
        this.f34011t0 = new boolean[3];
        this.f34013u0 = true;
        this.U0 = new ArrayList();
        this.V0 = new HashMap();
        this.W0 = new HashMap();
        this.X0 = new HashMap();
        this.f33989i1 = new ArrayList();
        this.f33993k1 = new ArrayList();
        this.f33998n1 = new HashMap();
        this.f34000o1 = new HashMap();
        this.f34002p1 = new HashMap();
        this.f34004q1 = new HashMap();
        this.f34007r1 = new HashMap();
        this.f34014u1 = new HashMap();
        this.f34016v1 = new HashMap();
        this.f34025y1 = new HashMap();
        this.D1 = new fm0(this);
        this.f33971b = i10;
        this.f34023y = authorizationform;
        this.E = tL_secureRequiredType;
        if (tL_secureRequiredType != null) {
            this.f34013u0 = tL_secureRequiredType.native_names;
        }
        this.H = tL_secureValue;
        this.F = tL_secureRequiredType2;
        this.I = tL_secureValue2;
        this.J = password;
        this.f34010s1 = hashMap;
        this.f34012t1 = hashMap2;
        if (i10 == 3) {
        ...
        if (hashMap == null) {
            this.f34010s1 = new HashMap();
        }
        if (hashMap2 == null) {
            this.f34012t1 = new HashMap();
        }
        if (i10 == 5) {
    ...
    public static void V(gn0 gn0Var) {
        ...
        HashMap hashMap = gn0Var.f34007r1;
        HashMap hashMap2 = gn0Var.f34004q1;
        String str = gn0Var.f34005r;
        ArrayList arrayList2 = new ArrayList();
        int size = gn0Var.f34023y.required_types.size();
        for (int i12 = 0; i12 < size; i12++) {
            TLRPC.SecureRequiredType secureRequiredType = gn0Var.f34023y.required_types.get(i12);
            ...
            HashMap hashMap3 = (HashMap) gn0Var.f34014u1.get(o1(tL_secureRequiredType.type));
        ...
        acceptauthorization.bot_id = gn0Var.f33974c;
        ...
        while (i14 < size3) {
            ...
            TLRPC.TL_secureValue tL_secureValue = gm0Var.f33962a;
            ...
            if (securePlainData != null) {
                ...
                try {
                    ...
                    if (gm0Var.f33964c && !tL_secureValue.translation.isEmpty()) {
    ...
    public static void W(gn0 gn0Var, TLRPC.TL_error tL_error, String str, wm0 wm0Var, TLObject tLObject, TL_account.sendVerifyPhoneCode sendverifyphonecode) {
        if (tL_error == null) {
            ...
            gn0 gn0Var2 = new gn0(7, gn0Var.f34023y, gn0Var.J, gn0Var.E, (TLRPC.TL_secureValue) null, (TLRPC.TL_secureRequiredType) null, (TLRPC.TL_secureValue) null, hashMap, (HashMap) null);
            gn0Var2.currentAccount = gn0Var.currentAccount;
            gn0Var2.f33980e1 = gn0Var.f33980e1;
            gn0Var2.f33976c1 = gn0Var.f33976c1;
            gn0Var2.B1 = wm0Var;
    ...
    public static void X(gn0 gn0Var, SecureDocument secureDocument, int i10) {
        HashMap hashMap = gn0Var.f33998n1;
        int i11 = gn0Var.S0;
        if (i11 == 1) {
            SecureDocument secureDocument2 = gn0Var.f33991j1;
            if (secureDocument2 != null) {
                en0 en0Var = (en0) hashMap.remove(secureDocument2);
                if (en0Var != null) {
                    gn0Var.f33984g0.removeView(en0Var);
                }
                gn0Var.f33991j1 = null;
            }
        } else if (i11 == 4) {
            if (gn0Var.f33993k1.size() >= 20) {
                return;
            }
        } else if (i11 == 2) {
            ...
            if (secureDocument3 != null) {
                ...
                if (en0Var2 != null) {
                    gn0Var.f33979e0.removeView(en0Var2);
                }
                gn0Var.l1 = null;
            }
        } else if (i11 == 3) {
            SecureDocument secureDocument4 = gn0Var.f33995m1;
            if (secureDocument4 != null) {
                en0 en0Var3 = (en0) hashMap.remove(secureDocument4);
                if (en0Var3 != null) {
                    gn0Var.f33982f0.removeView(en0Var3);
                }
                gn0Var.f33995m1 = null;
            }
        } else if (i11 == 0 && gn0Var.f33989i1.size() >= 20) {
            return;
        }
        gn0Var.f34000o1.put(secureDocument.path, secureDocument);
    ...
    public static void Z(int i10, String str, SecureDocument secureDocument, en0 en0Var, gn0 gn0Var) {
        HashMap hashMap = gn0Var.f34000o1;
        gn0Var.f33998n1.remove(secureDocument);
        if (i10 == 1) {
            gn0Var.f33991j1 = null;
            gn0Var.f33984g0.removeView(en0Var);
        } else if (i10 == 4) {
            gn0Var.f33993k1.remove(secureDocument);
            gn0Var.f33986h0.removeView(en0Var);
        } else if (i10 == 2) {
            gn0Var.l1 = null;
            gn0Var.f33979e0.removeView(en0Var);
        } else if (i10 == 3) {
            gn0Var.f33995m1 = null;
            gn0Var.f33982f0.removeView(en0Var);
        } else {
            gn0Var.f33989i1.remove(secureDocument);
            gn0Var.f33977d0.removeView(en0Var);
        }
        if (str != null) {
            HashMap hashMap2 = gn0Var.f34022x1;
            if (hashMap2 != null) {
                hashMap2.remove(str);
            }
            HashMap hashMap3 = gn0Var.f34025y1;
            if (hashMap3 != null) {
                hashMap3.remove(str);
            }
        }
    ...
    public static void a0(gn0 gn0Var) {
        ...
        for (int i10 = 0; i10 < gn0Var.f34023y.values.size(); i10++) {
            deletesecurevalue.types.add(gn0Var.f34023y.values.get(i10).type);
        }
        gn0Var.y1();
    ...
    public final void C1() {
        ...
        if (getParentActivity() != null && !arrayList.isEmpty()) {
            ...
            alertDialog$Builder.f18661a.R = LocaleController.getString(R.string.PassportNoDocumentsAdd);
    ...
    public final void D1() {
        ...
        int i11 = this.S0;
        ArrayList arrayList = this.f33989i1;
        int i12 = 1;
    ...
    public final void E1(TLRPC.TL_secureRequiredType tL_secureRequiredType, TLRPC.TL_secureRequiredType tL_secureRequiredType2, ArrayList arrayList, boolean z10) {
        ...
        if (i11 != -1) {
            HashMap hashMap4 = this.f34014u1;
            if (!z10) {
            ...
            TL_account.authorizationForm authorizationform = this.f34023y;
            int i12 = i11;
            TL_account.Password password = this.J;
            HashMap hashMap7 = this.f34002p1;
            ...
            gn0Var.f33980e1 = this.f33980e1;
            gn0Var.f33976c1 = this.f33976c1;
            gn0Var.f33974c = this.f33974c;
            gn0Var.f34019w1 = hashMap6;
            gn0Var.f34015v0 = z10;
            gn0Var.f34022x1 = hashMap2;
            gn0Var.G = arrayList;
            if (i12 == 4) {
                gn0Var.f33978d1 = this.f33978d1;
            }
    ...
    public final TLRPC.TL_secureValue H1(TLRPC.TL_secureRequiredType tL_secureRequiredType) {
        ...
        int size = this.f34023y.values.size();
        for (int i10 = 0; i10 < size; i10++) {
            if (tL_secureRequiredType.type.getClass() == this.f34023y.values.get(i10).type.getClass()) {
                return this.f34023y.values.remove(i10);
            }
        }
        return null;
    }
    ...
    public final void I1(View view) {
        while (view != null && this.f33975c0.indexOfChild(view) < 0) {
            view = (View) view.getParent();
        }
        if (view != null) {
            this.f33972b0.smoothScrollTo(0, view.getTop() - ((this.f33972b0.getMeasuredHeight() - view.getMeasuredHeight()) / 2));
        }
    }
    ...
    public final void J1(HashMap hashMap, EditTextBoldCursor editTextBoldCursor, String str) {
        ...
        HashMap hashMap2 = this.f34019w1;
        HashMap hashMap3 = this.f34025y1;
        ...
        HashMap hashMap4 = this.f34022x1;
    ...
    public final void K1(Bundle bundle, int i10, boolean z10) {
        ...
        if (z10) {
            ...
            animatorSet.addListener(new org.telegram.ui.Components.bl0(gw0Var2, gw0Var, 8));
            animatorSet.start();
            return;
        }
    ...
    public final void N1(boolean z10, boolean z11) {
        ...
        if (z10 && this.L != null) {
            ...
            if (z11) {
                ...
                animatorSet3.playTogether(ofFloat3, ofFloat4, ObjectAnimator.ofFloat(vqVar3, property6, 0.0f), ObjectAnimator.ofFloat(this.L.getContentView(), property4, 1.0f), ObjectAnimator.ofFloat(this.L.getContentView(), property5, 1.0f), ObjectAnimator.ofFloat(this.L.getContentView(), property6, 1.0f));
            }
            ...
            if (z11) {
                ...
                animatorSet5.playTogether(ofFloat7, ofFloat8, ObjectAnimator.ofFloat(vqVar6, property12, 0.0f), ObjectAnimator.ofFloat(this.O, property10, 1.0f), ObjectAnimator.ofFloat(this.O, property11, 1.0f), ObjectAnimator.ofFloat(this.O, property12, 1.0f));
            }
    ...
    public final void Q1() {
        if (this.f34023y.values.isEmpty()) {
            this.A0.setVisibility(0);
            this.f33994l0.setVisibility(8);
            this.f33990j0.setVisibility(8);
            this.f34021x0.setVisibility(8);
            this.f34024y0.setVisibility(8);
            this.f34026z0.setVisibility(8);
            return;
        }
        this.A0.setVisibility(8);
        this.f33994l0.setVisibility(0);
        this.f33990j0.setVisibility(0);
        this.f34024y0.setVisibility(0);
        this.f34026z0.setVisibility(0);
    ...
    public final void R0(final SecureDocument secureDocument, final int i10) {
        ...
        HashMap hashMap;
        if (i10 == 1) {
            this.f33991j1 = secureDocument;
            if (this.f33984g0 == null) {
                return;
            }
        } else if (i10 == 4) {
            this.f33993k1.add(secureDocument);
            if (this.f33986h0 == null) {
                return;
            }
        } else if (i10 == 2) {
            this.l1 = secureDocument;
            if (this.f33979e0 == null) {
                return;
            }
        } else if (i10 == 3) {
            this.f33995m1 = secureDocument;
            if (this.f33982f0 == null) {
                return;
            }
        } else {
            this.f33989i1.add(secureDocument);
            if (this.f33977d0 == null) {
                return;
            }
        }
        if (getParentActivity() == null) {
        ...
        if (i10 == 1) {
            ...
            this.f33979e0.addView(en0Var, w7.y5.n(-1, -2));
            str = "front" + n12;
        } else if (i10 == 3) {
            string = LocaleController.getString(R.string.PassportReverseSide);
            this.f33982f0.addView(en0Var, w7.y5.n(-1, -2));
            str = "reverse" + n12;
        } else {
            string = LocaleController.getString(R.string.AttachPhoto);
            this.f33977d0.addView(en0Var, w7.y5.n(-1, -2));
            str = "files" + n12;
        }
        if (str != null && (hashMap = this.f34022x1) != null && (formatDateForBan = (String) hashMap.get(str)) != null) {
            en0Var.f33444b.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19279p7, false));
            this.f34025y1.put(str, "");
        } else {
            formatDateForBan = LocaleController.formatDateForBan(secureDocument.secureFile.date);
        }
        en0Var.f33443a.setText(string);
        en0Var.f33444b.setText(formatDateForBan);
        org.telegram.ui.Components.w9 w9Var = en0Var.f33445c;
        w9Var.getClass();
        w9Var.m(ImageLocation.getForSecureDocument(secureDocument), "48_48", null, null, null, null, 0, null);
        en0Var.f33446f = secureDocument;
        en0Var.a(false);
        ...
        en0Var.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public final boolean onLongClick(View view) {
                ...
                int i11 = i10;
                if (i11 == 1) {
                    alertDialog$Builder.f18661a.T = LocaleController.getString(R.string.PassportDeleteSelfie);
                } else {
                    alertDialog$Builder.f18661a.T = LocaleController.getString(R.string.PassportDeleteScan);
                }
                ...
                gn0Var.showDialog(alertDialog$Builder.f18661a);
                return true;
            }
        });
    }
    ...
    public final void Y0(boolean z10) {
        ...
        if (this.f33969a0 != null) {
            ...
            if (this.E.native_names && !TextUtils.isEmpty(this.v) && !"EN".equals(str3)) {
                if (this.f34003q0.getVisibility() != 0) {
                    this.f34003q0.setVisibility(0);
                    this.f33990j0.setVisibility(0);
                    this.T.setVisibility(0);
                    int i11 = 0;
                    while (true) {
                        editTextBoldCursorArr = this.f33969a0;
                        if (i11 >= editTextBoldCursorArr.length) {
                            break;
                        }
                    ...
                    if (editTextBoldCursorArr[0].length() == 0 && this.f33969a0[1].length() == 0 && this.f33969a0[2].length() == 0) {
                        int i12 = 0;
                        while (true) {
                            boolean[] zArr = this.f34011t0;
                            if (i12 >= zArr.length) {
                                break;
                            } else if (zArr[i12]) {
                                this.f33969a0[0].setText(this.Y[0].getText());
                                this.f33969a0[1].setText(this.Y[1].getText());
                                this.f33969a0[2].setText(this.Y[2].getText());
                                break;
                            } else {
                                i12++;
                            }
                    ...
                    this.m0.setBackgroundDrawable(org.telegram.ui.ActionBar.h6.V0(getParentActivity(), R.drawable.greydivider, org.telegram.ui.ActionBar.h6.f19023b7));
                }
                this.f34003q0.setText(LocaleController.formatString("PassportNativeInfo", R.string.PassportNativeInfo, str2));
                if (str3 != null) {
                ...
                if (str != null) {
                    this.f33990j0.setText(LocaleController.formatString("PassportNativeHeaderLang", R.string.PassportNativeHeaderLang, str));
                } else {
                    this.f33990j0.setText(LocaleController.getString(R.string.PassportNativeHeader));
                }
                for (int i13 = 0; i13 < 3; i13++) {
                    if (i13 != 0) {
                        if (i13 != 1) {
                            if (i13 == 2) {
                                if (str != null) {
                                    this.f33969a0[i13].setHintText(LocaleController.getString(R.string.PassportSurname));
                                } else {
                                    this.f33969a0[i13].setHintText(LocaleController.formatString("PassportSurnameCountry", R.string.PassportSurnameCountry, str2));
                                }
                            }
                        } else if (str != null) {
                            this.f33969a0[i13].setHintText(LocaleController.getString(R.string.PassportMidname));
                        } else {
                            this.f33969a0[i13].setHintText(LocaleController.formatString("PassportMidnameCountry", R.string.PassportMidnameCountry, str2));
                        }
                    } else if (str != null) {
                        this.f33969a0[i13].setHintText(LocaleController.getString(R.string.PassportName));
                    } else {
                        this.f33969a0[i13].setHintText(LocaleController.formatString("PassportNameCountry", R.string.PassportNameCountry, str2));
                    }
                }
                if (z10) {
                    AndroidUtilities.runOnUIThread(new ql0(this, 2));
                }
            } else if (this.f34003q0.getVisibility() != 8) {
                this.f34003q0.setVisibility(8);
                this.f33990j0.setVisibility(8);
                this.T.setVisibility(8);
                while (true) {
                    EditTextBoldCursor[] editTextBoldCursorArr2 = this.f33969a0;
                ...
                if (((this.f33974c != 0 || this.F == null) && this.H != null && !this.f34015v0) || this.I != null) {
                    this.m0.setBackgroundDrawable(org.telegram.ui.ActionBar.h6.V0(getParentActivity(), R.drawable.greydivider, org.telegram.ui.ActionBar.h6.f19023b7));
                } else {
                    this.m0.setBackgroundDrawable(org.telegram.ui.ActionBar.h6.V0(getParentActivity(), R.drawable.greydivider_bottom, org.telegram.ui.ActionBar.h6.f19023b7));
                }
            }
        }
    }
    ...
    public final void a1(boolean z10) {
        ...
        String str;
        String str2;
        if (this.f34001p0 != null) {
            HashMap hashMap = this.f34019w1;
            HashMap hashMap2 = this.f34025y1;
            if (hashMap != null && ((z10 || hashMap2.containsKey("error_all")) && (str2 = (String) this.f34019w1.get("error_all")) != null)) {
            ...
            if (this.f34022x1 != null && ((z10 || hashMap2.containsKey("error_document_all")) && (str = (String) this.f34022x1.get("error_all")) != null)) {
            ...
            if (spannableStringBuilder != null) {
                spannableStringBuilder.setSpan(new ForegroundColorSpan(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19279p7, false)), 0, spannableStringBuilder.length(), 33);
                this.f34001p0.setText(spannableStringBuilder);
                this.f34001p0.setVisibility(0);
            } else if (this.f34001p0.getVisibility() != 8) {
                this.f34001p0.setVisibility(8);
            }
        }
    }
    ...
    public final void b1(Context context) {
        ...
        this.f34001p0.setPadding(0, AndroidUtilities.dp(7.0f), 0, 0);
        this.f33975c0.addView(this.f34001p0, w7.y5.n(-1, -2));
        a1(true);
        TLRPC.TL_secureRequiredType tL_secureRequiredType = this.F;
        if (tL_secureRequiredType != null) {
            ...
            org.telegram.ui.Cells.m4 m4Var2 = this.f33990j0;
            int i12 = org.telegram.ui.ActionBar.h6.f19059d6;
            m4Var2.setBackgroundColor(org.telegram.ui.ActionBar.h6.w0(null, i12, false));
            this.f33975c0.addView(this.f33990j0, w7.y5.n(-1, -2));
            LinearLayout linearLayout = new LinearLayout(context);
            this.f33977d0 = linearLayout;
            linearLayout.setOrientation(1);
            this.f33975c0.addView(this.f33977d0, w7.y5.n(-1, -2));
            ...
            if (hashMap != null) {
                ...
                if (str4 != null) {
                    ...
                    spannableStringBuilder.append((CharSequence) "\n\n");
                    spannableStringBuilder.append((CharSequence) this.f34027z1);
                    spannableStringBuilder.setSpan(new ForegroundColorSpan(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19279p7, false)), 0, str4.length(), 33);
                    hashMap2.put("files_all", "");
                    str3 = spannableStringBuilder;
                }
            }
            this.f33997n0.setText(str3);
            this.f33975c0.addView(this.f33997n0, w7.y5.n(-1, -2));
            if (this.F.translation_required) {
                org.telegram.ui.Cells.m4 m4Var3 = new org.telegram.ui.Cells.m4(context);
                this.f33990j0 = m4Var3;
                m4Var3.setText(LocaleController.getString(R.string.PassportTranslation));
                this.f33990j0.setBackgroundColor(org.telegram.ui.ActionBar.h6.w0(null, i12, false));
                this.f33975c0.addView(this.f33990j0, w7.y5.n(-1, -2));
                LinearLayout linearLayout2 = new LinearLayout(context);
                this.f33986h0 = linearLayout2;
                linearLayout2.setOrientation(1);
                this.f33975c0.addView(this.f33986h0, w7.y5.n(-1, -2));
                ...
                String str5 = this.A1;
                HashMap hashMap3 = this.f34022x1;
                String str6 = str5;
                if (hashMap3 != null) {
                    ...
                    if (str7 != null) {
                        ...
                        spannableStringBuilder2.setSpan(new ForegroundColorSpan(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19279p7, false)), 0, str7.length(), 33);
                        hashMap2.put("translation_all", "");
                        str6 = spannableStringBuilder2;
                    }
                }
                this.f33999o0.setText(str6);
                this.f33975c0.addView(this.f33999o0, w7.y5.n(-1, -2));
            }
        } else {
            j3 = 0;
        ...
        this.f33990j0 = m4Var4;
        m4Var4.setText(LocaleController.getString(R.string.PassportAddressHeader));
        this.f33990j0.setBackgroundColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19059d6, false));
        this.f33975c0.addView(this.f33990j0, w7.y5.n(-1, -2));
        ...
        for (int i13 = 0; i13 < 6; i13++) {
            ...
            this.f33975c0.addView(am0Var, w7.y5.n(-1, -2));
            ...
            if (i13 == 5) {
                ...
                this.f33975c0.addView(this.S, w7.y5.n(-1, 6));
            }
            if (this.f34015v0 && this.F != null) {
            ...
            this.Y[i13].setLineColors(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19186k6, false), org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19204l6, false), org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19279p7, false));
            if (i13 == 5) {
            ...
            J1(this.f34010s1, this.Y[i13], str);
            if (i13 == 2) {
        ...
        this.f33994l0 = b7Var;
        this.f33975c0.addView(b7Var, w7.y5.n(-1, -2));
        if (this.f34015v0 && this.F != null) {
            this.f33990j0.setVisibility(8);
            this.f33994l0.setVisibility(8);
        }
        ...
        if (((j10 != j3 || this.F == null) && this.H != null && !this.f34015v0) || tL_secureValue != null) {
            if (tL_secureValue != null) {
                T0(tL_secureValue.files);
                V0(tL_secureValue.translation);
            }
            org.telegram.ui.Cells.b7 b7Var2 = this.f33994l0;
            int i17 = R.drawable.greydivider;
            int i18 = org.telegram.ui.ActionBar.h6.f19023b7;
            ...
            eaVar3.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19279p7, false));
            ...
            this.f33975c0.addView(eaVar3, w7.y5.n(-1, -2));
            ...
            this.f33994l0 = b7Var3;
            b7Var3.setBackgroundDrawable(org.telegram.ui.ActionBar.h6.V0(context, R.drawable.greydivider_bottom, i18));
            this.f33975c0.addView(this.f33994l0, w7.y5.n(-1, -2));
        } else {
            org.telegram.ui.Cells.b7 b7Var4 = this.f33994l0;
            int i19 = R.drawable.greydivider_bottom;
            int i20 = org.telegram.ui.ActionBar.h6.f19023b7;
            b7Var4.setBackgroundDrawable(org.telegram.ui.ActionBar.h6.V0(context, i19, i20));
            if (this.f34015v0 && this.F != null) {
                this.f33997n0.setBackgroundDrawable(org.telegram.ui.ActionBar.h6.V0(context, R.drawable.greydivider_bottom, i20));
            }
        }
        S1(0);
        S1(4);
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.fileUploaded) {
            ...
            if (secureDocument != null) {
                ...
                HashMap hashMap2 = this.f33998n1;
                ...
                if (i12 == 0) {
                    if (this.f33997n0 != null && !TextUtils.isEmpty(this.f34027z1)) {
                        this.f33997n0.setText(this.f34027z1);
                    }
                    hashMap3.remove("files_all");
                } else if (i12 == 4) {
                    if (this.f33999o0 != null && !TextUtils.isEmpty(this.A1)) {
                        this.f33999o0.setText(this.A1);
                    }
    ...
    public final void e1(Context context) {
        ...
        int i13 = org.telegram.ui.ActionBar.h6.f19023b7;
        ...
        if (tL_secureRequiredType != null) {
            ...
            this.f33975c0.addView(this.f33990j0, w7.y5.n(-1, -2));
            LinearLayout linearLayout = new LinearLayout(context);
            this.f33979e0 = linearLayout;
            linearLayout.setOrientation(1);
            this.f33975c0.addView(this.f33979e0, w7.y5.n(-1, -2));
            ...
            this.f33975c0.addView(this.U, w7.y5.n(-1, -2));
            this.U.setOnClickListener(new rl0(this, 0));
            LinearLayout linearLayout2 = new LinearLayout(context);
            this.f33982f0 = linearLayout2;
            linearLayout2.setOrientation(1);
            this.f33975c0.addView(this.f33982f0, w7.y5.n(-1, -2));
            ...
            this.f33975c0.addView(this.V, w7.y5.n(-1, -2));
            this.V.setOnClickListener(new rl0(this, 2));
            if (this.F.selfie_required) {
                LinearLayout linearLayout3 = new LinearLayout(context);
                this.f33984g0 = linearLayout3;
                linearLayout3.setOrientation(1);
                this.f33975c0.addView(this.f33984g0, w7.y5.n(-1, -2));
                ...
                this.f33975c0.addView(this.W, w7.y5.n(-1, -2));
            ...
            this.f33997n0.setText(LocaleController.getString(R.string.PassportPersonalUploadInfo));
            this.f33975c0.addView(this.f33997n0, w7.y5.n(-1, -2));
            if (this.F.translation_required) {
                org.telegram.ui.Cells.m4 m4Var3 = new org.telegram.ui.Cells.m4(context);
                this.f33990j0 = m4Var3;
                m4Var3.setText(LocaleController.getString(R.string.PassportTranslation));
                this.f33990j0.setBackgroundColor(org.telegram.ui.ActionBar.h6.w0(null, i15, false));
                this.f33975c0.addView(this.f33990j0, w7.y5.n(-1, -2));
                LinearLayout linearLayout4 = new LinearLayout(context);
                this.f33986h0 = linearLayout4;
                ...
                if (hashMap != null) {
                    ...
                    if (str5 != null) {
                        ...
                        spannableStringBuilder.setSpan(new ForegroundColorSpan(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19279p7, false)), 0, str5.length(), 33);
                        this.f34025y1.put("translation_all", "");
                        str4 = spannableStringBuilder;
                    }
                }
                this.f33999o0.setText(str4);
                this.f33975c0.addView(this.f33999o0, w7.y5.n(-1, -2));
            }
        } else {
            j3 = 0;
            org.telegram.ui.Cells.ea eaVar2 = new org.telegram.ui.Cells.ea(context);
            this.f34006r0 = eaVar2;
            eaVar2.setBackgroundDrawable(org.telegram.ui.ActionBar.h6.K0(true));
            this.f34006r0.b(LocaleController.getString(R.string.PassportScanPassport), false);
            this.f33975c0.addView(this.f34006r0, w7.y5.n(-1, -2));
            this.f34006r0.setOnClickListener(new rl0(this, 5));
            org.telegram.ui.Cells.e9 e9Var4 = new org.telegram.ui.Cells.e9(context);
            this.f33997n0 = e9Var4;
            e9Var4.setBackgroundDrawable(org.telegram.ui.ActionBar.h6.V0(context, R.drawable.greydivider, i13));
            this.f33997n0.setText(LocaleController.getString(R.string.PassportScanPassportInfo));
            this.f33975c0.addView(this.f33997n0, w7.y5.n(-1, -2));
        }
        org.telegram.ui.Cells.m4 m4Var4 = new org.telegram.ui.Cells.m4(context);
        this.f33990j0 = m4Var4;
        ...
        while (true) {
            ...
            if (i17 < i10) {
                ...
                if (i17 == i10 - 1) {
                    ...
                    this.f33975c0.addView(this.S, w7.y5.n(i14, 6));
                }
                if (this.f34015v0 && this.F != null && i17 < i16) {
                    am0Var.setVisibility(8);
                    View view2 = this.S;
                    if (view2 != null) {
                        view2.setVisibility(8);
                ...
                this.Y[i17].setLineColors(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19186k6, false), org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19204l6, false), org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19279p7, false));
                int i20 = 5;
                if (i17 != 5 && i17 != 6) {
                    if (i17 != 3 && i17 != 8) {
                        if (i17 == 4) {
                ...
                HashMap hashMap3 = this.f34012t1;
                switch (i17) {
                    case 0:
                ...
                this.f33990j0 = m4Var5;
                m4Var5.setBackgroundColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19059d6, false));
                this.f33975c0.addView(this.f33990j0, w7.y5.n(-1, -2));
                this.f33969a0 = new EditTextBoldCursor[3];
                int i21 = 0;
                for (int i22 = 3; i21 < i22; i22 = 3) {
                    EditTextBoldCursor editTextBoldCursor5 = new EditTextBoldCursor(context);
                    this.f33969a0[i21] = editTextBoldCursor5;
                    am0 am0Var2 = new am0(context, editTextBoldCursor5, 2);
                    am0Var2.setWillNotDraw(false);
                    this.f33975c0.addView(am0Var2, w7.y5.n(-1, 64));
                    ...
                    if (i21 == 2) {
                        ...
                        this.f33975c0.addView(this.T, w7.y5.n(-1, 6));
                    }
                    this.f33969a0[i21].setTag(Integer.valueOf(i21));
                    this.f33969a0[i21].setSupportRtlHint(true);
                    this.f33969a0[i21].setTextSize(1, 16.0f);
                    this.f33969a0[i21].setHintColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.H6, false));
                    EditTextBoldCursor editTextBoldCursor6 = this.f33969a0[i21];
                    int i24 = org.telegram.ui.ActionBar.h6.G6;
                    editTextBoldCursor6.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, i24, false));
                    this.f33969a0[i21].setHeaderHintColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.L6, false));
                    this.f33969a0[i21].setTransformHintToHeader(true);
                    this.f33969a0[i21].setBackgroundDrawable(null);
                    this.f33969a0[i21].setCursorColor(org.telegram.ui.ActionBar.h6.w0(null, i24, false));
                    this.f33969a0[i21].setCursorSize(AndroidUtilities.dp(20.0f));
                    this.f33969a0[i21].setCursorWidth(1.5f);
                    this.f33969a0[i21].setLineColors(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19186k6, false), org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19204l6, false), org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19279p7, false));
                    this.f33969a0[i21].setInputType(16385);
                    this.f33969a0[i21].setImeOptions(268435461);
                    if (i21 != 0) {
                        if (i21 != 1) {
                            if (i21 == 2) {
                    ...
                    J1(hashMap2, this.f33969a0[i21], str);
                    EditTextBoldCursor editTextBoldCursor7 = this.f33969a0[i21];
                    editTextBoldCursor7.setSelection(editTextBoldCursor7.length());
                    if (i21 == 0 || i21 == 2 || i21 == 1) {
                        this.f33969a0[i21].addTextChangedListener(new cm0(this, editTextBoldCursor5, str, 1));
                    }
                    this.f33969a0[i21].setPadding(0, 0, 0, 0);
                    EditTextBoldCursor editTextBoldCursor8 = this.f33969a0[i21];
                    if (LocaleController.isRTL) {
                        i11 = 5;
                    } else {
                        i11 = 3;
                    ...
                    am0Var2.addView(this.f33969a0[i21], w7.y5.d(-1, -1.0f, 51, 21.0f, 0.0f, 21.0f, 0.0f));
                    this.f33969a0[i21].setOnEditorActionListener(new pl0(this, 2));
                    i21++;
                }
                org.telegram.ui.Cells.e9 e9Var5 = new org.telegram.ui.Cells.e9(context);
                this.f34003q0 = e9Var5;
                this.f33975c0.addView(e9Var5, w7.y5.n(-1, -2));
                long j10 = this.f33974c;
                TLRPC.TL_secureValue tL_secureValue = this.I;
                if (((j10 != j3 || this.F == null) && this.H != null && !this.f34015v0) || tL_secureValue != null) {
                    if (tL_secureValue != null) {
                    ...
                    org.telegram.ui.Cells.e9 e9Var6 = this.f34003q0;
                    int i25 = R.drawable.greydivider;
                    int i26 = org.telegram.ui.ActionBar.h6.f19023b7;
                    ...
                    this.f33994l0 = b7Var2;
                    b7Var2.setBackgroundDrawable(org.telegram.ui.ActionBar.h6.V0(context, R.drawable.greydivider_bottom, i26));
                    this.f33975c0.addView(this.f33994l0, w7.y5.n(-1, -2));
                } else {
                    this.f34003q0.setBackgroundDrawable(org.telegram.ui.ActionBar.h6.V0(context, R.drawable.greydivider_bottom, org.telegram.ui.ActionBar.h6.f19023b7));
                }
                P1();
                Y0(false);
                return;
    ...
    public final void g1(Context context) {
        ...
        this.f33975c0.addView(eaVar, w7.y5.n(-1, -2));
        ...
        this.f33997n0.setText(LocaleController.getString(R.string.PassportPhoneUseSameInfo));
        this.f33975c0.addView(this.f33997n0, w7.y5.n(-1, -2));
        org.telegram.ui.Cells.m4 m4Var = new org.telegram.ui.Cells.m4(context);
        this.f33990j0 = m4Var;
        ...
        for (int i11 = 0; i11 < 3; i11++) {
            if (i11 == 2) {
                this.Y[i11] = new org.telegram.ui.Components.h40(context);
            } else {
                this.Y[i11] = new EditTextBoldCursor(context);
            }
            if (i11 == 1) {
                frameLayout = org.telegram.messenger.ok.f(context, 0);
                this.f33975c0.addView(frameLayout, w7.y5.n(-1, 50));
            ...
            if (i11 == 1) {
                ...
                this.f34018w0 = textView;
                textView.setText("+");
                this.f34018w0.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, i12, false));
                this.f34018w0.setTextSize(1, 16.0f);
                frameLayout.addView(this.f34018w0, w7.y5.k(21.0f, 12.0f, 0.0f, 6.0f, -2, -2));
        ...
        org.telegram.ui.Cells.e9 e9Var2 = new org.telegram.ui.Cells.e9(context);
        this.f33997n0 = e9Var2;
        e9Var2.setBackgroundDrawable(org.telegram.ui.ActionBar.h6.V0(context, R.drawable.greydivider_bottom, org.telegram.ui.ActionBar.h6.f19023b7));
        this.f33997n0.setText(LocaleController.getString(R.string.PassportPhoneUploadInfo));
        this.f33975c0.addView(this.f33997n0, w7.y5.n(-1, -2));
    }
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f33972b0, 32768, null, null, null, null, i10));
        ...
        int i11 = 0;
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f33975c0, 0, new Class[]{View.class}, org.telegram.ui.ActionBar.h6.f19180k0, null, null, org.telegram.ui.ActionBar.h6.f19060d7));
        View view = this.S;
        int i12 = org.telegram.ui.ActionBar.h6.f19059d6;
        ...
        int i13 = 0;
        while (true) {
            ArrayList arrayList2 = this.f33992k0;
            if (i13 >= arrayList2.size()) {
                break;
            }
            arrayList.add(new org.telegram.ui.ActionBar.j6((View) arrayList2.get(i13), 1, null, null, null, null, org.telegram.ui.ActionBar.h6.f19060d7));
            i13++;
        }
        for (Map.Entry entry : this.f33998n1.entrySet()) {
            en0 en0Var = (en0) entry.getValue();
            arrayList.add(new org.telegram.ui.ActionBar.j6(en0Var, 268435456, new Class[]{en0.class}, null, null, null, org.telegram.ui.ActionBar.h6.f19059d6));
            ...
            arrayList.add(new org.telegram.ui.ActionBar.j6(en0Var, 0, new Class[]{en0.class}, new String[]{"valueTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.f19461z6));
        }
        int i14 = org.telegram.ui.ActionBar.h6.f19059d6;
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f33975c0, 268435456, new Class[]{org.telegram.ui.Cells.d9.class}, null, null, null, i14));
        int i15 = org.telegram.ui.ActionBar.h6.G6;
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f33975c0, 0, new Class[]{org.telegram.ui.Cells.d9.class}, new String[]{"textView"}, null, null, -1, null, i15));
        int i16 = org.telegram.ui.ActionBar.h6.f19461z6;
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f33975c0, 0, new Class[]{org.telegram.ui.Cells.d9.class}, new String[]{"valueTextView"}, null, null, -1, null, i16));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f33975c0, 268435456, new Class[]{org.telegram.ui.Cells.ea.class}, null, null, null, i14));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f33975c0, 0, new Class[]{org.telegram.ui.Cells.ea.class}, new String[]{"textView"}, null, null, -1, null, i15));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f33975c0, 0, new Class[]{org.telegram.ui.Cells.ea.class}, new String[]{"valueTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.I6));
        int i17 = org.telegram.ui.ActionBar.h6.f19023b7;
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f33975c0, 32, new Class[]{org.telegram.ui.Cells.b7.class}, null, null, null, i17));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f33975c0, 268435456, new Class[]{fn0.class}, null, null, null, i14));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f33975c0, 4, new Class[]{fn0.class}, new String[]{"textView"}, null, null, -1, null, i15));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f33975c0, 4, new Class[]{fn0.class}, null, null, null, org.telegram.ui.ActionBar.h6.f19060d7));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f33975c0, 4, new Class[]{fn0.class}, new String[]{"valueTextView"}, null, null, -1, null, i16));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f33975c0, 8, new Class[]{fn0.class}, new String[]{"checkImageView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.Mh));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f33975c0, 16, new Class[]{org.telegram.ui.Cells.m4.class}, null, null, null, i14));
        int i18 = org.telegram.ui.ActionBar.h6.L6;
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f33975c0, 0, new Class[]{org.telegram.ui.Cells.m4.class}, new String[]{"textView"}, null, null, -1, null, i18));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f33975c0, 32, new Class[]{org.telegram.ui.Cells.e9.class}, null, null, null, i17));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f33975c0, 0, new Class[]{org.telegram.ui.Cells.e9.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.B6));
        if (this.Y != null) {
            int i19 = 0;
            while (true) {
                EditTextBoldCursor[] editTextBoldCursorArr = this.Y;
                ...
                arrayList.add(new org.telegram.ui.ActionBar.j6((View) editTextBoldCursorArr[i19].getParent(), 1, null, null, null, null, org.telegram.ui.ActionBar.h6.f19059d6));
                ...
                arrayList.add(new org.telegram.ui.ActionBar.j6(this.Y[i19], 32, null, null, null, null, org.telegram.ui.ActionBar.h6.f19186k6));
                arrayList.add(new org.telegram.ui.ActionBar.j6(this.Y[i19], 65568, null, null, null, null, org.telegram.ui.ActionBar.h6.f19204l6));
                arrayList.add(new org.telegram.ui.ActionBar.j6(this.Y[i19], 2080, null, null, null, null, org.telegram.ui.ActionBar.h6.f19279p7));
                i19++;
            }
        } else {
            ...
            arrayList.add(new org.telegram.ui.ActionBar.j6(null, 32, null, null, null, null, org.telegram.ui.ActionBar.h6.f19186k6));
            arrayList.add(new org.telegram.ui.ActionBar.j6(null, 65568, null, null, null, null, org.telegram.ui.ActionBar.h6.f19204l6));
            arrayList.add(new org.telegram.ui.ActionBar.j6(null, 2080, null, null, null, null, org.telegram.ui.ActionBar.h6.f19279p7));
        }
        if (this.f33969a0 != null) {
            while (true) {
                EditTextBoldCursor[] editTextBoldCursorArr2 = this.f33969a0;
                ...
                arrayList.add(new org.telegram.ui.ActionBar.j6((View) editTextBoldCursorArr2[i11].getParent(), 1, null, null, null, null, org.telegram.ui.ActionBar.h6.f19059d6));
                arrayList.add(new org.telegram.ui.ActionBar.j6(this.f33969a0[i11], 16777220, null, null, null, null, org.telegram.ui.ActionBar.h6.G6));
                arrayList.add(new org.telegram.ui.ActionBar.j6(this.f33969a0[i11], 8388608, null, null, null, null, org.telegram.ui.ActionBar.h6.H6));
                arrayList.add(new org.telegram.ui.ActionBar.j6(this.f33969a0[i11], 8390656, null, null, null, null, org.telegram.ui.ActionBar.h6.L6));
                arrayList.add(new org.telegram.ui.ActionBar.j6(this.f33969a0[i11], 32, null, null, null, null, org.telegram.ui.ActionBar.h6.f19186k6));
                arrayList.add(new org.telegram.ui.ActionBar.j6(this.f33969a0[i11], 65568, null, null, null, null, org.telegram.ui.ActionBar.h6.f19204l6));
                arrayList.add(new org.telegram.ui.ActionBar.j6(this.f33969a0[i11], 2080, null, null, null, null, org.telegram.ui.ActionBar.h6.f19279p7));
                i11++;
            }
        }
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.F0, 2048, null, null, null, null, org.telegram.ui.ActionBar.h6.f19130h6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.K0, 4, null, null, null, null, org.telegram.ui.ActionBar.h6.f19316r6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f34018w0, 4, null, null, null, null, org.telegram.ui.ActionBar.h6.G6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.O, 4, null, null, null, null, org.telegram.ui.ActionBar.h6.f19364th));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.Q, 32, null, null, null, null, org.telegram.ui.ActionBar.h6.f19327rh));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.Q, 65568, null, null, null, null, org.telegram.ui.ActionBar.h6.f19346sh));
        org.telegram.ui.Components.vq vqVar = this.N;
        ...
        int i23 = org.telegram.ui.ActionBar.h6.f19461z6;
    ...
    public final byte[] i1(byte[] bArr, byte[] bArr2) {
        ...
        byte[] bArr3 = new byte[32];
        System.arraycopy(this.f33980e1, 0, bArr3, 0, 32);
        byte[] bArr4 = new byte[16];
        System.arraycopy(this.f33980e1, 32, bArr4, 0, 16);
        byte[] bArr5 = new byte[32];
        System.arraycopy(this.f33976c1, 0, bArr5, 0, 32);
            ...
            public final void run(TLObject tLObject, final TLRPC.TL_error tL_error) {
                ...
                AndroidUtilities.runOnUIThread(new Runnable() {
                    ...
                    public final void run() {
                        ...
                        int i11 = 0;
                        if (gn0Var2.f33971b == 8) {
                            fn0 fn0Var = (fn0) gn0Var2.f34004q1.remove(tL_secureRequiredType6);
                            if (fn0Var != null) {
                                gn0Var2.f33975c0.removeView(fn0Var);
                                View childAt = gn0Var2.f33975c0.getChildAt(linearLayout.getChildCount() - 6);
    ...
    public final cf.c k1(byte[] bArr) {
        ...
        byte[] bArr6 = new byte[32];
        System.arraycopy(this.f33980e1, 0, bArr6, 0, 32);
        byte[] bArr7 = new byte[16];
        System.arraycopy(this.f33980e1, 32, bArr7, 0, 16);
        byte[] bArr8 = new byte[32];
        System.arraycopy(this.f33976c1, 0, bArr8, 0, 32);
        Utilities.aesCbcEncryptionByteArraySafe(bArr8, bArr6, bArr7, 0, 32, 0, 0);
    ...
    public final String m1() {
        ...
        int size = arrayList.size();
        for (int i12 = 0; i12 < size; i12++) {
            sb2.append(((SecureDocument) arrayList.get(i12)).secureFile.f18470id);
        }
        SecureDocument secureDocument = this.l1;
        if (secureDocument != null) {
            sb2.append(secureDocument.secureFile.f18470id);
        }
        SecureDocument secureDocument2 = this.f33995m1;
        if (secureDocument2 != null) {
            sb2.append(secureDocument2.secureFile.f18470id);
        }
        SecureDocument secureDocument3 = this.f33991j1;
        if (secureDocument3 != null) {
            sb2.append(secureDocument3.secureFile.f18470id);
        }
        ArrayList arrayList2 = this.f33993k1;
        int size2 = arrayList2.size();
        for (int i13 = 0; i13 < size2; i13++) {
            sb2.append(((SecureDocument) arrayList2.get(i13)).secureFile.f18470id);
        }
        return sb2.toString();
    }
    ...
    public final void onActivityResultFragment(int i10, int i11, Intent intent) {
        if (i11 == -1) {
            ...
            org.telegram.ui.Components.wi wiVar = this.R0;
            if (wiVar != null) {
                wiVar.f30032j0.g0(i10, intent, this.Q0);
            }
            this.Q0 = null;
        }
    }
    ...
    public final void onDialogDismiss(Dialog dialog) {
        if (this.f33971b == 3 && Build.VERSION.SDK_INT >= 23 && dialog == this.L1) {
        ...
        if ((i11 == 1 || i11 == 2) && (wiVar = this.R0) != null) {
            if (i10 == 17) {
                ...
                if (getParentActivity() != null && iArr != null && iArr.length != 0 && iArr[0] != 0) {
                    AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(getParentActivity());
                    alertDialog$Builder.f18661a.R = LocaleController.getString(R.string.AppName);
                    alertDialog$Builder.f18661a.T = LocaleController.getString(R.string.PermissionNoAudioVideoWithHint);
                ...
                F1(0);
            } else if (i10 == 22 && iArr != null && iArr.length > 0 && iArr[0] == 0 && (eaVar = this.f34006r0) != null) {
                eaVar.callOnClick();
            }
        } else if (i11 == 3 && i10 == 6) {
    ...
    public final void onResume() {
        ...
        if (this.f33971b == 5 && (viewGroupArr = this.Z) != null && (viewGroup = viewGroupArr[0]) != null && viewGroup.getVisibility() == 0) {
    ...
    public final TLRPC.TL_secureValue r1(TLRPC.TL_secureRequiredType tL_secureRequiredType, boolean z10) {
        ...
        if (tL_secureRequiredType != null) {
            int size = this.f34023y.values.size();
            for (int i10 = 0; i10 < size; i10++) {
                TLRPC.TL_secureValue tL_secureValue = this.f34023y.values.get(i10);
    ...
    public final boolean s1(Class cls) {
        int size = this.f34023y.values.size();
        for (int i10 = 0; i10 < size; i10++) {
            if (this.f34023y.values.get(i10).type.getClass() == cls) {
                return false;
            }
        }
        return true;
    ...
    public gn0(int i10, long j3, String str, String str2, String str3, String str4, String str5, TL_account.authorizationForm authorizationform, TL_account.Password password) {
        ...
        try {
            ...
            while (i12 < size) {
                ...
                HashMap hashMap = (HashMap) this.f34014u1.get(o12);
                if (hashMap == null) {
                    hashMap = new HashMap();
                    i11 = size;
                    this.f34014u1.put(o12, hashMap);
                    this.f34016v1.put(o12, str6);
                } else {
                    i11 = size;
                }
                if (bArr != null) {
