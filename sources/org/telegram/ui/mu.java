...
public final class mu extends og.a {
    ...
    public final int d;
    public final int e;
    public final CharSequence f35668f;
    public final CharSequence f35669g;
    public final int h;
    ...
    public final boolean equals(Object obj) {
        ...
        mu muVar = (mu) obj;
        CharSequence charSequence = muVar.f35668f;
        int i10 = muVar.f15715a;
        int i11 = this.f15715a;
        if (i10 != i11) {
            return false;
        }
        CharSequence charSequence2 = this.f35668f;
        if (i11 != 1 && i11 != 4 && i11 != 3 && i11 != 5) {
            if (i11 != 2) {
                return true;
            }
            if (muVar.h != this.h || !TextUtils.equals(charSequence2, charSequence) || muVar.d != this.d || muVar.e != this.e || muVar.f35667c != this.f35667c) {
                return false;
            }
            return true;
        }
    ...
    public mu(int i10, int i11, int i12, int i13, CharSequence charSequence, CharSequence charSequence2) {
        ...
        this.d = i12;
        this.e = i13;
        this.f35668f = charSequence;
        this.f35669g = charSequence2;
    }
}
