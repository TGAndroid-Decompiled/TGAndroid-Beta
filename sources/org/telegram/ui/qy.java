...
public final class qy extends org.telegram.ui.Components.ga implements ai.s9 {
    public static final int f36955v3 = 0;
    public boolean f36956d3;
    public boolean f36957e3;
    public boolean f36958f3;
    public final ty f36959g3;
    public int f36960h3;
    public float f36961i3;
    public final Paint j3;
    public final RectF f36962k3;
    public org.telegram.ui.Components.ll0 f36963l3;
    public LongSparseArray f36964m3;
    public Paint f36965n3;
    public float f36966o3;
    public float f36967p3;
    public float f36968q3;
    public boolean f36969r3;
    public ai.rc f36970s3;
    public int f36971t3;
    public final uy f36972u3;
    ...
    public qy(uy uyVar, Context context, ty tyVar) {
        ...
        this.f36957e3 = true;
        this.j3 = new Paint();
        this.f36962k3 = new RectF();
        this.f36967p3 = 1.0f;
        this.f36959g3 = tyVar;
        this.f24284b3 = AndroidUtilities.dp(200.0f);
    }
    ...
    public final void A1() {
        ...
        ty tyVar = this.f36959g3;
        tyVar.v = i10;
        ax axVar = tyVar.f37807n;
        if (axVar != null) {
            if (i10 != 0) {
                z10 = true;
            }
    ...
    public final void a(int[] iArr) {
        int paddingTop = (int) (getPaddingTop() + this.f36972u3.N);
        iArr[0] = paddingTop;
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        if (motionEvent.getAction() == 0 && motionEvent.getY() < getPaddingTop() + this.f36972u3.N) {
            return false;
        }
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        if (getItemAnimator() != null && getItemAnimator().k() && (view instanceof org.telegram.ui.Cells.r2) && ((org.telegram.ui.Cells.r2) view).f20741r) {
            return true;
        }
    ...
    public final void onDraw(Canvas canvas) {
        ty tyVar = this.f36959g3;
        if (tyVar.f37807n != null && uy.A4 != 0.0f) {
            int paddingTop = getPaddingTop();
            if (paddingTop != 0) {
                canvas.save();
                canvas.translate(0.0f, paddingTop);
            }
            tyVar.f37807n.c(canvas, true);
            if (paddingTop != 0) {
                canvas.restore();
            }
        }
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (!this.X1) {
            uy uyVar = this.f36972u3;
            if (!uyVar.f38192b1 && !this.f36959g3.f37811x.k()) {
                if (motionEvent.getAction() == 0) {
                    kVar = ((org.telegram.ui.ActionBar.n2) uyVar).actionBar;
                    uyVar.f38198c1 = !kVar.s();
                }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        this.f36960h3 = getPaddingTop();
        this.f36972u3.f38307x3 = 0.0f;
        this.f36959g3.getClass();
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        uy uyVar = this.f36972u3;
        if (L0 != -1 && tyVar.e.f42824y == 0 && tyVar.f37805c.f42672y < 0 && tyVar.f37803a.getScrollState() != 1) {
            s4.c1 K = tyVar.f37803a.K(L0);
            if (K != null) {
                int top = K.f42675a.getTop();
                if (tyVar.f37809s == 0 && uyVar.Z3() && tyVar.v == 2) {
                    L0 = Math.max(1, L0);
                }
                this.f36958f3 = true;
                tyVar.f37805c.h1(L0, (int) ((top - this.f36960h3) + uyVar.f38307x3 + 0));
                this.f36958f3 = false;
            }
        } else if (L0 == -1 && this.f36957e3) {
            xw xwVar = tyVar.f37805c;
            if (tyVar.f37809s == 0 && uyVar.Z3()) {
                i12 = 1;
            } else {
                i12 = 0;
            }
        ...
        if (ksVar != null) {
            f7 = ksVar.getMetadata().f13990c.f13998a;
        } else {
            f7 = 0.0f;
        }
        int dp = i14 + ((int) (AndroidUtilities.dp(50.0f) * S3));
        this.f36971t3 += (int) (AndroidUtilities.dp(50.0f) * S3);
        ...
        this.f36971t3 -= AndroidUtilities.dp(Math.max(S3, f7) * 5.0f);
        int n32 = uyVar.n3();
        if (dp2 != this.Y2 || n32 != getPaddingBottom()) {
            setTopGlowOffset(dp2);
            setPadding(0, dp2, 0, n32);
            if (uyVar.K) {
                tyVar.f37810w.setPaddingTop(dp2 - AndroidUtilities.dp(81.0f));
            } else {
                tyVar.f37810w.setPaddingTop(dp2);
            }
        ...
        this.f36958f3 = false;
        if (this.f36957e3 && uyVar.getMessagesController().dialogsLoaded) {
            if (tyVar.f37809s == 0 && uyVar.Z3()) {
                this.f36958f3 = true;
        ...
        if (!uyVar.f38243l2 && dp2 != 0 && (tyVarArr = uyVar.f38207e0) != null && tyVarArr.length > 1 && !uyVar.f38244l3 && (animatorSet = uyVar.f38216f3) != null) {
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (!this.X1) {
            uy uyVar = this.f36972u3;
            if (uyVar.f38192b1 || uyVar.f38308y) {
                return false;
            }
            ...
            if (action == 1 || action == 3) {
                s4.y yVar = tyVar.e;
                if (yVar.f42824y != 0) {
                    sy syVar = tyVar.f37806f;
                    if (syVar.e) {
                        syVar.f37497f = true;
                        if (yVar.g(null, 4) != 0 && (c1Var = tyVar.f37806f.d) != null) {
            ...
            if (tyVar.f37809s == 0 && ((action == 1 || action == 3) && tyVar.v == 2 && uyVar.Z3() && ((s4.c0) getLayoutManager()).L0() == 0)) {
                int paddingTop = getPaddingTop();
                ...
                if (Q3 != null) {
                    ...
                    long currentTimeMillis = System.currentTimeMillis() - uyVar.f38200c3;
    ...
    public final void z1(boolean z10, org.telegram.ui.Cells.r2 r2Var) {
        ...
        if (SharedConfig.archiveHidden) {
            if (r2Var != null) {
                ...
                v0(0, top, org.telegram.ui.Components.qr.f27424g);
                if (z10) {
                    uyVar.f38203d1 = true;
                } else {
                    A1();
