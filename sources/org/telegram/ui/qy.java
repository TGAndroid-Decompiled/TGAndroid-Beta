...
public final class qy extends org.telegram.ui.Components.ia implements bi.b9 {
    public static final int f40026v3 = 0;
    public boolean f40027d3;
    public boolean f40028e3;
    public boolean f40029f3;
    public final ty f40030g3;
    public int f40031h3;
    public float f40032i3;
    public final Paint j3;
    public final RectF f40033k3;
    public org.telegram.ui.Components.ll0 f40034l3;
    public LongSparseArray f40035m3;
    public Paint f40036n3;
    public float f40037o3;
    public float f40038p3;
    public float f40039q3;
    public boolean f40040r3;
    public bi.xb f40041s3;
    public int f40042t3;
    public final uy f40043u3;
    ...
    public qy(uy uyVar, Context context, ty tyVar) {
        ...
        this.f40028e3 = true;
        this.j3 = new Paint();
        this.f40033k3 = new RectF();
        this.f40038p3 = 1.0f;
        this.f40030g3 = tyVar;
        this.f27083b3 = AndroidUtilities.dp(200.0f);
    }
    ...
    public final void a(int[] iArr) {
        int paddingTop = (int) (getPaddingTop() + this.f40043u3.N);
        iArr[0] = paddingTop;
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        if (motionEvent.getAction() == 0 && motionEvent.getY() < getPaddingTop() + this.f40043u3.N) {
            return false;
        }
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        if (getItemAnimator() != null && getItemAnimator().k() && (view instanceof org.telegram.ui.Cells.r2) && ((org.telegram.ui.Cells.r2) view).f22644r) {
            return true;
        }
    ...
    public final void onDraw(Canvas canvas) {
        ty tyVar = this.f40030g3;
        if (tyVar.f40891n != null && uy.A4 != 0.0f) {
            int paddingTop = getPaddingTop();
            if (paddingTop != 0) {
                canvas.save();
                canvas.translate(0.0f, paddingTop);
            }
            tyVar.f40891n.c(canvas, true);
            if (paddingTop != 0) {
                canvas.restore();
            }
        }
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (!this.X1) {
            uy uyVar = this.f40043u3;
            if (!uyVar.f41271b1 && !this.f40030g3.f40895x.k()) {
                if (motionEvent.getAction() == 0) {
                    kVar = ((org.telegram.ui.ActionBar.n2) uyVar).actionBar;
                    uyVar.f41277c1 = !kVar.s();
                }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        this.f40031h3 = getPaddingTop();
        this.f40043u3.f41387x3 = 0.0f;
        this.f40030g3.getClass();
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        uy uyVar = this.f40043u3;
        if (L0 != -1 && tyVar.f40889e.f45934y == 0 && tyVar.f40888c.f45764y < 0 && tyVar.f40886a.getScrollState() != 1) {
            s4.c1 K = tyVar.f40886a.K(L0);
            if (K != null) {
                int top = K.f45767a.getTop();
                if (tyVar.f40893s == 0 && uyVar.Z3() && tyVar.v == 2) {
                    L0 = Math.max(1, L0);
                }
                this.f40029f3 = true;
                tyVar.f40888c.h1(L0, (int) ((top - this.f40031h3) + uyVar.f41387x3 + 0));
                this.f40029f3 = false;
            }
        } else if (L0 == -1 && this.f40028e3) {
            xw xwVar = tyVar.f40888c;
            if (tyVar.f40893s == 0 && uyVar.Z3()) {
                i12 = 1;
            } else {
                i12 = 0;
            }
        ...
        this.f40042t3 += (int) (AndroidUtilities.dp(50.0f) * S3);
        ...
        this.f40042t3 -= AndroidUtilities.dp(Math.max(S3, f7) * 5.0f);
        int n32 = uyVar.n3();
        if (dp2 != this.Y2 || n32 != getPaddingBottom()) {
            setTopGlowOffset(dp2);
            setPadding(0, dp2, 0, n32);
            if (uyVar.K) {
                tyVar.f40894w.setPaddingTop(dp2 - AndroidUtilities.dp(81.0f));
            } else {
                tyVar.f40894w.setPaddingTop(dp2);
            }
        ...
        this.f40029f3 = false;
        if (this.f40028e3 && uyVar.getMessagesController().dialogsLoaded) {
            if (tyVar.f40893s == 0 && uyVar.Z3()) {
                this.f40029f3 = true;
        ...
        if (!uyVar.f41323l2 && dp2 != 0 && (tyVarArr = uyVar.f41287e0) != null && tyVarArr.length > 1 && !uyVar.f41324l3 && (animatorSet = uyVar.f41296f3) != null) {
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (!this.X1) {
            uy uyVar = this.f40043u3;
            if (uyVar.f41271b1 || uyVar.f41388y) {
                return false;
            }
            ...
            if (action == 1 || action == 3) {
                s4.y yVar = tyVar.f40889e;
                if (yVar.f45934y != 0) {
                    sy syVar = tyVar.f40890f;
                    if (syVar.f40596e) {
                        syVar.f40597f = true;
                        if (yVar.g(null, 4) != 0 && (c1Var = tyVar.f40890f.d) != null) {
            ...
            if (tyVar.f40893s == 0 && ((action == 1 || action == 3) && tyVar.v == 2 && uyVar.Z3() && ((s4.c0) getLayoutManager()).L0() == 0)) {
                int paddingTop = getPaddingTop();
                ...
                if (Q3 != null) {
                    ...
                    long currentTimeMillis = System.currentTimeMillis() - uyVar.f41279c3;
    ...
    public final void y1(boolean z10, org.telegram.ui.Cells.r2 r2Var) {
        ...
        if (SharedConfig.archiveHidden) {
            if (r2Var != null) {
                ...
                v0(0, top, org.telegram.ui.Components.pr.f29495g);
                if (z10) {
                    uyVar.f41282d1 = true;
                } else {
                    z1();
