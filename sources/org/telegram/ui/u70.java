...
public final class u70 extends org.telegram.ui.Components.ll0 {
    public final Context f37958c;
    public ArrayList d = new ArrayList();
    public ArrayList e = new ArrayList();
    public mw f37959f;
    public String h;
    public int f37960n;
    public final v70 f37961r;
    ...
    public static void E(u70 u70Var, String str) {
        ...
        if (v70Var.N) {
            if (!TextUtils.isEmpty(str)) {
                v70Var.d.setBackgroundColor(v70Var.getThemedColor(org.telegram.ui.ActionBar.j6.f18862d6));
            } else {
                v70Var.d.setBackground(null);
            }
        }
        if (u70Var.f37960n != 0) {
            v70Var.getConnectionsManager().cancelRequest(u70Var.f37960n, true);
            u70Var.f37960n = 0;
        }
        mw mwVar = u70Var.f37959f;
        if (mwVar != null) {
        ...
        if (TextUtils.isEmpty(str)) {
            v70Var.f38311b.setVisibility(8);
            v70Var.f38311b.e(false, true);
            return;
        }
        if (v70Var.f38311b.getVisibility() != 0) {
            v70Var.f38311b.setVisibility(0);
            v70Var.f38311b.e(true, false);
        } else {
            v70Var.f38311b.e(true, true);
        }
        mw mwVar2 = new mw(22, u70Var, str);
        u70Var.f37959f = mwVar2;
    ...
    public final long i(int i10) {
        ...
        if (j(i10) == 0) {
            ...
            return ((TLRPC.TL_messages_stickerSet) arrayList.get(i10)).set.f18148id;
        }
        return -1L;
    }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        org.telegram.ui.Cells.m8 m8Var = (org.telegram.ui.Cells.m8) c1Var.f42697a;
        ...
        if (indexOf != -1) {
            ...
            m8Var.f20444b.setText(spannableString);
        }
        ...
        if (indexOf2 != -1) {
            ...
            m8Var.f20445c.setText(spannableString2);
        }
        TLRPC.TL_messages_stickerSet tL_messages_stickerSet2 = v70Var.f38315r;
        if (tL_messages_stickerSet2 != null) {
            j3 = tL_messages_stickerSet2.set.f18148id;
        } else if (v70Var.b0(v70Var.v) != null) {
            j3 = v70Var.b0(v70Var.v).f18148id;
        } else {
            j3 = 0;
        }
        if (tL_messages_stickerSet.set.f18148id != j3) {
            z12 = false;
        }
        m8Var.b(z12, false);
    }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 != 0) {
            ...
            v70 v70Var = this.f37961r;
            org.telegram.ui.Cells.l4 l4Var = new org.telegram.ui.Cells.l4(this.f37958c, i12, 21, 0, 0, false, false, v70Var.getResourceProvider());
            org.telegram.ui.Components.pq pqVar = new org.telegram.ui.Components.pq(new ColorDrawable(v70Var.getThemedColor(org.telegram.ui.ActionBar.j6.f18806a7)), org.telegram.ui.ActionBar.j6.V0(context, R.drawable.greydivider_bottom, org.telegram.ui.ActionBar.j6.f18826b7));
            pqVar.f27113w = true;
            ...
            m8Var2.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18862d6, false));
            m8Var = m8Var2;
        }
