...
public final class u70 extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public r70 O;
    public FrameLayout f40955a;
    public org.telegram.ui.Components.xw0 f40956b;
    public org.telegram.ui.Components.t00 f40957c;
    public org.telegram.ui.Components.ll0 d;
    public s70 f40958e;
    public t70 f40959f;
    public s4.c0 h;
    public int f40960n;
    public TLRPC.TL_messages_stickerSet f40961r;
    public boolean f40962s;
    public TLRPC.ChatFull v;
    public final long f40963w;
    public int f40964x;
    public int f40965y;
    ...
    public static void U(u70 u70Var, View view, int i10) {
        if (u70Var.getParentActivity() != null) {
            if (u70Var.M) {
                if (i10 > u70Var.f40959f.d.size()) {
                    boolean a2 = ((org.telegram.ui.Cells.m8) view).a();
                    t70 t70Var = u70Var.f40959f;
                    u70Var.d0((TLRPC.TL_messages_stickerSet) t70Var.f40645e.get((i10 - t70Var.d.size()) - 1), a2, false);
                    return;
                } else if (i10 != u70Var.f40959f.d.size()) {
                    u70Var.d0((TLRPC.TL_messages_stickerSet) u70Var.f40959f.d.get(i10), ((org.telegram.ui.Cells.m8) view).a(), true);
                    return;
                } else {
                    return;
                }
            ...
            if (i10 == u70Var.J) {
                u70Var.d0(u70Var.f40961r, true, false);
            }
        }
    }
    ...
    public static void V(u70 u70Var, TLRPC.TL_error tL_error) {
        ...
        if (tL_error == null) {
            TLRPC.TL_messages_stickerSet tL_messages_stickerSet = u70Var.f40961r;
            if (tL_messages_stickerSet == null) {
                ...
                MediaDataController.getInstance(u70Var.currentAccount).putGroupStickerSet(u70Var.f40961r);
            }
            u70Var.h0();
            if (z10) {
    ...
    public static void a0(u70 u70Var, TLRPC.TL_messages_stickerSet tL_messages_stickerSet) {
        int i10 = u70Var.f40960n;
        if (tL_messages_stickerSet == null) {
            if (u70Var.f40961r != null) {
                org.telegram.messenger.w1.o(R.string.GroupsEmojiPackUpdated, org.telegram.ui.Components.yc.a0(u70Var), R.raw.done, 36);
            }
            u70Var.f40961r = null;
            u70Var.f40962s = true;
        } else {
            u70Var.f40961r = tL_messages_stickerSet;
            u70Var.f40962s = false;
            org.telegram.messenger.w1.o(R.string.GroupsEmojiPackUpdated, org.telegram.ui.Components.yc.a0(u70Var), R.raw.done, 36);
        }
        u70Var.h0();
        u70Var.f0(u70Var.f40961r, false);
        if (i10 != -1) {
            if (!u70Var.M) {
    ...
    public final View createView(Context context) {
        ...
        this.f40958e = new s70(this, context);
        this.f40959f = new t70(this, context);
        ...
        this.f40955a = frameLayout2;
        frameLayout2.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20664d6, false));
        ...
        this.f40957c.setIsSingleCell(true);
        this.f40957c.setItemsCount((int) Math.ceil(AndroidUtilities.displaySize.y / AndroidUtilities.dpf2(58.0f)));
        this.f40955a.addView(this.f40957c, w7.x5.c(-1.0f, -1));
        org.telegram.ui.Components.xw0 xw0Var = new org.telegram.ui.Components.xw0(context, this.f40957c, 1, null);
        this.f40956b = xw0Var;
        n7.z0.g(xw0Var);
        this.f40955a.addView(this.f40956b);
        frameLayout.addView(this.f40955a);
        this.f40955a.setVisibility(8);
        this.d.setEmptyView(this.f40955a);
        frameLayout.addView(this.d, w7.x5.c(-1.0f, -1));
        this.d.setAdapter(this.f40958e);
    ...
    public final void d0(TLRPC.TL_messages_stickerSet tL_messages_stickerSet, boolean z10, boolean z11) {
        ...
        ux0Var.f30997d0 = new p70(this, z10, tL_messages_stickerSet);
        ux0Var.B0();
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.stickersDidLoad) {
            ...
            if (chatFull.f19870id == this.f40963w) {
                if (this.v == null && b0(chatFull) != null) {
                    this.f40961r = MediaDataController.getInstance(this.currentAccount).getGroupStickerSetById(b0(chatFull));
                }
                this.v = chatFull;
                g0(true);
            }
    ...
    public final void e0(TLRPC.ChatFull chatFull) {
        this.v = chatFull;
        if (b0(chatFull) != null) {
            this.f40961r = MediaDataController.getInstance(this.currentAccount).getGroupStickerSetById(b0(this.v));
        }
    }
    ...
    public final void f0(TLRPC.TL_messages_stickerSet tL_messages_stickerSet, boolean z10) {
        ...
        if (tL_messages_stickerSet != null) {
            ...
            this.f40961r = tL_messages_stickerSet;
            g0(false);
            if (z11) {
                this.f40958e.o(this.J);
            } else {
                this.f40958e.m(this.J);
            }
            if (z10) {
                this.f40958e.m(this.I);
            }
            r70 r70Var = this.O;
            r70Var.f40086b = true;
            r70Var.invalidate();
    ...
    public final void g0(boolean z10) {
        ...
        this.f40964x = i13;
        h0();
        if (z10 && (s70Var = this.f40958e) != null) {
            s70Var.l();
        }
    }
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.d, 16, new Class[]{org.telegram.ui.Cells.m8.class, org.telegram.ui.Cells.ea.class}, null, null, null, org.telegram.ui.ActionBar.j6.f20664d6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.d, 0, new Class[]{org.telegram.ui.Cells.m8.class}, new String[]{"valueTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f21062z6));
    ...
    public final void onFragmentDestroy() {
        ...
        if ((this.f40961r != null || this.f40962s) && (chatFull = this.v) != null) {
            if (b0(chatFull) == null || (tL_messages_stickerSet = this.f40961r) == null || tL_messages_stickerSet.set.f19896id != b0(this.v).f19896id) {
                if (b0(this.v) != null || this.f40961r != null) {
                    boolean z10 = this.N;
                    long j3 = this.f40963w;
                    if (z10) {
                        ...
                        if (this.f40962s) {
                            ...
                            TLRPC.StickerSet stickerSet = this.f40961r.set;
                        ...
                        if (this.f40962s) {
                            ...
                            TLRPC.StickerSet stickerSet2 = this.f40961r.set;
