...
public final class u70 extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public r70 O;
    public FrameLayout f40982a;
    public org.telegram.ui.Components.xw0 f40983b;
    public org.telegram.ui.Components.t00 f40984c;
    public org.telegram.ui.Components.ll0 d;
    public s70 f40985e;
    public t70 f40986f;
    public s4.c0 h;
    public int f40987n;
    public TLRPC.TL_messages_stickerSet f40988r;
    public boolean f40989s;
    public TLRPC.ChatFull v;
    public final long f40990w;
    public int f40991x;
    public int f40992y;
    ...
    public static void U(u70 u70Var, View view, int i10) {
        if (u70Var.getParentActivity() != null) {
            if (u70Var.M) {
                if (i10 > u70Var.f40986f.d.size()) {
                    boolean a2 = ((org.telegram.ui.Cells.m8) view).a();
                    t70 t70Var = u70Var.f40986f;
                    u70Var.d0((TLRPC.TL_messages_stickerSet) t70Var.f40672e.get((i10 - t70Var.d.size()) - 1), a2, false);
                    return;
                } else if (i10 != u70Var.f40986f.d.size()) {
                    u70Var.d0((TLRPC.TL_messages_stickerSet) u70Var.f40986f.d.get(i10), ((org.telegram.ui.Cells.m8) view).a(), true);
                    return;
                } else {
                    return;
                }
            ...
            if (i10 == u70Var.J) {
                u70Var.d0(u70Var.f40988r, true, false);
            }
        }
    }
    ...
    public static void V(u70 u70Var, TLRPC.TL_error tL_error) {
        ...
        if (tL_error == null) {
            TLRPC.TL_messages_stickerSet tL_messages_stickerSet = u70Var.f40988r;
            if (tL_messages_stickerSet == null) {
                ...
                MediaDataController.getInstance(u70Var.currentAccount).putGroupStickerSet(u70Var.f40988r);
            }
            u70Var.h0();
            if (z10) {
            ...
            NotificationCenter.getInstance(u70Var.currentAccount).lambda$postNotificationNameOnUIThread$1(NotificationCenter.groupPackUpdated, Long.valueOf(u70Var.v.f19897id), Boolean.valueOf(z10));
    ...
    public static void a0(u70 u70Var, TLRPC.TL_messages_stickerSet tL_messages_stickerSet) {
        int i10 = u70Var.f40987n;
        if (tL_messages_stickerSet == null) {
            if (u70Var.f40988r != null) {
                org.telegram.messenger.w1.o(R.string.GroupsEmojiPackUpdated, org.telegram.ui.Components.yc.a0(u70Var), R.raw.done, 36);
            }
            u70Var.f40988r = null;
            u70Var.f40989s = true;
        } else {
            u70Var.f40988r = tL_messages_stickerSet;
            u70Var.f40989s = false;
            org.telegram.messenger.w1.o(R.string.GroupsEmojiPackUpdated, org.telegram.ui.Components.yc.a0(u70Var), R.raw.done, 36);
        }
        u70Var.h0();
        u70Var.f0(u70Var.f40988r, false);
        if (i10 != -1) {
            if (!u70Var.M) {
    ...
    public final View createView(Context context) {
        ...
        this.f40985e = new s70(this, context);
        this.f40986f = new t70(this, context);
        ...
        this.f40982a = frameLayout2;
        frameLayout2.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20691d6, false));
        ...
        this.f40984c.setIsSingleCell(true);
        this.f40984c.setItemsCount((int) Math.ceil(AndroidUtilities.displaySize.y / AndroidUtilities.dpf2(58.0f)));
        this.f40982a.addView(this.f40984c, w7.x5.c(-1.0f, -1));
        org.telegram.ui.Components.xw0 xw0Var = new org.telegram.ui.Components.xw0(context, this.f40984c, 1, null);
        this.f40983b = xw0Var;
        n7.z0.g(xw0Var);
        this.f40982a.addView(this.f40983b);
        frameLayout.addView(this.f40982a);
        this.f40982a.setVisibility(8);
        this.d.setEmptyView(this.f40982a);
        frameLayout.addView(this.d, w7.x5.c(-1.0f, -1));
        this.d.setAdapter(this.f40985e);
    ...
    public final void d0(TLRPC.TL_messages_stickerSet tL_messages_stickerSet, boolean z10, boolean z11) {
        ...
        ux0Var.f31024d0 = new p70(this, z10, tL_messages_stickerSet);
        ux0Var.B0();
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.stickersDidLoad) {
            ...
            if (chatFull.f19897id == this.f40990w) {
                if (this.v == null && b0(chatFull) != null) {
                    this.f40988r = MediaDataController.getInstance(this.currentAccount).getGroupStickerSetById(b0(chatFull));
                }
                this.v = chatFull;
                g0(true);
            }
            ...
            if (b0(this.v) != null && b0(this.v).f19923id == longValue) {
                g0(true);
            }
        }
    }
    ...
    public final void e0(TLRPC.ChatFull chatFull) {
        this.v = chatFull;
        if (b0(chatFull) != null) {
            this.f40988r = MediaDataController.getInstance(this.currentAccount).getGroupStickerSetById(b0(this.v));
        }
    }
    ...
    public final void f0(TLRPC.TL_messages_stickerSet tL_messages_stickerSet, boolean z10) {
        ...
        if (tL_messages_stickerSet != null) {
            ...
            this.f40988r = tL_messages_stickerSet;
            g0(false);
            if (z11) {
                this.f40985e.o(this.J);
            } else {
                this.f40985e.m(this.J);
            }
            if (z10) {
                this.f40985e.m(this.I);
            }
            r70 r70Var = this.O;
            r70Var.f40113b = true;
            r70Var.invalidate();
    ...
    public final void g0(boolean z10) {
        ...
        this.f40991x = i13;
        h0();
        if (z10 && (s70Var = this.f40985e) != null) {
            s70Var.l();
        }
    }
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.d, 16, new Class[]{org.telegram.ui.Cells.m8.class, org.telegram.ui.Cells.ea.class}, null, null, null, org.telegram.ui.ActionBar.j6.f20691d6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.d, 0, new Class[]{org.telegram.ui.Cells.m8.class}, new String[]{"valueTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f21089z6));
    ...
    public final void onFragmentDestroy() {
        ...
        if ((this.f40988r != null || this.f40989s) && (chatFull = this.v) != null) {
            if (b0(chatFull) == null || (tL_messages_stickerSet = this.f40988r) == null || tL_messages_stickerSet.set.f19923id != b0(this.v).f19923id) {
                if (b0(this.v) != null || this.f40988r != null) {
                    boolean z10 = this.N;
                    long j3 = this.f40990w;
                    if (z10) {
                        ...
                        if (this.f40989s) {
                            ...
                            TLRPC.StickerSet stickerSet = this.f40988r.set;
                        ...
                        if (this.f40989s) {
                            ...
                            edit.remove("group_hide_stickers_" + this.v.f19897id).apply();
                            TLRPC.TL_inputStickerSetID tL_inputStickerSetID2 = new TLRPC.TL_inputStickerSetID();
                            tL_channels_setStickers2.stickerset = tL_inputStickerSetID2;
                            TLRPC.StickerSet stickerSet2 = this.f40988r.set;
                            tL_inputStickerSetID2.f19916id = stickerSet2.f19923id;
