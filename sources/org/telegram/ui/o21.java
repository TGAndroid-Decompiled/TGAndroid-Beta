...
public final class o21 extends View {
    ...
    public String O;
    public boolean P;
    public final org.telegram.ui.Components.ec0 f36630a;
    public final Paint f36631b;
    public final BitmapShader f36632c;
    public final BitmapShader d;
    public e21 e;
    public Bitmap f36633f;
    public Bitmap h;
    public Bitmap f36634n;
    public boolean f36635r;
    public final org.telegram.ui.Components.mo0 f36636s;
    public TextPaint v;
    public StaticLayout f36637w;
    public final org.telegram.ui.Components.z5 f36638x;
    public final Paint f36639y;
    ...
    public o21(Context context) {
        ...
        this.f36638x = new org.telegram.ui.Components.z5(1.0f, this, 0L, 2000L, mrVar);
        ...
        ec0Var.N = true;
        ec0Var.r(this);
        Bitmap bitmap = ec0Var.f24580k;
        Shader.TileMode tileMode = Shader.TileMode.MIRROR;
        BitmapShader bitmapShader = new BitmapShader(bitmap, tileMode, tileMode);
        this.f36632c = bitmapShader;
        BitmapShader bitmapShader2 = new BitmapShader(ec0Var.f24580k, tileMode, tileMode);
        ...
        mo0Var.f25846a.setShader(bitmapShader2);
        mo0Var.f25847b = 17;
    ...
    public final void a(Canvas canvas) {
        ...
        if (this.C != null) {
            ...
            if (!this.J && (e21Var = this.e) != null) {
                u21 u21Var = e21Var.f33596a;
                u21Var.f38676c.set((int) (width2 - round), (int) (width3 - round), (int) (width2 + round), (int) (width3 + round));
    ...
    public final void d(boolean z4) {
        ...
        if (z4) {
            ...
            this.f36637w = org.telegram.ui.Components.kw0.c(Emoji.replaceEmoji(str, this.v.getFontMetricsInt(), false), this.v, getWidth(), Layout.Alignment.ALIGN_CENTER, 0.0f, false, TextUtils.TruncateAt.END, getWidth() - AndroidUtilities.dp(60.0f), 1, true);
            return;
        }
        this.f36637w = null;
    }
    ...
    public final void onSizeChanged(int i10, int i11, int i12, int i13) {
        ...
        this.f36633f = Bitmap.createBitmap(i10, i11, Bitmap.Config.ARGB_8888);
        Canvas canvas = new Canvas(this.f36633f);
        float f11 = i10;
        ...
        float max = Math.max((getWidth() * 1.0f) / this.f36630a.f24580k.getWidth(), (getHeight() * 1.0f) / this.f36630a.f24580k.getHeight());
        Matrix matrix = new Matrix();
        matrix.setScale(max, max);
        this.f36632c.setLocalMatrix(matrix);
