...
public final class dt0 extends org.telegram.ui.Components.v00 {
    public final ls0 e;
    public final PhotoViewer f33192f;

    public dt0(PhotoViewer photoViewer, ls0 ls0Var) {
        super(false);
        this.f33192f = photoViewer;
        this.e = ls0Var;
    }
    ...
    public final CharSequence d() {
        ...
        PhotoViewer photoViewer = this.f33192f;
        int[] iArr = photoViewer.f31293m3;
        ...
        int[] iArr2 = photoViewer.f31303n3;
    ...
    public final float k() {
        return this.f33192f.f31329q3.c();
    }
