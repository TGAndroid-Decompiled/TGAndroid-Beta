...
public final class dt0 extends org.telegram.ui.Components.v00 {
    public final ls0 e;
    public final PhotoViewer f33193f;

    public dt0(PhotoViewer photoViewer, ls0 ls0Var) {
        super(false);
        this.f33193f = photoViewer;
        this.e = ls0Var;
    }
    ...
    public final CharSequence d() {
        ...
        PhotoViewer photoViewer = this.f33193f;
        int[] iArr = photoViewer.f31294m3;
        ...
        int[] iArr2 = photoViewer.f31304n3;
    ...
    public final float k() {
        return this.f33193f.f31330q3.c();
    }
