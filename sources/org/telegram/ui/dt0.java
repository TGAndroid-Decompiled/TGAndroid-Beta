...
public final class dt0 extends AnimatorListenerAdapter {
    ...
    public final PhotoViewer f36304b;

    public dt0(PhotoViewer photoViewer, int i10) {
        this.f36304b = photoViewer;
        this.f36303a = i10;
    }
    ...
    public final void onAnimationEnd(Animator animator) {
        boolean z4;
        int i10;
        PhotoViewer photoViewer = this.f36304b;
        zt0 zt0Var = photoViewer.U4;
        org.telegram.ui.Components.y61 y61Var = null;
        ...
        if (bitmap != null || photoViewer.f34348o1) {
            ...
            if (photoViewer.f34348o1) {
                y61Var = (org.telegram.ui.Components.y61) photoViewer.f34442y2;
            }
            af0Var.b(bitmap, orientation, z4, false, fVar, y61Var, zt0Var.f43995c);
        ...
        animatorSet.playTogether(ObjectAnimator.ofFloat(photoViewer.R0, View.TRANSLATION_Y, AndroidUtilities.dp(48.0f), 0.0f), ObjectAnimator.ofFloat(photoViewer, org.telegram.ui.Components.n6.f29416g, 0.0f, 1.0f), ObjectAnimator.ofFloat(photoViewer.f34450z1, View.ALPHA, 0.0f, 1.0f));
        photoViewer.f34334m6.setDuration(200L);
        photoViewer.f34334m6.addListener(new ns0(this, 1));
