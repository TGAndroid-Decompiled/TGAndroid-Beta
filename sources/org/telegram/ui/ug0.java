...
public final class ug0 {
    ...
    public final void a(kg0 kg0Var) {
        ...
        if (i11 >= 23 && AndroidUtilities.isSimAvailable()) {
            ...
            if (wg0Var.v) {
                wg0Var.f42409r.clear();
                if (!z10) {
                    wg0Var.f42409r.add("android.permission.READ_PHONE_STATE");
                }
                if (!z11) {
                    wg0Var.f42409r.add("android.permission.CALL_PHONE");
                }
                if (!z12) {
                    wg0Var.f42409r.add("android.permission.READ_CALL_LOG");
                }
                if (!z13 && i11 >= 26) {
                    wg0Var.f42409r.add("android.permission.READ_PHONE_NUMBERS");
                }
                if (!wg0Var.f42409r.isEmpty()) {
                    ...
                    if (!globalMainSettings.getBoolean("firstlogin", true) && !wg0Var.getParentActivity().shouldShowRequestPermissionRationale("android.permission.READ_PHONE_STATE") && !wg0Var.getParentActivity().shouldShowRequestPermissionRationale("android.permission.READ_CALL_LOG")) {
                        try {
                            wg0Var.getParentActivity().requestPermissions((String[]) wg0Var.f42409r.toArray(new String[0]), 6);
                            return;
                        } catch (Exception e7) {
                            FileLog.e(e7);
                            return;
                    ...
                    wg0Var.h = wg0Var.showDialog(alertDialog$Builder.f20226a);
                    vg0Var.L = true;
                    return;
                }
            }
