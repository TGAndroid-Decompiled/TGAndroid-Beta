    ...
    public final void run() {
        ...
        switch (this.f38454a) {
            ...
            case 3:
                ...
                return;
            case 4:
                AndroidUtilities.removeFromParent(this.f38455b.P);
                return;
            case 5:
                yg0 yg0Var2 = this.f38455b;
                yg0Var2.getClass();
                new wj0(yg0Var2.getParentActivity(), yg0Var2).show();
                return;
            case 6:
                yg0 yg0Var3 = this.f38455b;
                yg0Var3.getClass();
                ...
                return;
            default:
                yg0 yg0Var4 = this.f38455b;
                if (yg0Var4.getParentActivity() != null && (bVarArr = yg0Var4.K) != null) {
                    oh.b bVar = bVarArr[4];
                    float width = ((bVar.getWidth() / 2.0f) + (yg0Var4.f38108b.getWidth() - ((bVar.getX() + yg0Var4.F.getX()) + bVar.getWidth()))) / AndroidUtilities.density;
                    ...
                    yg0Var4.f38108b.addView(yg0Var4.P, w7.y5.d(-1, 100.0f, 87, 0.0f, 0.0f, 0.0f, 72.0f));
                    ci.e4 e4Var2 = yg0Var4.P;
                    e4Var2.f4615l0 = new ug0(yg0Var4, 4);
                    e4Var2.d = 8000L;
                    e4Var2.u();
                    org.telegram.ui.Components.k40.f25631r.b();
                    return;
                }
                return;
        }
