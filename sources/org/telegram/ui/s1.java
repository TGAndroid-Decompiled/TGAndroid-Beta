...
public final class s1 extends FrameLayout implements org.telegram.ui.Cells.p9 {
    public final r1 f37239a;
    public final org.telegram.ui.Components.c91 f37240b;
    public a3 f37241c;
    public a3 d;
    public int e;
    public int f37242f;
    ...
    public final f4 f37246w;
    public final h4 f37247x;
    ...
    public final void a(boolean z10) {
        ...
        this.v = null;
        org.telegram.ui.Components.c91 c91Var = this.f37240b;
        if (c91Var != null) {
            c91Var.b();
        }
    }
    ...
    public final void onDraw(Canvas canvas) {
        if (this.v != null) {
            a3 a3Var = this.f37241c;
            h4 h4Var = this.f37247x;
            int i10 = 0;
            if (a3Var != null) {
                canvas.save();
                canvas.translate(this.e, this.f37242f);
                h4.v(h4Var, canvas, this, 0);
                this.f37241c.draw(canvas, this);
                canvas.restore();
                i10 = 1;
            }
            if (this.d != null) {
                canvas.save();
                canvas.translate(this.e, this.f37242f + this.h);
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (this.f37241c != null) {
            sb2.append(", ");
            sb2.append(this.f37241c.d.getText());
        }
        if (this.d != null) {
            sb2.append(", ");
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        h4 h4Var = this.f37247x;
        if (!h4.l(h4Var, this.f37246w, motionEvent, this, a3Var, i10, i11)) {
            if (!h4.l(h4Var, this.f37246w, motionEvent, this, this.d, this.e, this.f37242f + this.h) && !super.onTouchEvent(motionEvent)) {
                return false;
            }
            return true;
        }
