...
public final class s1 extends FrameLayout implements org.telegram.ui.Cells.p9 {
    public final r1 f37355a;
    public final org.telegram.ui.Components.d91 f37356b;
    public a3 f37357c;
    public a3 d;
    public int e;
    public int f37358f;
    ...
    public final f4 f37362w;
    public final h4 f37363x;
    ...
    public final void a(boolean z10) {
        ...
        this.v = null;
        org.telegram.ui.Components.d91 d91Var = this.f37356b;
        if (d91Var != null) {
            d91Var.b();
        }
    }
    ...
    public final void onDraw(Canvas canvas) {
        if (this.v != null) {
            a3 a3Var = this.f37357c;
            h4 h4Var = this.f37363x;
            int i10 = 0;
            if (a3Var != null) {
                canvas.save();
                canvas.translate(this.e, this.f37358f);
                h4.v(h4Var, canvas, this, 0);
                this.f37357c.draw(canvas, this);
                canvas.restore();
                i10 = 1;
            }
            if (this.d != null) {
                canvas.save();
                canvas.translate(this.e, this.f37358f + this.h);
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (this.f37357c != null) {
            sb2.append(", ");
            sb2.append(this.f37357c.d.getText());
        }
        if (this.d != null) {
            sb2.append(", ");
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        h4 h4Var = this.f37363x;
        if (!h4.l(h4Var, this.f37362w, motionEvent, this, a3Var, i10, i11)) {
            if (!h4.l(h4Var, this.f37362w, motionEvent, this, this.d, this.e, this.f37358f + this.h) && !super.onTouchEvent(motionEvent)) {
                return false;
            }
            return true;
        }
