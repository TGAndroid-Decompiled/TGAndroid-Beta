...
public final class s1 extends FrameLayout implements org.telegram.ui.Cells.q9 {
    public final r1 f37287a;
    public final org.telegram.ui.Components.r91 f37288b;
    public a3 f37289c;
    public a3 d;
    public int e;
    public int f37290f;
    ...
    public final f4 f37294w;
    public final h4 f37295x;
    ...
    public final void a(boolean z10) {
        ...
        this.v = null;
        org.telegram.ui.Components.r91 r91Var = this.f37288b;
        if (r91Var != null) {
            r91Var.b();
        }
    }
    ...
    public final void onDraw(Canvas canvas) {
        if (this.v != null) {
            a3 a3Var = this.f37289c;
            h4 h4Var = this.f37295x;
            int i10 = 0;
            if (a3Var != null) {
                canvas.save();
                canvas.translate(this.e, this.f37290f);
                h4.v(h4Var, canvas, this, 0);
                this.f37289c.draw(canvas, this);
                canvas.restore();
                i10 = 1;
            }
            if (this.d != null) {
                canvas.save();
                canvas.translate(this.e, this.f37290f + this.h);
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (this.f37289c != null) {
            sb2.append(", ");
            sb2.append(this.f37289c.d.getText());
        }
        if (this.d != null) {
            sb2.append(", ");
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        h4 h4Var = this.f37295x;
        if (!h4.l(h4Var, this.f37294w, motionEvent, this, a3Var, i10, i11)) {
            if (!h4.l(h4Var, this.f37294w, motionEvent, this, this.d, this.e, this.f37290f + this.h) && !super.onTouchEvent(motionEvent)) {
                return false;
            }
            return true;
        }
