...
public final class ge0 extends org.telegram.ui.Components.fw0 {
    public final qg0 E;
    public final org.telegram.ui.Components.jd0[] f33914a;
    public final EditTextBoldCursor[] f33915b;
    public final TextView f33916c;
    public final TextView d;
    public final TextView e;
    public final ImageView f33917f;
    public String h;
    public String f33918n;
    public String f33919r;
    public TL_account.Password f33920s;
    public Bundle v;
    public boolean f33921w;
    public final int f33922x;
    public boolean f33923y;
    ...
    public ge0(qg0 qg0Var, Context context, int i10) {
        ...
        this.f33915b = new EditTextBoldCursor[i11];
        this.f33914a = new org.telegram.ui.Components.jd0[i11];
        ...
        while (i15 < this.f33915b.length) {
            ...
            this.f33915b[i15] = new EditTextBoldCursor(context);
            this.f33915b[i15].setCursorSize(AndroidUtilities.dp(20.0f));
            this.f33915b[i15].setCursorWidth(1.5f);
            this.f33915b[i15].setImeOptions(268435461);
            this.f33915b[i15].setTextSize(1, f7);
            this.f33915b[i15].setMaxLines(1);
            this.f33915b[i15].setBackground(null);
            int dp = AndroidUtilities.dp(16.0f);
            this.f33915b[i15].setPadding(dp, dp, dp, dp);
            if (i10 == 0) {
                this.f33915b[i15].setInputType(129);
                this.f33915b[i15].setTransformationMethod(PasswordTransformationMethod.getInstance());
            }
            this.f33915b[i15].setTypeface(Typeface.DEFAULT);
            EditTextBoldCursor editTextBoldCursor = this.f33915b[i15];
            ...
            EditTextBoldCursor editTextBoldCursor2 = this.f33915b[i15];
            if (i15 == 0 && i10 == 0) {
                z10 = true;
            } else {
                z10 = false;
            ...
            this.f33915b[i15].setOnFocusChangeListener(new od(jd0Var, 3));
            if (z10) {
                LinearLayout linearLayout = new LinearLayout(context);
                linearLayout.setOrientation(0);
                linearLayout.setGravity(16);
                linearLayout.addView(this.f33915b[i15], w7.y5.l(1.0f, 0, -2));
                ImageView imageView = new ImageView(context);
                this.f33917f = imageView;
                imageView.setImageResource(R.drawable.msg_message);
                AndroidUtilities.updateViewVisibilityAnimated(imageView, true, 0.1f, false);
                imageView.setOnClickListener(new View.OnClickListener(this) {
                    public final ge0 f32696b;
                    ...
                    public final void onClick(View view) {
                        ...
                        switch (r2) {
                            case 0:
                                ge0 ge0Var = this.f32696b;
                                ImageView imageView2 = ge0Var.f33917f;
                                EditTextBoldCursor[] editTextBoldCursorArr = ge0Var.f33915b;
                                ge0Var.f33923y = !ge0Var.f33923y;
                                ...
                                imageView2.setTag(Boolean.valueOf(ge0Var.f33923y));
                                if (ge0Var.f33923y) {
                                ...
                                return;
                            default:
                                ge0 ge0Var2 = this.f32696b;
                                if (ge0Var2.f33922x == 0) {
                                    ge0Var2.o(null, null);
                                    return;
                                } else {
                                    ge0Var2.o(ge0Var2.f33918n, null);
                                    return;
                                }
                        }
                    }
                ...
                jd0Var.addView(this.f33915b[i15], w7.y5.c(-2.0f, -1));
            }
            jd0Var.e(this.f33915b[i15]);
            addView(jd0Var, w7.y5.t(-1, -2, 1, 16, 16, 16, 0));
            this.f33915b[i15].setOnEditorActionListener(new TextView.OnEditorActionListener() {
                @Override
    ...
    public final void h(String str) {
        if (!this.f33921w) {
            EditTextBoldCursor[] editTextBoldCursorArr = this.f33915b;
            ...
            if (length == 0) {
                ...
                bundle.putString("password", this.f33919r);
    ...
    @Override
    public final void j() {
        AndroidUtilities.runOnUIThread(new c10(this, 18), qg0.f36884t0);
    }

    @Override
    public final void k(Bundle bundle) {
        Bundle bundle2 = bundle.getBundle("recoveryview_params" + this.f33922x);
        this.v = bundle2;
        if (bundle2 != null) {
            m(bundle2, true);
        }
    ...
    public final void l(Bundle bundle) {
        if (this.v != null) {
            bundle.putBundle("recoveryview_params" + this.f33922x, this.v);
        }
    }
    ...
    public final void m(Bundle bundle, boolean z10) {
        ...
        int i10 = 0;
        while (true) {
            editTextBoldCursorArr = this.f33915b;
        ...
        if (string != null) {
            ...
            this.f33920s = TLdeserialize;
            TwoStepVerificationActivity.m0(TLdeserialize);
        }
        this.f33918n = this.v.getString("new_password");
    ...
    public final void n() {
        EditTextBoldCursor[] editTextBoldCursorArr;
        int i10;
        this.f33916c.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.G6, false));
        this.d.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.D6, false));
        for (EditTextBoldCursor editTextBoldCursor : this.f33915b) {
    ...
    public final void o(String str, String str2) {
        ...
        if (!TextUtils.isEmpty(str)) {
            ...
            passwordinputsettings.new_algo = this.f33920s.new_algo;
        }
