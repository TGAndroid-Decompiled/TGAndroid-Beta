...
public final class k extends pg.b {
    ...
    public final int j(int i10) {
        if (i10 >= 0) {
            l lVar = this.d;
            if (i10 < lVar.h.size()) {
                return ((j) lVar.h.get(i10)).f44072a;
            }
            return 0;
        }
        return 0;
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i10 >= 0 && i10 < arrayList.size()) {
            ...
            int i11 = i10 + 1;
            int i12 = 0;
            if (i11 < arrayList.size() && ((j) arrayList.get(i11)).f44072a == jVar.f44072a) {
                z10 = true;
            } else {
                z10 = false;
            }
            ...
            if (i13 == 0) {
                ((org.telegram.ui.Cells.l4) view).setText(jVar.f37460c);
            } else if (i13 == 2) {
                org.telegram.ui.Cells.e9 e9Var = (org.telegram.ui.Cells.e9) view;
                if (TextUtils.isEmpty(jVar.f37460c)) {
                    e9Var.setFixedSize(12);
                    e9Var.setText(null);
                    return;
                }
                e9Var.setFixedSize(0);
                e9Var.setText(jVar.f37460c);
            } else if (i13 == 1) {
