...
public final class k extends og.b {
    ...
    public final int j(int i10) {
        if (i10 >= 0) {
            l lVar = this.d;
            if (i10 < lVar.h.size()) {
                return ((j) lVar.h.get(i10)).f15508a;
            }
            return 0;
        }
        return 0;
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i10 >= 0 && i10 < arrayList.size()) {
            ...
            int i11 = i10 + 1;
            int i12 = 0;
            if (i11 < arrayList.size() && ((j) arrayList.get(i11)).f15508a == jVar.f15508a) {
                z10 = true;
            } else {
                z10 = false;
            }
            ...
            if (i13 == 0) {
                ((org.telegram.ui.Cells.m4) view).setText(jVar.f34291c);
            } else if (i13 == 2) {
                org.telegram.ui.Cells.f9 f9Var = (org.telegram.ui.Cells.f9) view;
                if (TextUtils.isEmpty(jVar.f34291c)) {
                    f9Var.setFixedSize(12);
                    f9Var.setText(null);
                    return;
                }
                f9Var.setFixedSize(0);
                f9Var.setText(jVar.f34291c);
            } else if (i13 == 1) {
