...
public final class ku extends FrameLayout {
    public final ImageView f35137a;
    public final TextView f35138b;
    public final ImageView f35139c;
    ...
    public ku(vu vuVar, Context context) {
        ...
        int i10;
        int i11;
        setBackgroundColor(vuVar.getThemedColor(org.telegram.ui.ActionBar.h6.f19045d6));
        ImageView imageView = new ImageView(context);
        this.f35137a = imageView;
        ...
        textView2.setTextColor(vuVar.getThemedColor(org.telegram.ui.ActionBar.h6.f19246o6));
