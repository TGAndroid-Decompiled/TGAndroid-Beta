...
public final class ku extends org.telegram.ui.Components.ll0 {
    ...
    public final int j(int i10) {
        ...
        if (i10 == dataAutoDownloadActivity.f30792s) {
            return 1;
        }
        if (i10 != dataAutoDownloadActivity.f30791r && i10 != dataAutoDownloadActivity.v) {
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        int i23;
        DataAutoDownloadActivity dataAutoDownloadActivity = this.d;
        int i24 = dataAutoDownloadActivity.f30789f;
        DownloadController.Preset preset = dataAutoDownloadActivity.G;
        int i25 = c1Var.f42705f;
        ...
        if (i25 != 0) {
                ...
                if (i25 != 3) {
                    ...
                    if (i25 != 4) {
                        if (i25 == 5) {
                            ...
                            if (i10 == dataAutoDownloadActivity.f30793w) {
                                e9Var.setText(LocaleController.getString(R.string.AutoDownloadAudioInfo));
                                e9Var.setFixedSize(0);
                                e9Var.setImportantForAccessibility(1);
                                return;
                            } else if (i10 == dataAutoDownloadActivity.f30790n) {
                                if (dataAutoDownloadActivity.f30791r == -1) {
                                    if (i24 == 0) {
            ...
            if (i10 == dataAutoDownloadActivity.f30791r) {
        ...
        if (i10 == i11) {
            ...
            if (preset.enabled) {
                i12 = org.telegram.ui.ActionBar.j6.f18899f6;
            } else {
                i12 = org.telegram.ui.ActionBar.j6.f18882e6;
            }
            w8Var.setTag(Integer.valueOf(i12));
            if (preset.enabled) {
                i13 = org.telegram.ui.ActionBar.j6.f18899f6;
            } else {
                i13 = org.telegram.ui.ActionBar.j6.f18882e6;
            }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
            ...
            if (i10 != 1) {
                if (i10 != 2) {
                    if (i10 != 3) {
                        ...
                        uv0Var2.setCallback(new gu(this, 1));
                        uv0Var = uv0Var2;
                    }
                } else {
        ...
        return com.google.android.gms.internal.vision.e2.k(uv0Var, uv0Var, -1, -2);
    }
}
