        ...
        switch (this.f39361a) {
            ...
            case 1:
                ...
                if (!zg1Var.M) {
                    int i10 = zg1Var.O;
                    if (i10 == 0) {
                        org.telegram.ui.Components.ij0 animatedDrawable = zg1Var.f40470a.getAnimatedDrawable();
                        if (zg1Var.f40484n.length() > 0) {
                            if (zg1Var.f40484n.getTransformationMethod() == null) {
                                org.telegram.ui.Components.ij0[] ij0VarArr = zg1Var.f40479f0;
                                if (animatedDrawable != ij0VarArr[3] && animatedDrawable != (ij0Var = ij0VarArr[5])) {
                                    zg1Var.f40470a.setAnimation(ij0Var);
                        ...
                        if (animatedDrawable != zg1Var.f40479f0[3] || zg1Var.f40484n.getTransformationMethod() != null) {
                            org.telegram.ui.Components.ij0[] ij0VarArr3 = zg1Var.f40479f0;
                            if (animatedDrawable != ij0VarArr3[5]) {
                                ij0VarArr3[2].P(-1);
                                org.telegram.ui.Components.ij0 ij0Var3 = zg1Var.f40479f0[2];
                                if (animatedDrawable != ij0Var3) {
                                    zg1Var.f40470a.setAnimation(ij0Var3);
