...
public final class u3 extends org.telegram.ui.Components.ov0 implements org.telegram.ui.ActionBar.k2, org.telegram.ui.ActionBar.v3 {
    ...
    public boolean G0;
    public final v3 H0;
    public final Paint f40908w0;
    public final Paint f40909x0;
    public final Paint f40910y0;
    public final Paint f40911z0;

    public u3(v3 v3Var, Context context) {
        super(context, null);
        this.H0 = v3Var;
        this.f40908w0 = new Paint(1);
        this.f40909x0 = new Paint(1);
        this.f40910y0 = new Paint(1);
        this.f40911z0 = new Paint(1);
        new Paint(1);
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        float min = Math.min(v3Var.f41402w, 1.0f - v3Var.f41403x);
        Paint paint = this.f40908w0;
        ...
        float max = Math.max(1.0f - v3Var.f41402w, v3Var.f41403x) * v3Var.k();
        canvas.save();
        ...
        int backgroundColor = i4Var.f37233u0[1].getBackgroundColor();
        Paint paint3 = this.f40910y0;
        paint3.setColor(backgroundColor);
        canvas.drawRect(rectF, paint3);
        paint3.setColor(i4Var.f37233u0[c10].getBackgroundColor());
        RectF rectF2 = AndroidUtilities.rectTmp;
        rectF2.set(rectF);
        rectF2.left = i4Var.f37233u0[c10].getX();
        ...
        if (e7 > 0.0f) {
            ...
            i4Var.f37221h0.a(canvas, org.telegram.messenger.w1.C(20.0f, l4, 1) - lerp2, e7, true);
            canvas.restore();
        }
        canvas.translate(0.0f, -max);
        if (!AndroidUtilities.makingGlobalBlurBitmap && (!i4Var.f37233u0[0].f() || canvas.isHardwareAccelerated())) {
    ...
    public final boolean onNestedPreFling(View view, float f7, float f10) {
        ...
        if (!i4Var.O0.y()) {
            ...
            if (m3Var.c()) {
                z10 = !m3Var.f38552b.canScrollVertically(-1);
            } else {
                z10 = false;
            }
            if (z10 && f10 < -1000.0f) {
        ...
        if (f7 != 0.0f || f10 != 0.0f) {
            ...
            AndroidUtilities.cancelRunOnUIThread(q9Var.f21775g0);
            q9Var.f21804z = false;
        }
        this.G0 = true;
    ...
    public final void onNestedPreScroll(View view, int i10, int i11, int[] iArr) {
        ...
        if (z10 && !i4Var.O0.y()) {
            iArr[1] = Math.min((int) (v3Var.k() * v3Var.f41403x), i11);
            v3Var.f41403x = Utilities.clamp(v3Var.f41403x - (i11 / v3Var.k()), 1.0f, 0.0f);
            v3Var.n();
            v3Var.h();
        }
        if (i10 == 0 && i11 == 0) {
    ...
    public final float z(Canvas canvas, RectF rectF, float f7, RectF rectF2, float f10) {
        ...
        Paint paint = this.f40908w0;
        paint.setColor(-16777216);
        paint.setAlpha((int) ((1.0f - v3Var.I) * Math.min(v3Var.f41402w, 1.0f - v3Var.f41403x) * f11 * 96.0f));
        canvas.drawRect(0.0f, 0.0f, getWidth(), getHeight(), paint);
        ...
        if (getChildCount() == 1) {
            ...
            if (v3Var.F) {
                i10 = i4Var.f37221h0.getMeasuredHeight();
            } else {
                i10 = 0;
            }
