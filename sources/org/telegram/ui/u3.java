...
public final class u3 implements org.telegram.ui.ActionBar.k2, org.telegram.ui.ActionBar.v3 {
    ...
    public boolean J;
    public final h4 K;
    public final AnimationNotificationsLocker f37919a = new AnimationNotificationsLocker();
    public org.telegram.ui.ActionBar.o2 f37920b;
    public final t3 f37921c;
    public View d;
    public org.telegram.ui.ActionBar.j3 e;
    public boolean f37922f;
    public boolean h;
    public boolean f37923n;
    public boolean f37924r;
    public boolean f37925s;
    public ai.e5 v;
    public float f37926w;
    public float f37927x;
    public ValueAnimator f37928y;
    ...
    public final org.telegram.ui.ActionBar.o3 a() {
        ...
        h4 h4Var = this.K;
        o3Var.E = h4Var.f34156h0.getTitle();
        o3Var.J = h4Var;
        l3 l3Var = h4Var.f34168u0[0];
        Bitmap bitmap = null;
        ...
        if (!this.F) {
            ...
            progress = h4Var.f34168u0[0].getProgress();
        }
        o3Var.I = progress;
        l3 l3Var3 = h4Var.f34168u0[0];
        o3Var.f19455c = l3Var3;
        if (l3Var3 != null && l3Var3.getWebView() != null) {
            bitmap = h4Var.f34168u0[0].getWebView().getFavicon();
        }
        o3Var.F = bitmap;
        l3 l3Var4 = o3Var.f19455c;
        if (l3Var4 != null) {
            o3Var.f19457g = l3Var4.getWidth();
            o3Var.h = o3Var.f19455c.getHeight();
        }
        o3Var.f19458i = l();
    ...
    public final boolean attachedToParent() {
        return this.f37921c.isAttachedToWindow();
    }
    ...
    public final void f() {
        ValueAnimator valueAnimator = this.f37928y;
        if (valueAnimator != null) {
            valueAnimator.cancel();
        }
        ValueAnimator ofFloat = ValueAnimator.ofFloat(this.f37926w, 1.0f);
        this.f37928y = ofFloat;
        ofFloat.addUpdateListener(new r3(this, 1));
        this.f37928y.addListener(new ai.b(this, 28));
        this.f37928y.setInterpolator(org.telegram.ui.Components.qr.h);
        this.f37928y.setDuration(320L);
        this.f37928y.start();
    }
    ...
    public final int getNavigationBarColor(int i10) {
        ...
        if (this.f37923n) {
            ...
            min = Math.min(this.f37926w, 1.0f - this.f37927x) * (1.0f - this.I);
        }
        int j3 = j();
        k0 k0Var = this.K.f34156h0;
        if (k0Var != null) {
            j3 = i0.a.d(k0Var.f38950a0, j3, k0Var.f38979x);
        }
    ...
    public final void h() {
        if (this.f37925s != isFullyVisible()) {
            this.f37925s = isFullyVisible();
            org.telegram.ui.ActionBar.o2 o2Var = this.f37920b;
            if (o2Var != null && (o2Var.getParentLayout() instanceof ActionBarLayout)) {
                ActionBarLayout actionBarLayout = (ActionBarLayout) this.f37920b.getParentLayout();
                org.telegram.ui.ActionBar.x xVar = actionBarLayout.f18424s;
                if (xVar != null) {
                    xVar.invalidate();
                }
                org.telegram.ui.ActionBar.x xVar2 = actionBarLayout.f18429w;
                if (xVar2 != null) {
                    xVar2.invalidate();
                    return;
                }
    ...
    public final void i() {
        ...
        boolean z10 = false;
        if (j3Var2 != null) {
            int navigationBarColor = j3Var2.f18780a.getNavigationBarColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18806a7, false));
            j3Var2.d.setColor(navigationBarColor);
            j3Var2.f18782c.invalidate();
        ...
        LaunchActivity.G1.H(true, true, true);
        if (AndroidUtilities.computePerceivedBrightness(getNavigationBarColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18806a7, false))) >= 0.721f) {
            z10 = true;
        }
    ...
    public final boolean isAttachedLightStatusBar() {
        ...
        if (this.f37923n) {
            ...
            min = (1.0f - this.I) * Math.min(this.f37926w, 1.0f - this.f37927x);
        }
        if (this.F && min > 0.25f) {
            if (!SharedConfig.adaptableColorInBrowser) {
                ...
                h4 h4Var = this.K;
                if (h4Var.f34168u0[0].getVisibility() == 0) {
                    f7 = 1.0f - (h4Var.f34168u0[0].getTranslationX() / h4Var.f34168u0[0].getWidth());
                }
                d = i0.a.d(1.0f - f7, h4Var.f34168u0[0].getActionBarColor(), h4Var.f34168u0[1].getActionBarColor());
            }
    ...
    public final boolean isFullyVisible() {
        if (this.G && this.f37927x <= 0.0f && this.f37926w >= 1.0f && this.I <= 0.0f && !this.f37923n && !this.h) {
            return true;
        }
        return false;
    }
    ...
    public final boolean isShown() {
        t3 t3Var;
        if (this.h || this.f37924r || this.f37926w <= 0.5f || (t3Var = this.f37921c) == null || !t3Var.isAttachedToWindow() || AndroidUtilities.lerp(t3Var.H0.l() - AndroidUtilities.dp(20.0f), 0, Utilities.clamp01(t3Var.A0.f22937c)) >= t3Var.getHeight() || this.I >= 1.0f) {
            return false;
        }
        return true;
    }
    ...
    public final int j() {
        ...
        if (h4Var.f34168u0[0].getVisibility() != 0) {
            ...
            translationX = 1.0f - (h4Var.f34168u0[0].getTranslationX() / h4Var.f34168u0[0].getWidth());
        }
        return i0.a.d(1.0f - translationX, h4Var.f34168u0[0].getBackgroundColor(), h4Var.f34168u0[1].getBackgroundColor());
    }
    ...
    public final int l() {
        ...
        if (l3Var2 != null && l3Var2.getVisibility() == 0) {
            i10 = (int) (h4Var.f34168u0[0].getAlpha() * h4Var.f34168u0[0].getListTop() * f7);
        }
        l3 l3Var3 = h4Var.f34168u0[1];
        if (l3Var3 != null && l3Var3.getVisibility() == 0) {
            return i10 + ((int) (h4Var.f34168u0[1].getAlpha() * h4Var.f34168u0[1].getListTop() * f10));
        }
        return i10;
    }
    ...
    public final void m() {
        h4 h4Var = this.K;
        h4Var.f34168u0[0].setLastVisible(this.J);
        h4Var.f34168u0[1].setLastVisible(false);
    }
    ...
    public final boolean onAttachedBackPressed() {
        h4 h4Var = this.K;
        if (h4Var.f34162o0) {
            AndroidUtilities.hideKeyboard(this.f37921c);
            return true;
        }
        k0 k0Var = h4Var.f34156h0;
        if (k0Var.T) {
            k0Var.h(false);
            return true;
        } else if (k0Var.W) {
    ...
    public final void release() {
        ...
        if (o2Var != null) {
            ...
            if (this.e == null) {
                AndroidUtilities.removeFromParent(this.f37921c);
            }
        }
        ai.e5 e5Var = this.v;
        if (e5Var != null) {
    ...
    public final void setLastVisible(boolean z10) {
        this.J = z10;
        h4 h4Var = this.K;
        h4Var.f34168u0[0].setLastVisible(z10);
        h4Var.f34168u0[1].setLastVisible(false);
    }
