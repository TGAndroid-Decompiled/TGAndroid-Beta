...
public final class dq extends s4.h0 {
    ...
    public final int h() {
        eq eqVar = this.d;
        ArrayList arrayList = eqVar.f36143r;
        int i10 = 0;
        if (eqVar.G) {
            if (!eqVar.d.isEmpty()) {
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (eqVar.G) {
            if (ChatObject.isChannelAndNotMegaGroup(eqVar.f36137a)) {
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 != 0) {
            if (i10 != 1) {
                ...
                eq eqVar = this.d;
                if (eqVar.f36144s.getParent() != null) {
                    ((ViewGroup) eqVar.f36144s.getParent()).removeView(eqVar.f36144s);
                }
                frameLayout.addView(eqVar.f36144s);
