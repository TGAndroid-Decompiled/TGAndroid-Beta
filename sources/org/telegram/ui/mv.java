...
public final class mv extends FrameLayout {
    ...
    public int d;
    public int e;
    public VelocityTracker f35843f;
    public boolean h;
    public final ov f35844n;
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        if (!a() && !this.f35844n.e.H && !onTouchEvent(motionEvent)) {
            return false;
        }
        return true;
    }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent != null) {
            if (this.f35843f == null) {
                this.f35843f = VelocityTracker.obtain();
            }
            this.f35843f.addMovement(motionEvent);
        }
        if (motionEvent != null && motionEvent.getAction() == 0 && !this.f35841b && !this.f35842c) {
            this.f35840a = motionEvent.getPointerId(0);
            this.f35842c = true;
            this.d = (int) motionEvent.getX();
            this.e = (int) motionEvent.getY();
            this.f35843f.clear();
        } else if (motionEvent != null && motionEvent.getAction() == 2 && motionEvent.getPointerId(0) == this.f35840a) {
            int x10 = (int) (motionEvent.getX() - this.d);
            int abs = Math.abs(((int) motionEvent.getY()) - this.e);
            if (this.f35841b && (((z12 = ovVar.f36415r) && x10 > 0) || (!z12 && x10 < 0))) {
                if (x10 < 0) {
                    z13 = true;
                } else {
                    z13 = false;
                ...
                if (!b(motionEvent, z13)) {
                    ...
                    ovVar.e.j(0.0f, nvVarArr[1].f36155f);
                }
            }
            if (this.f35842c && !this.f35841b) {
                ...
                ovVar.e.j(Math.abs(x10) / nvVarArr[0].getMeasuredWidth(), nvVarArr[1].f36155f);
            }
        } else if (motionEvent == null || (motionEvent.getPointerId(0) == this.f35840a && (motionEvent.getAction() == 3 || motionEvent.getAction() == 1 || motionEvent.getAction() == 6))) {
            this.f35843f.computeCurrentVelocity(1000, ovVar.v);
            if (motionEvent != null && motionEvent.getAction() != 3) {
                f7 = this.f35843f.getXVelocity();
                f10 = this.f35843f.getYVelocity();
                if (!this.f35841b && Math.abs(f7) >= 3000.0f && Math.abs(f7) > Math.abs(f10)) {
                    if (f7 < 0.0f) {
                        z11 = true;
                    } else {
                        z11 = false;
            ...
            if (this.f35841b) {
                ...
                ovVar.h.setInterpolator(ov.f36409x);
            ...
            VelocityTracker velocityTracker = this.f35843f;
