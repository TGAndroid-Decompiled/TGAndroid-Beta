...
public final class d1 extends FrameLayout implements org.telegram.ui.Cells.p9 {
    ...
    public final p70 f32857a;
    public final g4 f32858b;
    public final org.telegram.ui.Components.vq f32859c;
    public final TextView d;
    public final ImageView e;
    public int f32860f;
    public b3 h;
    public int f32861n;
    public final int f32862r;
    public final int f32863s;
    public int v;
    public final Paint f32864w;
    public AnimatorSet f32865x;
    public final int f32866y;

    public d1(Context context, p70 p70Var, g4 g4Var, int i10) {
        super(context);
        this.f32862r = AndroidUtilities.dp(18.0f);
        this.f32863s = AndroidUtilities.dp(11.0f);
        this.f32857a = p70Var;
        this.f32858b = g4Var;
        setWillNotDraw(false);
        this.f32864w = new Paint();
        this.f32866y = i10;
    ...
    public final void a(int i10, boolean z10) {
        ...
        float f25;
        float f26;
        AnimatorSet animatorSet = this.f32865x;
        if (animatorSet != null) {
            animatorSet.cancel();
        }
        this.f32860f = i10;
        ImageView imageView = this.e;
        org.telegram.ui.Components.vq vqVar = this.f32859c;
        TextView textView = this.d;
        if (z10) {
            AnimatorSet animatorSet2 = new AnimatorSet();
            this.f32865x = animatorSet2;
            if (i10 == 0) {
                f18 = 1.0f;
            } else {
                f18 = 0.0f;
    ...
    public final void onDraw(Canvas canvas) {
        if (this.E != null) {
            canvas.drawRect(0.0f, 0.0f, getMeasuredWidth(), AndroidUtilities.dp(39.0f), this.f32864w);
            b3 b3Var = this.h;
            if (b3Var != null && b3Var.d.getLineCount() > 0) {
                canvas.save();
                int i10 = this.f32863s;
                int i11 = this.f32862r;
                g4 g4Var = this.f32858b;
                ...
                if (this.f32866y == 0) {
                    i4.v(this.f32857a, canvas, this, 0);
                }
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        accessibilityNodeInfo.setText(i4.i(R.string.AccDescrChannel, i4.j(this.f32857a, this.f32858b, b3Var)));
    }

    @Override
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        int dp = ((this.f32861n / 2) + this.v) - AndroidUtilities.dp(19.0f);
        int i14 = this.v;
        int dp2 = AndroidUtilities.dp(20.0f);
        int dp3 = AndroidUtilities.dp(39.0f);
        this.e.layout(dp, 0, dp2 + (this.f32861n / 2) + i14, dp3);
        this.f32859c.layout(((this.f32861n / 2) + this.v) - AndroidUtilities.dp(19.0f), 0, AndroidUtilities.dp(20.0f) + (this.f32861n / 2) + this.v, AndroidUtilities.dp(39.0f));
        int i15 = this.v;
        TextView textView = this.d;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f32861n = textView.getMeasuredWidth();
        this.f32859c.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(39.0f), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(39.0f), 1073741824));
        ...
        if (pageblockchannel != null) {
            ...
            int dp = (size - AndroidUtilities.dp(52.0f)) - this.f32861n;
            TL_iv.pageBlockChannel pageblockchannel2 = this.E;
            Layout.Alignment[] alignmentArr = org.telegram.ui.Components.vw0.f29777a;
            ...
            this.h = i4.p(this.f32857a, this, str, null, dp, this.f32863s, pageblockchannel2, alignment2, 1, this.f32858b);
            int i12 = this.f32862r;
            g4 g4Var = this.f32858b;
            if (g4Var != null && g4Var.G) {
                this.v = i12;
            } else {
                this.v = (getMeasuredWidth() - i12) - this.f32861n;
            }
            b3 b3Var = this.h;
            if (b3Var != null) {
                b3Var.f32303s = i12;
                b3Var.v = this.f32863s;
            }
        }
    }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (!i4.l(this.f32857a, this.f32858b, motionEvent, this, this.h, this.f32862r, this.f32863s) && !super.onTouchEvent(motionEvent)) {
            return false;
        }
        return true;
    }
    ...
    public void setBlock(TL_iv.pageBlockChannel pageblockchannel) {
        ...
        int i10 = this.f32866y;
        ImageView imageView = this.e;
        Paint paint = this.f32864w;
        TextView textView = this.d;
        p70 p70Var = this.f32857a;
        if (i10 == 0) {
        ...
        if (chat != null && !chat.min) {
            ...
            if (!p70Var.f36423r && ChatObject.isPublic(chat2)) {
                p70Var.f36423r = true;
                int i12 = ((i4) p70Var).X;
                TLRPC.TL_contacts_resolveUsername tL_contacts_resolveUsername = new TLRPC.TL_contacts_resolveUsername();
                tL_contacts_resolveUsername.username = chat2.username;
                ConnectionsManager.getInstance(i12).sendRequest(tL_contacts_resolveUsername, new ai.za(p70Var, this.f32858b, i12, this, 2));
            }
            a(1, false);
        }
        requestLayout();
