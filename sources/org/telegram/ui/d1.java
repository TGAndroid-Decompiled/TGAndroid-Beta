...
public final class d1 extends FrameLayout implements org.telegram.ui.Cells.p9 {
    ...
    public final v70 f35617a;
    public final g4 f35618b;
    public final org.telegram.ui.Components.sq f35619c;
    public final TextView d;
    public final ImageView f35620e;
    public int f35621f;
    public b3 h;
    public int f35622n;
    public final int f35623r;
    public final int f35624s;
    public int v;
    public final Paint f35625w;
    public AnimatorSet f35626x;
    public final int f35627y;

    public d1(Context context, v70 v70Var, g4 g4Var, int i10) {
        super(context);
        this.f35623r = AndroidUtilities.dp(18.0f);
        this.f35624s = AndroidUtilities.dp(11.0f);
        this.f35617a = v70Var;
        this.f35618b = g4Var;
        setWillNotDraw(false);
        this.f35625w = new Paint();
        this.f35627y = i10;
    ...
    public final void a(int i10, boolean z10) {
        ...
        float f25;
        float f26;
        AnimatorSet animatorSet = this.f35626x;
        if (animatorSet != null) {
            animatorSet.cancel();
        }
        this.f35621f = i10;
        ImageView imageView = this.f35620e;
        org.telegram.ui.Components.sq sqVar = this.f35619c;
        TextView textView = this.d;
        if (z10) {
            AnimatorSet animatorSet2 = new AnimatorSet();
            this.f35626x = animatorSet2;
            if (i10 == 0) {
                f18 = 1.0f;
            } else {
                f18 = 0.0f;
    ...
    public final void onDraw(Canvas canvas) {
        if (this.E != null) {
            canvas.drawRect(0.0f, 0.0f, getMeasuredWidth(), AndroidUtilities.dp(39.0f), this.f35625w);
            b3 b3Var = this.h;
            if (b3Var != null && b3Var.d.getLineCount() > 0) {
                canvas.save();
                int i10 = this.f35624s;
                int i11 = this.f35623r;
                g4 g4Var = this.f35618b;
                ...
                if (this.f35627y == 0) {
                    i4.v(this.f35617a, canvas, this, 0);
                }
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        accessibilityNodeInfo.setText(i4.i(R.string.AccDescrChannel, i4.j(this.f35617a, this.f35618b, b3Var)));
    }

    @Override
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        int dp = ((this.f35622n / 2) + this.v) - AndroidUtilities.dp(19.0f);
        int i14 = this.v;
        int dp2 = AndroidUtilities.dp(20.0f);
        int dp3 = AndroidUtilities.dp(39.0f);
        this.f35620e.layout(dp, 0, dp2 + (this.f35622n / 2) + i14, dp3);
        this.f35619c.layout(((this.f35622n / 2) + this.v) - AndroidUtilities.dp(19.0f), 0, AndroidUtilities.dp(20.0f) + (this.f35622n / 2) + this.v, AndroidUtilities.dp(39.0f));
        int i15 = this.v;
        TextView textView = this.d;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f35622n = textView.getMeasuredWidth();
        this.f35619c.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(39.0f), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(39.0f), 1073741824));
        this.f35620e.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(39.0f), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(39.0f), 1073741824));
        TL_iv.pageBlockChannel pageblockchannel = this.E;
        if (pageblockchannel != null) {
            String str = pageblockchannel.channel.title;
            int dp = (size - AndroidUtilities.dp(52.0f)) - this.f35622n;
            TL_iv.pageBlockChannel pageblockchannel2 = this.E;
            Layout.Alignment[] alignmentArr = org.telegram.ui.Components.iw0.f27307a;
            ...
            this.h = i4.p(this.f35617a, this, str, null, dp, this.f35624s, pageblockchannel2, alignment2, 1, this.f35618b);
            int i12 = this.f35623r;
            g4 g4Var = this.f35618b;
            if (g4Var != null && g4Var.G) {
                this.v = i12;
            } else {
                this.v = (getMeasuredWidth() - i12) - this.f35622n;
            }
            b3 b3Var = this.h;
            if (b3Var != null) {
                b3Var.f34645s = i12;
                b3Var.v = this.f35624s;
            }
        }
    }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (!i4.l(this.f35617a, this.f35618b, motionEvent, this, this.h, this.f35623r, this.f35624s) && !super.onTouchEvent(motionEvent)) {
            return false;
        }
        return true;
    }
    ...
    public void setBlock(TL_iv.pageBlockChannel pageblockchannel) {
        ...
        ImageView imageView = this.f35620e;
        Paint paint = this.f35625w;
        TextView textView = this.d;
        v70 v70Var = this.f35617a;
        if (i10 == 0) {
        ...
        if (chat != null && !chat.min) {
            ...
            if (!v70Var.f41467r && ChatObject.isPublic(chat2)) {
                v70Var.f41467r = true;
                int i12 = ((i4) v70Var).X;
                TLRPC.TL_contacts_resolveUsername tL_contacts_resolveUsername = new TLRPC.TL_contacts_resolveUsername();
                tL_contacts_resolveUsername.username = chat2.username;
                ConnectionsManager.getInstance(i12).sendRequest(tL_contacts_resolveUsername, new bi.ga(v70Var, this.f35618b, i12, this, 2));
            }
            a(1, false);
        }
        requestLayout();
