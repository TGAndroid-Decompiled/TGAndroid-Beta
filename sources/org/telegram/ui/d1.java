...
public final class d1 extends s4.n0 {
    ...
    public final void a(Rect rect, View view, RecyclerView recyclerView, s4.z0 z0Var) {
        ...
        j1 j1Var = this.f32981a;
        if (z10) {
            groupedMessagePosition = (MessageObject.GroupedMessagePosition) j1Var.v.f34407b.get(((c2) view).N);
        } else if (view instanceof w2) {
            groupedMessagePosition = (MessageObject.GroupedMessagePosition) j1Var.v.f34407b.get(((w2) view).L);
        } else {
        ...
        if (groupedMessagePosition != null && groupedMessagePosition.siblingHeights != null) {
            ...
            while (true) {
                if (i10 < size) {
                    MessageObject.GroupedMessagePosition groupedMessagePosition2 = (MessageObject.GroupedMessagePosition) j1Var.v.f34406a.get(i10);
