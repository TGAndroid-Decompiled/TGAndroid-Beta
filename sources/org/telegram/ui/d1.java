...
public final class d1 extends s4.n0 {
    ...
    public final void a(Rect rect, View view, RecyclerView recyclerView, s4.z0 z0Var) {
        ...
        j1 j1Var = this.f32890a;
        if (z10) {
            groupedMessagePosition = (MessageObject.GroupedMessagePosition) j1Var.v.f34376b.get(((c2) view).N);
        } else if (view instanceof w2) {
            groupedMessagePosition = (MessageObject.GroupedMessagePosition) j1Var.v.f34376b.get(((w2) view).L);
        } else {
        ...
        if (groupedMessagePosition != null && groupedMessagePosition.siblingHeights != null) {
            ...
            while (true) {
                if (i10 < size) {
                    MessageObject.GroupedMessagePosition groupedMessagePosition2 = (MessageObject.GroupedMessagePosition) j1Var.v.f34375a.get(i10);
                    ...
                    if (b10 == b11 && ((groupedMessagePosition2.minX != groupedMessagePosition.minX || groupedMessagePosition2.maxX != groupedMessagePosition.maxX || b10 != b11 || groupedMessagePosition2.maxY != groupedMessagePosition.maxY) && b10 == b11)) {
                        dp2 = org.telegram.messenger.w1.z(4.0f, (int) Math.ceil(max * groupedMessagePosition2.f15600ph), dp2);
                        break;
                    }
                    i10++;
                } else {
