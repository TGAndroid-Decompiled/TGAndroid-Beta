...
public final class uq implements Utilities.Callback {
    ...
    public final void run(Object obj) {
        ...
        Object obj2 = this.f38546g;
        Object obj3 = this.f38545f;
        Object obj4 = this.e;
        Object obj5 = this.d;
        switch (i10) {
            case 0:
                ...
                xqVar.X0 = new yq(prVar, intValue, j10, this.f38543b, z10, zArr);
            ...
            default:
                ...
                tL_messages_toggleBotInAttachMenu.bot = MessagesController.getInstance(i13).getInputUser(this.f38544c);
    ...
    public uq(pr prVar, long j3, int i10, TLObject tLObject, TLRPC.TL_chatAdminRights tL_chatAdminRights, TLRPC.TL_chatBannedRights tL_chatBannedRights, String str, boolean z10) {
        ...
        this.f38543b = i10;
        this.e = tLObject;
        this.f38545f = tL_chatAdminRights;
        this.f38546g = tL_chatBannedRights;
        this.h = str;
    }
