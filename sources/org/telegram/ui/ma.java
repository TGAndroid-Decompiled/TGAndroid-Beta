...
public final class ma implements RequestDelegate {
    ...
    public final ob f40503b;

    public ma(ob obVar, int i10) {
        this.f40502a = i10;
        this.f40503b = obVar;
    }
    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        switch (this.f40502a) {
            ...
            case 2:
                ...
                return;
            case 3:
                AndroidUtilities.runOnUIThread(new org.telegram.ui.ActionBar.c(20, this.f40503b, tLObject));
                return;
            default:
                if (tLObject != null) {
                    final TLRPC.TL_channels_adminLogResults tL_channels_adminLogResults2 = (TLRPC.TL_channels_adminLogResults) tLObject;
                    final ob obVar3 = this.f40503b;
                    AndroidUtilities.runOnUIThread(new Runnable() {
                        @Override
                        public final void run() {
                            switch (r3) {
