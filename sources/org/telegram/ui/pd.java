    ...
    public final void onClick(View view) {
        switch (this.f36543a) {
            case 0:
                ...
                if (view.isEnabled()) {
                    ...
                    if (!dVar.N) {
                        ...
                        tL_payments_getStarsRevenueAdsAccountUrl.peer = MessagesController.getInstance(i10).getInputPeer(this.f36545c);
            ...
            default:
                ...
                ConnectionsManager.getInstance(i11).sendRequest(createconferencecall, new ai.j8(i11, dVar2, f3Var, this.f36545c));
                return;
        }
    }
