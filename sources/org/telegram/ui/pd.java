    ...
    public final void onClick(View view) {
        switch (this.f36498a) {
            case 0:
                ...
                if (view.isEnabled()) {
                    ...
                    if (!dVar.N) {
                        ...
                        tL_payments_getStarsRevenueAdsAccountUrl.peer = MessagesController.getInstance(i10).getInputPeer(this.f36500c);
            ...
            default:
                ...
                ConnectionsManager.getInstance(i11).sendRequest(createconferencecall, new ai.k8(i11, dVar2, e3Var, this.f36500c));
                return;
        }
    }
