...
public final class mb1 extends org.telegram.ui.Components.sl0 {
    ...
    public final ThemeActivity f39073e;

    public mb1(ThemeActivity themeActivity, Context context) {
        this.f39073e = themeActivity;
    ...
    public final int j(int i10) {
        ...
        int i23;
        int i24;
        ThemeActivity themeActivity = this.f39073e;
    ...
    public final void v(f2.m1 m1Var, int i10) {
        ...
        if (i24 != 1) {
            if (i24 != 2) {
                if (i24 != 4) {
                    if (i24 != 5) {
                        if (i24 != 6) {
                            if (i24 != 7) {
                                            ...
                                            if (i24 != 21) {
                                                switch (i24) {
                                                    case 10:
                                                        ...
                                                        if (z10) {
                                                            int i25 = org.telegram.ui.ActionBar.k6.f21850o;
                                                            if (i25 == 1) {
                                                    ...
                                                    case 11:
                                                        if (this.d) {
                                                            themeActivity.f34874c.x1(themeActivity.f34872b.getMeasuredWidth());
                                                            this.d = false;
                                                            return;
                                                        }
                                                        return;
                                                    case 12:
                                                        ...
                                                        ob1Var.l();
                                                        int indexOf = ob1Var.f39715e.indexOf(ob1Var.d.k(false));
                                                        if (indexOf == -1) {
                                                            indexOf = ob1Var.h() - 1;
                                                        }
                                                        if (indexOf != -1) {
                                                            ((f2.j0) tl0Var.getLayoutManager()).h1(indexOf, (themeActivity.f34872b.getMeasuredWidth() / 2) - AndroidUtilities.dp(42.0f));
                                                            return;
                                                        }
                                                        return;
                                                    default:
                                ...
                                if (i10 == i17) {
                                    ...
                                    int i26 = org.telegram.ui.ActionBar.k6.f21894q6;
                                    o8Var.e(i26, i26);
                                    ...
                                    o8Var.setSubtitle(null);
                                    int i28 = org.telegram.ui.ActionBar.k6.f21894q6;
                                    o8Var.e(i28, i28);
                                    o8Var.m(R.drawable.msg_colors, LocaleController.getString(R.string.CreateNewTheme), false);
                                    return;
                                } else {
                                    o8Var.setSubtitle(null);
                                    int i29 = org.telegram.ui.ActionBar.k6.f21894q6;
                                    o8Var.e(i29, i29);
                            ...
                            if (i10 == themeActivity.U) {
                                s8Var.f(LocaleController.getString("AutoNightLocation", R.string.AutoNightLocation), org.telegram.ui.ActionBar.k6.f21868p, true);
                                return;
                        ...
                        ((org.telegram.ui.Cells.k0) view).setProgress(org.telegram.ui.ActionBar.k6.f21887q);
                        return;
                    }
            ...
            if (i10 == themeActivity.f34875c0) {
                a9Var.setText(LocaleController.formatString("AutoNightBrightnessInfo", R.string.AutoNightBrightnessInfo, Integer.valueOf((int) (org.telegram.ui.ActionBar.k6.f21887q * 100.0f))));
                return;
        ...
        if (i10 == i11) {
            if (org.telegram.ui.ActionBar.k6.f21850o != 0 && org.telegram.ui.ActionBar.k6.J != null) {
            ...
            int i30 = org.telegram.ui.ActionBar.k6.f21905r;
            int i31 = i30 / 60;
            ...
            int i32 = org.telegram.ui.ActionBar.k6.f21922s;
            int i33 = i32 / 60;
            ...
            aaVar.c(LocaleController.getString("AutoNightUpdateLocation", R.string.AutoNightUpdateLocation), org.telegram.ui.ActionBar.k6.f21991w, false, false);
            ...
            aaVar.c(LocaleController.getString(R.string.SearchEngine), org.telegram.ui.web.m1.a().f42638a, themeActivity.M0, false);
    ...
    public final f2.m1 x(ViewGroup viewGroup, int i10) {
        ...
        switch (i10) {
            ...
            case 8:
                ...
                break;
            case 9:
                frameLayout = new ib1(context);
                frameLayout.f37793b = new org.telegram.ui.Cells.x0[2];
                ...
                int i21 = 0;
                while (true) {
                    ?? r32 = (org.telegram.ui.Cells.x0[]) frameLayout.f37793b;
                    if (i21 >= r32.length) {
                        j5Var = frameLayout;
                        break;
                    } else {
                        ...
                        frameLayout2.f24388c = new RectF();
                        TextPaint textPaint = new TextPaint(1);
                        frameLayout2.d = textPaint;
                        frameLayout2.setWillNotDraw(false);
                        frameLayout2.f24387b = z4;
                        if (z4) {
                        ...
                        org.telegram.ui.Cells.x0 x0Var = ((org.telegram.ui.Cells.x0[]) frameLayout.f37793b)[i21];
                        if (i21 == 1) {
                            i14 = 10;
                        } else {
                            i14 = 0;
                        ...
                        ((org.telegram.ui.Cells.x0[]) frameLayout.f37793b)[i21].setOnClickListener(new oh.b2(3, frameLayout, z4));
                        i21++;
                    }
                }
                break;
            case 10:
                j5Var = new org.telegram.ui.Cells.j5(21, 60, this.f39072c, null, true);
                break;
            case 11:
                this.d = true;
                jb1 jb1Var = new jb1(this, this.f39072c, themeActivity, themeActivity.f34879f, themeActivity.f34877e, themeActivity.d);
                themeActivity.f34874c = jb1Var;
                ...
                break;
            case 12:
                kb1 kb1Var = new kb1(context, 0, null);
            ...
            case 15:
                ...
                frameLayout3.f33201a = paint;
                frameLayout3.f33202b = new Paint(1);
                Paint paint2 = new Paint(1);
                frameLayout3.f33203c = paint2;
                Paint paint3 = new Paint(1);
                frameLayout3.d = paint3;
                frameLayout3.f33204e = new RectF();
                int i22 = 6;
                frameLayout3.h = r14;
                frameLayout3.f33206n = r15;
                frameLayout3.f33207r = new org.telegram.ui.Components.ij0[6];
                frameLayout3.v = new org.telegram.ui.Components.lj0[2];
                float f12 = 1.0f;
                frameLayout3.f33210x = 1.0f;
                ...
                int i23 = org.telegram.ui.ActionBar.k6.f21644c9;
                int[] iArr = {i23, i23, i23, i23, org.telegram.ui.ActionBar.k6.Y5, org.telegram.ui.ActionBar.k6.f21662d9};
                ...
                org.telegram.ui.Components.wy0 wy0Var = new org.telegram.ui.Components.wy0(frameLayout3, context);
                frameLayout3.f33205f = wy0Var;
                ...
                wy0Var.setMaxValue(i18);
                if (isEmpty) {
                    i22 = 5;
                }
                wy0Var.setAllItemsCount(i22);
                wy0Var.setWrapSelectorWheel(true);
                wy0Var.setFormatter(new org.telegram.ui.Components.vy0(frameLayout3));
                wy0Var.setOnValueChangedListener(new org.telegram.ui.Components.vy0(frameLayout3));
                wy0Var.setImportantForAccessibility(2);
                wy0Var.setValue(SharedConfig.getChatSwipeAction(i15));
                frameLayout3.addView(wy0Var, k7.c6.d(132, -1.0f, 5, 21.0f, 0.0f, 21.0f, 0.0f));
                frameLayout3.setWillNotDraw(false);
                frameLayout3.f33208s = 0;
                ...
                org.telegram.ui.Components.ij0 a2 = frameLayout3.a(frameLayout3.f33205f.getValue());
                if (a2 != null) {
                ...
                if (frameLayout3.f33205f.getValue() != 5) {
                    f12 = 0.0f;
                }
                frameLayout3.f33209w = f12;
                frameLayout3.C = frameLayout3.f33205f.getValue();
                j5Var = frameLayout3;
                break;
            case 16:
            ...
            case 20:
                ...
                ?? tl0Var = new org.telegram.ui.Components.tl0(context, null);
                tl0Var.U2 = new ArrayList();
                tl0Var.W2 = i16;
                tl0Var.setPadding(0, AndroidUtilities.dp(12.0f), 0, AndroidUtilities.dp(12.0f));
                tl0Var.setFocusable(false);
                tl0Var.setItemAnimator(null);
                tl0Var.setLayoutAnimation(null);
                f2.j0 j0Var2 = new f2.j0(0, false);
                tl0Var.V2 = j0Var2;
                tl0Var.setLayoutManager(j0Var2);
                tl0Var.setAdapter(new y7(tl0Var, 1));
                tl0Var.i(new hg.e2(tl0Var, 1));
                tl0Var.setOnItemClickListener(new oh.d0(tl0Var, themeActivity, context, 1));
                tl0Var.w1();
                j5Var = tl0Var;
                break;
            case 21:
                i17 = ((org.telegram.ui.ActionBar.p2) themeActivity).currentAccount;
                frameLayout = new qo0(i17, 0L, this.f39072c, themeActivity.getResourceProvider());
                j5Var = frameLayout;
                break;
        }
    ...
    public final void y(f2.m1 m1Var) {
        ...
        if (m1Var.f5879f == 4) {
            ...
            if (m1Var.b() == org.telegram.ui.ActionBar.k6.f21850o) {
                z4 = true;
            } else {
                z4 = false;
            }
