...
public final class e41 extends org.telegram.ui.Components.wl0 {
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i11 == 0) {
            ...
            if (i10 == 1) {
                ...
                w8Var.f(LocaleController.getString(R.string.RoundVideoCompositionEnabled), pi.e.f41361g.a(), false);
            }
        } else if (i11 == 2) {
            org.telegram.ui.Cells.ea eaVar = (org.telegram.ui.Cells.ea) view;
            eaVar.setEnabled(a2);
            if (i10 == 2) {
                eaVar.c(LocaleController.getString(R.string.RoundVideoOutputResolution), a4.a.o(((ki.q0) pi.e.f41359c.a()).f13831a, "p", new StringBuilder()), false, true);
            } else if (i10 == 3) {
                ...
                eaVar.c(LocaleController.getString(R.string.RoundVideoBitrate), f41.U(pi.e.f41360f.a()), false, false);
            }
        } else {
