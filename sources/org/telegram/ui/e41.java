...
public abstract class e41 extends FrameLayout {
    ...
    public AnimationNotificationsLocker f32798n;
    public boolean f32799r;
    public int f32800s;
    public boolean v;
    public org.telegram.ui.ActionBar.c5 f32801w;
    public o1.k f32802x;
    public float f32803y;
    ...
    public final void b() {
        ...
        if (!SharedConfig.animationsEnabled()) {
            this.e = 0.0f;
            g();
            sx sxVar = this.f32794a;
            if (sxVar != null) {
                sxVar.onPause();
                this.f32794a.onFragmentDestroy();
                removeAllViews();
                this.f32794a = null;
        ...
        this.h.addListener(new d41(this, 0));
        this.h.setDuration(250L);
        this.h.setInterpolator(org.telegram.ui.Components.rr.f27701f);
        this.h.start();
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        float f10;
        if (this.v) {
            f(this.E, this.f32794a, this.f32803y);
            invalidate();
        }
        ...
        if (this.f32794a != null && this.d != null && max > 0.0f) {
            if (this.P == null) {
                this.P = new Paint();
            }
            this.P.setColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19138w8, false));
            if (max == 1.0f) {
                canvas.save();
            } else {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (view != null) {
            ...
            layoutParams.topMargin = org.telegram.ui.ActionBar.k.getCurrentActionBarHeight() + i12 + this.f32800s;
        }
        org.telegram.ui.ActionBar.k kVar = this.d;
        if (kVar != null) {
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        org.telegram.ui.ActionBar.c5 c5Var = this.f32801w;
        ...
        if (motionEvent != null && motionEvent.getAction() == 0) {
            ...
            if (this.I) {
                ...
                if (f10 < getMeasuredWidth() / 3.0f && (xVelocity < 3500.0f || xVelocity < yVelocity)) {
                    ...
                    this.h.addListener(new d41(this, 1));
                    this.h.setDuration(250L);
                    this.h.setInterpolator(org.telegram.ui.Components.rr.f27701f);
                    this.h.start();
                } else {
    ...
    public void setCurrentTop(int i10) {
        ...
        View view = this.f32795b;
        if (view != null) {
            view.setTranslationY((i10 - view.getTop()) + this.f32800s);
        }
        k0 k0Var = this.f32796c;
        if (k0Var != null) {
    ...
    public void setTransitionPaddingBottom(int i10) {
        ...
        if (com.google.android.gms.internal.vision.e2.u(sxVar)) {
            float f7 = i10;
            sxVar.X0 = f7;
            sxVar.h.setTranslationY(((-f7) - sxVar.f38948e1) - sxVar.f38946d1);
        }
    }
