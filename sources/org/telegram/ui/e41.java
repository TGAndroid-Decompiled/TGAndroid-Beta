...
public final class e41 extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate {
    public static boolean f33169s;
    public static HashSet v;
    public d41 f33170a;
    public org.telegram.ui.Components.wl0 f33171b;
    public d41 f33172c;
    public org.telegram.ui.Components.mz d;
    public int e;
    public ArrayList f33173f;
    public ArrayList h;
    public HashSet f33174n;
    public HashSet f33175r;
    ...
    public static void U(e41 e41Var, View view, int i10) {
        ...
        if (e41Var.getParentActivity() != null && e41Var.parentLayout != null && (view instanceof org.telegram.ui.Cells.x8)) {
            int i11 = 0;
            if (e41Var.f33171b.getAdapter() == e41Var.f33172c) {
                z10 = true;
            } else {
                z10 = false;
            }
            if (z10 && (arrayList = e41Var.f33173f) != null) {
            ...
            if (language != null && language.code != null) {
                ...
                if (e41Var.f33175r.contains(str)) {
                    Collection.EL.removeIf(e41Var.f33175r, new r80(str, 2));
                } else {
                    e41Var.f33175r.add(str);
                }
                if (e41Var.f33175r.size() == 1 && e41Var.f33175r.contains(currentLocaleInfo.pluralLangCode)) {
                    a0(null, null);
                } else {
                    a0(e41Var.f33175r, Boolean.TRUE);
                }
                if (z10) {
                    int i13 = 0;
                    while (i11 < e41Var.f33173f.size()) {
                        if (TextUtils.equals(str, ((TranslateController.Language) e41Var.f33173f.get(i11)).code)) {
                            e41Var.Z(i13);
                        }
                        i11++;
                        i13++;
    ...
    public final void X() {
        ...
        ArrayList arrayList2 = new ArrayList(this.f33174n);
        ...
        while (i10 < this.h.size()) {
            ...
            if (TextUtils.equals(language2.code, str)) {
                ...
                i10--;
                language = language2;
            } else if (this.f33174n.contains(language2.code)) {
        ...
        for (int i11 = 0; i11 < arrayList2.size(); i11++) {
            ...
            language3.f15811q = language3.code.toLowerCase();
    ...
    public final void Z(int i10) {
        int b10;
        s4.h0 adapter = this.f33171b.getAdapter();
        for (int i11 = 0; i11 < this.f33171b.getChildCount(); i11++) {
            s4.c1 U = this.f33171b.U(this.f33171b.getChildAt(i11));
    ...
    public final View createView(Context context) {
        ...
        this.f33170a = new d41(this, context, false);
        this.f33172c = new d41(this, context, true);
        ...
        this.f33171b = wl0Var;
        wl0Var.q1();
        this.f33171b.setEmptyView(this.d);
        this.f33171b.setLayoutManager(new s4.c0(1, false));
        this.f33171b.setVerticalScrollBarEnabled(false);
        this.f33171b.setAdapter(this.f33170a);
        frameLayout2.addView(this.f33171b, w7.y5.c(-1.0f, -1));
        this.f33171b.setOnItemClickListener(new z21(this, 2));
        this.f33171b.setOnScrollListener(new h3(this, 27));
        return this.fragmentView;
    }

    @Override
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.suggestedLangpack && this.f33170a != null) {
            X();
            this.f33170a.l();
        }
    }
    ...
    public final ArrayList getThemeDescriptions() {
        ArrayList arrayList = new ArrayList();
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f33171b, 16, new Class[]{org.telegram.ui.Cells.q4.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19062d6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f33171b, 32768, null, null, null, null, org.telegram.ui.ActionBar.j6.f19340s8));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f33171b, 4096, null, null, null, null, org.telegram.ui.ActionBar.j6.f19152i6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.d, 4, null, null, null, null, org.telegram.ui.ActionBar.j6.f19045c7));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f33171b, 0, new Class[]{View.class}, org.telegram.ui.ActionBar.j6.f19184k0, null, null, org.telegram.ui.ActionBar.j6.f19063d7));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f33171b, 0, new Class[]{org.telegram.ui.Cells.q4.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.G6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f33171b, 0, new Class[]{org.telegram.ui.Cells.q4.class}, new String[]{"textView2"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.A6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f33171b, 0, new Class[]{org.telegram.ui.Cells.q4.class}, new String[]{"checkImage"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.Mh));
        return arrayList;
    }
