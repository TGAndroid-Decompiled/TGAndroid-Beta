...
public final class ge1 implements View.OnClickListener {
    public final gi0 f36681a;
    public final co f36682b;
    public final org.telegram.ui.Components.ll0 f36683c;
    public final LinearLayout d;
    public final org.telegram.ui.Components.n70 f36684e;
    public final org.telegram.ui.Components.n70 f36685f;
    public final le1 h;
    ...
    public final void onClick(View view) {
        ...
        if (!arrayList2.isEmpty()) {
            ...
            if (SharedConfig.messageSeenHintCount > 0 && coVar.X0.getKeyboardHeight() < AndroidUtilities.dp(20.0f)) {
                org.telegram.ui.Components.qc t10 = new org.telegram.ui.Components.yc(org.telegram.ui.Components.lb.a(le1Var.getContext()), le1Var.f38343a).t(AndroidUtilities.replaceTags(LocaleController.getString(R.string.MessageSeenTooltipMessage)), null);
                coVar.f35376n1 = t10;
                t10.f29707j = 4000;
                t10.j();
                SharedConfig.updateMessageSeenHintCount(SharedConfig.messageSeenHintCount - 1);
            }
            org.telegram.ui.Components.ll0 ll0Var = this.f36683c;
            ll0Var.requestLayout();
            this.d.requestLayout();
            ll0Var.getAdapter().l();
            this.f36684e.K(this.f36685f);
        }
    }
}
