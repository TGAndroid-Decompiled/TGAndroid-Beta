...
public final class ge1 implements View.OnClickListener {
    public final gi0 f36654a;
    public final co f36655b;
    public final org.telegram.ui.Components.ll0 f36656c;
    public final LinearLayout d;
    public final org.telegram.ui.Components.n70 f36657e;
    public final org.telegram.ui.Components.n70 f36658f;
    public final le1 h;
    ...
    public final void onClick(View view) {
        ...
        if (!arrayList2.isEmpty()) {
            ...
            if (SharedConfig.messageSeenHintCount > 0 && coVar.X0.getKeyboardHeight() < AndroidUtilities.dp(20.0f)) {
                org.telegram.ui.Components.qc t10 = new org.telegram.ui.Components.yc(org.telegram.ui.Components.lb.a(le1Var.getContext()), le1Var.f38316a).t(AndroidUtilities.replaceTags(LocaleController.getString(R.string.MessageSeenTooltipMessage)), null);
                coVar.f35349n1 = t10;
                t10.f29680j = 4000;
                t10.j();
                SharedConfig.updateMessageSeenHintCount(SharedConfig.messageSeenHintCount - 1);
            }
            org.telegram.ui.Components.ll0 ll0Var = this.f36656c;
            ll0Var.requestLayout();
            this.d.requestLayout();
            ll0Var.getAdapter().l();
            this.f36657e.K(this.f36658f);
        }
    }
}
