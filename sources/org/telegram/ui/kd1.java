...
public final class kd1 extends org.telegram.ui.Components.w9 {
    ...
    public final void onDraw(Canvas canvas) {
            ...
            if (!(drawable instanceof ColorDrawable) && !(drawable instanceof GradientDrawable) && !(drawable instanceof org.telegram.ui.Components.lc0)) {
                if (drawable instanceof BitmapDrawable) {
                    if (((BitmapDrawable) drawable).getTileModeX() == Shader.TileMode.REPEAT) {
                        ...
                        int ceil = (int) Math.ceil(this.G.getIntrinsicWidth() * max * vd1Var.f38533y1);
                        int ceil2 = (int) Math.ceil(this.G.getIntrinsicHeight() * max * vd1Var.f38533y1);
        ...
        if (vd1Var.a2) {
            if (!vd1Var.f38474c.isFinished() && vd1Var.f38474c.computeScrollOffset()) {
                if (vd1Var.f38474c.getStartX() < vd1Var.W1 && vd1Var.f38474c.getStartX() > 0) {
                    vd1Var.X1 = vd1Var.f38474c.getCurrX();
                }
                vd1Var.V0();
                invalidate();
            }
        ...
        if (vd1Var.M1) {
            float f11 = vd1Var.f38506n1;
            if (f11 > 0.0f) {
                canvas.drawColor(i0.a.k(-16777216, (int) (f11 * 255.0f * vd1Var.f38508o1)));
            }
        }
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        vd1 vd1Var = this.K;
        org.telegram.ui.Components.a91 a91Var = vd1Var.f38524v1;
        ...
        if (vd1Var.f38473b2 != measuredWidth2) {
            vd1Var.a2 = false;
        ...
        vd1Var.f38473b2 = measuredWidth2;
    }
