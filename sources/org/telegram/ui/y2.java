        ...
        if (videoPlayerHolderBase.firstFrameRendered) {
            ...
            if (textureView != null && textureView.getSurfaceTexture() != null) {
                if (Build.VERSION.SDK_INT >= 24) {
                    ...
                    surface.release();
                    obj.f40031b = createBitmap;
                    return obj;
                }
                obj.f40031b = textureView2.getBitmap();
            }
        }
        return obj;
    }
