...
public final class l01 implements di.gc {
    public final ProfileActivity f38164a;

    public l01(ProfileActivity profileActivity) {
        this.f38164a = profileActivity;
    }

    @Override
    public final di.kc a(long j3) {
        float f7;
        ProfileActivity profileActivity = this.f38164a;
        if (j3 == profileActivity.a()) {
            profileActivity.f33887e0.setRoundRadiusForExpand((int) AndroidUtilities.lerp(profileActivity.c4(), 0.0f, profileActivity.f33931k2));
    ...
    public final void b(long j3, bi.g gVar) {
        ProfileActivity profileActivity = this.f38164a;
        profileActivity.f33887e0.setHasStories(profileActivity.j4());
        if (j3 == profileActivity.a() && profileActivity.f33957o2 && profileActivity.f33931k2 > 0.0f) {
            profileActivity.f33871c.h1(0, profileActivity.T3() - profileActivity.f33856a.getPaddingTop());
            profileActivity.f33856a.post(new yb0(profileActivity, 14));
        }
