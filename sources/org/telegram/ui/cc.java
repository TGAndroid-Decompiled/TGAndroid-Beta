...
public final class cc extends og.b {
    ...
    public final boolean D(s4.c1 c1Var) {
        return ((dc) this.f32724f.f33365x.get(c1Var.b())).f15544b;
    }

    @Override
    public final int h() {
        return this.f32724f.f33365x.size();
    }

    @Override
    public final int j(int i10) {
        return ((dc) this.f32724f.f33365x.get(i10)).f15543a;
    }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        int i12;
        int i13;
        ec ecVar = this.f32724f;
        int i14 = ecVar.f33358b;
        TLRPC.Chat chat = ecVar.J;
        ArrayList arrayList = ecVar.f33365x;
        ...
        if (i15 != 4) {
            if (i15 != 1 && i15 != 12) {
                if (i15 == 0) {
                    ...
                    bVar.d(user, ContactsController.formatName(user), formatString, !((dc) arrayList.get(i10)).f33092f);
                    bVar.setStatus(boost);
                    bVar.setAvatarPadding(5);
                    return;
                } else if (i15 == 6) {
                    ((org.telegram.ui.Cells.e9) view).setText(((dc) arrayList.get(i10)).f33091c);
                    return;
                } else if (i15 == 9) {
                    org.telegram.ui.Cells.x4 x4Var = (org.telegram.ui.Cells.x4) view;
                    if (ecVar.f33366y == 0) {
                        x4Var.b(LocaleController.formatPluralString("BoostingShowMoreBoosts", ecVar.f33363s, new Object[0]), R.drawable.arrow_more, 5, false);
                        return;
                    } else {
                        x4Var.b(LocaleController.formatPluralString("BoostingShowMoreGifts", ecVar.f33364w, new Object[0]), R.drawable.arrow_more, 5, false);
                        return;
                    }
                } else if (i15 == 3) {
                    ((org.telegram.ui.Components.v80) view).setLink(((dc) arrayList.get(i10)).f33091c);
                    return;
                } else if (i15 == 11) {
                    dc dcVar = (dc) arrayList.get(i10);
                    TL_stories.PrepaidGiveaway prepaidGiveaway = dcVar.e;
                    boolean z10 = dcVar.f33092f;
                    yg.c cVar = (yg.c) view;
                    ...
                    if (i16 != i17 || this.e != ecVar.O) {
                        ...
                        this.e = ecVar.O;
                        ecVar.f33360f.g();
                        ecVar.f33360f.a(0, LocaleController.formatPluralString("BoostingBoostsCount", ecVar.P, new Object[0]), null);
                        if (MessagesController.getInstance(i14).giveawayGiftsPurchaseAvailable && (i11 = ecVar.O) > 0 && i11 != ecVar.P) {
                            ecVar.f33360f.a(1, LocaleController.formatPluralString("BoostingGiftsCount", i11, new Object[0]), null);
                        }
                        ecVar.f33360f.setInitialTabId(ecVar.f33366y);
                        ecVar.f33360f.c();
                        return;
                    }
                    return;
            ...
            cVar2.setTitle(((dc) arrayList.get(i10)).f33091c);
            cVar2.c(false);
            if (c1Var.f42705f == 12) {
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        switch (i10) {
            ...
            case 1:
                ...
                break;
            case 2:
                n6Var = new org.telegram.ui.Cells.a7(viewGroup.getContext(), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18807a7, false), 0);
                break;
            case 3:
                org.telegram.ui.Components.v80 v80Var = new org.telegram.ui.Components.v80(ecVar.getContext(), ecVar.f33359c, null, false, false);
            ...
            case 13:
                ...
                ecVar.f33360f = scrollSlidingTextTabStrip;
                ...
                ecVar.f33360f.setDelegate(new g(this, 11));
                n6Var2.addView(ecVar.f33360f, w7.x5.c(48.0f, -2));
                n6Var = n6Var2;
                break;
            default:
