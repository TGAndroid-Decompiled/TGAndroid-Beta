...
public final class at0 extends org.telegram.ui.Components.ld {
    public final Path f34547t1;
    public final PhotoViewer f34548u1;
    ...
    public at0(PhotoViewer photoViewer, Context context, bv0 bv0Var, org.telegram.ui.Components.ov0 ov0Var, FrameLayout frameLayout, org.telegram.ui.ActionBar.f6 f6Var, org.telegram.ui.Components.ja jaVar, ir0 ir0Var) {
        ...
        this.f34548u1 = photoViewer;
        this.f34547t1 = new Path();
    }

    @Override
    public final void A() {
        PhotoViewer.W(this.f34548u1);
    }

    @Override
    public final void B() {
        z();
        bt0 bt0Var = this.f34548u1.V1;
        if (bt0Var != null) {
            bt0Var.z();
        }
    }
    ...
    public final void I() {
        boolean z10;
        PhotoViewer photoViewer = this.f34548u1;
        av0 av0Var = photoViewer.d;
        if (av0Var != null && av0Var.l() && (photoViewer.U1.L.c() || (!photoViewer.f33662r1 && !TextUtils.isEmpty(photoViewer.f1().getText())))) {
            z10 = true;
        } else {
            z10 = false;
        }
    ...
    public final void invalidate() {
        int i10;
        if (SharedConfig.photoViewerBlur && ((i10 = this.f34548u1.f33630n4) == 1 || i10 == 2 || i10 == 3)) {
            return;
        }
        super.invalidate();
    }
    ...
    public final boolean l(float f7, float f10) {
        if (!this.f7604p0 && this.f34548u1.f33693u4 != 0) {
            return true;
        }
        return false;
    }
    ...
    public final void y() {
        di.i iVar = this.M;
        if (iVar != null) {
            iVar.setTranslationY(((-getEditTextHeight()) - AndroidUtilities.dp(14.0f)) - this.L.f7435l);
        }
    }
}
