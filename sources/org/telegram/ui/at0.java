...
public final class at0 extends AnimatorListenerAdapter {
    ...
    public final PhotoViewer f35242c;

    public at0(PhotoViewer photoViewer, boolean z4, int i10) {
        this.f35240a = i10;
        this.f35242c = photoViewer;
        this.f35241b = z4;
    }
    ...
    public void onAnimationCancel(Animator animator) {
        switch (this.f35240a) {
            case 1:
                PhotoViewer photoViewer = this.f35242c;
                ...
                return;
            case 2:
                PhotoViewer photoViewer2 = this.f35242c;
            ...
            default:
                if (animator.equals(photoViewer.Q7)) {
                    ...
                    if (z4) {
                        ...
                        animatorSet.playTogether(ObjectAnimator.ofFloat(nu0Var, property, 0.0f), ObjectAnimator.ofFloat(photoViewer.L7, property, 0.0f));
                    } else {
                        if (photoViewer.P4) {
