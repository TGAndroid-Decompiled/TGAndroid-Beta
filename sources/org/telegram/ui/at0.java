...
public final class at0 extends org.telegram.ui.Components.ld {
    public final Path f34548t1;
    public final PhotoViewer f34549u1;
    ...
    public at0(PhotoViewer photoViewer, Context context, bv0 bv0Var, org.telegram.ui.Components.ov0 ov0Var, FrameLayout frameLayout, org.telegram.ui.ActionBar.f6 f6Var, org.telegram.ui.Components.ja jaVar, ir0 ir0Var) {
        ...
        this.f34549u1 = photoViewer;
        this.f34548t1 = new Path();
    }

    @Override
    public final void A() {
        PhotoViewer.W(this.f34549u1);
    }

    @Override
    public final void B() {
        z();
        bt0 bt0Var = this.f34549u1.V1;
        if (bt0Var != null) {
            bt0Var.z();
        }
    }
    ...
    public final void I() {
        boolean z10;
        PhotoViewer photoViewer = this.f34549u1;
        av0 av0Var = photoViewer.d;
        if (av0Var != null && av0Var.l() && (photoViewer.U1.L.c() || (!photoViewer.f33663r1 && !TextUtils.isEmpty(photoViewer.f1().getText())))) {
            z10 = true;
        } else {
            z10 = false;
        }
    ...
    public final void invalidate() {
        int i10;
        if (SharedConfig.photoViewerBlur && ((i10 = this.f34549u1.f33631n4) == 1 || i10 == 2 || i10 == 3)) {
            return;
        }
        super.invalidate();
    }
    ...
    public final boolean l(float f7, float f10) {
        if (!this.f7604p0 && this.f34549u1.f33694u4 != 0) {
            return true;
        }
        return false;
    }
