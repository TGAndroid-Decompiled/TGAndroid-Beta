...
public final class hi implements View.OnClickListener {
    public final xh0 f37513a;
    public final org.telegram.ui.Components.tl0 f37514b;
    public final LinearLayout f37515c;
    public final ActionBarPopupWindow$ActionBarPopupWindowLayout d;
    public final int[] f37516e;
    public final xn f37517f;
    ...
    public final void onClick(View view) {
        ...
        if (xnVar.N8 != null && !arrayList2.isEmpty()) {
            ...
            if (SharedConfig.messageSeenHintCount > 0 && xnVar.U0.getKeyboardHeight() < AndroidUtilities.dp(20.0f)) {
                org.telegram.ui.Components.ic t6 = new org.telegram.ui.Components.qc(org.telegram.ui.Components.cb.a(xnVar.getParentActivity()), xnVar.f43136ba).t(AndroidUtilities.replaceTags(LocaleController.getString(R.string.MessageSeenTooltipMessage)), null);
                xnVar.f43241k1 = t6;
                t6.f27745j = 4000;
                t6.j();
                SharedConfig.updateMessageSeenHintCount(SharedConfig.messageSeenHintCount - 1);
            }
            org.telegram.ui.Components.tl0 tl0Var = this.f37514b;
            tl0Var.requestLayout();
            this.f37515c.requestLayout();
            tl0Var.getAdapter().l();
            this.d.getSwipeBack().e(this.f37516e[0]);
        }
    }
}
