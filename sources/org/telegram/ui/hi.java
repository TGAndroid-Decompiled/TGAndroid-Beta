...
public final class hi implements z4.e {
    public final AtomicBoolean f34165a;
    public final LinearLayout f34166b;
    public final int f34167c;
    public final HorizontalScrollView d;
    public final SparseIntArray e;
    public final ActionBarPopupWindow$ActionBarPopupWindowLayout f34168f;
    ...
    public hi(AtomicBoolean atomicBoolean, LinearLayout linearLayout, int i10, HorizontalScrollView horizontalScrollView, SparseIntArray sparseIntArray, ActionBarPopupWindow$ActionBarPopupWindowLayout actionBarPopupWindow$ActionBarPopupWindowLayout, int[] iArr) {
        this.f34165a = atomicBoolean;
        this.f34166b = linearLayout;
        this.f34167c = i10;
        this.d = horizontalScrollView;
        this.e = sparseIntArray;
        this.f34168f = actionBarPopupWindow$ActionBarPopupWindowLayout;
        this.f34169g = iArr;
    }

    @Override
    public final void a(int i10) {
        this.f34168f.getSwipeBack().f(this.f34169g[0], this.e.get(i10), true);
    }
    ...
    public final void b(float f7, int i10, int i11) {
        ...
        if (!this.f34165a.get()) {
            ...
            float f12 = -1.0f;
            while (true) {
                LinearLayout linearLayout = this.f34166b;
                ...
                if (i12 == i10) {
                    f10 = 1.0f - f7;
                } else if (i12 == (i10 + 1) % this.f34167c) {
                    f10 = f7;
                } else {
                    f10 = 0.0f;
                }
            ...
            this.f34168f.getSwipeBack().f(this.f34169g[0], (int) (f13 + ((1.0f - f7) * i13)), false);
        }
    }
