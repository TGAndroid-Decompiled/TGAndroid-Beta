...
public final class a40 extends org.telegram.ui.Components.voip.l0 {
    ...
    public final void i(boolean z10) {
        ...
        f50 f50Var = j60Var.O;
        p50 p50Var = j60Var.Q;
        org.telegram.ui.Components.s20 s20Var = j60Var.f37576p2;
        a40 a40Var = j60Var.a2;
        w30 w30Var = j60Var.f37563m2;
        j60Var.f37588s0 = z10;
        int i10 = 0;
        if (j60.G3) {
            if (!z10 && a40Var.f31598b) {
                j60Var.f37572o2.H(j60Var.f37568n2, false, true);
                return;
            }
            return;
        }
        if (z10) {
            ...
            if (w30Var.getVisibility() == 0) {
                for (int i11 = 0; i11 < w30Var.getChildCount(); i11++) {
                    ...
                    ((org.telegram.ui.Components.r20) childAt).setProgressToFullscreen(a40Var.f31600c);
                }
            }
        }
        View view = j60Var.K2;
    ...
    public final void l() {
        ...
        ((org.telegram.ui.ActionBar.f3) j60Var).navBarColor = AndroidUtilities.getOffsetColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20782jg, false), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20727gg, false), Math.max(f10, f7), 1.0f);
