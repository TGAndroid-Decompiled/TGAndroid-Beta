...
public final class a40 extends org.telegram.ui.Components.voip.m0 {
    ...
    public final void i(boolean z10) {
        ...
        e50 e50Var = i60Var.O;
        o50 o50Var = i60Var.Q;
        org.telegram.ui.Components.s20 s20Var = i60Var.f34441p2;
        a40 a40Var = i60Var.a2;
        w30 w30Var = i60Var.f34428m2;
        i60Var.f34453s0 = z10;
        int i10 = 0;
        if (i60.G3) {
            if (!z10 && a40Var.f29423b) {
                i60Var.f34437o2.H(i60Var.f34433n2, false, true);
                return;
            }
            return;
        }
        if (z10) {
            ...
            if (w30Var.getVisibility() == 0) {
                for (int i11 = 0; i11 < w30Var.getChildCount(); i11++) {
                    ...
                    ((org.telegram.ui.Components.r20) childAt).setProgressToFullscreen(a40Var.f29425c);
                }
            }
        }
        View view = i60Var.K2;
    ...
    public final void l() {
        ...
        ((org.telegram.ui.ActionBar.f3) i60Var).navBarColor = AndroidUtilities.getOffsetColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19227jg, false), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19172gg, false), Math.max(f10, f7), 1.0f);
