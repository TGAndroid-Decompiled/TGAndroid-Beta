...
public final class ly extends org.telegram.ui.ActionBar.g5 {
    ...
    public final void m() {
        ...
        uyVar.f38235j2 = false;
        uyVar.f38239k2 = false;
    ...
    public final void n() {
        ...
        if (tyVar != null) {
            if (uyVar.f38252n2 != null) {
                ...
                if (eyVar != null) {
                    ai.w0 w0Var = eyVar.V;
                    if (w0Var.f25952i1) {
                        w0Var.f25952i1 = false;
                        w0Var.K0(false);
                    }
                }
            }
            if (!uyVar.f38243l2) {
                ci.f4 f4Var = uyVar.f38260p0;
                if (f4Var != null) {
                    f4Var.e(true);
                }
                ci.f4 f4Var2 = uyVar.f38265q0;
                if (f4Var2 != null) {
                    f4Var2.e(true);
                }
            }
        ...
        uyVar.m3();
        ey eyVar2 = uyVar.C0;
        if (eyVar2 != null && (rn0Var2 = eyVar2.f30287b0) != null) {
            rn0Var2.f9759c = gg.f0.All;
        }
        if ((eyVar2 != null && (rn0Var = eyVar2.f30287b0) != null && rn0Var.N()) || uyVar.getMessagesController().getTotalDialogsCount() > 10 || uyVar.f38280s3 || uyVar.K) {
            uyVar.f38239k2 = true;
            if (!uyVar.f38263p3) {
    ...
    public final void q(EditText editText) {
        ...
        boolean z10 = true;
        uy uyVar = this.f35576f;
        if (!isEmpty || (((eyVar = uyVar.C0) != null && (rn0Var = eyVar.f30287b0) != null && rn0Var.N()) || uyVar.f38280s3 || uyVar.K)) {
            uyVar.f38239k2 = true;
            if (!uyVar.f38263p3) {
                uyVar.O4(true, false, true, false);
            }
