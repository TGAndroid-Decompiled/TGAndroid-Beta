...
public final class ly extends org.telegram.ui.Components.aa implements oh.a7 {
    public static final int f38903s3 = 0;
    public boolean f38904a3;
    public boolean f38905b3;
    public boolean c3;
    public final oy f38906d3;
    public int f38907e3;
    public float f38908f3;
    public final Paint f38909g3;
    public final RectF f38910h3;
    public org.telegram.ui.Components.tl0 f38911i3;
    public LongSparseArray f38912j3;
    public Paint f38913k3;
    public float f38914l3;
    public float f38915m3;
    public float f38916n3;
    public boolean f38917o3;
    public oh.q9 f38918p3;
    public int f38919q3;
    public final py f38920r3;

    public ly(py pyVar, Context context, oy oyVar) {
        super(context, null);
        this.f38920r3 = pyVar;
        this.f38905b3 = true;
        this.f38909g3 = new Paint();
        this.f38910h3 = new RectF();
        this.f38915m3 = 1.0f;
        this.f38906d3 = oyVar;
    ...
    public final void a(int[] iArr) {
        int paddingTop = (int) (getPaddingTop() + this.f38920r3.K);
        iArr[0] = paddingTop;
    ...
    public final void addView(View view, int i10, ViewGroup.LayoutParams layoutParams) {
        ...
        view.setTranslationY(py.f40178x4);
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        if (motionEvent.getAction() == 0 && motionEvent.getY() < getPaddingTop() + this.f38920r3.K) {
            return false;
        }
    ...
    public final boolean drawChild(Canvas canvas, View view, long j10) {
        if (getItemAnimator() != null && getItemAnimator().k() && (view instanceof org.telegram.ui.Cells.r2) && ((org.telegram.ui.Cells.r2) view).f23494r) {
            return true;
        }
    ...
    public final void onDraw(Canvas canvas) {
        oy oyVar = this.f38906d3;
        if (oyVar.f39871n != null && py.f40178x4 != 0.0f) {
            int paddingTop = getPaddingTop();
            if (paddingTop != 0) {
                canvas.save();
                canvas.translate(0.0f, paddingTop);
            }
            oyVar.f39871n.c(canvas, true);
            if (paddingTop != 0) {
                canvas.restore();
            }
        }
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (!this.U1) {
            py pyVar = this.f38920r3;
            if (!pyVar.Y0 && !this.f38906d3.f39875x.k()) {
    ...
    public final void onLayout(boolean z4, int i10, int i11, int i12, int i13) {
        ...
        this.f38907e3 = getPaddingTop();
        this.f38920r3.f40286u3 = 0.0f;
        this.f38906d3.getClass();
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        py pyVar = this.f38920r3;
        if (L0 != -1 && oyVar.f39869e.f5767y == 0 && oyVar.f39868c.f5825y < 0 && oyVar.f39866a.getScrollState() != 1) {
            f2.m1 K = oyVar.f39866a.K(L0);
            if (K != null) {
                ...
                this.c3 = true;
                oyVar.f39868c.h1(L0, (int) ((top - this.f38907e3) + pyVar.f40286u3 + 0));
                this.c3 = false;
            }
        } else if (L0 == -1 && this.f38905b3) {
            tw twVar = oyVar.f39868c;
            if (oyVar.f39873s == 0 && pyVar.Z3()) {
                i12 = 1;
            } else {
                i12 = 0;
            }
        ...
        this.f38919q3 += (int) (AndroidUtilities.dp(50.0f) * S3);
        ...
        this.f38919q3 -= AndroidUtilities.dp(Math.max(S3, f10) * 5.0f);
        int n32 = pyVar.n3();
        if (dp2 != this.V2 || n32 != getPaddingBottom()) {
            setTopGlowOffset(dp2);
            setPadding(0, dp2, 0, n32);
            if (pyVar.H) {
                oyVar.f39874w.setPaddingTop(dp2 - AndroidUtilities.dp(81.0f));
            } else {
                oyVar.f39874w.setPaddingTop(dp2);
            }
        ...
        this.c3 = false;
        if (this.f38905b3 && pyVar.getMessagesController().dialogsLoaded) {
            if (oyVar.f39873s == 0 && pyVar.Z3()) {
                this.c3 = true;
        ...
        if (!pyVar.f40224i2 && dp2 != 0 && (oyVarArr = pyVar.f40185b0) != null && oyVarArr.length > 1 && !pyVar.f40225i3 && (animatorSet = pyVar.c3) != null) {
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (!this.U1) {
            ...
            if (action == 1 || action == 3) {
                f2.f0 f0Var = oyVar.f39869e;
                if (f0Var.f5767y != 0) {
                    ny nyVar = oyVar.f39870f;
                    if (nyVar.f39542e) {
                        nyVar.f39543f = true;
                        if (f0Var.f(null, 4) != 0 && (m1Var = oyVar.f39870f.d) != null) {
            ...
            if (oyVar.f39873s == 0 && ((action == 1 || action == 3) && oyVar.v == 2 && pyVar.Z3() && ((f2.j0) getLayoutManager()).L0() == 0)) {
                int paddingTop = getPaddingTop();
    ...
    public final void y1(org.telegram.ui.ix r14, float r15, boolean r16) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.ly.y1(org.telegram.ui.ix, float, boolean):void");
    }
    ...
    public final void z1(boolean z4, org.telegram.ui.Cells.r2 r2Var) {
        ...
        if (SharedConfig.archiveHidden) {
            if (r2Var != null) {
                ...
                v0(0, top, org.telegram.ui.Components.pr.f30184g);
                if (z4) {
                    pyVar.f40181a1 = true;
                } else {
                    A1();
