...
public final class ly extends org.telegram.ui.ActionBar.g5 {
    ...
    public final void m() {
        ...
        uyVar.f38177j2 = false;
        uyVar.f38181k2 = false;
    ...
    public final void n() {
        ...
        if (tyVar != null) {
            if (uyVar.f38194n2 != null) {
                ...
                if (eyVar != null) {
                    ai.w0 w0Var = eyVar.W;
                    if (w0Var.f30076i1) {
                        w0Var.f30076i1 = false;
                        w0Var.L0(false);
                    }
                }
            }
            if (!uyVar.f38185l2) {
                ci.f4 f4Var = uyVar.f38202p0;
                if (f4Var != null) {
                    f4Var.e(true);
                }
                ci.f4 f4Var2 = uyVar.f38207q0;
                if (f4Var2 != null) {
                    f4Var2.e(true);
                }
            }
        ...
        uyVar.m3();
        ey eyVar2 = uyVar.C0;
        if (eyVar2 != null && (eo0Var2 = eyVar2.f26207c0) != null) {
            eo0Var2.f9763c = gg.f0.All;
        }
        if ((eyVar2 != null && (eo0Var = eyVar2.f26207c0) != null && eo0Var.N()) || uyVar.getMessagesController().getTotalDialogsCount() > 10 || uyVar.f38222s3 || uyVar.K) {
            uyVar.f38181k2 = true;
            if (!uyVar.f38205p3) {
    ...
    public final void q(EditText editText) {
        ...
        boolean z10 = true;
        uy uyVar = this.f35466f;
        if (!isEmpty || (((eyVar = uyVar.C0) != null && (eo0Var = eyVar.f26207c0) != null && eo0Var.N()) || uyVar.f38222s3 || uyVar.K)) {
            uyVar.f38181k2 = true;
            if (!uyVar.f38205p3) {
                uyVar.O4(true, false, true, false);
            }
