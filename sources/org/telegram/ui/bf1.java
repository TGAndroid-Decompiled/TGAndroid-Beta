...
public final class bf1 extends org.telegram.ui.ActionBar.o2 {
    ...
    public org.telegram.ui.Components.pq f32125s;
    public org.telegram.ui.Components.rl0 v;
    public TLRPC.TL_forumTopic f32126w;
    public ng.a f32127x;
    public bo f32128y;
    ...
    public final void b0(Long l4, boolean z10) {
        ...
        if (this.f32122f != null && this.v != null) {
            if (l4 == null) {
                longValue = 0;
            } else {
                longValue = l4.longValue();
            }
            this.f32122f.setSelected(Long.valueOf(longValue));
            if (this.f32120b != longValue) {
                ...
                if (longValue != 0) {
                    ...
                    l80Var.a(this.f32123n);
                    this.v.b(l80Var, false);
                    u9VarArr[1].setImageDrawable(this.f32125s);
    ...
    public final View createView(Context context) {
        ...
        TLRPC.TL_forumTopic tL_forumTopic = this.f32126w;
        ...
        frameLayout2.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view) {
                int i11 = r2;
                bf1 bf1Var = this.f38409b;
                switch (i11) {
                    case 0:
                        if (bf1Var.f32120b == 0 && bf1Var.f32126w == null) {
                            ng.a aVar = bf1Var.f32127x;
                            int i12 = aVar.e + 1;
                            aVar.e = i12;
        ...
        TLRPC.TL_forumTopic tL_forumTopic2 = this.f32126w;
        if (tL_forumTopic2 != null && tL_forumTopic2.f18173id == 1) {
            ...
            this.d.d(LocaleController.getString(R.string.EditTopicHide), !this.f32126w.hidden, false, false);
            this.d.setBackground(org.telegram.ui.ActionBar.j6.Z(getThemedColor(i12), getThemedColor(org.telegram.ui.ActionBar.j6.f18953i6), 16, 16));
            ...
            this.f32122f.setClipChildren(false);
            frameLayout3.addView(this.f32122f, w7.x5.d(-1, -1.0f, 0, 12.0f, 12.0f, 12.0f, 12.0f));
            org.telegram.ui.Components.pq d = ng.d.d(this.E, "");
            this.f32127x = (ng.a) d.f27109a;
            ...
            ArrayList arrayList2 = rl0Var2.f27648n;
            if (!arrayList2.contains(u9Var3)) {
                arrayList2.add(u9Var3);
            }
            u9VarArr[0].setImageDrawable(this.f32125s);
            ...
            ng.a aVar = this.f32127x;
            aVar.d.add(u9VarArr[0]);
            ng.a aVar2 = this.f32127x;
            aVar2.d.add(u9VarArr[1]);
        }
        linearLayout.addView(frameLayout3, w7.x5.c(-1.0f, -1));
        TLRPC.TL_forumTopic tL_forumTopic3 = this.f32126w;
        if (tL_forumTopic3 != null) {
            this.e.setText(tL_forumTopic3.title);
            b0(Long.valueOf(this.f32126w.icon_emoji_id), true);
        } else {
            b0(0L, true);
        }
    ...
    public final boolean onFragmentCreate() {
        this.f32119a = -this.arguments.getLong("chat_id");
        long j3 = this.arguments.getLong("topic_id", 0L);
        this.f32121c = j3;
        if (j3 != 0) {
            TLRPC.TL_forumTopic findTopic = getMessagesController().getTopicsController().findTopic(-this.f32119a, this.f32121c);
            this.f32126w = findTopic;
            if (findTopic == null) {
                return false;
            }
