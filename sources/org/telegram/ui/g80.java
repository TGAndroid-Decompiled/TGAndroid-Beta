...
public final class g80 extends FrameLayout implements org.telegram.ui.ActionBar.y5 {
    ...
    public g80(i80 i80Var, Context context, org.telegram.ui.ActionBar.v1 v1Var) {
        ...
        this.f33484c = imageView;
        imageView.setImageResource(R.drawable.outline_search_1_24);
        int i11 = org.telegram.ui.ActionBar.h6.G6;
        imageView.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.h6.l1(0.6f, i80Var.getThemedColor(i11)), PorterDuff.Mode.SRC_IN));
        ...
        h2Var.setTextColor(i80Var.getThemedColor(i11));
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        Paint paint = this.f33482a;
        paint.setShadowLayer(dpf2, 0.0f, dpf22, 285212672);
        int i10 = org.telegram.ui.ActionBar.h6.f18789d6;
        i80 i80Var = this.f33485f;
        paint.setColor(i80Var.getThemedColor(i10));
        RectF rectF = AndroidUtilities.rectTmp;
        rectF.set(AndroidUtilities.dp(12.0f), AndroidUtilities.dp(3.0f), getWidth() - AndroidUtilities.dp(12.0f), AndroidUtilities.dp(3.0f) + i80Var.f34064b.e + AndroidUtilities.dp(3.0f));
        Path path = this.f33483b;
        path.rewind();
        path.addRoundRect(rectF, AndroidUtilities.dp(20.0f), AndroidUtilities.dp(20.0f), Path.Direction.CW);
        GradientDrawable gradientDrawable = this.e;
        if (gradientDrawable != null) {
            gradientDrawable.setBounds(0, 0, getWidth(), Math.min(getHeight(), AndroidUtilities.dp(24.0f) + ((int) i80Var.f34064b.e)));
            this.e.draw(canvas);
        }
        canvas.save();
    ...
    @Override
    public final void e() {
        int themedColor = this.f33485f.getThemedColor(org.telegram.ui.ActionBar.h6.f18733a7);
