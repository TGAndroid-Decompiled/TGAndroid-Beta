...
public final class g80 extends org.telegram.ui.ActionBar.m2 implements NotificationCenter.NotificationCenterDelegate, View.OnClickListener, le.e, ph.d {
    ...
    public final le.f f33851b;
    public org.telegram.ui.Components.z10 f33852c;
    public e80 d;
    public org.telegram.ui.ActionBar.u1 e;
    public f80 f33853f;
    public org.telegram.ui.Components.wl0 h;
    public s4.c0 f33854n;
    public org.telegram.ui.Components.ix0 f33855r;
    public c80 f33856s;
    public boolean v;
    public ArrayList f33857w;
    public int f33858x;
    public boolean f33859y;
    ...
    public g80() {
        ...
        this.f33850a = i10;
        this.f33851b = new le.f(3, this, org.telegram.ui.Components.rr.h, 350L, AndroidUtilities.dp(37.0f));
        this.F = new HashMap();
    ...
    public static void U(g80 g80Var, View view, int i10) {
        ...
        if (i10 == 0 && !g80Var.E) {
            ...
            if (n30Var != null) {
                ...
                f80 f80Var = g80Var.f33853f;
                ArrayList arrayList = f80Var.f33578c;
                g80 g80Var2 = f80Var.h;
                g80Var2.G.add(n30Var2);
                g80Var2.F.put(n30Var2.getKey(), n30Var2);
                AnimatorSet animatorSet = f80Var.f33576a;
                if (animatorSet != null) {
                    animatorSet.setupEndValues();
                    f80Var.f33576a.cancel();
                }
                f80Var.f33577b = false;
                AnimatorSet animatorSet2 = new AnimatorSet();
                f80Var.f33576a = animatorSet2;
                animatorSet2.addListener(new org.telegram.ui.Components.q81(f80Var, 24));
                f80Var.f33576a.setInterpolator(org.telegram.ui.Components.rr.h);
                f80Var.f33576a.setDuration(320L);
                f80Var.d = n30Var2;
                arrayList.clear();
    ...
    public final void Y() {
        ...
        if (Build.VERSION.SDK_INT >= 31 && (hVar = this.L) != null) {
            ...
            this.P.set(0.0f, -dp, this.fragmentView.getMeasuredWidth(), this.actionBar.getMeasuredHeight() + dp + AndroidUtilities.dp(48.0f) + this.f33858x);
            hVar.g(1, this.O);
    ...
    public final void Z() {
        org.telegram.ui.Components.z10 z10Var = this.f33852c;
        if (z10Var != null) {
    ...
    public final void a0() {
        this.h.setPadding(0, AndroidUtilities.dp(4.0f) + this.actionBar.getMeasuredHeight() + AndroidUtilities.dp(this.f33850a) + ((int) this.f33851b.e), 0, this.J);
        this.f33855r.setPadding(0, 0, 0, this.J);
    }
    ...
    public final View createView(Context context) {
        ...
        this.f33855r.setAnimateLayoutChange(true);
        this.f33855r.d.setText(LocaleController.getString(R.string.NoContacts));
        this.f33855r.e.setText("");
        this.f33855r.e(ContactsController.getInstance(this.currentAccount).isLoadingContacts(), true);
        int i12 = org.telegram.ui.ActionBar.h6.f19004a7;
        k0Var.setBackgroundColor(getThemedColor(i12));
        k0Var.addView(this.f33855r);
        this.f33854n = new s4.c0(1, false);
        this.f33856s = new c80(this, context);
        org.telegram.ui.Components.wl0 wl0Var = new org.telegram.ui.Components.wl0(context, null);
        this.h = wl0Var;
        wl0Var.setSections(true);
        this.h.setEmptyView(this.f33855r);
        this.h.setAdapter(this.f33856s);
        this.h.setLayoutManager(this.f33854n);
        ...
        k0Var.addView(this.h, w7.y5.d(-1, -1.0f, 119, 0.0f, -this.f33850a, 0.0f, 0.0f));
        ...
        this.f33852c = z10Var;
        z10Var.f30762c.setImageDrawable(f2Var);
        this.f33852c.e(false, false);
        this.f33852c.setContentDescription(LocaleController.getString(R.string.Next));
        this.f33852c.setOnClickListener(new f60(this, 4));
        ...
        c80 c80Var = this.f33856s;
        if (c80Var != null && !this.E) {
            int h = c80Var.h();
            org.telegram.ui.Components.ix0 ix0Var2 = this.f33855r;
            if (h != 2) {
                i10 = 4;
            }
            ix0Var2.setVisibility(i10);
        }
        k0Var.addView(this.f33852c, org.telegram.ui.Components.z10.b());
    ...
    public final void d0() {
        ...
        this.f33857w = arrayList;
        Collections.sort(arrayList, new cf(22));
        org.telegram.ui.Components.ix0 ix0Var = this.f33855r;
        if (ix0Var != null) {
            ix0Var.e(false, true);
        }
        c80 c80Var = this.f33856s;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.contactsImported) {
            d0();
        } else if (i10 == NotificationCenter.contactsDidLoad && (ix0Var = this.f33855r) != null) {
            ix0Var.e(false, true);
        }
    }
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.h, 33554432, null, null, null, null, org.telegram.ui.ActionBar.h6.f19206l7));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.h, 33554432, null, null, null, null, org.telegram.ui.ActionBar.h6.f19225m7));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.h, 33554432, null, null, null, null, org.telegram.ui.ActionBar.h6.f19245n7));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.h, 0, new Class[]{View.class}, org.telegram.ui.ActionBar.h6.f19181k0, null, null, org.telegram.ui.ActionBar.h6.f19061d7));
        ...
        int i10 = org.telegram.ui.ActionBar.h6.f19015ai;
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.h, 4, new Class[]{org.telegram.ui.Cells.p4.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.f19150i7));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.h, 4, new Class[]{org.telegram.ui.Cells.p4.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.f19188k7));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.h, 262148, new Class[]{org.telegram.ui.Cells.p4.class}, new String[]{"statusTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.f19244n6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.h, 262148, new Class[]{org.telegram.ui.Cells.p4.class}, new String[]{"statusTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.f19443y6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.h, 0, new Class[]{org.telegram.ui.Cells.p4.class}, null, org.telegram.ui.ActionBar.h6.f19311r0, null, org.telegram.ui.ActionBar.h6.J7));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f33853f, 0, new Class[]{org.telegram.ui.Components.n30.class}, null, null, null, org.telegram.ui.ActionBar.h6.f19053ci));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f33853f, 0, new Class[]{org.telegram.ui.Components.n30.class}, null, null, null, org.telegram.ui.ActionBar.h6.f19034bi));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f33853f, 0, new Class[]{org.telegram.ui.Components.n30.class}, null, null, null, org.telegram.ui.ActionBar.h6.f19072di));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f33853f, 0, new Class[]{org.telegram.ui.Components.n30.class}, null, null, null, i11));
        return arrayList;
    }
    ...
    public final void onClick(View view) {
        ...
        if (n30Var.f26632y) {
            this.H = null;
            this.f33853f.a(n30Var);
            this.f33852c.e(!this.G.isEmpty(), true);
            c0();
            return;
        }
