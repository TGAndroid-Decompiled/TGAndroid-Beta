...
public final class zi0 extends org.telegram.ui.Components.fo {
    public final dj0 f40513v0;

    public zi0(dj0 dj0Var, Context context) {
        super(context, null, false, null);
        this.f40513v0 = dj0Var;
    }

    @Override
    public final void dispatchDraw(Canvas canvas) {
        super.dispatchDraw(canvas);
        dj0 dj0Var = this.f40513v0;
        dj0Var.W.setImageCoords(dj0Var.f33135b0.getAvatarImageView().getX(), dj0Var.f33135b0.getAvatarImageView().getY(), dj0Var.f33135b0.getAvatarImageView().getWidth(), dj0Var.f33135b0.getAvatarImageView().getHeight());
        if (dj0Var.Y) {
            canvas.save();
    ...
    public final void onAttachedToWindow() {
        ...
        this.f40513v0.W.onAttachedToWindow();
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        this.f40513v0.W.onDetachedFromWindow();
    }
}
