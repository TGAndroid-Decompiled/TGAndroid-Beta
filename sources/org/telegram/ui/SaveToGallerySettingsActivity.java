...
public class SaveToGallerySettingsActivity extends org.telegram.ui.ActionBar.n2 {
    ...
    public long f31429b;
    public SaveToGallerySettingsHelper.DialogException f31430c;
    public boolean d;
    ...
    public o41 f31432n;
    public org.telegram.ui.Components.ll0 f31433r;
    public final ArrayList f31434s;
    public LongSparseArray v;

    public SaveToGallerySettingsActivity(Bundle bundle) {
        super(bundle);
        this.f31434s = new ArrayList();
        this.v = new LongSparseArray();
    }

    public final SaveToGallerySettingsHelper.Settings X() {
        SaveToGallerySettingsHelper.DialogException dialogException = this.f31430c;
        if (dialogException != null) {
            return dialogException;
        }
        return SaveToGallerySettingsHelper.getSettings(this.f31428a);
    }
    ...
    public final void Y() {
        ...
        if (this.f31430c != null) {
            LongSparseArray<SaveToGallerySettingsHelper.DialogException> saveGalleryExceptions = getUserConfig().getSaveGalleryExceptions(this.f31428a);
            SaveToGallerySettingsHelper.DialogException dialogException = this.f31430c;
            saveGalleryExceptions.put(dialogException.dialogId, dialogException);
            getUserConfig().updateSaveGalleryExceptions(this.f31428a, saveGalleryExceptions);
            return;
        }
        SaveToGallerySettingsHelper.saveSettings(this.f31428a);
    }
    ...
    public final void Z() {
        ...
        String str = null;
        ArrayList arrayList2 = this.f31434s;
        if (!z10 && this.f31432n != null) {
        ...
        if (this.f31430c == null) {
            this.v = getUserConfig().getSaveGalleryExceptions(this.f31428a);
    ...
    public final View createView(Context context) {
        ...
        this.f31433r = ll0Var;
        ll0Var.p1();
        this.actionBar.setAdaptiveBackground(this.f31433r);
        s4.j jVar = new s4.j();
        jVar.n(400L);
        jVar.o(org.telegram.ui.Components.qr.h);
        jVar.C = false;
        jVar.f42710m = false;
        this.f31433r.setItemAnimator(jVar);
        this.f31433r.setLayoutManager(new s4.c0());
        org.telegram.ui.Components.ll0 ll0Var2 = this.f31433r;
        o41 o41Var = new o41(this);
        this.f31432n = o41Var;
        ll0Var2.setAdapter(o41Var);
        this.f31433r.setOnItemClickListener(new m41(this));
        this.f31433r.setOnItemLongClickListener(new m41(this));
        frameLayout.addView(this.f31433r);
    ...
    public final boolean onFragmentCreate() {
        this.f31428a = getArguments().getInt("type");
        this.v = getUserConfig().getSaveGalleryExceptions(this.f31428a);
        long j3 = getArguments().getLong("dialog_id");
        this.f31429b = j3;
        if (j3 != 0) {
            SaveToGallerySettingsHelper.DialogException dialogException = UserConfig.getInstance(this.currentAccount).getSaveGalleryExceptions(this.f31428a).get(this.f31429b);
            this.f31430c = dialogException;
            if (dialogException == null) {
                this.d = true;
                this.f31430c = new SaveToGallerySettingsHelper.DialogException();
                SaveToGallerySettingsHelper.Settings settings = SaveToGallerySettingsHelper.getSettings(this.f31428a);
                SaveToGallerySettingsHelper.DialogException dialogException2 = this.f31430c;
                ...
                dialogException2.dialogId = this.f31429b;
            }
        }
