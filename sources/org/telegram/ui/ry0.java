...
public final class ry0 implements Utilities.Callback2 {
    ...
    public final NotificationCenter.NotificationCenterDelegate f38076c;

    public ry0(boolean z4, NotificationCenter.NotificationCenterDelegate notificationCenterDelegate, int i10) {
        this.f38074a = i10;
        this.f38076c = notificationCenterDelegate;
        this.f38075b = z4;
    }
    ...
    public final void run(Object obj, Object obj2) {
        ...
        switch (this.f38074a) {
            case 0:
                ProfileActivity profileActivity = (ProfileActivity) this.f38076c;
                Integer num = (Integer) obj;
                TLRPC.TL_error tL_error = (TLRPC.TL_error) obj2;
                if (!profileActivity.M3()) {
                    if (org.telegram.ui.Components.qc.a(profileActivity)) {
                        int intValue = num.intValue();
                        boolean z10 = this.f38075b;
                        if (intValue == 1) {
                            org.telegram.ui.Components.qc.l(null, profileActivity, z10).j();
                        } else if (num.intValue() == 2) {
                            org.telegram.ui.Components.qc.l(DialogObject.getShortName(profileActivity.f32011b1), profileActivity, z10).j();
                ...
                return;
            case 1:
                ph.da daVar = (ph.da) this.f38076c;
                Bitmap bitmap = (Bitmap) obj2;
                int i10 = daVar.f41517c;
                if (obj != null && daVar.f41549m2 == null && !daVar.T && daVar.J()) {
                    int i11 = 0;
                    if (this.f38075b) {
                        if (daVar.H1 != null) {
                            daVar.u();
                            daVar.H1.f42419j = true;
                            if (obj instanceof MediaController.PhotoEntry) {
                                ...
                                if ((tLObject instanceof TLRPC.Photo) && (closestPhotoSizeWithSize = FileLoader.getClosestPhotoSizeWithSize(((TLRPC.Photo) tLObject).sizes, 1000)) != null) {
                                    f10 = closestPhotoSizeWithSize.f19184w / closestPhotoSizeWithSize.h;
                                } else {
                                    f10 = 1.0f;
                                }
                                if (f10 > 1.0f) {
                        ...
                        } else if (obj instanceof ph.t6) {
                            ph.t6 t6Var = (ph.t6) obj;
                            if (t6Var.L == null && !t6Var.v()) {
                                daVar.f41515b1.c(R.raw.error, "Failed to load draft");
                                MessagesController.getInstance(i10).getStoriesController().f15915w.c(t6Var);
                                return;
                            }
                            t6Var.J0 = daVar.f41568s0;
                            t6Var.K0 = daVar.f41571t0;
                            daVar.L1 = t6Var.K ? 1 : 0;
                            t6Var.M0 = bitmap;
                            daVar.I1 = false;
                            daVar.f41585x0.n(t6Var);
                            daVar.H1 = t6Var;
                            if (z11) {
                                ph.f8.a(i10, t6Var);
                            }
            ...
            default:
                ...
                sh.i0.m((sh.i0) this.f38076c, this.f38075b, (TLRPC.TL_error) obj2);
                return;
        }
    }
}
