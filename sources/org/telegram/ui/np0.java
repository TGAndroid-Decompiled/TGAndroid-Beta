...
public final class np0 extends org.telegram.ui.Components.kl0 {
    ...
    @Override
    public final int h() {
        return this.e.f38092k0;
    }

    @Override
    public final int j(int i10) {
        up0 up0Var = this.e;
        if (i10 == up0Var.R || i10 == up0Var.f38088g0 || i10 == up0Var.T || i10 == up0Var.W) {
            return 2;
        }
        if (i10 == up0Var.Q) {
            return 1;
        ...
        if (i10 == up0Var.f38089h0) {
            return 10;
        }
        if (i10 == up0Var.f38090i0) {
            return 11;
        }
        if (i10 == up0Var.f38079a0) {
            return 7;
        }
        if (i10 >= up0Var.f38081b0 && i10 < up0Var.f38083c0) {
            ...
            return 12;
        } else if (i10 >= up0Var.f38084d0 && i10 < up0Var.f38085e0) {
            return 9;
        } else {
            if (i10 != up0Var.f38092k0 - 1 && i10 != up0Var.f38091j0) {
                return 2;
            }
            return 4;
        }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        ArrayList arrayList = up0Var.f38093l0;
        ...
        switch (j3) {
            ...
            case 3:
                ...
                tp0Var.setBackgroundColor(aq0Var2.getThemedColor(org.telegram.ui.ActionBar.i6.f18834d6));
            ...
            case 6:
                ...
                r8Var.v();
                r8Var.setBackgroundColor(aq0Var.getThemedColor(org.telegram.ui.ActionBar.i6.f18834d6));
                r8Var.v();
                if (i10 == up0Var.V) {
                    if (aq0Var.f31870a) {
            ...
            case 7:
                ...
                m4Var.setBackgroundColor(aq0Var.getThemedColor(org.telegram.ui.ActionBar.i6.f18834d6));
                return;
            case 8:
                ip0 ip0Var = (ip0) view;
                int i17 = i10 - up0Var.f38081b0;
                if (i17 >= 0 && i17 < arrayList.size()) {
                    ...
                    TLRPC.TL_emojiStatusCollectible tL_emojiStatusCollectible = up0Var.f38098r;
                    if ((tL_emojiStatusCollectible != null && tL_emojiStatusCollectible.collectible_id == tL_starGiftUnique.f18334id) || ((tL_peerColorCollectible = up0Var.f38099s) != null && tL_peerColorCollectible.collectible_id == tL_starGiftUnique.f18334id)) {
                        z10 = true;
                    } else {
                        z10 = false;
                    }
            ...
            case 10:
                ...
                ArrayList arrayList4 = zp0Var.f40275f;
                if (zp0Var.K == 0) {
                    z11 = true;
                } else {
                    z11 = false;
            ...
            case 12:
                ...
                if (up0Var.J != null && i20 >= 0 && i20 < arrayList.size()) {
                    ...
                    TLRPC.TL_emojiStatusCollectible tL_emojiStatusCollectible2 = up0Var.f38098r;
                    if ((tL_emojiStatusCollectible2 == null || tL_emojiStatusCollectible2.collectible_id != tL_starGiftUnique2.f18334id) && ((tL_peerColorCollectible2 = up0Var.f38099s) == null || tL_peerColorCollectible2.collectible_id != tL_starGiftUnique2.f18334id)) {
                        z12 = false;
                    }
                    i1Var.e(z12, false);
                    return;
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        switch (i10) {
            case 1:
                ...
                up0Var.f38086f = xp0Var;
                xp0Var.setBackgroundColor(aq0Var.getThemedColor(org.telegram.ui.ActionBar.i6.f18834d6));
    ...
    public final void y(s4.c1 c1Var) {
        ...
        if (i10 == 8) {
            ip0 ip0Var = (ip0) view;
            int b10 = c1Var.b() - up0Var.f38081b0;
            if (b10 >= 0 && b10 < arrayList.size()) {
                ...
                TLRPC.TL_emojiStatusCollectible tL_emojiStatusCollectible = up0Var.f38098r;
                if ((tL_emojiStatusCollectible == null || tL_emojiStatusCollectible.collectible_id != tL_starGiftUnique.f18334id) && ((tL_peerColorCollectible2 = up0Var.f38099s) == null || tL_peerColorCollectible2.collectible_id != tL_starGiftUnique.f18334id)) {
                    z10 = false;
                }
                ip0Var.b(z10, false);
            }
            ...
            xh.i1 i1Var = (xh.i1) view;
            int b11 = c1Var.b() - up0Var.f38081b0;
            if (up0Var.J != null && b11 >= 0 && b11 < arrayList.size()) {
                ...
                i1Var.g(tL_starGiftUnique2, false, false, false, true, false);
                TLRPC.TL_emojiStatusCollectible tL_emojiStatusCollectible2 = up0Var.f38098r;
                if ((tL_emojiStatusCollectible2 == null || tL_emojiStatusCollectible2.collectible_id != tL_starGiftUnique2.f18334id) && ((tL_peerColorCollectible = up0Var.f38099s) == null || tL_peerColorCollectible.collectible_id != tL_starGiftUnique2.f18334id)) {
                    z10 = false;
                }
                i1Var.e(z10, false);
            }
