...
public final class ei0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    public static final org.telegram.ui.Components.ac0 f33346n;
    public static final org.telegram.ui.Components.ac0 f33347r;
    public final int f33348a;
    public final org.telegram.ui.Components.u9 f33349b;
    public final org.telegram.ui.ActionBar.j5 f33350c;
    public final TextView d;
    public final org.telegram.ui.Components.f9 e;
    public final org.telegram.ui.Components.kw0 f33351f;
    public TLObject h;

    static {
        int i10 = R.drawable.msg_mini_checks;
        int i11 = org.telegram.ui.ActionBar.i6.f19218y6;
        f33346n = new org.telegram.ui.Components.ac0(i10, i11);
        f33347r = new org.telegram.ui.Components.ac0(R.drawable.mini_checklist_done_outline, i11);
    }

    public ei0(Context context) {
        super(context);
        int i10;
        this.f33348a = UserConfig.selectedAccount;
        ...
        this.f33351f = new org.telegram.ui.Components.kw0(this);
        ...
        textView.setTextColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f19218y6, false));
    ...
    public final void a(TLObject tLObject, boolean z10, int i10) {
        ...
        org.telegram.ui.Components.kw0 kw0Var = this.f33351f;
        if (z11) {
        ...
        org.telegram.ui.ActionBar.j5 j5Var = this.f33350c;
        j5Var.i(a2);
        if (tLObject != null) {
            org.telegram.ui.Components.f9 f9Var = this.e;
            int i11 = this.f33348a;
            f9Var.j(i11, tLObject);
            this.f33349b.h(ImageLocation.getForUserOrChat(i11, tLObject, 1), "50_50", f9Var, tLObject);
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.userEmojiStatusUpdated) {
            ...
            if (user != null && user2 != null && user.f18259id == user2.f18259id) {
                this.h = user2;
                int w02 = org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f19240z9, false);
    ...
    public final void onAttachedToWindow() {
        ...
        this.f33351f.f25689a.a();
        NotificationCenter.getInstance(this.f33348a).addObserver(this, NotificationCenter.userEmojiStatusUpdated);
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        this.f33351f.f25689a.b();
        NotificationCenter.getInstance(this.f33348a).removeObserver(this, NotificationCenter.userEmojiStatusUpdated);
    }

    @Override
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        super.onInitializeAccessibilityNodeInfo(accessibilityNodeInfo);
        String formatString = LocaleController.formatString("AccDescrPersonHasSeen", R.string.AccDescrPersonHasSeen, this.f33350c.getText());
        TextView textView = this.d;
