        ...
        switch (this.f36509a) {
            case 0:
                ...
                if (!arrayList.isEmpty()) {
                    ...
                    if (mediaLocation != null) {
                        if (bzVar.f35639s == null) {
                            TLRPC.Document document = mediaLocation.document;
                            if (document != null) {
                                bzVar.f35639s = FileLoader.getAttachFileName(document, "tgs");
                            } else {
                                bzVar.f35639s = FileLoader.getAttachFileName(mediaLocation.location, "tgs");
                            }
                        }
                        if (bzVar.f35639s != null) {
                            Float fileProgress = ImageLoader.getInstance().getFileProgress(bzVar.f35639s);
                ...
                return;
            default:
                ti0 ti0Var2 = this.f36510b;
                lf.s0 s0Var = ti0Var2.d;
                if (s0Var != null) {
                    if (ti0Var2.B == 1.0f && ti0Var2.f41564n != null) {
                        z4 = true;
                    } else {
                        z4 = false;
                    }
                ...
                if (ti0Var2.B > 0.0f && ti0Var2.f41564n != null) {
                    ti0Var2.f41569r.reset();
                    float width = getWidth() / ti0Var2.f41556f.getWidth();
                    ti0Var2.f41569r.postScale(width, width);
                    ti0Var2.h.setLocalMatrix(ti0Var2.f41569r);
                    ti0Var2.f41564n.setAlpha((int) (ti0Var2.B * 255.0f));
                    canvas2 = canvas;
                    canvas2.drawRect(0.0f, 0.0f, getWidth(), getHeight(), ti0Var2.f41564n);
                } else {
                    canvas2 = canvas;
                }
    ...
    public void onLayout(boolean z4, int i10, int i11, int i12, int i13) {
        ...
        switch (this.f36509a) {
            case 1:
                ...
                ti0 ti0Var = this.f36510b;
                if (!ti0Var.f41553d0 || ti0Var.f41555e0) {
                    ...
                    if (ti0Var.C.getWidth() > 0) {
                        ...
                        int measuredHeight3 = (ti0Var.D.getMeasuredHeight() - AndroidUtilities.dp(8.0f)) - ti0Var.f41554e.d;
                        ...
                        FrameLayout frameLayout = ti0Var.f41548a0;
                        if (frameLayout != null) {
                            frameLayout.setX(l.d.c(6.0f, (ti0Var.U.l() + iArr[0]) - ti0Var.f41548a0.getMeasuredWidth(), 0));
                            RectF rectF = ti0Var.f41560i0;
                            if (rectF != null) {
                                FrameLayout frameLayout2 = ti0Var.f41548a0;
                                float max = Math.max(ti0Var.f41554e.f7758b, rectF.top - frameLayout2.getMeasuredWidth());
                                ti0Var.Z = max;
                                frameLayout2.setY(max);
                                hi0 hi0Var = ti0Var.f41550b0;
                                if (hi0Var != null) {
                                    hi0Var.setY(Math.max(ti0Var.f41554e.f7758b, (ti0Var.f41560i0.top - AndroidUtilities.dp(24.0f)) - ti0Var.f41550b0.getMeasuredHeight()));
                                }
                            } else {
                                float height2 = (ti0Var.U.getHeight() + iArr[1]) - mi0Var.getMeasuredHeight();
                                FrameLayout frameLayout3 = ti0Var.f41548a0;
                                float max2 = Math.max(ti0Var.f41554e.f7758b, height2 - frameLayout3.getMeasuredHeight()) + AndroidUtilities.dp(24.0f);
                                ti0Var.Z = max2;
                                frameLayout3.setY(max2);
                                hi0 hi0Var2 = ti0Var.f41550b0;
                                if (hi0Var2 != null) {
    ...
    public void onSizeChanged(int i10, int i11, int i12, int i13) {
        switch (this.f36509a) {
            case 1:
                ...
                ti0 ti0Var = this.f36510b;
                ug.c.c(ti0Var.f41558g0, ti0Var.C);
                ViewGroup viewGroup = ti0Var.W;
                if (viewGroup != null) {
