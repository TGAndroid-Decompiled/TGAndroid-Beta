...
public final class sh0 extends LinearLayout implements NotificationCenter.NotificationCenterDelegate {
    public final org.telegram.ui.Components.u9 f37496a;
    public final int f37497b;

    public sh0(Context context) {
        super(context);
        this.f37497b = UserConfig.selectedAccount;
    ...
    public final void a() {
        ...
        if (tL_messages_stickerSet != null && tL_messages_stickerSet.documents.size() >= 4) {
            ...
            this.f37496a.i(ImageLocation.getForDocument(document), "104_104", "tgs", DocumentObject.getSvgThumb(document, org.telegram.ui.ActionBar.j6.f18806a7, 1.0f), tL_messages_stickerSet);
            return;
        }
    ...
    public final void onAttachedToWindow() {
        ...
        a();
        NotificationCenter.getInstance(this.f37497b).addObserver(this, NotificationCenter.diceStickersDidLoad);
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        NotificationCenter.getInstance(this.f37497b).removeObserver(this, NotificationCenter.diceStickersDidLoad);
    }
}
