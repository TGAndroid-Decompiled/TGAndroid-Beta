...
public final class a60 extends FrameLayout {
    ...
    public boolean J;
    public final d60 K;
    public final org.telegram.ui.Components.lj0 f31993a;
    public final TextView f31994b;
    public final TLRPC.GroupCallParticipant f31995c;
    public final org.telegram.ui.Components.ij0 d;
    public boolean e;
    public float f31996f;
    public float h;
    public int f31997n;
    public double f31998r;
    public final Paint f31999s;
    public final Paint v;
    public final Path f32000w;
    public final float[] f32001x;
    public final RectF f32002y;
    ...
    public a60(d60 d60Var, Context context, TLRPC.GroupCallParticipant groupCallParticipant) {
        ...
        int i13;
        this.K = d60Var;
        this.f31999s = new Paint(1);
        Paint paint = new Paint(1);
        this.v = paint;
        this.f32000w = new Path();
        this.f32001x = new float[8];
        this.f32002y = new RectF();
        this.I = new float[3];
        setWillNotDraw(false);
        this.f31995c = groupCallParticipant;
        this.f31998r = ChatObject.getParticipantVolume(groupCallParticipant) / 20000.0f;
        this.G = 1.0f;
    ...
    public final void a(double d, boolean z10) {
        ...
        if (VoIPService.getSharedInstance() != null) {
            this.f31998r = d;
            TLRPC.GroupCallParticipant groupCallParticipant = this.f31995c;
            ...
            org.telegram.ui.Components.lj0 lj0Var = this.f31993a;
        ...
        if (motionEvent.getAction() != 1 && motionEvent.getAction() != 3) {
            if (motionEvent.getAction() == 2) {
                if (!this.e) {
                    ...
                    if (Math.abs(motionEvent.getY() - this.h) <= viewConfiguration.getScaledTouchSlop() && Math.abs(motionEvent.getX() - this.f31996f) > viewConfiguration.getScaledTouchSlop()) {
                        this.e = true;
                    ...
                    a(this.f31997n / getMeasuredWidth(), false);
                    invalidate();
                    return true;
                }
            }
            ...
            if (this.J) {
                if (motionEvent.getAction() == 1) {
                    a(this.f31997n / getMeasuredWidth(), true);
                }
                this.J = false;
                invalidate();
                return true;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        Path path = a60Var.f32000w;
        path.reset();
        float f12 = 6.0f;
        float dp2 = AndroidUtilities.dp(6.0f);
        float[] fArr = a60Var.f32001x;
        fArr[7] = dp2;
        fArr[6] = dp2;
        int i13 = 1;
        fArr[1] = dp2;
        fArr[0] = dp2;
        if (a60Var.f31997n < AndroidUtilities.dp(12.0f)) {
            f7 = Math.max(0.0f, (a60Var.f31997n - AndroidUtilities.dp(6.0f)) / AndroidUtilities.dp(6.0f));
        } else {
            f7 = 1.0f;
        }
        ...
        fArr[3] = dp3;
        fArr[2] = dp3;
        RectF rectF = a60Var.f32002y;
        rectF.set(0.0f, 0.0f, a60Var.f31997n, a60Var.getMeasuredHeight());
        path.addRoundRect(rectF, fArr, Path.Direction.CW);
        path.close();
        Canvas canvas2 = canvas;
        canvas2.drawPath(path, paint);
        int participantVolume = (int) (ChatObject.getParticipantVolume(a60Var.f31995c) / 100.0d);
        org.telegram.ui.Components.lj0 lj0Var = a60Var.f31993a;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f31997n = (int) (View.MeasureSpec.getSize(i10) * this.f31998r);
    }
