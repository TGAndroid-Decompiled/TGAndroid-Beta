...
public final class a60 extends FrameLayout {
    ...
    public boolean J;
    public final d60 K;
    public final org.telegram.ui.Components.lj0 f31979a;
    public final TextView f31980b;
    public final TLRPC.GroupCallParticipant f31981c;
    public final org.telegram.ui.Components.ij0 d;
    public boolean e;
    public float f31982f;
    public float h;
    public int f31983n;
    public double f31984r;
    public final Paint f31985s;
    public final Paint v;
    public final Path f31986w;
    public final float[] f31987x;
    public final RectF f31988y;
    ...
    public a60(d60 d60Var, Context context, TLRPC.GroupCallParticipant groupCallParticipant) {
        ...
        int i13;
        this.K = d60Var;
        this.f31985s = new Paint(1);
        Paint paint = new Paint(1);
        this.v = paint;
        this.f31986w = new Path();
        this.f31987x = new float[8];
        this.f31988y = new RectF();
        this.I = new float[3];
        setWillNotDraw(false);
        this.f31981c = groupCallParticipant;
        this.f31984r = ChatObject.getParticipantVolume(groupCallParticipant) / 20000.0f;
        this.G = 1.0f;
        ...
        this.f31979a = imageView;
        imageView.setScaleType(ImageView.ScaleType.CENTER);
        imageView.setAnimation(ij0Var);
        if (this.f31984r == 0.0d) {
            num = 1;
        } else {
            num = null;
        }
    ...
    public final void a(double d, boolean z10) {
        ...
        if (VoIPService.getSharedInstance() != null) {
            this.f31984r = d;
            TLRPC.GroupCallParticipant groupCallParticipant = this.f31981c;
            ...
            org.telegram.ui.Components.lj0 lj0Var = this.f31979a;
        ...
        if (motionEvent.getAction() != 1 && motionEvent.getAction() != 3) {
            if (motionEvent.getAction() == 2) {
                if (!this.e) {
                    ...
                    if (Math.abs(motionEvent.getY() - this.h) <= viewConfiguration.getScaledTouchSlop() && Math.abs(motionEvent.getX() - this.f31982f) > viewConfiguration.getScaledTouchSlop()) {
                        this.e = true;
                    ...
                    a(this.f31983n / getMeasuredWidth(), false);
                    invalidate();
                    return true;
                }
            }
            ...
            if (this.J) {
                if (motionEvent.getAction() == 1) {
                    a(this.f31983n / getMeasuredWidth(), true);
                }
                this.J = false;
                invalidate();
                return true;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        Path path = a60Var.f31986w;
        path.reset();
        float f12 = 6.0f;
        float dp2 = AndroidUtilities.dp(6.0f);
        float[] fArr = a60Var.f31987x;
        fArr[7] = dp2;
        fArr[6] = dp2;
        int i13 = 1;
        fArr[1] = dp2;
        fArr[0] = dp2;
        if (a60Var.f31983n < AndroidUtilities.dp(12.0f)) {
            f7 = Math.max(0.0f, (a60Var.f31983n - AndroidUtilities.dp(6.0f)) / AndroidUtilities.dp(6.0f));
        } else {
            f7 = 1.0f;
        }
        ...
        fArr[3] = dp3;
        fArr[2] = dp3;
        RectF rectF = a60Var.f31988y;
        rectF.set(0.0f, 0.0f, a60Var.f31983n, a60Var.getMeasuredHeight());
        path.addRoundRect(rectF, fArr, Path.Direction.CW);
        path.close();
        Canvas canvas2 = canvas;
        canvas2.drawPath(path, paint);
        int participantVolume = (int) (ChatObject.getParticipantVolume(a60Var.f31981c) / 100.0d);
        org.telegram.ui.Components.lj0 lj0Var = a60Var.f31979a;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f31983n = (int) (View.MeasureSpec.getSize(i10) * this.f31984r);
    }
