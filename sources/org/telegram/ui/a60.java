...
public final class a60 extends FrameLayout {
    ...
    public boolean J;
    public final d60 K;
    public final org.telegram.ui.Components.mj0 f31992a;
    public final TextView f31993b;
    public final TLRPC.GroupCallParticipant f31994c;
    public final org.telegram.ui.Components.jj0 d;
    public boolean e;
    public float f31995f;
    public float h;
    public int f31996n;
    public double f31997r;
    public final Paint f31998s;
    public final Paint v;
    public final Path f31999w;
    public final float[] f32000x;
    public final RectF f32001y;
    ...
    public a60(d60 d60Var, Context context, TLRPC.GroupCallParticipant groupCallParticipant) {
        ...
        int i13;
        this.K = d60Var;
        this.f31998s = new Paint(1);
        Paint paint = new Paint(1);
        this.v = paint;
        this.f31999w = new Path();
        this.f32000x = new float[8];
        this.f32001y = new RectF();
        this.I = new float[3];
        setWillNotDraw(false);
        this.f31994c = groupCallParticipant;
        this.f31997r = ChatObject.getParticipantVolume(groupCallParticipant) / 20000.0f;
        this.G = 1.0f;
        setPadding(AndroidUtilities.dp(12.0f), 0, AndroidUtilities.dp(12.0f), 0);
        org.telegram.ui.Components.jj0 jj0Var = new org.telegram.ui.Components.jj0(R.raw.speaker, AndroidUtilities.dp(24.0f), AndroidUtilities.dp(24.0f), true, null);
        this.d = jj0Var;
        ?? imageView = new ImageView(context);
        this.f31992a = imageView;
        imageView.setScaleType(ImageView.ScaleType.CENTER);
        imageView.setAnimation(jj0Var);
        if (this.f31997r == 0.0d) {
            num = 1;
        } else {
            num = null;
        }
    ...
    public final void a(double d, boolean z10) {
        ...
        if (VoIPService.getSharedInstance() != null) {
            this.f31997r = d;
            TLRPC.GroupCallParticipant groupCallParticipant = this.f31994c;
            ...
            org.telegram.ui.Components.mj0 mj0Var = this.f31992a;
            if ((mj0Var.getTag() == null && num != null) || (mj0Var.getTag() != null && num == null)) {
                if (this.f31997r == 0.0d) {
                    i10 = 17;
                } else {
                    i10 = 34;
        ...
        if (motionEvent.getAction() != 1 && motionEvent.getAction() != 3) {
            if (motionEvent.getAction() == 2) {
                if (!this.e) {
                    ...
                    if (Math.abs(motionEvent.getY() - this.h) <= viewConfiguration.getScaledTouchSlop() && Math.abs(motionEvent.getX() - this.f31995f) > viewConfiguration.getScaledTouchSlop()) {
                        this.e = true;
                    ...
                    a(this.f31996n / getMeasuredWidth(), false);
                    invalidate();
                    return true;
                }
            }
            ...
            if (this.J) {
                if (motionEvent.getAction() == 1) {
                    a(this.f31996n / getMeasuredWidth(), true);
                }
                this.J = false;
                invalidate();
                return true;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        Path path = a60Var.f31999w;
        path.reset();
        float f12 = 6.0f;
        float dp2 = AndroidUtilities.dp(6.0f);
        float[] fArr = a60Var.f32000x;
        fArr[7] = dp2;
        fArr[6] = dp2;
        int i13 = 1;
        fArr[1] = dp2;
        fArr[0] = dp2;
        if (a60Var.f31996n < AndroidUtilities.dp(12.0f)) {
            f7 = Math.max(0.0f, (a60Var.f31996n - AndroidUtilities.dp(6.0f)) / AndroidUtilities.dp(6.0f));
        } else {
            f7 = 1.0f;
        }
        ...
        fArr[3] = dp3;
        fArr[2] = dp3;
        RectF rectF = a60Var.f32001y;
        rectF.set(0.0f, 0.0f, a60Var.f31996n, a60Var.getMeasuredHeight());
        path.addRoundRect(rectF, fArr, Path.Direction.CW);
        path.close();
        Canvas canvas2 = canvas;
        canvas2.drawPath(path, paint);
        int participantVolume = (int) (ChatObject.getParticipantVolume(a60Var.f31994c) / 100.0d);
        org.telegram.ui.Components.mj0 mj0Var = a60Var.f31992a;
        int dp4 = AndroidUtilities.dp(5.0f) + (mj0Var.getMeasuredWidth() / 2) + mj0Var.getLeft();
        int measuredHeight = (mj0Var.getMeasuredHeight() / 2) + mj0Var.getTop();
        int i14 = 0;
        while (true) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f31996n = (int) (View.MeasureSpec.getSize(i10) * this.f31997r);
    }
