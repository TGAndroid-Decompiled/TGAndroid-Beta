...
public final class b20 extends FrameLayout {
    ...
    public final org.telegram.ui.ActionBar.k5 f32030a;
    public final TextView f32031b;
    public final ImageView f32032c;
    public int d;
    public int e;
    public final View f32033f;
    public final ImageView h;
    public final org.telegram.ui.Components.j30 f32034n;
    public boolean f32035r;
    public final org.telegram.ui.Components.g90 f32036s;
    public boolean v;
    public float f32037w;
    public MessagesController.DialogFilter f32038x;
    public ValueAnimator f32039y;
    ...
    public b20(FiltersSetupActivity filtersSetupActivity, Context context) {
        ...
        g90Var.C = true;
        g90Var.f24149t = 2.0f;
        int i22 = org.telegram.ui.ActionBar.j6.f18953i6;
        ...
        g90Var.f24151w.setStrokeWidth(dp);
        g90Var.j(40.0f);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        MessagesController.DialogFilter dialogFilter = this.f32038x;
        if (dialogFilter != null) {
            boolean z10 = dialogFilter.locked;
            if (z10) {
                float f7 = this.f32037w;
                if (f7 != 1.0f) {
                    this.f32037w = f7 + 0.10666667f;
                    invalidate();
                }
            }
            if (!z10) {
                float f10 = this.f32037w;
                if (f10 != 0.0f) {
                    this.f32037w = f10 - 0.10666667f;
                    invalidate();
                }
            }
        }
        float clamp = Utilities.clamp(this.f32037w, 1.0f, 0.0f);
        this.f32037w = clamp;
        org.telegram.ui.ActionBar.k5 k5Var = this.f32030a;
    ...
    public void setOnReorderButtonTouchListener(View.OnTouchListener onTouchListener) {
        this.f32032c.setOnTouchListener(onTouchListener);
    }
}
