...
public final class b20 extends og.a {
    ...
    public final boolean equals(Object obj) {
        ...
        b20 b20Var = (b20) obj;
        int i10 = b20Var.f15531a;
        int i11 = this.f15531a;
        if (i10 != i11) {
            return false;
        }
        if ((i11 == 0 || i11 == 4 || i11 == 3 || i11 == 6) && !TextUtils.equals(this.f32020c, b20Var.f32020c)) {
            return false;
        }
        int i12 = this.f15531a;
        if (i12 == 2) {
            ...
            if (dialogFilter != null && dialogFilter.f15601id != dialogFilter2.f15601id) {
                return false;
            }
        }
        if (i12 == 5) {
            ...
            if (tL_dialogFilterSuggested != null && tL_dialogFilterSuggested.filter.f18114id != tL_dialogFilterSuggested2.filter.f18114id) {
                return false;
            }
        }
        return true;
