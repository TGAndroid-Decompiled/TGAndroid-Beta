...
public final class b20 extends FrameLayout {
    public org.telegram.ui.ActionBar.h5 f32297a;
    public ImageView f32298b;

    @Override
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        int dp;
        int measuredWidth;
        ImageView imageView = this.f32298b;
        int i14 = i12 - i10;
        org.telegram.ui.ActionBar.h5 h5Var = this.f32297a;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f32297a.measure(org.telegram.messenger.ok.c(94.0f, size, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), 1073741824));
        this.f32298b.measure(View.MeasureSpec.makeMeasureSpec(size, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(50.0f), 1073741824));
