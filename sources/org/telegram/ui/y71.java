...
public final class y71 implements RequestDelegate {
    public final int f40173a;
    public final SessionsActivity f40174b;

    public y71(SessionsActivity sessionsActivity, int i10) {
        this.f40173a = i10;
        this.f40174b = sessionsActivity;
    }
    ...
    public final void run(final TLObject tLObject, final TLRPC.TL_error tL_error) {
        switch (this.f40173a) {
            case 0:
                AndroidUtilities.runOnUIThread(new sz0(this.f40174b, 17));
                return;
            case 1:
                final SessionsActivity sessionsActivity = this.f40174b;
                ...
                return;
            case 2:
                final SessionsActivity sessionsActivity2 = this.f40174b;
                AndroidUtilities.runOnUIThread(new Runnable() {
                    @Override
                    public final void run() {
                        org.telegram.ui.Components.qc a02;
                ...
                return;
            default:
                final SessionsActivity sessionsActivity3 = this.f40174b;
                AndroidUtilities.runOnUIThread(new Runnable() {
                    @Override
                    public final void run() {
                        org.telegram.ui.Components.qc a02;
