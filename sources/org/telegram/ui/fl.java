...
public final class fl extends org.telegram.ui.Components.yb0 {
    ...
    public final void b() {
        ...
        if (nnVar2 != null && (messageObject = nnVar2.f39484a) != null && ((nnVar = xnVar.f43144c5.quote) == null || nnVar.f39484a == null || messageObject.getId() == xnVar.f43144c5.quote.f39484a.getId())) {
            return;
        }
        xnVar.f43221i5 = xnVar.f43144c5.quote;
    }
        ...
        if (messagePreviewParams != null) {
            ...
            if (messages2 != null) {
                ...
                for (int i13 = 0; i13 < size; i13++) {
                    MessageObject messageObject = xnVar.f43144c5.forwardMessages.messages.get(i13);
            ...
            if (!z4 && (messages = xnVar.f43144c5.replyMessage) != null && !messages.messages.isEmpty() && xnVar.f43144c5.quote == null) {
                z11 = true;
            } else {
                z11 = false;
            }
            e6.putBoolean("reply_to", z11);
            if (z11 && (DialogObject.getPeerDialogId(xnVar.f43144c5.replyMessage.messages.get(0).getFromPeer())) != 0 && peerDialogId != xnVar.a() && peerDialogId != xnVar.getUserConfig().getClientUserId() && i11 > 0) {
                e6.putLong("reply_to_author", peerDialogId);
            }
            e6.putInt("hasPoll", i10);
            e6.putBoolean("hasInvoice", z10);
            MessagePreviewParams.Messages messages3 = xnVar.f43144c5.forwardMessages;
            if (messages3 != null) {
