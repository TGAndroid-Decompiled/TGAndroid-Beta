...
public final class fr0 extends org.telegram.ui.Components.qv0 {
    ...
    public final boolean a0(MotionEvent motionEvent, boolean z10) {
        ...
        this.f33744y0 = false;
        this.f33743x0 = true;
        this.f33745z0 = (int) motionEvent.getX();
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        canvas.drawLine(0.0f, translationY, getWidth(), translationY, org.telegram.ui.ActionBar.j6.f18984k0);
    }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent != null && motionEvent.getAction() == 0 && !this.f33743x0 && !this.f33744y0) {
            this.f33742w0 = motionEvent.getPointerId(0);
            this.f33744y0 = true;
            this.f33745z0 = (int) motionEvent.getX();
            this.A0 = (int) motionEvent.getY();
            this.B0.clear();
        } else if (motionEvent != null && motionEvent.getAction() == 2 && motionEvent.getPointerId(0) == this.f33742w0) {
            int x10 = (int) (motionEvent.getX() - this.f33745z0);
            int abs = Math.abs(((int) motionEvent.getY()) - this.A0);
            if (this.f33743x0 && (((z12 = ir0Var.v) && x10 > 0) || (!z12 && x10 < 0))) {
                if (x10 < 0) {
                    z13 = true;
                } else {
                    z13 = false;
            ...
            if (this.f33744y0 && !this.f33743x0) {
        ...
        } else if (motionEvent == null || (motionEvent.getPointerId(0) == this.f33742w0 && (motionEvent.getAction() == 3 || motionEvent.getAction() == 1 || motionEvent.getAction() == 6))) {
            this.B0.computeCurrentVelocity(1000, ir0Var.f34665x);
            if (motionEvent != null && motionEvent.getAction() != 3) {
                f7 = this.B0.getXVelocity();
                f10 = this.B0.getYVelocity();
                if (!this.f33743x0 && Math.abs(f7) >= 3000.0f && Math.abs(f7) > Math.abs(f10)) {
                    if (f7 < 0.0f) {
                        z11 = true;
                    } else {
                        z11 = false;
            ...
            if (this.f33743x0) {
                ...
                ir0Var.f34662r = new AnimatorSet();
                ...
                if (z10) {
                    ...
                    if (ir0Var.v) {
                        ir0Var.f34662r.playTogether(ObjectAnimator.ofFloat(gr0VarArr[0], property, 0.0f), ObjectAnimator.ofFloat(gr0VarArr[1], property, gr0Var4.getMeasuredWidth()));
                    } else {
                        ir0Var.f34662r.playTogether(ObjectAnimator.ofFloat(gr0VarArr[0], property, 0.0f), ObjectAnimator.ofFloat(gr0VarArr[1], property, -gr0Var3.getMeasuredWidth()));
                    }
                } else {
                    measuredWidth = gr0VarArr[0].getMeasuredWidth() - Math.abs(x11);
                    if (ir0Var.v) {
                        ir0Var.f34662r.playTogether(ObjectAnimator.ofFloat(gr0VarArr[0], property, -gr0Var2.getMeasuredWidth()), ObjectAnimator.ofFloat(gr0VarArr[1], property, 0.0f));
                    } else {
                        ir0Var.f34662r.playTogether(ObjectAnimator.ofFloat(gr0VarArr[0], property, gr0Var.getMeasuredWidth()), ObjectAnimator.ofFloat(gr0VarArr[1], property, 0.0f));
                    }
                }
                ir0Var.f34662r.setInterpolator(ir0.f34656y);
                ...
                ir0Var.f34662r.setDuration(Math.max(150, Math.min(measuredWidth2, 600)));
                ir0Var.f34662r.addListener(new er0(this, 0));
                ir0Var.f34662r.start();
                ir0Var.f34663s = true;
                this.f33743x0 = false;
            } else {
                this.f33744y0 = false;
