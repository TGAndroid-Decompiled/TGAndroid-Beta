...
public final class vu extends org.telegram.ui.ActionBar.m2 {
    ...
    public static final int[] f38814f = {R.drawable.msg_filled_data_videos, R.drawable.msg_filled_data_files, R.drawable.msg_filled_data_photos, R.drawable.msg_filled_data_messages, R.drawable.msg_filled_data_music, R.drawable.msg_filled_data_voice, R.drawable.msg_filled_data_calls};
    ...
    public static final int[] f38815n = {2, 5, 4, 1, 7, 3, 0};
    public org.telegram.ui.Components.w81 f38816a;
    public org.telegram.ui.Components.v81 f38817b;
    ...
    public final View createView(Context context) {
        ...
        org.telegram.ui.Components.v81 n10 = this.f38816a.n(8, true);
        this.f38817b = n10;
        n10.setBackgroundColor(getThemedColor(i10));
        k0Var.addView(this.f38817b, w7.y5.e(-1, 48, 55));
        k0Var.addView(this.f38816a, w7.y5.d(-1, -1.0f, 119, 0.0f, 48.0f, 0.0f, 0.0f));
    ...
    public final boolean isSwipeBackEnabled(MotionEvent motionEvent) {
        ...
        if (this.f38816a.getCurrentPosition() == 0) {
            return true;
        }
        return false;
    }
    ...
    public final void r0() {
        View currentView = this.f38816a.getCurrentView();
