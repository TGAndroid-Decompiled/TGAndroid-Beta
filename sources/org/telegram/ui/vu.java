...
public final class vu extends org.telegram.ui.ActionBar.m2 {
    ...
    public static final int[] f38799f = {R.drawable.msg_filled_data_videos, R.drawable.msg_filled_data_files, R.drawable.msg_filled_data_photos, R.drawable.msg_filled_data_messages, R.drawable.msg_filled_data_music, R.drawable.msg_filled_data_voice, R.drawable.msg_filled_data_calls};
    ...
    public static final int[] f38800n = {2, 5, 4, 1, 7, 3, 0};
    public org.telegram.ui.Components.w81 f38801a;
    public org.telegram.ui.Components.v81 f38802b;
    public boolean f38803c;
    ...
    public final View createView(Context context) {
        ...
        int i10 = org.telegram.ui.ActionBar.h6.f19396w8;
        kVar.setBackgroundColor(getThemedColor(i10));
        org.telegram.ui.ActionBar.k kVar2 = this.actionBar;
        int i11 = org.telegram.ui.ActionBar.h6.G6;
        kVar2.setTitleColor(getThemedColor(i11));
        this.actionBar.B(getThemedColor(i11), false);
        this.actionBar.A(getThemedColor(org.telegram.ui.ActionBar.h6.f19134i6), false);
        this.actionBar.setCastShadows(false);
        this.actionBar.setActionBarMenuOnItemClick(new oo(this, 19));
        k0 k0Var = new k0(this, context, 6);
        k0Var.setBackgroundColor(getThemedColor(org.telegram.ui.ActionBar.h6.f18989a7));
        org.telegram.ui.Components.w81 w81Var = new org.telegram.ui.Components.w81(context, null);
        this.f38801a = w81Var;
        w81Var.setAdapter(new su(this));
        org.telegram.ui.Components.v81 n10 = this.f38801a.n(8, true);
        this.f38802b = n10;
        n10.setBackgroundColor(getThemedColor(i10));
        k0Var.addView(this.f38802b, w7.y5.e(-1, 48, 55));
        k0Var.addView(this.f38801a, w7.y5.d(-1, -1.0f, 119, 0.0f, 48.0f, 0.0f, 0.0f));
    ...
    public final boolean isLightStatusBar() {
        ...
        if (AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19396w8, false)) <= 0.721f) {
            return false;
        }
        return true;
    }
    ...
    public final boolean isSwipeBackEnabled(MotionEvent motionEvent) {
        ...
        if (this.f38801a.getCurrentPosition() == 0) {
            return true;
        }
        return false;
    }
    ...
    public final void r0() {
        View currentView = this.f38801a.getCurrentView();
