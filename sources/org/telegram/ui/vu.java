...
public final class vu extends og.b {
    ...
    public final boolean D(s4.c1 c1Var) {
        switch (this.d) {
            case 0:
                su suVar = (su) ((xu) this.e).f39708c3.get(c1Var.b());
    ...
    public final int h() {
        switch (this.d) {
            case 0:
                return ((xu) this.e).f39708c3.size();
            default:
                return ((pc0) this.e).f36603s.size();
        }
    }
    ...
    public final int j(int i10) {
        switch (this.d) {
            case 0:
                return ((su) ((xu) this.e).f39708c3.get(i10)).f15543a;
            default:
                pc0 pc0Var = (pc0) this.e;
                if (i10 >= 0 && i10 < pc0Var.f36603s.size()) {
                    return ((jc0) pc0Var.f36603s.get(i10)).f15543a;
                }
                return 2;
        }
    }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        switch (i11) {
            case 0:
                ...
                org.telegram.ui.ActionBar.f6 f6Var = xuVar.f26194p2;
                if (i10 != 0) {
                    if (i10 != 1) {
                        if (i10 != 3) {
                            if (i10 != 4) {
                                if (i10 != 5) {
                                    if (i10 != 6) {
                                        if (i10 != 7) {
                                            ...
                                            int i13 = xu.f39705p3;
                                            knVar.setBackgroundColor(org.telegram.ui.ActionBar.j6.v0(i12, xuVar.f26194p2));
                                            r8Var = knVar;
                                        }
                                    } else {
                                        ?? view2 = new View(xuVar.getContext());
                                        view2.f40346a = new Path();
                                    ...
                                    r8Var2.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19083p7, f6Var));
                                    r8Var2.setBackgroundColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f18863d6, f6Var));
                                    r8Var = r8Var2;
                                }
                            } else {
                                View l4Var = new org.telegram.ui.Cells.l4(xuVar.getContext());
                                l4Var.setBackgroundColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f18863d6, f6Var));
                                r8Var = l4Var;
                            }
                        } else {
                        ...
                        frameLayout.f31988a = textView;
                        textView.setGravity(17);
                        textView.setTextSize(1, 13.0f);
                        textView.setTextColor(bvVar.getThemedColor(org.telegram.ui.ActionBar.j6.f19245y6));
                    ...
                    xuVar.f39718n3 = uuVar;
                    uuVar.setInterceptTouch(false);
                    View view3 = xuVar.f39718n3;
                    view3.setTag(-33024);
                    r8Var = view3;
                }
