...
public final class vu extends org.telegram.ui.Components.ll0 {
    public static final int f38685p3 = 0;
    public boolean X2;
    public int Y2;
    public final s4.c0 Z2;
    public final tu f38686a3;
    public final ArrayList f38687b3;
    public final ArrayList f38688c3;
    public final float[] f38689d3;
    public final int[] f38690e3;
    public final ArrayList f38691f3;
    public uu[] f38692g3;
    public uu[] f38693h3;
    public final boolean[] f38694i3;
    public long j3;
    public long f38695k3;
    public long f38696l3;
    public boolean f38697m3;
    public su f38698n3;
    public final zu f38699o3;
    ...
    public vu(zu zuVar, Activity activity) {
        ...
        this.X2 = false;
        this.Y2 = 0;
        this.f38687b3 = new ArrayList();
        this.f38688c3 = new ArrayList();
        this.f38689d3 = new float[7];
        this.f38690e3 = new int[7];
        this.f38691f3 = new ArrayList();
        this.f38694i3 = new boolean[7];
    ...
    public final void A1(boolean z10) {
        ...
        String format;
        CharSequence concat;
        ArrayList arrayList = this.f38687b3;
        arrayList.clear();
        ArrayList arrayList2 = this.f38688c3;
        ...
        int i14 = 0;
        while (true) {
            uu[] uuVarArr = this.f38692g3;
            if (i14 >= uuVarArr.length) {
                break;
            }
            uu uuVar = uuVarArr[i14];
            long j10 = j3;
            long j11 = uuVar.f22361c;
            int i15 = uuVar.d;
            if (!this.f38697m3 && !this.f38691f3.contains(Integer.valueOf(i15))) {
                z11 = false;
            } else {
                z11 = true;
            }
        ...
        if (!arrayList3.isEmpty()) {
            ...
            while (i22 < arrayList3.size()) {
                ...
                if (i23 >= 0 && !this.f38694i3[i23]) {
                    uu uuVar2 = this.f38692g3[i23];
                    int[] iArr2 = zu.f40298n;
                    int i24 = uuVar2.d;
                    int i25 = uuVar2.f38162g;
                    int i26 = uuVar2.h;
                    long j13 = uuVar2.e;
                    spannableString = spannableString4;
                    spannableString2 = spannableString5;
                    long j14 = uuVar2.f38161f;
                    int i27 = iArr2[i24];
                    if (i27 == 0) {
                        if (j14 > j12 || i26 > 0) {
                            i22++;
        ...
        if (!this.f38697m3) {
            ...
            arrayList2.add(new qu(-1, R.drawable.msg_filled_data_sent, -11565578, -13276952, LocaleController.getString(R.string.BytesSent), AndroidUtilities.formatFileSize(this.f38696l3)));
            arrayList2.add(new qu(-1, R.drawable.msg_filled_data_received, -11154873, -14175180, LocaleController.getString(R.string.BytesReceived), AndroidUtilities.formatFileSize(this.f38695k3)));
        }
        if (!arrayList3.isEmpty()) {
            i10 = 3;
    ...
    public final void z1() {
        ...
        this.f38695k3 = w1(6);
        this.f38696l3 = y1(6);
        if (this.f38692g3 == null) {
            this.f38692g3 = new uu[7];
        }
        if (this.f38693h3 == null) {
            this.f38693h3 = new uu[7];
        }
        int i19 = 0;
        while (true) {
            int[] iArr = zu.f40298n;
            int length = iArr.length;
            float[] fArr = this.f38689d3;
            if (i19 < length) {
                int i20 = iArr[i19];
                long w12 = w1(i20) + y1(i20);
                uu[] uuVarArr = this.f38693h3;
                uu[] uuVarArr2 = this.f38692g3;
                ...
                Arrays.sort(this.f38692g3, new df(20));
                AndroidUtilities.roundPercents(fArr, this.f38690e3);
                Arrays.fill(this.f38694i3, true);
                return;
            }
        }
    }
