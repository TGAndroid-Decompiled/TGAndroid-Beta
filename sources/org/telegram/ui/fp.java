...
public final class fp implements org.telegram.ui.Components.kl0 {
    ...
    public final void d(int i10, View view) {
        ...
        int i12;
        int i13;
        hp hpVar = this.f33591a;
        ip ipVar = hpVar.f34202a3;
        if ((view instanceof oa) && (tL_username = ((oa) view).v) != null) {
            if (tL_username.editable) {
                View view2 = ipVar.fragmentView;
                if (view2 instanceof ScrollView) {
                    ((ScrollView) view2).smoothScrollTo(0, ipVar.f34598y.getTop() - AndroidUtilities.dp(128.0f));
                }
                ipVar.f34570a.requestFocus();
                AndroidUtilities.showKeyboard(ipVar.f34570a);
                return;
            }
