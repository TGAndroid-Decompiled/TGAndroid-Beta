...
public final class fp implements org.telegram.ui.Components.ml0 {
    ...
    public final void d(int i10, View view) {
        ...
        int i12;
        int i13;
        hp hpVar = this.f33730a;
        ip ipVar = hpVar.f34270a3;
        if ((view instanceof oa) && (tL_username = ((oa) view).v) != null) {
            if (tL_username.editable) {
                View view2 = ipVar.fragmentView;
                if (view2 instanceof ScrollView) {
                    ((ScrollView) view2).smoothScrollTo(0, ipVar.f34682y.getTop() - AndroidUtilities.dp(128.0f));
                }
                ipVar.f34654a.requestFocus();
                AndroidUtilities.showKeyboard(ipVar.f34654a);
                return;
            }
