...
public final class sz0 extends org.telegram.ui.Components.qv0 implements r0.n {
    ...
    public final c5.e f41406t0;
    public final ProfileActivity f41407u0;
    public boolean f41408v0;
    public final Paint f41409w0;
    public boolean f41410x0;
    public final ArrayList f41411y0;
    public final du f41412z0;

    public sz0(ProfileActivity profileActivity, Context context) {
        super(context, null);
        this.A0 = profileActivity;
        this.f41407u0 = profileActivity;
        this.f41406t0 = new Object();
        this.f41409w0 = new Paint();
        this.f41411y0 = new ArrayList();
        this.f41412z0 = new du(8);
    }
    ...
    public final void E(ViewGroup viewGroup, int i10, int i11, int[] iArr, int i12) {
        ...
        int L0;
        int max;
        ProfileActivity profileActivity = this.f41407u0;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (Build.VERSION.SDK_INT >= 31 && eVar != null) {
            ...
            if (dVar != null && !dVar.f48092n) {
                ...
                a2.drawColor(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.f21605a7, profileActivity.f34714w0));
        ...
        if (profileActivity.f34560a.getVisibility() == 0) {
            ...
            ArrayList arrayList = this.f41411y0;
            arrayList.clear();
            boolean z10 = false;
            ...
            Collections.sort(arrayList, this.f41412z0);
        ...
        if (!profileActivity.F0) {
            ...
            if (oy0Var != null) {
                f10 = oy0Var.getTranslationX();
            } else {
                f10 = 0.0f;
            }
            canvas.translate(f10, 0.0f);
            int v03 = org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.f21659d6, profileActivity.f34714w0);
            int i13 = profileActivity.f34624i6;
            oy0 oy0Var2 = profileActivity.f34560a;
            if (oy0Var2 != null) {
                f11 = oy0Var2.getAlpha();
            }
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (uz0Var != null && (rt0Var = (rt0VarArr = uz0Var.f33980h0)[0]) != null && rt0Var.h.getFastScroll() != null && rt0VarArr[0].h.getFastScroll().f26044n) {
    ...
    public final void onMeasure(int r20, int r21) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.sz0.onMeasure(int, int):void");
    }
