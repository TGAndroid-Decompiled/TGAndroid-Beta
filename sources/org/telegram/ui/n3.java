...
public final class n3 implements zu0 {
    public final TLRPC.WebPage f35925a;
    public final List f35926b;
    public final h4 f35927c;

    public n3(h4 h4Var, TLRPC.WebPage webPage, List list) {
        this.f35927c = h4Var;
        this.f35925a = webPage;
        this.f35926b = list;
    }

    @Override
    public final boolean a(int i10) {
        if (i10 < this.f35926b.size() && i10 >= 0 && e4.g(this.f35925a, get(i10))) {
            return true;
        }
        return false;
    }
    ...
    public final boolean e(int i10) {
        if (i10 < this.f35926b.size() && i10 >= 0 && !e4.g(this.f35925a, get(i10))) {
            f4 f4Var = this.f35927c.f34168u0[0].f35431c;
            TL_iv.PageBlock pageBlock = get(i10);
            f4Var.getClass();
            if (f4.I(pageBlock) == 5) {
                return true;
    ...
    public final TL_iv.PageBlock get(int i10) {
        return (TL_iv.PageBlock) this.f35926b.get(i10);
    }
    ...
    public final void h(TL_iv.PageBlock pageBlock) {
        h4 h4Var = this.f35927c;
        int childCount = h4Var.f34168u0[0].f35430b.getChildCount();
        for (int i10 = 0; i10 < childCount; i10++) {
            View childAt = h4Var.f34168u0[0].f35430b.getChildAt(i10);
            if (childAt instanceof p2) {
                p2 p2Var = (p2) childAt;
                int indexOf = p2Var.d.items.indexOf(pageBlock);
                if (indexOf != -1) {
                    p2Var.f36492a.x(indexOf, false);
                    return;
                }
            }
        }
