...
public final class nt {
    public static TextPaint f35946f0;
    public static volatile nt f35947g0;
    ...
    public int f35948a;
    public TLRPC.InputStickerSet f35949a0;
    public int f35950b;
    public Object f35951b0;
    public float f35952c;
    public org.telegram.ui.ActionBar.d6 f35953c0;
    public float d;
    public VibrationEffect f35954d0;
    public boolean f35955e0;
    public float f35956f;
    public float f35957g;
    public View h;
    public boolean f35958i;
    public org.telegram.ui.Components.f21 f35959j;
    public org.telegram.ui.ActionBar.m1 f35960k;
    public lt f35961l;
    public boolean f35962m;
    public boolean f35963n;
    public ArrayList f35964o;
    public boolean f35965p;
    public int f35967r;
    public final fh.b f35968s;
    public final ah.c f35969t;
    public final ColorDrawable f35970u;
    public Bitmap v;
    public Activity f35971w;
    public WindowManager.LayoutParams f35972x;
    public k0 f35973y;
    public ci.m6 f35974z;
    public float e = 0.0f;
    public i0.b f35966q = i0.b.e;

    public nt() {
        fh.b bVar = new fh.b();
        this.f35968s = bVar;
        this.f35969t = new ah.c(bVar);
        this.f35970u = new ColorDrawable(1895825408);
    ...
    public static void a(nt ntVar, Bitmap bitmap, Bitmap bitmap2) {
        ...
        bVar.a(bitmap2);
        gh.d.c(bVar, ntVar.f35973y);
        ntVar.f35969t.d();
        ntVar.f35955e0 = false;
        ci.m6 m6Var = ntVar.f35974z;
        if (m6Var != null) {
            m6Var.invalidate();
        }
    }
    ...
    public static int d(nt ntVar, int i10) {
        return org.telegram.ui.ActionBar.h6.v0(i10, ntVar.f35953c0);
    }
    ...
    public static boolean h(nt ntVar, ActionBarPopupWindow$ActionBarPopupWindowLayout actionBarPopupWindow$ActionBarPopupWindowLayout) {
        ...
        TLRPC.PollAnswer h = ntVar.f35961l.h();
        ...
        if (!MessageObject.isVoted(d) && !d.poll.closed && !ntVar.f35961l.c()) {
            z11 = true;
        } else {
            z11 = false;
        }
        ...
        if (z10) {
            qh.q qVar2 = new qh.q(actionBarPopupWindow$ActionBarPopupWindowLayout.getContext(), ntVar.f35967r, ntVar.f35953c0);
            org.telegram.ui.Components.y70 y70Var = new org.telegram.ui.Components.y70(actionBarPopupWindow$ActionBarPopupWindowLayout, ntVar.f35953c0);
            int b10 = actionBarPopupWindow$ActionBarPopupWindowLayout.b(y70Var.B);
            int i10 = org.telegram.ui.ActionBar.h6.E8;
            y70Var.T(org.telegram.ui.ActionBar.h6.l1(0.06f, org.telegram.ui.ActionBar.h6.v0(i10, ntVar.f35953c0)));
            ah.c cVar = ntVar.f35969t;
            dh.e k10 = eh.b.k(ntVar.f35953c0);
            ...
            y70Var.k();
            MessageObject A = ntVar.f35961l.A();
            Activity activity = ntVar.f35971w;
            if ((activity instanceof LaunchActivity) && A != null) {
                ...
                if (m2Var != null) {
                    ...
                    qVar.f42074a.d(pollResult.recent_voters, false);
                    qVar.setLayoutParams(w7.y5.n(-1, 48));
                    qVar.setBackground(org.telegram.ui.ActionBar.h6.Y(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.I5, ntVar.f35953c0), 12, 0));
                    ...
                    org.telegram.ui.ActionBar.j1 j1Var = new org.telegram.ui.ActionBar.j1(actionBarPopupWindow$ActionBarPopupWindowLayout.getContext(), ntVar.f35953c0);
                    j1Var.setTag(R.id.fit_width_tag, 1);
                    j1Var.setColor(org.telegram.ui.ActionBar.h6.l1(0.06f, org.telegram.ui.ActionBar.h6.v0(i10, ntVar.f35953c0)));
            ...
            qVar.setOnClickListener(new ci.n4(actionBarPopupWindow$ActionBarPopupWindowLayout, b10, 17));
            actionBarPopupWindow$ActionBarPopupWindowLayout.addView(qVar);
            org.telegram.ui.ActionBar.j1 j1Var2 = new org.telegram.ui.ActionBar.j1(actionBarPopupWindow$ActionBarPopupWindowLayout.getContext(), ntVar.f35953c0);
            j1Var2.setTag(R.id.fit_width_tag, 1);
            j1Var2.setColor(org.telegram.ui.ActionBar.h6.l1(0.06f, org.telegram.ui.ActionBar.h6.v0(i10, ntVar.f35953c0)));
        ...
        if (z11) {
            f7 = 0.06f;
            org.telegram.ui.ActionBar.u0.c(false, false, actionBarPopupWindow$ActionBarPopupWindowLayout, R.drawable.msg_select, LocaleController.getString(R.string.PollSubmitVotesNoCaps), false, ntVar.f35953c0).setOnClickListener(new at(ntVar, 2));
        } else {
            f7 = 0.06f;
        }
        if (z12) {
            actionBarPopupWindow$ActionBarPopupWindowLayout2 = actionBarPopupWindow$ActionBarPopupWindowLayout;
            org.telegram.ui.ActionBar.u0.c(false, false, actionBarPopupWindow$ActionBarPopupWindowLayout2, R.drawable.msg_unvote, LocaleController.getString(R.string.Unvote), false, ntVar.f35953c0).setOnClickListener(new at(ntVar, 3));
        } else {
            actionBarPopupWindow$ActionBarPopupWindowLayout2 = actionBarPopupWindow$ActionBarPopupWindowLayout;
        }
        if (!z10 && (z11 || z12)) {
            org.telegram.ui.ActionBar.j1 j1Var3 = new org.telegram.ui.ActionBar.j1(actionBarPopupWindow$ActionBarPopupWindowLayout2.getContext(), ntVar.f35953c0);
            j1Var3.setTag(R.id.fit_width_tag, 1);
            j1Var3.setColor(org.telegram.ui.ActionBar.h6.l1(f7, org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.E8, ntVar.f35953c0)));
    ...
    public final void n() {
        if (this.f35971w != null && !this.K) {
            AndroidUtilities.cancelRunOnUIThread(this.U);
            this.F = 1.0f;
            this.H = System.currentTimeMillis();
            this.f35974z.invalidate();
            this.W = null;
            this.f35949a0 = null;
            this.Y = null;
            this.f35961l = null;
            ...
            ah1 ah1Var = this.O;
            if (ah1Var != null) {
                ah1Var.animate().alpha(0.0f).translationY(AndroidUtilities.dp(56.0f)).setDuration(150L).setInterpolator(org.telegram.ui.Components.rr.f28022f).start();
            }
            FrameLayout frameLayout = this.Q;
            if (frameLayout != null) {
                frameLayout.animate().alpha(0.0f).setDuration(150L).scaleX(0.6f).scaleY(0.6f).setInterpolator(org.telegram.ui.Components.rr.f28022f).start();
            }
    ...
    public final void o() {
        ...
        if (zbVar != null && (reactionsWindow = zbVar.getReactionsWindow()) != null && !reactionsWindow.f49247q) {
            reactionsWindow.d();
            return;
        }
        this.K = false;
    ...
    public final void p() {
        org.telegram.ui.ActionBar.m1 m1Var = this.f35960k;
        if (m1Var != null) {
            m1Var.dismiss();
            this.f35960k = null;
            return;
    ...
    public final boolean r(MotionEvent motionEvent, org.telegram.ui.Components.wl0 wl0Var, lt ltVar, org.telegram.ui.ActionBar.d6 d6Var) {
        ...
        this.f35961l = ltVar;
        if (ltVar != null) {
            this.f35962m = ltVar.l();
            this.f35963n = this.f35961l.q();
        }
        lt ltVar2 = this.f35961l;
        if ((ltVar2 == null || ltVar2.i()) && motionEvent.getAction() == 0) {
            ...
            while (true) {
                ...
                if (top <= y3 && bottom >= y3 && left <= x10 && right >= x10) {
                    ...
                    if (z10) {
                        if (((org.telegram.ui.Cells.f8) childAt).f20289a.hasNotThumb()) {
                            imageReceiver.setRoundRadius(0);
                            i10 = 0;
                        }
                        i10 = -1;
                    } else if (childAt instanceof org.telegram.ui.Cells.d8) {
                        if (((org.telegram.ui.Cells.d8) childAt).f20131a.getImageReceiver().getBitmap() != null) {
                            imageReceiver.setRoundRadius(0);
                            i10 = 0;
                        }
                        i10 = -1;
                        ...
                        if (childAt instanceof org.telegram.ui.Cells.f2) {
                            ...
                            if (f2Var.f20259a.getBitmap() != null) {
                                int i12 = f2Var.O;
                                if (i12 == 6) {
                                    imageReceiver.setRoundRadius(0);
                                    i10 = 0;
                                } else if (i12 == 2 && f2Var.f20273s) {
                            ...
                            if ((childAt instanceof org.telegram.ui.Components.wy0) && (((org.telegram.ui.Components.wy0) childAt).f30190b instanceof org.telegram.ui.Components.q5)) {
                                imageReceiver.setRoundRadius(0);
                            }
                            i10 = -1;
                        }
    ...
    public final void t(TLRPC.Document document, SendMessagesHelper.ImportingSticker importingSticker, String str, String str2, TLRPC.BotInlineResult botInlineResult, int i10, boolean z10, Object obj, org.telegram.ui.ActionBar.d6 d6Var, int i11) {
        ...
        jt jtVar;
        if (this.f35971w != null && this.f35973y != null) {
            this.f35953c0 = d6Var;
            this.f35965p = z10;
            this.G = null;
            if (AndroidUtilities.isDarkColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19045d6, d6Var))) {
                i12 = 1895825408;
            } else {
                i12 = 1692853990;
            }
            this.f35970u.setColor(i12);
            this.S = false;
                ...
                if (document != null || importingSticker != null) {
                    ...
                    if (document != null) {
                        ...
                        if (str != null) {
                            ...
                            this.G = new StaticLayout(AndroidUtilities.replaceCharSequence("…", TextUtils.ellipsize(Emoji.replaceEmoji(str, f35946f0.getFontMetricsInt(), false), f35946f0, AndroidUtilities.dp(200.0f), TextUtils.TruncateAt.END), ""), f35946f0, AndroidUtilities.dp(200.0f), Layout.Alignment.ALIGN_CENTER, 1.0f, 0.0f, false);
                        } else {
                            imageReceiver2 = imageReceiver4;
                        }
                        ...
                        TLRPC.TL_messages_stickerSet stickerSet = MediaDataController.getInstance(this.f35967r).getStickerSet(inputStickerSet, true);
                        if (stickerSet != null && stickerSet.documents.isEmpty()) {
                            inputStickerSet = null;
                        }
                        this.f35949a0 = inputStickerSet;
                        TLRPC.PhotoSize closestPhotoSizeWithSize = FileLoader.getClosestPhotoSizeWithSize(document.thumbs, 90);
                        if (MessageObject.isVideoStickerDocument(document)) {
                            charSequence = "";
                            str5 = "…";
                            imageReceiver4 = imageReceiver2;
                            imageReceiver4.setImage(ImageLocation.getForDocument(document), null, ImageLocation.getForDocument(closestPhotoSizeWithSize, document), null, null, 0L, "webp", this.f35949a0, 1);
                        } else {
                            charSequence = "";
                            str5 = "…";
                            imageReceiver4 = imageReceiver2;
                            imageReceiver4.setImage(ImageLocation.getForDocument(document), (String) null, ImageLocation.getForDocument(closestPhotoSizeWithSize, document), (String) null, "webp", this.f35949a0, 1);
                            if (MessageObject.isPremiumSticker(document)) {
                                this.S = true;
                                imageReceiver.setImage(ImageLocation.getForDocument(MessageObject.getPremiumStickerAnimation(document), document), (String) null, (ImageLocation) null, (String) null, "tgs", this.f35949a0, 1);
                            }
                        }
                        ...
                        if (this.G == null) {
                            ...
                            while (true) {
                                ...
                                if ((documentAttribute2 instanceof TLRPC.TL_documentAttributeSticker) && !TextUtils.isEmpty(documentAttribute2.alt)) {
                                    this.G = new StaticLayout(AndroidUtilities.replaceCharSequence(str5, TextUtils.ellipsize(Emoji.replaceEmoji(documentAttribute2.alt, f35946f0.getFontMetricsInt(), false), f35946f0, AndroidUtilities.dp(200.0f), TextUtils.TruncateAt.END), charSequence), f35946f0, AndroidUtilities.dp(200.0f), Layout.Alignment.ALIGN_CENTER, 1.0f, 0.0f, false);
                                    break;
                                }
                                i15++;
                            }
                        ...
                        if (importingSticker != null) {
                            ...
                            if (importingSticker.videoEditedInfo != null) {
                                if (this.C == null) {
                                    org.telegram.ui.Components.qd0 qd0Var = new org.telegram.ui.Components.qd0(this.f35974z.getContext());
                                    this.C = qd0Var;
                                    this.f35974z.addView(qd0Var, new FrameLayout.LayoutParams(512, 512));
                                }
                                z11 = false;
                            ...
                            if (str != null) {
                                this.G = new StaticLayout(AndroidUtilities.replaceCharSequence("…", TextUtils.ellipsize(Emoji.replaceEmoji(str, f35946f0.getFontMetricsInt(), z11), f35946f0, AndroidUtilities.dp(200.0f), TextUtils.TruncateAt.END), ""), f35946f0, AndroidUtilities.dp(200.0f), Layout.Alignment.ALIGN_CENTER, 1.0f, 0.0f, false);
                            }
                            this.f35961l.getClass();
                            AndroidUtilities.cancelRunOnUIThread(jtVar2);
                            if (i11 > 0) {
                                j3 = i11;
                            } else {
            ...
            this.f35974z.invalidate();
            if (!this.E) {
                AndroidUtilities.lockOrientation(this.f35971w);
                try {
                    if (this.f35973y.getParent() != null) {
                        str6 = str4;
                        try {
                            ((WindowManager) this.f35971w.getSystemService(str6)).removeView(this.f35973y);
                        } catch (Exception e) {
                            e = e;
                            FileLog.e(e);
                            ((WindowManager) this.f35971w.getSystemService(str6)).addView(this.f35973y, this.f35972x);
                            this.E = true;
                            this.F = 0.0f;
                            this.f35952c = -10000.0f;
                            this.f35957g = 0.0f;
                            this.d = 0.0f;
                            this.e = 0.0f;
                            this.H = System.currentTimeMillis();
    ...
    public final void u() {
        org.telegram.ui.Components.f21 f21Var = this.f35959j;
        if (f21Var != null) {
    ...
    public final void w(Activity activity) {
        ...
        int i11 = this.f35967r;
        ImageReceiver imageReceiver2 = this.B;
        imageReceiver2.setCurrentAccount(i11);
        imageReceiver2.setLayerNum(Integer.MAX_VALUE);
        if (this.f35971w == activity) {
            return;
        }
        this.f35971w = activity;
        this.J = activity.getResources().getDrawable(R.drawable.preview_arrow);
        this.f35973y = new k0(this, activity, 5);
        hh.k kVar = new hh.k(this.f35973y);
        k0 k0Var = this.f35973y;
        ah.c cVar = this.f35969t;
        cVar.f425f = kVar;
        cVar.f426g = k0Var;
        cVar.e = new pe.b(true);
        this.f35973y.setFocusable(true);
        this.f35973y.setFocusableInTouchMode(true);
        this.f35973y.setSystemUiVisibility(1792);
        k0 k0Var2 = this.f35973y;
        ...
        this.f35973y.addView(this.f35974z, w7.y5.e(-1, -1, 51));
        this.f35974z.setOnTouchListener(new e0(this, 1));
        MessagesController.getInstance(this.f35967r);
        this.I = MessagesController.getGlobalEmojiSettings().getInt("kbd_height", AndroidUtilities.dp(200.0f));
        WindowManager.LayoutParams layoutParams = new WindowManager.LayoutParams();
        this.f35972x = layoutParams;
        ...
        imageReceiver.setParentView(this.f35974z);
        imageReceiver2.setAspectFit(true);
        imageReceiver2.setInvalidateAll(true);
        imageReceiver2.setParentView(this.f35974z);
    }
    ...
    public final boolean y(View view) {
        ...
        String str = null;
        String findAnimatedEmojiEmoticon = MessageObject.findAnimatedEmojiEmoticon(f8Var.getSticker(), null, Integer.valueOf(this.f35967r));
        lt ltVar = this.f35961l;
        if (ltVar != null) {
            str = ltVar.G(false);
        }
        t(sticker, stickerPath, findAnimatedEmojiEmoticon, str, null, 0, f8Var.f20298y, f8Var.getParentObject(), this.f35953c0, 0);
        jt jtVar = this.U;
        AndroidUtilities.cancelRunOnUIThread(jtVar);
