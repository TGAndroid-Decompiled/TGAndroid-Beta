...
public final class yu0 extends View {
    public final Paint f40017a;
    public final org.telegram.ui.Components.n6 f40018b;
    public final TextPaint f40019c;
    ...
    public final org.telegram.ui.Components.d6 f40023s;
    public boolean v;
    public int f40024w;
    ...
    public yu0(Activity activity) {
        ...
        this.f40019c = textPaint;
        this.f40022r = false;
        org.telegram.ui.Components.qr qrVar = org.telegram.ui.Components.qr.h;
        this.f40023s = new org.telegram.ui.Components.d6(this, 0L, 350L, qrVar);
    ...
    public final void b(int i10, int i11, boolean z10) {
        ...
        if (LocaleController.getInstance().getCurrentLocaleInfo() != null && !TextUtils.equals(this.f40021n, LocaleController.getInstance().getCurrentLocaleInfo().shortName)) {
            c();
        }
        ...
        this.f40018b.q(format, z11, true);
        if (!LocaleController.isRTL) {
            max = max2;
        }
    ...
    public final void c() {
        this.f40021n = LocaleController.getInstance().getCurrentLocaleInfo().shortName;
        StaticLayout staticLayout = new StaticLayout(LocaleController.getString(R.string.Of).replace("%1$d", "").replace("%2$d", ""), this.f40019c, AndroidUtilities.dp(200.0f), Layout.Alignment.ALIGN_CENTER, 1.0f, 0.0f, false);
        this.d = staticLayout;
        if (staticLayout.getLineCount() >= 1) {
            this.e = this.d.getLineWidth(0);
            this.f40020f = this.d.getLineDescent(0);
            return;
        }
        this.e = 0.0f;
        this.f40020f = 0.0f;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        canvas.save();
        canvas.translate((-(this.d.getWidth() - this.e)) / 2.0f, ((this.f40020f / 2.0f) + (AndroidUtilities.dp(23.0f) - this.d.getHeight())) / 2.0f);
        this.f40019c.setAlpha(i10);
        this.d.draw(canvas);
        canvas.restore();
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f40024w = org.telegram.ui.ActionBar.k.getCurrentActionBarHeight() + AndroidUtilities.statusBarHeight;
        this.f40018b.G = size;
        this.h.G = size;
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(size, 1073741824), org.telegram.messenger.rk.C(43.0f, this.f40024w, 1073741824));
    }

    @Override
    public final boolean verifyDrawable(Drawable drawable) {
        if (this.f40018b != drawable && this.h != drawable && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
