...
public final class c70 extends org.telegram.ui.Components.tk0 {
    ...
    public final ArrayList f32693r = new ArrayList();
        ...
        if (e70Var.P || e70Var.O || z10) {
            ...
            if (z10) {
                ...
                for (int i11 = 0; i11 < size; i11++) {
                    ...
                    if (DialogObject.isUserDialog(dialog.f18116id) && !hashSet.contains(Long.valueOf(dialog.f18116id)) && (user = e70Var.getMessagesController().getUser(Long.valueOf(dialog.f18116id))) != null && !UserObject.isDeleted(user) && !UserObject.isUserSelf(user) && !UserObject.isBot(user) && !UserObject.isService(dialog.f18116id) && !MessagesController.isSupportUser(user)) {
                        this.f32693r.add(user);
                ...
                for (int i12 = 0; i12 < size2; i12++) {
                    ...
                    if (DialogObject.isChatDialog(dialog2.f18116id) && (chat = e70Var.getMessagesController().getChat(Long.valueOf(-dialog2.f18116id))) != null && chat.migrated_to == null && (!ChatObject.isChannel(chat) || chat.megagroup)) {
                        this.f32693r.add(chat);
                    }
                }
            }
            Collections.sort(this.f32693r, new Object());
            TLObject tLObject = null;
            int i13 = 0;
            while (i13 < this.f32693r.size()) {
                TLObject tLObject2 = (TLObject) this.f32693r.get(i13);
                if (tLObject != null) {
                ...
                ArrayList arrayList2 = this.f32693r;
        ...
        if (c1Var.f42678f != 0) {
            ...
            if (e70Var.J != null) {
                ...
                if (view instanceof org.telegram.ui.Cells.f4) {
                    ...
                    if ((object instanceof TLRPC.User) && e70Var.J.h(((TLRPC.User) object).f18259id) >= 0) {
                        return false;
                    }
                    return true;
                }
    ...
    public final String F(int i10) {
        String str;
        String str2;
        if (!this.f32692n && i10 >= this.E) {
            ArrayList arrayList = this.f32693r;
            int size = arrayList.size();
            int i11 = this.E;
            if (i10 < size + i11) {
                TLObject tLObject = (TLObject) arrayList.get(i10 - i11);
                if (tLObject instanceof d70) {
                    return ((d70) tLObject).f32944a;
                }
    ...
    public final void L(String str) {
        ...
        this.d.clear();
        this.e.clear();
        this.f32691f.f(null, null);
        gg.c2 c2Var = this.f32691f;
        e70 e70Var = this.I;
    ...
    public final int h() {
        ...
        this.E = i10;
        int size4 = this.f32693r.size() + i10;
        if (e70Var.R) {
            if (j10 != 0) {
    ...
    public final int j(int i10) {
        if (this.f32692n) {
            if (i10 == this.f32691f.d.size() + this.d.size()) {
                return 0;
            }
            return 1;
        } else if (i10 != this.f32695w) {
            if (i10 != this.f32694s) {
                if (i10 != this.f32696x && i10 != this.f32697y) {
                    if (this.F != 0 && i10 == 0) {
                        return 2;
                    }
                    if (this.G == i10) {
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i11 != 0) {
            ...
            if (i11 != 1) {
                if (i11 == 2) {
                    ...
                    if (i10 == this.f32695w) {
                        ...
                        r8Var.e(org.telegram.ui.ActionBar.i6.f19001m6, org.telegram.ui.ActionBar.i6.G6);
                        return;
                    } else {
            ...
            if (this.f32692n) {
            ...
            } else if (i10 == this.f32696x) {
                f4Var.f20076r = true;
                f4Var.f20074f = "premium";
                f4Var.f20071a.setImageDrawable(org.telegram.ui.Cells.f4.b(f4Var.getContext(), false));
                f4Var.f20072b.l(LocaleController.getString(R.string.PrivacyPremium), false);
                org.telegram.ui.ActionBar.j5 j5Var = f4Var.f20073c;
                int i12 = org.telegram.ui.ActionBar.i6.f19218y6;
                j5Var.setTag(Integer.valueOf(i12));
                if (f4Var.K) {
                    i12 = org.telegram.ui.ActionBar.i6.f19047og;
                }
                j5Var.setTextColor(org.telegram.ui.ActionBar.i6.v0(i12, f4Var.M));
                ...
                f4Var.c(z11, false);
                return;
            } else if (i10 == this.f32697y) {
                f4Var.f20077s = true;
                f4Var.f20074f = "miniapps";
                org.telegram.ui.Components.u9 u9Var = f4Var.f20071a;
                f4Var.getContext();
                u9Var.setImageDrawable(org.telegram.ui.Cells.f4.a(false));
                f4Var.f20072b.l(LocaleController.getString(R.string.PrivacyMiniapps), false);
                org.telegram.ui.ActionBar.j5 j5Var2 = f4Var.f20073c;
                int i13 = org.telegram.ui.ActionBar.i6.f19218y6;
                j5Var2.setTag(Integer.valueOf(i13));
                if (f4Var.K) {
                    i13 = org.telegram.ui.ActionBar.i6.f19047og;
                }
                j5Var2.setTextColor(org.telegram.ui.ActionBar.i6.v0(i13, f4Var.M));
        ...
        if (this.f32692n) {
            ...
            if (i14 >= 0 && i14 < arrayList.size()) {
                ...
                if (tLObject2 instanceof d70) {
                    u3Var.setText(((d70) tLObject2).f32944a.toUpperCase());
                }
            }
        }
        if (i10 == this.v) {
