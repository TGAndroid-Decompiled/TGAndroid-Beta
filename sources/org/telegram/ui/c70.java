...
public final class c70 extends AnimatorListenerAdapter {
    ...
    public void onAnimationCancel(Animator animator) {
        switch (this.f32589a) {
            case 0:
                ((g70) this.f32591c).h = null;
                return;
            case 3:
                tq0 tq0Var = (tq0) this.f32591c;
                if (animator.equals(tq0Var.f38202k0)) {
                    tq0Var.f38202k0 = null;
                    return;
                }
                return;
            case 9:
                ((z81) this.f32591c).f40415r = null;
                return;
            case 11:
                zg1 zg1Var = (zg1) this.f32591c;
    ...
    public final void onAnimationEnd(Animator animator) {
        ...
        switch (this.f32589a) {
            case 0:
                g70 g70Var = (g70) this.f32591c;
                if (g70Var.h != null && (idVar = g70Var.f33838f) != null) {
                    if (this.f32590b) {
                        idVar.setVisibility(4);
                    } else {
                        g70Var.f33839n.setVisibility(4);
                    }
                    g70Var.h = null;
                    return;
                }
            ...
            case 2:
                if (!this.f32590b) {
                    ((PasscodeActivity) this.f32591c).v.setVisibility(8);
                    return;
                }
                return;
            case 3:
                ...
                if (animator.equals(tq0Var.f38202k0)) {
                    if (!this.f32590b) {
                        ...
                        tq0Var.f38189a0.setVisibility(4);
                    }
                    tq0Var.f38202k0 = null;
                    return;
                }
            ...
            case 4:
                ...
                return;
            case 5:
                t01 t01Var = (t01) this.f32591c;
                if (t01Var.h) {
                    org.telegram.ui.ActionBar.u0 u0Var = t01Var.f37908n.U0;
                    if (u0Var != null) {
                    ...
                    ProfileActivity profileActivity2 = t01Var.f37908n;
                    if (profileActivity2.L0) {
                        profileActivity2.Q0.setVisibility(8);
                    }
                    ProfileActivity profileActivity3 = t01Var.f37908n;
                ...
                t01Var.f37908n.l5(false);
                return;
            case 6:
                x11 x11Var = (x11) this.f32591c;
                if (this.f32590b) {
                    x11Var.f39795c.setVisibility(8);
                    return;
                } else {
                    x11Var.f39796f.setVisibility(8);
                    return;
                }
            case 7:
                b51 b51Var = (b51) this.f32591c;
                if (this.f32590b) {
                    f10 = 1.0f;
                } else {
                    f10 = 0.0f;
            ...
            case 8:
                ...
                return;
            case 9:
                z81 z81Var = (z81) this.f32591c;
                if (z81Var.f40415r != null && (z3Var = z81Var.f40416s) != null) {
                    if (!this.f32590b) {
            ...
            case 11:
                ...
                if (animatorSet2 != null && animatorSet2.equals(animator)) {
                    if (this.f32590b) {
                        ...
                        zg1Var.f40472b.setVisibility(4);
                        return;
                    }
                }
                return;
            case 12:
                org.telegram.ui.web.v1 v1Var = (org.telegram.ui.web.v1) this.f32591c;
                fi.o oVar = v1Var.V;
                if (!v1Var.T) {
                ...
                return;
            case 13:
                l0 l0Var = (l0) this.f32591c;
                fi.o oVar2 = l0Var.f39229b0;
                if (!l0Var.W) {
                ...
                return;
            case 14:
                qg.z1 z1Var = (qg.z1) this.f32591c;
                ((pg.n) z1Var).f41176y.f41308n.d();
                if (this.f32590b) {
                    z1Var.f42027w.accept(Integer.valueOf(z1Var.f42026s));
                }
                ...
                return;
            case 15:
                LimitPreviewView limitPreviewView = (LimitPreviewView) this.f32591c;
                if (this.f32590b) {
                ...
                return;
            case 16:
                rg.p0 p0Var = (rg.p0) this.f32591c;
                if (this.f32590b) {
                    f15 = 1.0f;
                } else {
                    f15 = 0.0f;
                ...
                return;
            default:
                zg.b0 b0Var = (zg.b0) this.f32591c;
                org.telegram.ui.Components.qk0 qk0Var = b0Var.f49255n;
                b0Var.k();
                b0Var.l();
                ...
                qk0Var.setCustomEmojiEnterProgress(Utilities.clamp(b0Var.f49251j, 1.0f, 0.0f));
                if (!z10) {
                    qk0Var.setImportantForAccessibility(0);
                    qk0Var.setSkipDraw(false);
                    b0Var.f();
                    Runtime.getRuntime().gc();
                    int i11 = b0Var.f49265y;
    ...
    public void onAnimationStart(Animator animator) {
        switch (this.f32589a) {
            case 1:
                if (this.f32590b) {
                    ((qg0) this.f32591c).V.setVisibility(0);
                    return;
                }
                return;
            case 2:
                if (this.f32590b) {
                    ((PasscodeActivity) this.f32591c).v.setVisibility(0);
                    return;
                }
                return;
            case 3:
            ...
            case 6:
                x11 x11Var = (x11) this.f32591c;
                if (this.f32590b) {
                    x11Var.f39796f.setAlpha(0.0f);
                    x11Var.f39796f.setVisibility(0);
                    return;
                }
                x11Var.f39795c.setAlpha(0.0f);
                x11Var.f39795c.setVisibility(0);
                return;
        }
    }
}
