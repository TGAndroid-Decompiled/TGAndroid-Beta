...
public final class s50 extends View {
        ...
        switch (this.f37297a) {
            case 0:
                ...
                if (t50Var != null) {
                    ...
                    int i10 = 0;
                    while (true) {
                        v50[] v50VarArr = t50Var.f37625c;
                        if (i10 < v50VarArr.length) {
                            v50 v50Var = v50VarArr[i10];
                            v50Var.f38410i.add(this);
                            v50Var.a();
                            i10++;
                        } else {
                            return;
            ...
            case 12:
                super.onAttachedToWindow();
                xh.o1 o1Var = (xh.o1) this.f37298b;
                if (o1Var != null && !o1Var.f46346i) {
                    o1Var.f46346i = true;
                    o1Var.a();
    ...
    public void onDetachedFromWindow() {
        switch (this.f37297a) {
            case 0:
                ...
                t50 t50Var = (t50) this.f37298b;
                if (t50Var != null && t50Var.f37627g != this) {
                    int i10 = 0;
                    while (true) {
                        v50[] v50VarArr = t50Var.f37625c;
                        if (i10 < v50VarArr.length) {
                            v50 v50Var = v50VarArr[i10];
                            v50Var.f38410i.remove(this);
                            v50Var.a();
                            i10++;
                        } else {
                            t50Var.f37627g = null;
    ...
    public void onDraw(Canvas canvas) {
        ...
        switch (this.f37297a) {
            case 1:
                canvas.drawColor(((uj0) this.f37298b).getThemedColor(org.telegram.ui.ActionBar.j6.e7));
                return;
            case 2:
                lq0 lq0Var = (lq0) this.f37298b;
                String format = String.format("%d", Integer.valueOf(Math.max(1, lq0Var.f35507c.size())));
                ...
                lq0Var.U.setColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19165h5, false));
                int i11 = max / 2;
                ...
                return;
            case 3:
                cr0 cr0Var = (cr0) this.f37298b;
                String format2 = String.format("%d", Integer.valueOf(Math.max(1, cr0Var.f32836c.size())));
                int ceil2 = (int) Math.ceil(cr0Var.f32843h0.measureText(format2));
                int max2 = Math.max(AndroidUtilities.dp(16.0f) + ceil2, AndroidUtilities.dp(24.0f));
                int measuredWidth2 = getMeasuredWidth() / 2;
                getMeasuredHeight();
                cr0Var.f32843h0.setColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.C5, false));
                cr0Var.f32845j0.setColor(org.telegram.ui.ActionBar.j6.w0(null, cr0Var.f32858u0, false));
                int i14 = max2 / 2;
                int i15 = measuredWidth2 - i14;
                int i16 = i14 + measuredWidth2;
                cr0Var.f32844i0.set(i15, 0.0f, i16, getMeasuredHeight());
                canvas.drawRoundRect(cr0Var.f32844i0, AndroidUtilities.dp(12.0f), AndroidUtilities.dp(12.0f), cr0Var.f32845j0);
                cr0Var.f32845j0.setColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.B5, false));
                cr0Var.f32844i0.set(AndroidUtilities.dp(2.0f) + i15, AndroidUtilities.dp(2.0f), i16 - AndroidUtilities.dp(2.0f), getMeasuredHeight() - AndroidUtilities.dp(2.0f));
                canvas.drawRoundRect(cr0Var.f32844i0, AndroidUtilities.dp(10.0f), AndroidUtilities.dp(10.0f), cr0Var.f32845j0);
                canvas.drawText(format2, measuredWidth2 - (ceil2 / 2), AndroidUtilities.dp(16.2f), cr0Var.f32843h0);
                return;
            case 4:
                ((PhotoViewer) this.f37298b).f31327q3.a(canvas, this);
                return;
            case 5:
            case 6:
            case 9:
            ...
            case 7:
                ...
                org.telegram.ui.Components.kc0 kc0Var = f31Var.f33471n;
                if (kc0Var != null) {
                    kc0Var.setBounds(0, 0, getWidth(), getHeight());
                }
                f31Var.h.setBounds(0, 0, getWidth(), getHeight());
                org.telegram.ui.Components.kc0 kc0Var2 = f31Var.f33471n;
                if (kc0Var2 != null) {
                    kc0Var2.draw(canvas);
                }
                ...
                return;
            case 8:
                ((SecretMediaViewer) this.f37298b).Q.a(canvas, this);
                return;
            case 11:
                super.onDraw(canvas);
                rg.j0 j0Var = (rg.j0) this.f37298b;
                if (j0Var.f42622p0 - j0Var.f42621o0 > 1) {
    ...
    public void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        switch (this.f37297a) {
            case 9:
                ...
                y51 y51Var = (y51) this.f37298b;
                int[] iArr = y51Var.G;
                getLocationOnScreen(iArr);
                Rect rect = y51Var.d;
                int i14 = iArr[0];
                rect.set(i14, iArr[1], getWidth() + i14, getHeight() + iArr[1]);
                AndroidUtilities.lerp(y51Var.f33523c, rect, y51Var.I, y51Var.e);
                return;
            default:
                super.onLayout(z10, i10, i11, i12, i13);
                return;
    ...
    public void onMeasure(int i10, int i11) {
        ...
        switch (this.f37297a) {
            ...
            case 5:
                ...
                return;
            case 13:
                yh.w7 w7Var = (yh.w7) this.f37298b;
                if (w7Var.H) {
                    i12 = (yh.w7.C0(w7Var).getMeasuredHeight() + w7Var.I) - AndroidUtilities.dp(16.0f);
                } else {
                    int dp2 = AndroidUtilities.dp(140.0f) + w7Var.I;
                    if (AndroidUtilities.dp(24.0f) + w7Var.f37031y.getMeasuredHeight() > dp2) {
                        dp2 = AndroidUtilities.dp(24.0f) + w7Var.f37031y.getMeasuredHeight();
                    }
                    i12 = dp2;
                }
    ...
    public void setAlpha(float f7) {
        switch (this.f37297a) {
            case 6:
                super.setAlpha(f7);
                View view = ((ProfileActivity) this.f37298b).fragmentView;
                if (view != null) {
                    view.invalidate();
                    return;
                }
            ...
            case 10:
                super.setAlpha(f7);
                View view2 = ((fg1) this.f37298b).fragmentView;
                if (view2 != null) {
                    view2.invalidate();
                    return;
                }
        ...
        switch (this.f37297a) {
            case 12:
                ...
                if (drawable instanceof xh.o1) {
                    this.f37298b = (xh.o1) drawable;
                    if (isAttachedToWindow()) {
                        xh.o1 o1Var2 = (xh.o1) this.f37298b;
                        if (!o1Var2.f46346i) {
                            o1Var2.f46346i = true;
                            o1Var2.a();
