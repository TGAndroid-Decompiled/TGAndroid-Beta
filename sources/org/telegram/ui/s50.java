...
public final class s50 extends Dialog {
    public final bi.a4 f40303a;
    public final t50 f40304b;
    public Bitmap f40305c;
    public Paint d;
    public BitmapShader f40306e;
    public final Matrix f40307f;
    public float h;
    public ValueAnimator f40308n;
    public boolean f40309r;

    public s50(Context context, t50 t50Var) {
        super(context, R.style.TransparentDialog);
        this.f40307f = new Matrix();
        this.f40304b = t50Var;
    ...
    public final void b(float f7, r50 r50Var) {
        ValueAnimator valueAnimator = this.f40308n;
        if (valueAnimator != null) {
            valueAnimator.cancel();
            this.f40308n = null;
        }
        ValueAnimator ofFloat = ValueAnimator.ofFloat(this.h, f7);
        this.f40308n = ofFloat;
        ofFloat.addUpdateListener(new c3(this, 16));
        this.f40308n.addListener(new bi.h2(this, f7, r50Var, 3));
        this.f40308n.setDuration(420L);
        this.f40308n.setInterpolator(org.telegram.ui.Components.pr.h);
        this.f40308n.start();
    }
    ...
    public final void onCreate(Bundle bundle) {
        ...
        setContentView(this.f40303a, new ViewGroup.LayoutParams(-1, -1));
