...
public final class t91 extends org.telegram.ui.Components.ab {
    public static final int f37706d0 = 0;
    public final yh.a X;
    public final LinearLayout Y;
    public final LinearLayout Z;
    public boolean f37707a0;
    public boolean f37708b0;
    public org.telegram.ui.Components.k61 f37709c0;
    ...
    public t91(final Context context, final int i10, final org.telegram.ui.ActionBar.f6 f6Var, final of ofVar) {
        ...
        yh.a aVar = new yh.a(context, i10, zf.b.f49255b, f6Var);
        this.X = aVar;
        aVar.setScaleX(0.6f);
        aVar.setScaleY(0.6f);
        aVar.setAlpha(0.0f);
        ...
        a1.d dVar = new a1.d(context, new int[]{i14, i15, i16, i17, i18, i19, i19}, f6Var, a01Var, 18);
        ...
        TextView b13 = w7.d6.b(context, 14.0f, org.telegram.ui.ActionBar.j6.f19477y6, false, null);
        b13.setGravity(17);
        ...
        dVar2.setOnClickListener(new View.OnClickListener() {
            ...
            public final void onClick(View view2) {
                ...
                try {
                    ...
                    } else if (yh.u5.y(i23, true).f48114f.toDouble() < parseDouble) {
                        new di.h(context, f6Var, zf.a.i((long) (parseDouble * 1.0E9d), zf.b.f49255b), true, new u21(2));
                    } else {
        ...
        this.f37709c0.N(false);
    }

    public final void P() {
        boolean z10;
        float f7;
        if (this.f37707a0 && !isDismissed() && !isKeyboardVisible()) {
            z10 = true;
        } else {
            z10 = false;
        }
        if (this.f37708b0 != z10) {
            this.f37708b0 = z10;
            yh.a aVar = this.X;
            if (aVar != null) {
                aVar.setEnabled(z10);
