...
public final class ic0 implements org.telegram.ui.ActionBar.s0, org.telegram.ui.ActionBar.c2, IMapsProvider.OnCameraMoveStartedListener, uf.b, IMapsProvider.ITouchInterceptor {
    ...
    public void a(ArrayList arrayList) {
        switch (this.f37623a) {
            case 5:
                bd0 bd0Var = this.f37624b;
                ArrayList arrayList2 = bd0Var.f35480h0;
                if (arrayList != null) {
                    int size = arrayList2.size();
                    for (int i10 = 0; i10 < size; i10++) {
                        ((ad0) arrayList2.get(i10)).f35144b.remove();
                    }
                    arrayList2.clear();
                    ...
                    for (int i11 = 0; i11 < size2; i11++) {
                        ...
                        try {
                            ...
                            obj.f35144b = addMarker;
                            obj.f35145c = tL_messageMediaVenue;
                ...
                return;
            default:
                bd0 bd0Var2 = this.f37624b;
                bd0Var2.f35489q0 = false;
                bd0Var2.B0();
                return;
        }
    }
    ...
    public void h(int i10) {
        IMapsProvider.IMap iMap = this.f37624b.F;
        if (iMap != null) {
            if (i10 == 2) {
                iMap.setMapType(0);
            } else if (i10 == 3) {
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent, IMapsProvider.ICallableMethod iCallableMethod) {
        ...
        switch (i10) {
            case 6:
                ...
                return booleanValue;
            default:
                if (bd0Var.f35502y0 == null && bd0Var.f35498w0 == null) {
                    if (motionEvent.getAction() == 0) {
                        AnimatorSet animatorSet = bd0Var.f35481i0;
                        if (animatorSet != null) {
                            animatorSet.cancel();
                        }
                        AnimatorSet animatorSet2 = new AnimatorSet();
                        bd0Var.f35481i0 = animatorSet2;
                        animatorSet2.setDuration(200L);
                        bd0Var.f35481i0.playTogether(ObjectAnimator.ofFloat(bd0Var.U, View.TRANSLATION_Y, bd0Var.f35496v0 - AndroidUtilities.dp(10.0f)));
                        bd0Var.f35481i0.start();
                    } else if (motionEvent.getAction() == 1) {
                        AnimatorSet animatorSet3 = bd0Var.f35481i0;
                        if (animatorSet3 != null) {
                            animatorSet3.cancel();
                        }
                        bd0Var.K = 0.0f;
                        AnimatorSet animatorSet4 = new AnimatorSet();
                        bd0Var.f35481i0 = animatorSet4;
                        animatorSet4.setDuration(200L);
                        bd0Var.f35481i0.playTogether(ObjectAnimator.ofFloat(bd0Var.U, View.TRANSLATION_Y, bd0Var.f35496v0));
                        bd0Var.f35481i0.start();
                        bd0Var.Q.I();
                    }
                    if (motionEvent.getAction() == 2) {
                        ...
                        if (iMap != null && (location = bd0Var.f35495u0) != null) {
                            location.setLatitude(iMap.getCameraPosition().target.latitude);
                            bd0Var.f35495u0.setLongitude(bd0Var.F.getCameraPosition().target.longitude);
                        }
