...
public final class lb extends ub {
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        wb wbVar = this.X2;
        if (wbVar.v != null && wbVar.f38679x != null && (i14 = wbVar.N0) >= 0) {
            if (wbVar.M0 != 0) {
                int i15 = 0;
                while (true) {
                    sb sbVar = wbVar.E;
                    if (i15 < sbVar.d) {
                        if (i15 >= sbVar.f37451f && i15 < sbVar.h) {
                            ArrayList arrayList = sbVar.f37452n.f38667o0;
                            messageObject = (MessageObject) arrayList.get((arrayList.size() - (i15 - sbVar.f37451f)) - 1);
                        } else {
                            messageObject = null;
                        }
            ...
            wbVar.f38679x.i1(i14, wbVar.O0, true);
            wbVar.N0 = -1;
            wbVar.M0 = 0L;
        }
