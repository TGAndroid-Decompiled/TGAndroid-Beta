...
public final class lz implements ViewTreeObserver.OnGlobalLayoutListener {
    public final ExternalActionActivity f35419a;

    public lz(ExternalActionActivity externalActionActivity) {
        this.f35419a = externalActionActivity;
    }

    @Override
    public final void onGlobalLayout() {
        ExternalActionActivity externalActionActivity = this.f35419a;
        externalActionActivity.f();
        ActionBarLayout actionBarLayout = externalActionActivity.f31065c;
