...
public final class ti1 extends View {
    public final Paint f40790a;
    public final org.telegram.ui.Components.k9 f40791b;
    public org.telegram.ui.Components.f01 f40792c;
    ...
    public ti1(Activity activity) {
        ...
        this.f40791b = k9Var;
        k9Var.f27797p = AndroidUtilities.dp(100.0f);
        k9Var.f27796o = AndroidUtilities.dp(30.0f);
        k9Var.f27804x = false;
        k9Var.f27800s = AndroidUtilities.dp(24.0f);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        org.telegram.ui.Components.k9 k9Var = this.f40791b;
        float e7 = k9Var.e() + AndroidUtilities.dp(4.0f) + AndroidUtilities.dp(7.0f) + this.f40792c.f25875c + AndroidUtilities.dp(13.0f);
        RectF rectF = AndroidUtilities.rectTmp;
        rectF.set((getWidth() - e7) / 2.0f, 0.0f, (getWidth() + e7) / 2.0f, getHeight());
        float dp = AndroidUtilities.dp(30.0f) / 2.0f;
        canvas.drawRoundRect(rectF, dp, dp, this.f40790a);
        canvas.save();
        canvas.translate(rectF.left + AndroidUtilities.dp(4.0f), 0.0f);
        k9Var.i(canvas);
        canvas.translate(k9Var.A + AndroidUtilities.dp(7.0f), 0.0f);
        this.f40792c.c(0.0f, dp, 1.0f, -1, canvas);
        canvas.restore();
    }
