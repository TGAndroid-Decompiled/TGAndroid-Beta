...
public final class ti1 implements VoIPService.StateListener, NotificationCenter.NotificationCenterDelegate, rf.a {
    ...
    public boolean f37762a0;
    public boolean f37763a1;
    public Activity f37764b;
    public TextureViewRenderer f37765b0;
    public float f37766b1;
    public final TLRPC.User f37767c;
    public org.telegram.ui.Components.voip.s2 f37768c0;
    public float f37769c1;
    public final TLRPC.User d;
    public org.telegram.ui.Components.voip.s2 f37770d0;
    public int f37771d1;
    public org.telegram.ui.Components.voip.k3 e;
    public org.telegram.ui.Components.voip.e f37772e0;
    public int f37773e1;
    public org.telegram.ui.Components.voip.k3 f37774f;
    public boolean f37775f0;
    public pf.e f37777g0;
    public boolean f37778g1;
    public org.telegram.ui.Components.voip.k3 h;
    public View f37779h0;
    public boolean f37780h1;
    public View f37781i0;
    public ValueAnimator f37782i1;
    public org.telegram.ui.Components.voip.r1 f37783j0;
    public boolean f37784j1;
    public org.telegram.ui.Components.voip.s2 f37786k1;
    public com.google.android.gms.internal.cast.p l1;
    public boolean m0;
    public boolean f37788m1;
    public qi1 f37789n;
    public boolean f37790n0;
    public mi1 f37791o0;
    public int f37792p0;
    public int f37793q0;
    public WindowInsets f37795r0;
    public oi1 f37796s;
    public boolean f37797s0;
    public float f37798t0;
    public li1 f37799u0;
    public org.telegram.ui.Components.voip.c3 v;
    public int f37800v0;
    public org.telegram.ui.Components.voip.z2 f37801w;
    public AccessibilityManager f37802w0;
    public org.telegram.ui.Components.voip.e3 f37803x;
    public org.telegram.ui.Components.voip.t0 f37805y;
    public boolean f37807z0;
    public final org.telegram.ui.Components.voip.q1 f37794r = new org.telegram.ui.Components.voip.q1();
    public final org.telegram.ui.Components.u9[] V = new org.telegram.ui.Components.u9[4];
    public final Drawable[] W = new Drawable[4];
    public final Paint f37785k0 = new Paint();
    public final Paint f37787l0 = new Paint();
    public boolean f37804x0 = true;
    public float f37806y0 = 1.0f;
    ...
    public float f37776f1 = 1.0f;

    public ti1(int i10) {
        this.f37761a = i10;
        this.f37767c = MessagesController.getInstance(i10).getUser(Long.valueOf(UserConfig.getInstance(i10).getClientUserId()));
        ...
        this.f37793q0 = -1;
        this.f37792p0 = sharedState.getCallState();
    ...
    public static void i(ti1 ti1Var) {
        ...
        ti1Var.R0 = false;
        if (Build.VERSION.SDK_INT >= 23 && ti1Var.f37764b.checkSelfPermission("android.permission.CAMERA") != 0) {
            ti1Var.f37764b.requestPermissions(new String[]{"android.permission.CAMERA"}, 102);
        } else {
            ti1Var.C();
        }
    }
    ...
    public static void j(ti1 ti1Var) {
        ...
        if (ti1Var.f37778g1) {
            ...
            ti1Var.f37782i1 = ofFloat;
            ti1Var2 = ti1Var;
            ofFloat.addUpdateListener(new org.telegram.ui.Components.voip.x(ti1Var2, ti1Var.f37776f1, ti1Var.Y0, ti1Var.Z0, 1));
            ti1Var2.f37782i1.addListener(new hi1(ti1Var2, 0));
            ti1Var2.f37782i1.setDuration(350L);
            ti1Var2.f37782i1.setInterpolator(org.telegram.ui.Components.qr.f27383f);
            ti1Var2.f37782i1.start();
        } else {
            ti1Var2 = ti1Var;
        }
        ti1Var2.f37780h1 = false;
        ti1Var2.f37763a1 = false;
    }
        ...
        if (ti1Var != null) {
            if (i10 == 101) {
                if (VoIPService.getSharedState() == null) {
                    ...
                    ti1Var.r(new p91(2));
                } else if (!ti1Var.f37764b.shouldShowRequestPermissionRationale("android.permission.RECORD_AUDIO")) {
                    if (VoIPService.getSharedState() != null) {
                        VoIPService.getSharedState().declineIncomingCall();
                    }
                    org.telegram.ui.Components.voip.f2.h(ti1Var.f37764b, new di1(ti1Var, 2), i10);
                    return;
                }
            }
            if (i10 == 102) {
    ...
    public static void w(Activity activity, int i10) {
        ...
        float f7;
        ti1 ti1Var = f37760n1;
        if (ti1Var != null && ti1Var.f37799u0.getParent() == null) {
            ti1 ti1Var2 = f37760n1;
            if (ti1Var2 != null) {
                ti1Var2.f37768c0.d.release();
                f37760n1.f37770d0.d.release();
                f37760n1.f37765b0.release();
                li1 li1Var = f37760n1.f37799u0;
                if (li1Var != null) {
                    li1Var.d();
                }
                f37760n1.l();
        ...
        if (f37760n1 == null && !activity.isFinishing()) {
            ...
            if (VoIPService.getSharedState() != null && VoIPService.getSharedState().getUser() != null) {
                ...
                ti1Var3.f37764b = activity;
                f37760n1 = ti1Var3;
                li1 li1Var2 = new li1(activity, !z10, ti1Var3);
                f37760n1.J0 = ((KeyguardManager) activity.getSystemService("keyguard")).inKeyguardRestrictedInputMode();
                ((PowerManager) activity.getSystemService("power")).isInteractive();
                f37760n1.getClass();
                li1Var2.setLockOnScreen(f37760n1.J0);
                ti1Var3.f37799u0 = li1Var2;
                ...
                ti1Var3.f37798t0 = ViewConfiguration.get(activity).getScaledTouchSlop();
                ti1Var3.f37802w0 = (AccessibilityManager) f0.e.f(activity, AccessibilityManager.class);
                ...
                org.telegram.ui.Components.voip.q1 q1Var = ti1Var3.f37794r;
                ...
                ti1Var3.f37768c0 = s2Var;
                RendererCommon.ScalingType scalingType = RendererCommon.ScalingType.SCALE_ASPECT_FIT;
                s2Var.d.setScalingType(scalingType);
                ti1Var3.f37768c0.d.setEnableHardwareScaler(true);
                ti1Var3.f37768c0.d.setRotateTextureWithScreen(true);
                ti1Var3.f37768c0.f29184a0 = 1;
                ...
                if (LiteMode.isEnabled(512)) {
                    ...
                    if ((i13 == 11 && i14 >= 24 && i14 <= 31) || (i13 == 0 && i14 == 1)) {
                        view.f28921a = new org.telegram.ui.Components.bw0(0);
                    }
                }
                ti1Var3.f37803x = view;
                oi1Var.addView((View) view, w7.x5.c(220.0f, -1));
                oi1Var.addView(ti1Var3.f37768c0);
                ...
                ti1Var3.f37765b0 = textureViewRenderer;
                textureViewRenderer.setEnableHardwareScaler(true);
                ti1Var3.f37765b0.setIsCamera(false);
                ti1Var3.f37765b0.setFpsReduction(30.0f);
                ti1Var3.f37765b0.setScalingType(scalingType);
                ti1Var3.Z.addView(ti1Var3.f37765b0, w7.x5.e(-1, -2, 17));
                ...
                ti1Var3.f37805y = new org.telegram.ui.Components.voip.t0(activity);
                org.telegram.ui.Components.f9 f9Var = new org.telegram.ui.Components.f9((org.telegram.ui.ActionBar.f6) null);
                f9Var.r(user);
                org.telegram.ui.Components.voip.t0 t0Var = ti1Var3.f37805y;
                int i16 = ti1Var3.f37761a;
                t0Var.f29210b.h(ImageLocation.getForUserOrChat(i16, user, 0), null, f9Var, user);
                ti1Var3.f37805y.setRoundRadius(AndroidUtilities.dp(135.0f) / 2);
                ...
                frameLayout2.f29141a = new TextView[2];
                int i17 = 0;
                for (int i18 = 2; i17 < i18; i18 = 2) {
                    frameLayout2.f29141a[i17] = new TextView(activity);
                    frameLayout2.f29141a[i17].setTextSize(1, 15.0f);
                    frameLayout2.f29141a[i17].setTextColor(-1);
                    frameLayout2.f29141a[i17].setGravity(1);
                    frameLayout2.addView(frameLayout2.f29141a[i17]);
                    i17++;
                }
                FrameLayout frameLayout3 = new FrameLayout(activity);
                frameLayout2.f29143c = frameLayout3;
                ...
                frameLayout2.f29142b = textView3;
                ...
                if (sharedState != null && sharedState.getUser() != null && sharedState.isConference() && sharedState.getGroupCall() != null) {
                    ...
                    if (groupParticipants == null && i19 <= 0) {
                        ...
                        org.telegram.ui.Components.h9 h9Var = si1Var.f37510b;
                        h9Var.k(min);
                        int i20 = 0;
                        while (i20 < min) {
                        ...
                        if (max == 1 && (groupParticipants == null || groupParticipants.size() == 0 || (groupParticipants.size() == 1 && DialogObject.getPeerDialogId(groupParticipants.get(0).peer) == j10))) {
                            ...
                            si1Var.f37511c = new org.telegram.ui.Components.h01(LocaleController.formatPluralStringComma("Participants", max), 14.0f, AndroidUtilities.bold());
                ...
                oi1Var.addView(ti1Var3.f37805y, w7.x5.d(204, 204.0f, 1, 0.0f, 93.0f, 0.0f, 0.0f));
                ...
                ti1Var3.f37783j0 = new org.telegram.ui.Components.voip.r1(activity);
                ti1Var3.e = new org.telegram.ui.Components.voip.k3(activity, q1Var);
                ti1Var3.f37774f = new org.telegram.ui.Components.voip.k3(activity, q1Var);
                ti1Var3.h = new org.telegram.ui.Components.voip.k3(activity, q1Var);
                ti1Var3.f37789n = new org.telegram.ui.Components.voip.v2(activity, 52.0f);
                ...
                ti1Var3.f37774f.setTranslationY(AndroidUtilities.dp(100.0f));
                ti1Var3.f37774f.setScaleX(0.0f);
                ti1Var3.f37774f.setScaleY(0.0f);
                ti1Var3.f37774f.animate().setStartDelay(166).translationY(0.0f).scaleY(1.0f).scaleX(1.0f).setDuration(250L).start();
                ...
                ti1Var3.f37789n.setTranslationY(AndroidUtilities.dp(100.0f));
                ti1Var3.f37789n.setScaleX(0.0f);
                ti1Var3.f37789n.setScaleY(0.0f);
                ti1Var3.f37789n.animate().setStartDelay(198).translationY(0.0f).scaleY(1.0f).scaleX(1.0f).setDuration(250L).start();
                ti1Var3.f37783j0.addView(ti1Var3.e);
                ti1Var3.f37783j0.addView(ti1Var3.f37774f);
                ti1Var3.f37783j0.addView(ti1Var3.h);
                ti1Var3.f37783j0.addView(ti1Var3.f37789n);
                org.telegram.ui.Components.voip.e eVar = new org.telegram.ui.Components.voip.e(activity);
                ti1Var3.f37772e0 = eVar;
                eVar.setListener(new ri1(ti1Var3));
                ti1Var3.f37772e0.setScaleX(1.15f);
                ti1Var3.f37772e0.setScaleY(1.15f);
                oi1Var.addView(ti1Var3.f37783j0, w7.x5.e(-1, -2, 80));
                ...
                float f10 = i11;
                oi1Var.addView(ti1Var3.f37772e0, w7.x5.d(-1, 186.0f, 80, f10, 0.0f, f10, 0.0f));
                ...
                if (ti1Var3.f37799u0.f29312b) {
                    ti1Var3.H.setVisibility(8);
                    ti1Var3.I.setVisibility(8);
                }
                ?? linearLayout = new LinearLayout(activity);
                linearLayout.f28960a = new HashMap();
                linearLayout.f28961b = new ArrayList();
                linearLayout.f28962c = new ArrayList();
                TextPaint textPaint = new TextPaint();
                linearLayout.f28965r = textPaint;
                linearLayout.setOrientation(1);
                linearLayout.f28964n = q1Var;
                ...
                if (z10) {
                    ...
                    if (sharedInstance2 != null && sharedInstance2.getVideoState(false) == 2) {
                        ti1Var3.f37768c0.setStub(org.telegram.ui.Components.voip.m2.k().f29076r);
                        ti1Var3.f37770d0.setStub(org.telegram.ui.Components.voip.m2.k().f29075n);
                    }
                    ti1Var3.f37799u0.setAlpha(0.0f);
                    ti1Var3.H();
                    ti1Var3.E0 = true;
                ...
                if (sharedInstance3 != null && sharedInstance3.getRemoteVideoState() == 2 && sf.c.a(activity) == 1) {
                    ti1 ti1Var4 = f37760n1;
                    pf.d dVar = new pf.d(activity, ti1Var4);
                    dVar.f40812c = "voip-fragment-pip";
                    org.telegram.ui.Components.voip.s2 s2Var3 = ti1Var4.f37768c0;
                    dVar.f40816j = s2Var3.d;
                    dVar.f40817k = s2Var3.getPlaceholderView();
                    ti1Var4.f37777g0 = dVar.a();
                }
            }
        }
    }
    ...
    public final void A(boolean z10) {
        ...
        if (!z10 && this.f37804x0) {
            ...
            this.f37783j0.animate().alpha(0.0f).translationY(AndroidUtilities.dp(10.0f)).setDuration(150L).setInterpolator(qrVar).start();
            this.f37779h0.animate().alpha(0.0f).setDuration(150L).setInterpolator(qrVar).start();
            this.f37781i0.animate().alpha(0.0f).setDuration(150L).setInterpolator(qrVar).start();
            ValueAnimator ofFloat = ValueAnimator.ofFloat(this.f37806y0, 0.0f);
            this.P0 = ofFloat;
            ...
            this.R0 = false;
            this.f37783j0.setEnabled(false);
            this.O0.e(true);
            i10 = 150;
        } else {
            if (z10 && !this.f37804x0) {
                ...
                this.f37783j0.animate().alpha(1.0f).translationY(0.0f).setDuration(150L).setInterpolator(qrVar2).start();
                this.f37779h0.animate().alpha(1.0f).setDuration(150L).setInterpolator(qrVar2).start();
                this.f37781i0.animate().alpha(1.0f).setDuration(150L).setInterpolator(qrVar2).start();
                ValueAnimator ofFloat2 = ValueAnimator.ofFloat(this.f37806y0, 1.0f);
                this.P0 = ofFloat2;
                ofFloat2.addUpdateListener(k21Var);
                this.P0.setDuration(150L).setInterpolator(qrVar2);
                this.P0.start();
                this.f37783j0.setEnabled(true);
            }
            i10 = 0;
        }
        this.f37804x0 = z10;
        li1 li1Var = this.f37799u0;
        if (!z10) {
        ...
        animate.translationY(i12 - i11).setDuration(150L).setStartDelay(i10).setInterpolator(org.telegram.ui.Components.qr.f27383f).start();
    }
    ...
    public final void B() {
        if (VoIPService.getSharedInstance() != null) {
            ...
            this.R0 = false;
            if (this.f37807z0 && this.f37804x0) {
    ...
    public final void C() {
        ...
        VoIPService sharedInstance = VoIPService.getSharedInstance();
        if (sharedInstance != null) {
            if (this.f37802w0.isTouchExplorationEnabled()) {
                if (!this.f37790n0) {
                ...
                this.f37796s.announceForAccessibility(string);
            }
            if (!this.f37790n0) {
                if (this.f37791o0 == null) {
                    sharedInstance.createCaptureDevice(false);
                    if (!sharedInstance.isFrontFaceCamera()) {
                        sharedInstance.switchCamera();
                    }
                    this.f37799u0.setLockOnScreen(true);
                    int[] iArr = new int[2];
                    this.f37774f.getLocationOnScreen(iArr);
                    mi1 mi1Var = new mi1(this, this.f37796s.getContext(), iArr[0], iArr[1]);
                    this.f37791o0 = mi1Var;
                    WindowInsets windowInsets = this.f37795r0;
                    if (windowInsets != null) {
                        mi1Var.setBottomPadding(windowInsets.getSystemWindowInsetBottom());
                    }
                    this.f37796s.addView(this.f37791o0);
                    return;
                }
                return;
            }
    ...
    public final void D(boolean z10) {
        ...
        if (sharedInstance != null) {
            if (z10) {
                ...
                TransitionManager.beginDelayedTransition(this.f37783j0, transitionSet);
            }
            int i10 = this.f37792p0;
            if (i10 == 11) {
            ...
            if (i10 != 15 && i10 != 17) {
                ...
                if (!sharedInstance.isScreencast() && (this.f37790n0 || this.m0)) {
                ...
                v(this.f37774f, sharedInstance, false);
                t(this.h, sharedInstance, z10);
                this.f37789n.c(R.drawable.calls_decline, -1, -1041108, 1.0f, true, LocaleController.getString(R.string.VoipEndCall2), false, z10);
                this.f37789n.setOnClickListener(new ei1(this, 0));
            } else {
                TL_phone.PhoneCall phoneCall = sharedInstance.privateCall;
            ...
            if (this.f37774f.getVisibility() == 0) {
                this.f37774f.f29021f = i11;
                i11 += 16;
            }
            ...
            if (this.f37789n.getVisibility() == 0) {
                this.f37789n.F = i11;
            }
            F();
        }
    ...
    public final void G() {
        this.f37785k0.setColor(i0.a.k(-16777216, (int) (this.f37806y0 * 102.0f * this.F0)));
        this.f37787l0.setColor(i0.a.k(-16777216, (int) (127.5f * this.F0)));
        oi1 oi1Var = this.f37796s;
        if (oi1Var != null) {
            oi1Var.invalidate();
        }
    }
    ...
    public final void a(com.google.android.gms.internal.cast.p pVar) {
        this.l1 = pVar;
        org.telegram.ui.Components.voip.s2 s2Var = this.f37768c0;
        if (s2Var != null) {
            s2Var.d.clearFirstFrame();
        }
        this.f37788m1 = true;
        H();
        ((WindowManager) this.f37764b.getSystemService("window")).removeView(this.f37799u0);
        this.f37799u0.invalidate();
    }
    ...
    public final void b(com.google.android.gms.internal.cast.p pVar) {
        ...
        li1 li1Var = this.f37799u0;
        li1Var.getClass();
        ((WindowManager) this.f37764b.getSystemService("window")).addView(li1Var, org.telegram.ui.Components.voip.w2.a());
        this.f37788m1 = false;
        H();
        this.f37799u0.invalidate();
        org.telegram.ui.Components.voip.s2 s2Var = this.f37786k1;
        if (s2Var != null) {
            s2Var.d.release();
            this.f37786k1 = null;
        }
    ...
    public final Bitmap c() {
        ...
        if (s2Var != null && s2Var.d.isAvailable()) {
            return this.f37786k1.d.getBitmap();
        }
        return null;
    }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.voipServiceCreated) {
            if (this.f37792p0 == 17 && VoIPService.getSharedInstance() != null) {
                this.f37770d0.d.release();
                this.f37768c0.d.release();
                this.f37765b0.release();
                o();
                VoIPService.getSharedInstance().registerStateListener(this);
            }
            ...
            this.f37805y.setAmplitude(((Float) objArr[0]).floatValue() * 15.0f);
        } else if (i10 == NotificationCenter.nearEarEvent) {
            boolean booleanValue = ((Boolean) objArr[0]).booleanValue();
            this.f37775f0 = booleanValue;
            if (booleanValue) {
                this.f37805y.b(true, true);
            }
        }
    }
    ...
    public final Bitmap e() {
        org.telegram.ui.Components.voip.s2 s2Var = this.f37768c0;
        if (s2Var != null && s2Var.d.isAvailable()) {
            return this.f37768c0.d.getBitmap();
        }
        return null;
    }
    ...
    @Override
    public final View h() {
        org.telegram.ui.Components.voip.s2 s2Var = new org.telegram.ui.Components.voip.s2(this.f37764b, false, true, false, false);
        this.f37786k1 = s2Var;
        s2Var.d.setScalingType(RendererCommon.ScalingType.SCALE_ASPECT_FIT);
        this.f37786k1.d.setEnableHardwareScaler(true);
        this.f37786k1.d.setRotateTextureWithScreen(true);
        org.telegram.ui.Components.voip.s2 s2Var2 = this.f37786k1;
        s2Var2.f29184a0 = 1;
        s2Var2.d.init(VideoCapturerDevice.getEglBase().getEglBaseContext(), new ni1(this));
        View view = this.f37786k1.h;
        if (view != null) {
            view.setVisibility(8);
        }
        return this.f37786k1;
    }
    ...
    public final ValueAnimator k(boolean z10) {
        ...
        float f17 = org.telegram.ui.Components.voip.m2.k().d.x + org.telegram.ui.Components.voip.m2.k().f29080y;
        ...
        org.telegram.ui.Components.voip.m2.U.getClass();
        final float measuredWidth = f17 - ((this.f37768c0.getMeasuredWidth() - (this.f37768c0.getMeasuredWidth() * 0.25f)) / 2.0f);
        final float measuredHeight2 = f18 - ((this.f37768c0.getMeasuredHeight() - (this.f37768c0.getMeasuredHeight() * 0.25f)) / 2.0f);
        final float f19 = 1.0f;
        if (this.m0) {
            int measuredWidth2 = this.Y.getMeasuredWidth();
            if (this.f37790n0 && measuredWidth2 != 0) {
                f16 = (this.f37799u0.getMeasuredWidth() / measuredWidth2) * 0.25f * 0.4f;
                c10 = 0;
                f15 = (((org.telegram.ui.Components.voip.m2.k().f29074f * 0.25f) + (f17 - ((this.Y.getMeasuredWidth() - (this.Y.getMeasuredWidth() * f16)) / 2.0f))) - ((org.telegram.ui.Components.voip.m2.k().f29074f * 0.25f) * 0.4f)) - AndroidUtilities.dp(4.0f);
        ...
        if (z10) {
            ...
            this.f37768c0.setScaleX(0.25f);
            this.f37768c0.setScaleY(0.25f);
            this.f37768c0.setTranslationX(measuredWidth);
            this.f37768c0.setTranslationY(measuredHeight2);
            this.f37768c0.setRoundCorners((AndroidUtilities.dp(6.0f) * 1.0f) / 0.25f);
        }
        if (z10) {
            f12 = 1.0f;
        } else {
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                ...
                ti1Var.f37768c0.setScaleX(f25);
                ti1Var.f37768c0.setScaleY(f25);
                float f26 = 0.0f * f23;
                float f27 = (measuredWidth * floatValue) + f26;
                float f28 = (measuredHeight2 * floatValue) + f26;
                ti1Var.f37768c0.setTranslationX(f27);
                ti1Var.f37768c0.setTranslationY(f28);
                ti1Var.f37768c0.setRoundCorners(((AndroidUtilities.dp(4.0f) * floatValue) * 1.0f) / f25);
                if (!ti1Var.Y.P) {
                    ti1Var.f37770d0.d(floatValue, false);
                }
                ti1Var.f37799u0.invalidate();
            }
        });
        return ofFloat;
    }
    ...
    public final void l() {
        ...
        NotificationCenter.getInstance(this.f37761a).removeObserver(this, NotificationCenter.voipServiceCreated);
    ...
    public final void m(boolean z10) {
        ...
        if (this.B0 && this.C0 != z10 && this.f37804x0) {
            this.C0 = z10;
            org.telegram.ui.Components.voip.z2 z2Var = this.f37801w;
            if (z2Var.K && z10 != z2Var.E) {
                ...
                z2Var.f29362c = ofFloat;
                ofFloat.addUpdateListener(new org.telegram.ui.Components.voip.y2(z2Var, 1));
                z2Var.f29362c.setInterpolator(org.telegram.ui.Components.qr.f27383f);
                z2Var.f29362c.setDuration(200L);
                z2Var.f29362c.start();
            }
            if (z10) {
                ...
                AndroidUtilities.cancelRunOnUIThread(this.S0);
                this.R0 = false;
                if (this.f37805y.getVisibility() == 0) {
                    this.f37805y.animate().setStartDelay(0L).translationY(AndroidUtilities.dp(48.0f)).scaleY(0.1f).scaleX(0.1f).alpha(0.0f).setDuration(200L).setInterpolator(org.telegram.ui.Components.qr.f27383f).start();
                }
                ...
                this.O.animate().alpha(1.0f).scaleY(1.0f).scaleX(1.0f).setDuration(340L).setInterpolator(org.telegram.ui.Components.qr.f27384g).start();
                ...
                if (this.f37805y.getVisibility() == 0) {
                    this.f37805y.animate().setStartDelay(50L).translationY(0.0f).scaleX(1.0f).scaleY(1.0f).alpha(1.0f).setDuration(250L).setInterpolator(org.telegram.ui.Components.qr.f27383f).start();
                }
                this.O.animate().setListener(null).cancel();
    ...
    public final void o() {
        this.f37770d0.d.init(VideoCapturerDevice.getEglBase().getEglBaseContext(), new ii1(this));
        this.f37768c0.d.init(VideoCapturerDevice.getEglBase().getEglBaseContext(), new ji1(this), EglBase.CONFIG_PLAIN, new GlRectDrawer());
        this.f37765b0.init(VideoCapturerDevice.getEglBase().getEglBaseContext(), null);
    }
    ...
    public final void onMediaStateUpdated(int i10, int i11) {
        ...
        if (sharedInstance != null && sharedInstance.getRemoteVideoState() == 2) {
            if (this.f37777g0 == null && sf.c.a(this.f37764b) == 1) {
                pf.d dVar = new pf.d(this.f37764b, f37760n1);
                dVar.f40812c = "voip-fragment-pip";
                org.telegram.ui.Components.voip.s2 s2Var = this.f37768c0;
                dVar.f40816j = s2Var.d;
                dVar.f40817k = s2Var.getPlaceholderView();
                this.f37777g0 = dVar.a();
            }
        } else {
            pf.e eVar = this.f37777g0;
            if (eVar != null) {
    ...
    public final void onStateChanged(int i10) {
        int i11 = this.f37792p0;
        if (i11 != i10) {
            this.f37793q0 = i11;
            this.f37792p0 = i10;
            if (this.f37799u0 != null) {
                H();
            }
        }
    }
    ...
    public final void p() {
        if (!this.G0 && !this.E0) {
            mi1 mi1Var = this.f37791o0;
            if (mi1Var != null) {
                mi1Var.a(false, false);
            } else if (this.m0 && this.f37790n0 && this.H0) {
                this.H0 = false;
                ...
                if (this.D0 && VoIPService.getSharedInstance() != null && !VoIPService.getSharedInstance().isConverting()) {
                    if (sf.c.a(this.f37764b) > 0) {
                        if (!this.G0 && f37760n1 != null) {
                            this.G0 = true;
                            if (VoIPService.getSharedInstance() != null) {
                                int measuredHeight = f37760n1.f37799u0.getMeasuredHeight();
                                ti1 ti1Var = f37760n1;
                                org.telegram.ui.Components.voip.m2.l(ti1Var.f37764b, ti1Var.f37761a, ti1Var.f37799u0.getMeasuredWidth(), measuredHeight, 1);
                                WindowInsets windowInsets = f37760n1.f37795r0;
                                if (windowInsets != null) {
                                    org.telegram.ui.Components.voip.m2.W = windowInsets.getSystemWindowInsetTop();
                                    f37760n1.f37795r0.getSystemWindowInsetBottom();
                                }
                            }
                            if (org.telegram.ui.Components.voip.m2.k() != null) {
                                ...
                                this.f37783j0.animate().alpha(0.0f).setDuration(350L).setInterpolator(qrVar).start();
                                this.f37779h0.animate().alpha(0.0f).setDuration(350L).setInterpolator(qrVar).start();
                                this.f37781i0.animate().alpha(0.0f).setDuration(350L).setInterpolator(qrVar).start();
                    ...
                    org.telegram.ui.Components.c5.B(this.f37764b, new bi1(this, 0), true).o();
                    return;
                }
                this.f37799u0.b();
            }
    ...
    public final void r(Runnable runnable) {
        if (this.f37774f.getVisibility() == 0) {
            this.f37772e0.getLocationOnScreen(new int[2]);
            org.telegram.ui.Components.voip.e eVar = this.f37772e0;
            ValueAnimator valueAnimator = eVar.f28903b0;
            if (valueAnimator != null) {
                valueAnimator.cancel();
                eVar.f28903b0 = null;
                eVar.U.stop();
        ...
        this.f37789n.animate().cancel();
        this.e.animate().cancel();
        this.h.animate().cancel();
        this.f37774f.animate().cancel();
        this.f37772e0.getLocationOnScreen(new int[2]);
        org.telegram.ui.Components.voip.e eVar2 = this.f37772e0;
        ValueAnimator valueAnimator2 = eVar2.f28903b0;
        if (valueAnimator2 != null) {
            valueAnimator2.cancel();
            eVar2.f28903b0 = null;
            eVar2.U.stop();
        }
        this.f37789n.c(R.drawable.calls_decline, -1, -1041108, 1.0f, true, LocaleController.getString(R.string.VoipEndCall2), false, false);
        this.e.d(5, false, false);
        this.h.d(1, false, false);
        this.f37774f.d(3, true, false);
        this.f37789n.setVisibility(0);
        this.e.setVisibility(0);
        this.h.setVisibility(0);
        this.f37774f.setVisibility(0);
        this.f37789n.setAlpha(0.0f);
        this.e.setAlpha(0.0f);
        this.h.setAlpha(0.0f);
        this.f37774f.setAlpha(0.0f);
        final ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) this.f37772e0.getLayoutParams();
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator3) {
                ...
                ti1Var.f37772e0.setTranslationY(dp2 * floatValue);
                int i10 = marginEnd;
                int i11 = (int) (i10 - ((i10 + dp) * floatValue));
                ViewGroup.MarginLayoutParams marginLayoutParams2 = marginLayoutParams;
                marginLayoutParams2.leftMargin = i11;
                marginLayoutParams2.rightMargin = i11;
                ti1Var.f37772e0.requestLayout();
            }
        });
        org.telegram.ui.Components.voip.e eVar3 = this.f37772e0;
        ObjectAnimator ofFloat2 = ObjectAnimator.ofFloat(eVar3, View.SCALE_X, eVar3.getScaleX(), 1.0f, 1.0f, 1.0f);
        org.telegram.ui.Components.voip.e eVar4 = this.f37772e0;
        ObjectAnimator ofFloat3 = ObjectAnimator.ofFloat(eVar4, View.SCALE_Y, eVar4.getScaleY(), 1.0f, 1.0f, 1.0f);
        org.telegram.ui.Components.voip.e eVar5 = this.f37772e0;
        animatorSet.playTogether(ofFloat, ofFloat2, ofFloat3, ObjectAnimator.ofFloat(eVar5, View.ALPHA, eVar5.getAlpha(), this.f37772e0.getAlpha(), 0.0f, 0.0f));
    ...
    public final void t(org.telegram.ui.Components.voip.k3 k3Var, VoIPService voIPService, boolean z10) {
        ...
        float f7 = 0.0f;
        if (!z10) {
            ValueAnimator valueAnimator = u1Var.f29267f0;
            if (valueAnimator != null) {
                valueAnimator.cancel();
            }
            if (isMicMute) {
            ...
            ValueAnimator valueAnimator2 = u1Var.f29267f0;
            if (valueAnimator2 != null) {
                valueAnimator2.cancel();
            }
            float f10 = u1Var.K;
            ...
            u1Var.f29267f0 = ofFloat;
            ofFloat.addUpdateListener(u1Var.f29268g0);
            u1Var.f29267f0.setDuration(150L);
            u1Var.f29267f0.start();
        }
    ...
    public final void x(boolean z10, boolean z11) {
        ...
        Integer num = null;
        if (z10) {
            if (z12 && this.f37805y.getTag() == null) {
                this.f37805y.animate().setListener(null).cancel();
                this.f37805y.setVisibility(0);
                if (!this.C0) {
                    if (z11) {
                        this.f37805y.setAlpha(0.0f);
                        this.f37805y.animate().alpha(1.0f).translationY(0.0f).scaleY(1.0f).scaleX(1.0f).setDuration(150L).setInterpolator(org.telegram.ui.Components.qr.f27383f).start();
                    } else {
                        this.f37805y.setAlpha(0.0f);
                        this.f37805y.setTranslationY(-AndroidUtilities.dp(135.0f));
                        this.f37805y.animate().alpha(1.0f).translationY(0.0f).scaleY(1.0f).scaleX(1.0f).setDuration(150L).setInterpolator(org.telegram.ui.Components.qr.f27383f).start();
                    }
                } else if (z11) {
                    this.f37805y.setAlpha(0.0f);
                    this.f37805y.setTranslationY(AndroidUtilities.dp(48.0f));
                    this.f37805y.setScaleX(0.1f);
                    this.f37805y.setScaleY(0.1f);
                }
            } else if (!z12 && this.f37805y.getTag() != null) {
                this.f37805y.animate().setListener(null).cancel();
                this.f37805y.setTranslationY(0.0f);
                this.f37805y.animate().alpha(0.0f).setDuration(150L).scaleX(0.1f).scaleY(0.1f).setInterpolator(org.telegram.ui.Components.qr.f27383f).setListener(new hi1(this, 7)).start();
            }
        } else {
            this.f37805y.animate().setListener(null).cancel();
            this.f37805y.setTranslationY(0.0f);
            this.f37805y.setAlpha(1.0f);
            this.f37805y.setScaleX(1.0f);
            this.f37805y.setScaleY(1.0f);
            org.telegram.ui.Components.voip.t0 t0Var = this.f37805y;
            if (!z12) {
                i10 = 8;
            }
            t0Var.setVisibility(i10);
        }
        org.telegram.ui.Components.voip.t0 t0Var2 = this.f37805y;
        if (z12) {
            num = 1;
        }
        t0Var2.setTag(num);
    ...
    public final void y(CharSequence charSequence) {
        TextView textView;
        if (this.f37764b.isFinishing()) {
            return;
        }
        org.telegram.ui.ActionBar.c2 c2Var = new org.telegram.ui.ActionBar.c2(this.f37764b, 0, null);
        boolean[] zArr = new boolean[3];
        c2Var.R = LocaleController.getString(R.string.VoipFailed);
        c2Var.T = charSequence;
        c2Var.f18508l0 = LocaleController.getString(R.string.OK);
        c2Var.m0 = null;
        c2Var.show();
        for (int i10 = 0; i10 < 3; i10++) {
            if (zArr[i10] && (textView = (TextView) c2Var.d(-(i10 + 1))) != null) {
                textView.setTextColor(c2Var.e(org.telegram.ui.ActionBar.j6.f19101q7));
            }
        }
    ...
    public final void z(int i10, boolean z10) {
        ...
        if (this.Y.getTag() == null || ((Integer) this.Y.getTag()).intValue() != 2) {
            this.Y.setUiVisible(this.f37804x0);
        }
        ...
        if (i10 == 0) {
            if (z10) {
                if (this.Y.getTag() != null && ((Integer) this.Y.getTag()).intValue() != 0) {
                    ...
                    this.A0.setDuration(250L).setInterpolator(org.telegram.ui.Components.qr.f27383f);
