...
public final class ti1 implements VoIPService.StateListener, NotificationCenter.NotificationCenterDelegate, rf.a {
    ...
    public boolean f37793a0;
    public boolean f37794a1;
    public Activity f37795b;
    public TextureViewRenderer f37796b0;
    public float f37797b1;
    public final TLRPC.User f37798c;
    public org.telegram.ui.Components.voip.s2 f37799c0;
    public float f37800c1;
    public final TLRPC.User d;
    public org.telegram.ui.Components.voip.s2 f37801d0;
    public int f37802d1;
    public org.telegram.ui.Components.voip.k3 e;
    public org.telegram.ui.Components.voip.e f37803e0;
    public int f37804e1;
    public org.telegram.ui.Components.voip.k3 f37805f;
    public boolean f37806f0;
    public pf.e f37808g0;
    public boolean f37809g1;
    public org.telegram.ui.Components.voip.k3 h;
    public View f37810h0;
    public boolean f37811h1;
    public View f37812i0;
    public ValueAnimator f37813i1;
    public org.telegram.ui.Components.voip.r1 f37814j0;
    public boolean f37815j1;
    public org.telegram.ui.Components.voip.s2 f37817k1;
    public com.google.android.gms.internal.cast.p l1;
    public boolean m0;
    public boolean f37819m1;
    public qi1 f37820n;
    public boolean f37821n0;
    public mi1 f37822o0;
    public int f37823p0;
    public int f37824q0;
    public WindowInsets f37826r0;
    public oi1 f37827s;
    public boolean f37828s0;
    public float f37829t0;
    public li1 f37830u0;
    public org.telegram.ui.Components.voip.c3 v;
    public int f37831v0;
    public org.telegram.ui.Components.voip.z2 f37832w;
    public AccessibilityManager f37833w0;
    public org.telegram.ui.Components.voip.e3 f37834x;
    public org.telegram.ui.Components.voip.t0 f37836y;
    public boolean f37838z0;
    public final org.telegram.ui.Components.voip.q1 f37825r = new org.telegram.ui.Components.voip.q1();
    public final org.telegram.ui.Components.v9[] V = new org.telegram.ui.Components.v9[4];
    public final Drawable[] W = new Drawable[4];
    public final Paint f37816k0 = new Paint();
    public final Paint f37818l0 = new Paint();
    public boolean f37835x0 = true;
    public float f37837y0 = 1.0f;
    ...
    public float f37807f1 = 1.0f;

    public ti1(int i10) {
        this.f37792a = i10;
        this.f37798c = MessagesController.getInstance(i10).getUser(Long.valueOf(UserConfig.getInstance(i10).getClientUserId()));
        ...
        this.f37824q0 = -1;
        this.f37823p0 = sharedState.getCallState();
    ...
    public static void i(ti1 ti1Var) {
        ...
        ti1Var.R0 = false;
        if (Build.VERSION.SDK_INT >= 23 && ti1Var.f37795b.checkSelfPermission("android.permission.CAMERA") != 0) {
            ti1Var.f37795b.requestPermissions(new String[]{"android.permission.CAMERA"}, 102);
        } else {
            ti1Var.C();
        }
    }
    ...
    public static void j(ti1 ti1Var) {
        ...
        if (ti1Var.f37809g1) {
            ...
            ti1Var.f37813i1 = ofFloat;
            ti1Var2 = ti1Var;
            ofFloat.addUpdateListener(new org.telegram.ui.Components.voip.x(ti1Var2, ti1Var.f37807f1, ti1Var.Y0, ti1Var.Z0, 1));
            ti1Var2.f37813i1.addListener(new hi1(ti1Var2, 0));
            ti1Var2.f37813i1.setDuration(350L);
            ti1Var2.f37813i1.setInterpolator(org.telegram.ui.Components.qr.f27653f);
            ti1Var2.f37813i1.start();
        } else {
            ti1Var2 = ti1Var;
        }
        ti1Var2.f37811h1 = false;
        ti1Var2.f37794a1 = false;
    }
        ...
        if (ti1Var != null) {
            if (i10 == 101) {
                if (VoIPService.getSharedState() == null) {
                    ...
                    ti1Var.r(new u21(4));
                } else if (!ti1Var.f37795b.shouldShowRequestPermissionRationale("android.permission.RECORD_AUDIO")) {
                    if (VoIPService.getSharedState() != null) {
                        VoIPService.getSharedState().declineIncomingCall();
                    }
                    org.telegram.ui.Components.voip.f2.h(ti1Var.f37795b, new di1(ti1Var, 2), i10);
                    return;
                }
            }
            if (i10 == 102) {
    ...
    public static void w(Activity activity, int i10) {
        ...
        float f7;
        ti1 ti1Var = f37791n1;
        if (ti1Var != null && ti1Var.f37830u0.getParent() == null) {
            ti1 ti1Var2 = f37791n1;
            if (ti1Var2 != null) {
                ti1Var2.f37799c0.d.release();
                f37791n1.f37801d0.d.release();
                f37791n1.f37796b0.release();
                li1 li1Var = f37791n1.f37830u0;
                if (li1Var != null) {
                    li1Var.d();
                }
                f37791n1.l();
        ...
        if (f37791n1 == null && !activity.isFinishing()) {
            ...
            if (VoIPService.getSharedState() != null && VoIPService.getSharedState().getUser() != null) {
                ...
                ti1Var3.f37795b = activity;
                f37791n1 = ti1Var3;
                li1 li1Var2 = new li1(activity, !z10, ti1Var3);
                f37791n1.J0 = ((KeyguardManager) activity.getSystemService("keyguard")).inKeyguardRestrictedInputMode();
                ((PowerManager) activity.getSystemService("power")).isInteractive();
                f37791n1.getClass();
                li1Var2.setLockOnScreen(f37791n1.J0);
                ti1Var3.f37830u0 = li1Var2;
                ...
                ti1Var3.f37829t0 = ViewConfiguration.get(activity).getScaledTouchSlop();
                ti1Var3.f37833w0 = (AccessibilityManager) f0.e.f(activity, AccessibilityManager.class);
                ...
                org.telegram.ui.Components.voip.q1 q1Var = ti1Var3.f37825r;
                ...
                ti1Var3.f37799c0 = s2Var;
                RendererCommon.ScalingType scalingType = RendererCommon.ScalingType.SCALE_ASPECT_FIT;
                s2Var.d.setScalingType(scalingType);
                ti1Var3.f37799c0.d.setEnableHardwareScaler(true);
                ti1Var3.f37799c0.d.setRotateTextureWithScreen(true);
                ti1Var3.f37799c0.f29569a0 = 1;
                ...
                ti1Var3.f37832w = z2Var;
                oi1Var.addView(z2Var, w7.y5.c(-1.0f, -1));
                ?? view = new View(activity);
                if (LiteMode.isEnabled(512)) {
                    int i12 = org.telegram.ui.ActionBar.j6.f19046a;
                    ...
                    if ((i13 == 11 && i14 >= 24 && i14 <= 31) || (i13 == 0 && i14 == 1)) {
                        view.f29306a = new org.telegram.ui.Components.nw0(0);
                    }
                }
                ti1Var3.f37834x = view;
                oi1Var.addView((View) view, w7.y5.c(220.0f, -1));
                oi1Var.addView(ti1Var3.f37799c0);
                ...
                ti1Var3.f37796b0 = textureViewRenderer;
                textureViewRenderer.setEnableHardwareScaler(true);
                ti1Var3.f37796b0.setIsCamera(false);
                ti1Var3.f37796b0.setFpsReduction(30.0f);
                ti1Var3.f37796b0.setScalingType(scalingType);
                ti1Var3.Z.addView(ti1Var3.f37796b0, w7.y5.e(-1, -2, 17));
                ...
                for (int i15 = 0; i15 < 4; i15++) {
                    ...
                    org.telegram.ui.Components.v9 v9Var2 = v9VarArr[i15];
                    if (i15 == 0) {
                        f7 = 0.0f;
                    } else {
                        f7 = 6.0f;
                    }
                    dc1Var2.addView(v9Var2, w7.y5.k(f7, 0.0f, 0.0f, 0.0f, 25, 25));
                }
                ...
                ti1Var3.f37836y = new org.telegram.ui.Components.voip.t0(activity);
                org.telegram.ui.Components.g9 g9Var = new org.telegram.ui.Components.g9((org.telegram.ui.ActionBar.f6) null);
                g9Var.r(user);
                org.telegram.ui.Components.voip.t0 t0Var = ti1Var3.f37836y;
                int i16 = ti1Var3.f37792a;
                t0Var.f29595b.h(ImageLocation.getForUserOrChat(i16, user, 0), null, g9Var, user);
                ti1Var3.f37836y.setRoundRadius(AndroidUtilities.dp(135.0f) / 2);
                ...
                frameLayout2.f29526a = new TextView[2];
                int i17 = 0;
                for (int i18 = 2; i17 < i18; i18 = 2) {
                    frameLayout2.f29526a[i17] = new TextView(activity);
                    frameLayout2.f29526a[i17].setTextSize(1, 15.0f);
                    frameLayout2.f29526a[i17].setTextColor(-1);
                    frameLayout2.f29526a[i17].setGravity(1);
                    frameLayout2.addView(frameLayout2.f29526a[i17]);
                    i17++;
                }
                FrameLayout frameLayout3 = new FrameLayout(activity);
                frameLayout2.f29528c = frameLayout3;
                ...
                frameLayout2.f29527b = textView3;
                ...
                if (sharedState != null && sharedState.getUser() != null && sharedState.isConference() && sharedState.getGroupCall() != null) {
                    ...
                    ti1Var3.G = si1Var;
                    long j3 = sharedState.getUser().f18490id;
                    ...
                    if (groupParticipants == null && i19 <= 0) {
                        ...
                        org.telegram.ui.Components.i9 i9Var = si1Var.f37436b;
                        i9Var.k(min);
                        int i20 = 0;
                        while (i20 < min) {
                        ...
                        if (max == 1 && (groupParticipants == null || groupParticipants.size() == 0 || (groupParticipants.size() == 1 && DialogObject.getPeerDialogId(groupParticipants.get(0).peer) == j10))) {
                            ...
                            si1Var.f37437c = new org.telegram.ui.Components.w01(LocaleController.formatPluralStringComma("Participants", max), 14.0f, AndroidUtilities.bold());
                ...
                oi1Var.addView(ti1Var3.f37836y, w7.y5.d(204, 204.0f, 1, 0.0f, 93.0f, 0.0f, 0.0f));
                ...
                ti1Var3.f37814j0 = new org.telegram.ui.Components.voip.r1(activity);
                ti1Var3.e = new org.telegram.ui.Components.voip.k3(activity, q1Var);
                ti1Var3.f37805f = new org.telegram.ui.Components.voip.k3(activity, q1Var);
                ti1Var3.h = new org.telegram.ui.Components.voip.k3(activity, q1Var);
                ti1Var3.f37820n = new org.telegram.ui.Components.voip.v2(activity, 52.0f);
                ...
                ti1Var3.f37805f.setTranslationY(AndroidUtilities.dp(100.0f));
                ti1Var3.f37805f.setScaleX(0.0f);
                ti1Var3.f37805f.setScaleY(0.0f);
                ti1Var3.f37805f.animate().setStartDelay(166).translationY(0.0f).scaleY(1.0f).scaleX(1.0f).setDuration(250L).start();
                ...
                ti1Var3.f37820n.setTranslationY(AndroidUtilities.dp(100.0f));
                ti1Var3.f37820n.setScaleX(0.0f);
                ti1Var3.f37820n.setScaleY(0.0f);
                ti1Var3.f37820n.animate().setStartDelay(198).translationY(0.0f).scaleY(1.0f).scaleX(1.0f).setDuration(250L).start();
                ti1Var3.f37814j0.addView(ti1Var3.e);
                ti1Var3.f37814j0.addView(ti1Var3.f37805f);
                ti1Var3.f37814j0.addView(ti1Var3.h);
                ti1Var3.f37814j0.addView(ti1Var3.f37820n);
                org.telegram.ui.Components.voip.e eVar = new org.telegram.ui.Components.voip.e(activity);
                ti1Var3.f37803e0 = eVar;
                eVar.setListener(new ri1(ti1Var3));
                ti1Var3.f37803e0.setScaleX(1.15f);
                ti1Var3.f37803e0.setScaleY(1.15f);
                oi1Var.addView(ti1Var3.f37814j0, w7.y5.e(-1, -2, 80));
                ...
                float f10 = i11;
                oi1Var.addView(ti1Var3.f37803e0, w7.y5.d(-1, 186.0f, 80, f10, 0.0f, f10, 0.0f));
                ...
                if (ti1Var3.f37830u0.f29697b) {
                    ti1Var3.H.setVisibility(8);
                    ti1Var3.I.setVisibility(8);
                }
                ?? linearLayout = new LinearLayout(activity);
                linearLayout.f29345a = new HashMap();
                linearLayout.f29346b = new ArrayList();
                linearLayout.f29347c = new ArrayList();
                TextPaint textPaint = new TextPaint();
                linearLayout.f29350r = textPaint;
                linearLayout.setOrientation(1);
                linearLayout.f29349n = q1Var;
                ...
                d3Var.K = alignment;
                d3Var.d = -1L;
                d3Var.f4637l0 = new di1(ti1Var3, 6);
                d3Var.T = true;
                ...
                if (z10) {
                    ...
                    if (sharedInstance2 != null && sharedInstance2.getVideoState(false) == 2) {
                        ti1Var3.f37799c0.setStub(org.telegram.ui.Components.voip.m2.k().f29461r);
                        ti1Var3.f37801d0.setStub(org.telegram.ui.Components.voip.m2.k().f29460n);
                    }
                    ti1Var3.f37830u0.setAlpha(0.0f);
                    ti1Var3.H();
                    ti1Var3.E0 = true;
                ...
                if (sharedInstance3 != null && sharedInstance3.getRemoteVideoState() == 2 && sf.c.a(activity) == 1) {
                    ti1 ti1Var4 = f37791n1;
                    pf.d dVar = new pf.d(activity, ti1Var4);
                    dVar.f41101c = "voip-fragment-pip";
                    org.telegram.ui.Components.voip.s2 s2Var3 = ti1Var4.f37799c0;
                    dVar.f41105j = s2Var3.d;
                    dVar.f41106k = s2Var3.getPlaceholderView();
                    ti1Var4.f37808g0 = dVar.a();
                }
            }
        }
    }
    ...
    public final void A(boolean z10) {
        ...
        if (!z10 && this.f37835x0) {
            ...
            this.f37814j0.animate().alpha(0.0f).translationY(AndroidUtilities.dp(10.0f)).setDuration(150L).setInterpolator(qrVar).start();
            this.f37810h0.animate().alpha(0.0f).setDuration(150L).setInterpolator(qrVar).start();
            this.f37812i0.animate().alpha(0.0f).setDuration(150L).setInterpolator(qrVar).start();
            ValueAnimator ofFloat = ValueAnimator.ofFloat(this.f37837y0, 0.0f);
            this.P0 = ofFloat;
            ...
            this.R0 = false;
            this.f37814j0.setEnabled(false);
            this.O0.e(true);
            i10 = 150;
        } else {
            if (z10 && !this.f37835x0) {
                ...
                this.f37814j0.animate().alpha(1.0f).translationY(0.0f).setDuration(150L).setInterpolator(qrVar2).start();
                this.f37810h0.animate().alpha(1.0f).setDuration(150L).setInterpolator(qrVar2).start();
                this.f37812i0.animate().alpha(1.0f).setDuration(150L).setInterpolator(qrVar2).start();
                ValueAnimator ofFloat2 = ValueAnimator.ofFloat(this.f37837y0, 1.0f);
                this.P0 = ofFloat2;
                ofFloat2.addUpdateListener(i21Var);
                this.P0.setDuration(150L).setInterpolator(qrVar2);
                this.P0.start();
                this.f37814j0.setEnabled(true);
            }
            i10 = 0;
        }
        this.f37835x0 = z10;
        li1 li1Var = this.f37830u0;
        if (!z10) {
        ...
        animate.translationY(i12 - i11).setDuration(150L).setStartDelay(i10).setInterpolator(org.telegram.ui.Components.qr.f27653f).start();
    }
    ...
    public final void B() {
        if (VoIPService.getSharedInstance() != null) {
            ...
            this.R0 = false;
            if (this.f37838z0 && this.f37835x0) {
    ...
    public final void C() {
        ...
        VoIPService sharedInstance = VoIPService.getSharedInstance();
        if (sharedInstance != null) {
            if (this.f37833w0.isTouchExplorationEnabled()) {
                if (!this.f37821n0) {
                ...
                this.f37827s.announceForAccessibility(string);
            }
            if (!this.f37821n0) {
                if (this.f37822o0 == null) {
                    sharedInstance.createCaptureDevice(false);
                    if (!sharedInstance.isFrontFaceCamera()) {
                        sharedInstance.switchCamera();
                    }
                    this.f37830u0.setLockOnScreen(true);
                    int[] iArr = new int[2];
                    this.f37805f.getLocationOnScreen(iArr);
                    mi1 mi1Var = new mi1(this, this.f37827s.getContext(), iArr[0], iArr[1]);
                    this.f37822o0 = mi1Var;
                    WindowInsets windowInsets = this.f37826r0;
                    if (windowInsets != null) {
                        mi1Var.setBottomPadding(windowInsets.getSystemWindowInsetBottom());
                    }
                    this.f37827s.addView(this.f37822o0);
                    return;
                }
                return;
            }
    ...
    public final void D(boolean z10) {
        ...
        if (sharedInstance != null) {
            if (z10) {
                ...
                TransitionManager.beginDelayedTransition(this.f37814j0, transitionSet);
            }
            int i10 = this.f37823p0;
            if (i10 == 11) {
                this.e.setVisibility(8);
                this.f37805f.setVisibility(8);
                this.h.setVisibility(8);
                this.f37820n.setVisibility(8);
                return;
            }
            int i11 = 0;
            if (i10 != 15 && i10 != 17) {
                ...
                if (!sharedInstance.isScreencast() && (this.f37821n0 || this.m0)) {
                ...
                v(this.f37805f, sharedInstance, false);
                t(this.h, sharedInstance, z10);
                this.f37820n.c(R.drawable.calls_decline, -1, -1041108, 1.0f, true, LocaleController.getString(R.string.VoipEndCall2), false, z10);
                this.f37820n.setOnClickListener(new ei1(this, 0));
            } else {
                TL_phone.PhoneCall phoneCall = sharedInstance.privateCall;
            ...
            if (this.f37805f.getVisibility() == 0) {
                this.f37805f.f29406f = i11;
                i11 += 16;
            }
            ...
            if (this.f37820n.getVisibility() == 0) {
                this.f37820n.F = i11;
            }
            F();
        }
    ...
    public final void G() {
        this.f37816k0.setColor(i0.a.k(-16777216, (int) (this.f37837y0 * 102.0f * this.F0)));
        this.f37818l0.setColor(i0.a.k(-16777216, (int) (127.5f * this.F0)));
        oi1 oi1Var = this.f37827s;
        if (oi1Var != null) {
            oi1Var.invalidate();
        }
    }
    ...
    public final void a(com.google.android.gms.internal.cast.p pVar) {
        this.l1 = pVar;
        org.telegram.ui.Components.voip.s2 s2Var = this.f37799c0;
        if (s2Var != null) {
            s2Var.d.clearFirstFrame();
        }
        this.f37819m1 = true;
        H();
        ((WindowManager) this.f37795b.getSystemService("window")).removeView(this.f37830u0);
        this.f37830u0.invalidate();
    }
    ...
    public final void b(com.google.android.gms.internal.cast.p pVar) {
        ...
        li1 li1Var = this.f37830u0;
        li1Var.getClass();
        ((WindowManager) this.f37795b.getSystemService("window")).addView(li1Var, org.telegram.ui.Components.voip.w2.a());
        this.f37819m1 = false;
        H();
        this.f37830u0.invalidate();
        org.telegram.ui.Components.voip.s2 s2Var = this.f37817k1;
        if (s2Var != null) {
            s2Var.d.release();
            this.f37817k1 = null;
        }
    ...
    public final Bitmap c() {
        ...
        if (s2Var != null && s2Var.d.isAvailable()) {
            return this.f37817k1.d.getBitmap();
        }
        return null;
    }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.voipServiceCreated) {
            if (this.f37823p0 == 17 && VoIPService.getSharedInstance() != null) {
                this.f37801d0.d.release();
                this.f37799c0.d.release();
                this.f37796b0.release();
                o();
                VoIPService.getSharedInstance().registerStateListener(this);
            }
            ...
            this.f37836y.setAmplitude(((Float) objArr[0]).floatValue() * 15.0f);
        } else if (i10 == NotificationCenter.nearEarEvent) {
            boolean booleanValue = ((Boolean) objArr[0]).booleanValue();
            this.f37806f0 = booleanValue;
            if (booleanValue) {
                this.f37836y.b(true, true);
            }
        }
    }
    ...
    public final Bitmap e() {
        org.telegram.ui.Components.voip.s2 s2Var = this.f37799c0;
        if (s2Var != null && s2Var.d.isAvailable()) {
            return this.f37799c0.d.getBitmap();
        }
        return null;
    }
    ...
    @Override
    public final View h() {
        org.telegram.ui.Components.voip.s2 s2Var = new org.telegram.ui.Components.voip.s2(this.f37795b, false, true, false, false);
        this.f37817k1 = s2Var;
        s2Var.d.setScalingType(RendererCommon.ScalingType.SCALE_ASPECT_FIT);
        this.f37817k1.d.setEnableHardwareScaler(true);
        this.f37817k1.d.setRotateTextureWithScreen(true);
        org.telegram.ui.Components.voip.s2 s2Var2 = this.f37817k1;
        s2Var2.f29569a0 = 1;
        s2Var2.d.init(VideoCapturerDevice.getEglBase().getEglBaseContext(), new ni1(this));
        View view = this.f37817k1.h;
        if (view != null) {
            view.setVisibility(8);
        }
        return this.f37817k1;
    }
    ...
    public final ValueAnimator k(boolean z10) {
        ...
        float f17 = org.telegram.ui.Components.voip.m2.k().d.x + org.telegram.ui.Components.voip.m2.k().f29465y;
        ...
        org.telegram.ui.Components.voip.m2.U.getClass();
        final float measuredWidth = f17 - ((this.f37799c0.getMeasuredWidth() - (this.f37799c0.getMeasuredWidth() * 0.25f)) / 2.0f);
        final float measuredHeight2 = f18 - ((this.f37799c0.getMeasuredHeight() - (this.f37799c0.getMeasuredHeight() * 0.25f)) / 2.0f);
        final float f19 = 1.0f;
        if (this.m0) {
            int measuredWidth2 = this.Y.getMeasuredWidth();
            if (this.f37821n0 && measuredWidth2 != 0) {
                f16 = (this.f37830u0.getMeasuredWidth() / measuredWidth2) * 0.25f * 0.4f;
                c10 = 0;
                f15 = (((org.telegram.ui.Components.voip.m2.k().f29459f * 0.25f) + (f17 - ((this.Y.getMeasuredWidth() - (this.Y.getMeasuredWidth() * f16)) / 2.0f))) - ((org.telegram.ui.Components.voip.m2.k().f29459f * 0.25f) * 0.4f)) - AndroidUtilities.dp(4.0f);
        ...
        if (z10) {
            ...
            this.f37799c0.setScaleX(0.25f);
            this.f37799c0.setScaleY(0.25f);
            this.f37799c0.setTranslationX(measuredWidth);
            this.f37799c0.setTranslationY(measuredHeight2);
            this.f37799c0.setRoundCorners((AndroidUtilities.dp(6.0f) * 1.0f) / 0.25f);
        }
        if (z10) {
            f12 = 1.0f;
        } else {
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                ...
                ti1Var.f37799c0.setScaleX(f25);
                ti1Var.f37799c0.setScaleY(f25);
                float f26 = 0.0f * f23;
                float f27 = (measuredWidth * floatValue) + f26;
                float f28 = (measuredHeight2 * floatValue) + f26;
                ti1Var.f37799c0.setTranslationX(f27);
                ti1Var.f37799c0.setTranslationY(f28);
                ti1Var.f37799c0.setRoundCorners(((AndroidUtilities.dp(4.0f) * floatValue) * 1.0f) / f25);
                if (!ti1Var.Y.P) {
                    ti1Var.f37801d0.d(floatValue, false);
                }
                ti1Var.f37830u0.invalidate();
            }
        });
        return ofFloat;
    }
    ...
    public final void l() {
        ...
        NotificationCenter.getInstance(this.f37792a).removeObserver(this, NotificationCenter.voipServiceCreated);
    ...
    public final void m(boolean z10) {
        ...
        if (this.B0 && this.C0 != z10 && this.f37835x0) {
            this.C0 = z10;
            org.telegram.ui.Components.voip.z2 z2Var = this.f37832w;
            if (z2Var.K && z10 != z2Var.E) {
                ...
                z2Var.f29747c = ofFloat;
                ofFloat.addUpdateListener(new org.telegram.ui.Components.voip.y2(z2Var, 1));
                z2Var.f29747c.setInterpolator(org.telegram.ui.Components.qr.f27653f);
                z2Var.f29747c.setDuration(200L);
                z2Var.f29747c.start();
            }
            if (z10) {
                ...
                AndroidUtilities.cancelRunOnUIThread(this.S0);
                this.R0 = false;
                if (this.f37836y.getVisibility() == 0) {
                    this.f37836y.animate().setStartDelay(0L).translationY(AndroidUtilities.dp(48.0f)).scaleY(0.1f).scaleX(0.1f).alpha(0.0f).setDuration(200L).setInterpolator(org.telegram.ui.Components.qr.f27653f).start();
                }
                ...
                this.O.animate().alpha(1.0f).scaleY(1.0f).scaleX(1.0f).setDuration(340L).setInterpolator(org.telegram.ui.Components.qr.f27654g).start();
                ...
                if (this.f37836y.getVisibility() == 0) {
                    this.f37836y.animate().setStartDelay(50L).translationY(0.0f).scaleX(1.0f).scaleY(1.0f).alpha(1.0f).setDuration(250L).setInterpolator(org.telegram.ui.Components.qr.f27653f).start();
                }
                this.O.animate().setListener(null).cancel();
    ...
    public final void o() {
        this.f37801d0.d.init(VideoCapturerDevice.getEglBase().getEglBaseContext(), new ii1(this));
        this.f37799c0.d.init(VideoCapturerDevice.getEglBase().getEglBaseContext(), new ji1(this), EglBase.CONFIG_PLAIN, new GlRectDrawer());
        this.f37796b0.init(VideoCapturerDevice.getEglBase().getEglBaseContext(), null);
    }
    ...
    public final void onMediaStateUpdated(int i10, int i11) {
        ...
        if (sharedInstance != null && sharedInstance.getRemoteVideoState() == 2) {
            if (this.f37808g0 == null && sf.c.a(this.f37795b) == 1) {
                pf.d dVar = new pf.d(this.f37795b, f37791n1);
                dVar.f41101c = "voip-fragment-pip";
                org.telegram.ui.Components.voip.s2 s2Var = this.f37799c0;
                dVar.f41105j = s2Var.d;
                dVar.f41106k = s2Var.getPlaceholderView();
                this.f37808g0 = dVar.a();
            }
        } else {
            pf.e eVar = this.f37808g0;
            if (eVar != null) {
    ...
    public final void onStateChanged(int i10) {
        int i11 = this.f37823p0;
        if (i11 != i10) {
            this.f37824q0 = i11;
            this.f37823p0 = i10;
            if (this.f37830u0 != null) {
                H();
            }
        }
    }
    ...
    public final void p() {
        if (!this.G0 && !this.E0) {
            mi1 mi1Var = this.f37822o0;
            if (mi1Var != null) {
                mi1Var.a(false, false);
            } else if (this.m0 && this.f37821n0 && this.H0) {
                this.H0 = false;
                ...
                if (this.D0 && VoIPService.getSharedInstance() != null && !VoIPService.getSharedInstance().isConverting()) {
                    if (sf.c.a(this.f37795b) > 0) {
                        if (!this.G0 && f37791n1 != null) {
                            this.G0 = true;
                            if (VoIPService.getSharedInstance() != null) {
                                int measuredHeight = f37791n1.f37830u0.getMeasuredHeight();
                                ti1 ti1Var = f37791n1;
                                org.telegram.ui.Components.voip.m2.l(ti1Var.f37795b, ti1Var.f37792a, ti1Var.f37830u0.getMeasuredWidth(), measuredHeight, 1);
                                WindowInsets windowInsets = f37791n1.f37826r0;
                                if (windowInsets != null) {
                                    org.telegram.ui.Components.voip.m2.W = windowInsets.getSystemWindowInsetTop();
                                    f37791n1.f37826r0.getSystemWindowInsetBottom();
                                }
                            }
                            if (org.telegram.ui.Components.voip.m2.k() != null) {
                                ...
                                this.f37814j0.animate().alpha(0.0f).setDuration(350L).setInterpolator(qrVar).start();
                                this.f37810h0.animate().alpha(0.0f).setDuration(350L).setInterpolator(qrVar).start();
                                this.f37812i0.animate().alpha(0.0f).setDuration(350L).setInterpolator(qrVar).start();
                    ...
                    org.telegram.ui.Components.d5.B(this.f37795b, new bi1(this, 0), true).o();
                    return;
                }
                this.f37830u0.b();
            }
    ...
    public final void r(Runnable runnable) {
        if (this.f37805f.getVisibility() == 0) {
            this.f37803e0.getLocationOnScreen(new int[2]);
            org.telegram.ui.Components.voip.e eVar = this.f37803e0;
            ValueAnimator valueAnimator = eVar.f29288b0;
            if (valueAnimator != null) {
                valueAnimator.cancel();
                eVar.f29288b0 = null;
                eVar.U.stop();
        ...
        this.f37820n.animate().cancel();
        this.e.animate().cancel();
        this.h.animate().cancel();
        this.f37805f.animate().cancel();
        this.f37803e0.getLocationOnScreen(new int[2]);
        org.telegram.ui.Components.voip.e eVar2 = this.f37803e0;
        ValueAnimator valueAnimator2 = eVar2.f29288b0;
        if (valueAnimator2 != null) {
            valueAnimator2.cancel();
            eVar2.f29288b0 = null;
            eVar2.U.stop();
        }
        this.f37820n.c(R.drawable.calls_decline, -1, -1041108, 1.0f, true, LocaleController.getString(R.string.VoipEndCall2), false, false);
        this.e.d(5, false, false);
        this.h.d(1, false, false);
        this.f37805f.d(3, true, false);
        this.f37820n.setVisibility(0);
        this.e.setVisibility(0);
        this.h.setVisibility(0);
        this.f37805f.setVisibility(0);
        this.f37820n.setAlpha(0.0f);
        this.e.setAlpha(0.0f);
        this.h.setAlpha(0.0f);
        this.f37805f.setAlpha(0.0f);
        final ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) this.f37803e0.getLayoutParams();
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator3) {
                ...
                ti1Var.f37803e0.setTranslationY(dp2 * floatValue);
                int i10 = marginEnd;
                int i11 = (int) (i10 - ((i10 + dp) * floatValue));
                ViewGroup.MarginLayoutParams marginLayoutParams2 = marginLayoutParams;
                marginLayoutParams2.leftMargin = i11;
                marginLayoutParams2.rightMargin = i11;
                ti1Var.f37803e0.requestLayout();
            }
        });
        org.telegram.ui.Components.voip.e eVar3 = this.f37803e0;
        ObjectAnimator ofFloat2 = ObjectAnimator.ofFloat(eVar3, View.SCALE_X, eVar3.getScaleX(), 1.0f, 1.0f, 1.0f);
        org.telegram.ui.Components.voip.e eVar4 = this.f37803e0;
        ObjectAnimator ofFloat3 = ObjectAnimator.ofFloat(eVar4, View.SCALE_Y, eVar4.getScaleY(), 1.0f, 1.0f, 1.0f);
        org.telegram.ui.Components.voip.e eVar5 = this.f37803e0;
        animatorSet.playTogether(ofFloat, ofFloat2, ofFloat3, ObjectAnimator.ofFloat(eVar5, View.ALPHA, eVar5.getAlpha(), this.f37803e0.getAlpha(), 0.0f, 0.0f));
    ...
    public final void t(org.telegram.ui.Components.voip.k3 k3Var, VoIPService voIPService, boolean z10) {
        ...
        float f7 = 0.0f;
        if (!z10) {
            ValueAnimator valueAnimator = u1Var.f29652f0;
            if (valueAnimator != null) {
                valueAnimator.cancel();
            }
            if (isMicMute) {
            ...
            ValueAnimator valueAnimator2 = u1Var.f29652f0;
            if (valueAnimator2 != null) {
                valueAnimator2.cancel();
            }
            float f10 = u1Var.K;
            ...
            u1Var.f29652f0 = ofFloat;
            ofFloat.addUpdateListener(u1Var.f29653g0);
            u1Var.f29652f0.setDuration(150L);
            u1Var.f29652f0.start();
        }
    ...
    public final void x(boolean z10, boolean z11) {
        ...
        Integer num = null;
        if (z10) {
            if (z12 && this.f37836y.getTag() == null) {
                this.f37836y.animate().setListener(null).cancel();
                this.f37836y.setVisibility(0);
                if (!this.C0) {
                    if (z11) {
                        this.f37836y.setAlpha(0.0f);
                        this.f37836y.animate().alpha(1.0f).translationY(0.0f).scaleY(1.0f).scaleX(1.0f).setDuration(150L).setInterpolator(org.telegram.ui.Components.qr.f27653f).start();
                    } else {
                        this.f37836y.setAlpha(0.0f);
                        this.f37836y.setTranslationY(-AndroidUtilities.dp(135.0f));
                        this.f37836y.animate().alpha(1.0f).translationY(0.0f).scaleY(1.0f).scaleX(1.0f).setDuration(150L).setInterpolator(org.telegram.ui.Components.qr.f27653f).start();
                    }
                } else if (z11) {
                    this.f37836y.setAlpha(0.0f);
                    this.f37836y.setTranslationY(AndroidUtilities.dp(48.0f));
                    this.f37836y.setScaleX(0.1f);
                    this.f37836y.setScaleY(0.1f);
                }
            } else if (!z12 && this.f37836y.getTag() != null) {
                this.f37836y.animate().setListener(null).cancel();
                this.f37836y.setTranslationY(0.0f);
                this.f37836y.animate().alpha(0.0f).setDuration(150L).scaleX(0.1f).scaleY(0.1f).setInterpolator(org.telegram.ui.Components.qr.f27653f).setListener(new hi1(this, 7)).start();
            }
        } else {
            this.f37836y.animate().setListener(null).cancel();
            this.f37836y.setTranslationY(0.0f);
            this.f37836y.setAlpha(1.0f);
            this.f37836y.setScaleX(1.0f);
            this.f37836y.setScaleY(1.0f);
            org.telegram.ui.Components.voip.t0 t0Var = this.f37836y;
            if (!z12) {
                i10 = 8;
            }
            t0Var.setVisibility(i10);
        }
        org.telegram.ui.Components.voip.t0 t0Var2 = this.f37836y;
        if (z12) {
            num = 1;
        }
        t0Var2.setTag(num);
    ...
    public final void y(CharSequence charSequence) {
        TextView textView;
        if (this.f37795b.isFinishing()) {
            return;
        }
        org.telegram.ui.ActionBar.b2 b2Var = new org.telegram.ui.ActionBar.b2(this.f37795b, 0, null);
        boolean[] zArr = new boolean[3];
        b2Var.R = LocaleController.getString(R.string.VoipFailed);
        b2Var.T = charSequence;
        b2Var.f18710l0 = LocaleController.getString(R.string.OK);
        b2Var.m0 = null;
        b2Var.show();
        for (int i10 = 0; i10 < 3; i10++) {
            if (zArr[i10] && (textView = (TextView) b2Var.d(-(i10 + 1))) != null) {
                textView.setTextColor(b2Var.e(org.telegram.ui.ActionBar.j6.f19348q7));
            }
        }
    ...
    public final void z(int i10, boolean z10) {
        ...
        if (this.Y.getTag() == null || ((Integer) this.Y.getTag()).intValue() != 2) {
            this.Y.setUiVisible(this.f37835x0);
        }
        ...
        if (i10 == 0) {
            if (z10) {
                if (this.Y.getTag() != null && ((Integer) this.Y.getTag()).intValue() != 0) {
                    ...
                    this.A0.setDuration(250L).setInterpolator(org.telegram.ui.Components.qr.f27653f);
