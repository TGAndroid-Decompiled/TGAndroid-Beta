...
public final class ti1 implements VoIPService.StateListener, NotificationCenter.NotificationCenterDelegate, rf.a {
    ...
    public boolean f37694a0;
    public boolean f37695a1;
    public Activity f37696b;
    public TextureViewRenderer f37697b0;
    public float f37698b1;
    public final TLRPC.User f37699c;
    public org.telegram.ui.Components.voip.s2 f37700c0;
    public float f37701c1;
    public final TLRPC.User d;
    public org.telegram.ui.Components.voip.s2 f37702d0;
    public int f37703d1;
    public org.telegram.ui.Components.voip.k3 e;
    public org.telegram.ui.Components.voip.e f37704e0;
    public int f37705e1;
    public org.telegram.ui.Components.voip.k3 f37706f;
    public boolean f37707f0;
    public pf.e f37709g0;
    public boolean f37710g1;
    public org.telegram.ui.Components.voip.k3 h;
    public View f37711h0;
    public boolean f37712h1;
    public View f37713i0;
    public ValueAnimator f37714i1;
    public org.telegram.ui.Components.voip.r1 f37715j0;
    public boolean f37716j1;
    public org.telegram.ui.Components.voip.s2 f37718k1;
    public com.google.android.gms.internal.cast.p l1;
    public boolean m0;
    public boolean f37720m1;
    public qi1 f37721n;
    public boolean f37722n0;
    public mi1 f37723o0;
    public int f37724p0;
    public int f37725q0;
    public WindowInsets f37727r0;
    public oi1 f37728s;
    public boolean f37729s0;
    public float f37730t0;
    public li1 f37731u0;
    public org.telegram.ui.Components.voip.c3 v;
    public int f37732v0;
    public org.telegram.ui.Components.voip.z2 f37733w;
    public AccessibilityManager f37734w0;
    public org.telegram.ui.Components.voip.e3 f37735x;
    public org.telegram.ui.Components.voip.t0 f37737y;
    public boolean f37739z0;
    public final org.telegram.ui.Components.voip.q1 f37726r = new org.telegram.ui.Components.voip.q1();
    public final org.telegram.ui.Components.u9[] V = new org.telegram.ui.Components.u9[4];
    public final Drawable[] W = new Drawable[4];
    public final Paint f37717k0 = new Paint();
    public final Paint f37719l0 = new Paint();
    public boolean f37736x0 = true;
    public float f37738y0 = 1.0f;
    public final AnimationNotificationsLocker L0 = new AnimationNotificationsLocker();
    public final z11 Q0 = new z11(this, 20);
    public final di1 S0 = new di1(this, 12);
    public final di1 T0 = new di1(this, 13);
    public float f37708f1 = 1.0f;

    public ti1(int i10) {
        this.f37693a = i10;
        this.f37699c = MessagesController.getInstance(i10).getUser(Long.valueOf(UserConfig.getInstance(i10).getClientUserId()));
        ...
        this.f37725q0 = -1;
        this.f37724p0 = sharedState.getCallState();
    ...
    public static void i(ti1 ti1Var) {
        ...
        ti1Var.R0 = false;
        if (Build.VERSION.SDK_INT >= 23 && ti1Var.f37696b.checkSelfPermission("android.permission.CAMERA") != 0) {
            ti1Var.f37696b.requestPermissions(new String[]{"android.permission.CAMERA"}, 102);
        } else {
            ti1Var.C();
        }
    }
    ...
    public static void j(ti1 ti1Var) {
        ...
        if (ti1Var.f37710g1) {
            ...
            ti1Var.f37714i1 = ofFloat;
            ti1Var2 = ti1Var;
            ofFloat.addUpdateListener(new org.telegram.ui.Components.voip.x(ti1Var2, ti1Var.f37708f1, ti1Var.Y0, ti1Var.Z0, 1));
            ti1Var2.f37714i1.addListener(new hi1(ti1Var2, 0));
            ti1Var2.f37714i1.setDuration(350L);
            ti1Var2.f37714i1.setInterpolator(org.telegram.ui.Components.qr.f27423f);
            ti1Var2.f37714i1.start();
        } else {
            ti1Var2 = ti1Var;
        }
        ti1Var2.f37712h1 = false;
        ti1Var2.f37695a1 = false;
    }
        ...
        if (ti1Var != null) {
            if (i10 == 101) {
                if (VoIPService.getSharedState() == null) {
                    ...
                    ti1Var.r(new n91(2));
                } else if (!ti1Var.f37696b.shouldShowRequestPermissionRationale("android.permission.RECORD_AUDIO")) {
                    if (VoIPService.getSharedState() != null) {
                        VoIPService.getSharedState().declineIncomingCall();
                    }
                    org.telegram.ui.Components.voip.f2.h(ti1Var.f37696b, new di1(ti1Var, 2), i10);
                    return;
                }
            }
            if (i10 == 102) {
    ...
    public static void w(Activity activity, int i10) {
        ...
        float f7;
        ti1 ti1Var = f37692n1;
        if (ti1Var != null && ti1Var.f37731u0.getParent() == null) {
            ti1 ti1Var2 = f37692n1;
            if (ti1Var2 != null) {
                ti1Var2.f37700c0.d.release();
                f37692n1.f37702d0.d.release();
                f37692n1.f37697b0.release();
                li1 li1Var = f37692n1.f37731u0;
                if (li1Var != null) {
                    li1Var.d();
                }
                f37692n1.l();
        ...
        if (f37692n1 == null && !activity.isFinishing()) {
            ...
            if (VoIPService.getSharedState() != null && VoIPService.getSharedState().getUser() != null) {
                ...
                ti1Var3.f37696b = activity;
                f37692n1 = ti1Var3;
                li1 li1Var2 = new li1(activity, !z10, ti1Var3);
                f37692n1.J0 = ((KeyguardManager) activity.getSystemService("keyguard")).inKeyguardRestrictedInputMode();
                ((PowerManager) activity.getSystemService("power")).isInteractive();
                f37692n1.getClass();
                li1Var2.setLockOnScreen(f37692n1.J0);
                ti1Var3.f37731u0 = li1Var2;
                ...
                ti1Var3.f37730t0 = ViewConfiguration.get(activity).getScaledTouchSlop();
                ti1Var3.f37734w0 = (AccessibilityManager) f0.e.f(activity, AccessibilityManager.class);
                ...
                org.telegram.ui.Components.voip.q1 q1Var = ti1Var3.f37726r;
                ...
                ti1Var3.f37700c0 = s2Var;
                RendererCommon.ScalingType scalingType = RendererCommon.ScalingType.SCALE_ASPECT_FIT;
                s2Var.d.setScalingType(scalingType);
                ti1Var3.f37700c0.d.setEnableHardwareScaler(true);
                ti1Var3.f37700c0.d.setRotateTextureWithScreen(true);
                ti1Var3.f37700c0.f29204a0 = 1;
                ...
                ti1Var3.f37733w = z2Var;
                oi1Var.addView(z2Var, w7.x5.c(-1.0f, -1));
                ?? view = new View(activity);
                if (LiteMode.isEnabled(512)) {
                    int i12 = org.telegram.ui.ActionBar.i6.f18773a;
                    ...
                    if ((i13 == 11 && i14 >= 24 && i14 <= 31) || (i13 == 0 && i14 == 1)) {
                        view.f28941a = new org.telegram.ui.Components.aw0(0);
                    }
                }
                ti1Var3.f37735x = view;
                oi1Var.addView((View) view, w7.x5.c(220.0f, -1));
                oi1Var.addView(ti1Var3.f37700c0);
                GradientDrawable.Orientation orientation = GradientDrawable.Orientation.TOP_BOTTOM;
                new org.telegram.ui.Components.t9(orientation, new int[]{-14994098, -14328963}).f(k2.c0.m(0.5f, 1), new dd1(ti1Var3, 1), 0L);
                ...
                ti1Var3.f37697b0 = textureViewRenderer;
                textureViewRenderer.setEnableHardwareScaler(true);
                ti1Var3.f37697b0.setIsCamera(false);
                ti1Var3.f37697b0.setFpsReduction(30.0f);
                ti1Var3.f37697b0.setScalingType(scalingType);
                ti1Var3.Z.addView(ti1Var3.f37697b0, w7.x5.e(-1, -2, 17));
                ...
                ti1Var3.f37711h0 = view2;
                view2.setBackground(new GradientDrawable(orientation, new int[]{0, i0.a.k(-16777216, 127)}));
                oi1Var.addView(ti1Var3.f37711h0, w7.x5.e(-1, 160, 80));
                View view3 = new View(activity);
                ti1Var3.f37713i0 = view3;
                view3.setBackground(new GradientDrawable(orientation, new int[]{i0.a.k(-16777216, 102), 0}));
                oi1Var.addView(ti1Var3.f37713i0, w7.x5.e(-1, 160, 48));
                bc1 bc1Var = new bc1(ti1Var3, activity, 16);
                ti1Var3.N = bc1Var;
                ...
                for (int i15 = 0; i15 < 4; i15++) {
                    ...
                    bc1Var2.addView(u9Var2, w7.x5.k(f7, 0.0f, 0.0f, 0.0f, 25, 25));
                }
                ...
                ti1Var3.f37737y = new org.telegram.ui.Components.voip.t0(activity);
                org.telegram.ui.Components.f9 f9Var = new org.telegram.ui.Components.f9((org.telegram.ui.ActionBar.e6) null);
                f9Var.r(user);
                org.telegram.ui.Components.voip.t0 t0Var = ti1Var3.f37737y;
                int i16 = ti1Var3.f37693a;
                t0Var.f29230b.h(ImageLocation.getForUserOrChat(i16, user, 0), null, f9Var, user);
                ti1Var3.f37737y.setRoundRadius(AndroidUtilities.dp(135.0f) / 2);
                ...
                frameLayout2.f29161a = new TextView[2];
                int i17 = 0;
                for (int i18 = 2; i17 < i18; i18 = 2) {
                    frameLayout2.f29161a[i17] = new TextView(activity);
                    frameLayout2.f29161a[i17].setTextSize(1, 15.0f);
                    frameLayout2.f29161a[i17].setTextColor(-1);
                    frameLayout2.f29161a[i17].setGravity(1);
                    frameLayout2.addView(frameLayout2.f29161a[i17]);
                    i17++;
                }
                FrameLayout frameLayout3 = new FrameLayout(activity);
                frameLayout2.f29163c = frameLayout3;
                ...
                frameLayout2.f29162b = textView3;
                ...
                if (sharedState != null && sharedState.getUser() != null && sharedState.isConference() && sharedState.getGroupCall() != null) {
                    ...
                    ti1Var3.G = si1Var;
                    long j3 = sharedState.getUser().f18259id;
                    ...
                    if (groupParticipants == null && i19 <= 0) {
                        ...
                        org.telegram.ui.Components.h9 h9Var = si1Var.f37399b;
                        h9Var.k(min);
                        int i20 = 0;
                        while (i20 < min) {
                        ...
                        if (max == 1 && (groupParticipants == null || groupParticipants.size() == 0 || (groupParticipants.size() == 1 && DialogObject.getPeerDialogId(groupParticipants.get(0).peer) == j10))) {
                            ...
                            si1Var.f37400c = new org.telegram.ui.Components.g01(LocaleController.formatPluralStringComma("Participants", max), 14.0f, AndroidUtilities.bold());
                ...
                oi1Var.addView(ti1Var3.f37737y, w7.x5.d(204, 204.0f, 1, 0.0f, 93.0f, 0.0f, 0.0f));
                ...
                ti1Var3.f37715j0 = new org.telegram.ui.Components.voip.r1(activity);
                ti1Var3.e = new org.telegram.ui.Components.voip.k3(activity, q1Var);
                ti1Var3.f37706f = new org.telegram.ui.Components.voip.k3(activity, q1Var);
                ti1Var3.h = new org.telegram.ui.Components.voip.k3(activity, q1Var);
                ti1Var3.f37721n = new org.telegram.ui.Components.voip.v2(activity, 52.0f);
                ...
                ti1Var3.f37706f.setTranslationY(AndroidUtilities.dp(100.0f));
                ti1Var3.f37706f.setScaleX(0.0f);
                ti1Var3.f37706f.setScaleY(0.0f);
                ti1Var3.f37706f.animate().setStartDelay(166).translationY(0.0f).scaleY(1.0f).scaleX(1.0f).setDuration(250L).start();
                ...
                ti1Var3.f37721n.setTranslationY(AndroidUtilities.dp(100.0f));
                ti1Var3.f37721n.setScaleX(0.0f);
                ti1Var3.f37721n.setScaleY(0.0f);
                ti1Var3.f37721n.animate().setStartDelay(198).translationY(0.0f).scaleY(1.0f).scaleX(1.0f).setDuration(250L).start();
                ti1Var3.f37715j0.addView(ti1Var3.e);
                ti1Var3.f37715j0.addView(ti1Var3.f37706f);
                ti1Var3.f37715j0.addView(ti1Var3.h);
                ti1Var3.f37715j0.addView(ti1Var3.f37721n);
                org.telegram.ui.Components.voip.e eVar = new org.telegram.ui.Components.voip.e(activity);
                ti1Var3.f37704e0 = eVar;
                eVar.setListener(new ri1(ti1Var3));
                ti1Var3.f37704e0.setScaleX(1.15f);
                ti1Var3.f37704e0.setScaleY(1.15f);
                oi1Var.addView(ti1Var3.f37715j0, w7.x5.e(-1, -2, 80));
                ...
                float f10 = i11;
                oi1Var.addView(ti1Var3.f37704e0, w7.x5.d(-1, 186.0f, 80, f10, 0.0f, f10, 0.0f));
                ...
                ti1Var3.K.setBackground(org.telegram.ui.ActionBar.i6.f0(i0.a.k(-1, 76), 1, -1));
                ...
                if (ti1Var3.f37731u0.f29332b) {
                    ti1Var3.H.setVisibility(8);
                    ti1Var3.I.setVisibility(8);
                }
                ?? linearLayout = new LinearLayout(activity);
                linearLayout.f28980a = new HashMap();
                linearLayout.f28981b = new ArrayList();
                linearLayout.f28982c = new ArrayList();
                TextPaint textPaint = new TextPaint();
                linearLayout.f28985r = textPaint;
                linearLayout.setOrientation(1);
                linearLayout.f28984n = q1Var;
                ...
                d3Var.K = alignment;
                d3Var.d = -1L;
                d3Var.f4633l0 = new di1(ti1Var3, 6);
                d3Var.T = true;
                ...
                if (z10) {
                    ...
                    if (sharedInstance2 != null && sharedInstance2.getVideoState(false) == 2) {
                        ti1Var3.f37700c0.setStub(org.telegram.ui.Components.voip.m2.k().f29096r);
                        ti1Var3.f37702d0.setStub(org.telegram.ui.Components.voip.m2.k().f29095n);
                    }
                    ti1Var3.f37731u0.setAlpha(0.0f);
                    ti1Var3.H();
                    ti1Var3.E0 = true;
                ...
                if (sharedInstance3 != null && sharedInstance3.getRemoteVideoState() == 2 && sf.c.a(activity) == 1) {
                    ti1 ti1Var4 = f37692n1;
                    pf.d dVar = new pf.d(activity, ti1Var4);
                    dVar.f40785c = "voip-fragment-pip";
                    org.telegram.ui.Components.voip.s2 s2Var3 = ti1Var4.f37700c0;
                    dVar.f40789j = s2Var3.d;
                    dVar.f40790k = s2Var3.getPlaceholderView();
                    ti1Var4.f37709g0 = dVar.a();
                }
            }
        }
    }
    ...
    public final void A(boolean z10) {
        ...
        if (!z10 && this.f37736x0) {
            ...
            this.f37715j0.animate().alpha(0.0f).translationY(AndroidUtilities.dp(10.0f)).setDuration(150L).setInterpolator(qrVar).start();
            this.f37711h0.animate().alpha(0.0f).setDuration(150L).setInterpolator(qrVar).start();
            this.f37713i0.animate().alpha(0.0f).setDuration(150L).setInterpolator(qrVar).start();
            ValueAnimator ofFloat = ValueAnimator.ofFloat(this.f37738y0, 0.0f);
            this.P0 = ofFloat;
            ofFloat.addUpdateListener(z11Var);
            this.P0.setDuration(150L).setInterpolator(qrVar);
            this.P0.start();
            AndroidUtilities.cancelRunOnUIThread(this.S0);
            this.R0 = false;
            this.f37715j0.setEnabled(false);
            this.O0.e(true);
            i10 = 150;
        } else {
            if (z10 && !this.f37736x0) {
                ...
                this.f37715j0.animate().alpha(1.0f).translationY(0.0f).setDuration(150L).setInterpolator(qrVar2).start();
                this.f37711h0.animate().alpha(1.0f).setDuration(150L).setInterpolator(qrVar2).start();
                this.f37713i0.animate().alpha(1.0f).setDuration(150L).setInterpolator(qrVar2).start();
                ValueAnimator ofFloat2 = ValueAnimator.ofFloat(this.f37738y0, 1.0f);
                this.P0 = ofFloat2;
                ofFloat2.addUpdateListener(z11Var);
                this.P0.setDuration(150L).setInterpolator(qrVar2);
                this.P0.start();
                this.f37715j0.setEnabled(true);
            }
            i10 = 0;
        }
        this.f37736x0 = z10;
        li1 li1Var = this.f37731u0;
        if (!z10) {
        ...
        animate.translationY(i12 - i11).setDuration(150L).setStartDelay(i10).setInterpolator(org.telegram.ui.Components.qr.f27423f).start();
    }
    ...
    public final void B() {
        if (VoIPService.getSharedInstance() != null) {
            ...
            this.R0 = false;
            if (this.f37739z0 && this.f37736x0) {
    ...
    public final void C() {
        ...
        VoIPService sharedInstance = VoIPService.getSharedInstance();
        if (sharedInstance != null) {
            if (this.f37734w0.isTouchExplorationEnabled()) {
                if (!this.f37722n0) {
                ...
                this.f37728s.announceForAccessibility(string);
            }
            if (!this.f37722n0) {
                if (this.f37723o0 == null) {
                    sharedInstance.createCaptureDevice(false);
                    if (!sharedInstance.isFrontFaceCamera()) {
                        sharedInstance.switchCamera();
                    }
                    this.f37731u0.setLockOnScreen(true);
                    int[] iArr = new int[2];
                    this.f37706f.getLocationOnScreen(iArr);
                    mi1 mi1Var = new mi1(this, this.f37728s.getContext(), iArr[0], iArr[1]);
                    this.f37723o0 = mi1Var;
                    WindowInsets windowInsets = this.f37727r0;
                    if (windowInsets != null) {
                        mi1Var.setBottomPadding(windowInsets.getSystemWindowInsetBottom());
                    }
                    this.f37728s.addView(this.f37723o0);
                    return;
                }
                return;
            }
    ...
    public final void D(boolean z10) {
        ...
        if (sharedInstance != null) {
            if (z10) {
                ...
                TransitionManager.beginDelayedTransition(this.f37715j0, transitionSet);
            }
            int i10 = this.f37724p0;
            if (i10 == 11) {
                this.e.setVisibility(8);
                this.f37706f.setVisibility(8);
                this.h.setVisibility(8);
                this.f37721n.setVisibility(8);
                return;
            }
            int i11 = 0;
            if (i10 != 15 && i10 != 17) {
                ...
                if (!sharedInstance.isScreencast() && (this.f37722n0 || this.m0)) {
                ...
                v(this.f37706f, sharedInstance, false);
                t(this.h, sharedInstance, z10);
                this.f37721n.c(R.drawable.calls_decline, -1, -1041108, 1.0f, true, LocaleController.getString(R.string.VoipEndCall2), false, z10);
                this.f37721n.setOnClickListener(new ei1(this, 0));
            } else {
                TL_phone.PhoneCall phoneCall = sharedInstance.privateCall;
            ...
            if (this.f37706f.getVisibility() == 0) {
                this.f37706f.f29041f = i11;
                i11 += 16;
            }
            ...
            if (this.f37721n.getVisibility() == 0) {
                this.f37721n.F = i11;
            }
            F();
        }
    ...
    public final void G() {
        this.f37717k0.setColor(i0.a.k(-16777216, (int) (this.f37738y0 * 102.0f * this.F0)));
        this.f37719l0.setColor(i0.a.k(-16777216, (int) (127.5f * this.F0)));
        oi1 oi1Var = this.f37728s;
        if (oi1Var != null) {
            oi1Var.invalidate();
        }
    }
    ...
    public final void a(com.google.android.gms.internal.cast.p pVar) {
        this.l1 = pVar;
        org.telegram.ui.Components.voip.s2 s2Var = this.f37700c0;
        if (s2Var != null) {
            s2Var.d.clearFirstFrame();
        }
        this.f37720m1 = true;
        H();
        ((WindowManager) this.f37696b.getSystemService("window")).removeView(this.f37731u0);
        this.f37731u0.invalidate();
    }
    ...
    public final void b(com.google.android.gms.internal.cast.p pVar) {
        ...
        li1 li1Var = this.f37731u0;
        li1Var.getClass();
        ((WindowManager) this.f37696b.getSystemService("window")).addView(li1Var, org.telegram.ui.Components.voip.w2.a());
        this.f37720m1 = false;
        H();
        this.f37731u0.invalidate();
        org.telegram.ui.Components.voip.s2 s2Var = this.f37718k1;
        if (s2Var != null) {
            s2Var.d.release();
            this.f37718k1 = null;
        }
    ...
    public final Bitmap c() {
        ...
        if (s2Var != null && s2Var.d.isAvailable()) {
            return this.f37718k1.d.getBitmap();
        }
        return null;
    }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.voipServiceCreated) {
            if (this.f37724p0 == 17 && VoIPService.getSharedInstance() != null) {
                this.f37702d0.d.release();
                this.f37700c0.d.release();
                this.f37697b0.release();
                o();
                VoIPService.getSharedInstance().registerStateListener(this);
            }
            ...
            this.f37737y.setAmplitude(((Float) objArr[0]).floatValue() * 15.0f);
        } else if (i10 == NotificationCenter.nearEarEvent) {
            boolean booleanValue = ((Boolean) objArr[0]).booleanValue();
            this.f37707f0 = booleanValue;
            if (booleanValue) {
                this.f37737y.b(true, true);
            }
        }
    }
    ...
    public final Bitmap e() {
        org.telegram.ui.Components.voip.s2 s2Var = this.f37700c0;
        if (s2Var != null && s2Var.d.isAvailable()) {
            return this.f37700c0.d.getBitmap();
        }
        return null;
    }
    ...
    @Override
    public final View h() {
        org.telegram.ui.Components.voip.s2 s2Var = new org.telegram.ui.Components.voip.s2(this.f37696b, false, true, false, false);
        this.f37718k1 = s2Var;
        s2Var.d.setScalingType(RendererCommon.ScalingType.SCALE_ASPECT_FIT);
        this.f37718k1.d.setEnableHardwareScaler(true);
        this.f37718k1.d.setRotateTextureWithScreen(true);
        org.telegram.ui.Components.voip.s2 s2Var2 = this.f37718k1;
        s2Var2.f29204a0 = 1;
        s2Var2.d.init(VideoCapturerDevice.getEglBase().getEglBaseContext(), new ni1(this));
        View view = this.f37718k1.h;
        if (view != null) {
            view.setVisibility(8);
        }
        return this.f37718k1;
    }
    ...
    public final ValueAnimator k(boolean z10) {
        ...
        float f17 = org.telegram.ui.Components.voip.m2.k().d.x + org.telegram.ui.Components.voip.m2.k().f29100y;
        ...
        org.telegram.ui.Components.voip.m2.U.getClass();
        final float measuredWidth = f17 - ((this.f37700c0.getMeasuredWidth() - (this.f37700c0.getMeasuredWidth() * 0.25f)) / 2.0f);
        final float measuredHeight2 = f18 - ((this.f37700c0.getMeasuredHeight() - (this.f37700c0.getMeasuredHeight() * 0.25f)) / 2.0f);
        final float f19 = 1.0f;
        if (this.m0) {
            int measuredWidth2 = this.Y.getMeasuredWidth();
            if (this.f37722n0 && measuredWidth2 != 0) {
                f16 = (this.f37731u0.getMeasuredWidth() / measuredWidth2) * 0.25f * 0.4f;
                c10 = 0;
                f15 = (((org.telegram.ui.Components.voip.m2.k().f29094f * 0.25f) + (f17 - ((this.Y.getMeasuredWidth() - (this.Y.getMeasuredWidth() * f16)) / 2.0f))) - ((org.telegram.ui.Components.voip.m2.k().f29094f * 0.25f) * 0.4f)) - AndroidUtilities.dp(4.0f);
        ...
        if (z10) {
            ...
            this.f37700c0.setScaleX(0.25f);
            this.f37700c0.setScaleY(0.25f);
            this.f37700c0.setTranslationX(measuredWidth);
            this.f37700c0.setTranslationY(measuredHeight2);
            this.f37700c0.setRoundCorners((AndroidUtilities.dp(6.0f) * 1.0f) / 0.25f);
        }
        if (z10) {
            f12 = 1.0f;
        } else {
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                ...
                ti1Var.f37700c0.setScaleX(f25);
                ti1Var.f37700c0.setScaleY(f25);
                float f26 = 0.0f * f23;
                float f27 = (measuredWidth * floatValue) + f26;
                float f28 = (measuredHeight2 * floatValue) + f26;
                ti1Var.f37700c0.setTranslationX(f27);
                ti1Var.f37700c0.setTranslationY(f28);
                ti1Var.f37700c0.setRoundCorners(((AndroidUtilities.dp(4.0f) * floatValue) * 1.0f) / f25);
                if (!ti1Var.Y.P) {
                    ti1Var.f37702d0.d(floatValue, false);
                }
                ti1Var.f37731u0.invalidate();
            }
        });
        return ofFloat;
    }
    ...
    public final void l() {
        ...
        NotificationCenter.getInstance(this.f37693a).removeObserver(this, NotificationCenter.voipServiceCreated);
    ...
    public final void m(boolean z10) {
        ...
        if (this.B0 && this.C0 != z10 && this.f37736x0) {
            this.C0 = z10;
            org.telegram.ui.Components.voip.z2 z2Var = this.f37733w;
            if (z2Var.K && z10 != z2Var.E) {
                ...
                z2Var.f29382c = ofFloat;
                ofFloat.addUpdateListener(new org.telegram.ui.Components.voip.y2(z2Var, 1));
                z2Var.f29382c.setInterpolator(org.telegram.ui.Components.qr.f27423f);
                z2Var.f29382c.setDuration(200L);
                z2Var.f29382c.start();
            }
            if (z10) {
                ...
                AndroidUtilities.cancelRunOnUIThread(this.S0);
                this.R0 = false;
                if (this.f37737y.getVisibility() == 0) {
                    this.f37737y.animate().setStartDelay(0L).translationY(AndroidUtilities.dp(48.0f)).scaleY(0.1f).scaleX(0.1f).alpha(0.0f).setDuration(200L).setInterpolator(org.telegram.ui.Components.qr.f27423f).start();
                }
                ...
                this.O.animate().alpha(1.0f).scaleY(1.0f).scaleX(1.0f).setDuration(340L).setInterpolator(org.telegram.ui.Components.qr.f27424g).start();
                ...
                if (this.f37737y.getVisibility() == 0) {
                    this.f37737y.animate().setStartDelay(50L).translationY(0.0f).scaleX(1.0f).scaleY(1.0f).alpha(1.0f).setDuration(250L).setInterpolator(org.telegram.ui.Components.qr.f27423f).start();
                }
                this.O.animate().setListener(null).cancel();
    ...
    public final void o() {
        this.f37702d0.d.init(VideoCapturerDevice.getEglBase().getEglBaseContext(), new ii1(this));
        this.f37700c0.d.init(VideoCapturerDevice.getEglBase().getEglBaseContext(), new ji1(this), EglBase.CONFIG_PLAIN, new GlRectDrawer());
        this.f37697b0.init(VideoCapturerDevice.getEglBase().getEglBaseContext(), null);
    }
    ...
    public final void onMediaStateUpdated(int i10, int i11) {
        ...
        if (sharedInstance != null && sharedInstance.getRemoteVideoState() == 2) {
            if (this.f37709g0 == null && sf.c.a(this.f37696b) == 1) {
                pf.d dVar = new pf.d(this.f37696b, f37692n1);
                dVar.f40785c = "voip-fragment-pip";
                org.telegram.ui.Components.voip.s2 s2Var = this.f37700c0;
                dVar.f40789j = s2Var.d;
                dVar.f40790k = s2Var.getPlaceholderView();
                this.f37709g0 = dVar.a();
            }
        } else {
            pf.e eVar = this.f37709g0;
            if (eVar != null) {
    ...
    public final void onStateChanged(int i10) {
        int i11 = this.f37724p0;
        if (i11 != i10) {
            this.f37725q0 = i11;
            this.f37724p0 = i10;
            if (this.f37731u0 != null) {
                H();
            }
        }
    }
    ...
    public final void p() {
        if (!this.G0 && !this.E0) {
            mi1 mi1Var = this.f37723o0;
            if (mi1Var != null) {
                mi1Var.a(false, false);
            } else if (this.m0 && this.f37722n0 && this.H0) {
                this.H0 = false;
                ...
                if (this.D0 && VoIPService.getSharedInstance() != null && !VoIPService.getSharedInstance().isConverting()) {
                    if (sf.c.a(this.f37696b) > 0) {
                        if (!this.G0 && f37692n1 != null) {
                            this.G0 = true;
                            if (VoIPService.getSharedInstance() != null) {
                                int measuredHeight = f37692n1.f37731u0.getMeasuredHeight();
                                ti1 ti1Var = f37692n1;
                                org.telegram.ui.Components.voip.m2.l(ti1Var.f37696b, ti1Var.f37693a, ti1Var.f37731u0.getMeasuredWidth(), measuredHeight, 1);
                                WindowInsets windowInsets = f37692n1.f37727r0;
                                if (windowInsets != null) {
                                    org.telegram.ui.Components.voip.m2.W = windowInsets.getSystemWindowInsetTop();
                                    f37692n1.f37727r0.getSystemWindowInsetBottom();
                                }
                            }
                            if (org.telegram.ui.Components.voip.m2.k() != null) {
                                ...
                                this.f37715j0.animate().alpha(0.0f).setDuration(350L).setInterpolator(qrVar).start();
                                this.f37711h0.animate().alpha(0.0f).setDuration(350L).setInterpolator(qrVar).start();
                                this.f37713i0.animate().alpha(0.0f).setDuration(350L).setInterpolator(qrVar).start();
                    ...
                    org.telegram.ui.Components.c5.B(this.f37696b, new bi1(this, 0), true).o();
                    return;
                }
                this.f37731u0.b();
            }
    ...
    public final void r(Runnable runnable) {
        if (this.f37706f.getVisibility() == 0) {
            this.f37704e0.getLocationOnScreen(new int[2]);
            org.telegram.ui.Components.voip.e eVar = this.f37704e0;
            ValueAnimator valueAnimator = eVar.f28923b0;
            if (valueAnimator != null) {
                valueAnimator.cancel();
                eVar.f28923b0 = null;
                eVar.U.stop();
        ...
        this.f37721n.animate().cancel();
        this.e.animate().cancel();
        this.h.animate().cancel();
        this.f37706f.animate().cancel();
        this.f37704e0.getLocationOnScreen(new int[2]);
        org.telegram.ui.Components.voip.e eVar2 = this.f37704e0;
        ValueAnimator valueAnimator2 = eVar2.f28923b0;
        if (valueAnimator2 != null) {
            valueAnimator2.cancel();
            eVar2.f28923b0 = null;
            eVar2.U.stop();
        }
        this.f37721n.c(R.drawable.calls_decline, -1, -1041108, 1.0f, true, LocaleController.getString(R.string.VoipEndCall2), false, false);
        this.e.d(5, false, false);
        this.h.d(1, false, false);
        this.f37706f.d(3, true, false);
        this.f37721n.setVisibility(0);
        this.e.setVisibility(0);
        this.h.setVisibility(0);
        this.f37706f.setVisibility(0);
        this.f37721n.setAlpha(0.0f);
        this.e.setAlpha(0.0f);
        this.h.setAlpha(0.0f);
        this.f37706f.setAlpha(0.0f);
        final ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) this.f37704e0.getLayoutParams();
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator3) {
                ...
                ti1Var.f37704e0.setTranslationY(dp2 * floatValue);
                int i10 = marginEnd;
                int i11 = (int) (i10 - ((i10 + dp) * floatValue));
                ViewGroup.MarginLayoutParams marginLayoutParams2 = marginLayoutParams;
                marginLayoutParams2.leftMargin = i11;
                marginLayoutParams2.rightMargin = i11;
                ti1Var.f37704e0.requestLayout();
            }
        });
        org.telegram.ui.Components.voip.e eVar3 = this.f37704e0;
        ObjectAnimator ofFloat2 = ObjectAnimator.ofFloat(eVar3, View.SCALE_X, eVar3.getScaleX(), 1.0f, 1.0f, 1.0f);
        org.telegram.ui.Components.voip.e eVar4 = this.f37704e0;
        ObjectAnimator ofFloat3 = ObjectAnimator.ofFloat(eVar4, View.SCALE_Y, eVar4.getScaleY(), 1.0f, 1.0f, 1.0f);
        org.telegram.ui.Components.voip.e eVar5 = this.f37704e0;
        animatorSet.playTogether(ofFloat, ofFloat2, ofFloat3, ObjectAnimator.ofFloat(eVar5, View.ALPHA, eVar5.getAlpha(), this.f37704e0.getAlpha(), 0.0f, 0.0f));
    ...
    public final void t(org.telegram.ui.Components.voip.k3 k3Var, VoIPService voIPService, boolean z10) {
        ...
        float f7 = 0.0f;
        if (!z10) {
            ValueAnimator valueAnimator = u1Var.f29287f0;
            if (valueAnimator != null) {
                valueAnimator.cancel();
            }
            if (isMicMute) {
            ...
            ValueAnimator valueAnimator2 = u1Var.f29287f0;
            if (valueAnimator2 != null) {
                valueAnimator2.cancel();
            }
            float f10 = u1Var.K;
            ...
            u1Var.f29287f0 = ofFloat;
            ofFloat.addUpdateListener(u1Var.f29288g0);
            u1Var.f29287f0.setDuration(150L);
            u1Var.f29287f0.start();
        }
    ...
    public final void x(boolean z10, boolean z11) {
        ...
        Integer num = null;
        if (z10) {
            if (z12 && this.f37737y.getTag() == null) {
                this.f37737y.animate().setListener(null).cancel();
                this.f37737y.setVisibility(0);
                if (!this.C0) {
                    if (z11) {
                        this.f37737y.setAlpha(0.0f);
                        this.f37737y.animate().alpha(1.0f).translationY(0.0f).scaleY(1.0f).scaleX(1.0f).setDuration(150L).setInterpolator(org.telegram.ui.Components.qr.f27423f).start();
                    } else {
                        this.f37737y.setAlpha(0.0f);
                        this.f37737y.setTranslationY(-AndroidUtilities.dp(135.0f));
                        this.f37737y.animate().alpha(1.0f).translationY(0.0f).scaleY(1.0f).scaleX(1.0f).setDuration(150L).setInterpolator(org.telegram.ui.Components.qr.f27423f).start();
                    }
                } else if (z11) {
                    this.f37737y.setAlpha(0.0f);
                    this.f37737y.setTranslationY(AndroidUtilities.dp(48.0f));
                    this.f37737y.setScaleX(0.1f);
                    this.f37737y.setScaleY(0.1f);
                }
            } else if (!z12 && this.f37737y.getTag() != null) {
                this.f37737y.animate().setListener(null).cancel();
                this.f37737y.setTranslationY(0.0f);
                this.f37737y.animate().alpha(0.0f).setDuration(150L).scaleX(0.1f).scaleY(0.1f).setInterpolator(org.telegram.ui.Components.qr.f27423f).setListener(new hi1(this, 7)).start();
            }
        } else {
            this.f37737y.animate().setListener(null).cancel();
            this.f37737y.setTranslationY(0.0f);
            this.f37737y.setAlpha(1.0f);
            this.f37737y.setScaleX(1.0f);
            this.f37737y.setScaleY(1.0f);
            org.telegram.ui.Components.voip.t0 t0Var = this.f37737y;
            if (!z12) {
                i10 = 8;
            }
            t0Var.setVisibility(i10);
        }
        org.telegram.ui.Components.voip.t0 t0Var2 = this.f37737y;
        if (z12) {
            num = 1;
        }
        t0Var2.setTag(num);
    ...
    public final void y(CharSequence charSequence) {
        TextView textView;
        if (this.f37696b.isFinishing()) {
            return;
        }
        org.telegram.ui.ActionBar.b2 b2Var = new org.telegram.ui.ActionBar.b2(this.f37696b, 0, null);
        boolean[] zArr = new boolean[3];
        b2Var.R = LocaleController.getString(R.string.VoipFailed);
        b2Var.T = charSequence;
        b2Var.f18478l0 = LocaleController.getString(R.string.OK);
        b2Var.m0 = null;
        b2Var.show();
        for (int i10 = 0; i10 < 3; i10++) {
            if (zArr[i10] && (textView = (TextView) b2Var.d(-(i10 + 1))) != null) {
                textView.setTextColor(b2Var.e(org.telegram.ui.ActionBar.i6.f19074q7));
            }
        }
    ...
    public final void z(int i10, boolean z10) {
        ...
        if (this.Y.getTag() == null || ((Integer) this.Y.getTag()).intValue() != 2) {
            this.Y.setUiVisible(this.f37736x0);
        }
        ...
        if (i10 == 0) {
            if (z10) {
                if (this.Y.getTag() != null && ((Integer) this.Y.getTag()).intValue() != 0) {
                    ...
                    this.A0.setDuration(250L).setInterpolator(org.telegram.ui.Components.qr.f27423f);
