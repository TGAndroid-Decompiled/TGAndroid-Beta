...
public final class tk0 extends org.telegram.ui.Components.kl0 {
    public final Context f40814c;
    public ArrayList d = new ArrayList();
    public ArrayList f40815e = new ArrayList();
    public sk0 f40816f;
    public final hg.b2 h;
    public final NotificationsCustomSettingsActivity f40817n;

    public tk0(NotificationsCustomSettingsActivity notificationsCustomSettingsActivity, Context context) {
        this.f40817n = notificationsCustomSettingsActivity;
    ...
    public final void F(String str) {
        ...
        if (this.f40816f != null) {
            Utilities.searchQueue.cancelRunnable(this.f40816f);
            this.f40816f = null;
        }
        if (str == null) {
            this.d.clear();
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i10 < this.d.size()) {
            ...
            CharSequence charSequence = (CharSequence) this.f40815e.get(i10);
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        View zaVar;
        if (i10 != 0) {
            zaVar = new org.telegram.ui.Cells.u3(this.f40814c, null);
            zaVar.setBackgroundColor(0);
            zaVar.setTag(-33024);
        } else {
            zaVar = new org.telegram.ui.Cells.za(4, 0, this.f40814c, null, false, true);
        }
