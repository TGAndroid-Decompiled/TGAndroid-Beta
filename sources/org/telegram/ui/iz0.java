...
public final class iz0 extends ProfileStoriesView {
    public final Context f34606t0;
    public final ProfileActivity f34607u0;
    ...
    public iz0(ProfileActivity profileActivity, Context context, int i10, long j3, boolean z10, k0 k0Var, fz0 fz0Var, org.telegram.ui.ActionBar.d6 d6Var, Context context2) {
        ...
        this.f34607u0 = profileActivity;
        this.f34606t0 = context2;
    }
    ...
    public final void e(a6.i iVar) {
        ...
        ProfileActivity profileActivity = this.f34607u0;
        long a2 = profileActivity.a();
        ai.l9 storiesController = profileActivity.getMessagesController().getStoriesController();
        boolean I = storiesController.I(a2);
        Context context = this.f34606t0;
        if (!I && !storiesController.K(a2) && !storiesController.N(a2)) {
            TLRPC.UserFull userFull = profileActivity.f31673v2;
            if (userFull != null && (peerStories2 = userFull.stories) != null && !peerStories2.stories.isEmpty() && profileActivity.f31555e1 != profileActivity.getUserConfig().clientUserId) {
                profileActivity.getOrCreateStoryViewer().E(context, profileActivity.f31673v2.stories, iVar);
                return;
            }
            ...
            if (chatFull != null && (peerStories = chatFull.stories) != null && !peerStories.stories.isEmpty()) {
                profileActivity.getOrCreateStoryViewer().E(context, profileActivity.f31666u2.stories, iVar);
                return;
            } else {
                profileActivity.K3();
                return;
