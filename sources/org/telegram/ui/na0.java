...
public final class na0 implements org.telegram.ui.Components.rd0, org.telegram.ui.ActionBar.a2 {
    public final LaunchActivity f38893a;

    public na0(LaunchActivity launchActivity) {
        this.f38893a = launchActivity;
    }

    @Override
    public void g(org.telegram.ui.ActionBar.b2 b2Var, int i10) {
        Pattern pattern = LaunchActivity.B1;
        MessagesController.getInstance(this.f38893a.O).performLogout(2);
    }
    ...
    public void j(org.telegram.ui.Components.sd0 sd0Var) {
        ...
        LaunchActivity launchActivity = this.f38893a;
        ...
        launchActivity.f33453q0.getView().setVisibility(0);
        ...
        if (AndroidUtilities.isTablet()) {
            launchActivity.f33455r0.U(true, true);
            launchActivity.f33457s0.U(true, true);
            if (launchActivity.f33455r0.getView().getVisibility() == 4) {
                launchActivity.f33455r0.getView().setVisibility(0);
            }
            launchActivity.f33457s0.getView().setVisibility(0);
        }
