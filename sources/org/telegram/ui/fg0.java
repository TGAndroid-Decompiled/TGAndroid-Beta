...
public final class fg0 extends org.telegram.ui.Components.uv0 {
    public final ImageView f33592a;
    public final ci.d f33593b;
    public final yh.r[] f33594c;
    public Bundle d;
    public String e;
    ...
    public fg0(wg0 wg0Var, Context context) {
        ...
        canvas.drawColor(i0.a.d(0.5f, org.telegram.ui.ActionBar.i6.w0(null, i11, false), org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18904h5, false)));
        eg0Var.setBackgroundBitmap(createBitmap);
        sg.a aVar = eg0Var.f42933b;
        aVar.f42921w = i11;
        aVar.f42922x = org.telegram.ui.ActionBar.i6.Lj;
        aVar.b();
    ...
    public final void g() {
        ...
        if (this.f33598s >= 0) {
            ...
            ConnectionsManager.getInstance(i10).cancelRequest(this.f33598s, true);
            this.f33598s = -1;
        }
        this.f33595f = false;
        this.f33593b.setLoading(false);
    }
    ...
    public final void m(Bundle bundle, boolean z10) {
        ...
        yh.r[] rVarArr = this.f33594c;
        if (isEmpty) {
            rVarArr[0].f47643c.setText(LocaleController.getString(R.string.SMSFee1Text));
        } else {
            rVarArr[0].f47643c.setText(LocaleController.formatString(R.string.SMSFee1TextCountry, countryName));
        }
        yh.r rVar = rVarArr[2];
        if (i10 == 7) {
        ...
        this.f33592a.setOnClickListener(new ai.p5(this, string5, string6, string3, 14));
        ci.d dVar = this.f33593b;
    ...
    public final void p() {
        ...
        tL_checkPaidAuth.form_id = this.f33597r;
        tL_checkPaidAuth.phone_number = this.h;
        tL_checkPaidAuth.phone_code_hash = this.f33596n;
        i10 = ((org.telegram.ui.ActionBar.n2) this.v).currentAccount;
        this.f33598s = ConnectionsManager.getInstance(i10).sendRequest(tL_checkPaidAuth, new m(this, 14), 1096);
    }
}
