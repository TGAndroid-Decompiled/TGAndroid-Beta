...
public final class iw0 extends org.telegram.ui.Components.q81 {
    ...
    public final void b(View view, int i10, int i11) {
        ...
        switch (i12) {
            ...
            case 3:
                ai1 ai1Var = (ai1) obj;
                SparseArray sparseArray = ai1Var.f32121a;
                yh1 yh1Var = (yh1) sparseArray.get(i10);
                if (yh1Var != null) {
                    n2Var = yh1Var.f39963a;
                } else {
                ...
                if (n2Var.getFragmentView() == null) {
                    n2Var.performCreateView((Context) this.f34716b);
                    n2Var.setTitleOverlayText(ai1Var.f32125n, ai1Var.f32126r, ai1Var.f32127s);
                }
                ...
                if (!n2Var.hasOwnBackground() && fragmentView.getBackground() == null) {
                    fragmentView.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19109d6, false));
                }
    ...
    public final View d(int i10) {
        ...
        switch (this.f34715a) {
            case 0:
                FrameLayout frameLayout = new FrameLayout((Context) this.f34716b);
                frameLayout.setOnClickListener(new k60(this, 23));
                return frameLayout;
            case 1:
                return new b41((c41) this.f34717c, (Context) this.f34716b);
            case 2:
                FrameLayout frameLayout2 = new FrameLayout((Context) this.f34716b);
                frameLayout2.setOnClickListener(new h41(this, 7));
                return frameLayout2;
            case 3:
                return new u41((Context) this.f34716b, 8);
            case 4:
                if (i10 == 0) {
                    return ((tg.a0) this.f34716b).getContainerView();
                }
                return ((tg.z0) this.f34717c).getContainerView();
            default:
                yh.y3 y3Var = (yh.y3) this.f34717c;
                if (i10 == 0) {
                    yh.y3.j1(y3Var, false);
                    xh.n2 n2Var = y3Var.f48322b0;
                    if (n2Var != null) {
                        t5Var = n2Var.Y;
                        AndroidUtilities.removeFromParent(t5Var);
                        FrameLayout frameLayout3 = new FrameLayout((Context) this.f34716b);
                ...
                AndroidUtilities.removeFromParent(t5Var);
                FrameLayout frameLayout32 = new FrameLayout((Context) this.f34716b);
    ...
    public int h(int i10) {
        switch (this.f34715a) {
            ...
            case 4:
                return i10;
            case 5:
                return (i10 - (((yh.y3) this.f34717c).L1(false) ? 1 : 0)) + 1;
        }
    }
