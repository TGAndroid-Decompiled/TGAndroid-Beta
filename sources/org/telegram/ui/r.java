...
public final class r implements Utilities.Callback {
    ...
    public final void run(Object obj) {
        switch (this.f37028a) {
            case 0:
                h4 h4Var = this.f37029b;
                ai.x5 x5Var = h4Var.f34126q0;
            ...
            case 1:
                ...
                if (!TextUtils.isEmpty(str)) {
                    h4 h4Var2 = this.f37029b;
                    h4Var2.f34118h0.f39098b0.setText(str);
                    fi.o oVar = h4Var2.f34118h0.f39098b0;
                    oVar.setSelection(oVar.getText().length());
                    AndroidUtilities.showKeyboard(h4Var2.f34118h0.f39098b0);
                    return;
                }
                return;
            case 2:
                String str2 = (String) obj;
                h4 h4Var3 = this.f37029b;
                if (h4Var3.L != null && str2 != null) {
                    h4Var3.f34118h0.k(false);
                    if (nf.f.f(Uri.parse(str2), false, null)) {
                        ...
                        l3 l3Var = h4Var3.f34130u0[0];
                        if (l3Var != null && l3Var.getWebView() != null) {
                            h4Var3.f34130u0[0].getWebView().loadUrl(str2);
                            return;
                        } else {
                            nf.f.n(str2);
                            return;
            ...
            default:
                ...
                h4 h4Var4 = this.f37029b;
                if (h4Var4.L != null && e1Var != null) {
                    h4Var4.f34118h0.k(false);
                    l3 l3Var2 = h4Var4.f34130u0[0];
                    if (l3Var2 != null && l3Var2.getWebView() != null) {
                        h4Var4.f34130u0[0].getWebView().e(e1Var.f38914c, e1Var.d);
                        return;
                    } else {
                        nf.f.n(e1Var.f38914c);
                        return;
                    }
                }
                return;
