...
public final class ea0 implements oy {
    public final int f33239a = 1;
    public final LaunchActivity f33240b;
    ...
    public final boolean u(uy uyVar, ArrayList arrayList, CharSequence charSequence, boolean z10, boolean z11, int i10, int i11, dg1 dg1Var) {
        int i12 = this.f33239a;
        TLRPC.User user = this.e;
        int i13 = this.d;
        String str = this.f33241c;
        LaunchActivity launchActivity = this.f33240b;
        switch (i12) {
            case 0:
            ...
            default:
                ...
                tL_inputMediaGame.f18358id = tL_inputGameShortName;
