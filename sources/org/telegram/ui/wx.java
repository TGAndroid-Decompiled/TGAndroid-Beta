...
public final class wx extends lu0 {
    ...
    public final void D() {
        int i10;
        qy qyVar = this.f39775b;
        org.telegram.ui.Components.ar0 ar0Var = qyVar.G2;
        if (ar0Var != null) {
            i10 = ((org.telegram.ui.ActionBar.m2) qyVar).currentAccount;
            ar0Var.i(i10, qyVar.D2);
        }
    }
    ...
    public final vu0 E(MessageObject messageObject, TLRPC.FileLocation fileLocation, int i10, boolean z10, boolean z11) {
        ...
        vu0Var.f38825k = w9Var.getScaleX();
    ...
    public final ImageReceiver.BitmapHolder j(int i10) {
        org.telegram.ui.Components.w9 w9Var;
        org.telegram.ui.Components.ar0 ar0Var = this.f39775b.G2;
        if (ar0Var != null) {
            w9Var = ar0Var.f(i10);
        } else {
            w9Var = null;
