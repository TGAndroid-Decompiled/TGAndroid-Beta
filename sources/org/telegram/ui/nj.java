    ...
    public final void b(int i10) {
        ...
        if (i10 == -1) {
            if (!coVar.wc.f15396f) {
                ...
                if (kVar.s()) {
                    coVar.z7(false);
                } else if (coVar.R3 == 5 && (coVar.f35468u6.isEmpty() || coVar.f35256d4 == 0)) {
                    coVar.Qb();
                } else if (coVar.R3 == 6 && coVar.Y.w()) {
                    coVar.wb(new Runnable(this) {
                        public final nj f38105b;
                        ...
                        public final void run() {
                            switch (r2) {
                                case 0:
                                    this.f38105b.f38995b.finishFragment();
                                    return;
                                default:
                                    nj njVar = this.f38105b;
                                    njVar.getClass();
                                    co coVar2 = njVar.f38995b;
            ...
            if (i10 == 10) {
                ...
                for (int i18 = 1; i18 >= 0; i18--) {
                    ...
                    for (int i20 = 0; i20 < arrayList.size(); i20++) {
                        ...
                        if (arrayList.size() != 1 && ((user3 = coVar.f35277f) == null || !user3.self)) {
                            z15 = true;
                        } else {
                            z15 = false;
                        }
                ...
                if (ChatObject.isMonoForum(coVar.f35265e)) {
                    ...
                    if (ChatObject.canManageMonoForum(i17, coVar.f35265e)) {
                        j11 = coVar.f35256d4;
                        j3 = coVar.T5;
                    }
                }
                ...
                if (ChatObject.isMonoForum(coVar.f35265e)) {
                    ...
                    if (ChatObject.canManageMonoForum(i15, coVar.f35265e)) {
                        j12 = coVar.f35256d4;
                        j3 = coVar.T5;
                    }
                }
                ...
                if (coVar.getParentActivity() != null) {
                    coVar.showDialog(org.telegram.ui.Components.e5.V(coVar.getParentActivity(), coVar.h, coVar.f35275ea).f20226a);
                }
            } else if (i10 != 15 && i10 != 16 && i10 != 26) {
                if (i10 == 17) {
                    if (coVar.f35277f != null && coVar.getParentActivity() != null) {
                    ...
                    try {
                        coVar.getMediaDataController().installShortcut(coVar.f35277f.f20043id, MediaDataController.SHORTCUT_TYPE_USER_OR_CHAT);
                    } catch (Exception e7) {
                        FileLog.e(e7);
                    }
                } else if (i10 == 29) {
                    if (ChatObject.hasAdminRights(coVar.f35265e)) {
                    ...
                    for (int i26 = 1; i26 >= 0; i26--) {
                        if (messageObject == null && sparseArrayArr3[i26].size() == 1) {
                            ...
                            messageObject = (MessageObject) coVar.f35392o6[i26].get(((Integer) arrayList3.get(0)).intValue());
                        }
                    ...
                    org.telegram.ui.ActionBar.f1 f1Var = new org.telegram.ui.ActionBar.f1(0, this.f38994a, coVar.getResourceProvider(), true, true);
                    ...
                    if (i10 == 50) {
                        ...
                        if (coVar.f35244c4 != null) {
                            ...
                            long j15 = coVar.f35265e.f19896id;
                        ...
                        if (textView2 != null) {
                            textView2.setTextColor(coVar.getThemedColor(org.telegram.ui.ActionBar.j6.f20926q7));
                        }
                    } else if (i10 == 73) {
                ...
                } else if (coVar.f35277f != null && coVar.getParentActivity() != null) {
                    TLRPC.User user4 = coVar.f35277f;
                    if (i10 == 33) {
                        z12 = true;
                    } else {
                        z12 = false;
                    ...
                    org.telegram.ui.Components.voip.d2.m(user4, z12, z13, coVar.getParentActivity(), coVar.getMessagesController().getUserFull(coVar.f35277f.f20043id), coVar.getAccountInstance());
                }
            } else if (coVar.getParentActivity() != null) {
                if (i10 == 15 && ChatObject.isMonoForum(coVar.f35265e)) {
                    if (coVar.f35256d4 != 0 && (user2 = coVar.getMessagesController().getUser(Long.valueOf(coVar.f35256d4))) != null) {
                        org.telegram.ui.Components.e5.r(coVar, -1, user2, coVar.f35265e, true, new m4(10, this, user2), coVar.getResourceProvider());
                        return;
                    }
                    return;
                }
                ...
                if (i10 == 26 || (i10 == 15 && coVar.h == null && (((user = coVar.f35277f) != null && !UserObject.isUserSelf(user) && !UserObject.isDeleted(coVar.f35277f)) || ((chatFull = coVar.Z7) != null && chatFull.can_delete_channel)))) {
                    boolean z17 = z10;
                    org.telegram.ui.Components.e5.r(coVar, -1, coVar.f35277f, coVar.f35265e, z17, new mj(this, z17), coVar.getResourceProvider());
                    return;
                }
                if (i10 == 15) {
                    z11 = true;
                ...
                TLRPC.User user5 = coVar.f35277f;
                if (coVar.h == null) {
                    z16 = false;
                }
