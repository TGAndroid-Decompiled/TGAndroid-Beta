    ...
    public final void b(int i10) {
        ...
        if (i10 == -1) {
            if (!boVar.wc.f13975f) {
                ...
                if (kVar.s()) {
                    boVar.z7(false);
                } else if (boVar.R3 == 5 && (boVar.f32491u6.isEmpty() || boVar.f32279d4 == 0)) {
                    boVar.Qb();
                } else if (boVar.R3 == 6 && boVar.Y.w()) {
                    boVar.wb(new Runnable(this) {
                        public final nj f35175b;
                        ...
                        public final void run() {
                            switch (r2) {
                                case 0:
                                    this.f35175b.f35993b.finishFragment();
                                    return;
                                default:
                                    nj njVar = this.f35175b;
                                    njVar.getClass();
                                    bo boVar2 = njVar.f35993b;
            ...
            if (i10 == 10) {
                ...
                for (int i18 = 1; i18 >= 0; i18--) {
                    ...
                    for (int i20 = 0; i20 < arrayList.size(); i20++) {
                        ...
                        if (arrayList.size() != 1 && ((user3 = boVar.f32299f) == null || !user3.self)) {
                            z15 = true;
                        } else {
                            z15 = false;
                        }
                ...
                yh.v5.y(i14, false).C(j13, j14, new lg(this, j13, j14, 1));
            } else if (i10 == 28) {
                if (boVar.f32260bb == null) {
                    bo.G1(boVar);
                } else {
                    boVar.k9();
                }
                ...
                if (boVar.getParentActivity() != null) {
                    boVar.showDialog(org.telegram.ui.Components.c5.V(boVar.getParentActivity(), boVar.h, boVar.f32297ea).f18437a);
                }
            } else if (i10 == 15 || i10 == 16 || i10 == 26) {
                boolean z16 = false;
                if (boVar.getParentActivity() != null) {
                    if (i10 == 15 && ChatObject.isMonoForum(boVar.e)) {
                        if (boVar.f32279d4 != 0 && (user2 = boVar.getMessagesController().getUser(Long.valueOf(boVar.f32279d4))) != null) {
                    ...
                    if (i10 == 26 || (i10 == 15 && boVar.h == null && (((user = boVar.f32299f) != null && !UserObject.isUserSelf(user) && !UserObject.isDeleted(boVar.f32299f)) || ((chatFull = boVar.Z7) != null && chatFull.can_delete_channel)))) {
                        boolean z17 = z10;
                        org.telegram.ui.Components.c5.r(boVar, -1, boVar.f32299f, boVar.e, z17, new mj(this, z17), boVar.getResourceProvider());
                        return;
                    }
                    if (i10 == 15) {
                        z11 = true;
                    ...
                    TLRPC.User user4 = boVar.f32299f;
                    if (boVar.h != null) {
                        z16 = true;
                    }
                ...
                if (boVar.f32299f != null && boVar.getParentActivity() != null) {
                ...
                try {
                    boVar.getMediaDataController().installShortcut(boVar.f32299f.f18259id, MediaDataController.SHORTCUT_TYPE_USER_OR_CHAT);
                } catch (Exception e) {
                    FileLog.e(e);
                }
            } else if (i10 == 29) {
                ...
                for (int i26 = 1; i26 >= 0; i26--) {
                    if (messageObject == null && sparseArrayArr3[i26].size() == 1) {
                        ...
                        messageObject = (MessageObject) boVar.f32415o6[i26].get(((Integer) arrayList3.get(0)).intValue());
                    }
                ...
                hg.y1.d0(parentActivity2, i13, boVar.Q3, c10, boVar.getResourceProvider(), new nf(4, this, c10));
            } else if (i10 == 14) {
                org.telegram.ui.ActionBar.f1 f1Var = new org.telegram.ui.ActionBar.f1(0, this.f35992a, boVar.getResourceProvider(), true, true);
                ...
                if (i10 == 50) {
                    ...
                    if (boVar.f32267c4 != null) {
                        ...
                        long j15 = boVar.e.f18112id;
                        TLRPC.TL_forumTopic tL_forumTopic = boVar.f32267c4;
                        int i28 = tL_forumTopic.f18164id;
                    ...
                    if (textView2 != null) {
                        textView2.setTextColor(boVar.getThemedColor(org.telegram.ui.ActionBar.i6.f19074q7));
                    }
                } else if (i10 == 73) {
                    ze1 a02 = ze1.a0(-boVar.T5, 0L);
                    a02.f40156y = boVar;
            ...
            } else if (boVar.f32299f != null && boVar.getParentActivity() != null) {
                TLRPC.User user5 = boVar.f32299f;
                if (i10 == 33) {
                    z12 = true;
                } else {
                    z12 = false;
                ...
                org.telegram.ui.Components.voip.f2.m(user5, z12, z13, boVar.getParentActivity(), boVar.getMessagesController().getUserFull(boVar.f32299f.f18259id), boVar.getAccountInstance());
            }
        }
    }
}
