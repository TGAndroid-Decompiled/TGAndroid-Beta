...
public final class p00 extends org.telegram.ui.Cells.m4 {
    public final TextView f37142r;
    public final lh.x9 f37143s;
    public int v;
    public final org.telegram.ui.Components.c5 f37144w;
    public boolean f37145x;
    public final b10 f37146y;
    ...
    public final void d(int i10, boolean z4) {
        ...
        TextView textView = this.f37142r;
        ...
        this.v = i12;
        lh.x9 x9Var = this.f37143s;
        if (!z10) {
            x9Var.setEmojiColor(i12);
        }
        if (!z4) {
            this.f37144w.a(this.v, true);
        }
        if (z10 != this.f37145x) {
            this.f37145x = z10;
            ...
            animate2.alpha(f11).setDuration(320L).setInterpolator(nrVar).start();
        }
    }
