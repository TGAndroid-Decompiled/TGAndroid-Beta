...
public final class p00 extends pg.b {
    ...
    @Override
    public final int h() {
        return this.d.f40057d0.size();
    }

    @Override
    public final int j(int i10) {
        return ((w00) this.d.f40057d0.get(i10)).f44099a;
    }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        ArrayList arrayList = this.d.f40057d0;
        w00 w00Var = (w00) arrayList.get(i10);
        int i13 = i10 + 1;
        if (i13 < arrayList.size() && (i11 = ((w00) arrayList.get(i13)).f44099a) != 3 && i11 != 6) {
            z10 = true;
        } else {
            z10 = false;
        }
        if (i12 == 7) {
            ...
            if (i12 != 0 && i12 == 8) {
                m00 m00Var = (m00) view;
                m00Var.f38558a.setText(LocaleController.getString(R.string.CreateNewInviteLink));
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 == 8) {
            ...
            e9Var.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20762h5, false));
        } else if (i10 == 7) {
