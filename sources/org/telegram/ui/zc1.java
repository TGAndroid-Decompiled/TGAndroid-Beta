...
public final class zc1 implements org.telegram.ui.Components.kq {
    ...
    public final int M0(int i10) {
        ...
        wd1 wd1Var = this.f43380a;
        if (wd1Var.f41953n == 3) {
            org.telegram.ui.ActionBar.i6 i6Var = wd1Var.f41930e0;
            if (i6Var.S && i10 == 0 && (h6Var = (org.telegram.ui.ActionBar.h6) i6Var.f20542a0.get(org.telegram.ui.ActionBar.j6.f20840n)) != null) {
                return h6Var.f20494e;
            }
            return 0;
        }
        return 0;
    ...
    public final void k(boolean z10) {
        ...
        if (z10) {
            if (h6Var.f20506r == null) {
                ...
                MessagesController.getInstance(i11).saveThemeToServer(h6Var.f20492b, h6Var);
                NotificationCenter.getGlobalInstance().lambda$postNotificationNameOnUIThread$1(NotificationCenter.needShareTheme, h6Var.f20492b, h6Var);
                return;
            }
    ...
    public final void z() {
        ...
        if (wd1Var.getParentActivity() != null) {
            ...
            alertDialog$Builder.f20199a.R = LocaleController.getString(R.string.DeleteThemeTitle);
            alertDialog$Builder.f20199a.T = LocaleController.getString(R.string.DeleteThemeAlert);
            ...
            if (textView != null) {
                textView.setTextColor(wd1Var.getThemedColor(org.telegram.ui.ActionBar.j6.f20899q7));
            }
        }
    }
}
