...
public final class l8 implements Runnable {
    ...
    public final void run() {
        ...
        switch (this.f38565a) {
            case 0:
                l9 l9Var = this.f38566b;
                l9Var.f0();
                l9Var.i0();
                return;
            case 1:
                l9 l9Var2 = this.f38566b;
                l9Var2.n0(false);
                if (l9Var2.f38582w) {
                ...
                return;
            case 2:
                this.f38566b.p0(true);
                return;
            case 3:
                l9 l9Var3 = this.f38566b;
                l9Var3.h0();
                l9Var3.f0();
                return;
            case 4:
                this.f38566b.n0(false);
                return;
            case 5:
                this.f38566b.n0(true);
                return;
            default:
                l9 l9Var4 = this.f38566b;
