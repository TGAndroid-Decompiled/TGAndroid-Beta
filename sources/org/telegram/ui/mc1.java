...
public final class mc1 extends org.telegram.ui.Components.ul0 {
    ...
    public ArrayList e;
    public final ThemeActivity f34915f;

    public mc1(ThemeActivity themeActivity, Context context) {
        this.f34915f = themeActivity;
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (j3 != 0) {
            ...
            cc1Var.getClass();
            if (i6Var.W >= 8) {
                cc1Var.f31607b = new int[]{i6Var.l(6), i6Var.l(4), i6Var.l(7), i6Var.l(2), i6Var.l(0), i6Var.l(5), i6Var.l(3)};
                return;
            } else {
                cc1Var.f31607b = new int[7];
                return;
            }
        }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 != 0) {
            return new s4.c1(new cc1(context));
        }
