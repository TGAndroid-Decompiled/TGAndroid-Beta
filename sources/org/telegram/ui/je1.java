...
public final class je1 extends FrameLayout {
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        switch (this.f34859a) {
            case 0:
                me1 me1Var = this.f34860b;
                if (me1Var.f35786x > 0.0f && me1Var.v != null) {
                    me1Var.f35785w.reset();
                    float width = getWidth() / me1Var.f35783r.getWidth();
                    me1Var.f35785w.postScale(width, width);
                    me1Var.f35784s.setLocalMatrix(me1Var.f35785w);
                    me1Var.v.setAlpha((int) (me1Var.f35786x * 255.0f));
                    canvas2 = canvas;
    ...
    public boolean drawChild(Canvas canvas, View view, long j3) {
        switch (this.f34859a) {
            case 1:
                ...
                canvas.save();
                canvas.clipRect(0.0f, AndroidUtilities.lerp(me1Var.L, 0.0f, me1Var.f35786x), getWidth(), AndroidUtilities.lerp(me1Var.M, getHeight(), me1Var.f35786x));
    ...
    public void onSizeChanged(int i10, int i11, int i12, int i13) {
        switch (this.f34859a) {
            case 0:
                ...
                me1 me1Var = this.f34860b;
                gh.d.c(me1Var.E, me1Var.f35775b);
                me1Var.F.d();
                return;
            default:
                super.onSizeChanged(i10, i11, i12, i13);
