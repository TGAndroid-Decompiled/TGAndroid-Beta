...
public class PinchToZoomHelper {
    ...
    public class ZoomOverlayView extends FrameLayout {
        ...
        private void drawImage(Canvas canvas) {
            ...
            float f2 = ((pinchToZoomHelper.finishProgress * pinchToZoomHelper.pinchScale) + 1.0f) - PinchToZoomHelper.this.finishProgress;
            PinchToZoomHelper pinchToZoomHelper2 = PinchToZoomHelper.this;
            canvas.scale(f2, f2, pinchToZoomHelper2.pinchCenterX + left, pinchToZoomHelper2.pinchCenterY + top);
            PinchToZoomHelper pinchToZoomHelper3 = PinchToZoomHelper.this;
            float f3 = (pinchToZoomHelper3.finishProgress * pinchToZoomHelper3.pinchTranslationX) + left;
            PinchToZoomHelper pinchToZoomHelper4 = PinchToZoomHelper.this;
            canvas.translate(f3, (pinchToZoomHelper4.finishProgress * pinchToZoomHelper4.pinchTranslationY) + top);
            ...
            if (PinchToZoomHelper.this.imageHeight != PinchToZoomHelper.this.fullImageHeight || PinchToZoomHelper.this.imageWidth != PinchToZoomHelper.this.fullImageWidth) {
                if (f2 < 1.0f) {
                    ...
                    f = f2 < 1.4f ? (f2 - 1.0f) / 0.4f : 1.0f;
                }
                float f6 = (PinchToZoomHelper.this.fullImageHeight - PinchToZoomHelper.this.imageHeight) / 2.0f;
                float f7 = ((PinchToZoomHelper.this.fullImageWidth - PinchToZoomHelper.this.imageWidth) / 2.0f) * f;
            ...
            if (PinchToZoomHelper.this.isHardwareVideo) {
                ...
                frameLayout3.setTranslationX((pinchToZoomHelper7.finishProgress * pinchToZoomHelper7.pinchTranslationX * f2) + f11);
                FrameLayout frameLayout4 = this.videoPlayerContainer;
                float f12 = f5 + top;
                PinchToZoomHelper pinchToZoomHelper8 = PinchToZoomHelper.this;
                frameLayout4.setTranslationY((pinchToZoomHelper8.finishProgress * pinchToZoomHelper8.pinchTranslationY * f2) + f12);
            } else {
                if (PinchToZoomHelper.this.childImage != null) {
                    if (PinchToZoomHelper.this.progressToFullView != 1.0f) {
            ...
            if (PinchToZoomHelper.this.hasMediaSpoiler) {
                ...
                if (PinchToZoomHelper.this.mediaSpoilerEffect2 != null) {
                    canvas.translate(PinchToZoomHelper.this.childImage.getImageX(), PinchToZoomHelper.this.childImage.getImageY());
                    canvas2 = canvas;
                    PinchToZoomHelper.this.mediaSpoilerEffect2.draw(canvas2, PinchToZoomHelper.this.overlayView, (int) PinchToZoomHelper.this.childImage.getImageWidth(), (int) PinchToZoomHelper.this.childImage.getImageHeight(), 1.0f, false);
                } else {
                    canvas2 = canvas;
                    ...
                    PinchToZoomHelper.this.mediaSpoilerEffect.draw(canvas2);
                }
                canvas2.restore();
                invalidate();
            } else {
    ...
    public static float access$1216(PinchToZoomHelper pinchToZoomHelper, float f) {
        float f2 = pinchToZoomHelper.progressToFullView + f;
        pinchToZoomHelper.progressToFullView = f2;
        return f2;
    }

    public static float access$416(PinchToZoomHelper pinchToZoomHelper, float f) {
    ...
    public void finishZoom() {
        if (this.finishTransition == null && this.inOverlayMode) {
            ...
            valueAnimatorOfFloat.addUpdateListener(new QrActivity$$ExternalSyntheticLambda8(this, 12));
    ...
    public void startZoom(View view, ImageReceiver imageReceiver, View view2, View view3, MessageObject messageObject, int i) {
        ...
        if (!this.isSimple) {
            ...
            if (z && this.mediaSpoilerEffect2 == null) {
    ...
    public boolean checkPinchToZoom(MotionEvent motionEvent, View view, ImageReceiver imageReceiver, View view2, View view3, MessageObject messageObject, int i) {
        ...
        if (motionEvent.getActionMasked() == 0 || motionEvent.getActionMasked() == 5) {
            ...
            if (fHypot > 1.005f && !isInOverlayMode()) {
                ...
                float x2 = (motionEvent.getX(i3) + motionEvent.getX(i2)) / 2.0f;
                this.pinchCenterX = x2;
                this.pinchStartCenterX = x2;
                float y2 = (motionEvent.getY(i3) + motionEvent.getY(i2)) / 2.0f;
    ...
    public interface Callback {
        ...
        public abstract class CC {
            ...
            public static void $default$onZoomStarted(Callback callback, MessageObject messageObject) {
            }
        }
    }
}
