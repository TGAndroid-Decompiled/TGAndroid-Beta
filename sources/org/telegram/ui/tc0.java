...
public final class tc0 implements Runnable {
    ...
    public final id0 f40741b;
    public final IMapsProvider.IMapView f40742c;

    public tc0(id0 id0Var, IMapsProvider.IMapView iMapView, int i10) {
        this.f40740a = i10;
        this.f40741b = id0Var;
        this.f40742c = iMapView;
    }
    ...
    public final void run() {
        switch (this.f40740a) {
            case 0:
                ...
                return;
            default:
                id0 id0Var2 = this.f40741b;
                IMapsProvider.IMapView iMapView2 = this.f40742c;
                try {
