...
public final class mz implements ViewTreeObserver.OnGlobalLayoutListener {
    public final ExternalActionActivity f36291a;

    public mz(ExternalActionActivity externalActionActivity) {
        this.f36291a = externalActionActivity;
    }

    @Override
    public final void onGlobalLayout() {
        ExternalActionActivity externalActionActivity = this.f36291a;
        externalActionActivity.f();
        ActionBarLayout actionBarLayout = externalActionActivity.f31565c;
