...
public final class d80 extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public z4.g d;
    public org.telegram.ui.Components.sa f35714e;
    public TextView f35715f;
    public GradientDrawable h;
    public ci.n f35716n;
    public FrameLayout f35717r;
    public ah.w f35718s;
    public org.telegram.ui.Components.xi0 v;
    public int f35719w;
    public boolean f35720x;
    public boolean f35721y;

    public d80() {
        super(null);
        this.f35711a = new Object();
        this.f35712b = new Object();
        this.f35713c = UserConfig.selectedAccount;
        this.f35719w = 0;
        this.f35720x = false;
        this.f35721y = false;
    }
    ...
    public final void V(boolean z10) {
        ...
        this.f35715f.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.q6, false));
        this.f35716n.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.Sh, false));
        ci.n nVar = this.f35716n;
        ...
        if (z10) {
            ...
            for (int i12 = 0; i12 < this.d.getChildCount(); i12++) {
                ...
                ((TextView) childAt.findViewWithTag(this.f35711a)).setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i13, false));
                ((TextView) childAt.findViewWithTag(this.f35712b)).setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i13, false));
            }
            return;
        }
    ...
    public final View createView(Context context) {
        ...
        this.f35717r = frameLayout2;
        this.f35718s.addView(frameLayout2, w7.x5.d(-1, -2.0f, 51, 0.0f, 78.0f, 0.0f, 0.0f));
        TextureView textureView = new TextureView(context);
        this.f35717r.addView(textureView, w7.x5.e(200, 150, 17));
        ...
        this.f35718s.addView(this.d, w7.x5.c(-1.0f, -1));
        ...
        this.f35716n.setText(LocaleController.getString(R.string.StartMessaging));
        this.f35716n.setGravity(17);
        this.f35716n.setTypeface(AndroidUtilities.bold());
        this.f35716n.setTextSize(1, 15.0f);
        this.f35716n.setPadding(AndroidUtilities.dp(34.0f), 0, AndroidUtilities.dp(34.0f), 0);
        this.f35718s.addView(this.f35716n, w7.x5.d(-1, 48.0f, 81, 16.0f, 0.0f, 16.0f, 76.0f));
        this.f35716n.setOnClickListener(new View.OnClickListener(this) {
            public final d80 f43014b;
            ...
            public final void onClick(View view) {
                switch (r2) {
                    case 0:
                        ...
                        return;
                    default:
                        d80 d80Var2 = this.f43014b;
                        if (!d80Var2.f35721y && d80Var2.L != null) {
                            d80Var2.f35721y = true;
                            ...
                            LocaleController.getInstance().applyLanguage(d80Var2.L, true, false, d80Var2.f35713c);
                            return;
                        }
                        return;
                }
        ...
        this.f35714e = saVar;
        this.f35718s.addView(saVar, w7.x5.d(66, 5.0f, 49, 0.0f, 350.0f, 0.0f, 0.0f));
        TextView textView = new TextView(context);
        this.f35715f = textView;
        textView.setGravity(17);
        this.f35715f.setTextSize(1, 16.0f);
        this.f35718s.addView(this.f35715f, w7.x5.d(-2, 30.0f, 81, 0.0f, 0.0f, 0.0f, 20.0f));
        this.f35715f.setOnClickListener(new View.OnClickListener(this) {
            public final d80 f43014b;
        ...
        float f7 = 4;
        this.f35718s.addView(frameLayout, w7.x5.d(64, 64.0f, 53, 0.0f, f7, f7, 0.0f));
    ...
    public final ArrayList getThemeDescriptions() {
        return w7.a6.a(new e(this, 18), org.telegram.ui.ActionBar.j6.f20663d6, org.telegram.ui.ActionBar.j6.q6, org.telegram.ui.ActionBar.j6.P9, org.telegram.ui.ActionBar.j6.Q9, org.telegram.ui.ActionBar.j6.Sh, org.telegram.ui.ActionBar.j6.G6);
    }
    ...
    public final void onFragmentDestroy() {
        ...
        NotificationCenter.getInstance(this.f35713c).removeObserver(this, NotificationCenter.configLoaded);
