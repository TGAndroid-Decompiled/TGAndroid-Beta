...
public final class d80 extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public bi.o f32954n;
    public FrameLayout f32955r;
    public ci.n6 f32956s;
    public org.telegram.ui.Components.xi0 v;
    public int f32957w;
    public boolean f32958x;
    public boolean f32959y;

    public d80() {
        super(null);
        this.f32950a = new Object();
        this.f32951b = new Object();
        this.f32952c = UserConfig.selectedAccount;
        this.f32957w = 0;
        this.f32958x = false;
        this.f32959y = false;
    }
    ...
    public final void V(boolean z10) {
        ...
        this.f32953f.setTextColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.q6, false));
        this.f32954n.setTextColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.Sh, false));
        bi.o oVar = this.f32954n;
        ...
        if (z10) {
            ...
            for (int i12 = 0; i12 < this.d.getChildCount(); i12++) {
                ...
                ((TextView) childAt.findViewWithTag(this.f32950a)).setTextColor(org.telegram.ui.ActionBar.i6.w0(null, i13, false));
                ((TextView) childAt.findViewWithTag(this.f32951b)).setTextColor(org.telegram.ui.ActionBar.i6.w0(null, i13, false));
            }
            return;
        }
    ...
    public final View createView(Context context) {
        ...
        this.f32955r = frameLayout2;
        this.f32956s.addView(frameLayout2, w7.x5.d(-1, -2.0f, 51, 0.0f, 78.0f, 0.0f, 0.0f));
        TextureView textureView = new TextureView(context);
        this.f32955r.addView(textureView, w7.x5.e(200, 150, 17));
        ...
        this.f32956s.addView(this.d, w7.x5.c(-1.0f, -1));
        ...
        this.f32954n.setText(LocaleController.getString(R.string.StartMessaging));
        this.f32954n.setGravity(17);
        this.f32954n.setTypeface(AndroidUtilities.bold());
        this.f32954n.setTextSize(1, 15.0f);
        this.f32954n.setPadding(AndroidUtilities.dp(34.0f), 0, AndroidUtilities.dp(34.0f), 0);
        this.f32956s.addView(this.f32954n, w7.x5.d(-1, 48.0f, 81, 16.0f, 0.0f, 16.0f, 76.0f));
        this.f32954n.setOnClickListener(new View.OnClickListener(this) {
            public final d80 f39772b;
            ...
            public final void onClick(View view) {
                switch (r2) {
                    case 0:
                        ...
                        return;
                    default:
                        d80 d80Var2 = this.f39772b;
                        if (!d80Var2.f32959y && d80Var2.L != null) {
                            d80Var2.f32959y = true;
                            ...
                            LocaleController.getInstance().applyLanguage(d80Var2.L, true, false, d80Var2.f32952c);
                            return;
                        }
                        return;
                }
        ...
        this.e = qaVar;
        this.f32956s.addView(qaVar, w7.x5.d(66, 5.0f, 49, 0.0f, 350.0f, 0.0f, 0.0f));
        TextView textView = new TextView(context);
        this.f32953f = textView;
        textView.setGravity(17);
        this.f32953f.setTextSize(1, 16.0f);
        this.f32956s.addView(this.f32953f, w7.x5.d(-2, 30.0f, 81, 0.0f, 0.0f, 0.0f, 20.0f));
        this.f32953f.setOnClickListener(new View.OnClickListener(this) {
            public final d80 f39772b;
        ...
        float f7 = 4;
        this.f32956s.addView(frameLayout, w7.x5.d(64, 64.0f, 53, 0.0f, f7, f7, 0.0f));
        this.fragmentView = scrollView;
        NotificationCenter.getGlobalInstance().addObserver(this, NotificationCenter.suggestedLangpack);
        int i13 = this.f32952c;
    ...
    public final ArrayList getThemeDescriptions() {
        return w7.a6.a(new e(this, 18), org.telegram.ui.ActionBar.i6.f18836d6, org.telegram.ui.ActionBar.i6.q6, org.telegram.ui.ActionBar.i6.P9, org.telegram.ui.ActionBar.i6.Q9, org.telegram.ui.ActionBar.i6.Sh, org.telegram.ui.ActionBar.i6.G6);
    }
    ...
    public final void onFragmentDestroy() {
        ...
        NotificationCenter.getInstance(this.f32952c).removeObserver(this, NotificationCenter.configLoaded);
