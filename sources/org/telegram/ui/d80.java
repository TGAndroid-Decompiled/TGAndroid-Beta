...
public final class d80 extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public bi.o f32894n;
    public FrameLayout f32895r;
    public ci.n6 f32896s;
    ...
    public d80() {
        super(null);
        this.f32890a = new Object();
        this.f32891b = new Object();
        this.f32892c = UserConfig.selectedAccount;
        this.f32897w = 0;
        this.f32898x = false;
        this.f32899y = false;
    }
    ...
    public final void V(boolean z10) {
        ...
        this.f32893f.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.q6, false));
        this.f32894n.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.Sh, false));
        bi.o oVar = this.f32894n;
        ...
        if (z10) {
            ...
            for (int i12 = 0; i12 < this.d.getChildCount(); i12++) {
                ...
                ((TextView) childAt.findViewWithTag(this.f32890a)).setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i13, false));
                ((TextView) childAt.findViewWithTag(this.f32891b)).setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i13, false));
            }
            return;
        }
    ...
    public final View createView(Context context) {
        ...
        this.f32895r = frameLayout2;
        this.f32896s.addView(frameLayout2, w7.y5.d(-1, -2.0f, 51, 0.0f, 78.0f, 0.0f, 0.0f));
        TextureView textureView = new TextureView(context);
        this.f32895r.addView(textureView, w7.y5.e(200, 150, 17));
        ...
        this.f32896s.addView(this.d, w7.y5.c(-1.0f, -1));
        ...
        this.f32894n.setText(LocaleController.getString(R.string.StartMessaging));
        this.f32894n.setGravity(17);
        this.f32894n.setTypeface(AndroidUtilities.bold());
        this.f32894n.setTextSize(1, 15.0f);
        this.f32894n.setPadding(AndroidUtilities.dp(34.0f), 0, AndroidUtilities.dp(34.0f), 0);
        this.f32896s.addView(this.f32894n, w7.y5.d(-1, 48.0f, 81, 16.0f, 0.0f, 16.0f, 76.0f));
        this.f32894n.setOnClickListener(new View.OnClickListener(this) {
            public final d80 f39720b;
            ...
            public final void onClick(View view) {
                switch (r2) {
                    case 0:
                        ...
                        return;
                    default:
                        d80 d80Var2 = this.f39720b;
                        if (!d80Var2.f32899y && d80Var2.L != null) {
                            d80Var2.f32899y = true;
                            ...
                            LocaleController.getInstance().applyLanguage(d80Var2.L, true, false, d80Var2.f32892c);
                            return;
                        }
                        return;
                }
        ...
        this.e = saVar;
        this.f32896s.addView(saVar, w7.y5.d(66, 5.0f, 49, 0.0f, 350.0f, 0.0f, 0.0f));
        TextView textView = new TextView(context);
        this.f32893f = textView;
        textView.setGravity(17);
        this.f32893f.setTextSize(1, 16.0f);
        this.f32896s.addView(this.f32893f, w7.y5.d(-2, 30.0f, 81, 0.0f, 0.0f, 0.0f, 20.0f));
        this.f32893f.setOnClickListener(new View.OnClickListener(this) {
            public final d80 f39720b;
        ...
        float f7 = 4;
        this.f32896s.addView(frameLayout, w7.y5.d(64, 64.0f, 53, 0.0f, f7, f7, 0.0f));
        this.fragmentView = scrollView;
        NotificationCenter.getGlobalInstance().addObserver(this, NotificationCenter.suggestedLangpack);
        int i13 = this.f32892c;
    ...
    public final ArrayList getThemeDescriptions() {
        return w7.b6.a(new e(this, 18), org.telegram.ui.ActionBar.j6.f19062d6, org.telegram.ui.ActionBar.j6.q6, org.telegram.ui.ActionBar.j6.P9, org.telegram.ui.ActionBar.j6.Q9, org.telegram.ui.ActionBar.j6.Sh, org.telegram.ui.ActionBar.j6.G6);
    }
    ...
    public final void onFragmentDestroy() {
        ...
        NotificationCenter.getInstance(this.f32892c).removeObserver(this, NotificationCenter.configLoaded);
