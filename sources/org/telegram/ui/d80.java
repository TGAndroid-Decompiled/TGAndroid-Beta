...
public final class d80 extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public TextView f32958f;
    public GradientDrawable h;
    public bi.o f32959n;
    public FrameLayout f32960r;
    public ci.n6 f32961s;
    ...
    public d80() {
        super(null);
        this.f32955a = new Object();
        this.f32956b = new Object();
        this.f32957c = UserConfig.selectedAccount;
        this.f32962w = 0;
        this.f32963x = false;
        this.f32964y = false;
    }
    ...
    public final void V(boolean z10) {
        ...
        this.f32958f.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.q6, false));
        this.f32959n.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.Sh, false));
        bi.o oVar = this.f32959n;
        ...
        if (z10) {
            ...
            for (int i12 = 0; i12 < this.d.getChildCount(); i12++) {
                ...
                ((TextView) childAt.findViewWithTag(this.f32955a)).setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i13, false));
                ((TextView) childAt.findViewWithTag(this.f32956b)).setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i13, false));
            }
            return;
        }
    ...
    public final View createView(Context context) {
        ...
        this.f32960r = frameLayout2;
        this.f32961s.addView(frameLayout2, w7.y5.d(-1, -2.0f, 51, 0.0f, 78.0f, 0.0f, 0.0f));
        TextureView textureView = new TextureView(context);
        this.f32960r.addView(textureView, w7.y5.e(200, 150, 17));
        ...
        this.f32961s.addView(this.d, w7.y5.c(-1.0f, -1));
        ...
        this.f32959n.setText(LocaleController.getString(R.string.StartMessaging));
        this.f32959n.setGravity(17);
        this.f32959n.setTypeface(AndroidUtilities.bold());
        this.f32959n.setTextSize(1, 15.0f);
        this.f32959n.setPadding(AndroidUtilities.dp(34.0f), 0, AndroidUtilities.dp(34.0f), 0);
        this.f32961s.addView(this.f32959n, w7.y5.d(-1, 48.0f, 81, 16.0f, 0.0f, 16.0f, 76.0f));
        this.f32959n.setOnClickListener(new View.OnClickListener(this) {
            public final d80 f39821b;
            ...
            public final void onClick(View view) {
                switch (r2) {
                    case 0:
                        ...
                        return;
                    default:
                        d80 d80Var2 = this.f39821b;
                        if (!d80Var2.f32964y && d80Var2.L != null) {
                            d80Var2.f32964y = true;
                            ...
                            LocaleController.getInstance().applyLanguage(d80Var2.L, true, false, d80Var2.f32957c);
                            return;
                        }
                        return;
                }
        ...
        this.e = raVar;
        this.f32961s.addView(raVar, w7.y5.d(66, 5.0f, 49, 0.0f, 350.0f, 0.0f, 0.0f));
        TextView textView = new TextView(context);
        this.f32958f = textView;
        textView.setGravity(17);
        this.f32958f.setTextSize(1, 16.0f);
        this.f32961s.addView(this.f32958f, w7.y5.d(-2, 30.0f, 81, 0.0f, 0.0f, 0.0f, 20.0f));
        this.f32958f.setOnClickListener(new View.OnClickListener(this) {
            public final d80 f39821b;
        ...
        float f7 = 4;
        this.f32961s.addView(frameLayout, w7.y5.d(64, 64.0f, 53, 0.0f, f7, f7, 0.0f));
        this.fragmentView = scrollView;
        NotificationCenter.getGlobalInstance().addObserver(this, NotificationCenter.suggestedLangpack);
        int i13 = this.f32957c;
    ...
    public final ArrayList getThemeDescriptions() {
        return w7.c6.a(new e(this, 18), org.telegram.ui.ActionBar.j6.f19094d6, org.telegram.ui.ActionBar.j6.q6, org.telegram.ui.ActionBar.j6.P9, org.telegram.ui.ActionBar.j6.Q9, org.telegram.ui.ActionBar.j6.Sh, org.telegram.ui.ActionBar.j6.G6);
    }
    ...
    public final void onFragmentDestroy() {
        ...
        NotificationCenter.getInstance(this.f32957c).removeObserver(this, NotificationCenter.configLoaded);
