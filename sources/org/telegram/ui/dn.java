...
public final class dn extends org.telegram.ui.Components.lq0 {
    ...
    public final void R0(a0.h hVar, int i10, TLRPC.TL_forumTopic tL_forumTopic, boolean z4) {
        ...
        int i11 = xn.Ec;
        xnVar.Q7();
        if (jnVar.f35381a.f40209v3 != null && z4) {
            if (hVar.m() == 1) {
                if (((TLRPC.Dialog) hVar.n(0)).f19188id != jnVar.f35381a.getUserConfig().getClientUserId() || !org.telegram.ui.Components.qc.a0(jnVar.f35381a).e0(i10, ((TLRPC.Dialog) hVar.n(0)).f19188id)) {
                    jnVar.f35381a.f40209v3.k(((TLRPC.Dialog) hVar.n(0)).f19188id, 53, Integer.valueOf(i10), tL_forumTopic, null, null);
                    return;
                }
                return;
            }
            jnVar.f35381a.f40209v3.k(0L, 53, Integer.valueOf(i10), Integer.valueOf(hVar.m()), null, null);
        }
    }
    ...
    public final void S0(final View view) {
        ph.w9 w9Var;
        xn xnVar = this.Z0.f35381a;
        MessageObject.GroupedMessages groupedMessages = null;
        if (view instanceof org.telegram.ui.Cells.e7) {
            w9Var = ph.y9.b((org.telegram.ui.Cells.e7) view);
        } else {
            w9Var = null;
        }
        ...
        if (messageObject.getGroupId() != 0) {
            groupedMessages = (MessageObject.GroupedMessages) xnVar.f40199u6.f(messageObject.getGroupId());
        }
        ...
        E.O = new Utilities.Callback4() {
            ...
            public final void run(Object obj, Object obj2, Object obj3, Object obj4) {
                ...
                if (booleanValue) {
                    dn dnVar = dn.this;
                    AndroidUtilities.runOnUIThread(new yb(25, dnVar, l11));
                    dnVar.dismiss();
                    daVar.Y(null);
                } else {
                    View view2 = view;
                    if ((view2 instanceof org.telegram.ui.Cells.e7) && view2.isAttachedToWindow()) {
                        w9Var2 = ph.y9.b((org.telegram.ui.Cells.e7) view2);
                    }
                    daVar.Y(w9Var2);
                }
