...
public class l20 extends org.telegram.ui.Components.wc0 {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        j20 j20Var = m20Var.f35457y;
        int i11 = 0;
        if (!m20Var.f35451f) {
            if (m20Var.h) {
                float f10 = m20Var.f35452n + 0.016f;
                m20Var.f35452n = f10;
                if (f10 > 3.0f) {
                    m20Var.h = false;
                }
            } else {
                float f11 = m20Var.f35452n - 0.016f;
                m20Var.f35452n = f11;
                if (f11 < 1.0f) {
                    m20Var.h = true;
                }
        ...
        if (m20Var.f35450c.getLayoutManager() != null) {
            view = m20Var.f35450c.getLayoutManager().m(0);
        } else {
            view = null;
        }
        if (view != null) {
        ...
        float f12 = 1.0f - ((m20Var.f35453r - dp) / (m20Var.J - dp));
        m20Var.v = f12;
        float f13 = 0.0f;
        ...
        if (m20Var.f35453r < dp2) {
            m20Var.f35453r = dp2;
        }
        float f14 = m20Var.f35456x;
        m20Var.f35456x = 0.0f;
        if (m20Var.f35453r < AndroidUtilities.dp(30.0f) + dp2) {
            m20Var.f35456x = ((AndroidUtilities.dp(30.0f) + dp2) - m20Var.f35453r) / AndroidUtilities.dp(30.0f);
        }
        if (m20Var.H) {
            m20Var.f35456x = 1.0f;
            m20Var.v = 1.0f;
        }
        if (f14 != m20Var.f35456x) {
            m20Var.f35450c.invalidate();
        }
        int i12 = m20Var.f35453r;
        ...
        ((org.telegram.ui.Components.n90) j20Var.f34630c).setAlpha(f16);
        ...
        m20Var.f35448a.d(0, (-getMeasuredWidth()) * 0.1f * m20Var.f35452n, 0, getMeasuredWidth(), 0.0f, getMeasuredHeight());
        if (m20Var.M) {
            int themedColor = m20Var.getThemedColor(org.telegram.ui.ActionBar.h6.f19004a7);
            Paint paint2 = this.H0;
            paint2.setColor(themedColor);
            canvas.drawRect(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight(), paint2);
        } else {
            canvas.drawRect(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight(), m20Var.f35448a.f42841f);
        }
        int themedColor2 = m20Var.getThemedColor(org.telegram.ui.ActionBar.h6.f19166j5);
        if (m20Var.M) {
            i10 = org.telegram.ui.ActionBar.h6.G6;
        } else {
            i10 = org.telegram.ui.ActionBar.h6.Tj;
        }
        int d = i0.a.d(f16, themedColor2, m20Var.getThemedColor(i10));
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if ((!rectF2.contains(motionEvent.getX(), motionEvent.getY()) && !this.E0) || m20Var.f35450c.K1 || (layout = n90Var.getLayout()) == null) {
            f7 = 1.0f;
        } else {
            ...
            if (text instanceof Spanned) {
                ...
                if (clickableSpanArr != null && clickableSpanArr.length > 0 && m20Var.f35456x < 1.0f) {
        ...
        if ((rectF2.contains(motionEvent.getX(), motionEvent.getY()) || this.D0) && !m20Var.f35450c.K1 && isClickable && m20Var.f35456x < f7) {
        ...
        if ((rectF2.contains(motionEvent.getX(), motionEvent.getY()) || this.F0) && !m20Var.f35450c.K1 && m20Var.f35456x < f7) {
