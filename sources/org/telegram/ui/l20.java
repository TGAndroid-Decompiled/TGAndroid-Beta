...
public final class l20 {
    public LinearGradient f35284b;
    public final Paint[] f35283a = new Paint[4];
    public final Matrix f35285c = new Matrix();

    public final void a(Canvas canvas, RectF rectF, float f7) {
        Paint[] paintArr = this.f35283a;
        if (paintArr[0] == null) {
            Paint paint = new Paint(1);
            paintArr[0] = paint;
            paint.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.DST_OUT));
        }
        paintArr[0].setShader(this.f35284b);
    ...
    public final void b(Canvas canvas, RectF rectF, int i10, float f7) {
        ...
        if (this.f35284b == null) {
            this.f35284b = new LinearGradient(0.0f, 0.0f, 0.0f, 16.0f, new int[]{-65536, 16711680}, new float[]{0.0f, 1.0f}, Shader.TileMode.CLAMP);
        }
        Paint[] paintArr = this.f35283a;
        ...
        paintArr[i10].setShader(this.f35284b);
        Matrix matrix = this.f35285c;
        matrix.reset();
        if (i10 == 0) {
        ...
        this.f35284b.setLocalMatrix(matrix);
