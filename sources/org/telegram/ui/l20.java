...
public final class l20 {
    public LinearGradient f38177b;
    public final Paint[] f38176a = new Paint[4];
    public final Matrix f38178c = new Matrix();

    public final void a(Canvas canvas, RectF rectF, float f7) {
        Paint[] paintArr = this.f38176a;
        if (paintArr[0] == null) {
            Paint paint = new Paint(1);
            paintArr[0] = paint;
            paint.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.DST_OUT));
        }
        paintArr[0].setShader(this.f38177b);
    ...
    public final void b(Canvas canvas, RectF rectF, int i10, float f7) {
        ...
        if (this.f38177b == null) {
            this.f38177b = new LinearGradient(0.0f, 0.0f, 0.0f, 16.0f, new int[]{-65536, 16711680}, new float[]{0.0f, 1.0f}, Shader.TileMode.CLAMP);
        }
        Paint[] paintArr = this.f38176a;
        ...
        paintArr[i10].setShader(this.f38177b);
        Matrix matrix = this.f38178c;
        matrix.reset();
        if (i10 == 0) {
        ...
        this.f38177b.setLocalMatrix(matrix);
