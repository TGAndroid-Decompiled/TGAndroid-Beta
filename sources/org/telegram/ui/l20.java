...
public class l20 extends org.telegram.ui.Components.wc0 {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        j20 j20Var = m20Var.f35456y;
        int i11 = 0;
        if (!m20Var.f35450f) {
            if (m20Var.h) {
                float f10 = m20Var.f35451n + 0.016f;
                m20Var.f35451n = f10;
                if (f10 > 3.0f) {
                    m20Var.h = false;
                }
            } else {
                float f11 = m20Var.f35451n - 0.016f;
                m20Var.f35451n = f11;
                if (f11 < 1.0f) {
                    m20Var.h = true;
                }
        ...
        if (m20Var.f35449c.getLayoutManager() != null) {
            view = m20Var.f35449c.getLayoutManager().m(0);
        } else {
            view = null;
        }
        if (view != null) {
        ...
        float f12 = 1.0f - ((m20Var.f35452r - dp) / (m20Var.J - dp));
        m20Var.v = f12;
        float f13 = 0.0f;
        ...
        if (m20Var.f35452r < dp2) {
            m20Var.f35452r = dp2;
        }
        float f14 = m20Var.f35455x;
        m20Var.f35455x = 0.0f;
        if (m20Var.f35452r < AndroidUtilities.dp(30.0f) + dp2) {
            m20Var.f35455x = ((AndroidUtilities.dp(30.0f) + dp2) - m20Var.f35452r) / AndroidUtilities.dp(30.0f);
        }
        if (m20Var.H) {
            m20Var.f35455x = 1.0f;
            m20Var.v = 1.0f;
        }
        if (f14 != m20Var.f35455x) {
            m20Var.f35449c.invalidate();
        }
        int i12 = m20Var.f35452r;
        ...
        ((org.telegram.ui.Components.n90) j20Var.f34629c).setAlpha(f16);
        ...
        m20Var.f35447a.d(0, (-getMeasuredWidth()) * 0.1f * m20Var.f35451n, 0, getMeasuredWidth(), 0.0f, getMeasuredHeight());
        if (m20Var.M) {
            int themedColor = m20Var.getThemedColor(org.telegram.ui.ActionBar.h6.f19003a7);
            Paint paint2 = this.H0;
            paint2.setColor(themedColor);
            canvas.drawRect(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight(), paint2);
        } else {
            canvas.drawRect(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight(), m20Var.f35447a.f42840f);
        }
        int themedColor2 = m20Var.getThemedColor(org.telegram.ui.ActionBar.h6.f19165j5);
        if (m20Var.M) {
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if ((!rectF2.contains(motionEvent.getX(), motionEvent.getY()) && !this.E0) || m20Var.f35449c.K1 || (layout = n90Var.getLayout()) == null) {
            f7 = 1.0f;
        } else {
            ...
            if (text instanceof Spanned) {
                ...
                if (clickableSpanArr != null && clickableSpanArr.length > 0 && m20Var.f35455x < 1.0f) {
        ...
        if ((rectF2.contains(motionEvent.getX(), motionEvent.getY()) || this.D0) && !m20Var.f35449c.K1 && isClickable && m20Var.f35455x < f7) {
        ...
        if ((rectF2.contains(motionEvent.getX(), motionEvent.getY()) || this.F0) && !m20Var.f35449c.K1 && m20Var.f35455x < f7) {
