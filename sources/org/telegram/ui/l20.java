...
public class l20 extends org.telegram.ui.Components.xc0 {
    public boolean D0;
    public boolean E0;
    public boolean F0;
    public boolean G0;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        j20 j20Var = m20Var.f35455y;
        int i11 = 0;
        if (!m20Var.f35449f) {
            if (m20Var.h) {
                float f10 = m20Var.f35450n + 0.016f;
                m20Var.f35450n = f10;
                if (f10 > 3.0f) {
                    m20Var.h = false;
                }
            } else {
                float f11 = m20Var.f35450n - 0.016f;
                m20Var.f35450n = f11;
                if (f11 < 1.0f) {
                    m20Var.h = true;
                }
        ...
        float f12 = 1.0f - ((m20Var.f35451r - dp) / (m20Var.J - dp));
        m20Var.v = f12;
        float f13 = 0.0f;
        ...
        if (m20Var.f35451r < dp2) {
            m20Var.f35451r = dp2;
        }
        float f14 = m20Var.f35454x;
        m20Var.f35454x = 0.0f;
        if (m20Var.f35451r < AndroidUtilities.dp(30.0f) + dp2) {
            m20Var.f35454x = ((AndroidUtilities.dp(30.0f) + dp2) - m20Var.f35451r) / AndroidUtilities.dp(30.0f);
        }
        if (m20Var.H) {
            m20Var.f35454x = 1.0f;
            m20Var.v = 1.0f;
        }
        if (f14 != m20Var.f35454x) {
            m20Var.f35448c.invalidate();
        }
        int i12 = m20Var.f35451r;
        ...
        ((org.telegram.ui.Components.o90) j20Var.f34628c).setAlpha(f16);
        ...
        m20Var.f35446a.d(0, (-getMeasuredWidth()) * 0.1f * m20Var.f35450n, 0, getMeasuredWidth(), 0.0f, getMeasuredHeight());
        if (m20Var.M) {
            ...
            canvas.drawRect(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight(), m20Var.f35446a.f42839f);
        }
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        float x11 = o90Var.getX() + x10;
        float y3 = o90Var.getY() + j20Var.getY();
        RectF rectF2 = AndroidUtilities.rectTmp;
        rectF2.set(x11, y3, o90Var.getMeasuredWidth() + x11, o90Var.getMeasuredHeight() + y3);
        if ((!rectF2.contains(motionEvent.getX(), motionEvent.getY()) && !this.E0) || m20Var.f35448c.K1 || (layout = o90Var.getLayout()) == null) {
            f7 = 1.0f;
        } else {
            ...
            if (text instanceof Spanned) {
                ...
                if (clickableSpanArr != null && clickableSpanArr.length > 0 && m20Var.f35454x < 1.0f) {
        ...
        if ((rectF2.contains(motionEvent.getX(), motionEvent.getY()) || this.D0) && !m20Var.f35448c.K1 && isClickable && m20Var.f35454x < f7) {
        ...
        if ((rectF2.contains(motionEvent.getX(), motionEvent.getY()) || this.F0) && !m20Var.f35448c.K1 && m20Var.f35454x < f7) {
