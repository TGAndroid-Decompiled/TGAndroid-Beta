...
public class l20 extends org.telegram.ui.Components.wc0 {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        j20 j20Var = m20Var.f35443y;
        int i11 = 0;
        if (!m20Var.f35437f) {
            if (m20Var.h) {
                float f10 = m20Var.f35438n + 0.016f;
                m20Var.f35438n = f10;
                if (f10 > 3.0f) {
                    m20Var.h = false;
                }
            } else {
                float f11 = m20Var.f35438n - 0.016f;
                m20Var.f35438n = f11;
                if (f11 < 1.0f) {
                    m20Var.h = true;
                }
        ...
        if (m20Var.f35436c.getLayoutManager() != null) {
            view = m20Var.f35436c.getLayoutManager().m(0);
        } else {
            view = null;
        }
        if (view != null) {
        ...
        float f12 = 1.0f - ((m20Var.f35439r - dp) / (m20Var.J - dp));
        m20Var.v = f12;
        float f13 = 0.0f;
        ...
        if (m20Var.f35439r < dp2) {
            m20Var.f35439r = dp2;
        }
        float f14 = m20Var.f35442x;
        m20Var.f35442x = 0.0f;
        if (m20Var.f35439r < AndroidUtilities.dp(30.0f) + dp2) {
            m20Var.f35442x = ((AndroidUtilities.dp(30.0f) + dp2) - m20Var.f35439r) / AndroidUtilities.dp(30.0f);
        }
        if (m20Var.H) {
            m20Var.f35442x = 1.0f;
            m20Var.v = 1.0f;
        }
        if (f14 != m20Var.f35442x) {
            m20Var.f35436c.invalidate();
        }
        int i12 = m20Var.f35439r;
        ...
        ((org.telegram.ui.Components.n90) j20Var.f34615c).setAlpha(f16);
        ...
        m20Var.f35434a.d(0, (-getMeasuredWidth()) * 0.1f * m20Var.f35438n, 0, getMeasuredWidth(), 0.0f, getMeasuredHeight());
        if (m20Var.M) {
            int themedColor = m20Var.getThemedColor(org.telegram.ui.ActionBar.h6.f18989a7);
            Paint paint2 = this.H0;
            paint2.setColor(themedColor);
            canvas.drawRect(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight(), paint2);
        } else {
            canvas.drawRect(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight(), m20Var.f35434a.f42826f);
        }
        int themedColor2 = m20Var.getThemedColor(org.telegram.ui.ActionBar.h6.f19151j5);
        if (m20Var.M) {
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if ((!rectF2.contains(motionEvent.getX(), motionEvent.getY()) && !this.E0) || m20Var.f35436c.K1 || (layout = n90Var.getLayout()) == null) {
            f7 = 1.0f;
        } else {
            ...
            if (text instanceof Spanned) {
                ...
                if (clickableSpanArr != null && clickableSpanArr.length > 0 && m20Var.f35442x < 1.0f) {
        ...
        if ((rectF2.contains(motionEvent.getX(), motionEvent.getY()) || this.D0) && !m20Var.f35436c.K1 && isClickable && m20Var.f35442x < f7) {
        ...
        if ((rectF2.contains(motionEvent.getX(), motionEvent.getY()) || this.F0) && !m20Var.f35436c.K1 && m20Var.f35442x < f7) {
