...
public final class bj1 extends org.telegram.ui.Components.wl0 {
    public final WallpapersListActivity E;
    public final Context f32436c;
    public final ArrayList d = new ArrayList();
    public final HashMap e = new HashMap();
    public boolean f32437f = true;
    public String h;
    ...
    public final void E(String str, boolean z10) {
        int i10;
        if (str != null && this.f32438n != null) {
            str = a4.a.r(this.f32438n, " ", str, new StringBuilder("#color"));
        }
        p81 p81Var = this.f32443y;
        if (p81Var != null) {
        ...
        if (isEmpty) {
            ...
            if (this.f32440s != 0) {
                ...
                ConnectionsManager.getInstance(i10).cancelRequest(this.f32440s, true);
                this.f32440s = 0;
            }
    ...
    public final void F(String str, String str2, boolean z10) {
        ...
        int i17;
        int i18;
        int i19 = this.f32440s;
        WallpapersListActivity wallpapersListActivity = this.E;
        if (i19 != 0) {
            i18 = ((org.telegram.ui.ActionBar.m2) wallpapersListActivity).currentAccount;
            ConnectionsManager.getInstance(i18).cancelRequest(this.f32440s, true);
            this.f32440s = 0;
        }
        this.f32442x = str;
        i10 = ((org.telegram.ui.ActionBar.m2) wallpapersListActivity).currentAccount;
        ...
        this.f32440s = ConnectionsManager.getInstance(i13).sendRequest(tL_messages_getInlineBotResults, new ai.i8(this, i20, 7));
