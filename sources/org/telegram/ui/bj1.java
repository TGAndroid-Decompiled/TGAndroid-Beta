...
public final class bj1 implements org.telegram.ui.ActionBar.a2, oy {
    ...
    public void f(org.telegram.ui.ActionBar.b2 b2Var, int i10) {
        ...
        for (int i12 = 0; i12 < longSparseArray.size(); i12++) {
            ...
            if (valueAt instanceof gj1) {
                ...
                TLRPC.WallPaper wallPaper = gj1Var.f33875l;
                if (wallPaper != null && wallPaper.f18261id < 0) {
                    wallpapersListActivity.getMessagesStorage().deleteWallpaper(gj1Var.f33875l.f18261id);
                    wallpapersListActivity.f31628f0.remove(gj1Var);
                    wallpapersListActivity.f31625d0.remove(gj1Var.a());
                } else {
                    valueAt = wallPaper;
                }
            }
            if (valueAt instanceof TLRPC.WallPaper) {
                ...
                if (valueAt instanceof TLRPC.TL_wallPaperNoFile) {
                    ...
                    tL_inputWallPaperNoFile.f18182id = wallPaper2.f18261id;
                    savewallpaper.wallpaper = tL_inputWallPaperNoFile;
                } else {
                    TLRPC.TL_inputWallPaper tL_inputWallPaper = new TLRPC.TL_inputWallPaper();
                    tL_inputWallPaper.f18181id = wallPaper2.f18261id;
    ...
    public boolean u(uy uyVar, ArrayList arrayList, CharSequence charSequence, boolean z10, boolean z11, int i10, int i11, eg1 eg1Var) {
        ...
        int i17;
        String b10;
        WallpapersListActivity wallpapersListActivity = this.f32208a.f33039a;
        StringBuilder sb2 = new StringBuilder();
        int i18 = 0;
        while (true) {
            longSparseArray = wallpapersListActivity.f31631i0;
