...
public final class bj1 implements org.telegram.ui.ActionBar.a2, oy {
    ...
    public void g(org.telegram.ui.ActionBar.b2 b2Var, int i10) {
        ...
        for (int i12 = 0; i12 < longSparseArray.size(); i12++) {
            ...
            if (valueAt instanceof gj1) {
                ...
                TLRPC.WallPaper wallPaper = gj1Var.f36707l;
                if (wallPaper != null && wallPaper.f20021id < 0) {
                    wallpapersListActivity.getMessagesStorage().deleteWallpaper(gj1Var.f36707l.f20021id);
                    wallpapersListActivity.f34263f0.remove(gj1Var);
                    wallpapersListActivity.f34259d0.remove(gj1Var.a());
                } else {
                    valueAt = wallPaper;
                }
            }
    ...
    public boolean u(uy uyVar, ArrayList arrayList, CharSequence charSequence, boolean z10, boolean z11, int i10, int i11, eg1 eg1Var) {
        ...
        int i17;
        String b10;
        WallpapersListActivity wallpapersListActivity = this.f34824a.f35810a;
        StringBuilder sb2 = new StringBuilder();
        int i18 = 0;
        while (true) {
            longSparseArray = wallpapersListActivity.f34266i0;
