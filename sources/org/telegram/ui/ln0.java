    ...
    public final void run() {
        switch (this.f35389a) {
            ...
            case 1:
                ...
                return;
            case 2:
                oo0 oo0Var2 = this.f35390b;
                oo0Var2.getMessagesController().newMessageCallback = null;
                if (oo0Var2.f36292f1 == 3 && !oo0Var2.isFinishing()) {
                    oo0Var2.f36292f1 = 4;
                    ...
                    return;
                } else if (oo0Var2.f36292f1 == 1 && !oo0Var2.isFinishing()) {
                    oo0Var2.finishFragment();
                    return;
                } else {
                    return;
            ...
            default:
                oo0 oo0Var3 = this.f35390b;
                if (oo0Var3.f36286d0 != null) {
                    oo0Var3.w0();
                    oo0Var3.f36286d0 = null;
                    return;
                }
                return;
        }
