...
public final class nz extends LinearLayout {
    public final org.telegram.ui.ActionBar.f6 f36178a;
    public final FrameLayout f36179b;
    public final org.telegram.ui.Components.u9 f36180c;
    public final FrameLayout d;
    public final FrameLayout e;
    public final org.telegram.ui.Components.u9 f36181f;
    public final FrameLayout h;
    public ValueAnimator f36182n;
    ...
    public nz(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        int i12 = org.telegram.ui.ActionBar.j6.f18916g6;
    ...
    public final void a(boolean z10, boolean z11) {
        ...
        float f21;
        float f22;
        ValueAnimator valueAnimator = this.f36182n;
        if (valueAnimator != null) {
            valueAnimator.cancel();
            this.f36182n = null;
        }
        org.telegram.ui.Components.u9 u9Var = this.f36181f;
        org.telegram.ui.Components.u9 u9Var2 = this.f36180c;
        ...
        if (z11) {
            ...
            float f24 = this.f36183r;
            if (!z10) {
                f23 = 0.0f;
            }
            ValueAnimator ofFloat = ValueAnimator.ofFloat(f24, f23);
            this.f36182n = ofFloat;
            ofFloat.addUpdateListener(new b3(this, 10));
            this.f36182n.addListener(new org.telegram.ui.Components.aa(27, this, z10));
            this.f36182n.setInterpolator(qrVar);
            this.f36182n.setDuration(320L);
            this.f36182n.start();
        } else {
            ...
            org.telegram.ui.ActionBar.f6 f6Var = this.f36178a;
            int v02 = org.telegram.ui.ActionBar.j6.v0(i10, f6Var);
            int i11 = org.telegram.ui.ActionBar.j6.Oh;
            int d = i0.a.d(this.f36183r, v02, org.telegram.ui.ActionBar.j6.v0(i11, f6Var));
            PorterDuff.Mode mode = PorterDuff.Mode.SRC_IN;
            u9Var2.setColorFilter(new PorterDuffColorFilter(d, mode));
            u9Var2.invalidate();
            u9Var.setColorFilter(new PorterDuffColorFilter(i0.a.d(1.0f - this.f36183r, org.telegram.ui.ActionBar.j6.v0(i10, f6Var), org.telegram.ui.ActionBar.j6.v0(i11, f6Var)), mode));
            u9Var.invalidate();
        }
        if (z10) {
            u9Var = u9Var2;
