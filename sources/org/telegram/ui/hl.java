    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        switch (this.M0) {
            case 3:
                ...
                if (isFocusable()) {
                    if (profileActivity.h != null || profileActivity.f31613n != null) {
                        StringBuilder sb2 = new StringBuilder(getText());
                        if (profileActivity.f31613n != null) {
                            if (sb2.length() > 0) {
                                sb2.append(", ");
                            }
                            sb2.append(profileActivity.f31613n);
                        }
        ...
        switch (this.M0) {
            case 0:
                ...
                if (this == wnVar.D2[0] && wnVar.H2[1] != null) {
                    if (wnVar.O4 && f7 < 0.0f) {
                        wnVar.f39721z2.setTranslationY(f7 / 2.0f);
                        return;
                    } else {
                        wnVar.f39721z2.setTranslationY(0.0f);
                        return;
                    }
                }
                return;
