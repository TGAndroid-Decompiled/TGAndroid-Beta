...
public class g7 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public long L;
    public v01 M;
    public final org.telegram.ui.Components.w9 f20318a;
    public final ai.p4 f20319b;
    public final org.telegram.ui.ActionBar.j5 f20320c;
    public final np d;
    public final e7 e;
    public f7 f20321f;
    public TLRPC.User h;
    public final int f20322n;
    public float f20323r;
    public long f20324s;
    public long v;
    public boolean f20325w;
    public final int f20326x;
    public final org.telegram.ui.ActionBar.e6 f20327y;
    ...
    public g7(Context context, int i10, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        float f10;
        float f11;
        this.f20326x = UserConfig.selectedAccount;
        qr qrVar = qr.h;
        ...
        setBackground(org.telegram.ui.ActionBar.j6.Y(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19152i6, e6Var), AndroidUtilities.dp(2.0f), AndroidUtilities.dp(2.0f)));
    }
    ...
    public final void c(long j3, boolean z10, CharSequence charSequence) {
        ...
        e7 e7Var = this.e;
        e7Var.f24604p = 1.0f;
        org.telegram.ui.ActionBar.e6 e6Var = this.f20327y;
        org.telegram.ui.Components.w9 w9Var = this.f20318a;
        ai.p4 p4Var = this.f20319b;
        if (j3 == Long.MAX_VALUE) {
            p4Var.setText(a());
            if (this.f20321f == null) {
                this.f20321f = new f7(getContext(), w9Var, true, e6Var);
            }
            w9Var.h(null, null, this.f20321f, null);
        } else {
            ...
            if (isUserDialog) {
                ...
                p4Var.setTextColor(org.telegram.ui.ActionBar.j6.v0(i10, e6Var));
                e6Var3.a(this.F);
                if (this.H > 0) {
                    z11 = true;
                } else {
    ...
    public final void d(TLRPC.TL_forumTopic tL_forumTopic, boolean z10, boolean z11) {
        ...
        org.telegram.ui.ActionBar.j5 j5Var = this.f20320c;
        ...
        if (z12) {
            if (z10) {
                j5Var.l(MessagesController.getInstance(this.f20326x).getPeerName(DialogObject.getPeerDialogId(tL_forumTopic.from_id)), false);
            } else {
        ...
        if (z11) {
            ...
            kVar2.b(new o1.g() {
                ...
                public final void a(o1.h hVar, float f11, float f12) {
                    ...
                    g7 g7Var = g7.this;
                    org.telegram.ui.ActionBar.j5 j5Var2 = g7Var.f20320c;
                    j5Var2.setAlpha(f13);
                    ai.p4 p4Var = g7Var.f20319b;
                    float f14 = 1.0f - f13;
                    p4Var.setAlpha(f14);
            ...
            kVar2.a(new o1.f() {
                ...
                public final void a(o1.h hVar, boolean z14, float f11, float f12) {
                    g7.this.f20320c.setTag(R.id.spring_tag, null);
                }
            });
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.userIsPremiumBlockedUpadted) {
            ...
            if (user != null) {
                requirementToContact = MessagesController.getInstance(i13).isUserContactBlocked(this.h.f18443id);
            } else {
            ...
            if (this.F != DialogObject.isPremiumBlocked(requirementToContact) || this.H != messagesStarsPrice) {
                ...
                this.f20319b.setTextColor(org.telegram.ui.ActionBar.j6.v0(i12, this.f20327y));
                invalidate();
            }
        }
    }
    ...
    public final void onAttachedToWindow() {
        ...
        NotificationCenter.getInstance(this.f20326x).addObserver(this, NotificationCenter.userIsPremiumBlockedUpadted);
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        NotificationCenter.getInstance(this.f20326x).removeObserver(this, NotificationCenter.userIsPremiumBlockedUpadted);
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        org.telegram.ui.ActionBar.j6.f19258o0.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.B5, this.f20327y));
        org.telegram.ui.ActionBar.j6.f19258o0.setAlpha((int) (this.d.getProgress() * 255.0f));
        if (this.f20322n == 2) {
            f7 = 24.0f;
        } else {
            f7 = 28.0f;
        ...
        canvas.drawRoundRect(rectF, w9Var.getRoundRadius()[0], w9Var.getRoundRadius()[0], org.telegram.ui.ActionBar.j6.f19258o0);
        super.onDraw(canvas);
    }
