...
public final class y6 extends FrameLayout {
    public final TextView f21881a;
    public final TextView f21882b;
    public final ImageView f21883c;
    public boolean d;
    public int e;
    ...
    public y6(Context context) {
        ...
        imageView.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19223m6, false), PorterDuff.Mode.MULTIPLY));
        if (LocaleController.isRTL) {
            i14 = 5;
        } else {
            i14 = 3;
    ...
    public final void a(CharSequence charSequence, String[] strArr, boolean z10, boolean z11) {
        TextView textView = this.f21881a;
        FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) textView.getLayoutParams();
        TextView textView2 = this.f21882b;
        if (z10) {
            ...
            if (strArr != null) {
                ...
                for (int i11 = 0; i11 < strArr.length; i11++) {
                    if (i11 != 0) {
                        ...
                        mutate2.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19461z6, false), PorterDuff.Mode.MULTIPLY));
    ...
    public final void b(CharSequence charSequence, String[] strArr, int i10, boolean z10) {
        ...
        ImageView imageView = this.f21883c;
        if (i10 != 0) {
