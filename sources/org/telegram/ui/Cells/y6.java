...
public final class y6 extends FrameLayout {
    ...
    public y6(Context context) {
        ...
        this.f21848c = imageView;
        imageView.setScaleType(ImageView.ScaleType.CENTER);
        imageView.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19227m6, false), PorterDuff.Mode.MULTIPLY));
        if (LocaleController.isRTL) {
            i14 = 5;
        } else {
            i14 = 3;
            ...
            if (strArr != null) {
                ...
                for (int i11 = 0; i11 < strArr.length; i11++) {
                    if (i11 != 0) {
                        ...
                        mutate2.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19464z6, false), PorterDuff.Mode.MULTIPLY));
    ...
    public final void b(CharSequence charSequence, String[] strArr, int i10, boolean z10) {
        ...
        ImageView imageView = this.f21848c;
        if (i10 != 0) {
