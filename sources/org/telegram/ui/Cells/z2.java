...
public final class z2 extends FrameLayout {
    public final LinearLayout f21664a;
    public final LinearLayout f21665b;
    public final org.telegram.ui.Components.y5 f21666c;
    public final d90 d;
    public final ImageView e;
    public final ImageView f21667f;
    public final org.telegram.ui.Components.w9 h;
    public final org.telegram.ui.Components.k9 f21668n;
    ...
    public final void a(int i10, ArrayList arrayList) {
        ...
        org.telegram.ui.Components.k9 k9Var = this.f21668n;
        if (min != k9Var.f25558a.f25209n) {
            z10 = true;
        } else {
            z10 = false;
        }
        ...
        if (min <= 1) {
            ...
            dp = AndroidUtilities.dp(hg.c.g(min, 1, 18, 30));
        }
        layoutParams.width = dp;
        if (z10) {
            this.f21664a.requestLayout();
        }
        if (arrayList != null) {
    ...
    public final void c(CharSequence charSequence, CharSequence charSequence2, boolean z10, boolean z11) {
        ...
        org.telegram.ui.Components.y5 y5Var = this.f21666c;
        ...
        this.f21665b.setPadding(i13, 0, i12, 0);
        d();
    }
    ...
    public final void d() {
        ...
        this.f21666c.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, i10, false));
        ...
        imageView.setBackground(org.telegram.ui.ActionBar.x5.c(null, org.telegram.ui.ActionBar.x5.b(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.x5.f19674a, false))));
    }

    @Override
    public final void onMeasure(int i10, int i11) {
        super.onMeasure(i10, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.displaySize.y, Integer.MIN_VALUE));
        LinearLayout linearLayout = this.f21665b;
        ...
        this.f21667f.setTranslationY((getPaddingBottom() - getPaddingTop()) / 2.0f);
        this.f21668n.setTranslationY((getPaddingBottom() - getPaddingTop()) / 2.0f);
