...
public final class z2 extends FrameLayout {
    ...
    public final LinearLayout f21694b;
    public final org.telegram.ui.Components.w5 f21695c;
    public final c90 d;
    public final ImageView e;
    public final ImageView f21696f;
    public final org.telegram.ui.Components.u9 h;
    public final org.telegram.ui.Components.i9 f21697n;
    ...
    public final void a(int i10, ArrayList arrayList) {
        ...
        org.telegram.ui.Components.i9 i9Var = this.f21697n;
        if (min != i9Var.f24900a.f24592n) {
            z10 = true;
        } else {
            z10 = false;
        }
    ...
    public final void c(CharSequence charSequence, CharSequence charSequence2, boolean z10, boolean z11) {
        ...
        org.telegram.ui.Components.w5 w5Var = this.f21695c;
        ...
        this.f21694b.setPadding(i13, 0, i12, 0);
        d();
    }
    ...
    public final void d() {
        ...
        this.f21695c.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i10, false));
        ...
        ImageView imageView = this.f21696f;
        imageView.setColorFilter(w04, mode);
        imageView.setBackground(org.telegram.ui.ActionBar.z5.c(null, org.telegram.ui.ActionBar.z5.b(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.z5.f19761a, false))));
    }

    @Override
    public final void onMeasure(int i10, int i11) {
        super.onMeasure(i10, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.displaySize.y, Integer.MIN_VALUE));
        LinearLayout linearLayout = this.f21694b;
        ...
        this.f21696f.setTranslationY((getPaddingBottom() - getPaddingTop()) / 2.0f);
        this.f21697n.setTranslationY((getPaddingBottom() - getPaddingTop()) / 2.0f);
