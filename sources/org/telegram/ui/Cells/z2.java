...
public final class z2 extends FrameLayout {
    ...
    public final org.telegram.ui.Components.w5 f21679c;
    public final c90 d;
    public final ImageView e;
    public final ImageView f21680f;
    public final org.telegram.ui.Components.u9 h;
    public final org.telegram.ui.Components.i9 f21681n;
    ...
    public final void a(int i10, ArrayList arrayList) {
        ...
        org.telegram.ui.Components.i9 i9Var = this.f21681n;
        if (min != i9Var.f24972a.f24628n) {
            z10 = true;
        } else {
            z10 = false;
        }
    ...
    public final void c(CharSequence charSequence, CharSequence charSequence2, boolean z10, boolean z11) {
        ...
        org.telegram.ui.Components.w5 w5Var = this.f21679c;
        ...
        this.f21678b.setPadding(i13, 0, i12, 0);
        d();
    }
    ...
    public final void d() {
        ...
        this.f21679c.setTextColor(org.telegram.ui.ActionBar.i6.w0(null, i10, false));
        ...
        ImageView imageView = this.f21680f;
        imageView.setColorFilter(w04, mode);
        imageView.setBackground(org.telegram.ui.ActionBar.y5.c(null, org.telegram.ui.ActionBar.y5.b(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.y5.f19729a, false))));
    }

    @Override
    public final void onMeasure(int i10, int i11) {
        super.onMeasure(i10, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.displaySize.y, Integer.MIN_VALUE));
        LinearLayout linearLayout = this.f21678b;
        ...
        this.f21680f.setTranslationY((getPaddingBottom() - getPaddingTop()) / 2.0f);
        this.f21681n.setTranslationY((getPaddingBottom() - getPaddingTop()) / 2.0f);
