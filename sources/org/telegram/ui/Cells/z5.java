...
public final class z5 extends FrameLayout {
    ...
    public final void onAttachedToWindow() {
        ...
        this.f21910c.b(org.telegram.ui.ActionBar.h6.W9, org.telegram.ui.ActionBar.h6.X9, org.telegram.ui.ActionBar.h6.V9);
    }

    @Override
    public final void onMeasure(int i10, int i11) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(this.f21911f + this.h, 1073741824), View.MeasureSpec.makeMeasureSpec(this.f21911f, 1073741824));
    }

    public void setImage(MediaController.PhotoEntry photoEntry) {
        org.telegram.ui.t5 t5Var = this.e;
        org.telegram.ui.Components.w9 w9Var = this.f21908a;
