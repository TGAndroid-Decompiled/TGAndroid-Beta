...
public final class z5 extends FrameLayout {
    ...
    public z5(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.f21700b = textView2;
        wl.n(org.telegram.ui.ActionBar.j6.f19264z6, f6Var, textView2, 1, 13.0f);
        if (LocaleController.isRTL) {
            i13 = 5;
        } else {
            i13 = 3;
    ...
    public final void a(String str, String str2, int i10, int i11, boolean z10) {
        ...
        qb0Var.b(i12, i13);
        qb0Var.f27262b = q6;
        ImageView imageView = this.f21701c;
        imageView.setBackground(qb0Var);
        imageView.setImageResource(i11);
        boolean z11 = this.e;
        Switch r02 = this.d;
        r02.b(0, z10, z11);
        this.f21700b.setText(str2);
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        sb2.append(this.f21699a.getText());
    ...
    public void setValue(CharSequence charSequence) {
        this.f21700b.setText(charSequence);
    }
}
