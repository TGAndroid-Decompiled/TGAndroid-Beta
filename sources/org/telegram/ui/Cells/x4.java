...
public class x4 extends FrameLayout {
    public final org.telegram.ui.ActionBar.j5 f23554a;
    public final org.telegram.ui.ActionBar.j5 f23555b;
    ...
    public x4(Context context) {
        ...
        imageView.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20854m6, false), PorterDuff.Mode.MULTIPLY));
        addView(imageView);
    }

    public final void a(int i10, int i11) {
        int w02 = org.telegram.ui.ActionBar.j6.w0(null, i11, false);
        org.telegram.ui.ActionBar.j5 j5Var = this.f23554a;
        ...
        ImageView imageView = this.f23556c;
        imageView.setColorFilter(porterDuffColorFilter);
        imageView.setTag(Integer.valueOf(i10));
    }

    public final void b(String str, int i10, int i11, boolean z10) {
        this.f23554a.l(str, false);
        this.f23555b.setVisibility(4);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.d) {
            ...
            if (i10 != 0) {
                org.telegram.ui.ActionBar.j6.f20832l0.setColor(org.telegram.ui.ActionBar.j6.w0(null, i10, false));
            }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        int i15 = i13 - i11;
        int i16 = i12 - i10;
        org.telegram.ui.ActionBar.j5 j5Var = this.f23555b;
        ...
        org.telegram.ui.ActionBar.j5 j5Var2 = this.f23554a;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f23555b.measure(wl.d(24.0f, size, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), 1073741824));
        this.f23554a.measure(wl.d(95.0f, size, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), 1073741824));
        this.f23556c.measure(View.MeasureSpec.makeMeasureSpec(size, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(dp, Integer.MIN_VALUE));
