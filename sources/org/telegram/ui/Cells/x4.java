...
public class x4 extends FrameLayout {
    public final org.telegram.ui.ActionBar.k5 f22542a;
    public final org.telegram.ui.ActionBar.k5 f22543b;
    public final ImageView f22544c;
    public boolean d;
    public int e;
    ...
    public x4(Context context) {
        ...
        imageView.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20042m6, false), PorterDuff.Mode.MULTIPLY));
        addView(imageView);
    }

    public final void a(int i10, int i11) {
        int w02 = org.telegram.ui.ActionBar.j6.w0(null, i11, false);
        org.telegram.ui.ActionBar.k5 k5Var = this.f22542a;
    ...
    public final void b(String str, int i10, int i11, boolean z4) {
        this.f22542a.l(str, false);
        this.f22543b.setVisibility(4);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.d) {
            int i10 = this.e;
            if (i10 != 0) {
                org.telegram.ui.ActionBar.j6.f20019l0.setColor(org.telegram.ui.ActionBar.j6.w0(null, i10, false));
            }
    ...
    public final void onLayout(boolean z4, int i10, int i11, int i12, int i13) {
        ...
        int i15 = i13 - i11;
        int i16 = i12 - i10;
        org.telegram.ui.ActionBar.k5 k5Var = this.f22543b;
        ...
        org.telegram.ui.ActionBar.k5 k5Var2 = this.f22542a;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f22543b.measure(org.telegram.ui.b.d(24.0f, size, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), 1073741824));
        this.f22542a.measure(org.telegram.ui.b.d(95.0f, size, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), 1073741824));
        this.f22544c.measure(View.MeasureSpec.makeMeasureSpec(size, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(dp, Integer.MIN_VALUE));
