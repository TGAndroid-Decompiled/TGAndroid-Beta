...
public class x4 extends FrameLayout {
    public final org.telegram.ui.ActionBar.j5 f23555a;
    public final org.telegram.ui.ActionBar.j5 f23556b;
    ...
    public x4(Context context) {
        ...
        this.f23557c = imageView;
        imageView.setScaleType(ImageView.ScaleType.CENTER);
        imageView.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20855m6, false), PorterDuff.Mode.MULTIPLY));
        addView(imageView);
    }

    public final void a(int i10, int i11) {
        int w02 = org.telegram.ui.ActionBar.j6.w0(null, i11, false);
        org.telegram.ui.ActionBar.j5 j5Var = this.f23555a;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.d) {
            ...
            if (i10 != 0) {
                org.telegram.ui.ActionBar.j6.f20833l0.setColor(org.telegram.ui.ActionBar.j6.w0(null, i10, false));
            }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        int i15 = i13 - i11;
        int i16 = i12 - i10;
        org.telegram.ui.ActionBar.j5 j5Var = this.f23556b;
        ...
        org.telegram.ui.ActionBar.j5 j5Var2 = this.f23555a;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f23556b.measure(vl.d(24.0f, size, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), 1073741824));
        this.f23555a.measure(vl.d(95.0f, size, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), 1073741824));
        this.f23557c.measure(View.MeasureSpec.makeMeasureSpec(size, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(dp, Integer.MIN_VALUE));
