...
public final class u3 extends FrameLayout implements org.telegram.ui.ActionBar.z5 {
    public final org.telegram.ui.Components.y5 f23317a;
    public final t3 f23318b;
    public final FrameLayout.LayoutParams f23319c;
    ...
    public final void c(CharSequence charSequence, CharSequence charSequence2, View.OnClickListener onClickListener) {
        this.f23317a.setText(charSequence);
        t3 t3Var = this.f23318b;
    ...
    public final void d() {
        ...
        int i10 = org.telegram.ui.ActionBar.j6.f7;
        this.f23317a.setTextColor(org.telegram.ui.ActionBar.j6.v0(i10, f6Var));
        this.f23318b.setTextColor(org.telegram.ui.ActionBar.j6.v0(i10, f6Var));
    }
    ...
    public final void onMeasure(int i10, int i11) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i10), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(this.f23320e), 1073741824));
    }
    ...
    public void setRightTextMargin(int i10) {
        ...
        FrameLayout.LayoutParams layoutParams = this.f23319c;
        layoutParams.leftMargin = dp;
        layoutParams.rightMargin = AndroidUtilities.dp(f7);
        this.f23318b.setLayoutParams(layoutParams);
    }
    ...
    public void setTextColor(int i10) {
        ...
        this.f23317a.setTextColor(v02);
        this.f23318b.setTextColor(v02);
    }
