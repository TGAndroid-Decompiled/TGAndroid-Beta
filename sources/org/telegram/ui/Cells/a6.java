...
public final class a6 extends FrameLayout {
    ...
    public a6(Context context, org.telegram.ui.ActionBar.g6 g6Var) {
        ...
        org.telegram.ui.b.l(org.telegram.ui.ActionBar.k6.f22053z6, g6Var, textView2, 1, 13.0f);
        if (LocaleController.isRTL) {
            i13 = 5;
        } else {
            i13 = 3;
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        sb.append(this.f22542a.getText());
        TextView textView = this.f22543b;
    ...
    public void setValue(CharSequence charSequence) {
        this.f22543b.setText(charSequence);
    }
}
