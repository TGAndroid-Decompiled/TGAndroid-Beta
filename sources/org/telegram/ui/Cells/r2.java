...
public class r2 extends a0 implements ai.r9, org.telegram.ui.ActionBar.y5 {
    ...
    public int Z2;
    public boolean Z3;
    public TextPaint f20633a0;
    public boolean f20634a1;
    public final org.telegram.ui.Components.h9 a2;
    public int f20635a3;
    public int f20636a4;
    public Paint f20637b0;
    public boolean f20638b1;
    public boolean f20639b2;
    public int f20640b3;
    public int f20641b4;
    public fd f20642c0;
    public float f20643c1;
    public float f20644c2;
    public int f20645c3;
    public int f20646c4;
    public n2 f20647d0;
    public boolean f20648d1;
    public final l2 f20649d2;
    public int f20650d3;
    public int f20651d4;
    public boolean f20652e0;
    public boolean f20653e1;
    public ji0 f20654e2;
    public StaticLayout f20655e3;
    public StaticLayout f20656e4;
    public boolean f20657f;
    public boolean f20658f0;
    public MessageObject f20659f1;
    public TLRPC.User f20660f2;
    public StaticLayout f20661f3;
    public boolean f20662f4;
    public boolean f20663g0;
    public ArrayList f20664g1;
    public TLRPC.Chat f20665g2;
    public int f20666g3;
    public boolean f20667g4;
    public final boolean h;
    public Drawable[] f20668h0;
    public boolean f20669h1;
    public TLRPC.EncryptedChat f20670h2;
    public StaticLayout f20671h3;
    public boolean f20672h4;
    public float f20673i0;
    public CharSequence f20674i1;
    public CharSequence f20675i2;
    public final Stack f20676i3;
    public final ci.bb f20677i4;
    public boolean f20678j0;
    public int f20679j1;
    public int f20680j2;
    public final ArrayList j3;
    public final org.telegram.ui.Components.o5 f20681j4;
    public boolean f20682k0;
    public int f20683k1;
    public boolean f20684k2;
    public final Stack f20685k3;
    public final org.telegram.ui.Components.o5 f20686k4;
    public int f20687l0;
    public int l1;
    public TLRPC.DraftMessage f20688l2;
    public final ArrayList f20689l3;
    public int l4;
    public float m0;
    public boolean f20690m1;
    public final org.telegram.ui.Components.e6 f20691m2;
    public org.telegram.ui.Components.v5 f20692m3;
    public boolean f20693m4;
    public float f20694n;
    public u11 f20695n0;
    public boolean f20696n1;
    public boolean f20697n2;
    public org.telegram.ui.Components.v5 f20698n3;
    public final RectF f20699n4;
    public Paint f20700o0;
    public float f20701o1;
    public final org.telegram.ui.Components.e6 f20702o2;
    public org.telegram.ui.Components.v5 f20703o3;
    public gg.j f20704o4;
    public Paint f20705p0;
    public float f20706p1;
    public long f20707p2;
    public org.telegram.ui.Components.v5 f20708p3;
    public Path f20709p4;
    public boolean f20710q0;
    public float f20711q1;
    public ci.p3 f20712q2;
    public int f20713q3;
    public RectF f20714q4;
    public boolean f20715r;
    public boolean f20716r0;
    public float f20717r1;
    public final boolean f20718r2;
    public int f20719r3;
    public int f20720r4;
    public yi0 f20721s;
    public boolean f20722s0;
    public int f20723s1;
    public boolean f20724s2;
    public StaticLayout f20725s3;
    public int f20726s4;
    public is f20727t0;
    public float f20728t1;
    public boolean f20729t2;
    public boolean f20730t3;
    public int f20731t4;
    public final j2 f20732u0;
    public int f20733u1;
    public boolean f20734u2;
    public int f20735u3;
    public float f20736u4;
    public int v;
    public Path f20737v0;
    public int f20738v1;
    public boolean f20739v2;
    public int f20740v3;
    public boolean f20741v4;
    public boolean f20742w;
    public vh.h f20743w0;
    public float f20744w1;
    public boolean f20745w2;
    public boolean f20746w3;
    public ValueAnimator f20747w4;
    public boolean f20748x;
    public boolean f20749x0;
    public boolean f20750x1;
    public int f20751x2;
    public float f20752x3;
    public long f20753x4;
    public boolean f20754y;
    public boolean f20755y0;
    public yi0 f20756y1;
    public int f20757y2;
    public boolean y3;
    public int f20758y4;
    public boolean f20759z0;
    public boolean f20760z1;
    public StaticLayout f20761z2;
    public boolean f20762z3;
    public final ry f20763z4;
    ...
    private MessageObject getCaptionMessage() {
        ...
        if (this.f20664g1 == null) {
            MessageObject messageObject = this.f20659f1;
        ...
        int i10 = 0;
        for (int i11 = 0; i11 < this.f20664g1.size(); i11++) {
            MessageObject messageObject3 = (MessageObject) this.f20664g1.get(i11);
    ...
    private Paint getPaintReorderGradient() {
        int v02 = org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f18789d6, this.F4);
    ...
    public final void E(Canvas canvas, boolean z10, int i10, int i11, int i12, float f7, boolean z11) {
        ...
        if ((this.G3 && this.H3) || this.R3 != 1.0f) {
            ...
            if (z11) {
                ...
                f11 = 1.0f;
                this.T.setColor(i0.a.d(Color.alpha(w02) / 255.0f, org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f18789d6, false), i0.a.k(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19066s9, false), 255)));
            } else {
                f11 = 1.0f;
            }
            if (this.P && this.N.read_inbox_max_id == 0) {
                ...
                if (!z10 && this.J0 == 0) {
                    paint = org.telegram.ui.ActionBar.h6.f19130w0;
                } else {
                    paint = org.telegram.ui.ActionBar.h6.f19165y0;
                }
                z13 = false;
            }
            StaticLayout staticLayout = this.U3;
            RectF rectF3 = this.f20699n4;
            if (staticLayout != null && this.S0 != 0) {
                paint.setAlpha((int) ((f11 - this.f20752x3) * i16));
                org.telegram.ui.ActionBar.h6.M0.setAlpha((int) ((f11 - this.f20752x3) * 255.0f));
                float f13 = f10 * 2.0f;
                if (f13 > f11) {
                    f12 = 1.0f;
                } else {
                ...
                if (f10 <= 0.5f) {
                    interpolation = rr.f27702g.getInterpolation(f13);
                } else {
                    interpolation = rr.f27703i.getInterpolation(f11 - ((f10 - 0.5f) * 2.0f));
                }
                ...
                if (z12) {
                    if (this.f20709p4 == null || (rectF2 = this.f20714q4) == null || !rectF2.equals(rectF3)) {
                        RectF rectF4 = this.f20714q4;
                        if (rectF4 == null) {
                            this.f20714q4 = new RectF(rectF3);
                        } else {
                            rectF4.set(rectF3);
                        }
                        if (this.f20709p4 == null) {
                            this.f20709p4 = new Path();
                        }
                        w7.j0.a(this.f20709p4, this.f20714q4, AndroidUtilities.dp(10.33f));
                    }
                    canvas.drawPath(this.f20709p4, paint);
                    if (z11) {
                        canvas.drawPath(this.f20709p4, this.T);
                    }
                } else {
                ...
                if (z12) {
                    if (this.f20709p4 == null || (rectF = this.f20714q4) == null || !rectF.equals(rectF3)) {
                        RectF rectF5 = this.f20714q4;
                        if (rectF5 == null) {
                            this.f20714q4 = new RectF(rectF3);
                        } else {
                            rectF5.set(rectF3);
    ...
    public final CharSequence G() {
        ...
        for (int i11 = 0; i11 < size; i11++) {
            ...
            if (!messagesController.isHiddenByUndo(dialog.f18087id)) {
                TLRPC.Chat chat = null;
                if (DialogObject.isEncryptedDialog(dialog.f18087id)) {
                    TLRPC.EncryptedChat l4 = org.telegram.messenger.z0.l(messagesController, dialog.f18087id);
                    if (l4 != null) {
                        user = messagesController.getUser(Long.valueOf(l4.user_id));
                    } else {
                        user = null;
                    }
                } else if (DialogObject.isUserDialog(dialog.f18087id)) {
                    user = messagesController.getUser(Long.valueOf(dialog.f18087id));
                } else {
                    chat = messagesController.getChat(Long.valueOf(-dialog.f18087id));
                    user = null;
                }
                if (chat != null) {
    ...
    public final CharSequence J() {
        ...
        q2.a(this.J4, this.F0, this.f20659f1, this.f20665g2);
        this.J4.getClass();
        q2 q2Var = this.J4;
        this.I4 = q2Var.f20590c;
        this.f20658f0 = q2Var.d;
        return q2Var.f20592g;
    }
    ...
    public final SpannableStringBuilder L(int i10, CharSequence charSequence, String str, boolean z10) {
        ...
        MessageObject messageObject2 = this.f20659f1;
        ...
        if (message2 instanceof TLRPC.TL_messageService) {
            ...
            if (MessageObject.isTopicActionMessage(messageObject2)) {
                ...
                if (this.f20659f1.topicIconDrawable[0] instanceof ng.a) {
                    int i12 = this.F0;
                    TLRPC.TL_forumTopic findTopic = MessagesController.getInstance(i12).getTopicsController().findTopic(-this.f20659f1.getDialogId(), MessageObject.getTopicId(i12, this.f20659f1.messageOwner, true));
                    if (findTopic != null) {
                        ((ng.a) this.f20659f1.topicIconDrawable[0]).b(findTopic.icon_color);
                    }
                }
            } else {
                this.f20652e0 = false;
            ...
            if (captionMessage.hasHighlightedWords() && !TextUtils.isEmpty(captionMessage.messageOwner.message)) {
                ...
                if (this.W) {
                    if (!TextUtils.isEmpty(charSequence)) {
                        measuredWidth = (int) (measuredWidth - this.f20633a0.measureText(charSequence.toString()));
                    }
                    measuredWidth = (int) (measuredWidth - this.f20633a0.measureText(": "));
                }
                if (measuredWidth > 0 && captionMessage.messageTrimmedToHighlightCut) {
                    charSequence7 = AndroidUtilities.ellipsizeCenterEnd(charSequence7, captionMessage.highlightedWords.get(0), measuredWidth, this.f20633a0, 130);
                }
            ...
            if (message3 != null) {
                ...
                TextPaint textPaint = this.f20633a0;
                if (textPaint != null) {
            ...
            if (richMessage != null) {
                if (richMessage.blocks.size() == 1) {
                    z11 = MessageObject.isBlueBlock(this.f20659f1.messageOwner.rich_message.blocks.get(0));
                } else {
                    z11 = false;
                }
                SpannableStringBuilder I = I(this.f20659f1.messageText, charSequence, i10);
                if (z11 && !Q()) {
                    try {
                        f10 f10Var = new f10(org.telegram.ui.ActionBar.h6.f19010p9, d6Var);
                        if (this.W) {
                ...
                this.f20633a0 = org.telegram.ui.ActionBar.h6.H0[this.E0];
                int i13 = org.telegram.ui.ActionBar.h6.o9;
                MessageObject messageObject3 = this.f20659f1;
                ...
                if (messageMedia instanceof TLRPC.TL_messageMediaPoll) {
                    ...
                    charSequence3 = q3.j("🎧 \u2068", messageObject3.getMusicAuthor(), " - ", this.f20659f1.getMusicTitle(), "\u2069");
                    ...
                    i13 = org.telegram.ui.ActionBar.h6.f19010p9;
                } else if (this.R1 > 1) {
                    if (this.S1) {
                        ArrayList arrayList2 = this.f20664g1;
                        if (arrayList2 == null) {
                            size2 = 0;
                        } else {
                        ...
                        ArrayList arrayList3 = this.f20664g1;
                        if (arrayList3 == null) {
                            size = 0;
                        } else {
                ...
                MessageObject messageObject4 = this.f20659f1;
                String str3 = messageObject4.messageOwner.message;
                if (str3 != null) {
                    if (messageObject4.hasHighlightedWords()) {
                        CharSequence charSequence9 = this.f20659f1.messageTrimmedToHighlight;
                        ...
                        if (this.W) {
                            if (!TextUtils.isEmpty(charSequence)) {
                                measuredWidth2 = (int) (measuredWidth2 - this.f20633a0.measureText(charSequence.toString()));
                            }
                            measuredWidth2 = (int) (measuredWidth2 - this.f20633a0.measureText(": "));
                        }
                        if (measuredWidth2 > 0) {
                            replaceNewLines = AndroidUtilities.ellipsizeCenterEnd(replaceNewLines, this.f20659f1.highlightedWords.get(0), measuredWidth2, this.f20633a0, 130);
                        }
                    } else {
                    ...
                    MessageObject messageObject5 = this.f20659f1;
                    if (messageObject5 != null) {
                        messageObject5.spoilLoginCode();
                    }
                    MediaDataController.addTextStyleRuns(this.f20659f1, (Spannable) spannableString4, 264);
                    MessageObject messageObject6 = this.f20659f1;
                    if (messageObject6 != null && (message = messageObject6.messageOwner) != null) {
                        ArrayList<TLRPC.MessageEntity> arrayList4 = message.entities;
                        TextPaint textPaint2 = this.f20633a0;
                        if (textPaint2 != null) {
    ...
    public final boolean M() {
        is isVar = this.f20727t0;
        if (isVar != null && !isVar.f25057c.isEmpty()) {
            return true;
        }
        return false;
    }
    ...
    public final boolean N() {
        if (ChatObject.isCommunity(this.f20665g2)) {
            return !this.f20653e1;
        }
        if (this.P) {
            return this.f20634a1;
        }
        TLRPC.Chat chat = this.f20665g2;
    ...
    public boolean Q() {
        TLRPC.Chat chat;
        if (!O() && !this.P0 && (chat = this.f20665g2) != null) {
            if ((chat.forum || (ChatObject.isMonoForum(chat) && ChatObject.canManageMonoForum(this.F0, this.f20665g2))) && !this.P) {
                return true;
            }
            return false;
        }
    ...
    public final boolean R() {
        TLRPC.User user;
        if (!Q() && !this.f20732u0.f674w && (user = this.f20660f2) != null && !user.self) {
            TLRPC.UserStatus userStatus = user.status;
            int i10 = this.F0;
            if (userStatus == null || userStatus.expires > 0 || !MessagesController.getInstance(i10).onlinePrivacy.containsKey(Long.valueOf(this.f20660f2.f18230id))) {
                TLRPC.UserStatus userStatus2 = this.f20660f2.status;
    ...
    public final void U() {
        ...
        this.f20728t1 = 0.0f;
        this.f20750x1 = false;
        this.f20752x3 = (getIsPinned() && this.y3) ? 0.0f : 0.0f;
        this.f20746w3 = true;
        this.f20701o1 = 0.0f;
        setTranslationX(0.0f);
        setTranslationY(0.0f);
        org.telegram.ui.Components.o5 o5Var = this.f20681j4;
        if (o5Var != null && this.f20746w3) {
            o5Var.a();
        }
        org.telegram.ui.Components.o5 o5Var2 = this.f20686k4;
        if (o5Var2 != null && this.f20746w3) {
            o5Var2.a();
        }
    }

    public final void V(boolean z10, boolean z11) {
        ci.p3 p3Var = this.f20712q2;
        if (p3Var == null && !z10) {
            return;
        }
        if (p3Var == null) {
            ci.p3 p3Var2 = new ci.p3(this, getContext(), this.F4, 1);
            this.f20712q2 = p3Var2;
            p3Var2.b(-1, org.telegram.ui.ActionBar.h6.f18789d6, org.telegram.ui.ActionBar.h6.f18917k7);
            this.f20712q2.setDrawUnchecked(false);
            this.f20712q2.setDrawBackgroundAsArc(3);
            addView(this.f20712q2);
        }
        this.f20712q2.a(z10, z11);
        x();
    }
    ...
    public final void W(long j3, MessageObject messageObject, int i10, boolean z10, boolean z11) {
        ...
        this.H0 = j3;
        this.f20753x4 = System.currentTimeMillis();
        this.f20659f1 = messageObject;
        this.f20734u2 = z10;
        this.N0 = false;
        this.R0 = i10;
        if (messageObject != null) {
    ...
    public final void X(TLRPC.Dialog dialog, int i10, int i11) {
        boolean z10;
        if (this.H0 != dialog.f18087id) {
            ValueAnimator valueAnimator = this.f20747w4;
            if (valueAnimator != null) {
                valueAnimator.removeAllListeners();
                this.f20747w4.cancel();
            }
            this.f20741v4 = false;
            this.f20731t4 = -1;
        }
        this.H0 = dialog.f18087id;
        this.f20753x4 = System.currentTimeMillis();
        boolean z11 = true;
        this.N0 = true;
        ...
        if (dialog instanceof TLRPC.TL_dialogFolder) {
            this.J0 = ((TLRPC.TL_dialogFolder) dialog).folder.f18134id;
            ji0 ji0Var = this.f20654e2;
            if (ji0Var != null) {
                ji0Var.H = this;
                ji0Var.i();
            }
        ...
        if (this.f20727t0 == null) {
            this.f20727t0 = new is(this);
        }
        this.f20683k1 = i11;
        this.l1 = 0;
        if (b0(0, false)) {
    ...
    public final void Y(TLRPC.TL_forumTopic tL_forumTopic, long j3, MessageObject messageObject, boolean z10, boolean z11) {
        ...
        if (tL_forumTopic != null) {
            this.f20664g1 = tL_forumTopic.groupedMessages;
        }
        TLRPC.TL_forumTopic tL_forumTopic2 = this.N;
        if (tL_forumTopic2 != null && tL_forumTopic2.f18135id == 1 && (ji0Var = this.f20654e2) != null) {
            ji0Var.H = this;
            ji0Var.i();
        }
        b0(0, z11);
    ...
    public final void a0() {
        ...
        if (ji0Var != null) {
            if (this.P) {
                ...
                this.f20654e2.L = AndroidUtilities.dp(24.0f);
                this.f20654e2.M = 0.0f;
            } else {
                j2 j2Var = this.f20732u0;
                RectF rectF = j2Var.F;
                RectF rectF2 = j2Var.F;
                ji0Var.K = rectF.centerY();
                this.f20654e2.L = rectF2.centerX();
                this.f20654e2.M = rectF2.width() / 2.0f;
                if (!MessagesController.getInstance(this.F0).getStoriesController().h.isEmpty()) {
                    this.f20654e2.M -= AndroidUtilities.dpf2(3.5f);
                }
                ji0 ji0Var2 = this.f20654e2;
                this.Y1.getBitmapWidth();
                ji0Var2.getClass();
            }
            ji0 ji0Var3 = this.f20654e2;
    ...
    public final void d0(boolean z10) {
        ...
        boolean z11;
        if (this.V4 != null && this.f20660f2 != null) {
            requirementToContact = MessagesController.getInstance(this.F0).isUserContactBlocked(this.f20660f2.f18230id);
        } else {
            requirementToContact = null;
        }
        if (this.f20697n2 == DialogObject.isPremiumBlocked(requirementToContact) && this.f20707p2 == DialogObject.getMessagesStarsPrice(requirementToContact)) {
            return;
        }
        this.f20697n2 = DialogObject.isPremiumBlocked(requirementToContact);
        this.f20707p2 = DialogObject.getMessagesStarsPrice(requirementToContact);
        if (!z10) {
            this.f20691m2.f(this.f20697n2, true);
            if (this.f20707p2 > 0) {
                z11 = true;
            } else {
                z11 = false;
            }
            this.f20702o2.f(z11, true);
        }
        invalidate();
    }
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        if ((!this.P && !this.F && motionEvent.getAction() == 1) || motionEvent.getAction() == 3) {
            this.f20732u0.a(motionEvent, this);
        }
    ...
    public final void e0() {
        ...
        if (this.R1 > 0) {
            if (Q()) {
                staticLayout = this.f20671h3;
            } else {
                staticLayout = this.f20655e3;
            }
            if (Q()) {
                i10 = this.f20645c3;
            } else {
                ...
                try {
                    ...
                    if (text instanceof Spanned) {
                        ...
                        if (p2VarArr != null && p2VarArr.length > 0) {
                            ...
                            if (ceil != 0 && !this.f20749x0 && !this.f20755y0) {
    ...
    public long getStarsPrice() {
        return this.f20707p2;
    }

    @Override
    public float getTranslationX() {
        return this.f20744w1;
    }
    ...
    public final void invalidateDrawable(Drawable drawable) {
        if (drawable != this.f20756y1 && drawable != org.telegram.ui.ActionBar.h6.f19095u1) {
    ...
    public void onAttachedToWindow() {
        ...
        U();
        this.f20692m3 = org.telegram.ui.Components.z5.update(0, this, this.f20692m3, this.f20655e3);
        this.f20698n3 = org.telegram.ui.Components.z5.update(0, this, this.f20698n3, this.f20725s3);
        this.f20703o3 = org.telegram.ui.Components.z5.update(0, this, this.f20703o3, this.f20671h3);
        this.f20708p3 = org.telegram.ui.Components.z5.update(0, this, this.f20708p3, this.f20761z2);
        org.telegram.ui.Components.o5 o5Var = this.f20681j4;
        if (o5Var != null) {
            o5Var.a();
        }
    ...
    public void onDetachedFromWindow() {
        ...
        yi0 yi0Var = this.f20756y1;
        if (yi0Var != null) {
            yi0Var.stop();
            this.f20756y1.T(0.0f, true);
            this.f20756y1.setCallback(null);
            this.f20756y1 = null;
            this.f20760z1 = false;
        }
        gg.j jVar = this.f20704o4;
        if (jVar != null) {
        ...
        org.telegram.ui.Components.z5.release(this, this.f20692m3);
        org.telegram.ui.Components.z5.release(this, this.f20698n3);
        org.telegram.ui.Components.z5.release(this, this.f20703o3);
        org.telegram.ui.Components.z5.release(this, this.f20708p3);
        this.f20732u0.g();
        this.f20642c0 = null;
    }
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (P() && (ji0Var = this.f20654e2) != null && SharedConfig.archiveHidden && ji0Var.J == 0.0f) {
            accessibilityNodeInfo.setVisibleToUser(false);
        } else {
            accessibilityNodeInfo.addAction(16);
            accessibilityNodeInfo.addAction(32);
            if (!P() && this.f20763z4 != null) {
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        if (this.f20673i0 == 0.0f && !this.P && !this.F && this.f20732u0.a(motionEvent, this)) {
            return true;
        }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (this.H0 != 0 || this.G0 != null) {
            ci.bb bbVar = this.f20677i4;
            if (bbVar != null) {
                bbVar.layout(0, 0, AndroidUtilities.dp(22.0f), AndroidUtilities.dp(22.0f));
            }
            if (this.f20712q2 != null) {
                int i17 = this.I;
                boolean z11 = this.f20718r2;
                ...
                if (this.f20682k0) {
                    ...
                    dp = (getMeasuredHeight() - this.f20712q2.getMeasuredHeight()) >> 1;
                } else {
                    if (LocaleController.isRTL) {
                        dp2 = (i12 - i10) - dp2;
                    }
                ...
                ci.p3 p3Var = this.f20712q2;
                p3Var.layout(i16, dp, p3Var.getMeasuredWidth() + i16, this.f20712q2.getMeasuredHeight() + dp);
            }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.P) {
            ...
            setMeasuredDimension(size, AndroidUtilities.dp(i12 + i13) + (this.f20724s2 ? 1 : 0));
            this.Q = false;
            if (this.P && !M()) {
                t();
                if (this.R) {
        ...
        this.f20733u1 = 0;
        this.f20738v1 = getMeasuredHeight();
    }
    ...
    public final void onPopulateAccessibilityEvent(AccessibilityEvent accessibilityEvent) {
            ...
            if (this.P && this.N != null) {
                ...
                if (user2 != null) {
                    ...
                    if (chat != null) {
                        ...
                        sb2.append(". ");
                        sb2.append(this.f20665g2.title);
                        sb2.append(". ");
                    }
                }
            }
        ...
        if (messageObject != null && this.J0 == 0) {
            ...
            sb2.append(". ");
            if (this.f20665g2 != null && !this.f20659f1.isOut() && this.f20659f1.isFromUser() && this.f20659f1.messageOwner.action == null && (user = MessagesController.getInstance(this.F0).getUser(Long.valueOf(this.f20659f1.messageOwner.from_id.user_id))) != null) {
                sb2.append(ContactsController.formatName(user.first_name, user.last_name));
                sb2.append(". ");
            }
            if (this.f20670h2 == null) {
                StringBuilder sb3 = new StringBuilder();
                sb3.append(this.f20659f1.messageText);
                if (!this.f20659f1.isMediaEmpty() && (captionMessage = getCaptionMessage()) != null && !TextUtils.isEmpty(captionMessage.caption)) {
                    if (sb3.length() > 0) {
                        sb3.append(". ");
                    }
                    sb3.append(captionMessage.caption);
                }
                StaticLayout staticLayout = this.f20655e3;
                if (staticLayout == null) {
                    length = -1;
                } else {
    ...
    public final boolean performAccessibilityAction(int i10, Bundle bundle) {
        ry ryVar;
        if (i10 == R.id.acc_action_chat_preview && (ryVar = this.f20763z4) != null) {
            ryVar.H4(this);
            return true;
        }
    ...
    public void setTranslationX(float f7) {
        ...
        if (yi0Var != null && f7 == 0.0f) {
            yi0Var.T(0.0f, true);
            this.f20760z1 = false;
            this.f20690m1 = SharedConfig.archiveHidden;
            this.B1 = 0.0f;
            this.f20750x1 = false;
        }
        float f10 = this.f20744w1;
        if (f10 != 0.0f) {
            this.f20750x1 = true;
        } else {
            this.C1 = 0.0f;
        ...
        if (this.f20750x1 && !this.f20742w) {
            boolean z11 = this.A1;
            if (Math.abs(f10) < getMeasuredWidth() * 0.45f) {
                z10 = false;
            }
            this.A1 = z10;
            if (z11 != z10 && this.f20690m1 == SharedConfig.archiveHidden) {
                try {
    ...
    public final void w() {
        float f7;
        TLRPC.User user;
        if (this.f20660f2 != null && (user = MessagesController.getInstance(this.F0).getUser(Long.valueOf(this.f20660f2.f18230id))) != null) {
            this.f20660f2 = user;
        }
        if (R()) {
            f7 = 1.0f;
    ...
    public final void x() {
        ...
        float f7;
        ci.p3 p3Var;
        if (this.f20687l0 > 0 && !this.f20739v2 && !R() && (((p3Var = this.f20712q2) == null || !p3Var.f26827a.f21943q) && !this.f20732u0.f674w)) {
            z10 = true;
        } else {
            z10 = false;
        }
    ...
    public final int y() {
        float f7;
        if (Q() && !this.f20678j0 && !this.f20657f) {
            if (!this.f20718r2 && !SharedConfig.useThreeLinesLayout) {
                f7 = 91.0f;
            } else {
                f7 = 86.0f;
            }
    ...
    public final void z(int i10, int i11) {
        this.f20736u4 = 0.0f;
        ValueAnimator ofFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
        this.f20747w4 = ofFloat;
        ofFloat.setDuration(220L);
        this.f20747w4.setInterpolator(rr.f27701f);
        this.f20726s4 = i10;
        this.f20720r4 = i11;
        this.f20747w4.addUpdateListener(new g2(this, 2));
        this.f20747w4.addListener(new k2(this, 2));
        this.f20741v4 = true;
        this.f20747w4.start();
    }
    ...
    public r2(ry ryVar, Context context, boolean z10, int i10, org.telegram.ui.ActionBar.d6 d6Var) {
        ...
        this.f20649d2 = new l2(0);
        rr rrVar = rr.h;
        this.f20691m2 = new org.telegram.ui.Components.e6(this, 0L, 350L, rrVar);
        this.f20702o2 = new org.telegram.ui.Components.e6(this, 0L, 350L, rrVar);
        this.f20676i3 = new Stack();
        this.j3 = new ArrayList();
        this.f20685k3 = new Stack();
        this.f20689l3 = new ArrayList();
        this.H3 = true;
        this.O3 = new le.c(this, rrVar, 320L);
        this.R3 = 1.0f;
        this.S3 = 1.0f;
        this.f20699n4 = new RectF();
        this.f20731t4 = -1;
        this.D4 = -1;
        this.E4 = new o2(this);
        j2Var.I = true;
        ...
        while (true) {
            ...
            if (i11 < imageReceiverArr.length) {
                ...
                this.f20677i4 = bbVar;
                addView(bbVar);
                this.f20681j4 = new org.telegram.ui.Components.o5(AndroidUtilities.dp(22.0f), bbVar);
                this.f20686k4 = new org.telegram.ui.Components.o5(AndroidUtilities.dp(17.0f), this);
