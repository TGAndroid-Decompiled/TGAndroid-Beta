...
public final class r2 extends FrameLayout {
    ...
    public final void a(boolean z10, boolean z11) {
        ...
        TextView textView = this.f25208c;
        TextView textView2 = this.f25207b;
        setEnabled(z10);
        float f13 = 0.5f;
        if (z11) {
    ...
    public final void b() {
        ...
        if (textView2.getVisibility() == 0) {
            ...
            d = i7.f6.d(-1, -1.0f, i13, f11, 0.0f, f12, 0.0f);
        } else {
            ...
            d = i7.f6.d(-1, -1.0f, i14, f9, 0.0f, f10, 0.0f);
        }
        ...
        if (textView2.getVisibility() == 0) {
            ...
            d10 = i7.f6.d(22, 22.0f, i12 | 48, 20.0f, 15.0f, 20.0f, 0.0f);
        } else {
            if (!LocaleController.isRTL) {
                i12 = 5;
            }
    ...
    public final void onMeasure(int i10, int i11) {
        int i12;
        setMeasuredDimension(View.MeasureSpec.getSize(i10), AndroidUtilities.dp(50.0f) + (this.f25209e ? 1 : 0));
        ...
        this.f25207b.measure(View.MeasureSpec.makeMeasureSpec(dp, 1073741824), View.MeasureSpec.makeMeasureSpec(getMeasuredHeight(), 1073741824));
    }

    public void setTextColor(int i10) {
        this.f25207b.setTextColor(i10);
    }
}
