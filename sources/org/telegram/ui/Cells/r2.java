...
public class r2 extends a0 implements oh.z6, org.telegram.ui.ActionBar.b6 {
    ...
    public int Z3;
    public n2 f23411a0;
    public boolean f23412a1;
    public final f2.a0 a2;
    public int f23413a3;
    public int f23414a4;
    public boolean f23415b0;
    public boolean f23416b1;
    public ri0 f23417b2;
    public StaticLayout f23418b3;
    public StaticLayout f23419b4;
    public boolean f23420c0;
    public MessageObject f23421c1;
    public TLRPC.User f23422c2;
    public StaticLayout c3;
    public boolean f23423c4;
    public boolean f23424d0;
    public ArrayList f23425d1;
    public TLRPC.Chat f23426d2;
    public int f23427d3;
    public boolean f23428d4;
    public Drawable[] f23429e0;
    public boolean f23430e1;
    public TLRPC.EncryptedChat f23431e2;
    public StaticLayout f23432e3;
    public boolean f23433e4;
    public boolean f23434f;
    public float f23435f0;
    public CharSequence f23436f1;
    public CharSequence f23437f2;
    public final Stack f23438f3;
    public final fg.h0 f23439f4;
    public boolean f23440g0;
    public int f23441g1;
    public int f23442g2;
    public final ArrayList f23443g3;
    public final org.telegram.ui.Components.j5 f23444g4;
    public final boolean h;
    public boolean f23445h0;
    public int f23446h1;
    public boolean f23447h2;
    public final Stack f23448h3;
    public final org.telegram.ui.Components.j5 f23449h4;
    public int f23450i0;
    public int f23451i1;
    public TLRPC.DraftMessage f23452i2;
    public final ArrayList f23453i3;
    public int f23454i4;
    public float f23455j0;
    public boolean f23456j1;
    public final org.telegram.ui.Components.z5 f23457j2;
    public org.telegram.ui.Components.q5 f23458j3;
    public boolean f23459j4;
    public y11 f23460k0;
    public boolean f23461k1;
    public boolean f23462k2;
    public org.telegram.ui.Components.q5 f23463k3;
    public final RectF f23464k4;
    public Paint f23465l0;
    public float l1;
    public final org.telegram.ui.Components.z5 f23466l2;
    public org.telegram.ui.Components.q5 f23467l3;
    public uf.h f23468l4;
    public Paint m0;
    public float f23469m1;
    public long f23470m2;
    public org.telegram.ui.Components.q5 f23471m3;
    public Path f23472m4;
    public float f23473n;
    public boolean f23474n0;
    public float f23475n1;
    public k2 f23476n2;
    public int f23477n3;
    public RectF f23478n4;
    public boolean f23479o0;
    public float f23480o1;
    public final boolean f23481o2;
    public int f23482o3;
    public int f23483o4;
    public boolean f23484p0;
    public int f23485p1;
    public boolean f23486p2;
    public StaticLayout f23487p3;
    public int f23488p4;
    public is f23489q0;
    public float f23490q1;
    public boolean f23491q2;
    public boolean f23492q3;
    public int f23493q4;
    public boolean f23494r;
    public final j2 f23495r0;
    public int f23496r1;
    public boolean f23497r2;
    public int f23498r3;
    public float f23499r4;
    public ij0 f23500s;
    public Path f23501s0;
    public int f23502s1;
    public boolean f23503s2;
    public int f23504s3;
    public boolean f23505s4;
    public jh.k f23506t0;
    public float f23507t1;
    public boolean f23508t2;
    public boolean f23509t3;
    public ValueAnimator f23510t4;
    public boolean f23511u0;
    public boolean f23512u1;
    public int f23513u2;
    public float f23514u3;
    public long f23515u4;
    public int v;
    public boolean f23516v0;
    public ij0 f23517v1;
    public int f23518v2;
    public boolean f23519v3;
    public int f23520v4;
    public boolean f23521w;
    public boolean f23522w0;
    public boolean f23523w1;
    public StaticLayout f23524w2;
    public boolean f23525w3;
    public final py f23526w4;
    public boolean f23527x;
    public boolean f23528x0;
    public boolean f23529x1;
    public boolean f23530x2;
    public boolean f23531x3;
    public StaticLayout f23532x4;
    public boolean f23533y;
    public boolean f23534y0;
    public float f23535y1;
    public float f23536y2;
    public boolean f23537y3;
    public int f23538y4;
    public float f23539z0;
    public float f23540z1;
    public boolean f23541z2;
    public int f23542z3;
    public int z4;
    ...
    private MessageObject getCaptionMessage() {
        ...
        if (this.f23425d1 == null) {
            MessageObject messageObject = this.f23421c1;
        ...
        int i10 = 0;
        for (int i11 = 0; i11 < this.f23425d1.size(); i11++) {
            MessageObject messageObject3 = (MessageObject) this.f23425d1.get(i11);
    ...
    private Paint getPaintReorderGradient() {
        int v02 = org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.f21659d6, this.C4);
    ...
    public final void A(int i10, int i11) {
        ...
        this.f23510t4 = ofFloat;
        ofFloat.setDuration(220L);
        this.f23510t4.setInterpolator(pr.f30183f);
        this.f23488p4 = i10;
        this.f23483o4 = i11;
        this.f23510t4.addUpdateListener(new g2(this, 2));
        this.f23510t4.addListener(new l2(this, 2));
        this.f23505s4 = true;
        this.f23510t4.start();
    }
    ...
    public final void D(Canvas canvas, boolean z4, int i10, int i11, int i12, float f10, boolean z10) {
        ...
        if ((this.D3 && this.E3) || this.O3 != 1.0f) {
            ...
            if (z10) {
                ...
                f12 = 1.0f;
                this.Q.setColor(i0.a.d(Color.alpha(w02) / 255.0f, org.telegram.ui.ActionBar.k6.w0(null, org.telegram.ui.ActionBar.k6.f21659d6, false), i0.a.k(org.telegram.ui.ActionBar.k6.w0(null, org.telegram.ui.ActionBar.k6.s9, false), 255)));
            } else {
                f12 = 1.0f;
            }
            if (this.M && this.K.read_inbox_max_id == 0) {
                ...
                if (!z4 && this.G0 == 0) {
                    paint = org.telegram.ui.ActionBar.k6.f21992w0;
                } else {
                    paint = org.telegram.ui.ActionBar.k6.f22030y0;
                }
                z12 = false;
            }
            StaticLayout staticLayout = this.R3;
            RectF rectF3 = this.f23464k4;
            if (staticLayout != null && this.P0 != 0) {
                paint.setAlpha((int) ((f12 - this.f23514u3) * i16));
                org.telegram.ui.ActionBar.k6.M0.setAlpha((int) ((f12 - this.f23514u3) * 255.0f));
                float f14 = f11 * 2.0f;
                if (f14 > f12) {
                    f13 = 1.0f;
                } else {
                ...
                if (f11 <= 0.5f) {
                    interpolation = pr.f30184g.getInterpolation(f14);
                } else {
                    interpolation = pr.f30185i.getInterpolation(f12 - ((f11 - 0.5f) * 2.0f));
                }
                ...
                if (z11) {
                    if (this.f23472m4 == null || (rectF2 = this.f23478n4) == null || !rectF2.equals(rectF3)) {
                        RectF rectF4 = this.f23478n4;
                        if (rectF4 == null) {
                            this.f23478n4 = new RectF(rectF3);
                        } else {
                            rectF4.set(rectF3);
                        }
                        if (this.f23472m4 == null) {
                            this.f23472m4 = new Path();
                        }
                        k7.a6.a(this.f23472m4, this.f23478n4, AndroidUtilities.dp(10.33f));
                    }
                    canvas.drawPath(this.f23472m4, paint);
                    if (z10) {
                        canvas.drawPath(this.f23472m4, this.Q);
                    }
                } else {
                ...
                if (z11) {
                    if (this.f23472m4 == null || (rectF = this.f23478n4) == null || !rectF.equals(rectF3)) {
                        RectF rectF5 = this.f23478n4;
                        if (rectF5 == null) {
                            this.f23478n4 = new RectF(rectF3);
                        } else {
                            rectF5.set(rectF3);
    ...
    public final CharSequence F() {
        ...
        for (int i11 = 0; i11 < size; i11++) {
            ...
            if (!messagesController.isHiddenByUndo(dialog.f20847id)) {
                TLRPC.Chat chat = null;
                if (DialogObject.isEncryptedDialog(dialog.f20847id)) {
                    TLRPC.EncryptedChat n10 = org.telegram.messenger.y3.n(messagesController, dialog.f20847id);
                    if (n10 != null) {
                        user = messagesController.getUser(Long.valueOf(n10.user_id));
                    } else {
                        user = null;
                    }
                } else if (DialogObject.isUserDialog(dialog.f20847id)) {
                    user = messagesController.getUser(Long.valueOf(dialog.f20847id));
                } else {
                    chat = messagesController.getChat(Long.valueOf(-dialog.f20847id));
                    user = null;
                }
                if (chat != null) {
    ...
    public final CharSequence I() {
        ...
        q2.a(this.G4, this.C0, this.f23421c1, this.f23426d2);
        this.G4.getClass();
        q2 q2Var = this.G4;
        this.F4 = q2Var.f23356c;
        this.f23420c0 = q2Var.d;
        return q2Var.f23359g;
    }
    ...
    public final SpannableStringBuilder K(int i10, CharSequence charSequence, String str, boolean z4) {
        ...
        MessageObject messageObject2 = this.f23421c1;
        ...
        if (message2 instanceof TLRPC.TL_messageService) {
            ...
            if (MessageObject.isTopicActionMessage(messageObject2)) {
                ...
                if (this.f23421c1.topicIconDrawable[0] instanceof bg.b) {
                    int i12 = this.C0;
                    TLRPC.TL_forumTopic findTopic = MessagesController.getInstance(i12).getTopicsController().findTopic(-this.f23421c1.getDialogId(), MessageObject.getTopicId(i12, this.f23421c1.messageOwner, true));
                    if (findTopic != null) {
                        ((bg.b) this.f23421c1.topicIconDrawable[0]).b(findTopic.icon_color);
                    }
                }
            } else {
                this.f23415b0 = false;
            ...
            if (richMessage != null) {
                if (richMessage.blocks.size() == 1) {
                    z10 = MessageObject.isBlueBlock(this.f23421c1.messageOwner.rich_message.blocks.get(0));
                } else {
                    z10 = false;
                }
                SpannableStringBuilder H = H(this.f23421c1.messageText, charSequence, i10);
                if (z10 && !Q()) {
                    try {
                        f10 f10Var = new f10(org.telegram.ui.ActionBar.k6.f21878p9, g6Var);
                        if (this.T) {
                ...
                int i13 = org.telegram.ui.ActionBar.k6.f21860o9;
                MessageObject messageObject3 = this.f23421c1;
                ...
                if (messageMedia instanceof TLRPC.TL_messageMediaPoll) {
                    ...
                    charSequence3 = yh.l("🎧 \u2068", messageObject3.getMusicAuthor(), " - ", this.f23421c1.getMusicTitle(), "\u2069");
                    ...
                    i13 = org.telegram.ui.ActionBar.k6.f21878p9;
                } else if (this.O1 > 1) {
                    if (this.P1) {
                        ArrayList arrayList2 = this.f23425d1;
                        if (arrayList2 == null) {
                            size2 = 0;
                        } else {
                        ...
                        ArrayList arrayList3 = this.f23425d1;
                        if (arrayList3 == null) {
                            size = 0;
                        } else {
                ...
                MessageObject messageObject4 = this.f23421c1;
                String str3 = messageObject4.messageOwner.message;
                if (str3 != null) {
                    if (messageObject4.hasHighlightedWords()) {
                        CharSequence charSequence9 = this.f23421c1.messageTrimmedToHighlight;
                        ...
                        if (measuredWidth2 > 0) {
                            replaceNewLines = AndroidUtilities.ellipsizeCenterEnd(replaceNewLines, this.f23421c1.highlightedWords.get(0), measuredWidth2, this.U, 130);
                        }
                    } else {
                    ...
                    MessageObject messageObject5 = this.f23421c1;
                    if (messageObject5 != null) {
                        messageObject5.spoilLoginCode();
                    }
                    MediaDataController.addTextStyleRuns(this.f23421c1, (Spannable) spannableString4, 264);
                    MessageObject messageObject6 = this.f23421c1;
    ...
    public final boolean M() {
        is isVar = this.f23489q0;
        if (isVar != null && !isVar.f27900c.isEmpty()) {
            return true;
        }
        return false;
    }
    ...
    public final boolean N() {
        if (ChatObject.isCommunity(this.f23426d2)) {
            return !this.f23416b1;
        }
        if (this.M) {
            return this.X0;
        }
        TLRPC.Chat chat = this.f23426d2;
    ...
    public boolean Q() {
        TLRPC.Chat chat;
        if (!O() && !this.M0 && (chat = this.f23426d2) != null) {
            if ((chat.forum || (ChatObject.isMonoForum(chat) && ChatObject.canManageMonoForum(this.C0, this.f23426d2))) && !this.M) {
                return true;
            }
            return false;
        }
    ...
    public final boolean R() {
        TLRPC.User user;
        if (!Q() && !this.f23495r0.f17242w && (user = this.f23422c2) != null && !user.self) {
            TLRPC.UserStatus userStatus = user.status;
            int i10 = this.C0;
            if (userStatus == null || userStatus.expires > 0 || !MessagesController.getInstance(i10).onlinePrivacy.containsKey(Long.valueOf(this.f23422c2.f20990id))) {
                TLRPC.UserStatus userStatus2 = this.f23422c2.status;
    ...
    public final void T(boolean z4, boolean z10) {
        if ((!getIsPinned() && z4) || this.f23519v3 == z4) {
            if (!getIsPinned()) {
                this.f23519v3 = false;
                return;
            }
    ...
    public final void U() {
        ...
        this.f23490q1 = 0.0f;
        this.f23512u1 = false;
        this.f23514u3 = (getIsPinned() && this.f23519v3) ? 0.0f : 0.0f;
        this.f23509t3 = true;
        this.l1 = 0.0f;
        setTranslationX(0.0f);
        setTranslationY(0.0f);
        org.telegram.ui.Components.j5 j5Var = this.f23444g4;
        if (j5Var != null && this.f23509t3) {
            j5Var.a();
        }
        org.telegram.ui.Components.j5 j5Var2 = this.f23449h4;
        if (j5Var2 != null && this.f23509t3) {
            j5Var2.a();
        }
    }

    public final void V(boolean z4, boolean z10) {
        k2 k2Var = this.f23476n2;
        if (k2Var == null && !z4) {
            return;
        }
        if (k2Var == null) {
            k2 k2Var2 = new k2(this, getContext(), this.C4, 0);
            this.f23476n2 = k2Var2;
            k2Var2.b(-1, org.telegram.ui.ActionBar.k6.f21659d6, org.telegram.ui.ActionBar.k6.f21786k7);
            this.f23476n2.setDrawUnchecked(false);
            this.f23476n2.setDrawBackgroundAsArc(3);
            addView(this.f23476n2);
        }
        this.f23476n2.a(z4, z10);
        x();
    }
    ...
    public final void W(long j10, MessageObject messageObject, int i10, boolean z4, boolean z10) {
        ...
        this.E0 = j10;
        this.f23515u4 = System.currentTimeMillis();
        this.f23421c1 = messageObject;
        this.f23497r2 = z4;
        this.K0 = false;
        this.O0 = i10;
        if (messageObject != null) {
    ...
    public final void X(TLRPC.Dialog dialog, int i10, int i11) {
        boolean z4;
        if (this.E0 != dialog.f20847id) {
            ValueAnimator valueAnimator = this.f23510t4;
            if (valueAnimator != null) {
                valueAnimator.removeAllListeners();
                this.f23510t4.cancel();
            }
            this.f23505s4 = false;
            this.f23493q4 = -1;
        }
        this.E0 = dialog.f20847id;
        this.f23515u4 = System.currentTimeMillis();
        boolean z10 = true;
        this.K0 = true;
        ...
        if (dialog instanceof TLRPC.TL_dialogFolder) {
            this.G0 = ((TLRPC.TL_dialogFolder) dialog).folder.f20894id;
            ri0 ri0Var = this.f23417b2;
            if (ri0Var != null) {
                ri0Var.H = this;
                ri0Var.i();
            }
        ...
        if (this.f23489q0 == null) {
            this.f23489q0 = new is(this);
        }
        this.f23446h1 = i11;
        this.f23451i1 = 0;
        if (b0(0, false)) {
    ...
    public final void Y(TLRPC.TL_forumTopic tL_forumTopic, long j10, MessageObject messageObject, boolean z4, boolean z10) {
        ...
        this.Q0 = false;
        this.f23451i1 = messageObject.getId();
        ...
        if (tL_forumTopic != null) {
            this.f23425d1 = tL_forumTopic.groupedMessages;
        }
        TLRPC.TL_forumTopic tL_forumTopic2 = this.K;
        if (tL_forumTopic2 != null && tL_forumTopic2.f20895id == 1 && (ri0Var = this.f23417b2) != null) {
            ri0Var.H = this;
            ri0Var.i();
        }
        b0(0, z10);
    ...
    public final void a0() {
        ...
        if (ri0Var != null) {
            if (this.M) {
                ...
                this.f23417b2.L = AndroidUtilities.dp(24.0f);
                this.f23417b2.M = 0.0f;
            } else {
                j2 j2Var = this.f23495r0;
                RectF rectF = j2Var.F;
                RectF rectF2 = j2Var.F;
                ri0Var.K = rectF.centerY();
                this.f23417b2.L = rectF2.centerX();
                this.f23417b2.M = rectF2.width() / 2.0f;
                if (!MessagesController.getInstance(this.C0).getStoriesController().h.isEmpty()) {
                    this.f23417b2.M -= AndroidUtilities.dpf2(3.5f);
                }
                ri0 ri0Var2 = this.f23417b2;
                this.V1.getBitmapWidth();
                ri0Var2.getClass();
            }
            ri0 ri0Var3 = this.f23417b2;
    ...
    public final void d0(boolean z4) {
        ...
        boolean z10;
        if (this.S4 != null && this.f23422c2 != null) {
            requirementToContact = MessagesController.getInstance(this.C0).isUserContactBlocked(this.f23422c2.f20990id);
        } else {
            requirementToContact = null;
        }
        if (this.f23462k2 == DialogObject.isPremiumBlocked(requirementToContact) && this.f23470m2 == DialogObject.getMessagesStarsPrice(requirementToContact)) {
            return;
        }
        this.f23462k2 = DialogObject.isPremiumBlocked(requirementToContact);
        this.f23470m2 = DialogObject.getMessagesStarsPrice(requirementToContact);
        if (!z4) {
            this.f23457j2.f(this.f23462k2, true);
            if (this.f23470m2 > 0) {
                z10 = true;
            } else {
                z10 = false;
            }
            this.f23466l2.f(z10, true);
        }
        invalidate();
    }
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        if ((!this.M && !this.C && motionEvent.getAction() == 1) || motionEvent.getAction() == 3) {
            this.f23495r0.a(motionEvent, this);
        }
    ...
    public final void e0() {
        ...
        if (this.O1 > 0) {
            if (Q()) {
                staticLayout = this.f23432e3;
            } else {
                staticLayout = this.f23418b3;
            }
            if (Q()) {
                i10 = this.Z2;
            } else {
                ...
                try {
                    ...
                    if (text instanceof Spanned) {
                        ...
                        if (p2VarArr != null && p2VarArr.length > 0) {
                            ...
                            if (ceil != 0 && !this.f23511u0 && !this.f23516v0) {
    ...
    public boolean getIsPinned() {
        if (!this.f23531x3 && !this.f23537y3) {
            return false;
        }
        return true;
    }
    ...
    public MessageObject getMessage() {
        return this.f23421c1;
    }

    public int getMessageId() {
        return this.f23451i1;
    }
    ...
    public long getStarsPrice() {
        return this.f23470m2;
    }

    @Override
    public float getTranslationX() {
        return this.f23507t1;
    }
    ...
    public final void invalidateDrawable(Drawable drawable) {
        if (drawable != this.f23517v1 && drawable != org.telegram.ui.ActionBar.k6.f21956u1) {
    ...
    public void onAttachedToWindow() {
        ...
        U();
        this.f23458j3 = org.telegram.ui.Components.u5.update(0, this, this.f23458j3, this.f23418b3);
        this.f23463k3 = org.telegram.ui.Components.u5.update(0, this, this.f23463k3, this.f23487p3);
        this.f23467l3 = org.telegram.ui.Components.u5.update(0, this, this.f23467l3, this.f23432e3);
        this.f23471m3 = org.telegram.ui.Components.u5.update(0, this, this.f23471m3, this.f23524w2);
        org.telegram.ui.Components.j5 j5Var = this.f23444g4;
        if (j5Var != null) {
            j5Var.a();
        }
    ...
    public void onDetachedFromWindow() {
        ...
        ij0 ij0Var = this.f23517v1;
        if (ij0Var != null) {
            ij0Var.stop();
            this.f23517v1.Q(0.0f, true);
            this.f23517v1.setCallback(null);
            this.f23517v1 = null;
            this.f23523w1 = false;
        }
        uf.h hVar = this.f23468l4;
        if (hVar != null) {
        ...
        org.telegram.ui.Components.u5.release(this, this.f23458j3);
        org.telegram.ui.Components.u5.release(this, this.f23463k3);
        org.telegram.ui.Components.u5.release(this, this.f23467l3);
        org.telegram.ui.Components.u5.release(this, this.f23471m3);
        this.f23495r0.g();
        this.W = null;
    }
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (P() && (ri0Var = this.f23417b2) != null && SharedConfig.archiveHidden && ri0Var.J == 0.0f) {
            accessibilityNodeInfo.setVisibleToUser(false);
        } else {
            accessibilityNodeInfo.addAction(16);
            accessibilityNodeInfo.addAction(32);
            if (!P() && this.f23526w4 != null) {
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        if (this.f23435f0 == 0.0f && !this.M && !this.C && this.f23495r0.a(motionEvent, this)) {
            return true;
        }
    ...
    public final void onLayout(boolean z4, int i10, int i11, int i12, int i13) {
        ...
        if (this.E0 != 0 || this.D0 != null) {
            fg.h0 h0Var = this.f23439f4;
            if (h0Var != null) {
                h0Var.layout(0, 0, AndroidUtilities.dp(22.0f), AndroidUtilities.dp(22.0f));
            }
            if (this.f23476n2 != null) {
                int i17 = this.F;
                boolean z10 = this.f23481o2;
                ...
                if (this.f23445h0) {
                    ...
                    dp = (getMeasuredHeight() - this.f23476n2.getMeasuredHeight()) >> 1;
                } else {
                    if (LocaleController.isRTL) {
                        dp2 = (i12 - i10) - dp2;
                    }
                ...
                k2 k2Var = this.f23476n2;
                k2Var.layout(i16, dp, k2Var.getMeasuredWidth() + i16, this.f23476n2.getMeasuredHeight() + dp);
            }
            int measuredWidth = (getMeasuredWidth() + getMeasuredHeight()) << 16;
            if (measuredWidth == this.D4 && !this.f23528x0) {
                return;
            }
            this.f23528x0 = false;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.M) {
            ...
            setMeasuredDimension(size, AndroidUtilities.dp(i12 + i13) + (this.f23486p2 ? 1 : 0));
            this.N = false;
            if (this.M && !M()) {
                t();
                if (this.O) {
        ...
        this.f23496r1 = 0;
        this.f23502s1 = getMeasuredHeight();
    }
    ...
    public final void onPopulateAccessibilityEvent(AccessibilityEvent accessibilityEvent) {
        ...
        if (messageObject != null && this.G0 == 0) {
            ...
            if (this.f23421c1.isOut()) {
                sb.append(LocaleController.formatString("AccDescrSentDate", R.string.AccDescrSentDate, formatDateAudio));
            } else {
                sb.append(LocaleController.formatString("AccDescrReceivedDate", R.string.AccDescrReceivedDate, formatDateAudio));
            }
            sb.append(". ");
            if (this.f23426d2 != null && !this.f23421c1.isOut() && this.f23421c1.isFromUser() && this.f23421c1.messageOwner.action == null && (user = MessagesController.getInstance(this.C0).getUser(Long.valueOf(this.f23421c1.messageOwner.from_id.user_id))) != null) {
                sb.append(ContactsController.formatName(user.first_name, user.last_name));
                sb.append(". ");
            }
            if (this.f23431e2 == null) {
                StringBuilder sb2 = new StringBuilder();
                sb2.append(this.f23421c1.messageText);
                if (!this.f23421c1.isMediaEmpty() && (captionMessage = getCaptionMessage()) != null && !TextUtils.isEmpty(captionMessage.caption)) {
                    if (sb2.length() > 0) {
                        sb2.append(". ");
                    }
                    sb2.append(captionMessage.caption);
                }
                StaticLayout staticLayout = this.f23418b3;
                if (staticLayout == null) {
                    length = -1;
                } else {
    ...
    public final boolean performAccessibilityAction(int i10, Bundle bundle) {
        py pyVar;
        if (i10 == R.id.acc_action_chat_preview && (pyVar = this.f23526w4) != null) {
            pyVar.H4(this);
            return true;
        }
    ...
    public void setTranslationX(float f10) {
        ...
        if (ij0Var != null && f10 == 0.0f) {
            ij0Var.Q(0.0f, true);
            this.f23523w1 = false;
            this.f23456j1 = SharedConfig.archiveHidden;
            this.f23535y1 = 0.0f;
            this.f23512u1 = false;
        }
        float f11 = this.f23507t1;
        if (f11 != 0.0f) {
            this.f23512u1 = true;
        } else {
            this.f23540z1 = 0.0f;
        ...
        if (this.f23512u1 && !this.f23521w) {
            boolean z10 = this.f23529x1;
            if (Math.abs(f11) < getMeasuredWidth() * 0.45f) {
                z4 = false;
            }
            this.f23529x1 = z4;
            if (z10 != z4 && this.f23456j1 == SharedConfig.archiveHidden) {
                try {
    ...
    public final void w() {
        float f10;
        TLRPC.User user;
        if (this.f23422c2 != null && (user = MessagesController.getInstance(this.C0).getUser(Long.valueOf(this.f23422c2.f20990id))) != null) {
            this.f23422c2 = user;
        }
        if (R()) {
            f10 = 1.0f;
    ...
    public final void x() {
        ...
        float f10;
        k2 k2Var;
        if (this.f23450i0 > 0 && !this.f23503s2 && !R() && (((k2Var = this.f23476n2) == null || !k2Var.f29606a.f24809q) && !this.f23495r0.f17242w)) {
            z4 = true;
        } else {
            z4 = false;
        }
    ...
    public final int y() {
        float f10;
        if (Q() && !this.f23440g0 && !this.f23434f) {
            if (!this.f23481o2 && !SharedConfig.useThreeLinesLayout) {
                f10 = 91.0f;
            } else {
                f10 = 86.0f;
            }
    ...
    public r2(py pyVar, Context context, boolean z4, int i10, org.telegram.ui.ActionBar.g6 g6Var) {
        ...
        this.a2 = new f2.a0(5);
        pr prVar = pr.h;
        this.f23457j2 = new org.telegram.ui.Components.z5(this, 0L, 350L, prVar);
        this.f23466l2 = new org.telegram.ui.Components.z5(this, 0L, 350L, prVar);
        this.f23438f3 = new Stack();
        this.f23443g3 = new ArrayList();
        this.f23448h3 = new Stack();
        this.f23453i3 = new ArrayList();
        this.E3 = true;
        this.L3 = new xd.a(this, prVar, 320L);
        this.O3 = 1.0f;
        this.P3 = 1.0f;
        this.f23464k4 = new RectF();
        this.f23493q4 = -1;
        this.A4 = -1;
        this.B4 = new o2(this);
        j2Var.I = true;
        ...
        while (true) {
            ...
            if (i11 < imageReceiverArr.length) {
                ...
                this.f23439f4 = h0Var;
                addView(h0Var);
                this.f23444g4 = new org.telegram.ui.Components.j5(AndroidUtilities.dp(22.0f), h0Var);
                this.f23449h4 = new org.telegram.ui.Components.j5(AndroidUtilities.dp(17.0f), this);
