...
public class y4 extends FrameLayout {
    public final org.telegram.ui.ActionBar.l5 f24437a;
    public final org.telegram.ui.ActionBar.l5 f24438b;
    public final ImageView f24439c;
    public boolean d;
    public int f24440e;
    ...
    public final void a(int i10, int i11) {
        ...
        org.telegram.ui.ActionBar.l5 l5Var = this.f24437a;
        ...
        ImageView imageView = this.f24439c;
        imageView.setColorFilter(porterDuffColorFilter);
        imageView.setTag(Integer.valueOf(i10));
    }

    public final void b(String str, int i10, int i11, boolean z4) {
        this.f24437a.l(str, false);
        this.f24438b.setVisibility(4);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.d) {
            ...
            if (i10 != 0) {
                org.telegram.ui.ActionBar.k6.f21798l0.setColor(org.telegram.ui.ActionBar.k6.w0(null, i10, false));
            }
    ...
    public final void onLayout(boolean z4, int i10, int i11, int i12, int i13) {
        ...
        int i15 = i13 - i11;
        int i16 = i12 - i10;
        org.telegram.ui.ActionBar.l5 l5Var = this.f24438b;
        ...
        org.telegram.ui.ActionBar.l5 l5Var2 = this.f24437a;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f24438b.measure(org.telegram.ui.b.d(24.0f, size, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), 1073741824));
        this.f24437a.measure(org.telegram.ui.b.d(95.0f, size, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), 1073741824));
        this.f24439c.measure(View.MeasureSpec.makeMeasureSpec(size, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(dp, Integer.MIN_VALUE));
