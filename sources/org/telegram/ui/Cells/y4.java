...
public class y4 extends FrameLayout {
    public final org.telegram.ui.ActionBar.h5 f21876a;
    public final org.telegram.ui.ActionBar.h5 f21877b;
    public final ImageView f21878c;
    public boolean d;
    public int e;
    ...
    public final void a(int i10, int i11) {
        ...
        org.telegram.ui.ActionBar.h5 h5Var = this.f21876a;
        ...
        ImageView imageView = this.f21878c;
        imageView.setColorFilter(porterDuffColorFilter);
        imageView.setTag(Integer.valueOf(i10));
    }

    public final void b(String str, int i10, int i11, boolean z10) {
        this.f21876a.l(str, false);
        this.f21877b.setVisibility(4);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.d) {
            int i10 = this.e;
            if (i10 != 0) {
                org.telegram.ui.ActionBar.h6.f19201l0.setColor(org.telegram.ui.ActionBar.h6.w0(null, i10, false));
            }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        int i15 = i13 - i11;
        int i16 = i12 - i10;
        org.telegram.ui.ActionBar.h5 h5Var = this.f21877b;
        ...
        org.telegram.ui.ActionBar.h5 h5Var2 = this.f21876a;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f21877b.measure(ok.c(24.0f, size, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), 1073741824));
        this.f21876a.measure(ok.c(95.0f, size, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), 1073741824));
        this.f21878c.measure(View.MeasureSpec.makeMeasureSpec(size, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(dp, Integer.MIN_VALUE));
