...
public class y4 extends FrameLayout {
    public final org.telegram.ui.ActionBar.j5 f21649a;
    public final org.telegram.ui.ActionBar.j5 f21650b;
    ...
    public final void a(int i10, int i11) {
        ...
        org.telegram.ui.ActionBar.j5 j5Var = this.f21649a;
    ...
    public final void b(String str, int i10, int i11, boolean z10) {
        this.f21649a.l(str, false);
        this.f21650b.setVisibility(4);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.d) {
            int i10 = this.e;
            if (i10 != 0) {
                org.telegram.ui.ActionBar.i6.f18975l0.setColor(org.telegram.ui.ActionBar.i6.w0(null, i10, false));
            }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        int i15 = i13 - i11;
        int i16 = i12 - i10;
        org.telegram.ui.ActionBar.j5 j5Var = this.f21650b;
        ...
        org.telegram.ui.ActionBar.j5 j5Var2 = this.f21649a;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f21650b.measure(vl.d(24.0f, size, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), 1073741824));
        this.f21649a.measure(vl.d(95.0f, size, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), 1073741824));
        this.f21651c.measure(View.MeasureSpec.makeMeasureSpec(size, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(dp, Integer.MIN_VALUE));
