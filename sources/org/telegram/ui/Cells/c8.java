...
public final class c8 extends ImageReceiver {
    public final org.telegram.ui.ActionBar.g6 f22658a;
    public final d8 f22659b;
    ...
    public final boolean setImageBitmapByKey(Drawable drawable, String str, int i10, boolean z4, int i11) {
        if (drawable instanceof BitmapDrawable) {
            d8 d8Var = this.f22659b;
            if (d8Var.H == 0) {
                d8Var.H = AndroidUtilities.getDominantColor(((BitmapDrawable) drawable).getBitmap());
                int i12 = d8Var.H;
                if (i12 == -1 || i12 == 0) {
                    d8Var.H = org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.f21893q5, this.f22658a);
                }
