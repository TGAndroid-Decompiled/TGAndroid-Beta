...
public abstract class c8 extends FrameLayout {
    public final a8 f19857a;
    public final b8 f19858b;
    public final TextView f19859c;
    public final TextView d;
    public final TextView e;
    public final TextView f19860f;
    public final Paint h;
    public final org.telegram.ui.Components.f9 f19861n;
    public final ai.ca f19862r;
    public final org.telegram.ui.ActionBar.e6 f19863s;
    public wa1 v;
    public final TLRPC.ChatFull f19864w;
    ...
    public c8(Context context, TLRPC.ChatFull chatFull, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        float f12;
        this.h = new Paint(1);
        this.f19861n = new org.telegram.ui.Components.f9((org.telegram.ui.ActionBar.e6) null);
        this.f19862r = new ai.ca(null, false);
        this.f19864w = chatFull;
        this.f19863s = e6Var;
        ...
        pqVar2.f27119n = intrinsicHeight2;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.f19865x) {
            int v02 = org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f18835d7, this.f19863s);
            Paint paint = this.h;
            paint.setColor(v02);
            if (LocaleController.isRTL) {
    ...
    public void setData(sa1 sa1Var) {
        TLRPC.User user = sa1Var.f37361a;
        org.telegram.ui.Components.f9 f9Var = this.f19861n;
        f9Var.r(user);
        TLRPC.User user2 = sa1Var.f37361a;
        a8 a8Var = this.f19857a;
        a8Var.e(user2, f9Var);
        a8Var.setRoundRadius(AndroidUtilities.dp(46.0f) >> 1);
        this.f19858b.k(sa1Var.f37361a.first_name);
        this.e.setText(sa1Var.f37362b);
        this.f19859c.setVisibility(8);
        this.d.setVisibility(8);
        this.f19860f.setVisibility(8);
    }

    public void setImageViewAction(View.OnClickListener onClickListener) {
        this.f19857a.setOnClickListener(onClickListener);
    }
}
