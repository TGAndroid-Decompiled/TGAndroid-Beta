...
public abstract class c8 extends FrameLayout {
    public final a8 f20083a;
    public final b8 f20084b;
    public final TextView f20085c;
    public final TextView d;
    public final TextView e;
    public final TextView f20086f;
    public final Paint h;
    public final org.telegram.ui.Components.h9 f20087n;
    public final ai.ca f20088r;
    public final org.telegram.ui.ActionBar.d6 f20089s;
    public pa1 v;
    public final TLRPC.ChatFull f20090w;
    ...
    public c8(Context context, TLRPC.ChatFull chatFull, org.telegram.ui.ActionBar.d6 d6Var) {
        ...
        float f12;
        this.h = new Paint(1);
        this.f20087n = new org.telegram.ui.Components.h9((org.telegram.ui.ActionBar.d6) null);
        this.f20088r = new ai.ca(null, false);
        this.f20090w = chatFull;
        this.f20089s = d6Var;
        ...
        qqVar2.f27730n = intrinsicHeight2;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.f20091x) {
            int v02 = org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19046d7, this.f20089s);
            Paint paint = this.h;
            paint.setColor(v02);
            if (LocaleController.isRTL) {
    ...
    public void setData(la1 la1Var) {
        TLRPC.User user = la1Var.f35255a;
        org.telegram.ui.Components.h9 h9Var = this.f20087n;
        h9Var.r(user);
        TLRPC.User user2 = la1Var.f35255a;
        a8 a8Var = this.f20083a;
        a8Var.e(user2, h9Var);
        a8Var.setRoundRadius(AndroidUtilities.dp(46.0f) >> 1);
        this.f20084b.k(la1Var.f35255a.first_name);
        this.e.setText(la1Var.f35256b);
