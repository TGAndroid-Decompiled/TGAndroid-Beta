...
public class n6 extends FrameLayout {
    ...
    public n6(int i10, int i11, Context context, org.telegram.ui.ActionBar.f6 f6Var, boolean z10, boolean z11) {
        ...
        float f11;
        float f12;
        this.f20486r = new org.telegram.ui.Components.f9((org.telegram.ui.ActionBar.f6) null);
        this.E = 1.0f;
        this.f20488w = i10;
        this.f20482b = i11;
        this.v = f6Var;
        this.f20490y = new l6(this, f6Var);
        ...
        a6Var.i(lw0Var.f25983a);
        org.telegram.ui.ActionBar.k5 k5Var = new org.telegram.ui.ActionBar.k5(context);
        this.e = k5Var;
        k5Var.setTextSize(13);
        k5Var.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19245y6, f6Var));
    ...
    public final void onAttachedToWindow() {
        ...
        this.f20487s.f25983a.a();
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        this.f20487s.f25983a.b();
        this.f20490y.g();
    }
