...
public final class e2 extends FrameLayout implements DownloadController.FileDownloadProgressListener {
    ...
    public boolean W;
    public final ImageReceiver f19983a;
    public final np f19984a0;
    public boolean f19985b;
    public d2 f19986b0;
    public final l80 f19987c;
    public wc f19988c0;
    public final int d;
    public boolean f19989d0;
    public Object e;
    public String f19990e0;
    public final org.telegram.ui.ActionBar.e6 f19991f;
    public boolean f19992f0;
    public float f19993g0;
    public boolean h;
    public final c2 f19994h0;
    ...
    public final void c(boolean z10, boolean z11) {
        ...
        if (z11) {
            ...
            animatorSet2.playTogether(ObjectAnimator.ofFloat(this, this.f19994h0, f7));
    ...
    public final void f(boolean z10, boolean z11) {
        ...
        String str = this.f19990e0;
        if (str == null && !this.f19989d0) {
            this.f19989d0 = true;
            ...
            if (this.K != null) {
                isLoadingHttpFile = FileLoader.getInstance(this.d).isLoadingFile(this.f19990e0);
            } else {
                isLoadingHttpFile = ImageLoader.getInstance().isLoadingHttpFile(this.f19990e0);
            }
            if (!isLoadingHttpFile && this.f19992f0) {
                ...
                DownloadController.getInstance(this.d).addLoadingFileObserver(this.f19990e0, this);
                int i11 = this.O;
                float f7 = 0.0f;
                if (i11 != 5 && i11 != 3) {
                    this.U = 1;
                    Float fileProgress = ImageLoader.getInstance().getFileProgress(this.f19990e0);
                    ...
                    this.U = 4;
                    Float fileProgress2 = ImageLoader.getInstance().getFileProgress(this.f19990e0);
    ...
    public final void onAttachedToWindow() {
        ...
        if (this.f19983a.onAttachedToWindow()) {
            f(false, false);
        }
        this.V.e();
    }
    ...
    public final void onDetachedFromWindow() {
        ...
        this.f19983a.onDetachedFromWindow();
        this.V.f();
        DownloadController.getInstance(this.d).removeLoadingFileObserver(this);
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float f7;
        float f10;
        ImageReceiver imageReceiver = this.f19983a;
        np npVar = this.f19984a0;
        if (npVar != null && (npVar.f26546a.f21969q || !imageReceiver.hasBitmapImage() || imageReceiver.getCurrentAlpha() != 1.0f || PhotoViewer.M1((MessageObject) this.e))) {
        ...
        org.telegram.ui.ActionBar.e6 e6Var = this.f19991f;
        ...
        if (this.f20000y != null) {
            org.telegram.ui.ActionBar.i6.f18885g3.setColor(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.J6, e6Var));
            canvas.save();
            if (!LocaleController.isRTL) {
                f11 = AndroidUtilities.leftBaseline;
            }
            canvas.translate(AndroidUtilities.dp(f11), this.f19999x);
            this.f20000y.draw(canvas);
            canvas.restore();
        }
        boolean z10 = this.P;
        RadialProgress2 radialProgress2 = this.V;
        if (!z10) {
            boolean z11 = this.f19985b;
            l80 l80Var = this.f19987c;
            ...
            if (i12 != 3 && i12 != 5) {
                ...
                if (botInlineResult2 != null && botInlineResult2.type.equals("file")) {
                    int intrinsicWidth = org.telegram.ui.ActionBar.i6.f18996m4.getIntrinsicWidth();
                    int intrinsicHeight = org.telegram.ui.ActionBar.i6.f18996m4.getIntrinsicHeight();
                    ...
                    canvas.drawRect(imageReceiver.getImageX(), imageReceiver.getImageY(), imageReceiver.getImageX() + AndroidUtilities.dp(52.0f), imageReceiver.getImageY() + AndroidUtilities.dp(52.0f), l80.f25862j);
                    org.telegram.ui.ActionBar.i6.f18996m4.setBounds(imageX, imageY, intrinsicWidth + imageX, intrinsicHeight + imageY);
                    org.telegram.ui.ActionBar.i6.f18996m4.draw(canvas);
                } else {
                    ...
                    if (botInlineResult3 != null && (botInlineResult3.type.equals("audio") || this.I.type.equals("voice"))) {
                        int intrinsicWidth2 = org.telegram.ui.ActionBar.i6.f19016n4.getIntrinsicWidth();
                        int intrinsicHeight2 = org.telegram.ui.ActionBar.i6.f19016n4.getIntrinsicHeight();
                        ...
                        canvas.drawRect(imageReceiver.getImageX(), imageReceiver.getImageY(), imageReceiver.getImageX() + AndroidUtilities.dp(52.0f), imageReceiver.getImageY() + AndroidUtilities.dp(52.0f), l80.f25862j);
                        org.telegram.ui.ActionBar.i6.f19016n4.setBounds(imageX2, imageY2, intrinsicWidth2 + imageX2, intrinsicHeight2 + imageY2);
                        org.telegram.ui.ActionBar.i6.f19016n4.draw(canvas);
                    } else {
                        ...
                        if (botInlineResult4 != null && (botInlineResult4.type.equals("venue") || this.I.type.equals("geo"))) {
                            int intrinsicWidth3 = org.telegram.ui.ActionBar.i6.f19033o4.getIntrinsicWidth();
                            int intrinsicHeight3 = org.telegram.ui.ActionBar.i6.f19033o4.getIntrinsicHeight();
                            ...
                            canvas.drawRect(imageReceiver.getImageX(), imageReceiver.getImageY(), imageReceiver.getImageX() + AndroidUtilities.dp(52.0f), imageReceiver.getImageY() + AndroidUtilities.dp(52.0f), l80.f25862j);
                            org.telegram.ui.ActionBar.i6.f19033o4.setBounds(imageX3, imageY3, intrinsicWidth3 + imageX3, intrinsicHeight3 + imageY3);
                            org.telegram.ui.ActionBar.i6.f19033o4.draw(canvas);
                        } else {
                            l80Var.draw(canvas);
                        }
                    }
                ...
                if (this.f19995n) {
                    i11 = org.telegram.ui.ActionBar.i6.f18948jd;
                } else {
                    i11 = org.telegram.ui.ActionBar.i6.f18930id;
                }
            ...
            if (botInlineResult5 != null) {
                ...
                if ((botInlineMessage instanceof TLRPC.TL_botInlineMessageMediaGeo) || (botInlineMessage instanceof TLRPC.TL_botInlineMessageMediaVenue)) {
                    int intrinsicWidth4 = org.telegram.ui.ActionBar.i6.f19033o4.getIntrinsicWidth();
                    int intrinsicHeight4 = org.telegram.ui.ActionBar.i6.f19033o4.getIntrinsicHeight();
                    ...
                    canvas.drawRect(imageReceiver.getImageX(), imageReceiver.getImageY(), imageReceiver.getImageX() + imageReceiver.getImageWidth(), imageReceiver.getImageY() + imageReceiver.getImageHeight(), l80.f25862j);
                    org.telegram.ui.ActionBar.i6.f19033o4.setBounds(A, A2, intrinsicWidth4 + A, intrinsicHeight4 + A2);
                    org.telegram.ui.ActionBar.i6.f19033o4.draw(canvas);
                }
            }
        }
        if (this.f19985b) {
            ...
            canvas.save();
            float f12 = this.f19993g0;
            wc wcVar = this.f19988c0;
            if (wcVar != null) {
                f12 *= wcVar.a(0.1f);
            }
        ...
        if (this.h && !this.P) {
            if (LocaleController.isRTL) {
                canvas.drawLine(0.0f, getMeasuredHeight() - 1, getMeasuredWidth() - AndroidUtilities.dp(AndroidUtilities.leftBaseline), getMeasuredHeight() - 1, org.telegram.ui.ActionBar.i6.f18955k0);
            } else {
                canvas.drawLine(AndroidUtilities.dp(AndroidUtilities.leftBaseline), getMeasuredHeight() - 1, getMeasuredWidth(), getMeasuredHeight() - 1, org.telegram.ui.ActionBar.i6.f18955k0);
            }
        }
        if (this.f19996r) {
            org.telegram.ui.ActionBar.i6.f19051p4.setBounds(0, 0, getMeasuredWidth(), AndroidUtilities.dp(3.0f));
            org.telegram.ui.ActionBar.i6.f19051p4.draw(canvas);
        }
    }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (!this.P && this.f19986b0 != null && this.I != null) {
            ...
            if (i10 != 3 && i10 != 5) {
                ...
                if (botInlineResult != null && (webDocument = botInlineResult.content) != null && !TextUtils.isEmpty(webDocument.url)) {
                    ...
                    } else if (this.f19995n) {
                        if (motionEvent.getAction() == 1) {
                            this.f19995n = false;
                            playSoundEffect(0);
                            ((gg.w0) this.f19986b0).f9965a.V.f24993b.k(getResult());
                ...
                if (action == 0) {
                    ...
                    radialProgress2.n(this.f19995n, false);
                }
                z10 = false;
            }
            if (!z10) {
    ...
    public e2(Context context, org.telegram.ui.ActionBar.e6 e6Var, boolean z10) {
        ...
        if (z10) {
            ...
            npVar.b(-1, i11, org.telegram.ui.ActionBar.i6.f18962k7);
