...
public final class a2 extends FrameLayout {
    ...
    public View J;
    public int f20005a;
    public final org.telegram.ui.ActionBar.d6 f20006b;
    public final y1 f20007c;
    public final x1 d;
    public final View e;
    ...
    public final org.telegram.ui.Components.h9 f20013x;
    ...
    public final void d(org.telegram.ui.a aVar, ai.f2 f2Var) {
        ...
        if (aVar == null) {
            ...
            if (this.I == null) {
                ...
                this.I = view2;
                view2.setBackground(org.telegram.ui.ActionBar.h6.f0(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19148i6, this.f20006b), 2, -1));
    ...
    public final void f() {
        ...
        this.f20011s.setTranslationX(left);
    }
    ...
    public final void g() {
        ...
        int i13;
        boolean z10 = this.H;
        org.telegram.ui.ActionBar.d6 d6Var = this.f20006b;
        int i14 = this.f20014y;
        if (z10) {
            if (i14 != 1 && i14 != 5) {
                i13 = org.telegram.ui.ActionBar.h6.G6;
            } else {
                i13 = org.telegram.ui.ActionBar.h6.f19165j5;
            }
            ...
            y1 y1Var = this.f20007c;
            y1Var.setTextColor(v02);
            if (i14 != 1 && i14 != 5) {
                i11 = org.telegram.ui.ActionBar.h6.J6;
            } else {
                i11 = org.telegram.ui.ActionBar.h6.f19185k5;
            }
        ...
        if (i14 != 1 && i14 != 5) {
            ...
            i12 = org.telegram.ui.ActionBar.h6.f19222m5;
        }
        this.f20008f.setTextColor(org.telegram.ui.ActionBar.h6.v0(i12, d6Var));
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (i13 == 3) {
            ...
            org.telegram.ui.Components.w9 w9Var = this.f20012w;
            if (w9Var != null) {
    ...
    public void setCollapsed(Boolean bool) {
        ...
        if (this.f20011s == null) {
            this.f20011s = new View(getContext());
            Drawable mutate = getContext().getResources().getDrawable(R.drawable.arrow_more).mutate();
            mutate.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.G6, this.f20006b), PorterDuff.Mode.MULTIPLY));
            this.f20011s.setBackground(mutate);
            addView(this.f20011s, w7.y5.e(16, 16, 16));
        }
        f();
        this.f20011s.animate().cancel();
        ViewPropertyAnimator animate = this.f20011s.animate();
    ...
    public void setTextColor(int i10) {
        if (this.H) {
            ...
            this.f20007c.setTextColor(i10);
        }
    }

    public void setUserOrChat(TLObject tLObject) {
        String formatName;
        org.telegram.ui.Components.h9 h9Var = this.f20013x;
        h9Var.p(tLObject);
        this.f20012w.e(tLObject, h9Var);
        ...
        if (z10 && ((TLRPC.User) tLObject).f18482id == MessagesController.getInstance(UserConfig.selectedAccount).telegramAntispamUserId) {
        ...
        this.f20007c.setText(formatName);
    }
    ...
    public a2(int i10, int i11, Context context, org.telegram.ui.ActionBar.d6 d6Var, boolean z10) {
        ...
        if (z10) {
            ...
            x1Var.setTag(Integer.valueOf(org.telegram.ui.ActionBar.h6.v0((i10 == 1 || i10 == 5) ? org.telegram.ui.ActionBar.h6.f19165j5 : org.telegram.ui.ActionBar.h6.G6, d6Var)));
            ...
            y1Var.setTag(Integer.valueOf(org.telegram.ui.ActionBar.h6.v0((i10 == 1 || i10 == 5) ? org.telegram.ui.ActionBar.h6.f19165j5 : org.telegram.ui.ActionBar.h6.G6, d6Var)));
        ...
        this.f20008f = textView;
        textView.setTag(Integer.valueOf((i10 == 1 || i10 == 5) ? org.telegram.ui.ActionBar.h6.f19222m5 : org.telegram.ui.ActionBar.h6.I6));
        ...
        if (i10 == 6) {
            ...
            this.f20013x = new org.telegram.ui.Components.h9((org.telegram.ui.ActionBar.d6) null);
