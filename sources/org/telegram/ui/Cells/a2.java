...
public final class a2 extends FrameLayout {
    public final org.telegram.ui.Components.n6 f19793a;
    public final View f19794b;
    public final org.telegram.ui.ActionBar.f6 f19795c;
    ...
    public final void a() {
        float d = this.f19793a.getDrawable().d() + AndroidUtilities.dp(1.0f);
        boolean z10 = LocaleController.isRTL;
        View view = this.f19794b;
        if (z10) {
    ...
    public void setColor(int i10) {
        int v02 = org.telegram.ui.ActionBar.j6.v0(i10, this.f19795c);
        this.f19793a.setTextColor(v02);
        this.f19794b.getBackground().setColorFilter(new PorterDuffColorFilter(v02, PorterDuff.Mode.MULTIPLY));
    }
}
