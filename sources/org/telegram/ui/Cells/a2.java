...
public final class a2 extends FrameLayout {
    public final org.telegram.ui.Components.n6 f19782a;
    public final View f19783b;
    public final org.telegram.ui.ActionBar.e6 f19784c;
    ...
    public final void a() {
        float d = this.f19782a.getDrawable().d() + AndroidUtilities.dp(1.0f);
        boolean z10 = LocaleController.isRTL;
        View view = this.f19783b;
        if (z10) {
    ...
    public void setColor(int i10) {
        int v02 = org.telegram.ui.ActionBar.i6.v0(i10, this.f19784c);
        this.f19782a.setTextColor(v02);
        this.f19783b.getBackground().setColorFilter(new PorterDuffColorFilter(v02, PorterDuff.Mode.MULTIPLY));
    }
}
