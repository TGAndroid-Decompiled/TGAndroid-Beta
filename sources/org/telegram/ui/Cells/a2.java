...
public final class a2 extends FrameLayout {
    public final org.telegram.ui.Components.q6 f21598a;
    public final View f21599b;
    public final org.telegram.ui.ActionBar.f6 f21600c;
    ...
    public final void a() {
        float d = this.f21598a.getDrawable().d() + AndroidUtilities.dp(1.0f);
    ...
    public void setColor(int i10) {
        int v02 = org.telegram.ui.ActionBar.j6.v0(i10, this.f21600c);
        this.f21598a.setTextColor(v02);
        this.f21599b.getBackground().setColorFilter(new PorterDuffColorFilter(v02, PorterDuff.Mode.MULTIPLY));
    }
}
