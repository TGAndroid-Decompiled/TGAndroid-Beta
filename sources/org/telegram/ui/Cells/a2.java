...
public final class a2 extends FrameLayout {
    public final org.telegram.ui.Components.k6 f22537a;
    public final View f22538b;
    public final org.telegram.ui.ActionBar.g6 f22539c;
    ...
    public final void a() {
        float d = this.f22537a.getDrawable().d() + AndroidUtilities.dp(1.0f);
        boolean z4 = LocaleController.isRTL;
        View view = this.f22538b;
        if (z4) {
    ...
    public void setColor(int i10) {
        int v02 = org.telegram.ui.ActionBar.k6.v0(i10, this.f22539c);
        this.f22537a.setTextColor(v02);
        this.f22538b.getBackground().setColorFilter(new PorterDuffColorFilter(v02, PorterDuff.Mode.MULTIPLY));
    }
}
