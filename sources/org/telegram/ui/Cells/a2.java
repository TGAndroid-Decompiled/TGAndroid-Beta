...
public final class a2 extends FrameLayout {
    public final org.telegram.ui.Components.q6 f21625a;
    public final View f21626b;
    public final org.telegram.ui.ActionBar.f6 f21627c;
    ...
    public final void a() {
        float d = this.f21625a.getDrawable().d() + AndroidUtilities.dp(1.0f);
    ...
    public void setColor(int i10) {
        int v02 = org.telegram.ui.ActionBar.j6.v0(i10, this.f21627c);
        this.f21625a.setTextColor(v02);
        this.f21626b.getBackground().setColorFilter(new PorterDuffColorFilter(v02, PorterDuff.Mode.MULTIPLY));
    }
}
