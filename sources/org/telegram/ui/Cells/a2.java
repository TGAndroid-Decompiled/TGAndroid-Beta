...
public final class a2 extends FrameLayout {
    public final org.telegram.ui.Components.k6 f20816a;
    public final View f20817b;
    public final org.telegram.ui.ActionBar.f6 f20818c;
    ...
    public final void a() {
        float d = this.f20816a.getDrawable().d() + AndroidUtilities.dp(1.0f);
        boolean z4 = LocaleController.isRTL;
        View view = this.f20817b;
        if (z4) {
    ...
    public void setColor(int i10) {
        int v02 = org.telegram.ui.ActionBar.j6.v0(i10, this.f20818c);
        this.f20816a.setTextColor(v02);
        this.f20817b.getBackground().setColorFilter(new PorterDuffColorFilter(v02, PorterDuff.Mode.MULTIPLY));
    }
}
