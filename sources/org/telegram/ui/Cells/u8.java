...
public final class u8 extends org.telegram.ui.Components.r6 {
    ...
    public final void b(Object obj, float f7) {
        ...
        switch (this.f21426b) {
            ...
            case 11:
                ...
                hVar.G = f7;
                RectF rectF = hVar.v;
                RectF rectF2 = hVar.f43747s;
                float interpolation = 1.0f - uh.f.f43728p.getInterpolation(f7);
                float interpolation2 = (uh.f.h.getInterpolation(hVar.G) - uh.f.f43721i.getInterpolation(hVar.G)) * AndroidUtilities.dp(13.0f);
                RectF rectF3 = hVar.f43745n;
                RectF rectF4 = hVar.h;
                rectF3.set(rectF4);
                rectF3.offset(0.0f, -interpolation2);
                float g10 = uh.h.g(rectF3.height(), (AndroidUtilities.dp(2.0f) * interpolation) + AndroidUtilities.dp(uh.g.f43734b), uh.f.f43724l.getInterpolation(hVar.G)) / 2.0f;
                uh.e eVar = uh.f.f43725m;
                ...
                float interpolation4 = ((rectF4.bottom - g10) - 1.0f) - (uh.f.f43726n.getInterpolation(hVar.G) * ((AndroidUtilities.dp(6.0f) * interpolation) + AndroidUtilities.dp(38.0f)));
                RectF rectF5 = hVar.f43746r;
                rectF5.left = interpolation3 - max;
                rectF5.top = interpolation4 - g10;
                rectF5.right = interpolation3;
                rectF5.bottom = interpolation4 + g10;
                if (hVar.Q && !hVar.M) {
                    float g12 = uh.h.g(AndroidUtilities.dp(5.0f), AndroidUtilities.dp(3.0f), uh.f.f43727o.getInterpolation(hVar.G));
    ...
    public final Object get(Object obj) {
        switch (this.f21426b) {
            case 0:
                return Float.valueOf(((x8) obj).f21607s);
            case 1:
                return Float.valueOf(((y8) obj).h);
            case 2:
                return Float.valueOf(((h9) obj).f20166f);
            case 3:
