...
public final class v3 extends FrameLayout implements org.telegram.ui.ActionBar.z5 {
    public final org.telegram.ui.Components.y5 f21643a;
    public final u3 f21644b;
    public final FrameLayout.LayoutParams f21645c;
    ...
    public final void c(CharSequence charSequence, CharSequence charSequence2, View.OnClickListener onClickListener) {
        this.f21643a.setText(charSequence);
        u3 u3Var = this.f21644b;
    ...
    public final void e() {
        int v02;
        boolean z10 = this.f21646f;
        org.telegram.ui.ActionBar.e6 e6Var = this.d;
        if (z10) {
            v02 = 0;
        } else {
            v02 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.e7, e6Var);
        }
        setBackgroundColor(v02);
        int i10 = org.telegram.ui.ActionBar.j6.f7;
        this.f21643a.setTextColor(org.telegram.ui.ActionBar.j6.v0(i10, e6Var));
        this.f21644b.setTextColor(org.telegram.ui.ActionBar.j6.v0(i10, e6Var));
    }
    ...
    public void setRightTextMargin(int i10) {
        ...
        FrameLayout.LayoutParams layoutParams = this.f21645c;
        layoutParams.leftMargin = dp;
        layoutParams.rightMargin = AndroidUtilities.dp(f7);
        this.f21644b.setLayoutParams(layoutParams);
    }
    ...
    public void setTextColor(int i10) {
        ...
        this.f21643a.setTextColor(v02);
        this.f21644b.setTextColor(v02);
    }
