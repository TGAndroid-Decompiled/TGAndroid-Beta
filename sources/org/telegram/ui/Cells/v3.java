...
public final class v3 extends FrameLayout implements org.telegram.ui.ActionBar.y5 {
    public final org.telegram.ui.Components.y5 f21441a;
    public final u3 f21442b;
    public final FrameLayout.LayoutParams f21443c;
    ...
    public final void c(CharSequence charSequence, CharSequence charSequence2, View.OnClickListener onClickListener) {
        this.f21441a.setText(charSequence);
        u3 u3Var = this.f21442b;
    ...
    public final void e() {
        ...
        int i10 = org.telegram.ui.ActionBar.h6.f7;
        this.f21441a.setTextColor(org.telegram.ui.ActionBar.h6.v0(i10, d6Var));
        this.f21442b.setTextColor(org.telegram.ui.ActionBar.h6.v0(i10, d6Var));
    }
    ...
    public void setRightTextMargin(int i10) {
        ...
        FrameLayout.LayoutParams layoutParams = this.f21443c;
    ...
    public void setTextColor(int i10) {
        ...
        this.f21441a.setTextColor(v02);
        this.f21442b.setTextColor(v02);
    }
