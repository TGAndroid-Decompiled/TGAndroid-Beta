...
public final class v3 extends FrameLayout implements org.telegram.ui.ActionBar.x5 {
    public final org.telegram.ui.Components.y5 f21664a;
    public final u3 f21665b;
    public final FrameLayout.LayoutParams f21666c;
    ...
    public final void c(CharSequence charSequence, CharSequence charSequence2, View.OnClickListener onClickListener) {
        this.f21664a.setText(charSequence);
        u3 u3Var = this.f21665b;
    ...
    public final void e() {
        ...
        int i10 = org.telegram.ui.ActionBar.h6.f7;
        this.f21664a.setTextColor(org.telegram.ui.ActionBar.h6.v0(i10, d6Var));
        this.f21665b.setTextColor(org.telegram.ui.ActionBar.h6.v0(i10, d6Var));
    }
    ...
    public void setRightTextMargin(int i10) {
        ...
        FrameLayout.LayoutParams layoutParams = this.f21666c;
        layoutParams.leftMargin = dp;
        layoutParams.rightMargin = AndroidUtilities.dp(f7);
        this.f21665b.setLayoutParams(layoutParams);
    }
    ...
    public void setTextColor(int i10) {
        ...
        this.f21664a.setTextColor(v02);
        this.f21665b.setTextColor(v02);
    }
