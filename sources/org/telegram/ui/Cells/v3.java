...
public abstract class v3 extends FrameLayout {
    public org.telegram.ui.ActionBar.k5 f22459a;
    public org.telegram.ui.ActionBar.k5 f22460b;
    ...
    public int h;
    public int f22463n;
    public Paint f22464r;

    public final void a(int i10, int i11) {
        org.telegram.ui.ActionBar.k5 k5Var = this.f22459a;
        k5Var.setTextColor(i11);
        k5Var.setTag(null);
        ImageView imageView = this.f22461c;
        imageView.setColorFilter(new PorterDuffColorFilter(i10, PorterDuff.Mode.MULTIPLY));
        imageView.setTag(null);
    }

    public final void b(int i10, String str, boolean z4) {
        this.f22459a.l(str, false);
        org.telegram.ui.ActionBar.k5 k5Var = this.f22460b;
        k5Var.l(null, false);
        ImageView imageView = this.f22461c;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.f22462f) {
            ...
            canvas.drawLine(dp, measuredHeight, measuredWidth - i10, getMeasuredHeight() - 1, this.f22464r);
        }
    }
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        CharSequence text = this.f22459a.getText();
        if (!TextUtils.isEmpty(text)) {
            CharSequence text2 = this.f22460b.getText();
    ...
    public final void onLayout(boolean z4, int i10, int i11, int i12, int i13) {
        ...
        int measuredWidth;
        int measuredWidth2;
        int i15 = this.f22463n;
        int i16 = this.e;
        org.telegram.ui.ActionBar.k5 k5Var = this.f22459a;
        ImageView imageView = this.d;
        ImageView imageView2 = this.f22461c;
        int i17 = i13 - i11;
        int i18 = i12 - i10;
        org.telegram.ui.ActionBar.k5 k5Var2 = this.f22460b;
    ...
    public void onMeasure(int i10, int i11) {
        ...
        this.f22459a.measure(View.MeasureSpec.makeMeasureSpec((size - AndroidUtilities.dp(i12 + 71)) - k5Var.getTextWidth(), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), 1073741824));
        ImageView imageView2 = this.f22461c;
        if (imageView2.getVisibility() == 0) {
        ...
        setMeasuredDimension(size, AndroidUtilities.dp(50.0f) + (this.f22462f ? 1 : 0));
    }
