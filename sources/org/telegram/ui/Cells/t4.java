...
public final class t4 extends FrameLayout {
    public static u00 f22324x;
    public final org.telegram.ui.Components.k6 f22325a;
    public final org.telegram.ui.Components.k6 f22326b;
    public final org.telegram.ui.Components.p9 f22327c;
    public final ShapeDrawable d;
    public boolean e;
    public final org.telegram.ui.ActionBar.f6 f22328f;
    public boolean h;
    public CharSequence f22329n;
    ...
    public final void b(TLRPC.TL_messageMediaVenue tL_messageMediaVenue, int i10, boolean z4, boolean z10) {
        ...
        boolean z14;
        this.e = z4;
        org.telegram.ui.Components.k6 k6Var = this.f22325a;
        if (tL_messageMediaVenue != null) {
            if (TextUtils.equals(this.f22330r, tL_messageMediaVenue.emoji) && TextUtils.equals(this.f22331s, tL_messageMediaVenue.title)) {
                charSequence = this.f22329n;
            } else {
                ...
                this.f22330r = tL_messageMediaVenue.emoji;
                this.f22331s = tL_messageMediaVenue.title;
                this.f22329n = charSequence;
            }
        ...
        org.telegram.ui.Components.k6 k6Var2 = this.f22326b;
        if (tL_messageMediaVenue != null) {
        ...
        int a2 = a(i10);
        org.telegram.ui.Components.p9 p9Var = this.f22327c;
        if (tL_messageMediaVenue != null && (str3 = tL_messageMediaVenue.icon) != null) {
            if (!"pin".equals(str3) && !tL_messageMediaVenue.icon.startsWith("emoji")) {
                ...
                mutate.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.ni, this.f22328f), PorterDuff.Mode.MULTIPLY));
        ...
        this.f22332w = ValueAnimator.ofFloat(f11, f10);
        final long elapsedRealtime = SystemClock.elapsedRealtime();
        this.f22332w.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            @Override
            public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                ...
                t4Var.v = lerp;
                t4Var.f22327c.setAlpha(lerp);
                t4Var.f22325a.setAlpha(t4Var.v);
                t4Var.f22326b.setAlpha(t4Var.v);
                t4Var.invalidate();
            }
        });
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float width;
        u00 u00Var = f22324x;
        org.telegram.ui.ActionBar.f6 f6Var = this.f22328f;
        if (u00Var == null) {
        ...
        if (this.e) {
            ...
            if (G == null) {
                G = org.telegram.ui.ActionBar.j6.f20000k0;
            }
            Paint paint = G;
            if (LocaleController.isRTL) {
                dp = 0.0f;
