...
public final class t4 extends FrameLayout {
    public static t00 f21360x;
    public final org.telegram.ui.Components.n6 f21361a;
    public final org.telegram.ui.Components.n6 f21362b;
    public final org.telegram.ui.Components.u9 f21363c;
    public final ShapeDrawable d;
    public boolean e;
    public final org.telegram.ui.ActionBar.f6 f21364f;
    public boolean h;
    public CharSequence f21365n;
    public String f21366r;
    public String f21367s;
    public float v;
    ...
    public final void b(TLRPC.TL_messageMediaVenue tL_messageMediaVenue, int i10, boolean z10, boolean z11) {
        ...
        boolean z15;
        this.e = z10;
        org.telegram.ui.Components.n6 n6Var = this.f21361a;
        if (tL_messageMediaVenue != null) {
            if (TextUtils.equals(this.f21366r, tL_messageMediaVenue.emoji) && TextUtils.equals(this.f21367s, tL_messageMediaVenue.title)) {
                charSequence = this.f21365n;
            } else {
                ...
                this.f21366r = tL_messageMediaVenue.emoji;
                this.f21367s = tL_messageMediaVenue.title;
                this.f21365n = charSequence;
            }
        ...
        org.telegram.ui.Components.n6 n6Var2 = this.f21362b;
        if (tL_messageMediaVenue != null) {
        ...
        int a2 = a(i10);
        org.telegram.ui.Components.u9 u9Var = this.f21363c;
        if (tL_messageMediaVenue != null && (str3 = tL_messageMediaVenue.icon) != null) {
            if (!"pin".equals(str3) && !tL_messageMediaVenue.icon.startsWith("emoji")) {
                ...
                mutate.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19057ni, this.f21364f), PorterDuff.Mode.MULTIPLY));
        ...
        this.f21368w = ValueAnimator.ofFloat(f10, f7);
        final long elapsedRealtime = SystemClock.elapsedRealtime();
        this.f21368w.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            @Override
            public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                ...
                t4Var.v = lerp;
                t4Var.f21363c.setAlpha(lerp);
                t4Var.f21361a.setAlpha(t4Var.v);
                t4Var.f21362b.setAlpha(t4Var.v);
                t4Var.invalidate();
            }
        });
        ValueAnimator valueAnimator2 = this.f21368w;
        if (z13) {
            abs = Long.MAX_VALUE;
        }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float width;
        t00 t00Var = f21360x;
        org.telegram.ui.ActionBar.f6 f6Var = this.f21364f;
        if (t00Var == null) {
        ...
        if (this.e) {
            ...
            if (G == null) {
                G = org.telegram.ui.ActionBar.j6.f18985k0;
            }
            Paint paint = G;
            if (LocaleController.isRTL) {
                dp = 0.0f;
