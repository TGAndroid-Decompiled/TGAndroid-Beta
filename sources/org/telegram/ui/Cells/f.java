...
public final class f implements Runnable {
    ...
    public final void run() {
        String obj;
        j jVar = this.f20069a;
        d90 d90Var = jVar.f20301w;
        if (d90Var != null) {
            CharacterStyle characterStyle = d90Var.f23243i;
            ...
            final StaticLayout staticLayout = jVar.f20303y;
            final float f7 = jVar.f20302x;
            if (jVar.getContext() != null) {
                final ClickableSpan clickableSpan = (ClickableSpan) jVar.f20301w.f23243i;
