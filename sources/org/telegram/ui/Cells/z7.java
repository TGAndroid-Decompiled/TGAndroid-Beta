...
public final class z7 extends FrameLayout {
    ...
    public final org.telegram.ui.Components.p6 f21916c;
    public final org.telegram.ui.Components.p6 d;
    public final j0 e;
    public int f21917f;
    public int h;
    public Utilities.Callback f21918n;
    public y7 f21919r;
    public CharSequence f21920s;
    public float v;
    public float f21921w;
    public ValueAnimator f21922x;
    ...
    public final float b(int i10) {
        y7 y7Var;
        int i11;
        if (this.f21919r.f21886c != null) {
            int i12 = 1;
            while (true) {
                int[] iArr = this.f21919r.f21886c;
                if (i12 >= iArr.length) {
                    break;
                }
                int i13 = iArr[i12 - 1];
                int i14 = iArr[i12];
                if (i10 >= i13 && i10 <= i14) {
                    return (1.0f / (iArr.length - 1)) * ((Math.round(((i10 - i13) / (i14 - i13)) * y7Var.d) / this.f21919r.d) + i11);
                }
                i12++;
            }
        }
        return Utilities.clamp01((i10 - this.f21919r.b()) / (this.f21919r.a() - this.f21919r.b()));
    }
    ...
    public final void e(int i10, boolean z10) {
        int i11;
        float f7;
        y7 y7Var = this.f21919r;
        if (y7Var != null && y7Var.e != null) {
            org.telegram.ui.Components.p6 p6Var = this.f21915b;
            p6Var.a();
            org.telegram.ui.Components.p6 p6Var2 = this.d;
            p6Var2.a();
            org.telegram.ui.Components.p6 p6Var3 = this.f21916c;
            p6Var3.a();
            p6Var3.c((CharSequence) this.f21919r.e.run(0, Integer.valueOf(i10)), z10, true);
            p6Var.c((CharSequence) this.f21919r.e.run(-1, Integer.valueOf(this.f21919r.b())), z10, true);
            p6Var2.c((CharSequence) this.f21919r.e.run(1, Integer.valueOf(this.f21919r.a())), z10, true);
            ...
            if (Math.abs(this.f21921w - f7) >= 0.01f) {
                ValueAnimator valueAnimator = this.f21922x;
                ...
                if (z10) {
                    ...
                    this.f21922x = ofFloat;
                    ofFloat.addUpdateListener(new r(this, 6));
                    this.f21922x.addListener(new org.telegram.ui.ActionBar.y0(this, f7, 3));
                    this.f21922x.setDuration(240L);
                    this.f21922x.start();
                    return;
                }
