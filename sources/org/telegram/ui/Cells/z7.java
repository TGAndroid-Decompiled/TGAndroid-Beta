...
public final class z7 extends FrameLayout {
    public final org.telegram.ui.ActionBar.d6 f21915a;
    public final org.telegram.ui.Components.p6 f21916b;
    public final org.telegram.ui.Components.p6 f21917c;
    public final org.telegram.ui.Components.p6 d;
    public final j0 e;
    public int f21918f;
    public int h;
    public Utilities.Callback f21919n;
    public y7 f21920r;
    public CharSequence f21921s;
    public float v;
    public float f21922w;
    public ValueAnimator f21923x;
    ...
    public final float b(int i10) {
        y7 y7Var;
        int i11;
        if (this.f21920r.f21887c != null) {
            int i12 = 1;
            while (true) {
                int[] iArr = this.f21920r.f21887c;
                if (i12 >= iArr.length) {
                    break;
                }
                int i13 = iArr[i12 - 1];
                int i14 = iArr[i12];
                if (i10 >= i13 && i10 <= i14) {
                    return (1.0f / (iArr.length - 1)) * ((Math.round(((i10 - i13) / (i14 - i13)) * y7Var.d) / this.f21920r.d) + i11);
                }
                i12++;
            }
        }
        return Utilities.clamp01((i10 - this.f21920r.b()) / (this.f21920r.a() - this.f21920r.b()));
    }
    ...
    public final void e(int i10, boolean z10) {
        int i11;
        float f7;
        y7 y7Var = this.f21920r;
        if (y7Var != null && y7Var.e != null) {
            org.telegram.ui.Components.p6 p6Var = this.f21916b;
            p6Var.a();
            org.telegram.ui.Components.p6 p6Var2 = this.d;
            p6Var2.a();
            org.telegram.ui.Components.p6 p6Var3 = this.f21917c;
            p6Var3.a();
            p6Var3.c((CharSequence) this.f21920r.e.run(0, Integer.valueOf(i10)), z10, true);
            p6Var.c((CharSequence) this.f21920r.e.run(-1, Integer.valueOf(this.f21920r.b())), z10, true);
            p6Var2.c((CharSequence) this.f21920r.e.run(1, Integer.valueOf(this.f21920r.a())), z10, true);
            if (i10 >= this.f21920r.a()) {
                i11 = org.telegram.ui.ActionBar.h6.I6;
            } else {
                i11 = org.telegram.ui.ActionBar.h6.f19443y6;
            }
            p6Var2.f27275c.s(org.telegram.ui.ActionBar.h6.v0(i11, this.f21915a), z10);
            p6Var2.invalidate();
            if (i10 >= this.f21920r.a()) {
                f7 = 1.0f;
            } else {
            ...
            if (Math.abs(this.f21922w - f7) >= 0.01f) {
                ValueAnimator valueAnimator = this.f21923x;
                ...
                if (z10) {
                    ...
                    this.f21923x = ofFloat;
                    ofFloat.addUpdateListener(new r(this, 6));
                    this.f21923x.addListener(new org.telegram.ui.ActionBar.y0(this, f7, 3));
                    this.f21923x.setDuration(240L);
                    this.f21923x.start();
                    return;
                }
    ...
    public void setMinValueAllowed(int i10) {
        ...
        if (this.f21920r == null) {
            return;
        }
        this.e.setMinProgress(b(i10));
        e(this.f21918f, false);
        invalidate();
    }
}
