...
public final class z7 extends FrameLayout {
    public final org.telegram.ui.ActionBar.f6 f23620a;
    public final org.telegram.ui.Components.q6 f23621b;
    public final org.telegram.ui.Components.q6 f23622c;
    public final org.telegram.ui.Components.q6 d;
    public final j0 f23623e;
    public int f23624f;
    public int h;
    public Utilities.Callback f23625n;
    public y7 f23626r;
    public CharSequence f23627s;
    public float v;
    public float f23628w;
    public ValueAnimator f23629x;
    ...
    public final float b(int i10) {
        y7 y7Var;
        int i11;
        if (this.f23626r.f23573c != null) {
            int i12 = 1;
            while (true) {
                int[] iArr = this.f23626r.f23573c;
                if (i12 >= iArr.length) {
                    break;
                }
                int i13 = iArr[i12 - 1];
                int i14 = iArr[i12];
                if (i10 >= i13 && i10 <= i14) {
                    return (1.0f / (iArr.length - 1)) * ((Math.round(((i10 - i13) / (i14 - i13)) * y7Var.d) / this.f23626r.d) + i11);
                }
                i12++;
            }
        }
        return Utilities.clamp01((i10 - this.f23626r.b()) / (this.f23626r.a() - this.f23626r.b()));
    }
    ...
    public final void d(int i10, y7 y7Var, Utilities.Callback callback) {
        this.f23624f = i10;
        this.f23626r = y7Var;
        this.f23625n = callback;
        this.f23623e.e(b(i10), false);
        e(i10, false);
    }
    ...
    public final void e(int i10, boolean z10) {
        int i11;
        float f7;
        y7 y7Var = this.f23626r;
        if (y7Var != null && y7Var.f23574e != null) {
            org.telegram.ui.Components.q6 q6Var = this.f23621b;
            q6Var.a();
            org.telegram.ui.Components.q6 q6Var2 = this.d;
            q6Var2.a();
            org.telegram.ui.Components.q6 q6Var3 = this.f23622c;
            q6Var3.a();
            q6Var3.c((CharSequence) this.f23626r.f23574e.run(0, Integer.valueOf(i10)), z10, true);
            q6Var.c((CharSequence) this.f23626r.f23574e.run(-1, Integer.valueOf(this.f23626r.b())), z10, true);
            q6Var2.c((CharSequence) this.f23626r.f23574e.run(1, Integer.valueOf(this.f23626r.a())), z10, true);
            if (i10 >= this.f23626r.a()) {
                i11 = org.telegram.ui.ActionBar.j6.I6;
            } else {
                i11 = org.telegram.ui.ActionBar.j6.f21043y6;
            }
            q6Var2.f29598c.s(org.telegram.ui.ActionBar.j6.v0(i11, this.f23620a), z10);
            q6Var2.invalidate();
            if (i10 >= this.f23626r.a()) {
                f7 = 1.0f;
            } else {
            ...
            if (Math.abs(this.f23628w - f7) >= 0.01f) {
                ValueAnimator valueAnimator = this.f23629x;
                ...
                if (z10) {
                    ...
                    this.f23629x = ofFloat;
                    ofFloat.addUpdateListener(new r(this, 6));
                    this.f23629x.addListener(new org.telegram.ui.ActionBar.z0(this, f7, 3));
                    this.f23629x.setDuration(240L);
                    this.f23629x.start();
                    return;
                }
    ...
    public void setMinValueAllowed(int i10) {
        ...
        this.f23623e.setMinProgress(b(i10));
        e(this.f23624f, false);
        invalidate();
    }
}
