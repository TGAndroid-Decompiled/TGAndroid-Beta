...
public final class g0 extends Drawable {
    ...
    public final Paint f24364b;
    public final Paint f24365c;
    public final Paint d;
    public int f24366e;
    public ColorFilter f24367f;
    ...
    public final void a(Canvas canvas, float f10, float f11, float f12, float f13) {
        ...
        if (intrinsicWidth > 0 && intrinsicHeight > 0) {
            drawable.setAlpha(Math.round(this.f24366e * f13));
    ...
    public final void b(Canvas canvas, Rect rect, float f10, float f11, float f12, float f13, float f14, float f15) {
        float f16 = rect.left;
        float f17 = rect.top;
        canvas.drawLine((f12 * f10) + f16, (f13 * f11) + f17, (f14 * f10) + f16, (f15 * f11) + f17, this.f24365c);
    }
    ...
    public final void draw(Canvas canvas) {
        ...
        if (!bounds.isEmpty() && this.f24366e != 0) {
            ColorFilter colorFilter = this.f24367f;
            if (colorFilter != null) {
                Paint paint = this.d;
            ...
            canvas3.restore();
            int i11 = this.f24366e;
            Paint paint3 = this.f24365c;
            paint3.setAlpha(i11);
    ...
    public final void setColorFilter(ColorFilter colorFilter) {
        if (this.f24367f != colorFilter) {
            this.f24367f = colorFilter;
            invalidateSelf();
        }
    }
}
