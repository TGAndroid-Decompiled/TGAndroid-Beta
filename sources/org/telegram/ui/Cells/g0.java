...
public final class g0 extends Drawable {
    public final Drawable f22826a;
    public final Paint f22827b;
    public final Paint f22828c;
    public final Paint d;
    public int f22829e;
    public ColorFilter f22830f;
    ...
    public final void a(Canvas canvas, float f10, float f11, float f12, float f13) {
        Drawable drawable = this.f22826a;
        int intrinsicWidth = drawable.getIntrinsicWidth();
        int intrinsicHeight = drawable.getIntrinsicHeight();
        if (intrinsicWidth > 0 && intrinsicHeight > 0) {
            drawable.setAlpha(Math.round(this.f22829e * f13));
    ...
    public final void b(Canvas canvas, Rect rect, float f10, float f11, float f12, float f13, float f14, float f15) {
        float f16 = rect.left;
        float f17 = rect.top;
        canvas.drawLine((f12 * f10) + f16, (f13 * f11) + f17, (f14 * f10) + f16, (f15 * f11) + f17, this.f22828c);
    }
    ...
    public final void draw(Canvas canvas) {
        ...
        if (!bounds.isEmpty() && this.f22829e != 0) {
            ColorFilter colorFilter = this.f22830f;
            if (colorFilter != null) {
                Paint paint = this.d;
            ...
            int i11 = this.f22829e;
            Paint paint2 = this.f22827b;
            paint2.setAlpha(i11);
            canvas2.save();
    ...
    public final void setColorFilter(ColorFilter colorFilter) {
        if (this.f22830f != colorFilter) {
            this.f22830f = colorFilter;
            invalidateSelf();
        }
    }
}
