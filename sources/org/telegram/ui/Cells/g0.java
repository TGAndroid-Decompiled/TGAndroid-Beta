...
public final class g0 extends Drawable {
    ...
    public final Paint f21960b;
    public final Paint f21961c;
    public final Paint d;
    public int f21962e;
    public ColorFilter f21963f;
    ...
    public final void a(Canvas canvas, float f7, float f10, float f11, float f12) {
        Drawable drawable = this.f21959a;
        int intrinsicWidth = drawable.getIntrinsicWidth();
        int intrinsicHeight = drawable.getIntrinsicHeight();
        if (intrinsicWidth > 0 && intrinsicHeight > 0) {
            drawable.setAlpha(Math.round(this.f21962e * f12));
    ...
    public final void b(Canvas canvas, Rect rect, float f7, float f10, float f11, float f12, float f13, float f14) {
        float f15 = rect.left;
        float f16 = rect.top;
        canvas.drawLine((f11 * f7) + f15, (f12 * f10) + f16, (f13 * f7) + f15, (f14 * f10) + f16, this.f21961c);
    }
    ...
    public final void draw(Canvas canvas) {
        ...
        if (!bounds.isEmpty() && this.f21962e != 0) {
            ColorFilter colorFilter = this.f21963f;
            if (colorFilter != null) {
                Paint paint = this.d;
            ...
            int i11 = this.f21962e;
            Paint paint2 = this.f21960b;
            paint2.setAlpha(i11);
            canvas2.save();
    ...
    public final void setColorFilter(ColorFilter colorFilter) {
        if (this.f21963f != colorFilter) {
            this.f21963f = colorFilter;
            invalidateSelf();
        }
    }
}
