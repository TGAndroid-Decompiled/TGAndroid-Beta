...
public final class g0 extends Drawable {
    ...
    public final Paint f21987b;
    public final Paint f21988c;
    public final Paint d;
    public int f21989e;
    public ColorFilter f21990f;
    ...
    public final void a(Canvas canvas, float f7, float f10, float f11, float f12) {
        Drawable drawable = this.f21986a;
        int intrinsicWidth = drawable.getIntrinsicWidth();
        int intrinsicHeight = drawable.getIntrinsicHeight();
        if (intrinsicWidth > 0 && intrinsicHeight > 0) {
            drawable.setAlpha(Math.round(this.f21989e * f12));
    ...
    public final void b(Canvas canvas, Rect rect, float f7, float f10, float f11, float f12, float f13, float f14) {
        float f15 = rect.left;
        float f16 = rect.top;
        canvas.drawLine((f11 * f7) + f15, (f12 * f10) + f16, (f13 * f7) + f15, (f14 * f10) + f16, this.f21988c);
    }
    ...
    public final void draw(Canvas canvas) {
        ...
        if (!bounds.isEmpty() && this.f21989e != 0) {
            ColorFilter colorFilter = this.f21990f;
            if (colorFilter != null) {
                Paint paint = this.d;
            ...
            int i11 = this.f21989e;
            Paint paint2 = this.f21987b;
            paint2.setAlpha(i11);
            canvas2.save();
            ...
            canvas3.restore();
            int i12 = this.f21989e;
            Paint paint3 = this.f21988c;
            paint3.setAlpha(i12);
    ...
    public final void setColorFilter(ColorFilter colorFilter) {
        if (this.f21990f != colorFilter) {
            this.f21990f = colorFilter;
            invalidateSelf();
        }
    }
}
