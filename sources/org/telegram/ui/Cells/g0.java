...
public final class g0 extends Drawable {
    ...
    public final void a(Canvas canvas, float f9, float f10, float f11, float f12) {
        Drawable drawable = this.f24377a;
        int intrinsicWidth = drawable.getIntrinsicWidth();
        int intrinsicHeight = drawable.getIntrinsicHeight();
        if (intrinsicWidth > 0 && intrinsicHeight > 0) {
            drawable.setAlpha(Math.round(this.f24380e * f12));
    ...
    public final void b(Canvas canvas, Rect rect, float f9, float f10, float f11, float f12, float f13, float f14) {
        float f15 = rect.left;
        float f16 = rect.top;
        canvas.drawLine((f11 * f9) + f15, (f12 * f10) + f16, (f13 * f9) + f15, (f14 * f10) + f16, this.f24379c);
    }
    ...
    public final void draw(Canvas canvas) {
        ...
        if (!bounds.isEmpty() && this.f24380e != 0) {
            ColorFilter colorFilter = this.f24381f;
            if (colorFilter != null) {
                Paint paint = this.d;
    ...
    public final void setColorFilter(ColorFilter colorFilter) {
        if (this.f24381f != colorFilter) {
            this.f24381f = colorFilter;
            invalidateSelf();
        }
    }
}
