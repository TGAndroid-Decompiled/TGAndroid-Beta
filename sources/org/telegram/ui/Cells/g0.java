...
public final class g0 extends Drawable {
    public final Drawable f20076a;
    public final Paint f20077b;
    public final Paint f20078c;
    public final Paint d;
    public int e;
    public ColorFilter f20079f;
    ...
    public final void a(Canvas canvas, float f7, float f10, float f11, float f12) {
        Drawable drawable = this.f20076a;
    ...
    public final void b(Canvas canvas, Rect rect, float f7, float f10, float f11, float f12, float f13, float f14) {
        float f15 = rect.left;
        float f16 = rect.top;
        canvas.drawLine((f11 * f7) + f15, (f12 * f10) + f16, (f13 * f7) + f15, (f14 * f10) + f16, this.f20078c);
    }
    ...
    public final void draw(Canvas canvas) {
        ...
        if (!bounds.isEmpty() && this.e != 0) {
            ColorFilter colorFilter = this.f20079f;
            if (colorFilter != null) {
                Paint paint = this.d;
    ...
    public final void setColorFilter(ColorFilter colorFilter) {
        if (this.f20079f != colorFilter) {
            this.f20079f = colorFilter;
            invalidateSelf();
        }
    }
}
