...
public final class i5 extends LinearLayout {
    public final org.telegram.ui.Components.v9 f20442a;
    public final ai.p4 f20443b;
    public final TextView f20444c;
    public final org.telegram.ui.Components.g9 d;
    public final org.telegram.ui.ActionBar.f6 e;
    public Drawable f20445f;
    public boolean h;
    ...
    public final void a() {
        this.f20443b.setPadding(0, 0, 0, 0);
        Drawable drawable = this.f20445f;
        if (drawable != null) {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (drawable != null) {
            ...
            if (this.f20445f instanceof org.telegram.ui.Components.p5) {
                f10 = -2.0f;
            } else {
                f10 = 0.0f;
            }
            int dp2 = AndroidUtilities.dp(f10);
            Drawable drawable2 = this.f20445f;
            ai.p4 p4Var = this.f20443b;
    ...
    public final void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        if (this.h) {
            canvas.drawLine(AndroidUtilities.dp(52.0f), getHeight() - 1, getWidth() - AndroidUtilities.dp(8.0f), getHeight() - 1, org.telegram.ui.ActionBar.j6.f19231k0);
        }
    }
    ...
    public void setChat(TLRPC.Chat chat) {
        a();
        ai.p4 p4Var = this.f20443b;
        org.telegram.ui.Components.v9 v9Var = this.f20442a;
    ...
    public void setEmojiSuggestion(MediaDataController.KeywordResult keywordResult) {
        this.f20442a.setVisibility(4);
        this.f20444c.setVisibility(4);
        ...
        if (str != null && str.startsWith("animated_")) {
            try {
                ...
                this.f20445f = Emoji.getEmojiDrawable(keywordResult.emoji);
            }
        } else {
            this.f20445f = Emoji.getEmojiDrawable(keywordResult.emoji);
        }
