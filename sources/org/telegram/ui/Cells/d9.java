...
public class d9 extends FrameLayout {
    public final vh.o f19880a;
    public final c9 f19881b;
    public final c9 f19882c;
    public final ImageView d;
    public boolean e;
    public boolean f19883f;
    public final boolean h;
    public final org.telegram.ui.ActionBar.d6 f19884n;
    ...
    public final void b(Drawable drawable, String str) {
        int dp;
        boolean z10;
        ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) this.f19881b.getLayoutParams();
        ...
        if (drawable == null) {
            ...
            imageView.setBackground(org.telegram.ui.ActionBar.h6.h0(AndroidUtilities.dp(48.0f), 0, org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f18878i6, this.f19884n)));
    ...
    public final void c(CharSequence charSequence, CharSequence charSequence2, boolean z10) {
        this.f19880a.setText(charSequence);
        this.f19881b.setText(charSequence2);
    ...
    public final void d(CharSequence charSequence, String str, String str2) {
        this.f19880a.setText(charSequence);
        this.f19881b.setText(str);
        c9 c9Var = this.f19882c;
    ...
    public final void e() {
        ...
        org.telegram.ui.ActionBar.d6 d6Var = this.f19884n;
        ...
        this.f19882c.setTextColor(org.telegram.ui.ActionBar.h6.v0(i11, d6Var));
        c9Var.invalidate();
    }
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        CharSequence text = this.f19880a.getText();
        CharSequence text2 = this.f19881b.getText();
    ...
    public d9(int i10, Context context, org.telegram.ui.ActionBar.d6 d6Var, boolean z10, boolean z11) {
        ...
        this.f19880a = oVar;
        oVar.setOnLinkLongPressListener(new c90(this) {
            public final d9 f19811b;
                ...
                switch (r2) {
                    case 0:
                        ...
                        if (clickableSpan != null) {
                            ...
                            clickableSpan.onClick(d9Var.f19880a);
                            return;
                        }
                        return;
                    case 1:
                        d9 d9Var2 = this.f19811b;
                        if (clickableSpan != null) {
                            try {
                                d9Var2.performHapticFeedback(0, 1);
                            } catch (Exception unused2) {
                            }
                            clickableSpan.onClick(d9Var2.f19881b);
                            return;
                        }
                        return;
                    default:
                        d9 d9Var3 = this.f19811b;
                        if (clickableSpan != null) {
                            try {
                                d9Var3.performHapticFeedback(0, 1);
                            } catch (Exception unused3) {
                            }
                            clickableSpan.onClick(d9Var3.f19881b);
                            return;
                        }
                        return;
                }
        ...
        this.f19881b = c9Var;
        c9Var.setOnLinkLongPressListener(new c90(this) {
            public final d9 f19811b;
        ...
        this.f19882c = c9Var2;
        c9Var2.setOnLinkLongPressListener(new c90(this) {
            public final d9 f19811b;
