...
public class d9 extends FrameLayout {
    ...
    public final void a(String str, String str2, boolean z10) {
        this.f20152a.setText(str);
        this.f20153b.setText(str2);
        this.d = z10;
    ...
    public final void b(int i10, String str, String str2, boolean z10) {
        ...
        int i12;
        int i13;
        TextView textView = this.f20152a;
        textView.setText(str);
        TextView textView2 = this.f20153b;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float dp;
        int i10;
        if (this.d && org.telegram.ui.ActionBar.h6.f19180k0 != null) {
    ...
    public void setMultilineDetail(boolean z10) {
        this.e = z10;
        TextView textView = this.f20153b;
        if (z10) {
            textView.setLines(0);
    ...
    public void setValue(CharSequence charSequence) {
        this.f20153b.setText(charSequence);
    }
}
