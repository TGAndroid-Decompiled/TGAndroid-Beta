...
public class d9 extends FrameLayout {
    public final TextView f19915a;
    public final TextView f19916b;
    public final ImageView f19917c;
    public boolean d;
    public boolean e;
    ...
    public d9(Context context) {
        ...
        this.f19917c = imageView;
        imageView.setScaleType(ImageView.ScaleType.CENTER);
        imageView.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18998m6, false), PorterDuff.Mode.MULTIPLY));
        imageView.setVisibility(8);
        addView(imageView, w7.x5.d(52, 52.0f, (LocaleController.isRTL ? 5 : 3) | 48, 8.0f, 6.0f, 8.0f, 0.0f));
    }

    public final void a(String str, String str2, boolean z10) {
        this.f19915a.setText(str);
        this.f19916b.setText(str2);
        this.d = z10;
    ...
    public final void b(int i10, String str, String str2, boolean z10) {
        ...
        TextView textView2 = this.f19916b;
        textView2.setText(str2);
        ImageView imageView = this.f19917c;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float dp;
        int i10;
        if (this.d && org.telegram.ui.ActionBar.i6.f18955k0 != null) {
    ...
    public void setMultilineDetail(boolean z10) {
        this.e = z10;
        TextView textView = this.f19916b;
        if (z10) {
            textView.setLines(0);
    ...
    public void setValue(CharSequence charSequence) {
        this.f19916b.setText(charSequence);
    }
}
