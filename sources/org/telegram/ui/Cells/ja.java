...
public final class ja extends FrameLayout {
    ...
    public ImageView f20509b;
    public boolean f20510c;

    public final void a(String str, boolean z10, boolean z11) {
        int i10;
        this.f20508a.setText(str);
    ...
    public final void onMeasure(int i10, int i11) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i10), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(50.0f) + (this.f20510c ? 1 : 0), 1073741824));
    }
