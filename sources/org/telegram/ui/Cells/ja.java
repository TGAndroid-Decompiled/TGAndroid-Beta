...
public class ja extends LinearLayout {
    public org.telegram.ui.Components.s9 f20313a;
    public org.telegram.ui.Components.s9 f20314b;
    public Drawable f20315c;
    public Drawable d;
    public final t1[] e;
    public final Drawable f20316f;
    public final org.telegram.ui.ActionBar.d5 h;
    public final int f20317n;
    public org.telegram.ui.ActionBar.n2 f20318r;
    public int f20319s;
    public final g v;
    public Drawable f20320w;
    public boolean f20321x;
    public final org.telegram.ui.Components.c6 f20322y;
    ...
    public final void onAttachedToWindow() {
        ...
        Drawable drawable = this.f20320w;
    ...
    public final void onDetachedFromWindow() {
        ...
        org.telegram.ui.Components.s9 s9Var = this.f20313a;
        if (s9Var != null) {
            s9Var.dispose();
            this.f20313a = null;
        }
        org.telegram.ui.Components.s9 s9Var2 = this.f20314b;
        if (s9Var2 != null) {
            s9Var2.dispose();
            this.f20314b = null;
        }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        Drawable drawable;
        int i10;
        Drawable drawable2 = this.f20320w;
        if (drawable2 == null) {
        ...
        Drawable drawable3 = this.f20315c;
        org.telegram.ui.Components.c6 c6Var = this.f20322y;
        if (drawable2 != drawable3 && drawable2 != null) {
            if (org.telegram.ui.ActionBar.i6.sl != null || this.f20321x) {
                this.d = drawable3;
                this.f20314b = this.f20313a;
            } else {
                org.telegram.ui.Components.s9 s9Var = this.f20313a;
                if (s9Var != null) {
                    s9Var.dispose();
            ...
            this.f20315c = drawable2;
            c6Var.d(0.0f, true);
        }
        boolean z10 = this.f20321x;
        ...
        for (int i11 = 0; i11 < 2; i11++) {
            if (i11 == 0) {
                ...
                drawable = this.f20315c;
            }
            if (drawable != null) {
                if (i11 == 1 && this.d != null && (d5Var != null || this.f20321x)) {
                ...
                if (i10 > 0) {
                    ...
                    if (!(drawable instanceof ColorDrawable) && !(drawable instanceof GradientDrawable) && !(drawable instanceof cc0)) {
                        ...
                        if (drawable instanceof org.telegram.ui.Components.t9) {
                            this.f20313a = ((org.telegram.ui.Components.t9) drawable).c(canvas, this);
                        } else {
                            drawable.draw(canvas);
                        }
                    }
        ...
        Drawable drawable4 = this.f20316f;
    ...
    public void setOverrideBackground(Drawable drawable) {
        this.f20320w = drawable;
        if (drawable != null) {
            drawable.setCallback(this);
        }
        if ((this.f20320w instanceof fo) && isAttachedToWindow()) {
            ((fo) this.f20320w).f(this);
        }
        invalidate();
    }
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        if (drawable != this.f20320w && drawable != this.d && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
