...
public final class v8 extends FrameLayout {
    ...
    public v8(Context context) {
        ...
        this.f21469c = textView2;
        vl.o(org.telegram.ui.ActionBar.i6.f19234z6, null, textView2, 1, 13.0f);
        if (LocaleController.isRTL) {
            i12 = 5;
        } else {
            i12 = 3;
    ...
    public final void a(Runnable runnable, String str, boolean z10) {
        ...
        if (this.f21470f == null) {
            ...
            this.f21470f.addView(this.h, w7.x5.c(20.0f, -2));
            this.f21471n = new View(getContext());
            ...
            this.f21471n.setBackground(mutate);
            this.f21470f.addView(this.f21471n, w7.x5.q(16, 16, 16));
            this.f21470f.setClipChildren(false);
            setClipChildren(false);
            addView(this.f21470f, w7.x5.e(-2, -2, 16));
            kn knVar = new kn(getContext(), 9);
            this.f21472r = knVar;
            knVar.setBackground(org.telegram.ui.ActionBar.i6.f0(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18923i6, false), 2, -1));
            kn knVar2 = this.f21472r;
            if (LocaleController.isRTL) {
                i10 = 3;
            } else {
                i10 = 5;
        ...
        this.h.setText(str);
        this.f21471n.animate().cancel();
        ViewPropertyAnimator animate = this.f21471n.animate();
        if (z10) {
            f7 = 0.0f;
        } else {
            f7 = 180.0f;
        ...
        this.f21472r.setOnClickListener(new a(runnable, 11));
    }
    ...
    public final void b(boolean z10, boolean z11) {
        ...
        Switch r02 = this.d;
        TextView textView = this.f21469c;
        TextView textView2 = this.f21468b;
        float f11 = 0.5f;
        if (z11) {
    ...
    public final void d(String str, boolean z10, boolean z11, boolean z12) {
        TextView textView = this.f21468b;
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        LinearLayout linearLayout = this.f21470f;
        if (linearLayout != null) {
            boolean z11 = LocaleController.isRTL;
            TextView textView = this.f21468b;
            if (z11) {
                linearLayout.setTranslationX((textView.getLeft() - this.f21470f.getMeasuredWidth()) - AndroidUtilities.dp(8.0f));
                return;
            }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.f21469c.getVisibility() == 0) {
            f7 = 64.0f;
        } else {
            f7 = 50.0f;
        }
    ...
    public void setEnabled(boolean z10) {
        ...
        TextView textView = this.f21468b;
        textView.clearAnimation();
        TextView textView2 = this.f21469c;
        textView2.clearAnimation();
        Switch r22 = this.d;
        r22.clearAnimation();
        if (z10) {
