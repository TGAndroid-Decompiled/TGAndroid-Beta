...
public final class v8 extends FrameLayout {
    ...
    public v8(Context context) {
        ...
        this.f21493c = textView2;
        wl.n(org.telegram.ui.ActionBar.j6.f19264z6, null, textView2, 1, 13.0f);
        if (LocaleController.isRTL) {
            i12 = 5;
        } else {
            i12 = 3;
    ...
    public final void a(Runnable runnable, String str, boolean z10) {
        ...
        if (this.f21494f == null) {
            ...
            this.f21494f.addView(this.h, w7.x5.c(20.0f, -2));
            this.f21495n = new View(getContext());
            ...
            this.f21495n.setBackground(mutate);
            this.f21494f.addView(this.f21495n, w7.x5.q(16, 16, 16));
            this.f21494f.setClipChildren(false);
            setClipChildren(false);
            addView(this.f21494f, w7.x5.e(-2, -2, 16));
            kn knVar = new kn(getContext(), 9);
            this.f21496r = knVar;
            knVar.setBackground(org.telegram.ui.ActionBar.j6.f0(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18953i6, false), 2, -1));
            kn knVar2 = this.f21496r;
            if (LocaleController.isRTL) {
                i10 = 3;
            } else {
                i10 = 5;
        ...
        this.h.setText(str);
        this.f21495n.animate().cancel();
        ViewPropertyAnimator animate = this.f21495n.animate();
        if (z10) {
            f7 = 0.0f;
        } else {
            f7 = 180.0f;
        ...
        this.f21496r.setOnClickListener(new a(runnable, 11));
    }
    ...
    public final void b(boolean z10, boolean z11) {
        ...
        TextView textView2 = this.f21492b;
        float f11 = 0.5f;
        if (z11) {
    ...
    public final void d(String str, boolean z10, boolean z11, boolean z12) {
        TextView textView = this.f21492b;
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        LinearLayout linearLayout = this.f21494f;
        if (linearLayout != null) {
            boolean z11 = LocaleController.isRTL;
            TextView textView = this.f21492b;
            if (z11) {
                linearLayout.setTranslationX((textView.getLeft() - this.f21494f.getMeasuredWidth()) - AndroidUtilities.dp(8.0f));
                return;
            }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.f21493c.getVisibility() == 0) {
            f7 = 64.0f;
        } else {
            f7 = 50.0f;
        }
    ...
    public void setEnabled(boolean z10) {
        ...
        TextView textView = this.f21492b;
        textView.clearAnimation();
        TextView textView2 = this.f21493c;
        textView2.clearAnimation();
        Switch r22 = this.d;
        r22.clearAnimation();
        if (z10) {
