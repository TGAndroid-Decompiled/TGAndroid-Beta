...
public final class v8 extends FrameLayout {
    ...
    public v8(Context context) {
        ...
        ok.n(org.telegram.ui.ActionBar.h6.f19447z6, null, textView2, 1, 13.0f);
        if (LocaleController.isRTL) {
            i12 = 5;
        } else {
            i12 = 3;
    ...
    public final void a(Runnable runnable, String str, boolean z10) {
        ...
        if (this.f21688f == null) {
            ...
            this.f21688f.addView(this.h, w7.y5.c(20.0f, -2));
            this.f21689n = new View(getContext());
            ...
            this.f21689n.setBackground(mutate);
            this.f21688f.addView(this.f21689n, w7.y5.q(16, 16, 16));
            this.f21688f.setClipChildren(false);
            setClipChildren(false);
            addView(this.f21688f, w7.y5.e(-2, -2, 16));
            ln lnVar = new ln(getContext(), 9);
            this.f21690r = lnVar;
            lnVar.setBackground(org.telegram.ui.ActionBar.h6.f0(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19134i6, false), 2, -1));
            ln lnVar2 = this.f21690r;
            if (LocaleController.isRTL) {
                i10 = 3;
            } else {
                i10 = 5;
        ...
        this.h.setText(str);
        this.f21689n.animate().cancel();
        ViewPropertyAnimator animate = this.f21689n.animate();
        if (z10) {
            f7 = 0.0f;
        } else {
            f7 = 180.0f;
        ...
        this.f21690r.setOnClickListener(new a(runnable, 11));
    }
    ...
    public final void d(String str, boolean z10, boolean z11, boolean z12) {
        TextView textView = this.f21686b;
        textView.setText(str);
        this.d.c(z10, z12);
        this.e = z11;
        this.f21687c.setVisibility(8);
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        LinearLayout linearLayout = this.f21688f;
        if (linearLayout != null) {
            boolean z11 = LocaleController.isRTL;
            TextView textView = this.f21686b;
            if (z11) {
                linearLayout.setTranslationX((textView.getLeft() - this.f21688f.getMeasuredWidth()) - AndroidUtilities.dp(8.0f));
                return;
            }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.f21687c.getVisibility() == 0) {
            f7 = 64.0f;
        } else {
            f7 = 50.0f;
        }
