...
public final class v8 extends FrameLayout {
    ...
    public v8(Context context) {
        ...
        vl.n(org.telegram.ui.ActionBar.j6.f21062z6, null, textView2, 1, 13.0f);
        if (LocaleController.isRTL) {
            i12 = 5;
        } else {
            i12 = 3;
    ...
    public final void a(Runnable runnable, String str, boolean z10) {
        ...
        if (this.f23383f == null) {
            ...
            this.f23383f.addView(this.h, w7.x5.c(20.0f, -2));
            this.f23384n = new View(getContext());
            ...
            this.f23384n.setBackground(mutate);
            this.f23383f.addView(this.f23384n, w7.x5.q(16, 16, 16));
            this.f23383f.setClipChildren(false);
            setClipChildren(false);
            addView(this.f23383f, w7.x5.e(-2, -2, 16));
            jn jnVar = new jn(getContext(), 9);
            this.f23385r = jnVar;
            jnVar.setBackground(org.telegram.ui.ActionBar.j6.f0(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20754i6, false), 2, -1));
            jn jnVar2 = this.f23385r;
            if (LocaleController.isRTL) {
                i10 = 3;
            } else {
                i10 = 5;
        ...
        this.h.setText(str);
        this.f23384n.animate().cancel();
        ViewPropertyAnimator animate = this.f23384n.animate();
        if (z10) {
            f7 = 0.0f;
        } else {
            f7 = 180.0f;
        ...
        this.f23385r.setOnClickListener(new a(runnable, 11));
    }
    ...
    public final void b(boolean z10, boolean z11) {
        ...
        Switch r02 = this.d;
        TextView textView = this.f23381c;
        TextView textView2 = this.f23380b;
        float f11 = 0.5f;
        if (z11) {
    ...
    public final void d(String str, boolean z10, boolean z11, boolean z12) {
        TextView textView = this.f23380b;
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        LinearLayout linearLayout = this.f23383f;
        if (linearLayout != null) {
            boolean z11 = LocaleController.isRTL;
            TextView textView = this.f23380b;
            if (z11) {
                linearLayout.setTranslationX((textView.getLeft() - this.f23383f.getMeasuredWidth()) - AndroidUtilities.dp(8.0f));
                return;
            }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.f23381c.getVisibility() == 0) {
            f7 = 64.0f;
        } else {
            f7 = 50.0f;
        }
        super.onMeasure(makeMeasureSpec, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(f7) + (this.f23382e ? 1 : 0), 1073741824));
    }
    ...
    public void setEnabled(boolean z10) {
        ...
        TextView textView = this.f23380b;
        textView.clearAnimation();
        TextView textView2 = this.f23381c;
        textView2.clearAnimation();
        Switch r22 = this.d;
        r22.clearAnimation();
        if (z10) {
