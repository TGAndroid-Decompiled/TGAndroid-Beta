...
public final class t2 extends FrameLayout {
    ...
    public final void a(boolean z10, boolean z11) {
        ...
        TextView textView = this.f20428c;
        TextView textView2 = this.f20427b;
        setEnabled(z10);
        float f13 = 0.5f;
        if (z11) {
    ...
    public final void b() {
        ...
        float f11;
        float f12;
        TextView textView = this.f20427b;
        TextView textView2 = this.f20428c;
        int i12 = 3;
        if (textView2.getVisibility() == 0) {
            ...
            d = w7.a6.d(-1, -1.0f, i13, f11, 0.0f, f12, 0.0f);
        } else {
            ...
            d = w7.a6.d(-1, -1.0f, i14, f7, 0.0f, f10, 0.0f);
        }
        ...
        if (textView2.getVisibility() == 0) {
            ...
            d10 = w7.a6.d(22, 22.0f, i12 | 48, 20.0f, 15.0f, 20.0f, 0.0f);
        } else {
            if (!LocaleController.isRTL) {
                i12 = 5;
            }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f20427b.measure(View.MeasureSpec.makeMeasureSpec(dp, 1073741824), View.MeasureSpec.makeMeasureSpec(getMeasuredHeight(), 1073741824));
    }

    public void setTextColor(int i10) {
        this.f20427b.setTextColor(i10);
    }
}
