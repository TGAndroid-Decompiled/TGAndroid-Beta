...
public final class t2 extends FrameLayout {
    ...
    public final void a(boolean z10, boolean z11) {
        ...
        TextView textView = this.f23258c;
    ...
    public final void b() {
        ...
        TextView textView2 = this.f23258c;
        int i12 = 3;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.f23259e) {
            ...
            canvas.drawLine(dp, height, measuredWidth - AndroidUtilities.dp(f10), getHeight() - 1, org.telegram.ui.ActionBar.j6.f20813k0);
        }
    }
    ...
    public final void onMeasure(int i10, int i11) {
        int i12;
        setMeasuredDimension(View.MeasureSpec.getSize(i10), AndroidUtilities.dp(50.0f) + (this.f23259e ? 1 : 0));
        ...
        this.f23257b.measure(View.MeasureSpec.makeMeasureSpec(dp, 1073741824), View.MeasureSpec.makeMeasureSpec(getMeasuredHeight(), 1073741824));
    }

    public void setTextColor(int i10) {
        this.f23257b.setTextColor(i10);
    }
}
