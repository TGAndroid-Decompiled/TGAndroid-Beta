...
public final class u6 extends FrameLayout {
    ...
    public final ImageView f25737c;
    public boolean d;
    public int f25738e;
    ...
    public u6(Context context) {
        ...
        addView(textView2, i7.f6.d(-2, -2.0f, i13, f11, 33.0f, f12, 0.0f));
        ...
        addView(imageView, i7.f6.d(48, 48.0f, i14, 10.0f, 8.0f, 10.0f, 0.0f));
    }

    public final void a(CharSequence charSequence, String[] strArr, boolean z10, boolean z11) {
        TextView textView = this.f25735a;
        FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) textView.getLayoutParams();
        TextView textView2 = this.f25736b;
        if (z10) {
            ...
            if (strArr != null) {
                ...
                for (int i11 = 0; i11 < strArr.length; i11++) {
                    if (i11 != 0) {
                        ...
                        mutate2.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.g6.w0(null, org.telegram.ui.ActionBar.g6.f23450z6, false), PorterDuff.Mode.MULTIPLY));
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.d) {
            if (LocaleController.isRTL) {
                ...
                dp = AndroidUtilities.dp(this.f25738e);
            }
            float measuredHeight = getMeasuredHeight() - 1;
            int measuredWidth = getMeasuredWidth();
            if (LocaleController.isRTL) {
                i10 = AndroidUtilities.dp(this.f25738e);
            } else {
                i10 = 0;
            }
