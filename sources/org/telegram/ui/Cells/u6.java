...
public final class u6 extends FrameLayout {
    ...
    public final org.telegram.ui.ActionBar.h5 f21648b;
    public final org.telegram.ui.ActionBar.h5 f21649c;
    public final ImageView d;
    public long e;
    public final RectF f21650f;
    public final boolean h;
    public final boolean f21651n;
    public final org.telegram.ui.ActionBar.d6 f21652r;
    public boolean f21653s;
    public final t6 v;
    public final org.telegram.ui.Components.e6 f21654w;
    public final org.telegram.ui.Components.e6 f21655x;
    public final org.telegram.ui.Components.e6 f21656y;
    ...
    public final void a() {
        long j3;
        LocationController.SharingLocationInfo sharingLocationInfo = LocationController.getInstance(this.f21647a).getSharingLocationInfo(this.e);
    ...
    public final void b(String str, String str2) {
        this.f21649c.l(str, false);
        this.f21648b.l(str2, false);
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float dp;
        int i11;
        boolean z10 = this.f21653s;
        org.telegram.ui.ActionBar.d6 d6Var = this.f21652r;
        ...
        if (!this.f21651n) {
            ...
            org.telegram.ui.Components.e6 e6Var = this.f21654w;
            float f11 = e6Var.f23845c;
            int currentTime = ConnectionsManager.getInstance(i12).getCurrentTime();
            org.telegram.ui.Components.e6 e6Var2 = this.f21655x;
            ...
            if (LocaleController.isRTL) {
                this.f21650f.set(AndroidUtilities.dp(13.0f), (getMeasuredHeight() / 2.0f) - AndroidUtilities.dp(15.0f), AndroidUtilities.dp(43.0f), (getMeasuredHeight() / 2.0f) + AndroidUtilities.dp(15.0f));
            } else {
                this.f21650f.set(getMeasuredWidth() - AndroidUtilities.dp(43.0f), (getMeasuredHeight() / 2.0f) - AndroidUtilities.dp(15.0f), getMeasuredWidth() - AndroidUtilities.dp(13.0f), (getMeasuredHeight() / 2.0f) + AndroidUtilities.dp(15.0f));
            }
            canvas2.save();
            float lerp = AndroidUtilities.lerp(0.6f, 1.0f, f12);
            canvas2.scale(lerp, lerp, this.f21650f.centerX(), this.f21650f.centerY());
            ...
            float f14 = alpha;
            org.telegram.ui.ActionBar.h6.f19202l2.setAlpha((int) (0.2f * f14 * f12));
            canvas2.drawArc(this.f21650f, -90.0f, 360.0f, false, org.telegram.ui.ActionBar.h6.f19202l2);
            org.telegram.ui.ActionBar.h6.f19202l2.setAlpha((int) (f14 * f12));
            canvas.drawArc(this.f21650f, -90.0f, e6Var.d(f13, false) * (-360.0f), false, org.telegram.ui.ActionBar.h6.f19202l2);
            ...
            int length = o6Var.f26933g.length();
            if (length > 4) {
                f7 = 0.75f;
            } else if (length > 3) {
                f7 = 0.85f;
            ...
            float d10 = this.f21656y.d(f7, false);
            canvas.scale(d10, d10, this.f21650f.centerX(), this.f21650f.centerY());
            o6Var.r(v02);
            o6Var.f26947w = (int) (f12 * 255.0f);
            RectF rectF = this.f21650f;
            RectF rectF2 = this.f21650f;
    ...
    public void setHasLocation(boolean z10) {
        float f7;
        float f10;
        if (LocationController.getInstance(this.f21647a).getSharingLocationInfo(this.e) == null) {
            float f11 = 0.5f;
            if (z10) {
                f7 = 1.0f;
            } else {
            ...
            this.f21649c.setAlpha(f7);
            if (z10) {
                f10 = 1.0f;
            } else {
                f10 = 0.5f;
            }
            this.f21648b.setAlpha(f10);
            if (z10) {
                f11 = 1.0f;
            }
            this.d.setAlpha(f11);
