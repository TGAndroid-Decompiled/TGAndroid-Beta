...
public class aa extends da {
    ...
    public final void X(Canvas canvas) {
        Layout staticTextLayout = this.f20032u0.getStaticTextLayout();
        int v02 = org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.Md, this.f20168h0);
        this.f20180o.setColor(v02);
        this.f20182p.setColor(v02);
        i(canvas, staticTextLayout, this.f20192u, this.v, true, true, 0.0f);
    }

    @Override
    public final void j(int i10, t9 t9Var, boolean z10) {
        t9Var.f21248b = this.f20032u0.getStaticTextLayout();
        t9Var.f21249c = 0.0f;
        t9Var.d = 0.0f;
        t9Var.f21247a = 0;
    }
    ...
    public final int l(int i10, int i11, int i12, int i13, y9 y9Var, boolean z10) {
        ...
        if (layout != null) {
            ...
            if (i15 >= 0) {
                try {
                    return t9Var.f21247a + layout.getOffsetForHorizontal(i15, i14);
                } catch (Exception e) {
                    FileLog.e(e);
                }
            }
