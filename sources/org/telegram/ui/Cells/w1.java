    ...
    public void invalidate() {
        switch (this.f23492s) {
            case 1:
                ...
                pg0 pg0Var = ng0Var.d;
                if (ng0Var == pg0Var.f29398b.getPinnedHeader()) {
                    pg0Var.f29398b.invalidate();
                    return;
                }
                return;
            default:
    ...
    public void onDraw(Canvas canvas) {
        switch (this.f23492s) {
            ...
            case 2:
                ...
                ((l61) this.v).f28097b.draw(canvas);
                canvas.restore();
                return;
            case 3:
    ...
    public void onMeasure(int i10, int i11) {
        switch (this.f23492s) {
            case 4:
                ...
                super.onMeasure(View.MeasureSpec.makeMeasureSpec((int) ((size - lc0Var.d.getPaint().measureText(lc0Var.d.getText().toString())) - lc0Var.f38322f.getPaint().measureText(lc0Var.f38322f.getText().toString())), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(24.0f), 1073741824));
                return;
            default:
