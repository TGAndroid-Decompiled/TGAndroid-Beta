    ...
    public void invalidate() {
        switch (this.f24346s) {
            case 1:
                ...
                xg0 xg0Var = vg0Var.d;
                if (vg0Var == xg0Var.f33066b.getPinnedHeader()) {
                    xg0Var.f33066b.invalidate();
                    return;
                }
                return;
            default:
    ...
    public void onDraw(Canvas canvas) {
        switch (this.f24346s) {
            ...
            case 2:
                ...
                ((o61) this.v).f29675b.draw(canvas);
                canvas.restore();
                return;
            case 3:
    ...
    public void onMeasure(int i10, int i11) {
        switch (this.f24346s) {
            case 4:
                ...
                super.onMeasure(View.MeasureSpec.makeMeasureSpec((int) ((size - dc0Var.d.getPaint().measureText(dc0Var.d.getText().toString())) - dc0Var.f36156f.getPaint().measureText(dc0Var.f36156f.getText().toString())), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(24.0f), 1073741824));
                return;
            default:
