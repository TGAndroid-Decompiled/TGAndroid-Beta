    ...
    public void invalidate() {
        switch (this.f21535s) {
            case 1:
                ...
                qg0 qg0Var = og0Var.d;
                if (og0Var == qg0Var.f27340b.getPinnedHeader()) {
                    qg0Var.f27340b.invalidate();
                    return;
                }
                return;
            default:
    ...
    public void onDraw(Canvas canvas) {
        switch (this.f21535s) {
            ...
            case 2:
                ...
                ((k61) this.v).f25526b.draw(canvas);
                canvas.restore();
                return;
            case 3:
    ...
    public void onMeasure(int i10, int i11) {
        switch (this.f21535s) {
            case 4:
                ...
                super.onMeasure(View.MeasureSpec.makeMeasureSpec((int) ((size - gc0Var.d.getPaint().measureText(gc0Var.d.getText().toString())) - gc0Var.f33516f.getPaint().measureText(gc0Var.f33516f.getText().toString())), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(24.0f), 1073741824));
                return;
            default:
