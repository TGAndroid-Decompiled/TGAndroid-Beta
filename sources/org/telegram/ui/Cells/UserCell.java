...
public class UserCell extends FrameLayout implements NotificationCenter.NotificationCenterDelegate, Theme.Colorable {
    ...
    public final class AnonymousClass1 extends StoriesUtilities.AvatarStoryParams {
        ...
        public final void openStory(long j, Runnable runnable) {
            switch (this.$r8$classId) {
                case 0:
                    ((UserCell) this.this$0).openStory(j, null);
                    break;
                default:
    ...
    public final class AnonymousClass2 extends BackupImageView {
        ...
        private final void onDraw$org$telegram$ui$Cells$UserCell$2(Canvas canvas) {
        ...
        public final void onDraw(Canvas canvas) {
            switch (this.$r8$classId) {
                case 0:
                    onDraw$org$telegram$ui$Cells$UserCell$2(canvas);
                    break;
                default:
    ...
    public UserCell(int i, int i2, Context context, Theme.ResourcesProvider resourcesProvider, boolean z, boolean z2) {
        ...
        if (z2) {
            ...
            this.addButton.setBackground(Theme.AdaptiveRipple.filledRectByKey(new float[]{14.0f}, Theme.key_featuredStickers_addButton));
    ...
    public void openStory(long j, Runnable runnable) {
        ...
        if (lastFragment != null) {
            StoryViewer orCreateStoryViewer = lastFragment.getOrCreateStoryViewer();
            if (runnable != null) {
                orCreateStoryViewer.doOnAnimationReadyRunnables.add(runnable);
            } else {
                orCreateStoryViewer.getClass();
            }
            lastFragment.getOrCreateStoryViewer().open(getContext(), j, new StoriesListPlaceProvider((RecyclerListView) getParent(), false));
        }
    }
    ...
    public void setAdminRole(String str, boolean z, boolean z2, boolean z3, View.OnClickListener onClickListener) {
        ...
        if (z2) {
            ...
            color = (z3 && TextUtils.isEmpty(str)) ? Theme.getColor(Theme.key_featuredStickers_addButton, this.resourcesProvider) : Theme.getColor(Theme.key_chat_inAdminText, this.resourcesProvider);
        }
        ...
        if (z || z2) {
            ...
            this.adminTextView.setBackground(Theme.createRoundRectDrawable(AndroidUtilities.dp(32.0f), Theme.multAlpha(0.12f, color)));
            ...
            this.adminTextView.setPadding(AndroidUtilities.dp(6.0f), AndroidUtilities.dp(0.66f), AndroidUtilities.dp(6.0f), AndroidUtilities.dp(1.0f));
            this.adminTextView.setTranslationX(AndroidUtilities.dp(6.0f));
            this.adminTextView.setBackground(Theme.createRadSelectorDrawable(Theme.multAlpha(0.12f, color), AndroidUtilities.dp(32.0f), AndroidUtilities.dp(32.0f)));
            this.adminTextView.setOnClickListener(onClickListener);
        } else {
            this.adminTextView.setText(str);
    ...
    public void setCloseIcon(View.OnClickListener onClickListener) {
        ...
        if (this.closeView == null) {
            ...
            this.closeView.setBackground(Theme.createSelectorDrawable(Theme.getColor(Theme.key_listSelector, this.resourcesProvider), 5, -1));
    ...
    public void setException(NotificationsSettingsActivity.NotificationException notificationException, CharSequence charSequence, boolean z) {
        ...
        if (notificationException.story) {
            ...
            if (i > 0 || !notificationException.auto) {
                string = i <= 0 ? LocaleController.getString(R.string.NotificationEnabled) : LocaleController.getString(R.string.NotificationDisabled);
            } else {
            ...
            if (i2 != 3 || i3 == Integer.MAX_VALUE) {
                ...
                if (currentTime <= 0) {
                    string = z3 ? LocaleController.getString(R.string.NotificationsCustom) : LocaleController.getString(R.string.NotificationsUnmuted);
            ...
            if (notificationException.auto) {
                string = zzhp.m(string, ", Auto");
            }
        }
        CharSequence charSequence2 = string;
        if (DialogObject.isEncryptedDialog(notificationException.did)) {
            TLRPC.EncryptedChat encryptedChatM = MessagesController$DialogFilter$$ExternalSyntheticOutline0.m(MessagesController.getInstance(this.currentAccount), notificationException.did);
            ...
            setData(user, encryptedChatM, charSequence, charSequence2, 0, false);
            return;
        }
    ...
    public void update(int i) {
        ...
        if (i != 0) {
            if ((i & MessagesController.UPDATE_MASK_AVATAR) != 0) {
                ...
                if (!z || this.currentName != null || this.lastName == null || (i & MessagesController.UPDATE_MASK_NAME) == 0) {
                    ...
                    strRemoveRTL = user != null ? AndroidUtilities.removeRTL(AndroidUtilities.removeDiacritics(UserObject.getUserName(user))) : AndroidUtilities.removeRTL(AndroidUtilities.removeDiacritics(chat == null ? "" : chat.title));
        ...
        long botVerificationIcon = user != null ? DialogObject.getBotVerificationIcon(user) : chat != null ? DialogObject.getBotVerificationIcon(chat) : j;
        ...
        if (user == null || !MessagesController.getInstance(this.currentAccount).isPremiumUser(user) || MessagesController.getInstance(this.currentAccount).premiumFeaturesBlocked()) {
            ...
            if (DialogObject.getEmojiStatusDocumentId(user.emoji_status) != j) {
                ...
                if (this.premiumDrawable == null) {
                    ...
                    AnonymousClass3 anonymousClass3 = new AnonymousClass3(this.premiumDrawable, AndroidUtilities.dp(14.0f), AndroidUtilities.dp(14.0f));
                    this.premiumDrawable = anonymousClass3;
                    anonymousClass3.setColorFilter(new PorterDuffColorFilter(Theme.getColor(Theme.key_chats_verifiedBackground, this.resourcesProvider), PorterDuff.Mode.MULTIPLY));
                }
        ...
        this.avatarImageView.setRoundRadius(this.isCommunity ? AndroidUtilities.dp(12.777778f) : AndroidUtilities.dp((chat == null || !chat.forum) ? 24.0f : 14.0f));
