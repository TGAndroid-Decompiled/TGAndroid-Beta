...
public abstract class j extends FrameLayout {
    public static final int f20461a0 = AndroidUtilities.dp(76.0f);
    public static final int f20462b0 = View.MeasureSpec.makeMeasureSpec(999999, Integer.MIN_VALUE);
    public final k90 E;
    public h F;
    public r90 G;
    ...
    public int V;
    public boolean W;
    public StaticLayout f20463a;
    public String f20464b;
    public int f20465c;
    public int d;
    public SpannableStringBuilder e;
    public SpannableStringBuilder f20466f;
    public final TextView h;
    public final c f20467n;
    public final FrameLayout f20468r;
    public final FrameLayout f20469s;
    public final Drawable v;
    public o90 f20470w;
    public float f20471x;
    public StaticLayout f20472y;
    ...
    public j(Context context, org.telegram.ui.ActionBar.m2 m2Var, org.telegram.ui.ActionBar.d6 d6Var) {
        ...
        this.K = org.telegram.ui.ActionBar.h6.Y(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19134i6, d6Var), 0, 0);
        TextView textView = new TextView(context);
        this.h = textView;
        textView.setVisibility(8);
        ok.n(org.telegram.ui.ActionBar.h6.f19447z6, d6Var, textView, 1, 13.0f);
        textView.setLines(1);
        ...
        textView2.f20060a = false;
        this.f20467n = textView2;
        textView2.setTextColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19229n6, d6Var));
    ...
    private void setShowMoreMarginBottom(int i10) {
        FrameLayout frameLayout = this.f20468r;
    ...
    public final void a(int i10, boolean z10) {
        ...
        if (spannableStringBuilder != null && (i10 != this.V || z10)) {
            ...
            this.W = z11;
            int lineCount = this.f20463a.getLineCount();
            FrameLayout frameLayout2 = this.f20468r;
            if (lineCount >= 3 && this.W) {
                int max = Math.max(this.f20463a.getLineStart(2), this.f20463a.getLineEnd(2));
                ...
                this.M = new StaticLayout[this.f20463a.getLineCount() - 3];
                this.O = new Point[this.f20463a.getLineCount() - 3];
                ...
                for (int i15 = 3; i15 < this.f20463a.getLineCount(); i15++) {
                    int lineStart = this.f20463a.getLineStart(i15);
                    int lineEnd = this.f20463a.getLineEnd(i15);
            ...
            if (this.W && this.L != null) {
                ...
                int min = Math.min(f20461a0 + i11, g()) - AndroidUtilities.dp(8.0f);
    ...
    public final void d(ClickableSpan clickableSpan, Layout layout, float f7) {
        ...
        if (clickableSpan instanceof z51) {
            ...
            ((l01) this).f35172c0.e.B4(url, this.F);
    ...
    public final void f(String str, String str2, boolean z10) {
        if (!TextUtils.isEmpty(str) && !TextUtils.equals(str, this.f20464b)) {
            try {
                this.f20464b = AndroidUtilities.getSafeString(str);
            } catch (Throwable unused) {
                this.f20464b = str;
            }
            SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(this.f20464b);
    ...
    public final int g() {
        int dp;
        StaticLayout staticLayout = this.f20463a;
    ...
    public final void h() {
        ...
        float f7 = this.T;
        float g10 = g();
        float min = Math.min(f20461a0, g10);
    ...
    public final int i() {
        ...
        float min = Math.min(f20461a0 + i10, g());
        if (this.W) {
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (this.f20463a != null) {
            SpannableStringBuilder spannableStringBuilder = this.f20466f;
            if (spannableStringBuilder == null) {
                ...
                if (spannableStringBuilder2 == null) {
                    ...
                    if (clickableSpanArr != null && clickableSpanArr.length != 0) {
                        ...
                        this.f20466f = spannableStringBuilder3;
                        spannableStringBuilder = spannableStringBuilder3;
                    } else {
                        spannableStringBuilder = this.e;
                        this.f20466f = spannableStringBuilder;
                    }
                }
            }
