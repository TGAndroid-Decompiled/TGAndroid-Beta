...
public abstract class j extends FrameLayout {
    public static final int f20447a0 = AndroidUtilities.dp(76.0f);
    public static final int f20448b0 = View.MeasureSpec.makeMeasureSpec(999999, Integer.MIN_VALUE);
    public final h90 E;
    public h F;
    public o90 G;
    ...
    public int V;
    public boolean W;
    public StaticLayout f20449a;
    public String f20450b;
    public int f20451c;
    public int d;
    public SpannableStringBuilder e;
    public SpannableStringBuilder f20452f;
    public final TextView h;
    public final c f20453n;
    public final FrameLayout f20454r;
    public final FrameLayout f20455s;
    public final Drawable v;
    public l90 f20456w;
    public float f20457x;
    public StaticLayout f20458y;
    ...
    public j(Context context, org.telegram.ui.ActionBar.n2 n2Var, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.K = org.telegram.ui.ActionBar.j6.Y(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19184i6, f6Var), 0, 0);
        TextView textView = new TextView(context);
        this.h = textView;
        textView.setVisibility(8);
        rk.n(org.telegram.ui.ActionBar.j6.f19496z6, f6Var, textView, 1, 13.0f);
        textView.setLines(1);
        ...
        textView2.f20073a = false;
        this.f20453n = textView2;
        textView2.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19279n6, f6Var));
    ...
    private void setShowMoreMarginBottom(int i10) {
        FrameLayout frameLayout = this.f20454r;
    ...
    public final void a(int i10, boolean z10) {
        ...
        if (spannableStringBuilder != null && (i10 != this.V || z10)) {
            ...
            this.W = z11;
            int lineCount = this.f20449a.getLineCount();
            FrameLayout frameLayout2 = this.f20454r;
            if (lineCount >= 3 && this.W) {
                int max = Math.max(this.f20449a.getLineStart(2), this.f20449a.getLineEnd(2));
                ...
                this.M = new StaticLayout[this.f20449a.getLineCount() - 3];
                this.O = new Point[this.f20449a.getLineCount() - 3];
                ...
                for (int i15 = 3; i15 < this.f20449a.getLineCount(); i15++) {
                    int lineStart = this.f20449a.getLineStart(i15);
                    int lineEnd = this.f20449a.getLineEnd(i15);
            ...
            if (this.W && this.L != null) {
                ...
                int min = Math.min(f20447a0 + i11, g()) - AndroidUtilities.dp(8.0f);
    ...
    public final void d(ClickableSpan clickableSpan, Layout layout, float f7) {
        ...
        if (clickableSpan instanceof a61) {
            ...
            ((u01) this).f37921c0.e.B4(url, this.F);
    ...
    public final void f(String str, String str2, boolean z10) {
        if (!TextUtils.isEmpty(str) && !TextUtils.equals(str, this.f20450b)) {
            try {
                this.f20450b = AndroidUtilities.getSafeString(str);
            } catch (Throwable unused) {
                this.f20450b = str;
            }
            SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(this.f20450b);
    ...
    public final int g() {
        int dp;
        StaticLayout staticLayout = this.f20449a;
    ...
    public final void h() {
        ...
        float f7 = this.T;
        float g10 = g();
        float min = Math.min(f20447a0, g10);
    ...
    public final int i() {
        ...
        float min = Math.min(f20447a0 + i10, g());
        if (this.W) {
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (this.f20449a != null) {
            SpannableStringBuilder spannableStringBuilder = this.f20452f;
            if (spannableStringBuilder == null) {
                ...
                if (spannableStringBuilder2 == null) {
                    ...
                    if (clickableSpanArr != null && clickableSpanArr.length != 0) {
                        ...
                        this.f20452f = spannableStringBuilder3;
                        spannableStringBuilder = spannableStringBuilder3;
                    } else {
                        spannableStringBuilder = this.e;
                        this.f20452f = spannableStringBuilder;
                    }
                }
            }
