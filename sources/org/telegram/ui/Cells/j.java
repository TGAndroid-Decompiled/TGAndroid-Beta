...
public abstract class j extends FrameLayout {
    public static final int f20250a0 = AndroidUtilities.dp(76.0f);
    public static final int f20251b0 = View.MeasureSpec.makeMeasureSpec(999999, Integer.MIN_VALUE);
    public final a90 E;
    public h F;
    public h90 G;
    ...
    public j(Context context, org.telegram.ui.ActionBar.n2 n2Var, org.telegram.ui.ActionBar.d6 d6Var) {
        ...
        this.K = org.telegram.ui.ActionBar.h6.Y(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f18878i6, d6Var), 0, 0);
        TextView textView = new TextView(context);
        this.h = textView;
        textView.setVisibility(8);
        ul.o(org.telegram.ui.ActionBar.h6.f19189z6, d6Var, textView, 1, 13.0f);
        textView.setLines(1);
        ...
        textView2.f19823a = false;
        this.f20256n = textView2;
        textView2.setTextColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f18973n6, d6Var));
    ...
    private void setShowMoreMarginBottom(int i10) {
        FrameLayout frameLayout = this.f20257r;
    ...
    public final void a(int i10, boolean z10) {
        ...
        if (spannableStringBuilder != null && (i10 != this.V || z10)) {
            ...
            this.W = z11;
            int lineCount = this.f20252a.getLineCount();
            FrameLayout frameLayout2 = this.f20257r;
            if (lineCount >= 3 && this.W) {
                int max = Math.max(this.f20252a.getLineStart(2), this.f20252a.getLineEnd(2));
                ...
                this.M = new StaticLayout[this.f20252a.getLineCount() - 3];
                this.O = new Point[this.f20252a.getLineCount() - 3];
                ...
                for (int i15 = 3; i15 < this.f20252a.getLineCount(); i15++) {
                    int lineStart = this.f20252a.getLineStart(i15);
                    int lineEnd = this.f20252a.getLineEnd(i15);
            ...
            if (this.W && this.L != null) {
                ...
                int min = Math.min(f20250a0 + i11, g()) - AndroidUtilities.dp(8.0f);
    ...
    public final void d(ClickableSpan clickableSpan, Layout layout, float f7) {
        ...
        if (clickableSpan instanceof l51) {
            ...
            ((n01) this).f35417c0.e.B4(url, this.F);
    ...
    public final void f(String str, String str2, boolean z10) {
        if (!TextUtils.isEmpty(str) && !TextUtils.equals(str, this.f20253b)) {
            try {
                this.f20253b = AndroidUtilities.getSafeString(str);
            } catch (Throwable unused) {
                this.f20253b = str;
            }
            SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(this.f20253b);
    ...
    public final int g() {
        int dp;
        StaticLayout staticLayout = this.f20252a;
    ...
    public final void h() {
        ...
        float f7 = this.T;
        float g10 = g();
        float min = Math.min(f20250a0, g10);
    ...
    public final int i() {
        ...
        float min = Math.min(f20250a0 + i10, g());
        if (this.W) {
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (this.f20252a != null) {
            SpannableStringBuilder spannableStringBuilder = this.f20255f;
            if (spannableStringBuilder == null) {
                ...
                if (spannableStringBuilder2 == null) {
                    ...
                    if (clickableSpanArr != null && clickableSpanArr.length != 0) {
                        ...
                        this.f20255f = spannableStringBuilder3;
                        spannableStringBuilder = spannableStringBuilder3;
                    } else {
                        spannableStringBuilder = this.e;
                        this.f20255f = spannableStringBuilder;
                    }
                }
            }
