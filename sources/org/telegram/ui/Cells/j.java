...
public abstract class j extends FrameLayout {
    public static final int f20439a0 = AndroidUtilities.dp(76.0f);
    public static final int f20440b0 = View.MeasureSpec.makeMeasureSpec(999999, Integer.MIN_VALUE);
    public final i90 E;
    public h F;
    public p90 G;
    ...
    public int V;
    public boolean W;
    public StaticLayout f20441a;
    public String f20442b;
    public int f20443c;
    public int d;
    public SpannableStringBuilder e;
    public SpannableStringBuilder f20444f;
    public final TextView h;
    public final c f20445n;
    public final FrameLayout f20446r;
    public final FrameLayout f20447s;
    public final Drawable v;
    public m90 f20448w;
    public float f20449x;
    public StaticLayout f20450y;
    ...
    public j(Context context, org.telegram.ui.ActionBar.n2 n2Var, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        this.K = org.telegram.ui.ActionBar.j6.Y(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19152i6, e6Var), 0, 0);
        TextView textView = new TextView(context);
        this.h = textView;
        textView.setVisibility(8);
        wh.m(org.telegram.ui.ActionBar.j6.f19464z6, e6Var, textView, 1, 13.0f);
        textView.setLines(1);
        ...
        mutate.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(i11, e6Var), PorterDuff.Mode.SRC_ATOP));
        ...
        textView2.f20038a = false;
        this.f20445n = textView2;
        textView2.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19247n6, e6Var));
        ...
        this.f20446r = frameLayout3;
        Drawable mutate2 = context.getResources().getDrawable(R.drawable.gradient_left).mutate();
        this.v = mutate2;
        mutate2.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(i11, e6Var), PorterDuff.Mode.MULTIPLY));
    ...
    private void setShowMoreMarginBottom(int i10) {
        FrameLayout frameLayout = this.f20446r;
    ...
    public final void a(int i10, boolean z10) {
        ...
        if (spannableStringBuilder != null && (i10 != this.V || z10)) {
            ...
            this.W = z11;
            int lineCount = this.f20441a.getLineCount();
            FrameLayout frameLayout2 = this.f20446r;
            if (lineCount >= 3 && this.W) {
                int max = Math.max(this.f20441a.getLineStart(2), this.f20441a.getLineEnd(2));
                ...
                this.M = new StaticLayout[this.f20441a.getLineCount() - 3];
                this.O = new Point[this.f20441a.getLineCount() - 3];
                ...
                for (int i15 = 3; i15 < this.f20441a.getLineCount(); i15++) {
                    int lineStart = this.f20441a.getLineStart(i15);
                    int lineEnd = this.f20441a.getLineEnd(i15);
            ...
            if (this.W && this.L != null) {
                ...
                int min = Math.min(f20439a0 + i11, g()) - AndroidUtilities.dp(8.0f);
    ...
    public final void d(ClickableSpan clickableSpan, Layout layout, float f7) {
        ...
        if (clickableSpan instanceof b61) {
            ...
            ((u01) this).f37843c0.e.B4(url, this.F);
    ...
    public final void f(String str, String str2, boolean z10) {
        if (!TextUtils.isEmpty(str) && !TextUtils.equals(str, this.f20442b)) {
            try {
                this.f20442b = AndroidUtilities.getSafeString(str);
            } catch (Throwable unused) {
                this.f20442b = str;
            }
            SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(this.f20442b);
    ...
    public final int g() {
        int dp;
        StaticLayout staticLayout = this.f20441a;
    ...
    public final void h() {
        ...
        float f7 = this.T;
        float g10 = g();
        float min = Math.min(f20439a0, g10);
    ...
    public final int i() {
        ...
        float min = Math.min(f20439a0 + i10, g());
        if (this.W) {
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (this.f20441a != null) {
            SpannableStringBuilder spannableStringBuilder = this.f20444f;
            if (spannableStringBuilder == null) {
                ...
                if (spannableStringBuilder2 == null) {
                    ...
                    if (clickableSpanArr != null && clickableSpanArr.length != 0) {
                        ...
                        this.f20444f = spannableStringBuilder3;
                        spannableStringBuilder = spannableStringBuilder3;
                    } else {
                        spannableStringBuilder = this.e;
                        this.f20444f = spannableStringBuilder;
                    }
                }
            }
