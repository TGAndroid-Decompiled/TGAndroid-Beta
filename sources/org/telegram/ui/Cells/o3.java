...
public final class o3 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final TextView f20541c;
    public final org.telegram.ui.Components.u9 d;
    public final xh0 e;
    public final TextView f20542f;
    public final rg.p0 h;
    public AnimatorSet f20543n;
    public TLRPC.StickerSetCovered f20544r;
    ...
    public o3(Context context, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        float f13;
        float f14;
        this.f20539a = UserConfig.selectedAccount;
    ...
    public final void a(TLRPC.StickerSetCovered stickerSetCovered, boolean z10, boolean z11, boolean z12) {
        ...
        AnimatorSet animatorSet = this.f20543n;
        ...
        this.f20546w = z10;
        this.f20544r = stickerSetCovered;
        setWillNotDraw(!z10);
        String str2 = this.f20544r.set.title;
        TextView textView = this.f20540b;
        ...
        this.f20541c.setText(LocaleController.formatPluralString(str, stickerSet2.count, new Object[0]));
        ...
        if (z15 && (stickerSet = stickerSetCovered.set) != null) {
            this.f20548y = Long.valueOf(stickerSet.f18136id);
            if (!this.f20547x) {
            ...
            if (stickerSet3 != null && (arrayList = stickerSet3.documents) != null && !arrayList.isEmpty()) {
                ...
                while (true) {
                    if (i11 >= stickerSet3.documents.size()) {
                        break;
                    } else if (stickerSet3.documents.get(i11).f18115id == stickerSetCovered.set.thumb_document_id) {
                ...
                if (!stickerSetCovered.covers.isEmpty()) {
                    ...
                    if (stickerSetCovered.set != null) {
                        for (int i12 = 0; i12 < stickerSetCovered.covers.size(); i12++) {
                            if (stickerSetCovered.covers.get(i12).f18115id == stickerSetCovered.set.thumb_document_id) {
                    ...
                    if (!tL_stickerSetFullCovered.documents.isEmpty()) {
                        ...
                        for (int i13 = 0; i13 < arrayList2.size(); i13++) {
                            if (arrayList2.get(i13).f18115id == stickerSetCovered.set.thumb_document_id) {
        ...
        if (document != null) {
            if (MessageObject.canAutoplayAnimatedSticker(document)) {
                ...
                SvgHelper.SvgDrawable svgThumb = DocumentObject.getSvgThumb(stickerSetCovered.set.thumbs, org.telegram.ui.ActionBar.i6.f18778a7, 1.0f);
        ...
        this.E = z11;
        if (!z11 && !MediaDataController.getInstance(i10).isStickerPackInstalled(stickerSetCovered2.set.f18136id)) {
            z13 = false;
        } else {
            z13 = true;
        }
        ...
        this.v = z14;
        rg.p0 p0Var = this.h;
        TextView textView2 = this.f20542f;
        if (z12) {
            if (z14) {
            ...
            this.f20543n = animatorSet2;
            animatorSet2.setDuration(250L);
            AnimatorSet animatorSet3 = this.f20543n;
            if (this.f20545s && !this.v) {
                f7 = 1.0f;
            } else {
                f7 = 0.0f;
            }
            ...
            this.f20543n.addListener(new m3(this));
            this.f20543n.setInterpolator(new OvershootInterpolator(1.02f));
            this.f20543n.start();
        } else if (z14) {
            p0Var.setVisibility(0);
            p0Var.setAlpha(1.0f);
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.groupStickersDidLoad) {
            ...
            if (l4 != null && l4.longValue() == longValue) {
                ...
                a(tL_stickerSetNoCovered, this.f20546w, this.E, true);
            }
        }
    }
    ...
    public final void onDetachedFromWindow() {
        ...
        if (this.f20547x) {
            NotificationCenter.getInstance(this.f20539a).removeObserver(this, NotificationCenter.groupStickersDidLoad);
            this.f20547x = false;
        }
    }
    ...
    public final void onMeasure(int i10, int i11) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i10), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(64.0f) + (this.f20546w ? 1 : 0), 1073741824));
        int measuredWidth = this.e.getMeasuredWidth();
        TextView textView = this.f20542f;
        ...
        measureChildWithMargins(this.f20540b, i10, measuredWidth, i11, 0);
    }
