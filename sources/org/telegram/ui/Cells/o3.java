...
public final class o3 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final TextView f20552c;
    public final org.telegram.ui.Components.u9 d;
    public final xh0 e;
    public final TextView f20553f;
    public final rg.p0 h;
    public AnimatorSet f20554n;
    public TLRPC.StickerSetCovered f20555r;
    public boolean f20556s;
    public boolean v;
    ...
    public o3(Context context, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        float f13;
        float f14;
        this.f20550a = UserConfig.selectedAccount;
        ...
        this.f20552c = textView2;
        wl.r(textView2, org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f19237z6, false), 1, 13.0f, 1);
        ...
        this.f20553f = textView3;
        textView3.setGravity(17);
        org.telegram.messenger.w1.q(textView3, org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.Rh, false), 1, 14.0f);
    ...
    public final void a(TLRPC.StickerSetCovered stickerSetCovered, boolean z10, boolean z11, boolean z12) {
        ...
        AnimatorSet animatorSet = this.f20554n;
        ...
        this.f20557w = z10;
        this.f20555r = stickerSetCovered;
        setWillNotDraw(!z10);
        String str2 = this.f20555r.set.title;
        ...
        this.f20552c.setText(LocaleController.formatPluralString(str, stickerSet2.count, new Object[0]));
        ...
        if (z15 && (stickerSet = stickerSetCovered.set) != null) {
            this.f20559y = Long.valueOf(stickerSet.f18139id);
            if (!this.f20558x) {
            ...
            if (stickerSet3 != null && (arrayList = stickerSet3.documents) != null && !arrayList.isEmpty()) {
                ...
                while (true) {
                    if (i11 >= stickerSet3.documents.size()) {
                        break;
                    } else if (stickerSet3.documents.get(i11).f18118id == stickerSetCovered.set.thumb_document_id) {
                ...
                if (!stickerSetCovered.covers.isEmpty()) {
                    ...
                    if (stickerSetCovered.set != null) {
                        for (int i12 = 0; i12 < stickerSetCovered.covers.size(); i12++) {
                            if (stickerSetCovered.covers.get(i12).f18118id == stickerSetCovered.set.thumb_document_id) {
                    ...
                    if (!tL_stickerSetFullCovered.documents.isEmpty()) {
                        ...
                        for (int i13 = 0; i13 < arrayList2.size(); i13++) {
                            if (arrayList2.get(i13).f18118id == stickerSetCovered.set.thumb_document_id) {
        ...
        if (document != null) {
            if (MessageObject.canAutoplayAnimatedSticker(document)) {
                ...
                SvgHelper.SvgDrawable svgThumb = DocumentObject.getSvgThumb(stickerSetCovered.set.thumbs, org.telegram.ui.ActionBar.i6.f18780a7, 1.0f);
        ...
        this.E = z11;
        if (!z11 && !MediaDataController.getInstance(i10).isStickerPackInstalled(stickerSetCovered2.set.f18139id)) {
            z13 = false;
        } else {
            z13 = true;
        }
        ...
        if (z12) {
            ...
            this.f20554n = animatorSet2;
            animatorSet2.setDuration(250L);
            AnimatorSet animatorSet3 = this.f20554n;
            if (this.f20556s && !this.v) {
                f7 = 1.0f;
            } else {
                f7 = 0.0f;
            }
            ...
            this.f20554n.addListener(new m3(this));
            this.f20554n.setInterpolator(new OvershootInterpolator(1.02f));
            this.f20554n.start();
        } else if (z14) {
            p0Var.setVisibility(0);
            p0Var.setAlpha(1.0f);
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.groupStickersDidLoad) {
            ...
            if (l4 != null && l4.longValue() == longValue) {
                ...
                a(tL_stickerSetNoCovered, this.f20557w, this.E, true);
            }
        }
    }
    ...
    public final void onDetachedFromWindow() {
        ...
        if (this.f20558x) {
            NotificationCenter.getInstance(this.f20550a).removeObserver(this, NotificationCenter.groupStickersDidLoad);
            this.f20558x = false;
        }
    }
    ...
    public final void onMeasure(int i10, int i11) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i10), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(64.0f) + (this.f20557w ? 1 : 0), 1073741824));
        ...
        measureChildWithMargins(this.f20551b, i10, measuredWidth, i11, 0);
    }

    public void setAddOnClickListener(View.OnClickListener onClickListener) {
        this.e.setOnClickListener(onClickListener);
        this.f20553f.setOnClickListener(onClickListener);
    }
}
