...
public final class o3 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final yh0 e;
    public final TextView f20563f;
    public final rg.p0 h;
    public AnimatorSet f20564n;
    public TLRPC.StickerSetCovered f20565r;
    ...
    public o3(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        float f13;
        float f14;
        this.f20560a = UserConfig.selectedAccount;
        ...
        wl.r(textView2, org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19263z6, false), 1, 13.0f, 1);
    ...
    public final void a(TLRPC.StickerSetCovered stickerSetCovered, boolean z10, boolean z11, boolean z12) {
        ...
        AnimatorSet animatorSet = this.f20564n;
        ...
        this.f20567w = z10;
        this.f20565r = stickerSetCovered;
        setWillNotDraw(!z10);
        String str2 = this.f20565r.set.title;
        TextView textView = this.f20561b;
        ...
        this.f20562c.setText(LocaleController.formatPluralString(str, stickerSet2.count, new Object[0]));
        ...
        if (z15 && (stickerSet = stickerSetCovered.set) != null) {
            this.f20569y = Long.valueOf(stickerSet.f18148id);
            if (!this.f20568x) {
        ...
        if (document != null) {
            if (MessageObject.canAutoplayAnimatedSticker(document)) {
                ...
                SvgHelper.SvgDrawable svgThumb = DocumentObject.getSvgThumb(stickerSetCovered.set.thumbs, org.telegram.ui.ActionBar.j6.f18806a7, 1.0f);
        ...
        this.v = z14;
        rg.p0 p0Var = this.h;
        TextView textView2 = this.f20563f;
        if (z12) {
            if (z14) {
            ...
            this.f20564n = animatorSet2;
            animatorSet2.setDuration(250L);
            AnimatorSet animatorSet3 = this.f20564n;
            if (this.f20566s && !this.v) {
                f7 = 1.0f;
            } else {
                f7 = 0.0f;
            }
            ...
            this.f20564n.addListener(new m3(this));
            this.f20564n.setInterpolator(new OvershootInterpolator(1.02f));
            this.f20564n.start();
        } else if (z14) {
            p0Var.setVisibility(0);
            p0Var.setAlpha(1.0f);
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.groupStickersDidLoad) {
            ...
            if (l4 != null && l4.longValue() == longValue) {
                ...
                a(tL_stickerSetNoCovered, this.f20567w, this.E, true);
            }
        }
    }
    ...
    public final void onDetachedFromWindow() {
        ...
        if (this.f20568x) {
            NotificationCenter.getInstance(this.f20560a).removeObserver(this, NotificationCenter.groupStickersDidLoad);
            this.f20568x = false;
        }
    }
    ...
    public final void onMeasure(int i10, int i11) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i10), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(64.0f) + (this.f20567w ? 1 : 0), 1073741824));
        int measuredWidth = this.e.getMeasuredWidth();
        TextView textView = this.f20563f;
        ...
        measureChildWithMargins(this.f20561b, i10, measuredWidth, i11, 0);
    }

    public void setAddOnClickListener(View.OnClickListener onClickListener) {
        this.e.setOnClickListener(onClickListener);
        this.f20563f.setOnClickListener(onClickListener);
    }
}
