...
public final class o3 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public o3(Context context, org.telegram.ui.ActionBar.g6 g6Var) {
        ...
        float f14;
        float f15;
        this.f23290a = UserConfig.selectedAccount;
    ...
    public final void a(TLRPC.StickerSetCovered stickerSetCovered, boolean z4, boolean z10, boolean z11) {
        ...
        this.f23298w = z4;
        this.f23296r = stickerSetCovered;
        setWillNotDraw(!z4);
        String str2 = this.f23296r.set.title;
        TextView textView = this.f23291b;
        ...
        this.f23292c.setText(LocaleController.formatPluralString(str, stickerSet2.count, new Object[0]));
        ...
        if (z14 && (stickerSet = stickerSetCovered.set) != null) {
            this.f23300y = Long.valueOf(stickerSet.f20872id);
            if (!this.f23299x) {
            ...
            if (stickerSet3 != null && (arrayList = stickerSet3.documents) != null && !arrayList.isEmpty()) {
                ...
                while (true) {
                    if (i11 >= stickerSet3.documents.size()) {
                        break;
                    } else if (stickerSet3.documents.get(i11).f20851id == stickerSetCovered.set.thumb_document_id) {
                ...
                if (!stickerSetCovered.covers.isEmpty()) {
                    ...
                    if (stickerSetCovered.set != null) {
                        for (int i12 = 0; i12 < stickerSetCovered.covers.size(); i12++) {
                            if (stickerSetCovered.covers.get(i12).f20851id == stickerSetCovered.set.thumb_document_id) {
                    ...
                    if (!tL_stickerSetFullCovered.documents.isEmpty()) {
                        ...
                        for (int i13 = 0; i13 < arrayList2.size(); i13++) {
                            if (arrayList2.get(i13).f20851id == stickerSetCovered.set.thumb_document_id) {
        ...
        if (document != null) {
            if (MessageObject.canAutoplayAnimatedSticker(document)) {
                ...
                SvgHelper.SvgDrawable svgThumb = DocumentObject.getSvgThumb(stickerSetCovered.set.thumbs, org.telegram.ui.ActionBar.k6.f21607a7, 1.0f);
        ...
        gi0 gi0Var = this.f23293e;
        gi0Var.setVisibility(0);
        this.B = z10;
        if (!z10 && !MediaDataController.getInstance(i10).isStickerPackInstalled(stickerSetCovered2.set.f20872id)) {
            z12 = false;
        } else {
            z12 = true;
        }
        ...
        this.v = z13;
        fg.b1 b1Var = this.h;
        TextView textView2 = this.f23294f;
        if (z11) {
            if (z13) {
            ...
            AnimatorSet animatorSet3 = this.f23295n;
            if (this.f23297s && !this.v) {
                f10 = 1.0f;
            } else {
                f10 = 0.0f;
            }
            ...
            this.f23295n.addListener(new m3(this));
            this.f23295n.setInterpolator(new OvershootInterpolator(1.02f));
            this.f23295n.start();
        } else if (z13) {
            b1Var.setVisibility(0);
            b1Var.setAlpha(1.0f);
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.groupStickersDidLoad) {
            ...
            if (l10 != null && l10.longValue() == longValue) {
                ...
                a(tL_stickerSetNoCovered, this.f23298w, this.B, true);
            }
        }
    }
    ...
    public final void onDetachedFromWindow() {
        ...
        if (this.f23299x) {
            NotificationCenter.getInstance(this.f23290a).removeObserver(this, NotificationCenter.groupStickersDidLoad);
            this.f23299x = false;
        }
    }
    ...
    public final void onMeasure(int i10, int i11) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i10), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(64.0f) + (this.f23298w ? 1 : 0), 1073741824));
        int measuredWidth = this.f23293e.getMeasuredWidth();
        TextView textView = this.f23294f;
        ...
        measureChildWithMargins(this.f23291b, i10, measuredWidth, i11, 0);
    }

    public void setAddOnClickListener(View.OnClickListener onClickListener) {
        this.f23293e.setOnClickListener(onClickListener);
        this.f23294f.setOnClickListener(onClickListener);
    }
}
