...
public final class o3 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final hi0 e;
    public final TextView f19631f;
    public final qg.s0 h;
    public AnimatorSet f19632n;
    public TLRPC.StickerSetCovered f19633r;
    public boolean f19634s;
    public boolean v;
    public boolean f19635w;
    ...
    public o3(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        float f13;
        float f14;
        this.f19628a = UserConfig.selectedAccount;
        ...
        addView(textView2, w7.a6.d(-2, -2.0f, i13, f11, 35.0f, f12, 0.0f));
        ...
        addView(w9Var, w7.a6.d(48, 48.0f, i14, f13, 8.0f, f14, 0.0f));
    ...
    public final void a(TLRPC.StickerSetCovered stickerSetCovered, boolean z10, boolean z11, boolean z12) {
        ...
        AnimatorSet animatorSet = this.f19632n;
        ...
        this.f19635w = z10;
        this.f19633r = stickerSetCovered;
        setWillNotDraw(!z10);
        String str2 = this.f19633r.set.title;
        TextView textView = this.f19629b;
        ...
        this.f19630c.setText(LocaleController.formatPluralString(str, stickerSet2.count, new Object[0]));
        ...
        if (z15 && (stickerSet = stickerSetCovered.set) != null) {
            this.f19637y = Long.valueOf(stickerSet.f17222id);
            if (!this.f19636x) {
            ...
            if (stickerSet3 != null && (arrayList = stickerSet3.documents) != null && !arrayList.isEmpty()) {
                ...
                while (true) {
                    if (i11 >= stickerSet3.documents.size()) {
                        break;
                    } else if (stickerSet3.documents.get(i11).f17201id == stickerSetCovered.set.thumb_document_id) {
                ...
                if (!stickerSetCovered.covers.isEmpty()) {
                    ...
                    if (stickerSetCovered.set != null) {
                        for (int i12 = 0; i12 < stickerSetCovered.covers.size(); i12++) {
                            if (stickerSetCovered.covers.get(i12).f17201id == stickerSetCovered.set.thumb_document_id) {
                    ...
                    if (!tL_stickerSetFullCovered.documents.isEmpty()) {
                        ...
                        for (int i13 = 0; i13 < arrayList2.size(); i13++) {
                            if (arrayList2.get(i13).f17201id == stickerSetCovered.set.thumb_document_id) {
        ...
        if (document != null) {
            if (MessageObject.canAutoplayAnimatedSticker(document)) {
                ...
                SvgHelper.SvgDrawable svgThumb = DocumentObject.getSvgThumb(stickerSetCovered.set.thumbs, org.telegram.ui.ActionBar.j6.f17872a7, 1.0f);
        ...
        this.E = z11;
        if (!z11 && !MediaDataController.getInstance(i10).isStickerPackInstalled(stickerSetCovered2.set.f17222id)) {
            z13 = false;
        } else {
            z13 = true;
        }
        ...
        this.v = z14;
        qg.s0 s0Var = this.h;
        TextView textView2 = this.f19631f;
        if (z12) {
            if (z14) {
            ...
            this.f19632n = animatorSet2;
            animatorSet2.setDuration(250L);
            AnimatorSet animatorSet3 = this.f19632n;
            if (this.f19634s && !this.v) {
                f7 = 1.0f;
            } else {
                f7 = 0.0f;
            }
            ...
            ObjectAnimator ofFloat6 = ObjectAnimator.ofFloat(s0Var, property3, f14);
            if (!this.v) {
                f15 = 0.0f;
            } else {
                f15 = 1.0f;
            }
            ObjectAnimator ofFloat7 = ObjectAnimator.ofFloat(s0Var, property2, f15);
            if (!this.v) {
                f16 = 0.0f;
            } else {
                f16 = 1.0f;
            }
            animatorSet3.playTogether(ofFloat, ofFloat2, ofFloat3, ofFloat4, ofFloat5, ofFloat6, ofFloat7, ObjectAnimator.ofFloat(s0Var, property3, f16));
            this.f19632n.addListener(new m3(this));
            this.f19632n.setInterpolator(new OvershootInterpolator(1.02f));
            this.f19632n.start();
        } else if (z14) {
            s0Var.setVisibility(0);
            s0Var.setAlpha(1.0f);
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.groupStickersDidLoad) {
            ...
            if (l4 != null && l4.longValue() == longValue) {
                ...
                a(tL_stickerSetNoCovered, this.f19635w, this.E, true);
            }
        }
    }
    ...
    public final void onDetachedFromWindow() {
        ...
        if (this.f19636x) {
            NotificationCenter.getInstance(this.f19628a).removeObserver(this, NotificationCenter.groupStickersDidLoad);
            this.f19636x = false;
        }
    }
    ...
    public final void onMeasure(int i10, int i11) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i10), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(64.0f) + (this.f19635w ? 1 : 0), 1073741824));
        int measuredWidth = this.e.getMeasuredWidth();
        TextView textView = this.f19631f;
        ...
        measureChildWithMargins(this.f19629b, i10, measuredWidth, i11, 0);
    }

    public void setAddOnClickListener(View.OnClickListener onClickListener) {
        this.e.setOnClickListener(onClickListener);
        this.f19631f.setOnClickListener(onClickListener);
    }
}
