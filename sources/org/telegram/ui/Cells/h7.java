...
public class h7 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public long L;
    public u01 M;
    public final org.telegram.ui.Components.v9 f20397a;
    public final ai.p4 f20398b;
    public final org.telegram.ui.ActionBar.j5 f20399c;
    public final np d;
    public final f7 e;
    public g7 f20400f;
    public TLRPC.User h;
    ...
    public final org.telegram.ui.ActionBar.f6 f20406y;
    ...
    public h7(Context context, int i10, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        float f10;
        float f11;
        this.f20405x = UserConfig.selectedAccount;
        qr qrVar = qr.h;
        ...
        setBackground(org.telegram.ui.ActionBar.j6.Y(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19184i6, f6Var), AndroidUtilities.dp(2.0f), AndroidUtilities.dp(2.0f)));
    }
    ...
    public final void c(long j3, boolean z10, CharSequence charSequence) {
        ...
        f7 f7Var = this.e;
        f7Var.f24302p = 1.0f;
        org.telegram.ui.ActionBar.f6 f6Var = this.f20406y;
        org.telegram.ui.Components.v9 v9Var = this.f20397a;
        ai.p4 p4Var = this.f20398b;
        if (j3 == Long.MAX_VALUE) {
            p4Var.setText(a());
            if (this.f20400f == null) {
                this.f20400f = new g7(getContext(), v9Var, true, f6Var);
            }
            v9Var.h(null, null, this.f20400f, null);
        } else {
    ...
    public final void d(TLRPC.TL_forumTopic tL_forumTopic, boolean z10, boolean z11) {
        ...
        org.telegram.ui.ActionBar.j5 j5Var = this.f20399c;
        ...
        if (z12) {
            if (z10) {
                j5Var.l(MessagesController.getInstance(this.f20405x).getPeerName(DialogObject.getPeerDialogId(tL_forumTopic.from_id)), false);
            } else {
        ...
        if (z11) {
            ...
            kVar2.b(new o1.g() {
                ...
                public final void a(o1.h hVar, float f11, float f12) {
                    ...
                    h7 h7Var = h7.this;
                    org.telegram.ui.ActionBar.j5 j5Var2 = h7Var.f20399c;
                    j5Var2.setAlpha(f13);
                    ai.p4 p4Var = h7Var.f20398b;
                    float f14 = 1.0f - f13;
                    p4Var.setAlpha(f14);
            ...
            kVar2.a(new o1.f() {
                ...
                public final void a(o1.h hVar, boolean z14, float f11, float f12) {
                    h7.this.f20399c.setTag(R.id.spring_tag, null);
                }
            });
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.userIsPremiumBlockedUpadted) {
            TLRPC.User user = this.h;
            int i13 = this.f20405x;
            if (user != null) {
                requirementToContact = MessagesController.getInstance(i13).isUserContactBlocked(this.h.f18475id);
            } else {
            ...
            if (this.F != DialogObject.isPremiumBlocked(requirementToContact) || this.H != messagesStarsPrice) {
                ...
                this.f20398b.setTextColor(org.telegram.ui.ActionBar.j6.v0(i12, this.f20406y));
                invalidate();
            }
        }
    }
    ...
    public final void onAttachedToWindow() {
        ...
        NotificationCenter.getInstance(this.f20405x).addObserver(this, NotificationCenter.userIsPremiumBlockedUpadted);
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        NotificationCenter.getInstance(this.f20405x).removeObserver(this, NotificationCenter.userIsPremiumBlockedUpadted);
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        org.telegram.ui.ActionBar.j6.f19290o0.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.B5, this.f20406y));
        org.telegram.ui.ActionBar.j6.f19290o0.setAlpha((int) (this.d.getProgress() * 255.0f));
        if (this.f20401n == 2) {
            f7 = 24.0f;
        } else {
            f7 = 28.0f;
        ...
        canvas.drawRoundRect(rectF, v9Var.getRoundRadius()[0], v9Var.getRoundRadius()[0], org.telegram.ui.ActionBar.j6.f19290o0);
        super.onDraw(canvas);
    }
