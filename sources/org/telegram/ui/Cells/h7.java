...
public final class h7 extends FrameLayout {
    public final org.telegram.ui.Components.w9 f20389a;
    public final e7 f20390b;
    ...
    public h7(Context context, org.telegram.ui.ActionBar.d6 d6Var) {
        super(context);
        this.f20392f = UserConfig.selectedAccount;
        this.h = d6Var;
        ...
        this.f20391c = textView;
        ok.n(org.telegram.ui.ActionBar.h6.f19151j5, d6Var, textView, 1, 12.0f);
        textView.setMaxLines(2);
        textView.setGravity(49);
        textView.setLines(2);
        textView.setEllipsize(TextUtils.TruncateAt.END);
        addView(textView, w7.y5.d(-1, -2.0f, 51, 6.0f, 66.0f, 6.0f, 0.0f));
        this.f20390b = new e7(this, d6Var, 1);
        setBackground(org.telegram.ui.ActionBar.h6.Y(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19134i6, false), AndroidUtilities.dp(2.0f), AndroidUtilities.dp(2.0f)));
    }
    ...
    public void setAsNewBotForumTopic(boolean z10) {
        ...
        this.f20391c.setText(LocaleController.getString(i10));
        org.telegram.ui.Components.w9 w9Var = this.f20389a;
        w9Var.setAnimatedEmojiDrawable(null);
        ng.a aVar = new ng.a(ng.a.f15429k[0]);
