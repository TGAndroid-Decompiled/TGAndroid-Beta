...
public final class x0 extends FrameLayout {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        w0 w0Var = this.f25907a;
        w0Var.b(org.telegram.ui.ActionBar.g6.w0(null, org.telegram.ui.ActionBar.g6.f23118g7, false), org.telegram.ui.ActionBar.g6.w0(null, org.telegram.ui.ActionBar.g6.f23135h7, false));
        RectF rectF = this.f25909c;
        ...
        org.telegram.ui.ActionBar.g6.f23340t0.setColor(Color.argb((int) ((1.0f - w0Var.getProgress()) * 31.0f), red, green, blue));
        canvas.drawRoundRect(rectF, AndroidUtilities.dp(6.0f), AndroidUtilities.dp(6.0f), org.telegram.ui.ActionBar.g6.f23340t0);
        ...
        for (int i15 = 2; i14 < i15; i15 = 2) {
            ...
            canvas.drawCircle(AndroidUtilities.dp(22.0f), dp, AndroidUtilities.dp(11.0f), org.telegram.ui.ActionBar.g6.f23340t0);
            int i16 = 0;
            while (true) {
                if (z10) {
                    i12 = 3;
                ...
                if (i16 < i12) {
                    ...
                    if (z10) {
                        ...
                        canvas.drawRoundRect(rectF, AndroidUtilities.dpf2(1.5f), AndroidUtilities.dpf2(1.5f), org.telegram.ui.ActionBar.g6.f23340t0);
                    } else {
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        accessibilityNodeInfo.setChecked(this.f25907a.f26519f);
