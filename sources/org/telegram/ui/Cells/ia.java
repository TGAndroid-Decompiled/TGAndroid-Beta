...
public final class ia implements k1, ah.k, me.a, qg.y1, com.google.android.gms.common.api.internal.o, s4.e0, n5.b, v0.i, com.google.android.gms.common.api.internal.s {
    ...
    public void a() {
        ArrayList arrayList = (ArrayList) this.f20291b;
    ...
    public void b(Canvas canvas) {
        switch (this.f20290a) {
            case 1:
                vi viVar = (vi) this.f20291b;
                canvas.drawColor(viVar.getThemedColor(org.telegram.ui.ActionBar.j6.f18863d6));
                ...
                return;
            default:
                iq0 iq0Var = (iq0) this.f20291b;
                canvas.drawColor(iq0Var.getThemedColor(org.telegram.ui.ActionBar.j6.f18863d6));
                if (SharedConfig.chatBlurEnabled()) {
    ...
    public void c(Object obj) {
        ((g8.c) obj).onLocationAvailability((LocationAvailability) this.f20291b);
    }

    @Override
    public boolean c1(int i10, t1 t1Var) {
        if (i10 == ((ja) this.f20291b).f20355s) {
            return true;
        }
        return false;
    }
    ...
    public void d(s4.a aVar) {
        RecyclerView recyclerView = (RecyclerView) this.f20291b;
        ...
        if (i10 != 1) {
            if (i10 != 2) {
                if (i10 != 4) {
                    ...
                    recyclerView.f2868x.X(recyclerView, aVar.f42667b, aVar.d);
                    return;
                }
                recyclerView.f2868x.a0(recyclerView, aVar.f42667b, aVar.d, aVar.f42668c);
                return;
            }
            recyclerView.f2868x.Y(recyclerView, aVar.f42667b, aVar.d);
            return;
        }
        recyclerView.f2868x.V(recyclerView, aVar.f42667b, aVar.d);
    }

    @Override
    public boolean e() {
        return ((ja) this.f20291b).a();
    }
    ...
    public void g(za.a0 a0Var) {
        ((l5.r) ((i5.f) ((pa.b) this.f20291b).get())).a("FIREBASE_APPQUALITY_SESSION", new i5.c("json"), new r5.d(this, 28)).a(new i5.a(null, a0Var, i5.d.f10996a, null), new j2.e(18));
    }

    @Override
    public Object mo28get() {
        String packageName = ((Context) ((fd.a) this.f20291b).mo28get()).getPackageName();
        if (packageName != null) {
            return packageName;
        }
    ...
    public void k0(int i10, int i11) {
        ((s4.h0) this.f20291b).s(i10, i11);
    }

    @Override
    public void l(float f7) {
        qg.z0 z0Var = (qg.z0) this.f20291b;
        pg.s0.e(z0Var.f41751a).k("-1", f7);
    ...
    public void l1(int i10, int i11) {
        ((s4.h0) this.f20291b).r(i10, i11, null);
    }
    ...
    public void m(ah.a aVar) {
        switch (this.f20290a) {
            case 1:
                aVar.a(((vi) this.f20291b).getThemedColor(org.telegram.ui.ActionBar.j6.f18863d6));
                aVar.b(SharedConfig.chatBlurEnabled());
                return;
            default:
                aVar.a(((iq0) this.f20291b).getThemedColor(org.telegram.ui.ActionBar.j6.f18863d6));
                aVar.b(SharedConfig.chatBlurEnabled());
                return;
        }
    }
    ...
    public boolean needClickAt(View view, float f7, float f10) {
        ...
        i61 i61Var = (i61) this.f20291b;
        float f11 = -dp;
        i61Var.f24833g.inset(f11, f11);
        boolean contains = i61Var.f24833g.contains(f7, f10);
        float f12 = dp;
        i61Var.f24833g.inset(f12, f12);
        return contains;
    }
    ...
    public void onClickAt(View view, float f7, float f10) {
        Runnable runnable = ((i61) this.f20291b).f24835j;
        if (runnable != null) {
            runnable.run();
        }
    }
    ...
    public void q(int i10, int i11, Object obj) {
        ...
        for (int i15 = 0; i15 < L; i15++) {
            ...
            if (V != null && !V.r() && (i13 = V.f42704c) >= i10 && i13 < i14) {
                V.a(2);
                if (obj == null) {
                    V.a(1024);
                } else if ((1024 & V.f42710l) == 0) {
                    if (V.f42711m == null) {
                        ArrayList arrayList = new ArrayList();
                        V.f42711m = arrayList;
                        V.f42712n = DesugarCollections.unmodifiableList(arrayList);
                    }
                    V.f42711m.add(obj);
                }
                ((s4.p0) K.getLayoutParams()).f42810c = true;
            }
        }
        ...
        for (int size = arrayList2.size() - 1; size >= 0; size--) {
            ...
            if (c1Var != null && (i12 = c1Var.f42704c) >= i10 && i12 < i14) {
                c1Var.a(2);
                eVar.f(size);
            }
        }
    ...
    public void v(int i10, int i11) {
        ...
        for (int i12 = 0; i12 < L; i12++) {
            ...
            if (V != null && !V.r() && V.f42704c >= i10) {
                V.n(i11, false);
                recyclerView.f2863t0.f42863f = true;
            }
        }
        ...
        for (int i13 = 0; i13 < size; i13++) {
            ...
            if (c1Var != null && c1Var.f42704c >= i10) {
                c1Var.n(i11, true);
            }
        }
    ...
    public void x(int i10, int i11) {
        ...
        for (int i20 = 0; i20 < L; i20++) {
            ...
            if (V != null && (i18 = V.f42704c) >= i13 && i18 <= i12) {
                if (i18 == i10) {
                    V.n(i11 - i10, false);
                } else {
                    V.n(i14, false);
        ...
        for (int i21 = 0; i21 < size; i21++) {
            ...
            if (c1Var != null && (i17 = c1Var.f42704c) >= i16 && i17 <= i15) {
                if (i17 == i10) {
    ...
    public ia(TextView textView) {
        this.f20290a = 7;
        this.f20291b = new q1.g(textView);
    }

    @Override
    public float get() {
        qg.z0 z0Var = (qg.z0) this.f20291b;
        int i10 = z0Var.f41751a;
    ...
    public ia(Context context, l20 l20Var) {
        this.f20290a = 2;
        this.f20291b = new k20(context, l20Var);
    }
