...
public class ia extends LinearLayout {
    ...
    public org.telegram.ui.Components.u9 f20466b;
    public Drawable f20467c;
    public Drawable d;
    public final u1[] e;
    public final Drawable f20468f;
    public final org.telegram.ui.ActionBar.b5 h;
    public final int f20469n;
    public org.telegram.ui.ActionBar.m2 f20470r;
    public int f20471s;
    public final g v;
    public Drawable f20472w;
    public boolean f20473x;
    public final org.telegram.ui.Components.e6 f20474y;
    ...
    public final void onAttachedToWindow() {
        ...
        Drawable drawable = this.f20472w;
    ...
    public final void onDetachedFromWindow() {
        ...
        org.telegram.ui.Components.u9 u9Var = this.f20465a;
        if (u9Var != null) {
            u9Var.dispose();
            this.f20465a = null;
        }
        org.telegram.ui.Components.u9 u9Var2 = this.f20466b;
        if (u9Var2 != null) {
            u9Var2.dispose();
            this.f20466b = null;
        }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        Drawable drawable;
        int i10;
        Drawable drawable2 = this.f20472w;
        if (drawable2 == null) {
        ...
        Drawable drawable3 = this.f20467c;
        org.telegram.ui.Components.e6 e6Var = this.f20474y;
        if (drawable2 != drawable3 && drawable2 != null) {
            if (org.telegram.ui.ActionBar.h6.sl != null || this.f20473x) {
                this.d = drawable3;
                this.f20466b = this.f20465a;
            } else {
                org.telegram.ui.Components.u9 u9Var = this.f20465a;
                if (u9Var != null) {
                    u9Var.dispose();
            ...
            this.f20467c = drawable2;
            e6Var.d(0.0f, true);
        }
        boolean z10 = this.f20473x;
        ...
        for (int i11 = 0; i11 < 2; i11++) {
            if (i11 == 0) {
                ...
                drawable = this.f20467c;
            }
            if (drawable != null) {
                if (i11 == 1 && this.d != null && (b5Var != null || this.f20473x)) {
                ...
                if (i10 > 0) {
                    ...
                    if (!(drawable instanceof ColorDrawable) && !(drawable instanceof GradientDrawable) && !(drawable instanceof nc0)) {
                        ...
                        if (drawable instanceof org.telegram.ui.Components.v9) {
                            this.f20465a = ((org.telegram.ui.Components.v9) drawable).c(canvas, this);
                        } else {
                            drawable.draw(canvas);
                        }
                    }
        ...
        Drawable drawable4 = this.f20468f;
    ...
    public void setOverrideBackground(Drawable drawable) {
        this.f20472w = drawable;
        if (drawable != null) {
            drawable.setCallback(this);
        }
        if ((this.f20472w instanceof zn) && isAttachedToWindow()) {
            ((zn) this.f20472w).f(this);
        }
        invalidate();
    }
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        if (drawable != this.f20472w && drawable != this.d && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
