...
public final class ia implements k1, ah.j, me.a, qg.y1, com.google.android.gms.common.api.internal.o, s4.e0, n5.b, v0.i, com.google.android.gms.common.api.internal.s {
    ...
    public void a() {
        ArrayList arrayList = (ArrayList) this.f20260b;
    ...
    public void accept(Object obj, Object obj2) {
        ...
        try {
            ...
            iVar.f8048a.transact(19, obtain, null, 1);
            obtain.recycle();
    ...
    public void b(Canvas canvas) {
        switch (this.f20259a) {
            case 1:
                vi viVar = (vi) this.f20260b;
                canvas.drawColor(viVar.getThemedColor(org.telegram.ui.ActionBar.i6.f18834d6));
                ...
                return;
            default:
                hq0 hq0Var = (hq0) this.f20260b;
                canvas.drawColor(hq0Var.getThemedColor(org.telegram.ui.ActionBar.i6.f18834d6));
                if (SharedConfig.chatBlurEnabled()) {
    ...
    public void c(Object obj) {
        ((g8.c) obj).onLocationAvailability((LocationAvailability) this.f20260b);
    }

    @Override
    public boolean c1(int i10, t1 t1Var) {
        if (i10 == ((ja) this.f20260b).f20319s) {
            return true;
        }
        return false;
    }
    ...
    public void d(s4.a aVar) {
        RecyclerView recyclerView = (RecyclerView) this.f20260b;
        int i10 = aVar.f42635a;
        if (i10 != 1) {
            if (i10 != 2) {
                if (i10 != 4) {
                    if (i10 != 8) {
                    ...
                    recyclerView.f2865x.X(recyclerView, aVar.f42636b, aVar.d);
                    return;
                }
                recyclerView.f2865x.a0(recyclerView, aVar.f42636b, aVar.d, aVar.f42637c);
                return;
            }
            recyclerView.f2865x.Y(recyclerView, aVar.f42636b, aVar.d);
            return;
        }
        recyclerView.f2865x.V(recyclerView, aVar.f42636b, aVar.d);
    }

    @Override
    public boolean e() {
        return ((ja) this.f20260b).a();
    }
    ...
    public void g(za.a0 a0Var) {
        ((l5.r) ((i5.f) ((pa.b) this.f20260b).get())).a("FIREBASE_APPQUALITY_SESSION", new i5.c("json"), new r5.e(this, 27)).a(new i5.a(null, a0Var, i5.d.f10995a, null), new j2.e(17));
    }

    @Override
    public Object mo28get() {
        String packageName = ((Context) ((fd.a) this.f20260b).mo28get()).getPackageName();
        if (packageName != null) {
            return packageName;
        }
    ...
    public void k0(int i10, int i11) {
        ((s4.h0) this.f20260b).s(i10, i11);
    }

    @Override
    public void l(float f7) {
        qg.z0 z0Var = (qg.z0) this.f20260b;
        pg.s0.e(z0Var.f41720a).k("-1", f7);
    ...
    public void l1(int i10, int i11) {
        ((s4.h0) this.f20260b).r(i10, i11, null);
    }
    ...
    public void m(ah.a aVar) {
        switch (this.f20259a) {
            case 1:
                aVar.a(((vi) this.f20260b).getThemedColor(org.telegram.ui.ActionBar.i6.f18834d6));
                aVar.b(SharedConfig.chatBlurEnabled());
                return;
            default:
                aVar.a(((hq0) this.f20260b).getThemedColor(org.telegram.ui.ActionBar.i6.f18834d6));
                aVar.b(SharedConfig.chatBlurEnabled());
                return;
        }
    }
    ...
    public boolean needClickAt(View view, float f7, float f10) {
        ...
        h61 h61Var = (h61) this.f20260b;
        float f11 = -dp;
        h61Var.f24532g.inset(f11, f11);
        boolean contains = h61Var.f24532g.contains(f7, f10);
        float f12 = dp;
        h61Var.f24532g.inset(f12, f12);
        return contains;
    }
    ...
    public void onClickAt(View view, float f7, float f10) {
        Runnable runnable = ((h61) this.f20260b).f24534j;
        if (runnable != null) {
            runnable.run();
        }
    }
    ...
    public void q(int i10, int i11, Object obj) {
        ...
        for (int i15 = 0; i15 < L; i15++) {
            ...
            if (U != null && !U.r() && (i13 = U.f42673c) >= i10 && i13 < i14) {
                U.a(2);
                if (obj == null) {
                    U.a(1024);
                } else if ((1024 & U.f42679l) == 0) {
                    if (U.f42680m == null) {
                        ArrayList arrayList = new ArrayList();
                        U.f42680m = arrayList;
                        U.f42681n = DesugarCollections.unmodifiableList(arrayList);
                    }
                    U.f42680m.add(obj);
                }
                ((s4.p0) K.getLayoutParams()).f42779c = true;
            }
        }
        ...
        for (int size = arrayList2.size() - 1; size >= 0; size--) {
            ...
            if (c1Var != null && (i12 = c1Var.f42673c) >= i10 && i12 < i14) {
                c1Var.a(2);
                eVar.f(size);
            }
        }
        recyclerView.f2866x0 = true;
    }
    ...
    public void v(int i10, int i11) {
        ...
        for (int i12 = 0; i12 < L; i12++) {
            ...
            if (U != null && !U.r() && U.f42673c >= i10) {
                U.n(i11, false);
                recyclerView.f2860t0.f42832f = true;
            }
        }
        ArrayList arrayList = (ArrayList) recyclerView.f2837b.e;
        int size = arrayList.size();
        for (int i13 = 0; i13 < size; i13++) {
            s4.c1 c1Var = (s4.c1) arrayList.get(i13);
            if (c1Var != null && c1Var.f42673c >= i10) {
                c1Var.n(i11, true);
            }
        }
        recyclerView.requestLayout();
        recyclerView.f2864w0 = true;
    }
    ...
    public void x(int i10, int i11) {
        ...
        for (int i20 = 0; i20 < L; i20++) {
            ...
            if (U != null && (i18 = U.f42673c) >= i13 && i18 <= i12) {
                if (i18 == i10) {
                    U.n(i11 - i10, false);
                } else {
                    U.n(i14, false);
        ...
        for (int i21 = 0; i21 < size; i21++) {
            ...
            if (c1Var != null && (i17 = c1Var.f42673c) >= i16 && i17 <= i15) {
                if (i17 == i10) {
    ...
    public ia(TextView textView) {
        this.f20259a = 7;
        this.f20260b = new q1.g(textView);
    }

    @Override
    public float get() {
        qg.z0 z0Var = (qg.z0) this.f20260b;
        int i10 = z0Var.f41720a;
    ...
    public ia(Context context, l20 l20Var) {
        this.f20259a = 2;
        this.f20260b = new k20(context, l20Var);
    }
