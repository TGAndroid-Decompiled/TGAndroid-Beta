...
public final class y0 extends FrameLayout {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        x0 x0Var = this.f23581a;
        x0Var.b(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20746g7, false), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20763h7, false));
        RectF rectF = this.f23583c;
        ...
        org.telegram.ui.ActionBar.j6.f20975t0.setColor(Color.argb((int) ((1.0f - x0Var.getProgress()) * 31.0f), red, green, blue));
        canvas.drawRoundRect(rectF, AndroidUtilities.dp(6.0f), AndroidUtilities.dp(6.0f), org.telegram.ui.ActionBar.j6.f20975t0);
        ...
        for (int i15 = 2; i14 < i15; i15 = 2) {
            ...
            canvas.drawCircle(AndroidUtilities.dp(22.0f), dp, AndroidUtilities.dp(11.0f), org.telegram.ui.ActionBar.j6.f20975t0);
            int i16 = 0;
            while (true) {
                if (z10) {
                    i12 = 3;
                ...
                if (i16 < i12) {
                    ...
                    if (z10) {
                        ...
                        canvas.drawRoundRect(rectF, AndroidUtilities.dpf2(1.5f), AndroidUtilities.dpf2(1.5f), org.telegram.ui.ActionBar.j6.f20975t0);
                    } else {
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        accessibilityNodeInfo.setChecked(this.f23581a.f24137f);
