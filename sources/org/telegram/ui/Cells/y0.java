...
public final class y0 extends FrameLayout {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        x0 x0Var = this.f21646a;
        x0Var.b(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18891g7, false), org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18909h7, false));
        RectF rectF = this.f21648c;
        ...
        org.telegram.ui.ActionBar.i6.f19124t0.setColor(Color.argb((int) ((1.0f - x0Var.getProgress()) * 31.0f), red, green, blue));
        canvas.drawRoundRect(rectF, AndroidUtilities.dp(6.0f), AndroidUtilities.dp(6.0f), org.telegram.ui.ActionBar.i6.f19124t0);
        ...
        for (int i15 = 2; i14 < i15; i15 = 2) {
            ...
            canvas.drawCircle(AndroidUtilities.dp(22.0f), dp, AndroidUtilities.dp(11.0f), org.telegram.ui.ActionBar.i6.f19124t0);
            int i16 = 0;
            while (true) {
                if (z10) {
                    i12 = 3;
                ...
                if (i16 < i12) {
                    Paint paint2 = org.telegram.ui.ActionBar.i6.f19124t0;
                    if (i16 == 0) {
                        i13 = 204;
                    } else {
                        i13 = 90;
                    ...
                    if (z10) {
                        ...
                        canvas.drawRoundRect(rectF, AndroidUtilities.dpf2(1.5f), AndroidUtilities.dpf2(1.5f), org.telegram.ui.ActionBar.i6.f19124t0);
                    } else {
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        accessibilityNodeInfo.setChecked(this.f21646a.f22162f);
