...
public abstract class n9 extends z9 {
    public boolean A0;
    public final SparseArray f23233u0 = new SparseArray();
    public boolean f23234v0;
    public boolean f23235w0;
    public boolean f23236x0;
    public boolean f23237y0;
    public boolean f23238z0;
    ...
    public final boolean D() {
        ...
        CharSequence s6;
        String str;
        if (this.f23238z0 && (u9Var = this.W) != null && ((t1) u9Var).getMessageObject() != null && (richMessageLayout = ((t1) this.W).getMessageObject().richLayout) != null && !richMessageLayout.textBlocks.isEmpty() && (s6 = s()) != null && s6.length() != 0) {
            try {
                str = richMessageLayout.getSelectionHtml(this.f24537u, this.v);
            } catch (Exception e6) {
                FileLog.e(e6);
                str = null;
            }
    ...
    public final void F(boolean z4) {
        ...
        if (u9Var != null && ((t1) u9Var).g3() && !z4) {
            ...
            SparseArray sparseArray = this.f23233u0;
    ...
    public final void M(u9 u9Var, u9 u9Var2) {
        ...
        this.f24538w = t1Var.getMessageObject().getId();
        try {
            int i10 = t1Var.getMessageObject().messageOwner.edit_date;
        } catch (Exception unused) {
        }
        this.U = 0.0f;
        this.f23234v0 = this.f23235w0;
        this.f23236x0 = this.f23237y0;
        this.f23238z0 = this.A0;
        int i11 = this.f24538w;
        SparseArray sparseArray = this.f23233u0;
        ...
        ofFloat.start();
        sparseArray.put(this.f24538w, ofFloat);
        if (!z4) {
    ...
    public final void X(MessageObject messageObject) {
        ...
        if (this.f24538w == messageObject.getId()) {
            f(true);
        }
    }
    ...
    public final void Y(boolean z4, StaticLayout staticLayout, Canvas canvas) {
        ...
        Paint paint = this.f24527p;
        Paint paint2 = this.f24525o;
        if (z4) {
        ...
        i(canvas, staticLayout, this.f24537u, this.v, true, true, 0.0f);
    }
    ...
    public final void Z(MessageObject messageObject, RichMessageLayout richMessageLayout, Canvas canvas) {
        ...
        Canvas canvas2;
        boolean z4;
        if (this.f23238z0 && richMessageLayout != null && (u9Var = this.W) != null && ((t1) u9Var).getMessageObject() != null && ((t1) this.W).getMessageObject().getId() == messageObject.getId()) {
            ...
            while (i12 < richMessageLayout.textBlocks.size()) {
                ...
                if (layout != null && layout.getText() != null) {
                    ...
                    int clamp = Utilities.clamp(this.f24537u - intValue, length, 0);
                    int clamp2 = Utilities.clamp(this.v - intValue, length, 0);
                    if (clamp != clamp2) {
                        boolean z10 = true;
                        if (this.f24537u >= intValue) {
                            z4 = true;
                        } else {
                            z4 = false;
                        }
    ...
    public final void b0(t1 t1Var) {
        ...
        } else if (this.f23237y0 && t1Var.getFactCheckLayout() != null) {
    ...
    public final void c0(int i10, int i11) {
        if (this.f24500a == i10 && this.f24502b == i11) {
            return;
        }
        this.f24500a = i10;
        this.f24502b = i11;
    ...
    public final void j(int i10, p9 p9Var, boolean z4) {
        ...
        int i17 = 0;
        if (this.f23234v0) {
            p9Var.f23339b = t1Var.getDescriptionlayout();
            p9Var.f23340c = 0.0f;
            p9Var.d = 0.0f;
            p9Var.f23338a = 0;
        } else if (this.f23236x0) {
            p9Var.f23339b = t1Var.getFactCheckLayout();
            p9Var.f23340c = 0.0f;
            p9Var.d = 0.0f;
            p9Var.f23338a = 0;
        } else if (this.f23238z0) {
            ...
            if (richMessageLayout != null && !richMessageLayout.textBlocks.isEmpty()) {
                ...
                p9Var.f23339b = richMessageLayout.textBlocks.get(i17).getLayout();
                p9Var.f23340c = x9Var.getY();
                p9Var.d = x9Var.getX();
                p9Var.f23338a = richMessageLayout.textBlockCharOffsets.get(i17).intValue();
                return;
            }
            p9Var.f23339b = null;
        } else if (t1Var.P2()) {
            ...
            if (captionLayout.textLayoutBlocks.size() == 1) {
                p9Var.f23339b = captionLayout.textLayoutBlocks.get(0).textLayout;
                p9Var.f23340c = textLayoutBlock2.padTop;
            ...
            for (int i18 = 0; i18 < captionLayout.textLayoutBlocks.size(); i18++) {
                ...
                if (i19 >= 0 && i19 <= textLayoutBlock4.textLayout.getText().length()) {
                    p9Var.f23339b = textLayoutBlock4.textLayout;
                    p9Var.f23340c = textLayoutBlock4.textYOffset(captionLayout.textLayoutBlocks) + textLayoutBlock4.padTop;
                    ...
                    p9Var.f23338a = textLayoutBlock4.charactersOffset;
                    return;
                }
            }
            p9Var.f23339b = null;
            ...
            if (arrayList == null) {
                ...
                p9Var.f23339b = messageObject.textLayoutBlocks.get(0).textLayout;
                p9Var.f23340c = textLayoutBlock.padTop;
                ...
                for (int i20 = 0; i20 < messageObject.textLayoutBlocks.size(); i20++) {
                    ...
                    if (i21 >= 0 && i21 <= textLayoutBlock6.textLayout.getText().length()) {
                        p9Var.f23339b = textLayoutBlock6.textLayout;
                        p9Var.f23340c = textLayoutBlock6.textYOffset(messageObject.textLayoutBlocks) + textLayoutBlock6.padTop;
                        ...
                        p9Var.f23338a = textLayoutBlock6.charactersOffset;
                        return;
                    }
                }
                p9Var.f23339b = null;
    ...
    public final CharSequence t(u9 u9Var, boolean z4) {
        ...
        if (t1Var != null && t1Var.getMessageObject() != null) {
            if (!z4 ? this.f23234v0 : this.f23235w0) {
                return t1Var.getDescriptionlayout().getText();
            }
            if (!z4 ? this.f23236x0 : this.f23237y0) {
                return t1Var.getFactCheckLayout().getText();
            }
            if (!z4 ? this.f23238z0 : this.A0) {
    ...
    public void x() {
        ...
        u9 u9Var2 = this.W;
        if (u9Var2 != null) {
            if (this.f23236x0 || this.f23237y0) {
                ((t1) u9Var2).a3();
            }
        }
    }
