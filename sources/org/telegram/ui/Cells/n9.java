...
public final class n9 implements ActionMode.Callback {
    public String f20709a = null;
    public final da f20710b;
    ...
    public final void a(Menu menu) {
        ...
        if (this.f20710b.f20161l0 != null && ((this.f20709a != null && !w31.Y().contains(this.f20709a)) || !LanguageDetector.hasSupport())) {
            z10 = true;
        } else {
            z10 = false;
        }
    ...
    public final boolean onActionItemClicked(ActionMode actionMode, MenuItem menuItem) {
        ...
        CharSequence t10;
        da daVar = this.f20710b;
        g gVar = daVar.f20172r0;
        if (daVar.y()) {
            ...
            if (itemId == 16908321) {
                ...
                if (daVar.y()) {
                    ...
                    if (messageObject != null && daVar.s() != null) {
                        daVar.J(daVar.f20177u, daVar.v, messageObject);
                        daVar.f(true);
                    }
                }
                daVar.v();
    ...
    public final boolean onPrepareActionMode(ActionMode actionMode, Menu menu) {
        ...
        if (findItem != null) {
            findItem.setVisible(this.f20710b.e());
        }
        MenuItem findItem2 = menu.findItem(16908321);
        if (findItem2 != null) {
            findItem2.setVisible(this.f20710b.b());
        }
        MenuItem findItem3 = menu.findItem(16908319);
        boolean z10 = false;
        if (findItem3 != null && (y9Var = (daVar = this.f20710b).W) != null) {
            CharSequence t10 = daVar.t(y9Var, false);
            if (!this.f20710b.b()) {
                findItem3.setVisible(false);
            } else if (this.f20710b.k()) {
                findItem3.setVisible(true);
            } else {
                da daVar2 = this.f20710b;
                if (!daVar2.Z && (daVar2.f20177u > 0 || daVar2.v < t10.length() - 1)) {
                    findItem3.setVisible(true);
                } else {
                    findItem3.setVisible(false);
                }
        ...
        if (findItem4 != null) {
            findItem4.setVisible(this.f20710b instanceof ii.k3);
        }
        MenuItem findItem5 = menu.findItem(16908322);
        if (findItem5 != null) {
            da daVar3 = this.f20710b;
        ...
        if (this.f20710b.f20161l0 != null && LanguageDetector.hasSupport() && this.f20710b.s() != null) {
            LanguageDetector.detectLanguage(this.f20710b.s().toString(), new m9(this, menu), new m9(this, menu));
        } else {
            this.f20709a = null;
            a(menu);
        }
