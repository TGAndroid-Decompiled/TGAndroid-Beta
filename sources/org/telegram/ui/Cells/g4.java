...
public final class g4 extends FrameLayout {
    ...
    public Drawable T;
    public Paint U;
    public final org.telegram.ui.Components.w9 f20299a;
    public final ai.a6 f20300b;
    public final org.telegram.ui.ActionBar.j5 f20301c;
    public final np d;
    public final org.telegram.ui.Components.h9 e;
    public Object f20302f;
    public CharSequence h;
    public CharSequence f20303n;
    ...
    public static org.telegram.ui.Components.h9 a(boolean z10) {
        ...
        h9Var.f24604p = f7;
        h9Var.i(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.T7, false), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19007a8, false));
        return h9Var;
    }
    ...
    public final void c(boolean z10, boolean z11) {
        ...
        if (npVar != null) {
            ...
            if (z11) {
                ...
                org.telegram.ui.Components.w9 w9Var = this.f20299a;
                w9Var.setScaleX(f7);
                if (!this.H) {
                    f10 = 1.0f;
                }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (e > 0.0f) {
            ...
            canvas.save();
            Paint paint2 = org.telegram.ui.ActionBar.j6.f19351t0;
            ...
            canvas.drawCircle(width, height, AndroidUtilities.dp(11.33f) * e, org.telegram.ui.ActionBar.j6.f19351t0);
            if (this.Q == null) {
                if (this.S == null) {
                ...
                paint = this.S.f42810f;
            } else {
                if (this.U == null) {
                    this.U = new Paint();
                }
                this.U.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19046c8, e6Var));
                paint = this.U;
            }
    ...
    public final void g() {
        ...
        if (this.R) {
            ...
            } else if (this.f20302f instanceof TLRPC.User) {
                requirementToContact = MessagesController.getInstance(this.f20306w).isUserContactBlocked(((TLRPC.User) this.f20302f).f18443id);
            }
        }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.E) {
            ...
            if (this.K) {
                org.telegram.ui.ActionBar.j6.f19204l0.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19125gg, e6Var));
                canvas.drawRect(dp, getMeasuredHeight() - 1, dp2, getMeasuredHeight(), org.telegram.ui.ActionBar.j6.f19204l0);
                return;
            }
            canvas.drawRect(dp, getMeasuredHeight() - 1, dp2, getMeasuredHeight(), org.telegram.ui.ActionBar.j6.T0("paintDivider", e6Var));
        }
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        Object obj = this.f20302f;
        if ((obj instanceof String) && !"premium".equalsIgnoreCase((String) obj) && !"miniapps".equalsIgnoreCase((String) this.f20302f)) {
            f7 = 50.0f;
        } else {
            f7 = 58.0f;
        }
    ...
    public g4(int i10, int i11, Context context, org.telegram.ui.ActionBar.e6 e6Var, boolean z10, boolean z11) {
        super(context);
        this.f20306w = UserConfig.selectedAccount;
        ...
        a6Var.setTextColor(org.telegram.ui.ActionBar.j6.v0(z11 ? org.telegram.ui.ActionBar.j6.f19254ng : org.telegram.ui.ActionBar.j6.G6, e6Var));
