...
public final class a5 extends FrameLayout {
    ...
    public final org.telegram.ui.ActionBar.k5 f19799b;
    public final org.telegram.ui.ActionBar.k5 f19800c;
    public final org.telegram.ui.ActionBar.f6 d;
    public final org.telegram.ui.Components.f9 e;
    public final ImageView f19801f;
    public ImageView h;
    public Object f19802n;
    public TL_stories.StoryItem f19803r;
    public CharSequence f19804s;
    public CharSequence v;
    public String f19805w;
    public int f19806x;
    public TLRPC.FileLocation f19807y;
    ...
    public a5(int i10, int i11, Context context, org.telegram.ui.ActionBar.f6 f6Var, boolean z10) {
        ...
        this.d = f6Var;
        this.H = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19245y6, f6Var);
        this.I = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19048n6, f6Var);
        this.J = i11;
    ...
    public final void a() {
        this.f19798a.getImageReceiver().cancelLoadImage();
    }
    ...
    public final void b(TLObject tLObject, CharSequence charSequence, CharSequence charSequence2, boolean z10) {
        ...
        int i18;
        float f12;
        org.telegram.ui.ActionBar.k5 k5Var = this.f19800c;
        org.telegram.ui.ActionBar.k5 k5Var2 = this.f19799b;
        if (tLObject == null) {
            this.v = null;
            this.f19804s = null;
            this.f19802n = null;
            k5Var2.l("", false);
            k5Var.l("", false);
            this.f19798a.setImageDrawable(null);
            return;
        }
        this.v = charSequence2;
        this.f19804s = charSequence;
        this.f19802n = tLObject;
        ImageView imageView = this.f19801f;
        int i19 = 3;
        int i20 = this.J;
        int i21 = 28;
        if (imageView != null) {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.F) {
            int i11 = this.K;
            if (i11 >= 0) {
                org.telegram.ui.ActionBar.j6.f19005l0.setColor(org.telegram.ui.ActionBar.j6.v0(i11, this.d));
            }
            if (LocaleController.isRTL) {
                dp = 0.0f;
            } else {
            ...
            if (this.K >= 0) {
                paint = org.telegram.ui.ActionBar.j6.f19005l0;
            } else {
    ...
    public void setCustomRightImage(int i10) {
        ...
        this.h.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19038mg, this.d), PorterDuff.Mode.MULTIPLY));
        ImageView imageView2 = this.h;
        if (LocaleController.isRTL) {
            i11 = 3;
        } else {
