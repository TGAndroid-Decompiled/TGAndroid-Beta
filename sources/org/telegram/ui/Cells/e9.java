...
public class e9 extends FrameLayout {
    public final x1 f21893a;
    public final a90 f21894b;
    public int f21895c;
    public Integer d;
    public int f21896e;
    public int f21897f;
    ...
    public CharSequence f21899r;
    public final org.telegram.ui.ActionBar.f6 f21900s;
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        accessibilityNodeInfo.setText(this.f21899r);
    }
    ...
    public void setText(CharSequence charSequence) {
        if (!TextUtils.equals(charSequence, this.f21899r)) {
            this.f21899r = charSequence;
            x1 x1Var = this.f21893a;
            if (charSequence == null) {
                x1Var.setPadding(0, AndroidUtilities.dp(2.0f), 0, 0);
            } else {
                x1Var.setPadding(0, AndroidUtilities.dp(this.f21896e), 0, AndroidUtilities.dp(this.f21897f));
            }
    ...
    public void setTextColor(int i10) {
        this.f21893a.setTextColor(i10);
    }

    public void setTextColorByKey(int i10) {
        int v02 = org.telegram.ui.ActionBar.j6.v0(i10, this.f21900s);
        x1 x1Var = this.f21893a;
    ...
    public e9(Context context, int i10, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context);
        this.f21895c = org.telegram.ui.ActionBar.j6.J6;
        this.f21896e = 10;
        this.f21897f = 17;
        this.f21900s = f6Var;
