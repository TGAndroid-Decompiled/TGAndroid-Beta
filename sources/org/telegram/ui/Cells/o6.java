...
public final class o6 extends FrameLayout {
    public final a90 f22437a;
    public final d90 f22438b;
    public final CheckBoxSquare f22439c;
    ...
    public final void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        a90 a90Var = this.f22437a;
        if (a90Var != null) {
            canvas.save();
            d90 d90Var = this.f22438b;
    ...
    public void setChecked(boolean z10) {
        this.f22439c.a(z10, true);
    }

    public void setText(CharSequence charSequence) {
        this.f22438b.setText(charSequence);
    }
}
