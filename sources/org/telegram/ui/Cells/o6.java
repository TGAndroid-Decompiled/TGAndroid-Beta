...
public final class o6 extends FrameLayout {
    public final a90 f22464a;
    public final d90 f22465b;
    public final CheckBoxSquare f22466c;
    ...
    public final void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        a90 a90Var = this.f22464a;
        if (a90Var != null) {
            canvas.save();
            d90 d90Var = this.f22465b;
    ...
    public void setChecked(boolean z10) {
        this.f22466c.a(z10, true);
    }

    public void setText(CharSequence charSequence) {
        this.f22465b.setText(charSequence);
    }
}
