...
public final class la implements ml0, yf.m, ImageReceiver.ImageReceiverDelegate, FlagSecureReason.FlagSecureCondition, pp, Utilities.Callback2Return {
    ...
    public void a() {
        switch (this.f20618a) {
            case 4:
                n4 n4Var = (n4) this.f20619b;
                float progress = 1.0f - (n4Var.v.getProgress() * 0.143f);
                org.telegram.ui.Components.w9 w9Var = n4Var.f20687a;
                w9Var.setScaleX(progress);
                w9Var.setScaleY(progress);
                n4Var.invalidate();
                return;
            default:
                g7 g7Var = (g7) this.f20619b;
                float progress2 = 1.0f - (g7Var.d.getProgress() * 0.143f);
                org.telegram.ui.Components.w9 w9Var2 = g7Var.f20355a;
    ...
    public boolean d(int i10, View view) {
        pa paVar = (pa) this.f20619b;
        paVar.getClass();
        paVar.z1(((ThemesHorizontalListCell$InnerThemeView) view).f19991b);
        return true;
    }
    ...
    public void didSetImage(ImageReceiver imageReceiver, boolean z10, boolean z11, boolean z12) {
        ...
        switch (this.f20618a) {
            case 2:
                    ...
                    if (messageObject2 != null && !messageObject2.playedGiftAnimation) {
                        ...
                        if (messageObject2.wasUnread || w0Var.D1) {
                            ...
                            if (w0Var.getContext() instanceof LaunchActivity) {
                                ((LaunchActivity) w0Var.getContext()).f31145x0.c(false);
                            }
                            TLRPC.VideoSize videoSize = w0Var.A1;
                            if (videoSize != null && (t0Var = w0Var.X0) != null) {
                                t0Var.g1(w0Var, w0Var.f21784z1, videoSize);
                                return;
                            }
                            return;
                        }
                        return;
                    } else if (lottieAnimation.f25069a0 < 1) {
                ...
                return;
            default:
                t7 t7Var = (t7) this.f20619b;
                ImageReceiver imageReceiver2 = t7Var.d;
                ImageReceiver imageReceiver3 = t7Var.f21215c;
                if (z10 && !z11 && (messageObject = t7Var.f21227n) != null && messageObject.hasMediaSpoilers() && imageReceiver3.getBitmap() != null) {
                ...
                if (z10 && !z11 && t7Var.f21240w0 && imageReceiver3.getBitmap() != null) {
                    int dominantColor = AndroidUtilities.getDominantColor(imageReceiver3.getBitmap());
                    t7Var.f21211a = dominantColor;
                    CheckBoxBase checkBoxBase = t7Var.P;
                    if (checkBoxBase != null && checkBoxBase.f22201x != (v = org.telegram.ui.ActionBar.h6.v(dominantColor, org.telegram.ui.ActionBar.h6.l1(0.25f, -1)))) {
                        checkBoxBase.f22201x = v;
                        checkBoxBase.b();
                        return;
                    }
                    return;
    ...
    public Object run(Object obj, Object obj2) {
        ...
        return (CharSequence) ((ei.c) this.f20619b).run((Integer) obj2);
    }
    ...
    public boolean run() {
        ...
        k4 k4Var;
        u1 u1Var = (u1) this.f20619b;
        MessageObject messageObject = u1Var.f21608y7;
        if (messageObject == null || (message = messageObject.messageOwner) == null) {
            return false;
        }
        if (messageObject.type != 29 || ((k4Var = u1Var.F7) != null && k4Var.f20564i)) {
            return (message.noforwards && !messageObject.isEphemeral()) || u1Var.f21608y7.isVoiceOnce() || u1Var.f21608y7.hasRevealedExtendedMedia();
        }
        return true;
    }
}
