...
public final class o extends View {
    ...
    public final void a(zg.p0 p0Var) {
        ...
        if (p0Var.f49447f != null) {
            tL_availableReaction = MediaDataController.getInstance(UserConfig.selectedAccount).getReactionsMap().get(p0Var.f49447f);
        } else {
            tL_availableReaction = null;
        }
        if (tL_availableReaction == null) {
            document = org.telegram.ui.Components.p5.f(UserConfig.selectedAccount, p0Var.f49448g);
        ...
        if (document == null) {
            m10 = org.telegram.ui.Components.p5.n(2, p0Var.f49448g, null, UserConfig.selectedAccount);
        } else {
            m10 = org.telegram.ui.Components.p5.m(2, UserConfig.selectedAccount, document);
        }
        if (this.f20731n != null) {
            m10.setColorFilter(new PorterDuffColorFilter(this.f20731n.intValue(), PorterDuff.Mode.MULTIPLY));
        }
    ...
    public final void b(float f7, float f10) {
        ...
        this.f20730f = measuredHeight;
        setTranslationY(measuredHeight + this.h);
    }

    @Override
    public final void dispatchDraw(Canvas canvas) {
        int dp = AndroidUtilities.dp(this.f20729c);
        int dp2 = AndroidUtilities.dp(this.f20728b);
        int i10 = 0;
        while (true) {
            ArrayList arrayList = this.e;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        int i13 = this.f20728b;
        int max = Math.max(i12, i13);
        int i14 = this.f20729c;
    ...
    public void setColor(int i10) {
        this.f20731n = Integer.valueOf(i10);
        ...
        while (true) {
            ...
            if (i11 < arrayList.size()) {
                ...
                if (obj instanceof ImageReceiver) {
                    ...
                    ((zg.d) obj).f49326a.setColorFilter(porterDuffColorFilter2);
                }
                i11++;
            } else {
                return;
