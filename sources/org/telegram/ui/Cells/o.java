...
public final class o extends View {
    ...
    public final void a(zg.o0 o0Var) {
        ...
        if (o0Var.f49397f != null) {
            tL_availableReaction = MediaDataController.getInstance(UserConfig.selectedAccount).getReactionsMap().get(o0Var.f49397f);
        } else {
            tL_availableReaction = null;
        }
        if (tL_availableReaction == null) {
            document = org.telegram.ui.Components.q5.f(UserConfig.selectedAccount, o0Var.f49398g);
        ...
        if (document == null) {
            m10 = org.telegram.ui.Components.q5.n(2, o0Var.f49398g, null, UserConfig.selectedAccount);
        } else {
            m10 = org.telegram.ui.Components.q5.m(2, UserConfig.selectedAccount, document);
        }
        if (this.f20733n != null) {
            m10.setColorFilter(new PorterDuffColorFilter(this.f20733n.intValue(), PorterDuff.Mode.MULTIPLY));
        }
    ...
    public final void b(float f7, float f10) {
        ...
        this.f20732f = measuredHeight;
        setTranslationY(measuredHeight + this.h);
    }

    @Override
    public final void dispatchDraw(Canvas canvas) {
        int dp = AndroidUtilities.dp(this.f20731c);
        int dp2 = AndroidUtilities.dp(this.f20730b);
        int i10 = 0;
        while (true) {
            ArrayList arrayList = this.e;
    ...
    public void setColor(int i10) {
        this.f20733n = Integer.valueOf(i10);
        ...
        while (true) {
            ...
            if (i11 < arrayList.size()) {
                ...
                if (obj instanceof ImageReceiver) {
                    ...
                    ((zg.d) obj).f49278a.setColorFilter(porterDuffColorFilter2);
                }
                i11++;
            } else {
                return;
