...
public final class o extends View {
    ...
    public float f21453f;
    public float h;
    public Integer f21454n;
    ...
    public final void a(mg.q0 q0Var) {
        ...
        if (q0Var.f14095f != null) {
            tL_availableReaction = MediaDataController.getInstance(UserConfig.selectedAccount).getReactionsMap().get(q0Var.f14095f);
        } else {
            tL_availableReaction = null;
        }
        if (tL_availableReaction == null) {
            document = org.telegram.ui.Components.l5.f(UserConfig.selectedAccount, q0Var.f14096g);
        ...
        if (document == null) {
            m9 = org.telegram.ui.Components.l5.n(2, q0Var.f14096g, null, UserConfig.selectedAccount);
        } else {
            m9 = org.telegram.ui.Components.l5.m(2, UserConfig.selectedAccount, document);
        }
        if (this.f21454n != null) {
            m9.setColorFilter(new PorterDuffColorFilter(this.f21454n.intValue(), PorterDuff.Mode.MULTIPLY));
        }
    ...
    public final void b(float f10, float f11) {
        ...
        this.f21453f = measuredHeight;
        setTranslationY(measuredHeight + this.h);
    }

    @Override
    public final void dispatchDraw(Canvas canvas) {
        int dp = AndroidUtilities.dp(this.f21452c);
        int dp2 = AndroidUtilities.dp(this.f21451b);
        int i10 = 0;
        while (true) {
            ArrayList arrayList = this.e;
    ...
    public final void onMeasure(int i10, int i11) {
        int i12 = this.f21450a;
        int i13 = this.f21451b;
        int max = Math.max(i12, i13);
        int i14 = this.f21452c;
    ...
    public void setColor(int i10) {
        this.f21454n = Integer.valueOf(i10);
        ...
        while (true) {
            ...
            if (i11 < arrayList.size()) {
                ...
                if (obj instanceof ImageReceiver) {
                    ...
                    ((mg.d) obj).f13951a.setColorFilter(porterDuffColorFilter2);
                }
                i11++;
            } else {
                return;
