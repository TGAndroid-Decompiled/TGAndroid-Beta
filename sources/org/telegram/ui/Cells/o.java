...
public final class o extends View {
    ...
    public int d;
    public final ArrayList f22404e;
    public float f22405f;
    public float h;
    public Integer f22406n;
    ...
    public final void a(ah.j1 j1Var) {
        ...
        ArrayList arrayList = this.f22404e;
        ...
        if (this.f22406n != null) {
            m10.setColorFilter(new PorterDuffColorFilter(this.f22406n.intValue(), PorterDuff.Mode.MULTIPLY));
        }
    ...
    public final void b(float f7, float f10) {
        ...
        this.f22405f = measuredHeight;
        setTranslationY(measuredHeight + this.h);
    }

    @Override
    public final void dispatchDraw(Canvas canvas) {
        int dp = AndroidUtilities.dp(this.f22403c);
        int dp2 = AndroidUtilities.dp(this.f22402b);
        int i10 = 0;
        while (true) {
            ArrayList arrayList = this.f22404e;
    ...
    public void setColor(int i10) {
        this.f22406n = Integer.valueOf(i10);
