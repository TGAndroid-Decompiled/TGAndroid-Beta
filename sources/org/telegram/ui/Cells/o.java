...
public final class o extends View {
    ...
    public float f20520f;
    public float h;
    public Integer f20521n;
    ...
    public final void a(zg.p0 p0Var) {
        ...
        org.telegram.ui.Components.o5 m10;
        String findAnimatedEmojiEmoticon;
        if (p0Var.f49150f != null) {
            tL_availableReaction = MediaDataController.getInstance(UserConfig.selectedAccount).getReactionsMap().get(p0Var.f49150f);
        } else {
            tL_availableReaction = null;
        }
        if (tL_availableReaction == null) {
            document = org.telegram.ui.Components.o5.f(UserConfig.selectedAccount, p0Var.f49151g);
        ...
        if (document == null) {
            m10 = org.telegram.ui.Components.o5.n(2, p0Var.f49151g, null, UserConfig.selectedAccount);
        } else {
            m10 = org.telegram.ui.Components.o5.m(2, UserConfig.selectedAccount, document);
        }
        if (this.f20521n != null) {
            m10.setColorFilter(new PorterDuffColorFilter(this.f20521n.intValue(), PorterDuff.Mode.MULTIPLY));
        }
    ...
    public final void b(float f7, float f10) {
        ...
        this.f20520f = measuredHeight;
        setTranslationY(measuredHeight + this.h);
    }

    @Override
    public final void dispatchDraw(Canvas canvas) {
        int dp = AndroidUtilities.dp(this.f20519c);
        int dp2 = AndroidUtilities.dp(this.f20518b);
        int i10 = 0;
        while (true) {
            ArrayList arrayList = this.e;
    ...
    public final void onMeasure(int i10, int i11) {
        int i12 = this.f20517a;
        int i13 = this.f20518b;
        int max = Math.max(i12, i13);
        int i14 = this.f20519c;
    ...
    public void setColor(int i10) {
        this.f20521n = Integer.valueOf(i10);
        ...
        while (true) {
            ...
            if (i11 < arrayList.size()) {
                ...
                if (obj instanceof ImageReceiver) {
                    ...
                    ((zg.d) obj).f49029a.setColorFilter(porterDuffColorFilter2);
                }
                i11++;
            } else {
                return;
