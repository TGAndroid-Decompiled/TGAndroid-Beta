...
public abstract class da {
    ...
    public boolean Z;
    public int f19918a;
    public final t9 f19919a0;
    public int f19920b;
    public int f19921b0;
    public int f19922c;
    public final OvershootInterpolator f19923c0;
    public int d;
    public boolean f19924d0;
    public boolean e;
    public int f19925e0;
    public float f19926f;
    public final l7 f19927f0;
    public float f19928g;
    public final k9 f19929g0;
    public final int[] h = new int[2];
    public org.telegram.ui.ActionBar.e6 f19930h0;
    public boolean f19931i;
    public boolean f19932i0;
    public boolean f19933j;
    public boolean f19934j0;
    public boolean f19935k;
    public boolean f19936k0;
    public final int f19937l;
    public org.telegram.ui.t f19938l0;
    public final int f19939m;
    public ValueAnimator m0;
    public final float f19940n;
    public org.telegram.ui.ActionBar.n1 f19941n0;
    public final Paint f19942o;
    public ActionBarPopupWindow$ActionBarPopupWindowLayout f19943o0;
    public final Paint f19944p;
    public TextView f19945p0;
    public final uq f19946q;
    public Rect f19947q0;
    public final Path f19948r;
    public final g f19949r0;
    public int f19950s;
    public final l9 f19951s0;
    public int f19952t;
    public final x9 f19953t0;
    public int f19954u;
    public int v;
    public int f19955w;
    public int f19956x;
    ...
    public da() {
        new Path().f21473a = 0.0f;
        Paint paint = new Paint(1);
        this.f19942o = paint;
        this.f19944p = new Paint(1);
        uq uqVar = new uq();
        this.f19946q = uqVar;
        this.f19948r = new Path();
        new Path().f21443a = uqVar;
        this.f19954u = -1;
        this.v = -1;
        ...
        this.S = new RectF();
        this.T = new RectF();
        this.f19919a0 = new Object();
        this.f19923c0 = new OvershootInterpolator();
        this.f19924d0 = false;
        this.f19927f0 = new l7(this, 2);
        this.f19929g0 = new k9(this);
        this.f19932i0 = true;
        this.f19938l0 = null;
        this.f19949r0 = new g(this, 7);
        this.f19951s0 = new l9(this);
        ?? path = new Path();
        path.f21627a = 0.0f;
        path.f21628b = new ArrayList(1);
        path.f21629c = 0;
        this.f19953t0 = path;
        this.f19937l = ViewConfiguration.getLongPressTimeout();
        this.f19939m = ViewConfiguration.get(ApplicationLoader.applicationContext).getScaledTouchSlop();
    ...
    public static void a(da daVar, int i10) {
        ...
        if (Build.VERSION.SDK_INT >= 28 && daVar.W != null && !daVar.f19935k && daVar.f19931i && daVar.C != null) {
            if (daVar.f19933j) {
                i11 = daVar.f19954u;
            } else {
                i11 = daVar.v;
            ...
            if (layout != null) {
                int lineForOffset = layout.getLineForOffset(Utilities.clamp(i11 - t9Var.f21393a, layout.getText().length(), 0));
                int lineBottom = layout.getLineBottom(lineForOffset) - layout.getLineTop(lineForOffset);
                int[] m10 = daVar.m();
                int lineTop = (int) (((((layout.getLineTop(lineForOffset) + daVar.f19920b) + m10[1]) - lineBottom) - AndroidUtilities.dp(8.0f)) + t9Var.f21395c);
                y9 y9Var = daVar.W;
                if (y9Var instanceof org.telegram.ui.t2) {
                    lineLeft = m10[0];
                    lineRight = ((View) y9Var).getMeasuredWidth() + lineLeft;
                } else {
                    float f7 = m10[0] + daVar.f19918a + t9Var.d;
                    lineRight = (int) (layout.getLineRight(lineForOffset) + m10[0] + daVar.f19918a + t9Var.d);
    ...
    public boolean A(MessageObject messageObject) {
        if (messageObject == null || this.f19955w != messageObject.getId()) {
            return false;
        }
        return true;
    }
    ...
    public final int[] C(int i10) {
        t9 t9Var = this.f19919a0;
        j(i10, t9Var, false);
        Layout layout = t9Var.f21394b;
        int i11 = i10 - t9Var.f21393a;
        int[] iArr = this.h;
        if (layout != null && i11 >= 0 && i11 <= layout.getText().length()) {
            ...
            iArr[1] = lineBottom;
            iArr[1] = (int) (lineBottom + t9Var.f21395c);
        }
        return iArr;
    }
    ...
    public final boolean N(MotionEvent motionEvent) {
        ...
        if (action != 0) {
            if (action != 1) {
                if (action != 2) {
                    ...
                    int y3 = this.f19952t - ((int) motionEvent.getY());
                    int x10 = this.f19950s - ((int) motionEvent.getX());
                    int i10 = (x10 * x10) + (y3 * y3);
                    int i11 = this.f19939m;
                    if (i10 > i11 * i11) {
        ...
        this.f19950s = (int) motionEvent.getX();
        this.f19952t = (int) motionEvent.getY();
        this.f19958z = false;
        Rect rect = this.B;
        rect.inset(-AndroidUtilities.dp(8.0f), -AndroidUtilities.dp(8.0f));
        if (rect.contains(this.f19950s, this.f19952t) && this.X != null) {
            rect.inset(AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f));
            int i12 = this.f19950s;
            int i13 = this.f19952t;
            int i14 = rect.right;
            if (i12 > i14) {
                i12 = i14 - 1;
            }
            ...
            daVar = this;
            int l4 = daVar.l(i16, i13, this.f19922c, this.d, this.X, true);
            ...
            if (l4 >= 0 && l4 < t10.length() && t10.charAt(l4) != '\n') {
                AndroidUtilities.cancelRunOnUIThread(k9Var);
                AndroidUtilities.runOnUIThread(k9Var, daVar.f19937l);
                daVar.f19958z = true;
            }
        } else {
            daVar = this;
        }
        return daVar.f19958z;
    }
    ...
    public boolean c(int i10) {
        if (i10 != this.f19954u && i10 != this.v) {
            return true;
        }
        return false;
    }
    ...
    public void f(boolean z10) {
        ...
        this.W = null;
        this.f19955w = 0;
        AndroidUtilities.cancelRunOnUIThread(this.f19929g0);
        this.f19958z = false;
        ca caVar = this.C;
        if (caVar != null) {
    ...
    public final void h(Layout layout, int i10, int i11, int i12, boolean z10, boolean z11, float f7) {
        ...
        float f14;
        int lineTop;
        x9 x9Var = this.f19953t0;
        x9Var.reset();
        layout.getSelectionPath(i11, i12, x9Var);
        if (x9Var.f21627a < layout.getLineBottom(i10)) {
            f11 = layout.getLineTop(i10);
            f10 = (layout.getLineBottom(i10) - lineTop) / (x9Var.f21627a - f11);
        } else {
            f10 = 1.0f;
            f11 = 0.0f;
        }
        ...
        while (true) {
            ...
            RectF rectF = (RectF) x9Var.f21628b.get(i14);
    ...
    public org.telegram.ui.ActionBar.e6 r() {
        return this.f19930h0;
    }

    public CharSequence s() {
        CharSequence t10 = t(this.W, false);
        if (t10 != null) {
            return t10.subSequence(this.f19954u, this.v);
        }
        return null;
    }
    ...
    public int u(int i10) {
        return org.telegram.ui.ActionBar.i6.v0(i10, this.f19930h0);
    }
    ...
    public final void v() {
        ...
        org.telegram.ui.ActionBar.n1 n1Var = this.f19941n0;
        if (n1Var != null) {
            n1Var.d(true);
        }
    }
