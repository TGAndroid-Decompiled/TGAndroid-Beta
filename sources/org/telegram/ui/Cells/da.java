...
public final class da extends View {
    ...
    public final void a(RectF rectF) {
        ...
        this.f20163f.add(new Rect((int) Math.floor(rectF.left), (int) Math.floor(rectF.top), (int) Math.ceil(rectF.right), (int) Math.ceil(rectF.bottom)));
    }

    public final boolean b(MotionEvent motionEvent) {
        ea eaVar = this.f20165r;
        if (eaVar.y() && !eaVar.f20231i) {
            int action = motionEvent.getAction();
            if (action != 0) {
                if (action == 1 && System.currentTimeMillis() - this.d < 200 && v7.a7.b((int) this.f20161b, (int) this.f20162c, (int) motionEvent.getX(), (int) motionEvent.getY()) < eaVar.f20239m) {
    ...
    public final void c() {
        if (Build.VERSION.SDK_INT >= 29) {
            ArrayList arrayList = this.f20163f;
    ...
    public final void invalidate() {
        ...
        super.invalidate();
        ea eaVar = this.f20165r;
        if (eaVar.f20234j0 && (viewGroup = eaVar.F) != null) {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        int i12;
        ea eaVar = this.f20165r;
        g gVar2 = eaVar.f20249r0;
        OvershootInterpolator overshootInterpolator = eaVar.f20223c0;
        RectF rectF = eaVar.S;
        RectF rectF2 = eaVar.T;
        u9 u9Var = eaVar.f20219a0;
        if (eaVar.y()) {
            int dp = AndroidUtilities.dp(22.0f);
            int i13 = eaVar.f20256x;
            eaVar.O();
            z9 z9Var = eaVar.W;
            Paint paint = this.f20160a;
            Path path = this.e;
            if (z9Var != null) {
                canvas.save();
                int[] m10 = eaVar.m();
                c10 = 1;
                float f11 = m10[1] + eaVar.f20220b;
                f7 = 8.0f;
                float f12 = m10[0] + eaVar.f20218a;
                ...
                if (messageObject != null && messageObject.isOutOwner()) {
                    ...
                    paint.setColor(eaVar.u(org.telegram.ui.ActionBar.j6.f19448vf));
                }
                ...
                if (i14 >= 0 && i14 <= length) {
                    ...
                    if (layout != null) {
                        ...
                        int lineBottom = (int) (layout.getLineBottom(lineForOffset) + u9Var.f21672c);
                        float f13 = primaryHorizontal + u9Var.d;
                        Rect rect = u9Var.e;
                        if (rect != null) {
                            float f14 = rect.right - eaVar.f20218a;
                            i12 = rect.bottom - eaVar.f20220b;
                            f10 = f14;
                            z10 = false;
                        } else {
                        ...
                        float f16 = f11 + f15;
                        i10 = i13;
                        if (f16 > i10 + eaVar.f20225e0 && f16 < eaVar.F.getMeasuredHeight()) {
                            if (!z10) {
                                canvas.save();
            ...
            if (eaVar.W != null) {
                canvas.save();
                int[] m11 = eaVar.m();
                float f23 = m11[c10] + eaVar.f20220b;
                float f24 = m11[0] + eaVar.f20218a;
                canvas.translate(f24, f23);
                int length3 = eaVar.t(eaVar.W, false).length();
                int i16 = eaVar.f20254u;
                if (i16 >= 0 && i16 <= length3) {
                    eaVar.j(i16, u9Var, false);
                    Layout layout2 = u9Var.f21671b;
                    if (layout2 != null) {
                        int i17 = eaVar.f20254u - u9Var.f21670a;
                        int lineForOffset2 = layout2.getLineForOffset(i17);
                        float primaryHorizontal2 = layout2.getPrimaryHorizontal(i17);
                        int lineBottom2 = (int) (layout2.getLineBottom(lineForOffset2) + u9Var.f21672c);
                        float f25 = primaryHorizontal2 + u9Var.d;
                        Rect rect2 = u9Var.e;
                        if (rect2 != null) {
                            f25 = rect2.left - eaVar.f20218a;
                            lineBottom2 = rect2.bottom - eaVar.f20220b;
                            isRtlCharAt = false;
                        } else {
                            isRtlCharAt = layout2.isRtlCharAt(eaVar.f20254u);
                        }
                        float f26 = lineBottom2;
                        float f27 = f23 + f26;
                        if (f27 > i10 + eaVar.f20225e0 && f27 < eaVar.F.getMeasuredHeight()) {
                            if (!isRtlCharAt) {
                                canvas.save();
                                float f28 = dp;
            ...
            if (i11 != 0 && eaVar.f20231i) {
                if (!eaVar.f20233j) {
                    eaVar.O();
                }
                ea.a(eaVar, eaVar.f20221b0);
