...
public class c9 extends FrameLayout {
    ...
    public final b9 f19881b;
    public final b9 f19882c;
    public final ImageView d;
    public boolean e;
    public boolean f19883f;
    public final boolean h;
    public final org.telegram.ui.ActionBar.e6 f19884n;
    ...
    public final void b(Drawable drawable, String str) {
        ...
        if (drawable == null) {
            ...
            imageView.setBackground(org.telegram.ui.ActionBar.i6.h0(AndroidUtilities.dp(48.0f), 0, org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f18926i6, this.f19884n)));
    ...
    public final void e() {
        ...
        org.telegram.ui.ActionBar.e6 e6Var = this.f19884n;
        ...
        this.f19882c.setTextColor(org.telegram.ui.ActionBar.i6.v0(i11, e6Var));
        b9Var.invalidate();
    }
                ...
                switch (r2) {
                    case 0:
                        ...
                        if (clickableSpan != null) {
                            ...
                            clickableSpan.onClick(c9Var.f19880a);
                            return;
                        }
                        return;
                    case 1:
                        c9 c9Var2 = this.f19803b;
                        if (clickableSpan != null) {
                            try {
                                c9Var2.performHapticFeedback(0, 1);
                            } catch (Exception unused2) {
                            }
                            clickableSpan.onClick(c9Var2.f19881b);
                            return;
                        }
                        return;
                    default:
                        c9 c9Var3 = this.f19803b;
                        if (clickableSpan != null) {
                            try {
                                c9Var3.performHapticFeedback(0, 1);
                            } catch (Exception unused3) {
                            }
                            clickableSpan.onClick(c9Var3.f19881b);
                            return;
                        }
                        return;
                }
