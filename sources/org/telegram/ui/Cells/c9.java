...
public class c9 extends FrameLayout {
    public final vh.o f19866a;
    public final b9 f19867b;
    public final b9 f19868c;
    public final ImageView d;
    public boolean e;
    public boolean f19869f;
    public final boolean h;
    public final org.telegram.ui.ActionBar.e6 f19870n;
    ...
    public final void b(Drawable drawable, String str) {
        int dp;
        boolean z10;
        ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) this.f19867b.getLayoutParams();
        ...
        if (drawable == null) {
            ...
            imageView.setBackground(org.telegram.ui.ActionBar.i6.h0(AndroidUtilities.dp(48.0f), 0, org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f18923i6, this.f19870n)));
    ...
    public final void c(CharSequence charSequence, CharSequence charSequence2, boolean z10) {
        this.f19866a.setText(charSequence);
        this.f19867b.setText(charSequence2);
    ...
    public final void d(CharSequence charSequence, String str, String str2) {
        this.f19866a.setText(charSequence);
        this.f19867b.setText(str);
        b9 b9Var = this.f19868c;
    ...
    public final void e() {
        ...
        org.telegram.ui.ActionBar.e6 e6Var = this.f19870n;
        ...
        this.f19868c.setTextColor(org.telegram.ui.ActionBar.i6.v0(i11, e6Var));
        b9Var.invalidate();
    }
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        CharSequence text = this.f19866a.getText();
        CharSequence text2 = this.f19867b.getText();
                ...
                switch (r2) {
                    case 0:
                        ...
                        if (clickableSpan != null) {
                            ...
                            clickableSpan.onClick(c9Var.f19866a);
                            return;
                        }
                        return;
                    case 1:
                        c9 c9Var2 = this.f19791b;
                        if (clickableSpan != null) {
                            try {
                                c9Var2.performHapticFeedback(0, 1);
                            } catch (Exception unused2) {
                            }
                            clickableSpan.onClick(c9Var2.f19867b);
                            return;
                        }
                        return;
                    default:
                        c9 c9Var3 = this.f19791b;
                        if (clickableSpan != null) {
                            try {
                                c9Var3.performHapticFeedback(0, 1);
                            } catch (Exception unused3) {
                            }
                            clickableSpan.onClick(c9Var3.f19867b);
                            return;
                        }
                        return;
                }
