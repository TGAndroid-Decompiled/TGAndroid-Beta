...
public class c9 extends FrameLayout {
    public final wh.p f21731a;
    public final b9 f21732b;
    public final b9 f21733c;
    public final ImageView d;
    public boolean f21734e;
    public boolean f21735f;
    public final boolean h;
    public final org.telegram.ui.ActionBar.f6 f21736n;
    ...
    public final void b(Drawable drawable, String str) {
        int dp;
        boolean z10;
        ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) this.f21732b.getLayoutParams();
        ...
        if (drawable == null) {
            ...
            imageView.setBackground(org.telegram.ui.ActionBar.j6.h0(AndroidUtilities.dp(48.0f), 0, org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20780i6, this.f21736n)));
    ...
    public final void c(CharSequence charSequence, CharSequence charSequence2, boolean z10) {
        this.f21731a.setText(charSequence);
        this.f21732b.setText(charSequence2);
    ...
    public final void d(CharSequence charSequence, String str, String str2) {
        this.f21731a.setText(charSequence);
        this.f21732b.setText(str);
        b9 b9Var = this.f21733c;
    ...
    public final void e() {
        ...
        org.telegram.ui.ActionBar.f6 f6Var = this.f21736n;
        ...
        this.f21733c.setTextColor(org.telegram.ui.ActionBar.j6.v0(i11, f6Var));
        b9Var.invalidate();
    }
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        CharSequence text = this.f21731a.getText();
        CharSequence text2 = this.f21732b.getText();
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (!this.h) {
            i11 = View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(60.0f) + (this.f21734e ? 1 : 0), 1073741824);
        }
                ...
                switch (r2) {
                    case 0:
                        ...
                        if (clickableSpan != null) {
                            ...
                            clickableSpan.onClick(c9Var.f21731a);
                            return;
                        }
                        return;
                    case 1:
                        c9 c9Var2 = this.f21646b;
                        if (clickableSpan != null) {
                            try {
                                c9Var2.performHapticFeedback(0, 1);
                            } catch (Exception unused2) {
                            }
                            clickableSpan.onClick(c9Var2.f21732b);
                            return;
                        }
                        return;
                    default:
                        c9 c9Var3 = this.f21646b;
                        if (clickableSpan != null) {
                            try {
                                c9Var3.performHapticFeedback(0, 1);
                            } catch (Exception unused3) {
                            }
                            clickableSpan.onClick(c9Var3.f21732b);
                            return;
                        }
                        return;
                }
