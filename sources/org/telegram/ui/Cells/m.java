...
public final class m extends FrameLayout implements GiftAuctionController.OnActiveAuctionsUpdateListeners {
    ...
    public final org.telegram.ui.Components.k6 f21339b;
    public final org.telegram.ui.Components.k6 f21340c;
    public final l d;
    public ArrayList e;
    ...
    public final void a() {
        ...
        this.f21339b.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.G6, false));
        if (this.f21341f) {
            i10 = org.telegram.ui.ActionBar.j6.f20116q7;
        } else {
            i10 = org.telegram.ui.ActionBar.j6.f20256y6;
        }
        this.f21340c.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i10, false));
        invalidate();
    }
    ...
    public final void onActiveAuctionsUpdate(List list) {
        ...
        if (size == 1) {
            ...
            lVar.f21304f = 0;
            lVar.f21303c.b();
            lVar.f21301a.q(LocaleController.getString(R.string.Gift2AuctionPriceView), true, true);
        }
        ...
        int currentTime = ConnectionsManager.getInstance(this.f21338a).getCurrentTime();
        int i11 = 0;
        boolean z10 = false;
        boolean z11 = false;
        while (true) {
        ...
        this.f21341f = false;
        org.telegram.ui.Components.k6 k6Var2 = this.f21340c;
        if (z10) {
    ...
    public final void onDetachedFromWindow() {
        ...
        GiftAuctionController.getInstance(this.f21338a).unsubscribeFromActiveAuctionsUpdates(this);
    }
