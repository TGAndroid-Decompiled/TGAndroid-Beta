...
public final class m extends FrameLayout implements GiftAuctionController.OnActiveAuctionsUpdateListeners {
    ...
    public final org.telegram.ui.Components.q6 f22262b;
    public final org.telegram.ui.Components.q6 f22263c;
    public final l d;
    public ArrayList f22264e;
    ...
    public final void a() {
        ...
        this.f22262b.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.G6, false));
        if (this.f22265f) {
            i10 = org.telegram.ui.ActionBar.j6.f20899q7;
        } else {
            i10 = org.telegram.ui.ActionBar.j6.f21043y6;
        }
        this.f22263c.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i10, false));
        invalidate();
    }
    ...
    public final void onActiveAuctionsUpdate(List list) {
        ...
        this.f22264e = arrayList;
        int size = arrayList.size();
        l lVar = this.d;
        if (size == 1) {
            GiftAuctionController.Auction auction = (GiftAuctionController.Auction) this.f22264e.get(0);
            ...
            lVar.f22231f = 0;
            lVar.f22229c.b();
            lVar.f22227a.q(LocaleController.getString(R.string.Gift2AuctionPriceView), true, true);
        }
        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder();
        int size2 = this.f22264e.size();
        if (size2 == 0) {
            return;
        }
        int currentTime = ConnectionsManager.getInstance(this.f22261a).getCurrentTime();
        int i11 = 0;
        boolean z11 = false;
        boolean z12 = false;
        while (true) {
            ...
            GiftAuctionController.Auction auction2 = (GiftAuctionController.Auction) this.f22264e.get(i11);
        ...
        this.f22265f = false;
        org.telegram.ui.Components.q6 q6Var2 = this.f22263c;
        if (z11) {
            ...
            int approximatedMyPlace = ((GiftAuctionController.Auction) this.f22264e.get(0)).getApproximatedMyPlace();
            ...
            q6Var2.setText(LocaleController.formatString(R.string.Gift2ActiveAuctionsActiveStatusWinningOne, formatString2));
        }
        a();
    }
    ...
    public final void onDetachedFromWindow() {
        ...
        GiftAuctionController.getInstance(this.f22261a).unsubscribeFromActiveAuctionsUpdates(this);
    }
