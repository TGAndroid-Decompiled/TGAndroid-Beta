...
public final class m extends FrameLayout implements GiftAuctionController.OnActiveAuctionsUpdateListeners {
    ...
    public final org.telegram.ui.Components.n6 f20403b;
    public final org.telegram.ui.Components.n6 f20404c;
    public final l d;
    public ArrayList e;
    ...
    public final void a() {
        ...
        this.f20403b.setTextColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.G6, false));
        if (this.f20405f) {
            i10 = org.telegram.ui.ActionBar.i6.f19074q7;
        } else {
            i10 = org.telegram.ui.ActionBar.i6.f19218y6;
        }
        this.f20404c.setTextColor(org.telegram.ui.ActionBar.i6.w0(null, i10, false));
        invalidate();
    }
    ...
    public final void onActiveAuctionsUpdate(List list) {
        ...
        if (size == 1) {
            ...
            lVar.f20376f = 0;
            lVar.f20375c.b();
            lVar.f20373a.q(LocaleController.getString(R.string.Gift2AuctionPriceView), true, true);
        }
        ...
        int currentTime = ConnectionsManager.getInstance(this.f20402a).getCurrentTime();
        int i11 = 0;
        boolean z11 = false;
        boolean z12 = false;
        while (true) {
        ...
        this.f20405f = false;
        org.telegram.ui.Components.n6 n6Var2 = this.f20404c;
        if (z11) {
    ...
    public final void onDetachedFromWindow() {
        ...
        GiftAuctionController.getInstance(this.f20402a).unsubscribeFromActiveAuctionsUpdates(this);
    }
