...
public final class s7 {
    public final TextPaint f22872a;
    public final Paint f22873b;
    public final Drawable f22874c;
    public final Drawable d;
    public final Paint f22875e;
    public final SparseArray f22876f;
    public final HashMap f22877g;

    public s7(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        TextPaint textPaint = new TextPaint(1);
        this.f22872a = textPaint;
        Paint paint = new Paint();
        this.f22873b = paint;
        this.f22875e = new Paint();
        this.f22876f = new SparseArray();
        this.f22877g = new HashMap();
