...
public final class s7 {
    public final TextPaint f20971a;
    public final Paint f20972b;
    public final Drawable f20973c;
    public final Drawable d;
    public final Paint e;
    public final SparseArray f20974f;
    public final HashMap f20975g;

    public s7(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        TextPaint textPaint = new TextPaint(1);
        this.f20971a = textPaint;
        Paint paint = new Paint();
        this.f20972b = paint;
        this.e = new Paint();
        this.f20974f = new SparseArray();
        this.f20975g = new HashMap();
