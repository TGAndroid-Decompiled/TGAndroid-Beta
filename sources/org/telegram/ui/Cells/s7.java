...
public final class s7 {
    public final TextPaint f22871a;
    public final Paint f22872b;
    public final Drawable f22873c;
    public final Drawable d;
    public final Paint f22874e;
    public final SparseArray f22875f;
    public final HashMap f22876g;

    public s7(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        TextPaint textPaint = new TextPaint(1);
        this.f22871a = textPaint;
        Paint paint = new Paint();
        this.f22872b = paint;
        this.f22874e = new Paint();
        this.f22875f = new SparseArray();
        this.f22876g = new HashMap();
