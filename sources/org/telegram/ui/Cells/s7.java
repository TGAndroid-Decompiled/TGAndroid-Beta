...
public final class s7 extends FrameLayout {
    public o7[] f23742a;
    public MessageObject[] f23743b;
    public int[] f23744c;
    public p7 d;
    public int f23745e;
    public boolean f23746f;
    public boolean h;
    public Paint f23747n;
    public int f23748r;
    public int f23749s;
    ...
    public final void b(int i10, boolean z4) {
        float f10;
        o7 o7Var = this.f23742a[i10];
        FrameLayout frameLayout = o7Var.f23307f;
        np npVar = o7Var.f23306e;
    ...
    public final void c(int i10, int i11, MessageObject messageObject) {
        o7[] o7VarArr = this.f23742a;
        MessageObject[] messageObjectArr = this.f23743b;
        messageObjectArr[i10] = messageObject;
        this.f23744c[i10] = i11;
    ...
    public final void onMeasure(int i10, int i11) {
        int a2;
        int dp;
        View[] viewArr = this.f23742a;
        if (this.f23748r == 1) {
            a2 = org.telegram.ui.b.z(2.0f, this.f23745e - 1, View.MeasureSpec.getSize(i10)) / this.f23745e;
        } else {
            a2 = a(this.f23745e);
        }
        this.h = true;
        int i12 = 0;
        for (int i13 = 0; i13 < this.f23745e; i13++) {
            ...
            if (i13 == this.f23745e - 1) {
                if (AndroidUtilities.isTablet()) {
                    layoutParams.width = AndroidUtilities.dp(490.0f) - ((AndroidUtilities.dp(2.0f) + a2) * (this.f23745e - 1));
                } else {
                    layoutParams.width = AndroidUtilities.displaySize.x - ((AndroidUtilities.dp(2.0f) + a2) * (this.f23745e - 1));
                }
            } else {
