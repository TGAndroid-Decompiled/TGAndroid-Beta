...
public final class s7 {
    public final TextPaint f21065a;
    public final Paint f21066b;
    public final Drawable f21067c;
    public final Drawable d;
    public final Paint e;
    public final SparseArray f21068f;
    public final HashMap f21069g;

    public s7(Context context, org.telegram.ui.ActionBar.d6 d6Var) {
        TextPaint textPaint = new TextPaint(1);
        this.f21065a = textPaint;
        Paint paint = new Paint();
        this.f21066b = paint;
        this.e = new Paint();
        this.f21068f = new SparseArray();
