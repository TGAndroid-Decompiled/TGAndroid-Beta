...
public final class s7 {
    public final TextPaint f21066a;
    public final Paint f21067b;
    public final Drawable f21068c;
    public final Drawable d;
    public final Paint e;
    public final SparseArray f21069f;
    public final HashMap f21070g;

    public s7(Context context, org.telegram.ui.ActionBar.d6 d6Var) {
        TextPaint textPaint = new TextPaint(1);
        this.f21066a = textPaint;
        Paint paint = new Paint();
        this.f21067b = paint;
        this.e = new Paint();
        this.f21069f = new SparseArray();
