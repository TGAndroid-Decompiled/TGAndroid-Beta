...
public final class e8 extends ImageReceiver {
    public final org.telegram.ui.ActionBar.d6 f20232a;
    public final f8 f20233b;
    ...
    public final boolean setImageBitmapByKey(Drawable drawable, String str, int i10, boolean z10, int i11) {
        if (drawable instanceof BitmapDrawable) {
            f8 f8Var = this.f20233b;
            if (f8Var.K == 0) {
                f8Var.K = AndroidUtilities.getDominantColor(((BitmapDrawable) drawable).getBitmap());
                int i12 = f8Var.K;
                if (i12 == -1 || i12 == 0) {
                    f8Var.K = org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19283q5, this.f20232a);
                }
