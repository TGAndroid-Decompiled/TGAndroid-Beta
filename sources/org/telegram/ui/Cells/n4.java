...
public final class n4 extends FrameLayout {
    ...
    public fg.p1 F;
    public Drawable G;
    public final org.telegram.ui.Components.p9 f23206a;
    public final hg.q f23207b;
    public final org.telegram.ui.Components.z8 f23208c;
    public int d;
    public TLRPC.User f23209e;
    public long f23210f;
    public final int h;
    public float f23211n;
    public boolean f23212r;
    public final wq f23213s;
    public final np v;
    public final boolean f23214w;
    public boolean f23215x;
    public final org.telegram.ui.Components.z5 f23216y;

    public n4(Context context, org.telegram.ui.ActionBar.g6 g6Var, boolean z4) {
        super(context);
        this.f23208c = new org.telegram.ui.Components.z8((org.telegram.ui.ActionBar.g6) null);
        new RectF();
        this.h = UserConfig.selectedAccount;
        pr prVar = pr.h;
        this.f23216y = new org.telegram.ui.Components.z5(this, 0L, 350L, prVar);
        this.C = new org.telegram.ui.Components.z5(this, 0L, 350L, prVar);
        this.E = org.telegram.ui.ActionBar.k6.f21659d6;
        this.f23214w = z4;
    ...
    public final void a(long j10, String str) {
        ...
        org.telegram.ui.Components.p9 p9Var = this.f23206a;
        org.telegram.ui.Components.z8 z8Var = this.f23208c;
        int i10 = this.h;
        hg.q qVar = this.f23207b;
        if (isUserDialog) {
            ...
            z8Var.m(i10, this.f23209e);
            p9Var.e(this.f23209e, z8Var);
        } else {
    ...
    public final void b(int i10) {
        ...
        int i13 = this.h;
        if (i12 != 0 && this.f23209e != null) {
            this.f23209e = MessagesController.getInstance(i13).getUser(Long.valueOf(this.f23209e.f20990id));
        ...
        if (i10 == 0 || (MessagesController.UPDATE_MASK_READ_DIALOG_MESSAGE & i10) != 0 || (i10 & MessagesController.UPDATE_MASK_NEW_MESSAGE) != 0) {
            TLRPC.Dialog dialog = (TLRPC.Dialog) MessagesController.getInstance(i13).dialogs_dict.f(this.f23210f);
            wq wqVar = this.f23213s;
            if (dialog != null && (i11 = dialog.unread_count) != 0) {
                if (this.d != i11) {
                    this.d = i11;
                    wqVar.f32837a.c(i11, this.f23212r);
                    return;
                }
                return;
            }
            this.d = 0;
            wqVar.f32837a.c(0, this.f23212r);
        }
    }
    ...
    public final void c(boolean z4) {
        ...
        boolean z10;
        if (this.f23215x && this.f23209e != null) {
            requirementToContact = MessagesController.getInstance(this.h).isUserContactBlocked(this.f23209e.f20990id);
        } else {
    ...
    public final void onDraw(Canvas canvas) {
        if (this.f23214w) {
            ...
            org.telegram.ui.ActionBar.k6.f21851o0.setColor(org.telegram.ui.ActionBar.k6.w0(null, org.telegram.ui.ActionBar.k6.B5, false));
            org.telegram.ui.ActionBar.k6.f21851o0.setAlpha((int) (this.v.getProgress() * 255.0f));
            canvas.drawCircle(measuredWidth, measuredHeight, AndroidUtilities.dp(28.0f), org.telegram.ui.ActionBar.k6.f21851o0);
        }
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f23213s.f32837a.E = AndroidUtilities.dp(13.0f);
    }
}
