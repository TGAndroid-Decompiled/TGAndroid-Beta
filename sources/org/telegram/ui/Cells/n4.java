...
public final class n4 extends FrameLayout {
    ...
    public rg.z0 I;
    public Drawable J;
    public final org.telegram.ui.Components.w9 f20687a;
    public final ai.p4 f20688b;
    public final org.telegram.ui.Components.h9 f20689c;
    public int d;
    public TLRPC.User e;
    public long f20690f;
    public final int h;
    ...
    public final xq f20693s;
    public final op v;
    public final boolean f20694w;
    public boolean f20695x;
    public final org.telegram.ui.Components.e6 f20696y;

    public n4(Context context, org.telegram.ui.ActionBar.d6 d6Var, boolean z10) {
        super(context);
        this.f20689c = new org.telegram.ui.Components.h9((org.telegram.ui.ActionBar.d6) null);
        new RectF();
        this.h = UserConfig.selectedAccount;
        rr rrVar = rr.h;
        this.f20696y = new org.telegram.ui.Components.e6(this, 0L, 350L, rrVar);
        this.F = new org.telegram.ui.Components.e6(this, 0L, 350L, rrVar);
        this.H = org.telegram.ui.ActionBar.h6.f19060d6;
        this.f20694w = z10;
    ...
    public final void a(long j3, String str) {
        ...
        org.telegram.ui.Components.w9 w9Var = this.f20687a;
        org.telegram.ui.Components.h9 h9Var = this.f20689c;
        int i10 = this.h;
        ai.p4 p4Var = this.f20688b;
        if (isUserDialog) {
    ...
    public final void b(int i10) {
        ...
        if (i12 != 0 && this.e != null) {
            this.e = MessagesController.getInstance(i13).getUser(Long.valueOf(this.e.f18483id));
        ...
        if (i10 == 0 || (MessagesController.UPDATE_MASK_READ_DIALOG_MESSAGE & i10) != 0 || (i10 & MessagesController.UPDATE_MASK_NEW_MESSAGE) != 0) {
            TLRPC.Dialog dialog = (TLRPC.Dialog) MessagesController.getInstance(i13).dialogs_dict.f(this.f20690f);
            xq xqVar = this.f20693s;
            if (dialog != null && (i11 = dialog.unread_count) != 0) {
                if (this.d != i11) {
                    this.d = i11;
                    xqVar.f30386a.c(i11, this.f20692r);
                    return;
                }
                return;
            }
            this.d = 0;
            xqVar.f30386a.c(0, this.f20692r);
        }
    }
    ...
    public final void c(boolean z10) {
        ...
        boolean z11;
        if (this.f20695x && this.e != null) {
            requirementToContact = MessagesController.getInstance(this.h).isUserContactBlocked(this.e.f18483id);
        } else {
    ...
    public final void onDraw(Canvas canvas) {
        if (this.f20694w) {
            ...
            org.telegram.ui.ActionBar.h6.f19255o0.setColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.B5, false));
            org.telegram.ui.ActionBar.h6.f19255o0.setAlpha((int) (this.v.getProgress() * 255.0f));
            canvas.drawCircle(measuredWidth, measuredHeight, AndroidUtilities.dp(28.0f), org.telegram.ui.ActionBar.h6.f19255o0);
        }
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f20693s.f30386a.E = AndroidUtilities.dp(13.0f);
    }
}
