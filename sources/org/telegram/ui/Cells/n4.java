...
public final class n4 extends FrameLayout {
    ...
    public rg.z0 I;
    public Drawable J;
    public final org.telegram.ui.Components.u9 f20456a;
    public final ai.p4 f20457b;
    public final org.telegram.ui.Components.f9 f20458c;
    public int d;
    public TLRPC.User e;
    public long f20459f;
    public final int h;
    ...
    public final wq f20462s;
    public final np v;
    public final boolean f20463w;
    public boolean f20464x;
    public final org.telegram.ui.Components.c6 f20465y;

    public n4(Context context, org.telegram.ui.ActionBar.e6 e6Var, boolean z10) {
        super(context);
        this.f20458c = new org.telegram.ui.Components.f9((org.telegram.ui.ActionBar.e6) null);
        new RectF();
        this.h = UserConfig.selectedAccount;
        qr qrVar = qr.h;
        this.f20465y = new org.telegram.ui.Components.c6(this, 0L, 350L, qrVar);
        this.F = new org.telegram.ui.Components.c6(this, 0L, 350L, qrVar);
        this.H = org.telegram.ui.ActionBar.i6.f18834d6;
        this.f20463w = z10;
    ...
    public final void a(long j3, String str) {
        ...
        org.telegram.ui.Components.u9 u9Var = this.f20456a;
        org.telegram.ui.Components.f9 f9Var = this.f20458c;
        int i10 = this.h;
        ai.p4 p4Var = this.f20457b;
        if (isUserDialog) {
    ...
    public final void b(int i10) {
        ...
        if (i12 != 0 && this.e != null) {
            this.e = MessagesController.getInstance(i13).getUser(Long.valueOf(this.e.f18256id));
        ...
        if (i10 == 0 || (MessagesController.UPDATE_MASK_READ_DIALOG_MESSAGE & i10) != 0 || (i10 & MessagesController.UPDATE_MASK_NEW_MESSAGE) != 0) {
            TLRPC.Dialog dialog = (TLRPC.Dialog) MessagesController.getInstance(i13).dialogs_dict.f(this.f20459f);
            wq wqVar = this.f20462s;
            if (dialog != null && (i11 = dialog.unread_count) != 0) {
                if (this.d != i11) {
                    this.d = i11;
                    wqVar.f29766a.c(i11, this.f20461r);
                    return;
                }
                return;
            }
            this.d = 0;
            wqVar.f29766a.c(0, this.f20461r);
        }
    }
    ...
    public final void c(boolean z10) {
        ...
        boolean z11;
        if (this.f20464x && this.e != null) {
            requirementToContact = MessagesController.getInstance(this.h).isUserContactBlocked(this.e.f18256id);
        } else {
    ...
    public final void onDraw(Canvas canvas) {
        if (this.f20463w) {
            ...
            org.telegram.ui.ActionBar.i6.f19029o0.setColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.B5, false));
            org.telegram.ui.ActionBar.i6.f19029o0.setAlpha((int) (this.v.getProgress() * 255.0f));
            canvas.drawCircle(measuredWidth, measuredHeight, AndroidUtilities.dp(28.0f), org.telegram.ui.ActionBar.i6.f19029o0);
        }
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f20462s.f29766a.E = AndroidUtilities.dp(13.0f);
    }
}
