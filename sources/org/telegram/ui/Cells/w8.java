...
public class w8 extends FrameLayout {
    ...
    public void setAnimationProgress(float f7) {
        ...
        float max = (Math.max(lastTouchX, getMeasuredWidth() - lastTouchX) + AndroidUtilities.dp(40.0f)) * this.f21804s;
        Switch r22 = this.e;
        r22.R = lastTouchX;
    ...
    public final void b(int i10, boolean z10) {
        ObjectAnimator objectAnimator = this.f21806x;
        ...
        this.f21806x = ofFloat;
        ofFloat.addListener(new u8(this, i10, 0));
        this.f21806x.setInterpolator(rr.f28023g);
        this.f21806x.setDuration(240L).start();
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.f21803r != 0) {
            float lastTouchX = getLastTouchX();
            canvas.drawCircle(lastTouchX, getMeasuredHeight() / 2, (Math.max(lastTouchX, getMeasuredWidth() - lastTouchX) + AndroidUtilities.dp(40.0f)) * this.f21804s, this.v);
        }
        if (this.f21801f) {
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        sb2.append(this.f21800c.getText());
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        super.onMeasure(makeMeasureSpec, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(f7) + (this.f21801f ? 1 : 0), 1073741824));
    }

    @Override
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        this.f21805w = motionEvent.getX();
    ...
    public void setTypeface(Typeface typeface) {
        this.f21800c.setTypeface(typeface);
    }
    ...
    public w8(int i10, Context context, org.telegram.ui.ActionBar.d6 d6Var, boolean z10) {
        ...
        this.f21800c = textView;
        ok.n(z10 ? org.telegram.ui.ActionBar.h6.f19151j5 : org.telegram.ui.ActionBar.h6.G6, d6Var, textView, 1, 16.0f);
        textView.setLines(1);
        ...
        this.d = textView2;
        ok.n(z10 ? org.telegram.ui.ActionBar.h6.J5 : org.telegram.ui.ActionBar.h6.f19447z6, d6Var, textView2, 1, 13.0f);
