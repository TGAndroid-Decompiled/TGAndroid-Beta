...
public class w8 extends FrameLayout {
    ...
    public final Switch f23518e;
    public boolean f23519f;
    public boolean h;
    public int f23520n;
    public int f23521r;
    public float f23522s;
    public Paint v;
    public float f23523w;
    public ObjectAnimator f23524x;
    ...
    public void setAnimationProgress(float f7) {
        ...
        float max = (Math.max(lastTouchX, getMeasuredWidth() - lastTouchX) + AndroidUtilities.dp(40.0f)) * this.f23522s;
        Switch r22 = this.f23518e;
        r22.R = lastTouchX;
    ...
    public final void b(int i10, boolean z10) {
        ObjectAnimator objectAnimator = this.f23524x;
        if (objectAnimator != null) {
            objectAnimator.cancel();
            this.f23524x = null;
        }
        int i11 = this.f23521r;
        if (i11 != 0) {
        ...
        this.f23518e.setOverrideColor(i12);
        this.f23521r = i10;
        this.v.setColor(i10);
        this.f23522s = 0.0f;
        ObjectAnimator ofFloat = ObjectAnimator.ofFloat(this, J, 0.0f, 1.0f);
        this.f23524x = ofFloat;
        ofFloat.addListener(new u8(this, i10, 0));
        this.f23524x.setInterpolator(pr.f29495g);
        this.f23524x.setDuration(240L).start();
    }
    ...
    public final void c(int i10, int i11) {
        ...
        if (this.G == null) {
            ...
            TextView textView = this.f23517c;
    ...
    public final void d(int i10, int i11, int i12, int i13, int i14) {
        ...
        this.f23518e.d(i11, i12, i13, i14);
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.f23521r != 0) {
            float lastTouchX = getLastTouchX();
            canvas.drawCircle(lastTouchX, getMeasuredHeight() / 2, (Math.max(lastTouchX, getMeasuredWidth() - lastTouchX) + AndroidUtilities.dp(40.0f)) * this.f23522s, this.v);
        }
        if (this.f23519f) {
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        accessibilityNodeInfo.setChecked(this.f23518e.h);
        StringBuilder sb2 = new StringBuilder();
        sb2.append(this.f23517c.getText());
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        super.onMeasure(makeMeasureSpec, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(f7) + (this.f23519f ? 1 : 0), 1073741824));
    }

    @Override
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        this.f23523w = motionEvent.getX();
    ...
    public void setCheckBoxIcon(int i10) {
        this.f23518e.setIcon(i10);
    }

    public void setChecked(boolean z10) {
        this.f23518e.c(z10, true);
    }
    ...
    public void setPressed(boolean z10) {
        if (this.f23525y) {
            this.f23518e.setDrawRipple(z10);
        }
        super.setPressed(z10);
    }

    public void setTypeface(Typeface typeface) {
        this.f23517c.setTypeface(typeface);
    }
    ...
    public w8(int i10, Context context, org.telegram.ui.ActionBar.f6 f6Var, boolean z10) {
        ...
        vl.n(z10 ? org.telegram.ui.ActionBar.j6.f20798j5 : org.telegram.ui.ActionBar.j6.G6, f6Var, textView, 1, 16.0f);
        textView.setLines(1);
        ...
        this.d = textView2;
        vl.n(z10 ? org.telegram.ui.ActionBar.j6.J5 : org.telegram.ui.ActionBar.j6.f21089z6, f6Var, textView2, 1, 13.0f);
