...
public class w8 extends FrameLayout {
    ...
    public Paint v;
    public float f21586w;
    public ObjectAnimator f21587x;
    ...
    public void setAnimationProgress(float f7) {
        ...
        float max = (Math.max(lastTouchX, getMeasuredWidth() - lastTouchX) + AndroidUtilities.dp(40.0f)) * this.f21585s;
        Switch r22 = this.e;
        r22.R = lastTouchX;
    ...
    public final void b(int i10, boolean z10) {
        ObjectAnimator objectAnimator = this.f21587x;
        ...
        this.f21587x = ofFloat;
        ofFloat.addListener(new u8(this, i10, 0));
        this.f21587x.setInterpolator(qr.f27421g);
        this.f21587x.setDuration(240L).start();
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.f21584r != 0) {
            float lastTouchX = getLastTouchX();
            canvas.drawCircle(lastTouchX, getMeasuredHeight() / 2, (Math.max(lastTouchX, getMeasuredWidth() - lastTouchX) + AndroidUtilities.dp(40.0f)) * this.f21585s, this.v);
        }
        if (this.f21582f) {
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        sb2.append(this.f21581c.getText());
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        super.onMeasure(makeMeasureSpec, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(f7) + (this.f21582f ? 1 : 0), 1073741824));
    }

    @Override
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        this.f21586w = motionEvent.getX();
    ...
    public void setTypeface(Typeface typeface) {
        this.f21581c.setTypeface(typeface);
    }
    ...
    public w8(int i10, Context context, org.telegram.ui.ActionBar.e6 e6Var, boolean z10) {
        ...
        vl.o(z10 ? org.telegram.ui.ActionBar.i6.f18940j5 : org.telegram.ui.ActionBar.i6.G6, e6Var, textView, 1, 16.0f);
        textView.setLines(1);
        ...
        this.d = textView2;
        vl.o(z10 ? org.telegram.ui.ActionBar.i6.J5 : org.telegram.ui.ActionBar.i6.f19234z6, e6Var, textView2, 1, 13.0f);
