            ...
            if (MessageObject.canAutoplayAnimatedSticker(document)) {
                ...
                if (z16 && (MessageObject.isAnimatedStickerDocument(document, true) || MessageObject.isVideoSticker(document))) {
                    if (svgThumb != null) {
                        ...
                        v9Var.j(ImageLocation.getForDocument(document), "50_50", forSticker, null, 0, stickerSetCovered);
                    }
                } else if (forSticker != null && forSticker.imageType == 1) {
                    v9Var.i(forSticker, "50_50", "tgs", svgThumb, stickerSetCovered);
                } else {
                    v9Var.i(forSticker, "50_50", "webp", svgThumb, stickerSetCovered);
                }
            } else {
