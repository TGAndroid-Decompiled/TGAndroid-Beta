...
import org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda175;
...
public final class ChatMessageCell$$ExternalSyntheticLambda5 implements Runnable {
    ...
    public ChatMessageCell$$ExternalSyntheticLambda5(Object obj, int i, long j, int i2) {
        this.$r8$classId = i2;
        this.f$0 = obj;
        this.f$2 = i;
        this.f$1 = j;
    ...
    public final void run() {
        switch (this.$r8$classId) {
            case 0:
                BotForumHelper.BotDraftAnimationsPool botDraftAnimationsPool = ((ChatMessageCell) this.f$0).draftAnimationsPool;
                if (botDraftAnimationsPool != null) {
                    botDraftAnimationsPool.removeAnimator(this.f$1, this.f$2);
                }
                break;
            case 1:
            ...
            case 5:
                ...
                break;
            case 6:
                ((SharedMediaLayout) this.f$0).lambda$openDeleteStoriesAlbumAlert$71(this.f$2, this.f$1);
                break;
            case 7:
                ...
                if (safeLastFragment != null) {
                    ...
                    if (chat != null) {
                        AndroidUtilities.runOnUIThread(new LaunchActivity$$ExternalSyntheticLambda175(chatActivityOf, this.f$1, chat, 1), 250L);
                    }
                    break;
                }
                break;
    ...
    public ChatMessageCell$$ExternalSyntheticLambda5(Object obj, long j, int i, int i2) {
        this.$r8$classId = i2;
        this.f$0 = obj;
        this.f$1 = j;
        this.f$2 = i;
