...
public final class u0 {
    ...
    public u0() {
        ...
        textPaint.setTextSize(AndroidUtilities.dp(this.f21239b * 24.0f));
        paint.setColor(-1);
    }
    ...
    public void a(CharSequence charSequence, TextPaint textPaint, int i10) {
        ...
        this.f21241f = staticLayout;
        w0 w0Var2 = (w0) this.f21243i;
        MessageObject messageObject = w0Var2.H0;
        ArrayList arrayList = this.f21240c;
        ...
        this.h = org.telegram.ui.Components.z5.update(0, (View) w0Var, false, (org.telegram.ui.Components.v5) this.h, (StaticLayout) this.f21241f);
    }

    public u0(w0 w0Var) {
        this.f21243i = w0Var;
        this.f21240c = new ArrayList();
        this.f21242g = new AtomicReference();
    }
}
