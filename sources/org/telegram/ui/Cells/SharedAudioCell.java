...
public class SharedAudioCell extends FrameLayout implements DownloadController.FileDownloadProgressListener, NotificationCenter.NotificationCenterDelegate {
    ...
    public SharedAudioCell(Context context, int i, Theme.ResourcesProvider resourcesProvider) {
        ...
        if (resourcesProvider != null) {
            ...
            this.titlePaint.setColor(resourcesProvider.getColor(Theme.key_windowBackgroundWhiteBlackText));
        }
    }
    ...
    public boolean isDownloaded() {
        ...
        return messageObject.attachPathExists || messageObject.mediaExists;
    }
    ...
    public void onMeasure(int i, int i2) {
        ...
        try {
            ...
            StaticLayout staticLayout = new StaticLayout(TextUtils.ellipsize(charSequenceCreateFromInfoString, textPaint2, size - iDp, TextUtils.TruncateAt.END), textPaint2, (AndroidUtilities.dp(4.0f) + size) - iDp, Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
        ...
        try {
            if (this.viewType == 1 && (this.currentMessageObject.isVoice() || this.currentMessageObject.isRoundVideo())) {
                ...
                this.descriptionLayout = new StaticLayout(TextUtils.ellipsize(duration, textPaint3, size, TextUtils.TruncateAt.END), textPaint3, size + AndroidUtilities.dp(4.0f), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
            } else {
                ...
                this.descriptionLayout = new StaticLayout(SpannableStringBuilder.valueOf(TextUtils.ellipsize(charSequenceReplace, textPaint4, size - textPaint4.measureText(str), TextUtils.TruncateAt.END)).append((CharSequence) str), textPaint4, size + AndroidUtilities.dp(4.0f), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
            }
        ...
        int iDp2 = AndroidUtilities.dp(4.0f) + iM;
        this.buttonX = iDp2;
        int iDp3 = AndroidUtilities.dp(6.0f);
        this.buttonY = iDp3;
        radialProgress2.setProgressRect(iDp2, iDp3, AndroidUtilities.dp(48.0f) + iM, AndroidUtilities.dp(50.0f));
    ...
    public void updateButtonState(boolean z, boolean z2) {
        ...
        this.radialProgress.setMiniProgressBackgroundColor(Theme.getColor(this.currentMessageObject.isOutOwner() ? Theme.key_chat_outLoader : Theme.key_chat_inLoader, this.resourcesProvider));
