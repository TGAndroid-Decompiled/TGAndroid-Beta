...
public final class y1 extends FrameLayout {
    ...
    public View G;
    public int f22575a;
    public final org.telegram.ui.ActionBar.f6 f22576b;
    public final w1 f22577c;
    public final v1 d;
    public final View e;
    public final TextView f22578f;
    public final View h;
    public final CheckBoxSquare f22579n;
    public final kp f22580r;
    public View f22581s;
    public final x1 v;
    public final org.telegram.ui.Components.p9 f22582w;
    public final org.telegram.ui.Components.z8 f22583x;
    ...
    public final boolean b() {
        kp kpVar = this.f22580r;
        if (kpVar != null) {
            return kpVar.f26377a.f22938q;
        }
        return this.f22579n.h;
    }
    ...
    public final void d(org.telegram.ui.a aVar, org.telegram.messenger.video.g gVar) {
        ...
        if (aVar == null) {
            ...
            if (this.F == null) {
                ...
                this.F = view2;
                view2.setBackground(org.telegram.ui.ActionBar.j6.f0(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19971i6, this.f22576b), 2, -1));
        ...
        if (this.G == null) {
            ...
            addView(view4, k7.b6.e(56, -1, i10));
        }
    ...
    public final void e(CharSequence charSequence, String str, boolean z4, boolean z10, boolean z11) {
        if (this.E) {
            ...
            this.f22577c.setText(charSequence);
        }
        kp kpVar = this.f22580r;
        if (kpVar != null) {
            kpVar.a(z4, z11);
        } else {
            this.f22579n.a(z4, z11);
        }
        this.f22578f.setText(str);
        this.C = z10;
        setWillNotDraw(!z10);
    }
    ...
    public final void f() {
        ...
        this.f22581s.setTranslationX(left);
    }
    ...
    public final void g() {
        ...
        int i13;
        boolean z4 = this.E;
        org.telegram.ui.ActionBar.f6 f6Var = this.f22576b;
        int i14 = this.f22584y;
        if (z4) {
            if (i14 != 1 && i14 != 5) {
                i13 = org.telegram.ui.ActionBar.j6.G6;
            } else {
                i13 = org.telegram.ui.ActionBar.j6.f19987j5;
            }
            ...
            w1 w1Var = this.f22577c;
            w1Var.setTextColor(v02);
            if (i14 != 1 && i14 != 5) {
                i11 = org.telegram.ui.ActionBar.j6.J6;
            } else {
                i11 = org.telegram.ui.ActionBar.j6.f20005k5;
            }
        ...
        if (i14 != 1 && i14 != 5) {
            ...
            i12 = org.telegram.ui.ActionBar.j6.f20041m5;
        }
        this.f22578f.setTextColor(org.telegram.ui.ActionBar.j6.v0(i12, f6Var));
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.C) {
            ...
            int dp = AndroidUtilities.dp(f10) + ((int) Math.abs(this.e.getTranslationX()));
            if (this.f22584y == 7) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        int i12 = this.B;
        View view2 = this.e;
        TextView textView = this.f22578f;
        int i13 = this.f22584y;
        if (i13 == 3) {
            ...
            org.telegram.ui.Components.p9 p9Var = this.f22582w;
            if (p9Var != null) {
    ...
    public void setCollapsed(Boolean bool) {
        ...
        if (this.f22581s == null) {
            this.f22581s = new View(getContext());
            Drawable mutate = getContext().getResources().getDrawable(R.drawable.arrow_more).mutate();
            mutate.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.G6, this.f22576b), PorterDuff.Mode.MULTIPLY));
            this.f22581s.setBackground(mutate);
            addView(this.f22581s, k7.b6.e(16, 16, 16));
        }
        f();
        this.f22581s.animate().cancel();
        ViewPropertyAnimator animate = this.f22581s.animate();
        if (bool.booleanValue()) {
            f10 = 0.0f;
        } else {
            f10 = 180.0f;
        }
        animate.rotation(f10).setDuration(340L).setInterpolator(mr.h).start();
    }
    ...
    public void setTextColor(int i10) {
        if (this.E) {
            ...
            this.f22577c.setTextColor(i10);
        }
    }

    public void setUserOrChat(TLObject tLObject) {
        String formatName;
        org.telegram.ui.Components.z8 z8Var = this.f22583x;
        z8Var.p(tLObject);
        this.f22582w.e(tLObject, z8Var);
        ...
        if (z4 && ((TLRPC.User) tLObject).f19306id == MessagesController.getInstance(UserConfig.selectedAccount).telegramAntispamUserId) {
        ...
        this.f22577c.setText(formatName);
    }
    ...
    public y1(int i10, int i11, Context context, org.telegram.ui.ActionBar.f6 f6Var, boolean z4) {
        ...
        if (z4) {
            ...
            v1Var.setTag(Integer.valueOf(org.telegram.ui.ActionBar.j6.v0((i10 == 1 || i10 == 5) ? org.telegram.ui.ActionBar.j6.f19987j5 : org.telegram.ui.ActionBar.j6.G6, f6Var)));
            ...
            w1Var.setTag(Integer.valueOf(org.telegram.ui.ActionBar.j6.v0((i10 == 1 || i10 == 5) ? org.telegram.ui.ActionBar.j6.f19987j5 : org.telegram.ui.ActionBar.j6.G6, f6Var)));
        ...
        textView.setTag(Integer.valueOf((i10 == 1 || i10 == 5) ? org.telegram.ui.ActionBar.j6.f20041m5 : org.telegram.ui.ActionBar.j6.I6));
        ...
        if (i10 == 6) {
            ...
            this.f22583x = new org.telegram.ui.Components.z8((org.telegram.ui.ActionBar.f6) null);
