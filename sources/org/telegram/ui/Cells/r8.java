...
public class r8 extends FrameLayout {
    ...
    public boolean O;
    public int P;
    public final org.telegram.ui.ActionBar.j5 f22681a;
    public final org.telegram.ui.ActionBar.j5 f22682b;
    public final org.telegram.ui.Components.q6 f22683c;
    public final org.telegram.ui.ActionBar.j5 d;
    public final aj0 f22684e;
    public Switch f22685f;
    public final ImageView h;
    public int f22686n;
    public boolean f22687r;
    public int f22688s;
    public int v;
    public int f22689w;
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        if (o5Var3 != null) {
            o5Var3.setBounds((getWidth() - this.K.f28965s) - AndroidUtilities.dp(18.0f), (getHeight() - this.K.f28965s) / 2, getWidth() - AndroidUtilities.dp(18.0f), (getHeight() + this.K.f28965s) / 2);
            this.K.draw(canvas);
        }
    }
    ...
    public final void e(int i10, int i11) {
        ...
        org.telegram.ui.ActionBar.j5 j5Var = this.f22681a;
    ...
    public final void g(boolean z10) {
        ...
        ViewPropertyAnimator animate = this.f22681a.animate();
        float f12 = 0.5f;
        if (z10) {
            f7 = 1.0f;
        } else {
        ...
        ViewPropertyAnimator animate2 = this.f22682b.animate();
        if (z10) {
            f10 = 1.0f;
        } else {
            f10 = 0.5f;
        ...
        ViewPropertyAnimator animate3 = this.f22683c.animate();
        if (z10) {
            f11 = 1.0f;
        } else {
            f11 = 0.5f;
    ...
    public final void i(CharSequence charSequence, boolean z10) {
        ...
        j5Var.i(null);
        this.M = null;
        org.telegram.ui.Components.q6 q6Var = this.f22683c;
        q6Var.c(null, false, true);
        this.f22684e.setVisibility(8);
    ...
    public final void j(CharSequence charSequence, boolean z10, boolean z11) {
        ...
        this.h.setVisibility(8);
        this.f22687r = z11;
        Switch r62 = this.f22685f;
        if (r62 != null) {
            r62.setVisibility(0);
            this.f22685f.c(z10, false);
        }
        setWillNotDraw(!this.f22687r);
        org.telegram.ui.Components.o5 o5Var = this.K;
        if (o5Var != null) {
            o5Var.g(null, false);
        }
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.f22687r) {
            ...
            if (paint == null) {
                paint = org.telegram.ui.ActionBar.j6.f20786k0;
            }
            Paint paint2 = paint;
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (this.f22685f != null) {
            ...
            accessibilityNodeInfo.setChecked(this.f22685f.h);
    ...
    public void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (LocaleController.isRTL) {
            measuredWidth = AndroidUtilities.dp(this.f22686n - 6);
        } else {
            measuredWidth = (i18 - q6Var.getMeasuredWidth()) - AndroidUtilities.dp(this.f22686n - 6);
        }
        if (this.f22691y && !LocaleController.isRTL) {
            measuredWidth = (i18 - q6Var.getMeasuredWidth()) - AndroidUtilities.dp(this.f22686n);
        }
        q6Var.layout(measuredWidth, max, q6Var.getMeasuredWidth() + measuredWidth, q6Var.getMeasuredHeight() + max);
        if (LocaleController.isRTL) {
            measuredWidth2 = AndroidUtilities.dp(this.f22686n - 6);
        } else {
            measuredWidth2 = (i18 - j5Var.getMeasuredWidth()) - AndroidUtilities.dp(this.f22686n - 6);
        }
        j5Var.layout(measuredWidth2, max, j5Var.getMeasuredWidth() + measuredWidth2, j5Var.getMeasuredHeight() + max);
        boolean z11 = LocaleController.isRTL;
        aj0 aj0Var = this.f22684e;
        org.telegram.ui.ActionBar.j5 j5Var2 = this.f22681a;
        if (z11) {
        ...
        org.telegram.ui.ActionBar.j5 j5Var3 = this.f22682b;
        ...
        if (aj0Var.getVisibility() == 0) {
            ...
            if (!LocaleController.isRTL) {
                measuredWidth5 = AndroidUtilities.dp(this.f22689w);
            } else {
                measuredWidth5 = (i18 - aj0Var.getMeasuredWidth()) - AndroidUtilities.dp(this.f22689w);
            }
        ...
        Switch r92 = this.f22685f;
        if (r92 != null && r92.getVisibility() == 0) {
            int measuredHeight = (i17 - this.f22685f.getMeasuredHeight()) / 2;
            if (LocaleController.isRTL) {
                measuredWidth3 = AndroidUtilities.dp(22.0f);
            } else {
                measuredWidth3 = (i18 - this.f22685f.getMeasuredWidth()) - AndroidUtilities.dp(22.0f);
            }
            Switch r10 = this.f22685f;
            r10.layout(measuredWidth3, measuredHeight, r10.getMeasuredWidth() + measuredWidth3, this.f22685f.getMeasuredHeight() + measuredHeight);
        }
    }
    ...
    public void onMeasure(int i10, int i11) {
        ...
        this.L = size;
        boolean z10 = this.f22691y;
        org.telegram.ui.ActionBar.j5 j5Var = this.f22682b;
        org.telegram.ui.ActionBar.j5 j5Var2 = this.d;
        org.telegram.ui.ActionBar.j5 j5Var3 = this.f22681a;
        if (z10) {
            j5Var3.measure(vl.d(this.f22686n + 71, size, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), 1073741824));
            j5Var.measure(vl.d(this.f22686n + 71, size, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), 1073741824));
            int dp2 = (size - AndroidUtilities.dp(this.f22686n + 103)) - j5Var3.getTextWidth();
            if (LocaleController.isRTL) {
            ...
            int dp3 = (size - AndroidUtilities.dp(this.f22686n + 103)) - j5Var3.getTextWidth();
            if (LocaleController.isRTL) {
            ...
            int dp4 = size - AndroidUtilities.dp(this.f22686n);
            if (LocaleController.isRTL) {
            ...
            int dp5 = size - AndroidUtilities.dp(this.f22686n);
            if (LocaleController.isRTL) {
            ...
            j5Var3.measure(View.MeasureSpec.makeMeasureSpec(Math.max(0, (size - AndroidUtilities.dp(this.f22686n + 71)) - max), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), 1073741824));
            j5Var.measure(View.MeasureSpec.makeMeasureSpec((size - AndroidUtilities.dp(this.f22686n + 71)) - max, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), 1073741824));
        }
        aj0 aj0Var = this.f22684e;
        if (aj0Var.getVisibility() == 0) {
        ...
        setMeasuredDimension(size, dp + (this.f22687r ? 1 : 0));
    }
    ...
    public final void s(CharSequence charSequence, CharSequence charSequence2, boolean z10, int i10, boolean z11) {
        ...
        if (charSequence2 != null) {
            ...
            this.M = charSequence2;
            q6Var.c(TextUtils.ellipsize(charSequence2, q6Var.getPaint(), (int) Math.max(1.0f, AndroidUtilities.displaySize.x - ((g10 + AndroidUtilities.dp(this.f22688s)) + AndroidUtilities.dp(16.0f))), TextUtils.TruncateAt.END), z10, true);
        } else {
            q6Var.c("", z10, true);
        }
        q6Var.setVisibility(0);
    ...
    public final void v() {
        ...
        if (i10 != org.telegram.ui.ActionBar.j6.f20771j5 && i10 != org.telegram.ui.ActionBar.j6.G6) {
            v02 = c(v02);
        }
        j5Var.setTextColor(v02);
        aj0 aj0Var = this.f22684e;
        if (aj0Var.getTag() instanceof Integer) {
            ...
            if (intValue != org.telegram.ui.ActionBar.j6.J5 && intValue != org.telegram.ui.ActionBar.j6.f20828m6) {
                v03 = c(v03);
            }
            aj0Var.setColorFilter(new PorterDuffColorFilter(v03, PorterDuff.Mode.SRC_IN));
        }
        this.f22682b.setTextColor(c(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f21043y6, f6Var)));
        int i11 = org.telegram.ui.ActionBar.j6.I6;
        this.f22683c.setTextColor(c(org.telegram.ui.ActionBar.j6.v0(i11, f6Var)));
    ...
    public r8(int i10, Context context, org.telegram.ui.ActionBar.f6 f6Var, boolean z10, boolean z11) {
        ...
        this.f22681a = j5Var;
        j5Var.setTextColor(org.telegram.ui.ActionBar.j6.v0(z10 ? org.telegram.ui.ActionBar.j6.f20771j5 : org.telegram.ui.ActionBar.j6.G6, f6Var));
        ...
        this.f22682b = j5Var2;
        j5Var2.setTextColor(org.telegram.ui.ActionBar.j6.v0(z10 ? org.telegram.ui.ActionBar.j6.p5 : org.telegram.ui.ActionBar.j6.f21043y6, f6Var));
        ...
        this.f22683c = q6Var;
        q6Var.setTextColor(org.telegram.ui.ActionBar.j6.v0(z10 ? org.telegram.ui.ActionBar.j6.f20846n5 : org.telegram.ui.ActionBar.j6.I6, f6Var));
        ...
        if (!j5Var3.P) {
            j5Var3.f20583n0 = true;
            j5Var3.f20585p0 = bool;
            j5Var3.m();
            j5Var3.b();
        }
        j5Var3.f20586q0 = 18;
        j5Var3.m();
        j5Var3.setTextColor(org.telegram.ui.ActionBar.j6.v0(z10 ? org.telegram.ui.ActionBar.j6.f20846n5 : org.telegram.ui.ActionBar.j6.I6, f6Var));
        ...
        imageView.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(z10 ? org.telegram.ui.ActionBar.j6.J5 : org.telegram.ui.ActionBar.j6.f20828m6, f6Var), PorterDuff.Mode.SRC_IN));
        addView(imageView);
        ...
        if (z11) {
            ...
            addView(this.f22685f, w7.x5.d(37, 20.0f, (LocaleController.isRTL ? 3 : 5) | 16, 22.0f, 0.0f, 22.0f, 0.0f));
        }
        setFocusable(true);
    }
