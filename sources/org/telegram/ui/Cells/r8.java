...
public class r8 extends FrameLayout {
    ...
    public boolean O;
    public int P;
    public final org.telegram.ui.ActionBar.j5 f20838a;
    public final org.telegram.ui.ActionBar.j5 f20839b;
    public final org.telegram.ui.Components.p6 f20840c;
    public final org.telegram.ui.ActionBar.j5 d;
    public final lj0 e;
    public Switch f20841f;
    ...
    public static SpannableStringBuilder a(String str) {
        ...
        d10 d10Var = new d10();
        d10Var.f32835f = org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.Lj, false);
        spannableStringBuilder.setSpan(d10Var, spannableStringBuilder.length() - 1, spannableStringBuilder.length(), 0);
        return spannableStringBuilder;
    }

    public final boolean b() {
        Switch r02 = this.f20841f;
        if (r02 != null && r02.h) {
            return true;
        }
        return false;
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        if (o5Var3 != null) {
            o5Var3.setBounds((getWidth() - this.K.f26858s) - AndroidUtilities.dp(18.0f), (getHeight() - this.K.f26858s) / 2, getWidth() - AndroidUtilities.dp(18.0f), (getHeight() + this.K.f26858s) / 2);
            this.K.draw(canvas);
        }
    }
    ...
    public final void e(int i10, int i11) {
        ...
        org.telegram.ui.ActionBar.j5 j5Var = this.f20838a;
    ...
    public final void g(boolean z10) {
        ...
        ViewPropertyAnimator animate = this.f20838a.animate();
        float f12 = 0.5f;
        if (z10) {
            f7 = 1.0f;
        } else {
        ...
        ViewPropertyAnimator animate2 = this.f20839b.animate();
        if (z10) {
            f10 = 1.0f;
        } else {
            f10 = 0.5f;
        ...
        ViewPropertyAnimator animate3 = this.f20840c.animate();
        if (z10) {
            f11 = 1.0f;
        } else {
            f11 = 0.5f;
    ...
    public final void i(CharSequence charSequence, boolean z10) {
        ...
        j5Var.i(null);
        this.M = null;
        org.telegram.ui.Components.p6 p6Var = this.f20840c;
    ...
    public final void j(CharSequence charSequence, boolean z10, boolean z11) {
        ...
        this.h.setVisibility(8);
        this.f20843r = z11;
        Switch r62 = this.f20841f;
        if (r62 != null) {
            r62.setVisibility(0);
            this.f20841f.c(z10, false);
        }
        setWillNotDraw(!this.f20843r);
        org.telegram.ui.Components.o5 o5Var = this.K;
        if (o5Var != null) {
            o5Var.g(null, false);
        }
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (this.f20841f != null) {
            ...
            accessibilityNodeInfo.setChecked(this.f20841f.h);
    ...
    public void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (LocaleController.isRTL) {
            measuredWidth = AndroidUtilities.dp(this.f20842n - 6);
        } else {
            measuredWidth = (i18 - p6Var.getMeasuredWidth()) - AndroidUtilities.dp(this.f20842n - 6);
        }
        if (this.f20847y && !LocaleController.isRTL) {
            measuredWidth = (i18 - p6Var.getMeasuredWidth()) - AndroidUtilities.dp(this.f20842n);
        }
        p6Var.layout(measuredWidth, max, p6Var.getMeasuredWidth() + measuredWidth, p6Var.getMeasuredHeight() + max);
        if (LocaleController.isRTL) {
            measuredWidth2 = AndroidUtilities.dp(this.f20842n - 6);
        } else {
            measuredWidth2 = (i18 - j5Var.getMeasuredWidth()) - AndroidUtilities.dp(this.f20842n - 6);
        }
        j5Var.layout(measuredWidth2, max, j5Var.getMeasuredWidth() + measuredWidth2, j5Var.getMeasuredHeight() + max);
        boolean z11 = LocaleController.isRTL;
        lj0 lj0Var = this.e;
        org.telegram.ui.ActionBar.j5 j5Var2 = this.f20838a;
        if (z11) {
        ...
        org.telegram.ui.ActionBar.j5 j5Var3 = this.f20839b;
        if (j5Var3.getVisibility() == 0) {
            ...
            float f10 = i15;
            int dp2 = AndroidUtilities.dp(1.0f) + wh.A(f10, (i17 - j5Var2.getTextHeight()) - j5Var3.getTextHeight(), 2);
        ...
        if (lj0Var.getVisibility() == 0) {
            ...
            if (!LocaleController.isRTL) {
                measuredWidth5 = AndroidUtilities.dp(this.f20845w);
            } else {
                measuredWidth5 = (i18 - lj0Var.getMeasuredWidth()) - AndroidUtilities.dp(this.f20845w);
            }
        ...
        Switch r92 = this.f20841f;
        if (r92 != null && r92.getVisibility() == 0) {
            int measuredHeight = (i17 - this.f20841f.getMeasuredHeight()) / 2;
            if (LocaleController.isRTL) {
                measuredWidth3 = AndroidUtilities.dp(22.0f);
            } else {
                measuredWidth3 = (i18 - this.f20841f.getMeasuredWidth()) - AndroidUtilities.dp(22.0f);
            }
            Switch r10 = this.f20841f;
            r10.layout(measuredWidth3, measuredHeight, r10.getMeasuredWidth() + measuredWidth3, this.f20841f.getMeasuredHeight() + measuredHeight);
        }
    }
    ...
    public void onMeasure(int i10, int i11) {
        ...
        this.L = size;
        boolean z10 = this.f20847y;
        org.telegram.ui.ActionBar.j5 j5Var = this.f20839b;
        org.telegram.ui.ActionBar.j5 j5Var2 = this.d;
        org.telegram.ui.ActionBar.j5 j5Var3 = this.f20838a;
        if (z10) {
            j5Var3.measure(wh.y(this.f20842n + 71, size, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), 1073741824));
            j5Var.measure(wh.y(this.f20842n + 71, size, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), 1073741824));
            int dp2 = (size - AndroidUtilities.dp(this.f20842n + 103)) - j5Var3.getTextWidth();
            if (LocaleController.isRTL) {
            ...
            int dp3 = (size - AndroidUtilities.dp(this.f20842n + 103)) - j5Var3.getTextWidth();
            if (LocaleController.isRTL) {
            ...
            int dp4 = size - AndroidUtilities.dp(this.f20842n);
            if (LocaleController.isRTL) {
            ...
            int dp5 = size - AndroidUtilities.dp(this.f20842n);
            if (LocaleController.isRTL) {
            ...
            j5Var3.measure(View.MeasureSpec.makeMeasureSpec(Math.max(0, (size - AndroidUtilities.dp(this.f20842n + 71)) - max), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), 1073741824));
            j5Var.measure(View.MeasureSpec.makeMeasureSpec((size - AndroidUtilities.dp(this.f20842n + 71)) - max, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), 1073741824));
        }
        lj0 lj0Var = this.e;
        if (lj0Var.getVisibility() == 0) {
        ...
        setMeasuredDimension(size, dp + (this.f20843r ? 1 : 0));
    }
    ...
    public final void s(CharSequence charSequence, CharSequence charSequence2, boolean z10, int i10, boolean z11) {
        ...
        if (charSequence2 != null) {
            ...
            this.M = charSequence2;
            p6Var.c(TextUtils.ellipsize(charSequence2, p6Var.getPaint(), (int) Math.max(1.0f, AndroidUtilities.displaySize.x - ((g10 + AndroidUtilities.dp(this.f20844s)) + AndroidUtilities.dp(16.0f))), TextUtils.TruncateAt.END), z10, true);
        } else {
            p6Var.c("", z10, true);
        }
        p6Var.setVisibility(0);
    ...
    public final void v() {
        ...
        if (i10 != org.telegram.ui.ActionBar.j6.f19169j5 && i10 != org.telegram.ui.ActionBar.j6.G6) {
            v02 = c(v02);
        }
        j5Var.setTextColor(v02);
        lj0 lj0Var = this.e;
        if (lj0Var.getTag() instanceof Integer) {
            ...
            int v03 = org.telegram.ui.ActionBar.j6.v0(intValue, e6Var);
            if (intValue != org.telegram.ui.ActionBar.j6.J5 && intValue != org.telegram.ui.ActionBar.j6.f19227m6) {
                v03 = c(v03);
            }
            lj0Var.setColorFilter(new PorterDuffColorFilter(v03, PorterDuff.Mode.SRC_IN));
        }
        this.f20839b.setTextColor(c(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19445y6, e6Var)));
        int i11 = org.telegram.ui.ActionBar.j6.I6;
        this.f20840c.setTextColor(c(org.telegram.ui.ActionBar.j6.v0(i11, e6Var)));
        this.d.setTextColor(c(org.telegram.ui.ActionBar.j6.v0(i11, e6Var)));
    }
    ...
    public r8(int i10, Context context, org.telegram.ui.ActionBar.e6 e6Var, boolean z10, boolean z11) {
        ...
        this.f20838a = j5Var;
        j5Var.setTextColor(org.telegram.ui.ActionBar.j6.v0(z10 ? org.telegram.ui.ActionBar.j6.f19169j5 : org.telegram.ui.ActionBar.j6.G6, e6Var));
        ...
        this.f20839b = j5Var2;
        j5Var2.setTextColor(org.telegram.ui.ActionBar.j6.v0(z10 ? org.telegram.ui.ActionBar.j6.p5 : org.telegram.ui.ActionBar.j6.f19445y6, e6Var));
        ...
        this.f20840c = p6Var;
        p6Var.setTextColor(org.telegram.ui.ActionBar.j6.v0(z10 ? org.telegram.ui.ActionBar.j6.f19246n5 : org.telegram.ui.ActionBar.j6.I6, e6Var));
        ...
        if (!j5Var3.P) {
            j5Var3.f18981n0 = true;
            j5Var3.f18983p0 = bool;
            j5Var3.m();
            j5Var3.b();
        }
        j5Var3.f18984q0 = 18;
        j5Var3.m();
        j5Var3.setTextColor(org.telegram.ui.ActionBar.j6.v0(z10 ? org.telegram.ui.ActionBar.j6.f19246n5 : org.telegram.ui.ActionBar.j6.I6, e6Var));
        ...
        imageView.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(z10 ? org.telegram.ui.ActionBar.j6.J5 : org.telegram.ui.ActionBar.j6.f19227m6, e6Var), PorterDuff.Mode.SRC_IN));
        addView(imageView);
        ...
        if (z11) {
            ...
            addView(this.f20841f, w7.y5.d(37, 20.0f, (LocaleController.isRTL ? 3 : 5) | 16, 22.0f, 0.0f, 22.0f, 0.0f));
        }
        setFocusable(true);
    }
