...
public class r8 extends FrameLayout {
    ...
    public boolean O;
    public int P;
    public final org.telegram.ui.ActionBar.k5 f20815a;
    public final org.telegram.ui.ActionBar.k5 f20816b;
    public final org.telegram.ui.Components.n6 f20817c;
    public final org.telegram.ui.ActionBar.k5 d;
    public final bj0 e;
    public Switch f20818f;
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        if (m5Var3 != null) {
            m5Var3.setBounds((getWidth() - this.K.f26060s) - AndroidUtilities.dp(18.0f), (getHeight() - this.K.f26060s) / 2, getWidth() - AndroidUtilities.dp(18.0f), (getHeight() + this.K.f26060s) / 2);
            this.K.draw(canvas);
        }
    }
    ...
    public final void e(int i10, int i11) {
        ...
        org.telegram.ui.ActionBar.k5 k5Var = this.f20815a;
    ...
    public final void g(boolean z10) {
        ...
        ViewPropertyAnimator animate = this.f20815a.animate();
        float f12 = 0.5f;
        if (z10) {
            f7 = 1.0f;
        } else {
        ...
        ViewPropertyAnimator animate2 = this.f20816b.animate();
        if (z10) {
            f10 = 1.0f;
        } else {
            f10 = 0.5f;
        ...
        ViewPropertyAnimator animate3 = this.f20817c.animate();
        if (z10) {
            f11 = 1.0f;
        } else {
            f11 = 0.5f;
    ...
    public final void i(CharSequence charSequence, boolean z10) {
        ...
        k5Var.i(null);
        this.M = null;
        org.telegram.ui.Components.n6 n6Var = this.f20817c;
    ...
    public final void j(CharSequence charSequence, boolean z10, boolean z11) {
        ...
        this.h.setVisibility(8);
        this.f20820r = z11;
        Switch r62 = this.f20818f;
        if (r62 != null) {
            r62.setVisibility(0);
            this.f20818f.c(z10, false);
        }
        setWillNotDraw(!this.f20820r);
        org.telegram.ui.Components.m5 m5Var = this.K;
        if (m5Var != null) {
            m5Var.g(null, false);
        }
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (this.f20818f != null) {
            ...
            accessibilityNodeInfo.setChecked(this.f20818f.h);
    ...
    public void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (LocaleController.isRTL) {
            measuredWidth = AndroidUtilities.dp(this.f20819n - 6);
        } else {
            measuredWidth = (i18 - n6Var.getMeasuredWidth()) - AndroidUtilities.dp(this.f20819n - 6);
        }
        if (this.f20824y && !LocaleController.isRTL) {
            measuredWidth = (i18 - n6Var.getMeasuredWidth()) - AndroidUtilities.dp(this.f20819n);
        }
        n6Var.layout(measuredWidth, max, n6Var.getMeasuredWidth() + measuredWidth, n6Var.getMeasuredHeight() + max);
        if (LocaleController.isRTL) {
            measuredWidth2 = AndroidUtilities.dp(this.f20819n - 6);
        } else {
            measuredWidth2 = (i18 - k5Var.getMeasuredWidth()) - AndroidUtilities.dp(this.f20819n - 6);
        }
        k5Var.layout(measuredWidth2, max, k5Var.getMeasuredWidth() + measuredWidth2, k5Var.getMeasuredHeight() + max);
        boolean z11 = LocaleController.isRTL;
        bj0 bj0Var = this.e;
        org.telegram.ui.ActionBar.k5 k5Var2 = this.f20815a;
        if (z11) {
        ...
        org.telegram.ui.ActionBar.k5 k5Var3 = this.f20816b;
        ...
        if (bj0Var.getVisibility() == 0) {
            ...
            if (!LocaleController.isRTL) {
                measuredWidth5 = AndroidUtilities.dp(this.f20822w);
            } else {
                measuredWidth5 = (i18 - bj0Var.getMeasuredWidth()) - AndroidUtilities.dp(this.f20822w);
            }
        ...
        Switch r92 = this.f20818f;
        if (r92 != null && r92.getVisibility() == 0) {
            int measuredHeight = (i17 - this.f20818f.getMeasuredHeight()) / 2;
            if (LocaleController.isRTL) {
                measuredWidth3 = AndroidUtilities.dp(22.0f);
            } else {
                measuredWidth3 = (i18 - this.f20818f.getMeasuredWidth()) - AndroidUtilities.dp(22.0f);
            }
            Switch r10 = this.f20818f;
            r10.layout(measuredWidth3, measuredHeight, r10.getMeasuredWidth() + measuredWidth3, this.f20818f.getMeasuredHeight() + measuredHeight);
        }
    }
    ...
    public void onMeasure(int i10, int i11) {
        ...
        this.L = size;
        boolean z10 = this.f20824y;
        org.telegram.ui.ActionBar.k5 k5Var = this.f20816b;
        org.telegram.ui.ActionBar.k5 k5Var2 = this.d;
        org.telegram.ui.ActionBar.k5 k5Var3 = this.f20815a;
        if (z10) {
            k5Var3.measure(wl.d(this.f20819n + 71, size, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), 1073741824));
            k5Var.measure(wl.d(this.f20819n + 71, size, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), 1073741824));
            int dp2 = (size - AndroidUtilities.dp(this.f20819n + 103)) - k5Var3.getTextWidth();
            if (LocaleController.isRTL) {
            ...
            int dp3 = (size - AndroidUtilities.dp(this.f20819n + 103)) - k5Var3.getTextWidth();
            if (LocaleController.isRTL) {
            ...
            int dp4 = size - AndroidUtilities.dp(this.f20819n);
            if (LocaleController.isRTL) {
            ...
            int dp5 = size - AndroidUtilities.dp(this.f20819n);
            if (LocaleController.isRTL) {
            ...
            k5Var3.measure(View.MeasureSpec.makeMeasureSpec(Math.max(0, (size - AndroidUtilities.dp(this.f20819n + 71)) - max), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), 1073741824));
            k5Var.measure(View.MeasureSpec.makeMeasureSpec((size - AndroidUtilities.dp(this.f20819n + 71)) - max, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), 1073741824));
        }
        bj0 bj0Var = this.e;
        if (bj0Var.getVisibility() == 0) {
        ...
        setMeasuredDimension(size, dp + (this.f20820r ? 1 : 0));
    }
    ...
    public final void s(CharSequence charSequence, CharSequence charSequence2, boolean z10, int i10, boolean z11) {
        ...
        if (charSequence2 != null) {
            ...
            this.M = charSequence2;
            n6Var.c(TextUtils.ellipsize(charSequence2, n6Var.getPaint(), (int) Math.max(1.0f, AndroidUtilities.displaySize.x - ((g10 + AndroidUtilities.dp(this.f20821s)) + AndroidUtilities.dp(16.0f))), TextUtils.TruncateAt.END), z10, true);
        } else {
            n6Var.c("", z10, true);
        }
        n6Var.setVisibility(0);
    ...
    public final void v() {
        ...
        if (i10 != org.telegram.ui.ActionBar.j6.f18970j5 && i10 != org.telegram.ui.ActionBar.j6.G6) {
            v02 = c(v02);
        }
        k5Var.setTextColor(v02);
        bj0 bj0Var = this.e;
        if (bj0Var.getTag() instanceof Integer) {
            ...
            if (intValue != org.telegram.ui.ActionBar.j6.J5 && intValue != org.telegram.ui.ActionBar.j6.f19028m6) {
                v03 = c(v03);
            }
            bj0Var.setColorFilter(new PorterDuffColorFilter(v03, PorterDuff.Mode.SRC_IN));
        }
        this.f20816b.setTextColor(c(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19245y6, f6Var)));
        int i11 = org.telegram.ui.ActionBar.j6.I6;
        this.f20817c.setTextColor(c(org.telegram.ui.ActionBar.j6.v0(i11, f6Var)));
    ...
    public r8(int i10, Context context, org.telegram.ui.ActionBar.f6 f6Var, boolean z10, boolean z11) {
        ...
        this.f20815a = k5Var;
        k5Var.setTextColor(org.telegram.ui.ActionBar.j6.v0(z10 ? org.telegram.ui.ActionBar.j6.f18970j5 : org.telegram.ui.ActionBar.j6.G6, f6Var));
        ...
        this.f20816b = k5Var2;
        k5Var2.setTextColor(org.telegram.ui.ActionBar.j6.v0(z10 ? org.telegram.ui.ActionBar.j6.p5 : org.telegram.ui.ActionBar.j6.f19245y6, f6Var));
        ...
        this.f20817c = n6Var;
        n6Var.setTextColor(org.telegram.ui.ActionBar.j6.v0(z10 ? org.telegram.ui.ActionBar.j6.f19047n5 : org.telegram.ui.ActionBar.j6.I6, f6Var));
        ...
        if (!k5Var3.P) {
            k5Var3.f19350n0 = true;
            k5Var3.f19352p0 = bool;
            k5Var3.m();
            k5Var3.b();
        }
        k5Var3.f19353q0 = 18;
        k5Var3.m();
        k5Var3.setTextColor(org.telegram.ui.ActionBar.j6.v0(z10 ? org.telegram.ui.ActionBar.j6.f19047n5 : org.telegram.ui.ActionBar.j6.I6, f6Var));
        ...
        imageView.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(z10 ? org.telegram.ui.ActionBar.j6.J5 : org.telegram.ui.ActionBar.j6.f19028m6, f6Var), PorterDuff.Mode.SRC_IN));
        addView(imageView);
        ...
        if (z11) {
            ...
            int i13 = org.telegram.ui.ActionBar.j6.f18863d6;
            r42.d(i11, i12, i13, i13);
            addView(this.f20818f, w7.x5.d(37, 20.0f, (LocaleController.isRTL ? 3 : 5) | 16, 22.0f, 0.0f, 22.0f, 0.0f));
        }
        setFocusable(true);
    }
