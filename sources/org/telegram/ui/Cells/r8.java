...
public class r8 extends FrameLayout {
    ...
    public boolean O;
    public int P;
    public final org.telegram.ui.ActionBar.h5 f20860a;
    public final org.telegram.ui.ActionBar.h5 f20861b;
    public final org.telegram.ui.Components.p6 f20862c;
    public final org.telegram.ui.ActionBar.h5 d;
    public final lj0 e;
    public Switch f20863f;
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        if (o5Var3 != null) {
            o5Var3.setBounds((getWidth() - this.K.f26919s) - AndroidUtilities.dp(18.0f), (getHeight() - this.K.f26919s) / 2, getWidth() - AndroidUtilities.dp(18.0f), (getHeight() + this.K.f26919s) / 2);
            this.K.draw(canvas);
        }
    }
    ...
    public final void e(int i10, int i11) {
        ...
        org.telegram.ui.ActionBar.h5 h5Var = this.f20860a;
    ...
    public final void g(boolean z10) {
        ...
        ViewPropertyAnimator animate = this.f20860a.animate();
        float f12 = 0.5f;
        if (z10) {
            f7 = 1.0f;
        } else {
        ...
        ViewPropertyAnimator animate2 = this.f20861b.animate();
        if (z10) {
            f10 = 1.0f;
        } else {
            f10 = 0.5f;
        ...
        ViewPropertyAnimator animate3 = this.f20862c.animate();
        if (z10) {
            f11 = 1.0f;
        } else {
            f11 = 0.5f;
    ...
    public final void i(CharSequence charSequence, boolean z10) {
        ...
        h5Var.i(null);
        this.M = null;
        org.telegram.ui.Components.p6 p6Var = this.f20862c;
    ...
    public final void j(CharSequence charSequence, boolean z10, boolean z11) {
        ...
        this.h.setVisibility(8);
        this.f20865r = z11;
        Switch r62 = this.f20863f;
        if (r62 != null) {
            r62.setVisibility(0);
            this.f20863f.c(z10, false);
        }
        setWillNotDraw(!this.f20865r);
        org.telegram.ui.Components.o5 o5Var = this.K;
        if (o5Var != null) {
            o5Var.g(null, false);
        }
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (this.f20863f != null) {
            ...
            accessibilityNodeInfo.setChecked(this.f20863f.h);
    ...
    public void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (LocaleController.isRTL) {
            measuredWidth = AndroidUtilities.dp(this.f20864n - 6);
        } else {
            measuredWidth = (i18 - p6Var.getMeasuredWidth()) - AndroidUtilities.dp(this.f20864n - 6);
        }
        if (this.f20869y && !LocaleController.isRTL) {
            measuredWidth = (i18 - p6Var.getMeasuredWidth()) - AndroidUtilities.dp(this.f20864n);
        }
        p6Var.layout(measuredWidth, max, p6Var.getMeasuredWidth() + measuredWidth, p6Var.getMeasuredHeight() + max);
        if (LocaleController.isRTL) {
            measuredWidth2 = AndroidUtilities.dp(this.f20864n - 6);
        } else {
            measuredWidth2 = (i18 - h5Var.getMeasuredWidth()) - AndroidUtilities.dp(this.f20864n - 6);
        }
        h5Var.layout(measuredWidth2, max, h5Var.getMeasuredWidth() + measuredWidth2, h5Var.getMeasuredHeight() + max);
        boolean z11 = LocaleController.isRTL;
        lj0 lj0Var = this.e;
        org.telegram.ui.ActionBar.h5 h5Var2 = this.f20860a;
        if (z11) {
        ...
        org.telegram.ui.ActionBar.h5 h5Var3 = this.f20861b;
        ...
        if (lj0Var.getVisibility() == 0) {
            ...
            if (!LocaleController.isRTL) {
                measuredWidth5 = AndroidUtilities.dp(this.f20867w);
            } else {
                measuredWidth5 = (i18 - lj0Var.getMeasuredWidth()) - AndroidUtilities.dp(this.f20867w);
            }
        ...
        Switch r92 = this.f20863f;
        if (r92 != null && r92.getVisibility() == 0) {
            int measuredHeight = (i17 - this.f20863f.getMeasuredHeight()) / 2;
            if (LocaleController.isRTL) {
                measuredWidth3 = AndroidUtilities.dp(22.0f);
            } else {
                measuredWidth3 = (i18 - this.f20863f.getMeasuredWidth()) - AndroidUtilities.dp(22.0f);
            }
            Switch r10 = this.f20863f;
            r10.layout(measuredWidth3, measuredHeight, r10.getMeasuredWidth() + measuredWidth3, this.f20863f.getMeasuredHeight() + measuredHeight);
        }
    }
    ...
    public void onMeasure(int i10, int i11) {
        ...
        this.L = size;
        boolean z10 = this.f20869y;
        org.telegram.ui.ActionBar.h5 h5Var = this.f20861b;
        org.telegram.ui.ActionBar.h5 h5Var2 = this.d;
        org.telegram.ui.ActionBar.h5 h5Var3 = this.f20860a;
        if (z10) {
            h5Var3.measure(ok.c(this.f20864n + 71, size, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), 1073741824));
            h5Var.measure(ok.c(this.f20864n + 71, size, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), 1073741824));
            int dp2 = (size - AndroidUtilities.dp(this.f20864n + 103)) - h5Var3.getTextWidth();
            if (LocaleController.isRTL) {
            ...
            int dp3 = (size - AndroidUtilities.dp(this.f20864n + 103)) - h5Var3.getTextWidth();
            if (LocaleController.isRTL) {
            ...
            int dp4 = size - AndroidUtilities.dp(this.f20864n);
            if (LocaleController.isRTL) {
            ...
            int dp5 = size - AndroidUtilities.dp(this.f20864n);
            if (LocaleController.isRTL) {
            ...
            h5Var3.measure(View.MeasureSpec.makeMeasureSpec(Math.max(0, (size - AndroidUtilities.dp(this.f20864n + 71)) - max), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), 1073741824));
            h5Var.measure(View.MeasureSpec.makeMeasureSpec((size - AndroidUtilities.dp(this.f20864n + 71)) - max, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), 1073741824));
        }
        lj0 lj0Var = this.e;
        if (lj0Var.getVisibility() == 0) {
        ...
        setMeasuredDimension(size, dp + (this.f20865r ? 1 : 0));
    }
    ...
    public final void s(CharSequence charSequence, CharSequence charSequence2, boolean z10, int i10, boolean z11) {
        ...
        if (charSequence2 != null) {
            ...
            this.M = charSequence2;
            p6Var.c(TextUtils.ellipsize(charSequence2, p6Var.getPaint(), (int) Math.max(1.0f, AndroidUtilities.displaySize.x - ((g10 + AndroidUtilities.dp(this.f20866s)) + AndroidUtilities.dp(16.0f))), TextUtils.TruncateAt.END), z10, true);
        } else {
            p6Var.c("", z10, true);
        }
        p6Var.setVisibility(0);
    ...
    public final void v() {
        ...
        if (i10 != org.telegram.ui.ActionBar.h6.f19151j5 && i10 != org.telegram.ui.ActionBar.h6.G6) {
            v02 = c(v02);
        }
        h5Var.setTextColor(v02);
        lj0 lj0Var = this.e;
        if (lj0Var.getTag() instanceof Integer) {
            ...
            if (intValue != org.telegram.ui.ActionBar.h6.J5 && intValue != org.telegram.ui.ActionBar.h6.f19209m6) {
                v03 = c(v03);
            }
            lj0Var.setColorFilter(new PorterDuffColorFilter(v03, PorterDuff.Mode.SRC_IN));
        }
        this.f20861b.setTextColor(c(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19428y6, d6Var)));
        int i11 = org.telegram.ui.ActionBar.h6.I6;
        this.f20862c.setTextColor(c(org.telegram.ui.ActionBar.h6.v0(i11, d6Var)));
    ...
    public r8(int i10, Context context, org.telegram.ui.ActionBar.d6 d6Var, boolean z10, boolean z11) {
        ...
        this.f20860a = h5Var;
        h5Var.setTextColor(org.telegram.ui.ActionBar.h6.v0(z10 ? org.telegram.ui.ActionBar.h6.f19151j5 : org.telegram.ui.ActionBar.h6.G6, d6Var));
        ...
        this.f20861b = h5Var2;
        h5Var2.setTextColor(org.telegram.ui.ActionBar.h6.v0(z10 ? org.telegram.ui.ActionBar.h6.p5 : org.telegram.ui.ActionBar.h6.f19428y6, d6Var));
        ...
        this.f20862c = p6Var;
        p6Var.setTextColor(org.telegram.ui.ActionBar.h6.v0(z10 ? org.telegram.ui.ActionBar.h6.f19228n5 : org.telegram.ui.ActionBar.h6.I6, d6Var));
        ...
        if (!h5Var3.P) {
            h5Var3.f18964n0 = true;
            h5Var3.f18966p0 = bool;
            h5Var3.m();
            h5Var3.b();
        }
        h5Var3.f18967q0 = 18;
        h5Var3.m();
        h5Var3.setTextColor(org.telegram.ui.ActionBar.h6.v0(z10 ? org.telegram.ui.ActionBar.h6.f19228n5 : org.telegram.ui.ActionBar.h6.I6, d6Var));
        ...
        imageView.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.h6.v0(z10 ? org.telegram.ui.ActionBar.h6.J5 : org.telegram.ui.ActionBar.h6.f19209m6, d6Var), PorterDuff.Mode.SRC_IN));
        addView(imageView);
        ...
        if (z11) {
            ...
            addView(this.f20863f, w7.y5.d(37, 20.0f, (LocaleController.isRTL ? 3 : 5) | 16, 22.0f, 0.0f, 22.0f, 0.0f));
        }
        setFocusable(true);
    }
