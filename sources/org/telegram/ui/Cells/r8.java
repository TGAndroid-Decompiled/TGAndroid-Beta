...
public class r8 extends FrameLayout {
    ...
    public boolean O;
    public int P;
    public final org.telegram.ui.ActionBar.j5 f20804a;
    public final org.telegram.ui.ActionBar.j5 f20805b;
    public final org.telegram.ui.Components.n6 f20806c;
    public final org.telegram.ui.ActionBar.j5 d;
    public final aj0 e;
    public Switch f20807f;
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        if (m5Var3 != null) {
            m5Var3.setBounds((getWidth() - this.K.f26076s) - AndroidUtilities.dp(18.0f), (getHeight() - this.K.f26076s) / 2, getWidth() - AndroidUtilities.dp(18.0f), (getHeight() + this.K.f26076s) / 2);
            this.K.draw(canvas);
        }
    }
    ...
    public final void e(int i10, int i11) {
        ...
        org.telegram.ui.ActionBar.j5 j5Var = this.f20804a;
    ...
    public final void g(boolean z10) {
        ...
        ViewPropertyAnimator animate = this.f20804a.animate();
        float f12 = 0.5f;
        if (z10) {
            f7 = 1.0f;
        } else {
        ...
        ViewPropertyAnimator animate2 = this.f20805b.animate();
        if (z10) {
            f10 = 1.0f;
        } else {
            f10 = 0.5f;
        ...
        ViewPropertyAnimator animate3 = this.f20806c.animate();
        if (z10) {
            f11 = 1.0f;
        } else {
            f11 = 0.5f;
    ...
    public final void i(CharSequence charSequence, boolean z10) {
        ...
        j5Var.i(null);
        this.M = null;
        org.telegram.ui.Components.n6 n6Var = this.f20806c;
    ...
    public final void j(CharSequence charSequence, boolean z10, boolean z11) {
        ...
        this.h.setVisibility(8);
        this.f20809r = z11;
        Switch r62 = this.f20807f;
        if (r62 != null) {
            r62.setVisibility(0);
            this.f20807f.c(z10, false);
        }
        setWillNotDraw(!this.f20809r);
        org.telegram.ui.Components.m5 m5Var = this.K;
        if (m5Var != null) {
            m5Var.g(null, false);
        }
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (this.f20807f != null) {
            ...
            accessibilityNodeInfo.setChecked(this.f20807f.h);
    ...
    public void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (LocaleController.isRTL) {
            measuredWidth = AndroidUtilities.dp(this.f20808n - 6);
        } else {
            measuredWidth = (i18 - n6Var.getMeasuredWidth()) - AndroidUtilities.dp(this.f20808n - 6);
        }
        if (this.f20813y && !LocaleController.isRTL) {
            measuredWidth = (i18 - n6Var.getMeasuredWidth()) - AndroidUtilities.dp(this.f20808n);
        }
        n6Var.layout(measuredWidth, max, n6Var.getMeasuredWidth() + measuredWidth, n6Var.getMeasuredHeight() + max);
        if (LocaleController.isRTL) {
            measuredWidth2 = AndroidUtilities.dp(this.f20808n - 6);
        } else {
            measuredWidth2 = (i18 - j5Var.getMeasuredWidth()) - AndroidUtilities.dp(this.f20808n - 6);
        }
        j5Var.layout(measuredWidth2, max, j5Var.getMeasuredWidth() + measuredWidth2, j5Var.getMeasuredHeight() + max);
        boolean z11 = LocaleController.isRTL;
        aj0 aj0Var = this.e;
        org.telegram.ui.ActionBar.j5 j5Var2 = this.f20804a;
        if (z11) {
        ...
        org.telegram.ui.ActionBar.j5 j5Var3 = this.f20805b;
        ...
        if (aj0Var.getVisibility() == 0) {
            ...
            if (!LocaleController.isRTL) {
                measuredWidth5 = AndroidUtilities.dp(this.f20811w);
            } else {
                measuredWidth5 = (i18 - aj0Var.getMeasuredWidth()) - AndroidUtilities.dp(this.f20811w);
            }
        ...
        Switch r92 = this.f20807f;
        if (r92 != null && r92.getVisibility() == 0) {
            int measuredHeight = (i17 - this.f20807f.getMeasuredHeight()) / 2;
            if (LocaleController.isRTL) {
                measuredWidth3 = AndroidUtilities.dp(22.0f);
            } else {
                measuredWidth3 = (i18 - this.f20807f.getMeasuredWidth()) - AndroidUtilities.dp(22.0f);
            }
            Switch r10 = this.f20807f;
            r10.layout(measuredWidth3, measuredHeight, r10.getMeasuredWidth() + measuredWidth3, this.f20807f.getMeasuredHeight() + measuredHeight);
        }
    }
    ...
    public void onMeasure(int i10, int i11) {
        ...
        this.L = size;
        boolean z10 = this.f20813y;
        org.telegram.ui.ActionBar.j5 j5Var = this.f20805b;
        org.telegram.ui.ActionBar.j5 j5Var2 = this.d;
        org.telegram.ui.ActionBar.j5 j5Var3 = this.f20804a;
        if (z10) {
            j5Var3.measure(wl.d(this.f20808n + 71, size, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), 1073741824));
            j5Var.measure(wl.d(this.f20808n + 71, size, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), 1073741824));
            int dp2 = (size - AndroidUtilities.dp(this.f20808n + 103)) - j5Var3.getTextWidth();
            if (LocaleController.isRTL) {
            ...
            int dp3 = (size - AndroidUtilities.dp(this.f20808n + 103)) - j5Var3.getTextWidth();
            if (LocaleController.isRTL) {
            ...
            int dp4 = size - AndroidUtilities.dp(this.f20808n);
            if (LocaleController.isRTL) {
            ...
            int dp5 = size - AndroidUtilities.dp(this.f20808n);
            if (LocaleController.isRTL) {
            ...
            j5Var3.measure(View.MeasureSpec.makeMeasureSpec(Math.max(0, (size - AndroidUtilities.dp(this.f20808n + 71)) - max), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), 1073741824));
            j5Var.measure(View.MeasureSpec.makeMeasureSpec((size - AndroidUtilities.dp(this.f20808n + 71)) - max, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), 1073741824));
        }
        aj0 aj0Var = this.e;
        if (aj0Var.getVisibility() == 0) {
        ...
        setMeasuredDimension(size, dp + (this.f20809r ? 1 : 0));
    }
    ...
    public final void s(CharSequence charSequence, CharSequence charSequence2, boolean z10, int i10, boolean z11) {
        ...
        if (charSequence2 != null) {
            ...
            this.M = charSequence2;
            n6Var.c(TextUtils.ellipsize(charSequence2, n6Var.getPaint(), (int) Math.max(1.0f, AndroidUtilities.displaySize.x - ((g10 + AndroidUtilities.dp(this.f20810s)) + AndroidUtilities.dp(16.0f))), TextUtils.TruncateAt.END), z10, true);
        } else {
            n6Var.c("", z10, true);
        }
        n6Var.setVisibility(0);
    ...
    public final void v() {
        ...
        if (i10 != org.telegram.ui.ActionBar.i6.f18943j5 && i10 != org.telegram.ui.ActionBar.i6.G6) {
            v02 = c(v02);
        }
        j5Var.setTextColor(v02);
        aj0 aj0Var = this.e;
        if (aj0Var.getTag() instanceof Integer) {
            ...
            if (intValue != org.telegram.ui.ActionBar.i6.J5 && intValue != org.telegram.ui.ActionBar.i6.f19001m6) {
                v03 = c(v03);
            }
            aj0Var.setColorFilter(new PorterDuffColorFilter(v03, PorterDuff.Mode.SRC_IN));
        }
        this.f20805b.setTextColor(c(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f19218y6, e6Var)));
        int i11 = org.telegram.ui.ActionBar.i6.I6;
        this.f20806c.setTextColor(c(org.telegram.ui.ActionBar.i6.v0(i11, e6Var)));
    ...
    public r8(int i10, Context context, org.telegram.ui.ActionBar.e6 e6Var, boolean z10, boolean z11) {
        ...
        this.f20804a = j5Var;
        j5Var.setTextColor(org.telegram.ui.ActionBar.i6.v0(z10 ? org.telegram.ui.ActionBar.i6.f18943j5 : org.telegram.ui.ActionBar.i6.G6, e6Var));
        ...
        this.f20805b = j5Var2;
        j5Var2.setTextColor(org.telegram.ui.ActionBar.i6.v0(z10 ? org.telegram.ui.ActionBar.i6.p5 : org.telegram.ui.ActionBar.i6.f19218y6, e6Var));
        ...
        this.f20806c = n6Var;
        n6Var.setTextColor(org.telegram.ui.ActionBar.i6.v0(z10 ? org.telegram.ui.ActionBar.i6.f19020n5 : org.telegram.ui.ActionBar.i6.I6, e6Var));
        ...
        if (!j5Var3.P) {
            j5Var3.f19269n0 = true;
            j5Var3.f19271p0 = bool;
            j5Var3.m();
            j5Var3.b();
        }
        j5Var3.f19272q0 = 18;
        j5Var3.m();
        j5Var3.setTextColor(org.telegram.ui.ActionBar.i6.v0(z10 ? org.telegram.ui.ActionBar.i6.f19020n5 : org.telegram.ui.ActionBar.i6.I6, e6Var));
        ...
        imageView.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.i6.v0(z10 ? org.telegram.ui.ActionBar.i6.J5 : org.telegram.ui.ActionBar.i6.f19001m6, e6Var), PorterDuff.Mode.SRC_IN));
        addView(imageView);
        ...
        if (z11) {
            ...
            addView(this.f20807f, w7.x5.d(37, 20.0f, (LocaleController.isRTL ? 3 : 5) | 16, 22.0f, 0.0f, 22.0f, 0.0f));
        }
        setFocusable(true);
    }
