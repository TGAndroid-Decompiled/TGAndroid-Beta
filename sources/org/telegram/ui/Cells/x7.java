...
public final class x7 extends FrameLayout {
    public final org.telegram.ui.ActionBar.f6 f22580a;
    public final org.telegram.ui.Components.k6 f22581b;
    public final org.telegram.ui.Components.k6 f22582c;
    public final org.telegram.ui.Components.k6 d;
    public final j0 e;
    public int f22583f;
    public int h;
    public Utilities.Callback f22584n;
    public w7 f22585r;
    public CharSequence f22586s;
    public float v;
    public float f22587w;
    public ValueAnimator f22588x;
    ...
    public final float b(int i10) {
        w7 w7Var;
        int i11;
        if (this.f22585r.f22548c != null) {
            int i12 = 1;
            while (true) {
                int[] iArr = this.f22585r.f22548c;
                if (i12 >= iArr.length) {
                    break;
                }
                int i13 = iArr[i12 - 1];
                int i14 = iArr[i12];
                if (i10 >= i13 && i10 <= i14) {
                    return (1.0f / (iArr.length - 1)) * ((Math.round(((i10 - i13) / (i14 - i13)) * w7Var.d) / this.f22585r.d) + i11);
                }
                i12++;
            }
        }
        return Utilities.clamp01((i10 - this.f22585r.b()) / (this.f22585r.a() - this.f22585r.b()));
    }
    ...
    public final void e(int i10, boolean z4) {
        int i11;
        float f10;
        w7 w7Var = this.f22585r;
        if (w7Var != null && w7Var.e != null) {
            org.telegram.ui.Components.k6 k6Var = this.f22581b;
            k6Var.a();
            org.telegram.ui.Components.k6 k6Var2 = this.d;
            k6Var2.a();
            org.telegram.ui.Components.k6 k6Var3 = this.f22582c;
            k6Var3.a();
            k6Var3.c((CharSequence) this.f22585r.e.run(0, Integer.valueOf(i10)), z4, true);
            k6Var.c((CharSequence) this.f22585r.e.run(-1, Integer.valueOf(this.f22585r.b())), z4, true);
            k6Var2.c((CharSequence) this.f22585r.e.run(1, Integer.valueOf(this.f22585r.a())), z4, true);
            if (i10 >= this.f22585r.a()) {
                i11 = org.telegram.ui.ActionBar.j6.I6;
            } else {
                i11 = org.telegram.ui.ActionBar.j6.f20281y6;
            }
            k6Var2.f26167c.s(org.telegram.ui.ActionBar.j6.v0(i11, this.f22580a), z4);
            k6Var2.invalidate();
            if (i10 >= this.f22585r.a()) {
                f10 = 1.0f;
            } else {
            ...
            if (Math.abs(this.f22587w - f10) >= 0.01f) {
                ValueAnimator valueAnimator = this.f22588x;
                ...
                if (z4) {
                    ...
                    this.f22588x = ofFloat;
                    ofFloat.addUpdateListener(new r(this, 6));
                    this.f22588x.addListener(new org.telegram.ui.ActionBar.a1(this, f10, 3));
                    this.f22588x.setDuration(240L);
                    this.f22588x.start();
                    return;
                }
