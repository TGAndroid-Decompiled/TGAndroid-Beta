...
public final class x5 extends FrameLayout {
    public v5[] f23532a;
    public MediaController.AlbumEntry[] f23533b;
    public int f23534c;
    public w5 d;
    public Paint f23535e;

    public final void a(int i10, MediaController.AlbumEntry albumEntry) {
        v5[] v5VarArr = this.f23532a;
        this.f23533b[i10] = albumEntry;
        if (albumEntry != null) {
            v5 v5Var = v5VarArr[i10];
            org.telegram.ui.Components.x9 x9Var = v5Var.f23371a;
            org.telegram.ui.Components.x9 x9Var2 = v5Var.f23371a;
            x9Var.q(0, true);
            ...
            v5Var.f23372b.setText(albumEntry.bucketName);
            v5Var.f23373c.setText(String.format("%d", Integer.valueOf(albumEntry.photos.size())));
            return;
        }
    ...
    public final void onMeasure(int i10, int i11) {
        int A;
        View[] viewArr = this.f23532a;
        if (AndroidUtilities.isTablet()) {
            A = vl.A(4.0f, this.f23534c - 1, AndroidUtilities.dp(490.0f) - AndroidUtilities.dp(12.0f)) / this.f23534c;
        } else {
            A = vl.A(4.0f, this.f23534c - 1, AndroidUtilities.displaySize.x - AndroidUtilities.dp(12.0f)) / this.f23534c;
        }
        for (int i12 = 0; i12 < this.f23534c; i12++) {
