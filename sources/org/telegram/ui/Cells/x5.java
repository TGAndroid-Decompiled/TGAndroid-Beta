...
public final class x5 extends FrameLayout {
    public v5[] f21635a;
    public MediaController.AlbumEntry[] f21636b;
    public int f21637c;
    public w5 d;
    public Paint e;

    public final void a(int i10, MediaController.AlbumEntry albumEntry) {
        v5[] v5VarArr = this.f21635a;
        this.f21636b[i10] = albumEntry;
        if (albumEntry != null) {
            v5 v5Var = v5VarArr[i10];
            org.telegram.ui.Components.u9 u9Var = v5Var.f21484a;
            org.telegram.ui.Components.u9 u9Var2 = v5Var.f21484a;
            u9Var.q(0, true);
            ...
            v5Var.f21485b.setText(albumEntry.bucketName);
            v5Var.f21486c.setText(String.format("%d", Integer.valueOf(albumEntry.photos.size())));
            return;
        }
    ...
    public final void onMeasure(int i10, int i11) {
        int A;
        View[] viewArr = this.f21635a;
        if (AndroidUtilities.isTablet()) {
            A = wl.A(4.0f, this.f21637c - 1, AndroidUtilities.dp(490.0f) - AndroidUtilities.dp(12.0f)) / this.f21637c;
        } else {
            A = wl.A(4.0f, this.f21637c - 1, AndroidUtilities.displaySize.x - AndroidUtilities.dp(12.0f)) / this.f21637c;
        }
        for (int i12 = 0; i12 < this.f21637c; i12++) {
