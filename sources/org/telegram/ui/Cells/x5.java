...
public final class x5 extends FrameLayout {
    public v5[] f23559a;
    public MediaController.AlbumEntry[] f23560b;
    public int f23561c;
    public w5 d;
    public Paint f23562e;

    public final void a(int i10, MediaController.AlbumEntry albumEntry) {
        v5[] v5VarArr = this.f23559a;
        this.f23560b[i10] = albumEntry;
        if (albumEntry != null) {
            v5 v5Var = v5VarArr[i10];
            org.telegram.ui.Components.x9 x9Var = v5Var.f23398a;
            org.telegram.ui.Components.x9 x9Var2 = v5Var.f23398a;
            x9Var.q(0, true);
            ...
            v5Var.f23399b.setText(albumEntry.bucketName);
            v5Var.f23400c.setText(String.format("%d", Integer.valueOf(albumEntry.photos.size())));
            return;
        }
    ...
    public final void onMeasure(int i10, int i11) {
        int A;
        View[] viewArr = this.f23559a;
        if (AndroidUtilities.isTablet()) {
            A = vl.A(4.0f, this.f23561c - 1, AndroidUtilities.dp(490.0f) - AndroidUtilities.dp(12.0f)) / this.f23561c;
        } else {
            A = vl.A(4.0f, this.f23561c - 1, AndroidUtilities.displaySize.x - AndroidUtilities.dp(12.0f)) / this.f23561c;
        }
        for (int i12 = 0; i12 < this.f23561c; i12++) {
        ...
        super.onMeasure(i10, vl.C(4.0f, A, 1073741824));
    }
