...
public final class b9 extends FrameLayout {
    public final TextView f20888a;
    public final TextView f20889b;
    ...
    public b9(Context context) {
        ...
        addView(textView, k7.b6.d(-2, -1.0f, i11 | 48, 21.0f, 0.0f, 21.0f, 0.0f));
    ...
    public final void a(String str, String str2, boolean z4) {
        TextView textView = this.f20888a;
        textView.setText(str);
        TextView textView2 = this.f20889b;
        if (str2 != null) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        TextView textView = this.f20889b;
        textView.measure(makeMeasureSpec, makeMeasureSpec2);
        this.f20888a.measure(View.MeasureSpec.makeMeasureSpec((measuredWidth - textView.getMeasuredWidth()) - AndroidUtilities.dp(8.0f), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(getMeasuredHeight(), 1073741824));
    }

    public void setTextColor(int i10) {
        this.f20888a.setTextColor(i10);
    }

    public void setTextValueColor(int i10) {
        this.f20889b.setTextColor(i10);
    }
}
