...
public class q extends ImageView {
    public Drawable f20580a;
    public final Path f20581b;
    public int f20582c;
    public int d;

    public q(Context context) {
        super(context);
        this.f20581b = new Path();
        this.f20582c = AndroidUtilities.dp(5.0f);
    ...
    public void draw(Canvas canvas) {
        canvas.save();
        canvas.clipPath(this.f20581b);
        canvas.scale((this.d / getWidth()) + 1.0f, (this.d / getHeight()) + 1.0f, getWidth() / 2.0f, getHeight() / 2.0f);
        super.draw(canvas);
        canvas.restore();
        Drawable drawable = this.f20580a;
        if (drawable != null) {
            int i10 = this.f20582c;
            drawable.setBounds(-i10, -i10, getWidth() + this.f20582c, getHeight() + this.f20582c);
            this.f20580a.draw(canvas);
        }
    }
    ...
    public void setForeground(int i10) {
        this.f20580a = getContext().getDrawable(i10);
        invalidate();
    }
