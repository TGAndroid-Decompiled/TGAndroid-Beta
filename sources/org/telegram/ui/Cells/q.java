...
public class q extends ImageView {
    public Drawable f21559a;
    public final Path f21560b;
    public int f21561c;
    public int d;

    public q(Context context) {
        super(context);
        this.f21560b = new Path();
        this.f21561c = AndroidUtilities.dp(5.0f);
    ...
    public void draw(Canvas canvas) {
        canvas.save();
        canvas.clipPath(this.f21560b);
        canvas.scale((this.d / getWidth()) + 1.0f, (this.d / getHeight()) + 1.0f, getWidth() / 2.0f, getHeight() / 2.0f);
        super.draw(canvas);
        canvas.restore();
        Drawable drawable = this.f21559a;
        if (drawable != null) {
            int i10 = this.f21561c;
            drawable.setBounds(-i10, -i10, getWidth() + this.f21561c, getHeight() + this.f21561c);
            this.f21559a.draw(canvas);
        }
    }
    ...
    public void setForeground(int i10) {
        this.f21559a = getContext().getDrawable(i10);
        invalidate();
    }
