...
public class q extends ImageView {
    public Drawable f20595a;
    public final Path f20596b;
    public int f20597c;
    public int d;

    public q(Context context) {
        super(context);
        this.f20596b = new Path();
        this.f20597c = AndroidUtilities.dp(5.0f);
    ...
    public void draw(Canvas canvas) {
        canvas.save();
        canvas.clipPath(this.f20596b);
        canvas.scale((this.d / getWidth()) + 1.0f, (this.d / getHeight()) + 1.0f, getWidth() / 2.0f, getHeight() / 2.0f);
        super.draw(canvas);
        canvas.restore();
        Drawable drawable = this.f20595a;
        if (drawable != null) {
            int i10 = this.f20597c;
            drawable.setBounds(-i10, -i10, getWidth() + this.f20597c, getHeight() + this.f20597c);
    ...
    public void setForeground(int i10) {
        this.f20595a = getContext().getDrawable(i10);
        invalidate();
    }
