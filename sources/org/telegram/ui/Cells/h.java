...
public final class h extends nf.e {
    ...
    public final ClickableSpan f20359f;
    public final float f20360g;
    public final j h;

    public h(j jVar, Layout layout, ClickableSpan clickableSpan, float f7) {
        this.h = jVar;
        this.e = layout;
        this.f20359f = clickableSpan;
        this.f20360g = f7;
    }
    ...
    public final void d() {
        ...
        r90 i10 = k90.i(this.e, this.f20359f, this.f20360g);
        this.d = i10;
        jVar.G = i10;
        ...
        this.d.f27921w.setStrokeWidth(AndroidUtilities.dpf2(1.25f));
