...
public final class h extends nf.e {
    ...
    public final ClickableSpan f20158f;
    public final float f20159g;
    public final j h;

    public h(j jVar, Layout layout, ClickableSpan clickableSpan, float f7) {
        this.h = jVar;
        this.e = layout;
        this.f20158f = clickableSpan;
        this.f20159g = f7;
    }
    ...
    public final void d() {
        ...
        g90 i10 = z80.i(this.e, this.f20158f, this.f20159g);
        this.d = i10;
        jVar.G = i10;
        ...
        this.d.f24279w.setStrokeWidth(AndroidUtilities.dpf2(1.25f));
