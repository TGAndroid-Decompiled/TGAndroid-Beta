...
public class NotificationsCheckCell extends FrameLayout {
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.drawLine) {
            int iDp2 = LocaleController.isRTL ? AndroidUtilities.dp(76.0f) : RichMessageLayout$$ExternalSyntheticOutline1.m(76.0f, getMeasuredWidth(), 1);
    ...
    public NotificationsCheckCell(Context context, int i, int i2, boolean z, Theme.ResourcesProvider resourcesProvider) {
        ...
        float fM = RichMessageLayout$MediaCell$$ExternalSyntheticOutline0.m(this.currentHeight, 70, 2, 13);
        if (z2) {
            f2 = z ? 64 : i;
        } else {
            f2 = 80.0f;
        }
        addView(textView2, LayoutHelper.createFrame(-1, -2.0f, i3, f, fM, f2, 0.0f));
        ...
        float fM2 = RichMessageLayout$MediaCell$$ExternalSyntheticOutline0.m(this.currentHeight, 70, 2, 29 - (z ? 2 : 0));
        if (z3) {
            f4 = z ? 64 : i;
        } else {
            f4 = 80.0f;
        }
        addView(animatedTextView3, LayoutHelper.createFrame(-1, -2.0f, i5, f3, fM2, f4, 0.0f));
        ...
        float fM3 = RichMessageLayout$MediaCell$$ExternalSyntheticOutline0.m(this.currentHeight, 70, 2, 38 - (z ? 2 : 0));
        if (z4) {
            f6 = z ? 64 : i;
        } else {
            f6 = 80.0f;
        }
        addView(textView4, LayoutHelper.createFrame(-2, -2.0f, i6, f5, fM3, f6, 0.0f));
        Switch r3 = new Switch(context, resourcesProvider) {
            @Override
            public final int processColor(int i7) {
    ...
    public void setTextAndValueAndIconAndCheck(CharSequence charSequence, CharSequence charSequence2, int i, boolean z, int i2, boolean z2, boolean z3, boolean z4) {
        ...
        if (imageView != null) {
            ...
            this.imageView.setColorFilter(new PorterDuffColorFilter(Theme.getColor(null, Theme.key_dialogIcon, false), PorterDuff.Mode.MULTIPLY));
        }
