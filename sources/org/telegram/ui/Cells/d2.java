...
public final class d2 extends FrameLayout implements DownloadController.FileDownloadProgressListener {
    ...
    public c2 V;
    public rc W;
    public final ImageReceiver f20900a;
    public boolean f20901a0;
    public boolean f20902b;
    public String f20903b0;
    public final n80 f20904c;
    public boolean f20905c0;
    public final int d;
    public float f20906d0;
    public Object e;
    public final b2 f20907e0;
    public final org.telegram.ui.ActionBar.f6 f20908f;
    public boolean h;
    ...
    public final void c(boolean z4, boolean z10) {
        ...
        if (z10) {
            ...
            animatorSet2.playTogether(ObjectAnimator.ofFloat(this, this.f20907e0, f10));
    ...
    public final void f(boolean z4, boolean z10) {
        ...
        String str = this.f20903b0;
        if (str == null && !this.f20901a0) {
            this.f20901a0 = true;
            ...
            if (this.H != null) {
                isLoadingHttpFile = FileLoader.getInstance(this.d).isLoadingFile(this.f20903b0);
            } else {
                isLoadingHttpFile = ImageLoader.getInstance().isLoadingHttpFile(this.f20903b0);
            }
            if (!isLoadingHttpFile && this.f20905c0) {
                ...
                DownloadController.getInstance(this.d).addLoadingFileObserver(this.f20903b0, this);
                int i11 = this.L;
                float f10 = 0.0f;
                if (i11 != 5 && i11 != 3) {
                    this.R = 1;
                    Float fileProgress = ImageLoader.getInstance().getFileProgress(this.f20903b0);
                    ...
                    this.R = 4;
                    Float fileProgress2 = ImageLoader.getInstance().getFileProgress(this.f20903b0);
    ...
    public final void onAttachedToWindow() {
        ...
        if (this.f20900a.onAttachedToWindow()) {
            f(false, false);
        }
        this.S.e();
    }
    ...
    public final void onDetachedFromWindow() {
        ...
        this.f20900a.onDetachedFromWindow();
        this.S.f();
        DownloadController.getInstance(this.d).removeLoadingFileObserver(this);
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float f10;
        float f11;
        ImageReceiver imageReceiver = this.f20900a;
        kp kpVar = this.U;
        if (kpVar != null && (kpVar.f26377a.f22938q || !imageReceiver.hasBitmapImage() || imageReceiver.getCurrentAlpha() != 1.0f || PhotoViewer.M1((MessageObject) this.e))) {
        ...
        org.telegram.ui.ActionBar.f6 f6Var = this.f20908f;
        ...
        if (this.f20914y != null) {
            org.telegram.ui.ActionBar.j6.f19932g3.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.J6, f6Var));
            canvas.save();
            if (!LocaleController.isRTL) {
                f12 = AndroidUtilities.leftBaseline;
            }
            canvas.translate(AndroidUtilities.dp(f12), this.f20913x);
            this.f20914y.draw(canvas);
            canvas.restore();
        }
        boolean z4 = this.M;
        RadialProgress2 radialProgress2 = this.S;
        if (!z4) {
            boolean z10 = this.f20902b;
            n80 n80Var = this.f20904c;
            ...
            if (i12 != 3 && i12 != 5) {
                ...
                if (botInlineResult2 != null && botInlineResult2.type.equals("file")) {
                    int intrinsicWidth = org.telegram.ui.ActionBar.j6.f20040m4.getIntrinsicWidth();
                    int intrinsicHeight = org.telegram.ui.ActionBar.j6.f20040m4.getIntrinsicHeight();
                    ...
                    canvas.drawRect(imageReceiver.getImageX(), imageReceiver.getImageY(), imageReceiver.getImageX() + AndroidUtilities.dp(52.0f), imageReceiver.getImageY() + AndroidUtilities.dp(52.0f), n80.f27220j);
                    org.telegram.ui.ActionBar.j6.f20040m4.setBounds(imageX, imageY, intrinsicWidth + imageX, intrinsicHeight + imageY);
                    org.telegram.ui.ActionBar.j6.f20040m4.draw(canvas);
                } else {
                    ...
                    if (botInlineResult3 != null && (botInlineResult3.type.equals("audio") || this.F.type.equals("voice"))) {
                        int intrinsicWidth2 = org.telegram.ui.ActionBar.j6.f20058n4.getIntrinsicWidth();
                        int intrinsicHeight2 = org.telegram.ui.ActionBar.j6.f20058n4.getIntrinsicHeight();
                        ...
                        canvas.drawRect(imageReceiver.getImageX(), imageReceiver.getImageY(), imageReceiver.getImageX() + AndroidUtilities.dp(52.0f), imageReceiver.getImageY() + AndroidUtilities.dp(52.0f), n80.f27220j);
                        org.telegram.ui.ActionBar.j6.f20058n4.setBounds(imageX2, imageY2, intrinsicWidth2 + imageX2, intrinsicHeight2 + imageY2);
                        org.telegram.ui.ActionBar.j6.f20058n4.draw(canvas);
                    } else {
                        ...
                        if (botInlineResult4 != null && (botInlineResult4.type.equals("venue") || this.F.type.equals("geo"))) {
                            int intrinsicWidth3 = org.telegram.ui.ActionBar.j6.f20076o4.getIntrinsicWidth();
                            int intrinsicHeight3 = org.telegram.ui.ActionBar.j6.f20076o4.getIntrinsicHeight();
                            ...
                            canvas.drawRect(imageReceiver.getImageX(), imageReceiver.getImageY(), imageReceiver.getImageX() + AndroidUtilities.dp(52.0f), imageReceiver.getImageY() + AndroidUtilities.dp(52.0f), n80.f27220j);
                            org.telegram.ui.ActionBar.j6.f20076o4.setBounds(imageX3, imageY3, intrinsicWidth3 + imageX3, intrinsicHeight3 + imageY3);
                            org.telegram.ui.ActionBar.j6.f20076o4.draw(canvas);
                        } else {
                            n80Var.draw(canvas);
                        }
                    }
                ...
                if (this.f20909n) {
                    i11 = org.telegram.ui.ActionBar.j6.f19994jd;
                } else {
                    i11 = org.telegram.ui.ActionBar.j6.f19977id;
                }
            ...
            if (botInlineResult5 != null) {
                ...
                if ((botInlineMessage instanceof TLRPC.TL_botInlineMessageMediaGeo) || (botInlineMessage instanceof TLRPC.TL_botInlineMessageMediaVenue)) {
                    int intrinsicWidth4 = org.telegram.ui.ActionBar.j6.f20076o4.getIntrinsicWidth();
                    int intrinsicHeight4 = org.telegram.ui.ActionBar.j6.f20076o4.getIntrinsicHeight();
                    ...
                    canvas.drawRect(imageReceiver.getImageX(), imageReceiver.getImageY(), imageReceiver.getImageX() + imageReceiver.getImageWidth(), imageReceiver.getImageY() + imageReceiver.getImageHeight(), n80.f27220j);
                    org.telegram.ui.ActionBar.j6.f20076o4.setBounds(x10, x11, intrinsicWidth4 + x10, intrinsicHeight4 + x11);
                    org.telegram.ui.ActionBar.j6.f20076o4.draw(canvas);
                }
            }
        }
        ...
        if (this.h && !this.M) {
            if (LocaleController.isRTL) {
                canvas.drawLine(0.0f, getMeasuredHeight() - 1, getMeasuredWidth() - AndroidUtilities.dp(AndroidUtilities.leftBaseline), getMeasuredHeight() - 1, org.telegram.ui.ActionBar.j6.f20000k0);
            } else {
                canvas.drawLine(AndroidUtilities.dp(AndroidUtilities.leftBaseline), getMeasuredHeight() - 1, getMeasuredWidth(), getMeasuredHeight() - 1, org.telegram.ui.ActionBar.j6.f20000k0);
            }
        }
        if (this.f20910r) {
            org.telegram.ui.ActionBar.j6.f20094p4.setBounds(0, 0, getMeasuredWidth(), AndroidUtilities.dp(3.0f));
            org.telegram.ui.ActionBar.j6.f20094p4.draw(canvas);
        }
    }
        ...
        if (!this.M && this.V != null && this.F != null) {
            ...
            if (i10 != 3 && i10 != 5) {
                ...
                if (botInlineResult != null && (webDocument = botInlineResult.content) != null && !TextUtils.isEmpty(webDocument.url)) {
                    ...
                    } else if (this.f20909n) {
                        if (motionEvent.getAction() == 1) {
                            this.f20909n = false;
                            playSoundEffect(0);
                            ((tf.j0) this.V).f44818a.S.f26637b.k(getResult());
                ...
                if (action == 0) {
                    ...
                    radialProgress2.n(this.f20909n, false);
                }
                z4 = false;
            }
            if (!z4) {
    ...
    public d2(Context context, org.telegram.ui.ActionBar.f6 f6Var, boolean z4) {
        ...
        if (z4) {
            ...
            kpVar.b(-1, i11, org.telegram.ui.ActionBar.j6.f20007k7);
