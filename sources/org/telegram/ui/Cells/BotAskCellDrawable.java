...
public final class BotAskCellDrawable extends Drawable {
    ...
    public BotAskCellDrawable(Context context, int i, Theme.ResourcesProvider resourcesProvider) {
        ...
        text.align();
        Text text2 = new Text("", 13.0f, null);
        this.text = text2;
        text2.maxLines = 4;
    ...
    public final void draw(Canvas canvas) {
        ...
        this.title.draw(fCenterX - (text.getWidth() / 2.0f), text.layout.getHeight() / 2.0f, 1.0f, -1, canvas);
        canvas.translate(0.0f, text.layout.getHeight());
        canvas.translate(0.0f, AndroidUtilities.dp(4.0f));
        float fCenterX2 = rectF.centerX();
        Text text2 = this.text;
        this.text.draw(fCenterX2 - (text2.getWidth() / 2.0f), 0.0f, 1.0f, -1, canvas);
        canvas.translate(0.0f, text2.layout.getHeight());
