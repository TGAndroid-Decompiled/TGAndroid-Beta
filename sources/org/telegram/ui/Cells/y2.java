...
public final class y2 implements View.OnClickListener {
    ...
    public final void onClick(View view) {
        switch (this.f23561a) {
            case 0:
                View.OnClickListener onClickListener = (View.OnClickListener) this.f23563c;
                if (((z2) this.f23562b).getAlpha() > 0.5f && onClickListener != null) {
                    onClickListener.onClick(view);
                    return;
                }
                return;
            default:
                di.d dVar = (di.d) this.f23562b;
                org.telegram.ui.ActionBar.f3 f3Var = (org.telegram.ui.ActionBar.f3) this.f23563c;
                if (dVar.F > 0) {
