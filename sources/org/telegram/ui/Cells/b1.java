    ...
    public final void run() {
        switch (this.f19822a) {
            ...
            case 2:
                ...
                return;
            case 3:
                t1 t1Var2 = this.f19823b;
                pb.c cVar = t1Var2.f21285w;
                cVar.a(t1Var2.Qd);
                cVar.a(t1Var2.Rd);
                t1Var2.H3();
                MessageObject messageObject = t1Var2.f21322y7;
                ...
                return;
            case 4:
                t1 t1Var3 = this.f19823b;
                if (t1Var3.Q9 && !t1Var3.R9 && t1Var3.S9) {
                    t1Var3.R9 = true;
                    t1Var3.f21342zc.setState(new int[]{16842919, 16842910});
                    return;
                }
                return;
            case 5:
                t1 t1Var4 = this.f19823b;
                t1Var4.f21342zc.setState(new int[0]);
                t1Var4.invalidate();
                return;
            case 6:
                t1 t1Var5 = this.f19823b;
                t1Var5.f21342zc.setState(new int[0]);
                t1Var5.invalidate();
                return;
            case 7:
                t1 t1Var6 = this.f19823b;
                int i10 = 0;
                t1Var6.f21308x7 = false;
                t1Var6.getMessageObject().isSpoilersRevealed = true;
                MessageObject.TextLayoutBlocks textLayoutBlocks = t1Var6.f21074h4;
                ...
                MessageObject.TextLayoutBlocks textLayoutBlocks2 = t1Var6.f21004c4;
                if (textLayoutBlocks2 != null) {
                    ...
                    ArrayList<MessageObject.TextLayoutBlock> arrayList3 = t1Var6.f21322y7.textLayoutBlocks;
                    if (arrayList3 != null) {
