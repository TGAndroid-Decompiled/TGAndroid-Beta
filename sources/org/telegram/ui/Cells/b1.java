    ...
    public final void run() {
        switch (this.f19832a) {
            ...
            case 2:
                ...
                return;
            case 3:
                t1 t1Var2 = this.f19833b;
                pb.c cVar = t1Var2.f21295w;
                cVar.a(t1Var2.Qd);
                cVar.a(t1Var2.Rd);
                t1Var2.H3();
                MessageObject messageObject = t1Var2.f21332y7;
                ...
                return;
            case 4:
                t1 t1Var3 = this.f19833b;
                if (t1Var3.Q9 && !t1Var3.R9 && t1Var3.S9) {
                    t1Var3.R9 = true;
                    t1Var3.f21352zc.setState(new int[]{16842919, 16842910});
                    return;
                }
                return;
            case 5:
                t1 t1Var4 = this.f19833b;
                t1Var4.f21352zc.setState(new int[0]);
                t1Var4.invalidate();
                return;
            case 6:
                t1 t1Var5 = this.f19833b;
                t1Var5.f21352zc.setState(new int[0]);
                t1Var5.invalidate();
                return;
            case 7:
                t1 t1Var6 = this.f19833b;
                int i10 = 0;
                t1Var6.f21318x7 = false;
                t1Var6.getMessageObject().isSpoilersRevealed = true;
                MessageObject.TextLayoutBlocks textLayoutBlocks = t1Var6.f21084h4;
                ...
                MessageObject.TextLayoutBlocks textLayoutBlocks2 = t1Var6.f21014c4;
                if (textLayoutBlocks2 != null) {
                    ...
                    ArrayList<MessageObject.TextLayoutBlock> arrayList3 = t1Var6.f21332y7.textLayoutBlocks;
                    if (arrayList3 != null) {
