    ...
    public final void run() {
        switch (this.f20042a) {
            ...
            case 2:
                ...
                return;
            case 3:
                u1 u1Var2 = this.f20043b;
                l.d dVar = u1Var2.f21570w;
                dVar.H(u1Var2.Qd);
                dVar.H(u1Var2.Rd);
                u1Var2.H3();
                MessageObject messageObject = u1Var2.f21607y7;
                if (messageObject != null) {
                    messageObject.generateLayout(null);
                    MessageObject messageObject2 = u1Var2.f21607y7;
                ...
                return;
            case 4:
                u1 u1Var3 = this.f20043b;
                if (u1Var3.Q9 && !u1Var3.R9 && u1Var3.S9) {
                    u1Var3.R9 = true;
                    u1Var3.f21627zc.setState(new int[]{16842919, 16842910});
                    return;
                }
                return;
            case 5:
                u1 u1Var4 = this.f20043b;
                u1Var4.f21627zc.setState(new int[0]);
                u1Var4.invalidate();
                return;
            case 6:
                u1 u1Var5 = this.f20043b;
                u1Var5.f21627zc.setState(new int[0]);
                u1Var5.invalidate();
                return;
            case 7:
                u1 u1Var6 = this.f20043b;
                int i10 = 0;
                u1Var6.f21593x7 = false;
                u1Var6.getMessageObject().isSpoilersRevealed = true;
                MessageObject.TextLayoutBlocks textLayoutBlocks = u1Var6.f21359h4;
                ...
                MessageObject.TextLayoutBlocks textLayoutBlocks2 = u1Var6.f21290c4;
                if (textLayoutBlocks2 != null) {
                    ...
                    ArrayList<MessageObject.TextLayoutBlock> arrayList3 = u1Var6.f21607y7.textLayoutBlocks;
                    if (arrayList3 != null) {
