    ...
    public final void run() {
        switch (this.f21661a) {
            ...
            case 2:
                ...
                return;
            case 3:
                t1 t1Var2 = this.f21662b;
                k2.g0 g0Var = t1Var2.f23196w;
                g0Var.j(t1Var2.Qd);
                g0Var.j(t1Var2.Rd);
                t1Var2.H3();
                MessageObject messageObject = t1Var2.f23233y7;
                ...
                return;
            case 4:
                t1 t1Var3 = this.f21662b;
                if (t1Var3.Q9 && !t1Var3.R9 && t1Var3.S9) {
                    t1Var3.R9 = true;
                    t1Var3.f23253zc.setState(new int[]{16842919, 16842910});
                    return;
                }
                return;
            case 5:
                t1 t1Var4 = this.f21662b;
                t1Var4.f23253zc.setState(new int[0]);
                t1Var4.invalidate();
                return;
            case 6:
                t1 t1Var5 = this.f21662b;
                t1Var5.f23253zc.setState(new int[0]);
                t1Var5.invalidate();
                return;
            case 7:
                t1 t1Var6 = this.f21662b;
                int i10 = 0;
                t1Var6.f23219x7 = false;
                t1Var6.getMessageObject().isSpoilersRevealed = true;
                MessageObject.TextLayoutBlocks textLayoutBlocks = t1Var6.f22985h4;
                ...
                MessageObject.TextLayoutBlocks textLayoutBlocks2 = t1Var6.f22916c4;
                if (textLayoutBlocks2 != null) {
                    ...
                    ArrayList<MessageObject.TextLayoutBlock> arrayList3 = t1Var6.f23233y7.textLayoutBlocks;
                    if (arrayList3 != null) {
