...
public class f8 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate, pg.c {
    ...
    public final e8 f21941a;
    public final sg.e1 f21942b;
    public TLRPC.Document f21943c;
    public SendMessagesHelper.ImportingSticker d;
    public Object f21944e;
    public String f21945f;
    public final TextView h;
    public float f21946n;
    ...
    public f8(Context context, org.telegram.ui.ActionBar.f6 f6Var, boolean z10) {
        ...
        imageView.setBackground(org.telegram.ui.ActionBar.j6.b0(AndroidUtilities.dp(12.0f), org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20897q5, f6Var)));
    ...
    public final void a(boolean z10) {
        ...
        if (z10) {
            imageView.animate().alpha(0.0f).scaleX(0.4f).scaleY(0.4f).setDuration(200L).setInterpolator(pr.f29466f).start();
        } else {
            imageView.setAlpha(0.0f);
        }
    }
    ...
    public final void b(Canvas canvas, View view) {
        boolean z10;
        boolean z11 = this.f21947r;
        float f7 = this.H;
        e8 e8Var = this.f21941a;
        if (z11 || (((z10 = this.v) && this.f21949w != 0.8f) || (!z10 && this.f21949w != 1.0f))) {
            long currentTimeMillis = System.currentTimeMillis();
            long j3 = currentTimeMillis - this.f21948s;
            this.f21948s = currentTimeMillis;
            if (this.f21947r) {
                long j10 = this.f21950x + j3;
                this.f21950x = j10;
                if (j10 > 1050) {
                    this.f21950x = 1050L;
                }
                float interpolation = (N.getInterpolation(((float) this.f21950x) / 150.0f) * 0.5f) + 0.5f;
                this.f21946n = interpolation;
                if (interpolation >= 1.0f) {
                    this.f21947r = false;
                    this.f21946n = 1.0f;
                }
                e8Var.setAlpha(this.f21946n * f7);
            } else {
                if (this.v) {
                    float f10 = this.f21949w;
                    if (f10 != 0.8f) {
                ...
                float f12 = (((float) j3) / 400.0f) + this.f21949w;
                this.f21949w = f12;
                if (f12 > 1.0f) {
                    this.f21949w = 1.0f;
                }
        ...
        e8Var.setAlpha(this.f21946n * f7);
        if (this.f21949w != 1.0f) {
            canvas.save();
            float f15 = this.f21949w;
    ...
    public final void c(boolean z10) {
        ...
        if (z10) {
            ...
            imageView.animate().alpha(1.0f).scaleX(1.0f).scaleY(1.0f).setDuration(200L).setInterpolator(pr.f29466f).start();
            return;
        }
    ...
    public final void d(TLRPC.Document document, SendMessagesHelper.ImportingSticker importingSticker, Object obj, String str, boolean z10, boolean z11) {
        ...
        this.K = 0;
        this.J.setBackground(org.telegram.ui.ActionBar.j6.b0(AndroidUtilities.dp(12.0f), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20897q5, false)));
        if (z11) {
            c(false);
        } else {
            a(false);
        ...
        if (importingSticker != null) {
            ...
            if (importingSticker.validated) {
                ...
                SvgHelper.SvgDrawable svgRectThumb = DocumentObject.getSvgRectThumb(org.telegram.ui.ActionBar.j6.f20752i5, 1.0f);
                ...
                textView = textView2;
                i11 = 4;
                SvgHelper.SvgDrawable svgRectThumb2 = DocumentObject.getSvgRectThumb(org.telegram.ui.ActionBar.j6.f20752i5, 1.0f);
                if (importingSticker.animated) {
                    str3 = "tgs";
                } else {
                    str3 = null;
            ...
            z12 = true;
            if (document != null) {
                this.f21943c = document;
                this.f21944e = obj;
                TLRPC.PhotoSize closestPhotoSizeWithSize = FileLoader.getClosestPhotoSizeWithSize(document.thumbs, 90);
                boolean z13 = this.F;
                if (z13) {
                    i10 = org.telegram.ui.ActionBar.j6.f20646c7;
                } else {
                ...
                if (MessageObject.canAutoplayAnimatedSticker(document)) {
                    ...
                    if (svgThumb != null) {
                        e8Var.setImage(ImageLocation.getForDocument(document), str5, ImageLocation.getForDocument(closestPhotoSizeWithSize, document), null, null, null, svgThumb, 0L, null, this.f21944e, 1);
                    } else if (closestPhotoSizeWithSize != null) {
                        e8Var.setImage(ImageLocation.getForDocument(document), str5, ImageLocation.getForDocument(closestPhotoSizeWithSize, document), (String) null, (String) null, this.f21944e, 1);
                    } else {
                        e8Var.setImage(ImageLocation.getForDocument(document), str5, null, null, this.f21944e, 1);
                    }
                } else if (svgThumb != null) {
                    if (closestPhotoSizeWithSize != null) {
                        e8Var.setImage(ImageLocation.getForDocument(closestPhotoSizeWithSize, document), str5, svgThumb, "webp", this.f21944e, 1);
                    } else {
                        e8Var.setImage(ImageLocation.getForDocument(document), str5, svgThumb, "webp", this.f21944e, 1);
                    }
                } else if (closestPhotoSizeWithSize != null) {
                    e8Var.setImage(ImageLocation.getForDocument(closestPhotoSizeWithSize, document), str5, null, "webp", this.f21944e, 1);
                } else {
                    e8Var.setImage(ImageLocation.getForDocument(document), str5, null, "webp", this.f21944e, 1);
                }
                if (str != null) {
                    ...
                    textView2.setText(Emoji.replaceEmoji(MediaDataController.getInstance(this.E).getEmojiForSticker(this.f21943c.f19875id), textView2.getPaint().getFontMetricsInt(), false));
                    textView2.setVisibility(0);
                } else {
        ...
        e(false);
        e8Var.setAlpha(this.f21946n * this.H);
        if (this.L) {
    ...
    public final void onDetachedFromWindow() {
        ...
        this.f21941a.onDetachedFromWindow();
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (this.f21943c != null) {
            int i10 = 0;
            while (true) {
                if (i10 >= this.f21943c.attributes.size()) {
                    break;
                }
                TLRPC.DocumentAttribute documentAttribute = this.f21943c.attributes.get(i10);
                if (documentAttribute instanceof TLRPC.TL_documentAttributeSticker) {
    ...
    public void setScaled(boolean z10) {
        this.v = z10;
        this.f21948s = System.currentTimeMillis();
        invalidate();
    }
