...
public final class f2 extends FrameLayout {
    public final org.telegram.ui.ActionBar.l5 f22791a;
    ...
    public final void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        if (this.f22793c) {
            canvas.drawLine(AndroidUtilities.dp(this.d), getMeasuredHeight() - 1, AndroidUtilities.dp(23.0f) + getMeasuredWidth(), getMeasuredHeight(), org.telegram.ui.ActionBar.k6.f21781k0);
        }
    }
    ...
    public final void onLayout(boolean z4, int i10, int i11, int i12, int i13) {
        ...
        float f11;
        int i14 = i12 - i10;
        org.telegram.ui.ActionBar.l5 l5Var = this.f22791a;
        int textHeight = ((i13 - i11) - l5Var.getTextHeight()) / 2;
        boolean z10 = LocaleController.isRTL;
        ImageView imageView = this.f22792b;
        if (z10) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f22791a.measure(org.telegram.ui.b.d(94.0f, size, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), 1073741824));
        this.f22792b.measure(View.MeasureSpec.makeMeasureSpec(size, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(50.0f), 1073741824));
