...
public final class f2 extends FrameLayout {
    public final org.telegram.ui.ActionBar.k5 f20071a;
    public final ImageView f20072b;
    ...
    public final void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        if (this.f20073c) {
            canvas.drawLine(AndroidUtilities.dp(this.d), getMeasuredHeight() - 1, AndroidUtilities.dp(23.0f) + getMeasuredWidth(), getMeasuredHeight(), org.telegram.ui.ActionBar.j6.f18985k0);
        }
    }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        float f10;
        int i14 = i12 - i10;
        org.telegram.ui.ActionBar.k5 k5Var = this.f20071a;
        int textHeight = ((i13 - i11) - k5Var.getTextHeight()) / 2;
        boolean z11 = LocaleController.isRTL;
        ImageView imageView = this.f20072b;
        if (z11) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f20071a.measure(wl.d(94.0f, size, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), 1073741824));
        this.f20072b.measure(View.MeasureSpec.makeMeasureSpec(size, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(50.0f), 1073741824));
