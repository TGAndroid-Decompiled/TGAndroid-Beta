...
public final class r implements ValueAnimator.AnimatorUpdateListener {
    ...
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        ...
        switch (this.f20631a) {
            case 0:
                s sVar = (s) this.f20632b;
                sVar.getClass();
                sVar.a(((Float) valueAnimator.getAnimatedValue()).floatValue());
                return;
            case 1:
                e0 e0Var = (e0) this.f20632b;
                e0Var.getClass();
                e0Var.f19981w = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                e0Var.f19963a.run();
                return;
            case 2:
                t1 t1Var = (t1) this.f20632b;
                t1Var.getClass();
                t1Var.Bb = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                t1Var.invalidate();
                return;
            case 3:
                g4 g4Var = (g4) this.f20632b;
                ...
                return;
            case 4:
                o6 o6Var = (o6) this.f20632b;
                o6Var.getClass();
                o6Var.E = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                o6Var.invalidate();
                return;
            case 5:
                t7 t7Var = (t7) this.f20632b;
                t7Var.getClass();
                t7Var.f21369i0 = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                t7Var.invalidate();
                return;
            case 6:
                z7 z7Var = (z7) this.f20632b;
                z7Var.getClass();
                ...
                return;
            case 7:
                da daVar = (da) this.f20632b;
                daVar.getClass();
                daVar.V = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                daVar.C.invalidate();
                return;
            default:
                ga gaVar = (ga) ((fa) this.f20632b).f20094b;
                gaVar.f20145a.getTransitionParams().K1 = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                gaVar.f20145a.invalidate();
                return;
        }
    }
}
