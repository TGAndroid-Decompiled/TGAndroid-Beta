...
public final class r implements ValueAnimator.AnimatorUpdateListener {
    ...
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        ...
        switch (this.f20878a) {
            case 0:
                s sVar = (s) this.f20879b;
                sVar.getClass();
                sVar.a(((Float) valueAnimator.getAnimatedValue()).floatValue());
                return;
            case 1:
                e0 e0Var = (e0) this.f20879b;
                e0Var.getClass();
                e0Var.f20188w = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                e0Var.f20170a.run();
                return;
            case 2:
                u1 u1Var = (u1) this.f20879b;
                u1Var.getClass();
                u1Var.Bb = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                u1Var.invalidate();
                return;
            case 3:
                h4 h4Var = (h4) this.f20879b;
                ...
                return;
            case 4:
                p6 p6Var = (p6) this.f20879b;
                p6Var.getClass();
                p6Var.E = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                p6Var.invalidate();
                return;
            case 5:
                u7 u7Var = (u7) this.f20879b;
                u7Var.getClass();
                u7Var.f21646i0 = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                u7Var.invalidate();
                return;
            case 6:
                a8 a8Var = (a8) this.f20879b;
                a8Var.getClass();
                ...
                return;
            case 7:
                ea eaVar = (ea) this.f20879b;
                eaVar.getClass();
                eaVar.V = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                eaVar.C.invalidate();
                return;
            default:
                ha haVar = (ha) ((ga) this.f20879b).f20368b;
                haVar.f20430a.getTransitionParams().K1 = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                haVar.f20430a.invalidate();
                return;
        }
    }
}
