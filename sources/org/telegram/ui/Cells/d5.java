...
public abstract class d5 extends FrameLayout {
    ...
    public final void a(ArrayList arrayList, boolean z4) {
        ...
        float f12;
        float f13;
        TextView textView = this.f20940b;
        j0 j0Var = this.f20941c;
        TextView textView2 = this.f20939a;
        super.setEnabled(z4);
        float f14 = 0.5f;
        if (arrayList != null) {
            if (z4) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f20939a.measure(View.MeasureSpec.makeMeasureSpec(kh.a2.c(8.0f, measuredWidth - textView.getMeasuredWidth(), AndroidUtilities.dp(10.0f)), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(30.0f), 1073741824));
        this.f20941c.measure(org.telegram.ui.b.d(20.0f, getMeasuredWidth(), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(30.0f), 1073741824));
    }
    ...
    public void setSize(long j10) {
        ...
        float f11;
        this.d = j10;
        this.f20940b.setText(LocaleController.formatString("AutodownloadSizeLimitUpTo", R.string.AutodownloadSizeLimitUpTo, AndroidUtilities.formatFileSize(j10)));
        long j11 = j10 - 512000;
        if (j11 < 536576) {
        ...
        this.f20941c.setProgress(Math.min(1.0f, f11));
    }
