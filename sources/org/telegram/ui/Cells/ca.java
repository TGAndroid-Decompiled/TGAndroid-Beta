...
public final class ca extends View {
    public final Paint f19871a;
    public float f19872b;
    public float f19873c;
    public long d;
    public final Path e;
    public final ArrayList f19874f;
    public float h;
    public float f19875n;
    public final da f19876r;
    ...
    public final void a(RectF rectF) {
        ...
        this.f19874f.add(new Rect((int) Math.floor(rectF.left), (int) Math.floor(rectF.top), (int) Math.ceil(rectF.right), (int) Math.ceil(rectF.bottom)));
    }

    public final boolean b(MotionEvent motionEvent) {
        da daVar = this.f19876r;
        if (daVar.y() && !daVar.f19931i) {
            int action = motionEvent.getAction();
            if (action != 0) {
                if (action == 1 && System.currentTimeMillis() - this.d < 200 && v7.z6.b((int) this.f19872b, (int) this.f19873c, (int) motionEvent.getX(), (int) motionEvent.getY()) < daVar.f19939m) {
                ...
                this.f19872b = motionEvent.getX();
                this.f19873c = motionEvent.getY();
    ...
    public final void c() {
        if (Build.VERSION.SDK_INT >= 29) {
            ArrayList arrayList = this.f19874f;
    ...
    public final void invalidate() {
        ...
        super.invalidate();
        da daVar = this.f19876r;
        if (daVar.f19934j0 && (viewGroup = daVar.F) != null) {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        int i12;
        da daVar = this.f19876r;
        g gVar2 = daVar.f19949r0;
        OvershootInterpolator overshootInterpolator = daVar.f19923c0;
        RectF rectF = daVar.S;
        RectF rectF2 = daVar.T;
        t9 t9Var = daVar.f19919a0;
        if (daVar.y()) {
            int dp = AndroidUtilities.dp(22.0f);
            int i13 = daVar.f19956x;
            daVar.O();
            y9 y9Var = daVar.W;
            Paint paint = this.f19871a;
            Path path = this.e;
            if (y9Var != null) {
                canvas.save();
                int[] m10 = daVar.m();
                c10 = 1;
                float f11 = m10[1] + daVar.f19920b;
                f7 = 8.0f;
                float f12 = m10[0] + daVar.f19918a;
                ...
                if (messageObject != null && messageObject.isOutOwner()) {
                    ...
                    paint.setColor(daVar.u(org.telegram.ui.ActionBar.i6.f19171vf));
                }
                ...
                if (i14 >= 0 && i14 <= length) {
                    ...
                    if (layout != null) {
                        ...
                        int lineBottom = (int) (layout.getLineBottom(lineForOffset) + t9Var.f21395c);
                        float f13 = primaryHorizontal + t9Var.d;
                        Rect rect = t9Var.e;
                        if (rect != null) {
                            float f14 = rect.right - daVar.f19918a;
                            i12 = rect.bottom - daVar.f19920b;
                            f10 = f14;
                            z10 = false;
                        } else {
                        ...
                        float f16 = f11 + f15;
                        i10 = i13;
                        if (f16 > i10 + daVar.f19925e0 && f16 < daVar.F.getMeasuredHeight()) {
                            if (!z10) {
                                canvas.save();
            ...
            if (daVar.W != null) {
                canvas.save();
                int[] m11 = daVar.m();
                float f23 = m11[c10] + daVar.f19920b;
                float f24 = m11[0] + daVar.f19918a;
                canvas.translate(f24, f23);
                int length3 = daVar.t(daVar.W, false).length();
                int i16 = daVar.f19954u;
                if (i16 >= 0 && i16 <= length3) {
                    daVar.j(i16, t9Var, false);
                    Layout layout2 = t9Var.f21394b;
                    if (layout2 != null) {
                        int i17 = daVar.f19954u - t9Var.f21393a;
                        int lineForOffset2 = layout2.getLineForOffset(i17);
                        float primaryHorizontal2 = layout2.getPrimaryHorizontal(i17);
                        int lineBottom2 = (int) (layout2.getLineBottom(lineForOffset2) + t9Var.f21395c);
                        float f25 = primaryHorizontal2 + t9Var.d;
                        Rect rect2 = t9Var.e;
                        if (rect2 != null) {
                            f25 = rect2.left - daVar.f19918a;
                            lineBottom2 = rect2.bottom - daVar.f19920b;
                            isRtlCharAt = false;
                        } else {
                            isRtlCharAt = layout2.isRtlCharAt(daVar.f19954u);
                        }
                        float f26 = lineBottom2;
                        float f27 = f23 + f26;
                        if (f27 > i10 + daVar.f19925e0 && f27 < daVar.F.getMeasuredHeight()) {
                            if (!isRtlCharAt) {
                                canvas.save();
                                float f28 = dp;
            ...
            if (i11 != 0 && daVar.f19931i) {
                if (!daVar.f19933j) {
                    daVar.O();
                }
                da.a(daVar, daVar.f19921b0);
