...
public final class ca extends GestureDetector.SimpleOnGestureListener {
    ...
    public final boolean onDoubleTap(MotionEvent motionEvent) {
        ...
        if (selectReaction) {
            ea eaVar = daVar.Ge;
            ng.m0.d(eaVar.f22783r, null, eaVar.f22780e[1], null, motionEvent.getX(), motionEvent.getY(), ng.q0.b(MediaDataController.getInstance(i10).getDoubleTapReaction()), daVar.F7, 0);
            ng.m0.f();
        }
