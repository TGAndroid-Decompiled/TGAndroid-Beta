...
public final class j4 implements DownloadController.FileDownloadProgressListener {
    ...
    public int f23009c;
    public int d;
    public final t1 f23010e;
    public final ImageReceiver f23011f;
    public boolean h;
    public final int f23012n;
    public final int f23013r;
    public final float[] f23014s = new float[8];
    public String v;
    ...
    public j4(t1 t1Var, MessageObject messageObject, TLRPC.MessageExtendedMedia messageExtendedMedia, boolean z4, int i10, int i11) {
        ...
        if (messageExtendedMedia instanceof TLRPC.TL_messageExtendedMedia) {
            ...
            this.f23016x = ((messageMedia instanceof TLRPC.TL_messageMediaDocument) && MessageObject.isVideoDocument(messageMedia.document)) ? false : false;
            ...
            this.f23016x = (4 & tL_messageExtendedMediaPreview.flags) != 0;
    ...
    public final void c(TLRPC.MessageExtendedMedia messageExtendedMedia, MessageObject messageObject) {
        ...
        if (this.B != messageExtendedMedia) {
            ...
            int i11 = this.f23013r;
            String h = e2.c.h(i10, "_", i11);
            boolean z10 = messageExtendedMedia instanceof TLRPC.TL_messageExtendedMediaPreview;
            ImageReceiver imageReceiver = this.f23011f;
            if (z10) {
                this.h = true;
                this.v = null;
                this.f23011f.setImage(ImageLocation.getForObject(((TLRPC.TL_messageExtendedMediaPreview) messageExtendedMedia).thumb, messageObject.messageOwner), w.c.e(h, "_b2"), null, null, messageObject, 0);
                ...
                if (messageMedia instanceof TLRPC.TL_messageMediaPhoto) {
                    ...
                    this.f23011f.setImage(ImageLocation.getForPhoto(closestPhotoSizeWithSize, tL_messageMediaPhoto.photo), h, ImageLocation.getForPhoto(FileLoader.getClosestPhotoSizeWithSize(tL_messageMediaPhoto.photo.sizes, Math.min(i10, i11) / 100, false, closestPhotoSizeWithSize, false), tL_messageMediaPhoto.photo), h, 0L, null, messageObject, 0);
                } else if (messageMedia instanceof TLRPC.TL_messageMediaDocument) {
                    TLRPC.TL_messageMediaDocument tL_messageMediaDocument = (TLRPC.TL_messageMediaDocument) messageMedia;
                    boolean z12 = this.h;
                    boolean z13 = this.f23016x;
                    boolean z14 = this.f23015w;
                    ...
                    if (!z14 && z13 && (document = tL_messageMediaDocument.document) != null) {
                        ...
                        l10.append(str);
                        String str2 = h;
                        this.f23011f.setImage(imageLocation, l10.toString(), forDocument2, str2, forDocument3, str2, null, 0L, null, messageObject, 0);
                        return;
                    }
                    ...
                    if (document2 != null) {
                        ...
                        this.f23011f.setImage(ImageLocation.getForDocument(closestPhotoSizeWithSize4, tL_messageMediaDocument.document), h, ImageLocation.getForDocument(FileLoader.getClosestPhotoSizeWithSize(tL_messageMediaDocument.document.thumbs, Math.min(i10, i11), false, closestPhotoSizeWithSize4, false), tL_messageMediaDocument.document), h, 0L, null, messageObject, 0);
                    }
                }
            }
        }
