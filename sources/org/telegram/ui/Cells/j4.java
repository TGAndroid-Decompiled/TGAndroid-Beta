...
public final class j4 implements DownloadController.FileDownloadProgressListener {
    ...
    public int d;
    public final t1 e;
    public final ImageReceiver f20281f;
    public boolean h;
    public final int f20282n;
    public final int f20283r;
    public final float[] f20284s = new float[8];
    public String v;
    ...
    public j4(t1 t1Var, MessageObject messageObject, TLRPC.MessageExtendedMedia messageExtendedMedia, boolean z10, int i10, int i11) {
        ...
        if (messageExtendedMedia instanceof TLRPC.TL_messageExtendedMedia) {
            ...
            this.f20286x = ((messageMedia instanceof TLRPC.TL_messageMediaDocument) && MessageObject.isVideoDocument(messageMedia.document)) ? false : false;
            ...
            this.f20286x = (4 & tL_messageExtendedMediaPreview.flags) != 0;
    ...
    public final void c(TLRPC.MessageExtendedMedia messageExtendedMedia, MessageObject messageObject) {
        ...
        if (this.E != messageExtendedMedia) {
            ...
            int i11 = this.f20283r;
            String l4 = a4.a.l(i10, i11, "_");
            boolean z11 = messageExtendedMedia instanceof TLRPC.TL_messageExtendedMediaPreview;
            ImageReceiver imageReceiver = this.f20281f;
            if (z11) {
                this.h = true;
                this.v = null;
                this.f20281f.setImage(ImageLocation.getForObject(((TLRPC.TL_messageExtendedMediaPreview) messageExtendedMedia).thumb, messageObject.messageOwner), w.c.g(l4, "_b2"), null, null, messageObject, 0);
                ...
                if (messageMedia instanceof TLRPC.TL_messageMediaPhoto) {
                    ...
                    this.f20281f.setImage(ImageLocation.getForPhoto(closestPhotoSizeWithSize, tL_messageMediaPhoto.photo), l4, ImageLocation.getForPhoto(FileLoader.getClosestPhotoSizeWithSize(tL_messageMediaPhoto.photo.sizes, Math.min(i10, i11) / 100, false, closestPhotoSizeWithSize, false), tL_messageMediaPhoto.photo), l4, 0L, null, messageObject, 0);
                } else if (messageMedia instanceof TLRPC.TL_messageMediaDocument) {
                    TLRPC.TL_messageMediaDocument tL_messageMediaDocument = (TLRPC.TL_messageMediaDocument) messageMedia;
                    boolean z13 = this.h;
                    boolean z14 = this.f20286x;
                    boolean z15 = this.f20285w;
                    ...
                    if (!z15 && z14 && (document = tL_messageMediaDocument.document) != null) {
                        ...
                        v.append(str);
                        String str2 = l4;
                        this.f20281f.setImage(imageLocation, v.toString(), forDocument2, str2, forDocument3, str2, null, 0L, null, messageObject, 0);
                        return;
                    }
                    ...
                    if (document2 != null) {
                        ...
                        this.f20281f.setImage(ImageLocation.getForDocument(closestPhotoSizeWithSize4, tL_messageMediaDocument.document), l4, ImageLocation.getForDocument(FileLoader.getClosestPhotoSizeWithSize(tL_messageMediaDocument.document.thumbs, Math.min(i10, i11), false, closestPhotoSizeWithSize4, false), tL_messageMediaDocument.document), l4, 0L, null, messageObject, 0);
                    }
                }
            }
        }
