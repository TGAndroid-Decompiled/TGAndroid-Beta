...
public abstract class n1 extends Drawable {
    ...
    public final Path f20466b;
    public final Paint f20467c;
    ...
    public final void draw(Canvas canvas) {
        switch (this.f20465a) {
            case 0:
                e();
                canvas.drawPath(this.f20466b, this.f20467c);
                return;
            default:
