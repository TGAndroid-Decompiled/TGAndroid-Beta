...
public abstract class n1 extends Drawable {
    ...
    public final Path f22330b;
    public final Paint f22331c;
    ...
    public final void draw(Canvas canvas) {
        switch (this.f22329a) {
            case 0:
                e();
                canvas.drawPath(this.f22330b, this.f22331c);
                return;
            default:
