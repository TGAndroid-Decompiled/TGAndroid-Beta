...
public abstract class n1 extends Drawable {
    ...
    public final Path f20477b;
    public final Paint f20478c;
    ...
    public final void draw(Canvas canvas) {
        switch (this.f20476a) {
            case 0:
                e();
                canvas.drawPath(this.f20477b, this.f20478c);
                return;
            default:
