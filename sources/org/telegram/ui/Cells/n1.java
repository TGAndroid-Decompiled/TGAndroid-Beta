...
public abstract class n1 extends Drawable {
    ...
    public final Path f22329b;
    public final Paint f22330c;
    ...
    public final void draw(Canvas canvas) {
        switch (this.f22328a) {
            case 0:
                e();
                canvas.drawPath(this.f22329b, this.f22330c);
                return;
            default:
