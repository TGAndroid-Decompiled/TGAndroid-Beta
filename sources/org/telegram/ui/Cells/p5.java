...
public final class p5 extends org.telegram.ui.Components.p9 {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (imageReceiver != null) {
            if (this.f27787c != -1 && this.d != -1) {
                int height = getHeight();
                int i10 = this.d;
                imageReceiver.setImageCoords((getWidth() - this.f27787c) / 2, (height - i10) / 2, this.f27787c, i10);
                int height2 = getHeight();
                int i11 = this.d;
                this.f27786b.setImageCoords((getWidth() - this.f27787c) / 2, (height2 - i11) / 2, this.f27787c, i11);
            } else {
            ...
            if (i12 != 0 && t5Var.O != null) {
                Paint paint = this.D;
                paint.setAlpha((int) (nr.f27346f.getInterpolation(1.0f - f10) * 255.0f));
            ...
            if (t5Var.f22353s) {
                r5 r5Var = t5Var.R;
                if ((r5Var == null || !((em) ((org.telegram.ui.Components.t) r5Var).f28845b).f24604s) && (photoEntry = t5Var.D) != null && photoEntry.isLivePhoto()) {
