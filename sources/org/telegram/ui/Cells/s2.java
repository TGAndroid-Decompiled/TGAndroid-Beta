...
public class s2 extends a0 implements ai.r9, org.telegram.ui.ActionBar.z5 {
    ...
    public int Z2;
    public boolean Z3;
    public TextPaint f20885a0;
    public boolean f20886a1;
    public final org.telegram.ui.Components.h9 a2;
    public int f20887a3;
    public int f20888a4;
    public Paint f20889b0;
    public boolean f20890b1;
    public boolean f20891b2;
    public int f20892b3;
    public int f20893b4;
    public fd f20894c0;
    public float f20895c1;
    public float f20896c2;
    public int f20897c3;
    public int f20898c4;
    public o2 f20899d0;
    public boolean f20900d1;
    public final m2 f20901d2;
    public int f20902d3;
    public int f20903d4;
    public boolean f20904e0;
    public boolean f20905e1;
    public ti0 f20906e2;
    public StaticLayout f20907e3;
    public StaticLayout f20908e4;
    public boolean f20909f;
    public boolean f20910f0;
    public MessageObject f20911f1;
    public TLRPC.User f20912f2;
    public StaticLayout f20913f3;
    public boolean f20914f4;
    public boolean f20915g0;
    public ArrayList f20916g1;
    public TLRPC.Chat f20917g2;
    public int f20918g3;
    public boolean f20919g4;
    public final boolean h;
    public Drawable[] f20920h0;
    public boolean f20921h1;
    public TLRPC.EncryptedChat f20922h2;
    public StaticLayout f20923h3;
    public boolean f20924h4;
    public float f20925i0;
    public CharSequence f20926i1;
    public CharSequence f20927i2;
    public final Stack f20928i3;
    public final ci.eb f20929i4;
    public boolean f20930j0;
    public int f20931j1;
    public int f20932j2;
    public final ArrayList j3;
    public final org.telegram.ui.Components.o5 f20933j4;
    public boolean f20934k0;
    public int f20935k1;
    public boolean f20936k2;
    public final Stack f20937k3;
    public final org.telegram.ui.Components.o5 f20938k4;
    public int f20939l0;
    public int l1;
    public TLRPC.DraftMessage f20940l2;
    public final ArrayList f20941l3;
    public int l4;
    public float m0;
    public boolean f20942m1;
    public final org.telegram.ui.Components.e6 f20943m2;
    public org.telegram.ui.Components.v5 f20944m3;
    public boolean f20945m4;
    public float f20946n;
    public k21 f20947n0;
    public boolean f20948n1;
    public boolean f20949n2;
    public org.telegram.ui.Components.v5 f20950n3;
    public final RectF f20951n4;
    public Paint f20952o0;
    public float f20953o1;
    public final org.telegram.ui.Components.e6 f20954o2;
    public org.telegram.ui.Components.v5 f20955o3;
    public gg.j f20956o4;
    public Paint f20957p0;
    public float f20958p1;
    public long f20959p2;
    public org.telegram.ui.Components.v5 f20960p3;
    public Path f20961p4;
    public boolean f20962q0;
    public float f20963q1;
    public ci.q3 f20964q2;
    public int f20965q3;
    public RectF f20966q4;
    public boolean f20967r;
    public boolean f20968r0;
    public float f20969r1;
    public final boolean f20970r2;
    public int f20971r3;
    public int f20972r4;
    public ij0 f20973s;
    public boolean f20974s0;
    public int f20975s1;
    public boolean f20976s2;
    public StaticLayout f20977s3;
    public int f20978s4;
    public hs f20979t0;
    public float f20980t1;
    public boolean f20981t2;
    public boolean f20982t3;
    public int f20983t4;
    public final k2 f20984u0;
    public int f20985u1;
    public boolean f20986u2;
    public int f20987u3;
    public float f20988u4;
    public int v;
    public Path f20989v0;
    public int f20990v1;
    public boolean f20991v2;
    public int f20992v3;
    public boolean f20993v4;
    public boolean f20994w;
    public vh.h f20995w0;
    public float f20996w1;
    public boolean f20997w2;
    public boolean f20998w3;
    public ValueAnimator f20999w4;
    public boolean f21000x;
    public boolean f21001x0;
    public boolean f21002x1;
    public int f21003x2;
    public float f21004x3;
    public long f21005x4;
    ...
    public boolean y3;
    public int f21010y4;
    public boolean f21011z0;
    public boolean f21012z1;
    public StaticLayout f21013z2;
    public boolean f21014z3;
    public final uy f21015z4;
    ...
    private MessageObject getCaptionMessage() {
        ...
        if (this.f20916g1 == null) {
            MessageObject messageObject = this.f20911f1;
        ...
        int i10 = 0;
        for (int i11 = 0; i11 < this.f20916g1.size(); i11++) {
            MessageObject messageObject3 = (MessageObject) this.f20916g1.get(i11);
    ...
    private Paint getPaintReorderGradient() {
        int v02 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19062d6, this.F4);
    ...
    public final void E(Canvas canvas, boolean z10, int i10, int i11, int i12, float f7, boolean z11) {
        ...
        if ((this.G3 && this.H3) || this.R3 != 1.0f) {
            ...
            if (z11) {
                ...
                f11 = 1.0f;
                this.T.setColor(i0.a.d(Color.alpha(w02) / 255.0f, org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19062d6, false), i0.a.k(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19341s9, false), 255)));
            } else {
                f11 = 1.0f;
            }
            if (this.P && this.N.read_inbox_max_id == 0) {
                ...
                if (!z10 && this.J0 == 0) {
                    paint = org.telegram.ui.ActionBar.j6.f19405w0;
                } else {
                    paint = org.telegram.ui.ActionBar.j6.f19440y0;
                }
                z13 = false;
            }
            StaticLayout staticLayout = this.U3;
            RectF rectF3 = this.f20951n4;
            if (staticLayout != null && this.S0 != 0) {
                paint.setAlpha((int) ((f11 - this.f21004x3) * i16));
                org.telegram.ui.ActionBar.j6.M0.setAlpha((int) ((f11 - this.f21004x3) * 255.0f));
                float f13 = f10 * 2.0f;
                if (f13 > f11) {
                    f12 = 1.0f;
                } else {
                ...
                if (f10 <= 0.5f) {
                    interpolation = qr.f27716g.getInterpolation(f13);
                } else {
                    interpolation = qr.f27717i.getInterpolation(f11 - ((f10 - 0.5f) * 2.0f));
                }
                ...
                if (z12) {
                    if (this.f20961p4 == null || (rectF2 = this.f20966q4) == null || !rectF2.equals(rectF3)) {
                        RectF rectF4 = this.f20966q4;
                        if (rectF4 == null) {
                            this.f20966q4 = new RectF(rectF3);
                        } else {
                            rectF4.set(rectF3);
                        }
                        if (this.f20961p4 == null) {
                            this.f20961p4 = new Path();
                        }
                        w7.w5.a(this.f20961p4, this.f20966q4, AndroidUtilities.dp(10.33f));
                    }
                    canvas.drawPath(this.f20961p4, paint);
                    if (z11) {
                        canvas.drawPath(this.f20961p4, this.T);
                    }
                } else {
                ...
                if (z12) {
                    if (this.f20961p4 == null || (rectF = this.f20966q4) == null || !rectF.equals(rectF3)) {
                        RectF rectF5 = this.f20966q4;
                        if (rectF5 == null) {
                            this.f20966q4 = new RectF(rectF3);
                        } else {
                            rectF5.set(rectF3);
    ...
    public final CharSequence G() {
        ...
        for (int i11 = 0; i11 < size; i11++) {
            ...
            if (!messagesController.isHiddenByUndo(dialog.f18300id)) {
                TLRPC.Chat chat = null;
                if (DialogObject.isEncryptedDialog(dialog.f18300id)) {
                    TLRPC.EncryptedChat m10 = org.telegram.messenger.q.m(messagesController, dialog.f18300id);
                    if (m10 != null) {
                        user = messagesController.getUser(Long.valueOf(m10.user_id));
                    } else {
                        user = null;
                    }
                } else if (DialogObject.isUserDialog(dialog.f18300id)) {
                    user = messagesController.getUser(Long.valueOf(dialog.f18300id));
                } else {
                    chat = messagesController.getChat(Long.valueOf(-dialog.f18300id));
                    user = null;
                }
                if (chat != null) {
    ...
    public final CharSequence J() {
        ...
        r2.a(this.J4, this.F0, this.f20911f1, this.f20917g2);
        this.J4.getClass();
        r2 r2Var = this.J4;
        this.I4 = r2Var.f20830c;
        this.f20910f0 = r2Var.d;
        return r2Var.f20832g;
    }
    ...
    public final SpannableStringBuilder L(int i10, CharSequence charSequence, String str, boolean z10) {
        ...
        MessageObject messageObject2 = this.f20911f1;
        ...
        if (message2 instanceof TLRPC.TL_messageService) {
            ...
            if (MessageObject.isTopicActionMessage(messageObject2)) {
                ...
                if (this.f20911f1.topicIconDrawable[0] instanceof ng.a) {
                    int i12 = this.F0;
                    TLRPC.TL_forumTopic findTopic = MessagesController.getInstance(i12).getTopicsController().findTopic(-this.f20911f1.getDialogId(), MessageObject.getTopicId(i12, this.f20911f1.messageOwner, true));
                    if (findTopic != null) {
                        ((ng.a) this.f20911f1.topicIconDrawable[0]).b(findTopic.icon_color);
                    }
                }
            } else {
                this.f20904e0 = false;
            ...
            if (captionMessage.hasHighlightedWords() && !TextUtils.isEmpty(captionMessage.messageOwner.message)) {
                ...
                if (this.W) {
                    if (!TextUtils.isEmpty(charSequence)) {
                        measuredWidth = (int) (measuredWidth - this.f20885a0.measureText(charSequence.toString()));
                    }
                    measuredWidth = (int) (measuredWidth - this.f20885a0.measureText(": "));
                }
                if (measuredWidth > 0 && captionMessage.messageTrimmedToHighlightCut) {
                    charSequence7 = AndroidUtilities.ellipsizeCenterEnd(charSequence7, captionMessage.highlightedWords.get(0), measuredWidth, this.f20885a0, 130);
                }
            ...
            if (message3 != null) {
                ...
                TextPaint textPaint = this.f20885a0;
                if (textPaint != null) {
            ...
            if (richMessage != null) {
                if (richMessage.blocks.size() == 1) {
                    z11 = MessageObject.isBlueBlock(this.f20911f1.messageOwner.rich_message.blocks.get(0));
                } else {
                    z11 = false;
                }
                SpannableStringBuilder I = I(this.f20911f1.messageText, charSequence, i10);
                if (z11 && !Q()) {
                    try {
                        e10 e10Var = new e10(org.telegram.ui.ActionBar.j6.f19285p9, e6Var);
                        if (this.W) {
                ...
                this.f20885a0 = org.telegram.ui.ActionBar.j6.H0[this.E0];
                int i13 = org.telegram.ui.ActionBar.j6.o9;
                MessageObject messageObject3 = this.f20911f1;
                ...
                if (messageMedia instanceof TLRPC.TL_messageMediaPoll) {
                    ...
                    charSequence3 = c1.i("🎧 \u2068", messageObject3.getMusicAuthor(), " - ", this.f20911f1.getMusicTitle(), "\u2069");
                    ...
                    i13 = org.telegram.ui.ActionBar.j6.f19285p9;
                } else if (this.R1 > 1) {
                    if (this.S1) {
                        ArrayList arrayList2 = this.f20916g1;
                        if (arrayList2 == null) {
                            size2 = 0;
                        } else {
                        ...
                        ArrayList arrayList3 = this.f20916g1;
                        if (arrayList3 == null) {
                            size = 0;
                        } else {
                ...
                MessageObject messageObject4 = this.f20911f1;
                String str3 = messageObject4.messageOwner.message;
                if (str3 != null) {
                    if (messageObject4.hasHighlightedWords()) {
                        CharSequence charSequence9 = this.f20911f1.messageTrimmedToHighlight;
                        ...
                        if (this.W) {
                            if (!TextUtils.isEmpty(charSequence)) {
                                measuredWidth2 = (int) (measuredWidth2 - this.f20885a0.measureText(charSequence.toString()));
                            }
                            measuredWidth2 = (int) (measuredWidth2 - this.f20885a0.measureText(": "));
                        }
                        if (measuredWidth2 > 0) {
                            replaceNewLines = AndroidUtilities.ellipsizeCenterEnd(replaceNewLines, this.f20911f1.highlightedWords.get(0), measuredWidth2, this.f20885a0, 130);
                        }
                    } else {
                    ...
                    MessageObject messageObject5 = this.f20911f1;
                    if (messageObject5 != null) {
                        messageObject5.spoilLoginCode();
                    }
                    MediaDataController.addTextStyleRuns(this.f20911f1, (Spannable) spannableString4, 264);
                    MessageObject messageObject6 = this.f20911f1;
                    if (messageObject6 != null && (message = messageObject6.messageOwner) != null) {
                        ArrayList<TLRPC.MessageEntity> arrayList4 = message.entities;
                        TextPaint textPaint2 = this.f20885a0;
                        if (textPaint2 != null) {
    ...
    public final boolean M() {
        hs hsVar = this.f20979t0;
        if (hsVar != null && !hsVar.f24725c.isEmpty()) {
            return true;
        }
        return false;
    }
    ...
    public final boolean N() {
        if (ChatObject.isCommunity(this.f20917g2)) {
            return !this.f20905e1;
        }
        if (this.P) {
            return this.f20886a1;
        }
        TLRPC.Chat chat = this.f20917g2;
    ...
    public boolean Q() {
        TLRPC.Chat chat;
        if (!O() && !this.P0 && (chat = this.f20917g2) != null) {
            if ((chat.forum || (ChatObject.isMonoForum(chat) && ChatObject.canManageMonoForum(this.F0, this.f20917g2))) && !this.P) {
                return true;
            }
            return false;
        }
    ...
    public final boolean R() {
        TLRPC.User user;
        if (!Q() && !this.f20984u0.f668w && (user = this.f20912f2) != null && !user.self) {
            TLRPC.UserStatus userStatus = user.status;
            int i10 = this.F0;
            if (userStatus == null || userStatus.expires > 0 || !MessagesController.getInstance(i10).onlinePrivacy.containsKey(Long.valueOf(this.f20912f2.f18443id))) {
                TLRPC.UserStatus userStatus2 = this.f20912f2.status;
    ...
    public final void U() {
        ...
        this.f20980t1 = 0.0f;
        this.f21002x1 = false;
        this.f21004x3 = (getIsPinned() && this.y3) ? 0.0f : 0.0f;
        this.f20998w3 = true;
        this.f20953o1 = 0.0f;
        setTranslationX(0.0f);
        setTranslationY(0.0f);
        org.telegram.ui.Components.o5 o5Var = this.f20933j4;
        if (o5Var != null && this.f20998w3) {
            o5Var.a();
        }
        org.telegram.ui.Components.o5 o5Var2 = this.f20938k4;
        if (o5Var2 != null && this.f20998w3) {
            o5Var2.a();
        }
    }

    public final void V(boolean z10, boolean z11) {
        ci.q3 q3Var = this.f20964q2;
        if (q3Var == null && !z10) {
            return;
        }
        if (q3Var == null) {
            ci.q3 q3Var2 = new ci.q3(this, getContext(), this.F4, 1);
            this.f20964q2 = q3Var2;
            q3Var2.b(-1, org.telegram.ui.ActionBar.j6.f19062d6, org.telegram.ui.ActionBar.j6.f19191k7);
            this.f20964q2.setDrawUnchecked(false);
            this.f20964q2.setDrawBackgroundAsArc(3);
            addView(this.f20964q2);
        }
        this.f20964q2.a(z10, z11);
        x();
    }
    ...
    public final void W(long j3, MessageObject messageObject, int i10, boolean z10, boolean z11) {
        ...
        this.H0 = j3;
        this.f21005x4 = System.currentTimeMillis();
        this.f20911f1 = messageObject;
        this.f20986u2 = z10;
        this.N0 = false;
        this.R0 = i10;
        if (messageObject != null) {
    ...
    public final void X(TLRPC.Dialog dialog, int i10, int i11) {
        boolean z10;
        if (this.H0 != dialog.f18300id) {
            ValueAnimator valueAnimator = this.f20999w4;
            if (valueAnimator != null) {
                valueAnimator.removeAllListeners();
                this.f20999w4.cancel();
            }
            this.f20993v4 = false;
            this.f20983t4 = -1;
        }
        this.H0 = dialog.f18300id;
        this.f21005x4 = System.currentTimeMillis();
        boolean z11 = true;
        this.N0 = true;
        ...
        if (dialog instanceof TLRPC.TL_dialogFolder) {
            this.J0 = ((TLRPC.TL_dialogFolder) dialog).folder.f18347id;
            ti0 ti0Var = this.f20906e2;
            if (ti0Var != null) {
                ti0Var.H = this;
                ti0Var.i();
            }
        ...
        if (this.f20979t0 == null) {
            this.f20979t0 = new hs(this);
        }
        this.f20935k1 = i11;
        this.l1 = 0;
        if (b0(0, false)) {
    ...
    public final void Y(TLRPC.TL_forumTopic tL_forumTopic, long j3, MessageObject messageObject, boolean z10, boolean z11) {
        ...
        if (tL_forumTopic != null) {
            this.f20916g1 = tL_forumTopic.groupedMessages;
        }
        TLRPC.TL_forumTopic tL_forumTopic2 = this.N;
        if (tL_forumTopic2 != null && tL_forumTopic2.f18348id == 1 && (ti0Var = this.f20906e2) != null) {
            ti0Var.H = this;
            ti0Var.i();
        }
        b0(0, z11);
    ...
    public final void a0() {
        ...
        if (ti0Var != null) {
            if (this.P) {
                ...
                this.f20906e2.L = AndroidUtilities.dp(24.0f);
                this.f20906e2.M = 0.0f;
            } else {
                k2 k2Var = this.f20984u0;
                RectF rectF = k2Var.F;
                RectF rectF2 = k2Var.F;
                ti0Var.K = rectF.centerY();
                this.f20906e2.L = rectF2.centerX();
                this.f20906e2.M = rectF2.width() / 2.0f;
                if (!MessagesController.getInstance(this.F0).getStoriesController().h.isEmpty()) {
                    this.f20906e2.M -= AndroidUtilities.dpf2(3.5f);
                }
                ti0 ti0Var2 = this.f20906e2;
                this.Y1.getBitmapWidth();
                ti0Var2.getClass();
            }
            ti0 ti0Var3 = this.f20906e2;
            if (!ti0Var3.E && ti0Var3.I != null) {
                ...
                animatorSet2.addListener(new ed0(ti0Var3, 6));
    ...
    public final void d0(boolean z10) {
        ...
        boolean z11;
        if (this.V4 != null && this.f20912f2 != null) {
            requirementToContact = MessagesController.getInstance(this.F0).isUserContactBlocked(this.f20912f2.f18443id);
        } else {
            requirementToContact = null;
        }
        if (this.f20949n2 == DialogObject.isPremiumBlocked(requirementToContact) && this.f20959p2 == DialogObject.getMessagesStarsPrice(requirementToContact)) {
            return;
        }
        this.f20949n2 = DialogObject.isPremiumBlocked(requirementToContact);
        this.f20959p2 = DialogObject.getMessagesStarsPrice(requirementToContact);
        if (!z10) {
            this.f20943m2.f(this.f20949n2, true);
            if (this.f20959p2 > 0) {
                z11 = true;
            } else {
                z11 = false;
            }
            this.f20954o2.f(z11, true);
        }
        invalidate();
    }
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        if ((!this.P && !this.F && motionEvent.getAction() == 1) || motionEvent.getAction() == 3) {
            this.f20984u0.a(motionEvent, this);
        }
    ...
    public final void e0() {
        ...
        if (this.R1 > 0) {
            if (Q()) {
                staticLayout = this.f20923h3;
            } else {
                staticLayout = this.f20907e3;
            }
            if (Q()) {
                i10 = this.f20897c3;
            } else {
                ...
                try {
                    ...
                    if (text instanceof Spanned) {
                        ...
                        if (q2VarArr != null && q2VarArr.length > 0) {
                            ...
                            if (ceil != 0 && !this.f21001x0 && !this.f21007y0) {
    ...
    public long getStarsPrice() {
        return this.f20959p2;
    }

    @Override
    public float getTranslationX() {
        return this.f20996w1;
    }
    ...
    public final void invalidateDrawable(Drawable drawable) {
        if (drawable != this.f21008y1 && drawable != org.telegram.ui.ActionBar.j6.f19370u1) {
    ...
    public void onAttachedToWindow() {
        ...
        U();
        this.f20944m3 = org.telegram.ui.Components.z5.update(0, this, this.f20944m3, this.f20907e3);
        this.f20950n3 = org.telegram.ui.Components.z5.update(0, this, this.f20950n3, this.f20977s3);
        this.f20955o3 = org.telegram.ui.Components.z5.update(0, this, this.f20955o3, this.f20923h3);
        this.f20960p3 = org.telegram.ui.Components.z5.update(0, this, this.f20960p3, this.f21013z2);
        org.telegram.ui.Components.o5 o5Var = this.f20933j4;
        if (o5Var != null) {
            o5Var.a();
        }
    ...
    public void onDetachedFromWindow() {
        ...
        ij0 ij0Var = this.f21008y1;
        if (ij0Var != null) {
            ij0Var.stop();
            this.f21008y1.T(0.0f, true);
            this.f21008y1.setCallback(null);
            this.f21008y1 = null;
            this.f21012z1 = false;
        }
        gg.j jVar = this.f20956o4;
        if (jVar != null) {
        ...
        org.telegram.ui.Components.z5.release(this, this.f20944m3);
        org.telegram.ui.Components.z5.release(this, this.f20950n3);
        org.telegram.ui.Components.z5.release(this, this.f20955o3);
        org.telegram.ui.Components.z5.release(this, this.f20960p3);
        this.f20984u0.g();
        this.f20894c0 = null;
    }
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (P() && (ti0Var = this.f20906e2) != null && SharedConfig.archiveHidden && ti0Var.J == 0.0f) {
            accessibilityNodeInfo.setVisibleToUser(false);
        } else {
            accessibilityNodeInfo.addAction(16);
            accessibilityNodeInfo.addAction(32);
            if (!P() && this.f21015z4 != null) {
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        if (this.f20925i0 == 0.0f && !this.P && !this.F && this.f20984u0.a(motionEvent, this)) {
            return true;
        }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (this.H0 != 0 || this.G0 != null) {
            ci.eb ebVar = this.f20929i4;
            if (ebVar != null) {
                ebVar.layout(0, 0, AndroidUtilities.dp(22.0f), AndroidUtilities.dp(22.0f));
            }
            if (this.f20964q2 != null) {
                int i17 = this.I;
                boolean z11 = this.f20970r2;
                ...
                if (this.f20934k0) {
                    ...
                    dp = (getMeasuredHeight() - this.f20964q2.getMeasuredHeight()) >> 1;
                } else {
                    if (LocaleController.isRTL) {
                        dp2 = (i12 - i10) - dp2;
                    }
                ...
                ci.q3 q3Var = this.f20964q2;
                q3Var.layout(i16, dp, q3Var.getMeasuredWidth() + i16, this.f20964q2.getMeasuredHeight() + dp);
            }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.P) {
            ...
            setMeasuredDimension(size, AndroidUtilities.dp(i12 + i13) + (this.f20976s2 ? 1 : 0));
            this.Q = false;
            if (this.P && !M()) {
                t();
                if (this.R) {
        ...
        this.f20985u1 = 0;
        this.f20990v1 = getMeasuredHeight();
    }
    ...
    public final void onPopulateAccessibilityEvent(AccessibilityEvent accessibilityEvent) {
            ...
            if (this.P && this.N != null) {
                ...
                if (user2 != null) {
                    ...
                    if (chat != null) {
                        ...
                        sb2.append(". ");
                        sb2.append(this.f20917g2.title);
                        sb2.append(". ");
                    }
                }
            }
        ...
        if (messageObject != null && this.J0 == 0) {
            ...
            sb2.append(". ");
            if (this.f20917g2 != null && !this.f20911f1.isOut() && this.f20911f1.isFromUser() && this.f20911f1.messageOwner.action == null && (user = MessagesController.getInstance(this.F0).getUser(Long.valueOf(this.f20911f1.messageOwner.from_id.user_id))) != null) {
                sb2.append(ContactsController.formatName(user.first_name, user.last_name));
                sb2.append(". ");
            }
            if (this.f20922h2 == null) {
                StringBuilder sb3 = new StringBuilder();
                sb3.append(this.f20911f1.messageText);
                if (!this.f20911f1.isMediaEmpty() && (captionMessage = getCaptionMessage()) != null && !TextUtils.isEmpty(captionMessage.caption)) {
                    if (sb3.length() > 0) {
                        sb3.append(". ");
                    }
                    sb3.append(captionMessage.caption);
                }
                StaticLayout staticLayout = this.f20907e3;
                if (staticLayout == null) {
                    length = -1;
                } else {
    ...
    public final boolean performAccessibilityAction(int i10, Bundle bundle) {
        uy uyVar;
        if (i10 == R.id.acc_action_chat_preview && (uyVar = this.f21015z4) != null) {
            uyVar.H4(this);
            return true;
        }
    ...
    public void setTranslationX(float f7) {
        ...
        if (ij0Var != null && f7 == 0.0f) {
            ij0Var.T(0.0f, true);
            this.f21012z1 = false;
            this.f20942m1 = SharedConfig.archiveHidden;
            this.B1 = 0.0f;
            this.f21002x1 = false;
        }
        float f10 = this.f20996w1;
        if (f10 != 0.0f) {
            this.f21002x1 = true;
        } else {
            this.C1 = 0.0f;
        ...
        if (this.f21002x1 && !this.f20994w) {
            boolean z11 = this.A1;
            if (Math.abs(f10) < getMeasuredWidth() * 0.45f) {
                z10 = false;
            }
            this.A1 = z10;
            if (z11 != z10 && this.f20942m1 == SharedConfig.archiveHidden) {
                try {
    ...
    public final void w() {
        float f7;
        TLRPC.User user;
        if (this.f20912f2 != null && (user = MessagesController.getInstance(this.F0).getUser(Long.valueOf(this.f20912f2.f18443id))) != null) {
            this.f20912f2 = user;
        }
        if (R()) {
            f7 = 1.0f;
    ...
    public final void x() {
        ...
        float f7;
        ci.q3 q3Var;
        if (this.f20939l0 > 0 && !this.f20991v2 && !R() && (((q3Var = this.f20964q2) == null || !q3Var.f26739a.f22158q) && !this.f20984u0.f668w)) {
            z10 = true;
        } else {
            z10 = false;
        }
    ...
    public final int y() {
        float f7;
        if (Q() && !this.f20930j0 && !this.f20909f) {
            if (!this.f20970r2 && !SharedConfig.useThreeLinesLayout) {
                f7 = 91.0f;
            } else {
                f7 = 86.0f;
            }
    ...
    public final void z(int i10, int i11) {
        this.f20988u4 = 0.0f;
        ValueAnimator ofFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
        this.f20999w4 = ofFloat;
        ofFloat.setDuration(220L);
        this.f20999w4.setInterpolator(qr.f27715f);
        this.f20978s4 = i10;
        this.f20972r4 = i11;
        this.f20999w4.addUpdateListener(new h2(this, 2));
        this.f20999w4.addListener(new l2(this, 2));
        this.f20993v4 = true;
        this.f20999w4.start();
    }
    ...
    public s2(uy uyVar, Context context, boolean z10, int i10, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        this.f20901d2 = new m2(0);
        qr qrVar = qr.h;
        this.f20943m2 = new org.telegram.ui.Components.e6(this, 0L, 350L, qrVar);
        this.f20954o2 = new org.telegram.ui.Components.e6(this, 0L, 350L, qrVar);
        this.f20928i3 = new Stack();
        this.j3 = new ArrayList();
        this.f20937k3 = new Stack();
        this.f20941l3 = new ArrayList();
        this.H3 = true;
        this.O3 = new le.b(this, qrVar, 320L);
        this.R3 = 1.0f;
        this.S3 = 1.0f;
        this.f20951n4 = new RectF();
        this.f20983t4 = -1;
        this.D4 = -1;
        this.E4 = new p2(this);
        k2Var.I = true;
        ...
        while (true) {
            ...
            if (i11 < imageReceiverArr.length) {
                ...
                this.f20929i4 = ebVar;
                addView(ebVar);
                this.f20933j4 = new org.telegram.ui.Components.o5(AndroidUtilities.dp(22.0f), ebVar);
                this.f20938k4 = new org.telegram.ui.Components.o5(AndroidUtilities.dp(17.0f), this);
