...
public final class e6 {
    ...
    public static void a(e6 e6Var, TLObject tLObject, MessagesStorage messagesStorage, long j10, int i10, ArrayList arrayList) {
        ArrayList arrayList2 = e6Var.d;
        int i11 = e6Var.f20995a;
    ...
    public static void b(e6 e6Var, int i10, ArrayList arrayList, long j10, int i11, MessagesStorage messagesStorage) {
        int i12 = e6Var.f20995a;
        ArrayList arrayList2 = e6Var.d;
        if (i10 != e6Var.e) {
            return;
        }
        ...
        for (int i14 = 10; i14 >= 0; i14--) {
            int i15 = i11 - i14;
            if (i15 >= 0) {
                tL_channels_getMessages.f19197id.add(Integer.valueOf(i15));
            }
        }
    ...
    public final void d(TLRPC.UserFull userFull) {
        ...
        if (userFull != null && (userFull.flags2 & 64) != 0) {
            ...
            if (this.f20997c || this.f20996b) {
                if (this.f20998f == j10 && this.f20999g == i10) {
                    return;
                }
                this.f20997c = false;
                arrayList.clear();
