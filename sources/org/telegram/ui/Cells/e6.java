...
public final class e6 implements o2 {
    public final org.telegram.ui.ActionBar.m2 f20244a;
    public final Context f20245b;
    public final h01 f20246c;
    ...
    public final void c() {
        boolean z10;
        org.telegram.ui.ActionBar.m2 m2Var = this.f20244a;
        ...
        m2Var.getOrCreateStoryViewer().G(this.f20245b, null, arrayList2, 0, null, null, new ai.u9(this.f20246c), false);
    }
    ...
    public final void e(s2 s2Var) {
        ...
        if (m2Var.getMessagesController().getStoriesController().I(s2Var.getDialogId())) {
            ...
            m2Var.getOrCreateStoryViewer().D(m2Var.getContext(), s2Var.getDialogId(), new ai.u9(this.f20246c));
        }
    }
