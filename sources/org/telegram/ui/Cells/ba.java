...
public class ba extends ea {
    ...
    public final void X(Canvas canvas) {
        Layout staticTextLayout = this.f20084u0.getStaticTextLayout();
        int v02 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Md, this.f20230h0);
        this.f20242o.setColor(v02);
        this.f20244p.setColor(v02);
        i(canvas, staticTextLayout, this.f20254u, this.v, true, true, 0.0f);
    }

    @Override
    public final void j(int i10, u9 u9Var, boolean z10) {
        u9Var.f21671b = this.f20084u0.getStaticTextLayout();
        u9Var.f21672c = 0.0f;
        u9Var.d = 0.0f;
        u9Var.f21670a = 0;
    }
    ...
    public final int l(int i10, int i11, int i12, int i13, z9 z9Var, boolean z10) {
        ...
        if (layout != null) {
            ...
            if (i15 >= 0) {
                try {
                    return u9Var.f21670a + layout.getOffsetForHorizontal(i15, i14);
                } catch (Exception e) {
                    FileLog.e(e);
                }
            }
