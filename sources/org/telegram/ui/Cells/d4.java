...
public class d4 extends FrameLayout {
    ...
    public final b4 f20918a;
    public AnimatorSet f20919a0;
    public final org.telegram.ui.Components.p9 f20920b;
    public float f20921b0;
    public final org.telegram.ui.ActionBar.k5 f20922c;
    public final org.telegram.ui.ActionBar.k5[] d;
    public final org.telegram.ui.ActionBar.k5 e;
    public final jj0 f20923f;
    public final gj0 h;
    public final gj0 f20924n;
    public final org.telegram.ui.Components.j5 f20925r;
    public final org.telegram.ui.Components.j5 f20926s;
    public Drawable v;
    public Drawable f20927w;
    public final x3 f20928x;
    public final org.telegram.ui.Components.z8 f20929y;
    ...
    public d4(Context context) {
        ...
        this.O = new Runnable(this) {
            ...
            public final void run() {
                ...
                switch (r2) {
                    case 0:
                        d4 d4Var = this.f22501b;
                        d4Var.f20924n.P(0, null);
                        gj0 gj0Var = d4Var.h;
                        gj0Var.P(0, null);
                        d4Var.f20923f.setAnimation(gj0Var);
                        return;
                    case 1:
                        d4 d4Var2 = this.f22501b;
                        jj0 jj0Var = d4Var2.f20923f;
                        gj0 gj0Var2 = d4Var2.f20924n;
                        ...
                        gj0Var2.N(i19);
                        gj0Var2.P(i19 - 1, d4Var2.O);
                        jj0Var.setAnimation(gj0Var2);
                        gj0Var2.K(i18);
                        jj0Var.d();
                        return;
                    case 2:
                        this.f22501b.a(true, true);
                        return;
                    case 3:
                        d4 d4Var3 = this.f22501b;
                        d4Var3.U = false;
                        d4Var3.a(true, true);
                        d4Var3.f20918a.c(0.0d);
                        d4Var3.T = false;
                        return;
                    default:
                        this.f22501b.a(true, true);
        ...
        this.Q = org.telegram.ui.ActionBar.j6.f20141rg;
        ...
        this.f20929y = new org.telegram.ui.Components.z8((org.telegram.ui.ActionBar.f6) null);
        ...
        addView(x3Var, k7.b6.d(46, 46.0f, i19, f12, 6.0f, f13, 0.0f));
        ...
        this.f20925r = new org.telegram.ui.Components.j5(AndroidUtilities.dp(20.0f), 9, k5Var, false);
        this.f20926s = new org.telegram.ui.Components.j5(AndroidUtilities.dp(20.0f), 9, k5Var, false);
        Drawable drawable = context.getResources().getDrawable(R.drawable.voice_volume_mini);
        this.W = drawable;
        drawable.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20123qg, false), PorterDuff.Mode.MULTIPLY));
        int i21 = 0;
        while (true) {
            ...
            k5VarArr[i21] = new y3(this, context, i21);
            ...
            if (i21 == 4) {
                ...
                this.d[i21].setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20141rg, false));
                ...
                if (i21 == 0) {
                    this.d[i21].setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20106pg, false));
                    this.d[i21].k(LocaleController.getString(R.string.Listening));
                } else if (i21 == 1) {
                    this.d[i21].setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20123qg, false));
                    this.d[i21].k(LocaleController.getString(R.string.Speaking));
                    this.d[i21].setDrawablePadding(AndroidUtilities.dp(2.0f));
                } else if (i21 == 2) {
                    this.d[i21].setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20157sg, false));
        ...
        k5Var5.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20141rg, false));
        ...
        this.h = gj0Var;
        this.f20924n = new gj0(R.raw.hand_1, AndroidUtilities.dp(34.0f), AndroidUtilities.dp(32.0f), true, null);
        ?? imageView = new ImageView(context);
        this.f20923f = imageView;
        ...
        this.f20918a = new b4(AndroidUtilities.dp(26.0f), AndroidUtilities.dp(29.0f));
    ...
    public final boolean c() {
        ...
        if (chat == null || chat.f19159id != (-j10)) {
            return false;
        }
        return true;
    }
    ...
    public final void e(AccountInstance accountInstance, TLRPC.GroupCallParticipant groupCallParticipant, ChatObject.Call call, long j10, TLRPC.FileLocation fileLocation, boolean z4) {
        ...
        org.telegram.ui.ActionBar.k5 k5Var = this.f20922c;
        org.telegram.ui.Components.p9 p9Var = this.f20920b;
        org.telegram.ui.Components.z8 z8Var = this.f20929y;
        org.telegram.ui.Components.j5 j5Var = this.f20926s;
        if (peerId > 0) {
            ...
            if (user != null && user.verified) {
                ...
                if (user2 != null && user2.premium) {
                    if (this.f20927w == null) {
                        this.f20927w = getContext().getResources().getDrawable(R.drawable.msg_premium_liststar).mutate();
                        this.f20927w = new org.telegram.ui.Components.k5(AndroidUtilities.dp(14.0f), AndroidUtilities.dp(14.0f), this.f20927w);
                    }
                    j5Var.g(this.f20927w, z4);
                } else {
                    j5Var.g(null, z4);
                }
            }
        ...
        org.telegram.ui.Components.j5 j5Var2 = this.f20925r;
    ...
    public final void onDetachedFromWindow() {
        ...
        AnimatorSet animatorSet = this.f20919a0;
        if (animatorSet != null) {
            animatorSet.cancel();
        }
        org.telegram.ui.Components.j5 j5Var = this.f20926s;
    ...
    public void setProgressToAvatarPreview(float f10) {
        ...
        this.f20922c.setTranslationX(i10 * f10);
        boolean c3 = c();
        boolean z4 = true;
        org.telegram.ui.ActionBar.k5 k5Var = this.e;
        float f11 = 0.0f;
        ...
        this.f20920b.setAlpha(f11);
        this.f20918a.e(this, (this.U && i13 == 0) ? false : false);
        float f13 = 1.0f - f10;
        jj0 jj0Var = this.f20923f;
        jj0Var.setAlpha(f13);
