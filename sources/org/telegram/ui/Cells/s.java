...
public final class s extends LinearLayout {
    public static final int f22727f = 0;
    public Paint f22728a;
    public Paint f22729b;
    public q f22730c;
    public TextView d;
    ...
    public final void draw(Canvas canvas) {
        ...
        canvas.drawRoundRect(rectF, AndroidUtilities.dp(18.0f), AndroidUtilities.dp(18.0f), this.f22729b);
        super.draw(canvas);
