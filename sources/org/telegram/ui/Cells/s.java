...
public final class s extends LinearLayout {
    public static final int f23604f = 0;
    public Paint f23605a;
    public Paint f23606b;
    public q f23607c;
    public TextView d;
    ...
    public final void draw(Canvas canvas) {
        ...
        canvas.drawRoundRect(rectF, AndroidUtilities.dp(18.0f), AndroidUtilities.dp(18.0f), this.f23606b);
        super.draw(canvas);
