...
public final class s extends LinearLayout {
    public static final int f20911f = 0;
    public Paint f20912a;
    public Paint f20913b;
    public q f20914c;
    public TextView d;
    public float e;
    ...
    public final void draw(Canvas canvas) {
        ...
        canvas.drawRoundRect(rectF, AndroidUtilities.dp(18.0f), AndroidUtilities.dp(18.0f), this.f20913b);
        super.draw(canvas);
