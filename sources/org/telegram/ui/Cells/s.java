...
public final class s extends LinearLayout {
    public static final int f20810f = 0;
    public Paint f20811a;
    public Paint f20812b;
    public q f20813c;
    public TextView d;
    public float e;
    ...
    public final void draw(Canvas canvas) {
        ...
        canvas.drawRoundRect(rectF, AndroidUtilities.dp(18.0f), AndroidUtilities.dp(18.0f), this.f20812b);
        super.draw(canvas);
