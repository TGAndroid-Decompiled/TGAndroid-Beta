...
public final class s extends LinearLayout {
    public static final int f20832f = 0;
    public Paint f20833a;
    public Paint f20834b;
    public q f20835c;
    public TextView d;
    public float e;
    ...
    public final void draw(Canvas canvas) {
        ...
        canvas.drawRoundRect(rectF, AndroidUtilities.dp(18.0f), AndroidUtilities.dp(18.0f), this.f20834b);
        super.draw(canvas);
