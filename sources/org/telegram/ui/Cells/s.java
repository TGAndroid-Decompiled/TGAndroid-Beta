...
public final class s extends LinearLayout {
    public static final int f20786f = 0;
    public Paint f20787a;
    public Paint f20788b;
    public q f20789c;
    public TextView d;
    public float e;
    ...
    public final void draw(Canvas canvas) {
        ...
        canvas.drawRoundRect(rectF, AndroidUtilities.dp(18.0f), AndroidUtilities.dp(18.0f), this.f20788b);
        super.draw(canvas);
