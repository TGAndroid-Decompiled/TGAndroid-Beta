...
public class w9 extends z9 {
    ...
    public final void X(Canvas canvas) {
        Layout staticTextLayout = this.f24373u0.getStaticTextLayout();
        int v02 = org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.Md, this.f24515h0);
        this.f24527o.setColor(v02);
        this.f24529p.setColor(v02);
        i(canvas, staticTextLayout, this.f24539u, this.v, true, true, 0.0f);
    }

    @Override
    public final void j(int i10, p9 p9Var, boolean z4) {
        p9Var.f23341b = this.f24373u0.getStaticTextLayout();
        p9Var.f23342c = 0.0f;
        p9Var.d = 0.0f;
        p9Var.f23340a = 0;
    }
    ...
    public final int l(int i10, int i11, int i12, int i13, u9 u9Var, boolean z4) {
        ...
        if (layout != null) {
            ...
            if (i15 >= 0) {
                try {
                    return p9Var.f23340a + layout.getOffsetForHorizontal(i15, i14);
                } catch (Exception e6) {
                    FileLog.e(e6);
                }
            }
