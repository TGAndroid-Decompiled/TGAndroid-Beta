...
public final class y8 extends FrameLayout {
    ...
    public static final int[] f21660f = {-65536, -29183, -256, -16711936, -16711681, -16776961, -2984711, -65281, -1};
    ...
    public final void a(ArrayList arrayList, boolean z10) {
        ...
        float f10;
        setEnabled(z10);
        TextView textView = this.f21661a;
        float f11 = 0.5f;
        if (arrayList != null) {
            if (z10) {
                f10 = 1.0f;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.f21662b) {
            ...
            canvas2 = canvas;
            canvas2.drawLine(dp, measuredHeight, measuredWidth2 - i10, getMeasuredHeight() - 1, org.telegram.ui.ActionBar.i6.f18955k0);
        } else {
            canvas2 = canvas;
        }
    ...
    public final void onMeasure(int i10, int i11) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i10), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(50.0f) + (this.f21662b ? 1 : 0), 1073741824));
    }
}
