...
public final class y8 extends FrameLayout {
    public final TextView f21639a;
    public final TextView f21640b;
    public final op f21641c;
    public boolean d;
    public boolean e;
    public int f21642f;
    public float h;
    public float f21643n;
    ...
    public void setAnimationProgress(float f7) {
        this.h = f7;
        Math.max(this.f21643n, getMeasuredWidth() - this.f21643n);
        AndroidUtilities.dp(40.0f);
        getMeasuredHeight();
    }

    public final void b(String str, String str2, boolean z10, boolean z11) {
        TextView textView = this.f21639a;
        textView.setText(str);
        TextView textView2 = this.f21640b;
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        accessibilityNodeInfo.setChecked(this.f21641c.f26827a.f21943q);
        StringBuilder sb2 = new StringBuilder();
        sb2.append(this.f21639a.getText());
        TextView textView = this.f21640b;
        if (textView != null) {
            sb2.append("\n");
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.f21640b.getVisibility() == 0) {
            f7 = 64.0f;
        } else {
            f7 = this.f21642f;
        }
    ...
    public void setTypeface(Typeface typeface) {
        this.f21639a.setTypeface(typeface);
    }
}
