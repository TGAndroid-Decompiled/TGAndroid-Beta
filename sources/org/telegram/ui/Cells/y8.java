...
public final class y8 extends FrameLayout {
    ...
    public static final int[] f21664f = {-65536, -29183, -256, -16711936, -16711681, -16776961, -2984711, -65281, -1};
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.f21666b) {
            ...
            canvas2 = canvas;
            canvas2.drawLine(dp, measuredHeight, measuredWidth2 - i10, getMeasuredHeight() - 1, org.telegram.ui.ActionBar.i6.f18958k0);
        } else {
            canvas2 = canvas;
        }
        int i11 = this.f21667c;
        if (i11 != 0) {
            d.setColor(i11);
            if (LocaleController.isRTL) {
    ...
    public final void onMeasure(int i10, int i11) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i10), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(50.0f) + (this.f21666b ? 1 : 0), 1073741824));
    }
}
