...
public abstract class qa extends ll0 implements NotificationCenter.NotificationCenterDelegate {
    public static final byte[] f20624i3 = new byte[1024];
    public boolean X2;
    public final gg.b0 Y2;
    public final HashMap Z2;
    public final HashMap f20625a3;
    public org.telegram.ui.ActionBar.h6 f20626b3;
    public final pa f20627c3;
    public final ArrayList f20628d3;
    public final ArrayList f20629e3;
    public final int f20630f3;
    public int f20631g3;
    public final org.telegram.ui.ActionBar.n2 f20632h3;

    public qa(Context context, org.telegram.ui.ActionBar.n2 n2Var, int i10, ArrayList arrayList, ArrayList arrayList2) {
        super(context, null);
        this.Z2 = new HashMap();
        this.f20625a3 = new HashMap();
        this.f20628d3 = arrayList2;
        this.f20629e3 = arrayList;
        this.f20630f3 = i10;
        this.f20632h3 = n2Var;
        if (i10 == 2) {
        ...
        setOnItemClickListener(new zk0() {
            ...
            public final void d(int i11, View view) {
                qa qaVar = qa.this;
                qaVar.getClass();
                qaVar.y1(((ThemesHorizontalListCell$InnerThemeView) view).f19767b);
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.fileLoaded) {
            ...
            if (h6Var != null) {
                this.Z2.remove(str);
                if (this.f20625a3.remove(h6Var) != null) {
    ...
    public final void w1(org.telegram.ui.ActionBar.h6 h6Var) {
        ...
        for (int i10 = 0; i10 < childCount; i10++) {
            ...
            if (childAt instanceof ThemesHorizontalListCell$InnerThemeView) {
                ...
                if (themesHorizontalListCell$InnerThemeView.f19767b == h6Var && themesHorizontalListCell$InnerThemeView.c()) {
                    themesHorizontalListCell$InnerThemeView.f19767b.U = true;
    ...
    public final void x1(int i10) {
        ...
        if (i10 != 0) {
            ...
            this.f20626b3 = A0;
            ArrayList arrayList = this.f20629e3;
            int indexOf = arrayList.indexOf(A0);
            if (indexOf < 0 && (indexOf = this.f20628d3.indexOf(this.f20626b3) + arrayList.size()) < 0) {
                return;
            }
    ...
    public final void y1(org.telegram.ui.ActionBar.h6 h6Var) {
        ...
        if (tL_theme != null) {
            if (h6Var.U) {
                if (tL_theme.document == null) {
                    org.telegram.ui.ActionBar.n2 n2Var = this.f20632h3;
                    if (n2Var != null) {
                        n2Var.presentFragment(new ae1(h6Var, null, true));
                        return;
                    }
                    return;
                }
        ...
        for (int i10 = 0; i10 < childCount; i10++) {
            ...
            if (childAt instanceof ThemesHorizontalListCell$InnerThemeView) {
                ThemesHorizontalListCell$InnerThemeView themesHorizontalListCell$InnerThemeView = (ThemesHorizontalListCell$InnerThemeView) childAt;
                if (themesHorizontalListCell$InnerThemeView.f19766a0.f20630f3 == 1) {
                    A0 = org.telegram.ui.ActionBar.i6.J;
                } else {
                    A0 = org.telegram.ui.ActionBar.i6.A0();
                }
                RadioButton radioButton = themesHorizontalListCell$InnerThemeView.f19765a;
                if (themesHorizontalListCell$InnerThemeView.f19767b == A0) {
                    z10 = true;
                } else {
                    z10 = false;
                }
        ...
        if (this.f20630f3 != 1) {
            org.telegram.ui.ActionBar.i6.F1(this.f20632h3);
        }
    }
