...
public abstract class qa extends ml0 implements NotificationCenter.NotificationCenterDelegate {
    public static final byte[] f20634i3 = new byte[1024];
    public boolean X2;
    public final gg.b0 Y2;
    public final HashMap Z2;
    public final HashMap f20635a3;
    public org.telegram.ui.ActionBar.i6 f20636b3;
    public final pa f20637c3;
    public final ArrayList f20638d3;
    public final ArrayList f20639e3;
    public final int f20640f3;
    public int f20641g3;
    public final org.telegram.ui.ActionBar.o2 f20642h3;

    public qa(Context context, org.telegram.ui.ActionBar.o2 o2Var, int i10, ArrayList arrayList, ArrayList arrayList2) {
        super(context, null);
        this.Z2 = new HashMap();
        this.f20635a3 = new HashMap();
        this.f20638d3 = arrayList2;
        this.f20639e3 = arrayList;
        this.f20640f3 = i10;
        this.f20642h3 = o2Var;
        if (i10 == 2) {
        ...
        setOnItemClickListener(new al0() {
            ...
            public final void d(int i11, View view) {
                qa qaVar = qa.this;
                qaVar.getClass();
                qaVar.z1(((ThemesHorizontalListCell$InnerThemeView) view).f19777b);
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.fileLoaded) {
            ...
            if (i6Var != null) {
                this.Z2.remove(str);
                if (this.f20635a3.remove(i6Var) != null) {
    ...
    public final void x1(org.telegram.ui.ActionBar.i6 i6Var) {
        ...
        for (int i10 = 0; i10 < childCount; i10++) {
            ...
            if (childAt instanceof ThemesHorizontalListCell$InnerThemeView) {
                ...
                if (themesHorizontalListCell$InnerThemeView.f19777b == i6Var && themesHorizontalListCell$InnerThemeView.c()) {
                    themesHorizontalListCell$InnerThemeView.f19777b.U = true;
    ...
    public final void y1(int i10) {
        ...
        if (i10 != 0) {
            ...
            this.f20636b3 = A0;
            ArrayList arrayList = this.f20639e3;
            int indexOf = arrayList.indexOf(A0);
            if (indexOf < 0 && (indexOf = this.f20638d3.indexOf(this.f20636b3) + arrayList.size()) < 0) {
                return;
            }
    ...
    public final void z1(org.telegram.ui.ActionBar.i6 i6Var) {
        ...
        if (tL_theme != null) {
            if (i6Var.U) {
                if (tL_theme.document == null) {
                    org.telegram.ui.ActionBar.o2 o2Var = this.f20642h3;
                    if (o2Var != null) {
        ...
        for (int i10 = 0; i10 < childCount; i10++) {
            ...
            if (childAt instanceof ThemesHorizontalListCell$InnerThemeView) {
                ThemesHorizontalListCell$InnerThemeView themesHorizontalListCell$InnerThemeView = (ThemesHorizontalListCell$InnerThemeView) childAt;
                if (themesHorizontalListCell$InnerThemeView.f19776a0.f20640f3 == 1) {
                    A0 = org.telegram.ui.ActionBar.j6.J;
                } else {
                    A0 = org.telegram.ui.ActionBar.j6.A0();
                }
                RadioButton radioButton = themesHorizontalListCell$InnerThemeView.f19775a;
                if (themesHorizontalListCell$InnerThemeView.f19777b == A0) {
                    z10 = true;
                } else {
                    z10 = false;
                }
        ...
        if (this.f20640f3 != 1) {
            org.telegram.ui.ActionBar.j6.F1(this.f20642h3);
        }
    }
