...
public abstract class qa extends ml0 implements NotificationCenter.NotificationCenterDelegate {
    public static final byte[] f20635i3 = new byte[1024];
    public boolean X2;
    public final gg.b0 Y2;
    public final HashMap Z2;
    public final HashMap f20636a3;
    public org.telegram.ui.ActionBar.i6 f20637b3;
    public final pa f20638c3;
    public final ArrayList f20639d3;
    public final ArrayList f20640e3;
    public final int f20641f3;
    public int f20642g3;
    public final org.telegram.ui.ActionBar.o2 f20643h3;

    public qa(Context context, org.telegram.ui.ActionBar.o2 o2Var, int i10, ArrayList arrayList, ArrayList arrayList2) {
        super(context, null);
        this.Z2 = new HashMap();
        this.f20636a3 = new HashMap();
        this.f20639d3 = arrayList2;
        this.f20640e3 = arrayList;
        this.f20641f3 = i10;
        this.f20643h3 = o2Var;
        if (i10 == 2) {
            setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18934h5, false));
        } else {
        ...
        setOnItemClickListener(new al0() {
            ...
            public final void d(int i11, View view) {
                qa qaVar = qa.this;
                qaVar.getClass();
                qaVar.z1(((ThemesHorizontalListCell$InnerThemeView) view).f19778b);
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.fileLoaded) {
            ...
            if (i6Var != null) {
                this.Z2.remove(str);
                if (this.f20636a3.remove(i6Var) != null) {
    ...
    public final void x1(org.telegram.ui.ActionBar.i6 i6Var) {
        ...
        for (int i10 = 0; i10 < childCount; i10++) {
            ...
            if (childAt instanceof ThemesHorizontalListCell$InnerThemeView) {
                ...
                if (themesHorizontalListCell$InnerThemeView.f19778b == i6Var && themesHorizontalListCell$InnerThemeView.c()) {
                    themesHorizontalListCell$InnerThemeView.f19778b.U = true;
    ...
    public final void y1(int i10) {
        ...
        if (i10 != 0) {
            ...
            this.f20637b3 = A0;
            ArrayList arrayList = this.f20640e3;
            int indexOf = arrayList.indexOf(A0);
            if (indexOf < 0 && (indexOf = this.f20639d3.indexOf(this.f20637b3) + arrayList.size()) < 0) {
                return;
            }
    ...
    public final void z1(org.telegram.ui.ActionBar.i6 i6Var) {
        ...
        if (tL_theme != null) {
            if (i6Var.U) {
                if (tL_theme.document == null) {
                    org.telegram.ui.ActionBar.o2 o2Var = this.f20643h3;
                    if (o2Var != null) {
        ...
        for (int i10 = 0; i10 < childCount; i10++) {
            ...
            if (childAt instanceof ThemesHorizontalListCell$InnerThemeView) {
                ThemesHorizontalListCell$InnerThemeView themesHorizontalListCell$InnerThemeView = (ThemesHorizontalListCell$InnerThemeView) childAt;
                if (themesHorizontalListCell$InnerThemeView.f19777a0.f20641f3 == 1) {
                    A0 = org.telegram.ui.ActionBar.j6.J;
                } else {
                    A0 = org.telegram.ui.ActionBar.j6.A0();
                }
                RadioButton radioButton = themesHorizontalListCell$InnerThemeView.f19776a;
                if (themesHorizontalListCell$InnerThemeView.f19778b == A0) {
                    z10 = true;
                } else {
                    z10 = false;
                }
        ...
        if (this.f20641f3 != 1) {
            org.telegram.ui.ActionBar.j6.F1(this.f20643h3);
        }
    }
