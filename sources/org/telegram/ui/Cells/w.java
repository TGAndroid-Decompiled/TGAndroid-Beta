...
public final class w extends FrameLayout implements Checkable {
    ...
    public final xh0 e;
    public final xh0 f21493f;
    public boolean h;
    public Button f21494n;
    public AnimatorSet f21495r;
    public TLRPC.StickerSetCovered f21496s;
    public v v;
    ...
    public final void a(boolean z10, boolean z11, boolean z12) {
        ...
        int i10;
        int i11;
        if (this.f21490a && this.f21497w != z10) {
            this.f21497w = z10;
            c(z11);
            if (z12 && (vVar = this.v) != null) {
                ah.b bVar = (ah.b) vVar;
                org.telegram.ui.p pVar = ((org.telegram.ui.o) bVar.f418b).d;
                TLRPC.StickerSetCovered stickerSetCovered = (TLRPC.StickerSetCovered) bVar.f419c;
                a0.i iVar = pVar.f36373a;
                if (z10) {
                    a(false, false, false);
                    if (iVar.h(stickerSetCovered.set.f18139id) < 0) {
                        xh0 xh0Var = this.f21493f;
                        if (xh0Var != null) {
                            xh0Var.a(true, true);
                        }
    ...
    public final void c(boolean z10) {
        ...
        xh0 xh0Var;
        if (this.f21490a) {
            AnimatorSet animatorSet = this.f21495r;
            if (animatorSet != null) {
                animatorSet.cancel();
            }
            boolean z11 = this.f21497w;
            float f10 = 0.0f;
            if (z11) {
                f7 = 1.0f;
            } else {
            ...
            if (z10) {
                ...
                this.f21495r = animatorSet2;
                animatorSet2.setDuration(250L);
                AnimatorSet animatorSet3 = this.f21495r;
                ...
                this.f21495r.addListener(new org.telegram.ui.t4(this, 5));
                this.f21495r.setInterpolator(new OvershootInterpolator(1.02f));
                this.f21495r.start();
                return;
            }
            if (z11) {
    ...
    public final void measureChildWithMargins(View view, int i10, int i11, int i12, int i13) {
        if (this.f21490a && view == this.f21491b) {
            i11 += Math.max(this.f21493f.getMeasuredWidth(), this.e.getMeasuredWidth());
        }
