...
public final class w extends FrameLayout implements Checkable {
    ...
    public final ii0 e;
    public final ii0 f21713f;
    public boolean h;
    public Button f21714n;
    public AnimatorSet f21715r;
    public TLRPC.StickerSetCovered f21716s;
    public v v;
    ...
    public final void a(boolean z10, boolean z11, boolean z12) {
        ...
        int i10;
        int i11;
        if (this.f21710a && this.f21717w != z10) {
            this.f21717w = z10;
            c(z11);
            if (z12 && (vVar = this.v) != null) {
                org.telegram.ui.o oVar = (org.telegram.ui.o) vVar;
                org.telegram.ui.q qVar = ((org.telegram.ui.p) oVar.f36023b).d;
                TLRPC.StickerSetCovered stickerSetCovered = (TLRPC.StickerSetCovered) oVar.f36024c;
                a0.i iVar = qVar.f36710a;
                if (z10) {
                    a(false, false, false);
                    if (iVar.h(stickerSetCovered.set.f18363id) < 0) {
                        ii0 ii0Var = this.f21713f;
                        if (ii0Var != null) {
                            ii0Var.a(true, true);
                        }
    ...
    public final void c(boolean z10) {
        ...
        ii0 ii0Var;
        if (this.f21710a) {
            AnimatorSet animatorSet = this.f21715r;
            if (animatorSet != null) {
                animatorSet.cancel();
            }
            boolean z11 = this.f21717w;
            float f10 = 0.0f;
            if (z11) {
                f7 = 1.0f;
            } else {
            ...
            if (z10) {
                ...
                this.f21715r = animatorSet2;
                animatorSet2.setDuration(250L);
                AnimatorSet animatorSet3 = this.f21715r;
                ...
                this.f21715r.addListener(new org.telegram.ui.t4(this, 5));
                this.f21715r.setInterpolator(new OvershootInterpolator(1.02f));
                this.f21715r.start();
                return;
            }
            if (z11) {
    ...
    public final void measureChildWithMargins(View view, int i10, int i11, int i12, int i13) {
        if (this.f21710a && view == this.f21711b) {
            i11 += Math.max(this.f21713f.getMeasuredWidth(), this.e.getMeasuredWidth());
        }
