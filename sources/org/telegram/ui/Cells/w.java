...
public final class w extends FrameLayout implements Checkable {
    ...
    public final TextView f21502c;
    public final org.telegram.ui.Components.u9 d;
    public final yh0 e;
    public final yh0 f21503f;
    public boolean h;
    public Button f21504n;
    public AnimatorSet f21505r;
    public TLRPC.StickerSetCovered f21506s;
    public v v;
    ...
    public final void a(boolean z10, boolean z11, boolean z12) {
        ...
        int i10;
        int i11;
        if (this.f21500a && this.f21507w != z10) {
            this.f21507w = z10;
            c(z11);
    ...
    public final void c(boolean z10) {
        ...
        yh0 yh0Var;
        if (this.f21500a) {
            AnimatorSet animatorSet = this.f21505r;
            if (animatorSet != null) {
                animatorSet.cancel();
            }
            boolean z11 = this.f21507w;
            float f10 = 0.0f;
            if (z11) {
                f7 = 1.0f;
            } else {
            ...
            if (z10) {
                ...
                this.f21505r = animatorSet2;
                animatorSet2.setDuration(250L);
                AnimatorSet animatorSet3 = this.f21505r;
                ...
                this.f21505r.addListener(new org.telegram.ui.t4(this, 5));
                this.f21505r.setInterpolator(new OvershootInterpolator(1.02f));
                this.f21505r.start();
                return;
            }
            if (z11) {
    ...
    public final void measureChildWithMargins(View view, int i10, int i11, int i12, int i13) {
        if (this.f21500a && view == this.f21501b) {
            i11 += Math.max(this.f21503f.getMeasuredWidth(), this.e.getMeasuredWidth());
        }
    ...
    public final void onDraw(Canvas canvas) {
        if (this.h) {
            canvas.drawLine(0.0f, getHeight() - 1, getWidth() - getPaddingRight(), getHeight() - 1, org.telegram.ui.ActionBar.j6.f18984k0);
        }
    }
