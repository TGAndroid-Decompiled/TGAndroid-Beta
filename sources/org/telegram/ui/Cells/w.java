...
public final class w extends FrameLayout implements Checkable {
    ...
    public final ii0 e;
    public final ii0 f21677f;
    public boolean h;
    public Button f21678n;
    public AnimatorSet f21679r;
    public TLRPC.StickerSetCovered f21680s;
    public v v;
    ...
    public final void a(boolean z10, boolean z11, boolean z12) {
        ...
        int i10;
        int i11;
        if (this.f21674a && this.f21681w != z10) {
            this.f21681w = z10;
            c(z11);
    ...
    public final void c(boolean z10) {
        ...
        ii0 ii0Var;
        if (this.f21674a) {
            AnimatorSet animatorSet = this.f21679r;
            if (animatorSet != null) {
                animatorSet.cancel();
            }
            boolean z11 = this.f21681w;
            float f10 = 0.0f;
            if (z11) {
                f7 = 1.0f;
            } else {
            ...
            if (z10) {
                ...
                this.f21679r = animatorSet2;
                animatorSet2.setDuration(250L);
                AnimatorSet animatorSet3 = this.f21679r;
                ...
                this.f21679r.addListener(new org.telegram.ui.t4(this, 5));
                this.f21679r.setInterpolator(new OvershootInterpolator(1.02f));
                this.f21679r.start();
                return;
            }
            if (z11) {
    ...
    public final void measureChildWithMargins(View view, int i10, int i11, int i12, int i13) {
        if (this.f21674a && view == this.f21675b) {
            i11 += Math.max(this.f21677f.getMeasuredWidth(), this.e.getMeasuredWidth());
        }
