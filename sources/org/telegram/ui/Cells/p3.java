...
public final class p3 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public AnimatorSet f20790n;
    public TLRPC.StickerSetCovered f20791r;
    ...
    public p3(Context context, org.telegram.ui.ActionBar.d6 d6Var) {
        ...
        float f13;
        float f14;
        this.f20786a = UserConfig.selectedAccount;
        ...
        this.f20788c = textView2;
        ok.t(textView2, org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19447z6, false), 1, 13.0f, 1);
    ...
    public final void a(TLRPC.StickerSetCovered stickerSetCovered, boolean z10, boolean z11, boolean z12) {
        ...
        AnimatorSet animatorSet = this.f20790n;
        ...
        this.f20793w = z10;
        this.f20791r = stickerSetCovered;
        setWillNotDraw(!z10);
        String str2 = this.f20791r.set.title;
        TextView textView = this.f20787b;
        ...
        this.f20788c.setText(LocaleController.formatPluralString(str, stickerSet2.count, new Object[0]));
        ...
        if (z15 && (stickerSet = stickerSetCovered.set) != null) {
            this.f20795y = Long.valueOf(stickerSet.f18348id);
            if (!this.f20794x) {
            ...
            if (stickerSet3 != null && (arrayList = stickerSet3.documents) != null && !arrayList.isEmpty()) {
                ...
                while (true) {
                    if (i11 >= stickerSet3.documents.size()) {
                        break;
                    } else if (stickerSet3.documents.get(i11).f18327id == stickerSetCovered.set.thumb_document_id) {
                ...
                if (!stickerSetCovered.covers.isEmpty()) {
                    ...
                    if (stickerSetCovered.set != null) {
                        for (int i12 = 0; i12 < stickerSetCovered.covers.size(); i12++) {
                            if (stickerSetCovered.covers.get(i12).f18327id == stickerSetCovered.set.thumb_document_id) {
                    ...
                    if (!tL_stickerSetFullCovered.documents.isEmpty()) {
                        ...
                        for (int i13 = 0; i13 < arrayList2.size(); i13++) {
                            if (arrayList2.get(i13).f18327id == stickerSetCovered.set.thumb_document_id) {
        ...
        if (document != null) {
            if (MessageObject.canAutoplayAnimatedSticker(document)) {
                ...
                SvgHelper.SvgDrawable svgThumb = DocumentObject.getSvgThumb(stickerSetCovered.set.thumbs, org.telegram.ui.ActionBar.h6.f18989a7, 1.0f);
        ...
        this.E = z11;
        if (!z11 && !MediaDataController.getInstance(i10).isStickerPackInstalled(stickerSetCovered2.set.f18348id)) {
            z13 = false;
        } else {
            z13 = true;
        }
        ...
        this.v = z14;
        rg.p0 p0Var = this.h;
        TextView textView2 = this.f20789f;
        if (z12) {
            if (z14) {
            ...
            this.f20790n = animatorSet2;
            animatorSet2.setDuration(250L);
            AnimatorSet animatorSet3 = this.f20790n;
            if (this.f20792s && !this.v) {
                f7 = 1.0f;
            } else {
                f7 = 0.0f;
            }
            ...
            this.f20790n.addListener(new n3(this));
            this.f20790n.setInterpolator(new OvershootInterpolator(1.02f));
            this.f20790n.start();
        } else if (z14) {
            p0Var.setVisibility(0);
            p0Var.setAlpha(1.0f);
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.groupStickersDidLoad) {
            ...
            if (l4 != null && l4.longValue() == longValue) {
                ...
                a(tL_stickerSetNoCovered, this.f20793w, this.E, true);
            }
        }
    }
    ...
    public final void onDetachedFromWindow() {
        ...
        if (this.f20794x) {
            NotificationCenter.getInstance(this.f20786a).removeObserver(this, NotificationCenter.groupStickersDidLoad);
            this.f20794x = false;
        }
    }
    ...
    public final void onMeasure(int i10, int i11) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i10), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(64.0f) + (this.f20793w ? 1 : 0), 1073741824));
        int measuredWidth = this.e.getMeasuredWidth();
        TextView textView = this.f20789f;
        ...
        measureChildWithMargins(this.f20787b, i10, measuredWidth, i11, 0);
    }

    public void setAddOnClickListener(View.OnClickListener onClickListener) {
        this.e.setOnClickListener(onClickListener);
        this.f20789f.setOnClickListener(onClickListener);
    }
}
