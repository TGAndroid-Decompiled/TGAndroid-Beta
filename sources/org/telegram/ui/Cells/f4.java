...
public final class f4 extends FrameLayout {
    ...
    public Drawable T;
    public Paint U;
    public final org.telegram.ui.Components.x9 f21936a;
    public final bi.j5 f21937b;
    public final org.telegram.ui.ActionBar.j5 f21938c;
    public final mp d;
    public final org.telegram.ui.Components.i9 f21939e;
    public Object f21940f;
    public CharSequence h;
    public CharSequence f21941n;
    public boolean f21942r;
    public boolean f21943s;
    public final int v;
    public final int f21944w;
    public String f21945x;
    public int f21946y;
    ...
    public static org.telegram.ui.Components.i9 a(boolean z10) {
        ...
        i9Var.f27066p = f7;
        i9Var.i(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.T7, false), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20636a8, false));
        return i9Var;
    }
    ...
    public final void c(boolean z10, boolean z11) {
        ...
        if (mpVar != null) {
            ...
            if (z11) {
                ...
                org.telegram.ui.Components.x9 x9Var = this.f21936a;
                x9Var.setScaleX(f7);
                if (!this.H) {
                    f10 = 1.0f;
                }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (e7 > 0.0f) {
            ...
            canvas.drawCircle(width, height, AndroidUtilities.dp(11.33f) * e7, org.telegram.ui.ActionBar.j6.f20976t0);
            if (this.Q == null) {
                if (this.S == null) {
                ...
                paint = this.S.f46064f;
            } else {
                if (this.U == null) {
                    this.U = new Paint();
                }
                this.U.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20675c8, f6Var));
                paint = this.U;
            }
    ...
    public final void g() {
        ...
        if (this.R) {
            ...
            } else if (this.f21940f instanceof TLRPC.User) {
                requirementToContact = MessagesController.getInstance(this.f21944w).isUserContactBlocked(((TLRPC.User) this.f21940f).f20043id);
            }
        }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.E) {
            ...
            if (this.K) {
                org.telegram.ui.ActionBar.j6.f20833l0.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20754gg, f6Var));
                canvas.drawRect(dp, getMeasuredHeight() - 1, dp2, getMeasuredHeight(), org.telegram.ui.ActionBar.j6.f20833l0);
                return;
            }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if ((obj instanceof String) && !"premium".equalsIgnoreCase((String) obj) && !"miniapps".equalsIgnoreCase((String) this.f21940f)) {
            f7 = 50.0f;
        } else {
            f7 = 58.0f;
        }
    ...
    public f4(int i10, int i11, Context context, org.telegram.ui.ActionBar.f6 f6Var, boolean z10, boolean z11) {
        super(context);
        this.f21944w = UserConfig.selectedAccount;
        ...
        this.F = i11;
        this.L = z10;
        this.f21939e = new org.telegram.ui.Components.i9((org.telegram.ui.ActionBar.f6) null);
        ...
        j5Var.setTextColor(org.telegram.ui.ActionBar.j6.v0(z11 ? org.telegram.ui.ActionBar.j6.f20881ng : org.telegram.ui.ActionBar.j6.G6, f6Var));
