...
public class q9 extends da {
    ...
    public int f20838w0;
    public int f20841z0;
    public int f20836u0 = -1;
    public int f20837v0 = -1;
    public int f20839x0 = -1;
    public int f20840y0 = -1;
    public int A0 = -1;
    ...
    public void G() {
        ...
        if (e02 == this.f20836u0 && i10 == this.f20837v0) {
            this.f20838w0 = this.f20177u;
        }
        if (e02 == this.f20839x0 && i10 == this.f20840y0) {
            this.f20841z0 = this.v;
        }
    }
    ...
    public final void O() {
        ...
        if (y()) {
            this.J0 = false;
            int i10 = this.f20839x0;
            if (i10 >= 0) {
                s4.c0 c0Var = this.E0;
                if (c0Var != null) {
                    p9Var = (p9) c0Var.m(i10);
                } else if (i10 < this.F.getChildCount()) {
                    p9Var = (p9) this.F.getChildAt(this.f20839x0);
                } else {
                    p9Var = null;
                }
                if (p9Var == null) {
                ...
                this.W = p9Var;
                if (this.f20836u0 != this.f20839x0) {
                    this.f20177u = 0;
                } else if (this.f20837v0 != this.f20840y0) {
                    this.f20177u = 0;
                } else {
                    this.f20177u = this.f20838w0;
                }
                this.v = this.f20841z0;
                ...
                int i11 = this.f20840y0;
                if (i11 >= 0 && i11 < arrayList.size()) {
                    this.f20141a = ((ba) arrayList.get(this.f20840y0)).getX();
                    this.f20143b = ((ba) arrayList.get(this.f20840y0)).getY();
                }
            }
        }
    }
    ...
    public final void P() {
        ...
        if (y()) {
            this.J0 = true;
            int i10 = this.f20836u0;
            if (i10 >= 0) {
                s4.c0 c0Var = this.E0;
                if (c0Var != null) {
                    p9Var = (p9) c0Var.m(i10);
                } else if (this.f20839x0 < this.F.getChildCount()) {
                    p9Var = (p9) this.F.getChildAt(this.f20836u0);
                } else {
                    p9Var = null;
                }
                if (p9Var == null) {
                ...
                arrayList.clear();
                ((p9) this.W).fillTextLayoutBlocks(arrayList);
                int i11 = this.f20837v0;
                if (i11 >= 0 && i11 < arrayList.size()) {
                    this.f20141a = ((ba) arrayList.get(this.f20837v0)).getX();
                    this.f20143b = ((ba) arrayList.get(this.f20837v0)).getY();
                }
            }
        }
    }
    ...
    public final void a0(Canvas canvas, p9 p9Var, int i10) {
        ...
        this.f20165o.setColor(org.telegram.ui.ActionBar.h6.v0(i11, this.f20153h0));
        this.f20167p.setColor(org.telegram.ui.ActionBar.h6.v0(i11, this.f20153h0));
        int e02 = e0(p9Var);
        if (e02 >= 0) {
            ArrayList arrayList = this.F0;
            arrayList.clear();
            ...
            if (i10 >= 0 && i10 < arrayList.size() && (baVar = (ba) arrayList.get(i10)) != null && baVar.getLayout() != null && baVar.getLayout().getText() != null) {
                int i12 = this.f20841z0;
                int length = baVar.getLayout().getText().length();
                if (i12 > length) {
                    i12 = length;
                }
                int i13 = this.f20836u0;
                if (e02 == i13 && e02 == this.f20839x0) {
                    int i14 = this.f20837v0;
                    int i15 = this.f20840y0;
                    if (i14 == i15 && i14 == i10) {
                        i(canvas, baVar.getLayout(), this.f20838w0, i12, true, true, 0.0f);
                        return;
                    } else if (i10 == i14) {
                        i(canvas, baVar.getLayout(), this.f20838w0, length, true, false, 0.0f);
                        return;
                    } else {
                        int i16 = i12;
                        if (i10 == i15) {
                ...
                int i17 = i12;
                if (e02 == i13 && this.f20837v0 == i10) {
                    i(canvas, baVar.getLayout(), this.f20838w0, length, true, false, 0.0f);
                    return;
                }
                int i18 = this.f20839x0;
                if (e02 == i18 && this.f20840y0 == i10) {
                    i(canvas, baVar.getLayout(), 0, i17, false, true, 0.0f);
                } else if ((e02 > i13 && e02 < i18) || ((e02 == i13 && i10 > this.f20837v0) || (e02 == i18 && i10 < this.f20840y0))) {
                    i(canvas, baVar.getLayout(), 0, length, false, false, 0.0f);
                }
            }
        }
    ...
    public final boolean b0() {
        int i10;
        int length;
        if (y() && this.W != null && this.f20836u0 == this.f20839x0 && (i10 = this.f20837v0) == this.f20840y0) {
            if (i10 < 0) {
                i10 = 0;
            }
            ArrayList arrayList = this.F0;
            arrayList.clear();
            ((p9) this.W).fillTextLayoutBlocks(arrayList);
            if (!arrayList.isEmpty() && i10 < arrayList.size() && (length = ((ba) arrayList.get(i10)).getLayout().getText().length()) > 0 && (this.f20838w0 > 0 || this.f20841z0 < length)) {
    ...
    public final boolean c(int i10) {
        if (this.f20836u0 == this.f20839x0 && this.f20837v0 == this.f20840y0) {
            return super.c(i10);
        }
        return true;
    }
    ...
    public final boolean c0(int i10, int i11, p9 p9Var) {
        ...
        if (this.G0 < 0) {
            this.G0 = this.f20836u0;
            this.I0 = this.f20837v0;
            this.H0 = this.f20838w0;
        }
        i0(p9Var, e02);
        int i15 = this.G0;
        int i16 = this.I0;
    ...
    public final boolean d() {
        ...
        int N0 = this.E0.N0();
        int i10 = this.f20836u0;
        if ((L0 >= i10 && L0 <= this.f20839x0) || (N0 >= i10 && N0 <= this.f20839x0)) {
            return true;
        }
        if (i10 >= L0 && this.f20839x0 <= N0) {
            return true;
        }
        return false;
    }
    ...
    public final void h0(p9 p9Var, p9 p9Var2, int i10) {
        ...
        x();
        if (this.R && (i12 = this.f20836u0) == this.f20839x0) {
            if (e02 == i12) {
                if (i10 < this.f20837v0) {
                    this.f20837v0 = i10;
                    P();
                    this.f20156j = true;
                    int i13 = this.v;
            ...
            if (e02 == i11) {
                int i15 = this.f20840y0;
                if (i10 > i15 && e02 >= this.f20839x0) {
                    this.f20839x0 = e02;
                    this.f20837v0 = i15;
                    this.f20840y0 = i10;
                    this.f20838w0 = this.f20841z0;
                    O();
                    this.f20841z0 = 0;
                    this.f20156j = false;
                } else {
                    ...
                    this.f20837v0 = i10;
                    P();
                    this.f20838w0 = this.v;
                }
            } else if (e02 <= this.f20839x0) {
                this.f20836u0 = e02;
                this.f20837v0 = i10;
                P();
                this.f20838w0 = this.v;
            ...
            int i16 = this.f20837v0;
            if (i10 < i16 && e02 <= this.f20836u0) {
                this.f20836u0 = e02;
                this.f20840y0 = i16;
                this.f20837v0 = i10;
                this.f20841z0 = this.f20838w0;
                P();
                this.f20156j = true;
                this.f20838w0 = this.v;
            } else {
    ...
    public final void j(int i10, t9 t9Var, boolean z10) {
        ...
        if (i11 >= 0 && i11 < arrayList.size()) {
            t9Var.f21233b = ((ba) arrayList.get(i11)).getLayout();
    ...
    public final boolean k0(p9 p9Var, int i10, int i11, int i12) {
        ...
        ArrayList arrayList = this.F0;
        if (!arrayList.isEmpty() && i10 >= 0 && i10 < arrayList.size()) {
            this.f20141a = ((ba) arrayList.get(i10)).getX();
            this.f20143b = ((ba) arrayList.get(i10)).getY();
        } else if (!arrayList.isEmpty()) {
            this.f20141a = ((ba) arrayList.get(0)).getX();
            this.f20143b = ((ba) arrayList.get(0)).getY();
        }
        ca caVar = this.C;
        if (caVar != null) {
            caVar.setVisibility(0);
    ...
    public final void l0(View view, int i10, int i11) {
        if (view instanceof p9) {
            ...
            ArrayList arrayList = this.F0;
            this.f20145c = ((ba) arrayList.get(d02)).getX();
    ...
    public final CharSequence s() {
        ...
        int i10 = this.f20836u0;
        while (true) {
            int i11 = this.f20839x0;
            if (i10 > i11) {
                break;
            }
            int i12 = this.f20836u0;
            SparseIntArray sparseIntArray = this.D0;
            SparseArray sparseArray = this.B0;
            SparseArray sparseArray2 = this.C0;
            if (i10 == i12) {
                int i13 = i12 == i11 ? this.f20840y0 : sparseIntArray.get(i10) - 1;
                for (int i14 = this.f20837v0; i14 <= i13; i14++) {
                    int i15 = (i14 << 16) + i10;
                    CharSequence charSequence = (CharSequence) sparseArray.get(i15);
                    if (charSequence != null) {
                        int i16 = this.f20836u0;
                        int i17 = this.f20839x0;
                        if (i16 == i17 && i14 == this.f20840y0 && i14 == this.f20837v0) {
                            int i18 = this.f20841z0;
                            int i19 = this.f20838w0;
                            if (i18 >= i19) {
                                i19 = i18;
                                i18 = i19;
                            }
                ...
                for (int i22 = 0; i22 <= this.f20840y0; i22++) {
                    int i23 = (i22 << 16) + i10;
                    CharSequence charSequence4 = (CharSequence) sparseArray.get(i23);
                    if (charSequence4 != null) {
                        if (this.f20836u0 == this.f20839x0 && i22 == this.f20840y0 && i22 == this.f20837v0) {
                            int i24 = this.f20841z0;
                            int i25 = this.f20838w0;
                ...
                for (int i28 = this.f20837v0; i28 < i27; i28++) {
                    int i29 = (i28 << 16) + i10;
            ...
            if (w9VarArr != null && w9VarArr.length > 0) {
                ...
                for (w9 w9Var : w9VarArr) {
                    ...
                    if (spanStart >= 0 && spanEnd > spanStart) {
                        CharSequence charSequence8 = w9Var.f21808a;
