...
public final class y3 extends RadialProgressView {
    ...
    public final void onDraw(Canvas canvas) {
        switch (this.K) {
            case 0:
                d4 d4Var = (d4) this.M;
                org.telegram.ui.Components.u9 u9Var = d4Var.f19921b;
                ...
                d4Var.f19932x.setProgressColor(i0.a.k(-1, (int) (u9Var.getAlpha() * u9Var.getImageReceiver().getCurrentAlpha() * 255.0f)));
                super.onDraw(canvas);
                return;
            case 1:
                ...
                if (qz0Var != null && qz0Var.getImageReceiver().hasNotThumb()) {
                    Paint paint2 = this.L;
                    paint2.setAlpha((int) (profileActivity.f31285e0.getImageReceiver().getCurrentAlpha() * 85.0f));
