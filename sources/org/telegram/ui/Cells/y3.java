...
public final class y3 extends RadialProgressView {
    ...
    public final void onDraw(Canvas canvas) {
        switch (this.K) {
            case 0:
                d4 d4Var = (d4) this.M;
                org.telegram.ui.Components.x9 x9Var = d4Var.f21758b;
                ...
                d4Var.f21770x.setProgressColor(i0.a.k(-1, (int) (x9Var.getAlpha() * x9Var.getImageReceiver().getCurrentAlpha() * 255.0f)));
                super.onDraw(canvas);
                return;
            case 1:
                ...
                if (pz0Var != null && pz0Var.getImageReceiver().hasNotThumb()) {
                    Paint paint2 = this.L;
                    paint2.setAlpha((int) (profileActivity.f33915e0.getImageReceiver().getCurrentAlpha() * 85.0f));
