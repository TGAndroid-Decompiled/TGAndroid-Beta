...
public final class y3 extends RadialProgressView {
    ...
    public final void onDraw(Canvas canvas) {
        switch (this.K) {
            case 0:
                d4 d4Var = (d4) this.M;
                org.telegram.ui.Components.u9 u9Var = d4Var.f19910b;
                ...
                d4Var.f19921x.setProgressColor(i0.a.k(-1, (int) (u9Var.getAlpha() * u9Var.getImageReceiver().getCurrentAlpha() * 255.0f)));
                super.onDraw(canvas);
                return;
            case 1:
                ...
                if (oz0Var != null && oz0Var.getImageReceiver().hasNotThumb()) {
                    Paint paint2 = this.L;
                    paint2.setAlpha((int) (profileActivity.f31268e0.getImageReceiver().getCurrentAlpha() * 85.0f));
                    canvas.drawCircle(getMeasuredWidth() / 2.0f, getMeasuredHeight() / 2.0f, getMeasuredWidth() / 2.0f, paint2);
                }
                super.onDraw(canvas);
                return;
            default:
                e91 e91Var = (e91) this.M;
                org.telegram.ui.Components.u9 u9Var2 = e91Var.F;
                if (u9Var2 != null && u9Var2.getImageReceiver().hasNotThumb()) {
                    Paint paint3 = this.L;
                    paint3.setAlpha((int) (e91Var.F.getImageReceiver().getCurrentAlpha() * 85.0f));
    ...
    public y3(e91 e91Var, Context context) {
        super(context, null);
        this.M = e91Var;
        Paint paint = new Paint(1);
        this.L = paint;
