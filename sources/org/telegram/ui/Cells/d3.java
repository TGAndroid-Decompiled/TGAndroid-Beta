...
public final class d3 extends ju {
    ...
    public final boolean a() {
        if (this.f19917a0.f20077n && super.a()) {
            return true;
        }
        return false;
    }
    ...
    public final void i(Menu menu) {
        ...
        ?? obj = new Object();
        obj.f26905a |= 8;
        spannableStringBuilder3.setSpan(new q01(obj, 0), 0, spannableStringBuilder3.length(), 33);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        super.onDraw(canvas);
        canvas.restore();
        f3 f3Var = this.f19917a0;
        org.telegram.ui.Components.m6 m6Var = f3Var.v;
        org.telegram.ui.Components.f5 f5Var = f3Var.f20078r;
        if (f5Var != null) {
            if (f3Var.f20079s <= 0) {
            ...
            m6Var.r(f5Var.a(org.telegram.ui.ActionBar.j6.v0(i10, this.V), false));
        }
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        if (drawable != this.f19917a0.v && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
