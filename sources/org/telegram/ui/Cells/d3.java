...
public final class d3 extends View {
    ...
    public final org.telegram.ui.ActionBar.f6 f20135c;

    public d3(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context);
        this.f20134b = new Paint();
        this.f20135c = f6Var;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        org.telegram.ui.ActionBar.f6 f6Var = this.f20135c;
        Paint paint = this.f20134b;
        if (z10) {
            paint.setColor(i0.a.d(0.2f, -16777216, org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19432ug, f6Var)));
        } else {
            paint.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19110d7, f6Var));
        }
