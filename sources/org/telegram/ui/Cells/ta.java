...
public final class ta implements View.OnClickListener {
    ...
    public final void onClick(View view) {
        int i10;
        int i11;
        int i12 = this.f23326a;
        int i13 = this.f23328c;
        boolean z10 = this.f23327b;
        Serializable serializable = this.f23329e;
