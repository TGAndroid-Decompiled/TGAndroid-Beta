...
public final class n0 {
    ...
    public final org.telegram.ui.Components.g9[] f20666b;
    ...
    public final u01 f20672k;
    public boolean f20673l;
    public boolean f20674m;
    public final yc f20675n;
    ...
    public n0(int i10, u1 u1Var, TLObject[] tLObjectArr, int i11) {
        ...
        this.f20666b = new org.telegram.ui.Components.g9[3];
        for (int i12 = 0; i12 < 3; i12++) {
            ...
            this.f20666b[i12] = new org.telegram.ui.Components.g9((org.telegram.ui.ActionBar.f6) null);
            if (i12 < tLObjectArr.length && (tLObject = tLObjectArr[i12]) != null) {
                ...
                int v = org.telegram.ui.ActionBar.j6.v(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19355ra, u1Var.Id), org.telegram.ui.ActionBar.j6.l1(0.5f, org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19477y6, u1Var.Id)));
                paint.setColor(v);
        ...
        if (c(this.f20676o) == null) {
            ...
            this.f20672k = new u01(hg.k0.h(i11, "+"), 9.33f, AndroidUtilities.bold());
        }
    }
    ...
    public final void b(Canvas canvas, int i10, float f7) {
        ...
        if (staticLayout == null || staticLayout.getWidth() != i10) {
            if (Build.VERSION.SDK_INT >= 23) {
                ...
                this.f20668f = uw0.c(this.e, textPaint, i10, Layout.Alignment.ALIGN_CENTER, 0.0f, false, TextUtils.TruncateAt.END, i10 - AndroidUtilities.dp(16.0f), 2, false);
            }
        }
        if (this.f20668f != null) {
            ...
            if (length <= 1) {
                ...
                textPaint.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19477y6, u1Var.Id));
            }
            textPaint.setAlpha((int) (textPaint.getAlpha() * f7));
            this.f20668f.draw(canvas);
            canvas.restore();
        }
        u01 u01Var = this.f20672k;
        if (u01Var != null) {
            u01Var.f28503p = i10 - AndroidUtilities.dp(32.0f);
    ...
    public n0(int i10, u1 u1Var, TLObject tLObject) {
        ...
        if (c(tLObject) == null) {
            ...
            this.f20672k = new u01(c(tLObject), 9.33f, AndroidUtilities.bold());
        }
    }
}
