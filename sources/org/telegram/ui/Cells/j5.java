...
public class j5 extends FrameLayout {
    public final TextView f20288a;
    public final org.telegram.ui.Components.n6 f20289b;
    ...
    public final void b(CharSequence charSequence, CharSequence charSequence2, int i10, boolean z10, int i11, boolean z11, boolean z12, boolean z13) {
        this.f20288a.setText(charSequence);
        ...
        boolean z14 = this.f20294s;
        i5 i5Var = this.e;
        i5Var.b(i11, z10, z14);
        setMultiline(z11);
        boolean z15 = this.f20292n;
        org.telegram.ui.Components.n6 n6Var = this.f20289b;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.h) {
            if (LocaleController.isRTL) {
                ...
                B = org.telegram.messenger.y0.B(76.0f, getMeasuredWidth(), 1);
            }
            canvas.drawRect(B, vl.y(22.0f, getMeasuredHeight(), 2), B + 2, AndroidUtilities.dp(22.0f) + y3, org.telegram.ui.ActionBar.i6.f18955k0);
        }
    }
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        sb2.append(this.f20288a.getText());
        if (this.f20292n) {
            TextView textView = this.f20290c;
    ...
    public final void onMeasure(int i10, int i11) {
        if (this.f20292n) {
            ...
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i10), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(this.f20293r), 1073741824));
        }
    }
    ...
    public void setValue(CharSequence charSequence) {
        if (this.f20292n) {
            this.f20290c.setText(charSequence);
        } else {
            this.f20289b.c(charSequence, true, true);
        }
    }
    ...
    public j5(int i10, int i11, Context context, org.telegram.ui.ActionBar.e6 e6Var, boolean z10) {
        ...
        int i14 = org.telegram.ui.ActionBar.i6.f19234z6;
