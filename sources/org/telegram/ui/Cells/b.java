...
public final class b implements ValueAnimator.AnimatorUpdateListener {
    public final int f21624a = 1;
    public final float f21625b;
    public final float f21626c;
    public final FrameLayout d;
    public final Object f21627e;
    public final Object f21628f;
    ...
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        switch (this.f21624a) {
            case 0:
                j jVar = (j) this.d;
                o1.e eVar = (o1.e) this.f21628f;
                FrameLayout frameLayout = jVar.J;
                Float f7 = (Float) valueAnimator.getAnimatedValue();
                float floatValue = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                float f10 = this.f21625b;
                float f11 = this.f21626c;
                AndroidUtilities.lerp(f10, f11, floatValue);
                float min = Math.min((f7.floatValue() - ((Float) ((AtomicReference) this.f21627e).getAndSet(f7)).floatValue()) * 1000.0f * 8.0f, 250.0f);
                while (min > 0.0f) {
                ...
                jVar.f22147r.setAlpha(1.0f - jVar.T);
                jVar.f22148s.setAlpha((float) Math.pow(1.0f - jVar.T, 2.0d));
                jVar.i();
                frameLayout.invalidate();
                return;
            default:
                float floatValue2 = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                float f15 = this.f21626c;
                float f16 = this.f21625b;
                ((HorizontalScrollView) this.d).setScrollX((int) com.google.android.gms.internal.vision.e2.z(f15, f16, floatValue2, f16));
                ((qj0) this.f21627e).setOutlineProgress(1.0f - floatValue2);
                ((qj0) this.f21628f).setOutlineProgress(floatValue2);
                return;
        }
    }
