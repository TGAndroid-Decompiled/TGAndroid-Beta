...
public final class ua extends FrameLayout {
    public final org.telegram.ui.Components.w9 f21430a;
    public final TextView f21431b;
    public TLRPC.TL_forumTopic f21432c;
    public boolean d;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.d) {
            ...
            if (LocaleController.isRTL) {
                canvas.drawLine(0.0f, getMeasuredHeight() - 1, getMeasuredWidth() - dp, getMeasuredHeight() - 1, org.telegram.ui.ActionBar.h6.f18910k0);
            } else {
                canvas.drawLine(dp, getMeasuredHeight() - 1, getMeasuredWidth(), getMeasuredHeight() - 1, org.telegram.ui.ActionBar.h6.f18910k0);
            }
        }
    }
    ...
    public void setTopic(TLRPC.TL_forumTopic tL_forumTopic) {
        ...
        org.telegram.ui.Components.w9 w9Var = this.f21430a;
