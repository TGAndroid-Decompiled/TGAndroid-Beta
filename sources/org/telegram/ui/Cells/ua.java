...
public final class ua implements View.OnClickListener {
    ...
    public final void onClick(View view) {
        ...
        int i14 = 0;
        boolean z14 = false;
        int i15 = this.f21654b;
        Object obj = this.d;
        Object obj2 = this.f21655c;
        switch (i13) {
            case 0:
                wa waVar = (wa) obj2;
                waVar.e.a(true, true);
            ...
            case 4:
                ...
                if (wnVar2.f39437d5 != null && i15 < arrayList.size()) {
            ...
            case 6:
                ...
                TLRPC.TL_chatBannedRights tL_chatBannedRights = gsVar.f24519w0;
                boolean z15 = !z13;
            ...
            case 7:
                m40 m40Var = (m40) obj2;
                m40Var.f26349n = i15;
                m40Var.f26346b.d(view.getLeft(), false);
                m40Var.f26347c.d(view.getRight(), false);
            ...
            case 8:
                ...
                TextView textView = ze0Var.f30855n;
            ...
            case 9:
                ...
                m2Var2.getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.channelRecommendationsLoaded, Long.valueOf(-jv0Var.f25518j1));
                m2Var2.getMessagesController().addUserToChat(chat.f18321id, m2Var2.getUserConfig().getCurrentUser(), 0, null, m2Var2, new wn0(8, st0Var, chat));
                return;
            case 10:
                ((x41) obj2).run();
            ...
            case 14:
                ...
                bundle.putLong("dialog_id", ((j41) saveToGallerySettingsActivity.f31706s.get(i15)).f34627c.dialogId);
                bundle.putInt("type", saveToGallerySettingsActivity.f31700a);
                saveToGallerySettingsActivity.presentFragment(new SaveToGallerySettingsActivity(bundle));
                return;
            case 15:
                yx yxVar = (yx) obj;
                a71 a71Var = ((z51) obj2).f40325c;
                if (!yxVar.e && !UserConfig.getInstance(a71Var.V).isPremium()) {
                    org.telegram.ui.ActionBar.m2 R2 = LaunchActivity.R();
                    if (R2 != null) {
                        R2.showDialog(new rg.x0(a71Var.f32003c1, a71Var.getContext(), a71Var.V, 11, false));
                        return;
                    }
                    return;
                }
                ...
                while (true) {
                    ...
                    if (i21 < x51Var.getChildCount()) {
                        if ((x51Var.getChildAt(i21) instanceof e61) && (R = RecyclerView.R((view2 = x51Var.getChildAt(i21)))) >= 0 && a71Var.f32051y0.get(R) == i15) {
                ...
                uv.W(null, yxVar.f30705b, false, null, null);
                a71Var.B0.add(Long.valueOf(yxVar.f30705b.f18348id));
            ...
            case 17:
                ...
                ((r8) ((View) obj2)).u(org.telegram.ui.web.o1.a().f39154a, true);
                ((Dialog) ((AtomicReference) obj).get()).dismiss();
                return;
            case 18:
                qg.s1 s1Var = (qg.s1) obj2;
                s1Var.a(i15);
                s1Var.f41905b.v().i(i15 - 1, true);
                s1Var.f41905b.b((pg.m) obj);
                return;
            case 19:
                zr0 zr0Var = (zr0) obj2;
                ...
                boolean z17 = opVar.f27163a.f22180q;
                yc a02 = yc.a0(m2Var3);
                if (z17) {
                ...
                togglechatstargiftnotifications.peer = MessagesController.getInstance(i15).getInputPeer(zr0Var.f46384c);
            ...
            case 20:
                ...
                int flag = TLObject.setFlag(k5Var.f47597g & i14, i15, !TLObject.hasFlag(i12, i15));
                if (flag == 0) {
                    flag = (~i15) & i14;
                }
                int i23 = k5Var.f47597g;
