...
public final class g2 extends FrameLayout {
    public final org.telegram.ui.ActionBar.h5 f20325a;
    ...
    public final void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        if (this.f20327c) {
            canvas.drawLine(AndroidUtilities.dp(this.d), getMeasuredHeight() - 1, AndroidUtilities.dp(23.0f) + getMeasuredWidth(), getMeasuredHeight(), org.telegram.ui.ActionBar.h6.f19181k0);
        }
    }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        float f10;
        int i14 = i12 - i10;
        org.telegram.ui.ActionBar.h5 h5Var = this.f20325a;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f20325a.measure(ok.c(94.0f, size, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), 1073741824));
