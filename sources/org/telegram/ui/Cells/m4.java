...
public final class m4 extends FrameLayout {
    ...
    public final bi.c4 f22309b;
    public final org.telegram.ui.Components.i9 f22310c;
    public int d;
    public TLRPC.User f22311e;
    public long f22312f;
    public final int h;
    public float f22313n;
    public boolean f22314r;
    public final vq f22315s;
    public final mp v;
    public final boolean f22316w;
    public boolean f22317x;
    public final org.telegram.ui.Components.e6 f22318y;

    public m4(Context context, org.telegram.ui.ActionBar.f6 f6Var, boolean z10) {
        super(context);
        this.f22310c = new org.telegram.ui.Components.i9((org.telegram.ui.ActionBar.f6) null);
        new RectF();
        this.h = UserConfig.selectedAccount;
        pr prVar = pr.h;
        this.f22318y = new org.telegram.ui.Components.e6(this, 0L, 350L, prVar);
        this.F = new org.telegram.ui.Components.e6(this, 0L, 350L, prVar);
        this.H = org.telegram.ui.ActionBar.j6.f20691d6;
        this.f22316w = z10;
        ...
        if (z10) {
            ...
            this.v = mpVar;
            mpVar.b(org.telegram.ui.ActionBar.j6.B5, org.telegram.ui.ActionBar.j6.f20762h5, org.telegram.ui.ActionBar.j6.C5);
    ...
    public final void a(long j3, String str) {
        ...
        org.telegram.ui.Components.x9 x9Var = this.f22308a;
        org.telegram.ui.Components.i9 i9Var = this.f22310c;
        int i10 = this.h;
        bi.c4 c4Var = this.f22309b;
        if (isUserDialog) {
            ...
            i9Var.m(i10, this.f22311e);
            x9Var.e(this.f22311e, i9Var);
        } else {
    ...
    public final void b(int i10) {
        ...
        int i13 = this.h;
        if (i12 != 0 && this.f22311e != null) {
            this.f22311e = MessagesController.getInstance(i13).getUser(Long.valueOf(this.f22311e.f20043id));
        ...
        if (i10 == 0 || (MessagesController.UPDATE_MASK_READ_DIALOG_MESSAGE & i10) != 0 || (i10 & MessagesController.UPDATE_MASK_NEW_MESSAGE) != 0) {
            TLRPC.Dialog dialog = (TLRPC.Dialog) MessagesController.getInstance(i13).dialogs_dict.f(this.f22312f);
            vq vqVar = this.f22315s;
            if (dialog != null && (i11 = dialog.unread_count) != 0) {
                if (this.d != i11) {
                    this.d = i11;
                    vqVar.f31990a.c(i11, this.f22314r);
                    return;
                }
                return;
            }
            this.d = 0;
            vqVar.f31990a.c(0, this.f22314r);
        }
    }
    ...
    public final void c(boolean z10) {
        ...
        boolean z11;
        if (this.f22317x && this.f22311e != null) {
            requirementToContact = MessagesController.getInstance(this.h).isUserContactBlocked(this.f22311e.f20043id);
        } else {
    ...
    public final void onDraw(Canvas canvas) {
        if (this.f22316w) {
            ...
            org.telegram.ui.ActionBar.j6.f20884o0.setColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.B5, false));
            org.telegram.ui.ActionBar.j6.f20884o0.setAlpha((int) (this.v.getProgress() * 255.0f));
            canvas.drawCircle(measuredWidth, measuredHeight, AndroidUtilities.dp(28.0f), org.telegram.ui.ActionBar.j6.f20884o0);
        }
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f22315s.f31990a.E = AndroidUtilities.dp(13.0f);
    }
}
