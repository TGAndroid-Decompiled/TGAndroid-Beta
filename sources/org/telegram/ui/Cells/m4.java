...
public final class m4 extends FrameLayout {
    ...
    public rg.z0 I;
    public Drawable J;
    public final org.telegram.ui.Components.u9 f20430a;
    public final ai.p4 f20431b;
    public final org.telegram.ui.Components.f9 f20432c;
    public int d;
    public TLRPC.User e;
    public long f20433f;
    public final int h;
    public float f20434n;
    public boolean f20435r;
    public final wq f20436s;
    public final np v;
    public final boolean f20437w;
    public boolean f20438x;
    public final org.telegram.ui.Components.c6 f20439y;

    public m4(Context context, org.telegram.ui.ActionBar.f6 f6Var, boolean z10) {
        super(context);
        this.f20432c = new org.telegram.ui.Components.f9((org.telegram.ui.ActionBar.f6) null);
        new RectF();
        this.h = UserConfig.selectedAccount;
        qr qrVar = qr.h;
        this.f20439y = new org.telegram.ui.Components.c6(this, 0L, 350L, qrVar);
        this.F = new org.telegram.ui.Components.c6(this, 0L, 350L, qrVar);
        this.H = org.telegram.ui.ActionBar.j6.f18862d6;
        this.f20437w = z10;
    ...
    public final void a(long j3, String str) {
        ...
        org.telegram.ui.Components.u9 u9Var = this.f20430a;
        org.telegram.ui.Components.f9 f9Var = this.f20432c;
        int i10 = this.h;
        ai.p4 p4Var = this.f20431b;
        if (isUserDialog) {
    ...
    public final void b(int i10) {
        ...
        if (i12 != 0 && this.e != null) {
            ...
            this.f20430a.invalidate();
            invalidate();
        }
        if (i10 == 0 || (MessagesController.UPDATE_MASK_READ_DIALOG_MESSAGE & i10) != 0 || (i10 & MessagesController.UPDATE_MASK_NEW_MESSAGE) != 0) {
            TLRPC.Dialog dialog = (TLRPC.Dialog) MessagesController.getInstance(i13).dialogs_dict.f(this.f20433f);
            wq wqVar = this.f20436s;
            if (dialog != null && (i11 = dialog.unread_count) != 0) {
                if (this.d != i11) {
                    this.d = i11;
                    wqVar.f29725a.c(i11, this.f20435r);
                    return;
                }
                return;
            }
            this.d = 0;
            wqVar.f29725a.c(0, this.f20435r);
        }
    }
    ...
    public final void onDraw(Canvas canvas) {
        if (this.f20437w) {
            ...
            org.telegram.ui.ActionBar.j6.f19058o0.setColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.B5, false));
            org.telegram.ui.ActionBar.j6.f19058o0.setAlpha((int) (this.v.getProgress() * 255.0f));
            canvas.drawCircle(measuredWidth, measuredHeight, AndroidUtilities.dp(28.0f), org.telegram.ui.ActionBar.j6.f19058o0);
        }
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f20436s.f29725a.E = AndroidUtilities.dp(13.0f);
    }
}
