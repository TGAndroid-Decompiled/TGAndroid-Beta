...
public abstract class s9 extends ea {
    public boolean A0;
    public final SparseArray f20936u0 = new SparseArray();
    public boolean f20937v0;
    public boolean f20938w0;
    public boolean f20939x0;
    public boolean f20940y0;
    public boolean f20941z0;
    ...
    public final boolean D() {
        ...
        CharSequence s10;
        String str;
        if (this.f20941z0 && (z9Var = this.W) != null && ((t1) z9Var).getMessageObject() != null && (richMessageLayout = ((t1) this.W).getMessageObject().richLayout) != null && !richMessageLayout.textBlocks.isEmpty() && (s10 = s()) != null && s10.length() != 0) {
            try {
                str = richMessageLayout.getSelectionHtml(this.f20013u, this.v);
            } catch (Exception e) {
                FileLog.e(e);
                str = null;
            }
    ...
    public final void M(z9 z9Var, z9 z9Var2) {
        ...
        this.f20014w = t1Var.getMessageObject().getId();
        try {
            int i10 = t1Var.getMessageObject().messageOwner.edit_date;
        } catch (Exception unused) {
        }
        this.U = 0.0f;
        this.f20937v0 = this.f20938w0;
        this.f20939x0 = this.f20940y0;
        this.f20941z0 = this.A0;
        int i11 = this.f20014w;
        SparseArray sparseArray = this.f20936u0;
        ...
        ofFloat.start();
        sparseArray.put(this.f20014w, ofFloat);
        if (!z10) {
    ...
    public final void X(MessageObject messageObject) {
        ...
        if (this.f20014w == messageObject.getId()) {
            f(true);
        }
    }
    ...
    public final void Y(boolean z10, StaticLayout staticLayout, Canvas canvas) {
        ...
        Paint paint = this.f20003p;
        Paint paint2 = this.f20001o;
        if (z10) {
        ...
        i(canvas, staticLayout, this.f20013u, this.v, true, true, 0.0f);
    }
    ...
    public final void Z(MessageObject messageObject, RichMessageLayout richMessageLayout, Canvas canvas) {
        ...
        Canvas canvas2;
        boolean z10;
        if (this.f20941z0 && richMessageLayout != null && (z9Var = this.W) != null && ((t1) z9Var).getMessageObject() != null && ((t1) this.W).getMessageObject().getId() == messageObject.getId()) {
            ...
            while (i12 < richMessageLayout.textBlocks.size()) {
                ...
                if (layout != null && layout.getText() != null) {
                    ...
                    int clamp = Utilities.clamp(this.f20013u - intValue, length, 0);
                    int clamp2 = Utilities.clamp(this.v - intValue, length, 0);
                    if (clamp != clamp2) {
                        boolean z11 = true;
                        if (this.f20013u >= intValue) {
                            z10 = true;
                        } else {
                            z10 = false;
                        }
    ...
    public final void b0(t1 t1Var) {
        ...
        } else if (this.f20940y0 && t1Var.getFactCheckLayout() != null) {
    ...
    public final void c0(int i10, int i11) {
        if (this.f19977a == i10 && this.f19979b == i11) {
            return;
        }
        this.f19977a = i10;
        this.f19979b = i11;
    ...
    public final void j(int i10, u9 u9Var, boolean z10) {
        ...
        int i17 = 0;
        if (this.f20937v0) {
            u9Var.f21428b = t1Var.getDescriptionlayout();
            u9Var.f21429c = 0.0f;
            u9Var.d = 0.0f;
            u9Var.f21427a = 0;
        } else if (this.f20939x0) {
            u9Var.f21428b = t1Var.getFactCheckLayout();
            u9Var.f21429c = 0.0f;
            u9Var.d = 0.0f;
            u9Var.f21427a = 0;
        } else if (this.f20941z0) {
            ...
            if (richMessageLayout != null && !richMessageLayout.textBlocks.isEmpty()) {
                ...
                u9Var.f21428b = richMessageLayout.textBlocks.get(i17).getLayout();
                u9Var.f21429c = caVar.getY();
                u9Var.d = caVar.getX();
                u9Var.f21427a = richMessageLayout.textBlockCharOffsets.get(i17).intValue();
                return;
            }
            u9Var.f21428b = null;
        } else if (t1Var.P2()) {
            ...
            if (captionLayout.textLayoutBlocks.size() == 1) {
                u9Var.f21428b = captionLayout.textLayoutBlocks.get(0).textLayout;
                u9Var.f21429c = textLayoutBlock2.padTop;
            ...
            for (int i18 = 0; i18 < captionLayout.textLayoutBlocks.size(); i18++) {
                ...
                if (i19 >= 0 && i19 <= textLayoutBlock4.textLayout.getText().length()) {
                    u9Var.f21428b = textLayoutBlock4.textLayout;
                    u9Var.f21429c = textLayoutBlock4.textYOffset(captionLayout.textLayoutBlocks) + textLayoutBlock4.padTop;
                    ...
                    u9Var.f21427a = textLayoutBlock4.charactersOffset;
                    return;
                }
            }
            u9Var.f21428b = null;
            ...
            if (arrayList == null) {
                ...
                u9Var.f21428b = messageObject.textLayoutBlocks.get(0).textLayout;
                u9Var.f21429c = textLayoutBlock.padTop;
                ...
                for (int i20 = 0; i20 < messageObject.textLayoutBlocks.size(); i20++) {
                    ...
                    if (i21 >= 0 && i21 <= textLayoutBlock6.textLayout.getText().length()) {
                        u9Var.f21428b = textLayoutBlock6.textLayout;
                        u9Var.f21429c = textLayoutBlock6.textYOffset(messageObject.textLayoutBlocks) + textLayoutBlock6.padTop;
                        ...
                        u9Var.f21427a = textLayoutBlock6.charactersOffset;
                        return;
                    }
                }
                u9Var.f21428b = null;
    ...
    public final CharSequence t(z9 z9Var, boolean z10) {
        ...
        if (t1Var != null && t1Var.getMessageObject() != null) {
            if (!z10 ? this.f20937v0 : this.f20938w0) {
                return t1Var.getDescriptionlayout().getText();
            }
            if (!z10 ? this.f20939x0 : this.f20940y0) {
                return t1Var.getFactCheckLayout().getText();
            }
            if (!z10 ? this.f20941z0 : this.A0) {
    ...
    public void x() {
        ...
        z9 z9Var2 = this.W;
        if (z9Var2 != null) {
            if (this.f20939x0 || this.f20940y0) {
                ((t1) z9Var2).a3();
            }
        }
    }
