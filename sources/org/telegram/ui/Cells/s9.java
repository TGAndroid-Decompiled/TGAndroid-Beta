...
public abstract class s9 extends ea {
    public boolean A0;
    public final SparseArray f21070u0 = new SparseArray();
    public boolean f21071v0;
    public boolean f21072w0;
    public boolean f21073x0;
    public boolean f21074y0;
    public boolean f21075z0;
    ...
    public final boolean D() {
        ...
        CharSequence s10;
        String str;
        if (this.f21075z0 && (z9Var = this.W) != null && ((u1) z9Var).getMessageObject() != null && (richMessageLayout = ((u1) this.W).getMessageObject().richLayout) != null && !richMessageLayout.textBlocks.isEmpty() && (s10 = s()) != null && s10.length() != 0) {
            try {
                str = richMessageLayout.getSelectionHtml(this.f20239u, this.v);
            } catch (Exception e) {
                FileLog.e(e);
                str = null;
            }
    ...
    public final void M(z9 z9Var, z9 z9Var2) {
        ...
        this.f20240w = u1Var.getMessageObject().getId();
        try {
            int i10 = u1Var.getMessageObject().messageOwner.edit_date;
        } catch (Exception unused) {
        }
        this.U = 0.0f;
        this.f21071v0 = this.f21072w0;
        this.f21073x0 = this.f21074y0;
        this.f21075z0 = this.A0;
        int i11 = this.f20240w;
        SparseArray sparseArray = this.f21070u0;
        ...
        ofFloat.start();
        sparseArray.put(this.f20240w, ofFloat);
        if (!z10) {
    ...
    public final void X(MessageObject messageObject) {
        ...
        if (this.f20240w == messageObject.getId()) {
            f(true);
        }
    }
    ...
    public final void Y(boolean z10, StaticLayout staticLayout, Canvas canvas) {
        ...
        Paint paint = this.f20229p;
        Paint paint2 = this.f20227o;
        if (z10) {
        ...
        i(canvas, staticLayout, this.f20239u, this.v, true, true, 0.0f);
    }
    ...
    public final void Z(MessageObject messageObject, RichMessageLayout richMessageLayout, Canvas canvas) {
        ...
        Canvas canvas2;
        boolean z10;
        if (this.f21075z0 && richMessageLayout != null && (z9Var = this.W) != null && ((u1) z9Var).getMessageObject() != null && ((u1) this.W).getMessageObject().getId() == messageObject.getId()) {
            ...
            while (i12 < richMessageLayout.textBlocks.size()) {
                ...
                if (layout != null && layout.getText() != null) {
                    ...
                    int clamp = Utilities.clamp(this.f20239u - intValue, length, 0);
                    int clamp2 = Utilities.clamp(this.v - intValue, length, 0);
                    if (clamp != clamp2) {
                        boolean z11 = true;
                        if (this.f20239u >= intValue) {
                            z10 = true;
                        } else {
                            z10 = false;
                        }
    ...
    public final void b0(u1 u1Var) {
        ...
        } else if (this.f21074y0 && u1Var.getFactCheckLayout() != null) {
    ...
    public final void c0(int i10, int i11) {
        if (this.f20203a == i10 && this.f20205b == i11) {
            return;
        }
        this.f20203a = i10;
        this.f20205b = i11;
    ...
    public final void j(int i10, u9 u9Var, boolean z10) {
        ...
        int i17 = 0;
        if (this.f21071v0) {
            u9Var.f21656b = u1Var.getDescriptionlayout();
            u9Var.f21657c = 0.0f;
            u9Var.d = 0.0f;
            u9Var.f21655a = 0;
        } else if (this.f21073x0) {
            u9Var.f21656b = u1Var.getFactCheckLayout();
            u9Var.f21657c = 0.0f;
            u9Var.d = 0.0f;
            u9Var.f21655a = 0;
        } else if (this.f21075z0) {
            ...
            if (richMessageLayout != null && !richMessageLayout.textBlocks.isEmpty()) {
                ...
                u9Var.f21656b = richMessageLayout.textBlocks.get(i17).getLayout();
                u9Var.f21657c = caVar.getY();
                u9Var.d = caVar.getX();
                u9Var.f21655a = richMessageLayout.textBlockCharOffsets.get(i17).intValue();
                return;
            }
            u9Var.f21656b = null;
        } else if (u1Var.P2()) {
            ...
            if (captionLayout.textLayoutBlocks.size() == 1) {
                u9Var.f21656b = captionLayout.textLayoutBlocks.get(0).textLayout;
                u9Var.f21657c = textLayoutBlock2.padTop;
            ...
            for (int i18 = 0; i18 < captionLayout.textLayoutBlocks.size(); i18++) {
                ...
                if (i19 >= 0 && i19 <= textLayoutBlock4.textLayout.getText().length()) {
                    u9Var.f21656b = textLayoutBlock4.textLayout;
                    u9Var.f21657c = textLayoutBlock4.textYOffset(captionLayout.textLayoutBlocks) + textLayoutBlock4.padTop;
                    ...
                    u9Var.f21655a = textLayoutBlock4.charactersOffset;
                    return;
                }
            }
            u9Var.f21656b = null;
            ...
            if (arrayList == null) {
                ...
                u9Var.f21656b = messageObject.textLayoutBlocks.get(0).textLayout;
                u9Var.f21657c = textLayoutBlock.padTop;
                ...
                for (int i20 = 0; i20 < messageObject.textLayoutBlocks.size(); i20++) {
                    ...
                    if (i21 >= 0 && i21 <= textLayoutBlock6.textLayout.getText().length()) {
                        u9Var.f21656b = textLayoutBlock6.textLayout;
                        u9Var.f21657c = textLayoutBlock6.textYOffset(messageObject.textLayoutBlocks) + textLayoutBlock6.padTop;
                        ...
                        u9Var.f21655a = textLayoutBlock6.charactersOffset;
                        return;
                    }
                }
                u9Var.f21656b = null;
    ...
    public final CharSequence t(z9 z9Var, boolean z10) {
        ...
        if (u1Var != null && u1Var.getMessageObject() != null) {
            if (!z10 ? this.f21071v0 : this.f21072w0) {
                return u1Var.getDescriptionlayout().getText();
            }
            if (!z10 ? this.f21073x0 : this.f21074y0) {
                return u1Var.getFactCheckLayout().getText();
            }
            if (!z10 ? this.f21075z0 : this.A0) {
    ...
    public void x() {
        ...
        z9 z9Var2 = this.W;
        if (z9Var2 != null) {
            if (this.f21073x0 || this.f21074y0) {
                ((u1) z9Var2).a3();
            }
        }
    }
