...
public abstract class k0 extends FrameLayout {
    ...
    public final ImageView f20517c;
    public final j0 d;
    ...
    public final void onAttachedToWindow() {
        ...
        int i10 = org.telegram.ui.ActionBar.j6.f19227m6;
        int w02 = org.telegram.ui.ActionBar.j6.w0(null, i10, false);
        PorterDuff.Mode mode = PorterDuff.Mode.MULTIPLY;
        this.f20516b.setColorFilter(new PorterDuffColorFilter(w02, mode));
        this.f20517c.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.w0(null, i10, false), mode));
    }
    ...
    public final void onMeasure(int i10, int i11) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i10), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(this.f20515a), 1073741824));
    }
