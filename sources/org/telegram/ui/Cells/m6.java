...
public final class m6 extends FrameLayout {
    ...
    public final RadioButton f19531c;
    public int d;
    ...
    public m6(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        addView(radioButton, w7.a6.d(22, 22.0f, i18, i11, 14.0f, z10 ? 18 : 0, 0.0f));
        TextView textView = new TextView(context);
        this.f19529a = textView;
        em.n(org.telegram.ui.ActionBar.j6.f18034j5, f6Var, textView, 1, 16.0f);
        textView.setLines(1);
        ...
        addView(textView, w7.a6.d(-2, -2.0f, i19, f7, 13.0f, i15, 0.0f));
        TextView textView2 = new TextView(context);
        this.f19530b = textView2;
        em.n(org.telegram.ui.ActionBar.j6.f18306y6, f6Var, textView2, 1, 14.0f);
        if (LocaleController.isRTL) {
            i16 = 5;
        } else {
            i16 = 3;
        ...
        addView(textView2, w7.a6.d(-2, -2.0f, i20, i17, 37.0f, z12 ? 51 : 21, 0.0f));
    }

    public final void a(int i10, int i11) {
        this.f19531c.b(i10, i11);
    }

    public final void b(CharSequence charSequence, boolean z10) {
        this.f19529a.setText(charSequence);
        this.f19530b.setVisibility(8);
        this.f19531c.a(z10, false);
    }
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        accessibilityNodeInfo.setChecked(this.f19531c.f21247f);
    }
