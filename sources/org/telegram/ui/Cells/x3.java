...
public abstract class x3 extends FrameLayout {
    public org.telegram.ui.ActionBar.j5 f21806a;
    public org.telegram.ui.ActionBar.j5 f21807b;
    ...
    public int h;
    public int f21810n;
    public Paint f21811r;

    public final void a(int i10, int i11) {
        org.telegram.ui.ActionBar.j5 j5Var = this.f21806a;
        j5Var.setTextColor(i11);
        j5Var.setTag(null);
        ImageView imageView = this.f21808c;
        imageView.setColorFilter(new PorterDuffColorFilter(i10, PorterDuff.Mode.MULTIPLY));
        imageView.setTag(null);
    }

    public final void b(int i10, String str, boolean z10) {
        this.f21806a.l(str, false);
        org.telegram.ui.ActionBar.j5 j5Var = this.f21807b;
        j5Var.l(null, false);
        ImageView imageView = this.f21808c;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.f21809f) {
            ...
            canvas.drawLine(dp, measuredHeight, measuredWidth - i10, getMeasuredHeight() - 1, this.f21811r);
        }
    }
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        CharSequence text = this.f21806a.getText();
        if (!TextUtils.isEmpty(text)) {
            CharSequence text2 = this.f21807b.getText();
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        int measuredWidth;
        int measuredWidth2;
        int i15 = this.f21810n;
        int i16 = this.e;
        org.telegram.ui.ActionBar.j5 j5Var = this.f21806a;
        ImageView imageView = this.d;
        ImageView imageView2 = this.f21808c;
        int i17 = i13 - i11;
        int i18 = i12 - i10;
        org.telegram.ui.ActionBar.j5 j5Var2 = this.f21807b;
    ...
    public void onMeasure(int i10, int i11) {
        ...
        org.telegram.ui.ActionBar.j5 j5Var = this.f21807b;
        int i12 = this.e;
        j5Var.measure(wh.y(i12, size, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), 1073741824));
        this.f21806a.measure(View.MeasureSpec.makeMeasureSpec((size - AndroidUtilities.dp(i12 + 71)) - j5Var.getTextWidth(), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), 1073741824));
        ImageView imageView2 = this.f21808c;
        if (imageView2.getVisibility() == 0) {
        ...
        setMeasuredDimension(size, AndroidUtilities.dp(50.0f) + (this.f21809f ? 1 : 0));
    }
