...
public abstract class x3 extends FrameLayout {
    public org.telegram.ui.ActionBar.h5 f21842a;
    public org.telegram.ui.ActionBar.h5 f21843b;
    public ImageView f21844c;
    public ImageView d;
    public int e;
    public boolean f21845f;
    public int h;
    public int f21846n;
    public Paint f21847r;

    public final void a(int i10, int i11) {
        org.telegram.ui.ActionBar.h5 h5Var = this.f21842a;
    ...
    public final void b(int i10, String str, boolean z10) {
        this.f21842a.l(str, false);
        org.telegram.ui.ActionBar.h5 h5Var = this.f21843b;
        h5Var.l(null, false);
        ImageView imageView = this.f21844c;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.f21845f) {
            ...
            canvas.drawLine(dp, measuredHeight, measuredWidth - i10, getMeasuredHeight() - 1, this.f21847r);
        }
    }
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        CharSequence text = this.f21842a.getText();
        if (!TextUtils.isEmpty(text)) {
            CharSequence text2 = this.f21843b.getText();
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        int measuredWidth;
        int measuredWidth2;
        int i15 = this.f21846n;
        int i16 = this.e;
        org.telegram.ui.ActionBar.h5 h5Var = this.f21842a;
        ImageView imageView = this.d;
        ImageView imageView2 = this.f21844c;
        int i17 = i13 - i11;
        int i18 = i12 - i10;
        org.telegram.ui.ActionBar.h5 h5Var2 = this.f21843b;
    ...
    public void onMeasure(int i10, int i11) {
        ...
        this.f21842a.measure(View.MeasureSpec.makeMeasureSpec((size - AndroidUtilities.dp(i12 + 71)) - h5Var.getTextWidth(), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), 1073741824));
        ImageView imageView2 = this.f21844c;
        if (imageView2.getVisibility() == 0) {
        ...
        setMeasuredDimension(size, AndroidUtilities.dp(50.0f) + (this.f21845f ? 1 : 0));
    }
