...
public class za extends FrameLayout implements NotificationCenter.NotificationCenterDelegate, org.telegram.ui.ActionBar.z5 {
    ...
    public boolean V;
    public boolean W;
    public final bi.i5 f23660a;
    public final org.telegram.ui.ActionBar.j5 f23661b;
    public final org.telegram.ui.ActionBar.j5 f23662c;
    public final ImageView d;
    public final mp f23663e;
    public final CheckBoxSquare f23664f;
    public final ImageView h;
    public final TextView f23665n;
    public final TextView f23666r;
    public Drawable f23667s;
    public final org.telegram.ui.Components.o5 v;
    public final org.telegram.ui.Components.o5 f23668w;
    public ImageView f23669x;
    public final org.telegram.ui.ActionBar.f6 f23670y;
    ...
    public final void a(String str, boolean z10, boolean z11, boolean z12, View.OnClickListener onClickListener) {
        int v02;
        int i10;
        TextView textView = this.f23665n;
        if (textView == null) {
            return;
        }
        org.telegram.ui.ActionBar.f6 f6Var = this.f23670y;
        if (z11) {
            ...
            v02 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20844ld, f6Var);
        }
    ...
    public final void b(int i10, int i11) {
        ...
        FrameLayout.LayoutParams layoutParams2 = (FrameLayout.LayoutParams) this.f23661b.getLayoutParams();
        boolean z10 = LocaleController.isRTL;
        int i14 = 0;
        CheckBoxSquare checkBoxSquare = this.f23664f;
        if (z10) {
        ...
        FrameLayout.LayoutParams layoutParams3 = (FrameLayout.LayoutParams) this.f23662c.getLayoutParams();
        float f15 = 28.0f;
        if (LocaleController.isRTL) {
            f12 = 28.0f;
        } else {
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.emojiLoaded) {
            this.f23661b.invalidate();
        }
    }

    @Override
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        if (this.V && view == this.f23660a) {
    ...
    public final void e(Object obj, CharSequence charSequence, CharSequence charSequence2, boolean z10) {
        org.telegram.ui.ActionBar.j5 j5Var = this.f23661b;
        if (obj == null && charSequence == null && charSequence2 == null) {
            ...
            this.G = null;
            j5Var.l("", false);
            this.f23662c.l("", false);
            this.f23660a.setImageDrawable(null);
            return;
        }
    ...
    public final void g(wk0 wk0Var, CharSequence charSequence, boolean z10) {
        ...
        String string;
        Object user;
        boolean z11 = wk0Var.f42456e;
        int i11 = this.P;
        if (z11) {
            int i12 = wk0Var.f42455c;
            if (i12 <= 0 && wk0Var.f42457f) {
            ...
            boolean z12 = wk0Var.f42454b;
            int i13 = wk0Var.f42455c;
            int i14 = wk0Var.f42453a;
            boolean z13 = true;
        ...
        if (DialogObject.isEncryptedDialog(wk0Var.d)) {
            TLRPC.EncryptedChat m10 = org.telegram.messenger.w1.m(MessagesController.getInstance(i11), wk0Var.d);
        ...
        } else if (DialogObject.isUserDialog(wk0Var.d)) {
            Object user2 = MessagesController.getInstance(i11).getUser(Long.valueOf(wk0Var.d));
            if (user2 != null) {
                e(user2, charSequence, string, z10);
            }
        } else {
            Object chat = MessagesController.getInstance(i11).getChat(Long.valueOf(-wk0Var.d));
            if (chat != null) {
    ...
    public final void i(int i10, boolean z10) {
        ...
        this.f23661b.setPadding(i11, 0, i12, 0);
        if (z10) {
            ...
            this.f23662c.setPadding(i13, 0, i10, 0);
        }
    }
    ...
    public final void j(int r20) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Cells.za.j(int):void");
    }
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        org.telegram.ui.ActionBar.j5 j5Var2 = this.f23662c;
        if (j5Var2 != null) {
    ...
    public void setAddButtonVisible(boolean z10) {
        int i10;
        TextView textView = this.f23666r;
        if (textView == null) {
            return;
        }
        if (z10) {
    ...
    public void setCallCellStyle(int i10) {
        ...
        j5Var.setLayoutParams(w7.x5.d(-1, 20.0f, i15, f7, 10.0f, f10, 0.0f));
        org.telegram.ui.ActionBar.j5 j5Var2 = this.f23662c;
        ...
        j5Var2.setLayoutParams(w7.x5.d(-1, 20.0f, i16, f11, 32.0f, f12, 0.0f));
        ...
        i5Var.setLayoutParams(w7.x5.d(44, 44.0f, i17, f13, 6.0f, f14, 0.0f));
        mp mpVar = this.f23663e;
        if (mpVar != null) {
            ...
            mpVar.setLayoutParams(w7.x5.d(24, 24.0f, i18, f15, 32.0f, f16, 0.0f));
        }
    }
    ...
    public void setCloseIcon(View.OnClickListener onClickListener) {
        ...
        if (onClickListener == null) {
            ImageView imageView = this.f23669x;
            if (imageView != null) {
        ...
        if (this.f23669x == null) {
            ImageView imageView2 = new ImageView(getContext());
            this.f23669x = imageView2;
            imageView2.setScaleType(ImageView.ScaleType.CENTER);
            w7.z5.a(this.f23669x);
            this.f23669x.setImageResource(R.drawable.ic_close_white);
            ImageView imageView3 = this.f23669x;
            ...
            ImageView imageView4 = this.f23669x;
            int v02 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20781i6, f6Var);
            int i11 = 5;
            imageView4.setBackground(org.telegram.ui.ActionBar.j6.f0(v02, 5, -1));
            ImageView imageView5 = this.f23669x;
            boolean z10 = LocaleController.isRTL;
            if (z10) {
                i11 = 3;
            }
            ...
            addView(imageView5, w7.x5.d(30, 30.0f, i12, f7, 0.0f, f10, 0.0f));
        }
        this.f23669x.setOnClickListener(onClickListener);
    }
    ...
    public void setNameTypeface(Typeface typeface) {
        this.f23661b.setTypeface(typeface);
    }
    ...
    public za(int i10, int i11, Context context, org.telegram.ui.ActionBar.f6 f6Var, boolean z10, boolean z11) {
        ...
        this.Q = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f21070y6, f6Var);
        ...
        bi.i5 i5Var = new bi.i5(this, context, 3);
        this.f23660a = i5Var;
        ...
        addView(j5Var, w7.x5.d(-1, 20.0f, i14, f10, 10.0f, f7, 0.0f));
        this.v = new org.telegram.ui.Components.o5(AndroidUtilities.dp(20.0f), j5Var);
        this.f23668w = new org.telegram.ui.Components.o5(AndroidUtilities.dp(20.0f), j5Var);
        ...
        int v02 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20855m6, f6Var);
        ...
        if (z10) {
            ...
            this.f23665n = textView2;
            w7.z5.b(textView2, 0.05f, 1.2f);
            textView2.setTextSize(1, 14.0f);
            textView2.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f21011uh, f6Var));
