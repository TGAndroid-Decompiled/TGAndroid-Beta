...
public class za extends FrameLayout implements NotificationCenter.NotificationCenterDelegate, org.telegram.ui.ActionBar.z5 {
    ...
    public boolean V;
    public boolean W;
    public final ai.z5 f21891a;
    public final org.telegram.ui.ActionBar.j5 f21892b;
    public final org.telegram.ui.ActionBar.j5 f21893c;
    public final ImageView d;
    public final np e;
    public final CheckBoxSquare f21894f;
    public final ImageView h;
    public final TextView f21895n;
    public final TextView f21896r;
    public Drawable f21897s;
    public final org.telegram.ui.Components.o5 v;
    public final org.telegram.ui.Components.o5 f21898w;
    public ImageView f21899x;
    public final org.telegram.ui.ActionBar.e6 f21900y;
    ...
    public final void a(String str, boolean z10, boolean z11, boolean z12, View.OnClickListener onClickListener) {
        int v02;
        int i10;
        TextView textView = this.f21895n;
        if (textView == null) {
            return;
        }
        org.telegram.ui.ActionBar.e6 e6Var = this.f21900y;
        if (z11) {
            v02 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Dh, e6Var);
        } else if (z10) {
            v02 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Ch, e6Var);
        } else if (z12 && TextUtils.isEmpty(str)) {
            v02 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Oh, e6Var);
        } else {
            v02 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19215ld, e6Var);
        }
    ...
    public final void b(int i10, int i11) {
        ...
        FrameLayout.LayoutParams layoutParams2 = (FrameLayout.LayoutParams) this.f21892b.getLayoutParams();
        boolean z10 = LocaleController.isRTL;
        int i14 = 0;
        CheckBoxSquare checkBoxSquare = this.f21894f;
        if (z10) {
        ...
        FrameLayout.LayoutParams layoutParams3 = (FrameLayout.LayoutParams) this.f21893c.getLayoutParams();
        float f15 = 28.0f;
        if (LocaleController.isRTL) {
            f12 = 28.0f;
        } else {
    ...
    public final void d(Object obj, CharSequence charSequence, CharSequence charSequence2, boolean z10) {
        org.telegram.ui.ActionBar.j5 j5Var = this.f21892b;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.emojiLoaded) {
            this.f21892b.invalidate();
        }
    }

    @Override
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        if (this.V && view == this.f21891a) {
    ...
    public final void g(vk0 vk0Var, CharSequence charSequence, boolean z10) {
        ...
        int i11 = this.P;
        if (z11) {
            int i12 = vk0Var.f38592c;
            if (i12 <= 0 && vk0Var.f38593f) {
            ...
            boolean z12 = vk0Var.f38591b;
            int i13 = vk0Var.f38592c;
            int i14 = vk0Var.f38590a;
            boolean z13 = true;
        ...
        if (DialogObject.isEncryptedDialog(vk0Var.d)) {
            TLRPC.EncryptedChat m10 = org.telegram.messenger.q.m(MessagesController.getInstance(i11), vk0Var.d);
    ...
    public final void i(int i10, boolean z10) {
        ...
        this.f21892b.setPadding(i11, 0, i12, 0);
        if (z10) {
            ...
            this.f21893c.setPadding(i13, 0, i10, 0);
        }
    }
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (checkBoxSquare != null && checkBoxSquare.getVisibility() == 0) {
            ...
            if (npVar != null && npVar.getVisibility() == 0) {
                accessibilityNodeInfo.setCheckable(true);
                accessibilityNodeInfo.setChecked(npVar.f26739a.f22158q);
                accessibilityNodeInfo.setClassName("android.widget.CheckBox");
            }
        }
        ...
        org.telegram.ui.ActionBar.j5 j5Var2 = this.f21893c;
        if (j5Var2 != null) {
    ...
    public void setAddButtonVisible(boolean z10) {
        int i10;
        TextView textView = this.f21896r;
        if (textView == null) {
            return;
        }
        if (z10) {
    ...
    public void setCallCellStyle(int i10) {
        ...
        z5Var.setLayoutParams(w7.y5.d(44, 44.0f, i17, f13, 6.0f, f14, 0.0f));
        np npVar = this.e;
        if (npVar != null) {
            ...
            npVar.setLayoutParams(w7.y5.d(24, 24.0f, i18, f15, 32.0f, f16, 0.0f));
        }
    }
    ...
    public void setCloseIcon(View.OnClickListener onClickListener) {
        ...
        if (onClickListener == null) {
            ImageView imageView = this.f21899x;
            if (imageView != null) {
        ...
        if (this.f21899x == null) {
            ...
            this.f21899x = imageView2;
            imageView2.setScaleType(ImageView.ScaleType.CENTER);
            w7.a6.a(this.f21899x);
            this.f21899x.setImageResource(R.drawable.ic_close_white);
            ImageView imageView3 = this.f21899x;
            ...
            ImageView imageView4 = this.f21899x;
            ...
            ImageView imageView5 = this.f21899x;
            boolean z10 = LocaleController.isRTL;
            if (z10) {
                i11 = 3;
            }
        ...
        this.f21899x.setOnClickListener(onClickListener);
    }
    ...
    public za(int i10, int i11, Context context, org.telegram.ui.ActionBar.e6 e6Var, boolean z10, boolean z11) {
        ...
        this.Q = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19445y6, e6Var);
        ...
        this.f21898w = new org.telegram.ui.Components.o5(AndroidUtilities.dp(20.0f), j5Var);
        ...
        int v02 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19227m6, e6Var);
        ...
        if (z10) {
            ...
            this.f21895n = textView2;
            w7.a6.b(textView2, 0.05f, 1.2f);
            textView2.setTextSize(1, 14.0f);
            textView2.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19386uh, e6Var));
