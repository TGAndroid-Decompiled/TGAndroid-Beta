...
public class za extends FrameLayout implements NotificationCenter.NotificationCenterDelegate, org.telegram.ui.ActionBar.x5 {
    ...
    public boolean V;
    public boolean W;
    public final ai.y5 f21912a;
    public final org.telegram.ui.ActionBar.h5 f21913b;
    public final org.telegram.ui.ActionBar.h5 f21914c;
    public final ImageView d;
    public final op e;
    public final CheckBoxSquare f21915f;
    public final ImageView h;
    public final TextView f21916n;
    public final TextView f21917r;
    public Drawable f21918s;
    public final org.telegram.ui.Components.o5 v;
    public final org.telegram.ui.Components.o5 f21919w;
    public ImageView f21920x;
    public final org.telegram.ui.ActionBar.d6 f21921y;
    ...
    public final void a(String str, boolean z10, boolean z11, boolean z12, View.OnClickListener onClickListener) {
        ...
        org.telegram.ui.ActionBar.d6 d6Var = this.f21921y;
        if (z11) {
            ...
            v02 = org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19197ld, d6Var);
        }
    ...
    public final void b(int i10, int i11) {
        ...
        FrameLayout.LayoutParams layoutParams2 = (FrameLayout.LayoutParams) this.f21913b.getLayoutParams();
        boolean z10 = LocaleController.isRTL;
        int i14 = 0;
        CheckBoxSquare checkBoxSquare = this.f21915f;
        if (z10) {
        ...
        FrameLayout.LayoutParams layoutParams3 = (FrameLayout.LayoutParams) this.f21914c.getLayoutParams();
        float f15 = 28.0f;
        if (LocaleController.isRTL) {
            f12 = 28.0f;
        } else {
    ...
    public final void d(Object obj, CharSequence charSequence, CharSequence charSequence2, boolean z10) {
        org.telegram.ui.ActionBar.h5 h5Var = this.f21913b;
        if (obj == null && charSequence == null && charSequence2 == null) {
            ...
            this.G = null;
            h5Var.l("", false);
            this.f21914c.l("", false);
            this.f21912a.setImageDrawable(null);
            return;
        }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.emojiLoaded) {
            this.f21913b.invalidate();
        }
    }

    @Override
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        if (this.V && view == this.f21912a) {
    ...
    public final void g(nk0 nk0Var, CharSequence charSequence, boolean z10) {
        ...
        int i11 = this.P;
        if (z11) {
            int i12 = nk0Var.f35896c;
            if (i12 <= 0 && nk0Var.f35897f) {
            ...
            boolean z12 = nk0Var.f35895b;
            int i13 = nk0Var.f35896c;
            int i14 = nk0Var.f35894a;
            boolean z13 = true;
    ...
    public final void i(int i10, boolean z10) {
        ...
        this.f21913b.setPadding(i11, 0, i12, 0);
        if (z10) {
            ...
            this.f21914c.setPadding(i13, 0, i10, 0);
        }
    }
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (checkBoxSquare != null && checkBoxSquare.getVisibility() == 0) {
            ...
            if (opVar != null && opVar.getVisibility() == 0) {
                accessibilityNodeInfo.setCheckable(true);
                accessibilityNodeInfo.setChecked(opVar.f27163a.f22180q);
                accessibilityNodeInfo.setClassName("android.widget.CheckBox");
            }
        }
        ...
        org.telegram.ui.ActionBar.h5 h5Var2 = this.f21914c;
        if (h5Var2 != null) {
    ...
    public void setAddButtonVisible(boolean z10) {
        int i10;
        TextView textView = this.f21917r;
        if (textView == null) {
            return;
        }
        if (z10) {
    ...
    public void setCallCellStyle(int i10) {
        ...
        if (opVar != null) {
            ...
            opVar.setLayoutParams(w7.y5.d(24, 24.0f, i18, f15, 32.0f, f16, 0.0f));
        }
    }
    ...
    public void setCloseIcon(View.OnClickListener onClickListener) {
        ...
        if (onClickListener == null) {
            ImageView imageView = this.f21920x;
            if (imageView != null) {
        ...
        if (this.f21920x == null) {
            ...
            this.f21920x = imageView2;
            imageView2.setScaleType(ImageView.ScaleType.CENTER);
            w7.a6.a(this.f21920x);
            this.f21920x.setImageResource(R.drawable.ic_close_white);
            ImageView imageView3 = this.f21920x;
            ...
            ImageView imageView4 = this.f21920x;
            ...
            ImageView imageView5 = this.f21920x;
            boolean z10 = LocaleController.isRTL;
            if (z10) {
                i11 = 3;
            }
        ...
        this.f21920x.setOnClickListener(onClickListener);
    }
    ...
    public za(int i10, int i11, Context context, org.telegram.ui.ActionBar.d6 d6Var, boolean z10, boolean z11) {
        ...
        this.Q = org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19428y6, d6Var);
        ...
        this.f21919w = new org.telegram.ui.Components.o5(AndroidUtilities.dp(20.0f), h5Var);
        ...
        int v02 = org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19209m6, d6Var);
        ...
        if (z10) {
            ...
            this.f21916n = textView2;
            w7.a6.b(textView2, 0.05f, 1.2f);
            textView2.setTextSize(1, 14.0f);
            textView2.setTextColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19369uh, d6Var));
