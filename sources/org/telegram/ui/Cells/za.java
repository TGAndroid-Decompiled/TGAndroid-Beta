...
public final class za extends FrameLayout {
    public final org.telegram.ui.Components.u9 f21719a;
    public final ai.a6 f21720b;
    public final org.telegram.ui.ActionBar.k5 f21721c;
    public final ImageView d;
    public final org.telegram.ui.Components.f9 e;
    public TLObject f21722f;
    public CharSequence h;
    public int f21723n;
    public String f21724r;
    public final int f21725s;
    public final int v;
    public final int f21726w;
    ...
    public za(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        float f15;
        float f16;
        this.f21725s = UserConfig.selectedAccount;
        this.v = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19245y6, f6Var);
        this.f21726w = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19048n6, f6Var);
        ...
        imageView.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19028m6, f6Var), PorterDuff.Mode.MULTIPLY));
    ...
    public final void a(TLObject tLObject, String str) {
        if (tLObject == null && str == null) {
            ...
            this.f21722f = null;
            this.f21720b.k("");
            this.f21721c.l("", false);
            this.f21719a.setImageDrawable(null);
            return;
        }
        this.h = str;
        this.f21722f = tLObject;
        b();
    }
    ...
    public final void b() {
        ...
        float f7;
        TLObject tLObject = this.f21722f;
        ...
        if (user != null) {
            ...
            f9Var.n(this.f21723n, "#", null);
        }
        if (user != null) {
            this.f21724r = UserObject.getUserName(user);
        } else {
            this.f21724r = chat.title;
        }
        this.f21720b.k(this.f21724r);
        CharSequence charSequence = this.h;
        int i11 = this.v;
        org.telegram.ui.Components.u9 u9Var = this.f21719a;
        org.telegram.ui.ActionBar.k5 k5Var = this.f21721c;
        if (charSequence != null) {
            ...
            if (user.bot) {
                ...
                k5Var.setTextColor(this.f21726w);
    ...
    public void setNameTypeface(Typeface typeface) {
        this.f21720b.setTypeface(typeface);
    }
