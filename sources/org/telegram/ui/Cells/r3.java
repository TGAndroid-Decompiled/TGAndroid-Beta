...
public final class r3 extends FrameLayout {
    ...
    public TLRPC.StickerSetCovered f20804f;
    ...
    public r3(int i10, Context context, org.telegram.ui.ActionBar.f6 f6Var, boolean z10, boolean z11) {
        ...
        this.f20808w = UserConfig.selectedAccount;
        this.f20809x = new Paint(1);
        this.f20801a = z11;
        this.I = f6Var;
    ...
    public static void a(ArrayList arrayList, ml0 ml0Var, org.telegram.ui.ActionBar.k6 k6Var) {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(ml0Var, 0, new Class[]{r3.class}, org.telegram.ui.ActionBar.j6.f18985k0, null, null, org.telegram.ui.ActionBar.j6.f18864d7));
    ...
    public final void c(TLRPC.StickerSetCovered stickerSetCovered, boolean z10, boolean z11, int i10, int i11, boolean z12) {
        ...
        float f15 = 0.0f;
        if (this.f20804f != stickerSetCovered) {
            if (z10) {
                f14 = 1.0f;
            } else {
                f14 = 0.0f;
        ...
        this.f20804f = stickerSetCovered;
        this.f20810y = i10;
        this.E = i11;
        if (i11 != 0) {
            e();
        } else {
            this.f20802b.setText(stickerSetCovered.set.title);
        }
        ...
        this.v = z10;
        if (this.f20801a) {
            boolean z15 = this.f20807s;
            yh0 yh0Var = this.d;
            if (z15) {
                yh0Var.setVisibility(0);
                if (!z12 && !MediaDataController.getInstance(this.f20808w).isStickerPackInstalled(stickerSetCovered.set.f18148id)) {
                    z13 = false;
                } else {
                    z13 = true;
                }
    ...
    public final void e() {
        if (this.E != 0) {
            SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(this.f20804f.set.title);
            try {
        ...
        if (z10 || this.H != 0.0f) {
            if (z10) {
                ...
                if (f7 != 1.0f) {
                    ...
                    Paint paint = this.f20809x;
                    paint.setColor(v02);
                    canvas.drawCircle(AndroidUtilities.dp(12.0f) + this.f20802b.getRight(), AndroidUtilities.dp(20.0f), AndroidUtilities.dp(4.0f) * this.H, paint);
                }
            }
            if (!z10) {
                float f11 = this.H;
            ...
            Paint paint2 = this.f20809x;
            paint2.setColor(v022);
            canvas.drawCircle(AndroidUtilities.dp(12.0f) + this.f20802b.getRight(), AndroidUtilities.dp(20.0f), AndroidUtilities.dp(4.0f) * this.H, paint2);
        }
        if (this.f20805n) {
