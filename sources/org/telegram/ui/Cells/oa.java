...
public final class oa extends FrameLayout {
    public final org.telegram.ui.Components.p9 f23321a;
    public final TextView f23322b;
    public TLRPC.TL_forumTopic f23323c;
    public boolean d;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.d) {
            ...
            if (LocaleController.isRTL) {
                canvas.drawLine(0.0f, getMeasuredHeight() - 1, getMeasuredWidth() - dp, getMeasuredHeight() - 1, org.telegram.ui.ActionBar.k6.f21779k0);
            } else {
                canvas.drawLine(dp, getMeasuredHeight() - 1, getMeasuredWidth(), getMeasuredHeight() - 1, org.telegram.ui.ActionBar.k6.f21779k0);
            }
        }
    }
    ...
    public void setTopic(TLRPC.TL_forumTopic tL_forumTopic) {
        ...
        org.telegram.ui.Components.p9 p9Var = this.f23321a;
        ...
        if (p9Var != null && p9Var.getImageReceiver() != null && (p9Var.getImageReceiver().getDrawable() instanceof bg.d)) {
            ((bg.d) p9Var.getImageReceiver().getDrawable()).a(org.telegram.ui.ActionBar.k6.w0(null, org.telegram.ui.ActionBar.k6.f21644c9, false));
        }
    }
}
