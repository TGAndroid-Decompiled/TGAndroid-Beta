...
public final class z8 extends FrameLayout {
    ...
    public static final int[] f21681f = {-65536, -29183, -256, -16711936, -16711681, -16776961, -2984711, -65281, -1};
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.f21683b) {
            ...
            canvas2 = canvas;
            canvas2.drawLine(dp, measuredHeight, measuredWidth2 - i10, getMeasuredHeight() - 1, org.telegram.ui.ActionBar.h6.f18910k0);
        } else {
            canvas2 = canvas;
        }
        int i11 = this.f21684c;
        if (i11 != 0) {
            d.setColor(i11);
            if (LocaleController.isRTL) {
    ...
    public final void onMeasure(int i10, int i11) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i10), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(50.0f) + (this.f21683b ? 1 : 0), 1073741824));
    }
}
