...
public class z8 extends FrameLayout {
    public final TextView f24498a;
    public final TextView f24499b;
    public final ImageView f24500c;
    public boolean d;
    ...
    public final void a(String str, String str2, boolean z4) {
        this.f24498a.setText(str);
        this.f24499b.setText(str2);
        this.d = z4;
        this.f24500c.setVisibility(8);
        setWillNotDraw(!z4);
    }
    ...
    public final void b(int i10, String str, String str2, boolean z4) {
        ...
        int i12;
        int i13;
        TextView textView = this.f24498a;
        textView.setText(str);
        TextView textView2 = this.f24499b;
        textView2.setText(str2);
        ImageView imageView = this.f24500c;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float dp;
        int i10;
        if (this.d && org.telegram.ui.ActionBar.k6.f21781k0 != null) {
    ...
    public void setMultilineDetail(boolean z4) {
        this.f24501e = z4;
        TextView textView = this.f24499b;
        if (z4) {
            textView.setLines(0);
    ...
    public void setValue(CharSequence charSequence) {
        this.f24499b.setText(charSequence);
    }
}
