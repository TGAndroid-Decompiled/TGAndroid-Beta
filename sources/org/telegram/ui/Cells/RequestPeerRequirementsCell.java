        ...
        if (this.requestPeerType != requestPeerType) {
            ...
            if (requestPeerType instanceof TLRPC.TL_requestPeerTypeUser) {
                ...
                if (bool5 == null || !bool5.booleanValue()) {
                    ...
                    int i = R.string.PeerRequirementUserRights;
                    int i2 = R.string.PeerRequirementUserRight;
                    SpannableStringBuilder spannableStringBuilderReplaceTags = AndroidUtilities.replaceTags(LocaleController.getString(i));
                    SpannableStringBuilder spannableStringBuilderReplaceTags2 = AndroidUtilities.replaceTags(LocaleController.getString(i2));
                    if (tL_chatAdminRights != null) {
                        ArrayList arrayList2 = new ArrayList();
                        if (tL_chatAdminRights.change_info) {
                            zzks.m(z ? LocaleController.getString(R.string.EditAdminChangeChannelInfo) : LocaleController.getString(R.string.EditAdminChangeGroupInfo), arrayList2);
                        }
                        if (tL_chatAdminRights.post_messages && z) {
                            zzks.m(LocaleController.getString(R.string.EditAdminPostMessages), arrayList2);
                        }
                        if (tL_chatAdminRights.edit_messages && z) {
                            zzks.m(LocaleController.getString(R.string.EditAdminEditMessages), arrayList2);
                        }
                        if (tL_chatAdminRights.delete_messages) {
                            zzks.m(LocaleController.getString(z ? R.string.EditAdminDeleteMessages : R.string.EditAdminGroupDeleteMessages), arrayList2);
                        }
                        if (tL_chatAdminRights.ban_users && !z) {
                            zzks.m(LocaleController.getString(R.string.EditAdminBanUsers), arrayList2);
                        }
                        if (tL_chatAdminRights.invite_users) {
                            zzks.m(LocaleController.getString(R.string.EditAdminAddUsers), arrayList2);
                        }
                        if (tL_chatAdminRights.pin_messages && !z) {
                            zzks.m(LocaleController.getString(R.string.EditAdminPinMessages), arrayList2);
                        }
                        if (tL_chatAdminRights.add_admins) {
                            zzks.m(LocaleController.getString(R.string.EditAdminAddAdmins), arrayList2);
                        }
                        if (tL_chatAdminRights.anonymous && !z) {
                            zzks.m(LocaleController.getString(R.string.EditAdminSendAnonymously), arrayList2);
                        }
                        if (tL_chatAdminRights.manage_call) {
                            zzks.m(LocaleController.getString(R.string.StartVoipChatPermission), arrayList2);
                        }
                        if (tL_chatAdminRights.manage_topics && !z) {
                            zzks.m(LocaleController.getString(R.string.ManageTopicsPermission), arrayList2);
                        }
                        if (arrayList2.size() == 1) {
                            ...
                            for (int i3 = 0; i3 < arrayList2.size(); i3++) {
                                ...
                                spannableStringBuilderValueOf.append((CharSequence) ((Requirement) arrayList2.get(i3)).text.toString().toLowerCase());
                            }
                            spannableStringBuilderValueOf.append((CharSequence) ".");
            ...
            headerCell.setBackgroundColor(Theme.getColor(null, i4, false));
            addView(headerCell, LayoutHelper.createLinear(-1, -2));
            Drawable colorDrawable = new ColorDrawable(Theme.getColor(null, i4, false));
            View fixedHeightEmptyCell = new FixedHeightEmptyCell(getContext(), 9, 1);
            ...
            View fixedHeightEmptyCell2 = new FixedHeightEmptyCell(getContext(), 12, 1);
            ...
            View fixedHeightEmptyCell3 = new FixedHeightEmptyCell(getContext(), 12, 1);
