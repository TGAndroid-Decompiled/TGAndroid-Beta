...
public final class h3 extends cu {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        j3 j3Var = this.f20376f;
        org.telegram.ui.Components.o6 o6Var = j3Var.v;
        org.telegram.ui.Components.h5 h5Var = j3Var.f20481r;
        if (j3Var.f20482s <= 0) {
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        if (drawable != this.f20376f.v && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
