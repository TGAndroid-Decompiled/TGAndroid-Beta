...
public final class g9 extends FrameLayout {
    ...
    public final void b(String str, String str2, boolean z10) {
        ...
        TextView textView2 = this.f20353b;
        textView2.setText(str2);
        this.f20354c.a(false, false);
        this.d = z10;
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        RadioButton radioButton = this.f20354c;
        accessibilityNodeInfo.setChecked(radioButton.f22370f);
        if (radioButton.f22370f) {
        ...
        sb2.append(this.f20352a.getText());
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.f20353b.getVisibility() == 0) {
            f7 = 64.0f;
        } else {
            f7 = this.e;
        }
