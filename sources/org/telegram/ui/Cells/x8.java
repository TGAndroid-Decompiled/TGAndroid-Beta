...
public class x8 extends FrameLayout {
    ...
    public int f21873n;
    public int f21874r;
    public float f21875s;
    public Paint v;
    public float f21876w;
    public ObjectAnimator f21877x;
    ...
    public void setAnimationProgress(float f7) {
        ...
        float max = (Math.max(lastTouchX, getMeasuredWidth() - lastTouchX) + AndroidUtilities.dp(40.0f)) * this.f21875s;
        Switch r22 = this.e;
        r22.R = lastTouchX;
    ...
    public final void b(int i10, boolean z10) {
        ObjectAnimator objectAnimator = this.f21877x;
        if (objectAnimator != null) {
            objectAnimator.cancel();
            this.f21877x = null;
        }
        int i11 = this.f21874r;
        if (i11 != 0) {
        ...
        this.f21877x = ofFloat;
        ofFloat.addListener(new v8(this, i10, 0));
        this.f21877x.setInterpolator(qr.f27654g);
        this.f21877x.setDuration(240L).start();
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.f21874r != 0) {
            float lastTouchX = getLastTouchX();
            canvas.drawCircle(lastTouchX, getMeasuredHeight() / 2, (Math.max(lastTouchX, getMeasuredWidth() - lastTouchX) + AndroidUtilities.dp(40.0f)) * this.f21875s, this.v);
        }
        if (this.f21872f) {
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        sb2.append(this.f21871c.getText());
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        super.onMeasure(makeMeasureSpec, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(f7) + (this.f21872f ? 1 : 0), 1073741824));
    }

    @Override
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        this.f21876w = motionEvent.getX();
    ...
    public x8(int i10, Context context, org.telegram.ui.ActionBar.f6 f6Var, boolean z10) {
        ...
        rk.n(z10 ? org.telegram.ui.ActionBar.j6.f19216j5 : org.telegram.ui.ActionBar.j6.G6, f6Var, textView, 1, 16.0f);
        textView.setLines(1);
        ...
        this.d = textView2;
        rk.n(z10 ? org.telegram.ui.ActionBar.j6.J5 : org.telegram.ui.ActionBar.j6.f19511z6, f6Var, textView2, 1, 13.0f);
