...
public final class x8 extends FrameLayout {
    public final TextView f21851a;
    public final TextView f21852b;
    public final op f21853c;
    public boolean d;
    public boolean e;
    public int f21854f;
    public float h;
    ...
    public void setAnimationProgress(float f7) {
        this.h = f7;
        Math.max(this.f21855n, getMeasuredWidth() - this.f21855n);
        AndroidUtilities.dp(40.0f);
        getMeasuredHeight();
    }

    public final void b(String str, String str2, boolean z10, boolean z11) {
        TextView textView = this.f21851a;
        textView.setText(str);
        TextView textView2 = this.f21852b;
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        accessibilityNodeInfo.setChecked(this.f21853c.f27168a.f22195q);
        StringBuilder sb2 = new StringBuilder();
        sb2.append(this.f21851a.getText());
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.f21852b.getVisibility() == 0) {
            f7 = 64.0f;
        } else {
            f7 = this.f21854f;
        }
    ...
    public void setTypeface(Typeface typeface) {
        this.f21851a.setTypeface(typeface);
    }
}
