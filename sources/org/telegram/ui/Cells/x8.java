...
public class x8 extends FrameLayout {
    ...
    public int f21605n;
    public int f21606r;
    public float f21607s;
    public Paint v;
    public float f21608w;
    public ObjectAnimator f21609x;
    ...
    public void setAnimationProgress(float f7) {
        ...
        float max = (Math.max(lastTouchX, getMeasuredWidth() - lastTouchX) + AndroidUtilities.dp(40.0f)) * this.f21607s;
        Switch r22 = this.e;
        r22.R = lastTouchX;
    ...
    public final void b(int i10, boolean z10) {
        ObjectAnimator objectAnimator = this.f21609x;
        if (objectAnimator != null) {
            objectAnimator.cancel();
            this.f21609x = null;
        }
        int i11 = this.f21606r;
        if (i11 != 0) {
        ...
        this.f21609x = ofFloat;
        ofFloat.addListener(new v8(this, i10, 0));
        this.f21609x.setInterpolator(rr.f27702g);
        this.f21609x.setDuration(240L).start();
    }
    ...
    public final void c(int i10, int i11) {
        ...
        if (this.G == null) {
            ...
            TextView textView = this.f21603c;
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.f21606r != 0) {
            float lastTouchX = getLastTouchX();
            canvas.drawCircle(lastTouchX, getMeasuredHeight() / 2, (Math.max(lastTouchX, getMeasuredWidth() - lastTouchX) + AndroidUtilities.dp(40.0f)) * this.f21607s, this.v);
        }
        if (this.f21604f) {
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        sb2.append(this.f21603c.getText());
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        super.onMeasure(makeMeasureSpec, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(f7) + (this.f21604f ? 1 : 0), 1073741824));
    }

    @Override
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        this.f21608w = motionEvent.getX();
    ...
    public void setTypeface(Typeface typeface) {
        this.f21603c.setTypeface(typeface);
    }
    ...
    public x8(int i10, Context context, org.telegram.ui.ActionBar.d6 d6Var, boolean z10) {
        ...
        ul.o(z10 ? org.telegram.ui.ActionBar.h6.f18895j5 : org.telegram.ui.ActionBar.h6.G6, d6Var, textView, 1, 16.0f);
        textView.setLines(1);
        ...
        this.d = textView2;
        ul.o(z10 ? org.telegram.ui.ActionBar.h6.J5 : org.telegram.ui.ActionBar.h6.f19189z6, d6Var, textView2, 1, 13.0f);
