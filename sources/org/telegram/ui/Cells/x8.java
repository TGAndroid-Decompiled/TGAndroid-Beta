...
public class x8 extends FrameLayout {
    ...
    public int f21858n;
    public int f21859r;
    public float f21860s;
    public Paint v;
    public float f21861w;
    public ObjectAnimator f21862x;
    ...
    public void setAnimationProgress(float f7) {
        ...
        float max = (Math.max(lastTouchX, getMeasuredWidth() - lastTouchX) + AndroidUtilities.dp(40.0f)) * this.f21860s;
        Switch r22 = this.e;
        r22.R = lastTouchX;
    ...
    public final void b(int i10, boolean z10) {
        ObjectAnimator objectAnimator = this.f21862x;
        if (objectAnimator != null) {
            objectAnimator.cancel();
            this.f21862x = null;
        }
        int i11 = this.f21859r;
        if (i11 != 0) {
        ...
        this.f21862x = ofFloat;
        ofFloat.addListener(new v8(this, i10, 0));
        this.f21862x.setInterpolator(qr.f27643g);
        this.f21862x.setDuration(240L).start();
    }
    ...
    public final void c(int i10, int i11) {
        ...
        if (this.G == null) {
            ...
            addView(kj0Var, w7.y5.d(29, 29.0f, i12 | 16, 19.0f, 0.0f, 19.0f, 0.0f));
            this.E = AndroidUtilities.dp(65.0f);
            TextView textView = this.f21856c;
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.f21859r != 0) {
            float lastTouchX = getLastTouchX();
            canvas.drawCircle(lastTouchX, getMeasuredHeight() / 2, (Math.max(lastTouchX, getMeasuredWidth() - lastTouchX) + AndroidUtilities.dp(40.0f)) * this.f21860s, this.v);
        }
        if (this.f21857f) {
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        sb2.append(this.f21856c.getText());
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        super.onMeasure(makeMeasureSpec, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(f7) + (this.f21857f ? 1 : 0), 1073741824));
    }

    @Override
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        this.f21861w = motionEvent.getX();
    ...
    public void setTypeface(Typeface typeface) {
        this.f21856c.setTypeface(typeface);
    }
    ...
    public x8(int i10, Context context, org.telegram.ui.ActionBar.f6 f6Var, boolean z10) {
        ...
        rk.n(z10 ? org.telegram.ui.ActionBar.j6.f19201j5 : org.telegram.ui.ActionBar.j6.G6, f6Var, textView, 1, 16.0f);
        textView.setLines(1);
        ...
        this.d = textView2;
        rk.n(z10 ? org.telegram.ui.ActionBar.j6.J5 : org.telegram.ui.ActionBar.j6.f19496z6, f6Var, textView2, 1, 13.0f);
