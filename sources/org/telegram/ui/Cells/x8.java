...
public class x8 extends FrameLayout {
    ...
    public x8(Context context) {
        ...
        addView(textView, i7.f6.d(-2, -2.0f, i11 | 48, 21.0f, 10.0f, 21.0f, 0.0f));
        TextView textView2 = new TextView(context);
        this.f25929b = textView2;
        ...
        addView(textView2, i7.f6.d(-2, -2.0f, i13 | 48, 21.0f, 35.0f, 21.0f, 0.0f));
        ImageView imageView = new ImageView(context);
        this.f25930c = imageView;
    ...
    public final void a(String str, String str2, boolean z10) {
        this.f25928a.setText(str);
        this.f25929b.setText(str2);
        this.d = z10;
    ...
    public final void b(int i10, String str, String str2, boolean z10) {
        ...
        ImageView imageView = this.f25930c;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float dp;
        int i10;
        if (this.d && org.telegram.ui.ActionBar.g6.f23183k0 != null) {
    ...
    public void setMultilineDetail(boolean z10) {
        this.f25931e = z10;
        TextView textView = this.f25929b;
        if (z10) {
            textView.setLines(0);
    ...
    public void setValue(CharSequence charSequence) {
        this.f25929b.setText(charSequence);
    }
}
