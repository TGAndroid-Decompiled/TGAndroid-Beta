...
public final class o9 implements ActionMode.Callback {
    ...
    public final void a(Menu menu) {
        ...
        if (this.f20551b.f19997l0 != null && ((this.f20550a != null && !x31.Y().contains(this.f20550a)) || !LanguageDetector.hasSupport())) {
            z10 = true;
        } else {
            z10 = false;
        }
    ...
    public final boolean onActionItemClicked(ActionMode actionMode, MenuItem menuItem) {
        ...
        if (eaVar.y()) {
            ...
            if (itemId == 16908321) {
                ...
                if (eaVar.y()) {
                    z9 z9Var = eaVar.W;
                    if (z9Var instanceof t1) {
                        messageObject = ((t1) z9Var).getMessageObject();
                    } else {
                        messageObject = null;
                    }
                    if (messageObject != null && eaVar.s() != null) {
                        eaVar.J(eaVar.f20013u, eaVar.v, messageObject);
                        eaVar.f(true);
                    }
                }
                eaVar.v();
    ...
    public final boolean onPrepareActionMode(ActionMode actionMode, Menu menu) {
        ...
        if (findItem != null) {
            findItem.setVisible(this.f20551b.e());
        }
        MenuItem findItem2 = menu.findItem(16908321);
        if (findItem2 != null) {
            findItem2.setVisible(this.f20551b.b());
        }
        MenuItem findItem3 = menu.findItem(16908319);
        boolean z10 = false;
        if (findItem3 != null && (z9Var = (eaVar = this.f20551b).W) != null) {
            CharSequence t10 = eaVar.t(z9Var, false);
            if (!this.f20551b.b()) {
                findItem3.setVisible(false);
            } else if (this.f20551b.k()) {
                findItem3.setVisible(true);
            } else {
                ea eaVar2 = this.f20551b;
                if (!eaVar2.Z && (eaVar2.f20013u > 0 || eaVar2.v < t10.length() - 1)) {
                    findItem3.setVisible(true);
                } else {
                    findItem3.setVisible(false);
                }
        ...
        if (findItem4 != null) {
            findItem4.setVisible(this.f20551b instanceof ii.k3);
        }
        MenuItem findItem5 = menu.findItem(16908322);
        if (findItem5 != null) {
            ea eaVar3 = this.f20551b;
        ...
        if (this.f20551b.f19997l0 != null && LanguageDetector.hasSupport() && this.f20551b.s() != null) {
            LanguageDetector.detectLanguage(this.f20551b.s().toString(), new n9(this, menu), new n9(this, menu));
        } else {
            this.f20550a = null;
            a(menu);
        }
