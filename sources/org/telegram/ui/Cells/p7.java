...
public final class p7 {
    public final TextPaint f21514a;
    public final Paint f21515b;
    public final Drawable f21516c;
    public final Drawable d;
    public final Paint e;
    public final SparseArray f21517f;
    public final HashMap f21518g;

    public p7(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        TextPaint textPaint = new TextPaint(1);
        this.f21514a = textPaint;
        Paint paint = new Paint();
        this.f21515b = paint;
        this.e = new Paint();
        this.f21517f = new SparseArray();
