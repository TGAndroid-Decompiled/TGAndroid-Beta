...
public class k3 extends FrameLayout {
    ...
    public final org.telegram.ui.Components.g5 f20531r;
    public int f20532s;
    ...
    public k3(Context context, String str, boolean z10, boolean z11, int i10, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        int i12;
        this.e = -1;
        this.f20531r = new org.telegram.ui.Components.g5(this);
    ...
    public final void c() {
        ...
        this.f20532s = this.f20528c - getText().length();
        String str = "";
        if ((!TextUtils.isEmpty(getText()) || this.d) && ((!this.f20529f || (this.f20530n && !this.h)) && ((i10 = this.e) == -1 || this.f20532s <= i10))) {
            str = "" + this.f20532s;
        }
