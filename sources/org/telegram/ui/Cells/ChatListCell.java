...
public abstract class ChatListCell extends LinearLayout {
    ...
    public final class ListView extends FrameLayout {
        ...
        public ListView(Context context, boolean z) {
            ...
            addView((View) r0, LayoutHelper.createFrame(22, 22.0f, 53, 0.0f, 26.0f, 10.0f, 0.0f));
            if ((!z || !SharedConfig.useThreeLinesLayout) && (z || SharedConfig.useThreeLinesLayout)) {
                z2 = false;
            }
            r0.setChecked(z2, false);
        }
        ...
        public final void onDraw(Canvas canvas) {
            ...
            anonymousClass1.setColor(color2, color3);
    ...
    public ChatListCell(Context context) {
        ...
        while (true) {
            ...
            this.listView[i].setOnClickListener(new ChatListCell$$ExternalSyntheticLambda0(this, z, 0));
            i++;
        }
    }
    ...
    public final void lambda$new$0(boolean z, View view) {
        for (int i = 0; i < 2; i++) {
            ListView listView = this.listView[i];
            listView.button.setChecked(listView == view, true);
        }
        didSelectChatType(z);
    }
