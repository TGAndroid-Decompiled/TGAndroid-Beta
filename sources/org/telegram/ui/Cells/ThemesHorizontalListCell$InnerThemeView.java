...
public class ThemesHorizontalListCell$InnerThemeView extends FrameLayout {
    public static final int f19973b0 = 0;
    public int E;
    public int F;
    public int G;
    public int H;
    ...
    public long V;
    public boolean W;
    public final RadioButton f19974a;
    public final pa f19975a0;
    public org.telegram.ui.ActionBar.g6 f19976b;
    public final RectF f19977c;
    public final Paint d;
    public Drawable e;
    public final TextPaint f19978f;
    public final Drawable h;
    public final Drawable f19979n;
    ...
    public ThemesHorizontalListCell$InnerThemeView(pa paVar, Context context) {
        ...
        this.f19978f = textPaint;
        this.N = new ArgbEvaluator();
        this.P = new Paint(3);
        this.S = new Matrix();
        setWillNotDraw(false);
        this.h = context.getResources().getDrawable(R.drawable.minibubble_in).mutate();
        this.f19979n = context.getResources().getDrawable(R.drawable.minibubble_out).mutate();
        textPaint.setTextSize(AndroidUtilities.dp(13.0f));
        RadioButton radioButton = new RadioButton(context);
        this.f19974a = radioButton;
    ...
    public final void a() {
        int i10;
        org.telegram.ui.ActionBar.g6 g6Var = this.f19976b;
        if (g6Var.S && g6Var.Y == org.telegram.ui.ActionBar.h6.f19222n) {
            i10 = -1;
        } else {
            i10 = g6Var.Q;
        }
        ...
        this.f19979n.setColorFilter(new PorterDuffColorFilter(this.f19976b.p(), mode));
        double[] dArr = null;
        if (this.f19976b.f18920b == null) {
            d(false);
            this.e = null;
        } else {
            this.e = getResources().getDrawable(R.drawable.preview_dots).mutate();
            int o9 = this.f19976b.o();
            this.f19984y = o9;
            this.I = o9;
        }
        this.Q = null;
        this.O = null;
        org.telegram.ui.ActionBar.g6 g6Var2 = this.f19976b;
        int i11 = g6Var2.M;
        if (i11 != 0 && g6Var2.N != 0) {
            int o10 = this.f19976b.o();
            org.telegram.ui.ActionBar.g6 g6Var3 = this.f19976b;
            mc0 mc0Var = new mc0(true, o10, g6Var3.M, g6Var3.N, g6Var3.O);
            mc0Var.w(AndroidUtilities.dp(6.0f));
            this.O = mc0Var;
            dArr = AndroidUtilities.rgbToHsv(Color.red(this.f19976b.o()), Color.green(this.f19976b.o()), Color.blue(this.f19976b.o()));
        } else if (i11 != 0) {
            GradientDrawable gradientDrawable = new GradientDrawable(GradientDrawable.Orientation.BL_TR, new int[]{this.f19976b.o(), this.f19976b.M});
            gradientDrawable.setCornerRadius(AndroidUtilities.dp(6.0f));
            this.O = gradientDrawable;
            dArr = AndroidUtilities.rgbToHsv(Color.red(this.f19976b.o()), Color.green(this.f19976b.o()), Color.blue(this.f19976b.o()));
        } else if (g6Var2.P <= 0 && g6Var2.f18922c == null) {
            if (g6Var2.o() != 0) {
                dArr = AndroidUtilities.rgbToHsv(Color.red(this.f19976b.o()), Color.green(this.f19976b.o()), Color.blue(this.f19976b.o()));
            }
        } else {
            org.telegram.ui.ActionBar.g6 g6Var4 = this.f19976b;
            Bitmap scaledBitmap = AndroidUtilities.getScaledBitmap(AndroidUtilities.dp(76.0f), AndroidUtilities.dp(97.0f), g6Var4.f18922c, g6Var4.f18920b, g6Var4.P);
        ...
        if (this.f19976b.o() == 0 && this.f19976b.T && this.O == null) {
    ...
    public final boolean c() {
        ...
        int intValue;
        String[] split;
        HashMap hashMap = this.f19975a0.f20806a3;
        org.telegram.ui.ActionBar.g6 g6Var = this.f19976b;
        if (g6Var == null || g6Var.f18920b == null) {
            return false;
        }
        try {
            FileInputStream fileInputStream = new FileInputStream(new File(this.f19976b.f18920b));
            int i10 = 0;
            boolean z10 = false;
            while (true) {
                int read = fileInputStream.read(pa.f20805i3);
                if (read == -1) {
                    break;
                }
                int i11 = i10;
                ...
                while (true) {
                    ...
                    if (bArr[i12] == 10) {
                        ...
                        if (str.startsWith("WLS=")) {
                            ...
                            this.f19976b.e = parse.getQueryParameter("slug");
                            org.telegram.ui.ActionBar.g6 g6Var2 = this.f19976b;
                            File filesDirFixed = ApplicationLoader.getFilesDirFixed();
                            g6Var2.f18922c = new File(filesDirFixed, Utilities.MD5(substring) + ".wp").getAbsolutePath();
                            ...
                            if (!TextUtils.isEmpty(parse.getQueryParameter("pattern"))) {
                                try {
                                    ...
                                    if (!TextUtils.isEmpty(queryParameter2)) {
                                        this.f19976b.f18933r = Integer.parseInt(queryParameter2.substring(0, 6), 16) | (-16777216);
                                        if (queryParameter2.length() >= 13 && AndroidUtilities.isValidWallChar(queryParameter2.charAt(6))) {
                                            this.f19976b.f18934s = Integer.parseInt(queryParameter2.substring(7, 13), 16) | (-16777216);
                                        }
                                        if (queryParameter2.length() >= 20 && AndroidUtilities.isValidWallChar(queryParameter2.charAt(13))) {
                                            this.f19976b.v = Integer.parseInt(queryParameter2.substring(14, 20), 16) | (-16777216);
                                        }
                                        if (queryParameter2.length() == 27 && AndroidUtilities.isValidWallChar(queryParameter2.charAt(20))) {
                                            this.f19976b.f18935w = Integer.parseInt(queryParameter2.substring(21), 16) | (-16777216);
                                        }
                                    }
                                ...
                                try {
                                    ...
                                    if (!TextUtils.isEmpty(queryParameter3)) {
                                        this.f19976b.f18936x = Utilities.parseInt((CharSequence) queryParameter3).intValue();
                                    }
                                } catch (Exception unused2) {
                                }
                                String queryParameter4 = parse.getQueryParameter("intensity");
                                if (!TextUtils.isEmpty(queryParameter4)) {
                                    this.f19976b.f18937y = Utilities.parseInt((CharSequence) queryParameter4).intValue();
                                }
                                org.telegram.ui.ActionBar.g6 g6Var3 = this.f19976b;
                                if (g6Var3.f18937y == 0) {
                                    g6Var3.f18937y = 50;
                            ...
                            this.f19976b.P = i15 + i11;
                            z10 = true;
                            break;
                        } else {
                            int indexOf = str.indexOf(61);
                            if (indexOf != -1 && ((s10 = org.telegram.ui.ActionBar.e5.s(str.substring(0, indexOf))) == org.telegram.ui.ActionBar.h6.f19306ra || s10 == org.telegram.ui.ActionBar.h6.Aa || s10 == org.telegram.ui.ActionBar.h6.Nd || s10 == org.telegram.ui.ActionBar.h6.Od || s10 == org.telegram.ui.ActionBar.h6.Pd || s10 == org.telegram.ui.ActionBar.h6.Qd)) {
        ...
        org.telegram.ui.ActionBar.g6 g6Var4 = this.f19976b;
        if (g6Var4.f18922c != null && !g6Var4.f18926f && !new File(this.f19976b.f18922c).exists()) {
            if (hashMap.containsKey(this.f19976b)) {
                return false;
            }
            org.telegram.ui.ActionBar.g6 g6Var5 = this.f19976b;
            hashMap.put(g6Var5, g6Var5.e);
            TL_account.getWallPaper getwallpaper = new TL_account.getWallPaper();
            TLRPC.TL_inputWallPaperSlug tL_inputWallPaperSlug = new TLRPC.TL_inputWallPaperSlug();
            org.telegram.ui.ActionBar.g6 g6Var6 = this.f19976b;
            ...
            ConnectionsManager.getInstance(g6Var6.E).sendRequest(getwallpaper, new RequestDelegate() {
                ...
                public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                    int i17 = ThemesHorizontalListCell$InnerThemeView.f19973b0;
    ...
    public final void d(boolean z10) {
        ...
        this.J = this.E;
        int i13 = 0;
        org.telegram.ui.ActionBar.f6 k10 = this.f19976b.k(false);
        if (k10 != null) {
            i13 = k10.f18873c;
            i11 = k10.e;
            if (i11 == 0) {
        ...
        this.f19982w = org.telegram.ui.ActionBar.h6.B(g6Var, i13, i12);
        org.telegram.ui.ActionBar.g6 g6Var2 = this.f19976b;
        this.f19983x = org.telegram.ui.ActionBar.h6.B(g6Var2, i11, g6Var2.p());
        org.telegram.ui.ActionBar.g6 g6Var3 = this.f19976b;
        this.f19984y = org.telegram.ui.ActionBar.h6.B(g6Var3, i10, g6Var3.o());
        this.E = this.f19983x;
        this.F = this.f19976b.Y;
    ...
    public final void onAttachedToWindow() {
        ...
        this.f19974a.a(z10, false);
        org.telegram.ui.ActionBar.g6 g6Var = this.f19976b;
        if (g6Var != null && (tL_theme = g6Var.F) != null && !g6Var.U) {
            if (!paVar.Z2.containsKey(FileLoader.getAttachFileName(tL_theme.document)) && !paVar.f20806a3.containsKey(this.f19976b)) {
                this.f19976b.U = true;
                this.v = 0.0f;
                c();
                a();
    ...
    public final void onDraw(Canvas canvas) {
        ...
        TextPaint textPaint = this.f19978f;
        ...
        Paint paint = this.d;
        RadioButton radioButton = this.f19974a;
        if (tL_theme != null && (tL_theme.document == null || !g6Var.U)) {
            f10 = 6.0f;
            f11 = 1.0f;
        } else {
            paint.setColor(b(this.I, this.f19984y));
            boolean z10 = this.K;
            Drawable drawable = this.f19979n;
            Drawable drawable2 = this.h;
            if (z10) {
                f10 = 6.0f;
                f11 = 1.0f;
                int b10 = b(this.G, this.f19982w);
                PorterDuff.Mode mode = PorterDuff.Mode.MULTIPLY;
                drawable2.setColorFilter(new PorterDuffColorFilter(b10, mode));
                drawable.setColorFilter(new PorterDuffColorFilter(b(this.H, this.f19983x), mode));
                this.K = false;
            } else {
                f10 = 6.0f;
                f11 = 1.0f;
            ...
            org.telegram.ui.ActionBar.g6 g6Var2 = this.f19976b;
            if (g6Var2.X != 0) {
                if ("Day".equals(g6Var2.f18918a) || "Arctic Blue".equals(this.f19976b.f18918a)) {
            ...
            if (this.e != null && this.f19975a0.f20811f3 == 0) {
        ...
        if (tL_theme2 != null && tL_theme2.document == null) {
            ...
            paint.setColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f18989a7, false));
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        accessibilityNodeInfo.setChecked(this.f19974a.f22370f);
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (this.e != null && (g6Var = this.f19976b) != null && (g6Var.F == null || g6Var.U)) {
            pa paVar = this.f19975a0;
            if (paVar.f20811f3 == 0) {
