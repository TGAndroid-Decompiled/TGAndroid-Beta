...
public class ThemesHorizontalListCell$InnerThemeView extends FrameLayout {
    public static final int f21578b0 = 0;
    public int E;
    public int F;
    public int G;
    public int H;
    ...
    public long V;
    public boolean W;
    public final RadioButton f21579a;
    public final pa f21580a0;
    public org.telegram.ui.ActionBar.i6 f21581b;
    public final RectF f21582c;
    public final Paint d;
    public Drawable f21583e;
    public final TextPaint f21584f;
    public final Drawable h;
    public final Drawable f21585n;
    ...
    public ThemesHorizontalListCell$InnerThemeView(pa paVar, Context context) {
        ...
        this.f21584f = textPaint;
        this.N = new ArgbEvaluator();
        this.P = new Paint(3);
        this.S = new Matrix();
        setWillNotDraw(false);
        this.h = context.getResources().getDrawable(R.drawable.minibubble_in).mutate();
        this.f21585n = context.getResources().getDrawable(R.drawable.minibubble_out).mutate();
        textPaint.setTextSize(AndroidUtilities.dp(13.0f));
        RadioButton radioButton = new RadioButton(context);
        this.f21579a = radioButton;
    ...
    public final void a() {
        int i10;
        org.telegram.ui.ActionBar.i6 i6Var = this.f21581b;
        if (i6Var.S && i6Var.Y == org.telegram.ui.ActionBar.j6.f20840n) {
            i10 = -1;
        } else {
            i10 = i6Var.Q;
        }
        ...
        this.f21585n.setColorFilter(new PorterDuffColorFilter(this.f21581b.p(), mode));
        double[] dArr = null;
        if (this.f21581b.f20543b == null) {
            d(false);
            this.f21583e = null;
        } else {
            this.f21583e = getResources().getDrawable(R.drawable.preview_dots).mutate();
            int o9 = this.f21581b.o();
            this.f21590y = o9;
            this.I = o9;
        }
        this.Q = null;
        this.O = null;
        org.telegram.ui.ActionBar.i6 i6Var2 = this.f21581b;
        int i11 = i6Var2.M;
        if (i11 != 0 && i6Var2.N != 0) {
            int o10 = this.f21581b.o();
            org.telegram.ui.ActionBar.i6 i6Var3 = this.f21581b;
            dc0 dc0Var = new dc0(true, o10, i6Var3.M, i6Var3.N, i6Var3.O);
            dc0Var.w(AndroidUtilities.dp(6.0f));
            this.O = dc0Var;
            dArr = AndroidUtilities.rgbToHsv(Color.red(this.f21581b.o()), Color.green(this.f21581b.o()), Color.blue(this.f21581b.o()));
        } else if (i11 != 0) {
            GradientDrawable gradientDrawable = new GradientDrawable(GradientDrawable.Orientation.BL_TR, new int[]{this.f21581b.o(), this.f21581b.M});
            gradientDrawable.setCornerRadius(AndroidUtilities.dp(6.0f));
            this.O = gradientDrawable;
            dArr = AndroidUtilities.rgbToHsv(Color.red(this.f21581b.o()), Color.green(this.f21581b.o()), Color.blue(this.f21581b.o()));
        } else if (i6Var2.P <= 0 && i6Var2.f20545c == null) {
            if (i6Var2.o() != 0) {
                dArr = AndroidUtilities.rgbToHsv(Color.red(this.f21581b.o()), Color.green(this.f21581b.o()), Color.blue(this.f21581b.o()));
            }
        } else {
            org.telegram.ui.ActionBar.i6 i6Var4 = this.f21581b;
            Bitmap scaledBitmap = AndroidUtilities.getScaledBitmap(AndroidUtilities.dp(76.0f), AndroidUtilities.dp(97.0f), i6Var4.f20545c, i6Var4.f20543b, i6Var4.P);
        ...
        if (this.f21581b.o() == 0 && this.f21581b.T && this.O == null) {
    ...
    public final boolean c() {
        ...
        int intValue;
        String[] split;
        HashMap hashMap = this.f21580a0.f22468a3;
        org.telegram.ui.ActionBar.i6 i6Var = this.f21581b;
        if (i6Var == null || i6Var.f20543b == null) {
            return false;
        }
        try {
            FileInputStream fileInputStream = new FileInputStream(new File(this.f21581b.f20543b));
            int i10 = 0;
            boolean z10 = false;
            while (true) {
                int read = fileInputStream.read(pa.f22467i3);
                if (read == -1) {
                    break;
                }
                int i11 = i10;
                ...
                while (true) {
                    ...
                    if (bArr[i12] == 10) {
                        ...
                        if (str.startsWith("WLS=")) {
                            ...
                            this.f21581b.f20548e = parse.getQueryParameter("slug");
                            org.telegram.ui.ActionBar.i6 i6Var2 = this.f21581b;
                            File filesDirFixed = ApplicationLoader.getFilesDirFixed();
                            i6Var2.f20545c = new File(filesDirFixed, Utilities.MD5(substring) + ".wp").getAbsolutePath();
                            ...
                            if (!TextUtils.isEmpty(parse.getQueryParameter("pattern"))) {
                                try {
                                    ...
                                    if (!TextUtils.isEmpty(queryParameter2)) {
                                        this.f21581b.f20557r = Integer.parseInt(queryParameter2.substring(0, 6), 16) | (-16777216);
                                        if (queryParameter2.length() >= 13 && AndroidUtilities.isValidWallChar(queryParameter2.charAt(6))) {
                                            this.f21581b.f20558s = Integer.parseInt(queryParameter2.substring(7, 13), 16) | (-16777216);
                                        }
                                        if (queryParameter2.length() >= 20 && AndroidUtilities.isValidWallChar(queryParameter2.charAt(13))) {
                                            this.f21581b.v = Integer.parseInt(queryParameter2.substring(14, 20), 16) | (-16777216);
                                        }
                                        if (queryParameter2.length() == 27 && AndroidUtilities.isValidWallChar(queryParameter2.charAt(20))) {
                                            this.f21581b.f20559w = Integer.parseInt(queryParameter2.substring(21), 16) | (-16777216);
                                        }
                                    }
                                ...
                                try {
                                    ...
                                    if (!TextUtils.isEmpty(queryParameter3)) {
                                        this.f21581b.f20560x = Utilities.parseInt((CharSequence) queryParameter3).intValue();
                                    }
                                } catch (Exception unused2) {
                                }
                                String queryParameter4 = parse.getQueryParameter("intensity");
                                if (!TextUtils.isEmpty(queryParameter4)) {
                                    this.f21581b.f20561y = Utilities.parseInt((CharSequence) queryParameter4).intValue();
                                }
                                org.telegram.ui.ActionBar.i6 i6Var3 = this.f21581b;
                                if (i6Var3.f20561y == 0) {
                                    i6Var3.f20561y = 50;
                            ...
                            this.f21581b.P = i15 + i11;
                            z10 = true;
                            break;
                        } else {
                            int indexOf = str.indexOf(61);
                            if (indexOf != -1 && ((s10 = org.telegram.ui.ActionBar.g5.s(str.substring(0, indexOf))) == org.telegram.ui.ActionBar.j6.f20921ra || s10 == org.telegram.ui.ActionBar.j6.Aa || s10 == org.telegram.ui.ActionBar.j6.Nd || s10 == org.telegram.ui.ActionBar.j6.Od || s10 == org.telegram.ui.ActionBar.j6.Pd || s10 == org.telegram.ui.ActionBar.j6.Qd)) {
        ...
        org.telegram.ui.ActionBar.i6 i6Var4 = this.f21581b;
        if (i6Var4.f20545c != null && !i6Var4.f20550f && !new File(this.f21581b.f20545c).exists()) {
            if (hashMap.containsKey(this.f21581b)) {
                return false;
            }
            org.telegram.ui.ActionBar.i6 i6Var5 = this.f21581b;
            hashMap.put(i6Var5, i6Var5.f20548e);
            TL_account.getWallPaper getwallpaper = new TL_account.getWallPaper();
            TLRPC.TL_inputWallPaperSlug tL_inputWallPaperSlug = new TLRPC.TL_inputWallPaperSlug();
            org.telegram.ui.ActionBar.i6 i6Var6 = this.f21581b;
            tL_inputWallPaperSlug.slug = i6Var6.f20548e;
            getwallpaper.wallpaper = tL_inputWallPaperSlug;
            ConnectionsManager.getInstance(i6Var6.E).sendRequest(getwallpaper, new RequestDelegate() {
                @Override
                public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                    int i17 = ThemesHorizontalListCell$InnerThemeView.f21578b0;
    ...
    public final void d(boolean z10) {
        ...
        this.J = this.E;
        int i13 = 0;
        org.telegram.ui.ActionBar.h6 k10 = this.f21581b.k(false);
        if (k10 != null) {
            i13 = k10.f20493c;
            i11 = k10.f20494e;
            if (i11 == 0) {
        ...
        this.f21588w = org.telegram.ui.ActionBar.j6.B(i6Var, i13, i12);
        org.telegram.ui.ActionBar.i6 i6Var2 = this.f21581b;
        this.f21589x = org.telegram.ui.ActionBar.j6.B(i6Var2, i11, i6Var2.p());
        org.telegram.ui.ActionBar.i6 i6Var3 = this.f21581b;
        this.f21590y = org.telegram.ui.ActionBar.j6.B(i6Var3, i10, i6Var3.o());
        this.E = this.f21589x;
        this.F = this.f21581b.Y;
    ...
    public final void onAttachedToWindow() {
        ...
        this.f21579a.a(z10, false);
        org.telegram.ui.ActionBar.i6 i6Var = this.f21581b;
        if (i6Var != null && (tL_theme = i6Var.F) != null && !i6Var.U) {
            if (!paVar.Z2.containsKey(FileLoader.getAttachFileName(tL_theme.document)) && !paVar.f22468a3.containsKey(this.f21581b)) {
                this.f21581b.U = true;
                this.v = 0.0f;
                c();
                a();
    ...
    public final void onDraw(Canvas canvas) {
        ...
        TextPaint textPaint = this.f21584f;
        ...
        Paint paint = this.d;
        RadioButton radioButton = this.f21579a;
        if (tL_theme != null && (tL_theme.document == null || !i6Var.U)) {
            f10 = 6.0f;
            f11 = 1.0f;
        } else {
            paint.setColor(b(this.I, this.f21590y));
            boolean z10 = this.K;
            Drawable drawable = this.f21585n;
            Drawable drawable2 = this.h;
            if (z10) {
                f10 = 6.0f;
                f11 = 1.0f;
                int b10 = b(this.G, this.f21588w);
                PorterDuff.Mode mode = PorterDuff.Mode.MULTIPLY;
                drawable2.setColorFilter(new PorterDuffColorFilter(b10, mode));
                drawable.setColorFilter(new PorterDuffColorFilter(b(this.H, this.f21589x), mode));
                this.K = false;
            } else {
                f10 = 6.0f;
                f11 = 1.0f;
            ...
            org.telegram.ui.ActionBar.i6 i6Var2 = this.f21581b;
            if (i6Var2.X != 0) {
                if ("Day".equals(i6Var2.f20541a) || "Arctic Blue".equals(this.f21581b.f20541a)) {
            ...
            if (this.f21583e != null && this.f21580a0.f22473f3 == 0) {
                int dp4 = ((int) rectF.right) - AndroidUtilities.dp(16.0f);
                int dp5 = AndroidUtilities.dp(f10) + ((int) rectF.top);
                Drawable drawable4 = this.f21583e;
                drawable4.setBounds(dp4, dp5, drawable4.getIntrinsicWidth() + dp4, this.f21583e.getIntrinsicHeight() + dp5);
        ...
        if (tL_theme2 != null && tL_theme2.document == null) {
            ...
            paint.setColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20608a7, false));
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        accessibilityNodeInfo.setChecked(this.f21579a.f24111f);
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (this.f21583e != null && (i6Var = this.f21581b) != null && (i6Var.F == null || i6Var.U)) {
            pa paVar = this.f21580a0;
            if (paVar.f22473f3 == 0) {
