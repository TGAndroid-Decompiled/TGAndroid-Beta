...
public class ThemesHorizontalListCell$InnerThemeView extends FrameLayout {
    public static final int f19764b0 = 0;
    public int E;
    public int F;
    public int G;
    public int H;
    ...
    public long V;
    public boolean W;
    public final RadioButton f19765a;
    public final qa f19766a0;
    public org.telegram.ui.ActionBar.h6 f19767b;
    public final RectF f19768c;
    public final Paint d;
    public Drawable e;
    public final TextPaint f19769f;
    public final Drawable h;
    public final Drawable f19770n;
    ...
    public ThemesHorizontalListCell$InnerThemeView(qa qaVar, Context context) {
        super(context);
        this.f19766a0 = qaVar;
        this.f19768c = new RectF();
        this.d = new Paint(1);
        TextPaint textPaint = new TextPaint(1);
        this.f19769f = textPaint;
        this.N = new ArgbEvaluator();
        this.P = new Paint(3);
        this.S = new Matrix();
        setWillNotDraw(false);
        this.h = context.getResources().getDrawable(R.drawable.minibubble_in).mutate();
        this.f19770n = context.getResources().getDrawable(R.drawable.minibubble_out).mutate();
        textPaint.setTextSize(AndroidUtilities.dp(13.0f));
        RadioButton radioButton = new RadioButton(context);
        this.f19765a = radioButton;
    ...
    public final void a() {
        int i10;
        org.telegram.ui.ActionBar.h6 h6Var = this.f19767b;
        if (h6Var.S && h6Var.Y == org.telegram.ui.ActionBar.i6.f19014n) {
            i10 = -1;
        } else {
            i10 = h6Var.Q;
        }
        ...
        this.f19770n.setColorFilter(new PorterDuffColorFilter(this.f19767b.p(), mode));
        double[] dArr = null;
        if (this.f19767b.f18731b == null) {
            d(false);
            this.e = null;
        } else {
            this.e = getResources().getDrawable(R.drawable.preview_dots).mutate();
            int o9 = this.f19767b.o();
            this.f19775y = o9;
            this.I = o9;
        }
        this.Q = null;
        this.O = null;
        org.telegram.ui.ActionBar.h6 h6Var2 = this.f19767b;
        int i11 = h6Var2.M;
        if (i11 != 0 && h6Var2.N != 0) {
            int o10 = this.f19767b.o();
            org.telegram.ui.ActionBar.h6 h6Var3 = this.f19767b;
            cc0 cc0Var = new cc0(true, o10, h6Var3.M, h6Var3.N, h6Var3.O);
            cc0Var.w(AndroidUtilities.dp(6.0f));
            this.O = cc0Var;
            dArr = AndroidUtilities.rgbToHsv(Color.red(this.f19767b.o()), Color.green(this.f19767b.o()), Color.blue(this.f19767b.o()));
        } else if (i11 != 0) {
            GradientDrawable gradientDrawable = new GradientDrawable(GradientDrawable.Orientation.BL_TR, new int[]{this.f19767b.o(), this.f19767b.M});
            gradientDrawable.setCornerRadius(AndroidUtilities.dp(6.0f));
            this.O = gradientDrawable;
            dArr = AndroidUtilities.rgbToHsv(Color.red(this.f19767b.o()), Color.green(this.f19767b.o()), Color.blue(this.f19767b.o()));
        } else if (h6Var2.P <= 0 && h6Var2.f18733c == null) {
            if (h6Var2.o() != 0) {
                dArr = AndroidUtilities.rgbToHsv(Color.red(this.f19767b.o()), Color.green(this.f19767b.o()), Color.blue(this.f19767b.o()));
            }
        } else {
            org.telegram.ui.ActionBar.h6 h6Var4 = this.f19767b;
            Bitmap scaledBitmap = AndroidUtilities.getScaledBitmap(AndroidUtilities.dp(76.0f), AndroidUtilities.dp(97.0f), h6Var4.f18733c, h6Var4.f18731b, h6Var4.P);
        ...
        if (this.f19767b.o() == 0 && this.f19767b.T && this.O == null) {
    ...
    public final boolean c() {
        ...
        int intValue;
        String[] split;
        HashMap hashMap = this.f19766a0.f20625a3;
        org.telegram.ui.ActionBar.h6 h6Var = this.f19767b;
        if (h6Var == null || h6Var.f18731b == null) {
            return false;
        }
        try {
            FileInputStream fileInputStream = new FileInputStream(new File(this.f19767b.f18731b));
            int i10 = 0;
            boolean z10 = false;
            while (true) {
                int read = fileInputStream.read(qa.f20624i3);
                if (read == -1) {
                    break;
                }
                int i11 = i10;
                ...
                while (true) {
                    ...
                    if (bArr[i12] == 10) {
                        ...
                        if (str.startsWith("WLS=")) {
                            ...
                            this.f19767b.e = parse.getQueryParameter("slug");
                            org.telegram.ui.ActionBar.h6 h6Var2 = this.f19767b;
                            File filesDirFixed = ApplicationLoader.getFilesDirFixed();
                            h6Var2.f18733c = new File(filesDirFixed, Utilities.MD5(substring) + ".wp").getAbsolutePath();
                            ...
                            if (!TextUtils.isEmpty(parse.getQueryParameter("pattern"))) {
                                try {
                                    ...
                                    if (!TextUtils.isEmpty(queryParameter2)) {
                                        this.f19767b.f18744r = Integer.parseInt(queryParameter2.substring(0, 6), 16) | (-16777216);
                                        if (queryParameter2.length() >= 13 && AndroidUtilities.isValidWallChar(queryParameter2.charAt(6))) {
                                            this.f19767b.f18745s = Integer.parseInt(queryParameter2.substring(7, 13), 16) | (-16777216);
                                        }
                                        if (queryParameter2.length() >= 20 && AndroidUtilities.isValidWallChar(queryParameter2.charAt(13))) {
                                            this.f19767b.v = Integer.parseInt(queryParameter2.substring(14, 20), 16) | (-16777216);
                                        }
                                        if (queryParameter2.length() == 27 && AndroidUtilities.isValidWallChar(queryParameter2.charAt(20))) {
                                            this.f19767b.f18746w = Integer.parseInt(queryParameter2.substring(21), 16) | (-16777216);
                                        }
                                    }
                                ...
                                try {
                                    ...
                                    if (!TextUtils.isEmpty(queryParameter3)) {
                                        this.f19767b.f18747x = Utilities.parseInt((CharSequence) queryParameter3).intValue();
                                    }
                                } catch (Exception unused2) {
                                }
                                String queryParameter4 = parse.getQueryParameter("intensity");
                                if (!TextUtils.isEmpty(queryParameter4)) {
                                    this.f19767b.f18748y = Utilities.parseInt((CharSequence) queryParameter4).intValue();
                                }
                                org.telegram.ui.ActionBar.h6 h6Var3 = this.f19767b;
                                if (h6Var3.f18748y == 0) {
                                    h6Var3.f18748y = 50;
                            ...
                            this.f19767b.P = i15 + i11;
                            z10 = true;
                            break;
                        } else {
                            int indexOf = str.indexOf(61);
                            if (indexOf != -1 && ((s10 = org.telegram.ui.ActionBar.g5.s(str.substring(0, indexOf))) == org.telegram.ui.ActionBar.i6.f19096ra || s10 == org.telegram.ui.ActionBar.i6.Aa || s10 == org.telegram.ui.ActionBar.i6.Nd || s10 == org.telegram.ui.ActionBar.i6.Od || s10 == org.telegram.ui.ActionBar.i6.Pd || s10 == org.telegram.ui.ActionBar.i6.Qd)) {
        ...
        org.telegram.ui.ActionBar.h6 h6Var4 = this.f19767b;
        if (h6Var4.f18733c != null && !h6Var4.f18737f && !new File(this.f19767b.f18733c).exists()) {
            if (hashMap.containsKey(this.f19767b)) {
                return false;
            }
            org.telegram.ui.ActionBar.h6 h6Var5 = this.f19767b;
            hashMap.put(h6Var5, h6Var5.e);
            TL_account.getWallPaper getwallpaper = new TL_account.getWallPaper();
            TLRPC.TL_inputWallPaperSlug tL_inputWallPaperSlug = new TLRPC.TL_inputWallPaperSlug();
            org.telegram.ui.ActionBar.h6 h6Var6 = this.f19767b;
            tL_inputWallPaperSlug.slug = h6Var6.e;
            getwallpaper.wallpaper = tL_inputWallPaperSlug;
            ConnectionsManager.getInstance(h6Var6.E).sendRequest(getwallpaper, new RequestDelegate() {
                @Override
                public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                    int i17 = ThemesHorizontalListCell$InnerThemeView.f19764b0;
    ...
    public final void d(boolean z10) {
        ...
        this.J = this.E;
        int i13 = 0;
        org.telegram.ui.ActionBar.g6 k10 = this.f19767b.k(false);
        if (k10 != null) {
            i13 = k10.f18694c;
            i11 = k10.e;
            if (i11 == 0) {
        ...
        this.f19773w = org.telegram.ui.ActionBar.i6.B(h6Var, i13, i12);
        org.telegram.ui.ActionBar.h6 h6Var2 = this.f19767b;
        this.f19774x = org.telegram.ui.ActionBar.i6.B(h6Var2, i11, h6Var2.p());
        org.telegram.ui.ActionBar.h6 h6Var3 = this.f19767b;
        this.f19775y = org.telegram.ui.ActionBar.i6.B(h6Var3, i10, h6Var3.o());
        this.E = this.f19774x;
        this.F = this.f19767b.Y;
    ...
    public final void onAttachedToWindow() {
        ...
        this.f19765a.a(z10, false);
        org.telegram.ui.ActionBar.h6 h6Var = this.f19767b;
        if (h6Var != null && (tL_theme = h6Var.F) != null && !h6Var.U) {
            if (!qaVar.Z2.containsKey(FileLoader.getAttachFileName(tL_theme.document)) && !qaVar.f20625a3.containsKey(this.f19767b)) {
                this.f19767b.U = true;
                this.v = 0.0f;
                c();
                a();
    ...
    public final void onDraw(Canvas canvas) {
        ...
        TextPaint textPaint = this.f19769f;
        ...
        Paint paint = this.d;
        RadioButton radioButton = this.f19765a;
        if (tL_theme != null && (tL_theme.document == null || !h6Var.U)) {
            f10 = 6.0f;
            f11 = 1.0f;
        } else {
            paint.setColor(b(this.I, this.f19775y));
            boolean z10 = this.K;
            Drawable drawable = this.f19770n;
            Drawable drawable2 = this.h;
            if (z10) {
                f10 = 6.0f;
                f11 = 1.0f;
                int b10 = b(this.G, this.f19773w);
                PorterDuff.Mode mode = PorterDuff.Mode.MULTIPLY;
                drawable2.setColorFilter(new PorterDuffColorFilter(b10, mode));
                drawable.setColorFilter(new PorterDuffColorFilter(b(this.H, this.f19774x), mode));
                this.K = false;
            } else {
                f10 = 6.0f;
                f11 = 1.0f;
            ...
            org.telegram.ui.ActionBar.h6 h6Var2 = this.f19767b;
            if (h6Var2.X != 0) {
                if ("Day".equals(h6Var2.f18729a) || "Arctic Blue".equals(this.f19767b.f18729a)) {
            ...
            if (this.e != null && this.f19766a0.f20630f3 == 0) {
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        accessibilityNodeInfo.setChecked(this.f19765a.f22162f);
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (this.e != null && (h6Var = this.f19767b) != null && (h6Var.F == null || h6Var.U)) {
            qa qaVar = this.f19766a0;
            if (qaVar.f20630f3 == 0) {
