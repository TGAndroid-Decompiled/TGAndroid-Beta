...
public class ThemesHorizontalListCell$InnerThemeView extends FrameLayout {
    public static final int f19775b0 = 0;
    public int E;
    public int F;
    public int G;
    public int H;
    ...
    public long V;
    public boolean W;
    public final RadioButton f19776a;
    public final qa f19777a0;
    public org.telegram.ui.ActionBar.i6 f19778b;
    public final RectF f19779c;
    public final Paint d;
    public Drawable e;
    public final TextPaint f19780f;
    public final Drawable h;
    public final Drawable f19781n;
    ...
    public ThemesHorizontalListCell$InnerThemeView(qa qaVar, Context context) {
        super(context);
        this.f19777a0 = qaVar;
        this.f19779c = new RectF();
        this.d = new Paint(1);
        TextPaint textPaint = new TextPaint(1);
        this.f19780f = textPaint;
        this.N = new ArgbEvaluator();
        this.P = new Paint(3);
        this.S = new Matrix();
        setWillNotDraw(false);
        this.h = context.getResources().getDrawable(R.drawable.minibubble_in).mutate();
        this.f19781n = context.getResources().getDrawable(R.drawable.minibubble_out).mutate();
        textPaint.setTextSize(AndroidUtilities.dp(13.0f));
        RadioButton radioButton = new RadioButton(context);
        this.f19776a = radioButton;
    ...
    public final void a() {
        int i10;
        org.telegram.ui.ActionBar.i6 i6Var = this.f19778b;
        if (i6Var.S && i6Var.Y == org.telegram.ui.ActionBar.j6.f19041n) {
            i10 = -1;
        } else {
            i10 = i6Var.Q;
        }
        ...
        this.f19781n.setColorFilter(new PorterDuffColorFilter(this.f19778b.p(), mode));
        double[] dArr = null;
        if (this.f19778b.f18759b == null) {
            d(false);
            this.e = null;
        } else {
            this.e = getResources().getDrawable(R.drawable.preview_dots).mutate();
            int o9 = this.f19778b.o();
            this.f19786y = o9;
            this.I = o9;
        }
        this.Q = null;
        this.O = null;
        org.telegram.ui.ActionBar.i6 i6Var2 = this.f19778b;
        int i11 = i6Var2.M;
        if (i11 != 0 && i6Var2.N != 0) {
            int o10 = this.f19778b.o();
            org.telegram.ui.ActionBar.i6 i6Var3 = this.f19778b;
            cc0 cc0Var = new cc0(true, o10, i6Var3.M, i6Var3.N, i6Var3.O);
            cc0Var.w(AndroidUtilities.dp(6.0f));
            this.O = cc0Var;
            dArr = AndroidUtilities.rgbToHsv(Color.red(this.f19778b.o()), Color.green(this.f19778b.o()), Color.blue(this.f19778b.o()));
        } else if (i11 != 0) {
            GradientDrawable gradientDrawable = new GradientDrawable(GradientDrawable.Orientation.BL_TR, new int[]{this.f19778b.o(), this.f19778b.M});
            gradientDrawable.setCornerRadius(AndroidUtilities.dp(6.0f));
            this.O = gradientDrawable;
            dArr = AndroidUtilities.rgbToHsv(Color.red(this.f19778b.o()), Color.green(this.f19778b.o()), Color.blue(this.f19778b.o()));
        } else if (i6Var2.P <= 0 && i6Var2.f18761c == null) {
            if (i6Var2.o() != 0) {
                dArr = AndroidUtilities.rgbToHsv(Color.red(this.f19778b.o()), Color.green(this.f19778b.o()), Color.blue(this.f19778b.o()));
            }
        } else {
            org.telegram.ui.ActionBar.i6 i6Var4 = this.f19778b;
            Bitmap scaledBitmap = AndroidUtilities.getScaledBitmap(AndroidUtilities.dp(76.0f), AndroidUtilities.dp(97.0f), i6Var4.f18761c, i6Var4.f18759b, i6Var4.P);
        ...
        if (this.f19778b.o() == 0 && this.f19778b.T && this.O == null) {
    ...
    public final boolean c() {
        ...
        int intValue;
        String[] split;
        HashMap hashMap = this.f19777a0.f20636a3;
        org.telegram.ui.ActionBar.i6 i6Var = this.f19778b;
        if (i6Var == null || i6Var.f18759b == null) {
            return false;
        }
        try {
            FileInputStream fileInputStream = new FileInputStream(new File(this.f19778b.f18759b));
            int i10 = 0;
            boolean z10 = false;
            while (true) {
                int read = fileInputStream.read(qa.f20635i3);
                if (read == -1) {
                    break;
                }
                int i11 = i10;
                ...
                while (true) {
                    ...
                    if (bArr[i12] == 10) {
                        ...
                        if (str.startsWith("WLS=")) {
                            ...
                            this.f19778b.e = parse.getQueryParameter("slug");
                            org.telegram.ui.ActionBar.i6 i6Var2 = this.f19778b;
                            File filesDirFixed = ApplicationLoader.getFilesDirFixed();
                            i6Var2.f18761c = new File(filesDirFixed, Utilities.MD5(substring) + ".wp").getAbsolutePath();
                            ...
                            if (!TextUtils.isEmpty(parse.getQueryParameter("pattern"))) {
                                try {
                                    ...
                                    if (!TextUtils.isEmpty(queryParameter2)) {
                                        this.f19778b.f18772r = Integer.parseInt(queryParameter2.substring(0, 6), 16) | (-16777216);
                                        if (queryParameter2.length() >= 13 && AndroidUtilities.isValidWallChar(queryParameter2.charAt(6))) {
                                            this.f19778b.f18773s = Integer.parseInt(queryParameter2.substring(7, 13), 16) | (-16777216);
                                        }
                                        if (queryParameter2.length() >= 20 && AndroidUtilities.isValidWallChar(queryParameter2.charAt(13))) {
                                            this.f19778b.v = Integer.parseInt(queryParameter2.substring(14, 20), 16) | (-16777216);
                                        }
                                        if (queryParameter2.length() == 27 && AndroidUtilities.isValidWallChar(queryParameter2.charAt(20))) {
                                            this.f19778b.f18774w = Integer.parseInt(queryParameter2.substring(21), 16) | (-16777216);
                                        }
                                    }
                                ...
                                try {
                                    ...
                                    if (!TextUtils.isEmpty(queryParameter3)) {
                                        this.f19778b.f18775x = Utilities.parseInt((CharSequence) queryParameter3).intValue();
                                    }
                                } catch (Exception unused2) {
                                }
                                String queryParameter4 = parse.getQueryParameter("intensity");
                                if (!TextUtils.isEmpty(queryParameter4)) {
                                    this.f19778b.f18776y = Utilities.parseInt((CharSequence) queryParameter4).intValue();
                                }
                                org.telegram.ui.ActionBar.i6 i6Var3 = this.f19778b;
                                if (i6Var3.f18776y == 0) {
                                    i6Var3.f18776y = 50;
                            ...
                            this.f19778b.P = i15 + i11;
                            z10 = true;
                            break;
                        } else {
                            int indexOf = str.indexOf(61);
                            if (indexOf != -1 && ((s10 = org.telegram.ui.ActionBar.h5.s(str.substring(0, indexOf))) == org.telegram.ui.ActionBar.j6.f19123ra || s10 == org.telegram.ui.ActionBar.j6.Aa || s10 == org.telegram.ui.ActionBar.j6.Nd || s10 == org.telegram.ui.ActionBar.j6.Od || s10 == org.telegram.ui.ActionBar.j6.Pd || s10 == org.telegram.ui.ActionBar.j6.Qd)) {
        ...
        org.telegram.ui.ActionBar.i6 i6Var4 = this.f19778b;
        if (i6Var4.f18761c != null && !i6Var4.f18765f && !new File(this.f19778b.f18761c).exists()) {
            if (hashMap.containsKey(this.f19778b)) {
                return false;
            }
            org.telegram.ui.ActionBar.i6 i6Var5 = this.f19778b;
            hashMap.put(i6Var5, i6Var5.e);
            TL_account.getWallPaper getwallpaper = new TL_account.getWallPaper();
            TLRPC.TL_inputWallPaperSlug tL_inputWallPaperSlug = new TLRPC.TL_inputWallPaperSlug();
            org.telegram.ui.ActionBar.i6 i6Var6 = this.f19778b;
            ...
            ConnectionsManager.getInstance(i6Var6.E).sendRequest(getwallpaper, new RequestDelegate() {
                ...
                public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                    int i17 = ThemesHorizontalListCell$InnerThemeView.f19775b0;
    ...
    public final void d(boolean z10) {
        ...
        this.J = this.E;
        int i13 = 0;
        org.telegram.ui.ActionBar.h6 k10 = this.f19778b.k(false);
        if (k10 != null) {
            i13 = k10.f18723c;
            i11 = k10.e;
            if (i11 == 0) {
        ...
        this.f19784w = org.telegram.ui.ActionBar.j6.B(i6Var, i13, i12);
        org.telegram.ui.ActionBar.i6 i6Var2 = this.f19778b;
        this.f19785x = org.telegram.ui.ActionBar.j6.B(i6Var2, i11, i6Var2.p());
        org.telegram.ui.ActionBar.i6 i6Var3 = this.f19778b;
        this.f19786y = org.telegram.ui.ActionBar.j6.B(i6Var3, i10, i6Var3.o());
        this.E = this.f19785x;
        this.F = this.f19778b.Y;
    ...
    public final void onAttachedToWindow() {
        ...
        this.f19776a.a(z10, false);
        org.telegram.ui.ActionBar.i6 i6Var = this.f19778b;
        if (i6Var != null && (tL_theme = i6Var.F) != null && !i6Var.U) {
            if (!qaVar.Z2.containsKey(FileLoader.getAttachFileName(tL_theme.document)) && !qaVar.f20636a3.containsKey(this.f19778b)) {
                this.f19778b.U = true;
                this.v = 0.0f;
                c();
                a();
    ...
    public final void onDraw(Canvas canvas) {
        ...
        TextPaint textPaint = this.f19780f;
        ...
        Paint paint = this.d;
        RadioButton radioButton = this.f19776a;
        if (tL_theme != null && (tL_theme.document == null || !i6Var.U)) {
            f10 = 6.0f;
            f11 = 1.0f;
        } else {
            paint.setColor(b(this.I, this.f19786y));
            boolean z10 = this.K;
            Drawable drawable = this.f19781n;
            Drawable drawable2 = this.h;
            if (z10) {
                f10 = 6.0f;
                f11 = 1.0f;
                int b10 = b(this.G, this.f19784w);
                PorterDuff.Mode mode = PorterDuff.Mode.MULTIPLY;
                drawable2.setColorFilter(new PorterDuffColorFilter(b10, mode));
                drawable.setColorFilter(new PorterDuffColorFilter(b(this.H, this.f19785x), mode));
                this.K = false;
            } else {
                f10 = 6.0f;
                f11 = 1.0f;
            ...
            org.telegram.ui.ActionBar.i6 i6Var2 = this.f19778b;
            if (i6Var2.X != 0) {
                if ("Day".equals(i6Var2.f18757a) || "Arctic Blue".equals(this.f19778b.f18757a)) {
            ...
            if (this.e != null && this.f19777a0.f20641f3 == 0) {
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        accessibilityNodeInfo.setChecked(this.f19776a.f22175f);
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (this.e != null && (i6Var = this.f19778b) != null && (i6Var.F == null || i6Var.U)) {
            qa qaVar = this.f19777a0;
            if (qaVar.f20641f3 == 0) {
