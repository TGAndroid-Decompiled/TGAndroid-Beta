...
public final class a3 extends FrameLayout {
    public final LinearLayout f20015a;
    public final LinearLayout f20016b;
    public final org.telegram.ui.Components.y5 f20017c;
    public final o90 d;
    public final ImageView e;
    public final ImageView f20018f;
    public final org.telegram.ui.Components.w9 h;
    public final org.telegram.ui.Components.k9 f20019n;
    ...
    public final void a(int i10, ArrayList arrayList) {
        ...
        org.telegram.ui.Components.k9 k9Var = this.f20019n;
        if (min != k9Var.f25672a.f25341n) {
            z10 = true;
        } else {
            z10 = false;
        }
    ...
    public final void c(CharSequence charSequence, CharSequence charSequence2, boolean z10, boolean z11) {
        ...
        org.telegram.ui.Components.y5 y5Var = this.f20017c;
        ...
        this.f20016b.setPadding(i13, 0, i12, 0);
        d();
    }
    ...
    public final void d() {
        ...
        this.f20017c.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, i10, false));
        ...
        ImageView imageView = this.f20018f;
        imageView.setColorFilter(w04, mode);
        imageView.setBackground(org.telegram.ui.ActionBar.w5.c(null, org.telegram.ui.ActionBar.w5.b(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.w5.f19901a, false))));
    }

    @Override
    public final void onMeasure(int i10, int i11) {
        super.onMeasure(i10, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.displaySize.y, Integer.MIN_VALUE));
        LinearLayout linearLayout = this.f20016b;
        ...
        this.f20018f.setTranslationY((getPaddingBottom() - getPaddingTop()) / 2.0f);
        this.f20019n.setTranslationY((getPaddingBottom() - getPaddingTop()) / 2.0f);
