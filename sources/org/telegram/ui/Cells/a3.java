...
public final class a3 extends FrameLayout {
    public final LinearLayout f20016a;
    public final LinearLayout f20017b;
    public final org.telegram.ui.Components.y5 f20018c;
    public final n90 d;
    public final ImageView e;
    public final ImageView f20019f;
    public final org.telegram.ui.Components.w9 h;
    public final org.telegram.ui.Components.k9 f20020n;
    ...
    public final void a(int i10, ArrayList arrayList) {
        ...
        org.telegram.ui.Components.k9 k9Var = this.f20020n;
        if (min != k9Var.f25711a.f25349n) {
            z10 = true;
        } else {
            z10 = false;
        }
    ...
    public final void c(CharSequence charSequence, CharSequence charSequence2, boolean z10, boolean z11) {
        ...
        org.telegram.ui.Components.y5 y5Var = this.f20018c;
        ...
        this.f20017b.setPadding(i13, 0, i12, 0);
        d();
    }
    ...
    public final void d() {
        ...
        this.f20018c.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, i10, false));
        ...
        ImageView imageView = this.f20019f;
        imageView.setColorFilter(w04, mode);
        imageView.setBackground(org.telegram.ui.ActionBar.w5.c(null, org.telegram.ui.ActionBar.w5.b(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.w5.f19902a, false))));
    }

    @Override
    public final void onMeasure(int i10, int i11) {
        super.onMeasure(i10, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.displaySize.y, Integer.MIN_VALUE));
        LinearLayout linearLayout = this.f20017b;
        ...
        this.f20019f.setTranslationY((getPaddingBottom() - getPaddingTop()) / 2.0f);
        this.f20020n.setTranslationY((getPaddingBottom() - getPaddingTop()) / 2.0f);
