...
public abstract class a3 extends LinearLayout implements NotificationCenter.NotificationCenterDelegate {
    public int f20793a;
    public org.telegram.ui.Components.p9 f20794b;
    ...
    public final void a() {
        ...
        org.telegram.ui.Components.p9 p9Var = this.f20794b;
        ...
        if (document != null) {
            SvgHelper.SvgDrawable svgThumb = DocumentObject.getSvgThumb(document.thumbs, org.telegram.ui.ActionBar.j6.f19827a7, 0.2f);
            if (svgThumb != null) {
                svgThumb.overrideWidthAndHeight(512, 512);
            }
            this.f20794b.i(ImageLocation.getForDocument(document), "130_130", "tgs", svgThumb, tL_messages_stickerSet);
    ...
    public final void onAttachedToWindow() {
        ...
        NotificationCenter.getInstance(this.f20793a).addObserver(this, NotificationCenter.diceStickersDidLoad);
    }
    ...
    public void set(TLRPC.RequestPeerType requestPeerType) {
        ...
        TextView textView2 = this.f20795c;
