...
public final class x6 extends FrameLayout {
    ...
    public final void a(CharSequence charSequence, String[] strArr, boolean z10, boolean z11) {
        ...
        TextView textView2 = this.f23537b;
        if (z10) {
            ...
            if (strArr != null) {
                ...
                for (int i11 = 0; i11 < strArr.length; i11++) {
                    if (i11 != 0) {
                        ...
                        mutate2.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f21062z6, false), PorterDuff.Mode.MULTIPLY));
        ...
        if (strArr != null) {
            ...
            for (int i11 = 0; i11 < strArr.length; i11++) {
                if (i11 != 0) {
                    ...
                    Drawable mutate = getContext().getResources().getDrawable(R.drawable.settings_arrow).mutate();
                    mutate.setBounds(0, 0, mutate.getIntrinsicWidth(), mutate.getIntrinsicHeight());
                    mutate.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f21062z6, false), PorterDuff.Mode.MULTIPLY));
                    spannableStringBuilder.setSpan(new w6(mutate), spannableStringBuilder.length() - 2, spannableStringBuilder.length() - 1, 33);
                }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.d) {
            if (LocaleController.isRTL) {
                ...
                dp = AndroidUtilities.dp(this.f23539e);
            }
            float measuredHeight = getMeasuredHeight() - 1;
            int measuredWidth = getMeasuredWidth();
            if (LocaleController.isRTL) {
                i10 = AndroidUtilities.dp(this.f23539e);
            } else {
                i10 = 0;
            }
