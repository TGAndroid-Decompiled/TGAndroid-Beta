...
public class i3 extends FrameLayout {
    ...
    public final org.telegram.ui.Components.f5 f20233r;
    public int f20234s;
    ...
    public i3(Context context, String str, boolean z10, boolean z11, int i10, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        int i12;
        this.e = -1;
        this.f20233r = new org.telegram.ui.Components.f5(this);
        ...
        g3Var.setTextColor(org.telegram.ui.ActionBar.i6.v0(i13, e6Var));
        ...
        g3Var.setHint(str);
        g3Var.setCursorColor(org.telegram.ui.ActionBar.i6.v0(i13, e6Var));
    ...
    public final void c() {
        ...
        this.f20234s = this.f20230c - getText().length();
        String str = "";
        if ((!TextUtils.isEmpty(getText()) || this.d) && ((!this.f20231f || (this.f20232n && !this.h)) && ((i10 = this.e) == -1 || this.f20234s <= i10))) {
            str = "" + this.f20234s;
        }
