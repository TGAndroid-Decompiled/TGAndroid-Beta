...
public final class u7 extends FrameLayout {
    public q7[] f23364a;
    public MessageObject[] f23365b;
    public int[] f23366c;
    public r7 d;
    public int f23367e;
    public boolean f23368f;
    public boolean h;
    public Paint f23369n;
    public int f23370r;
    public int f23371s;
    ...
    public final void b(int i10, boolean z10) {
        float f7;
        q7 q7Var = this.f23364a[i10];
        FrameLayout frameLayout = q7Var.f22522f;
        mp mpVar = q7Var.f22521e;
    ...
    public final void c(int i10, int i11, MessageObject messageObject) {
        q7[] q7VarArr = this.f23364a;
        MessageObject[] messageObjectArr = this.f23365b;
        messageObjectArr[i10] = messageObject;
        this.f23366c[i10] = i11;
    ...
    public final void onMeasure(int i10, int i11) {
        int a2;
        int dp;
        View[] viewArr = this.f23364a;
        if (this.f23370r == 1) {
            a2 = wl.A(2.0f, this.f23367e - 1, View.MeasureSpec.getSize(i10)) / this.f23367e;
        } else {
            a2 = a(this.f23367e);
        }
        this.h = true;
        int i12 = 0;
        for (int i13 = 0; i13 < this.f23367e; i13++) {
            ...
            if (i13 == this.f23367e - 1) {
                if (AndroidUtilities.isTablet()) {
                    layoutParams.width = AndroidUtilities.dp(490.0f) - ((AndroidUtilities.dp(2.0f) + a2) * (this.f23367e - 1));
                } else {
                    layoutParams.width = AndroidUtilities.displaySize.x - ((AndroidUtilities.dp(2.0f) + a2) * (this.f23367e - 1));
                }
            } else {
