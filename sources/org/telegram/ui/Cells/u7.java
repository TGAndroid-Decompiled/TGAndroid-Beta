...
public final class u7 extends FrameLayout {
    public q7[] f21452a;
    public MessageObject[] f21453b;
    public int[] f21454c;
    public r7 d;
    public int e;
    public boolean f21455f;
    public boolean h;
    public Paint f21456n;
    public int f21457r;
    public int f21458s;
    ...
    public final void b(int i10, boolean z10) {
        float f7;
        q7 q7Var = this.f21452a[i10];
        FrameLayout frameLayout = q7Var.f20623f;
        np npVar = q7Var.e;
    ...
    public final void c(int i10, int i11, MessageObject messageObject) {
        q7[] q7VarArr = this.f21452a;
        MessageObject[] messageObjectArr = this.f21453b;
        messageObjectArr[i10] = messageObject;
        this.f21454c[i10] = i11;
    ...
    public final void onMeasure(int i10, int i11) {
        int a2;
        int dp;
        View[] viewArr = this.f21452a;
        if (this.f21457r == 1) {
            a2 = wl.A(2.0f, this.e - 1, View.MeasureSpec.getSize(i10)) / this.e;
        } else {
            a2 = a(this.e);
        }
        this.h = true;
