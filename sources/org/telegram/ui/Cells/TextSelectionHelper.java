...
public abstract class TextSelectionHelper<Cell extends SelectableView> {
    ...
    public TextSelectionHelper() {
        ...
        this.showActionsRunnable = new Runnable() {
            @Override
                    ...
                    if (i4 >= 0 && i4 <= length) {
                        ...
                        if (layout != null) {
                            ...
                            if (f5 <= r13.keyboardSize + i2 || f5 >= r13.parentView.getMeasuredHeight()) {
                                ...
                                this.path.reset();
                                this.path.addCircle(f7, f7, f7, Path.Direction.CCW);
                                this.path.addRect(0.0f, 0.0f, f7, f7, Path.Direction.CCW);
                                ...
                                this.path.reset();
                                this.path.addCircle(f10, f10, f10, Path.Direction.CCW);
                                this.path.addRect(f10, 0.0f, f9, f10, Path.Direction.CCW);
                                canvas.drawPath(this.path, this.handleViewPaint);
                                canvas.restore();
                                float f11 = f2 + f3;
                    ...
                    if (i8 >= 0 && i8 <= length3) {
                        ...
                        if (layout2 != null) {
                            ...
                            if (f16 <= i2 + r12.keyboardSize || f16 >= r12.parentView.getMeasuredHeight()) {
                                ...
                                this.path.addRect(f18, 0.0f, f17, f18, Path.Direction.CCW);
                                canvas.drawPath(this.path, this.handleViewPaint);
                                canvas.restore();
                                float f19 = f13 + f14;
                                ...
                                this.path.reset();
                                this.path.addCircle(f21, f21, f21, Path.Direction.CCW);
                                this.path.addRect(0.0f, 0.0f, f21, f21, Path.Direction.CCW);
                                canvas.drawPath(this.path, this.handleViewPaint);
                                canvas.restore();
                                float f22 = f13 + f14;
    ...
    public class AnonymousClass4 implements ActionMode.Callback {
        ...
        public boolean onCreateActionMode(ActionMode actionMode, Menu menu) {
            ...
            menu.add(0, 3, 3, LocaleController.getString("TranslateMessage", org.telegram.messenger.R.string.TranslateMessage));
            return true;
        }
