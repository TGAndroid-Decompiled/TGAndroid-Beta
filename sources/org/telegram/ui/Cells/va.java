...
public final class va implements View.OnClickListener {
    ...
    public final void onClick(View view) {
        ...
        int i11;
        int i12;
        int i13 = this.f21474a;
        AndroidUtilities.VcardItem vcardItem = null;
        boolean z13 = false;
        int i14 = 0;
        boolean z14 = false;
        int i15 = this.f21475b;
        Object obj = this.d;
        Object obj2 = this.f21476c;
        switch (i13) {
            case 0:
                xa xaVar = (xa) obj2;
                xaVar.e.a(true, true);
            ...
            case 2:
                ...
                if (view.isEnabled() && !aeVar.N && !jeVar.K0.N) {
                    ...
                    if (jeVar.L0 > currentTime) {
                        ...
                        vc.a0(za1Var).L(jeVar.getContext().getResources().getDrawable(R.drawable.star_small_inner).mutate(), AndroidUtilities.replaceSingleTag(LocaleController.formatPluralString("BotStarsWithdrawMinLimit", (int) MessagesController.getInstance(i15).starsRevenueWithdrawalMin, new Object[0]), new md(jeVar, i15, 1))).j();
                        return;
                    } else {
                        ...
                        twoStepVerificationActivity.s0(new sd(jeVar, za1Var, twoStepVerificationActivity, 2));
                        return;
                    }
                }
                return;
            ...
            case 4:
                ...
                if (boVar2.f32276d5 != null && i15 < arrayList.size()) {
            ...
            case 6:
                ...
                TLRPC.TL_chatBannedRights tL_chatBannedRights = fsVar.f24081w0;
                boolean z15 = !z13;
            ...
            case 7:
                l40 l40Var = (l40) obj2;
                l40Var.f25830n = i15;
                l40Var.f25827b.d(view.getLeft(), false);
                l40Var.f25828c.d(view.getRight(), false);
            ...
            case 8:
                ...
                TextView textView = pe0Var.f27023n;
                ArrayList arrayList2 = pe0Var.M;
                org.telegram.ui.ActionBar.n2 n2Var = pe0Var.f27024r;
                int i16 = pe0Var.F;
            ...
            case 9:
                ...
                n2Var2.getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.channelRecommendationsLoaded, Long.valueOf(-yu0Var.f30364j1));
                n2Var2.getMessagesController().addUserToChat(chat.f18109id, n2Var2.getUserConfig().getCurrentUser(), 0, null, n2Var2, new ar0(2, ht0Var, chat));
                return;
            case 10:
                ((k41) obj2).run();
            ...
            case 14:
                ...
                bundle.putLong("dialog_id", ((q41) saveToGallerySettingsActivity.f31431s.get(i15)).f36757c.dialogId);
                bundle.putInt("type", saveToGallerySettingsActivity.f31425a);
                saveToGallerySettingsActivity.presentFragment(new SaveToGallerySettingsActivity(bundle));
                return;
            case 15:
                wx wxVar = (wx) obj;
                h71 h71Var = ((g61) obj2).f33783c;
                if (!wxVar.e && !UserConfig.getInstance(h71Var.V).isPremium()) {
                    org.telegram.ui.ActionBar.n2 R2 = LaunchActivity.R();
                    if (R2 != null) {
                        R2.showDialog(new rg.x0(h71Var.f34122c1, h71Var.getContext(), h71Var.V, 11, false));
                        return;
                    }
                    return;
                }
                ...
                while (true) {
                    ...
                    if (i21 < e61Var.getChildCount()) {
                        if ((e61Var.getChildAt(i21) instanceof l61) && (R = RecyclerView.R((view2 = e61Var.getChildAt(i21)))) >= 0 && h71Var.f34170y0.get(R) == i15) {
                ...
                sv.W(null, wxVar.f29820b, false, null, null);
                h71Var.B0.add(Long.valueOf(wxVar.f29820b.f18136id));
            ...
            case 17:
                ...
                ((r8) ((View) obj2)).u(org.telegram.ui.web.o1.a().f39051a, true);
                ((Dialog) ((AtomicReference) obj).get()).dismiss();
                return;
            case 18:
                qg.u1 u1Var = (qg.u1) obj2;
                u1Var.a(i15);
                u1Var.f41661b.v().i(i15 - 1, true);
                u1Var.f41661b.b((pg.m) obj);
                return;
            case 19:
                nr0 nr0Var = (nr0) obj2;
                ...
                boolean z17 = npVar.f26546a.f21969q;
                vc a02 = vc.a0(n2Var3);
                if (z17) {
                ...
                togglechatstargiftnotifications.peer = MessagesController.getInstance(i15).getInputPeer(nr0Var.f46103c);
            ...
            case 20:
                ...
                int flag = TLObject.setFlag(m5Var.f47402g & i14, i15, !TLObject.hasFlag(i12, i15));
                if (flag == 0) {
                    flag = (~i15) & i14;
                }
                int i23 = m5Var.f47402g;
