...
public final class va implements View.OnClickListener {
    ...
    public va(eo eoVar, TLRPC.User user, String str, boolean z10, int i10) {
        this.d = eoVar;
        this.e = str;
        this.f20573b = z10;
        this.f20574c = i10;
    ...
    public final void onClick(View view) {
        ...
        switch (i12) {
            case 0:
                ...
                MessagesController.getInstance(i13).getUnconfirmedAuthController().confirm(arrayList, new org.telegram.ui.ActionBar.l3(2));
            ...
            default:
                ...
                if (eoVar.getParentActivity() != null) {
                    ...
                    h3Var.show();
                    textView2.setOnClickListener(new org.telegram.ui.Components.d3(h3Var, 0));
                    return;
                }
                return;
        }
    ...
    public va(wy wyVar, boolean z10, int i10, ArrayList arrayList) {
        this.d = wyVar;
        this.f20573b = z10;
        this.f20574c = i10;
        this.e = arrayList;
