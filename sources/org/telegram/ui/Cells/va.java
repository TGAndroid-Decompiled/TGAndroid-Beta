...
public final class va extends TextView {
    ...
    public final void onDraw(Canvas canvas) {
        Canvas canvas2;
        float e = this.f21707b.e(this.f21706a);
        if (e > 0.0f) {
            if (e < 1.0f) {
                canvas2 = canvas;
            ...
            float f10 = 1.0f - e;
            this.f21708c.setBounds(getWidth() / 2, (getHeight() / 2) + ((int) (AndroidUtilities.dp(12.0f) * f10)), getWidth() / 2, (getHeight() / 2) + ((int) (f10 * AndroidUtilities.dp(12.0f))));
            this.f21708c.setAlpha((int) (e * 255.0f));
            this.f21708c.draw(canvas2);
            invalidate();
            return;
        }
        super.onDraw(canvas);
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        if (this.f21708c != drawable && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
