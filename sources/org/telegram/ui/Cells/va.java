...
public final class va implements View.OnClickListener {
    ...
    public final void onClick(View view) {
        ...
        int i11;
        int i12;
        int i13 = this.f21498a;
        AndroidUtilities.VcardItem vcardItem = null;
        boolean z13 = false;
        int i14 = 0;
        boolean z14 = false;
        int i15 = this.f21499b;
        Object obj = this.d;
        Object obj2 = this.f21500c;
        switch (i13) {
            case 0:
                xa xaVar = (xa) obj2;
                xaVar.e.a(true, true);
            ...
            case 4:
                ...
                if (boVar2.f32262d5 != null && i15 < arrayList.size()) {
            ...
            case 6:
                ...
                TLRPC.TL_chatBannedRights tL_chatBannedRights = fsVar.f24008w0;
                boolean z15 = !z13;
            ...
            case 7:
                l40 l40Var = (l40) obj2;
                l40Var.f25819n = i15;
                l40Var.f25816b.d(view.getLeft(), false);
                l40Var.f25817c.d(view.getRight(), false);
            ...
            case 8:
                ...
                TextView textView = pe0Var.f27016n;
            ...
            case 9:
                ...
                o2Var2.getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.channelRecommendationsLoaded, Long.valueOf(-zu0Var.f30634j1));
            ...
            case 14:
                ...
                bundle.putLong("dialog_id", ((r41) saveToGallerySettingsActivity.f31451s.get(i15)).f37083c.dialogId);
                bundle.putInt("type", saveToGallerySettingsActivity.f31445a);
                saveToGallerySettingsActivity.presentFragment(new SaveToGallerySettingsActivity(bundle));
                return;
            case 15:
                wx wxVar = (wx) obj;
                i71 i71Var = ((h61) obj2).f34197c;
                if (!wxVar.e && !UserConfig.getInstance(i71Var.V).isPremium()) {
                    org.telegram.ui.ActionBar.o2 R = LaunchActivity.R();
                    if (R != null) {
                        R.showDialog(new rg.x0(i71Var.f34456c1, i71Var.getContext(), i71Var.V, 11, false));
                        return;
                    }
                    return;
                }
                ...
                while (true) {
                    ...
                    if (i21 < f61Var.getChildCount()) {
                        if ((f61Var.getChildAt(i21) instanceof m61) && (S = RecyclerView.S((view2 = f61Var.getChildAt(i21)))) >= 0 && i71Var.f34504y0.get(S) == i15) {
                ...
                sv.W(null, wxVar.f29762b, false, null, null);
                i71Var.B0.add(Long.valueOf(wxVar.f29762b.f18148id));
            ...
            case 17:
                ...
                ((r8) ((View) obj2)).u(org.telegram.ui.web.o1.a().f38894a, true);
                ((Dialog) ((AtomicReference) obj).get()).dismiss();
                return;
            case 18:
                qg.u1 u1Var = (qg.u1) obj2;
                u1Var.a(i15);
                u1Var.f41692b.v().i(i15 - 1, true);
                u1Var.f41692b.b((pg.m) obj);
                return;
            case 19:
                or0 or0Var = (or0) obj2;
                ...
                boolean z17 = npVar.f26511a.f21985q;
                vc a02 = vc.a0(o2Var3);
                if (z17) {
                ...
                togglechatstargiftnotifications.peer = MessagesController.getInstance(i15).getInputPeer(or0Var.f46135c);
            ...
            case 20:
                ...
                int flag = TLObject.setFlag(n5Var.f47522g & i14, i15, !TLObject.hasFlag(i12, i15));
                if (flag == 0) {
                    flag = (~i15) & i14;
                }
                int i23 = n5Var.f47522g;
