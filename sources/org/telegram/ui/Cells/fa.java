...
public final class fa extends FrameLayout {
    ...
    public final void a(String str, boolean z4, boolean z10) {
        ...
        ImageView imageView = this.f22822b;
        if (z4) {
            i10 = 0;
        } else {
            i10 = 4;
    ...
    public final void onMeasure(int i10, int i11) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i10), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(50.0f) + (this.f22823c ? 1 : 0), 1073741824));
    }
