    ...
    public final boolean onPreDraw() {
        ...
        switch (i10) {
            case 0:
                ...
                return false;
            case 1:
                ((mu) obj).f28542a.f30735c.getViewTreeObserver().removeOnPreDrawListener(this);
                return true;
            case 2:
                z20 z20Var = (z20) obj;
                d30 d30Var = z20Var.f33090f;
                org.telegram.ui.u7 u7Var = z20Var.f33089e;
                u7Var.getViewTreeObserver().removeOnPreDrawListener(this);
                int[] iArr = z20Var.G;
                u7Var.getLocationOnScreen(iArr);
                float f7 = z20Var.f33092r.x + z20Var.Q;
                f30 f30Var = z20Var.U;
                float measuredWidth = ((f30Var.getMeasuredWidth() / 2.0f) + f7) - iArr[0];
                float measuredWidth2 = ((f30Var.getMeasuredWidth() / 2.0f) + (z20Var.f33092r.y + z20Var.R)) - iArr[1];
            ...
            case 3:
                ...
                return true;
            default:
                b91 b91Var = (b91) ((j50) obj).f27382b;
                b91Var.f24661n.getViewTreeObserver().removeOnPreDrawListener(this);
                ImageView imageView = b91Var.f24652e;
                if (imageView != null) {
                    imageView.setVisibility(4);
                    b91Var.f24652e.setImageDrawable(null);
