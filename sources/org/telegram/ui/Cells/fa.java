    ...
    public final boolean onPreDraw() {
        ...
        switch (i10) {
            case 0:
                ...
                return false;
            case 1:
                ((ou) obj).f26885a.f29428c.getViewTreeObserver().removeOnPreDrawListener(this);
                return true;
            case 2:
                z20 z20Var = (z20) obj;
                d30 d30Var = z20Var.f30459f;
                org.telegram.ui.u7 u7Var = z20Var.e;
                u7Var.getViewTreeObserver().removeOnPreDrawListener(this);
                int[] iArr = z20Var.G;
                u7Var.getLocationOnScreen(iArr);
                float f7 = z20Var.f30461r.x + z20Var.Q;
                f30 f30Var = z20Var.U;
                float measuredWidth = ((f30Var.getMeasuredWidth() / 2.0f) + f7) - iArr[0];
                float measuredWidth2 = ((f30Var.getMeasuredWidth() / 2.0f) + (z20Var.f30461r.y + z20Var.R)) - iArr[1];
            ...
            case 3:
                ...
                return true;
            default:
                c91 c91Var = (c91) ((j50) obj).f25232b;
                c91Var.f23030n.getViewTreeObserver().removeOnPreDrawListener(this);
