...
public class s8 extends FrameLayout {
    ...
    public boolean O;
    public int P;
    public final org.telegram.ui.ActionBar.i5 f20926a;
    public final org.telegram.ui.ActionBar.i5 f20927b;
    public final org.telegram.ui.Components.p6 f20928c;
    public final org.telegram.ui.ActionBar.i5 d;
    public final bj0 e;
    public Switch f20929f;
    ...
    public static SpannableStringBuilder a(String str) {
        ...
        a10 a10Var = new a10();
        a10Var.f31635f = org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.Lj, false);
        spannableStringBuilder.setSpan(a10Var, spannableStringBuilder.length() - 1, spannableStringBuilder.length(), 0);
        return spannableStringBuilder;
    }

    public final boolean b() {
        Switch r02 = this.f20929f;
        if (r02 != null && r02.h) {
            return true;
        }
        return false;
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        if (o5Var3 != null) {
            o5Var3.setBounds((getWidth() - this.K.f26598s) - AndroidUtilities.dp(18.0f), (getHeight() - this.K.f26598s) / 2, getWidth() - AndroidUtilities.dp(18.0f), (getHeight() + this.K.f26598s) / 2);
            this.K.draw(canvas);
        }
    }
    ...
    public final void e(int i10, int i11) {
        ...
        org.telegram.ui.ActionBar.i5 i5Var = this.f20926a;
    ...
    public final void g(boolean z10) {
        ...
        ViewPropertyAnimator animate = this.f20926a.animate();
        float f12 = 0.5f;
        if (z10) {
            f7 = 1.0f;
        } else {
        ...
        ViewPropertyAnimator animate2 = this.f20927b.animate();
        if (z10) {
            f10 = 1.0f;
        } else {
            f10 = 0.5f;
        ...
        ViewPropertyAnimator animate3 = this.f20928c.animate();
        if (z10) {
            f11 = 1.0f;
        } else {
            f11 = 0.5f;
    ...
    public final void i(CharSequence charSequence, boolean z10) {
        ...
        i5Var.i(null);
        this.M = null;
        org.telegram.ui.Components.p6 p6Var = this.f20928c;
    ...
    public final void j(CharSequence charSequence, boolean z10, boolean z11) {
        ...
        this.h.setVisibility(8);
        this.f20931r = z11;
        Switch r62 = this.f20929f;
        if (r62 != null) {
            r62.setVisibility(0);
            this.f20929f.c(z10, false);
        }
        setWillNotDraw(!this.f20931r);
        org.telegram.ui.Components.o5 o5Var = this.K;
        if (o5Var != null) {
            o5Var.g(null, false);
        }
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (this.f20929f != null) {
            ...
            accessibilityNodeInfo.setChecked(this.f20929f.h);
    ...
    public void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (LocaleController.isRTL) {
            measuredWidth = AndroidUtilities.dp(this.f20930n - 6);
        } else {
            measuredWidth = (i18 - p6Var.getMeasuredWidth()) - AndroidUtilities.dp(this.f20930n - 6);
        }
        if (this.f20935y && !LocaleController.isRTL) {
            measuredWidth = (i18 - p6Var.getMeasuredWidth()) - AndroidUtilities.dp(this.f20930n);
        }
        p6Var.layout(measuredWidth, max, p6Var.getMeasuredWidth() + measuredWidth, p6Var.getMeasuredHeight() + max);
        if (LocaleController.isRTL) {
            measuredWidth2 = AndroidUtilities.dp(this.f20930n - 6);
        } else {
            measuredWidth2 = (i18 - i5Var.getMeasuredWidth()) - AndroidUtilities.dp(this.f20930n - 6);
        }
        i5Var.layout(measuredWidth2, max, i5Var.getMeasuredWidth() + measuredWidth2, i5Var.getMeasuredHeight() + max);
        boolean z11 = LocaleController.isRTL;
        bj0 bj0Var = this.e;
        org.telegram.ui.ActionBar.i5 i5Var2 = this.f20926a;
        if (z11) {
        ...
        org.telegram.ui.ActionBar.i5 i5Var3 = this.f20927b;
        if (i5Var3.getVisibility() == 0) {
            ...
            float f10 = i15;
            int dp2 = AndroidUtilities.dp(1.0f) + ul.y(f10, (i17 - i5Var2.getTextHeight()) - i5Var3.getTextHeight(), 2);
        ...
        if (bj0Var.getVisibility() == 0) {
            ...
            if (!LocaleController.isRTL) {
                measuredWidth5 = AndroidUtilities.dp(this.f20933w);
            } else {
                measuredWidth5 = (i18 - bj0Var.getMeasuredWidth()) - AndroidUtilities.dp(this.f20933w);
            }
        ...
        Switch r92 = this.f20929f;
        if (r92 != null && r92.getVisibility() == 0) {
            int measuredHeight = (i17 - this.f20929f.getMeasuredHeight()) / 2;
            if (LocaleController.isRTL) {
                measuredWidth3 = AndroidUtilities.dp(22.0f);
            } else {
                measuredWidth3 = (i18 - this.f20929f.getMeasuredWidth()) - AndroidUtilities.dp(22.0f);
            }
            Switch r10 = this.f20929f;
            r10.layout(measuredWidth3, measuredHeight, r10.getMeasuredWidth() + measuredWidth3, this.f20929f.getMeasuredHeight() + measuredHeight);
        }
    }
    ...
    public void onMeasure(int i10, int i11) {
        ...
        this.L = size;
        boolean z10 = this.f20935y;
        org.telegram.ui.ActionBar.i5 i5Var = this.f20927b;
        org.telegram.ui.ActionBar.i5 i5Var2 = this.d;
        org.telegram.ui.ActionBar.i5 i5Var3 = this.f20926a;
        if (z10) {
            i5Var3.measure(ul.d(this.f20930n + 71, size, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), 1073741824));
            i5Var.measure(ul.d(this.f20930n + 71, size, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), 1073741824));
            int dp2 = (size - AndroidUtilities.dp(this.f20930n + 103)) - i5Var3.getTextWidth();
            if (LocaleController.isRTL) {
            ...
            int dp3 = (size - AndroidUtilities.dp(this.f20930n + 103)) - i5Var3.getTextWidth();
            if (LocaleController.isRTL) {
            ...
            int dp4 = size - AndroidUtilities.dp(this.f20930n);
            if (LocaleController.isRTL) {
            ...
            int dp5 = size - AndroidUtilities.dp(this.f20930n);
            if (LocaleController.isRTL) {
            ...
            i5Var3.measure(View.MeasureSpec.makeMeasureSpec(Math.max(0, (size - AndroidUtilities.dp(this.f20930n + 71)) - max), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), 1073741824));
            i5Var.measure(View.MeasureSpec.makeMeasureSpec((size - AndroidUtilities.dp(this.f20930n + 71)) - max, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), 1073741824));
        }
        bj0 bj0Var = this.e;
        if (bj0Var.getVisibility() == 0) {
        ...
        setMeasuredDimension(size, dp + (this.f20931r ? 1 : 0));
    }
    ...
    public final void s(CharSequence charSequence, CharSequence charSequence2, boolean z10, int i10, boolean z11) {
        ...
        if (charSequence2 != null) {
            ...
            this.M = charSequence2;
            p6Var.c(TextUtils.ellipsize(charSequence2, p6Var.getPaint(), (int) Math.max(1.0f, AndroidUtilities.displaySize.x - ((g10 + AndroidUtilities.dp(this.f20932s)) + AndroidUtilities.dp(16.0f))), TextUtils.TruncateAt.END), z10, true);
        } else {
            p6Var.c("", z10, true);
        }
        p6Var.setVisibility(0);
    ...
    public final void v() {
        ...
        if (i10 != org.telegram.ui.ActionBar.h6.f18895j5 && i10 != org.telegram.ui.ActionBar.h6.G6) {
            v02 = c(v02);
        }
        i5Var.setTextColor(v02);
        bj0 bj0Var = this.e;
        if (bj0Var.getTag() instanceof Integer) {
            ...
            if (intValue != org.telegram.ui.ActionBar.h6.J5 && intValue != org.telegram.ui.ActionBar.h6.f18953m6) {
                v03 = c(v03);
            }
            bj0Var.setColorFilter(new PorterDuffColorFilter(v03, PorterDuff.Mode.SRC_IN));
        }
        this.f20927b.setTextColor(c(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19170y6, d6Var)));
        int i11 = org.telegram.ui.ActionBar.h6.I6;
        this.f20928c.setTextColor(c(org.telegram.ui.ActionBar.h6.v0(i11, d6Var)));
    ...
    public s8(int i10, Context context, org.telegram.ui.ActionBar.d6 d6Var, boolean z10, boolean z11) {
        ...
        this.f20926a = i5Var;
        i5Var.setTextColor(org.telegram.ui.ActionBar.h6.v0(z10 ? org.telegram.ui.ActionBar.h6.f18895j5 : org.telegram.ui.ActionBar.h6.G6, d6Var));
        ...
        this.f20927b = i5Var2;
        i5Var2.setTextColor(org.telegram.ui.ActionBar.h6.v0(z10 ? org.telegram.ui.ActionBar.h6.p5 : org.telegram.ui.ActionBar.h6.f19170y6, d6Var));
        ...
        this.f20928c = p6Var;
        p6Var.setTextColor(org.telegram.ui.ActionBar.h6.v0(z10 ? org.telegram.ui.ActionBar.h6.f18972n5 : org.telegram.ui.ActionBar.h6.I6, d6Var));
        ...
        if (!i5Var3.P) {
            i5Var3.f19226n0 = true;
            i5Var3.f19228p0 = bool;
            i5Var3.m();
            i5Var3.b();
        }
        i5Var3.f19229q0 = 18;
        i5Var3.m();
        i5Var3.setTextColor(org.telegram.ui.ActionBar.h6.v0(z10 ? org.telegram.ui.ActionBar.h6.f18972n5 : org.telegram.ui.ActionBar.h6.I6, d6Var));
        ...
        imageView.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.h6.v0(z10 ? org.telegram.ui.ActionBar.h6.J5 : org.telegram.ui.ActionBar.h6.f18953m6, d6Var), PorterDuff.Mode.SRC_IN));
        addView(imageView);
        ...
        if (z11) {
            ...
            addView(this.f20929f, w7.x5.d(37, 20.0f, (LocaleController.isRTL ? 3 : 5) | 16, 22.0f, 0.0f, 22.0f, 0.0f));
        }
        setFocusable(true);
    }
