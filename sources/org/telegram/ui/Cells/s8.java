...
public class s8 extends FrameLayout {
    ...
    public boolean O;
    public int P;
    public final org.telegram.ui.ActionBar.j5 f21075a;
    public final org.telegram.ui.ActionBar.j5 f21076b;
    public final org.telegram.ui.Components.o6 f21077c;
    public final org.telegram.ui.ActionBar.j5 d;
    public final nj0 e;
    public Switch f21078f;
    ...
    public static SpannableStringBuilder a(String str) {
        ...
        d10 d10Var = new d10();
        d10Var.f32926f = org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.Lj, false);
        spannableStringBuilder.setSpan(d10Var, spannableStringBuilder.length() - 1, spannableStringBuilder.length(), 0);
        return spannableStringBuilder;
    }

    public final boolean b() {
        Switch r02 = this.f21078f;
        if (r02 != null && r02.h) {
            return true;
        }
        return false;
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        if (n5Var3 != null) {
            n5Var3.setBounds((getWidth() - this.K.f26637s) - AndroidUtilities.dp(18.0f), (getHeight() - this.K.f26637s) / 2, getWidth() - AndroidUtilities.dp(18.0f), (getHeight() + this.K.f26637s) / 2);
            this.K.draw(canvas);
        }
    }
    ...
    public final void e(int i10, int i11) {
        ...
        org.telegram.ui.ActionBar.j5 j5Var = this.f21075a;
    ...
    public final void g(boolean z10) {
        ...
        ViewPropertyAnimator animate = this.f21075a.animate();
        float f12 = 0.5f;
        if (z10) {
            f7 = 1.0f;
        } else {
        ...
        ViewPropertyAnimator animate2 = this.f21076b.animate();
        if (z10) {
            f10 = 1.0f;
        } else {
            f10 = 0.5f;
        ...
        ViewPropertyAnimator animate3 = this.f21077c.animate();
        if (z10) {
            f11 = 1.0f;
        } else {
            f11 = 0.5f;
    ...
    public final void i(CharSequence charSequence, boolean z10) {
        ...
        j5Var.i(null);
        this.M = null;
        org.telegram.ui.Components.o6 o6Var = this.f21077c;
    ...
    public final void j(CharSequence charSequence, boolean z10, boolean z11) {
        ...
        this.h.setVisibility(8);
        this.f21080r = z11;
        Switch r62 = this.f21078f;
        if (r62 != null) {
            r62.setVisibility(0);
            this.f21078f.c(z10, false);
        }
        setWillNotDraw(!this.f21080r);
        org.telegram.ui.Components.n5 n5Var = this.K;
        if (n5Var != null) {
            n5Var.g(null, false);
        }
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (this.f21078f != null) {
            ...
            accessibilityNodeInfo.setChecked(this.f21078f.h);
    ...
    public void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (LocaleController.isRTL) {
            measuredWidth = AndroidUtilities.dp(this.f21079n - 6);
        } else {
            measuredWidth = (i18 - o6Var.getMeasuredWidth()) - AndroidUtilities.dp(this.f21079n - 6);
        }
        if (this.f21084y && !LocaleController.isRTL) {
            measuredWidth = (i18 - o6Var.getMeasuredWidth()) - AndroidUtilities.dp(this.f21079n);
        }
        o6Var.layout(measuredWidth, max, o6Var.getMeasuredWidth() + measuredWidth, o6Var.getMeasuredHeight() + max);
        if (LocaleController.isRTL) {
            measuredWidth2 = AndroidUtilities.dp(this.f21079n - 6);
        } else {
            measuredWidth2 = (i18 - j5Var.getMeasuredWidth()) - AndroidUtilities.dp(this.f21079n - 6);
        }
        j5Var.layout(measuredWidth2, max, j5Var.getMeasuredWidth() + measuredWidth2, j5Var.getMeasuredHeight() + max);
        boolean z11 = LocaleController.isRTL;
        nj0 nj0Var = this.e;
        org.telegram.ui.ActionBar.j5 j5Var2 = this.f21075a;
        if (z11) {
        ...
        org.telegram.ui.ActionBar.j5 j5Var3 = this.f21076b;
        ...
        if (nj0Var.getVisibility() == 0) {
            ...
            if (!LocaleController.isRTL) {
                measuredWidth5 = AndroidUtilities.dp(this.f21082w);
            } else {
                measuredWidth5 = (i18 - nj0Var.getMeasuredWidth()) - AndroidUtilities.dp(this.f21082w);
            }
        ...
        Switch r92 = this.f21078f;
        if (r92 != null && r92.getVisibility() == 0) {
            int measuredHeight = (i17 - this.f21078f.getMeasuredHeight()) / 2;
            if (LocaleController.isRTL) {
                measuredWidth3 = AndroidUtilities.dp(22.0f);
            } else {
                measuredWidth3 = (i18 - this.f21078f.getMeasuredWidth()) - AndroidUtilities.dp(22.0f);
            }
            Switch r10 = this.f21078f;
            r10.layout(measuredWidth3, measuredHeight, r10.getMeasuredWidth() + measuredWidth3, this.f21078f.getMeasuredHeight() + measuredHeight);
        }
    }
    ...
    public void onMeasure(int i10, int i11) {
        ...
        this.L = size;
        boolean z10 = this.f21084y;
        org.telegram.ui.ActionBar.j5 j5Var = this.f21076b;
        org.telegram.ui.ActionBar.j5 j5Var2 = this.d;
        org.telegram.ui.ActionBar.j5 j5Var3 = this.f21075a;
        if (z10) {
            j5Var3.measure(rk.c(this.f21079n + 71, size, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), 1073741824));
            j5Var.measure(rk.c(this.f21079n + 71, size, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), 1073741824));
            int dp2 = (size - AndroidUtilities.dp(this.f21079n + 103)) - j5Var3.getTextWidth();
            if (LocaleController.isRTL) {
            ...
            int dp3 = (size - AndroidUtilities.dp(this.f21079n + 103)) - j5Var3.getTextWidth();
            if (LocaleController.isRTL) {
            ...
            int dp4 = size - AndroidUtilities.dp(this.f21079n);
            if (LocaleController.isRTL) {
            ...
            int dp5 = size - AndroidUtilities.dp(this.f21079n);
            if (LocaleController.isRTL) {
            ...
            j5Var3.measure(View.MeasureSpec.makeMeasureSpec(Math.max(0, (size - AndroidUtilities.dp(this.f21079n + 71)) - max), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), 1073741824));
            j5Var.measure(View.MeasureSpec.makeMeasureSpec((size - AndroidUtilities.dp(this.f21079n + 71)) - max, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), 1073741824));
        }
        nj0 nj0Var = this.e;
        if (nj0Var.getVisibility() == 0) {
        ...
        setMeasuredDimension(size, dp + (this.f21080r ? 1 : 0));
    }
    ...
    public final void s(CharSequence charSequence, CharSequence charSequence2, boolean z10, int i10, boolean z11) {
        ...
        if (charSequence2 != null) {
            ...
            this.M = charSequence2;
            o6Var.c(TextUtils.ellipsize(charSequence2, o6Var.getPaint(), (int) Math.max(1.0f, AndroidUtilities.displaySize.x - ((g10 + AndroidUtilities.dp(this.f21081s)) + AndroidUtilities.dp(16.0f))), TextUtils.TruncateAt.END), z10, true);
        } else {
            o6Var.c("", z10, true);
        }
        o6Var.setVisibility(0);
    ...
    public final void v() {
        ...
        if (i10 != org.telegram.ui.ActionBar.j6.f19216j5 && i10 != org.telegram.ui.ActionBar.j6.G6) {
            v02 = c(v02);
        }
        j5Var.setTextColor(v02);
        nj0 nj0Var = this.e;
        if (nj0Var.getTag() instanceof Integer) {
            ...
            if (intValue != org.telegram.ui.ActionBar.j6.J5 && intValue != org.telegram.ui.ActionBar.j6.f19274m6) {
                v03 = c(v03);
            }
            nj0Var.setColorFilter(new PorterDuffColorFilter(v03, PorterDuff.Mode.SRC_IN));
        }
        this.f21076b.setTextColor(c(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19492y6, f6Var)));
        int i11 = org.telegram.ui.ActionBar.j6.I6;
        this.f21077c.setTextColor(c(org.telegram.ui.ActionBar.j6.v0(i11, f6Var)));
    ...
    public s8(int i10, Context context, org.telegram.ui.ActionBar.f6 f6Var, boolean z10, boolean z11) {
        ...
        this.f21075a = j5Var;
        j5Var.setTextColor(org.telegram.ui.ActionBar.j6.v0(z10 ? org.telegram.ui.ActionBar.j6.f19216j5 : org.telegram.ui.ActionBar.j6.G6, f6Var));
        ...
        this.f21076b = j5Var2;
        j5Var2.setTextColor(org.telegram.ui.ActionBar.j6.v0(z10 ? org.telegram.ui.ActionBar.j6.p5 : org.telegram.ui.ActionBar.j6.f19492y6, f6Var));
        ...
        this.f21077c = o6Var;
        o6Var.setTextColor(org.telegram.ui.ActionBar.j6.v0(z10 ? org.telegram.ui.ActionBar.j6.f19293n5 : org.telegram.ui.ActionBar.j6.I6, f6Var));
        ...
        if (!j5Var3.P) {
            j5Var3.f19028n0 = true;
            j5Var3.f19030p0 = bool;
            j5Var3.m();
            j5Var3.b();
        }
        j5Var3.f19031q0 = 18;
        j5Var3.m();
        j5Var3.setTextColor(org.telegram.ui.ActionBar.j6.v0(z10 ? org.telegram.ui.ActionBar.j6.f19293n5 : org.telegram.ui.ActionBar.j6.I6, f6Var));
        ...
        imageView.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(z10 ? org.telegram.ui.ActionBar.j6.J5 : org.telegram.ui.ActionBar.j6.f19274m6, f6Var), PorterDuff.Mode.SRC_IN));
        addView(imageView);
        ...
        if (z11) {
            ...
            addView(this.f21078f, w7.y5.d(37, 20.0f, (LocaleController.isRTL ? 3 : 5) | 16, 22.0f, 0.0f, 22.0f, 0.0f));
        }
        setFocusable(true);
    }
