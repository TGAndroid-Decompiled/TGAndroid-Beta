...
public final class k extends FrameLayout {
    public final org.telegram.ui.ActionBar.k5 f20358a;
    public final TextView f20359b;
    public final org.telegram.ui.Components.u9 f20360c;
    ...
    public k(Activity activity, boolean z10) {
        ...
        if (z10) {
            ...
            wl.r(textView, org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19073og, false), 1, 15.0f, 1);
    ...
    public final void onAttachedToWindow() {
        ...
        if (this.f20359b == null) {
            this.f20358a.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.G9, false));
        }
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (imageView == null && ((textView = this.f20359b) == null || getLayoutParams().width == -2)) {
            if (View.MeasureSpec.getMode(i10) == Integer.MIN_VALUE) {
                ...
                org.telegram.ui.ActionBar.k5 k5Var = this.f20358a;
    ...
    public void setObject(TLObject tLObject) {
        ...
        org.telegram.ui.Components.u9 u9Var = this.f20360c;
        TextView textView = this.f20359b;
