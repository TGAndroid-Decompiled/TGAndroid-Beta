...
public final class k extends FrameLayout {
    public final org.telegram.ui.ActionBar.j5 f22230a;
    public final TextView f22231b;
    public final org.telegram.ui.Components.x9 f22232c;
    public final ImageView d;
    public final org.telegram.ui.Components.i9 f22233e;
    public int f22234f;
    ...
    public k(Activity activity, boolean z10) {
        ...
        if (z10) {
            ...
            this.f22231b = textView;
            vl.r(textView, org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20899og, false), 1, 15.0f, 1);
    ...
    public final void onAttachedToWindow() {
        ...
        if (this.f22231b == null) {
            this.f22230a.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.G9, false));
        }
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (imageView == null && ((textView = this.f22231b) == null || getLayoutParams().width == -2)) {
            if (View.MeasureSpec.getMode(i10) == Integer.MIN_VALUE) {
                ...
                org.telegram.ui.ActionBar.j5 j5Var = this.f22230a;
    ...
    public void setObject(TLObject tLObject) {
        ...
        org.telegram.ui.Components.x9 x9Var = this.f22232c;
        TextView textView = this.f22231b;
        org.telegram.ui.Components.i9 i9Var = this.f22233e;
        if (z10) {
