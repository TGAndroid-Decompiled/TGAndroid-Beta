...
public abstract class h0 extends View {
    ...
    public int f22872n;
    public h90 f22873r;
    public final d90 f22874s;
    public f0 v;
    public final int f22875w;
    public final org.telegram.ui.ActionBar.g6 f22876x;
    public int f22877y;

    public h0(Context context, int i10, org.telegram.ui.ActionBar.g6 g6Var) {
        super(context);
        this.f22874s = new d90(this);
    ...
    public CharSequence getText() {
        StaticLayout staticLayout = this.f22867a;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        int width = (getWidth() - this.f22870e) / 2;
        int dp = AndroidUtilities.dp(2.0f) + this.f22877y;
        Drawable j10 = org.telegram.ui.ActionBar.k6.f21893q3.j();
        if (j10 != null) {
            j10.setBounds(width, dp, this.f22870e + width, this.f22871f + dp);
            j10.draw(canvas);
        }
        ...
        org.telegram.ui.ActionBar.g6 g6Var = this.f22876x;
        if (g6Var != null) {
        ...
        h5Var.setBounds(width, 0, this.f22870e + width, this.f22871f);
        h5Var.draw(canvas);
        z zVar = this.G;
        if (zVar != null) {
            int i12 = this.H;
            ...
            zVar.setBounds(AndroidUtilities.dp(2.0f) + width, AndroidUtilities.dp(2.0f), (this.f22870e + width) - AndroidUtilities.dp(2.0f), this.f22871f - AndroidUtilities.dp(2.0f));
            zVar.draw(canvas);
        }
        int i14 = this.E;
        float f11 = this.f22877y - i14;
        ImageReceiver imageReceiver = this.B;
        imageReceiver.setImageCoords(width + i14, i14, this.f22870e - (i14 * 2), f11);
        imageReceiver.draw(canvas);
        org.telegram.ui.ActionBar.k6.f21855o2.setColor(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.f21685ec, g6Var));
        org.telegram.ui.ActionBar.k6.f21855o2.linkColor = org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.f21722gc, g6Var);
        canvas.save();
        if (this.C) {
            f10 = 14.0f;
        } else {
    ...
    public final void onMeasure(int i10, int i11) {
        setMeasuredDimension(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i10), 1073741824), AndroidUtilities.dp(8.0f) + this.f22871f);
    }
