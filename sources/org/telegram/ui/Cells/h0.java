...
public abstract class h0 extends View {
    ...
    public int f20175n;
    public d90 f20176r;
    public final z80 f20177s;
    public f0 v;
    public final int f20178w;
    public final org.telegram.ui.ActionBar.f6 f20179x;
    public int f20180y;

    public h0(Context context, int i10, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context);
        this.f20177s = new z80(this);
    ...
    public CharSequence getText() {
        StaticLayout staticLayout = this.f20171a;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        int dp = AndroidUtilities.dp(2.0f) + this.f20180y;
        Drawable j3 = org.telegram.ui.ActionBar.j6.f19098q3.j();
        if (j3 != null) {
            j3.setBounds(width, dp, this.e + width, this.f20174f + dp);
            j3.draw(canvas);
        }
        ...
        org.telegram.ui.ActionBar.f6 f6Var = this.f20179x;
        if (f6Var != null) {
        ...
        g5Var.setBounds(width, 0, this.e + width, this.f20174f);
        g5Var.draw(canvas);
        z zVar = this.J;
        if (zVar != null) {
            int i12 = this.K;
            ...
            zVar.setBounds(AndroidUtilities.dp(2.0f) + width, AndroidUtilities.dp(2.0f), (this.e + width) - AndroidUtilities.dp(2.0f), this.f20174f - AndroidUtilities.dp(2.0f));
            zVar.draw(canvas);
        }
        int i14 = this.H;
        float f10 = this.f20180y - i14;
        ImageReceiver imageReceiver = this.E;
        imageReceiver.setImageCoords(width + i14, i14, this.e - (i14 * 2), f10);
        imageReceiver.draw(canvas);
        org.telegram.ui.ActionBar.j6.f19061o2.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.ec, f6Var));
        org.telegram.ui.ActionBar.j6.f19061o2.linkColor = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.gc, f6Var);
        canvas.save();
        if (this.F) {
            f7 = 14.0f;
        } else {
    ...
    public final void onMeasure(int i10, int i11) {
        setMeasuredDimension(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i10), 1073741824), AndroidUtilities.dp(8.0f) + this.f20174f);
    }
