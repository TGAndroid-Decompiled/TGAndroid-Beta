...
public abstract class h0 extends View {
    ...
    public int f20360n;
    public l90 f20361r;
    public final h90 f20362s;
    public f0 v;
    public final int f20363w;
    public final org.telegram.ui.ActionBar.f6 f20364x;
    public int f20365y;

    public h0(Context context, int i10, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context);
        this.f20362s = new h90(this);
    ...
    public CharSequence getText() {
        StaticLayout staticLayout = this.f20356a;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        int dp = AndroidUtilities.dp(2.0f) + this.f20365y;
        Drawable j3 = org.telegram.ui.ActionBar.j6.f19330q3.j();
        if (j3 != null) {
            j3.setBounds(width, dp, this.e + width, this.f20359f + dp);
            j3.draw(canvas);
        }
        ...
        org.telegram.ui.ActionBar.f6 f6Var = this.f20364x;
        if (f6Var != null) {
        ...
        f5Var.setBounds(width, 0, this.e + width, this.f20359f);
        f5Var.draw(canvas);
        z zVar = this.J;
        if (zVar != null) {
            int i12 = this.K;
            ...
            zVar.setBounds(AndroidUtilities.dp(2.0f) + width, AndroidUtilities.dp(2.0f), (this.e + width) - AndroidUtilities.dp(2.0f), this.f20359f - AndroidUtilities.dp(2.0f));
            zVar.draw(canvas);
        }
        int i14 = this.H;
        float f10 = this.f20365y - i14;
        ImageReceiver imageReceiver = this.E;
        imageReceiver.setImageCoords(width + i14, i14, this.e - (i14 * 2), f10);
        imageReceiver.draw(canvas);
        org.telegram.ui.ActionBar.j6.f19292o2.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.ec, f6Var));
        org.telegram.ui.ActionBar.j6.f19292o2.linkColor = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.gc, f6Var);
        canvas.save();
        if (this.F) {
            f7 = 14.0f;
        } else {
    ...
    public final void onMeasure(int i10, int i11) {
        setMeasuredDimension(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i10), 1073741824), AndroidUtilities.dp(8.0f) + this.f20359f);
    }
