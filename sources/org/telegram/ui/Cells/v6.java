...
public final class v6 extends FrameLayout {
    public final TextView f22471a;
    public final TextView f22472b;
    ...
    public v6(Context context) {
        ...
        addView(textView2, k7.b6.d(-2, -2.0f, i13, f12, 33.0f, f13, 0.0f));
        ...
        addView(imageView, k7.b6.d(48, 48.0f, i14, 10.0f, 8.0f, 10.0f, 0.0f));
    }

    public final void a(CharSequence charSequence, String[] strArr, boolean z4, boolean z10) {
        TextView textView = this.f22471a;
        FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) textView.getLayoutParams();
        TextView textView2 = this.f22472b;
        if (z4) {
            ...
            if (strArr != null) {
                ...
                for (int i11 = 0; i11 < strArr.length; i11++) {
                    if (i11 != 0) {
                        ...
                        mutate2.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20273z6, false), PorterDuff.Mode.MULTIPLY));
    ...
    public final void b(CharSequence charSequence, String[] strArr, int i10, boolean z4) {
        ...
        if (strArr != null) {
            ...
            for (int i11 = 0; i11 < strArr.length; i11++) {
                if (i11 != 0) {
                    ...
                    Drawable mutate = getContext().getResources().getDrawable(R.drawable.settings_arrow).mutate();
                    mutate.setBounds(0, 0, mutate.getIntrinsicWidth(), mutate.getIntrinsicHeight());
                    mutate.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20273z6, false), PorterDuff.Mode.MULTIPLY));
                    spannableStringBuilder.setSpan(new u6(mutate), spannableStringBuilder.length() - 2, spannableStringBuilder.length() - 1, 33);
                }
        ...
        ImageView imageView = this.f22473c;
        if (i10 != 0) {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.d) {
            ...
            if (LocaleController.isRTL) {
                i10 = AndroidUtilities.dp(this.e);
            } else {
                i10 = 0;
            }
