...
public final class u5 extends FrameLayout {
    public final TextView f21608a;
    public final LinearLayout f21609b;
    public View.OnClickListener f21610c;
    public int d;
    public final int[] e;
    ...
    public u5(Context context) {
        ...
        this.f21609b = linearLayout;
        linearLayout.setOrientation(0);
        for (int i10 = 0; i10 < this.e.length; i10++) {
            RadioButton radioButton = new RadioButton(context);
            radioButton.setSize(AndroidUtilities.dp(20.0f));
            radioButton.setTag(Integer.valueOf(i10));
            this.f21609b.addView(radioButton, w7.y5.l(1.0f / this.e.length, 0, -1));
            radioButton.setOnClickListener(new a(this, 8));
        }
        addView(this.f21609b, w7.y5.d(-1, 40.0f, 51, 96.0f, 0.0f, 24.0f, 0.0f));
    }

    public final void a(int i10, String str) {
        this.d = i10;
        this.f21608a.setText(str.substring(0, 1).toUpperCase() + str.substring(1).toLowerCase());
        b(false);
    }
    ...
    public final void b(boolean z10) {
        boolean z11;
        int i10;
        LinearLayout linearLayout = this.f21609b;
