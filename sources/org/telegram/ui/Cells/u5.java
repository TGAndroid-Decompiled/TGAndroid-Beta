...
public final class u5 extends FrameLayout {
    ...
    public final LinearLayout f24208b;
    public View.OnClickListener f24209c;
    public int d;
    public final int[] f24210e;

    public u5(Context context) {
        super(context);
        this.f24210e = new int[]{0, -45747, -753630, -13056, -8269183, -9321002, -16747844, -10080879};
        ...
        this.f24208b = linearLayout;
        linearLayout.setOrientation(0);
        for (int i10 = 0; i10 < this.f24210e.length; i10++) {
            RadioButton radioButton = new RadioButton(context);
            radioButton.setSize(AndroidUtilities.dp(20.0f));
            radioButton.setTag(Integer.valueOf(i10));
            this.f24208b.addView(radioButton, k7.c6.l(1.0f / this.f24210e.length, 0, -1));
            radioButton.setOnClickListener(new a(this, 8));
        }
        addView(this.f24208b, k7.c6.d(-1, 40.0f, 51, 96.0f, 0.0f, 24.0f, 0.0f));
    }

    public final void a(int i10, String str) {
        this.d = i10;
        this.f24207a.setText(str.substring(0, 1).toUpperCase() + str.substring(1).toLowerCase());
        b(false);
    }
