...
public final class ma implements ol0, yf.m, ImageReceiver.ImageReceiverDelegate, FlagSecureReason.FlagSecureCondition, op, Utilities.Callback2Return {
    ...
    public void a() {
        switch (this.f20672a) {
            case 4:
                o4 o4Var = (o4) this.f20673b;
                float progress = 1.0f - (o4Var.v.getProgress() * 0.143f);
                org.telegram.ui.Components.v9 v9Var = o4Var.f20758a;
                v9Var.setScaleX(progress);
                v9Var.setScaleY(progress);
                o4Var.invalidate();
                return;
            default:
                h7 h7Var = (h7) this.f20673b;
                float progress2 = 1.0f - (h7Var.d.getProgress() * 0.143f);
                org.telegram.ui.Components.v9 v9Var2 = h7Var.f20412a;
    ...
    public boolean d(int i10, View view) {
        qa qaVar = (qa) this.f20673b;
        qaVar.getClass();
        qaVar.A1(((ThemesHorizontalListCell$InnerThemeView) view).f20001b);
        return true;
    }
    ...
    public void didSetImage(ImageReceiver imageReceiver, boolean z10, boolean z11, boolean z12) {
        ...
        switch (this.f20672a) {
            case 2:
                    ...
                    if (messageObject2 != null && !messageObject2.playedGiftAnimation) {
                        ...
                        if (messageObject2.wasUnread || w0Var.D1) {
                            ...
                            if (w0Var.getContext() instanceof LaunchActivity) {
                                ((LaunchActivity) w0Var.getContext()).f31163x0.c(false);
                            }
                            TLRPC.VideoSize videoSize = w0Var.A1;
                            if (videoSize != null && (t0Var = w0Var.X0) != null) {
                                t0Var.h1(w0Var, w0Var.f21795z1, videoSize);
                                return;
                            }
                            return;
                        }
                        return;
                    } else if (lottieAnimation.f25711a0 < 1) {
                ...
                return;
            default:
                u7 u7Var = (u7) this.f20673b;
                ImageReceiver imageReceiver2 = u7Var.d;
                ImageReceiver imageReceiver3 = u7Var.f21638c;
                if (z10 && !z11 && (messageObject = u7Var.f21650n) != null && messageObject.hasMediaSpoilers() && imageReceiver3.getBitmap() != null) {
                ...
                if (z10 && !z11 && u7Var.f21663w0 && imageReceiver3.getBitmap() != null) {
                    int dominantColor = AndroidUtilities.getDominantColor(imageReceiver3.getBitmap());
                    u7Var.f21634a = dominantColor;
                    CheckBoxBase checkBoxBase = u7Var.P;
                    if (checkBoxBase != null && checkBoxBase.f22215x != (v = org.telegram.ui.ActionBar.j6.v(dominantColor, org.telegram.ui.ActionBar.j6.l1(0.25f, -1)))) {
                        checkBoxBase.f22215x = v;
                        checkBoxBase.b();
                        return;
                    }
                    return;
    ...
    public Object run(Object obj, Object obj2) {
        ...
        return (CharSequence) ((ei.c) this.f20673b).run((Integer) obj2);
    }
    ...
    public boolean run() {
        ...
        l4 l4Var;
        u1 u1Var = (u1) this.f20673b;
        MessageObject messageObject = u1Var.f21590y7;
        if (messageObject == null || (message = messageObject.messageOwner) == null) {
            return false;
        }
        if (messageObject.type != 29 || ((l4Var = u1Var.F7) != null && l4Var.f20613i)) {
            return (message.noforwards && !messageObject.isEphemeral()) || u1Var.f21590y7.isVoiceOnce() || u1Var.f21590y7.hasRevealedExtendedMedia();
        }
        return true;
    }
}
