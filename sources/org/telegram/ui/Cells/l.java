...
public final class l extends FrameLayout {
    public final org.telegram.ui.Components.o6 f20353a;
    public final Paint f20354b;
    public final yf.n f20355c;
    ...
    public l(Context context, int i10) {
        ...
        this.f20354b = paint;
        this.f20355c = new yf.n(new na(this, 1));
        this.e = i10;
    ...
    public final void b(long j3) {
        ...
        org.telegram.ui.Components.o6 o6Var = this.f20353a;
        if (j3 == 0) {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        canvas.drawRoundRect(0.0f, 0.0f, getWidth() - dp, getHeight(), AndroidUtilities.dp(14.0f), AndroidUtilities.dp(14.0f), this.f20354b);
        canvas.restore();
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        if (drawable != this.f20353a && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
