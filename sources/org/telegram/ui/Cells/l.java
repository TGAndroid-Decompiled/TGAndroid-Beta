...
public final class l extends FrameLayout {
    public final org.telegram.ui.Components.o6 f20561a;
    public final Paint f20562b;
    public final yf.n f20563c;
    ...
    public l(Context context, int i10) {
        ...
        this.f20562b = paint;
        this.f20563c = new yf.n(new la(this, 1));
        this.e = i10;
    ...
    public final void b(long j3) {
        ...
        org.telegram.ui.Components.o6 o6Var = this.f20561a;
        if (j3 == 0) {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        canvas.drawRoundRect(0.0f, 0.0f, getWidth() - dp, getHeight(), AndroidUtilities.dp(14.0f), AndroidUtilities.dp(14.0f), this.f20562b);
        canvas.restore();
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        if (drawable != this.f20561a && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
