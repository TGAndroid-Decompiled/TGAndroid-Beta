...
public abstract class r9 extends da {
    public boolean A0;
    public final SparseArray f20884u0 = new SparseArray();
    public boolean f20885v0;
    public boolean f20886w0;
    public boolean f20887x0;
    public boolean f20888y0;
    ...
    public final boolean D() {
        ...
        CharSequence s10;
        String str;
        if (this.f20889z0 && (y9Var = this.W) != null && ((u1) y9Var).getMessageObject() != null && (richMessageLayout = ((u1) this.W).getMessageObject().richLayout) != null && !richMessageLayout.textBlocks.isEmpty() && (s10 = s()) != null && s10.length() != 0) {
            try {
                str = richMessageLayout.getSelectionHtml(this.f20191u, this.v);
            } catch (Exception e) {
                FileLog.e(e);
                str = null;
            }
    ...
    public final void M(y9 y9Var, y9 y9Var2) {
        ...
        this.f20192w = u1Var.getMessageObject().getId();
        try {
            int i10 = u1Var.getMessageObject().messageOwner.edit_date;
        } catch (Exception unused) {
        }
        this.U = 0.0f;
        this.f20885v0 = this.f20886w0;
        this.f20887x0 = this.f20888y0;
        this.f20889z0 = this.A0;
        int i11 = this.f20192w;
        SparseArray sparseArray = this.f20884u0;
        ...
        ofFloat.start();
        sparseArray.put(this.f20192w, ofFloat);
        if (!z10) {
    ...
    public final void X(MessageObject messageObject) {
        ...
        if (this.f20192w == messageObject.getId()) {
            f(true);
        }
    }
    ...
    public final void Y(boolean z10, StaticLayout staticLayout, Canvas canvas) {
        ...
        Paint paint = this.f20181p;
        Paint paint2 = this.f20179o;
        if (z10) {
            int i10 = org.telegram.ui.ActionBar.h6.Vb;
            paint2.setColor(u(i10));
            paint.setColor(u(i10));
        } else {
            int i11 = org.telegram.ui.ActionBar.h6.f19381uf;
            paint2.setColor(u(i11));
            paint.setColor(u(i11));
        }
        i(canvas, staticLayout, this.f20191u, this.v, true, true, 0.0f);
    }
    ...
    public final void Z(MessageObject messageObject, RichMessageLayout richMessageLayout, Canvas canvas) {
        ...
        Canvas canvas2;
        boolean z10;
        if (this.f20889z0 && richMessageLayout != null && (y9Var = this.W) != null && ((u1) y9Var).getMessageObject() != null && ((u1) this.W).getMessageObject().getId() == messageObject.getId()) {
            ...
            while (i12 < richMessageLayout.textBlocks.size()) {
                ...
                if (layout != null && layout.getText() != null) {
                    ...
                    int clamp = Utilities.clamp(this.f20191u - intValue, length, 0);
                    int clamp2 = Utilities.clamp(this.v - intValue, length, 0);
                    if (clamp != clamp2) {
                        boolean z11 = true;
                        if (this.f20191u >= intValue) {
                            z10 = true;
                        } else {
                            z10 = false;
                        }
    ...
    public final void b0(u1 u1Var) {
        ...
        } else if (this.f20888y0 && u1Var.getFactCheckLayout() != null) {
    ...
    public final void c0(int i10, int i11) {
        if (this.f20155a == i10 && this.f20157b == i11) {
            return;
        }
        this.f20155a = i10;
        this.f20157b = i11;
    ...
    public final void j(int i10, t9 t9Var, boolean z10) {
        ...
        int i17 = 0;
        if (this.f20885v0) {
            t9Var.f21247b = u1Var.getDescriptionlayout();
            t9Var.f21248c = 0.0f;
            t9Var.d = 0.0f;
            t9Var.f21246a = 0;
        } else if (this.f20887x0) {
            t9Var.f21247b = u1Var.getFactCheckLayout();
            t9Var.f21248c = 0.0f;
            t9Var.d = 0.0f;
            t9Var.f21246a = 0;
        } else if (this.f20889z0) {
            ...
            if (richMessageLayout != null && !richMessageLayout.textBlocks.isEmpty()) {
                ...
                t9Var.f21247b = richMessageLayout.textBlocks.get(i17).getLayout();
                t9Var.f21248c = baVar.getY();
                t9Var.d = baVar.getX();
                t9Var.f21246a = richMessageLayout.textBlockCharOffsets.get(i17).intValue();
                return;
            }
            t9Var.f21247b = null;
        } else if (u1Var.P2()) {
            ...
            if (captionLayout.textLayoutBlocks.size() == 1) {
                t9Var.f21247b = captionLayout.textLayoutBlocks.get(0).textLayout;
                t9Var.f21248c = textLayoutBlock2.padTop;
            ...
            for (int i18 = 0; i18 < captionLayout.textLayoutBlocks.size(); i18++) {
                ...
                if (i19 >= 0 && i19 <= textLayoutBlock4.textLayout.getText().length()) {
                    t9Var.f21247b = textLayoutBlock4.textLayout;
                    t9Var.f21248c = textLayoutBlock4.textYOffset(captionLayout.textLayoutBlocks) + textLayoutBlock4.padTop;
                    ...
                    t9Var.f21246a = textLayoutBlock4.charactersOffset;
                    return;
                }
            }
            t9Var.f21247b = null;
            ...
            if (arrayList == null) {
                ...
                t9Var.f21247b = messageObject.textLayoutBlocks.get(0).textLayout;
                t9Var.f21248c = textLayoutBlock.padTop;
                ...
                for (int i20 = 0; i20 < messageObject.textLayoutBlocks.size(); i20++) {
                    ...
                    if (i21 >= 0 && i21 <= textLayoutBlock6.textLayout.getText().length()) {
                        t9Var.f21247b = textLayoutBlock6.textLayout;
                        t9Var.f21248c = textLayoutBlock6.textYOffset(messageObject.textLayoutBlocks) + textLayoutBlock6.padTop;
                        ...
                        t9Var.f21246a = textLayoutBlock6.charactersOffset;
                        return;
                    }
                }
                t9Var.f21247b = null;
    ...
    public final CharSequence t(y9 y9Var, boolean z10) {
        ...
        if (u1Var != null && u1Var.getMessageObject() != null) {
            if (!z10 ? this.f20885v0 : this.f20886w0) {
                return u1Var.getDescriptionlayout().getText();
            }
            if (!z10 ? this.f20887x0 : this.f20888y0) {
                return u1Var.getFactCheckLayout().getText();
            }
            if (!z10 ? this.f20889z0 : this.A0) {
    ...
    public void x() {
        ...
        y9 y9Var2 = this.W;
        if (y9Var2 != null) {
            if (this.f20887x0 || this.f20888y0) {
                ((u1) y9Var2).a3();
            }
        }
    }
