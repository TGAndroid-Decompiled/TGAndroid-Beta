...
public abstract class r9 extends da {
    public boolean A0;
    public final SparseArray f20824u0 = new SparseArray();
    public boolean f20825v0;
    public boolean f20826w0;
    public boolean f20827x0;
    public boolean f20828y0;
    public boolean f20829z0;
    ...
    public final boolean D() {
        ...
        CharSequence s10;
        String str;
        if (this.f20829z0 && (y9Var = this.W) != null && ((t1) y9Var).getMessageObject() != null && (richMessageLayout = ((t1) this.W).getMessageObject().richLayout) != null && !richMessageLayout.textBlocks.isEmpty() && (s10 = s()) != null && s10.length() != 0) {
            try {
                str = richMessageLayout.getSelectionHtml(this.f19985u, this.v);
            } catch (Exception e) {
                FileLog.e(e);
                str = null;
            }
    ...
    public final void M(y9 y9Var, y9 y9Var2) {
        ...
        this.f19986w = t1Var.getMessageObject().getId();
        try {
            int i10 = t1Var.getMessageObject().messageOwner.edit_date;
        } catch (Exception unused) {
        }
        this.U = 0.0f;
        this.f20825v0 = this.f20826w0;
        this.f20827x0 = this.f20828y0;
        this.f20829z0 = this.A0;
        int i11 = this.f19986w;
        SparseArray sparseArray = this.f20824u0;
        ...
        ofFloat.start();
        sparseArray.put(this.f19986w, ofFloat);
        if (!z10) {
    ...
    public final void X(MessageObject messageObject) {
        ...
        if (this.f19986w == messageObject.getId()) {
            f(true);
        }
    }
    ...
    public final void Y(boolean z10, StaticLayout staticLayout, Canvas canvas) {
        ...
        Paint paint = this.f19975p;
        Paint paint2 = this.f19973o;
        if (z10) {
            int i10 = org.telegram.ui.ActionBar.j6.Vb;
            paint2.setColor(u(i10));
            paint.setColor(u(i10));
        } else {
            int i11 = org.telegram.ui.ActionBar.j6.f19183uf;
            paint2.setColor(u(i11));
            paint.setColor(u(i11));
        }
        i(canvas, staticLayout, this.f19985u, this.v, true, true, 0.0f);
    }
    ...
    public final void Z(MessageObject messageObject, RichMessageLayout richMessageLayout, Canvas canvas) {
        ...
        Canvas canvas2;
        boolean z10;
        if (this.f20829z0 && richMessageLayout != null && (y9Var = this.W) != null && ((t1) y9Var).getMessageObject() != null && ((t1) this.W).getMessageObject().getId() == messageObject.getId()) {
            ...
            while (i12 < richMessageLayout.textBlocks.size()) {
                ...
                if (layout != null && layout.getText() != null) {
                    ...
                    int clamp = Utilities.clamp(this.f19985u - intValue, length, 0);
                    int clamp2 = Utilities.clamp(this.v - intValue, length, 0);
                    if (clamp != clamp2) {
                        boolean z11 = true;
                        if (this.f19985u >= intValue) {
                            z10 = true;
                        } else {
                            z10 = false;
                        }
    ...
    public final void b0(t1 t1Var) {
        ...
        } else if (this.f20828y0 && t1Var.getFactCheckLayout() != null) {
    ...
    public final void c0(int i10, int i11) {
        if (this.f19949a == i10 && this.f19951b == i11) {
            return;
        }
        this.f19949a = i10;
        this.f19951b = i11;
    ...
    public final void j(int i10, t9 t9Var, boolean z10) {
        ...
        int i17 = 0;
        if (this.f20825v0) {
            t9Var.f21418b = t1Var.getDescriptionlayout();
            t9Var.f21419c = 0.0f;
            t9Var.d = 0.0f;
            t9Var.f21417a = 0;
        } else if (this.f20827x0) {
            t9Var.f21418b = t1Var.getFactCheckLayout();
            t9Var.f21419c = 0.0f;
            t9Var.d = 0.0f;
            t9Var.f21417a = 0;
        } else if (this.f20829z0) {
            ...
            if (richMessageLayout != null && !richMessageLayout.textBlocks.isEmpty()) {
                ...
                t9Var.f21418b = richMessageLayout.textBlocks.get(i17).getLayout();
                t9Var.f21419c = baVar.getY();
                t9Var.d = baVar.getX();
                t9Var.f21417a = richMessageLayout.textBlockCharOffsets.get(i17).intValue();
                return;
            }
            t9Var.f21418b = null;
        } else if (t1Var.P2()) {
            ...
            if (captionLayout.textLayoutBlocks.size() == 1) {
                t9Var.f21418b = captionLayout.textLayoutBlocks.get(0).textLayout;
                t9Var.f21419c = textLayoutBlock2.padTop;
            ...
            for (int i18 = 0; i18 < captionLayout.textLayoutBlocks.size(); i18++) {
                ...
                if (i19 >= 0 && i19 <= textLayoutBlock4.textLayout.getText().length()) {
                    t9Var.f21418b = textLayoutBlock4.textLayout;
                    t9Var.f21419c = textLayoutBlock4.textYOffset(captionLayout.textLayoutBlocks) + textLayoutBlock4.padTop;
                    ...
                    t9Var.f21417a = textLayoutBlock4.charactersOffset;
                    return;
                }
            }
            t9Var.f21418b = null;
            ...
            if (arrayList == null) {
                ...
                t9Var.f21418b = messageObject.textLayoutBlocks.get(0).textLayout;
                t9Var.f21419c = textLayoutBlock.padTop;
                ...
                for (int i20 = 0; i20 < messageObject.textLayoutBlocks.size(); i20++) {
                    ...
                    if (i21 >= 0 && i21 <= textLayoutBlock6.textLayout.getText().length()) {
                        t9Var.f21418b = textLayoutBlock6.textLayout;
                        t9Var.f21419c = textLayoutBlock6.textYOffset(messageObject.textLayoutBlocks) + textLayoutBlock6.padTop;
                        ...
                        t9Var.f21417a = textLayoutBlock6.charactersOffset;
                        return;
                    }
                }
                t9Var.f21418b = null;
    ...
    public final CharSequence t(y9 y9Var, boolean z10) {
        ...
        if (t1Var != null && t1Var.getMessageObject() != null) {
            if (!z10 ? this.f20825v0 : this.f20826w0) {
                return t1Var.getDescriptionlayout().getText();
            }
            if (!z10 ? this.f20827x0 : this.f20828y0) {
                return t1Var.getFactCheckLayout().getText();
            }
            if (!z10 ? this.f20829z0 : this.A0) {
    ...
    public void x() {
        ...
        y9 y9Var2 = this.W;
        if (y9Var2 != null) {
            if (this.f20827x0 || this.f20828y0) {
                ((t1) y9Var2).a3();
            }
        }
    }
