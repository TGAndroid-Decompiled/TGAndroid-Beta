    ...
    public void invalidate() {
        switch (this.f21803s) {
            case 1:
                ...
                ah0 ah0Var = yg0Var.d;
                if (yg0Var == ah0Var.f22608b.getPinnedHeader()) {
                    ah0Var.f22608b.invalidate();
                    return;
                }
                return;
            default:
    ...
    public void onDraw(Canvas canvas) {
        switch (this.f21803s) {
            ...
            case 2:
                ...
                ((a71) this.v).f22557b.draw(canvas);
                canvas.restore();
                return;
            case 3:
    ...
    public void onMeasure(int i10, int i11) {
        switch (this.f21803s) {
            case 4:
                ...
                super.onMeasure(View.MeasureSpec.makeMeasureSpec((int) ((size - mc0Var.d.getPaint().measureText(mc0Var.d.getText().toString())) - mc0Var.f35593f.getPaint().measureText(mc0Var.f35593f.getText().toString())), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(24.0f), 1073741824));
                return;
            default:
