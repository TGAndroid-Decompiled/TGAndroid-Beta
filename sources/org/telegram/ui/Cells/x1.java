    ...
    public void invalidate() {
        switch (this.f21828s) {
            case 1:
                ...
                zg0 zg0Var = xg0Var.d;
                if (xg0Var == zg0Var.f30816b.getPinnedHeader()) {
                    zg0Var.f30816b.invalidate();
                    return;
                }
                return;
            default:
    ...
    public void onDraw(Canvas canvas) {
        switch (this.f21828s) {
            ...
            case 2:
                ...
                ((z61) this.v).f30768b.draw(canvas);
                canvas.restore();
                return;
            case 3:
    ...
    public void onMeasure(int i10, int i11) {
        switch (this.f21828s) {
            case 4:
                ...
                super.onMeasure(View.MeasureSpec.makeMeasureSpec((int) ((size - nc0Var.d.getPaint().measureText(nc0Var.d.getText().toString())) - nc0Var.f35973f.getPaint().measureText(nc0Var.f35973f.getText().toString())), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(24.0f), 1073741824));
                return;
            default:
