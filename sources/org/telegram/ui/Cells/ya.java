...
public final class ya extends FrameLayout {
    public final org.telegram.ui.Components.w9 f21856a;
    public final ai.a6 f21857b;
    public final org.telegram.ui.ActionBar.j5 f21858c;
    public final ImageView d;
    public final org.telegram.ui.Components.h9 e;
    public TLObject f21859f;
    ...
    public ya(Context context, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        float f15;
        float f16;
        this.f21862s = UserConfig.selectedAccount;
        this.v = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19445y6, e6Var);
        this.f21863w = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19247n6, e6Var);
        ...
        imageView.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19227m6, e6Var), PorterDuff.Mode.MULTIPLY));
    ...
    public final void a(TLObject tLObject, String str) {
        if (tLObject == null && str == null) {
            ...
            this.f21859f = null;
            this.f21857b.k("");
            this.f21858c.l("", false);
            this.f21856a.setImageDrawable(null);
            return;
        }
        this.h = str;
        this.f21859f = tLObject;
        b();
    }
    ...
    public final void b() {
        ...
        float f7;
        TLObject tLObject = this.f21859f;
        ...
        if (user != null) {
            ...
            h9Var.n(this.f21860n, "#", null);
        }
        if (user != null) {
            this.f21861r = UserObject.getUserName(user);
        } else {
            this.f21861r = chat.title;
        }
        this.f21857b.k(this.f21861r);
        CharSequence charSequence = this.h;
        int i11 = this.v;
        org.telegram.ui.Components.w9 w9Var = this.f21856a;
        org.telegram.ui.ActionBar.j5 j5Var = this.f21858c;
        if (charSequence != null) {
            ...
            } else if (user.f18443id != UserConfig.getInstance(i10).getClientUserId() && (((userStatus = user.status) == null || userStatus.expires <= ConnectionsManager.getInstance(i10).getCurrentTime()) && !MessagesController.getInstance(i10).onlinePrivacy.containsKey(Long.valueOf(user.f18443id)))) {
                j5Var.setTextColor(i11);
                j5Var.l(LocaleController.formatUserStatus(i10, user), false);
            } else {
                j5Var.setTextColor(this.f21863w);
