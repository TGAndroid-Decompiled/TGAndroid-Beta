...
public final class ya extends FrameLayout {
    public final org.telegram.ui.Components.w9 f21877a;
    public final ai.z5 f21878b;
    public final org.telegram.ui.ActionBar.h5 f21879c;
    public final ImageView d;
    public final org.telegram.ui.Components.h9 e;
    public TLObject f21880f;
    public CharSequence h;
    public int f21881n;
    public String f21882r;
    ...
    public ya(Context context, org.telegram.ui.ActionBar.d6 d6Var) {
        ...
        float f15;
        float f16;
        this.f21883s = UserConfig.selectedAccount;
        this.v = org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19428y6, d6Var);
        this.f21884w = org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19229n6, d6Var);
        ...
        imageView.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19209m6, d6Var), PorterDuff.Mode.MULTIPLY));
    ...
    public final void a(TLObject tLObject, String str) {
        if (tLObject == null && str == null) {
            ...
            this.f21880f = null;
            this.f21878b.k("");
            this.f21879c.l("", false);
            this.f21877a.setImageDrawable(null);
            return;
        }
        this.h = str;
        this.f21880f = tLObject;
        b();
    }
    ...
    public final void b() {
        ...
        float f7;
        TLObject tLObject = this.f21880f;
        ...
        if (user != null) {
            ...
            h9Var.n(this.f21881n, "#", null);
        }
        if (user != null) {
            this.f21882r = UserObject.getUserName(user);
        } else {
            this.f21882r = chat.title;
        }
        this.f21878b.k(this.f21882r);
        CharSequence charSequence = this.h;
        int i11 = this.v;
        org.telegram.ui.Components.w9 w9Var = this.f21877a;
        org.telegram.ui.ActionBar.h5 h5Var = this.f21879c;
        if (charSequence != null) {
            ...
            } else if (user.f18468id != UserConfig.getInstance(i10).getClientUserId() && (((userStatus = user.status) == null || userStatus.expires <= ConnectionsManager.getInstance(i10).getCurrentTime()) && !MessagesController.getInstance(i10).onlinePrivacy.containsKey(Long.valueOf(user.f18468id)))) {
                h5Var.setTextColor(i11);
                h5Var.l(LocaleController.formatUserStatus(i10, user), false);
            } else {
                h5Var.setTextColor(this.f21884w);
    ...
    public void setNameTypeface(Typeface typeface) {
        this.f21878b.setTypeface(typeface);
    }
