...
public final class p4 extends FrameLayout {
    public final org.telegram.ui.Components.w9 f20796a;
    public final org.telegram.ui.ActionBar.h5 f20797b;
    public final org.telegram.ui.ActionBar.h5 f20798c;
    public final org.telegram.ui.Components.h9 d;
    public final op e;
    public ContactsController.Contact f20799f;
    ...
    public p4(Context context, boolean z10) {
        ...
        if (z10) {
            ...
            addView(opVar, w7.y5.d(24, 24.0f, i16, f7, 32.0f, f10, 0.0f));
            return;
        }
        this.e = null;
    ...
    public final void a() {
        ContactsController.Contact contact = this.f20799f;
        if (contact == null) {
            return;
        }
        ...
        org.telegram.ui.ActionBar.h5 h5Var = this.f20797b;
        if (charSequence != null) {
            h5Var.l(charSequence, true);
        } else {
            ContactsController.Contact contact2 = this.f20799f;
        ...
        org.telegram.ui.ActionBar.h5 h5Var2 = this.f20798c;
        h5Var2.setTag(valueOf);
        h5Var2.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, i10, false));
        ContactsController.Contact contact3 = this.f20799f;
        ...
        this.f20796a.setImageDrawable(h9Var);
    }
