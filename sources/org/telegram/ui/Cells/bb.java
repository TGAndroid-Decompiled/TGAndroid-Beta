...
public class bb extends FrameLayout implements NotificationCenter.NotificationCenterDelegate, org.telegram.ui.ActionBar.y5 {
    ...
    public boolean V;
    public boolean W;
    public final ai.y5 f19813a;
    public final org.telegram.ui.ActionBar.i5 f19814b;
    public final org.telegram.ui.ActionBar.i5 f19815c;
    public final ImageView d;
    public final op e;
    public final CheckBoxSquare f19816f;
    public final ImageView h;
    public final TextView f19817n;
    public final TextView f19818r;
    public Drawable f19819s;
    public final org.telegram.ui.Components.o5 v;
    public final org.telegram.ui.Components.o5 f19820w;
    public ImageView f19821x;
    public final org.telegram.ui.ActionBar.d6 f19822y;
    ...
    public final void a(String str, boolean z10, boolean z11, boolean z12, View.OnClickListener onClickListener) {
        int v02;
        int i10;
        TextView textView = this.f19817n;
        if (textView == null) {
            return;
        }
        org.telegram.ui.ActionBar.d6 d6Var = this.f19822y;
        if (z11) {
            ...
            v02 = org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f18941ld, d6Var);
        }
    ...
    public final void b(int i10, int i11) {
        ...
        FrameLayout.LayoutParams layoutParams2 = (FrameLayout.LayoutParams) this.f19814b.getLayoutParams();
        boolean z10 = LocaleController.isRTL;
        int i14 = 0;
        CheckBoxSquare checkBoxSquare = this.f19816f;
        if (z10) {
        ...
        FrameLayout.LayoutParams layoutParams3 = (FrameLayout.LayoutParams) this.f19815c.getLayoutParams();
        float f15 = 28.0f;
        if (LocaleController.isRTL) {
            f12 = 28.0f;
        } else {
    ...
    public final void d(Object obj, CharSequence charSequence, CharSequence charSequence2, boolean z10) {
        org.telegram.ui.ActionBar.i5 i5Var = this.f19814b;
        if (obj == null && charSequence == null && charSequence2 == null) {
            ...
            this.G = null;
            i5Var.l("", false);
            this.f19815c.l("", false);
            this.f19813a.setImageDrawable(null);
            return;
        }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.emojiLoaded) {
            this.f19814b.invalidate();
        }
    }

    @Override
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        if (this.V && view == this.f19813a) {
    ...
    public final void g(nk0 nk0Var, CharSequence charSequence, boolean z10) {
        ...
        int i11 = this.P;
        if (z11) {
            int i12 = nk0Var.f35548c;
            if (i12 <= 0 && nk0Var.f35549f) {
            ...
            boolean z12 = nk0Var.f35547b;
            int i13 = nk0Var.f35548c;
            int i14 = nk0Var.f35546a;
            boolean z13 = true;
        ...
        if (DialogObject.isEncryptedDialog(nk0Var.d)) {
            TLRPC.EncryptedChat l4 = org.telegram.messenger.z0.l(MessagesController.getInstance(i11), nk0Var.d);
    ...
    public final void i(int i10, boolean z10) {
        ...
        this.f19814b.setPadding(i11, 0, i12, 0);
        if (z10) {
            ...
            this.f19815c.setPadding(i13, 0, i10, 0);
        }
    }
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        org.telegram.ui.ActionBar.i5 i5Var2 = this.f19815c;
        if (i5Var2 != null) {
    ...
    public void setAddButtonVisible(boolean z10) {
        int i10;
        TextView textView = this.f19818r;
        if (textView == null) {
            return;
        }
        if (z10) {
    ...
    public void setCallCellStyle(int i10) {
        ...
        i5Var.setLayoutParams(w7.x5.d(-1, 20.0f, i15, f7, 10.0f, f10, 0.0f));
        org.telegram.ui.ActionBar.i5 i5Var2 = this.f19815c;
        ...
        i5Var2.setLayoutParams(w7.x5.d(-1, 20.0f, i16, f11, 32.0f, f12, 0.0f));
        ...
        y5Var.setLayoutParams(w7.x5.d(44, 44.0f, i17, f13, 6.0f, f14, 0.0f));
        op opVar = this.e;
        if (opVar != null) {
            ...
            opVar.setLayoutParams(w7.x5.d(24, 24.0f, i18, f15, 32.0f, f16, 0.0f));
        }
    }
    ...
    public void setCloseIcon(View.OnClickListener onClickListener) {
        ...
        if (onClickListener == null) {
            ImageView imageView = this.f19821x;
            if (imageView != null) {
        ...
        if (this.f19821x == null) {
            ...
            this.f19821x = imageView2;
            imageView2.setScaleType(ImageView.ScaleType.CENTER);
            w7.z5.a(this.f19821x);
            this.f19821x.setImageResource(R.drawable.ic_close_white);
            ImageView imageView3 = this.f19821x;
            ...
            ImageView imageView4 = this.f19821x;
            ...
            ImageView imageView5 = this.f19821x;
            boolean z10 = LocaleController.isRTL;
            if (z10) {
                i11 = 3;
            }
        ...
        this.f19821x.setOnClickListener(onClickListener);
    }
    ...
    public void setNameTypeface(Typeface typeface) {
        this.f19814b.setTypeface(typeface);
    }
    ...
    public bb(int i10, int i11, Context context, org.telegram.ui.ActionBar.d6 d6Var, boolean z10, boolean z11) {
        ...
        this.Q = org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19170y6, d6Var);
        ...
        addView(i5Var, w7.x5.d(-1, 20.0f, i14, f10, 10.0f, f7, 0.0f));
        this.v = new org.telegram.ui.Components.o5(AndroidUtilities.dp(20.0f), i5Var);
        this.f19820w = new org.telegram.ui.Components.o5(AndroidUtilities.dp(20.0f), i5Var);
        ...
        int v02 = org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f18953m6, d6Var);
        ...
        if (z10) {
            ...
            this.f19817n = textView2;
            w7.z5.b(textView2, 0.05f, 1.2f);
            textView2.setTextSize(1, 14.0f);
            textView2.setTextColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19111uh, d6Var));
