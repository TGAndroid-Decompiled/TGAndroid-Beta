...
public final class z9 extends FrameLayout {
    ...
    public Paint D;
    public boolean E;
    public final org.telegram.ui.ActionBar.f6 f22676a;
    public final TextView f22677b;
    public final org.telegram.ui.Components.k6 f22678c;
    public final jj0 d;
    public org.telegram.ui.Components.p9 e;
    public final ImageView f22679f;
    public boolean h;
    ...
    public final void a(ArrayList arrayList, boolean z4) {
        ...
        ImageView imageView = this.f22679f;
        org.telegram.ui.Components.k6 k6Var = this.f22678c;
        float f14 = 0.5f;
        if (arrayList != null) {
            if (z4) {
                f12 = 1.0f;
    ...
    public final void b(CharSequence charSequence, boolean z4) {
        this.f22677b.setText(charSequence);
        this.f22678c.setVisibility(4);
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        float f11;
        int i10 = 0;
        if (this.f22681r || this.f22684x != 0.0f) {
            if (this.D == null) {
                Paint paint = new Paint(1);
                this.D = paint;
                paint.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.O5, this.f22676a));
            }
            if (this.v) {
                float f12 = this.f22683w + 0.016f;
                this.f22683w = f12;
                if (f12 > 1.0f) {
                    this.f22683w = 1.0f;
                    this.v = false;
            ...
            if (i11 > 0) {
                ...
                boolean z4 = this.f22681r;
                if (z4) {
                    float f14 = this.f22684x;
                    if (f14 != 1.0f) {
            ...
            this.D.setAlpha((int) (((this.f22683w * 0.4f) + 0.6f) * this.f22684x * 255.0f));
            int measuredHeight = getMeasuredHeight() >> 1;
            RectF rectF = AndroidUtilities.rectTmp;
            int measuredWidth = getMeasuredWidth();
            float f18 = this.f22682s;
            rectF.set((measuredWidth - AndroidUtilities.dp(f18)) - AndroidUtilities.dp(this.f22685y), measuredHeight - AndroidUtilities.dp(3.0f), getMeasuredWidth() - AndroidUtilities.dp(f18), AndroidUtilities.dp(3.0f) + measuredHeight);
            if (LocaleController.isRTL) {
        ...
        this.f22678c.setAlpha(1.0f - this.f22684x);
        ...
        if (this.h) {
            ...
            canvas.drawLine(f11, measuredHeight2, measuredWidth2 - i10, getMeasuredHeight() - 1, org.telegram.ui.ActionBar.j6.f20000k0);
        }
    }
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        sb.append((Object) this.f22677b.getText());
        org.telegram.ui.Components.k6 k6Var = this.f22678c;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f22677b.measure(View.MeasureSpec.makeMeasureSpec(measuredWidth, 1073741824), View.MeasureSpec.makeMeasureSpec(getMeasuredHeight(), 1073741824));
    }
    ...
    public void setIcon(int i10) {
        ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) this.f22677b.getLayoutParams();
        jj0 jj0Var = this.d;
        if (i10 == 0) {
            jj0Var.setVisibility(8);
            boolean z4 = LocaleController.isRTL;
            int i11 = this.f22682s;
            if (z4) {
        ...
        jj0Var.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20042m6, this.f22676a), PorterDuff.Mode.MULTIPLY));
    ...
    public void setTextColor(int i10) {
        this.f22677b.setTextColor(i10);
    }

    public void setTextValueColor(int i10) {
        this.f22678c.setTextColor(i10);
    }
    ...
    public z9(Context context, int i10, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        int i11 = org.telegram.ui.ActionBar.j6.f20042m6;
