...
public class ManageChatTextCell extends FrameLayout {
    ...
    public void onMeasure(int i, int i2) {
        ...
        this.valueTextView.measure(OKLCH.m(24.0f, size, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), 1073741824));
        this.textView.measure(OKLCH.m(95.0f, size, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), 1073741824));
