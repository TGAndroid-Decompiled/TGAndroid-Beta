...
public final class f5 extends FrameLayout {
    public final org.telegram.ui.Components.f9 f20091a;
    public final org.telegram.ui.Components.u9 f20092b;
    public final org.telegram.ui.ActionBar.k5 f20093c;
    ...
    public f5(Context context, final e5 e5Var, boolean z10) {
        ...
        int i16;
        int dp;
        this.f20091a = new org.telegram.ui.Components.f9((org.telegram.ui.ActionBar.f6) null);
        ...
        addView(u9Var, w7.x5.d(46, 46.0f, i10, 12.0f, 8.0f, 12.0f, 0.0f));
        if (LocaleController.isRTL) {
            i11 = 5;
        } else {
            i11 = 3;
        ...
        addView(k5Var, w7.x5.d(-1, -2.0f, 48, f7, 12.0f, f10, 0.0f));
        if (LocaleController.isRTL) {
            i12 = 5;
        } else {
            i12 = 3;
        ...
        k5Var2.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19244y6, false));
        ...
        addView(k5Var2, w7.x5.d(-1, -2.0f, 48, f11, 36.0f, f12, 0.0f));
        ...
        textView2.setBackground(org.telegram.ui.ActionBar.j6.i0(dp3, dp3, dp3, dp3, 0, org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18952i6, false), -16777216));
        if (LocaleController.isRTL) {
            i16 = 5;
        } else {
            i16 = 3;
        ...
        textView2.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19047n6, false));
