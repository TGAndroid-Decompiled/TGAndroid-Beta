...
public final class t5 extends FrameLayout {
    ...
    public final LinearLayout f21370b;
    public View.OnClickListener f21371c;
    public int d;
    public final int[] e;
    ...
    public t5(Context context) {
        ...
        for (int i10 = 0; i10 < this.e.length; i10++) {
            ...
            this.f21370b.addView(radioButton, w7.x5.l(1.0f / this.e.length, 0, -1));
            radioButton.setOnClickListener(new a(this, 8));
        }
        addView(this.f21370b, w7.x5.d(-1, 40.0f, 51, 96.0f, 0.0f, 24.0f, 0.0f));
    }

    public final void a(int i10, String str) {
        this.d = i10;
        this.f21369a.setText(str.substring(0, 1).toUpperCase() + str.substring(1).toLowerCase());
        b(false);
    }
    ...
    public final void b(boolean z10) {
        boolean z11;
        int i10;
        LinearLayout linearLayout = this.f21370b;
