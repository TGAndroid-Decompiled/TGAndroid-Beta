...
public final class t5 extends FrameLayout {
    ...
    public final LinearLayout f22334b;
    public View.OnClickListener f22335c;
    public int d;
    public final int[] e;
    ...
    public t5(Context context) {
        ...
        this.f22334b = linearLayout;
        linearLayout.setOrientation(0);
        for (int i10 = 0; i10 < this.e.length; i10++) {
            RadioButton radioButton = new RadioButton(context);
            radioButton.setSize(AndroidUtilities.dp(20.0f));
            radioButton.setTag(Integer.valueOf(i10));
            this.f22334b.addView(radioButton, k7.b6.l(1.0f / this.e.length, 0, -1));
            radioButton.setOnClickListener(new a(this, 8));
        }
        addView(this.f22334b, k7.b6.d(-1, 40.0f, 51, 96.0f, 0.0f, 24.0f, 0.0f));
    }

    public final void a(int i10, String str) {
        this.d = i10;
        this.f22333a.setText(str.substring(0, 1).toUpperCase() + str.substring(1).toLowerCase());
        b(false);
    }
    ...
    public final void b(boolean z4) {
        boolean z10;
        int i10;
        LinearLayout linearLayout = this.f22334b;
