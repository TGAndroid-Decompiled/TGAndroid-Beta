...
public final class t5 extends FrameLayout {
    ...
    public final p5 f22347a;
    public final o5 f22348b;
    public final FrameLayout f22349c;
    public final lp d;
    public final ImageView e;
    public final TextView f22350f;
    public final q5 h;
    public AnimatorSet f22351n;
    ...
    public t5(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.f22349c = frameLayout;
        addView(frameLayout, k7.b6.d(42, 42.0f, 51, 38.0f, 0.0f, 0.0f, 0.0f));
        this.f22356y = AndroidUtilities.dp(80.0f);
    }

    public final boolean a() {
        return this.d.f26837a.f22965q;
    }

    public final void b(int i10, boolean z4, boolean z10) {
        float f10;
        float f11;
        this.d.f26837a.f(i10, z4, z10);
        boolean z11 = false;
        if (this.f22355x) {
    ...
    public final void d(MediaController.PhotoEntry photoEntry, boolean z4, boolean z10, boolean z11, boolean z12) {
        ...
        TextView textView = this.f22350f;
        q5 q5Var = this.h;
        p5 p5Var = this.f22347a;
    ...
    public final void g(boolean z4) {
        ...
        if (!z4 || lpVar.getAlpha() != 1.0f) {
            ...
            AnimatorSet animatorSet = this.f22351n;
            if (animatorSet != null) {
                animatorSet.cancel();
                this.f22351n = null;
            }
            AnimatorSet animatorSet2 = new AnimatorSet();
            this.f22351n = animatorSet2;
            animatorSet2.setInterpolator(new DecelerateInterpolator());
            this.f22351n.setDuration(180L);
            AnimatorSet animatorSet3 = this.f22351n;
            if (z4) {
                f10 = 1.0f;
            } else {
                f10 = 0.0f;
            ...
            animatorSet3.playTogether(ofFloat, ObjectAnimator.ofFloat(lpVar, property, f11));
            this.f22351n.addListener(new org.telegram.ui.s5(this, 7));
            this.f22351n.start();
        }
    }
    ...
    public final void h(boolean z4) {
        p5 p5Var;
        o5 o5Var = this.f22348b;
        if (o5Var != null && (p5Var = this.f22347a) != null && p5Var.getMeasuredHeight() > 0 && p5Var.getMeasuredWidth() > 0) {
            if (z4) {
                if (this.J == null) {
                    this.J = ih.j.e(o5Var);
                    return;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        boolean z4 = this.d.f26837a.f22965q;
        p5 p5Var = this.f22347a;
        if (!z4 && this.f22348b.getScaleX() == 1.0f && p5Var.getImageReceiver().hasNotThumb() && p5Var.getImageReceiver().getCurrentAlpha() == 1.0f && (((photoEntry = this.D) == null || !PhotoViewer.L1(photoEntry.path)) && ((searchImage = this.E) == null || !PhotoViewer.L1(searchImage.getPathToAttach())))) {
            return;
        }
    ...
    public final void onMeasure(int i10, int i11) {
        if (this.f22355x) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(this.f22356y, 1073741824), org.telegram.ui.b.B(2.0f, this.f22356y, 1073741824));
            return;
        }
        int i12 = 6;
        if (this.B) {
    ...
    public void setItemSize(int i10) {
        this.f22356y = i10;
        FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) this.f22348b.getLayoutParams();
        int i11 = this.f22356y;
        layoutParams.height = i11;
        layoutParams.width = i11;
        FrameLayout.LayoutParams layoutParams2 = (FrameLayout.LayoutParams) this.f22349c.getLayoutParams();
    ...
    public void setOnCheckClickListener(View.OnClickListener onClickListener) {
        this.f22349c.setOnClickListener(onClickListener);
    }
}
