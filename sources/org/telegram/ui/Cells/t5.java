...
public final class t5 extends FrameLayout {
    public static final Rect f21197a0 = new Rect();
    public boolean E;
    ...
    public final p5 f21198a;
    public final o5 f21199b;
    public final FrameLayout f21200c;
    public final op d;
    public final ImageView e;
    public final TextView f21201f;
    public final q5 h;
    public AnimatorSet f21202n;
    ...
    public t5(Context context, org.telegram.ui.ActionBar.d6 d6Var) {
        ...
        this.f21207y = AndroidUtilities.dp(80.0f);
    }

    public final boolean a() {
        return this.d.f27167a.f22194q;
    }

    public final void b(int i10, boolean z10, boolean z11) {
        float f7;
        float f10;
        this.d.f27167a.f(i10, z10, z11);
        boolean z12 = false;
        if (this.f21206x) {
    ...
    public final void d(MediaController.PhotoEntry photoEntry, boolean z10, boolean z11, boolean z12, boolean z13) {
        ...
        TextView textView = this.f21201f;
        q5 q5Var = this.h;
        p5 p5Var = this.f21198a;
    ...
    public final void g(boolean z10) {
        ...
        if (!z10 || opVar.getAlpha() != 1.0f) {
            ...
            AnimatorSet animatorSet = this.f21202n;
            if (animatorSet != null) {
                animatorSet.cancel();
                this.f21202n = null;
            }
            AnimatorSet animatorSet2 = new AnimatorSet();
            this.f21202n = animatorSet2;
            animatorSet2.setInterpolator(new DecelerateInterpolator());
            this.f21202n.setDuration(180L);
            AnimatorSet animatorSet3 = this.f21202n;
            if (z10) {
                f7 = 1.0f;
            } else {
                f7 = 0.0f;
            ...
            this.f21202n.addListener(new org.telegram.ui.t4(this, 8));
            this.f21202n.start();
        }
    }
    ...
    public final void h(boolean z10) {
        p5 p5Var;
        o5 o5Var = this.f21199b;
        if (o5Var != null && (p5Var = this.f21198a) != null && p5Var.getMeasuredHeight() > 0 && p5Var.getMeasuredWidth() > 0) {
            if (z10) {
                if (this.M == null) {
                    this.M = vh.f.e(o5Var);
                    return;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        boolean z10 = this.d.f27167a.f22194q;
        p5 p5Var = this.f21198a;
        if (!z10 && this.f21199b.getScaleX() == 1.0f && p5Var.getImageReceiver().hasNotThumb() && p5Var.getImageReceiver().getCurrentAlpha() == 1.0f && (((photoEntry = this.G) == null || !PhotoViewer.L1(photoEntry.path)) && ((searchImage = this.H) == null || !PhotoViewer.L1(searchImage.getPathToAttach())))) {
            return;
        }
    ...
    public final void onMeasure(int i10, int i11) {
        if (this.f21206x) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(this.f21207y, 1073741824), ok.C(2.0f, this.f21207y, 1073741824));
            return;
        }
        int i12 = 6;
        if (this.E) {
    ...
    public void setItemSize(int i10) {
        this.f21207y = i10;
        FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) this.f21199b.getLayoutParams();
        int i11 = this.f21207y;
        layoutParams.height = i11;
        layoutParams.width = i11;
        FrameLayout.LayoutParams layoutParams2 = (FrameLayout.LayoutParams) this.f21200c.getLayoutParams();
    ...
    public void setOnCheckClickListener(View.OnClickListener onClickListener) {
        this.f21200c.setOnClickListener(onClickListener);
    }
}
