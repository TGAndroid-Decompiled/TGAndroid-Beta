...
public final class t5 extends FrameLayout {
    public static final Rect f21161a0 = new Rect();
    public boolean E;
    ...
    public final p5 f21162a;
    public final o5 f21163b;
    public final FrameLayout f21164c;
    public final np d;
    public final ImageView e;
    public final TextView f21165f;
    public final q5 h;
    public AnimatorSet f21166n;
    ...
    public t5(Context context, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        this.f21164c = frameLayout;
        addView(frameLayout, w7.y5.d(42, 42.0f, 51, 38.0f, 0.0f, 0.0f, 0.0f));
        this.f21171y = AndroidUtilities.dp(80.0f);
    }

    public final boolean a() {
        return this.d.f26739a.f22158q;
    }

    public final void b(int i10, boolean z10, boolean z11) {
        float f7;
        float f10;
        this.d.f26739a.f(i10, z10, z11);
        boolean z12 = false;
        if (this.f21170x) {
    ...
    public final void g(boolean z10) {
        ...
        if (!z10 || npVar.getAlpha() != 1.0f) {
            ...
            AnimatorSet animatorSet = this.f21166n;
            if (animatorSet != null) {
                animatorSet.cancel();
                this.f21166n = null;
            }
            AnimatorSet animatorSet2 = new AnimatorSet();
            this.f21166n = animatorSet2;
            animatorSet2.setInterpolator(new DecelerateInterpolator());
            this.f21166n.setDuration(180L);
            AnimatorSet animatorSet3 = this.f21166n;
            if (z10) {
                f7 = 1.0f;
            } else {
                f7 = 0.0f;
            ...
            this.f21166n.addListener(new org.telegram.ui.t4(this, 8));
            this.f21166n.start();
        }
    }
    ...
    public final void h(boolean z10) {
        p5 p5Var;
        o5 o5Var = this.f21163b;
        if (o5Var != null && (p5Var = this.f21162a) != null && p5Var.getMeasuredHeight() > 0 && p5Var.getMeasuredWidth() > 0) {
            if (z10) {
                if (this.M == null) {
                    this.M = vh.g.e(o5Var);
                    return;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        boolean z10 = this.d.f26739a.f22158q;
        p5 p5Var = this.f21162a;
        if (!z10 && this.f21163b.getScaleX() == 1.0f && p5Var.getImageReceiver().hasNotThumb() && p5Var.getImageReceiver().getCurrentAlpha() == 1.0f && (((photoEntry = this.G) == null || !PhotoViewer.L1(photoEntry.path)) && ((searchImage = this.H) == null || !PhotoViewer.L1(searchImage.getPathToAttach())))) {
            return;
        }
    ...
    public final void onMeasure(int i10, int i11) {
        if (this.f21170x) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(this.f21171y, 1073741824), wh.C(2.0f, this.f21171y, 1073741824));
            return;
        }
        int i12 = 6;
        if (this.E) {
    ...
    public void setItemSize(int i10) {
        this.f21171y = i10;
        FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) this.f21163b.getLayoutParams();
        int i11 = this.f21171y;
        layoutParams.height = i11;
        layoutParams.width = i11;
        FrameLayout.LayoutParams layoutParams2 = (FrameLayout.LayoutParams) this.f21164c.getLayoutParams();
    ...
    public void setOnCheckClickListener(View.OnClickListener onClickListener) {
        this.f21164c.setOnClickListener(onClickListener);
    }
}
