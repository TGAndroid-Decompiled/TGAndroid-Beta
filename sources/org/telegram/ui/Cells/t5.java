...
public final class t5 extends FrameLayout {
    public static final Rect f21323a0 = new Rect();
    public boolean E;
    ...
    public final p5 f21324a;
    public final o5 f21325b;
    public final FrameLayout f21326c;
    public final op d;
    public final ImageView e;
    public final TextView f21327f;
    public final q5 h;
    public AnimatorSet f21328n;
    ...
    public t5(Context context, org.telegram.ui.ActionBar.d6 d6Var) {
        ...
        this.f21326c = frameLayout;
        addView(frameLayout, w7.x5.d(42, 42.0f, 51, 38.0f, 0.0f, 0.0f, 0.0f));
        this.f21333y = AndroidUtilities.dp(80.0f);
    }

    public final boolean a() {
        return this.d.f26827a.f21943q;
    }

    public final void b(int i10, boolean z10, boolean z11) {
        float f7;
        float f10;
        this.d.f26827a.f(i10, z10, z11);
        boolean z12 = false;
        if (this.f21332x) {
    ...
    public final void g(boolean z10) {
        ...
        if (!z10 || opVar.getAlpha() != 1.0f) {
            ...
            AnimatorSet animatorSet = this.f21328n;
            if (animatorSet != null) {
                animatorSet.cancel();
                this.f21328n = null;
            }
            AnimatorSet animatorSet2 = new AnimatorSet();
            this.f21328n = animatorSet2;
            animatorSet2.setInterpolator(new DecelerateInterpolator());
            this.f21328n.setDuration(180L);
            AnimatorSet animatorSet3 = this.f21328n;
            if (z10) {
                f7 = 1.0f;
            } else {
                f7 = 0.0f;
            ...
            this.f21328n.addListener(new org.telegram.ui.u4(this, 8));
            this.f21328n.start();
        }
    }
    ...
    public final void h(boolean z10) {
        p5 p5Var;
        o5 o5Var = this.f21325b;
        if (o5Var != null && (p5Var = this.f21324a) != null && p5Var.getMeasuredHeight() > 0 && p5Var.getMeasuredWidth() > 0) {
            if (z10) {
                if (this.M == null) {
                    this.M = vh.g.e(o5Var);
                    return;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        boolean z10 = this.d.f26827a.f21943q;
        p5 p5Var = this.f21324a;
        if (!z10 && this.f21325b.getScaleX() == 1.0f && p5Var.getImageReceiver().hasNotThumb() && p5Var.getImageReceiver().getCurrentAlpha() == 1.0f && (((photoEntry = this.G) == null || !PhotoViewer.L1(photoEntry.path)) && ((searchImage = this.H) == null || !PhotoViewer.L1(searchImage.getPathToAttach())))) {
            return;
        }
    ...
    public final void onMeasure(int i10, int i11) {
        if (this.f21332x) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(this.f21333y, 1073741824), ul.C(2.0f, this.f21333y, 1073741824));
            return;
        }
        int i12 = 6;
        if (this.E) {
    ...
    public void setItemSize(int i10) {
        this.f21333y = i10;
        FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) this.f21325b.getLayoutParams();
        int i11 = this.f21333y;
        layoutParams.height = i11;
        layoutParams.width = i11;
        FrameLayout.LayoutParams layoutParams2 = (FrameLayout.LayoutParams) this.f21326c.getLayoutParams();
    ...
    public void setOnCheckClickListener(View.OnClickListener onClickListener) {
        this.f21326c.setOnClickListener(onClickListener);
    }
}
