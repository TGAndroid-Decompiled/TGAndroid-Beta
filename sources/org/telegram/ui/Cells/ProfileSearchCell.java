...
public class ProfileSearchCell extends BaseCell implements NotificationCenter.NotificationCenterDelegate, Theme.Colorable {
    ...
    public void buildLayout() {
        ...
        if (charSequence2 == null) {
            ...
            if (tLRPC$Chat2 != null) {
                str2 = AndroidUtilities.removeDiacritics(tLRPC$Chat2.title);
            } else {
                TLRPC$User tLRPC$User2 = this.user;
                if (tLRPC$User2 == null) {
                    str2 = "";
                } else {
                    str2 = AndroidUtilities.removeDiacritics(UserObject.getUserName(tLRPC$User2));
                }
            }
        ...
        CharSequence ellipsize = TextUtils.ellipsize(charSequence2, textPaint3, dp3, truncateAt);
        if (ellipsize != null) {
