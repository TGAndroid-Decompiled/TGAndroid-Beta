...
public class n8 extends FrameLayout {
    ...
    public boolean L;
    public int M;
    public final org.telegram.ui.ActionBar.k5 f21437a;
    public final org.telegram.ui.ActionBar.k5 f21438b;
    public final org.telegram.ui.Components.k6 f21439c;
    public final org.telegram.ui.ActionBar.k5 d;
    public final jj0 e;
    public Switch f21440f;
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        if (j5Var3 != null) {
            j5Var3.setBounds((getWidth() - this.H.f25839s) - AndroidUtilities.dp(18.0f), (getHeight() - this.H.f25839s) / 2, getWidth() - AndroidUtilities.dp(18.0f), (getHeight() + this.H.f25839s) / 2);
            this.H.draw(canvas);
        }
    }
    ...
    public final void e(int i10, int i11) {
        ...
        org.telegram.ui.ActionBar.k5 k5Var = this.f21437a;
    ...
    public final void g(boolean z4) {
        ...
        ViewPropertyAnimator animate = this.f21437a.animate();
        float f13 = 0.5f;
        if (z4) {
            f10 = 1.0f;
        } else {
        ...
        ViewPropertyAnimator animate2 = this.f21438b.animate();
        if (z4) {
            f11 = 1.0f;
        } else {
            f11 = 0.5f;
        ...
        ViewPropertyAnimator animate3 = this.f21439c.animate();
        if (z4) {
            f12 = 1.0f;
        } else {
            f12 = 0.5f;
    ...
    public final void i(CharSequence charSequence, boolean z4) {
        ...
        k5Var.i(null);
        this.J = null;
        org.telegram.ui.Components.k6 k6Var = this.f21439c;
    ...
    public final void j(CharSequence charSequence, boolean z4, boolean z10) {
        ...
        this.h.setVisibility(8);
        this.f21442r = z10;
        Switch r62 = this.f21440f;
        if (r62 != null) {
            r62.setVisibility(0);
            this.f21440f.c(z4, false);
        }
        setWillNotDraw(!this.f21442r);
        org.telegram.ui.Components.j5 j5Var = this.H;
        if (j5Var != null) {
            j5Var.g(null, false);
        }
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (this.f21440f != null) {
            ...
            accessibilityNodeInfo.setChecked(this.f21440f.h);
    ...
    public void onLayout(boolean z4, int i10, int i11, int i12, int i13) {
        ...
        if (LocaleController.isRTL) {
            measuredWidth = AndroidUtilities.dp(this.f21441n - 6);
        } else {
            measuredWidth = (i18 - k6Var.getMeasuredWidth()) - AndroidUtilities.dp(this.f21441n - 6);
        }
        if (this.f21446y && !LocaleController.isRTL) {
            measuredWidth = (i18 - k6Var.getMeasuredWidth()) - AndroidUtilities.dp(this.f21441n);
        }
        k6Var.layout(measuredWidth, max, k6Var.getMeasuredWidth() + measuredWidth, k6Var.getMeasuredHeight() + max);
        if (LocaleController.isRTL) {
            measuredWidth2 = AndroidUtilities.dp(this.f21441n - 6);
        } else {
            measuredWidth2 = (i18 - k5Var.getMeasuredWidth()) - AndroidUtilities.dp(this.f21441n - 6);
        }
        k5Var.layout(measuredWidth2, max, k5Var.getMeasuredWidth() + measuredWidth2, k5Var.getMeasuredHeight() + max);
        boolean z10 = LocaleController.isRTL;
        jj0 jj0Var = this.e;
        org.telegram.ui.ActionBar.k5 k5Var2 = this.f21437a;
        if (z10) {
        ...
        org.telegram.ui.ActionBar.k5 k5Var3 = this.f21438b;
        ...
        if (jj0Var.getVisibility() == 0) {
            ...
            if (!LocaleController.isRTL) {
                measuredWidth5 = AndroidUtilities.dp(this.f21444w);
            } else {
                measuredWidth5 = (i18 - jj0Var.getMeasuredWidth()) - AndroidUtilities.dp(this.f21444w);
            }
        ...
        Switch r92 = this.f21440f;
        if (r92 != null && r92.getVisibility() == 0) {
            int measuredHeight = (i17 - this.f21440f.getMeasuredHeight()) / 2;
            if (LocaleController.isRTL) {
                measuredWidth3 = AndroidUtilities.dp(22.0f);
            } else {
                measuredWidth3 = (i18 - this.f21440f.getMeasuredWidth()) - AndroidUtilities.dp(22.0f);
            }
            Switch r10 = this.f21440f;
            r10.layout(measuredWidth3, measuredHeight, r10.getMeasuredWidth() + measuredWidth3, this.f21440f.getMeasuredHeight() + measuredHeight);
        }
    }
    ...
    public void onMeasure(int i10, int i11) {
        ...
        this.I = size;
        boolean z4 = this.f21446y;
        org.telegram.ui.ActionBar.k5 k5Var = this.f21438b;
        org.telegram.ui.ActionBar.k5 k5Var2 = this.d;
        org.telegram.ui.ActionBar.k5 k5Var3 = this.f21437a;
        if (z4) {
            k5Var3.measure(org.telegram.ui.b.d(this.f21441n + 71, size, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), 1073741824));
            k5Var.measure(org.telegram.ui.b.d(this.f21441n + 71, size, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), 1073741824));
            int dp2 = (size - AndroidUtilities.dp(this.f21441n + 103)) - k5Var3.getTextWidth();
            if (LocaleController.isRTL) {
            ...
            int dp3 = (size - AndroidUtilities.dp(this.f21441n + 103)) - k5Var3.getTextWidth();
            if (LocaleController.isRTL) {
            ...
            int dp4 = size - AndroidUtilities.dp(this.f21441n);
            if (LocaleController.isRTL) {
            ...
            int dp5 = size - AndroidUtilities.dp(this.f21441n);
            if (LocaleController.isRTL) {
            ...
            k5Var3.measure(View.MeasureSpec.makeMeasureSpec(Math.max(0, (size - AndroidUtilities.dp(this.f21441n + 71)) - max), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), 1073741824));
            k5Var.measure(View.MeasureSpec.makeMeasureSpec((size - AndroidUtilities.dp(this.f21441n + 71)) - max, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), 1073741824));
        }
        jj0 jj0Var = this.e;
        if (jj0Var.getVisibility() == 0) {
        ...
        setMeasuredDimension(size, dp + (this.f21442r ? 1 : 0));
    }
    ...
    public final void s(CharSequence charSequence, CharSequence charSequence2, boolean z4, int i10, boolean z10) {
        ...
        if (charSequence2 != null) {
            ...
            this.J = charSequence2;
            k6Var.c(TextUtils.ellipsize(charSequence2, k6Var.getPaint(), (int) Math.max(1.0f, AndroidUtilities.displaySize.x - ((g10 + AndroidUtilities.dp(this.f21443s)) + AndroidUtilities.dp(16.0f))), TextUtils.TruncateAt.END), z4, true);
        } else {
            k6Var.c("", z4, true);
        }
        k6Var.setVisibility(0);
    ...
    public final void v() {
        ...
        if (i10 != org.telegram.ui.ActionBar.j6.f19987j5 && i10 != org.telegram.ui.ActionBar.j6.G6) {
            v02 = c(v02);
        }
        k5Var.setTextColor(v02);
        jj0 jj0Var = this.e;
        if (jj0Var.getTag() instanceof Integer) {
            ...
            if (intValue != org.telegram.ui.ActionBar.j6.J5 && intValue != org.telegram.ui.ActionBar.j6.f20042m6) {
                v03 = c(v03);
            }
            jj0Var.setColorFilter(new PorterDuffColorFilter(v03, PorterDuff.Mode.SRC_IN));
        }
        this.f21438b.setTextColor(c(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20256y6, f6Var)));
        int i11 = org.telegram.ui.ActionBar.j6.I6;
        this.f21439c.setTextColor(c(org.telegram.ui.ActionBar.j6.v0(i11, f6Var)));
    ...
    public n8(int i10, Context context, org.telegram.ui.ActionBar.f6 f6Var, boolean z4, boolean z10) {
        ...
        this.f21437a = k5Var;
        k5Var.setTextColor(org.telegram.ui.ActionBar.j6.v0(z4 ? org.telegram.ui.ActionBar.j6.f19987j5 : org.telegram.ui.ActionBar.j6.G6, f6Var));
        ...
        this.f21438b = k5Var2;
        k5Var2.setTextColor(org.telegram.ui.ActionBar.j6.v0(z4 ? org.telegram.ui.ActionBar.j6.f20095p5 : org.telegram.ui.ActionBar.j6.f20256y6, f6Var));
        ...
        this.f21439c = k6Var;
        k6Var.setTextColor(org.telegram.ui.ActionBar.j6.v0(z4 ? org.telegram.ui.ActionBar.j6.f20059n5 : org.telegram.ui.ActionBar.j6.I6, f6Var));
        ...
        k5Var3.f20374n0 = 18;
        k5Var3.m();
        k5Var3.setTextColor(org.telegram.ui.ActionBar.j6.v0(z4 ? org.telegram.ui.ActionBar.j6.f20059n5 : org.telegram.ui.ActionBar.j6.I6, f6Var));
        ...
        imageView.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(z4 ? org.telegram.ui.ActionBar.j6.J5 : org.telegram.ui.ActionBar.j6.f20042m6, f6Var), PorterDuff.Mode.SRC_IN));
        addView(imageView);
        ...
        if (z10) {
            ...
            addView(this.f21440f, k7.b6.d(37, 20.0f, (LocaleController.isRTL ? 3 : 5) | 16, 22.0f, 0.0f, 22.0f, 0.0f));
        }
        setFocusable(true);
    }
