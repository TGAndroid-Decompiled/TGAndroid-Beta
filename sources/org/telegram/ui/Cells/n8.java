...
public final class n8 extends FrameLayout {
    ...
    public n8(Context context, int i10) {
        ...
        addView(w9Var, w7.x5.d(40, 40.0f, i20, f7, 9.0f, f10, 0.0f));
        if (i10 != 0) {
        ...
        this.f20478x = frameLayout;
        TextView textView = new TextView(context);
        this.f20479y = textView;
        ...
        textView.setBackground(org.telegram.ui.ActionBar.x5.d(new float[]{14.0f}, org.telegram.ui.ActionBar.h6.w0(null, i23, false), org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.Qh, false)));
        ...
        textView2.setBackground(org.telegram.ui.ActionBar.x5.d(new float[]{14.0f}, 0, org.telegram.ui.ActionBar.h6.w0(null, i23, false) & 452984831));
        ...
        FrameLayout frameLayout2 = this.f20478x;
        rg.p0 p0Var2 = this.F;
        if (LocaleController.isRTL) {
            i14 = 3;
        } else {
        ...
        w7.z5.a(this.F);
        this.f20478x.setPadding(AndroidUtilities.dp(10.0f), 0, AndroidUtilities.dp(10.0f), 0);
        View view = this.f20478x;
        if (LocaleController.isRTL) {
            i15 = 3;
        } else {
            i15 = 5;
        ...
        this.f20478x.setOnClickListener(new h8(this, 1));
        ...
        this.f20472c = textView3;
        ul.s(textView3, org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19189z6, false), 1, 13.0f, 1);
        ...
        if (i10 == 3) {
            ...
            imageView3.setColorFilter(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19170y6, false), PorterDuff.Mode.SRC_IN);
            imageView3.setBackground(org.telegram.ui.ActionBar.h6.f0(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f18878i6, false), 1, -1));
    ...
    public final boolean a() {
        ...
        if (i10 == 1) {
            return this.e.f26827a.f21943q;
        }
        if (i10 == 3) {
            if (this.h.getVisibility() != 0) {
                return false;
            }
        } else if (!this.f20477w || this.f20478x.getVisibility() != 0) {
            return false;
        }
        return true;
    }
    ...
    public final void b(boolean z10, boolean z11) {
        ...
        } else if (this.f20477w) {
            FrameLayout frameLayout = this.f20478x;
            if (z11) {
    ...
    public final void c(final boolean z10) {
        ...
        if (this.f20470a == 1) {
            ...
            float[] fArr2 = {f10, f12};
            ImageView imageView = this.f20474n;
            ...
            duration.setInterpolator(rrVar).withEndAction(new Runnable(this) {
                ...
                public final void run() {
                    switch (r3) {
                        case 0:
                            boolean z11 = z10;
                            n8 n8Var = this.f20245b;
                            if (!z11) {
                                n8Var.f20474n.setVisibility(8);
                                return;
                            } else {
                                n8Var.getClass();
                                return;
                        ...
                        case 1:
                            boolean z12 = z10;
                            n8 n8Var2 = this.f20245b;
                            if (z12) {
                                n8Var2.f20478x.setVisibility(8);
                                return;
                            } else {
                                n8Var2.getClass();
                                return;
    ...
    public final void d(TLRPC.TL_messages_stickerSet tL_messages_stickerSet, boolean z10, boolean z11) {
        ...
        String str2;
        this.f20473f = z10;
        this.f20475r = tL_messages_stickerSet;
        this.f20476s = z11;
        org.telegram.ui.Components.w9 w9Var = this.d;
        w9Var.setVisibility(0);
        ai.p4 p4Var = this.f20471b;
        p4Var.setTranslationY(0.0f);
        p4Var.setText(this.f20475r.set.title);
        boolean z12 = this.f20475r.set.archived;
        TextView textView = this.f20472c;
        if (z12) {
            p4Var.setAlpha(0.5f);
        ...
        this.f20478x.setVisibility(i10);
        if (!this.f20477w) {
            i12 = 0;
        }
        ...
        if (arrayList != null && !arrayList.isEmpty()) {
            ...
            while (true) {
                if (i13 < arrayList.size()) {
                    ...
                    if (document2 != null && document2.f18089id == tL_messages_stickerSet.set.thumb_document_id) {
                        document = document2;
                        break;
                    }
                    i13++;
            ...
            SvgHelper.SvgDrawable svgThumb = DocumentObject.getSvgThumb(tL_messages_stickerSet.set.thumbs, org.telegram.ui.ActionBar.h6.f18733a7, 1.0f);
            ...
            if (!z14 || (!MessageObject.isAnimatedStickerDocument(document, true) && !MessageObject.isVideoSticker(document))) {
                ...
                if (MessageObject.isTextColorEmoji(document)) {
                    w9Var.setColorFilter(org.telegram.ui.ActionBar.h6.f19115v3);
                }
            }
        } else {
            tL_messages_stickerSet2 = tL_messages_stickerSet;
    ...
    public final void e(int i10) {
        ...
        TextView textView = this.f20479y;
        ...
        TextView textView3 = this.f20472c;
        ai.p4 p4Var = this.f20471b;
        if (z13) {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.f20473f) {
            ...
            canvas.drawLine(dp, height, width - i10, getHeight() - 1, org.telegram.ui.ActionBar.h6.f18910k0);
        }
    }
    ...
    public final void onMeasure(int i10, int i11) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i10), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(58.0f) + (this.f20473f ? 1 : 0), 1073741824));
    }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (getBackground() != null && this.f20477w && (frameLayout = this.f20478x) != null) {
    ...
    public void setOnReorderButtonTouchListener(View.OnTouchListener onTouchListener) {
        this.f20474n.setOnTouchListener(onTouchListener);
    }
