...
public final class ea extends FrameLayout {
    ...
    public Paint G;
    public boolean H;
    public final org.telegram.ui.ActionBar.e6 f20037a;
    public final TextView f20038b;
    public final org.telegram.ui.Components.n6 f20039c;
    public final aj0 d;
    public org.telegram.ui.Components.u9 e;
    public final ImageView f20040f;
    public boolean h;
    public boolean f20041n;
    public boolean f20042r;
    public final int f20043s;
    public boolean v;
    public float f20044w;
    public float f20045x;
    public int f20046y;
    ...
    public final void a(ArrayList arrayList, boolean z10) {
        ...
        float f12;
        setEnabled(z10);
        TextView textView = this.f20038b;
        ImageView imageView = this.f20040f;
        org.telegram.ui.Components.n6 n6Var = this.f20039c;
        float f13 = 0.5f;
        if (arrayList != null) {
            if (z10) {
                f11 = 1.0f;
    ...
    public final void b(CharSequence charSequence, boolean z10) {
        this.f20038b.setText(charSequence);
        this.f20039c.setVisibility(4);
        this.f20040f.setVisibility(4);
        this.h = z10;
        setWillNotDraw(!z10);
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        float f10;
        int i10 = 0;
        if (this.f20042r || this.f20045x != 0.0f) {
            if (this.G == null) {
                Paint paint = new Paint(1);
                this.G = paint;
                paint.setColor(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.O5, this.f20037a));
            }
            if (this.v) {
                float f11 = this.f20044w + 0.016f;
                this.f20044w = f11;
                if (f11 > 1.0f) {
                    this.f20044w = 1.0f;
                    this.v = false;
            ...
            if (i11 > 0) {
                ...
                boolean z10 = this.f20042r;
                if (z10) {
                    float f13 = this.f20045x;
                    if (f13 != 1.0f) {
            ...
            this.G.setAlpha((int) (((this.f20044w * 0.4f) + 0.6f) * this.f20045x * 255.0f));
            int measuredHeight = getMeasuredHeight() >> 1;
            RectF rectF = AndroidUtilities.rectTmp;
            int measuredWidth = getMeasuredWidth();
            float f17 = this.f20043s;
            rectF.set((measuredWidth - AndroidUtilities.dp(f17)) - AndroidUtilities.dp(this.f20046y), measuredHeight - AndroidUtilities.dp(3.0f), getMeasuredWidth() - AndroidUtilities.dp(f17), AndroidUtilities.dp(3.0f) + measuredHeight);
            if (LocaleController.isRTL) {
        ...
        this.f20039c.setAlpha(1.0f - this.f20045x);
        ...
        if (this.h) {
            ...
            canvas.drawLine(f10, measuredHeight2, measuredWidth2 - i10, getMeasuredHeight() - 1, org.telegram.ui.ActionBar.i6.f18955k0);
        }
    }
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        sb2.append((Object) this.f20038b.getText());
        org.telegram.ui.Components.n6 n6Var = this.f20039c;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (n6Var.getVisibility() == 0) {
            ...
            if (this.H) {
                measuredWidth = vl.w(8.0f, n6Var.getMeasuredWidth(), i12);
            } else {
        ...
        this.f20038b.measure(View.MeasureSpec.makeMeasureSpec(measuredWidth, 1073741824), View.MeasureSpec.makeMeasureSpec(getMeasuredHeight(), 1073741824));
    }
    ...
    public void setIcon(int i10) {
        ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) this.f20038b.getLayoutParams();
        aj0 aj0Var = this.d;
        if (i10 == 0) {
            aj0Var.setVisibility(8);
            boolean z10 = LocaleController.isRTL;
            int i11 = this.f20043s;
            if (z10) {
        ...
        aj0Var.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f18998m6, this.f20037a), PorterDuff.Mode.MULTIPLY));
    ...
    public void setTextColor(int i10) {
        this.f20038b.setTextColor(i10);
    }

    public void setTextValueColor(int i10) {
        this.f20039c.setTextColor(i10);
    }
