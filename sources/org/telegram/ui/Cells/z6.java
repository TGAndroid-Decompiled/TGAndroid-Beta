...
public final class z6 extends FrameLayout {
    ...
    public final void a(CharSequence charSequence, String[] strArr, boolean z10, boolean z11) {
        TextView textView = this.f21933a;
        FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) textView.getLayoutParams();
        TextView textView2 = this.f21934b;
        if (z10) {
            ...
            if (strArr != null) {
                ...
                for (int i11 = 0; i11 < strArr.length; i11++) {
                    if (i11 != 0) {
                        ...
                        mutate2.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19511z6, false), PorterDuff.Mode.MULTIPLY));
    ...
    public final void b(CharSequence charSequence, String[] strArr, int i10, boolean z10) {
        ...
        if (strArr != null) {
            ...
            for (int i11 = 0; i11 < strArr.length; i11++) {
                if (i11 != 0) {
                    ...
                    Drawable mutate = getContext().getResources().getDrawable(R.drawable.settings_arrow).mutate();
                    mutate.setBounds(0, 0, mutate.getIntrinsicWidth(), mutate.getIntrinsicHeight());
                    mutate.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19511z6, false), PorterDuff.Mode.MULTIPLY));
                    spannableStringBuilder.setSpan(new y6(mutate), spannableStringBuilder.length() - 2, spannableStringBuilder.length() - 1, 33);
                }
        ...
        ImageView imageView = this.f21935c;
        if (i10 != 0) {
