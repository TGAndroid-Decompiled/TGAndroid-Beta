...
public final class j6 extends FrameLayout {
    public final TextView f20516a;
    public final TextView f20517b;
    public final RadioButton f20518c;
    public boolean d;
    ...
    public final void a(boolean z10) {
        this.f20518c.a(z10, true);
    }

    public final void b(String str, String str2, boolean z10, boolean z11) {
        this.f20516a.setText(str);
        this.f20517b.setText(str2);
        this.f20518c.a(z11, false);
        this.d = z10;
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.d) {
            ...
            canvas.drawLine(dp, height, measuredWidth - AndroidUtilities.dp(f10), getHeight() - 1, org.telegram.ui.ActionBar.h6.f19181k0);
        }
    }
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        accessibilityNodeInfo.setChecked(this.f20518c.f22385f);
    }
