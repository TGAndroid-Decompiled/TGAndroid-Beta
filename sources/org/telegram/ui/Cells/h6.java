...
public final class h6 extends FrameLayout {
    ...
    public final TextView f21146b;
    public final RadioButton f21147c;
    public boolean d;
    ...
    public h6(Context context, boolean z4) {
        ...
        addView(radioButton, k7.b6.d(22, 22.0f, i17, i11, 10.0f, z10 ? 20 : 0, 0.0f));
        ...
        addView(textView, k7.b6.d(-2, -2.0f, i18, i14, 10.0f, z11 ? 61 : 23, 0.0f));
        TextView textView2 = new TextView(context);
        this.f21146b = textView2;
        if (z4) {
            textView2.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20114q5, false));
        } else {
        ...
        addView(textView2, k7.b6.d(-2, -2.0f, i19, i16, 35.0f, z12 ? 61 : 17, 0.0f));
    }

    public final void a(boolean z4) {
        this.f21147c.a(z4, true);
    }

    public final void b(String str, String str2, boolean z4, boolean z10) {
        this.f21145a.setText(str);
        this.f21146b.setText(str2);
        this.f21147c.a(z10, false);
        this.d = z4;
    }
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        accessibilityNodeInfo.setChecked(this.f21147c.f23122f);
    }
