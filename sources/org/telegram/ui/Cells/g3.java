...
public final class g3 extends bu {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        i3 i3Var = this.f20142f;
        org.telegram.ui.Components.m6 m6Var = i3Var.v;
        org.telegram.ui.Components.f5 f5Var = i3Var.f20243r;
        if (i3Var.f20244s <= 0) {
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        if (drawable != this.f20142f.v && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
