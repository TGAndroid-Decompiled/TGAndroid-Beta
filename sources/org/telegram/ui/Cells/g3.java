...
public final class g3 extends zt {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        i3 i3Var = this.f21970f;
        org.telegram.ui.Components.p6 p6Var = i3Var.v;
        org.telegram.ui.Components.h5 h5Var = i3Var.f22080r;
        if (i3Var.f22081s <= 0) {
    ...
    public final void extendActionMode(ActionMode actionMode, Menu menu) {
        if (!this.f21969e || menu.findItem(R.id.menu_bold) != null) {
            return;
        }
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        if (drawable != this.f21970f.v && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
