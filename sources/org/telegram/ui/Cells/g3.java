...
public final class g3 extends bu {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        i3 i3Var = this.f20143f;
        org.telegram.ui.Components.m6 m6Var = i3Var.v;
        org.telegram.ui.Components.f5 f5Var = i3Var.f20244r;
        if (i3Var.f20245s <= 0) {
            i10 = org.telegram.ui.ActionBar.j6.f19083p7;
        } else {
            i10 = org.telegram.ui.ActionBar.j6.P5;
        }
        m6Var.r(f5Var.a(org.telegram.ui.ActionBar.j6.v0(i10, this.d), false));
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        if (drawable != this.f20143f.v && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
