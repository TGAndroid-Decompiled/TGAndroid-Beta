...
public final class g3 extends zt {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        i3 i3Var = this.f21997f;
        org.telegram.ui.Components.p6 p6Var = i3Var.v;
        org.telegram.ui.Components.h5 h5Var = i3Var.f22107r;
        if (i3Var.f22108s <= 0) {
    ...
    public final void extendActionMode(ActionMode actionMode, Menu menu) {
        if (!this.f21996e || menu.findItem(R.id.menu_bold) != null) {
            return;
        }
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        if (drawable != this.f21997f.v && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
