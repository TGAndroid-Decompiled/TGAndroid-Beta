...
public final class q1 extends AccessibilityNodeProvider {
    public final Path f22481a = new Path();
    public final RectF f22482b = new RectF();
    public final Rect f22483c = new Rect();
    public final t1 d;
    ...
    public final ClickableSpan a(int i10, boolean z10) {
        ...
        if (z10) {
            int i11 = i10 - 3000;
            CharSequence charSequence = t1Var.f23206y7.caption;
        ...
        int i12 = i10 - 2000;
        CharSequence charSequence2 = t1Var.f23206y7.messageText;
    ...
    public final RichMessageLayout.RichBlock b(int i10, int[] iArr) {
        ...
        int i11;
        MessageObject messageObject = this.d.f23206y7;
    ...
    public final boolean performAction(int i10, int i11, Bundle bundle) {
        ...
        ArrayList arrayList2 = t1Var.f23059o7;
        if (i10 == -1) {
                ...
                if (i10 == 5000) {
                    ...
                    if (i10 >= 1000) {
                        ...
                        if (i12 < arrayList2.size()) {
                            ...
                            k1 k1Var3 = t1Var.Jc;
                            if (k1Var3 != null && !e0Var.f21822m) {
                                BotInlineKeyboard.ButtonCustom buttonCustom = e0Var.f21819j;
                                if (buttonCustom != null) {
                                    k1Var3.E(t1Var, buttonCustom);
                                } else {
                                    TL_keyboard.KeyboardInlineButton keyboardInlineButton = e0Var.f21818i;
                        ...
                        k1 k1Var4 = t1Var.Jc;
                        if (k1Var4 != null) {
                            k1Var4.L0(t1Var.f22874b3, t1Var);
                            return true;
                        }
                    } else if (i10 == 492) {
                        k1 k1Var5 = t1Var.Jc;
                        ...
                        if (t1Var.Jc != null && ((!t1Var.W7 || t1Var.U7 || t1Var.f23206y7.getReplyTopMsgId() != 0) && (t1Var.f23206y7.hasValidReplyMessageObject() || t1Var.f23208y9 || ((message = t1Var.f23206y7.messageOwner) != null && (messageReplyHeader = message.reply_to) != null && messageReplyHeader.reply_from != null)))) {
                            t1Var.Jc.T1(t1Var, t1Var.f23206y7.getReplyMsgId(), 0.0f, 0.0f, false);
                            return true;
                        }
                    } else if (i10 == 494) {
                        k1 k1Var10 = t1Var.Jc;
                        if (k1Var10 != null) {
                            TLRPC.Chat chat = t1Var.f22994jc;
                            if (chat != null) {
                                k1Var10.S(t1Var, chat, t1Var.f23206y7.messageOwner.fwd_from.channel_post, t1Var.f22942g1, t1Var.f22955h1, false);
                                return true;
                            }
                            TLRPC.User user = t1Var.f22965hc;
                            if (user != null) {
                                k1Var10.s0(t1Var, user, t1Var.f22942g1, t1Var.f22955h1);
                                return true;
