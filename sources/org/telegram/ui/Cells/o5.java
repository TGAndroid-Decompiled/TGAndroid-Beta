...
public final class o5 extends org.telegram.ui.Components.x9 {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (imageReceiver != null) {
            if (this.f32478c != -1 && this.d != -1) {
                int height = getHeight();
                int i10 = this.d;
                imageReceiver.setImageCoords((getWidth() - this.f32478c) / 2, (height - i10) / 2, this.f32478c, i10);
                int height2 = getHeight();
                int i11 = this.d;
                this.f32477b.setImageCoords((getWidth() - this.f32478c) / 2, (height2 - i11) / 2, this.f32478c, i11);
            } else {
            ...
            if (i12 != 0 && s5Var.R != null) {
                Paint paint = this.G;
                paint.setAlpha((int) (pr.f29466f.getInterpolation(1.0f - f7) * 255.0f));
            ...
            if (s5Var.f22838s) {
                q5 q5Var2 = s5Var.U;
                if ((q5Var2 == null || !((hm) ((org.telegram.ui.Components.t) q5Var2).f30454b).f26757s) && (photoEntry = s5Var.G) != null && photoEntry.isLivePhoto()) {
