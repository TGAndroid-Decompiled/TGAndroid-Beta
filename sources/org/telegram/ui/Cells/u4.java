...
public final class u4 extends FrameLayout {
    public static u00 f21620x;
    public final org.telegram.ui.Components.p6 f21621a;
    public final org.telegram.ui.Components.p6 f21622b;
    public final org.telegram.ui.Components.w9 f21623c;
    public final ShapeDrawable d;
    public boolean e;
    public final org.telegram.ui.ActionBar.d6 f21624f;
    public boolean h;
    public CharSequence f21625n;
    public String f21626r;
    public String f21627s;
    public float v;
    public ValueAnimator f21628w;
    ...
    public final void b(TLRPC.TL_messageMediaVenue tL_messageMediaVenue, int i10, boolean z10, boolean z11) {
        ...
        boolean z15;
        this.e = z10;
        org.telegram.ui.Components.p6 p6Var = this.f21621a;
        if (tL_messageMediaVenue != null) {
            if (TextUtils.equals(this.f21626r, tL_messageMediaVenue.emoji) && TextUtils.equals(this.f21627s, tL_messageMediaVenue.title)) {
                charSequence = this.f21625n;
            } else {
                ...
                this.f21626r = tL_messageMediaVenue.emoji;
                this.f21627s = tL_messageMediaVenue.title;
                this.f21625n = charSequence;
            }
        ...
        org.telegram.ui.Components.p6 p6Var2 = this.f21622b;
        if (tL_messageMediaVenue != null) {
        ...
        int a2 = a(i10);
        org.telegram.ui.Components.w9 w9Var = this.f21623c;
        if (tL_messageMediaVenue != null && (str3 = tL_messageMediaVenue.icon) != null) {
            if (!"pin".equals(str3) && !tL_messageMediaVenue.icon.startsWith("emoji")) {
                ...
                mutate.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19238ni, this.f21624f), PorterDuff.Mode.MULTIPLY));
        ...
        setClickable(z12);
        ValueAnimator valueAnimator = this.f21628w;
        ...
        this.f21628w = ValueAnimator.ofFloat(f10, f7);
        final long elapsedRealtime = SystemClock.elapsedRealtime();
        this.f21628w.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            @Override
            public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                ...
                u4Var.v = lerp;
                u4Var.f21623c.setAlpha(lerp);
                u4Var.f21621a.setAlpha(u4Var.v);
                u4Var.f21622b.setAlpha(u4Var.v);
                u4Var.invalidate();
            }
        });
        ValueAnimator valueAnimator2 = this.f21628w;
        if (z13) {
            abs = Long.MAX_VALUE;
        }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float width;
        u00 u00Var = f21620x;
        org.telegram.ui.ActionBar.d6 d6Var = this.f21624f;
        if (u00Var == null) {
        ...
        if (this.e) {
            ...
            if (G == null) {
                G = org.telegram.ui.ActionBar.h6.f19166k0;
            }
            Paint paint = G;
            if (LocaleController.isRTL) {
                dp = 0.0f;
