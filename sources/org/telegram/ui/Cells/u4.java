...
public final class u4 extends FrameLayout {
    public static a10 f20479x;
    public final org.telegram.ui.Components.o6 f20480a;
    public final org.telegram.ui.Components.o6 f20481b;
    public final org.telegram.ui.Components.w9 f20482c;
    public final ShapeDrawable d;
    public boolean e;
    public final org.telegram.ui.ActionBar.f6 f20483f;
    public boolean h;
    public CharSequence f20484n;
    public String f20485r;
    public String f20486s;
    public float v;
    public ValueAnimator f20487w;
    ...
    public u4(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        addView(w9Var, w7.a6.d(42, 42.0f, i17, f7, 11.0f, f10, 0.0f));
        ...
        addView(o6Var, w7.a6.d(-1, 22.0f, i18, f11, 10.0f, i14, 0.0f));
        ...
        addView(o6Var2, w7.a6.d(-1, 20.0f, i19, i16, 35.0f, z12 ? 73 : 16, 0.0f));
    ...
    public final void b(TLRPC.TL_messageMediaVenue tL_messageMediaVenue, int i10, boolean z10, boolean z11) {
        ...
        boolean z15;
        this.e = z10;
        org.telegram.ui.Components.o6 o6Var = this.f20480a;
        if (tL_messageMediaVenue != null) {
            if (TextUtils.equals(this.f20485r, tL_messageMediaVenue.emoji) && TextUtils.equals(this.f20486s, tL_messageMediaVenue.title)) {
                charSequence = this.f20484n;
            } else {
                ...
                this.f20485r = tL_messageMediaVenue.emoji;
                this.f20486s = tL_messageMediaVenue.title;
                this.f20484n = charSequence;
            }
        ...
        org.telegram.ui.Components.o6 o6Var2 = this.f20481b;
        if (tL_messageMediaVenue != null) {
        ...
        int a2 = a(i10);
        org.telegram.ui.Components.w9 w9Var = this.f20482c;
        if (tL_messageMediaVenue != null && (str3 = tL_messageMediaVenue.icon) != null) {
            if (!"pin".equals(str3) && !tL_messageMediaVenue.icon.startsWith("emoji")) {
                ...
                mutate.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.ni, this.f20483f), PorterDuff.Mode.MULTIPLY));
        ...
        setClickable(z12);
        ValueAnimator valueAnimator = this.f20487w;
        ...
        this.f20487w = ValueAnimator.ofFloat(f10, f7);
        final long elapsedRealtime = SystemClock.elapsedRealtime();
        this.f20487w.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            @Override
            public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                ...
                u4Var.v = lerp;
                u4Var.f20482c.setAlpha(lerp);
                u4Var.f20480a.setAlpha(u4Var.v);
                u4Var.f20481b.setAlpha(u4Var.v);
                u4Var.invalidate();
            }
        });
        ValueAnimator valueAnimator2 = this.f20487w;
        if (z13) {
            abs = Long.MAX_VALUE;
        }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float width;
        a10 a10Var = f20479x;
        org.telegram.ui.ActionBar.f6 f6Var = this.f20483f;
        if (a10Var == null) {
        ...
        if (this.e) {
            if (f6Var == null) {
                ...
                F = f6Var.F("paintDivider");
            }
            if (F == null) {
                F = org.telegram.ui.ActionBar.j6.f18049k0;
            }
            Paint paint = F;
            if (LocaleController.isRTL) {
                dp = 0.0f;
