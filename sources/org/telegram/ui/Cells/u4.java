...
public final class u4 extends FrameLayout {
    public static t00 f21599x;
    public final org.telegram.ui.Components.p6 f21600a;
    public final org.telegram.ui.Components.p6 f21601b;
    public final org.telegram.ui.Components.w9 f21602c;
    public final ShapeDrawable d;
    public boolean e;
    public final org.telegram.ui.ActionBar.e6 f21603f;
    public boolean h;
    public CharSequence f21604n;
    public String f21605r;
    public String f21606s;
    public float v;
    public ValueAnimator f21607w;
    ...
    public final void b(TLRPC.TL_messageMediaVenue tL_messageMediaVenue, int i10, boolean z10, boolean z11) {
        ...
        boolean z15;
        this.e = z10;
        org.telegram.ui.Components.p6 p6Var = this.f21600a;
        if (tL_messageMediaVenue != null) {
            if (TextUtils.equals(this.f21605r, tL_messageMediaVenue.emoji) && TextUtils.equals(this.f21606s, tL_messageMediaVenue.title)) {
                charSequence = this.f21604n;
            } else {
                ...
                this.f21605r = tL_messageMediaVenue.emoji;
                this.f21606s = tL_messageMediaVenue.title;
                this.f21604n = charSequence;
            }
        ...
        org.telegram.ui.Components.p6 p6Var2 = this.f21601b;
        if (tL_messageMediaVenue != null) {
        ...
        int a2 = a(i10);
        org.telegram.ui.Components.w9 w9Var = this.f21602c;
        if (tL_messageMediaVenue != null && (str3 = tL_messageMediaVenue.icon) != null) {
            if (!"pin".equals(str3) && !tL_messageMediaVenue.icon.startsWith("emoji")) {
                ...
                mutate.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19256ni, this.f21603f), PorterDuff.Mode.MULTIPLY));
        ...
        setClickable(z12);
        ValueAnimator valueAnimator = this.f21607w;
        ...
        this.f21607w = ValueAnimator.ofFloat(f10, f7);
        final long elapsedRealtime = SystemClock.elapsedRealtime();
        this.f21607w.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            @Override
            public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                ...
                u4Var.v = lerp;
                u4Var.f21602c.setAlpha(lerp);
                u4Var.f21600a.setAlpha(u4Var.v);
                u4Var.f21601b.setAlpha(u4Var.v);
                u4Var.invalidate();
            }
        });
        ValueAnimator valueAnimator2 = this.f21607w;
        if (z13) {
            abs = Long.MAX_VALUE;
        }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float width;
        t00 t00Var = f21599x;
        org.telegram.ui.ActionBar.e6 e6Var = this.f21603f;
        if (t00Var == null) {
        ...
        if (this.e) {
            ...
            if (G == null) {
                G = org.telegram.ui.ActionBar.j6.f19184k0;
            }
            Paint paint = G;
            if (LocaleController.isRTL) {
                dp = 0.0f;
