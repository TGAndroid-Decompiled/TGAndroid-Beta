...
public class d6 extends FrameLayout implements vy0, le.e {
    public Integer E;
    public final le.c f20135a;
    public final le.c f20136b;
    public final org.telegram.ui.ActionBar.d6 f20137c;
    public final c6 d;
    public qh.d e;
    public final ImageView f20138f;
    public final ImageView h;
    public org.telegram.ui.ActionBar.h5 f20139n;
    public final op f20140r;
    public boolean f20141s;
    public boolean v;
    public AnimatorSet f20142w;
    public boolean f20143x;
    public final bh f20144y;
    ...
    public d6(Context context, int i10, View.OnClickListener onClickListener, org.telegram.ui.ActionBar.d6 d6Var) {
        ...
        int i21;
        rr rrVar = rr.h;
        this.f20135a = new le.c(0, this, rrVar, 380L, false);
        this.f20136b = new le.c(1, this, rrVar, 380L, false);
        this.f20137c = d6Var;
        ...
        if (onClickListener != null) {
            ...
            int i23 = org.telegram.ui.ActionBar.h6.f19224m6;
            ...
            org.telegram.ui.ActionBar.h5 h5Var2 = this.f20139n;
            if (LocaleController.isRTL) {
                i19 = 3;
            } else {
                i19 = 5;
            ...
            this.f20140r = opVar;
            opVar.b(-1, i23, org.telegram.ui.ActionBar.h6.f19188k7);
            ...
            opVar.setOnClickListener(new View.OnClickListener(this) {
                ...
                public final void onClick(View view2) {
                    switch (r2) {
                        case 0:
                            d6 d6Var2 = this.f20061b;
                            op opVar2 = d6Var2.f20140r;
                            if (opVar2.getTag() != null) {
                                d6Var2.h(d6Var2, !opVar2.f27168a.f22195q);
                                return;
                            }
                            return;
                        default:
                            d6 d6Var3 = this.f20061b;
                            d6Var3.j(d6Var3);
                            return;
                    }
                }
        ...
        if (i10 == 1) {
            ...
            this.f20144y = bhVar;
            bhVar.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19224m6, d6Var), PorterDuff.Mode.SRC_IN));
            bhVar.j(zg.e, false);
    ...
    public final void D(int i10, float f7, float f10, le.f fVar) {
        ...
        int i11;
        if (i10 == 0) {
            op opVar = this.f20140r;
            if (opVar != null) {
                CheckBoxBase checkBoxBase = opVar.getCheckBoxBase();
                float f11 = this.f20135a.e;
                if (checkBoxBase.f22200w != f11) {
                    checkBoxBase.f22200w = f11;
                    checkBoxBase.b();
                }
                opVar.invalidate();
            }
        } else if (i10 == 1 && (bhVar = this.f20144y) != null) {
            float f12 = this.f20136b.e;
            float f13 = 0.85f * f12;
            bhVar.setScaleX(f13);
            bhVar.setScaleY(f13);
            bhVar.setAlpha(f12);
            ...
            org.telegram.ui.ActionBar.h5 h5Var = this.f20139n;
            if (h5Var != null && this.f20138f == null && h5Var.getVisibility() == 0) {
                if (this.e != null) {
                    this.f20139n.setTranslationY(AndroidUtilities.dp(36.0f));
                } else {
                    this.f20139n.setTranslationY(AndroidUtilities.dp(26.0f) * f12);
                }
            }
        }
    }
    ...
    public final qh.d b() {
        ...
        float f12;
        float f13;
        ImageView imageView = this.f20138f;
        if (imageView != null) {
        ...
        this.e.setBackground(org.telegram.ui.ActionBar.h6.f0(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.Vh, this.f20137c), 1, -1));
        w7.a6.a(this.e);
        qh.d dVar2 = this.e;
        boolean z10 = LocaleController.isRTL;
        int i14 = 5;
    ...
    public final void d() {
        ...
        org.telegram.ui.ActionBar.h5 h5Var3 = this.f20139n;
        boolean z10 = LocaleController.isRTL;
        if (z10) {
            i11 = 3;
        }
    ...
    public final void m(boolean z10, boolean z11) {
        ...
        AnimatorSet animatorSet = this.f20142w;
        Integer num = null;
        if (animatorSet != null) {
            animatorSet.cancel();
            this.f20142w = null;
