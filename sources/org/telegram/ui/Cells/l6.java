...
public final class l6 extends FrameLayout {
    public final TextView f20388a;
    public final TextView f20389b;
    public final RadioButton f20390c;
    public int d;
    ...
    public l6(Context context, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        this.f20388a = textView;
        vl.o(org.telegram.ui.ActionBar.i6.f18940j5, e6Var, textView, 1, 16.0f);
        textView.setLines(1);
        ...
        this.f20389b = textView2;
        vl.o(org.telegram.ui.ActionBar.i6.f19215y6, e6Var, textView2, 1, 14.0f);
        if (LocaleController.isRTL) {
            i16 = 5;
        } else {
            i16 = 3;
    ...
    public final void a(int i10, int i11) {
        this.f20390c.b(i10, i11);
    }

    public final void b(CharSequence charSequence, boolean z10) {
        this.f20388a.setText(charSequence);
        this.f20389b.setVisibility(8);
        this.f20390c.a(z10, false);
    }
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        accessibilityNodeInfo.setChecked(this.f20390c.f22159f);
    }
