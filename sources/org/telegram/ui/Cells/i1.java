...
public final class i1 extends o1 {
    ...
    public final void e() {
        ...
        Path path = this.f20755b;
        path.rewind();
        u1 u1Var = this.f20435f;
        int[] iArr = u1Var.f21572x3;
        int i12 = this.e;
        int i13 = iArr[i12];
        if (i13 != 3 && i13 != 4) {
            float f10 = 0.0f;
            if (i13 == 2) {
                ...
                for (int i14 = 0; i14 < 4; i14++) {
                    if (!u1Var.f21467q3) {
                        ...
                        if (i14 == i10) {
                            ...
                            fArr[i15 + 1] = dp;
                            fArr[i15] = dp;
                        } else if (((u1Var.f21389k8 && u1Var.L == null) || u1Var.F) && (i14 == 2 || i14 == 3)) {
                            float[] fArr2 = u1.Fe;
                            int i16 = i14 * 2;
                            int i17 = i16 + 1;
                            if (u1Var.F) {
                ...
                if (!z10 && !u1Var.J && (groupedMessagePosition = u1Var.L) == null && (groupedMessagePosition == null || u1Var.f21242a3)) {
