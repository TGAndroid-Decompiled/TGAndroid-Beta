...
public final class s5 extends FrameLayout {
    public static final Rect f20948a0 = new Rect();
    public boolean E;
    ...
    public final o5 f20949a;
    public final n5 f20950b;
    public final FrameLayout f20951c;
    public final np d;
    public final ImageView e;
    public final TextView f20952f;
    public final p5 h;
    public AnimatorSet f20953n;
    ...
    public s5(Context context, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        this.f20958y = AndroidUtilities.dp(80.0f);
    }

    public final boolean a() {
        return this.d.f26547a.f21972q;
    }

    public final void b(int i10, boolean z10, boolean z11) {
        float f7;
        float f10;
        this.d.f26547a.f(i10, z10, z11);
        boolean z12 = false;
        if (this.f20957x) {
    ...
    public final void d(MediaController.PhotoEntry photoEntry, boolean z10, boolean z11, boolean z12, boolean z13) {
        ...
        if (str != null) {
            o5Var.f(str, null, org.telegram.ui.ActionBar.i6.R4);
        } else {
            String str2 = photoEntry2.thumbPath;
            if (str2 != null) {
                o5Var.f(str2, null, org.telegram.ui.ActionBar.i6.R4);
            } else if (photoEntry2.path != null) {
                if (photoEntry2.isVideo && !photoEntry2.isLivePhoto()) {
                    o5Var.f("vthumb://" + this.G.imageId + ":" + this.G.path, null, org.telegram.ui.ActionBar.i6.R4);
                } else {
                    MediaController.PhotoEntry photoEntry3 = this.G;
                    o5Var.p(photoEntry3.orientation, photoEntry3.invert, true);
                    o5Var.f("thumb://" + this.G.imageId + ":" + this.G.path, null, org.telegram.ui.ActionBar.i6.R4);
                }
            } else {
                o5Var.setImageDrawable(org.telegram.ui.ActionBar.i6.R4);
            }
        }
    ...
    public final void g(boolean z10) {
        ...
        if (!z10 || npVar.getAlpha() != 1.0f) {
            ...
            AnimatorSet animatorSet = this.f20953n;
            if (animatorSet != null) {
                animatorSet.cancel();
                this.f20953n = null;
            }
            AnimatorSet animatorSet2 = new AnimatorSet();
            this.f20953n = animatorSet2;
            animatorSet2.setInterpolator(new DecelerateInterpolator());
            this.f20953n.setDuration(180L);
            AnimatorSet animatorSet3 = this.f20953n;
            if (z10) {
                f7 = 1.0f;
            } else {
                f7 = 0.0f;
            ...
            this.f20953n.addListener(new org.telegram.ui.t4(this, 8));
            this.f20953n.start();
        }
    }
    ...
    public final void h(boolean z10) {
        o5 o5Var;
        n5 n5Var = this.f20950b;
        if (n5Var != null && (o5Var = this.f20949a) != null && o5Var.getMeasuredHeight() > 0 && o5Var.getMeasuredWidth() > 0) {
            if (z10) {
                if (this.M == null) {
                    this.M = vh.g.e(n5Var);
                    return;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        boolean z10 = this.d.f26547a.f21972q;
        o5 o5Var = this.f20949a;
        if (!z10 && this.f20950b.getScaleX() == 1.0f && o5Var.getImageReceiver().hasNotThumb() && o5Var.getImageReceiver().getCurrentAlpha() == 1.0f && (((photoEntry = this.G) == null || !PhotoViewer.L1(photoEntry.path)) && ((searchImage = this.H) == null || !PhotoViewer.L1(searchImage.getPathToAttach())))) {
            return;
        }
    ...
    public final void onMeasure(int i10, int i11) {
        if (this.f20957x) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(this.f20958y, 1073741824), wl.C(2.0f, this.f20958y, 1073741824));
            return;
        }
        int i12 = 6;
        if (this.E) {
    ...
    public void setItemSize(int i10) {
        this.f20958y = i10;
        FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) this.f20950b.getLayoutParams();
        int i11 = this.f20958y;
        layoutParams.height = i11;
        layoutParams.width = i11;
        FrameLayout.LayoutParams layoutParams2 = (FrameLayout.LayoutParams) this.f20951c.getLayoutParams();
