...
public final class o8 extends FrameLayout {
    ...
    public final TextView f22441b;
    public final TextView f22442c;
    public final ImageView d;
    public boolean f22443e;
    public CharSequence f22444f;
    public int h;
    public int f22445n;
    public CharSequence f22446r;
    public int f22447s;
    ...
    public o8(Context context, boolean z10, boolean z11, org.telegram.ui.ActionBar.f6 f6Var, boolean z12) {
        ...
        imageView.setBackground(org.telegram.ui.ActionBar.j6.f0(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20754i6, f6Var), 3, -1));
        if (z11) {
            if (z10) {
                f12 = 0.0f;
            } else {
    ...
    public final void d(int i10, CharSequence charSequence) {
        ...
        this.f22441b.setVisibility(i11);
        f();
    }

    public final void e() {
        if (this.f22444f != null && this.f22445n > 0) {
            SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(this.f22444f);
            try {
                ...
                int i10 = this.h;
                spannableStringBuilder.setSpan(foregroundColorSpan, i10, this.f22445n + i10, 33);
    ...
    public final void f() {
        ...
        if (this.f22446r != null) {
            SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(this.f22446r);
            try {
                spannableStringBuilder.setSpan(new ForegroundColorSpan(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Ue, f6Var)), 0, this.f22447s, 33);
                spannableStringBuilder.setSpan(new ForegroundColorSpan(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Te, f6Var)), this.f22447s, this.f22446r.length(), 33);
            } catch (Exception unused) {
            }
            this.f22441b.setText(spannableStringBuilder);
        }
    }
    ...
    public final void invalidate() {
        this.f22440a.invalidate();
        super.invalidate();
    }

    @Override
    public final void measureChildWithMargins(View view, int i10, int i11, int i12, int i13) {
        if (view == this.f22441b) {
            i11 = org.telegram.messenger.w1.C(16.0f, this.f22440a.getMeasuredWidth(), i11);
        }
    ...
    public void setEdit(View.OnClickListener onClickListener) {
        TextView textView = this.f22442c;
    ...
    public void setHeaderOnClick(View.OnClickListener onClickListener) {
        this.f22440a.setOnClickListener(onClickListener);
    }
