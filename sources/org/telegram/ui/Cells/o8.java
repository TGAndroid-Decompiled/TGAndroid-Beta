...
public final class o8 extends FrameLayout {
    ...
    public o8(Context context, boolean z10, boolean z11, org.telegram.ui.ActionBar.d6 d6Var, boolean z12) {
        ...
        imageView.setBackground(org.telegram.ui.ActionBar.h6.f0(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19134i6, d6Var), 3, -1));
        if (z11) {
            if (z10) {
                f12 = 0.0f;
            } else {
    ...
    public final void c(CharSequence charSequence, int i10, CharSequence charSequence2, int i11, int i12) {
        ...
        this.h = i11;
        this.f20760n = i12;
        TextView textView = this.f20756a;
    ...
    public final void d(int i10, CharSequence charSequence) {
        ...
        this.f20757b.setVisibility(i11);
        f();
    }

    public final void e() {
        if (this.f20759f != null && this.f20760n > 0) {
            SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(this.f20759f);
            try {
                ...
                int i10 = this.h;
                spannableStringBuilder.setSpan(foregroundColorSpan, i10, this.f20760n + i10, 33);
    ...
    public final void f() {
        ...
        if (this.f20761r != null) {
            SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(this.f20761r);
            try {
                spannableStringBuilder.setSpan(new ForegroundColorSpan(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.Ue, d6Var)), 0, this.f20762s, 33);
                spannableStringBuilder.setSpan(new ForegroundColorSpan(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.Te, d6Var)), this.f20762s, this.f20761r.length(), 33);
            } catch (Exception unused) {
            }
            this.f20757b.setText(spannableStringBuilder);
        }
    }
    ...
    public final void invalidate() {
        this.f20756a.invalidate();
        super.invalidate();
    }

    @Override
    public final void measureChildWithMargins(View view, int i10, int i11, int i12, int i13) {
        if (view == this.f20757b) {
            i11 = org.telegram.messenger.f0.C(16.0f, this.f20756a.getMeasuredWidth(), i11);
        }
    ...
    public void setEdit(View.OnClickListener onClickListener) {
        TextView textView = this.f20758c;
