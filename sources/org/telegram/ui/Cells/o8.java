...
public class o8 extends FrameLayout {
    ...
    public boolean L;
    public int M;
    public final org.telegram.ui.ActionBar.l5 f23310a;
    public final org.telegram.ui.ActionBar.l5 f23311b;
    public final org.telegram.ui.Components.k6 f23312c;
    public final org.telegram.ui.ActionBar.l5 d;
    public final lj0 f23313e;
    public Switch f23314f;
    ...
    public int v;
    public int f23318w;
    public boolean f23319x;
    public boolean f23320y;
    ...
    public final void d(int i10, int i11, int i12) {
        ...
        lj0Var.setTranslationX(AndroidUtilities.dp(f10));
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        if (j5Var3 != null) {
            j5Var3.setBounds((getWidth() - this.H.f28001s) - AndroidUtilities.dp(18.0f), (getHeight() - this.H.f28001s) / 2, getWidth() - AndroidUtilities.dp(18.0f), (getHeight() + this.H.f28001s) / 2);
            this.H.draw(canvas);
        }
    }
    ...
    public final void e(int i10, int i11) {
        ...
        org.telegram.ui.ActionBar.l5 l5Var = this.f23310a;
    ...
    public final void g(boolean z4) {
        ...
        ViewPropertyAnimator animate = this.f23310a.animate();
        float f13 = 0.5f;
        if (z4) {
            f10 = 1.0f;
        } else {
        ...
        ViewPropertyAnimator animate2 = this.f23311b.animate();
        if (z4) {
            f11 = 1.0f;
        } else {
            f11 = 0.5f;
        ...
        ViewPropertyAnimator animate3 = this.f23312c.animate();
        if (z4) {
            f12 = 1.0f;
        } else {
            f12 = 0.5f;
    ...
    public final void i(CharSequence charSequence, boolean z4) {
        ...
        l5Var.i(null);
        this.J = null;
        org.telegram.ui.Components.k6 k6Var = this.f23312c;
    ...
    public final void j(CharSequence charSequence, boolean z4, boolean z10) {
        ...
        this.h.setVisibility(8);
        this.f23316r = z10;
        Switch r62 = this.f23314f;
        if (r62 != null) {
            r62.setVisibility(0);
            this.f23314f.c(z4, false);
        }
        setWillNotDraw(!this.f23316r);
        org.telegram.ui.Components.j5 j5Var = this.H;
        if (j5Var != null) {
            j5Var.g(null, false);
        }
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (this.f23314f != null) {
            ...
            accessibilityNodeInfo.setChecked(this.f23314f.h);
    ...
    public void onLayout(boolean z4, int i10, int i11, int i12, int i13) {
        ...
        if (LocaleController.isRTL) {
            measuredWidth = AndroidUtilities.dp(this.f23315n - 6);
        } else {
            measuredWidth = (i18 - k6Var.getMeasuredWidth()) - AndroidUtilities.dp(this.f23315n - 6);
        }
        if (this.f23320y && !LocaleController.isRTL) {
            measuredWidth = (i18 - k6Var.getMeasuredWidth()) - AndroidUtilities.dp(this.f23315n);
        }
        k6Var.layout(measuredWidth, max, k6Var.getMeasuredWidth() + measuredWidth, k6Var.getMeasuredHeight() + max);
        if (LocaleController.isRTL) {
            measuredWidth2 = AndroidUtilities.dp(this.f23315n - 6);
        } else {
            measuredWidth2 = (i18 - l5Var.getMeasuredWidth()) - AndroidUtilities.dp(this.f23315n - 6);
        }
        l5Var.layout(measuredWidth2, max, l5Var.getMeasuredWidth() + measuredWidth2, l5Var.getMeasuredHeight() + max);
        boolean z10 = LocaleController.isRTL;
        lj0 lj0Var = this.f23313e;
        org.telegram.ui.ActionBar.l5 l5Var2 = this.f23310a;
        if (z10) {
        ...
        org.telegram.ui.ActionBar.l5 l5Var3 = this.f23311b;
        ...
        if (lj0Var.getVisibility() == 0) {
            ...
            int dp5 = AndroidUtilities.dp(1.0f) + ((((i17 - lj0Var.getMeasuredHeight()) / 2) + AndroidUtilities.dp(f10)) - lj0Var.getPaddingTop());
            if (!LocaleController.isRTL) {
                measuredWidth5 = AndroidUtilities.dp(this.f23318w);
            } else {
                measuredWidth5 = (i18 - lj0Var.getMeasuredWidth()) - AndroidUtilities.dp(this.f23318w);
            }
        ...
        Switch r92 = this.f23314f;
        if (r92 != null && r92.getVisibility() == 0) {
            int measuredHeight = (i17 - this.f23314f.getMeasuredHeight()) / 2;
            if (LocaleController.isRTL) {
                measuredWidth3 = AndroidUtilities.dp(22.0f);
            } else {
                measuredWidth3 = (i18 - this.f23314f.getMeasuredWidth()) - AndroidUtilities.dp(22.0f);
            }
            Switch r10 = this.f23314f;
            r10.layout(measuredWidth3, measuredHeight, r10.getMeasuredWidth() + measuredWidth3, this.f23314f.getMeasuredHeight() + measuredHeight);
        }
    }
    ...
    public void onMeasure(int i10, int i11) {
        ...
        this.I = size;
        boolean z4 = this.f23320y;
        org.telegram.ui.ActionBar.l5 l5Var = this.f23311b;
        org.telegram.ui.ActionBar.l5 l5Var2 = this.d;
        org.telegram.ui.ActionBar.l5 l5Var3 = this.f23310a;
        if (z4) {
            l5Var3.measure(org.telegram.ui.b.d(this.f23315n + 71, size, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), 1073741824));
            l5Var.measure(org.telegram.ui.b.d(this.f23315n + 71, size, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), 1073741824));
            int dp2 = (size - AndroidUtilities.dp(this.f23315n + 103)) - l5Var3.getTextWidth();
            if (LocaleController.isRTL) {
            ...
            int dp3 = (size - AndroidUtilities.dp(this.f23315n + 103)) - l5Var3.getTextWidth();
            if (LocaleController.isRTL) {
            ...
            int dp4 = size - AndroidUtilities.dp(this.f23315n);
            if (LocaleController.isRTL) {
            ...
            int dp5 = size - AndroidUtilities.dp(this.f23315n);
            if (LocaleController.isRTL) {
            ...
            l5Var3.measure(View.MeasureSpec.makeMeasureSpec(Math.max(0, (size - AndroidUtilities.dp(this.f23315n + 71)) - max), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), 1073741824));
            l5Var.measure(View.MeasureSpec.makeMeasureSpec((size - AndroidUtilities.dp(this.f23315n + 71)) - max, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), 1073741824));
        }
        lj0 lj0Var = this.f23313e;
        if (lj0Var.getVisibility() == 0) {
        ...
        setMeasuredDimension(size, dp + (this.f23316r ? 1 : 0));
    }
    ...
    public final void s(CharSequence charSequence, CharSequence charSequence2, boolean z4, int i10, boolean z10) {
        ...
        org.telegram.ui.Components.k6 k6Var = this.f23312c;
        if (charSequence2 != null) {
            float g10 = qh.f3.g(charSequence, l5Var.getTextPaint());
            this.J = charSequence2;
            k6Var.c(TextUtils.ellipsize(charSequence2, k6Var.getPaint(), (int) Math.max(1.0f, AndroidUtilities.displaySize.x - ((g10 + AndroidUtilities.dp(this.f23317s)) + AndroidUtilities.dp(16.0f))), TextUtils.TruncateAt.END), z4, true);
        } else {
            k6Var.c("", z4, true);
        }
        k6Var.setVisibility(0);
    ...
    public final void v() {
        ...
        if (i10 != org.telegram.ui.ActionBar.k6.f21766j5 && i10 != org.telegram.ui.ActionBar.k6.G6) {
            v02 = c(v02);
        }
        l5Var.setTextColor(v02);
        lj0 lj0Var = this.f23313e;
        if (lj0Var.getTag() instanceof Integer) {
            ...
            if (intValue != org.telegram.ui.ActionBar.k6.J5 && intValue != org.telegram.ui.ActionBar.k6.f21821m6) {
                v03 = c(v03);
            }
            lj0Var.setColorFilter(new PorterDuffColorFilter(v03, PorterDuff.Mode.SRC_IN));
        }
        this.f23311b.setTextColor(c(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.f22036y6, g6Var)));
        int i11 = org.telegram.ui.ActionBar.k6.I6;
        this.f23312c.setTextColor(c(org.telegram.ui.ActionBar.k6.v0(i11, g6Var)));
    ...
    public o8(int i10, Context context, org.telegram.ui.ActionBar.g6 g6Var, boolean z4, boolean z10) {
        ...
        this.f23310a = l5Var;
        l5Var.setTextColor(org.telegram.ui.ActionBar.k6.v0(z4 ? org.telegram.ui.ActionBar.k6.f21766j5 : org.telegram.ui.ActionBar.k6.G6, g6Var));
        ...
        this.f23311b = l5Var2;
        l5Var2.setTextColor(org.telegram.ui.ActionBar.k6.v0(z4 ? org.telegram.ui.ActionBar.k6.f21874p5 : org.telegram.ui.ActionBar.k6.f22036y6, g6Var));
        ...
        this.f23312c = k6Var;
        k6Var.setTextColor(org.telegram.ui.ActionBar.k6.v0(z4 ? org.telegram.ui.ActionBar.k6.f21838n5 : org.telegram.ui.ActionBar.k6.I6, g6Var));
        ...
        l5Var3.f22106n0 = 18;
        l5Var3.m();
        l5Var3.setTextColor(org.telegram.ui.ActionBar.k6.v0(z4 ? org.telegram.ui.ActionBar.k6.f21838n5 : org.telegram.ui.ActionBar.k6.I6, g6Var));
        ...
        this.f23313e = imageView;
        ImageView.ScaleType scaleType = ImageView.ScaleType.CENTER;
        imageView.setScaleType(scaleType);
        imageView.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.k6.v0(z4 ? org.telegram.ui.ActionBar.k6.J5 : org.telegram.ui.ActionBar.k6.f21821m6, g6Var), PorterDuff.Mode.SRC_IN));
        addView(imageView);
        ...
        if (z10) {
            ...
            addView(this.f23314f, k7.c6.d(37, 20.0f, (LocaleController.isRTL ? 3 : 5) | 16, 22.0f, 0.0f, 22.0f, 0.0f));
        }
        setFocusable(true);
    }
