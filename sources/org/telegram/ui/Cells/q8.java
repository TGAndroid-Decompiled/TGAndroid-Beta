...
public final class q8 extends FrameLayout {
    public int f21733a;
    public final TextView f21734b;
    public final TextView f21735c;
    public final Switch d;
    public boolean e;
    public LinearLayout f21736f;
    ...
    public q8(Context context) {
        ...
        org.telegram.ui.b.l(org.telegram.ui.ActionBar.j6.f20273z6, null, textView2, 1, 13.0f);
        if (LocaleController.isRTL) {
            i12 = 5;
        } else {
            i12 = 3;
    ...
    public final void a(Runnable runnable, String str, boolean z4) {
        ...
        if (this.f21736f == null) {
            ...
            this.f21736f.addView(this.h, k7.b6.c(20.0f, -2));
            this.f21737n = new View(getContext());
            ...
            this.f21737n.setBackground(mutate);
            this.f21736f.addView(this.f21737n, k7.b6.q(16, 16, 16));
            this.f21736f.setClipChildren(false);
            setClipChildren(false);
            addView(this.f21736f, k7.b6.e(-2, -2, 16));
            gn gnVar = new gn(getContext(), 6);
            this.f21738r = gnVar;
            gnVar.setBackground(org.telegram.ui.ActionBar.j6.f0(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19971i6, false), 2, -1));
            gn gnVar2 = this.f21738r;
            if (LocaleController.isRTL) {
                i10 = 3;
            } else {
                i10 = 5;
            }
            addView(gnVar2, k7.b6.e(76, -1, i10));
        }
        this.h.setText(str);
        this.f21737n.animate().cancel();
        ViewPropertyAnimator animate = this.f21737n.animate();
        if (z4) {
            f10 = 0.0f;
        } else {
            f10 = 180.0f;
        ...
        this.f21738r.setOnClickListener(new a(runnable, 11));
    }
    ...
    public final void b(boolean z4, boolean z10) {
        ...
        super.setEnabled(z4);
        Switch r02 = this.d;
        TextView textView = this.f21735c;
        TextView textView2 = this.f21734b;
        float f12 = 0.5f;
        if (z10) {
    ...
    public final void onLayout(boolean z4, int i10, int i11, int i12, int i13) {
        ...
        LinearLayout linearLayout = this.f21736f;
        if (linearLayout != null) {
            boolean z10 = LocaleController.isRTL;
            TextView textView = this.f21734b;
            if (z10) {
                linearLayout.setTranslationX((textView.getLeft() - this.f21736f.getMeasuredWidth()) - AndroidUtilities.dp(8.0f));
                return;
            }
    ...
    public void setEnabled(boolean z4) {
        ...
        TextView textView = this.f21734b;
        textView.clearAnimation();
        TextView textView2 = this.f21735c;
        textView2.clearAnimation();
        Switch r22 = this.d;
        r22.clearAnimation();
        if (z4) {
