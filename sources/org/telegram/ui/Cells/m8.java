...
public final class m8 extends FrameLayout {
    ...
    public final bi.c4 f22295b;
    public final TextView f22296c;
    public final org.telegram.ui.Components.x9 d;
    public final mp f22297e;
    public boolean f22298f;
    public final ImageView h;
    public final ImageView f22299n;
    public TLRPC.TL_messages_stickerSet f22300r;
    public boolean f22301s;
    public final Rect v;
    public boolean f22302w;
    public final FrameLayout f22303x;
    public final TextView f22304y;
    ...
    public m8(Context context, int i10) {
        ...
        this.f22303x = frameLayout;
        TextView textView = new TextView(context);
        this.f22304y = textView;
        ...
        FrameLayout frameLayout2 = this.f22303x;
        sg.r0 r0Var2 = this.F;
        if (LocaleController.isRTL) {
            i14 = 3;
        } else {
        ...
        w7.z5.a(this.F);
        this.f22303x.setPadding(AndroidUtilities.dp(10.0f), 0, AndroidUtilities.dp(10.0f), 0);
        View view = this.f22303x;
        if (LocaleController.isRTL) {
            i15 = 3;
        } else {
            i15 = 5;
        ...
        this.f22303x.setOnClickListener(new g8(this, 1));
        ...
        this.f22296c = textView3;
        wl.r(textView3, org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f21061z6, false), 1, 13.0f, 1);
        ...
        if (i10 == 3) {
            ...
            imageView3.setColorFilter(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f21042y6, false), PorterDuff.Mode.SRC_IN);
            imageView3.setBackground(org.telegram.ui.ActionBar.j6.f0(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20753i6, false), 1, -1));
    ...
    public final boolean a() {
        ...
        if (i10 == 1) {
            return this.f22297e.f28477a.f23907q;
        }
        if (i10 == 3) {
            if (this.h.getVisibility() != 0) {
                return false;
            }
        } else if (!this.f22302w || this.f22303x.getVisibility() != 0) {
            return false;
        }
        return true;
    }
    ...
    public final void b(boolean z10, boolean z11) {
        ...
        } else if (this.f22302w) {
            FrameLayout frameLayout = this.f22303x;
            if (z11) {
    ...
    public final void c(final boolean z10) {
        ...
        if (this.f22294a == 1) {
            ...
            float[] fArr2 = {f10, f12};
            ImageView imageView = this.f22299n;
            ...
            duration.setInterpolator(prVar).withEndAction(new Runnable(this) {
                ...
                public final void run() {
                    switch (r3) {
                        case 0:
                            boolean z11 = z10;
                            m8 m8Var = this.f22062b;
                            if (!z11) {
                                m8Var.f22299n.setVisibility(8);
                                return;
                            } else {
                                m8Var.getClass();
                                return;
                        ...
                        case 1:
                            boolean z12 = z10;
                            m8 m8Var2 = this.f22062b;
                            if (z12) {
                                m8Var2.f22303x.setVisibility(8);
                                return;
                            } else {
                                m8Var2.getClass();
                                return;
    ...
    public final void d(TLRPC.TL_messages_stickerSet tL_messages_stickerSet, boolean z10, boolean z11) {
        ...
        String str2;
        this.f22298f = z10;
        this.f22300r = tL_messages_stickerSet;
        this.f22301s = z11;
        org.telegram.ui.Components.x9 x9Var = this.d;
        x9Var.setVisibility(0);
        bi.c4 c4Var = this.f22295b;
        c4Var.setTranslationY(0.0f);
        c4Var.setText(this.f22300r.set.title);
        boolean z12 = this.f22300r.set.archived;
        ...
        this.f22303x.setVisibility(i10);
        if (!this.f22302w) {
            i12 = 0;
        }
        ...
        if (arrayList != null && !arrayList.isEmpty()) {
            ...
            SvgHelper.SvgDrawable svgThumb = DocumentObject.getSvgThumb(tL_messages_stickerSet.set.thumbs, org.telegram.ui.ActionBar.j6.f20607a7, 1.0f);
            ...
            if (!z14 || (!MessageObject.isAnimatedStickerDocument(document, true) && !MessageObject.isVideoSticker(document))) {
                ...
                if (MessageObject.isTextColorEmoji(document)) {
                    x9Var.setColorFilter(org.telegram.ui.ActionBar.j6.f20987v3);
                }
            }
        } else {
            tL_messages_stickerSet2 = tL_messages_stickerSet;
    ...
    public final void e(int i10) {
        ...
        TextView textView3 = this.f22296c;
        bi.c4 c4Var = this.f22295b;
        if (z13) {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.f22298f) {
            ...
            canvas.drawLine(dp, height, width - i10, getHeight() - 1, org.telegram.ui.ActionBar.j6.f20785k0);
        }
    }
    ...
    public final void onMeasure(int i10, int i11) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i10), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(58.0f) + (this.f22298f ? 1 : 0), 1073741824));
    }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (getBackground() != null && this.f22302w && (frameLayout = this.f22303x) != null) {
    ...
    public void setOnReorderButtonTouchListener(View.OnTouchListener onTouchListener) {
        this.f22299n.setOnTouchListener(onTouchListener);
    }
