...
public final class m8 extends FrameLayout {
    ...
    public final TextView f23170b;
    public final TextView f23171c;
    public final ImageView d;
    public boolean f23172e;
    public CharSequence f23173f;
    public int h;
    public int f23174n;
    public CharSequence f23175r;
    public int f23176s;
    ...
    public m8(Context context, boolean z4, boolean z10, org.telegram.ui.ActionBar.g6 g6Var, boolean z11) {
        ...
        imageView.setBackground(org.telegram.ui.ActionBar.k6.f0(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.f21752i6, g6Var), 3, -1));
        if (z10) {
            if (z4) {
                f13 = 0.0f;
            } else {
    ...
    public final void c(CharSequence charSequence, int i10, CharSequence charSequence2, int i11, int i12) {
        ...
        this.h = i11;
        this.f23174n = i12;
        TextView textView = this.f23169a;
    ...
    public final void d(int i10, CharSequence charSequence) {
        ...
        this.f23170b.setVisibility(i11);
        f();
    }

    public final void e() {
        if (this.f23173f != null && this.f23174n > 0) {
            SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(this.f23173f);
            try {
                ...
                int i10 = this.h;
                spannableStringBuilder.setSpan(foregroundColorSpan, i10, this.f23174n + i10, 33);
    ...
    public final void f() {
        ...
        if (this.f23175r != null) {
            SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(this.f23175r);
            try {
                spannableStringBuilder.setSpan(new ForegroundColorSpan(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.Ue, g6Var)), 0, this.f23176s, 33);
                spannableStringBuilder.setSpan(new ForegroundColorSpan(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.Te, g6Var)), this.f23176s, this.f23175r.length(), 33);
            } catch (Exception unused) {
            }
            this.f23170b.setText(spannableStringBuilder);
        }
    }
    ...
    public final void invalidate() {
        this.f23169a.invalidate();
        super.invalidate();
    }

    @Override
    public final void measureChildWithMargins(View view, int i10, int i11, int i12, int i13) {
        if (view == this.f23170b) {
            i11 = org.telegram.messenger.y3.C(16.0f, this.f23169a.getMeasuredWidth(), i11);
        }
