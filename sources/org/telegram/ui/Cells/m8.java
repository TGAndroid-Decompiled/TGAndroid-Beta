...
public final class m8 extends FrameLayout {
    ...
    public TLRPC.TL_messages_stickerSet f20649r;
    public boolean f20650s;
    public final Rect v;
    public boolean f20651w;
    public final FrameLayout f20652x;
    ...
    public m8(Context context, int i10) {
        ...
        this.f20652x = frameLayout;
        TextView textView = new TextView(context);
        this.f20653y = textView;
        ...
        FrameLayout frameLayout2 = this.f20652x;
        rg.p0 p0Var2 = this.F;
        if (LocaleController.isRTL) {
            i14 = 3;
        } else {
        ...
        w7.a6.a(this.F);
        this.f20652x.setPadding(AndroidUtilities.dp(10.0f), 0, AndroidUtilities.dp(10.0f), 0);
        View view = this.f20652x;
        if (LocaleController.isRTL) {
            i15 = 3;
        } else {
            i15 = 5;
        ...
        this.f20652x.setOnClickListener(new g8(this, 1));
        ...
        this.f20646c = textView3;
        ok.t(textView3, org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19461z6, false), 1, 13.0f, 1);
        ...
        if (i10 == 3) {
            ...
            imageView3.setColorFilter(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19442y6, false), PorterDuff.Mode.SRC_IN);
            imageView3.setBackground(org.telegram.ui.ActionBar.h6.f0(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19148i6, false), 1, -1));
    ...
    public final boolean a() {
        ...
        } else if (!this.f20651w || this.f20652x.getVisibility() != 0) {
            return false;
        }
        return true;
    }
            ...
            duration.setInterpolator(rrVar).withEndAction(new Runnable(this) {
                ...
                public final void run() {
                    switch (r3) {
                        case 0:
                            boolean z11 = z10;
                            m8 m8Var = this.f20408b;
                            if (!z11) {
                                m8Var.f20648n.setVisibility(8);
                                return;
                            } else {
                                m8Var.getClass();
                                return;
                        ...
                        case 1:
                            boolean z12 = z10;
                            m8 m8Var2 = this.f20408b;
                            if (z12) {
                                m8Var2.f20652x.setVisibility(8);
                                return;
                            } else {
                                m8Var2.getClass();
                                return;
    ...
    public final void d(TLRPC.TL_messages_stickerSet tL_messages_stickerSet, boolean z10, boolean z11) {
        ...
        String str2;
        this.f20647f = z10;
        this.f20649r = tL_messages_stickerSet;
        this.f20650s = z11;
        org.telegram.ui.Components.w9 w9Var = this.d;
        w9Var.setVisibility(0);
        ai.p4 p4Var = this.f20645b;
        p4Var.setTranslationY(0.0f);
        p4Var.setText(this.f20649r.set.title);
        boolean z12 = this.f20649r.set.archived;
        ...
        this.f20652x.setVisibility(i10);
        if (!this.f20651w) {
            i12 = 0;
        }
        ...
        if (arrayList != null && !arrayList.isEmpty()) {
            ...
            while (true) {
                if (i13 < arrayList.size()) {
                    ...
                    if (document2 != null && document2.f18341id == tL_messages_stickerSet.set.thumb_document_id) {
                        document = document2;
                        break;
                    }
                    i13++;
            ...
            SvgHelper.SvgDrawable svgThumb = DocumentObject.getSvgThumb(tL_messages_stickerSet.set.thumbs, org.telegram.ui.ActionBar.h6.f19003a7, 1.0f);
            ...
            if (!z14 || (!MessageObject.isAnimatedStickerDocument(document, true) && !MessageObject.isVideoSticker(document))) {
                ...
                if (MessageObject.isTextColorEmoji(document)) {
                    w9Var.setColorFilter(org.telegram.ui.ActionBar.h6.f19387v3);
                }
            }
        } else {
            tL_messages_stickerSet2 = tL_messages_stickerSet;
    ...
    public final void e(int i10) {
        ...
        TextView textView = this.f20653y;
        ...
        TextView textView3 = this.f20646c;
        ai.p4 p4Var = this.f20645b;
        if (z13) {
    ...
    public final void onMeasure(int i10, int i11) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i10), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(58.0f) + (this.f20647f ? 1 : 0), 1073741824));
    }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (getBackground() != null && this.f20651w && (frameLayout = this.f20652x) != null) {
    ...
    public void setOnReorderButtonTouchListener(View.OnTouchListener onTouchListener) {
        this.f20648n.setOnTouchListener(onTouchListener);
    }
