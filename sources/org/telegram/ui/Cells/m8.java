...
public final class m8 extends FrameLayout {
    ...
    public final ImageView f20424n;
    public TLRPC.TL_messages_stickerSet f20425r;
    public boolean f20426s;
    public final Rect v;
    public boolean f20427w;
    public final FrameLayout f20428x;
    public final TextView f20429y;
    ...
    public m8(Context context, int i10) {
        ...
        FrameLayout frameLayout2 = this.f20428x;
        rg.p0 p0Var2 = this.F;
        if (LocaleController.isRTL) {
            i14 = 3;
        } else {
        ...
        w7.z5.a(this.F);
        this.f20428x.setPadding(AndroidUtilities.dp(10.0f), 0, AndroidUtilities.dp(10.0f), 0);
        View view = this.f20428x;
        if (LocaleController.isRTL) {
            i15 = 3;
        } else {
            i15 = 5;
        ...
        this.f20428x.setOnClickListener(new g8(this, 1));
        ...
        this.f20422c = textView3;
        vl.s(textView3, org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f19234z6, false), 1, 13.0f, 1);
        ...
        if (i10 == 3) {
            ...
            imageView3.setColorFilter(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f19215y6, false), PorterDuff.Mode.SRC_IN);
            imageView3.setBackground(org.telegram.ui.ActionBar.i6.f0(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18923i6, false), 1, -1));
    ...
    public final boolean a() {
        ...
        if (i10 == 1) {
            return this.e.f26546a.f21969q;
        }
        if (i10 == 3) {
            if (this.h.getVisibility() != 0) {
                return false;
            }
        } else if (!this.f20427w || this.f20428x.getVisibility() != 0) {
            return false;
        }
        return true;
    }
    ...
    public final void b(boolean z10, boolean z11) {
        ...
        } else if (this.f20427w) {
            FrameLayout frameLayout = this.f20428x;
            if (z11) {
    ...
    public final void c(final boolean z10) {
        ...
        if (this.f20420a == 1) {
            ...
            float[] fArr2 = {f10, f12};
            ImageView imageView = this.f20424n;
            ...
            duration.setInterpolator(qrVar).withEndAction(new Runnable(this) {
                ...
                public final void run() {
                    switch (r3) {
                        case 0:
                            boolean z11 = z10;
                            m8 m8Var = this.f20178b;
                            if (!z11) {
                                m8Var.f20424n.setVisibility(8);
                                return;
                            } else {
                                m8Var.getClass();
                                return;
                        ...
                        case 1:
                            boolean z12 = z10;
                            m8 m8Var2 = this.f20178b;
                            if (z12) {
                                m8Var2.f20428x.setVisibility(8);
                                return;
                            } else {
                                m8Var2.getClass();
                                return;
    ...
    public final void d(TLRPC.TL_messages_stickerSet tL_messages_stickerSet, boolean z10, boolean z11) {
        ...
        this.f20428x.setVisibility(i10);
        if (!this.f20427w) {
            i12 = 0;
        }
        ...
        if (arrayList != null && !arrayList.isEmpty()) {
            ...
            while (true) {
                if (i13 < arrayList.size()) {
                    ...
                    if (document2 != null && document2.f18115id == tL_messages_stickerSet.set.thumb_document_id) {
                        document = document2;
                        break;
                    }
                    i13++;
            ...
            SvgHelper.SvgDrawable svgThumb = DocumentObject.getSvgThumb(tL_messages_stickerSet.set.thumbs, org.telegram.ui.ActionBar.i6.f18778a7, 1.0f);
            ...
            if (!z14 || (!MessageObject.isAnimatedStickerDocument(document, true) && !MessageObject.isVideoSticker(document))) {
                ...
                if (MessageObject.isTextColorEmoji(document)) {
                    u9Var.setColorFilter(org.telegram.ui.ActionBar.i6.f19160v3);
                }
            }
        } else {
            tL_messages_stickerSet2 = tL_messages_stickerSet;
    ...
    public final void e(int i10) {
        ...
        TextView textView = this.f20429y;
        ...
        TextView textView3 = this.f20422c;
        ai.p4 p4Var = this.f20421b;
        if (z13) {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.f20423f) {
            ...
            canvas.drawLine(dp, height, width - i10, getHeight() - 1, org.telegram.ui.ActionBar.i6.f18955k0);
        }
    }
    ...
    public final void onMeasure(int i10, int i11) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i10), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(58.0f) + (this.f20423f ? 1 : 0), 1073741824));
    }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (getBackground() != null && this.f20427w && (frameLayout = this.f20428x) != null) {
    ...
    public void setOnReorderButtonTouchListener(View.OnTouchListener onTouchListener) {
        this.f20424n.setOnTouchListener(onTouchListener);
    }
