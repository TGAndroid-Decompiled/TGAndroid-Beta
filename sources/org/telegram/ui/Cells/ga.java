...
public final class ga extends GestureDetector.SimpleOnGestureListener {
    ...
    public final boolean onDoubleTap(MotionEvent motionEvent) {
        ...
        if (selectReaction) {
            ja jaVar = haVar.Ke;
            zg.l0.d(jaVar.f20318r, null, jaVar.e[1], null, motionEvent.getX(), motionEvent.getY(), zg.p0.b(MediaDataController.getInstance(i10).getDoubleTapReaction()), haVar.I7, 0);
            zg.l0.f();
        }
