...
public final class m9 implements LanguageDetector.StringCallback, LanguageDetector.ExceptionCallback, ff0 {
    ...
    public void l(int i10, int i11) {
        v5 v5Var = (v5) this.f20640a;
        ai.q4 q4Var = v5Var.e;
        TextView textView = v5Var.f21670b;
        ((ff0) this.f20641b).l(i10, i11);
        if (i11 > 0) {
        ...
        if (textView.getTag() == null) {
            ...
            animatorSet2.playTogether(ObjectAnimator.ofFloat(textView, property, 1.0f), ObjectAnimator.ofFloat(v5Var.f21669a, property, 0.0f));
    ...
    public void run(String str) {
        n9 n9Var = (n9) this.f20640a;
        n9Var.f20709a = str;
        n9Var.a((Menu) this.f20641b);
    }
