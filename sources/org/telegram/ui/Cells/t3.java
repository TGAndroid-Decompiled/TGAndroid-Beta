...
public final class t3 extends FrameLayout {
    ...
    public TLRPC.StickerSetCovered f21198f;
    ...
    public t3(int i10, Context context, org.telegram.ui.ActionBar.f6 f6Var, boolean z10, boolean z11) {
        ...
        this.f21202w = UserConfig.selectedAccount;
        this.f21203x = new Paint(1);
        this.f21195a = z11;
        this.I = f6Var;
    ...
    public static void a(ArrayList arrayList, vl0 vl0Var, org.telegram.ui.ActionBar.k6 k6Var) {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(vl0Var, 0, new Class[]{t3.class}, org.telegram.ui.ActionBar.j6.f19216k0, null, null, org.telegram.ui.ActionBar.j6.f19095d7));
    ...
    public final void c(TLRPC.StickerSetCovered stickerSetCovered, boolean z10, boolean z11, int i10, int i11, boolean z12) {
        ...
        float f15 = 0.0f;
        if (this.f21198f != stickerSetCovered) {
            if (z10) {
                f14 = 1.0f;
            } else {
                f14 = 0.0f;
        ...
        this.f21198f = stickerSetCovered;
        this.f21204y = i10;
        this.E = i11;
        if (i11 != 0) {
            e();
        } else {
            this.f21196b.setText(stickerSetCovered.set.title);
        }
        TLRPC.StickerSet stickerSet = stickerSetCovered.set;
        boolean z14 = stickerSet.emojis;
        TextView textView = this.f21197c;
        if (z14) {
        ...
        this.v = z10;
        if (this.f21195a) {
            boolean z15 = this.f21201s;
            hi0 hi0Var = this.d;
            if (z15) {
                hi0Var.setVisibility(0);
                if (!z12 && !MediaDataController.getInstance(this.f21202w).isStickerPackInstalled(stickerSetCovered.set.f18355id)) {
                    z13 = false;
                } else {
                    z13 = true;
                }
    ...
    public final void e() {
        if (this.E != 0) {
            SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(this.f21198f.set.title);
            try {
    ...
    public final void f() {
        ...
        if (this.F != null) {
            ...
            this.f21197c.setText(spannableStringBuilder);
        }
    }
        ...
        if (z10 || this.H != 0.0f) {
            if (z10) {
                ...
                if (f7 != 1.0f) {
                    ...
                    Paint paint = this.f21203x;
                    paint.setColor(v02);
                    canvas.drawCircle(AndroidUtilities.dp(12.0f) + this.f21196b.getRight(), AndroidUtilities.dp(20.0f), AndroidUtilities.dp(4.0f) * this.H, paint);
                }
            }
            if (!z10) {
                float f11 = this.H;
            ...
            Paint paint2 = this.f21203x;
            paint2.setColor(v022);
            canvas.drawCircle(AndroidUtilities.dp(12.0f) + this.f21196b.getRight(), AndroidUtilities.dp(20.0f), AndroidUtilities.dp(4.0f) * this.H, paint2);
        }
        if (this.f21199n) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.f21195a) {
            ...
            measureChildWithMargins(this.f21196b, i10, measuredWidth, i11, 0);
        }
    }
