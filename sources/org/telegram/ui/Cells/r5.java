...
public final class r5 extends FrameLayout {
    ...
    public final void onDraw(Canvas canvas) {
        switch (this.f20894a) {
            case 0:
                RectF rectF = this.f20895b;
                rectF.set(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight());
                canvas.drawRoundRect(rectF, AndroidUtilities.dp(4.0f), AndroidUtilities.dp(4.0f), org.telegram.ui.ActionBar.j6.f19195i2);
                return;
            default:
                RectF rectF2 = this.f20895b;
