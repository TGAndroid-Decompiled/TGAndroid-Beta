...
public final class z1 extends LinearLayout {
    public final ImageView f21919a;
    public final org.telegram.ui.Components.o6 f21920b;
    public final View f21921c;
    ...
    public z1(a2 a2Var, Context context, int i10) {
        ...
        org.telegram.ui.ActionBar.f6 f6Var = a2Var.f20017b;
        ...
        if (LocaleController.isRTL) {
            ...
            addView(o6Var, w7.y5.t(-2, 16, 16, 0, 0, i12, 0));
            View view2 = this.f21919a;
            if (view2 != null) {
                addView(view2, w7.y5.t(16, 16, 16, 0, 0, 11, 0));
            }
        } else {
            View view3 = this.f21919a;
            if (view3 != null) {
            ...
            addView(o6Var, w7.y5.t(-2, 16, 16, i11, 0, 3, 0));
            addView(view, w7.y5.t(16, 16, 16, 0, 0, 11, 0));
        }
        setBackground(org.telegram.ui.ActionBar.j6.Y(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19199i6, f6Var), 16, 16));
        setClickable(true);
    }
