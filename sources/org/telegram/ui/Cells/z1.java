...
public final class z1 extends FrameLayout {
    ...
    public View J;
    public int f21683a;
    public final org.telegram.ui.ActionBar.f6 f21684b;
    public final x1 f21685c;
    public final w1 d;
    public final View e;
    public final TextView f21686f;
    public final View h;
    public final CheckBoxSquare f21687n;
    public final np f21688r;
    public View f21689s;
    public final y1 v;
    public final org.telegram.ui.Components.u9 f21690w;
    public final org.telegram.ui.Components.f9 f21691x;
    ...
    public final boolean b() {
        np npVar = this.f21688r;
        if (npVar != null) {
            return npVar.f26511a.f21985q;
        }
        return this.f21687n.h;
    }
    ...
    public final void d(org.telegram.ui.a aVar, ai.f2 f2Var) {
        ...
        if (aVar == null) {
            ...
            if (this.I == null) {
                ...
                this.I = view2;
                view2.setBackground(org.telegram.ui.ActionBar.j6.f0(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f18953i6, this.f21684b), 2, -1));
    ...
    public final void e(CharSequence charSequence, String str, boolean z10, boolean z11, boolean z12) {
        if (this.H) {
            ...
            this.f21685c.setText(charSequence);
        }
        np npVar = this.f21688r;
        if (npVar != null) {
            npVar.a(z10, z12);
        } else {
            this.f21687n.a(z10, z12);
        }
        this.f21686f.setText(str);
        this.F = z11;
        setWillNotDraw(!z11);
    }
    ...
    public final void f() {
        ...
        this.f21689s.setTranslationX(left);
    }
    ...
    public final void g() {
        ...
        int i13;
        boolean z10 = this.H;
        org.telegram.ui.ActionBar.f6 f6Var = this.f21684b;
        int i14 = this.f21692y;
        if (z10) {
            if (i14 != 1 && i14 != 5) {
                i13 = org.telegram.ui.ActionBar.j6.G6;
            } else {
                i13 = org.telegram.ui.ActionBar.j6.f18970j5;
            }
            ...
            x1 x1Var = this.f21685c;
            x1Var.setTextColor(v02);
            if (i14 != 1 && i14 != 5) {
                i11 = org.telegram.ui.ActionBar.j6.J6;
            } else {
                i11 = org.telegram.ui.ActionBar.j6.f18990k5;
            }
        ...
        if (i14 != 1 && i14 != 5) {
            ...
            i12 = org.telegram.ui.ActionBar.j6.f19027m5;
        }
        this.f21686f.setTextColor(org.telegram.ui.ActionBar.j6.v0(i12, f6Var));
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        int i12 = this.E;
        View view2 = this.e;
        TextView textView = this.f21686f;
        int i13 = this.f21692y;
        if (i13 == 3) {
            ...
            org.telegram.ui.Components.u9 u9Var = this.f21690w;
            if (u9Var != null) {
    ...
    public void setCollapsed(Boolean bool) {
        ...
        if (this.f21689s == null) {
            this.f21689s = new View(getContext());
            Drawable mutate = getContext().getResources().getDrawable(R.drawable.arrow_more).mutate();
            mutate.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.G6, this.f21684b), PorterDuff.Mode.MULTIPLY));
            this.f21689s.setBackground(mutate);
            addView(this.f21689s, w7.x5.e(16, 16, 16));
        }
        f();
        this.f21689s.animate().cancel();
        ViewPropertyAnimator animate = this.f21689s.animate();
    ...
    public void setTextColor(int i10) {
        if (this.H) {
            ...
            this.f21685c.setTextColor(i10);
        }
    }

    public void setUserOrChat(TLObject tLObject) {
        String formatName;
        org.telegram.ui.Components.f9 f9Var = this.f21691x;
        f9Var.p(tLObject);
        this.f21690w.e(tLObject, f9Var);
        ...
        if (z10 && ((TLRPC.User) tLObject).f18268id == MessagesController.getInstance(UserConfig.selectedAccount).telegramAntispamUserId) {
        ...
        this.f21685c.setText(formatName);
    }
    ...
    public z1(int i10, int i11, Context context, org.telegram.ui.ActionBar.f6 f6Var, boolean z10) {
        ...
        if (z10) {
            ...
            w1Var.setTag(Integer.valueOf(org.telegram.ui.ActionBar.j6.v0((i10 == 1 || i10 == 5) ? org.telegram.ui.ActionBar.j6.f18970j5 : org.telegram.ui.ActionBar.j6.G6, f6Var)));
            ...
            x1Var.setTag(Integer.valueOf(org.telegram.ui.ActionBar.j6.v0((i10 == 1 || i10 == 5) ? org.telegram.ui.ActionBar.j6.f18970j5 : org.telegram.ui.ActionBar.j6.G6, f6Var)));
        ...
        this.f21686f = textView;
        textView.setTag(Integer.valueOf((i10 == 1 || i10 == 5) ? org.telegram.ui.ActionBar.j6.f19027m5 : org.telegram.ui.ActionBar.j6.I6));
        ...
        if (i10 == 6) {
            ...
            this.f21691x = new org.telegram.ui.Components.f9((org.telegram.ui.ActionBar.f6) null);
