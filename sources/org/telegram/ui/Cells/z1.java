...
public final class z1 extends FrameLayout {
    ...
    public View J;
    public int f20768a;
    public final org.telegram.ui.ActionBar.f6 f20769b;
    public final x1 f20770c;
    public final w1 d;
    public final View e;
    public final TextView f20771f;
    public final View h;
    public final CheckBoxSquare f20772n;
    public final tp f20773r;
    public View f20774s;
    public final y1 v;
    public final org.telegram.ui.Components.w9 f20775w;
    public final org.telegram.ui.Components.g9 f20776x;
    ...
    public final boolean b() {
        tp tpVar = this.f20773r;
        if (tpVar != null) {
            return tpVar.f27462a.f21057q;
        }
    ...
    public final void d(org.telegram.ui.a aVar, bi.n3 n3Var) {
        ...
        if (aVar == null) {
            ...
            if (this.I == null) {
                ...
                this.I = view2;
                view2.setBackground(org.telegram.ui.ActionBar.j6.f0(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f18017i6, this.f20769b), 2, -1));
        ...
        if (this.J == null) {
            ...
            addView(view4, w7.a6.e(56, -1, i10));
        }
    ...
    public final void e(CharSequence charSequence, String str, boolean z10, boolean z11, boolean z12) {
        if (this.H) {
            ...
            this.f20770c.setText(charSequence);
        }
        tp tpVar = this.f20773r;
        if (tpVar != null) {
            tpVar.a(z10, z12);
        } else {
            this.f20772n.a(z10, z12);
        }
        this.f20771f.setText(str);
        this.F = z11;
        setWillNotDraw(!z11);
    }
    ...
    public final void f() {
        ...
        this.f20774s.setTranslationX(left);
    }
    ...
    public final void g() {
        ...
        int i13;
        boolean z10 = this.H;
        org.telegram.ui.ActionBar.f6 f6Var = this.f20769b;
        int i14 = this.f20777y;
        if (z10) {
            if (i14 != 1 && i14 != 5) {
                i13 = org.telegram.ui.ActionBar.j6.G6;
            } else {
                i13 = org.telegram.ui.ActionBar.j6.f18034j5;
            }
            ...
            x1 x1Var = this.f20770c;
            x1Var.setTextColor(v02);
            if (i14 != 1 && i14 != 5) {
                i11 = org.telegram.ui.ActionBar.j6.J6;
            } else {
                i11 = org.telegram.ui.ActionBar.j6.f18054k5;
            }
        ...
        if (i14 != 1 && i14 != 5) {
            ...
            i12 = org.telegram.ui.ActionBar.j6.f18090m5;
        }
        this.f20771f.setTextColor(org.telegram.ui.ActionBar.j6.v0(i12, f6Var));
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (i13 == 3) {
            ...
            if (view2.getLayoutParams().width == -1) {
                view2.measure(em.d(8.0f, (dp - ((int) Math.abs(view2.getTranslationX()))) - measuredWidth2, 1073741824), View.MeasureSpec.makeMeasureSpec(getMeasuredHeight(), Integer.MIN_VALUE));
            } else {
                view2.measure(em.d(8.0f, (dp - ((int) Math.abs(view2.getTranslationX()))) - measuredWidth2, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(getMeasuredHeight(), Integer.MIN_VALUE));
            }
            org.telegram.ui.Components.w9 w9Var = this.f20775w;
            if (w9Var != null) {
    ...
    public void setCollapsed(Boolean bool) {
        ...
        if (this.f20774s == null) {
            this.f20774s = new View(getContext());
            Drawable mutate = getContext().getResources().getDrawable(R.drawable.arrow_more).mutate();
            mutate.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.G6, this.f20769b), PorterDuff.Mode.MULTIPLY));
            this.f20774s.setBackground(mutate);
            addView(this.f20774s, w7.a6.e(16, 16, 16));
        }
        f();
        this.f20774s.animate().cancel();
        ViewPropertyAnimator animate = this.f20774s.animate();
    ...
    public void setTextColor(int i10) {
        if (this.H) {
            ...
            this.f20770c.setTextColor(i10);
        }
    }

    public void setUserOrChat(TLObject tLObject) {
        String formatName;
        org.telegram.ui.Components.g9 g9Var = this.f20776x;
        g9Var.p(tLObject);
        this.f20775w.e(tLObject, g9Var);
        ...
        if (z10 && ((TLRPC.User) tLObject).f17342id == MessagesController.getInstance(UserConfig.selectedAccount).telegramAntispamUserId) {
        ...
        this.f20770c.setText(formatName);
    }
    ...
    public z1(int i10, int i11, Context context, org.telegram.ui.ActionBar.f6 f6Var, boolean z10) {
        ...
        if (z10) {
            ...
            w1Var.setTag(Integer.valueOf(org.telegram.ui.ActionBar.j6.v0((i10 == 1 || i10 == 5) ? org.telegram.ui.ActionBar.j6.f18034j5 : org.telegram.ui.ActionBar.j6.G6, f6Var)));
            ...
            x1Var.setTag(Integer.valueOf(org.telegram.ui.ActionBar.j6.v0((i10 == 1 || i10 == 5) ? org.telegram.ui.ActionBar.j6.f18034j5 : org.telegram.ui.ActionBar.j6.G6, f6Var)));
        ...
        textView.setTag(Integer.valueOf((i10 == 1 || i10 == 5) ? org.telegram.ui.ActionBar.j6.f18090m5 : org.telegram.ui.ActionBar.j6.I6));
        ...
        if (i10 == 6) {
            ...
            this.f20776x = new org.telegram.ui.Components.g9((org.telegram.ui.ActionBar.f6) null);
