...
public final class z1 extends FrameLayout {
    ...
    public View J;
    public int f23592a;
    public final org.telegram.ui.ActionBar.f6 f23593b;
    public final x1 f23594c;
    public final w1 d;
    public final View f23595e;
    public final TextView f23596f;
    public final View h;
    public final CheckBoxSquare f23597n;
    public final mp f23598r;
    public View f23599s;
    public final y1 v;
    public final org.telegram.ui.Components.x9 f23600w;
    public final org.telegram.ui.Components.i9 f23601x;
    public final int f23602y;
    ...
    public final boolean b() {
        mp mpVar = this.f23598r;
        if (mpVar != null) {
            return mpVar.f28478a.f23908q;
        }
        return this.f23597n.h;
    }
    ...
    public final void d(org.telegram.ui.a aVar, bi.u1 u1Var) {
        ...
        if (aVar == null) {
            ...
            if (this.I == null) {
                ...
                this.I = view2;
                view2.setBackground(org.telegram.ui.ActionBar.j6.f0(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20754i6, this.f23593b), 2, -1));
    ...
    public final void e(CharSequence charSequence, String str, boolean z10, boolean z11, boolean z12) {
        if (this.H) {
            ...
            this.f23594c.setText(charSequence);
        }
        mp mpVar = this.f23598r;
        if (mpVar != null) {
            mpVar.a(z10, z12);
        } else {
            this.f23597n.a(z10, z12);
        }
        this.f23596f.setText(str);
        this.F = z11;
        setWillNotDraw(!z11);
    }
    ...
    public final void f() {
        ...
        this.f23599s.setTranslationX(left);
    }
    ...
    public final void g() {
        ...
        int i13;
        boolean z10 = this.H;
        org.telegram.ui.ActionBar.f6 f6Var = this.f23593b;
        int i14 = this.f23602y;
        if (z10) {
            if (i14 != 1 && i14 != 5) {
                i13 = org.telegram.ui.ActionBar.j6.G6;
            } else {
                i13 = org.telegram.ui.ActionBar.j6.f20771j5;
            }
            ...
            x1 x1Var = this.f23594c;
            x1Var.setTextColor(v02);
            if (i14 != 1 && i14 != 5) {
                i11 = org.telegram.ui.ActionBar.j6.J6;
            } else {
                i11 = org.telegram.ui.ActionBar.j6.f20791k5;
            }
        ...
        if (i14 != 1 && i14 != 5) {
            ...
            i12 = org.telegram.ui.ActionBar.j6.f20827m5;
        }
        this.f23596f.setTextColor(org.telegram.ui.ActionBar.j6.v0(i12, f6Var));
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.F) {
            ...
            int dp = AndroidUtilities.dp(f7) + ((int) Math.abs(this.f23595e.getTranslationX()));
            if (this.f23602y == 7) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        View view = this.h;
        int i12 = this.E;
        View view2 = this.f23595e;
        TextView textView = this.f23596f;
        int i13 = this.f23602y;
        if (i13 == 3) {
            ...
            org.telegram.ui.Components.x9 x9Var = this.f23600w;
            if (x9Var != null) {
    ...
    public void setCollapsed(Boolean bool) {
        ...
        if (this.f23599s == null) {
            this.f23599s = new View(getContext());
            Drawable mutate = getContext().getResources().getDrawable(R.drawable.arrow_more).mutate();
            mutate.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.G6, this.f23593b), PorterDuff.Mode.MULTIPLY));
            this.f23599s.setBackground(mutate);
            addView(this.f23599s, w7.x5.e(16, 16, 16));
        }
        f();
        this.f23599s.animate().cancel();
        ViewPropertyAnimator animate = this.f23599s.animate();
    ...
    public void setEnabled(boolean z10) {
        ...
        this.f23595e.setAlpha(f7);
        if (z10) {
            f10 = 1.0f;
        } else {
            f10 = 0.5f;
        }
        this.f23596f.setAlpha(f10);
        if (z10) {
            f11 = 1.0f;
        }
        this.h.setAlpha(f11);
    ...
    public void setPad(int i10) {
        ...
        float f7 = dp;
        this.f23595e.setTranslationX(f7);
        org.telegram.ui.Components.x9 x9Var = this.f23600w;
        if (x9Var != null) {
    ...
    public void setTextColor(int i10) {
        if (this.H) {
            ...
            this.f23594c.setTextColor(i10);
        }
    }

    public void setUserOrChat(TLObject tLObject) {
        String formatName;
        org.telegram.ui.Components.i9 i9Var = this.f23601x;
        i9Var.p(tLObject);
        this.f23600w.e(tLObject, i9Var);
        ...
        this.f23594c.setText(formatName);
    }
    ...
    public z1(int i10, int i11, Context context, org.telegram.ui.ActionBar.f6 f6Var, boolean z10) {
        ...
        if (z10) {
            ...
            w1Var.setTag(Integer.valueOf(org.telegram.ui.ActionBar.j6.v0((i10 == 1 || i10 == 5) ? org.telegram.ui.ActionBar.j6.f20771j5 : org.telegram.ui.ActionBar.j6.G6, f6Var)));
            ...
            x1Var.setTag(Integer.valueOf(org.telegram.ui.ActionBar.j6.v0((i10 == 1 || i10 == 5) ? org.telegram.ui.ActionBar.j6.f20771j5 : org.telegram.ui.ActionBar.j6.G6, f6Var)));
        ...
        textView.setTag(Integer.valueOf((i10 == 1 || i10 == 5) ? org.telegram.ui.ActionBar.j6.f20827m5 : org.telegram.ui.ActionBar.j6.I6));
        ...
        if (i10 == 6) {
            ...
            this.f23601x = new org.telegram.ui.Components.i9((org.telegram.ui.ActionBar.f6) null);
