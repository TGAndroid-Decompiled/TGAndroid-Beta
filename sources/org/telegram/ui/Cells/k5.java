...
public final class k5 extends FrameLayout {
    public final TextView f20370a;
    public final TextView f20371b;
    ...
    public k5(Context context) {
        ...
        this.f20372c = textView3;
        wl.r(textView3, org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19264z6, false), 1, 14.0f, 1);
    ...
    public final void a(String str, String str2, TLRPC.WebDocument webDocument, String str3, Object obj) {
        ...
        TextView textView2 = this.f20371b;
        textView2.setText(str2);
        TextView textView3 = this.f20372c;
        ...
        if (webDocument != null && webDocument.mime_type.startsWith("image/")) {
            ...
            u9Var.getImageReceiver().setImage(ImageLocation.getForWebFile(WebFile.createWithWebDocument(webDocument)), a4.a.k(i14, i15, "_"), null, null, -1L, null, obj, 1);
            return;
        }
        if (LocaleController.isRTL) {
            i10 = 5;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.d.getVisibility() != 8) {
            ...
            ((FrameLayout.LayoutParams) this.f20372c.getLayoutParams()).topMargin = AndroidUtilities.dp(3.0f) + textView.getMeasuredHeight() + AndroidUtilities.dp(33.0f);
            i13 = makeMeasureSpec;
        }
