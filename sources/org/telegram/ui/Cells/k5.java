...
public final class k5 extends FrameLayout {
    ...
    public k5(Context context) {
        ...
        this.f20371c = textView3;
        wl.r(textView3, org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19263z6, false), 1, 14.0f, 1);
    ...
    public final void a(String str, String str2, TLRPC.WebDocument webDocument, String str3, Object obj) {
        ...
        float f13;
        float f14;
        TextView textView = this.f20369a;
        textView.setText(str);
        TextView textView2 = this.f20370b;
        textView2.setText(str2);
        TextView textView3 = this.f20371c;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.d.getVisibility() != 8) {
            ...
            TextView textView = this.f20370b;
            i12 = i10;
            measureChildWithMargins(textView, i12, 0, i11, 0);
            ((FrameLayout.LayoutParams) this.f20371c.getLayoutParams()).topMargin = AndroidUtilities.dp(3.0f) + textView.getMeasuredHeight() + AndroidUtilities.dp(33.0f);
            i13 = makeMeasureSpec;
        }
