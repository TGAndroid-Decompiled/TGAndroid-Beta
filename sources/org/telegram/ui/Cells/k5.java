...
public final class k5 extends FrameLayout {
    ...
    public k5(Context context) {
        ...
        addView(p9Var, k7.b6.d(100, 100.0f, i10, 10.0f, 10.0f, 10.0f, 0.0f));
        TextView textView = new TextView(context);
        this.f21271a = textView;
        ...
        addView(textView, k7.b6.d(-1, -2.0f, i17, f10, 9.0f, f11, 0.0f));
        TextView textView2 = new TextView(context);
        this.f21272b = textView2;
        ...
        addView(textView2, k7.b6.d(-1, -2.0f, i18, f12, 33.0f, f13, 0.0f));
        TextView textView3 = new TextView(context);
        this.f21273c = textView3;
        org.telegram.ui.b.q(textView3, org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20273z6, false), 1, 14.0f, 1);
        ...
        addView(textView3, k7.b6.d(-1, -2.0f, i19, f14, 90.0f, f15, 9.0f));
    }
    ...
    public final void a(String str, String str2, TLRPC.WebDocument webDocument, String str3, Object obj) {
        ...
        TextView textView2 = this.f21272b;
        textView2.setText(str2);
        TextView textView3 = this.f21273c;
        ...
        if (webDocument != null && webDocument.mime_type.startsWith("image/")) {
            ...
            textView.setLayoutParams(k7.b6.d(-1, -2.0f, i17, f10, 9.0f, f11, 0.0f));
            boolean z10 = LocaleController.isRTL;
            if (z10) {
                i13 = 5;
            } else {
            ...
            textView2.setLayoutParams(k7.b6.d(-1, -2.0f, i18, f12, 33.0f, f13, 0.0f));
            boolean z11 = LocaleController.isRTL;
            if (z11) {
                i16 = 5;
            }
            ...
            textView3.setLayoutParams(k7.b6.d(-1, -2.0f, i19, f14, 90.0f, f15, 0.0f));
        ...
        textView.setLayoutParams(k7.b6.d(-1, -2.0f, i10 | 48, 17.0f, 9.0f, 17.0f, 0.0f));
        if (LocaleController.isRTL) {
            i11 = 5;
        } else {
            i11 = 3;
        }
        textView2.setLayoutParams(k7.b6.d(-1, -2.0f, i11 | 48, 17.0f, 33.0f, 17.0f, 0.0f));
        if (LocaleController.isRTL) {
            i16 = 5;
        }
        textView3.setLayoutParams(k7.b6.d(-1, -2.0f, i16 | 48, 17.0f, 90.0f, 17.0f, 9.0f));
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.d.getVisibility() != 8) {
            ...
            TextView textView = this.f21272b;
            i12 = i10;
            measureChildWithMargins(textView, i12, 0, i11, 0);
            ((FrameLayout.LayoutParams) this.f21273c.getLayoutParams()).topMargin = AndroidUtilities.dp(3.0f) + textView.getMeasuredHeight() + AndroidUtilities.dp(33.0f);
            i13 = makeMeasureSpec;
        }
