...
public final class k5 extends FrameLayout {
    ...
    public k5(Context context) {
        ...
        this.f20361c = textView3;
        wl.r(textView3, org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f19237z6, false), 1, 14.0f, 1);
    ...
    public final void a(String str, String str2, TLRPC.WebDocument webDocument, String str3, Object obj) {
        ...
        TextView textView2 = this.f20360b;
        textView2.setText(str2);
        TextView textView3 = this.f20361c;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.d.getVisibility() != 8) {
            ...
            ((FrameLayout.LayoutParams) this.f20361c.getLayoutParams()).topMargin = AndroidUtilities.dp(3.0f) + textView.getMeasuredHeight() + AndroidUtilities.dp(33.0f);
            i13 = makeMeasureSpec;
        }
