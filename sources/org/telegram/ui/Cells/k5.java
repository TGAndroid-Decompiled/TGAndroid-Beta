...
public final class k5 extends org.telegram.ui.Components.p9 implements DownloadController.FileDownloadProgressListener {
    ...
    public final void onFailedDownload(String str, boolean z4) {
        TLRPC.TL_wallPaper tL_wallPaper = this.Q.f37073a.d.T0;
        TLRPC.TL_wallPaper tL_wallPaper2 = this.F;
        if ((tL_wallPaper2 == null && tL_wallPaper == null) || (tL_wallPaper != null && tL_wallPaper2 != null && tL_wallPaper2.f20997id == tL_wallPaper.f20997id)) {
            if (z4) {
    ...
    public final void onProgressDownload(String str, long j10, long j11) {
        ...
        TLRPC.TL_wallPaper tL_wallPaper = this.Q.f37073a.d.T0;
        TLRPC.TL_wallPaper tL_wallPaper2 = this.F;
        if (((tL_wallPaper2 == null && tL_wallPaper == null) || (tL_wallPaper != null && tL_wallPaper2 != null && tL_wallPaper2.f20997id == tL_wallPaper.f20997id)) && radialProgress2.f24974i.f32706q != 10) {
