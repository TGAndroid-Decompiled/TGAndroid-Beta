...
public final class k5 extends FrameLayout {
    ...
    public final void onMeasure(int i10, int i11) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(this.d, 1073741824), rl.B(2.0f, this.d, 1073741824));
    }
    ...
    public void setType(int i10) {
        TextView textView = this.f24584c;
        ImageView imageView = this.f24583b;
        ImageView imageView2 = this.f24582a;
        if (i10 == 0) {
