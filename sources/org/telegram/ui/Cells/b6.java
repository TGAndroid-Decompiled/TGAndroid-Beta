...
public final class b6 extends bu {
    ...
    public b6(FrameLayout frameLayout, Context context, org.telegram.ui.ActionBar.e6 e6Var, int i10) {
        super(context, e6Var);
        this.f19837c = i10;
        this.d = frameLayout;
    }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        switch (this.f19837c) {
            ...
            case 1:
                if (motionEvent.getAction() == 1 && ((x51) this.d).f38381y.u()) {
    ...
    public b6(Context context, org.telegram.ui.ActionBar.e6 e6Var, Drawable drawable) {
        super(context, e6Var);
        this.f19837c = 3;
        this.d = drawable;
    }
