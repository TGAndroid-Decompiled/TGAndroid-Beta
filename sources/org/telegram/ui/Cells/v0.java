...
public class v0 extends a0 implements DownloadController.FileDownloadProgressListener, NotificationCenter.NotificationCenterDelegate, o4 {
    public static final HashMap f22425g2;
    public float A0;
    public boolean A1;
    public boolean B;
    public float B0;
    ...
    public Paint Z0;
    public int Z1;
    public final nh.i7 f22426a0;
    public k01 f22427a1;
    public SpannableStringBuilder a2;
    public boolean f22428b0;
    public StaticLayout f22429b1;
    public boolean f22430b2;
    public boolean f22431c0;
    public boolean f22432c1;
    public Runnable f22433c2;
    public boolean f22434d0;
    public boolean f22435d1;
    public PorterDuffColorFilter f22436d2;
    public boolean f22437e0;
    public int f22438e1;
    public int f22439e2;
    public int f22440f;
    public boolean f22441f0;
    public final org.telegram.ui.Components.z5 f22442f1;
    public final u0 f22443f2;
    public int f22444g0;
    public g20 f22445g1;
    public int h;
    public boolean f22446h0;
    public eg.p f22447h1;
    public int f22448i0;
    public int f22449i1;
    ...
    public d21 f22452k0;
    public int f22453k1;
    public final RectF f22454l0;
    public k01 l1;
    public final ArrayList m0;
    public StaticLayout f22455m1;
    public final rc f22456n;
    public final Stack f22457n0;
    public boolean f22458n1;
    public org.telegram.ui.Components.q5 f22459o0;
    public TextPaint f22460o1;
    public TextPaint f22461p0;
    public StaticLayout f22462p1;
    public float f22463q0;
    public float f22464q1;
    public i90 f22465r;
    public float f22466r0;
    public StaticLayout f22467r1;
    public final boolean f22468s;
    public int f22469s0;
    public float f22470s1;
    public boolean f22471t0;
    public final TextPaint f22472t1;
    public ImageLocation f22473u0;
    public final TextPaint f22474u1;
    public View v;
    public float f22475v0;
    public final TextPaint f22476v1;
    public final int f22477w;
    public float f22478w0;
    public TLRPC.Document f22479w1;
    public URLSpan f22480x;
    public boolean f22481x0;
    public TLRPC.VideoSize f22482x1;
    public ih.k f22483y;
    public boolean f22484y0;
    public final RadialProgress2 f22485y1;
    public final mg.r0 f22486z0;
    public int f22487z1;
    ...
    private void setStarsPaused(boolean z4) {
        ...
        for (int i10 = 0; i10 < p2Var.f5437n.size(); i10++) {
            eg.o2 o2Var = (eg.o2) p2Var.f5437n.get(i10);
            o2Var.f5400a = (System.currentTimeMillis() - p2Var.Q) + o2Var.f5400a;
        }
        invalidate();
    }
    ...
    public final void A(Canvas canvas) {
        ...
        canvas2.save();
        float f13 = 2.0f;
        canvas2.translate(this.f22444g0 / 2.0f, getPaddingTop());
        canvas2.save();
        canvas2.translate(this.Q, this.P);
        StaticLayout staticLayout = this.J;
        org.telegram.ui.Components.q5 q5Var = this.f22459o0;
        ...
        if (i5Var.d()) {
            canvas2.save();
            float width = (getWidth() - i5Var.Q.e) / 2.0f;
            if (i5Var.f12600p) {
        ...
        canvas2.restore();
        d21 d21Var = this.f22452k0;
        org.telegram.ui.ActionBar.f6 f6Var = this.V0;
        if (d21Var != null) {
            float alpha = getAlpha();
            if (f6Var != null) {
                f6Var.l(this.f22466r0, this.f22463q0 + 0.0f, getMeasuredWidth(), this.f22469s0);
            } else {
                org.telegram.ui.ActionBar.j6.q(this.f22466r0, this.f22463q0 + 0.0f, getMeasuredWidth(), this.f22469s0);
            }
            this.f22452k0.c(canvas, getWidth(), this.f22444g0, 0.0f, 1.0f, alpha, this.f22450j0);
            canvas2 = canvas;
        }
        ArrayList arrayList = this.M1;
        if (arrayList != null && !arrayList.isEmpty()) {
            if (f6Var != null) {
                f6Var.l(this.f22466r0, this.f22463q0 + AndroidUtilities.dp(4.0f), getMeasuredWidth(), this.f22469s0);
            } else {
                org.telegram.ui.ActionBar.j6.q(this.f22466r0, this.f22463q0 + AndroidUtilities.dp(4.0f), getMeasuredWidth(), this.f22469s0);
            }
            float width2 = (getWidth() - this.X0) / 2.0f;
            float dp2 = AndroidUtilities.dp(4.0f) + AndroidUtilities.dp(4.0f) + this.P + this.L + this.f22440f;
            ...
            while (i13 < arrayList.size()) {
                ...
                float f15 = dp4 + dp3;
                RectF rectF = this.R0;
                rectF.set(dp4, dp2, f15, e0Var.f20965f + dp2);
                canvas2.save();
                if (a2 != 1.0f) {
                    f10 = 4.0f;
                ...
                if (zVar != null) {
                    int i14 = (int) dp2;
                    zVar.setBounds((int) dp4, i14, (int) f15, e0Var.f20965f + i14);
                    e0Var.f20977s.setAlpha(255);
                    e0Var.f20977s.draw(canvas2);
                }
                canvas2.restore();
                canvas2.save();
                if (e0Var.f20978t != null) {
                ...
                Drawable drawable = e0Var.f20978t;
                if (drawable != null) {
                    int i15 = (int) x10;
                    f11 = 2.0f;
                    drawable.setBounds(i15, (int) (((e0Var.f20965f - AndroidUtilities.dp(24.0f)) / f13) + dp2), AndroidUtilities.dp(24.0f) + i15, AndroidUtilities.dp(24.0f) + ((int) (((e0Var.f20965f - AndroidUtilities.dp(24.0f)) / 2.0f) + dp2)));
                    Drawable drawable2 = e0Var.f20978t;
                    if (e0Var.f20971m) {
                        i12 = 128;
                    } else {
                        i12 = 255;
                    ...
                    e0Var.f20978t.draw(canvas2);
                    x10 += f16;
                } else {
                    f11 = 2.0f;
                }
                e0Var.h.f26094p = Math.max(1, (((int) dp3) - AndroidUtilities.dp(15.0f)) - i10);
                k01 k01Var = e0Var.h;
    ...
    public final void C(Canvas canvas, boolean z4, Integer num) {
        ...
        if (f10 > 0.0f) {
            ...
            if (messageObject != null && messageObject.shouldDrawReactions()) {
                mg.r0 r0Var = this.f22486z0;
                boolean z10 = r0Var.f14114b;
                u0 u0Var = this.f22443f2;
                if (!z10 || (u0Var.f22379b && r0Var.f14121l)) {
                    r0Var.f14113a = 1.0f;
    ...
    public final ColorFilter E(int i10) {
        if (i10 != this.f22439e2 || this.f22436d2 == null) {
            this.f22439e2 = i10;
            this.f22436d2 = new PorterDuffColorFilter(i10, PorterDuff.Mode.SRC_IN);
        }
        ...
        if (messageObject != null) {
            try {
                if (messageObject.type == 22 && (str = (messagesController = MessagesController.getInstance(this.E)).uploadingWallpaper) != null && TextUtils.equals(messageObject.messageOwner.action.wallpaper.uploadingImage, str)) {
                    return messagesController.uploadingWallpaperInfo.f19568r;
                }
                return 1.0f;
            } catch (Exception e) {
                FileLog.e(e);
    ...
    public final void Q(CharacterStyle characterStyle) {
        if (this.U0 != null && (characterStyle instanceof URLSpan)) {
            ...
            if (url.startsWith("topic")) {
                URLSpan uRLSpan = this.f22480x;
                if (uRLSpan instanceof m51) {
                    TLObject tLObject = ((m51) uRLSpan).f26949c;
            ...
            if (url.startsWith("invite")) {
                URLSpan uRLSpan2 = this.f22480x;
                if (uRLSpan2 instanceof m51) {
                    TLObject tLObject2 = ((m51) uRLSpan2).f26949c;
    ...
    public final void S() {
        ...
        if (messageObject != null && (message = messageObject.messageOwner) != null) {
            ...
            if (z4) {
                ...
                starsTransaction.f19411id = tL_messageActionGiftStars.transaction_id;
                ...
                starsTransaction2.f19411id = tL_messageActionPrizeStars.transaction_id;
                ...
                starsTransaction3.f19411id = tL_messageActionGiftTon.transaction_id;
    ...
    public int getBoundsLeft() {
        ...
        if (i5Var.d()) {
            ...
            return kh.a2.d(getWidth(), this.X0, 2, this.f22444g0 / 2);
        } else {
            int i10 = this.P0;
    ...
    public final void invalidate() {
        ...
        Runnable runnable = this.f22433c2;
        if (runnable != null) {
            runnable.run();
        }
        if (!this.f22430b2 || getParent() == null) {
            return;
        }
    ...
    public final boolean m() {
        t0 t0Var = this.U0;
        if (t0Var != null) {
            return t0Var.u2(this, this.f22475v0, this.f22478w0);
        }
        return false;
    }
    ...
    public final void onAttachedToWindow() {
        ...
        if (this.f22468s && (t0Var = this.U0) != null && !t0Var.e()) {
            z4 = true;
        } else {
            z4 = false;
        }
        this.f22459o0 = org.telegram.ui.Components.u5.update(0, this, z4, this.f22459o0, this.J);
        eg.p pVar = this.f22447h1;
        if (pVar != null) {
            pVar.h = org.telegram.ui.Components.u5.update(0, (View) ((v0) pVar.f5420i), false, (org.telegram.ui.Components.q5) pVar.h, (StaticLayout) pVar.f5418f);
        }
        int i10 = this.E;
        ...
        ky0 ky0Var = this.D0;
        if (ky0Var != null) {
            ky0Var.d.f25170s0 = ky0Var.f26400b;
        }
    }
    ...
    public final void onDetachedFromWindow() {
        ...
        setStarsPaused(true);
        this.f22481x0 = false;
        org.telegram.ui.Components.u5.release(this, this.f22459o0);
        eg.p pVar = this.f22447h1;
        if (pVar != null) {
            org.telegram.ui.Components.u5.release((v0) pVar.f5420i, (org.telegram.ui.Components.q5) pVar.h);
        }
        ...
        this.f22426a0.g();
        this.f22443f2.f22378a = false;
        lh.i5 i5Var = this.C0;
        i5Var.P = false;
        i5Var.d.onDetachedFromWindow();
        i5Var.e.b();
        kh.v0 v0Var = i5Var.f12608y;
    ...
    public final void onSuccessDownload(String str) {
        ...
        if (messageObject != null && messageObject.type == 11) {
            ...
            this.F.setImage(this.f22473u0, "g", ImageLocation.getForObject(photoSize, messageObject.photoThumbsObject), "50_50_b", this.I, 0L, null, messageObject, 1);
    ...
    public final void u() {
        ...
        TextPaint textPaint = this.f22472t1;
        textPaint.setTextSize(AndroidUtilities.dp(14.0f));
        TextPaint textPaint2 = this.f22474u1;
        ...
        this.f22455m1 = staticLayout;
        this.f22458n1 = true;
        this.f22470s1 = P(staticLayout);
    }
    ...
    public final void v(CharSequence charSequence, SpannableStringBuilder spannableStringBuilder, CharSequence charSequence2, boolean z4, CharSequence charSequence3, int i10, String str, int i11, boolean z10) {
        ...
        if (spannableStringBuilder != null) {
            ...
            this.f22427a1 = k01Var;
            k01Var.f26082a.linkColor = -1;
        } else {
            this.f22427a1 = null;
        }
        ...
        if (messageObject4 != null && messageObject4.type == 22 && messageObject4.getDialogId() >= 0 && (a2 = ph.f3.a(charSequence4, textPaint2)) < dp2 && a2 > dp2 / 5.0f) {
            dp2 = a2;
        }
        boolean z11 = true;
        if (charSequence4 == null) {
            ...
            if (this.f22447h1 == null) {
                this.f22447h1 = new eg.p(this);
            }
            try {
                charSequence4 = Emoji.replaceEmoji(charSequence4, textPaint2.getFontMetricsInt(), r42);
            } catch (Exception unused) {
            }
            this.f22447h1.a(charSequence4, textPaint2, dp2);
            if (z4 && ((StaticLayout) this.f22447h1.f5418f).getLineCount() > 3) {
                this.f22435d1 = !this.f22432c1;
                this.f22438e1 = ((StaticLayout) this.f22447h1.f5418f).getLineBottom(2);
                ...
                int lineBottom = ((StaticLayout) this.f22447h1.f5418f).getLineBottom(2);
                this.f22451j1 = lineBottom;
                this.f22453k1 = lineBottom - ((StaticLayout) this.f22447h1.f5418f).getLineTop(2);
                this.f22449i1 = (int) ((StaticLayout) this.f22447h1.f5418f).getLineRight(2);
            } else {
                this.f22435d1 = r42;
                this.f22442f1.f(true, true);
                this.f22438e1 = r42;
            }
            if (this.f22435d1) {
                int lineEnd = ((StaticLayout) this.f22447h1.f5418f).getLineEnd(2) - 1;
                eg.p pVar2 = this.f22447h1;
                if (lineEnd >= 0) {
        ...
        if (charSequence3 != null) {
            ...
            this.f22455m1 = staticLayout;
            this.f22458n1 = (!z10 || this.f22435d1) ? false : false;
            this.f22470s1 = P(staticLayout);
        } else {
            this.f22455m1 = null;
            this.f22458n1 = r42;
        ...
        if (str != null) {
            ...
            this.H1 = k01Var2;
            k01Var2.f26094p = AndroidUtilities.dp(62.0f);
            return;
        }
        this.G1 = null;
        this.H1 = null;
    ...
    public final void y(Canvas canvas, boolean z4) {
        ...
        int i24;
        v0 v0Var2 = this;
        if (!v0Var2.f22468s || ((!v0Var2.I() || z4) && (v0Var2.I() || !z4))) {
            Paint G = v0Var2.G("paintChatActionBackground");
            Paint G2 = v0Var2.G("paintChatActionBackgroundDarken");
            v0Var2.f22461p0 = (TextPaint) v0Var2.G("paintChatActionText");
            int i25 = v0Var2.I0;
            ...
            if (z10) {
                ...
                while (i26 < lineCount) {
                    ...
                    i26 = yh.e(ceil, i26, 1, arrayList3);
                    i27 = ceil;
                }
                f12 = 2.0f;
                f13 = 4.0f;
            ...
            if (!v0Var.f22471t0) {
                v0Var.f22469s0 = ((ViewGroup) v0Var.getParent()).getMeasuredHeight();
            }
            if (f6Var != null) {
                f6Var.l(v0Var.f22466r0, v0Var.f22463q0 + AndroidUtilities.dp(f13), v0Var.getMeasuredWidth(), v0Var.f22469s0);
            } else {
                org.telegram.ui.ActionBar.j6.q(v0Var.f22466r0, v0Var.f22463q0 + AndroidUtilities.dp(f13), v0Var.getMeasuredWidth(), v0Var.f22469s0);
            }
            float f25 = 0.75f;
            ...
            if (i5Var.d()) {
                float dp7 = i5Var.Q.e + AndroidUtilities.dp(f11);
                ...
                ky0 ky0Var = v0Var.D0;
                ky0Var.getClass();
                int dp9 = AndroidUtilities.dp(140.0f) + ((int) ky0Var.f26402f.j());
                if (ky0Var.f26404i) {
                ...
                if (v0Var.N()) {
                    ...
                    AndroidUtilities.rectTmp.set(width3, dp10, v0Var.X0 + width3, v0Var.f22440f + dp10);
                } else {
                    float dp11 = f29 + AndroidUtilities.dp(12.0f);
                    RectF rectF3 = AndroidUtilities.rectTmp;
                    float f30 = v0Var.X0;
                    rectF3.set(width3, dp11, width3 + f30, f30 + dp11 + v0Var.f22487z1);
                }
                if (messageObject2 != null && messageObject2.type == 18 && !v0Var.f22435d1 && (pVar = v0Var.f22447h1) != null && v0Var.f22438e1 > 0) {
                    RectF rectF4 = AndroidUtilities.rectTmp;
                    rectF4.bottom = yh.c(1.0f, v0Var.f22442f1.f31241c, ((StaticLayout) pVar.f5418f).getHeight() - v0Var.f22438e1, rectF4.bottom);
                }
                if (v0Var.B1 == null) {
                    v0Var.B1 = new RectF();
                }
    ...
    public v0(Context context, org.telegram.ui.ActionBar.f6 f6Var, boolean z4) {
        super(context);
        this.f22456n = new rc(this);
        int i10 = UserConfig.selectedAccount;
        this.E = i10;
        nh.i7 i7Var = new nh.i7(null, false);
        this.f22426a0 = i7Var;
        this.f22450j0 = true;
        this.f22454l0 = new RectF();
        this.m0 = new ArrayList();
        this.f22457n0 = new Stack();
        this.f22486z0 = new mg.r0(this);
        this.I0 = -1;
        this.J0 = -1;
        this.M0 = new ArrayList();
        ...
        this.f22432c1 = false;
        this.f22435d1 = false;
        this.f22442f1 = new org.telegram.ui.Components.z5(this, 0L, 320L, nr.h);
        this.f22458n1 = true;
        TextPaint textPaint = new TextPaint(1);
        this.f22472t1 = textPaint;
        TextPaint textPaint2 = new TextPaint(1);
        this.f22474u1 = textPaint2;
        TextPaint textPaint3 = new TextPaint(1);
        this.f22476v1 = textPaint3;
        this.f22485y1 = new RadialProgress2(this, null);
        ...
        this.f22477w = DownloadController.getInstance(i10).generateObserverTag();
