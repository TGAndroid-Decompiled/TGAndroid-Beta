...
public final class d8 extends FrameLayout {
    public org.telegram.ui.Components.u9 f19929a;
    public TLRPC.Document f19930b;
    public Object f19931c;
    public long d;
    public boolean e;
    public float f19932f;
    public boolean h;
    public rg.b1 f19933n;
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        org.telegram.ui.Components.u9 u9Var = this.f19929a;
        if (view == u9Var && (((z10 = this.e) && this.f19932f != 0.8f) || (!z10 && this.f19932f != 1.0f))) {
            long currentTimeMillis = System.currentTimeMillis();
            long j10 = currentTimeMillis - this.d;
            this.d = currentTimeMillis;
            if (this.e) {
                float f7 = this.f19932f;
                if (f7 != 0.8f) {
                    ...
                    u9Var.setScaleX(this.f19932f);
                    u9Var.setScaleY(this.f19932f);
                    u9Var.invalidate();
                    invalidate();
                }
            }
            float f11 = (((float) j10) / 400.0f) + this.f19932f;
            this.f19932f = f11;
            if (f11 > 1.0f) {
                this.f19932f = 1.0f;
            }
    ...
    public MessageObject.SendAnimationData getSendAnimationData() {
        ...
        sendAnimationData.f15601x = imageReceiver.getCenterX() + iArr[0];
        sendAnimationData.f15602y = imageReceiver.getCenterY() + iArr[1];
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        String str = null;
        for (int i10 = 0; i10 < this.f19930b.attributes.size(); i10++) {
            TLRPC.DocumentAttribute documentAttribute = this.f19930b.attributes.get(i10);
