...
public final class d8 extends FrameLayout {
    public org.telegram.ui.Components.w9 f20109a;
    public TLRPC.Document f20110b;
    public Object f20111c;
    public long d;
    public boolean e;
    public float f20112f;
    public boolean h;
    public rg.b1 f20113n;
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        org.telegram.ui.Components.w9 w9Var = this.f20109a;
        if (view == w9Var && (((z10 = this.e) && this.f20112f != 0.8f) || (!z10 && this.f20112f != 1.0f))) {
            long currentTimeMillis = System.currentTimeMillis();
            long j10 = currentTimeMillis - this.d;
            this.d = currentTimeMillis;
            if (this.e) {
                float f7 = this.f20112f;
                if (f7 != 0.8f) {
                    ...
                    w9Var.setScaleX(this.f20112f);
                    w9Var.setScaleY(this.f20112f);
                    w9Var.invalidate();
                    invalidate();
                }
            }
            float f11 = (((float) j10) / 400.0f) + this.f20112f;
            this.f20112f = f11;
            if (f11 > 1.0f) {
                this.f20112f = 1.0f;
            }
    ...
    public MessageObject.SendAnimationData getSendAnimationData() {
        ...
        sendAnimationData.f15788x = imageReceiver.getCenterX() + iArr[0];
        sendAnimationData.f15789y = imageReceiver.getCenterY() + iArr[1];
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        String str = null;
        for (int i10 = 0; i10 < this.f20110b.attributes.size(); i10++) {
            TLRPC.DocumentAttribute documentAttribute = this.f20110b.attributes.get(i10);
