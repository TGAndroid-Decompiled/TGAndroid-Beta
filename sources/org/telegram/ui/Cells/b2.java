...
public final class b2 extends FrameLayout {
    public final org.telegram.ui.Components.p6 f20044a;
    public final View f20045b;
    public final org.telegram.ui.ActionBar.d6 f20046c;
    ...
    public final void a() {
        float d = this.f20044a.getDrawable().d() + AndroidUtilities.dp(1.0f);
    ...
    public void setColor(int i10) {
        int v02 = org.telegram.ui.ActionBar.h6.v0(i10, this.f20046c);
        this.f20044a.setTextColor(v02);
        this.f20045b.getBackground().setColorFilter(new PorterDuffColorFilter(v02, PorterDuff.Mode.MULTIPLY));
    }
}
