...
public final class b2 extends FrameLayout {
    public final org.telegram.ui.Components.p6 f20045a;
    public final View f20046b;
    public final org.telegram.ui.ActionBar.d6 f20047c;
    ...
    public final void a() {
        float d = this.f20045a.getDrawable().d() + AndroidUtilities.dp(1.0f);
        boolean z10 = LocaleController.isRTL;
        View view = this.f20046b;
        if (z10) {
    ...
    public void setColor(int i10) {
        int v02 = org.telegram.ui.ActionBar.h6.v0(i10, this.f20047c);
        this.f20045a.setTextColor(v02);
        this.f20046b.getBackground().setColorFilter(new PorterDuffColorFilter(v02, PorterDuff.Mode.MULTIPLY));
    }
}
