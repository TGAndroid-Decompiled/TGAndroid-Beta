...
public final class f9 extends FrameLayout {
    public final TextView f20299a;
    public final TextView f20300b;
    ...
    public f9(Context context) {
        ...
        addView(textView, w7.y5.d(-2, -1.0f, i11 | 48, 21.0f, 0.0f, 21.0f, 0.0f));
        TextView textView2 = new TextView(context);
        this.f20300b = textView2;
    ...
    public final void a(String str, String str2, boolean z10) {
        ...
        TextView textView2 = this.f20300b;
        if (str2 != null) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        TextView textView = this.f20300b;
        textView.measure(makeMeasureSpec, makeMeasureSpec2);
        this.f20299a.measure(View.MeasureSpec.makeMeasureSpec((measuredWidth - textView.getMeasuredWidth()) - AndroidUtilities.dp(8.0f), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(getMeasuredHeight(), 1073741824));
    }

    public void setTextColor(int i10) {
        this.f20299a.setTextColor(i10);
    }

    public void setTextValueColor(int i10) {
        this.f20300b.setTextColor(i10);
    }
}
