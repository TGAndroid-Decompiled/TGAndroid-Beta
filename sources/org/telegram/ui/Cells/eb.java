...
public abstract class eb extends FrameLayout {
    ...
    public final db[] f21914c;
    public int d;
    public boolean f21915e;
    public boolean f21916f;
    public int h;
    public final Paint f21917n;
    public final Paint f21918r;
    public final Paint f21919s;
    ...
    public eb(Context context, int i10) {
        ...
        this.f21913b = true;
        this.d = 3;
        this.f21914c = new db[i10];
        int i11 = 0;
        while (true) {
            db[] dbVarArr = this.f21914c;
    ...
    public final void c(int i10, boolean z10, boolean z11) {
        float f7;
        float f10;
        db dbVar = this.f21914c[i10];
        bi.i5 i5Var = dbVar.f21831a;
        CheckBox checkBox = dbVar.f21833c;
        if (checkBox.getVisibility() != 0) {
            checkBox.setVisibility(0);
        }
        checkBox.b(z10, z11);
        AnimatorSet animatorSet = dbVar.f21835f;
        if (animatorSet != null) {
            animatorSet.cancel();
            dbVar.f21835f = null;
        }
        ...
        if (z11) {
            ...
            dbVar.f21835f.setDuration(200L);
            dbVar.f21835f.addListener(new ah.q0(26, dbVar, z10));
            dbVar.f21835f.start();
        } else {
            if (z10) {
                f7 = 0.8875f;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        int i14 = 0;
        if (this.d == 1) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(this.f21912a, 1073741824), wl.C(6.0f, this.f21912a, 1073741824));
