...
public final class sa extends FrameLayout {
    public final org.telegram.ui.Components.x9 f22880a;
    public final TextView f22881b;
    public TLRPC.TL_forumTopic f22882c;
    public boolean d;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.d) {
            ...
            if (LocaleController.isRTL) {
                canvas.drawLine(0.0f, getMeasuredHeight() - 1, getMeasuredWidth() - dp, getMeasuredHeight() - 1, org.telegram.ui.ActionBar.j6.f20812k0);
            } else {
                canvas.drawLine(dp, getMeasuredHeight() - 1, getMeasuredWidth(), getMeasuredHeight() - 1, org.telegram.ui.ActionBar.j6.f20812k0);
            }
        }
    }
    ...
    public void setTopic(TLRPC.TL_forumTopic tL_forumTopic) {
        ...
        org.telegram.ui.Components.x9 x9Var = this.f22880a;
