...
public abstract class fb extends FrameLayout {
    ...
    public final eb[] f20127c;
    public int d;
    public boolean e;
    public boolean f20128f;
    public int h;
    public final Paint f20129n;
    public final Paint f20130r;
    public final Paint f20131s;
    ...
    public fb(Context context, int i10) {
        ...
        this.f20126b = true;
        this.d = 3;
        this.f20127c = new eb[i10];
        int i11 = 0;
        while (true) {
            eb[] ebVarArr = this.f20127c;
    ...
    public final void c(int i10, boolean z10, boolean z11) {
        float f7;
        float f10;
        eb ebVar = this.f20127c[i10];
        ai.z5 z5Var = ebVar.f20064a;
        CheckBox checkBox = ebVar.f20066c;
        if (checkBox.getVisibility() != 0) {
            checkBox.setVisibility(0);
        }
        checkBox.b(z10, z11);
        AnimatorSet animatorSet = ebVar.f20067f;
        if (animatorSet != null) {
            animatorSet.cancel();
            ebVar.f20067f = null;
        }
        ...
        if (z11) {
            ...
            ebVar.f20067f.setDuration(200L);
            ebVar.f20067f.addListener(new ai.n(25, ebVar, z10));
            ebVar.f20067f.start();
        } else {
            if (z10) {
                f7 = 0.8875f;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        int i14 = 0;
        if (this.d == 1) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(this.f20125a, 1073741824), wl.C(3.0f, this.f20125a, 1073741824));
