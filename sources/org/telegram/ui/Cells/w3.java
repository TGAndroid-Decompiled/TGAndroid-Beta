...
public abstract class w3 extends FrameLayout {
    public org.telegram.ui.ActionBar.j5 f23467a;
    public org.telegram.ui.ActionBar.j5 f23468b;
    public ImageView f23469c;
    public ImageView d;
    public int f23470e;
    public boolean f23471f;
    public int h;
    public int f23472n;
    public Paint f23473r;

    public final void a(int i10, int i11) {
        org.telegram.ui.ActionBar.j5 j5Var = this.f23467a;
        j5Var.setTextColor(i11);
        j5Var.setTag(null);
        ImageView imageView = this.f23469c;
        imageView.setColorFilter(new PorterDuffColorFilter(i10, PorterDuff.Mode.MULTIPLY));
        imageView.setTag(null);
    }

    public final void b(int i10, String str, boolean z10) {
        this.f23467a.l(str, false);
        org.telegram.ui.ActionBar.j5 j5Var = this.f23468b;
        j5Var.l(null, false);
        ImageView imageView = this.f23469c;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.f23471f) {
            ...
            canvas.drawLine(dp, measuredHeight, measuredWidth - i10, getMeasuredHeight() - 1, this.f23473r);
        }
    }
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        CharSequence text = this.f23467a.getText();
        if (!TextUtils.isEmpty(text)) {
            CharSequence text2 = this.f23468b.getText();
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        int measuredWidth;
        int measuredWidth2;
        int i15 = this.f23472n;
        int i16 = this.f23470e;
        org.telegram.ui.ActionBar.j5 j5Var = this.f23467a;
        ImageView imageView = this.d;
        ImageView imageView2 = this.f23469c;
        int i17 = i13 - i11;
        int i18 = i12 - i10;
        org.telegram.ui.ActionBar.j5 j5Var2 = this.f23468b;
    ...
    public void onMeasure(int i10, int i11) {
        ...
        this.f23467a.measure(View.MeasureSpec.makeMeasureSpec((size - AndroidUtilities.dp(i12 + 71)) - j5Var.getTextWidth(), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), 1073741824));
        ImageView imageView2 = this.f23469c;
        if (imageView2.getVisibility() == 0) {
        ...
        setMeasuredDimension(size, AndroidUtilities.dp(50.0f) + (this.f23471f ? 1 : 0));
    }
