...
public class k6 extends FrameLayout {
    ...
    public final RadioButton f20334b;
    ...
    public final void b(ArrayList arrayList, boolean z10) {
        ...
        RadioButton radioButton = this.f20334b;
    ...
    public final void c(String str, boolean z10, boolean z11) {
        this.f20333a.setText(str);
        this.f20334b.a(z10, false);
        this.f20335c = z11;
        setWillNotDraw(!z11);
    }
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        accessibilityNodeInfo.setChecked(this.f20334b.f22133f);
    }

    @Override
    public final void onMeasure(int i10, int i11) {
        setMeasuredDimension(View.MeasureSpec.getSize(i10), AndroidUtilities.dp(50.0f) + (this.f20335c ? 1 : 0));
        int measuredWidth = ((getMeasuredWidth() - getPaddingLeft()) - getPaddingRight()) - AndroidUtilities.dp(34.0f);
        this.f20334b.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(22.0f), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(22.0f), 1073741824));
        this.f20333a.measure(View.MeasureSpec.makeMeasureSpec(measuredWidth, 1073741824), View.MeasureSpec.makeMeasureSpec(getMeasuredHeight(), 1073741824));
    }

    public void setRadioIcon(Drawable drawable) {
        this.f20334b.setIcon(drawable);
    }

    public void setTextColor(int i10) {
        this.f20333a.setTextColor(i10);
    }
