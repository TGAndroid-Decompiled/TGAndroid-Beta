...
public final class k6 extends FrameLayout {
    ...
    public k6(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        wl.n(org.telegram.ui.ActionBar.j6.f18970j5, f6Var, textView, 1, 16.0f);
        textView.setLines(1);
        ...
        this.f20374b = textView2;
        wl.n(org.telegram.ui.ActionBar.j6.f19245y6, f6Var, textView2, 1, 14.0f);
        if (LocaleController.isRTL) {
            i16 = 5;
        } else {
            i16 = 3;
    ...
    public final void a(int i10, int i11) {
        this.f20375c.b(i10, i11);
    }

    public final void b(CharSequence charSequence, boolean z10) {
        this.f20373a.setText(charSequence);
        this.f20374b.setVisibility(8);
        this.f20375c.a(z10, false);
    }
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        accessibilityNodeInfo.setChecked(this.f20375c.f22175f);
    }
