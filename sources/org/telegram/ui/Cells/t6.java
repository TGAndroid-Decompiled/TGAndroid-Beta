...
public final class t6 extends ImageSpan {
    public static s21 f25704b;
    public final int f25705a = 1;

    public t6(Drawable drawable) {
        super(drawable);
    }
    ...
    public void draw(Canvas canvas, CharSequence charSequence, int i10, int i11, float f9, int i12, int i13, int i14, Paint paint) {
        switch (this.f25705a) {
            case 0:
                ...
                canvas.translate(f9, ((i13 + i15) - ((i15 - fontMetricsInt.ascent) / 2)) - ((drawable.getBounds().bottom - drawable.getBounds().top) / 2));
    ...
    public t6() {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Cells.t6.<init>():void");
    }
}
