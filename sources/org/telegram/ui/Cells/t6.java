...
public final class t6 extends FrameLayout {
    ...
    public final org.telegram.ui.ActionBar.j5 f23248b;
    public final org.telegram.ui.ActionBar.j5 f23249c;
    public final ImageView d;
    public long f23250e;
    public final RectF f23251f;
    public final boolean h;
    public final boolean f23252n;
    public final org.telegram.ui.ActionBar.f6 f23253r;
    public boolean f23254s;
    public final androidx.activity.i v;
    public final org.telegram.ui.Components.e6 f23255w;
    public final org.telegram.ui.Components.e6 f23256x;
    public final org.telegram.ui.Components.e6 f23257y;
    ...
    public final void a() {
        long j3;
        LocationController.SharingLocationInfo sharingLocationInfo = LocationController.getInstance(this.f23247a).getSharingLocationInfo(this.f23250e);
    ...
    public final void b(String str, String str2) {
        this.f23249c.l(str, false);
        this.f23248b.l(str2, false);
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float dp;
        int i11;
        boolean z10 = this.f23254s;
        org.telegram.ui.ActionBar.f6 f6Var = this.f23253r;
        ...
        if (!this.f23252n) {
            int i12 = this.f23247a;
            LocationController.SharingLocationInfo sharingLocationInfo = LocationController.getInstance(i12).getSharingLocationInfo(this.f23250e);
            org.telegram.ui.Components.e6 e6Var = this.f23255w;
            float f11 = e6Var.f25565c;
            int currentTime = ConnectionsManager.getInstance(i12).getCurrentTime();
            org.telegram.ui.Components.e6 e6Var2 = this.f23256x;
            ...
            if (LocaleController.isRTL) {
                this.f23251f.set(AndroidUtilities.dp(13.0f), (getMeasuredHeight() / 2.0f) - AndroidUtilities.dp(15.0f), AndroidUtilities.dp(43.0f), (getMeasuredHeight() / 2.0f) + AndroidUtilities.dp(15.0f));
            } else {
                this.f23251f.set(getMeasuredWidth() - AndroidUtilities.dp(43.0f), (getMeasuredHeight() / 2.0f) - AndroidUtilities.dp(15.0f), getMeasuredWidth() - AndroidUtilities.dp(13.0f), (getMeasuredHeight() / 2.0f) + AndroidUtilities.dp(15.0f));
            }
            canvas2.save();
            float lerp = AndroidUtilities.lerp(0.6f, 1.0f, f12);
            canvas2.scale(lerp, lerp, this.f23251f.centerX(), this.f23251f.centerY());
            ...
            float f14 = alpha;
            org.telegram.ui.ActionBar.j6.f20806l2.setAlpha((int) (0.2f * f14 * f12));
            canvas2.drawArc(this.f23251f, -90.0f, 360.0f, false, org.telegram.ui.ActionBar.j6.f20806l2);
            org.telegram.ui.ActionBar.j6.f20806l2.setAlpha((int) (f14 * f12));
            canvas.drawArc(this.f23251f, -90.0f, e6Var.d(f13, false) * (-360.0f), false, org.telegram.ui.ActionBar.j6.f20806l2);
            ...
            float d10 = this.f23257y.d(f7, false);
            canvas.scale(d10, d10, this.f23251f.centerX(), this.f23251f.centerY());
            p6Var.r(v02);
            p6Var.f29303w = (int) (f12 * 255.0f);
            RectF rectF = this.f23251f;
            RectF rectF2 = this.f23251f;
    ...
    public void setHasLocation(boolean z10) {
        float f7;
        float f10;
        if (LocationController.getInstance(this.f23247a).getSharingLocationInfo(this.f23250e) == null) {
            float f11 = 0.5f;
            if (z10) {
                f7 = 1.0f;
            } else {
            ...
            this.f23249c.setAlpha(f7);
            if (z10) {
                f10 = 1.0f;
            } else {
                f10 = 0.5f;
            }
            this.f23248b.setAlpha(f10);
            if (z10) {
                f11 = 1.0f;
            }
            this.d.setAlpha(f11);
