...
public class f7 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public long L;
    public h01 M;
    public final org.telegram.ui.Components.u9 f20101a;
    public final ai.p4 f20102b;
    public final org.telegram.ui.ActionBar.k5 f20103c;
    public final np d;
    public final d7 e;
    public e7 f20104f;
    public TLRPC.User h;
    public final int f20105n;
    public float f20106r;
    public long f20107s;
    public long v;
    public boolean f20108w;
    public final int f20109x;
    public final org.telegram.ui.ActionBar.f6 f20110y;
    ...
    public f7(Context context, int i10, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        float f10;
        float f11;
        this.f20109x = UserConfig.selectedAccount;
        qr qrVar = qr.h;
        ...
        setBackground(org.telegram.ui.ActionBar.j6.Y(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f18953i6, f6Var), AndroidUtilities.dp(2.0f), AndroidUtilities.dp(2.0f)));
    }
    ...
    public final void c(long j3, boolean z10, CharSequence charSequence) {
        ...
        d7 d7Var = this.e;
        d7Var.f23839p = 1.0f;
        org.telegram.ui.ActionBar.f6 f6Var = this.f20110y;
        org.telegram.ui.Components.u9 u9Var = this.f20101a;
        ai.p4 p4Var = this.f20102b;
        if (j3 == Long.MAX_VALUE) {
            p4Var.setText(a());
            if (this.f20104f == null) {
                this.f20104f = new e7(getContext(), u9Var, true, f6Var);
            }
            u9Var.h(null, null, this.f20104f, null);
        } else {
    ...
    public final void d(TLRPC.TL_forumTopic tL_forumTopic, boolean z10, boolean z11) {
        ...
        org.telegram.ui.ActionBar.k5 k5Var = this.f20103c;
        ...
        if (z12) {
            if (z10) {
                k5Var.l(MessagesController.getInstance(this.f20109x).getPeerName(DialogObject.getPeerDialogId(tL_forumTopic.from_id)), false);
            } else {
        ...
        if (z11) {
            ...
            kVar2.b(new o1.g() {
                ...
                public final void a(o1.h hVar, float f11, float f12) {
                    ...
                    f7 f7Var = f7.this;
                    org.telegram.ui.ActionBar.k5 k5Var2 = f7Var.f20103c;
                    k5Var2.setAlpha(f13);
                    ai.p4 p4Var = f7Var.f20102b;
                    float f14 = 1.0f - f13;
                    p4Var.setAlpha(f14);
            ...
            kVar2.a(new o1.f() {
                ...
                public final void a(o1.h hVar, boolean z14, float f11, float f12) {
                    f7.this.f20103c.setTag(R.id.spring_tag, null);
                }
            });
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.userIsPremiumBlockedUpadted) {
            ...
            if (this.F != DialogObject.isPremiumBlocked(requirementToContact) || this.H != messagesStarsPrice) {
                ...
                this.f20102b.setTextColor(org.telegram.ui.ActionBar.j6.v0(i12, this.f20110y));
                invalidate();
            }
        }
    }
    ...
    public final void onAttachedToWindow() {
        ...
        NotificationCenter.getInstance(this.f20109x).addObserver(this, NotificationCenter.userIsPremiumBlockedUpadted);
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        NotificationCenter.getInstance(this.f20109x).removeObserver(this, NotificationCenter.userIsPremiumBlockedUpadted);
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        org.telegram.ui.ActionBar.j6.f19059o0.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.B5, this.f20110y));
        org.telegram.ui.ActionBar.j6.f19059o0.setAlpha((int) (this.d.getProgress() * 255.0f));
        if (this.f20105n == 2) {
            f7 = 24.0f;
        } else {
            f7 = 28.0f;
        ...
        canvas.drawRoundRect(rectF, u9Var.getRoundRadius()[0], u9Var.getRoundRadius()[0], org.telegram.ui.ActionBar.j6.f19059o0);
        super.onDraw(canvas);
    }
