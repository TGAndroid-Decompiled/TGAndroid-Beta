...
public class f7 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public long L;
    public g01 M;
    public final org.telegram.ui.Components.u9 f20071a;
    public final ai.p4 f20072b;
    public final org.telegram.ui.ActionBar.j5 f20073c;
    public final np d;
    public final d7 e;
    public e7 f20074f;
    public TLRPC.User h;
    public final int f20075n;
    public float f20076r;
    public long f20077s;
    public long v;
    public boolean f20078w;
    public final int f20079x;
    public final org.telegram.ui.ActionBar.e6 f20080y;
    ...
    public f7(Context context, int i10, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        float f10;
        float f11;
        this.f20079x = UserConfig.selectedAccount;
        qr qrVar = qr.h;
        ...
        this.d = npVar;
        npVar.b(org.telegram.ui.ActionBar.i6.B5, org.telegram.ui.ActionBar.i6.f18904h5, org.telegram.ui.ActionBar.i6.C5);
        ...
        setBackground(org.telegram.ui.ActionBar.i6.Y(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f18923i6, e6Var), AndroidUtilities.dp(2.0f), AndroidUtilities.dp(2.0f)));
    }
    ...
    public final void c(long j3, boolean z10, CharSequence charSequence) {
        ...
        d7 d7Var = this.e;
        d7Var.f23866p = 1.0f;
        org.telegram.ui.ActionBar.e6 e6Var = this.f20080y;
        org.telegram.ui.Components.u9 u9Var = this.f20071a;
        ai.p4 p4Var = this.f20072b;
        if (j3 == Long.MAX_VALUE) {
            p4Var.setText(a());
            if (this.f20074f == null) {
                this.f20074f = new e7(getContext(), u9Var, true, e6Var);
            }
            u9Var.h(null, null, this.f20074f, null);
        } else {
    ...
    public final void d(TLRPC.TL_forumTopic tL_forumTopic, boolean z10, boolean z11) {
        ...
        org.telegram.ui.ActionBar.j5 j5Var = this.f20073c;
        ...
        if (z12) {
            if (z10) {
                j5Var.l(MessagesController.getInstance(this.f20079x).getPeerName(DialogObject.getPeerDialogId(tL_forumTopic.from_id)), false);
            } else {
        ...
        if (z11) {
            ...
            kVar2.b(new o1.g() {
                ...
                public final void a(o1.h hVar, float f11, float f12) {
                    ...
                    f7 f7Var = f7.this;
                    org.telegram.ui.ActionBar.j5 j5Var2 = f7Var.f20073c;
                    j5Var2.setAlpha(f13);
                    ai.p4 p4Var = f7Var.f20072b;
                    float f14 = 1.0f - f13;
                    p4Var.setAlpha(f14);
            ...
            kVar2.a(new o1.f() {
                ...
                public final void a(o1.h hVar, boolean z14, float f11, float f12) {
                    f7.this.f20073c.setTag(R.id.spring_tag, null);
                }
            });
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.userIsPremiumBlockedUpadted) {
            TLRPC.User user = this.h;
            int i13 = this.f20079x;
            if (user != null) {
                requirementToContact = MessagesController.getInstance(i13).isUserContactBlocked(this.h.f18256id);
            } else {
            ...
            if (this.F != DialogObject.isPremiumBlocked(requirementToContact) || this.H != messagesStarsPrice) {
                ...
                this.f20072b.setTextColor(org.telegram.ui.ActionBar.i6.v0(i12, this.f20080y));
                invalidate();
            }
        }
    }
    ...
    public final void onAttachedToWindow() {
        ...
        NotificationCenter.getInstance(this.f20079x).addObserver(this, NotificationCenter.userIsPremiumBlockedUpadted);
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        NotificationCenter.getInstance(this.f20079x).removeObserver(this, NotificationCenter.userIsPremiumBlockedUpadted);
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        org.telegram.ui.ActionBar.i6.f19029o0.setColor(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.B5, this.f20080y));
        org.telegram.ui.ActionBar.i6.f19029o0.setAlpha((int) (this.d.getProgress() * 255.0f));
        if (this.f20075n == 2) {
            f7 = 24.0f;
        } else {
            f7 = 28.0f;
        ...
        canvas.drawRoundRect(rectF, u9Var.getRoundRadius()[0], u9Var.getRoundRadius()[0], org.telegram.ui.ActionBar.i6.f19029o0);
        super.onDraw(canvas);
    }
