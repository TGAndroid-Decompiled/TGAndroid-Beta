...
public class f7 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public long L;
    public f01 M;
    public final org.telegram.ui.Components.w9 f20040a;
    public final ai.p4 f20041b;
    public final org.telegram.ui.ActionBar.i5 f20042c;
    public final op d;
    public final d7 e;
    public e7 f20043f;
    public TLRPC.User h;
    ...
    public final org.telegram.ui.ActionBar.d6 f20049y;
    ...
    public f7(Context context, int i10, org.telegram.ui.ActionBar.d6 d6Var) {
        ...
        float f10;
        float f11;
        this.f20048x = UserConfig.selectedAccount;
        rr rrVar = rr.h;
        ...
        addView(i5Var, w7.x5.d(-1, -2.0f, 51, 6.0f, f10, 6.0f, 0.0f));
        op opVar = new op(context, 21, d6Var);
        this.d = opVar;
        opVar.b(org.telegram.ui.ActionBar.h6.B5, org.telegram.ui.ActionBar.h6.f18859h5, org.telegram.ui.ActionBar.h6.C5);
        ...
        addView(opVar, w7.x5.d(24, 24.0f, 49, 19.0f, f11, 0.0f, 0.0f));
        setBackground(org.telegram.ui.ActionBar.h6.Y(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f18878i6, d6Var), AndroidUtilities.dp(2.0f), AndroidUtilities.dp(2.0f)));
    }
    ...
    public final void c(long j3, boolean z10, CharSequence charSequence) {
        ...
        d7 d7Var = this.e;
        d7Var.f24590p = 1.0f;
        org.telegram.ui.ActionBar.d6 d6Var = this.f20049y;
        org.telegram.ui.Components.w9 w9Var = this.f20040a;
        ai.p4 p4Var = this.f20041b;
        if (j3 == Long.MAX_VALUE) {
            p4Var.setText(a());
            if (this.f20043f == null) {
                this.f20043f = new e7(getContext(), w9Var, true, d6Var);
            }
            w9Var.h(null, null, this.f20043f, null);
        } else {
    ...
    public final void d(TLRPC.TL_forumTopic tL_forumTopic, boolean z10, boolean z11) {
        ...
        org.telegram.ui.ActionBar.i5 i5Var = this.f20042c;
        ...
        if (z12) {
            if (z10) {
                i5Var.l(MessagesController.getInstance(this.f20048x).getPeerName(DialogObject.getPeerDialogId(tL_forumTopic.from_id)), false);
            } else {
        ...
        if (z11) {
            ...
            kVar2.b(new o1.g() {
                ...
                public final void a(o1.h hVar, float f11, float f12) {
                    ...
                    f7 f7Var = f7.this;
                    org.telegram.ui.ActionBar.i5 i5Var2 = f7Var.f20042c;
                    i5Var2.setAlpha(f13);
                    ai.p4 p4Var = f7Var.f20041b;
                    float f14 = 1.0f - f13;
                    p4Var.setAlpha(f14);
            ...
            kVar2.a(new o1.f() {
                ...
                public final void a(o1.h hVar, boolean z14, float f11, float f12) {
                    f7.this.f20042c.setTag(R.id.spring_tag, null);
                }
            });
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.userIsPremiumBlockedUpadted) {
            TLRPC.User user = this.h;
            int i13 = this.f20048x;
            if (user != null) {
                requirementToContact = MessagesController.getInstance(i13).isUserContactBlocked(this.h.f18230id);
            } else {
            ...
            if (this.F != DialogObject.isPremiumBlocked(requirementToContact) || this.H != messagesStarsPrice) {
                ...
                this.f20041b.setTextColor(org.telegram.ui.ActionBar.h6.v0(i12, this.f20049y));
                invalidate();
            }
        }
    }
    ...
    public final void onAttachedToWindow() {
        ...
        NotificationCenter.getInstance(this.f20048x).addObserver(this, NotificationCenter.userIsPremiumBlockedUpadted);
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        NotificationCenter.getInstance(this.f20048x).removeObserver(this, NotificationCenter.userIsPremiumBlockedUpadted);
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        org.telegram.ui.ActionBar.h6.f18984o0.setColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.B5, this.f20049y));
        org.telegram.ui.ActionBar.h6.f18984o0.setAlpha((int) (this.d.getProgress() * 255.0f));
        if (this.f20044n == 2) {
            f7 = 24.0f;
        } else {
            f7 = 28.0f;
        ...
        canvas.drawRoundRect(rectF, w9Var.getRoundRadius()[0], w9Var.getRoundRadius()[0], org.telegram.ui.ActionBar.h6.f18984o0);
        super.onDraw(canvas);
    }
