...
public final class o4 extends FrameLayout {
    public final org.telegram.ui.Components.u9 f20570a;
    public final org.telegram.ui.ActionBar.k5 f20571b;
    public final org.telegram.ui.ActionBar.k5 f20572c;
    public final org.telegram.ui.Components.f9 d;
    public final np e;
    public ContactsController.Contact f20573f;
    ...
    public final void a() {
        ContactsController.Contact contact = this.f20573f;
        if (contact == null) {
            return;
        }
        ...
        org.telegram.ui.ActionBar.k5 k5Var = this.f20571b;
        if (charSequence != null) {
            k5Var.l(charSequence, true);
        } else {
            ContactsController.Contact contact2 = this.f20573f;
        ...
        org.telegram.ui.ActionBar.k5 k5Var2 = this.f20572c;
        k5Var2.setTag(valueOf);
        k5Var2.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i10, false));
        ContactsController.Contact contact3 = this.f20573f;
        ...
        this.f20570a.setImageDrawable(f9Var);
    }
