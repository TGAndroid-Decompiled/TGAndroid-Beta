...
public final class o4 extends FrameLayout {
    public final org.telegram.ui.Components.u9 f20560a;
    public final org.telegram.ui.ActionBar.j5 f20561b;
    public final org.telegram.ui.ActionBar.j5 f20562c;
    public final org.telegram.ui.Components.f9 d;
    public final np e;
    public ContactsController.Contact f20563f;
    ...
    public final void a() {
        ContactsController.Contact contact = this.f20563f;
        if (contact == null) {
            return;
        }
        ...
        org.telegram.ui.ActionBar.j5 j5Var = this.f20561b;
        if (charSequence != null) {
            j5Var.l(charSequence, true);
        } else {
            ContactsController.Contact contact2 = this.f20563f;
        ...
        org.telegram.ui.ActionBar.j5 j5Var2 = this.f20562c;
        j5Var2.setTag(valueOf);
        j5Var2.setTextColor(org.telegram.ui.ActionBar.i6.w0(null, i10, false));
        ContactsController.Contact contact3 = this.f20563f;
        ...
        this.f20560a.setImageDrawable(f9Var);
    }
