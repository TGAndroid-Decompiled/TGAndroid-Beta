...
public class e4 extends FrameLayout {
    ...
    public final y3 V;
    public boolean W;
    public final c4 f20189a;
    public boolean f20190a0;
    public final org.telegram.ui.Components.w9 f20191b;
    public boolean f20192b0;
    public final org.telegram.ui.ActionBar.j5 f20193c;
    public final Drawable f20194c0;
    public final org.telegram.ui.ActionBar.j5[] d;
    public AnimatorSet f20195d0;
    public final org.telegram.ui.ActionBar.j5 e;
    public float f20196e0;
    public final lj0 f20197f;
    public final ij0 h;
    public final ij0 f20198n;
    public final org.telegram.ui.Components.o5 f20199r;
    public final org.telegram.ui.Components.o5 f20200s;
    public Drawable v;
    public Drawable f20201w;
    public final z3 f20202x;
    public final org.telegram.ui.Components.h9 f20203y;
    ...
    public e4(Context context) {
        ...
        this.R = new Runnable(this) {
            ...
            public final void run() {
                ...
                switch (r2) {
                    case 0:
                        e4 e4Var = this.f21839b;
                        e4Var.f20198n.S(0, null);
                        ij0 ij0Var = e4Var.h;
                        ij0Var.S(0, null);
                        e4Var.f20197f.setAnimation(ij0Var);
                        return;
                    case 1:
                        e4 e4Var2 = this.f21839b;
                        lj0 lj0Var = e4Var2.f20197f;
                        ij0 ij0Var2 = e4Var2.f20198n;
                        ...
                        return;
                    case 2:
                        this.f21839b.a(true, true);
                        return;
                    case 3:
                        e4 e4Var3 = this.f21839b;
                        e4Var3.f20190a0 = false;
                        e4Var3.a(true, true);
                        e4Var3.f20189a.c(0.0d);
                        e4Var3.W = false;
                        return;
                    default:
                        this.f21839b.a(true, true);
        ...
        this.T = org.telegram.ui.ActionBar.j6.f19329rg;
        ...
        this.I = paint;
        paint.setColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19125gg, false));
        this.f20203y = new org.telegram.ui.Components.h9((org.telegram.ui.ActionBar.e6) null);
        ...
        this.f20199r = new org.telegram.ui.Components.o5(AndroidUtilities.dp(20.0f), 9, j5Var, false);
        this.f20200s = new org.telegram.ui.Components.o5(AndroidUtilities.dp(20.0f), 9, j5Var, false);
        Drawable drawable = context.getResources().getDrawable(R.drawable.voice_volume_mini);
        this.f20194c0 = drawable;
        drawable.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19310qg, false), PorterDuff.Mode.MULTIPLY));
        int i21 = 0;
        while (true) {
            ...
            if (i21 == 4) {
                ...
                this.d[i21].setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19329rg, false));
                ...
                if (i21 == 0) {
                    this.d[i21].setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19292pg, false));
                    this.d[i21].k(LocaleController.getString(R.string.Listening));
                } else if (i21 == 1) {
                    this.d[i21].setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19310qg, false));
                    this.d[i21].k(LocaleController.getString(R.string.Speaking));
                    this.d[i21].setDrawablePadding(AndroidUtilities.dp(2.0f));
                } else if (i21 == 2) {
                    this.d[i21].setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19348sg, false));
        ...
        j5Var5.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19329rg, false));
        ...
        this.h = ij0Var;
        this.f20198n = new ij0(R.raw.hand_1, AndroidUtilities.dp(34.0f), AndroidUtilities.dp(32.0f), true, null);
        ?? imageView = new ImageView(context);
        this.f20197f = imageView;
        ...
        this.f20189a = new c4(AndroidUtilities.dp(26.0f), AndroidUtilities.dp(29.0f));
    ...
    public final void e(AccountInstance accountInstance, TLRPC.GroupCallParticipant groupCallParticipant, ChatObject.Call call, long j3, TLRPC.FileLocation fileLocation, boolean z10) {
        ...
        org.telegram.ui.ActionBar.j5 j5Var = this.f20193c;
        org.telegram.ui.Components.w9 w9Var = this.f20191b;
        org.telegram.ui.Components.h9 h9Var = this.f20203y;
        org.telegram.ui.Components.o5 o5Var = this.f20200s;
        if (peerId > 0) {
            ...
            if (user != null && user.verified) {
                ...
                if (user2 != null && user2.premium) {
                    if (this.f20201w == null) {
                        this.f20201w = getContext().getResources().getDrawable(R.drawable.msg_premium_liststar).mutate();
                        this.f20201w = new org.telegram.ui.Components.p5(AndroidUtilities.dp(14.0f), AndroidUtilities.dp(14.0f), this.f20201w);
                    }
                    o5Var.g(this.f20201w, z10);
                } else {
                    o5Var.g(null, z10);
                }
            }
        ...
        org.telegram.ui.Components.o5 o5Var2 = this.f20199r;
    ...
    public int getClipHeight() {
        ...
        if (TextUtils.isEmpty(j5Var.getText()) || !this.f20192b0) {
            j5Var = this.d[4];
        }
    ...
    public final void onDetachedFromWindow() {
        ...
        AnimatorSet animatorSet = this.f20195d0;
        if (animatorSet != null) {
            animatorSet.cancel();
        }
        org.telegram.ui.Components.o5 o5Var = this.f20200s;
    ...
    public void setProgressToAvatarPreview(float f7) {
        ...
        this.f20193c.setTranslationX(i10 * f7);
        boolean c10 = c();
        boolean z10 = true;
        org.telegram.ui.ActionBar.j5 j5Var = this.e;
        float f10 = 0.0f;
        ...
        this.f20191b.setAlpha(f10);
        this.f20189a.e(this, (this.f20190a0 && i13 == 0) ? false : false);
        float f12 = 1.0f - f7;
        lj0 lj0Var = this.f20197f;
        lj0Var.setAlpha(f12);
