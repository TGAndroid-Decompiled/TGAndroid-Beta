...
public class e4 extends FrameLayout {
    ...
    public final y3 V;
    public boolean W;
    public final c4 f20004a;
    public boolean f20005a0;
    public final org.telegram.ui.Components.u9 f20006b;
    public boolean f20007b0;
    public final org.telegram.ui.ActionBar.j5 f20008c;
    public final Drawable f20009c0;
    public final org.telegram.ui.ActionBar.j5[] d;
    public AnimatorSet f20010d0;
    public final org.telegram.ui.ActionBar.j5 e;
    public float f20011e0;
    public final aj0 f20012f;
    public final xi0 h;
    public final xi0 f20013n;
    public final org.telegram.ui.Components.m5 f20014r;
    public final org.telegram.ui.Components.m5 f20015s;
    public Drawable v;
    public Drawable f20016w;
    public final z3 f20017x;
    public final org.telegram.ui.Components.f9 f20018y;
    ...
    public e4(Context context) {
        ...
        this.R = new Runnable(this) {
            ...
            public final void run() {
                ...
                switch (r2) {
                    case 0:
                        e4 e4Var = this.f21648b;
                        e4Var.f20013n.S(0, null);
                        xi0 xi0Var = e4Var.h;
                        xi0Var.S(0, null);
                        e4Var.f20012f.setAnimation(xi0Var);
                        return;
                    case 1:
                        e4 e4Var2 = this.f21648b;
                        aj0 aj0Var = e4Var2.f20012f;
                        xi0 xi0Var2 = e4Var2.f20013n;
                        ...
                        xi0Var2.P(i19);
                        xi0Var2.S(i19 - 1, e4Var2.R);
                        aj0Var.setAnimation(xi0Var2);
                        xi0Var2.M(i18);
                        aj0Var.d();
                        return;
                    case 2:
                        this.f21648b.a(true, true);
                        return;
                    case 3:
                        e4 e4Var3 = this.f21648b;
                        e4Var3.f20005a0 = false;
                        e4Var3.a(true, true);
                        e4Var3.f20004a.c(0.0d);
                        e4Var3.W = false;
                        return;
                    default:
                        this.f21648b.a(true, true);
        ...
        this.T = org.telegram.ui.ActionBar.i6.f19099rg;
        ...
        this.f20018y = new org.telegram.ui.Components.f9((org.telegram.ui.ActionBar.e6) null);
        ...
        this.f20014r = new org.telegram.ui.Components.m5(AndroidUtilities.dp(20.0f), 9, j5Var, false);
        this.f20015s = new org.telegram.ui.Components.m5(AndroidUtilities.dp(20.0f), 9, j5Var, false);
        Drawable drawable = context.getResources().getDrawable(R.drawable.voice_volume_mini);
        this.f20009c0 = drawable;
        drawable.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f19080qg, false), PorterDuff.Mode.MULTIPLY));
        int i21 = 0;
        while (true) {
            ...
            if (i21 == 4) {
                ...
                this.d[i21].setTextColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f19099rg, false));
                ...
                if (i21 == 0) {
                    this.d[i21].setTextColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f19062pg, false));
                    this.d[i21].k(LocaleController.getString(R.string.Listening));
                } else if (i21 == 1) {
                    this.d[i21].setTextColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f19080qg, false));
                    this.d[i21].k(LocaleController.getString(R.string.Speaking));
                    this.d[i21].setDrawablePadding(AndroidUtilities.dp(2.0f));
                } else if (i21 == 2) {
                    this.d[i21].setTextColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f19118sg, false));
        ...
        j5Var5.setTextColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f19099rg, false));
        ...
        this.h = xi0Var;
        this.f20013n = new xi0(R.raw.hand_1, AndroidUtilities.dp(34.0f), AndroidUtilities.dp(32.0f), true, null);
        ?? imageView = new ImageView(context);
        this.f20012f = imageView;
        ...
        this.f20004a = new c4(AndroidUtilities.dp(26.0f), AndroidUtilities.dp(29.0f));
    ...
    public final void e(AccountInstance accountInstance, TLRPC.GroupCallParticipant groupCallParticipant, ChatObject.Call call, long j3, TLRPC.FileLocation fileLocation, boolean z10) {
        ...
        org.telegram.ui.ActionBar.j5 j5Var = this.f20008c;
        org.telegram.ui.Components.u9 u9Var = this.f20006b;
        org.telegram.ui.Components.f9 f9Var = this.f20018y;
        org.telegram.ui.Components.m5 m5Var = this.f20015s;
        if (peerId > 0) {
            ...
            if (user != null && user.verified) {
                ...
                if (user2 != null && user2.premium) {
                    if (this.f20016w == null) {
                        this.f20016w = getContext().getResources().getDrawable(R.drawable.msg_premium_liststar).mutate();
                        this.f20016w = new org.telegram.ui.Components.n5(AndroidUtilities.dp(14.0f), AndroidUtilities.dp(14.0f), this.f20016w);
                    }
                    m5Var.g(this.f20016w, z10);
                } else {
                    m5Var.g(null, z10);
                }
            }
        ...
        org.telegram.ui.Components.m5 m5Var2 = this.f20014r;
    ...
    public int getClipHeight() {
        ...
        if (TextUtils.isEmpty(j5Var.getText()) || !this.f20007b0) {
            j5Var = this.d[4];
        }
    ...
    public final void onDetachedFromWindow() {
        ...
        AnimatorSet animatorSet = this.f20010d0;
        if (animatorSet != null) {
            animatorSet.cancel();
        }
        org.telegram.ui.Components.m5 m5Var = this.f20015s;
    ...
    public void setProgressToAvatarPreview(float f7) {
        ...
        this.f20008c.setTranslationX(i10 * f7);
        boolean c10 = c();
        boolean z10 = true;
        org.telegram.ui.ActionBar.j5 j5Var = this.e;
        float f10 = 0.0f;
        ...
        this.f20006b.setAlpha(f10);
        this.f20004a.e(this, (this.f20005a0 && i13 == 0) ? false : false);
        float f12 = 1.0f - f7;
        aj0 aj0Var = this.f20012f;
        aj0Var.setAlpha(f12);
