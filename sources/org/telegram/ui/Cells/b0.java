...
public abstract class b0 extends View {
    public final org.telegram.ui.ActionBar.e6 f19807a;
    public final c0 f19808b;
    public final b21 f19809c;
    public int d;
    public float e;
    ...
    public b0(Context context, int i10, org.telegram.ui.ActionBar.e6 e6Var) {
        super(context);
        this.f19807a = e6Var;
        this.f19808b = new c0(context, i10, e6Var);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float f10 = f7 / 2.0f;
        org.telegram.ui.ActionBar.e6 e6Var = this.f19807a;
        if (e6Var != null) {
            e6Var.m(f10, this.e, measuredWidth2, this.d);
        } else {
            org.telegram.ui.ActionBar.i6.q(f10, this.e, measuredWidth2, this.d);
        }
        this.f19809c.c(canvas, getWidth(), f7, 0.0f, 1.0f, 1.0f, false);
        c0Var.setBounds(i10, dp, c0Var.h + i10, c0Var.f19839i + dp);
        c0Var.draw(canvas);
    }

    @Override
    public final void onMeasure(int i10, int i11) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i10), 1073741824), vl.C(40.0f, this.f19808b.f19839i, 1073741824));
    }

    public void setDialogId(long j3) {
        c0 c0Var = this.f19808b;
        g01 g01Var = c0Var.d;
        TLRPC.User user = MessagesController.getInstance(c0Var.f19835b).getUser(Long.valueOf(j3));
        g01 g01Var2 = c0Var.e;
        g01Var2.n(1);
        g01Var2.q(9999.0f);
        ...
        if (g01Var2.f24145b.getLineCount() > 2) {
        ...
        float j11 = g01Var2.j();
        c0Var.h = (int) min;
        c0Var.f19839i = (int) (j11 + j10 + AndroidUtilities.dp(17.0f) + 0.0f + AndroidUtilities.dp(70.0f) + AndroidUtilities.dp(14.0f) + AndroidUtilities.dp(4.0f) + AndroidUtilities.dp(2.0f) + AndroidUtilities.dp(20.0f) + AndroidUtilities.dp(5.0f));
    }
}
