...
public abstract class pa extends ll0 implements NotificationCenter.NotificationCenterDelegate {
    public static final byte[] f22494i3 = new byte[1024];
    public boolean X2;
    public final hg.b0 Y2;
    public final HashMap Z2;
    public final HashMap f22495a3;
    public org.telegram.ui.ActionBar.i6 f22496b3;
    public final oa f22497c3;
    public final ArrayList f22498d3;
    public final ArrayList f22499e3;
    public final int f22500f3;
    public int f22501g3;
    public final org.telegram.ui.ActionBar.n2 f22502h3;

    public pa(Context context, org.telegram.ui.ActionBar.n2 n2Var, int i10, ArrayList arrayList, ArrayList arrayList2) {
        super(context, null);
        this.Z2 = new HashMap();
        this.f22495a3 = new HashMap();
        this.f22498d3 = arrayList2;
        this.f22499e3 = arrayList;
        this.f22500f3 = i10;
        this.f22502h3 = n2Var;
        if (i10 == 2) {
        ...
        setOnItemClickListener(new zk0() {
            ...
            public final void a(int i11, View view) {
                pa paVar = pa.this;
                paVar.getClass();
                paVar.x1(((ThemesHorizontalListCell$InnerThemeView) view).f21608b);
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.fileLoaded) {
            ...
            if (i6Var != null) {
                this.Z2.remove(str);
                if (this.f22495a3.remove(i6Var) != null) {
    ...
    public final void v1(org.telegram.ui.ActionBar.i6 i6Var) {
        ...
        for (int i10 = 0; i10 < childCount; i10++) {
            ...
            if (childAt instanceof ThemesHorizontalListCell$InnerThemeView) {
                ...
                if (themesHorizontalListCell$InnerThemeView.f21608b == i6Var && themesHorizontalListCell$InnerThemeView.c()) {
                    themesHorizontalListCell$InnerThemeView.f21608b.U = true;
    ...
    public final void w1(int i10) {
        ...
        if (i10 != 0) {
            ...
            this.f22496b3 = A0;
            ArrayList arrayList = this.f22499e3;
            int indexOf = arrayList.indexOf(A0);
            if (indexOf < 0 && (indexOf = this.f22498d3.indexOf(this.f22496b3) + arrayList.size()) < 0) {
                return;
            }
    ...
    public final void x1(org.telegram.ui.ActionBar.i6 i6Var) {
        ...
        if (tL_theme != null) {
            if (i6Var.U) {
                if (tL_theme.document == null) {
                    org.telegram.ui.ActionBar.n2 n2Var = this.f22502h3;
                    if (n2Var != null) {
        ...
        for (int i10 = 0; i10 < childCount; i10++) {
            ...
            if (childAt instanceof ThemesHorizontalListCell$InnerThemeView) {
                ThemesHorizontalListCell$InnerThemeView themesHorizontalListCell$InnerThemeView = (ThemesHorizontalListCell$InnerThemeView) childAt;
                if (themesHorizontalListCell$InnerThemeView.f21607a0.f22500f3 == 1) {
                    A0 = org.telegram.ui.ActionBar.j6.J;
                } else {
                    A0 = org.telegram.ui.ActionBar.j6.A0();
                }
                RadioButton radioButton = themesHorizontalListCell$InnerThemeView.f21606a;
                if (themesHorizontalListCell$InnerThemeView.f21608b == A0) {
                    z10 = true;
                } else {
                    z10 = false;
                }
        ...
        if (this.f22500f3 != 1) {
            org.telegram.ui.ActionBar.j6.F1(this.f22502h3);
        }
    }
