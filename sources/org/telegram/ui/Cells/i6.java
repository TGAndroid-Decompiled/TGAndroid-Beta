...
public final class i6 extends a0 implements NotificationCenter.NotificationCenterDelegate, org.telegram.ui.ActionBar.x5 {
    ...
    public CharSequence f20443n;
    public boolean f20444n0;
    public long f20445o0;
    public boolean f20446p0;
    public int f20447q0;
    public final ImageReceiver f20448r;
    public StaticLayout f20449r0;
    public final org.telegram.ui.Components.h9 f20450s;
    public final org.telegram.ui.Components.o5 f20451s0;
    public final org.telegram.ui.Components.o5 f20452t0;
    public final ai.ca f20453u0;
    ...
    public final yc f20460y0;
    public final RectF f20461z0;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.emojiLoaded) {
            ...
            TLRPC.User user = this.f20459y;
            TL_account.RequirementToContact requirementToContact = null;
            int i12 = this.N;
            if (user != null) {
                if (this.f20442l0) {
                    requirementToContact = MessagesController.getInstance(i12).isUserContactBlocked(this.f20459y.f18482id);
                }
            } else {
                ...
                if (chat != null) {
                    ...
                    if (contact != null) {
                        if (this.f20442l0 && contact.user != null) {
                            requirementToContact = MessagesController.getInstance(i12).isUserContactBlocked(this.G.user.f18482id);
                        }
                    } else {
                        return;
                    }
            ...
            if (this.f20444n0 != DialogObject.isPremiumBlocked(requirementToContact) || this.f20445o0 != DialogObject.getMessagesStarsPrice(requirementToContact)) {
                this.f20444n0 = DialogObject.isPremiumBlocked(requirementToContact);
                this.f20445o0 = DialogObject.getMessagesStarsPrice(requirementToContact);
                invalidate();
            }
        }
    }
    ...
    public final void onAttachedToWindow() {
        ...
        this.f20448r.onAttachedToWindow();
    ...
    public final void onDetachedFromWindow() {
        ...
        this.f20448r.onDetachedFromWindow();
    ...
    public final void r() {
        ...
        if (encryptedChat != null) {
            this.R = true;
            this.H = DialogObject.makeEncryptedDialogId(encryptedChat.f18343id);
            if (!LocaleController.isRTL) {
                this.S = AndroidUtilities.dp(AndroidUtilities.leftBaseline);
                this.O = org.telegram.ui.ActionBar.h6.f18998a1.getIntrinsicWidth() + AndroidUtilities.dp(AndroidUtilities.leftBaseline + 4);
            } else {
                this.S = (getMeasuredWidth() - AndroidUtilities.dp(AndroidUtilities.leftBaseline + 2)) - org.telegram.ui.ActionBar.h6.f18998a1.getIntrinsicWidth();
            ...
            if (chat2 != null) {
                ...
                v(this.f20441k0, null, this.E, false);
            } else {
                TLRPC.User user = this.f20459y;
                if (user != null) {
                    this.H = user.f18482id;
                    if (!LocaleController.isRTL) {
                        this.O = AndroidUtilities.dp(AndroidUtilities.leftBaseline);
                    } else {
                        this.O = AndroidUtilities.dp(11.0f);
                    ...
                    this.f20441k0 = this.f20459y.verified;
                    if (!this.L) {
                        MessagesController.getInstance(i12).isPremiumUser(this.f20459y);
                    }
                    v(this.f20441k0, this.f20459y, null, false);
                } else if (this.G != null) {
                    this.H = 0L;
                    if (!LocaleController.isRTL) {
                        this.O = AndroidUtilities.dp(AndroidUtilities.leftBaseline);
        ...
        if (!LocaleController.isRTL) {
            this.f20447q0 = AndroidUtilities.dp(AndroidUtilities.leftBaseline);
        } else {
            this.f20447q0 = AndroidUtilities.dp(11.0f);
        }
        ...
        CharSequence charSequence2 = this.f20443n;
        ...
        if (chat3 != null) {
            ...
            if (chat3.monoforum) {
                ...
                if (chat4 != null) {
                    ...
                    spannableStringBuilder2.setSpan(new a10(LocaleController.getString(R.string.MonoforumSpan), org.telegram.ui.ActionBar.h6.f19442y6, d6Var), length, spannableStringBuilder2.length(), 33);
        ...
        if (TextUtils.isEmpty(replaceNewLines)) {
            TLRPC.User user3 = this.f20459y;
            if (user3 != null && !TextUtils.isEmpty(user3.phone)) {
                replaceNewLines = ok.h(new StringBuilder("+"), this.f20459y.phone, gf.b.c());
            } else {
        ...
        if (this.G != null) {
            ...
            if (!LocaleController.isRTL) {
                this.f20430a0 = ((getMeasuredWidth() - measureText) - AndroidUtilities.dp(19.0f)) - AndroidUtilities.dp(16.0f);
            } else {
                this.f20430a0 = AndroidUtilities.dp(16.0f) + AndroidUtilities.dp(19.0f);
                this.O += measureText;
                this.f20447q0 += measureText;
            }
        ...
        if (this.f20433d0) {
            ...
            if (dialogUnreadCount != 0) {
                this.f20434e0 = dialogUnreadCount;
                ...
                f7 = 0.0f;
                f10 = 12.0f;
                this.f20438h0 = Math.max(AndroidUtilities.dp(12.0f), (int) Math.ceil(org.telegram.ui.ActionBar.h6.L0.measureText(sb3)));
                this.f20439i0 = new StaticLayout(sb3, org.telegram.ui.ActionBar.h6.L0, this.f20438h0, Layout.Alignment.ALIGN_CENTER, 1.0f, 0.0f, false);
                int dp3 = AndroidUtilities.dp(18.0f) + this.f20438h0;
                this.U -= dp3;
                paddingRight -= dp3;
                if (!LocaleController.isRTL) {
                    this.f20437g0 = (getMeasuredWidth() - this.f20438h0) - AndroidUtilities.dp(19.0f);
                } else {
                    this.f20437g0 = AndroidUtilities.dp(19.0f);
                    this.O += dp3;
                    this.f20447q0 += dp3;
                }
            } else {
        ...
        if (chat5 != null && this.v == null) {
            ...
            if (charSequence5 == null) {
                        ...
                        if (z10 && (i10 = user5.bot_active_users) != 0) {
                            ...
                            if (j3 == 489000) {
                                ...
                                if (this.f20440j0 == null) {
                                    this.f20440j0 = new boolean[1];
                                }
                                boolean[] zArr = this.f20440j0;
                                zArr[0] = false;
                                charSequence5 = LocaleController.formatUserStatus(i12, this.f20459y, zArr);
                                if (this.f20440j0[0]) {
                                    textPaint5 = org.telegram.ui.ActionBar.h6.P0;
                                }
                                TLRPC.User user6 = this.f20459y;
                                if (user6 != null && (user6.f18482id == UserConfig.getInstance(i12).getClientUserId() || ((userStatus = this.f20459y.status) != null && userStatus.expires > ConnectionsManager.getInstance(i12).getCurrentTime()))) {
                                    textPaint5 = org.telegram.ui.ActionBar.h6.P0;
                ...
                if (!this.L || UserObject.isReplyUser(this.f20459y)) {
        ...
        if (this.E0) {
            ...
            if (textPaint5 == org.telegram.ui.ActionBar.h6.Q0) {
                ...
                this.G0.setColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19278p6, d6Var));
            }
            textPaint5 = this.G0;
        }
        if (!TextUtils.isEmpty(charSequence)) {
            i11 = i13;
            this.f20449r0 = new StaticLayout(TextUtils.ellipsize(charSequence, textPaint5, i13 - AndroidUtilities.dp(f10), truncateAt), textPaint5, i13, alignment, 1.0f, 0.0f, false);
        ...
        if (LocaleController.isRTL) {
            ...
            StaticLayout staticLayout = this.f20449r0;
            if (staticLayout != null && staticLayout.getLineCount() > 0 && this.f20449r0.getLineLeft(0) == f7) {
                double ceil2 = Math.ceil(this.f20449r0.getLineWidth(0));
                double d11 = i11;
                if (ceil2 < d11) {
                    this.f20447q0 = (int) ((d11 - ceil2) + this.f20447q0);
                }
            }
        } else {
            ...
            StaticLayout staticLayout2 = this.f20449r0;
            if (staticLayout2 != null && staticLayout2.getLineCount() > 0 && this.f20449r0.getLineRight(0) == i11) {
                double ceil4 = Math.ceil(this.f20449r0.getLineWidth(0));
                double d13 = i11;
                if (ceil4 < d13) {
                    this.f20447q0 = (int) (this.f20447q0 - (d13 - ceil4));
                }
            }
        }
        this.O = getPaddingLeft() + this.O;
        this.f20447q0 = getPaddingLeft() + this.f20447q0;
    ...
    public final void t(Object obj, TLRPC.EncryptedChat encryptedChat, CharSequence charSequence, CharSequence charSequence2, boolean z10, boolean z11) {
        boolean z12;
        this.f20443n = charSequence;
        boolean z13 = obj instanceof TLRPC.User;
        int i10 = this.N;
        TL_account.RequirementToContact requirementToContact = null;
        if (z13) {
            this.f20459y = (TLRPC.User) obj;
            this.E = null;
            this.G = null;
            if (this.f20442l0) {
                requirementToContact = MessagesController.getInstance(i10).isUserContactBlocked(this.f20459y.f18482id);
            }
            this.f20444n0 = DialogObject.isPremiumBlocked(requirementToContact);
            this.f20445o0 = DialogObject.getMessagesStarsPrice(requirementToContact);
            if (this.B0 && this.f20459y.bot_has_main_app) {
                z12 = true;
            } else {
                z12 = false;
            }
            ...
            this.f20444n0 = DialogObject.isPremiumBlocked(requirementToContact2);
            this.f20445o0 = DialogObject.getMessagesStarsPrice(requirementToContact2);
            ...
            this.f20459y = null;
            if (this.f20442l0 && contact.user != null) {
                requirementToContact = MessagesController.getInstance(i10).isUserContactBlocked(this.G.user.f18482id);
            }
            this.f20444n0 = DialogObject.isPremiumBlocked(requirementToContact);
            this.f20445o0 = DialogObject.getMessagesStarsPrice(requirementToContact);
            setOpenBotButton(false);
    ...
    public final void v(boolean z10, TLRPC.User user, TLRPC.Chat chat, boolean z11) {
        ...
        if (z13 && z10) {
            ...
            o5Var.k(Integer.valueOf(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19464z9, d6Var)));
        ...
        org.telegram.ui.Components.o5 o5Var2 = this.f20451s0;
        if (j3 != 0 && !this.L) {
            o5Var2.j(j3, z11);
        } else {
            o5Var2.g(null, z11);
        }
        o5Var2.k(Integer.valueOf(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19464z9, d6Var)));
    }

    @Override
    public final boolean verifyDrawable(Drawable drawable) {
        if (this.f20452t0 != drawable && this.f20451s0 != drawable && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
