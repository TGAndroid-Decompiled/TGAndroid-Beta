...
public final class i4 implements DownloadController.FileDownloadProgressListener {
    ...
    public int f22085c;
    public int d;
    public final t1 f22086e;
    public final ImageReceiver f22087f;
    public boolean h;
    public final int f22088n;
    public final int f22089r;
    public final float[] f22090s = new float[8];
    public String v;
    ...
    public i4(t1 t1Var, MessageObject messageObject, TLRPC.MessageExtendedMedia messageExtendedMedia, boolean z10, int i10, int i11) {
        ...
        if (messageExtendedMedia instanceof TLRPC.TL_messageExtendedMedia) {
            ...
            this.f22092x = ((messageMedia instanceof TLRPC.TL_messageMediaDocument) && MessageObject.isVideoDocument(messageMedia.document)) ? false : false;
            ...
            this.f22092x = (4 & tL_messageExtendedMediaPreview.flags) != 0;
    ...
    public final void c(TLRPC.MessageExtendedMedia messageExtendedMedia, MessageObject messageObject) {
        ...
        if (this.E != messageExtendedMedia) {
            ...
            this.f22093y = false;
            int i10 = this.f22088n;
            int i11 = this.f22089r;
            String k10 = a4.a.k(i10, i11, "_");
            boolean z11 = messageExtendedMedia instanceof TLRPC.TL_messageExtendedMediaPreview;
            ImageReceiver imageReceiver = this.f22087f;
            if (z11) {
                this.h = true;
                this.v = null;
                this.f22087f.setImage(ImageLocation.getForObject(((TLRPC.TL_messageExtendedMediaPreview) messageExtendedMedia).thumb, messageObject.messageOwner), p6.t(k10, "_b2"), null, null, messageObject, 0);
                ...
                if (messageMedia instanceof TLRPC.TL_messageMediaPhoto) {
                    ...
                    this.f22087f.setImage(ImageLocation.getForPhoto(closestPhotoSizeWithSize, tL_messageMediaPhoto.photo), k10, ImageLocation.getForPhoto(FileLoader.getClosestPhotoSizeWithSize(tL_messageMediaPhoto.photo.sizes, Math.min(i10, i11) / 100, false, closestPhotoSizeWithSize, false), tL_messageMediaPhoto.photo), k10, 0L, null, messageObject, 0);
                } else if (messageMedia instanceof TLRPC.TL_messageMediaDocument) {
                    TLRPC.TL_messageMediaDocument tL_messageMediaDocument = (TLRPC.TL_messageMediaDocument) messageMedia;
                    boolean z13 = this.h;
                    boolean z14 = this.f22092x;
                    boolean z15 = this.f22091w;
                    ...
                    if (!z15 && z14 && (document = tL_messageMediaDocument.document) != null) {
                        ...
                        u10.append(str);
                        String str2 = k10;
                        this.f22087f.setImage(imageLocation, u10.toString(), forDocument2, str2, forDocument3, str2, null, 0L, null, messageObject, 0);
                        return;
                    }
                    ...
                    if (document2 != null) {
                        ...
                        this.f22087f.setImage(ImageLocation.getForDocument(closestPhotoSizeWithSize4, tL_messageMediaDocument.document), k10, ImageLocation.getForDocument(FileLoader.getClosestPhotoSizeWithSize(tL_messageMediaDocument.document.thumbs, Math.min(i10, i11), false, closestPhotoSizeWithSize4, false), tL_messageMediaDocument.document), k10, 0L, null, messageObject, 0);
                    }
                }
            }
        }
