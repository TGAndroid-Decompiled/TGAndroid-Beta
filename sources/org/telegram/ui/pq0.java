...
public final class pq0 extends tu0 {
    ...
    public final dv0 E(MessageObject messageObject, TLRPC.FileLocation fileLocation, int i10, boolean z10, boolean z11) {
        ...
        org.telegram.ui.Cells.s5 V = ar0.V(ar0Var, i10);
        if (V != null) {
    ...
    @Override
    public final int H() {
        return this.f36669a.f31910b.size();
    }
    ...
    public final int Q(Object obj) {
        ...
        ar0 ar0Var = this.f36669a;
        if (!ar0Var.f31910b.containsKey(obj2)) {
            return -1;
        }
        ar0Var.f31910b.remove(obj2);
        int indexOf = ar0Var.f31912c.indexOf(obj2);
        if (indexOf >= 0) {
            ar0Var.f31912c.remove(indexOf);
        }
        if (ar0Var.e) {
            ar0Var.h0();
        }
    ...
    public final void W(int i10) {
        ...
        if (V != null) {
            ...
            V.e((MediaController.SearchImage) ar0Var.f31916f.get(i10));
        }
    }
    ...
    public final ArrayList c() {
        return this.f36669a.f31912c;
    }

    @Override
    public final ImageReceiver.BitmapHolder j(int i10) {
        org.telegram.ui.Cells.s5 V = ar0.V(this.f36669a, i10);
        if (V != null) {
    ...
    public final int k(int i10, VideoEditedInfo videoEditedInfo) {
        ...
        if (albumEntry != null) {
            ...
            if (Y == -1) {
                ...
                Y = ar0Var.f31912c.indexOf(Integer.valueOf(photoEntry.imageId));
                z10 = true;
            } else {
                photoEntry.editedInfo = null;
                z10 = false;
            }
        } else if (i10 < 0 || i10 >= ar0Var.f31916f.size()) {
            return -1;
        } else {
            ...
            if (Y == -1) {
                ...
                Y = ar0Var.f31912c.indexOf(searchImage.f15597id);
                z10 = true;
            } else {
    ...
    public final void o(int i10, VideoEditedInfo videoEditedInfo, boolean z10, int i11, int i12, boolean z11) {
        ar0 ar0Var = this.f36669a;
        ArrayList arrayList = ar0Var.f31916f;
        MediaController.AlbumEntry albumEntry = ar0Var.J;
        if (ar0Var.f31910b.isEmpty()) {
            if (albumEntry != null) {
                if (i10 >= 0 && i10 < albumEntry.photos.size()) {
                    MediaController.PhotoEntry photoEntry = albumEntry.photos.get(i10);
                    photoEntry.editedInfo = videoEditedInfo;
    ...
    public final boolean x(int i10) {
        ...
        MediaController.AlbumEntry albumEntry = ar0Var.J;
        if (albumEntry != null) {
            if (i10 < 0 || i10 >= albumEntry.photos.size() || !ar0Var.f31910b.containsKey(Integer.valueOf(ar0Var.J.photos.get(i10).imageId))) {
                return false;
            }
            return true;
        } else if (i10 < 0 || i10 >= ar0Var.f31916f.size() || !ar0Var.f31910b.containsKey(((MediaController.SearchImage) ar0Var.f31916f.get(i10)).f15597id)) {
            return false;
        } else {
            return true;
        }
