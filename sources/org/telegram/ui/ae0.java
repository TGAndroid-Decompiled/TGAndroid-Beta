...
public final class ae0 implements Runnable {
    public final int f31835a = 0;
    public final ie0 f31836b;
    public final TLRPC.TL_error f31837c;
    public final TLObject d;
    public final String e;

    public ae0(ie0 ie0Var, TLRPC.TL_error tL_error, String str, TLObject tLObject) {
        this.f31836b = ie0Var;
        this.f31837c = tL_error;
        this.e = str;
        this.d = tLObject;
    }
    ...
    public final void run() {
        ...
        switch (this.f31835a) {
            case 0:
                final ie0 ie0Var = this.f31836b;
                fe0 fe0Var = ie0Var.f34541a;
                yg0 yg0Var = ie0Var.W;
                yg0Var.k1(false, true);
                TLRPC.TL_error tL_error = this.f31837c;
                String str = this.e;
                if (tL_error == null) {
                    ie0Var.E = false;
                ...
                return;
            default:
                final ie0 ie0Var2 = this.f31836b;
                ie0Var2.E = false;
                yg0 yg0Var2 = ie0Var2.W;
                yg0Var2.v1(false, true);
                TLRPC.TL_error tL_error2 = this.f31837c;
                if (tL_error2 == null) {
