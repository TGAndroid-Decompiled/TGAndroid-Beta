...
public final class ae0 extends org.telegram.ui.Components.gw0 {
    public boolean E;
    ...
    public boolean V;
    public final qg0 W;
    public final xd0 f32136a;
    public final TextView f32137b;
    public final vh.n f32138c;
    public final TextView d;
    public final FrameLayout e;
    public final TextView f32139f;
    public final FrameLayout h;
    public final ai.p4 f32140n;
    public final ai.p4 f32141r;
    public final TextView f32142s;
    public final org.telegram.ui.Components.v90 v;
    public final org.telegram.ui.Components.mj0 f32143w;
    public boolean f32144x;
    public Bundle f32145y;
    ...
    public final void j() {
        if (this.f32144x) {
            ...
            AndroidUtilities.runOnUIThread(new td0(this, 8), qg0.f36883t0);
        }
    }
    ...
    public final void k(Bundle bundle) {
        ...
        this.f32145y = bundle2;
        if (bundle2 != null) {
            m(bundle2, true);
        }
        String string = bundle.getString("emailcode_code");
        if (string != null) {
            this.f32136a.setText(string);
        }
    }

    @Override
    public final void l(Bundle bundle) {
        String code = this.f32136a.getCode();
        if (code != null && code.length() != 0) {
            bundle.putString("emailcode_code", code);
        }
        Bundle bundle2 = this.f32145y;
        if (bundle2 != null) {
    ...
    public final void m(Bundle bundle, boolean z10) {
        ...
        if (bundle != null) {
            ...
            this.M = this.f32145y.getString("phoneHash");
            this.I = this.f32145y.getString("phone");
            this.J = this.f32145y.getString("ephone");
            this.N = this.f32145y.getBoolean("setup");
            this.O = this.f32145y.getInt("length");
            this.K = this.f32145y.getString("email");
            this.G = this.f32145y.getInt("resetAvailablePeriod");
            this.H = this.f32145y.getInt("resetPendingDate");
            qg0 qg0Var = this.W;
            int i12 = qg0Var.F;
            int i13 = 8;
            FrameLayout frameLayout = this.h;
            vh.n nVar = this.f32138c;
            if (i12 == 3) {
                ...
                this.f32140n.setVisibility(i10);
                if (this.H != 0) {
                    i11 = 0;
                } else {
                    i11 = 8;
                }
                this.f32141r.setVisibility(i11);
                if (this.H != 0) {
                    r();
                }
            }
            ...
            if (!this.N && qg0Var.F != 3) {
                String string = this.f32145y.getString("emailPattern");
                ...
                if (indexOf != lastIndexOf && indexOf != -1 && lastIndexOf != -1) {
                    ...
                    obj.f23184c = i15;
                    spannableStringBuilder.setSpan(new org.telegram.ui.Components.d11(obj, 0), indexOf, i15, 0);
                }
            ...
            qg0.T0(qg0Var, xd0Var.f40236f[0]);
            xd0Var.requestFocus();
    ...
    @Override
    public final void n() {
        this.f32137b.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.G6, false));
        int i10 = org.telegram.ui.ActionBar.h6.D6;
        this.f32138c.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, i10, false));
        int i11 = org.telegram.ui.ActionBar.h6.q6;
        this.d.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, i11, false));
        this.v.a();
        this.f32139f.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, i11, false));
        this.f32140n.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, i11, false));
        this.f32141r.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, i10, false));
        this.f32142s.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19298q7, false));
        this.f32136a.invalidate();
    }
    ...
    public final void o(Runnable runnable) {
        ...
        while (true) {
            ...
            if (i10 < asVarArr.length) {
                ...
                xd0Var.postDelayed(new n80(16, this, runnable), (asVarArr.length * 75) + 400);
                return;
            }
        }
    }
    ...
    public final void q(boolean z10) {
        boolean z11;
        float f7;
        AndroidUtilities.updateViewVisibilityAnimated(this.f32139f, z10);
        ...
        org.telegram.ui.Components.v90 v90Var = this.v;
        if (v90Var.getVisibility() != 8) {
            if (z10) {
                f7 = 8.0f;
            } else {
                f7 = 16.0f;
            }
            v90Var.setLayoutParams(w7.y5.d(-1, 16.0f, 17, 0.0f, 0.0f, 0.0f, f7));
            v90Var.requestLayout();
        }
    }
