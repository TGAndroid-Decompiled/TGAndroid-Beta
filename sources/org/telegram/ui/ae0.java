...
public final class ae0 implements Runnable {
    public final int f31839a = 0;
    public final ie0 f31840b;
    public final TLRPC.TL_error f31841c;
    public final TLObject d;
    public final String e;

    public ae0(ie0 ie0Var, TLRPC.TL_error tL_error, String str, TLObject tLObject) {
        this.f31840b = ie0Var;
        this.f31841c = tL_error;
        this.e = str;
        this.d = tLObject;
    }
    ...
    public final void run() {
        ...
        switch (this.f31839a) {
            case 0:
                final ie0 ie0Var = this.f31840b;
                fe0 fe0Var = ie0Var.f34546a;
                yg0 yg0Var = ie0Var.W;
                yg0Var.k1(false, true);
                TLRPC.TL_error tL_error = this.f31841c;
                String str = this.e;
                if (tL_error == null) {
                    ie0Var.E = false;
                    ...
                    if (tL_error.text.contains("EMAIL_ADDRESS_INVALID")) {
                        ...
                        while (true) {
                            ...
                            if (i11 < isVarArr.length) {
                                isVarArr[i11].setText("");
                                fe0Var.f33753f[i11].i(1.0f);
                                i11++;
                            } else {
                ...
                return;
            default:
                final ie0 ie0Var2 = this.f31840b;
                ie0Var2.E = false;
                yg0 yg0Var2 = ie0Var2.W;
                yg0Var2.v1(false, true);
                TLRPC.TL_error tL_error2 = this.f31841c;
                if (tL_error2 == null) {
