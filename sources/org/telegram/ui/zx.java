...
public final class zx extends org.telegram.ui.Components.lo0 {
    ...
    public final yf.y f40589a1;
    public final qy f40590b1;
    ...
    public zx(qy qyVar, Activity activity, qy qyVar2, int i10, int i11, int i12, long j3, vx vxVar) {
        ...
        this.f40590b1 = qyVar;
        this.Z0 = new yf.y(2);
        this.f40589a1 = new yf.y(8);
    }

    public final void S(int i10, int i11) {
        qy qyVar;
        ah.h hVar;
        if (Build.VERSION.SDK_INT >= 31 && (hVar = (qyVar = this.f40590b1).f37067k4) != null) {
            hVar.f(i10, i11);
            qyVar.m3();
        }
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        qy qyVar = this.f40590b1;
        if (qyVar.f37012a0 != null || qyVar.X2 != 0) {
            int dp = AndroidUtilities.dp(54.0f);
            kVar = ((org.telegram.ui.ActionBar.m2) qyVar).actionBar;
            int dp2 = (AndroidUtilities.dp(qyVar.f37011a) + kVar.getMeasuredHeight()) - AndroidUtilities.dp(2.0f);
            if (qyVar.X2 != 0) {
                i10 = dp;
            } else {
                i10 = 0;
        ...
        if (qyVar.f37043f4 > AndroidUtilities.dp(32.0f)) {
            int l12 = org.telegram.ui.ActionBar.h6.l1(0.9f, qyVar.getThemedColor(org.telegram.ui.ActionBar.h6.f19059d6));
            yf.y yVar2 = this.f40589a1;
            yVar2.b(l12);
            yVar2.setBounds(0, getMeasuredHeight() - qyVar.f37043f4, getMeasuredWidth(), getMeasuredHeight());
            yVar2.draw(canvas);
        }
    }
