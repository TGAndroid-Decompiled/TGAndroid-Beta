...
public final class e1 extends FrameLayout implements org.telegram.ui.Cells.l9 {
    ...
    public final o70 f36351a;
    public final j4 f36352b;
    public final org.telegram.ui.Components.tq f36353c;
    public final TextView d;
    public final ImageView f36354e;
    public int f36355f;
    public d3 h;
    public int f36356n;
    public final int f36357r;
    public final int f36358s;
    public int v;
    public final Paint f36359w;
    public AnimatorSet f36360x;
    public final int f36361y;

    public e1(Context context, o70 o70Var, j4 j4Var, int i10) {
        super(context);
        this.f36357r = AndroidUtilities.dp(18.0f);
        this.f36358s = AndroidUtilities.dp(11.0f);
        this.f36351a = o70Var;
        this.f36352b = j4Var;
        setWillNotDraw(false);
        this.f36359w = new Paint();
        this.f36361y = i10;
    ...
    public final void a(int i10, boolean z4) {
        ...
        float f26;
        float f27;
        AnimatorSet animatorSet = this.f36360x;
        if (animatorSet != null) {
            animatorSet.cancel();
        }
        this.f36355f = i10;
        ImageView imageView = this.f36354e;
        org.telegram.ui.Components.tq tqVar = this.f36353c;
        TextView textView = this.d;
        if (z4) {
            AnimatorSet animatorSet2 = new AnimatorSet();
            this.f36360x = animatorSet2;
            if (i10 == 0) {
                f19 = 1.0f;
            } else {
                f19 = 0.0f;
    ...
    public final void onDraw(Canvas canvas) {
        if (this.B != null) {
            canvas.drawRect(0.0f, 0.0f, getMeasuredWidth(), AndroidUtilities.dp(39.0f), this.f36359w);
            d3 d3Var = this.h;
            if (d3Var != null && d3Var.d.getLineCount() > 0) {
                canvas.save();
                int i10 = this.f36358s;
                int i11 = this.f36357r;
                j4 j4Var = this.f36352b;
                ...
                if (this.f36361y == 0) {
                    l4.v(this.f36351a, canvas, this, 0);
                }
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        accessibilityNodeInfo.setText(l4.i(R.string.AccDescrChannel, l4.j(this.f36351a, this.f36352b, d3Var)));
    }

    @Override
    public final void onLayout(boolean z4, int i10, int i11, int i12, int i13) {
        int dp = ((this.f36356n / 2) + this.v) - AndroidUtilities.dp(19.0f);
        int i14 = this.v;
        int dp2 = AndroidUtilities.dp(20.0f);
        int dp3 = AndroidUtilities.dp(39.0f);
        this.f36354e.layout(dp, 0, dp2 + (this.f36356n / 2) + i14, dp3);
        this.f36353c.layout(((this.f36356n / 2) + this.v) - AndroidUtilities.dp(19.0f), 0, AndroidUtilities.dp(20.0f) + (this.f36356n / 2) + this.v, AndroidUtilities.dp(39.0f));
        int i15 = this.v;
        TextView textView = this.d;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f36356n = textView.getMeasuredWidth();
        this.f36353c.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(39.0f), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(39.0f), 1073741824));
        this.f36354e.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(39.0f), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(39.0f), 1073741824));
        TL_iv.pageBlockChannel pageblockchannel = this.B;
        if (pageblockchannel != null) {
            String str = pageblockchannel.channel.title;
            int dp = (size - AndroidUtilities.dp(52.0f)) - this.f36356n;
            TL_iv.pageBlockChannel pageblockchannel2 = this.B;
            Layout.Alignment[] alignmentArr = org.telegram.ui.Components.lw0.f28837a;
            ...
            this.h = l4.p(this.f36351a, this, str, null, dp, this.f36358s, pageblockchannel2, alignment2, 1, this.f36352b);
            int i12 = this.f36357r;
            j4 j4Var = this.f36352b;
            if (j4Var != null && j4Var.D) {
                this.v = i12;
            } else {
                this.v = (getMeasuredWidth() - i12) - this.f36356n;
            }
            d3 d3Var = this.h;
            if (d3Var != null) {
                d3Var.f35986s = i12;
                d3Var.v = this.f36358s;
            }
        }
    }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (!l4.l(this.f36351a, this.f36352b, motionEvent, this, this.h, this.f36357r, this.f36358s) && !super.onTouchEvent(motionEvent)) {
            return false;
        }
        return true;
    }
    ...
    public void setBlock(TL_iv.pageBlockChannel pageblockchannel) {
        ...
        int i10 = this.f36361y;
        ImageView imageView = this.f36354e;
        Paint paint = this.f36359w;
        TextView textView = this.d;
        o70 o70Var = this.f36351a;
        if (i10 == 0) {
        ...
        TLRPC.Chat chat = MessagesController.getInstance(((l4) o70Var).U).getChat(Long.valueOf(pageblockchannel.channel.f20843id));
        if (chat != null && !chat.min) {
            ...
            if (!o70Var.f39614r && ChatObject.isPublic(chat2)) {
                o70Var.f39614r = true;
                int i12 = ((l4) o70Var).U;
                TLRPC.TL_contacts_resolveUsername tL_contacts_resolveUsername = new TLRPC.TL_contacts_resolveUsername();
                tL_contacts_resolveUsername.username = chat2.username;
                ConnectionsManager.getInstance(i12).sendRequest(tL_contacts_resolveUsername, new oh.b8(o70Var, this.f36352b, i12, this, 1));
            }
            a(1, false);
        }
        requestLayout();
