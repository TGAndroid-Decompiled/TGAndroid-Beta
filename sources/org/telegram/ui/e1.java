...
public final class e1 extends s4.n0 {
    ...
    public final void a(Rect rect, View view, RecyclerView recyclerView, s4.z0 z0Var) {
        ...
        k1 k1Var = this.f35933a;
        if (z10) {
            groupedMessagePosition = (MessageObject.GroupedMessagePosition) k1Var.v.f37504b.get(((d2) view).N);
        } else if (view instanceof x2) {
            groupedMessagePosition = (MessageObject.GroupedMessagePosition) k1Var.v.f37504b.get(((x2) view).L);
        } else {
        ...
        if (groupedMessagePosition != null && groupedMessagePosition.siblingHeights != null) {
            ...
            int size = k1Var.v.f37503a.size();
            while (true) {
                if (i10 < size) {
                    MessageObject.GroupedMessagePosition groupedMessagePosition2 = (MessageObject.GroupedMessagePosition) k1Var.v.f37503a.get(i10);
