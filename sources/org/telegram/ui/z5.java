...
public final class z5 extends og.b {
    ...
    @Override
    public final int h() {
        return this.d.f32051c.size();
    }

    @Override
    public final int j(int i10) {
        return ((a6) this.d.f32051c.get(i10)).f15531a;
    }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (((a6) arrayList.get(i10)).f15531a == 2) {
            org.telegram.ui.Cells.ab abVar = (org.telegram.ui.Cells.ab) c1Var.f42671a;
            ...
            if (i10 != arrayList.size() - 1 && ((a6) arrayList.get(i10 + 1)).f15531a != 2) {
                z10 = false;
            }
