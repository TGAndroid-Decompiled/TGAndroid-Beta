...
public final class pg0 extends org.telegram.ui.Components.sl0 {
    ...
    public final boolean D(f2.m1 m1Var) {
        int b10 = m1Var.b();
        qg0 qg0Var = this.d;
        if (b10 != qg0Var.f40474c && b10 != qg0Var.d && b10 != qg0Var.f40475e && b10 != qg0Var.f40476f && b10 != qg0Var.h && b10 != qg0Var.f40478r) {
            return false;
        }
        return true;
    }
    ...
    public final int j(int i10) {
        ...
        if (i10 != qg0Var.f40474c && i10 != qg0Var.d && i10 != qg0Var.f40475e && i10 != qg0Var.f40476f && i10 != qg0Var.h) {
            if (i10 == qg0Var.f40477n) {
                return 2;
            }
            if (i10 == qg0Var.f40478r) {
                return 3;
            }
            return 4;
        }
    ...
    public final f2.m1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 != 0) {
            if (i10 != 1) {
                if (i10 != 2) {
                    if (i10 != 3) {
                        ...
                        view.setBackgroundDrawable(org.telegram.ui.ActionBar.k6.V0(context, R.drawable.greydivider, org.telegram.ui.ActionBar.k6.f21624b7));
                    } else {
            ...
            z8Var2.setBackgroundColor(org.telegram.ui.ActionBar.k6.w0(null, org.telegram.ui.ActionBar.k6.f21659d6, false));
            z8Var = z8Var2;
        } else {
