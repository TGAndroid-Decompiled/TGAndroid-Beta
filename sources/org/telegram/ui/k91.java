...
public final class k91 extends LinearLayout {
    public final org.telegram.ui.ActionBar.f1[] f35092a;
    ...
    public k91(ContextThemeWrapper contextThemeWrapper, final rr0 rr0Var) {
        ...
        c10.setOnClickListener(new View.OnClickListener() {
            ...
            public final void onClick(View view) {
                ...
                switch (i10) {
                    case 0:
                        PhotoViewer photoViewer = rr0Var2.f37242a;
                        Drawable[] drawableArr = PhotoViewer.U8;
                        photoViewer.D0(true, true, 0.2f);
                        return;
                    case 1:
                        PhotoViewer photoViewer2 = rr0Var2.f37242a;
                        Drawable[] drawableArr2 = PhotoViewer.U8;
                        photoViewer2.D0(true, true, 0.5f);
                        return;
                    case 2:
                        PhotoViewer photoViewer3 = rr0Var2.f37242a;
                        Drawable[] drawableArr3 = PhotoViewer.U8;
                        photoViewer3.D0(true, true, 1.0f);
                        return;
                    case 3:
                        PhotoViewer photoViewer4 = rr0Var2.f37242a;
                        Drawable[] drawableArr4 = PhotoViewer.U8;
                        photoViewer4.D0(true, true, 1.5f);
                        return;
                    default:
                        PhotoViewer photoViewer5 = rr0Var2.f37242a;
