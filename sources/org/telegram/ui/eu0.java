...
public final class eu0 extends View {
    public final Paint f34088a;
    public final org.telegram.ui.Components.j6 f34089b;
    public final TextPaint f34090c;
    public StaticLayout d;
    public float e;
    public float f34091f;
    public final org.telegram.ui.Components.j6 h;
    public String f34092n;
    public boolean f34093r;
    public final org.telegram.ui.Components.z5 f34094s;
    public boolean v;
    public int f34095w;
    ...
    public eu0(Activity activity) {
        ...
        this.f34090c = textPaint;
        this.f34093r = false;
        org.telegram.ui.Components.nr nrVar = org.telegram.ui.Components.nr.h;
        this.f34094s = new org.telegram.ui.Components.z5(this, 0L, 350L, nrVar);
    ...
    public final void b(int i10, int i11, boolean z4) {
        ...
        if (LocaleController.getInstance().getCurrentLocaleInfo() != null && !TextUtils.equals(this.f34092n, LocaleController.getInstance().getCurrentLocaleInfo().shortName)) {
            c();
        }
        ...
        this.f34089b.q(format, z10, true);
        if (!LocaleController.isRTL) {
            max = max2;
        }
    ...
    public final void c() {
        this.f34092n = LocaleController.getInstance().getCurrentLocaleInfo().shortName;
        StaticLayout staticLayout = new StaticLayout(LocaleController.getString(R.string.Of).replace("%1$d", "").replace("%2$d", ""), this.f34090c, AndroidUtilities.dp(200.0f), Layout.Alignment.ALIGN_CENTER, 1.0f, 0.0f, false);
        this.d = staticLayout;
        if (staticLayout.getLineCount() >= 1) {
            this.e = this.d.getLineWidth(0);
            this.f34091f = this.d.getLineDescent(0);
            return;
        }
        this.e = 0.0f;
        this.f34091f = 0.0f;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        canvas.save();
        canvas.translate((-(this.d.getWidth() - this.e)) / 2.0f, ((this.f34091f / 2.0f) + (AndroidUtilities.dp(23.0f) - this.d.getHeight())) / 2.0f);
        this.f34090c.setAlpha(i10);
        this.d.draw(canvas);
        canvas.restore();
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f34095w = org.telegram.ui.ActionBar.k.getCurrentActionBarHeight() + AndroidUtilities.statusBarHeight;
        this.f34089b.G = size;
        this.h.G = size;
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(size, 1073741824), b.B(43.0f, this.f34095w, 1073741824));
    }

    @Override
    public final boolean verifyDrawable(Drawable drawable) {
        if (this.f34089b != drawable && this.h != drawable && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
