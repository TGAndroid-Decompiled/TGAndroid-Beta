...
public final class eu0 implements ViewTreeObserver.OnPreDrawListener {
    public final ClippingImageView[] f36176a;
    public final ViewGroup.LayoutParams f36177b;
    public final float f36178c;
    public final cv0 d;
    public final float f36179e;
    public final av0 f36180f;
    public final ArrayList h;
    public final Integer f36181n;
    public final PhotoViewer f36182r;
    ...
    public eu0(PhotoViewer photoViewer, ClippingImageView[] clippingImageViewArr, ViewGroup.LayoutParams layoutParams, float f7, cv0 cv0Var, float f10, av0 av0Var, ArrayList arrayList, Integer num) {
        this.f36182r = photoViewer;
        this.f36176a = clippingImageViewArr;
        this.f36177b = layoutParams;
        this.f36178c = f7;
        this.d = cv0Var;
        this.f36179e = f10;
        this.f36180f = av0Var;
    ...
    public final boolean onPreDraw() {
        ...
        int i14;
        int i15;
        PhotoViewer photoViewer = this.f36182r;
        Rect rect = photoViewer.f33673s2;
        PhotoViewer.BackgroundDrawable backgroundDrawable = photoViewer.L0;
        float[][] fArr = photoViewer.f33605k4;
        ClippingImageView[] clippingImageViewArr = this.f36176a;
        ...
        ViewGroup.LayoutParams layoutParams = this.f36177b;
        if (i16 == 1) {
            ...
            int measuredWidth2 = photoViewer.f33566g0.getMeasuredWidth();
            v9 = com.google.android.gms.internal.vision.e2.v(layoutParams.width, f7, (measuredWidth2 - i15) - rect.right, 2.0f) + rect.left;
        } else {
            c10 = 0;
            float measuredWidth3 = photoViewer.f33566g0.getMeasuredWidth() / layoutParams.width;
            ...
            v9 = com.google.android.gms.internal.vision.e2.v(layoutParams.width, f7, photoViewer.f33566g0.getMeasuredWidth(), 2.0f);
            photoViewer.f33526b6 = 0.0f;
            photoViewer.f33564f6 = 0.0f;
        }
        cv0 cv0Var = this.d;
        int abs = (int) Math.abs(this.f36178c - cv0Var.f35540a.getImageX());
        float imageY = cv0Var.f35540a.getImageY();
        float f16 = this.f36179e;
        int abs2 = (int) Math.abs(f16 - imageY);
        if (cv0Var.f35540a.isAspectFit()) {
            abs = 0;
        }
        int[] iArr = new int[2];
        cv0Var.d.getLocationInWindow(iArr);
        float f17 = cv0Var.f35542c + f16;
        int i19 = (int) ((iArr[1] - f17) + cv0Var.f35547j);
        if (i19 < 0) {
            i19 = 0;
        }
        int height = (int) (((f17 + layoutParams.height) - (cv0Var.d.getHeight() + i12)) + cv0Var.f35546i);
        if (height < 0) {
            height = 0;
        }
        int max = Math.max(i19, abs2);
        int max2 = Math.max(height, abs2);
        fArr[c10][c10] = photoViewer.f33575h0.getScaleX();
        fArr[c10][1] = photoViewer.f33575h0.getScaleY();
        fArr[c10][2] = photoViewer.f33575h0.getTranslationX();
        fArr[c10][3] = photoViewer.f33575h0.getTranslationY();
        float[] fArr2 = fArr[c10];
        float f18 = abs;
        float f19 = cv0Var.f35548k;
        int i20 = 3;
        fArr2[4] = f18 * f19;
        fArr2[5] = max * f19;
        fArr2[6] = max2 * f19;
        int[] radius = photoViewer.f33575h0.getRadius();
        ...
        h90 h90Var = new h90(this, clippingImageViewArr, this.h, this.f36181n, this.f36180f, 15);
        photoViewer.f33648p4 = h90Var;
        if (!photoViewer.f33611l2) {
            ...
            for (int i23 = 0; i23 < clippingImageViewArr.length; i23++) {
                ObjectAnimator ofFloat = ObjectAnimator.ofFloat(clippingImageViewArr[i23], org.telegram.ui.Components.t6.f30539f, 0.0f, 1.0f);
                if (i23 == 0) {
            ...
            if (clippingImageViewArr.length > 1) {
                arrayList.add(ObjectAnimator.ofFloat(photoViewer.f33575h0, View.ALPHA, 0.0f, 1.0f));
            }
            ...
            arrayList.add(ObjectAnimator.ofFloat(photoViewer.f33593j0, property, 0.0f, 1.0f));
            if (photoViewer.f33532c2 == 1) {
            ...
            photoViewer.f33549e0.setLayerType(2, null);
            photoViewer.y2(false);
            photoViewer.f33639o4 = System.currentTimeMillis();
