...
public final class k4 extends AnimatorListenerAdapter {
    ...
    public final ArticleViewer$WindowView f35564b;

    public k4(ArticleViewer$WindowView articleViewer$WindowView, boolean z4) {
        this.f35564b = articleViewer$WindowView;
        this.f35563a = z4;
    }

    @Override
    public final void onAnimationEnd(Animator animator) {
        ArticleViewer$WindowView articleViewer$WindowView = this.f35564b;
        l4 l4Var = articleViewer$WindowView.E;
        boolean z4 = articleViewer$WindowView.e;
        boolean z10 = this.f35563a;
        if (z4) {
            Object obj = null;
