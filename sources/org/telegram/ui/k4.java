...
public final class k4 extends AnimatorListenerAdapter {
    ...
    public final ArticleViewer$WindowView f38268b;

    public k4(ArticleViewer$WindowView articleViewer$WindowView, boolean z4) {
        this.f38268b = articleViewer$WindowView;
        this.f38267a = z4;
    }

    @Override
    public final void onAnimationEnd(Animator animator) {
        ArticleViewer$WindowView articleViewer$WindowView = this.f38268b;
        l4 l4Var = articleViewer$WindowView.E;
        boolean z4 = articleViewer$WindowView.f22510e;
