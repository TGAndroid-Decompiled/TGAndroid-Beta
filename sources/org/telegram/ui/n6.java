...
public final class n6 implements Utilities.Callback2 {
    ...
    public final void run(Object obj, Object obj2) {
        ...
        int i11 = 0;
        Object obj3 = this.d;
        Object obj4 = this.f35949c;
        Object obj5 = this.f35948b;
        switch (i10) {
            case 0:
            ...
            case 1:
                ...
                if (bool.booleanValue() && !(webPage instanceof TLRPC.TL_webPagePending)) {
                    Iterator it = boVar.f32373mb.keySet().iterator();
                    while (it.hasNext() && boVar.f32373mb.size() > 5) {
                        it.next();
                        it.remove();
                    }
                    boVar.f32373mb.put(getwebpagepreview.message, webPage);
                }
            ...
            default:
                ...
                if (passkeys != null) {
                    ...
                    while (i11 < passkeys.passkeys.size()) {
                        if (TextUtils.equals(passkeys.passkeys.get(i11).f18325id, passkey.f18325id)) {
