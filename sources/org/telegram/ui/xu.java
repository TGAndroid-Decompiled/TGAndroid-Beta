...
public final class xu extends org.telegram.ui.Components.ml0 {
    public static final int f39700p3 = 0;
    public boolean X2;
    public int Y2;
    public final s4.c0 Z2;
    public final vu f39701a3;
    public final ArrayList f39702b3;
    public final ArrayList f39703c3;
    public final float[] f39704d3;
    public final int[] f39705e3;
    public final ArrayList f39706f3;
    public wu[] f39707g3;
    public wu[] f39708h3;
    public final boolean[] f39709i3;
    public long j3;
    public long f39710k3;
    public long f39711l3;
    public boolean f39712m3;
    public uu f39713n3;
    public final bv f39714o3;
    ...
    public xu(bv bvVar, Activity activity) {
        ...
        this.X2 = false;
        this.Y2 = 0;
        this.f39702b3 = new ArrayList();
        this.f39703c3 = new ArrayList();
        this.f39704d3 = new float[7];
        this.f39705e3 = new int[7];
        this.f39706f3 = new ArrayList();
        this.f39709i3 = new boolean[7];
        ...
        ki.b.a(this, bvVar.h, bvVar.f32573n, AndroidUtilities.dp(42.0f) + org.telegram.ui.ActionBar.k.getCurrentActionBarHeight());
    }
    ...
    public final void A1() {
        ...
        this.f39710k3 = x1(6);
        this.f39711l3 = z1(6);
        if (this.f39707g3 == null) {
            this.f39707g3 = new wu[7];
        }
        if (this.f39708h3 == null) {
            this.f39708h3 = new wu[7];
        }
        int i19 = 0;
        while (true) {
            int[] iArr = bv.f32568x;
            int length = iArr.length;
            float[] fArr = this.f39704d3;
            if (i19 < length) {
                int i20 = iArr[i19];
                long x12 = x1(i20) + z1(i20);
                wu[] wuVarArr = this.f39708h3;
                wu[] wuVarArr2 = this.f39707g3;
                long x13 = x1(iArr[i19]);
                long z12 = z1(iArr[i19]);
                int i21 = iArr[i19];
                int i22 = this.Y2;
                bv bvVar = this.f39714o3;
                ...
                Arrays.sort(this.f39707g3, new ff(20));
                AndroidUtilities.roundPercents(fArr, this.f39705e3);
                Arrays.fill(this.f39709i3, true);
                return;
            }
        }
    }
    ...
    public final void B1(boolean z10) {
        ...
        String format;
        CharSequence concat;
        ArrayList arrayList = this.f39702b3;
        arrayList.clear();
        ArrayList arrayList2 = this.f39703c3;
        ...
        int i14 = 0;
        while (true) {
            wu[] wuVarArr = this.f39707g3;
            if (i14 >= wuVarArr.length) {
                break;
            }
            wu wuVar = wuVarArr[i14];
            long j10 = j3;
            long j11 = wuVar.f22376c;
            int i15 = wuVar.d;
            if (!this.f39712m3 && !this.f39706f3.contains(Integer.valueOf(i15))) {
                z11 = false;
            } else {
                z11 = true;
            }
            ...
            if (i16 > 0 || z11) {
                ...
                metricAffectingSpan.f37305a = 0.1d;
                spannableString3.setSpan(metricAffectingSpan, 0, spannableString3.length(), 33);
                int i18 = bv.v[i15];
                int[] iArr = bv.f32565r[i15];
                int i19 = iArr[0];
                int i20 = iArr[1];
                if (i16 == 0) {
                    concat = LocaleController.getString(bv.f32567w[i15]);
                } else {
                    concat = TextUtils.concat(LocaleController.getString(bv.f32567w[i15]), "  ", spannableString3);
                }
        ...
        if (!arrayList3.isEmpty()) {
            ...
            while (i22 < arrayList3.size()) {
                ...
                if (i23 >= 0 && !this.f39709i3[i23]) {
                    wu wuVar2 = this.f39707g3[i23];
                    int[] iArr2 = bv.f32568x;
                    int i24 = wuVar2.d;
                    int i25 = wuVar2.f39170g;
                    int i26 = wuVar2.h;
                    long j13 = wuVar2.e;
                    spannableString = spannableString4;
                    spannableString2 = spannableString5;
                    long j14 = wuVar2.f39169f;
                    int i27 = iArr2[i24];
                    if (i27 == 0) {
                        if (j14 > j12 || i26 > 0) {
                            i22++;
        ...
        if (!this.f39712m3) {
            ...
            arrayList2.add(new su(-1, R.drawable.msg_filled_data_sent, -11565578, -13276952, LocaleController.getString(R.string.BytesSent), AndroidUtilities.formatFileSize(this.f39711l3)));
            arrayList2.add(new su(-1, R.drawable.msg_filled_data_received, -11154873, -14175180, LocaleController.getString(R.string.BytesReceived), AndroidUtilities.formatFileSize(this.f39710k3)));
        }
        if (!arrayList3.isEmpty()) {
            i10 = 3;
