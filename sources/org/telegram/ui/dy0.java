        ...
        if (b10 != i10) {
            ...
            if (b10 != i11) {
                ...
                if (b10 != i12) {
                    ...
                    if (b10 != i13 && b10 != privacySettingsActivity.f33879s) {
                        i14 = privacySettingsActivity.secretWebpageRow;
                        if (b10 != i14) {
                            i15 = privacySettingsActivity.webSessionsRow;
                            if (b10 != i15 && (b10 != privacySettingsActivity.f33877n || privacySettingsActivity.getContactsController().getLoadingPrivacyInfo(1))) {
            ...
            if (i10 != i11) {
                ...
                if (i10 != i12) {
                    ...
                    if (i10 != i13) {
                        ...
                        if (i10 != i14 && i10 != privacySettingsActivity.f33877n) {
                            ...
                            if (i10 != i15) {
                                ...
                                if (i10 != i16) {
                                    ...
                                    if (i10 != i17 && i10 != privacySettingsActivity.H) {
                                        if (i10 != privacySettingsActivity.h && i10 != privacySettingsActivity.E && i10 != privacySettingsActivity.f33878r && i10 != privacySettingsActivity.v && i10 != privacySettingsActivity.N && i10 != privacySettingsActivity.I && i10 != privacySettingsActivity.L && i10 != privacySettingsActivity.f33881x) {
                                            if (i10 != 0 && i10 != privacySettingsActivity.f33882y && i10 != privacySettingsActivity.f33876f && i10 != privacySettingsActivity.M && i10 != privacySettingsActivity.F && i10 != privacySettingsActivity.K && i10 != privacySettingsActivity.f33880w) {
                                                        ...
                                                        if (i10 != i20) {
                                                            ...
                                                            if (i10 != i21) {
                                                                if (i10 != privacySettingsActivity.J) {
                                                                    ...
                                                                    if (i10 != i22 && i10 != privacySettingsActivity.f33879s) {
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i42 != 0) {
                ...
                if (i42 != 2) {
                    if (i42 != 3) {
                        if (i42 == 5) {
                            ...
                            org.telegram.ui.Components.q6 q6Var = r8Var.f22709c;
                            ...
                            if (i10 == i34) {
                                ...
                                String str8 = "";
                                if (i10 != privacySettingsActivity.f33879s) {
                                    ...
                                    if (i10 != i35) {
                                        ...
                                        if (i10 != i36) {
                                            ...
                                            if (i10 != i37) {
                                                ...
                                                if (arrayList == null) {
                                                    ...
                                                    if (arrayList.size() == 1 && q6Var.getPaint().measureText(((TL_account.Passkey) privacySettingsActivity.f33875e.get(0)).name) < AndroidUtilities.displaySize.x / 3.0f) {
                                                        string3 = ((TL_account.Passkey) privacySettingsActivity.f33875e.get(0)).name;
                                                    } else if (privacySettingsActivity.f33875e.size() > 0) {
                                                        string3 = privacySettingsActivity.f33875e.size() + "";
                                                    } else {
                                            ...
                                            r8Var.s(LocaleController.getString(R.string.TwoStepVerification), str3, true, i41, true);
                                        }
                                    } else {
                                        ...
                                        if (password2 == null) {
                                            ...
                                            if (indexOf != lastIndexOf && indexOf != -1 && lastIndexOf != -1) {
                                                ...
                                                obj.f28620c = i46;
                                                valueOf.setSpan(new org.telegram.ui.Components.o01(obj, 0), indexOf, i46, 0);
                                            }
                                            z16 = false;
                                            str4 = valueOf;
                                        }
                                        ...
                                        r8Var.f22715w = 16;
                                        r8Var.f22714s = 58;
                                        org.telegram.ui.ActionBar.j5 j5Var = r8Var.f22707a;
                                        ...
                                        org.telegram.ui.Components.aj0 aj0Var = r8Var.f22710e;
                                    ...
                                    if (privacySettingsActivity.f33870a0.j0() == 0) {
                                        if (privacySettingsActivity.getMessagesController().lastKnownSessionsCount == 0) {
                                            str5 = "";
                                            z17 = true;
                                            privacySettingsActivity.getMessagesController().lastKnownSessionsCount = privacySettingsActivity.f33870a0.j0();
                                        ...
                                        format2 = String.format(LocaleController.getInstance().getCurrentLocale(), "%d", Integer.valueOf(privacySettingsActivity.f33870a0.j0()));
                                    }
                                    str5 = format2;
                                    privacySettingsActivity.getMessagesController().lastKnownSessionsCount = privacySettingsActivity.f33870a0.j0();
                                    r8Var.s(LocaleController.getString(R.string.SessionsTitle), str5, true, R.drawable.msg2_devices, false);
                    ...
                    w8Var.f(string7, z18, false);
                    return;
                }
                org.telegram.ui.Cells.l4 l4Var = (org.telegram.ui.Cells.l4) view;
                if (i10 == privacySettingsActivity.f33876f) {
                    ...
                    return;
                } else if (i10 == privacySettingsActivity.f33882y) {
                    ...
                    return;
                } else if (i10 == privacySettingsActivity.f33880w) {
            ...
            if (i10 == privacySettingsActivity.E) {
                ...
                return;
            } else if (i10 == privacySettingsActivity.f33878r) {
                ...
                return;
            } else if (i10 == privacySettingsActivity.f33881x) {
        ...
        if (i10 != i11) {
            ...
            if (i10 != i12) {
                ...
                if (i10 == i13) {
                    ...
                    if (i10 != i14) {
                        ...
                        if (i10 != i15) {
                            ...
                            if (i10 != i16) {
                                ...
                                if (i10 != i17) {
                                    ...
                                    if (i10 != i18) {
                                        ...
                                        if (i10 != i19) {
                                            ...
                                            if (i10 != i20) {
                                                ...
                                                if (i10 != i21) {
                                                        ...
                                                        if (i10 != i23) {
                                                            ...
                                                            if (i10 == i24) {
                                                                ...
                                                                if (i10 != i25) {
                                                                    ...
                                                                    eaVar.c(LocaleController.getString("MapPreviewProvider", R.string.MapPreviewProvider), string, privacySettingsActivity.R, true);
                                                            ...
                                                            eaVar.c(LocaleController.getString("DeleteAccountIfAwayFor3", R.string.DeleteAccountIfAwayFor3), str7, privacySettingsActivity.Q, false);
                                                    ...
                                                    eaVar.getValueImageView().setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20854m6, false), PorterDuff.Mode.MULTIPLY));
                                                    z17 = z13;
                                                }
                                            } else {
                                                ...
                                                eaVar.c(LocaleController.getString("PrivacyForwards", R.string.PrivacyForwards), str7, false, true);
                                            }
                                        } else {
                                            ...
                                            eaVar.c(LocaleController.getString(R.string.PrivacyGifts), str7, false, true);
                                        }
                                    } else {
                                        ...
                                        eaVar.c(LocaleController.getString(R.string.PrivacyBirthday), str7, false, true);
                                    }
                                } else {
                                    ...
                                    eaVar.c(LocaleController.getString(R.string.PrivacyMusic), str7, false, true);
                                }
                            } else {
                                ...
                                eaVar.c(LocaleController.getString("PrivacyBio", R.string.PrivacyBio), str7, false, true);
                            }
                        } else {
                            ...
                            eaVar.c(LocaleController.getString("PrivacyProfilePhoto", R.string.PrivacyProfilePhoto), str7, false, true);
                        }
                    } else {
                        ...
                        eaVar.c(LocaleController.getString("Calls", R.string.Calls), str7, false, true);
                    }
                } else {
                    ...
                    eaVar.c(LocaleController.getString(R.string.PrivacyInvites), str7, false, false);
                }
            } else {
                ...
                eaVar.c(LocaleController.getString("PrivacyPhone", R.string.PrivacyPhone), str7, false, true);
            }
            z17 = z11;
        } else {
                ...
                if (i10 != 2) {
                    if (i10 != 4) {
                        if (i10 != 5) {
                            ...
                            eaVar = new org.telegram.ui.Cells.r8(context);
                        }
                    } else {
                        eaVar = new org.telegram.ui.Cells.a7(context, (org.telegram.ui.Cells.p6) null);
                    }
                } else {
                    eaVar = new org.telegram.ui.Cells.l4(context);
                }
            } else {
