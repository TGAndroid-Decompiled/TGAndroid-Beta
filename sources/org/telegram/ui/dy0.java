        ...
        if (b10 != i10) {
            ...
            if (b10 != i11) {
                ...
                if (b10 != i12) {
                    ...
                    if (b10 != i13 && b10 != privacySettingsActivity.f33853s) {
                        i14 = privacySettingsActivity.secretWebpageRow;
                        if (b10 != i14) {
                            i15 = privacySettingsActivity.webSessionsRow;
                            if (b10 != i15 && (b10 != privacySettingsActivity.f33851n || privacySettingsActivity.getContactsController().getLoadingPrivacyInfo(1))) {
            ...
            if (i10 != i11) {
                ...
                if (i10 != i12) {
                    ...
                    if (i10 != i13) {
                        ...
                        if (i10 != i14 && i10 != privacySettingsActivity.f33851n) {
                            ...
                            if (i10 != i15) {
                                ...
                                if (i10 != i16) {
                                    ...
                                    if (i10 != i17 && i10 != privacySettingsActivity.H) {
                                        if (i10 != privacySettingsActivity.h && i10 != privacySettingsActivity.E && i10 != privacySettingsActivity.f33852r && i10 != privacySettingsActivity.v && i10 != privacySettingsActivity.N && i10 != privacySettingsActivity.I && i10 != privacySettingsActivity.L && i10 != privacySettingsActivity.f33855x) {
                                            if (i10 != 0 && i10 != privacySettingsActivity.f33856y && i10 != privacySettingsActivity.f33850f && i10 != privacySettingsActivity.M && i10 != privacySettingsActivity.F && i10 != privacySettingsActivity.K && i10 != privacySettingsActivity.f33854w) {
                                                        ...
                                                        if (i10 != i20) {
                                                            ...
                                                            if (i10 != i21) {
                                                                if (i10 != privacySettingsActivity.J) {
                                                                    ...
                                                                    if (i10 != i22 && i10 != privacySettingsActivity.f33853s) {
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i42 != 0) {
            if (i42 != 1) {
                if (i42 != 2) {
                    if (i42 != 3) {
                        if (i42 == 5) {
                            ...
                            org.telegram.ui.Components.q6 q6Var = r8Var.f22683c;
                            ...
                            if (i10 == i34) {
                                ...
                                String str8 = "";
                                if (i10 != privacySettingsActivity.f33853s) {
                                    ...
                                    if (i10 != i35) {
                                        ...
                                        if (i10 != i36) {
                                            ...
                                            if (i10 != i37) {
                                                ...
                                                if (arrayList == null) {
                                                    ...
                                                    if (arrayList.size() == 1 && q6Var.getPaint().measureText(((TL_account.Passkey) privacySettingsActivity.f33849e.get(0)).name) < AndroidUtilities.displaySize.x / 3.0f) {
                                                        string3 = ((TL_account.Passkey) privacySettingsActivity.f33849e.get(0)).name;
                                                    } else if (privacySettingsActivity.f33849e.size() > 0) {
                                                        string3 = privacySettingsActivity.f33849e.size() + "";
                                                    } else {
                                        ...
                                        r8Var.f22689w = 16;
                                        r8Var.f22688s = 58;
                                        org.telegram.ui.ActionBar.j5 j5Var = r8Var.f22681a;
                                        ...
                                        org.telegram.ui.Components.aj0 aj0Var = r8Var.f22684e;
                                    ...
                                    if (privacySettingsActivity.f33844a0.j0() == 0) {
                                        if (privacySettingsActivity.getMessagesController().lastKnownSessionsCount == 0) {
                                            str5 = "";
                                            z17 = true;
                                            privacySettingsActivity.getMessagesController().lastKnownSessionsCount = privacySettingsActivity.f33844a0.j0();
                                        ...
                                        format2 = String.format(LocaleController.getInstance().getCurrentLocale(), "%d", Integer.valueOf(privacySettingsActivity.f33844a0.j0()));
                                    }
                                    str5 = format2;
                                    privacySettingsActivity.getMessagesController().lastKnownSessionsCount = privacySettingsActivity.f33844a0.j0();
                                    r8Var.s(LocaleController.getString(R.string.SessionsTitle), str5, true, R.drawable.msg2_devices, false);
                ...
                if (i10 == privacySettingsActivity.f33850f) {
                    ...
                    return;
                } else if (i10 == privacySettingsActivity.f33856y) {
                    ...
                    return;
                } else if (i10 == privacySettingsActivity.f33854w) {
            ...
            if (i10 == privacySettingsActivity.E) {
                ...
                return;
            } else if (i10 == privacySettingsActivity.f33852r) {
                ...
                return;
            } else if (i10 == privacySettingsActivity.f33855x) {
                                        ...
                                        if (i10 != i19) {
                                            ...
                                            if (i10 != i20) {
                                                ...
                                                if (i10 != i21) {
                                                    ...
                                                    eaVar.getValueImageView().setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20828m6, false), PorterDuff.Mode.MULTIPLY));
                                                    z17 = z13;
                                                }
                                            } else {
