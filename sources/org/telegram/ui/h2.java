...
public final class h2 extends View implements org.telegram.ui.Cells.p9 {
    public final u70 f34016a;
    public final f4 f34017b;
    public a3 f34018c;
    public a3 d;
    public boolean e;
    ...
    public h2(Context context, u70 u70Var, f4 f4Var) {
        super(context);
        this.f34022s = AndroidUtilities.dp(18.0f);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.f34020n != null) {
            ...
            canvas.save();
            canvas.translate(this.f34022s, AndroidUtilities.dp(10.0f));
            a3 a3Var = this.f34018c;
            u70 u70Var = this.f34016a;
            int i11 = 0;
            if (a3Var != null) {
                h4.v(u70Var, canvas, this, 0);
                this.f34018c.draw(canvas, this);
                i10 = 1;
            } else {
                i10 = 0;
            }
            if (this.d != null) {
                canvas.translate(0.0f, this.f34023w);
                h4.v(u70Var, canvas, this, i10);
                this.d.draw(canvas, this);
            }
            canvas.restore();
            if (this.e) {
                f4 f4Var = this.f34017b;
                ...
                canvas.drawLine(dp, measuredHeight, measuredWidth - i11, getMeasuredHeight() - 1, h4.f34045r1);
            }
        }
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        b4 b4Var = this.f34020n;
        if (b4Var.f32232b != b4Var.f32231a.articles.size() - 1) {
            z10 = true;
        } else {
            z10 = false;
        }
        this.e = z10;
        b4 b4Var2 = this.f34020n;
        TL_iv.pageRelatedArticle pagerelatedarticle = b4Var2.f32231a.articles.get(b4Var2.f32232b);
        ...
        if (photo != null) {
            ...
            imageReceiver2.setImage(ImageLocation.getForPhoto(closestPhotoSizeWithSize, photo), "64_64", ImageLocation.getForPhoto(photoSize, photo), "64_64_b", closestPhotoSizeWithSize.size, null, this.f34021r, 1);
        ...
        if (str2 != null) {
            ...
            c10 = 1;
            f7 = 6.0f;
            this.f34018c = h4.p(this.f34016a, this, str2, null, i14, this.v, this.f34020n, Layout.Alignment.ALIGN_NORMAL, 3, this.f34017b);
        } else {
            i12 = dp3;
            c10 = 1;
            f7 = 6.0f;
        ...
        a3 a3Var = this.f34018c;
        int i15 = this.f34022s;
        int i16 = this.v;
        if (a3Var != null) {
            int lineCount = a3Var.d.getLineCount();
            int i17 = 4 - lineCount;
            this.f34023w = org.telegram.messenger.q.D(f7, this.f34018c.d.getHeight(), dp2);
            dp6 = this.f34018c.d.getHeight() + dp6;
            int i18 = 0;
            while (true) {
                if (i18 < lineCount) {
                    if (this.f34018c.d.getLineLeft(i18) != 0.0f) {
                        z11 = true;
                        break;
                    }
                    i18++;
        ...
        int i20 = this.f34023w + i16;
        String str4 = str;
        b4 b4Var3 = this.f34020n;
        if ((f4Var != null && f4Var.G) || z11) {
            alignment = org.telegram.ui.Components.vw0.a();
        } else {
            alignment = Layout.Alignment.ALIGN_NORMAL;
        }
        a3 p5 = h4.p(this.f34016a, this, str4, null, i14, i20, b4Var3, alignment, i13, this.f34017b);
        this.d = p5;
        if (p5 != null) {
            int height = p5.d.getHeight() + dp6;
            if (this.f34018c != null) {
                height = org.telegram.messenger.q.D(f7, dp2, height);
            }
            dp6 = height;
            a3 a3Var3 = this.d;
            a3Var3.f31935s = i15;
            a3Var3.v = i16 + this.f34023w;
        }
