...
public final class h2 extends View implements org.telegram.ui.Cells.p9 {
    public final w70 f34104a;
    public final f4 f34105b;
    public a3 f34106c;
    public a3 d;
    public boolean e;
    ...
    public b4 f34108n;
    public TLObject f34109r;
    public final int f34110s;
    public final int v;
    public int f34111w;

    public h2(Context context, w70 w70Var, f4 f4Var) {
        super(context);
        this.f34110s = AndroidUtilities.dp(18.0f);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.f34108n != null) {
            ...
            canvas.save();
            canvas.translate(this.f34110s, AndroidUtilities.dp(10.0f));
            a3 a3Var = this.f34106c;
            w70 w70Var = this.f34104a;
            int i11 = 0;
            if (a3Var != null) {
                h4.v(w70Var, canvas, this, 0);
                this.f34106c.draw(canvas, this);
                i10 = 1;
            } else {
                i10 = 0;
            }
            if (this.d != null) {
                canvas.translate(0.0f, this.f34111w);
                h4.v(w70Var, canvas, this, i10);
                this.d.draw(canvas, this);
            }
            canvas.restore();
            if (this.e) {
                f4 f4Var = this.f34105b;
                ...
                canvas.drawLine(dp, measuredHeight, measuredWidth - i11, getMeasuredHeight() - 1, h4.f34144r1);
            }
        }
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        b4 b4Var = this.f34108n;
        if (b4Var.f32049b != b4Var.f32048a.articles.size() - 1) {
            z10 = true;
        } else {
            z10 = false;
        }
        this.e = z10;
        b4 b4Var2 = this.f34108n;
        TL_iv.pageRelatedArticle pagerelatedarticle = b4Var2.f32048a.articles.get(b4Var2.f32049b);
        ...
        if (photo != null) {
            ...
            imageReceiver2.setImage(ImageLocation.getForPhoto(closestPhotoSizeWithSize, photo), "64_64", ImageLocation.getForPhoto(photoSize, photo), "64_64_b", closestPhotoSizeWithSize.size, null, this.f34109r, 1);
        ...
        if (str2 != null) {
            ...
            c10 = 1;
            f7 = 6.0f;
            this.f34106c = h4.p(this.f34104a, this, str2, null, i14, this.v, this.f34108n, Layout.Alignment.ALIGN_NORMAL, 3, this.f34105b);
        } else {
            i12 = dp3;
            c10 = 1;
            f7 = 6.0f;
        ...
        a3 a3Var = this.f34106c;
        int i15 = this.f34110s;
        int i16 = this.v;
        if (a3Var != null) {
            int lineCount = a3Var.d.getLineCount();
            int i17 = 4 - lineCount;
            this.f34111w = org.telegram.messenger.w1.C(f7, this.f34106c.d.getHeight(), dp2);
            dp6 = this.f34106c.d.getHeight() + dp6;
            int i18 = 0;
            while (true) {
                if (i18 < lineCount) {
                    if (this.f34106c.d.getLineLeft(i18) != 0.0f) {
                        z11 = true;
                        break;
                    }
                    i18++;
        ...
        int i20 = this.f34111w + i16;
        String str4 = str;
        b4 b4Var3 = this.f34108n;
        if ((f4Var != null && f4Var.G) || z11) {
            alignment = org.telegram.ui.Components.kw0.a();
        } else {
            alignment = Layout.Alignment.ALIGN_NORMAL;
        }
        a3 p5 = h4.p(this.f34104a, this, str4, null, i14, i20, b4Var3, alignment, i13, this.f34105b);
        this.d = p5;
        if (p5 != null) {
