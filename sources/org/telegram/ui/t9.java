...
public final class t9 extends TextView {
    public final int f37703a = 0;
    public final Paint f37704b;
    public Path f37705c;
    public Object d;
    ...
    public t9(org.telegram.ui.Components.wn0 wn0Var, Context context) {
        super(context);
        this.e = wn0Var;
        this.f37705c = new Path();
        this.d = new RectF();
        this.f37704b = new Paint();
    }
    ...
    public void dispatchDraw(Canvas canvas) {
        switch (this.f37703a) {
            case 1:
                int l1 = org.telegram.ui.ActionBar.j6.l1(0.15f, org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19311o6, ((org.telegram.ui.Components.wn0) this.e).f30076c));
                Paint paint = this.f37704b;
                paint.setColor(l1);
                RectF rectF = (RectF) this.d;
                rectF.set(0.0f, 0.0f, getWidth(), getHeight());
                Path path = this.f37705c;
    ...
    public void onDraw(Canvas canvas) {
        switch (this.f37703a) {
            case 0:
                org.telegram.ui.Components.h90 h90Var = (org.telegram.ui.Components.h90) this.f37705c;
                if (h90Var != null) {
                    canvas.drawPath(h90Var, this.f37704b);
                }
            ...
            case 0:
                ...
                if (getText() instanceof Spanned) {
                    ...
                    if (c61VarArr != null && c61VarArr.length > 0) {
                        ...
                        for (int i14 = 0; i14 < c61VarArr.length; i14++) {
                            int spanStart = spanned.getSpanStart(c61VarArr[i14]);
                            int spanEnd = spanned.getSpanEnd(c61VarArr[i14]);
                            ((org.telegram.ui.Components.h90) this.f37705c).d(getLayout(), spanStart, 0.0f);
                            if (getText() != null) {
                                i12 = getPaint().baselineShift;
                            } else {
                                i12 = 0;
                            }
                            org.telegram.ui.Components.h90 h90Var2 = (org.telegram.ui.Components.h90) this.f37705c;
                            if (i12 != 0) {
                                if (i12 > 0) {
                                    f7 = 5.0f;
                                } else {
                            ...
                            h90Var2.f24751o = i13;
                            getLayout().getSelectionPath(spanStart, spanEnd, (org.telegram.ui.Components.h90) this.f37705c);
                        }
                        ((org.telegram.ui.Components.h90) this.f37705c).f24750n = true;
                        return;
                    }
                    return;
                }
                    ...
                    if (lineLeft <= f10 && layout.getLineWidth(lineForVertical) + lineLeft >= f10 && y3 >= 0 && y3 <= layout.getHeight()) {
                        ...
                        if (clickableSpanArr.length != 0) {
                            ...
                            if (motionEvent.getAction() == 0) {
                                ...
                                int spanStart = spannable.getSpanStart(((org.telegram.ui.Components.o90) this.d).f27022i);
                                int spanEnd = spannable.getSpanEnd(((org.telegram.ui.Components.o90) this.d).f27022i);
