...
public final class u2 extends FrameLayout implements org.telegram.ui.Components.uz0, org.telegram.ui.Cells.p9 {
    public final p70 f38289a;
    public final g4 f38290b;
    public final t2 f38291c;
    public b3 d;
    public final org.telegram.ui.Components.vz0 e;
    public int f38292f;
    public int h;
    public int f38293n;
    public boolean f38294r;
    public TL_iv.pageBlockTable f38295s;
    ...
    public u2(Context context, p70 p70Var, g4 g4Var) {
        ...
        org.telegram.ui.Components.vz0 vz0Var = new org.telegram.ui.Components.vz0(context, this, ((i4) p70Var).O0);
        this.e = vz0Var;
        vz0Var.setOrientation(0);
        vz0Var.setRowOrderPreserved(true);
        t2Var.addView(vz0Var, new FrameLayout.LayoutParams(-2, -2));
    ...
    public final void a() {
        ...
        for (int i11 = 0; i11 < childCount; i11++) {
            ...
            org.telegram.ui.Components.nz0 nz0Var = d.f27154b;
            if (nz0Var != null) {
                nz0Var.setX((AndroidUtilities.dp(18.0f) + (d.b() + this.f38292f)) - this.f38291c.getScrollX());
                d.f27154b.setY(d.c() + this.h);
                d.f27154b.setRow(d.f27159j + 10);
                d.f27167r = i10;
                i10++;
            }
        }
    ...
    public final org.telegram.ui.Components.nz0 createTextLayout(TL_iv.pageTableCell pagetablecell, int i10) {
        ...
        return i4.p(this.f38289a, this, null, pagetablecell.text, i10, -1, this.f38295s, alignment2, 0, this.f38290b);
    }
    ...
    public final void fillTextLayoutBlocks(ArrayList arrayList) {
        ...
        for (int i10 = 0; i10 < childCount; i10++) {
            org.telegram.ui.Components.nz0 nz0Var = vz0Var.d(i10).f27154b;
            if (nz0Var != null) {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        b3 b3Var = this.d;
        p70 p70Var = this.f38289a;
        if (b3Var != null) {
            canvas.save();
            canvas.translate(this.f38293n, 0);
            i4.v(p70Var, canvas, this, 0);
            this.d.draw(canvas, this);
            canvas.restore();
        }
        i4.u(canvas, p70Var, this.f38295s, getMeasuredHeight());
    }
                ...
                while (true) {
                    ...
                    if (indexOf >= 0) {
                        ...
                        if (indexOf == 0 || AndroidUtilities.isPunctuationCharacter(lowerCase.charAt(indexOf - 1))) {
                            ...
                            this.f38290b.f33817y.put(p70Var.F + this.f38295s + b3Var.f32302r + indexOf, Integer.valueOf(staticLayout.getLineTop(staticLayout.getLineForOffset(indexOf)) + i11));
                        }
                        i12 = length;
                    } else {
                        return;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        TL_iv.pageBlockTable pageblocktable = this.f38295s;
        if (pageblocktable != null) {
            ...
            if (i14 > 0) {
                ...
                this.f38292f = 0;
                p70Var.getClass();
                this.f38293n = AndroidUtilities.dp(18);
                dp = size - AndroidUtilities.dp(36);
            }
            int i15 = dp;
            TL_iv.pageBlockTable pageblocktable2 = this.f38295s;
            b3 p5 = i4.p(this.f38289a, this, null, pageblocktable2.title, i15, 0, pageblocktable2, Layout.Alignment.ALIGN_CENTER, 0, this.f38290b);
            this.d = p5;
            if (p5 != null) {
                i13 = AndroidUtilities.dp(8.0f) + p5.d.getHeight();
                this.h = i13;
                b3 b3Var = this.d;
                b3Var.f32303s = this.f38293n;
                b3Var.v = 0;
            } else {
                this.h = AndroidUtilities.dp(8.0f);
                i13 = 0;
            }
            int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(size - this.f38292f, 1073741824);
            ...
            TL_iv.pageBlockTable pageblocktable3 = this.f38295s;
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        while (i10 < childCount) {
            ...
            if (nz0Var instanceof b3) {
                b3 b3Var = (b3) nz0Var;
                t2 t2Var = this.f38291c;
                int b10 = d.b() + (t2Var.getPaddingLeft() - t2Var.getScrollX()) + this.f38292f;
                int i11 = this.h;
                MotionEvent motionEvent3 = motionEvent;
                motionEvent2 = motionEvent3;
                if (i4.l(this.f38289a, this.f38290b, motionEvent3, this, b3Var, b10, d.c() + i11)) {
                    return true;
                }
            } else {
        ...
        if (!i4.l(this.f38289a, this.f38290b, motionEvent4, this, this.d, this.f38293n, 0) && !super.onTouchEvent(motionEvent4)) {
            return false;
        }
        return true;
    }
    ...
    public void setBlock(TL_iv.pageBlockTable pageblocktable) {
        boolean z10;
        int i10;
        this.f38295s = pageblocktable;
        int i11 = org.telegram.ui.ActionBar.h6.f19059d6;
        ((i4) this.f38289a).getClass();
        AndroidUtilities.setScrollViewEdgeEffectColor(this.f38291c, org.telegram.ui.ActionBar.h6.w0(null, i11, false));
        org.telegram.ui.Components.vz0 vz0Var = this.e;
        vz0Var.P.clear();
        vz0Var.K.clear();
        vz0Var.g();
        vz0Var.setDrawLines(this.f38295s.bordered);
        vz0Var.setStriped(this.f38295s.striped);
        g4 g4Var = this.f38290b;
        if (g4Var != null && g4Var.G) {
            z10 = true;
        } else {
        ...
        vz0Var.setRtl(z10);
        if (!this.f38295s.rows.isEmpty()) {
            TL_iv.pageTableRow pagetablerow = this.f38295s.rows.get(0);
        ...
        int size2 = this.f38295s.rows.size();
        for (int i14 = 0; i14 < size2; i14++) {
            TL_iv.pageTableRow pagetablerow2 = this.f38295s.rows.get(i14);
