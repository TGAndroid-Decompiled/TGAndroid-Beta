...
public final class u2 extends FrameLayout implements org.telegram.ui.Components.tz0, org.telegram.ui.Cells.p9 {
    ...
    public final void a() {
        ...
        for (int i11 = 0; i11 < childCount; i11++) {
            ...
            org.telegram.ui.Components.mz0 mz0Var = d.f26840b;
            if (mz0Var != null) {
                mz0Var.setX((AndroidUtilities.dp(18.0f) + (d.b() + this.f38294f)) - this.f38293c.getScrollX());
                d.f26840b.setY(d.c() + this.h);
                d.f26840b.setRow(d.f26845j + 10);
                d.f26853r = i10;
                i10++;
            }
        }
    ...
    public final void fillTextLayoutBlocks(ArrayList arrayList) {
        ...
        for (int i10 = 0; i10 < childCount; i10++) {
            org.telegram.ui.Components.mz0 mz0Var = uz0Var.d(i10).f26840b;
            if (mz0Var != null) {
    ...
    public void setBlock(TL_iv.pageBlockTable pageblocktable) {
        ...
        uz0Var.K.clear();
        uz0Var.g();
        uz0Var.setDrawLines(this.f38297s.bordered);
        uz0Var.setStriped(this.f38297s.striped);
        g4 g4Var = this.f38292b;
        if (g4Var != null && g4Var.G) {
            z10 = true;
        } else {
