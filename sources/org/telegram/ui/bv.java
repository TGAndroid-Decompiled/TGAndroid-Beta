...
public final class bv extends LinearLayout {
    public final wb1 f32480a;
    public s4.c0 f32481b;
    public final org.telegram.ui.Components.lp f32482c;
    public final org.telegram.ui.Components.ij0 d;
    public final org.telegram.ui.Cells.r8 e;
    public final org.telegram.ui.Cells.r8 f32483f;
    public ValueAnimator h;
    public int f32484n;
    public int f32485r;
    public final int f32486s;
    public int v;
    ...
    public bv(int i10, Context context, org.telegram.ui.ActionBar.m2 m2Var) {
        ...
        if (i10 == 0) {
            ...
            this.e = r8Var;
            r8Var.setBackground(org.telegram.ui.ActionBar.h6.f0(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19134i6, false), 2, -1));
            r8Var.f20867w = 21;
        ...
        if (!MediaDataController.getInstance(m2Var.getCurrentAccount()).defaultEmojiThemes.isEmpty()) {
            ...
            if (i10 == 0) {
                ...
                if (string != null && org.telegram.ui.ActionBar.h6.N0(string) != null) {
                    if (i12 == -1) {
                        i12 = org.telegram.ui.ActionBar.h6.N0(string).f18927f0;
                    }
                } else {
                ...
                if (string2 != null && org.telegram.ui.ActionBar.h6.N0(string2) != null) {
                    if (i14 == -1) {
                        i14 = org.telegram.ui.ActionBar.h6.N0(str).f18927f0;
                    }
                } else {
                ...
                a4Var.f18695a = org.telegram.ui.ActionBar.h6.N0(str);
                a4Var.e = i13;
                b4Var.f18745f.add(a4Var);
                b4Var.f18745f.add(null);
                org.telegram.ui.ActionBar.a4 a4Var2 = new org.telegram.ui.ActionBar.a4();
                a4Var2.f18695a = org.telegram.ui.ActionBar.h6.N0(str2);
                a4Var2.e = i14;
                b4Var.f18745f.add(a4Var2);
                b4Var.f18745f.add(null);
                b4Var.n(m2Var.getCurrentAccount());
                org.telegram.ui.Components.mp mpVar = new org.telegram.ui.Components.mp(b4Var);
                mpVar.f26559c = org.telegram.ui.ActionBar.h6.f1() ? 0 : 2;
                arrayList.add(mpVar);
            }
            lpVar.d = arrayList;
            lpVar.l();
        ...
        d();
        a();
        int i15 = this.f32485r;
        if (i15 >= 0 && (c0Var = this.f32481b) != null) {
            c0Var.h1(i15, AndroidUtilities.dp(16.0f));
        }
    }

    public final void a() {
        int i10 = this.f32486s;
        if (i10 == 0 || i10 == -1) {
            ...
            if (r8Var != null) {
                org.telegram.ui.ActionBar.h6.B1(r8Var.getBackground(), org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19134i6, false), true);
                r8Var.e(-1, org.telegram.ui.ActionBar.h6.q6);
            }
            org.telegram.ui.Cells.r8 r8Var2 = this.f32483f;
            if (r8Var2 != null) {
                r8Var2.setBackground(org.telegram.ui.ActionBar.h6.g0(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19045d6, false), org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19134i6, false)));
    ...
    public final void b() {
        ...
        org.telegram.ui.Components.lp lpVar = this.f32482c;
        if (lpVar.d != null) {
            for (int i14 = 0; i14 < lpVar.d.size(); i14++) {
                ((org.telegram.ui.Components.mp) lpVar.d.get(i14)).f26559c = this.v;
            }
    ...
    public final void c() {
        ...
        Boolean bool = this.f32487w;
        if (bool != null && bool.booleanValue() == z10) {
            return;
        }
        wb1 wb1Var = this.f32480a;
        int i11 = this.f32486s;
        if (i11 != 0 && i11 != -1) {
            if (z10) {
                i10 = 3;
            } else {
    ...
    public final void d() {
        ...
        while (true) {
            ...
            org.telegram.ui.ActionBar.b4 b4Var = ((org.telegram.ui.Components.mp) lpVar.d.get(i10)).f26557a;
            TLRPC.TL_theme tL_theme = ((org.telegram.ui.ActionBar.a4) b4Var.f18745f.get(this.v)).f18696b;
            org.telegram.ui.ActionBar.g6 j3 = ((org.telegram.ui.Components.mp) lpVar.d.get(i10)).f26557a.j(this.v);
            if (tL_theme != null) {
                org.telegram.ui.ActionBar.b4 b4Var2 = ((org.telegram.ui.Components.mp) lpVar.d.get(i10)).f26557a;
                if (org.telegram.ui.ActionBar.h6.I.f18918a.equals(org.telegram.ui.ActionBar.h6.q0(tL_theme.settings.get(((org.telegram.ui.ActionBar.a4) b4Var2.f18745f.get(this.v)).d)))) {
                    LongSparseArray longSparseArray = org.telegram.ui.ActionBar.h6.I.f18923c0;
                    if (longSparseArray == null) {
                        this.f32485r = i10;
                        break;
                    }
                    org.telegram.ui.ActionBar.f6 f6Var = (org.telegram.ui.ActionBar.f6) longSparseArray.get(tL_theme.f18458id);
                    if (f6Var != null && f6Var.f18871a == org.telegram.ui.ActionBar.h6.I.Y) {
                        this.f32485r = i10;
                        break;
                    }
                } else {
                ...
                if (j3 != null) {
                    if (org.telegram.ui.ActionBar.h6.I.f18918a.equals(j3.m())) {
                        org.telegram.ui.ActionBar.b4 b4Var3 = ((org.telegram.ui.Components.mp) lpVar.d.get(i10)).f26557a;
                        if (((org.telegram.ui.ActionBar.a4) b4Var3.f18745f.get(this.v)).e == org.telegram.ui.ActionBar.h6.I.Y) {
                            this.f32485r = i10;
                            break;
                        }
                    } else {
        ...
        if (this.f32485r == -1 && this.f32486s != 3) {
            this.f32485r = lpVar.d.size() - 1;
        }
