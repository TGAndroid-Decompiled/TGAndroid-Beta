...
public final class bv extends LinearLayout {
    ...
    public final org.telegram.ui.Components.lp f32497c;
    ...
    public bv(int i10, Context context, org.telegram.ui.ActionBar.m2 m2Var) {
        ...
        if (!MediaDataController.getInstance(m2Var.getCurrentAccount()).defaultEmojiThemes.isEmpty()) {
            ...
            if (i10 == 0) {
                ...
                mpVar.f26567c = org.telegram.ui.ActionBar.h6.f1() ? 0 : 2;
                arrayList.add(mpVar);
            }
            lpVar.d = arrayList;
            lpVar.l();
    ...
    public final void b() {
        ...
        org.telegram.ui.Components.lp lpVar = this.f32497c;
        if (lpVar.d != null) {
            for (int i14 = 0; i14 < lpVar.d.size(); i14++) {
                ((org.telegram.ui.Components.mp) lpVar.d.get(i14)).f26567c = this.v;
            }
    ...
    public final void d() {
        ...
        while (true) {
            ...
            org.telegram.ui.ActionBar.b4 b4Var = ((org.telegram.ui.Components.mp) lpVar.d.get(i10)).f26565a;
            TLRPC.TL_theme tL_theme = ((org.telegram.ui.ActionBar.a4) b4Var.f18760f.get(this.v)).f18711b;
            org.telegram.ui.ActionBar.g6 j3 = ((org.telegram.ui.Components.mp) lpVar.d.get(i10)).f26565a.j(this.v);
            if (tL_theme != null) {
                org.telegram.ui.ActionBar.b4 b4Var2 = ((org.telegram.ui.Components.mp) lpVar.d.get(i10)).f26565a;
                ...
                if (j3 != null) {
                    if (org.telegram.ui.ActionBar.h6.I.f18933a.equals(j3.m())) {
                        org.telegram.ui.ActionBar.b4 b4Var3 = ((org.telegram.ui.Components.mp) lpVar.d.get(i10)).f26565a;
