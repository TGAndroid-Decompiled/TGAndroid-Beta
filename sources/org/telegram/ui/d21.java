...
public abstract class d21 extends org.telegram.ui.Components.ga implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final f01 G;
    public final ci.a h;
    public final org.telegram.ui.Components.h81 f35654n;
    public final bi.f8 f35655r;
    public final c21 f35656s;
    public int v;
    public boolean f35657w;
    public ValueAnimator f35658x;
    public float f35659y;
    ...
    public d21(Context context, org.telegram.ui.Components.ov0 ov0Var, bi.f8 f8Var, final org.telegram.ui.Components.rr0 rr0Var) {
        ...
        int i14 = org.telegram.ui.ActionBar.j6.f20965s8;
        n10.P = i10;
        n10.Q = i11;
        n10.R = i12;
        n10.S = i13;
        n10.T = i14;
        n10.O.setColor(org.telegram.ui.ActionBar.j6.v0(i10, n10.f26674j0));
        n10.f26682r = 12;
                ...
                switch (r3) {
                    case 0:
                        ...
                        if (num.intValue() == -1) {
                            ...
                            org.telegram.ui.Components.e5.S(rr0Var2.f30105a, rr0Var2.f30106b, rr0Var2.f30107c, new org.telegram.ui.Components.kv(rr0Var2, 19));
                            return Boolean.TRUE;
                        }
                        return Boolean.FALSE;
                    default:
                        View view = (View) obj2;
                        if (num.intValue() != -1 && num.intValue() != 0 && !sr0Var.f35657w) {
                            ...
                            if (storiesController.i(xu0Var.f32729j1)) {
                                    ...
                                    public final void run() {
                                        switch (r3) {
                                            case 0:
                                                ...
                                                xu0Var2.O0(xu0Var2.f32754v1, xu0Var2.f32729j1, intValue);
                                                return;
                                            case 1:
                                                xu0 xu0Var3 = rr0Var3.d;
                                                xu0Var3.Q0(xu0Var3.f32754v1, xu0Var3.f32729j1, intValue);
                                                return;
                                            case 2:
                                            ...
                                            default:
                                                ...
                                                xu0Var4.P0(xu0Var4.f32754v1, xu0Var4.f32729j1, intValue);
                                                return;
                                        }
                                    }
                                }, false);
                                xu0Var.x(H, n2Var, xu0Var.f32729j1, intValue);
    ...
    public final void b(boolean z10, boolean z11, boolean z12) {
        ...
        this.E = z10;
        setEnabled(z10);
        ValueAnimator valueAnimator = this.f35658x;
        ...
        float f10 = this.f35659y;
        if (z10) {
            f7 = 1.0f;
        }
        ValueAnimator ofFloat = ValueAnimator.ofFloat(f10, f7);
        this.f35658x = ofFloat;
        ofFloat.setDuration(480L);
        this.f35658x.setInterpolator(org.telegram.ui.Components.pr.h);
        this.f35658x.addUpdateListener(new b21(this, 0));
        this.f35658x.start();
    }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.storyAlbumsCollectionsUpdate) {
            ...
            bi.f8 f8Var = this.f35655r;
            if (longValue == f8Var.f3007b) {
                org.telegram.ui.Components.h81 h81Var = this.f35654n;
                if (h81Var != null) {
    ...
    public int getCurrentAlbumId() {
        return this.f35656s.f(this.f35654n.getCurrentPosition());
    }
    ...
    public float getVisualHeight() {
        return getMeasuredHeight() * this.f35659y;
    }

    @Override
    public final void onAttachedToWindow() {
        super.onAttachedToWindow();
        NotificationCenter.getInstance(this.f35655r.f3006a).addObserver(this, NotificationCenter.storyAlbumsCollectionsUpdate);
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        NotificationCenter.getInstance(this.f35655r.f3006a).removeObserver(this, NotificationCenter.storyAlbumsCollectionsUpdate);
    }
