...
public abstract class d21 extends org.telegram.ui.Components.ga implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final f01 G;
    public final ci.a h;
    public final org.telegram.ui.Components.h81 f35627n;
    public final bi.f8 f35628r;
    public final c21 f35629s;
    public int v;
    public boolean f35630w;
    public ValueAnimator f35631x;
    public float f35632y;
    ...
    public d21(Context context, org.telegram.ui.Components.ov0 ov0Var, bi.f8 f8Var, final org.telegram.ui.Components.rr0 rr0Var) {
        ...
        int i14 = org.telegram.ui.ActionBar.j6.f20938s8;
        n10.P = i10;
        n10.Q = i11;
        n10.R = i12;
        n10.S = i13;
        n10.T = i14;
        n10.O.setColor(org.telegram.ui.ActionBar.j6.v0(i10, n10.f26647j0));
        n10.f26655r = 12;
                ...
                switch (r3) {
                    case 0:
                        ...
                        if (num.intValue() == -1) {
                            ...
                            org.telegram.ui.Components.e5.S(rr0Var2.f30078a, rr0Var2.f30079b, rr0Var2.f30080c, new org.telegram.ui.Components.kv(rr0Var2, 19));
                            return Boolean.TRUE;
                        }
                        return Boolean.FALSE;
                    default:
                        View view = (View) obj2;
                        if (num.intValue() != -1 && num.intValue() != 0 && !sr0Var.f35630w) {
                            ...
                            if (storiesController.i(xu0Var.f32702j1)) {
                                    ...
                                    public final void run() {
                                        switch (r3) {
                                            case 0:
                                                ...
                                                xu0Var2.O0(xu0Var2.f32727v1, xu0Var2.f32702j1, intValue);
                                                return;
                                            case 1:
                                                xu0 xu0Var3 = rr0Var3.d;
                                                xu0Var3.Q0(xu0Var3.f32727v1, xu0Var3.f32702j1, intValue);
                                                return;
                                            case 2:
                                            ...
                                            default:
                                                ...
                                                xu0Var4.P0(xu0Var4.f32727v1, xu0Var4.f32702j1, intValue);
                                                return;
                                        }
                                    }
                                }, false);
                                xu0Var.x(H, n2Var, xu0Var.f32702j1, intValue);
    ...
    public final void b(boolean z10, boolean z11, boolean z12) {
        ...
        this.E = z10;
        setEnabled(z10);
        ValueAnimator valueAnimator = this.f35631x;
        ...
        float f10 = this.f35632y;
        if (z10) {
            f7 = 1.0f;
        }
        ValueAnimator ofFloat = ValueAnimator.ofFloat(f10, f7);
        this.f35631x = ofFloat;
        ofFloat.setDuration(480L);
        this.f35631x.setInterpolator(org.telegram.ui.Components.pr.h);
        this.f35631x.addUpdateListener(new b21(this, 0));
        this.f35631x.start();
    }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.storyAlbumsCollectionsUpdate) {
            ...
            bi.f8 f8Var = this.f35628r;
            if (longValue == f8Var.f2980b) {
                org.telegram.ui.Components.h81 h81Var = this.f35627n;
                if (h81Var != null) {
    ...
    public int getCurrentAlbumId() {
        return this.f35629s.f(this.f35627n.getCurrentPosition());
    }
    ...
    public float getVisualHeight() {
        return getMeasuredHeight() * this.f35632y;
    }

    @Override
    public final void onAttachedToWindow() {
        super.onAttachedToWindow();
        NotificationCenter.getInstance(this.f35628r.f2979a).addObserver(this, NotificationCenter.storyAlbumsCollectionsUpdate);
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        NotificationCenter.getInstance(this.f35628r.f2979a).removeObserver(this, NotificationCenter.storyAlbumsCollectionsUpdate);
    }
