    ...
    public final void b(org.telegram.ui.Components.qc qcVar) {
        switch (this.f43360a) {
            ...
            case 2:
                ...
                co coVar = (co) this.f43361b;
                dh.d c10 = coVar.J.c(ubVar, null, true);
                eh.e eVar = new eh.e(coVar.f35274ea);
            ...
            case 3:
                return;
            case 4:
                uy uyVar = (uy) this.f43361b;
                UndoView undoView = uyVar.f41388y0[0];
                if (undoView != null && undoView.getVisibility() == 0) {
                    uyVar.f41388y0[0].e(2, true);
                    return;
                }
                return;
            case 5:
    ...
    public final void c(float f7) {
        switch (this.f43360a) {
            ...
            case 2:
                return;
            case 3:
                ContactsActivity contactsActivity = (ContactsActivity) this.f43361b;
                contactsActivity.f33384p0 = Math.max(0.0f, (f7 - contactsActivity.f33385q0) - contactsActivity.f33383o0);
                contactsActivity.i0();
                return;
            case 4:
                uy uyVar = (uy) this.f43361b;
                UndoView undoView = uyVar.f41388y0[0];
                if (undoView == null || undoView.getVisibility() != 0) {
                    uyVar.f41367u1 = Math.max(0.0f, (f7 - uyVar.f41301g4) - uyVar.f41315j4);
                    uyVar.X4();
                    return;
                }
                return;
    ...
    public final boolean e() {
        switch (this.f43360a) {
            ...
            case 7:
                return true;
            case 8:
                if (((ProfileActivity) this.f43361b).f34015s5 == null) {
                    return true;
                }
                return false;
            default:
    ...
    public final int f(int i10) {
        ...
        switch (this.f43360a) {
            case 0:
                ...
                break;
            case 1:
                return ((bd) this.f43361b).O.getMeasuredHeight();
            case 2:
                co coVar = (co) this.f43361b;
                if (i10 == 1) {
                    return 0;
                }
                return Math.round(coVar.S.getInputBubbleHeight() + AndroidUtilities.dp(16.0f) + coVar.W8(org.telegram.ui.Components.s21.f30205c) + coVar.v.c());
            case 3:
                ContactsActivity contactsActivity = (ContactsActivity) this.f43361b;
                i11 = contactsActivity.f33385q0;
                i12 = contactsActivity.f33383o0;
                break;
            case 4:
                uy uyVar = (uy) this.f43361b;
                if (uyVar.X2 != 0) {
                    return AndroidUtilities.dp(60.0f) + uyVar.f41301g4;
                }
                return uyVar.n3();
            case 5:
                i12 = ((eh0) this.f43361b).L;
                i11 = AndroidUtilities.dp(64.0f);
                break;
            case 6:
                PhotoViewer photoViewer = ((uu0) this.f43361b).E0;
                int i13 = 0;
                if (photoViewer.R4) {
                ...
                bi.g5 g5Var = photoViewer.f33611i0;
                if (g5Var != null && g5Var.getVisibility() == 0) {
                    i13 = (int) ((photoViewer.f33611i0.getAlpha() * photoViewer.f33611i0.getHeight()) + 0);
                }
                org.telegram.ui.Components.v30 v30Var = photoViewer.l1;
                if (v30Var != null && v30Var.c()) {
                    if (AndroidUtilities.isTablet() || photoViewer.f33576e0.getMeasuredHeight() > photoViewer.f33576e0.getMeasuredWidth()) {
                ...
                return i13;
            case 7:
                return ((PremiumPreviewFragment) this.f43361b).f33816o0.d;
            case 8:
                ProfileActivity profileActivity = (ProfileActivity) this.f43361b;
                if (profileActivity.f34015s5 == null) {
                    return profileActivity.f33967l6 + profileActivity.f33962k6;
                }
                return profileActivity.f33967l6 + profileActivity.f33962k6 + ((int) (((AndroidUtilities.dp(52.0f) - profileActivity.f34015s5.getTranslationY()) - (profileActivity.f34022t5[1].getTranslationY() * profileActivity.O.g0(9, false))) - (profileActivity.f34022t5[0].getTranslationY() * profileActivity.O.g0(8, true))));
            default:
                eg1 eg1Var = (eg1) this.f43361b;
                v51 v51Var = eg1Var.f36083o0;
                if (v51Var != null && v51Var.getVisibility() == 0) {
                    return eg1Var.f36083o0.getMeasuredHeight();
                }
                return 0;
        }
        return i11 + i12;
    ...
    public final int h(int i10) {
        ...
        switch (this.f43360a) {
            ...
            case 2:
                ...
                max2 = (int) Math.max(0.0f, coVar.f35458t9);
                break;
            case 3:
                return 0;
            case 4:
                ...
                if (swVar != null && swVar.getVisibility() == 0) {
                    i13 = uyVar.f41391z0.getMeasuredHeight();
                } else {
                    i13 = 0;
                }
                int i16 = i12 + i13;
