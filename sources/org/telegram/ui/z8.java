    ...
    public final void b(org.telegram.ui.Components.qc qcVar) {
        switch (this.f40404a) {
            ...
            case 4:
                ...
                UndoView undoView = qyVar.f37134y0[0];
                if (undoView != null && undoView.getVisibility() == 0) {
                    qyVar.f37134y0[0].e(2, true);
                    return;
                }
                return;
            case 5:
    ...
    public final void c(float f7) {
        switch (this.f40404a) {
            ...
            case 3:
                ...
                contactsActivity.f31039p0 = Math.max(0.0f, (f7 - contactsActivity.f31040q0) - contactsActivity.f31038o0);
                contactsActivity.i0();
                return;
            case 4:
                qy qyVar = (qy) this.f40405b;
                UndoView undoView = qyVar.f37134y0[0];
                if (undoView == null || undoView.getVisibility() != 0) {
                    qyVar.f37114u1 = Math.max(0.0f, (f7 - qyVar.f37043f4) - qyVar.f37058i4);
                    qyVar.X4();
                    return;
                }
                return;
    ...
    public final boolean e() {
        switch (this.f40404a) {
            ...
            case 7:
                return true;
            case 8:
                if (((ProfileActivity) this.f40405b).f31655s5 == null) {
                    return true;
                }
                return false;
            default:
    ...
    public final int f(int i10) {
        ...
        switch (this.f40404a) {
            ...
            case 2:
                ...
                return Math.round(wnVar.S.getInputBubbleHeight() + AndroidUtilities.dp(16.0f) + wnVar.W8(org.telegram.ui.Components.g31.f24360c) + wnVar.v.c());
            case 3:
                ContactsActivity contactsActivity = (ContactsActivity) this.f40405b;
                i11 = contactsActivity.f31040q0;
                i12 = contactsActivity.f31038o0;
                break;
            case 4:
                qy qyVar = (qy) this.f40405b;
                if (qyVar.X2 != 0) {
                    return AndroidUtilities.dp(60.0f) + qyVar.f37043f4;
                }
                return qyVar.n3();
            case 5:
            ...
            case 6:
                ...
                ai.w5 w5Var = photoViewer.f31258i0;
                if (w5Var != null && w5Var.getVisibility() == 0) {
                    i13 = (int) ((photoViewer.f31258i0.getAlpha() * photoViewer.f31258i0.getHeight()) + 0);
                }
                org.telegram.ui.Components.w30 w30Var = photoViewer.l1;
                if (w30Var != null && w30Var.c()) {
                    if (AndroidUtilities.isTablet() || photoViewer.f31223e0.getMeasuredHeight() > photoViewer.f31223e0.getMeasuredWidth()) {
                ...
                return i13;
            case 7:
                return ((PremiumPreviewFragment) this.f40405b).f31459o0.d;
            case 8:
                ProfileActivity profileActivity = (ProfileActivity) this.f40405b;
                if (profileActivity.f31655s5 == null) {
                    return profileActivity.f31607l6 + profileActivity.f31602k6;
                }
                return profileActivity.f31607l6 + profileActivity.f31602k6 + ((int) (((AndroidUtilities.dp(52.0f) - profileActivity.f31655s5.getTranslationY()) - (profileActivity.f31662t5[1].getTranslationY() * profileActivity.O.g0(9, false))) - (profileActivity.f31662t5[0].getTranslationY() * profileActivity.O.g0(8, true))));
            default:
        ...
        switch (this.f40404a) {
            ...
            case 4:
                ...
                if (nwVar != null && nwVar.getVisibility() == 0) {
                    i13 = qyVar.f37137z0.getMeasuredHeight();
                } else {
                    i13 = 0;
                }
                int i16 = i12 + i13;
