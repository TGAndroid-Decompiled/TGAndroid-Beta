...
public class AvatarSpan extends ReplacementSpan {
    ...
    public void draw(Canvas canvas, CharSequence charSequence, int i, int i2, float f, int i3, int i4, int i5, Paint paint) {
        if (this.needDrawShadow) {
            ...
            canvas.drawCircle((AndroidUtilities.dp(this.sz) / 2.0f) + this.translateX + f, ((i3 + i5) / 2.0f) + this.translateY, AndroidUtilities.dp(this.sz) / 2.0f, this.shadowPaint);
        }
        this.imageReceiver.setImageCoords(this.translateX + f, (((i3 + i5) / 2.0f) + this.translateY) - (AndroidUtilities.dp(this.sz) / 2.0f), AndroidUtilities.dp(this.sz), AndroidUtilities.dp(this.sz));
    ...
    public void setName(String str) {
        this.avatarDrawable.setInfo(0L, str, null, null, null, null);
        this.imageReceiver.setForUserOrChat(null, this.avatarDrawable);
    }
