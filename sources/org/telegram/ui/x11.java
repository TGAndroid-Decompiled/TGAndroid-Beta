...
public final class x11 extends FrameLayout {
    public final TextView f39794a;
    public final TextView f39795b;
    public final ImageView f39796c;
    public SharedConfig.ProxyInfo d;
    public Drawable e;
    public final org.telegram.ui.Components.op f39797f;
    public boolean h;
    public boolean f39798n;
    public int f39799r;
    public final ProxyListActivity f39800s;
    ...
    public x11(ProxyListActivity proxyListActivity, Context context) {
        ...
        int i16;
        int i17;
        this.f39800s = proxyListActivity;
        TextView textView = new TextView(context);
        this.f39794a = textView;
    ...
    public final void a(boolean z10, boolean z11) {
        ...
        if (!z11) {
            ...
            this.f39794a.setTranslationX(f10);
            this.f39795b.setTranslationX(f10);
            ImageView imageView = this.f39796c;
            ...
            float f12 = dp2 + f10;
            org.telegram.ui.Components.op opVar = this.f39797f;
    ...
    public void setChecked(boolean z10) {
        TextView textView = this.f39795b;
        if (z10) {
            if (this.e == null) {
            ...
            if (drawable != null) {
                drawable.setColorFilter(new PorterDuffColorFilter(this.f39799r, PorterDuff.Mode.MULTIPLY));
            }
            if (LocaleController.isRTL) {
    ...
    public void setValue(CharSequence charSequence) {
        this.f39795b.setText(charSequence);
    }
}
