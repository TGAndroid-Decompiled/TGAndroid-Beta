...
public final class sn0 implements TextWatcher {
    ...
    public final void afterTextChanged(Editable editable) {
        ...
        if (qo0Var.C0.invoice.max_tip_amount != 0) {
            ...
            long j10 = qo0Var.C0.invoice.max_tip_amount;
            if (longValue3 > j10) {
                qo0Var.H0 = Long.valueOf(j10);
            }
        }
        int selectionStart = qo0Var.f36496f[0].getSelectionStart();
        qo0Var.m0 = true;
        if (qo0Var.H0.longValue() == 0) {
            qo0Var.f36496f[0].setText("");
        } else {
            EditTextBoldCursor editTextBoldCursor = qo0Var.f36496f[0];
            str4 = LocaleController.getInstance().formatCurrencyString(qo0Var.H0.longValue(), false, z10, true, qo0Var.C0.invoice.currency);
            editTextBoldCursor.setText(str4);
        }
        if (j3 < qo0Var.H0.longValue() && j3 != 0 && this.f37338a && selectionStart >= 0) {
            EditTextBoldCursor editTextBoldCursor2 = qo0Var.f36496f[0];
            editTextBoldCursor2.setSelection(Math.min(selectionStart, editTextBoldCursor2.length()));
        } else if (this.f37340c && this.d != qo0Var.f36496f[0].length()) {
            EditTextBoldCursor editTextBoldCursor3 = qo0Var.f36496f[0];
            editTextBoldCursor3.setSelection(Math.max(0, Math.min(selectionStart, editTextBoldCursor3.length())));
        } else if (!this.f37341f && z10 && a2 >= 0) {
            int a10 = a(str4);
            if (a10 > 0) {
                qo0Var.f36496f[0].setSelection(a10 + 1);
            } else {
                EditTextBoldCursor editTextBoldCursor4 = qo0Var.f36496f[0];
                editTextBoldCursor4.setSelection(editTextBoldCursor4.length());
            }
        } else {
            EditTextBoldCursor editTextBoldCursor5 = qo0Var.f36496f[0];
    ...
    public final void beforeTextChanged(CharSequence charSequence, int i10, int i11, int i12) {
        ...
        String str;
        if (!this.f37342n.m0) {
            this.f37338a = !TextUtils.isEmpty(charSequence);
            this.f37339b = null;
            ...
            if (z10) {
                ...
                if ((charAt >= '0' && charAt <= '9') || (str.length() != 0 && longValue == 0)) {
                    if (a2 > 0 && i10 > a2 && longValue == 0) {
                        this.f37339b = fixNumbers.substring(0, a2 - 1);
                        return;
                    }
                    return;
                }
                while (true) {
                    ...
                    if (i13 >= 0) {
                        ...
                        if (charAt2 >= '0' && charAt2 <= '9') {
                            this.f37339b = fixNumbers.substring(0, i13) + fixNumbers.substring(i10);
                            return;
                        }
                        i10 = i13;
                    } else {
