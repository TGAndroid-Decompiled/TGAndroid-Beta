...
public final class gu implements Utilities.Callback {
    ...
    public final void run(Object obj) {
        ...
        switch (this.f34047a) {
            case 0:
                DataSettingsActivity dataSettingsActivity = (DataSettingsActivity) this.f34049c;
                Long l4 = (Long) obj;
                AndroidUtilities.cancelRunOnUIThread((fu) this.d);
                if (!dataSettingsActivity.W && System.currentTimeMillis() - this.f34048b <= 120) {
                    z10 = false;
                } else {
                    z10 = true;
                }
            ...
            case 1:
                ...
                qy qyVar = ((px) this.f34049c).f36690b;
                Boolean bool = qyVar.G.bot_participant;
                if (bool != null && bool.booleanValue()) {
                    qyVar.getMessagesController().addUserToChat(this.f34048b, qyVar.getMessagesController().getUser(Long.valueOf(qyVar.H)), 0, null, qyVar, false, runnable, new kf(8, runnable));
                    return;
                }
                runnable.run();
                return;
            case 2:
                ProfileActivity.k0((ProfileActivity) this.f34049c, (Context) this.d, this.f34048b, (TL_payments.connectedBotStarRef) obj);
                return;
            default:
                yh.x3 x3Var = (yh.x3) this.f34049c;
