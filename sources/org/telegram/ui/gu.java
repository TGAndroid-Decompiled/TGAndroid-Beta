...
public final class gu implements org.telegram.ui.Components.bl0, org.telegram.ui.Components.tv0, org.telegram.ui.ActionBar.b2, MessagesController.ErrorDelegate, org.telegram.ui.Components.tg0, Utilities.Callback5, org.telegram.ui.Components.rd0, org.telegram.ui.ActionBar.m1, org.telegram.ui.Components.xk0, gg.b2, org.telegram.ui.Components.cl0, r0.n, bu, le.d, vj0 {
    ...
    public r0.l1 Q0(View view, r0.l1 l1Var) {
        ya0 ya0Var = (ya0) this.f34044b;
        i0.b defaultWindowInsets = AndroidUtilities.getDefaultWindowInsets(l1Var, false);
        if (!ya0Var.f39842a.equals(defaultWindowInsets)) {
            ya0Var.f39842a = defaultWindowInsets;
    ...
    public void a(Canvas canvas) {
        ((Layout) this.f34044b).draw(canvas);
    }

    @Override
    public void a1(xt xtVar) {
        xg0 xg0Var = (xg0) this.f34044b;
        xg0Var.I = true;
        String str = xtVar.f39697c;
        xg0Var.f39614a.setText(str);
        xg0Var.v(str, xtVar);
        xg0Var.f39623y = xtVar;
        xg0Var.f39622x = 0;
        xg0Var.I = false;
        SharedPreferences.Editor edit = MessagesController.getGlobalMainSettings().edit();
        edit.putString("phone_code_last_matched_" + xtVar.f39697c, xtVar.d).apply();
    ...
    public void c(float f7, float f10, int i10, View view) {
        ...
        switch (this.f34043a) {
            case 0:
                DataAutoDownloadActivity.W((DataAutoDownloadActivity) this.f34044b, view, i10, f7);
                return;
            case 17:
                pc0 pc0Var = (pc0) this.f34044b;
                ArrayList arrayList = pc0Var.f36598s;
                if (view != null && i10 >= 0 && i10 < arrayList.size()) {
                    jc0 jc0Var = (jc0) arrayList.get(i10);
                    int i11 = jc0Var.f15543a;
                    int i12 = jc0Var.e;
                    if (i11 != 3 && i11 != 4) {
                        if (i11 == 5 && jc0Var.f34841f == 1) {
    ...
    public boolean d(int i10, View view) {
        ...
        switch (this.f34043a) {
            case 14:
                return LanguageSelectActivity.V((LanguageSelectActivity) this.f34044b, view, i10);
            case 24:
                final lj0 lj0Var = (lj0) this.f34044b;
                if (i10 >= lj0Var.I && i10 < lj0Var.J) {
                    try {
                        view.performHapticFeedback(0, 2);
                    } catch (Exception unused) {
                    }
                    final MessageObject messageObject = (MessageObject) lj0Var.f35574x.get(i10 - lj0Var.I);
    ...
    public void f(org.telegram.ui.ActionBar.c2 c2Var, int i10) {
        ...
        switch (i12) {
            ...
            case 19:
                re0 re0Var = (re0) obj;
                yg0.n0(re0Var.f37208y, re0Var.f37205s, re0Var.v, re0Var.f37206w);
                return;
            case 20:
                kf0 kf0Var = (kf0) obj;
                yg0 yg0Var = kf0Var.E;
            ...
            default:
                ...
                for (int i13 = 0; i13 < sparseArray.size(); i13++) {
                        ...
                        if (document2 != null) {
                            ...
                            while (true) {
                                if (i14 < arrayList2.size()) {
                                    if (((uf.b) arrayList2.get(i14)).f43713a != null && ((uf.b) arrayList2.get(i14)).f43713a.f18127id == document2.f18127id) {
                    ...
                    if (yk0Var.f39931g != null && (dVar = al0Var.getMediaDataController().ringtoneUploaderHashMap.get(yk0Var.f39931g)) != null) {
                        dVar.f43724c = true;
                        dVar.a();
                        int i15 = dVar.f43722a;
                    ...
                    if (yk0Var == al0Var.H) {
                        al0Var.N = null;
                        al0Var.H = (yk0) al0Var.f31914b.get(0);
                        al0Var.I = true;
                    }
                    al0Var.f31913a.remove(yk0Var);
                    al0Var.f31915c.remove(yk0Var);
                }
    ...
    public void g(int i10) {
        DataAutoDownloadActivity dataAutoDownloadActivity = ((ku) this.f34044b).d;
        DownloadController.Preset preset = (DownloadController.Preset) dataAutoDownloadActivity.f30785c.get(i10);
        if (preset == dataAutoDownloadActivity.f30792y) {
        ...
        int i11 = dataAutoDownloadActivity.f30786f;
        if (i11 == 0) {
        ...
        for (int i12 = 0; i12 < 4; i12++) {
            s4.c1 L = dataAutoDownloadActivity.f30784b.L(DataAutoDownloadActivity.i0(dataAutoDownloadActivity) + i12);
            if (L != null) {
                dataAutoDownloadActivity.f30783a.v(L, DataAutoDownloadActivity.i0(dataAutoDownloadActivity) + i12);
            }
        }
    ...
    public void h(int i10) {
        switch (this.f34043a) {
            case 12:
                e70 e70Var = (e70) this.f34044b;
                g70 g70Var = e70Var.I;
                g70Var.q0(e70Var.H);
                if (e70Var.h == null && !e70Var.f33304f.e() && e70Var.h() == 0) {
                    g70Var.f33890s.e(false, true);
                }
                e70Var.l();
                return;
            default:
                sk0 sk0Var = (sk0) this.f34044b;
                if (sk0Var.f37509f == null && !sk0Var.h.e()) {
                    sk0Var.f37510n.f30880c.c();
                }
                sk0Var.l();
                return;
        }
    ...
    public void i(org.telegram.ui.Components.sd0 sd0Var) {
        ExternalActionActivity externalActionActivity = (ExternalActionActivity) this.f34044b;
        ArrayList arrayList = ExternalActionActivity.f30803x;
        SharedConfig.isWaitingForPasscodeEnter = false;
        Intent intent = externalActionActivity.h;
        if (intent != null) {
            externalActionActivity.d(intent, externalActionActivity.f30809n, externalActionActivity.v, true, externalActionActivity.f30810r, externalActionActivity.f30811s);
            externalActionActivity.h = null;
        }
        externalActionActivity.f30807c.c0();
    ...
    public void o(KeyEvent keyEvent) {
        c00 c00Var = (c00) this.f34044b;
        if (keyEvent.getKeyCode() == 4 && keyEvent.getRepeatCount() == 0 && c00Var.f39735x.isShowing()) {
            c00Var.f39735x.d(true);
        }
    }
    ...
    @Override
    public int run() {
        return ((FiltersSetupActivity) this.f34044b).f30820w;
    }
    ...
    public void mo17run(Object obj, Object obj2, Object obj3, Object obj4, Object obj5) {
        switch (this.f34043a) {
            case 7:
                oz ozVar = (oz) this.f34044b;
                View view = (View) obj2;
                ((Integer) obj3).getClass();
                ((Float) obj4).getClass();
                ((Float) obj5).getClass();
                if (((org.telegram.ui.Components.j51) obj).d != 1 || ozVar.f36460b == null) {
                    return;
                }
                boolean z10 = !ozVar.f36461c;
                ozVar.f36461c = z10;
                ai.m0 m0Var = ozVar.f36462f;
                if (m0Var != null) {
                    m0Var.run(Boolean.valueOf(z10), Boolean.valueOf(ozVar.d));
                }
                ((org.telegram.ui.Cells.w8) view).setChecked(ozVar.f36461c);
                ozVar.e.Y2.N(true);
                return;
            default:
                org.telegram.ui.Components.ml0.P0((Canvas) obj, (RectF) obj2, ((Float) obj3).floatValue(), ((Float) obj4).floatValue(), ((Float) obj5).floatValue(), ((org.telegram.ui.Components.ml0) this.f34044b).f26191p2);
                return;
        }
    }
