...
public final class qk0 extends og.b {
    ...
    public final int j(int i10) {
        if (i10 >= 0) {
            ...
            if (i10 < notificationsCustomSettingsActivity.I.size()) {
                return ((pk0) notificationsCustomSettingsActivity.I.get(i10)).f15543a;
            }
            return 5;
        }
        return 5;
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i10 >= 0 && i10 < arrayList.size()) {
            ...
            boolean z11 = true;
            int i11 = i10 + 1;
            if (i11 < arrayList.size() && ((pk0) arrayList.get(i11)).f15543a != 4) {
                z10 = true;
            } else {
                z10 = false;
            }
            ...
            switch (i12) {
                case 0:
                    ...
                    return;
                case 1:
                    ((org.telegram.ui.Cells.w8) view).f("" + ((Object) pk0Var.e), pk0Var.f36656i, z10);
                    return;
                case 2:
                    ((org.telegram.ui.Cells.ab) view).g(pk0Var.f36655g, null, z10);
                    return;
                case 3:
                ...
                case 4:
                    ...
                    return;
                case 5:
                    ((org.telegram.ui.Cells.ea) view).c(pk0Var.e, pk0Var.f36654f, false, z10);
                    return;
                case 6:
                    org.telegram.ui.Cells.i5 i5Var = (org.telegram.ui.Cells.i5) view;
                    i5Var.setDrawLine(true);
                    i5Var.setChecked(pk0Var.f36656i);
                    i5Var.b(pk0Var.e, pk0Var.f36654f, pk0Var.d, pk0Var.f36656i, 0, false, z10, true);
                    return;
                case 7:
                    org.telegram.ui.Cells.r8 r8Var = (org.telegram.ui.Cells.r8) view;
                    if (pk0Var.d == 0) {
                        r8Var.e(-1, org.telegram.ui.ActionBar.j6.f19083p7);
                ...
                case 8:
                    ok0 ok0Var = (ok0) view;
                    ok0Var.e(org.telegram.ui.ActionBar.j6.f19193v6, org.telegram.ui.ActionBar.j6.f19175u6);
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        switch (i10) {
            ...
            case 8:
                ...
                imageView.setColorFilter(new PorterDuffColorFilter(notificationsCustomSettingsActivity.getThemedColor(org.telegram.ui.ActionBar.j6.f19193v6), PorterDuff.Mode.SRC_IN));
    ...
    public final void y(s4.c1 c1Var) {
        ...
        int i10 = notificationsCustomSettingsActivity.f30887s;
        if (i10 == 3 || ((arrayList2 = notificationsCustomSettingsActivity.f30888w) != null && arrayList2.isEmpty())) {
            if (i10 == 3) {
                Boolean bool = notificationsCustomSettingsActivity.f30885n;
                if (bool != null && !bool.booleanValue() && ((arrayList = notificationsCustomSettingsActivity.f30888w) == null || arrayList.isEmpty())) {
            ...
            if (pk0Var == null || pk0Var.f36653c != 102) {
