...
public final class qk0 extends org.telegram.ui.Components.kl0 {
    ...
    public final NotificationsCustomSettingsActivity f36898n;

    public qk0(NotificationsCustomSettingsActivity notificationsCustomSettingsActivity, Context context) {
        this.f36898n = notificationsCustomSettingsActivity;
        this.f36896c = context;
        gg.c2 c2Var = new gg.c2(true);
        this.h = c2Var;
        c2Var.f9686a = new hu(this, 25);
    }
    ...
    public final void F(String str) {
        ...
        if (this.f36897f != null) {
            Utilities.searchQueue.cancelRunnable(this.f36897f);
            this.f36897f = null;
        }
        if (str == null) {
            this.d.clear();
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        View abVar;
        if (i10 != 0) {
            abVar = new org.telegram.ui.Cells.v3(this.f36896c, null);
            abVar.setBackgroundColor(0);
            abVar.setTag(-33024);
        } else {
            abVar = new org.telegram.ui.Cells.ab(4, 0, this.f36896c, null, false, true);
        }
