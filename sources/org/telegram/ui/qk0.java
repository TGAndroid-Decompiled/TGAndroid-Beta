...
public final class qk0 extends og.b {
        ...
        if (i10 >= 0 && i10 < arrayList.size()) {
            ...
            switch (i12) {
                case 0:
                    ...
                    return;
                case 1:
                    ((org.telegram.ui.Cells.w8) view).f("" + ((Object) pk0Var.e), pk0Var.f36651i, z10);
                    return;
                case 2:
                    ((org.telegram.ui.Cells.ab) view).g(pk0Var.f36650g, null, z10);
                    return;
                case 3:
                ...
                case 4:
                    ...
                    return;
                case 5:
                    ((org.telegram.ui.Cells.ea) view).c(pk0Var.e, pk0Var.f36649f, false, z10);
                    return;
                case 6:
                    org.telegram.ui.Cells.i5 i5Var = (org.telegram.ui.Cells.i5) view;
                    i5Var.setDrawLine(true);
                    i5Var.setChecked(pk0Var.f36651i);
                    i5Var.b(pk0Var.e, pk0Var.f36649f, pk0Var.d, pk0Var.f36651i, 0, false, z10, true);
                    return;
                case 7:
                ...
                case 8:
                    ok0 ok0Var = (ok0) view;
                    ok0Var.e(org.telegram.ui.ActionBar.j6.f19192v6, org.telegram.ui.ActionBar.j6.f19174u6);
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        switch (i10) {
            ...
            case 8:
                ...
                imageView.setColorFilter(new PorterDuffColorFilter(notificationsCustomSettingsActivity.getThemedColor(org.telegram.ui.ActionBar.j6.f19192v6), PorterDuff.Mode.SRC_IN));
    ...
    public final void y(s4.c1 c1Var) {
        ...
        int i10 = notificationsCustomSettingsActivity.f30884s;
        if (i10 == 3 || ((arrayList2 = notificationsCustomSettingsActivity.f30885w) != null && arrayList2.isEmpty())) {
            if (i10 == 3) {
                Boolean bool = notificationsCustomSettingsActivity.f30882n;
                if (bool != null && !bool.booleanValue() && ((arrayList = notificationsCustomSettingsActivity.f30885w) == null || arrayList.isEmpty())) {
            ...
            if (pk0Var == null || pk0Var.f36648c != 102) {
