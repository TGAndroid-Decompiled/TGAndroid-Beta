...
public final class qk0 extends org.telegram.ui.ActionBar.p2 implements org.telegram.ui.Components.zj, NotificationCenter.NotificationCenterDelegate {
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.onUserRingtonesUpdated) {
            ...
            arrayList.clear();
            for (int i13 = 0; i13 < getMediaDataController().ringtoneDataStore.f7041e.size(); i13++) {
                gf.d dVar = (gf.d) getMediaDataController().ringtoneDataStore.f7041e.get(i13);
                ?? obj = new Object();
                ok0 ok0Var = (ok0) hashMap.get(Integer.valueOf(dVar.f7035c));
                if (ok0Var != null) {
                    if (ok0Var == this.E) {
                        this.E = obj;
                    }
