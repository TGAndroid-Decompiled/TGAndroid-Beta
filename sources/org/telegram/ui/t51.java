...
public abstract class t51 extends org.telegram.ui.Components.tl0 {
    ...
    public boolean Z2;
    public final LongSparseArray f41501a3;
    public final r61 f41502b3;

    public t51(r61 r61Var, Context context) {
        super(context, null);
        this.f41502b3 = r61Var;
        this.U2 = new SparseArray();
        this.V2 = new ArrayList();
        this.W2 = new ArrayList();
        this.X2 = new ArrayList();
        this.Y2 = new ArrayList();
        this.f41501a3 = new LongSparseArray();
    ...
    public final boolean H0(android.view.View r1, float r2, float r3) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.t51.H0(android.view.View, float, float):boolean");
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (getVisibility() == 0) {
            ...
            sparseArray.clear();
            if (r61Var.M1 > 0 && SystemClock.elapsedRealtime() - r61Var.M1 < r61Var.g() && r61Var.J1 != null && r61Var.K1 >= 0) {
                z4 = true;
            } else {
                z4 = false;
            }
            if (this.f41501a3 != null) {
                int i14 = 0;
                boolean z11 = false;
                while (i14 < getChildCount()) {
                    ...
                    if (childAt instanceof a61) {
                        ...
                        if (a61Var.isPressed()) {
                            float f14 = a61Var.K;
                            if (f14 != 1.0f && i15 != i12) {
                                a61Var.K = Utilities.clamp(f14 + 0.16f, 1.0f, 0.0f);
                                a61Var.invalidate();
                            }
                        }
                        int i16 = a61Var.f35039c;
                        if (r61Var.f40824t1) {
                        ...
                        if (a61Var.f35045w != null) {
                            ...
                            view = childAt;
                            canvas2.scale(f12, f13, a61Var.getWidth() / 2.0f, a61Var.getHeight() / 2.0f);
                            canvas2.rotate((i16 % 4) * 90, a61Var.getWidth() / 2.0f, a61Var.getHeight() / 2.0f);
                            collectionParticles.a(canvas2, a61Var.f35045w.intValue());
                            canvas2.restore();
                            z11 = z13;
                        } else {
                            i10 = i14;
                        ...
                        if ((z14 || a61Var.J || a61Var.P > 0.0f) && !a61Var.f35038b) {
                            if (z14 || a61Var.J) {
                                float f15 = a61Var.O;
                                if (f15 < 1.0f) {
                                    a61Var.O = ((1000.0f / AndroidUtilities.screenRefreshRate) / 240.0f) + f15;
                                    invalidate();
                                }
                            }
                            if (!a61Var.I && !a61Var.J) {
                                float f16 = a61Var.O;
                                if (f16 > 0.0f) {
                                    a61Var.O = f16 - ((1000.0f / AndroidUtilities.screenRefreshRate) / 240.0f);
                                    invalidate();
                                }
                            }
                            if (a61Var.I) {
                                interpolation = org.telegram.ui.Components.pr.h.getInterpolation(a61Var.O);
                            } else {
                                interpolation = 1.0f - org.telegram.ui.Components.pr.h.getInterpolation(1.0f - a61Var.O);
                            }
                            a61Var.P = Utilities.clamp(interpolation, 1.0f, 0.0f);
                            if (i15 == 6) {
                                f10 = 1.5f;
                            } else {
                                f10 = 1.0f;
                        ...
                        z51 z51Var = a61Var.G;
                        if (z51Var != null && z51Var.getVisibility() == 0 && a61Var.G.getImageReceiver() == null && (imageReceiver2 = a61Var.f35043r) != null) {
                            a61Var.G.setImageReceiver(imageReceiver2);
                        }
                    } else {
                        i10 = i14;
                        view = childAt;
                    ...
                    if (z4 && view != null) {
                        ...
                        List list = r61.W1;
                        if (R == i18 - 1) {
                            float interpolation2 = org.telegram.ui.Components.pr.f30184g.getInterpolation(k7.o.a(((float) (SystemClock.elapsedRealtime() - r61Var.M1)) / 200.0f, 0.0f, 1.0f));
                ...
                if (childAt2 instanceof a61) {
                    ...
                    if (z51Var2 != null && z51Var2.getVisibility() == 0) {
                        ...
                        if (drawable2 instanceof org.telegram.ui.Components.l5) {
                            imageReceiver = ((org.telegram.ui.Components.l5) drawable2).f28604k;
                        } else {
                            imageReceiver = a61Var3.h;
                        }
                        z51 z51Var3 = a61Var3.G;
                        if (!z51Var3.h) {
                            z51Var3.setImageReceiver(imageReceiver);
                        }
                    ...
                    if (a61Var3.H != null) {
                        ...
                        float f21 = dp3;
                        canvas2.translate((int) ((a61Var3.getX() + a61Var3.getMeasuredWidth()) - f21), (int) ((a61Var3.getY() + a61Var3.getMeasuredHeight()) - f21));
            ...
            Runnable runnable = ng.g0.f16069c;
            if (runnable != null) {
                runnable.run();
                ng.g0.f16069c = null;
            }
