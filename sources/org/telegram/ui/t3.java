...
public final class t3 extends org.telegram.ui.Components.aw0 implements org.telegram.ui.ActionBar.k2, org.telegram.ui.ActionBar.v3 {
    ...
    public boolean G0;
    public final u3 H0;
    public final Paint f37608w0;
    public final Paint f37609x0;
    public final Paint f37610y0;
    public final Paint f37611z0;

    public t3(u3 u3Var, Context context) {
        super(context, null);
        this.H0 = u3Var;
        this.f37608w0 = new Paint(1);
        this.f37609x0 = new Paint(1);
        this.f37610y0 = new Paint(1);
        this.f37611z0 = new Paint(1);
        new Paint(1);
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        float min = Math.min(u3Var.f37943w, 1.0f - u3Var.f37944x);
        Paint paint = this.f37608w0;
        ...
        float max = Math.max(1.0f - u3Var.f37943w, u3Var.f37944x) * u3Var.k();
        canvas.save();
        ...
        int backgroundColor = h4Var.f34114u0[1].getBackgroundColor();
        Paint paint3 = this.f37610y0;
        paint3.setColor(backgroundColor);
        canvas.drawRect(rectF, paint3);
        paint3.setColor(h4Var.f34114u0[c10].getBackgroundColor());
        RectF rectF2 = AndroidUtilities.rectTmp;
        rectF2.set(rectF);
        rectF2.left = h4Var.f34114u0[c10].getX();
        ...
        if (e > 0.0f) {
            ...
            h4Var.f34102h0.a(canvas, org.telegram.messenger.l0.C(20.0f, l4, 1) - lerp2, e, true);
            canvas.restore();
        }
        canvas.translate(0.0f, -max);
        if (!AndroidUtilities.makingGlobalBlurBitmap && (!h4Var.f34114u0[0].f() || canvas.isHardwareAccelerated())) {
    ...
    public final boolean onNestedPreFling(View view, float f7, float f10) {
        ...
        if (!h4Var.O0.y()) {
            ...
            if (l3Var.c()) {
                z10 = !l3Var.f35287b.canScrollVertically(-1);
            } else {
                z10 = false;
            }
            if (z10 && f10 < -1000.0f) {
        ...
        if (f7 != 0.0f || f10 != 0.0f) {
            ...
            AndroidUtilities.cancelRunOnUIThread(r9Var.f20214g0);
            r9Var.f20243z = false;
        }
        this.G0 = true;
    ...
    public final void onNestedPreScroll(View view, int i10, int i11, int[] iArr) {
        ...
        if (z10 && !h4Var.O0.y()) {
            iArr[1] = Math.min((int) (u3Var.k() * u3Var.f37944x), i11);
            u3Var.f37944x = Utilities.clamp(u3Var.f37944x - (i11 / u3Var.k()), 1.0f, 0.0f);
            u3Var.n();
            u3Var.h();
        }
        if (i10 == 0 && i11 == 0) {
    ...
    public final float x(Canvas canvas, RectF rectF, float f7, RectF rectF2, float f10) {
        ...
        Paint paint = this.f37608w0;
        paint.setColor(-16777216);
        paint.setAlpha((int) ((1.0f - u3Var.I) * Math.min(u3Var.f37943w, 1.0f - u3Var.f37944x) * f11 * 96.0f));
        canvas.drawRect(0.0f, 0.0f, getWidth(), getHeight(), paint);
        ...
        if (getChildCount() == 1) {
            ...
            if (u3Var.F) {
                i10 = h4Var.f34102h0.getMeasuredHeight();
            } else {
                i10 = 0;
            }
