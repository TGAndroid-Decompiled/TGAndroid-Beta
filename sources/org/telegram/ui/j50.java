...
public final class j50 extends org.telegram.ui.Components.l30 {
    ...
    public final void n(int i10) {
        ...
        k60 k60Var = this.f34781n.f35950b;
        k60Var.f35107w0 = false;
        alertDialog$Builder.f18447a.R = LocaleController.getString(R.string.VoipGroupStartRecordingTitle);
        if (i10 == 0) {
            if (k60Var.f35017a1.call.rtmp_stream) {
                i13 = R.string.VoipGroupStartRecordingRtmpText;
            } else {
                i13 = R.string.VoipGroupStartRecordingText;
            }
            alertDialog$Builder.f18447a.T = LocaleController.getString(i13);
        ...
        alertDialog$Builder.f18447a.f18526y0 = false;
        EditTextBoldCursor editTextBoldCursor = new EditTextBoldCursor(getContext());
        editTextBoldCursor.setBackgroundDrawable(org.telegram.ui.ActionBar.j6.T(getContext(), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19056nh, false), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19075oh, false)));
