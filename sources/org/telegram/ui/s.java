...
public final class s implements Utilities.Callback {
    ...
    public final void run(Object obj) {
        switch (this.f37553a) {
            case 0:
                i4 i4Var = this.f37554b;
                ai.w5 w5Var = i4Var.f34404q0;
            ...
            case 1:
                ...
                if (!TextUtils.isEmpty(str)) {
                    i4 i4Var2 = this.f37554b;
                    i4Var2.f34396h0.f39230b0.setText(str);
                    fi.o oVar = i4Var2.f34396h0.f39230b0;
                    oVar.setSelection(oVar.getText().length());
                    AndroidUtilities.showKeyboard(i4Var2.f34396h0.f39230b0);
                    return;
                }
                return;
            case 2:
                String str2 = (String) obj;
                i4 i4Var3 = this.f37554b;
                if (i4Var3.L != null && str2 != null) {
                    i4Var3.f34396h0.k(false);
                    if (nf.f.f(Uri.parse(str2), false, null)) {
                        ...
                        if (m3Var != null && m3Var.getWebView() != null) {
                            i4Var3.f34408u0[0].getWebView().loadUrl(str2);
                            return;
                        } else {
                            nf.f.n(str2);
                            return;
            ...
            default:
                ...
                i4 i4Var4 = this.f37554b;
                if (i4Var4.L != null && c1Var != null) {
                    i4Var4.f34396h0.k(false);
                    m3 m3Var2 = i4Var4.f34408u0[0];
                    if (m3Var2 != null && m3Var2.getWebView() != null) {
                        i4Var4.f34408u0[0].getWebView().e(c1Var.f39042c, c1Var.d);
                        return;
                    } else {
                        nf.f.n(c1Var.f39042c);
                        return;
                    }
                }
                return;
