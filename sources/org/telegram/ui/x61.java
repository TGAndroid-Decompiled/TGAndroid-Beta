...
public abstract class x61 extends FrameLayout implements org.telegram.ui.ActionBar.a6 {
    public final FrameLayout f39390a;
    public final ImageView f39391b;
    public final ImageView f39392c;
    public final org.telegram.ui.Components.jg0 d;
    public final View e;
    public final org.telegram.ui.Components.ym0 f39393f;
    public final org.telegram.ui.Cells.b6 h;
    public w61 f39394n;
    public float f39395r;
    public ValueAnimator f39396s;
    public g01 v;
    public boolean f39397w;
    public boolean f39398x;
    public final i71 f39399y;
    ...
    public x61(i71 i71Var, Context context, boolean z10) {
            ...
            public final void onClick(View view) {
                switch (r2) {
                    case 0:
                        ...
                        if (z51Var2.f39393f.f30281k == 1) {
                            b6Var.setText("");
                            z51Var2.f39399y.v(null, true, false);
                            w61 w61Var = z51Var2.f39394n;
                            if (w61Var != null) {
                                w61Var.G1(null);
                                z51Var2.f39394n.H1(true, true);
                                z51Var2.f39394n.E1();
                            }
                    ...
                    default:
                        ...
                        b6Var2.setText("");
                        z51Var4.f39399y.v(null, true, false);
                        w61 w61Var2 = z51Var4.f39394n;
                        if (w61Var2 != null) {
                            w61Var2.G1(null);
                            z51Var4.f39394n.H1(true, true);
                        }
        ...
        this.f39392c = imageView2;
        imageView2.setScaleType(scaleType);
        imageView2.setImageDrawable(new ci.j2(z51Var));
        imageView2.setBackground(org.telegram.ui.ActionBar.j6.f0(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f18952i6, f6Var), 1, AndroidUtilities.dp(15.0f)));
    ...
    public static void a(z51 z51Var, boolean z10) {
        ...
        AndroidUtilities.updateViewShow(z51Var.f39392c, false);
    }
    ...
    public final void c(boolean z10) {
        ...
        this.f39397w = z10;
        ValueAnimator valueAnimator = this.f39396s;
        if (valueAnimator != null) {
            valueAnimator.cancel();
        }
        float f10 = this.f39395r;
        if (z10) {
            f7 = 1.0f;
        } else {
            f7 = 0.0f;
        ...
        this.f39396s = ofFloat;
        ofFloat.addUpdateListener(new k21(this, 8));
        this.f39396s.setDuration(120L);
        this.f39396s.setInterpolator(org.telegram.ui.Components.qr.h);
        this.f39396s.start();
    }
    ...
    public final void d(boolean z10) {
        ...
        w61 w61Var;
        w61 w61Var2;
        org.telegram.ui.Components.ym0 ym0Var = this.f39393f;
        int i10 = ym0Var.f30281k;
        org.telegram.ui.Cells.b6 b6Var = this.h;
        int i11 = 2;
        if (i10 == 2 && ((b6Var.length() != 0 || ((w61Var2 = this.f39394n) != null && w61Var2.getSelectedCategory() != null)) && !z10)) {
            return;
        }
        if (b6Var.length() <= 0 && ((w61Var = this.f39394n) == null || w61Var.f30014o3 <= 0.5f || (!w61Var.j3 && w61Var.getSelectedCategory() == null))) {
            r62 = 0;
        } else {
            r62 = 1;
        }
        ym0Var.b(r62);
        ImageView imageView = this.f39391b;
    ...
    public final void e() {
        if (this.f39398x) {
            this.f39390a.setBackground(org.telegram.ui.ActionBar.j6.b0(AndroidUtilities.dp(18.0f), org.telegram.ui.ActionBar.j6.l1(0.06f, org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.E8, this.f39399y.Z0))));
        }
    }
