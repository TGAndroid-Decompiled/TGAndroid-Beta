...
public final class nb1 extends org.telegram.ui.ActionBar.h3 {
    public static nb1 f35201b;

    public static void m(nb1 nb1Var, wy wyVar) {
    ...
    public static void n(wy wyVar) {
        if (f35201b == null) {
            ?? h3Var = new org.telegram.ui.ActionBar.h3(wyVar.getParentActivity(), false);
            Activity parentActivity = wyVar.getParentActivity();
            LinearLayout f7 = org.telegram.messenger.a2.f(parentActivity, 1);
            org.telegram.ui.Components.kx0 kx0Var = new org.telegram.ui.Components.kx0(parentActivity, h3Var.currentAccount);
            ...
            textView3.setOnClickListener(new w71(5, h3Var, wyVar));
