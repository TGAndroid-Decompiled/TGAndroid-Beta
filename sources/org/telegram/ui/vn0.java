...
public final class vn0 implements OnCompleteListener, org.telegram.ui.ActionBar.a2, au {
    ...
    public void a1(vt vtVar) {
        switch (this.f41621a) {
            case 2:
                xo0 xo0Var = this.f41622b;
                xo0Var.A0 = vtVar;
                xo0Var.f42847f[4].setText(vtVar.f41721a);
                return;
            default:
                xo0 xo0Var2 = this.f41622b;
                xo0Var2.A0 = vtVar;
                xo0Var2.f42847f[4].setText(vtVar.f41721a);
                xo0Var2.B0 = vtVar.d;
                return;
        }
    }
