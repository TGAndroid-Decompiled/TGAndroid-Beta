...
public final class qh0 extends FrameLayout {
    ...
    public final TextView f36443c;
    public final TextView d;
    public final LinearLayout e;
    public final TextView f36444f;
    public final TextView h;
    public TLRPC.TL_chatInviteExported f36445n;
    public int f36446r;
    public final Paint f36447s;
    public final Paint v;
    public final RectF f36448w;
    public final ImageView f36449x;
    public int f36450y;

    public qh0(th0 th0Var, Context context) {
        super(context);
        this.K = th0Var;
        this.f36447s = new Paint(1);
        Paint paint = new Paint(1);
        this.v = paint;
        this.f36448w = new RectF();
        this.E = 1.0f;
        ...
        imageView.setBackground(org.telegram.ui.ActionBar.h6.f0(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f18878i6, false), 1, -1));
    ...
    public final int a(float f7, int i10) {
        TLRPC.TL_chatInviteExported tL_chatInviteExported = this.f36445n;
        ...
        if (i10 == 3) {
            return org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f18920ka, false);
        }
        if (i10 == 1) {
            if (f7 > 0.5f) {
                return i0.a.d(1.0f - ((f7 - 0.5f) / 0.5f), org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f18977na, false), org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f18993oa, false));
            }
            return i0.a.d(1.0f - (f7 / 0.5f), org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f18993oa, false), org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f18920ka, false));
        } else if (i10 == 2) {
            return org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f18993oa, false);
        } else {
            if (i10 == 4) {
                return org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.V8, false);
            }
            return org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.Oh, false);
        }
    }
    ...
    public final void b(TLRPC.TL_chatInviteExported tL_chatInviteExported, int i10) {
        ...
        ImageView imageView = this.f36449x;
        ...
        if (tL_starsSubscriptionPricing != null) {
            ...
            TextView textView = this.f36444f;
            textView.setText(X0);
        ...
        ((ViewGroup.MarginLayoutParams) this.f36442b.getLayoutParams()).rightMargin = dp;
        boolean isEmpty = TextUtils.isEmpty(tL_chatInviteExported.title);
        th0 th0Var = this.K;
        TextView textView3 = this.f36443c;
        if (!isEmpty) {
        ...
        if (tL_chatInviteExported.permanent && !tL_chatInviteExported.revoked) {
            ...
            ctVar.f23099b = AndroidUtilities.dp(1.5f);
            ...
            if (tL_chatInviteExported.expire_date > 0) {
                ...
                ctVar2.f23099b = AndroidUtilities.dp(1.5f);
                ...
                long currentTimeMillis = (tL_chatInviteExported.expire_date * 1000) - ((th0Var.f37672n0 * 1000) + System.currentTimeMillis());
            ...
            ctVar3.f23099b = AndroidUtilities.dp(1.5f);
        ...
        if (tL_chatInviteExported.request_needed) {
            ...
            ctVar4.f23099b = AndroidUtilities.dp(1.5f);
    ...
    public final void onDraw(android.graphics.Canvas r20) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.qh0.onDraw(android.graphics.Canvas):void");
    }
