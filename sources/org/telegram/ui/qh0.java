...
public final class qh0 extends LinearLayout implements NotificationCenter.NotificationCenterDelegate {
    public final org.telegram.ui.Components.u9 f36883a;
    public final int f36884b;

    public qh0(Context context) {
        super(context);
        this.f36884b = UserConfig.selectedAccount;
    ...
    public final void a() {
        ...
        if (tL_messages_stickerSet != null && tL_messages_stickerSet.documents.size() >= 4) {
            ...
            this.f36883a.i(ImageLocation.getForDocument(document), "104_104", "tgs", DocumentObject.getSvgThumb(document, org.telegram.ui.ActionBar.i6.f18780a7, 1.0f), tL_messages_stickerSet);
            return;
        }
    ...
    public final void onAttachedToWindow() {
        ...
        a();
        NotificationCenter.getInstance(this.f36884b).addObserver(this, NotificationCenter.diceStickersDidLoad);
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        NotificationCenter.getInstance(this.f36884b).removeObserver(this, NotificationCenter.diceStickersDidLoad);
    }
}
