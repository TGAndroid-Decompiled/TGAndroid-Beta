...
public final class qh0 extends LinearLayout implements NotificationCenter.NotificationCenterDelegate {
    public final org.telegram.ui.Components.x9 f39877a;
    public final int f39878b;

    public qh0(Context context) {
        super(context);
        this.f39878b = UserConfig.selectedAccount;
    ...
    public final void a() {
        ...
        if (tL_messages_stickerSet != null && tL_messages_stickerSet.documents.size() >= 4) {
            ...
            this.f39877a.i(ImageLocation.getForDocument(document), "104_104", "tgs", DocumentObject.getSvgThumb(document, org.telegram.ui.ActionBar.j6.f20608a7, 1.0f), tL_messages_stickerSet);
            return;
        }
    ...
    public final void onAttachedToWindow() {
        ...
        a();
        NotificationCenter.getInstance(this.f39878b).addObserver(this, NotificationCenter.diceStickersDidLoad);
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        NotificationCenter.getInstance(this.f39878b).removeObserver(this, NotificationCenter.diceStickersDidLoad);
    }
}
