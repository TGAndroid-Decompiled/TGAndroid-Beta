...
public final class jt0 extends VideoPlayerRewinder {
    public final PhotoViewer f37870a;

    public jt0(PhotoViewer photoViewer, VideoFramesRewinder videoFramesRewinder) {
        super(videoFramesRewinder);
        this.f37870a = photoViewer;
    }

    @Override
    public final void onRewindCanceled() {
        MotionEvent obtain = MotionEvent.obtain(0L, 0L, 3, 0.0f, 0.0f, 0);
        PhotoViewer photoViewer = this.f37870a;
        PhotoViewer.k(photoViewer, obtain);
        photoViewer.f33765z1.f(false);
        org.telegram.ui.Components.eg0.f25703p0.Q.f(false);
    }

    @Override
    public final void onRewindStart(boolean z10) {
        PhotoViewer photoViewer = this.f37870a;
        photoViewer.f33765z1.e(false);
        photoViewer.f33765z1.d(!z10);
        photoViewer.f33765z1.f(true);
    ...
    public final void updateRewindProgressUi(long j3, float f7, boolean z10) {
        PhotoViewer photoViewer = this.f37870a;
        photoViewer.f33765z1.g(Math.abs(j3));
        if (z10) {
