...
public final class jt0 extends AnimatorListenerAdapter {
    ...
    public final PhotoViewer f38122b;

    public jt0(PhotoViewer photoViewer, int i10) {
        this.f38122b = photoViewer;
        this.f38121a = i10;
    }
    ...
    public final void onAnimationEnd(Animator animator) {
        ...
        float min;
        int i11;
        PhotoViewer photoViewer = this.f38122b;
        ...
        animatorSet.playTogether(ObjectAnimator.ofFloat(photoViewer, org.telegram.ui.Components.n6.f29399g, 0.0f, 1.0f), ObjectAnimator.ofFloat(photoViewer.F1.getToolsView(), View.TRANSLATION_Y, AndroidUtilities.dp(186.0f), 0.0f));
        photoViewer.f34334m6.setDuration(200L);
        photoViewer.f34334m6.addListener(new ss0(this, 2));
