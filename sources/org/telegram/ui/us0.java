...
public final class us0 extends org.telegram.ui.ActionBar.j {
    public final org.telegram.ui.ActionBar.f6 f38196a;
    public final PhotoViewer f38197b;

    public us0(PhotoViewer photoViewer, org.telegram.ui.ActionBar.f6 f6Var) {
        this.f38197b = photoViewer;
        this.f38196a = f6Var;
    }
    ...
    public final boolean a() {
        ...
        boolean z10;
        PhotoViewer photoViewer = this.f38197b;
        if (photoViewer.T4 != null || photoViewer.f30931b5 != null) {
            return true;
        }
        if (photoViewer.f30921a5 != null) {
            FileLoader fileLoader = FileLoader.getInstance(photoViewer.T);
            ImageLocation imageLocation = photoViewer.f30921a5;
            ...
            if (photoViewer.f31146z5 == 0 && !photoViewer.B5) {
                z10 = false;
            } else {
                z10 = true;
            }
            ...
            ImageLocation imageLocation2 = photoViewer.f30921a5;
            ...
            return false;
        } else if (photoViewer.f31004j7 != null) {
            return true;
        } else {
            return false;
        }
