...
public final class yy0 implements org.telegram.ui.ActionBar.k6 {
    ...
    public final org.telegram.ui.ActionBar.o2 f40044b;
    ...
    public final void b() {
        ...
        int i12 = 0;
        org.telegram.ui.ActionBar.o2 o2Var = this.f40044b;
        switch (i11) {
            case 0:
            ...
            case 1:
                ...
                org.telegram.ui.Components.ml0 ml0Var = y11Var.f39762a;
                if (ml0Var != null) {
                    int childCount = ml0Var.getChildCount();
                    while (i12 < childCount) {
                        View childAt = y11Var.f39762a.getChildAt(i12);
            ...
            case 2:
                ...
                if (q21Var.h != null && ((valueAnimator = q21Var.G) == null || !valueAnimator.isRunning())) {
                    ...
                    if (q21Var.F) {
                        ...
                        i10 = org.telegram.ui.ActionBar.j6.f19263z6;
                    }
                    eaVar.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i10, false));
                }
                if (q21Var.f36781a != null) {
                    int i13 = 0;
                    while (true) {
                        EditTextBoldCursor[] editTextBoldCursorArr = q21Var.f36781a;
                        if (i13 < editTextBoldCursorArr.length) {
                            editTextBoldCursorArr[i13].setLineColors(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18990k6, false), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19008l6, false), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19082p7, false));
                            i13++;
                        } else {
                            return;
                        }
            ...
            case 3:
                ...
                g31Var.getClass();
                g31Var.setNavigationBarColor(g31Var.getThemedColor(org.telegram.ui.ActionBar.j6.f18806a7));
                return;
            case 4:
                n31 n31Var = (n31) o2Var;
                n31Var.f35928a.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18806a7, false));
                n31Var.f35930c.l();
                return;
            case 5:
            ...
            case 6:
                ...
                for (int i17 = 0; i17 < themeActivity.f31564b.getChildCount(); i17++) {
                    View childAt2 = themeActivity.f31564b.getChildAt(i17);
                ...
                for (int i18 = 0; i18 < themeActivity.f31564b.getCachedChildCount(); i18++) {
                    View Q = themeActivity.f31564b.Q(i18);
                ...
                for (int i19 = 0; i19 < themeActivity.f31564b.getHiddenChildCount(); i19++) {
                    View W = themeActivity.f31564b.W(i19);
                ...
                while (i12 < themeActivity.f31564b.getAttachedScrapChildCount()) {
                    View P = themeActivity.f31564b.P(i12);
            ...
            case 8:
                ...
                org.telegram.ui.Components.ml0 ml0Var2 = ue1Var.f38052a;
                if (ml0Var2 != null) {
                    int childCount3 = ml0Var2.getChildCount();
                    for (int i20 = 0; i20 < childCount3; i20++) {
                        View childAt3 = ue1Var.f38052a.getChildAt(i20);
                        if (childAt3 instanceof org.telegram.ui.Cells.f4) {
                            ((org.telegram.ui.Cells.f4) childAt3).f(0);
                        }
                    }
                }
                org.telegram.ui.Components.ml0 ml0Var3 = ue1Var.f38053b;
                if (ml0Var3 != null) {
                    int childCount4 = ml0Var3.getChildCount();
                    for (int i21 = 0; i21 < childCount4; i21++) {
                        View childAt4 = ue1Var.f38053b.getChildAt(i21);
                        if (childAt4 instanceof org.telegram.ui.Cells.f4) {
                            ((org.telegram.ui.Cells.f4) childAt4).f(0);
                        }
                    }
                }
                ue1Var.f38054c.setBackground(org.telegram.ui.ActionBar.z5.f(new float[]{4.0f}, org.telegram.ui.ActionBar.j6.Oh));
                ue1Var.F.setProgressColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18934h6, false));
                return;
            case 9:
                fg1.X((fg1) o2Var);
                return;
