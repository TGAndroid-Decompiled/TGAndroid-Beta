...
public final class aq implements NotificationCenter.NotificationCenterDelegate {
    ...
    public long Z;
    public int f34532a;
    public View f34533a0;
    public int f34534b;
    public boolean f34535b0;
    public int f34536c;
    public final org.telegram.ui.Components.uq f34537c0;
    public float d;
    public final int[] f34538d0;
    public final Paint f34539e;
    public final int f34540e0;
    public final TextPaint f34541f;
    public final int f34542f0;
    public final int f34543g0;
    public final TextPaint h;
    public final long f34544h0;
    public final long f34545i0;
    public final org.telegram.ui.ActionBar.f6 f34546j0;
    public org.telegram.ui.Components.q5 f34547k0;
    public final Paint f34548n;
    public final Path f34549r;
    public StaticLayout f34550s;
    public StaticLayout v;
    public StaticLayout f34551w;
    public int f34552x;
    public int f34553y;
    ...
    public final void a(Canvas canvas, uj ujVar, float f7, float f10) {
        ...
        if (this.f34533a0 != ujVar) {
            this.f34533a0 = ujVar;
            org.telegram.ui.Components.q5 q5Var = this.f34547k0;
            if (q5Var != null) {
                q5Var.a(ujVar);
            }
        }
        org.telegram.ui.Components.uq uqVar2 = this.f34537c0;
        uqVar2.H = ujVar;
        RectF rectF3 = uqVar2.f30967f;
        ...
        org.telegram.ui.ActionBar.j6.q(0.0f, ujVar.getMeasuredHeight() - dp, this.f34536c, ujVar.getMeasuredHeight());
        int i17 = org.telegram.ui.ActionBar.j6.f20787ic;
        org.telegram.ui.ActionBar.f6 f6Var = this.f34546j0;
        int v02 = org.telegram.ui.ActionBar.j6.v0(i17, f6Var);
        TextPaint textPaint3 = this.f34541f;
        textPaint3.setColor(v02);
        int v03 = org.telegram.ui.ActionBar.j6.v0(i17, f6Var);
        Paint paint2 = this.f34539e;
        paint2.setColor(v03);
        ...
        org.telegram.ui.ActionBar.j6.f20759h2.setAlpha((int) (alpha2 * f11));
        ...
        if (f28 >= 1.0f && !this.R) {
            ...
            if (this.W) {
                ...
                if (a12) {
                    int alpha6 = org.telegram.ui.ActionBar.j6.f20759h2.getAlpha();
                    org.telegram.ui.ActionBar.j6.f20759h2.setAlpha((int) (alpha6 * f14));
                    float f40 = this.d;
                    canvas2.drawRoundRect(rectF4, f40, f40, org.telegram.ui.ActionBar.j6.f20759h2);
                    org.telegram.ui.ActionBar.j6.f20759h2.setAlpha(alpha6);
                }
            }
        ...
        if (this.f34550s != null && this.K > 0.0f) {
            ...
            float f49 = (i16 - this.f34552x) / 2.0f;
            rectF5.set(f49, dp13, this.f34536c - f49, this.f34550s.getHeight() + dp13);
            ...
            if (a14) {
                canvas2.drawRoundRect(rectF5, AndroidUtilities.dp(15.0f), AndroidUtilities.dp(15.0f), org.telegram.ui.ActionBar.j6.f20759h2);
            }
            canvas2.save();
            canvas2.translate((this.f34536c - this.f34552x) / 2.0f, dp13);
            this.f34550s.draw(canvas2);
            canvas2.restore();
        } else {
            textPaint2 = textPaint;
        }
        if (!this.R && f16 > 0.0f) {
            ...
            org.telegram.ui.Components.q5 q5Var2 = this.f34547k0;
            if (q5Var2 == null || (imageReceiver = q5Var2.f29612k) == null) {
            ...
            if (this.X && imageReceiver2.getDrawable() != null && (imageReceiver2.getDrawable() instanceof org.telegram.ui.Components.oq) && (((org.telegram.ui.Components.oq) imageReceiver2.getDrawable()).f29188b instanceof org.telegram.ui.Components.l80)) {
                ((org.telegram.ui.Components.l80) ((org.telegram.ui.Components.oq) imageReceiver2.getDrawable()).f29188b).f28141i = f7;
            }
            if (this.K > 0.0f && this.f34535b0) {
                ...
                uqVar3.e(uqVar3.f30979s);
                canvas2.scale(f52, f52, (uqVar3.f30979s / 2.0f) + uqVar3.A + AndroidUtilities.dp(12.0f) + f18, (a10 - AndroidUtilities.dp(6.0f)) + AndroidUtilities.dp(14.0f));
                canvas2.translate(AndroidUtilities.dp(12.0f) + f18, a10 - AndroidUtilities.dp(6.0f));
                float f53 = uqVar3.C;
                float f54 = uqVar3.f30972l;
                if (f54 != 1.0f) {
                    f23 = 6.0f;
                    int i22 = uqVar3.f30965c;
                    if (i22 == 0 || i22 == 1) {
                        rectF2 = rectF;
                        f24 = 14.0f;
                        uqVar3.e(uqVar3.f30979s);
                        float dp14 = (uqVar3.f30983x - AndroidUtilities.dp(f53 * 2.0f)) / 2.0f;
                        float f55 = uqVar3.B;
                        rectF2.set(f55, dp14, uqVar3.f30979s + f55 + AndroidUtilities.dp(11.0f), AndroidUtilities.dp(23.0f) + dp14);
                    } else {
                        float f56 = f54 * 2.0f;
                        if (f56 > 1.0f) {
                            f56 = 1.0f;
                        }
                        float dp15 = (uqVar3.f30983x - AndroidUtilities.dp(f53 * 2.0f)) / 2.0f;
                        int i23 = uqVar3.f30979s;
                        int i24 = uqVar3.f30978r;
                        if (i23 == i24) {
                            z10 = i23;
                            f24 = 14.0f;
                        } else {
                    ...
                    f24 = 14.0f;
                    uqVar3.e(uqVar3.f30979s);
                    float dp16 = (uqVar3.f30983x - AndroidUtilities.dp(f53 * 2.0f)) / 2.0f;
                    float f58 = uqVar3.B;
                    rectF2.set(f58, dp16, uqVar3.f30979s + f58 + AndroidUtilities.dp(11.0f), AndroidUtilities.dp(23.0f) + dp16);
                }
                rectF2.inset(-AndroidUtilities.dp(2.0f), -AndroidUtilities.dp(2.0f));
                canvas2.drawRoundRect(rectF2, rectF2.height() / 2.0f, rectF2.height() / 2.0f, this.f34548n);
                canvas2.restore();
                canvas2.save();
                float f59 = this.K;
                uqVar3.e(uqVar3.f30979s);
                canvas2.scale(f59, f59, (uqVar3.f30979s / 2.0f) + uqVar3.A + AndroidUtilities.dp(12.0f) + f18, (a10 - AndroidUtilities.dp(f23)) + AndroidUtilities.dp(f24));
        ...
        org.telegram.ui.ActionBar.j6.f20759h2.setAlpha(i12);
        textPaint2.setAlpha(alpha3);
        paint.setAlpha(alpha4);
    }

    public final void b(Canvas canvas, int i10, int i11) {
        int v02 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Xk, this.f34546j0);
        ...
        if (this.v != null) {
            ...
            if (f7 < 1.0f) {
                ...
                canvas.save();
                canvas.translate((this.f34536c - this.f34553y) / 2.0f, height);
                this.v.draw(canvas);
                canvas.restore();
            }
        }
        if (this.f34551w != null) {
            float f10 = this.K;
            if (f10 > 0.0f) {
                textPaint.setAlpha((int) (alpha2 * f10 * this.S));
                float dp = ((1.0f - this.K) * AndroidUtilities.dp(10.0f)) + (((i11 - i10) - this.f34551w.getHeight()) / 2.0f) + i10;
                canvas.save();
                canvas.translate((this.f34536c - this.E) / 2.0f, dp);
                this.f34551w.draw(canvas);
                canvas.restore();
            }
        }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        TLRPC.Dialog dialog;
        if (this.Z != 0 && (dialog = (TLRPC.Dialog) MessagesController.getInstance(this.f34540e0).dialogs_dict.f(this.Z)) != null) {
            int i12 = dialog.unread_count;
            boolean z10 = true;
            this.f34537c0.c(i12, true);
            if (i12 <= 0) {
                z10 = false;
            }
            this.f34535b0 = z10;
            View view = this.f34533a0;
            if (view != null) {
                view.invalidate();
            }
        }
    ...
    public final void f() {
        ...
        org.telegram.ui.Components.q5 q5Var = this.f34547k0;
        if (q5Var != null && (view = this.f34533a0) != null) {
            q5Var.a(view);
        }
        NotificationCenter.getInstance(this.f34540e0).addObserver(this, NotificationCenter.updateInterfaces);
    }
    ...
    public final void g(final View view, boolean z10) {
        ...
        if (z10) {
            ...
            org.telegram.ui.Components.pr prVar = org.telegram.ui.Components.pr.f29497j;
        ...
        ofFloat5.setInterpolator(org.telegram.ui.Components.pr.f29494f);
    ...
    public final void h() {
        ...
        this.V = false;
        this.H = null;
        TLRPC.Dialog c10 = c(this.f34545i0, this.f34542f0, this.f34543g0, true, this.f34538d0);
        if (c10 != null) {
            this.Z = c10.f19900id;
            int[] iArr = this.f34538d0;
            if (iArr[0] == 1) {
                z10 = true;
            } else {
                z10 = false;
    ...
    public final void j() {
        ...
        int i10 = this.f34540e0;
        ArrayList<TLRPC.TL_forumTopic> topics = MessagesController.getInstance(i10).getTopicsController().getTopics(-this.f34545i0);
        if (topics != null && topics.size() > 1) {
            tL_forumTopic = null;
            for (int i11 = 0; i11 < topics.size(); i11++) {
                TLRPC.TL_forumTopic tL_forumTopic2 = topics.get(i11);
                if (tL_forumTopic2.f19948id != this.f34544h0 && !tL_forumTopic2.hidden && tL_forumTopic2.unread_count > 0 && (tL_forumTopic == null || ((message = tL_forumTopic2.topMessage) != null && (message2 = tL_forumTopic.topMessage) != null && message.date > message2.date))) {
        ...
        if (tL_forumTopic != null) {
            ...
            org.telegram.ui.ActionBar.f6 f6Var = this.f34546j0;
            if (i12 == 1) {
                View view3 = this.f34533a0;
                if (view3 != null && (q5Var2 = this.f34547k0) != null) {
                    q5Var2.o(view3);
                }
                this.f34547k0 = null;
                ...
                org.telegram.ui.Components.q5 q5Var3 = this.f34547k0;
                if (q5Var3 == null || q5Var3.i() != tL_forumTopic.icon_emoji_id) {
                    org.telegram.ui.Components.q5 q5Var4 = this.f34547k0;
                    if (q5Var4 != null && (view = this.f34533a0) != null) {
                        q5Var4.o(view);
                    }
                    org.telegram.ui.Components.q5 q5Var5 = new org.telegram.ui.Components.q5(22, i10, tL_forumTopic.icon_emoji_id);
                    this.f34547k0 = q5Var5;
                    q5Var5.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20787ic, f6Var), PorterDuff.Mode.SRC_IN));
                }
                org.telegram.ui.Components.q5 q5Var6 = this.f34547k0;
                if (q5Var6 != null && (view2 = this.f34533a0) != null) {
                    q5Var6.a(view2);
                }
                imageReceiver.setImageBitmap((Bitmap) null);
            } else {
                View view4 = this.f34533a0;
                if (view4 != null && (q5Var = this.f34547k0) != null) {
                    q5Var.o(view4);
                }
                this.f34547k0 = null;
