...
public final class aq implements NotificationCenter.NotificationCenterDelegate {
    ...
    public long Z;
    public int f34505a;
    public View f34506a0;
    public int f34507b;
    public boolean f34508b0;
    public int f34509c;
    public final org.telegram.ui.Components.uq f34510c0;
    public float d;
    public final int[] f34511d0;
    public final Paint f34512e;
    public final int f34513e0;
    public final TextPaint f34514f;
    public final int f34515f0;
    public final int f34516g0;
    public final TextPaint h;
    public final long f34517h0;
    public final long f34518i0;
    public final org.telegram.ui.ActionBar.f6 f34519j0;
    public org.telegram.ui.Components.q5 f34520k0;
    public final Paint f34521n;
    public final Path f34522r;
    public StaticLayout f34523s;
    public StaticLayout v;
    public StaticLayout f34524w;
    public int f34525x;
    public int f34526y;
    ...
    public final void a(Canvas canvas, uj ujVar, float f7, float f10) {
        ...
        if (this.f34506a0 != ujVar) {
            this.f34506a0 = ujVar;
            org.telegram.ui.Components.q5 q5Var = this.f34520k0;
            if (q5Var != null) {
                q5Var.a(ujVar);
            }
        }
        org.telegram.ui.Components.uq uqVar2 = this.f34510c0;
        uqVar2.H = ujVar;
        RectF rectF3 = uqVar2.f30940f;
        ...
        org.telegram.ui.ActionBar.j6.q(0.0f, ujVar.getMeasuredHeight() - dp, this.f34509c, ujVar.getMeasuredHeight());
        int i17 = org.telegram.ui.ActionBar.j6.f20760ic;
        org.telegram.ui.ActionBar.f6 f6Var = this.f34519j0;
        int v02 = org.telegram.ui.ActionBar.j6.v0(i17, f6Var);
        TextPaint textPaint3 = this.f34514f;
        textPaint3.setColor(v02);
        int v03 = org.telegram.ui.ActionBar.j6.v0(i17, f6Var);
        Paint paint2 = this.f34512e;
        paint2.setColor(v03);
        ...
        org.telegram.ui.ActionBar.j6.f20732h2.setAlpha((int) (alpha2 * f11));
        ...
        if (f28 >= 1.0f && !this.R) {
            ...
            if (this.W) {
                ...
                if (a12) {
                    int alpha6 = org.telegram.ui.ActionBar.j6.f20732h2.getAlpha();
                    org.telegram.ui.ActionBar.j6.f20732h2.setAlpha((int) (alpha6 * f14));
                    float f40 = this.d;
                    canvas2.drawRoundRect(rectF4, f40, f40, org.telegram.ui.ActionBar.j6.f20732h2);
                    org.telegram.ui.ActionBar.j6.f20732h2.setAlpha(alpha6);
                }
            }
        ...
        if (this.f34523s != null && this.K > 0.0f) {
            ...
            float f49 = (i16 - this.f34525x) / 2.0f;
            rectF5.set(f49, dp13, this.f34509c - f49, this.f34523s.getHeight() + dp13);
            ...
            if (a14) {
                canvas2.drawRoundRect(rectF5, AndroidUtilities.dp(15.0f), AndroidUtilities.dp(15.0f), org.telegram.ui.ActionBar.j6.f20732h2);
            }
            canvas2.save();
            canvas2.translate((this.f34509c - this.f34525x) / 2.0f, dp13);
            this.f34523s.draw(canvas2);
            canvas2.restore();
        } else {
            textPaint2 = textPaint;
        }
        if (!this.R && f16 > 0.0f) {
            ...
            org.telegram.ui.Components.q5 q5Var2 = this.f34520k0;
            if (q5Var2 == null || (imageReceiver = q5Var2.f29585k) == null) {
            ...
            if (this.X && imageReceiver2.getDrawable() != null && (imageReceiver2.getDrawable() instanceof org.telegram.ui.Components.oq) && (((org.telegram.ui.Components.oq) imageReceiver2.getDrawable()).f29161b instanceof org.telegram.ui.Components.l80)) {
                ((org.telegram.ui.Components.l80) ((org.telegram.ui.Components.oq) imageReceiver2.getDrawable()).f29161b).f28114i = f7;
            }
            if (this.K > 0.0f && this.f34508b0) {
                ...
                uqVar3.e(uqVar3.f30952s);
                canvas2.scale(f52, f52, (uqVar3.f30952s / 2.0f) + uqVar3.A + AndroidUtilities.dp(12.0f) + f18, (a10 - AndroidUtilities.dp(6.0f)) + AndroidUtilities.dp(14.0f));
                canvas2.translate(AndroidUtilities.dp(12.0f) + f18, a10 - AndroidUtilities.dp(6.0f));
                float f53 = uqVar3.C;
                float f54 = uqVar3.f30945l;
                if (f54 != 1.0f) {
                    f23 = 6.0f;
                    int i22 = uqVar3.f30938c;
                    if (i22 == 0 || i22 == 1) {
                        rectF2 = rectF;
                        f24 = 14.0f;
                        uqVar3.e(uqVar3.f30952s);
                        float dp14 = (uqVar3.f30956x - AndroidUtilities.dp(f53 * 2.0f)) / 2.0f;
                        float f55 = uqVar3.B;
                        rectF2.set(f55, dp14, uqVar3.f30952s + f55 + AndroidUtilities.dp(11.0f), AndroidUtilities.dp(23.0f) + dp14);
                    } else {
                        float f56 = f54 * 2.0f;
                        if (f56 > 1.0f) {
                            f56 = 1.0f;
                        }
                        float dp15 = (uqVar3.f30956x - AndroidUtilities.dp(f53 * 2.0f)) / 2.0f;
                        int i23 = uqVar3.f30952s;
                        int i24 = uqVar3.f30951r;
                        if (i23 == i24) {
                            z10 = i23;
                            f24 = 14.0f;
                        } else {
                    ...
                    f24 = 14.0f;
                    uqVar3.e(uqVar3.f30952s);
                    float dp16 = (uqVar3.f30956x - AndroidUtilities.dp(f53 * 2.0f)) / 2.0f;
                    float f58 = uqVar3.B;
                    rectF2.set(f58, dp16, uqVar3.f30952s + f58 + AndroidUtilities.dp(11.0f), AndroidUtilities.dp(23.0f) + dp16);
                }
                rectF2.inset(-AndroidUtilities.dp(2.0f), -AndroidUtilities.dp(2.0f));
                canvas2.drawRoundRect(rectF2, rectF2.height() / 2.0f, rectF2.height() / 2.0f, this.f34521n);
                canvas2.restore();
                canvas2.save();
                float f59 = this.K;
                uqVar3.e(uqVar3.f30952s);
                canvas2.scale(f59, f59, (uqVar3.f30952s / 2.0f) + uqVar3.A + AndroidUtilities.dp(12.0f) + f18, (a10 - AndroidUtilities.dp(f23)) + AndroidUtilities.dp(f24));
        ...
        org.telegram.ui.ActionBar.j6.f20732h2.setAlpha(i12);
        textPaint2.setAlpha(alpha3);
        paint.setAlpha(alpha4);
    }

    public final void b(Canvas canvas, int i10, int i11) {
        int v02 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Xk, this.f34519j0);
        ...
        if (this.v != null) {
            ...
            if (f7 < 1.0f) {
                ...
                canvas.save();
                canvas.translate((this.f34509c - this.f34526y) / 2.0f, height);
                this.v.draw(canvas);
                canvas.restore();
            }
        }
        if (this.f34524w != null) {
            ...
            if (f10 > 0.0f) {
                ...
                float dp = ((1.0f - this.K) * AndroidUtilities.dp(10.0f)) + (((i11 - i10) - this.f34524w.getHeight()) / 2.0f) + i10;
                canvas.save();
                canvas.translate((this.f34509c - this.E) / 2.0f, dp);
                this.f34524w.draw(canvas);
                canvas.restore();
            }
        }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        TLRPC.Dialog dialog;
        if (this.Z != 0 && (dialog = (TLRPC.Dialog) MessagesController.getInstance(this.f34513e0).dialogs_dict.f(this.Z)) != null) {
            int i12 = dialog.unread_count;
            boolean z10 = true;
            this.f34510c0.c(i12, true);
            if (i12 <= 0) {
                z10 = false;
            }
            this.f34508b0 = z10;
            View view = this.f34506a0;
            if (view != null) {
                view.invalidate();
            }
        }
    ...
    public final void f() {
        ...
        org.telegram.ui.Components.q5 q5Var = this.f34520k0;
        if (q5Var != null && (view = this.f34506a0) != null) {
            q5Var.a(view);
        }
        NotificationCenter.getInstance(this.f34513e0).addObserver(this, NotificationCenter.updateInterfaces);
    }
    ...
    public final void g(final View view, boolean z10) {
        ...
        if (z10) {
            ...
            org.telegram.ui.Components.pr prVar = org.telegram.ui.Components.pr.f29470j;
        ...
        ofFloat5.setInterpolator(org.telegram.ui.Components.pr.f29467f);
    ...
    public final void h() {
        ...
        this.V = false;
        this.H = null;
        TLRPC.Dialog c10 = c(this.f34518i0, this.f34515f0, this.f34516g0, true, this.f34511d0);
        if (c10 != null) {
            this.Z = c10.f19873id;
            int[] iArr = this.f34511d0;
            if (iArr[0] == 1) {
                z10 = true;
            } else {
                z10 = false;
    ...
    public final void j() {
        ...
        int i10 = this.f34513e0;
        ArrayList<TLRPC.TL_forumTopic> topics = MessagesController.getInstance(i10).getTopicsController().getTopics(-this.f34518i0);
        if (topics != null && topics.size() > 1) {
            tL_forumTopic = null;
            for (int i11 = 0; i11 < topics.size(); i11++) {
                TLRPC.TL_forumTopic tL_forumTopic2 = topics.get(i11);
                if (tL_forumTopic2.f19921id != this.f34517h0 && !tL_forumTopic2.hidden && tL_forumTopic2.unread_count > 0 && (tL_forumTopic == null || ((message = tL_forumTopic2.topMessage) != null && (message2 = tL_forumTopic.topMessage) != null && message.date > message2.date))) {
        ...
        if (tL_forumTopic != null) {
            ...
            org.telegram.ui.ActionBar.f6 f6Var = this.f34519j0;
            if (i12 == 1) {
                View view3 = this.f34506a0;
                if (view3 != null && (q5Var2 = this.f34520k0) != null) {
                    q5Var2.o(view3);
                }
                this.f34520k0 = null;
                ...
                org.telegram.ui.Components.q5 q5Var3 = this.f34520k0;
                if (q5Var3 == null || q5Var3.i() != tL_forumTopic.icon_emoji_id) {
                    org.telegram.ui.Components.q5 q5Var4 = this.f34520k0;
                    if (q5Var4 != null && (view = this.f34506a0) != null) {
                        q5Var4.o(view);
                    }
                    org.telegram.ui.Components.q5 q5Var5 = new org.telegram.ui.Components.q5(22, i10, tL_forumTopic.icon_emoji_id);
                    this.f34520k0 = q5Var5;
                    q5Var5.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20760ic, f6Var), PorterDuff.Mode.SRC_IN));
                }
                org.telegram.ui.Components.q5 q5Var6 = this.f34520k0;
                if (q5Var6 != null && (view2 = this.f34506a0) != null) {
                    q5Var6.a(view2);
                }
                imageReceiver.setImageBitmap((Bitmap) null);
            } else {
                View view4 = this.f34506a0;
                if (view4 != null && (q5Var = this.f34520k0) != null) {
                    q5Var.o(view4);
                }
                this.f34520k0 = null;
