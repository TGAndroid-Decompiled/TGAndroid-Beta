...
public final class lx0 extends LinearLayout {
    public final TextView f35643a;
    public final TextView f35644b;
    public final FrameLayout f35645c;
    public final hx0 d;
    public final ix0 e;
    public boolean f35646f;
    public boolean h;
    public final PremiumPreviewFragment f35647n;
    ...
    public lx0(PremiumPreviewFragment premiumPreviewFragment, Context context) {
        ...
        int i11;
        int i12;
        this.f35647n = premiumPreviewFragment;
        setOrientation(1);
        FrameLayout frameLayout = new FrameLayout(context);
        this.f35645c = frameLayout;
        int i13 = premiumPreviewFragment.f31178g0;
        if (i13 == 1) {
            i10 = 175;
        } else {
            i10 = 190;
    ...
    public final void b() {
        ...
        int i12;
        int i13;
        PremiumPreviewFragment premiumPreviewFragment = this.f35647n;
        int i14 = premiumPreviewFragment.f31178g0;
        TextView textView = this.f35643a;
        TextView textView2 = this.f35644b;
        if (i14 == 0) {
            if (premiumPreviewFragment.f31187p0) {
                i12 = R.string.TelegramPremiumSubscribedTitle;
            } else {
                i12 = R.string.TelegramPremium;
            }
            textView.setText(LocaleController.getString(i12));
            if (!premiumPreviewFragment.getUserConfig().isPremium() && !premiumPreviewFragment.f31187p0) {
        ...
        int i15 = 0;
        if (!premiumPreviewFragment.f31187p0 && !BuildVars.IS_BILLING_UNAVAILABLE && premiumPreviewFragment.d.size() > 1) {
            z10 = false;
        } else {
            z10 = true;
        }
