...
public final class tt0 extends gu0 {
    public final int f38219p0;
    public final NotificationCenter.NotificationCenterDelegate f38220q0;
    ...
    public tt0(NotificationCenter.NotificationCenterDelegate notificationCenterDelegate, Context context, ju0 ju0Var, FrameLayout frameLayout, int i10) {
        ...
        this.f38219p0 = i10;
        this.f38220q0 = notificationCenterDelegate;
    }

    @Override
    public boolean C() {
        switch (this.f38219p0) {
            case 0:
                return !((PhotoViewer) this.f38220q0).f31330s;
            default:
                return super.C();
        }
    }
    ...
    public void D() {
        switch (this.f38219p0) {
            case 1:
                SecretMediaViewer secretMediaViewer = (SecretMediaViewer) this.f38220q0;
                if (secretMediaViewer.J && getScrollY() <= 0) {
                    AndroidUtilities.runOnUIThread(secretMediaViewer.f31747r1, 3000L);
                    return;
                }
                return;
            default:
    ...
    public void F() {
        switch (this.f38219p0) {
            case 1:
                AndroidUtilities.cancelRunOnUIThread(((SecretMediaViewer) this.f38220q0).f31747r1);
                return;
            default:
                return;
        }
        ...
        switch (this.f38219p0) {
            case 1:
                ...
                if (secretMediaViewer.K0 == null) {
                    if (getScrollY() < getMeasuredHeight() / 3.0f && secretMediaViewer.f31732k0) {
                        z10 = true;
                    } else {
                        z10 = false;
                    }
    ...
    public void invalidate() {
        ...
        switch (this.f38219p0) {
            case 0:
                super.invalidate();
                PhotoViewer photoViewer = (PhotoViewer) this.f38220q0;
                ...
                if (photoViewer.J) {
                    ...
                    if (!z10) {
                        int b10 = ru0VarArr[0].b() + ru0VarArr[0].f37469j;
                        if (C()) {
