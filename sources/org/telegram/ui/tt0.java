...
public final class tt0 extends gu0 {
    public final int f38237p0;
    public final NotificationCenter.NotificationCenterDelegate f38238q0;
    ...
    public tt0(NotificationCenter.NotificationCenterDelegate notificationCenterDelegate, Context context, ju0 ju0Var, FrameLayout frameLayout, int i10) {
        ...
        this.f38237p0 = i10;
        this.f38238q0 = notificationCenterDelegate;
    }

    @Override
    public boolean C() {
        switch (this.f38237p0) {
            case 0:
                return !((PhotoViewer) this.f38238q0).f31343s;
            default:
                return super.C();
        }
    }
    ...
    public void D() {
        switch (this.f38237p0) {
            case 1:
                SecretMediaViewer secretMediaViewer = (SecretMediaViewer) this.f38238q0;
                if (secretMediaViewer.J && getScrollY() <= 0) {
                    AndroidUtilities.runOnUIThread(secretMediaViewer.f31760r1, 3000L);
                    return;
                }
                return;
            default:
    ...
    public void F() {
        switch (this.f38237p0) {
            case 1:
                AndroidUtilities.cancelRunOnUIThread(((SecretMediaViewer) this.f38238q0).f31760r1);
                return;
            default:
                return;
        }
        ...
        switch (this.f38237p0) {
            case 1:
                ...
                if (secretMediaViewer.K0 == null) {
                    if (getScrollY() < getMeasuredHeight() / 3.0f && secretMediaViewer.f31745k0) {
                        z10 = true;
                    } else {
                        z10 = false;
                    }
    ...
    public void invalidate() {
        ...
        switch (this.f38237p0) {
            case 0:
                super.invalidate();
                PhotoViewer photoViewer = (PhotoViewer) this.f38238q0;
                ...
                if (photoViewer.J) {
                    ...
                    if (!z10) {
                        int b10 = ru0VarArr[0].b() + ru0VarArr[0].f37483j;
                        if (C()) {
