...
public abstract class s7 extends FrameLayout implements org.telegram.ui.Components.lc0 {
    public final ArrayList f37263a;
    public final org.telegram.ui.Components.h81 f37264b;
    public final View f37265c;
    public final org.telegram.ui.ActionBar.n2 d;
    public final ArrayList e;
    public zh.b f37266f;
    public final org.telegram.ui.Components.i81 h;
    public final r7[] f37267n;
    public h7 f37268r;
    public int f37269s;
    public i7 v;
    ...
    public s7(Context context, org.telegram.ui.ActionBar.n2 n2Var) {
        ...
        while (true) {
            ...
            if (i10 < r7VarArr2.length) {
                ...
                int i12 = org.telegram.ui.ActionBar.i6.f19239z8;
                ...
                this.f37263a.add(imageView);
                imageView.setOnClickListener(new View.OnClickListener(this) {
                    public final s7 f31715b;
    ...
    public static void a(s7 s7Var, m7 m7Var, o7 o7Var, org.telegram.ui.Components.ll0 ll0Var) {
        ...
        if (s7Var.f37268r == null) {
            s7Var.f37268r = new h7(s7Var);
        }
        s7Var.f37268r.f34180a = ll0Var;
        if (arrayList.indexOf(m7Var) >= 0) {
            PhotoViewer.t1().f2(o7Var.f36112r, arrayList.indexOf(m7Var), -1, false, s7Var.f37268r, null);
        }
    }
    ...
    public static void b(s7 s7Var, zh.a aVar, k7 k7Var) {
        ...
        if (k7Var.e == 2) {
            if (ll0Var.getAdapter() instanceof l7) {
                ...
                if (!file.getName().endsWith("mp4") && !file.getName().endsWith(".jpg") && !lowerCase.endsWith(".jpeg") && !lowerCase.endsWith(".png") && !lowerCase.endsWith(".gif")) {
                    ...
                    PhotoViewer.t1().f2(arrayList, 0, -1, false, s7Var.f37268r, null);
                }
            } else {
                return;
            }
        ...
        if (k7Var.e == 3) {
            if (MediaController.getInstance().isPlayingMessage(aVar.f49197f)) {
                if (!MediaController.getInstance().isMessagePaused()) {
                    MediaController.getInstance().lambda$startAudioAgain$7(aVar.f49197f);
                    return;
                } else {
                    MediaController.getInstance().playMessage(aVar.f49197f);
                    return;
                }
            }
            MediaController.getInstance().playMessage(aVar.f49197f);
