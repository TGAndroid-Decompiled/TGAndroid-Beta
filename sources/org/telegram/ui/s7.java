...
public final class s7 extends i7 {
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        boolean z11;
        float f7;
        m7 m7Var = (m7) c1Var.f42697a;
        org.telegram.ui.Cells.i7 i7Var = (org.telegram.ui.Cells.i7) m7Var.f35697b.getChildAt(0);
        ...
        m7Var.setTag(aVar);
        u7 u7Var = this.f37396n;
        if (aVar.f49220f == null) {
            ...
            tL_message.message = "";
            tL_message.attachPath = aVar.f49217a.getPath();
            TLRPC.TL_messageMediaDocument tL_messageMediaDocument = new TLRPC.TL_messageMediaDocument();
            tL_message.media = tL_messageMediaDocument;
            tL_messageMediaDocument.flags |= 3;
            tL_messageMediaDocument.document = new TLRPC.TL_document();
            tL_message.flags |= 768;
            tL_message.dialog_id = aVar.f49218b;
            String fileExtension = FileLoader.getFileExtension(aVar.f49217a);
        ...
        if (i7Var.f20275f0 != z13) {
            i7Var.f20275f0 = z13;
            i7Var.invalidate();
        }
        m7Var.d = z11;
        m7Var.f35698c.setText(AndroidUtilities.formatFileSize(aVar.f49219c));
        m7Var.f35696a.a(this.f37396n.f37951f.f49228j.contains(aVar), z10);
    }
