...
public abstract class s7 extends FrameLayout implements org.telegram.ui.Components.kc0 {
    public final ArrayList f37137a;
    public final org.telegram.ui.Components.g81 f37138b;
    public final View f37139c;
    public final org.telegram.ui.ActionBar.n2 d;
    public final ArrayList e;
    public zh.b f37140f;
    public final org.telegram.ui.Components.h81 h;
    public final r7[] f37141n;
    public h7 f37142r;
    public int f37143s;
    public i7 v;
    ...
    public s7(Context context, org.telegram.ui.ActionBar.n2 n2Var) {
        ...
        while (true) {
            ...
            if (i10 < r7VarArr2.length) {
                ...
                linearLayout.setBackgroundColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f18789d6, false));
                ...
                int i12 = org.telegram.ui.ActionBar.h6.f19191z8;
                ...
                this.f37137a.add(imageView);
                imageView.setOnClickListener(new View.OnClickListener(this) {
                    public final s7 f31688b;
    ...
    public static void a(s7 s7Var, m7 m7Var, o7 o7Var, org.telegram.ui.Components.ml0 ml0Var) {
        ...
        if (s7Var.f37142r == null) {
            s7Var.f37142r = new h7(s7Var);
        }
        s7Var.f37142r.f33746a = ml0Var;
        if (arrayList.indexOf(m7Var) >= 0) {
            PhotoViewer.t1().f2(o7Var.f35700r, arrayList.indexOf(m7Var), -1, false, s7Var.f37142r, null);
        }
    }
    ...
    public static void b(s7 s7Var, zh.a aVar, k7 k7Var) {
        ...
        if (k7Var.e == 2) {
            if (ml0Var.getAdapter() instanceof l7) {
                ...
                if (!file.getName().endsWith("mp4") && !file.getName().endsWith(".jpg") && !lowerCase.endsWith(".jpeg") && !lowerCase.endsWith(".png") && !lowerCase.endsWith(".gif")) {
                    ...
                    PhotoViewer.t1().f2(arrayList, 0, -1, false, s7Var.f37142r, null);
                }
            } else {
                return;
            }
        ...
        if (k7Var.e == 3) {
            if (MediaController.getInstance().isPlayingMessage(aVar.f49141f)) {
                if (!MediaController.getInstance().isMessagePaused()) {
                    MediaController.getInstance().lambda$startAudioAgain$7(aVar.f49141f);
                    return;
                } else {
                    MediaController.getInstance().playMessage(aVar.f49141f);
                    return;
                }
            }
            MediaController.getInstance().playMessage(aVar.f49141f);
