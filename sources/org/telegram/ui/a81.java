...
public final class a81 extends org.telegram.ui.Components.rl0 {
        ...
        if (b10 != i10) {
            if (b10 < sessionsActivity.H || b10 >= sessionsActivity.I) {
                if (b10 < sessionsActivity.J || b10 >= sessionsActivity.K) {
                    if ((b10 < sessionsActivity.D || b10 >= sessionsActivity.E) && b10 != sessionsActivity.f32290y) {
    ...
    public final long i(int i10) {
        ...
        } else if (i10 == sessionsActivity.f32289x) {
        ...
        } else if (i10 == sessionsActivity.f32290y) {
            ...
            if (i10 >= i13 && i10 < sessionsActivity.I) {
                ...
                if (i10 >= i14 && i10 < sessionsActivity.K) {
                    ...
                    if (i10 >= i15 && i10 < sessionsActivity.E) {
                        TLObject tLObject2 = (TLObject) sessionsActivity.f32284f.get(i10 - i15);
    ...
    public final int j(int i10) {
        ...
        if (i10 != i11) {
            if (i10 != sessionsActivity.B && i10 != sessionsActivity.L && i10 != sessionsActivity.F && i10 != sessionsActivity.O && i10 != sessionsActivity.R && i10 != sessionsActivity.M) {
                if (i10 != sessionsActivity.f32289x && i10 != sessionsActivity.G && i10 != sessionsActivity.C && i10 != sessionsActivity.Q) {
    ...
    public final void v(f2.l1 l1Var, int i10) {
        ...
        if (i13 != 0) {
            if (i13 != 1) {
                if (i13 != 2) {
                    if (i13 != 5) {
                        if (i13 != 6) {
                            org.telegram.ui.Cells.t6 t6Var = (org.telegram.ui.Cells.t6) l1Var.f5785a;
                            SessionsActivity sessionsActivity = this.d;
                            if (i10 == sessionsActivity.f32290y) {
                                TLRPC.TL_authorization tL_authorization = sessionsActivity.f32285n;
                                if (tL_authorization == null) {
                                    t6Var.f22364w = sessionsActivity.d;
                                    t6Var.f22363s = true;
                                    ...
                                    org.telegram.ui.Components.p9 p9Var = t6Var.f22360f;
                                    if (p9Var != null) {
                                ...
                                t6Var.c(tL_authorization, (sessionsActivity.e.isEmpty() && this.d.f32284f.isEmpty() && this.d.N == -1) ? true : true);
                                return;
                            }
                            ...
                            if (i10 >= i17 && i10 < sessionsActivity.E) {
                                TLObject tLObject2 = (TLObject) sessionsActivity.f32284f.get(i10 - i17);
                                if (i10 != this.d.E - 1) {
                                    z4 = true;
                                }
            ...
            org.telegram.ui.Cells.a9 a9Var = (org.telegram.ui.Cells.a9) l1Var.f5785a;
            a9Var.setFixedSize(0);
            SessionsActivity sessionsActivity4 = this.d;
            if (i10 == sessionsActivity4.B) {
                if (sessionsActivity4.f32288w == 0) {
        ...
        org.telegram.ui.Cells.o8 o8Var = (org.telegram.ui.Cells.o8) l1Var.f5785a;
        i11 = this.d.terminateAllSessionsRow;
        if (i10 == i11) {
            int i19 = org.telegram.ui.ActionBar.j6.f20122p7;
            o8Var.e(i19, i19);
    ...
    public final f2.l1 x(android.view.ViewGroup r26, int r27) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.a81.x(android.view.ViewGroup, int):f2.l1");
    }
}
