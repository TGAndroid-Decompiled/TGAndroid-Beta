...
public final class jj0 extends la1 {
        ...
        if (this.f35412r.f35971c <= 0) {
            ...
            if (gVar.f11166t0.G) {
                ...
                if (this.f35413s == 4) {
                    ...
                    ?? obj = new Object();
                    mj0Var.f35779w = obj;
                    mj0Var.f35775f.getClass();
                    obj.f32048a = RecyclerView.S(this);
                    gVar.f11166t0.d(true, false);
                    i10 = ((org.telegram.ui.ActionBar.n2) mj0Var).currentAccount;
                    int sendRequest = ConnectionsManager.getInstance(i10).sendRequest(tL_loadAsyncGraph, new ba(this, str, (Object) obj, 25), null, null, 0, mj0Var.f35767a.stats_dc, 1, true);
    ...
    public final void f() {
        kj0 kj0Var = this.v;
        mj0 mj0Var = kj0Var.d;
        ab1 ab1Var = mj0Var.f35779w;
        if (ab1Var != null) {
            ab1Var.f32049b = true;
        }
        int childCount = mj0Var.f35775f.getChildCount();
        for (int i10 = 0; i10 < childCount; i10++) {
            View childAt = kj0Var.d.f35775f.getChildAt(i10);
            if (childAt instanceof la1) {
                ((la1) childAt).f35408b.f11166t0.d(false, true);
            }
        }
    }
