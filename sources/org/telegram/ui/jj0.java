...
public final class jj0 extends org.telegram.ui.Components.kl0 {
    ...
    public final boolean D(s4.c1 c1Var) {
        if (c1Var.f45743f == 0) {
            return ((org.telegram.ui.Cells.a5) c1Var.f45739a).getCurrentObject() instanceof TLObject;
        }
        return false;
    }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i16 != 0) {
            if (i16 != 1) {
                if (i16 != 2) {
                    if (i16 != 4) {
                        ...
                        kj0 kj0Var = (kj0) view;
                        TextView[] textViewArr = kj0Var.f38079a;
                        TextView[] textViewArr2 = kj0Var.f38080b;
                        lj0 lj0Var2 = kj0Var.f38081c;
                        ya1 ya1Var = lj0Var2.f38388e0;
                        MessageObject messageObject2 = lj0Var2.f38390n;
                        if (ya1Var != null) {
                            i14 = ya1Var.d();
                            i13 = ya1Var.a();
                            i15 = ya1Var.c();
                        ...
                        TLRPC.ChatFull chatFull = lj0Var2.f38380a;
                    ...
                    la1Var2.e(lj0Var.f38391r, false);
            ...
            view.setBackgroundDrawable(org.telegram.ui.ActionBar.j6.V0(this.f37786c, R.drawable.greydivider_bottom, org.telegram.ui.ActionBar.j6.f20628b7));
            return;
        }
        org.telegram.ui.Cells.a5 a5Var = (org.telegram.ui.Cells.a5) view;
        int i20 = lj0Var.I;
        if (i10 >= i20 && i10 < lj0Var.J) {
            messageObject = (MessageObject) lj0Var.f38394x.get(i10 - i20);
        } else {
            messageObject = null;
        }
        ...
        if (messageObject.isStory()) {
            ...
            a5Var.f21609r = storyItem;
            a5Var.f21603a.setOnClickListener(tvVar);
            return;
        }
        a5Var.f21609r = null;
        a5Var.f21603a.setOnClickListener(null);
        if (DialogObject.isUserDialog(dialogId)) {
        ...
        if (i10 != 0) {
            ...
            if (i10 != 1) {
                if (i10 != 2) {
                    ...
                    lj0Var.f38385c0 = fVar;
                    view = new ij0(this, this.f37786c, i11, fVar, lj0Var.getResourceProvider());
                } else {
                    org.telegram.ui.Cells.l4 l4Var = new org.telegram.ui.Cells.l4(this.f37786c, org.telegram.ui.ActionBar.j6.G6, 16, 11, false, lj0Var.getResourceProvider());
                    l4Var.setHeight(43);
                    a7Var = l4Var;
                }
            } else {
            ...
            org.telegram.ui.Cells.a5 a5Var = new org.telegram.ui.Cells.a5(6, 2, this.f37786c, lj0Var.getResourceProvider(), false);
            a5Var.setDividerColor(org.telegram.ui.ActionBar.j6.f20665d7);
            view = a5Var;
        }
