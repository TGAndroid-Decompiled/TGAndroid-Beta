...
public abstract class m41 extends FrameLayout {
    ...
    public AnimationNotificationsLocker f35600n;
    public boolean f35601r;
    public int f35602s;
    public boolean v;
    public org.telegram.ui.ActionBar.d5 f35603w;
    public o1.k f35604x;
    public float f35605y;
    ...
    public final void b() {
        ...
        if (!SharedConfig.animationsEnabled()) {
            this.e = 0.0f;
            g();
            vx vxVar = this.f35596a;
            if (vxVar != null) {
                vxVar.onPause();
                this.f35596a.onFragmentDestroy();
                removeAllViews();
                this.f35596a = null;
        ...
        this.h.setInterpolator(org.telegram.ui.Components.qr.f27420f);
        this.h.start();
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        float f10;
        if (this.v) {
            f(this.E, this.f35596a, this.f35605y);
            invalidate();
        }
        ...
        if (this.f35596a != null && this.d != null && max > 0.0f) {
            if (this.P == null) {
                this.P = new Paint();
            }
            this.P.setColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f19183w8, false));
            if (max == 1.0f) {
                canvas.save();
            } else {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (view != null) {
            ...
            layoutParams.topMargin = org.telegram.ui.ActionBar.k.getCurrentActionBarHeight() + i12 + this.f35602s;
        }
        org.telegram.ui.ActionBar.k kVar = this.d;
        if (kVar != null) {
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        org.telegram.ui.ActionBar.d5 d5Var = this.f35603w;
    ...
    public void setCurrentTop(int i10) {
        ...
        View view = this.f35597b;
        if (view != null) {
            view.setTranslationY((i10 - view.getTop()) + this.f35602s);
        }
        j0 j0Var = this.f35598c;
        if (j0Var != null) {
    ...
    public void setTransitionPaddingBottom(int i10) {
        ...
        if (com.google.android.gms.internal.vision.e2.u(vxVar)) {
            float f7 = i10;
            vxVar.X0 = f7;
            vxVar.h.setTranslationY(((-f7) - vxVar.f33303e1) - vxVar.f33301d1);
        }
    }
