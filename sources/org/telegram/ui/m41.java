...
public final class m41 implements org.telegram.ui.Components.al0, org.telegram.ui.Components.cl0, oy {
    public final SaveToGallerySettingsActivity f35629a;

    public m41(SaveToGallerySettingsActivity saveToGallerySettingsActivity) {
        this.f35629a = saveToGallerySettingsActivity;
    }
    ...
    public void c(float f7, float f10, int i10, View view) {
        SaveToGallerySettingsActivity saveToGallerySettingsActivity = this.f35629a;
        ...
        } else if (i10 == saveToGallerySettingsActivity.f31431f) {
            SaveToGallerySettingsHelper.Settings X2 = saveToGallerySettingsActivity.X();
            X2.saveVideo = !X2.saveVideo;
            saveToGallerySettingsActivity.Y();
            saveToGallerySettingsActivity.Z();
        } else if (((p41) arrayList.get(i10)).f15533a == 1) {
            Bundle bundle = new Bundle();
            bundle.putBoolean("onlySelect", true);
            bundle.putBoolean("checkCanWrite", false);
            int i11 = saveToGallerySettingsActivity.f31428a;
            if (i11 == 2) {
    ...
    public boolean mo18c(float f7, float f10, int i10, View view) {
        SaveToGallerySettingsActivity saveToGallerySettingsActivity = this.f35629a;
        ArrayList arrayList = saveToGallerySettingsActivity.f31434s;
        if (((p41) arrayList.get(i10)).f15533a == 2) {
