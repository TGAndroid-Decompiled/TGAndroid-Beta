    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        switch (i10) {
            case 0:
                ...
                AndroidUtilities.runOnUIThread(new org.telegram.messenger.ib(this.f35728b, this.d, tLObject, this.f35729c, (TL_account.authorizationForm) obj5, (TL_account.getAuthorizationForm) obj4, (String) obj3, (String) obj2, (String) obj, 2));
                return;
            case 1:
                int[] iArr = (int[]) obj5;
            ...
            default:
                ...
                AndroidUtilities.runOnUIThread(new org.telegram.messenger.ib(this.f35728b, tLObject, (int[]) obj5, this.f35729c, this.d, (Integer) obj4, (Integer) obj3, (Long) obj2, (Integer) obj, 3));
                return;
        }
    }
