...
public final class d90 implements RequestDelegate {
    ...
    public final LaunchActivity f32970b;
    public final int f32971c;
    public final r80 d;
    public final Object e;
    public final Object f32972f;
    public final Object f32973g;
    public final Object h;
    public final Object f32974i;
    ...
    public d90(LaunchActivity launchActivity, r80 r80Var, int i10, TL_account.authorizationForm authorizationform, TL_account.getAuthorizationForm getauthorizationform, String str, String str2, String str3) {
        this.f32969a = 0;
        this.f32970b = launchActivity;
        this.d = r80Var;
        this.f32971c = i10;
        this.f32974i = authorizationform;
    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        Object obj = this.h;
        Object obj2 = this.f32973g;
        Object obj3 = this.f32972f;
        Object obj4 = this.e;
        Object obj5 = this.f32974i;
        switch (i10) {
            case 0:
                Pattern pattern = LaunchActivity.B1;
                AndroidUtilities.runOnUIThread(new org.telegram.messenger.jb(this.f32970b, this.d, tLObject, this.f32971c, (TL_account.authorizationForm) obj5, (TL_account.getAuthorizationForm) obj4, (String) obj3, (String) obj2, (String) obj, 2));
                return;
            case 1:
                int[] iArr = (int[]) obj5;
                ...
                LaunchActivity launchActivity = this.f32970b;
                r80 r80Var = this.d;
                if (authorizationform != null) {
                    TL_account.getPassword getpassword = new TL_account.getPassword();
                    int i11 = this.f32971c;
            ...
            default:
                ...
                AndroidUtilities.runOnUIThread(new org.telegram.messenger.jb(this.f32970b, tLObject, (int[]) obj5, this.f32971c, this.d, (Integer) obj4, (Integer) obj3, (Long) obj2, (Integer) obj, 3));
                return;
        }
    }
