...
public abstract class SelectAnimatedEmojiDialog extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public SelectAnimatedEmojiDialog(final BaseFragment baseFragment, Context context, boolean z, Integer num, final int i, boolean z2, final Theme.ResourcesProvider resourcesProvider, int i2, int i3) {
        ...
        this.updateRowsDelayed = new Runnable() {
            @Override
            public final void run() {
                SelectAnimatedEmojiDialog.m4023$r8$lambda$uHop_huHj1xJMIWI7or3I9HibY(this.f$0);
            }
        };
                            ...
                            if (emojiTabButton != null) {
                                emojiTabButton.setOnLongClickListener(new View.OnLongClickListener() {
                                    ...
                                    public final boolean onLongClick(View view2) {
                                        return SelectAnimatedEmojiDialog.m4011$r8$lambda$QCXkvQ9bkNtZguPabv3aBxtopI(this.f$0, view2);
                                    }
                                });
                            }
                    ...
                    if (emojiTabButton != null) {
                        emojiTabButton.setOnLongClickListener(new View.OnLongClickListener() {
                            ...
                            public final boolean onLongClick(View view4) {
                                return SelectAnimatedEmojiDialog.m4011$r8$lambda$QCXkvQ9bkNtZguPabv3aBxtopI(this.f$0, view4);
                            }
                        });
                    }
                    emojiTabsStrip.updateButtonDrawables = false;
                ...
                if (emojiTabButton != null) {
                    emojiTabButton.setOnLongClickListener(new View.OnLongClickListener() {
                        ...
                        public final boolean onLongClick(View view7) {
                            return SelectAnimatedEmojiDialog.m4011$r8$lambda$QCXkvQ9bkNtZguPabv3aBxtopI(this.f$0, view7);
                        }
                    });
                }
                emojiTabsStrip.updateButtonDrawables = false;
            ...
            if (emojiTabButton != null) {
                emojiTabButton.setOnLongClickListener(new View.OnLongClickListener() {
                    ...
                    public final boolean onLongClick(View view10) {
                        return SelectAnimatedEmojiDialog.m4011$r8$lambda$QCXkvQ9bkNtZguPabv3aBxtopI(this.f$0, view10);
                    }
                });
            }
            emojiTabsStrip.updateButtonDrawables = false;
    ...
    public static boolean m4011$r8$lambda$QCXkvQ9bkNtZguPabv3aBxtopI(SelectAnimatedEmojiDialog selectAnimatedEmojiDialog, View view) {
    ...
    private void onRecentLongClick() {
        ...
        builder.setPositiveButton(LocaleController.getString(R.string.Clear), new AlertDialog.OnButtonClickListener() {
            ...
            public final void onClick(AlertDialog alertDialog, int i) {
                SelectAnimatedEmojiDialog.m4009$r8$lambda$CPc3dBnDJF5XSt8h2d_RZu0o20(this.f$0, alertDialog, i);
            }
        });
    ...
    public static void m4009$r8$lambda$CPc3dBnDJF5XSt8h2d_RZu0o20(SelectAnimatedEmojiDialog selectAnimatedEmojiDialog, AlertDialog alertDialog, int i) {
    ...
    public void switchGrids(final boolean z, boolean z2) {
        ...
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator3) {
                SelectAnimatedEmojiDialog.m4018$r8$lambda$loeIBbFUHLDt3gXndl1ZiQGIRY(this.f$0, z, valueAnimator3);
            }
        });
    ...
    public static void m4018$r8$lambda$loeIBbFUHLDt3gXndl1ZiQGIRY(SelectAnimatedEmojiDialog selectAnimatedEmojiDialog, boolean z, ValueAnimator valueAnimator) {
        selectAnimatedEmojiDialog.getClass();
        float fFloatValue = ((Float) valueAnimator.getAnimatedValue()).floatValue();
        if (!z) {
        ...
        if (TextUtils.isEmpty(str)) {
            ...
            if (!z3) {
                ...
                Runnable runnable3 = new Runnable() {
                    @Override
                    public final void run() {
                        SelectAnimatedEmojiDialog.m4017$r8$lambda$jhgunHjppe1Nl3HY5HImC4pMa4(this.f$0);
                    }
                };
    ...
    public static void m4017$r8$lambda$jhgunHjppe1Nl3HY5HImC4pMa4(SelectAnimatedEmojiDialog selectAnimatedEmojiDialog) {
    ...
    public static void $r8$lambda$0_d5OHyRUY4ysLng6YWuLZtonl8(final SelectAnimatedEmojiDialog selectAnimatedEmojiDialog, final String str, final boolean z, final boolean z2, final String[] strArr) {
                ...
                public final void run(Object obj) {
                    MediaDataController.getInstance(this.f$0.currentAccount).getEmojiSuggestions(SelectAnimatedEmojiDialog.lastSearchKeyboardLanguage, str, false, new MediaDataController.KeywordResultCallback() {
                        ...
                        public final void run(ArrayList arrayList5, String str2) {
                            SelectAnimatedEmojiDialog.m4008$r8$lambda$AjnXrckaUyOFf1LhEYN6gD_kg(linkedHashSet, runnable, arrayList5, str2);
                        }
        ...
        if (i == 14) {
            if (zFullyConsistsOfEmojis) {
                callback = new Utilities.Callback() {
                    @Override
                    public final void run(Object obj) {
                        SelectAnimatedEmojiDialog.m4010$r8$lambda$K_t75OL6eeYSYgWVYYjpPsL0Q0(this.f$0, str, arrayList2, arrayList, (Runnable) obj);
                    }
                };
            } else {
                callback = new Utilities.Callback() {
        ...
        Utilities.doCallbacks(new Utilities.Callback() {
            ...
            @Override
            public final void run(Object obj) {
                SelectAnimatedEmojiDialog.m4024$r8$lambda$vv2_DsahJM2nfdlJyjPQjbxxXg(this.f$0, zFullyConsistsOfEmojis, linkedHashSet, str, reactionsMap, arrayList, (Runnable) obj);
            }
        }, new Utilities.Callback() {
            @Override
            public final void run(Object obj) {
    ...
    public static void $r8$lambda$meCFBPbPc6HnIihh5JSJW61c25E(final SelectAnimatedEmojiDialog selectAnimatedEmojiDialog, final String str, final boolean z, final ArrayList arrayList, final HashMap map, final ArrayList arrayList2, final LinkedHashSet linkedHashSet, final LinkedHashSet linkedHashSet2, final ArrayList arrayList3, final ArrayList arrayList4, final boolean z2, Runnable runnable) {
        ...
        AndroidUtilities.runOnUIThread(new Runnable() {
            @Override
            public final void run() {
                SelectAnimatedEmojiDialog.m4022$r8$lambda$tHXBoLdIMVo0ki4SWZFKMYwaw(this.f$0, str, z, arrayList, map, arrayList2, linkedHashSet, linkedHashSet2, arrayList3, arrayList4, z2);
            }
        });
    }

    public static void m4022$r8$lambda$tHXBoLdIMVo0ki4SWZFKMYwaw(SelectAnimatedEmojiDialog selectAnimatedEmojiDialog, String str, boolean z, ArrayList arrayList, HashMap map, ArrayList arrayList2, LinkedHashSet linkedHashSet, LinkedHashSet linkedHashSet2, ArrayList arrayList3, ArrayList arrayList4, boolean z2) {
    ...
    public static void m4008$r8$lambda$AjnXrckaUyOFf1LhEYN6gD_kg(LinkedHashSet linkedHashSet, Runnable runnable, ArrayList arrayList, String str) {
        for (int i = 0; i < arrayList.size(); i++) {
            try {
    ...
    public static void m4010$r8$lambda$K_t75OL6eeYSYgWVYYjpPsL0Q0(SelectAnimatedEmojiDialog selectAnimatedEmojiDialog, String str, ArrayList arrayList, ArrayList arrayList2, Runnable runnable) {
    ...
    public static void $r8$lambda$FpEboR_auA7dATXw3KK5Jam1QCs(boolean z, String str, final LinkedHashSet linkedHashSet, final Runnable runnable) {
        if (z) {
            StickerCategoriesListView.search.fetch(UserConfig.selectedAccount, str, new Utilities.Callback() {
                @Override
                public final void run(Object obj) {
                    SelectAnimatedEmojiDialog.m4012$r8$lambda$Rx4qUjTWhwvkg983nASK1BOzd8(linkedHashSet, runnable, (TLRPC.TL_emojiList) obj);
                }
            });
        } else {
            runnable.run();
    ...
    public static void m4012$r8$lambda$Rx4qUjTWhwvkg983nASK1BOzd8(LinkedHashSet linkedHashSet, Runnable runnable, TLRPC.TL_emojiList tL_emojiList) {
    ...
    public static void m4024$r8$lambda$vv2_DsahJM2nfdlJyjPQjbxxXg(final SelectAnimatedEmojiDialog selectAnimatedEmojiDialog, boolean z, final LinkedHashSet linkedHashSet, String str, final HashMap map, final ArrayList arrayList, final Runnable runnable) {
    ...
    class HeaderView extends FrameLayout {
        ...
        public void updateLock(boolean z, boolean z2) {
            ...
            if (z2) {
                ...
                valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                    @Override
                    public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                        SelectAnimatedEmojiDialog.HeaderView.m4025$r8$lambda$k7I8r5Dptp4d9llghovAWxtrYA(this.f$0, valueAnimator2);
                    }
                });
        ...
        public static void m4025$r8$lambda$k7I8r5Dptp4d9llghovAWxtrYA(HeaderView headerView, ValueAnimator valueAnimator) {
            headerView.getClass();
            ...
            if (i3 == 0 || i3 == 12 || i3 == 9 || i3 == 10 || i3 == 2) {
                if (!willApplyEmoji(view, Long.valueOf(animatedEmojiSpan.documentId), document, imageViewEmoji.starGift, null)) {
                    ...
                    animateEmojiSelect(imageViewEmoji, new Runnable() {
                        @Override
                        public final void run() {
                            SelectAnimatedEmojiDialog.m4020$r8$lambda$qwCROphBujA1JTWT1SxcYWAA2Y(this.f$0, view, animatedEmojiSpan, document, imageViewEmoji);
                        }
                    });
                    return;
                }
    ...
    public static void m4020$r8$lambda$qwCROphBujA1JTWT1SxcYWAA2Y(SelectAnimatedEmojiDialog selectAnimatedEmojiDialog, View view, AnimatedEmojiSpan animatedEmojiSpan, TLRPC.Document document, ImageViewEmoji imageViewEmoji) {
        selectAnimatedEmojiDialog.getClass();
    ...
    public static void m4023$r8$lambda$uHop_huHj1xJMIWI7or3I9HibY(SelectAnimatedEmojiDialog selectAnimatedEmojiDialog) {
        selectAnimatedEmojiDialog.getClass();
    ...
    public void onShow(Runnable runnable) {
        ...
        if (isAnimatedShow()) {
            ...
            HwEmojis.prepare(new Runnable() {
                @Override
                public final void run() {
                    SelectAnimatedEmojiDialog.m4016$r8$lambda$iR2TEtgi6JnaEnSfMOLyJYCg(this.f$0);
                }
            }, true);
    ...
    public static void m4016$r8$lambda$iR2TEtgi6JnaEnSfMOLyJYCg(final SelectAnimatedEmojiDialog selectAnimatedEmojiDialog) {
        selectAnimatedEmojiDialog.getClass();
        HwEmojis.enableHw();
        AndroidUtilities.runOnUIThread(new Runnable() {
            @Override
    ...
    public class SearchBox extends FrameLayout implements Theme.Colorable {
        ...
        private void createCategoriesListView() {
            ...
            if (SelectAnimatedEmojiDialog.this.type == 1 || SelectAnimatedEmojiDialog.this.type == 11 || SelectAnimatedEmojiDialog.this.type == 2 || SelectAnimatedEmojiDialog.this.type == 0 || SelectAnimatedEmojiDialog.this.type == 12 || SelectAnimatedEmojiDialog.this.type == 4 || SelectAnimatedEmojiDialog.this.type == 10 || SelectAnimatedEmojiDialog.this.type == 9 || SelectAnimatedEmojiDialog.this.type == 14) {
                ...
                this.categoriesListView.setOnScrollIntoOccupiedWidth(new Utilities.Callback() {
                    @Override
                    public final void run(Object obj) {
                        SelectAnimatedEmojiDialog.SearchBox.m4028$r8$lambda$XWQ854u3lZSTEe8P72_tcGfw2I(this.f$0, (Integer) obj);
                    }
                });
        ...
        public static void m4028$r8$lambda$XWQ854u3lZSTEe8P72_tcGfw2I(SearchBox searchBox, Integer num) {
        ...
        public void showInputBoxGradient(boolean z) {
            ...
            valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                @Override
                public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                    SelectAnimatedEmojiDialog.SearchBox.m4027$r8$lambda$XDHLL4YMCMalyww5F5ku3vdT2M(this.f$0, valueAnimator2);
                }
            });
        ...
        public static void m4027$r8$lambda$XDHLL4YMCMalyww5F5ku3vdT2M(SearchBox searchBox, ValueAnimator valueAnimator) {
            searchBox.getClass();
            float fFloatValue = ((Float) valueAnimator.getAnimatedValue()).floatValue();
    ...
    class SelectStatusDurationDialog extends Dialog {
        ...
        public SelectStatusDurationDialog(final Context context, Runnable runnable, View view, ImageViewEmoji imageViewEmoji, Theme.ResourcesProvider resourcesProvider) {
            ...
            ActionBarMenuItem.addItem(false, false, this.menuView, 0, LocaleController.getString(R.string.SetEmojiStatusUntil2Hours), false, resourcesProvider).setOnClickListener(new View.OnClickListener() {
                @Override
                public final void onClick(View view3) {
                    SelectAnimatedEmojiDialog.SelectStatusDurationDialog.m4034$r8$lambda$otMmABbzTRQ_ZgChO9YiDhqgfs(this.f$0, view3);
                }
            });
            ActionBarMenuItem.addItem(false, false, this.menuView, 0, LocaleController.getString(R.string.SetEmojiStatusUntil8Hours), false, resourcesProvider).setOnClickListener(new View.OnClickListener() {
                @Override
                public final void onClick(View view3) {
                    SelectAnimatedEmojiDialog.SelectStatusDurationDialog.m4035$r8$lambda$xDQ9q5wEcuggLNRMJBSDDBe9zA(this.f$0, view3);
                }
            });
            ActionBarMenuItem.addItem(false, false, this.menuView, 0, LocaleController.getString(R.string.SetEmojiStatusUntil2Days), false, resourcesProvider).setOnClickListener(new View.OnClickListener() {
                @Override
                public final void onClick(View view3) {
                    SelectAnimatedEmojiDialog.SelectStatusDurationDialog.m4033$r8$lambda$oBoyHEampfY_4R2lm7E_Z4w6F4(this.f$0, view3);
                }
            });
        ...
        public static void m4034$r8$lambda$otMmABbzTRQ_ZgChO9YiDhqgfs(SelectStatusDurationDialog selectStatusDurationDialog, View view) {
            selectStatusDurationDialog.getClass();
            selectStatusDurationDialog.done(Integer.valueOf((int) ((System.currentTimeMillis() / 1000) + 7200)));
        }

        public static void m4035$r8$lambda$xDQ9q5wEcuggLNRMJBSDDBe9zA(SelectStatusDurationDialog selectStatusDurationDialog, View view) {
            selectStatusDurationDialog.getClass();
            selectStatusDurationDialog.done(Integer.valueOf((int) ((System.currentTimeMillis() / 1000) + 28800)));
        }

        public static void m4033$r8$lambda$oBoyHEampfY_4R2lm7E_Z4w6F4(SelectStatusDurationDialog selectStatusDurationDialog, View view) {
            selectStatusDurationDialog.getClass();
        ...
        public static void $r8$lambda$w2BVkvY8HD0D3rs69FTnsTMPN2I(final SelectStatusDurationDialog selectStatusDurationDialog, Context context, View view) {
            ...
            BottomSheet.Builder builderCreateStatusUntilDatePickerDialog = AlertsCreator.createStatusUntilDatePickerDialog(context, System.currentTimeMillis() / 1000, new AlertsCreator.StatusUntilDatePickerDelegate() {
                ...
                public final void didSelectDate(int i) {
                    SelectAnimatedEmojiDialog.SelectStatusDurationDialog.m4029$r8$lambda$B9IrBL_luvLZai2dqiK9u_uE4E(this.f$0, zArr, i);
                }
            });
            builderCreateStatusUntilDatePickerDialog.setOnPreDismissListener(new DialogInterface.OnDismissListener() {
                @Override
                public final void onDismiss(DialogInterface dialogInterface) {
                    SelectAnimatedEmojiDialog.SelectStatusDurationDialog.m4032$r8$lambda$XEB4iv7CJ4CfHd79mnHBTMMJ0(this.f$0, zArr, dialogInterface);
                }
            });
        ...
        public static void m4029$r8$lambda$B9IrBL_luvLZai2dqiK9u_uE4E(SelectStatusDurationDialog selectStatusDurationDialog, boolean[] zArr, int i) {
            selectStatusDurationDialog.getClass();
            zArr[0] = true;
            selectStatusDurationDialog.done(Integer.valueOf(i));
        }

        public static void m4032$r8$lambda$XEB4iv7CJ4CfHd79mnHBTMMJ0(SelectStatusDurationDialog selectStatusDurationDialog, boolean[] zArr, DialogInterface dialogInterface) {
            selectStatusDurationDialog.getClass();
            if (!zArr[0]) {
        ...
        private void done(final Integer num) {
            ...
            animateShow(false, new Runnable() {
                @Override
                public final void run() {
                    SelectAnimatedEmojiDialog.SelectStatusDurationDialog.m4031$r8$lambda$QHZT4k_7QL56MyKI5F6vPUltWI(this.f$0, num);
                }
            }, new Runnable() {
                @Override
                public final void run() {
                    SelectAnimatedEmojiDialog.SelectStatusDurationDialog.m4030$r8$lambda$Ivp3FI4AOu5X0m0rlbRtX87XL4(this.f$0, num);
                }
            }, !z);
            animateMenuShow(false, null);
        }

        public static void m4031$r8$lambda$QHZT4k_7QL56MyKI5F6vPUltWI(SelectStatusDurationDialog selectStatusDurationDialog, Integer num) {
        ...
        public static void m4030$r8$lambda$Ivp3FI4AOu5X0m0rlbRtX87XL4(SelectStatusDurationDialog selectStatusDurationDialog, Integer num) {
            selectStatusDurationDialog.getClass();
            if (num != null) {
                try {
