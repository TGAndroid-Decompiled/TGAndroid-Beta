...
public final class nf implements Utilities.Callback {
    ...
    public final void run(Object obj) {
        ...
        int[] iArr;
        int i11;
        int i12 = this.f35972a;
        float f10 = -0.04f;
        float f11 = 0.25f;
        SendMessageChatArguments sendMessageChatArguments = null;
        int i13 = 0;
        Object obj2 = this.f35974c;
        Object obj3 = this.f35973b;
        switch (i12) {
            case 0:
                bo boVar = (bo) obj3;
                ...
                Long l4 = (Long) obj;
                if (boVar.R3 == 1) {
                    org.telegram.ui.Components.c5.M(boVar.getParentActivity(), boVar.T5, new b7(boVar, botInlineResult, l4, 2), boVar.f32293ea);
                    return;
                } else {
            ...
            case 2:
                ...
                if (tL_statsPollStats != null) {
                    if (tL_statsPollStats.votes_graph instanceof TL_stats.TL_statsGraphError) {
                        ...
                        new th.g(boVar2.getParentActivity(), boVar2.f32293ea, tL_statsPollStats).show();
                        return;
                    }
                }
                return;
            ...
            case 4:
                ...
                bo boVar4 = ((nj) obj3).f35998b;
                if (b2Var != null) {
                    i10 = ((org.telegram.ui.ActionBar.n2) boVar4).currentAccount;
                    hg.c2.f(i10).k(b2Var.f10219a, str);
                }
                boVar4.Q3 = str;
                boVar4.f32233a1.setTitle(str);
                return;
            case 5:
                MessageObject messageObject2 = (MessageObject) obj2;
                Long l10 = (Long) obj;
                bo boVar5 = ((nn) obj3).f36017a;
                if (boVar5.f7()) {
                    SendMessagesHelper.SendMessageParams of2 = SendMessagesHelper.SendMessageParams.of(messageObject2.getDiceEmoji(), boVar5.T5, boVar5.f32398n5, boVar5.X3, null, false, null, null, null, true, 0, 0, null, false);
            ...
            case 6:
                ...
                bo boVar6 = ((nn) obj3).f36017a;
                if (((Boolean) obj).booleanValue()) {
                    while (i13 < boVar6.f32519x0.getChildCount()) {
                        View childAt = boVar6.f32519x0.getChildAt(i13);
            ...
            case 8:
                ...
                ((nn) obj3).f36017a.getMessagesController().rejectSuggestedMessage(DialogObject.getPeerDialogId(message.peer_id), message.f18130id, (String) obj);
                return;
            case 9:
                fo foVar = (fo) obj3;
                foVar.f33640f.t(((dg.a) obj).f7724b, ((TLRPC.WallPaper) obj2).settings.intensity);
                View view = foVar.f33638b;
                if (view != null) {
                    view.invalidate();
                    return;
                }
            ...
            case 10:
                Long l11 = (Long) obj;
                ChatActivityEnterView chatActivityEnterView = ((org.telegram.ui.Components.nf) obj3).f26446a;
            ...
            case 11:
                ...
                ((bo) obj3).f32313g5 = (MessageSuggestionParams) obj;
                boolean G1 = viVar.G1(0, true, 0, viVar.s1(), viVar.N0);
                org.telegram.ui.Components.kf kfVar = viVar.f28753h0;
                if (kfVar != null) {
                    kfVar.h(!G1);
                    viVar.f28753h0 = null;
                    return;
            ...
            case 12:
                ...
                return;
            case 13:
                org.telegram.ui.Components.gl glVar = ((org.telegram.ui.Components.dl) obj3).f23355b;
                glVar.f24412x0.b(((org.telegram.ui.Components.fl) obj2).f24012c, glVar.f24414y0, true, 0, ((Long) obj).longValue());
            ...
            case 16:
                ...
                org.telegram.ui.Components.jy jyVar = iyVar.f25164a;
                ...
                if (!SharedConfig.suggestAnimatedEmoji && !UserConfig.getInstance(kzVar.f25700c1).isPremium()) {
                    z10 = false;
                } else {
                    z10 = true;
                }
            ...
            case 17:
                ...
                org.telegram.ui.Components.jy jyVar2 = ((org.telegram.ui.Components.iy) obj3).f25164a;
                if (ConnectionsManager.getInstance(jyVar2.F.f25700c1).getConnectionState() != 3) {
                    runnable.run();
                    return;
                } else {
            ...
            case 18:
                ...
                while (i13 < size) {
                    ...
                    if (stickerSetCovered instanceof TLRPC.TL_stickerSetFullCovered) {
                        ...
                        TLRPC.TL_messages_stickerSet stickerSet = MediaDataController.getInstance(dzVar.f23432w.Q.f25700c1).getStickerSet(MediaDataController.getInputStickerSet(stickerSetCovered.set), Integer.valueOf(stickerSetCovered.set.hash), true);
                        if (stickerSet != null) {
                    ...
                    if (arrayList != null && !arrayList.isEmpty()) {
                        dzVar.f23429n.add(new org.telegram.ui.Components.cy(stickerSetCovered, arrayList));
                    }
                }
                runnable2.run();
                return;
            case 19:
                ...
                if (c10Var.f22905a0 == null && !(c10Var.Z instanceof TL_chatlists.TL_chatlists_chatlistInviteAlready)) {
                    org.telegram.ui.Components.oc M = org.telegram.ui.Components.vc.a0(n2Var).M(AndroidUtilities.replaceTags(LocaleController.formatString(R.string.FolderLinkAddedTitle, c10Var.f22910f0)), LocaleController.formatPluralString("FolderLinkAddedSubtitle", arrayList4.size(), new Object[0]), R.raw.contact_check);
                    M.f26751j = 5000;
                    M.j();
                    return;
                }
                ...
                SpannableStringBuilder replaceTags = AndroidUtilities.replaceTags(LocaleController.formatString(R.string.FolderLinkUpdatedTitle, c10Var.f22910f0));
                if (arrayList4.size() <= 0) {
                    formatPluralString = LocaleController.formatPluralString("FolderLinkUpdatedSubtitle", c10Var.f22912h0.size(), new Object[0]);
                } else {
            ...
            case 27:
                ...
                r50Var.f37029c = bitmap2;
                Paint paint = new Paint(1);
                r50Var.d = paint;
                Bitmap bitmap3 = r50Var.f37029c;
            ...
            case 28:
                ...
                fc0Var.a();
                if (user != null) {
                    long j10 = userArr[0].f18256id;
                    Bundle bundle2 = new Bundle();
                    bundle2.putLong("user_id", user.f18256id);
            ...
            default:
                ...
                ArrayList arrayList5 = rj0Var.f37149f0;
                arrayList5.clear();
                if (list != null) {
                    for (TLRPC.User user2 : list) {
                        if (user2 != null && !hashSet.contains(Long.valueOf(user2.f18256id)) && rj0Var.R(user2)) {
                            arrayList5.add(user2);
                            hashSet.add(Long.valueOf(user2.f18256id));
                        }
                    }
                }
                Boolean bool2 = rj0Var.f37160r0;
                if (bool2 != null && bool2.booleanValue()) {
                    ...
                    if (str3 != null && !str3.isEmpty()) {
                        ...
                        tL_contacts_search.f18155q = str3;
                        tL_contacts_search.limit = 50;
                        i13 = connectionsManager.sendRequest(tL_contacts_search, new cj1(3, messagesController2, mj0Var));
                    } else {
