...
public final class nf implements Utilities.Callback {
    ...
    public final void run(Object obj) {
        ...
        int[] iArr;
        int i11;
        int i12 = this.f38967a;
        float f10 = -0.04f;
        float f11 = 0.25f;
        SendMessageChatArguments sendMessageChatArguments = null;
        int i13 = 0;
        Object obj2 = this.f38969c;
        Object obj3 = this.f38968b;
        switch (i12) {
            case 0:
                co coVar = (co) obj3;
                ...
                Long l4 = (Long) obj;
                if (coVar.R3 == 1) {
                    org.telegram.ui.Components.e5.M(coVar.getParentActivity(), coVar.T5, new b7(coVar, botInlineResult, l4, 2), coVar.f35275ea);
                    return;
                } else {
            ...
            case 2:
                ...
                if (tL_statsPollStats != null) {
                    if (tL_statsPollStats.votes_graph instanceof TL_stats.TL_statsGraphError) {
                        ...
                        new uh.g(coVar2.getParentActivity(), coVar2.f35275ea, tL_statsPollStats).show();
                        return;
                    }
                }
                return;
            ...
            case 4:
                ...
                co coVar4 = ((nj) obj3).f38995b;
                if (a2Var != null) {
                    i10 = ((org.telegram.ui.ActionBar.n2) coVar4).currentAccount;
                    ig.b2.f(i10).k(a2Var.f12018a, str);
                }
                coVar4.Q3 = str;
                coVar4.f35214a1.setTitle(str);
                return;
            case 5:
                MessageObject messageObject2 = (MessageObject) obj2;
                Long l10 = (Long) obj;
                co coVar5 = ((on) obj3).f39311a;
                if (coVar5.f7()) {
                    SendMessagesHelper.SendMessageParams of2 = SendMessagesHelper.SendMessageParams.of(messageObject2.getDiceEmoji(), coVar5.T5, coVar5.f35380n5, coVar5.X3, null, false, null, null, null, true, 0, 0, null, false);
            ...
            case 6:
                ...
                co coVar6 = ((on) obj3).f39311a;
                if (((Boolean) obj).booleanValue()) {
                    while (i13 < coVar6.f35501x0.getChildCount()) {
                        View childAt = coVar6.f35501x0.getChildAt(i13);
            ...
            case 8:
                ...
                ((on) obj3).f39311a.getMessagesController().rejectSuggestedMessage(DialogObject.getPeerDialogId(message.peer_id), message.f19917id, (String) obj);
                return;
            case 9:
                go goVar = (go) obj3;
                goVar.f36756f.t(((dg.a) obj).f6836b, ((TLRPC.WallPaper) obj2).settings.intensity);
                View view = goVar.f36753b;
                if (view != null) {
                    view.invalidate();
                    return;
                }
            ...
            case 10:
                Long l11 = (Long) obj;
                ChatActivityEnterView chatActivityEnterView = ((org.telegram.ui.Components.pf) obj3).f29394a;
            ...
            case 11:
                ...
                ((co) obj3).f35295g5 = (MessageSuggestionParams) obj;
                boolean G1 = viVar.G1(0, true, 0, viVar.s1(), viVar.N0);
                org.telegram.ui.Components.nf nfVar2 = viVar.f31313h0;
                if (nfVar2 != null) {
                    nfVar2.h(!G1);
                    viVar.f31313h0 = null;
                    return;
            ...
            case 12:
                ...
                return;
            case 13:
                org.telegram.ui.Components.gl glVar = ((org.telegram.ui.Components.dl) obj3).f25447b;
                glVar.f26483x0.b(((org.telegram.ui.Components.fl) obj2).f26153c, glVar.f26485y0, true, 0, ((Long) obj).longValue());
            ...
            case 16:
                ...
                org.telegram.ui.Components.ky kyVar = jyVar.f27612a;
                org.telegram.ui.Components.kz kzVar = kyVar.F;
                MediaDataController mediaDataController = MediaDataController.getInstance(kzVar.f27960c1);
                ...
                if (!SharedConfig.suggestAnimatedEmoji && !UserConfig.getInstance(kzVar.f27960c1).isPremium()) {
                    z10 = false;
                } else {
                    z10 = true;
                }
            ...
            case 17:
                ...
                org.telegram.ui.Components.ky kyVar2 = ((org.telegram.ui.Components.jy) obj3).f27612a;
                if (ConnectionsManager.getInstance(kyVar2.F.f27960c1).getConnectionState() != 3) {
                    runnable.run();
                    return;
                } else {
            ...
            case 18:
                ...
                while (i13 < size) {
                    ...
                    if (stickerSetCovered instanceof TLRPC.TL_stickerSetFullCovered) {
                        ...
                        TLRPC.TL_messages_stickerSet stickerSet = MediaDataController.getInstance(dzVar.f25518w.Q.f27960c1).getStickerSet(MediaDataController.getInputStickerSet(stickerSetCovered.set), Integer.valueOf(stickerSetCovered.set.hash), true);
                        if (stickerSet != null) {
                    ...
                    if (arrayList != null && !arrayList.isEmpty()) {
                        dzVar.f25515n.add(new org.telegram.ui.Components.dy(stickerSetCovered, arrayList));
                    }
                }
                runnable2.run();
                return;
            case 19:
                ...
                if (c10Var.f24869a0 == null && !(c10Var.Z instanceof TL_chatlists.TL_chatlists_chatlistInviteAlready)) {
                    org.telegram.ui.Components.qc M = org.telegram.ui.Components.yc.a0(n2Var).M(AndroidUtilities.replaceTags(LocaleController.formatString(R.string.FolderLinkAddedTitle, c10Var.f24874f0)), LocaleController.formatPluralString("FolderLinkAddedSubtitle", arrayList4.size(), new Object[0]), R.raw.contact_check);
                    M.f29707j = 5000;
                    M.j();
                    return;
                }
                ...
                SpannableStringBuilder replaceTags = AndroidUtilities.replaceTags(LocaleController.formatString(R.string.FolderLinkUpdatedTitle, c10Var.f24874f0));
                if (arrayList4.size() <= 0) {
                    formatPluralString = LocaleController.formatPluralString("FolderLinkUpdatedSubtitle", c10Var.f24876h0.size(), new Object[0]);
                } else {
            ...
            case 27:
                ...
                s50Var.f40332c = bitmap2;
                Paint paint = new Paint(1);
                s50Var.d = paint;
                Bitmap bitmap3 = s50Var.f40332c;
                Shader.TileMode tileMode = Shader.TileMode.CLAMP;
                BitmapShader bitmapShader = new BitmapShader(bitmap3, tileMode, tileMode);
                s50Var.f40333e = bitmapShader;
            ...
            case 28:
                ...
                fc0Var.a();
                if (user != null) {
                    long j10 = userArr[0].f20043id;
                    Bundle bundle2 = new Bundle();
                    bundle2.putLong("user_id", user.f20043id);
            ...
            default:
                ...
                ArrayList arrayList5 = tj0Var.f40801f0;
                arrayList5.clear();
                if (list != null) {
                    for (TLRPC.User user2 : list) {
                        if (user2 != null && !hashSet.contains(Long.valueOf(user2.f20043id)) && tj0Var.R(user2)) {
                            arrayList5.add(user2);
                            hashSet.add(Long.valueOf(user2.f20043id));
                        }
                    }
                }
                Boolean bool2 = tj0Var.f40812r0;
                if (bool2 != null && bool2.booleanValue()) {
                    ...
                    if (str3 != null && !str3.isEmpty()) {
                        ...
                        tL_contacts_search.f19942q = str3;
