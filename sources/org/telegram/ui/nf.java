...
public final class nf implements Utilities.Callback {
    ...
    public final void run(Object obj) {
        ...
        int[] iArr;
        int i11;
        int i12 = this.f35964a;
        float f10 = -0.04f;
        float f11 = 0.25f;
        SendMessageChatArguments sendMessageChatArguments = null;
        int i13 = 0;
        Object obj2 = this.f35966c;
        Object obj3 = this.f35965b;
        switch (i12) {
            case 0:
                bo boVar = (bo) obj3;
                ...
                Long l4 = (Long) obj;
                if (boVar.R3 == 1) {
                    org.telegram.ui.Components.c5.M(boVar.getParentActivity(), boVar.T5, new b7(boVar, botInlineResult, l4, 2), boVar.f32297ea);
                    return;
                } else {
            ...
            case 1:
                bo.q1((bo) obj3, (h41[]) obj2, (org.telegram.ui.Components.n70) obj);
                return;
            case 2:
                bo boVar2 = (bo) obj3;
                ...
                if (tL_statsPollStats != null) {
                    if (tL_statsPollStats.votes_graph instanceof TL_stats.TL_statsGraphError) {
                        ...
                        new th.g(boVar2.getParentActivity(), boVar2.f32297ea, tL_statsPollStats).show();
                        return;
                    }
                }
                return;
            ...
            case 4:
                ...
                bo boVar4 = ((nj) obj3).f35993b;
                if (a2Var != null) {
                    i10 = ((org.telegram.ui.ActionBar.n2) boVar4).currentAccount;
                    hg.b2.f(i10).k(a2Var.f10217a, str);
                }
                boVar4.Q3 = str;
                boVar4.f32237a1.setTitle(str);
                return;
            case 5:
                MessageObject messageObject2 = (MessageObject) obj2;
                Long l10 = (Long) obj;
                bo boVar5 = ((nn) obj3).f36012a;
                if (boVar5.f7()) {
                    SendMessagesHelper.SendMessageParams of2 = SendMessagesHelper.SendMessageParams.of(messageObject2.getDiceEmoji(), boVar5.T5, boVar5.f32403n5, boVar5.X3, null, false, null, null, null, true, 0, 0, null, false);
            ...
            case 6:
                ...
                bo boVar6 = ((nn) obj3).f36012a;
                if (((Boolean) obj).booleanValue()) {
                    while (i13 < boVar6.f32524x0.getChildCount()) {
                        View childAt = boVar6.f32524x0.getChildAt(i13);
            ...
            case 8:
                ...
                ((nn) obj3).f36012a.getMessagesController().rejectSuggestedMessage(DialogObject.getPeerDialogId(message.peer_id), message.f18133id, (String) obj);
                return;
            case 9:
                fo foVar = (fo) obj3;
                foVar.f33626f.t(((dg.a) obj).f7722b, ((TLRPC.WallPaper) obj2).settings.intensity);
                View view = foVar.f33624b;
                if (view != null) {
                    view.invalidate();
                    return;
                }
            ...
            case 10:
                Long l11 = (Long) obj;
                ChatActivityEnterView chatActivityEnterView = ((org.telegram.ui.Components.nf) obj3).f26447a;
            ...
            case 11:
                ...
                ((bo) obj3).f32317g5 = (MessageSuggestionParams) obj;
                boolean G1 = viVar.G1(0, true, 0, viVar.s1(), viVar.N0);
                org.telegram.ui.Components.kf kfVar = viVar.f28756h0;
                if (kfVar != null) {
                    kfVar.h(!G1);
                    viVar.f28756h0 = null;
                    return;
            ...
            case 12:
                ...
                return;
            case 13:
                org.telegram.ui.Components.gl glVar = ((org.telegram.ui.Components.dl) obj3).f23356b;
                glVar.f24415x0.b(((org.telegram.ui.Components.fl) obj2).f24013c, glVar.f24417y0, true, 0, ((Long) obj).longValue());
            ...
            case 16:
                ...
                org.telegram.ui.Components.jy jyVar = iyVar.f25167a;
                ...
                if (!SharedConfig.suggestAnimatedEmoji && !UserConfig.getInstance(kzVar.f25703c1).isPremium()) {
                    z10 = false;
                } else {
                    z10 = true;
                }
            ...
            case 17:
                ...
                org.telegram.ui.Components.jy jyVar2 = ((org.telegram.ui.Components.iy) obj3).f25167a;
                if (ConnectionsManager.getInstance(jyVar2.F.f25703c1).getConnectionState() != 3) {
                    runnable.run();
                    return;
                } else {
            ...
            case 18:
                ...
                while (i13 < size) {
                    ...
                    if (stickerSetCovered instanceof TLRPC.TL_stickerSetFullCovered) {
                        ...
                        TLRPC.TL_messages_stickerSet stickerSet = MediaDataController.getInstance(dzVar.f23435w.Q.f25703c1).getStickerSet(MediaDataController.getInputStickerSet(stickerSetCovered.set), Integer.valueOf(stickerSetCovered.set.hash), true);
                        if (stickerSet != null) {
                    ...
                    if (arrayList != null && !arrayList.isEmpty()) {
                        dzVar.f23432n.add(new org.telegram.ui.Components.cy(stickerSetCovered, arrayList));
                    }
                }
                runnable2.run();
                return;
            case 19:
                ...
                if (c10Var.f22907a0 == null && !(c10Var.Z instanceof TL_chatlists.TL_chatlists_chatlistInviteAlready)) {
                    org.telegram.ui.Components.oc M = org.telegram.ui.Components.vc.a0(n2Var).M(AndroidUtilities.replaceTags(LocaleController.formatString(R.string.FolderLinkAddedTitle, c10Var.f22912f0)), LocaleController.formatPluralString("FolderLinkAddedSubtitle", arrayList4.size(), new Object[0]), R.raw.contact_check);
                    M.f26754j = 5000;
                    M.j();
                    return;
                }
                org.telegram.ui.Components.vc a02 = org.telegram.ui.Components.vc.a0(n2Var);
                int i14 = R.raw.folder_in;
                SpannableStringBuilder replaceTags = AndroidUtilities.replaceTags(LocaleController.formatString(R.string.FolderLinkUpdatedTitle, c10Var.f22912f0));
                if (arrayList4.size() <= 0) {
                    formatPluralString = LocaleController.formatPluralString("FolderLinkUpdatedSubtitle", c10Var.f22914h0.size(), new Object[0]);
                } else {
            ...
            case 27:
                ...
                r50Var.f37025c = bitmap2;
                Paint paint = new Paint(1);
                r50Var.d = paint;
                Bitmap bitmap3 = r50Var.f37025c;
            ...
            case 28:
                ...
                fc0Var.a();
                if (user != null) {
                    long j10 = userArr[0].f18259id;
                    Bundle bundle2 = new Bundle();
                    bundle2.putLong("user_id", user.f18259id);
            ...
            default:
                ...
                ArrayList arrayList5 = rj0Var.f37131f0;
                arrayList5.clear();
                if (list != null) {
                    for (TLRPC.User user2 : list) {
                        if (user2 != null && !hashSet.contains(Long.valueOf(user2.f18259id)) && rj0Var.R(user2)) {
                            arrayList5.add(user2);
                            hashSet.add(Long.valueOf(user2.f18259id));
                        }
                    }
                }
                Boolean bool2 = rj0Var.f37142r0;
                if (bool2 != null && bool2.booleanValue()) {
                    mj0 mj0Var = new mj0(0, rj0Var, hashSet);
                    MessagesController messagesController2 = MessagesController.getInstance(UserConfig.selectedAccount);
                    ConnectionsManager connectionsManager = ConnectionsManager.getInstance(UserConfig.selectedAccount);
                    if (str3 != null && !str3.isEmpty()) {
                        TLRPC.TL_contacts_search tL_contacts_search = new TLRPC.TL_contacts_search();
                        tL_contacts_search.f18158q = str3;
                        tL_contacts_search.limit = 50;
                        i13 = connectionsManager.sendRequest(tL_contacts_search, new bj1(3, messagesController2, mj0Var));
                    } else {
    ...
    public nf(org.telegram.ui.Components.vi viVar, bo boVar) {
        this.f35964a = 11;
        this.f35966c = viVar;
        this.f35965b = boVar;
    }
