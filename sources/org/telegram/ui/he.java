...
public final class he extends LinearLayout {
    public final LinearLayout f34200a;
    public final LinearLayout[] f34201b;
    public final org.telegram.ui.Components.y5[] f34202c;
    public final TextView[] d;
    public final TextView e;
    public final DecimalFormat f34203f;

    public he(Context context, org.telegram.ui.ActionBar.d6 d6Var) {
        super(context);
        this.f34201b = new LinearLayout[2];
        this.f34202c = new org.telegram.ui.Components.y5[2];
        this.d = new TextView[2];
        setOrientation(1);
        LinearLayout linearLayout = new LinearLayout(context);
        this.f34200a = linearLayout;
        linearLayout.setOrientation(1);
        addView(linearLayout, w7.y5.k(22.0f, 9.0f, 22.0f, 0.0f, -1, -2));
        for (int i10 = 0; i10 < 2; i10++) {
            this.f34201b[i10] = new LinearLayout(context);
            this.f34201b[i10].setOrientation(0);
            this.f34200a.addView(this.f34201b[i10], w7.y5.o(-1, -2, 1.0f, 119));
            this.f34202c[i10] = new org.telegram.ui.Components.y5(context);
            this.f34202c[i10].setTypeface(AndroidUtilities.bold());
            this.f34202c[i10].setTextSize(1, 16.0f);
            this.f34202c[i10].setTextColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.G6, d6Var));
            this.f34201b[i10].addView(this.f34202c[i10], w7.y5.t(-2, -2, 80, 0, 0, 5, 0));
            this.d[i10] = new org.telegram.ui.Components.y5(context);
            this.d[i10].setTextSize(1, 11.5f);
            this.d[i10].setTextColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19443y6, d6Var));
            this.f34201b[i10].addView(this.d[i10], w7.y5.q(-2, -2, 80));
        }
    ...
    public void set(ge geVar) {
        ...
        while (i11 < 2) {
            ...
            LinearLayout[] linearLayoutArr = this.f34201b;
            if (i11 == 0 && !geVar.f33908a) {
                ...
                TextView[] textViewArr = this.f34202c;
                if (equalsIgnoreCase) {
                    String format = this.f34203f.format(geVar.d / 1.0E9d);
