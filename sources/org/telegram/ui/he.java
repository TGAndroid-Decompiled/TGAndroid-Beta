...
public final class he extends LinearLayout {
    ...
    public final org.telegram.ui.Components.j81 f34248b;
    public final ge f34249c;
    public final long d;
    public final pd e;
    public String f34250f;
    public final ArrayList h;
    public final ArrayList f34251n;
    public String f34252r;
    public final boolean[] f34253s;
    public final le v;
    ...
    public he(le leVar, Context context, int i10, long j3, int i11, pd pdVar, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.f34252r = "";
        this.f34253s = new boolean[]{false, false};
        this.f34247a = i10;
        this.d = j3;
        this.e = pdVar;
        setOrientation(1);
    ...
    public final boolean a() {
        if (this.h.isEmpty() && this.f34251n.isEmpty()) {
            return false;
        }
        return true;
    }
    ...
    public final void c(final int i10) {
        ...
        if (!zArr[i10]) {
            ...
            if (i10 == 1) {
                                            ...
                                            switch (r7) {
                                                case 0:
                                                    ...
                                                    if (z12) {
                                                        ...
                                                        heVar2.f34251n.addAll(starsStatus.history);
                                                        heVar2.f34252r = starsStatus.next_offset;
                                                        heVar2.f34253s[i15] = false;
                                                        heVar2.d();
                                                    } else {
                                                ...
                                                default:
                                                    ...
                                                    if (z13) {
                                                        ...
                                                        heVar3.f34250f = starsStatus2.next_offset;
                                                        heVar3.f34253s[i17] = false;
                                                        heVar3.d();
                                                    } else {
                                            ...
                                            switch (r7) {
                                                case 0:
                                                    ...
                                                    if (z122) {
                                                        ...
                                                        heVar22.f34251n.addAll(starsStatus.history);
                                                        heVar22.f34252r = starsStatus.next_offset;
                                                        heVar22.f34253s[i15] = false;
                                                        heVar22.d();
                                                    } else {
                                                        TLRPC.TL_error tL_error2 = tL_error;
                                                        if (tL_error2 != null) {
            ...
            } else if (i10 == 0 && this.f34252r != null && leVar.f35515g1) {
                zArr[i10] = true;
                ...
                tL_payments_getStarsTransactions2.offset = this.f34252r;
                if (this.f34251n.isEmpty()) {
                    i11 = 5;
                }
    ...
    public final void d() {
        int i10 = 0;
        while (true) {
            org.telegram.ui.Components.j81 j81Var = this.f34248b;
            if (i10 < j81Var.getViewPages().length) {
                View view = j81Var.getViewPages()[i10];
                if (view instanceof fe) {
                    fe feVar = (fe) view;
                    org.telegram.ui.Components.f61 f61Var = feVar.f33624a;
                    f61Var.Y2.N(true);
    ...
    public final void e() {
        ...
        int[] iArr = j81Var.f25184f;
        if (iArr[0] != j81Var.L.h(j81Var.f25182b)) {
            j81Var.J(0);
            View view = viewArr[1];
            if (view != null) {
    ...
    public org.telegram.ui.Components.ml0 getCurrentListView() {
        View currentView = this.f34248b.getCurrentView();
        if (!(currentView instanceof fe)) {
            return null;
        }
        return ((fe) currentView).f33624a;
    }
}
