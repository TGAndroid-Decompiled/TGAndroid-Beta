...
public final class he extends LinearLayout {
    ...
    public final org.telegram.ui.Components.y5[] f33826c;
    public final TextView[] d;
    public final TextView e;
    public final DecimalFormat f33827f;

    public he(Context context, org.telegram.ui.ActionBar.d6 d6Var) {
        super(context);
        this.f33825b = new LinearLayout[2];
        this.f33826c = new org.telegram.ui.Components.y5[2];
        ...
        for (int i10 = 0; i10 < 2; i10++) {
            this.f33825b[i10] = new LinearLayout(context);
            this.f33825b[i10].setOrientation(0);
            this.f33824a.addView(this.f33825b[i10], w7.x5.o(-1, -2, 1.0f, 119));
            this.f33826c[i10] = new org.telegram.ui.Components.y5(context);
            this.f33826c[i10].setTypeface(AndroidUtilities.bold());
            this.f33826c[i10].setTextSize(1, 16.0f);
            this.f33826c[i10].setTextColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.G6, d6Var));
            this.f33825b[i10].addView(this.f33826c[i10], w7.x5.t(-2, -2, 80, 0, 0, 5, 0));
            this.d[i10] = new org.telegram.ui.Components.y5(context);
            this.d[i10].setTextSize(1, 11.5f);
            this.d[i10].setTextColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19170y6, d6Var));
            this.f33825b[i10].addView(this.d[i10], w7.x5.q(-2, -2, 80));
        }
    ...
    public void set(ge geVar) {
        ...
        while (i11 < 2) {
            ...
            LinearLayout[] linearLayoutArr = this.f33825b;
            if (i11 == 0 && !geVar.f33532a) {
                linearLayoutArr[i11].setVisibility(8);
            } else if (i11 == 1 && !geVar.f33536g) {
                linearLayoutArr[i11].setVisibility(8);
            } else {
                ...
                TextView[] textViewArr = this.f33826c;
                if (equalsIgnoreCase) {
                    String format = this.f33827f.format(geVar.d / 1.0E9d);
                    ...
                    if ("XTR".equalsIgnoreCase(str)) {
                        if (i10 == 0) {
                            ...
                            spannableStringBuilder2.append((CharSequence) yh.w7.J0(geVar.f33537i, 0.8f, ' '));
                        }
                ...
                textView.setText("≈" + BillingController.getInstance().formatCurrency(j3, geVar.f33535f));
                i11 = i10 + 1;
            }
            i10 = i11;
            i11 = i10 + 1;
