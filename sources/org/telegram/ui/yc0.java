...
public final class yc0 extends gg.t0 {
    ...
    public yc0(kd0 kd0Var, Context context, int i10, long j3, org.telegram.ui.ActionBar.f6 f6Var, boolean z10, boolean z11) {
        ...
        this.f39853n0 = kd0Var;
        this.m0 = true;
    }

    @Override
    public final void K() {
        this.f39853n0.r0(null);
    }

    @Override
    public final void N(ArrayList arrayList) {
        int i10;
        kd0 kd0Var = this.f39853n0;
        ...
        if (messageObject != null && messageObject.isLiveLocation()) {
            ...
            if (arrayList != null) {
                ...
                for (int i12 = 0; i12 < arrayList.size(); i12++) {
                    ...
                    if (ed0Var != null && !UserObject.isUserSelf(ed0Var.f33368c)) {
                        i10++;
                    }
                }
            } else {
            ...
            if (this.m0 && i10 == 1) {
                kd0Var.f35226i0 = ((ed0) arrayList.get(0)).f33366a;
            }
            this.m0 = false;
