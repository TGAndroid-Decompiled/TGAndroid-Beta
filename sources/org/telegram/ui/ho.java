...
public final class ho implements View.OnClickListener {
    ...
    public final void onClick(View view) {
        switch (this.f34335a) {
            case 0:
                final wo woVar = (wo) this.f34337c;
                ...
                if (!zArr[0]) {
                    ...
                    boostsController.getBoostsStats(j3, new e2.h() {
                        ...
                        public final void accept(Object obj) {
                            ...
                            wo woVar2 = wo.this;
                            TLRPC.Chat chat = woVar2.f39296x0;
                            int i11 = chat.level;
                            int i12 = tL_premium_boostsStatus.level;
                            if (i11 != i12) {
                                chat.level = i12;
                                woVar2.getMessagesController().putChat(woVar2.f39296x0, false);
                            }
                            ...
                            tL_channels_toggleAutotranslation.channel = MessagesController.getInputChannel(woVar2.f39296x0);
                ...
                return;
            case 1:
                ((org.telegram.ui.ActionBar.b2[]) this.f34337c)[0].dismiss();
                ((org.telegram.ui.Components.bs) this.d).run(-this.f34336b);
                return;
            case 2:
                ((org.telegram.ui.ActionBar.b2[]) this.f34337c)[0].dismiss();
                ((org.telegram.ui.Components.bs) this.d).run(-this.f34336b);
                return;
            case 3:
                org.telegram.ui.Components.b70.N((org.telegram.ui.Components.b70) this.f34337c, (Context) this.d, this.f34336b);
                return;
            case 4:
                uy uyVar = (uy) this.f34337c;
            ...
            case 5:
                ...
                if (l4 != null && longValue == l4.longValue()) {
                    ...
                    wo0Var.f39315f[0].setText(LocaleController.getInstance().formatCurrencyString(this.f34336b, false, true, true, wo0Var.C0.invoice.currency));
                }
                EditTextBoldCursor editTextBoldCursor = wo0Var.f39315f[0];
                editTextBoldCursor.setSelection(editTextBoldCursor.length());
                return;
            default:
                yh.z3.Y0((yh.z3) this.f34337c, (String) this.d, this.f34336b);
                return;
        }
    }
}
