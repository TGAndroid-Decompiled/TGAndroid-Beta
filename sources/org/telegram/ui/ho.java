    ...
    public final void onClick(View view) {
        switch (this.f34319a) {
            case 0:
                ...
                if (!zArr[0]) {
                    ...
                    boostsController.getBoostsStats(j3, new e2.h() {
                        ...
                        public final void accept(Object obj) {
                            ...
                            wo woVar2 = wo.this;
                            TLRPC.Chat chat = woVar2.f39118x0;
                            int i11 = chat.level;
                            int i12 = tL_premium_boostsStatus.level;
                            if (i11 != i12) {
                                chat.level = i12;
                                woVar2.getMessagesController().putChat(woVar2.f39118x0, false);
                            }
                            ...
                            tL_channels_toggleAutotranslation.channel = MessagesController.getInputChannel(woVar2.f39118x0);
                ...
                return;
            case 1:
                ((org.telegram.ui.ActionBar.c2[]) this.f34321c)[0].dismiss();
            ...
            case 5:
                ...
                if (l4 != null && longValue == l4.longValue()) {
                    ...
                    yo0Var.f39962f[0].setText(LocaleController.getInstance().formatCurrencyString(this.f34320b, false, true, true, yo0Var.C0.invoice.currency));
                }
