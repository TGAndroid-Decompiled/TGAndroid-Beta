...
public final class zf0 extends org.telegram.ui.Components.tv0 implements NotificationCenter.NotificationCenterDelegate {
    public static final int f43423t0 = 0;
    ...
    public int V;
    public int W;
    public final org.telegram.ui.Components.xi0 f43424a;
    public double f43425a0;
    public String f43426b;
    public double f43427b0;
    public String f43428c;
    public boolean f43429c0;
    public String d;
    public boolean f43430d0;
    public String f43431e;
    public String f43432e0;
    public final es f43433f;
    public final int f43434f0;
    public int f43435g0;
    public final org.telegram.ui.Components.voip.l2 h;
    public int f43436h0;
    public boolean f43437i0;
    public String f43438j0;
    public String f43439k0;
    public String f43440l0;
    public int m0;
    public final TextView f43441n;
    public String f43442n0;
    public Bundle f43443o0;
    public TLRPC.TL_auth_sentCode f43444p0;
    public boolean f43445q0;
    public final TextView f43446r;
    public final mf0 f43447r0;
    public final org.telegram.ui.Components.aj0 f43448s;
    public final wg0 f43449s0;
    public final xf0 v;
    public final fe0 f43450w;
    public final xf0 f43451x;
    public final FrameLayout f43452y;
    ...
    public static void o(zf0 zf0Var, Context context) {
        ...
        try {
            ...
            sb2.append(zf0Var.f43431e);
            sb2.append(" Android Registration/Login Issue ");
            sb2.append(str4);
            if (zf0Var.f43449s0.f42394e) {
                str = " #paidauth";
            } else {
                str = "";
            }
            ...
            sb3.append(str3);
            sb3.append("\n");
            if (!TextUtils.isEmpty(zf0Var.f43432e0)) {
                sb3.append("Error: ");
                sb3.append(zf0Var.f43432e0);
                sb3.append("\n");
            }
            sb3.append("\n\n================================================\n");
            ...
            zf0Var.f43449s0.l1(LocaleController.getString(R.string.AppName), LocaleController.getString("NoMailInstalled", R.string.NoMailInstalled));
        }
    }
    ...
    public final void A(int i10) {
        ...
        if (xi0Var != null) {
            ...
            this.Q = true;
            org.telegram.ui.Components.xi0 xi0Var2 = this.f43424a;
            if (xi0Var2.f32581b0 != xi0Var2.f32585e[0] - 1) {
                xi0Var2.f32605u0 = new sf0(this, i10, 0);
                return;
            }
            xi0Var.f32605u0 = new mf0(this, 3);
            org.telegram.ui.Components.aj0 aj0Var = this.f43448s;
    ...
    public final boolean c(boolean z10) {
        int i10;
        wg0 wg0Var = this.f43449s0;
        if (wg0Var.F != 0) {
            wg0Var.finishFragment();
            return false;
        }
        int i11 = this.f43436h0;
        if (i11 != 0) {
            ...
            b2Var.R = string;
            b2Var.T = AndroidUtilities.replaceTags(LocaleController.formatString("EditNumberInfo", R.string.EditNumberInfo, this.f43426b));
            ...
            tL_auth_cancelCode.phone_code_hash = this.f43428c;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (this.f43429c0) {
            es esVar = this.f43433f;
            if (esVar.f36191f != null) {
                if (i10 == NotificationCenter.didReceiveSmsCode) {
                    esVar.setText("" + objArr[0]);
                    h(null);
                } else if (i10 == NotificationCenter.didReceiveCall) {
                    String str = "" + objArr[0];
                    if (AndroidUtilities.checkPhonePattern(this.f43438j0, str)) {
                        if (!this.f43438j0.equals("*")) {
                            this.f43440l0 = str;
    ...
    public final void g() {
        ...
        this.f43437i0 = false;
        this.f43430d0 = false;
        if (this.f43436h0 != 0 && (bundle = this.H) != null) {
    ...
    public final void h(String str) {
        ...
        int i12;
        wg0 wg0Var = this.f43449s0;
        int i13 = wg0Var.f42387a;
        if (i13 == 11) {
            if (this.f43430d0) {
                return;
            }
        } else if (!this.f43430d0) {
        ...
        int i15 = wg0Var.f42387a;
        if (i15 < 1 || i15 > 4 || !esVar.f36190e) {
            this.f43430d0 = true;
            int i16 = this.f43434f0;
            if (i16 == 15) {
                NotificationCenter.getGlobalInstance().removeObserver(this, NotificationCenter.didReceiveSmsCode);
            } else if (i16 == 2) {
                AndroidUtilities.setWaitingForSms(false);
            ...
            if (i17 != 1) {
                if (i17 != 2) {
                    ...
                    tL_auth_signIn.phone_code_hash = this.f43428c;
                ...
                changephone.phone_code_hash = this.f43428c;
                w();
                esVar.f36190e = true;
            ...
            confirmphone.phone_code_hash = this.f43428c;
            w();
            esVar.f36190e = true;
            gs[] gsVarArr3 = esVar.f36191f;
    ...
    @Override
    public final void j() {
        org.telegram.ui.Components.xi0 xi0Var = this.f43424a;
        if (xi0Var != null) {
            xi0Var.K(0);
        }
        AndroidUtilities.runOnUIThread(new mf0(this, 0), wg0.f42386t0);
    }
    ...
    public final void l(Bundle bundle) {
        String code = this.f43433f.getCode();
        int length = code.length();
        int i10 = this.f43434f0;
        if (length != 0) {
            bundle.putString("smsview_code_" + i10, code);
        }
        String str = this.f43440l0;
        if (str != null) {
    ...
    public final void n() {
        ...
        if (i12 == 11) {
            ...
            int w03 = org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20837l6, false);
        ...
        if (i12 != 15) {
            this.f43451x.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.q6, false));
        }
        this.E.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20926q7, false));
    }
    ...
    public final void onConfigurationChanged(Configuration configuration) {
        ...
        es esVar = this.f43433f;
        if (esVar != null && (gsVarArr = esVar.f36191f) != null) {
    ...
    public final void s() {
        ...
        this.S = new Timer();
        this.f43427b0 = System.currentTimeMillis();
    ...
    public final void x() {
        int i10;
        if (!this.f43430d0 && !this.f43437i0) {
            wg0 wg0Var = this.f43449s0;
            if (!wg0Var.f42406o0) {
                this.f43437i0 = true;
                this.v.invalidate();
                this.f43451x.invalidate();
                Bundle bundle = new Bundle();
                bundle.putString("phone", this.f43426b);
                bundle.putString("ephone", this.f43431e);
                bundle.putString("phoneFormated", this.d);
                bundle.putInt("prevType", this.f43434f0);
                this.f43430d0 = true;
                TLRPC.TL_auth_resendCode tL_auth_resendCode = new TLRPC.TL_auth_resendCode();
                tL_auth_resendCode.phone_number = this.d;
                tL_auth_resendCode.phone_code_hash = this.f43428c;
                i10 = ((org.telegram.ui.ActionBar.n2) wg0Var).currentAccount;
    ...
    public final void y() {
        ...
        while (true) {
            ...
            esVar.f36191f[i10].i(1.0f);
            i10++;
        }
        fe0 fe0Var = this.f43450w;
        if (fe0Var.getCurrentView() != this.E) {
            fe0Var.showNext();
        }
        esVar.f36191f[0].requestFocus();
        if (this.f43434f0 == 11) {
            f7 = 3.5f;
        } else {
            f7 = 10.0f;
    ...
    public final void z(boolean z10) {
        if (this.N != null) {
            ...
            this.Q = false;
            this.f43448s.setAutoRepeat(false);
            org.telegram.ui.Components.xi0 xi0Var = this.O;
            xi0Var.I(0);
            xi0Var.P(xi0Var.f32585e[0] - 1, new mf0(this, 1));
            return;
        }
        this.f43449s0.k1(z10, true);
    }
}
