...
public final class zf0 extends org.telegram.ui.Components.fw0 {
    public final ImageView f40444a;
    public final ci.d f40445b;
    public final yh.r[] f40446c;
    public Bundle d;
    public String e;
    ...
    public zf0(qg0 qg0Var, Context context) {
        ...
        canvas.drawColor(i0.a.d(0.5f, org.telegram.ui.ActionBar.h6.w0(null, i11, false), org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19115h5, false)));
        yf0Var.setBackgroundBitmap(createBitmap);
        sg.a aVar = yf0Var.f43211b;
        aVar.f43199w = i11;
        aVar.f43200x = org.telegram.ui.ActionBar.h6.Lj;
        aVar.b();
    ...
    public static void o(zf0 zf0Var, String str, String str2, String str3) {
        String str4;
        ...
        try {
            ...
            if (Build.VERSION.SDK_INT >= 29) {
                try {
                    ConnectivityManager connectivityManager = (ConnectivityManager) zf0Var.getContext().getSystemService(ConnectivityManager.class);
                    SignalStrength signalStrength = ((TelephonyManager) zf0Var.getContext().getSystemService(TelephonyManager.class)).getSignalStrength();
    ...
    public final void g() {
        ...
        if (this.f40450s >= 0) {
            ...
            ConnectionsManager.getInstance(i10).cancelRequest(this.f40450s, true);
            this.f40450s = -1;
        }
        this.f40447f = false;
        this.f40445b.setLoading(false);
    }
    ...
    public final void m(Bundle bundle, boolean z10) {
        ...
        yh.r[] rVarArr = this.f40446c;
        if (isEmpty) {
            rVarArr[0].f47925c.setText(LocaleController.getString(R.string.SMSFee1Text));
        } else {
            rVarArr[0].f47925c.setText(LocaleController.formatString(R.string.SMSFee1TextCountry, countryName));
        }
        yh.r rVar = rVarArr[2];
        if (i10 == 7) {
        ...
        this.f40444a.setOnClickListener(new ai.o5(this, string5, string6, string3, 14));
        ci.d dVar = this.f40445b;
    ...
    public final void p() {
        ...
        tL_checkPaidAuth.form_id = this.f40449r;
        tL_checkPaidAuth.phone_number = this.h;
        tL_checkPaidAuth.phone_code_hash = this.f40448n;
        i10 = ((org.telegram.ui.ActionBar.m2) this.v).currentAccount;
        this.f40450s = ConnectionsManager.getInstance(i10).sendRequest(tL_checkPaidAuth, new m(this, 14), 1096);
    }
}
