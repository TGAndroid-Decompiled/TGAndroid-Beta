...
public final class zf0 extends org.telegram.ui.Components.uv0 implements NotificationCenter.NotificationCenterDelegate {
    public static final int f40160t0 = 0;
    ...
    public int V;
    public int W;
    public final org.telegram.ui.Components.xi0 f40161a;
    public double f40162a0;
    public String f40163b;
    public double f40164b0;
    public String f40165c;
    public boolean f40166c0;
    public String d;
    public boolean f40167d0;
    public String e;
    public String f40168e0;
    public final ds f40169f;
    public final int f40170f0;
    public int f40171g0;
    public final org.telegram.ui.Components.voip.n2 h;
    public int f40172h0;
    public boolean f40173i0;
    public String f40174j0;
    public String f40175k0;
    public String f40176l0;
    public int m0;
    public final TextView f40177n;
    public String f40178n0;
    public Bundle f40179o0;
    public TLRPC.TL_auth_sentCode f40180p0;
    public boolean f40181q0;
    public final TextView f40182r;
    public final mf0 f40183r0;
    public final org.telegram.ui.Components.aj0 f40184s;
    public final wg0 f40185s0;
    public final xf0 v;
    public final fe0 f40186w;
    public final xf0 f40187x;
    public final FrameLayout f40188y;
    ...
    public static void o(zf0 zf0Var, Context context) {
        ...
        try {
            ...
            sb3.append(str3);
            sb3.append("\n");
            if (!TextUtils.isEmpty(zf0Var.f40168e0)) {
                sb3.append("Error: ");
                sb3.append(zf0Var.f40168e0);
                sb3.append("\n");
            }
            sb3.append("\n\n================================================\n");
            ...
            zf0Var.f40185s0.l1(LocaleController.getString(R.string.AppName), LocaleController.getString("NoMailInstalled", R.string.NoMailInstalled));
        }
    }
    ...
    public final void A(int i10) {
        ...
        if (xi0Var != null) {
            ...
            this.Q = true;
            org.telegram.ui.Components.xi0 xi0Var2 = this.f40161a;
            if (xi0Var2.f29948b0 != xi0Var2.e[0] - 1) {
                xi0Var2.f29971u0 = new sf0(this, i10, 0);
                return;
            }
            xi0Var.f29971u0 = new mf0(this, 3);
            org.telegram.ui.Components.aj0 aj0Var = this.f40184s;
    ...
    public final boolean c(boolean z10) {
        int i10;
        wg0 wg0Var = this.f40185s0;
        if (wg0Var.F != 0) {
            wg0Var.finishFragment();
            return false;
        }
        int i11 = this.f40172h0;
        if (i11 != 0) {
            ...
            b2Var.R = string;
            b2Var.T = AndroidUtilities.replaceTags(LocaleController.formatString("EditNumberInfo", R.string.EditNumberInfo, this.f40163b));
            ...
            tL_auth_cancelCode.phone_code_hash = this.f40165c;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (this.f40166c0) {
            ds dsVar = this.f40169f;
            if (dsVar.f33120f != null) {
                if (i10 == NotificationCenter.didReceiveSmsCode) {
                    dsVar.setText("" + objArr[0]);
                    h(null);
                } else if (i10 == NotificationCenter.didReceiveCall) {
                    String str = "" + objArr[0];
                    if (AndroidUtilities.checkPhonePattern(this.f40174j0, str)) {
                        if (!this.f40174j0.equals("*")) {
                            this.f40176l0 = str;
    ...
    public final void g() {
        ...
        this.f40173i0 = false;
        this.f40167d0 = false;
        if (this.f40172h0 != 0 && (bundle = this.H) != null) {
    ...
    public final void h(String str) {
        ...
        int i12;
        wg0 wg0Var = this.f40185s0;
        int i13 = wg0Var.f39193a;
        if (i13 == 11) {
            if (this.f40167d0) {
                return;
            }
        } else if (!this.f40167d0) {
        ...
        int i15 = wg0Var.f39193a;
        if (i15 < 1 || i15 > 4 || !dsVar.e) {
            this.f40167d0 = true;
            int i16 = this.f40170f0;
            if (i16 == 15) {
                NotificationCenter.getGlobalInstance().removeObserver(this, NotificationCenter.didReceiveSmsCode);
            } else if (i16 == 2) {
                AndroidUtilities.setWaitingForSms(false);
            ...
            if (i17 != 1) {
                if (i17 != 2) {
                    ...
                    tL_auth_signIn.phone_code_hash = this.f40165c;
                ...
                changephone.phone_code_hash = this.f40165c;
                w();
                dsVar.e = true;
            ...
            confirmphone.phone_code_hash = this.f40165c;
            w();
            dsVar.e = true;
            gs[] gsVarArr3 = dsVar.f33120f;
    ...
    @Override
    public final void j() {
        org.telegram.ui.Components.xi0 xi0Var = this.f40161a;
        if (xi0Var != null) {
            xi0Var.M(0);
        }
        AndroidUtilities.runOnUIThread(new mf0(this, 0), wg0.f39192t0);
    }
    ...
    public final void l(Bundle bundle) {
        String code = this.f40169f.getCode();
        int length = code.length();
        int i10 = this.f40170f0;
        if (length != 0) {
            bundle.putString("smsview_code_" + i10, code);
        }
        String str = this.f40176l0;
        if (str != null) {
    ...
    public final void n() {
        ...
        if (i12 == 11) {
            ...
            int w03 = org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18982l6, false);
        ...
        if (i12 != 15) {
            this.f40187x.setTextColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.q6, false));
        }
        this.E.setTextColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f19074q7, false));
    }
    ...
    public final void onConfigurationChanged(Configuration configuration) {
        ...
        ds dsVar = this.f40169f;
        if (dsVar != null && (gsVarArr = dsVar.f33120f) != null) {
    ...
    public final void s() {
        ...
        this.S = new Timer();
        this.f40164b0 = System.currentTimeMillis();
    ...
    public final void x() {
        int i10;
        if (!this.f40167d0 && !this.f40173i0) {
            wg0 wg0Var = this.f40185s0;
            if (!wg0Var.f39211o0) {
                this.f40173i0 = true;
                this.v.invalidate();
                this.f40187x.invalidate();
                Bundle bundle = new Bundle();
                bundle.putString("phone", this.f40163b);
                bundle.putString("ephone", this.e);
                bundle.putString("phoneFormated", this.d);
                bundle.putInt("prevType", this.f40170f0);
                this.f40167d0 = true;
                TLRPC.TL_auth_resendCode tL_auth_resendCode = new TLRPC.TL_auth_resendCode();
                tL_auth_resendCode.phone_number = this.d;
                tL_auth_resendCode.phone_code_hash = this.f40165c;
                i10 = ((org.telegram.ui.ActionBar.n2) wg0Var).currentAccount;
    ...
    public final void y() {
        ...
        while (true) {
            ...
            dsVar.f33120f[i10].i(1.0f);
            i10++;
        }
        fe0 fe0Var = this.f40186w;
        if (fe0Var.getCurrentView() != this.E) {
            fe0Var.showNext();
        }
        dsVar.f33120f[0].requestFocus();
        if (this.f40170f0 == 11) {
            f7 = 3.5f;
        } else {
            f7 = 10.0f;
    ...
    public final void z(boolean z10) {
        if (this.N != null) {
            ...
            this.Q = false;
            this.f40184s.setAutoRepeat(false);
            org.telegram.ui.Components.xi0 xi0Var = this.O;
            xi0Var.K(0);
            xi0Var.R(xi0Var.e[0] - 1, new mf0(this, 1));
            return;
        }
        this.f40185s0.k1(z10, true);
    }
}
