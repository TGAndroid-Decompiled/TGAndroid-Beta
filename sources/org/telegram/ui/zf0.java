...
public final class zf0 extends org.telegram.ui.Components.tv0 implements NotificationCenter.NotificationCenterDelegate {
    public static final int f43396t0 = 0;
    ...
    public int V;
    public int W;
    public final org.telegram.ui.Components.xi0 f43397a;
    public double f43398a0;
    public String f43399b;
    public double f43400b0;
    public String f43401c;
    public boolean f43402c0;
    public String d;
    public boolean f43403d0;
    public String f43404e;
    public String f43405e0;
    public final es f43406f;
    public final int f43407f0;
    public int f43408g0;
    public final org.telegram.ui.Components.voip.l2 h;
    public int f43409h0;
    public boolean f43410i0;
    public String f43411j0;
    public String f43412k0;
    public String f43413l0;
    public int m0;
    public final TextView f43414n;
    public String f43415n0;
    public Bundle f43416o0;
    public TLRPC.TL_auth_sentCode f43417p0;
    public boolean f43418q0;
    public final TextView f43419r;
    public final mf0 f43420r0;
    public final org.telegram.ui.Components.aj0 f43421s;
    public final wg0 f43422s0;
    public final xf0 v;
    public final fe0 f43423w;
    public final xf0 f43424x;
    public final FrameLayout f43425y;
    ...
    public static void o(zf0 zf0Var, Context context) {
        ...
        try {
            ...
            sb2.append(zf0Var.f43404e);
            sb2.append(" Android Registration/Login Issue ");
            sb2.append(str4);
            if (zf0Var.f43422s0.f42367e) {
                str = " #paidauth";
            } else {
                str = "";
            }
            ...
            sb3.append(str3);
            sb3.append("\n");
            if (!TextUtils.isEmpty(zf0Var.f43405e0)) {
                sb3.append("Error: ");
                sb3.append(zf0Var.f43405e0);
                sb3.append("\n");
            }
            sb3.append("\n\n================================================\n");
            ...
            zf0Var.f43422s0.l1(LocaleController.getString(R.string.AppName), LocaleController.getString("NoMailInstalled", R.string.NoMailInstalled));
        }
    }
    ...
    public final void A(int i10) {
        ...
        if (xi0Var != null) {
            ...
            this.Q = true;
            org.telegram.ui.Components.xi0 xi0Var2 = this.f43397a;
            if (xi0Var2.f32554b0 != xi0Var2.f32558e[0] - 1) {
                xi0Var2.f32578u0 = new sf0(this, i10, 0);
                return;
            }
            xi0Var.f32578u0 = new mf0(this, 3);
            org.telegram.ui.Components.aj0 aj0Var = this.f43421s;
    ...
    public final boolean c(boolean z10) {
        int i10;
        wg0 wg0Var = this.f43422s0;
        if (wg0Var.F != 0) {
            wg0Var.finishFragment();
            return false;
        }
        int i11 = this.f43409h0;
        if (i11 != 0) {
            ...
            b2Var.R = string;
            b2Var.T = AndroidUtilities.replaceTags(LocaleController.formatString("EditNumberInfo", R.string.EditNumberInfo, this.f43399b));
            ...
            tL_auth_cancelCode.phone_code_hash = this.f43401c;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (this.f43402c0) {
            es esVar = this.f43406f;
            if (esVar.f36164f != null) {
                if (i10 == NotificationCenter.didReceiveSmsCode) {
                    esVar.setText("" + objArr[0]);
                    h(null);
                } else if (i10 == NotificationCenter.didReceiveCall) {
                    String str = "" + objArr[0];
                    if (AndroidUtilities.checkPhonePattern(this.f43411j0, str)) {
                        if (!this.f43411j0.equals("*")) {
                            this.f43413l0 = str;
    ...
    public final void g() {
        ...
        this.f43410i0 = false;
        this.f43403d0 = false;
        if (this.f43409h0 != 0 && (bundle = this.H) != null) {
    ...
    public final void h(String str) {
        ...
        int i12;
        wg0 wg0Var = this.f43422s0;
        int i13 = wg0Var.f42360a;
        if (i13 == 11) {
            if (this.f43403d0) {
                return;
            }
        } else if (!this.f43403d0) {
        ...
        int i15 = wg0Var.f42360a;
        if (i15 < 1 || i15 > 4 || !esVar.f36163e) {
            this.f43403d0 = true;
            int i16 = this.f43407f0;
            if (i16 == 15) {
                NotificationCenter.getGlobalInstance().removeObserver(this, NotificationCenter.didReceiveSmsCode);
            } else if (i16 == 2) {
                AndroidUtilities.setWaitingForSms(false);
            ...
            if (i17 != 1) {
                if (i17 != 2) {
                    ...
                    tL_auth_signIn.phone_code_hash = this.f43401c;
                ...
                changephone.phone_code_hash = this.f43401c;
                w();
                esVar.f36163e = true;
            ...
            confirmphone.phone_code_hash = this.f43401c;
            w();
            esVar.f36163e = true;
            gs[] gsVarArr3 = esVar.f36164f;
    ...
    @Override
    public final void j() {
        org.telegram.ui.Components.xi0 xi0Var = this.f43397a;
        if (xi0Var != null) {
            xi0Var.K(0);
        }
        AndroidUtilities.runOnUIThread(new mf0(this, 0), wg0.f42359t0);
    }
    ...
    public final void l(Bundle bundle) {
        String code = this.f43406f.getCode();
        int length = code.length();
        int i10 = this.f43407f0;
        if (length != 0) {
            bundle.putString("smsview_code_" + i10, code);
        }
        String str = this.f43413l0;
        if (str != null) {
    ...
    public final void n() {
        ...
        if (i12 == 11) {
            ...
            int w03 = org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20810l6, false);
        ...
        if (i12 != 15) {
            this.f43424x.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.q6, false));
        }
        this.E.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20899q7, false));
    }
    ...
    public final void onConfigurationChanged(Configuration configuration) {
        ...
        es esVar = this.f43406f;
        if (esVar != null && (gsVarArr = esVar.f36164f) != null) {
    ...
    public final void s() {
        ...
        this.S = new Timer();
        this.f43400b0 = System.currentTimeMillis();
    ...
    public final void x() {
        int i10;
        if (!this.f43403d0 && !this.f43410i0) {
            wg0 wg0Var = this.f43422s0;
            if (!wg0Var.f42379o0) {
                this.f43410i0 = true;
                this.v.invalidate();
                this.f43424x.invalidate();
                Bundle bundle = new Bundle();
                bundle.putString("phone", this.f43399b);
                bundle.putString("ephone", this.f43404e);
                bundle.putString("phoneFormated", this.d);
                bundle.putInt("prevType", this.f43407f0);
                this.f43403d0 = true;
                TLRPC.TL_auth_resendCode tL_auth_resendCode = new TLRPC.TL_auth_resendCode();
                tL_auth_resendCode.phone_number = this.d;
                tL_auth_resendCode.phone_code_hash = this.f43401c;
                i10 = ((org.telegram.ui.ActionBar.n2) wg0Var).currentAccount;
    ...
    public final void y() {
        ...
        while (true) {
            ...
            esVar.f36164f[i10].i(1.0f);
            i10++;
        }
        fe0 fe0Var = this.f43423w;
        if (fe0Var.getCurrentView() != this.E) {
            fe0Var.showNext();
        }
        esVar.f36164f[0].requestFocus();
        if (this.f43407f0 == 11) {
            f7 = 3.5f;
        } else {
            f7 = 10.0f;
    ...
    public final void z(boolean z10) {
        if (this.N != null) {
            ...
            this.Q = false;
            this.f43421s.setAutoRepeat(false);
            org.telegram.ui.Components.xi0 xi0Var = this.O;
            xi0Var.I(0);
            xi0Var.P(xi0Var.f32558e[0] - 1, new mf0(this, 1));
            return;
        }
        this.f43422s0.k1(z10, true);
    }
}
