...
public final class ze1 extends org.telegram.ui.ActionBar.n2 {
    ...
    public boolean f40102r;
    public org.telegram.ui.Components.pq f40103s;
    public org.telegram.ui.Components.bm0 v;
    public TLRPC.TL_forumTopic f40104w;
    public ng.a f40105x;
    public zn f40106y;
    ...
    public final void b0(Long l4, boolean z10) {
        ...
        if (this.f40100f != null && this.v != null) {
            if (l4 == null) {
                longValue = 0;
            } else {
                longValue = l4.longValue();
            }
            this.f40100f.setSelected(Long.valueOf(longValue));
            if (this.f40098b != longValue) {
                ...
                if (longValue != 0) {
                    ...
                    u80Var.a(this.f40101n);
                    this.v.b(u80Var, false);
                    w9VarArr[1].setImageDrawable(this.f40103s);
    ...
    public final View createView(Context context) {
        ...
        TLRPC.TL_forumTopic tL_forumTopic = this.f40104w;
        ...
        frameLayout2.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view) {
                int i11 = r2;
                ze1 ze1Var = this.f37708b;
                switch (i11) {
                    case 0:
                        if (ze1Var.f40098b == 0 && ze1Var.f40104w == null) {
                            ng.a aVar = ze1Var.f40105x;
                            int i12 = aVar.e + 1;
                            aVar.e = i12;
                            int[] iArr = ng.a.f15401k;
                            if (i12 > 5) {
                                aVar.e = 0;
                            }
                            int[] iArr2 = aVar.h;
                            int i13 = iArr[aVar.e];
                            aVar.f15408i = i13;
                            aVar.h = (int[]) ng.a.f15402l.get(i13);
        ...
        TLRPC.TL_forumTopic tL_forumTopic2 = this.f40104w;
        if (tL_forumTopic2 != null && tL_forumTopic2.f18348id == 1) {
            ...
            this.d.d(LocaleController.getString(R.string.EditTopicHide), !this.f40104w.hidden, false, false);
            this.d.setBackground(org.telegram.ui.ActionBar.j6.Z(getThemedColor(i12), getThemedColor(org.telegram.ui.ActionBar.j6.f19152i6), 16, 16));
            ...
            this.f40100f.setClipChildren(false);
            frameLayout3.addView(this.f40100f, w7.y5.d(-1, -1.0f, 0, 12.0f, 12.0f, 12.0f, 12.0f));
            org.telegram.ui.Components.pq d = ng.d.d(this.E, "");
            this.f40105x = (ng.a) d.f27296a;
            ...
            ArrayList arrayList2 = bm0Var2.f23044n;
            if (!arrayList2.contains(w9Var3)) {
                arrayList2.add(w9Var3);
            }
            w9VarArr[0].setImageDrawable(this.f40103s);
            ...
            ng.a aVar = this.f40105x;
            aVar.d.add(w9VarArr[0]);
            ng.a aVar2 = this.f40105x;
            aVar2.d.add(w9VarArr[1]);
        }
        linearLayout.addView(frameLayout3, w7.y5.c(-1.0f, -1));
        TLRPC.TL_forumTopic tL_forumTopic3 = this.f40104w;
        if (tL_forumTopic3 != null) {
            this.e.setText(tL_forumTopic3.title);
            b0(Long.valueOf(this.f40104w.icon_emoji_id), true);
        } else {
            b0(0L, true);
        }
    ...
    public final boolean onFragmentCreate() {
        this.f40097a = -this.arguments.getLong("chat_id");
        long j3 = this.arguments.getLong("topic_id", 0L);
        this.f40099c = j3;
        if (j3 != 0) {
            TLRPC.TL_forumTopic findTopic = getMessagesController().getTopicsController().findTopic(-this.f40097a, this.f40099c);
            this.f40104w = findTopic;
            if (findTopic == null) {
                return false;
            }
            this.E = findTopic.icon_color;
        } else {
            this.E = ng.a.f15401k[Math.abs(Utilities.random.nextInt() % 6)];
        }
