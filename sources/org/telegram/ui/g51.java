...
public final class g51 extends FrameLayout {
    public final Paint f33003a;
    public final Paint f33004b;
    public final RectF f33005c;
    public final org.telegram.ui.Components.l21 d;
    public boolean e;
    public long f33006f;
    public long h;
    public final org.telegram.ui.Components.hj0 f33007n;
    public final TextPaint f33008r;
    public StaticLayout f33009s;
    public float v;
    public float f33010w;
    public final SecretMediaViewer f33011x;

    public g51(SecretMediaViewer secretMediaViewer, Activity activity) {
        super(activity);
        this.f33011x = secretMediaViewer;
        this.f33005c = new RectF();
        this.d = new org.telegram.ui.Components.l21();
        this.f33008r = new TextPaint(1);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float max;
        MessageObject messageObject = this.f33011x.f30566h0;
        if (messageObject != null) {
            ...
            if (message.destroyTime != 0 || message.ttl == Integer.MAX_VALUE) {
                if (this.f33006f == 0) {
                    ...
                    max = ((float) Math.max(0L, this.f33006f - (System.currentTimeMillis() + (ConnectionsManager.getInstance(secretMediaViewer.f30548a).getTimeDifference() * 1000)))) / (((float) this.h) * 1000.0f);
                }
                boolean z10 = this.e;
                Paint paint = this.f33004b;
                Paint paint2 = this.f33003a;
                float f7 = max;
                RectF rectF = this.f33005c;
                if (z10) {
                    canvas.save();
                    canvas.translate(rectF.centerX() - (this.v / 2.0f), rectF.centerY() - (this.f33010w / 2.0f));
                    this.f33009s.draw(canvas);
                    canvas.restore();
                    ...
                    org.telegram.ui.Components.hj0 hj0Var = this.f33007n;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f33005c.set(measuredWidth - dpf2, measuredHeight - dpf2, measuredWidth + dpf2, dpf2 + measuredHeight);
