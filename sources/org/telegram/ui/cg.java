    ...
    public final void f(Canvas canvas, RectF rectF) {
        ...
        switch (this.f32697a) {
            case 0:
                ...
                if (f7 > 0.0f) {
                    canvas.drawColor(org.telegram.ui.ActionBar.h6.l1(f7 * 0.85f, wnVar.getThemedColor(org.telegram.ui.ActionBar.h6.f19045d6)));
                }
                gh.d.b(new cg(pmVar2, 1), canvas, rectF, wnVar.f39680x0, pmVar3, i10);
                ...
                if (i1Var != null && i1Var.getVisibility() == 0) {
                    int childCount = wnVar.f39590q1.getChildCount();
                    for (int i12 = 0; i12 < childCount; i12++) {
                        View childAt = wnVar.f39590q1.getChildAt(i12);
                        if ((childAt instanceof yn) && childAt.getVisibility() == 0) {
                            yn ynVar = (yn) childAt;
                            xn xnVar = ynVar.f40177a;
                            pm pmVar4 = xnVar.X0;
            ...
            default:
                ...
                wn wnVar3 = this.f32698b.J0;
                if (wnVar3.f39680x0.Z0()) {
                    wnVar3.f39680x0.f(canvas, rectF);
                    return;
                }
                wnVar3.f39680x0.w1(canvas, rectF);
                for (int i13 = 0; i13 < wnVar3.f39680x0.getChildCount(); i13++) {
                    View childAt2 = wnVar3.f39680x0.getChildAt(i13);
                    if (!wn.d2(wnVar3, childAt2, rectF)) {
                        if (childAt2 instanceof org.telegram.ui.Cells.u1) {
                            ...
                            canvas.restore();
                            wnVar3.f39680x0.drawChild(canvas, childAt2, uptimeMillis);
                            if (u1Var.U2()) {
                                canvas.save();
                ...
                wnVar3.f39680x0.x1(canvas, rectF);
                return;
        }
    }
}
