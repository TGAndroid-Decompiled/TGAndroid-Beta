...
public final class cg implements org.telegram.ui.Components.pj0, org.telegram.ui.ActionBar.b2 {
    ...
    public final bo f32793b;
    public final MessageObject f32794c;

    public cg(bo boVar, MessageObject messageObject, int i10) {
        this.f32792a = i10;
        this.f32793b = boVar;
        this.f32794c = messageObject;
    }
    ...
    public void a(long j3, TLRPC.MessagePeerReaction messagePeerReaction) {
        switch (this.f32792a) {
            case 0:
                ...
                bo boVar = this.f32793b;
                if (messagePeerReaction != null && messagePeerReaction.reaction != null) {
                    bundle.putInt("report_reaction_message_id", this.f32794c.getId());
            ...
            default:
                ...
                if (messagePeerReaction != null && messagePeerReaction.reaction != null) {
                    bundle2.putInt("report_reaction_message_id", this.f32794c.getId());
    ...
    public void f(org.telegram.ui.ActionBar.c2 c2Var, int i10) {
        bo boVar = this.f32793b;
        org.telegram.ui.ActionBar.c2[] c2VarArr = {new org.telegram.ui.ActionBar.c2(boVar.getParentActivity(), 3, boVar.f32279ea)};
        TLRPC.TL_messages_editMessage tL_messages_editMessage = new TLRPC.TL_messages_editMessage();
        MessageObject messageObject = this.f32794c;
