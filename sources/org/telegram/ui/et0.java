...
public final class et0 extends org.telegram.ui.Components.jd {
    public final Path f33472t1;
    public final PhotoViewer f33473u1;
    ...
    public et0(PhotoViewer photoViewer, ContextThemeWrapper contextThemeWrapper, ev0 ev0Var, org.telegram.ui.Components.qv0 qv0Var, FrameLayout frameLayout, org.telegram.ui.ActionBar.f6 f6Var, org.telegram.ui.Components.ha haVar, kr0 kr0Var) {
        ...
        this.f33473u1 = photoViewer;
        this.f33472t1 = new Path();
    }

    @Override
    public final void A() {
        PhotoViewer.W(this.f33473u1);
    }

    @Override
    public final void B() {
        z();
        dt0 dt0Var = this.f33473u1.U1;
        if (dt0Var != null) {
            dt0Var.z();
        }
    }
    ...
    public final boolean e() {
        PhotoViewer photoViewer = this.f33473u1;
    ...
    public final void invalidate() {
        int i10;
        if (SharedConfig.photoViewerBlur && ((i10 = this.f33473u1.f31035n4) == 1 || i10 == 2 || i10 == 3)) {
            return;
        }
        super.invalidate();
    }
    ...
    public final boolean l(float f7, float f10) {
        if (!this.f5006p0 && this.f33473u1.f31098u4 != 0) {
            return true;
        }
        return false;
    }
