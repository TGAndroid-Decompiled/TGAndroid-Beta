...
public final class cm0 implements org.telegram.ui.ActionBar.a2, zt, dn0 {
    public final int f32717a;
    public final pn0 f32718b;
    ...
    public void a1(vt vtVar) {
        ...
        switch (this.f32717a) {
            case 2:
                pn0 pn0Var = this.f32718b;
                pn0Var.Y[5].setText(vtVar.f38617a);
                pn0Var.f36561s = vtVar.d;
                return;
            default:
                pn0 pn0Var2 = this.f32718b;
                pn0Var2.Y[0].setText(vtVar.f38617a);
                if (pn0Var2.U0.indexOf(vtVar.f38617a) != -1) {
                    pn0Var2.Z0 = true;
                    String str2 = (String) pn0Var2.V0.get(vtVar.f38617a);
