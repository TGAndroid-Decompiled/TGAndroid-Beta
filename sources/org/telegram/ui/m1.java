...
public final class m1 extends View implements Drawable.Callback, org.telegram.ui.Cells.p9 {
    public final v70 f38563a;
    public final g4 f38564b;
    public b3 f38565c;
    public int d;
    public int f38566e;
    public final AnimatedArrowDrawable f38567f;
    ...
    public m1(Context context, v70 v70Var, g4 g4Var) {
        ...
        this.f38563a = v70Var;
        this.f38564b = g4Var;
        this.f38567f = new AnimatedArrowDrawable(v70Var.a(), true);
    }

    @Override
    public final void fillTextLayoutBlocks(ArrayList arrayList) {
        b3 b3Var = this.f38565c;
        if (b3Var != null) {
            arrayList.add(b3Var);
        }
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        canvas.save();
        v70 v70Var = this.f38563a;
        v70Var.getClass();
        canvas.translate(AndroidUtilities.dp(18), ((getMeasuredHeight() - AndroidUtilities.dp(13.0f)) - 1) / 2);
        this.f38567f.draw(canvas);
        canvas.restore();
        if (this.f38565c != null) {
            canvas.save();
            canvas.translate(this.d, this.f38566e);
            i4.v(v70Var, canvas, this, 0);
            this.f38565c.draw(canvas, this);
            canvas.restore();
        }
        float measuredHeight = getMeasuredHeight() - 1;
        canvas.drawLine(0.0f, measuredHeight, getMeasuredWidth(), measuredHeight, i4.f37231r1);
    }
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        b3 b3Var = this.f38565c;
        if (b3Var != null && (j3 = i4.j(this.f38563a, this.f38564b, b3Var)) != null) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f38566e = AndroidUtilities.dp(11.0f) + 1;
        TL_iv.pageBlockDetails pageblockdetails = this.h;
        if (pageblockdetails != null) {
            ...
            g4 g4Var = this.f38564b;
            if (g4Var != null && g4Var.G) {
                alignment = org.telegram.ui.Components.iw0.a();
            } else {
                alignment = Layout.Alignment.ALIGN_NORMAL;
            }
            b3 p5 = i4.p(v70Var, this, null, richText, dp2, 0, pageblockdetails2, alignment, 0, this.f38564b);
            this.f38565c = p5;
            if (p5 != null) {
                dp = Math.max(dp, this.f38565c.d.getHeight() + AndroidUtilities.dp(21.0f));
                int dp3 = ((AndroidUtilities.dp(21.0f) + this.f38565c.d.getHeight()) - this.f38565c.d.getHeight()) / 2;
                this.f38566e = dp3;
                b3 b3Var = this.f38565c;
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        if (!i4.l(this.f38563a, this.f38564b, motionEvent, this, this.f38565c, this.d, this.f38566e) && !super.onTouchEvent(motionEvent)) {
            return false;
        }
        return true;
    }
    ...
    public void setBlock(TL_iv.pageBlockDetails pageblockdetails) {
        ...
        AnimatedArrowDrawable animatedArrowDrawable = this.f38567f;
