...
public class rq extends org.telegram.ui.ActionBar.p2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public qq f36406a;
    public int f36407a0;
    public final boolean f36408a1;
    public bi.y1 f36409b;
    public int f36410b0;
    public ValueAnimator f36411b1;
    public fg.a0 f36412c;
    public int f36413c0;
    public ValueAnimator f36414c1;
    public FrameLayout d;
    public int f36415d0;
    public FrameLayout e;
    public int f36416e0;
    public org.telegram.ui.Components.o6 f36417f;
    public int f36418f0;
    public int f36419g0;
    ...
    public int f36436v0;
    public TLRPC.Chat f36437w;
    public int f36438w0;
    public TLRPC.ChatFull f36439x;
    public int f36440x0;
    public final int f36441y;
    public int f36442y0;
    public int f36443z0;
    ...
    public rq(long j3, long j10, TLRPC.TL_chatAdminRights tL_chatAdminRights, TLRPC.TL_chatBannedRights tL_chatBannedRights, TLRPC.TL_chatBannedRights tL_chatBannedRights2, String str, int i10, boolean z10, boolean z11, String str2) {
        ...
        this.O0 = z37;
        this.Y0 = str2;
        this.f36437w = getMessagesController().getChat(Long.valueOf(this.f36432s));
        this.f36439x = getMessagesController().getChatFull(this.f36432s);
        ...
        this.S = str3;
        this.T = str3;
        this.F = ChatObject.isCommunity(this.f36437w);
        TLRPC.Chat chat2 = this.f36437w;
        if (chat2 != null) {
            if (ChatObject.isChannel(chat2) && !this.f36437w.megagroup) {
                z35 = true;
            } else {
                z35 = false;
            }
            this.E = z35;
            this.G = ChatObject.isForum(this.f36437w);
            this.N = this.f36437w.admin_rights;
        }
        if (this.N == null) {
            if (i10 == 2 && ((chat = this.f36437w) == null || !chat.creator)) {
                z34 = false;
            } else {
                z34 = true;
            }
    ...
    public static void U(rq rqVar, long j3) {
        if (j3 != 0) {
            rqVar.f36432s = j3;
            rqVar.f36437w = MessagesController.getInstance(rqVar.currentAccount).getChat(Long.valueOf(j3));
            rqVar.r0(true);
        }
    }

    public static void V(rq rqVar, org.telegram.ui.ActionBar.c3 c3Var, View view) {
        Runnable runnable;
                ...
                if (intValue != 2) {
                    if (intValue != 3) {
                        if (intValue == 4) {
                            ...
                            try {
                                DatePickerDialog datePickerDialog = new DatePickerDialog(rqVar.getParentActivity(), new DatePickerDialog.OnDateSetListener() {
                                    @Override
                                    public final void onDateSet(DatePicker datePicker, int i10, int i11, int i12) {
                                        ...
                                        try {
                                            TimePickerDialog timePickerDialog = new TimePickerDialog(rqVar2.getParentActivity(), new TimePickerDialog.OnTimeSetListener() {
                                                @Override
                                                public final void onTimeSet(TimePicker timePicker, int i13, int i14) {
                                                    rq rqVar3 = rq.this;
                                                    rqVar3.O.until_date = (i14 * 60) + (i13 * 3600) + time;
                                                    rqVar3.f36406a.m(rqVar3.M0);
                                                }
                                            }, 0, 0, true);
    ...
    public static boolean W(rq rqVar, TLRPC.TL_error tL_error) {
        rqVar.t0(false);
        if (tL_error != null && "USER_PRIVACY_RESTRICTED".equals(tL_error.text)) {
            if (!ChatObject.isChannel(rqVar.f36437w)) {
                ...
                k0Var.I1(rqVar.f36437w, arrayList, null, null, null);
                k0Var.show();
            }
            return false;
        }
    ...
    public static void X(org.telegram.ui.rq r23, android.content.Context r24, android.view.View r25, int r26) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.rq.X(org.telegram.ui.rq, android.content.Context, android.view.View, int):void");
    }
            ...
            if (rqVar.getParentActivity() != null) {
                if ("PASSWORD_HASH_INVALID".equals(tL_error.text)) {
                    if (inputCheckPasswordSRP == null) {
                        ...
                        d2Var.T = AndroidUtilities.replaceTags(LocaleController.formatString(R.string.EditAdminTransferReadyAlertText, rqVar.f36437w.title, UserObject.getFirstName(user)));
                        alertDialog$Builder.k(LocaleController.getString(R.string.EditAdminTransferChangeOwner), new gq(rqVar, 5));
    ...
    public static void Z(rq rqVar, long j3) {
        long j10;
        TLRPC.User user;
        TLRPC.ChatFull chatFull = rqVar.f36439x;
        if (chatFull != null) {
        ...
        if (j10 != 0) {
            user = rqVar.getMessagesController().getUser(Long.valueOf(j10));
        } else {
            user = null;
        }
        TLRPC.User user2 = user;
        if (user2 != null && j3 != 0 && user2.f17342id != j3) {
            new org.telegram.ui.Components.g40(rqVar.getParentActivity(), rqVar.resourceProvider, user2, rqVar.v, new hq(rqVar, j3, 0)).show();
            return;
        }
        rqVar.f36425n = j3;
        rqVar.f36430r = true;
    ...
    public static void a0(rq rqVar, TLRPC.InputCheckPasswordSRP inputCheckPasswordSRP, TwoStepVerificationActivity twoStepVerificationActivity, long j3) {
        if (j3 != 0) {
            rqVar.f36432s = j3;
            rqVar.f36437w = MessagesController.getInstance(rqVar.currentAccount).getChat(Long.valueOf(j3));
    ...
    public final View createView(Context context) {
        ...
        if (this.I || (!this.E && this.f36437w.creator && UserObject.isUserSelf(this.v))) {
            org.telegram.ui.ActionBar.z n10 = this.actionBar.n();
            Drawable mutate = context.getResources().getDrawable(R.drawable.ic_ab_done).mutate();
            int i12 = org.telegram.ui.ActionBar.j6.f18256v8;
            mutate.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.w0(null, i12, false), PorterDuff.Mode.MULTIPLY));
            this.h = new org.telegram.ui.Components.vr(mutate, new org.telegram.ui.Components.zp(org.telegram.ui.ActionBar.j6.w0(null, i12, false)));
        ...
        t7Var.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f17872a7, false));
        ...
        y1Var.setClipChildren(z10);
        fg.a0 a0Var = new fg.a0(1, false, 5);
        this.f36412c = a0Var;
        a0Var.E = 100;
        this.f36409b.setLayoutManager(a0Var);
        bi.y1 y1Var2 = this.f36409b;
        qq qqVar = new qq(this, context);
        this.f36406a = qqVar;
        y1Var2.setAdapter(qqVar);
        s4.j jVar = new s4.j();
        if (i11 == 2) {
            this.f36409b.setResetSelectorOnChanged(false);
        }
        jVar.f41645m = false;
        jVar.C = false;
        jVar.o(org.telegram.ui.Components.wr.h);
        jVar.n(350L);
        this.f36409b.setItemAnimator(jVar);
        bi.y1 y1Var3 = this.f36409b;
        if (!LocaleController.isRTL) {
            i10 = 2;
        }
        y1Var3.setVerticalScrollbarPosition(i10);
        frameLayout.addView(this.f36409b, w7.a6.c(-1.0f, -1));
        this.f36409b.o1();
        this.actionBar.setAdaptiveBackground(this.f36409b);
        this.f36409b.setOnScrollListener(new j3(this, 6));
        this.f36409b.setOnItemClickListener(new ai.b0(6, this, context));
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.chatInfoDidLoad) {
            ...
            TLRPC.Chat chat = this.f36437w;
            if (chat != null && chatFull.f17196id == chat.f17195id) {
                this.f36439x = chatFull;
                n0();
            }
        } else if (i10 == NotificationCenter.dialogDeleted) {
            if ((-this.f36432s) == ((Long) objArr[0]).longValue()) {
    ...
    public final ArrayList getThemeDescriptions() {
        ArrayList arrayList = new ArrayList();
        e eVar = new e(this, 9);
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36409b, 16, new Class[]{org.telegram.ui.Cells.ab.class, org.telegram.ui.Cells.ga.class, org.telegram.ui.Cells.w8.class, org.telegram.ui.Cells.m4.class, org.telegram.ui.Cells.d9.class, org.telegram.ui.Cells.e6.class}, null, null, null, org.telegram.ui.ActionBar.j6.f17928d6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36409b, 32768, null, null, null, null, i10));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36409b, 4096, null, null, null, null, org.telegram.ui.ActionBar.j6.f18017i6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36409b, 0, new Class[]{View.class}, org.telegram.ui.ActionBar.j6.f18049k0, null, null, org.telegram.ui.ActionBar.j6.f17929d7));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36409b, 0, new Class[]{org.telegram.ui.Cells.f9.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.B6));
        int i11 = org.telegram.ui.ActionBar.j6.f18144p7;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36409b, 262144, new Class[]{org.telegram.ui.Cells.ga.class}, new String[]{"textView"}, null, null, -1, null, i11));
        int i12 = org.telegram.ui.ActionBar.j6.G6;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36409b, 262144, new Class[]{org.telegram.ui.Cells.ga.class}, new String[]{"textView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36409b, 0, new Class[]{org.telegram.ui.Cells.ga.class}, new String[]{"valueTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.I6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36409b, 0, new Class[]{org.telegram.ui.Cells.ga.class}, new String[]{"valueImageView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f18091m6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36409b, 0, new Class[]{org.telegram.ui.Cells.d9.class}, new String[]{"textView"}, null, null, -1, null, i12));
        int i13 = org.telegram.ui.ActionBar.j6.f18325z6;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36409b, 0, new Class[]{org.telegram.ui.Cells.d9.class}, new String[]{"valueTextView"}, null, null, -1, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36409b, 0, new Class[]{org.telegram.ui.Cells.w8.class}, new String[]{"textView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36409b, 0, new Class[]{org.telegram.ui.Cells.w8.class}, new String[]{"valueTextView"}, null, null, -1, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36409b, 0, new Class[]{org.telegram.ui.Cells.w8.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.U6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36409b, 0, new Class[]{org.telegram.ui.Cells.w8.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.V6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36409b, 0, new Class[]{org.telegram.ui.Cells.m4.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.L6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36409b, 262144, new Class[]{org.telegram.ui.Cells.m4.class}, new String[]{"textView2"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36409b, 262144, new Class[]{org.telegram.ui.Cells.m4.class}, new String[]{"textView2"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.A6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36409b, 4, new Class[]{org.telegram.ui.Cells.e6.class}, new String[]{"textView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36409b, 8388608, new Class[]{org.telegram.ui.Cells.e6.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.H6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36409b, 0, new Class[]{org.telegram.ui.Cells.ab.class}, new String[]{"nameTextView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36409b, 0, new Class[]{org.telegram.ui.Cells.ab.class}, new String[]{"statusColor"}, null, null, -1, eVar, org.telegram.ui.ActionBar.j6.f18306y6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36409b, 0, new Class[]{org.telegram.ui.Cells.ab.class}, new String[]{"statusOnlineColor"}, null, null, -1, eVar, org.telegram.ui.ActionBar.j6.f18110n6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36409b, 0, new Class[]{org.telegram.ui.Cells.ab.class}, null, org.telegram.ui.ActionBar.j6.f18174r0, null, org.telegram.ui.ActionBar.j6.J7));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(null, 0, new Class[]{org.telegram.ui.Cells.t2.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f18034j5));
        arrayList.add(new org.telegram.ui.ActionBar.l6(null, 0, new Class[]{org.telegram.ui.Cells.t2.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f18161q5));
        ...
        if (i10 != 2) {
            ...
            if (!equals) {
                if (z10) {
                    ...
                    org.telegram.ui.ActionBar.d2 d2Var = alertDialog$Builder.f17528a;
                    d2Var.R = string;
                    d2Var.T = AndroidUtilities.replaceTags(LocaleController.formatString("UserRestrictionsApplyChangesText", R.string.UserRestrictionsApplyChangesText, MessagesController.getInstance(this.currentAccount).getChat(Long.valueOf(this.f36432s)).title));
                    alertDialog$Builder.k(LocaleController.getString(R.string.ApplyTheme), new gq(this, 0));
    ...
    public final void n0() {
        ...
        TLRPC.User user;
        long j3;
        int i10 = this.f36423k0;
        if (i10 >= 0) {
            org.telegram.ui.Cells.w8 w8Var = (org.telegram.ui.Cells.w8) this.f36412c.m(i10);
            if (w8Var != null) {
                TLRPC.ChatFull chatFull = this.f36439x;
    ...
    public final void p0(TLRPC.InputCheckPasswordSRP inputCheckPasswordSRP, TwoStepVerificationActivity twoStepVerificationActivity) {
        ...
        if (inputCheckPasswordSRP != null && !ChatObject.isChannel(this.f36437w)) {
            MessagesController.getInstance(this.currentAccount).convertToMegaGroup(getParentActivity(), this.f36432s, this, new a7(this, inputCheckPasswordSRP, twoStepVerificationActivity, 10));
            return;
        }
        TLRPC.TL_channels_editCreator tL_channels_editCreator = new TLRPC.TL_channels_editCreator();
        if (ChatObject.isChannel(this.f36437w)) {
    ...
    public final void r0(boolean r20) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.rq.r0(boolean):void");
    }

    public final void t0(boolean z10) {
        float f7;
        ValueAnimator valueAnimator = this.f36411b1;
        ...
        if (vrVar != null) {
            ...
            this.f36411b1 = ofFloat;
            ofFloat.addUpdateListener(new iq(this, 0));
            this.f36411b1.addListener(new org.telegram.ui.Cells.v5(this, 14));
            this.f36411b1.setDuration(Math.abs(this.h.f28591c - (this.H ? 1.0f : 0.0f)) * 150.0f);
            this.f36411b1.start();
        }
    }
    ...
    public final void u0(boolean z10) {
        int i10;
        int min = Math.min(this.f36433s0, this.f36434t0);
        this.W = -1;
        this.X = -1;
        this.Y = -1;
        this.Z = -1;
        ...
        if (z14) {
            ...
            if (!z12 && (!this.S.isEmpty() || (this.f36437w.creator && UserObject.isUserSelf(user)))) {
                int i32 = this.V;
                this.f36427o0 = i32;
                this.V = i32 + 2;
                this.f36436v0 = i32 + 1;
                if (this.f36437w.creator && UserObject.isUserSelf(user)) {
                    int i33 = this.V;
                    this.V = i33 + 1;
                    this.f36438w0 = i33;
                } else {
        ...
        if (z10) {
            if (min == -1 && (i10 = this.f36433s0) != -1) {
                this.f36406a.s(Math.min(i10, this.f36434t0), 2);
            } else if (min != -1 && this.f36433s0 == -1) {
                this.f36406a.t(min, 2);
            }
        }
    }
}
