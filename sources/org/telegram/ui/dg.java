        ...
        switch (this.f33117a) {
            case 0:
                if (messagePeerReaction != null && messagePeerReaction.reaction != null) {
                    final bo boVar = this.f33118b;
                    if (j3 != boVar.getUserConfig().getClientUserId() && this.f33119c) {
                ...
                return;
            default:
                final bo boVar2 = this.f33118b;
                boVar2.getClass();
                if (messagePeerReaction != null && messagePeerReaction.reaction != null && j3 != boVar2.getUserConfig().getClientUserId() && this.f33119c) {
