...
public final class v10 extends FrameLayout {
    ...
    public final org.telegram.ui.ActionBar.l5 f41977a;
    public final TextView f41978b;
    public final ImageView f41979c;
    public int d;
    public int f41980e;
    public final View f41981f;
    public final ImageView h;
    public final org.telegram.ui.Components.m30 f41982n;
    public boolean f41983r;
    public final org.telegram.ui.Components.k90 f41984s;
    public boolean v;
    public float f41985w;
    public MessagesController.DialogFilter f41986x;
    public ValueAnimator f41987y;
    ...
    public v10(FiltersSetupActivity filtersSetupActivity, Context context) {
        ...
        k90Var.f28369w.setStrokeWidth(dp);
        k90Var.j(40.0f);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        MessagesController.DialogFilter dialogFilter = this.f41986x;
        if (dialogFilter != null) {
            boolean z4 = dialogFilter.locked;
            if (z4) {
                float f10 = this.f41985w;
                if (f10 != 1.0f) {
                    this.f41985w = f10 + 0.10666667f;
                    invalidate();
                }
            }
            if (!z4) {
                float f11 = this.f41985w;
                if (f11 != 0.0f) {
                    this.f41985w = f11 - 0.10666667f;
                    invalidate();
                }
            }
        }
        float clamp = Utilities.clamp(this.f41985w, 1.0f, 0.0f);
        this.f41985w = clamp;
        org.telegram.ui.ActionBar.l5 l5Var = this.f41977a;
    ...
    public void setOnReorderButtonTouchListener(View.OnTouchListener onTouchListener) {
        this.f41979c.setOnTouchListener(onTouchListener);
    }
}
