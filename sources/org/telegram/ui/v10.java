...
public final class v10 extends FrameLayout {
    ...
    public final org.telegram.ui.ActionBar.k5 f39051a;
    public final TextView f39052b;
    public final ImageView f39053c;
    public int d;
    public int e;
    public final View f39054f;
    public final ImageView h;
    public final org.telegram.ui.Components.k30 f39055n;
    public boolean f39056r;
    public final org.telegram.ui.Components.i90 f39057s;
    public boolean v;
    public float f39058w;
    public MessagesController.DialogFilter f39059x;
    public ValueAnimator f39060y;
    ...
    public v10(FiltersSetupActivity filtersSetupActivity, Context context) {
        ...
        textView.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20298z6, false));
        ...
        i90Var.f25650w.setStrokeWidth(dp);
        i90Var.j(40.0f);
        ...
        k30Var.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.w0(null, i18, false), mode));
        ...
        addView(k30Var, k7.b6.d(40, 40.0f, i23, f14, 0.0f, f15, 0.0f));
    ...
    public final void onDraw(Canvas canvas) {
        ...
        MessagesController.DialogFilter dialogFilter = this.f39059x;
        if (dialogFilter != null) {
            boolean z4 = dialogFilter.locked;
            if (z4) {
                float f10 = this.f39058w;
                if (f10 != 1.0f) {
                    this.f39058w = f10 + 0.10666667f;
                    invalidate();
                }
            }
            if (!z4) {
                float f11 = this.f39058w;
                if (f11 != 0.0f) {
                    this.f39058w = f11 - 0.10666667f;
                    invalidate();
                }
            }
        }
        float clamp = Utilities.clamp(this.f39058w, 1.0f, 0.0f);
        this.f39058w = clamp;
        org.telegram.ui.ActionBar.k5 k5Var = this.f39051a;
    ...
    public void setOnReorderButtonTouchListener(View.OnTouchListener onTouchListener) {
        this.f39053c.setOnTouchListener(onTouchListener);
    }
}
