...
public final class v10 extends org.telegram.ui.Components.kl0 {
    ...
    public final int h() {
        x10 x10Var = this.d;
        ArrayList arrayList = x10Var.f39443f;
        if (arrayList.isEmpty()) {
            return 0;
        }
        return ((int) Math.ceil(arrayList.size() / x10Var.f39458s)) + (!x10Var.N ? 1 : 0);
    }

    @Override
    public final int j(int i10) {
        x10 x10Var = this.d;
        if (i10 < ((int) Math.ceil(x10Var.f39443f.size() / x10Var.f39458s))) {
            return 0;
        }
        return 1;
    }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i11 == 0) {
            ...
            u7Var.setItemsCount(x10Var.f39458s);
            if (i10 != 0) {
                z11 = false;
            }
                ...
                if (i12 < i13) {
                    ...
                    if (i14 < arrayList.size()) {
                        ...
                        if (x10Var.f39453o0.g()) {
                            ...
                            p10Var.f36392a = messageObject.getDialogId();
                            p10Var.f36393b = id2;
                            u7Var.b(i12, x10Var.f39453o0.c(p10Var));
                        } else {
                            u7Var.b(i12, false);
                        }
                    } else {
            ...
            r2Var.O = x10Var.f39454p0;
            r2Var.W(messageObject2.getDialogId(), messageObject2, messageObject2.messageOwner.date, false, false);
            if (x10Var.f39453o0.g()) {
                int id3 = messageObject2.getId();
                p10Var.f36392a = messageObject2.getDialogId();
                p10Var.f36393b = id3;
                r2Var.V(x10Var.f39453o0.c(p10Var), z11);
                return;
            }
            r2Var.V(false, z11);
        } else if (i11 == 1) {
            int i15 = x10Var.f39458s;
            ((org.telegram.ui.Components.t00) view).v = i15 - ((((int) Math.ceil(arrayList.size() / x10Var.f39458s)) * i15) - arrayList.size());
        }
    }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 != 0) {
            ...
            frameLayout.f21437n = paint;
            frameLayout.f21439s = UserConfig.selectedAccount;
            frameLayout.f21438r = 1;
            paint.setColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.Lh, false));
            frameLayout.f21434b = new MessageObject[6];
            frameLayout.f21433a = new org.telegram.ui.Cells.q7[6];
            frameLayout.f21435c = new int[6];
            for (int i11 = 0; i11 < 6; i11++) {
                frameLayout.f21433a[i11] = new org.telegram.ui.Cells.q7(frameLayout, context);
                frameLayout.addView(frameLayout.f21433a[i11]);
                frameLayout.f21433a[i11].setVisibility(4);
                frameLayout.f21433a[i11].setTag(Integer.valueOf(i11));
                frameLayout.f21433a[i11].setOnClickListener(new org.telegram.ui.Cells.a(frameLayout, 10));
                frameLayout.f21433a[i11].setOnLongClickListener(new View.OnLongClickListener() {
                    @Override
