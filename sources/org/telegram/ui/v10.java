...
public final class v10 extends FrameLayout {
    ...
    public final org.telegram.ui.ActionBar.h5 f38573a;
    ...
    public final org.telegram.ui.Components.k30 f38577n;
    public boolean f38578r;
    public final org.telegram.ui.Components.r90 f38579s;
    public boolean v;
    public float f38580w;
    public MessagesController.DialogFilter f38581x;
    public ValueAnimator f38582y;
    ...
    public v10(FiltersSetupActivity filtersSetupActivity, Context context) {
        ...
        r90Var.C = true;
        r90Var.f27919t = 2.0f;
        int i22 = org.telegram.ui.ActionBar.h6.f19134i6;
        ...
        r90Var.f27921w.setStrokeWidth(dp);
        r90Var.j(40.0f);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        MessagesController.DialogFilter dialogFilter = this.f38581x;
        if (dialogFilter != null) {
            boolean z10 = dialogFilter.locked;
            if (z10) {
                float f7 = this.f38580w;
                if (f7 != 1.0f) {
                    this.f38580w = f7 + 0.10666667f;
                    invalidate();
                }
            }
            if (!z10) {
                float f10 = this.f38580w;
                if (f10 != 0.0f) {
                    this.f38580w = f10 - 0.10666667f;
                    invalidate();
                }
            }
        }
        float clamp = Utilities.clamp(this.f38580w, 1.0f, 0.0f);
        this.f38580w = clamp;
        org.telegram.ui.ActionBar.h5 h5Var = this.f38573a;
    ...
    public void setOnReorderButtonTouchListener(View.OnTouchListener onTouchListener) {
        this.f38575c.setOnTouchListener(onTouchListener);
    }
}
