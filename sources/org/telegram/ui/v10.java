...
public final class v10 extends org.telegram.ui.Components.kl0 {
    ...
    public final int h() {
        x10 x10Var = this.d;
        ArrayList arrayList = x10Var.f42545f;
        if (arrayList.isEmpty()) {
            return 0;
        }
        return ((int) Math.ceil(arrayList.size() / x10Var.f42560s)) + (!x10Var.N ? 1 : 0);
    }

    @Override
    public final int j(int i10) {
        x10 x10Var = this.d;
        if (i10 < ((int) Math.ceil(x10Var.f42545f.size() / x10Var.f42560s))) {
            return 0;
        }
        return 1;
    }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i11 == 0) {
            ...
            u7Var.setItemsCount(x10Var.f42560s);
            if (i10 != 0) {
                z11 = false;
            }
                ...
                if (i12 < i13) {
                    ...
                    if (i14 < arrayList.size()) {
                        ...
                        if (x10Var.f42555o0.g()) {
                            ...
                            p10Var.f39382a = messageObject.getDialogId();
                            p10Var.f39383b = id2;
                            u7Var.b(i12, x10Var.f42555o0.b(p10Var));
                        } else {
                            u7Var.b(i12, false);
                        }
                    } else {
            ...
            r2Var.O = x10Var.f42556p0;
            r2Var.W(messageObject2.getDialogId(), messageObject2, messageObject2.messageOwner.date, false, false);
            if (x10Var.f42555o0.g()) {
                int id3 = messageObject2.getId();
                p10Var.f39382a = messageObject2.getDialogId();
                p10Var.f39383b = id3;
                r2Var.V(x10Var.f42555o0.b(p10Var), z11);
                return;
            }
            r2Var.V(false, z11);
        } else if (i11 == 1) {
            int i15 = x10Var.f42560s;
            ((org.telegram.ui.Components.t00) view).v = i15 - ((((int) Math.ceil(arrayList.size() / x10Var.f42560s)) * i15) - arrayList.size());
        }
    }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 != 0) {
            ...
            frameLayout.f23343n = paint;
            frameLayout.f23345s = UserConfig.selectedAccount;
            frameLayout.f23344r = 1;
            paint.setColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.Lh, false));
            frameLayout.f23339b = new MessageObject[6];
            frameLayout.f23338a = new org.telegram.ui.Cells.q7[6];
            frameLayout.f23340c = new int[6];
            for (int i11 = 0; i11 < 6; i11++) {
                frameLayout.f23338a[i11] = new org.telegram.ui.Cells.q7(frameLayout, context);
                frameLayout.addView(frameLayout.f23338a[i11]);
                frameLayout.f23338a[i11].setVisibility(4);
                frameLayout.f23338a[i11].setTag(Integer.valueOf(i11));
                frameLayout.f23338a[i11].setOnClickListener(new org.telegram.ui.Cells.a(frameLayout, 10));
                frameLayout.f23338a[i11].setOnLongClickListener(new View.OnLongClickListener() {
                    @Override
