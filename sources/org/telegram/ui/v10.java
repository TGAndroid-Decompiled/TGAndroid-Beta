...
public final class v10 extends org.telegram.ui.Components.xl0 {
    ...
    public final int h() {
        x10 x10Var = this.d;
        ArrayList arrayList = x10Var.f39324f;
        if (arrayList.isEmpty()) {
            return 0;
        }
        return ((int) Math.ceil(arrayList.size() / x10Var.f39339s)) + (!x10Var.N ? 1 : 0);
    }

    @Override
    public final int j(int i10) {
        x10 x10Var = this.d;
        if (i10 < ((int) Math.ceil(x10Var.f39324f.size() / x10Var.f39339s))) {
            return 0;
        }
        return 1;
    }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i11 == 0) {
            ...
            v7Var.setItemsCount(x10Var.f39339s);
            if (i10 != 0) {
                z11 = false;
            }
                ...
                if (i12 < i13) {
                    ...
                    if (i14 < arrayList.size()) {
                        ...
                        if (x10Var.f39334o0.g()) {
                            ...
                            p10Var.f36451b = id2;
                            v7Var.b(i12, x10Var.f39334o0.c(p10Var));
                        } else {
                            v7Var.b(i12, false);
                        }
                    } else {
            ...
            if (x10Var.f39334o0.g()) {
                ...
                p10Var.f36450a = messageObject2.getDialogId();
                p10Var.f36451b = id3;
                s2Var.V(x10Var.f39334o0.c(p10Var), z11);
                return;
            }
            s2Var.V(false, z11);
        } else if (i11 == 1) {
            int i15 = x10Var.f39339s;
            ((org.telegram.ui.Components.t00) view).v = i15 - ((((int) Math.ceil(arrayList.size() / x10Var.f39339s)) * i15) - arrayList.size());
        }
    }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 != 0) {
            ...
            frameLayout.f21711n = paint;
            frameLayout.f21713s = UserConfig.selectedAccount;
            frameLayout.f21712r = 1;
            paint.setColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.Lh, false));
            frameLayout.f21708b = new MessageObject[6];
            frameLayout.f21707a = new org.telegram.ui.Cells.r7[6];
            frameLayout.f21709c = new int[6];
            for (int i11 = 0; i11 < 6; i11++) {
                frameLayout.f21707a[i11] = new org.telegram.ui.Cells.r7(frameLayout, context);
                frameLayout.addView(frameLayout.f21707a[i11]);
                frameLayout.f21707a[i11].setVisibility(4);
                frameLayout.f21707a[i11].setTag(Integer.valueOf(i11));
                frameLayout.f21707a[i11].setOnClickListener(new org.telegram.ui.Cells.a(frameLayout, 10));
                frameLayout.f21707a[i11].setOnLongClickListener(new View.OnLongClickListener() {
                    @Override
