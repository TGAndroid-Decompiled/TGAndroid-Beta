...
public abstract class pa extends FrameLayout {
    ...
    public final org.telegram.ui.ActionBar.f6 f36576b;
    public final org.telegram.ui.ActionBar.k5 f36577c;
    public final ImageView d;
    public final org.telegram.ui.Components.tp e;
    public final org.telegram.ui.Components.n6 f36578f;
    public final Drawable[] h;
    public float f36579n;
    public boolean f36580r;
    public ValueAnimator f36581s;
    public TLRPC.TL_username v;
    public boolean f36582w;
    public long f36583x;
    public final org.telegram.ui.Components.c6 f36584y;

    public pa(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context);
        this.f36575a = false;
        this.f36584y = new org.telegram.ui.Components.c6(this, 300L, org.telegram.ui.Components.qr.f27383f);
        this.I = new org.telegram.ui.Components.c6(this, 400L, org.telegram.ui.Components.qr.h);
        this.f36576b = f6Var;
        setBackgroundColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f18863d6, f6Var));
        ...
        this.d = imageView;
        org.telegram.ui.Components.tp tpVar = new org.telegram.ui.Components.tp(AndroidUtilities.dp(7.0f), AndroidUtilities.dp(1.35f), org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19048n6, f6Var));
        this.e = tpVar;
        ...
        n6Var.b(0.4f, 120L, org.telegram.ui.Components.qr.f27384g);
    ...
    public final void a(TLRPC.TL_username tL_username, boolean z10, boolean z11, long j3) {
        ...
        boolean z14 = this.f36575a;
        org.telegram.ui.Components.n6 n6Var = this.f36578f;
        if (z14) {
            if (this.H) {
        ...
        if (z11) {
            ...
            this.F.setInterpolator(org.telegram.ui.Components.qr.f27384g);
            this.F.start();
            return;
        }
        if (z13) {
        ...
        org.telegram.ui.ActionBar.f6 f6Var = this.f36576b;
        int d = i0.a.d(this.E, org.telegram.ui.ActionBar.j6.v0(i12, f6Var), org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19048n6, f6Var));
        this.e.b(d);
    ...
    public final void b(String str) {
        ...
        org.telegram.ui.ActionBar.k5 k5Var = this.f36577c;
        if (isEmpty) {
            ...
            spannableString.setSpan(new ForegroundColorSpan(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.H6, this.f36576b)), 0, spannableString.length(), 33);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float d10 = this.f36584y.d(f12, false);
        if (d10 > f11) {
            int alpha = org.telegram.ui.ActionBar.j6.f18985k0.getAlpha();
            org.telegram.ui.ActionBar.j6.f18985k0.setAlpha((int) (alpha * d10));
            canvas.drawRect(AndroidUtilities.dp(70.0f), getHeight() - 1, getWidth(), getHeight(), org.telegram.ui.ActionBar.j6.f18985k0);
    ...
    public void setLoading(boolean z10) {
        ...
        if (this.f36580r != z10) {
            this.f36580r = z10;
            ValueAnimator valueAnimator = this.f36581s;
            if (valueAnimator != null) {
                valueAnimator.cancel();
            }
            this.d.setVisibility(0);
            float f10 = this.f36579n;
            if (z10) {
                f7 = 1.0f;
            } else {
                f7 = 0.0f;
            ...
            ValueAnimator ofFloat = ValueAnimator.ofFloat(f10, f7);
            this.f36581s = ofFloat;
            ofFloat.addUpdateListener(new oa(this, 0));
            this.f36581s.addListener(new ai.n(26, this, z10));
            this.f36581s.setInterpolator(org.telegram.ui.Components.qr.f27384g);
            this.f36581s.setDuration(200L);
            this.f36581s.start();
        }
    }
}
