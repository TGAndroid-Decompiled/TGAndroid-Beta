...
public final class lt0 extends org.telegram.ui.Components.u00 {
    public final ts0 e;
    public final PhotoViewer f35547f;

    public lt0(PhotoViewer photoViewer, ts0 ts0Var) {
        super(false);
        this.f35547f = photoViewer;
        this.e = ts0Var;
    }
    ...
    public final CharSequence d() {
        ...
        PhotoViewer photoViewer = this.f35547f;
        int[] iArr = photoViewer.f31312m3;
        ...
        int[] iArr2 = photoViewer.f31322n3;
    ...
    public final float k() {
        return this.f35547f.f31348q3.c();
    }
