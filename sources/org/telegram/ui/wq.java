...
public final class wq implements ViewTreeObserver.OnPreDrawListener {
    ...
    public final boolean onPreDraw() {
        ...
        switch (i10) {
            case 0:
                pr prVar = (pr) obj;
                prVar.f36604c.getViewTreeObserver().removeOnPreDrawListener(this);
                int childCount = prVar.f36604c.getChildCount();
                AnimatorSet animatorSet = new AnimatorSet();
                for (int i14 = 0; i14 < childCount; i14++) {
                    View childAt = prVar.f36604c.getChildAt(i14);
                    if (childAt != view) {
                        prVar.f36604c.getClass();
                        if (RecyclerView.R(childAt) >= i11) {
                            childAt.setAlpha(0.0f);
                            ObjectAnimator ofFloat = ObjectAnimator.ofFloat(childAt, View.ALPHA, 0.0f, 1.0f);
                            ofFloat.setStartDelay((int) ((Math.min(prVar.f36604c.getMeasuredHeight(), Math.max(0, childAt.getTop())) / prVar.f36604c.getMeasuredHeight()) * 100.0f));
                ...
                if (view != null && view.getParent() == null) {
                    prVar.f36604c.addView(view);
                    s4.o0 layoutManager = prVar.f36604c.getLayoutManager();
            ...
            case 1:
                ...
                int childCount2 = pkVar.f27359r.getChildCount();
                AnimatorSet animatorSet2 = new AnimatorSet();
                for (int i15 = 0; i15 < childCount2; i15++) {
                    View childAt2 = pkVar.f27359r.getChildAt(i15);
                    if (view != null) {
                        pkVar.f27359r.getClass();
                        if (RecyclerView.R(childAt2) < i11) {
                        }
                    }
                    childAt2.setAlpha(0.0f);
                    ObjectAnimator ofFloat3 = ObjectAnimator.ofFloat(childAt2, View.ALPHA, 0.0f, 1.0f);
                    ofFloat3.setStartDelay((int) ((Math.min(pkVar.f27359r.getMeasuredHeight(), Math.max(0, childAt2.getTop())) / pkVar.f27359r.getMeasuredHeight()) * 100.0f));
                ...
                animatorSet2.start();
                if (view != null && view.getParent() == null) {
                    pkVar.f27359r.addView(view);
                    s4.o0 layoutManager2 = pkVar.f27359r.getLayoutManager();
            ...
            case 2:
                ...
                SparseArray sparseArray = bl0Var.f23014b;
                org.telegram.ui.Components.wl0 wl0Var = bl0Var.f23013a;
                ...
                bl0Var.f23017g.add(animatorSet3);
                animatorSet3.start();
