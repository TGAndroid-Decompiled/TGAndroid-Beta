    ...
    public final boolean onPreDraw() {
        ...
        switch (i10) {
            ...
            case 1:
                ...
                int childCount2 = pkVar.f27374r.getChildCount();
                AnimatorSet animatorSet2 = new AnimatorSet();
                for (int i15 = 0; i15 < childCount2; i15++) {
                    View childAt2 = pkVar.f27374r.getChildAt(i15);
                    if (view != null) {
                        pkVar.f27374r.getClass();
                        if (RecyclerView.R(childAt2) < i11) {
                        }
                    }
                    childAt2.setAlpha(0.0f);
                    ObjectAnimator ofFloat3 = ObjectAnimator.ofFloat(childAt2, View.ALPHA, 0.0f, 1.0f);
                    ofFloat3.setStartDelay((int) ((Math.min(pkVar.f27374r.getMeasuredHeight(), Math.max(0, childAt2.getTop())) / pkVar.f27374r.getMeasuredHeight()) * 100.0f));
                ...
                animatorSet2.start();
                if (view != null && view.getParent() == null) {
                    pkVar.f27374r.addView(view);
                    s4.o0 layoutManager2 = pkVar.f27374r.getLayoutManager();
            ...
            case 2:
                ...
                SparseArray sparseArray = bl0Var.f23041b;
                org.telegram.ui.Components.wl0 wl0Var = bl0Var.f23040a;
                ...
                bl0Var.f23044g.add(animatorSet3);
                animatorSet3.start();
