...
public final class g21 extends org.telegram.ui.ActionBar.j {
    ...
    public final ProxyListActivity f36534b;

    public g21(ProxyListActivity proxyListActivity, Context context) {
        this.f36534b = proxyListActivity;
    ...
    public final void b(int i10) {
        ...
        int i12;
        StringBuilder sb2;
        ProxyListActivity proxyListActivity = this.f36534b;
        ...
        if (i10 != -1) {
            ...
            if (i10 != 0) {
                if (i10 == 1) {
                    ...
                    this.f36533a.startActivity(createChooser);
