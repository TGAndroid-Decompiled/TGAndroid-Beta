...
public final class gw0 extends FrameLayout {
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        switch (this.f36807a) {
            case 0:
                lw0 lw0Var = this.f36808b;
                if (lw0Var.f38508y > 0.0f && lw0Var.f38506w != null) {
                    lw0Var.f38507x.reset();
                    float width = getWidth() / lw0Var.f38505s.getWidth();
                    lw0Var.f38507x.postScale(width, width);
                    lw0Var.v.setLocalMatrix(lw0Var.f38507x);
                    lw0Var.f38506w.setAlpha((int) (lw0Var.f38508y * 255.0f));
                    canvas2 = canvas;
                    canvas2.drawRect(0.0f, 0.0f, getWidth(), getHeight(), lw0Var.f38506w);
                } else {
                    canvas2 = canvas;
                }
    ...
    public boolean drawChild(Canvas canvas, View view, long j3) {
        switch (this.f36807a) {
            case 1:
                ...
                canvas.save();
                canvas.clipRect(0.0f, AndroidUtilities.lerp(lw0Var.M, 0.0f, lw0Var.f38508y), getWidth(), AndroidUtilities.lerp(lw0Var.N, getHeight(), lw0Var.f38508y));
    ...
    public void onSizeChanged(int i10, int i11, int i12, int i13) {
        switch (this.f36807a) {
            case 0:
                ...
                lw0 lw0Var = this.f36808b;
                hh.d.c(lw0Var.F, lw0Var.f38495c);
                lw0Var.G.d();
                return;
            default:
                super.onSizeChanged(i10, i11, i12, i13);
