...
public final class k01 implements ci.fc {
    public final ProfileActivity f35005a;

    public k01(ProfileActivity profileActivity) {
        this.f35005a = profileActivity;
    }

    @Override
    public final ci.jc a(long j3) {
        float f7;
        ProfileActivity profileActivity = this.f35005a;
        if (j3 == profileActivity.a()) {
            profileActivity.f31268e0.setRoundRadiusForExpand((int) AndroidUtilities.lerp(profileActivity.c4(), 0.0f, profileActivity.f31312k2));
            ...
            if (oz0Var != null && oz0Var.getRootView() != null) {
                ...
                hcVar.f4857c.set(imageX, imageY, imageX + imageWidth, imageWidth + imageY);
    ...
    public final void d(long j3, ai.j jVar) {
        ProfileActivity profileActivity = this.f35005a;
        profileActivity.f31268e0.setHasStories(profileActivity.j4());
        if (j3 == profileActivity.a() && profileActivity.f31338o2 && profileActivity.f31312k2 > 0.0f) {
            profileActivity.f31253c.h1(0, profileActivity.T3() - profileActivity.f31238a.getPaddingTop());
            profileActivity.f31238a.post(new yb0(profileActivity, 14));
        }
