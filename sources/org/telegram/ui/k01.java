...
public final class k01 extends org.telegram.ui.Components.pv0 implements r0.m {
    ...
    public final b2.q0 f35017w0;
    public final ProfileActivity f35018x0;
    public boolean f35019y0;
    public final Paint f35020z0;

    public k01(ProfileActivity profileActivity, Context context) {
        super(context, null);
        this.D0 = profileActivity;
        this.f35018x0 = profileActivity;
        this.f35017w0 = new Object();
        this.f35020z0 = new Paint();
    ...
    public final void E(ViewGroup viewGroup, int i10, int i11, int[] iArr, int i12) {
        ...
        int L0;
        int max;
        ProfileActivity profileActivity = this.f35018x0;
        if (viewGroup == profileActivity.f31235a) {
            int i14 = -1;
            if (profileActivity.J4 != -1 && profileActivity.Q) {
                kVar = ((org.telegram.ui.ActionBar.n2) profileActivity).actionBar;
                boolean z10 = kVar.f19313n0;
    ...
    public final void L(Canvas canvas, ArrayList arrayList) {
        canvas.save();
        ProfileActivity profileActivity = this.f35018x0;
        canvas.translate(0.0f, profileActivity.f31235a.getY());
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        org.telegram.ui.Components.f50 f50Var = profileActivity.f31397x0;
        Paint paint = profileActivity.f31348q2;
        fh.d dVar = profileActivity.f31332n6;
        ah.h hVar = profileActivity.f31324m6;
        Paint paint2 = profileActivity.f31404y0;
        if (Build.VERSION.SDK_INT >= 31 && hVar != null) {
            ...
            if (dVar != null && !dVar.f9075n) {
                ...
                a2.drawColor(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f18778a7, profileActivity.f31409z0));
        ...
        paint.setColor(org.telegram.ui.ActionBar.i6.v0(i10, profileActivity.f31409z0));
        if (profileActivity.f31235a.getVisibility() == 0) {
            int v02 = org.telegram.ui.ActionBar.i6.v0(i10, profileActivity.f31409z0);
            Paint paint3 = this.f35020z0;
            paint3.setColor(v02);
            if (profileActivity.H1) {
                paint.setAlpha((int) (profileActivity.f31235a.getAlpha() * 255.0f));
            }
            if (profileActivity.H1) {
                paint3.setAlpha((int) (profileActivity.f31235a.getAlpha() * 255.0f));
            }
            ...
            for (int i11 = 0; i11 < childCount; i11++) {
                View childAt = profileActivity.f31235a.getChildAt(i11);
                profileActivity.f31235a.getClass();
                if (RecyclerView.R(childAt) != -1) {
                    arrayList.add(profileActivity.f31235a.getChildAt(i11));
                } else {
                    z11 = true;
                }
            }
            Collections.sort(arrayList, this.C0);
            profileActivity.f31235a.getY();
        ...
        if (f50Var.getAlpha() > 0) {
            canvas.drawRect(0.0f, 0.0f, getWidth(), getHeight(), profileActivity.f31397x0);
        }
        if (profileActivity.f31390w0 != null) {
            int save = canvas.save();
            canvas.translate(profileActivity.f31390w0.getLeft(), profileActivity.f31390w0.getTop());
            View view2 = profileActivity.f31390w0;
            kVar = ((org.telegram.ui.ActionBar.n2) profileActivity).actionBar;
            if (view2 == kVar.getBackButton()) {
                int alpha = paint2.getAlpha();
                paint2.setAlpha((int) (((f50Var.getAlpha() / 255.0f) * alpha) / 0.3f));
                float max = Math.max(profileActivity.f31390w0.getMeasuredWidth(), profileActivity.f31390w0.getMeasuredHeight()) / 2;
                canvas.drawCircle(max, max, 0.7f * max, paint2);
                paint2.setAlpha(alpha);
            }
            profileActivity.f31390w0.draw(canvas);
        ...
        if (!profileActivity.I0) {
            ...
            int v03 = org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f18834d6, profileActivity.f31409z0);
            int i13 = profileActivity.f31318l6;
            gz0 gz0Var2 = profileActivity.f31235a;
            if (gz0Var2 != null) {
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (m01Var != null && (rt0Var = (rt0VarArr = m01Var.f30365k0)[0]) != null && rt0Var.h.getFastScroll() != null && rt0VarArr[0].h.getFastScroll().f27898n) {
    ...
    public final void j(ViewGroup viewGroup, int i10, int i11, int i12, int i13, int i14, int[] iArr) {
        ProfileActivity profileActivity = this.f35018x0;
        try {
            if (viewGroup == profileActivity.f31235a && profileActivity.Q) {
    ...
    public final void onSizeChanged(int i10, int i11, int i12, int i13) {
        ...
        ProfileActivity profileActivity = this.D0;
        gh.d.c(profileActivity.f31345p6, profileActivity.fragmentView);
        profileActivity.q6.d();
    }

    @Override
    public final boolean p(View view, View view2, int i10, int i11) {
        if (this.f35018x0.J4 != -1 && i10 == 2) {
            return true;
        }
        return false;
    }
