    ...
    public final void onClick(View view) {
        ...
        switch (this.f39929a) {
            case 0:
                ...
                return;
            case 1:
                mi1 mi1Var2 = this.f39930b;
                if (mi1Var2.f35596n0 && mi1Var2.m0 && System.currentTimeMillis() - mi1Var2.K0 > 500) {
            ...
            case 2:
                ...
                if (mi1Var3.H0 && System.currentTimeMillis() - mi1Var3.K0 > 500) {
                    ...
                    mi1Var3.f35568a0 = false;
                    mi1Var3.H0 = false;
                    mi1Var3.f35599q0 = mi1Var3.f35598p0;
                    mi1Var3.H();
                    return;
                }
                return;
            ...
            case 5:
                ...
                if (mi1Var6.K.getTag() != null && (sharedInstance = VoIPService.getSharedInstance()) != null) {
                    ...
                    sharedInstance.toggleSpeakerphoneOrShowRouteSheet(mi1Var6.f35570b, false, Integer.valueOf(i10));
                    return;
                }
                return;
            default:
