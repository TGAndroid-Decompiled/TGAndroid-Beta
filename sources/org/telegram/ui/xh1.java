...
public final class xh1 extends ViewGroup {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        UsersSelectActivity usersSelectActivity = this.f39649f;
        usersSelectActivity.f31627c.measure(View.MeasureSpec.makeMeasureSpec(dp - i14, 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(32.0f), 1073741824));
        if (!this.f39647b) {
            ...
            if (this.f39646a != null) {
                ...
                if (usersSelectActivity.f31634y != dp7) {
                    arrayList.add(ObjectAnimator.ofInt(usersSelectActivity, "containerHeight", dp7));
                }
                float f11 = dp6;
                if (usersSelectActivity.f31627c.getTranslationX() != f11) {
                    arrayList.add(ObjectAnimator.ofFloat(usersSelectActivity.f31627c, property2, f11));
                }
                float translationY = usersSelectActivity.f31627c.getTranslationY();
                float f12 = usersSelectActivity.Q;
                if (translationY != f12) {
                    arrayList.add(ObjectAnimator.ofFloat(usersSelectActivity.f31627c, property, f12));
                }
                usersSelectActivity.f31627c.setAllowDrawCursor(false);
                this.f39646a.playTogether(arrayList);
                this.f39646a.start();
                this.f39647b = true;
            } else {
                usersSelectActivity.f31634y = dp5;
                usersSelectActivity.f31627c.setTranslationX(dp6);
                usersSelectActivity.f31627c.setTranslationY(usersSelectActivity.Q);
            }
        } else if (this.f39646a != null && !usersSelectActivity.v && this.e == null) {
            ci.h2 h2Var = usersSelectActivity.f31627c;
            h2Var.bringPointIntoView(h2Var.getSelectionStart());
        }
        setMeasuredDimension(size, usersSelectActivity.f31634y);
    }
}
