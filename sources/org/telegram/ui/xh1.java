    ...
    public final void onClick(View view) {
        ...
        switch (this.f39928a) {
            case 0:
                ...
                return;
            case 1:
                mi1 mi1Var2 = this.f39929b;
                if (mi1Var2.f35595n0 && mi1Var2.m0 && System.currentTimeMillis() - mi1Var2.K0 > 500) {
            ...
            case 2:
                ...
                if (mi1Var3.H0 && System.currentTimeMillis() - mi1Var3.K0 > 500) {
                    ...
                    mi1Var3.f35567a0 = false;
                    mi1Var3.H0 = false;
                    mi1Var3.f35598q0 = mi1Var3.f35597p0;
                    mi1Var3.H();
                    return;
                }
                return;
            ...
            case 5:
                ...
                if (mi1Var6.K.getTag() != null && (sharedInstance = VoIPService.getSharedInstance()) != null) {
                    ...
                    sharedInstance.toggleSpeakerphoneOrShowRouteSheet(mi1Var6.f35569b, false, Integer.valueOf(i10));
                    return;
                }
                return;
            default:
