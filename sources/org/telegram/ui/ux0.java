...
public final class ux0 extends s4.o {
    public int f38194b;
    public final SparseIntArray f38195c = new SparseIntArray();
    ...
    public final boolean b(int i10, int i11) {
        int i12 = this.f38195c.get(i10, -1);
    ...
    public final void f(SparseIntArray sparseIntArray) {
        ...
        g(6, privacyControlActivity.f31197g0, sparseIntArray);
        ...
        g(19, privacyControlActivity.f31188a0, sparseIntArray);
        g(20, privacyControlActivity.f31190b0, sparseIntArray);
        g(21, privacyControlActivity.f31192c0, sparseIntArray);
        i14 = privacyControlActivity.readRow;
        g(22, i14, sparseIntArray);
        g(23, privacyControlActivity.f31193d0, sparseIntArray);
        g(24, privacyControlActivity.f31194e0, sparseIntArray);
        g(25, privacyControlActivity.f31196f0, sparseIntArray);
        g(26, privacyControlActivity.f31198h0, sparseIntArray);
        i15 = privacyControlActivity.priceRow;
        g(27, i15, sparseIntArray);
        g(28, privacyControlActivity.f31200j0, sparseIntArray);
        i16 = privacyControlActivity.showGiftIconRow;
        g(29, i16, sparseIntArray);
        g(30, privacyControlActivity.f31201k0, sparseIntArray);
        i17 = privacyControlActivity.giftTypesHeaderRow;
        g(31, i17, sparseIntArray);
        g(32, privacyControlActivity.m0, sparseIntArray);
        g(33, privacyControlActivity.f31202l0, sparseIntArray);
        g(34, privacyControlActivity.f31204n0, sparseIntArray);
        g(35, privacyControlActivity.f31205o0, sparseIntArray);
        g(36, privacyControlActivity.f31206p0, sparseIntArray);
        g(37, privacyControlActivity.f31207q0, sparseIntArray);
    }
}
