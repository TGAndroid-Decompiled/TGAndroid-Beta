...
public final class tv implements org.telegram.ui.Components.pq0, org.telegram.ui.Components.jl0, org.telegram.ui.Components.kl0, k10, org.telegram.ui.ActionBar.c2, r0.o, org.telegram.ui.Components.yk0 {
    public final int f41643a;
    public final py f41644b;
    ...
    public r0.m1 M0(View view, r0.m1 m1Var) {
        ...
        py pyVar = this.f41644b;
        pyVar.v.i(m1Var);
        i0.b defaultWindowInsets = AndroidUtilities.getDefaultWindowInsets(m1Var, false);
        pyVar.f40164c4 = defaultWindowInsets.f7758b;
        pyVar.f40169d4 = defaultWindowInsets.d;
        int i10 = m1Var.f46483a.f(8).d;
        if (pyVar.f40175e4 != i10) {
            pyVar.f40175e4 = i10;
            pyVar.fragmentView.requestLayout();
        }
        pyVar.C0.setPadding(0, pyVar.f40164c4, 0, 0);
        pyVar.X4();
        for (UndoView undoView : pyVar.f40257v0) {
            if (undoView != null) {
                int i11 = pyVar.f40169d4 + pyVar.f40181f4;
    ...
    public boolean f(int i10, View view) {
        py.n0(this.f41644b, i10);
        return false;
    }

    public void g(int i10) {
        ax axVar = this.f41644b.f40273y1;
        if (axVar == null) {
            return;
        }
        if (i10 == 0) {
    ...
    public void h(boolean z4, ArrayList arrayList, ArrayList arrayList2, boolean z10) {
        this.f41644b.W4(z4, arrayList, arrayList2, z10, true);
    }
