...
public final class u8 implements RequestDelegate {
    ...
    public final Object f40971f;
    public final Object f40972g;
    ...
    public u8(int i10, TLRPC.InputGroupCall inputGroupCall, String[] strArr, FrameLayout frameLayout, org.telegram.ui.Components.d90 d90Var, org.telegram.ui.ActionBar.f3 f3Var, org.telegram.ui.ActionBar.f6 f6Var) {
        this.f40967a = 0;
        this.f40968b = i10;
        this.f40969c = inputGroupCall;
        this.d = strArr;
        this.f40970e = frameLayout;
        this.f40971f = d90Var;
        this.f40972g = f3Var;
        this.h = f6Var;
    }
    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        Object obj = this.h;
        Object obj2 = this.f40972g;
        Object obj3 = this.f40971f;
        Object obj4 = this.f40970e;
        Object obj5 = this.d;
        Object obj6 = this.f40969c;
        switch (i10) {
            case 0:
            ...
            case 1:
                ...
                return;
            case 2:
                ArrayList arrayList2 = ExternalActionActivity.f33396x;
                AndroidUtilities.runOnUIThread(new org.telegram.messenger.x5((ExternalActionActivity) obj6, (org.telegram.ui.ActionBar.b2) obj5, tLObject, this.f40968b, (TL_account.authorizationForm) obj4, (TL_account.getAuthorizationForm) obj3, (String) obj2, (String) obj));
                return;
            default:
                AndroidUtilities.runOnUIThread(new org.telegram.messenger.ib((fg0) obj6, tLObject, tL_error, (c5.k) obj5, this.f40968b, (c5.o) obj4, (TLRPC.TL_inputStorePaymentAuthCode) obj3, (String) obj2, (TLRPC.TL_payments_canPurchaseStore) obj));
                return;
        }
    }
    ...
    public u8(KeyEvent.Callback callback, Object obj, int i10, Object obj2, TLObject tLObject, String str, Object obj3, int i11) {
        this.f40967a = i11;
        this.f40969c = callback;
        this.d = obj;
        this.f40968b = i10;
        this.f40970e = obj2;
        this.f40971f = tLObject;
        this.f40972g = str;
        this.h = obj3;
    }
}
