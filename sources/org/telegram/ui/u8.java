...
public final class u8 implements RequestDelegate {
    ...
    public final Object f40997e;
    public final Object f40998f;
    public final Object f40999g;
    ...
    public u8(int i10, TLRPC.InputGroupCall inputGroupCall, String[] strArr, FrameLayout frameLayout, org.telegram.ui.Components.d90 d90Var, org.telegram.ui.ActionBar.f3 f3Var, org.telegram.ui.ActionBar.f6 f6Var) {
        this.f40994a = 0;
        this.f40995b = i10;
        this.f40996c = inputGroupCall;
        this.d = strArr;
        this.f40997e = frameLayout;
        this.f40998f = d90Var;
        this.f40999g = f3Var;
        this.h = f6Var;
    }
    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        Object obj = this.h;
        Object obj2 = this.f40999g;
        Object obj3 = this.f40998f;
        Object obj4 = this.f40997e;
        Object obj5 = this.d;
        Object obj6 = this.f40996c;
        switch (i10) {
            case 0:
            ...
            case 1:
                ...
                return;
            case 2:
                ArrayList arrayList2 = ExternalActionActivity.f33423x;
                AndroidUtilities.runOnUIThread(new org.telegram.messenger.x5((ExternalActionActivity) obj6, (org.telegram.ui.ActionBar.b2) obj5, tLObject, this.f40995b, (TL_account.authorizationForm) obj4, (TL_account.getAuthorizationForm) obj3, (String) obj2, (String) obj));
                return;
            default:
                AndroidUtilities.runOnUIThread(new org.telegram.messenger.ib((fg0) obj6, tLObject, tL_error, (c5.k) obj5, this.f40995b, (c5.o) obj4, (TLRPC.TL_inputStorePaymentAuthCode) obj3, (String) obj2, (TLRPC.TL_payments_canPurchaseStore) obj));
                return;
        }
    }
