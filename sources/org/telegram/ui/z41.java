...
public final class z41 extends org.telegram.ui.Cells.u1 {
    ...
    public final void E1(Canvas canvas) {
        ...
        if (paint != null) {
            ...
            if (f7 > 0.0f) {
                if (b51Var.Q) {
                    ...
                    getPhotoImage().setAlpha(Math.max(1.0f - this.Qe.e(b51Var.Q), 1.0f - b51Var.f32319s));
        ...
        canvas.drawArc(rectF2, -90.0f, (1.0f - b51Var.f32309a0) * (-360.0f), false, paint3);
        if (this.Pe == null) {
        ...
        this.Pe.a((1.0f - b51Var.f32309a0) * (-360.0f), 1.0f, canvas, paint3, rectF2);
        canvas.restore();
    }
    ...
    public final void d2(Canvas canvas, float f7, Integer num) {
        ...
        zg.p0 p0Var = this.N;
        b51 b51Var = this.Te;
        canvas.translate(AndroidUtilities.lerp(0, -p0Var.f49394c, b51Var.f32319s), AndroidUtilities.lerp(b51Var.O.getBackgroundDrawableBottom() - getBackgroundDrawableBottom(), p0Var.f49404p, b51Var.f32319s));
        super.d2(canvas, (1.0f - b51Var.f32319s) * f7, num);
        canvas.restore();
    }
    ...
    public final void m2(float f7, Canvas canvas, boolean z10) {
        ...
        if (b51Var.S) {
            ...
            canvas.translate(((this.Ie.right - (AndroidUtilities.dp(8 + i11) + i10)) - this.f21493rb) * b51Var.f32319s, 0.0f);
        }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (z10) {
            ...
            AndroidUtilities.lerp(rectF3, rectF2, b51Var.f32319s, rectF);
            U3(rectF.left, rectF.top, rectF.width(), rectF.height());
            getPhotoImage().setRoundRadius((int) rectF.width());
            if (b51Var.f32319s > 0.0f && b51Var.Q) {
                canvas2 = canvas;
                canvas2.saveLayerAlpha(0.0f, 0.0f, getWidth(), getHeight(), 255, 31);
            } else {
                canvas2 = canvas;
            }
            this.f21570we = 1.0f - b51Var.f32319s;
        } else {
            canvas2 = canvas;
        }
        S1(canvas2);
        if (b51Var.S && b51Var.f32319s > 0.0f && b51Var.Q) {
            canvas2.restore();
        }
    }
