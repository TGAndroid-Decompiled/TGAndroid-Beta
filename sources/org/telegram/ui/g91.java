...
public final class g91 extends org.telegram.ui.Components.sa {
    public static final int f34368a0 = 0;
    public final lh.c U;
    ...
    public g91(final Context context, final int i10, final org.telegram.ui.ActionBar.f6 f6Var, final kh.a1 a1Var) {
        ...
        lh.c cVar = new lh.c(context, i10, lf.b.f12057b, f6Var);
        this.U = cVar;
        cVar.setScaleX(0.6f);
        cVar.setScaleY(0.6f);
        cVar.setAlpha(0.0f);
        ...
        TextView b13 = k7.f6.b(context, 14.0f, org.telegram.ui.ActionBar.j6.f20256y6, false, null);
        b13.setGravity(17);
            ...
            public final void onClick(View view2) {
                ...
                try {
                    ...
                    if (parseDouble > MessagesController.getInstance(i23).tonStakeddiceStakeAmountMax / 1.0E9d) {
                        ...
                        int i24 = -iArr2[0];
                        iArr2[0] = i24;
                        AndroidUtilities.shakeViewSpring(bd0Var2, i24);
                        ...
                        int i25 = -iArr2[0];
                        iArr2[0] = i25;
                        AndroidUtilities.shakeViewSpring(bd0Var2, i25);
                    } else if (lh.t7.y(i23, true).f13136f.toDouble() < parseDouble) {
                        new qh.f(context, f6Var, lf.a.i((long) (parseDouble * 1.0E9d), lf.b.f12057b), true, new j21(3));
                    } else {
        ...
        rl0Var.setPadding(i24, 0, i24, AndroidUtilities.dp(68.0f));
        this.Z.N(false);
    }
