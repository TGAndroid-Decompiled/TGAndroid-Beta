...
public final class g91 extends org.telegram.ui.ActionBar.o2 implements NotificationCenter.NotificationCenterDelegate, org.telegram.ui.Components.t40, fh0, le.d {
    ...
    public final le.b f33917a;
    public final RectF f33918a0;
    public y8 f33919b;
    public final RectF f33920b0;
    public org.telegram.ui.Components.f61 f33921c;
    public ci.s6 d;
    public org.telegram.ui.ActionBar.w0 e;
    public org.telegram.ui.ActionBar.w0 f33922f;
    public y81 h;
    public org.telegram.ui.Components.u40 f33923n;
    public AnimatorSet f33924r;
    public org.telegram.ui.Cells.y3 f33925s;
    public TLRPC.FileLocation v;
    public TLRPC.FileLocation f33926w;
    public FrameLayout f33927x;
    public FrameLayout f33928y;
    ...
    public static boolean U(g91 g91Var, org.telegram.ui.Components.j51 j51Var, View view) {
        ...
        if (j51Var.G(org.telegram.ui.Cells.v6.class)) {
            ...
            if (!TextUtils.isEmpty(str)) {
                ...
                H.W(g91Var.f33921c.W0(view, false));
                H.Z();
                return true;
            }
        }
    ...
    public static void W(g91 g91Var) {
        ...
        org.telegram.ui.Components.u40 u40Var = g91Var.f33923n;
    ...
    public static void b0(g91 g91Var, ArrayList arrayList) {
        ...
        if (r0Var != null && r0Var.getTag() != null) {
            ...
            if (y81Var.f35421w) {
                ArrayList arrayList6 = y81Var.f35419r;
            ...
            if (!arrayList5.isEmpty()) {
                ...
                while (i15 < size3) {
                    ...
                    if (obj3 instanceof k11) {
                        k11 k11Var = (k11) obj3;
                        String str = k11Var.f34971a;
                        int i16 = org.telegram.ui.Cells.v6.f21486a;
                        ...
                        int i17 = org.telegram.ui.Cells.v6.f21486a;
            ...
            if (!arrayList4.isEmpty()) {
                ...
                while (i10 < size4) {
                    ...
                    int i18 = org.telegram.ui.Cells.v6.f21486a;
        ...
        FrameLayout frameLayout = g91Var.f33927x;
        ...
        if (attachMenuBots != null && (arrayList2 = attachMenuBots.bots) != null && !arrayList2.isEmpty()) {
            ...
            while (i10 < size5) {
                ...
                if (tL_attachMenuBot2.show_in_side_menu && tL_attachMenuBot2.bot_id == 1985737506) {
                    ...
                    J7.d = (int) (j11 ^ (j11 >>> 32));
                    J7.f25123k = i24;
                    J7.f25124l = tL_attachMenuBot2.short_name;
    ...
    public static void c0(g91 g91Var, TLRPC.TL_error tL_error, TLObject tLObject, String str) {
        ...
        if (tL_error == null) {
            ...
            } else if (closestPhotoSizeWithSize2 != null && g91Var.f33926w != null) {
                FileLoader.getInstance(g91Var.currentAccount).getPathToAttach(g91Var.f33926w, true).renameTo(FileLoader.getInstance(g91Var.currentAccount).getPathToAttach(closestPhotoSizeWithSize2, true));
            }
        ...
        if (i10 == 1) {
            ...
            try {
                if (i10 == 14) {
                    ...
                    alertDialog$Builder.f18446a.R = "Force performance class";
    ...
    public static void e0(g91 g91Var, TLRPC.InputFile inputFile, TLRPC.InputFile inputFile2, TLRPC.VideoSize videoSize, double d, String str, TLRPC.PhotoSize photoSize, TLRPC.PhotoSize photoSize2) {
        if (inputFile == null && inputFile2 == null && videoSize == null) {
            ...
            g91Var.f33926w = photoSize2.location;
    ...
    public static void f0(g91 g91Var, org.telegram.ui.Components.j51 j51Var) {
        ...
        if (obj instanceof TLRPC.TL_attachMenuBot) {
            ...
            if (obj2 instanceof k11) {
                ...
                k11Var.f34972b.run();
                AndroidUtilities.scrollToFragmentRow(parentLayout, k11Var.f34973c);
            } else if (obj2 instanceof MessagesController.FaqSearchResult) {
    ...
    public final void B(float f7) {
        org.telegram.ui.Cells.y3 y3Var = this.f33925s;
        if (y3Var == null) {
            return;
        }
    ...
    public final View createView(Context context) {
        this.f33919b = new y8(this, context, 7);
        ...
        this.f33922f.e(2, R.drawable.msg_leave, LocaleController.getString(R.string.LogOut));
        ...
        f61Var.q1();
        this.f33921c.setPadding(0, AndroidUtilities.dp(12.0f) + AndroidUtilities.statusBarHeight, 0, AndroidUtilities.navigationBarHeight + this.T);
        this.f33921c.setClipToPadding(false);
        this.f33921c.j(new h3(this, 28));
        org.telegram.ui.Components.f61 f61Var2 = this.f33921c;
        y8 y8Var = this.f33919b;
        Objects.requireNonNull(f61Var2);
        this.Y = new ah.o(f61Var2, y8Var, new x8(f61Var2, 0));
        this.f33921c.D0(new t81(this, 2));
        this.f33919b.addView(this.f33921c, w7.x5.e(-1, -1, 119));
        ci.s6 s6Var = new ci.s6(this, context);
        this.d = s6Var;
        this.f33919b.addView(s6Var, w7.x5.e(-1, 200, 48));
        this.f33919b.addView(this.actionBar, w7.x5.e(-1, -2, 55));
        org.telegram.ui.Components.u40 u40Var = new org.telegram.ui.Components.u40(0, true, true);
        this.f33923n = u40Var;
        u40Var.H = true;
        u40Var.f28272a = this;
        u40Var.f28273b = this;
        this.f33927x = new FrameLayout(context);
        FrameLayout frameLayout = new FrameLayout(context);
        this.f33928y = frameLayout;
        this.f33927x.addView(frameLayout, w7.x5.d(120, 120.0f, 49, 0.0f, 11.0f, 0.0f, 0.0f));
        this.f33928y.setOnClickListener(new u81(this, 5));
        w7.z5.a(this.f33928y);
        ...
        this.f33928y.addView(this.F, w7.x5.d(90, 90.0f, 49, 0.0f, 15.0f, 0.0f, 0.0f));
        org.telegram.ui.Cells.y3 y3Var = new org.telegram.ui.Cells.y3(this, context);
        this.f33925s = y3Var;
        y3Var.setSize(AndroidUtilities.dp(26.0f));
        this.f33925s.setProgressColor(-1);
        this.f33925s.setNoProgress(false);
        this.f33928y.addView(this.f33925s, w7.x5.d(90, 90.0f, 49, 0.0f, 15.0f, 0.0f, 0.0f));
        n0(false, false);
        FrameLayout frameLayout2 = new FrameLayout(context);
        this.G = frameLayout2;
        frameLayout2.setBackground(org.telegram.ui.ActionBar.j6.K(AndroidUtilities.dp(32.0f), getThemedColor(org.telegram.ui.ActionBar.j6.f18806a7)));
        ...
        this.f33928y.addView(this.G, w7.x5.d(34, 34.0f, 49, 32.0f, 75.0f, 0.0f, 0.0f));
        w7.z5.a(this.G);
        ...
        TextView f7 = org.telegram.ui.Cells.p6.f(this.f33927x, this.J, w7.x5.d(-1, -2.0f, 49, 16.0f, 126.33299f, 16.0f, 0.0f), context);
        this.K = f7;
        f7.setTextSize(1, 13.0f);
        this.K.setGravity(17);
        this.K.setSingleLine();
        this.K.setEllipsize(truncateAt);
        TextView f10 = org.telegram.ui.Cells.p6.f(this.f33927x, this.K, w7.x5.d(-1, -2.0f, 49, 0.0f, 156.0f, 0.0f, 0.0f), context);
        this.L = f10;
        ...
        this.L.setBackground(org.telegram.ui.ActionBar.j6.f0(getThemedColor(org.telegram.ui.ActionBar.j6.f18952i6), 2, -1));
        this.L.setOnClickListener(new u81(this, 6));
        this.N = new View(context);
        o0(true, false);
        this.f33921c.Y2.N(false);
        m0(getUserConfig().getCurrentUser());
        p0();
        j0();
        y8 y8Var2 = this.f33919b;
        w81 w81Var = new w81(this);
        WeakHashMap weakHashMap = r0.i0.f41865a;
        r0.a0.j(y8Var2, w81Var);
        y8 y8Var3 = this.f33919b;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.starBalanceUpdated) {
            ...
            m0(getUserConfig().getCurrentUser());
        } else if (i10 == NotificationCenter.newSuggestionsAvailable && (f61Var = this.f33921c) != null) {
            f61Var.Y2.N(true);
        }
    }
    ...
    public final void i0() {
        ...
        if (Build.VERSION.SDK_INT >= 31 && (iVar = this.V) != null) {
            ...
            this.f33918a0.set(0.0f, -dp, this.fragmentView.getMeasuredWidth(), this.actionBar.getMeasuredHeight() + dp);
            RectF rectF = this.f33920b0;
    ...
    public final boolean isSwipeBackEnabled(MotionEvent motionEvent) {
        return !this.f33917a.f13985f;
    }

    public final void j0() {
        float f7;
        org.telegram.ui.ActionBar.w0 w0Var = this.f33922f;
        le.b bVar = this.f33917a;
    ...
    public final void l0(org.telegram.ui.ActionBar.o2 o2Var) {
        ...
        if (AndroidUtilities.isTablet() && (launchActivity = LaunchActivity.G1) != null && (actionBarLayout = launchActivity.f30862s0) != null) {
    ...
    public final void n0(boolean z10, boolean z11) {
        ...
        AnimatorSet animatorSet = this.f33924r;
        if (animatorSet != null) {
            animatorSet.cancel();
            this.f33924r = null;
        }
        if (z11) {
            ...
            this.f33924r = animatorSet2;
            if (z10) {
                this.f33925s.setVisibility(0);
                this.f33924r.playTogether(ObjectAnimator.ofFloat(this.f33925s, View.ALPHA, 1.0f));
            } else {
                animatorSet2.playTogether(ObjectAnimator.ofFloat(this.f33925s, View.ALPHA, 0.0f));
            }
            this.f33924r.setDuration(180L);
            this.f33924r.addListener(new j70(9, this, z10));
            this.f33924r.start();
        } else if (z10) {
            this.f33925s.setAlpha(1.0f);
            this.f33925s.setVisibility(0);
        } else {
            this.f33925s.setAlpha(0.0f);
            this.f33925s.setVisibility(4);
        }
    }
    ...
    public final void p0() {
        ...
        this.f33919b.setBackgroundColor(getThemedColor(org.telegram.ui.ActionBar.j6.f18806a7));
        this.J.setTextColor(getThemedColor(i10));
        this.K.setTextColor(getThemedColor(org.telegram.ui.ActionBar.j6.f19244y6));
        this.e.N();
    ...
    public g91(Bundle bundle) {
        super(bundle);
        this.f33917a = new le.b(0, this, org.telegram.ui.Components.qr.h, 350L, false);
        this.O = 0;
