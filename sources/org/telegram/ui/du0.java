...
public final class du0 extends qu0 {
    public final int f33228p0;
    public final NotificationCenter.NotificationCenterDelegate f33229q0;
    ...
    public du0(NotificationCenter.NotificationCenterDelegate notificationCenterDelegate, Context context, tu0 tu0Var, FrameLayout frameLayout, int i10) {
        ...
        this.f33228p0 = i10;
        this.f33229q0 = notificationCenterDelegate;
    }

    @Override
    public boolean C() {
        switch (this.f33228p0) {
            case 0:
                return !((PhotoViewer) this.f33229q0).f31075s;
            default:
                return super.C();
        }
    }
    ...
    public void D() {
        switch (this.f33228p0) {
            case 1:
                SecretMediaViewer secretMediaViewer = (SecretMediaViewer) this.f33229q0;
                if (secretMediaViewer.J && getScrollY() <= 0) {
                    AndroidUtilities.runOnUIThread(secretMediaViewer.f31492r1, 3000L);
                    return;
                }
                return;
            default:
    ...
    public void F() {
        switch (this.f33228p0) {
            case 1:
                AndroidUtilities.cancelRunOnUIThread(((SecretMediaViewer) this.f33229q0).f31492r1);
                return;
            default:
                return;
        }
        ...
        switch (this.f33228p0) {
            case 1:
                ...
                if (secretMediaViewer.K0 == null) {
                    if (getScrollY() < getMeasuredHeight() / 3.0f && secretMediaViewer.f31477k0) {
                        z10 = true;
                    } else {
                        z10 = false;
                    }
    ...
    public void invalidate() {
        ...
        switch (this.f33228p0) {
            case 0:
                super.invalidate();
                PhotoViewer photoViewer = (PhotoViewer) this.f33229q0;
                ...
                if (photoViewer.J) {
                    ...
                    if (!z10) {
                        int b10 = bv0VarArr[0].b() + bv0VarArr[0].f32584j;
                        if (C()) {
