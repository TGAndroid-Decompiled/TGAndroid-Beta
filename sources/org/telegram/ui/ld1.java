...
public final class ld1 extends org.telegram.ui.Components.u9 {
    ...
    public final void onDraw(Canvas canvas) {
            ...
            if (!(drawable instanceof ColorDrawable) && !(drawable instanceof GradientDrawable) && !(drawable instanceof org.telegram.ui.Components.cc0)) {
                if (drawable instanceof BitmapDrawable) {
                    if (((BitmapDrawable) drawable).getTileModeX() == Shader.TileMode.REPEAT) {
                        ...
                        int ceil = (int) Math.ceil(this.G.getIntrinsicWidth() * max * wd1Var.f38852y1);
                        int ceil2 = (int) Math.ceil(this.G.getIntrinsicHeight() * max * wd1Var.f38852y1);
        ...
        if (wd1Var.a2) {
            if (!wd1Var.f38793c.isFinished() && wd1Var.f38793c.computeScrollOffset()) {
                if (wd1Var.f38793c.getStartX() < wd1Var.W1 && wd1Var.f38793c.getStartX() > 0) {
                    wd1Var.X1 = wd1Var.f38793c.getCurrX();
                }
                wd1Var.V0();
                invalidate();
            }
        ...
        if (wd1Var.M1) {
            float f11 = wd1Var.f38825n1;
            if (f11 > 0.0f) {
                canvas.drawColor(i0.a.k(-16777216, (int) (f11 * 255.0f * wd1Var.f38827o1)));
            }
        }
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        wd1 wd1Var = this.K;
        org.telegram.ui.Components.l81 l81Var = wd1Var.f38843v1;
        ...
        if (wd1Var.f38792b2 != measuredWidth2) {
            wd1Var.a2 = false;
        ...
        wd1Var.f38792b2 = measuredWidth2;
    }
