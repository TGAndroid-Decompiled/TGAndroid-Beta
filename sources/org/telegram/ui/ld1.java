...
public final class ld1 extends org.telegram.ui.ActionBar.j {
    ...
    public final void b(int i10) {
        ...
        if (i10 == -1) {
            ...
            h6Var.f18732o = str2;
            h6Var.f18733p = xd1Var.l1;
            h6Var.f18734q = xd1Var.E1;
            if (((int) h6Var.f18727j) == 0) {
                h6Var.f18727j = 4294967296L;
            }
            if (((int) h6Var.f18728k) == 0) {
                h6Var.f18728k = 4294967296L;
            }
            if (((int) h6Var.f18729l) == 0) {
                h6Var.f18729l = 4294967296L;
            }
            if (((int) h6Var.f18730m) == 0) {
                h6Var.f18730m = 4294967296L;
            }
            xd1Var.W0();
            NotificationCenter.getGlobalInstance().removeObserver(xd1Var, NotificationCenter.wallpapersDidLoad);
            org.telegram.ui.ActionBar.j6.t1(xd1Var.f39550e0, true, false, false, true, false);
            ...
            if (xd1Var.getParentActivity() != null) {
                ...
                if (obj instanceof TLRPC.TL_wallPaper) {
                    ...
                    fj1 fj1Var = new fj1(str, xd1Var.Z0, xd1Var.f39541b1, xd1Var.f39545c1, xd1Var.f39548d1, xd1Var.f39561h1, xd1Var.l1, xd1Var.E1, null);
                    fj1Var.f33712g = tL_wallPaper2;
                    b10 = fj1Var.b();
                } else if (BuildVars.DEBUG_PRIVATE_VERSION && (k10 = org.telegram.ui.ActionBar.j6.I.k(false)) != null) {
                    fj1 fj1Var2 = new fj1(k10.f18732o, (int) k10.f18727j, (int) k10.f18728k, (int) k10.f18729l, (int) k10.f18730m, k10.f18731n, k10.f18733p, k10.f18734q, null);
                    ...
                    while (true) {
                        ...
                        if (tL_wallPaper3.pattern && k10.f18732o.equals(tL_wallPaper3.slug)) {
                            fj1Var2.f33712g = tL_wallPaper3;
                            break;
                        }
                        i12++;
                    }
