...
public final class d11 extends FrameLayout {
    ...
    public int f32860a;
    public final Paint f32861b;
    public boolean f32862c;
    public final org.telegram.ui.Components.e6 d;
    public int e;
    public int f32863f;
    public final org.telegram.ui.Components.h5 h;
    public final org.telegram.ui.Components.h5 f32864n;
    public int f32865r;
    public int f32866s;
    public int v;
    public float f32867w;
    public float f32868x;
    public RadialGradient f32869y;

    public d11(ProfileActivity profileActivity, Context context) {
        super(context);
        this.N = profileActivity;
        this.f32861b = new Paint();
        ...
        this.f32864n = new org.telegram.ui.Components.h5(this, 350L, rrVar);
        this.E = new Matrix();
        this.F = new Paint(1);
    ...
    public final void a(MessagesController.PeerColor peerColor, boolean z10) {
        ...
        if (peerColor != null) {
            ...
            this.f32863f = bgColor2;
            profileActivity.f31527c1 = i0.a.d(0.25f, this.e, bgColor2);
            ...
            profileActivity.f31527c1 = this.f32860a;
            this.f32862c = false;
            int i11 = org.telegram.ui.ActionBar.h6.f19323s8;
            if (AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.h6.v0(i11, profileActivity.f31684z0)) > 0.8f) {
                this.G = -1;
                this.H = -1;
            } else if (AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.h6.v0(i11, profileActivity.f31684z0)) < 0.2f) {
                this.G = org.telegram.ui.ActionBar.h6.l1(0.5f, org.telegram.ui.ActionBar.h6.b(0.02f, 0.25f, org.telegram.ui.ActionBar.h6.v0(i11, profileActivity.f31684z0)));
                this.H = org.telegram.ui.ActionBar.h6.l1(0.35f, org.telegram.ui.ActionBar.h6.b(0.02f, 0.25f, org.telegram.ui.ActionBar.h6.v0(i11, profileActivity.f31684z0)));
            } else {
                this.G = tp0.w0(org.telegram.ui.ActionBar.h6.v0(i11, profileActivity.f31684z0));
                this.H = org.telegram.ui.ActionBar.h6.l1(0.15f, tp0.w0(org.telegram.ui.ActionBar.h6.v0(i11, profileActivity.f31684z0)));
            }
        }
        if (!z10) {
            this.h.a(this.e, true);
            this.f32864n.a(this.f32863f, true);
        }
        invalidate();
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        Paint paint3 = this.f32861b;
        if (i12 != 0) {
            paint3.setColor(this.f32860a);
            int a2 = this.h.a(this.e, false);
            int a10 = this.f32864n.a(this.f32863f, false);
            org.telegram.ui.Components.oh0 oh0Var = profileActivity.f31511a0;
            if (oh0Var != null) {
                int i13 = this.H;
                boolean z10 = this.f32862c;
            ...
            RadialGradient radialGradient = this.f32869y;
            Paint paint4 = this.F;
            if (radialGradient == null || this.f32865r != a2 || this.f32866s != a10 || this.v != width) {
                this.f32867w = AndroidUtilities.dp(96.0f) * 2;
                ...
                this.f32868x = kVar3.getTranslationY() + ((org.telegram.ui.ActionBar.k.getCurrentActionBarHeight() + i11) - (AndroidUtilities.density * 21.0f));
                this.v = width;
                float f13 = this.f32868x;
                float f14 = this.f32867w;
                this.f32866s = a10;
                this.f32865r = a2;
                ...
                this.f32869y = radialGradient2;
                radialGradient2.setLocalMatrix(this.E);
                paint4.setShader(this.f32869y);
            }
            ...
            float e = this.d.e(this.f32862c) * f7;
            if (e < 1.0f) {
                paint2 = paint3;
            ...
            if (this.K) {
                ...
                if (!z11) {
                    if (o5Var != null) {
                        ...
                        if ((drawable instanceof org.telegram.ui.Components.q5) && (l4Var = ((org.telegram.ui.Components.q5) drawable).f27498k) != null && l4Var.hasImageLoaded()) {
                            this.L = true;
                        }
                    }
                    z12 = false;
                ...
                if ((!profileActivity.G1 || profileActivity.J1 != 2) && e7 > 0.0f && profileActivity.Y != null) {
                    ...
                    canvas2.restore();
                    chVar = profileActivity.f31560g5;
        ...
        if (i12 != f12 && !profileActivity.G1) {
            paint.setColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19045d6, profileActivity.f31684z0));
            this.M.set(0, i12, getMeasuredWidth(), (int) f12);
            profileActivity.f31598m5.J(canvas2, getY(), this.M, paint, true);
        }
    }
    ...
    public final void setBackgroundColor(int i10) {
        if (i10 != this.f32860a) {
            this.f32860a = i10;
            this.f32861b.setColor(i10);
            invalidate();
            if (!this.f32862c) {
                this.N.f31527c1 = this.f32860a;
            }
        }
    }
}
