...
public final class pf implements Utilities.Callback {
    ...
    public final void run(Object obj) {
        ...
        int i13 = 0;
        Object obj2 = this.f36615c;
        Object obj3 = this.f36614b;
        switch (i12) {
            case 0:
                bo boVar = (bo) obj3;
                ...
                Long l4 = (Long) obj;
                if (boVar.R3 == 1) {
                    org.telegram.ui.Components.c5.M(boVar.getParentActivity(), boVar.T5, new c7(boVar, botInlineResult, l4, 2), boVar.f32275ea);
                    return;
                } else {
            ...
            case 2:
                ...
                if (tL_statsPollStats != null) {
                    if (tL_statsPollStats.votes_graph instanceof TL_stats.TL_statsGraphError) {
                        ...
                        new th.g(boVar2.getParentActivity(), boVar2.f32275ea, tL_statsPollStats).show();
                        return;
                    }
                }
                return;
            ...
            case 4:
                ...
                bo boVar4 = ((oj) obj3).f36362b;
                if (a2Var != null) {
                    i10 = ((org.telegram.ui.ActionBar.o2) boVar4).currentAccount;
                    hg.b2.f(i10).k(a2Var.f10222a, str);
                }
                boVar4.Q3 = str;
                boVar4.f32215a1.setTitle(str);
                return;
            case 5:
                MessageObject messageObject2 = (MessageObject) obj2;
                Long l10 = (Long) obj;
                bo boVar5 = ((nn) obj3).f36134a;
                if (boVar5.f7()) {
                    SendMessagesHelper.SendMessageParams of2 = SendMessagesHelper.SendMessageParams.of(messageObject2.getDiceEmoji(), boVar5.T5, boVar5.f32381n5, boVar5.X3, null, false, null, null, null, true, 0, 0, null, false);
            ...
            case 6:
                ...
                bo boVar6 = ((nn) obj3).f36134a;
                if (((Boolean) obj).booleanValue()) {
                    while (i13 < boVar6.f32502x0.getChildCount()) {
                        View childAt = boVar6.f32502x0.getChildAt(i13);
            ...
            case 8:
                ...
                ((nn) obj3).f36134a.getMessagesController().rejectSuggestedMessage(DialogObject.getPeerDialogId(message.peer_id), message.f18142id, (String) obj);
                return;
            case 9:
                fo foVar = (fo) obj3;
                foVar.f33728f.t(((dg.a) obj).f7727b, ((TLRPC.WallPaper) obj2).settings.intensity);
                View view = foVar.f33726b;
                if (view != null) {
                    view.invalidate();
                    return;
                }
            ...
            case 10:
                Long l11 = (Long) obj;
                ChatActivityEnterView chatActivityEnterView = ((org.telegram.ui.Components.nf) obj3).f26449a;
            ...
            case 11:
                ...
                ((bo) obj3).f32295g5 = (MessageSuggestionParams) obj;
                boolean G1 = viVar.G1(0, true, 0, viVar.s1(), viVar.N0);
                org.telegram.ui.Components.kf kfVar = viVar.f28748h0;
                if (kfVar != null) {
                    kfVar.h(!G1);
                    viVar.f28748h0 = null;
                    return;
            ...
            case 12:
                ...
                return;
            case 13:
                org.telegram.ui.Components.gl glVar = ((org.telegram.ui.Components.dl) obj3).f23358b;
                glVar.f24337x0.b(((org.telegram.ui.Components.fl) obj2).f23957c, glVar.f24339y0, true, 0, ((Long) obj).longValue());
            ...
            case 16:
                ...
                org.telegram.ui.Components.jy jyVar = iyVar.f25047a;
                ...
                if (!SharedConfig.suggestAnimatedEmoji && !UserConfig.getInstance(kzVar.f25713c1).isPremium()) {
                    z10 = false;
                } else {
                    z10 = true;
                }
            ...
            case 17:
                ...
                org.telegram.ui.Components.jy jyVar2 = ((org.telegram.ui.Components.iy) obj3).f25047a;
                if (ConnectionsManager.getInstance(jyVar2.F.f25713c1).getConnectionState() != 3) {
                    runnable.run();
                    return;
                } else {
            ...
            case 18:
                ...
                while (i13 < size) {
                    ...
                    if (stickerSetCovered instanceof TLRPC.TL_stickerSetFullCovered) {
                        ...
                        TLRPC.TL_messages_stickerSet stickerSet = MediaDataController.getInstance(dzVar.f23412w.Q.f25713c1).getStickerSet(MediaDataController.getInputStickerSet(stickerSetCovered.set), Integer.valueOf(stickerSetCovered.set.hash), true);
                        if (stickerSet != null) {
                    ...
                    if (arrayList != null && !arrayList.isEmpty()) {
                        dzVar.f23409n.add(new org.telegram.ui.Components.cy(stickerSetCovered, arrayList));
                    }
                }
                runnable2.run();
                return;
            case 19:
                ...
                if (c10Var.f22869a0 == null && !(c10Var.Z instanceof TL_chatlists.TL_chatlists_chatlistInviteAlready)) {
                    org.telegram.ui.Components.oc M = org.telegram.ui.Components.vc.a0(o2Var).M(AndroidUtilities.replaceTags(LocaleController.formatString(R.string.FolderLinkAddedTitle, c10Var.f22874f0)), LocaleController.formatPluralString("FolderLinkAddedSubtitle", arrayList4.size(), new Object[0]), R.raw.contact_check);
                    M.f26702j = 5000;
                    M.j();
                    return;
                }
                ...
                SpannableStringBuilder replaceTags = AndroidUtilities.replaceTags(LocaleController.formatString(R.string.FolderLinkUpdatedTitle, c10Var.f22874f0));
                if (arrayList4.size() <= 0) {
                    formatPluralString = LocaleController.formatPluralString("FolderLinkUpdatedSubtitle", c10Var.f22876h0.size(), new Object[0]);
                } else {
            ...
            case 27:
                ...
                t50Var.f37656c = bitmap2;
                Paint paint = new Paint(1);
                t50Var.d = paint;
                Bitmap bitmap3 = t50Var.f37656c;
            ...
            default:
                ...
                ArrayList arrayList5 = tj0Var.f37811f0;
                arrayList5.clear();
                if (list != null) {
