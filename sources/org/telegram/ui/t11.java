...
public final class t11 extends org.telegram.ui.ActionBar.j {
    ...
    public final void b(int i10) {
        ...
        int i16;
        int i17;
        w11 w11Var = this.f37526b;
        long j3 = w11Var.f38745f;
        long j10 = w11Var.e;
        String str = this.f37525a;
        if (i10 == -1) {
            if (!w11Var.h && w11Var.f38746n) {
            ...
            if (w11Var.f38747r != null) {
                ...
                obj.f37744c = c10;
                if (c10 != 0) {
                    obj.f37742a = org.telegram.messenger.w1.c("notifyuntil_", str, notificationsSettings, 0);
                }
                w11Var.f38747r.v(obj);
            }
        }
