...
public final class qq0 extends su0 {
    ...
    @Override
    public final int H() {
        return this.f39999a.f34910b.size();
    }
    ...
    public final int Q(Object obj) {
        ...
        br0 br0Var = this.f39999a;
        if (!br0Var.f34910b.containsKey(obj2)) {
            return -1;
        }
        br0Var.f34910b.remove(obj2);
        int indexOf = br0Var.f34912c.indexOf(obj2);
        if (indexOf >= 0) {
            br0Var.f34912c.remove(indexOf);
        }
        if (br0Var.f34915e) {
            br0Var.h0();
        }
    ...
    public final void W(int i10) {
        ...
        if (V != null) {
            ...
            V.e((MediaController.SearchImage) br0Var.f34917f.get(i10));
        }
    }
    ...
    public final ArrayList c() {
        return this.f39999a.f34912c;
    }

    @Override
    public final ImageReceiver.BitmapHolder j(int i10) {
        org.telegram.ui.Cells.s5 V = br0.V(this.f39999a, i10);
        if (V != null) {
    ...
    public final int k(int i10, VideoEditedInfo videoEditedInfo) {
        ...
        if (albumEntry != null) {
            ...
            if (Y == -1) {
                ...
                Y = br0Var.f34912c.indexOf(Integer.valueOf(photoEntry.imageId));
                z10 = true;
            } else {
                photoEntry.editedInfo = null;
                z10 = false;
            }
        } else if (i10 < 0 || i10 >= br0Var.f34917f.size()) {
            return -1;
        } else {
            MediaController.SearchImage searchImage = (MediaController.SearchImage) br0Var.f34917f.get(i10);
            Y = br0Var.Y(-1, searchImage);
            if (Y == -1) {
                searchImage.editedInfo = videoEditedInfo;
                Y = br0Var.f34912c.indexOf(searchImage.f17101id);
                z10 = true;
            } else {
    ...
    public final void o(int i10, VideoEditedInfo videoEditedInfo, boolean z10, int i11, int i12, boolean z11) {
        br0 br0Var = this.f39999a;
        ArrayList arrayList = br0Var.f34917f;
        MediaController.AlbumEntry albumEntry = br0Var.J;
        if (br0Var.f34910b.isEmpty()) {
            if (albumEntry != null) {
                if (i10 >= 0 && i10 < albumEntry.photos.size()) {
                    MediaController.PhotoEntry photoEntry = albumEntry.photos.get(i10);
                    photoEntry.editedInfo = videoEditedInfo;
    ...
    public final boolean x(int i10) {
        ...
        MediaController.AlbumEntry albumEntry = br0Var.J;
        if (albumEntry != null) {
            if (i10 < 0 || i10 >= albumEntry.photos.size() || !br0Var.f34910b.containsKey(Integer.valueOf(br0Var.J.photos.get(i10).imageId))) {
                return false;
            }
            return true;
        } else if (i10 < 0 || i10 >= br0Var.f34917f.size() || !br0Var.f34910b.containsKey(((MediaController.SearchImage) br0Var.f34917f.get(i10)).f17101id)) {
            return false;
        } else {
            return true;
        }
