...
public final class qq0 implements org.telegram.ui.Cells.s5 {
    ...
    public final void a(org.telegram.ui.Cells.t5 t5Var) {
        ...
        tq0 tq0Var = this.f36972a.d;
        MediaController.AlbumEntry albumEntry = tq0Var.J;
        int i10 = -1;
        int i11 = 1;
        if (albumEntry != null) {
            MediaController.PhotoEntry photoEntry = albumEntry.photos.get(intValue);
            boolean containsKey = tq0Var.f38191b.containsKey(Integer.valueOf(photoEntry.imageId));
            z10 = !containsKey;
            if (!containsKey && tq0Var.H > 0 && tq0Var.f38191b.size() >= tq0Var.H) {
                b();
                return;
            }
            if (tq0Var.e && !containsKey) {
                i10 = tq0Var.f38193c.size();
            }
            t5Var.b(i10, z10, true);
            tq0Var.Y(intValue, photoEntry);
        } else {
            AndroidUtilities.hideKeyboard(tq0Var.getParentActivity().getCurrentFocus());
            MediaController.SearchImage searchImage = (MediaController.SearchImage) tq0Var.f38197f.get(intValue);
            boolean containsKey2 = tq0Var.f38191b.containsKey(searchImage.f15826id);
            z10 = !containsKey2;
            if (!containsKey2 && tq0Var.H > 0 && tq0Var.f38191b.size() >= tq0Var.H) {
                b();
                return;
            }
