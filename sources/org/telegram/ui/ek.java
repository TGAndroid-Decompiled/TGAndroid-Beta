...
public final class ek implements pt {
    ...
    @Override
    public final long a() {
        return this.f33824a.Q5;
    }

    @Override
    public final boolean b() {
        return this.f33824a.D6();
    }

    @Override
    public final boolean c() {
        if (this.f33824a.O3 == 1) {
            return true;
        }
        return false;
    }
    ...
    public final void m(TLRPC.Document document, String str, Object obj, boolean z4, int i10, int i11) {
        this.f33824a.V.d(document, str, obj, null, true, z4, i10, i11);
    }
