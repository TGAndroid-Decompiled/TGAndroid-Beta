        ...
        switch (this.f34803a) {
            case 0:
                if (LiteMode.isEnabled(65536) && org.telegram.ui.Components.w01.c()) {
                    co coVar = this.f34804b;
                    org.telegram.ui.Components.w01 w01Var = coVar.f35447v0;
                    if (w01Var == null || w01Var.f32055e) {
                        if (coVar.getParentActivity() != null && org.telegram.ui.Components.w01.c() && coVar.f35473x0 != null && coVar.X0 != null) {
                            org.telegram.ui.Components.w01 w01Var2 = coVar.f35447v0;
                            if (w01Var2 != null) {
                            ...
                            coVar.f35447v0 = w01Var3;
                            org.telegram.ui.Components.w01[] w01VarArr = {w01Var3};
                            um umVar = coVar.X0;
                            umVar.addView(w01Var3, umVar.indexOfChild(coVar.f35473x0) + 1, w7.x5.c(-1.0f, -1));
                        }
                    }
                    return coVar.f35447v0;
                }
                return null;
            default:
