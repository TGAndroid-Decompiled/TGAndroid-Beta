...
public final class uv0 implements org.telegram.ui.Components.ky {
    ...
    public final boolean k() {
        EditTextBoldCursor editField = this.f38170a.f31970b0.getEditField();
        if (editField == null) {
            return false;
        }
    ...
    public final void x(long j3, TLRPC.Document document, String str, boolean z10) {
        ...
        aw0 aw0Var = this.f38170a;
        EditTextBoldCursor editField = aw0Var.f31970b0.getEditField();
        if (editField == null) {
            return;
        }
        int selectionEnd = editField.getSelectionEnd();
        ...
        try {
            ...
            x5Var.cacheType = aw0Var.R.f25701c;
