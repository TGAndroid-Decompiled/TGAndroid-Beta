...
public final class uv0 implements Runnable {
    public final int f38563a = 1;
    public final dw0 f38564b;
        ...
        switch (this.f38563a) {
            case 0:
                ...
                if (!z10) {
                    ...
                    ArrayList<TLRPC.PollAnswer> arrayList = this.f38566f;
                ...
                return;
            default:
                dw0 dw0Var2 = this.f38564b;
                dw0Var2.getClass();
                boolean z11 = this.f38565c;
                ...
                if (!z11) {
                    ...
                    ArrayList<TLRPC.PollAnswer> arrayList3 = this.f38566f;
