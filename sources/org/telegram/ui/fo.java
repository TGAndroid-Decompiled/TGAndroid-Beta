...
public final class fo extends Drawable {
    ...
    public View f33638b;
    public int f33639c = 255;
    public final float d;
    public final ai.l4 e;
    public final org.telegram.ui.Components.cc0 f33640f;
    public final TLRPC.WallPaper f33641g;
    public boolean h;
    public boolean f33642i;
    public final ArrayList f33643j;
        ...
        if (wallPaper.document != null) {
            ...
            if (wallPaperSettings != null && wallPaperSettings.intensity >= 0) {
                if (wallPaperSettings.second_background_color == 0) {
                    ...
                    a2 = new BitmapDrawable(cc0Var.f23054k);
                }
            } else {
    ...
    public final Drawable c(boolean z10) {
        org.telegram.ui.Components.cc0 cc0Var = this.f33640f;
        if (cc0Var != null) {
            return cc0Var;
        }
        ai.l4 l4Var = this.e;
    ...
    public final void draw(Canvas canvas) {
        ...
        l4Var.setAlpha(this.f33639c / 255.0f);
        l4Var.draw(canvas);
        if (z10 && f7 != 0.0f) {
    ...
    public final void f(View view) {
        ArrayList arrayList = this.f33643j;
        if (!arrayList.contains(view)) {
            arrayList.add(view);
        }
        int size = arrayList.size();
        ai.l4 l4Var = this.e;
        if (size > 0 && !this.f33642i) {
            this.f33642i = true;
            l4Var.onAttachedToWindow();
        } else if (arrayList.size() <= 0 && this.f33642i) {
            this.f33642i = false;
