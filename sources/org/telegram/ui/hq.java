    ...
    public final void run() {
        ...
        switch (i10) {
            case 0:
                ...
                i12.putLong("chat_id", pqVar.f36662w.f18109id);
                ...
                if (org.telegram.ui.Components.vc.a(boVar)) {
                    ...
                    if (z10 && pqVar.K) {
                        ...
                        org.telegram.ui.Components.wb wbVar = new org.telegram.ui.Components.wb(boVar.getParentActivity(), boVar.f32293ea);
                        wbVar.d(R.raw.ic_admin, "Shield");
                        wbVar.f29679b.setText(AndroidUtilities.replaceTags(LocaleController.formatString("UserAddedAsAdminHint", R.string.UserAddedAsAdminHint, str)));
            ...
            default:
                if (pqVar.f36655r) {
                    long j3 = pqVar.f36650n;
                    org.telegram.ui.ActionBar.b2[] b2VarArr = {new org.telegram.ui.ActionBar.b2(pqVar.getParentActivity(), 3, null)};
                    pqVar.getMessagesController().toggleChatJoinRequest(pqVar.f36657s, j3, true, false, true, new xg(b2VarArr, 2), new xg(b2VarArr, 3));
                    b2VarArr[0].q(300L);
                }
                mq mqVar2 = pqVar.X0;
                if (mqVar2 != null) {
