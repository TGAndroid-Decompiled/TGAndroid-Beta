...
public final class y40 extends AnimatorListenerAdapter {
    ...
    public final void onAnimationEnd(Animator animator) {
        ...
        switch (this.f43536a) {
            case 0:
                d60 d60Var = this.f43537b;
                d60Var.S.setVisibility(4);
                d60Var.T.setVisibility(4);
                d60Var.R.setVisibility(4);
                return;
            case 1:
                this.f43537b.f36007e0 = null;
                return;
            default:
                d60 d60Var2 = this.f43537b;
                d60Var2.f36008e1 = null;
                Paint paint = d60Var2.f36003d1;
                if (d60Var2.Q1 == 3) {
                    i10 = -1163700;
                } else {
                    i10 = -12761513;
