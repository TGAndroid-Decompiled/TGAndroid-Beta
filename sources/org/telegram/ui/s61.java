...
public final class s61 extends org.telegram.ui.Components.ll0 {
    ...
    public int d;
    public int h;
    public final i71 f37395s;
    public int e = -1;
    public int f37392f = -1;
    public int f37393n = 1;
    public final ArrayList f37394r = new ArrayList();
    ...
    public final void E(boolean z10) {
        i71 i71Var = this.f37395s;
        int i10 = i71Var.W;
        boolean z11 = i71Var.I;
        ArrayList arrayList = this.f37394r;
        ...
        if (i10 == 14) {
            ...
            if (arrayList3 != null && !arrayList3.isEmpty()) {
                int i13 = this.f37393n;
                this.f37393n = i13 + 1;
                this.f37392f = i13;
                arrayList.add(2);
                this.f37391c = this.f37393n;
        ...
        if (arrayList5 != null) {
            int i17 = this.f37393n;
            this.h = i17;
            this.f37393n = arrayList5.size() + i17;
        }
        l();
        if (i71Var.f34500y1 && this.f37393n == 0) {
            z12 = true;
        }
        if (i71Var.G1 != z12) {
            i71Var.G1 = z12;
            ...
            i71Var.H1.start();
            if (z12) {
                i71.D(i71Var.V, i71Var.f34469l0);
            }
        }
    }
    ...
    public final int j(int i10) {
        int i11;
        if (i10 == this.e || i10 == this.f37392f) {
            return 6;
        }
        i71 i71Var = this.f37395s;
        if (i71Var.W == 14) {
            ArrayList arrayList = i71Var.B1;
            if (arrayList != null && i10 >= (i11 = this.f37391c) && i10 - i11 < arrayList.size()) {
                return 4;
            }
        } else {
        ...
        int i13 = this.d;
        if (i10 > i13 && (i10 - i13) - 1 < arrayList2.size() && (i71Var.W == 13 || ((zg.p0) i71Var.A1.get((i10 - this.d) - 1)).f49151g != 0)) {
            return 3;
        }
        int i14 = this.h;
        ...
        if (i16 == 6) {
            ...
            if (arrayList != null && (i13 = i10 - this.h) >= 0 && i13 < arrayList.size()) {
                ...
                if (document2 instanceof f71) {
                    CharSequence charSequence = ((f71) document2).f33569a;
                    String str = i71Var.f34502z1;
                    n61Var.getClass();
                    if (charSequence != null && str != null && (indexOf = charSequence.toString().toLowerCase().indexOf(str.toLowerCase())) >= 0) {
                        SpannableString spannableString = new SpannableString(charSequence);
                        spannableString.setSpan(new ForegroundColorSpan(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Ue, n61Var.f35953f.Z0)), indexOf, str.length() + indexOf, 33);
                        charSequence = spannableString;
                    }
                    n61Var.f35950a.setText(charSequence);
                    n61Var.b(false);
                }
            } else if (i10 == this.e) {
            ...
            n61Var.f35952c.setVisibility(8);
        } else if (i16 == 5) {
            TLRPC.Document document3 = (TLRPC.Document) i71Var.C1.get((i10 - this.f37391c) - 1);
            r61 r61Var = (r61) view;
            r61Var.a(v51Var);
            r61Var.h.setImage(ImageLocation.getForDocument(document3), "100_100_firstframe", null, null, DocumentObject.getSvgThumb(document3, org.telegram.ui.ActionBar.j6.f19027m6, 0.2f), 0L, "tgs", document3, 0);
            r61Var.Q = true;
            r61Var.d = document3;
            r61Var.e = null;
        } else if (i16 == 4) {
            ...
            r61Var2.f37095c = i10;
            ImageReceiver imageReceiver = r61Var2.f37097n;
            ArrayList arrayList2 = i71Var.A1;
            if (arrayList2 != null && i10 >= 0 && i10 < arrayList2.size()) {
                p0Var = (zg.p0) i71Var.A1.get(i10);
            } else {
                ArrayList arrayList3 = i71Var.B1;
                if (arrayList3 != null && i10 >= (i12 = this.f37391c) && i10 - i12 < arrayList3.size()) {
                    p0Var = (zg.p0) i71Var.B1.get(i10 - this.f37391c);
                } else {
                    return;
                }
            }
            ...
            r61Var2.f37101x = p0Var;
            r61Var2.f37102y = false;
            r61Var2.d(i71Var.J.contains(p0Var), false);
            r61Var2.f37094b = false;
            r61Var2.invalidate();
            if (i14 == 13) {
                r61Var2.setDrawable(Emoji.getEmojiDrawable(p0Var.f49150f));
            } else if (!p0Var.f49148b && p0Var.f49150f != null) {
                r61Var2.f37099s = true;
                TLRPC.TL_availableReaction tL_availableReaction = MediaDataController.getInstance(i15).getReactionsMap().get(p0Var.f49150f);
                if (tL_availableReaction != null) {
                    SvgHelper.SvgDrawable svgThumb = DocumentObject.getSvgThumb(tL_availableReaction.activate_animation, org.telegram.ui.ActionBar.j6.f19027m6, 0.2f);
                ...
                if (tL_availableReaction == null && p0Var.f49148b) {
                    r61Var2.setDrawable(Emoji.getEmojiDrawable(p0Var.f49150f));
                }
            } else {
                r61Var2.f37099s = false;
                r61Var2.e = new org.telegram.ui.Components.x5(p0Var.f49151g, (Paint.FontMetricsInt) null);
                r61Var2.d = null;
                r61Var2.h.clearImage();
                imageReceiver.clearImage();
                org.telegram.ui.Components.o5 o5Var = (org.telegram.ui.Components.o5) v51Var.f35122d3.get(r61Var2.e.getDocumentId());
                if (o5Var == null) {
                    cacheType2 = i71Var.getCacheType();
                    o5Var = org.telegram.ui.Components.o5.n(i15, r61Var2.e.getDocumentId(), null, cacheType2);
                    v51Var.f35122d3.put(r61Var2.e.getDocumentId(), o5Var);
                }
                r61Var2.setDrawable(o5Var);
            }
            if (!UserConfig.getInstance(i15).isPremium() && i14 == 14 && p0Var.f49148b && p0Var.d) {
                r61Var2.b();
            ...
            if (p0Var.e) {
                r61Var2.setEmojicon(p0Var.f49150f);
            } else {
                r61Var2.setEmojicon(null);
            }
            ...
            if (arrayList4 != null && i10 >= 0 && i10 < arrayList4.size()) {
                ...
                r61Var3.f37101x = p0Var3;
                long j3 = p0Var3.f49151g;
                if (j3 == 0) {
                    boolean contains2 = i71Var.J.contains(p0Var3);
                    r61Var3.f37102y = true;
                    r61Var3.setDrawable(Emoji.getEmojiDrawable(p0Var3.f49150f));
                    r61Var3.d(contains2, false);
                    return;
                }
                l4 = Long.valueOf(j3);
                if (i14 == 14 && !UserConfig.getInstance(i15).isPremium() && p0Var3.f49148b && p0Var3.d) {
                    r61Var3.b();
            ...
            if (l4 == null && document == null) {
                ...
                org.telegram.ui.Components.o5 o5Var2 = (org.telegram.ui.Components.o5) v51Var.f35122d3.get(r61Var3.e.getDocumentId());
                if (o5Var2 == null) {
                    cacheType = i71Var.getCacheType();
                    o5Var2 = org.telegram.ui.Components.o5.n(i15, r61Var3.e.getDocumentId(), null, cacheType);
                    v51Var.f35122d3.put(r61Var3.e.getDocumentId(), o5Var2);
                }
