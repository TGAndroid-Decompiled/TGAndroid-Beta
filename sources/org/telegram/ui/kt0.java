...
public final class kt0 extends org.telegram.ui.Components.u00 {
    public final ss0 f38127e;
    public final PhotoViewer f38128f;

    public kt0(PhotoViewer photoViewer, ss0 ss0Var) {
        super(false);
        this.f38128f = photoViewer;
        this.f38127e = ss0Var;
    }
    ...
    public final CharSequence d() {
        ...
        PhotoViewer photoViewer = this.f38128f;
        int[] iArr = photoViewer.f33620m3;
        ...
        int[] iArr2 = photoViewer.f33630n3;
    ...
    public final float k() {
        return this.f38128f.f33656q3.c();
    }
