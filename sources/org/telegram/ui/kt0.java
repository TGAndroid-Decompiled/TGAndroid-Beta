...
public final class kt0 extends VideoPlayerRewinder {
    public final PhotoViewer f35172a;

    public kt0(PhotoViewer photoViewer, VideoFramesRewinder videoFramesRewinder) {
        super(videoFramesRewinder);
        this.f35172a = photoViewer;
    }

    @Override
    public final void onRewindCanceled() {
        MotionEvent obtain = MotionEvent.obtain(0L, 0L, 3, 0.0f, 0.0f, 0);
        PhotoViewer photoViewer = this.f35172a;
        PhotoViewer.k(photoViewer, obtain);
        photoViewer.f31369z1.f(false);
        org.telegram.ui.Components.pg0.f27209p0.Q.f(false);
    }

    @Override
    public final void onRewindStart(boolean z10) {
        PhotoViewer photoViewer = this.f35172a;
        photoViewer.f31369z1.e(false);
        photoViewer.f31369z1.d(!z10);
        photoViewer.f31369z1.f(true);
    ...
    public final void updateRewindProgressUi(long j3, float f7, boolean z10) {
        PhotoViewer photoViewer = this.f35172a;
        photoViewer.f31369z1.g(Math.abs(j3));
        if (z10) {
