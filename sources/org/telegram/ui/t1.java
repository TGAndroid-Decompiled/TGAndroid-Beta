...
public final class t1 extends FrameLayout implements org.telegram.ui.Cells.p9 {
    public final s1 f37909a;
    public final org.telegram.ui.Components.o91 f37910b;
    public b3 f37911c;
    public b3 d;
    public int e;
    public int f37912f;
    ...
    public final g4 f37916w;
    public final i4 f37917x;
    ...
    public final void a(boolean z10) {
        ...
        this.v = null;
        org.telegram.ui.Components.o91 o91Var = this.f37910b;
        if (o91Var != null) {
            o91Var.b();
        }
    }
    ...
    public final void onDraw(Canvas canvas) {
        if (this.v != null) {
            b3 b3Var = this.f37911c;
            i4 i4Var = this.f37917x;
            int i10 = 0;
            if (b3Var != null) {
                canvas.save();
                canvas.translate(this.e, this.f37912f);
                i4.v(i4Var, canvas, this, 0);
                this.f37911c.draw(canvas, this);
                canvas.restore();
                i10 = 1;
            }
            if (this.d != null) {
                canvas.save();
                canvas.translate(this.e, this.f37912f + this.h);
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (this.f37911c != null) {
            sb2.append(", ");
            sb2.append(this.f37911c.d.getText());
        }
        if (this.d != null) {
            sb2.append(", ");
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        b3 b3Var = this.f37911c;
        int i10 = this.e;
        int i11 = this.f37912f;
        i4 i4Var = this.f37917x;
        if (!i4.l(i4Var, this.f37916w, motionEvent, this, b3Var, i10, i11)) {
            if (!i4.l(i4Var, this.f37916w, motionEvent, this, this.d, this.e, this.f37912f + this.h) && !super.onTouchEvent(motionEvent)) {
                return false;
            }
            return true;
        }
