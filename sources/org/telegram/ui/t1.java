...
public final class t1 extends FrameLayout implements org.telegram.ui.Cells.q9 {
    public final s1 f37495a;
    public final org.telegram.ui.Components.b91 f37496b;
    public b3 f37497c;
    public b3 d;
    public int e;
    public int f37498f;
    ...
    public final g4 f37502w;
    public final i4 f37503x;
    ...
    public final void a(boolean z10) {
        ...
        this.v = null;
        org.telegram.ui.Components.b91 b91Var = this.f37496b;
        if (b91Var != null) {
            b91Var.b();
        }
    }
    ...
    public final void onDraw(Canvas canvas) {
        if (this.v != null) {
            b3 b3Var = this.f37497c;
            i4 i4Var = this.f37503x;
            int i10 = 0;
            if (b3Var != null) {
                canvas.save();
                canvas.translate(this.e, this.f37498f);
                i4.v(i4Var, canvas, this, 0);
                this.f37497c.draw(canvas, this);
                canvas.restore();
                i10 = 1;
            }
            if (this.d != null) {
                canvas.save();
                canvas.translate(this.e, this.f37498f + this.h);
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (this.f37497c != null) {
            sb2.append(", ");
            sb2.append(this.f37497c.d.getText());
        }
        if (this.d != null) {
            sb2.append(", ");
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        i4 i4Var = this.f37503x;
        if (!i4.l(i4Var, this.f37502w, motionEvent, this, b3Var, i10, i11)) {
            if (!i4.l(i4Var, this.f37502w, motionEvent, this, this.d, this.e, this.f37498f + this.h) && !super.onTouchEvent(motionEvent)) {
                return false;
            }
            return true;
        }
