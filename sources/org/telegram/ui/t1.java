...
public final class t1 extends FrameLayout implements org.telegram.ui.Cells.p9 {
    public final s1 f37892a;
    public final org.telegram.ui.Components.o91 f37893b;
    public b3 f37894c;
    public b3 d;
    public int e;
    public int f37895f;
    ...
    public int f37896n;
    public int f37897r;
    public boolean f37898s;
    public TL_iv.pageBlockEmbed v;
    public final g4 f37899w;
    public final i4 f37900x;
    ...
    public final void a(boolean z10) {
        ...
        this.v = null;
        org.telegram.ui.Components.o91 o91Var = this.f37893b;
        if (o91Var != null) {
            o91Var.b();
        }
    }
    ...
    public final void onDraw(Canvas canvas) {
        if (this.v != null) {
            b3 b3Var = this.f37894c;
            i4 i4Var = this.f37900x;
            int i10 = 0;
            if (b3Var != null) {
                canvas.save();
                canvas.translate(this.e, this.f37895f);
                i4.v(i4Var, canvas, this, 0);
                this.f37894c.draw(canvas, this);
                canvas.restore();
                i10 = 1;
            }
            if (this.d != null) {
                canvas.save();
                canvas.translate(this.e, this.f37895f + this.h);
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (this.f37894c != null) {
            sb2.append(", ");
            sb2.append(this.f37894c.d.getText());
        }
        if (this.d != null) {
            sb2.append(", ");
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        i4 i4Var = this.f37900x;
        if (!i4.l(i4Var, this.f37899w, motionEvent, this, b3Var, i10, i11)) {
            if (!i4.l(i4Var, this.f37899w, motionEvent, this, this.d, this.e, this.f37895f + this.h) && !super.onTouchEvent(motionEvent)) {
                return false;
            }
            return true;
        }
