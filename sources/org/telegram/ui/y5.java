...
public final class y5 extends pg.b {
    ...
    @Override
    public final int h() {
        return this.d.f34341c.size();
    }

    @Override
    public final int j(int i10) {
        return ((z5) this.d.f34341c.get(i10)).f44072a;
    }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (((z5) arrayList.get(i10)).f44072a == 2) {
            org.telegram.ui.Cells.za zaVar = (org.telegram.ui.Cells.za) c1Var.f45739a;
            ...
            if (i10 != arrayList.size() - 1 && ((z5) arrayList.get(i10 + 1)).f44072a != 2) {
                z10 = false;
            }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 != 1) {
            if (i10 != 2) {
                ...
                zaVar.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20664d6, false));
                view = zaVar;
            }
