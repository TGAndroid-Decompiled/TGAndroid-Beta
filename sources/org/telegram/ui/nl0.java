...
public final class nl0 implements org.telegram.ui.ActionBar.b2, Utilities.Callback5, org.telegram.ui.Cells.w5, org.telegram.ui.Components.u61, org.telegram.ui.ActionBar.n1, r0.n, Utilities.Callback2Return, org.telegram.ui.Cells.z4, LanguageDetector.ExceptionCallback, RequestTimeDelegate, org.telegram.ui.ActionBar.n2, org.telegram.ui.Components.cl0, ig.e, gg.b2 {
    ...
    public r0.l1 Q0(View view, r0.l1 l1Var) {
        ...
        switch (this.f36130a) {
            case 9:
                PremiumPreviewFragment premiumPreviewFragment = (PremiumPreviewFragment) this.f36131b;
                i0.b defaultWindowInsets = AndroidUtilities.getDefaultWindowInsets(l1Var, false);
                premiumPreviewFragment.f31190o0 = defaultWindowInsets;
                premiumPreviewFragment.f31172a.setPadding(0, defaultWindowInsets.f10592b, 0, AndroidUtilities.dp(48.0f) + premiumPreviewFragment.f31190o0.d);
                org.telegram.ui.Components.ml0 ml0Var = premiumPreviewFragment.f31172a;
                i0.b bVar = premiumPreviewFragment.f31190o0;
                AndroidUtilities.setViewLayoutMargins(ml0Var, bVar.f10591a, 0, bVar.f10593c, 0);
                lx0 lx0Var = premiumPreviewFragment.U;
                i0.b bVar2 = premiumPreviewFragment.f31190o0;
                lx0Var.setPadding(bVar2.f10591a, 0, bVar2.f10593c, 0);
                FrameLayout frameLayout = premiumPreviewFragment.J;
                if (frameLayout != null) {
                    int i12 = premiumPreviewFragment.f31190o0.f10591a;
                    int dp = AndroidUtilities.dp(14.0f);
                    i0.b bVar3 = premiumPreviewFragment.f31190o0;
                    frameLayout.setPadding(i12, dp, bVar3.f10593c, bVar3.d);
                }
                return r0.l1.f41881b;
            default:
                gh0 gh0Var = (gh0) ((ai1) this.f36131b);
                ...
                View view2 = gh0Var.f33982y.f35289b;
                ...
                gh0Var.f33982y.setPadding(0, 0, 0, gh0Var.L);
                ...
                ViewGroup.MarginLayoutParams marginLayoutParams2 = (ViewGroup.MarginLayoutParams) gh0Var.f31904c.getLayoutParams();
                if (marginLayoutParams2.bottomMargin != i11 || marginLayoutParams2.leftMargin != i13 || marginLayoutParams2.rightMargin != i14) {
                    ...
                    gh0Var.f31904c.setLayoutParams(marginLayoutParams2);
                }
                gh0Var.E.setPadding(i13, 0, i14, gh0Var.L);
                if (z10) {
                    l1Var = l1Var.f41882a.m(0, 0, 0, gh0Var.L);
                }
                gh0Var.i0();
                gh0Var.h0();
                SparseArray sparseArray = gh0Var.f31902a;
                int size = sparseArray.size();
                for (int i15 = 0; i15 < size; i15++) {
                    yh1 yh1Var = (yh1) sparseArray.valueAt(i15);
                    if (yh1Var != null && (fragmentView = yh1Var.f39923a.getFragmentView()) != null) {
    ...
    public void b(org.telegram.ui.Components.vz vzVar) {
        ...
        vzVar.f(new org.telegram.ui.Components.wz((MediaController.SavedFilterState) this.f36131b));
    }

    @Override
    public boolean c(org.telegram.ui.Cells.a5 a5Var, boolean z10) {
        hy0 hy0Var = (hy0) this.f36131b;
        if (z10) {
    ...
    public boolean d(int i10, View view) {
        switch (this.f36130a) {
            case 18:
                return ((v71) this.f36131b).Q(i10, view);
            case 19:
                final ab1 ab1Var = (ab1) this.f36131b;
                org.telegram.ui.ActionBar.c2[] c2VarArr = ab1Var.f31797h0;
                fa1 fa1Var = ab1Var.X;
                int i11 = fa1Var.I;
                if (i10 >= i11 && i10 <= fa1Var.J) {
                    final MessageObject messageObject = ((xa1) ab1Var.f31813v0.get(i10 - i11)).f39511b;
                        ...
                        public final void run() {
                            switch (r3) {
                                ...
                                default:
                                    ...
                                    bundle.putLong("chat_id", ab1Var3.f31788b);
                    ...
                    if (i10 >= i12 && i10 <= fa1Var.V) {
                        ((ta1) ab1Var.Q.get(i10 - i12)).c(ab1Var.f31786a, ab1Var, c2VarArr, true);
                    } else {
                        int i13 = fa1Var.R;
                        if (i10 >= i13 && i10 <= fa1Var.S) {
                            ((ta1) ab1Var.O.get(i10 - i13)).c(ab1Var.f31786a, ab1Var, c2VarArr, true);
                        } else {
                            int i14 = fa1Var.X;
                            if (i10 < i14 || i10 > fa1Var.Y) {
                                return false;
                            }
                            ((ta1) ab1Var.P.get(i10 - i14)).c(ab1Var.f31786a, ab1Var, c2VarArr, true);
                        }
                    }
                }
                return true;
            default:
                ((ue1) this.f36131b).J.d(i10, view);
                return true;
        }
    }
    ...
    public void f(org.telegram.ui.ActionBar.c2 c2Var, int i10) {
        ...
        switch (this.f36130a) {
            case 0:
                PasscodeActivity passcodeActivity = (PasscodeActivity) this.f36131b;
                passcodeActivity.getClass();
                SharedConfig.passcodeHash = "";
                SharedConfig.appLocked = false;
                SharedConfig.saveConfig();
                passcodeActivity.getMediaDataController().buildShortcuts();
                int childCount = passcodeActivity.f30903c.getChildCount();
                int i14 = 0;
                while (true) {
                    if (i14 < childCount) {
                        View childAt = passcodeActivity.f30903c.getChildAt(i14);
                ...
                return;
            case 4:
                PhotoViewer photoViewer = ((st0) this.f36131b).f37553b;
                try {
                    AndroidUtilities.openForView(photoViewer.T4, photoViewer.f31132y, photoViewer.f31105v2, true);
            ...
            case 5:
                ((cw0) this.f36131b).finishFragment();
                return;
            case 6:
                ((wv0) this.f36131b).f39183a.R.r();
                return;
            case 8:
                PopupNotificationActivity popupNotificationActivity = (PopupNotificationActivity) this.f36131b;
            ...
            case 12:
                ((org.telegram.messenger.nk) this.f36131b).run(1);
                return;
            case 15:
                ProxyListActivity proxyListActivity = ((f21) this.f36131b).f33526b;
                ...
                return;
            case 21:
                ThemeActivity themeActivity = ((wb1) this.f36131b).f38684a;
                ...
                if (k02) {
                    ...
                    hc1 hc1Var2 = themeActivity.f31566a;
                    i13 = themeActivity.bubbleRadiusRow;
                    hc1Var2.n(i13, new Object());
                }
                if (themeActivity.f31570c != null) {
                    ...
                    SparseArray sparseArray = N0.f18758a0;
                    int i18 = org.telegram.ui.ActionBar.j6.f19041n;
                    ...
                    if (h6Var != null) {
                        ...
                        c6Var.f18540c = "d";
                        c6Var.f18538a = "Blue_99_wp.jpg";
                        c6Var.f18539b = "Blue_99_wp.jpg";
                        h6Var.f18741y = c6Var;
                        N0.v(c6Var);
                    }
                    if (N0 != A0) {
                ...
                return;
            case 22:
                xd1 xd1Var = ((ad1) this.f36131b).f31838a;
                org.telegram.ui.ActionBar.j6.j0(xd1Var.f39550e0, xd1Var.f39585s, true);
                org.telegram.ui.ActionBar.j6.o();
                org.telegram.ui.ActionBar.j6.n1(false, false);
                NotificationCenter.getGlobalInstance().lambda$postNotificationNameOnUIThread$1(NotificationCenter.needSetDayNightTheme, xd1Var.f39550e0, Boolean.valueOf(xd1Var.f39554f0), null, -1);
                xd1Var.finishFragment();
                return;
            default:
                ((gh1) this.f36131b).f33983a.E0(true);
                return;
        }
    }
    ...
    public void h(int i10) {
        wh1 wh1Var = (wh1) this.f36131b;
        if (wh1Var.h == null && !wh1Var.f39042f.e()) {
            wh1Var.v.f31628f.e(false, true);
        }
        wh1Var.l();
    }
    ...
    public void mo17run(Object obj, Object obj2, Object obj3, Object obj4, Object obj5) {
        switch (this.f36130a) {
            case 1:
                ...
                ((Float) obj4).getClass();
                ((Float) obj5).getClass();
                PasskeysActivity.W((PasskeysActivity) this.f36131b, (org.telegram.ui.Components.j51) obj, (View) obj2);
                return;
            default:
                c41 c41Var = (c41) this.f36131b;
                ...
                if (j51Var.f15543a == 30) {
                    ...
                    d41.H(d41Var, j51Var.f25127l, null, null);
                    return;
                }
                return;
        }
    ...
    public void run(long j3) {
        AndroidUtilities.runOnUIThread(new org.telegram.messenger.rh((SharedConfig.ProxyInfo) this.f36131b, j3, 1));
    }

    @Override
    public Object run(Object obj, Object obj2) {
        Integer num = (Integer) obj2;
        PrivacyControlActivity privacyControlActivity = ((ay0) this.f36131b).d;
        if (((Integer) obj).intValue() == 0) {
            if (!privacyControlActivity.getUserConfig().isPremium()) {
                if (privacyControlActivity.f31241z0 == null) {
                    ...
                    privacyControlActivity.f31241z0 = spannableString;
                }
                SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder();
                spannableStringBuilder.append((CharSequence) privacyControlActivity.f31241z0);
