...
public final class u21 implements t9 {
    public final int f37834a;
    public final org.telegram.ui.ActionBar.n2 f37835b;
    ...
    public final void K(String str) {
        ...
        if (!TextUtils.isEmpty(b10)) {
            MessagesController.getInstance(this.f37834a).getUserNameResolver().resolve(b10, new xb(this.f37835b, 4));
        } else {
