...
public final class u21 implements org.telegram.ui.ActionBar.i6 {
    public boolean f38299a = false;
    public final v21 f38300b;
    ...
    public final void a(float f7) {
        ArrayList arrayList;
        v21 v21Var = this.f38300b;
        if (f7 == 0.0f && !this.f38299a) {
            ...
            if (lpVar != null && (arrayList = lpVar.d) != null) {
                ...
                while (i10 < size) {
                    ...
                    i10++;
                    ((org.telegram.ui.Components.mp) obj).f26566c = v21Var.M ? 1 : 0;
                }
            }
            if (!v21Var.Q) {
                org.telegram.ui.Components.lp lpVar2 = v21Var.f38609b;
