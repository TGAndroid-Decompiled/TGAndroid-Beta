...
public class l11 extends org.telegram.ui.Components.kl0 {
    ...
    public boolean F;
    public k11[] f38193c;
    public final org.telegram.ui.ActionBar.n2 f38194e;
    public final int f38195f;
    public final Context h;
    public boolean f38199w;
    public rx0 f38200x;
    public String f38201y;
    public final ArrayList d = new ArrayList();
    public ArrayList f38196n = new ArrayList();
    public ArrayList f38197r = new ArrayList();
    public ArrayList f38198s = new ArrayList();
    public final ArrayList v = new ArrayList();

    public l11(Context context, org.telegram.ui.ActionBar.n2 n2Var) {
        this.f38194e = n2Var;
        this.f38195f = n2Var.getCurrentAccount();
        this.h = context;
        this.f38193c = H(n2Var);
        J();
    }
            ...
            public final void run() {
                switch (r1) {
                    ...
                    case 11:
                        ...
                        int i10 = 0;
                        while (true) {
                            ArrayList arrayList = nc0Var10.f38951s;
                            if (i10 < arrayList.size()) {
                                if (((hc0) arrayList.get(i10)).f36979f == 1) {
                                    nc0Var10.f38945b.d1(new i2.t(nc0Var10, i10, 12), 700, true);
                                    return;
                                }
                                i10++;
                            } else {
                ...
                switch (r2) {
                    ...
                    default:
                        ...
                        if (!isPremium) {
                            ...
                            ybVar.f32904b.setText(spannableStringBuilder);
    ...
    public final void I(String str) {
        ...
        if (this.f38200x != null) {
            Utilities.searchQueue.cancelRunnable(this.f38200x);
            this.f38200x = null;
        }
        if (TextUtils.isEmpty(str)) {
            ...
            this.f38198s.clear();
            this.f38196n.clear();
            org.telegram.ui.ActionBar.n2 n2Var = this.f38194e;
            if (n2Var instanceof ProfileActivity) {
                try {
                    ((ProfileActivity) n2Var).P.f32781b.getImageReceiver().startAnimation();
                    ((ProfileActivity) this.f38194e).P.d.setText(LocaleController.getString(R.string.SettingsNoRecent));
                } catch (Exception e7) {
                    FileLog.e(e7);
                }
            }
    ...
    public final void J() {
        ...
        int i10 = 0;
        while (true) {
            k11[] k11VarArr = this.f38193c;
            if (i10 >= k11VarArr.length) {
                break;
            }
            k11 k11Var2 = k11VarArr[i10];
            if (k11Var2 != null) {
                hashMap.put(Integer.valueOf(k11Var2.f37920f), this.f38193c[i10]);
            }
            i10++;
        }
    ...
    public final int h() {
        ...
        int i10 = 0;
        if (this.f38199w) {
            int size2 = this.f38197r.size();
            if (!this.f38198s.isEmpty()) {
                i10 = this.f38198s.size() + 1;
            }
            return size2 + i10;
        }
        ArrayList arrayList = this.v;
    ...
    public final int j(int i10) {
        if (this.f38199w) {
            if (i10 < this.f38197r.size() || i10 != this.f38197r.size()) {
                return 0;
            }
        } else {
            ArrayList arrayList = this.v;
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        boolean z11 = false;
        if (this.f38199w) {
            if (i10 < this.f38197r.size()) {
                k11 k11Var2 = (k11) this.f38197r.get(i10);
                if (i10 > 0) {
                    k11Var = (k11) this.f38197r.get(i10 - 1);
                } else {
                    k11Var = null;
                }
                if (k11Var != null && k11Var.f37919e == k11Var2.f37919e) {
                    i11 = 0;
                } else {
                    i11 = k11Var2.f37919e;
                }
                CharSequence charSequence = (CharSequence) this.f38196n.get(i10);
                String[] strArr = k11Var2.d;
                if (i10 >= this.f38197r.size() - 1) {
                    z10 = false;
                }
                x6Var.b(charSequence, strArr, i11, z10);
                return;
            }
            int f7 = com.google.android.gms.internal.vision.e2.f(1, i10, this.f38197r);
            CharSequence charSequence2 = (CharSequence) this.f38196n.get(this.f38197r.size() + f7);
            String[] strArr2 = ((MessagesController.FaqSearchResult) this.f38198s.get(f7)).path;
            if (f7 < this.f38197r.size() - 1) {
                z11 = true;
            }
