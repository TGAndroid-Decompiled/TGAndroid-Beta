...
public final class za1 extends org.telegram.ui.Components.u51 {
    ...
    public org.telegram.ui.Cells.s7 f40416a;
    ...
    public final View createView(Context context, org.telegram.ui.Components.wl0 wl0Var, int i10, int i11, org.telegram.ui.ActionBar.d6 d6Var) {
        if (this.f40416a == null) {
            this.f40416a = new org.telegram.ui.Cells.s7(context, d6Var);
        }
        org.telegram.ui.Cells.t7 t7Var = new org.telegram.ui.Cells.t7(context, this.f40416a, i10);
        t7Var.f21225w0 = true;
        t7Var.f21202d0 = true;
        return t7Var;
    }
    ...
    public final boolean equals(org.telegram.ui.Components.v51 v51Var, org.telegram.ui.Components.v51 v51Var2) {
        if (v51Var.f29047q == v51Var2.f29047q && v51Var.e == v51Var2.e && v51Var.B == v51Var2.B) {
            return true;
        }
        return false;
    }
