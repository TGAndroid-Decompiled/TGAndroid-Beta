...
public final class i9 extends FrameLayout {
    ...
    public final TextView f34470a;
    public final TextView f34471b;
    public final View f34472c;
    ...
    public i9(l9 l9Var, Context context, org.telegram.ui.Components.t00 t00Var) {
        ...
        textView2.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19045c7, false));
    ...
    public final void a() {
        ...
        this.f34470a.animate().alpha(0.0f).setDuration(150L).start();
        this.f34471b.animate().alpha(0.0f).setDuration(150L).start();
        this.f34472c.animate().alpha(1.0f).setDuration(150L).start();
    }

    public final void b() {
        org.telegram.ui.Components.lj0 lj0Var = this.d;
        lj0Var.animate().alpha(1.0f).setDuration(150L).start();
        this.f34470a.animate().alpha(1.0f).setDuration(150L).start();
        this.f34471b.animate().alpha(1.0f).setDuration(150L).start();
        this.f34472c.animate().alpha(0.0f).setDuration(150L).start();
        lj0Var.d();
    }
