...
public final class i9 extends FrameLayout {
    ...
    public final TextView f34497a;
    public final TextView f34498b;
    ...
    public i9(l9 l9Var, Context context, org.telegram.ui.Components.t00 t00Var) {
        ...
        textView2.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19077c7, false));
    ...
    public final void a() {
        ...
        this.f34497a.animate().alpha(0.0f).setDuration(150L).start();
        this.f34498b.animate().alpha(0.0f).setDuration(150L).start();
        this.f34499c.animate().alpha(1.0f).setDuration(150L).start();
    }

    public final void b() {
        org.telegram.ui.Components.kj0 kj0Var = this.d;
        kj0Var.animate().alpha(1.0f).setDuration(150L).start();
        this.f34497a.animate().alpha(1.0f).setDuration(150L).start();
        this.f34498b.animate().alpha(1.0f).setDuration(150L).start();
        this.f34499c.animate().alpha(0.0f).setDuration(150L).start();
        kj0Var.d();
    }
