...
public final class sd1 implements TextWatcher {
    ...
    public final void afterTextChanged(Editable editable) {
        td1 td1Var = this.f37701a;
        if (td1Var.I) {
            return;
        }
        if (td1Var.f38036a.length() > 0) {
            String str = "https://" + td1Var.getMessagesController().linkPrefix + "/addtheme/" + ((Object) td1Var.f38036a.getText());
    ...
    public final void onTextChanged(CharSequence charSequence, int i10, int i11, int i12) {
        ...
        td1Var.Z(td1Var.f38036a.getText().toString(), false);
    }
