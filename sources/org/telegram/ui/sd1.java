...
public final class sd1 implements TextWatcher {
    ...
    public final void afterTextChanged(Editable editable) {
        td1 td1Var = this.f37248a;
        if (td1Var.I) {
            return;
        }
        if (td1Var.f37612a.length() > 0) {
            String str = "https://" + td1Var.getMessagesController().linkPrefix + "/addtheme/" + ((Object) td1Var.f37612a.getText());
    ...
    public final void onTextChanged(CharSequence charSequence, int i10, int i11, int i12) {
        ...
        td1Var.Z(td1Var.f37612a.getText().toString(), false);
    }
