...
public final class c41 extends org.telegram.ui.ActionBar.f3 {
    ...
    public final ci.i1 f32653b;
    public final Paint f32654c;
    public final boolean d;
    public final boolean e;
    public final boolean f32655f;
    public final ArrayList h;
    public final byte[] f32656n;
    public final long f32657r;
    public y31 f32658s;
    ...
    public static void H(c41 c41Var, CharSequence charSequence, byte[] bArr, String str) {
        ...
        if (c41Var.d) {
            ...
            if (c41Var.e) {
                ...
                if (arrayList != null) {
                    tL_stories_report.f18356id.addAll(arrayList);
                }
                if (str != null) {
                    str2 = str;
                }
                ...
                if (arrayList != null && !arrayList.isEmpty()) {
                    tL_reportMessage.f18324id = ((Integer) arrayList.get(0)).intValue();
                }
                if (str != null) {
                    str2 = str;
                }
                ...
                if (arrayList != null) {
                    tL_messages_report2.f18213id.addAll(arrayList);
                }
                if (str != null) {
                    str2 = str;
                }
    ...
    public static void K(int i10, final Context context, final long j3, final boolean z10, final boolean z11, final ArrayList arrayList, final org.telegram.ui.Components.vc vcVar, final org.telegram.ui.ActionBar.e6 e6Var, byte[] bArr, String str, final Utilities.Callback callback) {
        ...
        if (context != null) {
            ...
            if (z10) {
                ...
                tL_messages_report3.f18213id.addAll(arrayList);
    ...
    public static void m(Context context, org.telegram.ui.ActionBar.e6 e6Var, boolean z10, boolean z11, long j3, ArrayList arrayList, boolean[] zArr, Utilities.Callback callback, org.telegram.ui.Components.vc vcVar, TLRPC.ReportResult reportResult) {
        ...
        c41Var.f32658s = new t31(zArr, callback, vcVar);
    ...
    public static void n(c41 c41Var, TLObject tLObject, CharSequence charSequence, TLRPC.TL_error tL_error, byte[] bArr, String str) {
        ...
        y31 y31Var2;
        ci.d dVar;
        ci.i1 i1Var = c41Var.f32653b;
        if ((i1Var.getCurrentView() instanceof b41) && (dVar = ((b41) i1Var.getCurrentView()).f32036s) != null) {
        ...
        if (tLObject != null) {
            ...
            if (!z10 && !(tLObject instanceof TLRPC.TL_reportResultChooseOption) && !(tLObject instanceof TLRPC.TL_reportResultAddComment)) {
                if (tLObject instanceof TLRPC.TL_channels_sponsoredMessageReportResultAdsHidden) {
                    ...
                    return;
                } else if (((tLObject instanceof TLRPC.TL_channels_sponsoredMessageReportResultReported) || (tLObject instanceof TLRPC.TL_reportResultReported)) && (y31Var2 = c41Var.f32658s) != null) {
                    y31Var2.a();
                    c41Var.dismiss();
                    return;
                } else {
            ...
            if (b41Var != null) {
                ...
                if (tLObject instanceof TLRPC.TL_reportResultChooseOption) {
                    b41Var.f32031b = null;
                    b41Var.f32032c = (TLRPC.TL_reportResultChooseOption) tLObject;
                    b41Var.d = null;
                    e61Var.Y2.N(false);
                } else if (tLObject instanceof TLRPC.TL_reportResultAddComment) {
                    b41Var.b((TLRPC.TL_reportResultAddComment) tLObject);
                } else if (z10) {
                    b41Var.f32031b = (TLRPC.TL_channels_sponsoredMessageReportResultChooseOption) tLObject;
                    b41Var.f32032c = null;
                    b41Var.d = null;
                    e61Var.Y2.N(false);
                }
            ...
            if (!c41Var.d && "MESSAGE_ID_REQUIRED".equals(tL_error.text)) {
                ...
                y31 y31Var4 = c41Var.f32658s;
                if (y31Var4 != null) {
                    y31Var4.c();
                }
            } else if ("AD_EXPIRED".equals(tL_error.text) && (y31Var = c41Var.f32658s) != null) {
                y31Var.a();
            }
            c41Var.dismiss();
        }
    ...
    public final void O(TLRPC.TL_channels_sponsoredMessageReportResultChooseOption tL_channels_sponsoredMessageReportResultChooseOption) {
        View[] viewPages = this.f32653b.getViewPages();
        View view = viewPages[0];
        if (view instanceof b41) {
            ((b41) view).a(0);
    ...
    public final boolean canDismissWithSwipe() {
        View currentView = this.f32653b.getCurrentView();
        if (!(currentView instanceof b41)) {
            return true;
        }
        return !((b41) currentView).f32033f.canScrollVertically(-1);
    }

    @Override
    public final void onBackPressed() {
        a41 a41Var;
        ci.i1 i1Var = this.f32653b;
        if ((i1Var.getCurrentView() instanceof b41) && (a41Var = ((b41) i1Var.getCurrentView()).f32034n) != null) {
