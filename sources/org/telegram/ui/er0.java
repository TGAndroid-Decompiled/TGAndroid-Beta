...
public final class er0 implements Runnable {
    ...
    public final void run() {
        ...
        Object obj = this.h;
        Serializable serializable = this.f33842f;
        Object obj2 = this.e;
        switch (i10) {
            case 0:
                ...
                photoViewer.Z1 = 2;
                photoViewer.f31825r2 = false;
                photoViewer.d = new qt0(photoViewer, photoViewer.d, messageObject, orientation, this.f33841c, this.d);
                photoViewer.f31777m1.l();
                if (photoViewer.R6 == null) {
                    photoViewer.R6 = VelocityTracker.obtain();
                }
                photoViewer.f31895y7 = 3;
                photoViewer.p3(false, false);
                photoViewer.j3(true, false);
                zn znVar = photoViewer.f31746i4;
                if (znVar != null && znVar.V != null && znVar.x9()) {
                    photoViewer.f31746i4.V.P();
                } else {
                    photoViewer.R1();
                }
                ...
                org.telegram.ui.Components.pp0 pp0Var = photoViewer.P0;
                if (photoViewer.f31796o1) {
                    f11 = 154.0f;
                } else {
                    f11 = 96.0f;
                }
                pp0Var.setTranslationY(AndroidUtilities.dp(f11));
            ...
            default:
                ...
                int i13 = ((int[]) obj)[0];
                if (i12 == i13) {
                    iu0 iu0Var = ds0Var.f33528b.f31679b0;
                    boolean z10 = this.f33840b;
                    boolean z11 = this.f33841c;
                    int i14 = z10 ? 1 : 0;
                    boolean z12 = this.d;
                    if ((z11 ? 1 : 0) + i14 + (z12 ? 1 : 0) > 1) {
                        ...
                        if (i13 > 1) {
                            pcVar = org.telegram.ui.Components.pc.f27821s;
                        } else {
                            pcVar = org.telegram.ui.Components.pc.f27820r;
                        }
                    } else if (z10) {
                        if (i13 > 1) {
                            pcVar = org.telegram.ui.Components.pc.f27819n;
                        } else {
                            pcVar = org.telegram.ui.Components.pc.h;
                        }
                    } else if (i13 > 1) {
                        pcVar = org.telegram.ui.Components.pc.f27818f;
                    } else {
