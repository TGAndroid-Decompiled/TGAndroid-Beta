...
public final class er0 extends org.telegram.ui.Components.aw0 {
    ...
    public final hr0 D0;
    public int f33389w0;
    public boolean f33390x0;
    public boolean f33391y0;
    public int f33392z0;
    ...
    public final boolean a0(MotionEvent motionEvent, boolean z10) {
        ...
        this.f33391y0 = false;
        this.f33390x0 = true;
        this.f33392z0 = (int) motionEvent.getX();
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        canvas.drawLine(0.0f, translationY, getWidth(), translationY, org.telegram.ui.ActionBar.j6.f19216k0);
    }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent != null && motionEvent.getAction() == 0 && !this.f33390x0 && !this.f33391y0) {
            this.f33389w0 = motionEvent.getPointerId(0);
            this.f33391y0 = true;
            this.f33392z0 = (int) motionEvent.getX();
            this.A0 = (int) motionEvent.getY();
            this.B0.clear();
        } else if (motionEvent != null && motionEvent.getAction() == 2 && motionEvent.getPointerId(0) == this.f33389w0) {
            int x10 = (int) (motionEvent.getX() - this.f33392z0);
            int abs = Math.abs(((int) motionEvent.getY()) - this.A0);
            if (this.f33390x0 && (((z12 = hr0Var.v) && x10 > 0) || (!z12 && x10 < 0))) {
                if (x10 < 0) {
                    z13 = true;
                } else {
                    z13 = false;
            ...
            if (this.f33391y0 && !this.f33390x0) {
        ...
        } else if (motionEvent == null || (motionEvent.getPointerId(0) == this.f33389w0 && (motionEvent.getAction() == 3 || motionEvent.getAction() == 1 || motionEvent.getAction() == 6))) {
            this.B0.computeCurrentVelocity(1000, hr0Var.f34271x);
            if (motionEvent != null && motionEvent.getAction() != 3) {
                f7 = this.B0.getXVelocity();
                f10 = this.B0.getYVelocity();
                if (!this.f33390x0 && Math.abs(f7) >= 3000.0f && Math.abs(f7) > Math.abs(f10)) {
                    if (f7 < 0.0f) {
                        z11 = true;
                    } else {
                        z11 = false;
            ...
            if (this.f33390x0) {
                ...
                hr0Var.f34268r = new AnimatorSet();
                ...
                if (z10) {
                    ...
                    if (hr0Var.v) {
                        hr0Var.f34268r.playTogether(ObjectAnimator.ofFloat(fr0VarArr[0], property, 0.0f), ObjectAnimator.ofFloat(fr0VarArr[1], property, fr0Var4.getMeasuredWidth()));
                    } else {
                        hr0Var.f34268r.playTogether(ObjectAnimator.ofFloat(fr0VarArr[0], property, 0.0f), ObjectAnimator.ofFloat(fr0VarArr[1], property, -fr0Var3.getMeasuredWidth()));
                    }
                } else {
                    measuredWidth = fr0VarArr[0].getMeasuredWidth() - Math.abs(x11);
                    if (hr0Var.v) {
                        hr0Var.f34268r.playTogether(ObjectAnimator.ofFloat(fr0VarArr[0], property, -fr0Var2.getMeasuredWidth()), ObjectAnimator.ofFloat(fr0VarArr[1], property, 0.0f));
                    } else {
                        hr0Var.f34268r.playTogether(ObjectAnimator.ofFloat(fr0VarArr[0], property, fr0Var.getMeasuredWidth()), ObjectAnimator.ofFloat(fr0VarArr[1], property, 0.0f));
                    }
                }
                hr0Var.f34268r.setInterpolator(hr0.f34262y);
                ...
                hr0Var.f34268r.setDuration(Math.max(150, Math.min(measuredWidth2, 600)));
                hr0Var.f34268r.addListener(new gp0(this, 1));
                hr0Var.f34268r.start();
                hr0Var.f34269s = true;
                this.f33390x0 = false;
            } else {
                this.f33391y0 = false;
