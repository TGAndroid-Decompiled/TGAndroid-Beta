...
public abstract class p61 extends FrameLayout implements org.telegram.ui.ActionBar.x5 {
    public final FrameLayout f36407a;
    public final ImageView f36408b;
    public final ImageView f36409c;
    public final org.telegram.ui.Components.tg0 d;
    public final View e;
    public final org.telegram.ui.Components.ln0 f36410f;
    public final org.telegram.ui.Cells.c6 h;
    public o61 f36411n;
    public float f36412r;
    public ValueAnimator f36413s;
    public vz0 v;
    public boolean f36414w;
    public boolean f36415x;
    public final a71 f36416y;
    ...
    public p61(a71 a71Var, Context context, boolean z10) {
        ...
        ln0Var.a(org.telegram.ui.ActionBar.h6.v0(i11, d6Var));
            ...
            public final void onClick(View view) {
                switch (r2) {
                    case 0:
                        ...
                        if (r51Var2.f36410f.f26120k == 1) {
                            c6Var.setText("");
                            r51Var2.f36416y.v(null, true, false);
                            o61 o61Var = r51Var2.f36411n;
                            if (o61Var != null) {
                                o61Var.F1(null);
                                r51Var2.f36411n.G1(true, true);
                                r51Var2.f36411n.D1();
                            }
                    ...
                    default:
                        ...
                        c6Var2.setText("");
                        r51Var4.f36416y.v(null, true, false);
                        o61 o61Var2 = r51Var4.f36411n;
                        if (o61Var2 != null) {
                            o61Var2.F1(null);
                            r51Var4.f36411n.G1(true, true);
                        }
        ...
        org.telegram.ui.Components.tg0 tg0Var = new org.telegram.ui.Components.tg0(r51Var, context, z10);
        this.d = tg0Var;
    ...
    public static void a(r51 r51Var, boolean z10) {
        ...
        AndroidUtilities.updateViewShow(r51Var.f36409c, false);
    }
    ...
    public final void c(boolean z10) {
        ...
        this.f36414w = z10;
        ValueAnimator valueAnimator = this.f36413s;
        if (valueAnimator != null) {
            valueAnimator.cancel();
        }
        float f10 = this.f36412r;
        if (z10) {
            f7 = 1.0f;
        } else {
            f7 = 0.0f;
        ...
        this.f36413s = ofFloat;
        ofFloat.addUpdateListener(new q11(this, 9));
        this.f36413s.setDuration(120L);
        this.f36413s.setInterpolator(org.telegram.ui.Components.sr.h);
        this.f36413s.start();
    }
    ...
    public final void d(boolean z10) {
        ...
        o61 o61Var;
        o61 o61Var2;
        org.telegram.ui.Components.ln0 ln0Var = this.f36410f;
        int i10 = ln0Var.f26120k;
        org.telegram.ui.Cells.c6 c6Var = this.h;
        int i11 = 2;
        if (i10 == 2 && ((c6Var.length() != 0 || ((o61Var2 = this.f36411n) != null && o61Var2.getSelectedCategory() != null)) && !z10)) {
            return;
        }
        if (c6Var.length() <= 0 && ((o61Var = this.f36411n) == null || o61Var.f24898o3 <= 0.5f || (!o61Var.j3 && o61Var.getSelectedCategory() == null))) {
            r62 = 0;
        } else {
            r62 = 1;
        }
        ln0Var.b(r62);
        ImageView imageView = this.f36408b;
    ...
    public final void e() {
        if (this.f36415x) {
            this.f36407a.setBackground(org.telegram.ui.ActionBar.h6.b0(AndroidUtilities.dp(18.0f), org.telegram.ui.ActionBar.h6.l1(0.06f, org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.E8, this.f36416y.Z0))));
        }
    }
