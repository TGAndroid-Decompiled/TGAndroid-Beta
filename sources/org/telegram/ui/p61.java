...
public abstract class p61 extends FrameLayout implements org.telegram.ui.ActionBar.x5 {
    public final FrameLayout f36398a;
    public final ImageView f36399b;
    public final ImageView f36400c;
    public final org.telegram.ui.Components.sg0 d;
    public final View e;
    public final org.telegram.ui.Components.kn0 f36401f;
    public final org.telegram.ui.Cells.c6 h;
    public o61 f36402n;
    public float f36403r;
    public ValueAnimator f36404s;
    public vz0 v;
    public boolean f36405w;
    public boolean f36406x;
    public final a71 f36407y;
            ...
            public final void onClick(View view) {
                switch (r2) {
                    case 0:
                        ...
                        if (r51Var2.f36401f.f25810k == 1) {
                            c6Var.setText("");
                            r51Var2.f36407y.v(null, true, false);
                            o61 o61Var = r51Var2.f36402n;
                            if (o61Var != null) {
                                o61Var.F1(null);
                                r51Var2.f36402n.G1(true, true);
                                r51Var2.f36402n.D1();
                            }
                    ...
                    default:
                        ...
                        c6Var2.setText("");
                        r51Var4.f36407y.v(null, true, false);
                        o61 o61Var2 = r51Var4.f36402n;
                        if (o61Var2 != null) {
                            o61Var2.F1(null);
                            r51Var4.f36402n.G1(true, true);
                        }
    ...
    public static void a(r51 r51Var, boolean z10) {
        ...
        AndroidUtilities.updateViewShow(r51Var.f36400c, false);
    }
    ...
    public final void c(boolean z10) {
        ...
        this.f36405w = z10;
        ValueAnimator valueAnimator = this.f36404s;
        if (valueAnimator != null) {
            valueAnimator.cancel();
        }
        float f10 = this.f36403r;
        if (z10) {
            f7 = 1.0f;
        } else {
            f7 = 0.0f;
        ...
        this.f36404s = ofFloat;
        ofFloat.addUpdateListener(new q11(this, 9));
        this.f36404s.setDuration(120L);
        this.f36404s.setInterpolator(org.telegram.ui.Components.rr.h);
        this.f36404s.start();
    }
    ...
    public final void d(boolean z10) {
        ...
        o61 o61Var;
        o61 o61Var2;
        org.telegram.ui.Components.kn0 kn0Var = this.f36401f;
        int i10 = kn0Var.f25810k;
        org.telegram.ui.Cells.c6 c6Var = this.h;
        int i11 = 2;
        if (i10 == 2 && ((c6Var.length() != 0 || ((o61Var2 = this.f36402n) != null && o61Var2.getSelectedCategory() != null)) && !z10)) {
            return;
        }
        if (c6Var.length() <= 0 && ((o61Var = this.f36402n) == null || o61Var.f24553o3 <= 0.5f || (!o61Var.j3 && o61Var.getSelectedCategory() == null))) {
            r62 = 0;
        } else {
            r62 = 1;
        }
        kn0Var.b(r62);
        ImageView imageView = this.f36399b;
    ...
    public final void e() {
        if (this.f36406x) {
            this.f36398a.setBackground(org.telegram.ui.ActionBar.h6.b0(AndroidUtilities.dp(18.0f), org.telegram.ui.ActionBar.h6.l1(0.06f, org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.E8, this.f36407y.Z0))));
        }
    }
