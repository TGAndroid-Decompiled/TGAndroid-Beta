...
public final class z01 {
    ...
    public final Runnable f40291b;
    public final String f40292c;
    public final String[] d;
    public final int e;
    public final int f40293f;
    public int f40294g;
    public String h;
    ...
    public final boolean equals(Object obj) {
        if ((obj instanceof z01) && this.f40293f == ((z01) obj).f40293f) {
            return true;
        }
        return false;
    }
    ...
    public final String toString() {
        ...
        serializedData.writeInt32(this.f40294g);
        serializedData.writeInt32(1);
        serializedData.writeInt32(this.f40293f);
