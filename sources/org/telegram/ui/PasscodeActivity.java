    ...
    public void lambda$createView$5(View view, final int i) {
        if (view.isEnabled()) {
            if (i == this.disablePasscodeRow) {
                AlertDialog create = new AlertDialog.Builder(getParentActivity()).setTitle(LocaleController.getString((int) R.string.DisablePasscode)).setMessage(LocaleController.getString((int) R.string.DisablePasscodeConfirmMessage)).setNegativeButton(LocaleController.getString((int) R.string.Cancel), null).setPositiveButton(LocaleController.getString((int) R.string.DisablePasscodeTurnOff), new DialogInterface.OnClickListener() {
                    @Override
            ...
            if (itemViewType == 0) {
                ...
                if (i == PasscodeActivity.this.changePasscodeRow) {
                    ...
                    if (i3 == 0) {
                        ...
                        str = LocaleController.formatString("AutoLockInTime", R.string.AutoLockInTime, LocaleController.formatPluralString("Minutes", i3 / 60));
                    } else {
                        str = i3 < 86400 ? LocaleController.formatString("AutoLockInTime", R.string.AutoLockInTime, LocaleController.formatPluralString("Hours", (int) Math.ceil((i3 / 60.0f) / 60.0f))) : LocaleController.formatString("AutoLockInTime", R.string.AutoLockInTime, LocaleController.formatPluralString("Days", (int) Math.ceil(((i3 / 60.0f) / 60.0f) / 24.0f)));
                    }
