...
public class PasscodeActivity extends org.telegram.ui.ActionBar.p2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public bl0 M;
    public sb0 N;
    public org.telegram.ui.Components.jj0 f31656a;
    private int autoLockRow;
    public hl0 f31657b;
    public org.telegram.ui.Components.rl0 f31658c;
    private int changePasscodeRow;
    public TextView d;
    private int disablePasscodeRow;
    public org.telegram.ui.Components.u01 e;
    public org.telegram.ui.Components.bd0 f31659f;
    private int fingerprintRow;
    public EditTextBoldCursor h;
    public xd0 f31660n;
    public TextView f31661r;
    public ImageView f31662s;
    public org.telegram.ui.Components.rr v;
    public org.telegram.ui.Components.a20 f31663w;
    public final int f31664x;
    public int f31665y;
    ...
    public static void U(PasscodeActivity passcodeActivity, org.telegram.ui.Components.xc0 xc0Var, int i10) {
        ...
        passcodeActivity.f31657b.m(i10);
    ...
    public static void V(PasscodeActivity passcodeActivity, View view, int i10) {
        if (view.isEnabled()) {
            if (i10 == passcodeActivity.disablePasscodeRow) {
                ...
                d2Var.show();
                ((TextView) d2Var.d(-1)).setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20116q7, false));
    ...
    public final boolean c0() {
        if (e0() && this.f31664x != 0 && !AndroidUtilities.isTablet()) {
    ...
    public final boolean d0() {
        int i10 = this.f31664x;
        if ((i10 == 1 && this.f31665y == 1) || (i10 == 2 && SharedConfig.passcodeType == 1)) {
            return true;
        }
        return false;
    }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.didSetPasscode) {
            if ((objArr.length == 0 || ((Boolean) objArr[0]).booleanValue()) && this.f31664x == 0) {
                m0();
                hl0 hl0Var = this.f31657b;
                if (hl0Var != null) {
                    hl0Var.l();
                }
            }
    ...
    public final boolean e0() {
        int i10 = this.f31664x;
        if ((i10 == 1 && this.f31665y == 0) || (i10 == 2 && SharedConfig.passcodeType == 0)) {
            return true;
        }
        return false;
    }
    ...
    public final void f0() {
        ...
        if (e0()) {
            for (ds dsVar : this.f31660n.f32635f) {
                dsVar.i(1.0f);
            }
        } else {
            this.f31659f.a(1.0f);
    ...
    public final void g0() {
        ...
        if (i10 == 1) {
            if (!this.C.equals(obj)) {
                AndroidUtilities.updateViewVisibilityAnimated(this.f31661r, true);
                for (ds dsVar : this.f31660n.f32635f) {
                    dsVar.setText("");
                }
                if (e0()) {
                    this.f31660n.f32635f[0].requestFocus();
                }
                this.h.setText("");
                f0();
                this.f31660n.removeCallbacks(this.L);
                this.f31660n.post(new al0(this, 0));
                return;
            }
            ...
            SharedConfig.passcodeType = this.f31665y;
            SharedConfig.saveConfig();
            this.h.clearFocus();
            AndroidUtilities.hideKeyboard(this.h);
            for (ds dsVar2 : this.f31660n.f32635f) {
                dsVar2.clearFocus();
            ...
            if (j10 > 0) {
                ...
                for (ds dsVar3 : this.f31660n.f32635f) {
                    dsVar3.setText("");
                }
                this.h.setText("");
                if (e0()) {
                ...
                this.h.setText("");
                for (ds dsVar4 : this.f31660n.f32635f) {
                    dsVar4.setText("");
                }
                if (e0()) {
                    this.f31660n.f32635f[0].requestFocus();
                ...
                this.h.clearFocus();
                AndroidUtilities.hideKeyboard(this.h);
                for (ds dsVar5 : this.f31660n.f32635f) {
                    dsVar5.clearFocus();
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31658c, 16, new Class[]{org.telegram.ui.Cells.r8.class, org.telegram.ui.Cells.z9.class}, null, null, null, i10));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31658c, 32768, null, null, null, null, org.telegram.ui.ActionBar.j6.f20151s8));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31658c, 4096, null, null, null, null, org.telegram.ui.ActionBar.j6.f19971i6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31658c, 0, new Class[]{View.class}, org.telegram.ui.ActionBar.j6.f20000k0, null, null, org.telegram.ui.ActionBar.j6.f19882d7));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.h, 32, null, null, null, null, org.telegram.ui.ActionBar.j6.f20006k6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.h, 65568, null, null, null, null, org.telegram.ui.ActionBar.j6.f20024l6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31658c, 0, new Class[]{org.telegram.ui.Cells.r8.class}, new String[]{"textView"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31658c, 0, new Class[]{org.telegram.ui.Cells.r8.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.M6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31658c, 0, new Class[]{org.telegram.ui.Cells.r8.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.N6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31658c, 262144, new Class[]{org.telegram.ui.Cells.z9.class}, new String[]{"textView"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31658c, 262144, new Class[]{org.telegram.ui.Cells.z9.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.E6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31658c, 0, new Class[]{org.telegram.ui.Cells.z9.class}, new String[]{"valueTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.I6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31658c, 0, new Class[]{org.telegram.ui.Cells.z8.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.B6));
        return arrayList;
    }

    public final void h0() {
        String obj;
        if ((this.f31665y == 1 && this.h.getText().length() == 0) || (this.f31665y == 0 && this.f31660n.getCode().length() != 4)) {
            f0();
            return;
        }
    ...
    public final void i0(boolean z4, boolean z10) {
        float f10;
        org.telegram.ui.Components.mr mrVar;
        if (z4) {
        ...
        float f12 = 0.0f;
        if (!z10) {
            org.telegram.ui.Components.rr rrVar = this.v;
            if (!z4) {
                i10 = 8;
            }
            rrVar.setVisibility(i10);
            org.telegram.ui.Components.rr rrVar2 = this.v;
            if (!z4) {
                f11 = 0.0f;
            }
            rrVar2.setAlpha(f11);
            org.telegram.ui.Components.rr rrVar3 = this.v;
            if (!z4) {
                f12 = AndroidUtilities.dp(230.0f);
            }
            rrVar3.setTranslationY(f12);
        ...
        if (z4) {
            mrVar = org.telegram.ui.Components.mr.f27122f;
        } else {
            mrVar = org.telegram.ui.Components.ft.e;
        }
    ...
    public final void k0() {
        if (e0()) {
            this.f31660n.f32635f[0].requestFocus();
            if (!c0()) {
                AndroidUtilities.showKeyboard(this.f31660n.f32635f[0]);
            }
        } else if (d0()) {
            this.h.requestFocus();
    ...
    public final void l0() {
        ...
        if (e0()) {
            AndroidUtilities.updateViewVisibilityAnimated(this.f31660n, true, 1.0f, z4);
            AndroidUtilities.updateViewVisibilityAnimated(this.f31659f, false, 1.0f, z4);
        } else if (d0()) {
            AndroidUtilities.updateViewVisibilityAnimated(this.f31660n, false, 1.0f, z4);
            AndroidUtilities.updateViewVisibilityAnimated(this.f31659f, true, 1.0f, z4);
        }
        if (d0()) {
    ...
    public final void onConfigurationChanged(Configuration configuration) {
        ...
        i0(c0(), false);
        org.telegram.ui.Components.jj0 jj0Var = this.f31656a;
        if (jj0Var != null) {
        ...
        xd0 xd0Var = this.f31660n;
        if (xd0Var != null && (dsVarArr = xd0Var.f32635f) != null) {
