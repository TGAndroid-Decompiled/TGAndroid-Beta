...
public class PasscodeActivity extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public nl0 P;
    public cc0 Q;
    public org.telegram.ui.Components.nj0 f31189a;
    private int autoLockRow;
    public tl0 f31190b;
    public org.telegram.ui.Components.yl0 f31191c;
    private int changePasscodeRow;
    public TextView d;
    private int disablePasscodeRow;
    public org.telegram.ui.Components.g11 e;
    public org.telegram.ui.Components.kd0 f31192f;
    private int fingerprintRow;
    public EditTextBoldCursor h;
    public fe0 f31193n;
    public TextView f31194r;
    public ImageView f31195s;
    public org.telegram.ui.Components.ur v;
    public org.telegram.ui.Components.y10 f31196w;
    ...
    public static void U(PasscodeActivity passcodeActivity, org.telegram.ui.Components.fd0 fd0Var, int i10) {
        ...
        passcodeActivity.f31190b.m(i10);
    ...
    public static void V(PasscodeActivity passcodeActivity, View view, int i10) {
        if (view.isEnabled()) {
            if (i10 == passcodeActivity.disablePasscodeRow) {
                ...
                b2Var.show();
                ((TextView) b2Var.d(-1)).setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19348q7, false));
    ...
    public final boolean c0() {
        if (e0() && this.f31197x != 0 && !AndroidUtilities.isTablet()) {
    ...
    public final boolean d0() {
        int i10 = this.f31197x;
        if ((i10 == 1 && this.f31198y == 1) || (i10 == 2 && SharedConfig.passcodeType == 1)) {
            return true;
        }
        return false;
    }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.didSetPasscode) {
            if ((objArr.length == 0 || ((Boolean) objArr[0]).booleanValue()) && this.f31197x == 0) {
                m0();
                tl0 tl0Var = this.f31190b;
                if (tl0Var != null) {
                    tl0Var.l();
                }
            }
    ...
    public final boolean e0() {
        int i10 = this.f31197x;
        if ((i10 == 1 && this.f31198y == 0) || (i10 == 2 && SharedConfig.passcodeType == 0)) {
            return true;
        }
        return false;
    }
    ...
    public final void f0() {
        ...
        if (e0()) {
            for (gs gsVar : this.f31193n.f33145f) {
                gsVar.i(1.0f);
            }
        } else {
            this.f31192f.a(1.0f);
    ...
    public final void g0() {
        ...
        if (i10 == 1) {
            if (!this.F.equals(obj)) {
                AndroidUtilities.updateViewVisibilityAnimated(this.f31194r, true);
                for (gs gsVar : this.f31193n.f33145f) {
                    gsVar.setText("");
                }
                if (e0()) {
                    this.f31193n.f33145f[0].requestFocus();
                }
                this.h.setText("");
                f0();
                this.f31193n.removeCallbacks(this.O);
                this.f31193n.post(new ml0(this, 0));
                return;
            }
            ...
            SharedConfig.passcodeType = this.f31198y;
            SharedConfig.saveConfig();
            this.h.clearFocus();
            AndroidUtilities.hideKeyboard(this.h);
            for (gs gsVar2 : this.f31193n.f33145f) {
                gsVar2.clearFocus();
            ...
            if (j3 > 0) {
                ...
                for (gs gsVar3 : this.f31193n.f33145f) {
                    gsVar3.setText("");
                }
                this.h.setText("");
                if (e0()) {
                ...
                this.h.setText("");
                for (gs gsVar4 : this.f31193n.f33145f) {
                    gsVar4.setText("");
                }
                if (e0()) {
                    this.f31193n.f33145f[0].requestFocus();
                ...
                this.h.clearFocus();
                AndroidUtilities.hideKeyboard(this.h);
                for (gs gsVar5 : this.f31193n.f33145f) {
                    gsVar5.clearFocus();
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31191c, 16, new Class[]{org.telegram.ui.Cells.x8.class, org.telegram.ui.Cells.fa.class}, null, null, null, i10));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31191c, 32768, null, null, null, null, org.telegram.ui.ActionBar.j6.f19387s8));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31191c, 4096, null, null, null, null, org.telegram.ui.ActionBar.j6.f19199i6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31191c, 0, new Class[]{View.class}, org.telegram.ui.ActionBar.j6.f19231k0, null, null, org.telegram.ui.ActionBar.j6.f19110d7));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.h, 32, null, null, null, null, org.telegram.ui.ActionBar.j6.f19237k6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.h, 65568, null, null, null, null, org.telegram.ui.ActionBar.j6.f19255l6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31191c, 0, new Class[]{org.telegram.ui.Cells.x8.class}, new String[]{"textView"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31191c, 0, new Class[]{org.telegram.ui.Cells.x8.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.M6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31191c, 0, new Class[]{org.telegram.ui.Cells.x8.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.N6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31191c, 262144, new Class[]{org.telegram.ui.Cells.fa.class}, new String[]{"textView"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31191c, 262144, new Class[]{org.telegram.ui.Cells.fa.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.E6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31191c, 0, new Class[]{org.telegram.ui.Cells.fa.class}, new String[]{"valueTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.I6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31191c, 0, new Class[]{org.telegram.ui.Cells.f9.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.B6));
        return arrayList;
    }

    public final void h0() {
        String obj;
        if ((this.f31198y == 1 && this.h.getText().length() == 0) || (this.f31198y == 0 && this.f31193n.getCode().length() != 4)) {
            f0();
            return;
        }
    ...
    public final void i0(boolean z10, boolean z11) {
        ...
        if (z10) {
            qrVar = org.telegram.ui.Components.qr.f27653f;
        } else {
    ...
    public final void k0() {
        if (e0()) {
            this.f31193n.f33145f[0].requestFocus();
            if (!c0()) {
                AndroidUtilities.showKeyboard(this.f31193n.f33145f[0]);
            }
        } else if (d0()) {
            this.h.requestFocus();
    ...
    public final void l0() {
        ...
        if (i12 == 2) {
            ...
            org.telegram.ui.Components.g11 g11Var = this.e;
            if (this.f31198y == 0) {
                i11 = R.string.CreatePasscodeInfoPIN;
            } else {
                i11 = R.string.CreatePasscodeInfoPassword;
            }
            g11Var.a(LocaleController.getString(i11), z10, false);
        }
        if (e0()) {
            AndroidUtilities.updateViewVisibilityAnimated(this.f31193n, true, 1.0f, z10);
            AndroidUtilities.updateViewVisibilityAnimated(this.f31192f, false, 1.0f, z10);
        } else if (d0()) {
            AndroidUtilities.updateViewVisibilityAnimated(this.f31193n, false, 1.0f, z10);
            AndroidUtilities.updateViewVisibilityAnimated(this.f31192f, true, 1.0f, z10);
        }
        if (d0()) {
    ...
    public final void onConfigurationChanged(Configuration configuration) {
        ...
        i0(c0(), false);
        org.telegram.ui.Components.nj0 nj0Var = this.f31189a;
        if (nj0Var != null) {
        ...
        fe0 fe0Var = this.f31193n;
        if (fe0Var != null && (gsVarArr = fe0Var.f33145f) != null) {
