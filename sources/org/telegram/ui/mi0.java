        ...
        switch (this.f35757a) {
            case 0:
                ...
                if (!arrayList.isEmpty()) {
                    fz fzVar = (fz) hg.k0.h(1, arrayList);
                    ...
                    if (mediaLocation != null) {
                        if (fzVar.f33717s == null) {
                            TLRPC.Document document = mediaLocation.document;
                            if (document != null) {
                                fzVar.f33717s = FileLoader.getAttachFileName(document, "tgs");
                            } else {
                                fzVar.f33717s = FileLoader.getAttachFileName(mediaLocation.location, "tgs");
                            }
                        }
                        if (fzVar.f33717s != null) {
                            Float fileProgress = ImageLoader.getInstance().getFileProgress(fzVar.f33717s);
                ...
                return;
            default:
                bj0 bj0Var2 = this.f35758b;
                kb0 kb0Var = bj0Var2.d;
                if (kb0Var != null) {
                    if (bj0Var2.E == 1.0f && bj0Var2.f32191n != null) {
                        z10 = true;
                    } else {
                        z10 = false;
                    }
                ...
                if (bj0Var2.E > 0.0f && bj0Var2.f32191n != null) {
                    bj0Var2.f32196r.reset();
                    float width = getWidth() / bj0Var2.f32183f.getWidth();
                    bj0Var2.f32196r.postScale(width, width);
                    bj0Var2.h.setLocalMatrix(bj0Var2.f32196r);
                    bj0Var2.f32191n.setAlpha((int) (bj0Var2.E * 255.0f));
                    canvas2 = canvas;
                    canvas2.drawRect(0.0f, 0.0f, getWidth(), getHeight(), bj0Var2.f32191n);
                } else {
                    canvas2 = canvas;
                }
            ...
            case 1:
                ...
                if (!bj0Var.f32185g0 || bj0Var.f32186h0) {
                    ...
                    if (bj0Var.F.getWidth() > 0) {
                        ...
                        if (bj0Var.f32185g0) {
                            org.telegram.messenger.wl.q(ui0Var.animate().translationY(((bj0Var.X.getHeight() + iArr[1]) - ui0Var.getMeasuredHeight()) - ui0Var.getTop()), ji.n.V, 250L);
                        } else {
                        ...
                        FrameLayout frameLayout = bj0Var.f32181d0;
                        if (frameLayout != null) {
                            frameLayout.setX(hg.k0.f(6.0f, (bj0Var.X.l() + iArr[0]) - bj0Var.f32181d0.getMeasuredWidth(), 0));
                            RectF rectF = bj0Var.f32190l0;
                            if (rectF != null) {
                                FrameLayout frameLayout2 = bj0Var.f32181d0;
                                float max = Math.max(bj0Var.e.f10589b, rectF.top - frameLayout2.getMeasuredWidth());
                                bj0Var.f32180c0 = max;
                                frameLayout2.setY(max);
                                pi0 pi0Var = bj0Var.f32182e0;
                                if (pi0Var != null) {
                                    pi0Var.setY(Math.max(bj0Var.e.f10589b, (bj0Var.f32190l0.top - AndroidUtilities.dp(24.0f)) - bj0Var.f32182e0.getMeasuredHeight()));
                                }
                            } else {
                                float height2 = (bj0Var.X.getHeight() + iArr[1]) - ui0Var.getMeasuredHeight();
                                FrameLayout frameLayout3 = bj0Var.f32181d0;
                                float max2 = Math.max(bj0Var.e.f10589b, height2 - frameLayout3.getMeasuredHeight()) + AndroidUtilities.dp(24.0f);
                                bj0Var.f32180c0 = max2;
                                frameLayout3.setY(max2);
                                pi0 pi0Var2 = bj0Var.f32182e0;
                                if (pi0Var2 != null) {
                                    pi0Var2.setY(Math.max(0.0f, (height2 - pi0Var2.getMeasuredHeight()) - bj0Var.f32180c0));
                                }
                            }
                        }
                    }
                    bj0Var.f32185g0 = true;
                    return;
                }
                return;
            default:
    ...
    public void onSizeChanged(int i10, int i11, int i12, int i13) {
        switch (this.f35757a) {
            case 1:
                ...
                bj0 bj0Var = this.f35758b;
                gh.d.c(bj0Var.f32188j0, bj0Var.F);
                ViewGroup viewGroup = bj0Var.Z;
                if (viewGroup != null) {
