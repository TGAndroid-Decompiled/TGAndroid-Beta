...
public final class l1 extends FrameLayout implements org.telegram.ui.Cells.l9 {
    public final mh.d1 f38454a;
    public final i1 f38455b;
    public d3 f38456c;
    public d3 d;
    public int f38457e;
    public int f38458f;
    ...
    public TL_iv.pageBlockCollage f38461s;
    public final k1 v;
    public final j4 f38462w;
    public final l4 f38463x;
    ...
    public final void onDraw(Canvas canvas) {
        if (this.f38461s != null) {
            d3 d3Var = this.f38456c;
            l4 l4Var = this.f38463x;
            int i10 = 0;
            if (d3Var != null) {
                canvas.save();
                canvas.translate(this.f38458f, this.h);
                l4.v(l4Var, canvas, this, 0);
                this.f38456c.draw(canvas, this);
                canvas.restore();
                i10 = 1;
            }
            if (this.d != null) {
                canvas.save();
                canvas.translate(this.f38458f, this.h + this.f38459n);
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (this.f38456c != null) {
            sb.append(", ");
            sb.append(this.f38456c.d.getText());
        }
        if (this.d != null) {
            sb.append(", ");
    ...
    public final void onLayout(boolean z4, int i10, int i11, int i12, int i13) {
        int i14 = this.f38457e;
        int dp = AndroidUtilities.dp(8.0f);
        int i15 = this.f38457e;
        mh.d1 d1Var = this.f38454a;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        TL_iv.pageBlockCollage pageblockcollage = this.f38461s;
        if (pageblockcollage != null) {
            ...
            if (i14 > 0) {
                ...
                this.f38457e = 0;
                this.f38458f = AndroidUtilities.dp(18.0f);
            ...
            this.h = dp3;
            TL_iv.pageBlockCollage pageblockcollage2 = this.f38461s;
            TL_iv.RichText richText = pageblockcollage2.caption.text;
            HashSet hashSet = l4.Y0;
            Layout.Alignment alignment = Layout.Alignment.ALIGN_NORMAL;
            l4 l4Var = this.f38463x;
            l1Var = this;
            d3 p10 = l4.p(l4Var, l1Var, null, richText, dp, dp3, pageblockcollage2, alignment, 0, this.f38462w);
            l1Var.f38456c = p10;
            if (p10 != null) {
                int height = l1Var.f38456c.d.getHeight() + AndroidUtilities.dp(4.0f);
                l1Var.f38459n = height;
                measuredHeight = org.telegram.messenger.y3.C(4.0f, height, measuredHeight);
                d3 d3Var = l1Var.f38456c;
                d3Var.f35964s = l1Var.f38458f;
                d3Var.v = l1Var.h;
            } else {
                l1Var.f38459n = 0;
            }
            TL_iv.pageBlockCollage pageblockcollage3 = l1Var.f38461s;
            TL_iv.RichText richText2 = pageblockcollage3.caption.credit;
            if (l1Var.f38462w.D) {
                alignment = org.telegram.ui.Components.kw0.a();
            }
            d3 p11 = l4.p(l4Var, l1Var, null, richText2, dp, 0, pageblockcollage3, alignment, 0, l1Var.f38462w);
            l1Var.d = p11;
            if (p11 != null) {
                measuredHeight += l1Var.d.d.getHeight() + AndroidUtilities.dp(4.0f);
                d3 d3Var2 = l1Var.d;
                d3Var2.f35964s = l1Var.f38458f;
                d3Var2.v = l1Var.h + l1Var.f38459n;
            }
            int dp4 = AndroidUtilities.dp(16.0f) + measuredHeight;
            TL_iv.pageBlockCollage pageblockcollage4 = l1Var.f38461s;
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        int i11 = this.h;
        l4 l4Var = this.f38463x;
        if (!l4.l(l4Var, this.f38462w, motionEvent, this, d3Var, i10, i11)) {
            if (!l4.l(l4Var, this.f38462w, motionEvent, this, this.d, this.f38458f, this.h + this.f38459n) && !super.onTouchEvent(motionEvent)) {
                return false;
            }
            return true;
        }
