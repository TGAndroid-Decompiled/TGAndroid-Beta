...
public final class w11 extends org.telegram.ui.Components.ll0 {
    ...
    public final boolean D(s4.c1 c1Var) {
        ...
        y11 y11Var = this.d;
        if (b10 == y11Var.E) {
            return y11Var.f39772n;
        }
        if (c1Var.b() == y11Var.W) {
            return true;
        }
        switch (c1Var.f42705f) {
            case 0:
            case 2:
            case 5:
            case 6:
        ...
        if (i10 != y11Var.F && i10 != y11Var.G && i10 != y11Var.I && i10 != y11Var.H && i10 != y11Var.Q && i10 != y11Var.R && i10 != y11Var.W) {
            if (i10 != y11Var.N && i10 != y11Var.V && i10 != y11Var.J && i10 != y11Var.S) {
                ...
                if (i10 != y11Var.L && i10 != y11Var.M) {
                    if (i10 == y11Var.f39775w) {
                        return 5;
                    }
                    if (i10 != y11Var.f39776x && i10 != y11Var.X) {
                        if (i10 != y11Var.f39777y && i10 != y11Var.E && i10 != y11Var.O) {
                            return 0;
                        }
                        return 7;
                    }
        ...
        switch (i18) {
            ...
            case 1:
                ...
                if (i10 == y11Var.W) {
                    ...
                    eaVar.setTextColor(y11Var.getThemedColor(org.telegram.ui.ActionBar.j6.f19101q7));
                    return;
                }
            ...
            case 3:
                ...
                while (true) {
                    if (i19 < 9) {
                        if (org.telegram.ui.Cells.y8.f21676f[i19] == i13) {
            ...
            case 6:
                ...
                if (a7Var.f19812c != z10 || a7Var.d != z11) {
                    a7Var.f19812c = z10;
                    a7Var.d = z11;
                    int i20 = a7Var.f19811b;
                    if (i20 == 0) {
            ...
            case 7:
                ...
                if (i10 == y11Var.f39777y) {
                    w8Var.f(LocaleController.getString(R.string.Notifications), y11Var.f39772n, true);
                    return;
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        switch (i10) {
            case 0:
                ...
                l4Var.setBackgroundColor(y11Var.getThemedColor(org.telegram.ui.ActionBar.j6.f18863d6));
                break;
            case 1:
            ...
            if (i10 != 1) {
                if (i10 != 2) {
                    if (i10 != 3) {
                        ...
                        ((org.telegram.ui.Cells.j6) view).b(null, y11Var.f39772n);
                        return;
                    }
                    ((org.telegram.ui.Cells.y8) view).a(null, y11Var.f39772n);
                    return;
                }
                ((org.telegram.ui.Cells.e9) view).c(null, y11Var.f39772n);
                return;
            }
            org.telegram.ui.Cells.ea eaVar = (org.telegram.ui.Cells.ea) view;
            if (c1Var.b() == y11Var.W) {
                ...
                eaVar.a(null, y11Var.f39772n);
                return;
            }
        }
        ((org.telegram.ui.Cells.l4) view).a(null, y11Var.f39772n);
    }
}
