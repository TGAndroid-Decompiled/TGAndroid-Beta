...
public final class x10 extends org.telegram.ui.Components.ll0 {
    public final Context f39347c;
    public final z10 d;

    public x10(z10 z10Var, Context context) {
        this.d = z10Var;
        this.f39347c = context;
    }
    ...
    public final int h() {
        z10 z10Var = this.d;
        ArrayList arrayList = z10Var.f40077f;
        if (arrayList.isEmpty()) {
            return 0;
        }
        return ((int) Math.ceil(arrayList.size() / z10Var.f40092s)) + (!z10Var.N ? 1 : 0);
    }

    @Override
    public final int j(int i10) {
        z10 z10Var = this.d;
        if (i10 < ((int) Math.ceil(z10Var.f40077f.size() / z10Var.f40092s))) {
            return 0;
        }
        return 1;
    }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i11 == 0) {
            ...
            u7Var.setItemsCount(z10Var.f40092s);
            if (i10 != 0) {
                z11 = false;
            }
                ...
                if (i12 < i13) {
                    ...
                    if (i14 < arrayList.size()) {
                        ...
                        if (z10Var.f40087o0.g()) {
                            ...
                            r10Var.f37063b = id2;
                            u7Var.b(i12, z10Var.f40087o0.c(r10Var));
                        } else {
                            u7Var.b(i12, false);
                        }
                    } else {
            ...
            r2Var.O = z10Var.f40088p0;
            r2Var.W(messageObject2.getDialogId(), messageObject2, messageObject2.messageOwner.date, false, false);
            if (z10Var.f40087o0.g()) {
                int id3 = messageObject2.getId();
                r10Var.f37062a = messageObject2.getDialogId();
                r10Var.f37063b = id3;
                r2Var.V(z10Var.f40087o0.c(r10Var), z11);
                return;
            }
            r2Var.V(false, z11);
        } else if (i11 == 1) {
            int i15 = z10Var.f40092s;
            ((org.telegram.ui.Components.t00) view).v = i15 - ((((int) Math.ceil(arrayList.size() / z10Var.f40092s)) * i15) - arrayList.size());
        }
    }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 != 0) {
            ...
            frameLayout.f21456n = paint;
            frameLayout.f21458s = UserConfig.selectedAccount;
            frameLayout.f21457r = 1;
            paint.setColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.Lh, false));
            frameLayout.f21453b = new MessageObject[6];
            frameLayout.f21452a = new org.telegram.ui.Cells.q7[6];
            frameLayout.f21454c = new int[6];
            for (int i11 = 0; i11 < 6; i11++) {
                frameLayout.f21452a[i11] = new org.telegram.ui.Cells.q7(frameLayout, context);
                frameLayout.addView(frameLayout.f21452a[i11]);
                frameLayout.f21452a[i11].setVisibility(4);
                frameLayout.f21452a[i11].setTag(Integer.valueOf(i11));
                frameLayout.f21452a[i11].setOnClickListener(new org.telegram.ui.Cells.a(frameLayout, 10));
                frameLayout.f21452a[i11].setOnLongClickListener(new View.OnLongClickListener() {
                    @Override
