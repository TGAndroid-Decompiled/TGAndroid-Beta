...
public final class x10 extends FrameLayout {
    ...
    public final org.telegram.ui.ActionBar.i5 f39144a;
    public final TextView f39145b;
    public final ImageView f39146c;
    public int d;
    public int e;
    public final View f39147f;
    public final ImageView h;
    public final org.telegram.ui.Components.k30 f39148n;
    public boolean f39149r;
    public final org.telegram.ui.Components.h90 f39150s;
    public boolean v;
    public float f39151w;
    public MessagesController.DialogFilter f39152x;
    public ValueAnimator f39153y;
    ...
    public x10(FiltersSetupActivity filtersSetupActivity, Context context) {
        ...
        i5Var.setEmojiColor(org.telegram.ui.ActionBar.h6.v0(i19, d6Var));
        ...
        addView(i5Var, w7.x5.d(-1, -2.0f, i20, f7, 10.0f, f10, 0.0f));
        TextView textView = new TextView(context);
        this.f39145b = textView;
        textView.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19189z6, false));
        ...
        h90Var.C = true;
        h90Var.f24616t = 2.0f;
        int i22 = org.telegram.ui.ActionBar.h6.f18878i6;
        ...
        h90Var.f24618w.setStrokeWidth(dp);
        h90Var.j(40.0f);
        ...
        addView(k30Var, w7.x5.d(40, 40.0f, i23, f13, 0.0f, f14, 0.0f));
    ...
    public final void onDraw(Canvas canvas) {
        ...
        MessagesController.DialogFilter dialogFilter = this.f39152x;
        if (dialogFilter != null) {
            boolean z10 = dialogFilter.locked;
            if (z10) {
                float f7 = this.f39151w;
                if (f7 != 1.0f) {
                    this.f39151w = f7 + 0.10666667f;
                    invalidate();
                }
            }
            if (!z10) {
                float f10 = this.f39151w;
                if (f10 != 0.0f) {
                    this.f39151w = f10 - 0.10666667f;
                    invalidate();
                }
            }
        }
        float clamp = Utilities.clamp(this.f39151w, 1.0f, 0.0f);
        this.f39151w = clamp;
        org.telegram.ui.ActionBar.i5 i5Var = this.f39144a;
    ...
    public void setOnReorderButtonTouchListener(View.OnTouchListener onTouchListener) {
        this.f39146c.setOnTouchListener(onTouchListener);
    }
}
