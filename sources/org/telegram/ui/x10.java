...
public final class x10 extends bg.b {
    ...
    public final boolean equals(Object obj) {
        ...
        x10 x10Var = (x10) obj;
        int i10 = x10Var.f1808a;
        int i11 = this.f1808a;
        if (i10 != i11) {
            return false;
        }
        if ((i11 == 0 || i11 == 4 || i11 == 3 || i11 == 6) && !TextUtils.equals(this.f39830c, x10Var.f39830c)) {
            return false;
        }
        int i12 = this.f1808a;
        if (i12 == 2) {
            ...
            if (dialogFilter != null && dialogFilter.f16669id != dialogFilter2.f16669id) {
                return false;
            }
        }
        if (i12 == 5) {
            ...
            if (tL_dialogFilterSuggested != null && tL_dialogFilterSuggested.filter.f19189id != tL_dialogFilterSuggested2.filter.f19189id) {
                return false;
            }
        }
        return true;
