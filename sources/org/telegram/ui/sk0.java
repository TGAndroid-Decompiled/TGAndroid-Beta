...
public final class sk0 extends org.telegram.ui.Components.ll0 {
    ...
    public final NotificationsCustomSettingsActivity f37515n;

    public sk0(NotificationsCustomSettingsActivity notificationsCustomSettingsActivity, Context context) {
        this.f37515n = notificationsCustomSettingsActivity;
    ...
    public final void F(String str) {
        ...
        if (this.f37514f != null) {
            Utilities.searchQueue.cancelRunnable(this.f37514f);
            this.f37514f = null;
        }
        if (str == null) {
            this.d.clear();
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        View abVar;
        if (i10 != 0) {
            abVar = new org.telegram.ui.Cells.u3(this.f37513c, null);
            abVar.setBackgroundColor(0);
            abVar.setTag(-33024);
        } else {
            abVar = new org.telegram.ui.Cells.ab(4, 0, this.f37513c, null, false, true);
        }
