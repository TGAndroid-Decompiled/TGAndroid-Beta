...
public final class sk0 extends org.telegram.ui.Components.vl0 {
    public final Context f37364c;
    public ArrayList d = new ArrayList();
    public ArrayList e = new ArrayList();
    public rk0 f37365f;
    public final gg.c2 h;
    public final NotificationsCustomSettingsActivity f37366n;

    public sk0(NotificationsCustomSettingsActivity notificationsCustomSettingsActivity, Context context) {
        this.f37366n = notificationsCustomSettingsActivity;
        this.f37364c = context;
        gg.c2 c2Var = new gg.c2(true);
        this.h = c2Var;
        c2Var.f9689a = new fu(this, 26);
    }
    ...
    public final void F(String str) {
        ...
        if (this.f37365f != null) {
            Utilities.searchQueue.cancelRunnable(this.f37365f);
            this.f37365f = null;
        }
        if (str == null) {
            this.d.clear();
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i10 < this.d.size()) {
            ...
            zaVar.g(vk0Var, charSequence, z10);
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        View zaVar;
        if (i10 != 0) {
            zaVar = new org.telegram.ui.Cells.v3(this.f37364c, null);
            zaVar.setBackgroundColor(0);
            zaVar.setTag(-33024);
        } else {
            zaVar = new org.telegram.ui.Cells.za(4, 0, this.f37364c, null, false, true);
        }
