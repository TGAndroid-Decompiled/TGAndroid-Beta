...
public final class nl implements org.telegram.ui.Components.ti {
    ...
    public final void C1(int i10, boolean z10, boolean z11, int i11, int i12, long j3, boolean z12, boolean z13, long j10) {
        ...
        if (znVar.getParentActivity() != null && (g4Var = znVar.J1) != null) {
            ...
            if (i10 != 8 && i10 != 7 && (i10 != 4 || g4Var.f29108j0.getSelectedPhotos().isEmpty())) {
            ...
            HashMap<Object, Object> selectedPhotos = znVar.J1.f29108j0.getSelectedPhotos();
            ArrayList<Object> selectedPhotosOrder = znVar.J1.f29108j0.getSelectedPhotosOrder();
            if (!selectedPhotos.isEmpty()) {
                ...
                while (i15 < ceil) {
                    ...
                    if (messageObject2 != null && messageObject2.needResendWhenEdit()) {
                        ...
                        i14 = i20;
                        i13 = i19;
                        SendMessagesHelper.prepareSendingMedia(accountInstance, arrayList, j11, messageObject3, messageObject4, null, pnVar, z16, z10, null, z11, i11, i12, znVar.R3, z14, null, znVar.C8(), j3, z12, j10, znVar.N8(), messageSuggestionParams2);
                    } else {
                        i13 = ceil;
                        i14 = i15;
                        AccountInstance accountInstance2 = znVar.getAccountInstance();
                        long j12 = znVar.T5;
                        MessageObject messageObject5 = znVar.f40430n5;
                        ...
                        SendMessagesHelper.prepareSendingMedia(accountInstance2, arrayList2, j12, messageObject5, messageObject6, null, pnVar2, z15, z10, znVar.p5, z11, i11, i12, znVar.R3, z14, null, znVar.C8(), j3, z12, j10, znVar.N8(), znVar.f40344g5);
                    }
                    i15 = i14 + 1;
                    ceil = i13;
