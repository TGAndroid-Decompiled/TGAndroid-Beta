...
public final class pa0 implements org.telegram.ui.Components.rd0, org.telegram.ui.ActionBar.b2 {
    public final LaunchActivity f36580a;

    public pa0(LaunchActivity launchActivity) {
        this.f36580a = launchActivity;
    }

    @Override
    public void f(org.telegram.ui.ActionBar.c2 c2Var, int i10) {
        Pattern pattern = LaunchActivity.B1;
        MessagesController.getInstance(this.f36580a.O).performLogout(2);
    }
    ...
    public void i(org.telegram.ui.Components.sd0 sd0Var) {
        ...
        LaunchActivity launchActivity = this.f36580a;
        ...
        launchActivity.f30858q0.getView().setVisibility(0);
        ...
        if (AndroidUtilities.isTablet()) {
            launchActivity.f30860r0.U(true, true);
            launchActivity.f30862s0.U(true, true);
            if (launchActivity.f30860r0.getView().getVisibility() == 4) {
                launchActivity.f30860r0.getView().setVisibility(0);
            }
            launchActivity.f30862s0.getView().setVisibility(0);
        }
