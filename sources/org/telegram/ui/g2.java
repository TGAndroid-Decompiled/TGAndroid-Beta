...
public final class g2 extends FrameLayout implements org.telegram.ui.Cells.p9, e3 {
    public final v70 f36527a;
    public final g4 f36528b;
    public b3 f36529c;
    public final ji.z3 d;
    public final f2 f36530e;
    public TL_iv.pageBlockPreformatted f36531f;
    ...
    public int getBoundLeft() {
        ...
        int a2 = this.f36529c.a() + AndroidUtilities.dp(16.0f);
    ...
    public int getBoundRight() {
        ...
        int b10 = this.f36529c.b() + AndroidUtilities.dp(16.0f);
        this.f36527a.getClass();
    ...
    public int getLastLineBoundRight() {
        ...
        int c10 = this.f36529c.c() + AndroidUtilities.dp(16.0f);
        this.f36527a.getClass();
    ...
    public final void onDraw(Canvas canvas) {
        ...
        canvas.drawRect(0.0f, AndroidUtilities.dp(8.0f), getMeasuredWidth(), getMeasuredHeight() - AndroidUtilities.dp(8.0f), i4.f37202p1);
    }
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        accessibilityNodeInfo.setText(i4.i(R.string.AccDescrIVCode, i4.j(this.f36527a, this.f36528b, b3Var)));
    }
    ...
    public void setBlock(TL_iv.pageBlockPreformatted pageblockpreformatted) {
        this.h = null;
        this.f36531f = pageblockpreformatted;
        this.d.setScrollX(0);
        this.f36530e.requestLayout();
    }
}
