...
public final class jo0 implements vo0 {
    public final Runnable f37823a;
    public final xo0 f37824b;

    public jo0(xo0 xo0Var, Runnable runnable) {
        this.f37824b = xo0Var;
        this.f37823a = runnable;
    }

    @Override
    public final boolean c(String str, String str2, boolean z10, TLRPC.TL_inputPaymentCredentialsGooglePay tL_inputPaymentCredentialsGooglePay, TLRPC.TL_paymentSavedCredentialsCard tL_paymentSavedCredentialsCard) {
        String str3;
        xo0 xo0Var = this.f37824b;
        xo0Var.f42845y0 = tL_paymentSavedCredentialsCard;
        xo0Var.f42841w0 = str;
        xo0Var.U0 = z10;
        xo0Var.f42843x0 = str2;
        ...
        if (d9Var != null) {
            ...
            String str4 = xo0Var.f42843x0;
            if (str4 != null && str4.length() > 1) {
                str3 = xo0Var.f42843x0.substring(0, 1).toUpperCase() + xo0Var.f42843x0.substring(1);
            } else {
                str3 = xo0Var.f42843x0;
            }
        ...
        Runnable runnable = this.f37823a;
        if (runnable != null) {
            runnable.run();
        }
        return false;
