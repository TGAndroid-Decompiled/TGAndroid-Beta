...
public final class jo0 implements vo0 {
    public final Runnable f34923a;
    public final xo0 f34924b;
    ...
    public final boolean c(String str, String str2, boolean z10, TLRPC.TL_inputPaymentCredentialsGooglePay tL_inputPaymentCredentialsGooglePay, TLRPC.TL_paymentSavedCredentialsCard tL_paymentSavedCredentialsCard) {
        String str3;
        xo0 xo0Var = this.f34924b;
        xo0Var.f39577y0 = tL_paymentSavedCredentialsCard;
        xo0Var.f39573w0 = str;
        xo0Var.U0 = z10;
        xo0Var.f39575x0 = str2;
        ...
        if (d9Var != null) {
            ...
            String str4 = xo0Var.f39575x0;
            if (str4 != null && str4.length() > 1) {
                str3 = xo0Var.f39575x0.substring(0, 1).toUpperCase() + xo0Var.f39575x0.substring(1);
            } else {
                str3 = xo0Var.f39575x0;
            }
        ...
        Runnable runnable = this.f34923a;
        if (runnable != null) {
            runnable.run();
        }
        return false;
