...
public final class bq implements NotificationCenter.NotificationCenterDelegate {
    ...
    public long Z;
    public int f31316a;
    public View f31317a0;
    public int f31318b;
    public boolean f31319b0;
    public int f31320c;
    public final org.telegram.ui.Components.br f31321c0;
    public float d;
    public final int[] f31322d0;
    public final Paint e;
    public final int f31323e0;
    public final TextPaint f31324f;
    public final int f31325f0;
    public final int f31326g0;
    public final TextPaint h;
    public final long f31327h0;
    public final long f31328i0;
    public final org.telegram.ui.ActionBar.f6 f31329j0;
    public org.telegram.ui.Components.p5 f31330k0;
    public final Paint f31331n;
    public final Path f31332r;
    public StaticLayout f31333s;
    public StaticLayout v;
    public StaticLayout f31334w;
    public int f31335x;
    public int f31336y;
    ...
    public static TLRPC.Dialog c(long j3, int i10, int i11, boolean z10, int[] iArr) {
        ...
        if (dialogs != null) {
            for (int i13 = 0; i13 < dialogs.size(); i13++) {
                ...
                TLRPC.Chat chat = messagesController.getChat(Long.valueOf(-dialog.f17199id));
                if (chat != null && dialog.f17199id != j3 && dialog.unread_count > 0 && DialogObject.isChannel(dialog) && !chat.megagroup && !messagesController.isPromoDialog(dialog.f17199id, false) && messagesController.getRestrictionReason(chat.restriction_reason) == null) {
                    return dialog;
                }
            }
            if (z10) {
                if (i11 != 0) {
                    ...
                    while (i14 < messagesController.dialogFilters.size()) {
                        int i15 = messagesController.dialogFilters.get(i14).f14645id;
                        if (i11 != i15) {
                            long j11 = j3;
                            int i16 = i10;
                            int[] iArr3 = iArr;
    ...
    public final void a(Canvas canvas, wj wjVar, float f7, float f10) {
        ...
        if (this.f31317a0 != wjVar) {
            this.f31317a0 = wjVar;
            org.telegram.ui.Components.p5 p5Var = this.f31330k0;
            if (p5Var != null) {
                p5Var.a(wjVar);
            }
        }
        org.telegram.ui.Components.br brVar2 = this.f31321c0;
        brVar2.H = wjVar;
        RectF rectF3 = brVar2.f21872f;
        ...
        org.telegram.ui.ActionBar.j6.q(0.0f, wjVar.getMeasuredHeight() - dp, this.f31320c, wjVar.getMeasuredHeight());
        int i17 = org.telegram.ui.ActionBar.j6.f18023ic;
        org.telegram.ui.ActionBar.f6 f6Var = this.f31329j0;
        int v02 = org.telegram.ui.ActionBar.j6.v0(i17, f6Var);
        TextPaint textPaint3 = this.f31324f;
        ...
        org.telegram.ui.ActionBar.j6.f17995h2.setAlpha((int) (alpha2 * f11));
        ...
        if (f28 >= 1.0f && !this.R) {
            ...
            if (this.W) {
                ...
                if (a12) {
                    int alpha6 = org.telegram.ui.ActionBar.j6.f17995h2.getAlpha();
                    org.telegram.ui.ActionBar.j6.f17995h2.setAlpha((int) (alpha6 * f14));
                    float f40 = this.d;
                    canvas2.drawRoundRect(rectF4, f40, f40, org.telegram.ui.ActionBar.j6.f17995h2);
                    org.telegram.ui.ActionBar.j6.f17995h2.setAlpha(alpha6);
                }
            }
            ...
            canvas2.restore();
            if (this.R) {
                float a2 = org.telegram.ui.Cells.r6.a(f15 - AndroidUtilities.dp(2.0f), this.K, (1.0f - this.K) * (((-AndroidUtilities.dp(8.0f)) - (AndroidUtilities.dp2(8.0f) * f7)) - f16), f19);
        ...
        if (this.f31333s != null && this.K > 0.0f) {
            ...
            float f49 = (i16 - this.f31335x) / 2.0f;
            rectF5.set(f49, dp13, this.f31320c - f49, this.f31333s.getHeight() + dp13);
            ...
            if (a14) {
                canvas2.drawRoundRect(rectF5, AndroidUtilities.dp(15.0f), AndroidUtilities.dp(15.0f), org.telegram.ui.ActionBar.j6.f17995h2);
            }
            canvas2.save();
            canvas2.translate((this.f31320c - this.f31335x) / 2.0f, dp13);
            this.f31333s.draw(canvas2);
            canvas2.restore();
        } else {
            textPaint2 = textPaint;
        }
        if (!this.R && f16 > 0.0f) {
            float a10 = org.telegram.ui.Cells.r6.a((-f20) + AndroidUtilities.dp(4.0f), this.K, (1.0f - this.K) * (((-AndroidUtilities.dp(8.0f)) - (AndroidUtilities.dp2(8.0f) * f7)) - f16), f19);
            org.telegram.ui.Components.p5 p5Var2 = this.f31330k0;
            if (p5Var2 == null || (imageReceiver = p5Var2.f26033k) == null) {
            ...
            if (this.X && imageReceiver2.getDrawable() != null && (imageReceiver2.getDrawable() instanceof org.telegram.ui.Components.vq) && (((org.telegram.ui.Components.vq) imageReceiver2.getDrawable()).f28574b instanceof org.telegram.ui.Components.v80)) {
                ((org.telegram.ui.Components.v80) ((org.telegram.ui.Components.vq) imageReceiver2.getDrawable()).f28574b).f27884i = f7;
            }
            if (this.K > 0.0f && this.f31319b0) {
                ...
                brVar3.e(brVar3.f21884s);
                canvas2.scale(f52, f52, (brVar3.f21884s / 2.0f) + brVar3.A + AndroidUtilities.dp(12.0f) + f18, (a10 - AndroidUtilities.dp(6.0f)) + AndroidUtilities.dp(14.0f));
                canvas2.translate(AndroidUtilities.dp(12.0f) + f18, a10 - AndroidUtilities.dp(6.0f));
                float f53 = brVar3.C;
                float f54 = brVar3.f21877l;
                if (f54 != 1.0f) {
                    f23 = 6.0f;
                    int i22 = brVar3.f21871c;
                    if (i22 == 0 || i22 == 1) {
                        rectF2 = rectF;
                        f24 = 14.0f;
                        brVar3.e(brVar3.f21884s);
                        float dp14 = (brVar3.f21888x - AndroidUtilities.dp(f53 * 2.0f)) / 2.0f;
                        float f55 = brVar3.B;
                        rectF2.set(f55, dp14, brVar3.f21884s + f55 + AndroidUtilities.dp(11.0f), AndroidUtilities.dp(23.0f) + dp14);
                    } else {
                        float f56 = f54 * 2.0f;
                        if (f56 > 1.0f) {
                            f56 = 1.0f;
                        }
                        float dp15 = (brVar3.f21888x - AndroidUtilities.dp(f53 * 2.0f)) / 2.0f;
                        int i23 = brVar3.f21884s;
                        int i24 = brVar3.f21883r;
                        if (i23 == i24) {
                            z10 = i23;
                            f24 = 14.0f;
                        } else {
                    ...
                    f24 = 14.0f;
                    brVar3.e(brVar3.f21884s);
                    float dp16 = (brVar3.f21888x - AndroidUtilities.dp(f53 * 2.0f)) / 2.0f;
                    float f58 = brVar3.B;
                    rectF2.set(f58, dp16, brVar3.f21884s + f58 + AndroidUtilities.dp(11.0f), AndroidUtilities.dp(23.0f) + dp16);
                }
                rectF2.inset(-AndroidUtilities.dp(2.0f), -AndroidUtilities.dp(2.0f));
                canvas2.drawRoundRect(rectF2, rectF2.height() / 2.0f, rectF2.height() / 2.0f, this.f31331n);
                canvas2.restore();
                canvas2.save();
                float f59 = this.K;
                brVar3.e(brVar3.f21884s);
                canvas2.scale(f59, f59, (brVar3.f21884s / 2.0f) + brVar3.A + AndroidUtilities.dp(12.0f) + f18, (a10 - AndroidUtilities.dp(f23)) + AndroidUtilities.dp(f24));
        ...
        org.telegram.ui.ActionBar.j6.f17995h2.setAlpha(i12);
        textPaint2.setAlpha(alpha3);
        paint.setAlpha(alpha4);
    }

    public final void b(Canvas canvas, int i10, int i11) {
        int v02 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Xk, this.f31329j0);
        ...
        if (this.v != null) {
            ...
            if (f7 < 1.0f) {
                ...
                canvas.save();
                canvas.translate((this.f31320c - this.f31336y) / 2.0f, height);
                this.v.draw(canvas);
                canvas.restore();
            }
        }
        if (this.f31334w != null) {
            float f10 = this.K;
            if (f10 > 0.0f) {
                textPaint.setAlpha((int) (alpha2 * f10 * this.S));
                float dp = ((1.0f - this.K) * AndroidUtilities.dp(10.0f)) + (((i11 - i10) - this.f31334w.getHeight()) / 2.0f) + i10;
                canvas.save();
                canvas.translate((this.f31320c - this.E) / 2.0f, dp);
                this.f31334w.draw(canvas);
                canvas.restore();
            }
        }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        TLRPC.Dialog dialog;
        if (this.Z != 0 && (dialog = (TLRPC.Dialog) MessagesController.getInstance(this.f31323e0).dialogs_dict.f(this.Z)) != null) {
            int i12 = dialog.unread_count;
            boolean z10 = true;
            this.f31321c0.c(i12, true);
            if (i12 <= 0) {
                z10 = false;
            }
            this.f31319b0 = z10;
            View view = this.f31317a0;
            if (view != null) {
                view.invalidate();
            }
        }
    ...
    public final void f() {
        ...
        org.telegram.ui.Components.p5 p5Var = this.f31330k0;
        if (p5Var != null && (view = this.f31317a0) != null) {
            p5Var.a(view);
        }
        NotificationCenter.getInstance(this.f31323e0).addObserver(this, NotificationCenter.updateInterfaces);
    }
    ...
    public final void g(final View view, boolean z10) {
        ...
        if (z10) {
            ...
            org.telegram.ui.Components.wr wrVar = org.telegram.ui.Components.wr.f28822j;
            ...
            this.J = animatorSet2;
            animatorSet2.addListener(new bi.u3(13, this, view));
        ...
        ofFloat5.setInterpolator(org.telegram.ui.Components.wr.f28819f);
    ...
    public final void h() {
        ...
        this.V = false;
        this.H = null;
        TLRPC.Dialog c10 = c(this.f31328i0, this.f31325f0, this.f31326g0, true, this.f31322d0);
        if (c10 != null) {
            this.Z = c10.f17199id;
            int[] iArr = this.f31322d0;
            if (iArr[0] == 1) {
                z10 = true;
            } else {
                z10 = false;
            ...
            this.f31318b = iArr[2];
            this.R = false;
            int i10 = this.f31323e0;
            TLRPC.Chat chat = MessagesController.getInstance(i10).getChat(Long.valueOf(-c10.f17199id));
            this.G = chat;
            if (chat == null) {
                this.G = MessagesController.getInstance(i10).getChat(Long.valueOf(c10.f17199id));
            }
            ...
            MessagesController.getInstance(i10).ensureMessagesLoaded(c10.f17199id, 0, null);
            int i11 = c10.unread_count;
            this.f31321c0.c(i11, false);
            if (i11 > 0) {
                z11 = true;
            }
            this.f31319b0 = z11;
    ...
    public final void i(TLRPC.Chat chat) {
        ...
        int i11 = this.f31323e0;
        g9Var.k(i11, chat2);
        this.F.setImage(ImageLocation.getForChat(this.G, 1), "50_50", g9Var, null, UserConfig.getInstance(0).getCurrentUser(), 0);
        MessagesController.getInstance(i11).ensureMessagesLoaded(-chat.f17195id, 0, null);
        TLRPC.Dialog dialog = MessagesController.getInstance(i11).getDialog(-chat.f17195id);
        if (dialog == null) {
            i10 = 0;
        } else {
            i10 = dialog.unread_count;
        }
        this.f31321c0.c(i10, false);
        if (i10 > 0) {
            z11 = true;
        }
        this.f31319b0 = z11;
    ...
    public final void j() {
        ...
        int i10 = this.f31323e0;
        ArrayList<TLRPC.TL_forumTopic> topics = MessagesController.getInstance(i10).getTopicsController().getTopics(-this.f31328i0);
        if (topics != null && topics.size() > 1) {
            tL_forumTopic = null;
            for (int i11 = 0; i11 < topics.size(); i11++) {
                TLRPC.TL_forumTopic tL_forumTopic2 = topics.get(i11);
                if (tL_forumTopic2.f17247id != this.f31327h0 && !tL_forumTopic2.hidden && tL_forumTopic2.unread_count > 0 && (tL_forumTopic == null || ((message = tL_forumTopic2.topMessage) != null && (message2 = tL_forumTopic.topMessage) != null && message.date > message2.date))) {
        ...
        if (tL_forumTopic != null) {
            ...
            int i12 = tL_forumTopic.f17247id;
            org.telegram.ui.ActionBar.f6 f6Var = this.f31329j0;
            if (i12 == 1) {
                View view3 = this.f31317a0;
                if (view3 != null && (p5Var2 = this.f31330k0) != null) {
                    p5Var2.o(view3);
                }
                this.f31330k0 = null;
                ...
                org.telegram.ui.Components.p5 p5Var3 = this.f31330k0;
                if (p5Var3 == null || p5Var3.i() != tL_forumTopic.icon_emoji_id) {
                    org.telegram.ui.Components.p5 p5Var4 = this.f31330k0;
                    if (p5Var4 != null && (view = this.f31317a0) != null) {
                        p5Var4.o(view);
                    }
                    org.telegram.ui.Components.p5 p5Var5 = new org.telegram.ui.Components.p5(22, i10, tL_forumTopic.icon_emoji_id);
                    this.f31330k0 = p5Var5;
                    p5Var5.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f18023ic, f6Var), PorterDuff.Mode.SRC_IN));
                }
                org.telegram.ui.Components.p5 p5Var6 = this.f31330k0;
                if (p5Var6 != null && (view2 = this.f31317a0) != null) {
                    p5Var6.a(view2);
                }
                imageReceiver.setImageBitmap((Bitmap) null);
            } else {
                View view4 = this.f31317a0;
                if (view4 != null && (p5Var = this.f31330k0) != null) {
                    p5Var.o(view4);
                }
                this.f31330k0 = null;
