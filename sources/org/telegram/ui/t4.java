...
public abstract class t4 extends View implements org.telegram.ui.Components.sh0 {
    ...
    public int P;
    public String Q;
    public final RectF f41431a;
    public int f41432b;
    public final Rect f41433c;
    public final Rect d;
    public final RectF f41434e;
    public final GradientDrawable f41435f;
    public final GradientDrawable h;
    public final float[] f41436n;
    public final Paint f41437r;
    public final Paint f41438s;
    public final Paint v;
    public final Path f41439w;
    public final RectF f41440x;
    public final GradientDrawable[] f41441y;

    public t4(Context context) {
        super(context);
        GradientDrawable.Orientation orientation;
        this.f41431a = new RectF();
        this.f41432b = 1;
        this.f41433c = new Rect();
        this.d = new Rect();
        this.f41434e = new RectF();
        this.f41436n = new float[]{0.0f, 1.0f};
        this.f41439w = new Path();
        this.f41440x = new RectF();
        this.f41441y = new GradientDrawable[2];
        ...
        for (int i10 = 0; i10 < 2; i10++) {
            ...
            this.f41441y[i10] = new GradientDrawable(orientation, new int[]{838860800, 0});
            this.f41441y[i10].setShape(0);
        }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        Path path = this.f41439w;
        path.reset();
        RectF rectF = this.f41440x;
