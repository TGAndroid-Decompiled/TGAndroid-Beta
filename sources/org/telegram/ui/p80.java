...
public final class p80 extends ActionBarPopupWindow$ActionBarPopupWindowLayout {
    ...
    public final ArrayList f39425a0;
    public final org.telegram.ui.Components.l00 f39426b0;
    public int f39427c0;
    public final CacheByChatsController f39428d0;
    public n80 f39429e0;
    public ArrayList f39430f0;
    public final org.telegram.ui.ActionBar.n2 f39431g0;
    public final FrameLayout f39432h0;

    public p80(Context context, org.telegram.ui.ActionBar.n2 n2Var) {
        super(context, null);
        ArrayList arrayList = new ArrayList();
        this.f39425a0 = arrayList;
        this.f39431g0 = n2Var;
        this.f39428d0 = n2Var.getMessagesController().getCacheByChatsController();
        setFitItems(true);
        ...
        this.f39432h0 = frameLayout;
        frameLayout.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.H8, false));
        View view = new View(context);
        view.setBackground(org.telegram.ui.ActionBar.j6.U0(context, R.drawable.greydivider, org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20627b7, null)));
        ...
        this.f39426b0 = l00Var;
        a(l00Var, w7.x5.n(-1, 48));
        l00Var.setOnClickListener(new tv(12, this, n2Var));
        for (int i11 = 0; i11 < this.f39425a0.size(); i11++) {
            ((o80) this.f39425a0.get(i11)).f39133a.setOnClickListener(new di.o4(this, ((o80) this.f39425a0.get(i11)).f39134b, 18));
        }
    ...
    public final void f() {
        if (this.f39430f0 != null) {
            ((org.telegram.ui.Components.l9) this.f39426b0.d).setTranslationX((3 - Math.min(3, this.f39430f0.size())) * AndroidUtilities.dp(12.0f));
        }
    }
    ...
    public final void g(boolean z10) {
        ...
        this.f39426b0.setVisibility(8);
    }

    public void setCallback(n80 n80Var) {
        this.f39429e0 = n80Var;
    }
}
