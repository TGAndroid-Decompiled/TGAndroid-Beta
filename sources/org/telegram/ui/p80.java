...
public final class p80 extends ActionBarPopupWindow$ActionBarPopupWindowLayout {
    ...
    public final ArrayList f36376a0;
    public final org.telegram.ui.Components.l00 f36377b0;
    public int f36378c0;
    public final CacheByChatsController f36379d0;
    public n80 f36380e0;
    public ArrayList f36381f0;
    public final org.telegram.ui.ActionBar.n2 f36382g0;
    public final FrameLayout f36383h0;

    public p80(Context context, org.telegram.ui.ActionBar.n2 n2Var) {
        super(context, null);
        ArrayList arrayList = new ArrayList();
        this.f36376a0 = arrayList;
        this.f36382g0 = n2Var;
        this.f36379d0 = n2Var.getMessagesController().getCacheByChatsController();
        setFitItems(true);
        ...
        this.f36383h0 = frameLayout;
        frameLayout.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.H8, false));
        View view = new View(context);
        view.setBackground(org.telegram.ui.ActionBar.j6.U0(context, R.drawable.greydivider, org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19026b7, null)));
        ...
        this.f36377b0 = l00Var;
        a(l00Var, w7.y5.n(-1, 48));
        l00Var.setOnClickListener(new tv(12, this, n2Var));
        for (int i11 = 0; i11 < this.f36376a0.size(); i11++) {
            ((o80) this.f36376a0.get(i11)).f36124a.setOnClickListener(new ci.o4(this, ((o80) this.f36376a0.get(i11)).f36125b, 18));
        }
    ...
    public final void f() {
        if (this.f36381f0 != null) {
            ((org.telegram.ui.Components.k9) this.f36377b0.d).setTranslationX((3 - Math.min(3, this.f36381f0.size())) * AndroidUtilities.dp(12.0f));
        }
    }
    ...
    public final void g(boolean z10) {
        ...
        this.f36377b0.setVisibility(8);
    }

    public void setCallback(n80 n80Var) {
        this.f36380e0 = n80Var;
    }
}
