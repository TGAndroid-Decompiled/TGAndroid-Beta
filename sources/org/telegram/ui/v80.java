...
public final class v80 implements Runnable {
    ...
    public final void run() {
        ...
        LaunchActivity launchActivity = this.f38433b;
        switch (i10) {
            case 0:
                ...
                if (UserConfig.getInstance(launchActivity.O).isClientActivated()) {
                    try {
                        ...
                        if ((((i11 == 2 || i11 == 1) && Math.abs(launchActivity.f31141w1 - System.currentTimeMillis()) > 240000) || Math.abs(globalMainSettings.getLong("last_space_check", 0L) - System.currentTimeMillis()) >= 259200000) && (directory = FileLoader.getDirectory(4)) != null) {
                            StatFs statFs = new StatFs(directory.getAbsolutePath());
                            long availableBlocksLong = statFs.getAvailableBlocksLong() * statFs.getBlockSizeLong();
                            if (i11 > 0 || availableBlocksLong < 52428800) {
                                if (i11 > 0) {
                                    launchActivity.f31141w1 = System.currentTimeMillis();
                                }
