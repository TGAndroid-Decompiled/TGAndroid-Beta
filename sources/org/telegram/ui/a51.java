...
public final class a51 extends FrameLayout {
    public final Paint f31700a;
    public final Paint f31701b;
    public final RectF f31702c;
    public final org.telegram.ui.Components.x11 d;
    public boolean e;
    public long f31703f;
    public long h;
    public final org.telegram.ui.Components.xi0 f31704n;
    public final TextPaint f31705r;
    public StaticLayout f31706s;
    public float v;
    public float f31707w;
    public final SecretMediaViewer f31708x;

    public a51(SecretMediaViewer secretMediaViewer, Activity activity) {
        super(activity);
        this.f31708x = secretMediaViewer;
        this.f31702c = new RectF();
        this.d = new org.telegram.ui.Components.x11();
        this.f31705r = new TextPaint(1);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float max;
        MessageObject messageObject = this.f31708x.f31454h0;
        if (messageObject != null) {
            ...
            if (message.destroyTime != 0 || message.ttl == Integer.MAX_VALUE) {
                if (this.f31703f == 0) {
                    ...
                    max = ((float) Math.max(0L, this.f31703f - (System.currentTimeMillis() + (ConnectionsManager.getInstance(secretMediaViewer.f31436a).getTimeDifference() * 1000)))) / (((float) this.h) * 1000.0f);
                }
                boolean z10 = this.e;
                Paint paint = this.f31701b;
                Paint paint2 = this.f31700a;
                float f7 = max;
                RectF rectF = this.f31702c;
                if (z10) {
                    canvas.save();
                    canvas.translate(rectF.centerX() - (this.v / 2.0f), rectF.centerY() - (this.f31707w / 2.0f));
                    this.f31706s.draw(canvas);
                    canvas.restore();
                    ...
                    org.telegram.ui.Components.xi0 xi0Var = this.f31704n;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f31702c.set(measuredWidth - dpf2, measuredHeight - dpf2, measuredWidth + dpf2, dpf2 + measuredHeight);
