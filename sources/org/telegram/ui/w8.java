...
public final class w8 extends org.telegram.ui.Components.ov0 {
    public final int f41794w0;
    public final Object f41795x0;
    ...
    public void J(Canvas canvas, float f7, Rect rect, Paint paint, boolean z10) {
        switch (this.f41794w0) {
            case 0:
                k9 k9Var = (k9) this.f41795x0;
                ...
                return;
            case 3:
                ContactsActivity contactsActivity = (ContactsActivity) this.f41795x0;
                if (Build.VERSION.SDK_INT >= 29 && SharedConfig.chatBlurEnabled() && contactsActivity.f33365u0 != null) {
                    canvas.save();
                    canvas.translate(0.0f, -f7);
                    contactsActivity.f33365u0.v(canvas, rect.left, rect.top + f7, rect.right, rect.bottom + f7);
                    canvas.restore();
        ...
        switch (this.f41794w0) {
            case 0:
                ...
                if (Build.VERSION.SDK_INT >= 31 && fVar != null) {
                    ...
                    if (dVar2 != null && !dVar2.f10658n) {
                        RecordingCanvas a2 = dVar2.a(measuredWidth, measuredHeight);
                        a2.drawColor(k9Var.getThemedColor(org.telegram.ui.ActionBar.j6.f20608a7));
                    ...
                    if (dVar != null && !dVar.f10658n) {
                        ...
                        a10.drawColor(k9Var.getThemedColor(org.telegram.ui.ActionBar.j6.f20608a7));
                        if (SharedConfig.chatBlurEnabled()) {
                            fVar.b(a10, -2);
                        }
                        dVar.b();
            ...
            case 3:
                ContactsActivity contactsActivity = (ContactsActivity) this.f41795x0;
                gh.d dVar3 = contactsActivity.f33366v0;
                gh.d dVar4 = contactsActivity.f33365u0;
                bh.f fVar2 = contactsActivity.f33364t0;
                if (Build.VERSION.SDK_INT >= 31 && fVar2 != null) {
                    contactsActivity.g0();
                    int measuredWidth2 = getMeasuredWidth();
                    int measuredHeight2 = getMeasuredHeight();
                    if (dVar4 != null && !dVar4.f10658n) {
                        RecordingCanvas a11 = dVar4.a(measuredWidth2, measuredHeight2);
                        a11.drawColor(contactsActivity.getThemedColor(org.telegram.ui.ActionBar.j6.f20664d6));
                        if (SharedConfig.chatBlurEnabled()) {
                            fVar2.b(a11, -3);
                        }
                        dVar4.b();
                    }
                    if (dVar3 != null && !dVar3.f10658n) {
                        RecordingCanvas a12 = dVar3.a(measuredWidth2, measuredHeight2);
                        a12.drawColor(contactsActivity.getThemedColor(org.telegram.ui.ActionBar.j6.f20664d6));
                        if (SharedConfig.chatBlurEnabled()) {
                            fVar2.b(a12, -2);
                        }
                        dVar3.b();
            ...
            case 7:
                ...
                if (Build.VERSION.SDK_INT >= 31 && fVar3 != null) {
                    ...
                    if (dVar6 != null && !dVar6.f10658n) {
                        RecordingCanvas a13 = dVar6.a(measuredWidth3, measuredHeight3);
                        a13.drawColor(i91Var.getThemedColor(org.telegram.ui.ActionBar.j6.f20664d6));
                        if (SharedConfig.chatBlurEnabled()) {
                            fVar3.b(a13, -3);
                        }
                        dVar6.b();
                    }
                    if (dVar5 != null && !dVar5.f10658n) {
                        RecordingCanvas a14 = dVar5.a(measuredWidth3, measuredHeight3);
                        a14.drawColor(i91Var.getThemedColor(org.telegram.ui.ActionBar.j6.f20664d6));
                        if (SharedConfig.chatBlurEnabled()) {
                            fVar3.b(a14, -2);
                        }
                        dVar5.b();
                ...
                super.dispatchDraw(canvas);
                if (!i91Var.M) {
                    AndroidUtilities.drawNavigationBarProtection(canvas, this, i91Var.getThemedColor(org.telegram.ui.ActionBar.j6.f20664d6), i91Var.S);
                    return;
                }
                return;
            case 8:
                ...
                if (Build.VERSION.SDK_INT >= 31 && fVar4 != null) {
                    ...
                    if (dVar8 != null && !dVar8.f10658n) {
                        RecordingCanvas a15 = dVar8.a(measuredWidth4, measuredHeight4);
                        a15.drawColor(bb1Var.getThemedColor(org.telegram.ui.ActionBar.j6.f20664d6));
                        if (SharedConfig.chatBlurEnabled()) {
                            fVar4.b(a15, -3);
                        }
                        dVar8.b();
                    }
                    if (dVar7 != null && !dVar7.f10658n) {
                        RecordingCanvas a16 = dVar7.a(measuredWidth4, measuredHeight4);
                        a16.drawColor(bb1Var.getThemedColor(org.telegram.ui.ActionBar.j6.f20664d6));
                        if (SharedConfig.chatBlurEnabled()) {
                            fVar4.b(a16, -2);
                        }
                        dVar7.b();
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        switch (this.f41794w0) {
            case 1:
                if (motionEvent.getY() < ((org.telegram.ui.Components.qb0) this.f41795x0).T) {
                    return false;
                }
    ...
    public Drawable getNewDrawable() {
        switch (this.f41794w0) {
            case 1:
                Drawable d = ((ao) ((org.telegram.ui.Components.qb0) this.f41795x0).f29663c0.F).d();
                if (d == null) {
    ...
    public org.telegram.ui.ActionBar.f6 getResourceProvider() {
        switch (this.f41794w0) {
            case 2:
                return ((org.telegram.ui.Components.a01) this.f41795x0).f24204c;
            default:
    ...
    public void onMeasure(int i10, int i11) {
        ...
        switch (this.f41794w0) {
            case 0:
                ...
                ((ViewGroup.MarginLayoutParams) k9Var.f37964b.getLayoutParams()).topMargin = k9.d0(k9Var).getMeasuredHeight();
                ((ViewGroup.MarginLayoutParams) k9Var.f37974r.getLayoutParams()).topMargin = k9.a0(k9Var).getMeasuredHeight();
                k9Var.i0();
            ...
            case 2:
                super.onMeasure(i10, i11);
                setMeasuredDimension(View.MeasureSpec.getSize(i10), ((org.telegram.ui.Components.a01) this.f41795x0).d.getMeasuredHeight() + AndroidUtilities.dp(24.0f));
                return;
            case 3:
                ContactsActivity contactsActivity = (ContactsActivity) this.f41795x0;
                ...
                ((ViewGroup.MarginLayoutParams) contactsActivity.f33345e.getLayoutParams()).topMargin = AndroidUtilities.dp(48.0f) + kVar2.getMeasuredHeight();
                ...
                return;
            case 4:
                xb0 xb0Var = (xb0) this.f41795x0;
                super.onMeasure(i10, i11);
                R();
                int i17 = this.f29207f;
                if (i17 != 0 && i17 < AndroidUtilities.dp(20.0f)) {
                    xb0Var.F.clearFocus();
                    xb0Var.K.clearFocus();
                }
                FrameLayout frameLayout = xb0Var.H;
                if (this.f29207f > AndroidUtilities.dp(20.0f)) {
                    i12 = 8;
                } else {
                    i12 = 0;
                }
            ...
            case 5:
                ...
                if (qcVar != null && qcVar.f29682l) {
                    super.onMeasure(i10, i11);
                    marginLayoutParams.bottomMargin = org.telegram.messenger.vl.D(10.0f, org.telegram.ui.Components.qc.f29672w.f29676e.getMeasuredHeight() + AndroidUtilities.dp(14.0f), i13);
                } else {
                ...
                TextView textView = wg0Var.f42370f0;
                if (textView != null) {
                    ((ViewGroup.MarginLayoutParams) textView.getLayoutParams()).topMargin = AndroidUtilities.dp(16.0f) + i18;
                }
                if (R() > AndroidUtilities.dp(20.0f) && wg0Var.f42364c.getVisibility() != 8 && !AndroidUtilities.isAccessibilityTouchExplorationEnabled() && !wg0Var.f42361a0) {
                    ValueAnimator valueAnimator = wg0Var.d;
                    if (valueAnimator != null) {
                        valueAnimator.cancel();
                    }
                    wg0Var.f42364c.setVisibility(8);
                }
                super.onMeasure(i10, i11);
                return;
            case 6:
                PopupNotificationActivity popupNotificationActivity = (PopupNotificationActivity) this.f41795x0;
                ...
                if (R() <= AndroidUtilities.dp(20.0f)) {
                    size2 -= popupNotificationActivity.f33761b.getEmojiPadding();
                }
                int i19 = size2;
                ...
                for (int i20 = 0; i20 < childCount; i20++) {
                    ...
                    if (childAt.getVisibility() != 8) {
                        if (popupNotificationActivity.f33761b.u0(childAt)) {
                            childAt.measure(View.MeasureSpec.makeMeasureSpec(size, 1073741824), View.MeasureSpec.makeMeasureSpec(childAt.getLayoutParams().height, 1073741824));
                        } else if (childAt == popupNotificationActivity.f33761b.M1) {
                ...
                return;
            case 9:
                yh.g4 g4Var = (yh.g4) this.f41795x0;
                FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) g4Var.f50303y.getLayoutParams();
                ...
                FrameLayout.LayoutParams layoutParams3 = (FrameLayout.LayoutParams) g4Var.f50298n.getLayoutParams();
                ...
                FrameLayout.LayoutParams layoutParams4 = (FrameLayout.LayoutParams) g4Var.f50301w.getLayoutParams();
