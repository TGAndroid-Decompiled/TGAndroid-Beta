...
public final class w8 extends org.telegram.ui.Components.aw0 {
    public final int f38928w0;
    public final Object f38929x0;
    ...
    public void J(Canvas canvas, float f7, Rect rect, Paint paint, boolean z10) {
        switch (this.f38928w0) {
            case 0:
                k9 k9Var = (k9) this.f38929x0;
                ...
                return;
            case 3:
                ContactsActivity contactsActivity = (ContactsActivity) this.f38929x0;
                if (Build.VERSION.SDK_INT >= 29 && SharedConfig.chatBlurEnabled() && contactsActivity.f31047u0 != null) {
                    canvas.save();
                    canvas.translate(0.0f, -f7);
                    contactsActivity.f31047u0.y(canvas, rect.left, rect.top + f7, rect.right, rect.bottom + f7);
                    canvas.restore();
    ...
    public void dispatchDraw(Canvas canvas) {
        switch (this.f38928w0) {
            case 0:
                ...
                if (Build.VERSION.SDK_INT >= 31 && hVar != null) {
                    ...
                    if (dVar2 != null && !dVar2.f9060n) {
                        ...
                        a2.drawColor(k9Var.getThemedColor(org.telegram.ui.ActionBar.h6.f19004a7));
                    ...
                    if (dVar != null && !dVar.f9060n) {
                        ...
                        a10.drawColor(k9Var.getThemedColor(org.telegram.ui.ActionBar.h6.f19004a7));
                        if (SharedConfig.chatBlurEnabled()) {
                            hVar.b(a10, -2);
                        }
                        dVar.c();
            ...
            case 3:
                ContactsActivity contactsActivity = (ContactsActivity) this.f38929x0;
                fh.d dVar3 = contactsActivity.f31048v0;
                fh.d dVar4 = contactsActivity.f31047u0;
                ah.h hVar2 = contactsActivity.f31046t0;
                if (Build.VERSION.SDK_INT >= 31 && hVar2 != null) {
                    ...
                    if (dVar4 != null && !dVar4.f9060n) {
                        ...
                        a11.drawColor(contactsActivity.getThemedColor(org.telegram.ui.ActionBar.h6.f19060d6));
                        if (SharedConfig.chatBlurEnabled()) {
                            hVar2.b(a11, -3);
                        }
                        dVar4.c();
                    ...
                    if (dVar3 != null && !dVar3.f9060n) {
                        ...
                        a12.drawColor(contactsActivity.getThemedColor(org.telegram.ui.ActionBar.h6.f19060d6));
                        if (SharedConfig.chatBlurEnabled()) {
                            hVar2.b(a12, -2);
                        }
                        dVar3.c();
            ...
            case 7:
                ...
                if (Build.VERSION.SDK_INT >= 31 && hVar3 != null) {
                    ...
                    if (dVar6 != null && !dVar6.f9060n) {
                        ...
                        a13.drawColor(z81Var.getThemedColor(org.telegram.ui.ActionBar.h6.f19060d6));
                        if (SharedConfig.chatBlurEnabled()) {
                            hVar3.b(a13, -3);
                        }
                        dVar6.c();
                    ...
                    if (dVar5 != null && !dVar5.f9060n) {
                        ...
                        a14.drawColor(z81Var.getThemedColor(org.telegram.ui.ActionBar.h6.f19060d6));
                        if (SharedConfig.chatBlurEnabled()) {
                            hVar3.b(a14, -2);
                        }
                        dVar5.c();
                ...
                super.dispatchDraw(canvas);
                if (!z81Var.M) {
                    AndroidUtilities.drawNavigationBarProtection(canvas, this, z81Var.getThemedColor(org.telegram.ui.ActionBar.h6.f19060d6), z81Var.S);
                    return;
                }
                return;
            case 8:
                ...
                if (Build.VERSION.SDK_INT >= 31 && hVar4 != null) {
                    ...
                    if (dVar8 != null && !dVar8.f9060n) {
                        ...
                        a15.drawColor(sa1Var.getThemedColor(org.telegram.ui.ActionBar.h6.f19060d6));
                        if (SharedConfig.chatBlurEnabled()) {
                            hVar4.b(a15, -3);
                        }
                        dVar8.c();
                    ...
                    if (dVar7 != null && !dVar7.f9060n) {
                        ...
                        a16.drawColor(sa1Var.getThemedColor(org.telegram.ui.ActionBar.h6.f19060d6));
                        if (SharedConfig.chatBlurEnabled()) {
                            hVar4.b(a16, -2);
                        }
                        dVar7.c();
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        switch (this.f38928w0) {
            case 1:
                if (motionEvent.getY() < ((org.telegram.ui.Components.zb0) this.f38929x0).T) {
                    return false;
                }
    ...
    public Drawable getNewDrawable() {
        switch (this.f38928w0) {
            case 1:
                Drawable d = ((un) ((org.telegram.ui.Components.zb0) this.f38929x0).f30840c0.F).d();
                if (d == null) {
    ...
    public org.telegram.ui.ActionBar.d6 getResourceProvider() {
        switch (this.f38928w0) {
            case 2:
                return ((org.telegram.ui.Components.l01) this.f38929x0).f25972c;
            default:
    ...
    public void onMeasure(int i10, int i11) {
        ...
        switch (this.f38928w0) {
            case 0:
                ...
                ((ViewGroup.MarginLayoutParams) k9Var.f34983b.getLayoutParams()).topMargin = k9.d0(k9Var).getMeasuredHeight();
                ((ViewGroup.MarginLayoutParams) k9Var.f34992r.getLayoutParams()).topMargin = k9.a0(k9Var).getMeasuredHeight();
                k9Var.i0();
            ...
            case 2:
                super.onMeasure(i10, i11);
                setMeasuredDimension(View.MeasureSpec.getSize(i10), ((org.telegram.ui.Components.l01) this.f38929x0).d.getMeasuredHeight() + AndroidUtilities.dp(24.0f));
                return;
            case 3:
                ContactsActivity contactsActivity = (ContactsActivity) this.f38929x0;
            ...
            case 4:
                ...
                if (this.f22795f > AndroidUtilities.dp(20.0f)) {
                    i12 = 8;
                } else {
                    i12 = 0;
                }
            ...
            case 5:
                ...
                if (qcVar != null && qcVar.f27580l) {
                    super.onMeasure(i10, i11);
                    marginLayoutParams.bottomMargin = org.telegram.messenger.ok.D(10.0f, org.telegram.ui.Components.qc.f27571w.e.getMeasuredHeight() + AndroidUtilities.dp(14.0f), i13);
                } else {
                ...
                TextView textView = qg0Var.f36895f0;
                if (textView != null) {
                    ((ViewGroup.MarginLayoutParams) textView.getLayoutParams()).topMargin = AndroidUtilities.dp(16.0f) + i18;
                }
                if (R() > AndroidUtilities.dp(20.0f) && qg0Var.f36890c.getVisibility() != 8 && !AndroidUtilities.isAccessibilityTouchExplorationEnabled() && !qg0Var.f36887a0) {
                    ValueAnimator valueAnimator = qg0Var.d;
                    if (valueAnimator != null) {
                        valueAnimator.cancel();
                    }
                    qg0Var.f36890c.setVisibility(8);
                }
                super.onMeasure(i10, i11);
                return;
            case 6:
                PopupNotificationActivity popupNotificationActivity = (PopupNotificationActivity) this.f38929x0;
                ...
                if (R() <= AndroidUtilities.dp(20.0f)) {
                    size2 -= popupNotificationActivity.f31433b.getEmojiPadding();
                }
                int i19 = size2;
                ...
                for (int i20 = 0; i20 < childCount; i20++) {
                    ...
                    if (childAt.getVisibility() != 8) {
                        if (popupNotificationActivity.f31433b.u0(childAt)) {
                            childAt.measure(View.MeasureSpec.makeMeasureSpec(size, 1073741824), View.MeasureSpec.makeMeasureSpec(childAt.getLayoutParams().height, 1073741824));
                        } else if (childAt == popupNotificationActivity.f31433b.N1) {
                ...
                return;
            case 9:
                xh.i4 i4Var = (xh.i4) this.f38929x0;
                FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) i4Var.f46191y.getLayoutParams();
                ...
                FrameLayout.LayoutParams layoutParams3 = (FrameLayout.LayoutParams) i4Var.f46186n.getLayoutParams();
                ...
                FrameLayout.LayoutParams layoutParams4 = (FrameLayout.LayoutParams) i4Var.f46189w.getLayoutParams();
