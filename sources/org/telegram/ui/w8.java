...
public final class w8 implements RequestDelegate {
    ...
    public final Object f38594f;
    public final Object f38595g;
    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        Object obj = this.h;
        Object obj2 = this.f38595g;
        Object obj3 = this.f38594f;
        Object obj4 = this.e;
        Object obj5 = this.d;
        Object obj6 = this.f38593c;
        switch (i10) {
            case 0:
            ...
            case 1:
                ...
                return;
            case 2:
                ArrayList arrayList2 = ExternalActionActivity.f30803x;
                AndroidUtilities.runOnUIThread(new org.telegram.messenger.y5((ExternalActionActivity) obj6, (org.telegram.ui.ActionBar.c2) obj5, tLObject, this.f38592b, (TL_account.authorizationForm) obj4, (TL_account.getAuthorizationForm) obj3, (String) obj2, (String) obj));
                return;
            default:
                AndroidUtilities.runOnUIThread(new org.telegram.messenger.jb((hg0) obj6, tLObject, tL_error, (c5.k) obj5, this.f38592b, (c5.o) obj4, (TLRPC.TL_inputStorePaymentAuthCode) obj3, (String) obj2, (TLRPC.TL_payments_canPurchaseStore) obj));
                return;
        }
    }
    ...
    public w8(KeyEvent.Callback callback, Object obj, int i10, Object obj2, TLObject tLObject, String str, Object obj3, int i11) {
        this.f38591a = i11;
        this.f38593c = callback;
        this.d = obj;
        this.f38592b = i10;
        this.e = obj2;
        this.f38594f = tLObject;
        this.f38595g = str;
        this.h = obj3;
    }
}
