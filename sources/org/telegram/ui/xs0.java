...
public final class xs0 extends o4 {
    ...
    public final boolean drawChild(Canvas canvas, View view, long j10) {
        ...
        if (view == photoViewer.B3 && photoViewer.f31727d4) {
            return true;
        }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        TextureView textureView = photoViewer.f31916y2;
        if (textureView instanceof org.telegram.ui.Components.w61) {
            textureView.setPivotX(textureView.getMeasuredWidth() / 2);
            photoViewer.B2.setPivotX(photoViewer.f31916y2.getMeasuredWidth() / 2);
        } else {
            if (textureView != null) {
