...
public final class wf0 extends org.telegram.ui.Components.vv0 {
    ...
    public final ph.d f39726b;
    public final lh.e0[] f39727c;
    public Bundle d;
    public String e;
    public boolean f39728f;
    public String h;
    public String f39729n;
    public long f39730r;
    public int f39731s;
    public final ng0 v;
    ...
    public wf0(ng0 ng0Var, Context context) {
        ...
        canvas.drawColor(i0.a.d(0.5f, org.telegram.ui.ActionBar.j6.w0(null, i11, false), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19977h5, false)));
    ...
    public static void o(wf0 wf0Var, String str, String str2, String str3) {
        String str4;
        ...
        try {
            ...
            if (Build.VERSION.SDK_INT >= 29) {
                try {
                    ConnectivityManager connectivityManager = (ConnectivityManager) wf0Var.getContext().getSystemService(ConnectivityManager.class);
                    SignalStrength signalStrength = ((TelephonyManager) wf0Var.getContext().getSystemService(TelephonyManager.class)).getSignalStrength();
    ...
    public final void g() {
        ...
        if (this.f39731s >= 0) {
            ...
            ConnectionsManager.getInstance(i10).cancelRequest(this.f39731s, true);
            this.f39731s = -1;
        }
        this.f39728f = false;
        this.f39726b.setLoading(false);
    }
    ...
    public final void m(Bundle bundle, boolean z4) {
        ...
        lh.e0[] e0VarArr = this.f39727c;
        if (isEmpty) {
            e0VarArr[0].f12333c.setText(LocaleController.getString(R.string.SMSFee1Text));
        } else {
            e0VarArr[0].f12333c.setText(LocaleController.formatString(R.string.SMSFee1TextCountry, countryName));
        }
        ...
        this.f39725a.setOnClickListener(new kh.u3(this, string5, string6, string3, 12));
        ph.d dVar = this.f39726b;
    ...
    public final void p() {
        ...
        tL_checkPaidAuth.form_id = this.f39730r;
        tL_checkPaidAuth.phone_number = this.h;
        tL_checkPaidAuth.phone_code_hash = this.f39729n;
        i10 = ((org.telegram.ui.ActionBar.p2) this.v).currentAccount;
        this.f39731s = ConnectionsManager.getInstance(i10).sendRequest(tL_checkPaidAuth, new o(this, 14), 1096);
    }
}
