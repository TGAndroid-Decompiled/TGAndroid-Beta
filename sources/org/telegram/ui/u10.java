...
public final class u10 {
    public LinearGradient f43129b;
    public final Paint[] f43128a = new Paint[4];
    public final Matrix f43130c = new Matrix();

    public final void a(Canvas canvas, RectF rectF, float f9) {
        Paint[] paintArr = this.f43128a;
        if (paintArr[0] == null) {
            Paint paint = new Paint(1);
            paintArr[0] = paint;
            paint.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.DST_OUT));
        }
        paintArr[0].setShader(this.f43129b);
    ...
    public final void b(Canvas canvas, RectF rectF, int i10, float f9) {
        ...
        if (this.f43129b == null) {
            this.f43129b = new LinearGradient(0.0f, 0.0f, 0.0f, 16.0f, new int[]{-65536, 16711680}, new float[]{0.0f, 1.0f}, Shader.TileMode.CLAMP);
        }
        Paint[] paintArr = this.f43128a;
        ...
        paintArr[i10].setShader(this.f43129b);
        Matrix matrix = this.f43130c;
        matrix.reset();
        if (i10 == 0) {
        ...
        this.f43129b.setLocalMatrix(matrix);
