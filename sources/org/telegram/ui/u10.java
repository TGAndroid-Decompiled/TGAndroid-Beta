...
public final class u10 implements Runnable {
    ...
    public final FiltersSetupActivity f38289b;

    public u10(FiltersSetupActivity filtersSetupActivity, int i10) {
        this.f38288a = i10;
        this.f38289b = filtersSetupActivity;
    }
    ...
    public final void run() {
        switch (this.f38288a) {
            case 0:
                FiltersSetupActivity filtersSetupActivity = this.f38289b;
                filtersSetupActivity.getClass();
                filtersSetupActivity.presentFragment(new PremiumPreviewFragment(0, "settings"));
                return;
            case 1:
                FiltersSetupActivity filtersSetupActivity2 = this.f38289b;
                filtersSetupActivity2.f31086a.e1(new du(filtersSetupActivity2, 9), 700, true);
                return;
            default:
                FiltersSetupActivity filtersSetupActivity3 = this.f38289b;
