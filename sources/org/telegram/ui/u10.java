...
public final class u10 extends org.telegram.ui.Components.il0 {
    ...
    public final int M(int i10) {
        z10 z10Var = this.v;
        int i11 = 1;
        if (i10 >= z10Var.f40090n.size()) {
            return 1;
        }
        int size = ((ArrayList) z10Var.f40095r.get(z10Var.f40090n.get(i10))).size();
        if (i10 == 0) {
            i11 = 0;
        }
        return size + i11;
    ...
    public final int P(int i10, int i11) {
        if (i10 >= this.v.f40090n.size()) {
            return 2;
        }
        if (i10 != 0 && i11 == 0) {
            return 0;
        }
        int i12 = this.f37913s;
        if (i12 != 2 && i12 != 4) {
            return 1;
        }
        return 3;
    ...
    public final int R() {
        z10 z10Var = this.v;
        int i10 = 0;
        if (z10Var.f40090n.isEmpty()) {
            return 0;
        }
        int size = z10Var.f40090n.size();
        if (!z10Var.f40090n.isEmpty() && !z10Var.N) {
            i10 = 1;
        }
        return size + i10;
    }
    ...
    public final View T(int i10, View view) {
        if (view == null) {
            view = new org.telegram.ui.Cells.u3(this.f37912r, null);
        ...
        if (i10 < z10Var.f40090n.size()) {
            view.setAlpha(1.0f);
            ((org.telegram.ui.Cells.u3) view).setText(LocaleController.formatSectionDate(((MessageObject) ((ArrayList) z10Var.f40095r.get((String) z10Var.f40090n.get(i10))).get(0)).messageOwner.date));
        }
        return view;
    }
    ...
    public final void W(int i10, int i11, s4.c1 c1Var) {
        boolean z10;
        z10 z10Var = this.v;
        ArrayList arrayList = z10Var.f40090n;
        int i12 = c1Var.f42705f;
        View view = c1Var.f42702a;
        if (i12 != 2) {
            ArrayList arrayList2 = (ArrayList) z10Var.f40095r.get((String) arrayList.get(i10));
