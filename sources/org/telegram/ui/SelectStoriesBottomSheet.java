...
public class SelectStoriesBottomSheet extends BottomSheetWithRecyclerListView implements NotificationCenter.NotificationCenterDelegate {
    ...
    public SelectStoriesBottomSheet(BaseFragment baseFragment, long j, int i, final Utilities.Callback callback) {
        ...
        buttonWithCounterView.setOnClickListener(new View.OnClickListener() {
            ...
            public final void onClick(View view2) {
                SelectStoriesBottomSheet.m4046$r8$lambda$EPXWdL0t1J3afAkZkuAhy8C3Po(this.f$0, callback, view2);
            }
        });
    ...
    public static void m4046$r8$lambda$EPXWdL0t1J3afAkZkuAhy8C3Po(SelectStoriesBottomSheet selectStoriesBottomSheet, Utilities.Callback callback, View view) {
