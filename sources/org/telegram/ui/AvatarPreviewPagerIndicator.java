...
public class AvatarPreviewPagerIndicator extends View implements ProfileGalleryView.Callback {
    ...
    public AvatarPreviewPagerIndicator(Context context) {
        ...
        valueAnimatorOfFloat.addUpdateListener(new PhotoViewer$73$$ExternalSyntheticLambda0(this, 27));
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (realCount <= 1 || realCount > 20) {
            ...
            for (int i5 = 0; i5 < realCount; i5++) {
                int iDp2 = (iM$2 * i5) + AndroidUtilities.dp((i5 * 2) + 5);
                if (i5 != this.previousSelectedPotision || Math.abs(this.previousSelectedProgress - 1.0f) <= 1.0E-4f) {
                    ...
                    if (i5 == this.selectedPosition) {
                        if (this.profileGalleryView.isCurrentItemVideo()) {
                            ...
                            this.rect.set(iDp2, iDp, iDp2 + iM$2, AndroidUtilities.dp(2.0f) + iDp);
                    ...
                    float f7 = iDp2;
                    this.rect.set(f7, iDp, (iM$2 * currentItemProgress) + f7, AndroidUtilities.dp(2.0f) + iDp);
                    if (i5 != this.selectedPosition) {
                    ...
                    float f9 = iDp;
                    float f10 = iDp2 + iM$2;
                    canvas.clipRect((iM$2 * currentItemProgress) + f8, f9, f10, AndroidUtilities.dp(2.0f) + iDp);
                    this.rect.set(f8, f9, f10, AndroidUtilities.dp(2.0f) + iDp);
                    this.barPaint.setAlpha((int) (this.alpha * 85.0f));
                    canvas.drawRoundRect(this.rect, AndroidUtilities.dp(1.0f), AndroidUtilities.dp(1.0f), this.barPaint);
                    canvas.restore();
                }
                ...
                z = true;
                float f11 = iDp2;
                this.rect.set(f11, iDp, (iM$2 * currentItemProgress) + f11, AndroidUtilities.dp(2.0f) + iDp);
                if (i5 != this.selectedPosition) {
                    this.alphas[i5] = 0.75f;
                } else if (this.overlayCountVisible == 3) {
                    this.barPaint.setAlpha((int) (AndroidUtilities.lerp(i2, 255, CubicBezierInterpolator.EASE_BOTH.getInterpolation(this.alphas[i5])) * this.alpha));
        ...
        if (realCount > i || this.progressToCounter != 0.0f) {
            ...
            rectF3.left = rectF3.right - (AndroidUtilities.dpf2(16.0f) + fMeasureText);
            ...
            if (z2) {
                ...
                if (f16 != 1.0f) {
                    this.progressToCounter = (j / 150.0f) + f16;
                } else if (!z2) {
            ...
            canvas.drawText(getCurrentTitle(), this.indicatorRect.centerX(), AndroidUtilities.dpf2(18.5f) + this.indicatorRect.top, this.textPaint);
            canvas.restore();
        }
    ...
    public void onSizeChanged(int i, int i2, int i3, int i4) {
        ...
        this.topOverlayGradient.setBounds(0, this.topOverlayRect.bottom, i, AndroidUtilities.dp(16.0f) + currentActionBarHeight);
