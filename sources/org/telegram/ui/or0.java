...
public final class or0 implements Utilities.Callback {
    ...
    public final PhotoViewer f36335b;

    public or0(PhotoViewer photoViewer, int i10) {
        this.f36334a = i10;
        this.f36335b = photoViewer;
    }
    ...
    public final void run(Object obj) {
        ...
        switch (this.f36334a) {
            case 0:
                PhotoViewer photoViewer = this.f36335b;
                qg.m2 m2Var = (qg.m2) obj;
                Drawable[] drawableArr = PhotoViewer.U8;
                try {
                    boolean isEmpty = TextUtils.isEmpty(((MediaController.MediaEditState) photoViewer.f30958g7.get(photoViewer.P4)).filterPath);
                    ...
                    photoViewer.f31070t5.post(new ir0(photoViewer, 9));
                    return;
                } catch (Exception e) {
                    FileLog.e(e);
                    return;
            ...
            case 1:
                Uri uri = (Uri) obj;
                org.telegram.ui.Components.vc.F(this.f36335b.f30934e0, true).j();
                return;
            case 2:
                PhotoViewer photoViewer2 = this.f36335b;
                photoViewer2.L1.f41525h2 = photoViewer2.K1.c();
                photoViewer2.f30934e0.invalidate();
                int max = Math.max(((Integer) obj).intValue(), photoViewer2.L1.f41529j2);
                ...
                ValueAnimator valueAnimator = photoViewer2.f31063s7;
                if (valueAnimator != null) {
                    valueAnimator.cancel();
                    photoViewer2.f31063s7 = null;
                }
                if (photoViewer2.f31078u4 != 3) {
                    f7 = 0.0f;
                }
                ValueAnimator ofFloat = ValueAnimator.ofFloat(photoViewer2.Z5, f7);
                photoViewer2.f31063s7 = ofFloat;
                ofFloat.addUpdateListener(new hr0(photoViewer2, 9));
                photoViewer2.f31063s7.setDuration(320L);
                ValueAnimator valueAnimator2 = photoViewer2.f31063s7;
                org.telegram.ui.Components.qr qrVar = org.telegram.ui.Components.qr.h;
                valueAnimator2.setInterpolator(qrVar);
                photoViewer2.f31063s7.start();
                ...
                ObjectAnimator ofFloat4 = ObjectAnimator.ofFloat(photoViewer2.L1.f41514c1, property, Math.min(0, AndroidUtilities.dp(40.0f) + i11));
                ci.x5 x5Var = photoViewer2.L1.f41520f1;
                ...
                if (!au0Var.f41525h2 && !au0Var.f41523g2) {
                    z10 = true;
                } else {
                    z10 = false;
                }
                ...
                TextView textView3 = au0Var.f41548z1;
                if (!au0Var.f41525h2 && !au0Var.f41523g2) {
                    z13 = false;
                } else {
                    z13 = true;
                ...
                return;
            case 3:
                PhotoViewer photoViewer3 = this.f36335b;
                MediaController.PhotoEntry photoEntry = (MediaController.PhotoEntry) obj;
                if (!photoViewer3.f31042q5.f25594b.N && (i10 = photoViewer3.P4) >= 0 && i10 < photoViewer3.f30958g7.size() && (photoViewer3.f30958g7.get(photoViewer3.P4) instanceof MediaController.PhotoEntry)) {
                    org.telegram.ui.Components.kf0 kf0Var = photoViewer3.f31042q5;
                    ci.b4 b4Var = kf0Var.h;
                    if (b4Var != null) {
                        b4Var.dismiss();
                        kf0Var.h = null;
                    }
                    photoViewer3.f31042q5.f25594b.setLoading(true);
                    Utilities.globalQueue.postRunnable(new org.telegram.ui.Components.jn0(photoViewer3, photoEntry, (MediaController.PhotoEntry) photoViewer3.f30958g7.get(photoViewer3.P4), PhotoViewer.y1(), 28));
                    return;
                }
                return;
            case 4:
                PhotoViewer photoViewer4 = this.f36335b;
                Integer num = (Integer) obj;
                Object obj2 = photoViewer4.f30958g7.get(photoViewer4.P4);
                ...
                return;
            case 5:
                PhotoViewer photoViewer5 = this.f36335b;
                ...
                photoViewer5.f30935e1.setTranslationY(photoViewer5.U1.getAlpha() * (-hg.c.f(46.0f, num2.intValue(), 0)));
                photoViewer5.f30944f1.setTranslationY(photoViewer5.U1.getAlpha() * (-hg.c.f(46.0f, num2.intValue(), 0)));
                photoViewer5.f30952g1.setTranslationY(photoViewer5.U1.getAlpha() * (-hg.c.f(46.0f, num2.intValue(), 0)));
                ...
                return;
            case 6:
                PhotoViewer photoViewer6 = this.f36335b;
                Integer num3 = (Integer) obj;
                Object obj3 = photoViewer6.f30958g7.get(photoViewer6.P4);
            ...
            case 7:
                ...
                return;
            case 8:
                PhotoViewer photoViewer7 = this.f36335b;
                Boolean bool = (Boolean) obj;
                Drawable[] drawableArr2 = PhotoViewer.U8;
                photoViewer7.B0(0, false);
                return;
            default:
                PhotoViewer photoViewer8 = this.f36335b;
