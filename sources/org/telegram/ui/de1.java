...
public final class de1 extends Dialog {
    ...
    public boolean N;
    public int O;
    public org.telegram.ui.Components.rk0 P;
    public ViewGroup Q;
    public float R;
    public ViewGroup S;
    public float T;
    ...
    public float Y;
    public boolean Z;
    public final org.telegram.ui.ActionBar.d6 f33088a;
    public boolean f33089a0;
    public final ae1 f33090b;
    public boolean f33091b0;
    public final ae1 f33092c;
    public tm f33093c0;
    public final ae1 d;
    public ValueAnimator f33094d0;
    public final ci.i1 e;
    public ValueAnimator f33095e0;
    public final TextView f33096f;
    public final org.telegram.ui.Components.ec0 h;
    public i0.b f33097n;
    public Bitmap f33098r;
    public BitmapShader f33099s;
    public Paint v;
    public Matrix f33100w;
    public float f33101x;
    public float f33102y;
    ...
    public de1(Activity activity, org.telegram.ui.ActionBar.d6 d6Var) {
        ...
        ae1Var2.addView(ec0Var, w7.y5.e(-1, 66, 80));
        ec0Var.setOnTabClick(new t3(i1Var, 25));
    ...
    public final void b(boolean z10, org.telegram.ui.Components.zr0 zr0Var) {
        float f7;
        long j3;
        ValueAnimator valueAnimator = this.f33094d0;
        if (valueAnimator != null) {
            valueAnimator.cancel();
        }
        ValueAnimator valueAnimator2 = this.f33095e0;
        if (valueAnimator2 != null) {
            valueAnimator2.cancel();
        }
        d();
        float f10 = this.f33101x;
        float f11 = 0.0f;
        if (z10) {
            f7 = 1.0f;
        } else {
        ...
        this.f33094d0 = ofFloat;
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) {
            public final de1 f38965b;
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator3) {
                switch (r2) {
                    case 0:
                        ...
                        de1 de1Var = this.f38965b;
                        de1Var.f33101x = floatValue;
                        de1Var.f33090b.invalidate();
                        de1Var.f33092c.invalidate();
                        de1Var.e();
                        return;
                    default:
                        de1 de1Var2 = this.f38965b;
                        de1Var2.getClass();
                        de1Var2.f33102y = ((Float) valueAnimator3.getAnimatedValue()).floatValue();
                        return;
                }
            }
        });
        this.f33094d0.addListener(new androidx.fragment.app.g(this, z10, zr0Var, 11));
        if (!z10) {
            j3 = 330;
        } else {
            j3 = 520;
        }
        ValueAnimator valueAnimator3 = this.f33094d0;
        org.telegram.ui.Components.sr srVar = org.telegram.ui.Components.sr.h;
        valueAnimator3.setInterpolator(srVar);
        this.f33094d0.setDuration(j3);
        this.f33094d0.start();
        float f12 = this.f33102y;
        if (z10) {
            f11 = 1.0f;
        }
        ValueAnimator ofFloat2 = ValueAnimator.ofFloat(f12, f11);
        this.f33095e0 = ofFloat2;
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator32) {
                switch (r2) {
                    ...
                    default:
                        de1 de1Var2 = this.f38965b;
                        de1Var2.getClass();
                        de1Var2.f33102y = ((Float) valueAnimator32.getAnimatedValue()).floatValue();
                        return;
                }
            }
        });
        this.f33095e0.addListener(new c70(10, this, z10));
        this.f33095e0.setDuration(((float) j3) * 1.5f);
        this.f33095e0.setInterpolator(srVar);
        this.f33095e0.start();
    }
    ...
    public final void c(boolean z10) {
        ...
        if (z10 && (rk0Var = this.P) != null && rk0Var.getReactionsWindow() != null && !this.P.getReactionsWindow().f49257q) {
            this.P.e();
        } else if (this.f33089a0) {
        } else {
            this.f33089a0 = true;
            this.W = false;
            ci.i1 i1Var = this.e;
            ...
            this.f33091b0 = !z10;
            d();
            b(false, new org.telegram.ui.Components.zr0(12, this, z11));
            this.f33090b.invalidate();
        }
    }
    ...
    public final void e() {
        ...
        if (viewGroup2 != null) {
            ...
            this.S.setAlpha(this.f33101x);
            float lerp3 = AndroidUtilities.lerp(0.75f, 1.0f, this.f33101x);
        ...
        if (this.Q != null) {
            ...
            this.Q.setAlpha(this.f33101x);
            float lerp4 = AndroidUtilities.lerp(0.75f, 1.0f, this.f33101x);
            this.Q.setScaleX(lerp4);
            this.Q.setScaleY(lerp4);
        }
        if (this.f33091b0) {
            this.J.setAlpha(this.f33101x);
            this.I.setAlpha(this.f33101x);
        }
        if (this.P != null) {
    ...
    public final void show() {
        ...
        super.show();
        org.telegram.ui.Components.nm0.d(new b5(this, 28));
        this.N = true;
        b(true, null);
    }
}
