...
public final class ur0 implements Runnable {
    ...
    public final void run() {
        ...
        Object obj = this.h;
        Serializable serializable = this.f38180f;
        Object obj2 = this.e;
        switch (i10) {
            case 0:
                ...
                photoViewer.f30934c2 = 2;
                photoViewer.f31092u2 = false;
                photoViewer.d = new gu0(photoViewer, photoViewer.d, messageObject, orientation, this.f38179c, this.d);
                photoViewer.f31046p1.l();
            ...
            default:
                ...
                int i13 = ((int[]) obj)[0];
                if (i12 == i13) {
                    xu0 xu0Var = us0Var.f38192b.f30950e0;
                    boolean z11 = this.f38178b;
                    boolean z12 = this.f38179c;
                    int i14 = z11 ? 1 : 0;
                    boolean z13 = this.d;
                    if ((z12 ? 1 : 0) + i14 + (z13 ? 1 : 0) > 1) {
                        ...
                        if (i13 > 1) {
                            ucVar = org.telegram.ui.Components.uc.f28324s;
                        } else {
                            ucVar = org.telegram.ui.Components.uc.f28323r;
                        }
                    } else if (z11) {
                        if (i13 > 1) {
                            ucVar = org.telegram.ui.Components.uc.f28322n;
                        } else {
                            ucVar = org.telegram.ui.Components.uc.h;
                        }
                    } else if (i13 > 1) {
                        ucVar = org.telegram.ui.Components.uc.f28321f;
                    } else {
