...
public final class an0 implements Runnable {
    ...
    public final bn0 f32103b;
    public final TLRPC.TL_error f32104c;
    ...
    public final void run() {
        switch (this.f32102a) {
            case 0:
                bn0 bn0Var = this.f32103b;
                TLObject tLObject = this.d;
                TLRPC.TL_error tL_error = this.f32104c;
                pn0 pn0Var = bn0Var.e;
                if (tLObject instanceof Vector) {
                    ...
                    for (int i10 = 0; i10 < size; i10++) {
                        pn0Var.f36576y.values.add((TLRPC.TL_secureValue) vector.objects.get(i10));
                    }
                    bn0Var.a();
                    return;
                }
                ...
                return;
            case 1:
                bn0 bn0Var2 = this.f32103b;
                TLRPC.TL_error tL_error2 = this.f32104c;
                ...
                return;
            default:
                bn0 bn0Var3 = this.f32103b;
                TLRPC.TL_error tL_error3 = this.f32104c;
