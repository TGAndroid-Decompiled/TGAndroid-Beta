...
public final class tu extends org.telegram.ui.Components.sl0 {
    public static final int f38750m3 = 0;
    public boolean U2;
    public int V2;
    ...
    public final float[] f38751a3;
    public final int[] f38752b3;
    public final ArrayList c3;
    public su[] f38753d3;
    public su[] f38754e3;
    public final boolean[] f38755f3;
    public long f38756g3;
    public long f38757h3;
    public long f38758i3;
    public boolean f38759j3;
    public qu f38760k3;
    public final xu f38761l3;
    ...
    public tu(xu xuVar, Activity activity) {
        ...
        this.f38751a3 = new float[7];
        this.f38752b3 = new int[7];
        this.c3 = new ArrayList();
        this.f38755f3 = new boolean[7];
    ...
    public final void A1(boolean z4) {
        ...
        int i14 = 0;
        while (true) {
            su[] suVarArr = this.f38753d3;
            if (i14 >= suVarArr.length) {
                break;
            }
            su suVar = suVarArr[i14];
            long j11 = j10;
            long j12 = suVar.f29422c;
            int i15 = suVar.d;
            if (!this.f38759j3 && !this.c3.contains(Integer.valueOf(i15))) {
                z10 = false;
            } else {
                z10 = true;
            }
            ...
            if (i16 > 0 || z10) {
                ...
                metricAffectingSpan.f36727a = 0.1d;
                spannableString3.setSpan(metricAffectingSpan, 0, spannableString3.length(), 33);
                int i18 = xu.f40307f[i15];
                int[] iArr = xu.d[i15];
                int i19 = iArr[0];
                int i20 = iArr[1];
                if (i16 == 0) {
                    concat = LocaleController.getString(xu.h[i15]);
                } else {
                    concat = TextUtils.concat(LocaleController.getString(xu.h[i15]), "  ", spannableString3);
                }
                arrayList3.add(new ou(i14, i18, i19, i20, concat, AndroidUtilities.formatFileSize(j12)));
            }
            i14++;
            j10 = j11;
            i13 = 1;
        ...
        if (!arrayList3.isEmpty()) {
            ...
            while (i22 < arrayList3.size()) {
                ...
                if (i23 >= 0 && !this.f38755f3[i23]) {
                    su suVar2 = this.f38753d3[i23];
                    int[] iArr2 = xu.f40308n;
                    int i24 = suVar2.d;
                    int i25 = suVar2.f38442g;
                    int i26 = suVar2.h;
                    long j14 = suVar2.e;
                    spannableString = spannableString4;
                    spannableString2 = spannableString5;
                    long j15 = suVar2.f38441f;
                    int i27 = iArr2[i24];
                    if (i27 == 0) {
                        if (j15 > j13 || i26 > 0) {
                            i22++;
                            arrayList3.add(i22, ou.b(LocaleController.formatPluralStringComma("OutgoingCallsCount", i26), AndroidUtilities.formatFileSize(j15)));
                        }
                        if (j14 > j13 || i25 > 0) {
                            i22++;
                            arrayList3.add(i22, ou.b(LocaleController.formatPluralStringComma("IncomingCallsCount", i25), AndroidUtilities.formatFileSize(j14)));
                        }
                    } else if (i27 != 1) {
                        if (j15 > j13 || i26 > 0) {
                            i22++;
                            arrayList3.add(i22, ou.b(TextUtils.concat(spannableString, " ", AndroidUtilities.replaceTags(LocaleController.formatPluralStringComma("FilesSentCount", i26))), AndroidUtilities.formatFileSize(j15)));
                        }
                        if (j14 > j13 || i25 > 0) {
                            i22++;
                            arrayList3.add(i22, ou.b(TextUtils.concat(spannableString2, " ", AndroidUtilities.replaceTags(LocaleController.formatPluralStringComma("FilesReceivedCount", i25))), AndroidUtilities.formatFileSize(j14)));
                        }
                    } else {
                        if (j15 > j13 || i26 > 0) {
                            i22++;
                            arrayList3.add(i22, ou.b(TextUtils.concat(spannableString, " ", LocaleController.getString(R.string.BytesSent)), AndroidUtilities.formatFileSize(j15)));
                        }
                        if (j14 > j13 || i25 > 0) {
                            i22++;
                            arrayList3.add(i22, ou.b(TextUtils.concat(spannableString2, " ", LocaleController.getString(R.string.BytesReceived)), AndroidUtilities.formatFileSize(j14)));
                            i22++;
        ...
        if (!this.f38759j3) {
            ...
            arrayList2.add(new ou(-1, R.drawable.msg_filled_data_sent, -11565578, -13276952, LocaleController.getString(R.string.BytesSent), AndroidUtilities.formatFileSize(this.f38758i3)));
            arrayList2.add(new ou(-1, R.drawable.msg_filled_data_received, -11154873, -14175180, LocaleController.getString(R.string.BytesReceived), AndroidUtilities.formatFileSize(this.f38757h3)));
        }
        if (!arrayList3.isEmpty()) {
            i10 = 3;
    ...
    public final void z1() {
        ...
        int i17;
        int i18;
        this.f38756g3 = w1(6) + y1(6);
        this.f38757h3 = w1(6);
        this.f38758i3 = y1(6);
        if (this.f38753d3 == null) {
            this.f38753d3 = new su[7];
        }
        if (this.f38754e3 == null) {
            this.f38754e3 = new su[7];
        }
        int i19 = 0;
        while (true) {
            int[] iArr = xu.f40308n;
            int length = iArr.length;
            float[] fArr = this.f38751a3;
            if (i19 < length) {
                int i20 = iArr[i19];
                long w12 = w1(i20) + y1(i20);
                su[] suVarArr = this.f38754e3;
                su[] suVarArr2 = this.f38753d3;
                ...
                obj.f29421b = z4;
                obj.e = w13;
                obj.f38442g = recivedItemsCount;
                obj.f38441f = y12;
                obj.h = sentItemsCount;
                suVarArr2[i19] = obj;
                suVarArr[i19] = obj;
                fArr[i19] = ((float) w12) / ((float) this.f38756g3);
                i19++;
            } else {
                Arrays.sort(this.f38753d3, new cu(1));
                AndroidUtilities.roundPercents(fArr, this.f38752b3);
                Arrays.fill(this.f38755f3, true);
                return;
            }
        }
    }
