...
public final class tu extends org.telegram.ui.Components.dd {
    ...
    public final void d(int i10, boolean z10) {
        int i11;
        wu wuVar = (wu) this.f37808e0.e;
        if (!z10) {
            wuVar.k1();
        } else if (i10 >= 0 && i10 < wuVar.f39249g3.length) {
            int i12 = 0;
            while (true) {
            ...
            int i13 = 0;
            while (true) {
                if (i13 < wuVar.f39245c3.size()) {
                    ru ruVar = (ru) wuVar.f39245c3.get(i13);
                    if (ruVar != null && ruVar.f15672a == 2 && ruVar.h == i12) {
                        i11 = i13;
                        break;
                    }
                    i13++;
