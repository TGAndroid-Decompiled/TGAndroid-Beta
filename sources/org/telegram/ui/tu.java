...
public final class tu extends org.telegram.ui.Components.ed {
    ...
    public final void d(int i10, boolean z10) {
        int i11;
        wu wuVar = (wu) this.f40830e0.f41220e;
        if (!z10) {
            wuVar.i1();
        } else if (i10 >= 0 && i10 < wuVar.f42487g3.length) {
            int i12 = 0;
            while (true) {
                vu[] vuVarArr = wuVar.f42487g3;
                i11 = -1;
            ...
            int i13 = 0;
            while (true) {
                if (i13 < wuVar.f42483c3.size()) {
                    ru ruVar = (ru) wuVar.f42483c3.get(i13);
                    if (ruVar != null && ruVar.f44072a == 2 && ruVar.h == i12) {
                        i11 = i13;
                        break;
                    }
                    i13++;
