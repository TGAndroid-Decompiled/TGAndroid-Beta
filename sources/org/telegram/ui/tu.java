...
public final class tu implements org.telegram.ui.Components.xk0, org.telegram.ui.ActionBar.b2 {
    public final xu f37871a;
    ...
    public void f(org.telegram.ui.ActionBar.c2 c2Var, int i10) {
        ...
        int i12;
        int i13;
        xu xuVar = this.f37871a;
        bv bvVar = xuVar.f39719o3;
        ArrayList arrayList = xuVar.f39711f3;
        arrayList.clear();
        int i14 = 0;
        while (true) {
            wu[] wuVarArr = xuVar.f39712g3;
    ...
    public int run() {
        xu xuVar = this.f37871a;
        ArrayList arrayList = xuVar.f39708c3;
        int i10 = 0;
        while (true) {
            if (i10 < arrayList.size()) {
                if (((su) arrayList.get(i10)).f15543a == 5) {
                    break;
                }
                i10++;
            } else {
