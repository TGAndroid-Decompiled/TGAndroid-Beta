...
public final class tu extends og.b {
    ...
    public final boolean D(s4.c1 c1Var) {
        switch (this.d) {
            case 0:
                qu quVar = (qu) ((vu) this.e).f38688c3.get(c1Var.b());
    ...
    public final int h() {
        switch (this.d) {
            case 0:
                return ((vu) this.e).f38688c3.size();
            default:
                return ((nc0) this.e).f35949s.size();
        }
    }
    ...
    public final int j(int i10) {
        switch (this.d) {
            case 0:
                return ((qu) ((vu) this.e).f38688c3.get(i10)).f15533a;
            default:
                nc0 nc0Var = (nc0) this.e;
                if (i10 >= 0 && i10 < nc0Var.f35949s.size()) {
                    return ((hc0) nc0Var.f35949s.get(i10)).f15533a;
                }
                return 2;
        }
    }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        switch (i11) {
            case 0:
                ...
                org.telegram.ui.ActionBar.e6 e6Var = vuVar.f25966p2;
                if (i10 != 0) {
                    if (i10 != 1) {
                        if (i10 != 3) {
                            if (i10 != 4) {
                                if (i10 != 5) {
                                    if (i10 != 6) {
                                        if (i10 != 7) {
                                            ...
                                            int i13 = vu.f38685p3;
                                            knVar.setBackgroundColor(org.telegram.ui.ActionBar.i6.v0(i12, vuVar.f25966p2));
                                            r8Var = knVar;
                                        }
                                    } else {
                                        ?? view2 = new View(vuVar.getContext());
                                        view2.f39679a = new Path();
                                    ...
                                    r8Var2.setTextColor(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f19056p7, e6Var));
                                    r8Var2.setBackgroundColor(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f18836d6, e6Var));
                                    r8Var = r8Var2;
                                }
                            } else {
                                View l4Var = new org.telegram.ui.Cells.l4(vuVar.getContext());
                                l4Var.setBackgroundColor(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f18836d6, e6Var));
                                r8Var = l4Var;
                            }
                        } else {
                        ...
                        frameLayout.f39990a = textView;
                        textView.setGravity(17);
                        textView.setTextSize(1, 13.0f);
                        textView.setTextColor(zuVar.getThemedColor(org.telegram.ui.ActionBar.i6.f19218y6));
                    ...
                    int[] iArr = zu.e;
                    su suVar = new su(this, context2, iArr.length, iArr, zu.f40297f);
                    vuVar.f38698n3 = suVar;
                    suVar.setInterceptTouch(false);
                    View view3 = vuVar.f38698n3;
                    view3.setTag(-33024);
                    r8Var = view3;
                }
