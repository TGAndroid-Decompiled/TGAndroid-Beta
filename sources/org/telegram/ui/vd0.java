...
public final class vd0 implements RequestDelegate {
    ...
    public final xd0 f43552b;

    public vd0(xd0 xd0Var, int i10) {
        this.f43551a = i10;
        this.f43552b = xd0Var;
    }
    ...
    public final void run(final TLObject tLObject, final TLRPC.TL_error tL_error) {
        switch (this.f43551a) {
            case 0:
                    ...
                    public final void run() {
                        ...
                        switch (i11) {
                            case 0:
                                xd0Var2.getClass();
                                if (tL_error2 == null) {
                                    xd0Var2.f44563n = (TL_account.Password) tLObject2;
                                    xd0Var2.h(null);
                                    return;
                                }
                                return;
                            case 1:
                                fg0 fg0Var = xd0Var2.f44568y;
                                ...
                                if (tL_error2 == null) {
                                    ...
                                    if (fg0Var.getParentActivity() != null) {
                                        ...
                                        if (indexOf != lastIndexOf && indexOf != -1 && lastIndexOf != -1) {
                                            ...
                                            obj.f29026c = i12;
                                            valueOf.setSpan(new org.telegram.ui.Components.i01(obj, 0), indexOf, i12, 0);
                                        }
                            ...
                            default:
                                ...
                                if (tL_error2 != null && "SRP_ID_INVALID".equals(tL_error2.text)) {
                                    ...
                                    ConnectionsManager.getInstance(i10).sendRequest(getpassword, new vd0(xd0Var2, 0), 8);
                                    return;
                                    ...
                                    if (tL_error2.text.equals("PASSWORD_HASH_INVALID")) {
                                        if (fg0Var2.getParentActivity() != null) {
                                            xd0Var2.f44558a.setText("");
                                            fg0.U0(fg0Var2, xd0Var2.f44567x, true);
                                            return;
                                        }
                                        return;
                                    } else if (tL_error2.text.startsWith("FLOOD_WAIT")) {
                ...
                return;
            case 1:
                final xd0 xd0Var2 = this.f43552b;
                AndroidUtilities.runOnUIThread(new Runnable() {
                    @Override
                    public final void run() {
                        String formatPluralString;
                        ...
                        switch (i11) {
                            case 0:
                                xd0Var22.getClass();
                                if (tL_error2 == null) {
                                    xd0Var22.f44563n = (TL_account.Password) tLObject2;
                                    xd0Var22.h(null);
                                    return;
                                }
                                return;
                            case 1:
                                fg0 fg0Var = xd0Var22.f44568y;
                                fg0Var.k1(false, true);
                                if (tL_error2 == null) {
                                    TLRPC.TL_auth_passwordRecovery tL_auth_passwordRecovery = (TLRPC.TL_auth_passwordRecovery) tLObject2;
                                    if (fg0Var.getParentActivity() != null) {
                            ...
                            default:
                                fg0 fg0Var2 = xd0Var22.f44568y;
                                xd0Var22.h = false;
                                if (tL_error2 != null && "SRP_ID_INVALID".equals(tL_error2.text)) {
                                    TL_account.getPassword getpassword = new TL_account.getPassword();
                                    i10 = ((org.telegram.ui.ActionBar.o2) fg0Var2).currentAccount;
                                    ConnectionsManager.getInstance(i10).sendRequest(getpassword, new vd0(xd0Var22, 0), 8);
                                    return;
                                } else if (tLObject2 instanceof TLRPC.TL_auth_authorization) {
                                    fg0Var2.v1(false, true);
                                    ...
                                    if (tL_error2.text.equals("PASSWORD_HASH_INVALID")) {
                                        if (fg0Var2.getParentActivity() != null) {
                                            xd0Var22.f44558a.setText("");
                                            fg0.U0(fg0Var2, xd0Var22.f44567x, true);
                                            return;
                                        }
                                        return;
                                    } else if (tL_error2.text.startsWith("FLOOD_WAIT")) {
                ...
                return;
            default:
                final xd0 xd0Var3 = this.f43552b;
                AndroidUtilities.runOnUIThread(new Runnable() {
                    @Override
                    public final void run() {
                        String formatPluralString;
