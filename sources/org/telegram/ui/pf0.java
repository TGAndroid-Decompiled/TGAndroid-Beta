...
public final class pf0 implements RequestDelegate {
    ...
    public final bg0 f36622b;
    public final TLRPC.TL_auth_signIn f36623c;

    public pf0(bg0 bg0Var, TLRPC.TL_auth_signIn tL_auth_signIn, int i10) {
        this.f36621a = i10;
        this.f36622b = bg0Var;
        this.f36623c = tL_auth_signIn;
    }
    ...
    public final void run(final TLObject tLObject, final TLRPC.TL_error tL_error) {
        switch (this.f36621a) {
            case 0:
                final bg0 bg0Var = this.f36622b;
                final TLRPC.TL_auth_signIn tL_auth_signIn = this.f36623c;
                    ...
                    public final void run() {
                        ...
                        switch (r5) {
                            case 0:
                                ...
                                int i14 = bg0Var2.f32142f0;
                                yg0 yg0Var = bg0Var2.f32157s0;
                                bg0Var2.z(false);
                                TLRPC.TL_error tL_error2 = tL_error;
                                TLRPC.TL_auth_signIn tL_auth_signIn2 = tL_auth_signIn;
                                if (tL_error2 == null) {
                                    bg0Var2.f32139d0 = false;
                                    ...
                                    if (tLObject2 instanceof TLRPC.TL_auth_authorizationSignUpRequired) {
                                        ...
                                        bundle.putString("phoneHash", bg0Var2.f32137c);
                                        ...
                                        bg0Var2.q(new Runnable() {
                                            ...
                                            public final void run() {
                                                switch (r3) {
                                                    case 0:
                                                        bg0Var2.f32157s0.u1(5, true, bundle, false);
                                                        return;
                                                    default:
                                                        bg0Var2.f32157s0.u1(6, true, bundle, false);
                                                        return;
                                                }
                                            }
                                        });
                                    ...
                                    if (str.contains("SESSION_PASSWORD_NEEDED")) {
                                        ...
                                        bg0Var2.f32139d0 = false;
                                        yg0Var.v1(false, true);
                                        if ((i14 == 3 && ((i12 = bg0Var2.f32143g0) == 4 || i12 == 2 || i12 == 17 || i12 == 16)) || ((i14 == 2 && ((i11 = bg0Var2.f32143g0) == 4 || i11 == 3)) || (i14 == 4 && ((i10 = bg0Var2.f32143g0) == 2 || i10 == 17 || i10 == 16)))) {
                                            bg0Var2.u();
                                        }
                                        if (i14 == 15) {
                            ...
                            default:
                                ...
                                bg0Var3.f32139d0 = false;
                                yg0 yg0Var2 = bg0Var3.f32157s0;
                                ...
                                if (tL_error3 == null) {
                                    ...
                                    bundle2.putString("phoneHash", bg0Var3.f32137c);
                                    ...
                                    bg0Var3.q(new Runnable() {
                                        ...
                                        public final void run() {
                                            switch (r3) {
                                                case 0:
                                                    bg0Var3.f32157s0.u1(5, true, bundle2, false);
                                                    return;
                                                default:
                                                    bg0Var3.f32157s0.u1(6, true, bundle2, false);
                                                    return;
                                            }
                                        }
                                    });
                ...
                return;
            default:
                final bg0 bg0Var2 = this.f36622b;
                final TLRPC.TL_auth_signIn tL_auth_signIn2 = this.f36623c;
                AndroidUtilities.runOnUIThread(new Runnable() {
                    @Override
                    public final void run() {
                        int i10;
                        ...
                        switch (r5) {
                            case 0:
                                ...
                                int i14 = bg0Var22.f32142f0;
                                yg0 yg0Var = bg0Var22.f32157s0;
                                bg0Var22.z(false);
                                TLRPC.TL_error tL_error2 = tL_error;
                                TLRPC.TL_auth_signIn tL_auth_signIn22 = tL_auth_signIn2;
                                if (tL_error2 == null) {
                                    bg0Var22.f32139d0 = false;
                                    yg0Var.v1(false, true);
                                    bg0Var22.w();
                                    bg0Var22.v();
                                    TLObject tLObject2 = tLObject;
                                    if (tLObject2 instanceof TLRPC.TL_auth_authorizationSignUpRequired) {
                                        ...
                                        bundle.putString("phoneHash", bg0Var22.f32137c);
                                        ...
                                        bg0Var22.q(new Runnable() {
                                            ...
                                            public final void run() {
                                                switch (r3) {
                                                    case 0:
                                                        bg0Var22.f32157s0.u1(5, true, bundle, false);
                                                        return;
                                                    default:
                                                        bg0Var22.f32157s0.u1(6, true, bundle, false);
                                                        return;
                                                }
                                            }
                                        });
                                    ...
                                    if (str.contains("SESSION_PASSWORD_NEEDED")) {
                                        ...
                                        bg0Var22.f32139d0 = false;
                                        yg0Var.v1(false, true);
                                        if ((i14 == 3 && ((i12 = bg0Var22.f32143g0) == 4 || i12 == 2 || i12 == 17 || i12 == 16)) || ((i14 == 2 && ((i11 = bg0Var22.f32143g0) == 4 || i11 == 3)) || (i14 == 4 && ((i10 = bg0Var22.f32143g0) == 2 || i10 == 17 || i10 == 16)))) {
                                            bg0Var22.u();
                                        }
                                        if (i14 == 15) {
