...
public final class o00 extends FrameLayout {
    public final TextView f36189a;
    public final ImageView f36190b;
    ...
    public final void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        if (this.f36191c) {
            TextView textView = this.f36189a;
    ...
    public final void setEnabled(boolean z10) {
        ...
        this.f36189a.setAlpha(f7);
        if (z10) {
            f10 = 1.0f;
        }
        this.f36190b.setAlpha(f10);
    }
}
