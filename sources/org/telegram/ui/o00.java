...
public final class o00 extends ReplacementSpan {
    public final org.telegram.ui.ActionBar.c6 f40945a;
    public final Paint f40946b;
    ...
    public final void draw(Canvas canvas, CharSequence charSequence, int i10, int i11, float f9, int i12, int i13, int i14, Paint paint) {
        int v02 = org.telegram.ui.ActionBar.g6.v0(this.f40947c, this.f40945a);
        int l1 = org.telegram.ui.ActionBar.g6.l1(0.15f, v02);
        Paint paint2 = this.f40946b;
        paint2.setColor(l1);
        float f10 = (i14 + i12) / 2.0f;
        RectF rectF = AndroidUtilities.rectTmp;
        float dp = AndroidUtilities.dp(14.66f) / 2.0f;
        rectF.set(f9, f10 - dp, this.d.l() + f9 + AndroidUtilities.dp(9.33f), dp + f10);
