...
public final class o00 extends FrameLayout {
    ...
    public final void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        if (this.f36196c) {
            TextView textView = this.f36194a;
            canvas.drawRect(textView.getLeft(), getMeasuredHeight() - 1, textView.getRight(), getMeasuredHeight(), org.telegram.ui.ActionBar.j6.f18985k0);
        }
    }
    ...
    public final void setEnabled(boolean z10) {
        ...
        this.f36194a.setAlpha(f7);
        if (z10) {
            f10 = 1.0f;
        }
        this.f36195b.setAlpha(f10);
    }
}
