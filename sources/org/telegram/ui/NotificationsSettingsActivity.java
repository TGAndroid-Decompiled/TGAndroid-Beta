...
public class NotificationsSettingsActivity extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public boolean W;
    public boolean X;
    public org.telegram.ui.Components.yl0 f31179a;
    ...
    public static void U(NotificationsSettingsActivity notificationsSettingsActivity, ArrayList arrayList, ArrayList arrayList2, ArrayList arrayList3, ArrayList arrayList4, ArrayList arrayList5, ArrayList arrayList6, ArrayList arrayList7, ArrayList arrayList8, Runnable runnable) {
        ...
        notificationsSettingsActivity.f31182f = arrayList6;
        notificationsSettingsActivity.h = arrayList7;
        notificationsSettingsActivity.f31183n = arrayList8;
        vk0 vk0Var = notificationsSettingsActivity.f31181c;
        if (vk0Var != null) {
            vk0Var.m(notificationsSettingsActivity.privateRow);
            notificationsSettingsActivity.f31181c.m(notificationsSettingsActivity.groupRow);
            notificationsSettingsActivity.f31181c.m(notificationsSettingsActivity.channelsRow);
            notificationsSettingsActivity.f31181c.m(notificationsSettingsActivity.storiesRow);
        }
        if (runnable != null) {
            runnable.run();
        }
    ...
    public static void V(NotificationsSettingsActivity notificationsSettingsActivity) {
        ...
        notificationsSettingsActivity.f31180b = false;
        ...
        notificationsSettingsActivity.f31181c.l();
    ...
    public static void X(NotificationsSettingsActivity notificationsSettingsActivity, int i10, int i11) {
        ...
        notificationsSettingsActivity.f31181c.m(i10);
    }
    ...
    public static void Z(NotificationsSettingsActivity notificationsSettingsActivity) {
        if (notificationsSettingsActivity.f31180b) {
            return;
        }
        notificationsSettingsActivity.f31180b = true;
    ...
    public final View createView(Context context) {
        ...
        this.f31179a = yl0Var;
        yl0Var.q1();
        this.f31179a.setItemAnimator(null);
        this.f31179a.setLayoutAnimation(null);
        this.f31179a.setLayoutManager(new gg.b0(1, false, 13));
        this.f31179a.setVerticalScrollBarEnabled(false);
        frameLayout.addView(this.f31179a, w7.y5.c(-1.0f, -1));
        org.telegram.ui.Components.yl0 yl0Var2 = this.f31179a;
        vk0 vk0Var = new vk0(this, context);
        this.f31181c = vk0Var;
        yl0Var2.setAdapter(vk0Var);
        this.f31179a.setOnItemClickListener(new uk0(this));
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31179a, 16, new Class[]{org.telegram.ui.Cells.n4.class, org.telegram.ui.Cells.x8.class, org.telegram.ui.Cells.e9.class, org.telegram.ui.Cells.fa.class, org.telegram.ui.Cells.k5.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19109d6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31179a, 32768, null, null, null, null, org.telegram.ui.ActionBar.j6.f19387s8));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31179a, 4096, null, null, null, null, org.telegram.ui.ActionBar.j6.f19199i6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31179a, 0, new Class[]{View.class}, org.telegram.ui.ActionBar.j6.f19231k0, null, null, org.telegram.ui.ActionBar.j6.f19110d7));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31179a, 0, new Class[]{org.telegram.ui.Cells.n4.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.L6));
        int i10 = org.telegram.ui.ActionBar.j6.G6;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31179a, 0, new Class[]{org.telegram.ui.Cells.k5.class}, new String[]{"textView"}, null, null, -1, null, i10));
        int i11 = org.telegram.ui.ActionBar.j6.f19511z6;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31179a, 0, new Class[]{org.telegram.ui.Cells.k5.class}, new String[]{"valueTextView"}, null, null, -1, null, i11));
        int i12 = org.telegram.ui.ActionBar.j6.M6;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31179a, 0, new Class[]{org.telegram.ui.Cells.k5.class}, new String[]{"checkBox"}, null, null, -1, null, i12));
        int i13 = org.telegram.ui.ActionBar.j6.N6;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31179a, 0, new Class[]{org.telegram.ui.Cells.k5.class}, new String[]{"checkBox"}, null, null, -1, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31179a, 0, new Class[]{org.telegram.ui.Cells.x8.class}, new String[]{"textView"}, null, null, -1, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31179a, 0, new Class[]{org.telegram.ui.Cells.x8.class}, new String[]{"valueTextView"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31179a, 0, new Class[]{org.telegram.ui.Cells.x8.class}, new String[]{"checkBox"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31179a, 0, new Class[]{org.telegram.ui.Cells.x8.class}, new String[]{"checkBox"}, null, null, -1, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31179a, 0, new Class[]{org.telegram.ui.Cells.fa.class}, new String[]{"textView"}, null, null, -1, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31179a, 0, new Class[]{org.telegram.ui.Cells.fa.class}, new String[]{"valueTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.I6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31179a, 0, new Class[]{org.telegram.ui.Cells.e9.class}, new String[]{"textView"}, null, null, -1, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31179a, 0, new Class[]{org.telegram.ui.Cells.e9.class}, new String[]{"valueTextView"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31179a, 0, new Class[]{org.telegram.ui.Cells.f9.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.B6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31179a, 2, new Class[]{org.telegram.ui.Cells.f9.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.J6));
        return arrayList;
    }
