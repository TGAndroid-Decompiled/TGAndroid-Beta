...
public abstract class q4 extends View implements org.telegram.ui.Components.jh0 {
    ...
    public int S;
    public String T;
    public final RectF f36751a;
    public int f36752b;
    public final Rect f36753c;
    public final Rect d;
    public final RectF e;
    public final GradientDrawable f36754f;
    public final GradientDrawable h;
    public final float[] f36755n;
    public final Paint f36756r;
    public final Paint f36757s;
    public final Paint v;
    public final Path f36758w;
    public final RectF f36759x;
    public final GradientDrawable[] f36760y;

    public q4(Context context) {
        super(context);
        GradientDrawable.Orientation orientation;
        this.f36751a = new RectF();
        this.f36752b = 1;
        this.f36753c = new Rect();
        this.d = new Rect();
        this.e = new RectF();
        this.f36755n = new float[]{0.0f, 1.0f};
        this.f36758w = new Path();
        this.f36759x = new RectF();
        this.f36760y = new GradientDrawable[2];
        ...
        for (int i10 = 0; i10 < 2; i10++) {
            ...
            this.f36760y[i10] = new GradientDrawable(orientation, new int[]{838860800, 0});
            this.f36760y[i10].setShape(0);
        }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        Path path = this.f36758w;
        path.reset();
        RectF rectF = this.f36759x;
