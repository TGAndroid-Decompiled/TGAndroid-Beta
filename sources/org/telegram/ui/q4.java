...
public final class q4 extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final int U() {
        ...
        while (true) {
            ...
            if (i10 < arrayList.size()) {
                if (((p4) arrayList.get(i10)).f20334b.f22133f) {
    ...
    public final void V(int i10, boolean z10) {
        ...
        transitionSet.setInterpolator((TimeInterpolator) org.telegram.ui.Components.rr.f27701f);
        TransitionManager.beginDelayedTransition(this.f36282f, transitionSet);
        int i11 = 0;
        while (true) {
            ArrayList arrayList = this.h;
            if (i11 < arrayList.size()) {
                ...
                while (i12 < arrayList.size()) {
                    if (((p4) arrayList.get(i12)).d) {
                        this.f36282f.removeView((View) arrayList.get(i12));
                ...
                this.f36282f.addView((View) k6Var, size);
                X();
                W(k6Var, z10);
                return;
            }
    ...
    public final void X() {
        ...
        while (true) {
            ArrayList arrayList = this.h;
            if (i10 < arrayList.size()) {
                ((p4) arrayList.get(i10)).setBackground(org.telegram.ui.ActionBar.h6.g0(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f18789d6, false), org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f18878i6, false)));
    ...
    public final View createView(Context context) {
        ...
        this.f36282f = linearLayout;
        linearLayout.setOrientation(1);
        this.f36282f.setBackgroundColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f18789d6, false));
        xdVar.addView(this.f36282f, w7.x5.n(-1, -2));
        ...
        p4 p4Var2 = this.f36280b;
        p4Var2.e = 1440;
        this.f36282f.addView(p4Var2);
        ...
        p4 p4Var3 = this.f36281c;
        p4Var3.e = 10080;
        this.f36282f.addView(p4Var3);
        ...
        this.e.f20334b.setVisibility(8);
        this.f36282f.addView(this.e);
        p4 p4Var5 = this.f36279a;
        ArrayList arrayList = this.h;
        arrayList.add(p4Var5);
        arrayList.add(this.f36280b);
        arrayList.add(this.f36281c);
    ...
    public final void onPause() {
        ...
        while (true) {
            ...
            if (i10 < arrayList.size()) {
                if (((p4) arrayList.get(i10)).f20334b.f22133f) {
                    if (((p4) arrayList.get(i10)).e != this.f36283n) {
                        this.f36283n = ((p4) arrayList.get(i10)).e;
                        ...
                        getUserConfig().setGlobalTtl(this.f36283n);
