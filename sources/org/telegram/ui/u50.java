...
public final class u50 {
    ...
    public final org.telegram.ui.Components.t01 f37114f;
    public t50 f37115g;
    public int f37117j;
    public final Paint f37111a = new Paint(1);
    public final Paint f37112b = new Paint(1);
    public final w50[] f37113c = new w50[4];
    public boolean h = true;
    public final org.telegram.ui.Components.d6 f37116i = new org.telegram.ui.Components.d6(new i10(this, 7), 320, org.telegram.ui.Components.wr.h, 0);
    public final RectF f37118k = new RectF();
    public final RectF f37119l = new RectF();
    public final Path f37120m = new Path();

    public u50() {
        int i10 = 0;
        while (true) {
            w50[] w50VarArr = this.f37113c;
            if (i10 < w50VarArr.length) {
                w50VarArr[i10] = new w50(i10);
                i10++;
            } else {
                this.f37111a.setColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18227tg, false));
                ...
                this.e = t01Var;
                this.f37114f = new org.telegram.ui.Components.t01(LocaleController.getString(R.string.ConferenceEncryptedClose), 14.0f, AndroidUtilities.bold());
                b(null);
                return;
            }
        }
    ...
    public final boolean a(Canvas canvas, float f7, float f10) {
        ...
        t01Var.f27257p = f7 - AndroidUtilities.dp(132.0f);
        int d = i0.a.d(f10, this.f37117j, org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18227tg, false));
        Paint paint = this.f37111a;
        paint.setColor(d);
        float e = this.f37116i.e(this.h);
        ...
        if (f10 > 0.0f) {
            ...
            this.f37114f.c(rectF.centerX() - (this.f37114f.l() / 2.0f), j3 - AndroidUtilities.dp(20.0f), f10, -1, canvas);
        }
        canvas.restore();
        return z11;
    }
    ...
    public final void b(String[] strArr) {
        ...
        for (int i10 = 0; i10 < 4; i10++) {
            w50 w50Var = this.f37113c[i10];
            if (strArr == null) {
                str = null;
            } else {
                str = strArr[i10];
            }
            v50 v50Var = w50Var.f37722k;
            boolean z12 = w50Var.f37718f;
            if (str != null) {
                z11 = true;
            } else {
                z11 = false;
            ...
            w50Var.f37718f = z11;
            if (str != null && (w50Var.d == null || !TextUtils.equals(w50Var.f37723l, str))) {
                org.telegram.ui.Components.p5 p5Var = w50Var.d;
                if (p5Var != null) {
                    p5Var.p(v50Var);
                }
                w50Var.f37717c = Emoji.getEmojiDrawable(str);
            ...
            if (w50Var.f37718f && !z12) {
                w50Var.e = false;
            }
        }
        t50 t50Var = this.f37115g;
        if (t50Var != null) {
            t50Var.invalidate();
        }
    }
