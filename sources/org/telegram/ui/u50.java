...
public final class u50 {
    ...
    public final org.telegram.ui.Components.f01 f40959e;
    public final org.telegram.ui.Components.f01 f40960f;
    public t50 f40961g;
    public int f40963j;
    public final Paint f40956a = new Paint(1);
    public final Paint f40957b = new Paint(1);
    public final w50[] f40958c = new w50[4];
    public boolean h = true;
    public final org.telegram.ui.Components.e6 f40962i = new org.telegram.ui.Components.e6(new g10(this, 7), 320, org.telegram.ui.Components.pr.h, 0);
    public final RectF f40964k = new RectF();
    public final RectF f40965l = new RectF();
    public final Path f40966m = new Path();

    public u50() {
        int i10 = 0;
        while (true) {
            w50[] w50VarArr = this.f40958c;
            if (i10 < w50VarArr.length) {
                w50VarArr[i10] = new w50(i10);
                i10++;
            } else {
                this.f40956a.setColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20990tg, false));
                ...
                this.f40959e = f01Var;
                this.f40960f = new org.telegram.ui.Components.f01(LocaleController.getString(R.string.ConferenceEncryptedClose), 14.0f, AndroidUtilities.bold());
                b(null);
                return;
            }
        }
    ...
    public final boolean a(Canvas canvas, float f7, float f10) {
        ...
        f01Var.f25885p = f7 - AndroidUtilities.dp(132.0f);
        int d = i0.a.d(f10, this.f40963j, org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20990tg, false));
        Paint paint = this.f40956a;
        paint.setColor(d);
        float e7 = this.f40962i.e(this.h);
        ...
        float j3 = this.f40959e.j() + AndroidUtilities.dp(54.0f) + AndroidUtilities.dp(50.0f);
        ...
        if (f10 > 0.0f) {
            this.f40959e.c(AndroidUtilities.dp(16.0f) + (rectF.centerX() - (dp4 / 2.0f)), AndroidUtilities.dp(54.0f), f10, -1, canvas);
            Paint paint2 = this.f40957b;
            ...
            this.f40960f.c(rectF.centerX() - (this.f40960f.l() / 2.0f), j3 - AndroidUtilities.dp(20.0f), f10, -1, canvas);
        }
        canvas.restore();
        return z11;
    }
    ...
    public final void b(String[] strArr) {
        ...
        for (int i10 = 0; i10 < 4; i10++) {
            w50 w50Var = this.f40958c[i10];
            if (strArr == null) {
                str = null;
            } else {
                str = strArr[i10];
            }
            v50 v50Var = w50Var.f41798k;
            boolean z12 = w50Var.f41794f;
            if (str != null) {
                z11 = true;
            } else {
                z11 = false;
            ...
            w50Var.f41794f = z11;
            if (str != null && (w50Var.d == null || !TextUtils.equals(w50Var.f41799l, str))) {
                org.telegram.ui.Components.q5 q5Var = w50Var.d;
                if (q5Var != null) {
                    q5Var.p(v50Var);
                }
                w50Var.f41792c = Emoji.getEmojiDrawable(str);
            ...
            if (w50Var.f41794f && !z12) {
                w50Var.f41793e = false;
            }
        }
        t50 t50Var = this.f40961g;
        if (t50Var != null) {
            t50Var.invalidate();
        }
    }
