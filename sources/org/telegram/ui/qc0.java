...
public final class qc0 extends gg.t0 {
    ...
    public qc0(cd0 cd0Var, Context context, int i10, long j3, org.telegram.ui.ActionBar.d6 d6Var, boolean z10, boolean z11) {
        ...
        this.f36859n0 = cd0Var;
        this.m0 = true;
    }

    @Override
    public final void K() {
        this.f36859n0.r0(null);
    }

    @Override
    public final void N(ArrayList arrayList) {
        int i10;
        cd0 cd0Var = this.f36859n0;
        ...
        if (messageObject != null && messageObject.isLiveLocation()) {
            ...
            if (arrayList != null) {
                ...
                for (int i12 = 0; i12 < arrayList.size(); i12++) {
                    ...
                    if (wc0Var != null && !UserObject.isUserSelf(wc0Var.f38956c)) {
                        i10++;
                    }
                }
            } else {
            ...
            if (this.m0 && i10 == 1) {
                cd0Var.f32666i0 = ((wc0) arrayList.get(0)).f38954a;
            }
            this.m0 = false;
