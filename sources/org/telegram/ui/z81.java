...
public final class z81 extends org.telegram.ui.ActionBar.m2 implements NotificationCenter.NotificationCenterDelegate, org.telegram.ui.Components.u40, xg0, le.e {
    ...
    public final le.c f40408a;
    public final RectF f40409a0;
    public w8 f40410b;
    public final RectF f40411b0;
    public org.telegram.ui.Components.r61 f40412c;
    public ci.r6 d;
    public org.telegram.ui.ActionBar.u0 e;
    public org.telegram.ui.ActionBar.u0 f40413f;
    public r81 h;
    public org.telegram.ui.Components.v40 f40414n;
    public AnimatorSet f40415r;
    public org.telegram.ui.Cells.z3 f40416s;
    public TLRPC.FileLocation v;
    public TLRPC.FileLocation f40417w;
    public FrameLayout f40418x;
    public FrameLayout f40419y;
    ...
    public static boolean U(z81 z81Var, org.telegram.ui.Components.v51 v51Var, View view) {
        ...
        if (v51Var.G(org.telegram.ui.Cells.w6.class)) {
            ...
            if (!TextUtils.isEmpty(str)) {
                ...
                H.W(z81Var.f40412c.V0(view, false));
                H.Z();
                return true;
            }
        }
    ...
    public static void V(z81 z81Var) {
        ...
        org.telegram.ui.Components.v40 v40Var = z81Var.f40414n;
    ...
    public static void b0(z81 z81Var, ArrayList arrayList) {
        ...
        if (p0Var != null && p0Var.getTag() != null) {
            ...
            if (r81Var.f31957w) {
                ArrayList arrayList6 = r81Var.f31955r;
                ...
                while (i12 < size) {
                    ...
                    J.f29048l = (CharSequence) r81Var.f31954n.get(i11);
                    J.G = (z01) obj;
                    arrayList.add(J);
                    i11++;
                }
                if (!r81Var.f31956s.isEmpty()) {
                    arrayList.add(org.telegram.ui.Components.v51.q(LocaleController.getString(R.string.SettingsFaqSearchTitle)));
                    ArrayList arrayList7 = r81Var.f31956s;
                    ...
                    while (i10 < size2) {
                        ...
                        J2.f29048l = (CharSequence) r81Var.f31954n.get(i11);
        ...
        if (attachMenuBots != null && (arrayList2 = attachMenuBots.bots) != null && !arrayList2.isEmpty()) {
            ...
            while (i10 < size5) {
                ...
                if (tL_attachMenuBot2.show_in_side_menu && tL_attachMenuBot2.bot_id == 1985737506) {
                    ...
                    J7.d = (int) (j11 ^ (j11 >>> 32));
                    J7.f29047k = i24;
                    J7.f29048l = tL_attachMenuBot2.short_name;
    ...
    public static void c0(z81 z81Var, TLRPC.TL_error tL_error, TLObject tLObject, String str) {
        ...
        if (tL_error == null) {
            ...
            } else if (closestPhotoSizeWithSize2 != null && z81Var.f40417w != null) {
                FileLoader.getInstance(z81Var.currentAccount).getPathToAttach(z81Var.f40417w, true).renameTo(FileLoader.getInstance(z81Var.currentAccount).getPathToAttach(closestPhotoSizeWithSize2, true));
            }
        ...
        if (i10 == 1) {
            ...
            try {
                if (i10 == 14) {
                    ...
                    pi.a aVar = pi.e.f41358a;
                    synchronized (aVar) {
                        try {
                            if (!aVar.f41350b) {
                                aVar.f41351c = pi.d.f41357a.getBoolean("experimental_settings_allowed", true);
                                aVar.f41350b = true;
                            }
                            boolean z12 = !aVar.f41351c;
                            aVar.f41351c = z12;
                            aVar.f41350b = true;
                            pi.d.f41357a.edit().putBoolean("experimental_settings_allowed", z12).apply();
                        } finally {
                        }
                    }
                    z81Var.f40412c.Y2.N(true);
    ...
    public static void e0(z81 z81Var, TLRPC.InputFile inputFile, TLRPC.InputFile inputFile2, TLRPC.VideoSize videoSize, double d, String str, TLRPC.PhotoSize photoSize, TLRPC.PhotoSize photoSize2) {
        if (inputFile == null && inputFile2 == null && videoSize == null) {
            ...
            z81Var.f40417w = photoSize2.location;
    ...
    public static void f0(z81 z81Var, org.telegram.ui.Components.v51 v51Var) {
        ...
        if (obj instanceof TLRPC.TL_attachMenuBot) {
            ...
            if (obj2 instanceof z01) {
                ...
                z01Var.f40307b.run();
                AndroidUtilities.scrollToFragmentRow(parentLayout, z01Var.f40308c);
            } else if (obj2 instanceof MessagesController.FaqSearchResult) {
    ...
    public final void B(float f7) {
        org.telegram.ui.Cells.z3 z3Var = this.f40416s;
        if (z3Var == null) {
            return;
        }
    ...
    public final View createView(Context context) {
        this.f40410b = new w8(this, context, 7);
        ...
        this.f40413f.e(2, R.drawable.msg_leave, LocaleController.getString(R.string.LogOut));
        ...
        r61Var.p1();
        this.f40412c.setPadding(0, AndroidUtilities.dp(12.0f) + AndroidUtilities.statusBarHeight, 0, AndroidUtilities.navigationBarHeight + this.T);
        this.f40412c.setClipToPadding(false);
        this.f40412c.j(new i3(this, 28));
        org.telegram.ui.Components.r61 r61Var2 = this.f40412c;
        w8 w8Var = this.f40410b;
        Objects.requireNonNull(r61Var2);
        this.Y = new ah.n(r61Var2, w8Var, new v8(r61Var2, 0));
        this.f40412c.C0(new m81(this, 2));
        this.f40410b.addView(this.f40412c, w7.y5.e(-1, -1, 119));
        ci.r6 r6Var = new ci.r6(this, context);
        this.d = r6Var;
        this.f40410b.addView(r6Var, w7.y5.e(-1, 200, 48));
        this.f40410b.addView(this.actionBar, w7.y5.e(-1, -2, 55));
        org.telegram.ui.Components.v40 v40Var = new org.telegram.ui.Components.v40(0, true, true);
        this.f40414n = v40Var;
        v40Var.H = true;
        v40Var.f28991a = this;
        v40Var.f28992b = this;
        this.f40418x = new FrameLayout(context);
        FrameLayout frameLayout = new FrameLayout(context);
        this.f40419y = frameLayout;
        this.f40418x.addView(frameLayout, w7.y5.d(120, 120.0f, 49, 0.0f, 11.0f, 0.0f, 0.0f));
        this.f40419y.setOnClickListener(new n81(this, 5));
        w7.a6.a(this.f40419y);
        ...
        this.f40419y.addView(this.F, w7.y5.d(90, 90.0f, 49, 0.0f, 15.0f, 0.0f, 0.0f));
        org.telegram.ui.Cells.z3 z3Var = new org.telegram.ui.Cells.z3(this, context);
        this.f40416s = z3Var;
        z3Var.setSize(AndroidUtilities.dp(26.0f));
        this.f40416s.setProgressColor(-1);
        this.f40416s.setNoProgress(false);
        this.f40419y.addView(this.f40416s, w7.y5.d(90, 90.0f, 49, 0.0f, 15.0f, 0.0f, 0.0f));
        n0(false, false);
        ...
        this.f40419y.addView(this.G, w7.y5.d(34, 34.0f, 49, 32.0f, 75.0f, 0.0f, 0.0f));
        w7.a6.a(this.G);
        ...
        TextView h = org.telegram.ui.Cells.c1.h(this.f40418x, this.J, w7.y5.d(-1, -2.0f, 49, 16.0f, 126.33299f, 16.0f, 0.0f), context);
        this.K = h;
        h.setTextSize(1, 13.0f);
        this.K.setGravity(17);
        this.K.setSingleLine();
        this.K.setEllipsize(truncateAt);
        TextView h10 = org.telegram.ui.Cells.c1.h(this.f40418x, this.K, w7.y5.d(-1, -2.0f, 49, 0.0f, 156.0f, 0.0f, 0.0f), context);
        this.L = h10;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.starBalanceUpdated) {
            ...
            m0(getUserConfig().getCurrentUser());
        } else if (i10 == NotificationCenter.newSuggestionsAvailable && (r61Var = this.f40412c) != null) {
            r61Var.Y2.N(true);
        }
    }
    ...
    public final void i0() {
        ...
        if (Build.VERSION.SDK_INT >= 31 && (hVar = this.V) != null) {
            ...
            this.f40409a0.set(0.0f, -dp, this.fragmentView.getMeasuredWidth(), this.actionBar.getMeasuredHeight() + dp);
            RectF rectF = this.f40411b0;
    ...
    public final boolean isSwipeBackEnabled(MotionEvent motionEvent) {
        return !this.f40408a.f14201f;
    }

    public final void j0() {
        float f7;
        org.telegram.ui.ActionBar.u0 u0Var = this.f40413f;
        le.c cVar = this.f40408a;
    ...
    public final void l0(org.telegram.ui.ActionBar.m2 m2Var) {
        ...
        if (AndroidUtilities.isTablet() && (launchActivity = LaunchActivity.G1) != null && (actionBarLayout = launchActivity.f31134s0) != null) {
    ...
    public final void n0(boolean z10, boolean z11) {
        ...
        AnimatorSet animatorSet = this.f40415r;
        if (animatorSet != null) {
            animatorSet.cancel();
            this.f40415r = null;
        }
        if (z11) {
            ...
            this.f40415r = animatorSet2;
            if (z10) {
                this.f40416s.setVisibility(0);
                this.f40415r.playTogether(ObjectAnimator.ofFloat(this.f40416s, View.ALPHA, 1.0f));
            } else {
                animatorSet2.playTogether(ObjectAnimator.ofFloat(this.f40416s, View.ALPHA, 0.0f));
            }
            this.f40415r.setDuration(180L);
            this.f40415r.addListener(new c70(9, this, z10));
            this.f40415r.start();
        } else if (z10) {
            this.f40416s.setAlpha(1.0f);
            this.f40416s.setVisibility(0);
        } else {
            this.f40416s.setAlpha(0.0f);
            this.f40416s.setVisibility(4);
        }
    }
    ...
    public final void p0() {
        ...
        this.f40410b.setBackgroundColor(getThemedColor(org.telegram.ui.ActionBar.h6.f19003a7));
    ...
    public z81(Bundle bundle) {
        super(bundle);
        this.f40408a = new le.c(0, this, org.telegram.ui.Components.rr.h, 350L, false);
        this.O = 0;
