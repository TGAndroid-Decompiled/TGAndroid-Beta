...
public final class op0 extends Drawable {
    ...
    public float f36319a = AndroidUtilities.dpf2(10.6665f);
    public final boolean f36320b;
    public Paint f36321c;
    public final Paint d;
    public final Paint e;
    public final Paint f36322f;
    public final Path f36323g;
    public final Path h;
    public final org.telegram.ui.Components.o5 f36324i;
    ...
    public op0(int i10, int i11, int i12) {
        ...
        this.f36322f = paint3;
        this.f36323g = new Path();
        this.h = new Path();
        this.f36320b = i12 != i10;
        paint.setColor(i10);
        paint2.setColor(i11);
        paint3.setColor(i12);
        this.f36324i = null;
    ...
    public final void d() {
        Path path = this.h;
        path.rewind();
        float f7 = this.f36319a;
        path.addCircle(f7, f7, f7, Path.Direction.CW);
        Path path2 = this.f36323g;
        path2.rewind();
        path2.moveTo(this.f36319a * 2.0f, 0.0f);
        float f10 = this.f36319a;
        path2.lineTo(f10 * 2.0f, f10 * 2.0f);
        path2.lineTo(0.0f, this.f36319a * 2.0f);
        path2.close();
    }
    ...
    public final void draw(Canvas canvas) {
        canvas.save();
        canvas.translate(getBounds().centerX() - this.f36319a, getBounds().centerY() - this.f36319a);
        Paint paint = this.f36321c;
        if (paint != null) {
            float f7 = this.f36319a;
        ...
        canvas.drawPath(this.f36323g, this.e);
        if (this.f36320b) {
            RectF rectF = AndroidUtilities.rectTmp;
            rectF.set(this.f36319a - AndroidUtilities.dp(3.66f), this.f36319a - AndroidUtilities.dp(3.66f), this.f36319a + AndroidUtilities.dp(3.66f), this.f36319a + AndroidUtilities.dp(3.66f));
            float f10 = this.f36319a;
            canvas.rotate(45.0f, f10, f10);
            canvas.drawRoundRect(rectF, AndroidUtilities.dp(2.33f), AndroidUtilities.dp(2.33f), this.f36322f);
        }
        canvas.restore();
        org.telegram.ui.Components.o5 o5Var = this.f36324i;
        if (o5Var != null) {
    ...
    public final void f(float f7, int i10) {
        ...
        this.f36321c.setStrokeWidth(f7);
        this.f36321c.setColor(i10);
    }

    @Override
    public final int getIntrinsicHeight() {
        return (int) (this.f36319a * 2.0f);
    }
