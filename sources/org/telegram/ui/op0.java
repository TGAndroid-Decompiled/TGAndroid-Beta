...
public final class op0 extends org.telegram.ui.Components.kl0 {
    ...
    @Override
    public final int h() {
        return this.f39324e.f41642k0;
    }

    @Override
    public final int j(int i10) {
        vp0 vp0Var = this.f39324e;
        if (i10 == vp0Var.R || i10 == vp0Var.f41638g0 || i10 == vp0Var.T || i10 == vp0Var.W) {
            return 2;
        }
        if (i10 == vp0Var.Q) {
            return 1;
        ...
        if (i10 == vp0Var.f41639h0) {
            return 10;
        }
        if (i10 == vp0Var.f41640i0) {
            return 11;
        }
        if (i10 == vp0Var.f41628a0) {
            return 7;
        }
        if (i10 >= vp0Var.f41630b0 && i10 < vp0Var.f41632c0) {
            ...
            return 12;
        } else if (i10 >= vp0Var.f41633d0 && i10 < vp0Var.f41635e0) {
            return 9;
        } else {
            if (i10 != vp0Var.f41642k0 - 1 && i10 != vp0Var.f41641j0) {
                return 2;
            }
            return 4;
        }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        ArrayList arrayList = vp0Var.f41643l0;
        ...
        switch (j3) {
            ...
            case 3:
                ...
                up0Var.setBackgroundColor(bq0Var2.getThemedColor(org.telegram.ui.ActionBar.j6.f20691d6));
            ...
            case 6:
                ...
                r8Var.v();
                r8Var.setBackgroundColor(bq0Var.getThemedColor(org.telegram.ui.ActionBar.j6.f20691d6));
                r8Var.v();
                if (i10 == vp0Var.V) {
                    if (bq0Var.f34885a) {
            ...
            case 7:
                ...
                l4Var.setBackgroundColor(bq0Var.getThemedColor(org.telegram.ui.ActionBar.j6.f20691d6));
                return;
            case 8:
                jp0 jp0Var = (jp0) view;
                int i17 = i10 - vp0Var.f41630b0;
                if (i17 >= 0 && i17 < arrayList.size()) {
                    ...
                    TLRPC.TL_emojiStatusCollectible tL_emojiStatusCollectible = vp0Var.f41648r;
                    if ((tL_emojiStatusCollectible != null && tL_emojiStatusCollectible.collectible_id == tL_starGiftUnique.f20123id) || ((tL_peerColorCollectible = vp0Var.f41649s) != null && tL_peerColorCollectible.collectible_id == tL_starGiftUnique.f20123id)) {
                        z10 = true;
                    } else {
                        z10 = false;
                    }
            ...
            case 10:
                ...
                ArrayList arrayList4 = aq0Var.f34558f;
                if (aq0Var.K == 0) {
                    z11 = true;
                } else {
                    z11 = false;
            ...
            case 12:
                ...
                if (vp0Var.J != null && i20 >= 0 && i20 < arrayList.size()) {
                    ...
                    TLRPC.TL_emojiStatusCollectible tL_emojiStatusCollectible2 = vp0Var.f41648r;
                    if ((tL_emojiStatusCollectible2 == null || tL_emojiStatusCollectible2.collectible_id != tL_starGiftUnique2.f20123id) && ((tL_peerColorCollectible2 = vp0Var.f41649s) == null || tL_peerColorCollectible2.collectible_id != tL_starGiftUnique2.f20123id)) {
                        z12 = false;
                    }
                    h1Var.e(z12, false);
                    return;
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        switch (i10) {
            case 1:
                ...
                vp0Var.f41636f = yp0Var;
                yp0Var.setBackgroundColor(bq0Var.getThemedColor(org.telegram.ui.ActionBar.j6.f20691d6));
    ...
    public final void y(s4.c1 c1Var) {
        ...
        if (i10 == 8) {
            jp0 jp0Var = (jp0) view;
            int b10 = c1Var.b() - vp0Var.f41630b0;
            if (b10 >= 0 && b10 < arrayList.size()) {
                ...
                TLRPC.TL_emojiStatusCollectible tL_emojiStatusCollectible = vp0Var.f41648r;
                if ((tL_emojiStatusCollectible == null || tL_emojiStatusCollectible.collectible_id != tL_starGiftUnique.f20123id) && ((tL_peerColorCollectible2 = vp0Var.f41649s) == null || tL_peerColorCollectible2.collectible_id != tL_starGiftUnique.f20123id)) {
                    z10 = false;
                }
                jp0Var.b(z10, false);
            }
            ...
            yh.h1 h1Var = (yh.h1) view;
            int b11 = c1Var.b() - vp0Var.f41630b0;
            if (vp0Var.J != null && b11 >= 0 && b11 < arrayList.size()) {
                ...
                h1Var.g(tL_starGiftUnique2, false, false, false, true, false);
                TLRPC.TL_emojiStatusCollectible tL_emojiStatusCollectible2 = vp0Var.f41648r;
                if ((tL_emojiStatusCollectible2 == null || tL_emojiStatusCollectible2.collectible_id != tL_starGiftUnique2.f20123id) && ((tL_peerColorCollectible = vp0Var.f41649s) == null || tL_peerColorCollectible.collectible_id != tL_starGiftUnique2.f20123id)) {
                    z10 = false;
                }
                h1Var.e(z10, false);
            }
