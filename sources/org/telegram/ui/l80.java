...
public final class l80 extends FrameLayout implements org.telegram.ui.ActionBar.a6 {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        Paint paint = this.f35480a;
        paint.setShadowLayer(dpf2, 0.0f, dpf22, 285212672);
        int i10 = org.telegram.ui.ActionBar.j6.f18863d6;
        n80 n80Var = this.f35483f;
        paint.setColor(n80Var.getThemedColor(i10));
        RectF rectF = AndroidUtilities.rectTmp;
        rectF.set(AndroidUtilities.dp(12.0f), AndroidUtilities.dp(3.0f), getWidth() - AndroidUtilities.dp(12.0f), AndroidUtilities.dp(3.0f) + n80Var.f35973b.e + AndroidUtilities.dp(3.0f));
        Path path = this.f35481b;
        path.rewind();
        path.addRoundRect(rectF, AndroidUtilities.dp(20.0f), AndroidUtilities.dp(20.0f), Path.Direction.CW);
        GradientDrawable gradientDrawable = this.e;
        if (gradientDrawable != null) {
            gradientDrawable.setBounds(0, 0, getWidth(), Math.min(getHeight(), AndroidUtilities.dp(24.0f) + ((int) n80Var.f35973b.e)));
            this.e.draw(canvas);
        }
        canvas.save();
    ...
    @Override
    public final void e() {
        int themedColor = this.f35483f.getThemedColor(org.telegram.ui.ActionBar.j6.f18807a7);
