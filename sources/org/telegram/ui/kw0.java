...
public final class kw0 extends fg.i {
    ...
    public final void g() {
        ...
        if (premiumPreviewFragment.f31969o0 == null && BuildVars.DEBUG_PRIVATE_VERSION) {
            Context context = this.V;
            premiumPreviewFragment.f31969o0 = new FrameLayout(context);
            ScrollView scrollView = new ScrollView(context);
            fg.a aVar = ow0Var.d.f6156b;
            dg.u3 u3Var = new dg.u3(context, 8);
            u3Var.setOrientation(1);
            TextView textView = new TextView(context);
            textView.setText("Spectral top ");
            int i19 = org.telegram.ui.ActionBar.j6.f20084n5;
            ...
            ko0Var5.setProgress(dg.u3.f4812b / 2.0f);
            ko0Var5.setReportChanges(true);
            u3Var.addView(ko0Var5, k7.b6.d(-1, 38.0f, 0, 5.0f, 4.0f, 5.0f, 0.0f));
            scrollView.addView(u3Var);
            premiumPreviewFragment.f31969o0.addView(scrollView);
            premiumPreviewFragment.f31969o0.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19977h5, false));
            premiumPreviewFragment.f31952a0.addView(premiumPreviewFragment.f31969o0, k7.b6.e(-1, -1, 80));
            ((ViewGroup.MarginLayoutParams) premiumPreviewFragment.f31969o0.getLayoutParams()).topMargin = premiumPreviewFragment.Z;
            premiumPreviewFragment.f31969o0.setTranslationY(AndroidUtilities.dp(1000.0f));
            premiumPreviewFragment.f31969o0.animate().translationY(1.0f).setDuration(300L);
        }
    }
}
