...
public final class kw0 extends org.telegram.ui.ActionBar.m2 {
    ...
    public org.telegram.ui.Cells.z7 f35183b;
    public org.telegram.ui.Components.h90 f35184c;
    public org.telegram.ui.Components.s61 d;
    public org.telegram.ui.Components.rr e;
    public org.telegram.ui.ActionBar.u0 f35185f;
    public final boolean h;
    public final long f35186n;
    ...
    public final void V(boolean z10) {
        ...
        float f11;
        float f12;
        if (this.f35185f == null || this.f35189w == (X = X())) {
            return;
        }
        this.f35189w = X;
        this.f35185f.setEnabled(X);
        float f13 = 0.0f;
        if (z10) {
            ViewPropertyAnimator animate = this.f35185f.animate();
            if (X) {
                f11 = 1.0f;
            } else {
                f11 = 0.0f;
        ...
        org.telegram.ui.ActionBar.u0 u0Var = this.f35185f;
        if (X) {
            f7 = 1.0f;
        } else {
            f7 = 0.0f;
        ...
        u0Var.setAlpha(f7);
        org.telegram.ui.ActionBar.u0 u0Var2 = this.f35185f;
        if (X) {
            f10 = 1.0f;
        } else {
            f10 = 0.0f;
        ...
        org.telegram.ui.ActionBar.u0 u0Var3 = this.f35185f;
        if (X) {
            f13 = 1.0f;
        }
    ...
    public final String W() {
        ...
        return LocaleController.formatString(R.string.PostSuggestionsPriceInfo2, ei.l.G0(i10), String.valueOf(((int) (((((float) this.f35188s) * (i10 / 1000.0f)) / 1000.0d) * getMessagesController().starsUsdWithdrawRate1000)) / 100.0d));
    }

    public final boolean X() {
        if (this.f35188s == this.f35186n && this.f35187r == this.h) {
            return false;
        }
        return true;
    }
        ...
        if (this.e.f28047c <= 0.0f) {
            ...
            if (chat != null) {
                ...
                if (chat2 != null) {
                    if (this.f35187r) {
                        chat2.flags2 |= 16384;
                        chat2.send_paid_messages_stars = this.f35188s;
                    } else {
                        chat2.flags2 &= -16385;
    ...
    public final View createView(Context context) {
        ...
        this.f35185f = this.actionBar.n().i(AndroidUtilities.dp(56.0f), LocaleController.getString(R.string.Done), this.e);
        V(false);
        ...
        org.telegram.ui.Components.h90 h90Var = new org.telegram.ui.Components.h90(context, this, null, true, true);
        this.f35184c = h90Var;
        h90Var.setPadding(AndroidUtilities.dp(16.0f), AndroidUtilities.dp(12.0f), AndroidUtilities.dp(16.0f), 0);
        this.f35184c.setBackgroundColor(getThemedColor(i11));
        this.f35184c.b(true);
        this.f35184c.d(0, null, false);
        org.telegram.ui.Components.s61 s61Var = new org.telegram.ui.Components.s61(context, this.currentAccount, this.classGuid, false, new b5(this, 16), new jw0(this, 2), null, this.resourceProvider);
        this.d = s61Var;
        s61Var.p1();
