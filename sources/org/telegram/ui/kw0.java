...
public final class kw0 extends org.telegram.ui.ActionBar.m2 {
    ...
    public org.telegram.ui.Cells.z7 f35152b;
    public org.telegram.ui.Components.g90 f35153c;
    public org.telegram.ui.Components.r61 d;
    public org.telegram.ui.Components.qr e;
    public org.telegram.ui.ActionBar.u0 f35154f;
    public final boolean h;
    public final long f35155n;
    public boolean f35156r;
    public long f35157s;
    public io v;
    public boolean f35158w;
    ...
    public final void V(boolean z10) {
        ...
        float f11;
        float f12;
        if (this.f35154f == null || this.f35158w == (X = X())) {
            return;
        }
        this.f35158w = X;
        this.f35154f.setEnabled(X);
        float f13 = 0.0f;
        if (z10) {
            ViewPropertyAnimator animate = this.f35154f.animate();
            if (X) {
                f11 = 1.0f;
            } else {
                f11 = 0.0f;
        ...
        org.telegram.ui.ActionBar.u0 u0Var = this.f35154f;
        if (X) {
            f7 = 1.0f;
        } else {
            f7 = 0.0f;
        ...
        u0Var.setAlpha(f7);
        org.telegram.ui.ActionBar.u0 u0Var2 = this.f35154f;
        if (X) {
            f10 = 1.0f;
        } else {
            f10 = 0.0f;
        ...
        org.telegram.ui.ActionBar.u0 u0Var3 = this.f35154f;
        if (X) {
            f13 = 1.0f;
        }
    ...
    public final String W() {
        ...
        return LocaleController.formatString(R.string.PostSuggestionsPriceInfo2, ei.l.G0(i10), String.valueOf(((int) (((((float) this.f35157s) * (i10 / 1000.0f)) / 1000.0d) * getMessagesController().starsUsdWithdrawRate1000)) / 100.0d));
    }

    public final boolean X() {
        if (this.f35157s == this.f35155n && this.f35156r == this.h) {
            return false;
        }
        return true;
    }
        ...
        if (this.e.f27745c <= 0.0f) {
            ...
            if (chat != null) {
                ...
                if (chat2 != null) {
                    if (this.f35156r) {
                        chat2.flags2 |= 16384;
                        chat2.send_paid_messages_stars = this.f35157s;
                    } else {
                        chat2.flags2 &= -16385;
    ...
    public final View createView(Context context) {
        ...
        this.f35154f = this.actionBar.n().i(AndroidUtilities.dp(56.0f), LocaleController.getString(R.string.Done), this.e);
        V(false);
        ...
        this.f35153c.setBackgroundColor(getThemedColor(i11));
        this.f35153c.b(true);
        this.f35153c.d(0, null, false);
    ...
    public final boolean onBackPressed(boolean z10) {
        if (X()) {
            if (z10) {
                ...
                alertDialog$Builder.f18647a.T = LocaleController.getString(R.string.MessageSuggestionsUnsavedChanges);
