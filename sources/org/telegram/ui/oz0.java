...
public final class oz0 implements nq {
    public final TLRPC.Chat f39364a;
    public final qq f39365b;
    public final ProfileActivity f39366c;

    public oz0(ProfileActivity profileActivity, TLRPC.Chat chat, qq qqVar) {
        this.f39366c = profileActivity;
        this.f39364a = chat;
        this.f39365b = qqVar;
    }
    ...
    public final void a(TLRPC.User user) {
        int i10;
        ProfileActivity profileActivity = this.f39366c;
        UndoView undoView = profileActivity.M;
        long j3 = -profileActivity.f33897f1;
    ...
    public final void b(int i10, TLRPC.TL_chatAdminRights tL_chatAdminRights, TLRPC.TL_chatBannedRights tL_chatBannedRights, String str) {
        ...
        if (user != null && (chat = this.f39364a) != null && profileActivity.f33889e1 != 0) {
            qq qqVar = this.f39365b;
