...
public final class uc extends FrameLayout implements org.telegram.ui.ActionBar.z5 {
    public final hp0 f41085a;
    public final tc f41086b;
    public final org.telegram.ui.ActionBar.j5 f41087c;
    public final TextView d;
    public final TextView f41088e;
    public final LinearLayout f41089f;
    public final bd h;
    ...
    public uc(bd bdVar, Activity activity) {
        ...
        if (bdVar instanceof t60) {
            ...
            if (bdVar.d && bdVar.f34785s == -1) {
                i11 = bdVar.getThemedColor(i13);
            } else {
                i11 = -1;
            }
            textView2.setTextColor(i11);
            TL_stories.TL_premium_boostsStatus tL_premium_boostsStatus = bdVar.f34765c;
    ...
    public final void a() {
        ...
        org.telegram.ui.ActionBar.j5 j5Var = this.f41087c;
