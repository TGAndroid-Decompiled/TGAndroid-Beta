...
public final class mi1 implements VoIPService.StateListener, NotificationCenter.NotificationCenterDelegate, rf.a {
    ...
    public boolean f35302a0;
    public boolean f35303a1;
    public Activity f35304b;
    public TextureViewRenderer f35305b0;
    public float f35306b1;
    public final TLRPC.User f35307c;
    public org.telegram.ui.Components.voip.s2 f35308c0;
    public float f35309c1;
    public final TLRPC.User d;
    public org.telegram.ui.Components.voip.s2 f35310d0;
    public int f35311d1;
    public org.telegram.ui.Components.voip.k3 e;
    public org.telegram.ui.Components.voip.e f35312e0;
    public int f35313e1;
    public org.telegram.ui.Components.voip.k3 f35314f;
    public boolean f35315f0;
    public pf.e f35317g0;
    public boolean f35318g1;
    public org.telegram.ui.Components.voip.k3 h;
    public View f35319h0;
    public boolean f35320h1;
    public View f35321i0;
    public ValueAnimator f35322i1;
    public org.telegram.ui.Components.voip.r1 f35323j0;
    public boolean f35324j1;
    public org.telegram.ui.Components.voip.s2 f35326k1;
    public com.google.android.gms.internal.cast.p l1;
    public boolean m0;
    public boolean f35328m1;
    public ji1 f35329n;
    public boolean f35330n0;
    public fi1 f35331o0;
    public int f35332p0;
    public int f35333q0;
    public WindowInsets f35335r0;
    public hi1 f35336s;
    public boolean f35337s0;
    public float f35338t0;
    public ei1 f35339u0;
    public org.telegram.ui.Components.voip.c3 v;
    public int f35340v0;
    public org.telegram.ui.Components.voip.z2 f35341w;
    public AccessibilityManager f35342w0;
    public org.telegram.ui.Components.voip.e3 f35343x;
    public org.telegram.ui.Components.voip.t0 f35345y;
    public boolean f35347z0;
    public final org.telegram.ui.Components.voip.q1 f35334r = new org.telegram.ui.Components.voip.q1();
    public final org.telegram.ui.Components.w9[] V = new org.telegram.ui.Components.w9[4];
    public final Drawable[] W = new Drawable[4];
    public final Paint f35325k0 = new Paint();
    public final Paint f35327l0 = new Paint();
    public boolean f35344x0 = true;
    public float f35346y0 = 1.0f;
    ...
    public float f35316f1 = 1.0f;

    public mi1(int i10) {
        this.f35301a = i10;
        this.f35307c = MessagesController.getInstance(i10).getUser(Long.valueOf(UserConfig.getInstance(i10).getClientUserId()));
        ...
        this.f35333q0 = -1;
        this.f35332p0 = sharedState.getCallState();
    ...
    public static void i(mi1 mi1Var) {
        ...
        mi1Var.R0 = false;
        if (Build.VERSION.SDK_INT >= 23 && mi1Var.f35304b.checkSelfPermission("android.permission.CAMERA") != 0) {
            mi1Var.f35304b.requestPermissions(new String[]{"android.permission.CAMERA"}, 102);
        } else {
            mi1Var.C();
        }
    }
    ...
    public static void j(mi1 mi1Var) {
        ...
        if (mi1Var.f35318g1) {
            ...
            mi1Var.f35322i1 = ofFloat;
            mi1Var2 = mi1Var;
            ofFloat.addUpdateListener(new org.telegram.ui.Components.voip.x(mi1Var2, mi1Var.f35316f1, mi1Var.Y0, mi1Var.Z0, 1));
            mi1Var2.f35322i1.addListener(new ai1(mi1Var2, 0));
            mi1Var2.f35322i1.setDuration(350L);
            mi1Var2.f35322i1.setInterpolator(org.telegram.ui.Components.rr.f27701f);
            mi1Var2.f35322i1.start();
        } else {
            mi1Var2 = mi1Var;
        }
        mi1Var2.f35320h1 = false;
        mi1Var2.f35303a1 = false;
    }
        ...
        if (mi1Var != null) {
            if (i10 == 101) {
                if (VoIPService.getSharedState() == null) {
                    ...
                    mi1Var.r(new g91(2));
                } else if (!mi1Var.f35304b.shouldShowRequestPermissionRationale("android.permission.RECORD_AUDIO")) {
                    if (VoIPService.getSharedState() != null) {
                        VoIPService.getSharedState().declineIncomingCall();
                    }
                    org.telegram.ui.Components.voip.f2.h(mi1Var.f35304b, new wh1(mi1Var, 2), i10);
                    return;
                }
            }
            if (i10 == 102) {
    ...
    public static void w(Activity activity, int i10) {
        ...
        float f7;
        mi1 mi1Var = f35300n1;
        if (mi1Var != null && mi1Var.f35339u0.getParent() == null) {
            mi1 mi1Var2 = f35300n1;
            if (mi1Var2 != null) {
                mi1Var2.f35308c0.d.release();
                f35300n1.f35310d0.d.release();
                f35300n1.f35305b0.release();
                ei1 ei1Var = f35300n1.f35339u0;
                if (ei1Var != null) {
                    ei1Var.d();
                }
                f35300n1.l();
        ...
        if (f35300n1 == null && !activity.isFinishing()) {
            ...
            if (VoIPService.getSharedState() != null && VoIPService.getSharedState().getUser() != null) {
                ...
                mi1Var3.f35304b = activity;
                f35300n1 = mi1Var3;
                ei1 ei1Var2 = new ei1(activity, !z10, mi1Var3);
                f35300n1.J0 = ((KeyguardManager) activity.getSystemService("keyguard")).inKeyguardRestrictedInputMode();
                ((PowerManager) activity.getSystemService("power")).isInteractive();
                f35300n1.getClass();
                ei1Var2.setLockOnScreen(f35300n1.J0);
                mi1Var3.f35339u0 = ei1Var2;
                ...
                mi1Var3.f35338t0 = ViewConfiguration.get(activity).getScaledTouchSlop();
                mi1Var3.f35342w0 = (AccessibilityManager) f0.e.f(activity, AccessibilityManager.class);
                ...
                org.telegram.ui.Components.voip.q1 q1Var = mi1Var3.f35334r;
                ...
                mi1Var3.f35308c0 = s2Var;
                RendererCommon.ScalingType scalingType = RendererCommon.ScalingType.SCALE_ASPECT_FIT;
                s2Var.d.setScalingType(scalingType);
                mi1Var3.f35308c0.d.setEnableHardwareScaler(true);
                mi1Var3.f35308c0.d.setRotateTextureWithScreen(true);
                mi1Var3.f35308c0.f29175a0 = 1;
                ...
                mi1Var3.f35341w = z2Var;
                hi1Var.addView(z2Var, w7.x5.c(-1.0f, -1));
                ?? view = new View(activity);
                if (LiteMode.isEnabled(512)) {
                    int i12 = org.telegram.ui.ActionBar.h6.f18726a;
                    ...
                    if ((i13 == 11 && i14 >= 24 && i14 <= 31) || (i13 == 0 && i14 == 1)) {
                        view.f28912a = new org.telegram.ui.Components.aw0(0);
                    }
                }
                mi1Var3.f35343x = view;
                hi1Var.addView((View) view, w7.x5.c(220.0f, -1));
                hi1Var.addView(mi1Var3.f35308c0);
                ...
                mi1Var3.f35305b0 = textureViewRenderer;
                textureViewRenderer.setEnableHardwareScaler(true);
                mi1Var3.f35305b0.setIsCamera(false);
                mi1Var3.f35305b0.setFpsReduction(30.0f);
                mi1Var3.f35305b0.setScalingType(scalingType);
                mi1Var3.Z.addView(mi1Var3.f35305b0, w7.x5.e(-1, -2, 17));
                ...
                for (int i15 = 0; i15 < 4; i15++) {
                    ...
                    ub1Var2.addView(w9Var2, w7.x5.k(f7, 0.0f, 0.0f, 0.0f, 25, 25));
                }
                ...
                mi1Var3.f35345y = new org.telegram.ui.Components.voip.t0(activity);
                org.telegram.ui.Components.h9 h9Var = new org.telegram.ui.Components.h9((org.telegram.ui.ActionBar.d6) null);
                h9Var.r(user);
                org.telegram.ui.Components.voip.t0 t0Var = mi1Var3.f35345y;
                int i16 = mi1Var3.f35301a;
                t0Var.f29201b.h(ImageLocation.getForUserOrChat(i16, user, 0), null, h9Var, user);
                mi1Var3.f35345y.setRoundRadius(AndroidUtilities.dp(135.0f) / 2);
                ...
                frameLayout2.f29132a = new TextView[2];
                int i17 = 0;
                for (int i18 = 2; i17 < i18; i18 = 2) {
                    frameLayout2.f29132a[i17] = new TextView(activity);
                    frameLayout2.f29132a[i17].setTextSize(1, 15.0f);
                    frameLayout2.f29132a[i17].setTextColor(-1);
                    frameLayout2.f29132a[i17].setGravity(1);
                    frameLayout2.addView(frameLayout2.f29132a[i17]);
                    i17++;
                }
                FrameLayout frameLayout3 = new FrameLayout(activity);
                frameLayout2.f29134c = frameLayout3;
                ...
                frameLayout2.f29133b = textView3;
                ...
                if (sharedState != null && sharedState.getUser() != null && sharedState.isConference() && sharedState.getGroupCall() != null) {
                    ...
                    mi1Var3.G = li1Var;
                    long j3 = sharedState.getUser().f18230id;
                    ...
                    if (groupParticipants == null && i19 <= 0) {
                        ...
                        org.telegram.ui.Components.j9 j9Var = li1Var.f34990b;
                        j9Var.k(min);
                        int i20 = 0;
                        while (i20 < min) {
                        ...
                        if (max == 1 && (groupParticipants == null || groupParticipants.size() == 0 || (groupParticipants.size() == 1 && DialogObject.getPeerDialogId(groupParticipants.get(0).peer) == j10))) {
                            ...
                            li1Var.f34991c = new org.telegram.ui.Components.f01(LocaleController.formatPluralStringComma("Participants", max), 14.0f, AndroidUtilities.bold());
                ...
                hi1Var.addView(mi1Var3.f35345y, w7.x5.d(204, 204.0f, 1, 0.0f, 93.0f, 0.0f, 0.0f));
                ...
                mi1Var3.f35323j0 = new org.telegram.ui.Components.voip.r1(activity);
                mi1Var3.e = new org.telegram.ui.Components.voip.k3(activity, q1Var);
                mi1Var3.f35314f = new org.telegram.ui.Components.voip.k3(activity, q1Var);
                mi1Var3.h = new org.telegram.ui.Components.voip.k3(activity, q1Var);
                mi1Var3.f35329n = new org.telegram.ui.Components.voip.v2(activity, 52.0f);
                ...
                mi1Var3.f35314f.setTranslationY(AndroidUtilities.dp(100.0f));
                mi1Var3.f35314f.setScaleX(0.0f);
                mi1Var3.f35314f.setScaleY(0.0f);
                mi1Var3.f35314f.animate().setStartDelay(166).translationY(0.0f).scaleY(1.0f).scaleX(1.0f).setDuration(250L).start();
                ...
                mi1Var3.f35329n.setTranslationY(AndroidUtilities.dp(100.0f));
                mi1Var3.f35329n.setScaleX(0.0f);
                mi1Var3.f35329n.setScaleY(0.0f);
                mi1Var3.f35329n.animate().setStartDelay(198).translationY(0.0f).scaleY(1.0f).scaleX(1.0f).setDuration(250L).start();
                mi1Var3.f35323j0.addView(mi1Var3.e);
                mi1Var3.f35323j0.addView(mi1Var3.f35314f);
                mi1Var3.f35323j0.addView(mi1Var3.h);
                mi1Var3.f35323j0.addView(mi1Var3.f35329n);
                org.telegram.ui.Components.voip.e eVar = new org.telegram.ui.Components.voip.e(activity);
                mi1Var3.f35312e0 = eVar;
                eVar.setListener(new ki1(mi1Var3));
                mi1Var3.f35312e0.setScaleX(1.15f);
                mi1Var3.f35312e0.setScaleY(1.15f);
                hi1Var.addView(mi1Var3.f35323j0, w7.x5.e(-1, -2, 80));
                ...
                float f10 = i11;
                hi1Var.addView(mi1Var3.f35312e0, w7.x5.d(-1, 186.0f, 80, f10, 0.0f, f10, 0.0f));
                ...
                if (mi1Var3.f35339u0.f29303b) {
                    mi1Var3.H.setVisibility(8);
                    mi1Var3.I.setVisibility(8);
                }
                ?? linearLayout = new LinearLayout(activity);
                linearLayout.f28951a = new HashMap();
                linearLayout.f28952b = new ArrayList();
                linearLayout.f28953c = new ArrayList();
                TextPaint textPaint = new TextPaint();
                linearLayout.f28956r = textPaint;
                linearLayout.setOrientation(1);
                linearLayout.f28955n = q1Var;
                ...
                d3Var.K = alignment;
                d3Var.d = -1L;
                d3Var.f4615l0 = new wh1(mi1Var3, 6);
                d3Var.T = true;
                ...
                if (z10) {
                    ...
                    if (sharedInstance2 != null && sharedInstance2.getVideoState(false) == 2) {
                        mi1Var3.f35308c0.setStub(org.telegram.ui.Components.voip.m2.k().f29067r);
                        mi1Var3.f35310d0.setStub(org.telegram.ui.Components.voip.m2.k().f29066n);
                    }
                    mi1Var3.f35339u0.setAlpha(0.0f);
                    mi1Var3.H();
                    mi1Var3.E0 = true;
                ...
                if (sharedInstance3 != null && sharedInstance3.getRemoteVideoState() == 2 && sf.c.a(activity) == 1) {
                    mi1 mi1Var4 = f35300n1;
                    pf.d dVar = new pf.d(activity, mi1Var4);
                    dVar.f40736c = "voip-fragment-pip";
                    org.telegram.ui.Components.voip.s2 s2Var3 = mi1Var4.f35308c0;
                    dVar.f40740j = s2Var3.d;
                    dVar.f40741k = s2Var3.getPlaceholderView();
                    mi1Var4.f35317g0 = dVar.a();
                }
            }
        }
    }
    ...
    public final void A(boolean z10) {
        ...
        if (!z10 && this.f35344x0) {
            ...
            this.f35323j0.animate().alpha(0.0f).translationY(AndroidUtilities.dp(10.0f)).setDuration(150L).setInterpolator(rrVar).start();
            this.f35319h0.animate().alpha(0.0f).setDuration(150L).setInterpolator(rrVar).start();
            this.f35321i0.animate().alpha(0.0f).setDuration(150L).setInterpolator(rrVar).start();
            ValueAnimator ofFloat = ValueAnimator.ofFloat(this.f35346y0, 0.0f);
            this.P0 = ofFloat;
            ...
            this.R0 = false;
            this.f35323j0.setEnabled(false);
            this.O0.e(true);
            i10 = 150;
        } else {
            if (z10 && !this.f35344x0) {
                ...
                org.telegram.ui.Components.rr rrVar2 = org.telegram.ui.Components.rr.f27701f;
                ...
                this.f35323j0.animate().alpha(1.0f).translationY(0.0f).setDuration(150L).setInterpolator(rrVar2).start();
                this.f35319h0.animate().alpha(1.0f).setDuration(150L).setInterpolator(rrVar2).start();
                this.f35321i0.animate().alpha(1.0f).setDuration(150L).setInterpolator(rrVar2).start();
                ValueAnimator ofFloat2 = ValueAnimator.ofFloat(this.f35346y0, 1.0f);
                this.P0 = ofFloat2;
                ofFloat2.addUpdateListener(s11Var);
                this.P0.setDuration(150L).setInterpolator(rrVar2);
                this.P0.start();
                this.f35323j0.setEnabled(true);
            }
            i10 = 0;
        }
        this.f35344x0 = z10;
        ei1 ei1Var = this.f35339u0;
        if (!z10) {
        ...
        animate.translationY(i12 - i11).setDuration(150L).setStartDelay(i10).setInterpolator(org.telegram.ui.Components.rr.f27701f).start();
    }
    ...
    public final void B() {
        if (VoIPService.getSharedInstance() != null) {
            ...
            this.R0 = false;
            if (this.f35347z0 && this.f35344x0) {
    ...
    public final void C() {
        ...
        VoIPService sharedInstance = VoIPService.getSharedInstance();
        if (sharedInstance != null) {
            if (this.f35342w0.isTouchExplorationEnabled()) {
                if (!this.f35330n0) {
                ...
                this.f35336s.announceForAccessibility(string);
            }
            if (!this.f35330n0) {
                if (this.f35331o0 == null) {
                    sharedInstance.createCaptureDevice(false);
                    if (!sharedInstance.isFrontFaceCamera()) {
                        sharedInstance.switchCamera();
                    }
                    this.f35339u0.setLockOnScreen(true);
                    int[] iArr = new int[2];
                    this.f35314f.getLocationOnScreen(iArr);
                    fi1 fi1Var = new fi1(this, this.f35336s.getContext(), iArr[0], iArr[1]);
                    this.f35331o0 = fi1Var;
                    WindowInsets windowInsets = this.f35335r0;
                    if (windowInsets != null) {
                        fi1Var.setBottomPadding(windowInsets.getSystemWindowInsetBottom());
                    }
                    this.f35336s.addView(this.f35331o0);
                    return;
                }
                return;
            }
    ...
    public final void D(boolean z10) {
        ...
        if (sharedInstance != null) {
            if (z10) {
                ...
                TransitionManager.beginDelayedTransition(this.f35323j0, transitionSet);
            }
            int i10 = this.f35332p0;
            if (i10 == 11) {
                this.e.setVisibility(8);
                this.f35314f.setVisibility(8);
                this.h.setVisibility(8);
                this.f35329n.setVisibility(8);
                return;
            }
            int i11 = 0;
            if (i10 != 15 && i10 != 17) {
                ...
                if (!sharedInstance.isScreencast() && (this.f35330n0 || this.m0)) {
                ...
                v(this.f35314f, sharedInstance, false);
                t(this.h, sharedInstance, z10);
                this.f35329n.c(R.drawable.calls_decline, -1, -1041108, 1.0f, true, LocaleController.getString(R.string.VoipEndCall2), false, z10);
                this.f35329n.setOnClickListener(new xh1(this, 0));
            } else {
                TL_phone.PhoneCall phoneCall = sharedInstance.privateCall;
            ...
            if (this.f35314f.getVisibility() == 0) {
                this.f35314f.f29012f = i11;
                i11 += 16;
            }
            ...
            if (this.f35329n.getVisibility() == 0) {
                this.f35329n.F = i11;
            }
            F();
        }
    ...
    public final void G() {
        this.f35325k0.setColor(i0.a.k(-16777216, (int) (this.f35346y0 * 102.0f * this.F0)));
        this.f35327l0.setColor(i0.a.k(-16777216, (int) (127.5f * this.F0)));
        hi1 hi1Var = this.f35336s;
        if (hi1Var != null) {
            hi1Var.invalidate();
        }
    }
    ...
    public final void a(com.google.android.gms.internal.cast.p pVar) {
        this.l1 = pVar;
        org.telegram.ui.Components.voip.s2 s2Var = this.f35308c0;
        if (s2Var != null) {
            s2Var.d.clearFirstFrame();
        }
        this.f35328m1 = true;
        H();
        ((WindowManager) this.f35304b.getSystemService("window")).removeView(this.f35339u0);
        this.f35339u0.invalidate();
    }
    ...
    public final void b(com.google.android.gms.internal.cast.p pVar) {
        ...
        ei1 ei1Var = this.f35339u0;
        ei1Var.getClass();
        ((WindowManager) this.f35304b.getSystemService("window")).addView(ei1Var, org.telegram.ui.Components.voip.w2.a());
        this.f35328m1 = false;
        H();
        this.f35339u0.invalidate();
        org.telegram.ui.Components.voip.s2 s2Var = this.f35326k1;
        if (s2Var != null) {
            s2Var.d.release();
            this.f35326k1 = null;
        }
    ...
    public final Bitmap c() {
        ...
        if (s2Var != null && s2Var.d.isAvailable()) {
            return this.f35326k1.d.getBitmap();
        }
        return null;
    }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.voipServiceCreated) {
            if (this.f35332p0 == 17 && VoIPService.getSharedInstance() != null) {
                this.f35310d0.d.release();
                this.f35308c0.d.release();
                this.f35305b0.release();
                o();
                VoIPService.getSharedInstance().registerStateListener(this);
            }
            ...
            this.f35345y.setAmplitude(((Float) objArr[0]).floatValue() * 15.0f);
        } else if (i10 == NotificationCenter.nearEarEvent) {
            boolean booleanValue = ((Boolean) objArr[0]).booleanValue();
            this.f35315f0 = booleanValue;
            if (booleanValue) {
                this.f35345y.b(true, true);
            }
        }
    }
    ...
    public final Bitmap e() {
        org.telegram.ui.Components.voip.s2 s2Var = this.f35308c0;
        if (s2Var != null && s2Var.d.isAvailable()) {
            return this.f35308c0.d.getBitmap();
        }
        return null;
    }
    ...
    @Override
    public final View h() {
        org.telegram.ui.Components.voip.s2 s2Var = new org.telegram.ui.Components.voip.s2(this.f35304b, false, true, false, false);
        this.f35326k1 = s2Var;
        s2Var.d.setScalingType(RendererCommon.ScalingType.SCALE_ASPECT_FIT);
        this.f35326k1.d.setEnableHardwareScaler(true);
        this.f35326k1.d.setRotateTextureWithScreen(true);
        org.telegram.ui.Components.voip.s2 s2Var2 = this.f35326k1;
        s2Var2.f29175a0 = 1;
        s2Var2.d.init(VideoCapturerDevice.getEglBase().getEglBaseContext(), new gi1(this));
        View view = this.f35326k1.h;
        if (view != null) {
            view.setVisibility(8);
        }
        return this.f35326k1;
    }
    ...
    public final ValueAnimator k(boolean z10) {
        ...
        float f17 = org.telegram.ui.Components.voip.m2.k().d.x + org.telegram.ui.Components.voip.m2.k().f29071y;
        ...
        org.telegram.ui.Components.voip.m2.U.getClass();
        final float measuredWidth = f17 - ((this.f35308c0.getMeasuredWidth() - (this.f35308c0.getMeasuredWidth() * 0.25f)) / 2.0f);
        final float measuredHeight2 = f18 - ((this.f35308c0.getMeasuredHeight() - (this.f35308c0.getMeasuredHeight() * 0.25f)) / 2.0f);
        final float f19 = 1.0f;
        if (this.m0) {
            int measuredWidth2 = this.Y.getMeasuredWidth();
            if (this.f35330n0 && measuredWidth2 != 0) {
                f16 = (this.f35339u0.getMeasuredWidth() / measuredWidth2) * 0.25f * 0.4f;
                c10 = 0;
                f15 = (((org.telegram.ui.Components.voip.m2.k().f29065f * 0.25f) + (f17 - ((this.Y.getMeasuredWidth() - (this.Y.getMeasuredWidth() * f16)) / 2.0f))) - ((org.telegram.ui.Components.voip.m2.k().f29065f * 0.25f) * 0.4f)) - AndroidUtilities.dp(4.0f);
        ...
        if (z10) {
            ...
            this.f35308c0.setScaleX(0.25f);
            this.f35308c0.setScaleY(0.25f);
            this.f35308c0.setTranslationX(measuredWidth);
            this.f35308c0.setTranslationY(measuredHeight2);
            this.f35308c0.setRoundCorners((AndroidUtilities.dp(6.0f) * 1.0f) / 0.25f);
        }
        if (z10) {
            f12 = 1.0f;
        } else {
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                ...
                mi1Var.f35308c0.setScaleX(f25);
                mi1Var.f35308c0.setScaleY(f25);
                float f26 = 0.0f * f23;
                float f27 = (measuredWidth * floatValue) + f26;
                float f28 = (measuredHeight2 * floatValue) + f26;
                mi1Var.f35308c0.setTranslationX(f27);
                mi1Var.f35308c0.setTranslationY(f28);
                mi1Var.f35308c0.setRoundCorners(((AndroidUtilities.dp(4.0f) * floatValue) * 1.0f) / f25);
                if (!mi1Var.Y.P) {
                    mi1Var.f35310d0.d(floatValue, false);
                }
                mi1Var.f35339u0.invalidate();
            }
        });
        return ofFloat;
    }
    ...
    public final void l() {
        ...
        NotificationCenter.getInstance(this.f35301a).removeObserver(this, NotificationCenter.voipServiceCreated);
    ...
    public final void m(boolean z10) {
        ...
        if (this.B0 && this.C0 != z10 && this.f35344x0) {
            this.C0 = z10;
            org.telegram.ui.Components.voip.z2 z2Var = this.f35341w;
            if (z2Var.K && z10 != z2Var.E) {
                ...
                z2Var.f29353c = ofFloat;
                ofFloat.addUpdateListener(new org.telegram.ui.Components.voip.y2(z2Var, 1));
                z2Var.f29353c.setInterpolator(org.telegram.ui.Components.rr.f27701f);
                z2Var.f29353c.setDuration(200L);
                z2Var.f29353c.start();
            }
            if (z10) {
                ...
                AndroidUtilities.cancelRunOnUIThread(this.S0);
                this.R0 = false;
                if (this.f35345y.getVisibility() == 0) {
                    this.f35345y.animate().setStartDelay(0L).translationY(AndroidUtilities.dp(48.0f)).scaleY(0.1f).scaleX(0.1f).alpha(0.0f).setDuration(200L).setInterpolator(org.telegram.ui.Components.rr.f27701f).start();
                }
                ...
                this.O.animate().alpha(1.0f).scaleY(1.0f).scaleX(1.0f).setDuration(340L).setInterpolator(org.telegram.ui.Components.rr.f27702g).start();
                ...
                if (this.f35345y.getVisibility() == 0) {
                    this.f35345y.animate().setStartDelay(50L).translationY(0.0f).scaleX(1.0f).scaleY(1.0f).alpha(1.0f).setDuration(250L).setInterpolator(org.telegram.ui.Components.rr.f27701f).start();
                }
                this.O.animate().setListener(null).cancel();
    ...
    public final void o() {
        this.f35310d0.d.init(VideoCapturerDevice.getEglBase().getEglBaseContext(), new bi1(this));
        this.f35308c0.d.init(VideoCapturerDevice.getEglBase().getEglBaseContext(), new ci1(this), EglBase.CONFIG_PLAIN, new GlRectDrawer());
        this.f35305b0.init(VideoCapturerDevice.getEglBase().getEglBaseContext(), null);
    }
    ...
    public final void onMediaStateUpdated(int i10, int i11) {
        ...
        if (sharedInstance != null && sharedInstance.getRemoteVideoState() == 2) {
            if (this.f35317g0 == null && sf.c.a(this.f35304b) == 1) {
                pf.d dVar = new pf.d(this.f35304b, f35300n1);
                dVar.f40736c = "voip-fragment-pip";
                org.telegram.ui.Components.voip.s2 s2Var = this.f35308c0;
                dVar.f40740j = s2Var.d;
                dVar.f40741k = s2Var.getPlaceholderView();
                this.f35317g0 = dVar.a();
            }
        } else {
            pf.e eVar = this.f35317g0;
            if (eVar != null) {
    ...
    public final void onStateChanged(int i10) {
        int i11 = this.f35332p0;
        if (i11 != i10) {
            this.f35333q0 = i11;
            this.f35332p0 = i10;
            if (this.f35339u0 != null) {
                H();
            }
        }
    }
    ...
    public final void p() {
        if (!this.G0 && !this.E0) {
            fi1 fi1Var = this.f35331o0;
            if (fi1Var != null) {
                fi1Var.a(false, false);
            } else if (this.m0 && this.f35330n0 && this.H0) {
                this.H0 = false;
                ...
                if (this.D0 && VoIPService.getSharedInstance() != null && !VoIPService.getSharedInstance().isConverting()) {
                    if (sf.c.a(this.f35304b) > 0) {
                        if (!this.G0 && f35300n1 != null) {
                            this.G0 = true;
                            if (VoIPService.getSharedInstance() != null) {
                                int measuredHeight = f35300n1.f35339u0.getMeasuredHeight();
                                mi1 mi1Var = f35300n1;
                                org.telegram.ui.Components.voip.m2.l(mi1Var.f35304b, mi1Var.f35301a, mi1Var.f35339u0.getMeasuredWidth(), measuredHeight, 1);
                                WindowInsets windowInsets = f35300n1.f35335r0;
                                if (windowInsets != null) {
                                    org.telegram.ui.Components.voip.m2.W = windowInsets.getSystemWindowInsetTop();
                                    f35300n1.f35335r0.getSystemWindowInsetBottom();
                                }
                            }
                            if (org.telegram.ui.Components.voip.m2.k() != null) {
                                ...
                                this.f35323j0.animate().alpha(0.0f).setDuration(350L).setInterpolator(rrVar).start();
                                this.f35319h0.animate().alpha(0.0f).setDuration(350L).setInterpolator(rrVar).start();
                                this.f35321i0.animate().alpha(0.0f).setDuration(350L).setInterpolator(rrVar).start();
                    ...
                    org.telegram.ui.Components.e5.B(this.f35304b, new uh1(this, 0), true).o();
                    return;
                }
                this.f35339u0.b();
            }
    ...
    public final void r(Runnable runnable) {
        if (this.f35314f.getVisibility() == 0) {
            this.f35312e0.getLocationOnScreen(new int[2]);
            org.telegram.ui.Components.voip.e eVar = this.f35312e0;
            ValueAnimator valueAnimator = eVar.f28894b0;
            if (valueAnimator != null) {
                valueAnimator.cancel();
                eVar.f28894b0 = null;
                eVar.U.stop();
        ...
        this.f35329n.animate().cancel();
        this.e.animate().cancel();
        this.h.animate().cancel();
        this.f35314f.animate().cancel();
        this.f35312e0.getLocationOnScreen(new int[2]);
        org.telegram.ui.Components.voip.e eVar2 = this.f35312e0;
        ValueAnimator valueAnimator2 = eVar2.f28894b0;
        if (valueAnimator2 != null) {
            valueAnimator2.cancel();
            eVar2.f28894b0 = null;
            eVar2.U.stop();
        }
        this.f35329n.c(R.drawable.calls_decline, -1, -1041108, 1.0f, true, LocaleController.getString(R.string.VoipEndCall2), false, false);
        this.e.d(5, false, false);
        this.h.d(1, false, false);
        this.f35314f.d(3, true, false);
        this.f35329n.setVisibility(0);
        this.e.setVisibility(0);
        this.h.setVisibility(0);
        this.f35314f.setVisibility(0);
        this.f35329n.setAlpha(0.0f);
        this.e.setAlpha(0.0f);
        this.h.setAlpha(0.0f);
        this.f35314f.setAlpha(0.0f);
        final ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) this.f35312e0.getLayoutParams();
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator3) {
                ...
                mi1Var.f35312e0.setTranslationY(dp2 * floatValue);
                int i10 = marginEnd;
                int i11 = (int) (i10 - ((i10 + dp) * floatValue));
                ViewGroup.MarginLayoutParams marginLayoutParams2 = marginLayoutParams;
                marginLayoutParams2.leftMargin = i11;
                marginLayoutParams2.rightMargin = i11;
                mi1Var.f35312e0.requestLayout();
            }
        });
        org.telegram.ui.Components.voip.e eVar3 = this.f35312e0;
        ObjectAnimator ofFloat2 = ObjectAnimator.ofFloat(eVar3, View.SCALE_X, eVar3.getScaleX(), 1.0f, 1.0f, 1.0f);
        org.telegram.ui.Components.voip.e eVar4 = this.f35312e0;
        ObjectAnimator ofFloat3 = ObjectAnimator.ofFloat(eVar4, View.SCALE_Y, eVar4.getScaleY(), 1.0f, 1.0f, 1.0f);
        org.telegram.ui.Components.voip.e eVar5 = this.f35312e0;
        animatorSet.playTogether(ofFloat, ofFloat2, ofFloat3, ObjectAnimator.ofFloat(eVar5, View.ALPHA, eVar5.getAlpha(), this.f35312e0.getAlpha(), 0.0f, 0.0f));
    ...
    public final void t(org.telegram.ui.Components.voip.k3 k3Var, VoIPService voIPService, boolean z10) {
        ...
        float f7 = 0.0f;
        if (!z10) {
            ValueAnimator valueAnimator = u1Var.f29258f0;
            if (valueAnimator != null) {
                valueAnimator.cancel();
            }
            if (isMicMute) {
            ...
            ValueAnimator valueAnimator2 = u1Var.f29258f0;
            if (valueAnimator2 != null) {
                valueAnimator2.cancel();
            }
            float f10 = u1Var.K;
            ...
            u1Var.f29258f0 = ofFloat;
            ofFloat.addUpdateListener(u1Var.f29259g0);
            u1Var.f29258f0.setDuration(150L);
            u1Var.f29258f0.start();
        }
    ...
    public final void x(boolean z10, boolean z11) {
        ...
        Integer num = null;
        if (z10) {
            if (z12 && this.f35345y.getTag() == null) {
                this.f35345y.animate().setListener(null).cancel();
                this.f35345y.setVisibility(0);
                if (!this.C0) {
                    if (z11) {
                        this.f35345y.setAlpha(0.0f);
                        this.f35345y.animate().alpha(1.0f).translationY(0.0f).scaleY(1.0f).scaleX(1.0f).setDuration(150L).setInterpolator(org.telegram.ui.Components.rr.f27701f).start();
                    } else {
                        this.f35345y.setAlpha(0.0f);
                        this.f35345y.setTranslationY(-AndroidUtilities.dp(135.0f));
                        this.f35345y.animate().alpha(1.0f).translationY(0.0f).scaleY(1.0f).scaleX(1.0f).setDuration(150L).setInterpolator(org.telegram.ui.Components.rr.f27701f).start();
                    }
                } else if (z11) {
                    this.f35345y.setAlpha(0.0f);
                    this.f35345y.setTranslationY(AndroidUtilities.dp(48.0f));
                    this.f35345y.setScaleX(0.1f);
                    this.f35345y.setScaleY(0.1f);
                }
            } else if (!z12 && this.f35345y.getTag() != null) {
                this.f35345y.animate().setListener(null).cancel();
                this.f35345y.setTranslationY(0.0f);
                this.f35345y.animate().alpha(0.0f).setDuration(150L).scaleX(0.1f).scaleY(0.1f).setInterpolator(org.telegram.ui.Components.rr.f27701f).setListener(new ai1(this, 7)).start();
            }
        } else {
            this.f35345y.animate().setListener(null).cancel();
            this.f35345y.setTranslationY(0.0f);
            this.f35345y.setAlpha(1.0f);
            this.f35345y.setScaleX(1.0f);
            this.f35345y.setScaleY(1.0f);
            org.telegram.ui.Components.voip.t0 t0Var = this.f35345y;
            if (!z12) {
                i10 = 8;
            }
            t0Var.setVisibility(i10);
        }
        org.telegram.ui.Components.voip.t0 t0Var2 = this.f35345y;
        if (z12) {
            num = 1;
        }
        t0Var2.setTag(num);
    ...
    public final void y(CharSequence charSequence) {
        TextView textView;
        if (this.f35304b.isFinishing()) {
            return;
        }
        org.telegram.ui.ActionBar.b2 b2Var = new org.telegram.ui.ActionBar.b2(this.f35304b, 0, null);
        boolean[] zArr = new boolean[3];
        b2Var.R = LocaleController.getString(R.string.VoipFailed);
        b2Var.T = charSequence;
        b2Var.f18464l0 = LocaleController.getString(R.string.OK);
        b2Var.m0 = null;
        b2Var.show();
        for (int i10 = 0; i10 < 3; i10++) {
            if (zArr[i10] && (textView = (TextView) b2Var.d(-(i10 + 1))) != null) {
                textView.setTextColor(b2Var.e(org.telegram.ui.ActionBar.h6.f19026q7));
            }
        }
    ...
    public final void z(int i10, boolean z10) {
        ...
        if (this.Y.getTag() == null || ((Integer) this.Y.getTag()).intValue() != 2) {
            this.Y.setUiVisible(this.f35344x0);
        }
        ...
        if (i10 == 0) {
            if (z10) {
                if (this.Y.getTag() != null && ((Integer) this.Y.getTag()).intValue() != 0) {
                    ...
                    this.A0.setDuration(250L).setInterpolator(org.telegram.ui.Components.rr.f27701f);
