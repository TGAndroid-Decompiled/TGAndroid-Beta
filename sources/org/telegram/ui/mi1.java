...
public final class mi1 implements VoIPService.StateListener, NotificationCenter.NotificationCenterDelegate, rf.a {
    ...
    public boolean f35567a0;
    public boolean f35568a1;
    public Activity f35569b;
    public TextureViewRenderer f35570b0;
    public float f35571b1;
    public final TLRPC.User f35572c;
    public org.telegram.ui.Components.voip.t2 f35573c0;
    public float f35574c1;
    public final TLRPC.User d;
    public org.telegram.ui.Components.voip.t2 f35575d0;
    public int f35576d1;
    public org.telegram.ui.Components.voip.l3 e;
    public org.telegram.ui.Components.voip.e f35577e0;
    public int f35578e1;
    public org.telegram.ui.Components.voip.l3 f35579f;
    public boolean f35580f0;
    public pf.e f35582g0;
    public boolean f35583g1;
    public org.telegram.ui.Components.voip.l3 h;
    public View f35584h0;
    public boolean f35585h1;
    public View f35586i0;
    public ValueAnimator f35587i1;
    public org.telegram.ui.Components.voip.s1 f35588j0;
    public boolean f35589j1;
    public org.telegram.ui.Components.voip.t2 f35591k1;
    public com.google.android.gms.internal.cast.p l1;
    public boolean m0;
    public boolean f35593m1;
    public ji1 f35594n;
    public boolean f35595n0;
    public fi1 f35596o0;
    public int f35597p0;
    public int f35598q0;
    public WindowInsets f35600r0;
    public hi1 f35601s;
    public boolean f35602s0;
    public float f35603t0;
    public ei1 f35604u0;
    public org.telegram.ui.Components.voip.d3 v;
    public int f35605v0;
    public org.telegram.ui.Components.voip.a3 f35606w;
    public AccessibilityManager f35607w0;
    public org.telegram.ui.Components.voip.f3 f35608x;
    public org.telegram.ui.Components.voip.t0 f35610y;
    public boolean f35612z0;
    public final org.telegram.ui.Components.voip.r1 f35599r = new org.telegram.ui.Components.voip.r1();
    public final org.telegram.ui.Components.w9[] V = new org.telegram.ui.Components.w9[4];
    public final Drawable[] W = new Drawable[4];
    public final Paint f35590k0 = new Paint();
    public final Paint f35592l0 = new Paint();
    public boolean f35609x0 = true;
    public float f35611y0 = 1.0f;
    ...
    public float f35581f1 = 1.0f;

    public mi1(int i10) {
        this.f35566a = i10;
        this.f35572c = MessagesController.getInstance(i10).getUser(Long.valueOf(UserConfig.getInstance(i10).getClientUserId()));
        ...
        this.f35598q0 = -1;
        this.f35597p0 = sharedState.getCallState();
    ...
    public static void i(mi1 mi1Var) {
        ...
        mi1Var.R0 = false;
        if (Build.VERSION.SDK_INT >= 23 && mi1Var.f35569b.checkSelfPermission("android.permission.CAMERA") != 0) {
            mi1Var.f35569b.requestPermissions(new String[]{"android.permission.CAMERA"}, 102);
        } else {
            mi1Var.C();
        }
    }
    ...
    public static void j(mi1 mi1Var) {
        ...
        if (mi1Var.f35583g1) {
            ...
            mi1Var.f35587i1 = ofFloat;
            mi1Var2 = mi1Var;
            ofFloat.addUpdateListener(new org.telegram.ui.Components.voip.x(mi1Var2, mi1Var.f35581f1, mi1Var.Y0, mi1Var.Z0, 1));
            mi1Var2.f35587i1.addListener(new ai1(mi1Var2, 0));
            mi1Var2.f35587i1.setDuration(350L);
            mi1Var2.f35587i1.setInterpolator(org.telegram.ui.Components.sr.f28339f);
            mi1Var2.f35587i1.start();
        } else {
            mi1Var2 = mi1Var;
        }
        mi1Var2.f35585h1 = false;
        mi1Var2.f35568a1 = false;
    }
        ...
        if (mi1Var != null) {
            if (i10 == 101) {
                if (VoIPService.getSharedState() == null) {
                    ...
                    mi1Var.r(new l21(4));
                } else if (!mi1Var.f35569b.shouldShowRequestPermissionRationale("android.permission.RECORD_AUDIO")) {
                    if (VoIPService.getSharedState() != null) {
                        VoIPService.getSharedState().declineIncomingCall();
                    }
                    org.telegram.ui.Components.voip.g2.h(mi1Var.f35569b, new wh1(mi1Var, 2), i10);
                    return;
                }
            }
            if (i10 == 102) {
    ...
    public static void w(Activity activity, int i10) {
        ...
        float f7;
        mi1 mi1Var = f35565n1;
        if (mi1Var != null && mi1Var.f35604u0.getParent() == null) {
            mi1 mi1Var2 = f35565n1;
            if (mi1Var2 != null) {
                mi1Var2.f35573c0.d.release();
                f35565n1.f35575d0.d.release();
                f35565n1.f35570b0.release();
                ei1 ei1Var = f35565n1.f35604u0;
                if (ei1Var != null) {
                    ei1Var.d();
                }
                f35565n1.l();
        ...
        if (f35565n1 == null && !activity.isFinishing()) {
            ...
            if (VoIPService.getSharedState() != null && VoIPService.getSharedState().getUser() != null) {
                ...
                mi1Var3.f35569b = activity;
                f35565n1 = mi1Var3;
                ei1 ei1Var2 = new ei1(activity, !z10, mi1Var3);
                f35565n1.J0 = ((KeyguardManager) activity.getSystemService("keyguard")).inKeyguardRestrictedInputMode();
                ((PowerManager) activity.getSystemService("power")).isInteractive();
                f35565n1.getClass();
                ei1Var2.setLockOnScreen(f35565n1.J0);
                mi1Var3.f35604u0 = ei1Var2;
                ...
                mi1Var3.f35603t0 = ViewConfiguration.get(activity).getScaledTouchSlop();
                mi1Var3.f35607w0 = (AccessibilityManager) f0.e.f(activity, AccessibilityManager.class);
                ...
                org.telegram.ui.Components.voip.r1 r1Var = mi1Var3.f35599r;
                ...
                mi1Var3.f35573c0 = t2Var;
                RendererCommon.ScalingType scalingType = RendererCommon.ScalingType.SCALE_ASPECT_FIT;
                t2Var.d.setScalingType(scalingType);
                mi1Var3.f35573c0.d.setEnableHardwareScaler(true);
                mi1Var3.f35573c0.d.setRotateTextureWithScreen(true);
                mi1Var3.f35573c0.f29544a0 = 1;
                ...
                if (LiteMode.isEnabled(512)) {
                    ...
                    if ((i13 == 11 && i14 >= 24 && i14 <= 31) || (i13 == 0 && i14 == 1)) {
                        view.f29269a = new org.telegram.ui.Components.mw0(0);
                    }
                }
                mi1Var3.f35608x = view;
                hi1Var.addView((View) view, w7.y5.c(220.0f, -1));
                hi1Var.addView(mi1Var3.f35573c0);
                ...
                mi1Var3.f35570b0 = textureViewRenderer;
                textureViewRenderer.setEnableHardwareScaler(true);
                mi1Var3.f35570b0.setIsCamera(false);
                mi1Var3.f35570b0.setFpsReduction(30.0f);
                mi1Var3.f35570b0.setScalingType(scalingType);
                mi1Var3.Z.addView(mi1Var3.f35570b0, w7.y5.e(-1, -2, 17));
                ...
                mi1Var3.f35610y = new org.telegram.ui.Components.voip.t0(activity);
                org.telegram.ui.Components.h9 h9Var = new org.telegram.ui.Components.h9((org.telegram.ui.ActionBar.d6) null);
                h9Var.r(user);
                org.telegram.ui.Components.voip.t0 t0Var = mi1Var3.f35610y;
                int i16 = mi1Var3.f35566a;
                t0Var.f29537b.h(ImageLocation.getForUserOrChat(i16, user, 0), null, h9Var, user);
                mi1Var3.f35610y.setRoundRadius(AndroidUtilities.dp(135.0f) / 2);
                ...
                frameLayout2.f29490a = new TextView[2];
                int i17 = 0;
                for (int i18 = 2; i17 < i18; i18 = 2) {
                    frameLayout2.f29490a[i17] = new TextView(activity);
                    frameLayout2.f29490a[i17].setTextSize(1, 15.0f);
                    frameLayout2.f29490a[i17].setTextColor(-1);
                    frameLayout2.f29490a[i17].setGravity(1);
                    frameLayout2.addView(frameLayout2.f29490a[i17]);
                    i17++;
                }
                FrameLayout frameLayout3 = new FrameLayout(activity);
                frameLayout2.f29492c = frameLayout3;
                ...
                frameLayout2.f29491b = textView3;
                ...
                if (sharedState != null && sharedState.getUser() != null && sharedState.isConference() && sharedState.getGroupCall() != null) {
                    ...
                    if (groupParticipants == null && i19 <= 0) {
                        ...
                        org.telegram.ui.Components.j9 j9Var = li1Var.f35368b;
                        j9Var.k(min);
                        int i20 = 0;
                        while (i20 < min) {
                        ...
                        if (max == 1 && (groupParticipants == null || groupParticipants.size() == 0 || (groupParticipants.size() == 1 && DialogObject.getPeerDialogId(groupParticipants.get(0).peer) == j10))) {
                            ...
                            li1Var.f35369c = new org.telegram.ui.Components.u01(LocaleController.formatPluralStringComma("Participants", max), 14.0f, AndroidUtilities.bold());
                ...
                hi1Var.addView(mi1Var3.f35610y, w7.y5.d(204, 204.0f, 1, 0.0f, 93.0f, 0.0f, 0.0f));
                ...
                mi1Var3.f35588j0 = new org.telegram.ui.Components.voip.s1(activity);
                mi1Var3.e = new org.telegram.ui.Components.voip.l3(activity, r1Var);
                mi1Var3.f35579f = new org.telegram.ui.Components.voip.l3(activity, r1Var);
                mi1Var3.h = new org.telegram.ui.Components.voip.l3(activity, r1Var);
                mi1Var3.f35594n = new org.telegram.ui.Components.voip.w2(activity, 52.0f);
                ...
                mi1Var3.f35579f.setTranslationY(AndroidUtilities.dp(100.0f));
                mi1Var3.f35579f.setScaleX(0.0f);
                mi1Var3.f35579f.setScaleY(0.0f);
                mi1Var3.f35579f.animate().setStartDelay(166).translationY(0.0f).scaleY(1.0f).scaleX(1.0f).setDuration(250L).start();
                ...
                mi1Var3.f35594n.setTranslationY(AndroidUtilities.dp(100.0f));
                mi1Var3.f35594n.setScaleX(0.0f);
                mi1Var3.f35594n.setScaleY(0.0f);
                mi1Var3.f35594n.animate().setStartDelay(198).translationY(0.0f).scaleY(1.0f).scaleX(1.0f).setDuration(250L).start();
                mi1Var3.f35588j0.addView(mi1Var3.e);
                mi1Var3.f35588j0.addView(mi1Var3.f35579f);
                mi1Var3.f35588j0.addView(mi1Var3.h);
                mi1Var3.f35588j0.addView(mi1Var3.f35594n);
                org.telegram.ui.Components.voip.e eVar = new org.telegram.ui.Components.voip.e(activity);
                mi1Var3.f35577e0 = eVar;
                eVar.setListener(new ki1(mi1Var3));
                mi1Var3.f35577e0.setScaleX(1.15f);
                mi1Var3.f35577e0.setScaleY(1.15f);
                hi1Var.addView(mi1Var3.f35588j0, w7.y5.e(-1, -2, 80));
                ...
                float f10 = i11;
                hi1Var.addView(mi1Var3.f35577e0, w7.y5.d(-1, 186.0f, 80, f10, 0.0f, f10, 0.0f));
                ...
                if (mi1Var3.f35604u0.f29671b) {
                    mi1Var3.H.setVisibility(8);
                    mi1Var3.I.setVisibility(8);
                }
                ?? linearLayout = new LinearLayout(activity);
                linearLayout.f29309a = new HashMap();
                linearLayout.f29310b = new ArrayList();
                linearLayout.f29311c = new ArrayList();
                TextPaint textPaint = new TextPaint();
                linearLayout.f29314r = textPaint;
                linearLayout.setOrientation(1);
                linearLayout.f29313n = r1Var;
                ...
                if (z10) {
                    ...
                    if (sharedInstance2 != null && sharedInstance2.getVideoState(false) == 2) {
                        mi1Var3.f35573c0.setStub(org.telegram.ui.Components.voip.n2.k().f29426r);
                        mi1Var3.f35575d0.setStub(org.telegram.ui.Components.voip.n2.k().f29425n);
                    }
                    mi1Var3.f35604u0.setAlpha(0.0f);
                    mi1Var3.H();
                    mi1Var3.E0 = true;
                ...
                if (sharedInstance3 != null && sharedInstance3.getRemoteVideoState() == 2 && sf.c.a(activity) == 1) {
                    mi1 mi1Var4 = f35565n1;
                    pf.d dVar = new pf.d(activity, mi1Var4);
                    dVar.f41051c = "voip-fragment-pip";
                    org.telegram.ui.Components.voip.t2 t2Var3 = mi1Var4.f35573c0;
                    dVar.f41055j = t2Var3.d;
                    dVar.f41056k = t2Var3.getPlaceholderView();
                    mi1Var4.f35582g0 = dVar.a();
                }
            }
        }
    }
    ...
    public final void A(boolean z10) {
        ...
        if (!z10 && this.f35609x0) {
            ...
            this.f35588j0.animate().alpha(0.0f).translationY(AndroidUtilities.dp(10.0f)).setDuration(150L).setInterpolator(srVar).start();
            this.f35584h0.animate().alpha(0.0f).setDuration(150L).setInterpolator(srVar).start();
            this.f35586i0.animate().alpha(0.0f).setDuration(150L).setInterpolator(srVar).start();
            ValueAnimator ofFloat = ValueAnimator.ofFloat(this.f35611y0, 0.0f);
            this.P0 = ofFloat;
            ...
            this.R0 = false;
            this.f35588j0.setEnabled(false);
            this.O0.e(true);
            i10 = 150;
        } else {
            if (z10 && !this.f35609x0) {
                ...
                org.telegram.ui.Components.sr srVar2 = org.telegram.ui.Components.sr.f28339f;
                ...
                this.f35588j0.animate().alpha(1.0f).translationY(0.0f).setDuration(150L).setInterpolator(srVar2).start();
                this.f35584h0.animate().alpha(1.0f).setDuration(150L).setInterpolator(srVar2).start();
                this.f35586i0.animate().alpha(1.0f).setDuration(150L).setInterpolator(srVar2).start();
                ValueAnimator ofFloat2 = ValueAnimator.ofFloat(this.f35611y0, 1.0f);
                this.P0 = ofFloat2;
                ofFloat2.addUpdateListener(q11Var);
                this.P0.setDuration(150L).setInterpolator(srVar2);
                this.P0.start();
                this.f35588j0.setEnabled(true);
            }
            i10 = 0;
        }
        this.f35609x0 = z10;
        ei1 ei1Var = this.f35604u0;
        if (!z10) {
        ...
        animate.translationY(i12 - i11).setDuration(150L).setStartDelay(i10).setInterpolator(org.telegram.ui.Components.sr.f28339f).start();
    }
    ...
    public final void B() {
        if (VoIPService.getSharedInstance() != null) {
            ...
            this.R0 = false;
            if (this.f35612z0 && this.f35609x0) {
    ...
    public final void C() {
        ...
        VoIPService sharedInstance = VoIPService.getSharedInstance();
        if (sharedInstance != null) {
            if (this.f35607w0.isTouchExplorationEnabled()) {
                if (!this.f35595n0) {
                ...
                this.f35601s.announceForAccessibility(string);
            }
            if (!this.f35595n0) {
                if (this.f35596o0 == null) {
                    sharedInstance.createCaptureDevice(false);
                    if (!sharedInstance.isFrontFaceCamera()) {
                        sharedInstance.switchCamera();
                    }
                    this.f35604u0.setLockOnScreen(true);
                    int[] iArr = new int[2];
                    this.f35579f.getLocationOnScreen(iArr);
                    fi1 fi1Var = new fi1(this, this.f35601s.getContext(), iArr[0], iArr[1]);
                    this.f35596o0 = fi1Var;
                    WindowInsets windowInsets = this.f35600r0;
                    if (windowInsets != null) {
                        fi1Var.setBottomPadding(windowInsets.getSystemWindowInsetBottom());
                    }
                    this.f35601s.addView(this.f35596o0);
                    return;
                }
                return;
            }
    ...
    public final void D(boolean z10) {
        ...
        if (sharedInstance != null) {
            if (z10) {
                ...
                TransitionManager.beginDelayedTransition(this.f35588j0, transitionSet);
            }
            int i10 = this.f35597p0;
            if (i10 == 11) {
                this.e.setVisibility(8);
                this.f35579f.setVisibility(8);
                this.h.setVisibility(8);
                this.f35594n.setVisibility(8);
                return;
            }
            int i11 = 0;
            if (i10 != 15 && i10 != 17) {
                ...
                if (!sharedInstance.isScreencast() && (this.f35595n0 || this.m0)) {
                ...
                v(this.f35579f, sharedInstance, false);
                t(this.h, sharedInstance, z10);
                this.f35594n.c(R.drawable.calls_decline, -1, -1041108, 1.0f, true, LocaleController.getString(R.string.VoipEndCall2), false, z10);
                this.f35594n.setOnClickListener(new xh1(this, 0));
            } else {
                TL_phone.PhoneCall phoneCall = sharedInstance.privateCall;
            ...
            if (this.f35579f.getVisibility() == 0) {
                this.f35579f.f29373f = i11;
                i11 += 16;
            }
            ...
            if (this.f35594n.getVisibility() == 0) {
                this.f35594n.F = i11;
            }
            F();
        }
    ...
    public final void G() {
        this.f35590k0.setColor(i0.a.k(-16777216, (int) (this.f35611y0 * 102.0f * this.F0)));
        this.f35592l0.setColor(i0.a.k(-16777216, (int) (127.5f * this.F0)));
        hi1 hi1Var = this.f35601s;
        if (hi1Var != null) {
            hi1Var.invalidate();
        }
    }
    ...
    public final void a(com.google.android.gms.internal.cast.p pVar) {
        this.l1 = pVar;
        org.telegram.ui.Components.voip.t2 t2Var = this.f35573c0;
        if (t2Var != null) {
            t2Var.d.clearFirstFrame();
        }
        this.f35593m1 = true;
        H();
        ((WindowManager) this.f35569b.getSystemService("window")).removeView(this.f35604u0);
        this.f35604u0.invalidate();
    }
    ...
    public final void b(com.google.android.gms.internal.cast.p pVar) {
        ...
        ei1 ei1Var = this.f35604u0;
        ei1Var.getClass();
        ((WindowManager) this.f35569b.getSystemService("window")).addView(ei1Var, org.telegram.ui.Components.voip.x2.a());
        this.f35593m1 = false;
        H();
        this.f35604u0.invalidate();
        org.telegram.ui.Components.voip.t2 t2Var = this.f35591k1;
        if (t2Var != null) {
            t2Var.d.release();
            this.f35591k1 = null;
        }
    ...
    public final Bitmap c() {
        ...
        if (t2Var != null && t2Var.d.isAvailable()) {
            return this.f35591k1.d.getBitmap();
        }
        return null;
    }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.voipServiceCreated) {
            if (this.f35597p0 == 17 && VoIPService.getSharedInstance() != null) {
                this.f35575d0.d.release();
                this.f35573c0.d.release();
                this.f35570b0.release();
                o();
                VoIPService.getSharedInstance().registerStateListener(this);
            }
            ...
            this.f35610y.setAmplitude(((Float) objArr[0]).floatValue() * 15.0f);
        } else if (i10 == NotificationCenter.nearEarEvent) {
            boolean booleanValue = ((Boolean) objArr[0]).booleanValue();
            this.f35580f0 = booleanValue;
            if (booleanValue) {
                this.f35610y.b(true, true);
            }
        }
    }
    ...
    public final Bitmap e() {
        org.telegram.ui.Components.voip.t2 t2Var = this.f35573c0;
        if (t2Var != null && t2Var.d.isAvailable()) {
            return this.f35573c0.d.getBitmap();
        }
        return null;
    }
    ...
    @Override
    public final View h() {
        org.telegram.ui.Components.voip.t2 t2Var = new org.telegram.ui.Components.voip.t2(this.f35569b, false, true, false, false);
        this.f35591k1 = t2Var;
        t2Var.d.setScalingType(RendererCommon.ScalingType.SCALE_ASPECT_FIT);
        this.f35591k1.d.setEnableHardwareScaler(true);
        this.f35591k1.d.setRotateTextureWithScreen(true);
        org.telegram.ui.Components.voip.t2 t2Var2 = this.f35591k1;
        t2Var2.f29544a0 = 1;
        t2Var2.d.init(VideoCapturerDevice.getEglBase().getEglBaseContext(), new gi1(this));
        View view = this.f35591k1.h;
        if (view != null) {
            view.setVisibility(8);
        }
        return this.f35591k1;
    }
    ...
    public final ValueAnimator k(boolean z10) {
        ...
        float f17 = org.telegram.ui.Components.voip.n2.k().d.x + org.telegram.ui.Components.voip.n2.k().f29430y;
        ...
        org.telegram.ui.Components.voip.n2.U.getClass();
        final float measuredWidth = f17 - ((this.f35573c0.getMeasuredWidth() - (this.f35573c0.getMeasuredWidth() * 0.25f)) / 2.0f);
        final float measuredHeight2 = f18 - ((this.f35573c0.getMeasuredHeight() - (this.f35573c0.getMeasuredHeight() * 0.25f)) / 2.0f);
        final float f19 = 1.0f;
        if (this.m0) {
            int measuredWidth2 = this.Y.getMeasuredWidth();
            if (this.f35595n0 && measuredWidth2 != 0) {
                f16 = (this.f35604u0.getMeasuredWidth() / measuredWidth2) * 0.25f * 0.4f;
                c10 = 0;
                f15 = (((org.telegram.ui.Components.voip.n2.k().f29424f * 0.25f) + (f17 - ((this.Y.getMeasuredWidth() - (this.Y.getMeasuredWidth() * f16)) / 2.0f))) - ((org.telegram.ui.Components.voip.n2.k().f29424f * 0.25f) * 0.4f)) - AndroidUtilities.dp(4.0f);
        ...
        if (z10) {
            ...
            this.f35573c0.setScaleX(0.25f);
            this.f35573c0.setScaleY(0.25f);
            this.f35573c0.setTranslationX(measuredWidth);
            this.f35573c0.setTranslationY(measuredHeight2);
            this.f35573c0.setRoundCorners((AndroidUtilities.dp(6.0f) * 1.0f) / 0.25f);
        }
        if (z10) {
            f12 = 1.0f;
        } else {
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                ...
                mi1Var.f35573c0.setScaleX(f25);
                mi1Var.f35573c0.setScaleY(f25);
                float f26 = 0.0f * f23;
                float f27 = (measuredWidth * floatValue) + f26;
                float f28 = (measuredHeight2 * floatValue) + f26;
                mi1Var.f35573c0.setTranslationX(f27);
                mi1Var.f35573c0.setTranslationY(f28);
                mi1Var.f35573c0.setRoundCorners(((AndroidUtilities.dp(4.0f) * floatValue) * 1.0f) / f25);
                if (!mi1Var.Y.P) {
                    mi1Var.f35575d0.d(floatValue, false);
                }
                mi1Var.f35604u0.invalidate();
            }
        });
        return ofFloat;
    }
    ...
    public final void l() {
        ...
        NotificationCenter.getInstance(this.f35566a).removeObserver(this, NotificationCenter.voipServiceCreated);
    ...
    public final void m(boolean z10) {
        ...
        if (this.B0 && this.C0 != z10 && this.f35609x0) {
            this.C0 = z10;
            org.telegram.ui.Components.voip.a3 a3Var = this.f35606w;
            if (a3Var.K && z10 != a3Var.E) {
                ...
                a3Var.f29188c = ofFloat;
                ofFloat.addUpdateListener(new org.telegram.ui.Components.voip.z2(a3Var, 1));
                a3Var.f29188c.setInterpolator(org.telegram.ui.Components.sr.f28339f);
                a3Var.f29188c.setDuration(200L);
                a3Var.f29188c.start();
            }
            if (z10) {
                ...
                AndroidUtilities.cancelRunOnUIThread(this.S0);
                this.R0 = false;
                if (this.f35610y.getVisibility() == 0) {
                    this.f35610y.animate().setStartDelay(0L).translationY(AndroidUtilities.dp(48.0f)).scaleY(0.1f).scaleX(0.1f).alpha(0.0f).setDuration(200L).setInterpolator(org.telegram.ui.Components.sr.f28339f).start();
                }
                ...
                this.O.animate().alpha(1.0f).scaleY(1.0f).scaleX(1.0f).setDuration(340L).setInterpolator(org.telegram.ui.Components.sr.f28340g).start();
                ...
                if (this.f35610y.getVisibility() == 0) {
                    this.f35610y.animate().setStartDelay(50L).translationY(0.0f).scaleX(1.0f).scaleY(1.0f).alpha(1.0f).setDuration(250L).setInterpolator(org.telegram.ui.Components.sr.f28339f).start();
                }
                this.O.animate().setListener(null).cancel();
    ...
    public final void o() {
        this.f35575d0.d.init(VideoCapturerDevice.getEglBase().getEglBaseContext(), new bi1(this));
        this.f35573c0.d.init(VideoCapturerDevice.getEglBase().getEglBaseContext(), new ci1(this), EglBase.CONFIG_PLAIN, new GlRectDrawer());
        this.f35570b0.init(VideoCapturerDevice.getEglBase().getEglBaseContext(), null);
    }
    ...
    public final void onMediaStateUpdated(int i10, int i11) {
        ...
        if (sharedInstance != null && sharedInstance.getRemoteVideoState() == 2) {
            if (this.f35582g0 == null && sf.c.a(this.f35569b) == 1) {
                pf.d dVar = new pf.d(this.f35569b, f35565n1);
                dVar.f41051c = "voip-fragment-pip";
                org.telegram.ui.Components.voip.t2 t2Var = this.f35573c0;
                dVar.f41055j = t2Var.d;
                dVar.f41056k = t2Var.getPlaceholderView();
                this.f35582g0 = dVar.a();
            }
        } else {
            pf.e eVar = this.f35582g0;
            if (eVar != null) {
    ...
    public final void onStateChanged(int i10) {
        int i11 = this.f35597p0;
        if (i11 != i10) {
            this.f35598q0 = i11;
            this.f35597p0 = i10;
            if (this.f35604u0 != null) {
                H();
            }
        }
    }
    ...
    public final void p() {
        if (!this.G0 && !this.E0) {
            fi1 fi1Var = this.f35596o0;
            if (fi1Var != null) {
                fi1Var.a(false, false);
            } else if (this.m0 && this.f35595n0 && this.H0) {
                this.H0 = false;
                ...
                if (this.D0 && VoIPService.getSharedInstance() != null && !VoIPService.getSharedInstance().isConverting()) {
                    if (sf.c.a(this.f35569b) > 0) {
                        if (!this.G0 && f35565n1 != null) {
                            this.G0 = true;
                            if (VoIPService.getSharedInstance() != null) {
                                int measuredHeight = f35565n1.f35604u0.getMeasuredHeight();
                                mi1 mi1Var = f35565n1;
                                org.telegram.ui.Components.voip.n2.l(mi1Var.f35569b, mi1Var.f35566a, mi1Var.f35604u0.getMeasuredWidth(), measuredHeight, 1);
                                WindowInsets windowInsets = f35565n1.f35600r0;
                                if (windowInsets != null) {
                                    org.telegram.ui.Components.voip.n2.W = windowInsets.getSystemWindowInsetTop();
                                    f35565n1.f35600r0.getSystemWindowInsetBottom();
                                }
                            }
                            if (org.telegram.ui.Components.voip.n2.k() != null) {
                                ...
                                this.f35588j0.animate().alpha(0.0f).setDuration(350L).setInterpolator(srVar).start();
                                this.f35584h0.animate().alpha(0.0f).setDuration(350L).setInterpolator(srVar).start();
                                this.f35586i0.animate().alpha(0.0f).setDuration(350L).setInterpolator(srVar).start();
                    ...
                    org.telegram.ui.Components.e5.B(this.f35569b, new uh1(this, 0), true).o();
                    return;
                }
                this.f35604u0.b();
            }
    ...
    public final void r(Runnable runnable) {
        if (this.f35579f.getVisibility() == 0) {
            this.f35577e0.getLocationOnScreen(new int[2]);
            org.telegram.ui.Components.voip.e eVar = this.f35577e0;
            ValueAnimator valueAnimator = eVar.f29243b0;
            if (valueAnimator != null) {
                valueAnimator.cancel();
                eVar.f29243b0 = null;
                eVar.U.stop();
        ...
        this.f35594n.animate().cancel();
        this.e.animate().cancel();
        this.h.animate().cancel();
        this.f35579f.animate().cancel();
        this.f35577e0.getLocationOnScreen(new int[2]);
        org.telegram.ui.Components.voip.e eVar2 = this.f35577e0;
        ValueAnimator valueAnimator2 = eVar2.f29243b0;
        if (valueAnimator2 != null) {
            valueAnimator2.cancel();
            eVar2.f29243b0 = null;
            eVar2.U.stop();
        }
        this.f35594n.c(R.drawable.calls_decline, -1, -1041108, 1.0f, true, LocaleController.getString(R.string.VoipEndCall2), false, false);
        this.e.d(5, false, false);
        this.h.d(1, false, false);
        this.f35579f.d(3, true, false);
        this.f35594n.setVisibility(0);
        this.e.setVisibility(0);
        this.h.setVisibility(0);
        this.f35579f.setVisibility(0);
        this.f35594n.setAlpha(0.0f);
        this.e.setAlpha(0.0f);
        this.h.setAlpha(0.0f);
        this.f35579f.setAlpha(0.0f);
        final ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) this.f35577e0.getLayoutParams();
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator3) {
                ...
                mi1Var.f35577e0.setTranslationY(dp2 * floatValue);
                int i10 = marginEnd;
                int i11 = (int) (i10 - ((i10 + dp) * floatValue));
                ViewGroup.MarginLayoutParams marginLayoutParams2 = marginLayoutParams;
                marginLayoutParams2.leftMargin = i11;
                marginLayoutParams2.rightMargin = i11;
                mi1Var.f35577e0.requestLayout();
            }
        });
        org.telegram.ui.Components.voip.e eVar3 = this.f35577e0;
        ObjectAnimator ofFloat2 = ObjectAnimator.ofFloat(eVar3, View.SCALE_X, eVar3.getScaleX(), 1.0f, 1.0f, 1.0f);
        org.telegram.ui.Components.voip.e eVar4 = this.f35577e0;
        ObjectAnimator ofFloat3 = ObjectAnimator.ofFloat(eVar4, View.SCALE_Y, eVar4.getScaleY(), 1.0f, 1.0f, 1.0f);
        org.telegram.ui.Components.voip.e eVar5 = this.f35577e0;
        animatorSet.playTogether(ofFloat, ofFloat2, ofFloat3, ObjectAnimator.ofFloat(eVar5, View.ALPHA, eVar5.getAlpha(), this.f35577e0.getAlpha(), 0.0f, 0.0f));
        animatorSet.setDuration(400L);
        animatorSet.setInterpolator(new LinearInterpolator());
        animatorSet.addListener(new org.telegram.ui.Components.bl0(17, this, runnable));
        animatorSet.start();
    ...
    public final void t(org.telegram.ui.Components.voip.l3 l3Var, VoIPService voIPService, boolean z10) {
        ...
        float f7 = 0.0f;
        if (!z10) {
            ValueAnimator valueAnimator = v1Var.f29615f0;
            if (valueAnimator != null) {
                valueAnimator.cancel();
            }
            if (isMicMute) {
            ...
            ValueAnimator valueAnimator2 = v1Var.f29615f0;
            if (valueAnimator2 != null) {
                valueAnimator2.cancel();
            }
            float f10 = v1Var.K;
            ...
            v1Var.f29615f0 = ofFloat;
            ofFloat.addUpdateListener(v1Var.f29616g0);
            v1Var.f29615f0.setDuration(150L);
            v1Var.f29615f0.start();
        }
    ...
    public final void x(boolean z10, boolean z11) {
        ...
        Integer num = null;
        if (z10) {
            if (z12 && this.f35610y.getTag() == null) {
                this.f35610y.animate().setListener(null).cancel();
                this.f35610y.setVisibility(0);
                if (!this.C0) {
                    if (z11) {
                        this.f35610y.setAlpha(0.0f);
                        this.f35610y.animate().alpha(1.0f).translationY(0.0f).scaleY(1.0f).scaleX(1.0f).setDuration(150L).setInterpolator(org.telegram.ui.Components.sr.f28339f).start();
                    } else {
                        this.f35610y.setAlpha(0.0f);
                        this.f35610y.setTranslationY(-AndroidUtilities.dp(135.0f));
                        this.f35610y.animate().alpha(1.0f).translationY(0.0f).scaleY(1.0f).scaleX(1.0f).setDuration(150L).setInterpolator(org.telegram.ui.Components.sr.f28339f).start();
                    }
                } else if (z11) {
                    this.f35610y.setAlpha(0.0f);
                    this.f35610y.setTranslationY(AndroidUtilities.dp(48.0f));
                    this.f35610y.setScaleX(0.1f);
                    this.f35610y.setScaleY(0.1f);
                }
            } else if (!z12 && this.f35610y.getTag() != null) {
                this.f35610y.animate().setListener(null).cancel();
                this.f35610y.setTranslationY(0.0f);
                this.f35610y.animate().alpha(0.0f).setDuration(150L).scaleX(0.1f).scaleY(0.1f).setInterpolator(org.telegram.ui.Components.sr.f28339f).setListener(new ai1(this, 7)).start();
            }
        } else {
            this.f35610y.animate().setListener(null).cancel();
            this.f35610y.setTranslationY(0.0f);
            this.f35610y.setAlpha(1.0f);
            this.f35610y.setScaleX(1.0f);
            this.f35610y.setScaleY(1.0f);
            org.telegram.ui.Components.voip.t0 t0Var = this.f35610y;
            if (!z12) {
                i10 = 8;
            }
            t0Var.setVisibility(i10);
        }
        org.telegram.ui.Components.voip.t0 t0Var2 = this.f35610y;
        if (z12) {
            num = 1;
        }
        t0Var2.setTag(num);
    ...
    public final void y(CharSequence charSequence) {
        TextView textView;
        if (this.f35569b.isFinishing()) {
            return;
        }
        org.telegram.ui.ActionBar.a2 a2Var = new org.telegram.ui.ActionBar.a2(this.f35569b, 0, null);
    ...
    public final void z(int i10, boolean z10) {
        ...
        if (this.Y.getTag() == null || ((Integer) this.Y.getTag()).intValue() != 2) {
            this.Y.setUiVisible(this.f35609x0);
        }
        ...
        if (i10 == 0) {
            if (z10) {
                if (this.Y.getTag() != null && ((Integer) this.Y.getTag()).intValue() != 0) {
                    ...
                    this.A0.setDuration(250L).setInterpolator(org.telegram.ui.Components.sr.f28339f);
