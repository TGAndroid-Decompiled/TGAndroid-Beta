...
public final class zt0 extends eg.a3 {
    public final Path f44024l0;
    public boolean m0;
    public final org.telegram.ui.Components.z5 f44025n0;
    public final PhotoViewer f44026o0;

    public zt0(PhotoViewer photoViewer) {
        super(photoViewer.f34333m5, photoViewer.B, photoViewer.f34387s2, photoViewer.Y);
        this.f44026o0 = photoViewer;
        this.f44024l0 = new Path();
        this.f44025n0 = new org.telegram.ui.Components.z5(this, 0L, 420L, org.telegram.ui.Components.pr.h);
    }

    public final void m(boolean z4, boolean z10) {
        this.m0 = z4;
        if (!z10) {
            this.f44025n0.f(z4, true);
        }
        invalidate();
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        PhotoViewer photoViewer = this.f44026o0;
        ...
        float e6 = this.f44025n0.e(this.m0);
        if (e6 > 0.0f) {
