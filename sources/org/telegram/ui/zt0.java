...
public final class zt0 implements ViewTreeObserver.OnPreDrawListener {
    public final tu0 f40575a;
    public final Integer f40576b;
    public final PhotoViewer f40577c;

    public zt0(PhotoViewer photoViewer, tu0 tu0Var, Integer num) {
        this.f40577c = photoViewer;
        this.f40575a = tu0Var;
        this.f40576b = num;
    }
    ...
    public final boolean onPreDraw() {
        PhotoViewer photoViewer = this.f40577c;
        ...
        photoViewer.f31347s3.setTranslationY(AndroidUtilities.dp(32.0f));
        photoViewer.f31347s3.animate().alpha(1.0f).translationY(0.0f).setDuration(150L).setInterpolator(srVar).start();
        photoViewer.f31222e0.setAlpha(0.0f);
        photoViewer.L0.setAlpha(0);
        photoViewer.f31303n4 = 4;
        ...
        animatorSet.playTogether(ObjectAnimator.ofFloat(photoViewer.f31222e0, property, 0.0f, 1.0f).setDuration(220L), ObjectAnimator.ofFloat(photoViewer.f31266j0, property, 0.0f, 1.0f).setDuration(220L), duration2, duration3);
