        ...
        switch (this.f32559a) {
            ...
            case 1:
                ...
                for (int i10 = 0; i10 < longSparseArray.size(); i10++) {
                    ...
                    arrayList.add(r6Var);
                    if (z6Var2.getMessagesController().getUserOrChat(((r6) arrayList.get(i10)).f37174a) == null) {
                ...
                Collections.sort(bVar.f49461f, new db1(26));
                Collections.sort(bVar.f49462g, new db1(26));
                ...
                return;
            default:
                z6 z6Var3 = this.f32560b;
                z6Var3.h = z6.q0(5, FileLoader.checkDirectory(4));
                if (!z6.f40326k0) {
                    z6Var3.f40345r = z6.q0(4, FileLoader.checkDirectory(4));
                    if (!z6.f40326k0) {
                        long q02 = z6.q0(0, FileLoader.checkDirectory(0));
                        z6Var3.f40349y = q02;
                        z6Var3.f40349y = z6.q0(0, FileLoader.checkDirectory(100)) + q02;
                        if (!z6.f40326k0) {
                            ...
                            if (!z6.f40326k0) {
                                ...
                                if (!z6.f40326k0) {
                                    ...
                                    z6Var3.f40346s = q05;
                                    z6Var3.f40346s = z6.q0(1, FileLoader.checkDirectory(5)) + q05;
                                    if (!z6.f40326k0) {
                                        long q06 = z6.q0(2, FileLoader.checkDirectory(3));
                                        z6Var3.f40348x = q06;
                                        z6Var3.f40348x = z6.q0(2, FileLoader.checkDirectory(5)) + q06;
                                        if (!z6.f40326k0) {
                                            z6Var3.G = z6.q0(0, new File(FileLoader.checkDirectory(4), "acache"));
                                            if (!z6.f40326k0) {
                                                z6Var3.f40344n = z6.q0(3, FileLoader.checkDirectory(4));
                                                if (!z6.f40326k0) {
                                                    z6Var3.G += z6Var3.f40344n;
                                                    z6Var3.v = z6.q0(0, FileLoader.checkDirectory(1));
                                                    z6Var3.f40347w = z6.q0(0, FileLoader.checkDirectory(6));
                                                    if (!z6.f40326k0) {
                                                        long j10 = z6Var3.h + z6Var3.f40345r + z6Var3.E + z6Var3.F + z6Var3.v + z6Var3.f40349y + z6Var3.f40346s + z6Var3.f40348x + z6Var3.f40347w + z6Var3.G;
                                                        z6.m0 = Long.valueOf(j10);
                                                        z6Var3.H = j10;
                                                        z6.f40327l0 = System.currentTimeMillis();
