        ...
        switch (this.f35034a) {
            ...
            case 1:
                ...
                for (int i10 = 0; i10 < longSparseArray.size(); i10++) {
                    ...
                    arrayList.add(s6Var);
                    if (z6Var2.getMessagesController().getUserOrChat(((s6) arrayList.get(i10)).f40339a) == null) {
                ...
                Collections.sort(cVar.f759e, new a4.e(2));
                Collections.sort(cVar.f760f, new a4.e(2));
                Collections.sort(cVar.f761g, new a4.e(2));
                ...
                return;
            default:
                z6 z6Var3 = this.f35035b;
                z6Var3.h = z6.q0(5, FileLoader.checkDirectory(4));
                if (!z6.f43326k0) {
                    z6Var3.f43346r = z6.q0(4, FileLoader.checkDirectory(4));
                    if (!z6.f43326k0) {
                        long q02 = z6.q0(0, FileLoader.checkDirectory(0));
                        z6Var3.f43350y = q02;
                        z6Var3.f43350y = z6.q0(0, FileLoader.checkDirectory(100)) + q02;
                        if (!z6.f43326k0) {
                            ...
                            if (!z6.f43326k0) {
                                ...
                                if (!z6.f43326k0) {
                                    ...
                                    z6Var3.f43347s = q05;
                                    z6Var3.f43347s = z6.q0(1, FileLoader.checkDirectory(5)) + q05;
                                    if (!z6.f43326k0) {
                                        long q06 = z6.q0(2, FileLoader.checkDirectory(3));
                                        z6Var3.f43349x = q06;
                                        z6Var3.f43349x = z6.q0(2, FileLoader.checkDirectory(5)) + q06;
                                        if (!z6.f43326k0) {
                                            z6Var3.G = z6.q0(0, new File(FileLoader.checkDirectory(4), "acache"));
                                            if (!z6.f43326k0) {
                                                z6Var3.f43345n = z6.q0(3, FileLoader.checkDirectory(4));
                                                if (!z6.f43326k0) {
                                                    z6Var3.G += z6Var3.f43345n;
                                                    z6Var3.v = z6.q0(0, FileLoader.checkDirectory(1));
                                                    z6Var3.f43348w = z6.q0(0, FileLoader.checkDirectory(6));
                                                    if (!z6.f43326k0) {
                                                        long j10 = z6Var3.h + z6Var3.f43346r + z6Var3.E + z6Var3.F + z6Var3.v + z6Var3.f43350y + z6Var3.f43347s + z6Var3.f43349x + z6Var3.f43348w + z6Var3.G;
                                                        z6.m0 = Long.valueOf(j10);
                                                        z6Var3.H = j10;
                                                        z6.f43327l0 = System.currentTimeMillis();
