        ...
        switch (this.f32572a) {
            ...
            case 1:
                ...
                for (int i10 = 0; i10 < longSparseArray.size(); i10++) {
                    ...
                    arrayList.add(r6Var);
                    if (z6Var2.getMessagesController().getUserOrChat(((r6) arrayList.get(i10)).f37185a) == null) {
                ...
                Collections.sort(bVar.f49471f, new db1(26));
                Collections.sort(bVar.f49472g, new db1(26));
                ...
                return;
            default:
                z6 z6Var3 = this.f32573b;
                z6Var3.h = z6.q0(5, FileLoader.checkDirectory(4));
                if (!z6.f40341k0) {
                    z6Var3.f40360r = z6.q0(4, FileLoader.checkDirectory(4));
                    if (!z6.f40341k0) {
                        long q02 = z6.q0(0, FileLoader.checkDirectory(0));
                        z6Var3.f40364y = q02;
                        z6Var3.f40364y = z6.q0(0, FileLoader.checkDirectory(100)) + q02;
                        if (!z6.f40341k0) {
                            ...
                            if (!z6.f40341k0) {
                                ...
                                if (!z6.f40341k0) {
                                    ...
                                    z6Var3.f40361s = q05;
                                    z6Var3.f40361s = z6.q0(1, FileLoader.checkDirectory(5)) + q05;
                                    if (!z6.f40341k0) {
                                        long q06 = z6.q0(2, FileLoader.checkDirectory(3));
                                        z6Var3.f40363x = q06;
                                        z6Var3.f40363x = z6.q0(2, FileLoader.checkDirectory(5)) + q06;
                                        if (!z6.f40341k0) {
                                            z6Var3.G = z6.q0(0, new File(FileLoader.checkDirectory(4), "acache"));
                                            if (!z6.f40341k0) {
                                                z6Var3.f40359n = z6.q0(3, FileLoader.checkDirectory(4));
                                                if (!z6.f40341k0) {
                                                    z6Var3.G += z6Var3.f40359n;
                                                    z6Var3.v = z6.q0(0, FileLoader.checkDirectory(1));
                                                    z6Var3.f40362w = z6.q0(0, FileLoader.checkDirectory(6));
                                                    if (!z6.f40341k0) {
                                                        long j10 = z6Var3.h + z6Var3.f40360r + z6Var3.E + z6Var3.F + z6Var3.v + z6Var3.f40364y + z6Var3.f40361s + z6Var3.f40363x + z6Var3.f40362w + z6Var3.G;
                                                        z6.m0 = Long.valueOf(j10);
                                                        z6Var3.H = j10;
                                                        z6.f40342l0 = System.currentTimeMillis();
