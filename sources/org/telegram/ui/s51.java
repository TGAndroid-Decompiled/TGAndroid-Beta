...
public final class s51 extends FrameLayout {
    ...
    public s51(Context context, int i10) {
        super(context);
        this.f37256a = i10;
    }
    ...
    public void dispatchDraw(Canvas canvas) {
        switch (this.f37256a) {
            case 6:
                org.telegram.ui.ActionBar.i6.f18923i3.setBounds(0, 0, getMeasuredWidth(), org.telegram.ui.ActionBar.i6.f18923i3.getIntrinsicHeight());
                org.telegram.ui.ActionBar.i6.f18923i3.draw(canvas);
    ...
    public void onDraw(Canvas canvas) {
        switch (this.f37256a) {
            case 5:
                super.onDraw(canvas);
                canvas.drawRect(0.0f, 0.0f, getMeasuredWidth(), 1.0f, org.telegram.ui.ActionBar.i6.f18958k0);
                return;
            default:
                super.onDraw(canvas);
                return;
