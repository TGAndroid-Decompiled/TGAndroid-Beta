...
public final class GroupCallSheet$$ExternalSyntheticLambda5 implements Runnable {
    public final int $r8$classId;
    public final int f$0;
    public final int f$1;

    public GroupCallSheet$$ExternalSyntheticLambda5(int i, int i2, int i3) {
        this.$r8$classId = i3;
        this.f$0 = i;
        this.f$1 = i2;
    }
    ...
    public final void run() {
        switch (this.$r8$classId) {
            case 0:
                GroupCallSheet.lambda$show$2(this.f$0, this.f$1);
                break;
            case 1:
