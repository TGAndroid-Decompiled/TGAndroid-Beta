...
public final class ad extends FrameLayout {
    ...
    public final void a(String str, boolean z10) {
        ...
        int i11 = 0;
        while (true) {
            arrayList = this.f31826c;
            boolean z11 = true;
            if (i11 >= arrayList.size()) {
                break;
            }
            org.telegram.ui.Components.lp lpVar = (org.telegram.ui.Components.lp) arrayList.get(i11);
            if (!TextUtils.equals(this.f31830s, lpVar.a()) && (!TextUtils.isEmpty(str) || !lpVar.f25954a.f18617a)) {
                z11 = false;
            }
            lpVar.d = z11;
            if (z11) {
    ...
    public void setGalleryWallpaper(TLRPC.WallPaper wallPaper) {
        ...
        if (this.v != null) {
            ArrayList arrayList = this.f31826c;
            if ((arrayList.isEmpty() || ((org.telegram.ui.Components.lp) arrayList.get(0)).f25954a.f18617a) && this.f31827f) {
                arrayList.add(0, new org.telegram.ui.Components.lp(org.telegram.ui.ActionBar.e4.a(this.f31824a)));
                this.h.l();
            }
        }
    }
