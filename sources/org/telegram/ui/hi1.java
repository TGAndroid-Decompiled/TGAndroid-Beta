...
public final class hi1 extends FrameLayout {
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        if (view == d3Var && (mi1Var.f35596n0 || mi1Var.m0)) {
            return false;
        }
        if ((view != d3Var && view != mi1Var.f35574c0 && (view != mi1Var.Y || !mi1Var.f35568a0)) || (!mi1Var.f35584g1 && mi1Var.f35588i1 == null)) {
            return super.drawChild(canvas, view, j3);
        }
        canvas.save();
        float f7 = mi1Var.f35582f1;
        canvas.scale(f7, f7, mi1Var.f35572b1, mi1Var.f35575c1);
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent.getActionMasked() == 1) {
            mi1Var.f35611y.b(false, false);
            mi1Var.v.a();
            AndroidUtilities.cancelRunOnUIThread(wh1Var);
            if (mi1Var.f35598p0 == 3) {
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (!mi1Var.f35586h1 && !mi1Var.f35569a1 && !mi1Var.f35584g1 && motionEvent.getActionMasked() != 0) {
            mi1.j(mi1Var);
            return false;
        }
        if (motionEvent.getActionMasked() == 0) {
            mi1Var.f35586h1 = false;
            mi1Var.f35569a1 = false;
            mi1Var.f35584g1 = false;
        }
        if (mi1Var.m0) {
            t2Var = mi1Var.f35574c0;
        } else {
            t2Var = mi1Var.f35576d0;
        }
        if (motionEvent.getActionMasked() != 0 && motionEvent.getActionMasked() != 5) {
            if (motionEvent.getActionMasked() == 2 && mi1Var.f35569a1) {
                int i10 = -1;
                int i11 = -1;
                for (int i12 = 0; i12 < motionEvent.getPointerCount(); i12++) {
                    if (mi1Var.f35577d1 == motionEvent.getPointerId(i12)) {
                        i10 = i12;
                    }
                    if (mi1Var.f35579e1 == motionEvent.getPointerId(i12)) {
                        i11 = i12;
                    }
                }
                if (i10 != -1 && i11 != -1) {
                    ...
                    mi1Var.f35582f1 = hypot;
                    if (hypot > 1.005f && !mi1Var.f35584g1) {
                        ...
                        mi1Var.f35584g1 = true;
                        mi1Var.f35569a1 = true;
                    }
            ...
            } else if (motionEvent.getActionMasked() == 1 || ((motionEvent.getActionMasked() == 6 && motionEvent.getPointerCount() >= 2 && ((mi1Var.f35577d1 == motionEvent.getPointerId(0) && mi1Var.f35579e1 == motionEvent.getPointerId(1)) || (mi1Var.f35577d1 == motionEvent.getPointerId(1) && mi1Var.f35579e1 == motionEvent.getPointerId(0)))) || motionEvent.getActionMasked() == 3)) {
                getParent().requestDisallowInterceptTouchEvent(false);
                mi1.j(mi1Var);
            }
        } else {
            if (motionEvent.getActionMasked() == 0) {
                ...
                mi1Var.f35586h1 = contains;
                if (!contains) {
                    mi1.j(mi1Var);
                }
            }
            if (mi1Var.f35586h1 && !mi1Var.f35569a1 && motionEvent.getPointerCount() == 2) {
                ...
                mi1Var.W0 = y12;
                mi1Var.f35582f1 = 1.0f;
                mi1Var.f35577d1 = motionEvent.getPointerId(0);
                mi1Var.f35579e1 = motionEvent.getPointerId(1);
                mi1Var.f35569a1 = true;
            }
        }
        ...
        if (action != 0) {
            ...
            } else if (this.f34232c) {
                float x14 = motionEvent.getX() - this.f34230a;
                float y13 = motionEvent.getY() - this.f34231b;
                long currentTimeMillis = System.currentTimeMillis();
                float f10 = (y13 * y13) + (x14 * x14);
                float f11 = mi1Var.f35604t0;
                if (f10 < f11 * f11 && currentTimeMillis - this.d < 300 && currentTimeMillis - mi1Var.K0 > 300) {
                    mi1Var.K0 = System.currentTimeMillis();
                    if (mi1Var.C0) {
                        mi1Var.m(false);
                    } else if (mi1Var.f35613z0) {
                        mi1Var.A(!mi1Var.f35610x0);
                        mi1Var.f35599q0 = mi1Var.f35598p0;
                        if (!mi1Var.f35610x0 && (e3Var = mi1Var.N0) != null && e3Var.V) {
                            e3Var.e(true);
                        }
                        mi1Var.H();
                    }
            ...
            this.f34230a = motionEvent.getX();
            this.f34231b = motionEvent.getY();
            this.f34232c = true;
            this.d = System.currentTimeMillis();
        }
        if (!mi1Var.f35586h1 && !this.f34232c) {
            return false;
        }
        return true;
    }
