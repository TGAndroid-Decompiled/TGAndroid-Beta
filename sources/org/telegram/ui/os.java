...
public final class os extends org.telegram.ui.ActionBar.j {
    ...
    public final void b(int i10) {
        ...
        int i11;
        int i12;
        ss ssVar = this.f39305a;
        if (i10 == -1) {
            ssVar.finishFragment();
        } else if (i10 == 1 && ssVar.f40512b.getText().length() != 0) {
            ...
            user.first_name = ssVar.f40512b.getText().toString();
            user.last_name = ssVar.f40513c.getText().toString();
            user.contact = true;
