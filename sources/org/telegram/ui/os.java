...
public final class os extends org.telegram.ui.ActionBar.j {
    ...
    public final void b(int i10) {
        ...
        int i11;
        int i12;
        ss ssVar = this.f39332a;
        if (i10 == -1) {
            ssVar.finishFragment();
        } else if (i10 == 1 && ssVar.f40539b.getText().length() != 0) {
            ...
            user.first_name = ssVar.f40539b.getText().toString();
            user.last_name = ssVar.f40540c.getText().toString();
            user.contact = true;
