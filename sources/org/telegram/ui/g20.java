...
public final class g20 extends og.b {
    ...
    public final int j(int i10) {
        ...
        if (i10 >= 0) {
            ...
            if (i10 >= filtersSetupActivity.f30817n.size() || (d20Var = (d20) filtersSetupActivity.f30817n.get(i10)) == null) {
                return 3;
            }
            return d20Var.f15543a;
        }
        return 3;
    }
    ...
    public final void v(s4.c1 r22, int r23) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.g20.v(s4.c1, int):void");
    }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 != 0) {
            if (i10 != 1) {
                    ...
                    if (i10 != 3) {
                        if (i10 != 4) {
                            if (i10 != 6) {
                                ...
                                frameLayout.f34108b = textView2;
                                org.telegram.messenger.wl.r(textView2, org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19263z6, false), 1, 13.0f, 1);
                                ...
                                frameLayout.setAddOnClickListener(new uv(6, this, frameLayout));
                                b20Var = frameLayout;
                            } else {
                                b20Var = new org.telegram.ui.Cells.w8(context);
                            }
                        } else {
                            ?? frameLayout2 = new FrameLayout(context);
                            org.telegram.ui.ActionBar.k5 k5Var = new org.telegram.ui.ActionBar.k5(context);
                            frameLayout2.f34417a = k5Var;
                            k5Var.setTextSize(16);
                            if (LocaleController.isRTL) {
                                i15 = 5;
                            }
                            k5Var.setGravity(i15);
                            int i16 = org.telegram.ui.ActionBar.j6.f19064o6;
                            ...
                            frameLayout2.f34418b = imageView;
                            imageView.setScaleType(ImageView.ScaleType.CENTER);
                            frameLayout2.addView(imageView);
                            b20Var = frameLayout2;
                        }
                    } else {
                        b20Var = new org.telegram.ui.Cells.e9(context);
                    }
                } else {
                    b20 b20Var2 = new b20(this.e, context);
                    b20Var2.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18862d6, false));
                    b20Var2.setOnReorderButtonTouchListener(new ci.q1(6, this, b20Var2));
                ...
                frameLayout3.f32644a = imageView2;
            ...
            b20Var = new org.telegram.ui.Cells.l4(context);
        }
