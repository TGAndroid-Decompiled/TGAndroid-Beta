...
public final class g20 {
    public LinearGradient f33803b;
    public final Paint[] f33802a = new Paint[4];
    public final Matrix f33804c = new Matrix();

    public final void a(Canvas canvas, RectF rectF, float f7) {
        Paint[] paintArr = this.f33802a;
        if (paintArr[0] == null) {
            Paint paint = new Paint(1);
            paintArr[0] = paint;
            paint.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.DST_OUT));
        }
        paintArr[0].setShader(this.f33803b);
    ...
    public final void b(Canvas canvas, RectF rectF, int i10, float f7) {
        ...
        if (this.f33803b == null) {
            this.f33803b = new LinearGradient(0.0f, 0.0f, 0.0f, 16.0f, new int[]{-65536, 16711680}, new float[]{0.0f, 1.0f}, Shader.TileMode.CLAMP);
        }
        Paint[] paintArr = this.f33802a;
        ...
        paintArr[i10].setShader(this.f33803b);
        Matrix matrix = this.f33804c;
        matrix.reset();
        if (i10 == 0) {
        ...
        this.f33803b.setLocalMatrix(matrix);
