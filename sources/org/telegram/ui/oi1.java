...
public final class oi1 extends FrameLayout {
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        if (view == c3Var && (ti1Var.f37821n0 || ti1Var.m0)) {
            return false;
        }
        if ((view != c3Var && view != ti1Var.f37799c0 && (view != ti1Var.Y || !ti1Var.f37793a0)) || (!ti1Var.f37809g1 && ti1Var.f37813i1 == null)) {
            return super.drawChild(canvas, view, j3);
        }
        canvas.save();
        float f7 = ti1Var.f37807f1;
        canvas.scale(f7, f7, ti1Var.f37797b1, ti1Var.f37800c1);
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent.getActionMasked() == 1) {
            ti1Var.f37836y.b(false, false);
            ti1Var.v.a();
            AndroidUtilities.cancelRunOnUIThread(di1Var);
            if (ti1Var.f37823p0 == 3) {
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (!ti1Var.f37811h1 && !ti1Var.f37794a1 && !ti1Var.f37809g1 && motionEvent.getActionMasked() != 0) {
            ti1.j(ti1Var);
            return false;
        }
        if (motionEvent.getActionMasked() == 0) {
            ti1Var.f37811h1 = false;
            ti1Var.f37794a1 = false;
            ti1Var.f37809g1 = false;
        }
        if (ti1Var.m0) {
            s2Var = ti1Var.f37799c0;
        } else {
            s2Var = ti1Var.f37801d0;
        }
        if (motionEvent.getActionMasked() != 0 && motionEvent.getActionMasked() != 5) {
            if (motionEvent.getActionMasked() == 2 && ti1Var.f37794a1) {
                int i10 = -1;
                int i11 = -1;
                for (int i12 = 0; i12 < motionEvent.getPointerCount(); i12++) {
                    if (ti1Var.f37802d1 == motionEvent.getPointerId(i12)) {
                        i10 = i12;
                    }
                    if (ti1Var.f37804e1 == motionEvent.getPointerId(i12)) {
                        i11 = i12;
                    }
                }
                if (i10 != -1 && i11 != -1) {
                    ...
                    ti1Var.f37807f1 = hypot;
                    if (hypot > 1.005f && !ti1Var.f37809g1) {
                        ...
                        ti1Var.f37809g1 = true;
                        ti1Var.f37794a1 = true;
                    }
            ...
            } else if (motionEvent.getActionMasked() == 1 || ((motionEvent.getActionMasked() == 6 && motionEvent.getPointerCount() >= 2 && ((ti1Var.f37802d1 == motionEvent.getPointerId(0) && ti1Var.f37804e1 == motionEvent.getPointerId(1)) || (ti1Var.f37802d1 == motionEvent.getPointerId(1) && ti1Var.f37804e1 == motionEvent.getPointerId(0)))) || motionEvent.getActionMasked() == 3)) {
                getParent().requestDisallowInterceptTouchEvent(false);
                ti1.j(ti1Var);
            }
        } else {
            if (motionEvent.getActionMasked() == 0) {
                ...
                ti1Var.f37811h1 = contains;
                if (!contains) {
                    ti1.j(ti1Var);
                }
            }
            if (ti1Var.f37811h1 && !ti1Var.f37794a1 && motionEvent.getPointerCount() == 2) {
                ...
                ti1Var.W0 = y12;
                ti1Var.f37807f1 = 1.0f;
                ti1Var.f37802d1 = motionEvent.getPointerId(0);
                ti1Var.f37804e1 = motionEvent.getPointerId(1);
                ti1Var.f37794a1 = true;
            }
        }
        ...
        if (!ti1Var.f37811h1 && !this.f36341c) {
            return false;
        }
        return true;
    }
