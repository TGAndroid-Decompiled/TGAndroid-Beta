...
public final class oi1 extends FrameLayout {
    public float f36319a;
    public float f36320b;
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        if (view == c3Var && (ti1Var.f37798n0 || ti1Var.m0)) {
            return false;
        }
        if ((view != c3Var && view != ti1Var.f37776c0 && (view != ti1Var.Y || !ti1Var.f37770a0)) || (!ti1Var.f37786g1 && ti1Var.f37790i1 == null)) {
            return super.drawChild(canvas, view, j3);
        }
        canvas.save();
        float f7 = ti1Var.f37784f1;
        canvas.scale(f7, f7, ti1Var.f37774b1, ti1Var.f37777c1);
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent.getActionMasked() == 1) {
            ti1Var.f37813y.b(false, false);
            ti1Var.v.a();
            AndroidUtilities.cancelRunOnUIThread(di1Var);
            if (ti1Var.f37800p0 == 3) {
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (!ti1Var.f37788h1 && !ti1Var.f37771a1 && !ti1Var.f37786g1 && motionEvent.getActionMasked() != 0) {
            ti1.j(ti1Var);
            return false;
        }
        if (motionEvent.getActionMasked() == 0) {
            ti1Var.f37788h1 = false;
            ti1Var.f37771a1 = false;
            ti1Var.f37786g1 = false;
        }
        if (ti1Var.m0) {
            s2Var = ti1Var.f37776c0;
        } else {
            s2Var = ti1Var.f37778d0;
        }
        if (motionEvent.getActionMasked() != 0 && motionEvent.getActionMasked() != 5) {
            if (motionEvent.getActionMasked() == 2 && ti1Var.f37771a1) {
                int i10 = -1;
                int i11 = -1;
                for (int i12 = 0; i12 < motionEvent.getPointerCount(); i12++) {
                    if (ti1Var.f37779d1 == motionEvent.getPointerId(i12)) {
                        i10 = i12;
                    }
                    if (ti1Var.f37781e1 == motionEvent.getPointerId(i12)) {
                        i11 = i12;
                    }
                }
                if (i10 != -1 && i11 != -1) {
                    ...
                    ti1Var.f37784f1 = hypot;
                    if (hypot > 1.005f && !ti1Var.f37786g1) {
                        ...
                        ti1Var.f37786g1 = true;
                        ti1Var.f37771a1 = true;
                    }
            ...
            } else if (motionEvent.getActionMasked() == 1 || ((motionEvent.getActionMasked() == 6 && motionEvent.getPointerCount() >= 2 && ((ti1Var.f37779d1 == motionEvent.getPointerId(0) && ti1Var.f37781e1 == motionEvent.getPointerId(1)) || (ti1Var.f37779d1 == motionEvent.getPointerId(1) && ti1Var.f37781e1 == motionEvent.getPointerId(0)))) || motionEvent.getActionMasked() == 3)) {
                getParent().requestDisallowInterceptTouchEvent(false);
                ti1.j(ti1Var);
            }
        } else {
            if (motionEvent.getActionMasked() == 0) {
                ...
                ti1Var.f37788h1 = contains;
                if (!contains) {
                    ti1.j(ti1Var);
                }
            }
            if (ti1Var.f37788h1 && !ti1Var.f37771a1 && motionEvent.getPointerCount() == 2) {
                ...
                ti1Var.W0 = y12;
                ti1Var.f37784f1 = 1.0f;
                ti1Var.f37779d1 = motionEvent.getPointerId(0);
                ti1Var.f37781e1 = motionEvent.getPointerId(1);
                ti1Var.f37771a1 = true;
            }
        }
        ...
        if (action != 0) {
            ...
            } else if (this.f36321c) {
                float x14 = motionEvent.getX() - this.f36319a;
                float y13 = motionEvent.getY() - this.f36320b;
                long currentTimeMillis = System.currentTimeMillis();
                float f10 = (y13 * y13) + (x14 * x14);
                float f11 = ti1Var.f37806t0;
                if (f10 < f11 * f11 && currentTimeMillis - this.d < 300 && currentTimeMillis - ti1Var.K0 > 300) {
                    ti1Var.K0 = System.currentTimeMillis();
                    if (ti1Var.C0) {
                        ti1Var.m(false);
                    } else if (ti1Var.f37815z0) {
                        ti1Var.A(!ti1Var.f37812x0);
                        ti1Var.f37801q0 = ti1Var.f37800p0;
                        if (!ti1Var.f37812x0 && (d3Var = ti1Var.N0) != null && d3Var.V) {
                            d3Var.e(true);
                        }
                        ti1Var.H();
                    }
            ...
            this.f36319a = motionEvent.getX();
            this.f36320b = motionEvent.getY();
            this.f36321c = true;
            this.d = System.currentTimeMillis();
        }
        if (!ti1Var.f37788h1 && !this.f36321c) {
            return false;
        }
        return true;
    }
