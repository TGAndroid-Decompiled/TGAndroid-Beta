...
public final class p50 {
    ...
    public final org.telegram.ui.Components.k01 f36954f;
    public eg.h0 f36955g;
    public int f36957j;
    public final Paint f36951a = new Paint(1);
    public final Paint f36952b = new Paint(1);
    public final r50[] f36953c = new r50[4];
    public boolean h = true;
    public final org.telegram.ui.Components.z5 f36956i = new org.telegram.ui.Components.z5(new d10(this, 7), 320, org.telegram.ui.Components.mr.h, 0);
    public final RectF f36958k = new RectF();
    public final RectF f36959l = new RectF();
    public final Path f36960m = new Path();

    public p50() {
        int i10 = 0;
        while (true) {
            r50[] r50VarArr = this.f36953c;
            if (i10 < r50VarArr.length) {
                r50VarArr[i10] = new r50(i10);
                i10++;
            } else {
                this.f36951a.setColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20173tg, false));
                ...
                this.e = k01Var;
                this.f36954f = new org.telegram.ui.Components.k01(LocaleController.getString(R.string.ConferenceEncryptedClose), 14.0f, AndroidUtilities.bold());
                b(null);
                return;
            }
        }
    ...
    public final boolean a(Canvas canvas, float f10, float f11) {
        ...
        k01Var.f26134p = f10 - AndroidUtilities.dp(132.0f);
        int d = i0.a.d(f11, this.f36957j, org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20173tg, false));
        Paint paint = this.f36951a;
        paint.setColor(d);
        float e = this.f36956i.e(this.h);
        ...
        if (f11 > 0.0f) {
            ...
            this.f36954f.c(rectF.centerX() - (this.f36954f.l() / 2.0f), j10 - AndroidUtilities.dp(20.0f), f11, -1, canvas);
        }
        canvas.restore();
        return z10;
    }
    ...
    public final void b(String[] strArr) {
        ...
        for (int i10 = 0; i10 < 4; i10++) {
            r50 r50Var = this.f36953c[i10];
            if (strArr == null) {
                str = null;
            } else {
                str = strArr[i10];
            }
            q50 q50Var = r50Var.f37709k;
            boolean z11 = r50Var.f37705f;
            if (str != null) {
                z10 = true;
            } else {
                z10 = false;
            ...
            r50Var.f37705f = z10;
            if (str != null && (r50Var.d == null || !TextUtils.equals(r50Var.f37710l, str))) {
                org.telegram.ui.Components.l5 l5Var = r50Var.d;
                if (l5Var != null) {
                    l5Var.p(q50Var);
                }
                r50Var.f37704c = Emoji.getEmojiDrawable(str);
            ...
            if (r50Var.f37705f && !z11) {
                r50Var.e = false;
            }
        }
        eg.h0 h0Var = this.f36955g;
        if (h0Var != null) {
            h0Var.invalidate();
        }
    }
