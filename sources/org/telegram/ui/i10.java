...
public final class i10 extends f2.a1 {
    ...
    public final void a(RecyclerView recyclerView, int i10) {
        if (i10 == 1) {
            AndroidUtilities.hideKeyboard(this.f37717a.H.getCurrentFocus());
        }
    }
    ...
    public final void b(RecyclerView recyclerView, int i10, int i11) {
        ...
        t10 t10Var = this.f37717a;
        oh.b3 b3Var = t10Var.f41439j0;
        f2.j0 j0Var = t10Var.f41436g0;
        xd.a aVar = t10Var.f41425a;
        c10 c10Var = t10Var.f41440k0;
        if (recyclerView.getAdapter() != null && t10Var.d != null) {
            ...
            if (t10Var.d == t10Var.R) {
                if (i11 != 0 && !t10Var.f41434f.isEmpty() && TextUtils.isEmpty(t10Var.N)) {
            ...
            View pinnedHeader = t10Var.f41427b.getPinnedHeader();
            if (pinnedHeader instanceof org.telegram.ui.Cells.u3) {
                ...
                if (!TextUtils.isEmpty(text) && u3Var.getAlpha() > 0.0f) {
                    ...
                    if (!TextUtils.equals((String) b3Var.d, charSequence)) {
                        ...
                        ((org.telegram.ui.Components.j6) b3Var.f16884b).q(charSequence, true, true);
                    }
                    if (i11 != 0) {
                        AndroidUtilities.cancelRunOnUIThread(c10Var);
                        AndroidUtilities.runOnUIThread(c10Var, 1650L);
