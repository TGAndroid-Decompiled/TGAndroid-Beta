...
public final class bu0 extends ou0 {
    public final int f32586p0;
    public final NotificationCenter.NotificationCenterDelegate f32587q0;
    ...
    public bu0(NotificationCenter.NotificationCenterDelegate notificationCenterDelegate, Context context, ru0 ru0Var, FrameLayout frameLayout, int i10) {
        ...
        this.f32586p0 = i10;
        this.f32587q0 = notificationCenterDelegate;
    }

    @Override
    public boolean C() {
        switch (this.f32586p0) {
            case 0:
                return !((PhotoViewer) this.f32587q0).f31057s;
            default:
                return super.C();
        }
    }
    ...
    public void D() {
        switch (this.f32586p0) {
            case 1:
                SecretMediaViewer secretMediaViewer = (SecretMediaViewer) this.f32587q0;
                if (secretMediaViewer.J && getScrollY() <= 0) {
                    AndroidUtilities.runOnUIThread(secretMediaViewer.f31475r1, 3000L);
                    return;
                }
                return;
            default:
    ...
    public void F() {
        switch (this.f32586p0) {
            case 1:
                AndroidUtilities.cancelRunOnUIThread(((SecretMediaViewer) this.f32587q0).f31475r1);
                return;
            default:
                return;
        }
        ...
        switch (this.f32586p0) {
            case 1:
                ...
                if (secretMediaViewer.K0 == null) {
                    if (getScrollY() < getMeasuredHeight() / 3.0f && secretMediaViewer.f31460k0) {
                        z10 = true;
                    } else {
                        z10 = false;
                    }
    ...
    public void invalidate() {
        ...
        switch (this.f32586p0) {
            case 0:
                super.invalidate();
                PhotoViewer photoViewer = (PhotoViewer) this.f32587q0;
                ...
                if (photoViewer.J) {
                    ...
                    if (!z10) {
                        int b10 = zu0VarArr[0].b() + zu0VarArr[0].f40308j;
                        if (C()) {
