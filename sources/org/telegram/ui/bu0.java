...
public final class bu0 extends ou0 {
    public final int f32458p0;
    public final NotificationCenter.NotificationCenterDelegate f32459q0;
    ...
    public bu0(NotificationCenter.NotificationCenterDelegate notificationCenterDelegate, Context context, ru0 ru0Var, FrameLayout frameLayout, int i10) {
        ...
        this.f32458p0 = i10;
        this.f32459q0 = notificationCenterDelegate;
    }

    @Override
    public boolean C() {
        switch (this.f32458p0) {
            case 0:
                return !((PhotoViewer) this.f32459q0).f31302s;
            default:
                return super.C();
        }
    }
    ...
    public void D() {
        switch (this.f32458p0) {
            case 1:
                SecretMediaViewer secretMediaViewer = (SecretMediaViewer) this.f32459q0;
                if (secretMediaViewer.J && getScrollY() <= 0) {
                    AndroidUtilities.runOnUIThread(secretMediaViewer.f31719r1, 3000L);
                    return;
                }
                return;
            default:
    ...
    public void F() {
        switch (this.f32458p0) {
            case 1:
                AndroidUtilities.cancelRunOnUIThread(((SecretMediaViewer) this.f32459q0).f31719r1);
                return;
            default:
                return;
        }
        ...
        switch (this.f32458p0) {
            case 1:
                ...
                if (secretMediaViewer.K0 == null) {
                    if (getScrollY() < getMeasuredHeight() / 3.0f && secretMediaViewer.f31704k0) {
                        z10 = true;
                    } else {
                        z10 = false;
                    }
    ...
    public void invalidate() {
        ...
        switch (this.f32458p0) {
            case 0:
                super.invalidate();
                PhotoViewer photoViewer = (PhotoViewer) this.f32459q0;
                ...
                if (photoViewer.J) {
                    ...
                    if (!z10) {
                        int b10 = zu0VarArr[0].b() + zu0VarArr[0].f40564j;
                        if (C()) {
