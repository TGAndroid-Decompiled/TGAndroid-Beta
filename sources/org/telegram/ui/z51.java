...
public final class z51 implements org.telegram.ui.Components.ml0 {
    ...
    public final Context f40101b;
    public final org.telegram.ui.ActionBar.f6 f40102c;
    ...
    public final boolean mo18c(float f7, float f10, int i10, View view) {
        j71 j71Var = this.e;
        int i11 = j71Var.V;
        int i12 = this.f40100a;
        if (i12 != 11 && i12 != 13 && j71Var.f34793h1) {
            ...
            if (z10 && (i12 == 1 || i12 == 8)) {
                ...
                s61 s61Var = (s61) view;
                if (!s61Var.f37312s && !UserConfig.getInstance(i11).isPremium()) {
                ...
                if (s61Var.f37312s) {
                    ...
                    TLRPC.TL_availableReaction tL_availableReaction = MediaDataController.getInstance(i11).getReactionsMap().get(j71Var.S0.f37314x.f49423f);
                    if (tL_availableReaction != null) {
                        j71Var.V0.setImage(ImageLocation.getForDocument(tL_availableReaction.select_animation), "60_60_pcache", null, null, null, 0L, "tgs", j71Var.S0.f37314x, 0);
                    }
                } else {
                ...
                if (s61Var2.e != null && (i12 == 0 || i12 == 12 || i12 == 9 || i12 == 10)) {
                    ...
                    y51 y51Var = new y51(this, this.f40101b, j71Var.T1, j71Var, s61Var2, this.f40102c, view, tL_starGiftUnique);
                    j71Var.X0 = y51Var;
                    y51Var.show();
                    try {
