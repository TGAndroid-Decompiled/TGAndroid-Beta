...
public final class z51 implements org.telegram.ui.Components.cl0 {
    ...
    public final org.telegram.ui.ActionBar.f6 f43297c;
    public final Integer d;
    public final j71 f43298e;
    ...
    public final boolean mo18d(float f7, float f10, int i10, View view) {
        j71 j71Var = this.f43298e;
        int i11 = j71Var.V;
        int i12 = this.f43295a;
        if (i12 != 11 && i12 != 13 && j71Var.f37647h1) {
            ...
            if (z10 && (i12 == 1 || i12 == 8)) {
                ...
                s61 s61Var = (s61) view;
                if (!s61Var.f40322s && !UserConfig.getInstance(i11).isPremium()) {
                    org.telegram.ui.Components.z5 z5Var = s61Var.f40318e;
                    TLRPC.Document document = z5Var.document;
                    if (document == null) {
                        document = org.telegram.ui.Components.q5.f(i11, z5Var.documentId);
                    }
                    j71Var.p(s61Var, Long.valueOf(s61Var.f40318e.documentId), document, s61Var.v, null);
                    return true;
                }
                j71Var.S0 = s61Var;
                j71Var.U0 = 0.0f;
                ...
                if (s61Var.f40322s) {
                    ...
                    TLRPC.TL_availableReaction tL_availableReaction = MediaDataController.getInstance(i11).getReactionsMap().get(j71Var.S0.f40324x.f597f);
                    if (tL_availableReaction != null) {
                        j71Var.V0.setImage(ImageLocation.getForDocument(tL_availableReaction.select_animation), "60_60_pcache", null, null, null, 0L, "tgs", j71Var.S0.f40324x, 0);
                    }
                } else {
                    j71Var.setBigReactionAnimatedEmoji(new org.telegram.ui.Components.q5(4, i11, j71Var.S0.f40318e.documentId));
                }
                ...
                if (s61Var2.f40318e != null && (i12 == 0 || i12 == 12 || i12 == 9 || i12 == 10)) {
                    TL_stars.TL_starGiftUnique tL_starGiftUnique = s61Var2.v;
                    y51 y51Var = new y51(this, this.f43296b, j71Var.T1, j71Var, s61Var2, this.f43297c, view, tL_starGiftUnique);
                    j71Var.X0 = y51Var;
                    y51Var.show();
                    try {
