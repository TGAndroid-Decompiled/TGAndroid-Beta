...
public final class z51 extends x61 {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (i61Var != null) {
            ...
            zg.c0 c0Var = (zg.c0) dVar.f43143b;
            zg.b0 b0Var = c0Var.f49006a;
            RectF rectF = AndroidUtilities.rectTmp;
            float f7 = 0;
            rectF.set(f7, f7, measuredWidth, measuredHeight);
            org.telegram.ui.Components.fk0 delegate = ((org.telegram.ui.Components.gk0) dVar.f43144c).getDelegate();
            float x11 = b0Var.getX() + x10;
            if (c0Var.f49026y == 1) {
                y3 = b0Var.getY() - AndroidUtilities.statusBarHeight;
            } else {
                y3 = b0Var.getY() + c0Var.f49008c.getY();
            }
