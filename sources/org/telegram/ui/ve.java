...
public final class ve implements org.telegram.ui.ActionBar.a2, org.telegram.ui.Components.ho, MessagesStorage.BooleanCallback, org.telegram.ui.Components.mj0, ResultCallback, xh.c, kh.a, kh.b, a70, rs, org.telegram.ui.Components.bl0, kh.d, org.telegram.ui.Components.nk0, FlagSecureReason.FlagSecureCondition, lv0 {
            ...
            if ((adapter.I != null || adapter.J != null) && i10 != 0) {
                ...
                if (J instanceof hg.h1) {
                    ...
                    if (coVar.I1.getAdapter().J != null) {
                        ...
                        alertDialog$Builder.f20225a.T = LocaleController.getString(R.string.ClearSearch);
    ...
    public void c() {
        ...
        if (coVar.y3 == null && coVar.getParentActivity() != null) {
            coVar.Q7();
            coVar.y3.m(coVar.T5, coVar.f35276f, 8);
        }
    }
    ...
    public void d(TLRPC.Document document) {
        switch (this.f41549a) {
            case 2:
                co.t0(this.f41550b, document);
                return;
            default:
                co.u0(this.f41550b, document);
                return;
        }
    }
        ...
        switch (this.f41549a) {
            case 9:
                ...
                if (coVar.getParentActivity() != null && coVar.getParentActivity() != null) {
                    ji jiVar = new ji(coVar, coVar, coVar.getParentActivity(), coVar.f35274ea, arrayList);
                ...
                return;
            default:
                co coVar2 = this.f41550b;
                if (coVar2.getParentActivity() != null && coVar2.getParentActivity() != null) {
                    gj gjVar = new gj(coVar2, coVar2, coVar2.getParentActivity(), coVar2.f35274ea, arrayList);
    ...
    public void f(boolean z10, boolean z11) {
        co coVar = this.f41550b;
        coVar.M0.i(coVar.f35286fa.c(), z10, z11);
    }
    ...
    public void g(org.telegram.ui.ActionBar.b2 b2Var, int i10) {
        switch (this.f41549a) {
            ...
            case 4:
                co coVar2 = this.f41550b;
                MessagePreviewParams messagePreviewParams = coVar2.f35282f5;
            ...
            case 5:
                ...
                return;
            case 6:
                co coVar3 = this.f41550b;
                coVar3.getMessagesController().unblockPeer(coVar3.f35276f.f20043id);
                return;
            case 8:
                this.f41550b.finishFragment();
                return;
            case 10:
                hg.k1 adapter = this.f41550b.I1.getAdapter();
                adapter.f11181w.c();
                adapter.I.clear();
                adapter.l();
            ...
            case 13:
                ...
                return;
            case 15:
                co coVar6 = this.f41550b;
                MessagePreviewParams messagePreviewParams2 = coVar6.f35282f5;
    ...
    public void h(float[] fArr) {
        co coVar = this.f41550b;
        fArr[1] = coVar.f35500x0.getBottom() - coVar.Aa;
        fArr[0] = (coVar.f35500x0.getTop() + coVar.f35445s9) - AndroidUtilities.dp(4.0f);
    }

    @Override
    public void j(int i10, ArrayList arrayList) {
        co coVar = this.f41550b;
        coVar.getMessagesController().addUsersToChat(coVar.f35264e, coVar, arrayList, i10, null, null, null);
        coVar.getMessagesController().hidePeerSettingsBar(coVar.T5, coVar.f35276f, coVar.f35264e);
        coVar.Qc(true);
        coVar.oc(true);
    }
    ...
    public void k(int i10) {
        ...
        if (i10 == 1) {
            ...
            coVar.D4 = true;
            coVar.getMessagesController().getNextPollVotesMention(coVar.T5, coVar.d(), coVar.f35361m1, new qg(coVar, 1));
        } else if (i10 == 6) {
            coVar.Y8(true);
        } else if (i10 == 5) {
            coVar.Y8(false);
