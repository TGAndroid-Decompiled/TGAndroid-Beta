...
public final class h21 extends FrameLayout {
    ...
    public final TextView f34032b;
    public final ImageView f34033c;
    public SharedConfig.ProxyInfo d;
    public Drawable e;
    public final org.telegram.ui.Components.np f34034f;
    public boolean h;
    public boolean f34035n;
    public int f34036r;
    public final ProxyListActivity f34037s;
    ...
    public h21(ProxyListActivity proxyListActivity, Context context) {
        ...
        int i16;
        int i17;
        this.f34037s = proxyListActivity;
        TextView textView = new TextView(context);
        this.f34031a = textView;
        ...
        this.f34034f = npVar;
        npVar.b(org.telegram.ui.ActionBar.i6.f18924i7, org.telegram.ui.ActionBar.i6.f18889g7, org.telegram.ui.ActionBar.i6.f18962k7);
    ...
    public final void a(boolean z10, boolean z11) {
        ...
        if (!z11) {
            ...
            this.f34031a.setTranslationX(f10);
            this.f34032b.setTranslationX(f10);
            ImageView imageView = this.f34033c;
            ...
            float f12 = dp2 + f10;
            org.telegram.ui.Components.np npVar = this.f34034f;
    ...
    public final void b() {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.h21.b():void");
    }
    ...
    public void setChecked(boolean z10) {
        TextView textView = this.f34032b;
        if (z10) {
            if (this.e == null) {
            ...
            if (drawable != null) {
                drawable.setColorFilter(new PorterDuffColorFilter(this.f34036r, PorterDuff.Mode.MULTIPLY));
            }
            if (LocaleController.isRTL) {
    ...
    public void setProxy(SharedConfig.ProxyInfo proxyInfo) {
        String str;
        if (proxyInfo.settings.f15243a == 3) {
            str = a4.a.t(new StringBuilder(), proxyInfo.settings.f15244b, " (WEB)");
        } else {
            str = proxyInfo.settings.f15244b + ":" + proxyInfo.settings.f15245c;
        }
        this.f34031a.setText(str);
        this.d = proxyInfo;
    }

    public void setValue(CharSequence charSequence) {
        this.f34032b.setText(charSequence);
    }
}
