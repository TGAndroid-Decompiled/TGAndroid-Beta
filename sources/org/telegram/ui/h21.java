...
public final class h21 extends FrameLayout {
    ...
    public Drawable e;
    public final org.telegram.ui.Components.np f34118f;
    public boolean h;
    public boolean f34119n;
    public int f34120r;
    public final ProxyListActivity f34121s;
    ...
    public h21(ProxyListActivity proxyListActivity, Context context) {
        ...
        int i16;
        int i17;
        this.f34121s = proxyListActivity;
    ...
    public final void a(boolean z10, boolean z11) {
        ...
        if (!z11) {
            ...
            this.f34115a.setTranslationX(f10);
            this.f34116b.setTranslationX(f10);
            ImageView imageView = this.f34117c;
            ...
            float f12 = dp2 + f10;
            org.telegram.ui.Components.np npVar = this.f34118f;
    ...
    public void setChecked(boolean z10) {
        TextView textView = this.f34116b;
        if (z10) {
            if (this.e == null) {
            ...
            if (drawable != null) {
                drawable.setColorFilter(new PorterDuffColorFilter(this.f34120r, PorterDuff.Mode.MULTIPLY));
            }
            if (LocaleController.isRTL) {
    ...
    public void setValue(CharSequence charSequence) {
        this.f34116b.setText(charSequence);
    }
}
