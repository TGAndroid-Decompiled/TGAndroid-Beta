...
public final class h21 extends FrameLayout {
    ...
    public final ImageView f34112c;
    public SharedConfig.ProxyInfo d;
    public Drawable e;
    public final org.telegram.ui.Components.np f34113f;
    public boolean h;
    public boolean f34114n;
    public int f34115r;
    public final ProxyListActivity f34116s;
    ...
    public h21(ProxyListActivity proxyListActivity, Context context) {
        ...
        int i16;
        int i17;
        this.f34116s = proxyListActivity;
        TextView textView = new TextView(context);
        this.f34110a = textView;
        ...
        this.f34113f = npVar;
        npVar.b(org.telegram.ui.ActionBar.j6.f18953i7, org.telegram.ui.ActionBar.j6.f18917g7, org.telegram.ui.ActionBar.j6.f18991k7);
    ...
    public final void a(boolean z10, boolean z11) {
        ...
        if (!z11) {
            ...
            this.f34110a.setTranslationX(f10);
            this.f34111b.setTranslationX(f10);
            ...
            float f12 = dp2 + f10;
            org.telegram.ui.Components.np npVar = this.f34113f;
        ...
        duration.addUpdateListener(new pg(this, f10, 4));
    ...
    public void setChecked(boolean z10) {
        ...
        if (z10) {
            ...
            if (drawable != null) {
                drawable.setColorFilter(new PorterDuffColorFilter(this.f34115r, PorterDuff.Mode.MULTIPLY));
            }
            if (LocaleController.isRTL) {
    ...
    public void setProxy(SharedConfig.ProxyInfo proxyInfo) {
        String str;
        if (proxyInfo.settings.f15255a == 3) {
            str = a4.a.s(new StringBuilder(), proxyInfo.settings.f15256b, " (WEB)");
        } else {
            str = proxyInfo.settings.f15256b + ":" + proxyInfo.settings.f15257c;
        }
        this.f34110a.setText(str);
        this.d = proxyInfo;
    }

    public void setValue(CharSequence charSequence) {
        this.f34111b.setText(charSequence);
    }
}
