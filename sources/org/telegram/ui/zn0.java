...
public final class zn0 implements TextWatcher {
    ...
    public final void afterTextChanged(Editable editable) {
        ...
        int selectionStart = xo0Var.f39551f[0].getSelectionStart();
        xo0Var.m0 = true;
        if (xo0Var.H0.longValue() == 0) {
            xo0Var.f39551f[0].setText("");
        } else {
        ...
        if (j3 < xo0Var.H0.longValue() && j3 != 0 && this.f40526a && selectionStart >= 0) {
            EditTextBoldCursor editTextBoldCursor2 = xo0Var.f39551f[0];
            editTextBoldCursor2.setSelection(Math.min(selectionStart, editTextBoldCursor2.length()));
        } else if (this.f40528c && this.d != xo0Var.f39551f[0].length()) {
            EditTextBoldCursor editTextBoldCursor3 = xo0Var.f39551f[0];
            editTextBoldCursor3.setSelection(Math.max(0, Math.min(selectionStart, editTextBoldCursor3.length())));
        } else if (!this.f40529f && z10 && a2 >= 0) {
            int a10 = a(str4);
            if (a10 > 0) {
                xo0Var.f39551f[0].setSelection(a10 + 1);
            } else {
                EditTextBoldCursor editTextBoldCursor4 = xo0Var.f39551f[0];
                editTextBoldCursor4.setSelection(editTextBoldCursor4.length());
            }
        } else {
            EditTextBoldCursor editTextBoldCursor5 = xo0Var.f39551f[0];
    ...
    public final void beforeTextChanged(CharSequence charSequence, int i10, int i11, int i12) {
        ...
        String str;
        if (!this.f40530n.m0) {
            this.f40526a = !TextUtils.isEmpty(charSequence);
            this.f40527b = null;
            ...
            if (z10) {
                ...
                if ((charAt >= '0' && charAt <= '9') || (str.length() != 0 && longValue == 0)) {
                    if (a2 > 0 && i10 > a2 && longValue == 0) {
                        this.f40527b = fixNumbers.substring(0, a2 - 1);
                        return;
                    }
                    return;
                }
                while (true) {
                    ...
                    if (i13 >= 0) {
                        ...
                        if (charAt2 >= '0' && charAt2 <= '9') {
                            this.f40527b = fixNumbers.substring(0, i13) + fixNumbers.substring(i10);
                            return;
                        }
                        i10 = i13;
                    } else {
