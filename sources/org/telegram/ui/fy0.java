...
public final class fy0 extends org.telegram.ui.Components.kl0 {
    ...
    public final int j(int i10) {
        ...
        if (i10 == gy0Var.f33970n) {
            return 3;
        }
        if (i10 == gy0Var.f33969f) {
            return 2;
        }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i12 != 0) {
            if (i12 != 1) {
                ...
                y4Var.a(org.telegram.ui.ActionBar.i6.f19163v6, org.telegram.ui.ActionBar.i6.f19145u6);
                if (i11 == 1) {
        ...
        if (i11 == 1) {
            long keyAt = gy0Var.getMessagesController().blockePeers.keyAt(i10 - gy0Var.f33971r);
                ...
                if (user != null) {
                    if (user.bot) {
                        ...
                        if (str != null && str.length() != 0) {
                            string2 = org.telegram.messenger.vl.h(new StringBuilder("+"), user.phone, gf.b.c());
                        } else {
                            string2 = LocaleController.getString(R.string.NumberUnknown);
                        }
                    }
                    if (i10 != gy0Var.f33972s - 1) {
                        z10 = true;
                    }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        FrameLayout e9Var;
        if (i10 != 0) {
            Context context = this.f33719c;
            if (i10 != 1) {
                if (i10 != 2) {
                    if (i10 != 4) {
                        org.telegram.ui.Cells.m4 m4Var2 = new org.telegram.ui.Cells.m4(this.f33719c, org.telegram.ui.ActionBar.i6.L6, 21, 11, false, null);
                        m4Var2.setHeight(43);
                        m4Var = m4Var2;
                    } else {
            ...
            org.telegram.ui.Cells.b5 b5Var = new org.telegram.ui.Cells.b5(7, 6, this.f33719c, null, true);
