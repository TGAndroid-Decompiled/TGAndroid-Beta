...
public final class fy0 implements Runnable {
    ...
    public final ProfileActivity f33395b;
    public final TLRPC.TL_error f33396c;
    public final TLObject d;
    public final TLRPC.TL_channels_getParticipants e;

    public fy0(ProfileActivity profileActivity, TLRPC.TL_error tL_error, TLObject tLObject, TLRPC.TL_channels_getParticipants tL_channels_getParticipants, int i10) {
        this.f33394a = i10;
        this.f33395b = profileActivity;
        this.f33396c = tL_error;
        this.d = tLObject;
    ...
    public final void run() {
        switch (this.f33394a) {
            case 0:
                ProfileActivity profileActivity = this.f33395b;
                profileActivity.getNotificationCenter().doOnIdle(new fy0(profileActivity, this.f33396c, this.d, this.e, 1));
                return;
            default:
                ProfileActivity profileActivity2 = this.f33395b;
                if (this.f33396c == null) {
                    ...
                    if (this.e.offset == 0) {
                        ...
                        profileActivity2.f31351u2.participants = new TLRPC.TL_chatParticipants();
                        ...
                        profileActivity2.getMessagesStorage().updateChannelUsers(profileActivity2.f31248f1, tL_channels_channelParticipants.participants);
                    }
                    for (int i10 = 0; i10 < tL_channels_channelParticipants.participants.size(); i10++) {
                        ...
                        if (profileActivity2.C1.h(peerId) < 0) {
                            TLRPC.ChatFull chatFull = profileActivity2.f31351u2;
                            if (chatFull.participants == null) {
                                chatFull.participants = new TLRPC.TL_chatParticipants();
                            }
                            profileActivity2.f31351u2.participants.participants.add(tL_chatChannelParticipant);
