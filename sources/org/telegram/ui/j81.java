...
public final class j81 implements t9 {
    public TLObject f34686a = null;
    public TLRPC.TL_error f34687b = null;
    public final SessionsActivity f34688c;

    public j81(SessionsActivity sessionsActivity) {
        this.f34688c = sessionsActivity;
    }
    ...
    public final void K(String str) {
        TLObject tLObject = this.f34686a;
        if (tLObject instanceof TLRPC.TL_authorization) {
            TLRPC.TL_authorization tL_authorization = (TLRPC.TL_authorization) tLObject;
            boolean z10 = tL_authorization.password_pending;
            SessionsActivity sessionsActivity = this.f34688c;
            if (z10) {
                sessionsActivity.f31784f.add(0, tL_authorization);
            ...
            sessionsActivity.f31787s.m(0L, this.f34686a, 11);
        } else if (this.f34687b != null) {
