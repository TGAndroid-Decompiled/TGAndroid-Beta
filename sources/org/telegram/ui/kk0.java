...
public final class kk0 implements org.telegram.ui.Components.oo {
    ...
    public final tk0 f35184c;
    public final boolean d;
    public final int e;
    public final ArrayList f35185f;
    ...
    public final void a() {
        ...
        ArrayList arrayList = notificationsCustomSettingsActivity.f30871w;
        tk0 tk0Var = this.f35184c;
        ArrayList arrayList2 = this.f35185f;
        if (arrayList2 != arrayList && (indexOf = arrayList.indexOf(tk0Var)) >= 0) {
            notificationsCustomSettingsActivity.f30871w.remove(indexOf);
            notificationsCustomSettingsActivity.f30872x.remove(Long.valueOf(tk0Var.d));
        }
        arrayList2.remove(tk0Var);
        if (arrayList2 == notificationsCustomSettingsActivity.f30871w) {
    ...
    public final void b() {
        org.telegram.ui.ActionBar.k kVar;
        NotificationsCustomSettingsActivity notificationsCustomSettingsActivity = this.h;
        if (notificationsCustomSettingsActivity.getMessagesController().isDialogMuted(this.f35182a, 0) != this.f35183b) {
            a();
            return;
        }
        ...
        tk0 tk0Var = this.f35184c;
        sb2.append(tk0Var.d);
        tk0Var.f37743b = notificationsSettings.getBoolean(sb2.toString(), false);
        int i10 = notificationsSettings.getInt("notify2_" + tk0Var.d, 0);
        tk0Var.f37744c = i10;
        if (i10 != 0) {
            int i11 = notificationsSettings.getInt("notifyuntil_" + tk0Var.d, -1);
            if (i11 != -1) {
                tk0Var.f37742a = i11;
            }
        }
        if (this.d) {
            notificationsCustomSettingsActivity.f30871w.add(tk0Var);
            notificationsCustomSettingsActivity.f30872x.put(Long.valueOf(tk0Var.d), tk0Var);
            notificationsCustomSettingsActivity.l0(true);
        } else {
            notificationsCustomSettingsActivity.f30864a.getAdapter().m(this.e);
        }
        kVar = ((org.telegram.ui.ActionBar.n2) notificationsCustomSettingsActivity).actionBar;
        kVar.h(true);
    }
    ...
    public final void n() {
        ...
        long j3 = 0;
        long j10 = this.f35182a;
        notificationsCustomSettingsActivity.getNotificationsController().muteDialog(this.f35182a, j3, !messagesController.isDialogMuted(j10, j3));
    ...
    @Override
    public final void o() {
        long j3 = this.f35182a;
        if (j3 != 0) {
            w11 w11Var = new w11(w.f.e(j3, "dialog_id"), null);
            w11Var.f38747r = new g(this, 28);
    ...
    public final void r() {
        int i10;
        String sharedPrefKey = NotificationsController.getSharedPrefKey(this.f35182a, 0);
        NotificationsCustomSettingsActivity notificationsCustomSettingsActivity = this.h;
    ...
    public final void t(int i10) {
        NotificationsCustomSettingsActivity notificationsCustomSettingsActivity = this.h;
        if (i10 == 0) {
            if (notificationsCustomSettingsActivity.getMessagesController().isDialogMuted(this.f35182a, 0)) {
                n();
            }
            if (org.telegram.ui.Components.vc.a(notificationsCustomSettingsActivity)) {
            ...
            notificationsCustomSettingsActivity.getNotificationsController().muteUntil(this.f35182a, 0, i10);
            if (org.telegram.ui.Components.vc.a(notificationsCustomSettingsActivity)) {
