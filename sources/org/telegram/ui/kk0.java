...
public final class kk0 implements oy, org.telegram.ui.ActionBar.a2, x11 {
    public final NotificationsCustomSettingsActivity f38085a;

    public kk0(NotificationsCustomSettingsActivity notificationsCustomSettingsActivity) {
        this.f38085a = notificationsCustomSettingsActivity;
    }
    ...
    public void g(org.telegram.ui.ActionBar.b2 b2Var, int i10) {
        NotificationsCustomSettingsActivity notificationsCustomSettingsActivity = this.f38085a;
        SharedPreferences.Editor edit = notificationsCustomSettingsActivity.getNotificationsSettings().edit();
        int size = notificationsCustomSettingsActivity.f33482w.size();
        for (int i11 = 0; i11 < size; i11++) {
            wk0 wk0Var = (wk0) notificationsCustomSettingsActivity.f33482w.get(i11);
            if (notificationsCustomSettingsActivity.f33481s == 3) {
        ...
        edit.commit();
        int size2 = notificationsCustomSettingsActivity.f33482w.size();
        for (int i12 = 0; i12 < size2; i12++) {
            notificationsCustomSettingsActivity.getNotificationsController().updateServerNotificationsSettings(((wk0) notificationsCustomSettingsActivity.f33482w.get(i12)).d, 0, false);
        }
        notificationsCustomSettingsActivity.f33482w.clear();
        notificationsCustomSettingsActivity.f33483x.clear();
    ...
    public boolean u(uy uyVar, ArrayList arrayList, CharSequence charSequence, boolean z10, boolean z11, int i10, int i11, eg1 eg1Var) {
        ...
        if (notificationsCustomSettingsActivity.f33481s == 3) {
            ...
            ArrayList arrayList3 = notificationsCustomSettingsActivity.f33482w;
            if (arrayList3 != null) {
            ...
            obj.f42428c = i12;
            if (notificationsCustomSettingsActivity.f33482w == null) {
                notificationsCustomSettingsActivity.f33482w = new ArrayList();
            }
            notificationsCustomSettingsActivity.f33482w.add(obj);
            notificationsCustomSettingsActivity.l0(true);
            return true;
        }
        ...
        y11Var.f42958r = new kk0(notificationsCustomSettingsActivity);
    ...
    public void v(wk0 wk0Var) {
        NotificationsCustomSettingsActivity notificationsCustomSettingsActivity = this.f38085a;
        notificationsCustomSettingsActivity.f33482w.add(0, wk0Var);
        notificationsCustomSettingsActivity.l0(true);
    }
