...
public final class a1 extends View implements DownloadController.FileDownloadProgressListener, org.telegram.ui.Cells.p9 {
    ...
    public final p70 f31939a;
    public final g4 f31940b;
    public b3 f31941c;
    public b3 d;
    public final RadialProgress2 e;
    public final org.telegram.ui.Components.oo0 f31942f;
    public boolean h;
    public int f31943n;
    ...
    public String v;
    public b3 f31946w;
    public StaticLayout f31947x;
    public int f31948y;

    public a1(Context context, p70 p70Var, g4 g4Var) {
        super(context);
        this.f31944r = AndroidUtilities.dp(58.0f);
        this.f31939a = p70Var;
        this.f31940b = g4Var;
    ...
    public final void b() {
        ...
        if (this.L != null && (messageObject = this.M) != null) {
            org.telegram.ui.Components.oo0 oo0Var = this.f31942f;
            if (!oo0Var.e) {
            ...
            if (str == null || !str.equals(formatShortDuration)) {
                ...
                TextPaint textPaint = i4.f34366e1;
                textPaint.setTextSize(AndroidUtilities.dp(16.0f));
                this.f31947x = new StaticLayout(formatShortDuration, textPaint, (int) Math.ceil(textPaint.measureText(formatShortDuration)), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
            }
            i4.f34366e1.setColor(this.f31939a.b());
            invalidate();
        }
    }
    ...
    public final void fillTextLayoutBlocks(ArrayList arrayList) {
        b3 b3Var = this.f31946w;
        if (b3Var != null) {
            arrayList.add(b3Var);
        }
        b3 b3Var2 = this.f31941c;
        if (b3Var2 != null) {
    ...
    public final void onDetachedFromWindow() {
        ...
        DownloadController.getInstance(((i4) this.f31939a).X).removeLoadingFileObserver(this);
        b3 b3Var = this.f31946w;
        if (b3Var != null) {
            b3Var.detach(this);
        }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        p70 p70Var = this.f31939a;
        ((i4) p70Var).getClass();
        int i15 = 0;
        radialProgress2.d = org.telegram.ui.ActionBar.h6.w0(null, i14, false);
        radialProgress2.draw(canvas);
        canvas.save();
        canvas.translate(this.f31948y, this.E);
        this.f31942f.b(canvas);
        canvas.restore();
        if (this.f31947x != null) {
            canvas.save();
            canvas.translate(AndroidUtilities.dp(54.0f) + this.F, AndroidUtilities.dp(6.0f) + this.E);
            this.f31947x.draw(canvas);
            canvas.restore();
        }
        if (this.f31946w != null) {
            canvas.save();
            this.f31946w.f32304s = AndroidUtilities.dp(54.0f) + this.F;
            this.f31946w.v = this.E - AndroidUtilities.dp(16.0f);
            b3 b3Var = this.f31946w;
            canvas.translate(b3Var.f32304s, b3Var.v);
            i4.v(p70Var, canvas, this, 0);
            this.f31946w.draw(canvas, this);
            canvas.restore();
            i15 = 1;
        }
        b3 b3Var2 = this.f31941c;
        int i16 = this.f31944r;
        if (b3Var2 != null) {
            canvas.save();
            b3 b3Var3 = this.f31941c;
            int i17 = this.f31943n;
            b3Var3.f32304s = i17;
            b3Var3.v = i16;
            canvas.translate(i17, i16);
            i4.v(p70Var, canvas, this, i15);
            this.f31941c.draw(canvas, this);
            canvas.restore();
            i15++;
        }
        if (this.d != null) {
            canvas.save();
            b3 b3Var4 = this.d;
            int i18 = this.f31943n;
            b3Var4.f32304s = i18;
            int i19 = this.f31945s;
            b3Var4.v = i16 + i19;
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (this.f31946w != null) {
            sb2.append(", ");
            sb2.append(this.f31946w.d.getText());
        }
        if (this.f31941c != null) {
            sb2.append(", ");
            sb2.append(this.f31941c.d.getText());
        }
        if (this.d != null) {
            sb2.append(", ");
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (pageblockaudio != null) {
            ...
            if (i13 > 0) {
                this.f31943n = AndroidUtilities.dp(18.0f) + AndroidUtilities.dp(i13 * 14);
            } else {
                this.f31943n = AndroidUtilities.dp(18.0f);
            }
            int dp2 = (size - this.f31943n) - AndroidUtilities.dp(18.0f);
            ...
            b3 q6 = i4.q(this.f31939a, this, null, pageblockaudio2.caption.text, dp2, this.f31944r, pageblockaudio2, this.f31940b);
            this.f31941c = q6;
            if (q6 != null) {
                int height = this.f31941c.d.getHeight() + AndroidUtilities.dp(8.0f);
                this.f31945s = height;
            ...
            int i15 = this.f31944r + this.f31945s;
            if (this.f31940b.G) {
            ...
            b3 p5 = i4.p(this.f31939a, this, null, richText, dp2, i15, pageblockaudio3, alignment2, 0, this.f31940b);
            this.d = p5;
            if (p5 != null) {
            ...
            if (TextUtils.isEmpty(musicTitle) && TextUtils.isEmpty(musicAuthor)) {
                ...
                b3 b3Var = new b3(this.f31939a);
                this.f31946w = b3Var;
                b3Var.d = new StaticLayout(ellipsize, i4.f34366e1, dp5, Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
                this.f31946w.f32302n = this.K;
                this.E = AndroidUtilities.dp(11.0f) + ((dp3 - AndroidUtilities.dp(30.0f)) / 2) + this.G;
            }
            this.f31942f.j(dp5, AndroidUtilities.dp(30.0f));
        } else {
            i12 = 1;
        }
