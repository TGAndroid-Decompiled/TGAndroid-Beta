...
public final class a1 extends View implements DownloadController.FileDownloadProgressListener, org.telegram.ui.Cells.p9 {
    ...
    public final v70 f34306a;
    public final g4 f34307b;
    public b3 f34308c;
    public b3 d;
    public final RadialProgress2 f34309e;
    public final org.telegram.ui.Components.bo0 f34310f;
    public boolean h;
    public int f34311n;
    public final int f34312r;
    public int f34313s;
    public String v;
    public b3 f34314w;
    public StaticLayout f34315x;
    public int f34316y;

    public a1(Context context, v70 v70Var, g4 g4Var) {
        super(context);
        this.f34312r = AndroidUtilities.dp(58.0f);
        this.f34306a = v70Var;
        this.f34307b = g4Var;
        RadialProgress2 radialProgress2 = new RadialProgress2(this, null);
        this.f34309e = radialProgress2;
    ...
    public final void a(boolean z10) {
        ...
        RadialProgress2 radialProgress2 = this.f34309e;
        if (isEmpty) {
    ...
    public final void b() {
        ...
        if (this.L != null && (messageObject = this.M) != null) {
            org.telegram.ui.Components.bo0 bo0Var = this.f34310f;
            if (!bo0Var.f24785e) {
            ...
            if (str == null || !str.equals(formatShortDuration)) {
                ...
                TextPaint textPaint = i4.f37219e1;
                textPaint.setTextSize(AndroidUtilities.dp(16.0f));
                this.f34315x = new StaticLayout(formatShortDuration, textPaint, (int) Math.ceil(textPaint.measureText(formatShortDuration)), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
            }
            i4.f37219e1.setColor(this.f34306a.b());
            invalidate();
        }
    }
    ...
    public final void fillTextLayoutBlocks(ArrayList arrayList) {
        b3 b3Var = this.f34314w;
        if (b3Var != null) {
            arrayList.add(b3Var);
        }
        b3 b3Var2 = this.f34308c;
        if (b3Var2 != null) {
    ...
    public final void onDetachedFromWindow() {
        ...
        DownloadController.getInstance(((i4) this.f34306a).X).removeLoadingFileObserver(this);
        b3 b3Var = this.f34314w;
        if (b3Var != null) {
            b3Var.detach(this);
        }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        int i10 = org.telegram.ui.ActionBar.j6.f20789ie;
        int i11 = org.telegram.ui.ActionBar.j6.f20807je;
        int i12 = org.telegram.ui.ActionBar.j6.f21006uc;
        int i13 = org.telegram.ui.ActionBar.j6.f21023vc;
        RadialProgress2 radialProgress2 = this.f34309e;
        radialProgress2.g(i10, i11, i12, i13);
        int i14 = org.telegram.ui.ActionBar.j6.Bd;
        v70 v70Var = this.f34306a;
        ((i4) v70Var).getClass();
        int i15 = 0;
        radialProgress2.d = org.telegram.ui.ActionBar.j6.w0(null, i14, false);
        radialProgress2.draw(canvas);
        canvas.save();
        canvas.translate(this.f34316y, this.E);
        this.f34310f.b(canvas);
        canvas.restore();
        if (this.f34315x != null) {
            canvas.save();
            canvas.translate(AndroidUtilities.dp(54.0f) + this.F, AndroidUtilities.dp(6.0f) + this.E);
            this.f34315x.draw(canvas);
            canvas.restore();
        }
        if (this.f34314w != null) {
            canvas.save();
            this.f34314w.f34645s = AndroidUtilities.dp(54.0f) + this.F;
            this.f34314w.v = this.E - AndroidUtilities.dp(16.0f);
            b3 b3Var = this.f34314w;
            canvas.translate(b3Var.f34645s, b3Var.v);
            i4.v(v70Var, canvas, this, 0);
            this.f34314w.draw(canvas, this);
            canvas.restore();
            i15 = 1;
        }
        b3 b3Var2 = this.f34308c;
        int i16 = this.f34312r;
        if (b3Var2 != null) {
            canvas.save();
            b3 b3Var3 = this.f34308c;
            int i17 = this.f34311n;
            b3Var3.f34645s = i17;
            b3Var3.v = i16;
            canvas.translate(i17, i16);
            i4.v(v70Var, canvas, this, i15);
            this.f34308c.draw(canvas, this);
            canvas.restore();
            i15++;
        }
        if (this.d != null) {
            canvas.save();
            b3 b3Var4 = this.d;
            int i18 = this.f34311n;
            b3Var4.f34645s = i18;
            int i19 = this.f34313s;
            b3Var4.v = i16 + i19;
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (this.f34314w != null) {
            sb2.append(", ");
            sb2.append(this.f34314w.d.getText());
        }
        if (this.f34308c != null) {
            sb2.append(", ");
            sb2.append(this.f34308c.d.getText());
        }
        if (this.d != null) {
            sb2.append(", ");
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (pageblockaudio != null) {
            ...
            if (i13 > 0) {
                this.f34311n = AndroidUtilities.dp(18.0f) + AndroidUtilities.dp(i13 * 14);
            } else {
                this.f34311n = AndroidUtilities.dp(18.0f);
            }
            int dp2 = (size - this.f34311n) - AndroidUtilities.dp(18.0f);
            int dp3 = AndroidUtilities.dp(44.0f);
            this.F = AndroidUtilities.dp(16.0f);
            int dp4 = AndroidUtilities.dp(5.0f);
            this.G = dp4;
            int i14 = this.F;
            this.f34309e.q(i14, dp4, i14 + dp3, dp4 + dp3);
            TL_iv.pageBlockAudio pageblockaudio2 = this.K;
            b3 q6 = i4.q(this.f34306a, this, null, pageblockaudio2.caption.text, dp2, this.f34312r, pageblockaudio2, this.f34307b);
            this.f34308c = q6;
            if (q6 != null) {
                int height = this.f34308c.d.getHeight() + AndroidUtilities.dp(8.0f);
                this.f34313s = height;
            ...
            int i15 = this.f34312r + this.f34313s;
            if (this.f34307b.G) {
            ...
            b3 p5 = i4.p(this.f34306a, this, null, richText, dp2, i15, pageblockaudio3, alignment2, 0, this.f34307b);
            this.d = p5;
            if (p5 != null) {
            ...
            if (TextUtils.isEmpty(musicTitle) && TextUtils.isEmpty(musicAuthor)) {
                ...
                b3 b3Var = new b3(this.f34306a);
                this.f34314w = b3Var;
                b3Var.d = new StaticLayout(ellipsize, i4.f37219e1, dp5, Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
                this.f34314w.f34643n = this.K;
                this.E = AndroidUtilities.dp(11.0f) + ((dp3 - AndroidUtilities.dp(30.0f)) / 2) + this.G;
            }
            this.f34310f.j(dp5, AndroidUtilities.dp(30.0f));
        } else {
            i12 = 1;
        }
    ...
    public final void onProgressDownload(String str, long j3, long j10) {
        this.f34309e.o(Math.min(1.0f, ((float) j3) / ((float) j10)), true);
        if (this.H != 3) {
            a(true);
        }
    }
