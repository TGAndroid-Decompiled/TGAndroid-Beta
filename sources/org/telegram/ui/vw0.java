...
public final class vw0 extends org.telegram.ui.ActionBar.o2 {
    ...
    public org.telegram.ui.Cells.z7 f38513b;
    public org.telegram.ui.Components.v80 f38514c;
    public org.telegram.ui.Components.f61 d;
    public org.telegram.ui.Components.pr e;
    public org.telegram.ui.ActionBar.w0 f38515f;
    public final boolean h;
    public final long f38516n;
    public boolean f38517r;
    public long f38518s;
    public no v;
    public boolean f38519w;
    ...
    public final void V(boolean z10) {
        ...
        float f11;
        float f12;
        if (this.f38515f == null || this.f38519w == (X = X())) {
            return;
        }
        this.f38519w = X;
        this.f38515f.setEnabled(X);
        float f13 = 0.0f;
        if (z10) {
            ViewPropertyAnimator animate = this.f38515f.animate();
            if (X) {
                f11 = 1.0f;
            } else {
                f11 = 0.0f;
        ...
        org.telegram.ui.ActionBar.w0 w0Var = this.f38515f;
        if (X) {
            f7 = 1.0f;
        } else {
            f7 = 0.0f;
        ...
        w0Var.setAlpha(f7);
        org.telegram.ui.ActionBar.w0 w0Var2 = this.f38515f;
        if (X) {
            f10 = 1.0f;
        } else {
            f10 = 0.0f;
        ...
        org.telegram.ui.ActionBar.w0 w0Var3 = this.f38515f;
        if (X) {
            f13 = 1.0f;
        }
    ...
    public final String W() {
        ...
        return LocaleController.formatString(R.string.PostSuggestionsPriceInfo2, ei.l.G0(i10), String.valueOf(((int) (((((float) this.f38518s) * (i10 / 1000.0f)) / 1000.0d) * getMessagesController().starsUsdWithdrawRate1000)) / 100.0d));
    }

    public final boolean X() {
        if (this.f38518s == this.f38516n && this.f38517r == this.h) {
            return false;
        }
        return true;
    }
        ...
        if (this.e.f27117c <= 0.0f) {
            ...
            if (chat != null) {
                ...
                if (chat2 != null) {
                    if (this.f38517r) {
                        chat2.flags2 |= 16384;
                        chat2.send_paid_messages_stars = this.f38518s;
                    } else {
                        chat2.flags2 &= -16385;
    ...
    public final View createView(Context context) {
        ...
        this.f38515f = this.actionBar.n().i(AndroidUtilities.dp(56.0f), LocaleController.getString(R.string.Done), this.e);
        V(false);
        ...
        this.f38514c.setBackgroundColor(getThemedColor(i11));
        this.f38514c.b(true);
        this.f38514c.d(0, null, false);
    ...
    public final boolean onBackPressed(boolean z10) {
        if (X()) {
            if (z10) {
                ...
                alertDialog$Builder.f18446a.T = LocaleController.getString(R.string.MessageSuggestionsUnsavedChanges);
