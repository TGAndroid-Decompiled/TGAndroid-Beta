...
public final class lk0 implements Runnable {
    ...
    public final NotificationsCustomSettingsActivity f38401b;
    public final View f38402c;
    public final int d;

    public lk0(NotificationsCustomSettingsActivity notificationsCustomSettingsActivity, View view, int i10, int i11) {
        this.f38400a = i11;
        this.f38401b = notificationsCustomSettingsActivity;
        this.f38402c = view;
        this.d = i10;
    }
    ...
    public final void run() {
        switch (this.f38400a) {
            case 0:
                NotificationsCustomSettingsActivity notificationsCustomSettingsActivity = this.f38401b;
                ...
                return;
            case 1:
                NotificationsCustomSettingsActivity notificationsCustomSettingsActivity2 = this.f38401b;
                ArrayList arrayList2 = notificationsCustomSettingsActivity2.I;
                View view2 = this.f38402c;
                if (view2 instanceof org.telegram.ui.Cells.ea) {
                    int i11 = this.d;
                    if (i11 >= 0 && i11 < arrayList2.size()) {
                        ((qk0) arrayList2.get(i11)).f39899f = notificationsCustomSettingsActivity2.g0();
                    }
                ...
                return;
            default:
                NotificationsCustomSettingsActivity notificationsCustomSettingsActivity3 = this.f38401b;
                ArrayList arrayList3 = notificationsCustomSettingsActivity3.I;
                View view3 = this.f38402c;
                if (view3 instanceof org.telegram.ui.Cells.ea) {
                    int i12 = this.d;
                    if (i12 >= 0 && i12 < arrayList3.size()) {
                        ((qk0) arrayList3.get(i12)).f39899f = notificationsCustomSettingsActivity3.h0();
                    }
