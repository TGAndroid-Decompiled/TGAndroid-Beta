...
public final class lk0 implements Runnable {
    ...
    public final NotificationsCustomSettingsActivity f38429b;
    public final View f38430c;
    public final int d;

    public lk0(NotificationsCustomSettingsActivity notificationsCustomSettingsActivity, View view, int i10, int i11) {
        this.f38428a = i11;
        this.f38429b = notificationsCustomSettingsActivity;
        this.f38430c = view;
        this.d = i10;
    }
    ...
    public final void run() {
        switch (this.f38428a) {
            case 0:
                NotificationsCustomSettingsActivity notificationsCustomSettingsActivity = this.f38429b;
                ArrayList arrayList = notificationsCustomSettingsActivity.I;
                View view = this.f38430c;
                ...
                return;
            case 1:
                NotificationsCustomSettingsActivity notificationsCustomSettingsActivity2 = this.f38429b;
                ArrayList arrayList2 = notificationsCustomSettingsActivity2.I;
                View view2 = this.f38430c;
                if (view2 instanceof org.telegram.ui.Cells.ea) {
                    int i11 = this.d;
                    if (i11 >= 0 && i11 < arrayList2.size()) {
                        ((qk0) arrayList2.get(i11)).f39927f = notificationsCustomSettingsActivity2.g0();
                    }
                ...
                return;
            default:
                NotificationsCustomSettingsActivity notificationsCustomSettingsActivity3 = this.f38429b;
                ArrayList arrayList3 = notificationsCustomSettingsActivity3.I;
                View view3 = this.f38430c;
                if (view3 instanceof org.telegram.ui.Cells.ea) {
                    int i12 = this.d;
                    if (i12 >= 0 && i12 < arrayList3.size()) {
                        ((qk0) arrayList3.get(i12)).f39927f = notificationsCustomSettingsActivity3.h0();
                    }
