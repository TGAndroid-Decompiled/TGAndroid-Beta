    ...
    public void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        switch (this.Q) {
            ...
            case 1:
                ...
                int measuredHeight4 = (measuredHeight3 - qx0Var.d.f31503v0.getMeasuredHeight()) / 2;
                org.telegram.ui.Components.w9 w9Var2 = qx0Var.d.f31503v0;
                w9Var2.layout(dp2, measuredHeight4, w9Var2.getMeasuredWidth() + dp2, qx0Var.d.f31503v0.getMeasuredHeight() + measuredHeight4);
                return;
            default:
                super.onLayout(z10, i10, i11, i12, i13);
                return;
    ...
    public void onMeasure(int i10, int i11) {
        switch (this.Q) {
            ...
            case 1:
                super.onMeasure(i10, i11);
                qx0 qx0Var = (qx0) this.R;
                qx0Var.d.f31503v0.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(30.0f), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(30.0f), 1073741824));
                qx0Var.d.f31503v0.setRoundRadius(AndroidUtilities.dp(30.0f));
                return;
            default:
                super.onMeasure(i10, i11);
                return;
