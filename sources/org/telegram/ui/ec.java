...
public final class ec implements Utilities.Callback3 {
    public final bd f36023a;
    public final int f36024b;
    public final View f36025c;
    ...
    public final void run(Object obj, Object obj2, Object obj3) {
        ...
        bd bdVar = this.f36023a;
        int i10 = bdVar.U;
        int i11 = this.f36024b;
        if (i11 == i10) {
            bdVar.f34779n = l4.longValue();
            bdVar.a1(true);
        } else if (i11 == bdVar.f34767c0) {
            bdVar.f34791w = l4.longValue();
            bdVar.b1();
        } else if (i11 == bdVar.f34772f0) {
            if (l4.longValue() == 0) {
                bdVar.f34795y = null;
                ...
                bdVar.f34795y = emojiStatusCollectibleFromGift;
                bdVar.f34786s = -1;
                bdVar.f34791w = 0L;
            } else {
                ...
                bdVar.f34795y = tL_emojiStatus;
            }
            bdVar.b1();
        }
        bdVar.X0(true);
        pc pcVar = (pc) this.f36025c;
