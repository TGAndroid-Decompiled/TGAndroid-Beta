...
public final class n1 implements org.telegram.ui.Components.a91 {
    ...
    public final void c(float f7) {
        this.f35924a.f37363x.R.a(f7, 0);
    }

    @Override
    public final void d() {
        this.f35924a.f37355a.setVisibility(0);
        this.f35924a.f37356b.setVisibility(4);
        this.f35924a.f37356b.g(null, null, null, null, false);
        HashMap hashMap = new HashMap();
        hashMap.put("Referer", ApplicationLoader.applicationContext.getPackageName());
        s1 s1Var = this.f35924a;
        s1Var.f37355a.loadUrl(s1Var.v.url, hashMap);
    }

    @Override
    public final void e(org.telegram.ui.Components.d91 d91Var, boolean z10) {
        h4 h4Var = this.f35924a.f37363x;
        if (z10) {
