        ...
        switch (this.f37495a) {
            case 0:
                ...
                if (qyVar.a4() && (arrayList = qyVar.D2) != null && !arrayList.isEmpty() && qyVar.getParentActivity() != null) {
                    ...
                    PhotoViewer.t1().f31325p7 = true;
                    PhotoViewer.t1().f31333q7 = charSequence;
            ...
            case 5:
                ...
                return;
            case 6:
                this.f37496b.b4(true);
                return;
            case 7:
                this.f37496b.finishPreviewFragment();
                return;
            case 8:
                qy qyVar7 = this.f37496b;
                qyVar7.f37138z0.setIsEditing(false);
                qyVar7.I4(false);
                return;
            case 9:
                qy qyVar8 = this.f37496b;
                qyVar8.getClass();
                qyVar8.showDialog(new rg.x0((org.telegram.ui.ActionBar.m2) qyVar8, 2, true));
                return;
            case 10:
                qy qyVar9 = this.f37496b;
                qyVar9.getContactsController().loadGlobalPrivacySetting();
                qyVar9.K4();
                return;
            case 11:
                this.f37496b.p4(view);
                return;
            case 12:
                qy.t0(this.f37496b);
                return;
            ...
            case 14:
                ...
                return;
            case 15:
                qy qyVar10 = this.f37496b;
                qyVar10.showDialog(org.telegram.ui.Components.e5.m(qyVar10.getParentActivity(), LocaleController.getString(R.string.EditProfileBirthdayTitle), LocaleController.getString(R.string.EditProfileBirthdayButton), null, new uv(qyVar10, 1), new lv(qyVar10, 17), false, false, qyVar10.getResourceProvider()).f19950a);
                return;
            case 16:
                qy.C0(this.f37496b);
                return;
            ...
            case 18:
                ...
                premiumPreviewFragment.f31455j0 = true;
                qy qyVar11 = this.f37496b;
