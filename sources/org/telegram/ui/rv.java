        ...
        switch (this.f37494a) {
            case 0:
                ...
                if (qyVar.a4() && (arrayList = qyVar.D2) != null && !arrayList.isEmpty() && qyVar.getParentActivity() != null) {
                    ...
                    PhotoViewer.t1().f31324p7 = true;
                    PhotoViewer.t1().f31332q7 = charSequence;
            ...
            case 5:
                ...
                return;
            case 6:
                this.f37495b.b4(true);
                return;
            case 7:
                this.f37495b.finishPreviewFragment();
                return;
            case 8:
                qy qyVar7 = this.f37495b;
                qyVar7.f37137z0.setIsEditing(false);
                qyVar7.I4(false);
                return;
            case 9:
                qy qyVar8 = this.f37495b;
                qyVar8.getClass();
                qyVar8.showDialog(new rg.x0((org.telegram.ui.ActionBar.m2) qyVar8, 2, true));
                return;
            case 10:
                qy qyVar9 = this.f37495b;
                qyVar9.getContactsController().loadGlobalPrivacySetting();
                qyVar9.K4();
                return;
            case 11:
                this.f37495b.p4(view);
                return;
            case 12:
                qy.t0(this.f37495b);
                return;
            ...
            case 18:
                ...
                premiumPreviewFragment.f31454j0 = true;
                qy qyVar11 = this.f37495b;
