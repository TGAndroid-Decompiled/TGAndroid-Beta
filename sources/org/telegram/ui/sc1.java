...
public final class sc1 extends org.telegram.ui.Components.ml0 {
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        if (view instanceof org.telegram.ui.Cells.t1) {
            ...
            if (avatarImage != null) {
                ...
                xd1 xd1Var = this.Z2;
                if (m32 && (U = xd1Var.f39590u0.U(view)) != null) {
                    if (xd1Var.f39590u0.L(U.b() - 1) != null) {
                ...
                int measuredHeight = xd1Var.f39590u0.getMeasuredHeight() - xd1Var.f39590u0.getPaddingBottom();
                if (layoutHeight > measuredHeight) {
                    layoutHeight = measuredHeight;
                }
                if (t1Var.n3() && (r11 = xd1Var.f39590u0.U(view)) != null) {
                    int i10 = 0;
                    while (i10 < 20) {
                        i10++;
                        s4.c1 U2 = xd1Var.f39590u0.L(U2.b() + 1);
                        if (U2 == null) {
                            break;
                        }
                        View view2 = U2.f42702a;
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        xd1 xd1Var = this.Z2;
        if (action == 1) {
            if (!xd1Var.f39583r0 && (xd1Var.B1 instanceof fj1) && xd1Var.L0[0].getVisibility() == 0) {
                xd1Var.f1(0, false, true);
            }
            xd1Var.f39583r0 = false;
        }
        if (xd1Var.a2) {
