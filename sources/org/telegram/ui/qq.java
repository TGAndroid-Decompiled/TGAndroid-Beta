...
public class qq extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public pq f39933a;
    public int f39934a0;
    public final boolean f39935a1;
    public bi.o0 f39936b;
    public int f39937b0;
    public ValueAnimator f39938b1;
    public hg.b0 f39939c;
    public int f39940c0;
    public ValueAnimator f39941c1;
    public FrameLayout d;
    public int f39942d0;
    public FrameLayout f39943e;
    public int f39944e0;
    public org.telegram.ui.Components.q6 f39945f;
    public int f39946f0;
    public int f39947g0;
    ...
    public int f39964v0;
    public TLRPC.Chat f39965w;
    public int f39966w0;
    public TLRPC.ChatFull f39967x;
    public int f39968x0;
    public final int f39969y;
    public int f39970y0;
    public int f39971z0;
    ...
    public qq(long j3, long j10, TLRPC.TL_chatAdminRights tL_chatAdminRights, TLRPC.TL_chatBannedRights tL_chatBannedRights, TLRPC.TL_chatBannedRights tL_chatBannedRights2, String str, int i10, boolean z10, boolean z11, String str2) {
        ...
        this.O0 = z37;
        this.Y0 = str2;
        this.f39965w = getMessagesController().getChat(Long.valueOf(this.f39960s));
        this.f39967x = getMessagesController().getChatFull(this.f39960s);
        ...
        this.S = str3;
        this.T = str3;
        this.F = ChatObject.isCommunity(this.f39965w);
        TLRPC.Chat chat2 = this.f39965w;
        if (chat2 != null) {
            if (ChatObject.isChannel(chat2) && !this.f39965w.megagroup) {
                z35 = true;
            } else {
                z35 = false;
            }
            this.E = z35;
            this.G = ChatObject.isForum(this.f39965w);
            this.N = this.f39965w.admin_rights;
        }
        if (this.N == null) {
            if (i10 == 2 && ((chat = this.f39965w) == null || !chat.creator)) {
                z34 = false;
            } else {
                z34 = true;
            }
    ...
    public static void U(qq qqVar, long j3) {
        if (j3 != 0) {
            qqVar.f39960s = j3;
            qqVar.f39965w = MessagesController.getInstance(qqVar.currentAccount).getChat(Long.valueOf(j3));
            qqVar.r0(true);
        }
    }
    ...
    public static boolean W(qq qqVar, TLRPC.TL_error tL_error) {
        ...
        if (tL_error != null && "USER_PRIVACY_RESTRICTED".equals(tL_error.text)) {
            if (!ChatObject.isChannel(qqVar.f39965w)) {
                ...
                k0Var.I1(qqVar.f39965w, arrayList, null, null, null);
                k0Var.show();
            }
            return false;
        }
            ...
            if (qqVar.getParentActivity() != null) {
                if ("PASSWORD_HASH_INVALID".equals(tL_error.text)) {
                    if (inputCheckPasswordSRP == null) {
                        ...
                        b2Var.T = AndroidUtilities.replaceTags(LocaleController.formatString(R.string.EditAdminTransferReadyAlertText, qqVar.f39965w.title, UserObject.getFirstName(user)));
    ...
    public static void Z(qq qqVar, long j3) {
        long j10;
        TLRPC.User user;
        TLRPC.ChatFull chatFull = qqVar.f39967x;
        if (chatFull != null) {
    ...
    public final View createView(Context context) {
        ...
        if (this.I || (!this.E && this.f39965w.creator && UserObject.isUserSelf(this.v))) {
            org.telegram.ui.ActionBar.z n10 = this.actionBar.n();
            Drawable mutate = context.getResources().getDrawable(R.drawable.ic_ab_done).mutate();
            int i12 = org.telegram.ui.ActionBar.j6.f20992v8;
        ...
        u7Var.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20607a7, false));
        ...
        this.f39939c = b0Var;
        b0Var.E = 100;
        this.f39936b.setLayoutManager(b0Var);
        bi.o0 o0Var2 = this.f39936b;
        pq pqVar = new pq(this, context);
        this.f39933a = pqVar;
        o0Var2.setAdapter(pqVar);
        s4.j jVar = new s4.j();
        if (i11 == 2) {
            this.f39936b.setResetSelectorOnChanged(false);
        }
        jVar.f45777m = false;
        jVar.C = false;
        jVar.o(org.telegram.ui.Components.pr.h);
        jVar.n(350L);
        this.f39936b.setItemAnimator(jVar);
        bi.o0 o0Var3 = this.f39936b;
        if (!LocaleController.isRTL) {
            i10 = 2;
        }
        o0Var3.setVerticalScrollbarPosition(i10);
        frameLayout.addView(this.f39936b, w7.x5.c(-1.0f, -1));
        this.f39936b.o1();
        this.actionBar.setAdaptiveBackground(this.f39936b);
        this.f39936b.setOnScrollListener(new i3(this, 6));
        this.f39936b.setOnItemClickListener(new bi.x5(7, this, context));
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.chatInfoDidLoad) {
            ...
            TLRPC.Chat chat = this.f39965w;
            if (chat != null && chatFull.f19870id == chat.f19869id) {
                this.f39967x = chatFull;
                n0();
            }
        } else if (i10 == NotificationCenter.dialogDeleted) {
            if ((-this.f39960s) == ((Long) objArr[0]).longValue()) {
    ...
    public final ArrayList getThemeDescriptions() {
        ArrayList arrayList = new ArrayList();
        e eVar = new e(this, 9);
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f39936b, 16, new Class[]{org.telegram.ui.Cells.ya.class, org.telegram.ui.Cells.ea.class, org.telegram.ui.Cells.v8.class, org.telegram.ui.Cells.l4.class, org.telegram.ui.Cells.c9.class, org.telegram.ui.Cells.c6.class}, null, null, null, org.telegram.ui.ActionBar.j6.f20663d6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f39936b, 32768, null, null, null, null, i10));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f39936b, 4096, null, null, null, null, org.telegram.ui.ActionBar.j6.f20753i6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f39936b, 0, new Class[]{View.class}, org.telegram.ui.ActionBar.j6.f20785k0, null, null, org.telegram.ui.ActionBar.j6.f20664d7));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f39936b, 0, new Class[]{org.telegram.ui.Cells.e9.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.B6));
        int i11 = org.telegram.ui.ActionBar.j6.f20880p7;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f39936b, 262144, new Class[]{org.telegram.ui.Cells.ea.class}, new String[]{"textView"}, null, null, -1, null, i11));
        int i12 = org.telegram.ui.ActionBar.j6.G6;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f39936b, 262144, new Class[]{org.telegram.ui.Cells.ea.class}, new String[]{"textView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f39936b, 0, new Class[]{org.telegram.ui.Cells.ea.class}, new String[]{"valueTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.I6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f39936b, 0, new Class[]{org.telegram.ui.Cells.ea.class}, new String[]{"valueImageView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f20827m6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f39936b, 0, new Class[]{org.telegram.ui.Cells.c9.class}, new String[]{"textView"}, null, null, -1, null, i12));
        int i13 = org.telegram.ui.ActionBar.j6.f21061z6;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f39936b, 0, new Class[]{org.telegram.ui.Cells.c9.class}, new String[]{"valueTextView"}, null, null, -1, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f39936b, 0, new Class[]{org.telegram.ui.Cells.v8.class}, new String[]{"textView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f39936b, 0, new Class[]{org.telegram.ui.Cells.v8.class}, new String[]{"valueTextView"}, null, null, -1, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f39936b, 0, new Class[]{org.telegram.ui.Cells.v8.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.U6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f39936b, 0, new Class[]{org.telegram.ui.Cells.v8.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.V6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f39936b, 0, new Class[]{org.telegram.ui.Cells.l4.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.L6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f39936b, 262144, new Class[]{org.telegram.ui.Cells.l4.class}, new String[]{"textView2"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f39936b, 262144, new Class[]{org.telegram.ui.Cells.l4.class}, new String[]{"textView2"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.A6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f39936b, 4, new Class[]{org.telegram.ui.Cells.c6.class}, new String[]{"textView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f39936b, 8388608, new Class[]{org.telegram.ui.Cells.c6.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.H6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f39936b, 0, new Class[]{org.telegram.ui.Cells.ya.class}, new String[]{"nameTextView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f39936b, 0, new Class[]{org.telegram.ui.Cells.ya.class}, new String[]{"statusColor"}, null, null, -1, eVar, org.telegram.ui.ActionBar.j6.f21042y6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f39936b, 0, new Class[]{org.telegram.ui.Cells.ya.class}, new String[]{"statusOnlineColor"}, null, null, -1, eVar, org.telegram.ui.ActionBar.j6.f20846n6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f39936b, 0, new Class[]{org.telegram.ui.Cells.ya.class}, null, org.telegram.ui.ActionBar.j6.f20910r0, null, org.telegram.ui.ActionBar.j6.J7));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(null, 0, new Class[]{org.telegram.ui.Cells.t2.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f20770j5));
        arrayList.add(new org.telegram.ui.ActionBar.l6(null, 0, new Class[]{org.telegram.ui.Cells.t2.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f20897q5));
        ...
        if (i10 != 2) {
            ...
            if (!equals) {
                if (z10) {
                    ...
                    org.telegram.ui.ActionBar.b2 b2Var = alertDialog$Builder.f20198a;
                    b2Var.R = string;
                    b2Var.T = AndroidUtilities.replaceTags(LocaleController.formatString("UserRestrictionsApplyChangesText", R.string.UserRestrictionsApplyChangesText, MessagesController.getInstance(this.currentAccount).getChat(Long.valueOf(this.f39960s)).title));
    ...
    public final void n0() {
        ...
        TLRPC.User user;
        long j3;
        int i10 = this.f39951k0;
        if (i10 >= 0) {
            org.telegram.ui.Cells.v8 v8Var = (org.telegram.ui.Cells.v8) this.f39939c.m(i10);
            if (v8Var != null) {
                TLRPC.ChatFull chatFull = this.f39967x;
    ...
    public final void p0(TLRPC.InputCheckPasswordSRP inputCheckPasswordSRP, TwoStepVerificationActivity twoStepVerificationActivity) {
        ...
        if (inputCheckPasswordSRP != null && !ChatObject.isChannel(this.f39965w)) {
            MessagesController.getInstance(this.currentAccount).convertToMegaGroup(getParentActivity(), this.f39960s, this, new b7(this, inputCheckPasswordSRP, twoStepVerificationActivity, 10));
            return;
        }
        TLRPC.TL_channels_editCreator tL_channels_editCreator = new TLRPC.TL_channels_editCreator();
        if (ChatObject.isChannel(this.f39965w)) {
    ...
    public final void t0(boolean z10) {
        float f7;
        ValueAnimator valueAnimator = this.f39938b1;
        ...
        if (orVar != null) {
            ...
            this.f39938b1 = ofFloat;
            ofFloat.addUpdateListener(new hq(this, 0));
            this.f39938b1.addListener(new s0(this, 27));
            this.f39938b1.setDuration(Math.abs(this.h.f29171c - (this.H ? 1.0f : 0.0f)) * 150.0f);
            this.f39938b1.start();
        }
    }
    ...
    public final void u0(boolean z10) {
        int i10;
        int min = Math.min(this.f39961s0, this.f39962t0);
        this.W = -1;
        this.X = -1;
        this.Y = -1;
        this.Z = -1;
        ...
        if (z14) {
            ...
            if (!z12 && (!this.S.isEmpty() || (this.f39965w.creator && UserObject.isUserSelf(user)))) {
                int i32 = this.V;
                this.f39955o0 = i32;
                this.V = i32 + 2;
                this.f39964v0 = i32 + 1;
                if (this.f39965w.creator && UserObject.isUserSelf(user)) {
                    int i33 = this.V;
                    this.V = i33 + 1;
                    this.f39966w0 = i33;
                } else {
        ...
        if (z10) {
            if (min == -1 && (i10 = this.f39961s0) != -1) {
                this.f39933a.s(Math.min(i10, this.f39962t0), 2);
            } else if (min != -1 && this.f39961s0 == -1) {
                this.f39933a.t(min, 2);
            }
        }
    }
}
