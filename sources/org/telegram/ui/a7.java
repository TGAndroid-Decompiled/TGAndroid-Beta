...
public final class a7 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    public u6 f35046a;
    public final org.telegram.ui.ActionBar.g6 f35047b;
    public final TextView f35048c;
    public final org.telegram.ui.Components.k6 d;
    public final org.telegram.ui.Components.p9 f35049e;
    public boolean f35050f;
    public boolean h;
    public org.telegram.ui.Components.np f35051n;
    ...
    public a7(Context context, org.telegram.ui.ActionBar.g6 g6Var) {
        ...
        this.f35049e = p9Var;
        p9Var.getAvatarDrawable().f33847p = 0.8f;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        TextView textView;
        if (i10 == NotificationCenter.emojiLoaded && (textView = this.f35048c) != null) {
            textView.invalidate();
        }
    }
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        sb.append((Object) this.f35048c.getText());
    ...
    public final void onMeasure(int i10, int i11) {
        setMeasuredDimension(View.MeasureSpec.getSize(i10), AndroidUtilities.dp(50.0f) + (this.f35050f ? 1 : 0));
        int measuredWidth = ((getMeasuredWidth() - getPaddingLeft()) - getPaddingRight()) - AndroidUtilities.dp(34.0f);
        int i12 = measuredWidth / 2;
        org.telegram.ui.Components.p9 p9Var = this.f35049e;
        ...
        org.telegram.ui.Components.np npVar = this.f35051n;
        if (npVar != null) {
