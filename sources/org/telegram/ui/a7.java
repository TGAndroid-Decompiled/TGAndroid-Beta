...
public final class a7 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    public u6 f32470a;
    public final org.telegram.ui.ActionBar.f6 f32471b;
    public final TextView f32472c;
    public final org.telegram.ui.Components.k6 d;
    public final org.telegram.ui.Components.p9 e;
    public boolean f32473f;
    public boolean h;
    public org.telegram.ui.Components.lp f32474n;
    ...
    public a7(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.e = p9Var;
        p9Var.getAvatarDrawable().f31276p = 0.8f;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        TextView textView;
        if (i10 == NotificationCenter.emojiLoaded && (textView = this.f32472c) != null) {
            textView.invalidate();
        }
    }
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        sb.append((Object) this.f32472c.getText());
    ...
    public final void onMeasure(int i10, int i11) {
        setMeasuredDimension(View.MeasureSpec.getSize(i10), AndroidUtilities.dp(50.0f) + (this.f32473f ? 1 : 0));
        ...
        org.telegram.ui.Components.lp lpVar = this.f32474n;
        if (lpVar != null) {
