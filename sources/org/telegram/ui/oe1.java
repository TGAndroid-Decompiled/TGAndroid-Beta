    ...
    public final void b(int i10) {
        ...
        if (i10 == 1) {
            ...
            if (TextUtils.isEmpty(obj)) {
                ...
                tL_messages_createForumTopic.peer = se1Var.getMessagesController().getInputPeer(se1Var.f37707a);
            ...
            if (!se1Var.f37714w.title.equals(str) || se1Var.f37714w.icon_emoji_id != se1Var.f37708b) {
                TL_forum.TL_messages_editForumTopic tL_messages_editForumTopic = new TL_forum.TL_messages_editForumTopic();
                tL_messages_editForumTopic.peer = se1Var.getMessagesController().getInputPeer(se1Var.f37707a);
                TLRPC.TL_forumTopic tL_forumTopic = se1Var.f37714w;
                tL_messages_editForumTopic.topic_id = tL_forumTopic.f18373id;
                if (!tL_forumTopic.title.equals(str)) {
                    tL_messages_editForumTopic.title = str;
                    tL_messages_editForumTopic.flags |= 1;
                }
                long j10 = se1Var.f37714w.icon_emoji_id;
                long j11 = se1Var.f37708b;
                if (j10 != j11) {
            ...
            if (se1Var.d != null) {
                TLRPC.TL_forumTopic tL_forumTopic2 = se1Var.f37714w;
                if (tL_forumTopic2.f18373id == 1 && (!v8Var.d.h) != tL_forumTopic2.hidden) {
                    TL_forum.TL_messages_editForumTopic tL_messages_editForumTopic2 = new TL_forum.TL_messages_editForumTopic();
                    tL_messages_editForumTopic2.peer = se1Var.getMessagesController().getInputPeer(se1Var.f37707a);
                    tL_messages_editForumTopic2.topic_id = se1Var.f37714w.f18373id;
            ...
            TLRPC.TL_forumTopic tL_forumTopic3 = se1Var.f37714w;
            long j12 = se1Var.f37708b;
            ...
            se1Var.getMessagesController().getTopicsController().onTopicEdited(se1Var.f37707a, se1Var.f37714w);
            se1Var.finishFragment();
        }
    }
}
