    ...
    public final void b(int i10) {
        ...
        if (i10 == 1) {
            ...
            if (TextUtils.isEmpty(obj)) {
                ...
                tL_messages_createForumTopic.peer = se1Var.getMessagesController().getInputPeer(se1Var.f37721a);
            ...
            if (!se1Var.f37728w.title.equals(str) || se1Var.f37728w.icon_emoji_id != se1Var.f37722b) {
                TL_forum.TL_messages_editForumTopic tL_messages_editForumTopic = new TL_forum.TL_messages_editForumTopic();
                tL_messages_editForumTopic.peer = se1Var.getMessagesController().getInputPeer(se1Var.f37721a);
                TLRPC.TL_forumTopic tL_forumTopic = se1Var.f37728w;
                ...
                long j10 = se1Var.f37728w.icon_emoji_id;
                long j11 = se1Var.f37722b;
                if (j10 != j11) {
            ...
            if (se1Var.d != null) {
                TLRPC.TL_forumTopic tL_forumTopic2 = se1Var.f37728w;
                if (tL_forumTopic2.f18387id == 1 && (!v8Var.d.h) != tL_forumTopic2.hidden) {
                    ...
                    tL_messages_editForumTopic2.peer = se1Var.getMessagesController().getInputPeer(se1Var.f37721a);
                    tL_messages_editForumTopic2.topic_id = se1Var.f37728w.f18387id;
            ...
            TLRPC.TL_forumTopic tL_forumTopic3 = se1Var.f37728w;
            long j12 = se1Var.f37722b;
            ...
            se1Var.getMessagesController().getTopicsController().onTopicEdited(se1Var.f37721a, se1Var.f37728w);
            se1Var.finishFragment();
        }
    }
}
