...
public final class be0 implements Runnable {
    public final int f32385a = 1;
    public final ge0 f32386b;
    public final TLRPC.TL_error f32387c;
    public final String d;
    public final String e;
    public final TLObject f32388f;

    public be0(ge0 ge0Var, TLRPC.TL_error tL_error, String str, String str2, TLObject tLObject) {
        this.f32386b = ge0Var;
        this.f32387c = tL_error;
        this.d = str;
        this.e = str2;
        this.f32388f = tLObject;
    }
    ...
    public final void run() {
        ...
        TLObject tLObject = this.f32388f;
        String str = this.e;
        String str2 = this.d;
        TLRPC.TL_error tL_error = this.f32387c;
        ge0 ge0Var = this.f32386b;
        switch (i11) {
            case 0:
                ge0Var.getClass();
                if (tL_error == null) {
                    TL_account.Password password = (TL_account.Password) tLObject;
                    ge0Var.f33905s = password;
