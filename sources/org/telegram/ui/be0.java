    ...
    public final void run() {
        switch (this.f32112a) {
            ...
            case 1:
                ...
                return;
            case 2:
                fe0 fe0Var = this.f32113b.f34546a;
                int i10 = 0;
                fe0Var.e = false;
            ...
            case 3:
                ie0 ie0Var2 = this.f32113b;
                ie0Var2.postDelayed(new be0(ie0Var2, 5), 150L);
                return;
            case 4:
                ie0 ie0Var3 = this.f32113b;
                he0 he0Var = ie0Var3.Q;
                boolean z10 = false;
                ie0Var3.R = false;
                int i11 = 0;
                while (true) {
                    is[] isVarArr2 = ie0Var3.f34546a.f33753f;
                    if (i11 < isVarArr2.length) {
                        ...
                        if (ie0Var3.f34549f.getVisibility() != 0 && ie0Var3.W.F != 3 && !ie0Var3.P) {
                            z10 = true;
                        }
                ...
                break;
            case 5:
                fe0 fe0Var2 = this.f32113b.f34546a;
                int i12 = 0;
                fe0Var2.e = false;
                fe0Var2.f33753f[0].requestFocus();
                while (true) {
                    is[] isVarArr3 = fe0Var2.f33753f;
            ...
            case 7:
                ...
                return;
            default:
                ie0 ie0Var4 = this.f32113b;
                org.telegram.ui.Components.bj0 bj0Var = ie0Var4.f34553w;
                bj0Var.getAnimatedDrawable().N(0, false, false);
                bj0Var.d();
                fe0 fe0Var3 = ie0Var4.f34546a;
                if (fe0Var3 != null && fe0Var3.f33753f != null) {
                    fe0Var3.setText("");
                    fe0Var3.f33753f[0].requestFocus();
                    return;
                }
                return;
        }
