...
public final class ii1 extends AnimatorListenerAdapter {
    ...
    public final void onAnimationEnd(Animator animator) {
        ...
        switch (this.f37387a) {
            case 0:
                ui1 ui1Var = this.f37388b;
                ui1Var.f41130i1 = null;
                ...
                return;
            case 1:
                org.telegram.ui.Components.voip.k2.k().f31578a.setAlpha(1.0f);
                AndroidUtilities.runOnUIThread(new f01(this, 23), 200L);
                return;
            case 2:
                ui1 ui1Var2 = this.f37388b;
                ui1Var2.L0.unlock();
                ui1Var2.Y.setCornerRadius(-1.0f);
                ui1Var2.E0 = false;
                ui1Var2.Y.f31785b0 = false;
                ui1Var2.f41141q0 = ui1Var2.f41140p0;
                ui1Var2.H();
                return;
            case 3:
                for (org.telegram.ui.Components.x9 x9Var : this.f37388b.V) {
                    org.telegram.ui.Components.q5 q5Var = x9Var.f32480e;
                    if (q5Var != null && (y3Var = q5Var.f29585k) != null) {
                        y3Var.setAllowStartAnimation(true);
                        x9Var.f32480e.f29585k.startAnimation();
                    }
                }
                return;
            case 4:
                ui1 ui1Var3 = this.f37388b;
                ui1Var3.B();
                for (org.telegram.ui.Components.x9 x9Var2 : ui1Var3.V) {
                    org.telegram.ui.Components.q5 q5Var2 = x9Var2.f32480e;
                    if (q5Var2 != null && (y3Var2 = q5Var2.f29585k) != null) {
                        y3Var2.setAllowStartAnimation(false);
                        x9Var2.f32480e.f29585k.stopAnimation();
                    }
                }
                ui1Var3.R.setVisibility(8);
                return;
            case 5:
                ui1 ui1Var4 = this.f37388b;
            ...
            case 6:
                ...
                return;
            case 7:
                this.f37388b.f41153y.setVisibility(8);
                return;
            default:
                this.f37388b.f41120e0.setVisibility(8);
                return;
        }
    }
}
