...
public final class m81 implements RequestDelegate {
    ...
    public final SessionsActivity f34866b;

    public m81(SessionsActivity sessionsActivity, int i10) {
        this.f34865a = i10;
        this.f34866b = sessionsActivity;
    }
    ...
    public final void run(final TLObject tLObject, final TLRPC.TL_error tL_error) {
        switch (this.f34865a) {
            case 0:
                AndroidUtilities.runOnUIThread(new k01(this.f34866b, 17));
                return;
            case 1:
                final SessionsActivity sessionsActivity = this.f34866b;
                ...
                return;
            case 2:
                final SessionsActivity sessionsActivity2 = this.f34866b;
                AndroidUtilities.runOnUIThread(new Runnable() {
                    @Override
                    public final void run() {
                        org.telegram.ui.Components.wc a02;
                        ...
                        switch (r4) {
                            case 0:
                                ...
                                if (sessionsActivity22.getParentActivity() != null) {
                                    ...
                                    org.telegram.messenger.a2.o(i11, a02, i102, 36);
                ...
                return;
            default:
                final SessionsActivity sessionsActivity3 = this.f34866b;
                AndroidUtilities.runOnUIThread(new Runnable() {
                    @Override
                    public final void run() {
                        org.telegram.ui.Components.wc a02;
                        ...
                        switch (r4) {
                            case 0:
                                ...
                                if (sessionsActivity22.getParentActivity() != null) {
                                    ...
                                    org.telegram.messenger.a2.o(i112, a02, i102, 36);
                                    sessionsActivity22.k0(false);
                                    return;
                                }
                                return;
