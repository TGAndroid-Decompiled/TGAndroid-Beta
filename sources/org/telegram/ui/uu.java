...
public final class uu extends org.telegram.ui.Components.tl0 {
    public static final int f42037m3 = 0;
    public boolean U2;
    public int V2;
    ...
    public final float[] f42038a3;
    public final int[] f42039b3;
    public final ArrayList c3;
    public tu[] f42040d3;
    public tu[] f42041e3;
    public final boolean[] f42042f3;
    public long f42043g3;
    public long f42044h3;
    public long f42045i3;
    public boolean f42046j3;
    public ru f42047k3;
    public final yu f42048l3;
    ...
    public uu(yu yuVar, Activity activity) {
        ...
        this.f42038a3 = new float[7];
        this.f42039b3 = new int[7];
        this.c3 = new ArrayList();
        this.f42042f3 = new boolean[7];
    ...
    public final void A1(boolean z4) {
        ...
        int i14 = 0;
        while (true) {
            tu[] tuVarArr = this.f42040d3;
            if (i14 >= tuVarArr.length) {
                break;
            }
            tu tuVar = tuVarArr[i14];
            long j11 = j10;
            long j12 = tuVar.f31882c;
            int i15 = tuVar.d;
            if (!this.f42046j3 && !this.c3.contains(Integer.valueOf(i15))) {
                z10 = false;
            } else {
                z10 = true;
            }
        ...
        if (!arrayList3.isEmpty()) {
            ...
            while (i22 < arrayList3.size()) {
                ...
                if (i23 >= 0 && !this.f42042f3[i23]) {
                    tu tuVar2 = this.f42040d3[i23];
                    int[] iArr2 = yu.f43709n;
                    int i24 = tuVar2.d;
                    int i25 = tuVar2.f41710g;
                    int i26 = tuVar2.h;
                    long j14 = tuVar2.f41708e;
                    spannableString = spannableString4;
                    spannableString2 = spannableString5;
                    long j15 = tuVar2.f41709f;
                    int i27 = iArr2[i24];
                    if (i27 == 0) {
                        if (j15 > j13 || i26 > 0) {
                            i22++;
        ...
        if (!this.f42046j3) {
            ...
            arrayList2.add(new pu(-1, R.drawable.msg_filled_data_sent, -11565578, -13276952, LocaleController.getString(R.string.BytesSent), AndroidUtilities.formatFileSize(this.f42045i3)));
            arrayList2.add(new pu(-1, R.drawable.msg_filled_data_received, -11154873, -14175180, LocaleController.getString(R.string.BytesReceived), AndroidUtilities.formatFileSize(this.f42044h3)));
        }
        if (!arrayList3.isEmpty()) {
            i10 = 3;
    ...
    public final void z1() {
        ...
        int i17;
        int i18;
        this.f42043g3 = w1(6) + y1(6);
        this.f42044h3 = w1(6);
        this.f42045i3 = y1(6);
        if (this.f42040d3 == null) {
            this.f42040d3 = new tu[7];
        }
        if (this.f42041e3 == null) {
            this.f42041e3 = new tu[7];
        }
        int i19 = 0;
        while (true) {
            int[] iArr = yu.f43709n;
            int length = iArr.length;
            float[] fArr = this.f42038a3;
            if (i19 < length) {
                int i20 = iArr[i19];
                long w12 = w1(i20) + y1(i20);
                tu[] tuVarArr = this.f42041e3;
                tu[] tuVarArr2 = this.f42040d3;
                ...
                obj.f31881b = z4;
                obj.f41708e = w13;
                obj.f41710g = recivedItemsCount;
                obj.f41709f = y12;
                obj.h = sentItemsCount;
                tuVarArr2[i19] = obj;
                tuVarArr[i19] = obj;
                fArr[i19] = ((float) w12) / ((float) this.f42043g3);
                i19++;
            } else {
                Arrays.sort(this.f42040d3, new du(1));
                AndroidUtilities.roundPercents(fArr, this.f42039b3);
                Arrays.fill(this.f42042f3, true);
                return;
            }
        }
    }
