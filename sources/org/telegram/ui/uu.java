...
public final class uu extends pg.b {
    ...
    public final boolean D(s4.c1 c1Var) {
        switch (this.d) {
            case 0:
                ru ruVar = (ru) ((wu) this.f41220e).f42483c3.get(c1Var.b());
    ...
    public final int h() {
        switch (this.d) {
            case 0:
                return ((wu) this.f41220e).f42483c3.size();
            default:
                return ((nc0) this.f41220e).f38924s.size();
        }
    }
    ...
    public final int j(int i10) {
        switch (this.d) {
            case 0:
                return ((ru) ((wu) this.f41220e).f42483c3.get(i10)).f44072a;
            default:
                nc0 nc0Var = (nc0) this.f41220e;
                if (i10 >= 0 && i10 < nc0Var.f38924s.size()) {
                    return ((hc0) nc0Var.f38924s.get(i10)).f44072a;
                }
                return 2;
        }
    }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        int i11 = this.d;
        View view = null;
        Object obj = this.f41220e;
        switch (i11) {
            case 0:
                wu wuVar = (wu) obj;
                av avVar = wuVar.f42494o3;
                org.telegram.ui.ActionBar.f6 f6Var = wuVar.f28225p2;
                if (i10 != 0) {
                    if (i10 != 1) {
                        if (i10 != 3) {
                            if (i10 != 4) {
                                if (i10 != 5) {
                                    if (i10 != 6) {
                                        if (i10 != 7) {
                                            ...
                                            int i13 = wu.f42480p3;
                                            jnVar.setBackgroundColor(org.telegram.ui.ActionBar.j6.v0(i12, wuVar.f28225p2));
                                            r8Var = jnVar;
                                        }
                                    } else {
                                        ?? view2 = new View(wuVar.getContext());
                                        view2.f43206a = new Path();
                                    ...
                                    r8Var2.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20881p7, f6Var));
                                    r8Var2.setBackgroundColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20664d6, f6Var));
                                    r8Var = r8Var2;
                                }
                            } else {
                                View l4Var = new org.telegram.ui.Cells.l4(wuVar.getContext());
                                l4Var.setBackgroundColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20664d6, f6Var));
                                r8Var = l4Var;
                            }
                        } else {
                        ...
                        frameLayout.f43517a = textView;
                        textView.setGravity(17);
                        textView.setTextSize(1, 13.0f);
                        textView.setTextColor(avVar.getThemedColor(org.telegram.ui.ActionBar.j6.f21043y6));
                    ...
                    int[] iArr = av.f34552e;
                    tu tuVar = new tu(this, context2, iArr.length, iArr, av.f34553f);
                    wuVar.f42493n3 = tuVar;
                    tuVar.setInterceptTouch(false);
                    View view3 = wuVar.f42493n3;
                    view3.setTag(-33024);
                    r8Var = view3;
                }
