...
public final class uu extends org.telegram.ui.Components.bd {
    ...
    public final void d(int i10, boolean z10) {
        int i11;
        xu xuVar = (xu) this.f38227e0.e;
        if (!z10) {
            xuVar.k1();
        } else if (i10 >= 0 && i10 < xuVar.f39712g3.length) {
            int i12 = 0;
            while (true) {
            ...
            int i13 = 0;
            while (true) {
                if (i13 < xuVar.f39708c3.size()) {
                    su suVar = (su) xuVar.f39708c3.get(i13);
