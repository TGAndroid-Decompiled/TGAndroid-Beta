...
public final class a61 extends y61 {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (j61Var != null) {
            ...
            ah.u0 u0Var = (ah.u0) i0Var.f599b;
            ah.t0 t0Var = u0Var.f697a;
            RectF rectF = AndroidUtilities.rectTmp;
            float f7 = 0;
            rectF.set(f7, f7, measuredWidth, measuredHeight);
            org.telegram.ui.Components.ek0 delegate = ((org.telegram.ui.Components.fk0) i0Var.f600c).getDelegate();
            float x11 = t0Var.getX() + x10;
            if (u0Var.f718y == 1) {
                y3 = t0Var.getY() - AndroidUtilities.statusBarHeight;
            } else {
                y3 = t0Var.getY() + u0Var.f699c.getY();
            }
