...
public final class o50 {
    ...
    public final org.telegram.ui.Components.t01 f36029f;
    public n50 f36030g;
    public int f36032j;
    public final Paint f36026a = new Paint(1);
    public final Paint f36027b = new Paint(1);
    public final q50[] f36028c = new q50[4];
    public boolean h = true;
    public final org.telegram.ui.Components.e6 f36031i = new org.telegram.ui.Components.e6(new c10(this, 7), 320, org.telegram.ui.Components.rr.h, 0);
    public final RectF f36033k = new RectF();
    public final RectF f36034l = new RectF();
    public final Path f36035m = new Path();

    public o50() {
        int i10 = 0;
        while (true) {
            q50[] q50VarArr = this.f36028c;
            if (i10 < q50VarArr.length) {
                q50VarArr[i10] = new q50(i10);
                i10++;
            } else {
                this.f36026a.setColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19349tg, false));
                ...
                this.e = t01Var;
                this.f36029f = new org.telegram.ui.Components.t01(LocaleController.getString(R.string.ConferenceEncryptedClose), 14.0f, AndroidUtilities.bold());
                b(null);
                return;
            }
        }
    ...
    public final boolean a(Canvas canvas, float f7, float f10) {
        ...
        t01Var.f28367p = f7 - AndroidUtilities.dp(132.0f);
        int d = i0.a.d(f10, this.f36032j, org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19349tg, false));
        Paint paint = this.f36026a;
        paint.setColor(d);
        float e = this.f36031i.e(this.h);
        ...
        if (f10 > 0.0f) {
            ...
            this.f36029f.c(rectF.centerX() - (this.f36029f.l() / 2.0f), j3 - AndroidUtilities.dp(20.0f), f10, -1, canvas);
        }
        canvas.restore();
        return z11;
    }
    ...
    public final void b(String[] strArr) {
        ...
        for (int i10 = 0; i10 < 4; i10++) {
            q50 q50Var = this.f36028c[i10];
            if (strArr == null) {
                str = null;
            } else {
                str = strArr[i10];
            }
            p50 p50Var = q50Var.f36781k;
            boolean z12 = q50Var.f36777f;
            if (str != null) {
                z11 = true;
            } else {
                z11 = false;
            ...
            q50Var.f36777f = z11;
            if (str != null && (q50Var.d == null || !TextUtils.equals(q50Var.f36782l, str))) {
                org.telegram.ui.Components.q5 q5Var = q50Var.d;
                if (q5Var != null) {
                    q5Var.p(p50Var);
                }
                q50Var.f36776c = Emoji.getEmojiDrawable(str);
            ...
            if (q50Var.f36777f && !z12) {
                q50Var.e = false;
            }
        }
        n50 n50Var = this.f36030g;
        if (n50Var != null) {
            n50Var.invalidate();
        }
    }
