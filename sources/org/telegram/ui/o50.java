...
public final class o50 {
    ...
    public final org.telegram.ui.Components.t01 f36054f;
    public n50 f36055g;
    public int f36057j;
    public final Paint f36051a = new Paint(1);
    public final Paint f36052b = new Paint(1);
    public final q50[] f36053c = new q50[4];
    public boolean h = true;
    public final org.telegram.ui.Components.e6 f36056i = new org.telegram.ui.Components.e6(new c10(this, 7), 320, org.telegram.ui.Components.rr.h, 0);
    public final RectF f36058k = new RectF();
    public final RectF f36059l = new RectF();
    public final Path f36060m = new Path();

    public o50() {
        int i10 = 0;
        while (true) {
            q50[] q50VarArr = this.f36053c;
            if (i10 < q50VarArr.length) {
                q50VarArr[i10] = new q50(i10);
                i10++;
            } else {
                this.f36051a.setColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19364tg, false));
                ...
                this.e = t01Var;
                this.f36054f = new org.telegram.ui.Components.t01(LocaleController.getString(R.string.ConferenceEncryptedClose), 14.0f, AndroidUtilities.bold());
                b(null);
                return;
            }
        }
    ...
    public final boolean a(Canvas canvas, float f7, float f10) {
        ...
        t01Var.f28374p = f7 - AndroidUtilities.dp(132.0f);
        int d = i0.a.d(f10, this.f36057j, org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19364tg, false));
        Paint paint = this.f36051a;
        paint.setColor(d);
        float e = this.f36056i.e(this.h);
        ...
        if (f10 > 0.0f) {
            ...
            this.f36054f.c(rectF.centerX() - (this.f36054f.l() / 2.0f), j3 - AndroidUtilities.dp(20.0f), f10, -1, canvas);
        }
        canvas.restore();
        return z11;
    }
    ...
    public final void b(String[] strArr) {
        ...
        for (int i10 = 0; i10 < 4; i10++) {
            ...
            if (str != null && (q50Var.d == null || !TextUtils.equals(q50Var.f36798l, str))) {
                ...
                drawable.f27506l = 1.0f;
                drawable.f27508n = null;
                drawable.f27509o = null;
                drawable.f27502g = 21;
