...
public final class ye implements org.telegram.ui.ActionBar.b2, org.telegram.ui.Components.bl0 {
    ...
    public final NotificationCenter.NotificationCenterDelegate f39865c;
    ...
    public ye(Object obj, KeyEvent.Callback callback, Object obj2, long j3, Object obj3, int i10) {
        this.f39863a = i10;
        this.f39865c = (NotificationCenter.NotificationCenterDelegate) obj;
        this.d = callback;
        this.e = obj2;
        this.f39864b = j3;
        this.f39866f = obj3;
    ...
    public void c(final float f7, final float f10, int i10, View view) {
        ...
        long j3;
        int i12 = i10;
        final org.telegram.ui.Components.zu0 zu0Var = (org.telegram.ui.Components.zu0) this.f39865c;
        org.telegram.ui.Components.vr0 vr0Var = (org.telegram.ui.Components.vr0) this.d;
        final Context context = (Context) this.e;
        org.telegram.ui.ActionBar.f6 f6Var = (org.telegram.ui.ActionBar.f6) this.f39866f;
        org.telegram.ui.Components.it0 it0Var = zu0Var.Q;
        org.telegram.ui.Components.ju0 ju0Var = zu0Var.R;
        org.telegram.ui.Components.jt0 jt0Var = zu0Var.f30607a0;
        ...
        if (i13 == 7) {
            ...
            org.telegram.ui.Components.qt0 qt0Var = zu0Var.f30630j0;
            if (adapter == qt0Var) {
            ...
            if (i13 == 3 && (view instanceof org.telegram.ui.Cells.n7)) {
                    ...
                    if (o2Var != null) {
                        ...
                        messagesController.getContentSettings(new Utilities.Callback() {
                            ...
                            public final void run(Object obj) {
                                ...
                                org.telegram.ui.ActionBar.o2 o2Var2 = zu0.this.f30656v1;
                                c2Var.c(200L);
                                ...
                                alertDialog$Builder.f18446a.R = LocaleController.getString(R.string.MessageShowSensitiveContentMediaTitle);
                                if (z11) {
                                    i15 = R.string.MessageShowSensitiveContentMediaTextClosed;
                                } else {
                                    i15 = R.string.MessageShowSensitiveContentMediaText;
                                }
                                alertDialog$Builder.f18446a.T = LocaleController.getString(i15);
                                alertDialog$Builder.n(frameLayout);
                                alertDialog$Builder.f18446a.G = 9;
                                if (z11) {
                                ...
                                if (o2Var2 != null && o2Var2.getContext() != null) {
                                    o2Var2.showDialog(alertDialog$Builder.f18446a);
                                } else {
                ...
                MessageObject messageObject2 = t7Var.f21397n;
                if (messageObject2 != null && messageObject2.hasMediaSpoilers() && t7Var.f21393i0 == 0.0f && !t7Var.f21397n.isMediaSpoilersRevealedInSharedMedia) {
                    t7Var.n(f7, f10);
                ...
                if (i15 == 10) {
                    ...
                    if (vr0Var.h.getAdapter() == ku0Var) {
                        ...
                        if (ju0Var.v.f42846y == 0) {
                            ju0Var.E(view);
                        }
                    } else {
                        Bundle bundle5 = new Bundle();
                        if (i12 >= 0 && i12 < ju0Var.f25441f.size()) {
                            bundle5.putLong("user_id", o2Var.getUserConfig().getClientUserId());
                            bundle5.putInt("chatMode", 3);
                            bo boVar2 = new bo(bundle5);
                            boVar2.f32257d4 = ((SavedMessagesController.SavedDialog) ju0Var.f25441f.get(i12)).dialogId;
    ...
    public void f(org.telegram.ui.ActionBar.c2 c2Var, int i10) {
        switch (this.f39863a) {
            case 0:
                bo.X0((bo) this.f39865c, (TLRPC.TL_game) this.d, (MessageObject) this.e, (String) this.f39866f, this.f39864b);
                return;
            default:
                org.telegram.ui.Components.y21 y21Var = (org.telegram.ui.Components.y21) this.f39865c;
                ArrayList arrayList = (ArrayList) this.d;
                HashSet hashSet = (HashSet) this.e;
                org.telegram.ui.Components.sh shVar = (org.telegram.ui.Components.sh) this.f39866f;
                ...
                while (true) {
                    ...
                    if (i11 < size) {
                        ...
                        y21Var.f30103e0.addAll(hashSet);
                        y21Var.o();
