...
public final class d3 extends FrameLayout {
    public final LinearLayout f32494a;
    public boolean f32495b;
    public final org.telegram.ui.Components.w9 f32496c;
    public final TextView d;
    public final TextView e;
    public final TextView f32497f;
    public final ci.d h;
    public ValueAnimator f32498n;
    ...
    public final void b(boolean z10, boolean z11) {
        ...
        this.f32499r = z10;
        ValueAnimator valueAnimator = this.f32498n;
        ...
        this.f32497f.setTextColor(i12);
    }

    @Override
    public void setVisibility(int i10) {
        super.setVisibility(i10);
        if (i10 == 0 && !this.f32495b) {
            this.f32495b = true;
            MediaDataController.getInstance(UserConfig.selectedAccount).setPlaceholderImage(this.f32496c, "tg_placeholders_android", "🧐", "100_100");
        }
    }
}
