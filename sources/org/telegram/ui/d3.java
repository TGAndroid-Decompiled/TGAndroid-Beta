...
public final class d3 extends FrameLayout {
    public final LinearLayout f35633a;
    public boolean f35634b;
    public final org.telegram.ui.Components.x9 f35635c;
    public final TextView d;
    public final TextView f35636e;
    public final TextView f35637f;
    public final di.d h;
    public ValueAnimator f35638n;
    ...
    public final void a(String str, String str2) {
        ...
        org.telegram.messenger.vl.p(R.string.WebErrorInfoBot, new Object[]{str}, this.f35636e);
        this.f35637f.setText(str2);
    }
    ...
    public final void b(boolean z10, boolean z11) {
        ...
        this.f35639r = z10;
        ValueAnimator valueAnimator = this.f35638n;
        ...
        this.f35636e.setTextColor(i11);
        if (!z10) {
            i12 = -16777216;
        }
        this.f35637f.setTextColor(i12);
    }

    @Override
    public void setVisibility(int i10) {
        super.setVisibility(i10);
        if (i10 == 0 && !this.f35634b) {
            this.f35634b = true;
            MediaDataController.getInstance(UserConfig.selectedAccount).setPlaceholderImage(this.f35635c, "tg_placeholders_android", "🧐", "100_100");
        }
    }
}
