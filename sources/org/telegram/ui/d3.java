...
public final class d3 extends FrameLayout {
    ...
    public final org.telegram.ui.Components.x9 f35662c;
    public final TextView d;
    public final TextView f35663e;
    public final TextView f35664f;
    public final di.d h;
    public ValueAnimator f35665n;
    public boolean f35666r;
    ...
    public final void a(String str, String str2) {
        ...
        org.telegram.messenger.vl.p(R.string.WebErrorInfoBot, new Object[]{str}, this.f35663e);
        this.f35664f.setText(str2);
    }
    ...
    public final void b(boolean z10, boolean z11) {
        ...
        this.f35666r = z10;
        ValueAnimator valueAnimator = this.f35665n;
        ...
        this.f35663e.setTextColor(i11);
        if (!z10) {
            i12 = -16777216;
        }
        this.f35664f.setTextColor(i12);
    }

    @Override
    public void setVisibility(int i10) {
        super.setVisibility(i10);
        if (i10 == 0 && !this.f35661b) {
            this.f35661b = true;
            MediaDataController.getInstance(UserConfig.selectedAccount).setPlaceholderImage(this.f35662c, "tg_placeholders_android", "🧐", "100_100");
        }
    }
}
