...
public final class ld extends org.telegram.ui.ActionBar.m2 implements NotificationCenter.NotificationCenterDelegate, org.telegram.ui.Components.u40 {
    ...
    public boolean Z;
    public org.telegram.ui.ActionBar.u0 f35267a;
    public boolean f35268a0;
    public org.telegram.ui.Components.qr f35269b;
    public boolean f35270b0;
    public org.telegram.ui.Components.ku f35271c;
    public TLRPC.TL_chatInviteExported f35272c0;
    public org.telegram.ui.Cells.b7 d;
    public boolean f35273d0;
    public ai.y5 e;
    public org.telegram.ui.Cells.e9 f35274e0;
    public ci.r6 f35275f;
    public final ArrayList f35276f0;
    public org.telegram.ui.Cells.s4 f35277g0;
    public id h;
    public final int f35278h0;
    public final long f35279i0;
    public boolean f35280j0;
    public final Boolean f35281k0;
    public TLRPC.InputFile f35282l0;
    public TLRPC.InputFile m0;
    public AnimatorSet f35283n;
    public TLRPC.VideoSize f35284n0;
    public String f35285o0;
    public double f35286p0;
    public boolean f35287q0;
    public jd f35288r;
    public boolean f35289r0;
    public final org.telegram.ui.Components.h9 f35290s;
    public Integer f35291s0;
    public Utilities.Callback2 f35292t0;
    public org.telegram.ui.ActionBar.a2 f35293u0;
    public final org.telegram.ui.Components.v40 v;
    public final cd f35294v0;
    public EditTextBoldCursor f35295w;
    public ValueAnimator f35296w0;
    public TLRPC.FileLocation f35297x;
    public TLRPC.FileLocation f35298y;

    public ld(Bundle bundle) {
        super(bundle);
        this.f35276f0 = new ArrayList();
        this.f35280j0 = true;
        this.f35294v0 = new cd(this, 2);
        int i10 = bundle.getInt("step", 0);
        this.f35278h0 = i10;
        if (bundle.containsKey("forcePublic")) {
            this.f35281k0 = Boolean.valueOf(bundle.getBoolean("forcePublic", false));
        }
        if (i10 == 0) {
            this.f35290s = new org.telegram.ui.Components.h9((org.telegram.ui.ActionBar.d6) null);
        ...
        this.f35279i0 = bundle.getLong("chat_id", 0L);
    }

    public static void U(ld ldVar, org.telegram.ui.ActionBar.a2 a2Var) {
        ldVar.f35289r0 = false;
        ldVar.f35287q0 = false;
        if (ldVar.f35291s0 != null) {
            ConnectionsManager.getInstance(ldVar.currentAccount).cancelRequest(ldVar.f35291s0.intValue(), true);
            ldVar.f35291s0 = null;
        }
        ldVar.g0(false);
        a2Var.dismiss();
    ...
    public static void W(ld ldVar, String str) {
        ...
        tL_channels_checkUsername.channel = MessagesController.getInstance(ldVar.currentAccount).getInputChannel(ldVar.f35279i0);
    ...
    public static void Y(ld ldVar) {
        if (ldVar.f35293u0 != null) {
            return;
        }
        AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(ldVar.getParentActivity());
        alertDialog$Builder.f18647a.R = LocaleController.getString(R.string.StopLoadingTitle);
        alertDialog$Builder.f18647a.T = LocaleController.getString(R.string.StopLoading);
        ...
        ldVar.f35293u0 = alertDialog$Builder.o();
    }

    @Override
    public final void B(float f7) {
        jd jdVar = this.f35288r;
        if (jdVar == null) {
            return;
        }
    ...
    public final View createView(Context context) {
        ...
        int i20;
        ld ldVar = this;
        org.telegram.ui.Components.ku kuVar = ldVar.f35271c;
        if (kuVar != null) {
            kuVar.o();
        }
        ...
        int i21 = org.telegram.ui.ActionBar.h6.f19378v8;
        ...
        ldVar.f35269b = qrVar;
        ldVar.f35267a = n10.i(AndroidUtilities.dp(56.0f), LocaleController.getString(R.string.Done), qrVar);
        int i22 = ldVar.f35278h0;
        if (i22 == 0) {
            ...
            org.telegram.ui.Components.h9 h9Var = ldVar.f35290s;
            ...
            ldVar.f35275f.setOnClickListener(new dd(ldVar, 1));
            ...
            ldVar.f35288r.setProgressColor(-1);
            ldVar.f35288r.setNoProgress(false);
            jd jdVar2 = ldVar.f35288r;
            ...
            ldVar = this;
            ldVar.f35271c = kuVar2;
            kuVar2.setHint(LocaleController.getString(R.string.EnterChannelName));
            String str = ldVar.E;
            if (str != null) {
                ldVar.f35271c.setText(str);
                ldVar.E = null;
            }
            ldVar.f35271c.setFilters(new InputFilter[]{new InputFilter.LengthFilter(100)});
            ldVar.f35271c.getEditText().setSingleLine(true);
            ldVar.f35271c.getEditText().setImeOptions(5);
            ldVar.f35271c.getEditText().setOnEditorActionListener(new TextView.OnEditorActionListener(ldVar) {
                public final ld f33344b;
                ...
                public final boolean onEditorAction(TextView textView, int i28, KeyEvent keyEvent) {
                    ...
                    switch (r2) {
                        case 0:
                            ld ldVar2 = this.f33344b;
                            if (i28 == 5) {
                                if (!TextUtils.isEmpty(ldVar2.f35271c.getEditText().getText())) {
                                    ldVar2.f35295w.requestFocus();
                                    return true;
                                }
                            } else {
                                ldVar2.getClass();
                            ...
                            return false;
                        default:
                            if (i28 == 6 && (u0Var = this.f33344b.f35267a) != null) {
                                u0Var.performClick();
                                return true;
                            }
                            return false;
            ...
            org.telegram.ui.Components.ku kuVar3 = ldVar.f35271c;
            ...
            frameLayout.addView(kuVar3, w7.y5.d(-1, -2.0f, 16, f17, 0.0f, f18, 0.0f));
            EditTextBoldCursor editTextBoldCursor = new EditTextBoldCursor(context);
            ldVar.f35295w = editTextBoldCursor;
            editTextBoldCursor.setTextSize(1, 18.0f);
            ldVar.f35295w.setHintTextColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.H6, false));
            EditTextBoldCursor editTextBoldCursor2 = ldVar.f35295w;
            int i28 = org.telegram.ui.ActionBar.h6.G6;
            editTextBoldCursor2.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, i28, false));
            ldVar.f35295w.setBackgroundDrawable(null);
            ldVar.f35295w.setLineColors(ldVar.getThemedColor(org.telegram.ui.ActionBar.h6.f19172k6), ldVar.getThemedColor(org.telegram.ui.ActionBar.h6.f19190l6), ldVar.getThemedColor(org.telegram.ui.ActionBar.h6.f19265p7));
            ldVar.f35295w.setPadding(0, 0, 0, AndroidUtilities.dp(6.0f));
            EditTextBoldCursor editTextBoldCursor3 = ldVar.f35295w;
            ...
            ldVar.f35295w.setInputType(180225);
            ldVar.f35295w.setImeOptions(6);
            ldVar.f35295w.setFilters(new InputFilter[]{new InputFilter.LengthFilter(120)});
            ldVar.f35295w.setHint(LocaleController.getString(R.string.DescriptionPlaceholder));
            ldVar.f35295w.setCursorColor(org.telegram.ui.ActionBar.h6.w0(null, i28, false));
            ldVar.f35295w.setCursorSize(AndroidUtilities.dp(20.0f));
            ldVar.f35295w.setCursorWidth(1.5f);
            ldVar.K.addView(ldVar.f35295w, w7.y5.k(24.0f, 18.0f, 24.0f, 0.0f, -1, -2));
            ldVar.f35295w.setOnEditorActionListener(new TextView.OnEditorActionListener(ldVar) {
                public final ld f33344b;
                ...
                public final boolean onEditorAction(TextView textView, int i282, KeyEvent keyEvent) {
                    ...
                    switch (r2) {
                        case 0:
                            ...
                            return false;
                        default:
                            if (i282 == 6 && (u0Var = this.f33344b.f35267a) != null) {
                                u0Var.performClick();
                                return true;
                            }
                            return false;
            ...
            ldVar.f35295w.addTextChangedListener(new kd(0));
            ...
            int i29 = org.telegram.ui.ActionBar.h6.f18989a7;
            ...
            int i30 = org.telegram.ui.ActionBar.h6.f19045d6;
            ...
            Boolean bool = ldVar.f35281k0;
            if (bool != null && !bool.booleanValue()) {
                ldVar.f35268a0 = true;
            }
            if (ldVar.I) {
                ldVar.Q.b(LocaleController.getString(R.string.MegaPublic), LocaleController.getString(R.string.MegaPublicInfo), false, !ldVar.f35268a0);
            } else {
                ldVar.Q.b(LocaleController.getString(R.string.ChannelPublic), LocaleController.getString(R.string.ChannelPublicInfo), false, !ldVar.f35268a0);
            }
            ...
            if (bool != null && bool.booleanValue()) {
                ldVar.f35268a0 = false;
            }
            if (ldVar.I) {
                ldVar.R.b(LocaleController.getString(R.string.MegaPrivate), LocaleController.getString(R.string.MegaPrivateInfo), false, ldVar.f35268a0);
            } else {
                ldVar.R.b(LocaleController.getString(R.string.ChannelPrivate), LocaleController.getString(R.string.ChannelPrivateInfo), false, ldVar.f35268a0);
            }
            ...
            ldVar.f35295w = editTextBoldCursor7;
            editTextBoldCursor7.setTextSize(1, 18.0f);
            ldVar.f35295w.setHintTextColor(org.telegram.ui.ActionBar.h6.w0(null, i31, false));
            ldVar.f35295w.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, i32, false));
            ldVar.f35295w.setMaxLines(1);
            ldVar.f35295w.setLines(1);
            ldVar.f35295w.setBackgroundDrawable(null);
            ldVar.f35295w.setPadding(0, 0, 0, 0);
            ldVar.f35295w.setSingleLine(true);
            ldVar.f35295w.setInputType(163872);
            ldVar.f35295w.setImeOptions(6);
            ldVar.f35295w.setHint(LocaleController.getString(R.string.ChannelUsernamePlaceholder));
            ldVar.f35295w.setCursorColor(org.telegram.ui.ActionBar.h6.w0(null, i32, false));
            ldVar.f35295w.setCursorSize(AndroidUtilities.dp(20.0f));
            ldVar.f35295w.setCursorWidth(1.5f);
            ldVar.N.addView(ldVar.f35295w, w7.y5.n(-1, 36));
            ldVar.f35295w.addTextChangedListener(new m0(ldVar, 1));
            ...
            int i34 = org.telegram.ui.ActionBar.h6.f19009b7;
    ...
    public final boolean d0(String str) {
            ...
            if (!str.startsWith("_") && !str.endsWith("_")) {
                for (int i10 = 0; i10 < str.length(); i10++) {
                    ...
                    if (i10 == 0 && charAt >= '0' && charAt <= '9') {
                        ...
                        int i11 = org.telegram.ui.ActionBar.h6.f19265p7;
                        ...
                        int i12 = org.telegram.ui.ActionBar.h6.f19265p7;
                ...
                int i13 = org.telegram.ui.ActionBar.h6.f19265p7;
        ...
        if (str != null && str.length() >= 4) {
            if (str.length() > 32) {
                ...
                int i14 = org.telegram.ui.ActionBar.h6.f19265p7;
        ...
        int i16 = org.telegram.ui.ActionBar.h6.f19265p7;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.chatDidFailCreate) {
            org.telegram.ui.ActionBar.a2 a2Var = this.f35293u0;
            if (a2Var != null) {
                try {
                    a2Var.dismiss();
                    this.f35293u0 = null;
            ...
            org.telegram.ui.ActionBar.a2 a2Var2 = this.f35293u0;
            if (a2Var2 != null) {
                try {
                    a2Var2.dismiss();
                    this.f35293u0 = null;
            ...
            bundle.putBoolean("canCreatePublic", this.f35280j0);
            Boolean bool = this.f35281k0;
            if (bool != null) {
                bundle.putBoolean("forcePublic", bool.booleanValue());
            }
            if (this.f35282l0 != null || this.m0 != null || this.f35284n0 != null) {
                MessagesController.getInstance(this.currentAccount).changeChatAvatar(longValue, null, this.f35282l0, this.m0, this.f35284n0, this.f35286p0, this.f35285o0, this.f35297x, this.f35298y, null);
            }
            ld ldVar = new ld(bundle);
            ldVar.f35292t0 = this.f35292t0;
    ...
    public final boolean dismissDialogOnPause(Dialog dialog) {
        org.telegram.ui.Components.v40 v40Var = this.v;
        if ((v40Var == null || dialog != v40Var.f28987c) && super.dismissDialogOnPause(dialog)) {
            return true;
        }
        return false;
    }
    ...
    public final void e0(boolean z10, boolean z11) {
        ...
        AnimatorSet animatorSet = this.f35283n;
        if (animatorSet != null) {
        ...
        if (z11) {
            this.f35283n = new AnimatorSet();
            if (z10) {
                this.f35288r.setVisibility(0);
                AnimatorSet animatorSet2 = this.f35283n;
                id idVar = this.h;
                Property property = View.ALPHA;
                animatorSet2.playTogether(ObjectAnimator.ofFloat(idVar, property, 0.0f), ObjectAnimator.ofFloat(this.f35288r, property, 1.0f));
            } else {
                if (this.h.getVisibility() != 0) {
                    this.h.setAlpha(0.0f);
                }
                this.h.setVisibility(0);
                AnimatorSet animatorSet3 = this.f35283n;
                id idVar2 = this.h;
                Property property2 = View.ALPHA;
                animatorSet3.playTogether(ObjectAnimator.ofFloat(idVar2, property2, 1.0f), ObjectAnimator.ofFloat(this.f35288r, property2, 0.0f));
            }
            this.f35283n.setDuration(180L);
            this.f35283n.addListener(new ai.n(27, this, z10));
            this.f35283n.start();
        } else if (z10) {
            this.h.setAlpha(1.0f);
            this.h.setVisibility(4);
            this.f35288r.setAlpha(1.0f);
            this.f35288r.setVisibility(0);
        } else {
            this.h.setAlpha(1.0f);
            this.h.setVisibility(0);
            this.f35288r.setAlpha(0.0f);
            this.f35288r.setVisibility(4);
        }
    }
    ...
    public final void g0(boolean z10) {
        float f7;
        if (!z10) {
            AndroidUtilities.cancelRunOnUIThread(this.f35294v0);
        }
        if (this.f35269b != null) {
            ValueAnimator valueAnimator = this.f35296w0;
            if (valueAnimator != null) {
                valueAnimator.cancel();
            }
            float f10 = this.f35269b.f27745c;
            float f11 = 0.0f;
            if (z10) {
                f7 = 1.0f;
            } else {
            ...
            this.f35296w0 = ofFloat;
            ofFloat.addUpdateListener(new c3(this, 4));
            ValueAnimator valueAnimator2 = this.f35296w0;
            float f12 = this.f35269b.f27745c;
            if (z10) {
                f11 = 1.0f;
            }
            valueAnimator2.setDuration(Math.abs(f12 - f11) * 200.0f);
            this.f35296w0.setInterpolator(org.telegram.ui.Components.rr.f28022f);
            this.f35296w0.start();
        }
    }
    ...
    public final String getInitialSearchString() {
        return this.f35271c.getText().toString();
    }
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        org.telegram.ui.Components.ku kuVar = this.f35271c;
        int i11 = org.telegram.ui.ActionBar.h6.G6;
        arrayList.add(new org.telegram.ui.ActionBar.j6(kuVar, 4, null, null, null, null, i11));
        org.telegram.ui.Components.ku kuVar2 = this.f35271c;
        ...
        org.telegram.ui.Components.ku kuVar3 = this.f35271c;
        int i13 = org.telegram.ui.ActionBar.h6.f19172k6;
        arrayList.add(new org.telegram.ui.ActionBar.j6(kuVar3, 32, null, null, null, null, i13));
        org.telegram.ui.Components.ku kuVar4 = this.f35271c;
        int i14 = org.telegram.ui.ActionBar.h6.f19190l6;
        arrayList.add(new org.telegram.ui.ActionBar.j6(kuVar4, 65568, null, null, null, null, i14));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f35295w, 4, null, null, null, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f35295w, 8388608, null, null, null, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f35295w, 32, null, null, null, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f35295w, 65568, null, null, null, null, i14));
        ...
        org.telegram.ui.Cells.y1 y1Var = this.U;
        int i18 = org.telegram.ui.ActionBar.h6.f19265p7;
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.U, 262148, null, null, null, null, org.telegram.ui.ActionBar.h6.f19394w6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f35274e0, 32, new Class[]{org.telegram.ui.Cells.e9.class}, null, null, null, i16));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.L, 1, null, null, null, null, i10));
        LinearLayout linearLayout = this.O;
        int i19 = org.telegram.ui.ActionBar.h6.f19134i6;
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f35277g0, 0, new Class[]{org.telegram.ui.Cells.s4.class}, new String[]{"progressBar"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.f19116h6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.Q, 4096, null, null, null, null, i19));
        int i20 = org.telegram.ui.ActionBar.h6.f19100g7;
        ...
        int i21 = org.telegram.ui.ActionBar.h6.f19117h7;
        ...
        int i22 = org.telegram.ui.ActionBar.h6.f19447z6;
        ...
        int i23 = org.telegram.ui.ActionBar.h6.f19428y6;
    ...
    public final void h0() {
        ...
        String str = null;
        int i16 = 8;
        if (!this.f35268a0 && !this.f35280j0) {
            this.S.setText(LocaleController.getString(R.string.ChangePublicLimitReached));
            org.telegram.ui.Cells.e9 e9Var = this.S;
            int i17 = org.telegram.ui.ActionBar.h6.f19265p7;
            e9Var.setTag(Integer.valueOf(i17));
            this.S.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, i17, false));
            this.M.setVisibility(8);
            this.d.setVisibility(8);
            if (this.f35273d0) {
                this.f35277g0.setVisibility(0);
                this.L.setVisibility(8);
                org.telegram.ui.Cells.e9 e9Var2 = this.S;
                e9Var2.setBackgroundDrawable(org.telegram.ui.ActionBar.h6.V0(e9Var2.getContext(), R.drawable.greydivider_bottom, org.telegram.ui.ActionBar.h6.f19009b7));
                this.f35274e0.setVisibility(8);
            } else {
                org.telegram.ui.Cells.e9 e9Var3 = this.S;
                e9Var3.setBackgroundDrawable(org.telegram.ui.ActionBar.h6.V0(e9Var3.getContext(), R.drawable.greydivider, org.telegram.ui.ActionBar.h6.f19009b7));
                this.f35277g0.setVisibility(8);
                this.L.setVisibility(0);
                this.f35274e0.setVisibility(0);
            }
        } else {
            ...
            e9Var5.setBackgroundDrawable(org.telegram.ui.ActionBar.h6.V0(e9Var5.getContext(), R.drawable.greydivider_bottom, org.telegram.ui.ActionBar.h6.f19009b7));
            ...
            TLRPC.TL_chatInviteExported tL_chatInviteExported = this.f35272c0;
            if (tL_chatInviteExported != null) {
                str = tL_chatInviteExported.link;
            }
            g90Var.setLink(str);
            org.telegram.ui.Cells.y1 y1Var = this.U;
            if (!this.f35268a0 && y1Var.length() != 0) {
                i16 = 0;
            }
            y1Var.setVisibility(i16);
        }
        this.Q.a(!this.f35268a0);
        this.R.a(this.f35268a0);
        this.f35295w.clearFocus();
        AndroidUtilities.hideKeyboard(this.f35295w);
    }
    ...
    public final boolean onFragmentCreate() {
        ...
        if (this.f35278h0 == 1 && !this.f35270b0 && this.f35272c0 == null) {
            MessagesController messagesController = getMessagesController();
            long j3 = this.f35279i0;
            TLRPC.ChatFull chatFull = messagesController.getChatFull(j3);
            if (chatFull != null) {
                this.f35272c0 = chatFull.exported_invite;
            }
            if (this.f35272c0 == null) {
                this.f35270b0 = true;
    ...
    public final void onFragmentDestroy() {
        ...
        if (this.f35291s0 != null) {
            ConnectionsManager.getInstance(this.currentAccount).cancelRequest(this.f35291s0.intValue(), true);
            this.f35291s0 = null;
        }
    ...
    public final void onTransitionAnimationEnd(boolean z10, boolean z11) {
        if (z10 && this.f35278h0 != 1) {
            this.f35271c.requestFocus();
            org.telegram.ui.Components.fu fuVar = this.f35271c.f25862a;
            fuVar.requestFocus();
