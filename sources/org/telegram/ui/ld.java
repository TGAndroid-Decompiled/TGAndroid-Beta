...
public final class ld extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate, org.telegram.ui.Components.t40 {
    ...
    public l4 Y;
    public boolean Z;
    public org.telegram.ui.ActionBar.v0 f35407a;
    public boolean f35408a0;
    public org.telegram.ui.Components.pr f35409b;
    public boolean f35410b0;
    public org.telegram.ui.Components.ju f35411c;
    public TLRPC.TL_chatInviteExported f35412c0;
    public org.telegram.ui.Cells.a7 d;
    public boolean f35413d0;
    public ai.z5 e;
    public org.telegram.ui.Cells.e9 f35414e0;
    public ci.s6 f35415f;
    public final ArrayList f35416f0;
    public org.telegram.ui.Cells.s4 f35417g0;
    public id h;
    public final int f35418h0;
    public final long f35419i0;
    public boolean f35420j0;
    public final Boolean f35421k0;
    public TLRPC.InputFile f35422l0;
    public TLRPC.InputFile m0;
    public AnimatorSet f35423n;
    public TLRPC.VideoSize f35424n0;
    public String f35425o0;
    public double f35426p0;
    public boolean f35427q0;
    public jd f35428r;
    public boolean f35429r0;
    public final org.telegram.ui.Components.f9 f35430s;
    public Integer f35431s0;
    public Utilities.Callback2 f35432t0;
    public org.telegram.ui.ActionBar.b2 f35433u0;
    public final org.telegram.ui.Components.u40 v;
    public final cd f35434v0;
    public EditTextBoldCursor f35435w;
    public ValueAnimator f35436w0;
    public TLRPC.FileLocation f35437x;
    public TLRPC.FileLocation f35438y;

    public ld(Bundle bundle) {
        super(bundle);
        this.f35416f0 = new ArrayList();
        this.f35420j0 = true;
        this.f35434v0 = new cd(this, 2);
        int i10 = bundle.getInt("step", 0);
        this.f35418h0 = i10;
        if (bundle.containsKey("forcePublic")) {
            this.f35421k0 = Boolean.valueOf(bundle.getBoolean("forcePublic", false));
        }
        if (i10 == 0) {
            this.f35430s = new org.telegram.ui.Components.f9((org.telegram.ui.ActionBar.e6) null);
        ...
        this.f35419i0 = bundle.getLong("chat_id", 0L);
    }

    public static void U(ld ldVar, org.telegram.ui.ActionBar.b2 b2Var) {
        ldVar.f35429r0 = false;
        ldVar.f35427q0 = false;
        if (ldVar.f35431s0 != null) {
            ConnectionsManager.getInstance(ldVar.currentAccount).cancelRequest(ldVar.f35431s0.intValue(), true);
            ldVar.f35431s0 = null;
        }
        ldVar.g0(false);
        b2Var.dismiss();
    ...
    public static void W(ld ldVar, String str) {
        ...
        tL_channels_checkUsername.channel = MessagesController.getInstance(ldVar.currentAccount).getInputChannel(ldVar.f35419i0);
    ...
    public static void Y(ld ldVar) {
        ...
        ldVar.f35433u0 = alertDialog$Builder.o();
    }

    @Override
    public final void B(float f7) {
        jd jdVar = this.f35428r;
        if (jdVar == null) {
            return;
        }
    ...
    public final View createView(Context context) {
        ...
        int i20;
        ld ldVar = this;
        org.telegram.ui.Components.ju juVar = ldVar.f35411c;
        if (juVar != null) {
            juVar.o();
        }
        ...
        int i21 = org.telegram.ui.ActionBar.i6.f19165v8;
        ...
        ldVar.f35409b = prVar;
        ldVar.f35407a = n10.i(AndroidUtilities.dp(56.0f), LocaleController.getString(R.string.Done), prVar);
        int i22 = ldVar.f35418h0;
        if (i22 == 0) {
            ...
            int i23 = org.telegram.ui.ActionBar.i6.f18834d6;
            ...
            org.telegram.ui.Components.f9 f9Var = ldVar.f35430s;
            ...
            ldVar.f35415f.setOnClickListener(new dd(ldVar, 1));
            ...
            ldVar.f35428r.setProgressColor(-1);
            ldVar.f35428r.setNoProgress(false);
            jd jdVar2 = ldVar.f35428r;
            ...
            ldVar = this;
            ldVar.f35411c = juVar2;
            juVar2.setHint(LocaleController.getString(R.string.EnterChannelName));
            String str = ldVar.E;
            if (str != null) {
                ldVar.f35411c.setText(str);
                ldVar.E = null;
            }
            ldVar.f35411c.setFilters(new InputFilter[]{new InputFilter.LengthFilter(100)});
            ldVar.f35411c.getEditText().setSingleLine(true);
            ldVar.f35411c.getEditText().setImeOptions(5);
            ldVar.f35411c.getEditText().setOnEditorActionListener(new TextView.OnEditorActionListener(ldVar) {
                public final ld f33266b;
                ...
                public final boolean onEditorAction(TextView textView, int i28, KeyEvent keyEvent) {
                    ...
                    switch (r2) {
                        case 0:
                            ld ldVar2 = this.f33266b;
                            if (i28 == 5) {
                                if (!TextUtils.isEmpty(ldVar2.f35411c.getEditText().getText())) {
                                    ldVar2.f35435w.requestFocus();
                                    return true;
                                }
                            } else {
                                ldVar2.getClass();
                            ...
                            return false;
                        default:
                            if (i28 == 6 && (v0Var = this.f33266b.f35407a) != null) {
                                v0Var.performClick();
                                return true;
                            }
                            return false;
            ...
            org.telegram.ui.Components.ju juVar3 = ldVar.f35411c;
            ...
            ldVar.f35435w = editTextBoldCursor;
            editTextBoldCursor.setTextSize(1, 18.0f);
            ldVar.f35435w.setHintTextColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.H6, false));
            EditTextBoldCursor editTextBoldCursor2 = ldVar.f35435w;
            int i28 = org.telegram.ui.ActionBar.i6.G6;
            editTextBoldCursor2.setTextColor(org.telegram.ui.ActionBar.i6.w0(null, i28, false));
            ldVar.f35435w.setBackgroundDrawable(null);
            ldVar.f35435w.setLineColors(ldVar.getThemedColor(org.telegram.ui.ActionBar.i6.f18961k6), ldVar.getThemedColor(org.telegram.ui.ActionBar.i6.f18979l6), ldVar.getThemedColor(org.telegram.ui.ActionBar.i6.f19053p7));
            ldVar.f35435w.setPadding(0, 0, 0, AndroidUtilities.dp(6.0f));
            EditTextBoldCursor editTextBoldCursor3 = ldVar.f35435w;
            ...
            ldVar.f35435w.setInputType(180225);
            ldVar.f35435w.setImeOptions(6);
            ldVar.f35435w.setFilters(new InputFilter[]{new InputFilter.LengthFilter(120)});
            ldVar.f35435w.setHint(LocaleController.getString(R.string.DescriptionPlaceholder));
            ldVar.f35435w.setCursorColor(org.telegram.ui.ActionBar.i6.w0(null, i28, false));
            ldVar.f35435w.setCursorSize(AndroidUtilities.dp(20.0f));
            ldVar.f35435w.setCursorWidth(1.5f);
            ldVar.K.addView(ldVar.f35435w, w7.x5.k(24.0f, 18.0f, 24.0f, 0.0f, -1, -2));
            ldVar.f35435w.setOnEditorActionListener(new TextView.OnEditorActionListener(ldVar) {
                public final ld f33266b;
                ...
                public final boolean onEditorAction(TextView textView, int i282, KeyEvent keyEvent) {
                    ...
                    switch (r2) {
                        case 0:
                            ...
                            return false;
                        default:
                            if (i282 == 6 && (v0Var = this.f33266b.f35407a) != null) {
                                v0Var.performClick();
                                return true;
                            }
                            return false;
            ...
            ldVar.f35435w.addTextChangedListener(new kd(0));
            ...
            int i29 = org.telegram.ui.ActionBar.i6.f18778a7;
            ...
            int i30 = org.telegram.ui.ActionBar.i6.f18834d6;
            ...
            Boolean bool = ldVar.f35421k0;
            if (bool != null && !bool.booleanValue()) {
                ldVar.f35408a0 = true;
            }
            if (ldVar.I) {
                ldVar.Q.b(LocaleController.getString(R.string.MegaPublic), LocaleController.getString(R.string.MegaPublicInfo), false, !ldVar.f35408a0);
            } else {
                ldVar.Q.b(LocaleController.getString(R.string.ChannelPublic), LocaleController.getString(R.string.ChannelPublicInfo), false, !ldVar.f35408a0);
            }
            ...
            if (bool != null && bool.booleanValue()) {
                ldVar.f35408a0 = false;
            }
            if (ldVar.I) {
                ldVar.R.b(LocaleController.getString(R.string.MegaPrivate), LocaleController.getString(R.string.MegaPrivateInfo), false, ldVar.f35408a0);
            } else {
                ldVar.R.b(LocaleController.getString(R.string.ChannelPrivate), LocaleController.getString(R.string.ChannelPrivateInfo), false, ldVar.f35408a0);
            }
            ...
            ldVar.f35435w = editTextBoldCursor7;
            editTextBoldCursor7.setTextSize(1, 18.0f);
            ldVar.f35435w.setHintTextColor(org.telegram.ui.ActionBar.i6.w0(null, i31, false));
            ldVar.f35435w.setTextColor(org.telegram.ui.ActionBar.i6.w0(null, i32, false));
            ldVar.f35435w.setMaxLines(1);
            ldVar.f35435w.setLines(1);
            ldVar.f35435w.setBackgroundDrawable(null);
            ldVar.f35435w.setPadding(0, 0, 0, 0);
            ldVar.f35435w.setSingleLine(true);
            ldVar.f35435w.setInputType(163872);
            ldVar.f35435w.setImeOptions(6);
            ldVar.f35435w.setHint(LocaleController.getString(R.string.ChannelUsernamePlaceholder));
            ldVar.f35435w.setCursorColor(org.telegram.ui.ActionBar.i6.w0(null, i32, false));
            ldVar.f35435w.setCursorSize(AndroidUtilities.dp(20.0f));
            ldVar.f35435w.setCursorWidth(1.5f);
            ldVar.N.addView(ldVar.f35435w, w7.x5.n(-1, 36));
            ldVar.f35435w.addTextChangedListener(new l0(ldVar, 1));
            ...
            int i34 = org.telegram.ui.ActionBar.i6.f18798b7;
    ...
    public final boolean d0(String str) {
            ...
            if (!str.startsWith("_") && !str.endsWith("_")) {
                for (int i10 = 0; i10 < str.length(); i10++) {
                    ...
                    if (i10 == 0 && charAt >= '0' && charAt <= '9') {
                        ...
                        int i12 = org.telegram.ui.ActionBar.i6.f19053p7;
        ...
        if (str != null && str.length() >= 4) {
            if (str.length() > 32) {
                ...
                int i14 = org.telegram.ui.ActionBar.i6.f19053p7;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.chatDidFailCreate) {
            org.telegram.ui.ActionBar.b2 b2Var = this.f35433u0;
            if (b2Var != null) {
                try {
                    b2Var.dismiss();
                    this.f35433u0 = null;
            ...
            org.telegram.ui.ActionBar.b2 b2Var2 = this.f35433u0;
            if (b2Var2 != null) {
                try {
                    b2Var2.dismiss();
                    this.f35433u0 = null;
            ...
            bundle.putBoolean("canCreatePublic", this.f35420j0);
            Boolean bool = this.f35421k0;
            if (bool != null) {
                bundle.putBoolean("forcePublic", bool.booleanValue());
            }
            if (this.f35422l0 != null || this.m0 != null || this.f35424n0 != null) {
                MessagesController.getInstance(this.currentAccount).changeChatAvatar(longValue, null, this.f35422l0, this.m0, this.f35424n0, this.f35426p0, this.f35425o0, this.f35437x, this.f35438y, null);
            }
            ld ldVar = new ld(bundle);
            ldVar.f35432t0 = this.f35432t0;
    ...
    public final boolean dismissDialogOnPause(Dialog dialog) {
        org.telegram.ui.Components.u40 u40Var = this.v;
        if ((u40Var == null || dialog != u40Var.f28282c) && super.dismissDialogOnPause(dialog)) {
            return true;
        }
        return false;
    }
    ...
    public final void e0(boolean z10, boolean z11) {
        ...
        AnimatorSet animatorSet = this.f35423n;
        if (animatorSet != null) {
        ...
        if (z11) {
            this.f35423n = new AnimatorSet();
            if (z10) {
                this.f35428r.setVisibility(0);
                AnimatorSet animatorSet2 = this.f35423n;
                id idVar = this.h;
                Property property = View.ALPHA;
                animatorSet2.playTogether(ObjectAnimator.ofFloat(idVar, property, 0.0f), ObjectAnimator.ofFloat(this.f35428r, property, 1.0f));
            } else {
                if (this.h.getVisibility() != 0) {
                    this.h.setAlpha(0.0f);
                }
                this.h.setVisibility(0);
                AnimatorSet animatorSet3 = this.f35423n;
                id idVar2 = this.h;
                Property property2 = View.ALPHA;
                animatorSet3.playTogether(ObjectAnimator.ofFloat(idVar2, property2, 1.0f), ObjectAnimator.ofFloat(this.f35428r, property2, 0.0f));
            }
            this.f35423n.setDuration(180L);
            this.f35423n.addListener(new ai.n(27, this, z10));
            this.f35423n.start();
        } else if (z10) {
            this.h.setAlpha(1.0f);
            this.h.setVisibility(4);
            this.f35428r.setAlpha(1.0f);
            this.f35428r.setVisibility(0);
        } else {
            this.h.setAlpha(1.0f);
            this.h.setVisibility(0);
            this.f35428r.setAlpha(0.0f);
            this.f35428r.setVisibility(4);
        }
    }
    ...
    public final void g0(boolean z10) {
        float f7;
        if (!z10) {
            AndroidUtilities.cancelRunOnUIThread(this.f35434v0);
        }
        if (this.f35409b != null) {
            ValueAnimator valueAnimator = this.f35436w0;
            if (valueAnimator != null) {
                valueAnimator.cancel();
            }
            float f10 = this.f35409b.f27129c;
            float f11 = 0.0f;
            if (z10) {
                f7 = 1.0f;
            } else {
            ...
            this.f35436w0 = ofFloat;
            ofFloat.addUpdateListener(new b3(this, 4));
            ValueAnimator valueAnimator2 = this.f35436w0;
            float f12 = this.f35409b.f27129c;
            if (z10) {
                f11 = 1.0f;
            }
            valueAnimator2.setDuration(Math.abs(f12 - f11) * 200.0f);
            this.f35436w0.setInterpolator(org.telegram.ui.Components.qr.f27420f);
            this.f35436w0.start();
        }
    }
    ...
    public final String getInitialSearchString() {
        return this.f35411c.getText().toString();
    }
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        org.telegram.ui.Components.ju juVar = this.f35411c;
        int i11 = org.telegram.ui.ActionBar.i6.G6;
        arrayList.add(new org.telegram.ui.ActionBar.k6(juVar, 4, null, null, null, null, i11));
        org.telegram.ui.Components.ju juVar2 = this.f35411c;
        ...
        org.telegram.ui.Components.ju juVar3 = this.f35411c;
        int i13 = org.telegram.ui.ActionBar.i6.f18961k6;
        arrayList.add(new org.telegram.ui.ActionBar.k6(juVar3, 32, null, null, null, null, i13));
        org.telegram.ui.Components.ju juVar4 = this.f35411c;
        int i14 = org.telegram.ui.ActionBar.i6.f18979l6;
        arrayList.add(new org.telegram.ui.ActionBar.k6(juVar4, 65568, null, null, null, null, i14));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f35435w, 4, null, null, null, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f35435w, 8388608, null, null, null, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f35435w, 32, null, null, null, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f35435w, 65568, null, null, null, null, i14));
        ...
        org.telegram.ui.Cells.x1 x1Var = this.U;
        int i18 = org.telegram.ui.ActionBar.i6.f19053p7;
        ...
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.U, 262148, null, null, null, null, org.telegram.ui.ActionBar.i6.f19181w6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f35414e0, 32, new Class[]{org.telegram.ui.Cells.e9.class}, null, null, null, i16));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f35417g0, 0, new Class[]{org.telegram.ui.Cells.s4.class}, new String[]{"progressBar"}, null, null, -1, null, org.telegram.ui.ActionBar.i6.f18905h6));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.Q, 4096, null, null, null, null, i19));
        int i20 = org.telegram.ui.ActionBar.i6.f18889g7;
        ...
        int i21 = org.telegram.ui.ActionBar.i6.f18906h7;
        ...
        int i22 = org.telegram.ui.ActionBar.i6.f19234z6;
        ...
        int i23 = org.telegram.ui.ActionBar.i6.f19215y6;
    ...
    public final void h0() {
        ...
        String str = null;
        int i16 = 8;
        if (!this.f35408a0 && !this.f35420j0) {
            this.S.setText(LocaleController.getString(R.string.ChangePublicLimitReached));
            org.telegram.ui.Cells.e9 e9Var = this.S;
            int i17 = org.telegram.ui.ActionBar.i6.f19053p7;
            e9Var.setTag(Integer.valueOf(i17));
            this.S.setTextColor(org.telegram.ui.ActionBar.i6.w0(null, i17, false));
            this.M.setVisibility(8);
            this.d.setVisibility(8);
            if (this.f35413d0) {
                this.f35417g0.setVisibility(0);
                this.L.setVisibility(8);
                org.telegram.ui.Cells.e9 e9Var2 = this.S;
                e9Var2.setBackgroundDrawable(org.telegram.ui.ActionBar.i6.V0(e9Var2.getContext(), R.drawable.greydivider_bottom, org.telegram.ui.ActionBar.i6.f18798b7));
                this.f35414e0.setVisibility(8);
            } else {
                org.telegram.ui.Cells.e9 e9Var3 = this.S;
                e9Var3.setBackgroundDrawable(org.telegram.ui.ActionBar.i6.V0(e9Var3.getContext(), R.drawable.greydivider, org.telegram.ui.ActionBar.i6.f18798b7));
                this.f35417g0.setVisibility(8);
                this.L.setVisibility(0);
                this.f35414e0.setVisibility(0);
            }
        } else {
            ...
            e9Var5.setBackgroundDrawable(org.telegram.ui.ActionBar.i6.V0(e9Var5.getContext(), R.drawable.greydivider_bottom, org.telegram.ui.ActionBar.i6.f18798b7));
            ...
            TLRPC.TL_chatInviteExported tL_chatInviteExported = this.f35412c0;
            if (tL_chatInviteExported != null) {
                str = tL_chatInviteExported.link;
            }
            v80Var.setLink(str);
            org.telegram.ui.Cells.x1 x1Var = this.U;
            if (!this.f35408a0 && x1Var.length() != 0) {
                i16 = 0;
            }
            x1Var.setVisibility(i16);
        }
        this.Q.a(!this.f35408a0);
        this.R.a(this.f35408a0);
        this.f35435w.clearFocus();
        AndroidUtilities.hideKeyboard(this.f35435w);
    }
    ...
    public final boolean onFragmentCreate() {
        ...
        if (this.f35418h0 == 1 && !this.f35410b0 && this.f35412c0 == null) {
            MessagesController messagesController = getMessagesController();
            long j3 = this.f35419i0;
            TLRPC.ChatFull chatFull = messagesController.getChatFull(j3);
            if (chatFull != null) {
                this.f35412c0 = chatFull.exported_invite;
            }
            if (this.f35412c0 == null) {
                this.f35410b0 = true;
    ...
    public final void onFragmentDestroy() {
        ...
        if (this.f35431s0 != null) {
            ConnectionsManager.getInstance(this.currentAccount).cancelRequest(this.f35431s0.intValue(), true);
            this.f35431s0 = null;
        }
    ...
    public final void onTransitionAnimationEnd(boolean z10, boolean z11) {
        if (z10 && this.f35418h0 != 1) {
            this.f35411c.requestFocus();
            org.telegram.ui.Components.eu euVar = this.f35411c.f25419a;
            euVar.requestFocus();
