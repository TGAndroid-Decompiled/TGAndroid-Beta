...
public final class mg implements Utilities.Callback2 {
    ...
    public final void run(Object obj, Object obj2) {
        ...
        Object obj3 = this.d;
        Object obj4 = this.f35802c;
        switch (i10) {
            case 0:
                AndroidUtilities.runOnUIThread(new ei.l3((bo) obj4, this.f35801b, (Boolean) obj, (TLRPC.WebPage) obj2, (TL_account.getWebPagePreview) obj3, 15));
                return;
            case 1:
                ...
                AndroidUtilities.runOnUIThread(new ei.l3(launchActivity, oa0Var, tL_error, updates, this.f35801b, 25));
                return;
            default:
                PasskeysActivity passkeysActivity = (PasskeysActivity) obj4;
                TL_account.Passkey passkey = (TL_account.Passkey) obj3;
                TLRPC.TL_error tL_error2 = (TLRPC.TL_error) obj2;
                ArrayList arrayList = passkeysActivity.f30912b;
