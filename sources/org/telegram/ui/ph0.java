...
public final class ph0 extends org.telegram.ui.Components.rl0 {
    public final Context f40019c;
    public final qh0 d;

    public ph0(qh0 qh0Var, Context context) {
        this.d = qh0Var;
        this.f40019c = context;
    }
    ...
    public final boolean D(f2.m1 m1Var) {
        int b10 = m1Var.b();
        qh0 qh0Var = this.d;
        if (qh0Var.N != b10 && qh0Var.f40506x != b10) {
            if (b10 < qh0Var.f40507y || b10 >= qh0Var.B) {
    ...
    public final int j(int i10) {
        qh0 qh0Var = this.d;
        if (i10 == qh0Var.f40503r) {
            return 0;
        }
        if (i10 == qh0Var.f40504s || i10 == qh0Var.I || i10 == qh0Var.P || i10 == qh0Var.M) {
            return 1;
        }
        if (i10 == qh0Var.v) {
            return 2;
        }
        if (i10 == qh0Var.f40506x) {
            return 3;
        }
        if (i10 != qh0Var.f40505w && i10 != qh0Var.G && i10 != qh0Var.J && i10 != qh0Var.O && i10 != qh0Var.Q) {
            if (i10 < qh0Var.f40507y || i10 >= qh0Var.B) {
    ...
    public final f2.m1 x(ViewGroup viewGroup, int i10) {
        ...
        int i11;
        qh0 qh0Var = this.d;
        Context context = this.f40019c;
        switch (i10) {
            case 1:
                y80Var = new org.telegram.ui.Cells.m4(context, 23);
                break;
            case 2:
                org.telegram.ui.Components.y80 y80Var2 = new org.telegram.ui.Components.y80(this.f40019c, qh0Var, null, true, qh0Var.h);
            ...
            case 9:
                ...
                break;
            case 10:
                y80Var = new org.telegram.ui.Cells.b5(8, 6, this.f40019c, null, false);
                break;
            case 11:
