...
public final class uz implements View.OnClickListener {
    ...
    public final void onClick(View view) {
        switch (this.f41370a) {
            case 0:
                a00 a00Var = this.f41371b;
                String str = a00Var.f41722s;
                if (str != null) {
                    AndroidUtilities.addToClipboard(str);
                    org.telegram.messenger.vl.o(R.string.LinkCopied, org.telegram.ui.Components.yc.a0(a00Var.f41721r));
                    return;
                }
                return;
            case 1:
                a00 a00Var2 = this.f41371b;
                FrameLayout frameLayout = a00Var2.f41715a;
                ...
                float[] fArr = a00Var2.f41725y;
                if (a00Var2.f41724x == null && a00Var2.f41722s != null) {
                    ...
                    FrameLayout overlayContainerView = a00Var2.f41721r.getParentLayout().getOverlayContainerView();
                    if (overlayContainerView != null) {
                        ...
                        a00Var2.f41724x = n1Var;
                        n1Var.setOnDismissListener(new org.telegram.ui.Components.s80(a00Var2, r6Var, overlayContainerView, eiVar, 1));
                        a00Var2.f41724x.setOutsideTouchable(true);
                        a00Var2.f41724x.setFocusable(true);
                        a00Var2.f41724x.setBackgroundDrawable(new ColorDrawable(0));
                        a00Var2.f41724x.setAnimationStyle(R.style.PopupContextAnimation);
                        a00Var2.f41724x.setInputMethodMode(2);
                        a00Var2.f41724x.setSoftInputMode(0);
                        ...
                        a00Var2.f41724x.showAtLocation(overlayContainerView, 0, (int) (overlayContainerView.getX() + ((overlayContainerView.getMeasuredWidth() - actionBarPopupWindow$ActionBarPopupWindowLayout.getMeasuredWidth()) - AndroidUtilities.dp(16.0f)) + f10), (int) (overlayContainerView.getY() + f7 + frameLayout.getMeasuredHeight()));
                        return;
                    }
                    return;
                }
                return;
            case 2:
                a00 a00Var3 = this.f41371b;
                String str2 = a00Var3.f41722s;
                if (str2 != null) {
                    AndroidUtilities.addToClipboard(str2);
                    org.telegram.messenger.vl.o(R.string.LinkCopied, org.telegram.ui.Components.yc.a0(a00Var3.f41721r));
                    return;
                }
                return;
            case 3:
                a00 a00Var4 = this.f41371b;
                if (a00Var4.f41722s != null) {
                    try {
                        Intent intent = new Intent("android.intent.action.SEND");
                        intent.setType("text/plain");
                        intent.putExtra("android.intent.extra.TEXT", a00Var4.f41722s);
                        a00Var4.f41721r.startActivityForResult(Intent.createChooser(intent, LocaleController.getString(R.string.InviteToGroupByLink)), 500);
                        return;
                    } catch (Exception e7) {
                        FileLog.e(e7);
                        return;
                ...
                return;
            case 4:
                a00 a00Var5 = this.f41371b;
                org.telegram.ui.ActionBar.n1 n1Var2 = a00Var5.f41724x;
                if (n1Var2 != null) {
                    n1Var2.d(true);
                }
                c00 c00Var = a00Var5.E.f34579c;
                ...
                if (tL_exportedChatlistInvite != null && tL_exportedChatlistInvite.url != null) {
                    ...
                    alertDialog$Builder.f20198a.I = org.telegram.ui.ActionBar.j6.H5;
                    alertDialog$Builder.f20198a.R = LocaleController.getString(R.string.FilterInviteEditName);
                    ...
                    editTextBoldCursor.setHint(c00Var.f34955c.name);
                    editTextBoldCursor.setHintTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20953t5, false));
                ...
                return;
            case 5:
                a00 a00Var6 = this.f41371b;
                org.telegram.ui.ActionBar.n1 n1Var3 = a00Var6.f41724x;
                if (n1Var3 != null) {
                    n1Var3.d(true);
                }
                if (a00Var6.f41722s != null) {
                    org.telegram.ui.Components.ji0 ji0Var = new org.telegram.ui.Components.ji0(a00Var6.getContext(), LocaleController.getString(R.string.InviteByQRCode), a00Var6.f41722s, LocaleController.getString(R.string.QRCodeLinkHelpFolder), false);
                ...
                return;
            default:
                a00 a00Var7 = this.f41371b;
                org.telegram.ui.ActionBar.n1 n1Var4 = a00Var7.f41724x;
                if (n1Var4 != null) {
                    n1Var4.d(true);
                }
                ...
                c00 c00Var2 = a00Var7.E.f34579c;
                tL_inputChatlistDialogFilter.filter_id = c00Var2.f34955c.f17080id;
