...
public final class o60 extends org.telegram.ui.Components.kl0 {
    public ChatObject.Call f36107c;
    public final int d;
    public ArrayList f36108f;
    public a40 h;
    public final i60 f36109n;
    public final ArrayList e = new ArrayList();
    public boolean f36110r = false;
    ...
    public final void E(org.telegram.ui.Components.voip.l lVar, boolean z10) {
        if (z10 && lVar.getRenderer() == null) {
            lVar.setRenderer(org.telegram.ui.Components.voip.u.c(this.f36108f, this.h, null, null, lVar, lVar.getParticipant(), this.f36107c, this.f36109n));
    ...
    public final int F() {
        org.telegram.ui.Components.ll0 ll0Var = this.f36109n.f34463n2;
    ...
    public final void I(org.telegram.ui.Components.ll0 ll0Var, boolean z10) {
        ...
        if (z10) {
            ...
            arrayList.clear();
            arrayList.addAll(this.f36107c.visibleVideoParticipants);
    ...
    public final void v(s4.c1 c1Var, int i10) {
        org.telegram.ui.Components.voip.l lVar = (org.telegram.ui.Components.voip.l) c1Var.f42675a;
        ...
        MessageObject.getPeerId(this.f36107c.selfPeer);
