...
public final class vx0 implements GenericProvider, org.telegram.ui.Components.ml0, v60 {
    ...
    public boolean d(int i10, View view) {
        yx0 yx0Var = this.f38846a;
        if (i10 >= yx0Var.f40273r && i10 < yx0Var.f40274s) {
            if (yx0Var.f40277y == 1) {
                yx0Var.U(Long.valueOf(yx0Var.getMessagesController().blockePeers.keyAt(i10 - yx0Var.f40273r)), view);
                return true;
            }
            throw null;
        }
    ...
    public Object provide(Object obj) {
        yx0 yx0Var = this.f38846a;
        yx0Var.getClass();
        if (((Integer) obj).intValue() != yx0Var.f40275w) {
            return null;
        }
