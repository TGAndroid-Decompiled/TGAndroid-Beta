...
public final class vx0 implements View.OnClickListener {
    ...
    public final ProfileActivity f42230b;

    public vx0(ProfileActivity profileActivity, int i10) {
        this.f42229a = i10;
        this.f42230b = profileActivity;
    }

    @Override
    public final void onClick(View view) {
        int i10 = this.f42229a;
        ProfileActivity profileActivity = this.f42230b;
        switch (i10) {
            case 0:
                    ...
                    while (i11 < profileActivity.getParentLayout().getFragmentStack().size()) {
                        ...
                        if (p2Var instanceof py) {
                            ...
                            if (kxVar != null) {
                                ...
                                if ((fragment instanceof sf1) && (-((sf1) fragment).f41188a) == profileActivity.a()) {
                                    pyVar.C3.a();
                                }
                            }
                            ...
                            if ((-((sf1) p2Var).f41188a) == profileActivity.a()) {
                                ((ActionBarLayout) profileActivity.getParentLayout()).a0(p2Var, false);
                                i11--;
                            }
