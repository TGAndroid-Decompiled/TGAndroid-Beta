...
public final class StarsController$$ExternalSyntheticLambda16 implements DialogInterface.OnDismissListener {
    public final int $r8$classId;
    public final Utilities.Callback2 f$0;
    public final boolean[] f$1;

    public StarsController$$ExternalSyntheticLambda16(Utilities.Callback2 callback2, boolean[] zArr, int i) {
        this.$r8$classId = i;
        this.f$0 = callback2;
        this.f$1 = zArr;
    }
