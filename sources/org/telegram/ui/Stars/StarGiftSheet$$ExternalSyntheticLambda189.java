...
public final class StarGiftSheet$$ExternalSyntheticLambda189 implements Runnable {
    public final int $r8$classId;
    public final GiftMessageBottomSheet f$0;

    public StarGiftSheet$$ExternalSyntheticLambda189(GiftMessageBottomSheet giftMessageBottomSheet, int i) {
        this.$r8$classId = i;
