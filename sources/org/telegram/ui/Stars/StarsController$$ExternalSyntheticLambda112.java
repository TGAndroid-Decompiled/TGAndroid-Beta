...
public final class StarsController$$ExternalSyntheticLambda112 implements Utilities.Callback2 {
    public final int $r8$classId = 0;
    public final Utilities.Callback f$0;
    public final boolean[] f$1;
    public final Utilities.Callback2 f$2;

    public StarsController$$ExternalSyntheticLambda112(Utilities.Callback callback, boolean[] zArr, Utilities.Callback2 callback2) {
        this.f$0 = callback;
        this.f$1 = zArr;
        this.f$2 = callback2;
    }
    ...
    public StarsController$$ExternalSyntheticLambda112(boolean[] zArr, Utilities.Callback2 callback2, Utilities.Callback callback) {
        this.f$1 = zArr;
        this.f$2 = callback2;
        this.f$0 = callback;
    }
