...
public final class StarsIntroActivity$$ExternalSyntheticLambda4 implements Runnable {
    public final int $r8$classId;
    public final BottomSheet[] f$0;
    public final TL_stars.StarsTransaction f$1;
    public final long f$2;

    public StarsIntroActivity$$ExternalSyntheticLambda4(BottomSheet[] bottomSheetArr, long j, TL_stars.StarsTransaction starsTransaction) {
        this.$r8$classId = 3;
            ...
            case 0:
                ...
                if (safeLastFragment != null) {
                    ...
                    if (i == 0) {
                        ...
                        safeLastFragment.presentFragment(ChatActivity.of(starsTransaction.giveaway_post_id, j));
                    }
                }
                break;
            case 1:
                ...
                if (safeLastFragment2 != null) {
                    ...
                    if (i2 == 0) {
                        ...
                        safeLastFragment2.presentFragment(ChatActivity.of(starsTransaction2.giveaway_post_id, j2));
                    }
                }
                break;
            case 2:
                ...
                if (safeLastFragment3 != null) {
                    ...
                    if (i3 == 0) {
                        ...
                        safeLastFragment3.presentFragment(ChatActivity.of(starsTransaction3.giveaway_post_id, j3));
                    }
                }
                break;
            case 3:
            ...
            default:
                ...
                if (safeLastFragment5 != null) {
                    ...
                    if (i4 == 0) {
                        ...
                        safeLastFragment5.presentFragment(ChatActivity.of(starsTransaction4.giveaway_post_id, j4));
                    }
                }
                break;
        }
    ...
    public StarsIntroActivity$$ExternalSyntheticLambda4(BottomSheet[] bottomSheetArr, TL_stars.StarsTransaction starsTransaction, long j, int i) {
        this.$r8$classId = i;
        this.f$0 = bottomSheetArr;
        this.f$1 = starsTransaction;
        this.f$2 = j;
