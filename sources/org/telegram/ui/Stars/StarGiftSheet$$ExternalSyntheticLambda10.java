...
public final class StarGiftSheet$$ExternalSyntheticLambda10 implements View.OnClickListener {
    public final int $r8$classId;
    public final StarGiftSheet f$0;
    public final int f$1;

    public StarGiftSheet$$ExternalSyntheticLambda10(StarGiftSheet starGiftSheet, int i, int i2) {
        this.$r8$classId = i2;
    ...
    public final void onClick(View view) {
        switch (this.$r8$classId) {
            case 0:
                ...
                anonymousClass2.scrollToPosition(anonymousClass2.getCurrentPosition() + (i > starGiftSheet.getListPosition$1() ? 1 : -1));
                break;
            case 1:
                ...
                anonymousClass3.scrollToPosition(anonymousClass3.getCurrentPosition() + (i2 > starGiftSheet2.getListPosition$1() ? 1 : -1));
                break;
            case 2:
                ...
                anonymousClass4.scrollToPosition(anonymousClass4.getCurrentPosition() + (i3 > starGiftSheet3.getListPosition$1() ? 1 : -1));
                break;
            default:
                ...
                anonymousClass5.scrollToPosition(anonymousClass5.getCurrentPosition() + (i4 > starGiftSheet4.getListPosition$1() ? 1 : -1));
                break;
        }
    }
}
