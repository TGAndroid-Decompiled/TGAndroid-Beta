...
public final class StarsController$$ExternalSyntheticLambda61 implements Utilities.Callback {
    ...
    public StarsController$$ExternalSyntheticLambda61(StarsController starsController, int i, Utilities.Callback callback, boolean[] zArr, Utilities.Callback callback2) {
    ...
    public StarsController$$ExternalSyntheticLambda61(StarsController starsController, boolean[] zArr, int i, Utilities.Callback callback, Utilities.Callback callback2) {
        this.f$0 = starsController;
        this.f$3 = zArr;
        this.f$1 = i;
        this.f$2 = callback;
