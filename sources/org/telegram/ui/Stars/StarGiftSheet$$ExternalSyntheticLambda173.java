...
public final class StarGiftSheet$$ExternalSyntheticLambda173 implements Runnable {
    ...
    public StarGiftSheet$$ExternalSyntheticLambda173(StarGiftSheet starGiftSheet, TLRPC.TL_error tL_error, TLObject tLObject, TwoStepVerificationActivity twoStepVerificationActivity) {
        ...
        switch (this.$r8$classId) {
            ...
            default:
                ...
                if (this.f$1 == null) {
                    ...
                    TwoStepVerificationActivity twoStepVerificationActivity = this.f$2;
    ...
    public StarGiftSheet$$ExternalSyntheticLambda173(StarGiftSheet starGiftSheet, TLRPC.TL_error tL_error, TwoStepVerificationActivity twoStepVerificationActivity, TLObject tLObject) {
        this.f$0 = starGiftSheet;
        this.f$1 = tL_error;
        this.f$2 = twoStepVerificationActivity;
        this.f$3 = tLObject;
