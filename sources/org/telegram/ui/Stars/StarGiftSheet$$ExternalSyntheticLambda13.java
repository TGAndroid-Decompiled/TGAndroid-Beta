...
public final class StarGiftSheet$$ExternalSyntheticLambda13 implements Runnable {
    public final int $r8$classId;
    public final StarGiftSheet f$0;
    public final String f$1;

    public StarGiftSheet$$ExternalSyntheticLambda13(StarGiftSheet starGiftSheet, String str, int i) {
        this.$r8$classId = i;
