...
public class StarsController {
    ...
    public static void m4213$r8$lambda$_CaaQE60qTIO9sLAkjRqiU8go() {
    }
    ...
    public static void $r8$lambda$6JEx8_TrfbXFHKbKcMqJfI7YAVM(final StarsController starsController, final TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        AndroidUtilities.runOnUIThread(new Runnable() {
            @Override
            public final void run() {
                StarsController.m4211$r8$lambda$UWon6LcgZnftrsCWmL7Ghso3DE(this.f$0, tLObject);
            }
        });
    }

    public static void m4211$r8$lambda$UWon6LcgZnftrsCWmL7Ghso3DE(final StarsController starsController, TLObject tLObject) {
        starsController.getClass();
    ...
    public static void $r8$lambda$HvmJ62FicKm0RQQVOBWgWPj4zdg(final StarsController starsController, final ArrayList arrayList) {
        ...
        BillingController.getInstance().queryProductDetails(arrayList2, new BillingController.ProductDetailsResponseListenerLegacy() {
            ...
            public final void onProductDetailsResponse(BillingResult billingResult, List list) {
                StarsController.m4214$r8$lambda$aQBbLDlxm68EHYJOylDwiuZWnc(this.f$0, arrayList, billingResult, list);
            }
        });
    }

    public static void m4214$r8$lambda$aQBbLDlxm68EHYJOylDwiuZWnc(final StarsController starsController, final ArrayList arrayList, final BillingResult billingResult, final List list) {
        starsController.getClass();
        AndroidUtilities.runOnUIThread(new Runnable() {
            @Override
            public final void run() {
    ...
    public ArrayList getGiftOptions() {
        ...
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(new TL_stars.TL_payments_getStarsGiftOptions(), new RequestDelegate() {
            @Override
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                StarsController.m4212$r8$lambda$XR9EsXeH550JhyzqVdx4zkRfw8(this.f$0, tLObject, tL_error);
            }
        });
        return this.giftOptions;
    }

    public static void m4212$r8$lambda$XR9EsXeH550JhyzqVdx4zkRfw8(final StarsController starsController, final TLObject tLObject, TLRPC.TL_error tL_error) {
        starsController.getClass();
        AndroidUtilities.runOnUIThread(new Runnable() {
            @Override
            public final void run() {
    ...
    public static void $r8$lambda$E2pgljsMpDTlGFSzrWlQyTVBVlc(final StarsController starsController, final ArrayList arrayList) {
        ...
        BillingController.getInstance().queryProductDetails(arrayList2, new BillingController.ProductDetailsResponseListenerLegacy() {
            @Override
            public final void onProductDetailsResponse(BillingResult billingResult, List list) {
                StarsController.m4222$r8$lambda$oYKWwxdPXz_VU79ULkKrCY2CoY(this.f$0, arrayList, billingResult, list);
            }
        });
    }

    public static void m4222$r8$lambda$oYKWwxdPXz_VU79ULkKrCY2CoY(final StarsController starsController, final ArrayList arrayList, final BillingResult billingResult, final List list) {
        starsController.getClass();
        AndroidUtilities.runOnUIThread(new Runnable() {
            @Override
            public final void run() {
    ...
    public ArrayList getGiveawayOptions() {
        ...
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(new TL_stars.TL_payments_getStarsGiveawayOptions(), new RequestDelegate() {
            @Override
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                StarsController.m4229$r8$lambda$zSf1Ixy5O01ZT_aMdOiA1Xo0w(this.f$0, tLObject, tL_error);
            }
        });
        return this.giveawayOptions;
    }

    public static void m4229$r8$lambda$zSf1Ixy5O01ZT_aMdOiA1Xo0w(final StarsController starsController, final TLObject tLObject, TLRPC.TL_error tL_error) {
        starsController.getClass();
        AndroidUtilities.runOnUIThread(new Runnable() {
            @Override
            public final void run() {
    ...
    public static void $r8$lambda$Qobo3ysRaIGdmaNh6nsqCdiX_R4(final StarsController starsController, final ArrayList arrayList) {
        ...
        BillingController.getInstance().queryProductDetails(arrayList2, new BillingController.ProductDetailsResponseListenerLegacy() {
            @Override
            public final void onProductDetailsResponse(BillingResult billingResult, List list) {
                StarsController.m4197$r8$lambda$AN3SoZPVLKKLVvX4h4MoI67qE(this.f$0, arrayList, billingResult, list);
            }
        });
    }

    public static void m4197$r8$lambda$AN3SoZPVLKKLVvX4h4MoI67qE(final StarsController starsController, final ArrayList arrayList, final BillingResult billingResult, final List list) {
        starsController.getClass();
        AndroidUtilities.runOnUIThread(new Runnable() {
            @Override
            public final void run() {
    ...
    public static void $r8$lambda$DRcRo4H7xRsZHcu9fbSAa2BDsy8(final StarsController starsController, final TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        AndroidUtilities.runOnUIThread(new Runnable() {
            @Override
            public final void run() {
                StarsController.m4219$r8$lambda$j2kZ3TUVuqEfHIbcjteQk233Uk(this.f$0, tLObject);
            }
        });
    }

    public static void m4219$r8$lambda$j2kZ3TUVuqEfHIbcjteQk233Uk(StarsController starsController, TLObject tLObject) {
        starsController.subscriptionsLoading = false;
        if (tLObject instanceof TL_stars.StarsStatus) {
            TL_stars.StarsStatus starsStatus = (TL_stars.StarsStatus) tLObject;
            MessagesController.getInstance(starsController.currentAccount).putUsers(starsStatus.users, false);
    ...
    public void loadInsufficientSubscriptions() {
        ...
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_getStarsSubscriptions, new RequestDelegate() {
            @Override
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                StarsController.m4204$r8$lambda$MJdSoWK4CTwte4cus4ccMb8rD8(this.f$0, tLObject, tL_error);
            }
        });
    }

    public static void m4204$r8$lambda$MJdSoWK4CTwte4cus4ccMb8rD8(final StarsController starsController, final TLObject tLObject, TLRPC.TL_error tL_error) {
        starsController.getClass();
        AndroidUtilities.runOnUIThread(new Runnable() {
            @Override
            public final void run() {
    ...
    public void showStarsTopupInternal(Activity activity, long j, String str) {
        ...
        new StarsIntroActivity.StarsNeededSheet(activity, null, j, 4, str, new Runnable() {
            @Override
            public final void run() {
                StarsController.m4213$r8$lambda$_CaaQE60qTIO9sLAkjRqiU8go();
            }
        }, 0L).show();
    }
    ...
    public void buy(final Activity activity, final TL_stars.TL_starsTopupOption tL_starsTopupOption, final Utilities.Callback2 callback2, TLRPC.InputPeer inputPeer) {
        ...
        if ((BuildVars.useInvoiceBilling() || !BillingController.getInstance().isReady()) && !zIsInvoiceBillingDisabled) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_payments_getPaymentForm, new RequestDelegate() {
                @Override
                public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                    StarsController.m4210$r8$lambda$URwfflcKYUwRheceHB4mKvlQYc(this.f$0, callback2, tL_inputInvoiceStars, tLObject, tL_error);
                }
            });
            return;
        }
    ...
    public static void m4210$r8$lambda$URwfflcKYUwRheceHB4mKvlQYc(final StarsController starsController, final Utilities.Callback2 callback2, final TLRPC.TL_inputInvoiceStars tL_inputInvoiceStars, final TLObject tLObject, final TLRPC.TL_error tL_error) {
        starsController.getClass();
        AndroidUtilities.runOnUIThread(new Runnable() {
            @Override
            public final void run() {
    ...
    public static void $r8$lambda$DErIybbYfQ854cklBZI8aDA5518(List list, final Utilities.Callback2 callback2, TLRPC.TL_inputStorePaymentStarsTopup tL_inputStorePaymentStarsTopup, TL_stars.TL_starsTopupOption tL_starsTopupOption, Activity activity) {
        ...
        BillingController.getInstance().setOnCanceled(new Runnable() {
            @Override
            public final void run() {
                StarsController.m4206$r8$lambda$N4Q4pfKNiiMlcRyDII8I9qqz4Y(callback2);
            }
        });
    ...
    public static void m4206$r8$lambda$N4Q4pfKNiiMlcRyDII8I9qqz4Y(final Utilities.Callback2 callback2) {
    ...
    public void buyGiveaway(final Activity activity, TLRPC.Chat chat, List list, TL_stars.TL_starsGiveawayOption tL_starsGiveawayOption, int i, List list2, int i2, boolean z, boolean z2, boolean z3, String str, final Utilities.Callback2 callback2) {
        ...
        if (BuildVars.useInvoiceBilling() || !BillingController.getInstance().isReady() || tL_starsGiveawayOption.store_product == null) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_payments_getPaymentForm, new RequestDelegate() {
                ...
                public final void run(TLObject tLObject2, TLRPC.TL_error tL_error) {
                    StarsController.m4202$r8$lambda$JXQGlRm1HTbT0yavfgmbYhrmng(this.f$0, callback2, tL_inputInvoiceStars, tLObject2, tL_error);
                }
            });
            return;
        }
        BillingController.getInstance().queryProductDetails(Arrays.asList(QueryProductDetailsParams.Product.newBuilder().setProductType("inapp").setProductId(tL_starsGiveawayOption.store_product).build()), new BillingController.ProductDetailsResponseListenerLegacy() {
            ...
            public final void onProductDetailsResponse(BillingResult billingResult, List list3) {
                StarsController.m4228$r8$lambda$zMx6ZT729rZf200ZLOgAnJZ6E(this.f$0, callback2, tL_inputStorePaymentStarsGiveaway, activity, billingResult, list3);
            }
        });
    }

    public static void m4202$r8$lambda$JXQGlRm1HTbT0yavfgmbYhrmng(final StarsController starsController, final Utilities.Callback2 callback2, final TLRPC.TL_inputInvoiceStars tL_inputInvoiceStars, final TLObject tLObject, final TLRPC.TL_error tL_error) {
        starsController.getClass();
        AndroidUtilities.runOnUIThread(new Runnable() {
            @Override
            public final void run() {
    ...
    public static void m4228$r8$lambda$zMx6ZT729rZf200ZLOgAnJZ6E(final StarsController starsController, final Utilities.Callback2 callback2, final TLRPC.TL_inputStorePaymentStarsGiveaway tL_inputStorePaymentStarsGiveaway, final Activity activity, final BillingResult billingResult, final List list) {
        starsController.getClass();
        AndroidUtilities.runOnUIThread(new Runnable() {
            @Override
            public final void run() {
                StarsController.m4208$r8$lambda$QyeXIYYWo68_mwcW4Tp3NZSXNU(this.f$0, list, callback2, tL_inputStorePaymentStarsGiveaway, billingResult, activity);
            }
        });
    }

    public static void m4208$r8$lambda$QyeXIYYWo68_mwcW4Tp3NZSXNU(StarsController starsController, final List list, final Utilities.Callback2 callback2, final TLRPC.TL_inputStorePaymentStarsGiveaway tL_inputStorePaymentStarsGiveaway, final BillingResult billingResult, final Activity activity) {
        starsController.getClass();
        if (list.isEmpty()) {
            AndroidUtilities.runOnUIThread(new Runnable() {
                @Override
        ...
        ConnectionsManager.getInstance(starsController.currentAccount).sendRequest(tL_payments_canPurchaseStore, new RequestDelegate() {
            ...
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                AndroidUtilities.runOnUIThread(new Runnable() {
                    @Override
                    public final void run() {
                        StarsController.m4223$r8$lambda$qE9Zs7WyGEKPaMBs3dblGFThSk(tLObject, productDetails, billingResult, callback2, activity, tL_inputStorePaymentStarsGiveaway, list, tL_error);
                    }
                });
            }
        });
    ...
    public static void m4223$r8$lambda$qE9Zs7WyGEKPaMBs3dblGFThSk(TLObject tLObject, ProductDetails productDetails, final BillingResult billingResult, final Utilities.Callback2 callback2, Activity activity, TLRPC.TL_inputStorePaymentStarsGiveaway tL_inputStorePaymentStarsGiveaway, List list, TLRPC.TL_error tL_error) {
        if (tLObject instanceof TLRPC.TL_boolTrue) {
            BillingController.getInstance().addResultListener(productDetails.getProductId(), new Consumer() {
                @Override
                public final void accept(Object obj) {
    ...
    public static void $r8$lambda$8S9fwiWKQY64lRcnVMPHf2SOWYU(final StarsController starsController, final MessageObject messageObject, final TLRPC.TL_inputInvoiceMessage tL_inputInvoiceMessage, final Runnable runnable, final TLObject tLObject, final TLRPC.TL_error tL_error) {
        ...
        AndroidUtilities.runOnUIThread(new Runnable() {
            @Override
            public final void run() {
                StarsController.m4218$r8$lambda$gF8ltFeuI57iYH_GifzSnPd6VE(this.f$0, tLObject, messageObject, tL_inputInvoiceMessage, runnable, tL_error);
            }
        });
    }

    public static void m4218$r8$lambda$gF8ltFeuI57iYH_GifzSnPd6VE(StarsController starsController, TLObject tLObject, MessageObject messageObject, TLRPC.TL_inputInvoiceMessage tL_inputInvoiceMessage, Runnable runnable, TLRPC.TL_error tL_error) {
        starsController.getClass();
            ...
            if (context2 != null) {
                ...
                StarsIntroActivity.openConfirmPurchaseSheet(context2, resourceProvider, this.currentAccount, messageObject, j2, str, j3, tL_payments_paymentFormStars.photo, i2, new Utilities.Callback() {
                    ...
                    public final void run(Object obj) {
                        StarsController.m4194$r8$lambda$1EOvTkJw3L653tBUEcQgrPyEWs(this.f$0, j3, zArr, callback, context2, resourceProvider, z, userName, messageObject, inputInvoice, tL_payments_paymentFormStars, i2, j2, (Utilities.Callback) obj);
                    }
                }, new Runnable() {
                    @Override
                    public final void run() {
                        StarsController.m4215$r8$lambda$dDVmgmPFHBhm3NQ591YnR9aR8s(this.f$0, zArr, callback);
                    }
                });
            }
        }
    ...
    public static void m4194$r8$lambda$1EOvTkJw3L653tBUEcQgrPyEWs(final StarsController starsController, long j, final boolean[] zArr, final Utilities.Callback callback, Context context, Theme.ResourcesProvider resourcesProvider, boolean z, String str, final MessageObject messageObject, final TLRPC.InputInvoice inputInvoice, final TLRPC.TL_payments_paymentFormStars tL_payments_paymentFormStars, final int i, long j2, final Utilities.Callback callback2) {
    ...
    public static void $r8$lambda$FRZeScknA6YrbNU1kriAH6bC2Vk(final StarsController starsController, boolean[] zArr, MessageObject messageObject, TLRPC.InputInvoice inputInvoice, TLRPC.TL_payments_paymentFormStars tL_payments_paymentFormStars, final boolean[] zArr2, final int i, final Utilities.Callback callback, final Utilities.Callback callback2) {
        ...
        starsController.payAfterConfirmed(messageObject, inputInvoice, tL_payments_paymentFormStars, new Utilities.Callback() {
            @Override
            public final void run(Object obj) {
                StarsController.m4230$r8$lambda$zcOFQ6YN5XqO0Jcn6o9mWXitk0(this.f$0, zArr2, i, callback, callback2, (Boolean) obj);
            }
        });
    }

    public static void m4230$r8$lambda$zcOFQ6YN5XqO0Jcn6o9mWXitk0(StarsController starsController, boolean[] zArr, int i, Utilities.Callback callback, Utilities.Callback callback2, Boolean bool) {
        starsController.getClass();
        zArr[0] = true;
        if (i > 0) {
    ...
    public static void m4215$r8$lambda$dDVmgmPFHBhm3NQ591YnR9aR8s(StarsController starsController, boolean[] zArr, Utilities.Callback callback) {
        starsController.paymentFormOpened = false;
        if (zArr[0] || callback == null) {
            return;
        }
    ...
    public static void $r8$lambda$kbAD7BpEa74bhP6cw7ZRffBjcCw(StarsController starsController, boolean[] zArr, String str, TLRPC.ChatInvite chatInvite, final boolean[] zArr2, final Utilities.Callback2 callback2, final Utilities.Callback callback) {
        ...
        starsController.payAfterConfirmed(str, chatInvite, new Utilities.Callback2() {
            @Override
            public final void run(Object obj, Object obj2) {
                StarsController.m4231$r8$lambda$znJy1AHu4aZaErIcGDMC8oLPo(zArr2, callback2, callback, (Long) obj, (Boolean) obj2);
            }
        });
    }

    public static void m4231$r8$lambda$znJy1AHu4aZaErIcGDMC8oLPo(boolean[] zArr, Utilities.Callback2 callback2, Utilities.Callback callback, Long l, Boolean bool) {
        zArr[0] = true;
        if (callback2 != null) {
    ...
    public void payAfterConfirmed(final MessageObject messageObject, final TLRPC.InputInvoice inputInvoice, final TLRPC.TL_payments_paymentFormStars tL_payments_paymentFormStars, final Utilities.Callback callback) {
        ...
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_payments_sendStarsForm, new RequestDelegate() {
            @Override
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                StarsController.m4205$r8$lambda$MuwfEWSSTOAT5rSjAcAunaYPTQ(this.f$0, callback, messageObject, context, j, str, i2, str2, inputInvoice, j2, resourceProvider, tL_payments_paymentFormStars, tLObject, tL_error);
            }
        });
    }

    public static void m4205$r8$lambda$MuwfEWSSTOAT5rSjAcAunaYPTQ(final StarsController starsController, final Utilities.Callback callback, final MessageObject messageObject, final Context context, final long j, final String str, final int i, final String str2, final TLRPC.InputInvoice inputInvoice, final long j2, final Theme.ResourcesProvider resourcesProvider, final TLRPC.TL_payments_paymentFormStars tL_payments_paymentFormStars, final TLObject tLObject, final TLRPC.TL_error tL_error) {
        starsController.getClass();
        AndroidUtilities.runOnUIThread(new Runnable() {
            @Override
            public final void run() {
        ...
        if (tL_error != null && "BALANCE_TOO_LOW".equals(tL_error.text)) {
            if (!MessagesController.getInstance(starsController.currentAccount).starsPurchaseAvailable()) {
                ...
                StarsIntroActivity.StarsNeededSheet starsNeededSheet = new StarsIntroActivity.StarsNeededSheet(context, resourcesProvider, j, 0, str, new Runnable() {
                    @Override
                    public final void run() {
                        StarsController.m4209$r8$lambda$T6t5kJP4MDEAlbMFZ889IevwSM(this.f$0, zArr, messageObject, inputInvoice, tL_payments_paymentFormStars, callback);
                    }
                }, j2);
                starsNeededSheet.setOnDismissListener(new DialogInterface.OnDismissListener() {
                    @Override
    ...
    public static void m4209$r8$lambda$T6t5kJP4MDEAlbMFZ889IevwSM(StarsController starsController, boolean[] zArr, MessageObject messageObject, TLRPC.InputInvoice inputInvoice, TLRPC.TL_payments_paymentFormStars tL_payments_paymentFormStars, final Utilities.Callback callback) {
        starsController.getClass();
        zArr[0] = true;
        starsController.payAfterConfirmed(messageObject, inputInvoice, tL_payments_paymentFormStars, new Utilities.Callback() {
            @Override
            public final void run(Object obj) {
                StarsController.m4193$r8$lambda$RZjEMxvYCtyuSt_61udmFKLPfw(callback, (Boolean) obj);
            }
        });
    }

    public static void m4193$r8$lambda$RZjEMxvYCtyuSt_61udmFKLPfw(Utilities.Callback callback, Boolean bool) {
        if (callback != null) {
            callback.run(bool);
        }
    }
    ...
    public static void $r8$lambda$BbneXcS265i5fG2WwiwTs5BnoVA(final StarsController starsController, final Utilities.Callback2 callback2, final long j, final String str, final Context context, final Theme.ResourcesProvider resourcesProvider, final TLRPC.ChatInvite chatInvite, final String str2, final TLObject tLObject, final TLRPC.TL_error tL_error) {
        ...
        AndroidUtilities.runOnUIThread(new Runnable() {
            @Override
            public final void run() {
                StarsController.m4220$r8$lambda$jrXc0sNvoUY9F9rtaLpzfuCEo(this.f$0, tLObject, callback2, j, str, tL_error, context, resourcesProvider, chatInvite, str2);
            }
        });
    }

    public static void m4220$r8$lambda$jrXc0sNvoUY9F9rtaLpzfuCEo(final StarsController starsController, TLObject tLObject, final Utilities.Callback2 callback2, long j, String str, TLRPC.TL_error tL_error, Context context, Theme.ResourcesProvider resourcesProvider, final TLRPC.ChatInvite chatInvite, final String str2) {
        starsController.paymentFormOpened = false;
        BaseFragment lastFragment = LaunchActivity.getLastFragment();
        ...
        if (tL_error == null || !"BALANCE_TOO_LOW".equals(tL_error.text)) {
            ...
            starsNeededSheet.setOnDismissListener(new DialogInterface.OnDismissListener() {
                @Override
                public final void onDismiss(DialogInterface dialogInterface) {
                    StarsController.m4196$r8$lambda$6oxdMonxiNsfmY_HYNHPjtUF7I(callback2, zArr, dialogInterface);
                }
            });
            starsNeededSheet.show();
        }
    ...
    public static void $r8$lambda$J8fuZu3TkOxx51WJIp3a5Afzpw0(StarsController starsController, boolean[] zArr, String str, TLRPC.ChatInvite chatInvite, final Utilities.Callback2 callback2) {
        ...
        starsController.payAfterConfirmed(str, chatInvite, new Utilities.Callback2() {
            @Override
            public final void run(Object obj, Object obj2) {
                StarsController.m4226$r8$lambda$wNJonyjdy9Z4FZ9RC680nAQhM(callback2, (Long) obj, (Boolean) obj2);
            }
        });
    }

    public static void m4226$r8$lambda$wNJonyjdy9Z4FZ9RC680nAQhM(Utilities.Callback2 callback2, Long l, Boolean bool) {
        if (callback2 != null) {
            callback2.run(l, bool);
        }
    }

    public static void m4196$r8$lambda$6oxdMonxiNsfmY_HYNHPjtUF7I(Utilities.Callback2 callback2, boolean[] zArr, DialogInterface dialogInterface) {
    ...
    private void updateMediaPrice(final MessageObject messageObject, final long j, final Runnable runnable, final boolean z) {
        ...
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_editMessage, new RequestDelegate() {
            @Override
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                StarsController.m4225$r8$lambda$w5Kyg7LhyEWFTO58ygUdFZPKY(this.f$0, runnable, z, dialogId, id, messageObject, j, tLObject, tL_error);
            }
        });
    }

    public static void m4225$r8$lambda$w5Kyg7LhyEWFTO58ygUdFZPKY(final StarsController starsController, final Runnable runnable, final boolean z, final long j, final int i, final MessageObject messageObject, final long j2, final TLObject tLObject, final TLRPC.TL_error tL_error) {
        starsController.getClass();
        AndroidUtilities.runOnUIThread(new Runnable() {
            @Override
            public final void run() {
        ...
        if (tLObject instanceof TLRPC.Updates) {
            ...
            if (tL_error != null && FileRefController.isFileRefError(tL_error.text) && !z) {
                ...
                ConnectionsManager.getInstance(starsController.currentAccount).sendRequest(tL_messages_getScheduledMessages, new RequestDelegate() {
                    @Override
                    public final void run(TLObject tLObject2, TLRPC.TL_error tL_error2) {
                        StarsController.m4224$r8$lambda$s7R69qiUn6Ln9T19z4bwvx0HY(this.f$0, messageObject, j2, runnable, tLObject2, tL_error2);
                    }
                });
                return;
            }
    ...
    public static void m4224$r8$lambda$s7R69qiUn6Ln9T19z4bwvx0HY(final StarsController starsController, final MessageObject messageObject, final long j, final Runnable runnable, final TLObject tLObject, TLRPC.TL_error tL_error) {
        starsController.getClass();
        AndroidUtilities.runOnUIThread(new Runnable() {
            @Override
            public final void run() {
    ...
    public static void $r8$lambda$yDo8SPv83PDjdDT8jSf4OT6lyDs(StarsController starsController, ArrayList arrayList, Integer num, Long l, ArrayList arrayList2, ArrayList arrayList3) {
        ...
        Collections.sort(starsController.birthdaySortedGifts, Comparator$EL.thenComparingInt(Comparator$CC.comparingInt(new ToIntFunction() {
            ...
            @Override
            public final int applyAsInt(Object obj) {
                return StarsController.m4203$r8$lambda$LJA61Htjvlsb7cftFmMy3Rd8((TL_stars.StarGift) obj);
            }
        }));
    ...
    public static int m4203$r8$lambda$LJA61Htjvlsb7cftFmMy3Rd8(TL_stars.StarGift starGift) {
        ...
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(getstargifts, new RequestDelegate() {
            ...
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                AndroidUtilities.runOnUIThread(new Runnable() {
                    @Override
                    public final void run() {
                        StarsController.m4199$r8$lambda$EOwRo6RAibLoJMYmUqnoGU6u10(tLObject, callback);
                    }
                });
            }
        });
    ...
    public static void m4199$r8$lambda$EOwRo6RAibLoJMYmUqnoGU6u10(TLObject tLObject, Utilities.Callback callback) {
    ...
    public static void $r8$lambda$L1Im6MTpBfr9oKzasG9SqKi0FlI(final StarsController starsController, TLObject tLObject, TLRPC.TL_error tL_error, final Utilities.Callback2 callback2, TLRPC.TL_inputInvoiceStarGift tL_inputInvoiceStarGift, final Context context, final Theme.ResourcesProvider resourcesProvider, final String str, final TL_stars.StarGift starGift, final boolean z, final boolean z2, final long j, final TLRPC.TL_textWithEntities tL_textWithEntities) {
        ...
        ConnectionsManager.getInstance(starsController.currentAccount).sendRequest(tL_payments_sendStarsForm, new RequestDelegate() {
            @Override
            public final void run(TLObject tLObject2, TLRPC.TL_error tL_error2) {
                StarsController.m4198$r8$lambda$CNQ41l37SdswbgSGQ7busCmyUU(this.f$0, callback2, context, resourcesProvider, j2, str, starGift, z, z2, j, tL_textWithEntities, tLObject2, tL_error2);
            }
        });
    }

    public static void m4198$r8$lambda$CNQ41l37SdswbgSGQ7busCmyUU(final StarsController starsController, final Utilities.Callback2 callback2, final Context context, final Theme.ResourcesProvider resourcesProvider, final long j, final String str, final TL_stars.StarGift starGift, final boolean z, final boolean z2, final long j2, final TLRPC.TL_textWithEntities tL_textWithEntities, final TLObject tLObject, final TLRPC.TL_error tL_error) {
        starsController.getClass();
        AndroidUtilities.runOnUIThread(new Runnable() {
            @Override
            public final void run() {
            ...
            if (tL_error != null && "BALANCE_TOO_LOW".equals(tL_error.text)) {
                if (!MessagesController.getInstance(starsController.currentAccount).starsPurchaseAvailable()) {
                    ...
                    StarsIntroActivity.StarsNeededSheet starsNeededSheet = new StarsIntroActivity.StarsNeededSheet(context, resourcesProvider, j, 6, str, new Runnable() {
                        @Override
                        public final void run() {
                            StarsController.m4207$r8$lambda$PQNsam9xP1WQU53sMyKAJHppp0(this.f$0, zArr, starGift, z, z2, j2, tL_textWithEntities, callback2);
                        }
                    }, 0L);
                    starsNeededSheet.setOnDismissListener(new DialogInterface.OnDismissListener() {
                        @Override
                        public final void onDismiss(DialogInterface dialogInterface) {
                            StarsController.m4221$r8$lambda$nadFl9CkQFfHIYek7Zj3B51CGo(callback2, zArr, dialogInterface);
                        }
                    });
                    starsNeededSheet.show();
                    return;
    ...
    public static void m4207$r8$lambda$PQNsam9xP1WQU53sMyKAJHppp0(StarsController starsController, boolean[] zArr, TL_stars.StarGift starGift, boolean z, boolean z2, long j, TLRPC.TL_textWithEntities tL_textWithEntities, Utilities.Callback2 callback2) {
        starsController.getClass();
        zArr[0] = true;
        starsController.buyStarGift(starGift, z, z2, j, tL_textWithEntities, callback2);
    }

    public static void m4221$r8$lambda$nadFl9CkQFfHIYek7Zj3B51CGo(Utilities.Callback2 callback2, boolean[] zArr, DialogInterface dialogInterface) {
        if (callback2 == null || zArr[0]) {
            return;
        }
        callback2.run(Boolean.FALSE, null);
    ...
    public void getResellingGiftForm(final TL_stars.StarGift starGift, final long j, TLRPC.TL_textWithEntities tL_textWithEntities, boolean z, final Utilities.Callback callback) {
        ...
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_payments_getPaymentForm, new RequestDelegate() {
            @Override
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                StarsController.m4195$r8$lambda$6jX9Dab3_DzikP78lhmkpRwv8(this.f$0, callback, tLObject, tL_error);
            }
        });
    }
    ...
    public static void m4195$r8$lambda$6jX9Dab3_DzikP78lhmkpRwv8(final StarsController starsController, final Utilities.Callback callback, final TLObject tLObject, final TLRPC.TL_error tL_error) {
        starsController.getClass();
        AndroidUtilities.runOnUIThread(new Runnable() {
            @Override
            public final void run() {
                StarsController.m4201$r8$lambda$JOmo2jJGWZwvxnpyxfGlcSKZAs(this.f$0, tLObject, tL_error, callback);
            }
        });
    }

    public static void m4201$r8$lambda$JOmo2jJGWZwvxnpyxfGlcSKZAs(StarsController starsController, TLObject tLObject, TLRPC.TL_error tL_error, Utilities.Callback callback) {
        starsController.getClass();
        if (!(tLObject instanceof TLRPC.TL_payments_paymentFormStarGift)) {
            starsController.bulletinError(tL_error, "NO_PAYMENT_FORM");
            callback.run(null);
    ...
    public static class GiftsCollections {
        ...
        public static void $r8$lambda$aXrbr1JBcQidsThBar62rNr0UU4(final GiftsCollections giftsCollections, final TLObject tLObject, TLRPC.TL_error tL_error) {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() {
                @Override
                public final void run() {
                    StarsController.GiftsCollections.m4232$r8$lambda$Dnzr_JXYKqlwh8B_GBWlD1wbyE(this.f$0, tLObject);
                }
            });
        }

        public static void m4232$r8$lambda$Dnzr_JXYKqlwh8B_GBWlD1wbyE(GiftsCollections giftsCollections, TLObject tLObject) {
            giftsCollections.getClass();
        ...
        public void createCollection(String str, final Utilities.Callback callback) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(createstargiftcollection, new RequestDelegate() {
                @Override
                public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                    StarsController.GiftsCollections.m4233$r8$lambda$SCsYlD92hx096soRSGr9X0nBw(this.f$0, tL_starGiftCollection, giftsList, callback, tLObject, tL_error);
                }
            });
        }

        public static void m4233$r8$lambda$SCsYlD92hx096soRSGr9X0nBw(final GiftsCollections giftsCollections, final TL_stars.TL_starGiftCollection tL_starGiftCollection, final GiftsList giftsList, final Utilities.Callback callback, final TLObject tLObject, final TLRPC.TL_error tL_error) {
            giftsCollections.getClass();
            AndroidUtilities.runOnUIThread(new Runnable() {
                @Override
                public final void run() {
        ...
        public void addGifts(int i, ArrayList arrayList, boolean z) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(updatestargiftcollection, new RequestDelegate() {
                @Override
                public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                    StarsController.GiftsCollections.m4236$r8$lambda$um1AjQkJ_a0ixht96VU4tDpU28(this.f$0, tLObject, tL_error);
                }
            });
        }

        public static void m4236$r8$lambda$um1AjQkJ_a0ixht96VU4tDpU28(final GiftsCollections giftsCollections, final TLObject tLObject, TLRPC.TL_error tL_error) {
            giftsCollections.getClass();
            AndroidUtilities.runOnUIThread(new Runnable() {
                @Override
                public final void run() {
                    StarsController.GiftsCollections.m4234$r8$lambda$pvMIToOxiuZkBXBsVlwzFF6B5k(this.f$0, tLObject);
                }
            });
        }

        public static void m4234$r8$lambda$pvMIToOxiuZkBXBsVlwzFF6B5k(GiftsCollections giftsCollections, TLObject tLObject) {
            giftsCollections.getClass();
            if (tLObject instanceof TL_stars.TL_starGiftCollection) {
        ...
        public static void $r8$lambda$jKD92iaTyY7atUl36R5VfP0J7UI(final GiftsCollections giftsCollections, final TLObject tLObject, TLRPC.TL_error tL_error) {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() {
                @Override
                public final void run() {
                    StarsController.GiftsCollections.m4235$r8$lambda$tcJZgsb9xFBZmPvhenrngFaCy0(this.f$0, tLObject);
                }
            });
        }

        public static void m4235$r8$lambda$tcJZgsb9xFBZmPvhenrngFaCy0(GiftsCollections giftsCollections, TLObject tLObject) {
            giftsCollections.getClass();
            if (tLObject instanceof TL_stars.TL_starGiftCollection) {
                TL_stars.TL_starGiftCollection tL_starGiftCollection = (TL_stars.TL_starGiftCollection) tLObject;
                int iIndexOf = giftsCollections.indexOf(tL_starGiftCollection.collection_id);
    ...
    public static void $r8$lambda$sX6keYetb5L2e1ZX7Bvp_YppqqQ(final StarsController starsController, final long j, final Utilities.Callback callback, final TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        AndroidUtilities.runOnUIThread(new Runnable() {
            @Override
            public final void run() {
                StarsController.m4217$r8$lambda$flACazvrJHdB4UgEvu7ji4HAfQ(this.f$0, tLObject, j, callback);
            }
        });
    }

    public static void m4217$r8$lambda$flACazvrJHdB4UgEvu7ji4HAfQ(StarsController starsController, TLObject tLObject, long j, Utilities.Callback callback) {
        starsController.getClass();
