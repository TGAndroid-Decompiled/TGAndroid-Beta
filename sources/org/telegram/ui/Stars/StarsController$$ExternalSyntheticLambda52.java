...
public final class StarsController$$ExternalSyntheticLambda52 implements Runnable {
    ...
    public StarsController$$ExternalSyntheticLambda52(MessagesStorage messagesStorage, long j, boolean z, String str, long j2, int i, String str2, String str3, String str4) {
        ...
        switch (this.$r8$classId) {
            case 0:
                ...
                if (tLObject instanceof TLRPC.Updates) {
                    Utilities.stageQueue.postRunnable(new StarsController$$ExternalSyntheticLambda24(starsController, tLObject, 1));
                    runnable.run();
                    ...
                    ConnectionsManager.getInstance(starsController.currentAccount).sendRequest(tL_messages_getScheduledMessages, new StarGiftSheet$$ExternalSyntheticLambda150(starsController, messageObject, j2, runnable, 6));
                }
                break;
            default:
    ...
    public StarsController$$ExternalSyntheticLambda52(StarsController starsController, TLObject tLObject, Runnable runnable, TLRPC.TL_error tL_error, boolean z, long j, int i, MessageObject messageObject, long j2) {
