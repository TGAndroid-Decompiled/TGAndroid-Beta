...
public final class StarGiftSheet$$ExternalSyntheticLambda54 implements AlertDialog.OnButtonClickListener {
    public final int $r8$classId;
    public final StarGiftSheet f$0;
    public final TL_stars.TL_starGiftUnique f$1;

    public StarGiftSheet$$ExternalSyntheticLambda54(StarGiftSheet starGiftSheet, TL_stars.TL_starGiftUnique tL_starGiftUnique, int i) {
        this.$r8$classId = i;
