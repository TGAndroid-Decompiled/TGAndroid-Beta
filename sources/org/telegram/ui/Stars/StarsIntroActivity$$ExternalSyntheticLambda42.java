...
public final class StarsIntroActivity$$ExternalSyntheticLambda42 implements Utilities.Callback {
    ...
    public StarsIntroActivity$$ExternalSyntheticLambda42(Object obj, Context context, int i, long j, Theme.ResourcesProvider resourcesProvider, int i2) {
        this.$r8$classId = i2;
        this.f$0 = obj;
        this.f$1 = context;
        this.f$2 = i;
