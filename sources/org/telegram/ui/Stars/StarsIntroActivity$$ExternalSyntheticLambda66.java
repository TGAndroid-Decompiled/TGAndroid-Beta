...
public final class StarsIntroActivity$$ExternalSyntheticLambda66 implements View.OnClickListener {
    public final int $r8$classId;
    public final StarsIntroActivity.StarsBalanceView f$0;

    public StarsIntroActivity$$ExternalSyntheticLambda66(StarsIntroActivity.StarsBalanceView starsBalanceView, int i) {
        this.$r8$classId = i;
