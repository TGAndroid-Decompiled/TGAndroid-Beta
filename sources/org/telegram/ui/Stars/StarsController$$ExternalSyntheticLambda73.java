...
public final class StarsController$$ExternalSyntheticLambda73 implements Runnable {
    ...
    public StarsController$$ExternalSyntheticLambda73(int i, int i2, long j, ArrayList arrayList, MessagesStorage messagesStorage) {
        this.$r8$classId = i2;
    ...
    public StarsController$$ExternalSyntheticLambda73(MessagesStorage messagesStorage, long j, ArrayList arrayList, int i) {
        this.$r8$classId = 0;
        this.f$0 = messagesStorage;
        this.f$1 = arrayList;
        this.f$2 = i;
