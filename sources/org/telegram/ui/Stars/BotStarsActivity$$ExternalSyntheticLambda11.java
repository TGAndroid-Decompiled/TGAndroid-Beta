...
public final class BotStarsActivity$$ExternalSyntheticLambda11 implements Runnable {
    public final int $r8$classId;
    public final BotStarsActivity f$0;
    public final TwoStepVerificationActivity f$1;

    public BotStarsActivity$$ExternalSyntheticLambda11(BotStarsActivity botStarsActivity, TwoStepVerificationActivity twoStepVerificationActivity, int i) {
        this.$r8$classId = i;
    ...
    public final void run() {
        switch (this.$r8$classId) {
            ...
            default:
                ...
                botStarsActivity2.balanceButton.setLoading(false);
