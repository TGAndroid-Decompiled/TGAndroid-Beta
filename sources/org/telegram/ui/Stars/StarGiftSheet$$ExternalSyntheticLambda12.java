...
public final class StarGiftSheet$$ExternalSyntheticLambda12 implements Runnable {
    public final int $r8$classId;
    public final StarGiftSheet f$0;
    public final long f$1;

    public StarGiftSheet$$ExternalSyntheticLambda12(StarGiftSheet starGiftSheet, long j, int i) {
        this.$r8$classId = i;
    ...
    public final void run() {
        switch (this.$r8$classId) {
            ...
            case 1:
                ...
                if (this.f$1 > 0) {
                    StarGiftSheet$$ExternalSyntheticLambda3 starGiftSheet$$ExternalSyntheticLambda3 = starGiftSheet.tickUpgradePriceRunnable;
