...
public final class StarsIntroActivity$$ExternalSyntheticLambda6 implements Runnable {
    public final int $r8$classId;
    public final BottomSheet[] f$0;
    public final long f$1;

    public StarsIntroActivity$$ExternalSyntheticLambda6(BottomSheet[] bottomSheetArr, long j, int i) {
        this.$r8$classId = i;
        ...
        switch (this.$r8$classId) {
            ...
            case 1:
                ...
                if (safeLastFragment2 != null) {
                    safeLastFragment2.presentFragment(ProfileActivity.of(this.f$1));
                }
                break;
            case 2:
                this.f$0[0].lambda$showGiftOfferSheet$15();
                ...
                if (safeLastFragment3 != null) {
                    safeLastFragment3.presentFragment(ChatActivity.of(this.f$1));
                }
                break;
            case 3:
                ...
                if (safeLastFragment4 != null) {
                    safeLastFragment4.presentFragment(ChatActivity.of(this.f$1));
                    break;
                }
                break;
            case 4:
                ...
                if (safeLastFragment5 != null) {
                    safeLastFragment5.presentFragment(new AffiliateProgramFragment(this.f$1));
                }
                break;
            case 5:
                this.f$0[0].lambda$showGiftOfferSheet$15();
            ...
            default:
                ...
                if (safeLastFragment7 != null) {
                    safeLastFragment7.presentFragment(ProfileActivity.of(this.f$1));
                }
                break;
        }
    }
