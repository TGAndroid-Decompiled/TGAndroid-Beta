...
public final class StarsController$$ExternalSyntheticLambda48 implements Utilities.Callback {
    ...
    public StarsController$$ExternalSyntheticLambda48(StarsController starsController, long j, boolean[] zArr, Utilities.Callback callback, Context context, Theme.ResourcesProvider resourcesProvider, boolean z, String str, MessageObject messageObject, TLRPC.InputInvoice inputInvoice, TLRPC.TL_payments_paymentFormStars tL_payments_paymentFormStars, int i, long j2) {
    ...
    public final void run(Object obj) {
        ...
        int i = this.f$11;
        if (j >= j2) {
            starsController.payAfterConfirmed(messageObject, inputInvoice, tL_payments_paymentFormStars, new StarsController$$ExternalSyntheticLambda61(starsController, i, callback, zArr, callback2));
            return;
        }
        ...
        if (zStarsPurchaseAvailable) {
            boolean[] zArr2 = {false};
            StarsIntroActivity.StarsNeededSheet starsNeededSheet = new StarsIntroActivity.StarsNeededSheet(context, resourcesProvider, j2, this.f$6 ? 9 : 0, this.f$7, new LaunchActivity$$ExternalSyntheticLambda40(starsController, zArr2, messageObject, inputInvoice, tL_payments_paymentFormStars, zArr, i, callback2, callback), this.f$12);
            starsNeededSheet.setOnDismissListener(new StarsController$$ExternalSyntheticLambda60(starsController, callback, zArr2, zArr, callback2, 0));
