...
public final class StarsIntroActivity$$ExternalSyntheticLambda63 implements View.OnClickListener {
    ...
    public StarsIntroActivity$$ExternalSyntheticLambda63(StarsReactionsSheet starsReactionsSheet, MessageObject messageObject, ChatActivity chatActivity, int i, boolean z, Context context, Theme.ResourcesProvider resourcesProvider, long j, TLRPC.Chat chat) {
            ...
            case 0:
                ...
                if (!buttonWithCounterView.loading) {
                    ...
                    if (starsController.balance.amount >= starsSubscription.pricing.amount) {
                        ...
                        new StarsIntroActivity.StarsNeededSheet((Activity) this.f$5, this.f$6, starsSubscription.pricing.amount, this.f$7 ? 8 : j < 0 ? 2 : 7, (String) this.f$8, botForumHelper$$ExternalSyntheticLambda2, j).show();
                    }
                    break;
                }
                break;
                ...
                if (!starsReactionsSheet.sending) {
                    ...
                    if ((liveCommentsView$$ExternalSyntheticLambda9 != null || (messageObject != null && chatActivity != null)) && starsReactionsSheet.iconAnimator == null) {
                        ...
                        if (!MessagesController.getInstance(i2).isFrozen()) {
                            ...
                            PhotoViewer$$ExternalSyntheticLambda177 photoViewer$$ExternalSyntheticLambda177 = new PhotoViewer$$ExternalSyntheticLambda177(starsReactionsSheet, value, starsController2, messageObject, chatActivity, 15);
                            if (starsController2.balanceLoaded && starsController2.getBalance().amount < value) {
                                ...
                                if (!z) {
                                    ...
                                    new StarsIntroActivity.StarsNeededSheet(context, resourcesProvider, value, 5, chat == null ? "" : chat.title, photoViewer$$ExternalSyntheticLambda177, j2).show();
                                } else {
                                    new StarsIntroActivity.StarsNeededSheet(context, resourcesProvider, value, 17, DialogObject.getShortName(i2, j2), photoViewer$$ExternalSyntheticLambda177, j2).show();
                                }
                            } else {
    ...
    public StarsIntroActivity$$ExternalSyntheticLambda63(ButtonWithCounterView buttonWithCounterView, int i, TL_stars.StarsSubscription starsSubscription, BottomSheet[] bottomSheetArr, long j, Activity activity, Theme.ResourcesProvider resourcesProvider, boolean z, String str) {
