...
public final class c31 extends FrameLayout {
    public final org.telegram.ui.Components.o5 f32539a;
    public final d31 f32540b;
    ...
    public c31(d31 d31Var, Context context) {
        ...
        this.f32539a = new org.telegram.ui.Components.o5(AndroidUtilities.dp(24.0f), this);
    }

    public final void a(boolean z10) {
        d31 d31Var = this.f32540b;
        String doubleTapReaction = MediaDataController.getInstance(d31.Y(d31Var)).getDoubleTapReaction();
        org.telegram.ui.Components.o5 o5Var = this.f32539a;
    ...
    public final void b() {
        int width = getWidth();
        org.telegram.ui.Components.o5 o5Var = this.f32539a;
        o5Var.setBounds((width - o5Var.f26919s) - AndroidUtilities.dp(21.0f), (getHeight() - o5Var.f26919s) / 2, getWidth() - AndroidUtilities.dp(21.0f), (getHeight() + o5Var.f26919s) / 2);
    }
