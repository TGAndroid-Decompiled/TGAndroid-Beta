...
public final class c31 extends FrameLayout {
    public final org.telegram.ui.Components.o5 f32554a;
    public final d31 f32555b;
    ...
    public c31(d31 d31Var, Context context) {
        ...
        this.f32554a = new org.telegram.ui.Components.o5(AndroidUtilities.dp(24.0f), this);
    }

    public final void a(boolean z10) {
        d31 d31Var = this.f32555b;
        String doubleTapReaction = MediaDataController.getInstance(d31.Y(d31Var)).getDoubleTapReaction();
        org.telegram.ui.Components.o5 o5Var = this.f32554a;
    ...
    public final void b() {
        int width = getWidth();
        org.telegram.ui.Components.o5 o5Var = this.f32554a;
        o5Var.setBounds((width - o5Var.f26924s) - AndroidUtilities.dp(21.0f), (getHeight() - o5Var.f26924s) / 2, getWidth() - AndroidUtilities.dp(21.0f), (getHeight() + o5Var.f26924s) / 2);
    }
