...
public final class zi1 implements org.telegram.ui.ActionBar.a2, oy {
    public final bj1 f40180a;
    ...
    public void f(org.telegram.ui.ActionBar.b2 b2Var, int i10) {
        ...
        for (int i12 = 0; i12 < longSparseArray.size(); i12++) {
            ...
            if (valueAt instanceof ej1) {
                ...
                TLRPC.WallPaper wallPaper = ej1Var.f33301l;
                if (wallPaper != null && wallPaper.f18448id < 0) {
                    wallpapersListActivity.getMessagesStorage().deleteWallpaper(ej1Var.f33301l.f18448id);
                    wallpapersListActivity.f31872d0.remove(ej1Var);
                    wallpapersListActivity.f31869b0.remove(ej1Var.a());
                } else {
                    valueAt = wallPaper;
                }
            }
            if (valueAt instanceof TLRPC.WallPaper) {
                ...
                if (valueAt instanceof TLRPC.TL_wallPaperNoFile) {
                    ...
                    tL_inputWallPaperNoFile.f18369id = wallPaper2.f18448id;
                    savewallpaper.wallpaper = tL_inputWallPaperNoFile;
                } else {
                    TLRPC.TL_inputWallPaper tL_inputWallPaper = new TLRPC.TL_inputWallPaper();
                    tL_inputWallPaper.f18368id = wallPaper2.f18448id;
    ...
    public boolean u(uy uyVar, ArrayList arrayList, CharSequence charSequence, boolean z10, boolean z11, int i10, int i11, dg1 dg1Var) {
        ...
        int i17;
        String b10;
        WallpapersListActivity wallpapersListActivity = this.f40180a.f32395a;
        StringBuilder sb2 = new StringBuilder();
        int i18 = 0;
        while (true) {
            longSparseArray = wallpapersListActivity.f31876g0;
