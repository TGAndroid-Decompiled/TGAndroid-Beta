...
public final class ib1 extends org.telegram.ui.Components.g51 {
    ...
    public org.telegram.ui.Cells.s7 f37320a;
    ...
    public final View createView(Context context, org.telegram.ui.Components.ll0 ll0Var, int i10, int i11, org.telegram.ui.ActionBar.f6 f6Var) {
        if (this.f37320a == null) {
            this.f37320a = new org.telegram.ui.Cells.s7(context, f6Var);
        }
        org.telegram.ui.Cells.t7 t7Var = new org.telegram.ui.Cells.t7(context, this.f37320a, i10);
        t7Var.f23316w0 = true;
        t7Var.f23292d0 = true;
        return t7Var;
    }
    ...
    public final boolean equals(org.telegram.ui.Components.h51 h51Var, org.telegram.ui.Components.h51 h51Var2) {
        if (h51Var.f26627q == h51Var2.f26627q && h51Var.f26616e == h51Var2.f26616e && h51Var.B == h51Var2.B) {
            return true;
        }
        return false;
    }
