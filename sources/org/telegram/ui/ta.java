...
public final class ta implements Utilities.Callback {
    ...
    public final Object f40722c;
    public final Object d;
    public final Object f40723e;
    public final Object f40724f;
    ...
    public ta(NotificationCenter.NotificationCenterDelegate notificationCenterDelegate, Object obj, Object obj2, Object obj3, Object obj4, int i10) {
        this.f40720a = i10;
        this.f40721b = notificationCenterDelegate;
        this.f40722c = obj;
        this.d = obj2;
        this.f40723e = obj3;
        this.f40724f = obj4;
    ...
    public final void run(Object obj) {
        ...
        switch (this.f40720a) {
            case 0:
                AndroidUtilities.runOnUIThread(new bi.h8((ub) this.f40721b, (TLRPC.ChannelParticipant) obj, (ArrayList) this.f40722c, (ArrayList) this.d, (ArrayList) this.f40723e, (sa) this.f40724f));
                return;
            case 1:
                final co coVar = (co) this.f40721b;
                org.telegram.ui.Cells.t1 t1Var = (org.telegram.ui.Cells.t1) this.f40722c;
                String str = (String) this.d;
                TLRPC.TL_contact tL_contact = (TLRPC.TL_contact) this.f40723e;
                CharacterStyle characterStyle = (CharacterStyle) this.f40724f;
                ...
                return;
            case 2:
                co coVar2 = (co) this.f40721b;
                TLRPC.TL_document tL_document = (TLRPC.TL_document) this.f40722c;
                String str2 = (String) this.d;
                MessageObject.SendAnimationData sendAnimationData = (MessageObject.SendAnimationData) this.f40724f;
                Long l4 = (Long) obj;
                int i10 = coVar2.R3;
                Object obj2 = this.f40723e;
                if (i10 == 1) {
                    org.telegram.ui.Components.e5.M(coVar2.getParentActivity(), coVar2.T5, new a1.d(coVar2, tL_document, str2, obj2, 4), coVar2.f35274ea);
                } else {
                    coVar2.getSendMessagesHelper().sendSticker(tL_document, str2, coVar2.T5, coVar2.f35379n5, coVar2.X3, null, coVar2.f35353l5, sendAnimationData, true, 0, 0, false, obj2, coVar2.C8(), l4.longValue(), coVar2.N8(), coVar2.f35294g5);
                ...
                return;
            case 3:
                ArrayList arrayList = (ArrayList) this.f40722c;
                ArrayList arrayList2 = (ArrayList) this.d;
                ArrayList arrayList3 = (ArrayList) this.f40723e;
                Runnable runnable = (Runnable) obj;
                org.telegram.ui.Components.ky kyVar = ((org.telegram.ui.Components.jy) this.f40721b).f27611a;
                String str3 = kyVar.v;
                ArrayList arrayList4 = kyVar.f27945r;
                ArrayList arrayList5 = kyVar.h;
                ArrayList arrayList6 = kyVar.f27946s;
                org.telegram.ui.Components.kz kzVar = kyVar.F;
                if (((String) this.f40724f).equals(str3)) {
                    ...
                    arrayList5.clear();
                    arrayList5.addAll(kyVar.f27944n);
                    arrayList4.clear();
                    ...
                    while (i12 < size) {
                        ...
                        if (longSparseIntArray.indexOfKey(dyVar.f25505c.f19923id) < 0) {
                            longSparseIntArray.append(dyVar.f25505c.f19923id, 1);
                    ...
                    while (i11 < size2) {
                        ...
                        if (longSparseIntArray.indexOfKey(dyVar2.f25505c.f19923id) < 0) {
                            longSparseIntArray.append(dyVar2.f25505c.f19923id, 1);
                ...
                return;
            case 4:
                uy uyVar = (uy) this.f40721b;
                Long l10 = (Long) this.d;
                Runnable runnable2 = (Runnable) obj;
                uyVar.getClass();
                ((org.telegram.ui.ActionBar.b2) this.f40722c).dismiss();
                uyVar.getMessagesController().loadChannelParticipants(l10);
                oy oyVar = uyVar.C2;
                uyVar.removeSelfFromStack();
                ((md) this.f40723e).removeSelfFromStack();
                ((org.telegram.ui.ActionBar.n2) this.f40724f).finishFragment();
                if (oyVar != null) {
                ...
                return;
            default:
                zh.w3.s0((zh.w3) this.f40721b, (TL_stars.StarGift) this.f40722c, (TL_stars.StarGiftAttribute) this.d, (org.telegram.ui.Components.ad[]) this.f40723e, (boolean[]) this.f40724f, (ArrayList) obj);
                return;
        }
    }
