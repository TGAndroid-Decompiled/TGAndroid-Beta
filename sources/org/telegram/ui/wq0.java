...
public final class wq0 implements org.telegram.ui.Components.y4, org.telegram.ui.ActionBar.c2, ImageReceiver.ImageReceiverDelegate, r0.o {
    public final PhotoViewer f42874a;

    public wq0(PhotoViewer photoViewer) {
        this.f42874a = photoViewer;
    }

    @Override
    public void I(int i10, int i11, boolean z4) {
        Drawable[] drawableArr = PhotoViewer.Q8;
        this.f42874a.w2(z4, i10, i11, false, false, false);
    }

    @Override
    public r0.m1 M0(View view, r0.m1 m1Var) {
        PhotoViewer photoViewer = this.f42874a;
        oq0 oq0Var = photoViewer.f34389s4;
        ...
        if (!rect2.equals(rect)) {
            ...
            ku0 ku0Var = photoViewer.f34248d0;
            if (ku0Var != null) {
    ...
    public void didSetImage(ImageReceiver imageReceiver, boolean z4, boolean z10, boolean z11) {
        ...
        if (imageReceiver == photoViewer.z4 && z4 && (ju0Var = photoViewer.d) != null && ju0Var.J() && !photoViewer.f34290h5 && (i10 = photoViewer.Z1) != 1 && i10 != 11) {
            if (!photoViewer.Q5) {
                photoViewer.R5 = true;
            } else {
                photoViewer.N2();
