    ...
    public final void b(int i10) {
        ...
        if (i10 == -1) {
            ...
            if (ChatObject.isChannelOrGiga(d60Var.W0)) {
                alertDialog$Builder.f21168a.O = LocaleController.getString(R.string.VoipChannelEndAlertTitle);
                alertDialog$Builder.f21168a.Q = LocaleController.getString(R.string.VoipChannelEndAlertText);
            } else {
                alertDialog$Builder.f21168a.O = LocaleController.getString(R.string.VoipGroupEndAlertTitle);
                alertDialog$Builder.f21168a.Q = LocaleController.getString(R.string.VoipGroupEndAlertText);
            }
            ...
            if (call.recording) {
                ...
                alertDialog$Builder2.f21168a.F = org.telegram.ui.ActionBar.k6.f21887pg;
                alertDialog$Builder2.f21168a.O = LocaleController.getString(R.string.VoipGroupStopRecordingTitle);
                if (ChatObject.isChannelOrGiga(d60Var.W0)) {
                    alertDialog$Builder2.f21168a.Q = LocaleController.getString(R.string.VoipChannelStopRecordingText);
                } else {
                    alertDialog$Builder2.f21168a.Q = LocaleController.getString(R.string.VoipGroupStopRecordingText);
                }
                alertDialog$Builder2.k(LocaleController.getString(R.string.Stop), new jh.q(8, this, z4));
                alertDialog$Builder2.h(LocaleController.getString(R.string.Cancel), null);
                int w04 = org.telegram.ui.ActionBar.k6.w0(null, org.telegram.ui.ActionBar.k6.f21973ug, false);
                org.telegram.ui.ActionBar.d2 d2Var2 = alertDialog$Builder2.f21168a;
                d2Var2.i(w04);
                d2Var2.show();
                d2Var2.o(org.telegram.ui.ActionBar.k6.w0(null, org.telegram.ui.ActionBar.k6.f21850ng, false));
                return;
            }
            ...
            d60Var.f36024i0 = true;
            d60Var.f36061r1.setVisibility(0);
            d60Var.f36066s1.setVisibility(0);
            d60Var.f36033k1.setVisibility(8);
            d60Var.f36074u1.setVisibility(8);
            d60Var.f36078v1.setVisibility(8);
            d60Var.f36070t1.setVisibility(8);
            d60Var.f36048o1.setVisibility(8);
            d60Var.l1.setVisibility(8);
            d60Var.f36052p1.setVisibility(8);
            d60Var.f36056q1.setVisibility(8);
            d60Var.f36020h0.setVisibility(8);
            d60Var.f36039m1.setVisibility(8);
            d60Var.f36044n1.setVisibility(8);
            org.telegram.ui.ActionBar.w0 w0Var = d60Var.f36021h1;
            org.telegram.ui.ActionBar.p1 p1Var = w0Var.d;
            if (p1Var != null && p1Var.isShowing()) {
                w0Var.f22346b.measure(b.d(40.0f, AndroidUtilities.displaySize.x, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.displaySize.y, Integer.MIN_VALUE));
                w0Var.O(true, true);
            }
        } else if (i10 == 6) {
            ...
            alertDialog$Builder3.f21168a.F = org.telegram.ui.ActionBar.k6.f21887pg;
            if (ChatObject.isChannelOrGiga(d60Var.W0)) {
                alertDialog$Builder3.f21168a.O = LocaleController.getString(R.string.VoipChannelTitle);
            } else {
                alertDialog$Builder3.f21168a.O = LocaleController.getString(R.string.VoipGroupTitle);
            }
            alertDialog$Builder3.f21168a.f21265v0 = false;
            ...
            int w05 = org.telegram.ui.ActionBar.k6.w0(null, org.telegram.ui.ActionBar.k6.f21707fg, false);
            ...
            org.telegram.ui.Components.a80.u(d60Var.getContext(), -d60Var.i1(), d60Var.d, null, 2, d60Var.f36087x0, new b50(this));
        } else if (i10 == 11) {
            ...
            org.telegram.ui.ActionBar.h3 h3Var = new org.telegram.ui.ActionBar.h3(this.f37224a, null, false, false);
            ...
            int i16 = org.telegram.ui.ActionBar.k6.f21797kg;
            ...
            h3Var.show();
            h3Var.setTitleColor(org.telegram.ui.ActionBar.k6.w0(null, org.telegram.ui.ActionBar.k6.f21850ng, false));
            for (int i17 = 0; i17 < h3Var.getItemViews().size(); i17++) {
                org.telegram.ui.ActionBar.a3 a3Var = h3Var.getItemViews().get(i17);
                if (i17 == i11) {
                    w02 = org.telegram.ui.ActionBar.k6.w0(null, org.telegram.ui.ActionBar.k6.f21887pg, false);
                    a3Var.f21181f = true;
                } else {
                    w02 = org.telegram.ui.ActionBar.k6.w0(null, org.telegram.ui.ActionBar.k6.f21850ng, false);
                }
                a3Var.setTextColor(w02);
                a3Var.setIconColor(w02);
                a3Var.setBackground(org.telegram.ui.ActionBar.k6.f0(i0.a.k(org.telegram.ui.ActionBar.k6.w0(null, org.telegram.ui.ActionBar.k6.f21743hg, false), 12), 2, -1));
            }
        }
    }
}
