...
public final class r9 extends ViewGroup {
    public final int f40129a = 1;
    public final Object f40130b;
    public final org.telegram.ui.ActionBar.n2 f40131c;

    public r9(u9 u9Var, Context context) {
        super(context);
        this.f40131c = u9Var;
        this.f40130b = new Path();
    }
    ...
    public boolean drawChild(Canvas canvas, View view, long j3) {
        switch (this.f40129a) {
            case 0:
                Path path = (Path) this.f40130b;
                boolean drawChild = super.drawChild(canvas, view, j3);
                u9 u9Var = (u9) this.f40131c;
                Paint paint = u9Var.f41014n;
                Paint paint2 = u9Var.h;
                if (u9Var.a0() && view == u9Var.f41008c) {
                    ...
                    if (u9Var.f41005a0 < 1.0f) {
                        if (u9Var.f41007b0 == null) {
                            u9Var.h0();
                        }
                        AndroidUtilities.lerp(u9Var.f41007b0, rectF3, u9Var.f41005a0, rectF3);
                    }
                    ...
                    paint2.setAlpha((int) (Math.max(0.0f, 1.0f - u9Var.f41019y) * 255.0f));
                    canvas.drawRect(f13, f11, f14, f12, paint2);
                    int lerp = AndroidUtilities.lerp(0, AndroidUtilities.dp(4.0f), Math.min(1.0f, u9Var.f41019y * 20.0f));
                    int i15 = lerp / 2;
                    int lerp2 = AndroidUtilities.lerp(Math.min(i10, i11), AndroidUtilities.dp(20.0f), Math.min(1.2f, (float) Math.pow(u9Var.f41019y, 1.7999999523162842d)));
                    paint.setAlpha((int) (Math.min(1.0f, u9Var.f41019y) * 255.0f));
                    path.reset();
        ...
        switch (this.f40129a) {
            case 0:
                ...
                if (i16 != 0) {
                    ...
                    if (cameraView != null) {
                        cameraView.layout(0, 0, cameraView.getMeasuredWidth(), u9Var.f41008c.getMeasuredHeight());
                    }
                    int min = (int) (Math.min(i14, i15) / 1.5f);
                    if (i16 == 1) {
                        measuredHeight = ((i15 - min) / 2) - u9Var.f41004a.getMeasuredHeight();
                    ...
                    u9Var.f41004a.layout(AndroidUtilities.dp(36.0f), i17, u9Var.f41004a.getMeasuredWidth() + AndroidUtilities.dp(36.0f), u9Var.f41004a.getMeasuredHeight() + i17);
                    if (i16 == 3) {
                        int C = org.telegram.messenger.w1.C(8.0f, u9Var.f41004a.getMeasuredHeight(), i17);
                        u9Var.f41006b.layout(AndroidUtilities.dp(36.0f), C, u9Var.f41006b.getMeasuredWidth() + AndroidUtilities.dp(36.0f), u9Var.f41006b.getMeasuredHeight() + C);
                    }
                    u9Var.f41013f.layout(0, getMeasuredHeight() - u9Var.f41013f.getMeasuredHeight(), getMeasuredWidth(), getMeasuredHeight());
                    int measuredWidth2 = (i14 / 2) - (u9Var.f41015r.getMeasuredWidth() / 2);
                    int dp2 = AndroidUtilities.dp(80.0f) + i2.g.C(i15, min, 2, min);
                    ImageView imageView = u9Var.f41015r;
                    imageView.layout(measuredWidth2, dp2, imageView.getMeasuredWidth() + measuredWidth2, u9Var.f41015r.getMeasuredHeight() + dp2);
                } else {
                    CameraView cameraView2 = u9Var.f41008c;
                    if (cameraView2 != null) {
                        cameraView2.layout(0, 0, cameraView2.getMeasuredWidth(), u9Var.f41008c.getMeasuredHeight());
                    }
                    u9Var.f41013f.setTextSize(0, i15 / 22);
                    u9Var.f41013f.setPadding(0, 0, 0, i15 / 15);
                    int i18 = (int) (i15 * 0.65f);
                    u9Var.f41004a.layout(AndroidUtilities.dp(36.0f), i18, u9Var.f41004a.getMeasuredWidth() + AndroidUtilities.dp(36.0f), u9Var.f41004a.getMeasuredHeight() + i18);
                }
                if (i16 != 3) {
                    int i19 = (int) (i15 * 0.74f);
                    int i20 = (int) (i14 * 0.05f);
                    TextView textView = u9Var.f41006b;
                    textView.layout(i20, i19, textView.getMeasuredWidth() + i20, u9Var.f41006b.getMeasuredHeight() + i19);
                }
                u9Var.h0();
                return;
            default:
                hh1 hh1Var = (hh1) this.f40131c;
                ...
                di.r6 r6Var = hh1Var.f37049y;
                r6Var.layout(0, 0, r6Var.getMeasuredWidth(), hh1Var.f37049y.getMeasuredHeight());
                org.telegram.ui.Components.w90 w90Var = (org.telegram.ui.Components.w90) this.f40130b;
        ...
        switch (this.f40129a) {
            case 0:
                ...
                if (i12 == 0) {
                    ...
                    u9Var.f41013f.measure(View.MeasureSpec.makeMeasureSpec(size, 1073741824), View.MeasureSpec.makeMeasureSpec(size2, 0));
                    u9Var.f41015r.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(60.0f), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(60.0f), 1073741824));
                }
                u9Var.f41004a.measure(org.telegram.messenger.wl.d(72.0f, size, 1073741824), View.MeasureSpec.makeMeasureSpec(size2, 0));
                if (i12 == 3) {
                    u9Var.f41006b.measure(org.telegram.messenger.wl.d(72.0f, size, 1073741824), View.MeasureSpec.makeMeasureSpec(size2, 0));
                } else {
                    u9Var.f41006b.measure(View.MeasureSpec.makeMeasureSpec((int) (size * 0.9f), 1073741824), View.MeasureSpec.makeMeasureSpec(size2, 0));
                }
            ...
            default:
                ...
                ((org.telegram.ui.Components.w90) this.f40130b).measure(View.MeasureSpec.makeMeasureSpec(size3, 1073741824), i11);
