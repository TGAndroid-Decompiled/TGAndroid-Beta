...
public final class gy {
    ...
    public final long a() {
        uy uyVar = this.f33965a;
        ox oxVar = uyVar.F3;
        if (oxVar != null && (oxVar.getFragment() instanceof eg1)) {
            return -((eg1) uyVar.F3.getFragment()).f33291a;
        }
        return 0L;
    }
    ...
    public final void b() {
        ...
        org.telegram.ui.Components.rn0 rn0Var = uyVar.C0.f30284b0;
        if (rn0Var.N && rn0Var.P()) {
            alertDialog$Builder.f18435a.R = LocaleController.getString(R.string.ClearSearchAlertPartialTitle);
            org.telegram.ui.Components.rn0 rn0Var2 = uyVar.C0.f30284b0;
            if (rn0Var2.N) {
                arrayList = rn0Var2.f9783v0;
            } else {
                arrayList = rn0Var2.f9782u0;
            }
            if (arrayList != null) {
                i10 = arrayList.size();
            } else {
            ...
            alertDialog$Builder.f18435a.T = LocaleController.formatPluralString("ClearSearchAlertPartial", i10, new Object[0]);
            alertDialog$Builder.k(LocaleController.getString(R.string.Clear), new org.telegram.ui.ActionBar.a2(this) {
                public final gy f33718b;
                ...
                public final void f(org.telegram.ui.ActionBar.b2 b2Var, int i11) {
                    switch (r2) {
                        case 0:
                            this.f33718b.f33965a.C0.f30284b0.E();
                            return;
                        default:
                            uy uyVar2 = this.f33718b.f33965a;
                            if (uyVar2.C0.f30284b0.P()) {
                                uyVar2.C0.f30284b0.E();
                                return;
                            }
                            org.telegram.ui.Components.rn0 rn0Var3 = uyVar2.C0.f30284b0;
                            rn0Var3.f9769j0.c();
                            rn0Var3.J.clear();
                            rn0Var3.l();
                            return;
    ...
    public final void c() {
        int i10;
        ey eyVar = this.f33965a.C0;
        if (eyVar != null) {
            org.telegram.ui.Components.qk0 qk0Var = eyVar.f30286d0;
            int i11 = eyVar.S0;
            if (i11 > 0) {
                i10 = i11 + 1;
            } else {
    ...
    public final void d(boolean z10, boolean z11) {
        ...
        if (uyVar.f38250j2 && uyVar.f38254k2) {
            ey eyVar = uyVar.C0;
            if (eyVar.W != null) {
                if (!z10 && eyVar.f30284b0.h() == 0) {
