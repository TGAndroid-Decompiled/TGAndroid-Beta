...
public final class hj1 extends org.telegram.ui.Components.vl0 {
    ...
    public boolean f34174f = true;
    public String h;
    public String f34175n;
    public String f34176r;
    public int f34177s;
    public int v;
    public boolean f34178w;
    public String f34179x;
    public x81 f34180y;
    ...
    public final void E(String str, boolean z10) {
        int i10;
        if (str != null && this.f34175n != null) {
            str = a4.a.q(this.f34175n, " ", str, new StringBuilder("#color"));
        }
        x81 x81Var = this.f34180y;
        if (x81Var != null) {
        ...
        if (isEmpty) {
            ...
            if (this.f34177s != 0) {
                ...
                ConnectionsManager.getInstance(i10).cancelRequest(this.f34177s, true);
                this.f34177s = 0;
            }
    ...
    public final void F(String str, String str2, boolean z10) {
        ...
        int i17;
        int i18;
        int i19 = this.f34177s;
        WallpapersListActivity wallpapersListActivity = this.E;
        if (i19 != 0) {
            i18 = ((org.telegram.ui.ActionBar.n2) wallpapersListActivity).currentAccount;
            ConnectionsManager.getInstance(i18).cancelRequest(this.f34177s, true);
            this.f34177s = 0;
        }
        this.f34179x = str;
        i10 = ((org.telegram.ui.ActionBar.n2) wallpapersListActivity).currentAccount;
        ...
        this.f34177s = ConnectionsManager.getInstance(i13).sendRequest(tL_messages_getInlineBotResults, new ai.g8(this, i20, 7));
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        for (int i14 = 0; i14 < wallpapersListActivity.P; i14++) {
            ...
            ebVar.e(wallpapersListActivity.f31879r, obj, "", i14);
        }
    }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 != 0) {
            ...
            if (i10 != 1) {
                ...
                ?? dc1Var = new dc1(context, 13, null);
