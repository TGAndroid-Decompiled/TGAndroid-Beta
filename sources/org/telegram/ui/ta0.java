...
public final class ta0 implements Runnable {
    ...
    public final ua0 f38032b;
    public final AccountInstance f38033c;
    public final long d;
    ...
    public final void run() {
        switch (this.f38031a) {
            case 0:
                AndroidUtilities.runOnUIThread(new ta0(this.f38032b, this.f38033c, this.d, this.e, 1));
                return;
            default:
                AccountInstance accountInstance = this.f38033c;
                ...
                org.telegram.ui.Components.voip.g2.l(chat, null, false, Boolean.valueOf((groupCall == null || !groupCall.call.rtmp_stream) ? true : true), this.f38032b.f38383g, this.e, accountInstance);
                return;
        }
    }
}
