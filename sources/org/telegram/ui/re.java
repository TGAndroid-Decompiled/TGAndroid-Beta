...
public final class re implements Runnable {
    ...
    public final xn f38000b;
    public final MessageObject f38001c;

    public re(xn xnVar, MessageObject messageObject, int i10) {
        this.f37999a = i10;
        this.f38000b = xnVar;
        this.f38001c = messageObject;
    }
    ...
    public final void run() {
        ...
        switch (this.f37999a) {
            case 0:
                MessageObject messageObject = this.f38001c;
                ...
                if (messageMedia != null && (webPage = messageMedia.webpage) != null && webPage.cached_page != null) {
                    ...
                    if (launchActivity == null || launchActivity.P() == null || LaunchActivity.D1.P().k(messageObject) == null) {
                        this.f38000b.createArticleViewer(false).N(messageObject, null, null, null);
                        return;
                    }
                    return;
                }
                return;
            case 1:
                xn xnVar = this.f38000b;
                xnVar.getClass();
                MessageObject messageObject2 = this.f38001c;
            ...
            case 2:
                int id2 = this.f38001c.getId();
                xn xnVar2 = this.f38000b;
                ...
                return;
            case 3:
                xn xnVar3 = this.f38000b;
                xnVar3.getClass();
                MessageObject messageObject3 = this.f38001c;
                int replyMsgId = messageObject3.getReplyMsgId();
                int i15 = messageObject3.messageOwner.f19205id;
                ...
                return;
            case 4:
                xn xnVar4 = this.f38000b;
                xnVar4.getClass();
                MessageObject messageObject4 = this.f38001c;
                int replyMsgId2 = messageObject4.getReplyMsgId();
                int i16 = messageObject4.messageOwner.f19205id;
                ...
                return;
            case 5:
                xn xnVar5 = this.f38000b;
                xnVar5.getClass();
                MessageObject messageObject5 = this.f38001c;
                int replyMsgId3 = messageObject5.getReplyMsgId();
                int i17 = messageObject5.messageOwner.f19205id;
                ...
                return;
            case 6:
                xn xnVar6 = this.f38000b;
                xnVar6.getClass();
                MessageObject messageObject6 = this.f38001c;
            ...
            case 7:
                xn xnVar7 = this.f38000b;
                xnVar7.getMessagesController().pinMessage(xnVar7.e, xnVar7.f40009f, this.f38001c.getId(), true, false, false);
                xnVar7.f40237x3 = null;
                return;
            default:
                xn xnVar8 = this.f38000b;
                org.telegram.ui.Components.qc.a0(xnVar8).c(LocaleController.getString(R.string.AdHidden)).j();
                MessageObject messageObject7 = this.f38001c;
