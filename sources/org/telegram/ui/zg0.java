...
public final class zg0 extends org.telegram.ui.Components.ll0 {
    public final Context f40250c;
    public final ah0 d;

    public zg0(ah0 ah0Var, Context context) {
        this.d = ah0Var;
        this.f40250c = context;
    }
    ...
    public final boolean D(s4.c1 c1Var) {
        int b10 = c1Var.b();
        ah0 ah0Var = this.d;
        if (b10 != ah0Var.f31861c && b10 != ah0Var.d && b10 != ah0Var.e && b10 != ah0Var.f31862f && b10 != ah0Var.h && b10 != ah0Var.f31864r) {
            return false;
        }
        return true;
    }
    ...
    public final int j(int i10) {
        ...
        if (i10 != ah0Var.f31861c && i10 != ah0Var.d && i10 != ah0Var.e && i10 != ah0Var.f31862f && i10 != ah0Var.h) {
            if (i10 == ah0Var.f31863n) {
                return 2;
            }
            if (i10 == ah0Var.f31864r) {
                return 3;
            }
            return 4;
        }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 != 0) {
            if (i10 != 1) {
                if (i10 != 2) {
                    if (i10 != 3) {
                        ...
                        view.setBackgroundDrawable(org.telegram.ui.ActionBar.j6.V0(context, R.drawable.greydivider, org.telegram.ui.ActionBar.j6.f18826b7));
                    } else {
            ...
            d9Var2.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18862d6, false));
            d9Var = d9Var2;
        } else {
