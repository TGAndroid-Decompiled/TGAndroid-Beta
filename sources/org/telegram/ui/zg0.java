...
public final class zg0 extends org.telegram.ui.Components.xl0 {
    ...
    public final boolean D(s4.c1 c1Var) {
        int b10 = c1Var.b();
        ah0 ah0Var = this.d;
        if (b10 != ah0Var.f32082c && b10 != ah0Var.d && b10 != ah0Var.e && b10 != ah0Var.f32083f && b10 != ah0Var.h && b10 != ah0Var.f32085r) {
            return false;
        }
        return true;
    }
    ...
    public final int j(int i10) {
        ...
        if (i10 != ah0Var.f32082c && i10 != ah0Var.d && i10 != ah0Var.e && i10 != ah0Var.f32083f && i10 != ah0Var.h) {
            if (i10 == ah0Var.f32084n) {
                return 2;
            }
            if (i10 == ah0Var.f32085r) {
                return 3;
            }
            return 4;
        }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 != 0) {
            ...
            e9Var2.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19109d6, false));
            e9Var = e9Var2;
        } else {
