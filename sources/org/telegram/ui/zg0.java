...
public final class zg0 extends org.telegram.ui.Components.b6 {
    ...
    public final xd.a N;
    public final yd.b O;
    public final org.telegram.ui.ActionBar.f6 f40476s;
    public int v;
    public float[] f40477w;
    public float[] f40478x;
    public int[] f40479y;
    ...
    public zg0(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        new ArrayList();
        new ArrayList();
        o1.c cVar = o1.h.f16167s;
        o1.c cVar2 = o1.h.f16166r;
        o1.c cVar3 = o1.h.f16163o;
        o1.c cVar4 = o1.h.f16165q;
        new o1.k(1.0f);
        new ArrayList();
        new ArrayList();
        o1.c cVar5 = o1.h.f16164p;
        new o1.k(1.0f);
        o1.j jVar = new o1.j(this, new org.telegram.ui.Components.hb(1));
        this.H = jVar;
        o1.j jVar2 = new o1.j(this, new org.telegram.ui.Components.hb(2));
        this.I = jVar2;
        jVar.f16178u = ai.m(1.0f, 1500.0f, 0.75f);
    ...
    public static void m(zg0 zg0Var, float f10, boolean z4, boolean z10) {
        ...
        if (z4) {
            ...
            while (true) {
                ...
                if (childAt3.getVisibility() == 0 && (childAt3 instanceof bh.b) && ((bh.b) childAt3).h.f46961f) {
                    view2 = childAt3;
                    break;
                }
                i12++;
            ...
            if (view2 != null) {
                ...
                if (jVar2.f16172f) {
                    ...
                    if (jVar2.f16178u == null) {
                        jVar2.f16178u = new o1.k(0.0f);
                    }
                    jVar2.f16178u.f16184i = 0.0f;
                    jVar2.f();
                }
        ...
        if (view != null) {
            ...
            if (z10) {
                ...
                if (0.0f != width3 || 0.0f != x10) {
                    ...
                    if (jVar.f16178u == null) {
                        jVar.f16178u = new o1.k(x10);
                    }
                    jVar.f16178u.f16184i = x10;
                    jVar.f();
                }
            }
        }
    ...
    public void setSkipDrawSelector(boolean z4) {
        this.F = z4;
        if (z4) {
            this.G.setColor(org.telegram.ui.ActionBar.j6.l1(0.09f, org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.al, this.f40476s)));
        }
    ...
    public final void o() {
        ...
        for (int i10 = 0; i10 < entriesCount; i10++) {
            xd.e n10 = this.f23560c.n(i10);
            ((bh.b) ((org.telegram.ui.Components.a6) n10.f46967a).f23323a).setVisualWidth(n10.b().width());
        }
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        while (true) {
            ...
            if (i15 < 3) {
                if (fArr[i15] != f13) {
                    int childCount = getChildCount();
                    float[] fArr2 = this.f40477w;
                    if (fArr2 == null || fArr2.length < childCount) {
                        this.f40477w = new float[childCount];
                        this.f40478x = new float[childCount];
                        this.f40479y = new int[childCount];
                    ...
                    for (int i17 = 0; i17 < childCount; i17++) {
                        ...
                        if (!d(childAt)) {
                            ...
                            if (childAt instanceof yg0) {
                                ...
                                f12 = bVar.Q.measureText(bVar.f1843a.getText().toString());
                            } else {
                                f12 = 0.0f;
                            }
                            this.f40477w[i17] = f12;
        ...
        for (int i19 = 0; i19 < childCount3; i19++) {
            ...
            if (childAt2 instanceof yg0) {
                ((bh.b) ((yg0) childAt2)).setTextSizeDp(f16);
            }
        }
        ...
        for (int i21 = 0; i21 < childCount4; i21++) {
            if (!d(getChildAt(i21))) {
                float[] fArr3 = this.f40477w;
                this.f40478x[i21] = f10;
                fArr3[i21] = f10;
                this.f40479y[i21] = i12;
            } else {
                float[] fArr4 = this.f40478x;
                float f18 = this.f40477w[i21] + dp2;
                fArr4[i21] = f18;
                int[] iArr2 = this.f40479y;
                if (f18 > max + dp2) {
                    i13 = 0;
                } else {
                    i13 = 1;
        ...
        if (i20 == 0) {
            ...
            for (int i22 = 0; i22 < childCount5; i22++) {
                this.f40479y[i22] = d(getChildAt(i22)) ? 1 : 0;
            }
            i20 = this.D;
        }
        ...
        if (f17 > f19) {
            ...
            if (f17 < f21) {
                ...
                for (int i24 = 0; i24 < childCount7; i24++) {
                    float[] fArr6 = this.f40478x;
                    fArr6[i24] = (this.f40479y[i24] * f22) + fArr6[i24];
                }
            }
        }
        ...
        for (int i26 = 0; i26 < childCount8; i26++) {
            if (d(getChildAt(i26))) {
                this.B[i26] = Math.round(this.f40478x[i26]);
                this.C[i26] = i25;
                i25 += this.B[i26];
            }
        }
