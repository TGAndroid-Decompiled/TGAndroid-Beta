...
public final class sg0 extends AnimatedPhoneNumberEditText {
    ...
    public final void onFocusChanged(boolean z10, int i10, Rect rect) {
        ...
        vg0 vg0Var = this.G;
        wg0 wg0Var = vg0Var.V;
        org.telegram.ui.Components.zc0 zc0Var = vg0Var.f41541f;
        if (!z10 && !vg0Var.f41537a.isFocused()) {
            f7 = 0.0f;
        } else {
            f7 = 1.0f;
        }
    ...
    public final boolean onKeyDown(int i10, KeyEvent keyEvent) {
        ...
        if (i10 == 67 && vg0Var.f41538b.length() == 0) {
            ck0Var.requestFocus();
