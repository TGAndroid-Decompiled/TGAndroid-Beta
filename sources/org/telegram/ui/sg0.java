...
public final class sg0 extends AnimatedPhoneNumberEditText {
    ...
    public final void onFocusChanged(boolean z10, int i10, Rect rect) {
        ...
        vg0 vg0Var = this.G;
        wg0 wg0Var = vg0Var.V;
        org.telegram.ui.Components.yc0 yc0Var = vg0Var.f38534f;
        if (!z10 && !vg0Var.f38531a.isFocused()) {
            f7 = 0.0f;
        } else {
            f7 = 1.0f;
        }
    ...
    public final boolean onKeyDown(int i10, KeyEvent keyEvent) {
        ...
        if (i10 == 67 && vg0Var.f38532b.length() == 0) {
            ak0Var.requestFocus();
