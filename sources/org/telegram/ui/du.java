...
public final class du extends org.telegram.ui.Components.bb {
    ...
    public final di.d Y;
    public final di.d Z;
    public final ArrayList f35861a0;
    public final HashSet f35862b0;
    public boolean f35863c0;
    public org.telegram.ui.Components.v51 f35864d0;

    public du(Activity activity, HashSet hashSet) {
        super(activity, null, false, false, new bi.b());
        ArrayList arrayList = new ArrayList();
        this.f35861a0 = arrayList;
        HashSet hashSet2 = new HashSet();
        this.f35862b0 = hashSet2;
        ...
        imageView.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view) {
                switch (r2) {
                    case 0:
                        this.f35538b.dismiss();
                        return;
                    case 1:
                        this.f35538b.S(false);
                        return;
                    default:
                        this.f35538b.S(true);
                        return;
        ...
        org.telegram.ui.Components.v51 v51Var = this.f35864d0;
        if (v51Var != null) {
            v51Var.N(false);
        }
        s4.j jVar = new s4.j();
    ...
    public static void R(du duVar, ArrayList arrayList) {
        ...
        ArrayList arrayList2 = duVar.f35861a0;
