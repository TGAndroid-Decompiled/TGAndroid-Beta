...
public final class ee0 extends org.telegram.ui.Components.vv0 {
    public final og0 B;
    public final org.telegram.ui.Components.cd0[] f36455a;
    public final EditTextBoldCursor[] f36456b;
    public final TextView f36457c;
    public final TextView d;
    public final TextView f36458e;
    public final ImageView f36459f;
    public String h;
    public String f36460n;
    public String f36461r;
    public TL_account.Password f36462s;
    public Bundle v;
    public boolean f36463w;
    public final int f36464x;
    public boolean f36465y;
    ...
    public ee0(og0 og0Var, Context context, int i10) {
        ...
        this.f36456b = new EditTextBoldCursor[i11];
        this.f36455a = new org.telegram.ui.Components.cd0[i11];
        ...
        while (i15 < this.f36456b.length) {
            ...
            this.f36456b[i15] = new EditTextBoldCursor(context);
            this.f36456b[i15].setCursorSize(AndroidUtilities.dp(20.0f));
            this.f36456b[i15].setCursorWidth(1.5f);
            this.f36456b[i15].setImeOptions(268435461);
            this.f36456b[i15].setTextSize(1, f10);
            this.f36456b[i15].setMaxLines(1);
            this.f36456b[i15].setBackground(null);
            int dp = AndroidUtilities.dp(16.0f);
            this.f36456b[i15].setPadding(dp, dp, dp, dp);
            if (i10 == 0) {
                this.f36456b[i15].setInputType(129);
                this.f36456b[i15].setTransformationMethod(PasswordTransformationMethod.getInstance());
            }
            this.f36456b[i15].setTypeface(Typeface.DEFAULT);
            EditTextBoldCursor editTextBoldCursor = this.f36456b[i15];
            ...
            EditTextBoldCursor editTextBoldCursor2 = this.f36456b[i15];
            if (i15 == 0 && i10 == 0) {
                z4 = true;
            } else {
                z4 = false;
            ...
            this.f36456b[i15].setOnFocusChangeListener(new qd(cd0Var, 3));
            if (z4) {
                LinearLayout linearLayout = new LinearLayout(context);
                linearLayout.setOrientation(0);
                linearLayout.setGravity(16);
                linearLayout.addView(this.f36456b[i15], k7.c6.l(1.0f, 0, -2));
                ImageView imageView = new ImageView(context);
                this.f36459f = imageView;
                imageView.setImageResource(R.drawable.msg_message);
                AndroidUtilities.updateViewVisibilityAnimated(imageView, true, 0.1f, false);
                imageView.setOnClickListener(new View.OnClickListener(this) {
                    public final ee0 f35506b;
                    ...
                    public final void onClick(View view) {
                        ...
                        switch (r2) {
                            case 0:
                                ee0 ee0Var = this.f35506b;
                                ImageView imageView2 = ee0Var.f36459f;
                                EditTextBoldCursor[] editTextBoldCursorArr = ee0Var.f36456b;
                                ee0Var.f36465y = !ee0Var.f36465y;
                                ...
                                imageView2.setTag(Boolean.valueOf(ee0Var.f36465y));
                                if (ee0Var.f36465y) {
                                    i16 = org.telegram.ui.ActionBar.k6.f21805l6;
                                } else {
                                ...
                                return;
                            default:
                                ee0 ee0Var2 = this.f35506b;
                                if (ee0Var2.f36464x == 0) {
                                    ee0Var2.o(null, null);
                                    return;
                                } else {
                                    ee0Var2.o(ee0Var2.f36460n, null);
                                    return;
                                }
                        }
                    }
                ...
                cd0Var.addView(this.f36456b[i15], k7.c6.c(-2.0f, -1));
            }
            cd0Var.e(this.f36456b[i15]);
            addView(cd0Var, k7.c6.t(-1, -2, 1, 16, 16, 16, 0));
            this.f36456b[i15].setOnEditorActionListener(new TextView.OnEditorActionListener() {
                @Override
    ...
    public final void h(String str) {
        if (!this.f36463w) {
            EditTextBoldCursor[] editTextBoldCursorArr = this.f36456b;
            ...
            if (length == 0) {
                ...
                bundle.putString("password", this.f36461r);
    ...
    @Override
    public final void j() {
        AndroidUtilities.runOnUIThread(new c10(this, 18), og0.f39709q0);
    }

    @Override
    public final void k(Bundle bundle) {
        Bundle bundle2 = bundle.getBundle("recoveryview_params" + this.f36464x);
        this.v = bundle2;
        if (bundle2 != null) {
            m(bundle2, true);
        }
    ...
    public final void l(Bundle bundle) {
        if (this.v != null) {
            bundle.putBundle("recoveryview_params" + this.f36464x, this.v);
        }
    }
    ...
    public final void m(Bundle bundle, boolean z4) {
        ...
        int i10 = 0;
        while (true) {
            editTextBoldCursorArr = this.f36456b;
        ...
        if (string != null) {
            ...
            this.f36462s = TLdeserialize;
            TwoStepVerificationActivity.m0(TLdeserialize);
        }
        this.f36460n = this.v.getString("new_password");
    ...
    public final void n() {
        EditTextBoldCursor[] editTextBoldCursorArr;
        int i10;
        this.f36457c.setTextColor(org.telegram.ui.ActionBar.k6.w0(null, org.telegram.ui.ActionBar.k6.G6, false));
        this.d.setTextColor(org.telegram.ui.ActionBar.k6.w0(null, org.telegram.ui.ActionBar.k6.D6, false));
        for (EditTextBoldCursor editTextBoldCursor : this.f36456b) {
            editTextBoldCursor.setTextColor(org.telegram.ui.ActionBar.k6.w0(null, org.telegram.ui.ActionBar.k6.G6, false));
            editTextBoldCursor.setCursorColor(org.telegram.ui.ActionBar.k6.w0(null, org.telegram.ui.ActionBar.k6.f21805l6, false));
        }
        for (org.telegram.ui.Components.cd0 cd0Var : this.f36455a) {
            cd0Var.f();
        }
        this.f36458e.setTextColor(org.telegram.ui.ActionBar.k6.w0(null, org.telegram.ui.ActionBar.k6.f21896q6, false));
        ImageView imageView = this.f36459f;
        if (imageView != null) {
            if (this.f36465y) {
                i10 = org.telegram.ui.ActionBar.k6.f21805l6;
            } else {
                i10 = org.telegram.ui.ActionBar.k6.H6;
            }
            imageView.setColorFilter(org.telegram.ui.ActionBar.k6.w0(null, i10, false));
            imageView.setBackground(org.telegram.ui.ActionBar.k6.f0(this.B.getThemedColor(org.telegram.ui.ActionBar.k6.f21752i6), 1, -1));
        }
    }
    ...
    public final void o(String str, String str2) {
        ...
        if (!TextUtils.isEmpty(str)) {
            ...
            passwordinputsettings.new_algo = this.f36462s.new_algo;
        }
