...
public final class rm implements org.telegram.ui.Components.mg {
    ...
    public final boolean C0() {
        int i10;
        bo boVar = this.f37149c;
        if ((!boVar.getMessagesController().isForum(boVar.a()) || boVar.f32328h4) && (i10 = boVar.R3) != 9 && boVar.S3 > 0) {
            if (i10 != 0) {
    ...
    public final void E0(int i10, int i11) {
        ...
        if (boVar.f32336i0 != null) {
            ...
            if (i11 - i10 > 0) {
                ...
                if (yVar.f19726o == null) {
                    yVar.f19726o = 1;
                    if (boVar.f32336i0.f19723l != 0) {
                        if ((boVar.R3 == 3 && boVar.I8() == boVar.getUserConfig().getClientUserId()) || (boVar.R3 == 0 && ((boVar.f32279d4 == 0 || boVar.f32328h4) && !UserObject.isReplyUser(boVar.f32299f) && !boVar.A9()))) {
                            boVar.f32336i0.f(0);
                            bo.J3(boVar);
                            ...
                            org.telegram.ui.ActionBar.y yVar2 = boVar.f32288e0;
                            if (yVar2 != null) {
                                yVar2.f(8);
                            }
            ...
            org.telegram.ui.ActionBar.y yVar3 = boVar.f32336i0;
            if (yVar3.f19726o != null) {
                yVar3.f19726o = null;
                if (yVar3.f19723l != 8) {
                    if ((boVar.R3 == 3 && boVar.I8() == boVar.getUserConfig().getClientUserId()) || (boVar.R3 == 0 && ((boVar.f32279d4 == 0 || boVar.f32328h4) && !UserObject.isReplyUser(boVar.f32299f) && !boVar.A9()))) {
                        boVar.f32336i0.f(8);
                        if (boVar.Y.k0() && TextUtils.isEmpty(boVar.Y.getSlowModeTimer())) {
                            ...
                            org.telegram.ui.ActionBar.y yVar4 = boVar.f32288e0;
                            if (yVar4 != null) {
                                yVar4.f(0);
                            }
                        ...
                        org.telegram.ui.ActionBar.v0 v0Var3 = boVar.f32324h0;
                        if (v0Var3 != null) {
                            v0Var3.setVisibility(0);
                        }
                        org.telegram.ui.ActionBar.y yVar5 = boVar.f32288e0;
                        if (yVar5 != null) {
                            yVar5.f(8);
                        }
                    ...
                    ofFloat2.setInterpolator(org.telegram.ui.Components.qr.f27423f);
    ...
    public final void H(CharSequence charSequence, boolean z10, int i10, int i11, long j3) {
        ...
        if (i10 != 0) {
            ...
            if (messagePreviewParams2 != null && (messages2 = messagePreviewParams2.forwardMessages) != null && !messages2.messages.isEmpty()) {
                boVar.S3 += boVar.f32305f5.forwardMessages.messages.size();
            }
            boVar.Ec(false);
        }
        if (!TextUtils.isEmpty(charSequence) && (messagePreviewParams = boVar.f32305f5) != null && (messages = messagePreviewParams.forwardMessages) != null && !messages.messages.isEmpty() && boVar.f32305f5.quote == null && j3 <= 0) {
            ArrayList<MessageObject> arrayList2 = new ArrayList<>();
            boVar.f32305f5.forwardMessages.getSelectedMessages(arrayList2);
            ...
            if (z12) {
                ...
                org.telegram.ui.Components.aj0 aj0Var = ((org.telegram.ui.Components.lc) M.e).f25902a;
        ...
        if (ChatObject.isForum(boVar.e) && !boVar.f32328h4 && (messageObject = boVar.f32403n5) != null) {
            ...
            if (tL_forumTopic == null) {
                ...
                topicId = MessageObject.getTopicId(i12, boVar.f32403n5.messageOwner, true);
            } else {
                topicId = tL_forumTopic.f18164id;
            }
            long j10 = topicId;
            if (j10 != 0) {
        ...
        if (mkVar != null && mkVar.getEmojiView() != null && (g1Var = boVar.Y.getEmojiView().T0) != null) {
            if (g1Var.e) {
                MessagesController.getInstance(g1Var.f9735a).sendTyping(g1Var.f9736b, g1Var.f9737c, 2, 0);
            }
            g1Var.f9738f = -1L;
        }
    ...
    public final TLRPC.TL_channels_sendAsPeers J() {
        return this.f37149c.ha;
    }

    @Override
    public final void J0() {
        this.f37149c.ja(0, false);
    }

    @Override
    public final void K(float f7, int i10) {
        gl glVar = this.f37149c.f32252b3;
        if (glVar != null) {
            glVar.e(f7, i10);
        }
    }
    ...
    public final void T0() {
        ...
        if (sendingMessageId != 0) {
            this.f37149c.F(sendingMessageId, 0, 0, 0, true, true);
        }
    }
    ...
    public final void a1(int i10) {
        ...
        bo boVar = this.f37149c;
        if (boVar.f32266c3.getVisibility() != i11) {
            boVar.f32266c3.setVisibility(i11);
        }
    }

    @Override
    public final int b1() {
        return this.f37149c.X0.getHeight();
    }
    ...
    public final void d2() {
        org.telegram.ui.Components.ny0 ny0Var = this.f37149c.f32276d1;
        if (ny0Var != null) {
            ny0Var.e();
        }
    }
    ...
    public final void f2(int i10) {
        ...
        if (i10 < currentActionBarHeight) {
            boVar.Z4 = false;
            if (boVar.f32276d1.getVisibility() == 0) {
                boVar.f32276d1.setVisibility(4);
            }
        } else {
            boVar.Z4 = true;
            if (boVar.f32276d1.getVisibility() == 4 && !boVar.isInPreviewMode()) {
                boVar.f32276d1.setVisibility(0);
            }
        }
        boVar.f32240a5 = true ^ boVar.Y.t0();
        if (boVar.Y.t0()) {
            i11 = 65536;
        } else {
            i11 = 0;
    ...
    public final void i2() {
        ...
        if (boVar.getParentActivity() != null) {
            if ((boVar.e != null || boVar.f32243a8 != null) && boVar.fragmentView != null) {
                ...
                if ((i40Var == null || i40Var.getVisibility() != 0) && (indexOfChild = (tmVar = boVar.X0).indexOfChild(boVar.S)) != -1) {
                    ...
                    if (boVar.f32302f2 == null) {
                        org.telegram.ui.Components.i40 i40Var2 = new org.telegram.ui.Components.i40(9, boVar.getParentActivity(), boVar.f32297ea, false);
                        boVar.f32302f2 = i40Var2;
                        i40Var2.setVisibility(8);
                        tmVar.addView(boVar.f32302f2, indexOfChild + 1, w7.x5.d(-2, -2.0f, 51, 10.0f, 0.0f, 10.0f, 0.0f));
                    }
                    TLRPC.UserFull userFull = boVar.f32243a8;
                    if (userFull != null && userFull.voice_messages_forbidden) {
                        org.telegram.ui.Components.i40 i40Var3 = boVar.f32302f2;
                        if (boVar.Y.f21747c1) {
                            i10 = R.string.VideoMessagesRestrictedByPrivacy;
                        } else {
                            i10 = R.string.VoiceMessagesRestrictedByPrivacy;
                        }
                        i40Var3.setText(AndroidUtilities.replaceTags(LocaleController.formatString(i10, boVar.f32299f.first_name)));
                    } else if (!ChatObject.canSendVoice(boVar.e) && !ChatObject.canSendRoundVideo(boVar.e)) {
                        if (!boVar.K6()) {
                            if (boVar.Y.f21747c1) {
                                boVar.f32302f2.setText(ChatObject.getRestrictedErrorText(boVar.e, 21));
                            } else {
                                boVar.f32302f2.setText(ChatObject.getRestrictedErrorText(boVar.e, 20));
                            }
                        } else {
                            return;
                        }
                    } else if (ChatObject.isActionBannedByDefault(boVar.e, 20)) {
                        boVar.f32302f2.setText(LocaleController.getString(R.string.GlobalAttachVoiceRestricted));
                    } else if (ChatObject.isActionBannedByDefault(boVar.e, 21)) {
                        boVar.f32302f2.setText(LocaleController.getString(R.string.GlobalAttachRoundRestricted));
                    } else if (ChatObject.isActionBannedByDefault(boVar.e, 7)) {
                        boVar.f32302f2.setText(LocaleController.getString(R.string.GlobalAttachMediaRestricted));
                    } else {
                        ...
                        if (tL_chatBannedRights != null) {
                            if (AndroidUtilities.isBannedForever(tL_chatBannedRights)) {
                                boVar.f32302f2.setText(LocaleController.getString(R.string.AttachMediaRestrictedForever));
                            } else {
                                boVar.f32302f2.setText(LocaleController.formatString("AttachMediaRestricted", R.string.AttachMediaRestricted, LocaleController.formatDateForBan(boVar.e.banned_rights.until_date)));
                            }
                        } else {
                            return;
                        }
                    ...
                    boVar.f32302f2.f(sendButton, true);
                }
            }
        }
    }
    ...
    public final void k2(int i10, int i11, int i12, long j3, long j10, boolean z10) {
        bo boVar = this.f37149c;
        boolean z11 = true;
        if (boVar.f32252b3 == null && CameraView.isCameraAllowed() && boVar.getParentActivity() != null) {
            gl glVar = new gl(boVar, boVar.getParentActivity(), boVar, boVar.f32297ea);
            boVar.f32252b3 = glVar;
            glVar.setClipToPadding(false);
            gl glVar2 = boVar.f32252b3;
            ah.c cVar = boVar.J;
            ...
            boVar.X0.addView(boVar.f32252b3, Math.min(indexOfChild + 1, boVar.X0.getChildCount()), w7.x5.e(-1, -1, 51));
        }
        gl glVar3 = boVar.f32252b3;
        if (glVar3 != null) {
            if (i10 == 0) {
                glVar3.l(false);
                boVar.f32524x0.B0();
    ...
    public final void l1(CharSequence charSequence, boolean z10, boolean z11) {
        ...
        if (fkVar != null && fkVar.getAdapter() != null) {
            ...
            boVar.I1.getAdapter().U(charSequence2, boVar.Y.getCursorPosition(), boVar.f32491u6, false, false);
        } else {
            charSequence2 = charSequence;
        }
        i9.s sVar = boVar.J5;
        ...
        if (chat == null || ChatObject.canSendEmbed(chat)) {
            mk mkVar = boVar.Y;
            if (mkVar.X2 && (!mkVar.r0() || !boVar.Y.Z1)) {
                if (z10) {
        ...
        xk xkVar = boVar.f32534xa;
        if (xkVar != null) {
            ArrayList arrayList = xkVar.F;
            for (int i10 = 0; i10 < arrayList.size(); i10++) {
                ((fz) arrayList.get(i10)).f33712n = true;
            }
        }
        zg.l0 l0Var = zg.l0.B;
        if (l0Var != null) {
        ...
        if (!z11) {
            ...
            if ((ijVar != null && ijVar.getVisibility() == 0) || ((i40Var = boVar.f32338i2) != null && i40Var.getVisibility() == 0)) {
                ij ijVar2 = boVar.f32314g2;
                if (ijVar2 != null) {
                    ijVar2.b(true);
                }
                org.telegram.ui.Components.i40 i40Var2 = boVar.f32338i2;
                if (i40Var2 != null) {
                    i40Var2.b(true);
                    return;
                }
            ...
            qf qfVar = boVar.Na;
            if (UserObject.isUserSelf(boVar.f32299f) || ((chatFull = boVar.Z7) != null && chatFull.slowmode_next_send_date > 0 && boVar.R3 == 0)) {
                z13 = true;
            }
            if (!boVar.f32351j2 && !boVar.f32326h2 && !z13 && SharedConfig.scheduledHintShows < 3 && !boVar.Y.r0()) {
    ...
    public final boolean o1() {
        ...
        if (user != null && !UserObject.isUserSelf(user) && !boVar.f32299f.bot && boVar.h == null && boVar.R3 == 0) {
            return true;
        }
        return false;
    }
    ...
    @Override
    public final rn p0() {
        return this.f37149c.f32377l5;
    }

    @Override
    public final int q() {
        return this.f37149c.X0.R();
    }
    ...
    public final void s1() {
        ...
        if (fkVar != null) {
            ...
            animate.alpha(f7).setInterpolator(org.telegram.ui.Components.qr.f27423f).start();
        }
        org.telegram.ui.Components.ny0 ny0Var = boVar.f32276d1;
        if (ny0Var != null) {
            ny0Var.setVisibility(0);
            ViewPropertyAnimator animate2 = boVar.f32276d1.animate();
            if (!z12 && !boVar.isInPreviewMode()) {
                f10 = 1.0f;
            }
            animate2.alpha(f10).setInterpolator(org.telegram.ui.Components.qr.f27423f).withEndAction(new bi.f(19, this, z12)).start();
        }
    }
    ...
    public final void t1(View view, CharSequence charSequence, boolean z10) {
        ...
        if (v0Var != null && v0Var.getVisibility() != 0) {
            boVar.f32324h0.setVisibility(0);
            org.telegram.ui.ActionBar.y yVar = boVar.f32288e0;
            if (yVar != null) {
                yVar.f(8);
            }
            hs hsVar = boVar.f32275d0;
    ...
    public final void v1(CharSequence charSequence) {
        this.f37149c.Ya(charSequence, true);
    }

    @Override
    public final boolean w1() {
        MessagePreviewParams.Messages messages;
        MessagePreviewParams messagePreviewParams = this.f37149c.f32305f5;
    ...
    public final void x() {
        ...
        if (boVar.f32414o5 != 0) {
            boVar.getConnectionsManager().cancelRequest(boVar.f32414o5, true);
            boVar.f32414o5 = 0;
        }
        boVar.yc(0, true);
        boVar.hc(false);
