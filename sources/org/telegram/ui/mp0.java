...
public final class mp0 extends FrameLayout {
    public final TextView f35641a;
    public org.telegram.ui.Components.t01 f35642b;
    public final org.telegram.ui.Components.o5 f35643c;
    public final np0 d;
    ...
    public mp0(np0 np0Var, Context context) {
        ...
        setBackgroundColor(tp0Var.getThemedColor(org.telegram.ui.ActionBar.h6.f19060d6));
        TextView textView = new TextView(context);
        this.f35641a = textView;
        textView.setTextSize(1, 16.0f);
        boolean z10 = tp0Var.f38165a;
        ...
        this.f35643c = new org.telegram.ui.Components.o5(AndroidUtilities.dp(24.0f), 13, this, false);
    }
    ...
    public final int a() {
        ...
        int i12 = np0Var.h;
        if (i12 < 0) {
            int i13 = org.telegram.ui.ActionBar.h6.f19338s8;
            if (AndroidUtilities.computePerceivedBrightness(tp0Var.getThemedColor(i13)) > 0.8f) {
                int i14 = org.telegram.ui.ActionBar.h6.f19244n6;
                ...
                int i16 = org.telegram.ui.ActionBar.h6.f19060d6;
            ...
            return tp0Var.getThemedColor(org.telegram.ui.ActionBar.h6.f19319r8[i12]);
        } else {
            if (np0Var.m0 == 1) {
            ...
            return tp0Var.getThemedColor(org.telegram.ui.ActionBar.h6.f19319r8[0]);
        }
    }
    ...
    public final void b(boolean z10) {
        int i10;
        np0 np0Var = this.d;
        long j3 = np0Var.f35953n;
        org.telegram.ui.Components.o5 o5Var = this.f35643c;
        if (j3 != 0) {
            o5Var.j(j3, z10);
            this.f35642b = null;
            return;
        ...
        if (this.f35642b == null) {
            if (np0Var.f35956p0.f38165a) {
                i10 = R.string.ChannelReplyIconOff;
            } else {
                i10 = R.string.UserReplyIconOff;
            }
            this.f35642b = new org.telegram.ui.Components.t01(LocaleController.getString(i10), 16.0f, null);
        }
    }
    ...
    public final void c() {
        ...
        if (z10) {
            ...
            width = (getWidth() - o5Var.f26924s) - AndroidUtilities.dp(21.0f);
        }
        int height = (getHeight() - o5Var.f26924s) / 2;
        if (LocaleController.isRTL) {
            width2 = AndroidUtilities.dp(21.0f) + o5Var.f26924s;
        } else {
            width2 = getWidth() - AndroidUtilities.dp(21.0f);
        }
        o5Var.setBounds(width, height, width2, (getHeight() + o5Var.f26924s) / 2);
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        org.telegram.ui.Components.o5 o5Var = this.f35643c;
        o5Var.k(valueOf);
        org.telegram.ui.Components.t01 t01Var = this.f35642b;
        if (t01Var != null) {
            t01Var.c((getMeasuredWidth() - this.f35642b.l()) - AndroidUtilities.dp(19.0f), getMeasuredHeight() / 2.0f, 1.0f, this.d.f35956p0.getThemedColor(org.telegram.ui.ActionBar.h6.q6), canvas);
        } else {
            o5Var.draw(canvas);
        }
    }
