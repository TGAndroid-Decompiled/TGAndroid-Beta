...
public final class ov extends org.telegram.ui.ActionBar.n2 {
    public static final org.telegram.ui.Components.ir0 f39344x = new org.telegram.ui.Components.ir0(2);
    public uy f39345a;
    public ContactsActivity f39346b;
    public org.telegram.ui.ActionBar.v0 f39347c;
    public Paint d;
    public ScrollSlidingTextTabStrip f39348e;
    public nv[] f39349f;
    ...
    public static void j0(ov ovVar, float f7) {
        ...
        for (int i10 = 0; i10 < nvVarArr.length; i10++) {
            ...
            bi.o0 o0Var = nvVarArr[i10].f39066e;
            if (o0Var != null) {
    ...
    public final View createView(Context context) {
        ...
        bi.o0 o0Var;
        ContactsActivity contactsActivity = this.f39346b;
        uy uyVar = this.f39345a;
        nv[] nvVarArr = this.f39349f;
        ...
        this.f39348e = scrollSlidingTextTabStrip;
        scrollSlidingTextTabStrip.setUseSameWidth(true);
        this.actionBar.addView(this.f39348e, w7.x5.e(-1, 44, 83));
        this.f39348e.setDelegate(new g(this, 14));
        ...
        for (int i10 = 0; i10 < nvVarArr.length; i10++) {
            ...
            if (i10 == 0) {
                ...
                nvVar2.f39063a = uyVar;
                nvVar2.d = uyVar.f41287e0[0].f40886a;
                uyVar.M3();
                ey eyVar = uyVar.C0;
                if (eyVar != null) {
                    o0Var = eyVar.V;
                ...
                nvVar2.f39066e = o0Var;
            } else if (i10 == 1) {
                nv nvVar3 = nvVarArr[i10];
                nvVar3.f39063a = contactsActivity;
                nvVar3.d = contactsActivity.f33374f;
                nvVar3.setVisibility(8);
            }
            nvVarArr[i10].d.setScrollingTouchSlop(1);
            nv nvVar4 = nvVarArr[i10];
            nvVar4.f39064b = (FrameLayout) nvVar4.f39063a.getFragmentView();
            nv nvVar5 = nvVarArr[i10];
            nvVar5.f39065c = nvVar5.f39063a.getActionBar();
            nv nvVar6 = nvVarArr[i10];
            nvVar6.addView(nvVar6.f39064b, w7.x5.c(-1.0f, -1));
            AndroidUtilities.removeFromParent(nvVarArr[i10].f39065c);
            nv nvVar7 = nvVarArr[i10];
            nvVar7.addView(nvVar7.f39065c, w7.x5.c(-2.0f, -1));
            nvVarArr[i10].f39065c.setVisibility(8);
            for (int i11 = 0; i11 < 2; i11++) {
                if (i11 == 0) {
                    ll0Var = nvVarArr[i10].d;
                } else {
                    ll0Var = nvVarArr[i10].f39066e;
                }
                if (ll0Var != null) {
        ...
        ScrollSlidingTextTabStrip scrollSlidingTextTabStrip2 = this.f39348e;
        if (scrollSlidingTextTabStrip2 != null) {
            scrollSlidingTextTabStrip2.a(0, LocaleController.getString(R.string.BlockUserChatsTitle), null);
            this.f39348e.a(1, LocaleController.getString(R.string.BlockUserContactsTitle), null);
            this.f39348e.setVisibility(0);
            this.actionBar.setExtraHeight(AndroidUtilities.dp(44.0f));
            int currentTabId = this.f39348e.getCurrentTabId();
            if (currentTabId >= 0) {
                nvVarArr[0].f39067f = currentTabId;
            }
            this.f39348e.c();
        }
        m0(false);
        if (this.f39348e.getCurrentTabId() == this.f39348e.getFirstTabId()) {
            z10 = true;
        }
        this.f39353w = z10;
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.fragmentView, 0, null, null, null, null, org.telegram.ui.ActionBar.j6.f20691d6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f39348e.getTabsContainer(), 262148, new Class[]{TextView.class}, null, null, null, org.telegram.ui.ActionBar.j6.I8));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f39348e.getTabsContainer(), 262148, new Class[]{TextView.class}, null, null, null, org.telegram.ui.ActionBar.j6.J8));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f39348e.getTabsContainer(), 65568, new Class[]{TextView.class}, null, null, null, org.telegram.ui.ActionBar.j6.K8));
        arrayList.add(new org.telegram.ui.ActionBar.l6(null, 0, null, null, new Drawable[]{this.f39348e.getSelectorDrawable()}, null, org.telegram.ui.ActionBar.j6.L8));
        arrayList.addAll(this.f39345a.getThemeDescriptions());
        arrayList.addAll(this.f39346b.getThemeDescriptions());
        return arrayList;
    }
    ...
    public final void m0(boolean z10) {
        ...
        for (int i11 = 0; i11 < 2; i11++) {
            if (i11 == 0) {
                ...
                ll0Var = nvVarArr[z10 ? 1 : 0].f39066e;
            }
            if (ll0Var != null) {
                ll0Var.getAdapter();
