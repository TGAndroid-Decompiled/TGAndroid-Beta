...
public final class d9 extends f70 {
    public final int f35726v0;
    public final org.telegram.ui.ActionBar.n2 f35727w0;
    ...
    public final void n0(HashSet hashSet) {
        ...
        if (size == 1) {
            ...
            ConnectionsManager.getInstance(i10).sendRequest(createconferencecall, new hg.u(i10, hashSet, this.f35727w0));
        }
        finishFragment();
    }
}
