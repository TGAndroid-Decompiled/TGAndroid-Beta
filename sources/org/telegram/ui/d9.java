...
public final class d9 extends f70 {
    public final int f35752v0;
    public final org.telegram.ui.ActionBar.n2 f35753w0;
    ...
    public final void n0(HashSet hashSet) {
        ...
        int i10 = this.f35752v0;
        if (size == 1) {
            TLRPC.User user = MessagesController.getInstance(i10).getUser((Long) hashSet.iterator().next());
            TLRPC.UserFull userFull = MessagesController.getInstance(i10).getUserFull(user.f20043id);
            if (userFull == null) {
                TLRPC.TL_users_getFullUser tL_users_getFullUser = new TLRPC.TL_users_getFullUser();
                tL_users_getFullUser.f20036id = MessagesController.getInstance(i10).getInputUser(user.f20043id);
            ...
            ConnectionsManager.getInstance(i10).sendRequest(createconferencecall, new hg.u(i10, hashSet, this.f35753w0));
        }
        finishFragment();
    }
}
