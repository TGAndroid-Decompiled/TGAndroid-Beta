...
public final class d9 extends e70 {
    public final int f32982v0;
    public final org.telegram.ui.ActionBar.n2 f32983w0;
    ...
    public final void n0(HashSet hashSet) {
        ...
        int i10 = this.f32982v0;
        if (size == 1) {
            TLRPC.User user = MessagesController.getInstance(i10).getUser((Long) hashSet.iterator().next());
            TLRPC.UserFull userFull = MessagesController.getInstance(i10).getUserFull(user.f18256id);
            if (userFull == null) {
                TLRPC.TL_users_getFullUser tL_users_getFullUser = new TLRPC.TL_users_getFullUser();
                tL_users_getFullUser.f18249id = MessagesController.getInstance(i10).getInputUser(user.f18256id);
            ...
            ConnectionsManager.getInstance(i10).sendRequest(createconferencecall, new gg.u(i10, hashSet, this.f32983w0));
        }
        finishFragment();
    }
}
