...
public final class d9 extends z60 {
    public final int f33043v0;
    public final org.telegram.ui.ActionBar.m2 f33044w0;
    ...
    public final void n0(HashSet hashSet) {
        ...
        int i10 = this.f33043v0;
        if (size == 1) {
            TLRPC.User user = MessagesController.getInstance(i10).getUser((Long) hashSet.iterator().next());
            TLRPC.UserFull userFull = MessagesController.getInstance(i10).getUserFull(user.f18468id);
            if (userFull == null) {
                TLRPC.TL_users_getFullUser tL_users_getFullUser = new TLRPC.TL_users_getFullUser();
                tL_users_getFullUser.f18461id = MessagesController.getInstance(i10).getInputUser(user.f18468id);
            ...
            ConnectionsManager.getInstance(i10).sendRequest(createconferencecall, new gg.u(i10, hashSet, this.f33044w0));
        }
        finishFragment();
    }
}
