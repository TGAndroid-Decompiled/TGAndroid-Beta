...
public final class m91 extends FrameLayout {
    ...
    public m91(Context context, int i10) {
        super(context);
        this.f34895a = i10;
    }
    ...
    public void dispatchDraw(Canvas canvas) {
        switch (this.f34895a) {
            case 5:
                org.telegram.ui.ActionBar.j6.f18014i3.setBounds(0, 0, getMeasuredWidth(), org.telegram.ui.ActionBar.j6.f18014i3.getIntrinsicHeight());
    ...
    public void onDraw(Canvas canvas) {
        switch (this.f34895a) {
            case 4:
                super.onDraw(canvas);
                canvas.drawRect(0.0f, 0.0f, getMeasuredWidth(), 1.0f, org.telegram.ui.ActionBar.j6.f18049k0);
                return;
            default:
                super.onDraw(canvas);
                return;
