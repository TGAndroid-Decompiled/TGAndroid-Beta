...
public final class vj extends xm {
    ...
    public final ArrayList f38440a3;
    public final ArrayList f38441b3;
    public final ArrayList f38442c3;
    public final ArrayList f38443d3;
    public int f38444e3;
    public int f38445f3;
    public int f38446g3;
    public long f38447h3;
    public float f38448i3;
    public float j3;
    public boolean f38449k3;
    public final float f38450l3;
    public final Paint f38451m3;
    public final Paint f38452n3;
    public final o1.j f38453o3;
    public final o1.k f38454p3;
    public final o1.j f38455q3;
    public final o1.k f38456r3;
    public final o1.j f38457s3;
    public final o1.k f38458t3;
    public boolean f38459u3;
    public final Path f38460v3;
    public boolean f38461w3;
    public int f38462x3;
    public final bo y3;
    ...
    public vj(bo boVar, Context context, zn znVar) {
        ...
        this.f38440a3 = new ArrayList();
        this.f38441b3 = new ArrayList();
        this.f38442c3 = new ArrayList();
        this.f38443d3 = new ArrayList(10);
        this.f38450l3 = 2000.0f;
        Paint paint = new Paint(1);
        this.f38451m3 = paint;
        Paint paint2 = new Paint(1);
        this.f38452n3 = paint2;
        o1.j jVar = new o1.j(0.0f);
        this.f38453o3 = jVar;
        o1.k kVar = new o1.k(jVar);
        kVar.h = 0.0f;
        kVar.f15355g = 2000.0f;
        kVar.f15361u = org.telegram.ui.Cells.p6.l(0.0f, 1500.0f, 1.0f);
        kVar.b(new o1.g(this) {
            public final vj f37804b;
        ...
        kVar2.h = 0.0f;
        kVar2.f15361u = org.telegram.ui.Cells.p6.l(0.0f, 400.0f, 0.5f);
        ...
        kVar3.h = 0.0f;
        kVar3.f15361u = org.telegram.ui.Cells.p6.l(0.0f, 200.0f, 1.0f);
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (boVar.N9 != 0.0f) {
            ...
            if (boVar.U9 != 0.0f) {
                f7 = (boVar.f32502x0.getMeasuredHeight() - boVar.N9) * boVar.U9;
            } else {
                f7 = 0.0f;
            }
            float f10 = (-boVar.N9) - f7;
            boVar.f32524ya = f10;
    ...
    public final void draw(android.graphics.Canvas r44) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.vj.draw(android.graphics.Canvas):void");
    }

    @Override
    public final boolean drawChild(android.graphics.Canvas r22, android.view.View r23, long r24) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.vj.drawChild(android.graphics.Canvas, android.view.View, long):boolean");
    }
    ...
    public final void onDraw(android.graphics.Canvas r32) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.vj.onDraw(android.graphics.Canvas):void");
    }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (this.f38462x3 != measuredHeight) {
            this.f38461w3 = true;
            xj xjVar = boVar.f32515y0;
            if (xjVar != null) {
                xjVar.g();
            }
            boVar.W8.a();
            this.f38461w3 = false;
            this.f38462x3 = measuredHeight;
        }
        boVar.R5 = false;
        um umVar = boVar.f32250c9;
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (boVar.N9 != 0.0f && (motionEvent.getAction() == 1 || motionEvent.getAction() == 3)) {
            ...
            if (motionEvent.getAction() == 1 && min == 1.0f && (zpVar = boVar.P9) != null && !zpVar.R) {
                if (zpVar.K != 1.0f) {
                    ...
                    ofFloat.start();
                    final zp zpVar2 = boVar.P9;
                    ej ejVar = new ej(this, 1);
                    AnimatorSet animatorSet = zpVar2.J;
                    if (animatorSet != null) {
                        animatorSet.removeAllListeners();
                        zpVar2.J.cancel();
                    }
                    zpVar2.Y = ejVar;
                    zpVar2.J = new AnimatorSet();
                    ValueAnimator ofFloat2 = ValueAnimator.ofFloat(zpVar2.K, 1.0f);
                        ...
                        public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                            switch (r2) {
                                case 0:
                                    zp zpVar3 = zpVar2;
                                    zpVar3.getClass();
                                    zpVar3.K = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                                    zpVar3.T.invalidate();
                                    View view = zpVar3.f40294a0;
                                    if (view != null) {
                                        view.invalidate();
                                        return;
                                    }
                    ...
                    ValueAnimator ofFloat3 = ValueAnimator.ofFloat(zpVar2.L, 0.0f);
                    ...
                    zpVar2.J.addListener(new t4(zpVar2, 23));
                    zpVar2.J.playTogether(ofFloat2, ofFloat3);
                    zpVar2.J.setDuration(120L);
                    zpVar2.J.setInterpolator(qrVar);
                    zpVar2.J.start();
                } else {
                    bo.X1(boVar);
                }
                ...
                zp zpVar3 = boVar.P9;
                if (zpVar3 != null && zpVar3.R) {
                    long currentTimeMillis = System.currentTimeMillis();
                    zp zpVar4 = boVar.P9;
                    if (currentTimeMillis - zpVar4.U < 500 && zpVar4.M) {
                        AnimatorSet animatorSet2 = new AnimatorSet();
                        boVar.Q9 = animatorSet2;
                        if (boVar.P9 != null) {
                            bVar.a(false, true);
                        }
                        ValueAnimator ofFloat4 = ValueAnimator.ofFloat(boVar.N9, AndroidUtilities.dp(111.0f));
                ...
                ValueAnimator ofFloat6 = ValueAnimator.ofFloat(boVar.N9, 0.0f);
                boVar.Q9 = ofFloat6;
                if (boVar.P9 != null) {
                    bVar.a(false, true);
                }
        ...
        if (!this.X1) {
            ...
            if (!kVar.s() && !boVar.A9()) {
                z1(motionEvent);
                if (boVar.f32286f9 || onTouchEvent) {
                    return true;
                }
            } else {
                return onTouchEvent;
    ...
    public final void x1(android.graphics.Canvas r30, android.graphics.RectF r31) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.vj.x1(android.graphics.Canvas, android.graphics.RectF):void");
    }
    ...
    public final void y1(Canvas canvas, RectF rectF) {
        ...
        ArrayList arrayList3 = this.f38440a3;
        ...
        ArrayList arrayList4 = this.f38441b3;
        ...
        if (size3 > 0) {
            ...
            while (i12 < size3) {
                ...
                if (bo.d2(boVar, t1Var3, rectF)) {
                    ...
                    if (t1Var3.getTransitionParams().f20927v0) {
        ...
        ArrayList arrayList5 = this.f38442c3;
        ...
        if (size4 > 0) {
            for (int i13 = 0; i13 < size4; i13++) {
                ...
                if (!bo.d2(boVar, t1Var4, rectF)) {
                    ...
                    if (!z10 && t1Var4.getTransitionParams().f20927v0) {
    ...
    public final void z1(MotionEvent motionEvent) {
        ...
        if (motionEvent != null && motionEvent.getAction() == 0 && !boVar.f32286f9 && !boVar.f32274e9 && boVar.f32262d9 == null) {
            ...
            if (!z10) {
                ...
                if (pressedChildView instanceof org.telegram.ui.Cells.t1) {
                    ...
                    boVar.f32262d9 = (org.telegram.ui.Cells.t1) pressedChildView;
                    MessageObject T1 = bo.T1(boVar);
                    boolean F6 = boVar.F6(T1);
                    int i10 = boVar.R3;
                    if ((i10 == 0 || i10 == 5 || i10 == 8 || (i10 == 3 && boVar.f32257d4 == boVar.getUserConfig().getClientUserId())) && (((arrayList = boVar.f32217a4) == null || !arrayList.contains(T1)) && ((boVar.E8(T1) != 1 || (T1.getDialogId() != boVar.L6 && !T1.needDrawBluredPreview())) && ((boVar.h != null || T1.getId() >= 0) && (((chat2 = boVar.e) == null || !ChatObject.isForum(chat2) || F6) && !boVar.b9() && (!T1.isEphemeral() || !T1.isOut())))))) {
                        this.f38446g3 = motionEvent.getPointerId(0);
                        boVar.f32274e9 = true;
                        this.f38444e3 = (int) motionEvent.getX();
                        this.f38445f3 = (int) motionEvent.getY();
                        return;
                    }
                    bo.V1(boVar, 0.0f);
                    boVar.f32262d9 = null;
        ...
        if (boVar.f32262d9 != null && motionEvent != null && motionEvent.getAction() == 2 && motionEvent.getPointerId(0) == this.f38446g3) {
            int max = Math.max(AndroidUtilities.dp(-80.0f), Math.min(0, (int) (motionEvent.getX() - this.f38444e3)));
            int abs = Math.abs(((int) motionEvent.getY()) - this.f38445f3);
            if (getScrollState() == 0 && boVar.f32274e9 && !boVar.f32286f9 && max <= (-AndroidUtilities.getPixelsInCM(0.4f, true)) && Math.abs(max) / 3 > abs) {
                MotionEvent obtain = MotionEvent.obtain(0L, 0L, 3, 0.0f, 0.0f, 0);
                boVar.f32262d9.onTouchEvent(obtain);
        ...
        } else if (boVar.f32262d9 != null) {
            if (motionEvent != null) {
                if (motionEvent.getPointerId(0) == this.f38446g3) {
            ...
            if (motionEvent != null && motionEvent.getAction() != 3) {
                org.telegram.ui.Cells.t1 t1Var2 = boVar.f32262d9;
                ...
                if (Math.abs(f10) >= AndroidUtilities.dp(50.0f)) {
                    ...
                    if ((skVar != null && skVar.getVisibility() == 0 && ((!boVar.I0 || !F62) && !T13.wasJustSent)) || ((chat = boVar.e) != null && ((ChatObject.isNotInChat(chat) && !boVar.F9()) || ((ChatObject.isChannel(boVar.e) && !ChatObject.canPost(boVar.e) && !boVar.e.megagroup) || !ChatObject.canSendMessages(boVar.e))))) {
                        ...
                        if (i11 != 0 && peerDialogId != boVar.a() && peerDialogId != boVar.getUserConfig().getClientUserId() && i11 > 0) {
            ...
            org.telegram.ui.Cells.t1 t1Var3 = boVar.f32262d9;
            ...
            this.f38447h3 = System.currentTimeMillis();
            this.f38448i3 = 0.0f;
            invalidate();
            boVar.f32274e9 = false;
