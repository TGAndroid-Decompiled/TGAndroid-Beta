...
public final class yk0 extends org.telegram.ui.ActionBar.n2 implements org.telegram.ui.Components.fk, NotificationCenter.NotificationCenterDelegate {
    ...
    public Ringtone P;
    public long Q;
    public final ArrayList f39896a;
    ...
    public static void W(yk0 yk0Var) {
        yk0Var.J.clear();
        vk0 vk0Var = yk0Var.f39899f;
        vk0Var.q(0, vk0Var.f38576c.f39900n);
        yk0Var.b0();
    }
    ...
    public final void Z(wk0 wk0Var) {
        int i10 = wk0Var.f39250c;
        SparseArray sparseArray = this.J;
        if (sparseArray.get(i10) != null) {
            sparseArray.remove(wk0Var.f39250c);
        } else if (wk0Var.f39248a) {
            sparseArray.put(wk0Var.f39250c, wk0Var);
        } else {
            return;
        }
        b0();
        vk0 vk0Var = this.f39899f;
        vk0Var.q(0, vk0Var.f38576c.f39900n);
    }
    ...
    public final void c0() {
        ...
        this.F = -1;
        this.f39900n = 1;
        ArrayList arrayList = this.f39896a;
        if (!arrayList.isEmpty()) {
            int i10 = this.f39900n;
            this.f39901r = i10;
            int size = arrayList.size() + i10;
            this.f39900n = size;
            this.f39902s = size;
        }
        int i11 = this.f39900n;
        this.v = i11;
        this.f39900n = i11 + 2;
        this.f39903w = i11 + 1;
        ArrayList arrayList2 = this.f39897b;
        if (!arrayList2.isEmpty()) {
            int i12 = this.f39900n;
            int i13 = i12 + 1;
            this.f39900n = i13;
            this.f39905y = i12;
            this.E = i13;
    ...
    public final View createView(Context context) {
        ...
        this.actionBar.A(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f18871f8, this.h), false);
        this.actionBar.B(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f19165v8, this.h), false);
        ...
        this.d.setTextColor(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f19217y8, this.h));
        ...
        frameLayout.setBackgroundColor(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f18778a7, this.h));
        ...
        this.f39899f = vk0Var;
        vk0Var.C(true);
        this.e.setAdapter(this.f39899f);
        ((s4.j) this.e.getItemAnimator()).f42706m = false;
        ...
        for (int i11 = 0; i11 < getMediaDataController().ringtoneDataStore.e.size(); i11++) {
            ...
            obj.f39248a = true;
            obj.d = bVar.f43688c;
            TLRPC.Document document3 = bVar.f43686a;
            String str = document3.file_name_fixed;
            obj.f39251f = str;
            obj.e = document3;
            obj.f39251f = a0(document3, str);
            obj.f39252g = bVar.f43687b;
            wk0 wk0Var = this.N;
            if (wk0Var != null && (document = wk0Var.e) != null && (document2 = bVar.f43686a) != null && document.f18115id == document2.f18115id) {
                this.N = null;
                this.H = obj;
            }
            this.f39896a.add(obj);
        }
        ...
        this.G = i13 + 1;
        obj2.f39250c = i13;
        obj2.f39251f = LocaleController.getString(R.string.NoSound);
        this.f39897b.add(obj2);
        ?? obj3 = new Object();
        int i14 = this.G;
        this.G = i14 + 1;
        obj3.f39250c = i14;
        obj3.f39251f = LocaleController.getString(R.string.DefaultRingtone);
        obj3.f39249b = true;
        this.f39897b.add(obj3);
        wk0 wk0Var2 = this.N;
        if (wk0Var2 != null && wk0Var2.e == null && wk0Var2.f39252g.equals("NoSound")) {
            this.N = null;
            this.H = obj2;
        }
        wk0 wk0Var3 = this.N;
        if (wk0Var3 != null && wk0Var3.e == null && wk0Var3.f39252g.equals("Default")) {
            this.N = null;
            this.H = obj3;
        }
        while (cursor.moveToNext()) {
            ...
            obj4.f39252g = str2;
            wk0 wk0Var4 = this.N;
            if (wk0Var4 != null && wk0Var4.e == null && wk0Var4.f39252g.equals(str2)) {
                this.N = null;
                this.H = obj4;
            }
            this.f39897b.add(obj4);
        }
        if (getMediaDataController().ringtoneDataStore.f43694f && this.H == null) {
            this.H = obj3;
            this.I = true;
        }
        c0();
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.onUserRingtonesUpdated) {
            ...
            for (int i13 = 0; i13 < getMediaDataController().ringtoneDataStore.e.size(); i13++) {
                ...
                ?? obj = new Object();
                wk0 wk0Var = (wk0) hashMap.get(Integer.valueOf(bVar.f43688c));
                if (wk0Var != null) {
                    if (wk0Var == this.H) {
                        this.H = obj;
                    }
                    obj.f39250c = wk0Var.f39250c;
                } else {
                    int i14 = this.G;
                    this.G = i14 + 1;
                    obj.f39250c = i14;
                ...
                TLRPC.Document document3 = bVar.f43686a;
                if (document3 != null) {
                    obj.f39251f = document3.file_name_fixed;
                } else {
                    obj.f39251f = new File(bVar.f43687b).getName();
                }
                TLRPC.Document document4 = bVar.f43686a;
                obj.e = document4;
                obj.f39251f = a0(document4, obj.f39251f);
                obj.f39252g = bVar.f43687b;
                wk0 wk0Var2 = this.N;
                if (wk0Var2 != null && (document = wk0Var2.e) != null && (document2 = bVar.f43686a) != null && document.f18115id == document2.f18115id) {
                    this.N = null;
                    this.H = obj;
                }
                arrayList.add(obj);
        ...
        if (i10 == 21 && intent != null && this.O != null) {
            ...
            if (intent.getData() != null) {
                ...
                if (path != null) {
                    ...
                    if (this.O.f28776p0.M(new File(path))) {
                ...
                for (int i12 = 0; i12 < clipData.getItemCount(); i12++) {
                    ...
                    if (this.O.f28776p0.M(new File(uri2))) {
    ...
    public final void onFragmentDestroy() {
        ...
        if (this.H != null && this.I) {
            ...
            wk0 wk0Var = this.H;
            if (wk0Var.f39248a && (document = wk0Var.e) != null) {
                edit.putLong(str3, document.f18115id);
                edit.putString(str, this.H.f39251f);
                edit.putString(str2, "NoSound");
            } else if (wk0Var.f39252g != null) {
                edit.putString(str, wk0Var.f39251f);
                edit.putString(str2, this.H.f39252g);
                edit.remove(str3);
            } else if (wk0Var.f39249b) {
