...
public final class cz0 implements org.telegram.ui.Components.ml0 {
    ...
    public final ProfileActivity f32816c;

    public cz0(ProfileActivity profileActivity, Context context) {
        this.f32816c = profileActivity;
    ...
    public static void a(cz0 cz0Var, Context context, int i10) {
        ...
        int i20 = 0;
        if (i10 == 0) {
            cz0Var.f32816c.getUserConfig().syncContacts = true;
            cz0Var.f32816c.getUserConfig().saveConfig(false);
            cz0Var.f32816c.getContactsController().forceImportContacts();
            return;
        }
        long j10 = 0;
        if (i10 == 1) {
            cz0Var.f32816c.getContactsController().loadContacts(false, 0L);
        } else if (i10 == 2) {
            cz0Var.f32816c.getContactsController().resetImportedContacts();
        } else if (i10 == 3) {
            cz0Var.f32816c.getMessagesController().forceResetDialogs();
        } else if (i10 == 4) {
            ...
            cz0Var.f32816c.getMessagesStorage().clearSentMedia();
            ...
            w7.x5.a();
            i15 = ((org.telegram.ui.ActionBar.m2) cz0Var.f32816c).currentAccount;
            ...
            i16 = ((org.telegram.ui.ActionBar.m2) cz0Var.f32816c).currentAccount;
            ChatThemeController.getInstance(i16).clearCache();
            cz0Var.f32816c.getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.newSuggestionsAvailable, new Object[0]);
            w31.W();
            i17 = ((org.telegram.ui.ActionBar.m2) cz0Var.f32816c).currentAccount;
            pg.u0.e(i17).a();
            SharedPreferences mainSettings = cz0Var.f32816c.getMessagesController().getMainSettings();
            ...
            edit.apply();
            i18 = ((org.telegram.ui.ActionBar.m2) cz0Var.f32816c).currentAccount;
            SharedPreferences.Editor edit2 = MessagesController.getNotificationsSettings(i18).edit();
            i19 = ((org.telegram.ui.ActionBar.m2) cz0Var.f32816c).currentAccount;
            ...
            org.telegram.ui.Components.voip.g2.i(cz0Var.f32816c.getParentActivity());
        } else if (i10 == 8) {
            SharedConfig.toggleRoundCamera16to9();
        } else if (i10 == 9) {
            ((LaunchActivity) cz0Var.f32816c.getParentActivity()).z(true);
        } else if (i10 == 10) {
            cz0Var.f32816c.getMessagesStorage().readAllDialogs(-1);
        } else if (i10 == 11) {
            ...
            Set<String> set = cz0Var.f32816c.getMessagesController().pendingSuggestions;
            ...
            try {
                if (i10 == 14) {
                    ...
                    Activity parentActivity = cz0Var.f32816c.getParentActivity();
                    ...
                    w7.y.a((LaunchActivity) cz0Var.f32816c.getParentActivity(), !SharedConfig.isFloatingDebugActive, true);
                } else if (i10 == 19) {
                    cz0Var.f32816c.getMessagesController().loadAppConfig();
                    TLRPC.TL_help_dismissSuggestion tL_help_dismissSuggestion = new TLRPC.TL_help_dismissSuggestion();
                    tL_help_dismissSuggestion.suggestion = "VALIDATE_PHONE_NUMBER";
                    tL_help_dismissSuggestion.peer = new TLRPC.TL_inputPeerEmpty();
                    cz0Var.f32816c.getConnectionsManager().sendRequest(tL_help_dismissSuggestion, new zy0(cz0Var, 0));
                } else if (i10 == 20) {
                    ...
                    ProfileActivity.S0(cz0Var.f32816c, "video/avc", sb3);
                    ProfileActivity.S0(cz0Var.f32816c, "video/hevc", sb3);
                    ProfileActivity.S0(cz0Var.f32816c, "video/x-vnd.on2.vp8", sb3);
                    ProfileActivity.S0(cz0Var.f32816c, "video/x-vnd.on2.vp9", sb3);
                    cz0Var.f32816c.showDialog(new bz0(cz0Var, cz0Var.f32816c.getParentActivity(), sb3.toString()));
                } else if (i10 == 21) {
                    AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(cz0Var.f32816c.getParentActivity(), 0, cz0Var.f32816c.f31684z0);
                    alertDialog$Builder.f18647a.R = "Force performance class";
                    ...
                    boolean q6 = ci.d1.q(cz0Var.f32816c.getParentActivity());
                    MessagesController.getGlobalMainSettings().edit().putBoolean("dual_available", !q6).apply();
                    Activity parentActivity2 = cz0Var.f32816c.getParentActivity();
                    if (!q6) {
                    ...
                    while (i20 < cz0Var.f32816c.getParentLayout().getFragmentStack().size()) {
                        ((org.telegram.ui.ActionBar.m2) cz0Var.f32816c.getParentLayout().getFragmentStack().get(i20)).clearSheets();
                        i20++;
                    }
                } else if (i10 == 25) {
                    ...
                    cz0Var.f32816c.getMediaDataController().loadAttachMenuBots(false, true);
                } else if (i10 == 28) {
                    i12 = ((org.telegram.ui.ActionBar.m2) cz0Var.f32816c).currentAccount;
                    ...
                    i11 = ((org.telegram.ui.ActionBar.m2) cz0Var.f32816c).currentAccount;
