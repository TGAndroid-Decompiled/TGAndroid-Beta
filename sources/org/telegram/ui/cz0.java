...
public final class cz0 extends q61 {
    public final g61[] a2;
    public final ProfileActivity f33452b2;
    ...
    public final boolean F(TL_stars.TL_starGiftUnique tL_starGiftUnique) {
        ...
        if (tL_starGiftUnique != null) {
            i10 = ((org.telegram.ui.ActionBar.p2) this.f33452b2).currentAccount;
    ...
    public final void p(View view, Long l10, TLRPC.Document document, TL_stars.TL_starGiftUnique tL_starGiftUnique, Integer num) {
        ...
        int i11;
        int i12;
        ProfileActivity profileActivity = this.f33452b2;
        ...
        if (tL_starGiftUnique != null) {
            ...
            if (n10 != null && MessagesController.getGlobalMainSettings().getInt("statusgiftpage", 0) < 2) {
                ...
                lh.g5 g5Var = new lh.g5(context, i11, UserConfig.getInstance(i12).getClientUserId(), profileActivity.f32181w0, null);
                g5Var.j2(n10, null);
                g5Var.m2();
                g5Var.show();
            ...
            tL_inputEmojiStatusCollectible2.collectible_id = tL_starGiftUnique.f19409id;
        ...
        if (tL_starGiftUnique != null) {
            l11 = Long.valueOf(tL_starGiftUnique.f19409id);
        } else {
            l11 = null;
        }
        ...
        if (l10 != null) {
            org.telegram.ui.Cells.o oVar = profileActivity.f32029a0;
            ?? obj = new Object();
