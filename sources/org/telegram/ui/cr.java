...
public final class cr implements ViewTreeObserver.OnPreDrawListener {
    ...
    public final boolean onPreDraw() {
        ...
        switch (i10) {
            case 0:
                vr vrVar = (vr) obj;
                vrVar.f41635c.getViewTreeObserver().removeOnPreDrawListener(this);
                int childCount = vrVar.f41635c.getChildCount();
                AnimatorSet animatorSet = new AnimatorSet();
                for (int i14 = 0; i14 < childCount; i14++) {
                    View childAt = vrVar.f41635c.getChildAt(i14);
                    if (childAt != view) {
                        vrVar.f41635c.getClass();
                        if (RecyclerView.R(childAt) >= i11) {
                            childAt.setAlpha(0.0f);
                            ObjectAnimator ofFloat = ObjectAnimator.ofFloat(childAt, View.ALPHA, 0.0f, 1.0f);
                            ofFloat.setStartDelay((int) ((Math.min(vrVar.f41635c.getMeasuredHeight(), Math.max(0, childAt.getTop())) / vrVar.f41635c.getMeasuredHeight()) * 100.0f));
                ...
                if (view != null && view.getParent() == null) {
                    vrVar.f41635c.addView(view);
                    s4.o0 layoutManager = vrVar.f41635c.getLayoutManager();
            ...
            case 1:
                ...
                int childCount2 = okVar.f29092r.getChildCount();
                AnimatorSet animatorSet2 = new AnimatorSet();
                for (int i15 = 0; i15 < childCount2; i15++) {
                    View childAt2 = okVar.f29092r.getChildAt(i15);
                    if (view != null) {
                        okVar.f29092r.getClass();
                        if (RecyclerView.R(childAt2) < i11) {
                        }
                    }
                    childAt2.setAlpha(0.0f);
                    ObjectAnimator ofFloat3 = ObjectAnimator.ofFloat(childAt2, View.ALPHA, 0.0f, 1.0f);
                    ofFloat3.setStartDelay((int) ((Math.min(okVar.f29092r.getMeasuredHeight(), Math.max(0, childAt2.getTop())) / okVar.f29092r.getMeasuredHeight()) * 100.0f));
                ...
                animatorSet2.start();
                if (view != null && view.getParent() == null) {
                    okVar.f29092r.addView(view);
                    s4.o0 layoutManager2 = okVar.f29092r.getLayoutManager();
            ...
            case 2:
                ...
                SparseArray sparseArray = qk0Var.f29754b;
                org.telegram.ui.Components.ll0 ll0Var = qk0Var.f29753a;
                ...
                qk0Var.f29758g.add(animatorSet3);
                animatorSet3.start();
