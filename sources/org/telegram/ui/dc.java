...
public final class dc implements Utilities.Callback3 {
    public final ad f33058a;
    public final int f33059b;
    public final View f33060c;
    ...
    public final void run(Object obj, Object obj2, Object obj3) {
        ...
        ad adVar = this.f33058a;
        int i10 = adVar.U;
        int i11 = this.f33059b;
        if (i11 == i10) {
            adVar.f32101n = l4.longValue();
            adVar.a1(true);
        } else if (i11 == adVar.f32090c0) {
            adVar.f32113w = l4.longValue();
            adVar.b1();
        } else if (i11 == adVar.f32094f0) {
            if (l4.longValue() == 0) {
                adVar.f32117y = null;
                ...
                adVar.f32117y = emojiStatusCollectibleFromGift;
                adVar.f32108s = -1;
                adVar.f32113w = 0L;
            } else {
                ...
                adVar.f32117y = tL_emojiStatus;
            }
            adVar.b1();
        }
        adVar.X0(true);
        nc ncVar = (nc) this.f33060c;
