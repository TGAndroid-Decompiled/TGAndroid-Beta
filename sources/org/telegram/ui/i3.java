...
public final class i3 extends s4.s0 {
    ...
    public void a(RecyclerView recyclerView, int i10) {
        ...
        switch (this.f34357a) {
            ...
            case 5:
                if (i10 == 1) {
                    AndroidUtilities.hideKeyboard(((wn) this.f34358b).X0);
                    return;
                }
                return;
            case 6:
                if (i10 == 1) {
                    AndroidUtilities.hideKeyboard(((kq) this.f34358b).getParentActivity().getCurrentFocus());
                    return;
                }
                return;
            case 7:
                if (i10 == 1) {
                    AndroidUtilities.hideKeyboard(((pr) this.f34358b).getParentActivity().getCurrentFocus());
                    return;
                }
                return;
            case 8:
                if (i10 == 1) {
                    AndroidUtilities.hideKeyboard(((wt) this.f34358b).getParentActivity().getCurrentFocus());
                    return;
                }
                return;
            case 11:
                m20 m20Var = (m20) this.f34358b;
                if (i10 == 0) {
                    kVar = ((org.telegram.ui.ActionBar.m2) m20Var).actionBar;
                    int dp = AndroidUtilities.dp(16.0f) + kVar.getBottom();
                    if (m20Var.v > 0.5f) {
                        m20Var.f35449c.v0(0, m20Var.f35452r - dp, null);
                        return;
                    }
                    ...
                    if (view != null && view.getTop() < 0) {
                        m20Var.f35449c.v0(0, view.getTop(), null);
                        return;
                    }
                    return;
                }
            ...
            case 12:
                ...
                return;
            case 13:
                z60 z60Var = (z60) this.f34358b;
                if (i10 == 1) {
                    z60Var.f40374f.f23160r.hideActionMode();
                    AndroidUtilities.hideKeyboard(z60Var.f40374f.f23160r);
                    return;
                }
                return;
            case 14:
                if (i10 == 1) {
                    AndroidUtilities.hideKeyboard(((g70) this.f34358b).f33837c);
                    return;
                }
                return;
            case 15:
                if (i10 == 1) {
                    AndroidUtilities.hideKeyboard(((o70) this.f34358b).getParentActivity().getCurrentFocus());
                    return;
                }
                return;
            case 16:
                g80 g80Var = (g80) this.f34358b;
                if (i10 == 1) {
            ...
            case 17:
                if (i10 == 1) {
                    AndroidUtilities.hideKeyboard(((LanguageSelectActivity) this.f34358b).getParentActivity().getCurrentFocus());
                    return;
                }
                return;
            case 18:
                if (i10 == 1) {
                    cd0 cd0Var = (cd0) this.f34358b;
                    if (cd0Var.f32677r0 && cd0Var.f32679s0) {
            ...
            case 21:
                if (i10 == 1) {
                    AndroidUtilities.hideKeyboard(((kj0) this.f34358b).Y.getEditText());
                    return;
                }
                return;
            case 22:
                if (i10 == 1) {
                    AndroidUtilities.hideKeyboard(((NotificationsCustomSettingsActivity) this.f34358b).getParentActivity().getCurrentFocus());
                    return;
                }
                return;
            case 23:
                return;
            case 24:
                PremiumPreviewFragment premiumPreviewFragment = (PremiumPreviewFragment) this.f34358b;
                if (i10 == 0) {
                    kVar2 = ((org.telegram.ui.ActionBar.m2) premiumPreviewFragment).actionBar;
                    int dp2 = AndroidUtilities.dp(16.0f) + kVar2.getBottom();
                    if (premiumPreviewFragment.f31450f0 > 0.5f) {
                        premiumPreviewFragment.f31441a.v0(0, premiumPreviewFragment.f31446c0 - dp2, null);
                        return;
                    }
                    if (premiumPreviewFragment.f31441a.getLayoutManager() != null) {
                        view3 = premiumPreviewFragment.f31441a.getLayoutManager().m(0);
                    } else {
                        view3 = null;
                    }
                    if (view3 != null && view3.getTop() < 0) {
                        premiumPreviewFragment.f31441a.v0(0, view3.getTop(), null);
                        return;
                    }
                    return;
                }
            ...
            case 27:
                if (i10 == 1) {
                    AndroidUtilities.hideKeyboard(((w31) this.f34358b).getParentActivity().getCurrentFocus());
                    return;
                }
                return;
            case 29:
                if (i10 == 0) {
                    ((od1) this.f34358b).f36199r0 = false;
                    return;
                }
                return;
        }
    ...
    public void b(RecyclerView recyclerView, int i10, int i11) {
        ...
        switch (i13) {
            ...
            case 1:
                q qVar = (q) obj;
                if (!qVar.I && !qVar.f36714r && qVar.d.N0() > qVar.E - 2) {
                    qVar.W();
                    return;
                }
                return;
            case 2:
                i4 i4Var3 = (i4) obj;
                if (i4Var3.f34396i0.f39123w.K1) {
                    AndroidUtilities.hideKeyboard(i4Var3.f34395h0.f39229b0);
                    return;
                }
                return;
            case 3:
            ...
            case 9:
                fv fvVar = (fv) obj;
                org.telegram.ui.Components.va vaVar = fvVar.f22959s;
                if (vaVar != null) {
                    fvVar.f22960w = !vaVar.Z();
                    vaVar.invalidate();
                    return;
                }
                return;
            case 10:
                b10 b10Var = (b10) obj;
                if (b10Var.f32273a.K1 && (v00Var = b10Var.K) != null && (e3Var = v00Var.f20328b) != null) {
                    if (e3Var.e) {
                        e3Var.k(true);
                        return;
                    } else {
            ...
            case 12:
                ...
                int measuredHeight = n60Var.f35753z0.getMeasuredHeight() - n60.g1(n60Var).getMeasuredHeight();
                float top = n60Var.f35753z0.getTop() * (-1);
                ...
                n60Var.f35753z0.f38044b.setAlpha(AndroidUtilities.lerp(1.0f, 0.0f, min));
                n60Var.f35753z0.f38046f.setAlpha(AndroidUtilities.lerp(1.0f, 0.0f, min));
                n60Var.f35753z0.f38045c.setAlpha(AndroidUtilities.lerp(0.0f, 1.0f, min2));
                if (n60Var.A0 >= 1.0f) {
                    n60Var.f35753z0.setTranslationY(top - f7);
                    return;
                } else {
                    n60Var.f35753z0.setTranslationY(0.0f);
                    return;
                }
            case 13:
                z60 z60Var = (z60) obj;
            ...
            case 20:
                ...
                if (i14 > 0 && !dj0Var.V && !dj0Var.E && !dj0Var.f33145x.isEmpty() && L02 + i14 >= h - 5 && dj0Var.f33146y) {
                    dj0Var.b0();
                    return;
                }
                return;
                ...
                if (xy0Var != null && xy0Var.f30435s) {
                    ...
                    if (delegate instanceof org.telegram.ui.Cells.d6) {
                        ...
                        if (T != null) {
                            ...
                            if (!c0Var.f43054c.H(view) || !c0Var.d.H(view)) {
                                rv0Var.Q.f();
                                return;
                            }
                            return;
            ...
            case 24:
                ...
                premiumPreviewFragment.f31447d0.invalidate();
                if (Build.VERSION.SDK_INT >= 31 && (hVar3 = premiumPreviewFragment.f31467u0) != null) {
                    hVar3.f(i10, i11);
