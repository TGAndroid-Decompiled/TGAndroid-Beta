...
public final class id1 extends tu0 {
    public final MediaController.PhotoEntry f34501a;
    public final jd1 f34502b;

    public id1(jd1 jd1Var, MediaController.PhotoEntry photoEntry) {
        this.f34502b = jd1Var;
        this.f34501a = photoEntry;
    }

    @Override
    public final void o(int i10, VideoEditedInfo videoEditedInfo, boolean z10, int i11, int i12, boolean z11) {
        vd1 vd1Var = this.f34502b.f34846a;
        MediaController.PhotoEntry photoEntry = this.f34501a;
        if (photoEntry.imagePath != null) {
            ...
            vd1Var.f38473b2 = 0;
            vd1Var.f38529x0.requestLayout();
            vd1Var.b1(false);
            vd1Var.f38527w1 = null;
            vd1Var.i1();
        }
    }
