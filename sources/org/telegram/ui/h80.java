...
public final class h80 extends org.telegram.ui.Components.kl0 {
    public final Context f34196c;
    public ArrayList d = new ArrayList();
    public ArrayList e = new ArrayList();
    public Timer f34197f;
    public boolean h;
    public final l80 f34198n;

    public h80(l80 l80Var, Context context) {
        this.f34198n = l80Var;
        this.f34196c = context;
    }
    ...
    public final void A(s4.c1 c1Var) {
        ...
        if (view instanceof org.telegram.ui.Cells.p4) {
            ((org.telegram.ui.Cells.p4) view).f20579a.getImageReceiver().cancelLoadImage();
        }
    }
    ...
    public final int h() {
        ...
        return this.f34198n.f35352w.size() + 2;
    }
    ...
    public final void l() {
        int i10;
        super.l();
        l80 l80Var = this.f34198n;
        h80 h80Var = l80Var.f35351s;
        if (h80Var != null && !l80Var.E) {
            int h = h80Var.h();
            org.telegram.ui.Components.yw0 yw0Var = l80Var.f35350r;
            if (h == 2) {
                i10 = 0;
            } else {
                i10 = 4;
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (c1Var.f42674f == 0) {
            org.telegram.ui.Cells.p4 p4Var = (org.telegram.ui.Cells.p4) c1Var.f42671a;
            boolean z10 = this.h;
            l80 l80Var = this.f34198n;
            if (z10) {
