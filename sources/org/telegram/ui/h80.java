...
public final class h80 extends org.telegram.ui.Components.kl0 {
    ...
    public Timer f34210f;
    public boolean h;
    public final l80 f34211n;
    ...
    public final void A(s4.c1 c1Var) {
        ...
        if (view instanceof org.telegram.ui.Cells.o4) {
            ((org.telegram.ui.Cells.o4) view).f20560a.getImageReceiver().cancelLoadImage();
        }
    }
    ...
    public final int h() {
        ...
        return this.f34211n.f35373w.size() + 2;
    }
    ...
    public final void l() {
        int i10;
        super.l();
        l80 l80Var = this.f34211n;
        h80 h80Var = l80Var.f35372s;
        if (h80Var != null && !l80Var.E) {
            int h = h80Var.h();
            org.telegram.ui.Components.yw0 yw0Var = l80Var.f35371r;
            if (h == 2) {
                i10 = 0;
            } else {
                i10 = 4;
            }
            yw0Var.setVisibility(i10);
        }
    }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (c1Var.f42678f == 0) {
            org.telegram.ui.Cells.o4 o4Var = (org.telegram.ui.Cells.o4) c1Var.f42675a;
            boolean z10 = this.h;
            l80 l80Var = this.f34211n;
            if (z10) {
                ...
                contact = (ContactsController.Contact) l80Var.f35373w.get(i10 - 2);
                charSequence = null;
            }
            o4Var.f20563f = contact;
