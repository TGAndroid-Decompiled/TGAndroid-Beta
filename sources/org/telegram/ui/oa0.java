...
public final class oa0 implements org.telegram.ui.Components.ae0, org.telegram.ui.ActionBar.a2 {
    public final LaunchActivity f36152a;

    public oa0(LaunchActivity launchActivity) {
        this.f36152a = launchActivity;
    }

    @Override
    public void f(org.telegram.ui.ActionBar.b2 b2Var, int i10) {
        Pattern pattern = LaunchActivity.B1;
        MessagesController.getInstance(this.f36152a.O).performLogout(2);
    }
    ...
    public void g(org.telegram.ui.Components.be0 be0Var) {
        ...
        LaunchActivity launchActivity = this.f36152a;
        ...
        launchActivity.f31088q0.getView().setVisibility(0);
        ...
        if (AndroidUtilities.isTablet()) {
            launchActivity.f31090r0.U(true, true);
            launchActivity.f31092s0.U(true, true);
            if (launchActivity.f31090r0.getView().getVisibility() == 4) {
                launchActivity.f31090r0.getView().setVisibility(0);
            }
            launchActivity.f31092s0.getView().setVisibility(0);
        }
