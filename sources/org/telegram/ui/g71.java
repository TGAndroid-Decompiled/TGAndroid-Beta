...
public abstract class g71 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public int f33710a;
    public final a61 f33711a0;
    public float f33712a1;
    public int f33713b;
    public final ci.s6 f33714b0;
    public float f33715b1;
    public int f33716c;
    public final org.telegram.ui.Components.cw[] f33717c0;
    public final org.telegram.ui.ActionBar.n2 f33718c1;
    public int d;
    public org.telegram.ui.Components.cw f33719d0;
    public final int f33720d1;
    public int e;
    public final y51 f33721e0;
    public final e61 f33722e1;
    public int f33723f;
    public final x51 f33724f0;
    public final int f33725f1;
    public final r41 f33726g0;
    public boolean f33727g1;
    public int h;
    public final d61 f33728h0;
    public boolean f33729h1;
    public final t51 f33730i0;
    public ValueAnimator f33731i1;
    public final FrameLayout f33732j0;
    public Drawable f33733j1;
    public final ci.n6 f33734k0;
    public final PorterDuffColorFilter f33735k1;
    public final org.telegram.ui.Components.w9 f33736l0;
    public float l1;
    public final View m0;
    public int f33737m1;
    public int f33738n;
    public final org.telegram.ui.Components.kn f33739n0;
    public org.telegram.ui.Components.o5 f33740n1;
    public final View f33741o0;
    public Rect f33742o1;
    public final f61 f33743p0;
    public View f33744p1;
    public final q61 f33745q0;
    public float f33746q1;
    public int f33747r;
    public final u51 f33748r0;
    public p61 f33749r1;
    public int f33750s;
    public final org.telegram.ui.Components.zk0 f33751s0;
    public Rect f33752s1;
    public final View f33753t0;
    public final OvershootInterpolator f33754t1;
    public int f33755u0;
    public ValueAnimator f33756u1;
    public int v;
    public final ArrayList f33757v0;
    public boolean f33758v1;
    public int f33759w;
    public final SparseIntArray f33760w0;
    public boolean f33761w1;
    public int f33762x;
    public final SparseIntArray f33763x0;
    public boolean f33764x1;
    public int f33765y;
    public final SparseIntArray f33766y0;
    public boolean f33767y1;
    public final SparseIntArray f33768z0;
    public String f33769z1;
    public static final List Z1 = Arrays.asList("😖", "😫", "🫠", "😨", "❓");
    public static final boolean[] f33708b2 = new boolean[4];
    public static final HashMap f33709c2 = new HashMap();
    ...
    public static void a(g71 g71Var, int i10, int i11) {
        int i12;
        org.telegram.ui.Components.zk0 zk0Var = g71Var.f33751s0;
        u51 u51Var = g71Var.f33748r0;
        ...
        ci.m1 m1Var = new ci.m1(g71Var, g71Var.f33728h0.getContext(), 4);
        m1Var.f43079a = i10;
        m1Var.f13105p = i11;
        u51Var.w0(m1Var);
    }
    ...
    public Drawable getPremiumStar() {
        if (this.f33733j1 == null) {
            int i10 = this.W;
            if (i10 != 5 && i10 != 9 && i10 != 10 && i10 != 7) {
                this.f33733j1 = ApplicationLoader.applicationContext.getResources().getDrawable(R.drawable.msg_settings_premium).mutate();
            } else {
                this.f33733j1 = ApplicationLoader.applicationContext.getResources().getDrawable(R.drawable.msg_filled_blocked).mutate();
            }
            this.f33733j1.setColorFilter(this.f33735k1);
        }
        return this.f33733j1;
    }
    ...
    public static ArrayList j(HashSet hashSet, ArrayList arrayList) {
        ...
        while (i10 < arrayList.size()) {
            ...
            if (document == null || hashSet.contains(Long.valueOf(document.f18302id))) {
    ...
    public void setBigReactionAnimatedEmoji(org.telegram.ui.Components.q5 q5Var) {
        ...
        if (this.I && (q5Var2 = this.W0) != q5Var) {
            ...
            this.W0 = q5Var;
            if (q5Var != null) {
                q5Var.setColorFilter(this.f33735k1);
                this.W0.a(this);
            }
        }
    }
    ...
    public static void t(final int i10) {
        ...
        if (!zArr[i10] && MediaDataController.getInstance(i10) != null) {
            ...
            org.telegram.ui.Components.ix0.f25064x3.fetch(i10, 1, new Utilities.Callback() {
                @Override
    ...
    public final void A(Long l4) {
        ...
        if (d61Var != null) {
            ...
            for (int i11 = 0; i11 < d61Var.getChildCount(); i11++) {
                if (d61Var.getChildAt(i11) instanceof p61) {
                    ...
                    if (z5Var != null && z5Var.getDocumentId() == l4.longValue()) {
                        ...
                        if (document != null && document.f18302id == l4.longValue()) {
                            p61Var.f();
                        }
                    }
                    z10 = true;
            ...
            if (!z10) {
                while (true) {
                    ArrayList arrayList = this.f33757v0;
    ...
    public final void C() {
        ...
        if (d61Var.getChildCount() > 0) {
            ...
            if (RecyclerView.S(childAt) == this.f33710a && "searchbox".equals(childAt.getTag())) {
                x51Var.setVisibility(0);
    ...
    public final void E(float f7) {
        ...
        View view = this.m0;
        if (view != null) {
            float interpolation = org.telegram.ui.Components.qr.f27716g.getInterpolation(w7.q.a((((f7 * 800.0f) - 0.0f) / 120.0f) / 1.0f, 0.0f, 1.0f));
        ...
        org.telegram.ui.Components.kn knVar = this.f33739n0;
        if (knVar != null) {
        ...
        this.f33714b0.setAlpha(a14);
        this.f33724f0.setAlpha(a14);
        int i12 = 0;
        for (int i13 = 0; i13 < this.f33719d0.f30846b.getChildCount(); i13++) {
            this.f33719d0.f30846b.getChildAt(i13).setAlpha(a14);
        }
        if (this.f33740n1 != null) {
            invalidate();
        }
        float f12 = 1.0f - a14;
        a61 a61Var = this.f33711a0;
        a61Var.setTranslationY(AndroidUtilities.dp(-5.0f) * f12);
        if (knVar != null) {
            knVar.setTranslationY(AndroidUtilities.dp(-5.0f) * f12);
        }
        this.f33712a1 = (interpolation2 * 0.85f) + 0.15f;
        this.f33715b1 = (interpolation3 * 0.925f) + 0.075f;
        a61Var.invalidateOutline();
        if (knVar != null) {
            knVar.setAlpha(a14);
        }
        y51 y51Var = this.f33721e0;
        y51Var.setAlpha(a14);
        y51Var.setScaleX(Math.min(this.f33712a1, 1.0f));
        ...
        for (int i14 = 0; i14 < this.f33719d0.f30846b.getChildCount(); i14++) {
            View childAt = this.f33719d0.f30846b.getChildAt(i14);
            if (f7 == 0.0f) {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        org.telegram.ui.Components.o5 o5Var = this.f33740n1;
        if (o5Var != null && (num = this.Y0) != null) {
            Rect bounds = o5Var.getBounds();
            View view = this.f33744p1;
            if (view == null) {
                scaleY = 1.0f;
            } else {
                scaleY = view.getScaleY();
            }
            int alpha = this.f33740n1.getAlpha();
            View view2 = this.f33744p1;
            if (view2 == null) {
                bounds.height();
            } else {
                view2.getHeight();
            ...
            this.f33740n1.v = (int) (Math.pow(this.f33711a0.getAlpha(), 0.25d) * alpha * this.l1);
            if (this.f33742o1 == null) {
                this.f33742o1 = new Rect();
            }
            ...
            this.f33742o1.set((int) (intValue - width), (int) (scrimDrawableTranslationY - height), (int) (intValue + width), (int) (scrimDrawableTranslationY + height));
            org.telegram.ui.Components.o5 o5Var2 = this.f33740n1;
            Rect rect = this.f33742o1;
            int i12 = rect.left;
            Rect rect2 = this.f33742o1;
            o5Var2.setBounds(i12, rect.top, (int) ((rect.width() / scaleY) + i12), (int) ((rect2.height() / scaleY) + rect2.top));
            Rect rect3 = this.f33742o1;
            canvas.scale(scaleY, scaleY, rect3.left, rect3.top);
            this.f33740n1.draw(canvas);
            org.telegram.ui.Components.o5 o5Var3 = this.f33740n1;
            o5Var3.v = alpha;
            o5Var3.setBounds(bounds);
            canvas.restore();
        }
        super.dispatchDraw(canvas);
        p61 p61Var = this.f33749r1;
        if (p61Var != null && this.f33752s1 != null && p61Var.E != null) {
            canvas.save();
            canvas.translate(0.0f, -getTranslationY());
            this.f33749r1.E.setAlpha((int) (this.f33746q1 * 255.0f));
            this.f33749r1.E.setBounds(this.f33752s1);
            this.f33749r1.E.setColorFilter(new PorterDuffColorFilter(i0.a.d(1.0f - this.l1, this.f33725f1, this.f33737m1), PorterDuff.Mode.SRC_IN));
            this.f33749r1.E.draw(canvas);
            canvas.restore();
        }
    }
    ...
    public final void h() {
        ...
        if (canScrollVertically != this.f33758v1) {
            this.f33758v1 = canScrollVertically;
            ViewPropertyAnimator animate = this.f33741o0.animate();
    ...
    public final void o(android.view.View r14, org.telegram.ui.Components.z5 r15) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.g71.o(android.view.View, org.telegram.ui.Components.z5):void");
    }
    ...
    public void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (z10 && this.W == 6) {
            this.f33748r0.y1((getMeasuredWidth() / AndroidUtilities.dp(42.0f)) * 5);
        }
    }
    ...
    public final void s(w61 w61Var) {
        Integer num = this.Y1;
        if (num != null) {
            Parcelable parcelable = (Parcelable) f33709c2.get(num);
        }
        this.T1 = w61Var;
        boolean z10 = this.Q0;
        d61 d61Var = this.f33728h0;
        ...
        if (i11 != 3 && i11 != 4 && i11 != 6) {
            ...
            zg.e0.f49273c = k51Var;
            NotificationCenter.getGlobalInstance().lambda$postNotificationNameOnUIThread$1(NotificationCenter.stopAllHeavyOperations, 512);
            this.W1.lock();
            this.U1.setDuration(800L);
            d61Var.setLayerType(2, null);
            this.f33724f0.setLayerType(2, null);
            this.f33721e0.setLayerType(2, null);
            this.f33714b0.setLayerType(2, null);
            org.telegram.ui.Components.kn knVar = this.f33739n0;
            if (knVar != null) {
    ...
    public void setDrawBackground(boolean z10) {
        this.Q0 = z10;
        this.f33711a0.setClipToOutline(z10);
        ci.s6 s6Var = this.f33714b0;
        if (!z10) {
    ...
    public void setEnterAnimationInProgress(boolean z10) {
        if (this.T != z10) {
            this.T = z10;
            if (!z10) {
                AndroidUtilities.forEachViews((RecyclerView) this.f33728h0, (e2.h) new ai.i(29));
                for (int i10 = 0; i10 < this.f33719d0.f30846b.getChildCount(); i10++) {
                    View childAt = this.f33719d0.f30846b.getChildAt(i10);
                    childAt.setScaleX(1.0f);
                    childAt.setScaleY(1.0f);
                }
                this.f33719d0.f30846b.invalidate();
            }
        }
    }
    ...
    public void setSelectedReactions(HashSet<zg.o0> hashSet) {
        ...
        for (int i10 = 0; i10 < arrayList.size(); i10++) {
            if (arrayList.get(i10) != null && ((zg.o0) arrayList.get(i10)).f49378g != 0) {
                hashSet2.add(Long.valueOf(((zg.o0) arrayList.get(i10)).f49378g));
            }
        }
    }
    ...
    public final void v(String str, boolean z10, boolean z11) {
        ...
        if (isEmpty) {
            ...
            if (!z12) {
                ...
                q61Var.E(false);
            } else if (!str.equals(this.f33769z1)) {
    ...
    public final void w(float f7) {
        ValueAnimator valueAnimator = this.f33731i1;
        if (valueAnimator != null) {
            valueAnimator.cancel();
            this.f33731i1 = null;
        }
        ValueAnimator ofFloat = ValueAnimator.ofFloat(this.f33753t0.getAlpha(), f7 * 0.25f);
        this.f33731i1 = ofFloat;
        ofFloat.addUpdateListener(new j51(this, 2));
        this.f33731i1.setDuration(200L);
        this.f33731i1.setInterpolator(org.telegram.ui.Components.qr.f27715f);
        this.f33731i1.start();
    }
    ...
    public final void z(boolean z10, boolean z11) {
        ...
        org.telegram.messenger.wh.r(animate.translationY(f7).setUpdateListener(new j51(this, 1)), org.telegram.ui.Components.qr.f27715f, 160L);
        if (this.F1 && z11) {
    ...
    public g71(org.telegram.ui.ActionBar.n2 n2Var, Context context, boolean z10, Integer num, int i10, boolean z11, org.telegram.ui.ActionBar.e6 e6Var, int i11) {
        this(n2Var, context, z10, num, i10, z11, e6Var, i11, org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19393v6, e6Var));
    }
