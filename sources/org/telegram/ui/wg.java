...
public final class wg implements Runnable {
    ...
    public final bo f39190b;
    public final org.telegram.ui.ActionBar.b2[] f39191c;
    public final int d;

    public wg(bo boVar, org.telegram.ui.ActionBar.b2[] b2VarArr, int i10, int i11) {
        this.f39189a = i11;
        this.f39190b = boVar;
        this.f39191c = b2VarArr;
        this.d = i10;
    }
    ...
    public final void run() {
        switch (this.f39189a) {
            case 0:
                org.telegram.ui.ActionBar.b2[] b2VarArr = this.f39191c;
                org.telegram.ui.ActionBar.b2 b2Var = b2VarArr[0];
                if (b2Var != null) {
                    final bo boVar = this.f39190b;
                ...
                return;
            case 1:
                org.telegram.ui.ActionBar.b2[] b2VarArr2 = this.f39191c;
                org.telegram.ui.ActionBar.b2 b2Var2 = b2VarArr2[0];
                if (b2Var2 != null) {
                    final bo boVar2 = this.f39190b;
                ...
                return;
            default:
                org.telegram.ui.ActionBar.b2[] b2VarArr3 = this.f39191c;
                org.telegram.ui.ActionBar.b2 b2Var3 = b2VarArr3[0];
                if (b2Var3 != null) {
                    final bo boVar3 = this.f39190b;
