    ...
    public final void run() {
        ...
        switch (i10) {
            ...
            case 1:
                ...
                if (boVar.f32506x0 != null && boVar.A0 != null) {
                    int i11 = Integer.MAX_VALUE;
                    int i12 = Integer.MIN_VALUE;
                    for (int i13 = 0; i13 < boVar.f32506x0.getChildCount(); i13++) {
                    ...
                    if (i11 <= i12) {
                        ...
                        for (int i15 = 0; i15 < arrayList.size(); i15++) {
                            ...
                            MessageObject.GroupedMessages groupedMessages = (MessageObject.GroupedMessages) boVar.f32512x6.f(messageObject.getGroupId());
            ...
            case 2:
                ...
                if (nkVar != null && boVar.Bc != null) {
                    if (nkVar.u0()) {
                        boVar.Y.n0(false);
                        AndroidUtilities.showKeyboard(boVar.Bc.f41779a);
                        boVar.Bc.f41780b.f41776a.a(false, true);
                        return;
                    }
                    boVar.Y.V0(false, false, false);
                    boVar.Y.s1();
                    boVar.Bc.f41780b.f41776a.a(true, true);
                    return;
                }
                return;
            case 3:
            ...
            case 12:
                ...
                return;
            case 13:
                org.telegram.ui.ActionBar.c2 c2Var = new org.telegram.ui.ActionBar.c2(boVar.getParentActivity(), 3, boVar.f32279ea);
                boVar.f32401ob = c2Var;
                c2Var.setOnShowListener(new qf(boVar, 1));
                boVar.f32401ob.setOnCancelListener(boVar.f32376ma);
                boVar.f32401ob.q(500L);
                return;
            case 14:
                boVar.N6();
                return;
            case 15:
                boVar.f32217a = (boVar.f32217a + 1) % 3;
                return;
            case 16:
                boVar.f32230b = !boVar.f32230b;
                return;
            case 17:
                boVar.A7(true);
            ...
            case 23:
                rk rkVar = boVar.R2;
                if ((rkVar == null || rkVar.getVisibility() != 0) && (f4Var = boVar.f32494w1) != null) {
                    f4Var.u();
                    return;
                }
                return;
            ...
            case 27:
                ...
                boVar.X0.addView(boVar.f32520y1, e);
                boVar.f32520y1.setTranslationY(-AndroidUtilities.navigationBarHeight);
                boVar.f32520y1.m(0.0f, boVar.Y.getEmojiButton().getX() + AndroidUtilities.dp(22.0f));
                boVar.f32520y1.u();
                return;
            case 28:
                int i17 = bo.Gc;
