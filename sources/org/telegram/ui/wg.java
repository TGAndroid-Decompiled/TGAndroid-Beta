...
public final class wg implements sv0, ly {
    public final boolean f38983a;
    public final int f38984b;
    public final Object f38985c;
    public final Object d;

    public wg(xn xnVar, boolean z10, MessageObject messageObject, int i10) {
        this.f38985c = xnVar;
        this.f38983a = z10;
    ...
    public boolean u(ry ryVar, ArrayList arrayList, CharSequence charSequence, boolean z10, boolean z11, int i10, int i11, wf1 wf1Var) {
        LaunchActivity launchActivity = (LaunchActivity) this.f38985c;
        String str = (String) this.d;
        Pattern pattern = LaunchActivity.B1;
        long j3 = ((MessagesStorage.TopicKey) arrayList.get(0)).dialogId;
        Bundle bundle = new Bundle();
        bundle.putBoolean("scrollToTopOnResume", true);
        bundle.putBoolean("hasUrl", this.f38983a);
    ...
    public wg(LaunchActivity launchActivity, boolean z10, int i10, String str) {
        this.f38985c = launchActivity;
        this.f38983a = z10;
        this.f38984b = i10;
        this.d = str;
    }
