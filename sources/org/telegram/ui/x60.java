...
public final class x60 extends org.telegram.ui.Components.el0 {
    ...
    public final gg.c2 f39826f;
    public Runnable h;
    public boolean f39827n;
    public int f39829s;
    public int v;
    public int f39830w;
    public int f39831x;
    ...
    public final ArrayList f39828r = new ArrayList();
        ...
        if (z60Var.P || z60Var.O || z10) {
            ...
            if (z10) {
                ...
                for (int i11 = 0; i11 < size; i11++) {
                    ...
                    if (DialogObject.isUserDialog(dialog.f18325id) && !hashSet.contains(Long.valueOf(dialog.f18325id)) && (user = z60Var.getMessagesController().getUser(Long.valueOf(dialog.f18325id))) != null && !UserObject.isDeleted(user) && !UserObject.isUserSelf(user) && !UserObject.isBot(user) && !UserObject.isService(dialog.f18325id) && !MessagesController.isSupportUser(user)) {
                        this.f39828r.add(user);
                        hashSet.add(Long.valueOf(user.f18468id));
                    }
                }
            } else {
                ...
                for (int i12 = 0; i12 < size2; i12++) {
                    ...
                    if (DialogObject.isChatDialog(dialog2.f18325id) && (chat = z60Var.getMessagesController().getChat(Long.valueOf(-dialog2.f18325id))) != null && chat.migrated_to == null && (!ChatObject.isChannel(chat) || chat.megagroup)) {
                        this.f39828r.add(chat);
                    }
                }
            }
            Collections.sort(this.f39828r, new Object());
            TLObject tLObject = null;
            int i13 = 0;
            while (i13 < this.f39828r.size()) {
                TLObject tLObject2 = (TLObject) this.f39828r.get(i13);
                if (tLObject != null) {
                ...
                ArrayList arrayList2 = this.f39828r;
        ...
        if (c1Var.f42949f != 0) {
            ...
            if (z60Var.J != null) {
                ...
                if (view instanceof org.telegram.ui.Cells.g4) {
                    ...
                    if ((object instanceof TLRPC.User) && z60Var.J.h(((TLRPC.User) object).f18468id) >= 0) {
                        return false;
                    }
                    return true;
                }
    ...
    public final String F(int i10) {
        String str;
        String str2;
        if (!this.f39827n && i10 >= this.E) {
            ArrayList arrayList = this.f39828r;
            int size = arrayList.size();
            int i11 = this.E;
            if (i10 < size + i11) {
                TLObject tLObject = (TLObject) arrayList.get(i10 - i11);
                if (tLObject instanceof y60) {
                    return ((y60) tLObject).f40050a;
                }
    ...
    public final void L(String str) {
        ...
        this.d.clear();
        this.e.clear();
        this.f39826f.f(null, null);
        gg.c2 c2Var = this.f39826f;
        z60 z60Var = this.I;
    ...
    public final int h() {
        ...
        this.E = i10;
        int size4 = this.f39828r.size() + i10;
        if (z60Var.R) {
            if (j10 != 0) {
    ...
    public final int j(int i10) {
        if (this.f39827n) {
            if (i10 == this.f39826f.d.size() + this.d.size()) {
                return 0;
            }
            return 1;
        } else if (i10 != this.f39830w) {
            if (i10 != this.f39829s) {
                if (i10 != this.f39831x && i10 != this.f39832y) {
                    if (this.F != 0 && i10 == 0) {
                        return 2;
                    }
                    if (this.G == i10) {
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i11 != 0) {
            ...
            if (i11 != 1) {
                if (i11 == 2) {
                    ...
                    if (i10 == this.f39830w) {
                        ...
                        r8Var.e(org.telegram.ui.ActionBar.h6.f19209m6, org.telegram.ui.ActionBar.h6.G6);
                        return;
                    } else {
            ...
            if (this.f39827n) {
            ...
            } else if (i10 == this.f39831x) {
                g4Var.f20326r = true;
                g4Var.f20324f = "premium";
                g4Var.f20321a.setImageDrawable(org.telegram.ui.Cells.g4.b(g4Var.getContext(), false));
                g4Var.f20322b.l(LocaleController.getString(R.string.PrivacyPremium), false);
                org.telegram.ui.ActionBar.h5 h5Var = g4Var.f20323c;
                int i12 = org.telegram.ui.ActionBar.h6.f19428y6;
                h5Var.setTag(Integer.valueOf(i12));
                if (g4Var.K) {
                    i12 = org.telegram.ui.ActionBar.h6.f19255og;
                }
                ...
                g4Var.c(z11, false);
                return;
            } else if (i10 == this.f39832y) {
                g4Var.f20327s = true;
                g4Var.f20324f = "miniapps";
                org.telegram.ui.Components.w9 w9Var = g4Var.f20321a;
                g4Var.getContext();
                w9Var.setImageDrawable(org.telegram.ui.Cells.g4.a(false));
                g4Var.f20322b.l(LocaleController.getString(R.string.PrivacyMiniapps), false);
                org.telegram.ui.ActionBar.h5 h5Var2 = g4Var.f20323c;
                int i13 = org.telegram.ui.ActionBar.h6.f19428y6;
                h5Var2.setTag(Integer.valueOf(i13));
                if (g4Var.K) {
                    i13 = org.telegram.ui.ActionBar.h6.f19255og;
                }
        ...
        if (this.f39827n) {
            ...
            if (i14 >= 0 && i14 < arrayList.size()) {
                ...
                if (tLObject2 instanceof y60) {
                    v3Var.setText(((y60) tLObject2).f40050a.toUpperCase());
                }
            }
        }
        if (i10 == this.v) {
