...
public final class vy extends org.telegram.ui.Components.rl0 {
        ...
        if (i11 != 0) {
            if (i11 != 1) {
                if (i11 == 3) {
                    ...
                    Long l10 = (Long) yyVar.f43732e.get(i10 - yyVar.f43734n);
                    long longValue = l10.longValue();
                    if (DialogObject.isUserDialog(longValue)) {
                        TLRPC.User user = yyVar.getMessagesController().getUser(l10);
                        if (i10 == yyVar.f43735r - 1) {
                            z4 = false;
                        }
        ...
        if (i10 != 0) {
            if (i10 != 1) {
                if (i10 != 2) {
                    ...
                    imageView.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.k6.w0(null, org.telegram.ui.ActionBar.k6.f21628b9, false), PorterDuff.Mode.MULTIPLY));
                    xyVar = g4Var;
                } else {
                    yy yyVar = this.d;
                    xy xyVar2 = new xy(yyVar, context);
                    yyVar.f43733f = xyVar2;
                    xyVar = xyVar2;
                }
            } else {
    ...
    public final void y(f2.m1 m1Var) {
        ...
        m1Var.f5875a.setBackgroundColor(org.telegram.ui.ActionBar.k6.w0(null, org.telegram.ui.ActionBar.k6.f21661d6, false));
    }
}
