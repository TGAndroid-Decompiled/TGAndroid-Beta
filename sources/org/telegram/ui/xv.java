...
public final class xv implements org.telegram.ui.Components.lq0, org.telegram.ui.Components.al0, org.telegram.ui.Components.bl0, o10, org.telegram.ui.ActionBar.a2, r0.n, org.telegram.ui.Components.nk0 {
    ...
    public r0.l1 T0(View view, r0.l1 l1Var) {
        ...
        uy uyVar = this.f42932b;
        uyVar.v.i(l1Var);
        i0.c defaultWindowInsets = AndroidUtilities.getDefaultWindowInsets(l1Var, false);
        uyVar.f41297f4 = defaultWindowInsets.f11452b;
        uyVar.f41302g4 = defaultWindowInsets.d;
        int i10 = l1Var.f44740a.f(8).d;
        if (uyVar.f41307h4 != i10) {
            uyVar.f41307h4 = i10;
            uyVar.fragmentView.requestLayout();
        }
        uyVar.F0.setPadding(0, uyVar.f41297f4, 0, 0);
        uyVar.X4();
        for (UndoView undoView : uyVar.f41389y0) {
            if (undoView != null) {
                int i11 = uyVar.f41302g4 + uyVar.f41312i4;
    ...
    public void i(boolean z10, ArrayList arrayList, ArrayList arrayList2, boolean z11) {
        this.f42932b.W4(z10, arrayList, arrayList2, z11, true);
    }
