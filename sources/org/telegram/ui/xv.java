        ...
        switch (this.f39715a) {
            case 0:
                ...
                if (wyVar.a4() && (arrayList = wyVar.D2) != null && !arrayList.isEmpty() && wyVar.getParentActivity() != null) {
                    ...
                    PhotoViewer.t1().f31051p7 = true;
                    PhotoViewer.t1().f31059q7 = charSequence;
            ...
            case 5:
                ...
                return;
            case 6:
                this.f39716b.b4(true);
                return;
            case 7:
                this.f39716b.finishPreviewFragment();
                return;
            case 8:
                wy wyVar7 = this.f39716b;
                wyVar7.f39320z0.setIsEditing(false);
                wyVar7.I4(false);
                return;
            case 9:
                wy wyVar8 = this.f39716b;
                wyVar8.getClass();
                wyVar8.showDialog(new rg.x0((org.telegram.ui.ActionBar.o2) wyVar8, 2, true));
                return;
            case 10:
                wy wyVar9 = this.f39716b;
                wyVar9.getContactsController().loadGlobalPrivacySetting();
                wyVar9.K4();
                return;
            case 11:
                this.f39716b.p4(view);
                return;
            case 12:
                wy.t0(this.f39716b);
                return;
            ...
            case 14:
                ...
                return;
            case 15:
                wy wyVar10 = this.f39716b;
                wyVar10.showDialog(org.telegram.ui.Components.c5.m(wyVar10.getParentActivity(), LocaleController.getString(R.string.EditProfileBirthdayTitle), LocaleController.getString(R.string.EditProfileBirthdayButton), null, new aw(wyVar10, 1), new rv(wyVar10, 17), false, false, wyVar10.getResourceProvider()).f18470a);
                return;
            case 16:
                wy.C0(this.f39716b);
                return;
            ...
            case 18:
                ...
                premiumPreviewFragment.f31181j0 = true;
                wy wyVar11 = this.f39716b;
