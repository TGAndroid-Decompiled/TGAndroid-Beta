...
public abstract class oa extends FrameLayout {
    ...
    public final org.telegram.ui.ActionBar.f6 f36243b;
    public final org.telegram.ui.ActionBar.j5 f36244c;
    public final ImageView d;
    public final org.telegram.ui.Components.tp e;
    public final org.telegram.ui.Components.o6 f36245f;
    public final Drawable[] h;
    public float f36246n;
    public boolean f36247r;
    public ValueAnimator f36248s;
    public TLRPC.TL_username v;
    public boolean f36249w;
    public long f36250x;
    public final org.telegram.ui.Components.d6 f36251y;

    public oa(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context);
        this.f36242a = false;
        this.f36251y = new org.telegram.ui.Components.d6(this, 300L, org.telegram.ui.Components.qr.f27653f);
        this.I = new org.telegram.ui.Components.d6(this, 400L, org.telegram.ui.Components.qr.h);
        this.f36243b = f6Var;
        setBackgroundColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19109d6, f6Var));
        ...
        this.d = imageView;
        org.telegram.ui.Components.tp tpVar = new org.telegram.ui.Components.tp(AndroidUtilities.dp(7.0f), AndroidUtilities.dp(1.35f), org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19294n6, f6Var));
        this.e = tpVar;
        ...
        o6Var.b(0.4f, 120L, org.telegram.ui.Components.qr.f27654g);
    ...
    public final void a(TLRPC.TL_username tL_username, boolean z10, boolean z11, long j3) {
        ...
        boolean z14 = this.f36242a;
        org.telegram.ui.Components.o6 o6Var = this.f36245f;
        if (z14) {
            if (this.H) {
        ...
        if (z11) {
            ...
            this.F.setInterpolator(org.telegram.ui.Components.qr.f27654g);
            this.F.start();
            return;
        }
        if (z13) {
        ...
        org.telegram.ui.ActionBar.f6 f6Var = this.f36243b;
        int d = i0.a.d(this.E, org.telegram.ui.ActionBar.j6.v0(i12, f6Var), org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19294n6, f6Var));
        this.e.b(d);
    ...
    public final void b(String str) {
        ...
        org.telegram.ui.ActionBar.j5 j5Var = this.f36244c;
        if (isEmpty) {
            ...
            spannableString.setSpan(new ForegroundColorSpan(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.H6, this.f36243b)), 0, spannableString.length(), 33);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float d10 = this.f36251y.d(f12, false);
        if (d10 > f11) {
            int alpha = org.telegram.ui.ActionBar.j6.f19231k0.getAlpha();
            org.telegram.ui.ActionBar.j6.f19231k0.setAlpha((int) (alpha * d10));
            canvas.drawRect(AndroidUtilities.dp(70.0f), getHeight() - 1, getWidth(), getHeight(), org.telegram.ui.ActionBar.j6.f19231k0);
    ...
    public void setLoading(boolean z10) {
        ...
        if (this.f36247r != z10) {
            this.f36247r = z10;
            ValueAnimator valueAnimator = this.f36248s;
            if (valueAnimator != null) {
                valueAnimator.cancel();
            }
            this.d.setVisibility(0);
            float f10 = this.f36246n;
            if (z10) {
                f7 = 1.0f;
            } else {
                f7 = 0.0f;
            ...
            ValueAnimator ofFloat = ValueAnimator.ofFloat(f10, f7);
            this.f36248s = ofFloat;
            ofFloat.addUpdateListener(new na(this, 0));
            this.f36248s.addListener(new ai.n(26, this, z10));
            this.f36248s.setInterpolator(org.telegram.ui.Components.qr.f27654g);
            this.f36248s.setDuration(200L);
            this.f36248s.start();
        }
    }
}
