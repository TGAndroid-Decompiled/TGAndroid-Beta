...
public final class gv extends LinearLayout {
    public final ec1 f36791a;
    public s4.c0 f36792b;
    public final org.telegram.ui.Components.jp f36793c;
    public final org.telegram.ui.Components.xi0 d;
    public final org.telegram.ui.Cells.r8 f36794e;
    public final org.telegram.ui.Cells.r8 f36795f;
    public ValueAnimator h;
    public int f36796n;
    public int f36797r;
    public final int f36798s;
    public int v;
    ...
    public gv(int i10, Context context, org.telegram.ui.ActionBar.n2 n2Var) {
        ...
        if (i10 == 0) {
            ...
            this.f36794e = r8Var;
            r8Var.setBackground(org.telegram.ui.ActionBar.j6.f0(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20753i6, false), 2, -1));
            r8Var.f22688w = 21;
        ...
        if (!MediaDataController.getInstance(n2Var.getCurrentAccount()).defaultEmojiThemes.isEmpty()) {
            ...
            if (i10 == 0) {
                ...
                if (string != null && org.telegram.ui.ActionBar.j6.N0(string) != null) {
                    if (i12 == -1) {
                        i12 = org.telegram.ui.ActionBar.j6.N0(string).f20550f0;
                    }
                } else {
                ...
                if (string2 != null && org.telegram.ui.ActionBar.j6.N0(string2) != null) {
                    if (i14 == -1) {
                        i14 = org.telegram.ui.ActionBar.j6.N0(str).f20550f0;
                    }
                } else {
                ...
                c4Var.f20316a = org.telegram.ui.ActionBar.j6.N0(str);
                c4Var.f20319e = i13;
                d4Var.f20365f.add(c4Var);
                d4Var.f20365f.add(null);
                org.telegram.ui.ActionBar.c4 c4Var2 = new org.telegram.ui.ActionBar.c4();
                c4Var2.f20316a = org.telegram.ui.ActionBar.j6.N0(str2);
                c4Var2.f20319e = i14;
                ...
                kpVar.f27884c = org.telegram.ui.ActionBar.j6.f1() ? 0 : 2;
                arrayList.add(kpVar);
            }
            jpVar.d = arrayList;
            jpVar.l();
        ...
        d();
        a();
        int i15 = this.f36797r;
        if (i15 >= 0 && (c0Var = this.f36792b) != null) {
            c0Var.h1(i15, AndroidUtilities.dp(16.0f));
        }
    }

    public final void a() {
        int i10 = this.f36798s;
        if (i10 == 0 || i10 == -1) {
            ...
            org.telegram.ui.Cells.r8 r8Var = this.f36794e;
            if (r8Var != null) {
                org.telegram.ui.ActionBar.j6.B1(r8Var.getBackground(), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20753i6, false), true);
                r8Var.e(-1, org.telegram.ui.ActionBar.j6.q6);
            }
            org.telegram.ui.Cells.r8 r8Var2 = this.f36795f;
            if (r8Var2 != null) {
                r8Var2.setBackground(org.telegram.ui.ActionBar.j6.g0(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20663d6, false), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20753i6, false)));
    ...
    public final void b() {
        ...
        org.telegram.ui.Components.jp jpVar = this.f36793c;
        if (jpVar.d != null) {
            for (int i14 = 0; i14 < jpVar.d.size(); i14++) {
                ((org.telegram.ui.Components.kp) jpVar.d.get(i14)).f27884c = this.v;
            }
    ...
    public final void c() {
        ...
        Boolean bool = this.f36799w;
        if (bool != null && bool.booleanValue() == z10) {
            return;
        }
        ec1 ec1Var = this.f36791a;
        int i11 = this.f36798s;
        if (i11 != 0 && i11 != -1) {
            if (z10) {
                i10 = 3;
            } else {
    ...
    public final void d() {
        ...
        while (true) {
            ...
            org.telegram.ui.ActionBar.d4 d4Var = ((org.telegram.ui.Components.kp) jpVar.d.get(i10)).f27882a;
            TLRPC.TL_theme tL_theme = ((org.telegram.ui.ActionBar.c4) d4Var.f20365f.get(this.v)).f20317b;
            org.telegram.ui.ActionBar.i6 j3 = ((org.telegram.ui.Components.kp) jpVar.d.get(i10)).f27882a.j(this.v);
            if (tL_theme != null) {
                org.telegram.ui.ActionBar.d4 d4Var2 = ((org.telegram.ui.Components.kp) jpVar.d.get(i10)).f27882a;
                if (org.telegram.ui.ActionBar.j6.I.f20540a.equals(org.telegram.ui.ActionBar.j6.q0(tL_theme.settings.get(((org.telegram.ui.ActionBar.c4) d4Var2.f20365f.get(this.v)).d)))) {
                    LongSparseArray longSparseArray = org.telegram.ui.ActionBar.j6.I.f20545c0;
                    if (longSparseArray == null) {
                        this.f36797r = i10;
                        break;
                    }
                    org.telegram.ui.ActionBar.h6 h6Var = (org.telegram.ui.ActionBar.h6) longSparseArray.get(tL_theme.f20006id);
                    if (h6Var != null && h6Var.f20490a == org.telegram.ui.ActionBar.j6.I.Y) {
                        this.f36797r = i10;
                        break;
                    }
                } else {
                ...
                if (j3 != null) {
                    if (org.telegram.ui.ActionBar.j6.I.f20540a.equals(j3.m())) {
                        org.telegram.ui.ActionBar.d4 d4Var3 = ((org.telegram.ui.Components.kp) jpVar.d.get(i10)).f27882a;
                        if (((org.telegram.ui.ActionBar.c4) d4Var3.f20365f.get(this.v)).f20319e == org.telegram.ui.ActionBar.j6.I.Y) {
                            this.f36797r = i10;
                            break;
                        }
                    } else {
        ...
        if (this.f36797r == -1 && this.f36798s != 3) {
            this.f36797r = jpVar.d.size() - 1;
        }
