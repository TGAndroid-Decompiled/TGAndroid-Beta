...
public final class g4 extends AnimatorListenerAdapter {
    ...
    public final ArticleViewer$WindowView f33839b;

    public g4(ArticleViewer$WindowView articleViewer$WindowView, boolean z10) {
        this.f33839b = articleViewer$WindowView;
        this.f33838a = z10;
    }

    @Override
    public final void onAnimationEnd(Animator animator) {
        ArticleViewer$WindowView articleViewer$WindowView = this.f33839b;
        h4 h4Var = articleViewer$WindowView.H;
        boolean z10 = articleViewer$WindowView.e;
        boolean z11 = this.f33838a;
        if (z10) {
            Object obj = null;
