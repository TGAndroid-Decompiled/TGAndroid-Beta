...
public final class g4 extends org.telegram.ui.Components.kl0 {
    ...
    public int J;
    public final i4 L;
    public final Context f36577c;
    public final ArrayList d = new ArrayList();
    public final ArrayList f36578e = new ArrayList();
    public final ArrayList f36579f = new ArrayList();
    public final HashMap h = new HashMap();
    public final HashMap f36580n = new HashMap();
    public final HashMap f36581r = new HashMap();
    public final HashMap f36582s = new HashMap();
    public final ArrayList v = new ArrayList();
    public final HashMap f36583w = new HashMap();
    public final ArrayList f36584x = new ArrayList();
    public final HashMap f36585y = new HashMap();
    ...
    public final void E(TL_iv.PageBlock pageBlock, g4 g4Var) {
        ...
        ArrayList arrayList = this.f36579f;
        if (z10) {
    ...
    public final void G(Object obj, TL_iv.PageBlock pageBlock) {
        if (!(obj instanceof TL_iv.textEmpty)) {
            HashMap hashMap = this.f36583w;
            if (hashMap.containsKey(obj)) {
                return;
            }
            hashMap.put(obj, pageBlock);
            this.f36584x.add(obj);
        }
    }
    ...
    public final void K(TL_iv.PageBlock pageBlock) {
        if (pageBlock instanceof TL_iv.pageBlockEmbedPost) {
            ...
            if (pageBlock instanceof TL_iv.pageBlockSlideshow) {
                ...
                TL_iv.RichText richText2 = y3Var.f43001e;
                if (richText2 != null) {
                    L(null, richText2);
                    G(y3Var.f43001e, y3Var);
                    return;
                }
                ...
                TL_iv.RichText richText3 = a4Var.f34356e;
                if (richText3 != null) {
                    L(null, richText3);
                    G(a4Var.f34356e, a4Var);
                    return;
                }
    ...
    public final void M() {
        ...
        arrayList.clear();
        ArrayList arrayList2 = this.f36578e;
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i11 >= 0) {
            ...
            if (i11 < arrayList.size()) {
                H(c1Var.f45771f, c1Var, (TL_iv.PageBlock) arrayList.get(i11), i11, arrayList.size(), false);
            }
        }
    }
    ...
    public final void y(s4.c1 c1Var) {
        ...
        i4 i4Var = p3Var.f39424e;
        TextView textView = p3Var.f39421a;
        TextView textView2 = p3Var.f39422b;
        if (i10 == 0) {
            p3Var.f39423c = false;
