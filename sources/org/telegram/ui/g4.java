...
public final class g4 extends org.telegram.ui.Components.vl0 {
    ...
    public int J;
    public final i4 L;
    public final Context f33796c;
    public final ArrayList d = new ArrayList();
    public final ArrayList e = new ArrayList();
    public final ArrayList f33797f = new ArrayList();
    public final HashMap h = new HashMap();
    public final HashMap f33798n = new HashMap();
    public final HashMap f33799r = new HashMap();
    public final HashMap f33800s = new HashMap();
    public final ArrayList v = new ArrayList();
    public final HashMap f33801w = new HashMap();
    public final ArrayList f33802x = new ArrayList();
    public final HashMap f33803y = new HashMap();
    ...
    public final void E(TL_iv.PageBlock pageBlock, g4 g4Var) {
        ...
        ArrayList arrayList = this.f33797f;
        if (z10) {
    ...
    public final void G(Object obj, TL_iv.PageBlock pageBlock) {
        if (!(obj instanceof TL_iv.textEmpty)) {
            HashMap hashMap = this.f33801w;
            if (hashMap.containsKey(obj)) {
                return;
            }
            hashMap.put(obj, pageBlock);
            this.f33802x.add(obj);
        }
    }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i11 >= 0) {
            ...
            if (i11 < arrayList.size()) {
                H(c1Var.f42949f, c1Var, (TL_iv.PageBlock) arrayList.get(i11), i11, arrayList.size(), false);
            }
        }
    }
    ...
    public final void y(s4.c1 c1Var) {
        ...
        i4 i4Var = p3Var.e;
        TextView textView = p3Var.f36379a;
        TextView textView2 = p3Var.f36380b;
        if (i10 == 0) {
            p3Var.f36381c = false;
