...
public final class g4 extends org.telegram.ui.Components.vl0 {
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i11 >= 0) {
            ...
            if (i11 < arrayList.size()) {
                H(c1Var.f42964f, c1Var, (TL_iv.PageBlock) arrayList.get(i11), i11, arrayList.size(), false);
            }
        }
    }
    ...
    public final void y(s4.c1 c1Var) {
        ...
        i4 i4Var = p3Var.e;
        TextView textView = p3Var.f36390a;
        TextView textView2 = p3Var.f36391b;
        if (i10 == 0) {
            p3Var.f36392c = false;
