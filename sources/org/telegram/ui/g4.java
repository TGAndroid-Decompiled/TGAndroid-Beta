...
public final class g4 extends AnimatorListenerAdapter {
    ...
    public final ArticleViewer$WindowView f33795b;

    public g4(ArticleViewer$WindowView articleViewer$WindowView, boolean z10) {
        this.f33795b = articleViewer$WindowView;
        this.f33794a = z10;
    }

    @Override
    public final void onAnimationEnd(Animator animator) {
        ArticleViewer$WindowView articleViewer$WindowView = this.f33795b;
