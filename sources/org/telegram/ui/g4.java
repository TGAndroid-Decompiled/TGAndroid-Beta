...
public final class g4 extends org.telegram.ui.Components.wl0 {
    ...
    public int J;
    public final i4 L;
    public final Context f33810c;
    public final ArrayList d = new ArrayList();
    public final ArrayList e = new ArrayList();
    public final ArrayList f33811f = new ArrayList();
    public final HashMap h = new HashMap();
    public final HashMap f33812n = new HashMap();
    public final HashMap f33813r = new HashMap();
    public final HashMap f33814s = new HashMap();
    public final ArrayList v = new ArrayList();
    public final HashMap f33815w = new HashMap();
    public final ArrayList f33816x = new ArrayList();
    public final HashMap f33817y = new HashMap();
    ...
    public final void E(TL_iv.PageBlock pageBlock, g4 g4Var) {
        ...
        ArrayList arrayList = this.f33811f;
        if (z10) {
    ...
    public final void G(Object obj, TL_iv.PageBlock pageBlock) {
        if (!(obj instanceof TL_iv.textEmpty)) {
            HashMap hashMap = this.f33815w;
            if (hashMap.containsKey(obj)) {
                return;
            }
            hashMap.put(obj, pageBlock);
            this.f33816x.add(obj);
        }
    }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i11 >= 0) {
            ...
            if (i11 < arrayList.size()) {
                H(c1Var.f42962f, c1Var, (TL_iv.PageBlock) arrayList.get(i11), i11, arrayList.size(), false);
            }
        }
    }
    ...
    public final void y(s4.c1 c1Var) {
        ...
        i4 i4Var = p3Var.e;
        TextView textView = p3Var.f36388a;
        TextView textView2 = p3Var.f36389b;
        if (i10 == 0) {
            p3Var.f36390c = false;
