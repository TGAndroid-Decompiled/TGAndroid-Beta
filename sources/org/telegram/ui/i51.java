...
public final class i51 extends Dialog {
    ...
    public float f34314a0;
    public final j0 f34315b;
    public boolean f34316b0;
    public final ci.n6 f34317c;
    public org.telegram.ui.ActionBar.b2 f34318c0;
    public org.telegram.ui.Components.m11 d;
    public ValueAnimator f34319d0;
    public i0.b e;
    public ValueAnimator f34320e0;
    public Bitmap f34321f;
    public BitmapShader h;
    public Paint f34322n;
    public Matrix f34323r;
    public float f34324s;
    public float v;
    public org.telegram.ui.Components.u71 f34325w;
    public ci.f4 f34326x;
    ...
    public final void c(boolean z10, d51 d51Var) {
        float f7;
        long j3;
        ValueAnimator valueAnimator = this.f34319d0;
        if (valueAnimator != null) {
            valueAnimator.cancel();
        }
        ValueAnimator valueAnimator2 = this.f34320e0;
        if (valueAnimator2 != null) {
            valueAnimator2.cancel();
        }
        d();
        float f10 = this.f34324s;
        float f11 = 0.0f;
        if (z10) {
            f7 = 1.0f;
        } else {
        ...
        this.f34319d0 = ofFloat;
        ofFloat.addUpdateListener(new ai.bb(10, this, z10));
        this.f34319d0.addListener(new androidx.fragment.app.g(this, z10, d51Var, 10));
        if (!z10 && this.Y == null) {
            j3 = 330;
        } else {
            j3 = 520;
        }
        ValueAnimator valueAnimator3 = this.f34319d0;
        org.telegram.ui.Components.qr qrVar = org.telegram.ui.Components.qr.h;
        valueAnimator3.setInterpolator(qrVar);
        this.f34319d0.setDuration(j3);
        this.f34319d0.start();
        float f12 = this.v;
        if (z10) {
            f11 = 1.0f;
        ...
        this.f34320e0 = ofFloat2;
        ofFloat2.addUpdateListener(new i21(this, 6));
        this.f34320e0.addListener(new h70(7, this, z10));
        this.f34320e0.setDuration(((float) j3) * 1.5f);
        this.f34320e0.setInterpolator(qrVar);
        this.f34320e0.start();
    }

    public final void d() {
        if (!this.H) {
            j0 j0Var = this.f34315b;
            if (j0Var.getWidth() > 0) {
                ...
                if (u1Var != null) {
                    ...
                    i0.b bVar2 = this.e;
                    this.G = org.telegram.messenger.q.y(((height - bVar2.f10592b) - bVar2.d) - this.O.getHeight(), this.K, 2.0f, iArr[1] - this.e.f10592b);
                    if (!this.J) {
                        this.J = true;
    ...
    public final void dismiss() {
        g51 g51Var;
        if (!this.f34316b0) {
            org.telegram.ui.ActionBar.b2 b2Var = this.f34318c0;
            if (b2Var != null) {
                b2Var.dismiss();
                this.f34318c0 = null;
            }
            this.f34316b0 = true;
            ci.f4 f4Var = this.f34326x;
            if (f4Var != null) {
                f4Var.e(true);
            }
            org.telegram.ui.Components.u71 u71Var = this.f34325w;
            if (u71Var != null) {
                u71Var.B();
                this.f34325w.H();
                this.f34325w = null;
            ...
            if (!this.S && (g51Var = this.N) != null && g51Var.getSeekBarWaveform() != null) {
                ...
                seekBarWaveform.L = this.f34324s;
            ...
            if (jtVar != null) {
                ...
                SensorManager sensorManager = jtVar.f25437a;
                if (jtVar.f25441n) {
                    Sensor sensor = jtVar.f25440f;
                    if (sensor != null) {
                    ...
                    sensorManager.unregisterListener(jtVar, jtVar.f25439c);
    ...
    public final void e() {
        if (this.d == null) {
            this.N.setTranslationX(AndroidUtilities.lerp(this.F, 0.0f, this.f34324s));
            this.N.setTranslationY(AndroidUtilities.lerp(this.G, this.I, this.f34324s));
            ci.f4 f4Var = this.f34326x;
            if (f4Var != null) {
                f4Var.setTranslationX(AndroidUtilities.lerp(this.F, 0.0f, this.f34324s));
                this.f34326x.setTranslationY(AndroidUtilities.lerp(this.G, this.I, this.f34324s));
            }
        }
    }
    ...
    public final void onBackPressed() {
        ...
        if (b2Var != null) {
            b2Var.dismiss();
            this.f34318c0 = null;
        } else if (!this.f34316b0 && (messageObject = this.M) != null && !messageObject.isOutOwner()) {
            ...
            this.f34318c0 = b2Var2;
            b2Var2.show();
            TextView textView = (TextView) this.f34318c0.d(-2);
            if (textView != null) {
        ...
        if (AndroidUtilities.isSafeToShow(getContext())) {
            ...
            if (jtVar != null) {
                ...
                if (!jtVar.f25441n) {
                    ...
                    sensorManager.registerListener(jtVar, jtVar.f25439c, 3);
