...
public class ThemeActivity extends org.telegram.ui.ActionBar.p2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public org.telegram.ui.Components.sl0 f32333b;
    public int f32334b0;
    ...
    public int m0;
    public org.telegram.ui.ActionBar.h6 f32347n;
    public int f32348n0;
    ...
    public int f32351q0;
    public org.telegram.ui.ActionBar.d2 f32352r;
    public int f32353r0;
    private int raiseToListenRow;
    public org.telegram.ui.ActionBar.w0 f32354s;
    public int f32355s0;
    ...
    public static class InnerAccentView extends View {
        public final Paint f32366a;
        public ObjectAnimator f32367b;
        ...
        public InnerAccentView(Context context) {
            super(context);
            this.f32366a = new Paint(1);
        }

        public final void a(boolean z4) {
            boolean z10;
            if (this.d.V == this.e.f19761a) {
                z10 = true;
            } else {
                z10 = false;
            }
            this.f32369f = z10;
            ObjectAnimator objectAnimator = this.f32367b;
        ...
        public final void onDraw(Canvas canvas) {
            ...
            int i10 = this.e.f19763c;
            Paint paint = this.f32366a;
            paint.setColor(i10);
            paint.setStyle(Paint.Style.STROKE);
            paint.setStrokeWidth(AndroidUtilities.dp(3.0f));
            paint.setAlpha(Math.round(this.f32368c * 255.0f));
            canvas.drawCircle(measuredWidth, measuredHeight, dp - (paint.getStrokeWidth() * 0.5f), paint);
            paint.setAlpha(255);
            paint.setStyle(Paint.Style.FILL);
            canvas.drawCircle(measuredWidth, measuredHeight, dp - (AndroidUtilities.dp(5.0f) * this.f32368c), paint);
            if (this.f32368c != 0.0f) {
                paint.setColor(-1);
                paint.setAlpha(Math.round(this.f32368c * 255.0f));
                canvas.drawCircle(measuredWidth, measuredHeight, AndroidUtilities.dp(2.0f), paint);
                canvas.drawCircle(measuredWidth - (AndroidUtilities.dp(7.0f) * this.f32368c), measuredHeight, AndroidUtilities.dp(2.0f), paint);
                canvas.drawCircle((AndroidUtilities.dp(7.0f) * this.f32368c) + measuredWidth, measuredHeight, AndroidUtilities.dp(2.0f), paint);
            }
            int i11 = this.e.e;
            if (i11 != 0 && this.f32368c != 1.0f) {
                paint.setColor(i11);
                canvas.drawCircle(measuredWidth, measuredHeight, (1.0f - this.f32368c) * AndroidUtilities.dp(8.0f), paint);
            }
        }
        ...
        public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
            ...
            accessibilityNodeInfo.setChecked(this.f32369f);
        ...
        if (!TextUtils.isEmpty(str) && messagesController.config.needAgeVideoVerification.get()) {
            ...
            dVar.setOnClickListener(new View.OnClickListener() {
                ...
                public final void onClick(View view) {
                    ...
                    org.telegram.ui.Components.ge0.e(i13, i14, new String[]{"android.permission.CAMERA"}, new String[]{"android.permission.CAMERA"}, new Utilities.Callback() {
                        @Override
                        public final void run(Object obj) {
                            ...
                            userNameResolver.resolve(str3, new h5.d() {
                                ...
                                public final void accept(Object obj2) {
                                    ...
                                    q2Var.f43689h0 = U.getParentActivity();
                                    q2Var.s(U, b12);
                                    q2Var.show();
                                    dVar4.setLoading(false);
                                    g3VarArr2[0].dismiss();
    ...
    public static void U(ThemeActivity themeActivity, TL_account.contentSettings contentsettings) {
        lb1 lb1Var;
        boolean z4;
        org.telegram.ui.Components.sl0 sl0Var = themeActivity.f32333b;
        if (sl0Var != null && sl0Var.D && (lb1Var = themeActivity.f32331a) != null) {
    ...
    public static void W(final ThemeActivity themeActivity, Context context, View view, final int i10, float f10) {
        ...
        if (i10 == themeActivity.K) {
            ...
            if (!SharedConfig.raiseToListen && themeActivity.B != -1) {
                for (int i13 = 0; i13 < themeActivity.f32333b.getChildCount(); i13++) {
                    View childAt = themeActivity.f32333b.getChildAt(i13);
                    if (childAt instanceof org.telegram.ui.Cells.s8) {
                        themeActivity.f32333b.getClass();
            ...
            if (i10 == themeActivity.H) {
                if (themeActivity.getParentActivity() != null) {
                    ...
                    for (final int i14 = 0; i14 < 3; i14++) {
                        ...
                        k6Var.setOnClickListener(new View.OnClickListener(themeActivity) {
                            public final ThemeActivity f37963b;

                            {
                                this.f37963b = themeActivity;
                            }
                            ...
                            public final void onClick(View view2) {
                                switch (r4) {
                                    case 0:
                                        ThemeActivity themeActivity2 = this.f37963b;
                                        themeActivity2.getClass();
                                        SharedConfig.setSearchEngineType(i14);
                                        themeActivity2.M0 = true;
                                        f2.l1 K = themeActivity2.f32333b.K(themeActivity2.I);
                                        if (K != null) {
                                            themeActivity2.f32331a.v(K, themeActivity2.I);
                                        }
                                        ((Dialog) atomicReference.get()).dismiss();
                                        return;
                                    default:
                                        ThemeActivity themeActivity3 = this.f37963b;
                                        themeActivity3.getClass();
                                        SharedConfig.setDistanceSystemType(i14);
                                        themeActivity3.L0 = true;
                                        f2.l1 K2 = themeActivity3.f32333b.K(themeActivity3.H);
                                        if (K2 != null) {
                                            themeActivity3.f32331a.v(K2, themeActivity3.H);
                                        }
                                        ((Dialog) atomicReference.get()).dismiss();
                                        return;
                                }
                ...
                if (themeActivity.getParentActivity() != null) {
                    ...
                    final int i15 = 0;
                    while (i15 < size) {
                        charSequenceArr2[i15] = ((org.telegram.ui.web.l1) b10.get(i15)).f39570a;
                        ...
                        k6Var2.a(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19961g7, false), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.E5, false));
                        ...
                        k6Var2.setBackground(org.telegram.ui.ActionBar.j6.f0(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19996i6, false), 2, -1));
                        f13.addView(k6Var2);
                ...
                if (themeActivity.getParentActivity() != null) {
                    ...
                    int i16 = org.telegram.ui.ActionBar.j6.f19961g7;
                    ...
                    int i18 = org.telegram.ui.ActionBar.j6.f19996i6;
                    ...
                    k6Var3.setOnClickListener(new View.OnClickListener(themeActivity) {
                        public final ThemeActivity f38248b;

                        {
                            this.f38248b = themeActivity;
                        }
                        ...
                        public final void onClick(View view2) {
                            switch (r3) {
                                case 0:
                                    ThemeActivity themeActivity2 = this.f38248b;
                                    themeActivity2.getClass();
                                    SharedConfig.recordViaSco = false;
                                    SharedConfig.saveConfig();
                                    themeActivity2.K0 = true;
                                    ((Dialog) atomicReference3.get()).dismiss();
                                    f2.l1 K = themeActivity2.f32333b.K(themeActivity2.J);
                                    if (K != null) {
                                        themeActivity2.f32331a.v(K, themeActivity2.J);
                                        return;
                                    }
                                    return;
                                default:
                                    ...
                                    ThemeActivity themeActivity3 = this.f38248b;
                                    AtomicReference atomicReference4 = atomicReference3;
                                    org.telegram.ui.Components.ge0.e(i19, i20, new String[]{"android.permission.BLUETOOTH_CONNECT"}, new String[]{"android.permission.BLUETOOTH_CONNECT"}, new org.telegram.ui.Components.vk(27, themeActivity3, atomicReference4));
                                    SharedConfig.recordViaSco = true;
                                    SharedConfig.saveConfig();
                                    themeActivity3.K0 = true;
                                    ((Dialog) atomicReference4.get()).dismiss();
                                    f2.l1 K2 = themeActivity3.f32333b.K(themeActivity3.J);
                                    if (K2 != null) {
                                        themeActivity3.f32331a.v(K2, themeActivity3.J);
                                        return;
                                    }
                                    return;
                            }
                    ...
                    k6Var4.f21303a.setText(string5);
                    TextView textView = k6Var4.f21304b;
                    textView.setVisibility(0);
                    textView.setText(string6);
                    k6Var4.f21305c.a(z16, false);
                ...
                if (i10 == themeActivity.N) {
                    if (themeActivity.getParentActivity() != null) {
                        ...
                        d2Var5.O = string9;
                        alertDialog$Builder5.f(new CharSequence[]{LocaleController.getString("Default", R.string.Default), LocaleController.getString("SortFirstName", R.string.SortFirstName), LocaleController.getString("SortLastName", R.string.SortLastName)}, new sy(themeActivity, i10, 2));
                    ...
                    if ((LocaleController.isRTL && f10 <= AndroidUtilities.dp(76.0f)) || (!LocaleController.isRTL && f10 >= view.getMeasuredWidth() - AndroidUtilities.dp(76.0f))) {
                        ...
                        if (org.telegram.ui.ActionBar.j6.f20096o == 0) {
                            org.telegram.ui.ActionBar.j6.f20096o = 2;
                            j5Var.setChecked(true);
                        } else {
                            org.telegram.ui.ActionBar.j6.f20096o = 0;
                        ...
                        if (z4) {
                            int i19 = org.telegram.ui.ActionBar.j6.f20096o;
                            if (i19 == 1) {
                    ...
                    if (org.telegram.ui.ActionBar.j6.f20096o != 1) {
                        org.telegram.ui.ActionBar.j6.f20096o = 1;
                        if (org.telegram.ui.ActionBar.j6.f20114p) {
                    ...
                    if (org.telegram.ui.ActionBar.j6.f20096o != 3) {
                        org.telegram.ui.ActionBar.j6.f20096o = 3;
                        themeActivity.A0(true);
                        org.telegram.ui.ActionBar.j6.E(false);
                    }
                } else if (i10 == themeActivity.U) {
                    boolean z17 = !org.telegram.ui.ActionBar.j6.f20114p;
                    org.telegram.ui.ActionBar.j6.f20114p = z17;
                    ...
                    if (i10 == themeActivity.X) {
                        i11 = org.telegram.ui.ActionBar.j6.f20151r;
                        i12 = i11 / 60;
                    } else {
                        i11 = org.telegram.ui.ActionBar.j6.f20168s;
                        i12 = i11 / 60;
                    }
                    int i20 = i11 - (i12 * 60);
                    ...
                    themeActivity.showDialog(new TimePickerDialog(themeActivity.getParentActivity(), new TimePickerDialog.OnTimeSetListener() {
                        ...
                        public final void onTimeSet(TimePicker timePicker, int i21, int i22) {
                            ...
                            if (i25 == i24) {
                                org.telegram.ui.ActionBar.j6.f20151r = i23;
                            ...
                            org.telegram.ui.ActionBar.j6.f20168s = i23;
    ...
    public static boolean Y(ThemeActivity themeActivity, int i10, boolean z4) {
        ...
        edit.commit();
        f2.l1 K = themeActivity.f32333b.K(themeActivity.textSizeRow);
        if (K != null) {
            View view = K.f5785a;
            if (view instanceof mb1) {
                mb1 mb1Var = (mb1) view;
                org.telegram.ui.Cells.t1[] cells = mb1Var.f36259a.getCells();
        ...
        f2.l1 K2 = themeActivity.f32333b.K(themeActivity.bubbleRadiusRow);
        if (K2 != null) {
        ...
        if (i10 != SharedConfig.fontSize) {
            ...
            if (sharedPreferences != null) {
                ...
                if (K != null) {
                    View view = K.f5785a;
                    if (view instanceof mb1) {
                        org.telegram.ui.Cells.t1[] cells = ((mb1) view).f36259a.getCells();
                        for (int i11 = 0; i11 < cells.length; i11++) {
                            cells[i11].getMessageObject().resetLayout();
                            cells[i11].requestLayout();
                        }
    ...
    public static String y0() {
        ...
        int i12 = org.telegram.ui.ActionBar.j6.f20184t;
        int i13 = i12 / 60;
    ...
    public final void A0(boolean z4) {
        ...
        int i22 = this.G0;
        int i23 = this.f32348n0;
        int i24 = this.f32358v0;
        int i25 = this.B;
        this.G0 = 0;
        this.M = -1;
        this.N = -1;
        ...
        while (true) {
            ...
            if (i10 == 0 || i10 == 3 || ((i6Var.f19807b != null || i6Var.q()) && ((tL_theme = i6Var.C) == null || tL_theme.document != null))) {
        ...
        if (i10 == 3) {
            ...
            this.v = z12;
            ib1 ib1Var = this.f32335c;
            if (ib1Var != null) {
                ib1Var.setDrawDivider(z12);
            }
            if (this.v) {
                int i28 = this.G0;
                this.G0 = i28 + 1;
            ...
            if (arrayList3 != null && !arrayList3.isEmpty() && k10 != null && k10.f19761a >= 100) {
                int i30 = this.G0;
                this.G0 = i30 + 1;
                this.f32358v0 = i30;
            }
            ...
            this.f32342h0 = i32 + 10;
            this.f32343i0 = i32 + 11;
            this.f32344j0 = i32 + 12;
            this.f32345k0 = i32 + 13;
            this.E0 = i32 + 14;
            this.appIconSelectorRow = i32 + 15;
            this.F0 = i32 + 16;
            this.f32351q0 = i32 + 17;
            this.f32353r0 = i32 + 18;
            this.f32355s0 = i32 + 19;
            this.nightThemeRow = i32 + 20;
            this.browserRow = i32 + 21;
            this.liteModeRow = i32 + 22;
            this.stickersRow = i32 + 23;
            this.f32364y0 = i32 + 24;
            this.B0 = i32 + 25;
            this.C = i32 + 26;
            int i33 = i32 + 28;
            this.G0 = i33;
            ...
            this.G0 = i40;
            this.S = i39;
            int i41 = org.telegram.ui.ActionBar.j6.f20096o;
            if (i41 == 1) {
                this.T = i40;
                int i42 = i39 + 3;
                this.G0 = i42;
            ...
            if (org.telegram.ui.ActionBar.j6.f20096o != 0) {
                ...
                this.v = z10;
                ib1 ib1Var2 = this.f32335c;
                if (ib1Var2 != null) {
                    ib1Var2.setDrawDivider(z10);
                }
                if (this.v) {
                    int i44 = this.G0;
                    this.G0 = i44 + 1;
        ...
        ib1 ib1Var3 = this.f32335c;
        if (ib1Var3 != null) {
            int width = this.f32333b.getWidth();
            int i46 = ib1Var3.f21368d3;
        ...
        lb1 lb1Var = this.f32331a;
        if (lb1Var != null) {
            if (i10 == 1 && (i15 = this.I0) != (i16 = org.telegram.ui.ActionBar.j6.f20096o) && i15 != -1) {
                int i47 = this.S;
                int i48 = i47 + 1;
                if (i15 != i16) {
                    for (int i49 = 0; i49 < 4; i49++) {
                        org.telegram.ui.Components.el0 el0Var = (org.telegram.ui.Components.el0) this.f32333b.K(i49);
                        if (el0Var != null) {
                            ...
                            if (view instanceof org.telegram.ui.Cells.fa) {
                                ...
                                if (i49 == org.telegram.ui.ActionBar.j6.f20096o) {
                                    z11 = true;
                                } else {
                                    z11 = false;
                                }
                    ...
                    int i50 = org.telegram.ui.ActionBar.j6.f20096o;
                    if (i50 == 0) {
                        this.f32331a.t(i48, i22 - i48);
                    } else if (i50 == 1) {
                        int i51 = this.I0;
                        if (i51 == 0) {
                            this.f32331a.s(i48, this.G0 - i48);
                        } else if (i51 == 2) {
                            this.f32331a.t(i48, 3);
                            lb1 lb1Var2 = this.f32331a;
                            if (org.telegram.ui.ActionBar.j6.f20114p) {
                                i21 = 4;
                            } else {
                                i21 = 5;
                    ...
                    boolean z13 = this.J0;
                    boolean z14 = org.telegram.ui.ActionBar.j6.f20114p;
                    if (z13 != z14) {
                        int i54 = i47 + 3;
                        if (z14) {
                            i17 = 3;
                ...
                if (i23 == -1 && (i14 = this.f32348n0) != -1) {
                    lb1Var.o(i14);
                } else if (i23 != -1 && this.f32348n0 == -1) {
                    lb1Var.u(i23);
                    if (i24 != -1) {
                        i24--;
                    }
                } else {
                    int i55 = this.f32348n0;
                    if (i55 != -1) {
                        lb1Var.m(i55);
                    }
                }
                if (i24 == -1 && (i13 = this.f32358v0) != -1) {
                    this.f32331a.o(i13);
                } else if (i24 != -1 && this.f32358v0 == -1) {
                    this.f32331a.u(i24);
                }
        ...
        if (i10 == 1) {
            this.J0 = org.telegram.ui.ActionBar.j6.f20114p;
            this.I0 = org.telegram.ui.ActionBar.j6.f20096o;
        }
        z0();
    }
    ...
    public final void B0(Location location, boolean z4) {
            ...
            if (getParentActivity().getPackageManager().hasSystemFeature("android.hardware.location.gps")) {
                try {
                    if (!((LocationManager) ApplicationLoader.applicationContext.getSystemService("location")).isProviderEnabled("gps")) {
                        ...
                        alertDialog$Builder.f19503a.Q = LocaleController.getString("GpsDisabledAlertText", R.string.GpsDisabledAlertText);
        ...
        org.telegram.ui.ActionBar.j6.f20256x = location.getLatitude();
        org.telegram.ui.ActionBar.j6.f20274y = location.getLongitude();
        int[] calculateSunriseSunset = SunDate.calculateSunriseSunset(org.telegram.ui.ActionBar.j6.f20256x, org.telegram.ui.ActionBar.j6.f20274y);
        org.telegram.ui.ActionBar.j6.v = calculateSunriseSunset[0];
        org.telegram.ui.ActionBar.j6.f20184t = calculateSunriseSunset[1];
        org.telegram.ui.ActionBar.j6.f20237w = null;
        Calendar calendar = Calendar.getInstance();
        calendar.setTimeInMillis(System.currentTimeMillis());
        org.telegram.ui.ActionBar.j6.f20200u = calendar.get(5);
        Utilities.globalQueue.postRunnable(new ya1(this, 1));
        org.telegram.ui.Components.el0 el0Var = (org.telegram.ui.Components.el0) this.f32333b.K(this.W);
        if (el0Var != null) {
            View view = el0Var.f5785a;
        ...
        if (org.telegram.ui.ActionBar.j6.f20114p && org.telegram.ui.ActionBar.j6.f20096o == 1) {
            org.telegram.ui.ActionBar.j6.E(false);
        }
    }
    ...
    public final View createView(Context context) {
        ...
        if (i10 == 3) {
            ...
            int i11 = R.raw.sun;
            org.telegram.ui.Components.gj0 gj0Var = new org.telegram.ui.Components.gj0(i11, "" + R.raw.sun, AndroidUtilities.dp(28.0f), AndroidUtilities.dp(28.0f), true, null);
            this.P0 = gj0Var;
            if (this.R0) {
            ...
            this.f32354s.e(2, R.drawable.msg_share, LocaleController.getString("ShareTheme", R.string.ShareTheme));
            this.f32354s.e(3, R.drawable.msg_edit, LocaleController.getString("EditThemeColors", R.string.EditThemeColors));
            this.f32354s.e(1, R.drawable.msg_palette, LocaleController.getString("CreateNewThemeMenu", R.string.CreateNewThemeMenu));
            this.f32354s.e(4, R.drawable.msg_reset, LocaleController.getString("ThemeResetToDefaults", R.string.ThemeResetToDefaults));
        ...
        this.f32331a = new lb1(this, context);
        FrameLayout frameLayout = new FrameLayout(context);
        ...
        this.f32333b = sl0Var;
        sl0Var.p1();
        this.f32333b.setLayoutManager(new f2.i0(1, false));
        this.f32333b.setVerticalScrollBarEnabled(false);
        this.f32333b.setAdapter(this.f32331a);
        ((f2.l) this.f32333b.getItemAnimator()).C = false;
        frameLayout.addView(this.f32333b, k7.b6.c(-1.0f, -1));
        this.actionBar.setAdaptiveBackground(this.f32333b);
        this.f32333b.setOnItemClickListener(new tl0(20, this, context));
        if (i10 == 0) {
            f2.l lVar = new f2.l();
            lVar.n(350L);
            ...
            lVar.C = false;
            lVar.f5818m = false;
            this.f32333b.setItemAnimator(lVar);
        }
        if (this.Q0) {
            A0(false);
            this.Q0 = false;
            this.f32333b.u0(this.f32331a.e.G0 - 1);
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.locationPermissionGranted) {
            ...
            if (i10 == NotificationCenter.webBrowserSettingsUpdate) {
                lb1 lb1Var = this.f32331a;
                if (lb1Var != null && (i15 = this.browserRow) != -1) {
                    lb1Var.m(i15);
                }
            } else if (i10 == NotificationCenter.themeAccentListUpdated) {
                lb1 lb1Var2 = this.f32331a;
                if (lb1Var2 != null && (i14 = this.f32348n0) != -1) {
                ...
                if (i10 == NotificationCenter.themeUploadedToServer) {
                    ...
                    if (i6Var == this.h && h6Var == this.f32347n) {
                        ...
                        org.telegram.ui.ActionBar.d2 d2Var2 = this.f32352r;
                        if (d2Var2 != null) {
                            d2Var2.dismiss();
                        }
                    }
                    ...
                    if (i6Var2 == this.h && h6Var2 == this.f32347n && (d2Var = this.f32352r) == null) {
                        d2Var.dismiss();
                    }
                    ...
                    if (this.f32339f == 3) {
                        ...
                        if (this.R0 != z4) {
                            ...
                            gj0Var.N(i13);
                            this.f32354s.getIconView().d();
                        }
                        if (this.m0 >= 0) {
                            for (int i16 = 0; i16 < this.f32333b.getChildCount(); i16++) {
                                if (this.f32333b.getChildAt(i16) instanceof cv) {
                                    ((cv) this.f32333b.getChildAt(i16)).b();
                                }
                            }
                        }
                    }
            ...
            org.telegram.ui.Components.sl0 sl0Var = this.f32333b;
            if (sl0Var != null) {
                sl0Var.f1();
            }
            z0();
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32333b, 16, new Class[]{org.telegram.ui.Cells.aa.class, org.telegram.ui.Cells.s8.class, org.telegram.ui.Cells.m4.class, org.telegram.ui.Cells.k0.class, org.telegram.ui.Cells.fa.class, mb1.class, bb1.class, hb1.class, org.telegram.ui.Cells.j5.class, org.telegram.ui.Cells.la.class, jb1.class, org.telegram.ui.Cells.o8.class, oo0.class, org.telegram.ui.Components.wy0.class, cv.class, org.telegram.ui.Cells.t.class}, null, null, null, i10));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32333b, 32768, null, null, null, null, org.telegram.ui.ActionBar.j6.f20176s8));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32333b, 4096, null, null, null, null, org.telegram.ui.ActionBar.j6.f19996i6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32333b, 0, new Class[]{View.class}, org.telegram.ui.ActionBar.j6.f20025k0, null, null, org.telegram.ui.ActionBar.j6.f19907d7));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32333b, 0, new Class[]{org.telegram.ui.Cells.a9.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.B6));
        int i11 = org.telegram.ui.ActionBar.j6.G6;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32333b, 0, new Class[]{org.telegram.ui.Cells.aa.class}, new String[]{"textView"}, null, null, -1, null, i11));
        int i12 = org.telegram.ui.ActionBar.j6.I6;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32333b, 0, new Class[]{org.telegram.ui.Cells.aa.class}, new String[]{"valueTextView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32333b, 0, new Class[]{org.telegram.ui.Cells.m4.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.L6));
        int i13 = org.telegram.ui.ActionBar.j6.f20140q6;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32333b, 0, new Class[]{org.telegram.ui.Cells.o8.class}, new String[]{"textView"}, null, null, -1, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32333b, 0, new Class[]{org.telegram.ui.Cells.o8.class}, new String[]{"imageView"}, null, null, -1, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32333b, 0, new Class[]{org.telegram.ui.Cells.s8.class}, new String[]{"textView"}, null, null, -1, null, i11));
        int i14 = org.telegram.ui.ActionBar.j6.M6;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32333b, 0, new Class[]{org.telegram.ui.Cells.s8.class}, new String[]{"checkBox"}, null, null, -1, null, i14));
        int i15 = org.telegram.ui.ActionBar.j6.N6;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32333b, 0, new Class[]{org.telegram.ui.Cells.s8.class}, new String[]{"checkBox"}, null, null, -1, null, i15));
        int i16 = org.telegram.ui.ActionBar.j6.f20067m6;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32333b, 8, new Class[]{org.telegram.ui.Cells.k0.class}, new String[]{"leftImageView"}, null, null, -1, null, i16));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32333b, 8, new Class[]{org.telegram.ui.Cells.k0.class}, new String[]{"rightImageView"}, null, null, -1, null, i16));
        int i17 = org.telegram.ui.ActionBar.j6.Ti;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32333b, 0, new Class[]{org.telegram.ui.Cells.k0.class}, new String[]{"seekBarView"}, null, null, -1, null, i17));
        int i18 = org.telegram.ui.ActionBar.j6.Vi;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32333b, 2048, new Class[]{org.telegram.ui.Cells.k0.class}, new String[]{"seekBarView"}, null, null, -1, null, i18));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32333b, 0, new Class[]{org.telegram.ui.Cells.fa.class}, new String[]{"textView"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32333b, 0, new Class[]{org.telegram.ui.Cells.fa.class}, new String[]{"checkImage"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.Mh));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32333b, 2048, new Class[]{mb1.class}, new String[]{"sizeBar"}, null, null, -1, null, i18));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32333b, 0, new Class[]{mb1.class}, new String[]{"sizeBar"}, null, null, -1, null, i17));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32333b, 2048, new Class[]{bb1.class}, new String[]{"sizeBar"}, null, null, -1, null, i18));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32333b, 0, new Class[]{bb1.class}, new String[]{"sizeBar"}, null, null, -1, null, i17));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32333b, 0, new Class[]{hb1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19961g7));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32333b, 0, new Class[]{hb1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19979h7));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32333b, 0, new Class[]{org.telegram.ui.Cells.j5.class}, new String[]{"textView"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32333b, 0, new Class[]{org.telegram.ui.Cells.j5.class}, new String[]{"valueTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f20298z6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32333b, 0, new Class[]{org.telegram.ui.Cells.j5.class}, new String[]{"checkBox"}, null, null, -1, null, i14));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32333b, 0, new Class[]{org.telegram.ui.Cells.j5.class}, new String[]{"checkBox"}, null, null, -1, null, i15));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32333b, 0, new Class[]{mb1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.f20064m3, org.telegram.ui.ActionBar.j6.f20137q3}, null, org.telegram.ui.ActionBar.j6.f20162ra));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32333b, 0, new Class[]{mb1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.f20082n3, org.telegram.ui.ActionBar.j6.f20155r3}, null, org.telegram.ui.ActionBar.j6.f19912dc));
        Drawable[] drawableArr = org.telegram.ui.ActionBar.j6.f20064m3.f19734y;
        int i19 = org.telegram.ui.ActionBar.j6.f20193ta;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32333b, 0, new Class[]{mb1.class}, null, drawableArr, null, i19));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32333b, 0, new Class[]{mb1.class}, null, org.telegram.ui.ActionBar.j6.f20137q3.f19734y, null, i19));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32333b, 0, new Class[]{mb1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.f20100o3, org.telegram.ui.ActionBar.j6.f20172s3}, null, org.telegram.ui.ActionBar.j6.Aa));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32333b, 0, new Class[]{mb1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.f20100o3, org.telegram.ui.ActionBar.j6.f20172s3}, null, org.telegram.ui.ActionBar.j6.Da));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32333b, 0, new Class[]{mb1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.f20100o3, org.telegram.ui.ActionBar.j6.f20172s3}, null, org.telegram.ui.ActionBar.j6.Ea));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32333b, 0, new Class[]{mb1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.f20100o3, org.telegram.ui.ActionBar.j6.f20172s3}, null, org.telegram.ui.ActionBar.j6.Fa));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32333b, 0, new Class[]{mb1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.f20118p3, org.telegram.ui.ActionBar.j6.f20188t3}, null, org.telegram.ui.ActionBar.j6.Ba));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32333b, 0, new Class[]{mb1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.f20100o3, org.telegram.ui.ActionBar.j6.f20172s3}, null, org.telegram.ui.ActionBar.j6.Ca));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32333b, 0, new Class[]{mb1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.f20064m3, org.telegram.ui.ActionBar.j6.f20137q3}, null, i19));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32333b, 0, new Class[]{mb1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19929ec));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32333b, 0, new Class[]{mb1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19947fc));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32333b, 0, new Class[]{mb1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.f20278y3}, null, org.telegram.ui.ActionBar.j6.Ja));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32333b, 0, new Class[]{mb1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.f20296z3}, null, org.telegram.ui.ActionBar.j6.Ka));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32333b, 0, new Class[]{mb1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.A3, org.telegram.ui.ActionBar.j6.C3}, null, org.telegram.ui.ActionBar.j6.La));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32333b, 0, new Class[]{mb1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.B3, org.telegram.ui.ActionBar.j6.D3}, null, org.telegram.ui.ActionBar.j6.Ma));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32333b, 0, new Class[]{mb1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.F3, org.telegram.ui.ActionBar.j6.G3}, null, org.telegram.ui.ActionBar.j6.f20178sc));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32333b, 0, new Class[]{mb1.class}, null, null, null, org.telegram.ui.ActionBar.j6.Uc));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32333b, 0, new Class[]{mb1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19856ab));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32333b, 0, new Class[]{mb1.class}, null, null, null, org.telegram.ui.ActionBar.j6.Wc));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32333b, 0, new Class[]{mb1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19893cb));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32333b, 0, new Class[]{mb1.class}, null, null, null, org.telegram.ui.ActionBar.j6.Yc));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32333b, 0, new Class[]{mb1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19911db));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32333b, 0, new Class[]{mb1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19858ad));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32333b, 0, new Class[]{mb1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19946fb));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32333b, 0, new Class[]{mb1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f20091nd));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32333b, 0, new Class[]{mb1.class}, null, null, null, org.telegram.ui.ActionBar.j6.sb));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32333b, 0, new Class[]{mb1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f20109od));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32333b, 0, new Class[]{mb1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f20090nb));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32333b, 0, new Class[]{org.telegram.ui.Cells.t.class}, null, null, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32333b, 0, new Class[]{org.telegram.ui.Cells.t.class}, null, null, null, i11));
        int i20 = org.telegram.ui.ActionBar.j6.H6;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32333b, 0, new Class[]{org.telegram.ui.Cells.t.class}, null, null, null, i20));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32333b, 0, new Class[]{org.telegram.ui.Cells.t.class}, null, null, null, i12));
    ...
    public final void onInsets(int i10, int i11, int i12, int i13) {
        this.f32333b.setPadding(0, 0, 0, i13);
        this.f32333b.setClipToPadding(false);
    }
    ...
    public final void w0() {
        ...
        AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(getParentActivity());
        alertDialog$Builder.f19503a.O = LocaleController.getString("NewTheme", R.string.NewTheme);
        alertDialog$Builder.f19503a.Q = LocaleController.getString("CreateNewThemeAlert", R.string.CreateNewThemeAlert);
        alertDialog$Builder.h(LocaleController.getString("Cancel", R.string.Cancel), null);
    ...
    public final void x0() {
        ...
        presentFragment(new cd1(A0, false, 1, z4, z10));
    }
    ...
    public final void z0() {
        ...
        if (arrayList != null && !arrayList.isEmpty() && k10 != null && k10.f19761a >= 100) {
            this.f32354s.K(2);
            this.f32354s.K(3);
        } else {
            this.f32354s.r(2);
        ...
        org.telegram.ui.ActionBar.i6 A02 = org.telegram.ui.ActionBar.j6.A0();
        if (SharedConfig.fontSize == i10 && SharedConfig.bubbleRadius == 17 && A02.P && A02.V == org.telegram.ui.ActionBar.j6.f20078n && (k10 == null || (c6Var = k10.f19781y) == null || "d".equals(c6Var.f19556c))) {
            this.f32354s.r(4);
        } else {
            this.f32354s.K(4);
        }
