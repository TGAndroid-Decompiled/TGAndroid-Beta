...
public class ThemeActivity extends org.telegram.ui.ActionBar.o2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public org.telegram.ui.Components.ml0 f31568b;
    public int f31569b0;
    ...
    public int m0;
    public org.telegram.ui.ActionBar.h6 f31582n;
    public int f31583n0;
    ...
    public int f31586q0;
    public org.telegram.ui.ActionBar.c2 f31587r;
    public int f31588r0;
    private int raiseToListenRow;
    public org.telegram.ui.ActionBar.w0 f31589s;
    public int f31590s0;
    ...
    public static class InnerAccentView extends View {
        public final Paint f31601a;
        public ObjectAnimator f31602b;
        public float f31603c;
        ...
        public InnerAccentView(Context context) {
            super(context);
            this.f31601a = new Paint(1);
        }

        public final void a(boolean z10) {
            boolean z11;
            if (this.d.Y == this.e.f18721a) {
                z11 = true;
            } else {
                z11 = false;
            }
            this.f31604f = z11;
            ObjectAnimator objectAnimator = this.f31602b;
        ...
        public final void onDraw(Canvas canvas) {
            ...
            int i10 = this.e.f18723c;
            Paint paint = this.f31601a;
            paint.setColor(i10);
            paint.setStyle(Paint.Style.STROKE);
            paint.setStrokeWidth(AndroidUtilities.dp(3.0f));
            paint.setAlpha(Math.round(this.f31603c * 255.0f));
            canvas.drawCircle(measuredWidth, measuredHeight, dp - (paint.getStrokeWidth() * 0.5f), paint);
            paint.setAlpha(255);
            paint.setStyle(Paint.Style.FILL);
            canvas.drawCircle(measuredWidth, measuredHeight, dp - (AndroidUtilities.dp(5.0f) * this.f31603c), paint);
            if (this.f31603c != 0.0f) {
                paint.setColor(-1);
                paint.setAlpha(Math.round(this.f31603c * 255.0f));
                canvas.drawCircle(measuredWidth, measuredHeight, AndroidUtilities.dp(2.0f), paint);
                canvas.drawCircle(measuredWidth - (AndroidUtilities.dp(7.0f) * this.f31603c), measuredHeight, AndroidUtilities.dp(2.0f), paint);
                canvas.drawCircle((AndroidUtilities.dp(7.0f) * this.f31603c) + measuredWidth, measuredHeight, AndroidUtilities.dp(2.0f), paint);
            }
            int i11 = this.e.e;
            if (i11 != 0 && this.f31603c != 1.0f) {
                paint.setColor(i11);
                canvas.drawCircle(measuredWidth, measuredHeight, (1.0f - this.f31603c) * AndroidUtilities.dp(8.0f), paint);
            }
        }
        ...
        public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
            ...
            accessibilityNodeInfo.setChecked(this.f31604f);
    ...
    public static void C0(final int i10, final Context context, final Utilities.Callback callback, final org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        if (!TextUtils.isEmpty(str) && messagesController.config.needAgeVideoVerification.get()) {
            ...
            int i13 = org.telegram.ui.ActionBar.j6.f18970j5;
    ...
    public static void U(ThemeActivity themeActivity, TL_account.contentSettings contentsettings) {
        ...
        if (ml0Var != null && ml0Var.G && (hc1Var = themeActivity.f31566a) != null) {
    ...
    public static void W(ThemeActivity themeActivity, Context context, View view, final int i10, float f7) {
        ...
        if (i10 == themeActivity.N) {
            ...
            if (!SharedConfig.raiseToListen && themeActivity.E != -1) {
                for (int i13 = 0; i13 < themeActivity.f31568b.getChildCount(); i13++) {
                    View childAt = themeActivity.f31568b.getChildAt(i13);
                    if (childAt instanceof org.telegram.ui.Cells.w8) {
                        themeActivity.f31568b.getClass();
            ...
            if (i10 == themeActivity.K) {
                if (themeActivity.getParentActivity() != null) {
                    ...
                    for (final int i14 = 0; i14 < 3; i14++) {
                        ...
                        k6Var.setOnClickListener(new View.OnClickListener(themeActivity) {
                            public final ThemeActivity f35762b;

                            {
                                this.f35762b = themeActivity;
                            }
                            ...
                            public final void onClick(View view2) {
                                switch (r4) {
                                    case 0:
                                        ThemeActivity themeActivity2 = this.f35762b;
                                        themeActivity2.getClass();
                                        SharedConfig.setSearchEngineType(i14);
                                        themeActivity2.P0 = true;
                                        s4.c1 L = themeActivity2.f31568b.L(themeActivity2.L);
                                        if (L != null) {
                                            themeActivity2.f31566a.v(L, themeActivity2.L);
                                        }
                                        ((Dialog) atomicReference.get()).dismiss();
                                        return;
                                    default:
                                        ThemeActivity themeActivity3 = this.f35762b;
                                        themeActivity3.getClass();
                                        SharedConfig.setDistanceSystemType(i14);
                                        themeActivity3.O0 = true;
                                        s4.c1 L2 = themeActivity3.f31568b.L(themeActivity3.K);
                                        if (L2 != null) {
                                            themeActivity3.f31566a.v(L2, themeActivity3.K);
                                        }
                                        ((Dialog) atomicReference.get()).dismiss();
                                        return;
                                }
                ...
                if (themeActivity.getParentActivity() != null) {
                    ...
                    final int i15 = 0;
                    while (i15 < size) {
                        charSequenceArr2[i15] = ((org.telegram.ui.web.o1) b10.get(i15)).f38894a;
                        ...
                        k6Var2.a(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18918g7, false), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.E5, false));
                        ...
                        k6Var2.setBackground(org.telegram.ui.ActionBar.j6.f0(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18953i6, false), 2, -1));
                        f12.addView(k6Var2);
                ...
                if (themeActivity.getParentActivity() != null) {
                    ...
                    int i16 = org.telegram.ui.ActionBar.j6.f18918g7;
                    ...
                    int i18 = org.telegram.ui.ActionBar.j6.f18953i6;
                    ...
                    k6Var3.setOnClickListener(new View.OnClickListener(themeActivity) {
                        public final ThemeActivity f36020b;

                        {
                            this.f36020b = themeActivity;
                        }
                        ...
                        public final void onClick(View view2) {
                            switch (r3) {
                                case 0:
                                    ThemeActivity themeActivity2 = this.f36020b;
                                    themeActivity2.getClass();
                                    SharedConfig.recordViaSco = false;
                                    SharedConfig.saveConfig();
                                    themeActivity2.N0 = true;
                                    ((Dialog) atomicReference3.get()).dismiss();
                                    s4.c1 L = themeActivity2.f31568b.L(themeActivity2.M);
                                    if (L != null) {
                                        themeActivity2.f31566a.v(L, themeActivity2.M);
                                        return;
                                    }
                                    return;
                                default:
                                    ...
                                    ThemeActivity themeActivity3 = this.f36020b;
                                    ...
                                    s4.c1 L2 = themeActivity3.f31568b.L(themeActivity3.M);
                                    if (L2 != null) {
                                        themeActivity3.f31566a.v(L2, themeActivity3.M);
                                        return;
                                    }
                                    return;
                            }
                    ...
                    k6Var4.f20373a.setText(string5);
                    TextView textView = k6Var4.f20374b;
                    textView.setVisibility(0);
                    textView.setText(string6);
                    k6Var4.f20375c.a(z17, false);
            ...
            } else if (i10 == themeActivity.f31598y) {
                ...
                if (i10 == themeActivity.Q) {
                ...
                } else if (i10 == themeActivity.f31590s0) {
                    ...
                    if ((LocaleController.isRTL && f7 <= AndroidUtilities.dp(76.0f)) || (!LocaleController.isRTL && f7 >= view.getMeasuredWidth() - AndroidUtilities.dp(76.0f))) {
                        ...
                        if (org.telegram.ui.ActionBar.j6.f19058o == 0) {
                            org.telegram.ui.ActionBar.j6.f19058o = 2;
                            i5Var.setChecked(true);
                        } else {
                            org.telegram.ui.ActionBar.j6.f19058o = 0;
                        ...
                        if (z10) {
                            int i19 = org.telegram.ui.ActionBar.j6.f19058o;
                            if (i19 == 1) {
                    ...
                    if (org.telegram.ui.ActionBar.j6.f19058o != 1) {
                        org.telegram.ui.ActionBar.j6.f19058o = 1;
                        if (org.telegram.ui.ActionBar.j6.f19076p) {
                    ...
                    if (org.telegram.ui.ActionBar.j6.f19058o != 2) {
                        org.telegram.ui.ActionBar.j6.f19058o = 2;
                        themeActivity.A0(true);
                        org.telegram.ui.ActionBar.j6.E(false);
                    }
                } else if (i10 == themeActivity.U) {
                    if (org.telegram.ui.ActionBar.j6.f19058o != 3) {
                        org.telegram.ui.ActionBar.j6.f19058o = 3;
                        themeActivity.A0(true);
                        org.telegram.ui.ActionBar.j6.E(false);
                    }
                } else if (i10 == themeActivity.X) {
                    boolean z18 = !org.telegram.ui.ActionBar.j6.f19076p;
                    org.telegram.ui.ActionBar.j6.f19076p = z18;
                    ...
                    org.telegram.ui.ActionBar.j6.E(false);
                } else if (i10 != themeActivity.f31567a0 && i10 != themeActivity.f31569b0) {
                    if (i10 == themeActivity.Y) {
                        themeActivity.B0(null, true);
                    } else if (i10 == themeActivity.createNewThemeRow) {
                        themeActivity.w0();
                    } else if (i10 == themeActivity.f31599y0) {
                        themeActivity.x0();
                    ...
                    if (i10 == themeActivity.f31567a0) {
                        i11 = org.telegram.ui.ActionBar.j6.f19112r;
                        i12 = i11 / 60;
                    } else {
                        i11 = org.telegram.ui.ActionBar.j6.f19131s;
                        i12 = i11 / 60;
                    }
                    int i20 = i11 - (i12 * 60);
                    ...
                    themeActivity.showDialog(new TimePickerDialog(themeActivity.getParentActivity(), new TimePickerDialog.OnTimeSetListener() {
                        ...
                        public final void onTimeSet(TimePicker timePicker, int i21, int i22) {
                            int i23 = (i21 * 60) + i22;
                            int i24 = ThemeActivity.this.f31567a0;
                            int i25 = i10;
                            org.telegram.ui.Cells.ea eaVar2 = eaVar;
                            if (i25 == i24) {
                                org.telegram.ui.ActionBar.j6.f19112r = i23;
                            ...
                            org.telegram.ui.ActionBar.j6.f19131s = i23;
    ...
    public static boolean Y(ThemeActivity themeActivity, int i10, boolean z10) {
        ...
        edit.commit();
        s4.c1 L = themeActivity.f31568b.L(themeActivity.textSizeRow);
        if (L != null) {
            View view = L.f42702a;
            if (view instanceof ic1) {
                ic1 ic1Var = (ic1) view;
                org.telegram.ui.Cells.t1[] cells = ic1Var.f34531a.getCells();
        ...
        s4.c1 L2 = themeActivity.f31568b.L(themeActivity.bubbleRadiusRow);
        if (L2 != null) {
            View view2 = L2.f42702a;
        ...
        if (i10 != SharedConfig.fontSize) {
            ...
            if (sharedPreferences != null) {
                ...
                if (L != null) {
                    View view = L.f42702a;
                    if (view instanceof ic1) {
                        org.telegram.ui.Cells.t1[] cells = ((ic1) view).f34531a.getCells();
                        for (int i11 = 0; i11 < cells.length; i11++) {
                            cells[i11].getMessageObject().resetLayout();
                            cells[i11].requestLayout();
                        }
    ...
    public static String y0() {
        ...
        int i12 = org.telegram.ui.ActionBar.j6.f19150t;
        int i13 = i12 / 60;
    ...
    public final void A0(boolean z10) {
        ...
        int i22 = this.J0;
        int i23 = this.f31586q0;
        int i24 = this.f31599y0;
        int i25 = this.E;
        this.J0 = 0;
        this.P = -1;
        this.Q = -1;
        ...
        while (true) {
            ...
            if (i10 == 0 || i10 == 3 || ((i6Var.f18759b != null || i6Var.q()) && ((tL_theme = i6Var.F) == null || tL_theme.document != null))) {
        ...
        if (i10 == 3) {
            ...
            ArrayList arrayList3 = A02.f18760b0;
            if (arrayList3 != null && !arrayList3.isEmpty() && k10 != null && k10.f18721a >= 100) {
                int i30 = this.J0;
                this.J0 = i30 + 1;
                this.f31599y0 = i30;
            }
            ...
            this.f31580k0 = i32 + 10;
            this.f31581l0 = i32 + 11;
            this.m0 = i32 + 12;
            this.f31583n0 = i32 + 13;
            this.H0 = i32 + 14;
            this.appIconSelectorRow = i32 + 15;
            this.I0 = i32 + 16;
            this.f31591t0 = i32 + 17;
            this.f31592u0 = i32 + 18;
            this.f31593v0 = i32 + 19;
            ...
            this.J0 = i40;
            this.V = i39;
            int i41 = org.telegram.ui.ActionBar.j6.f19058o;
            if (i41 == 1) {
                this.W = i40;
                int i42 = i39 + 3;
                this.J0 = i42;
        ...
        ec1 ec1Var3 = this.f31570c;
        if (ec1Var3 != null) {
            int width = this.f31568b.getWidth();
            int i46 = ec1Var3.f20642g3;
            org.telegram.ui.Cells.pa paVar = ec1Var3.f20638c3;
            if (i46 != paVar.h()) {
                paVar.l();
                if (ec1Var3.f20641f3 == 1) {
                    A0 = org.telegram.ui.ActionBar.j6.J;
                } else {
                    A0 = org.telegram.ui.ActionBar.j6.A0();
                }
                if (ec1Var3.f20637b3 != A0) {
                    ec1Var3.y1(width);
                }
            }
        }
        hc1 hc1Var = this.f31566a;
        if (hc1Var != null) {
            if (i10 == 1 && (i15 = this.L0) != (i16 = org.telegram.ui.ActionBar.j6.f19058o) && i15 != -1) {
                int i47 = this.V;
                int i48 = i47 + 1;
                if (i15 != i16) {
                    for (int i49 = 0; i49 < 4; i49++) {
                        org.telegram.ui.Components.wk0 wk0Var = (org.telegram.ui.Components.wk0) this.f31568b.L(i49);
                        if (wk0Var != null) {
                            ...
                            if (view instanceof org.telegram.ui.Cells.ka) {
                                ...
                                if (i49 == org.telegram.ui.ActionBar.j6.f19058o) {
                                    z12 = true;
                                } else {
                                    z12 = false;
                                }
                    ...
                    int i50 = org.telegram.ui.ActionBar.j6.f19058o;
                    if (i50 == 0) {
                        this.f31566a.t(i48, i22 - i48);
                    } else if (i50 == 1) {
                        int i51 = this.L0;
                        if (i51 == 0) {
                            this.f31566a.s(i48, this.J0 - i48);
                        } else if (i51 == 2) {
                            this.f31566a.t(i48, 3);
                            hc1 hc1Var2 = this.f31566a;
                            if (org.telegram.ui.ActionBar.j6.f19076p) {
                                i21 = 4;
                            } else {
                                i21 = 5;
                    ...
                    boolean z14 = this.M0;
                    boolean z15 = org.telegram.ui.ActionBar.j6.f19076p;
                    if (z14 != z15) {
                        int i54 = i47 + 3;
                        if (z15) {
                            i17 = 3;
                ...
                if (i23 == -1 && (i14 = this.f31586q0) != -1) {
                    hc1Var.o(i14);
                } else if (i23 != -1 && this.f31586q0 == -1) {
                    hc1Var.u(i23);
                    if (i24 != -1) {
                        i24--;
                    }
                } else {
                    int i55 = this.f31586q0;
                    if (i55 != -1) {
                        hc1Var.m(i55);
                    }
                }
                if (i24 == -1 && (i13 = this.f31599y0) != -1) {
                    this.f31566a.o(i13);
                } else if (i24 != -1 && this.f31599y0 == -1) {
                    this.f31566a.u(i24);
                }
        ...
        if (i10 == 1) {
            this.M0 = org.telegram.ui.ActionBar.j6.f19076p;
            this.L0 = org.telegram.ui.ActionBar.j6.f19058o;
        }
        z0();
    }
    ...
    public final void B0(Location location, boolean z10) {
            ...
            if (getParentActivity().getPackageManager().hasSystemFeature("android.hardware.location.gps")) {
                try {
                    if (!((LocationManager) ApplicationLoader.applicationContext.getSystemService("location")).isProviderEnabled("gps")) {
                        ...
                        alertDialog$Builder.f18447a.T = LocaleController.getString("GpsDisabledAlertText", R.string.GpsDisabledAlertText);
        ...
        org.telegram.ui.ActionBar.j6.f19221x = location.getLatitude();
        org.telegram.ui.ActionBar.j6.f19239y = location.getLongitude();
        int[] calculateSunriseSunset = SunDate.calculateSunriseSunset(org.telegram.ui.ActionBar.j6.f19221x, org.telegram.ui.ActionBar.j6.f19239y);
        org.telegram.ui.ActionBar.j6.v = calculateSunriseSunset[0];
        org.telegram.ui.ActionBar.j6.f19150t = calculateSunriseSunset[1];
        org.telegram.ui.ActionBar.j6.f19204w = null;
        Calendar calendar = Calendar.getInstance();
        calendar.setTimeInMillis(System.currentTimeMillis());
        org.telegram.ui.ActionBar.j6.f19168u = calendar.get(5);
        Utilities.globalQueue.postRunnable(new ub1(this, 1));
        org.telegram.ui.Components.wk0 wk0Var = (org.telegram.ui.Components.wk0) this.f31568b.L(this.Z);
        if (wk0Var != null) {
            View view = wk0Var.f42702a;
        ...
        if (org.telegram.ui.ActionBar.j6.f19076p && org.telegram.ui.ActionBar.j6.f19058o == 1) {
            org.telegram.ui.ActionBar.j6.E(false);
        }
    }
    ...
    public final View createView(Context context) {
        ...
        if (i10 == 3) {
            ...
            this.f31589s.e(2, R.drawable.msg_share, LocaleController.getString("ShareTheme", R.string.ShareTheme));
            this.f31589s.e(3, R.drawable.msg_edit, LocaleController.getString("EditThemeColors", R.string.EditThemeColors));
            this.f31589s.e(1, R.drawable.msg_palette, LocaleController.getString("CreateNewThemeMenu", R.string.CreateNewThemeMenu));
            this.f31589s.e(4, R.drawable.msg_reset, LocaleController.getString("ThemeResetToDefaults", R.string.ThemeResetToDefaults));
        ...
        this.f31566a = new hc1(this, context);
        FrameLayout frameLayout = new FrameLayout(context);
        ...
        this.f31568b = ml0Var;
        ml0Var.q1();
        this.f31568b.setLayoutManager(new s4.c0(1, false));
        this.f31568b.setVerticalScrollBarEnabled(false);
        this.f31568b.setAdapter(this.f31566a);
        ((s4.j) this.f31568b.getItemAnimator()).C = false;
        frameLayout.addView(this.f31568b, w7.x5.c(-1.0f, -1));
        this.f31568b.setOnItemClickListener(new tv0(11, this, context));
        if (i10 == 0) {
            s4.j jVar = new s4.j();
            jVar.n(350L);
            ...
            jVar.C = false;
            jVar.f42737m = false;
            this.f31568b.setItemAnimator(jVar);
        }
        if (this.T0) {
            A0(false);
            this.T0 = false;
            this.f31568b.v0(this.f31566a.e.J0 - 1);
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.locationPermissionGranted) {
            ...
            if (i10 == NotificationCenter.webBrowserSettingsUpdate) {
                ...
                hc1 hc1Var2 = this.f31566a;
                if (hc1Var2 != null && (i14 = this.f31586q0) != -1) {
                ...
                if (i10 == NotificationCenter.themeUploadedToServer) {
                    ...
                    if (i6Var == this.h && h6Var == this.f31582n) {
                        ...
                        org.telegram.ui.ActionBar.c2 c2Var2 = this.f31587r;
                        if (c2Var2 != null) {
                            c2Var2.dismiss();
                        }
                    }
                    ...
                    if (i6Var2 == this.h && h6Var2 == this.f31582n && (c2Var = this.f31587r) == null) {
                        c2Var.dismiss();
                    }
                    ...
                    if (this.f31574f == 3) {
                        ...
                        if (this.U0 != z10) {
                            ...
                            yi0Var.P(i13);
                            this.f31589s.getIconView().d();
                        }
                        if (this.f31585p0 >= 0) {
                            for (int i16 = 0; i16 < this.f31568b.getChildCount(); i16++) {
                                if (this.f31568b.getChildAt(i16) instanceof hv) {
                                    ((hv) this.f31568b.getChildAt(i16)).b();
                                }
                            }
                        }
                    }
                } else if (i10 == NotificationCenter.emojiPreviewThemesChanged) {
                    int i17 = this.f31585p0;
                    if (i17 >= 0) {
                        this.f31566a.m(i17);
                    }
            ...
            org.telegram.ui.Components.ml0 ml0Var = this.f31568b;
            if (ml0Var != null) {
                ml0Var.g1();
            }
            z0();
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31568b, 32768, null, null, null, null, org.telegram.ui.ActionBar.j6.f19140s8));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31568b, 4096, null, null, null, null, org.telegram.ui.ActionBar.j6.f18953i6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31568b, 0, new Class[]{View.class}, org.telegram.ui.ActionBar.j6.f18985k0, null, null, org.telegram.ui.ActionBar.j6.f18864d7));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31568b, 0, new Class[]{org.telegram.ui.Cells.e9.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.B6));
        int i11 = org.telegram.ui.ActionBar.j6.G6;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31568b, 0, new Class[]{org.telegram.ui.Cells.ea.class}, new String[]{"textView"}, null, null, -1, null, i11));
        int i12 = org.telegram.ui.ActionBar.j6.I6;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31568b, 0, new Class[]{org.telegram.ui.Cells.ea.class}, new String[]{"valueTextView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31568b, 0, new Class[]{org.telegram.ui.Cells.l4.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.L6));
        int i13 = org.telegram.ui.ActionBar.j6.q6;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31568b, 0, new Class[]{org.telegram.ui.Cells.r8.class}, new String[]{"textView"}, null, null, -1, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31568b, 0, new Class[]{org.telegram.ui.Cells.r8.class}, new String[]{"imageView"}, null, null, -1, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31568b, 0, new Class[]{org.telegram.ui.Cells.w8.class}, new String[]{"textView"}, null, null, -1, null, i11));
        int i14 = org.telegram.ui.ActionBar.j6.M6;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31568b, 0, new Class[]{org.telegram.ui.Cells.w8.class}, new String[]{"checkBox"}, null, null, -1, null, i14));
        int i15 = org.telegram.ui.ActionBar.j6.N6;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31568b, 0, new Class[]{org.telegram.ui.Cells.w8.class}, new String[]{"checkBox"}, null, null, -1, null, i15));
        int i16 = org.telegram.ui.ActionBar.j6.f19028m6;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31568b, 8, new Class[]{org.telegram.ui.Cells.k0.class}, new String[]{"leftImageView"}, null, null, -1, null, i16));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31568b, 8, new Class[]{org.telegram.ui.Cells.k0.class}, new String[]{"rightImageView"}, null, null, -1, null, i16));
        int i17 = org.telegram.ui.ActionBar.j6.Ti;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31568b, 0, new Class[]{org.telegram.ui.Cells.k0.class}, new String[]{"seekBarView"}, null, null, -1, null, i17));
        int i18 = org.telegram.ui.ActionBar.j6.Vi;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31568b, 2048, new Class[]{org.telegram.ui.Cells.k0.class}, new String[]{"seekBarView"}, null, null, -1, null, i18));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31568b, 0, new Class[]{org.telegram.ui.Cells.ka.class}, new String[]{"textView"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31568b, 0, new Class[]{org.telegram.ui.Cells.ka.class}, new String[]{"checkImage"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.Mh));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31568b, 2048, new Class[]{ic1.class}, new String[]{"sizeBar"}, null, null, -1, null, i18));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31568b, 0, new Class[]{ic1.class}, new String[]{"sizeBar"}, null, null, -1, null, i17));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31568b, 2048, new Class[]{xb1.class}, new String[]{"sizeBar"}, null, null, -1, null, i18));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31568b, 0, new Class[]{xb1.class}, new String[]{"sizeBar"}, null, null, -1, null, i17));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31568b, 0, new Class[]{dc1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f18918g7));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31568b, 0, new Class[]{dc1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f18936h7));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31568b, 0, new Class[]{org.telegram.ui.Cells.i5.class}, new String[]{"textView"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31568b, 0, new Class[]{org.telegram.ui.Cells.i5.class}, new String[]{"valueTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f19264z6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31568b, 0, new Class[]{org.telegram.ui.Cells.i5.class}, new String[]{"checkBox"}, null, null, -1, null, i14));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31568b, 0, new Class[]{org.telegram.ui.Cells.i5.class}, new String[]{"checkBox"}, null, null, -1, null, i15));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31568b, 0, new Class[]{ic1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.f19025m3, org.telegram.ui.ActionBar.j6.f19098q3}, null, org.telegram.ui.ActionBar.j6.f19123ra));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31568b, 0, new Class[]{ic1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.f19045n3, org.telegram.ui.ActionBar.j6.f19116r3}, null, org.telegram.ui.ActionBar.j6.f18869dc));
        Drawable[] drawableArr = org.telegram.ui.ActionBar.j6.f19025m3.f18695y;
        int i19 = org.telegram.ui.ActionBar.j6.ta;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31568b, 0, new Class[]{ic1.class}, null, drawableArr, null, i19));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31568b, 0, new Class[]{ic1.class}, null, org.telegram.ui.ActionBar.j6.f19098q3.f18695y, null, i19));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31568b, 0, new Class[]{ic1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.f19062o3, org.telegram.ui.ActionBar.j6.f19135s3}, null, org.telegram.ui.ActionBar.j6.Aa));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31568b, 0, new Class[]{ic1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.f19062o3, org.telegram.ui.ActionBar.j6.f19135s3}, null, org.telegram.ui.ActionBar.j6.Da));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31568b, 0, new Class[]{ic1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.f19062o3, org.telegram.ui.ActionBar.j6.f19135s3}, null, org.telegram.ui.ActionBar.j6.Ea));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31568b, 0, new Class[]{ic1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.f19062o3, org.telegram.ui.ActionBar.j6.f19135s3}, null, org.telegram.ui.ActionBar.j6.Fa));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31568b, 0, new Class[]{ic1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.f19080p3, org.telegram.ui.ActionBar.j6.f19154t3}, null, org.telegram.ui.ActionBar.j6.Ba));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31568b, 0, new Class[]{ic1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.f19062o3, org.telegram.ui.ActionBar.j6.f19135s3}, null, org.telegram.ui.ActionBar.j6.Ca));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31568b, 0, new Class[]{ic1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.f19025m3, org.telegram.ui.ActionBar.j6.f19098q3}, null, i19));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31568b, 0, new Class[]{ic1.class}, null, null, null, org.telegram.ui.ActionBar.j6.ec));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31568b, 0, new Class[]{ic1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f18904fc));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31568b, 0, new Class[]{ic1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.y3}, null, org.telegram.ui.ActionBar.j6.Ja));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31568b, 0, new Class[]{ic1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.f19261z3}, null, org.telegram.ui.ActionBar.j6.Ka));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31568b, 0, new Class[]{ic1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.A3, org.telegram.ui.ActionBar.j6.C3}, null, org.telegram.ui.ActionBar.j6.La));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31568b, 0, new Class[]{ic1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.B3, org.telegram.ui.ActionBar.j6.D3}, null, org.telegram.ui.ActionBar.j6.Ma));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31568b, 0, new Class[]{ic1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.F3, org.telegram.ui.ActionBar.j6.G3}, null, org.telegram.ui.ActionBar.j6.f19144sc));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31568b, 0, new Class[]{ic1.class}, null, null, null, org.telegram.ui.ActionBar.j6.Uc));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31568b, 0, new Class[]{ic1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f18811ab));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31568b, 0, new Class[]{ic1.class}, null, null, null, org.telegram.ui.ActionBar.j6.Wc));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31568b, 0, new Class[]{ic1.class}, null, null, null, org.telegram.ui.ActionBar.j6.cb));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31568b, 0, new Class[]{ic1.class}, null, null, null, org.telegram.ui.ActionBar.j6.Yc));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31568b, 0, new Class[]{ic1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f18868db));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31568b, 0, new Class[]{ic1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f18813ad));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31568b, 0, new Class[]{ic1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f18903fb));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31568b, 0, new Class[]{ic1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19053nd));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31568b, 0, new Class[]{ic1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19143sb));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31568b, 0, new Class[]{ic1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19071od));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31568b, 0, new Class[]{ic1.class}, null, null, null, org.telegram.ui.ActionBar.j6.nb));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31568b, 0, new Class[]{org.telegram.ui.Cells.t.class}, null, null, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31568b, 0, new Class[]{org.telegram.ui.Cells.t.class}, null, null, null, i11));
        int i20 = org.telegram.ui.ActionBar.j6.H6;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31568b, 0, new Class[]{org.telegram.ui.Cells.t.class}, null, null, null, i20));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31568b, 0, new Class[]{org.telegram.ui.Cells.t.class}, null, null, null, i12));
    ...
    public final void w0() {
        ...
        AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(getParentActivity());
        alertDialog$Builder.f18447a.R = LocaleController.getString("NewTheme", R.string.NewTheme);
        alertDialog$Builder.f18447a.T = LocaleController.getString("CreateNewThemeAlert", R.string.CreateNewThemeAlert);
        alertDialog$Builder.h(LocaleController.getString("Cancel", R.string.Cancel), null);
    ...
    public final void z0() {
        ...
        ArrayList arrayList = A0.f18760b0;
        if (arrayList != null && !arrayList.isEmpty() && k10 != null && k10.f18721a >= 100) {
            this.f31589s.K(2);
            this.f31589s.K(3);
        } else {
            this.f31589s.r(2);
        ...
        org.telegram.ui.ActionBar.i6 A02 = org.telegram.ui.ActionBar.j6.A0();
        if (SharedConfig.fontSize == i10 && SharedConfig.bubbleRadius == 17 && A02.S && A02.Y == org.telegram.ui.ActionBar.j6.f19041n && (k10 == null || (c6Var = k10.f18741y) == null || "d".equals(c6Var.f18540c))) {
            this.f31589s.r(4);
        } else {
            this.f31589s.K(4);
        }
