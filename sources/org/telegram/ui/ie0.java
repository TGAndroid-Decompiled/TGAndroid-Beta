...
public final class ie0 implements RequestDelegate {
    ...
    public final pe0 f37644b;
    public final TLRPC.TL_auth_signIn f37645c;

    public ie0(pe0 pe0Var, TLRPC.TL_auth_signIn tL_auth_signIn, int i10) {
        this.f37643a = i10;
        this.f37644b = pe0Var;
        this.f37645c = tL_auth_signIn;
    }
    ...
    public final void run(final TLObject tLObject, final TLRPC.TL_error tL_error) {
        switch (this.f37643a) {
            case 0:
                final pe0 pe0Var = this.f37644b;
                final TLRPC.TL_auth_signIn tL_auth_signIn = this.f37645c;
                AndroidUtilities.runOnUIThread(new Runnable() {
                    ...
                    public final void run() {
                        ...
                        switch (r5) {
                            case 0:
                                pe0 pe0Var2 = pe0Var;
                                int i11 = pe0Var2.f39986a;
                                lg.f fVar = pe0Var2.f39988c;
                ...
                return;
            default:
                final pe0 pe0Var2 = this.f37644b;
                final TLRPC.TL_auth_signIn tL_auth_signIn2 = this.f37645c;
                AndroidUtilities.runOnUIThread(new Runnable() {
                    @Override
                    public final void run() {
                        int i10;
                        switch (r5) {
                            case 0:
                                ...
                                int i11 = pe0Var22.f39986a;
                                lg.f fVar = pe0Var22.f39988c;
