...
public final class ie0 extends org.telegram.ui.Components.vv0 {
    ...
    public boolean V;
    public final yg0 W;
    public final fe0 f34546a;
    public final TextView f34547b;
    public final vh.o f34548c;
    public final TextView d;
    public final FrameLayout e;
    public final TextView f34549f;
    public final FrameLayout h;
    public final ai.p4 f34550n;
    public final ai.p4 f34551r;
    public final TextView f34552s;
    public final org.telegram.ui.Components.j90 v;
    public final org.telegram.ui.Components.bj0 f34553w;
    public boolean f34554x;
    public Bundle f34555y;
    ...
    public final void j() {
        if (this.f34554x) {
            ...
            AndroidUtilities.runOnUIThread(new be0(this, 8), yg0.f39887t0);
        }
    }
    ...
    public final void k(Bundle bundle) {
        ...
        this.f34555y = bundle2;
        if (bundle2 != null) {
            m(bundle2, true);
        }
        String string = bundle.getString("emailcode_code");
        if (string != null) {
            this.f34546a.setText(string);
        }
    }

    @Override
    public final void l(Bundle bundle) {
        String code = this.f34546a.getCode();
        if (code != null && code.length() != 0) {
            bundle.putString("emailcode_code", code);
        }
        Bundle bundle2 = this.f34555y;
        if (bundle2 != null) {
    ...
    public final void m(Bundle bundle, boolean z10) {
        ...
        if (bundle != null) {
            ...
            this.M = this.f34555y.getString("phoneHash");
            this.I = this.f34555y.getString("phone");
            this.J = this.f34555y.getString("ephone");
            this.N = this.f34555y.getBoolean("setup");
            this.O = this.f34555y.getInt("length");
            this.K = this.f34555y.getString("email");
            this.G = this.f34555y.getInt("resetAvailablePeriod");
            this.H = this.f34555y.getInt("resetPendingDate");
            yg0 yg0Var = this.W;
            int i12 = yg0Var.F;
            int i13 = 8;
            FrameLayout frameLayout = this.h;
            vh.o oVar = this.f34548c;
            if (i12 == 3) {
                ...
                this.f34550n.setVisibility(i10);
                if (this.H != 0) {
                    i11 = 0;
                } else {
                    i11 = 8;
                }
                this.f34551r.setVisibility(i11);
                if (this.H != 0) {
                    r();
                }
            }
            ...
            if (!this.N && yg0Var.F != 3) {
                String string = this.f34555y.getString("emailPattern");
            ...
            yg0.T0(yg0Var, fe0Var.f33753f[0]);
            fe0Var.requestFocus();
    ...
    @Override
    public final void n() {
        this.f34547b.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.G6, false));
        int i10 = org.telegram.ui.ActionBar.j6.D6;
        this.f34548c.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i10, false));
        int i11 = org.telegram.ui.ActionBar.j6.q6;
        this.d.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i11, false));
        this.v.a();
        this.f34549f.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i11, false));
        this.f34550n.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i11, false));
        this.f34551r.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i10, false));
        this.f34552s.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19101q7, false));
        this.f34546a.invalidate();
    }
    ...
    public final void q(boolean z10) {
        boolean z11;
        float f7;
        AndroidUtilities.updateViewVisibilityAnimated(this.f34549f, z10);
