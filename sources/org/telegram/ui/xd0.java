...
public final class xd0 implements RequestDelegate {
    ...
    public final ge0 f39587b;
    public final Bundle f39588c;
    ...
    public final void run(final TLObject tLObject, final TLRPC.TL_error tL_error) {
        switch (this.f39586a) {
            case 0:
                final ge0 ge0Var = this.f39587b;
                final Bundle bundle = this.f39588c;
                                ...
                                if (wg0Var.getParentActivity() != null) {
                                    ...
                                    if (tLObject2 instanceof TLRPC.TL_auth_sentCode) {
                                        ...
                                        if (str.contains("TASK_ALREADY_EXISTS")) {
                                            ...
                                            org.telegram.ui.Components.c5.f0(i10, tL_error2, wg0Var, tL_auth_resetLoginEmail2, new Object[0]);
                                            return;
                                        } else {
                            ...
                            default:
                                ...
                                if (tLObject2 instanceof TLRPC.TL_auth_sentCode) {
                                    ...
                                    if (auth_sentcodetype instanceof TLRPC.TL_auth_sentCodeTypeEmailCode) {
                                        auth_sentcodetype.email_pattern = ge0Var2.f33885y.getString("emailPattern");
                                        ge0Var2.f33884x = true;
                                    }
                                    ...
                                    if (!str2.contains("PHONE_CODE_EXPIRED")) {
                                        ...
                                        org.telegram.ui.Components.c5.f0(i11, tL_error2, wg0Var2, tL_auth_resetLoginEmail2, new Object[0]);
                                        return;
                                    }
                ...
                return;
            default:
                final ge0 ge0Var2 = this.f39587b;
                final Bundle bundle2 = this.f39588c;
                        ...
                        switch (i12) {
                                ...
                                if (wg0Var.getParentActivity() != null) {
                                    ...
                                    if (tLObject2 instanceof TLRPC.TL_auth_sentCode) {
                                        ...
                                        if (str.contains("TASK_ALREADY_EXISTS")) {
                                            ...
                                            i10 = ((org.telegram.ui.ActionBar.n2) wg0Var).currentAccount;
                                            org.telegram.ui.Components.c5.f0(i10, tL_error2, wg0Var, tL_auth_resetLoginEmail22, new Object[0]);
                                            return;
                                        } else {
                                            wg0Var.u1(0, true, null, true);
                                            wg0Var.l1(LocaleController.getString(R.string.RestorePasswordNoEmailTitle), LocaleController.getString("CodeExpired", R.string.CodeExpired));
                            ...
                            default:
                                ...
                                if (tLObject2 instanceof TLRPC.TL_auth_sentCode) {
                                    ...
                                    TLRPC.auth_SentCodeType auth_sentcodetype = tL_auth_sentCode.type;
                                    if (auth_sentcodetype instanceof TLRPC.TL_auth_sentCodeTypeEmailCode) {
                                        auth_sentcodetype.email_pattern = ge0Var22.f33885y.getString("emailPattern");
                                        ge0Var22.f33884x = true;
                                    }
                                    ...
                                    if (!str2.contains("PHONE_CODE_EXPIRED")) {
                                        i11 = ((org.telegram.ui.ActionBar.n2) wg0Var2).currentAccount;
                                        org.telegram.ui.Components.c5.f0(i11, tL_error2, wg0Var2, tL_auth_resetLoginEmail22, new Object[0]);
                                        return;
                                    }
                                    wg0Var2.u1(0, true, null, true);
                                    wg0Var2.l1(LocaleController.getString(R.string.RestorePasswordNoEmailTitle), LocaleController.getString("CodeExpired", R.string.CodeExpired));
