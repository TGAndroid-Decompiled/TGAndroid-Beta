...
public final class xd0 implements RequestDelegate {
    ...
    public final void run(final TLObject tLObject, final TLRPC.TL_error tL_error) {
        switch (this.f39595a) {
            case 0:
                final ge0 ge0Var = this.f39596b;
                final Bundle bundle = this.f39597c;
                            ...
                            default:
                                ...
                                if (tLObject2 instanceof TLRPC.TL_auth_sentCode) {
                                    ...
                                    if (auth_sentcodetype instanceof TLRPC.TL_auth_sentCodeTypeEmailCode) {
                                        auth_sentcodetype.email_pattern = ge0Var2.f33836y.getString("emailPattern");
                                        ge0Var2.f33835x = true;
                                    }
                ...
                return;
            default:
                final ge0 ge0Var2 = this.f39596b;
                final Bundle bundle2 = this.f39597c;
                        ...
                        switch (i12) {
                            ...
                            default:
                                ...
                                if (tLObject2 instanceof TLRPC.TL_auth_sentCode) {
                                    ...
                                    TLRPC.auth_SentCodeType auth_sentcodetype = tL_auth_sentCode.type;
                                    if (auth_sentcodetype instanceof TLRPC.TL_auth_sentCodeTypeEmailCode) {
                                        auth_sentcodetype.email_pattern = ge0Var22.f33836y.getString("emailPattern");
                                        ge0Var22.f33835x = true;
                                    }
