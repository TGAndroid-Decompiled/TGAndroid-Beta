...
public final class u71 extends FrameLayout {
    public final ImageView f38701a;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.e) {
            canvas.drawRect(AndroidUtilities.dp(64.0f), getMeasuredHeight() - 1, getMeasuredWidth(), getMeasuredHeight(), org.telegram.ui.ActionBar.j6.f20000k0);
        }
    }
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (r02 != null) {
            ...
            sb.append((Object) this.f38702b.getText());
            sb.append("\n");
            sb.append((Object) this.f38703c.getText());
            sb.append("\n");
            if (r02.h) {
