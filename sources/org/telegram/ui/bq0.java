...
public final class bq0 extends org.telegram.ui.Components.ll0 {
    public final Context f32161c;
    public final dq0 d;

    public bq0(dq0 dq0Var, Context context) {
        this.d = dq0Var;
        this.f32161c = context;
    }
    ...
    public final int h() {
        ...
        if (arrayList != null) {
            return (int) Math.ceil(arrayList.size() / dq0Var.f32698f);
        }
        return 0;
    }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        org.telegram.ui.Cells.y5 y5Var = (org.telegram.ui.Cells.y5) c1Var.f42627a;
        dq0 dq0Var = this.d;
        y5Var.setAlbumsCount(dq0Var.f32698f);
        int i11 = 0;
        while (true) {
            int i12 = dq0Var.f32698f;
            if (i11 < i12) {
                int i13 = (i12 * i10) + i11;
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        Context context = this.f32161c;
        ?? frameLayout = new FrameLayout(context);
        frameLayout.e = new Paint();
        frameLayout.f21634b = new MediaController.AlbumEntry[4];
        frameLayout.f21633a = new org.telegram.ui.Cells.w5[4];
        for (int i11 = 0; i11 < 4; i11++) {
            frameLayout.f21633a[i11] = new org.telegram.ui.Cells.w5(frameLayout, context);
        ...
        frameLayout.setDelegate(new nl0(this, 1));
