...
public final class s9 extends TextView {
    public final int f40378a = 0;
    public final Paint f40379b;
    public Path f40380c;
    public Object d;
    public final Object f40381e;

    public s9(org.telegram.ui.Components.hn0 hn0Var, Context context) {
        super(context);
        this.f40381e = hn0Var;
        this.f40380c = new Path();
        this.d = new RectF();
        this.f40379b = new Paint();
    }
    ...
    public void dispatchDraw(Canvas canvas) {
        switch (this.f40378a) {
            case 1:
                int l1 = org.telegram.ui.ActionBar.j6.l1(0.15f, org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20889o6, ((org.telegram.ui.Components.hn0) this.f40381e).f26791c));
                Paint paint = this.f40379b;
                paint.setColor(l1);
                RectF rectF = (RectF) this.d;
                rectF.set(0.0f, 0.0f, getWidth(), getHeight());
                Path path = this.f40380c;
    ...
    public void onDraw(Canvas canvas) {
        switch (this.f40378a) {
            case 0:
                org.telegram.ui.Components.x80 x80Var = (org.telegram.ui.Components.x80) this.f40380c;
                if (x80Var != null) {
                    canvas.drawPath(x80Var, this.f40379b);
                }
                if (((org.telegram.ui.Components.a90) this.f40381e).f(canvas)) {
                    invalidate();
                }
                super.onDraw(canvas);
                return;
    ...
    public void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        switch (this.f40378a) {
            case 1:
                org.telegram.ui.Components.hn0 hn0Var = (org.telegram.ui.Components.hn0) this.f40381e;
                ...
                if (getText() instanceof Spanned) {
                    ...
                    if (l51VarArr != null && l51VarArr.length > 0) {
                        ...
                        for (int i14 = 0; i14 < l51VarArr.length; i14++) {
                            ...
                            ((org.telegram.ui.Components.x80) this.f40380c).d(getLayout(), spanStart, 0.0f);
                            if (getText() != null) {
                                i12 = getPaint().baselineShift;
                            } else {
                                i12 = 0;
                            }
                            org.telegram.ui.Components.x80 x80Var2 = (org.telegram.ui.Components.x80) this.f40380c;
                            if (i12 != 0) {
                                if (i12 > 0) {
                                    f7 = 5.0f;
                                } else {
                            ...
                            x80Var2.f32485o = i13;
                            getLayout().getSelectionPath(spanStart, spanEnd, (org.telegram.ui.Components.x80) this.f40380c);
                        }
                        ((org.telegram.ui.Components.x80) this.f40380c).f32484n = true;
                        return;
                    }
                    return;
                }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        switch (this.f40378a) {
            case 0:
                org.telegram.ui.Components.a90 a90Var = (org.telegram.ui.Components.a90) this.f40381e;
                    ...
                    if (lineLeft <= f10 && layout.getLineWidth(lineForVertical) + lineLeft >= f10 && y3 >= 0 && y3 <= layout.getHeight()) {
                        ...
                        if (clickableSpanArr.length != 0) {
                            ...
                            if (motionEvent.getAction() == 0) {
                                ...
                                int spanStart = spannable.getSpanStart(((org.telegram.ui.Components.e90) this.d).f25650i);
                                int spanEnd = spannable.getSpanEnd(((org.telegram.ui.Components.e90) this.d).f25650i);
                                ...
                                if (e90Var2 != null) {
                                    CharacterStyle characterStyle = e90Var2.f25650i;
    ...
    public s9(Context context, Paint paint) {
        super(context);
        this.f40379b = paint;
        this.f40381e = new org.telegram.ui.Components.a90(this);
    }
}
