...
public final class s9 extends ViewGroup {
    public final int f38218a = 1;
    public final Object f38219b;
    public final org.telegram.ui.ActionBar.p2 f38220c;

    public s9(v9 v9Var, Context context) {
        super(context);
        this.f38220c = v9Var;
        this.f38219b = new Path();
    }
    ...
    public boolean drawChild(Canvas canvas, View view, long j10) {
        switch (this.f38218a) {
            case 0:
                Path path = (Path) this.f38219b;
                boolean drawChild = super.drawChild(canvas, view, j10);
                v9 v9Var = (v9) this.f38220c;
                Paint paint = v9Var.f39113n;
                Paint paint2 = v9Var.h;
                if (v9Var.a0() && view == v9Var.f39111c) {
                    ...
                    paint2.setAlpha((int) (Math.max(0.0f, 1.0f - v9Var.f39118y) * 255.0f));
                    canvas.drawRect(f14, f12, f15, f13, paint2);
                    int lerp = AndroidUtilities.lerp(0, AndroidUtilities.dp(4.0f), Math.min(1.0f, v9Var.f39118y * 20.0f));
                    int i15 = lerp / 2;
                    int lerp2 = AndroidUtilities.lerp(Math.min(i10, i11), AndroidUtilities.dp(20.0f), Math.min(1.2f, (float) Math.pow(v9Var.f39118y, 1.7999999523162842d)));
                    paint.setAlpha((int) (Math.min(1.0f, v9Var.f39118y) * 255.0f));
                    path.reset();
        ...
        switch (this.f38218a) {
            case 0:
                ...
                if (i16 != 0) {
                    ...
                    if (cameraView != null) {
                        cameraView.layout(0, 0, cameraView.getMeasuredWidth(), v9Var.f39111c.getMeasuredHeight());
                    }
                    int min = (int) (Math.min(i14, i15) / 1.5f);
                    if (i16 == 1) {
                        measuredHeight = ((i15 - min) / 2) - v9Var.f39107a.getMeasuredHeight();
                    ...
                    v9Var.f39107a.layout(AndroidUtilities.dp(36.0f), i17, v9Var.f39107a.getMeasuredWidth() + AndroidUtilities.dp(36.0f), v9Var.f39107a.getMeasuredHeight() + i17);
                    if (i16 == 3) {
                        int C = org.telegram.messenger.y3.C(8.0f, v9Var.f39107a.getMeasuredHeight(), i17);
                        v9Var.f39109b.layout(AndroidUtilities.dp(36.0f), C, v9Var.f39109b.getMeasuredWidth() + AndroidUtilities.dp(36.0f), v9Var.f39109b.getMeasuredHeight() + C);
                    }
                    v9Var.f39112f.layout(0, getMeasuredHeight() - v9Var.f39112f.getMeasuredHeight(), getMeasuredWidth(), getMeasuredHeight());
                    int measuredWidth2 = (i14 / 2) - (v9Var.f39114r.getMeasuredWidth() / 2);
                    int dp2 = AndroidUtilities.dp(80.0f) + kh.a2.d(i15, min, 2, min);
                    ImageView imageView = v9Var.f39114r;
                    imageView.layout(measuredWidth2, dp2, imageView.getMeasuredWidth() + measuredWidth2, v9Var.f39114r.getMeasuredHeight() + dp2);
                } else {
                    CameraView cameraView2 = v9Var.f39111c;
                    if (cameraView2 != null) {
                        cameraView2.layout(0, 0, cameraView2.getMeasuredWidth(), v9Var.f39111c.getMeasuredHeight());
                    }
                    v9Var.f39112f.setTextSize(0, i15 / 22);
                    v9Var.f39112f.setPadding(0, 0, 0, i15 / 15);
                    int i18 = (int) (i15 * 0.65f);
                    v9Var.f39107a.layout(AndroidUtilities.dp(36.0f), i18, v9Var.f39107a.getMeasuredWidth() + AndroidUtilities.dp(36.0f), v9Var.f39107a.getMeasuredHeight() + i18);
                }
                if (i16 != 3) {
                    int i19 = (int) (i15 * 0.74f);
                    int i20 = (int) (i14 * 0.05f);
                    TextView textView = v9Var.f39109b;
                    textView.layout(i20, i19, textView.getMeasuredWidth() + i20, v9Var.f39109b.getMeasuredHeight() + i19);
                }
                v9Var.h0();
                return;
            default:
                og1 og1Var = (og1) this.f38220c;
                ...
                i0Var.layout(0, 0, i0Var.getMeasuredWidth(), og1Var.f36909y.getMeasuredHeight());
                org.telegram.ui.Components.x90 x90Var = (org.telegram.ui.Components.x90) this.f38219b;
        ...
        switch (this.f38218a) {
            case 0:
                ...
                if (i12 == 0) {
                    ...
                    v9Var.f39112f.measure(View.MeasureSpec.makeMeasureSpec(size, 1073741824), View.MeasureSpec.makeMeasureSpec(size2, 0));
                    v9Var.f39114r.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(60.0f), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(60.0f), 1073741824));
                }
                v9Var.f39107a.measure(b.d(72.0f, size, 1073741824), View.MeasureSpec.makeMeasureSpec(size2, 0));
                if (i12 == 3) {
                    v9Var.f39109b.measure(b.d(72.0f, size, 1073741824), View.MeasureSpec.makeMeasureSpec(size2, 0));
                } else {
                    v9Var.f39109b.measure(View.MeasureSpec.makeMeasureSpec((int) (size * 0.9f), 1073741824), View.MeasureSpec.makeMeasureSpec(size2, 0));
                }
            ...
            default:
                ...
                ((org.telegram.ui.Components.x90) this.f38219b).measure(View.MeasureSpec.makeMeasureSpec(size3, 1073741824), i11);
