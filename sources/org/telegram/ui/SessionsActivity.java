...
public class SessionsActivity extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public q81 f31493a;
    public q60 f31494b;
    public org.telegram.ui.Components.mz f31495c;
    public org.telegram.ui.Components.t00 d;
    public final ArrayList e;
    public final ArrayList f31496f;
    public ArrayList h;
    public TLRPC.TL_authorization f31497n;
    ...
    public static void U(SessionsActivity sessionsActivity, int i10) {
        ...
        int i16 = sessionsActivity.f31500w;
        float f7 = 4.0f;
        boolean z13 = true;
        if (i10 == sessionsActivity.ttlRow) {
            if (sessionsActivity.getParentActivity() != null) {
                ...
                while (i18 < 4) {
                    ...
                    l6Var.setOnClickListener(new wy0(4, sessionsActivity, alertDialog$Builder));
                    i18++;
                    f7 = 4.0f;
                }
            ...
            if (sessionsActivity.getParentActivity() != null) {
                ...
                alertDialog$Builder2.k(string, new l81(sessionsActivity, 1));
            ...
            if (sessionsActivity.getParentActivity() != null && (arrayList = sessionsActivity.h) != null && !arrayList.isEmpty()) {
                ...
                new hg.m0(sessionsActivity.getParentActivity(), (TL_account.TL_connectedBot) sessionsActivity.h.get(i20), new org.telegram.ui.Components.id(sessionsActivity, i20, 27), sessionsActivity.resourceProvider).show();
            }
        } else if (((i10 >= sessionsActivity.K && i10 < sessionsActivity.L) || ((i10 >= sessionsActivity.G && i10 < sessionsActivity.H) || i10 == sessionsActivity.f31502y)) && sessionsActivity.getParentActivity() != null) {
            if (i16 == 0) {
                if (i10 == sessionsActivity.f31502y) {
                    tL_authorization = sessionsActivity.f31497n;
                    z10 = true;
                } else {
                    ...
                    if (i10 >= i21 && i10 < sessionsActivity.L) {
                        ...
                        tL_authorization = (TLRPC.TL_authorization) sessionsActivity.f31496f.get(i10 - sessionsActivity.G);
                    }
                    z10 = false;
                }
                if (tL_authorization != null) {
                    ...
                    f3Var.f33226b = tL_authorization;
                    f3Var.f33227c = sessionsActivity;
                    ...
                    f3Var.d = imageView;
                    imageView.setOnClickListener(new v71(f3Var));
                    ...
                    textView3.setTextColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f19215y6, false));
                    ...
                    d81Var.f32980b.setText(sb3);
                    Drawable mutate = parentActivity.getDrawable(R.drawable.menu_devices).mutate();
                    int i22 = org.telegram.ui.ActionBar.i6.f18998m6;
                    int w02 = org.telegram.ui.ActionBar.i6.w0(null, i22, false);
                    PorterDuff.Mode mode = PorterDuff.Mode.SRC_IN;
                    mutate.setColorFilter(new PorterDuffColorFilter(w02, mode));
                    d81Var.f32979a.setImageDrawable(mutate);
                    d81Var.f32981c.setText(LocaleController.getString(R.string.Application));
                    linearLayout2.addView(d81Var);
                    if (tL_authorization.country.length() != 0) {
                        d81 d81Var2 = new d81(parentActivity, false);
                        d81Var2.f32980b.setText(tL_authorization.country);
                        ...
                        d81Var2.f32979a.setImageDrawable(mutate2);
                        d81Var2.f32981c.setText(LocaleController.getString(R.string.Location));
                        d81Var2.setOnClickListener(new w71(f3Var, tL_authorization));
                        d81Var2.setOnLongClickListener(new x71(f3Var, tL_authorization));
                        d81Var2.setBackground(org.telegram.ui.ActionBar.i6.f0(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18923i6, false), 2, -1));
                        linearLayout2.addView(d81Var2);
                        d81Var.e = true;
                        d81Var = d81Var2;
                    }
                    if (tL_authorization.ip.length() != 0) {
                        d81 d81Var3 = new d81(parentActivity, false);
                        d81Var3.f32980b.setText(tL_authorization.ip);
                        ...
                        d81Var3.f32979a.setImageDrawable(mutate3);
                        d81Var3.f32981c.setText(LocaleController.getString(R.string.IpAddress));
                        d81Var3.setOnClickListener(new y71(f3Var, tL_authorization));
                        d81Var3.setOnLongClickListener(new z71(f3Var, tL_authorization));
                        d81Var3.setBackground(org.telegram.ui.ActionBar.i6.f0(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18923i6, false), 2, -1));
                        linearLayout2.addView(d81Var3);
                        z11 = true;
                        d81Var.e = true;
                        d81Var = d81Var3;
                    } else {
                    ...
                    if (i23 != 2040 && i23 != 2496) {
                        ...
                        d81Var4.f32980b.setText(LocaleController.getString(R.string.AcceptSecretChats));
                        ...
                        d81Var4.f32979a.setImageDrawable(mutate4);
                        d81Var4.d.c(!tL_authorization.encrypted_requests_disabled, false);
                        d81Var4.setBackground(org.telegram.ui.ActionBar.i6.f0(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18923i6, false), 7, -1));
                        d81Var4.setOnClickListener(new a81(f3Var, d81Var4, tL_authorization));
                        d81Var.e = true;
                        d81Var4.f32981c.setText(LocaleController.getString(R.string.AcceptSecretChatsDescription));
                        linearLayout2.addView(d81Var4);
                        d81Var = d81Var4;
                    }
                    if (tL_authorization.api_id != 22) {
                        d81 d81Var5 = new d81(parentActivity, true);
                        d81Var5.f32980b.setText(LocaleController.getString(R.string.AcceptCalls));
                        ...
                        d81Var5.f32979a.setImageDrawable(mutate5);
                        d81Var5.d.c(!tL_authorization.call_requests_disabled, false);
                        d81Var5.setBackground(org.telegram.ui.ActionBar.i6.f0(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18923i6, false), 7, -1));
                        d81Var5.setOnClickListener(new b81(f3Var, d81Var5, tL_authorization));
                        d81Var.e = true;
                        d81Var5.f32981c.setText(LocaleController.getString(R.string.AcceptCallsChatsDescription));
                        linearLayout2.addView(d81Var5);
                    }
                    if (!z10) {
                        ...
                        int w03 = org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18965ka, false);
                        ...
                        textView4.setOnClickListener(new c81(f3Var, n81Var, tL_authorization, sessionsActivity));
                    }
            ...
            if (textView5 != null) {
                textView5.setTextColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f19071q7, false));
            }
        }
    }
    ...
    public static void Y(SessionsActivity sessionsActivity, TLRPC.TL_error tL_error, TLObject tLObject, boolean z10) {
        ArrayList arrayList = sessionsActivity.e;
        sessionsActivity.f31498r = false;
        if (tL_error == null) {
            arrayList.clear();
    ...
    public final View createView(Context context) {
        ...
        this.f31493a = new q81(this, context);
        ...
        this.f31495c = mzVar;
        mzVar.b();
        frameLayout.addView(this.f31495c, w7.x5.e(-1, -1, 17));
        q60 q60Var = new q60(this, context);
        this.f31494b = q60Var;
        q60Var.p1();
        this.actionBar.setAdaptiveBackground(this.f31494b);
        this.f31494b.setLayoutManager(new gg.b0(1, false, 18));
        this.f31494b.setVerticalScrollBarEnabled(false);
        this.f31494b.setEmptyView(this.f31495c);
        q60 q60Var2 = this.f31494b;
        q60Var2.Y1 = true;
        q60Var2.Z1 = 0;
        frameLayout.addView(q60Var2, w7.x5.c(-1.0f, -1));
        this.f31494b.setAdapter(this.f31493a);
        s4.j jVar = new s4.j();
        jVar.n(150L);
        org.telegram.ui.Components.qr qrVar = org.telegram.ui.Components.qr.f27420f;
        jVar.f42755i = qrVar;
        jVar.f42728o = qrVar;
        this.f31494b.setItemAnimator(jVar);
        this.f31494b.setOnItemClickListener(new a31(this, 5));
        if (i10 == 0) {
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f31494b, 16, new Class[]{org.telegram.ui.Cells.ea.class, org.telegram.ui.Cells.m4.class, org.telegram.ui.Cells.u6.class}, null, null, null, org.telegram.ui.ActionBar.i6.f18834d6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f31494b, 32768, null, null, null, null, org.telegram.ui.ActionBar.i6.f19110s8));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f31494b, 4096, null, null, null, null, org.telegram.ui.ActionBar.i6.f18923i6));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f31494b, 0, new Class[]{View.class}, org.telegram.ui.ActionBar.i6.f18955k0, null, null, org.telegram.ui.ActionBar.i6.f18835d7));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f31495c, 2048, null, null, null, null, org.telegram.ui.ActionBar.i6.f18905h6));
        int i10 = org.telegram.ui.ActionBar.i6.f19053p7;
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f31494b, 262148, new Class[]{org.telegram.ui.Cells.ea.class}, new String[]{"textView"}, null, null, -1, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f31494b, 262148, new Class[]{org.telegram.ui.Cells.ea.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.i6.q6));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f31494b, 32, new Class[]{org.telegram.ui.Cells.e9.class}, null, null, null, org.telegram.ui.ActionBar.i6.f18798b7));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f31494b, 0, new Class[]{org.telegram.ui.Cells.e9.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.i6.B6));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f31494b, 0, new Class[]{org.telegram.ui.Cells.m4.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.i6.L6));
        int i11 = org.telegram.ui.ActionBar.i6.G6;
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f31494b, 0, new Class[]{org.telegram.ui.Cells.u6.class}, new String[]{"nameTextView"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f31494b, 262144, new Class[]{org.telegram.ui.Cells.u6.class}, new String[]{"onlineTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.i6.I6));
        int i12 = org.telegram.ui.ActionBar.i6.A6;
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f31494b, 262144, new Class[]{org.telegram.ui.Cells.u6.class}, new String[]{"onlineTextView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f31494b, 0, new Class[]{org.telegram.ui.Cells.u6.class}, new String[]{"detailTextView"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f31494b, 0, new Class[]{org.telegram.ui.Cells.u6.class}, new String[]{"detailExTextView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f31499s, 32, null, null, null, null, org.telegram.ui.ActionBar.i6.Fi));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f31499s, 0, new Class[]{UndoView.class}, new String[]{"undoImageView"}, null, null, -1, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f31499s, 0, new Class[]{UndoView.class}, new String[]{"undoTextView"}, null, null, -1, null, i10));
        int i13 = org.telegram.ui.ActionBar.i6.Hi;
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f31499s, 0, new Class[]{UndoView.class}, new String[]{"infoTextView"}, null, null, -1, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f31499s, 0, new Class[]{UndoView.class}, new String[]{"textPaint"}, null, null, -1, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f31499s, 0, new Class[]{UndoView.class}, new String[]{"progressPaint"}, null, null, -1, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f31499s, 8, new Class[]{UndoView.class}, new String[]{"leftImageView"}, null, null, -1, null, i13));
        return arrayList;
    }
    ...
    public final int j0() {
        ...
        int i10 = 0;
        if (arrayList.size() == 0 && this.f31498r) {
            return 0;
        }
    ...
    public final void k0(final boolean z10) {
        ...
        if (this.f31500w == 0) {
            ConnectionsManager.getInstance(this.currentAccount).bindRequestToGuid(ConnectionsManager.getInstance(this.currentAccount).sendRequest(new TL_account.getAuthorizations(), new RequestDelegate(this) {
                public final SessionsActivity f33535b;
                ...
                public final void run(final TLObject tLObject, final TLRPC.TL_error tL_error) {
                    switch (r3) {
                        case 0:
                            final SessionsActivity sessionsActivity = this.f33535b;
                                ...
                                public final void run() {
                                    switch (r5) {
                                        case 0:
                                            ...
                                            ArrayList arrayList = sessionsActivity2.f31496f;
                                            ArrayList arrayList2 = sessionsActivity2.e;
                                            sessionsActivity2.f31498r = false;
                                            if (tL_error == null) {
                                                arrayList2.clear();
                                                arrayList.clear();
                                                ...
                                                for (int i10 = 0; i10 < size; i10++) {
                                                    ...
                                                    if ((tL_authorization.flags & 1) != 0) {
                                                        sessionsActivity2.f31497n = tL_authorization;
                                            ...
                                            q81 q81Var = sessionsActivity2.f31493a;
                                            if (q81Var != null) {
                                                q81Var.l();
                                            }
                            ...
                            return;
                        default:
                            final SessionsActivity sessionsActivity2 = this.f33535b;
                                ...
                                public final void run() {
                                    switch (r5) {
                                        case 0:
                                            ...
                                            ArrayList arrayList = sessionsActivity22.f31496f;
                                            ArrayList arrayList2 = sessionsActivity22.e;
                                            sessionsActivity22.f31498r = false;
                                            if (tL_error == null) {
                                                arrayList2.clear();
                                                arrayList.clear();
                                                TL_account.authorizations authorizationsVar = (TL_account.authorizations) tLObject;
                                                ...
                                                for (int i10 = 0; i10 < size; i10++) {
                                                    TLRPC.TL_authorization tL_authorization = authorizationsVar.authorizations.get(i10);
                                                    if ((tL_authorization.flags & 1) != 0) {
                                                        sessionsActivity22.f31497n = tL_authorization;
                                                    } else if (tL_authorization.password_pending) {
                                                        arrayList.add(tL_authorization);
                                                    } else {
                                                        arrayList2.add(tL_authorization);
                                            ...
                                            q81 q81Var = sessionsActivity22.f31493a;
                                            if (q81Var != null) {
                                                q81Var.l();
                                            }
    ...
    public final void m0() {
        ...
        ArrayList arrayList = this.f31496f;
        boolean isEmpty = arrayList.isEmpty();
        ArrayList arrayList2 = this.e;
        if (isEmpty && arrayList2.isEmpty()) {
            this.terminateAllSessionsRow = -1;
            this.E = -1;
            if (i10 != 1 && this.f31497n == null) {
                this.P = -1;
            } else {
                int i14 = this.S;
                this.S = i14 + 1;
    ...
    public final void onInsets(int i10, int i11, int i12, int i13) {
        this.f31494b.setPadding(0, 0, 0, i13);
        this.f31494b.setClipToPadding(false);
        m81 m81Var = this.f31499s;
        if (m81Var != null) {
    ...
    public final void onTransitionAnimationEnd(boolean z10, boolean z11) {
        ...
        if (z10 && !z11) {
            this.X = true;
            for (int i10 = 0; i10 < this.f31494b.getChildCount(); i10++) {
                View childAt = this.f31494b.getChildAt(i10);
                if (childAt instanceof r81) {
                    ((r81) childAt).f37069b.invalidate();
                }
            }
        }
    }
