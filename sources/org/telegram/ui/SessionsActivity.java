...
public class SessionsActivity extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public p81 f31496a;
    public q60 f31497b;
    public org.telegram.ui.Components.mz f31498c;
    public org.telegram.ui.Components.t00 d;
    public final ArrayList e;
    public final ArrayList f31499f;
    public ArrayList h;
    public TLRPC.TL_authorization f31500n;
    ...
    public static void U(SessionsActivity sessionsActivity, int i10) {
        ...
        int i16 = sessionsActivity.f31503w;
        float f7 = 4.0f;
        boolean z13 = true;
        if (i10 == sessionsActivity.ttlRow) {
            if (sessionsActivity.getParentActivity() != null) {
                ...
                while (i18 < 4) {
                    ...
                    k6Var.setOnClickListener(new vy0(4, sessionsActivity, alertDialog$Builder));
                    i18++;
                    f7 = 4.0f;
                }
                    ...
                    while (i19 < size) {
                        ...
                        if (user != null) {
                            ...
                            if (!TextUtils.isEmpty(publicUsername)) {
                                ...
                                append.setSpan(new org.telegram.ui.Components.m51(org.telegram.ui.Cells.p6.i("https://t.me/", publicUsername), (org.telegram.ui.Components.o01) null), 0, append.length(), 33);
        ...
        } else if (((i10 >= sessionsActivity.K && i10 < sessionsActivity.L) || ((i10 >= sessionsActivity.G && i10 < sessionsActivity.H) || i10 == sessionsActivity.f31505y)) && sessionsActivity.getParentActivity() != null) {
            if (i16 == 0) {
                if (i10 == sessionsActivity.f31505y) {
                    tL_authorization = sessionsActivity.f31500n;
                    z10 = true;
                } else {
                    ...
                    if (i10 >= i21 && i10 < sessionsActivity.L) {
                        ...
                        tL_authorization = (TLRPC.TL_authorization) sessionsActivity.f31499f.get(i10 - sessionsActivity.G);
                    }
                    z10 = false;
                }
                if (tL_authorization != null) {
                    ...
                    f3Var.f32960b = tL_authorization;
                    f3Var.f32961c = sessionsActivity;
                    ...
                    textView3.setTextColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f19218y6, false));
                    ...
                    if (tL_authorization.country.length() != 0) {
                        ...
                        c81Var2.f32711a.setImageDrawable(mutate2);
                        c81Var2.f32713c.setText(LocaleController.getString(R.string.Location));
                        c81Var2.setOnClickListener(new v71(f3Var, tL_authorization));
                        c81Var2.setOnLongClickListener(new w71(f3Var, tL_authorization));
                        c81Var2.setBackground(org.telegram.ui.ActionBar.i6.f0(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18926i6, false), 2, -1));
                    ...
                    if (tL_authorization.ip.length() != 0) {
                        ...
                        c81Var3.f32712b.setText(tL_authorization.ip);
                        ...
                        c81Var3.f32711a.setImageDrawable(mutate3);
                        c81Var3.f32713c.setText(LocaleController.getString(R.string.IpAddress));
                        c81Var3.setOnClickListener(new x71(f3Var, tL_authorization));
                        c81Var3.setOnLongClickListener(new y71(f3Var, tL_authorization));
                        c81Var3.setBackground(org.telegram.ui.ActionBar.i6.f0(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18926i6, false), 2, -1));
                    ...
                    if (i23 != 2040 && i23 != 2496) {
                        ...
                        c81Var4.f32712b.setText(LocaleController.getString(R.string.AcceptSecretChats));
                        ...
                        c81Var4.f32711a.setImageDrawable(mutate4);
                        c81Var4.d.c(!tL_authorization.encrypted_requests_disabled, false);
                        c81Var4.setBackground(org.telegram.ui.ActionBar.i6.f0(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18926i6, false), 7, -1));
                        c81Var4.setOnClickListener(new z71(f3Var, c81Var4, tL_authorization));
                        c81Var.e = true;
                        c81Var4.f32713c.setText(LocaleController.getString(R.string.AcceptSecretChatsDescription));
                        linearLayout2.addView(c81Var4);
                        c81Var = c81Var4;
                    }
                    if (tL_authorization.api_id != 22) {
                        c81 c81Var5 = new c81(parentActivity, true);
                        c81Var5.f32712b.setText(LocaleController.getString(R.string.AcceptCalls));
                        ...
                        c81Var5.f32711a.setImageDrawable(mutate5);
                        c81Var5.d.c(!tL_authorization.call_requests_disabled, false);
                        c81Var5.setBackground(org.telegram.ui.ActionBar.i6.f0(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18926i6, false), 7, -1));
                        c81Var5.setOnClickListener(new a81(f3Var, c81Var5, tL_authorization));
                        c81Var.e = true;
                        c81Var5.f32713c.setText(LocaleController.getString(R.string.AcceptCallsChatsDescription));
                    ...
                    if (!z10) {
                        ...
                        int w03 = org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18968ka, false);
            ...
            if (textView5 != null) {
                textView5.setTextColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f19074q7, false));
            }
        }
    }
    ...
    public static void Y(SessionsActivity sessionsActivity, TLRPC.TL_error tL_error, TLObject tLObject, boolean z10) {
        ArrayList arrayList = sessionsActivity.e;
        sessionsActivity.f31501r = false;
        if (tL_error == null) {
            arrayList.clear();
    ...
    public final View createView(Context context) {
        ...
        this.f31496a = new p81(this, context);
        ...
        this.f31498c = mzVar;
        mzVar.b();
        frameLayout.addView(this.f31498c, w7.x5.e(-1, -1, 17));
        q60 q60Var = new q60(this, context);
        this.f31497b = q60Var;
        q60Var.p1();
        this.actionBar.setAdaptiveBackground(this.f31497b);
        this.f31497b.setLayoutManager(new gg.b0(1, false, 18));
        this.f31497b.setVerticalScrollBarEnabled(false);
        this.f31497b.setEmptyView(this.f31498c);
        q60 q60Var2 = this.f31497b;
        q60Var2.Y1 = true;
        q60Var2.Z1 = 0;
        ...
        jVar.f42759i = qrVar;
        jVar.f42732o = qrVar;
        this.f31497b.setItemAnimator(jVar);
        this.f31497b.setOnItemClickListener(new z21(this, 5));
        if (i10 == 0) {
            l81 l81Var = new l81(this, context);
            this.f31502s = l81Var;
            frameLayout.addView(l81Var, w7.x5.d(-1, -2.0f, 83, 8.0f, 0.0f, 8.0f, 8.0f));
        }
        m0();
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f31497b, 16, new Class[]{org.telegram.ui.Cells.ea.class, org.telegram.ui.Cells.l4.class, org.telegram.ui.Cells.u6.class}, null, null, null, org.telegram.ui.ActionBar.i6.f18836d6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f31497b, 32768, null, null, null, null, org.telegram.ui.ActionBar.i6.f19113s8));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f31497b, 4096, null, null, null, null, org.telegram.ui.ActionBar.i6.f18926i6));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f31497b, 0, new Class[]{View.class}, org.telegram.ui.ActionBar.i6.f18958k0, null, null, org.telegram.ui.ActionBar.i6.f18837d7));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f31498c, 2048, null, null, null, null, org.telegram.ui.ActionBar.i6.f18908h6));
        int i10 = org.telegram.ui.ActionBar.i6.f19056p7;
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f31497b, 262148, new Class[]{org.telegram.ui.Cells.ea.class}, new String[]{"textView"}, null, null, -1, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f31497b, 262148, new Class[]{org.telegram.ui.Cells.ea.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.i6.q6));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f31497b, 32, new Class[]{org.telegram.ui.Cells.e9.class}, null, null, null, org.telegram.ui.ActionBar.i6.f18800b7));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f31497b, 0, new Class[]{org.telegram.ui.Cells.e9.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.i6.B6));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f31497b, 0, new Class[]{org.telegram.ui.Cells.l4.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.i6.L6));
        int i11 = org.telegram.ui.ActionBar.i6.G6;
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f31497b, 0, new Class[]{org.telegram.ui.Cells.u6.class}, new String[]{"nameTextView"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f31497b, 262144, new Class[]{org.telegram.ui.Cells.u6.class}, new String[]{"onlineTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.i6.I6));
        int i12 = org.telegram.ui.ActionBar.i6.A6;
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f31497b, 262144, new Class[]{org.telegram.ui.Cells.u6.class}, new String[]{"onlineTextView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f31497b, 0, new Class[]{org.telegram.ui.Cells.u6.class}, new String[]{"detailTextView"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f31497b, 0, new Class[]{org.telegram.ui.Cells.u6.class}, new String[]{"detailExTextView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f31502s, 32, null, null, null, null, org.telegram.ui.ActionBar.i6.Fi));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f31502s, 0, new Class[]{UndoView.class}, new String[]{"undoImageView"}, null, null, -1, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f31502s, 0, new Class[]{UndoView.class}, new String[]{"undoTextView"}, null, null, -1, null, i10));
        int i13 = org.telegram.ui.ActionBar.i6.Hi;
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f31502s, 0, new Class[]{UndoView.class}, new String[]{"infoTextView"}, null, null, -1, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f31502s, 0, new Class[]{UndoView.class}, new String[]{"textPaint"}, null, null, -1, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f31502s, 0, new Class[]{UndoView.class}, new String[]{"progressPaint"}, null, null, -1, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f31502s, 8, new Class[]{UndoView.class}, new String[]{"leftImageView"}, null, null, -1, null, i13));
        return arrayList;
    }
    ...
    public final int j0() {
        ...
        int i10 = 0;
        if (arrayList.size() == 0 && this.f31501r) {
            return 0;
        }
    ...
    public final void k0(final boolean z10) {
        ...
        if (this.f31503w == 0) {
            ConnectionsManager.getInstance(this.currentAccount).bindRequestToGuid(ConnectionsManager.getInstance(this.currentAccount).sendRequest(new TL_account.getAuthorizations(), new RequestDelegate(this) {
                public final SessionsActivity f33273b;
                ...
                public final void run(final TLObject tLObject, final TLRPC.TL_error tL_error) {
                    switch (r3) {
                        case 0:
                            final SessionsActivity sessionsActivity = this.f33273b;
                                ...
                                public final void run() {
                                    switch (r5) {
                                        case 0:
                                            ...
                                            ArrayList arrayList = sessionsActivity2.f31499f;
                                            ArrayList arrayList2 = sessionsActivity2.e;
                                            sessionsActivity2.f31501r = false;
                                            if (tL_error == null) {
                                                arrayList2.clear();
                                                arrayList.clear();
                                                ...
                                                for (int i10 = 0; i10 < size; i10++) {
                                                    ...
                                                    if ((tL_authorization.flags & 1) != 0) {
                                                        sessionsActivity2.f31500n = tL_authorization;
                                            ...
                                            p81 p81Var = sessionsActivity2.f31496a;
                                            if (p81Var != null) {
                                                p81Var.l();
                                            }
                            ...
                            return;
                        default:
                            final SessionsActivity sessionsActivity2 = this.f33273b;
                                ...
                                public final void run() {
                                    switch (r5) {
                                        case 0:
                                            ...
                                            ArrayList arrayList = sessionsActivity22.f31499f;
                                            ArrayList arrayList2 = sessionsActivity22.e;
                                            sessionsActivity22.f31501r = false;
                                            if (tL_error == null) {
                                                arrayList2.clear();
                                                arrayList.clear();
                                                TL_account.authorizations authorizationsVar = (TL_account.authorizations) tLObject;
                                                ...
                                                for (int i10 = 0; i10 < size; i10++) {
                                                    TLRPC.TL_authorization tL_authorization = authorizationsVar.authorizations.get(i10);
                                                    if ((tL_authorization.flags & 1) != 0) {
                                                        sessionsActivity22.f31500n = tL_authorization;
                                                    } else if (tL_authorization.password_pending) {
                                                        arrayList.add(tL_authorization);
                                                    } else {
                                                        arrayList2.add(tL_authorization);
                                            ...
                                            p81 p81Var = sessionsActivity22.f31496a;
                                            if (p81Var != null) {
                                                p81Var.l();
                                            }
    ...
    public final void m0() {
        ...
        ArrayList arrayList = this.f31499f;
        boolean isEmpty = arrayList.isEmpty();
        ArrayList arrayList2 = this.e;
        if (isEmpty && arrayList2.isEmpty()) {
            this.terminateAllSessionsRow = -1;
            this.E = -1;
            if (i10 != 1 && this.f31500n == null) {
                this.P = -1;
            } else {
                int i14 = this.S;
                this.S = i14 + 1;
    ...
    public final void onInsets(int i10, int i11, int i12, int i13) {
        this.f31497b.setPadding(0, 0, 0, i13);
        this.f31497b.setClipToPadding(false);
        l81 l81Var = this.f31502s;
        if (l81Var != null) {
    ...
    public final void onRequestPermissionsResultFragment(int i10, String[] strArr, int[] iArr) {
        if (getParentActivity() != null && i10 == 34) {
            if (iArr.length > 0 && iArr[0] == 0) {
                u9.e0(getParentActivity(), 2, new o81(this));
                return;
            }
    ...
    public final void onTransitionAnimationEnd(boolean z10, boolean z11) {
        ...
        if (z10 && !z11) {
            this.X = true;
            for (int i10 = 0; i10 < this.f31497b.getChildCount(); i10++) {
                View childAt = this.f31497b.getChildAt(i10);
                if (childAt instanceof q81) {
                    ((q81) childAt).f36803b.invalidate();
                }
            }
        }
    }
