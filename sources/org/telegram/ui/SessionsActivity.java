...
public class SessionsActivity extends org.telegram.ui.ActionBar.m2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public k81 f31783a;
    public l60 f31784b;
    public org.telegram.ui.Components.nz f31785c;
    public org.telegram.ui.Components.u00 d;
    public final ArrayList e;
    public final ArrayList f31786f;
    public ArrayList h;
    public TLRPC.TL_authorization f31787n;
    public boolean f31788r;
    public g81 f31789s;
    private int terminateAllSessionsRow;
    private int ttlRow;
    public int v;
    public final int f31790w;
    public int f31791x;
    public int f31792y;
    ...
    public static void U(SessionsActivity sessionsActivity, int i10) {
        ...
        int i16 = sessionsActivity.f31790w;
        float f7 = 4.0f;
        boolean z13 = true;
        if (i10 == sessionsActivity.ttlRow) {
        ...
        } else if (((i10 >= sessionsActivity.K && i10 < sessionsActivity.L) || ((i10 >= sessionsActivity.G && i10 < sessionsActivity.H) || i10 == sessionsActivity.f31792y)) && sessionsActivity.getParentActivity() != null) {
            if (i16 == 0) {
                if (i10 == sessionsActivity.f31792y) {
                    tL_authorization = sessionsActivity.f31787n;
                    z10 = true;
                } else {
                    ...
                    if (i10 >= i21 && i10 < sessionsActivity.L) {
                        ...
                        tL_authorization = (TLRPC.TL_authorization) sessionsActivity.f31786f.get(i10 - sessionsActivity.G);
                    }
                    z10 = false;
                }
                if (tL_authorization != null) {
                    ...
                    e3Var.f39857b = tL_authorization;
                    e3Var.f39858c = sessionsActivity;
                    ...
                    textView3.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19443y6, false));
                    ...
                    if (tL_authorization.country.length() != 0) {
                        ...
                        w71Var2.f38925a.setImageDrawable(mutate2);
                        w71Var2.f38927c.setText(LocaleController.getString(R.string.Location));
                        w71Var2.setOnClickListener(new p71(e3Var, tL_authorization));
                        w71Var2.setOnLongClickListener(new q71(e3Var, tL_authorization));
                        w71Var2.setBackground(org.telegram.ui.ActionBar.h6.f0(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19149i6, false), 2, -1));
                    ...
                    if (tL_authorization.ip.length() != 0) {
                        ...
                        w71Var3.f38926b.setText(tL_authorization.ip);
                        ...
                        w71Var3.f38925a.setImageDrawable(mutate3);
                        w71Var3.f38927c.setText(LocaleController.getString(R.string.IpAddress));
                        w71Var3.setOnClickListener(new r71(e3Var, tL_authorization));
                        w71Var3.setOnLongClickListener(new s71(e3Var, tL_authorization));
                        w71Var3.setBackground(org.telegram.ui.ActionBar.h6.f0(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19149i6, false), 2, -1));
                    ...
                    if (i23 != 2040 && i23 != 2496) {
                        ...
                        w71Var4.f38926b.setText(LocaleController.getString(R.string.AcceptSecretChats));
                        ...
                        w71Var4.f38925a.setImageDrawable(mutate4);
                        w71Var4.d.c(!tL_authorization.encrypted_requests_disabled, false);
                        w71Var4.setBackground(org.telegram.ui.ActionBar.h6.f0(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19149i6, false), 7, -1));
                        w71Var4.setOnClickListener(new t71(e3Var, w71Var4, tL_authorization));
                        w71Var.e = true;
                        w71Var4.f38927c.setText(LocaleController.getString(R.string.AcceptSecretChatsDescription));
                        linearLayout2.addView(w71Var4);
                        w71Var = w71Var4;
                    }
                    if (tL_authorization.api_id != 22) {
                        w71 w71Var5 = new w71(parentActivity, true);
                        w71Var5.f38926b.setText(LocaleController.getString(R.string.AcceptCalls));
                        ...
                        w71Var5.f38925a.setImageDrawable(mutate5);
                        w71Var5.d.c(!tL_authorization.call_requests_disabled, false);
                        w71Var5.setBackground(org.telegram.ui.ActionBar.h6.f0(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19149i6, false), 7, -1));
                        w71Var5.setOnClickListener(new u71(e3Var, w71Var5, tL_authorization));
                        w71Var.e = true;
                        w71Var5.f38927c.setText(LocaleController.getString(R.string.AcceptCallsChatsDescription));
                    ...
                    if (!z10) {
                        ...
                        int w03 = org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19191ka, false);
            ...
            if (textView5 != null) {
                textView5.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19299q7, false));
            }
        }
    }
    ...
    public static void Y(SessionsActivity sessionsActivity, TLRPC.TL_error tL_error, TLObject tLObject, boolean z10) {
        ArrayList arrayList = sessionsActivity.e;
        sessionsActivity.f31788r = false;
        if (tL_error == null) {
            arrayList.clear();
    ...
    public final View createView(Context context) {
        ...
        this.f31783a = new k81(this, context);
        ...
        this.f31785c = nzVar;
        nzVar.b();
        frameLayout.addView(this.f31785c, w7.y5.e(-1, -1, 17));
        l60 l60Var = new l60(this, context);
        this.f31784b = l60Var;
        l60Var.p1();
        this.actionBar.setAdaptiveBackground(this.f31784b);
        this.f31784b.setLayoutManager(new gg.b0(1, false, 18));
        this.f31784b.setVerticalScrollBarEnabled(false);
        this.f31784b.setEmptyView(this.f31785c);
        l60 l60Var2 = this.f31784b;
        l60Var2.Y1 = true;
        l60Var2.Z1 = 0;
        frameLayout.addView(l60Var2, w7.y5.c(-1.0f, -1));
        this.f31784b.setAdapter(this.f31783a);
        s4.j jVar = new s4.j();
        jVar.n(150L);
        org.telegram.ui.Components.rr rrVar = org.telegram.ui.Components.rr.f28031f;
        jVar.f43045i = rrVar;
        jVar.f43018o = rrVar;
        this.f31784b.setItemAnimator(jVar);
        this.f31784b.setOnItemClickListener(new r21(this, 6));
        if (i10 == 0) {
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31784b, 16, new Class[]{org.telegram.ui.Cells.ea.class, org.telegram.ui.Cells.m4.class, org.telegram.ui.Cells.v6.class}, null, null, null, org.telegram.ui.ActionBar.h6.f19060d6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31784b, 32768, null, null, null, null, org.telegram.ui.ActionBar.h6.f19338s8));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31784b, 4096, null, null, null, null, org.telegram.ui.ActionBar.h6.f19149i6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31784b, 0, new Class[]{View.class}, org.telegram.ui.ActionBar.h6.f19181k0, null, null, org.telegram.ui.ActionBar.h6.f19061d7));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31785c, 2048, null, null, null, null, org.telegram.ui.ActionBar.h6.f19131h6));
        int i10 = org.telegram.ui.ActionBar.h6.f19280p7;
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31784b, 262148, new Class[]{org.telegram.ui.Cells.ea.class}, new String[]{"textView"}, null, null, -1, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31784b, 262148, new Class[]{org.telegram.ui.Cells.ea.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.q6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31784b, 32, new Class[]{org.telegram.ui.Cells.e9.class}, null, null, null, org.telegram.ui.ActionBar.h6.f19024b7));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31784b, 0, new Class[]{org.telegram.ui.Cells.e9.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.B6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31784b, 0, new Class[]{org.telegram.ui.Cells.m4.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.L6));
        int i11 = org.telegram.ui.ActionBar.h6.G6;
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31784b, 0, new Class[]{org.telegram.ui.Cells.v6.class}, new String[]{"nameTextView"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31784b, 262144, new Class[]{org.telegram.ui.Cells.v6.class}, new String[]{"onlineTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.I6));
        int i12 = org.telegram.ui.ActionBar.h6.A6;
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31784b, 262144, new Class[]{org.telegram.ui.Cells.v6.class}, new String[]{"onlineTextView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31784b, 0, new Class[]{org.telegram.ui.Cells.v6.class}, new String[]{"detailTextView"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31784b, 0, new Class[]{org.telegram.ui.Cells.v6.class}, new String[]{"detailExTextView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31789s, 32, null, null, null, null, org.telegram.ui.ActionBar.h6.Fi));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31789s, 0, new Class[]{UndoView.class}, new String[]{"undoImageView"}, null, null, -1, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31789s, 0, new Class[]{UndoView.class}, new String[]{"undoTextView"}, null, null, -1, null, i10));
        int i13 = org.telegram.ui.ActionBar.h6.Hi;
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31789s, 0, new Class[]{UndoView.class}, new String[]{"infoTextView"}, null, null, -1, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31789s, 0, new Class[]{UndoView.class}, new String[]{"textPaint"}, null, null, -1, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31789s, 0, new Class[]{UndoView.class}, new String[]{"progressPaint"}, null, null, -1, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31789s, 8, new Class[]{UndoView.class}, new String[]{"leftImageView"}, null, null, -1, null, i13));
        return arrayList;
    }
    ...
    public final int j0() {
        ...
        int i10 = 0;
        if (arrayList.size() == 0 && this.f31788r) {
            return 0;
        }
    ...
    public final void k0(final boolean z10) {
        ...
        if (this.f31790w == 0) {
            ConnectionsManager.getInstance(this.currentAccount).bindRequestToGuid(ConnectionsManager.getInstance(this.currentAccount).sendRequest(new TL_account.getAuthorizations(), new RequestDelegate(this) {
                public final SessionsActivity f40080b;
                ...
                public final void run(final TLObject tLObject, final TLRPC.TL_error tL_error) {
                    switch (r3) {
                        case 0:
                            final SessionsActivity sessionsActivity = this.f40080b;
                                ...
                                public final void run() {
                                    switch (r5) {
                                        case 0:
                                            ...
                                            ArrayList arrayList = sessionsActivity2.f31786f;
                                            ArrayList arrayList2 = sessionsActivity2.e;
                                            sessionsActivity2.f31788r = false;
                                            if (tL_error == null) {
                                                arrayList2.clear();
                                                arrayList.clear();
                                                ...
                                                for (int i10 = 0; i10 < size; i10++) {
                                                    ...
                                                    if ((tL_authorization.flags & 1) != 0) {
                                                        sessionsActivity2.f31787n = tL_authorization;
                                            ...
                                            k81 k81Var = sessionsActivity2.f31783a;
                                            if (k81Var != null) {
                                                k81Var.l();
                                            }
                            ...
                            return;
                        default:
                            final SessionsActivity sessionsActivity2 = this.f40080b;
                                ...
                                public final void run() {
                                    switch (r5) {
                                        case 0:
                                            ...
                                            ArrayList arrayList = sessionsActivity22.f31786f;
                                            ArrayList arrayList2 = sessionsActivity22.e;
                                            sessionsActivity22.f31788r = false;
                                            if (tL_error == null) {
                                                arrayList2.clear();
                                                arrayList.clear();
                                                TL_account.authorizations authorizationsVar = (TL_account.authorizations) tLObject;
                                                ...
                                                for (int i10 = 0; i10 < size; i10++) {
                                                    TLRPC.TL_authorization tL_authorization = authorizationsVar.authorizations.get(i10);
                                                    if ((tL_authorization.flags & 1) != 0) {
                                                        sessionsActivity22.f31787n = tL_authorization;
                                                    } else if (tL_authorization.password_pending) {
                                                        arrayList.add(tL_authorization);
                                                    } else {
                                                        arrayList2.add(tL_authorization);
                                            ...
                                            k81 k81Var = sessionsActivity22.f31783a;
                                            if (k81Var != null) {
                                                k81Var.l();
                                            }
    ...
    public final void m0() {
        ...
        ArrayList arrayList = this.f31786f;
        boolean isEmpty = arrayList.isEmpty();
        ArrayList arrayList2 = this.e;
        if (isEmpty && arrayList2.isEmpty()) {
            this.terminateAllSessionsRow = -1;
            this.E = -1;
            if (i10 != 1 && this.f31787n == null) {
                this.P = -1;
            } else {
                int i14 = this.S;
                this.S = i14 + 1;
    ...
    public final void onInsets(int i10, int i11, int i12, int i13) {
        this.f31784b.setPadding(0, 0, 0, i13);
        this.f31784b.setClipToPadding(false);
        g81 g81Var = this.f31789s;
        if (g81Var != null) {
    ...
    public final void onTransitionAnimationEnd(boolean z10, boolean z11) {
        ...
        if (z10 && !z11) {
            this.X = true;
            for (int i10 = 0; i10 < this.f31784b.getChildCount(); i10++) {
                View childAt = this.f31784b.getChildAt(i10);
                if (childAt instanceof l81) {
                    ((l81) childAt).f35243b.invalidate();
                }
            }
        }
    }
