...
public final class ue0 implements Runnable {
    public final int f37977a = 0;
    public final ye0 f37978b;
    public final TLRPC.TL_error f37979c;
    public final Bundle d;
    public final TLObject e;

    public ue0(ye0 ye0Var, TLObject tLObject, Bundle bundle, TLRPC.TL_error tL_error) {
        this.f37978b = ye0Var;
        this.e = tLObject;
        this.d = bundle;
        this.f37979c = tL_error;
    }
    ...
    public final void run() {
        ...
        switch (this.f37977a) {
            case 0:
                ye0 ye0Var = this.f37978b;
                xg0 xg0Var = ye0Var.f39797a0;
                ye0Var.M = false;
                ye0Var.v.invalidate();
                ...
                TLRPC.TL_error tL_error = this.f37979c;
                ...
                return;
            default:
                ye0 ye0Var2 = this.f37978b;
                xg0 xg0Var2 = ye0Var2.f39797a0;
                ye0Var2.R = false;
                TLRPC.TL_error tL_error2 = this.f37979c;
                if (tL_error2 == null) {
    ...
    public ue0(ye0 ye0Var, TLRPC.TL_error tL_error, Bundle bundle, TLObject tLObject) {
        this.f37978b = ye0Var;
        this.f37979c = tL_error;
        this.d = bundle;
        this.e = tLObject;
