...
public final class lb0 implements OnBackInvokedCallback {
    public final LaunchActivity f35414a;

    public lb0(LaunchActivity launchActivity) {
        this.f35414a = launchActivity;
    }

    public final void onBackInvoked() {
        if (AndroidUtilities.isTablet()) {
            this.f35414a.onBackPressed();
        } else if (!this.f35414a.c0(true)) {
        } else {
            LaunchActivity launchActivity = this.f35414a;
