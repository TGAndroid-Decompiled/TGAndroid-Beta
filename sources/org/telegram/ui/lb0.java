...
public final class lb0 {
    ...
    public static lb0[] values() {
        return (lb0[]) f35380n.clone();
    }

    public final ComponentName a(Context context) {
        if (this.f35384f == null) {
            String packageName = context.getPackageName();
            this.f35384f = new ComponentName(packageName, "org.telegram.messenger." + this.f35381a);
        }
        return this.f35384f;
    }
}
