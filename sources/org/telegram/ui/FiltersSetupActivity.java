...
public class FiltersSetupActivity extends org.telegram.ui.ActionBar.m2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final ArrayList f31088n;
    public int f31089r;
    public int f31090s;
    ...
    public static void U(FiltersSetupActivity filtersSetupActivity, Context context, View view, int i10) {
        ...
        if (i10 >= 0 && i10 < arrayList.size() && (x10Var = (x10) arrayList.get(i10)) != null) {
            ...
            if (i11 == 6) {
                ...
                z10 z10Var = filtersSetupActivity.f31085b;
                int i12 = filtersSetupActivity.f31090s;
    ...
    public final void Z(boolean z10) {
        ...
        arrayList2.clear();
        ArrayList arrayList3 = this.f31088n;
        ...
        if (!dialogFilters.isEmpty()) {
            ...
            this.v = size2;
            ai.w0 w0Var3 = this.f31084a;
            if (w0Var3 != null) {
                ArrayList arrayList5 = w0Var3.K2;
                int i13 = this.f31090s;
                int i14 = size2 - 1;
        ...
        aVar9.f39791c = string;
        arrayList3.add(aVar9);
        z10 z10Var = this.f31085b;
        if (z10Var != null) {
            if (z10) {
    ...
    public final View createView(Context context) {
        ...
        this.f31084a = w0Var;
        w0Var.p1();
        this.actionBar.setAdaptiveBackground(this.f31084a);
        s4.j jVar = new s4.j();
        jVar.n(350L);
        jVar.o(org.telegram.ui.Components.sr.h);
        jVar.C = false;
        jVar.f42994m = false;
        this.f31084a.setItemAnimator(jVar);
        ((s4.j) this.f31084a.getItemAnimator()).C = false;
        this.f31084a.setLayoutManager(new s4.c0(1, false));
        this.f31084a.setVerticalScrollBarEnabled(false);
        s4.y yVar = new s4.y(new c20(this));
        this.f31086c = yVar;
        yVar.e(this.f31084a);
        frameLayout.addView(this.f31084a, w7.y5.c(-1.0f, -1));
        ai.w0 w0Var2 = this.f31084a;
        z10 z10Var = new z10(this, context);
        this.f31085b = z10Var;
        w0Var2.setAdapter(z10Var);
        this.f31084a.setOnItemClickListener(new ow(1, this, context));
        if (this.f31087f) {
            Z(false);
            this.f31087f = false;
            this.f31084a.u0(this.f31085b.h() - 1);
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31084a, 16, new Class[]{org.telegram.ui.Cells.m4.class, b20.class, v10.class, a20.class}, null, null, null, org.telegram.ui.ActionBar.h6.f19059d6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31084a, 32768, null, null, null, null, org.telegram.ui.ActionBar.h6.f19337s8));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31084a, 4096, null, null, null, null, org.telegram.ui.ActionBar.h6.f19148i6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31084a, 0, new Class[]{View.class}, org.telegram.ui.ActionBar.h6.f19180k0, null, null, org.telegram.ui.ActionBar.h6.f19060d7));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31084a, 0, new Class[]{org.telegram.ui.Cells.m4.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.L6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31084a, 0, new Class[]{v10.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.G6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31084a, 0, new Class[]{v10.class}, new String[]{"valueTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.f19461z6));
        int i10 = org.telegram.ui.ActionBar.h6.Uh;
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31084a, 0, new Class[]{v10.class}, new String[]{"moveImageView"}, null, null, -1, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31084a, 0, new Class[]{v10.class}, new String[]{"optionsImageView"}, null, null, -1, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31084a, 196608, new Class[]{v10.class}, new String[]{"optionsImageView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.Vh));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31084a, 0, new Class[]{b20.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.f19260o6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31084a, 32, new Class[]{b20.class}, new String[]{"imageView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.N6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31084a, 0, new Class[]{b20.class}, new String[]{"imageView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.f19187k7));
        return arrayList;
    }
    ...
    public final void onInsets(int i10, int i11, int i12, int i13) {
        this.f31084a.setPadding(0, 0, 0, i13);
        this.f31084a.setClipToPadding(false);
