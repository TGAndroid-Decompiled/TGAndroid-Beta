...
public class FiltersSetupActivity extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final ArrayList f31087n;
    public int f31088r;
    public int f31089s;
    ...
    public static void U(FiltersSetupActivity filtersSetupActivity, Context context, View view, int i10) {
        c20 c20Var;
        ArrayList arrayList = filtersSetupActivity.f31087n;
        if (i10 >= 0 && i10 < arrayList.size() && (c20Var = (c20) arrayList.get(i10)) != null) {
            int i11 = c20Var.f15704a;
            if (i11 == 6) {
                ...
                e20 e20Var = filtersSetupActivity.f31084b;
                int i12 = filtersSetupActivity.f31089s;
    ...
    public final void Z(boolean z10) {
        ...
        arrayList2.clear();
        ArrayList arrayList3 = this.f31087n;
        ...
        if (!dialogFilters.isEmpty()) {
            ...
            this.v = size2;
            ai.w0 w0Var3 = this.f31083a;
            if (w0Var3 != null) {
                ArrayList arrayList5 = w0Var3.K2;
                int i13 = this.f31089s;
                int i14 = size2 - 1;
        ...
        aVar9.f32603c = string;
        arrayList3.add(aVar9);
        e20 e20Var = this.f31084b;
        if (e20Var != null) {
            if (z10) {
    ...
    public final View createView(Context context) {
        ...
        jVar.C = false;
        jVar.f43009m = false;
        this.f31083a.setItemAnimator(jVar);
        ((s4.j) this.f31083a.getItemAnimator()).C = false;
        this.f31083a.setLayoutManager(new s4.c0(1, false));
        this.f31083a.setVerticalScrollBarEnabled(false);
        s4.y yVar = new s4.y(new h20(this));
        this.f31085c = yVar;
        yVar.e(this.f31083a);
        frameLayout.addView(this.f31083a, w7.y5.c(-1.0f, -1));
        ai.w0 w0Var2 = this.f31083a;
        e20 e20Var = new e20(this, context);
        this.f31084b = e20Var;
        w0Var2.setAdapter(e20Var);
        this.f31083a.setOnItemClickListener(new z10(0, this, context));
        if (this.f31086f) {
            Z(false);
            this.f31086f = false;
            this.f31083a.v0(this.f31084b.h() - 1);
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31083a, 16, new Class[]{org.telegram.ui.Cells.n4.class, g20.class, a20.class, f20.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19094d6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31083a, 32768, null, null, null, null, org.telegram.ui.ActionBar.j6.f19372s8));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31083a, 4096, null, null, null, null, org.telegram.ui.ActionBar.j6.f19184i6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31083a, 0, new Class[]{View.class}, org.telegram.ui.ActionBar.j6.f19216k0, null, null, org.telegram.ui.ActionBar.j6.f19095d7));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31083a, 0, new Class[]{org.telegram.ui.Cells.n4.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.L6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31083a, 0, new Class[]{a20.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.G6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31083a, 0, new Class[]{a20.class}, new String[]{"valueTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f19496z6));
        int i10 = org.telegram.ui.ActionBar.j6.Uh;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31083a, 0, new Class[]{a20.class}, new String[]{"moveImageView"}, null, null, -1, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31083a, 0, new Class[]{a20.class}, new String[]{"optionsImageView"}, null, null, -1, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31083a, 196608, new Class[]{a20.class}, new String[]{"optionsImageView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.Vh));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31083a, 0, new Class[]{g20.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f19296o6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31083a, 32, new Class[]{g20.class}, new String[]{"imageView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.N6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31083a, 0, new Class[]{g20.class}, new String[]{"imageView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f19223k7));
        return arrayList;
    }
    ...
    public final void onFragmentDestroy() {
        ...
        if (this.e) {
            ...
            for (int i11 = 0; i11 < size; i11 = com.google.android.gms.internal.vision.e2.e(dialogFilters.get(i11).f15822id, i11, 1, tL_messages_updateDialogFiltersOrder.order)) {
            }
