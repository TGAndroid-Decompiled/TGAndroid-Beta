...
public final class ez0 implements org.telegram.ui.Components.cl0 {
    ...
    public final ProfileActivity f33047c;

    public ez0(ProfileActivity profileActivity, Context context) {
        this.f33047c = profileActivity;
    ...
    public static void a(ez0 ez0Var, Context context, int i10) {
        ...
        int i20 = 0;
        if (i10 == 0) {
            ez0Var.f33047c.getUserConfig().syncContacts = true;
            ez0Var.f33047c.getUserConfig().saveConfig(false);
            ez0Var.f33047c.getContactsController().forceImportContacts();
            return;
        }
        long j10 = 0;
        if (i10 == 1) {
            ez0Var.f33047c.getContactsController().loadContacts(false, 0L);
        } else if (i10 == 2) {
            ez0Var.f33047c.getContactsController().resetImportedContacts();
        } else if (i10 == 3) {
            ez0Var.f33047c.getMessagesController().forceResetDialogs();
        } else if (i10 == 4) {
            ...
            ez0Var.f33047c.getMessagesStorage().clearSentMedia();
            ...
            w7.w5.a();
            i15 = ((org.telegram.ui.ActionBar.n2) ez0Var.f33047c).currentAccount;
            ...
            i16 = ((org.telegram.ui.ActionBar.n2) ez0Var.f33047c).currentAccount;
            ChatThemeController.getInstance(i16).clearCache();
            ez0Var.f33047c.getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.newSuggestionsAvailable, new Object[0]);
            x31.W();
            i17 = ((org.telegram.ui.ActionBar.n2) ez0Var.f33047c).currentAccount;
            pg.t0.e(i17).a();
            SharedPreferences mainSettings = ez0Var.f33047c.getMessagesController().getMainSettings();
            ...
            edit.apply();
            i18 = ((org.telegram.ui.ActionBar.n2) ez0Var.f33047c).currentAccount;
            SharedPreferences.Editor edit2 = MessagesController.getNotificationsSettings(i18).edit();
            i19 = ((org.telegram.ui.ActionBar.n2) ez0Var.f33047c).currentAccount;
            ...
            org.telegram.ui.Components.voip.f2.i(ez0Var.f33047c.getParentActivity());
        } else if (i10 == 8) {
            SharedConfig.toggleRoundCamera16to9();
        } else if (i10 == 9) {
            ((LaunchActivity) ez0Var.f33047c.getParentActivity()).z(true);
        } else if (i10 == 10) {
            ez0Var.f33047c.getMessagesStorage().readAllDialogs(-1);
        } else if (i10 == 11) {
            ...
            Set<String> set = ez0Var.f33047c.getMessagesController().pendingSuggestions;
            ...
            try {
                if (i10 == 14) {
                    ...
                    Activity parentActivity = ez0Var.f33047c.getParentActivity();
                    ...
                    w7.x.a((LaunchActivity) ez0Var.f33047c.getParentActivity(), !SharedConfig.isFloatingDebugActive, true);
                } else if (i10 == 19) {
                    ez0Var.f33047c.getMessagesController().loadAppConfig();
                    TLRPC.TL_help_dismissSuggestion tL_help_dismissSuggestion = new TLRPC.TL_help_dismissSuggestion();
                    tL_help_dismissSuggestion.suggestion = "VALIDATE_PHONE_NUMBER";
                    tL_help_dismissSuggestion.peer = new TLRPC.TL_inputPeerEmpty();
                    ez0Var.f33047c.getConnectionsManager().sendRequest(tL_help_dismissSuggestion, new bz0(ez0Var, 0));
                } else if (i10 == 20) {
                    ...
                    ProfileActivity.S0(ez0Var.f33047c, "video/avc", sb3);
                    ProfileActivity.S0(ez0Var.f33047c, "video/hevc", sb3);
                    ProfileActivity.S0(ez0Var.f33047c, "video/x-vnd.on2.vp8", sb3);
                    ProfileActivity.S0(ez0Var.f33047c, "video/x-vnd.on2.vp9", sb3);
                    ez0Var.f33047c.showDialog(new dz0(ez0Var, ez0Var.f33047c.getParentActivity(), sb3.toString()));
                } else if (i10 == 21) {
                    AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(ez0Var.f33047c.getParentActivity(), 0, ez0Var.f33047c.f31383z0);
                    ...
                    boolean q6 = ci.d1.q(ez0Var.f33047c.getParentActivity());
                    MessagesController.getGlobalMainSettings().edit().putBoolean("dual_available", !q6).apply();
                    Activity parentActivity2 = ez0Var.f33047c.getParentActivity();
                    if (!q6) {
                    ...
                    while (i20 < ez0Var.f33047c.getParentLayout().getFragmentStack().size()) {
                        ((org.telegram.ui.ActionBar.n2) ez0Var.f33047c.getParentLayout().getFragmentStack().get(i20)).clearSheets();
                        i20++;
                    }
                } else if (i10 == 25) {
                    ...
                    ez0Var.f33047c.getMediaDataController().loadAttachMenuBots(false, true);
                } else if (i10 == 28) {
                    i12 = ((org.telegram.ui.ActionBar.n2) ez0Var.f33047c).currentAccount;
                    ...
                    i11 = ((org.telegram.ui.ActionBar.n2) ez0Var.f33047c).currentAccount;
