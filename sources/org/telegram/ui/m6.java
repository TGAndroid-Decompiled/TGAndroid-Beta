...
public final class m6 implements Utilities.Callback2 {
    ...
    public final void run(Object obj, Object obj2) {
        ...
        int i11 = 0;
        Object obj3 = this.d;
        Object obj4 = this.f35641c;
        Object obj5 = this.f35640b;
        switch (i10) {
            case 0:
            ...
            case 1:
                ...
                if (bool.booleanValue() && !(webPage instanceof TLRPC.TL_webPagePending)) {
                    Iterator it = boVar.f32395mb.keySet().iterator();
                    while (it.hasNext() && boVar.f32395mb.size() > 5) {
                        it.next();
                        it.remove();
                    }
                    boVar.f32395mb.put(getwebpagepreview.message, webPage);
                }
            ...
            default:
                ...
                if (passkeys != null) {
                    ...
                    while (i11 < passkeys.passkeys.size()) {
                        if (TextUtils.equals(passkeys.passkeys.get(i11).f18316id, passkey.f18316id)) {
