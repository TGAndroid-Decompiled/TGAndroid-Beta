...
public final class xh0 extends FrameLayout {
    ...
    public final ai0 K;
    public int f39631a;
    public final LinearLayout f39632b;
    public final TextView f39633c;
    public final TextView d;
    public final LinearLayout e;
    public final TextView f39634f;
    public final TextView h;
    public TLRPC.TL_chatInviteExported f39635n;
    public int f39636r;
    public final Paint f39637s;
    public final Paint v;
    public final RectF f39638w;
    public final ImageView f39639x;
    public int f39640y;

    public xh0(ai0 ai0Var, Context context) {
        super(context);
        this.K = ai0Var;
        this.f39637s = new Paint(1);
        Paint paint = new Paint(1);
        this.v = paint;
        this.f39638w = new RectF();
        this.E = 1.0f;
        ...
        imageView.setBackground(org.telegram.ui.ActionBar.j6.f0(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18952i6, false), 1, -1));
    ...
    public final int a(float f7, int i10) {
        TLRPC.TL_chatInviteExported tL_chatInviteExported = this.f39635n;
        ...
        if (i10 == 3) {
            return org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18994ka, false);
        }
        if (i10 == 1) {
            if (f7 > 0.5f) {
                return i0.a.d(1.0f - ((f7 - 0.5f) / 0.5f), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19051na, false), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19067oa, false));
            }
            return i0.a.d(1.0f - (f7 / 0.5f), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19067oa, false), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18994ka, false));
        } else if (i10 == 2) {
            return org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19067oa, false);
        } else {
            if (i10 == 4) {
    ...
    public final void b(TLRPC.TL_chatInviteExported tL_chatInviteExported, int i10) {
        ...
        ImageView imageView = this.f39639x;
        ...
        if (tL_starsSubscriptionPricing != null) {
            ...
            TextView textView = this.f39634f;
            textView.setText(X0);
        ...
        ((ViewGroup.MarginLayoutParams) this.f39632b.getLayoutParams()).rightMargin = dp;
        boolean isEmpty = TextUtils.isEmpty(tL_chatInviteExported.title);
        ai0 ai0Var = this.K;
        TextView textView3 = this.f39633c;
        if (!isEmpty) {
        ...
        if (tL_chatInviteExported.permanent && !tL_chatInviteExported.revoked) {
            ...
            btVar.f22798b = AndroidUtilities.dp(1.5f);
            ...
            if (tL_chatInviteExported.expire_date > 0) {
                ...
                btVar2.f22798b = AndroidUtilities.dp(1.5f);
                ...
                long currentTimeMillis = (tL_chatInviteExported.expire_date * 1000) - ((ai0Var.f31886n0 * 1000) + System.currentTimeMillis());
            ...
            btVar3.f22798b = AndroidUtilities.dp(1.5f);
        ...
        if (tL_chatInviteExported.request_needed) {
            ...
            btVar4.f22798b = AndroidUtilities.dp(1.5f);
