...
public final class xh0 extends FrameLayout {
    ...
    public final ai0 K;
    public int f39601a;
    public final LinearLayout f39602b;
    public final TextView f39603c;
    public final TextView d;
    public final LinearLayout e;
    public final TextView f39604f;
    public final TextView h;
    public TLRPC.TL_chatInviteExported f39605n;
    public int f39606r;
    public final Paint f39607s;
    public final Paint v;
    public final RectF f39608w;
    public final ImageView f39609x;
    public int f39610y;

    public xh0(ai0 ai0Var, Context context) {
        super(context);
        this.K = ai0Var;
        this.f39607s = new Paint(1);
        Paint paint = new Paint(1);
        this.v = paint;
        this.f39608w = new RectF();
        this.E = 1.0f;
        this.J = new org.telegram.ui.Components.n21();
        paint.setStyle(Paint.Style.STROKE);
        paint.setStrokeCap(Paint.Cap.ROUND);
        LinearLayout linearLayout = new LinearLayout(context);
        this.f39602b = linearLayout;
        ...
        imageView.setBackground(org.telegram.ui.ActionBar.j6.f0(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19199i6, false), 1, -1));
    ...
    public final int a(float f7, int i10) {
        TLRPC.TL_chatInviteExported tL_chatInviteExported = this.f39605n;
        ...
        if (i10 == 3) {
            return org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19241ka, false);
        }
        if (i10 == 1) {
            if (f7 > 0.5f) {
                return i0.a.d(1.0f - ((f7 - 0.5f) / 0.5f), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19298na, false), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19314oa, false));
            }
            return i0.a.d(1.0f - (f7 / 0.5f), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19314oa, false), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19241ka, false));
        } else if (i10 == 2) {
            return org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19314oa, false);
        } else {
            if (i10 == 4) {
    ...
    public final void b(TLRPC.TL_chatInviteExported tL_chatInviteExported, int i10) {
        ...
        ImageView imageView = this.f39609x;
        ...
        if (tL_starsSubscriptionPricing != null) {
            ...
            TextView textView = this.f39604f;
            textView.setText(X0);
        ...
        ((ViewGroup.MarginLayoutParams) this.f39602b.getLayoutParams()).rightMargin = dp;
        boolean isEmpty = TextUtils.isEmpty(tL_chatInviteExported.title);
        ai0 ai0Var = this.K;
        TextView textView3 = this.f39603c;
        if (!isEmpty) {
        ...
        if (tL_chatInviteExported.permanent && !tL_chatInviteExported.revoked) {
            ...
            btVar.f23091b = AndroidUtilities.dp(1.5f);
            ...
            if (tL_chatInviteExported.expire_date > 0) {
                ...
                btVar2.f23091b = AndroidUtilities.dp(1.5f);
                ...
                long currentTimeMillis = (tL_chatInviteExported.expire_date * 1000) - ((ai0Var.f32109n0 * 1000) + System.currentTimeMillis());
            ...
            btVar3.f23091b = AndroidUtilities.dp(1.5f);
        ...
        if (tL_chatInviteExported.request_needed) {
            ...
            btVar4.f23091b = AndroidUtilities.dp(1.5f);
