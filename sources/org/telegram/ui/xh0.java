...
public final class xh0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    public static final org.telegram.ui.Components.cc0 f39985n;
    public static final org.telegram.ui.Components.cc0 f39986r;
    public final int f39987a;
    public final org.telegram.ui.Components.p9 f39988b;
    public final org.telegram.ui.ActionBar.k5 f39989c;
    public final TextView d;
    public final org.telegram.ui.Components.z8 e;
    public final org.telegram.ui.Components.lw0 f39990f;
    public TLObject h;

    static {
        int i10 = R.drawable.msg_mini_checks;
        int i11 = org.telegram.ui.ActionBar.j6.f20256y6;
        f39985n = new org.telegram.ui.Components.cc0(i10, i11);
        f39986r = new org.telegram.ui.Components.cc0(R.drawable.mini_checklist_done_outline, i11);
    }

    public xh0(Context context) {
        super(context);
        int i10;
        this.f39987a = UserConfig.selectedAccount;
        ...
        this.f39990f = new org.telegram.ui.Components.lw0(this);
        ...
        textView.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20256y6, false));
    ...
    public final void a(TLObject tLObject, boolean z4, int i10) {
        ...
        org.telegram.ui.Components.lw0 lw0Var = this.f39990f;
        if (z10) {
        ...
        org.telegram.ui.ActionBar.k5 k5Var = this.f39989c;
        k5Var.i(a2);
        if (tLObject != null) {
            org.telegram.ui.Components.z8 z8Var = this.e;
            int i11 = this.f39987a;
            z8Var.j(i11, tLObject);
            this.f39988b.h(ImageLocation.getForUserOrChat(i11, tLObject, 1), "50_50", z8Var, tLObject);
        ...
        textView.setText(TextUtils.concat(cc0Var.a(getContext(), null), LocaleController.formatSeenDate(i10)));
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.userEmojiStatusUpdated) {
            ...
            if (user != null && user2 != null && user.f19306id == user2.f19306id) {
                this.h = user2;
                int w02 = org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20276z9, false);
    ...
    public final void onAttachedToWindow() {
        ...
        this.f39990f.f26889a.a();
        NotificationCenter.getInstance(this.f39987a).addObserver(this, NotificationCenter.userEmojiStatusUpdated);
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        this.f39990f.f26889a.b();
        NotificationCenter.getInstance(this.f39987a).removeObserver(this, NotificationCenter.userEmojiStatusUpdated);
    }

    @Override
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        super.onInitializeAccessibilityNodeInfo(accessibilityNodeInfo);
        String formatString = LocaleController.formatString("AccDescrPersonHasSeen", R.string.AccDescrPersonHasSeen, this.f39989c.getText());
        TextView textView = this.d;
