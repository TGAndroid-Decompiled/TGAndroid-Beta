...
public final class ey implements org.telegram.ui.Components.v40 {
    public final qy f33481a;
    ...
    public final void B(float f7) {
        org.telegram.ui.Components.qc qcVar = this.f33481a.f37031d4;
        if (qcVar != null) {
    ...
    public final void L(boolean z10, boolean z11) {
        ...
        int i10;
        qy qyVar = this.f33481a;
        org.telegram.ui.Components.qc qcVar = qyVar.f37031d4;
        if (qcVar != null) {
            qcVar.b();
            qyVar.f37031d4 = null;
        }
        ...
        if (z10) {
            w9Var.setImageBitmap(qyVar.f37014a4.f29846r);
        } else {
        ...
        b10.f27643r = false;
        b10.i(false);
        org.telegram.ui.Components.qc qcVar2 = qyVar.f37031d4;
        qcVar2.f27644s = true;
        qcVar2.j();
    }
    ...
    public final void Q(final TLRPC.InputFile inputFile, final TLRPC.InputFile inputFile2, final double d, final String str, final TLRPC.PhotoSize photoSize, final TLRPC.PhotoSize photoSize2, final boolean z10, final TLRPC.VideoSize videoSize) {
        AndroidUtilities.runOnUIThread(new Runnable() {
            ...
            public final void run() {
                ...
                ey eyVar = ey.this;
                qy qyVar = eyVar.f33481a;
                TLRPC.InputFile inputFile3 = inputFile;
                TLRPC.InputFile inputFile4 = inputFile2;
                TLRPC.VideoSize videoSize2 = videoSize;
                if (inputFile3 == null && inputFile4 == null && videoSize2 == null) {
                    qyVar.f37020b4 = photoSize2.location;
                    qyVar.f37026c4 = photoSize.location;
                } else if (qyVar.f37020b4 == null) {
                    return;
                } else {
    ...
    public final vu0 getCloseIntoObject() {
        ...
        if (qcVar != null) {
            ...
            vu0 vu0Var = new vu0();
            int[] iArr = new int[2];
            org.telegram.ui.Components.w9 w9Var = hcVar.f24749c;
            org.telegram.ui.Components.w9 w9Var2 = hcVar.f24749c;
            ...
            vu0Var.f38823i = 0;
            vu0Var.h = vu0Var.f38818a.getRoundRadius();
            vu0Var.f38825k = w9Var2.getScaleX();
            return vu0Var;
        }
        return null;
    }
