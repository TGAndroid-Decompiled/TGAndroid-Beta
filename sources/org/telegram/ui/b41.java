...
public final class b41 extends org.telegram.ui.ActionBar.f3 {
    ...
    public static void H(b41 b41Var, CharSequence charSequence, byte[] bArr, String str) {
        ...
        if (b41Var.d) {
            ...
            if (b41Var.e) {
                ...
                if (arrayList != null) {
                    tL_stories_report.f18543id.addAll(arrayList);
                }
                if (str != null) {
                    str2 = str;
                }
                ...
                if (arrayList != null && !arrayList.isEmpty()) {
                    tL_reportMessage.f18511id = ((Integer) arrayList.get(0)).intValue();
                }
                if (str != null) {
                    str2 = str;
                }
                ...
                if (arrayList != null) {
                    tL_messages_report2.f18400id.addAll(arrayList);
                }
                if (str != null) {
                    str2 = str;
                }
    ...
    public static void K(int i10, final Context context, final long j3, final boolean z10, final boolean z11, final ArrayList arrayList, final org.telegram.ui.Components.xc xcVar, final org.telegram.ui.ActionBar.e6 e6Var, byte[] bArr, String str, final Utilities.Callback callback) {
        ...
        if (context != null) {
            ...
            if (z10) {
                ...
                tL_messages_report3.f18400id.addAll(arrayList);
    ...
    public static void m(Context context, org.telegram.ui.ActionBar.e6 e6Var, boolean z10, boolean z11, long j3, ArrayList arrayList, boolean[] zArr, Utilities.Callback callback, org.telegram.ui.Components.xc xcVar, TLRPC.ReportResult reportResult) {
        ...
        b41Var.f32238s = new s31(zArr, callback, xcVar);
    ...
    public static void n(b41 b41Var, TLObject tLObject, CharSequence charSequence, TLRPC.TL_error tL_error, byte[] bArr, String str) {
        ...
        x31 x31Var2;
        ci.d dVar;
        ci.i1 i1Var = b41Var.f32233b;
        if ((i1Var.getCurrentView() instanceof a41) && (dVar = ((a41) i1Var.getCurrentView()).f31951s) != null) {
        ...
        if (tLObject != null) {
            ...
            if (!z10 && !(tLObject instanceof TLRPC.TL_reportResultChooseOption) && !(tLObject instanceof TLRPC.TL_reportResultAddComment)) {
                if (tLObject instanceof TLRPC.TL_channels_sponsoredMessageReportResultAdsHidden) {
                    ...
                    return;
                } else if (((tLObject instanceof TLRPC.TL_channels_sponsoredMessageReportResultReported) || (tLObject instanceof TLRPC.TL_reportResultReported)) && (x31Var2 = b41Var.f32238s) != null) {
                    x31Var2.a();
                    b41Var.dismiss();
                    return;
                } else {
            ...
            if (a41Var != null) {
                ...
                if (tLObject instanceof TLRPC.TL_reportResultChooseOption) {
                    a41Var.f31946b = null;
                    a41Var.f31947c = (TLRPC.TL_reportResultChooseOption) tLObject;
                    a41Var.d = null;
                    t61Var.Y2.N(false);
                } else if (tLObject instanceof TLRPC.TL_reportResultAddComment) {
                    a41Var.b((TLRPC.TL_reportResultAddComment) tLObject);
                } else if (z10) {
                    a41Var.f31946b = (TLRPC.TL_channels_sponsoredMessageReportResultChooseOption) tLObject;
                    a41Var.f31947c = null;
                    a41Var.d = null;
                    t61Var.Y2.N(false);
                }
            ...
            if (!b41Var.d && "MESSAGE_ID_REQUIRED".equals(tL_error.text)) {
                ...
                x31 x31Var4 = b41Var.f32238s;
                if (x31Var4 != null) {
                    x31Var4.c();
                }
            } else if ("AD_EXPIRED".equals(tL_error.text) && (x31Var = b41Var.f32238s) != null) {
                x31Var.a();
            }
            b41Var.dismiss();
        }
    ...
    public final void O(TLRPC.TL_channels_sponsoredMessageReportResultChooseOption tL_channels_sponsoredMessageReportResultChooseOption) {
        View[] viewPages = this.f32233b.getViewPages();
        View view = viewPages[0];
        if (view instanceof a41) {
            ((a41) view).a(0);
    ...
    public final boolean canDismissWithSwipe() {
        View currentView = this.f32233b.getCurrentView();
        if (!(currentView instanceof a41)) {
            return true;
        }
        return !((a41) currentView).f31948f.canScrollVertically(-1);
    }

    @Override
    public final void onBackPressed() {
        z31 z31Var;
        ci.i1 i1Var = this.f32233b;
        if ((i1Var.getCurrentView() instanceof a41) && (z31Var = ((a41) i1Var.getCurrentView()).f31949n) != null) {
