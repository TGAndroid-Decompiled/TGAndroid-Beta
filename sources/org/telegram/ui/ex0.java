    ...
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        ...
        switch (this.f33424a) {
            case 0:
                ...
                return;
            default:
                jb1 jb1Var = (jb1) this.f33425b;
                jb1Var.getClass();
                jb1Var.f34837a = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                ((ChatActivityEnterView) this.f33426c).getEditField().setAlpha(jb1Var.f34837a);
