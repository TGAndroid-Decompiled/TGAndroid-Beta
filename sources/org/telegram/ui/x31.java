...
public final class x31 extends FrameLayout {
    public final org.telegram.ui.Components.d6 f39360a;
    public float f39361b;
    public final Path f39362c;
    public Boolean d;
    public final c41 e;
    ...
    public x31(c41 c41Var, Context context) {
        super(context);
        this.e = c41Var;
        this.f39360a = new org.telegram.ui.Components.d6(this, 250L, org.telegram.ui.Components.qr.h);
        this.f39362c = new Path();
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        while (i12 < length) {
            ...
            if (view == null) {
                ...
                while (true) {
                    ...
                    if (H >= 0 && H < m61Var.f26345x.size() && (G = m61Var.G(H)) != null && G.f15719a == 28) {
                ...
                viewArr = viewPages;
                this.f39361b = (paddingTop * clamp) + f11;
                if (b41Var.getVisibility() == 0) {
                    ...
                    while (true) {
                        ...
                        u61Var.X2.getClass();
                        if (m61Var.G(s4.o0.H(childAt2)).f15719a == 28) {
        ...
        if (this.f39361b <= AndroidUtilities.statusBarHeight) {
            f7 = 1.0f;
        } else {
            f7 = 0.0f;
        }
        float d = this.f39360a.d(f7, false);
        float f13 = AndroidUtilities.statusBarHeight;
        float f14 = f13 * d;
        this.f39361b = Math.max(f13, this.f39361b) - (AndroidUtilities.statusBarHeight * d);
        RectF rectF = AndroidUtilities.rectTmp;
        i10 = ((org.telegram.ui.ActionBar.f3) c41Var).backgroundPaddingLeft;
        float f15 = this.f39361b;
        int width = getWidth();
        ...
        canvas.drawRoundRect(rectF, lerp, lerp, c41Var.f32637c);
        canvas.save();
        Path path = this.f39362c;
        path.rewind();
        ...
        if (AndroidUtilities.computePerceivedBrightness(c41Var.getThemedColor(org.telegram.ui.ActionBar.j6.f19180h5)) > 0.721f) {
            z11 = true;
        } else {
            z11 = false;
        }
        if (AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.j6.v(c41Var.getThemedColor(org.telegram.ui.ActionBar.j6.f19387s8), 855638016)) > 0.721f) {
            z12 = true;
        } else {
            z12 = false;
        }
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        if (motionEvent.getAction() == 0 && motionEvent.getY() < this.f39361b) {
            this.e.dismiss();
            return true;
        }
