...
public class nq extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public mq f35999a;
    public int f36000a0;
    public final boolean f36001a1;
    public ai.w0 f36002b;
    public int f36003b0;
    public ValueAnimator f36004b1;
    public gg.b0 f36005c;
    public int f36006c0;
    public ValueAnimator f36007c1;
    public FrameLayout d;
    public int f36008d0;
    public FrameLayout e;
    public int f36009e0;
    public org.telegram.ui.Components.p6 f36010f;
    public int f36011f0;
    public int f36012g0;
    ...
    public int f36029v0;
    public TLRPC.Chat f36030w;
    public int f36031w0;
    public TLRPC.ChatFull f36032x;
    public int f36033x0;
    public final int f36034y;
    public int f36035y0;
    public int f36036z0;
    ...
    public nq(long j3, long j10, TLRPC.TL_chatAdminRights tL_chatAdminRights, TLRPC.TL_chatBannedRights tL_chatBannedRights, TLRPC.TL_chatBannedRights tL_chatBannedRights2, String str, int i10, boolean z10, boolean z11, String str2) {
        ...
        this.O0 = z37;
        this.Y0 = str2;
        this.f36030w = getMessagesController().getChat(Long.valueOf(this.f36025s));
        this.f36032x = getMessagesController().getChatFull(this.f36025s);
        ...
        this.S = str3;
        this.T = str3;
        this.F = ChatObject.isCommunity(this.f36030w);
        TLRPC.Chat chat2 = this.f36030w;
        if (chat2 != null) {
            if (ChatObject.isChannel(chat2) && !this.f36030w.megagroup) {
                z35 = true;
            } else {
                z35 = false;
            }
            this.E = z35;
            this.G = ChatObject.isForum(this.f36030w);
            this.N = this.f36030w.admin_rights;
        }
        if (this.N == null) {
            if (i10 == 2 && ((chat = this.f36030w) == null || !chat.creator)) {
                z34 = false;
            } else {
                z34 = true;
            }
    ...
    public static void U(nq nqVar, long j3) {
        if (j3 != 0) {
            nqVar.f36025s = j3;
            nqVar.f36030w = MessagesController.getInstance(nqVar.currentAccount).getChat(Long.valueOf(j3));
            nqVar.r0(true);
        }
    }
    ...
    public static boolean W(nq nqVar, TLRPC.TL_error tL_error) {
        ...
        if (tL_error != null && "USER_PRIVACY_RESTRICTED".equals(tL_error.text)) {
            if (!ChatObject.isChannel(nqVar.f36030w)) {
                ...
                j0Var.I1(nqVar.f36030w, arrayList, null, null, null);
                j0Var.show();
            }
            return false;
        }
            ...
            if (nqVar.getParentActivity() != null) {
                if ("PASSWORD_HASH_INVALID".equals(tL_error.text)) {
                    if (inputCheckPasswordSRP == null) {
                        ...
                        b2Var.T = AndroidUtilities.replaceTags(LocaleController.formatString(R.string.EditAdminTransferReadyAlertText, nqVar.f36030w.title, UserObject.getFirstName(user)));
    ...
    public static void Z(nq nqVar, long j3) {
        long j10;
        TLRPC.User user;
        TLRPC.ChatFull chatFull = nqVar.f36032x;
        if (chatFull != null) {
        ...
        if (user2 != null && j3 != 0 && user2.f18443id != j3) {
    ...
    public final View createView(Context context) {
        ...
        if (this.I || (!this.E && this.f36030w.creator && UserObject.isUserSelf(this.v))) {
            org.telegram.ui.ActionBar.z n10 = this.actionBar.n();
            Drawable mutate = context.getResources().getDrawable(R.drawable.ic_ab_done).mutate();
            int i12 = org.telegram.ui.ActionBar.j6.f19395v8;
        ...
        v7Var.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19006a7, false));
        ...
        this.f36005c = b0Var;
        b0Var.E = 100;
        this.f36002b.setLayoutManager(b0Var);
        ai.w0 w0Var2 = this.f36002b;
        mq mqVar = new mq(this, context);
        this.f35999a = mqVar;
        w0Var2.setAdapter(mqVar);
        s4.j jVar = new s4.j();
        if (i11 == 2) {
            this.f36002b.setResetSelectorOnChanged(false);
        }
        jVar.f42964m = false;
        jVar.C = false;
        jVar.o(org.telegram.ui.Components.qr.h);
        jVar.n(350L);
        this.f36002b.setItemAnimator(jVar);
        ai.w0 w0Var3 = this.f36002b;
        if (!LocaleController.isRTL) {
            i10 = 2;
        }
        w0Var3.setVerticalScrollbarPosition(i10);
        frameLayout.addView(this.f36002b, w7.y5.c(-1.0f, -1));
        this.f36002b.q1();
        this.f36002b.setOnScrollListener(new h3(this, 6));
        this.f36002b.setOnItemClickListener(new ai.o6(7, this, context));
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.chatInfoDidLoad) {
            ...
            TLRPC.Chat chat = this.f36030w;
            if (chat != null && chatFull.f18297id == chat.f18296id) {
                this.f36032x = chatFull;
                n0();
            }
        } else if (i10 == NotificationCenter.dialogDeleted) {
            if ((-this.f36025s) == ((Long) objArr[0]).longValue()) {
    ...
    public final ArrayList getThemeDescriptions() {
        ArrayList arrayList = new ArrayList();
        e eVar = new e(this, 9);
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36002b, 16, new Class[]{org.telegram.ui.Cells.ya.class, org.telegram.ui.Cells.ea.class, org.telegram.ui.Cells.v8.class, org.telegram.ui.Cells.m4.class, org.telegram.ui.Cells.c9.class, org.telegram.ui.Cells.d6.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19062d6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36002b, 32768, null, null, null, null, i10));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36002b, 4096, null, null, null, null, org.telegram.ui.ActionBar.j6.f19152i6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36002b, 0, new Class[]{View.class}, org.telegram.ui.ActionBar.j6.f19184k0, null, null, org.telegram.ui.ActionBar.j6.f19063d7));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36002b, 0, new Class[]{org.telegram.ui.Cells.e9.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.B6));
        int i11 = org.telegram.ui.ActionBar.j6.f19283p7;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36002b, 262144, new Class[]{org.telegram.ui.Cells.ea.class}, new String[]{"textView"}, null, null, -1, null, i11));
        int i12 = org.telegram.ui.ActionBar.j6.G6;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36002b, 262144, new Class[]{org.telegram.ui.Cells.ea.class}, new String[]{"textView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36002b, 0, new Class[]{org.telegram.ui.Cells.ea.class}, new String[]{"valueTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.I6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36002b, 0, new Class[]{org.telegram.ui.Cells.ea.class}, new String[]{"valueImageView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f19227m6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36002b, 0, new Class[]{org.telegram.ui.Cells.c9.class}, new String[]{"textView"}, null, null, -1, null, i12));
        int i13 = org.telegram.ui.ActionBar.j6.f19464z6;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36002b, 0, new Class[]{org.telegram.ui.Cells.c9.class}, new String[]{"valueTextView"}, null, null, -1, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36002b, 0, new Class[]{org.telegram.ui.Cells.v8.class}, new String[]{"textView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36002b, 0, new Class[]{org.telegram.ui.Cells.v8.class}, new String[]{"valueTextView"}, null, null, -1, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36002b, 0, new Class[]{org.telegram.ui.Cells.v8.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.U6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36002b, 0, new Class[]{org.telegram.ui.Cells.v8.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.V6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36002b, 0, new Class[]{org.telegram.ui.Cells.m4.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.L6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36002b, 262144, new Class[]{org.telegram.ui.Cells.m4.class}, new String[]{"textView2"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36002b, 262144, new Class[]{org.telegram.ui.Cells.m4.class}, new String[]{"textView2"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.A6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36002b, 4, new Class[]{org.telegram.ui.Cells.d6.class}, new String[]{"textView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36002b, 8388608, new Class[]{org.telegram.ui.Cells.d6.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.H6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36002b, 0, new Class[]{org.telegram.ui.Cells.ya.class}, new String[]{"nameTextView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36002b, 0, new Class[]{org.telegram.ui.Cells.ya.class}, new String[]{"statusColor"}, null, null, -1, eVar, org.telegram.ui.ActionBar.j6.f19445y6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36002b, 0, new Class[]{org.telegram.ui.Cells.ya.class}, new String[]{"statusOnlineColor"}, null, null, -1, eVar, org.telegram.ui.ActionBar.j6.f19247n6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36002b, 0, new Class[]{org.telegram.ui.Cells.ya.class}, null, org.telegram.ui.ActionBar.j6.f19313r0, null, org.telegram.ui.ActionBar.j6.J7));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(null, 0, new Class[]{org.telegram.ui.Cells.u2.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f19169j5));
        arrayList.add(new org.telegram.ui.ActionBar.l6(null, 0, new Class[]{org.telegram.ui.Cells.u2.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f19300q5));
        ...
        if (i10 != 2) {
            ...
            if (!equals) {
                if (z10) {
                    ...
                    org.telegram.ui.ActionBar.b2 b2Var = alertDialog$Builder.f18622a;
                    b2Var.R = string;
                    b2Var.T = AndroidUtilities.replaceTags(LocaleController.formatString("UserRestrictionsApplyChangesText", R.string.UserRestrictionsApplyChangesText, MessagesController.getInstance(this.currentAccount).getChat(Long.valueOf(this.f36025s)).title));
    ...
    public final void n0() {
        ...
        TLRPC.User user;
        long j3;
        int i10 = this.f36016k0;
        if (i10 >= 0) {
            org.telegram.ui.Cells.v8 v8Var = (org.telegram.ui.Cells.v8) this.f36005c.m(i10);
            if (v8Var != null) {
                TLRPC.ChatFull chatFull = this.f36032x;
    ...
    public final void p0(TLRPC.InputCheckPasswordSRP inputCheckPasswordSRP, TwoStepVerificationActivity twoStepVerificationActivity) {
        ...
        if (inputCheckPasswordSRP != null && !ChatObject.isChannel(this.f36030w)) {
            MessagesController.getInstance(this.currentAccount).convertToMegaGroup(getParentActivity(), this.f36025s, this, new b7(this, inputCheckPasswordSRP, twoStepVerificationActivity, 10));
            return;
        }
        TLRPC.TL_channels_editCreator tL_channels_editCreator = new TLRPC.TL_channels_editCreator();
        if (ChatObject.isChannel(this.f36030w)) {
            TLRPC.TL_inputChannel tL_inputChannel = new TLRPC.TL_inputChannel();
            tL_channels_editCreator.channel = tL_inputChannel;
            TLRPC.Chat chat = this.f36030w;
            tL_inputChannel.channel_id = chat.f18296id;
    ...
    public final void t0(boolean z10) {
        float f7;
        ValueAnimator valueAnimator = this.f36004b1;
        ...
        if (prVar != null) {
            ...
            this.f36004b1 = ofFloat;
            ofFloat.addUpdateListener(new eq(this, 0));
            this.f36004b1.addListener(new t4(this, 24));
            this.f36004b1.setDuration(Math.abs(this.h.f27307c - (this.H ? 1.0f : 0.0f)) * 150.0f);
            this.f36004b1.start();
        }
    }
    ...
    public final void u0(boolean z10) {
        int i10;
        int min = Math.min(this.f36026s0, this.f36027t0);
        this.W = -1;
        this.X = -1;
        this.Y = -1;
        this.Z = -1;
        ...
        if (z14) {
            ...
            if (!z12 && (!this.S.isEmpty() || (this.f36030w.creator && UserObject.isUserSelf(user)))) {
                int i32 = this.V;
                this.f36020o0 = i32;
                this.V = i32 + 2;
                this.f36029v0 = i32 + 1;
                if (this.f36030w.creator && UserObject.isUserSelf(user)) {
                    int i33 = this.V;
                    this.V = i33 + 1;
                    this.f36031w0 = i33;
                } else {
        ...
        if (z10) {
            if (min == -1 && (i10 = this.f36026s0) != -1) {
                this.f35999a.s(Math.min(i10, this.f36027t0), 2);
            } else if (min != -1 && this.f36026s0 == -1) {
                this.f35999a.t(min, 2);
            }
        }
    }
}
