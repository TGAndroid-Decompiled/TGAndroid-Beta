...
public final class nn implements rt {
    public final TLRPC.TL_messageMediaPoll f35307a;
    public final TLRPC.PollAnswer f35308b;
    public final org.telegram.ui.Cells.t1 f35309c;
    public final pn d;
    ...
    public nn(pn pnVar, TLRPC.TL_messageMediaPoll tL_messageMediaPoll, TLRPC.PollAnswer pollAnswer, org.telegram.ui.Cells.t1 t1Var) {
        this.d = pnVar;
        this.f35307a = tL_messageMediaPoll;
        this.f35308b = pollAnswer;
        this.f35309c = t1Var;
    }
    ...
    public final void J() {
        ...
        arrayList.add(this.f35308b);
        SendMessagesHelper sendMessagesHelper = this.d.f35881a.getSendMessagesHelper();
        org.telegram.ui.Cells.t1 t1Var = this.f35309c;
    ...
    public final void M(TLRPC.InputStickerSet inputStickerSet, boolean z10) {
        ...
        if (inputStickerSet != null && eoVar.getParentActivity() != null) {
            ...
            org.telegram.ui.Components.hy0 hy0Var = new org.telegram.ui.Components.hy0(eoVar.getParentActivity(), eoVar, tL_inputStickerSetID, null, eoVar.Y, eoVar.f32316ea);
    ...
    public final MessageObject y() {
        return this.f35309c.getMessageObject();
    }
