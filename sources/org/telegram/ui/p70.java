...
public final class p70 extends org.telegram.ui.ActionBar.p2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public l0 d;
    public LinearLayout f39936e;
    public LinearLayout f39937f;
    public int h;
    public AnimatorSet f39938n;
    ...
    public final View createView(Context context) {
        ...
        this.f39937f = linearLayout;
        linearLayout.setOrientation(1);
        this.f39937f.setWeightSum(100.0f);
        frameLayout.addView(this.f39937f, k7.c6.c(-1.0f, -1));
        ...
        this.f39937f.addView(frameLayout2, k7.c6.l(50.0f, -1, -1));
        ImageView imageView = new ImageView(context);
        imageView.setScaleType(ImageView.ScaleType.FIT_XY);
        frameLayout2.addView(imageView, k7.c6.c(-1.0f, -1));
        l0 l0Var = new l0(this, context, 8);
        this.d = l0Var;
        l0Var.setBackgroundColor(org.telegram.ui.ActionBar.k6.w0(null, org.telegram.ui.ActionBar.k6.f21659d6, false));
        this.f39937f.addView(this.d, k7.c6.l(50.0f, -1, -1));
        LinearLayout linearLayout2 = new LinearLayout(context);
        this.f39936e = linearLayout2;
        linearLayout2.setOrientation(1);
        this.f39936e.setPadding(AndroidUtilities.dp(10.0f), 0, AndroidUtilities.dp(10.0f), 0);
        this.d.addView(this.f39936e, k7.c6.e(-2, -2, 17));
        ...
        this.f39934b.setGravity(17);
        this.f39934b.setTypeface(Typeface.MONOSPACE);
        this.f39934b.setTextSize(1, 16.0f);
        this.f39936e.addView(this.f39934b, k7.c6.q(-2, -2, 1));
        TextView textView2 = new TextView(context);
        this.f39933a = textView2;
        textView2.setTextColor(org.telegram.ui.ActionBar.k6.w0(null, i10, false));
        this.f39933a.setLinkTextColor(org.telegram.ui.ActionBar.k6.w0(null, org.telegram.ui.ActionBar.k6.J6, false));
        this.f39933a.setTextSize(1, 16.0f);
        this.f39933a.setLinksClickable(true);
        this.f39933a.setClickable(true);
        this.f39933a.setGravity(17);
        this.f39933a.setMovementMethod(new org.telegram.ui.Components.mv(1));
        this.f39936e.addView(this.f39933a, k7.c6.e(-2, -2, 1));
        TextView textView3 = new TextView(context);
        this.f39935c = textView3;
        textView3.setTextColor(org.telegram.ui.ActionBar.k6.w0(null, i10, false));
        this.f39935c.setGravity(17);
        this.f39935c.setTextSize(1, 32.0f);
        this.d.addView(this.f39935c, k7.c6.c(-2.0f, -2));
        ...
        if (encryptedChat != null) {
            ...
            if (bArr == null) {
                ...
                q40Var.f30270a = calcAuthKeyHash;
            ...
            if (bArr2.length > 16) {
                ...
                this.f39939r = sb.toString();
            }
            this.f39934b.setText(spannableStringBuilder.toString());
            ...
            this.f39933a.setText(spannableStringBuilder);
        }
        AnimatorSet animatorSet = this.f39938n;
        if (animatorSet != null) {
            animatorSet.cancel();
            this.f39938n = null;
        }
        this.f39935c.setAlpha(0.0f);
        this.f39934b.setAlpha(1.0f);
        this.f39935c.setScaleX(0.0f);
        this.f39935c.setScaleY(0.0f);
        this.f39934b.setScaleX(1.0f);
        this.f39934b.setScaleY(1.0f);
        this.f39935c.setTag(Integer.valueOf(org.telegram.ui.ActionBar.k6.Me));
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        TextView textView;
        if (i10 == NotificationCenter.emojiLoaded && (textView = this.f39935c) != null) {
            textView.invalidate();
        }
    }
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.m6(this.d, 1, null, null, null, null, org.telegram.ui.ActionBar.k6.f21659d6));
        ...
        TextView textView = this.f39933a;
        int i10 = org.telegram.ui.ActionBar.k6.B6;
        arrayList.add(new org.telegram.ui.ActionBar.m6(textView, 4, null, null, null, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.m6(this.f39934b, 4, null, null, null, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.m6(this.f39933a, 2, null, null, null, null, org.telegram.ui.ActionBar.k6.J6));
        return arrayList;
    }
    ...
    public final void onTransitionAnimationEnd(boolean z4, boolean z10) {
        String str;
        if (z4 && !z10 && (str = this.f39939r) != null) {
            TextView textView = this.f39935c;
