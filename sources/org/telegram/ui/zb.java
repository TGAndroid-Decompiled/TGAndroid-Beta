...
public final class zb implements RequestDelegate {
    ...
    public final cc f40128b;
    public final CountDownLatch f40129c;
    public final Runnable d;

    public zb(cc ccVar, CountDownLatch countDownLatch, Runnable runnable, int i10) {
        this.f40127a = i10;
        this.f40128b = ccVar;
        this.f40129c = countDownLatch;
        this.d = runnable;
    }
    ...
    public final void run(final TLObject tLObject, TLRPC.TL_error tL_error) {
        switch (this.f40127a) {
            case 0:
                final cc ccVar = this.f40128b;
                final CountDownLatch countDownLatch = this.f40129c;
                        ...
                        switch (r5) {
                            case 0:
                                ...
                                if (tLObject2 != null) {
                                    ...
                                    boolean z10 = false;
                                    MessagesController.getInstance(ccVar2.f32741b).putUsers(tL_premium_boostsList.users, false);
                                    ...
                                    while (true) {
                                        ...
                                        if (i11 < size) {
                                            ...
                                            ccVar2.f32746s = Math.max(0, tL_premium_boostsList.count - i10);
                                            if (!TextUtils.isEmpty(tL_premium_boostsList.next_offset) && ccVar2.f32746s > 0) {
                                                z10 = true;
                                            }
                                            ccVar2.f32745r = z10;
                            ...
                            default:
                                cc ccVar3 = ccVar;
                                ArrayList arrayList2 = ccVar3.f32744n;
                                ...
                                if (tLObject3 != null) {
                                    ...
                                    boolean z11 = false;
                                    MessagesController.getInstance(ccVar3.f32741b).putUsers(tL_premium_boostsList2.users, false);
                                    ...
                                    while (true) {
                                        ...
                                        if (i15 < size2) {
                                            ...
                                            ccVar3.f32747w = Math.max(0, tL_premium_boostsList2.count - i14);
                                            if (!TextUtils.isEmpty(tL_premium_boostsList2.next_offset) && ccVar3.f32747w > 0) {
                                                z11 = true;
                                            }
                                            ccVar3.v = z11;
                ...
                return;
            default:
                final cc ccVar2 = this.f40128b;
                final CountDownLatch countDownLatch2 = this.f40129c;
                        ...
                        switch (r5) {
                            case 0:
                                ...
                                if (tLObject2 != null) {
                                    ...
                                    TL_stories.TL_premium_boostsList tL_premium_boostsList = (TL_stories.TL_premium_boostsList) tLObject2;
                                    boolean z10 = false;
                                    MessagesController.getInstance(ccVar22.f32741b).putUsers(tL_premium_boostsList.users, false);
                                    ...
                                    while (true) {
                                        ...
                                        if (i11 < size) {
                                            ...
                                            ccVar22.f32746s = Math.max(0, tL_premium_boostsList.count - i10);
                                            if (!TextUtils.isEmpty(tL_premium_boostsList.next_offset) && ccVar22.f32746s > 0) {
                                                z10 = true;
                                            }
                                            ccVar22.f32745r = z10;
