...
public final class zb extends og.b {
    ...
    public final boolean D(s4.c1 c1Var) {
        return ((ac) this.f40432f.f32381x.get(c1Var.b())).f15716b;
    }

    @Override
    public final int h() {
        return this.f40432f.f32381x.size();
    }

    @Override
    public final int j(int i10) {
        return ((ac) this.f40432f.f32381x.get(i10)).f15715a;
    }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        int i12;
        int i13;
        bc bcVar = this.f40432f;
        int i14 = bcVar.f32374b;
        TLRPC.Chat chat = bcVar.J;
        ArrayList arrayList = bcVar.f32381x;
        ...
        if (i15 != 4) {
            if (i15 != 1 && i15 != 12) {
                if (i15 == 0) {
                    ...
                    bVar.d(user, ContactsController.formatName(user), formatString, !((ac) arrayList.get(i10)).f32094f);
                    bVar.setStatus(boost);
                    bVar.setAvatarPadding(5);
                    return;
                } else if (i15 == 6) {
                    ((org.telegram.ui.Cells.e9) view).setText(((ac) arrayList.get(i10)).f32093c);
                    return;
                } else if (i15 == 9) {
                    org.telegram.ui.Cells.y4 y4Var = (org.telegram.ui.Cells.y4) view;
                    if (bcVar.f32382y == 0) {
                        y4Var.b(LocaleController.formatPluralString("BoostingShowMoreBoosts", bcVar.f32379s, new Object[0]), R.drawable.arrow_more, 5, false);
                        return;
                    } else {
                        y4Var.b(LocaleController.formatPluralString("BoostingShowMoreGifts", bcVar.f32380w, new Object[0]), R.drawable.arrow_more, 5, false);
                        return;
                    }
                } else if (i15 == 3) {
                    ((org.telegram.ui.Components.h90) view).setLink(((ac) arrayList.get(i10)).f32093c);
                    return;
                } else if (i15 == 11) {
                    ac acVar = (ac) arrayList.get(i10);
                    TL_stories.PrepaidGiveaway prepaidGiveaway = acVar.e;
                    boolean z10 = acVar.f32094f;
                    yg.c cVar = (yg.c) view;
                    ...
                    if (i16 != i17 || this.e != bcVar.O) {
                        ...
                        this.e = bcVar.O;
                        bcVar.f32376f.g();
                        bcVar.f32376f.a(0, LocaleController.formatPluralString("BoostingBoostsCount", bcVar.P, new Object[0]), null);
                        if (MessagesController.getInstance(i14).giveawayGiftsPurchaseAvailable && (i11 = bcVar.O) > 0 && i11 != bcVar.P) {
                            bcVar.f32376f.a(1, LocaleController.formatPluralString("BoostingGiftsCount", i11, new Object[0]), null);
                        }
                        bcVar.f32376f.setInitialTabId(bcVar.f32382y);
                        bcVar.f32376f.c();
                        return;
                    }
                    return;
            ...
            cVar2.setTitle(((ac) arrayList.get(i10)).f32093c);
            cVar2.c(false);
            if (c1Var.f42962f == 12) {
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        switch (i10) {
            ...
            case 1:
                ...
                break;
            case 2:
                m6Var = new org.telegram.ui.Cells.b7(viewGroup.getContext(), org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19003a7, false), 0);
                break;
            case 3:
                org.telegram.ui.Components.h90 h90Var = new org.telegram.ui.Components.h90(bcVar.getContext(), bcVar.f32375c, null, false, false);
                h90Var.d.setVisibility(8);
                h90Var.f24726a.setGravity(17);
                h90Var.h.setVisibility(8);
                h90Var.v.setVisibility(8);
                h90Var.setPadding(AndroidUtilities.dp(11.0f), 0, AndroidUtilities.dp(11.0f), AndroidUtilities.dp(24.0f));
                m6Var = h90Var;
                break;
            case 4:
            ...
            case 13:
                ...
                bcVar.f32376f = scrollSlidingTextTabStrip;
                ...
                bcVar.f32376f.setDelegate(new g(this, 11));
                m6Var2.addView(bcVar.f32376f, w7.y5.c(48.0f, -2));
                m6Var = m6Var2;
                break;
            default:
