...
public final class db1 extends View {
    public static final int f33573c = 0;
    public final Paint f33574a;
    public int[] f33575b;

    public db1(Context context) {
        super(context);
        this.f33574a = new Paint(1);
        this.f33575b = new int[7];
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        Paint paint = this.f33574a;
        paint.setStyle(style);
        int i10 = 0;
        paint.setColor(this.f33575b[0]);
        canvas.drawCircle(measuredWidth, measuredHeight, dp, paint);
        double d = 0.0d;
        while (i10 < 6) {
            i10++;
            paint.setColor(this.f33575b[i10]);
