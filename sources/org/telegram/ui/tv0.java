...
public final class tv0 implements org.telegram.ui.Components.b5, GenericProvider, org.telegram.ui.ActionBar.b2, MediaDataController.KeywordResultCallback, org.telegram.ui.Components.bl0, org.telegram.ui.Components.cl0, bw0, MessagesStorage.BooleanCallback, x11, OnSuccessListener, pa.a, OnFailureListener, t5.b, s5.e {
    ...
    public void J(int i10, int i11, boolean z10) {
        cw0 cw0Var = ((uv0) this.f37873b).f38231a;
        cw0Var.f32937e0.a((TLRPC.TL_messageMediaPoll) this.f37874c);
        cw0Var.finishFragment();
    }

    @Override
    public void a(TLRPC.MessageMedia messageMedia) {
        me1 me1Var = (me1) this.f37873b;
        bo boVar = (bo) this.f37874c;
    ...
    public Object apply(Object obj) {
        i5.d[] values;
        s5.g gVar = (s5.g) this.f37873b;
        l5.i iVar = (l5.i) this.f37874c;
        SQLiteDatabase sQLiteDatabase = (SQLiteDatabase) obj;
        s5.a aVar = gVar.d;
        ArrayList d = gVar.d(sQLiteDatabase, iVar, aVar.f42868b);
        for (i5.d dVar : i5.d.values()) {
            if (dVar != iVar.f13909c) {
                int size = aVar.f42868b - d.size();
                if (size <= 0) {
                    break;
                }
        ...
        for (int i10 = 0; i10 < d.size(); i10++) {
            sb2.append(((s5.b) d.get(i10)).f42870a);
            if (i10 < d.size() - 1) {
                sb2.append(',');
            }
        }
        ...
        while (listIterator.hasNext()) {
            ...
            long j10 = bVar.f42870a;
            if (hashMap.containsKey(Long.valueOf(j10))) {
                com.google.firebase.messaging.n c10 = bVar.f42872c.c();
                for (s5.f fVar : (Set) hashMap.get(Long.valueOf(j10))) {
                    c10.c(fVar.f42873a, fVar.f42874b);
                }
                listIterator.set(new s5.b(j10, bVar.f42871b, c10.g()));
            }
        }
        return d;
    }
    ...
    public void c(float f7, float f10, int i10, View view) {
        ThemeActivity.W((ThemeActivity) this.f37873b, (Context) this.f37874c, view, i10, f7);
    }

    @Override
    public boolean d(int i10, View view) {
        String str;
        final hc1 hc1Var = (hc1) this.f37873b;
        final jc1 jc1Var = (jc1) this.f37874c;
        ...
        if (i10 >= 0 && i10 < jc1Var.e.size()) {
            ...
            if (h6Var.f18720a >= 100 && !h6Var.f18741z) {
                    ...
                    public final void onClick(DialogInterface dialogInterface, int i11) {
                        ...
                        if (themeActivity2.getParentActivity() != null) {
                            ...
                            if (i11 == 0) {
                                ...
                                org.telegram.ui.Components.c5.W(themeActivity2, i12, h6Var2.f18721b, h6Var2);
                            } else if (i11 == 1) {
                                if (h6Var2.f18734r == null) {
                                    themeActivity2.getMessagesController().saveThemeToServer(h6Var2.f18721b, h6Var2);
                                    NotificationCenter.getGlobalInstance().lambda$postNotificationNameOnUIThread$1(NotificationCenter.needShareTheme, h6Var2.f18721b, h6Var2);
                                    return;
                                }
                                String str2 = "https://" + themeActivity2.getMessagesController().linkPrefix + "/addtheme/" + h6Var2.f18734r.slug;
                                ...
                                themeActivity2.presentFragment(new ce1(h6Var2.f18721b, h6Var2, false));
    ...
    public void f(org.telegram.ui.ActionBar.c2 c2Var, int i10) {
        ...
        switch (this.f37872a) {
            case 2:
                ((PrivacyControlActivity) this.f37873b).t0();
                ((SharedPreferences) this.f37874c).edit().putBoolean("privacyAlertShowed", true).commit();
                return;
            case 3:
                PrivacySettingsActivity privacySettingsActivity = (PrivacySettingsActivity) this.f37873b;
                ...
                privacySettingsActivity.getConnectionsManager().sendRequest(tL_payments_clearSavedInfo, new dc0(14, privacySettingsActivity, (org.telegram.ui.Cells.w8) this.f37874c));
                return;
            case 4:
                ProfileActivity.c0((ProfileActivity) this.f37873b, (org.telegram.ui.Cells.z1[]) this.f37874c);
                return;
            case 5:
                j01 j01Var = (j01) this.f37873b;
                TLRPC.User user = (TLRPC.User) this.f37874c;
                j01Var.getClass();
            ...
            case 19:
            default:
                rg.j0.Q((rg.j0) this.f37873b, (ArrayList) this.f37874c);
                return;
            case 8:
                s71 s71Var = (s71) this.f37873b;
                TLRPC.User user2 = (TLRPC.User) this.f37874c;
                ...
                if (U != null) {
                    ...
                    twoStepVerificationActivity.f31604b0 = c7Var;
                    U.presentFragment(twoStepVerificationActivity);
                    return;
                }
                return;
            case 9:
                ib1.m((ib1) this.f37873b, (wy) this.f37874c);
                return;
            case 10:
                ThemeActivity.X((ThemeActivity) this.f37873b, (ky0) this.f37874c);
                return;
            case 13:
                hc1 hc1Var = (hc1) this.f37873b;
                org.telegram.ui.ActionBar.i6 i6Var = (org.telegram.ui.ActionBar.i6) this.f37874c;
                hc1Var.getClass();
                ...
                if (i6Var.f18758b == null) {
                    ...
                    hashMap.remove(i6Var.f18756a);
                    org.telegram.ui.ActionBar.c6 c6Var = i6Var.f18768i0;
                    if (c6Var != null) {
                ...
                return;
            case 17:
                ih1.W((ih1) this.f37873b, (byte[]) this.f37874c);
                return;
            case 18:
                ti1 ti1Var = (ti1) this.f37873b;
                ti1Var.getClass();
                ((boolean[]) this.f37874c)[0] = true;
                ti1Var.f37787p0 = 17;
            ...
            case 20:
                ((e2.h) this.f37873b).accept(Boolean.TRUE);
                ((boolean[]) this.f37874c)[0] = true;
                c2Var.dismiss();
                return;
            case 21:
                org.telegram.ui.web.p.Y((org.telegram.ui.web.p) this.f37873b, (HashSet) this.f37874c);
                return;
            case 22:
                org.telegram.ui.web.d1 d1Var = (org.telegram.ui.web.d1) this.f37873b;
                ...
                ConnectionsManager.getInstance(d1Var.M).sendRequest(allowsendmessage, new ai.t5(d1Var, (String[]) this.f37874c, c2Var, 15));
                return;
            case 23:
                boolean[] zArr2 = (boolean[]) this.f37873b;
                JsPromptResult jsPromptResult = (JsPromptResult) this.f37874c;
                if (!zArr2[0]) {
                    zArr2[0] = true;
    ...
    public Object i() {
        switch (this.f37872a) {
            case 26:
                Iterable iterable = (Iterable) this.f37874c;
                s5.g gVar = (s5.g) ((s5.d) ((da.b) this.f37873b).f7583c);
                gVar.getClass();
                ...
                return null;
            default:
                da.b bVar = (da.b) this.f37873b;
                for (Map.Entry entry : ((HashMap) this.f37874c).entrySet()) {
    ...
    public void j(pa.b bVar) {
        ((pa.a) this.f37873b).j(bVar);
        ((pa.a) this.f37874c).j(bVar);
    }

    @Override
    public void onFailure(Exception exc) {
        qg.a2 a2Var = (qg.a2) this.f37873b;
        Bitmap bitmap = (Bitmap) this.f37874c;
        a2Var.B0 = false;
        FileLog.e(exc);
    ...
    public void onSuccess(Object obj) {
        ...
        FileLog.d("wear-auth: /token delivered to " + ((String) ((cf.c) this.f37873b).d));
        ((ci.d) this.f37874c).setLoading(false);
        kj1.d = null;
        org.telegram.ui.ActionBar.g3 g3Var = kj1.f35296c;
        if (g3Var != null) {
            g3Var.dismiss();
            kj1.f35296c = null;
        }
    ...
    public Object provide(Object obj) {
        jx0 jx0Var = (jx0) this.f37874c;
        Void r10 = (Void) obj;
        PremiumPreviewFragment premiumPreviewFragment = ((kx0) this.f37873b).d.f35647n;
        premiumPreviewFragment.f31185n0.d(0, 0.0f, 0, jx0Var.getMeasuredWidth(), -jx0Var.getTier().h, premiumPreviewFragment.O);
        return premiumPreviewFragment.f31185n0.f42578f;
    }

    @Override
    public void run(boolean z10) {
        TLRPC.Chat chat = (TLRPC.Chat) this.f37874c;
        fg1 fg1Var = ((pf1) this.f37873b).f36620b;
    ...
    public void v(vk0 vk0Var) {
        lg1 lg1Var = ((ig1) this.f37873b).f34564a;
        lg1Var.e.add(Integer.valueOf(((TLRPC.TL_forumTopic) this.f37874c).f18173id));
        lg1Var.V();
    }
    ...
    public tv0(uv0 uv0Var, TLRPC.TL_messageMediaPoll tL_messageMediaPoll, ArrayList arrayList) {
        this.f37872a = 0;
        this.f37873b = uv0Var;
        this.f37874c = tL_messageMediaPoll;
    }

    @Override
    public void run(ArrayList arrayList, String str) {
        LinkedHashSet linkedHashSet = (LinkedHashSet) this.f37873b;
        Runnable runnable = (Runnable) this.f37874c;
