...
public class ProfileStoriesCollectionTabs extends BlurredFrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public class Adapter extends ViewPagerFixed.Adapter {
        ...
        public void applyReorder(ArrayList<Integer> arrayList) {
            ...
            StoriesController.StoriesCollections storiesCollections = ProfileStoriesCollectionTabs.this.collections;
            ...
            while (i < size3) {
                ...
                num3.getClass();
                StoriesController.StoryAlbum storyAlbum2 = (StoriesController.StoryAlbum) map.get(num3);
                if (storyAlbum2 != null) {
    ...
    public ProfileStoriesCollectionTabs(Context context, SizeNotifierFrameLayout sizeNotifierFrameLayout, StoriesController.StoriesCollections storiesCollections, final Delegate delegate) {
        super(context, sizeNotifierFrameLayout);
        this.clipRect = new Rect();
        this.collections = storiesCollections;
        Objects.requireNonNull(storiesCollections);
        this.sendCollectionsOrder = new MainTabsLayout$$ExternalSyntheticLambda0(storiesCollections, 19);
        ...
        final int i = 0;
        tabsViewCreateTabsView.setPreTabClick(new Utilities.Callback2Return(this) {
            ...
            public final Object run(Object obj, Object obj2) {
                ...
                switch (i) {
                    case 0:
                        return this.f$0.lambda$new$0(delegate, num, (Integer) obj2);
                    default:
                        return this.f$0.lambda$new$1(delegate, num, (View) obj2);
                }
            }
        });
        final int i2 = 1;
        tabsViewCreateTabsView.setOnTabLongClick(new Utilities.Callback2Return(this) {
            public final ProfileStoriesCollectionTabs f$0;
    ...
    private void setVisibility(boolean z, boolean z2, boolean z3) {
        if (this.visibilityValue != z || z3) {
            ...
            if (!z2) {
                ...
                this.visibilityAnimator.addUpdateListener(new QrActivity$$ExternalSyntheticLambda8(this, 13));
    ...
    public void setReorderingAlbums(boolean z) {
        ...
        if (z) {
            ...
            if (safeLastFragment instanceof ProfileActivity) {
                ...
                AndroidUtilities.runOnUIThread(new LinkManager$$ExternalSyntheticLambda1((ProfileActivity) safeLastFragment, 27));
            }
        }
        if (z) {
            return;
