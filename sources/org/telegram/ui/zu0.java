            ...
            if (hv0Var.f37641a0) {
                ...
                for (int i20 = 0; i20 < charSequenceArr.length; i20++) {
                    if (!TextUtils.isEmpty(org.telegram.ui.Components.sn.Y(charSequenceArr[i20]))) {
                        ...
                        int[] iArr2 = hv0Var.f37662r;
                        if (iArr2 != null && i20 < iArr2.length) {
                            todoItem.f20988id = iArr2[i20];
                        } else {
                            i15++;
                            todoItem.f20988id = i15;
                        }
                ...
                hv0Var.f37643b0.a(tL_messageMediaToDo);
                hv0Var.finishFragment();
            } else if (!hv0Var.I || hv0Var.f37640a.getAlpha() == 1.0f) {
                ...
                ArrayList arrayList = new ArrayList(hv0Var.f37657n);
                int i23 = 0;
                while (i23 < charSequenceArr.length) {
                    if (!TextUtils.isEmpty(org.telegram.ui.Components.sn.Y(charSequenceArr[i23]))) {
                        CharSequence[] charSequenceArr5 = new CharSequence[1];
                        charSequenceArr5[i17] = org.telegram.ui.Components.sn.Y(charSequenceArr[i23]);
                ...
                hv0Var.f37643b0.a(tL_messageMediaPoll);
                hv0Var.finishFragment();
            } else {
                int i25 = 0;
                ...
                if (i25 <= 0) {
                    ...
                    for (int i26 = hv0Var.f37655k0; i26 < hv0Var.f37655k0 + hv0Var.f37673y; i26++) {
                        f2.m1 K = hv0Var.f37644c.K(i26);
                        if (K != null) {
                            View view = K.f5875a;
