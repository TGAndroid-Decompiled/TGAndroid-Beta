...
public final class zu0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    public final FrameLayout f43517a;
    public final bi.g5 f43518b;
    public final org.telegram.ui.ActionBar.j5[] f43519c;
    public final org.telegram.ui.Components.q6 d;
    public AnimatorSet f43520e;
    public AnimatorSet f43521f;
    public boolean h;
    public ValueAnimator f43522n;
    public float f43523r;
    public int f43524s;

    public zu0(Activity activity) {
        super(activity);
        FrameLayout frameLayout = new FrameLayout(activity);
        this.f43517a = frameLayout;
        ...
        this.f43519c = new org.telegram.ui.ActionBar.j5[2];
        for (int i10 = 0; i10 < 2; i10++) {
            this.f43519c[i10] = new org.telegram.ui.ActionBar.j5(activity);
            this.f43519c[i10].setGravity(19);
            this.f43519c[i10].setTextColor(-1);
            this.f43519c[i10].setTextSize(20);
            this.f43519c[i10].setTypeface(AndroidUtilities.bold());
            this.f43519c[i10].setDrawablePadding(AndroidUtilities.dp(4.0f));
            this.f43519c[i10].setScrollNonFitText(true);
            this.f43518b.addView(this.f43519c[i10], w7.x5.e(-1, -2, 19));
        }
        ...
        this.f43517a.addView(q6Var, w7.x5.d(-1, 20.0f, 51, 16.0f, 0.0f, 0.0f, 0.0f));
    }
    ...
    public final void a(CharSequence charSequence, boolean z10) {
        ...
        if (z12 != z13) {
            this.h = z12;
            AnimatorSet animatorSet = this.f43521f;
            if (animatorSet != null) {
                animatorSet.cancel();
            }
            ...
            if (z10) {
                ...
                this.f43521f = animatorSet2;
                animatorSet2.playTogether(arrayList);
                this.f43521f.setInterpolator(org.telegram.ui.Components.pr.h);
                this.f43521f.start();
            } else {
                if (!isEmpty) {
                    f7 = 1.0f;
    ...
    public final void b(boolean z10) {
        int i10;
        int i11;
        org.telegram.ui.ActionBar.j5[] j5VarArr = this.f43519c;
        int i12 = 0;
    ...
    public final void d(CharSequence charSequence, boolean z10, boolean z11) {
        ...
        AnimatorSet animatorSet = this.f43520e;
        if (animatorSet != null) {
            animatorSet.cancel();
            this.f43520e = null;
        }
        ...
        j5VarArr[1].setRightPadding((int) this.f43523r);
        ...
        AnimatorSet animatorSet2 = new AnimatorSet();
        this.f43520e = animatorSet2;
        animatorSet2.playTogether(arrayList);
        this.f43520e.addListener(new gk0(this, 12));
        this.f43520e.setDuration(320L);
        this.f43520e.setInterpolator(org.telegram.ui.Components.pr.h);
        this.f43520e.start();
    }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        this.f43517a.layout(0, AndroidUtilities.statusBarHeight, i12 - i10, i13 - i11);
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f43517a.measure(View.MeasureSpec.makeMeasureSpec(size, 1073741824), View.MeasureSpec.makeMeasureSpec(size2 - i12, 1073741824));
