...
public final class r50 extends Dialog {
    public final ai.n4 f37027a;
    public final s50 f37028b;
    public Bitmap f37029c;
    public Paint d;
    public BitmapShader e;
    public final Matrix f37030f;
    public float h;
    public ValueAnimator f37031n;
    public boolean f37032r;

    public r50(Context context, s50 s50Var) {
        super(context, R.style.TransparentDialog);
        this.f37030f = new Matrix();
        this.f37028b = s50Var;
    ...
    public final void b(float f7, q50 q50Var) {
        ValueAnimator valueAnimator = this.f37031n;
        if (valueAnimator != null) {
            valueAnimator.cancel();
            this.f37031n = null;
        }
        ValueAnimator ofFloat = ValueAnimator.ofFloat(this.h, f7);
        this.f37031n = ofFloat;
        ofFloat.addUpdateListener(new b3(this, 16));
        this.f37031n.addListener(new ai.t2(this, f7, q50Var, 3));
        this.f37031n.setDuration(420L);
        this.f37031n.setInterpolator(org.telegram.ui.Components.qr.h);
        this.f37031n.start();
    }
    ...
    public final void onCreate(Bundle bundle) {
        ...
        setContentView(this.f37027a, new ViewGroup.LayoutParams(-1, -1));
