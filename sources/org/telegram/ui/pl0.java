...
public final class pl0 implements Runnable {
    ...
    public final void run() {
        ...
        switch (this.f36658a) {
            case 0:
                org.telegram.ui.ActionBar.g1 g1Var = (org.telegram.ui.ActionBar.g1) this.f36660c;
                PasscodeActivity passcodeActivity = ((ql0) this.f36659b).f36937b;
                ...
                if (passcodeActivity.e0()) {
                    ...
                    AndroidUtilities.updateViewVisibilityAnimated(passcodeActivity.f30907s, true, 0.1f, false);
                    return;
                }
                return;
            case 1:
                ((PasskeysActivity) this.f36659b).Y((TL_account.Passkey) this.f36660c);
                return;
            case 2:
                qn0 qn0Var = (qn0) this.f36659b;
                MrzRecognizer.Result result = (MrzRecognizer.Result) this.f36660c;
                int[] iArr = qn0Var.f36999x;
                int i16 = result.type;
                if (i16 == 2) {
                ...
                return;
            case 3:
                qn0 qn0Var2 = (qn0) this.f36659b;
                TLObject tLObject = (TLObject) this.f36660c;
                if (tLObject != null) {
                ...
                return;
            case 4:
                qn0 qn0Var3 = (qn0) this.f36659b;
                TLRPC.TL_error tL_error = (TLRPC.TL_error) this.f36660c;
                if (tL_error == null) {
                    qn0Var3.f36962f1 = true;
                    qn0Var3.W0(true);
            ...
            case 5:
                ((ln0) this.f36659b).f35595a.K = ((TLRPC.TL_error) this.f36660c).text;
                return;
            case 6:
                ((yo0) this.f36659b).D0(false);
                ((View) this.f36660c).callOnClick();
                return;
            case 7:
                yo0 yo0Var = (yo0) this.f36659b;
                TLRPC.TL_error tL_error2 = (TLRPC.TL_error) this.f36660c;
                yo0Var.H0(true, false);
                if (tL_error2 == null) {
                    if (yo0Var.getParentActivity() != null) {
                        vn0 vn0Var = yo0Var.f39958d0;
                        if (vn0Var != null) {
                            AndroidUtilities.cancelRunOnUIThread(vn0Var);
                            yo0Var.f39958d0 = null;
                        }
                        yo0Var.t0();
                        return;
                    }
                    ...
                    j3Var2.f20307a.setText("");
                    j3Var2.f20308b = false;
            ...
            case 8:
                yo0.W((yo0) this.f36659b, (TLRPC.TL_payments_validatedRequestedInfo) this.f36660c);
                return;
            case 9:
                yo0 yo0Var2 = (yo0) this.f36659b;
                TLRPC.Message[] messageArr = (TLRPC.Message[]) this.f36660c;
                ...
                if (parentActivity != null) {
                    yo0Var2.f39951a1 = true;
                    yo0Var2.f39964f1 = 1;
                    TLRPC.InputInvoice inputInvoice = yo0Var2.f39954b1;
                    ...
                    if (z12) {
                        ...
                        formatString = LocaleController.formatString(R.string.PaymentInfoHint, yo0Var2.R0[0], yo0Var2.f39975q0);
                    }
                ...
                return;
            case 10:
                PhotoViewer photoViewer = (PhotoViewer) this.f36659b;
                j41.T(photoViewer.E, photoViewer.f31025m4, false, (ai.d) this.f36660c, null);
                return;
            case 11:
                PhotoViewer photoViewer2 = (PhotoViewer) this.f36659b;
                it0 it0Var = (it0) this.f36660c;
            ...
            case 12:
                ...
                ((org.telegram.messenger.f2) this.f36659b).run((Bitmap) this.f36660c);
                return;
            case 13:
                PhotoViewer photoViewer3 = (PhotoViewer) this.f36659b;
                qg.z0 z0Var = (qg.z0) this.f36660c;
                Drawable[] drawableArr3 = PhotoViewer.U8;
                z0Var.e.h();
                z0Var.f41753c.postRunnable(new p91(10));
                photoViewer3.f30954e0.removeView(photoViewer3.N1);
                return;
            case 14:
                org.telegram.ui.Components.b6 b6Var = (org.telegram.ui.Components.b6) this.f36659b;
                Bitmap bitmap = (Bitmap) this.f36660c;
                Drawable[] drawableArr4 = PhotoViewer.U8;
                if (b6Var != null) {
                    ArrayList arrayList = b6Var.h;
                    org.telegram.ui.Components.y5 y5Var = b6Var.f22599n;
                    if (y5Var != null) {
                        arrayList.add(y5Var);
                    }
                    org.telegram.ui.Components.y5 y5Var2 = b6Var.f22604r;
                    if (y5Var2 != null) {
                        arrayList.add(y5Var2);
                    }
                    org.telegram.ui.Components.y5 y5Var3 = b6Var.f22606s;
                    if (y5Var3 != null) {
                        arrayList.add(y5Var3);
                    }
                    b6Var.f22599n = new org.telegram.ui.Components.y5(bitmap);
                    b6Var.f22604r = null;
                    b6Var.f22606s = null;
                    b6Var.t();
                    return;
                ...
                return;
            case 15:
                js0 js0Var = (js0) this.f36659b;
                js0Var.getClass();
                ((View) this.f36660c).setOutlineProvider(null);
                PhotoViewer photoViewer4 = js0Var.f34934c;
                ImageView imageView = photoViewer4.f31126x3;
                if (imageView != null) {
                ...
                return;
            case 16:
                tt0 tt0Var = (tt0) this.f36659b;
                org.telegram.ui.Components.h71 h71Var = (org.telegram.ui.Components.h71) this.f36660c;
                tt0Var.getClass();
                if (h71Var.p() > 0 && h71Var.n() >= h71Var.p() - 590) {
                    tt0Var.f37870a.f30954e0.invalidate();
                    return;
                }
                return;
            case 17:
                xt0 xt0Var = (xt0) this.f36659b;
                qg.z0 z0Var2 = (qg.z0) this.f36660c;
                z0Var2.e.h();
                z0Var2.f41753c.postRunnable(new p91(10));
                try {
                    xt0Var.f39704b.f30954e0.removeView(z0Var2);
                    return;
                } catch (Exception e) {
                    FileLog.e(e);
                    return;
            ...
            case 18:
                ci.n6 n6Var = (ci.n6) this.f36660c;
                PhotoViewer photoViewer5 = ((ct0) this.f36659b).f32916b;
                if (photoViewer5.C3 != null) {
                    ImageView imageView2 = photoViewer5.f31126x3;
                    if (imageView2 != null) {
                        imageView2.setVisibility(0);
                        photoViewer5.f31126x3.setImageBitmap(photoViewer5.C3);
                    }
                ...
                return;
            case 19:
                ((hu0) this.f36659b).f34357r.f31020l7.lock();
                ((AnimatorSet) this.f36660c).start();
                return;
            case 20:
                fv0 fv0Var = (fv0) this.f36660c;
                ((hu0) this.f36659b).f34357r.f31080s4 = false;
                if (!fv0Var.f33782s) {
                    fv0Var.f33767a.setVisible(false, true);
                    return;
                }
                return;
            case 21:
                ow0 ow0Var = (ow0) this.f36659b;
                ow0Var.getClass();
                AndroidUtilities.addToClipboard((String) this.f36660c);
                ow0Var.c(true);
                return;
            case 22:
                ow0 ow0Var2 = (ow0) this.f36659b;
                ow0Var2.getClass();
                AndroidUtilities.addToClipboard(MessageObject.formatTextWithEntities(((TLRPC.PollAnswer) this.f36660c).text, false));
                ow0Var2.c(true);
                return;
            case 23:
                ow0 ow0Var3 = (ow0) this.f36659b;
                SendMessagesHelper.getInstance(ow0Var3.H.currentAccount).deletePollOption(ow0Var3.H, (byte[]) this.f36660c);
                ow0Var3.c(true);
                return;
            case 24:
                PrivacyControlActivity.W((PrivacyControlActivity) this.f36659b, (TLObject) this.f36660c);
                return;
            case 25:
                PrivacyControlActivity privacyControlActivity = (PrivacyControlActivity) this.f36659b;
                boolean[] zArr = (boolean[]) this.f36660c;
                ...
                return;
            case 26:
                PrivacySettingsActivity privacySettingsActivity = (PrivacySettingsActivity) this.f36659b;
                privacySettingsActivity.d = (TL_account.Password) this.f36660c;
                privacySettingsActivity.y0();
                return;
            case 27:
                PrivacySettingsActivity privacySettingsActivity2 = (PrivacySettingsActivity) this.f36659b;
                boolean z13 = !privacySettingsActivity2.V;
                privacySettingsActivity2.V = z13;
                ((org.telegram.ui.Cells.w8) this.f36660c).setChecked(z13);
                return;
            case 28:
                ((iy0) this.f36659b).getMessagesController().unblockPeer(((Long) this.f36660c).longValue());
                return;
            default:
                ProfileActivity profileActivity = (ProfileActivity) this.f36659b;
                ...
                bundle.putInt("enc_id", ((TLRPC.EncryptedChat) ((Object[]) this.f36660c)[0]).f18129id);
