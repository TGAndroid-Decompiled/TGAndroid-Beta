...
public final class ip implements org.telegram.ui.Components.zk0 {
    ...
    public final void a(int i10, View view) {
        ...
        int i12;
        int i13;
        kp kpVar = this.f37419a;
        lp lpVar = kpVar.f38100a3;
        if ((view instanceof na) && (tL_username = ((na) view).v) != null) {
            if (tL_username.editable) {
                View view2 = lpVar.fragmentView;
                if (view2 instanceof ScrollView) {
                    ((ScrollView) view2).smoothScrollTo(0, lpVar.f38452y.getTop() - AndroidUtilities.dp(128.0f));
                }
                lpVar.f38423a.requestFocus();
                AndroidUtilities.showKeyboard(lpVar.f38423a);
                return;
            }
