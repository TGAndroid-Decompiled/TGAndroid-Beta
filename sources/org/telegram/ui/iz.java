...
public final class iz extends LinearLayout {
    public final org.telegram.ui.ActionBar.f6 f35047a;
    public final FrameLayout f35048b;
    public final org.telegram.ui.Components.p9 f35049c;
    public final FrameLayout d;
    public final FrameLayout e;
    public final org.telegram.ui.Components.p9 f35050f;
    public final FrameLayout h;
    public ValueAnimator f35051n;
    ...
    public iz(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        int i12 = org.telegram.ui.ActionBar.j6.f19935g6;
    ...
    public final void a(boolean z4, boolean z10) {
        ...
        float f22;
        float f23;
        ValueAnimator valueAnimator = this.f35051n;
        if (valueAnimator != null) {
            valueAnimator.cancel();
            this.f35051n = null;
        }
        org.telegram.ui.Components.p9 p9Var = this.f35050f;
        org.telegram.ui.Components.p9 p9Var2 = this.f35049c;
        ...
        if (z10) {
            ...
            scaleY2.alpha(f23).setInterpolator(mrVar).setDuration(320L).start();
            float f25 = this.f35052r;
            if (!z4) {
                f24 = 0.0f;
            }
            ValueAnimator ofFloat = ValueAnimator.ofFloat(f25, f24);
            this.f35051n = ofFloat;
            ofFloat.addUpdateListener(new g3(this, 11));
            this.f35051n.addListener(new org.telegram.ui.Components.m00(19, this, z4));
            this.f35051n.setInterpolator(mrVar);
            this.f35051n.setDuration(320L);
            this.f35051n.start();
        } else {
            ...
            org.telegram.ui.ActionBar.f6 f6Var = this.f35047a;
            int v02 = org.telegram.ui.ActionBar.j6.v0(i10, f6Var);
            int i11 = org.telegram.ui.ActionBar.j6.Oh;
            int d = i0.a.d(this.f35052r, v02, org.telegram.ui.ActionBar.j6.v0(i11, f6Var));
            PorterDuff.Mode mode = PorterDuff.Mode.SRC_IN;
            p9Var2.setColorFilter(new PorterDuffColorFilter(d, mode));
            p9Var2.invalidate();
            p9Var.setColorFilter(new PorterDuffColorFilter(i0.a.d(1.0f - this.f35052r, org.telegram.ui.ActionBar.j6.v0(i10, f6Var), org.telegram.ui.ActionBar.j6.v0(i11, f6Var)), mode));
            p9Var.invalidate();
        }
        if (z4) {
            p9Var = p9Var2;
