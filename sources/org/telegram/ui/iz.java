...
public final class iz extends LinearLayout {
    public final org.telegram.ui.ActionBar.d6 f34284a;
    public final FrameLayout f34285b;
    public final org.telegram.ui.Components.w9 f34286c;
    public final FrameLayout d;
    public final FrameLayout e;
    public final org.telegram.ui.Components.w9 f34287f;
    public final FrameLayout h;
    public ValueAnimator f34288n;
    public float f34289r;
    ...
    public iz(Context context, org.telegram.ui.ActionBar.d6 d6Var) {
        ...
        int i12 = org.telegram.ui.ActionBar.h6.f18843g6;
    ...
    public final void a(boolean z10, boolean z11) {
        ...
        float f21;
        float f22;
        ValueAnimator valueAnimator = this.f34288n;
        if (valueAnimator != null) {
            valueAnimator.cancel();
            this.f34288n = null;
        }
        org.telegram.ui.Components.w9 w9Var = this.f34287f;
        org.telegram.ui.Components.w9 w9Var2 = this.f34286c;
        ...
        if (z11) {
            ...
            float f24 = this.f34289r;
            if (!z10) {
                f23 = 0.0f;
            }
            ValueAnimator ofFloat = ValueAnimator.ofFloat(f24, f23);
            this.f34288n = ofFloat;
            ofFloat.addUpdateListener(new c3(this, 11));
            this.f34288n.addListener(new org.telegram.ui.Components.ca(27, this, z10));
            this.f34288n.setInterpolator(rrVar);
            this.f34288n.setDuration(320L);
            this.f34288n.start();
        } else {
            ...
            org.telegram.ui.ActionBar.d6 d6Var = this.f34284a;
            int v02 = org.telegram.ui.ActionBar.h6.v0(i10, d6Var);
            int i11 = org.telegram.ui.ActionBar.h6.Oh;
            int d = i0.a.d(this.f34289r, v02, org.telegram.ui.ActionBar.h6.v0(i11, d6Var));
            PorterDuff.Mode mode = PorterDuff.Mode.SRC_IN;
            w9Var2.setColorFilter(new PorterDuffColorFilter(d, mode));
            w9Var2.invalidate();
            w9Var.setColorFilter(new PorterDuffColorFilter(i0.a.d(1.0f - this.f34289r, org.telegram.ui.ActionBar.h6.v0(i10, d6Var), org.telegram.ui.ActionBar.h6.v0(i11, d6Var)), mode));
            w9Var.invalidate();
        }
        if (z10) {
            w9Var = w9Var2;
