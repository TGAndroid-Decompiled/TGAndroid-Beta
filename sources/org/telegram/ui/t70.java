...
public final class t70 extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public org.telegram.ui.Components.yw0 f37585b;
    public org.telegram.ui.Components.t00 f37586c;
    public org.telegram.ui.Components.ll0 d;
    public r70 e;
    public s70 f37587f;
    public s4.c0 h;
    public int f37588n;
    public TLRPC.TL_messages_stickerSet f37589r;
    public boolean f37590s;
    public TLRPC.ChatFull v;
    public final long f37591w;
    public int f37592x;
    public int f37593y;
    ...
    public static void U(t70 t70Var, View view, int i10) {
        if (t70Var.getParentActivity() != null) {
            if (t70Var.M) {
                if (i10 > t70Var.f37587f.d.size()) {
                    boolean a2 = ((org.telegram.ui.Cells.m8) view).a();
                    s70 s70Var = t70Var.f37587f;
                    t70Var.d0((TLRPC.TL_messages_stickerSet) s70Var.e.get((i10 - s70Var.d.size()) - 1), a2, false);
                    return;
                } else if (i10 != t70Var.f37587f.d.size()) {
                    t70Var.d0((TLRPC.TL_messages_stickerSet) t70Var.f37587f.d.get(i10), ((org.telegram.ui.Cells.m8) view).a(), true);
                    return;
                } else {
                    return;
                }
            ...
            if (i10 == t70Var.J) {
                t70Var.d0(t70Var.f37589r, true, false);
            }
        }
    }
    ...
    public static void V(t70 t70Var, TLRPC.TL_error tL_error) {
        ...
        if (tL_error == null) {
            TLRPC.TL_messages_stickerSet tL_messages_stickerSet = t70Var.f37589r;
            if (tL_messages_stickerSet == null) {
                ...
                MediaDataController.getInstance(t70Var.currentAccount).putGroupStickerSet(t70Var.f37589r);
            }
            t70Var.h0();
            if (z10) {
            ...
            NotificationCenter.getInstance(t70Var.currentAccount).lambda$postNotificationNameOnUIThread$1(NotificationCenter.groupPackUpdated, Long.valueOf(t70Var.v.f18110id), Boolean.valueOf(z10));
    ...
    public static void a0(t70 t70Var, TLRPC.TL_messages_stickerSet tL_messages_stickerSet) {
        ...
        if (t70Var.f37588n != -1) {
            ...
            t70Var.e.m(t70Var.E + t70Var.f37588n);
        }
    }
    ...
    public final View createView(Context context) {
        ...
        this.f37587f = new s70(this, context);
        ...
        this.f37584a = frameLayout2;
        frameLayout2.setBackgroundColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18834d6, false));
        ...
        this.f37586c.setIsSingleCell(true);
        this.f37586c.setItemsCount((int) Math.ceil(AndroidUtilities.displaySize.y / AndroidUtilities.dpf2(58.0f)));
        this.f37584a.addView(this.f37586c, w7.x5.c(-1.0f, -1));
        org.telegram.ui.Components.yw0 yw0Var = new org.telegram.ui.Components.yw0(context, this.f37586c, 1, null);
        this.f37585b = yw0Var;
        n7.a1.j(yw0Var);
        this.f37584a.addView(this.f37585b);
        frameLayout.addView(this.f37584a);
        this.f37584a.setVisibility(8);
        this.d.setEmptyView(this.f37584a);
    ...
    public final void d0(TLRPC.TL_messages_stickerSet tL_messages_stickerSet, boolean z10, boolean z11) {
        ...
        vx0Var.f29456d0 = new o70(this, z10, tL_messages_stickerSet);
        vx0Var.B0();
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.stickersDidLoad) {
            ...
            if (chatFull.f18110id == this.f37591w) {
                if (this.v == null && b0(chatFull) != null) {
                    this.f37589r = MediaDataController.getInstance(this.currentAccount).getGroupStickerSetById(b0(chatFull));
                }
                this.v = chatFull;
                g0(true);
            }
            ...
            if (b0(this.v) != null && b0(this.v).f18136id == longValue) {
                g0(true);
            }
        }
    }
    ...
    public final void e0(TLRPC.ChatFull chatFull) {
        this.v = chatFull;
        if (b0(chatFull) != null) {
            this.f37589r = MediaDataController.getInstance(this.currentAccount).getGroupStickerSetById(b0(this.v));
        }
    }
    ...
    public final void f0(TLRPC.TL_messages_stickerSet tL_messages_stickerSet, boolean z10) {
        ...
        if (tL_messages_stickerSet != null) {
            ...
            this.f37589r = tL_messages_stickerSet;
            g0(false);
            if (z11) {
                this.e.o(this.J);
            } else {
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.d, 16, new Class[]{org.telegram.ui.Cells.m8.class, org.telegram.ui.Cells.ea.class}, null, null, null, org.telegram.ui.ActionBar.i6.f18834d6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.d, 0, new Class[]{org.telegram.ui.Cells.m8.class}, new String[]{"valueTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.i6.f19234z6));
    ...
    public final void onFragmentDestroy() {
        ...
        if ((this.f37589r != null || this.f37590s) && (chatFull = this.v) != null) {
            if (b0(chatFull) == null || (tL_messages_stickerSet = this.f37589r) == null || tL_messages_stickerSet.set.f18136id != b0(this.v).f18136id) {
                if (b0(this.v) != null || this.f37589r != null) {
                    boolean z10 = this.N;
                    long j3 = this.f37591w;
                    if (z10) {
                        ...
                        if (this.f37590s) {
                            ...
                            TLRPC.StickerSet stickerSet = this.f37589r.set;
                        ...
                        if (this.f37590s) {
                            ...
                            edit.remove("group_hide_stickers_" + this.v.f18110id).apply();
                            TLRPC.TL_inputStickerSetID tL_inputStickerSetID2 = new TLRPC.TL_inputStickerSetID();
                            tL_channels_setStickers2.stickerset = tL_inputStickerSetID2;
                            TLRPC.StickerSet stickerSet2 = this.f37589r.set;
                            tL_inputStickerSetID2.f18129id = stickerSet2.f18136id;
