...
public final class t70 extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public q70 O;
    public FrameLayout f37596a;
    public org.telegram.ui.Components.kx0 f37597b;
    public org.telegram.ui.Components.t00 f37598c;
    public org.telegram.ui.Components.wl0 d;
    public r70 e;
    public s70 f37599f;
    public s4.c0 h;
    public int f37600n;
    public TLRPC.TL_messages_stickerSet f37601r;
    public boolean f37602s;
    public TLRPC.ChatFull v;
    public final long f37603w;
    public int f37604x;
    public int f37605y;
    ...
    public static void U(t70 t70Var, View view, int i10) {
        if (t70Var.getParentActivity() != null) {
            if (t70Var.M) {
                if (i10 > t70Var.f37599f.d.size()) {
                    boolean a2 = ((org.telegram.ui.Cells.m8) view).a();
                    s70 s70Var = t70Var.f37599f;
                    t70Var.d0((TLRPC.TL_messages_stickerSet) s70Var.e.get((i10 - s70Var.d.size()) - 1), a2, false);
                    return;
                } else if (i10 != t70Var.f37599f.d.size()) {
                    t70Var.d0((TLRPC.TL_messages_stickerSet) t70Var.f37599f.d.get(i10), ((org.telegram.ui.Cells.m8) view).a(), true);
                    return;
                } else {
                    return;
                }
            ...
            if (i10 == t70Var.J) {
                t70Var.d0(t70Var.f37601r, true, false);
            }
        }
    }
    ...
    public static void V(t70 t70Var, TLRPC.TL_error tL_error) {
        ...
        if (tL_error == null) {
            TLRPC.TL_messages_stickerSet tL_messages_stickerSet = t70Var.f37601r;
            if (tL_messages_stickerSet == null) {
                ...
                MediaDataController.getInstance(t70Var.currentAccount).putGroupStickerSet(t70Var.f37601r);
            }
            t70Var.h0();
            if (z10) {
            ...
            NotificationCenter.getInstance(t70Var.currentAccount).lambda$postNotificationNameOnUIThread$1(NotificationCenter.groupPackUpdated, Long.valueOf(t70Var.v.f18297id), Boolean.valueOf(z10));
    ...
    public static void a0(t70 t70Var, TLRPC.TL_messages_stickerSet tL_messages_stickerSet) {
        ...
        if (t70Var.f37600n != -1) {
            ...
            t70Var.e.m(t70Var.E + t70Var.f37600n);
        }
    }
    ...
    public final View createView(Context context) {
        ...
        this.f37599f = new s70(this, context);
        ...
        this.f37596a = frameLayout2;
        frameLayout2.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19062d6, false));
        ...
        this.f37598c.setIsSingleCell(true);
        this.f37598c.setItemsCount((int) Math.ceil(AndroidUtilities.displaySize.y / AndroidUtilities.dpf2(58.0f)));
        this.f37596a.addView(this.f37598c, w7.y5.c(-1.0f, -1));
        org.telegram.ui.Components.kx0 kx0Var = new org.telegram.ui.Components.kx0(context, this.f37598c, 1, null);
        this.f37597b = kx0Var;
        n7.z0.k(kx0Var);
        this.f37596a.addView(this.f37597b);
        frameLayout.addView(this.f37596a);
        this.f37596a.setVisibility(8);
        this.d.setEmptyView(this.f37596a);
    ...
    public final void d0(TLRPC.TL_messages_stickerSet tL_messages_stickerSet, boolean z10, boolean z11) {
        ...
        hy0Var.f24757d0 = new o70(this, z10, tL_messages_stickerSet);
        hy0Var.B0();
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.stickersDidLoad) {
            ...
            if (chatFull.f18297id == this.f37603w) {
                if (this.v == null && b0(chatFull) != null) {
                    this.f37601r = MediaDataController.getInstance(this.currentAccount).getGroupStickerSetById(b0(chatFull));
                }
                this.v = chatFull;
                g0(true);
            }
            ...
            if (b0(this.v) != null && b0(this.v).f18323id == longValue) {
                g0(true);
            }
        }
    }
    ...
    public final void e0(TLRPC.ChatFull chatFull) {
        this.v = chatFull;
        if (b0(chatFull) != null) {
            this.f37601r = MediaDataController.getInstance(this.currentAccount).getGroupStickerSetById(b0(this.v));
        }
    }
    ...
    public final void f0(TLRPC.TL_messages_stickerSet tL_messages_stickerSet, boolean z10) {
        ...
        if (tL_messages_stickerSet != null) {
            ...
            this.f37601r = tL_messages_stickerSet;
            g0(false);
            if (z11) {
                this.e.o(this.J);
            } else {
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.d, 16, new Class[]{org.telegram.ui.Cells.m8.class, org.telegram.ui.Cells.ea.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19062d6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.d, 0, new Class[]{org.telegram.ui.Cells.m8.class}, new String[]{"valueTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f19464z6));
    ...
    public final void onFragmentDestroy() {
        ...
        if ((this.f37601r != null || this.f37602s) && (chatFull = this.v) != null) {
            if (b0(chatFull) == null || (tL_messages_stickerSet = this.f37601r) == null || tL_messages_stickerSet.set.f18323id != b0(this.v).f18323id) {
                if (b0(this.v) != null || this.f37601r != null) {
                    boolean z10 = this.N;
                    long j3 = this.f37603w;
                    if (z10) {
                        ...
                        if (this.f37602s) {
                            ...
                            TLRPC.StickerSet stickerSet = this.f37601r.set;
                        ...
                        if (this.f37602s) {
                            ...
                            edit.remove("group_hide_stickers_" + this.v.f18297id).apply();
                            TLRPC.TL_inputStickerSetID tL_inputStickerSetID2 = new TLRPC.TL_inputStickerSetID();
                            tL_channels_setStickers2.stickerset = tL_inputStickerSetID2;
                            TLRPC.StickerSet stickerSet2 = this.f37601r.set;
                            tL_inputStickerSetID2.f18316id = stickerSet2.f18323id;
