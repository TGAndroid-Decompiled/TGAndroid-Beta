    ...
    public final void onClick(View view) {
        switch (this.f39394a) {
            case 0:
                ...
                return;
            case 1:
                i91 i91Var2 = this.f39395b;
                i91Var2.getClass();
                i91Var2.presentFragment(new h(3));
                return;
            case 2:
                this.f39395b.getMessagesController().removeSuggestion(0L, "VALIDATE_PHONE_NUMBER");
                return;
            case 3:
                i91 i91Var3 = this.f39395b;
                i91Var3.getClass();
                i91Var3.presentFragment(new ih1(8, null));
                return;
            case 4:
                this.f39395b.getMessagesController().removeSuggestion(0L, "VALIDATE_PASSWORD");
                return;
            case 5:
                i91.W(this.f39395b);
                return;
