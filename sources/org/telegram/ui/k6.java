...
public final class k6 extends FrameLayout {
    public final z6 E;
    public final org.telegram.ui.Components.q6 f37933a;
    public final TextView[] f37934b;
    public final RectF f37935c;
    public final org.telegram.ui.Components.h90 d;
    public Float f37936e;
    public Float f37937f;
    public final org.telegram.ui.Components.e6 h;
    public final org.telegram.ui.Components.e6 f37938n;
    public final org.telegram.ui.Components.e6 f37939r;
    public final Paint f37940s;
    public final Paint v;
    public final Paint f37941w;
    public Path f37942x;
    public float[] f37943y;

    public k6(z6 z6Var, Context context) {
        super(context);
        float f7;
        this.E = z6Var;
        this.f37934b = new TextView[3];
        this.f37935c = new RectF();
        this.d = new org.telegram.ui.Components.h90();
        org.telegram.ui.Components.pr prVar = org.telegram.ui.Components.pr.h;
        this.h = new org.telegram.ui.Components.e6(this, 450L, prVar);
        this.f37938n = new org.telegram.ui.Components.e6(this, 450L, prVar);
        this.f37939r = new org.telegram.ui.Components.e6(this, 450L, prVar);
        this.f37940s = new Paint(1);
        this.v = new Paint(1);
        this.f37941w = new Paint(1);
        ...
        for (int i10 = 0; i10 < 3; i10++) {
            this.f37934b[i10] = new TextView(context);
            this.f37934b[i10].setTextSize(1, 13.0f);
            this.f37934b[i10].setGravity(17);
            this.f37934b[i10].setPadding(AndroidUtilities.dp(24.0f), 0, AndroidUtilities.dp(24.0f), 0);
            if (i10 == 0) {
                this.f37934b[i10].setText(LocaleController.getString(R.string.StorageUsageCalculating));
            } else if (i10 == 1) {
                this.f37934b[i10].setAlpha(0.0f);
                this.f37934b[i10].setText(LocaleController.getString(R.string.StorageUsageTelegram));
                this.f37934b[i10].setVisibility(4);
            } else if (i10 == 2) {
                this.f37934b[i10].setText(LocaleController.getString(R.string.StorageCleared2));
                this.f37934b[i10].setAlpha(0.0f);
                this.f37934b[i10].setVisibility(4);
            }
            this.f37934b[i10].setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.B6, false));
            View view = this.f37934b[i10];
            if (i10 == 2) {
                f7 = 12.0f;
            } else {
                f7 = -6.0f;
        ...
        this.d.e(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f21063z8, false), org.telegram.ui.ActionBar.j6.l1(0.2f, org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.B6, false)));
        this.d.j(4.0f);
        this.d.setCallback(this);
    }

    public final void a(float f7, float f10, Canvas canvas, Paint paint, RectF rectF) {
        Path path = this.f37942x;
        if (path == null) {
            this.f37942x = new Path();
        } else {
            path.rewind();
        }
        if (this.f37943y == null) {
            this.f37943y = new float[8];
        }
        float[] fArr = this.f37943y;
        fArr[7] = f7;
        fArr[6] = f7;
        fArr[1] = f7;
        fArr[0] = f7;
        ...
        fArr[3] = f10;
        fArr[2] = f10;
        this.f37942x.addRoundRect(rectF, fArr, Path.Direction.CW);
        canvas.drawPath(this.f37942x, paint);
    }
    ...
    public final void b(float f7, float f10, boolean z10) {
        ...
        this.f37933a.setText(string);
        if (z10) {
            z6 z6Var = this.E;
            TextView[] textViewArr = this.f37934b;
            if (f7 < 0.01f) {
        ...
        this.f37936e = Float.valueOf(f7);
        this.f37937f = Float.valueOf(f10);
        invalidate();
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        float f10;
        float f11;
        float alpha = 1.0f - this.f37934b[2].getAlpha();
        if (this.f37936e == null) {
            f7 = 1.0f;
        } else {
            f7 = 0.0f;
        }
        float d = this.f37939r.d(f7, false);
        Float f12 = this.f37936e;
        if (f12 == null) {
            floatValue = 0.0f;
        } else {
        ...
        Float f13 = this.f37937f;
        if (f13 == null) {
            floatValue2 = 0.0f;
        } else {
            floatValue2 = f13.floatValue();
        }
        float d11 = this.f37938n.d(floatValue2, false);
        int i11 = org.telegram.ui.ActionBar.j6.f21063z8;
        int w02 = org.telegram.ui.ActionBar.j6.w0(null, i11, false);
        Paint paint = this.f37940s;
        paint.setColor(w02);
        paint.setAlpha((int) (paint.getAlpha() * alpha));
        RectF rectF2 = AndroidUtilities.rectTmp;
        RectF rectF3 = this.f37935c;
        float f14 = 1.0f - d;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        while (true) {
            ...
            if (i13 < textViewArr.length) {
                ...
                this.f37935c.set((size - min) / 2.0f, i15 - AndroidUtilities.dp(30.0f), (size + min) / 2.0f, i15 - AndroidUtilities.dp(26.0f));
                return;
            }
        }
    }
