...
public final class k6 extends FrameLayout {
    public final z6 E;
    public final org.telegram.ui.Components.n6 f35035a;
    public final TextView[] f35036b;
    public final RectF f35037c;
    public final org.telegram.ui.Components.g90 d;
    public Float e;
    public Float f35038f;
    public final org.telegram.ui.Components.c6 h;
    public final org.telegram.ui.Components.c6 f35039n;
    public final org.telegram.ui.Components.c6 f35040r;
    public final Paint f35041s;
    public final Paint v;
    public final Paint f35042w;
    public Path f35043x;
    public float[] f35044y;

    public k6(z6 z6Var, Context context) {
        super(context);
        float f7;
        this.E = z6Var;
        this.f35036b = new TextView[3];
        this.f35037c = new RectF();
        this.d = new org.telegram.ui.Components.g90();
        org.telegram.ui.Components.qr qrVar = org.telegram.ui.Components.qr.h;
        this.h = new org.telegram.ui.Components.c6(this, 450L, qrVar);
        this.f35039n = new org.telegram.ui.Components.c6(this, 450L, qrVar);
        this.f35040r = new org.telegram.ui.Components.c6(this, 450L, qrVar);
        this.f35041s = new Paint(1);
        this.v = new Paint(1);
        this.f35042w = new Paint(1);
        ...
        for (int i10 = 0; i10 < 3; i10++) {
            this.f35036b[i10] = new TextView(context);
            this.f35036b[i10].setTextSize(1, 13.0f);
            this.f35036b[i10].setGravity(17);
            this.f35036b[i10].setPadding(AndroidUtilities.dp(24.0f), 0, AndroidUtilities.dp(24.0f), 0);
            if (i10 == 0) {
                this.f35036b[i10].setText(LocaleController.getString(R.string.StorageUsageCalculating));
            } else if (i10 == 1) {
                this.f35036b[i10].setAlpha(0.0f);
                this.f35036b[i10].setText(LocaleController.getString(R.string.StorageUsageTelegram));
                this.f35036b[i10].setVisibility(4);
            } else if (i10 == 2) {
                this.f35036b[i10].setText(LocaleController.getString(R.string.StorageCleared2));
                this.f35036b[i10].setAlpha(0.0f);
                this.f35036b[i10].setVisibility(4);
            }
            this.f35036b[i10].setTextColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.B6, false));
            View view = this.f35036b[i10];
            if (i10 == 2) {
                f7 = 12.0f;
            } else {
                f7 = -6.0f;
        ...
        this.d.e(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f19239z8, false), org.telegram.ui.ActionBar.i6.l1(0.2f, org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.B6, false)));
        this.d.j(4.0f);
        this.d.setCallback(this);
    }

    public final void a(float f7, float f10, Canvas canvas, Paint paint, RectF rectF) {
        Path path = this.f35043x;
        if (path == null) {
            this.f35043x = new Path();
        } else {
            path.rewind();
        }
        if (this.f35044y == null) {
            this.f35044y = new float[8];
        }
        float[] fArr = this.f35044y;
        fArr[7] = f7;
        fArr[6] = f7;
        fArr[1] = f7;
        fArr[0] = f7;
        ...
        fArr[3] = f10;
        fArr[2] = f10;
        this.f35043x.addRoundRect(rectF, fArr, Path.Direction.CW);
        canvas.drawPath(this.f35043x, paint);
    }
    ...
    public final void b(float f7, float f10, boolean z10) {
        ...
        this.f35035a.setText(string);
        if (z10) {
            z6 z6Var = this.E;
            TextView[] textViewArr = this.f35036b;
            if (f7 < 0.01f) {
        ...
        this.f35038f = Float.valueOf(f10);
        invalidate();
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        float f10;
        float f11;
        float alpha = 1.0f - this.f35036b[2].getAlpha();
        if (this.e == null) {
            f7 = 1.0f;
        } else {
            f7 = 0.0f;
        }
        float d = this.f35040r.d(f7, false);
        Float f12 = this.e;
        if (f12 == null) {
            floatValue = 0.0f;
        } else {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        while (true) {
            ...
            if (i13 < textViewArr.length) {
                ...
                this.f35037c.set((size - min) / 2.0f, i15 - AndroidUtilities.dp(30.0f), (size + min) / 2.0f, i15 - AndroidUtilities.dp(26.0f));
                return;
            }
        }
    }
