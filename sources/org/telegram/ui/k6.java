...
public final class k6 extends FrameLayout {
    public final z6 E;
    public final org.telegram.ui.Components.q6 f37934a;
    public final TextView[] f37935b;
    public final RectF f37936c;
    public final org.telegram.ui.Components.h90 d;
    public Float f37937e;
    public Float f37938f;
    public final org.telegram.ui.Components.e6 h;
    public final org.telegram.ui.Components.e6 f37939n;
    public final org.telegram.ui.Components.e6 f37940r;
    public final Paint f37941s;
    public final Paint v;
    public final Paint f37942w;
    public Path f37943x;
    public float[] f37944y;

    public k6(z6 z6Var, Context context) {
        super(context);
        float f7;
        this.E = z6Var;
        this.f37935b = new TextView[3];
        this.f37936c = new RectF();
        this.d = new org.telegram.ui.Components.h90();
        org.telegram.ui.Components.pr prVar = org.telegram.ui.Components.pr.h;
        this.h = new org.telegram.ui.Components.e6(this, 450L, prVar);
        this.f37939n = new org.telegram.ui.Components.e6(this, 450L, prVar);
        this.f37940r = new org.telegram.ui.Components.e6(this, 450L, prVar);
        this.f37941s = new Paint(1);
        this.v = new Paint(1);
        this.f37942w = new Paint(1);
        ...
        for (int i10 = 0; i10 < 3; i10++) {
            this.f37935b[i10] = new TextView(context);
            this.f37935b[i10].setTextSize(1, 13.0f);
            this.f37935b[i10].setGravity(17);
            this.f37935b[i10].setPadding(AndroidUtilities.dp(24.0f), 0, AndroidUtilities.dp(24.0f), 0);
            if (i10 == 0) {
                this.f37935b[i10].setText(LocaleController.getString(R.string.StorageUsageCalculating));
            } else if (i10 == 1) {
                this.f37935b[i10].setAlpha(0.0f);
                this.f37935b[i10].setText(LocaleController.getString(R.string.StorageUsageTelegram));
                this.f37935b[i10].setVisibility(4);
            } else if (i10 == 2) {
                this.f37935b[i10].setText(LocaleController.getString(R.string.StorageCleared2));
                this.f37935b[i10].setAlpha(0.0f);
                this.f37935b[i10].setVisibility(4);
            }
            this.f37935b[i10].setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.B6, false));
            View view = this.f37935b[i10];
            if (i10 == 2) {
                f7 = 12.0f;
            } else {
                f7 = -6.0f;
        ...
        this.d.e(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f21064z8, false), org.telegram.ui.ActionBar.j6.l1(0.2f, org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.B6, false)));
        this.d.j(4.0f);
        this.d.setCallback(this);
    }

    public final void a(float f7, float f10, Canvas canvas, Paint paint, RectF rectF) {
        Path path = this.f37943x;
        if (path == null) {
            this.f37943x = new Path();
        } else {
            path.rewind();
        }
        if (this.f37944y == null) {
            this.f37944y = new float[8];
        }
        float[] fArr = this.f37944y;
        fArr[7] = f7;
        fArr[6] = f7;
        fArr[1] = f7;
        fArr[0] = f7;
        ...
        fArr[3] = f10;
        fArr[2] = f10;
        this.f37943x.addRoundRect(rectF, fArr, Path.Direction.CW);
        canvas.drawPath(this.f37943x, paint);
    }
    ...
    public final void b(float f7, float f10, boolean z10) {
        ...
        this.f37934a.setText(string);
        if (z10) {
            z6 z6Var = this.E;
            TextView[] textViewArr = this.f37935b;
            if (f7 < 0.01f) {
        ...
        this.f37937e = Float.valueOf(f7);
        this.f37938f = Float.valueOf(f10);
        invalidate();
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        float f10;
        float f11;
        float alpha = 1.0f - this.f37935b[2].getAlpha();
        if (this.f37937e == null) {
            f7 = 1.0f;
        } else {
            f7 = 0.0f;
        }
        float d = this.f37940r.d(f7, false);
        ...
        Float f13 = this.f37938f;
        if (f13 == null) {
            floatValue2 = 0.0f;
        } else {
            floatValue2 = f13.floatValue();
        }
        float d11 = this.f37939n.d(floatValue2, false);
        int i11 = org.telegram.ui.ActionBar.j6.f21064z8;
        int w02 = org.telegram.ui.ActionBar.j6.w0(null, i11, false);
        Paint paint = this.f37941s;
        paint.setColor(w02);
        paint.setAlpha((int) (paint.getAlpha() * alpha));
        RectF rectF2 = AndroidUtilities.rectTmp;
        RectF rectF3 = this.f37936c;
        float f14 = 1.0f - d;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        while (true) {
            ...
            if (i13 < textViewArr.length) {
                ...
                this.f37936c.set((size - min) / 2.0f, i15 - AndroidUtilities.dp(30.0f), (size + min) / 2.0f, i15 - AndroidUtilities.dp(26.0f));
                return;
            }
        }
    }
