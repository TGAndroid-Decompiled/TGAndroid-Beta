...
public final class l31 extends FrameLayout {
    public final org.telegram.ui.Components.n5 f35296a;
    public final m31 f35297b;
    ...
    public l31(m31 m31Var, Context context) {
        ...
        this.f35296a = new org.telegram.ui.Components.n5(AndroidUtilities.dp(24.0f), this);
    }

    public final void a(boolean z10) {
        m31 m31Var = this.f35297b;
        String doubleTapReaction = MediaDataController.getInstance(m31.Y(m31Var)).getDoubleTapReaction();
        org.telegram.ui.Components.n5 n5Var = this.f35296a;
    ...
    public final void b() {
        int width = getWidth();
        org.telegram.ui.Components.n5 n5Var = this.f35296a;
        n5Var.setBounds((width - n5Var.f26568s) - AndroidUtilities.dp(21.0f), (getHeight() - n5Var.f26568s) / 2, getWidth() - AndroidUtilities.dp(21.0f), (getHeight() + n5Var.f26568s) / 2);
    }
