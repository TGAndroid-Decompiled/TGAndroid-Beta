...
public final class ew0 implements View.OnClickListener {
    public final gi0 f36197a;
    public final co f36198b;
    public final org.telegram.ui.Components.ll0 f36199c;
    public final LinearLayout d;
    public final org.telegram.ui.Components.n70 f36200e;
    public final org.telegram.ui.Components.n70 f36201f;
    public final lw0 h;
    ...
    public final void onClick(View view) {
        ...
        if (!arrayList2.isEmpty()) {
            ...
            if (SharedConfig.messageSeenHintCount > 0 && coVar.X0.getKeyboardHeight() < AndroidUtilities.dp(20.0f)) {
                org.telegram.ui.Components.qc t10 = new org.telegram.ui.Components.yc(org.telegram.ui.Components.lb.a(lw0Var.getContext()), lw0Var.f38493b).t(AndroidUtilities.replaceTags(LocaleController.getString(R.string.MessageSeenTooltipMessage)), null);
                coVar.f35349n1 = t10;
                t10.f29680j = 4000;
                t10.j();
                SharedConfig.updateMessageSeenHintCount(SharedConfig.messageSeenHintCount - 1);
            }
            org.telegram.ui.Components.ll0 ll0Var = this.f36199c;
            ll0Var.requestLayout();
            this.d.requestLayout();
            ll0Var.getAdapter().l();
            this.f36200e.K(this.f36201f);
        }
    }
}
