...
public final class ot0 extends AnimatorListenerAdapter {
    ...
    public final void onAnimationEnd(Animator animator) {
        ...
        if (i11 == 0 || i11 == 4 || ((i11 == 2 || i11 == 5) && photoViewer.f31233g7.size() > 1)) {
        ...
        if (bitmap != null || photoViewer.f31322r1) {
            ...
            ef0Var.b(bitmap, orientation, z10, false, gVar, i71Var, ku0Var.f35142c);
            photoViewer.C1.a();
            ...
            float min = Math.min(photoViewer.k1(photoViewer.f31353u4) / f7, photoViewer.i1() / f10);
        ...
        animatorSet.playTogether(ObjectAnimator.ofFloat(photoViewer.U0, View.TRANSLATION_Y, AndroidUtilities.dp(48.0f), 0.0f), ObjectAnimator.ofFloat(photoViewer, org.telegram.ui.Components.s6.f28157g, 0.0f, 1.0f), ObjectAnimator.ofFloat(photoViewer.C1, View.ALPHA, 0.0f, 1.0f));
        photoViewer.f31309p6.setDuration(200L);
        photoViewer.f31309p6.addListener(new xo0(this, 3));
