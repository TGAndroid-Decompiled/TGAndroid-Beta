...
public final class nz0 extends kq {
    public final boolean[] f36019d1;
    public final TLRPC.User f36020e1;
    public final ProfileActivity f36021f1;
    ...
    public final void onTransitionAnimationEnd(boolean z10, boolean z11) {
        if (!z10 && z11 && this.f36019d1[0]) {
            ProfileActivity profileActivity = this.f36021f1;
            if (org.telegram.ui.Components.xc.a(profileActivity)) {
                org.telegram.ui.Components.xc.C(profileActivity, this.f36020e1.first_name).j();
            }
        }
    }
}
