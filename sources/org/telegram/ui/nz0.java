...
public final class nz0 implements org.telegram.ui.Components.cl0 {
    ...
    public static void a(nz0 nz0Var, Context context, int i10) {
        ...
        int i20 = 0;
        if (i10 == 0) {
            nz0Var.f36191c.getUserConfig().syncContacts = true;
            nz0Var.f36191c.getUserConfig().saveConfig(false);
            nz0Var.f36191c.getContactsController().forceImportContacts();
            return;
        }
        long j10 = 0;
        if (i10 == 1) {
            nz0Var.f36191c.getContactsController().loadContacts(false, 0L);
        } else if (i10 == 2) {
            nz0Var.f36191c.getContactsController().resetImportedContacts();
        } else if (i10 == 3) {
            nz0Var.f36191c.getMessagesController().forceResetDialogs();
        } else if (i10 == 4) {
            ...
            nz0Var.f36191c.getMessagesStorage().clearSentMedia();
            ...
            w7.w5.a();
            i15 = ((org.telegram.ui.ActionBar.o2) nz0Var.f36191c).currentAccount;
            ...
            i16 = ((org.telegram.ui.ActionBar.o2) nz0Var.f36191c).currentAccount;
            ChatThemeController.getInstance(i16).clearCache();
            nz0Var.f36191c.getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.newSuggestionsAvailable, new Object[0]);
            g41.W();
            i17 = ((org.telegram.ui.ActionBar.o2) nz0Var.f36191c).currentAccount;
            pg.s0.e(i17).a();
            SharedPreferences mainSettings = nz0Var.f36191c.getMessagesController().getMainSettings();
            ...
            edit.apply();
            i18 = ((org.telegram.ui.ActionBar.o2) nz0Var.f36191c).currentAccount;
            SharedPreferences.Editor edit2 = MessagesController.getNotificationsSettings(i18).edit();
            i19 = ((org.telegram.ui.ActionBar.o2) nz0Var.f36191c).currentAccount;
            ...
            org.telegram.ui.Components.voip.f2.i(nz0Var.f36191c.getParentActivity());
        } else if (i10 == 8) {
            SharedConfig.toggleRoundCamera16to9();
        } else if (i10 == 9) {
            ((LaunchActivity) nz0Var.f36191c.getParentActivity()).z(true);
        } else if (i10 == 10) {
            nz0Var.f36191c.getMessagesStorage().readAllDialogs(-1);
        } else if (i10 == 11) {
            ...
            Set<String> set = nz0Var.f36191c.getMessagesController().pendingSuggestions;
            ...
            try {
                if (i10 == 14) {
                    ...
                    Activity parentActivity = nz0Var.f36191c.getParentActivity();
                    ...
                    w7.x.a((LaunchActivity) nz0Var.f36191c.getParentActivity(), !SharedConfig.isFloatingDebugActive, true);
                } else if (i10 == 19) {
                    nz0Var.f36191c.getMessagesController().loadAppConfig();
                    TLRPC.TL_help_dismissSuggestion tL_help_dismissSuggestion = new TLRPC.TL_help_dismissSuggestion();
                    tL_help_dismissSuggestion.suggestion = "VALIDATE_PHONE_NUMBER";
                    tL_help_dismissSuggestion.peer = new TLRPC.TL_inputPeerEmpty();
                    nz0Var.f36191c.getConnectionsManager().sendRequest(tL_help_dismissSuggestion, new kz0(nz0Var, 0));
                } else if (i10 == 20) {
                    ...
                    ProfileActivity.S0(nz0Var.f36191c, "video/avc", sb3);
                    ProfileActivity.S0(nz0Var.f36191c, "video/hevc", sb3);
                    ProfileActivity.S0(nz0Var.f36191c, "video/x-vnd.on2.vp8", sb3);
                    ProfileActivity.S0(nz0Var.f36191c, "video/x-vnd.on2.vp9", sb3);
                    nz0Var.f36191c.showDialog(new mz0(nz0Var, nz0Var.f36191c.getParentActivity(), sb3.toString()));
                } else if (i10 == 21) {
                    AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(nz0Var.f36191c.getParentActivity(), 0, nz0Var.f36191c.f31429z0);
                    ...
                    alertDialog$Builder.f(new CharSequence[]{replaceTags, replaceTags2, AndroidUtilities.replaceTags(str5.concat(str8))}, new lz0(measureDevicePerformanceClass, 0));
                    alertDialog$Builder.h(LocaleController.getString("Cancel", R.string.Cancel), null);
                    alertDialog$Builder.o();
                } else if (i10 == 22) {
                    SharedConfig.toggleRoundCamera();
                } else if (i10 == 23) {
                    boolean q6 = ci.d1.q(nz0Var.f36191c.getParentActivity());
                    MessagesController.getGlobalMainSettings().edit().putBoolean("dual_available", !q6).apply();
                    Activity parentActivity2 = nz0Var.f36191c.getParentActivity();
                    if (!q6) {
                    ...
                    while (i20 < nz0Var.f36191c.getParentLayout().getFragmentStack().size()) {
                        ((org.telegram.ui.ActionBar.o2) nz0Var.f36191c.getParentLayout().getFragmentStack().get(i20)).clearSheets();
                        i20++;
                    }
                } else if (i10 == 25) {
                    ...
                    nz0Var.f36191c.getMediaDataController().loadAttachMenuBots(false, true);
                } else if (i10 == 28) {
                    i12 = ((org.telegram.ui.ActionBar.o2) nz0Var.f36191c).currentAccount;
                    ...
                    i11 = ((org.telegram.ui.ActionBar.o2) nz0Var.f36191c).currentAccount;
    ...
    public final boolean d(int r46, android.view.View r47) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.nz0.d(int, android.view.View):boolean");
    }
}
