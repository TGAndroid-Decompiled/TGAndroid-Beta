...
public final class ck extends s4.s0 {
    ...
    public final bo d;
    public float f32825a = 0.0f;
    public final int f32827c = AndroidUtilities.dp(100.0f);
    ...
    public final void a(RecyclerView recyclerView, int i10) {
        bo boVar = this.d;
        if (i10 == 0) {
            org.telegram.ui.Cells.t1 t1Var = boVar.f32405p2;
            if (t1Var != null) {
                boVar.f32382n2.e(t1Var, -1, boVar.f32417q2, boVar.f32430r2, true);
                boVar.f32405p2 = null;
            }
            boVar.j3 = false;
            boVar.f32346k3 = false;
            boVar.f32358l3 = false;
            boVar.f32369m3 = false;
            boVar.f9(true);
            boVar.g9(true);
            ...
            boVar.f32506x0.setOverScrollMode(0);
            boVar.f32254c9.W();
            boVar.Wc(false);
            boVar.q9(1);
            boVar.f32452sa = false;
            return;
        }
        ci.f4 f4Var = boVar.f32520y1;
    ...
    public final void b(RecyclerView recyclerView, int i10, int i11) {
        ...
        this.f32826b = z10;
        int L0 = boVar.f32531z0.L0();
        aa.a aVar = null;
        if (((i11 != 0 && boVar.f32452sa && recyclerView.getScrollState() == 2) || recyclerView.getScrollState() == 1) && boVar.N4 != 0) {
            if (this.f32826b && !boVar.O4) {
                if (!boVar.f32506x0.X1 && L0 != -1) {
                    int N0 = boVar.f32531z0.N0();
                    MessageObject messageObject = null;
                    while (true) {
                        if (N0 >= L0) {
                            View m10 = boVar.f32531z0.m(N0);
        ...
        if (i11 != 0 && boVar.j3 && !boVar.f32285f3) {
        ...
        if (boVar.t9() && i11 != 0 && boVar.f32346k3 && !boVar.f32285f3) {
            if (boVar.L7 != Integer.MAX_VALUE) {
                boVar.Ia();
                boVar.Wc(false);
            }
        ...
        if (L0 != -1) {
            ...
            if (L0 == 0 && boVar.E6[0]) {
                if (i11 >= 0) {
                    boVar.f32303g9 = false;
                    boVar.vc();
                }
            } else {
                aa.a[] aVarArr = boVar.f32332j1.e;
                if (1 < aVarArr.length) {
                    aVar = aVarArr[1];
                }
                ...
                int i12 = this.f32827c;
                if (i11 > 0) {
                    if (!z12) {
                        float f7 = this.f32825a + i11;
                        this.f32825a = f7;
                        if (f7 > i12) {
                            this.f32825a = 0.0f;
                            boVar.f32303g9 = true;
                ...
                } else if (boVar.f32344k1 && z12) {
                    float f10 = this.f32825a + i11;
                    this.f32825a = f10;
                    if (f10 < (-i12)) {
                        boVar.f32303g9 = false;
                        boVar.vc();
        ...
        boVar.r9();
        boVar.f32254c9.H();
        ArrayList arrayList = boVar.f32516xa.F;
        for (int i13 = 0; i13 < arrayList.size(); i13++) {
            if (!((hz) arrayList.get(i13)).f34389c) {
                ((hz) arrayList.get(i13)).f34388b -= i11;
            }
        }
        zg.l0 l0Var = zg.l0.B;
        if (l0Var != null) {
