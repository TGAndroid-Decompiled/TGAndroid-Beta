    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            if (velocityTracker3 != null) {
                ...
                profileActivity.f31543i2 = this.Y2.getYVelocity(motionEvent.getPointerId(motionEvent.getActionIndex()));
            }
        ...
        if (action == 2) {
            ...
            if (profileActivity.f31575n2 && !profileActivity.I0) {
                O3 = profileActivity.T3();
            } else {
                i12 = profileActivity.f31482a.getMeasuredWidth();
        ...
        if ((action == 1 || action == 3) && (m10 = profileActivity.f31497c.m(0)) != null) {
            if (profileActivity.O1) {
                profileActivity.O1 = false;
                profileActivity.f31482a.N0 = true;
            }
            if (profileActivity.f31582o2) {
                if (profileActivity.f31589p2) {
                    ...
                    profileActivity.f31482a.w0(0, ((m10.getTop() - profileActivity.f31482a.getMeasuredWidth()) - profileActivity.O3()) + currentActionBarHeight2 + i10, org.telegram.ui.Components.qr.h);
                    return onTouchEvent;
                }
                profileActivity.f31482a.w0(0, m10.getTop() - profileActivity.T3(), org.telegram.ui.Components.qr.h);
                return onTouchEvent;
            }
            ...
            if (z10) {
                ...
                if (f7 > 0.0f && ((f7 < profileActivity.T3() * 0.6f || profileActivity.f31543i2 < -1000.0f) && profileActivity.Q1 > profileActivity.O3() * 0.6f)) {
                    profileActivity.f31482a.w0(0, (int) (profileActivity.Q1 - profileActivity.O3()), org.telegram.ui.Components.qr.h);
                    return onTouchEvent;
                }
            }
            if (z10) {
                ...
                if (f10 > 0.0f && f10 < profileActivity.O3() * 0.6f) {
                    profileActivity.f31482a.w0(0, (int) (profileActivity.O3() - profileActivity.Q1), org.telegram.ui.Components.qr.h);
                    return onTouchEvent;
                }
            }
            if (!z10) {
                float f11 = profileActivity.Q1;
                if (f11 > 0.0f && profileActivity.f31543i2 < -1000.0f) {
                    profileActivity.f31482a.w0(0, (int) f11, org.telegram.ui.Components.qr.h);
                    return onTouchEvent;
                }
            }
