...
public final class ne0 implements Runnable {
    public final int f35862a = 0;
    public final re0 f35863b;
    public final TLRPC.TL_error f35864c;
    ...
    public final void run() {
        ...
        switch (this.f35862a) {
            case 0:
                ...
                TLRPC.TL_error tL_error = this.f35864c;
                ...
                return;
            default:
                re0 re0Var2 = this.f35863b;
                qg0 qg0Var2 = re0Var2.f37312a0;
                re0Var2.R = false;
                TLRPC.TL_error tL_error2 = this.f35864c;
                if (tL_error2 == null) {
