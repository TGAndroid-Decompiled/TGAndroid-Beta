...
public final class ne0 implements Runnable {
    public final int f35848a = 0;
    public final re0 f35849b;
    ...
    public final void run() {
        ...
        switch (this.f35848a) {
            case 0:
                re0 re0Var = this.f35849b;
                qg0 qg0Var = re0Var.f37299a0;
                re0Var.M = false;
                re0Var.v.invalidate();
                ...
                TLRPC.TL_error tL_error = this.f35850c;
                ...
                return;
            default:
                re0 re0Var2 = this.f35849b;
                qg0 qg0Var2 = re0Var2.f37299a0;
                re0Var2.R = false;
                TLRPC.TL_error tL_error2 = this.f35850c;
                if (tL_error2 == null) {
