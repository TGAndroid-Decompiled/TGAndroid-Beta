...
public final class vg0 extends ReplacementSpan {
    ...
    public final TextPaint f39093c;
    public final Paint d;
    public final float e;
    public final xg0 f39094f;

    public vg0(xg0 xg0Var, int i10, boolean z4) {
        this.f39094f = xg0Var;
        TextPaint textPaint = new TextPaint(1);
        this.f39093c = textPaint;
        this.d = new Paint(1);
        String valueOf = String.valueOf(i10);
        this.f39091a = valueOf;
        this.f39092b = z4;
    ...
    public final void draw(Canvas canvas, CharSequence charSequence, int i10, int i11, float f10, int i12, int i13, int i14, Paint paint) {
        ...
        xg0 xg0Var = this.f39094f;
        int themedColor = xg0Var.getThemedColor(i15);
        Paint paint2 = this.d;
        paint2.setColor(themedColor);
        int themedColor2 = xg0Var.getThemedColor(org.telegram.ui.ActionBar.j6.f20151s8);
        TextPaint textPaint = this.f39093c;
