...
public final class vg0 {
    ...
    public final void a(lg0 lg0Var) {
        ...
        if (i11 >= 23 && AndroidUtilities.isSimAvailable()) {
            ...
            if (xg0Var.v) {
                xg0Var.f39482r.clear();
                if (!z10) {
                    xg0Var.f39482r.add("android.permission.READ_PHONE_STATE");
                }
                if (!z11) {
                    xg0Var.f39482r.add("android.permission.CALL_PHONE");
                }
                if (!z12) {
                    xg0Var.f39482r.add("android.permission.READ_CALL_LOG");
                }
                if (!z13 && i11 >= 26) {
                    xg0Var.f39482r.add("android.permission.READ_PHONE_NUMBERS");
                }
                if (!xg0Var.f39482r.isEmpty()) {
                    ...
                    if (!globalMainSettings.getBoolean("firstlogin", true) && !xg0Var.getParentActivity().shouldShowRequestPermissionRationale("android.permission.READ_PHONE_STATE") && !xg0Var.getParentActivity().shouldShowRequestPermissionRationale("android.permission.READ_CALL_LOG")) {
                        try {
                            xg0Var.getParentActivity().requestPermissions((String[]) xg0Var.f39482r.toArray(new String[0]), 6);
                            return;
                        } catch (Exception e) {
                            FileLog.e(e);
                            return;
                    ...
                    xg0Var.h = xg0Var.showDialog(alertDialog$Builder.f18622a);
                    wg0Var.L = true;
                    return;
                }
            }
