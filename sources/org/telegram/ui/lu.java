...
public final class lu extends FrameLayout {
    public final ImageView f35087a;
    public final TextView f35088b;
    public final ImageView f35089c;
    ...
    public lu(wu wuVar, Context context) {
        ...
        int i10;
        int i11;
        setBackgroundColor(wuVar.getThemedColor(org.telegram.ui.ActionBar.h6.f18789d6));
        ...
        this.f35088b = textView;
        textView.setTextSize(1, 16.0f);
        int i12 = org.telegram.ui.ActionBar.h6.G6;
        textView.setTextColor(wuVar.getThemedColor(i12));
        textView.setEllipsize(TextUtils.TruncateAt.END);
        textView.setSingleLine();
        textView.setLines(1);
        ImageView imageView2 = new ImageView(context);
        this.f35089c = imageView2;
        imageView2.setScaleType(ImageView.ScaleType.FIT_CENTER);
        imageView2.setImageResource(R.drawable.arrow_more);
        imageView2.setColorFilter(new PorterDuffColorFilter(wuVar.getThemedColor(i12), PorterDuff.Mode.MULTIPLY));
        ...
        textView2.setTextColor(wuVar.getThemedColor(org.telegram.ui.ActionBar.h6.f18990o6));
