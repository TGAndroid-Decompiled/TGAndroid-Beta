...
public final class lu implements Utilities.Callback {
    ...
    public final void run(Object obj) {
        ...
        switch (this.f35525a) {
            case 0:
                DataSettingsActivity dataSettingsActivity = (DataSettingsActivity) this.f35527c;
                Long l4 = (Long) obj;
                AndroidUtilities.cancelRunOnUIThread((ku) this.d);
                if (!dataSettingsActivity.W && System.currentTimeMillis() - this.f35526b <= 120) {
                    z10 = false;
                } else {
                    z10 = true;
                }
            ...
            case 1:
                ...
                uy uyVar = ((tx) this.f35527c).f37899b;
                Boolean bool = uyVar.G.bot_participant;
                if (bool != null && bool.booleanValue()) {
                    uyVar.getMessagesController().addUserToChat(this.f35526b, uyVar.getMessagesController().getUser(Long.valueOf(uyVar.H)), 0, null, uyVar, false, runnable, new mf(8, runnable));
                    return;
                }
                runnable.run();
                return;
            default:
                ProfileActivity.k0((ProfileActivity) this.f35527c, (Context) this.d, this.f35526b, (TL_payments.connectedBotStarRef) obj);
                return;
        }
    }
}
