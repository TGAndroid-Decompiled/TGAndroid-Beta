...
public final class ky implements org.telegram.ui.Components.t40 {
    ...
    public final void B(float f7) {
        org.telegram.ui.Components.oc ocVar = this.f35375a.f39219e4;
        if (ocVar != null) {
    ...
    public final void L(boolean z10, boolean z11) {
        ...
        int i10;
        wy wyVar = this.f35375a;
        org.telegram.ui.Components.oc ocVar = wyVar.f39219e4;
        if (ocVar != null) {
            ocVar.b();
            wyVar.f39219e4 = null;
        }
        ...
        if (z10) {
            u9Var.setImageBitmap(wyVar.f39203b4.f28277r);
        } else {
    ...
    public final void Q(final TLRPC.InputFile inputFile, final TLRPC.InputFile inputFile2, final double d, final String str, final TLRPC.PhotoSize photoSize, final TLRPC.PhotoSize photoSize2, final boolean z10, final TLRPC.VideoSize videoSize) {
        AndroidUtilities.runOnUIThread(new Runnable() {
            ...
            public final void run() {
                ...
                ky kyVar = ky.this;
                wy wyVar = kyVar.f35375a;
                TLRPC.InputFile inputFile3 = inputFile;
                TLRPC.InputFile inputFile4 = inputFile2;
                TLRPC.VideoSize videoSize2 = videoSize;
                if (inputFile3 == null && inputFile4 == null && videoSize2 == null) {
                    wyVar.f39209c4 = photoSize2.location;
                    wyVar.f39214d4 = photoSize.location;
                } else if (wyVar.f39209c4 == null) {
                    return;
                } else {
    ...
    public final fv0 getCloseIntoObject() {
        ...
        if (ocVar != null) {
            ...
            fv0 fv0Var = new fv0();
            int[] iArr = new int[2];
            org.telegram.ui.Components.u9 u9Var = fcVar.f23864c;
            org.telegram.ui.Components.u9 u9Var2 = fcVar.f23864c;
            ...
            fv0Var.f33768i = 0;
            fv0Var.h = fv0Var.f33763a.getRoundRadius();
            fv0Var.f33770k = u9Var2.getScaleX();
            return fv0Var;
        }
        return null;
    }
