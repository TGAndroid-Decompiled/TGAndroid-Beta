...
public final class pt extends org.telegram.ui.Components.kl0 {
    ...
    public final void v(s4.c1 c1Var, int i10) {
        rt rtVar = (rt) c1Var.f42675a;
        TLRPC.StickerSetCovered stickerSetCovered = (TLRPC.StickerSetCovered) this.f36677c.get(i10);
        org.telegram.ui.ActionBar.j5 j5Var = rtVar.f37184b;
        org.telegram.ui.Components.u9 u9Var = rtVar.f37183a;
        ...
        if (document != null) {
            ...
            SvgHelper.SvgDrawable svgThumb = DocumentObject.getSvgThumb(stickerSetCovered.cover, org.telegram.ui.ActionBar.i6.f18780a7, 1.0f, 1.0f, rtVar.f37185c);
            if (svgThumb != null) {
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        rt rtVar = new rt(viewGroup.getContext(), this.d.f37456c0);
