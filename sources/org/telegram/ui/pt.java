...
public final class pt extends org.telegram.ui.Components.ul0 {
    public final ArrayList f36681c;
    public final st d;

    public pt(st stVar, ArrayList arrayList) {
        this.d = stVar;
        this.f36681c = arrayList;
    }
    ...
    @Override
    public final int h() {
        return this.f36681c.size();
    }

    @Override
    public final void v(s4.c1 c1Var, int i10) {
        rt rtVar = (rt) c1Var.f42974a;
        TLRPC.StickerSetCovered stickerSetCovered = (TLRPC.StickerSetCovered) this.f36681c.get(i10);
        org.telegram.ui.ActionBar.j5 j5Var = rtVar.f37223b;
        org.telegram.ui.Components.v9 v9Var = rtVar.f37222a;
        ...
        if (document != null) {
            ...
            SvgHelper.SvgDrawable svgThumb = DocumentObject.getSvgThumb(stickerSetCovered.cover, org.telegram.ui.ActionBar.j6.f19038a7, 1.0f, 1.0f, rtVar.f37224c);
            if (svgThumb != null) {
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        rt rtVar = new rt(viewGroup.getContext(), this.d.f37529c0);
