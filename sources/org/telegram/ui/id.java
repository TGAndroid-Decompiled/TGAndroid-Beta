...
public final class id extends org.telegram.ui.Components.ov0 {
    public final int f37328w0;
    public boolean f37329x0;
    public final org.telegram.ui.ActionBar.n2 f37330y0;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        float f12;
        switch (this.f37328w0) {
            case 0:
                int size = View.MeasureSpec.getSize(i10);
                int size2 = View.MeasureSpec.getSize(i11);
                setMeasuredDimension(size, size2);
                int paddingTop = size2 - getPaddingTop();
                md mdVar = (md) this.f37330y0;
                ...
                for (int i13 = 0; i13 < childCount; i13++) {
                    ...
                    if (childAt != null && childAt.getVisibility() != 8 && childAt != md.b0(mdVar)) {
                        org.telegram.ui.Components.hu huVar = mdVar.f38665c;
            ...
            case 2:
                ...
                for (int i15 = 0; i15 < childCount3; i15++) {
                    ...
                    if (childAt3 != null && childAt3.getVisibility() != 8) {
                        ...
                        if (childAt3 != kVar4) {
                            org.telegram.ui.Components.hu huVar4 = l70Var.f38237c;
                ...
                for (int i17 = 0; i17 < childCount4; i17++) {
                    ...
                    if (childAt4 != null && childAt4.getVisibility() != 8) {
                        ...
                        if (childAt4 != kVar6) {
                            ...
                            } else if (zv0Var.f43559c == childAt4) {
