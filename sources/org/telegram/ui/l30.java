...
public final class l30 implements View.OnClickListener {
    public final w5 f35211a = new w5(this, 5);
    public final d60 f35212b;
    ...
    public final void onClick(View view) {
        ...
        d60 d60Var = this.f35212b;
        j30 j30Var = d60Var.f33029x;
        ...
        if (d60Var.f32935a1 != null && d60Var.F1 != 3) {
            int i11 = 6;
            int i12 = 0;
            if (d60Var.r1() && !d60Var.f32935a1.isScheduled()) {
                v30 v30Var = d60Var.a2;
                if (v30Var != null && v30Var.f29461b && (AndroidUtilities.isTablet() || d60.F3 == d60Var.q1())) {
                    d60Var.e1(null);
                    if (d60.F3) {
                        AndroidUtilities.runOnUIThread(new c10(this, 5), 200L);
                    }
                    d60Var.f32968i0.setRequestedOrientation(-1);
                    return;
                    ...
                    if (d60Var.q1()) {
                        d60Var.f32968i0.setRequestedOrientation(6);
                        return;
                    } else {
                        d60Var.f32968i0.setRequestedOrientation(1);
                        return;
            ...
            if (i13 == 5) {
                if (!d60Var.H1) {
                    ...
                    accountInstance.getConnectionsManager().sendRequest(startscheduledgroupcall, new RequestDelegate(this) {
                        ...
                        public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                            switch (r2) {
                                case 0:
                                    l30 l30Var = this.f34920b;
                                    if (tLObject != null) {
                                        l30Var.f35212b.d.getMessagesController().processUpdates((TLRPC.Updates) tLObject, false);
                                        return;
                                    } else {
                                        l30Var.getClass();
                                        return;
                                ...
                                default:
                                    l30 l30Var2 = this.f34920b;
                                    if (tLObject != null) {
                                        l30Var2.f35212b.d.getMessagesController().processUpdates((TLRPC.Updates) tLObject, false);
                                        return;
                                    } else {
                                        l30Var2.getClass();
                                        return;
                ...
                if (VoIPService.getSharedInstance() != null && (i10 = d60Var.T1) != 1 && i10 != 2 && i10 != 6 && i10 != 5) {
                    ...
                    if (i14 != 2 && i14 != 4) {
                        try {
                            if (i14 == 0) {
                                if (Build.VERSION.SDK_INT >= 23 && (launchActivity = d60Var.f32968i0) != null && launchActivity.checkSelfPermission("android.permission.RECORD_AUDIO") != 0) {
                        ...
                        ij0Var.P(i15);
                        ij0Var.S(i15 - 1, this.f35211a);
                        j30Var.setAnimation(ij0Var);
                        ij0Var.M(i12);
                        j30Var.d();
                        if (d60Var.F1 == 2) {
                            long peerId = MessageObject.getPeerId(((TLRPC.GroupCallParticipant) d60Var.f32935a1.participants.f(MessageObject.getPeerId(d60Var.A0))).peer);
                ...
                if (i13 == 6 && (j40Var = d60Var.f32986n0) != null) {
                    j40Var.b(true);
                }
                TL_phone.toggleGroupCallStartSubscription togglegroupcallstartsubscription = new TL_phone.toggleGroupCallStartSubscription();
                togglegroupcallstartsubscription.call = d60Var.f32935a1.getInputGroupCall();
                TLRPC.GroupCall groupCall = d60Var.f32935a1.call;
                ...
                if (d60Var.f32935a1.call.schedule_start_subscribed) {
                    i11 = 7;
                }
                d60Var.J1(i11, true);
            }
