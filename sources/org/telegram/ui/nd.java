...
public final class nd implements Runnable {
    ...
    public final void run() {
        ...
        int i11 = this.f35905c;
        ke keVar = this.f35904b;
        switch (i10) {
            case 0:
            ...
            default:
                ...
                if (currentTime < keVar.L0) {
                    ...
                    if (keVar.f35048h1 == null) {
                        keVar.f35048h1 = new SpannableStringBuilder("l");
                        org.telegram.ui.Components.oq oqVar = new org.telegram.ui.Components.oq(R.drawable.mini_switch_lock, 0);
                        oqVar.setTopOffset(1);
                        keVar.f35048h1.setSpan(oqVar, 0, 1, 33);
                    }
                    SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder();
                    spannableStringBuilder.append((CharSequence) keVar.f35048h1).append((CharSequence) yh.g.j0(keVar.L0 - currentTime));
                    ...
                    if (qcVar != null) {
                        ...
                        if ((ubVar instanceof org.telegram.ui.Components.yb) && ubVar.isAttachedToWindow()) {
                            org.telegram.messenger.wh.p(R.string.BotStarsWithdrawalToast, new Object[]{yh.g.j0(keVar.L0 - currentTime)}, ((org.telegram.ui.Components.yb) keVar.Z0.e).f30530b);
                        }
                    }
                ...
                beVar.g(yh.v7.V0(false, formatPluralStringSpaced, keVar.R0), true, true);
                return;
        }
    }
}
