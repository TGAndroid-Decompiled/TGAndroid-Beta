...
public final class nd extends org.telegram.ui.ActionBar.o2 implements NotificationCenter.NotificationCenterDelegate, org.telegram.ui.Components.t40 {
    ...
    public l4 Y;
    public boolean Z;
    public org.telegram.ui.ActionBar.w0 f36037a;
    public boolean f36038a0;
    public org.telegram.ui.Components.pr f36039b;
    public boolean f36040b0;
    public org.telegram.ui.Components.ju f36041c;
    public TLRPC.TL_chatInviteExported f36042c0;
    public org.telegram.ui.Cells.a7 d;
    public boolean f36043d0;
    public ai.z5 e;
    public org.telegram.ui.Cells.e9 f36044e0;
    public ci.s6 f36045f;
    public final ArrayList f36046f0;
    public org.telegram.ui.Cells.r4 f36047g0;
    public kd h;
    public final int f36048h0;
    public final long f36049i0;
    public boolean f36050j0;
    public final Boolean f36051k0;
    public TLRPC.InputFile f36052l0;
    public TLRPC.InputFile m0;
    public AnimatorSet f36053n;
    public TLRPC.VideoSize f36054n0;
    public String f36055o0;
    public double f36056p0;
    public boolean f36057q0;
    public ld f36058r;
    public boolean f36059r0;
    public final org.telegram.ui.Components.f9 f36060s;
    public Integer f36061s0;
    public Utilities.Callback2 f36062t0;
    public org.telegram.ui.ActionBar.c2 f36063u0;
    public final org.telegram.ui.Components.u40 v;
    public final ed f36064v0;
    public EditTextBoldCursor f36065w;
    public ValueAnimator f36066w0;
    public TLRPC.FileLocation f36067x;
    public TLRPC.FileLocation f36068y;

    public nd(Bundle bundle) {
        super(bundle);
        this.f36046f0 = new ArrayList();
        this.f36050j0 = true;
        this.f36064v0 = new ed(this, 2);
        int i10 = bundle.getInt("step", 0);
        this.f36048h0 = i10;
        if (bundle.containsKey("forcePublic")) {
            this.f36051k0 = Boolean.valueOf(bundle.getBoolean("forcePublic", false));
        }
        if (i10 == 0) {
            this.f36060s = new org.telegram.ui.Components.f9((org.telegram.ui.ActionBar.f6) null);
        ...
        this.f36049i0 = bundle.getLong("chat_id", 0L);
    }

    public static void U(nd ndVar, org.telegram.ui.ActionBar.c2 c2Var) {
        ndVar.f36059r0 = false;
        ndVar.f36057q0 = false;
        if (ndVar.f36061s0 != null) {
            ConnectionsManager.getInstance(ndVar.currentAccount).cancelRequest(ndVar.f36061s0.intValue(), true);
            ndVar.f36061s0 = null;
        }
        ndVar.g0(false);
        c2Var.dismiss();
    ...
    public static void W(nd ndVar, String str) {
        ...
        tL_channels_checkUsername.channel = MessagesController.getInstance(ndVar.currentAccount).getInputChannel(ndVar.f36049i0);
    ...
    public static void Y(nd ndVar) {
        ...
        ndVar.f36063u0 = alertDialog$Builder.o();
    }

    @Override
    public final void B(float f7) {
        ld ldVar = this.f36058r;
        if (ldVar == null) {
            return;
        }
    ...
    public final View createView(Context context) {
        ...
        int i20;
        nd ndVar = this;
        org.telegram.ui.Components.ju juVar = ndVar.f36041c;
        if (juVar != null) {
            juVar.o();
        }
        ...
        int i21 = org.telegram.ui.ActionBar.j6.f19194v8;
        ...
        ndVar.f36039b = prVar;
        ndVar.f36037a = n10.i(AndroidUtilities.dp(56.0f), LocaleController.getString(R.string.Done), prVar);
        int i22 = ndVar.f36048h0;
        if (i22 == 0) {
            ...
            int i23 = org.telegram.ui.ActionBar.j6.f18862d6;
            ...
            org.telegram.ui.Components.f9 f9Var = ndVar.f36060s;
            ...
            ndVar.f36045f.setOnClickListener(new fd(ndVar, 1));
            ...
            ndVar.f36058r.setProgressColor(-1);
            ndVar.f36058r.setNoProgress(false);
            ld ldVar2 = ndVar.f36058r;
            ...
            ndVar = this;
            ndVar.f36041c = juVar2;
            juVar2.setHint(LocaleController.getString(R.string.EnterChannelName));
            String str = ndVar.E;
            if (str != null) {
                ndVar.f36041c.setText(str);
                ndVar.E = null;
            }
            ndVar.f36041c.setFilters(new InputFilter[]{new InputFilter.LengthFilter(100)});
            ndVar.f36041c.getEditText().setSingleLine(true);
            ndVar.f36041c.getEditText().setImeOptions(5);
            ndVar.f36041c.getEditText().setOnEditorActionListener(new TextView.OnEditorActionListener(ndVar) {
                public final nd f33948b;
                ...
                public final boolean onEditorAction(TextView textView, int i28, KeyEvent keyEvent) {
                    ...
                    switch (r2) {
                        case 0:
                            nd ndVar2 = this.f33948b;
                            if (i28 == 5) {
                                if (!TextUtils.isEmpty(ndVar2.f36041c.getEditText().getText())) {
                                    ndVar2.f36065w.requestFocus();
                                    return true;
                                }
                            } else {
                                ndVar2.getClass();
                            ...
                            return false;
                        default:
                            if (i28 == 6 && (w0Var = this.f33948b.f36037a) != null) {
                                w0Var.performClick();
                                return true;
                            }
                            return false;
            ...
            org.telegram.ui.Components.ju juVar3 = ndVar.f36041c;
            ...
            ndVar.f36065w = editTextBoldCursor;
            editTextBoldCursor.setTextSize(1, 18.0f);
            ndVar.f36065w.setHintTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.H6, false));
            EditTextBoldCursor editTextBoldCursor2 = ndVar.f36065w;
            int i28 = org.telegram.ui.ActionBar.j6.G6;
            editTextBoldCursor2.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i28, false));
            ndVar.f36065w.setBackgroundDrawable(null);
            ndVar.f36065w.setLineColors(ndVar.getThemedColor(org.telegram.ui.ActionBar.j6.f18990k6), ndVar.getThemedColor(org.telegram.ui.ActionBar.j6.f19008l6), ndVar.getThemedColor(org.telegram.ui.ActionBar.j6.f19082p7));
            ndVar.f36065w.setPadding(0, 0, 0, AndroidUtilities.dp(6.0f));
            EditTextBoldCursor editTextBoldCursor3 = ndVar.f36065w;
            ...
            ndVar.f36065w.setInputType(180225);
            ndVar.f36065w.setImeOptions(6);
            ndVar.f36065w.setFilters(new InputFilter[]{new InputFilter.LengthFilter(120)});
            ndVar.f36065w.setHint(LocaleController.getString(R.string.DescriptionPlaceholder));
            ndVar.f36065w.setCursorColor(org.telegram.ui.ActionBar.j6.w0(null, i28, false));
            ndVar.f36065w.setCursorSize(AndroidUtilities.dp(20.0f));
            ndVar.f36065w.setCursorWidth(1.5f);
            ndVar.K.addView(ndVar.f36065w, w7.x5.k(24.0f, 18.0f, 24.0f, 0.0f, -1, -2));
            ndVar.f36065w.setOnEditorActionListener(new TextView.OnEditorActionListener(ndVar) {
                public final nd f33948b;
                ...
                public final boolean onEditorAction(TextView textView, int i282, KeyEvent keyEvent) {
                    ...
                    switch (r2) {
                        case 0:
                            ...
                            return false;
                        default:
                            if (i282 == 6 && (w0Var = this.f33948b.f36037a) != null) {
                                w0Var.performClick();
                                return true;
                            }
                            return false;
            ...
            ndVar.f36065w.addTextChangedListener(new md(0));
            ...
            int i29 = org.telegram.ui.ActionBar.j6.f18806a7;
            ...
            int i30 = org.telegram.ui.ActionBar.j6.f18862d6;
            ...
            Boolean bool = ndVar.f36051k0;
            if (bool != null && !bool.booleanValue()) {
                ndVar.f36038a0 = true;
            }
            if (ndVar.I) {
                ndVar.Q.b(LocaleController.getString(R.string.MegaPublic), LocaleController.getString(R.string.MegaPublicInfo), false, !ndVar.f36038a0);
            } else {
                ndVar.Q.b(LocaleController.getString(R.string.ChannelPublic), LocaleController.getString(R.string.ChannelPublicInfo), false, !ndVar.f36038a0);
            }
            ...
            if (bool != null && bool.booleanValue()) {
                ndVar.f36038a0 = false;
            }
            if (ndVar.I) {
                ndVar.R.b(LocaleController.getString(R.string.MegaPrivate), LocaleController.getString(R.string.MegaPrivateInfo), false, ndVar.f36038a0);
            } else {
                ndVar.R.b(LocaleController.getString(R.string.ChannelPrivate), LocaleController.getString(R.string.ChannelPrivateInfo), false, ndVar.f36038a0);
            }
            ...
            ndVar.f36065w = editTextBoldCursor7;
            editTextBoldCursor7.setTextSize(1, 18.0f);
            ndVar.f36065w.setHintTextColor(org.telegram.ui.ActionBar.j6.w0(null, i31, false));
            ndVar.f36065w.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i32, false));
            ndVar.f36065w.setMaxLines(1);
            ndVar.f36065w.setLines(1);
            ndVar.f36065w.setBackgroundDrawable(null);
            ndVar.f36065w.setPadding(0, 0, 0, 0);
            ndVar.f36065w.setSingleLine(true);
            ndVar.f36065w.setInputType(163872);
            ndVar.f36065w.setImeOptions(6);
            ndVar.f36065w.setHint(LocaleController.getString(R.string.ChannelUsernamePlaceholder));
            ndVar.f36065w.setCursorColor(org.telegram.ui.ActionBar.j6.w0(null, i32, false));
            ndVar.f36065w.setCursorSize(AndroidUtilities.dp(20.0f));
            ndVar.f36065w.setCursorWidth(1.5f);
            ndVar.N.addView(ndVar.f36065w, w7.x5.n(-1, 36));
            ndVar.f36065w.addTextChangedListener(new l0(ndVar, 1));
            ...
            int i34 = org.telegram.ui.ActionBar.j6.f18826b7;
    ...
    public final boolean d0(String str) {
        ...
        int i16 = org.telegram.ui.ActionBar.j6.f19082p7;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.chatDidFailCreate) {
            org.telegram.ui.ActionBar.c2 c2Var = this.f36063u0;
            if (c2Var != null) {
                try {
                    c2Var.dismiss();
                    this.f36063u0 = null;
            ...
            org.telegram.ui.ActionBar.c2 c2Var2 = this.f36063u0;
            if (c2Var2 != null) {
                try {
                    c2Var2.dismiss();
                    this.f36063u0 = null;
            ...
            bundle.putBoolean("canCreatePublic", this.f36050j0);
            Boolean bool = this.f36051k0;
            if (bool != null) {
                bundle.putBoolean("forcePublic", bool.booleanValue());
            }
            if (this.f36052l0 != null || this.m0 != null || this.f36054n0 != null) {
                MessagesController.getInstance(this.currentAccount).changeChatAvatar(longValue, null, this.f36052l0, this.m0, this.f36054n0, this.f36056p0, this.f36055o0, this.f36067x, this.f36068y, null);
            }
            nd ndVar = new nd(bundle);
            ndVar.f36062t0 = this.f36062t0;
    ...
    public final void e0(boolean z10, boolean z11) {
        ...
        AnimatorSet animatorSet = this.f36053n;
        if (animatorSet != null) {
        ...
        if (z11) {
            this.f36053n = new AnimatorSet();
            if (z10) {
                this.f36058r.setVisibility(0);
                AnimatorSet animatorSet2 = this.f36053n;
                kd kdVar = this.h;
                Property property = View.ALPHA;
                animatorSet2.playTogether(ObjectAnimator.ofFloat(kdVar, property, 0.0f), ObjectAnimator.ofFloat(this.f36058r, property, 1.0f));
            } else {
                if (this.h.getVisibility() != 0) {
                    this.h.setAlpha(0.0f);
                }
                this.h.setVisibility(0);
                AnimatorSet animatorSet3 = this.f36053n;
                kd kdVar2 = this.h;
                Property property2 = View.ALPHA;
                animatorSet3.playTogether(ObjectAnimator.ofFloat(kdVar2, property2, 1.0f), ObjectAnimator.ofFloat(this.f36058r, property2, 0.0f));
            }
            this.f36053n.setDuration(180L);
            this.f36053n.addListener(new ai.n(27, this, z10));
            this.f36053n.start();
        } else if (z10) {
            this.h.setAlpha(1.0f);
            this.h.setVisibility(4);
            this.f36058r.setAlpha(1.0f);
            this.f36058r.setVisibility(0);
        } else {
            this.h.setAlpha(1.0f);
            this.h.setVisibility(0);
            this.f36058r.setAlpha(0.0f);
            this.f36058r.setVisibility(4);
        }
    }
    ...
    public final void g0(boolean z10) {
        float f7;
        if (!z10) {
            AndroidUtilities.cancelRunOnUIThread(this.f36064v0);
        }
        if (this.f36039b != null) {
            ValueAnimator valueAnimator = this.f36066w0;
            if (valueAnimator != null) {
                valueAnimator.cancel();
            }
            float f10 = this.f36039b.f27117c;
            float f11 = 0.0f;
            if (z10) {
                f7 = 1.0f;
            } else {
            ...
            this.f36066w0 = ofFloat;
            ofFloat.addUpdateListener(new b3(this, 3));
            ValueAnimator valueAnimator2 = this.f36066w0;
            float f12 = this.f36039b.f27117c;
            if (z10) {
                f11 = 1.0f;
            }
            valueAnimator2.setDuration(Math.abs(f12 - f11) * 200.0f);
            this.f36066w0.setInterpolator(org.telegram.ui.Components.qr.f27380f);
            this.f36066w0.start();
        }
    }
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        org.telegram.ui.Components.ju juVar = this.f36041c;
        int i11 = org.telegram.ui.ActionBar.j6.G6;
        arrayList.add(new org.telegram.ui.ActionBar.l6(juVar, 4, null, null, null, null, i11));
        org.telegram.ui.Components.ju juVar2 = this.f36041c;
        ...
        org.telegram.ui.Components.ju juVar3 = this.f36041c;
        int i13 = org.telegram.ui.ActionBar.j6.f18990k6;
        arrayList.add(new org.telegram.ui.ActionBar.l6(juVar3, 32, null, null, null, null, i13));
        org.telegram.ui.Components.ju juVar4 = this.f36041c;
        int i14 = org.telegram.ui.ActionBar.j6.f19008l6;
        arrayList.add(new org.telegram.ui.ActionBar.l6(juVar4, 65568, null, null, null, null, i14));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36065w, 4, null, null, null, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36065w, 8388608, null, null, null, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36065w, 32, null, null, null, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36065w, 65568, null, null, null, null, i14));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.U, 262148, null, null, null, null, org.telegram.ui.ActionBar.j6.f19210w6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36044e0, 32, new Class[]{org.telegram.ui.Cells.e9.class}, null, null, null, i16));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.L, 1, null, null, null, null, i10));
        LinearLayout linearLayout = this.O;
        int i19 = org.telegram.ui.ActionBar.j6.f18952i6;
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36047g0, 0, new Class[]{org.telegram.ui.Cells.r4.class}, new String[]{"progressBar"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f18934h6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.Q, 4096, null, null, null, null, i19));
        int i20 = org.telegram.ui.ActionBar.j6.f18917g7;
        ...
        int i21 = org.telegram.ui.ActionBar.j6.f18935h7;
        ...
        int i22 = org.telegram.ui.ActionBar.j6.f19263z6;
        ...
        int i23 = org.telegram.ui.ActionBar.j6.f19244y6;
    ...
    public final void h0() {
        ...
        String str = null;
        int i16 = 8;
        if (!this.f36038a0 && !this.f36050j0) {
            ...
            if (this.f36043d0) {
                this.f36047g0.setVisibility(0);
                this.L.setVisibility(8);
                org.telegram.ui.Cells.e9 e9Var2 = this.S;
                e9Var2.setBackgroundDrawable(org.telegram.ui.ActionBar.j6.V0(e9Var2.getContext(), R.drawable.greydivider_bottom, org.telegram.ui.ActionBar.j6.f18826b7));
                this.f36044e0.setVisibility(8);
            } else {
                org.telegram.ui.Cells.e9 e9Var3 = this.S;
                e9Var3.setBackgroundDrawable(org.telegram.ui.ActionBar.j6.V0(e9Var3.getContext(), R.drawable.greydivider, org.telegram.ui.ActionBar.j6.f18826b7));
                this.f36047g0.setVisibility(8);
                this.L.setVisibility(0);
                this.f36044e0.setVisibility(0);
            }
        } else {
            ...
            e9Var5.setBackgroundDrawable(org.telegram.ui.ActionBar.j6.V0(e9Var5.getContext(), R.drawable.greydivider_bottom, org.telegram.ui.ActionBar.j6.f18826b7));
            ...
            TLRPC.TL_chatInviteExported tL_chatInviteExported = this.f36042c0;
            if (tL_chatInviteExported != null) {
                str = tL_chatInviteExported.link;
            }
            v80Var.setLink(str);
            org.telegram.ui.Cells.x1 x1Var = this.U;
            if (!this.f36038a0 && x1Var.length() != 0) {
                i16 = 0;
            }
            x1Var.setVisibility(i16);
        }
        this.Q.a(!this.f36038a0);
        this.R.a(this.f36038a0);
        this.f36065w.clearFocus();
        AndroidUtilities.hideKeyboard(this.f36065w);
    }
    ...
    public final boolean onFragmentCreate() {
        ...
        if (this.f36048h0 == 1 && !this.f36040b0 && this.f36042c0 == null) {
            MessagesController messagesController = getMessagesController();
            long j3 = this.f36049i0;
            TLRPC.ChatFull chatFull = messagesController.getChatFull(j3);
            if (chatFull != null) {
                this.f36042c0 = chatFull.exported_invite;
            }
            if (this.f36042c0 == null) {
                this.f36040b0 = true;
    ...
    public final void onFragmentDestroy() {
        ...
        if (this.f36061s0 != null) {
            ConnectionsManager.getInstance(this.currentAccount).cancelRequest(this.f36061s0.intValue(), true);
            this.f36061s0 = null;
        }
    ...
    public final void onTransitionAnimationEnd(boolean z10, boolean z11) {
        if (z10 && this.f36048h0 != 1) {
            this.f36041c.requestFocus();
            org.telegram.ui.Components.eu euVar = this.f36041c.f25430a;
            euVar.requestFocus();
