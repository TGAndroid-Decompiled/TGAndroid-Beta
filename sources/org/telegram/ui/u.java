...
public final class u implements ev0, org.telegram.ui.Components.ml0, org.telegram.ui.ActionBar.k1 {
    ...
    public void b(float[] fArr) {
        i4 i4Var = this.f38261a;
        fArr[0] = i4Var.I0;
        fArr[1] = i4Var.f34407u0[0].f35460b.getMeasuredHeight();
    }
    ...
    public boolean d(int i10, View view) {
        ...
        if (view instanceof i2) {
            c4 c4Var = ((i2) view).f34349n;
            i4Var.Z(c4Var.f32555a.articles.get(c4Var.f32556b).url);
            return true;
        }
        return false;
    }
