...
public final class zp0 extends FrameLayout {
    ...
    public int K;
    public final aq0 L;
    public final q60 f40272a;
    public final s4.c0 f40273b;
    public final w7 f40274c;
    public int d;
    public final org.telegram.ui.Components.c6 e;
    public final ArrayList f40275f;
    public mp0 h;
    public final RectF f40276n;
    public final RectF f40277r;
    public final RectF f40278s;
    public final Paint v;
    public final Paint f40279w;
    public int f40280x;
    public int f40281y;
    ...
    public zp0(aq0 aq0Var, Context context, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        this.f40276n = new RectF();
        this.f40277r = new RectF();
        this.f40278s = new RectF();
        this.v = new Paint(1);
        this.f40279w = new Paint(1);
        this.J = new Path();
    ...
    public final void a(int i10, boolean z10) {
        ...
        ArrayList arrayList = this.f40275f;
        boolean isEmpty = arrayList.isEmpty();
        q60 q60Var = this.f40272a;
        if (!isEmpty) {
