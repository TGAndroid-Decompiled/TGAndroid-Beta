...
public final class sc extends FrameLayout {
    public final org.telegram.ui.ActionBar.f6 f40434a;
    public final ec1 f40435b;
    public final s4.c0 f40436c;
    public final int d;
    public int f40437e;
    ...
    public final void a(int i10, boolean z10) {
        ...
        if (peerColors != null) {
            ...
            while (true) {
                if (i12 >= peerColors.colors.size()) {
                    break;
                } else if (peerColors.colors.get(i12).f17109id == i10) {
                    i11 = i12;
                    break;
                } else {
                    i12++;
        ...
        if (i11 != this.f40437e) {
            this.f40437e = i11;
            if (!z10) {
                this.f40436c.h1(i11, (AndroidUtilities.displaySize.x - AndroidUtilities.dp(56.0f)) / 2);
            }
            AndroidUtilities.forEachViews((RecyclerView) this.f40435b, (e2.h) new m4.s0(1, this, z10));
        }
    }
