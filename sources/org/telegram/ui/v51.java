...
public final class v51 extends FrameLayout {
    ...
    public void dispatchDraw(Canvas canvas) {
        switch (this.f41454a) {
            case 6:
                org.telegram.ui.ActionBar.j6.f20778i3.setBounds(0, 0, getMeasuredWidth(), org.telegram.ui.ActionBar.j6.f20778i3.getIntrinsicHeight());
    ...
    public void onDraw(Canvas canvas) {
        switch (this.f41454a) {
            case 5:
                super.onDraw(canvas);
                canvas.drawRect(0.0f, 0.0f, getMeasuredWidth(), 1.0f, org.telegram.ui.ActionBar.j6.f20813k0);
                return;
            default:
                super.onDraw(canvas);
                return;
