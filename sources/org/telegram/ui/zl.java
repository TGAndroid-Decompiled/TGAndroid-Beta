...
public final class zl extends lu0 {
    public final MessageObject f40531a;
    public final MediaController.PhotoEntry f40532b;
    public final am f40533c;

    public zl(am amVar, MessageObject messageObject, MediaController.PhotoEntry photoEntry) {
        this.f40533c = amVar;
        this.f40531a = messageObject;
        this.f40532b = photoEntry;
    }

    @Override
    public final vu0 E(MessageObject messageObject, TLRPC.FileLocation fileLocation, int i10, boolean z10, boolean z11) {
        return this.f40533c.f32197a.Q.Fa.E(this.f40531a, fileLocation, i10, z10, false);
    }

    @Override
    public final void o(int i10, VideoEditedInfo videoEditedInfo, boolean z10, int i11, int i12, boolean z11) {
        jm jmVar = this.f40533c.f32197a;
        MessageObject messageObject = this.f40531a;
        messageObject.settingAvatar = true;
        MediaController.PhotoEntry photoEntry = this.f40532b;
        ...
        v40Var.t(photoEntry);
        v40Var.f28992b = new da(currentAccount, ajVar, parentLayout, v40Var);
    }
}
