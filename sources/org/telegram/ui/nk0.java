...
public final class nk0 implements org.telegram.ui.Components.no {
    ...
    public final void a() {
        ...
        ArrayList arrayList = notificationsCustomSettingsActivity.f33482w;
        wk0 wk0Var = this.f38976c;
        ArrayList arrayList2 = this.f38978f;
        if (arrayList2 != arrayList && (indexOf = arrayList.indexOf(wk0Var)) >= 0) {
            notificationsCustomSettingsActivity.f33482w.remove(indexOf);
            notificationsCustomSettingsActivity.f33483x.remove(Long.valueOf(wk0Var.d));
        }
        arrayList2.remove(wk0Var);
        if (arrayList2 == notificationsCustomSettingsActivity.f33482w) {
            notificationsCustomSettingsActivity.l0(true);
            notificationsCustomSettingsActivity.d0();
        } else {
            notificationsCustomSettingsActivity.l0(true);
            notificationsCustomSettingsActivity.d.m(this.f38977e);
        }
    ...
    public final void b() {
        org.telegram.ui.ActionBar.k kVar;
        NotificationsCustomSettingsActivity notificationsCustomSettingsActivity = this.h;
        if (notificationsCustomSettingsActivity.getMessagesController().isDialogMuted(this.f38974a, 0) != this.f38975b) {
            a();
            return;
        }
        ...
        wk0 wk0Var = this.f38976c;
        sb2.append(wk0Var.d);
        wk0Var.f42427b = notificationsSettings.getBoolean(sb2.toString(), false);
        ...
        if (this.d) {
            notificationsCustomSettingsActivity.f33482w.add(wk0Var);
            notificationsCustomSettingsActivity.f33483x.put(Long.valueOf(wk0Var.d), wk0Var);
            notificationsCustomSettingsActivity.l0(true);
        } else {
            notificationsCustomSettingsActivity.f33474a.getAdapter().m(this.f38977e);
        }
        kVar = ((org.telegram.ui.ActionBar.n2) notificationsCustomSettingsActivity).actionBar;
        kVar.h(true);
    }
    ...
    public final void n() {
        ...
        notificationsCustomSettingsActivity.getNotificationsController().muteDialog(this.f38974a, j3, !messagesController.isDialogMuted(j10, j3));
    ...
    @Override
    public final void p() {
        long j3 = this.f38974a;
        if (j3 != 0) {
            y11 y11Var = new y11(w.f.e(j3, "dialog_id"), null);
            y11Var.f42958r = new g(this, 28);
    ...
    public final void s() {
        int i10;
        String sharedPrefKey = NotificationsController.getSharedPrefKey(this.f38974a, 0);
        NotificationsCustomSettingsActivity notificationsCustomSettingsActivity = this.h;
    ...
    public final void x(int i10) {
        NotificationsCustomSettingsActivity notificationsCustomSettingsActivity = this.h;
        if (i10 == 0) {
            if (notificationsCustomSettingsActivity.getMessagesController().isDialogMuted(this.f38974a, 0)) {
                n();
            }
            if (org.telegram.ui.Components.yc.a(notificationsCustomSettingsActivity)) {
            ...
            notificationsCustomSettingsActivity.getNotificationsController().muteUntil(this.f38974a, 0, i10);
            if (org.telegram.ui.Components.yc.a(notificationsCustomSettingsActivity)) {
