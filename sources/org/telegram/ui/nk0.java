...
public final class nk0 implements org.telegram.ui.Components.no {
    ...
    public final wk0 f39002c;
    public final boolean d;
    public final int f39003e;
    public final ArrayList f39004f;
    ...
    public final void a() {
        ...
        ArrayList arrayList = notificationsCustomSettingsActivity.f33508w;
        wk0 wk0Var = this.f39002c;
        ArrayList arrayList2 = this.f39004f;
        if (arrayList2 != arrayList && (indexOf = arrayList.indexOf(wk0Var)) >= 0) {
            notificationsCustomSettingsActivity.f33508w.remove(indexOf);
            notificationsCustomSettingsActivity.f33509x.remove(Long.valueOf(wk0Var.d));
        }
        arrayList2.remove(wk0Var);
        if (arrayList2 == notificationsCustomSettingsActivity.f33508w) {
            notificationsCustomSettingsActivity.l0(true);
            notificationsCustomSettingsActivity.d0();
        } else {
            notificationsCustomSettingsActivity.l0(true);
            notificationsCustomSettingsActivity.d.m(this.f39003e);
        }
    ...
    public final void b() {
        org.telegram.ui.ActionBar.k kVar;
        NotificationsCustomSettingsActivity notificationsCustomSettingsActivity = this.h;
        if (notificationsCustomSettingsActivity.getMessagesController().isDialogMuted(this.f39000a, 0) != this.f39001b) {
            a();
            return;
        }
        ...
        wk0 wk0Var = this.f39002c;
        sb2.append(wk0Var.d);
        wk0Var.f42453b = notificationsSettings.getBoolean(sb2.toString(), false);
        ...
        if (this.d) {
            notificationsCustomSettingsActivity.f33508w.add(wk0Var);
            notificationsCustomSettingsActivity.f33509x.put(Long.valueOf(wk0Var.d), wk0Var);
            notificationsCustomSettingsActivity.l0(true);
        } else {
            notificationsCustomSettingsActivity.f33500a.getAdapter().m(this.f39003e);
        }
        kVar = ((org.telegram.ui.ActionBar.n2) notificationsCustomSettingsActivity).actionBar;
        kVar.h(true);
    }
    ...
    public final void n() {
        ...
        long j3 = 0;
        long j10 = this.f39000a;
        notificationsCustomSettingsActivity.getNotificationsController().muteDialog(this.f39000a, j3, !messagesController.isDialogMuted(j10, j3));
    ...
    @Override
    public final void p() {
        long j3 = this.f39000a;
        if (j3 != 0) {
            y11 y11Var = new y11(w.f.e(j3, "dialog_id"), null);
            y11Var.f42984r = new g(this, 28);
    ...
    public final void s() {
        int i10;
        String sharedPrefKey = NotificationsController.getSharedPrefKey(this.f39000a, 0);
        NotificationsCustomSettingsActivity notificationsCustomSettingsActivity = this.h;
    ...
    public final void x(int i10) {
        NotificationsCustomSettingsActivity notificationsCustomSettingsActivity = this.h;
        if (i10 == 0) {
            if (notificationsCustomSettingsActivity.getMessagesController().isDialogMuted(this.f39000a, 0)) {
                n();
            }
            if (org.telegram.ui.Components.yc.a(notificationsCustomSettingsActivity)) {
            ...
            notificationsCustomSettingsActivity.getNotificationsController().muteUntil(this.f39000a, 0, i10);
            if (org.telegram.ui.Components.yc.a(notificationsCustomSettingsActivity)) {
