...
public final class ym0 implements RequestDelegate {
    ...
    public final void run(TLObject tLObject, final TLRPC.TL_error tL_error) {
        switch (this.f39938a) {
            case 0:
                AndroidUtilities.runOnUIThread(new zm0(this.f39939b, tLObject, tL_error));
                return;
            case 1:
                final an0 an0Var = this.f39939b;
                    ...
                    public final void run() {
                        ...
                        switch (r3) {
                            case 0:
                                ...
                                if (on0Var.f36308y == null) {
                                    on0Var.f36308y = new TL_account.authorizationForm();
                                }
                                an0Var2.a();
                                return;
                            default:
                                ...
                                if (tL_error3 != null && "SRP_ID_INVALID".equals(tL_error3.text)) {
                                    ...
                                    i11 = ((org.telegram.ui.ActionBar.n2) an0Var3.e).currentAccount;
                                    ConnectionsManager.getInstance(i11).sendRequest(getpassword2, new ym0(an0Var3, 3), 8);
                                    return;
                                }
                                Utilities.globalQueue.postRunnable(new pf0(an0Var3, an0Var3.f31876b, an0Var3.d, 12));
                                return;
                        }
                    }
                });
                return;
            case 2:
                final an0 an0Var2 = this.f39939b;
                AndroidUtilities.runOnUIThread(new Runnable() {
                    @Override
                    public final void run() {
                        int i10;
                ...
                return;
            case 3:
                AndroidUtilities.runOnUIThread(new zm0(this.f39939b, tL_error, tLObject, 1));
                return;
            default:
                AndroidUtilities.runOnUIThread(new zm0(this.f39939b, tL_error, tLObject, 2));
                return;
        }
    }
}
