...
public final class ym0 implements RequestDelegate {
    ...
    public final void run(TLObject tLObject, final TLRPC.TL_error tL_error) {
        switch (this.f39910a) {
            case 0:
                AndroidUtilities.runOnUIThread(new zm0(this.f39911b, tLObject, tL_error));
                return;
            case 1:
                final an0 an0Var = this.f39911b;
                    ...
                    public final void run() {
                        ...
                        switch (r3) {
                            case 0:
                                ...
                                if (on0Var.f36311y == null) {
                                    on0Var.f36311y = new TL_account.authorizationForm();
                                }
                                an0Var2.a();
                                return;
                            default:
                                ...
                                Utilities.globalQueue.postRunnable(new pf0(an0Var3, an0Var3.f31861b, an0Var3.d, 12));
                                return;
                        }
                    }
                });
                return;
            case 2:
                final an0 an0Var2 = this.f39911b;
                AndroidUtilities.runOnUIThread(new Runnable() {
                    @Override
                    public final void run() {
                        int i10;
                ...
                return;
            case 3:
                AndroidUtilities.runOnUIThread(new zm0(this.f39911b, tL_error, tLObject, 1));
                return;
            default:
                AndroidUtilities.runOnUIThread(new zm0(this.f39911b, tL_error, tLObject, 2));
                return;
        }
    }
}
