...
public final class cu0 extends jh.s {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (w9Var != null && w9Var.y()) {
            canvas.save();
            canvas.translate(getPaddingLeft(), getPaddingTop());
            if (w9Var != null && getStaticTextLayout() != null && w9Var.f24373u0 == this) {
                w9Var.X(canvas);
            }
            canvas.restore();
        }
