...
public final class a31 extends a71 {
    public final c31 f31972d2;
    public final r61[] f31973e2;
    public final d31 f31974f2;
    ...
    public a31(d31 d31Var, d31 d31Var2, Activity activity, Integer num, c31 c31Var, r61[] r61VarArr) {
        ...
        this.f31974f2 = d31Var;
        this.f31972d2 = c31Var;
        this.f31973e2 = r61VarArr;
    }
    ...
    public final void p(View view, Long l4, TLRPC.Document document, TL_stars.TL_starGiftUnique tL_starGiftUnique, Integer num) {
        ...
        if (l4 != null) {
            ...
            c31 c31Var = this.f31972d2;
            if (c31Var != null) {
                c31Var.a(true);
            }
            r61 r61Var = this.f31973e2[0];
            if (r61Var != null) {
                d31Var.f32908n = null;
                r61Var.dismiss();
            }
    ...
    public final void r(j61 j61Var, zg.o0 o0Var) {
        ...
        d31 d31Var = this.f31974f2;
        i10 = ((org.telegram.ui.ActionBar.m2) d31Var).currentAccount;
        MediaDataController.getInstance(i10).setDoubleTapReaction(o0Var.f49395f);
        c31 c31Var = this.f31972d2;
        if (c31Var != null) {
            c31Var.a(true);
        }
