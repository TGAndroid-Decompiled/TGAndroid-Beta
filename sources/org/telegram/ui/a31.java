...
public final class a31 extends View {
    ...
    public String R;
    public boolean S;
    public final org.telegram.ui.Components.cc0 f31701a;
    public final Paint f31702b;
    public final BitmapShader f31703c;
    public final BitmapShader d;
    public r21 e;
    public Bitmap f31704f;
    public Bitmap h;
    public Bitmap f31705n;
    public boolean f31706r;
    public final org.telegram.ui.Components.ko0 f31707s;
    public TextPaint v;
    public StaticLayout f31708w;
    public final org.telegram.ui.Components.c6 f31709x;
    public final Paint f31710y;
    ...
    public a31(Context context) {
        ...
        this.f31709x = new org.telegram.ui.Components.c6(1.0f, this, 0L, 2000L, qrVar);
        ...
        cc0Var.N = true;
        cc0Var.r(this);
        Bitmap bitmap = cc0Var.f23006k;
        Shader.TileMode tileMode = Shader.TileMode.MIRROR;
        BitmapShader bitmapShader = new BitmapShader(bitmap, tileMode, tileMode);
        this.f31703c = bitmapShader;
        BitmapShader bitmapShader2 = new BitmapShader(cc0Var.f23006k, tileMode, tileMode);
        ...
        ko0Var.f26066a.setShader(bitmapShader2);
        ko0Var.f26067b = 17;
    ...
    public final void a(Canvas canvas) {
        ...
        if (this.F != null) {
            ...
            if (!this.M && (r21Var = this.e) != null) {
                g31 g31Var = r21Var.f37068a;
                g31Var.f33830c.set((int) (width2 - round), (int) (width3 - round), (int) (width2 + round), (int) (width3 + round));
    ...
    public final void d(boolean z10) {
        ...
        if (z10) {
            ...
            this.f31708w = org.telegram.ui.Components.kw0.c(Emoji.replaceEmoji(str, this.v.getFontMetricsInt(), false), this.v, getWidth(), Layout.Alignment.ALIGN_CENTER, 0.0f, false, TextUtils.TruncateAt.END, getWidth() - AndroidUtilities.dp(60.0f), 1, true);
            return;
        }
        this.f31708w = null;
    }
    ...
    public final void onSizeChanged(int i10, int i11, int i12, int i13) {
        ...
        this.f31704f = Bitmap.createBitmap(i10, i11, Bitmap.Config.ARGB_8888);
        Canvas canvas = new Canvas(this.f31704f);
        float f10 = i10;
        ...
        float max = Math.max((getWidth() * 1.0f) / this.f31701a.f23006k.getWidth(), (getHeight() * 1.0f) / this.f31701a.f23006k.getHeight());
        Matrix matrix = new Matrix();
        matrix.setScale(max, max);
        this.f31703c.setLocalMatrix(matrix);
