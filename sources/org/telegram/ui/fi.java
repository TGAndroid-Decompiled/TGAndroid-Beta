...
public final class fi extends AnimatorListenerAdapter {
    public final ao f33688a;
    public final boolean f33689b;
    public final org.telegram.ui.ActionBar.k5 f33690c;
    ...
    public final void onAnimationEnd(Animator animator) {
        ...
        ao aoVar = this.f33688a;
        aoVar.setTranslationY(0.0f);
        boolean z10 = this.f33689b;
        if (!z10) {
            aoVar.setTranslationY(0.0f);
        }
        org.telegram.ui.ActionBar.k5 k5Var = this.f33690c;
        if (!z10) {
