...
public final class tz0 extends pv0 {
    ...
    public final void c(Canvas canvas, float f7, float f10, float f11, float f12, float f13) {
        ...
        if (f7 > 0.0f) {
            ...
            rectF.set(0.0f, 0.0f, profileActivity.f31329n0.getMeasuredWidth(), AndroidUtilities.dp(30.0f) + profileActivity.f31329n0.getMeasuredHeight());
    ...
    public final void e() {
        ...
        for (int i10 = 0; i10 < profileActivity.f31329n0.getChildCount(); i10++) {
            profileActivity.f31329n0.getChildAt(i10).invalidate();
        }
        org.telegram.ui.Components.aj0 aj0Var = profileActivity.v;
        if (aj0Var != null) {
            aj0Var.invalidate();
    ...
    public final boolean j(View view, ImageReceiver imageReceiver) {
        if (super.j(view, imageReceiver) && this.T.f31238a.getScrollState() != 1) {
            return true;
        }
        return false;
    }
