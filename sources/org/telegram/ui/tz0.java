...
public final class tz0 extends pv0 {
    ...
    public final void c(Canvas canvas, float f7, float f10, float f11, float f12, float f13) {
        ...
        if (f7 > 0.0f) {
            ...
            rectF.set(0.0f, 0.0f, profileActivity.f31613n0.getMeasuredWidth(), AndroidUtilities.dp(30.0f) + profileActivity.f31613n0.getMeasuredHeight());
    ...
    public final void e() {
        ...
        for (int i10 = 0; i10 < profileActivity.f31613n0.getChildCount(); i10++) {
            profileActivity.f31613n0.getChildAt(i10).invalidate();
        }
        org.telegram.ui.Components.kj0 kj0Var = profileActivity.v;
        if (kj0Var != null) {
            kj0Var.invalidate();
    ...
    public final boolean j(View view, ImageReceiver imageReceiver) {
        if (super.j(view, imageReceiver) && this.T.f31522a.getScrollState() != 1) {
            return true;
        }
        return false;
    }
