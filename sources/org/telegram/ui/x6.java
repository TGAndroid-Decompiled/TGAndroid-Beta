...
public final class x6 extends og.b {
    ...
    @Override
    public final int h() {
        return this.e.f40075a0.size();
    }

    @Override
    public final int j(int i10) {
        return ((u6) this.e.f40075a0.get(i10)).f15533a;
    }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        Boolean bool;
        z6 z6Var = this.e;
        ArrayList arrayList = z6Var.f40075a0;
            ...
            if (i12 != 1) {
                if (i12 != 2) {
                    if (i12 != 3) {
                        if (i12 != 7) {
                            switch (i12) {
                                ...
                                case 11:
                                    ...
                                    String formatFileSize = AndroidUtilities.formatFileSize(u6Var.f37864g);
                                    if (u6Var.f37863f >= 0 ? !u6Var.f37866j : !z6Var.M) {
                                        z11 = true;
                                    } else {
                                        z11 = false;
                                    }
                                    ...
                                    int i17 = u6Var.h;
                                    int i18 = org.telegram.ui.ActionBar.i6.f18965k7;
                                    org.telegram.ui.Components.np npVar = z1Var.f21676r;
                                    if (npVar != null) {
                                        npVar.b(i17, i17, i18);
                                    }
                                    if (u6Var.f37863f < 0) {
                                    ...
                                    z1Var.setPad(u6Var.f37865i ? 1 : 0);
                                    return;
                                default:
                                    return;
                            }
                        ...
                        int i19 = u6Var.f37862c;
                        int size = cacheByChatsController.getKeepMediaExceptions(((u6) arrayList.get(i10)).f37862c).size();
                        if (size > 0) {
                        ...
                        if (((u6) arrayList.get(i10)).f37862c == 0) {
                        ...
                        } else if (((u6) arrayList.get(i10)).f37862c == 1) {
                        ...
                        } else if (((u6) arrayList.get(i10)).f37862c == 2) {
                        ...
                        } else if (((u6) arrayList.get(i10)).f37862c == 3) {
                ...
                boolean z14 = z6Var.L;
                long j12 = z6Var.f40082f;
                long j13 = z6Var.H;
                long j14 = z6Var.J;
                long j15 = z6Var.I;
                com.google.firebase.messaging.m mVar = fy0Var.I;
                View view2 = fy0Var.f24119w;
                TextView textView = fy0Var.f24116n;
                TextView textView2 = fy0Var.h;
                TextView textView3 = fy0Var.v;
                org.telegram.ui.Cells.ea eaVar = fy0Var.f24121y;
                fy0Var.e = z14;
                TextView textView4 = fy0Var.f24117r;
                ...
                TextView textView5 = fy0Var.f24118s;
                long j16 = j15 - j14;
                ...
                if (z14) {
                    ...
                    if (fy0Var.E != f12) {
                        ...
                        ValueAnimator ofFloat = ValueAnimator.ofFloat(fy0Var.E, f12);
                        fy0Var.G = ofFloat;
                    ...
                    if (fy0Var.F != f13) {
                        ...
                        ValueAnimator ofFloat2 = ValueAnimator.ofFloat(fy0Var.F, f13);
                        fy0Var.H = ofFloat2;
        ...
        if (i10 != 0) {
            ...
            switch (i10) {
                case 2:
                    ...
                    frameLayout.f24112a = paint;
                    Paint paint2 = new Paint(1);
                    Paint paint3 = new Paint(1);
                    frameLayout.f24113b = paint3;
                    Paint paint4 = new Paint(1);
                    frameLayout.f24114c = paint4;
                    ...
                    frameLayout.f24116n = textView3;
                    textView3.setCompoundDrawablePadding(AndroidUtilities.dp(6.0f));
                    textView3.setTextColor(org.telegram.ui.ActionBar.i6.w0(null, i12, false));
                    TextView textView4 = new TextView(context);
                    frameLayout.f24117r = textView4;
                    textView4.setCompoundDrawablePadding(AndroidUtilities.dp(6.0f));
                    textView4.setTextColor(org.telegram.ui.ActionBar.i6.w0(null, i12, false));
                    TextView textView5 = new TextView(context);
                    frameLayout.f24118s = textView5;
                    textView5.setCompoundDrawablePadding(AndroidUtilities.dp(6.0f));
                    textView5.setTextColor(org.telegram.ui.ActionBar.i6.w0(null, i12, false));
                    frameLayout.f24120x = org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.Vi, false);
                    textView2.setCompoundDrawablesWithIntrinsicBounds(org.telegram.ui.ActionBar.i6.K(AndroidUtilities.dp(10.0f), frameLayout.f24120x), (Drawable) null, (Drawable) null, (Drawable) null);
                    textView2.setCompoundDrawablePadding(AndroidUtilities.dp(6.0f));
                    textView4.setCompoundDrawablesWithIntrinsicBounds(org.telegram.ui.ActionBar.i6.K(AndroidUtilities.dp(10.0f), i0.a.k(frameLayout.f24120x, 64)), (Drawable) null, (Drawable) null, (Drawable) null);
                    textView4.setCompoundDrawablePadding(AndroidUtilities.dp(6.0f));
                    textView5.setCompoundDrawablesWithIntrinsicBounds(org.telegram.ui.ActionBar.i6.K(AndroidUtilities.dp(10.0f), i0.a.k(frameLayout.f24120x, 127)), (Drawable) null, (Drawable) null, (Drawable) null);
                    textView5.setCompoundDrawablePadding(AndroidUtilities.dp(6.0f));
                    textView3.setCompoundDrawablesWithIntrinsicBounds(org.telegram.ui.ActionBar.i6.K(AndroidUtilities.dp(10.0f), frameLayout.f24120x), (Drawable) null, (Drawable) null, (Drawable) null);
                    textView3.setCompoundDrawablePadding(AndroidUtilities.dp(6.0f));
                    ...
                    frameLayout.f24119w = view;
                    linearLayout.addView(view, w7.x5.t(-1, -2, 0, 21, 0, 0, 0));
                    view.getLayoutParams().height = 1;
                    view.setBackgroundColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18837d7, false));
                    org.telegram.ui.Cells.ea eaVar = new org.telegram.ui.Cells.ea(frameLayout.getContext());
                    frameLayout.f24121y = eaVar;
                ...
                case 4:
                    ...
                    tv0Var.setCallback(new m4.u0(15));
                    ...
                    tv0Var.b(i11, null, LocaleController.formatPluralString("Days", 3, new Object[0]), LocaleController.formatPluralString("Weeks", 1, new Object[0]), LocaleController.formatPluralString("Months", 1, new Object[0]), LocaleController.getString(R.string.KeepMediaForever));
                    p6Var = tv0Var;
                    break;
                case 5:
