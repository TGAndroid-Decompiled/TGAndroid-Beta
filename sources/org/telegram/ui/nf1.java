        ...
        switch (i10) {
            ...
            case 2:
                ...
                if (chatFull != null) {
                    ...
                    lf1 lf1Var = new lf1(this, this.f35930a, i11, iVar, chatFull.f18297id, dg1Var, j10);
                    lf1Var.f25611l0 = new ai.z1(this, j10, 11);
                    lf1Var.show();
                    return;
                }
                return;
            ...
            case 5:
                if (hashSet.size() > 0) {
                    dg1Var.C0 = true;
                    dg1Var.N0 = true;
                    TopicsController topicsController2 = dg1Var.f33005s;
                    long j11 = dg1Var.f32970a;
            ...
            case 8:
                ...
                for (int i14 = 0; i14 < arrayList2.size(); i14++) {
                    ...
                    if (findTopic != null) {
                        dg1Var.getMessagesController().markMentionsAsRead(-j3, findTopic.f18348id);
                        ...
                        messagesController.markDialogAsRead(j12, i15, 0, i12, false, findTopic.f18348id, 0, true, 0);
                        dg1Var.getMessagesStorage().updateRepliesMaxReadId(dg1Var.f32970a, findTopic.f18348id, findTopic.top_message, 0, true);
                    }
                }
                dg1Var.C0();
                return;
            ...
            case 13:
                ...
                while (true) {
                    if (i17 < dg1Var.N.getChildCount()) {
                        ...
                        if ((childAt instanceof ag1) && (tL_forumTopic = (ag1Var = (ag1) childAt).N) != null && tL_forumTopic.f18348id == 1) {
                ...
                if (tL_forumTopic2 == null) {
                    while (true) {
                        if (i13 < arrayList.size()) {
                            if (arrayList.get(i13) != null && ((uf1) arrayList.get(i13)).f37987c != null && ((uf1) arrayList.get(i13)).f37987c.f18348id == 1) {
                                tL_forumTopic2 = ((uf1) arrayList.get(i13)).f37987c;
                            } else {
                                i13++;
                            }
                        }
