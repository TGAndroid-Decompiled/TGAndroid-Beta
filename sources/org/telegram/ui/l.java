...
public final class l extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate {
    public org.telegram.ui.Components.ll0 f35291a;
    public k f35292b;
    public boolean f35293c;
    public TLRPC.GlobalPrivacySettings d;
    public int e;
    public final ArrayList f35294f;
    ...
    public l() {
        ...
        this.f35293c = false;
        this.e = -3;
        this.f35294f = new ArrayList();
        this.h = new ArrayList();
    }

    public final void U(boolean z10) {
        ArrayList arrayList = this.f35294f;
        arrayList.clear();
    ...
    public final View createView(Context context) {
        ...
        this.f35291a = ll0Var;
        ll0Var.p1();
        this.actionBar.setAdaptiveBackground(this.f35291a);
        this.f35291a.setLayoutManager(new gg.b0(1, false, 2));
        this.f35291a.setVerticalScrollBarEnabled(false);
        this.f35291a.setLayoutAnimation(null);
        org.telegram.ui.Components.ll0 ll0Var2 = this.f35291a;
        k kVar = new k(this);
        this.f35292b = kVar;
        ...
        jVar.C = false;
        jVar.f42710m = false;
        this.f35291a.setItemAnimator(jVar);
        frameLayout.addView(this.f35291a, w7.x5.c(-1.0f, -1));
        this.f35291a.setOnItemClickListener(new i(this, 0));
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.privacyRulesUpdated) {
            ...
            if (this.f35291a != null) {
                for (int i12 = 0; i12 < this.f35291a.getChildCount(); i12++) {
                    View childAt = this.f35291a.getChildAt(i12);
                    this.f35291a.getClass();
    ...
    public final void onInsets(int i10, int i11, int i12, int i13) {
        this.f35291a.setPadding(0, 0, 0, i13);
        this.f35291a.setClipToPadding(false);
    }
}
