...
public final class l extends org.telegram.ui.ActionBar.m2 implements NotificationCenter.NotificationCenterDelegate {
    public org.telegram.ui.Components.wl0 f35201a;
    public k f35202b;
    public boolean f35203c;
    public TLRPC.GlobalPrivacySettings d;
    public int e;
    public final ArrayList f35204f;
    ...
    public final void U(boolean z10) {
        ArrayList arrayList = this.f35204f;
        arrayList.clear();
    ...
    public final View createView(Context context) {
        ...
        this.f35201a = wl0Var;
        wl0Var.p1();
        this.actionBar.setAdaptiveBackground(this.f35201a);
        this.f35201a.setLayoutManager(new gg.b0(1, false, 2));
        this.f35201a.setVerticalScrollBarEnabled(false);
        this.f35201a.setLayoutAnimation(null);
        org.telegram.ui.Components.wl0 wl0Var2 = this.f35201a;
        k kVar = new k(this);
        this.f35202b = kVar;
        ...
        jVar.C = false;
        jVar.f42996m = false;
        this.f35201a.setItemAnimator(jVar);
        frameLayout.addView(this.f35201a, w7.y5.c(-1.0f, -1));
        this.f35201a.setOnItemClickListener(new i(this, 0));
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.privacyRulesUpdated) {
            ...
            if (this.f35201a != null) {
                for (int i12 = 0; i12 < this.f35201a.getChildCount(); i12++) {
                    View childAt = this.f35201a.getChildAt(i12);
    ...
    public final void onInsets(int i10, int i11, int i12, int i13) {
        this.f35201a.setPadding(0, 0, 0, i13);
        this.f35201a.setClipToPadding(false);
    }
}
