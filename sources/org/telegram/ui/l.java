...
public final class l extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate {
    public org.telegram.ui.Components.ll0 f38157a;
    public k f38158b;
    public boolean f38159c;
    public TLRPC.GlobalPrivacySettings d;
    public int f38160e;
    public final ArrayList f38161f;
    ...
    public final void U(boolean z10) {
        ArrayList arrayList = this.f38161f;
        arrayList.clear();
    ...
    public final View createView(Context context) {
        ...
        this.f38157a = ll0Var;
        ll0Var.o1();
        this.actionBar.setAdaptiveBackground(this.f38157a);
        this.f38157a.setLayoutManager(new hg.b0(1, false, 2));
        this.f38157a.setVerticalScrollBarEnabled(false);
        this.f38157a.setLayoutAnimation(null);
        org.telegram.ui.Components.ll0 ll0Var2 = this.f38157a;
        k kVar = new k(this);
        this.f38158b = kVar;
        ...
        jVar.C = false;
        jVar.f45778m = false;
        this.f38157a.setItemAnimator(jVar);
        frameLayout.addView(this.f38157a, w7.x5.c(-1.0f, -1));
        this.f38157a.setOnItemClickListener(new i(this, 0));
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.privacyRulesUpdated) {
            ...
            if (this.f38157a != null) {
                for (int i12 = 0; i12 < this.f38157a.getChildCount(); i12++) {
                    View childAt = this.f38157a.getChildAt(i12);
    ...
    public final void onInsets(int i10, int i11, int i12, int i13) {
        this.f38157a.setPadding(0, 0, 0, i13);
        this.f38157a.setClipToPadding(false);
    }
}
