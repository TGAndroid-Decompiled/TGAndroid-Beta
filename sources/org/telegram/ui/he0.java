...
public final class he0 implements Runnable {
    public final int f34251a = 1;
    public final me0 f34252b;
    public final TLRPC.TL_error f34253c;
    public final String d;
    public final String e;
    public final TLObject f34254f;

    public he0(me0 me0Var, TLRPC.TL_error tL_error, String str, String str2, TLObject tLObject) {
        this.f34252b = me0Var;
        this.f34253c = tL_error;
        this.d = str;
        this.e = str2;
        this.f34254f = tLObject;
    }
    ...
    public final void run() {
        ...
        TLObject tLObject = this.f34254f;
        String str = this.e;
        String str2 = this.d;
        TLRPC.TL_error tL_error = this.f34253c;
        me0 me0Var = this.f34252b;
        switch (i11) {
            case 0:
                me0Var.getClass();
                if (tL_error == null) {
