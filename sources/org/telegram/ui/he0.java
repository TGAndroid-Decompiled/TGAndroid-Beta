...
public final class he0 implements RequestDelegate {
    ...
    public final je0 f34204b;

    public he0(je0 je0Var, int i10) {
        this.f34203a = i10;
        this.f34204b = je0Var;
    }
    ...
    public final void run(final TLObject tLObject, final TLRPC.TL_error tL_error) {
        switch (this.f34203a) {
            case 0:
                    ...
                    public final void run() {
                        ...
                        switch (i11) {
                            case 0:
                                je0Var2.getClass();
                                if (tL_error2 == null) {
                                    je0Var2.f34782n = (TL_account.Password) tLObject2;
                                    je0Var2.h(null);
                                    return;
                                }
                                return;
                            case 1:
                                qg0 qg0Var = je0Var2.f34787y;
                                ...
                                if (tL_error2 == null) {
                                    ...
                                    qg0Var.l1(LocaleController.getString(R.string.WrongCodeTitle), LocaleController.formatString("FloodWaitTime", R.string.FloodWaitTime, formatPluralString));
                                    return;
                                } else {
                            ...
                            default:
                                qg0 qg0Var2 = je0Var2.f34787y;
                                je0Var2.h = false;
                                if (tL_error2 != null && "SRP_ID_INVALID".equals(tL_error2.text)) {
                                    TL_account.getPassword getpassword = new TL_account.getPassword();
                                    i10 = ((org.telegram.ui.ActionBar.m2) qg0Var2).currentAccount;
                                    ConnectionsManager.getInstance(i10).sendRequest(getpassword, new he0(je0Var2, 0), 8);
                                    return;
                                    ...
                                    if (tL_error2.text.equals("PASSWORD_HASH_INVALID")) {
                                        if (qg0Var2.getParentActivity() != null) {
                                            je0Var2.f34778a.setText("");
                                            qg0.U0(qg0Var2, je0Var2.f34786x, true);
                                            return;
                                        }
                                        return;
                                    } else if (tL_error2.text.startsWith("FLOOD_WAIT")) {
                                        ...
                                        qg0Var2.l1(LocaleController.getString(R.string.RestorePasswordNoEmailTitle), LocaleController.formatString("FloodWaitTime", R.string.FloodWaitTime, formatPluralString2));
                                        return;
                                    } else {
                ...
                return;
            case 1:
                final je0 je0Var2 = this.f34204b;
                AndroidUtilities.runOnUIThread(new Runnable() {
                    @Override
                    public final void run() {
                        String formatPluralString;
                        ...
                        switch (i11) {
                            case 0:
                                je0Var22.getClass();
                                if (tL_error2 == null) {
                                    je0Var22.f34782n = (TL_account.Password) tLObject2;
                                    je0Var22.h(null);
                                    return;
                                }
                                return;
                            case 1:
                                qg0 qg0Var = je0Var22.f34787y;
                                qg0Var.k1(false, true);
                                if (tL_error2 == null) {
                                    TLRPC.TL_auth_passwordRecovery tL_auth_passwordRecovery = (TLRPC.TL_auth_passwordRecovery) tLObject2;
                                    if (qg0Var.getParentActivity() != null) {
                            ...
                            default:
                                qg0 qg0Var2 = je0Var22.f34787y;
                                je0Var22.h = false;
                                if (tL_error2 != null && "SRP_ID_INVALID".equals(tL_error2.text)) {
                                    TL_account.getPassword getpassword = new TL_account.getPassword();
                                    i10 = ((org.telegram.ui.ActionBar.m2) qg0Var2).currentAccount;
                                    ConnectionsManager.getInstance(i10).sendRequest(getpassword, new he0(je0Var22, 0), 8);
                                    return;
                                } else if (tLObject2 instanceof TLRPC.TL_auth_authorization) {
                                    qg0Var2.v1(false, true);
                                    ...
                                    if (tL_error2.text.equals("PASSWORD_HASH_INVALID")) {
                                        if (qg0Var2.getParentActivity() != null) {
                                            je0Var22.f34778a.setText("");
                                            qg0.U0(qg0Var2, je0Var22.f34786x, true);
                                            return;
                                        }
                                        return;
                                    } else if (tL_error2.text.startsWith("FLOOD_WAIT")) {
                ...
                return;
            default:
                final je0 je0Var3 = this.f34204b;
                AndroidUtilities.runOnUIThread(new Runnable() {
                    @Override
                    public final void run() {
                        String formatPluralString;
