...
public final class jj extends org.telegram.ui.ActionBar.j {
    ...
    public final void b(int i10) {
        ...
        if (i10 == -1) {
                ...
                if (kVar.s()) {
                    ...
                    xnVar.wb(new Runnable(this) {
                        ...
                        public final void run() {
                            switch (r2) {
                                case 0:
                                    this.f34633b.f35363b.finishFragment();
                                    return;
                                default:
                                    jj jjVar = this.f34633b;
                                    jjVar.getClass();
                                    xn xnVar2 = jjVar.f35363b;
            ...
            if (i10 == 10) {
                ...
                for (int i18 = 1; i18 >= 0; i18--) {
                    ...
                    for (int i20 = 0; i20 < arrayList.size(); i20++) {
                        ...
                        if (arrayList.size() != 1 && ((user3 = xnVar.f40009f) == null || !user3.self)) {
                            z14 = true;
                        } else {
                            z14 = false;
                        }
                ...
                if (xnVar.getParentActivity() != null) {
                    xnVar.showDialog(org.telegram.ui.Components.z4.V(xnVar.getParentActivity(), xnVar.h, xnVar.f39968ba).f19503a);
                }
            } else if (i10 == 15 || i10 == 16 || i10 == 26) {
                boolean z15 = false;
                if (xnVar.getParentActivity() != null) {
                    if (i10 == 15 && ChatObject.isMonoForum(xnVar.e)) {
                        if (xnVar.f39948a4 != 0 && (user2 = xnVar.getMessagesController().getUser(Long.valueOf(xnVar.f39948a4))) != null) {
                            org.telegram.ui.Components.z4.r(xnVar, -1, user2, xnVar.e, true, new mg.w(18, this, user2), xnVar.getResourceProvider());
                            return;
                        }
                        return;
                    }
                    ...
                    if (i10 != 26) {
                        int i23 = 15;
                        if (i10 == 15) {
                            if (xnVar.h != null || (((user = xnVar.f40009f) == null || UserObject.isUserSelf(user) || UserObject.isDeleted(xnVar.f40009f)) && ((chatFull = xnVar.W7) == null || !chatFull.can_delete_channel))) {
                                i23 = 15;
                            }
                        }
                        if (i10 == i23) {
                        ...
                        TLRPC.User user4 = xnVar.f40009f;
                        if (xnVar.h != null) {
                            z15 = true;
                        }
                        org.telegram.ui.Components.z4.s(xnVar, z10, chat2, user4, z15, true, false, z4, new gg.m2(this, i10, z4));
                        return;
                    }
                    boolean z16 = z4;
                    org.telegram.ui.Components.z4.r(xnVar, -1, xnVar.f40009f, xnVar.e, z16, new ij(this, z16), xnVar.getResourceProvider());
                }
            } else if (i10 == 17) {
                if (xnVar.f40009f != null && xnVar.getParentActivity() != null) {
                ...
                try {
                    xnVar.getMediaDataController().installShortcut(xnVar.f40009f.f19331id, MediaDataController.SHORTCUT_TYPE_USER_OR_CHAT);
                } catch (Exception e) {
                    FileLog.e(e);
                }
            } else if (i10 == 29) {
                ...
                for (int i27 = 1; i27 >= 0; i27--) {
                    if (messageObject == null && sparseArrayArr3[i27].size() == 1) {
                        ...
                        messageObject = (MessageObject) xnVar.f40089l6[i27].get(((Integer) arrayList3.get(0)).intValue());
                    }
                ...
                uf.o1 c3 = uf.p1.f(i12).c(xnVar.H8());
                Activity parentActivity2 = xnVar.getParentActivity();
                i13 = ((org.telegram.ui.ActionBar.p2) xnVar).currentAccount;
                uf.m1.d0(parentActivity2, i13, xnVar.N3, c3, xnVar.getResourceProvider(), new kh.a1(21, this, c3));
            } else if (i10 == 14) {
                org.telegram.ui.ActionBar.g1 g1Var = new org.telegram.ui.ActionBar.g1(0, this.f35362a, xnVar.getResourceProvider(), true, true);
                ...
                if (i10 == 50) {
                    ...
                    if (jkVar != null && jkVar.getEditField() != null) {
                        xnVar.V.getEditField().setSelectionOverride(xnVar.f40238x4, xnVar.f40252y4);
                    ...
                    if (xnVar.Z3 != null) {
                        ...
                        long j16 = xnVar.e.f19184id;
                        TLRPC.TL_forumTopic tL_forumTopic = xnVar.Z3;
                        int i29 = tL_forumTopic.f19236id;
                    ...
                    if (textView2 != null) {
                        textView2.setTextColor(xnVar.getThemedColor(org.telegram.ui.ActionBar.j6.f20141q7));
                    }
                } else if (i10 == 73) {
            ...
            } else if (xnVar.f40009f != null && xnVar.getParentActivity() != null) {
                TLRPC.User user5 = xnVar.f40009f;
                if (i10 == 33) {
                    z11 = true;
                } else {
                    z11 = false;
                ...
                org.telegram.ui.Components.voip.f2.n(user5, z11, z12, xnVar.getParentActivity(), xnVar.getMessagesController().getUserFull(xnVar.f40009f.f19331id), xnVar.getAccountInstance());
            }
        }
    }
}
