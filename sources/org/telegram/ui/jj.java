...
public final class jj extends org.telegram.ui.ActionBar.j {
    ...
    public final void b(int i10) {
        ...
        if (i10 == -1) {
                ...
                if (kVar.s()) {
                    ...
                    xnVar.wb(new Runnable(this) {
                        ...
                        public final void run() {
                            switch (r2) {
                                case 0:
                                    this.f37118b.f38068b.finishFragment();
                                    return;
                                default:
                                    jj jjVar = this.f37118b;
                                    jjVar.getClass();
                                    xn xnVar2 = jjVar.f38068b;
            ...
            if (i10 == 10) {
                ...
                for (int i18 = 1; i18 >= 0; i18--) {
                    ...
                    for (int i20 = 0; i20 < arrayList.size(); i20++) {
                        ...
                        if (arrayList.size() != 1 && ((user3 = xnVar.f43156f) == null || !user3.self)) {
                            z14 = true;
                        } else {
                            z14 = false;
                        }
                ...
                if (ChatObject.isMonoForum(xnVar.f43143e)) {
                    ...
                    if (ChatObject.canManageMonoForum(i17, xnVar.f43143e)) {
                        j12 = xnVar.f43094a4;
                        j10 = xnVar.Q5;
                    }
                }
                ...
                if (ChatObject.isMonoForum(xnVar.f43143e)) {
                    ...
                    if (ChatObject.canManageMonoForum(i15, xnVar.f43143e)) {
                        j13 = xnVar.f43094a4;
                        j10 = xnVar.Q5;
                    }
                }
                ...
                if (xnVar.getParentActivity() != null) {
                    xnVar.showDialog(org.telegram.ui.Components.z4.V(xnVar.getParentActivity(), xnVar.h, xnVar.f43114ba).f21168a);
                }
            } else if (i10 == 15 || i10 == 16 || i10 == 26) {
                boolean z15 = false;
                if (xnVar.getParentActivity() != null) {
                    if (i10 == 15 && ChatObject.isMonoForum(xnVar.f43143e)) {
                        if (xnVar.f43094a4 != 0 && (user2 = xnVar.getMessagesController().getUser(Long.valueOf(xnVar.f43094a4))) != null) {
                            org.telegram.ui.Components.z4.r(xnVar, -1, user2, xnVar.f43143e, true, new ng.w(18, this, user2), xnVar.getResourceProvider());
                            return;
                        }
                        return;
                    }
                    ...
                    if (i10 != 26) {
                        int i23 = 15;
                        if (i10 == 15) {
                            if (xnVar.h != null || (((user = xnVar.f43156f) == null || UserObject.isUserSelf(user) || UserObject.isDeleted(xnVar.f43156f)) && ((chatFull = xnVar.W7) == null || !chatFull.can_delete_channel))) {
                                i23 = 15;
                            }
                        }
                        if (i10 == i23) {
                        ...
                        TLRPC.User user4 = xnVar.f43156f;
                        if (xnVar.h != null) {
                            z15 = true;
                        }
                    ...
                    boolean z16 = z4;
                    org.telegram.ui.Components.z4.r(xnVar, -1, xnVar.f43156f, xnVar.f43143e, z16, new ij(this, z16), xnVar.getResourceProvider());
                }
            } else if (i10 == 17) {
                if (xnVar.f43156f != null && xnVar.getParentActivity() != null) {
                ...
                try {
                    xnVar.getMediaDataController().installShortcut(xnVar.f43156f.f20992id, MediaDataController.SHORTCUT_TYPE_USER_OR_CHAT);
                } catch (Exception e6) {
                    FileLog.e(e6);
                }
            } else if (i10 == 29) {
                if (ChatObject.hasAdminRights(xnVar.f43143e)) {
                ...
                for (int i27 = 1; i27 >= 0; i27--) {
                    if (messageObject == null && sparseArrayArr3[i27].size() == 1) {
                        ...
                        messageObject = (MessageObject) xnVar.f43236l6[i27].get(((Integer) arrayList3.get(0)).intValue());
                    }
                ...
                org.telegram.ui.ActionBar.g1 g1Var = new org.telegram.ui.ActionBar.g1(0, this.f38067a, xnVar.getResourceProvider(), true, true);
                ...
                if (i10 == 50) {
                    ...
                    if (jkVar != null && jkVar.getEditField() != null) {
                        xnVar.V.getEditField().setSelectionOverride(xnVar.f43385x4, xnVar.f43399y4);
                    ...
                    if (xnVar.Z3 != null) {
                        ...
                        long j16 = xnVar.f43143e.f20845id;
                        TLRPC.TL_forumTopic tL_forumTopic = xnVar.Z3;
                        int i29 = tL_forumTopic.f20897id;
                    ...
                    if (textView2 != null) {
                        textView2.setTextColor(xnVar.getThemedColor(org.telegram.ui.ActionBar.k6.f21897q7));
                    }
                } else if (i10 == 73) {
            ...
            } else if (xnVar.f43156f != null && xnVar.getParentActivity() != null) {
                TLRPC.User user5 = xnVar.f43156f;
                if (i10 == 33) {
                    z11 = true;
                } else {
                    z11 = false;
                ...
                org.telegram.ui.Components.voip.g2.m(user5, z11, z12, xnVar.getParentActivity(), xnVar.getMessagesController().getUserFull(xnVar.f43156f.f20992id), xnVar.getAccountInstance());
            }
        }
    }
}
