...
public final class aa implements RequestDelegate {
    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        int i11 = 0;
        Object obj = this.d;
        Object obj2 = this.f31715c;
        Object obj3 = this.f31714b;
        switch (i10) {
            case 0:
            ...
            case 2:
                ...
                return;
            case 3:
                AndroidUtilities.runOnUIThread(new org.telegram.ui.ActionBar.m5((Object) ((xn) obj3), (Object) ((nf.e) obj2), tLObject, (Object) ((sa) obj), 6));
                return;
            case 4:
                xn xnVar = (xn) obj3;
                long[] jArr = (long[]) obj;
                AndroidUtilities.cancelRunOnUIThread((org.telegram.ui.ActionBar.m5) obj2);
                xnVar.f39353d5.messageOwner.voiceTranscriptionRated = true;
                xnVar.getMessagesStorage().updateMessageVoiceTranscriptionOpen(xnVar.f39353d5.getDialogId(), xnVar.f39353d5.getId(), xnVar.f39353d5.messageOwner);
                sg sgVar = new sg(xnVar, 17);
                long j3 = 0;
                if (jArr[0] > 0) {
            ...
            case 5:
                ...
                AndroidUtilities.runOnUIThread(new vg((org.telegram.ui.ActionBar.b2[]) obj2, 1));
                if (tL_error == null) {
            ...
            case 8:
                ...
                return;
            case 9:
                AndroidUtilities.runOnUIThread(new qv((ry) obj3, (TLRPC.TL_attachMenuBot) obj2, (LaunchActivity) obj, 1));
                return;
            case 10:
            ...
            case 11:
                ...
                AndroidUtilities.runOnUIThread(new hw(16, f60Var, tL_error));
                return;
            case 12:
            ...
            case 14:
                ...
                if (Objects.equals(p70Var.h, (String) obj2) && (tLObject instanceof TLRPC.TL_messages_foundStickerSets)) {
                    ...
                    ArrayList<TLRPC.TL_messages_stickerSet> stickerSets = MediaDataController.getInstance(q70.X(q70Var)).getStickerSets(q70Var.c0());
            ...
            case 15:
                ...
                AndroidUtilities.runOnUIThread(new d90((Object) ((LaunchActivity) obj3), tLObject, (Object) ((TLRPC.TL_messages_requestUrlAuth) obj), (Object) ((String) obj2), tL_error, 2));
                return;
            case 16:
            ...
            case 17:
                ...
                return;
            case 18:
                AndroidUtilities.runOnUIThread(new d90((Object) ((ac0) obj3), tL_error, tLObject, (Object) ((TLRPC.TL_inputInvoiceSlug) obj), (Object) ((String) obj2), 4));
                return;
            case 19:
                AndroidUtilities.runOnUIThread(new tq((dd0) obj3, (org.telegram.ui.ActionBar.b2[]) obj2, (TLRPC.TL_messageMediaVenue) obj, 23));
                return;
            case 20:
                AndroidUtilities.runOnUIThread(new d90((KeyEvent.Callback) ((be0) obj3), tLObject, (Object) ((Bundle) obj2), tL_error, (TLObject) ((TLRPC.TL_auth_resendCode) obj), 6));
                return;
            case 21:
                AndroidUtilities.runOnUIThread(new d90((KeyEvent.Callback) ((gf0) obj3), tLObject, (Object) ((Bundle) obj2), tL_error, (TLObject) ((TL_account.verifyEmail) obj), 8));
                return;
            case 22:
                AndroidUtilities.runOnUIThread(new d90((KeyEvent.Callback) ((gf0) obj3), tLObject, (Object) ((Bundle) obj2), tL_error, (TLObject) ((TL_account.sendVerifyEmailCode) obj), 7));
                return;
            case 23:
                AndroidUtilities.runOnUIThread(new d90((Object) ((ag0) obj3), tLObject, (Object) ((TLRPC.TL_inputInvoicePremiumAuthCode) obj2), (Object) ((TLRPC.TL_inputStorePaymentAuthCode) obj), tL_error, 9));
                return;
            case 24:
                ej0 ej0Var = (ej0) obj3;
            ...
            case 25:
                ...
                if (tLObject instanceof TL_stats.TL_statsGraph) {
                    try {
                        bVar = ra1.e0(new JSONObject(((TL_stats.TL_statsGraph) tLObject).json.data), bj0Var.f32039r.f32556i, false);
            ...
            case 26:
                ...
                return;
            case 27:
                AndroidUtilities.runOnUIThread(new d90((Object) ((en0) obj3), tL_error, (Object) ((Bundle) obj2), (Object) tLObject, (Object) ((TLRPC.TL_auth_resendCode) obj), 13));
                return;
            case 28:
                AndroidUtilities.runOnUIThread(new d90((Object) ((qo0) obj3), tL_error, tLObject, (Object) ((String) obj2), (Object) ((TL_account.getPassword) obj), 14));
                return;
            default:
                qo0 qo0Var = (qo0) obj3;
                gl0 gl0Var = (gl0) obj2;
                ...
                if (tLObject instanceof TLRPC.TL_payments_validatedRequestedInfo) {
                    AndroidUtilities.runOnUIThread(new kf0(qo0Var, (TLRPC.TL_payments_validatedRequestedInfo) tLObject, gl0Var, 16));
                    return;
                } else {
