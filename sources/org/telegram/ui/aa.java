    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        switch (i10) {
            ...
            case 4:
                ...
                boVar.f32280d5.messageOwner.voiceTranscriptionRated = true;
                boVar.getMessagesStorage().updateMessageVoiceTranscriptionOpen(boVar.f32280d5.getDialogId(), boVar.f32280d5.getId(), boVar.f32280d5.messageOwner);
            ...
            case 24:
                ...
                if (tLObject instanceof TL_stats.TL_statsGraph) {
                    try {
                        bVar = ya1.e0(new JSONObject(((TL_stats.TL_statsGraph) tLObject).json.data), 1, false);
            ...
            case 25:
                ...
                if (tLObject instanceof TL_stats.TL_statsGraph) {
                    try {
                        bVar = ya1.e0(new JSONObject(((TL_stats.TL_statsGraph) tLObject).json.data), gj0Var.f34576r.f35098i, false);
                ...
                AndroidUtilities.runOnUIThread(new org.telegram.ui.Components.jn0(gj0Var, bVar, str4, xa1Var, 24));
                return;
            case 26:
