...
public final class k11 extends Drawable implements org.telegram.ui.ActionBar.i5 {
    public final org.telegram.ui.Components.n6 f35036a;
    public final Paint f35037b;
    public int f35038c;
    public float d;
    public float e;
    public final org.telegram.ui.Cells.l0 f35039f;
    ...
    public k11(String str) {
        ...
        this.d = 1.0f;
        this.e = 1.0f;
        this.f35039f = new org.telegram.ui.Cells.l0(this);
    ...
    public final void draw(Canvas canvas) {
        ...
        org.telegram.ui.Components.n6 n6Var = this.f35036a;
        n6Var.r(i10);
        n6Var.f26660w = (int) (f7 * 255.0f);
    ...
    public final int getIntrinsicWidth() {
        return (int) (this.f35036a.d + AndroidUtilities.dp(11.0f));
    }
