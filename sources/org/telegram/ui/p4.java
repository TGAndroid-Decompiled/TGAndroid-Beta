...
public final class p4 extends org.telegram.ui.ActionBar.m2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final int U() {
        ...
        while (true) {
            ...
            if (i10 < arrayList.size()) {
                if (((o4) arrayList.get(i10)).f20567b.f22370f) {
    ...
    public final void V(int i10, boolean z10) {
        ...
        transitionSet.setInterpolator((TimeInterpolator) org.telegram.ui.Components.rr.f28022f);
        TransitionManager.beginDelayedTransition(this.f36387f, transitionSet);
        int i11 = 0;
        while (true) {
            ArrayList arrayList = this.h;
            if (i11 < arrayList.size()) {
                ...
                while (i12 < arrayList.size()) {
                    if (((o4) arrayList.get(i12)).d) {
                        this.f36387f.removeView((View) arrayList.get(i12));
                ...
                this.f36387f.addView((View) k6Var, size);
                X();
                W(k6Var, z10);
                return;
            }
    ...
    public final void X() {
        ...
        while (true) {
            ArrayList arrayList = this.h;
            if (i10 < arrayList.size()) {
                ((o4) arrayList.get(i10)).setBackground(org.telegram.ui.ActionBar.h6.g0(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19045d6, false), org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19134i6, false)));
    ...
    public final View createView(Context context) {
        ...
        this.f36387f = linearLayout;
        linearLayout.setOrientation(1);
        this.f36387f.setBackgroundColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19045d6, false));
        xdVar.addView(this.f36387f, w7.y5.n(-1, -2));
        ...
        o4 o4Var2 = this.f36385b;
        o4Var2.e = 1440;
        this.f36387f.addView(o4Var2);
        ...
        o4 o4Var3 = this.f36386c;
        o4Var3.e = 10080;
        this.f36387f.addView(o4Var3);
        ...
        this.e.f20567b.setVisibility(8);
        this.f36387f.addView(this.e);
        o4 o4Var5 = this.f36384a;
        ArrayList arrayList = this.h;
        arrayList.add(o4Var5);
        arrayList.add(this.f36385b);
        arrayList.add(this.f36386c);
    ...
    public final void onPause() {
        ...
        while (true) {
            ...
            if (i10 < arrayList.size()) {
                if (((o4) arrayList.get(i10)).f20567b.f22370f) {
                    if (((o4) arrayList.get(i10)).e != this.f36388n) {
                        this.f36388n = ((o4) arrayList.get(i10)).e;
                        ...
                        getUserConfig().setGlobalTtl(this.f36388n);
