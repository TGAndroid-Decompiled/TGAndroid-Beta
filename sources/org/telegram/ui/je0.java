...
public final class je0 implements Runnable {
    public final int f34860a = 1;
    public final oe0 f34861b;
    public final TLRPC.TL_error f34862c;
    public final String d;
    public final String e;
    public final TLObject f34863f;

    public je0(oe0 oe0Var, TLRPC.TL_error tL_error, String str, String str2, TLObject tLObject) {
        this.f34861b = oe0Var;
        this.f34862c = tL_error;
        this.d = str;
        this.e = str2;
        this.f34863f = tLObject;
    }
    ...
    public final void run() {
        ...
        TLObject tLObject = this.f34863f;
        String str = this.e;
        String str2 = this.d;
        TLRPC.TL_error tL_error = this.f34862c;
        oe0 oe0Var = this.f34861b;
        switch (i11) {
            case 0:
                oe0Var.getClass();
                if (tL_error == null) {
                    TL_account.Password password = (TL_account.Password) tLObject;
                    oe0Var.f36327s = password;
