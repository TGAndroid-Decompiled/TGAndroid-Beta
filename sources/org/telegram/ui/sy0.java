...
public final class sy0 implements org.telegram.ui.Components.kl0 {
    ...
    public static void a(sy0 sy0Var, Context context, int i10) {
        ...
        int i20 = 0;
        if (i10 == 0) {
            sy0Var.f38459c.getUserConfig().syncContacts = true;
            sy0Var.f38459c.getUserConfig().saveConfig(false);
            sy0Var.f38459c.getContactsController().forceImportContacts();
            return;
        }
        long j11 = 0;
        if (i10 == 1) {
            sy0Var.f38459c.getContactsController().loadContacts(false, 0L);
        } else if (i10 == 2) {
            sy0Var.f38459c.getContactsController().resetImportedContacts();
        } else if (i10 == 3) {
            sy0Var.f38459c.getMessagesController().forceResetDialogs();
        } else if (i10 == 4) {
            ...
            sy0Var.f38459c.getMessagesStorage().clearSentMedia();
            ...
            k7.a6.a();
            i15 = ((org.telegram.ui.ActionBar.p2) sy0Var.f38459c).currentAccount;
            ...
            i16 = ((org.telegram.ui.ActionBar.p2) sy0Var.f38459c).currentAccount;
            ChatThemeController.getInstance(i16).clearCache();
            sy0Var.f38459c.getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.newSuggestionsAvailable, new Object[0]);
            n31.W();
            i17 = ((org.telegram.ui.ActionBar.p2) sy0Var.f38459c).currentAccount;
            cg.f1.e(i17).a();
            SharedPreferences mainSettings = sy0Var.f38459c.getMessagesController().getMainSettings();
            ...
            edit.apply();
            i18 = ((org.telegram.ui.ActionBar.p2) sy0Var.f38459c).currentAccount;
            SharedPreferences.Editor edit2 = MessagesController.getNotificationsSettings(i18).edit();
            i19 = ((org.telegram.ui.ActionBar.p2) sy0Var.f38459c).currentAccount;
            ...
            org.telegram.ui.Components.voip.f2.j(sy0Var.f38459c.getParentActivity());
        } else if (i10 == 8) {
            SharedConfig.toggleRoundCamera16to9();
        } else if (i10 == 9) {
            ((LaunchActivity) sy0Var.f38459c.getParentActivity()).z(true);
        } else if (i10 == 10) {
            sy0Var.f38459c.getMessagesStorage().readAllDialogs(-1);
        } else if (i10 == 11) {
            ...
            Set<String> set = sy0Var.f38459c.getMessagesController().pendingSuggestions;
            ...
            try {
                if (i10 == 14) {
                    ...
                    Activity parentActivity = sy0Var.f38459c.getParentActivity();
                    ...
                    k7.x8.a((LaunchActivity) sy0Var.f38459c.getParentActivity(), !SharedConfig.isFloatingDebugActive, true);
                } else if (i10 == 19) {
                    sy0Var.f38459c.getMessagesController().loadAppConfig();
                    TLRPC.TL_help_dismissSuggestion tL_help_dismissSuggestion = new TLRPC.TL_help_dismissSuggestion();
                    tL_help_dismissSuggestion.suggestion = "VALIDATE_PHONE_NUMBER";
                    tL_help_dismissSuggestion.peer = new TLRPC.TL_inputPeerEmpty();
                    sy0Var.f38459c.getConnectionsManager().sendRequest(tL_help_dismissSuggestion, new py0(sy0Var, 0));
                } else if (i10 == 20) {
                    ...
                    ProfileActivity.S0(sy0Var.f38459c, "video/avc", sb2);
                    ProfileActivity.S0(sy0Var.f38459c, "video/hevc", sb2);
                    ProfileActivity.S0(sy0Var.f38459c, "video/x-vnd.on2.vp8", sb2);
                    ProfileActivity.S0(sy0Var.f38459c, "video/x-vnd.on2.vp9", sb2);
                    sy0Var.f38459c.showDialog(new ry0(sy0Var, sy0Var.f38459c.getParentActivity(), sb2.toString()));
                } else if (i10 == 21) {
                    AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(sy0Var.f38459c.getParentActivity(), 0, sy0Var.f38459c.f32181w0);
                    ...
                    alertDialog$Builder.f(new CharSequence[]{replaceTags, replaceTags2, AndroidUtilities.replaceTags(str5.concat(str8))}, new qy0(measureDevicePerformanceClass, 0));
                    alertDialog$Builder.h(LocaleController.getString("Cancel", R.string.Cancel), null);
                    alertDialog$Builder.o();
                } else if (i10 == 22) {
                    SharedConfig.toggleRoundCamera();
                } else if (i10 == 23) {
                    boolean q10 = ph.v0.q(sy0Var.f38459c.getParentActivity());
                    MessagesController.getGlobalMainSettings().edit().putBoolean("dual_available", !q10).apply();
                    Activity parentActivity2 = sy0Var.f38459c.getParentActivity();
                    if (!q10) {
                    ...
                    while (i20 < sy0Var.f38459c.getParentLayout().getFragmentStack().size()) {
                        ((org.telegram.ui.ActionBar.p2) sy0Var.f38459c.getParentLayout().getFragmentStack().get(i20)).clearSheets();
                        i20++;
                    }
                } else if (i10 == 25) {
                    ...
                    sy0Var.f38459c.getMediaDataController().loadAttachMenuBots(false, true);
                } else if (i10 == 28) {
                    i12 = ((org.telegram.ui.ActionBar.p2) sy0Var.f38459c).currentAccount;
                    ...
                    i11 = ((org.telegram.ui.ActionBar.p2) sy0Var.f38459c).currentAccount;
    ...
    public final boolean f(int r46, android.view.View r47) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.sy0.f(int, android.view.View):boolean");
    }
}
