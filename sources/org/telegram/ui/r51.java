...
public final class r51 extends p61 {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (a61Var != null) {
            ...
            zg.b0 b0Var = (zg.b0) eVar.f43137b;
            zg.a0 a0Var = b0Var.f49245a;
            RectF rectF = AndroidUtilities.rectTmp;
            float f7 = 0;
            rectF.set(f7, f7, measuredWidth, measuredHeight);
            org.telegram.ui.Components.pk0 delegate = ((org.telegram.ui.Components.qk0) eVar.f43138c).getDelegate();
            float x11 = a0Var.getX() + x10;
            if (b0Var.f49265y == 1) {
                y3 = a0Var.getY() - AndroidUtilities.statusBarHeight;
            } else {
                y3 = a0Var.getY() + b0Var.f49247c.getY();
            }
