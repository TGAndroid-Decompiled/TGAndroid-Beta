...
public final class oc extends org.telegram.ui.Components.vl0 {
    ...
    @Override
    public final int h() {
        return this.f36163c.R;
    }

    @Override
    public final int j(int i10) {
        bd bdVar = this.f36163c;
        if (i10 == bdVar.S) {
            return 0;
        }
        if (i10 == bdVar.W) {
        ...
        if (i10 == bdVar.f32313b0) {
            return 4;
        }
        if (i10 != bdVar.U && i10 != bdVar.f32315c0 && i10 != bdVar.f32319f0 && i10 != bdVar.f32321h0 && i10 != bdVar.f32323j0) {
            if (i10 != bdVar.X && i10 != bdVar.f32317e0) {
                return 7;
            }
            return 5;
        }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i16 != 1) {
            if (i16 != 3) {
                if (i16 != 4) {
                    if (i16 != 5) {
                        ...
                        if (i10 == bdVar.U) {
                            ...
                            if (bdVar.f32312b < bdVar.J0()) {
                                pcVar.e(bdVar.J0());
                            } else {
                                pcVar.e(0);
                            }
                            pcVar.c(bdVar.f32338w, false, false);
                            return;
                        } else if (i10 == bdVar.f32319f0) {
                            i13 = ((org.telegram.ui.ActionBar.n2) bdVar).currentAccount;
                            pcVar.a(i13, bdVar.f32333s, false);
                            j5Var.l(LocaleController.getString(bdVar.G0()), false);
                            if (bdVar.f32312b < bdVar.F0()) {
                                pcVar.e(bdVar.F0());
                            } else {
                                pcVar.e(0);
                            }
                            pcVar.c(DialogObject.getEmojiStatusDocumentId(bdVar.f32342y), DialogObject.isEmojiStatusCollectible(bdVar.f32342y), false);
                            return;
                        } else if (i10 == bdVar.f32321h0) {
                            i12 = ((org.telegram.ui.ActionBar.n2) bdVar).currentAccount;
                            pcVar.a(i12, bdVar.f32333s, false);
                            j5Var.l(LocaleController.getString(bdVar.B0()), false);
                            if (bdVar.f32312b < bdVar.H0()) {
                                pcVar.e(bdVar.H0());
                            } else {
                                pcVar.e(0);
                            }
                ...
                ((zp0) view).a(bdVar.f32333s, false);
                return;
            }
            ((sc) view).a(bdVar.f32318f, false);
            return;
        }
        uc ucVar = (uc) view;
        ip0 ip0Var = ucVar.f37960a;
        tc tcVar = ucVar.f37961b;
        i11 = ((org.telegram.ui.ActionBar.n2) bdVar).currentAccount;
        ip0Var.b(i11, bdVar.f32333s, false);
        tcVar.b(bdVar.f32333s, false);
        tcVar.d(bdVar.f32338w, false, false);
        tcVar.setForum(bdVar.R0());
        tcVar.e(DialogObject.getEmojiStatusDocumentId(bdVar.f32342y), false, false);
        tcVar.a(bdVar.f32318f);
    }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 == 0) {
                ...
                public final void run(Object obj) {
                    switch (r2) {
                        case 0:
                            ...
                            bd bdVar2 = this.f35890b.f36163c;
                            if (str == null) {
                                bdVar2.F = bdVar2.G;
                            } else if (str.equals("❌")) {
                                bdVar2.F = null;
                                ...
                                tL_wallPaperNoFile.f18448id = 0L;
                            ...
                            return;
                        default:
                            bd bdVar3 = this.f35890b.f36163c;
                            bdVar3.f32333s = ((Integer) obj).intValue();
                            if (bdVar3.f32342y instanceof TLRPC.TL_emojiStatusCollectible) {
                                bdVar3.f32342y = null;
                            }
                            bdVar3.X0(true);
                            bdVar3.b1();
            ...
            frameLayout.f36445c = new org.telegram.ui.Components.o5(AndroidUtilities.dp(24.0f), 13, frameLayout, false);
            zcVar = frameLayout;
        } else if (i10 == 3) {
            ...
            scVar.f37246b.setOnItemClickListener(new ai.o6(5, this, scVar));
            zcVar = scVar;
        } else if (i10 == 4) {
            ...
            zcVar = new kp0(parentActivity7, e6Var2, false);
        } else if (i10 == 10) {
    ...
    public final void y(s4.c1 c1Var) {
        ...
        bd bdVar = this.f36163c;
        if (z10) {
            tc tcVar = ((uc) view).f37961b;
            TLRPC.EmojiStatus emojiStatus = bdVar.f32342y;
            if (emojiStatus instanceof TLRPC.TL_emojiStatusCollectible) {
                tcVar.c(MessagesController.PeerColor.fromCollectible(emojiStatus), false);
                tcVar.d(((TLRPC.TL_emojiStatusCollectible) bdVar.f32342y).pattern_document_id, true, false);
            } else {
                tcVar.b(bdVar.f32333s, false);
                tcVar.d(bdVar.f32338w, false, false);
            }
            tcVar.e(DialogObject.getEmojiStatusDocumentId(bdVar.f32342y), DialogObject.isEmojiStatusCollectible(bdVar.f32342y), false);
            tcVar.setForum(bdVar.R0());
            tcVar.a(bdVar.f32318f);
