...
public final class fc0 {
    ...
    public final void a() {
        ...
        org.telegram.ui.ActionBar.b2 b2Var = this.f36371e;
        if (b2Var != null) {
            b2Var.dismiss();
        }
        of.e eVar = this.f36370c;
        if (eVar != null) {
            eVar.b();
        }
        this.f36373g = true;
    ...
    public final org.telegram.ui.ActionBar.d5 c() {
        return this.f36368a.O();
    }

    public final UserConfig d() {
        return UserConfig.getInstance(this.f36369b);
    }
    ...
    public final boolean e(Uri uri) {
        ...
        if (uri != null) {
            ...
            LaunchActivity launchActivity = this.f36368a;
            if (equalsIgnoreCase) {
                        ...
                        if (!arrayList.isEmpty()) {
                            ...
                            if ("newbot".equalsIgnoreCase(str4)) {
                                ...
                                if ("new".equalsIgnoreCase(str4)) {
                                    ...
                                    di.pc E = di.pc.E(launchActivity, this.f36369b);
                                    if (E.O1 != r15) {
                                        E.O1 = r15;
                                        ?? r22 = E.Q0;
                                        if (r22 != 0) {
    ...
    public final boolean f(String str) {
        ...
        k();
        ConnectionsManager.getInstance(this.f36369b).sendRequestTyped(gettone, new Object(), new b5(this, 14));
        return true;
    }
    ...
    public final boolean g(String str) {
        ...
        this.h = ConnectionsManager.getInstance(this.f36369b).sendRequest(tL_payments_getPaymentForm, new aa((Object) this, (TLObject) tL_inputInvoiceSlug, str, 18));
        return true;
    }
    ...
    public final void h(String str, String str2, String str3) {
        ...
        if (U != null && U.getContext() != null) {
            ...
            MessagesController.getInstance(this.f36369b).getUserNameResolver().resolve(str, new qh(this, userArr, new org.telegram.ui.Components.in0(this, U, userArr, tL_requestPeerTypeCreateBot, 15), 3));
        }
    }
    ...
    public final boolean i(Uri uri, String str) {
        ...
        ConnectionsManager.getInstance(this.f36369b).sendRequestTyped(tL_messages_requestUrlAuth, new Object(), new bi.f0(16, this, tL_messages_requestUrlAuth));
        return true;
    }
    ...
    public final void k() {
        if (!this.f36372f && !this.f36373g) {
            of.e eVar = this.f36370c;
            if (eVar == null) {
                if (this.f36371e == null) {
                    this.f36371e = new org.telegram.ui.ActionBar.b2(this.f36368a, 3, null);
                }
                this.f36371e.setOnCancelListener(new pg(this, 3));
                this.f36371e.q(300L);
            } else {
    ...
    public final void o(String str) {
        AndroidUtilities.scrollToFragmentRow(this.f36368a.O(), str);
    }
}
