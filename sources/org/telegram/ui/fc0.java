...
public final class fc0 extends FrameLayout {
    public final ImageView f34027a;
    public final LinearLayout f34028b;
    public final gg.q f34029c;
    public final org.telegram.ui.Components.k6 d;
    public final ImageView e;
    public final Switch f34030f;
    ...
    public fc0(gc0 gc0Var, Context context) {
        ...
        this.f34027a = imageView;
        int w02 = org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20042m6, false);
        ...
        addView(kpVar, k7.b6.d(21, 21.0f, i20, f10, 0.0f, f11, 0.0f));
        setFocusable(true);
    }

    public final int a(int r5) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.fc0.a(int):int");
    }
    ...
    public final void b(boolean z4, boolean z10) {
        ...
        if (this.f34033s != z4) {
            ...
            Switch r12 = this.f34030f;
            LinearLayout linearLayout = this.f34028b;
            ImageView imageView = this.f34027a;
            float f16 = 1.0f;
            if (z10) {
                ...
                ViewPropertyAnimator animate4 = kpVar.animate();
                if (z4) {
                    f16 = 0.5f;
                }
    ...
    public final void c(ac0 ac0Var, boolean z4) {
        ...
        int i10 = ac0Var.e;
        this.f34034w = a(value & i10);
        this.f34035x = a(i10);
        boolean z10 = false;
        String format = String.format("%d/%d", Integer.valueOf(this.f34034w), Integer.valueOf(this.f34035x));
    ...
    public final void onDraw(Canvas canvas) {
        ...
        super.onDraw(canvas);
        boolean z4 = LocaleController.isRTL;
        gg.q qVar = this.f34029c;
        if (z4) {
            if (this.f34032r) {
                float dp = AndroidUtilities.dp(75.0f);
                canvas.drawRect(dp - AndroidUtilities.dp(0.66f), (getMeasuredHeight() - AndroidUtilities.dp(20.0f)) / 2.0f, dp, (AndroidUtilities.dp(20.0f) + getMeasuredHeight()) / 2.0f, org.telegram.ui.ActionBar.j6.f20000k0);
            }
            if (this.f34031n) {
                ...
                canvas.drawLine(measuredWidth + i10, getMeasuredHeight() - 1, 0.0f, getMeasuredHeight() - 1, org.telegram.ui.ActionBar.j6.f20000k0);
                return;
            }
            return;
        }
        if (this.f34032r) {
            ...
            canvas.drawRect(measuredWidth2 - AndroidUtilities.dp(0.66f), (getMeasuredHeight() - AndroidUtilities.dp(20.0f)) / 2.0f, measuredWidth2, (AndroidUtilities.dp(20.0f) + getMeasuredHeight()) / 2.0f, org.telegram.ui.ActionBar.j6.f20000k0);
        }
        if (this.f34031n) {
            canvas.drawLine(qVar.getTranslationX() + AndroidUtilities.dp(64.0f), getMeasuredHeight() - 1, getMeasuredWidth(), getMeasuredHeight() - 1, org.telegram.ui.ActionBar.j6.f20000k0);
        }
    }
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (kpVar.getVisibility() == 0) {
            ...
            accessibilityNodeInfo.setChecked(this.f34030f.h);
        }
        StringBuilder sb = new StringBuilder();
        sb.append(this.f34029c.getText());
        if (this.v) {
            sb.append('\n');
            sb.append(LocaleController.formatString("Of", R.string.Of, Integer.valueOf(this.f34034w), Integer.valueOf(this.f34035x)));
        }
