...
public final class fc0 extends FrameLayout {
    public final org.telegram.ui.Components.y9 f33609a;
    public final SpannableStringBuilder f33610b;
    public final org.telegram.ui.Cells.x1 f33611c;
    public final TextView d;
    public final org.telegram.ui.Cells.x1 e;
    public final TextView f33612f;
    public final org.telegram.ui.Components.so0 h;
    public final dc0 f33613n;
    public boolean f33614r;
    public float f33615s;
    public ValueAnimator v;
    public float f33616w;
    public ValueAnimator f33617x;
    public final hc0 f33618y;
    ...
    public fc0(hc0 hc0Var, Context context) {
        ...
        x1Var2.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19229n6, false));
        frameLayout.addView(x1Var2, w7.y5.e(-2, -2, 17));
        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder("b");
        this.f33610b = spannableStringBuilder;
        org.telegram.ui.Components.y9 y9Var = new org.telegram.ui.Components.y9();
        this.f33609a = y9Var;
        y9Var.f30561a = x1Var2.getPaint();
        y9Var.f30564f = AndroidUtilities.dp(1.5f);
    ...
    public final void a() {
        ...
        if (powerSaverLevel <= 0) {
            ...
            this.f33609a.a(f11 / 100.0f, true);
            x1Var.c(AndroidUtilities.replaceCharSequence("%s", LocaleController.getString(R.string.LiteBatteryWhenBelow), TextUtils.concat(String.format("%d%% ", Integer.valueOf(Math.round(f11))), this.f33610b)), !LocaleController.isRTL, true);
        }
        ...
        org.telegram.ui.Cells.x1 x1Var2 = this.f33611c;
        ...
        if (this.f33615s != f7) {
            ...
            ValueAnimator ofFloat = ValueAnimator.ofFloat(this.f33615s, f7);
            this.v = ofFloat;
            ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) {
                public final fc0 f32636b;
                ...
                public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                    switch (r2) {
                        case 0:
                            ...
                            fc0Var.f33615s = floatValue;
                            textView.setTextColor(i0.a.d(floatValue, w02, w03));
                            return;
                        default:
                            fc0 fc0Var2 = this.f32636b;
        ...
        if (this.f33616w != f12) {
            this.f33616w = f12;
            ValueAnimator valueAnimator2 = this.f33617x;
            if (valueAnimator2 != null) {
                valueAnimator2.cancel();
                this.f33617x = null;
            }
            ValueAnimator ofFloat2 = ValueAnimator.ofFloat(this.f33616w, f12);
            this.f33617x = ofFloat2;
            ...
            this.f33617x.addListener(new ec0(this, f12, 1));
            this.f33617x.setInterpolator(org.telegram.ui.Components.rr.h);
            this.f33617x.setDuration(320L);
            this.f33617x.start();
        }
    }
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        this.f33613n.onInitializeAccessibilityNodeInfo(this, accessibilityNodeInfo);
    }
    ...
    public final void onPopulateAccessibilityEvent(AccessibilityEvent accessibilityEvent) {
        ...
        this.f33613n.onPopulateAccessibilityEvent(this, accessibilityEvent);
    }

    @Override
    public final boolean performAccessibilityAction(int i10, Bundle bundle) {
        return this.f33613n.performAccessibilityAction(this, i10, bundle);
    }
}
