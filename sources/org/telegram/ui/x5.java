...
public final class x5 implements i80 {
    ...
    public final a6 f39830b;
    public final CacheByChatsController.KeepMediaException f39831c;

    public x5(a6 a6Var, CacheByChatsController.KeepMediaException keepMediaException, int i10) {
        this.f39829a = i10;
        this.f39830b = a6Var;
        this.f39831c = keepMediaException;
    }
