...
public final class x5 implements qy, org.telegram.ui.ActionBar.b2, v4, org.telegram.ui.Components.b5, MessagesController.ErrorDelegate, LanguageDetector.ExceptionCallback, org.telegram.ui.Components.pj0, MessagesStorage.BooleanCallback, ResultCallback, MessagesStorage.LongCallback, vg1 {
    ...
    public final Object f39376b;
    public final Object f39377c;
    ...
    public void J(int i10, int i11, boolean z10) {
        switch (this.f39375a) {
            case 4:
                bo boVar = (bo) this.f39376b;
                boVar.l8(null, null);
                SendMessagesHelper.prepareSendingPhoto(boVar.getAccountInstance(), null, (Uri) this.f39377c, boVar.T5, boVar.f32381n5, boVar.X3, boVar.f32355l5, null, null, null, null, 0, boVar.p5, z10, i10, boVar.R3, boVar.C8());
                return;
            case 5:
            default:
                nn nnVar = (nn) this.f39376b;
                MessageObject messageObject = (MessageObject) this.f39377c;
                if (z10) {
                    nnVar.f36134a.getMessagesController().approveSuggestedMessage(DialogObject.getPeerDialogId(messageObject.messageOwner.peer_id), messageObject.messageOwner.f18142id, i10);
                    return;
                } else {
                    nnVar.getClass();
                    return;
            ...
            case 6:
                bo boVar2 = (bo) this.f39376b;
                boVar2.getSendMessagesHelper().sendMessage(SendMessagesHelper.SendMessageParams.of((String) this.f39377c, boVar2.T5, boVar2.f32381n5, boVar2.X3, null, false, null, null, null, z10, i10, 0, null, false));
    ...
    public void a(long j3, TLRPC.MessagePeerReaction messagePeerReaction) {
        MessageObject messageObject = (MessageObject) this.f39377c;
        bo boVar = ((ii) this.f39376b).f34601p;
    ...
    public void b(d5 d5Var) {
        nb nbVar = (nb) this.f39376b;
        TLRPC.User user = (TLRPC.User) this.f39377c;
        int ordinal = d5Var.ordinal();
        if (ordinal != 0) {
            if (ordinal == 3) {
                sb sbVar = nbVar.f36008a;
                if (user != null) {
                    Bundle bundle = new Bundle();
                    bundle.putLong("user_id", user.f18268id);
                    org.telegram.ui.ActionBar.o2 o2Var = sbVar.f37447n;
    ...
    public void e(TLRPC.TL_inputCheckPasswordSRP tL_inputCheckPasswordSRP) {
        ((pq) this.f39376b).p0(tL_inputCheckPasswordSRP, (TwoStepVerificationActivity) this.f39377c);
    }
    ...
    public void f(org.telegram.ui.ActionBar.c2 c2Var, int i10) {
        ...
        switch (this.f39375a) {
            case 1:
                nf.f.o(((wb) this.f39376b).getParentActivity(), (String) this.f39377c, true);
                return;
            case 2:
            case 4:
            case 5:
            ...
            case 16:
            default:
                org.telegram.ui.Components.mf mfVar = (org.telegram.ui.Components.mf) this.f39376b;
                boolean[] zArr = (boolean[]) this.f39377c;
                boolean z10 = zArr[0];
                boolean z11 = zArr[1];
                wy wyVar = (wy) mfVar.f26139b;
                ArrayList arrayList = (ArrayList) mfVar.f26140c;
                wyVar.getClass();
                ...
                return;
            case 3:
                nd.V((nd) this.f39376b, (TLRPC.Chat) this.f39377c);
                return;
            case 13:
                kp kpVar = (kp) this.f39376b;
                TLRPC.TL_channels_updateUsername tL_channels_updateUsername = new TLRPC.TL_channels_updateUsername();
                tL_channels_updateUsername.channel = MessagesController.getInputChannel((TLRPC.Chat) this.f39377c);
                tL_channels_updateUsername.username = "";
                kpVar.getConnectionsManager().sendRequest(tL_channels_updateUsername, new xo(kpVar, 0), 64);
                return;
            case 17:
                org.telegram.ui.Components.e0.P((org.telegram.ui.Components.e0) this.f39376b, (TL_aicompose.TL_aiComposeTone) this.f39377c, c2Var);
                return;
            case 18:
                ((AtomicBoolean) this.f39376b).set(true);
                ((q0.a) this.f39377c).accept(Boolean.FALSE);
                return;
            case 19:
                MessagesStorage.IntCallback intCallback = (MessagesStorage.IntCallback) this.f39377c;
                int i13 = ((int[]) this.f39376b)[0];
                if (i13 == 0) {
                    i11 = 900;
                } else if (i13 == 1) {
                    i11 = 3600;
                ...
                return;
            case 20:
                TLRPC.TL_langPackLanguage tL_langPackLanguage = (TLRPC.TL_langPackLanguage) this.f39376b;
                LaunchActivity launchActivity = (LaunchActivity) this.f39377c;
            ...
            case 21:
                c2Var.dismiss();
                ((pf) this.f39376b).run(((EditText) this.f39377c).getText().toString());
                return;
            case 22:
                org.telegram.ui.Components.d4 d4Var = (org.telegram.ui.Components.d4) this.f39376b;
                Utilities.Callback callback = (Utilities.Callback) this.f39377c;
                String trim = d4Var.getText().toString().trim();
                if (TextUtils.isEmpty(trim)) {
                    matches = false;
                } else {
                    matches = org.telegram.ui.Components.c5.f22931a.matcher(trim.trim()).matches();
                }
                if (!matches) {
                ...
                return;
            case 23:
                String str2 = (String) this.f39376b;
                org.telegram.ui.ActionBar.o2 o2Var = (org.telegram.ui.ActionBar.o2) this.f39377c;
                try {
            ...
            case 24:
                TLRPC.EncryptedChat encryptedChat = (TLRPC.EncryptedChat) this.f39376b;
                int i14 = encryptedChat.ttl;
                int value = ((org.telegram.ui.Components.uc0) this.f39377c).getValue();
                if (value >= 0 && value < 16) {
                ...
                return;
            case 25:
                ((fa) this.f39376b).run(((boolean[]) this.f39377c)[0]);
                return;
            case 26:
                Runnable runnable = (Runnable) this.f39377c;
                SharedPreferences.Editor edit = MessagesController.getNotificationsSettings(UserConfig.selectedAccount).edit();
                edit.remove("color_" + ((String) this.f39376b));
                edit.commit();
                if (runnable != null) {
                    runnable.run();
                    return;
                ...
                return;
            case 27:
                ((MessagesStorage.BooleanCallback) this.f39376b).run(((boolean[]) this.f39377c)[0]);
                return;
            case 28:
                ((Utilities.Callback) this.f39376b).run(Boolean.valueOf(((boolean[]) this.f39377c)[0]));
                return;
        }
    }
    ...
    public void onComplete(Object obj) {
        zn znVar = (zn) this.f39376b;
        org.telegram.ui.Components.cc0 cc0Var = (org.telegram.ui.Components.cc0) this.f39377c;
        Pair pair = (Pair) obj;
        znVar.getClass();
        if (pair != null) {
            long longValue = ((Long) pair.first).longValue();
            Bitmap bitmap = (Bitmap) pair.second;
            org.telegram.ui.ActionBar.e4 e4Var = znVar.f40280f;
            if (e4Var != null && longValue == e4Var.i(znVar.G ? 1 : 0) && bitmap != null) {
                cc0Var.f23018x = bitmap;
                cc0Var.i();
            }
        }
    }
    ...
    public boolean run(TLRPC.TL_error tL_error) {
        bo.g0((bo) this.f39376b, (Context) this.f39377c, tL_error);
        return false;
    }
    ...
    public boolean u(wy wyVar, ArrayList arrayList, CharSequence charSequence, boolean z10, boolean z11, int i10, int i11, fg1 fg1Var) {
        b6 b6Var = (b6) this.f39376b;
        ArrayList arrayList2 = b6Var.f32055c;
        ((wy) this.f39377c).finishFragment();
        ...
        if (keepMediaException != null) {
            ...
            while (true) {
                if (i16 < arrayList2.size()) {
                    if (((a6) arrayList2.get(i16)).f31725c != null && ((a6) arrayList2.get(i16)).f31725c.dialogId == keepMediaException.dialogId) {
                        i12 = i16;
                        break;
                    }
                    i16++;
    ...
    public void run(long j3) {
        switch (this.f39375a) {
            case 12:
                wo woVar = (wo) this.f39376b;
                woVar.getClass();
                ((org.telegram.ui.ActionBar.c2) this.f39377c).dismiss();
                woVar.N0 = false;
                if (j3 == 0) {
                    return;
                }
                ...
                woVar.getMessagesController().toggleChannelForum(woVar.f39111w0, woVar.F0, woVar.H0);
                TLRPC.Chat chat2 = woVar.f39113x0;
            ...
            case 13:
            default:
                sp spVar = (sp) this.f39376b;
                Runnable runnable = (Runnable) this.f39377c;
                if (j3 != 0) {
                    wp wpVar = spVar.f37538x.d;
                    if (wpVar.f39123s) {
                        wpVar.v.set(0, wpVar.getMessagesController().getChat(Long.valueOf(j3)));
                    } else {
                        wpVar.E = j3;
                        wpVar.f39120f = wpVar.getMessagesController().getChat(Long.valueOf(j3));
                    }
                    runnable.run();
                    return;
                }
    ...
    public void run(boolean z10) {
        long j3 = ((TLRPC.User) this.f39377c).f18268id;
        bo boVar = ((oj) this.f39376b).f36362b;
    ...
    public void run(Exception exc) {
        AtomicReference atomicReference = (AtomicReference) this.f39377c;
        FileLog.e("mlkit: failed to detect language in message");
        ((AtomicBoolean) this.f39376b).set(false);
