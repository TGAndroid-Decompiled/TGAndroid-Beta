...
public final class hg0 extends org.telegram.ui.Components.vv0 {
    public final ImageView f34267a;
    public final ci.d f34268b;
    public final yh.r[] f34269c;
    public Bundle d;
    public String e;
    ...
    public hg0(yg0 yg0Var, Context context) {
        ...
        canvas.drawColor(i0.a.d(0.5f, org.telegram.ui.ActionBar.j6.w0(null, i11, false), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18934h5, false)));
        gg0Var.setBackgroundBitmap(createBitmap);
        sg.a aVar = gg0Var.f42964b;
        aVar.f42952w = i11;
        aVar.f42953x = org.telegram.ui.ActionBar.j6.Lj;
        aVar.b();
    ...
    public final void g() {
        ...
        if (this.f34273s >= 0) {
            ...
            ConnectionsManager.getInstance(i10).cancelRequest(this.f34273s, true);
            this.f34273s = -1;
        }
        this.f34270f = false;
        this.f34268b.setLoading(false);
    }
    ...
    public final void m(Bundle bundle, boolean z10) {
        ...
        yh.r[] rVarArr = this.f34269c;
        if (isEmpty) {
            rVarArr[0].f47716c.setText(LocaleController.getString(R.string.SMSFee1Text));
        } else {
            rVarArr[0].f47716c.setText(LocaleController.formatString(R.string.SMSFee1TextCountry, countryName));
        }
        yh.r rVar = rVarArr[2];
        if (i10 == 7) {
        ...
        this.f34267a.setOnClickListener(new ai.p5(this, string5, string6, string3, 14));
        ci.d dVar = this.f34268b;
    ...
    public final void p() {
        ...
        tL_checkPaidAuth.form_id = this.f34272r;
        tL_checkPaidAuth.phone_number = this.h;
        tL_checkPaidAuth.phone_code_hash = this.f34271n;
        i10 = ((org.telegram.ui.ActionBar.o2) this.v).currentAccount;
        this.f34273s = ConnectionsManager.getInstance(i10).sendRequest(tL_checkPaidAuth, new m(this, 14), 1096);
    }
}
