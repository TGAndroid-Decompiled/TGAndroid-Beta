...
public final class hg0 extends org.telegram.ui.Components.vv0 {
    public final ImageView f34262a;
    public final ci.d f34263b;
    public final yh.r[] f34264c;
    public Bundle d;
    public String e;
    ...
    public hg0(yg0 yg0Var, Context context) {
        ...
        canvas.drawColor(i0.a.d(0.5f, org.telegram.ui.ActionBar.j6.w0(null, i11, false), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18933h5, false)));
        gg0Var.setBackgroundBitmap(createBitmap);
        sg.a aVar = gg0Var.f42959b;
        aVar.f42947w = i11;
        aVar.f42948x = org.telegram.ui.ActionBar.j6.Lj;
        aVar.b();
    ...
    public final void g() {
        ...
        if (this.f34268s >= 0) {
            ...
            ConnectionsManager.getInstance(i10).cancelRequest(this.f34268s, true);
            this.f34268s = -1;
        }
        this.f34265f = false;
        this.f34263b.setLoading(false);
    }
    ...
    public final void m(Bundle bundle, boolean z10) {
        ...
        yh.r[] rVarArr = this.f34264c;
        if (isEmpty) {
            rVarArr[0].f47711c.setText(LocaleController.getString(R.string.SMSFee1Text));
        } else {
            rVarArr[0].f47711c.setText(LocaleController.formatString(R.string.SMSFee1TextCountry, countryName));
        }
        yh.r rVar = rVarArr[2];
        if (i10 == 7) {
        ...
        this.f34262a.setOnClickListener(new ai.p5(this, string5, string6, string3, 14));
        ci.d dVar = this.f34263b;
    ...
    public final void p() {
        ...
        tL_checkPaidAuth.form_id = this.f34267r;
        tL_checkPaidAuth.phone_number = this.h;
        tL_checkPaidAuth.phone_code_hash = this.f34266n;
        i10 = ((org.telegram.ui.ActionBar.o2) this.v).currentAccount;
        this.f34268s = ConnectionsManager.getInstance(i10).sendRequest(tL_checkPaidAuth, new m(this, 14), 1096);
    }
}
