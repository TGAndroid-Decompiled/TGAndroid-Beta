...
public final class o11 extends FrameLayout {
    ...
    public int f39103a;
    public final Paint f39104b;
    public boolean f39105c;
    public final org.telegram.ui.Components.e6 d;
    public int f39106e;
    public int f39107f;
    public final org.telegram.ui.Components.h5 h;
    public final org.telegram.ui.Components.h5 f39108n;
    public int f39109r;
    public int f39110s;
    public int v;
    public float f39111w;
    public float f39112x;
    public RadialGradient f39113y;

    public o11(ProfileActivity profileActivity, Context context) {
        super(context);
        this.N = profileActivity;
        this.f39104b = new Paint();
        ...
        this.f39108n = new org.telegram.ui.Components.h5(this, 350L, prVar);
        this.E = new Matrix();
        this.F = new Paint(1);
    ...
    public final void a(MessagesController.PeerColor peerColor, boolean z10) {
        ...
        if (peerColor != null) {
            this.f39105c = true;
            this.f39106e = peerColor.getBgColor1(org.telegram.ui.ActionBar.j6.I.q());
            int bgColor2 = peerColor.getBgColor2(org.telegram.ui.ActionBar.j6.I.q());
            this.f39107f = bgColor2;
            profileActivity.f33901c1 = i0.a.d(0.25f, this.f39106e, bgColor2);
            int i10 = peerColor.patternColor;
            if (i10 != 0) {
                this.G = i10;
                this.H = org.telegram.ui.ActionBar.j6.l1(0.45f, i10);
            } else {
                this.G = bq0.w0(this.f39106e);
                this.H = org.telegram.ui.ActionBar.j6.l1(0.15f, bq0.w0(this.f39106e));
            }
        } else {
            profileActivity.f33901c1 = this.f39103a;
            this.f39105c = false;
            int i11 = org.telegram.ui.ActionBar.j6.f20965s8;
            if (AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.j6.v0(i11, profileActivity.f34059z0)) > 0.8f) {
                this.G = -1;
                this.H = -1;
            } else if (AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.j6.v0(i11, profileActivity.f34059z0)) < 0.2f) {
                this.G = org.telegram.ui.ActionBar.j6.l1(0.5f, org.telegram.ui.ActionBar.j6.b(0.02f, 0.25f, org.telegram.ui.ActionBar.j6.v0(i11, profileActivity.f34059z0)));
                this.H = org.telegram.ui.ActionBar.j6.l1(0.35f, org.telegram.ui.ActionBar.j6.b(0.02f, 0.25f, org.telegram.ui.ActionBar.j6.v0(i11, profileActivity.f34059z0)));
            } else {
                this.G = bq0.w0(org.telegram.ui.ActionBar.j6.v0(i11, profileActivity.f34059z0));
                this.H = org.telegram.ui.ActionBar.j6.l1(0.15f, bq0.w0(org.telegram.ui.ActionBar.j6.v0(i11, profileActivity.f34059z0)));
            }
        }
        if (!z10) {
            this.h.a(this.f39106e, true);
            this.f39108n.a(this.f39107f, true);
        }
        invalidate();
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        Paint paint3 = this.f39104b;
        if (i12 != 0) {
            paint3.setColor(this.f39103a);
            int a2 = this.h.a(this.f39106e, false);
            int a10 = this.f39108n.a(this.f39107f, false);
            org.telegram.ui.Components.dh0 dh0Var = profileActivity.f33885a0;
            if (dh0Var != null) {
                int i13 = this.H;
                boolean z10 = this.f39105c;
            ...
            RadialGradient radialGradient = this.f39113y;
            Paint paint4 = this.F;
            if (radialGradient == null || this.f39109r != a2 || this.f39110s != a10 || this.v != width) {
                this.f39111w = AndroidUtilities.dp(96.0f) * 2;
                ...
                this.f39112x = kVar3.getTranslationY() + ((org.telegram.ui.ActionBar.k.getCurrentActionBarHeight() + i11) - (AndroidUtilities.density * 21.0f));
                this.v = width;
                float f13 = this.f39112x;
                float f14 = this.f39111w;
                this.f39110s = a10;
                this.f39109r = a2;
                ...
                this.f39113y = radialGradient2;
                radialGradient2.setLocalMatrix(this.E);
                paint4.setShader(this.f39113y);
            }
            ...
            float e7 = this.d.e(this.f39105c) * f7;
            if (e7 < 1.0f) {
                paint2 = paint3;
            ...
            if (this.K) {
                ...
                if (!z11) {
                    if (o5Var != null) {
                        ...
                        if ((drawable instanceof org.telegram.ui.Components.q5) && (y3Var = ((org.telegram.ui.Components.q5) drawable).f29612k) != null && y3Var.hasImageLoaded()) {
                            this.L = true;
                        }
                    }
                    z12 = false;
                ...
                if ((!profileActivity.G1 || profileActivity.J1 != 2) && e10 > 0.0f && profileActivity.Y != null) {
                    ...
                    canvas2.restore();
                    chVar = profileActivity.f33935g5;
        ...
        if (i12 != f12 && !profileActivity.G1) {
            paint.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20691d6, profileActivity.f34059z0));
            this.M.set(0, i12, getMeasuredWidth(), (int) f12);
            profileActivity.f33973m5.J(canvas2, getY(), this.M, paint, true);
        }
    }
    ...
    public final void setBackgroundColor(int i10) {
        if (i10 != this.f39103a) {
            this.f39103a = i10;
            this.f39104b.setColor(i10);
            invalidate();
            if (!this.f39105c) {
                this.N.f33901c1 = this.f39103a;
            }
        }
    }
}
