...
public final class te0 implements Runnable {
    public final int f40724a = 0;
    public final xe0 f40725b;
    public final TLRPC.TL_error f40726c;
    public final Bundle d;
    public final TLObject f40727e;

    public te0(xe0 xe0Var, TLObject tLObject, Bundle bundle, TLRPC.TL_error tL_error) {
        this.f40725b = xe0Var;
        this.f40727e = tLObject;
        this.d = bundle;
        this.f40726c = tL_error;
    }
    ...
    public final void run() {
        ...
        switch (this.f40724a) {
            case 0:
                xe0 xe0Var = this.f40725b;
                wg0 wg0Var = xe0Var.f42701a0;
                xe0Var.M = false;
                xe0Var.v.invalidate();
                TLObject tLObject = this.f40727e;
                if (tLObject != null) {
                ...
                TLRPC.TL_error tL_error = this.f40726c;
                ...
                return;
            default:
                xe0 xe0Var2 = this.f40725b;
                wg0 wg0Var2 = xe0Var2.f42701a0;
                xe0Var2.R = false;
                TLRPC.TL_error tL_error2 = this.f40726c;
                if (tL_error2 == null) {
                    wg0Var2.g1(this.d, (TLRPC.TL_auth_sentCode) this.f40727e, true);
                } else {
