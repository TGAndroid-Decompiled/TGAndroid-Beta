...
public final class m11 extends org.telegram.ui.ActionBar.j {
    ...
    public final void b(int i10) {
        ...
        int i16;
        int i17;
        p11 p11Var = this.f35125b;
        long j3 = p11Var.f36002f;
        long j10 = p11Var.e;
        String str = this.f35124a;
        if (i10 == -1) {
            if (!p11Var.h && p11Var.f36003n) {
            ...
            if (p11Var.f36004r != null) {
                ?? obj = new Object();
                obj.d = j10;
                obj.f35547b = true;
                int c10 = org.telegram.messenger.z0.c("notify2_", str, notificationsSettings, 0);
                obj.f35548c = c10;
                if (c10 != 0) {
                    obj.f35546a = org.telegram.messenger.z0.c("notifyuntil_", str, notificationsSettings, 0);
                }
                p11Var.f36004r.v(obj);
            }
        }
