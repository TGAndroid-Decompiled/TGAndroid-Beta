...
public final class w60 implements Runnable {
    ...
    public final void run() {
        ...
        switch (this.f38885a) {
            case 0:
                x60 x60Var = this.f38886b;
                String str2 = this.f38887c;
                x60Var.getClass();
                AndroidUtilities.runOnUIThread(new w60(x60Var, str2, 1));
                return;
            case 1:
                x60 x60Var2 = this.f38886b;
                String str3 = this.f38887c;
                gg.c2 c2Var = x60Var2.f39826f;
                ...
                return;
            default:
                x60 x60Var3 = this.f38886b;
                String str4 = this.f38887c;
                ArrayList arrayList2 = x60Var3.f39828r;
