...
public class yd extends LinearLayout {
    public static float f43107b = 1.0f;
        ...
        switch (this.f43108a) {
            case 4:
                if (getParent() instanceof org.telegram.ui.Components.zn0) {
                    ...
                    canvas.save();
                    LinearLayout linearLayout = zn0Var.f33217b;
                    Path path = zn0Var.f33221n;
                    if (view != null && org.telegram.ui.Components.zn0.e(view)) {
                        ...
                        if (!z10 && !z11) {
                            ...
                            path.rewind();
                            path.addRoundRect(rectF, zn0Var.f33219e, Path.Direction.CW);
                            canvas.clipPath(path);
                        }
                    }
