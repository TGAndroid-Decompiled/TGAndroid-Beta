...
class RichBlockInset {
        ...
        if (z && z2 && (i = this.currentPx) != iInsetFor) {
            ...
            valueAnimatorOfInt.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                    RichBlockInset.m4910$r8$lambda$KfrOuEFUlBLg4raSGcYPQEdYY(this.f$0, applier, valueAnimator2);
                }
            });
    ...
    public static void m4910$r8$lambda$KfrOuEFUlBLg4raSGcYPQEdYY(RichBlockInset richBlockInset, Applier applier, ValueAnimator valueAnimator) {
