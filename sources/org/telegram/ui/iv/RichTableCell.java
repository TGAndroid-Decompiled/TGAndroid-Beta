...
public class RichTableCell extends RichBlockCell implements Theme.Colorable, TextSelectionHelper.ArticleSelectableView {
    ...
    public RichTableCell(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        richEditText.setDelegate(new EditTextCaption.EditTextCaptionDelegate() {
            ...
            public final void onSpansChanged() {
                RichTableCell.m5016$r8$lambda$Su1cqipSUeadHDEPTbqvFgQHo(this.f$0);
            }
        });
    ...
    public static void m5016$r8$lambda$Su1cqipSUeadHDEPTbqvFgQHo(RichTableCell richTableCell) {
        BlockRow blockRow;
    ...
    private void focusCellAt(int i, int i2) {
        ...
        post(new Runnable() {
            @Override
            public final void run() {
                RichTableCell.m5015$r8$lambda$OiBw7tU0oyPrRYM2QMmv9Rm2Nc(this.f$0, pagetablecell);
            }
        });
    }

    public static void m5015$r8$lambda$OiBw7tU0oyPrRYM2QMmv9Rm2Nc(RichTableCell richTableCell, TL_iv.pageTableCell pagetablecell) {
        ...
        public void onSelectionChanged(final RichEditText richEditText, final int i, final int i2) {
            ...
            if (!(selectionHelper.isInSelectionMode() && selectionHelper.getSelectedCell() == RichTableCell.this) && (iChildPosForAnchor = RichTableCell.this.childPosForAnchor(this.val$host.cell)) >= 0) {
                RichTableCell.this.post(new Runnable() {
                    @Override
                    public final void run() {
                        RichTableCell.AnonymousClass3.m5017$r8$lambda$h4CWbDdD6LfyxuGhoQxoD0zeLU(this.f$0, richEditText, i2, selectionHelper, iChildPosForAnchor, i);
                    }
                });
            }
        }

        public static void m5017$r8$lambda$h4CWbDdD6LfyxuGhoQxoD0zeLU(AnonymousClass3 anonymousClass3, RichEditText richEditText, int i, TextSelectionHelper.ArticleTextSelectionHelper articleTextSelectionHelper, int i2, int i3) {
