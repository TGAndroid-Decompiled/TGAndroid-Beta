...
public class RichEditorToolbar extends FrameLayout {
    ...
    public RichEditorToolbar(Context context, final Delegate delegate) {
        ...
        imageView.setBackground(RichEditor.withShadow(Theme.createRadSelectorDrawable(iColor, Theme.blendOver(iColor2, color(i2)), AndroidUtilities.dp(22.0f), AndroidUtilities.dp(22.0f))));
        int i3 = Theme.key_windowBackgroundWhiteBlackText;
        int iColor3 = color(i3);
    ...
    private RichEditor.Button addBlockButton(int i, final int i2) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public final void onClick(View view) {
                this.f$0.lambda$addBlockButton$11(i2, view);
            }
        });
    ...
    public void lambda$addBlockButton$11(int i, View view) {
    ...
    private void addFormattingButton(int i, final int i2) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public final void onClick(View view) {
                this.f$0.lambda$addFormattingButton$12(i2, view);
            }
        });
    ...
    public void lambda$addFormattingButton$12(int i, View view) {
        ...
        if (z) {
            ...
            duration.setInterpolator(cubicBezierInterpolator).withEndAction(new Runnable() {
                ...
                public final void run() {
                    this.f$0.lambda$updatePanel$13();
                }
            }).start();
    ...
    public void lambda$updatePanel$13() {
        if (this.panelType != 0) {
