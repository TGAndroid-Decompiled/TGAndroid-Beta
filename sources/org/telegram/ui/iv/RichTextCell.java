...
public class RichTextCell extends FrameLayout implements Theme.Colorable, TextSelectionHelper.ArticleSelectableView {
    ...
    public static boolean m5012$r8$lambda$WlQ74KoGXP_hHDx2kZV7wXg4E(View view) {
        return true;
    }
    ...
    public RichTextCell(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        checkBoxView.setOnClickListener(new View.OnClickListener() {
            ...
            public final void onClick(View view2) {
                RichTextCell.$r8$lambda$U7eQEHmaQrnR5CUYTmeiyCDDKFg(this.f$0, view2);
            }
        });
        ...
        richEditText.setDelegate(new EditTextCaption.EditTextCaptionDelegate() {
            ...
            public final void onSpansChanged() {
                RichTextCell.m5010$r8$lambda$1qBBSSV3_qXnIgzIL2cb3Mc29A(this.f$0);
            }
        });
        richEditText.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            @Override
            public final void onFocusChange(View view2, boolean z) {
                RichTextCell.m5009$r8$lambda$1TBRaFPPPdYKleX2ap9DhIQwMA(this.f$0, view2, z);
            }
        });
        ...
        richEditText2.setDelegate(new EditTextCaption.EditTextCaptionDelegate() {
            @Override
            public final void onSpansChanged() {
                RichTextCell.m5008$r8$lambda$1P8uujXIyJbbJWccL0VJp2Sb0Q(this.f$0);
            }
        });
    ...
    public static void $r8$lambda$U7eQEHmaQrnR5CUYTmeiyCDDKFg(RichTextCell richTextCell, View view) {
    ...
    class AnonymousClass2 implements RichEditText.Listener {
        ...
        public void onTextChanged(RichEditText richEditText, Editable editable) {
            ...
            if (iMatchMarkdownCommand == 0 || RichTextCell.this.delegate == null) {
                ...
                if (transformMatchMarkdownTrigger != null && RichTextCell.this.delegate != null) {
                    ...
                    RichTextCell.this.post(new Runnable() {
                        ...
                        public final void run() {
                            RichTextCell.AnonymousClass2.$r8$lambda$1SW3xSW4Il9o2aX501GGHrGXVw4(this.f$0, blockRow, transformMatchMarkdownTrigger);
                        }
                    });
                }
            } else {
                ...
                RichTextCell.this.post(new Runnable() {
                    @Override
                    public final void run() {
                        RichTextCell.AnonymousClass2.$r8$lambda$JKi_yu6ffjr_EOlKylbPYr0cYsw(this.f$0, blockRow2, iMatchMarkdownCommand);
                    }
                });
            }
        ...
        public static void $r8$lambda$JKi_yu6ffjr_EOlKylbPYr0cYsw(AnonymousClass2 anonymousClass2, BlockRow blockRow, int i) {
            if (RichTextCell.this.delegate == null) {
                return;
            }
        ...
        public static void $r8$lambda$1SW3xSW4Il9o2aX501GGHrGXVw4(AnonymousClass2 anonymousClass2, BlockRow blockRow, Transform transform) {
            if (RichTextCell.this.delegate != null) {
        ...
        public void onSelectionChanged(final RichEditText richEditText, final int i, final int i2) {
            ...
            RichTextCell.this.post(new Runnable() {
                @Override
                public final void run() {
                    RichTextCell.AnonymousClass2.m5014$r8$lambda$7fSgMRis17tacghQ4AXXetFGrQ(this.f$0, richEditText, i2, selectionHelper, i);
                }
            });
        }

        public static void m5014$r8$lambda$7fSgMRis17tacghQ4AXXetFGrQ(AnonymousClass2 anonymousClass2, RichEditText richEditText, int i, TextSelectionHelper.ArticleTextSelectionHelper articleTextSelectionHelper, int i2) {
    ...
    public static void m5010$r8$lambda$1qBBSSV3_qXnIgzIL2cb3Mc29A(RichTextCell richTextCell) {
    ...
    public static void m5009$r8$lambda$1TBRaFPPPdYKleX2ap9DhIQwMA(RichTextCell richTextCell, View view, boolean z) {
        Delegate delegate;
    ...
    class AnonymousClass3 implements RichEditText.Listener {
        ...
        public void onSelectionChanged(final RichEditText richEditText, final int i, final int i2) {
            ...
            richEditText.post(new Runnable() {
                @Override
                public final void run() {
                    RichTextCell.AnonymousClass3.$r8$lambda$A8TXYECEK3UQ83hDcoC5GleM_ZQ(this.f$0, richEditText, i2, selectionHelper, i);
                }
            });
        }

        public static void $r8$lambda$A8TXYECEK3UQ83hDcoC5GleM_ZQ(AnonymousClass3 anonymousClass3, RichEditText richEditText, int i, TextSelectionHelper.ArticleTextSelectionHelper articleTextSelectionHelper, int i2) {
    ...
    public static void m5008$r8$lambda$1P8uujXIyJbbJWccL0VJp2Sb0Q(RichTextCell richTextCell) {
        ...
        if (this.languageButton == null) {
            ...
            this.languageButton.setOnClickListener(new View.OnClickListener() {
                ...
                public final void onClick(View view) {
                    RichTextCell.m5011$r8$lambda$2QlZutym7cGe1oz0jmQj5jFuM(this.f$0, view);
                }
            });
            this.languageButton.setOnLongClickListener(new View.OnLongClickListener() {
                @Override
                public final boolean onLongClick(View view) {
                    return RichTextCell.m5012$r8$lambda$WlQ74KoGXP_hHDx2kZV7wXg4E(view);
                }
            });
        }
    ...
    public static void m5011$r8$lambda$2QlZutym7cGe1oz0jmQj5jFuM(RichTextCell richTextCell, View view) {
        Delegate delegate = richTextCell.delegate;
        if (delegate != null) {
        ...
        if (isHighlightableCode()) {
            ...
            CodeHighlighting.highlightEditable(string, str, new Utilities.Callback() {
                ...
                public final void run(Object obj) {
                    RichTextCell.m5013$r8$lambda$fV9Ed2lV2VkAyDNniN_pHhE9Ok(this.f$0, i, blockRow, string, (SpannableString) obj);
                }
            });
        }
    }

    public static void m5013$r8$lambda$fV9Ed2lV2VkAyDNniN_pHhE9Ok(RichTextCell richTextCell, int i, BlockRow blockRow, String str, SpannableString spannableString) {
    ...
    public void focusAuthorFromBody() {
        ...
        this.authorEditText.post(new Runnable() {
            @Override
            public final void run() {
                RichTextCell.$r8$lambda$doAVWkhRczp1kiWU1UAXwRXBqwM(this.f$0, fCaretX);
            }
        });
    }

    public static void $r8$lambda$doAVWkhRczp1kiWU1UAXwRXBqwM(RichTextCell richTextCell, float f) {
    ...
    public void focusBodyFromAuthor() {
        ...
        this.editText.post(new Runnable() {
            @Override
            public final void run() {
                RichTextCell.$r8$lambda$FzB43jT4_VUBdGFSkdN4CwEkUvk(this.f$0, fCaretX);
            }
        });
    }

    public static void $r8$lambda$FzB43jT4_VUBdGFSkdN4CwEkUvk(RichTextCell richTextCell, float f) {
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (this.showCommandBackground) {
            ...
            if (width4 < fMax2 && height2 < fMax3) {
                ...
                canvas3.drawRoundRect(fDp5, fDp4, fDp6, fDp7, AndroidUtilities.dp(4.0f), AndroidUtilities.dp(4.0f), this.bgPaint);
                canvas2 = canvas3;
            }
        }
        Delegate delegate = this.delegate;
