...
public final class ua0 implements MessagesController.MessagesLoadedCallback {
    public final n80 f38379a;
    public final String f38380b;
    public final org.telegram.ui.ActionBar.m2 f38381c;
    public final long d;
    public final Integer e;
    public final Bundle f38382f;
    public final LaunchActivity f38383g;
    ...
    public final void onError() {
        LaunchActivity launchActivity = this.f38383g;
    ...
    public final void onMessagesLoaded(boolean z10) {
        ...
        if (!launchActivity.isFinishing()) {
            ...
            long j3 = this.d;
            org.telegram.ui.ActionBar.m2 m2Var = this.f38381c;
            if (str == null || !(m2Var instanceof wn) || ((wn) m2Var).a() != j3) {
                if (m2Var instanceof wn) {
                    wn wnVar = (wn) m2Var;
                    if (wnVar.a() == j3 && this.e == null) {
                        AndroidUtilities.shakeViewSpring(wnVar.f39694x0, 5.0f);
                ...
                m2Var = new wn(this.f38382f);
                ((ActionBarLayout) launchActivity.O()).P(m2Var);
            }
            AndroidUtilities.runOnUIThread(new org.telegram.ui.Components.x21(this, this.f38380b, this.d, m2Var, 4), 150L);
        }
    }
}
