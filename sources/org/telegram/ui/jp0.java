...
public final class jp0 extends org.telegram.ui.Components.i51 {
    public static final int f34922a = 0;
    ...
    public final void bindView(View view, org.telegram.ui.Components.j51 j51Var, boolean z10, org.telegram.ui.Components.x51 x51Var, org.telegram.ui.Components.f61 f61Var) {
        ...
        kp0Var.f35351a = savedStarGift.gift.f18346id;
        kp0Var.setPadding(0, 0, 0, 0);
        kp0Var.c(savedStarGift.gift.getDocument(), savedStarGift.gift);
        kp0Var.f35352b = (TL_stars.starGiftAttributeBackdrop) yh.v5.l(savedStarGift.gift.attributes, TL_stars.starGiftAttributeBackdrop.class);
        kp0Var.f35353c = (TL_stars.starGiftAttributePattern) yh.v5.l(savedStarGift.gift.attributes, TL_stars.starGiftAttributePattern.class);
        e1Var.d(kp0Var.f35352b);
        e1Var.e(kp0Var.f35353c);
        if (j1Var != null) {
            j1Var.setBackdrop(kp0Var.f35352b);
            String k10 = hg.k0.k(savedStarGift.gift.num, ',', new StringBuilder("#"));
            j1Var.f45970b = k10;
            j1Var.f45969a.e(9, k10, false);
        }
