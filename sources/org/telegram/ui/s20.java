...
public class s20 extends org.telegram.ui.Components.mc0 {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        q20 q20Var = t20Var.f37635y;
        int i11 = 0;
        if (!t20Var.f37629f) {
            if (t20Var.h) {
                float f10 = t20Var.f37630n + 0.016f;
                t20Var.f37630n = f10;
                if (f10 > 3.0f) {
                    t20Var.h = false;
                }
            } else {
                float f11 = t20Var.f37630n - 0.016f;
                t20Var.f37630n = f11;
                if (f11 < 1.0f) {
                    t20Var.h = true;
                }
        ...
        float f12 = 1.0f - ((t20Var.f37631r - dp) / (t20Var.J - dp));
        t20Var.v = f12;
        float f13 = 0.0f;
        ...
        if (t20Var.f37631r < dp2) {
            t20Var.f37631r = dp2;
        }
        float f14 = t20Var.f37634x;
        t20Var.f37634x = 0.0f;
        if (t20Var.f37631r < AndroidUtilities.dp(30.0f) + dp2) {
            t20Var.f37634x = ((AndroidUtilities.dp(30.0f) + dp2) - t20Var.f37631r) / AndroidUtilities.dp(30.0f);
        }
        if (t20Var.H) {
            t20Var.f37634x = 1.0f;
            t20Var.v = 1.0f;
        }
        if (f14 != t20Var.f37634x) {
            t20Var.f37628c.invalidate();
        }
        int i12 = t20Var.f37631r;
        ...
        TextView textView = (TextView) q20Var.f36784b;
        ...
        ((org.telegram.ui.Components.c90) q20Var.f36785c).setAlpha(f16);
        ...
        t20Var.f37626a.d(0, (-getMeasuredWidth()) * 0.1f * t20Var.f37630n, 0, getMeasuredWidth(), 0.0f, getMeasuredHeight());
        if (t20Var.M) {
            int themedColor = t20Var.getThemedColor(org.telegram.ui.ActionBar.j6.f18807a7);
            Paint paint2 = this.G0;
            paint2.setColor(themedColor);
            canvas.drawRect(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight(), paint2);
        } else {
            canvas.drawRect(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight(), t20Var.f37626a.f42583f);
        }
        int themedColor2 = t20Var.getThemedColor(org.telegram.ui.ActionBar.j6.f18970j5);
        if (t20Var.M) {
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        org.telegram.ui.Components.c90 c90Var = (org.telegram.ui.Components.c90) q20Var.f36785c;
        ...
        if ((!rectF2.contains(motionEvent.getX(), motionEvent.getY()) && !this.D0) || t20Var.f37628c.K1 || (layout = c90Var.getLayout()) == null) {
            f7 = 1.0f;
        } else {
            ...
            if (text instanceof Spanned) {
                ...
                if (clickableSpanArr != null && clickableSpanArr.length > 0 && t20Var.f37634x < 1.0f) {
        ...
        if ((rectF2.contains(motionEvent.getX(), motionEvent.getY()) || this.C0) && !t20Var.f37628c.K1 && isClickable && t20Var.f37634x < f7) {
        ...
        if ((rectF2.contains(motionEvent.getX(), motionEvent.getY()) || this.E0) && !t20Var.f37628c.K1 && t20Var.f37634x < f7) {
