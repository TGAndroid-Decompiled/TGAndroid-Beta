...
public final class my0 implements Runnable {
    ...
    public final ProfileActivity f35839b;
    public final TLRPC.TL_error f35840c;
    ...
    public my0(ProfileActivity profileActivity, TLRPC.TL_error tL_error, TLObject tLObject, TLRPC.TL_channels_getParticipants tL_channels_getParticipants, int i10) {
        this.f35838a = i10;
        this.f35839b = profileActivity;
        this.f35840c = tL_error;
        this.d = tLObject;
    ...
    public final void run() {
        switch (this.f35838a) {
            case 0:
                ProfileActivity profileActivity = this.f35839b;
                profileActivity.getNotificationCenter().doOnIdle(new my0(profileActivity, this.f35840c, this.d, this.e, 1));
                return;
            default:
                ProfileActivity profileActivity2 = this.f35839b;
                if (this.f35840c == null) {
                    ...
                    if (this.e.offset == 0) {
                        ...
                        profileActivity2.f31380u2.participants = new TLRPC.TL_chatParticipants();
                        ...
                        profileActivity2.getMessagesStorage().updateChannelUsers(profileActivity2.f31277f1, tL_channels_channelParticipants.participants);
                    }
                    for (int i10 = 0; i10 < tL_channels_channelParticipants.participants.size(); i10++) {
                        ...
                        if (profileActivity2.C1.h(peerId) < 0) {
                            TLRPC.ChatFull chatFull = profileActivity2.f31380u2;
                            if (chatFull.participants == null) {
                                chatFull.participants = new TLRPC.TL_chatParticipants();
                            }
                            profileActivity2.f31380u2.participants.participants.add(tL_chatChannelParticipant);
