...
public final class be1 implements TextWatcher {
    ...
    public final void afterTextChanged(Editable editable) {
        ce1 ce1Var = this.f32393a;
        if (ce1Var.I) {
            return;
        }
        if (ce1Var.f32721a.length() > 0) {
            String str = "https://" + ce1Var.getMessagesController().linkPrefix + "/addtheme/" + ((Object) ce1Var.f32721a.getText());
    ...
    public final void onTextChanged(CharSequence charSequence, int i10, int i11, int i12) {
        ...
        ce1Var.Z(ce1Var.f32721a.getText().toString(), false);
    }
