...
public final class wy extends View implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final Paint f39404b;
    public final int f39405c;
    public final ArrayList d;
    public float e;
    public float f39406f;
    public float h;
    public final ImageReceiver f39407n;
    public final ImageReceiver f39408r;
    public final org.telegram.ui.Components.xi0 f39409s;
    public final org.telegram.ui.Components.xi0 v;
    public boolean f39410w;
    public int f39411x;
    public boolean f39412y;

    public wy(Context context, int i10) {
        super(context);
        this.f39403a = new Paint(1);
        this.f39404b = new Paint(1);
        this.d = new ArrayList();
        ImageReceiver imageReceiver = new ImageReceiver(this);
        this.f39407n = imageReceiver;
        ImageReceiver imageReceiver2 = new ImageReceiver(this);
        this.f39408r = imageReceiver2;
        this.f39405c = i10;
    ...
    public final void a() {
        ...
        this.f39409s.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.i6.w0(null, i10, false), PorterDuff.Mode.SRC_IN));
    ...
    public final void b() {
        ...
        while (true) {
            ...
            hashMap.put(((vy) arrayList.get(i11)).f38708c, (vy) arrayList.get(i11));
        ...
        if (arrayList.size() == 0 && !this.f39412y) {
    ...
    public final void c() {
        MessagesStorage.getInstance(this.f39405c);
        int i10 = 0;
        long j3 = 0;
        long j10 = 0;
        while (true) {
            ...
            j3 += ((vy) arrayList.get(i10)).f38706a;
            j10 += ((vy) arrayList.get(i10)).f38707b;
            i10++;
        }
        if (j3 == 0) {
            this.e = 1.0f;
        ...
        this.h = ((this.e - this.f39406f) * 16.0f) / 150.0f;
        invalidate();
    }
    ...
    public final void onAttachedToWindow() {
        ...
        b();
        NotificationCenter.getInstance(this.f39405c).addObserver(this, NotificationCenter.onDownloadingFilesChanged);
        this.f39407n.onAttachedToWindow();
        this.f39408r.onAttachedToWindow();
    }
    ...
    public final void onDetachedFromWindow() {
        ...
        while (true) {
            ...
            if (i10 < size) {
                ...
                this.f39407n.onDetachedFromWindow();
                this.f39408r.onDetachedFromWindow();
                return;
            }
        }
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (getAlpha() != 0.0f) {
            ...
            ImageReceiver imageReceiver = this.f39408r;
            ImageReceiver imageReceiver2 = this.f39407n;
            Paint paint = this.f39403a;
            Paint paint2 = this.f39404b;
            if (i10 != w02) {
                this.f39411x = org.telegram.ui.ActionBar.i6.w0(null, i11, false);
            ...
            rectF.set(dp3, f13, ((getMeasuredWidth() - (2.0f * dp3)) * this.f39406f) + dp3, f14);
            ...
            if (this.e == 1.0f && !this.f39410w && this.f39409s.f29948b0 == 0) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        float f7 = dp;
        this.f39407n.setImageCoords(f7, f7, getMeasuredWidth() - i12, getMeasuredHeight() - i12);
        this.f39408r.setImageCoords(f7, f7, getMeasuredWidth() - i12, getMeasuredHeight() - (dp * 2));
    }
