...
public final class wy extends View implements NotificationCenter.NotificationCenterDelegate {
    public final Paint f39399a;
    public final Paint f39400b;
    public final int f39401c;
    public final ArrayList d;
    public float e;
    public float f39402f;
    public float h;
    public final ImageReceiver f39403n;
    public final ImageReceiver f39404r;
    public final org.telegram.ui.Components.xi0 f39405s;
    public final org.telegram.ui.Components.xi0 v;
    public boolean f39406w;
    public int f39407x;
    public boolean f39408y;

    public wy(Context context, int i10) {
        super(context);
        this.f39399a = new Paint(1);
        this.f39400b = new Paint(1);
        this.d = new ArrayList();
        ImageReceiver imageReceiver = new ImageReceiver(this);
        this.f39403n = imageReceiver;
        ImageReceiver imageReceiver2 = new ImageReceiver(this);
        this.f39404r = imageReceiver2;
        this.f39401c = i10;
    ...
    public final void a() {
        ...
        this.f39405s.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.i6.w0(null, i10, false), PorterDuff.Mode.SRC_IN));
    ...
    public final void b() {
        ...
        while (true) {
            ...
            hashMap.put(((vy) arrayList.get(i11)).f38644c, (vy) arrayList.get(i11));
        ...
        if (arrayList.size() == 0 && !this.f39408y) {
    ...
    public final void c() {
        MessagesStorage.getInstance(this.f39401c);
        int i10 = 0;
        long j3 = 0;
        long j10 = 0;
        while (true) {
            ...
            j3 += ((vy) arrayList.get(i10)).f38642a;
            j10 += ((vy) arrayList.get(i10)).f38643b;
            i10++;
        }
        if (j3 == 0) {
            this.e = 1.0f;
        ...
        this.h = ((this.e - this.f39402f) * 16.0f) / 150.0f;
        invalidate();
    }
    ...
    public final void onAttachedToWindow() {
        ...
        b();
        NotificationCenter.getInstance(this.f39401c).addObserver(this, NotificationCenter.onDownloadingFilesChanged);
        this.f39403n.onAttachedToWindow();
        this.f39404r.onAttachedToWindow();
    }
    ...
    public final void onDetachedFromWindow() {
        ...
        while (true) {
            ...
            if (i10 < size) {
                ...
                this.f39403n.onDetachedFromWindow();
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (getAlpha() != 0.0f) {
            ...
            ImageReceiver imageReceiver2 = this.f39403n;
            Paint paint = this.f39399a;
            Paint paint2 = this.f39400b;
            if (i10 != w02) {
                this.f39407x = org.telegram.ui.ActionBar.i6.w0(null, i11, false);
            ...
            rectF.set(dp3, f13, ((getMeasuredWidth() - (2.0f * dp3)) * this.f39402f) + dp3, f14);
            ...
            if (this.e == 1.0f && !this.f39406w && this.f39405s.f29943a0 == 0) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        float f7 = dp;
        this.f39403n.setImageCoords(f7, f7, getMeasuredWidth() - i12, getMeasuredHeight() - i12);
        this.f39404r.setImageCoords(f7, f7, getMeasuredWidth() - i12, getMeasuredHeight() - (dp * 2));
    }
