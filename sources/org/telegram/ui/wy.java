...
public final class wy extends View implements NotificationCenter.NotificationCenterDelegate {
    public final Paint f39267a;
    public final Paint f39268b;
    public final int f39269c;
    public final ArrayList d;
    public float e;
    public float f39270f;
    public float h;
    public final ImageReceiver f39271n;
    public final ImageReceiver f39272r;
    public final org.telegram.ui.Components.ij0 f39273s;
    public final org.telegram.ui.Components.ij0 v;
    public boolean f39274w;
    public int f39275x;
    public boolean f39276y;

    public wy(Context context, int i10) {
        super(context);
        this.f39267a = new Paint(1);
        this.f39268b = new Paint(1);
        this.d = new ArrayList();
        ImageReceiver imageReceiver = new ImageReceiver(this);
        this.f39271n = imageReceiver;
        ImageReceiver imageReceiver2 = new ImageReceiver(this);
        this.f39272r = imageReceiver2;
        this.f39269c = i10;
    ...
    public final void a() {
        ...
        this.f39273s.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.w0(null, i10, false), PorterDuff.Mode.SRC_IN));
    ...
    public final void b() {
        ...
        while (true) {
            ...
            hashMap.put(((vy) arrayList.get(i11)).f38632c, (vy) arrayList.get(i11));
        ...
        if (arrayList.size() == 0 && !this.f39276y) {
    ...
    public final void c() {
        MessagesStorage.getInstance(this.f39269c);
        int i10 = 0;
        long j3 = 0;
        long j10 = 0;
        while (true) {
            ...
            j3 += ((vy) arrayList.get(i10)).f38630a;
            j10 += ((vy) arrayList.get(i10)).f38631b;
            i10++;
        }
        if (j3 == 0) {
            this.e = 1.0f;
        ...
        this.h = ((this.e - this.f39270f) * 16.0f) / 150.0f;
        invalidate();
    }
    ...
    public final void onAttachedToWindow() {
        ...
        b();
        NotificationCenter.getInstance(this.f39269c).addObserver(this, NotificationCenter.onDownloadingFilesChanged);
        this.f39271n.onAttachedToWindow();
        this.f39272r.onAttachedToWindow();
    }
    ...
    public final void onDetachedFromWindow() {
        ...
        while (true) {
            ...
            if (i10 < size) {
                ...
                this.f39271n.onDetachedFromWindow();
                this.f39272r.onDetachedFromWindow();
                return;
            }
        }
    }
    ...
    public final void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        if (getAlpha() != 0.0f) {
            int i10 = this.f39275x;
            int i11 = org.telegram.ui.ActionBar.j6.f19395v8;
            int w02 = org.telegram.ui.ActionBar.j6.w0(null, i11, false);
            ImageReceiver imageReceiver = this.f39272r;
            ImageReceiver imageReceiver2 = this.f39271n;
            Paint paint = this.f39267a;
            Paint paint2 = this.f39268b;
            if (i10 != w02) {
                this.f39275x = org.telegram.ui.ActionBar.j6.w0(null, i11, false);
            ...
            rectF.set(dp3, f13, ((getMeasuredWidth() - (2.0f * dp3)) * this.f39270f) + dp3, f14);
            ...
            if (this.e == 1.0f && !this.f39274w && this.f39273s.f24972a0 == 0) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        float f7 = dp;
        this.f39271n.setImageCoords(f7, f7, getMeasuredWidth() - i12, getMeasuredHeight() - i12);
        this.f39272r.setImageCoords(f7, f7, getMeasuredWidth() - i12, getMeasuredHeight() - (dp * 2));
    }
