...
public final class wh1 extends org.telegram.ui.Components.tk0 {
    public final Context f39228c;
    public final gg.c2 f39229f;
    public Runnable h;
    public boolean f39230n;
    public final int f39232s;
    public final UsersSelectActivity v;
    public ArrayList d = new ArrayList();
    public ArrayList e = new ArrayList();
    public final ArrayList f39231r = new ArrayList();
    ...
    public wh1(UsersSelectActivity usersSelectActivity, Context context) {
        ...
        if (usersSelectActivity.F) {
            ...
            int i10 = usersSelectActivity.f31616x;
            if (i10 == 2) {
                this.f39232s = (!usersSelectActivity.H ? 1 : 0) + 5;
            } else if (i10 == 0) {
        ...
        int i11 = usersSelectActivity.f31616x;
        if (i11 != 2) {
            z10 = true;
        } else {
            z10 = false;
        ...
        for (int i12 = 0; i12 < size; i12++) {
            ...
            if (!DialogObject.isEncryptedDialog(dialog.f18116id)) {
                if (DialogObject.isUserDialog(dialog.f18116id)) {
                    TLRPC.User user = usersSelectActivity.getMessagesController().getUser(Long.valueOf(dialog.f18116id));
                    if (user != null && ((usersSelectActivity.G || !UserObject.isUserSelf(user)) && (!user.bot || z10))) {
                        this.f39231r.add(user);
                        if (UserObject.isUserSelf(user)) {
                            z12 = true;
                        }
                    }
                } else {
                    TLRPC.Chat chat = usersSelectActivity.getMessagesController().getChat(Long.valueOf(-dialog.f18116id));
                    if (z11 && chat != null) {
                        this.f39231r.add(chat);
                    }
                }
            }
        }
        if (!z12 && usersSelectActivity.G) {
            this.f39231r.add(0, usersSelectActivity.getMessagesController().getUser(Long.valueOf(usersSelectActivity.getUserConfig().clientUserId)));
        }
        gg.c2 c2Var = new gg.c2(false);
        this.f39229f = c2Var;
        c2Var.f9697p = false;
        c2Var.f9685a = new tl0(this, 26);
    }
    ...
    public final void A(s4.c1 c1Var) {
        ...
        if (view instanceof org.telegram.ui.Cells.f4) {
            ((org.telegram.ui.Cells.f4) view).f20071a.getImageReceiver().cancelLoadImage();
        }
    }
    ...
    public final void L(String str) {
        ...
        if (str == null) {
            this.d.clear();
            this.e.clear();
            this.f39229f.f(null, null);
            this.f39229f.g(null, true, false, false, false, 0L, false, 0, 0);
            l();
            return;
        }
    ...
    public final int j(int i10) {
        ...
        if (!this.f39230n) {
            UsersSelectActivity usersSelectActivity = this.v;
            if (!usersSelectActivity.F ? !((i11 = usersSelectActivity.f31616x) != 2 ? i11 != 0 || (!usersSelectActivity.I ? !(i10 == 0 || i10 == 4) : !(i10 == 0 || i10 == 6)) : i10 != 0 && i10 != (!usersSelectActivity.H ? 1 : 0) + 4) : i10 == 0) {
                return 2;
            }
        }
        return 1;
