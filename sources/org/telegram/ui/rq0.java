...
public final class rq0 extends vu0 {
    ...
    @Override
    public final int H() {
        return this.f37293a.f32873b.size();
    }
    ...
    public final int Q(Object obj) {
        ...
        cr0 cr0Var = this.f37293a;
        if (!cr0Var.f32873b.containsKey(obj2)) {
            return -1;
        }
        cr0Var.f32873b.remove(obj2);
        int indexOf = cr0Var.f32875c.indexOf(obj2);
        if (indexOf >= 0) {
            cr0Var.f32875c.remove(indexOf);
        }
        if (cr0Var.e) {
            cr0Var.h0();
        }
    ...
    public final void W(int i10) {
        ...
        if (V != null) {
            ...
            V.e((MediaController.SearchImage) cr0Var.f32879f.get(i10));
        }
    }
    ...
    public final ArrayList c() {
        return this.f37293a.f32875c;
    }

    @Override
    public final ImageReceiver.BitmapHolder j(int i10) {
        org.telegram.ui.Cells.s5 V = cr0.V(this.f37293a, i10);
        if (V != null) {
    ...
    public final int k(int i10, VideoEditedInfo videoEditedInfo) {
        ...
        if (albumEntry != null) {
            ...
            if (Y == -1) {
                ...
                Y = cr0Var.f32875c.indexOf(Integer.valueOf(photoEntry.imageId));
                z10 = true;
            } else {
                photoEntry.editedInfo = null;
                z10 = false;
            }
        } else if (i10 < 0 || i10 >= cr0Var.f32879f.size()) {
            return -1;
        } else {
            MediaController.SearchImage searchImage = (MediaController.SearchImage) cr0Var.f32879f.get(i10);
            Y = cr0Var.Y(-1, searchImage);
            if (Y == -1) {
                searchImage.editedInfo = videoEditedInfo;
                Y = cr0Var.f32875c.indexOf(searchImage.f15607id);
                z10 = true;
            } else {
    ...
    public final void o(int i10, VideoEditedInfo videoEditedInfo, boolean z10, int i11, int i12, boolean z11) {
        cr0 cr0Var = this.f37293a;
        ArrayList arrayList = cr0Var.f32879f;
        MediaController.AlbumEntry albumEntry = cr0Var.J;
        if (cr0Var.f32873b.isEmpty()) {
            if (albumEntry != null) {
                if (i10 >= 0 && i10 < albumEntry.photos.size()) {
                    MediaController.PhotoEntry photoEntry = albumEntry.photos.get(i10);
                    photoEntry.editedInfo = videoEditedInfo;
    ...
    public final boolean x(int i10) {
        ...
        MediaController.AlbumEntry albumEntry = cr0Var.J;
        if (albumEntry != null) {
            if (i10 < 0 || i10 >= albumEntry.photos.size() || !cr0Var.f32873b.containsKey(Integer.valueOf(cr0Var.J.photos.get(i10).imageId))) {
                return false;
            }
            return true;
        } else if (i10 < 0 || i10 >= cr0Var.f32879f.size() || !cr0Var.f32873b.containsKey(((MediaController.SearchImage) cr0Var.f32879f.get(i10)).f15607id)) {
            return false;
        } else {
            return true;
        }
