...
public final class kx extends d41 {
    ...
    public kx(qy qyVar, Context context, jy jyVar, Context context2) {
        ...
        this.V = context2;
        this.e = 0.0f;
        this.f32913n = new AnimationNotificationsLocker();
        this.M = true;
    }
    ...
    public final void d(boolean z10) {
        py pyVar = this.T;
        pyVar.f36695c.G = true;
        pyVar.d.O(this.T.f36693a, c());
        py pyVar2 = this.T;
        pyVar2.d.G = false;
        pyVar2.G.G = false;
        qy qyVar = this.W;
        qyVar.A4(false, true);
        this.T.f36693a.setClipChildren(true);
        this.T.f36693a.invalidate();
        this.T.d.l();
        this.T.G.l();
        this.T.f36693a.y1(null, 0.0f, z10);
        qyVar.f37132y = false;
    ...
    public final void e(boolean z10) {
        ...
        this.T = pyVar;
        if (pyVar.F == null) {
            pyVar.F = new org.telegram.ui.Components.xl0(this.V, null);
            this.T.F.setLayoutManager(new jx(this, this.T));
            py pyVar2 = this.T;
            int i11 = this.T.f36699s;
            int i12 = qyVar.V2;
            boolean z11 = qyVar.f37068l2;
        ...
        py pyVar5 = this.T;
        gg.m mVar2 = pyVar5.G;
        mVar2.h = pyVar5.f36699s;
        mVar2.l();
        py pyVar6 = this.T;
        pyVar6.d.O(pyVar6.f36693a, false);
        py pyVar7 = this.T;
        pyVar7.d.G = true;
        pyVar7.G.G = true;
        pyVar7.f36695c.H = false;
        qyVar.A4(true, true);
        qyVar.c4(this.S);
        this.T.d.l();
        this.T.G.l();
        ...
        py pyVar8 = this.T;
        pyVar8.f36693a.y1(pyVar8.F, f7, false);
        this.T.f36693a.setClipChildren(false);
        this.T.f36693a.B0();
        qyVar.D3();
        qyVar.U4();
    }
    ...
    public final void setOpenProgress(float f7) {
        ...
        if (pyVar2 != null && (myVar = pyVar2.f36693a) != null) {
            myVar.requestLayout();
        }
