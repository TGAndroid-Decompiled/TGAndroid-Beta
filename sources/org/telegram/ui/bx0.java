...
public final class bx0 extends uw0 {
    public final int f32595r = 0;
    public final org.telegram.ui.Components.kl0 f32596s;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        switch (this.f32595r) {
            ...
            default:
                ...
                ImageView imageView2 = this.f38174c;
                rectF2.set(imageView2.getLeft(), imageView2.getTop(), imageView2.getRight(), imageView2.getBottom());
                rg.j1 j1Var = (rg.j1) this.f32596s;
                j1Var.f42335c.f42358p0.d(0, 0.0f, 0, getMeasuredWidth(), -this.f38175f.e, j1Var.f42335c.f42348e0);
                canvas.drawRoundRect(rectF2, AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f), j1Var.f42335c.f42358p0.f42556f);
                super.dispatchDraw(canvas);
                return;
        }
    }
