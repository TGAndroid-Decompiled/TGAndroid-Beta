...
public final class bx0 extends i71 {
    public final ai.m0 f32595d2;
    public final z61[] f32596e2;
    public final PremiumPreviewFragment f32597f2;
    ...
    public bx0(PremiumPreviewFragment premiumPreviewFragment, PremiumPreviewFragment premiumPreviewFragment2, Activity activity, Integer num, int i10, org.telegram.ui.ActionBar.f6 f6Var, int i11, ai.m0 m0Var, z61[] z61VarArr) {
        ...
        this.f32597f2 = premiumPreviewFragment;
        this.f32595d2 = m0Var;
        this.f32596e2 = z61VarArr;
    }
    ...
    public final void p(View view, Long l4, TLRPC.Document document, TL_stars.TL_starGiftUnique tL_starGiftUnique, Integer num) {
        this.f32595d2.run(l4, num);
        z61 z61Var = this.f32596e2[0];
        if (z61Var != null) {
            this.f32597f2.f31192s0 = null;
            z61Var.dismiss();
        }
    }
}
