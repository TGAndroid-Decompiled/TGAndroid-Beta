...
public final class nn0 extends FrameLayout implements DownloadController.FileDownloadProgressListener {
    public final TextView f35986a;
    public final TextView f35987b;
    public final org.telegram.ui.Components.w9 f35988c;
    public final org.telegram.ui.Components.mj0 d;
    public int e;
    public SecureDocument f35989f;
    public final int h;
    public final pn0 f35990n;
    ...
    public final void a(boolean z10) {
        ...
        int i12;
        int i13;
        String attachFileName = FileLoader.getAttachFileName(this.f35989f);
        boolean exists = FileLoader.getInstance(UserConfig.selectedAccount).getPathToAttach(this.f35989f).exists();
        ...
        SecureDocument secureDocument = this.f35989f;
        String str = secureDocument.path;
        float f7 = 0.0f;
        pn0 pn0Var = this.f35990n;
        if (str != null) {
            ...
            DownloadController.getInstance(i12).addLoadingFileObserver(this.f35989f.path, this);
            this.e = 1;
            Float fileProgress = ImageLoader.getInstance().getFileProgress(this.f35989f.path);
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        org.telegram.ui.Components.w9 w9Var = this.f35988c;
    ...
    public void setValue(CharSequence charSequence) {
        this.f35987b.setText(charSequence);
    }
}
