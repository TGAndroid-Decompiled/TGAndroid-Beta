...
public final class nn0 extends FrameLayout implements DownloadController.FileDownloadProgressListener {
    public final TextView f38988a;
    public final TextView f38989b;
    public final org.telegram.ui.Components.x9 f38990c;
    public final org.telegram.ui.Components.bj0 d;
    public int f38991e;
    public SecureDocument f38992f;
    public final int h;
    public final pn0 f38993n;
    ...
    public final void a(boolean z10) {
        ...
        int i12;
        int i13;
        String attachFileName = FileLoader.getAttachFileName(this.f38992f);
        boolean exists = FileLoader.getInstance(UserConfig.selectedAccount).getPathToAttach(this.f38992f).exists();
        ...
        SecureDocument secureDocument = this.f38992f;
        String str = secureDocument.path;
        float f7 = 0.0f;
        pn0 pn0Var = this.f38993n;
        if (str != null) {
            ...
            DownloadController.getInstance(i12).addLoadingFileObserver(this.f38992f.path, this);
            this.f38991e = 1;
            Float fileProgress = ImageLoader.getInstance().getFileProgress(this.f38992f.path);
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        org.telegram.ui.Components.x9 x9Var = this.f38990c;
    ...
    public void setValue(CharSequence charSequence) {
        this.f38989b.setText(charSequence);
    }
}
