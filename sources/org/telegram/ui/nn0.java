...
public final class nn0 extends FrameLayout implements DownloadController.FileDownloadProgressListener {
    ...
    public final org.telegram.ui.Components.x9 f39018c;
    public final org.telegram.ui.Components.bj0 d;
    public int f39019e;
    public SecureDocument f39020f;
    public final int h;
    public final pn0 f39021n;
    ...
    public final void a(boolean z10) {
        ...
        int i12;
        int i13;
        String attachFileName = FileLoader.getAttachFileName(this.f39020f);
        boolean exists = FileLoader.getInstance(UserConfig.selectedAccount).getPathToAttach(this.f39020f).exists();
        ...
        SecureDocument secureDocument = this.f39020f;
        String str = secureDocument.path;
        float f7 = 0.0f;
        pn0 pn0Var = this.f39021n;
        if (str != null) {
            ...
            DownloadController.getInstance(i12).addLoadingFileObserver(this.f39020f.path, this);
            this.f39019e = 1;
            Float fileProgress = ImageLoader.getInstance().getFileProgress(this.f39020f.path);
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        org.telegram.ui.Components.x9 x9Var = this.f39018c;
    ...
    public void setValue(CharSequence charSequence) {
        this.f39017b.setText(charSequence);
    }
}
