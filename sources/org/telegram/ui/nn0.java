...
public final class nn0 extends FrameLayout implements DownloadController.FileDownloadProgressListener {
    ...
    public final TextView f38990b;
    public final org.telegram.ui.Components.x9 f38991c;
    public final org.telegram.ui.Components.bj0 d;
    public int f38992e;
    public SecureDocument f38993f;
    public final int h;
    public final pn0 f38994n;
    ...
    public final void a(boolean z10) {
        ...
        int i12;
        int i13;
        String attachFileName = FileLoader.getAttachFileName(this.f38993f);
        boolean exists = FileLoader.getInstance(UserConfig.selectedAccount).getPathToAttach(this.f38993f).exists();
        ...
        SecureDocument secureDocument = this.f38993f;
        String str = secureDocument.path;
        float f7 = 0.0f;
        pn0 pn0Var = this.f38994n;
        if (str != null) {
            ...
            DownloadController.getInstance(i12).addLoadingFileObserver(this.f38993f.path, this);
            this.f38992e = 1;
            Float fileProgress = ImageLoader.getInstance().getFileProgress(this.f38993f.path);
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        org.telegram.ui.Components.x9 x9Var = this.f38991c;
    ...
    public void setValue(CharSequence charSequence) {
        this.f38990b.setText(charSequence);
    }
}
