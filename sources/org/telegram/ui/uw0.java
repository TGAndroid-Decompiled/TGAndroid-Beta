...
public class uw0 extends FrameLayout {
    public final org.telegram.ui.ActionBar.j5 f38172a;
    public final TextView f38173b;
    public final ImageView f38174c;
    public final ImageView d;
    public boolean e;
    public kx0 f38175f;
    public org.telegram.ui.Components.m5 h;
    public Drawable f38176n;
    ...
    public final void a(kx0 kx0Var, boolean z10) {
        ...
        if (isPremium && kx0Var.f35284a == 12 && kx0Var.f35285b == R.drawable.filled_premium_status2) {
        ...
        this.f38175f = kx0Var;
        this.f38172a.l(kx0Var.f35286c, false);
        this.f38173b.setText(kx0Var.d);
        this.f38174c.setImageResource(kx0Var.f35285b);
        this.e = z10;
    }
    ...
    public final void b(long j3, boolean z10) {
        ...
        if (j3 == 0) {
            if (this.f38176n == null) {
                Drawable mutate = getContext().getResources().getDrawable(R.drawable.msg_premium_prolfilestar).mutate();
                this.f38176n = mutate;
                mutate.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f19166v6, false), PorterDuff.Mode.SRC_IN));
            }
            this.h.g(this.f38176n, z10);
            return;
        }
        this.h.j(j3, z10);
    }
    ...
    public final void c() {
        this.h.setBounds((getWidth() - this.h.f26076s) - AndroidUtilities.dp(21.0f), (getHeight() - this.h.f26076s) / 2, getWidth() - AndroidUtilities.dp(21.0f), (getHeight() + this.h.f26076s) / 2);
    }
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        if (this.h != null) {
            c();
            this.h.k(Integer.valueOf(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f19166v6, false)));
            this.h.draw(canvas);
        }
        if (this.e) {
            canvas.drawRect(AndroidUtilities.dp(62.0f), getMeasuredHeight() - 1, getMeasuredWidth(), getMeasuredHeight(), org.telegram.ui.ActionBar.i6.f18958k0);
        }
    }
