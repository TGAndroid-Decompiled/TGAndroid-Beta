...
public final class uw0 extends nw0 {
    public final int f38228r = 0;
    public final org.telegram.ui.Components.ll0 f38229s;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        switch (this.f38228r) {
            ...
            default:
                ...
                ImageView imageView2 = this.f35617c;
                rectF2.set(imageView2.getLeft(), imageView2.getTop(), imageView2.getRight(), imageView2.getBottom());
                rg.j1 j1Var = (rg.j1) this.f38229s;
                j1Var.f42286c.f42309p0.d(0, 0.0f, 0, getMeasuredWidth(), -this.f35618f.e, j1Var.f42286c.f42299e0);
                canvas.drawRoundRect(rectF2, AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f), j1Var.f42286c.f42309p0.f42507f);
                super.dispatchDraw(canvas);
                return;
        }
    }
