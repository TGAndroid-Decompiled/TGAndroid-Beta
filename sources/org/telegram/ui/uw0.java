...
public class uw0 extends FrameLayout {
    public final org.telegram.ui.ActionBar.j5 f38113a;
    public final TextView f38114b;
    public final ImageView f38115c;
    public final ImageView d;
    public boolean e;
    public kx0 f38116f;
    public org.telegram.ui.Components.o5 h;
    public Drawable f38117n;
    ...
    public final void a(kx0 kx0Var, boolean z10) {
        ...
        if (isPremium && kx0Var.f35197a == 12 && kx0Var.f35198b == R.drawable.filled_premium_status2) {
        ...
        this.f38116f = kx0Var;
        this.f38113a.l(kx0Var.f35199c, false);
        this.f38114b.setText(kx0Var.d);
        this.f38115c.setImageResource(kx0Var.f35198b);
        this.e = z10;
    }
    ...
    public final void b(long j3, boolean z10) {
        ...
        if (j3 == 0) {
            if (this.f38117n == null) {
                ...
                this.f38117n = mutate;
                mutate.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19393v6, false), PorterDuff.Mode.SRC_IN));
            }
            this.h.g(this.f38117n, z10);
            return;
        }
        this.h.j(j3, z10);
    }
    ...
    public final void c() {
        this.h.setBounds((getWidth() - this.h.f26858s) - AndroidUtilities.dp(21.0f), (getHeight() - this.h.f26858s) / 2, getWidth() - AndroidUtilities.dp(21.0f), (getHeight() + this.h.f26858s) / 2);
    }
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        if (this.h != null) {
            c();
            this.h.k(Integer.valueOf(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19393v6, false)));
            this.h.draw(canvas);
        }
        if (this.e) {
            canvas.drawRect(AndroidUtilities.dp(62.0f), getMeasuredHeight() - 1, getMeasuredWidth(), getMeasuredHeight(), org.telegram.ui.ActionBar.j6.f19184k0);
        }
    }
