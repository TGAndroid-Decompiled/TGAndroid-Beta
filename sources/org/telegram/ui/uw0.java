...
public class uw0 extends FrameLayout {
    public final org.telegram.ui.ActionBar.j5 f41252a;
    ...
    public final void a(kx0 kx0Var, boolean z10) {
        ...
        if (isPremium && kx0Var.f38175a == 12 && kx0Var.f38176b == R.drawable.filled_premium_status2) {
        ...
        this.f41256f = kx0Var;
        this.f41252a.l(kx0Var.f38177c, false);
        this.f41253b.setText(kx0Var.d);
        this.f41254c.setImageResource(kx0Var.f38176b);
        this.f41255e = z10;
    }
    ...
    public final void b(long j3, boolean z10) {
        ...
        if (j3 == 0) {
            if (this.f41257n == null) {
                Drawable mutate = getContext().getResources().getDrawable(R.drawable.msg_premium_prolfilestar).mutate();
                this.f41257n = mutate;
                mutate.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f21018v6, false), PorterDuff.Mode.SRC_IN));
            }
            this.h.g(this.f41257n, z10);
            return;
        }
        this.h.j(j3, z10);
    }
    ...
    public final void c() {
        this.h.setBounds((getWidth() - this.h.f28992s) - AndroidUtilities.dp(21.0f), (getHeight() - this.h.f28992s) / 2, getWidth() - AndroidUtilities.dp(21.0f), (getHeight() + this.h.f28992s) / 2);
    }
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        if (this.h != null) {
            c();
            this.h.k(Integer.valueOf(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f21018v6, false)));
            this.h.draw(canvas);
        }
        if (this.f41255e) {
            canvas.drawRect(AndroidUtilities.dp(62.0f), getMeasuredHeight() - 1, getMeasuredWidth(), getMeasuredHeight(), org.telegram.ui.ActionBar.j6.f20813k0);
        }
    }
