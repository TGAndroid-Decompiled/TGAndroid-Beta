...
public final class bn0 implements RequestDelegate {
    ...
    public final void a() {
        ...
        int i12;
        pn0 pn0Var = this.f34877e;
        if (pn0Var.Y == null) {
            return;
        }
        if (!this.f34874a) {
            i12 = ((org.telegram.ui.ActionBar.n2) pn0Var).currentAccount;
            UserConfig.getInstance(i12).savePassword(this.f34875b, pn0Var.f39589e1);
        }
        AndroidUtilities.hideKeyboard(pn0Var.Y[0]);
        pn0Var.f39592f1 = true;
        long j3 = pn0Var.f39582c;
        if (j3 == 0) {
            i10 = 8;
        } else {
            i10 = 0;
        }
        pn0 pn0Var2 = new pn0(i10, j3, pn0Var.h, pn0Var.f39614r, pn0Var.d, pn0Var.f39587e, pn0Var.f39605n, pn0Var.f39632y, pn0Var.J);
        pn0Var2.f39586d1 = pn0Var.f39586d1;
        ...
        pn0Var2.f39581b1 = pn0Var.f39581b1;
    ...
    public final void b() {
        ...
        if (passwordKdfAlgo instanceof TLRPC.TL_passwordKdfAlgoSHA256SHA256PBKDF2HMACSHA512iter100000SHA256ModPow) {
            updatepasswordsettings.password = SRPHelper.startCheck(this.f34875b, password.srp_id, password.srp_B, (TLRPC.TL_passwordKdfAlgoSHA256SHA256PBKDF2HMACSHA512iter100000SHA256ModPow) passwordKdfAlgo);
        }
        ...
        ConnectionsManager.getInstance(i10).sendRequest(this.f34876c, new zm0(this, 1));
    }
    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        if (tL_error != null && "SRP_ID_INVALID".equals(tL_error.text)) {
            ...
            i10 = ((org.telegram.ui.ActionBar.n2) this.f34877e).currentAccount;
            ConnectionsManager.getInstance(i10).sendRequest(getpassword, new di.u3(9, this, this.f34874a), 8);
        } else if (tL_error == null) {
            Utilities.globalQueue.postRunnable(new bi.e4(this, tLObject, this.d, this.f34874a, 24));
        } else {
            AndroidUtilities.runOnUIThread(new dm0(this, this.f34874a, tL_error, 1));
        }
    }
}
