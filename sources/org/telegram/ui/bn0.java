...
public final class bn0 implements Runnable {
    ...
    public final cn0 f32211b;
    public final TLRPC.TL_error f32212c;
    ...
    public final void run() {
        switch (this.f32210a) {
            case 0:
                cn0 cn0Var = this.f32211b;
                TLObject tLObject = this.d;
                TLRPC.TL_error tL_error = this.f32212c;
                qn0 qn0Var = cn0Var.e;
                if (tLObject instanceof Vector) {
                    ...
                    for (int i10 = 0; i10 < size; i10++) {
                        qn0Var.f36997y.values.add((TLRPC.TL_secureValue) vector.objects.get(i10));
                    }
                    cn0Var.a();
                    return;
                }
                ...
                return;
            case 1:
                cn0 cn0Var2 = this.f32211b;
                TLRPC.TL_error tL_error2 = this.f32212c;
                ...
                return;
            default:
                cn0 cn0Var3 = this.f32211b;
                TLRPC.TL_error tL_error3 = this.f32212c;
