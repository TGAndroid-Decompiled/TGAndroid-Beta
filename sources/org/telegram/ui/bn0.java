...
public final class bn0 implements RequestDelegate {
    ...
    public final byte[] f34848b;
    public final TL_account.getPasswordSettings f34849c;
    public final String d;
    public final pn0 f34850e;

    public bn0(pn0 pn0Var, boolean z10, byte[] bArr, TL_account.getPasswordSettings getpasswordsettings, String str) {
        this.f34850e = pn0Var;
        this.f34847a = z10;
        this.f34848b = bArr;
        this.f34849c = getpasswordsettings;
        this.d = str;
    }
    ...
    public final void a() {
        ...
        int i12;
        pn0 pn0Var = this.f34850e;
        if (pn0Var.Y == null) {
            return;
        }
        if (!this.f34847a) {
            i12 = ((org.telegram.ui.ActionBar.n2) pn0Var).currentAccount;
            UserConfig.getInstance(i12).savePassword(this.f34848b, pn0Var.f39562e1);
        }
        AndroidUtilities.hideKeyboard(pn0Var.Y[0]);
        pn0Var.f39565f1 = true;
        long j3 = pn0Var.f39555c;
        if (j3 == 0) {
            i10 = 8;
        } else {
            i10 = 0;
        }
        pn0 pn0Var2 = new pn0(i10, j3, pn0Var.h, pn0Var.f39587r, pn0Var.d, pn0Var.f39560e, pn0Var.f39578n, pn0Var.f39605y, pn0Var.J);
        pn0Var2.f39559d1 = pn0Var.f39559d1;
        ...
        pn0Var2.f39554b1 = pn0Var.f39554b1;
    ...
    public final void b() {
        ...
        if (passwordKdfAlgo instanceof TLRPC.TL_passwordKdfAlgoSHA256SHA256PBKDF2HMACSHA512iter100000SHA256ModPow) {
            updatepasswordsettings.password = SRPHelper.startCheck(this.f34848b, password.srp_id, password.srp_B, (TLRPC.TL_passwordKdfAlgoSHA256SHA256PBKDF2HMACSHA512iter100000SHA256ModPow) passwordKdfAlgo);
        }
        ...
        ConnectionsManager.getInstance(i10).sendRequest(this.f34849c, new zm0(this, 1));
    }
    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        if (tL_error != null && "SRP_ID_INVALID".equals(tL_error.text)) {
            ...
            i10 = ((org.telegram.ui.ActionBar.n2) this.f34850e).currentAccount;
            ConnectionsManager.getInstance(i10).sendRequest(getpassword, new di.u3(9, this, this.f34847a), 8);
        } else if (tL_error == null) {
            Utilities.globalQueue.postRunnable(new bi.e4(this, tLObject, this.d, this.f34847a, 24));
        } else {
            AndroidUtilities.runOnUIThread(new dm0(this, this.f34847a, tL_error, 1));
        }
    }
}
