...
public final class bn0 implements RequestDelegate {
    ...
    public final TL_account.getPasswordSettings f32520c;
    ...
    public bn0(pn0 pn0Var, boolean z10, byte[] bArr, TL_account.getPasswordSettings getpasswordsettings, String str) {
        ...
        this.f32518a = z10;
        this.f32519b = bArr;
        this.f32520c = getpasswordsettings;
        this.d = str;
    }
    ...
    public final void a() {
        ...
        if (!this.f32518a) {
            ...
            UserConfig.getInstance(i12).savePassword(this.f32519b, pn0Var.f36636e1);
        }
        AndroidUtilities.hideKeyboard(pn0Var.Y[0]);
        pn0Var.f36639f1 = true;
        long j3 = pn0Var.f36630c;
        if (j3 == 0) {
            i10 = 8;
        } else {
            i10 = 0;
        }
        pn0 pn0Var2 = new pn0(i10, j3, pn0Var.h, pn0Var.f36661r, pn0Var.d, pn0Var.e, pn0Var.f36652n, pn0Var.f36679y, pn0Var.J);
        pn0Var2.f36634d1 = pn0Var.f36634d1;
        ...
        pn0Var2.f36629b1 = pn0Var.f36629b1;
    ...
    public final void b() {
        ...
        if (passwordKdfAlgo instanceof TLRPC.TL_passwordKdfAlgoSHA256SHA256PBKDF2HMACSHA512iter100000SHA256ModPow) {
            updatepasswordsettings.password = SRPHelper.startCheck(this.f32519b, password.srp_id, password.srp_B, (TLRPC.TL_passwordKdfAlgoSHA256SHA256PBKDF2HMACSHA512iter100000SHA256ModPow) passwordKdfAlgo);
        }
        ...
        ConnectionsManager.getInstance(i10).sendRequest(this.f32520c, new zm0(this, 1));
    }
    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        if (tL_error != null && "SRP_ID_INVALID".equals(tL_error.text)) {
            ...
            ConnectionsManager.getInstance(i10).sendRequest(getpassword, new ci.u3(9, this, this.f32518a), 8);
        } else if (tL_error == null) {
            Utilities.globalQueue.postRunnable(new ai.s4(this, tLObject, this.d, this.f32518a, 25));
        } else {
            AndroidUtilities.runOnUIThread(new ka0(this, this.f32518a, tL_error, 2));
        }
    }
}
