...
public final class bt0 extends org.telegram.ui.Components.ld {
    public final Path f34949t1;
    public final PhotoViewer f34950u1;
    ...
    public bt0(PhotoViewer photoViewer, ContextThemeWrapper contextThemeWrapper, bv0 bv0Var, org.telegram.ui.Components.ov0 ov0Var, FrameLayout frameLayout, org.telegram.ui.ActionBar.f6 f6Var, org.telegram.ui.Components.ja jaVar, ir0 ir0Var) {
        ...
        this.f34950u1 = photoViewer;
        this.f34949t1 = new Path();
    }

    @Override
    public final void A() {
        PhotoViewer.W(this.f34950u1);
    }

    @Override
    public final void B() {
        z();
        at0 at0Var = this.f34950u1.U1;
        if (at0Var != null) {
            at0Var.z();
        }
    }
    ...
    public final boolean e() {
        PhotoViewer photoViewer = this.f34950u1;
        org.telegram.ui.Components.qc qcVar = photoViewer.f33661n7;
        if (qcVar != null && org.telegram.ui.Components.qc.f29699w == qcVar) {
            return false;
        }
        return photoViewer.T2(photoViewer.f33577e0);
    }
    ...
    public final void invalidate() {
        int i10;
        if (SharedConfig.photoViewerBlur && ((i10 = this.f34950u1.f33658n4) == 1 || i10 == 2 || i10 == 3)) {
            return;
        }
        super.invalidate();
    }
    ...
    public final boolean l(float f7, float f10) {
        if (!this.f7632p0 && this.f34950u1.f33721u4 != 0) {
            return true;
        }
        return false;
    }
    ...
    public final void w() {
        ...
        if (photoViewer.l4 != null) {
            ...
            if (photoViewer.l4.f35265e == null) {
                z10 = false;
            }
