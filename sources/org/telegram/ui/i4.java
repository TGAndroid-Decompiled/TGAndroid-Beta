...
public final class i4 extends FrameLayout {
    public final org.telegram.ui.Components.ao0 f39117a;
    public final int f39118b;
    public final int f39119c;
    public int d;
    public final TextPaint f39120e;
    public final m4 f39121f;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.d != size) {
            ...
            int i13 = this.f39118b;
            this.f39117a.setProgress((i12 - i13) / (this.f39119c - i13));
            this.d = size;
        }
    }
}
