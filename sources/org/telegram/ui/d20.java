...
public final class d20 extends og.a {
    ...
    public final boolean equals(Object obj) {
        ...
        d20 d20Var = (d20) obj;
        int i10 = d20Var.f15543a;
        int i11 = this.f15543a;
        if (i10 != i11) {
            return false;
        }
        if ((i11 == 0 || i11 == 4 || i11 == 3 || i11 == 6) && !TextUtils.equals(this.f32985c, d20Var.f32985c)) {
            return false;
        }
        ...
        if (i12 == 2) {
            ...
            if (dialogFilter != null && dialogFilter.f15613id != dialogFilter2.f15613id) {
                return false;
            }
        }
        if (i12 == 5) {
            ...
            if (tL_dialogFilterSuggested != null && tL_dialogFilterSuggested.filter.f18126id != tL_dialogFilterSuggested2.filter.f18126id) {
                return false;
            }
        }
        return true;
