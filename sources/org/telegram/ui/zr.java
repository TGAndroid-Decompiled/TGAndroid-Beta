...
public final class zr extends Drawable {
    public final org.telegram.ui.ActionBar.f6 f43521a;
    public final Paint f43522b = new Paint(1);
    public final Paint f43523c;
    public final Drawable d;
    public final RectF f43524e;
    public final org.telegram.ui.Components.p6 f43525f;
    public final org.telegram.ui.Components.p6 f43526g;
    public final Paint h;
    public final Path f43527i;
    public final Drawable f43528j;
    public int f43529k;
    public boolean f43530l;
    public final org.telegram.ui.Components.e6 f43531m;

    public zr(Context context, int i10, org.telegram.ui.ActionBar.f6 f6Var) {
        Paint paint = new Paint(1);
        this.f43523c = paint;
        this.f43524e = new RectF();
        ...
        Path path = new Path();
        this.f43527i = path;
        this.f43531m = new org.telegram.ui.Components.e6(new dj(this, 12), 320L, org.telegram.ui.Components.pr.h, 0);
        yr yrVar = new yr(0, this);
        this.f43521a = f6Var;
        this.d = context.getResources().getDrawable(i10).mutate();
        this.f43528j = context.getResources().getDrawable(R.drawable.mini_casting_fill).mutate();
        paint.setColor(-1);
    ...
    public final void draw(Canvas canvas) {
        ...
        int i10;
        float f12;
        float e7 = this.f43531m.e(this.f43530l);
        org.telegram.ui.Components.p6 p6Var = this.f43525f;
        float d = p6Var.d() + (p6Var.g() * AndroidUtilities.dp(5.0f));
        org.telegram.ui.Components.p6 p6Var2 = this.f43526g;
        ...
        Paint paint2 = this.f43523c;
        RectF rectF = this.f43524e;
        if (i11 > 0) {
            f7 = dp;
            float f13 = f7 / 2.0f;
            f10 = height;
        ...
        if (d * f15 > 0.0f) {
            ...
            p6Var.f29330w = (int) (p6Var.g() * 255.0f * f15);
            float f16 = f7 / 2.0f;
        ...
        if (e7 > 0.0f) {
            canvas2.save();
            int v02 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Oh, this.f43521a);
            int i13 = this.f43529k;
            Drawable drawable2 = this.f43528j;
            if (i13 != v02) {
                this.f43529k = v02;
            ...
            if (e7 > 0.5f) {
                ...
                canvas2.drawPath(this.f43527i, this.h);
                canvas2.restore();
            }
        ...
        if (i10 > 0) {
            ...
            p6Var2.f29330w = (int) (p6Var2.g() * f12);
            float f17 = f7 / 2.0f;
