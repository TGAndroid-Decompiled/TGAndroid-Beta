...
public final class zr implements Drawable.Callback {
    ...
    public final Drawable f40329b;

    public zr(int i10, Drawable drawable) {
        this.f40328a = i10;
        this.f40329b = drawable;
    }
    ...
    public final void invalidateDrawable(Drawable drawable) {
        switch (this.f40328a) {
            case 0:
                ((as) this.f40329b).invalidateSelf();
                return;
            default:
                org.telegram.ui.Cells.w0 w0Var = ((m11) this.f40329b).h;
                if (w0Var != null) {
                    w0Var.invalidate();
                    return;
                }
    ...
    public final void scheduleDrawable(Drawable drawable, Runnable runnable, long j3) {
        switch (this.f40328a) {
            case 0:
                ((as) this.f40329b).scheduleSelf(runnable, j3);
                return;
            default:
                return;
        }
    ...
    public final void unscheduleDrawable(Drawable drawable, Runnable runnable) {
        switch (this.f40328a) {
            case 0:
                ((as) this.f40329b).unscheduleSelf(runnable);
                return;
            default:
                return;
        }
