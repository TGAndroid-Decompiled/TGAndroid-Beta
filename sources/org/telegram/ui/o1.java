...
public final class o1 extends WebChromeClient {
    ...
    public final KeyEvent.Callback f36082b;

    public o1(KeyEvent.Callback callback, int i10) {
        this.f36081a = i10;
        this.f36082b = callback;
    }
    ...
    public final void onHideCustomView() {
        switch (this.f36081a) {
            case 0:
                ...
                s1 s1Var = (s1) this.f36082b;
                h4 h4Var = s1Var.f37232x;
                if (h4Var.O != null) {
                    h4Var.P.setVisibility(4);
                    h4 h4Var2 = s1Var.f37232x;
                    h4Var2.P.removeView(h4Var2.O);
                    WebChromeClient.CustomViewCallback customViewCallback = s1Var.f37232x.S;
                    if (customViewCallback != null && !customViewCallback.getClass().getName().contains(".chromium.")) {
                        s1Var.f37232x.S.onCustomViewHidden();
                    }
                    s1Var.f37232x.O = null;
                    return;
                }
                return;
            default:
                super.onHideCustomView();
                org.telegram.ui.Components.vu vuVar = (org.telegram.ui.Components.vu) this.f36082b;
                if (vuVar.d != null) {
                    vuVar.getSheetContainer().setVisibility(0);
                    vuVar.e.setVisibility(4);
                    vuVar.e.removeView(vuVar.d);
                    WebChromeClient.CustomViewCallback customViewCallback2 = vuVar.f29432f;
                    if (customViewCallback2 != null && !customViewCallback2.getClass().getName().contains(".chromium.")) {
                        vuVar.f29432f.onCustomViewHidden();
                    }
                    vuVar.d = null;
                    return;
                }
    ...
    public final void onShowCustomView(View view, WebChromeClient.CustomViewCallback customViewCallback) {
        switch (this.f36081a) {
            case 0:
                h4 h4Var = ((s1) this.f36082b).f37232x;
                if (h4Var.O != null) {
            ...
            default:
                ...
                if (vuVar.d == null && !org.telegram.ui.Components.eg0.f23638p0.P) {
                    vuVar.I();
                    vuVar.d = view;
                    vuVar.getSheetContainer().setVisibility(4);
                    frameLayout.setVisibility(0);
                    frameLayout.addView(view, w7.x5.c(-1.0f, -1));
                    vuVar.f29432f = customViewCallback;
                    return;
                }
                customViewCallback.onCustomViewHidden();
                return;
