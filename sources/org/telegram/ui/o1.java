...
public final class o1 implements org.telegram.ui.Components.y81 {
    ...
    public final void c(float f7) {
        this.f39101a.f40623x.R.a(f7, 0);
    }

    @Override
    public final void d() {
        this.f39101a.f40614a.setVisibility(0);
        this.f39101a.f40615b.setVisibility(4);
        this.f39101a.f40615b.g(null, null, null, null, false);
        HashMap hashMap = new HashMap();
        hashMap.put("Referer", ApplicationLoader.applicationContext.getPackageName());
        t1 t1Var = this.f39101a;
        t1Var.f40614a.loadUrl(t1Var.v.url, hashMap);
    }

    @Override
    public final void e(org.telegram.ui.Components.b91 b91Var, boolean z10) {
        i4 i4Var = this.f39101a.f40623x;
        if (z10) {
