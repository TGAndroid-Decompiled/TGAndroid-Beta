...
public final class ye0 extends org.telegram.ui.Components.gw0 {
    ...
    public final xg0 f39797a0;
    public final org.telegram.ui.Components.id0 f39798b;
    public final ci.h2 f39799c;
    ...
    public final TextView f39801n;
    public final TextView f39802r;
    public final TextView f39803s;
    public final yf0 v;
    public boolean f39804w;
    public boolean f39805x;
    public boolean f39806y;

    public ye0(org.telegram.ui.xg0 r28, android.content.Context r29, int r30) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.ye0.<init>(org.telegram.ui.xg0, android.content.Context, int):void");
    }
    ...
    public final void h(String str) {
        ...
        String obj = this.f39799c.getText().toString();
        if (obj.length() == 0) {
            s(false);
        } else if (!p(obj)) {
            s(true);
    ...
    @Override
    public final void j() {
        AndroidUtilities.runOnUIThread(new ve0(this, 3), xg0.f39460t0);
    }

    @Override
    public final void k(Bundle bundle) {
        Bundle bundle2 = bundle.getBundle("recoveryview_word" + this.f39796a);
        this.L = bundle2;
        if (bundle2 != null) {
            m(bundle2, true);
        }
    ...
    public final void l(Bundle bundle) {
        if (this.L != null) {
            bundle.putBundle("recoveryview_word" + this.f39796a, this.L);
        }
    }
    ...
    public final void m(Bundle bundle, boolean z10) {
        ...
        if (bundle == null) {
            if (this.S != null && this.T != null) {
                ...
                yf0Var.setText(AndroidUtilities.replaceArrows(LocaleController.getString(i12), true, AndroidUtilities.dp(1.0f), AndroidUtilities.dp(1.0f)));
                return;
            }
            return;
        }
        ci.h2 h2Var = this.f39799c;
        h2Var.setText("");
        this.L = bundle;
        this.K = null;
        ...
        String str2 = this.K;
        TextView textView = this.f39802r;
        if (str2 == null) {
            if (!z11) {
            ...
            org.telegram.messenger.wh.p(i11, new Object[]{str}, textView);
        } else {
            if (!z11) {
            ...
            org.telegram.messenger.wh.p(i10, new Object[]{str, str2}, textView);
        }
        xg0.T0(xg0Var, h2Var);
        h2Var.requestFocus();
        ...
        yf0Var.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i15, false));
        int i16 = this.E;
        if (i16 != 2 && i16 != 4 && i16 != 3) {
            ...
            yf0Var.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i15, false));
            yf0Var.setTag(R.id.color_key_tag, Integer.valueOf(i15));
    ...
    public final void n() {
        ...
        xg0 xg0Var = this.f39797a0;
        this.f39801n.setTextColor(xg0Var.getThemedColor(i10));
        this.f39802r.setTextColor(xg0Var.getThemedColor(org.telegram.ui.ActionBar.j6.D6));
        int themedColor = xg0Var.getThemedColor(i10);
        ci.h2 h2Var = this.f39799c;
        h2Var.setTextColor(themedColor);
        h2Var.setCursorColor(xg0Var.getThemedColor(org.telegram.ui.ActionBar.j6.f19208l6));
    ...
    public final void o(boolean z10) {
        ...
        if (this.f39804w && !this.f39805x) {
            f10 = 1.0f;
        }
        float f13 = (0.1f * f10) + 0.9f;
        ViewPropertyAnimator alpha = this.f39800f.animate().scaleX(f13).scaleY(f13).alpha(f10);
        float f14 = 1.0f - f10;
        if (this.f39805x) {
            f12 = 5.0f;
        }
    ...
    public final void q(boolean z10) {
        ...
        if (TextUtils.isEmpty(this.f39799c.getText()) && clipboardManager != null && clipboardManager.hasPrimaryClip()) {
            z11 = true;
        } else {
            z11 = false;
        }
        if (this.f39804w != z11) {
            ...
            float f16 = 0.9f;
            float f17 = 0.7f;
            TextView textView = this.f39803s;
            ...
            if (z10) {
                ...
                ViewPropertyAnimator alpha2 = scaleX2.scaleY(f16).alpha((!this.f39804w || this.f39805x) ? 0.0f : 0.0f);
                if (!this.f39804w || this.f39805x) {
                    if (this.f39805x) {
                        f15 = 5.0f;
                    }
                ...
                textView2.setAlpha((!this.f39804w || this.f39805x) ? 0.0f : 0.0f);
                if (!this.f39804w || this.f39805x) {
                    if (this.f39805x) {
                        f15 = 5.0f;
                    }
    ...
    public final void s(boolean z10) {
        ...
        int i11;
        ci.h2 h2Var = this.f39799c;
        if (this.f39797a0.getParentActivity() == null) {
            return;
        }
        try {
