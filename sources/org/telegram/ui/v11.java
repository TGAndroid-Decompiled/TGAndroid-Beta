...
public final class v11 extends org.telegram.ui.ActionBar.j {
    ...
    public final void b(int i10) {
        ...
        int i16;
        int i17;
        y11 y11Var = this.f41411b;
        long j3 = y11Var.f42982f;
        long j10 = y11Var.f42981e;
        String str = this.f41410a;
        if (i10 == -1) {
            if (!y11Var.h && y11Var.f42983n) {
            ...
            if (y11Var.f42984r != null) {
                ...
                obj.f42454c = c10;
                if (c10 != 0) {
                    obj.f42452a = org.telegram.messenger.w1.c("notifyuntil_", str, notificationsSettings, 0);
                }
                y11Var.f42984r.v(obj);
            }
        }
