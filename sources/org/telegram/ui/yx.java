...
public final class yx extends UndoView {
    ...
    public final boolean a() {
        int i10 = 0;
        while (true) {
            ty[] tyVarArr = this.f43259f0.f41286e0;
            if (i10 < tyVarArr.length) {
                if (tyVarArr[i10].f40894x.k()) {
                    return false;
                }
                i10++;
            } else {
        ...
        if (uyVar.R1 != null) {
            ...
            while (true) {
                if (i11 < uyVar.R1.size()) {
                    if (((TLRPC.Dialog) uyVar.R1.get(i11)).f19900id == j3) {
                        break;
                    }
                    i11++;
                } else {
    ...
    public final void setTranslationY(float f7) {
        ...
        uy uyVar = this.f43259f0;
        UndoView[] undoViewArr = uyVar.f41388y0;
        if (this == undoViewArr[0]) {
            UndoView undoView = undoViewArr[1];
            if (undoView == null || undoView.getVisibility() != 0) {
                uyVar.f41367u1 = Math.max(0.0f, (AndroidUtilities.dp(8.0f) + getMeasuredHeight()) - f7);
                uyVar.X4();
            }
        }
    }
