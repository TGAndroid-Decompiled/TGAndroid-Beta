...
public final class yx extends org.telegram.ui.Components.eo0 {
    ...
    public final void S(int i10, int i11) {
        py pyVar;
        og.e eVar;
        if (Build.VERSION.SDK_INT >= 31 && (eVar = (pyVar = this.X0).f40226i4) != null) {
            eVar.f(i10, i11);
            pyVar.m3();
        }
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (pyVar.X != null || pyVar.U2 != 0) {
            ...
            int dp2 = (AndroidUtilities.dp(pyVar.f40179a) + kVar.getMeasuredHeight()) - AndroidUtilities.dp(2.0f);
            if (pyVar.U2 != 0) {
                i10 = dp;
            } else {
                i10 = 0;
            ...
            int i13 = i12 + i11;
            int l1 = org.telegram.ui.ActionBar.k6.l1(0.7f, pyVar.getThemedColor(org.telegram.ui.ActionBar.k6.f21659d6));
            lf.b0 b0Var = this.V0;
            b0Var.b(l1);
            b0Var.c(i13, 0);
        ...
        if (pyVar.f40199d4 > AndroidUtilities.dp(32.0f)) {
            int l12 = org.telegram.ui.ActionBar.k6.l1(0.9f, pyVar.getThemedColor(org.telegram.ui.ActionBar.k6.f21659d6));
            lf.b0 b0Var2 = this.W0;
            b0Var2.b(l12);
            b0Var2.setBounds(0, getMeasuredHeight() - pyVar.f40199d4, getMeasuredWidth(), getMeasuredHeight());
            b0Var2.draw(canvas);
        }
    }
