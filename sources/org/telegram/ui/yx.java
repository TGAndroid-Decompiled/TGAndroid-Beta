...
public final class yx extends UndoView {
    ...
    public final boolean a() {
        int i10 = 0;
        while (true) {
            ty[] tyVarArr = this.f43233f0.f41260e0;
            if (i10 < tyVarArr.length) {
                if (tyVarArr[i10].f40868x.k()) {
                    return false;
                }
                i10++;
            } else {
    ...
    public final void setTranslationY(float f7) {
        ...
        uy uyVar = this.f43233f0;
        UndoView[] undoViewArr = uyVar.f41362y0;
        if (this == undoViewArr[0]) {
            UndoView undoView = undoViewArr[1];
            if (undoView == null || undoView.getVisibility() != 0) {
                uyVar.f41341u1 = Math.max(0.0f, (AndroidUtilities.dp(8.0f) + getMeasuredHeight()) - f7);
                uyVar.X4();
            }
        }
    }
