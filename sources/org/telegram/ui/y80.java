...
public final class y80 implements Runnable {
    ...
    public final LaunchActivity f43577b;

    public y80(LaunchActivity launchActivity, int i10) {
        this.f43576a = i10;
        this.f43577b = launchActivity;
    }
    ...
    public final void run() {
        ...
        LaunchActivity launchActivity = this.f43577b;
        switch (i10) {
            case 0:
            ...
            case 3:
                if (!launchActivity.f34160n0.getFragmentStack().isEmpty()) {
                    launchActivity.f34160n0.getFragmentStack().get(0).showDialog(new org.telegram.ui.Components.yx0(launchActivity, launchActivity.f34148g0, launchActivity.f34144e0, launchActivity.f34146f0));
                    return;
                }
                return;
            case 4:
            ...
            case 7:
                if (launchActivity.Q0 != null) {
                    File file = new File(ApplicationLoader.getFilesDirFixed(), android.support.v4.media.a.q(new StringBuilder("remote"), launchActivity.Q0.f20980id, ".attheme"));
