...
public final class p30 extends org.telegram.ui.Components.kj0 {
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        j60 j60Var = this.f35678r;
        w20 w20Var = j60Var.f34038y2;
        ArrayList arrayList = j60Var.Z1;
        if (j60Var.r1()) {
            return super.onTouchEvent(motionEvent);
        }
        if (motionEvent.getAction() == 0 && j60Var.F1 == 0 && j60Var.f33936a1 != null) {
            ...
            if (j60Var.R1) {
                ...
                AndroidUtilities.cancelRunOnUIThread(j60Var.f34033x2);
                j60Var.J1(0, true);
                if (VoIPService.getSharedInstance() != null) {
                    VoIPService.getSharedInstance().setMicMute(true, true, false);
                    try {
                        j60Var.f34025w.performHapticFeedback(3, 2);
