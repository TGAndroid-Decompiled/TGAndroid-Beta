...
public final class pm0 extends vu0 {
    ...
    public final void B(int i10) {
        ...
        qn0 qn0Var = this.f36663a;
        int i11 = qn0Var.S0;
        if (i11 == 1) {
            secureDocument = qn0Var.f36970j1;
        } else if (i11 == 4) {
            secureDocument = (SecureDocument) qn0Var.f36972k1.get(i10);
        } else if (i11 == 2) {
            secureDocument = qn0Var.l1;
        } else if (i11 == 3) {
            secureDocument = qn0Var.f36974m1;
        } else {
            secureDocument = (SecureDocument) qn0Var.f36968i1.get(i10);
        }
        on0 on0Var = (on0) qn0Var.f36977n1.remove(secureDocument);
        if (on0Var == null) {
            return;
        }
        ...
        if (str != null) {
            HashMap hashMap = qn0Var.f37001x1;
            if (hashMap != null) {
                hashMap.remove(str);
            }
            HashMap hashMap2 = qn0Var.f37004y1;
            if (hashMap2 != null) {
                hashMap2.remove(str);
            }
        }
        qn0Var.S1(qn0Var.S0);
        qn0Var.f36967i0.removeView(on0Var);
    }
    ...
    public final fv0 E(MessageObject messageObject, TLRPC.FileLocation fileLocation, int i10, boolean z10, boolean z11) {
        if (i10 >= 0) {
            qn0 qn0Var = this.f36663a;
            if (i10 < qn0Var.f36967i0.getChildCount()) {
                on0 on0Var = (on0) qn0Var.f36967i0.getChildAt(i10);
                int[] iArr = new int[2];
                on0Var.f36393c.getLocationInWindow(iArr);
                fv0 fv0Var = new fv0();
                fv0Var.f33768b = iArr[0];
                fv0Var.f33769c = iArr[1];
                fv0Var.d = qn0Var.f36967i0;
                ImageReceiver imageReceiver = on0Var.f36393c.getImageReceiver();
