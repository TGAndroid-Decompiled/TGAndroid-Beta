...
public final class pm0 implements RequestDelegate {
    ...
    public final void run(TLObject tLObject, final TLRPC.TL_error tL_error) {
        switch (this.f40088a) {
            case 0:
                AndroidUtilities.runOnUIThread(new qm0(this.f40089b, tLObject, tL_error));
                return;
            case 1:
                final rm0 rm0Var = this.f40089b;
                        ...
                        switch (r3) {
                            ...
                            default:
                                ...
                                if (tL_error3 != null && "SRP_ID_INVALID".equals(tL_error3.text)) {
                                    ...
                                    i11 = ((org.telegram.ui.ActionBar.p2) rm0Var3.f40996e).currentAccount;
                ...
                return;
            case 2:
                final rm0 rm0Var2 = this.f40089b;
                AndroidUtilities.runOnUIThread(new Runnable() {
                    @Override
                    public final void run() {
                        int i10;
                ...
                return;
            case 3:
                AndroidUtilities.runOnUIThread(new qm0(this.f40089b, tL_error, tLObject, 1));
                return;
            default:
                AndroidUtilities.runOnUIThread(new qm0(this.f40089b, tL_error, tLObject, 2));
                return;
        }
    }
}
