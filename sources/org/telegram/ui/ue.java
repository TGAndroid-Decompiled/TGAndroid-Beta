...
public final class ue implements Runnable {
    public final int f38441a = 0;
    public final wn f38442b;
    public final MessagesController f38443c;
    ...
    public ue(wn wnVar, CharSequence charSequence, MessagesController messagesController, boolean z10) {
        this.f38442b = wnVar;
        this.d = charSequence;
        this.f38443c = messagesController;
        this.e = z10;
    }
    ...
    public final void run() {
        switch (this.f38441a) {
            case 0:
                wn.g1(this.f38442b, this.d, this.f38443c, this.e);
                return;
            default:
                wn wnVar = this.f38442b;
                ...
                MessagesController messagesController = this.f38443c;
