...
public final class ih0 implements RequestDelegate {
    ...
    public final yh0 f37402b;
    public final TLRPC.TL_chatInviteExported f37403c;

    public ih0(yh0 yh0Var, TLRPC.TL_chatInviteExported tL_chatInviteExported, int i10) {
        this.f37401a = i10;
        this.f37402b = yh0Var;
        this.f37403c = tL_chatInviteExported;
    }
    ...
    public final void run(final TLObject tLObject, final TLRPC.TL_error tL_error) {
        switch (this.f37401a) {
            case 0:
                final yh0 yh0Var = this.f37402b;
                final TLRPC.TL_chatInviteExported tL_chatInviteExported = this.f37403c;
                        ...
                        switch (r5) {
                            case 0:
                                if (tL_error == null) {
                                    ...
                                    yh0 yh0Var2 = yh0Var;
                                    yh0Var2.f43154e = tL_chatInviteExported2;
                                    ...
                                    if (yh0Var2.getParentActivity() != null) {
                                        ...
                                        ph0 f02 = yh0Var2.f0();
                                        yh0Var2.f43161j0.add(0, tL_chatInviteExported3);
                                        yh0Var2.h0(f02);
                            ...
                            default:
                                yh0 yh0Var3 = yh0Var;
                                ArrayList arrayList = yh0Var3.f43160i0;
                                if (tL_error == null) {
                                    ...
                                    if (z10) {
                                        ...
                                        if (!yh0Var3.f43166o0) {
                                            yh0Var3.f43154e = (TLRPC.TL_chatInviteExported) tL_messages_exportedChatInviteReplaced.new_invite;
                                        }
                                        tL_chatInviteExported4.revoked = true;
                                        ph0 f03 = yh0Var3.f0();
                                        if (yh0Var3.f43166o0 && yh0Var3.f43156f == yh0Var3.getAccountInstance().getUserConfig().getClientUserId()) {
                                        ...
                                        } else if (yh0Var3.f43154e != null) {
                                            yh0Var3.f43154e = (TLRPC.TL_chatInviteExported) tL_messages_exportedChatInviteReplaced.new_invite;
                                        }
                                        yh0Var3.f43161j0.add(0, tL_chatInviteExported4);
                                        yh0Var3.h0(f03);
                                    } else {
                                        yh0Var3.f43172s0.b(tL_chatInviteExported4, tLObject2);
                                        ...
                                        if (chatFull2 != null) {
                                            ...
                                            yh0Var3.getMessagesStorage().saveChatLinksCount(yh0Var3.f43164n, yh0Var3.d.invitesCount);
                                        }
                                    }
                ...
                return;
            case 1:
                yh0 yh0Var2 = this.f37402b;
                yh0Var2.getClass();
                AndroidUtilities.runOnUIThread(new pf0(yh0Var2, tL_error, this.f37403c, 5));
                return;
            default:
                final yh0 yh0Var3 = this.f37402b;
                final TLRPC.TL_chatInviteExported tL_chatInviteExported2 = this.f37403c;
                AndroidUtilities.runOnUIThread(new Runnable() {
                    @Override
                    public final void run() {
                        switch (r5) {
                            case 0:
                                if (tL_error == null) {
                                    ...
                                    yh0Var22.f43154e = tL_chatInviteExported22;
                                    ...
                                    if (yh0Var22.getParentActivity() != null) {
                                        ...
                                        tL_chatInviteExported3.revoked = true;
                                        ph0 f02 = yh0Var22.f0();
                                        yh0Var22.f43161j0.add(0, tL_chatInviteExported3);
                                        yh0Var22.h0(f02);
                            ...
                            default:
                                ...
                                ArrayList arrayList = yh0Var32.f43160i0;
                                if (tL_error == null) {
                                    TLObject tLObject2 = tLObject;
                                    boolean z10 = tLObject2 instanceof TLRPC.TL_messages_exportedChatInviteReplaced;
                                    ...
                                    if (z10) {
                                        TLRPC.TL_messages_exportedChatInviteReplaced tL_messages_exportedChatInviteReplaced = (TLRPC.TL_messages_exportedChatInviteReplaced) tLObject2;
                                        if (!yh0Var32.f43166o0) {
                                            yh0Var32.f43154e = (TLRPC.TL_chatInviteExported) tL_messages_exportedChatInviteReplaced.new_invite;
                                        }
                                        tL_chatInviteExported4.revoked = true;
                                        ph0 f03 = yh0Var32.f0();
                                        if (yh0Var32.f43166o0 && yh0Var32.f43156f == yh0Var32.getAccountInstance().getUserConfig().getClientUserId()) {
                                            arrayList.remove(tL_chatInviteExported4);
                                            arrayList.add(0, (TLRPC.TL_chatInviteExported) tL_messages_exportedChatInviteReplaced.new_invite);
                                        } else if (yh0Var32.f43154e != null) {
                                            yh0Var32.f43154e = (TLRPC.TL_chatInviteExported) tL_messages_exportedChatInviteReplaced.new_invite;
                                        }
                                        yh0Var32.f43161j0.add(0, tL_chatInviteExported4);
                                        yh0Var32.h0(f03);
                                    } else {
                                        yh0Var32.f43172s0.b(tL_chatInviteExported4, tLObject2);
                                        ...
                                        if (chatFull2 != null) {
                                            ...
                                            yh0Var32.getMessagesStorage().saveChatLinksCount(yh0Var32.f43164n, yh0Var32.d.invitesCount);
                                        }
                                    }
