    ...
    public final Object e(z4.g gVar, int i10) {
        ...
        switch (this.f33327c) {
            case 0:
                ...
                textView.setTag(f80Var.f33578a);
                TextView textView2 = new TextView(gVar.getContext());
                textView2.setTag(f80Var.f33579b);
            ...
            default:
                ...
                int i13 = mx0Var.f35908a;
                String str = mx0Var.d;
                CharSequence charSequence = mx0Var.f35910c;
                int i14 = 8;
                TextView textView3 = w0Var.f42556b;
                org.telegram.ui.Components.c90 c90Var = w0Var.f42557c;
                if (i13 != 0 && i13 != 14 && i13 != 28) {
                    if (x0Var.E) {
                        int i15 = x0Var.f42572y;
                        if (i15 == 4) {
