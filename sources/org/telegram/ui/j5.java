...
public final class j5 implements RequestDelegate {
    ...
    public final v5 f37507b;
    public final CountDownLatch f37508c;
    public final Runnable d;

    public j5(v5 v5Var, CountDownLatch countDownLatch, Runnable runnable, int i10) {
        this.f37506a = i10;
        this.f37507b = v5Var;
        this.f37508c = countDownLatch;
        this.d = runnable;
    }
    ...
    public final void run(final TLObject tLObject, TLRPC.TL_error tL_error) {
        switch (this.f37506a) {
            case 0:
                final v5 v5Var = this.f37507b;
                final CountDownLatch countDownLatch = this.f37508c;
                        ...
                        switch (r5) {
                            case 0:
                                ...
                                if (tLObject2 != null) {
                                    ...
                                    v5Var2.f41421i0 = tL_premium_boostsList.next_offset;
                                    ...
                                    while (true) {
                                        ...
                                        if (i11 < size) {
                                            ...
                                            v5Var2.Y = z10;
                                            v5Var2.f41424l0 = tL_premium_boostsList.count;
                            ...
                            default:
                                ...
                                if (tLObject3 != null) {
                                    ...
                                    v5Var3.f41420h0 = tL_premium_boostsList2.next_offset;
                ...
                return;
            default:
                final v5 v5Var2 = this.f37507b;
                final CountDownLatch countDownLatch2 = this.f37508c;
                        ...
                        switch (r5) {
                            case 0:
                                ...
                                if (tLObject2 != null) {
                                    ...
                                    v5Var22.f41421i0 = tL_premium_boostsList.next_offset;
                                    arrayList.addAll(tL_premium_boostsList.boosts);
                                    int size = arrayList.size();
                                    int i10 = 0;
                                    int i11 = 0;
                                    while (true) {
                                        ...
                                        if (i11 < size) {
                                            ...
                                            v5Var22.Y = z10;
                                            v5Var22.f41424l0 = tL_premium_boostsList.count;
