...
public abstract class uf1 extends org.telegram.ui.Components.ia {
    public static final int f38465h3 = 0;
    public boolean f38466d3;
    public boolean f38467e3;
    public float f38468f3;
    public final wf1 f38469g3;

    public uf1(wf1 wf1Var, Context context) {
        super(context, null);
        this.f38469g3 = wf1Var;
        this.f38466d3 = true;
        new Paint();
        new RectF();
        this.f30383h1 = true;
    ...
    public final void addView(View view, int i10, ViewGroup.LayoutParams layoutParams) {
        ...
        view.setTranslationY(this.f38468f3);
    ...
    public final void dispatchDraw(Canvas canvas) {
        wf1 wf1Var = this.f38469g3;
        if (wf1Var.f39312b1 != null) {
            canvas.save();
            canvas.translate(wf1Var.f39312b1.getLeft(), wf1Var.f39312b1.getY());
            wf1Var.f39312b1.draw(canvas);
            canvas.restore();
        }
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        y1();
        if (this.f38469g3.f39312b1 == view) {
            return true;
        }
    ...
    public final void onDraw(Canvas canvas) {
        wf1 wf1Var = this.f38469g3;
        if (wf1Var.f39347w != null && this.f38468f3 != 0.0f) {
            int paddingTop = getPaddingTop();
            if (paddingTop != 0) {
                canvas.save();
                canvas.translate(0.0f, paddingTop);
            }
            wf1Var.f39347w.c(canvas, true);
            if (paddingTop != 0) {
                canvas.restore();
            }
        }
        ...
        if (!this.X1) {
            ...
            if (wf1Var.getParentLayout() == null || !((ActionBarLayout) wf1Var.getParentLayout()).y()) {
                ...
                if (action == 1 || action == 3) {
                    af1 af1Var = wf1Var.O;
                    if (af1Var.f43108y != 0 && wf1Var.P.d && af1Var.g(null, 4) != 0) {
                        wf1Var.P.getClass();
                    }
                }
                boolean onTouchEvent = super.onTouchEvent(motionEvent);
                if ((action == 1 || action == 3) && wf1Var.f39351y == 2 && wf1Var.f39349x > 0 && (L0 = (c0Var = (s4.c0) getLayoutManager()).L0()) == 0) {
                    int paddingTop = getPaddingTop();
                    View m10 = c0Var.m(L0);
                    ...
                    float f10 = this.f38468f3;
                    if (f10 != 0.0f) {
                        ValueAnimator ofFloat = ValueAnimator.ofFloat(f10, 0.0f);
                        ofFloat.addUpdateListener(new q11(this, 19));
                        ofFloat.setDuration(Math.max(100L, org.telegram.messenger.ok.b(this.f38468f3, AndroidUtilities.dp(72.0f), 120.0f, 350.0f)));
