...
public final class pc0 extends org.telegram.ui.ActionBar.n2 {
    public FrameLayout f36558a;
    public org.telegram.ui.Components.yl0 f36559b;
    public s4.c0 f36560c;
    public uu d;
    public org.telegram.ui.Components.pc e;
    public int f36561f;
    public final s3 h;
    public final boolean[] f36562n;
    public final ArrayList f36563r;
    public final ArrayList f36564s;

    public pc0() {
        super(null);
        this.h = new s3(this, 7);
        this.f36562n = new boolean[3];
        this.f36563r = new ArrayList();
        this.f36564s = new ArrayList();
    }
    ...
    public final void V(int i10) {
        int i11 = 0;
        while (true) {
            ArrayList arrayList = this.f36564s;
            if (i11 < arrayList.size()) {
                if (((jc0) arrayList.get(i11)).e == i10) {
                    this.f36559b.f1(new i2.s(this, i11, 12), 700, true);
                    return;
                }
                i11++;
            } else {
    ...
    public final void X() {
        String formatString;
        ArrayList arrayList = this.f36563r;
        arrayList.clear();
        ArrayList arrayList2 = this.f36564s;
        ...
        arrayList2.add(jc0.c(R.drawable.msg2_ask_question, this.f36561f, LocaleController.getString(R.string.LiteOptionsChat)));
        if (zArr[2]) {
    ...
    public final void Y() {
        ...
        if (this.f36559b != null) {
            for (int i10 = 0; i10 < this.f36559b.getChildCount(); i10++) {
                View childAt = this.f36559b.getChildAt(i10);
                if (childAt != null) {
                    this.f36559b.getClass();
                        ...
                        if (S < arrayList.size()) {
                            ...
                            if (i11 != 3 && i11 != 4) {
                                ...
                                if (i11 == 3) {
                                    ...
                                    oc0Var.f36286f.c(LiteMode.isEnabled(i12), true);
                                } else {
    ...
    public final View createView(Context context) {
        ...
        this.f36559b = yl0Var;
        yl0Var.q1();
        org.telegram.ui.Components.yl0 yl0Var2 = this.f36559b;
        s4.c0 c0Var = new s4.c0();
        this.f36560c = c0Var;
        yl0Var2.setLayoutManager(c0Var);
        org.telegram.ui.Components.yl0 yl0Var3 = this.f36559b;
        ...
        jVar.C = false;
        jVar.f43030m = false;
        this.f36559b.setItemAnimator(jVar);
        this.f36558a.addView(this.f36559b, w7.y5.c(-1.0f, -1));
        this.f36559b.setOnItemClickListener(new fu(this, 17));
        this.fragmentView = this.f36558a;
        if (AndroidUtilities.isTablet()) {
            i10 = 360864;
        } else {
            i10 = 360928;
