...
public final class pc0 extends org.telegram.ui.ActionBar.o2 {
    public FrameLayout f36597a;
    public org.telegram.ui.Components.ml0 f36598b;
    public s4.c0 f36599c;
    public vu d;
    public org.telegram.ui.Components.oc e;
    public int f36600f;
    public final s3 h;
    public final boolean[] f36601n;
    public final ArrayList f36602r;
    public final ArrayList f36603s;

    public pc0() {
        super(null);
        this.h = new s3(this, 7);
        this.f36601n = new boolean[3];
        this.f36602r = new ArrayList();
        this.f36603s = new ArrayList();
    }
    ...
    public final void V(int i10) {
        int i11 = 0;
        while (true) {
            ArrayList arrayList = this.f36603s;
            if (i11 < arrayList.size()) {
                if (((jc0) arrayList.get(i11)).e == i10) {
                    this.f36598b.f1(new i2.s(this, i11, 12), 700, true);
                    return;
                }
                i11++;
            } else {
    ...
    public final void X() {
        String formatString;
        ArrayList arrayList = this.f36602r;
        arrayList.clear();
        ArrayList arrayList2 = this.f36603s;
        ...
        arrayList2.add(jc0.c(R.drawable.msg2_ask_question, this.f36600f, LocaleController.getString(R.string.LiteOptionsChat)));
        if (zArr[2]) {
    ...
    public final void Y() {
        ...
        if (this.f36598b != null) {
            for (int i10 = 0; i10 < this.f36598b.getChildCount(); i10++) {
                View childAt = this.f36598b.getChildAt(i10);
                if (childAt != null) {
                        ...
                        if (S < arrayList.size()) {
                            ...
                            if (i11 != 3 && i11 != 4) {
                                ...
                                if (i11 == 3) {
                                    ...
                                    oc0Var.f36302f.c(LiteMode.isEnabled(i12), true);
                                } else {
    ...
    public final View createView(Context context) {
        ...
        this.f36598b = ml0Var;
        ml0Var.q1();
        org.telegram.ui.Components.ml0 ml0Var2 = this.f36598b;
        s4.c0 c0Var = new s4.c0();
        this.f36599c = c0Var;
        ml0Var2.setLayoutManager(c0Var);
        org.telegram.ui.Components.ml0 ml0Var3 = this.f36598b;
        ...
        jVar.C = false;
        jVar.f42737m = false;
        this.f36598b.setItemAnimator(jVar);
        this.f36597a.addView(this.f36598b, w7.x5.c(-1.0f, -1));
        this.f36598b.setOnItemClickListener(new gu(this, 17));
        this.fragmentView = this.f36597a;
        if (AndroidUtilities.isTablet()) {
            i10 = 360864;
        } else {
            i10 = 360928;
