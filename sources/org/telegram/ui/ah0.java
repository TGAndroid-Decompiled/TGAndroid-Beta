...
public final class ah0 extends org.telegram.ui.Components.g6 {
    ...
    public final le.c Q;
    public final me.b R;
    public final org.telegram.ui.ActionBar.d6 f32164s;
    public int v;
    public float[] f32165w;
    public float[] f32166x;
    public int[] f32167y;
    ...
    public ah0(Context context, org.telegram.ui.ActionBar.d6 d6Var) {
        ...
        new ArrayList();
        new ArrayList();
        o1.c cVar = o1.h.f15521s;
        o1.c cVar2 = o1.h.f15520r;
        o1.c cVar3 = o1.h.f15517o;
        o1.c cVar4 = o1.h.f15519q;
        new o1.l(1.0f);
        new ArrayList();
        new ArrayList();
        o1.c cVar5 = o1.h.f15518p;
        new o1.l(1.0f);
        o1.k kVar = new o1.k(this, new org.telegram.ui.Components.qb(1));
        this.K = kVar;
        o1.k kVar2 = new o1.k(this, new org.telegram.ui.Components.qb(2));
        this.L = kVar2;
        kVar.f15533u = org.telegram.ui.Cells.c1.l(1.0f, 1500.0f, 0.75f);
    ...
    public static void m(ah0 ah0Var, float f7, boolean z10, boolean z11) {
        ...
        if (z10) {
            ...
            while (true) {
                ...
                if (childAt3.getVisibility() == 0 && (childAt3 instanceof oh.b) && ((oh.b) childAt3).h.f14201f) {
                    view2 = childAt3;
                    break;
                }
                i12++;
            ...
            if (view2 != null) {
                ...
                if (kVar2.f15526f) {
                    ...
                    if (kVar2.f15533u == null) {
                        kVar2.f15533u = new o1.l(0.0f);
                    }
                    kVar2.f15533u.f15539i = 0.0f;
                    kVar2.f();
                }
        ...
        if (view != null) {
            ...
            if (z11) {
                ...
                if (0.0f != width3 || 0.0f != x10) {
                    ...
                    if (kVar.f15533u == null) {
                        kVar.f15533u = new o1.l(x10);
                    }
                    kVar.f15533u.f15539i = x10;
                    kVar.f();
                }
            }
        }
    ...
    public void setSkipDrawSelector(boolean z10) {
        this.I = z10;
        if (z10) {
            this.J.setColor(org.telegram.ui.ActionBar.h6.l1(0.09f, org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.al, this.f32164s)));
        }
    ...
    public final void o() {
        ...
        for (int i10 = 0; i10 < entriesCount; i10++) {
            le.h n10 = this.f24375c.n(i10);
            ((oh.b) ((org.telegram.ui.Components.f6) n10.f14210a).f24082a).setVisualWidth(n10.b().width());
        }
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        while (true) {
            ...
            if (i15 < 3) {
                if (fArr[i15] != f12) {
                    int childCount = getChildCount();
                    float[] fArr2 = this.f32165w;
                    if (fArr2 == null || fArr2.length < childCount) {
                        this.f32165w = new float[childCount];
                        this.f32166x = new float[childCount];
                        this.f32167y = new int[childCount];
                    ...
                    for (int i17 = 0; i17 < childCount; i17++) {
                        ...
                        if (!d(childAt)) {
                            ...
                            if (childAt instanceof zg0) {
                                ...
                                f11 = bVar.T.measureText(bVar.f15728a.getText().toString());
                            } else {
                                f11 = 0.0f;
                            }
                            this.f32165w[i17] = f11;
        ...
        for (int i19 = 0; i19 < childCount3; i19++) {
            ...
            if (childAt2 instanceof zg0) {
                ((oh.b) ((zg0) childAt2)).setTextSizeDp(f15);
            }
        }
        ...
        for (int i21 = 0; i21 < childCount4; i21++) {
            if (!d(getChildAt(i21))) {
                float[] fArr3 = this.f32165w;
                this.f32166x[i21] = f7;
                fArr3[i21] = f7;
                this.f32167y[i21] = i12;
            } else {
                float[] fArr4 = this.f32166x;
                float f17 = this.f32165w[i21] + dp2;
                fArr4[i21] = f17;
                int[] iArr2 = this.f32167y;
                if (f17 > max + dp2) {
                    i13 = 0;
                } else {
                    i13 = 1;
        ...
        if (i20 == 0) {
            ...
            for (int i22 = 0; i22 < childCount5; i22++) {
                this.f32167y[i22] = d(getChildAt(i22)) ? 1 : 0;
            }
            i20 = this.G;
        }
        ...
        if (f16 > f18) {
            ...
            if (f16 < f20) {
                ...
                for (int i24 = 0; i24 < childCount7; i24++) {
                    float[] fArr6 = this.f32166x;
                    fArr6[i24] = (this.f32167y[i24] * f21) + fArr6[i24];
                }
            }
        }
        ...
        for (int i26 = 0; i26 < childCount8; i26++) {
            if (d(getChildAt(i26))) {
                this.E[i26] = Math.round(this.f32166x[i26]);
                this.F[i26] = i25;
                i25 += this.E[i26];
            }
        }
