    ...
    public final void run() {
        ...
        switch (this.f34476a) {
            ...
            case 3:
                ...
                return;
            case 4:
                AndroidUtilities.removeFromParent(this.f34477b.Q);
                return;
            case 5:
                eh0 eh0Var2 = this.f34477b;
                eh0Var2.getClass();
                new ek0(eh0Var2.getParentActivity(), eh0Var2).show();
                return;
            case 6:
                eh0 eh0Var3 = this.f34477b;
                eh0Var3.getClass();
                ...
                return;
            default:
                eh0 eh0Var4 = this.f34477b;
                if (eh0Var4.getParentActivity() != null && (bVarArr = eh0Var4.K) != null) {
                    ph.b bVar = bVarArr[4];
                    float width = ((bVar.getWidth() / 2.0f) + (eh0Var4.f34842b.getWidth() - ((bVar.getX() + eh0Var4.F.getX()) + bVar.getWidth()))) / AndroidUtilities.density;
                    ...
                    eh0Var4.f34842b.addView(eh0Var4.Q, w7.x5.d(-1, 100.0f, 87, 0.0f, 0.0f, 0.0f, 72.0f));
                    di.f4 f4Var2 = eh0Var4.Q;
                    f4Var2.f7238l0 = new ah0(eh0Var4, 4);
                    f4Var2.d = 8000L;
                    f4Var2.u();
                    org.telegram.ui.Components.j40.f27364r.b();
                    return;
                }
                return;
        }
