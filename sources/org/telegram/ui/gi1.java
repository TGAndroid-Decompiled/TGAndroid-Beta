...
public final class gi1 implements org.telegram.ui.Components.voip.d {
    ...
    public final void a() {
        ...
        } else if (Build.VERSION.SDK_INT >= 23 && ii1Var.f34947b.checkSelfPermission("android.permission.RECORD_AUDIO") != 0) {
            ii1Var.f34947b.requestPermissions(new String[]{"android.permission.RECORD_AUDIO"}, 101);
