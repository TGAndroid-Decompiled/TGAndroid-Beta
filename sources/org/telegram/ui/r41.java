...
public final class r41 extends og.b {
    ...
    @Override
    public final int h() {
        return this.d.f31739s.size();
    }

    @Override
    public final int j(int i10) {
        return ((s41) this.d.f31739s.get(i10)).f15719a;
    }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (((s41) arrayList.get(i10)).f15719a == 1) {
            ...
            if (i10 == saveToGallerySettingsActivity.h) {
                ...
                int i12 = saveToGallerySettingsActivity.f31733a;
                if (i12 == 1) {
        ...
        } else if (((s41) arrayList.get(i10)).f15719a == 5) {
            ...
            abVar.d(userOrChat, str, dialogException.createDescription(i11), (i10 == arrayList.size() - 1 || ((s41) arrayList.get(i10 + 1)).f15719a == 2) ? true : true);
        }
    }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        switch (i10) {
            ...
            case 8:
                ...
                linearLayout2.addView(uo0Var, w7.y5.t(-1, 38, 0, 5, 0, 5, 4));
                long j3 = saveToGallerySettingsActivity.X().limitVideo;
                ...
                uo0Var.f28868w.X(uo0Var.getProgress(), false);
                linearLayout2.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19109d6, false));
            ...
            case 9:
                ...
                if (DialogObject.isUserDialog(saveToGallerySettingsActivity.f31734b)) {
                    i12 = ((org.telegram.ui.ActionBar.n2) saveToGallerySettingsActivity).currentAccount;
                    chat = MessagesController.getInstance(i12).getUser(Long.valueOf(saveToGallerySettingsActivity.f31734b));
                } else {
                    i11 = ((org.telegram.ui.ActionBar.n2) saveToGallerySettingsActivity).currentAccount;
                    chat = MessagesController.getInstance(i11).getChat(Long.valueOf(-saveToGallerySettingsActivity.f31734b));
                }
                zaVar2.a(chat, null);
                zaVar2.setBackgroundColor(saveToGallerySettingsActivity.getThemedColor(org.telegram.ui.ActionBar.j6.f19109d6));
                zaVar = zaVar2;
                view = zaVar;
                break;
            case 10:
                View c7Var = new org.telegram.ui.Cells.c7(viewGroup.getContext(), (org.telegram.ui.Cells.c1) null);
                c7Var.setBackgroundDrawable(org.telegram.ui.ActionBar.j6.U0(saveToGallerySettingsActivity.getParentActivity(), R.drawable.greydivider_bottom, org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19073b7, saveToGallerySettingsActivity.getResourceProvider())));
                zaVar = c7Var;
                view = zaVar;
                break;
        }
