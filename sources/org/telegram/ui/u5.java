...
public final class u5 extends og.a {
    ...
    public final boolean equals(Object obj) {
        ...
        if (boost2.f18566id.hashCode() == boost.f18566id.hashCode() && z10 == z11 && this.f38325g == u5Var.f38325g) {
            return true;
        }
        return false;
    }
    ...
    public final int hashCode() {
        return Objects.hash(this.f38323c, this.d, this.e, Boolean.valueOf(this.f38324f), Integer.valueOf(this.f38325g));
    }
