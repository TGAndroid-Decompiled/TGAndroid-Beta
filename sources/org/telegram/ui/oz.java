...
public final class oz extends org.telegram.ui.ActionBar.o2 {
    public long f36464a;
    public TLRPC.Chat f36465b;
    public boolean f36466c;
    public boolean d;
    public lz e;
    public ai.m0 f36467f;
    ...
    public final View createView(Context context) {
        ...
        this.e = f61Var;
        f61Var.q1();
        this.e.setBackgroundColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f18807a7, this.resourceProvider));
    ...
    public final boolean onFragmentCreate() {
        this.f36465b = getMessagesController().getChat(Long.valueOf(-this.f36464a));
