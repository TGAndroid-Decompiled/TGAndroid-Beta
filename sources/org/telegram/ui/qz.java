...
public final class qz implements View.OnClickListener {
    ...
    public final void onClick(View view) {
        switch (this.f37145a) {
            case 0:
                wz wzVar = this.f37146b;
                String str = wzVar.f37548s;
                if (str != null) {
                    AndroidUtilities.addToClipboard(str);
                    org.telegram.messenger.ok.o(R.string.LinkCopied, org.telegram.ui.Components.xc.a0(wzVar.f37547r));
                    return;
                }
                return;
            case 1:
                wz wzVar2 = this.f37146b;
                FrameLayout frameLayout = wzVar2.f37542a;
                ...
                float[] fArr = wzVar2.f37551y;
                if (wzVar2.f37550x == null && wzVar2.f37548s != null) {
                    ...
                    FrameLayout overlayContainerView = wzVar2.f37547r.getParentLayout().getOverlayContainerView();
                    if (overlayContainerView != null) {
                        ...
                        wzVar2.f37550x = m1Var;
                        m1Var.setOnDismissListener(new org.telegram.ui.Components.c90(wzVar2, r6Var, overlayContainerView, biVar, 1));
                        wzVar2.f37550x.setOutsideTouchable(true);
                        wzVar2.f37550x.setFocusable(true);
                        wzVar2.f37550x.setBackgroundDrawable(new ColorDrawable(0));
                        wzVar2.f37550x.setAnimationStyle(R.style.PopupContextAnimation);
                        wzVar2.f37550x.setInputMethodMode(2);
                        wzVar2.f37550x.setSoftInputMode(0);
                        ...
                        wzVar2.f37550x.showAtLocation(overlayContainerView, 0, (int) (overlayContainerView.getX() + ((overlayContainerView.getMeasuredWidth() - actionBarPopupWindow$ActionBarPopupWindowLayout.getMeasuredWidth()) - AndroidUtilities.dp(16.0f)) + f10), (int) (overlayContainerView.getY() + f7 + frameLayout.getMeasuredHeight()));
                        return;
                    }
                    return;
                }
                return;
            case 2:
                wz wzVar3 = this.f37146b;
                String str2 = wzVar3.f37548s;
                if (str2 != null) {
                    AndroidUtilities.addToClipboard(str2);
                    org.telegram.messenger.ok.o(R.string.LinkCopied, org.telegram.ui.Components.xc.a0(wzVar3.f37547r));
                    return;
                }
                return;
            case 3:
                wz wzVar4 = this.f37146b;
                if (wzVar4.f37548s != null) {
                    try {
                        Intent intent = new Intent("android.intent.action.SEND");
                        intent.setType("text/plain");
                        intent.putExtra("android.intent.extra.TEXT", wzVar4.f37548s);
                        wzVar4.f37547r.startActivityForResult(Intent.createChooser(intent, LocaleController.getString(R.string.InviteToGroupByLink)), 500);
                        return;
                    } catch (Exception e) {
                        FileLog.e(e);
                        return;
                ...
                return;
            case 4:
                wz wzVar5 = this.f37146b;
                org.telegram.ui.ActionBar.m1 m1Var2 = wzVar5.f37550x;
                if (m1Var2 != null) {
                    m1Var2.d(true);
                }
                yz yzVar = wzVar5.E.f40008c;
                ...
                if (tL_exportedChatlistInvite != null && tL_exportedChatlistInvite.url != null) {
                    ...
                    alertDialog$Builder.f18662a.I = org.telegram.ui.ActionBar.h6.H5;
                    alertDialog$Builder.f18662a.R = LocaleController.getString(R.string.FilterInviteEditName);
                    ...
                    editTextBoldCursor.setHint(yzVar.f40287c.name);
                    editTextBoldCursor.setHintTextColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19354t5, false));
                ...
                return;
            case 5:
                wz wzVar6 = this.f37146b;
                org.telegram.ui.ActionBar.m1 m1Var3 = wzVar6.f37550x;
                if (m1Var3 != null) {
                    m1Var3.d(true);
                }
                if (wzVar6.f37548s != null) {
                    org.telegram.ui.Components.ui0 ui0Var = new org.telegram.ui.Components.ui0(wzVar6.getContext(), LocaleController.getString(R.string.InviteByQRCode), wzVar6.f37548s, LocaleController.getString(R.string.QRCodeLinkHelpFolder), false);
                ...
                return;
            default:
                wz wzVar7 = this.f37146b;
                org.telegram.ui.ActionBar.m1 m1Var4 = wzVar7.f37550x;
                if (m1Var4 != null) {
                    m1Var4.d(true);
                }
                ...
                yz yzVar2 = wzVar7.E.f40008c;
                tL_inputChatlistDialogFilter.filter_id = yzVar2.f40287c.f15832id;
