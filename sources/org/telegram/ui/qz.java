...
public final class qz implements View.OnClickListener {
    ...
    public final void onClick(View view) {
        switch (this.f37143a) {
            case 0:
                wz wzVar = this.f37144b;
                String str = wzVar.f37546s;
                if (str != null) {
                    AndroidUtilities.addToClipboard(str);
                    org.telegram.messenger.ok.o(R.string.LinkCopied, org.telegram.ui.Components.xc.a0(wzVar.f37545r));
                    return;
                }
                return;
            case 1:
                wz wzVar2 = this.f37144b;
                FrameLayout frameLayout = wzVar2.f37540a;
                ...
                float[] fArr = wzVar2.f37549y;
                if (wzVar2.f37548x == null && wzVar2.f37546s != null) {
                    ...
                    FrameLayout overlayContainerView = wzVar2.f37545r.getParentLayout().getOverlayContainerView();
                    if (overlayContainerView != null) {
                        ...
                        wzVar2.f37548x = m1Var;
                        m1Var.setOnDismissListener(new org.telegram.ui.Components.d90(wzVar2, r6Var, overlayContainerView, biVar, 1));
                        wzVar2.f37548x.setOutsideTouchable(true);
                        wzVar2.f37548x.setFocusable(true);
                        wzVar2.f37548x.setBackgroundDrawable(new ColorDrawable(0));
                        wzVar2.f37548x.setAnimationStyle(R.style.PopupContextAnimation);
                        wzVar2.f37548x.setInputMethodMode(2);
                        wzVar2.f37548x.setSoftInputMode(0);
                        ...
                        wzVar2.f37548x.showAtLocation(overlayContainerView, 0, (int) (overlayContainerView.getX() + ((overlayContainerView.getMeasuredWidth() - actionBarPopupWindow$ActionBarPopupWindowLayout.getMeasuredWidth()) - AndroidUtilities.dp(16.0f)) + f10), (int) (overlayContainerView.getY() + f7 + frameLayout.getMeasuredHeight()));
                        return;
                    }
                    return;
                }
                return;
            case 2:
                wz wzVar3 = this.f37144b;
                String str2 = wzVar3.f37546s;
                if (str2 != null) {
                    AndroidUtilities.addToClipboard(str2);
                    org.telegram.messenger.ok.o(R.string.LinkCopied, org.telegram.ui.Components.xc.a0(wzVar3.f37545r));
                    return;
                }
                return;
            case 3:
                wz wzVar4 = this.f37144b;
                if (wzVar4.f37546s != null) {
                    try {
                        Intent intent = new Intent("android.intent.action.SEND");
                        intent.setType("text/plain");
                        intent.putExtra("android.intent.extra.TEXT", wzVar4.f37546s);
                        wzVar4.f37545r.startActivityForResult(Intent.createChooser(intent, LocaleController.getString(R.string.InviteToGroupByLink)), 500);
                        return;
                    } catch (Exception e) {
                        FileLog.e(e);
                        return;
                ...
                return;
            case 4:
                wz wzVar5 = this.f37144b;
                org.telegram.ui.ActionBar.m1 m1Var2 = wzVar5.f37548x;
                if (m1Var2 != null) {
                    m1Var2.d(true);
                }
                yz yzVar = wzVar5.E.f40006c;
                ...
                if (tL_exportedChatlistInvite != null && tL_exportedChatlistInvite.url != null) {
                    ...
                    editTextBoldCursor.setHint(yzVar.f40285c.name);
                ...
                return;
            case 5:
                wz wzVar6 = this.f37144b;
                org.telegram.ui.ActionBar.m1 m1Var3 = wzVar6.f37548x;
                if (m1Var3 != null) {
                    m1Var3.d(true);
                }
                if (wzVar6.f37546s != null) {
                    org.telegram.ui.Components.vi0 vi0Var = new org.telegram.ui.Components.vi0(wzVar6.getContext(), LocaleController.getString(R.string.InviteByQRCode), wzVar6.f37546s, LocaleController.getString(R.string.QRCodeLinkHelpFolder), false);
                ...
                return;
            default:
                wz wzVar7 = this.f37144b;
                org.telegram.ui.ActionBar.m1 m1Var4 = wzVar7.f37548x;
                if (m1Var4 != null) {
                    m1Var4.d(true);
                }
                ...
                yz yzVar2 = wzVar7.E.f40006c;
                tL_inputChatlistDialogFilter.filter_id = yzVar2.f40285c.f15832id;
