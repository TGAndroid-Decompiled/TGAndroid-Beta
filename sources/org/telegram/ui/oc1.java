...
public final class oc1 implements org.telegram.ui.ActionBar.d6 {
    public org.telegram.ui.ActionBar.d6 f36140a;
    public final SparseIntArray f36141b = new SparseIntArray();
    public final Paint f36142c = new Paint(3);
    public final Paint d = new Paint(3);
    public final Paint e;
    public final TextPaint f36143f;
    public final TextPaint h;
    public final TextPaint f36144n;
    public Bitmap f36145r;
    public BitmapShader f36146s;
    public Matrix v;
    public final od1 f36147w;
    public final od1 f36148x;
    ...
    public oc1(od1 od1Var) {
        ...
        this.f36143f = textPaint;
        TextPaint textPaint2 = new TextPaint();
        this.h = textPaint2;
        TextPaint textPaint3 = new TextPaint();
        this.f36144n = textPaint3;
    ...
    public final Paint G(String str) {
        ...
        switch (c10) {
            ...
            case 5:
                return this.f36143f;
            default:
                org.telegram.ui.ActionBar.d6 d6Var = this.f36140a;
                if (d6Var != null) {
                    return d6Var.G(str);
                }
    ...
    public final boolean a() {
        fd1 fd1Var = this.f36148x.f36196p1;
        if (fd1Var != null) {
            return fd1Var.a();
        }
        fd1 fd1Var2 = this.f36147w.f36196p1;
        if (fd1Var2 != null) {
            return fd1Var2.a();
        }
        org.telegram.ui.ActionBar.d6 d6Var = this.f36140a;
    ...
    public final void b(Drawable drawable, Drawable drawable2, Float f7) {
        ...
        float f12;
        float f13;
        int i10 = org.telegram.ui.ActionBar.h6.f19211lc;
        int G0 = G0(i10);
        int G02 = G0(org.telegram.ui.ActionBar.h6.f19230mc);
        if (drawable == null) {
            drawable = drawable2;
        }
        boolean z10 = drawable instanceof org.telegram.ui.Components.mc0;
        TextPaint textPaint = this.h;
        TextPaint textPaint2 = this.f36143f;
        if ((z10 || (drawable instanceof BitmapDrawable)) && SharedConfig.getDevicePerformanceClass() != 0 && LiteMode.isEnabled(32)) {
            if (z10) {
                bitmap = ((org.telegram.ui.Components.mc0) drawable).f26443k;
            } else if (drawable instanceof BitmapDrawable) {
                bitmap = ((BitmapDrawable) drawable).getBitmap();
            } else {
                bitmap = null;
            }
            if (this.f36145r != bitmap) {
                this.f36145r = bitmap;
                Bitmap bitmap2 = this.f36145r;
                Shader.TileMode tileMode = Shader.TileMode.CLAMP;
                this.f36146s = new BitmapShader(bitmap2, tileMode, tileMode);
                if (this.v == null) {
                    this.v = new Matrix();
                }
            }
            ...
            textPaint2.linkColor = G0(org.telegram.ui.ActionBar.h6.f19173jc);
        }
        Paint paint = this.f36142c;
        paint.setColor(G0);
        Paint paint2 = this.d;
        paint2.setColor(G02);
        if (this.f36146s != null && (this.f36141b.indexOfKey(i10) < 0 || z10 || (drawable instanceof BitmapDrawable))) {
            ColorMatrix colorMatrix = new ColorMatrix();
            if (z10) {
                float f14 = -0.06f;
                if (((org.telegram.ui.Components.mc0) drawable).f26449q >= 0.0f) {
            ...
            if (z10) {
                float f15 = ((org.telegram.ui.Components.mc0) drawable).f26449q;
                if (f7 != null) {
                    f15 = f7.floatValue();
                }
                if (f15 >= 0.0f) {
            ...
            paint.setShader(this.f36146s);
            paint.setColorFilter(new ColorMatrixColorFilter(colorMatrix));
            paint.setAlpha(255);
            paint2.setShader(this.f36146s);
    ...
    public final void m(float f7, float f10, int i10, int i11) {
        ...
        Bitmap bitmap = this.f36145r;
        if (bitmap != null && (bitmapShader = this.f36146s) != null) {
