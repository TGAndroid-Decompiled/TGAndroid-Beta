...
public final class oc1 implements org.telegram.ui.ActionBar.d6 {
    public org.telegram.ui.ActionBar.d6 f36115a;
    public final SparseIntArray f36116b = new SparseIntArray();
    public final Paint f36117c = new Paint(3);
    public final Paint d = new Paint(3);
    public final Paint e;
    public final TextPaint f36118f;
    public final TextPaint h;
    public final TextPaint f36119n;
    public Bitmap f36120r;
    public BitmapShader f36121s;
    public Matrix v;
    public final od1 f36122w;
    public final od1 f36123x;
    ...
    public oc1(od1 od1Var) {
        ...
        this.f36118f = textPaint;
        TextPaint textPaint2 = new TextPaint();
        this.h = textPaint2;
        TextPaint textPaint3 = new TextPaint();
        this.f36119n = textPaint3;
    ...
    public final Paint G(String str) {
        ...
        switch (c10) {
            ...
            case 5:
                return this.f36118f;
            default:
                org.telegram.ui.ActionBar.d6 d6Var = this.f36115a;
                if (d6Var != null) {
                    return d6Var.G(str);
                }
    ...
    public final boolean a() {
        fd1 fd1Var = this.f36123x.f36171p1;
        if (fd1Var != null) {
            return fd1Var.a();
        }
        fd1 fd1Var2 = this.f36122w.f36171p1;
        if (fd1Var2 != null) {
            return fd1Var2.a();
        }
        org.telegram.ui.ActionBar.d6 d6Var = this.f36115a;
    ...
    public final void b(Drawable drawable, Drawable drawable2, Float f7) {
        ...
        float f12;
        float f13;
        int i10 = org.telegram.ui.ActionBar.h6.f19196lc;
        int G0 = G0(i10);
        int G02 = G0(org.telegram.ui.ActionBar.h6.f19215mc);
        if (drawable == null) {
            drawable = drawable2;
        }
        boolean z10 = drawable instanceof org.telegram.ui.Components.mc0;
        TextPaint textPaint = this.h;
        TextPaint textPaint2 = this.f36118f;
        if ((z10 || (drawable instanceof BitmapDrawable)) && SharedConfig.getDevicePerformanceClass() != 0 && LiteMode.isEnabled(32)) {
            if (z10) {
                bitmap = ((org.telegram.ui.Components.mc0) drawable).f26435k;
            } else if (drawable instanceof BitmapDrawable) {
                bitmap = ((BitmapDrawable) drawable).getBitmap();
            } else {
                bitmap = null;
            }
            if (this.f36120r != bitmap) {
                this.f36120r = bitmap;
                Bitmap bitmap2 = this.f36120r;
                Shader.TileMode tileMode = Shader.TileMode.CLAMP;
                this.f36121s = new BitmapShader(bitmap2, tileMode, tileMode);
                if (this.v == null) {
                    this.v = new Matrix();
                }
            }
            ...
            textPaint2.linkColor = G0(org.telegram.ui.ActionBar.h6.f19158jc);
        }
        Paint paint = this.f36117c;
        paint.setColor(G0);
        Paint paint2 = this.d;
        paint2.setColor(G02);
        if (this.f36121s != null && (this.f36116b.indexOfKey(i10) < 0 || z10 || (drawable instanceof BitmapDrawable))) {
            ColorMatrix colorMatrix = new ColorMatrix();
            if (z10) {
                float f14 = -0.06f;
                if (((org.telegram.ui.Components.mc0) drawable).f26441q >= 0.0f) {
            ...
            if (z10) {
                float f15 = ((org.telegram.ui.Components.mc0) drawable).f26441q;
                if (f7 != null) {
                    f15 = f7.floatValue();
                }
                if (f15 >= 0.0f) {
            ...
            paint.setShader(this.f36121s);
            paint.setColorFilter(new ColorMatrixColorFilter(colorMatrix));
            paint.setAlpha(255);
            paint2.setShader(this.f36121s);
    ...
    public final void m(float f7, float f10, int i10, int i11) {
        ...
        Bitmap bitmap = this.f36120r;
        if (bitmap != null && (bitmapShader = this.f36121s) != null) {
