...
public class ChartHeaderView extends FrameLayout {
    ...
    public ChartHeaderView(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.back.setBackground(Theme.getRoundRectSelectorDrawable(AndroidUtilities.dp(3.0f), Theme.getColor(Theme.key_featuredStickers_removeButtonText, resourcesProvider)));
    ...
    public final void lambda$new$0(View view, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
