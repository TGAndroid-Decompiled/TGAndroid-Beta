...
public abstract class c5 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public boolean E;
    public final OvershootInterpolator f32662a;
    public final j0 f32663b;
    public final u4 f32664c;
    public final ActionBarPopupWindow$ActionBarPopupWindowLayout d;
    public final v4 e;
    public final org.telegram.ui.ActionBar.e6 f32665f;
    public final fh.b h;
    public AnimatorSet f32666n;
    public boolean f32667r;
    public d5[] f32668s;
    public final View v;
    public boolean f32669w;
    public String f32670x;
    public z4 f32671y;

    public c5(Context context, org.telegram.ui.ActionBar.e6 e6Var, v4 v4Var) {
        super(context);
        this.f32662a = new OvershootInterpolator(1.02f);
        fh.b bVar = new fh.b();
        this.h = bVar;
    ...
    public final void a(x4 x4Var) {
        ...
        boolean z11;
        boolean z12;
        this.f32668s = x4Var.f39487i;
        if (x4Var.f39484c != null) {
            z10 = true;
        } else {
            z10 = false;
        }
        u4 u4Var = this.f32664c;
        u4Var.f37853c = z10;
        u4Var.invalidate();
        this.f32670x = x4Var.f39485f;
        z4 z4Var = this.f32671y;
        if (z4Var != null) {
            if (z4Var.f40063g) {
                z4Var.f40063g = false;
                z4Var.f40060b.removeObserver(z4Var.f40059a, z4Var.e);
            }
            this.f32671y = null;
        }
        z4 z4Var2 = x4Var.f39488j;
        if (z4Var2 != null) {
            this.f32671y = z4Var2;
            ci.l5 l5Var = new ci.l5(1, this, x4Var);
            if (!z4Var2.f40063g) {
                z4Var2.f40063g = true;
                z4Var2.f40062f = l5Var;
                z4Var2.f40060b.addObserver(z4Var2.f40059a, z4Var2.e);
                z4Var2.a();
            }
        }
        int i10 = UserConfig.selectedAccount;
        ImageLocation imageLocation = x4Var.f39484c;
        String str = x4Var.e;
        ImageLocation imageLocation2 = x4Var.f39482a;
        ImageLocation imageLocation3 = x4Var.f39483b;
        String str2 = x4Var.d;
        BitmapDrawable bitmapDrawable = x4Var.f39486g;
        Object obj = x4Var.h;
        ...
        int i11 = 0;
        while (true) {
            d5[] d5VarArr = this.f32668s;
            if (i11 < d5VarArr.length) {
                d5 d5Var = d5VarArr[i11];
                String string = LocaleController.getString(d5Var.f32927a, d5Var.f32928b);
                if (i11 == 0) {
                    z11 = true;
                } else {
                    z11 = false;
                }
                if (i11 == this.f32668s.length - 1) {
                    z12 = true;
                } else {
                    z12 = false;
                }
                ...
                org.telegram.ui.ActionBar.f1 c10 = org.telegram.ui.ActionBar.v0.c(z11, z12, actionBarPopupWindow$ActionBarPopupWindowLayout2, d5Var.f32929c, string, false, this.f32665f);
    ...
    public final void b(final boolean z10) {
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                switch (r3) {
                    case 0:
                        ...
                        c5Var.f32664c.setTranslationY(AndroidUtilities.dp(40.0f) * f10);
        ...
        AnimatorSet animatorSet = this.f32666n;
        if (animatorSet != null) {
            animatorSet.cancel();
        }
        AnimatorSet animatorSet2 = new AnimatorSet();
        this.f32666n = animatorSet2;
        if (z10) {
            j3 = 190;
        } else {
            j3 = 150;
        ...
        this.f32666n.playTogether(ofFloat, ofFloat2);
        this.f32666n.addListener(new ai.n(20, this, z10));
        this.f32666n.start();
    }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        u4 u4Var = this.f32664c;
        boolean z10 = u4Var.f37853c;
        RadialProgress2 radialProgress2 = (RadialProgress2) u4Var.e;
        if (z10 && !TextUtils.isEmpty(this.f32670x)) {
            if (i10 == NotificationCenter.fileLoaded) {
                if (TextUtils.equals((String) objArr[0], this.f32670x)) {
                    radialProgress2.o(1.0f, true);
                }
            } else if (i10 == NotificationCenter.fileLoadProgressChanged && TextUtils.equals((String) objArr[0], this.f32670x)) {
