...
public abstract class c5 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public boolean E;
    public final OvershootInterpolator f32659a;
    public final j0 f32660b;
    public final u4 f32661c;
    public final ActionBarPopupWindow$ActionBarPopupWindowLayout d;
    public final v4 e;
    public final org.telegram.ui.ActionBar.e6 f32662f;
    public final fh.b h;
    public AnimatorSet f32663n;
    public boolean f32664r;
    public d5[] f32665s;
    public final View v;
    public boolean f32666w;
    public String f32667x;
    public z4 f32668y;

    public c5(Context context, org.telegram.ui.ActionBar.e6 e6Var, v4 v4Var) {
        super(context);
        this.f32659a = new OvershootInterpolator(1.02f);
        fh.b bVar = new fh.b();
        this.h = bVar;
    ...
    public final void a(x4 x4Var) {
        ...
        boolean z11;
        boolean z12;
        this.f32665s = x4Var.f39495i;
        if (x4Var.f39492c != null) {
            z10 = true;
        } else {
            z10 = false;
        }
        u4 u4Var = this.f32661c;
        u4Var.f37803c = z10;
        u4Var.invalidate();
        this.f32667x = x4Var.f39493f;
        z4 z4Var = this.f32668y;
        if (z4Var != null) {
            if (z4Var.f40046g) {
                z4Var.f40046g = false;
        ...
        z4 z4Var2 = x4Var.f39496j;
        if (z4Var2 != null) {
            this.f32668y = z4Var2;
            ci.l5 l5Var = new ci.l5(1, this, x4Var);
            if (!z4Var2.f40046g) {
                z4Var2.f40046g = true;
                z4Var2.f40045f = l5Var;
                z4Var2.f40043b.addObserver(z4Var2.f40042a, z4Var2.e);
                z4Var2.a();
            }
        }
        int i10 = UserConfig.selectedAccount;
        ImageLocation imageLocation = x4Var.f39492c;
        String str = x4Var.e;
        ImageLocation imageLocation2 = x4Var.f39490a;
        ImageLocation imageLocation3 = x4Var.f39491b;
        String str2 = x4Var.d;
        BitmapDrawable bitmapDrawable = x4Var.f39494g;
        Object obj = x4Var.h;
        ...
        int i11 = 0;
        while (true) {
            d5[] d5VarArr = this.f32665s;
            if (i11 < d5VarArr.length) {
                d5 d5Var = d5VarArr[i11];
                String string = LocaleController.getString(d5Var.f32937a, d5Var.f32938b);
                if (i11 == 0) {
                    z11 = true;
                } else {
                    z11 = false;
                }
                if (i11 == this.f32665s.length - 1) {
                    z12 = true;
                } else {
                    z12 = false;
                }
                ...
                org.telegram.ui.ActionBar.f1 c10 = org.telegram.ui.ActionBar.v0.c(z11, z12, actionBarPopupWindow$ActionBarPopupWindowLayout2, d5Var.f32939c, string, false, this.f32662f);
    ...
    public final void b(final boolean z10) {
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                switch (r3) {
                    case 0:
                        ...
                        c5Var.f32661c.setTranslationY(AndroidUtilities.dp(40.0f) * f10);
        ...
        this.f32663n.playTogether(ofFloat, ofFloat2);
        this.f32663n.addListener(new ai.n(20, this, z10));
        this.f32663n.start();
    }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        u4 u4Var = this.f32661c;
        boolean z10 = u4Var.f37803c;
        RadialProgress2 radialProgress2 = (RadialProgress2) u4Var.e;
        if (z10 && !TextUtils.isEmpty(this.f32667x)) {
            if (i10 == NotificationCenter.fileLoaded) {
                if (TextUtils.equals((String) objArr[0], this.f32667x)) {
                    radialProgress2.o(1.0f, true);
                }
            } else if (i10 == NotificationCenter.fileLoadProgressChanged && TextUtils.equals((String) objArr[0], this.f32667x)) {
