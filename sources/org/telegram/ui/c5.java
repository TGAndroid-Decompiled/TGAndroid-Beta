...
public abstract class c5 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public boolean E;
    public final OvershootInterpolator f35021a;
    public final j0 f35022b;
    public final u4 f35023c;
    public final ActionBarPopupWindow$ActionBarPopupWindowLayout d;
    public final v4 f35024e;
    public final org.telegram.ui.ActionBar.f6 f35025f;
    public final gh.b h;
    public AnimatorSet f35026n;
    public boolean f35027r;
    public d5[] f35028s;
    public final View v;
    public boolean f35029w;
    public String f35030x;
    public z4 f35031y;

    public c5(Context context, org.telegram.ui.ActionBar.f6 f6Var, v4 v4Var) {
        super(context);
        this.f35021a = new OvershootInterpolator(1.02f);
        gh.b bVar = new gh.b();
        this.h = bVar;
        new Matrix();
        this.f35024e = v4Var;
    ...
    public final void a(x4 x4Var) {
        ...
        boolean z11;
        boolean z12;
        this.f35028s = x4Var.f42616i;
        if (x4Var.f42612c != null) {
            z10 = true;
        } else {
            z10 = false;
        }
        u4 u4Var = this.f35023c;
        u4Var.f40949c = z10;
        u4Var.invalidate();
        this.f35030x = x4Var.f42614f;
        z4 z4Var = this.f35031y;
        if (z4Var != null) {
            if (z4Var.f43315g) {
                z4Var.f43315g = false;
        ...
        z4 z4Var2 = x4Var.f42617j;
        if (z4Var2 != null) {
            this.f35031y = z4Var2;
            di.l5 l5Var = new di.l5(1, this, x4Var);
            if (!z4Var2.f43315g) {
                z4Var2.f43315g = true;
                z4Var2.f43314f = l5Var;
                z4Var2.f43311b.addObserver(z4Var2.f43310a, z4Var2.f43313e);
                z4Var2.a();
            }
        }
        int i10 = UserConfig.selectedAccount;
        ImageLocation imageLocation = x4Var.f42612c;
        String str = x4Var.f42613e;
        ImageLocation imageLocation2 = x4Var.f42610a;
        ImageLocation imageLocation3 = x4Var.f42611b;
        String str2 = x4Var.d;
        BitmapDrawable bitmapDrawable = x4Var.f42615g;
        Object obj = x4Var.h;
        ...
        int i11 = 0;
        while (true) {
            d5[] d5VarArr = this.f35028s;
            if (i11 < d5VarArr.length) {
                d5 d5Var = d5VarArr[i11];
                String string = LocaleController.getString(d5Var.f35685a, d5Var.f35686b);
                if (i11 == 0) {
                    z11 = true;
                } else {
                    z11 = false;
                }
                if (i11 == this.f35028s.length - 1) {
                    z12 = true;
                } else {
                    z12 = false;
                }
                ...
                org.telegram.ui.ActionBar.f1 c10 = org.telegram.ui.ActionBar.v0.c(z11, z12, actionBarPopupWindow$ActionBarPopupWindowLayout2, d5Var.f35687c, string, false, this.f35025f);
    ...
    public final void b(final boolean z10) {
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                switch (r3) {
                    case 0:
                        ...
                        c5Var.f35023c.setTranslationY(AndroidUtilities.dp(40.0f) * f10);
        ...
        AnimatorSet animatorSet = this.f35026n;
        if (animatorSet != null) {
            animatorSet.cancel();
        }
        AnimatorSet animatorSet2 = new AnimatorSet();
        this.f35026n = animatorSet2;
        if (z10) {
            j3 = 190;
        } else {
            j3 = 150;
        ...
        this.f35026n.playTogether(ofFloat, ofFloat2);
        this.f35026n.addListener(new ah.q0(21, this, z10));
        this.f35026n.start();
    }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        u4 u4Var = this.f35023c;
        boolean z10 = u4Var.f40949c;
        RadialProgress2 radialProgress2 = (RadialProgress2) u4Var.f40950e;
        if (z10 && !TextUtils.isEmpty(this.f35030x)) {
            if (i10 == NotificationCenter.fileLoaded) {
                if (TextUtils.equals((String) objArr[0], this.f35030x)) {
                    radialProgress2.o(1.0f, true);
                }
            } else if (i10 == NotificationCenter.fileLoadProgressChanged && TextUtils.equals((String) objArr[0], this.f35030x)) {
