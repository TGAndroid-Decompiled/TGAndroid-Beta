...
public final class q2 extends FrameLayout implements org.telegram.ui.Cells.p9 {
    public final l2 f36725a;
    public final o2 f36726b;
    public final p2 f36727c;
    ...
    public int v;
    public final g4 f36732w;
    public final i4 f36733x;
    ...
    public final void onDraw(Canvas canvas) {
        if (this.d != null) {
            b3 b3Var = this.e;
            i4 i4Var = this.f36733x;
            int i10 = this.h;
            int i11 = 0;
            if (b3Var != null) {
                canvas.save();
                canvas.translate(i10, this.f36729n);
            ...
            if (this.f36728f != null) {
                canvas.save();
                canvas.translate(i10, this.f36729n + this.f36730r);
                i4.v(i4Var, canvas, this, i11);
                this.f36728f.draw(canvas, this);
                canvas.restore();
            }
        }
    }
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (this.f36728f != null) {
            sb2.append(", ");
            sb2.append(this.f36728f.d.getText());
        }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.d != null) {
            ...
            this.f36725a.measure(View.MeasureSpec.makeMeasureSpec(size, 1073741824), View.MeasureSpec.makeMeasureSpec(dp, 1073741824));
            this.d.items.size();
            this.f36727c.measure(View.MeasureSpec.makeMeasureSpec(size, 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(10.0f), 1073741824));
            ...
            i4 i4Var = this.f36733x;
            b3 p5 = i4.p(i4Var, this, null, richText, dp2, dp3, pageblockslideshow, alignment, 0, this.f36732w);
            this.e = p5;
            int i13 = this.h;
            if (p5 != null) {
            ...
            b3 p10 = i4.p(i4Var, this, null, richText2, dp2, 0, pageblockslideshow2, alignment, 0, this.f36732w);
            this.f36728f = p10;
            if (p10 != null) {
                dp += this.f36728f.d.getHeight() + AndroidUtilities.dp(4.0f);
                b3 b3Var2 = this.f36728f;
                b3Var2.f32303s = i13;
                b3Var2.v = this.f36729n + this.f36730r;
            }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        b3 b3Var = this.e;
        int i10 = this.h;
        int i11 = this.f36729n;
        i4 i4Var = this.f36733x;
        if (!i4.l(i4Var, this.f36732w, motionEvent, this, b3Var, i10, i11)) {
            if (!i4.l(i4Var, this.f36732w, motionEvent, this, this.f36728f, this.h, this.f36729n + this.f36730r) && !super.onTouchEvent(motionEvent)) {
                return false;
            }
            return true;
        }
