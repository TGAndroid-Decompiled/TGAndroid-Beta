...
public class iv0 {
    ...
    public final ViewGroup f34252a;
    public final ViewGroup f34253b;
    public final boolean f34254c;
    public hv0 d;
    public View e;
    public ImageReceiver f34255f;
    public ImageReceiver f34256g;
    public ImageReceiver h;
    public boolean f34257i;
    public final vh.h f34258j;
    public vh.g f34259k;
    public final Path f34260l;
    public final float[] f34261m;
    public boolean f34262n;
    public float f34263o;
    public float f34264p;
    public float f34265q;
    public float f34266r;
    public float f34267s;
    public float f34268t;
    public float f34269u;
    public float v;
    public float f34270w;
    public float f34271x;
    public float f34272y;
    public float f34273z;

    public iv0(ViewGroup viewGroup, ViewGroup viewGroup2) {
        this.f34256g = new ImageReceiver();
        this.h = new ImageReceiver();
        this.f34258j = new vh.h();
        this.f34260l = new Path();
        this.f34261m = new float[8];
        this.Q = new float[2];
        this.f34252a = viewGroup;
        this.f34253b = viewGroup2;
        this.f34254c = false;
    }
            ...
            if (motionEvent.getActionMasked() == 2 && this.L) {
                ...
                if (i15 != -1 && i16 != -1) {
                    ...
                    if (hypot > 1.005f && !this.f34262n) {
                        ...
                        hv0 hv0Var = this.d;
                        ViewGroup viewGroup2 = this.f34252a;
                        boolean z11 = this.f34254c;
                        if (hv0Var == null && !z11) {
                            i13 = -1;
                        ...
                        if (this.f34256g == null) {
                            ...
                            this.f34256g = imageReceiver2;
                            imageReceiver2.setCrossfadeAlpha((byte) 2);
                            this.f34256g.setCrossfadeWithOldImage(false);
                            this.f34256g.onAttachedToWindow();
                        ...
                        if (!z11) {
                            ...
                            this.f34257i = z10;
                            if (z10 && this.f34259k == null) {
                                vh.g e = vh.g.e(this.d);
                                this.f34259k = e;
                                if (e != null) {
                                    e.f44351k.put(this.d, Integer.valueOf(i10));
                                }
                            }
                            ...
                            if (imageReceiver.getBitmap() != null && !imageReceiver.getBitmap().isRecycled() && this.f34257i) {
                            ...
                            if (messageObject == null || !messageObject.isPhoto()) {
                                ...
                                if (imageLocation != null) {
                                    i11 = i16;
                                    i14 = i15;
                                    this.f34256g.setImage(imageLocation, null, null, null, null, iArr[0], null, messageObject, messageObject.isWebpage() ? 1 : 0);
                                    this.f34256g.setCrossfadeAlpha((byte) 2);
                                } else {
                                    i14 = i15;
                                    i11 = i16;
                                }
                            ...
                            this.f34269u = imageReceiver.getImageX();
                            this.v = imageReceiver.getImageY() + viewGroup.getPaddingTop();
                            this.f34270w = imageReceiver.getImageHeight();
                            this.f34271x = imageReceiver.getImageWidth();
                            this.f34272y = imageReceiver.getBitmapHeight();
                            float bitmapWidth = imageReceiver.getBitmapWidth();
                            this.f34273z = bitmapWidth;
                            float f7 = this.f34272y;
                            float f10 = f7 / bitmapWidth;
                            float f11 = this.f34270w;
                            float f12 = this.f34271x;
                            float f13 = f11 / f12;
                            if (f10 != f13) {
                                if (f10 < f13) {
                                    this.f34273z = (bitmapWidth / f7) * f11;
                                    this.f34272y = f11;
                                } else {
                                    this.f34272y = f10 * f12;
                                    this.f34273z = f12;
                                }
                            } else {
                                this.f34272y = f11;
                            ...
                            if (messageObject != null && messageObject.isVideo() && MediaController.getInstance().isPlayingMessage(messageObject)) {
                                ...
                                hv0 hv0Var3 = this.d;
                                mediaController.setTextureView(hv0Var3.f33934b, hv0Var3.f33935c, hv0Var3.f33933a, true);
                                FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) this.d.f33933a.getLayoutParams();
                                this.d.f33933a.setTag(R.id.parent_tag, imageReceiver);
                                if (layoutParams.width != imageReceiver.getImageWidth() || layoutParams.height != imageReceiver.getImageHeight()) {
                                    this.d.f33935c.setResizeMode(3);
                                    layoutParams.width = (int) imageReceiver.getImageWidth();
                                    layoutParams.height = (int) imageReceiver.getImageHeight();
                                    this.d.f33933a.setLayoutParams(layoutParams);
                                }
                                this.d.f33934b.setScaleX(1.0f);
                                this.d.f33934b.setScaleY(1.0f);
                                ev0 ev0Var = this.E;
                                if (ev0Var != null) {
                                    this.d.d.setImageBitmap(ev0Var.j0().getBitmap((int) this.f34273z, (int) this.f34272y));
                                    this.d.d.s((int) this.f34273z, (int) this.f34272y);
                                    this.d.d.getImageReceiver().setRoundRadius(imageReceiver.getRoundRadius(true));
                                }
                                this.d.f33933a.setVisibility(0);
                            } else {
                                this.R = false;
                                ImageReceiver imageReceiver5 = new ImageReceiver();
                                this.f34255f = imageReceiver5;
                                imageReceiver5.onAttachedToWindow();
                                Drawable drawable = imageReceiver.getDrawable();
                                this.f34255f.setImageBitmap(drawable);
                                ...
                                this.f34255f.setImageCoords(this.f34269u, this.v, this.f34271x, this.f34270w);
                                this.f34255f.setAspectFit(imageReceiver.isAspectFit());
                                this.f34255f.setRoundRadius(imageReceiver.getRoundRadius(true));
                                this.f34256g.setRoundRadius(imageReceiver.getRoundRadius(true));
                                this.f34256g.setAspectFit(imageReceiver.isAspectFit());
                                this.d.f33933a.setVisibility(8);
                            }
                        } else {
                            i14 = i15;
                            i11 = i16;
    ...
    public final void b() {
        ...
        if (hv0Var != null && hv0Var.getParent() != null) {
            this.f34252a.removeView(this.d);
            this.d.d.getImageReceiver().clearImage();
            vh.g gVar = this.f34259k;
            if (gVar != null) {
                gVar.b(this.d);
                this.f34259k = null;
            }
            ImageReceiver imageReceiver = this.f34255f;
        ...
        ImageReceiver imageReceiver2 = this.f34255f;
        if (imageReceiver2 != null) {
            imageReceiver2.onDetachedFromWindow();
            this.f34255f.clearImage();
            this.f34255f = null;
        }
        ImageReceiver imageReceiver3 = this.f34256g;
        if (imageReceiver3 != null) {
            imageReceiver3.onDetachedFromWindow();
            this.f34256g.clearImage();
            this.f34256g = null;
        }
        ImageReceiver imageReceiver4 = this.h;
    ...
    public final void d() {
        if (this.C == null && this.f34262n) {
            ...
            this.C.setInterpolator(org.telegram.ui.Components.rr.f27701f);
            this.C.start();
        }
    }
    ...
    public void e() {
        View view;
        if (this.f34254c && (view = this.e) != null) {
            view.invalidate();
        }
        hv0 hv0Var = this.d;
        if (hv0Var != null) {
    ...
    public final boolean g(MotionEvent motionEvent) {
        if (i() && this.e != null) {
            motionEvent.offsetLocation(-this.f34265q, -this.f34266r);
    ...
    public final boolean i() {
        ...
        float f10 = 0.0f;
        float f11 = 0.0f;
        for (View view = this.e; view != this.f34252a; view = (View) view.getParent()) {
            if (view == null) {
                return false;
            }
            f10 += view.getLeft();
        ...
        float f12 = 0.0f;
        for (View view2 = this.e; view2 != this.f34253b; view2 = (View) view2.getParent()) {
            if (view2 == null) {
                return false;
            }
            f7 += view2.getLeft();
    ...
    public boolean j(View view, ImageReceiver imageReceiver) {
        if (!this.f34254c) {
            if (imageReceiver.getDrawable() instanceof org.telegram.ui.Components.d6) {
                AnimatedFileDrawableStream animatedFileDrawableStream = ((org.telegram.ui.Components.d6) imageReceiver.getDrawable()).f23276u0;
