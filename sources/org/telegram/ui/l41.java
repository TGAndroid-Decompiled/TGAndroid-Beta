...
public abstract class l41 extends FrameLayout {
    ...
    public AnimationNotificationsLocker f35332n;
    public boolean f35333r;
    public int f35334s;
    public boolean v;
    public org.telegram.ui.ActionBar.d5 f35335w;
    public o1.k f35336x;
    public float f35337y;
    ...
    public final void b() {
        ...
        if (!SharedConfig.animationsEnabled()) {
            this.e = 0.0f;
            g();
            vx vxVar = this.f35328a;
            if (vxVar != null) {
                vxVar.onPause();
                this.f35328a.onFragmentDestroy();
                removeAllViews();
                this.f35328a = null;
        ...
        this.h.setInterpolator(org.telegram.ui.Components.qr.f27423f);
        this.h.start();
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        float f10;
        if (this.v) {
            f(this.E, this.f35328a, this.f35337y);
            invalidate();
        }
        ...
        if (this.f35328a != null && this.d != null && max > 0.0f) {
            if (this.P == null) {
                this.P = new Paint();
            }
            this.P.setColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f19186w8, false));
            if (max == 1.0f) {
                canvas.save();
            } else {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (view != null) {
            ...
            layoutParams.topMargin = org.telegram.ui.ActionBar.k.getCurrentActionBarHeight() + i12 + this.f35334s;
        }
        org.telegram.ui.ActionBar.k kVar = this.d;
        if (kVar != null) {
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        org.telegram.ui.ActionBar.d5 d5Var = this.f35335w;
    ...
    public void setCurrentTop(int i10) {
        ...
        View view = this.f35329b;
        if (view != null) {
            view.setTranslationY((i10 - view.getTop()) + this.f35334s);
        }
        j0 j0Var = this.f35330c;
        if (j0Var != null) {
    ...
    public void setTransitionPaddingBottom(int i10) {
        ...
        if (com.google.android.gms.internal.vision.e2.u(vxVar)) {
            float f7 = i10;
            vxVar.X0 = f7;
            vxVar.h.setTranslationY(((-f7) - vxVar.f33024e1) - vxVar.f33022d1);
        }
    }
