...
public abstract class l41 extends FrameLayout {
    ...
    public AnimationNotificationsLocker f35245n;
    public boolean f35246r;
    public int f35247s;
    public boolean v;
    public org.telegram.ui.ActionBar.d5 f35248w;
    public o1.k f35249x;
    ...
    public final void b() {
        ...
        if (!SharedConfig.animationsEnabled()) {
            this.e = 0.0f;
            g();
            vx vxVar = this.f35241a;
            if (vxVar != null) {
                vxVar.onPause();
                this.f35241a.onFragmentDestroy();
                removeAllViews();
                this.f35241a = null;
        ...
        this.h.setInterpolator(org.telegram.ui.Components.qr.f27715f);
        this.h.start();
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        float f10;
        if (this.v) {
            f(this.E, this.f35241a, this.f35250y);
            invalidate();
        }
        ...
        if (this.f35241a != null && this.d != null && max > 0.0f) {
            if (this.P == null) {
                this.P = new Paint();
            }
            this.P.setColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19413w8, false));
            if (max == 1.0f) {
                canvas.save();
            } else {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (view != null) {
            ...
            layoutParams.topMargin = org.telegram.ui.ActionBar.k.getCurrentActionBarHeight() + i12 + this.f35247s;
        }
        org.telegram.ui.ActionBar.k kVar = this.d;
        if (kVar != null) {
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        org.telegram.ui.ActionBar.d5 d5Var = this.f35248w;
    ...
    public void setCurrentTop(int i10) {
        ...
        View view = this.f35242b;
        if (view != null) {
            view.setTranslationY((i10 - view.getTop()) + this.f35247s);
        }
        j0 j0Var = this.f35243c;
        if (j0Var != null) {
    ...
    public void setTransitionPaddingBottom(int i10) {
        ...
        if (com.google.android.gms.internal.vision.e2.u(vxVar)) {
            float f7 = i10;
            vxVar.X0 = f7;
            vxVar.h.setTranslationY(((-f7) - vxVar.f32982e1) - vxVar.f32980d1);
        }
    }
