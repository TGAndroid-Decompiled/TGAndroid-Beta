...
public final class yo0 implements yf.b0, r0.n, org.telegram.ui.ActionBar.a2 {
    ...
    public void a(int i10) {
        int i11;
        bq0 bq0Var = this.f43203b;
        gh.d dVar = bq0Var.f34896g0;
        ArrayList arrayList = bq0Var.f34900k0;
        bh.f fVar = bq0Var.f34895f0;
        int i12 = Build.VERSION.SDK_INT;
        if (i12 >= 31 && fVar != null) {
            ArrayList arrayList2 = bq0Var.f34899j0;
            if (i12 >= 29 && dVar != null) {
            ...
            fVar.g(a2, arrayList);
            if (fVar.e(bq0Var.f34898i0, bq0Var.d.getWidth(), bq0Var.d.getHeight())) {
                if (dVar != null) {
                    dVar.d();
                }
                Iterator it = bq0Var.f34891d0.iterator();
                while (it.hasNext()) {
