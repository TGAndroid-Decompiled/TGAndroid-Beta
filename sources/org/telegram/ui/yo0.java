...
public final class yo0 implements yf.a0, r0.n, org.telegram.ui.ActionBar.a2 {
    ...
    public void a(int i10) {
        int i11;
        cq0 cq0Var = this.f39972b;
        fh.d dVar = cq0Var.f32818g0;
        ArrayList arrayList = cq0Var.f32822k0;
        ah.i iVar = cq0Var.f32817f0;
        int i12 = Build.VERSION.SDK_INT;
        if (i12 >= 31 && iVar != null) {
            ArrayList arrayList2 = cq0Var.f32821j0;
            if (i12 >= 29 && dVar != null) {
            ...
            iVar.g(a2, arrayList);
            if (iVar.e(cq0Var.f32820i0, cq0Var.d.getWidth(), cq0Var.d.getHeight())) {
                if (dVar != null) {
                    dVar.f();
                }
                Iterator it = cq0Var.f32814d0.iterator();
                while (it.hasNext()) {
