...
public final class fc1 extends org.telegram.ui.Components.kl0 {
    ...
    public final int j(int i10) {
        ...
        if (i10 != themeActivity.f31550a0 && i10 != themeActivity.K && i10 != themeActivity.f31552b0 && i10 != themeActivity.Y && i10 != themeActivity.P && i10 != themeActivity.Q && i10 != themeActivity.M && i10 != themeActivity.L) {
            if (i10 != themeActivity.f31558f0 && i10 != themeActivity.Z && i10 != themeActivity.f31576v0 && i10 != themeActivity.A0 && i10 != themeActivity.G0) {
                if (i10 != themeActivity.f31571r0 && i10 != themeActivity.V && i10 != themeActivity.f31554c0 && i10 != themeActivity.O && i10 != themeActivity.f31560h0 && i10 != themeActivity.f31566n0 && i10 != themeActivity.f31563k0 && i10 != themeActivity.J && i10 != themeActivity.I0 && i10 != themeActivity.f31583z0 && i10 != themeActivity.B0 && i10 != themeActivity.C0 && i10 != themeActivity.D0) {
                    if (i10 != themeActivity.R && i10 != themeActivity.S && i10 != themeActivity.T && i10 != themeActivity.U) {
                        if (i10 != themeActivity.W && i10 != themeActivity.f31555d0 && i10 != themeActivity.f31559g0 && i10 != themeActivity.f31579x && i10 != themeActivity.f31561i0 && i10 != themeActivity.f31577w && i10 != themeActivity.f31564l0 && i10 != themeActivity.f31562j0 && i10 != themeActivity.f31574t0 && i10 != themeActivity.f31578w0 && i10 != themeActivity.H0 && i10 != themeActivity.E0 && i10 != themeActivity.F0) {
                            if (i10 == themeActivity.f31556e0) {
                                return 6;
                            }
                            if (i10 != themeActivity.X && i10 != themeActivity.G && i10 != themeActivity.E) {
                                ...
                                if (i10 != i11) {
                                    ...
                                    if (i10 != i12 && i10 != themeActivity.f31581y && i10 != themeActivity.f31573s0) {
                                            ...
                                            if (i10 != i14) {
                                                ...
                                                if (i10 != themeActivity.m0) {
                                                    ...
                                                    if (i10 != i16) {
                                                        ...
                                                        if (i10 != i17) {
                                                            if (i10 == themeActivity.f31567o0) {
                                                                return 11;
                                                            }
                                                            if (i10 != themeActivity.f31569q0) {
                                                                i18 = themeActivity.bubbleRadiusRow;
                                                                if (i10 != i18) {
                                                                    i19 = themeActivity.backgroundRow;
                                                                    if (i10 != i19 && i10 != themeActivity.f31582y0) {
                                                                        ...
                                                                        if (i10 != i20) {
                                                                            ...
                                                                            if (i10 != i21) {
                                                                                ...
                                                                                if (i10 != i22) {
                                                                                    if (i10 == themeActivity.f31575u0) {
                                                                                        return 15;
                                                                                    }
                                                                                    if (i10 == themeActivity.f31580x0) {
                                                                                        return 16;
                                                                                    }
                                                                                    if (i10 == themeActivity.f31568p0) {
                                                                                        return 17;
                                                                                    }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i24 != 1) {
                    ...
                    if (i24 != 5) {
                        if (i24 != 6) {
                                            ...
                                            if (i24 != 21) {
                                                switch (i24) {
                                                    case 10:
                                                        ...
                                                        if (z11) {
                                                            int i25 = org.telegram.ui.ActionBar.i6.f19031o;
                                                            if (i25 == 1) {
                                                    ...
                                                    case 11:
                                                        if (this.d) {
                                                            themeActivity.f31553c.x1(themeActivity.f31551b.getMeasuredWidth());
                                                            this.d = false;
                                                            return;
                                                        }
                                                        return;
                                                    case 12:
                                                        ...
                                                        hc1 hc1Var = (hc1) ll0Var.getAdapter();
                                                        hc1Var.l();
                                                        ...
                                                        if (indexOf != -1) {
                                                            ((s4.c0) ll0Var.getLayoutManager()).h1(indexOf, (themeActivity.f31551b.getMeasuredWidth() / 2) - AndroidUtilities.dp(42.0f));
                                                            return;
                                                        }
                                                        return;
                                                    default:
                            ...
                            if (i10 == themeActivity.X) {
                                w8Var.f(LocaleController.getString("AutoNightLocation", R.string.AutoNightLocation), org.telegram.ui.ActionBar.i6.f19049p, true);
                                return;
                        ...
                        ((org.telegram.ui.Cells.k0) view).setProgress(org.telegram.ui.ActionBar.i6.f19067q);
                        return;
                    }
            ...
            if (i10 == themeActivity.f31558f0) {
                e9Var.setText(LocaleController.formatString("AutoNightBrightnessInfo", R.string.AutoNightBrightnessInfo, Integer.valueOf((int) (org.telegram.ui.ActionBar.i6.f19067q * 100.0f))));
                return;
            } else if (i10 == themeActivity.Z) {
                e9Var.setText(ThemeActivity.y0());
                return;
            } else if (i10 == themeActivity.f31576v0) {
        ...
        if (i10 == i11) {
            if (org.telegram.ui.ActionBar.i6.f19031o != 0 && org.telegram.ui.ActionBar.i6.J != null) {
        ...
        } else if (i10 == themeActivity.f31550a0) {
            int i30 = org.telegram.ui.ActionBar.i6.f19085r;
            int i31 = i30 / 60;
        ...
        } else if (i10 == themeActivity.f31552b0) {
            int i32 = org.telegram.ui.ActionBar.i6.f19104s;
            int i33 = i32 / 60;
            ...
            eaVar.c(LocaleController.getString("AutoNightUpdateLocation", R.string.AutoNightUpdateLocation), org.telegram.ui.ActionBar.i6.f19177w, false, false);
            ...
            eaVar.c(LocaleController.getString(R.string.SearchEngine), org.telegram.ui.web.o1.a().f39046a, themeActivity.P0, false);
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        switch (i10) {
            ...
            case 4:
                ...
                frameLayout.f20370a = textView;
                org.telegram.messenger.wl.r(textView, org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.G6, false), 1, 16.0f, 1);
            ...
            case 5:
                ...
                break;
            case 6:
                i5Var = new ac1(this, context);
                break;
            case 7:
                i5Var = new org.telegram.ui.Cells.w8(context);
                break;
            case 8:
                i5Var = new gc1(themeActivity, context);
                break;
            case 9:
                frameLayout = new bc1(context);
                frameLayout.f32135b = new org.telegram.ui.Cells.y0[2];
                ...
                int i21 = 0;
                while (true) {
                    ?? r32 = (org.telegram.ui.Cells.y0[]) frameLayout.f32135b;
                    if (i21 >= r32.length) {
                        i5Var = frameLayout;
                        break;
                    } else {
                        ...
                        frameLayout2.f21648c = new RectF();
                        TextPaint textPaint = new TextPaint(1);
                        frameLayout2.d = textPaint;
                        frameLayout2.setWillNotDraw(false);
                        frameLayout2.f21647b = z10;
                        if (z10) {
                        ...
                        org.telegram.ui.Cells.y0 y0Var = ((org.telegram.ui.Cells.y0[]) frameLayout.f32135b)[i21];
                        if (i21 == 1) {
                            i14 = 10;
                        } else {
                            i14 = 0;
                        ...
                        ((org.telegram.ui.Cells.y0[]) frameLayout.f32135b)[i21].setOnClickListener(new ai.j3(3, frameLayout, z10));
                        i21++;
                    }
                }
                break;
            case 10:
                i5Var = new org.telegram.ui.Cells.i5(21, 60, this.f33539c, null, true);
                break;
            case 11:
                this.d = true;
                cc1 cc1Var = new cc1(this, this.f33539c, themeActivity, themeActivity.f31557f, themeActivity.e, themeActivity.d);
                themeActivity.f31553c = cc1Var;
                cc1Var.setDrawDivider(themeActivity.v);
                themeActivity.f31553c.setFocusable(false);
                View view = themeActivity.f31553c;
                view.setLayoutParams(new s4.p0(-1, AndroidUtilities.dp(148.0f)));
                i5Var = view;
                break;
            case 12:
                dc1 dc1Var = new dc1(context, 0, null);
                ...
                dc1Var.setOnItemLongClickListener(new rv0(12, this, hc1Var));
                dc1Var.setLayoutParams(new s4.p0(-1, AndroidUtilities.dp(62.0f)));
                i5Var = dc1Var;
                break;
            case 13:
                i5Var = new vb1(themeActivity, context);
                break;
            case 14:
            case 18:
            default:
            ...
            case 15:
                ...
                frameLayout3.f28208a = paint;
                frameLayout3.f28209b = new Paint(1);
                Paint paint2 = new Paint(1);
                frameLayout3.f28210c = paint2;
                Paint paint3 = new Paint(1);
                frameLayout3.d = paint3;
                frameLayout3.e = new RectF();
                int i22 = 6;
                frameLayout3.h = r14;
                frameLayout3.f28212n = r15;
                frameLayout3.f28213r = new org.telegram.ui.Components.xi0[6];
                frameLayout3.v = new org.telegram.ui.Components.aj0[2];
                float f11 = 1.0f;
                frameLayout3.f28216x = 1.0f;
                ...
                int i23 = org.telegram.ui.ActionBar.i6.f18821c9;
                int[] iArr = {i23, i23, i23, i23, org.telegram.ui.ActionBar.i6.Y5, org.telegram.ui.ActionBar.i6.f18839d9};
                ...
                org.telegram.ui.Components.sy0 sy0Var = new org.telegram.ui.Components.sy0(frameLayout3, context);
                frameLayout3.f28211f = sy0Var;
                ...
                sy0Var.setMaxValue(i18);
                if (isEmpty) {
                    i22 = 5;
                }
                sy0Var.setAllItemsCount(i22);
                sy0Var.setWrapSelectorWheel(true);
                sy0Var.setFormatter(new org.telegram.ui.Components.ry0(frameLayout3));
                sy0Var.setOnValueChangedListener(new org.telegram.ui.Components.ry0(frameLayout3));
                sy0Var.setImportantForAccessibility(2);
                sy0Var.setValue(SharedConfig.getChatSwipeAction(i15));
                frameLayout3.addView(sy0Var, w7.x5.d(132, -1.0f, 5, 21.0f, 0.0f, 21.0f, 0.0f));
                frameLayout3.setWillNotDraw(false);
                frameLayout3.f28214s = 0;
                ...
                org.telegram.ui.Components.xi0 a2 = frameLayout3.a(frameLayout3.f28211f.getValue());
                if (a2 != null) {
                ...
                if (frameLayout3.f28211f.getValue() != 5) {
                    f11 = 0.0f;
                }
                frameLayout3.f28215w = f11;
                frameLayout3.F = frameLayout3.f28211f.getValue();
                i5Var = frameLayout3;
                break;
            case 16:
                ...
                break;
            case 17:
                View fvVar = new fv(themeActivity.f31557f, context, themeActivity);
            ...
            case 20:
                ...
                ll0Var.i(new ci.r1(ll0Var, 1));
                ll0Var.setOnItemClickListener(new ai.u0(ll0Var, themeActivity, context, 3));
                ll0Var.w1();
                i5Var = ll0Var;
                break;
            case 21:
                i17 = ((org.telegram.ui.ActionBar.n2) themeActivity).currentAccount;
                frameLayout = new fp0(i17, 0L, this.f33539c, themeActivity.getResourceProvider());
                i5Var = frameLayout;
                break;
        }
    ...
    public final void y(s4.c1 c1Var) {
        boolean z10;
        if (c1Var.f42678f == 4) {
            org.telegram.ui.Cells.ka kaVar = (org.telegram.ui.Cells.ka) c1Var.f42675a;
            if (c1Var.b() == org.telegram.ui.ActionBar.i6.f19031o) {
                z10 = true;
            } else {
                z10 = false;
            }
