...
public class gz implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final long J;
    public HashMap K;
    public final bo f33976a;
    public int f33977b;
    public TLRPC.TL_messages_stickerSet f33978c;
    public boolean f33980n;
    public String v;
    public dj f33985y;
    public boolean d = false;
    public final HashMap e = new HashMap();
    public final HashMap f33979f = new HashMap();
    public final Random h = new Random();
    public int f33981r = -1;
    public long f33982s = 0;
    public final ArrayList f33983w = new ArrayList();
    public final ArrayList f33984x = new ArrayList();
    ...
    public final void b() {
        if (!this.d) {
            TLRPC.TL_messages_stickerSet stickerSetByName = MediaDataController.getInstance(this.f33977b).getStickerSetByName("EmojiAnimations");
            this.f33978c = stickerSetByName;
            if (stickerSetByName == null) {
                this.f33978c = MediaDataController.getInstance(this.f33977b).getStickerSetByEmojiOrName("EmojiAnimations");
            }
            if (this.f33978c == null) {
                MediaDataController.getInstance(this.f33977b).loadStickersByEmojiOrName("EmojiAnimations", false, true);
            }
            if (this.f33978c != null) {
                HashMap hashMap = new HashMap();
                for (int i10 = 0; i10 < this.f33978c.documents.size(); i10++) {
                    hashMap.put(Long.valueOf(this.f33978c.documents.get(i10).f18115id), this.f33978c.documents.get(i10));
                }
                for (int i11 = 0; i11 < this.f33978c.packs.size(); i11++) {
                    TLRPC.TL_stickerPack tL_stickerPack = this.f33978c.packs.get(i11);
    ...
    public final void c() {
        ...
        while (true) {
            ...
            if (i10 < arrayList.size()) {
                ((fz) arrayList.get(i10)).f33734r.onDetachedFromWindow();
                if (((fz) arrayList.get(i10)).f33726j != null) {
                    ((fz) arrayList.get(i10)).f33726j.d(this.G);
                }
                i10++;
            } else {
                arrayList.clear();
            ...
            if (z14 || ((arrayList != null && !arrayList.isEmpty()) || z13)) {
                ...
                while (true) {
                    ...
                    if (i13 < arrayList2.size()) {
                        if (((fz) arrayList2.get(i13)).f33732p == i10) {
                            i14++;
                            if (!z14 && (((fz) arrayList2.get(i13)).f33734r.getLottieAnimation() == null || ((fz) arrayList2.get(i13)).f33734r.getLottieAnimation().y())) {
                                return false;
                            }
                        }
                        if (((fz) arrayList2.get(i13)).f33733q != null && document != null) {
                            if (((fz) arrayList2.get(i13)).f33733q.f18115id == document.f18115id) {
                                i15++;
                            }
                        }
                        i13++;
                        ...
                        if (ocVar != null && ocVar.f26746b == messageObject.getId()) {
                            return false;
                        }
                        TLRPC.InputStickerSet inputStickerSet = messageObject.getInputStickerSet();
                        if (inputStickerSet.short_name != null) {
                            tL_messages_stickerSet = MediaDataController.getInstance(this.f33977b).getStickerSetByName(inputStickerSet.short_name);
                        } else {
                            tL_messages_stickerSet = null;
                        }
                        if (tL_messages_stickerSet == null) {
                            tL_messages_stickerSet = MediaDataController.getInstance(this.f33977b).getStickerSetById(inputStickerSet.f18129id);
                        }
                        if (tL_messages_stickerSet == null) {
                            TLRPC.TL_messages_getStickerSet tL_messages_getStickerSet = new TLRPC.TL_messages_getStickerSet();
                            tL_messages_getStickerSet.stickerset = inputStickerSet;
                            ConnectionsManager.getInstance(this.f33977b).sendRequest(tL_messages_getStickerSet, new qo(18, this, messageObject));
                            return false;
                        }
                        ...
                        if (z14) {
                            ...
                            TLRPC.messages_AvailableEffects availableEffects = MessagesController.getInstance(this.f33977b).getAvailableEffects();
                            ...
                            while (true) {
                                if (i16 < availableEffects.documents.size()) {
                                    ...
                                    long j11 = j10;
                                    if (document2 != null && document2.f18115id == j11) {
                                        break;
                                    }
                                    i16++;
                                    j10 = j11;
                                    ...
                                    if (i12 >= 0 && i12 <= arrayList.size() - 1) {
                                        ...
                                        for (int i17 = 0; i17 < arrayList.size(); i17++) {
                                            ...
                                            if (document3 != null) {
                                                ...
                                                if (hashMap != null) {
                                                    bool = (Boolean) hashMap.get(Long.valueOf(document3.f18115id));
                                                } else {
                                                    bool = null;
                                                }
                        ...
                        fzVar.f33725i = z14;
                        if (!z14) {
                            fzVar.f33723f = ((random.nextInt() % 101) / 100.0f) * (f7 / 4.0f);
                            fzVar.f33724g = ((random.nextInt() % 101) / 100.0f) * (f10 / 4.0f);
                        }
                        fzVar.f33732p = i10;
                        fzVar.f33733q = document2;
                        fzVar.f33729m = z12;
                        fzVar.f33734r.setAllowStartAnimation(true);
                        fzVar.f33734r.setAllowLottieVibration(z10);
                        if (SharedConfig.getDevicePerformanceClass() > 1 && BuildVars.DEBUG_VERSION) {
                            z15 = false;
                        } else {
                            z15 = true;
                        }
                        HashMap hashMap2 = this.f33979f;
                        int i18 = i12;
                        if (premiumStickerAnimation == null) {
                            int f11 = f();
                            z16 = z13;
                            boolean z17 = z15;
                            Integer num = (Integer) hashMap2.get(Long.valueOf(document2.f18115id));
                            if (num == null) {
                                intValue3 = 0;
                            } else {
                            ...
                            int i19 = intValue3 + 1;
                            hashMap2.put(Long.valueOf(document2.f18115id), Integer.valueOf(i19));
                            ImageLocation forDocument = ImageLocation.getForDocument(document2);
                            fzVar.f33734r.setUniqKeyPrefix(i19 + "_" + fzVar.f33732p + "_");
                            ...
                            sb2.append(str3);
                            fzVar.f33734r.setImage(forDocument, sb2.toString(), null, "tgs", this.f33978c, 1);
                            fzVar.f33734r.setDelegate(new ez(this, fzVar, z10, messageObject));
                            ...
                            int f12 = f();
                            if (i15 > 0) {
                                Integer num2 = (Integer) hashMap2.get(Long.valueOf(document2.f18115id));
                                if (num2 == null) {
                                    intValue2 = 0;
                                } else {
                                    intValue2 = num2.intValue();
                                }
                                hashMap2.put(Long.valueOf(document2.f18115id), Integer.valueOf((intValue2 + 1) % 4));
                                fzVar.f33734r.setUniqKeyPrefix(intValue2 + "_" + fzVar.f33732p + "_");
                            }
                            fzVar.f33733q = document2;
                            ...
                            sb3.append(str2);
                            fzVar.f33734r.setImage(forDocument2, sb3.toString(), null, "tgs", this.f33978c, 1);
                        }
                        fzVar.f33734r.setLayerNum(Integer.MAX_VALUE);
                        fzVar.f33734r.setAutoRepeat(0);
                        if (fzVar.f33734r.getLottieAnimation() != null) {
                            if (fzVar.h) {
                                fzVar.f33734r.getLottieAnimation().N(0, false, true);
                            }
                            fzVar.f33734r.getLottieAnimation().start();
                        }
                        arrayList2.add(fzVar);
                        fzVar.f33734r.onAttachedToWindow();
                        ImageReceiver imageReceiver = fzVar.f33734r;
                        FrameLayout frameLayout = this.G;
                        imageReceiver.setParentView(frameLayout);
                        frameLayout.invalidate();
                        if (z10 && !z16 && UserConfig.getInstance(this.f33977b).clientUserId != this.I) {
                            int i20 = this.f33981r;
                            if (i20 != 0 && i20 != i10 && (djVar = this.f33985y) != null) {
                                AndroidUtilities.cancelRunOnUIThread(djVar);
                                this.f33985y.run();
                            }
                            this.f33981r = i10;
                            this.v = str;
                            long j12 = this.f33982s;
                            ArrayList arrayList4 = this.f33984x;
                            ArrayList arrayList5 = this.f33983w;
                            if (j12 == j3) {
                                this.f33982s = System.currentTimeMillis();
                                arrayList5.clear();
                                arrayList4.clear();
                                arrayList5.add(Long.valueOf(j3));
                                arrayList4.add(Integer.valueOf(i18));
                            } else {
                                arrayList5.add(Long.valueOf(System.currentTimeMillis() - this.f33982s));
                                arrayList4.add(Integer.valueOf(i18));
                            }
                            dj djVar2 = this.f33985y;
                            if (djVar2 != null) {
                        ...
                        if (z11) {
                            MessagesController.getInstance(this.f33977b).sendTyping(this.I, this.J, 11, str, 0);
                            return true;
                        }
                        return true;
                    }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        } else if (i10 == NotificationCenter.updateInterfaces && (printingStringType = MessagesController.getInstance(this.f33977b).getPrintingStringType(j3, this.J)) != null && printingStringType.intValue() == 5) {
            i9.s sVar = this.E;
            if (sVar != null) {
    ...
    public final void e(Canvas canvas) {
        ...
        if (!this.F.isEmpty()) {
            ...
            while (i10 < this.F.size()) {
                ...
                if (this.f33976a != null) {
                    ...
                    while (true) {
                        if (i11 < this.H.getChildCount()) {
                            ...
                            if (messageObject != null && messageObject.getId() == fzVar.f33732p) {
                                fzVar.f33722c = true;
                                ...
                                if (fzVar.f33725i && (childAt instanceof org.telegram.ui.Cells.t1)) {
                                    ...
                                    float f15 = f13 / 2.0f;
                                    f7 = 3.0f;
                                    fzVar.f33720a = Utilities.clamp(timeX - f15, AndroidUtilities.displaySize.x - f13, 0.0f);
                                    fzVar.f33721b = (t1Var2.getTimeY() + y3) - f15;
                                } else {
                                    f7 = 3.0f;
                                    if (fzVar.h) {
                                        fzVar.f33720a = imageReceiver.getImageX() + x10;
                                        fzVar.f33721b = imageReceiver.getImageY() + y3;
                                    } else {
                                        ...
                                        fzVar.f33720a = f11;
                                        fzVar.f33721b = imageY - imageReceiver.getImageWidth();
                                    }
                                }
                            } else {
                                i11++;
                    ...
                    if (!fzVar.f33722c || fzVar.e + f10 < this.f33976a.f32464s9 || f10 > this.H.getMeasuredHeight() - this.f33976a.Aa) {
                        fzVar.f33730n = true;
                    }
                    if (fzVar.h) {
                        ...
                        if ((f10 - this.f33976a.f32464s9) + f16 <= 0.0f) {
                            z13 = true;
                        } else {
                            z13 = false;
                        }
                    ...
                    if (fzVar.f33730n) {
                        float f17 = fzVar.f33731o;
                        if (f17 != 1.0f) {
                            float clamp = Utilities.clamp(f17 + 0.10666667f, 1.0f, 0.0f);
                            fzVar.f33731o = clamp;
                            fzVar.f33734r.setAlpha(1.0f - clamp);
                            this.f33976a.X0.invalidate();
                        }
                    }
                } else {
                    f7 = 3.0f;
                ...
                if (!fzVar.f33728l && fzVar.f33730n) {
                    z10 = true;
                } else {
                    z10 = false;
                }
                if (!z10) {
                    if (fzVar.h && !fzVar.f33725i) {
                        float f18 = fzVar.e;
                        float f19 = 1.49926f * f18;
                        float f20 = 0.0546875f * f19;
                        float f21 = (((f18 / 2.0f) + fzVar.f33721b) - (f19 / 2.0f)) - (0.00279f * f19);
                        if (!fzVar.f33729m) {
                            fzVar.f33734r.setImageCoords(fzVar.f33720a - f20, f21, f19, f19);
                        } else {
                            fzVar.f33734r.setImageCoords(((fzVar.f33720a + fzVar.d) - f19) + f20, f21, f19, f19);
                        }
                        if (!fzVar.f33729m) {
                            canvas.save();
                            canvas.scale(-1.0f, 1.0f, fzVar.f33734r.getCenterX(), fzVar.f33734r.getCenterY());
                            fzVar.f33734r.draw(canvas);
                            canvas.restore();
                        } else {
                            fzVar.f33734r.draw(canvas);
                        }
                    } else {
                        zg.d dVar = fzVar.f33726j;
                        if (dVar != null) {
                            float f22 = fzVar.f33720a + fzVar.f33723f;
                            float f23 = fzVar.f33721b + fzVar.f33724g;
                            float f24 = fzVar.d * f7;
                            dVar.e((int) f22, (int) f23, (int) (f22 + f24), (int) (f23 + f24));
                            fzVar.f33726j.b(canvas);
                        } else {
                            ImageReceiver imageReceiver2 = fzVar.f33734r;
                            float f25 = fzVar.f33720a + fzVar.f33723f;
                            float f26 = fzVar.f33721b + fzVar.f33724g;
                ...
                zg.d dVar2 = fzVar.f33726j;
                if (dVar2 != null) {
                    z11 = dVar2.c();
                } else if (fzVar.f33728l && fzVar.f33734r.getLottieAnimation() != null && fzVar.f33734r.getLottieAnimation().f29943a0 >= fzVar.f33734r.getLottieAnimation().e[0] - 2) {
                    z11 = true;
                } else {
                    z11 = false;
                }
                if (fzVar.f33731o != 1.0f && !z11 && !z10) {
                    if (fzVar.f33734r.getLottieAnimation() != null && fzVar.f33734r.getLottieAnimation().f29956k0) {
                        fzVar.f33728l = true;
                    } else if (fzVar.f33734r.getLottieAnimation() != null && !fzVar.f33734r.getLottieAnimation().f29956k0) {
                        fzVar.f33734r.getLottieAnimation().N(0, true, false);
                        fzVar.f33734r.getLottieAnimation().start();
                    }
                } else {
                    fz fzVar2 = (fz) this.F.remove(i10);
                    if (fzVar.h && fzVar.f33734r.getLottieAnimation() != null) {
                        fzVar2.f33734r.getLottieAnimation().N(0, true, true);
                    }
                    fzVar2.f33734r.onDetachedFromWindow();
                    zg.d dVar3 = fzVar2.f33726j;
                    if (dVar3 != null) {
                        dVar3.d(this.G);
                    }
                    i10--;
    ...
    public final void j() {
        this.f33980n = true;
        b();
        NotificationCenter.getInstance(this.f33977b).addObserver(this, NotificationCenter.diceStickersDidLoad);
        NotificationCenter.getInstance(this.f33977b).addObserver(this, NotificationCenter.onEmojiInteractionsReceived);
        NotificationCenter.getInstance(this.f33977b).addObserver(this, NotificationCenter.updateInterfaces);
        int i10 = 0;
        while (true) {
            ArrayList arrayList = this.F;
            if (i10 < arrayList.size()) {
                ((fz) arrayList.get(i10)).f33734r.onAttachedToWindow();
                if (((fz) arrayList.get(i10)).f33726j != null) {
                    ((fz) arrayList.get(i10)).f33726j.f(this.G);
                }
                i10++;
            } else {
                return;
    ...
    public final void k() {
        int i10 = 0;
        this.f33980n = false;
        NotificationCenter.getInstance(this.f33977b).removeObserver(this, NotificationCenter.diceStickersDidLoad);
        NotificationCenter.getInstance(this.f33977b).removeObserver(this, NotificationCenter.onEmojiInteractionsReceived);
        NotificationCenter.getInstance(this.f33977b).removeObserver(this, NotificationCenter.updateInterfaces);
        while (true) {
            ArrayList arrayList = this.F;
            if (i10 < arrayList.size()) {
                ((fz) arrayList.get(i10)).f33734r.onDetachedFromWindow();
    ...
    public final void l(org.telegram.ui.Cells.t1 t1Var, bo boVar, boolean z10) {
        ...
        if (!boVar.v() && t1Var.getMessageObject() != null && t1Var.getMessageObject().getId() >= 0) {
            if (t1Var.getMessageObject().isPremiumSticker() || boVar.f32295f != null) {
                ...
                if (!isPremiumSticker && t1Var.getEffect() == null && (z10 || !t1Var.getMessageObject().isAnimatedEmojiStickerSingle())) {
                    Integer printingStringType = MessagesController.getInstance(this.f33977b).getPrintingStringType(j3, this.J);
                    if ((printingStringType == null || printingStringType.intValue() != 5) && this.E == null && o9) {
                        org.telegram.ui.Components.oc ocVar = org.telegram.ui.Components.oc.f26744w;
                        if ((ocVar == null || !ocVar.f26753l) && SharedConfig.emojiInteractionsHintCount > 0 && UserConfig.getInstance(this.f33977b).getClientUserId() != boVar.f32295f.f18256id) {
                            ...
                            if (t1Var.getMessageObject().isAnimatedAnimatedEmoji()) {
                                ...
                                emojiAnimatedSticker = MediaDataController.getInstance(this.f33977b).getEmojiAnimatedSticker(t1Var.getMessageObject().getStickerEmoji());
                            }
                            ...
                            ax0Var.f25585c.setVisibility(8);
                            SpannableStringBuilder replaceTags = AndroidUtilities.replaceTags(LocaleController.formatString("EmojiInteractionTapHint", R.string.EmojiInteractionTapHint, boVar.f32295f.first_name));
                            TextView textView = ax0Var.f25584b;
    ...
    public final void m(TLRPC.Document document) {
        if (document != null) {
            HashMap hashMap = this.K;
            if (hashMap != null && hashMap.containsKey(Long.valueOf(document.f18115id))) {
                return;
            }
            if (this.K == null) {
                this.K = new HashMap();
            }
            this.K.put(Long.valueOf(document.f18115id), Boolean.TRUE);
            MediaDataController.getInstance(this.f33977b).preloadImage(ImageLocation.getForDocument(document), 2);
        }
    }
    ...
    public final void p(TLRPC.TL_messages_stickerSet tL_messages_stickerSet, MessageObject messageObject) {
        bo boVar = this.f33976a;
        if (boVar != null && !MessagesController.getInstance(this.f33977b).premiumFeaturesBlocked() && boVar.getParentActivity() != null) {
            ...
            ax0Var.f25584b.setText(tL_messages_stickerSet.set.title);
            ax0Var.f25585c.setText(LocaleController.getString(R.string.PremiumStickerTooltip));
            ...
            mcVar.f26136a = new kw(6, this, messageObject);
            ...
            g10.f26746b = messageObject.getId();
            g10.j();
        }
    }
