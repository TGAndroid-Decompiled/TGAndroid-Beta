...
public final class mf1 extends org.telegram.ui.Components.qv0 {
    public boolean f35797w0;
    public final Paint f35798x0;
    public final fg1 f35799y0;

    public mf1(fg1 fg1Var, Context context) {
        super(context, null);
        this.f35799y0 = fg1Var;
        setWillNotDraw(false);
        this.f35798x0 = new Paint();
    }
    ...
    public final void J(Canvas canvas, float f7, Rect rect, Paint paint, boolean z10) {
        if (Build.VERSION.SDK_INT >= 29 && SharedConfig.chatBlurEnabled()) {
            fg1 fg1Var = this.f35799y0;
            if (fg1Var.f33657g1 != null) {
                canvas.save();
                canvas.translate(0.0f, -f7);
                fg1Var.f33657g1.y(canvas, rect.left, rect.top + f7, rect.right, rect.bottom + f7);
                canvas.restore();
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        int measuredHeight;
        fg1 fg1Var = this.f35799y0;
        fh.d dVar = fg1Var.f33659h1;
        fh.d dVar2 = fg1Var.f33657g1;
        ah.i iVar = fg1Var.f33655f1;
        ...
        if (fg1Var.isInPreviewMode()) {
            int themedColor = fg1Var.getThemedColor(org.telegram.ui.ActionBar.j6.f18863d6);
            Paint paint = this.f35798x0;
            paint.setColor(themedColor);
            paint.setAlpha((int) (fg1Var.W * 255.0f));
            canvas2 = canvas;
            canvas2.drawRect(0.0f, 0.0f, getWidth(), AndroidUtilities.statusBarHeight, paint);
            canvas2.drawLine(0.0f, 0.0f, 0.0f, getHeight(), org.telegram.ui.ActionBar.j6.f18985k0);
        } else {
            canvas2 = canvas;
        }
        if (fg1Var.M0 == null) {
            AndroidUtilities.drawNavigationBarProtection(canvas2, this, fg1Var.getThemedColor(org.telegram.ui.ActionBar.j6.f18863d6), fg1Var.f33652e1);
        }
    }
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        if (view == kVar && !fg1Var.isInPreviewMode()) {
            ...
            org.telegram.ui.Components.i81 i81Var = fg1Var.f33642a1;
            if (i81Var != null && i81Var.getVisibility() != 8) {
                f7 = fg1Var.f33642a1.getMeasuredHeight();
            } else {
                f7 = 0.0f;
            }
            ...
            if (f10 > 0.0f) {
                if (f10 < 1.0f) {
                    ...
                    org.telegram.ui.ActionBar.j6.f18985k0.setAlpha((int) (alpha * fg1Var.W));
                    float f11 = i10;
                    canvas.drawLine(0.0f, f11, getMeasuredWidth(), f11, org.telegram.ui.ActionBar.j6.f18985k0);
                    org.telegram.ui.ActionBar.j6.f18985k0.setAlpha(alpha);
                } else {
                    float f12 = i10;
                    canvas.drawLine(0.0f, f12, getMeasuredWidth(), f12, org.telegram.ui.ActionBar.j6.f18985k0);
                }
            }
        }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (t41Var != null) {
            ...
            int i13 = fg1Var.f33652e1;
            layoutParams.height = dp + i13;
            fg1Var.f33670o0.setPadding(0, 0, 0, i13);
            this.f35797w0 = false;
        }
        int i14 = 0;
