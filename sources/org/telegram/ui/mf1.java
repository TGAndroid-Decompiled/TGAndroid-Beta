...
public class mf1 extends org.telegram.ui.ActionBar.p2 implements NotificationCenter.NotificationCenterDelegate, org.telegram.ui.Components.rg, vg0 {
    public static final HashSet f39101k1 = new HashSet();
    public oh.z4 A0;
    public boolean B;
    public af1 B0;
    public ne1 C;
    ...
    public org.telegram.ui.ActionBar.w0 f39103a0;
    public int f39104a1;
    public final ArrayList f39105b;
    public org.telegram.ui.ActionBar.w0 f39106b0;
    public int f39107b1;
    public int f39108c;
    public org.telegram.ui.ActionBar.w0 f39109c0;
    public final og.e f39110c1;
    public se1 d;
    public org.telegram.ui.ActionBar.w0 f39111d0;
    public final tg.d f39112d1;
    public l0 f39113e;
    public org.telegram.ui.ActionBar.w0 f39114e0;
    public final tg.d f39115e1;
    public org.telegram.ui.Components.bo f39116f;
    public org.telegram.ui.ActionBar.w0 f39117f0;
    public final og.a f39118f1;
    public org.telegram.ui.ActionBar.g1 f39119g0;
    public og.k f39120g1;
    public org.telegram.ui.Components.a20 h;
    public org.telegram.ui.ActionBar.g1 f39121h0;
    public final ArrayList f39122h1;
    public org.telegram.ui.ActionBar.g1 f39123i0;
    public final RectF f39124i1;
    public org.telegram.ui.ActionBar.w0 f39125j0;
    public final RectF f39126j1;
    public RadialProgressView f39127k0;
    public c51 f39128l0;
    public org.telegram.ui.ActionBar.w0 m0;
    public cf1 f39129n;
    public org.telegram.ui.ActionBar.w0 f39130n0;
    public if1 f39131o0;
    public boolean f39132p0;
    public final boolean f39133q0;
    public final bf1 f39134r;
    public final boolean f39135r0;
    public final TopicsController f39136s;
    public final boolean f39137s0;
    public final boolean f39138t0;
    public final boolean f39139u0;
    public nf1 v;
    public String f39140v0;
    public ww f39141w;
    public boolean f39142w0;
    public int f39143x;
    public HashSet f39144x0;
    public int f39145y;
    public boolean f39146y0;
    public boolean f39147z0;

    public mf1(Bundle bundle) {
        super(bundle);
        this.f39105b = new ArrayList();
        new ArrayList();
        this.f39134r = new bf1(this);
        this.f39143x = 0;
        this.B = true;
        this.D = true;
        this.S = true;
        ...
        this.f39122h1 = arrayList;
        RectF rectF = new RectF();
        this.f39124i1 = rectF;
        RectF rectF2 = new RectF();
        this.f39126j1 = rectF2;
        arrayList.add(rectF);
        arrayList.add(rectF2);
        long j10 = this.arguments.getLong("chat_id", 0L);
        this.f39102a = j10;
        this.f39133q0 = this.arguments.getBoolean("for_select", false);
        this.f39135r0 = this.arguments.getBoolean("forward_to", false);
        this.f39139u0 = this.arguments.getBoolean("bot_share_to", false);
        this.f39137s0 = this.arguments.getBoolean("quote", false);
        this.f39138t0 = this.arguments.getBoolean("reply_to", false);
        this.f39140v0 = this.arguments.getString("voicechat", null);
        this.f39142w0 = this.arguments.getBoolean("videochat", false);
        this.f39136s = getMessagesController().getTopicsController();
        ...
        if (Build.VERSION.SDK_INT >= 31) {
            this.f39110c1 = new og.e(false);
            this.f39112d1 = new tg.d(null);
    ...
    public static void I0(org.telegram.ui.xn r6) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.mf1.I0(org.telegram.ui.xn):void");
    }
    ...
    public static boolean U(mf1 mf1Var, TLRPC.TL_error tL_error) {
        ...
        SharedPreferences.Editor edit = MessagesController.getNotificationsSettings(mf1Var.currentAccount).edit();
        edit.putLong("dialog_join_requested_time_" + (-mf1Var.f39102a), System.currentTimeMillis()).commit();
    ...
    public static void V(mf1 mf1Var, View view) {
        ...
        if (mf1Var.getParentLayout() != null && !((ActionBarLayout) mf1Var.getParentLayout()).y() && (view instanceof jf1)) {
            ...
            long j12 = -j11;
            boolean isMonoForum = mf1Var.getMessagesController().isMonoForum(j12);
            if (tL_forumTopic == null) {
                j10 = 0;
            } else if (isMonoForum) {
                j10 = DialogObject.getPeerDialogId(tL_forumTopic.from_id);
            } else {
                j10 = tL_forumTopic.f20895id;
            }
            long j13 = j10;
            if (mf1Var.f39133q0) {
                nf1 nf1Var = mf1Var.v;
                if (nf1Var != null) {
                    pf1 pf1Var = nf1Var.f39424a;
                    Bundle bundle = new Bundle();
                    sf1 sf1Var = pf1Var.f40030a;
                    bundle.putLong("dialog_id", sf1Var.f41279c);
                    bundle.putLong("topic_id", tL_forumTopic.f20895id);
                    bundle.putBoolean("exception", true);
                    g11 g11Var = new g11(bundle, null);
                    g11Var.f37062r = new vl0(25, pf1Var, tL_forumTopic);
                    sf1Var.presentFragment(g11Var);
                }
                py pyVar = mf1Var.I0;
                if (pyVar != null) {
                    pyVar.O3(j12, j13, true, mf1Var);
                }
            } else if (mf1Var.X.size() > 0) {
                mf1Var.N0(view);
            } else {
                if (mf1Var.inPreviewMode && AndroidUtilities.isTablet()) {
                    for (org.telegram.ui.ActionBar.p2 p2Var : mf1Var.getParentLayout().getFragmentStack()) {
                        if (p2Var instanceof py) {
                            py pyVar2 = (py) p2Var;
                            if (pyVar2.h4()) {
                                MessagesStorage.TopicKey topicKey = pyVar2.f40242m2;
                ...
                bg.e.m(mf1Var, j11, tL_forumTopic, 0);
            }
        }
    }

    public static boolean W(mf1 mf1Var, View view, float f10) {
        if (mf1Var.f39133q0 || mf1Var.getParentLayout() == null || ((ActionBarLayout) mf1Var.getParentLayout()).y()) {
            return false;
        }
    ...
    public static void X(mf1 mf1Var) {
        ...
        if (iw0Var != null && Build.VERSION.SDK_INT >= 23) {
            iw0Var.setForeground(new ColorDrawable(i0.a.k(mf1Var.getThemedColor(org.telegram.ui.ActionBar.k6.f21659d6), 100)));
        }
        mf1Var.P0();
    }
    ...
    public static void b0(mf1 mf1Var, boolean z4) {
        ...
        if (mf1Var.X0 == null) {
            org.telegram.ui.Components.l81 n10 = mf1Var.f39131o0.n(8, false);
            mf1Var.X0 = n10;
            if (mf1Var.J0 != null) {
                n10.setBackgroundColor(mf1Var.getThemedColor(org.telegram.ui.ActionBar.k6.f21659d6));
            }
            mf1Var.f39113e.addView(mf1Var.X0, k7.c6.c(44.0f, -1));
        }
        float f11 = mf1Var.T;
        if (z4) {
            f10 = 1.0f;
        ...
        mf1Var.V0 = ValueAnimator.ofFloat(f11, f10);
        AndroidUtilities.updateViewVisibilityAnimated(mf1Var.f39131o0, false, 1.0f, true);
        py pyVar = mf1Var.J0;
        if (pyVar != null && (kxVar = pyVar.C3) != null) {
            kxVar.J = !z4;
        }
        if (!z4 && mf1Var.f39131o0.getVisibility() == 0 && mf1Var.f39131o0.getAlpha() == 1.0f) {
            z10 = true;
        } else {
            z10 = false;
        }
        ...
        mf1Var.f39131o0.setVisibility(0);
        if (!z4) {
            mf1Var.f39130n0.setVisibility(0);
        } else {
            AndroidUtilities.requestAdjustResize(mf1Var.getParentActivity(), mf1Var.classGuid);
            mf1Var.Q0(false);
        }
        mf1Var.V0.addListener(new ve1(mf1Var, z4, 0));
        mf1Var.V0.setDuration(200L);
        mf1Var.V0.setInterpolator(org.telegram.ui.Components.pr.f30183f);
        mf1Var.V0.start();
    ...
    public final void A0() {
        this.G0 = this.f39136s.isLoading(this.f39102a);
        if (this.A0 != null) {
            ArrayList arrayList = this.f39105b;
            if (arrayList.size() == 0 || (arrayList.size() == 1 && ((df1) arrayList.get(0)).f36216c != null && ((df1) arrayList.get(0)).f36216c.f20895id == 1)) {
    ...
    public final void D0(HashSet hashSet, Runnable runnable) {
        ...
        if (hashSet.size() == 1) {
            d2Var.Q = LocaleController.formatString(R.string.DeleteSelectedTopic, this.f39136s.findTopic(this.f39102a, ((Integer) arrayList.get(0)).intValue()).title);
        } else {
    ...
    public final void H0(boolean z4) {
        ...
        Bundle bundle = new Bundle();
        bundle.putLong("chat_id", this.f39102a);
        ProfileActivity profileActivity = new ProfileActivity(bundle, this.f39116f.getSharedMediaPreloader());
        profileActivity.K4(this.G);
        if (this.fragmentView.getMeasuredHeight() > this.fragmentView.getMeasuredWidth() && this.f39116f.getAvatarImageView().getImageReceiver().hasImageLoaded() && z4) {
            i10 = 2;
        } else {
            i10 = 1;
        }
    ...
    public final void M0(org.telegram.ui.Cells.r2 r2Var) {
        ...
        int b10 = r32[0].b(noVar.f29574f);
        noVar.f29582o = 1;
        long j11 = this.f39102a;
        long j12 = -j11;
        noVar.d(j12, tL_forumTopic.f20895id, null);
        if (ChatObject.canManageTopics(g())) {
            ...
            g1Var.setOnClickListener(new View.OnClickListener(this) {
                ...
                public final void onClick(View view) {
                    switch (r3) {
                        case 0:
                            mf1 mf1Var = this.f39093b;
                            mf1Var.f39147z0 = true;
                            mf1Var.K0 = true;
                            TopicsController topicsController = mf1Var.f39136s;
                            long j13 = mf1Var.f39102a;
                            TLRPC.TL_forumTopic tL_forumTopic2 = tL_forumTopic;
                            topicsController.pinTopic(j13, tL_forumTopic2.f20895id, !tL_forumTopic2.pinned, mf1Var);
                            mf1Var.finishPreviewFragment();
                            return;
                        case 1:
                            mf1 mf1Var2 = this.f39093b;
                            mf1Var2.K0 = true;
                            TopicsController topicsController2 = mf1Var2.f39136s;
                            long j14 = mf1Var2.f39102a;
                            TLRPC.TL_forumTopic tL_forumTopic3 = tL_forumTopic;
                            topicsController2.toggleCloseTopic(j14, tL_forumTopic3.f20895id, true ^ tL_forumTopic3.closed);
                            mf1Var2.finishPreviewFragment();
                            return;
                        default:
                            HashSet hashSet = new HashSet();
                            hashSet.add(Integer.valueOf(tL_forumTopic.f20895id));
                            mf1 mf1Var3 = this.f39093b;
        ...
        if (getMessagesController().isDialogMuted(j12, tL_forumTopic.f20895id)) {
        ...
        if (ChatObject.canDeleteTopic(this.currentAccount, g(), tL_forumTopic)) {
            ...
            g1Var4.setIconColor(getThemedColor(org.telegram.ui.ActionBar.k6.f21876p7));
            g1Var4.setTextColor(getThemedColor(org.telegram.ui.ActionBar.k6.f21895q7));
    ...
    public final void N0(View view) {
        ...
        if ((view instanceof jf1) && (tL_forumTopic = (jf1Var = (jf1) view).K) != null) {
            int i19 = tL_forumTopic.f20895id;
            Integer valueOf = Integer.valueOf(i19);
            HashSet hashSet = this.X;
            if (!hashSet.remove(valueOf)) {
                hashSet.add(Integer.valueOf(i19));
            }
            jf1Var.V(hashSet.contains(Integer.valueOf(i19)), true);
            ...
            if (!hashSet.isEmpty()) {
                if (!this.actionBar.a(null)) {
                    ...
                    this.Z.setTextColor(getThemedColor(org.telegram.ui.ActionBar.k6.f22038y8));
                    j11.addView(this.Z, k7.c6.m(1.0f, 0, -1, 72, 0, 0));
                    this.Z.setOnTouchListener(new org.telegram.ui.ActionBar.s2(29));
                    this.f39103a0 = j11.g(4, R.drawable.msg_pin, AndroidUtilities.dp(54.0f));
                    this.f39106b0 = j11.g(5, R.drawable.msg_unpin, AndroidUtilities.dp(54.0f));
                    this.f39109c0 = j11.g(6, R.drawable.msg_mute, AndroidUtilities.dp(54.0f));
                    this.f39111d0 = j11.h(7, R.drawable.msg_delete, LocaleController.getString(R.string.Delete), AndroidUtilities.dp(54.0f));
                    ...
                    this.f39125j0 = h10;
                    this.f39119g0 = h10.e(8, R.drawable.msg_markread, LocaleController.getString(R.string.MarkAsRead));
                    this.f39121h0 = this.f39125j0.e(9, R.drawable.msg_topic_close, LocaleController.getString(R.string.CloseTopic));
                    this.f39123i0 = this.f39125j0.e(10, R.drawable.msg_topic_restart, LocaleController.getString(R.string.RestartTopic));
                }
                if (this.inPreviewMode) {
                ...
                if (i20 > 0) {
                    this.f39119g0.setVisibility(0);
                    this.f39119g0.g(LocaleController.getString(R.string.MarkAsRead), R.drawable.msg_markread, null);
                } else {
                    this.f39119g0.setVisibility(8);
                }
                if (i21 != 0) {
                    this.f39146y0 = false;
                    this.f39109c0.setIcon(R.drawable.msg_unmute);
                    this.f39109c0.setContentDescription(LocaleController.getString(R.string.ChatsUnmute));
                    z4 = true;
                } else {
                    z4 = true;
                    this.f39146y0 = true;
                    this.f39109c0.setIcon(R.drawable.msg_mute);
                    this.f39109c0.setContentDescription(LocaleController.getString(R.string.ChatsMute));
                }
                org.telegram.ui.ActionBar.w0 w0Var = this.f39103a0;
                if (i22 == z4 && i23 == 0) {
                    i10 = 0;
                } else {
                    i10 = 8;
                ...
                org.telegram.ui.ActionBar.w0 w0Var2 = this.f39106b0;
                if (i23 == z4 && i22 == 0) {
                    i11 = 0;
                } else {
                    i11 = 8;
                ...
                org.telegram.ui.ActionBar.g1 g1Var = this.f39121h0;
                if (i24 == 0 && i25 > 0) {
                    i12 = 0;
                } else {
                    i12 = 8;
                ...
                org.telegram.ui.ActionBar.g1 g1Var2 = this.f39121h0;
                if (i25 > 1) {
                ...
                org.telegram.ui.ActionBar.g1 g1Var3 = this.f39123i0;
                if (i25 == 0 && i24 > 0) {
                    i14 = 0;
                } else {
                    i14 = 8;
                ...
                org.telegram.ui.ActionBar.g1 g1Var4 = this.f39123i0;
                if (i24 > 1) {
                ...
                org.telegram.ui.ActionBar.w0 w0Var3 = this.f39111d0;
                ...
                org.telegram.ui.ActionBar.w0 w0Var4 = this.f39114e0;
                ...
                org.telegram.ui.ActionBar.w0 w0Var5 = this.f39117f0;
    ...
    public final void O0(boolean r20) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.mf1.O0(boolean):void");
    }

    public final void P0() {
        RadialProgressView radialProgressView = this.f39127k0;
        if (radialProgressView == null) {
            return;
        }
        radialProgressView.setProgressColor(getThemedColor(org.telegram.ui.ActionBar.k6.Ae));
        this.h.g();
        c51 c51Var = this.f39128l0;
        ...
        this.f39131o0.setBackgroundColor(getThemedColor(i10));
    }
    ...
    public final void Q0(boolean z4) {
        ...
        TLRPC.Chat chat = messagesController.getChat(Long.valueOf(j10));
        int i10 = 0;
        if (!ChatObject.isNotInChat(getMessagesController().getChat(Long.valueOf(j10))) && ChatObject.canCreateTopic(chat) && !this.f39132p0 && !this.f39133q0 && !this.G0) {
            z10 = true;
        } else {
            z10 = false;
        }
    ...
    public final void S0(float f10) {
        this.T = f10;
        int themedColor = getThemedColor(org.telegram.ui.ActionBar.k6.f21981v8);
        ...
        this.actionBar.B(i0.a.d(this.T, getThemedColor(org.telegram.ui.ActionBar.k6.f21946t8), getThemedColor(org.telegram.ui.ActionBar.k6.f22055z8)), false);
        if (!this.inPreviewMode) {
            this.actionBar.setBackgroundColor(i0.a.d(this.T, getThemedColor(org.telegram.ui.ActionBar.k6.f21930s8), getThemedColor(org.telegram.ui.ActionBar.k6.f21659d6)));
        }
        float f11 = 1.0f - f10;
        this.f39116f.getTitleTextView().setAlpha(f11);
        this.f39116f.getSubtitleTextView().setAlpha(f11);
        org.telegram.ui.Components.l81 l81Var = this.X0;
        if (l81Var != null) {
            l81Var.setTranslationY((-AndroidUtilities.dp(16.0f)) * f11);
            this.X0.setAlpha(f10);
        }
        this.f39131o0.setTranslationY((-AndroidUtilities.dp(16.0f)) * f11);
        this.f39131o0.setAlpha(f10);
        if (isInPreviewMode()) {
            this.f39113e.invalidate();
        }
        this.d.invalidate();
        this.K.setAlpha(f11);
        if (this.W0) {
    ...
    public final void T0() {
        oh.z4 z4Var = this.A0;
        if (z4Var != null && z4Var.f25364e != null) {
            ...
            if (ChatObject.canUserDoAdminAction(g(), 15)) {
                this.A0.f25364e.setText(AndroidUtilities.replaceCharSequence("%s", AndroidUtilities.replaceTags(LocaleController.getString(R.string.NoTopicsDescription)), spannableStringBuilder));
                return;
            }
            String string = LocaleController.getString(R.string.General);
            TLRPC.TL_forumTopic findTopic = getMessagesController().getTopicsController().findTopic(this.f39102a, 1L);
            if (findTopic != null) {
                string = findTopic.title;
            }
            this.A0.f25364e.setText(AndroidUtilities.replaceTags(LocaleController.formatString("NoTopicsDescriptionUser", R.string.NoTopicsDescriptionUser, string)));
        }
    }
    ...
    public final void U0(boolean z4, boolean z10) {
        ...
        this.K0 = false;
        TopicsController topicsController = this.f39136s;
        long j10 = this.f39102a;
        ...
        if (topics != null) {
            ...
            arrayList.clear();
            ze1 ze1Var2 = null;
            if (UserObject.isBotForum(this.currentAccount, -j10) && this.f39135r0) {
                arrayList.add(new df1(3, null));
            }
            for (int i10 = 0; i10 < topics.size(); i10++) {
                HashSet hashSet = this.f39144x0;
                if (hashSet == null || !hashSet.contains(Integer.valueOf(topics.get(i10).f20895id))) {
            ...
            for (int i11 = 0; i11 < arrayList.size(); i11++) {
                ...
                if (df1Var != null && (tL_forumTopic = df1Var.f36216c) != null && tL_forumTopic.hidden) {
                    this.f39143x++;
                }
            }
            xe1 xe1Var = this.K;
            if (xe1Var != null) {
                f2.u0 itemAnimator = xe1Var.getItemAnimator();
                if (z4) {
                    ze1Var = this.F0;
                } else {
                    ze1Var = null;
                ...
                if (itemAnimator != ze1Var) {
                    ...
                    xe1Var2.setItemAnimator(ze1Var2);
                }
            }
            bf1 bf1Var = this.f39134r;
            if (bf1Var != null) {
            ...
            if ((this.f39147z0 || size == 0) && (ne1Var = this.C) != null) {
                ne1Var.h1(0, 0);
                this.f39147z0 = false;
            }
        }
    ...
    public final View createView(Context context) {
        ...
        se1Var.setBackgroundColor(getThemedColor(org.telegram.ui.ActionBar.k6.f21659d6));
        ...
        this.actionBar.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view) {
                ...
                switch (r2) {
                    case 0:
                        mf1 mf1Var = this.f38134b;
                        mf1Var.presentFragment(ie1.a0(mf1Var.f39102a, 0L));
                        return;
                    case 1:
                        mf1 mf1Var2 = this.f38134b;
                        mf1Var2.getMessagesController().hidePeerSettingsBar(-mf1Var2.f39102a, null, mf1Var2.g());
                        mf1Var2.O0(false);
                        return;
                    case 2:
                        mf1 mf1Var3 = this.f38134b;
                        if (!mf1Var3.f39132p0) {
                            mf1Var3.H0(false);
                            return;
                        }
                        return;
                    case 3:
                        this.f38134b.finishPreviewFragment();
                        return;
                    default:
                        py pyVar3 = this.f38134b.J0;
                        if (pyVar3 != null && (w0Var = pyVar3.f40212g0) != null) {
                            w0Var.performClick();
                            return;
                        }
                        return;
        ...
        this.f39130n0.e(1, R.drawable.msg_discussion, LocaleController.getString(R.string.TopicViewAsMessages));
        this.O = this.f39130n0.e(2, R.drawable.msg_addcontact, LocaleController.getString(R.string.AddMember));
        org.telegram.ui.ActionBar.w0 w0Var = this.f39130n0;
        int i13 = R.raw.boosts;
        this.Q = w0Var.d(14, 0, new org.telegram.ui.Components.ij0(i13, AndroidUtilities.dp(24.0f), "" + R.raw.boosts, AndroidUtilities.dp(24.0f)), LocaleController.getString(R.string.BoostingBoostGroupMenu), true, false, w0Var.f22356j0);
        this.N = this.f39130n0.e(3, R.drawable.msg_topic_create, LocaleController.getString(R.string.CreateTopic));
        this.R = this.f39130n0.e(15, R.drawable.msg_report, LocaleController.getString(R.string.ReportChat));
        this.P = this.f39130n0.f(11, R.drawable.msg_leave, LocaleController.getString(R.string.LeaveMegaMenu), null);
        ...
        org.telegram.ui.Components.bo boVar2 = this.f39116f;
        if (!AndroidUtilities.isTablet() && !this.inPreviewMode) {
            z10 = true;
        } else {
            z10 = false;
        }
        boVar2.setOccupyStatusBar(z10);
        org.telegram.ui.Components.bo boVar3 = this.f39116f;
        long j10 = -this.f39102a;
        if (j10 < 0) {
            z11 = true;
        } else {
        ...
        boVar3.f25663b = z11;
        boVar3.setClipChildren(false);
        this.actionBar.addView(this.f39116f, 0, k7.c6.d(-2, -1.0f, 51, 56.0f, 0.0f, 86.0f, 0.0f));
        if (!this.f39133q0) {
            this.f39116f.getAvatarImageView().setOnClickListener(new a8(this, 3));
        }
        this.K = new xe1(this, context);
        vg.i iVar = new vg.i(this.d);
        ViewGroup viewGroup = this.d;
        og.a aVar = this.f39118f1;
        aVar.d = iVar;
        ...
        this.f39120g1 = new og.k(xe1Var, viewGroup, new x8(xe1Var2, 2));
        ...
        this.K.setOnScrollListener(new oe1(this, 1));
        xe1 xe1Var4 = this.K;
        xe1Var4.V1 = true;
        xe1Var4.W1 = 0;
        ...
        this.K.setOnScrollListener(new oe1(this, 2));
        xe1 xe1Var5 = this.K;
        ...
        new SparseArray();
        new HashMap();
        this.K.setAdapter(this.f39134r);
        this.K.setClipToPadding(false);
        this.K.j(new oe1(this, 0));
            ...
            public final void onClick(View view) {
                ...
                switch (r2) {
                    ...
                    case 3:
                        ...
                        return;
                    default:
                        py pyVar32 = this.f38134b.J0;
                        if (pyVar32 != null && (w0Var2 = pyVar32.f40212g0) != null) {
                            w0Var2.performClick();
                            return;
                        }
                        return;
        ...
        this.h.f25128c.setImageResource(R.drawable.ic_chatlist_add_2);
        this.h.f25128c.setScaleType(ImageView.ScaleType.CENTER_INSIDE);
        this.h.f25128c.setPadding(AndroidUtilities.dp(12.0f), AndroidUtilities.dp(12.0f), AndroidUtilities.dp(12.0f), AndroidUtilities.dp(12.0f));
        ...
        textView.setTextColor(getThemedColor(org.telegram.ui.ActionBar.k6.f22036y6));
        ...
        this.f39129n = frameLayout;
        textView.setAlpha(0.0f);
        oh.z4 z4Var = new oh.z4(this, context, u00Var);
        this.A0 = z4Var;
        try {
            z4Var.f25362b.getImageReceiver().setAutoRepeat(2);
        } catch (Exception unused) {
        }
        this.A0.e(this.G0, this.fragmentBeginToShow);
        this.A0.d.setText(LocaleController.getString(R.string.NoTopics));
        T0();
        this.f39129n.addView(u00Var);
        this.f39129n.addView(this.A0);
        this.d.addView(this.f39129n);
        this.K.setEmptyView(this.f39129n);
        this.f39128l0 = new c51(context, 6);
        org.telegram.ui.Components.k61 k61Var = new org.telegram.ui.Components.k61(context);
        this.I = k61Var;
        this.f39128l0.addView(k61Var);
        this.d.addView(this.f39128l0, k7.c6.e(-1, 51, 80));
        this.I.setOnClickListener(new qe1(this));
        RadialProgressView radialProgressView = new RadialProgressView(context, null);
        this.f39127k0 = radialProgressView;
        radialProgressView.setSize(AndroidUtilities.dp(22.0f));
        this.f39127k0.setVisibility(4);
        this.f39128l0.addView(this.f39127k0, k7.c6.e(30, 30, 17));
        ImageView imageView = new ImageView(context);
        this.T0 = imageView;
        imageView.setImageResource(R.drawable.miniplayer_close);
        this.T0.setContentDescription(LocaleController.getString(R.string.Close));
        ImageView imageView2 = this.T0;
        int i14 = org.telegram.ui.ActionBar.k6.f21667de;
        imageView2.setBackground(org.telegram.ui.ActionBar.a6.c(null, org.telegram.ui.ActionBar.a6.b(getThemedColor(i14))));
        ...
        this.f39128l0.addView(this.T0, k7.c6.d(36, 36.0f, 53, 0.0f, 6.0f, 2.0f, 0.0f));
        ...
        this.f39131o0 = if1Var;
        if1Var.setVisibility(8);
        this.f39113e.addView(this.f39131o0, k7.c6.d(-1, -1.0f, 119, 0.0f, 44.0f, 0.0f, 0.0f));
        if1 if1Var2 = this.f39131o0;
        int i15 = org.telegram.ui.ActionBar.k6.f21659d6;
        if1Var2.setBackgroundColor(getThemedColor(i15));
        this.actionBar.setDrawBlurBackground(this.d);
        getMessagesStorage().loadChatInfo(this.f39102a, true, null, true, false, 0);
        ...
        this.R0.setOnAnimatedHeightChangedListener(new ke1(this, 0));
        ...
        if (Build.VERSION.SDK_INT >= 23) {
            iw0Var.setForeground(new ColorDrawable(i0.a.k(getThemedColor(i15), 100)));
        }
        ...
        if (this.inPreviewMode && AndroidUtilities.isTablet()) {
            ...
            while (true) {
                ...
                if (p2Var instanceof py) {
                    py pyVar4 = (py) p2Var;
                    if (pyVar4.h4()) {
                        MessagesStorage.TopicKey topicKey = pyVar4.f40242m2;
    ...
    public final TLRPC.Chat g() {
        return getMessagesController().getChat(Long.valueOf(this.f39102a));
    }
    ...
    public final boolean isLightStatusBar() {
        ...
        if (this.actionBar.s()) {
            themedColor = getThemedColor(org.telegram.ui.ActionBar.k6.f22000w8);
        }
    ...
    public final void onFragmentDestroy() {
        ...
        TLRPC.Chat chat = getMessagesController().getChat(Long.valueOf(this.f39102a));
        if (ChatObject.isChannel(chat)) {
    ...
    public final void onPause() {
        super.onPause();
        getMessagesController().getTopicsController().onTopicFragmentPause(this.f39102a);
    ...
    public final void setPreviewOpenedProgress(float f10) {
        org.telegram.ui.Components.bo boVar = this.f39116f;
        if (boVar != null) {
            boVar.setAlpha(f10);
            this.f39130n0.setAlpha(f10);
    ...
    public final void setPreviewReplaceProgress(float f10) {
        ...
        if (boVar != null) {
            boVar.setAlpha(f10);
            this.f39116f.setTranslationX((1.0f - f10) * AndroidUtilities.dp(40.0f));
        }
    }
    ...
    public final void x0() {
        ...
        float f10;
        int i10;
        if (Build.VERSION.SDK_INT >= 31 && (eVar = this.f39110c1) != null) {
            ...
            int measuredHeight = (view.getMeasuredHeight() - this.f39107b1) - AndroidUtilities.dp(8.0f);
            this.f39124i1.set(0.0f, -dp, view.getMeasuredWidth(), kVar.getMeasuredHeight() + dp + dp2);
            RectF rectF = this.f39126j1;
            ...
            eVar.g(i10, this.f39122h1);
            eVar.e(this.f39120g1, view.getMeasuredWidth(), view.getMeasuredHeight());
        }
    }

    @Override
    public final tg.d y() {
        return this.f39115e1;
    }
    ...
    public final void y0() {
        ...
        if (!topicsController.endIsReached(j10) && (ne1Var = this.C) != null) {
            int N0 = ne1Var.N0();
            if (this.f39105b.isEmpty() || N0 >= this.f39134r.h() - 5) {
    ...
    public final void z0(boolean z4) {
        ...
        ChatObject.Call call = this.E0;
        if (call != null && ((str = this.f39140v0) != null || this.f39142w0)) {
            org.telegram.ui.Components.voip.g2.m(chat, str, false, Boolean.valueOf(!call.call.rtmp_stream), getParentActivity(), this, getAccountInstance());
            this.f39140v0 = null;
            this.f39142w0 = false;
        } else if (this.f39140v0 != null && z4 && chatFull != null && chatFull.call == null && this.fragmentView != null && getParentActivity() != null) {
