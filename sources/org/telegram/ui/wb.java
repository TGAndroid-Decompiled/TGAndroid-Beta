...
public final class wb extends org.telegram.ui.ActionBar.o2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final fh.e f38644a;
    public FrameLayout f38645a0;
    public final ah.c f38646b;
    public ImageView f38647b0;
    public final ah.c f38648c;
    public org.telegram.ui.ActionBar.k5 f38649c0;
    public final ah.i d;
    public j0 f38650d0;
    public final int e;
    public k4 f38651e0;
    public final TLRPC.Chat f38652f;
    public TextureView f38653f0;
    public int f38654g0;
    public final ArrayList h;
    public int f38655h0;
    public boolean f38656i0;
    public boolean f38657j0;
    public final a0.i f38658k0;
    public final a0.i f38659l0;
    public final HashMap m0;
    public FrameLayout f38660n;
    public final ArrayList f38661n0;
    public final ArrayList f38662o0;
    public final HashSet f38663p0;
    public boolean f38664q0;
    public View f38665r;
    public boolean f38666r0;
    public RadialProgressView f38667s;
    public boolean f38668s0;
    public ArrayList f38669t0;
    public TLRPC.TL_channelAdminLogEventsFilter f38670u0;
    public lb v;
    public String f38671v0;
    public UndoView f38672w;
    public a0.i f38673w0;
    public gg.b0 f38674x;
    public final AnimationNotificationsLocker f38675x0;
    public org.telegram.ui.Components.pk0 f38676y;
    public final HashMap f38677y0;
    public HashMap f38678z0;
    ...
    public wb(TLRPC.Chat chat) {
        ...
        this.f38656i0 = true;
        this.f38657j0 = false;
        this.f38658k0 = new a0.i();
        this.f38659l0 = new a0.i();
        this.m0 = new HashMap();
        this.f38661n0 = new ArrayList();
        this.f38662o0 = new ArrayList();
        this.f38663p0 = new HashSet();
        this.f38670u0 = null;
        this.f38671v0 = "";
        this.f38675x0 = new AnimationNotificationsLocker(R0);
        this.f38677y0 = new HashMap();
        this.B0 = new ib(this);
    ...
    public static void K0(wb wbVar) {
        if (wbVar.v != null && !wbVar.f38661n0.isEmpty()) {
            wbVar.f38674x.h1(wbVar.f38662o0.size() - 1, (-100000) - wbVar.v.getPaddingTop());
        }
    }
    ...
    public static void U(wb wbVar, TLRPC.TL_channels_adminLogResults tL_channels_adminLogResults) {
        ...
        ArrayList arrayList = wbVar.f38661n0;
        boolean z10 = false;
        for (int i11 = 0; i11 < tL_channels_adminLogResults.events.size(); i11++) {
            ...
            if (iVar.h(tL_channelAdminLogEvent.f18153id) < 0) {
                ...
                MessageObject messageObject2 = new MessageObject(wbVar.currentAccount, tL_channelAdminLogEvent, (ArrayList<MessageObject>) arrayList, (HashMap<String, ArrayList<MessageObject>>) wbVar.m0, wbVar.f38652f, wbVar.T, false);
        ...
        for (int size = arrayList.size(); size < arrayList.size(); size++) {
            ...
            if (messageObject3 != null && messageObject3.contentType != 0 && messageObject3.getRealId() >= 0) {
                wbVar.f38659l0.k(messageObject3, messageObject3.getRealId());
            }
        ...
        if (!arrayList2.isEmpty()) {
            MediaDataController.getInstance(wbVar.currentAccount).loadReplyMessagesForMessages(arrayList2, -wbVar.f38652f.f18121id, 0, 0L, new za(wbVar, 1), wbVar.getClassGuid(), null);
        }
        wbVar.R0();
        wbVar.f38666r0 = false;
        if (!z10) {
            wbVar.f38664q0 = true;
        }
        AndroidUtilities.updateViewVisibilityAnimated(wbVar.f38660n, false, 0.3f, true);
        ...
        if (w0Var != null) {
            if (wbVar.f38662o0.isEmpty() && TextUtils.isEmpty(wbVar.f38671v0)) {
                i10 = 8;
            }
            ...
            while (i11 < size) {
                if (arrayList4.get(i11) == null) {
                    ...
                    if (((Integer) arrayList4.get(i11)).intValue() == 35) {
                        g1Var.c(wbVar.getThemedColor(org.telegram.ui.ActionBar.j6.f19100q7), wbVar.getThemedColor(org.telegram.ui.ActionBar.j6.f19082p7));
                    }
    ...
    public static void Y(wb wbVar, TLRPC.TL_channels_adminLogResults tL_channels_adminLogResults) {
        ...
        for (int i10 = 0; i10 < tL_channels_adminLogResults.events.size(); i10++) {
            ...
            if (iVar.h(tL_channelAdminLogEvent2.f18153id) < 0) {
                ...
                MessageObject messageObject = new MessageObject(wbVar.currentAccount, tL_channelAdminLogEvent2, (ArrayList<MessageObject>) arrayList, (HashMap<String, ArrayList<MessageObject>>) hashMap, wbVar.f38652f, wbVar.T, false);
                if (messageObject.contentType >= 0 && (((tL_channelAdminLogEvent = messageObject.currentEvent) == null || !(tL_channelAdminLogEvent.action instanceof TLRPC.TL_channelAdminLogEventActionDeleteMessage)) && !iVar.d(tL_channelAdminLogEvent2.f18153id))) {
                    wbVar.f38661n0.add(0, messageObject);
    ...
    public static void Z(wb wbVar, TLRPC.TL_error tL_error, TLObject tLObject) {
        ...
        if (tL_error == null) {
            ...
            wbVar.f38669t0 = tL_channels_channelParticipants.participants;
            if (chat != null && (chatFull = wbVar.getMessagesController().getChatFull(chat.f18121id)) != null && chatFull.antispam) {
                ...
                wbVar.f38669t0.add(0, channelParticipant);
            }
            Dialog dialog = wbVar.visibleDialog;
            if (dialog instanceof org.telegram.ui.Components.g0) {
                ((org.telegram.ui.Components.g0) dialog).S(wbVar.f38669t0);
            }
        }
    }
    ...
    public final MessageObject N0(long j3, long j10, ArrayList arrayList, boolean z10, boolean z11) {
        ...
        int i12 = 0;
        while (true) {
            ArrayList arrayList2 = this.f38662o0;
            messageObject = null;
        ...
        if (messageObject2 == null) {
            ...
            tL_message.dialog_id = -this.f38652f.f18121id;
        ...
        if (z11 && arrayList.size() > 1) {
            ...
            if (S0 == null) {
                ...
                org.telegram.ui.Components.m6 m6Var = S0.f35663a;
                m6Var.u(bold);
                ...
                org.telegram.ui.Components.m6 m6Var2 = S0.f35663a;
                if (z10) {
    ...
    public final void O0(boolean z10) {
        int abs;
        gg.b0 b0Var = this.f38674x;
        if (b0Var != null && !this.f38656i0) {
            int L0 = b0Var.L0();
            int i10 = 1;
            if (L0 == -1) {
                abs = 0;
            } else {
                abs = Math.abs(this.f38674x.N0() - L0) + 1;
            }
            if (abs > 0) {
                this.E.getClass();
                if (z10) {
                ...
                if (L0 <= i10 && !this.f38666r0 && !this.f38664q0) {
                    U0(false);
                }
            }
        }
    ...
    public final TextureView Q0(boolean z10) {
        ...
        if (this.f38650d0 == null) {
            j0 j0Var = new j0(this, getParentActivity(), 4);
            this.f38650d0 = j0Var;
            j0Var.setOutlineProvider(new ai.k2(8));
            this.f38650d0.setClipToOutline(true);
            this.f38650d0.setWillNotDraw(false);
            this.f38650d0.setVisibility(4);
            k4 k4Var = new k4(getParentActivity());
            this.f38651e0 = k4Var;
            k4Var.setBackgroundColor(0);
            if (z10) {
                this.f38650d0.addView(this.f38651e0, w7.x5.c(-1.0f, -1));
            }
            TextureView textureView = new TextureView(getParentActivity());
            this.f38653f0 = textureView;
            textureView.setOpaque(false);
            this.f38651e0.addView(this.f38653f0, w7.x5.c(-1.0f, -1));
        }
        if (this.f38650d0.getParent() == null) {
            tb tbVar = this.X;
            j0 j0Var2 = this.f38650d0;
            int i10 = AndroidUtilities.roundMessageSize;
            tbVar.addView(j0Var2, 1, new FrameLayout.LayoutParams(i10, i10));
        }
        this.f38650d0.setVisibility(4);
        this.f38651e0.setDrawingReady(false);
        return this.f38653f0;
    }
    ...
    public final void R0() {
        ...
        int i12 = 0;
        while (true) {
            ArrayList arrayList4 = this.f38661n0;
            if (i12 < arrayList4.size()) {
                ...
                if (j3 != j10 && !arrayList3.isEmpty()) {
                    ...
                    if (!arrayList3.isEmpty()) {
                        ...
                        if (TextUtils.isEmpty(this.f38671v0) && arrayList3.size() > 3) {
                            z11 = true;
                        } else {
                            z11 = false;
                        }
                        Long valueOf = Long.valueOf(messageObject3.eventId);
                        HashSet hashSet = this.f38663p0;
                ...
                ArrayList arrayList6 = this.f38662o0;
                arrayList6.clear();
    ...
    public final void U0(boolean z10) {
        sb sbVar;
        if (!this.f38666r0) {
            ArrayList arrayList = this.f38661n0;
            if (z10) {
                this.O = Long.MAX_VALUE;
                FrameLayout frameLayout = this.f38660n;
                if (frameLayout != null) {
            ...
            tL_channels_getAdminLog.channel = MessagesController.getInputChannel(this.f38652f);
            tL_channels_getAdminLog.f18156q = this.f38671v0;
            ...
            TLRPC.TL_channelAdminLogEventsFilter tL_channelAdminLogEventsFilter = this.f38670u0;
            ...
            if (this.f38673w0 != null) {
                tL_channels_getAdminLog.flags |= 2;
                for (int i10 = 0; i10 < this.f38673w0.m(); i10++) {
                    tL_channels_getAdminLog.admins.add(MessagesController.getInstance(this.currentAccount).getInputUser((TLRPC.User) this.f38673w0.n(i10)));
                }
            }
            b1();
    ...
    public final void W0(boolean z10) {
        ...
        long j3;
        lb lbVar = this.v;
        if (lbVar != null && this.f38674x != null && lbVar.getChildCount() > 0) {
            if (z10) {
    ...
    public final int X0(MessageObject messageObject) {
        ...
        if (!TextUtils.isEmpty(null)) {
            if (!TextUtils.isEmpty(messageObject.caption) && (t1Var = this.J0) != null && (textLayoutBlocks = t1Var.f21014c4) != null) {
                ...
                if (t1Var2 != null && t1Var2.f21253t1) {
                    i10 = t1Var2.f21152m2 + AndroidUtilities.dp(10.0f);
    ...
    public final void b1() {
        ...
        if (!TextUtils.isEmpty(this.f38671v0)) {
        ...
        } else if (this.f38673w0 == null && this.f38670u0 == null) {
    ...
    public final void c1() {
        ...
        for (int i13 = 0; i13 < childCount; i13++) {
            ...
            if (childAt instanceof org.telegram.ui.Cells.u1) {
                ...
                if (this.f38650d0 != null && messageObject2.isRoundVideo() && MediaController.getInstance().isPlayingMessage(messageObject2)) {
                    ImageReceiver photoImage = t1Var2.getPhotoImage();
                    this.f38650d0.setTranslationX(photoImage.getImageX());
                    this.f38650d0.setTranslationY(photoImage.getImageY() + this.fragmentView.getPaddingTop() + top);
                    this.fragmentView.invalidate();
                    this.f38650d0.invalidate();
                    z11 = true;
                }
    ...
    public final View createView(Context context) {
        ...
        this.J = linearLayout;
        linearLayout.setBackground(new org.telegram.ui.ActionBar.w5(this.L, this.X, AndroidUtilities.dp(12.0f), org.telegram.ui.ActionBar.j6.f18894f2));
        ...
        this.f38674x = b0Var;
        b0Var.j1(1);
        this.f38674x.l1(true);
        this.v.setLayoutManager(this.f38674x);
        org.telegram.ui.Components.pk0 pk0Var = new org.telegram.ui.Components.pk0(this.v, this.f38674x);
        this.f38676y = pk0Var;
        pk0Var.h = new ab(this);
        pk0Var.f27065i = this.L0;
        this.X.addView(this.v, w7.x5.c(-1.0f, -1));
        this.v.setOnScrollListener(new h3(this));
        this.glassEngine.a(this.v);
        int i14 = this.f38654g0;
        if (i14 != -1) {
            this.f38674x.h1(i14, this.f38655h0);
            this.f38654g0 = -1;
        }
        ?? view = new View(context);
        this.W = view;
        view.setup(this.f38646b);
        ...
        this.f38660n = frameLayout2;
        frameLayout2.setVisibility(4);
        this.X.addView(this.f38660n, w7.x5.e(-1, -1, 51));
        View view2 = new View(context);
        this.f38665r = view2;
        view2.setBackground(new org.telegram.ui.ActionBar.w5(this.f38665r, this.X, AndroidUtilities.dp(18.0f), org.telegram.ui.ActionBar.j6.f18894f2));
        this.f38660n.addView(this.f38665r, w7.x5.e(36, 36, 17));
        RadialProgressView radialProgressView = new RadialProgressView(context, null);
        this.f38667s = radialProgressView;
        radialProgressView.setSize(AndroidUtilities.dp(28.0f));
        this.f38667s.setProgressColor(org.telegram.ui.ActionBar.j6.w0(null, i11, false));
        this.f38660n.addView(this.f38667s, w7.x5.e(32, 32, 17));
        ...
        textView.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view3) {
                switch (r2) {
                    case 0:
                        wb wbVar = this.f33080b;
                        if (wbVar.getParentActivity() != null) {
                            org.telegram.ui.Components.g0 g0Var = new org.telegram.ui.Components.g0(wbVar, wbVar.f38670u0, wbVar.f38673w0, wbVar.f38652f.megagroup);
                            g0Var.S(wbVar.f38669t0);
                            g0Var.f24050g0 = new ab(wbVar);
                            wbVar.showDialog(g0Var);
                            return;
                        }
                        return;
                    case 1:
                        wb wbVar2 = this.f33080b;
                        AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(wbVar2.getParentActivity());
                        if (wbVar2.f38652f.megagroup) {
                            alertDialog$Builder.f18446a.T = AndroidUtilities.replaceTags(LocaleController.getString(R.string.EventLogInfoDetail));
                        } else {
                            alertDialog$Builder.f18446a.T = AndroidUtilities.replaceTags(LocaleController.getString(R.string.EventLogInfoDetailChannel));
                        }
                        alertDialog$Builder.k(LocaleController.getString(R.string.OK), null);
                        ...
                        return;
                    default:
                        wb wbVar3 = this.f33080b;
                        if (wbVar3.getParentActivity() != null) {
                            AndroidUtilities.hideKeyboard(wbVar3.N.getSearchField());
                            wbVar3.showDialog(org.telegram.ui.Components.c5.p(wbVar3.getParentActivity(), new wa(wbVar3, 0), null).f18470a);
                            return;
                        }
                        return;
                }
        ...
        this.f38645a0 = frameLayout3;
        frameLayout3.setWillNotDraw(false);
        this.f38645a0.setVisibility(4);
        this.f38645a0.setFocusable(true);
        this.f38645a0.setFocusableInTouchMode(true);
        this.f38645a0.setClickable(true);
        this.f38645a0.setPadding(0, AndroidUtilities.dp(3.0f), 0, 0);
        this.X.addView(this.f38645a0, w7.x5.e(-1, 51, 80));
        ImageView imageView2 = new ImageView(context);
        this.f38647b0 = imageView2;
        imageView2.setScaleType(scaleType);
        this.f38647b0.setImageResource(R.drawable.msg_calendar);
        this.f38647b0.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19234xe, false), PorterDuff.Mode.MULTIPLY));
        this.f38645a0.addView(this.f38647b0, w7.x5.e(48, 48, 53));
        this.f38647b0.setOnClickListener(new View.OnClickListener(this) {
            public final wb f33080b;
        ...
        this.f38649c0 = k5Var;
        k5Var.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19252ye, false));
        this.f38649c0.setTextSize(15);
        this.f38649c0.setTypeface(AndroidUtilities.bold());
        this.f38645a0.addView(this.f38649c0, w7.x5.d(-1, -2.0f, 19, 108.0f, 0.0f, 0.0f, 0.0f));
        this.E.D(true);
        if (this.f38666r0 && this.f38661n0.isEmpty()) {
            AndroidUtilities.updateViewVisibilityAnimated(this.f38660n, true, 0.3f, true);
            this.v.setEmptyView(null);
        } else {
            AndroidUtilities.updateViewVisibilityAnimated(this.f38660n, false, 0.3f, true);
        ...
        this.f38672w = undoView;
        undoView.setAdditionalTranslationY(AndroidUtilities.dp(51.0f));
        this.X.addView(this.f38672w, w7.x5.d(-1, -2.0f, 83, 8.0f, 0.0f, 8.0f, 8.0f));
        b1();
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.messagePlayingDidStart) {
            if (((MessageObject) objArr[0]).isRoundVideo()) {
                MediaController.getInstance().setTextureView(Q0(true), this.f38651e0, this.f38650d0, true);
                ...
                while (true) {
                    if (i12 < childCount) {
                        ...
                        if (childAt instanceof org.telegram.ui.Cells.t1) {
                            ...
                            if (this.f38650d0 != null && messageObject4.isRoundVideo() && MediaController.getInstance().isPlayingMessage(messageObject4)) {
                                ImageReceiver photoImage = t1Var4.getPhotoImage();
                                this.f38650d0.setTranslationX(photoImage.getImageX());
                                this.f38650d0.setTranslationY(photoImage.getImageY() + t1Var4.getTop() + this.fragmentView.getPaddingTop());
                                this.fragmentView.invalidate();
                                this.f38650d0.invalidate();
                                z10 = true;
                                break;
                ...
                if (this.f38650d0 != null) {
                    MessageObject playingMessageObject = MediaController.getInstance().getPlayingMessageObject();
                    if (!z10) {
                        this.f38650d0.setTranslationY((-AndroidUtilities.roundMessageSize) - 100);
                        this.fragmentView.invalidate();
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.I.getSubtitleTextView(), 4, (Class[]) null, new Paint[]{org.telegram.ui.ActionBar.j6.f18840c2, org.telegram.ui.ActionBar.j6.f18858d2}, org.telegram.ui.ActionBar.j6.B8));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.actionBar, 256, null, null, null, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, org.telegram.ui.ActionBar.j6.f19112r0, null, org.telegram.ui.ActionBar.j6.J7));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f18954i8));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f18972j8));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f18992k8));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19010l8));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19029m8));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19049n8));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19066o8));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.f19024m3, org.telegram.ui.ActionBar.j6.f19097q3}, null, org.telegram.ui.ActionBar.j6.f19122ra));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.f19044n3, org.telegram.ui.ActionBar.j6.f19115r3}, null, org.telegram.ui.ActionBar.j6.f18868dc));
        Drawable[] k10 = org.telegram.ui.ActionBar.j6.f19024m3.k();
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, org.telegram.ui.ActionBar.j6.f19097q3.k(), null, i13));
        Drawable[] k11 = org.telegram.ui.ActionBar.j6.f19061o3.k();
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, org.telegram.ui.ActionBar.j6.f19134s3.k(), null, i14));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.f19061o3, org.telegram.ui.ActionBar.j6.f19134s3}, null, org.telegram.ui.ActionBar.j6.Aa));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.f19061o3, org.telegram.ui.ActionBar.j6.f19134s3}, null, org.telegram.ui.ActionBar.j6.Da));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.f19061o3, org.telegram.ui.ActionBar.j6.f19134s3}, null, org.telegram.ui.ActionBar.j6.Ea));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.f19061o3, org.telegram.ui.ActionBar.j6.f19134s3}, null, org.telegram.ui.ActionBar.j6.Fa));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.f19079p3, org.telegram.ui.ActionBar.j6.f19153t3}, null, org.telegram.ui.ActionBar.j6.Ba));
        TextPaint textPaint = org.telegram.ui.ActionBar.j6.f19133s2;
        int i15 = org.telegram.ui.ActionBar.j6.f18958ic;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 4, new Class[]{org.telegram.ui.Cells.w0.class}, textPaint, null, null, i15));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 2, new Class[]{org.telegram.ui.Cells.w0.class}, org.telegram.ui.ActionBar.j6.f19133s2, null, null, org.telegram.ui.ActionBar.j6.f18976jc));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.f19208w4, org.telegram.ui.ActionBar.j6.f19098q4, org.telegram.ui.ActionBar.j6.f19225x4, org.telegram.ui.ActionBar.j6.f19190v4, org.telegram.ui.ActionBar.j6.f19172u4, org.telegram.ui.ActionBar.j6.C4}, null, org.telegram.ui.ActionBar.j6.f18996kc));
        int i16 = org.telegram.ui.ActionBar.j6.f19014lc;
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class, org.telegram.ui.Cells.w0.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19033mc));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f18903fc));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 2, new Class[]{org.telegram.ui.Cells.t1.class}, (Paint[]) null, org.telegram.ui.ActionBar.j6.f18939hc));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.f19260z3}, null, org.telegram.ui.ActionBar.j6.Ka));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.F3, org.telegram.ui.ActionBar.j6.G3}, null, org.telegram.ui.ActionBar.j6.f19143sc));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.N3, org.telegram.ui.ActionBar.j6.R3, org.telegram.ui.ActionBar.j6.V3}, null, org.telegram.ui.ActionBar.j6.f19250yc));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.f18803a4, org.telegram.ui.ActionBar.j6.f18823b4, org.telegram.ui.ActionBar.j6.Z3}, null, org.telegram.ui.ActionBar.j6.f19269zc));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.f18879e4}, null, org.telegram.ui.ActionBar.j6.Ta));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.f18896f4}, null, org.telegram.ui.ActionBar.j6.Ua));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.f18842c4}, null, org.telegram.ui.ActionBar.j6.Ac));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.f18860d4}, null, org.telegram.ui.ActionBar.j6.Bc));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.f18914g4}, null, org.telegram.ui.ActionBar.j6.Cc));
        Drawable[] drawableArr = {org.telegram.ui.ActionBar.j6.f18950i4};
        ...
        Drawable[] drawableArr2 = {org.telegram.ui.ActionBar.j6.f18932h4, org.telegram.ui.ActionBar.j6.B4, org.telegram.ui.ActionBar.j6.D4};
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.P4}, null, org.telegram.ui.ActionBar.j6.f19119r7));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.Q4}, null, org.telegram.ui.ActionBar.j6.f19103qa));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, org.telegram.ui.ActionBar.j6.f18821b2, null, null, org.telegram.ui.ActionBar.j6.Fc));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.f18968j4}, null, org.telegram.ui.ActionBar.j6.Gc));
        ...
        int i20 = org.telegram.ui.ActionBar.j6.f18810ab;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, null, null, i20));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f18830bb));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f18867db));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f18885eb));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f18812ad));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f18902fb));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f18850cd));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f18921gb));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f18869dd));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f18938hb));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f18886ed));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f18957ib));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f18904fd));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f18975jb));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f18940hd));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f18959id));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19104qb));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f18977jd));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19123rb));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f18997kd));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19052nd));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19142sb));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19070od));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19088pd));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19013lb));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19125rd));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19160tb));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19144sd));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19179ub));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19162td));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19196vb));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19181ud));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19215wb));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19216wd));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19249yb));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19233xd));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19198vd));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19268zb));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19232xb));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19251yd));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19270zd));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f18960ie));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19180uc));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f18978je));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19197vc));
        Drawable[] drawableArr3 = org.telegram.ui.ActionBar.j6.T4;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 32, new Class[]{org.telegram.ui.Cells.t1.class}, null, new Drawable[]{drawableArr3[0]}, null, org.telegram.ui.ActionBar.j6.f19126re));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, new Drawable[]{drawableArr3[0]}, null, org.telegram.ui.ActionBar.j6.f19145se));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19089pe));
        Drawable[] drawableArr4 = org.telegram.ui.ActionBar.j6.S4;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.v, 0, new Class[]{org.telegram.ui.Cells.t1.class}, null, new Drawable[]{drawableArr4[0]}, null, org.telegram.ui.ActionBar.j6.f19107qe));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f38667s, 2048, null, null, null, null, i15));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f38665r, 536870912, null, null, null, null, i16));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.L, 536870912, null, null, null, null, i16));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f38672w, 32, null, null, null, null, org.telegram.ui.ActionBar.j6.Fi));
        int i21 = org.telegram.ui.ActionBar.j6.Gi;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f38672w, 0, new Class[]{UndoView.class}, new String[]{"undoImageView"}, null, null, null, i21));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f38672w, 0, new Class[]{UndoView.class}, new String[]{"undoTextView"}, null, null, null, i21));
        int i22 = org.telegram.ui.ActionBar.j6.Hi;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f38672w, 0, new Class[]{UndoView.class}, new String[]{"infoTextView"}, null, null, null, i22));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f38672w, 0, new Class[]{UndoView.class}, new String[]{"textPaint"}, null, null, null, i22));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f38672w, 0, new Class[]{UndoView.class}, new String[]{"progressPaint"}, null, null, null, i22));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f38672w, 8, new Class[]{UndoView.class}, new String[]{"leftImageView"}, null, null, null, i22));
        return arrayList;
    }
    ...
    public final void onBecomeFullyHidden() {
        UndoView undoView = this.f38672w;
        if (undoView != null) {
            undoView.e(0, true);
        }
    }
    ...
    public final boolean onFragmentCreate() {
        ...
        tL_channels_getParticipants.channel = MessagesController.getInputChannel(this.f38652f);
    ...
    public final void onRemoveFromParent() {
        MediaController.getInstance().setTextureView(this.f38653f0, null, null, false);
