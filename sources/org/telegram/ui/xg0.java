...
public final class xg0 extends org.telegram.ui.Components.kl0 {
    ...
    public final boolean D(s4.c1 c1Var) {
        int b10 = c1Var.b();
        yg0 yg0Var = this.d;
        if (b10 != yg0Var.f39874c && b10 != yg0Var.d && b10 != yg0Var.e && b10 != yg0Var.f39875f && b10 != yg0Var.h && b10 != yg0Var.f39877r) {
            return false;
        }
        return true;
    }
    ...
    public final int j(int i10) {
        ...
        if (i10 != yg0Var.f39874c && i10 != yg0Var.d && i10 != yg0Var.e && i10 != yg0Var.f39875f && i10 != yg0Var.h) {
            if (i10 == yg0Var.f39876n) {
                return 2;
            }
            if (i10 == yg0Var.f39877r) {
                return 3;
            }
            return 4;
        }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        View view;
        Context context = this.f39618c;
        if (i10 != 0) {
            if (i10 != 1) {
                if (i10 != 2) {
                    if (i10 != 3) {
                        view = new org.telegram.ui.Cells.e9(context);
                        view.setBackgroundDrawable(org.telegram.ui.ActionBar.i6.V0(context, R.drawable.greydivider, org.telegram.ui.ActionBar.i6.f18800b7));
                    } else {
            ...
            d9Var2.setBackgroundColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18836d6, false));
            d9Var = d9Var2;
        } else {
