...
public final class xg0 extends org.telegram.ui.Components.kl0 {
    ...
    public final boolean D(s4.c1 c1Var) {
        int b10 = c1Var.b();
        yg0 yg0Var = this.d;
        if (b10 != yg0Var.f43110c && b10 != yg0Var.d && b10 != yg0Var.f43111e && b10 != yg0Var.f43112f && b10 != yg0Var.h && b10 != yg0Var.f43114r) {
            return false;
        }
        return true;
    }
    ...
    public final int j(int i10) {
        ...
        if (i10 != yg0Var.f43110c && i10 != yg0Var.d && i10 != yg0Var.f43111e && i10 != yg0Var.f43112f && i10 != yg0Var.h) {
            if (i10 == yg0Var.f43113n) {
                return 2;
            }
            if (i10 == yg0Var.f43114r) {
                return 3;
            }
            return 4;
        }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 != 0) {
            if (i10 != 1) {
                if (i10 != 2) {
                    if (i10 != 3) {
                        ...
                        view.setBackgroundDrawable(org.telegram.ui.ActionBar.j6.V0(context, R.drawable.greydivider, org.telegram.ui.ActionBar.j6.f20627b7));
                    } else {
            ...
            d9Var2.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20663d6, false));
            d9Var = d9Var2;
        } else {
