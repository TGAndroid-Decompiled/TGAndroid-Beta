...
public final class hg1 implements org.telegram.ui.Components.zk0 {
    ...
    public final void d(int i10, View view) {
        kg1 kg1Var = this.f34259a;
        ArrayList arrayList = kg1Var.d;
        if (((jg1) arrayList.get(i10)).f15531a == 1) {
            Bundle bundle = new Bundle();
            bundle.putLong("chat_id", -kg1Var.f35158c);
        ...
        if (((jg1) arrayList.get(i10)).f15531a == 2) {
            ...
            bundle2.putLong("dialog_id", kg1Var.f35158c);
            bundle2.putLong("topic_id", tL_forumTopic.f18161id);
            bundle2.putBoolean("exception", false);
            x11 x11Var = new x11(bundle2, null);
            x11Var.f39468r = new gg1(this, tL_forumTopic);
            kg1Var.presentFragment(x11Var);
        }
        if (((jg1) arrayList.get(i10)).f15531a == 4) {
            AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(kg1Var.getParentActivity());
            alertDialog$Builder.f18435a.R = LocaleController.getString(R.string.NotificationsDeleteAllExceptionTitle);
            alertDialog$Builder.f18435a.T = LocaleController.getString(R.string.NotificationsDeleteAllExceptionAlert);
