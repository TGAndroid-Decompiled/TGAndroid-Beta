...
public final class hg1 implements org.telegram.ui.Components.zk0 {
    ...
    public final void a(int i10, View view) {
        kg1 kg1Var = this.f37025a;
        ArrayList arrayList = kg1Var.d;
        if (((jg1) arrayList.get(i10)).f44099a == 1) {
            Bundle bundle = new Bundle();
            bundle.putLong("chat_id", -kg1Var.f38093c);
            bundle.putBoolean("for_select", true);
            eg1 eg1Var = new eg1(bundle);
            eg1Var.A0 = kg1Var.f38094e;
        ...
        if (((jg1) arrayList.get(i10)).f44099a == 2) {
            ...
            bundle2.putLong("dialog_id", kg1Var.f38093c);
            bundle2.putLong("topic_id", tL_forumTopic.f19948id);
            bundle2.putBoolean("exception", false);
            y11 y11Var = new y11(bundle2, null);
            y11Var.f42985r = new gg1(this, tL_forumTopic);
            kg1Var.presentFragment(y11Var);
        }
        if (((jg1) arrayList.get(i10)).f44099a == 4) {
            AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(kg1Var.getParentActivity());
            alertDialog$Builder.f20226a.R = LocaleController.getString(R.string.NotificationsDeleteAllExceptionTitle);
            alertDialog$Builder.f20226a.T = LocaleController.getString(R.string.NotificationsDeleteAllExceptionAlert);
