...
public final class k80 extends ActionBarPopupWindow$ActionBarPopupWindowLayout {
    ...
    public final ArrayList f34958a0;
    public final org.telegram.ui.Components.m00 f34959b0;
    public int f34960c0;
    public final CacheByChatsController f34961d0;
    public i80 f34962e0;
    public ArrayList f34963f0;
    public final org.telegram.ui.ActionBar.m2 f34964g0;
    public final FrameLayout f34965h0;

    public k80(Context context, org.telegram.ui.ActionBar.m2 m2Var) {
        super(context, null);
        ArrayList arrayList = new ArrayList();
        this.f34958a0 = arrayList;
        this.f34964g0 = m2Var;
        this.f34961d0 = m2Var.getMessagesController().getCacheByChatsController();
        setFitItems(true);
        ...
        this.f34965h0 = frameLayout;
        frameLayout.setBackgroundColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.H8, false));
        View view = new View(context);
        view.setBackground(org.telegram.ui.ActionBar.h6.U0(context, R.drawable.greydivider, org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19009b7, null)));
        ...
        this.f34959b0 = m00Var;
        a(m00Var, w7.y5.n(-1, 48));
        m00Var.setOnClickListener(new ov(12, this, m2Var));
        for (int i11 = 0; i11 < this.f34958a0.size(); i11++) {
            ((j80) this.f34958a0.get(i11)).f34671a.setOnClickListener(new ci.n4(this, ((j80) this.f34958a0.get(i11)).f34672b, 18));
        }
    ...
    public final void f() {
        if (this.f34963f0 != null) {
            ((org.telegram.ui.Components.k9) this.f34959b0.d).setTranslationX((3 - Math.min(3, this.f34963f0.size())) * AndroidUtilities.dp(12.0f));
        }
    }
    ...
    public final void g(boolean z10) {
        ...
        this.f34959b0.setVisibility(8);
    }

    public void setCallback(i80 i80Var) {
        this.f34962e0 = i80Var;
    }
}
