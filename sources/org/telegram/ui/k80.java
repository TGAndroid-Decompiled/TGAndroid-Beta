...
public final class k80 extends org.telegram.ui.Components.rl0 {
    ...
    public final int h() {
        ...
        int size = languageSelectActivity.f31609f.size() + i11 + 1;
    ...
    public final int j(int r7) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.k80.j(int):int");
    }

    @Override
    public final void v(f2.l1 r22, int r23) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.k80.v(f2.l1, int):void");
    }
    ...
    public final f2.l1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 != 0) {
            ...
            frameLayout.e = 50;
            frameLayout.f20932r = 21;
            TextView textView = new TextView(context);
            frameLayout.f20927a = textView;
            ...
            frameLayout.f20929c = radioButton;
            ...
            frameLayout.f20931n = LocaleController.isRTL;
            frameLayout.setClipChildren(false);
            z6Var = frameLayout;
        }
        return new f2.l1(z6Var);
    }
