...
public final class kw implements Runnable {
    ...
    public final void run() {
        ...
        Object obj2 = this.f35272b;
        switch (i11) {
            case 0:
                ((ty) obj).f37752a.postOnAnimation(new pv((uy) obj2, 14));
                return;
            case 1:
                uy uyVar = (uy) obj2;
            ...
            case 2:
                ...
                uy uyVar2 = ((tw) obj2).f37741b;
                uyVar2.y3 = 2;
                uyVar2.A4(true, true);
                uyVar2.o3();
                while (i12 < arrayList2.size()) {
                    long j3 = ((TLRPC.Dialog) arrayList2.get(i12)).f18113id;
            ...
            case 5:
                ...
                ((tx) obj2).f37751b.removeSelfFromStack();
                if (n2VarArr[1] != null) {
            ...
            case 6:
                gz gzVar = (gz) obj2;
                bo boVar = gzVar.f33976a;
                org.telegram.ui.Components.vx0 vx0Var = new org.telegram.ui.Components.vx0(boVar.getParentActivity(), gzVar.f33976a, ((MessageObject) obj).getInputStickerSet(), null, boVar.Y, boVar.getResourceProvider());
            ...
            case 7:
                ...
                b00 b00Var = a00Var.E;
                c00 c00Var = b00Var.f31999c;
                Utilities.Callback callback = c00Var.f32607x;
                if (callback != null) {
                    callback.run(c00Var.d);
                }
                b00Var.f31999c.finishFragment();
                return;
            case 8:
                f10 f10Var = (f10) obj2;
                c00 c00Var2 = new c00(f10Var.f33452r, ((w00) obj).f38671m);
                c00Var2.f32608y = new f00(f10Var, 1);
                c00Var2.f32607x = new f00(f10Var, 2);
            ...
            case 9:
                ...
                f10Var2.h = false;
                f10Var2.f33453s = false;
                f10Var2.f33452r.flags = f10Var2.f33456y;
                f10Var2.i0(true);
            ...
            case 11:
                ...
                MessagesController.DialogFilter dialogFilter = f10Var4.f33452r;
                if (b2Var != null) {
                    try {
                        b2Var.dismiss();
                    } catch (Exception e) {
            ...
            case 13:
                ...
                if (((TLRPC.TL_messages_toggleDialogFilterTags) obj).enabled && !filtersSetupActivity.f30804x) {
                    filtersSetupActivity.getMessagesController().loadRemoteFilters(true);
                    filtersSetupActivity.f30804x = true;
                    return;
                }
                return;
            case 14:
            ...
            case 15:
                ...
                for (int i14 = 0; i14 < arrayList5.size(); i14++) {
                    if (((org.telegram.ui.Components.voip.u) arrayList5.get(i14)).f29265w != null) {
                        arrayList4.remove(((org.telegram.ui.Components.voip.u) arrayList5.get(i14)).f29265w);
                    }
                }
            ...
            case 18:
                ((i60) ((w5) obj2).f38698b).U0.setNewColors((int[]) obj);
                return;
            case 19:
            ...
            case 20:
                ...
                q70 q70Var = p70Var.f36457a;
                q70Var.e = str;
                TLRPC.TL_messages_getStickerSet tL_messages_getStickerSet = new TLRPC.TL_messages_getStickerSet();
                TLRPC.TL_inputStickerSetShortName tL_inputStickerSetShortName = new TLRPC.TL_inputStickerSetShortName();
                tL_messages_getStickerSet.stickerset = tL_inputStickerSetShortName;
                tL_inputStickerSetShortName.short_name = str;
                q70Var.f36781c = q70Var.h.getConnectionsManager().sendRequest(tL_messages_getStickerSet, new qo(24, p70Var, str), 66);
                return;
            case 21:
                TLObject tLObject2 = (TLObject) obj;
                q70 q70Var2 = ((p70) obj2).f36457a;
                if (tLObject2 != null) {
            ...
            case 22:
                ...
                if (t70Var.N) {
                    ...
                    tL_messages_searchEmojiStickerSets.f18219q = str2;
                    ...
                    tL_messages_searchStickerSets2.f18221q = str2;
                    tL_messages_searchStickerSets = tL_messages_searchStickerSets2;
                }
                s70Var.f37289n = t70Var.getConnectionsManager().sendRequest(tL_messages_searchStickerSets, new aa(s70Var, str2, str2, 14), 66);
                return;
            case 23:
            ...
            case 24:
                ...
                languageSelectActivity.f30807c.l();
                return;
            case 25:
                ...
                int size2 = languageSelectActivity2.f30808f.size();
                while (i12 < size2) {
                    LocaleController.LocaleInfo localeInfo2 = (LocaleController.LocaleInfo) languageSelectActivity2.f30808f.get(i12);
            ...
            case 26:
                ...
                if (tLObject3 instanceof TL_account.resolvedBusinessChatLinks) {
                    ...
                    boVar2.f32341ia = resolvedbusinesschatlinks;
            ...
            default:
                ...
                if (!launchActivity3.f30841q0.getFragmentStack().isEmpty()) {
                    launchActivity3.f30841q0.getFragmentStack().get(0).presentFragment(new PremiumPreviewFragment(0, Uri.parse(str4).getQueryParameter("ref")));
                    return;
                }
                return;
        }
