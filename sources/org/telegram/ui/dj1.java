...
public final class dj1 extends org.telegram.ui.ActionBar.j {
    public final WallpapersListActivity f35810a;

    public dj1(WallpapersListActivity wallpapersListActivity) {
        this.f35810a = wallpapersListActivity;
    }
    ...
    public final void b(int i10) {
        ...
        WallpapersListActivity wallpapersListActivity = this.f35810a;
        ...
        if (i10 == -1) {
            ...
            if (wallpapersListActivity.getParentActivity() != null) {
                ...
                alertDialog$Builder.f20199a.R = LocaleController.formatPluralString("DeleteBackground", longSparseArray.size(), new Object[0]);
                alertDialog$Builder.f20199a.T = LocaleController.formatString("DeleteChatBackgroundsAlert", R.string.DeleteChatBackgroundsAlert, new Object[0]);
