...
public class dg1 extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate, org.telegram.ui.Components.bh, eh0 {
    public static final HashSet f32969n1 = new HashSet();
    public HashSet A0;
    public boolean B0;
    public boolean C0;
    public ai.d7 D0;
    ...
    public final HashSet f32971a0;
    public org.telegram.ui.Components.w81 f32972a1;
    public final ArrayList f32973b;
    public boolean f32974b0;
    public View f32975b1;
    public int f32976c;
    public NumberTextView f32977c0;
    public int f32978c1;
    public kf1 d;
    public org.telegram.ui.ActionBar.v0 f32979d0;
    public int f32980d1;
    public j0 e;
    public org.telegram.ui.ActionBar.v0 f32981e0;
    public int f32982e1;
    public org.telegram.ui.Components.eo f32983f;
    public org.telegram.ui.ActionBar.v0 f32984f0;
    public final ah.i f32985f1;
    public org.telegram.ui.ActionBar.v0 f32986g0;
    public final fh.d f32987g1;
    public org.telegram.ui.Components.y10 h;
    public org.telegram.ui.ActionBar.v0 f32988h0;
    public final fh.d f32989h1;
    public org.telegram.ui.ActionBar.v0 f32990i0;
    public final ah.c f32991i1;
    public org.telegram.ui.ActionBar.f1 f32992j0;
    public ah.o f32993j1;
    public org.telegram.ui.ActionBar.f1 f32994k0;
    public final ArrayList f32995k1;
    public org.telegram.ui.ActionBar.f1 f32996l0;
    public final RectF l1;
    public org.telegram.ui.ActionBar.v0 m0;
    public final RectF f32997m1;
    public tf1 f32998n;
    public RadialProgressView f32999n0;
    public r41 f33000o0;
    public org.telegram.ui.ActionBar.v0 f33001p0;
    public org.telegram.ui.ActionBar.v0 f33002q0;
    public final sf1 f33003r;
    public zf1 f33004r0;
    public final TopicsController f33005s;
    public boolean f33006s0;
    public final boolean f33007t0;
    public final boolean f33008u0;
    public eg1 v;
    public final boolean f33009v0;
    public ax f33010w;
    public final boolean f33011w0;
    public int f33012x;
    public final boolean f33013x0;
    public int f33014y;
    public String f33015y0;
    public boolean f33016z0;

    public dg1(Bundle bundle) {
        super(bundle);
        this.f32973b = new ArrayList();
        new ArrayList();
        this.f33003r = new sf1(this);
        this.f33012x = 0;
        this.E = true;
        this.G = true;
        this.V = true;
        this.W = 0.0f;
        this.f32971a0 = new HashSet();
        this.B0 = false;
        this.O0 = new AnimationNotificationsLocker(new int[]{NotificationCenter.topicsDidLoaded});
        this.S0 = 1.0f;
        new ArrayList();
        ArrayList arrayList = new ArrayList();
        this.f32995k1 = arrayList;
        RectF rectF = new RectF();
        this.l1 = rectF;
        RectF rectF2 = new RectF();
        this.f32997m1 = rectF2;
        arrayList.add(rectF);
        arrayList.add(rectF2);
        long j3 = this.arguments.getLong("chat_id", 0L);
        this.f32970a = j3;
        this.f33007t0 = this.arguments.getBoolean("for_select", false);
        this.f33008u0 = this.arguments.getBoolean("forward_to", false);
        this.f33013x0 = this.arguments.getBoolean("bot_share_to", false);
        this.f33009v0 = this.arguments.getBoolean("quote", false);
        this.f33011w0 = this.arguments.getBoolean("reply_to", false);
        this.f33015y0 = this.arguments.getString("voicechat", null);
        this.f33016z0 = this.arguments.getBoolean("videochat", false);
        this.f33005s = getMessagesController().getTopicsController();
        ...
        if (Build.VERSION.SDK_INT >= 31) {
            this.f32985f1 = new ah.i(false);
            this.f32987g1 = new fh.d(null);
    ...
    public static void I0(org.telegram.ui.zn r6) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.dg1.I0(org.telegram.ui.zn):void");
    }
    ...
    public static boolean U(dg1 dg1Var, TLRPC.TL_error tL_error) {
        ...
        edit.putLong("dialog_join_requested_time_" + (-dg1Var.f32970a), System.currentTimeMillis()).commit();
    ...
    public static void V(dg1 dg1Var, View view) {
        ...
        if (dg1Var.getParentLayout() != null && !((ActionBarLayout) dg1Var.getParentLayout()).y() && (view instanceof ag1)) {
            ...
            if (tL_forumTopic == null) {
                ...
                j3 = tL_forumTopic.f18348id;
            }
            long j12 = j3;
            if (dg1Var.f33007t0) {
                eg1 eg1Var = dg1Var.v;
                if (eg1Var != null) {
                    gg1 gg1Var = eg1Var.f33277a;
                    Bundle bundle = new Bundle();
                    jg1 jg1Var = gg1Var.f33843a;
                    bundle.putLong("dialog_id", jg1Var.f34876c);
                    bundle.putLong("topic_id", tL_forumTopic.f18348id);
                    bundle.putBoolean("exception", true);
                    w11 w11Var = new w11(bundle, null);
                    w11Var.f38671r = new rv0(17, gg1Var, tL_forumTopic);
            ...
            } else if (dg1Var.f32971a0.size() > 0) {
                dg1Var.N0(view);
            } else {
                if (dg1Var.inPreviewMode && AndroidUtilities.isTablet()) {
                    for (org.telegram.ui.ActionBar.n2 n2Var : dg1Var.getParentLayout().getFragmentStack()) {
                        if (n2Var instanceof uy) {
                            uy uyVar2 = (uy) n2Var;
                            if (uyVar2.h4()) {
                                MessagesStorage.TopicKey topicKey = uyVar2.f38204p2;
    ...
    public static boolean W(dg1 dg1Var, View view, float f7) {
        if (dg1Var.f33007t0 || dg1Var.getParentLayout() == null || ((ActionBarLayout) dg1Var.getParentLayout()).y()) {
            return false;
        }
    ...
    public static void X(dg1 dg1Var) {
        ...
        if (s50Var != null && Build.VERSION.SDK_INT >= 23) {
            s50Var.setForeground(new ColorDrawable(i0.a.k(dg1Var.getThemedColor(org.telegram.ui.ActionBar.j6.f19062d6), 100)));
        }
        dg1Var.P0();
    }
    ...
    public static void b0(dg1 dg1Var, boolean z10) {
        ...
        if (dg1Var.f32972a1 == null) {
            org.telegram.ui.Components.w81 n10 = dg1Var.f33004r0.n(8, false);
            dg1Var.f32972a1 = n10;
            if (dg1Var.M0 != null) {
                n10.setBackgroundColor(dg1Var.getThemedColor(org.telegram.ui.ActionBar.j6.f19062d6));
            }
            dg1Var.e.addView(dg1Var.f32972a1, w7.y5.c(44.0f, -1));
        }
        float f10 = dg1Var.W;
        if (z10) {
            f7 = 1.0f;
        ...
        AndroidUtilities.updateViewVisibilityAnimated(dg1Var.f33004r0, false, 1.0f, true);
        uy uyVar = dg1Var.M0;
        if (uyVar != null && (oxVar = uyVar.F3) != null) {
            oxVar.M = !z10;
        }
        if (!z10 && dg1Var.f33004r0.getVisibility() == 0 && dg1Var.f33004r0.getAlpha() == 1.0f) {
            z11 = true;
        } else {
            z11 = false;
        }
        ...
        dg1Var.f33004r0.setVisibility(0);
        if (!z10) {
            dg1Var.f33002q0.setVisibility(0);
        } else {
        ...
        dg1Var.Y0.setInterpolator(org.telegram.ui.Components.qr.f27715f);
        dg1Var.Y0.start();
        NotificationCenter.getGlobalInstance().lambda$postNotificationNameOnUIThread$1(NotificationCenter.needCheckSystemBarColors, Boolean.TRUE);
    }

    public final void A0() {
        this.J0 = this.f33005s.isLoading(this.f32970a);
        if (this.D0 != null) {
            ArrayList arrayList = this.f32973b;
            if (arrayList.size() == 0 || (arrayList.size() == 1 && ((uf1) arrayList.get(0)).f37987c != null && ((uf1) arrayList.get(0)).f37987c.f18348id == 1)) {
    ...
    public final void B0() {
        ...
        if (uyVar != null) {
            ...
            if (ksVar2 != null) {
                ...
                if (ksVar3 != null) {
                    f10 = ksVar3.getMetadata().f14146c.f14154a;
                } else {
                    f10 = 0.0f;
                }
                ...
                if (ksVar5 != null) {
                    f11 = ksVar5.getMetadata().f14146c.f14154a;
                }
        ...
        int i11 = this.f32982e1 + this.f32978c1;
        if (this.V) {
    ...
    public final void D0(HashSet hashSet, Runnable runnable) {
        ...
        if (hashSet.size() == 1) {
            b2Var.T = LocaleController.formatString(R.string.DeleteSelectedTopic, this.f33005s.findTopic(this.f32970a, ((Integer) arrayList.get(0)).intValue()).title);
        } else {
    ...
    public final void H0(boolean z10) {
        ...
        Bundle bundle = new Bundle();
        bundle.putLong("chat_id", this.f32970a);
        ProfileActivity profileActivity = new ProfileActivity(bundle, this.f32983f.getSharedMediaPreloader());
        profileActivity.K4(this.J);
        if (this.fragmentView.getMeasuredHeight() > this.fragmentView.getMeasuredWidth() && this.f32983f.getAvatarImageView().getImageReceiver().hasImageLoaded() && z10) {
            i10 = 2;
        } else {
            i10 = 1;
        }
    ...
    public final void M0(org.telegram.ui.Cells.s2 s2Var) {
        ...
        int b10 = r32[0].b(poVar.f27280f);
        poVar.f27288o = 1;
        long j10 = this.f32970a;
        long j11 = -j10;
        poVar.d(j11, tL_forumTopic.f18348id, null);
        if (ChatObject.canManageTopics(g())) {
            ...
            f1Var.setOnClickListener(new View.OnClickListener(this) {
                ...
                public final void onClick(View view) {
                    switch (r3) {
                        case 0:
                            dg1 dg1Var = this.f32959b;
                            dg1Var.C0 = true;
                            dg1Var.N0 = true;
                            TopicsController topicsController = dg1Var.f33005s;
                            long j12 = dg1Var.f32970a;
                            TLRPC.TL_forumTopic tL_forumTopic2 = tL_forumTopic;
                            topicsController.pinTopic(j12, tL_forumTopic2.f18348id, !tL_forumTopic2.pinned, dg1Var);
                            dg1Var.finishPreviewFragment();
                            return;
                        case 1:
                            dg1 dg1Var2 = this.f32959b;
                            dg1Var2.N0 = true;
                            TopicsController topicsController2 = dg1Var2.f33005s;
                            long j13 = dg1Var2.f32970a;
                            TLRPC.TL_forumTopic tL_forumTopic3 = tL_forumTopic;
                            topicsController2.toggleCloseTopic(j13, tL_forumTopic3.f18348id, true ^ tL_forumTopic3.closed);
                            dg1Var2.finishPreviewFragment();
                            return;
                        default:
                            HashSet hashSet = new HashSet();
                            hashSet.add(Integer.valueOf(tL_forumTopic.f18348id));
                            dg1 dg1Var3 = this.f32959b;
        ...
        if (getMessagesController().isDialogMuted(j11, tL_forumTopic.f18348id)) {
        ...
        if (ChatObject.canDeleteTopic(this.currentAccount, g(), tL_forumTopic)) {
            ...
            f1Var4.setIconColor(getThemedColor(org.telegram.ui.ActionBar.j6.f19283p7));
            f1Var4.setTextColor(getThemedColor(org.telegram.ui.ActionBar.j6.f19301q7));
        ...
        zn znVar = new zn(t8.b.f(j10, "chat_id"));
        if (isMonoForum) {
        ...
        if ((view instanceof ag1) && (tL_forumTopic = (ag1Var = (ag1) view).N) != null) {
            ...
            if (!hashSet.isEmpty()) {
                if (!this.actionBar.a(null)) {
                    ...
                    this.f32977c0 = numberTextView;
                    numberTextView.setTextSize(18);
                    this.f32977c0.setTypeface(AndroidUtilities.bold());
                    this.f32977c0.setTextColor(getThemedColor(org.telegram.ui.ActionBar.j6.f19447y8));
                    j10.addView(this.f32977c0, w7.y5.m(1.0f, 0, -1, 72, 0, 0));
                    this.f32977c0.setOnTouchListener(new ef1(0));
                    this.f32979d0 = j10.g(4, R.drawable.msg_pin, AndroidUtilities.dp(54.0f));
                    this.f32981e0 = j10.g(5, R.drawable.msg_unpin, AndroidUtilities.dp(54.0f));
                    this.f32984f0 = j10.g(6, R.drawable.msg_mute, AndroidUtilities.dp(54.0f));
                    this.f32986g0 = j10.h(7, R.drawable.msg_delete, LocaleController.getString(R.string.Delete), AndroidUtilities.dp(54.0f));
                    ...
                    this.m0 = h11;
                    this.f32992j0 = h11.e(8, R.drawable.msg_markread, LocaleController.getString(R.string.MarkAsRead));
                    this.f32994k0 = this.m0.e(9, R.drawable.msg_topic_close, LocaleController.getString(R.string.CloseTopic));
                    this.f32996l0 = this.m0.e(10, R.drawable.msg_topic_restart, LocaleController.getString(R.string.RestartTopic));
                }
                if (this.inPreviewMode) {
                ...
                if (i20 > 0) {
                    this.f32992j0.setVisibility(0);
                    this.f32992j0.g(LocaleController.getString(R.string.MarkAsRead), R.drawable.msg_markread, null);
                } else {
                    this.f32992j0.setVisibility(8);
                }
                if (i21 != 0) {
                    this.B0 = false;
                    this.f32984f0.setIcon(R.drawable.msg_unmute);
                    this.f32984f0.setContentDescription(LocaleController.getString(R.string.ChatsUnmute));
                    z10 = true;
                } else {
                    z10 = true;
                    this.B0 = true;
                    this.f32984f0.setIcon(R.drawable.msg_mute);
                    this.f32984f0.setContentDescription(LocaleController.getString(R.string.ChatsMute));
                }
                org.telegram.ui.ActionBar.v0 v0Var = this.f32979d0;
                if (i22 == z10 && i23 == 0) {
                    i10 = 0;
                } else {
                    i10 = 8;
                ...
                org.telegram.ui.ActionBar.v0 v0Var2 = this.f32981e0;
                if (i23 == z10 && i22 == 0) {
                    i11 = 0;
                } else {
                    i11 = 8;
                ...
                this.f32977c0.a(hashSet3.size(), z10);
                ...
                org.telegram.ui.ActionBar.f1 f1Var = this.f32994k0;
                if (i24 == 0 && i25 > 0) {
                    i12 = 0;
                } else {
                    i12 = 8;
                ...
                org.telegram.ui.ActionBar.f1 f1Var2 = this.f32994k0;
                if (i25 > 1) {
                ...
                org.telegram.ui.ActionBar.f1 f1Var3 = this.f32996l0;
                if (i25 == 0 && i24 > 0) {
                    i14 = 0;
                } else {
                    i14 = 8;
                ...
                org.telegram.ui.ActionBar.f1 f1Var4 = this.f32996l0;
                if (i24 > 1) {
                ...
                org.telegram.ui.ActionBar.v0 v0Var3 = this.f32986g0;
                ...
                org.telegram.ui.ActionBar.v0 v0Var4 = this.f32988h0;
                ...
                org.telegram.ui.ActionBar.v0 v0Var5 = this.f32990i0;
    ...
    public final void P0() {
        ...
        this.f33004r0.setBackgroundColor(getThemedColor(i10));
    }
    ...
    public final void Q0(boolean z10) {
        ...
        TLRPC.Chat chat = messagesController.getChat(Long.valueOf(j3));
        int i10 = 0;
        if (!ChatObject.isNotInChat(getMessagesController().getChat(Long.valueOf(j3))) && ChatObject.canCreateTopic(chat) && !this.f33006s0 && !this.f33007t0 && !this.J0) {
            z11 = true;
        } else {
            z11 = false;
        }
    ...
    public final void R0() {
        boolean z10;
        if (ChatObject.canManageTopics(g()) && !this.f32971a0.isEmpty()) {
            z10 = true;
        } else {
            z10 = false;
        }
        if (this.f32974b0 != z10) {
            this.f32974b0 = z10;
            sf1 sf1Var = this.f33003r;
            sf1Var.q(0, sf1Var.h());
        }
    }
    ...
    public final void S0(float f7) {
        this.W = f7;
        int themedColor = getThemedColor(org.telegram.ui.ActionBar.j6.f19395v8);
        ...
        this.actionBar.A(i0.a.d(this.W, getThemedColor(org.telegram.ui.ActionBar.j6.f19359t8), getThemedColor(org.telegram.ui.ActionBar.j6.f19466z8)), false);
        if (!this.inPreviewMode) {
            this.actionBar.setBackgroundColor(i0.a.d(this.W, getThemedColor(org.telegram.ui.ActionBar.j6.f19340s8), getThemedColor(org.telegram.ui.ActionBar.j6.f19062d6)));
        }
        float f10 = 1.0f - f7;
        this.f32983f.getTitleTextView().setAlpha(f10);
        this.f32983f.getSubtitleTextView().setAlpha(f10);
        org.telegram.ui.Components.w81 w81Var = this.f32972a1;
        if (w81Var != null) {
            w81Var.setTranslationY((-AndroidUtilities.dp(16.0f)) * f10);
            this.f32972a1.setAlpha(f7);
        }
        this.f33004r0.setTranslationY((-AndroidUtilities.dp(16.0f)) * f10);
        this.f33004r0.setAlpha(f7);
        if (isInPreviewMode()) {
            this.e.invalidate();
        }
        this.d.invalidate();
    ...
    public final void T0() {
        ...
        if (d7Var != null && d7Var.e != null) {
            ...
            TLRPC.TL_forumTopic findTopic = getMessagesController().getTopicsController().findTopic(this.f32970a, 1L);
            if (findTopic != null) {
    ...
    public final void U0(boolean z10, boolean z11) {
        ...
        this.N0 = false;
        TopicsController topicsController = this.f33005s;
        long j3 = this.f32970a;
        ...
        if (topics != null) {
            ...
            arrayList.clear();
            qf1 qf1Var2 = null;
            if (UserObject.isBotForum(this.currentAccount, -j3) && this.f33008u0) {
                arrayList.add(new uf1(3, null));
            }
            for (int i10 = 0; i10 < topics.size(); i10++) {
                HashSet hashSet = this.A0;
                if (hashSet == null || !hashSet.contains(Integer.valueOf(topics.get(i10).f18348id))) {
            ...
            for (int i11 = 0; i11 < arrayList.size(); i11++) {
                ...
                if (uf1Var != null && (tL_forumTopic = uf1Var.f37987c) != null && tL_forumTopic.hidden) {
                    this.f33012x++;
                }
            }
            of1 of1Var = this.N;
    ...
    public final View createView(Context context) {
        ...
        kf1Var.setBackgroundColor(getThemedColor(org.telegram.ui.ActionBar.j6.f19062d6));
        ...
        this.actionBar.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view) {
                ...
                switch (r2) {
                    case 0:
                        dg1 dg1Var = this.f32025b;
                        dg1Var.presentFragment(ze1.a0(dg1Var.f32970a, 0L));
                        return;
                    case 1:
                        dg1 dg1Var2 = this.f32025b;
                        dg1Var2.getMessagesController().hidePeerSettingsBar(-dg1Var2.f32970a, null, dg1Var2.g());
                        dg1Var2.O0(false);
                        return;
                    case 2:
                        dg1 dg1Var3 = this.f32025b;
                        if (!dg1Var3.f33006s0) {
                            dg1Var3.H0(false);
                            return;
                        }
                        return;
                    case 3:
                        this.f32025b.finishPreviewFragment();
                        return;
                    default:
                        uy uyVar3 = this.f32025b.M0;
                        if (uyVar3 != null && (v0Var = uyVar3.f38175j0) != null) {
                            v0Var.performClick();
                            return;
                        }
                        return;
        ...
        if (this.M0 != null) {
            ...
            this.f33001p0.setSearchPaddingStart(56);
            this.f33001p0.setSearchFieldHint(LocaleController.getString(R.string.Search));
            EditTextBoldCursor searchField = this.f33001p0.getSearchField();
        ...
        this.f33002q0.e(1, R.drawable.msg_discussion, LocaleController.getString(R.string.TopicViewAsMessages));
        this.R = this.f33002q0.e(2, R.drawable.msg_addcontact, LocaleController.getString(R.string.AddMember));
        org.telegram.ui.ActionBar.v0 v0Var = this.f33002q0;
        ...
        this.Q = this.f33002q0.e(3, R.drawable.msg_topic_create, LocaleController.getString(R.string.CreateTopic));
        this.U = this.f33002q0.e(15, R.drawable.msg_report, LocaleController.getString(R.string.ReportChat));
        this.S = this.f33002q0.f(11, R.drawable.msg_leave, LocaleController.getString(R.string.LeaveMegaMenu), null);
        ...
        org.telegram.ui.Components.eo eoVar2 = this.f32983f;
        if (!AndroidUtilities.isTablet() && !this.inPreviewMode) {
            z11 = true;
        } else {
            z11 = false;
        ...
        org.telegram.ui.Components.eo eoVar3 = this.f32983f;
        long j3 = -this.f32970a;
        if (j3 < 0) {
            z12 = true;
        } else {
        ...
        this.actionBar.addView(this.f32983f, 0, w7.y5.d(-2, -1.0f, 51, 56.0f, 0.0f, 86.0f, 0.0f));
        if (!this.f33007t0) {
            this.f32983f.getAvatarImageView().setOnClickListener(new z7(this, 3));
        }
        this.N = new of1(this, context);
        hh.k kVar2 = new hh.k(this.d);
        ViewGroup viewGroup = this.d;
        ah.c cVar = this.f32991i1;
        cVar.f425f = kVar2;
        ...
        this.f32993j1 = new ah.o(of1Var, viewGroup, new w8(of1Var2, 2));
        ...
        new SparseArray();
        new HashMap();
        this.N.setAdapter(this.f33003r);
            ...
            public final void onClick(View view) {
                ...
                switch (r2) {
                    ...
                    case 3:
                        ...
                        return;
                    default:
                        uy uyVar32 = this.f32025b.M0;
                        if (uyVar32 != null && (v0Var2 = uyVar32.f38175j0) != null) {
                            v0Var2.performClick();
                            return;
                        }
                        return;
        ...
        this.h.f30441c.setImageResource(R.drawable.ic_chatlist_add_2);
        this.h.f30441c.setScaleType(ImageView.ScaleType.CENTER_INSIDE);
        this.h.f30441c.setPadding(AndroidUtilities.dp(12.0f), AndroidUtilities.dp(12.0f), AndroidUtilities.dp(12.0f), AndroidUtilities.dp(12.0f));
        ...
        textView.setTextColor(getThemedColor(org.telegram.ui.ActionBar.j6.f19445y6));
        ...
        this.f32998n = frameLayout;
        textView.setAlpha(0.0f);
        ai.d7 d7Var = new ai.d7(this, context, t00Var);
        this.D0 = d7Var;
        try {
            d7Var.f25865b.getImageReceiver().setAutoRepeat(2);
        } catch (Exception unused) {
        }
        this.D0.e(this.J0, this.fragmentBeginToShow);
        this.D0.d.setText(LocaleController.getString(R.string.NoTopics));
        T0();
        this.f32998n.addView(t00Var);
        this.f32998n.addView(this.D0);
        this.d.addView(this.f32998n);
        this.N.setEmptyView(this.f32998n);
        this.f33000o0 = new r41(context, 7);
        org.telegram.ui.Components.v61 v61Var = new org.telegram.ui.Components.v61(context);
        this.L = v61Var;
        this.f33000o0.addView(v61Var);
        this.d.addView(this.f33000o0, w7.y5.e(-1, 51, 80));
        this.L.setOnClickListener(new if1(this));
        RadialProgressView radialProgressView = new RadialProgressView(context, null);
        this.f32999n0 = radialProgressView;
        radialProgressView.setSize(AndroidUtilities.dp(22.0f));
        this.f32999n0.setVisibility(4);
        this.f33000o0.addView(this.f32999n0, w7.y5.e(30, 30, 17));
        ImageView imageView = new ImageView(context);
        this.W0 = imageView;
        imageView.setImageResource(R.drawable.miniplayer_close);
        this.W0.setContentDescription(LocaleController.getString(R.string.Close));
        ImageView imageView2 = this.W0;
        int i13 = org.telegram.ui.ActionBar.j6.f19070de;
        ...
        this.f33000o0.addView(this.W0, w7.y5.d(36, 36.0f, 53, 0.0f, 6.0f, 2.0f, 0.0f));
        ...
        this.f33004r0 = zf1Var;
        zf1Var.setVisibility(8);
        this.e.addView(this.f33004r0, w7.y5.d(-1, -1.0f, 119, 0.0f, 44.0f, 0.0f, 0.0f));
        zf1 zf1Var2 = this.f33004r0;
        ...
        getMessagesStorage().loadChatInfo(this.f32970a, true, null, true, false, 0);
        ...
        if (g10 != null) {
            ...
            this.U0.g(this.R0.c());
            wh.d dVar2 = this.R0;
            dVar2.f45334m = new cf1(this);
            TLRPC.ChatFull chatFull = this.J;
            dVar2.f45331j = chatFull;
            if (chatFull != null) {
        ...
        if (this.inPreviewMode && AndroidUtilities.isTablet()) {
            ...
            while (true) {
                ...
                if (n2Var instanceof uy) {
                    uy uyVar4 = (uy) n2Var;
                    if (uyVar4.h4()) {
                        MessagesStorage.TopicKey topicKey = uyVar4.f38204p2;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == i12) {
            ...
            if (chatFull2.f18297id == j3) {
                O0(false);
                wh.d dVar = this.R0;
                if (dVar != null) {
                    dVar.f45331j = chatFull2;
    ...
    public final TLRPC.Chat g() {
        return getMessagesController().getChat(Long.valueOf(this.f32970a));
    }
    ...
    public final boolean isLightStatusBar() {
        ...
        if (this.actionBar.s()) {
            themedColor = getThemedColor(org.telegram.ui.ActionBar.j6.f19413w8);
        }
    ...
    public final boolean onBackPressed(boolean z10) {
        if (!this.f32971a0.isEmpty()) {
            if (z10) {
                C0();
                return false;
            }
        } else if (this.f33006s0) {
            if (z10) {
                this.actionBar.v(this.f33001p0.L(false));
            }
        } else {
    ...
    public final void onFragmentDestroy() {
        ...
        TLRPC.Chat chat = getMessagesController().getChat(Long.valueOf(this.f32970a));
        if (ChatObject.isChannel(chat)) {
    ...
    public final void onPause() {
        super.onPause();
        getMessagesController().getTopicsController().onTopicFragmentPause(this.f32970a);
    ...
    public final void setPreviewOpenedProgress(float f7) {
        org.telegram.ui.Components.eo eoVar = this.f32983f;
        if (eoVar != null) {
            eoVar.setAlpha(f7);
            this.f33002q0.setAlpha(f7);
            org.telegram.ui.ActionBar.v0 v0Var = this.f33001p0;
            if (v0Var != null) {
                v0Var.setAlpha(f7);
            }
    ...
    public final void setPreviewReplaceProgress(float f7) {
        ...
        if (eoVar != null) {
            eoVar.setAlpha(f7);
            this.f32983f.setTranslationX((1.0f - f7) * AndroidUtilities.dp(40.0f));
        }
    }

    @Override
    public final fh.d x() {
        return this.f32989h1;
    }
    ...
    public final void x0() {
        ...
        float f7;
        int i10;
        if (Build.VERSION.SDK_INT >= 31 && (iVar = this.f32985f1) != null) {
            ...
            int measuredHeight = (view.getMeasuredHeight() - this.f32982e1) - AndroidUtilities.dp(8.0f);
            this.l1.set(0.0f, -dp, view.getMeasuredWidth(), kVar.getMeasuredHeight() + dp + dp2);
            RectF rectF = this.f32997m1;
            ...
            iVar.g(i10, this.f32995k1);
            iVar.e(this.f32993j1, view.getMeasuredWidth(), view.getMeasuredHeight());
        }
    }
    ...
    public final void y0() {
        ...
        if (!topicsController.endIsReached(j3) && (ff1Var = this.F) != null) {
            int N0 = ff1Var.N0();
            if (this.f32973b.isEmpty() || N0 >= this.f33003r.h() - 5) {
    ...
    public final void z0(boolean z10) {
        ...
        ChatObject.Call call = this.H0;
        if (call != null && ((str = this.f33015y0) != null || this.f33016z0)) {
            ...
            this.f33015y0 = null;
            this.f33016z0 = false;
        } else if (this.f33015y0 != null && z10 && chatFull != null && chatFull.call == null && this.fragmentView != null && getParentActivity() != null) {
