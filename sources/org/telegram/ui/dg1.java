...
public final class dg1 implements org.telegram.ui.ActionBar.z1 {
    ...
    public final TwoStepVerificationActivity f33117b;

    public dg1(TwoStepVerificationActivity twoStepVerificationActivity, int i10) {
        this.f33116a = i10;
        this.f33117b = twoStepVerificationActivity;
    }
    ...
    public final void f(org.telegram.ui.ActionBar.a2 a2Var, int i10) {
        switch (this.f33116a) {
            case 0:
                this.f33117b.finishFragment();
                return;
            case 1:
                TL_account.declinePasswordReset declinepasswordreset = new TL_account.declinePasswordReset();
                TwoStepVerificationActivity twoStepVerificationActivity = this.f33117b;
