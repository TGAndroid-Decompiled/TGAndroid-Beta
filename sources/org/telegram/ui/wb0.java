...
public final class wb0 {
    ...
    public static boolean l(java.lang.String r7) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.wb0.l(java.lang.String):boolean");
    }
    ...
    public final org.telegram.ui.ActionBar.e5 c() {
        return this.f39389a.O();
    }

    public final UserConfig d() {
        return UserConfig.getInstance(this.f39390b);
    }
    ...
    public final boolean e(Uri uri) {
        ...
        if (uri != null) {
            ...
            LaunchActivity launchActivity = this.f39389a;
            if (equalsIgnoreCase) {
            ...
            if (!"http".equalsIgnoreCase(scheme2) && !"https".equalsIgnoreCase(scheme2)) {
                        ...
                        if (!arrayList.isEmpty()) {
                            ...
                            if ("newbot".equalsIgnoreCase(str4)) {
                                ...
                                if ("new".equalsIgnoreCase(str4)) {
                                    ...
                                    ph.da E = ph.da.E(launchActivity, this.f39390b);
                                    if (E.L1 != r15) {
                                        E.L1 = r15;
                                        ?? r22 = E.N0;
                                        if (r22 != 0) {
                ...
                if (host != null) {
                    Matcher matcher = LaunchActivity.f31612y1.matcher(host.toLowerCase());
    ...
    public final boolean f(String str) {
        ...
        k();
        ConnectionsManager.getInstance(this.f39390b).sendRequestTyped(gettone, new Object(), new d5(this, 14));
        return true;
    }
    ...
    public final boolean g(String str) {
        ...
        this.h = ConnectionsManager.getInstance(this.f39390b).sendRequest(tL_payments_getPaymentForm, new ba((Object) this, (TLObject) tL_inputInvoiceSlug, str, 18));
        return true;
    }
    ...
    public final void h(String str, String str2, String str3) {
        ...
        if (U != null && U.getContext() != null) {
            ...
            MessagesController.getInstance(this.f39390b).getUserNameResolver().resolve(str, new jh(this, userArr, new a30(this, U, userArr, tL_requestPeerTypeCreateBot, 6), 3));
        }
    }
    ...
    public final boolean i(Uri uri, String str) {
        ...
        ConnectionsManager.getInstance(this.f39390b).sendRequestTyped(tL_messages_requestUrlAuth, new Object(), new dh.v(21, this, tL_messages_requestUrlAuth));
        return true;
    }

    public final boolean j(java.util.List r28) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.wb0.j(java.util.List):boolean");
    }

    public final void k() {
        if (!this.f39392f && !this.f39393g) {
            af.f fVar = this.f39391c;
            if (fVar == null) {
                if (this.e == null) {
                    this.e = new org.telegram.ui.ActionBar.d2(this.f39389a, 3, null);
                }
                this.e.setOnCancelListener(new ig(this, 3));
                this.e.q(300L);
            } else {
                fVar.f165b = new pb0(this, 0);
                fVar.d();
            }
            this.f39392f = true;
        }
    ...
    public final void o(String str) {
        AndroidUtilities.scrollToFragmentRow(this.f39389a.O(), str);
    }
}
