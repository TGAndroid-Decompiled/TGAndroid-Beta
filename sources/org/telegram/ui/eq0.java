...
public final class eq0 implements br0 {
    public final HashMap f33460a;
    public final ArrayList f33461b;
    public final lq0 f33462c;

    public eq0(lq0 lq0Var, HashMap hashMap, ArrayList arrayList) {
        this.f33462c = lq0Var;
        this.f33460a = hashMap;
        this.f33461b = arrayList;
    }

    @Override
    public final void b(Editable editable) {
        lq0 lq0Var = this.f33462c;
    ...
    public final void i(int i10, boolean z10, boolean z11) {
        ...
        if (!z10) {
            lq0Var.V(this.f33460a, this.f33461b, z11, i10);
        }
    }
