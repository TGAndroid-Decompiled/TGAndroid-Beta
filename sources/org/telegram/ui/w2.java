...
public final class w2 extends FrameLayout implements DownloadController.FileDownloadProgressListener, org.telegram.ui.Cells.p9 {
    ...
    public boolean U;
    public final w70 f38548a;
    public final f4 f38549b;
    public a3 f38550c;
    public a3 d;
    public final ImageReceiver e;
    public final FrameLayout f38551f;
    public final k4 h;
    public final TextureView f38552n;
    public final RadialProgress2 f38553r;
    public final c1 f38554s;
    public final int v;
    ...
    public w2(Context context, w70 w70Var, f4 f4Var, int i10) {
        ...
        this.f38552n = textureView;
        textureView.setOpaque(false);
        FrameLayout frameLayout = new FrameLayout(getContext());
        this.f38551f = frameLayout;
    ...
    public final void a() {
        int i10 = ((h4) this.f38548a).X;
        int i11 = this.I;
        ImageReceiver imageReceiver = this.e;
        RadialProgress2 radialProgress2 = this.f38553r;
        if (i11 == 0) {
            this.S = false;
            radialProgress2.o(0.0f, false);
            boolean z10 = this.P;
            f4 f4Var = this.f38549b;
            if (z10) {
    ...
    public final void b(TL_iv.pageBlockVideo pageblockvideo, x2 x2Var, boolean z10, boolean z11) {
        ...
        if (pageblockvideo2 != null && (videoPlayerHolderBase = (w70Var = this.f38548a).f38587w) != null && w70Var.f38588x == this) {
    ...
    public final void c(x2 x2Var) {
        ...
        Bitmap bitmap3;
        x2 x2Var2 = this.M;
        if (x2Var2 != null && (bitmap2 = x2Var.f39349b) != null && (bitmap3 = x2Var2.f39349b) != null && bitmap2 != bitmap3) {
            bitmap3.recycle();
            this.M.f39349b = null;
        }
        x2 x2Var3 = this.M;
        if (x2Var3 != null && x2Var.f39349b == null && (bitmap = x2Var3.f39349b) != null) {
            x2Var.f39348a = x2Var3.f39348a;
            x2Var.f39349b = bitmap;
        }
        this.M = x2Var;
    }
    ...
    public final void d() {
        ...
        if (visibility == 0 && isAttachedToWindow()) {
            ...
            w70 w70Var = this.f38548a;
            if (pageblockvideo != null && (videoPlayerHolderBase = w70Var.f38587w) != null && w70Var.f38588x == this) {
                a0.i iVar = w70Var.f38589y;
    ...
    public final void e(boolean z10) {
        ...
        if (z11) {
            ...
            x2 x2Var = this.M;
            float f7 = 0.0f;
            if (x2Var != null && x2Var.f39349b != null) {
                this.I = -1;
            } else {
    ...
    public final void onDraw(Canvas canvas) {
        if (this.L != null) {
            ...
            if (!imageReceiver.hasBitmapImage() || imageReceiver.getCurrentAlpha() != 1.0f) {
                canvas.drawRect(imageReceiver.getDrawRegion(), h4.f34136o1);
            }
            ...
            if (a3Var != null) {
                canvas.save();
                canvas.translate(this.f38556x, this.f38557y);
                h4.v(w70Var, canvas, this, 0);
                this.f38550c.draw(canvas, this);
                canvas.restore();
                i10 = 1;
            }
            if (this.d != null) {
                canvas.save();
                canvas.translate(this.f38556x, this.f38557y + this.E);
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (this.f38550c != null) {
            sb2.append(", ");
            sb2.append(this.f38550c.d.getText());
        }
    ...
    public final void onProgressDownload(String str, long j3, long j10) {
        this.f38553r.o(Math.min(1.0f, ((float) j3) / ((float) j10)), true);
        if (this.I != 1) {
            e(true);
        }
    }
