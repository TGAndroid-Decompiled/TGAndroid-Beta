...
public final class w2 extends FrameLayout implements DownloadController.FileDownloadProgressListener, org.telegram.ui.Cells.p9 {
    ...
    public final void b(TL_iv.pageBlockVideo pageblockvideo, x2 x2Var, boolean z10, boolean z11) {
        ...
        if (pageblockvideo2 != null && (videoPlayerHolderBase = (u70Var = this.f38676a).f37832w) != null && u70Var.f37833x == this) {
    ...
    public final void c(x2 x2Var) {
        ...
        Bitmap bitmap3;
        x2 x2Var2 = this.M;
        if (x2Var2 != null && (bitmap2 = x2Var.f39474b) != null && (bitmap3 = x2Var2.f39474b) != null && bitmap2 != bitmap3) {
            bitmap3.recycle();
            this.M.f39474b = null;
        }
        x2 x2Var3 = this.M;
        if (x2Var3 != null && x2Var.f39474b == null && (bitmap = x2Var3.f39474b) != null) {
            x2Var.f39473a = x2Var3.f39473a;
            x2Var.f39474b = bitmap;
        }
        this.M = x2Var;
    }
    ...
    public final void d() {
        ...
        if (visibility == 0 && isAttachedToWindow()) {
            ...
            if (pageblockvideo != null && (videoPlayerHolderBase = u70Var.f37832w) != null && u70Var.f37833x == this) {
                a0.i iVar = u70Var.f37834y;
    ...
    public final void e(boolean z10) {
        ...
        if (z11) {
            ...
            x2 x2Var = this.M;
            float f7 = 0.0f;
            if (x2Var != null && x2Var.f39474b != null) {
                this.I = -1;
            } else {
    ...
    public final void onDraw(Canvas canvas) {
        if (this.L != null) {
            ...
            if (!imageReceiver.hasBitmapImage() || imageReceiver.getCurrentAlpha() != 1.0f) {
                canvas.drawRect(imageReceiver.getDrawRegion(), h4.f34058o1);
            }
