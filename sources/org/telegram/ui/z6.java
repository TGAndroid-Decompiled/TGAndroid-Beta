...
public final class z6 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    public t6 f40130a;
    public final org.telegram.ui.ActionBar.f6 f40131b;
    ...
    public boolean h;
    public org.telegram.ui.Components.np f40134n;
    ...
    public z6(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.e = u9Var;
        u9Var.getAvatarDrawable().f23839p = 0.8f;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        TextView textView;
        if (i10 == NotificationCenter.emojiLoaded && (textView = this.f40132c) != null) {
            textView.invalidate();
        }
    }
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        sb2.append((Object) this.f40132c.getText());
    ...
    public final void onMeasure(int i10, int i11) {
        setMeasuredDimension(View.MeasureSpec.getSize(i10), AndroidUtilities.dp(50.0f) + (this.f40133f ? 1 : 0));
        ...
        boolean z10 = LocaleController.isRTL;
        TextView textView = this.f40132c;
        if (z10) {
        ...
        org.telegram.ui.Components.np npVar = this.f40134n;
        if (npVar != null) {
