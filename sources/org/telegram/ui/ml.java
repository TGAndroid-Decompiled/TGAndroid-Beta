...
public final class ml implements org.telegram.ui.Components.ji {
    ...
    public final void H(int i10, boolean z4, boolean z10, int i11, int i12, long j10, boolean z11, boolean z12, long j11) {
        ...
        if (xnVar.getParentActivity() != null && (t2Var = xnVar.G1) != null) {
            ...
            xnVar.f40100m5 = messageObject;
            if (messageObject != null && (message = messageObject.messageOwner) != null) {
                message.invert_media = z11;
            }
            if (i10 != 8 && i10 != 7 && (i10 != 4 || t2Var.f26702g0.getSelectedPhotos().isEmpty())) {
            ...
            HashMap<Object, Object> selectedPhotos = xnVar.G1.f26702g0.getSelectedPhotos();
            ArrayList<Object> selectedPhotosOrder = xnVar.G1.f26702g0.getSelectedPhotosOrder();
                ...
                while (i15 < ceil) {
                    ...
                    if (messageObject2 != null && messageObject2.needResendWhenEdit()) {
                        ...
                        if (messageSuggestionParams == null) {
                            messageSuggestionParams = MessageSuggestionParams.of(xnVar.f40100m5.messageOwner.suggested_post);
                        }
                        ...
                        int i19 = ceil;
                        long j12 = xnVar.Q5;
                        MessageObject messageObject3 = xnVar.f40100m5;
                        int i20 = i15;
                        MessageObject messageObject4 = xnVar.U3;
                        nn nnVar = xnVar.f40052i5;
                        if (i10 != 4 && !z12) {
                        ...
                        long j13 = xnVar.Q5;
                        MessageObject messageObject5 = xnVar.f40076k5;
                        ...
                        SendMessagesHelper.prepareSendingMedia(accountInstance2, arrayList2, j13, messageObject5, messageObject6, null, nnVar2, z14, z4, xnVar.f40100m5, z10, i11, i12, xnVar.O3, z13, null, xnVar.C8(), j10, z11, j11, xnVar.N8(), xnVar.f39989d5);
                    }
                    i15 = i14 + 1;
                    ceil = i13;
