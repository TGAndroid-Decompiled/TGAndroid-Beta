...
public final class yz0 implements nq {
    ...
    public final void a(TLRPC.User user) {
        int i10;
        ProfileActivity profileActivity = this.f43247e;
    ...
    public final void b(int i10, TLRPC.TL_chatAdminRights tL_chatAdminRights, TLRPC.TL_chatBannedRights tL_chatBannedRights, String str) {
        ...
        int i11 = 0;
        TLRPC.ChatParticipant chatParticipant = this.f43245b;
        ProfileActivity profileActivity = this.f43247e;
        int i12 = this.f43244a;
        if (i12 == 0) {
            if (chatParticipant instanceof TLRPC.TL_chatChannelParticipant) {
                ...
                int indexOf = profileActivity.f34000u2.participants.participants.indexOf(chatParticipant);
                if (indexOf >= 0) {
                    profileActivity.f34000u2.participants.participants.set(indexOf, tL_chatParticipant);
                }
            }
            if (i10 == 1 && !this.f43246c) {
                this.d[0] = true;
            }
        } else if (i12 == 1 && i10 == 0 && profileActivity.E2.megagroup && (chatFull = profileActivity.f34000u2) != null && chatFull.participants != null) {
            int i13 = 0;
            while (true) {
                if (i13 < profileActivity.f34000u2.participants.participants.size()) {
                    if (MessageObject.getPeerId(((TLRPC.TL_chatChannelParticipant) profileActivity.f34000u2.participants.participants.get(i13)).channelParticipant.peer) == chatParticipant.user_id) {
            ...
            TLRPC.ChatFull chatFull3 = profileActivity.f34000u2;
            if (chatFull3 != null && chatFull3.participants != null) {
                while (true) {
                    if (i11 >= profileActivity.f34000u2.participants.participants.size()) {
                        break;
                    } else if (profileActivity.f34000u2.participants.participants.get(i11).user_id == chatParticipant.user_id) {
                        profileActivity.f34000u2.participants.participants.remove(i11);
                        z10 = true;
                        break;
                    } else {
                        i11++;
