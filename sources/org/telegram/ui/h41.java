...
public final class h41 implements org.telegram.ui.Components.ro0 {
    public final org.telegram.ui.Components.so0 f34121a;
    public final k41 f34122b;
    public final k41 f34123c;
    public final k41 d;
    public final i41 e;
    ...
    public final void X(float f7, boolean z10) {
        ...
        boolean isAttachedToWindow = this.f34121a.isAttachedToWindow();
        if (f7 > 0.7f) {
        ...
        k41 k41Var = this.d;
        k41 k41Var2 = this.f34122b;
        k41 k41Var3 = this.f34123c;
        if (f7 >= 1.0f) {
