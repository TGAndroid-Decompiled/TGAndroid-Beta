...
public final class x50 {
    ...
    public Emoji.EmojiDrawable f39380c;
    public org.telegram.ui.Components.o5 d;
    public boolean e;
    public boolean f39381f;
    public long f39382g;
    public String f39386l;
    public final Drawable[] f39379b = new Drawable[6];
    public final n20 h = new n20();
    public final HashSet f39383i = new HashSet();
    public boolean f39384j = false;
    public final w50 f39385k = new w50(this, 0);
    public final RectF f39387m = new RectF();

    public x50(int i10) {
        int i11 = 0;
        this.f39378a = i10;
        while (true) {
            Drawable[] drawableArr = this.f39379b;
            if (i11 < drawableArr.length) {
                drawableArr[i11] = Emoji.getEmojiDrawable(k60.A0());
                i11++;
            } else {
                this.f39382g = System.currentTimeMillis();
                return;
            }
        }
    }
    ...
    public final void a() {
        boolean isEmpty = this.f39383i.isEmpty();
        boolean z10 = !isEmpty;
        if (this.f39384j != z10) {
            this.f39384j = z10;
            w50 w50Var = this.f39385k;
            if (!isEmpty) {
    ...
    public final boolean b(Canvas canvas, RectF rectF, float f7) {
        ...
        RectF rectF2 = this.f39387m;
        rectF2.set(rectF);
        float f12 = -dp;
        rectF2.inset(f12, f12);
        canvas.saveLayerAlpha(rectF2.left, rectF2.top, rectF2.right, rectF2.bottom, 255, 31);
        long currentTimeMillis = (this.f39378a * 45) + System.currentTimeMillis();
        long j10 = currentTimeMillis - this.f39382g;
        float f13 = ((float) j10) / 180.0f;
        float min = Math.min(1.0f, f13);
        boolean z10 = this.f39381f;
        Drawable[] drawableArr = this.f39379b;
        boolean z11 = false;
        if (z10 && this.d != null && this.f39380c != null && this.e) {
            rectF2.set(rectF);
            ...
            if (f7 < 1.0f) {
                ...
                f11 = 0.0f;
                j3 = j10;
                this.f39380c.setBounds(0, 0, (int) rectF2.width(), (int) rectF2.height());
                canvas.translate(rectF2.left, rectF2.top);
                this.f39380c.setAlpha((int) ((1.0f - f7) * 255.0f));
                this.f39380c.draw(canvas);
                this.f39380c.setAlpha(255);
                canvas.restore();
            } else {
                j3 = j10;
                f10 = 255.0f;
        ...
        canvas.restore();
        if (f13 >= 1.0f) {
            if (this.f39381f && this.e) {
                z11 = true;
            } else {
                this.f39382g = currentTimeMillis - (j3 % 180);
                int i10 = 0;
    ...
    public final void c() {
        ...
        if (this.d != null && this.f39386l != null) {
            ...
            if (stickerSet != null) {
                String replace = this.f39386l.replace("️", "");
                ...
                FileLog.e("emoji \"" + this.f39386l + "\" not found in addemoji/" + tL_inputStickerSetShortName.short_name);
            }
        }
    }
}
