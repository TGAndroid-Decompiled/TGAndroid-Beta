...
public final class x50 {
    ...
    public Emoji.EmojiDrawable f39385c;
    public org.telegram.ui.Components.o5 d;
    public boolean e;
    public boolean f39386f;
    public long f39387g;
    public String f39391l;
    public final Drawable[] f39384b = new Drawable[6];
    public final n20 h = new n20();
    public final HashSet f39388i = new HashSet();
    public boolean f39389j = false;
    public final w50 f39390k = new w50(this, 0);
    public final RectF f39392m = new RectF();

    public x50(int i10) {
        int i11 = 0;
        this.f39383a = i10;
        while (true) {
            Drawable[] drawableArr = this.f39384b;
            if (i11 < drawableArr.length) {
                drawableArr[i11] = Emoji.getEmojiDrawable(k60.A0());
                i11++;
            } else {
                this.f39387g = System.currentTimeMillis();
                return;
            }
        }
    }
    ...
    public final void a() {
        boolean isEmpty = this.f39388i.isEmpty();
        boolean z10 = !isEmpty;
        if (this.f39389j != z10) {
            this.f39389j = z10;
            w50 w50Var = this.f39390k;
            if (!isEmpty) {
    ...
    public final boolean b(Canvas canvas, RectF rectF, float f7) {
        ...
        RectF rectF2 = this.f39392m;
        rectF2.set(rectF);
        float f12 = -dp;
        rectF2.inset(f12, f12);
        canvas.saveLayerAlpha(rectF2.left, rectF2.top, rectF2.right, rectF2.bottom, 255, 31);
        long currentTimeMillis = (this.f39383a * 45) + System.currentTimeMillis();
        long j10 = currentTimeMillis - this.f39387g;
        float f13 = ((float) j10) / 180.0f;
        float min = Math.min(1.0f, f13);
        boolean z10 = this.f39386f;
        Drawable[] drawableArr = this.f39384b;
        boolean z11 = false;
        if (z10 && this.d != null && this.f39385c != null && this.e) {
            rectF2.set(rectF);
            ...
            if (f7 < 1.0f) {
                ...
                f11 = 0.0f;
                j3 = j10;
                this.f39385c.setBounds(0, 0, (int) rectF2.width(), (int) rectF2.height());
                canvas.translate(rectF2.left, rectF2.top);
                this.f39385c.setAlpha((int) ((1.0f - f7) * 255.0f));
                this.f39385c.draw(canvas);
                this.f39385c.setAlpha(255);
                canvas.restore();
            } else {
                j3 = j10;
                f10 = 255.0f;
        ...
        canvas.restore();
        if (f13 >= 1.0f) {
            if (this.f39386f && this.e) {
                z11 = true;
            } else {
                this.f39387g = currentTimeMillis - (j3 % 180);
                int i10 = 0;
    ...
    public final void c() {
        ...
        if (this.d != null && this.f39391l != null) {
            ...
            if (stickerSet != null) {
                String replace = this.f39391l.replace("️", "");
                ...
                FileLog.e("emoji \"" + this.f39391l + "\" not found in addemoji/" + tL_inputStickerSetShortName.short_name);
            }
        }
    }
}
