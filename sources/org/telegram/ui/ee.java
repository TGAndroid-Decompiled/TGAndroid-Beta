...
public final class ee extends org.telegram.ui.Components.n81 {
    ...
    public final View d(int i10) {
        return new de(this.f33383f, this.f33380a, i10, this.f33381b, this.f33382c, new ai.o8(this, i10, 18), this.d);
    }
    ...
    public final int h(int i10) {
        if (i10 >= 0) {
            ...
            if (i10 < arrayList.size()) {
                return ((org.telegram.ui.Components.v51) arrayList.get(i10)).f29061z;
            }
            return 1;
        }
        return 1;
