...
public final class om extends org.telegram.ui.ActionBar.o1 {
    ...
    public final boolean b() {
        ...
        if (!wnVar.Oa) {
            ...
            if (!z10) {
                ...
                if (!z11 && !AndroidUtilities.isInMultiwindow && parentLayout != null && wnVar.f39586pa <= 0 && System.currentTimeMillis() - wnVar.E9 >= 250) {
                    if ((wnVar != parentLayout.getLastFragment() || !((ActionBarLayout) parentLayout).B()) && !((ActionBarLayout) parentLayout).f18616n) {
    ...
    public final void e(float f7, float f10, boolean z10) {
        ...
        int i10;
        fj fjVar;
        pm pmVar = this.f36252x;
        wn wnVar = pmVar.J0;
        if (wnVar.getParentLayout() == null || !((ActionBarLayout) wnVar.getParentLayout()).f18616n) {
            wnVar.f39676w9 = f7;
            wnVar.f39689x9 = f10;
            ai.g4 g4Var = wnVar.J1;
            if (g4Var == null || !g4Var.isShowing()) {
                ...
                ci.e4 e4Var = wnVar.f39668w1;
                if (e4Var != null) {
                    e4Var.setTranslationY(f7);
                }
                ci.e4 e4Var2 = wnVar.f39655v1;
                if (e4Var2 != null) {
            ...
            org.telegram.ui.Components.j40 j40Var = wnVar.f39618s2;
            if (j40Var != null && j40Var.getVisibility() == 0) {
                wnVar.f39618s2.f(wnVar.Y.getAudioVideoButtonContainer(), false);
            }
            ek ekVar = wnVar.X1;
    ...
    public final void f() {
        ...
        wn wnVar = this.f36252x.J0;
        jk jkVar = wnVar.Y;
        if (jkVar != null && (jeVar = jkVar.f22054u0) != null) {
            jeVar.run();
            jkVar.f22054u0 = null;
        }
        org.telegram.ui.Components.j40 j40Var = wnVar.f39618s2;
