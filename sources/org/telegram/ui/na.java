...
public abstract class na extends FrameLayout {
    ...
    public final org.telegram.ui.ActionBar.f6 f38883b;
    public final org.telegram.ui.ActionBar.j5 f38884c;
    public final ImageView d;
    public final org.telegram.ui.Components.sp f38885e;
    public final org.telegram.ui.Components.q6 f38886f;
    public final Drawable[] h;
    public float f38887n;
    public boolean f38888r;
    public ValueAnimator f38889s;
    public TLRPC.TL_username v;
    public boolean f38890w;
    public long f38891x;
    public final org.telegram.ui.Components.e6 f38892y;

    public na(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context);
        this.f38882a = false;
        this.f38892y = new org.telegram.ui.Components.e6(this, 300L, org.telegram.ui.Components.pr.f29466f);
        this.I = new org.telegram.ui.Components.e6(this, 400L, org.telegram.ui.Components.pr.h);
        this.f38883b = f6Var;
        setBackgroundColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20663d6, f6Var));
        ...
        this.d = imageView;
        org.telegram.ui.Components.sp spVar = new org.telegram.ui.Components.sp(AndroidUtilities.dp(7.0f), AndroidUtilities.dp(1.35f), org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20846n6, f6Var));
        this.f38885e = spVar;
        ...
        q6Var.b(0.4f, 120L, org.telegram.ui.Components.pr.f29467g);
    ...
    public final void a(TLRPC.TL_username tL_username, boolean z10, boolean z11, long j3) {
        ...
        boolean z14 = this.f38882a;
        org.telegram.ui.Components.q6 q6Var = this.f38886f;
        if (z14) {
            if (this.H) {
        ...
        if (z11) {
            ...
            this.F.setInterpolator(org.telegram.ui.Components.pr.f29467g);
            this.F.start();
            return;
        }
        if (z13) {
        ...
        org.telegram.ui.ActionBar.f6 f6Var = this.f38883b;
        int d = i0.a.d(this.E, org.telegram.ui.ActionBar.j6.v0(i12, f6Var), org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20846n6, f6Var));
        this.f38885e.b(d);
    ...
    public final void b(String str) {
        ...
        org.telegram.ui.ActionBar.j5 j5Var = this.f38884c;
        if (isEmpty) {
            ...
            spannableString.setSpan(new ForegroundColorSpan(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.H6, this.f38883b)), 0, spannableString.length(), 33);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float d10 = this.f38892y.d(f12, false);
        if (d10 > f11) {
            int alpha = org.telegram.ui.ActionBar.j6.f20785k0.getAlpha();
            org.telegram.ui.ActionBar.j6.f20785k0.setAlpha((int) (alpha * d10));
            canvas.drawRect(AndroidUtilities.dp(70.0f), getHeight() - 1, getWidth(), getHeight(), org.telegram.ui.ActionBar.j6.f20785k0);
    ...
    public void setLoading(boolean z10) {
        ...
        if (this.f38888r != z10) {
            this.f38888r = z10;
            ValueAnimator valueAnimator = this.f38889s;
            if (valueAnimator != null) {
                valueAnimator.cancel();
            }
            this.d.setVisibility(0);
            float f10 = this.f38887n;
            if (z10) {
                f7 = 1.0f;
            } else {
                f7 = 0.0f;
            ...
            ValueAnimator ofFloat = ValueAnimator.ofFloat(f10, f7);
            this.f38889s = ofFloat;
            ofFloat.addUpdateListener(new ma(this, 0));
            this.f38889s.addListener(new ah.q0(27, this, z10));
            this.f38889s.setInterpolator(org.telegram.ui.Components.pr.f29467g);
            this.f38889s.setDuration(200L);
            this.f38889s.start();
        }
    }
}
