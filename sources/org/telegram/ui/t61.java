...
public final class t61 extends org.telegram.ui.Components.ul0 {
    ...
    public int d;
    public int h;
    public final j71 f37644s;
    public int e = -1;
    public int f37641f = -1;
    public int f37642n = 1;
    public final ArrayList f37643r = new ArrayList();
    ...
    public final void E(boolean z10) {
        j71 j71Var = this.f37644s;
        int i10 = j71Var.W;
        boolean z11 = j71Var.I;
        ArrayList arrayList = this.f37643r;
        ...
        if (i10 == 14) {
            ...
            if (arrayList3 != null && !arrayList3.isEmpty()) {
                int i13 = this.f37642n;
                this.f37642n = i13 + 1;
                this.f37641f = i13;
                arrayList.add(2);
                this.f37640c = this.f37642n;
        ...
        if (arrayList5 != null) {
            int i17 = this.f37642n;
            this.h = i17;
            this.f37642n = arrayList5.size() + i17;
        }
        l();
        if (j71Var.f34831y1 && this.f37642n == 0) {
            z12 = true;
        }
        if (j71Var.G1 != z12) {
            j71Var.G1 = z12;
            ...
            j71Var.H1.start();
            if (z12) {
                j71.D(j71Var.V, j71Var.f34800l0);
            }
        }
    }
    ...
    public final int j(int i10) {
        int i11;
        if (i10 == this.e || i10 == this.f37641f) {
            return 6;
        }
        j71 j71Var = this.f37644s;
        if (j71Var.W == 14) {
            ArrayList arrayList = j71Var.B1;
            if (arrayList != null && i10 >= (i11 = this.f37640c) && i10 - i11 < arrayList.size()) {
                return 4;
            }
        } else {
        ...
        int i13 = this.d;
        if (i10 > i13 && (i10 - i13) - 1 < arrayList2.size() && (j71Var.W == 13 || ((zg.o0) j71Var.A1.get((i10 - this.d) - 1)).f49424g != 0)) {
            return 3;
        }
        int i14 = this.h;
        ...
        if (i16 == 6) {
            ...
            if (arrayList != null && (i13 = i10 - this.h) >= 0 && i13 < arrayList.size()) {
                ...
                if (document2 instanceof g71) {
                    CharSequence charSequence = ((g71) document2).f33819a;
                    String str = j71Var.f34833z1;
                    o61Var.getClass();
                    if (charSequence != null && str != null && (indexOf = charSequence.toString().toLowerCase().indexOf(str.toLowerCase())) >= 0) {
                        SpannableString spannableString = new SpannableString(charSequence);
                        spannableString.setSpan(new ForegroundColorSpan(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Ue, o61Var.f36199f.Z0)), indexOf, str.length() + indexOf, 33);
                        charSequence = spannableString;
                    }
                    o61Var.f36196a.setText(charSequence);
                    o61Var.b(false);
                }
            } else if (i10 == this.e) {
            ...
            o61Var.f36198c.setVisibility(8);
        } else if (i16 == 5) {
            TLRPC.Document document3 = (TLRPC.Document) j71Var.C1.get((i10 - this.f37640c) - 1);
            s61 s61Var = (s61) view;
            s61Var.a(w51Var);
            s61Var.h.setImage(ImageLocation.getForDocument(document3), "100_100_firstframe", null, null, DocumentObject.getSvgThumb(document3, org.telegram.ui.ActionBar.j6.f19259m6, 0.2f), 0L, "tgs", document3, 0);
            s61Var.Q = true;
            s61Var.d = document3;
            s61Var.e = null;
        } else if (i16 == 4) {
            ...
            s61Var2.f37308c = i10;
            ImageReceiver imageReceiver = s61Var2.f37310n;
            ArrayList arrayList2 = j71Var.A1;
            if (arrayList2 != null && i10 >= 0 && i10 < arrayList2.size()) {
                o0Var = (zg.o0) j71Var.A1.get(i10);
            } else {
                ArrayList arrayList3 = j71Var.B1;
                if (arrayList3 != null && i10 >= (i12 = this.f37640c) && i10 - i12 < arrayList3.size()) {
                    o0Var = (zg.o0) j71Var.B1.get(i10 - this.f37640c);
                } else {
                    return;
                }
            }
            ...
            s61Var2.f37314x = o0Var;
            s61Var2.f37315y = false;
            s61Var2.d(j71Var.J.contains(o0Var), false);
            s61Var2.f37307b = false;
            s61Var2.invalidate();
            if (i14 == 13) {
                s61Var2.setDrawable(Emoji.getEmojiDrawable(o0Var.f49423f));
            } else if (!o0Var.f49421b && o0Var.f49423f != null) {
                s61Var2.f37312s = true;
                TLRPC.TL_availableReaction tL_availableReaction = MediaDataController.getInstance(i15).getReactionsMap().get(o0Var.f49423f);
                if (tL_availableReaction != null) {
                    SvgHelper.SvgDrawable svgThumb = DocumentObject.getSvgThumb(tL_availableReaction.activate_animation, org.telegram.ui.ActionBar.j6.f19259m6, 0.2f);
                ...
                if (tL_availableReaction == null && o0Var.f49421b) {
                    s61Var2.setDrawable(Emoji.getEmojiDrawable(o0Var.f49423f));
                }
            } else {
                s61Var2.f37312s = false;
                s61Var2.e = new org.telegram.ui.Components.y5(o0Var.f49424g, (Paint.FontMetricsInt) null);
                s61Var2.d = null;
                s61Var2.h.clearImage();
                imageReceiver.clearImage();
                org.telegram.ui.Components.p5 p5Var = (org.telegram.ui.Components.p5) w51Var.f35328d3.get(s61Var2.e.getDocumentId());
                if (p5Var == null) {
                    cacheType2 = j71Var.getCacheType();
                    p5Var = org.telegram.ui.Components.p5.n(i15, s61Var2.e.getDocumentId(), null, cacheType2);
                    w51Var.f35328d3.put(s61Var2.e.getDocumentId(), p5Var);
                }
                s61Var2.setDrawable(p5Var);
            }
            if (!UserConfig.getInstance(i15).isPremium() && i14 == 14 && o0Var.f49421b && o0Var.d) {
                s61Var2.b();
            ...
            if (o0Var.e) {
                s61Var2.setEmojicon(o0Var.f49423f);
            } else {
                s61Var2.setEmojicon(null);
            }
            ...
            if (arrayList4 != null && i10 >= 0 && i10 < arrayList4.size()) {
                zg.o0 o0Var3 = (zg.o0) j71Var.A1.get(i10);
                s61Var3.f37314x = o0Var3;
                long j3 = o0Var3.f49424g;
                if (j3 == 0) {
                    boolean contains2 = j71Var.J.contains(o0Var3);
                    s61Var3.f37315y = true;
                    s61Var3.setDrawable(Emoji.getEmojiDrawable(o0Var3.f49423f));
                    s61Var3.d(contains2, false);
                    return;
                }
                l4 = Long.valueOf(j3);
                if (i14 == 14 && !UserConfig.getInstance(i15).isPremium() && o0Var3.f49421b && o0Var3.d) {
                    s61Var3.b();
            ...
            if (l4 == null && document == null) {
                ...
                if (document != null) {
                    ...
                    s61Var3.d = document;
                    contains = hashSet.contains(Long.valueOf(document.f18334id));
                } else {
                ...
                org.telegram.ui.Components.p5 p5Var2 = (org.telegram.ui.Components.p5) w51Var.f35328d3.get(s61Var3.e.getDocumentId());
                if (p5Var2 == null) {
                    cacheType = j71Var.getCacheType();
                    p5Var2 = org.telegram.ui.Components.p5.n(i15, s61Var3.e.getDocumentId(), null, cacheType);
                    w51Var.f35328d3.put(s61Var3.e.getDocumentId(), p5Var2);
                }
