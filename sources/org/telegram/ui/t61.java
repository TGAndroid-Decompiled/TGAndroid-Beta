...
public final class t61 extends org.telegram.ui.Components.kl0 {
    ...
    public int d;
    public int h;
    public final j71 f40668s;
    public int f40664e = -1;
    public int f40665f = -1;
    public int f40666n = 1;
    public final ArrayList f40667r = new ArrayList();
    ...
    public final void E(boolean z10) {
        j71 j71Var = this.f40668s;
        int i10 = j71Var.W;
        boolean z11 = j71Var.I;
        ArrayList arrayList = this.f40667r;
        ...
        if (i10 == 14) {
            ...
            if (arrayList3 != null && !arrayList3.isEmpty()) {
                int i13 = this.f40666n;
                this.f40666n = i13 + 1;
                this.f40665f = i13;
                arrayList.add(2);
                this.f40663c = this.f40666n;
        ...
        if (arrayList5 != null) {
            int i17 = this.f40666n;
            this.h = i17;
            this.f40666n = arrayList5.size() + i17;
        }
        l();
        if (j71Var.f37713y1 && this.f40666n == 0) {
            z12 = true;
        }
        if (j71Var.G1 != z12) {
            j71Var.G1 = z12;
            ...
            j71Var.H1.start();
            if (z12) {
                j71.D(j71Var.V, j71Var.f37682l0);
            }
        }
    }
    ...
    public final int j(int i10) {
        int i11;
        if (i10 == this.f40664e || i10 == this.f40665f) {
            return 6;
        }
        j71 j71Var = this.f40668s;
        if (j71Var.W == 14) {
            ArrayList arrayList = j71Var.B1;
            if (arrayList != null && i10 >= (i11 = this.f40663c) && i10 - i11 < arrayList.size()) {
                return 4;
            }
        } else {
            int i12 = this.f40663c;
        ...
        if (i16 == 6) {
            ...
            if (arrayList != null && (i13 = i10 - this.h) >= 0 && i13 < arrayList.size()) {
                ...
                if (document2 instanceof g71) {
                    CharSequence charSequence = ((g71) document2).f36619a;
                    String str = j71Var.f37715z1;
                    o61Var.getClass();
                    if (charSequence != null && str != null && (indexOf = charSequence.toString().toLowerCase().indexOf(str.toLowerCase())) >= 0) {
                        SpannableString spannableString = new SpannableString(charSequence);
                        spannableString.setSpan(new ForegroundColorSpan(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Ue, o61Var.f39150f.Z0)), indexOf, str.length() + indexOf, 33);
                        charSequence = spannableString;
                    }
                    o61Var.f39146a.setText(charSequence);
                    o61Var.b(false);
                }
            } else if (i10 == this.f40664e) {
            ...
            o61Var.f39148c.setVisibility(8);
        } else if (i16 == 5) {
            TLRPC.Document document3 = (TLRPC.Document) j71Var.C1.get((i10 - this.f40663c) - 1);
            s61 s61Var = (s61) view;
            s61Var.a(w51Var);
            s61Var.h.setImage(ImageLocation.getForDocument(document3), "100_100_firstframe", null, null, DocumentObject.getSvgThumb(document3, org.telegram.ui.ActionBar.j6.f20855m6, 0.2f), 0L, "tgs", document3, 0);
            s61Var.Q = true;
            s61Var.d = document3;
            s61Var.f40346e = null;
        } else if (i16 == 4) {
            ...
            s61Var2.f40345c = i10;
            ImageReceiver imageReceiver = s61Var2.f40348n;
            ArrayList arrayList2 = j71Var.A1;
            if (arrayList2 != null && i10 >= 0 && i10 < arrayList2.size()) {
                j1Var = (ah.j1) j71Var.A1.get(i10);
            } else {
                ArrayList arrayList3 = j71Var.B1;
                if (arrayList3 != null && i10 >= (i12 = this.f40663c) && i10 - i12 < arrayList3.size()) {
                    j1Var = (ah.j1) j71Var.B1.get(i10 - this.f40663c);
                } else {
                    return;
                }
            }
            ...
            if (i14 == 13) {
                ...
                s61Var2.f40350s = false;
                s61Var2.f40346e = new org.telegram.ui.Components.z5(j1Var.f610g, (Paint.FontMetricsInt) null);
                s61Var2.d = null;
                s61Var2.h.clearImage();
                imageReceiver.clearImage();
                org.telegram.ui.Components.q5 q5Var = (org.telegram.ui.Components.q5) w51Var.f38231d3.get(s61Var2.f40346e.getDocumentId());
                if (q5Var == null) {
                    cacheType2 = j71Var.getCacheType();
                    q5Var = org.telegram.ui.Components.q5.n(i15, s61Var2.f40346e.getDocumentId(), null, cacheType2);
                    w51Var.f38231d3.put(s61Var2.f40346e.getDocumentId(), q5Var);
                }
            ...
            if (l4 == null && document == null) {
                ...
                if (document != null) {
                    s61Var3.f40346e = new org.telegram.ui.Components.z5(document, (Paint.FontMetricsInt) null);
                    s61Var3.d = document;
                    ...
                    s61Var3.f40346e = z5Var;
                    s61Var3.d = z5Var.document;
                    contains = hashSet.contains(l4);
                }
                org.telegram.ui.Components.q5 q5Var2 = (org.telegram.ui.Components.q5) w51Var.f38231d3.get(s61Var3.f40346e.getDocumentId());
                if (q5Var2 == null) {
                    cacheType = j71Var.getCacheType();
                    q5Var2 = org.telegram.ui.Components.q5.n(i15, s61Var3.f40346e.getDocumentId(), null, cacheType);
                    w51Var.f38231d3.put(s61Var3.f40346e.getDocumentId(), q5Var2);
                }
