...
public final class ch0 extends ReplacementSpan {
    ...
    public final TextPaint f35114c;
    public final Paint d;
    public final float f35115e;
    public final eh0 f35116f;

    public ch0(eh0 eh0Var, int i10, boolean z10) {
        this.f35116f = eh0Var;
        TextPaint textPaint = new TextPaint(1);
        this.f35114c = textPaint;
        this.d = new Paint(1);
        String valueOf = String.valueOf(i10);
        this.f35112a = valueOf;
        this.f35113b = z10;
        textPaint.setTextSize(AndroidUtilities.dpf2(11.0f));
        textPaint.setTypeface(AndroidUtilities.bold());
        this.f35115e = Math.max(AndroidUtilities.dp(7.333f), textPaint.measureText(valueOf)) + AndroidUtilities.dp(10.0f);
    }
    ...
    public final void draw(Canvas canvas, CharSequence charSequence, int i10, int i11, float f7, int i12, int i13, int i14, Paint paint) {
        ...
        eh0 eh0Var = this.f35116f;
        int themedColor = eh0Var.getThemedColor(i15);
        Paint paint2 = this.d;
        paint2.setColor(themedColor);
        int themedColor2 = eh0Var.getThemedColor(org.telegram.ui.ActionBar.j6.f20938s8);
        TextPaint textPaint = this.f35114c;
        textPaint.setColor(themedColor2);
        RectF rectF = AndroidUtilities.rectTmp;
        float f10 = this.f35115e;
    ...
    public final int getSize(Paint paint, CharSequence charSequence, int i10, int i11, Paint.FontMetricsInt fontMetricsInt) {
        return (int) Math.ceil(AndroidUtilities.dp(5.0f) + this.f35115e);
    }
}
