...
public final class ch0 implements RequestDelegate {
    ...
    public final sh0 f32727b;
    public final TLRPC.TL_chatInviteExported f32728c;

    public ch0(sh0 sh0Var, TLRPC.TL_chatInviteExported tL_chatInviteExported, int i10) {
        this.f32726a = i10;
        this.f32727b = sh0Var;
        this.f32728c = tL_chatInviteExported;
    }
    ...
    public final void run(final TLObject tLObject, final TLRPC.TL_error tL_error) {
        switch (this.f32726a) {
            case 0:
                final sh0 sh0Var = this.f32727b;
                final TLRPC.TL_chatInviteExported tL_chatInviteExported = this.f32728c;
                AndroidUtilities.runOnUIThread(new Runnable() {
                    ...
                    public final void run() {
                        switch (r5) {
                            case 0:
                                if (tL_error == null) {
                                    ...
                                    if (sh0Var2.getParentActivity() != null) {
                                        ...
                                        jh0 f02 = sh0Var2.f0();
                                        sh0Var2.f37782j0.add(0, tL_chatInviteExported3);
                                        sh0Var2.h0(f02);
                            ...
                            default:
                                sh0 sh0Var3 = sh0Var;
                                ArrayList arrayList = sh0Var3.f37781i0;
                                if (tL_error == null) {
                                    ...
                                    if (z10) {
                                        ...
                                        jh0 f03 = sh0Var3.f0();
                                        if (sh0Var3.f37787o0 && sh0Var3.f37777f == sh0Var3.getAccountInstance().getUserConfig().getClientUserId()) {
                                        ...
                                        sh0Var3.f37782j0.add(0, tL_chatInviteExported4);
                                        sh0Var3.h0(f03);
                                    } else {
                                        sh0Var3.f37793s0.b(tL_chatInviteExported4, tLObject2);
                                        ...
                                        if (chatFull2 != null) {
                                            ...
                                            sh0Var3.getMessagesStorage().saveChatLinksCount(sh0Var3.f37785n, sh0Var3.d.invitesCount);
                                        }
                                    }
                ...
                return;
            case 1:
                sh0 sh0Var2 = this.f32727b;
                sh0Var2.getClass();
                AndroidUtilities.runOnUIThread(new jf0(sh0Var2, tL_error, this.f32728c, 5));
                return;
            default:
                final sh0 sh0Var3 = this.f32727b;
                final TLRPC.TL_chatInviteExported tL_chatInviteExported2 = this.f32728c;
                AndroidUtilities.runOnUIThread(new Runnable() {
                    @Override
                    public final void run() {
                        switch (r5) {
                            case 0:
                                if (tL_error == null) {
                                    ...
                                    if (sh0Var22.getParentActivity() != null) {
                                        ...
                                        tL_chatInviteExported3.revoked = true;
                                        jh0 f02 = sh0Var22.f0();
                                        sh0Var22.f37782j0.add(0, tL_chatInviteExported3);
                                        sh0Var22.h0(f02);
                            ...
                            default:
                                ...
                                ArrayList arrayList = sh0Var32.f37781i0;
                                if (tL_error == null) {
                                    TLObject tLObject2 = tLObject;
                                    boolean z10 = tLObject2 instanceof TLRPC.TL_messages_exportedChatInviteReplaced;
                                    ...
                                    if (z10) {
                                        TLRPC.TL_messages_exportedChatInviteReplaced tL_messages_exportedChatInviteReplaced = (TLRPC.TL_messages_exportedChatInviteReplaced) tLObject2;
                                        if (!sh0Var32.f37787o0) {
                                            sh0Var32.e = (TLRPC.TL_chatInviteExported) tL_messages_exportedChatInviteReplaced.new_invite;
                                        }
                                        tL_chatInviteExported4.revoked = true;
                                        jh0 f03 = sh0Var32.f0();
                                        if (sh0Var32.f37787o0 && sh0Var32.f37777f == sh0Var32.getAccountInstance().getUserConfig().getClientUserId()) {
                                            arrayList.remove(tL_chatInviteExported4);
                                            arrayList.add(0, (TLRPC.TL_chatInviteExported) tL_messages_exportedChatInviteReplaced.new_invite);
                                        } else if (sh0Var32.e != null) {
                                            sh0Var32.e = (TLRPC.TL_chatInviteExported) tL_messages_exportedChatInviteReplaced.new_invite;
                                        }
                                        sh0Var32.f37782j0.add(0, tL_chatInviteExported4);
                                        sh0Var32.h0(f03);
                                    } else {
                                        sh0Var32.f37793s0.b(tL_chatInviteExported4, tLObject2);
                                        ...
                                        if (chatFull2 != null) {
                                            ...
                                            sh0Var32.getMessagesStorage().saveChatLinksCount(sh0Var32.f37785n, sh0Var32.d.invitesCount);
                                        }
                                    }
