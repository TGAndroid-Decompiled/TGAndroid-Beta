    ...
    public final void run() {
        ...
        switch (this.f32762a) {
            ...
            case 3:
                ...
                return;
            case 4:
                AndroidUtilities.removeFromParent(this.f32763b.P);
                return;
            case 5:
                gh0 gh0Var2 = this.f32763b;
                gh0Var2.getClass();
                new fk0(gh0Var2.getParentActivity(), gh0Var2).show();
                return;
            case 6:
                gh0 gh0Var3 = this.f32763b;
                gh0Var3.getClass();
                ...
                return;
            default:
                gh0 gh0Var4 = this.f32763b;
                if (gh0Var4.getParentActivity() != null && (bVarArr = gh0Var4.K) != null) {
                    oh.b bVar = bVarArr[4];
                    float width = ((bVar.getWidth() / 2.0f) + (gh0Var4.f32101b.getWidth() - ((bVar.getX() + gh0Var4.F.getX()) + bVar.getWidth()))) / AndroidUtilities.density;
                    ...
                    gh0Var4.f32101b.addView(gh0Var4.P, w7.y5.d(-1, 100.0f, 87, 0.0f, 0.0f, 0.0f, 72.0f));
                    ci.f4 f4Var2 = gh0Var4.P;
                    f4Var2.f4639l0 = new ch0(gh0Var4, 4);
                    f4Var2.d = 8000L;
                    f4Var2.u();
                    org.telegram.ui.Components.j40.f25218r.b();
                    return;
                }
                return;
        }
