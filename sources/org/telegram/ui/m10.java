...
public final class m10 extends s4.s0 {
    ...
    public final void a(RecyclerView recyclerView, int i10) {
        if (i10 == 1) {
            AndroidUtilities.hideKeyboard(this.f38568a.K.getCurrentFocus());
        }
    }
    ...
    public final void b(RecyclerView recyclerView, int i10, int i11) {
        ...
        x10 x10Var = this.f38568a;
        bi.a4 a4Var = x10Var.m0;
        s4.c0 c0Var = x10Var.f42577j0;
        le.b bVar = x10Var.f42563a;
        g10 g10Var = x10Var.f42581n0;
        if (recyclerView.getAdapter() != null && x10Var.d != null) {
            ...
            View pinnedHeader = x10Var.f42565b.getPinnedHeader();
