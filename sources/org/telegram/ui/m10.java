...
public final class m10 extends vu0 {
    ...
    public final CharSequence C(int i10) {
        return LocaleController.formatDateAudio(((MessageObject) this.f35667a.f40082f.get(i10)).messageOwner.date, false);
    }
    ...
    public final fv0 E(MessageObject messageObject, TLRPC.FileLocation fileLocation, int i10, boolean z10, boolean z11) {
        ...
        if (messageObject != null) {
            ai.w0 w0Var = this.f35667a.f40076b;
            ...
            for (int i12 = 0; i12 < childCount; i12++) {
                ...
                if (childAt instanceof org.telegram.ui.Cells.u7) {
                    ...
                    for (int i13 = 0; i13 < 6; i13++) {
                        if (i13 >= u7Var.e) {
                            ...
                            messageObject2 = u7Var.f21454b[i13];
                        }
                        ...
                        if (messageObject2.getId() == messageObject.getId()) {
                            if (i13 >= u7Var.e) {
                                ...
                                u9Var = u7Var.f21453a[i13].f20621a;
                            }
                ...
                if (photoImage != null) {
                    ...
                    fv0Var.f33777n = -iArr[1];
                    fv0Var.f33767a = photoImage;
                    fv0Var.f33778o = false;
                    fv0Var.h = photoImage.getRoundRadius(true);
                    fv0Var.e = fv0Var.f33767a.getBitmapSafe();
                    ...
                    if (PhotoViewer.M1(messageObject) && (pinnedHeader = w0Var.getPinnedHeader()) != null) {
                        ...
                        int i14 = i11 - fv0Var.f33769c;
                        if (i14 > childAt.getHeight()) {
                            w0Var.scrollBy(0, -(pinnedHeader.getHeight() + i14));
                            return fv0Var;
                        }
                        int height = fv0Var.f33769c - w0Var.getHeight();
                        if (childAt instanceof org.telegram.ui.Cells.j7) {
    ...
    public final boolean Y() {
        z10 z10Var = this.f35667a;
        if (!z10Var.N) {
            z10Var.h(z10Var.E, z10Var.F, z10Var.H, z10Var.G, z10Var.f40100y, z10Var.J, z10Var.f40098w, false);
            return true;
        }
        return true;
    }
    ...
    public final CharSequence b0(int i10) {
        return z10.d((MessageObject) this.f35667a.f40082f.get(i10), true, 0, null);
    }

    @Override
    public final int y() {
        return this.f35667a.O;
    }
}
