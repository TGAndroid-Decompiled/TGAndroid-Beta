...
public final class zw0 implements v60, ug.e {
    public final int f44007a;
    public final boolean f44008b;
    public final Object f44009c;

    public zw0(int i10, Object obj, boolean z4) {
        this.f44009c = obj;
        this.f44007a = i10;
        this.f44008b = z4;
    }
    ...
    public void a(Canvas canvas, RectF rectF, float[] fArr) {
        ...
        paint2.setColor(this.f44007a);
        float f11 = bVar.f44858l;
        if (f11 > 0.0f) {
            paint2.setShadowLayer(f11, 0.0f, bVar.f44859m, bVar.d);
        }
        canvas.drawPath(path, paint2);
        if (bVar.f44858l > 0.0f) {
            paint2.clearShadowLayer();
            canvas.drawPath(path, paint2);
        }
        if (this.f44008b) {
            float[] copyOf = Arrays.copyOf(aVar.f44837b, 8);
            boolean c3 = lf.l0.c(copyOf);
            float min = Math.min(rectF.width(), rectF.height()) / 2.0f;
            Paint paint3 = new Paint(1);
            if (Color.alpha(bVar.f44853f) > 0 && copyOf[0] > 0.0f) {
                ...
                float f15 = rectF.top;
                path2.addRoundRect(f14, aVar.f44842i + f15, rectF.right, Math.min(Math.max(copyOf[0], copyOf[2]) + f15, rectF.bottom), fArr2, Path.Direction.CCW);
                paint.setColor(bVar.f44853f);
            ...
            if (Color.alpha(bVar.f44854g) > 0 && copyOf[4] > f10) {
                Arrays.fill(fArr2, 0.0f);
                fArr2[4] = copyOf[4];
                fArr2[5] = copyOf[5];
                fArr2[6] = copyOf[6];
                ...
                path3.addRoundRect(rectF.left, Math.max(rectF.bottom - Math.max(copyOf[4], copyOf[6]), rectF.top), rectF.right, rectF.bottom - aVar.f44843j, fArr2, Path.Direction.CCW);
                paint.setColor(bVar.f44854g);
    ...
    public void b(ArrayList arrayList, boolean z4, boolean z10) {
        char c3;
        PrivacyControlActivity privacyControlActivity = (PrivacyControlActivity) this.f44009c;
        boolean[] zArr = privacyControlActivity.B;
        int i10 = privacyControlActivity.Q;
        int i11 = this.f44007a;
        boolean z11 = this.f44008b;
        int i12 = 0;
        boolean z12 = true;
        if (i11 == i10) {
