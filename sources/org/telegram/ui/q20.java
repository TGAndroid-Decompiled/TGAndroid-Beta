...
public class q20 extends org.telegram.ui.Components.nc0 {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        o20 o20Var = r20Var.f40077y;
        int i11 = 0;
        if (!r20Var.f40071f) {
            if (r20Var.h) {
                float f10 = r20Var.f40072n + 0.016f;
                r20Var.f40072n = f10;
                if (f10 > 3.0f) {
                    r20Var.h = false;
                }
            } else {
                float f11 = r20Var.f40072n - 0.016f;
                r20Var.f40072n = f11;
                if (f11 < 1.0f) {
                    r20Var.h = true;
                }
        ...
        float f12 = 1.0f - ((r20Var.f40073r - dp) / (r20Var.J - dp));
        r20Var.v = f12;
        float f13 = 0.0f;
        ...
        if (r20Var.f40073r < dp2) {
            r20Var.f40073r = dp2;
        }
        float f14 = r20Var.f40076x;
        r20Var.f40076x = 0.0f;
        if (r20Var.f40073r < AndroidUtilities.dp(30.0f) + dp2) {
            r20Var.f40076x = ((AndroidUtilities.dp(30.0f) + dp2) - r20Var.f40073r) / AndroidUtilities.dp(30.0f);
        }
        if (r20Var.H) {
            r20Var.f40076x = 1.0f;
            r20Var.v = 1.0f;
        }
        if (f14 != r20Var.f40076x) {
            r20Var.f40069c.invalidate();
        }
        int i12 = r20Var.f40073r;
        ...
        ((FrameLayout) o20Var.f39118e).setAlpha(f16);
        ((org.telegram.ui.Components.d90) o20Var.f39117c).setAlpha(f16);
        r20Var.f40070e.setAlpha(1.0f - r20Var.v);
        r20Var.f40070e.setTranslationY((frameLayout.getY() + o20Var.getY()) - AndroidUtilities.dp(30.0f));
        ...
        r20Var.f40067a.d(0, (-getMeasuredWidth()) * 0.1f * r20Var.f40072n, 0, getMeasuredWidth(), 0.0f, getMeasuredHeight());
        if (r20Var.M) {
            int themedColor = r20Var.getThemedColor(org.telegram.ui.ActionBar.j6.f20635a7);
            Paint paint2 = this.H0;
            paint2.setColor(themedColor);
            canvas.drawRect(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight(), paint2);
        } else {
            canvas.drawRect(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight(), r20Var.f40067a.f46064f);
        }
        int themedColor2 = r20Var.getThemedColor(org.telegram.ui.ActionBar.j6.f20798j5);
        if (r20Var.M) {
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        FrameLayout frameLayout = (FrameLayout) o20Var.f39118e;
        ...
        if ((!rectF2.contains(motionEvent.getX(), motionEvent.getY()) && !this.E0) || r20Var.f40069c.K1 || (layout = d90Var.getLayout()) == null) {
            f7 = 1.0f;
        } else {
            ...
            if (text instanceof Spanned) {
                ...
                if (clickableSpanArr != null && clickableSpanArr.length > 0 && r20Var.f40076x < 1.0f) {
        ...
        if ((rectF2.contains(motionEvent.getX(), motionEvent.getY()) || this.D0) && !r20Var.f40069c.K1 && isClickable && r20Var.f40076x < f7) {
        ...
        if ((rectF2.contains(motionEvent.getX(), motionEvent.getY()) || this.F0) && !r20Var.f40069c.K1 && r20Var.f40076x < f7) {
