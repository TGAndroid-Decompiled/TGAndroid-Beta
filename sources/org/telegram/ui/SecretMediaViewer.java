...
public class SecretMediaViewer implements NotificationCenter.NotificationCenterDelegate, GestureDetector.OnGestureListener, GestureDetector.OnDoubleTapListener {
    ...
    private final Runnable updateProgressRunnable = new SecretMediaViewer$$ExternalSyntheticLambda2(this, 1);
    private final int[] videoPlayerCurrentTime = new int[2];
    private final int[] videoPlayerTotalTime = new int[2];
    private final Runnable hideActionBarRunnable = new SecretMediaViewer$$ExternalSyntheticLambda2(this, 2);
    ...
    public class AnonymousClass11 extends Fade {
        ...
        public AnonymousClass11(int i, boolean z, boolean z2) {
            super(i);
        ...
        public Animator onAppear(ViewGroup viewGroup, View view, TransitionValues transitionValues, TransitionValues transitionValues2) {
            ...
            if (this.val$isCurrentCaptionEmpty && !this.val$isCaptionEmpty && view == SecretMediaViewer.this.captionTextViewSwitcher) {
                ...
                ((ObjectAnimator) animatorOnAppear).addUpdateListener(new PhotoViewer$73$$ExternalSyntheticLambda0(this, 16));
            }
    ...
    public class AnonymousClass12 extends Fade {
        ...
        public Animator onDisappear(ViewGroup viewGroup, View view, TransitionValues transitionValues, TransitionValues transitionValues2) {
            ...
            if (!this.val$isCurrentCaptionEmpty && this.val$isCaptionEmpty && view == SecretMediaViewer.this.captionTextViewSwitcher) {
                ...
                ((ObjectAnimator) animatorOnDisappear).addUpdateListener(new PhotoViewer$73$$ExternalSyntheticLambda0(this, 17));
            }
    ...
    public class AnonymousClass13 extends Transition {
        ...
        public Animator createAnimator(ViewGroup viewGroup, TransitionValues transitionValues, TransitionValues transitionValues2) {
            ...
            if (transitionValues.view == SecretMediaViewer.this.captionScrollView) {
                ...
                valueAnimatorOfInt.addUpdateListener(new PhotoViewer$73$$ExternalSyntheticLambda0(this, 18));
    ...
    public class AnonymousClass17 extends AnimatorListenerAdapter {
        ...
        public AnonymousClass17(PhotoViewer.PlaceProviderObject placeProviderObject) {
        ...
        public void onAnimationEnd(Animator animator) {
            ...
            AndroidUtilities.runOnUIThread(new VoIPFragment$8$$ExternalSyntheticLambda1(this, 12));
        }
    }
    ...
    public class AnonymousClass2 implements VideoPlayer.VideoPlayerDelegate {
        ...
        public void onError(VideoPlayer videoPlayer, Exception exc) {
            ...
            AndroidUtilities.runOnUIThread(new PhotoViewer$7$$ExternalSyntheticLambda0(8, this, this.val$file), 100L);
        }
    ...
    public class SecretDeleteTimer extends FrameLayout {
        ...
        public SecretDeleteTimer(Context context) {
            ...
            int i = R.raw.fire_on;
            RLottieDrawable rLottieDrawable = new RLottieDrawable(i, Fragment$$ExternalSyntheticOutline0.m(i, ""), AndroidUtilities.dp(16.0f), AndroidUtilities.dp(16.0f));
    ...
    public class VideoPlayerControlFrameLayout extends FrameLayout {
        ...
        public VideoPlayerControlFrameLayout(Context context) {
            ...
            SpringAnimation springAnimationM = ChatActivity$21$$ExternalSyntheticOutline0.m(0.0f, 750.0f, 1.0f, new SpringAnimation(floatValueHolder));
            springAnimationM.addUpdateListener(new LoginActivity$$ExternalSyntheticLambda12(this, 3));
            this.timeSpring = springAnimationM;
            this.SEEKBAR_ALPHA = new AnimationProperties.FloatProperty<VideoPlayerControlFrameLayout>("progress") {
                @Override
        ...
        public void onMeasure(int i, int i2) {
            ...
            long j2 = j / 60;
            int iCeil = (int) Math.ceil(SecretMediaViewer.this.videoPlayerTime.getPaint().measureText(String.format(Locale.ROOT, "%1$s / %1$s", j2 > 60 ? String.format(Locale.ROOT, "%02d:%02d:%02d", Long.valueOf(j2 / 60), Long.valueOf(j2 % 60), Long.valueOf(j % 60)) : String.format(Locale.ROOT, "%02d:%02d", Long.valueOf(j2), Long.valueOf(j % 60)))));
            this.timeSpring.cancel();
            if (this.lastTimeWidth != 0) {
                float f = iCeil;
                if (this.timeValue.mValue != f) {
        ...
        public void setSeekBarTransitionEnabled(boolean z) {
            if (this.seekBarTransitionEnabled != z) {
                ...
                if (z) {
                    ...
                    SecretMediaViewer.this.seekbarView.setAlpha(1.0f);
                } else {
                    SecretMediaViewer.this.videoPlayerTime.setScaleX(1.0f);
                    SecretMediaViewer.this.videoPlayerTime.setScaleY(1.0f);
                    SecretMediaViewer.this.seekbar.setTransitionProgress(0.0f);
                }
    ...
    public static int access$1610(SecretMediaViewer secretMediaViewer) {
    ...
    public View lambda$setParentActivity$2(Activity activity) {
        return new PhotoViewer.CaptionTextView(activity, this.captionScrollView, this.textSelectionHelper, new LinkManager$$ExternalSyntheticLambda6(this, 23), new PhotoViewer$$ExternalSyntheticLambda178(this, 2));
    }
        ...
        if (this.isPhotoVisible) {
            if (this.imageMoveAnimation != null) {
                ...
                if (this.useOvershootForScale) {
                    float f6 = this.animationValue;
                    if (f6 < 0.9f) {
                        f5 = f6 / 0.9f;
                        float f7 = this.scale;
                        f = (((this.animateToScale * 1.02f) - f7) * f5) + f7;
                    } else {
                        float f8 = this.animateToScale;
                        f = f8 + ((1.0f - ((f6 - 0.9f) / 0.100000024f)) * 0.01999998f * f8);
                        f5 = 1.0f;
                    }
                    float f9 = this.translationY;
                    fM = DiffUtil.m(this.animateToY, f9, f5, f9);
                    float f10 = this.translationX;
                    fM2 = DiffUtil.m(this.animateToX, f10, f5, f10);
                    float f11 = this.clipTop;
                    fM3 = DiffUtil.m(this.animateToClipTop, f11, f5, f11);
                    float f12 = this.clipBottom;
                    fM4 = DiffUtil.m(this.animateToClipBottom, f12, f5, f12);
                    float f13 = this.clipTopOrigin;
                    fM5 = DiffUtil.m(this.animateToClipTopOrigin, f13, f5, f13);
                    float f14 = this.clipBottomOrigin;
                    fM6 = DiffUtil.m(this.animateToClipBottomOrigin, f14, f5, f14);
                    float f15 = this.clipHorizontal;
                    fM7 = DiffUtil.m(this.animateToClipHorizontal, f15, f5, f15);
                } else {
                    ...
                    fM = DiffUtil.m(this.animateToY, f20, f18, f20);
                    float f21 = this.translationX;
                    fM2 = DiffUtil.m(this.animateToX, f21, f18, f21);
                    float f22 = this.clipTop;
                    fM3 = DiffUtil.m(this.animateToClipTop, f22, f18, f22);
                    float f23 = this.clipBottom;
                    fM4 = DiffUtil.m(this.animateToClipBottom, f23, f18, f23);
                    float f24 = this.clipTopOrigin;
                    fM5 = DiffUtil.m(this.animateToClipTopOrigin, f24, f18, f24);
                    float f25 = this.clipBottomOrigin;
                    fM6 = DiffUtil.m(this.animateToClipBottomOrigin, f25, f18, f25);
                    float f26 = this.clipHorizontal;
                    float fM8 = DiffUtil.m(this.animateToClipHorizontal, f26, f18, f26);
                    f = f19;
                    fM7 = fM8;
                }
                f2 = (this.animateToScale == 1.0f && this.scale == 1.0f && this.translationX == 0.0f) ? fM : -1.0f;
                this.containerView.invalidate();
            } else {
                ...
                f = this.scale;
                fM = this.translationY;
                fM2 = this.translationX;
                fM3 = this.clipTop;
                fM4 = this.clipBottom;
                fM5 = this.clipTopOrigin;
                fM6 = this.clipBottomOrigin;
                fM7 = this.clipHorizontal;
                f2 = !this.moving ? fM : -1.0f;
            }
            if (this.animateFromRadius != null) {
                if (this.currentRadii == null) {
                    this.currentRadii = new float[8];
                }
                float f28 = this.animateToRadius ? this.animationValue : 1.0f - this.animationValue;
                int i2 = 0;
                z = true;
                for (int i3 = 8; i2 < i3; i3 = 8) {
                    float[] fArr = this.currentRadii;
                    float fLerp = AndroidUtilities.lerp(this.animateFromRadius[i2 / 2] * 2.0f, 0.0f, f28);
                    fArr[i2 + 1] = fLerp;
                    fArr[i2] = fLerp;
            ...
            if (this.photoAnimationInProgress == 3) {
                ...
                if (this.scale != 1.0f || f2 == -1.0f || this.zoomAnimation) {
                    ...
                    this.photoBackgroundDrawable.setAlpha((int) Math.max(127.0f, (1.0f - (Math.min(Math.abs(f2), containerViewHeight) / containerViewHeight)) * 255.0f));
                }
                if (this.zoomAnimation) {
                    ...
                    float f29 = this.maxX;
                    if (fM2 > f29) {
                        float fMin = Math.min(1.0f, (fM2 - f29) / canvas.getWidth());
                        f4 = 0.3f * fMin;
                        f3 = 1.0f - fMin;
                        fM2 = this.maxX;
                    } else {
            ...
            canvas.save();
            float f30 = f - f4;
            canvas.translate((getContainerViewWidth() / 2) + fM2, (getContainerViewHeight() / 2) + fM);
            ...
            float f31 = bitmapHeight;
            float f32 = bitmapWidth;
            float fMin2 = Math.min(getContainerViewHeight() / f31, getContainerViewWidth() / f32);
            int i5 = (int) (f32 * fMin2);
            int i6 = (int) (f31 * fMin2);
            float f33 = (-i5) / 2;
            float f34 = fM7 / f30;
            float f35 = f33 + f34;
            float f36 = (-i6) / 2;
            float f37 = (i5 / 2) - f34;
            float f38 = i6 / 2;
            canvas.clipRect(f35, (fM3 / f30) + f36, f37, f38 - (fM4 / f30));
            if (!z) {
                this.roundRectPath.reset();
                RectF rectF = AndroidUtilities.rectTmp;
                rectF.set(f35, (fM5 / f30) + f36, f37, f38 - (fM6 / f30));
            ...
            if (!z2 || !this.textureUploaded || !this.videoCrossfadeStarted || this.videoCrossfadeAlpha != 1.0f) {
                this.centerImage.setAlpha(f3);
                this.centerImage.setImageCoords(f33, f36, i5, i6);
            ...
            if (z2) {
                ...
                canvas.translate(f33, f36);
                this.videoTextureView.setAlpha(f3 * this.videoCrossfadeAlpha);
                ...
                if (this.videoCrossfadeStarted && this.videoCrossfadeAlpha < 1.0f) {
                    ...
                    this.videoCrossfadeAlpha = (j / 200.0f) + this.videoCrossfadeAlpha;
                    this.containerView.invalidate();
    ...
    private void onPhotoClosed(PhotoViewer.PlaceProviderObject placeProviderObject) {
        ...
        releasePlayer();
        new ArrayList();
        AndroidUtilities.runOnUIThread(new SecretMediaViewer$$ExternalSyntheticLambda2(this, 0), 50L);
    }
            ...
            if (motionEvent.getActionMasked() == 0 || motionEvent.getActionMasked() == 5) {
                ...
                if (!this.draggingDown) {
                    if (motionEvent.getPointerCount() == 2) {
                        ...
                        this.pinchCenterX = (motionEvent.getX(1) + motionEvent.getX(0)) / 2.0f;
                        this.pinchCenterY = (motionEvent.getY(1) + motionEvent.getY(0)) / 2.0f;
                ...
                if (motionEvent.getActionMasked() == 2) {
                    if (motionEvent.getPointerCount() == 2 && !this.draggingDown && this.zooming) {
                        ...
                        this.translationX = TextureRenderer$$ExternalSyntheticOutline0.m(this.scale, this.pinchStartScale, (this.pinchCenterX - (getContainerViewWidth() / 2)) - this.pinchStartX, this.pinchCenterX - (getContainerViewWidth() / 2));
                        ...
                        float f3 = this.scale;
                        this.translationY = TextureRenderer$$ExternalSyntheticOutline0.m(f3, this.pinchStartScale, containerViewHeight2, containerViewHeight);
                        updateMinMax(f3);
                        this.containerView.invalidate();
                    } else if (motionEvent.getPointerCount() == 1) {
                    ...
                    if (this.zooming) {
                        ...
                        if (f8 < 1.0f) {
                            ...
                            float fM = TextureRenderer$$ExternalSyntheticOutline0.m(3.0f, this.pinchStartScale, (this.pinchCenterX - (getContainerViewWidth() / 2)) - this.pinchStartX, this.pinchCenterX - (getContainerViewWidth() / 2));
                            float fM2 = TextureRenderer$$ExternalSyntheticOutline0.m(3.0f, this.pinchStartScale, (this.pinchCenterY - (getContainerViewHeight() / 2)) - this.pinchStartY, this.pinchCenterY - (getContainerViewHeight() / 2));
                            updateMinMax(3.0f);
                            float f9 = this.minX;
                            if (fM < f9) {
                                fM = f9;
    ...
    private void updateVideoPlayerTime() {
        ...
        String str = i >= 60 ? String.format(Locale.ROOT, "%02d:%02d:%02d", Integer.valueOf(i / 60), Integer.valueOf(this.videoPlayerCurrentTime[0] % 60), Integer.valueOf(this.videoPlayerCurrentTime[1])) : String.format(Locale.ROOT, "%02d:%02d", Integer.valueOf(i), Integer.valueOf(this.videoPlayerCurrentTime[1]));
        int i2 = this.videoPlayerTotalTime[0];
        String str2 = i2 >= 60 ? String.format(Locale.ROOT, "%02d:%02d:%02d", Integer.valueOf(i2 / 60), Integer.valueOf(this.videoPlayerTotalTime[0] % 60), Integer.valueOf(this.videoPlayerTotalTime[1])) : String.format(Locale.ROOT, "%02d:%02d", Integer.valueOf(i2), Integer.valueOf(this.videoPlayerTotalTime[1]));
        SimpleTextView simpleTextView = this.videoPlayerTime;
    ...
    public boolean closePhoto(boolean z, boolean z2) {
        ...
        if (z) {
            ...
            if (placeForPhoto == null || placeForPhoto.imageReceiver.getThumbBitmap() == null || z2 || this.onClose != null) {
                ...
                this.animateToY = ((f2 / 2.0f) + (placeForPhoto.viewY + drawRegion.top)) - (i4 / 2);
                ...
                float height = (((placeForPhoto.viewY + drawRegion.top) + ((int) f2)) - (placeForPhoto.parentView.getHeight() + iArr[1])) + placeForPhoto.clipBottomAddition;
            ...
            if (this.isVideo) {
                ...
                ObjectAnimator objectAnimatorOfFloat = ObjectAnimator.ofFloat(this, this.ANIMATION_VALUE, 0.0f, 1.0f);
                ActionBar actionBar = this.actionBar;
                Property property = View.ALPHA;
                ...
                ObjectAnimator objectAnimatorOfFloat9 = ObjectAnimator.ofFloat(this, this.ANIMATION_VALUE, 0.0f, 1.0f);
                ...
                ObjectAnimator objectAnimatorOfFloat16 = ObjectAnimator.ofFloat(this.centerImage, AnimationProperties.IMAGE_RECEIVER_ALPHA, 0.0f);
            ...
            this.photoAnimationEndRunnable = new SecretMediaViewer$$ExternalSyntheticLambda5(this, placeForPhoto, i);
            ...
            this.photoAnimationEndRunnable = new SecretMediaViewer$$ExternalSyntheticLambda5(this, placeForPhoto, 2);
    ...
    public boolean onDoubleTap(MotionEvent motionEvent) {
        ...
        if (this.animationStartTime == 0 && this.photoAnimationInProgress == 0) {
            z = true;
            if (f == 1.0f) {
                float fM = TextureRenderer$$ExternalSyntheticOutline0.m(3.0f, this.scale, (motionEvent.getX() - (getContainerViewWidth() / 2)) - this.translationX, motionEvent.getX() - (getContainerViewWidth() / 2));
                float fM2 = TextureRenderer$$ExternalSyntheticOutline0.m(3.0f, this.scale, (motionEvent.getY() - (getContainerViewHeight() / 2)) - this.translationY, motionEvent.getY() - (getContainerViewHeight() / 2));
                updateMinMax(3.0f);
                float f2 = this.minX;
                if (fM < f2) {
                    fM = f2;
    ...
    public void openMedia(MessageObject messageObject, PhotoViewer.PhotoViewerProvider photoViewerProvider, Runnable runnable, Runnable runnable2) {
        PhotoViewer.PlaceProviderObject placeForPhoto;
        char c;
        ...
        float f3 = rectF.left;
        this.translationX = ((fWidth / 2.0f) + (f2 + f3)) - (i / 2);
        this.translationY = ((fHeight / 2.0f) + (placeForPhoto.viewY + rectF.top)) - (i2 / 2);
        ...
        float height = (((placeForPhoto.viewY + rectF.top) + ((int) fHeight)) - (placeForPhoto.parentView.getHeight() + iArr3[c])) + placeForPhoto.clipBottomAddition;
        ...
        if (document != null) {
            ...
            if (MessageObject.isGifDocument(document)) {
                ...
                f = 1.0f;
                this.centerImage.setImage((str2 == null || !messageObject.attachPathExists) ? ImageLocation.getForDocument(document) : ImageLocation.getForPath(str2), (String) null, this.currentThumb != null ? new BitmapDrawable(this.currentThumb.bitmap) : null, -1L, (String) null, messageObject, 1);
            } else {
                placeProviderObject = placeForPhoto;
                str = "window";
                f = 1.0f;
        ...
        if (this.ignoreDelete) {
            ...
            this.secretDeleteTimer.setOnClickListener(new PollItemMenu$$ExternalSyntheticLambda14(this, 9));
        } else {
        ...
        VideoPlayerControlFrameLayout videoPlayerControlFrameLayout = this.seekbarContainer;
        int i5 = 1;
        ObjectAnimator objectAnimatorOfFloat5 = ObjectAnimator.ofFloat(videoPlayerControlFrameLayout, videoPlayerControlFrameLayout.SEEKBAR_ALPHA, f);
        VideoPlayerControlFrameLayout videoPlayerControlFrameLayout2 = this.seekbarContainer;
        if (!this.isVideo) {
            f = 0.0f;
        }
        ...
        this.photoAnimationInProgress = 3;
        this.photoAnimationEndRunnable = new TodoItemMenu$$ExternalSyntheticLambda11(this, runnable, messageObject, i5);
        this.imageMoveAnimation.setDuration(250L);
        ...
        this.photoBackgroundDrawable.drawRunnable = new SecretMediaViewer$$ExternalSyntheticLambda5(this, placeProviderObject, 0);
        this.imageMoveAnimation.start();
    }
    ...
    public void setParentActivity(final Activity activity) {
        ...
        this.containerView.setOnApplyWindowInsetsListener(new SecretMediaViewer$$ExternalSyntheticLambda0(this, 0));
