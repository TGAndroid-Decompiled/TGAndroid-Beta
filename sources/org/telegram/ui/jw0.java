...
public final class jw0 extends org.telegram.ui.Cells.t1 {
    ...
    public final void Y1(Canvas canvas) {
        ...
        this.f23030k6 = (-AndroidUtilities.dp(7.0f)) * this.Ke.f38535y;
        super.Y1(canvas);
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        rectF.top = AndroidUtilities.lerp(dp, f7, lw0Var.f38535y) + f10;
        float f11 = rectF.bottom;
        boolean z10 = lw0Var.V;
        float dp2 = AndroidUtilities.dp(3.0f);
        if (!z10) {
            dp2 = AndroidUtilities.lerp(dp2, 0.0f, lw0Var.f38535y);
        }
        ...
        Paint paint = this.Ge;
        paint.setColor(0);
        paint.setShadowLayer(AndroidUtilities.dp(2.0f), 0.0f, AndroidUtilities.dp(0.66f), org.telegram.ui.ActionBar.j6.l1(lw0Var.f38535y * 0.2f, -16777216));
