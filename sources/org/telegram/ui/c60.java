...
public final class c60 extends org.telegram.ui.Components.vl0 {
    ...
    public final void E() {
        ...
        if (call != null && !call.isScheduled() && !i60Var.f34402s0) {
            this.f32557w = -1;
            this.f32558x = -1;
            this.f32559y = -1;
            this.I = -1;
            ...
            boolean z10 = false;
            this.F = 0;
            if (i60Var.f34329a1.participants.h(MessageObject.getPeerId(i60Var.A0)) >= 0) {
                z10 = true;
            }
            this.L = z10;
            if (i60Var.o1()) {
            ...
            if (!arrayList.isEmpty() && i60Var.Q0() && i60Var.f34329a1.call.participants_count > i60Var.d.getMessagesController().groupCallVideoMaxParticipants) {
                int i13 = this.F;
                this.F = i13 + 1;
                this.J = i13;
            }
            this.d = this.F;
            if (!i60Var.r1()) {
                this.F = i60Var.f34329a1.visibleParticipants.size() + this.F;
            }
            this.e = this.F;
            if (!i60Var.f34329a1.invitedUsers.isEmpty() && !i60Var.r1()) {
                int i14 = this.F;
                this.f32553f = i14;
                int size2 = i60Var.f34329a1.invitedUsers.size() + i14;
                this.F = size2;
                this.h = size2;
            } else {
                this.f32553f = -1;
            ...
            if (!i60Var.f34329a1.shadyJoinParticipants.isEmpty() && !i60Var.r1()) {
                int i15 = this.F;
                this.f32554n = i15;
                int size3 = i60Var.f34329a1.shadyJoinParticipants.size() + i15;
                this.F = size3;
                this.f32555r = size3;
            } else {
                this.f32554n = -1;
            ...
            if (!i60Var.f34329a1.shadyLeftParticipants.isEmpty() && !i60Var.r1()) {
                int i16 = this.F;
                this.f32556s = i16;
                int size4 = i60Var.f34329a1.shadyLeftParticipants.size() + i16;
                this.F = size4;
                this.v = size4;
            } else {
                this.f32556s = -1;
    ...
    public final int j(int i10) {
        ...
        if (i10 != this.f32557w && i10 != this.f32558x && i10 != this.f32559y) {
            if (i10 == this.I) {
                return 5;
            }
        ...
        if (i10 != 0) {
            if (i10 != 1) {
                if (i10 != 2) {
                        ...
                        if (i10 != 5) {
                            if (i10 != 6) {
                                if (i10 != 7) {
                                    ...
                                    if (i60Var.f34388p0 == null) {
                                        i60Var.f34388p0 = new t50();
                                    }
                                    s50Var = new s50(context, i60Var.f34388p0);
                                }
                            } else {
                    ...
                    frameLayout.f21758n = org.telegram.ui.ActionBar.j6.f19329rg;
                    ...
                    j5Var2.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, frameLayout.f21758n, false));
                    ...
                    imageView.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.w0(null, frameLayout.f21758n, false), PorterDuff.Mode.MULTIPLY));
                    if (!LocaleController.isRTL) {
                        i17 = 5;
                    }
            ...
            frameLayout2.h = 67;
            frameLayout2.f21810n = 18;
            Paint paint2 = new Paint();
            frameLayout2.f21811r = paint2;
            paint2.setColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19125gg, false));
            frameLayout2.e = 23;
            org.telegram.ui.ActionBar.j5 j5Var3 = new org.telegram.ui.ActionBar.j5(context);
            frameLayout2.f21806a = j5Var3;
            ...
            frameLayout2.f21808c = imageView2;
            ImageView.ScaleType scaleType = ImageView.ScaleType.CENTER;
            imageView2.setScaleType(scaleType);
            imageView2.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19227m6, false), PorterDuff.Mode.MULTIPLY));
    ...
    public final void y(s4.c1 c1Var) {
        ...
        if (i12 == 1) {
            ...
            w3Var.a(i10, org.telegram.ui.ActionBar.j6.w0(null, i10, false));
            if (c1Var.b() != this.F - 2) {
                z10 = true;
            }
