...
public final class c60 extends org.telegram.ui.Components.kl0 {
    ...
    public final void E() {
        ...
        TLRPC.Chat chat2;
        i60 i60Var = this.M;
        ArrayList arrayList = i60Var.f34473q0;
        ChatObject.Call call = i60Var.f34410a1;
        if (call != null && !call.isScheduled() && !i60Var.f34483s0) {
            this.f32682w = -1;
            this.f32683x = -1;
            this.f32684y = -1;
            this.I = -1;
            ...
            boolean z10 = false;
            this.F = 0;
            if (i60Var.f34410a1.participants.h(MessageObject.getPeerId(i60Var.A0)) >= 0) {
                z10 = true;
            }
            this.L = z10;
            if (i60Var.o1()) {
            ...
            if (!arrayList.isEmpty() && i60Var.Q0() && i60Var.f34410a1.call.participants_count > i60Var.d.getMessagesController().groupCallVideoMaxParticipants) {
                int i13 = this.F;
                this.F = i13 + 1;
                this.J = i13;
            }
            this.d = this.F;
            if (!i60Var.r1()) {
                this.F = i60Var.f34410a1.visibleParticipants.size() + this.F;
            }
            this.e = this.F;
            if (!i60Var.f34410a1.invitedUsers.isEmpty() && !i60Var.r1()) {
                int i14 = this.F;
                this.f32678f = i14;
                int size2 = i60Var.f34410a1.invitedUsers.size() + i14;
                this.F = size2;
                this.h = size2;
            } else {
                this.f32678f = -1;
            ...
            if (!i60Var.f34410a1.shadyJoinParticipants.isEmpty() && !i60Var.r1()) {
                int i15 = this.F;
                this.f32679n = i15;
                int size3 = i60Var.f34410a1.shadyJoinParticipants.size() + i15;
                this.F = size3;
                this.f32680r = size3;
            } else {
                this.f32679n = -1;
            ...
            if (!i60Var.f34410a1.shadyLeftParticipants.isEmpty() && !i60Var.r1()) {
                int i16 = this.F;
                this.f32681s = i16;
                int size4 = i60Var.f34410a1.shadyLeftParticipants.size() + i16;
                this.F = size4;
                this.v = size4;
            } else {
                this.f32681s = -1;
    ...
    public final int j(int i10) {
        ...
        if (i10 != this.f32682w && i10 != this.f32683x && i10 != this.f32684y) {
            if (i10 == this.I) {
                return 5;
            }
        ...
        if (i10 != 0) {
            if (i10 != 1) {
                if (i10 != 2) {
                        ...
                        if (i10 != 5) {
                            if (i10 != 6) {
                                if (i10 != 7) {
                                    ...
                                    if (i60Var.f34469p0 == null) {
                                        i60Var.f34469p0 = new t50();
                                    }
                                    s50Var = new s50(context, i60Var.f34469p0);
                                }
                            } else {
                    ...
                    frameLayout.f21468n = org.telegram.ui.ActionBar.i6.f19102rg;
                    ...
                    j5Var2.setTextColor(org.telegram.ui.ActionBar.i6.w0(null, frameLayout.f21468n, false));
                    ...
                    imageView.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.i6.w0(null, frameLayout.f21468n, false), PorterDuff.Mode.MULTIPLY));
                    if (!LocaleController.isRTL) {
                        i17 = 5;
                    }
            ...
            frameLayout2.h = 67;
            frameLayout2.f21571n = 18;
            Paint paint2 = new Paint();
            frameLayout2.f21572r = paint2;
            paint2.setColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18899gg, false));
            frameLayout2.e = 23;
            org.telegram.ui.ActionBar.j5 j5Var3 = new org.telegram.ui.ActionBar.j5(context);
            frameLayout2.f21567a = j5Var3;
            ...
            frameLayout2.f21569c = imageView2;
            ImageView.ScaleType scaleType = ImageView.ScaleType.CENTER;
            imageView2.setScaleType(scaleType);
            imageView2.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f19001m6, false), PorterDuff.Mode.MULTIPLY));
    ...
    public final void y(s4.c1 c1Var) {
        ...
        if (i12 == 1) {
            ...
            d4Var.f(i11, org.telegram.ui.ActionBar.i6.w0(null, i11, false));
            if (c1Var.b() != this.F - 2) {
                z10 = true;
            }
            ...
            v3Var.a(i10, org.telegram.ui.ActionBar.i6.w0(null, i10, false));
            if (c1Var.b() != this.F - 2) {
                z10 = true;
            }
