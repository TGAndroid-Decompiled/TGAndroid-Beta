...
public final class bf0 implements org.telegram.ui.ActionBar.a2 {
    ...
    public final void g(org.telegram.ui.ActionBar.b2 b2Var, int i10) {
        switch (this.f34814a) {
            case 0:
                hf0 hf0Var = this.f34815b;
                hf0Var.c(true);
                hf0Var.O.u1(0, true, null, true);
                hf0Var.o();
                return;
            case 1:
                hf0 hf0Var2 = this.f34815b;
                hf0Var2.O.f42407p0.popup = false;
                hf0Var2.h(null);
                return;
            case 2:
                hf0 hf0Var3 = this.f34815b;
                wg0 wg0Var = hf0Var3.O;
                AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(wg0Var.getParentActivity());
                alertDialog$Builder.f20226a.R = LocaleController.getString("TermsOfService", R.string.TermsOfService);
                alertDialog$Builder.f20226a.T = LocaleController.getString("TosDecline", R.string.TosDecline);
                ...
                wg0Var.showDialog(alertDialog$Builder.f20226a);
                return;
            case 3:
                hf0 hf0Var4 = this.f34815b;
                hf0Var4.O.f42407p0.popup = false;
                hf0Var4.h(null);
                return;
            default:
                hf0 hf0Var5 = this.f34815b;
                hf0Var5.c(true);
