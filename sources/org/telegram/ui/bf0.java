...
public final class bf0 extends org.telegram.ui.Components.fw0 implements org.telegram.ui.Components.u40 {
    ...
    public final qg0 O;
    public final org.telegram.ui.Components.jd0 f32405a;
    public final org.telegram.ui.Components.jd0 f32406b;
    public final EditTextBoldCursor f32407c;
    public final EditTextBoldCursor d;
    public final ai.y5 e;
    public final org.telegram.ui.Components.h9 f32408f;
    public final ci.r6 h;
    public final id f32409n;
    public final jd f32410r;
    public AnimatorSet f32411s;
    public final TextView v;
    public final TextView f32412w;
    public final TextView f32413x;
    public final TextView f32414y;
    ...
    public bf0(qg0 qg0Var, Context context) {
        ...
        this.f32407c = editTextBoldCursor;
        ...
        editTextBoldCursor.setOnFocusChangeListener(new View.OnFocusChangeListener(this) {
            ...
            public final void onFocusChange(View view, boolean z10) {
                ...
                switch (r2) {
                    case 0:
                        org.telegram.ui.Components.jd0 jd0Var2 = this.f39910b.f32405a;
                        if (z10) {
                            f10 = 1.0f;
                        } else {
                            f10 = 0.0f;
                        ...
                        return;
                    default:
                        org.telegram.ui.Components.jd0 jd0Var3 = this.f39910b.f32406b;
                        if (z10) {
                            f11 = 1.0f;
                        } else {
                            f11 = 0.0f;
        ...
        editTextBoldCursor2.setOnFocusChangeListener(new View.OnFocusChangeListener(this) {
            ...
            public final void onFocusChange(View view, boolean z10) {
                ...
                switch (r2) {
                    case 0:
                        org.telegram.ui.Components.jd0 jd0Var22 = this.f39910b.f32405a;
                        if (z10) {
                            f10 = 1.0f;
                        } else {
                            f10 = 0.0f;
    ...
    public final void h(String str) {
        ...
        qg0 qg0Var = this.O;
        TLRPC.TL_help_termsOfService tL_help_termsOfService = qg0Var.f36904p0;
        if (tL_help_termsOfService != null && tL_help_termsOfService.popup) {
            q(true);
            return;
        }
        EditTextBoldCursor editTextBoldCursor = this.f32407c;
        if (editTextBoldCursor.length() == 0) {
            qg0.U0(qg0Var, this.f32405a, true);
            return;
        }
        this.H = true;
    ...
    @Override
    public final void j() {
        TextView textView = this.f32413x;
        if (textView != null) {
            if (this.O.f36893f) {
        ...
        AndroidUtilities.runOnUIThread(new od0(this, 3), qg0.f36884t0);
    }
    ...
    public final void k(Bundle bundle) {
        ...
        try {
            ...
            if (string != null && (decode = Base64.decode(string, 0)) != null) {
                ...
                this.O.f36904p0 = TLRPC.TL_help_termsOfService.TLdeserialize(serializedData, serializedData.readInt32(false), false);
    ...
    public final void l(Bundle bundle) {
        String obj = this.f32407c.getText().toString();
        if (obj.length() != 0) {
        ...
        if (tL_help_termsOfService != null) {
            ...
            qg0Var.f36904p0.serializeToStream(serializedData);
    ...
    @Override
    public final void n() {
        this.f32408f.invalidateSelf();
        int i10 = org.telegram.ui.ActionBar.h6.G6;
        this.f32414y.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, i10, false));
        ...
        this.f32412w.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.q6, false));
    ...
    public final void o() {
        this.f32413x.animate().alpha(0.0f).setDuration(150L).setStartDelay(0L).setInterpolator(AndroidUtilities.accelerateInterpolator).start();
    }

    public final void p(boolean z10) {
        id idVar = this.f32409n;
        if (idVar == null) {
            return;
        }
        AnimatorSet animatorSet = this.f32411s;
        if (animatorSet != null) {
            animatorSet.cancel();
            this.f32411s = null;
        }
        jd jdVar = this.f32410r;
        if (z10) {
            this.f32411s = new AnimatorSet();
            idVar.setVisibility(0);
            AnimatorSet animatorSet2 = this.f32411s;
            Property property = View.ALPHA;
            animatorSet2.playTogether(ObjectAnimator.ofFloat(idVar, property, 1.0f), ObjectAnimator.ofFloat(jdVar, property, 0.0f));
            this.f32411s.setDuration(180L);
            this.f32411s.addListener(new org.telegram.ui.Components.q81(this, 26));
            this.f32411s.start();
            return;
        }
        idVar.setAlpha(1.0f);
    ...
    public final void q(boolean z10) {
        ...
        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(qg0Var.f36904p0.text);
        MessageObject.addEntitiesToText(spannableStringBuilder, qg0Var.f36904p0.entities, false, false, false, false);
