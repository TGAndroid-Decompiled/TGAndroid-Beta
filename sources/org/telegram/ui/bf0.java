...
public final class bf0 extends org.telegram.ui.Components.gw0 implements org.telegram.ui.Components.v40 {
    public String E;
    public String F;
    public Bundle G;
    public boolean H;
    public final org.telegram.ui.Components.jj0 I;
    public final org.telegram.ui.Components.jj0 J;
    public boolean K;
    public final org.telegram.ui.Components.w40 L;
    public TLRPC.FileLocation M;
    public TLRPC.FileLocation N;
    public final qg0 O;
    public final org.telegram.ui.Components.kd0 f32404a;
    public final org.telegram.ui.Components.kd0 f32405b;
    public final EditTextBoldCursor f32406c;
    public final EditTextBoldCursor d;
    public final ai.y5 e;
    public final org.telegram.ui.Components.h9 f32407f;
    public final ci.r6 h;
    public final id f32408n;
    public final jd f32409r;
    public AnimatorSet f32410s;
    public final TextView v;
    public final TextView f32411w;
    public final TextView f32412x;
    public final TextView f32413y;
    ...
    public bf0(qg0 qg0Var, Context context) {
        ...
        r6Var.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view) {
                ...
                switch (r2) {
                    case 0:
                        bf0 bf0Var = this.f38971b;
                        id idVar = bf0Var.f32408n;
                        org.telegram.ui.Components.jj0 jj0Var = bf0Var.I;
                        org.telegram.ui.Components.w40 w40Var2 = bf0Var.L;
                        if (bf0Var.M != null) {
                            z10 = true;
                        } else {
                            z10 = false;
                        }
                        w40Var2.o(z10, new od0(bf0Var, 1), new r5(bf0Var, 8), 0);
                        bf0Var.K = false;
        ...
        org.telegram.ui.Components.jj0 jj0Var = new org.telegram.ui.Components.jj0(R.raw.camera, AndroidUtilities.dp(70.0f), AndroidUtilities.dp(70.0f), false, null);
        this.I = jj0Var;
        this.J = new org.telegram.ui.Components.jj0(R.raw.camera_wait, AndroidUtilities.dp(70.0f), AndroidUtilities.dp(70.0f), false, null);
        ...
        this.f32406c = editTextBoldCursor;
        ...
        editTextBoldCursor.setOnFocusChangeListener(new View.OnFocusChangeListener(this) {
            ...
            public final void onFocusChange(View view, boolean z10) {
                ...
                switch (r2) {
                    case 0:
                        org.telegram.ui.Components.kd0 kd0Var2 = this.f39909b.f32404a;
                        if (z10) {
                            f10 = 1.0f;
                        } else {
                            f10 = 0.0f;
                        ...
                        return;
                    default:
                        org.telegram.ui.Components.kd0 kd0Var3 = this.f39909b.f32405b;
                        if (z10) {
                            f11 = 1.0f;
                        } else {
                            f11 = 0.0f;
        ...
        editTextBoldCursor2.setOnFocusChangeListener(new View.OnFocusChangeListener(this) {
            ...
            public final void onFocusChange(View view, boolean z10) {
                ...
                switch (r2) {
                    case 0:
                        org.telegram.ui.Components.kd0 kd0Var22 = this.f39909b.f32404a;
                        if (z10) {
                            f10 = 1.0f;
                        } else {
                            f10 = 0.0f;
    ...
    public final boolean c(boolean z10) {
        ...
        if (!z10) {
            ...
            alertDialog$Builder.f18661a.T = LocaleController.getString("AreYouSureRegistration", R.string.AreYouSureRegistration);
    ...
    public final void h(String str) {
        ...
        qg0 qg0Var = this.O;
        TLRPC.TL_help_termsOfService tL_help_termsOfService = qg0Var.f36903p0;
        if (tL_help_termsOfService != null && tL_help_termsOfService.popup) {
            q(true);
            return;
        }
        EditTextBoldCursor editTextBoldCursor = this.f32406c;
        if (editTextBoldCursor.length() == 0) {
            qg0.U0(qg0Var, this.f32404a, true);
            return;
        }
        this.H = true;
    ...
    @Override
    public final void j() {
        TextView textView = this.f32412x;
        if (textView != null) {
            if (this.O.f36892f) {
        ...
        AndroidUtilities.runOnUIThread(new od0(this, 3), qg0.f36883t0);
    }
    ...
    public final void k(Bundle bundle) {
        ...
        try {
            ...
            if (string != null && (decode = Base64.decode(string, 0)) != null) {
                ...
                this.O.f36903p0 = TLRPC.TL_help_termsOfService.TLdeserialize(serializedData, serializedData.readInt32(false), false);
    ...
    public final void l(Bundle bundle) {
        String obj = this.f32406c.getText().toString();
        if (obj.length() != 0) {
        ...
        if (tL_help_termsOfService != null) {
            ...
            qg0Var.f36903p0.serializeToStream(serializedData);
    ...
    @Override
    public final void n() {
        this.f32407f.invalidateSelf();
        int i10 = org.telegram.ui.ActionBar.h6.G6;
        this.f32413y.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, i10, false));
        ...
        int i12 = org.telegram.ui.ActionBar.h6.f19204l6;
        ...
        this.f32411w.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.q6, false));
    ...
    public final void o() {
        this.f32412x.animate().alpha(0.0f).setDuration(150L).setStartDelay(0L).setInterpolator(AndroidUtilities.accelerateInterpolator).start();
    }

    public final void p(boolean z10) {
        id idVar = this.f32408n;
        if (idVar == null) {
            return;
        }
        AnimatorSet animatorSet = this.f32410s;
        if (animatorSet != null) {
            animatorSet.cancel();
            this.f32410s = null;
        }
        jd jdVar = this.f32409r;
        if (z10) {
            this.f32410s = new AnimatorSet();
            idVar.setVisibility(0);
            AnimatorSet animatorSet2 = this.f32410s;
            Property property = View.ALPHA;
            animatorSet2.playTogether(ObjectAnimator.ofFloat(idVar, property, 1.0f), ObjectAnimator.ofFloat(jdVar, property, 0.0f));
            this.f32410s.setDuration(180L);
            this.f32410s.addListener(new org.telegram.ui.Components.r81(this, 26));
            this.f32410s.start();
            return;
        }
        idVar.setAlpha(1.0f);
    ...
    public final void q(boolean z10) {
        ...
        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(qg0Var.f36903p0.text);
        MessageObject.addEntitiesToText(spannableStringBuilder, qg0Var.f36903p0.entities, false, false, false, false);
