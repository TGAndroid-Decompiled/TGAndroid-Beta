...
public final class uy extends s4.v {
    ...
    public final long d(RecyclerView recyclerView, int i10, float f7, float f10) {
        ...
        if (i10 == 8 && (r2Var = (wyVar = this.h).X0) != null) {
            AndroidUtilities.runOnUIThread(new kh(1, r2Var), this.f38247g.f38535x.e);
            wyVar.X0 = null;
        }
    ...
    public final boolean n(RecyclerView recyclerView, s4.c1 c1Var, s4.c1 c1Var2) {
        ...
        int i10;
        wy wyVar = this.h;
        ArrayList arrayList = wyVar.f39201a1;
        ...
        if (view instanceof org.telegram.ui.Cells.r2) {
            ...
            if (dialog != null && wyVar.g4(dialog) && !DialogObject.isFolderDialogId(dialogId)) {
                int b10 = c1Var.b();
                int b11 = c1Var2.b();
                vy vyVar = this.f38247g;
                if (vyVar.f38527a.getItemAnimator() == null) {
                    vyVar.f38527a.setItemAnimator(vyVar.f38535x);
                }
                dx dxVar = vyVar.d;
                wy wyVar2 = dxVar.R;
                int i11 = dxVar.F;
                ...
                dxVar.W(null);
                int i15 = wyVar.f39221e0[0].f38533s;
                if (i15 != 7) {
                    i10 = 8;
                    if (i15 != 8) {
                        wyVar.Z0 = true;
                ...
                if (wyVar.f39221e0[0].f38533s == i10) {
                    c11 = 1;
                }
    ...
    public final void p(s4.c1 c1Var, int i10) {
        if (c1Var != null) {
            this.f38247g.f38527a.e1(false);
        }
        this.d = c1Var;
        if (c1Var != null) {
            View view = c1Var.f42702a;
            if (view instanceof org.telegram.ui.Cells.r2) {
                ((org.telegram.ui.Cells.r2) view).f20779w = false;
            }
        }
    }
    ...
    public final void q(s4.c1 c1Var) {
        ...
        if (c1Var != null) {
            ...
            if (Utilities.random.nextInt(1000) == 1) {
                if (wyVar.V0 == null) {
                    sy syVar2 = vyVar.f38527a;
                    ?? obj = new Object();
                    obj.f22380a = new Paint(1);
                    Paint paint = new Paint(1);
                    obj.f22381b = paint;
                    obj.e = 0L;
                    obj.f22383f = new RectF();
