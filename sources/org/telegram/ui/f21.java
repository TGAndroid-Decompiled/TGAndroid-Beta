...
public final class f21 extends FrameLayout {
    ...
    public final ImageView f33456c;
    public SharedConfig.ProxyInfo d;
    public Drawable e;
    public final org.telegram.ui.Components.np f33457f;
    public boolean h;
    public boolean f33458n;
    public int f33459r;
    public final ProxyListActivity f33460s;
    ...
    public f21(ProxyListActivity proxyListActivity, Context context) {
        ...
        int i16;
        int i17;
        this.f33460s = proxyListActivity;
    ...
    public final void a(boolean z10, boolean z11) {
        ...
        if (!z11) {
            ...
            this.f33454a.setTranslationX(f10);
            this.f33455b.setTranslationX(f10);
            ImageView imageView = this.f33456c;
            ...
            float f12 = dp2 + f10;
            org.telegram.ui.Components.np npVar = this.f33457f;
    ...
    public void setChecked(boolean z10) {
        TextView textView = this.f33455b;
        if (z10) {
            if (this.e == null) {
            ...
            if (drawable != null) {
                drawable.setColorFilter(new PorterDuffColorFilter(this.f33459r, PorterDuff.Mode.MULTIPLY));
            }
            if (LocaleController.isRTL) {
    ...
    public void setProxy(SharedConfig.ProxyInfo proxyInfo) {
        String str;
        if (proxyInfo.settings.f15736a == 3) {
            str = a4.a.s(new StringBuilder(), proxyInfo.settings.f15737b, " (WEB)");
        } else {
            str = proxyInfo.settings.f15737b + ":" + proxyInfo.settings.f15738c;
        }
        this.f33454a.setText(str);
        this.d = proxyInfo;
    }

    public void setValue(CharSequence charSequence) {
        this.f33455b.setText(charSequence);
    }
}
