...
public final class f21 extends FrameLayout {
    ...
    public Drawable e;
    public final org.telegram.ui.Components.np f33413f;
    public boolean h;
    public boolean f33414n;
    public int f33415r;
    public final ProxyListActivity f33416s;
    ...
    public f21(ProxyListActivity proxyListActivity, Context context) {
        ...
        int i16;
        int i17;
        this.f33416s = proxyListActivity;
        TextView textView = new TextView(context);
        this.f33410a = textView;
        ...
        this.f33413f = npVar;
        npVar.b(org.telegram.ui.ActionBar.j6.f19153i7, org.telegram.ui.ActionBar.j6.f19117g7, org.telegram.ui.ActionBar.j6.f19191k7);
    ...
    public final void a(boolean z10, boolean z11) {
        ...
        if (!z11) {
            ...
            this.f33410a.setTranslationX(f10);
            this.f33411b.setTranslationX(f10);
            ImageView imageView = this.f33412c;
            ...
            float f12 = dp2 + f10;
            org.telegram.ui.Components.np npVar = this.f33413f;
    ...
    public final void onMeasure(int i10, int i11) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i10), 1073741824), org.telegram.messenger.wh.C(64.0f, 1, 1073741824));
    }

    public void setChecked(boolean z10) {
        TextView textView = this.f33411b;
        if (z10) {
            if (this.e == null) {
            ...
            if (drawable != null) {
                drawable.setColorFilter(new PorterDuffColorFilter(this.f33415r, PorterDuff.Mode.MULTIPLY));
            }
            if (LocaleController.isRTL) {
    ...
    public void setProxy(SharedConfig.ProxyInfo proxyInfo) {
        String str;
        if (proxyInfo.settings.f15704a == 3) {
            str = a4.a.s(new StringBuilder(), proxyInfo.settings.f15705b, " (WEB)");
        } else {
            str = proxyInfo.settings.f15705b + ":" + proxyInfo.settings.f15706c;
        }
        this.f33410a.setText(str);
        this.d = proxyInfo;
    }

    public void setValue(CharSequence charSequence) {
        this.f33411b.setText(charSequence);
    }
}
