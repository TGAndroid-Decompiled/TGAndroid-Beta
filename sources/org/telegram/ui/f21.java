...
public final class f21 extends org.telegram.ui.ActionBar.j {
    ...
    public final ProxyListActivity f33522b;

    public f21(ProxyListActivity proxyListActivity, Context context) {
        this.f33522b = proxyListActivity;
    ...
    public final void b(int i10) {
        ...
        StringBuilder sb2;
        boolean z10;
        ProxyListActivity proxyListActivity = this.f33522b;
        ...
        if (i10 != -1) {
            ...
            if (i10 != 0) {
                if (i10 == 1) {
                    ...
                    this.f33521a.startActivity(createChooser);
            ...
            alertDialog$Builder.f18446a.R = LocaleController.getString(R.string.DeleteProxyTitle);
