...
public final class f21 extends FrameLayout {
    public final TextView f33479a;
    public final TextView f33480b;
    public final ImageView f33481c;
    public SharedConfig.ProxyInfo d;
    public Drawable e;
    public final org.telegram.ui.Components.np f33482f;
    public boolean h;
    public boolean f33483n;
    public int f33484r;
    public final ProxyListActivity f33485s;
    ...
    public f21(ProxyListActivity proxyListActivity, Context context) {
        ...
        int i16;
        int i17;
        this.f33485s = proxyListActivity;
        TextView textView = new TextView(context);
        this.f33479a = textView;
    ...
    public final void a(boolean z10, boolean z11) {
        ...
        if (!z11) {
            ...
            this.f33479a.setTranslationX(f10);
            this.f33480b.setTranslationX(f10);
            ImageView imageView = this.f33481c;
            ...
            float f12 = dp2 + f10;
            org.telegram.ui.Components.np npVar = this.f33482f;
    ...
    public final void onMeasure(int i10, int i11) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i10), 1073741824), org.telegram.messenger.rk.C(64.0f, 1, 1073741824));
    }

    public void setChecked(boolean z10) {
        TextView textView = this.f33480b;
        if (z10) {
            if (this.e == null) {
            ...
            if (drawable != null) {
                drawable.setColorFilter(new PorterDuffColorFilter(this.f33484r, PorterDuff.Mode.MULTIPLY));
            }
            if (LocaleController.isRTL) {
    ...
    public void setProxy(SharedConfig.ProxyInfo proxyInfo) {
        String str;
        if (proxyInfo.settings.f15751a == 3) {
            str = a4.a.s(new StringBuilder(), proxyInfo.settings.f15752b, " (WEB)");
        } else {
            str = proxyInfo.settings.f15752b + ":" + proxyInfo.settings.f15753c;
        }
        this.f33479a.setText(str);
        this.d = proxyInfo;
    }

    public void setValue(CharSequence charSequence) {
        this.f33480b.setText(charSequence);
    }
}
