...
public final class o5 extends og.b {
    ...
    public final boolean D(s4.c1 c1Var) {
        return ((u5) this.d.f38347a0.get(c1Var.b())).f15534b;
    }

    @Override
    public final int h() {
        return this.d.f38347a0.size();
    }

    @Override
    public final int j(int i10) {
        return ((u5) this.d.f38347a0.get(i10)).f15533a;
    }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        v5 v5Var = this.d;
        int i14 = v5Var.Q;
        TLRPC.Chat chat = v5Var.f38353g0;
        ArrayList arrayList = v5Var.f38347a0;
        ...
        if (i15 != 4 && i15 != 14 && i15 != 15) {
            if (i15 != 1 && i15 != 12 && i15 != 16) {
                if (i15 == 0) {
                    sa1 sa1Var = (sa1) view;
                    sa1Var.a(Integer.toString(v5Var.R.level), 0, null, LocaleController.getString(R.string.BoostsLevel2));
                    ...
                    if (tL_statsPercentValue != null) {
                        ...
                        if (d != 0.0d) {
                            ...
                            sa1Var.a(String.valueOf(v5Var.R.boosts), 2, null, LocaleController.getString(R.string.BoostsExisting));
                            ...
                            sa1Var.setPadding(AndroidUtilities.dp(23.0f), sa1Var.getPaddingTop(), AndroidUtilities.dp(23.0f), sa1Var.getPaddingBottom());
                            return;
                        }
                    }
                    if (ChatObject.isChannelAndNotMegaGroup(chat)) {
                    ...
                    bVar.d(user, ContactsController.formatName(user), formatString, !((u5) arrayList.get(i10)).f37858f);
                    bVar.setStatus(boost);
                    bVar.setAvatarPadding(5);
                    return;
                } else if (i15 == 6) {
                    org.telegram.ui.Cells.e9 e9Var = (org.telegram.ui.Cells.e9) view;
                    e9Var.setText(((u5) arrayList.get(i10)).f37857c);
                    ...
                    ((org.telegram.ui.Components.v80) view).setLink(((u5) arrayList.get(i10)).f37857c);
                    return;
                } else if (i15 == 11) {
                    u5 u5Var = (u5) arrayList.get(i10);
                    TL_stories.PrepaidGiveaway prepaidGiveaway = u5Var.e;
                    boolean z10 = u5Var.f37858f;
                    yg.c cVar = (yg.c) view;
                    ...
                    if (v5Var.T.getTag() == null || ((Integer) v5Var.T.getTag()).intValue() != Objects.hash(Integer.valueOf(v5Var.m0), Integer.valueOf(v5Var.f38358l0))) {
                        v5Var.T.setTag(Integer.valueOf(Objects.hash(Integer.valueOf(v5Var.m0), Integer.valueOf(v5Var.f38358l0))));
                        v5Var.T.g();
                        v5Var.T.a(0, LocaleController.formatPluralString("BoostingBoostsCount", v5Var.m0, new Object[0]), null);
                        if (MessagesController.getInstance(i14).giveawayGiftsPurchaseAvailable && (i11 = v5Var.f38358l0) > 0 && i11 != v5Var.m0) {
                            v5Var.T.a(1, LocaleController.formatPluralString("BoostingGiftsCount", i11, new Object[0]), null);
                        }
                        v5Var.T.setInitialTabId(v5Var.f38348b0);
                        v5Var.T.c();
                        return;
                    }
                    return;
            ...
            cVar2.setTitle(((u5) arrayList.get(i10)).f37857c);
            cVar2.c(false);
            if (c1Var.f42678f == 12) {
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        switch (i10) {
            case 0:
                x5Var = new sa1(v5Var.getParentActivity(), 2);
                break;
            case 1:
            case 16:
            ...
            case 8:
                ...
                if (ChatObject.isChannelAndNotMegaGroup(v5Var.f38353g0)) {
