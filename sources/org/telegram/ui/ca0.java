...
public final class ca0 implements Runnable {
    public final LaunchActivity f32705a;
    public final org.telegram.ui.ActionBar.o2 f32706b;
    public final int f32707c;
    public final TLRPC.User d;
    public final TLRPC.TL_messages_botApp e;
    public final AtomicBoolean f32708f;
    public final String h;
    public final boolean f32709n;
    public final boolean f32710r;
    public final boolean f32711s;
    ...
    public ca0(LaunchActivity launchActivity, org.telegram.ui.ActionBar.o2 o2Var, int i10, TLRPC.User user, TLRPC.TL_messages_botApp tL_messages_botApp, AtomicBoolean atomicBoolean, String str, boolean z10, boolean z11, boolean z12, boolean z13) {
        this.f32705a = launchActivity;
        this.f32706b = o2Var;
        this.f32707c = i10;
        this.d = user;
        this.e = tL_messages_botApp;
        this.f32708f = atomicBoolean;
        this.h = str;
        this.f32709n = z10;
        this.f32710r = z11;
        this.f32711s = z12;
    ...
    public final void run() {
        ...
        org.telegram.ui.ActionBar.o2 o2Var = this.f32706b;
        if (o2Var != null && LaunchActivity.C1) {
            LaunchActivity launchActivity = this.f32705a;
            if (!launchActivity.isFinishing() && !launchActivity.isDestroyed()) {
                ...
                boolean z10 = this.f32708f.get();
                int i10 = this.f32707c;
                String str = this.h;
                boolean z11 = this.f32709n;
                boolean z12 = this.f32710r;
                ...
                if (launchActivity.P() == null || launchActivity.P().k(b10) == null) {
                    ...
                    if (b3Var != null) {
                        b3Var.setWasOpenedByLinkIntent(this.f32711s);
                    }
                    k3Var.w(!z11);
                    if (z12) {
