...
public final class d4 extends FrameLayout {
    public final org.telegram.ui.Components.go0 f32995a;
    public final int f32996b;
    public final int f32997c;
    public int d;
    public final TextPaint e;
    public final h4 f32998f;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.d != size) {
            ...
            int i13 = this.f32996b;
            this.f32995a.setProgress((i12 - i13) / (this.f32997c - i13));
            this.d = size;
        }
    }
}
