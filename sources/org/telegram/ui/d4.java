...
public final class d4 extends FrameLayout {
    public final org.telegram.ui.Components.fo0 f32915a;
    public final int f32916b;
    public final int f32917c;
    public int d;
    public final TextPaint e;
    public final h4 f32918f;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.d != size) {
            ...
            int i13 = this.f32916b;
            this.f32915a.setProgress((i12 - i13) / (this.f32917c - i13));
            this.d = size;
        }
    }
}
