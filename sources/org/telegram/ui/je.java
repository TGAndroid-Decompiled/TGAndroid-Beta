...
public final class je extends LinearLayout {
    public final LinearLayout f34856a;
    public final LinearLayout[] f34857b;
    public final org.telegram.ui.Components.w5[] f34858c;
    public final TextView[] d;
    public final TextView e;
    public final DecimalFormat f34859f;

    public je(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context);
        this.f34857b = new LinearLayout[2];
        this.f34858c = new org.telegram.ui.Components.w5[2];
        ...
        for (int i10 = 0; i10 < 2; i10++) {
            this.f34857b[i10] = new LinearLayout(context);
            this.f34857b[i10].setOrientation(0);
            this.f34856a.addView(this.f34857b[i10], w7.x5.o(-1, -2, 1.0f, 119));
            this.f34858c[i10] = new org.telegram.ui.Components.w5(context);
            this.f34858c[i10].setTypeface(AndroidUtilities.bold());
            this.f34858c[i10].setTextSize(1, 16.0f);
            this.f34858c[i10].setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.G6, f6Var));
            this.f34857b[i10].addView(this.f34858c[i10], w7.x5.t(-2, -2, 80, 0, 0, 5, 0));
            this.d[i10] = new org.telegram.ui.Components.w5(context);
            this.d[i10].setTextSize(1, 11.5f);
            this.d[i10].setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19245y6, f6Var));
            this.f34857b[i10].addView(this.d[i10], w7.x5.q(-2, -2, 80));
        }
    ...
    public void set(ie ieVar) {
        ...
        while (i11 < 2) {
            ...
            LinearLayout[] linearLayoutArr = this.f34857b;
            if (i11 == 0 && !ieVar.f34539a) {
                linearLayoutArr[i11].setVisibility(8);
            } else if (i11 == 1 && !ieVar.f34543g) {
                linearLayoutArr[i11].setVisibility(8);
            } else {
                ...
                TextView[] textViewArr = this.f34858c;
                if (equalsIgnoreCase) {
                    String format = this.f34859f.format(ieVar.d / 1.0E9d);
                    ...
                    if ("XTR".equalsIgnoreCase(str)) {
                        if (i10 == 0) {
                            ...
                            spannableStringBuilder2.append((CharSequence) yh.y7.J0(ieVar.f34544i, 0.8f, ' '));
                        }
                ...
                textView.setText("≈" + BillingController.getInstance().formatCurrency(j3, ieVar.f34542f));
                i11 = i10 + 1;
            }
            i10 = i11;
            i11 = i10 + 1;
