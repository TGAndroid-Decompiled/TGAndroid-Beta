    ...
    public final void f(Canvas canvas, RectF rectF) {
        ...
        switch (this.f33970a) {
            case 0:
                ...
                if (f7 > 0.0f) {
                    canvas.drawColor(org.telegram.ui.ActionBar.j6.l1(f7 * 0.85f, boVar.getThemedColor(org.telegram.ui.ActionBar.j6.f18863d6)));
                }
                gh.d.b(new gg(tmVar2, 1), canvas, rectF, boVar.f32506x0, tmVar3, i10);
                ...
                if (i1Var != null && i1Var.getVisibility() == 0) {
                    int childCount = boVar.f32416q1.getChildCount();
                    for (int i12 = 0; i12 < childCount; i12++) {
                        View childAt = boVar.f32416q1.getChildAt(i12);
                        if ((childAt instanceof eo) && childAt.getVisibility() == 0) {
                            eo eoVar = (eo) childAt;
                            co coVar = eoVar.f33448a;
                            tm tmVar4 = coVar.X0;
            ...
            default:
                ...
                bo boVar3 = this.f33971b.J0;
                if (boVar3.f32506x0.a1()) {
                    boVar3.f32506x0.f(canvas, rectF);
                    return;
                }
                boVar3.f32506x0.x1(canvas, rectF);
                for (int i13 = 0; i13 < boVar3.f32506x0.getChildCount(); i13++) {
                    View childAt2 = boVar3.f32506x0.getChildAt(i13);
                    if (!bo.d2(boVar3, childAt2, rectF)) {
                        if (childAt2 instanceof org.telegram.ui.Cells.t1) {
                            ...
                            canvas.restore();
                            boVar3.f32506x0.drawChild(canvas, childAt2, uptimeMillis);
                            if (t1Var.U2()) {
                                canvas.save();
                ...
                boVar3.f32506x0.y1(canvas, rectF);
                return;
        }
    }
}
