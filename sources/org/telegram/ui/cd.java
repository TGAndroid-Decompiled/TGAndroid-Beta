...
public final class cd implements Runnable {
    ...
    public final TLRPC.PhotoSize f35767b;
    public final TLRPC.InputFile f35768c;
    public final TLRPC.InputFile d;
    public final TLRPC.VideoSize f35769e;
    public final TLRPC.PhotoSize f35770f;
    public final double h;
    public final String f35771n;
    public final org.telegram.ui.Components.x40 f35772r;
    ...
    public cd(org.telegram.ui.ActionBar.p2 p2Var, TLRPC.InputFile inputFile, TLRPC.InputFile inputFile2, TLRPC.VideoSize videoSize, String str, double d, TLRPC.PhotoSize photoSize, TLRPC.PhotoSize photoSize2, int i10) {
        this.f35766a = i10;
        this.f35772r = (org.telegram.ui.Components.x40) p2Var;
        this.f35768c = inputFile;
        this.d = inputFile2;
        this.f35769e = videoSize;
        this.f35771n = str;
        this.h = d;
        this.f35767b = photoSize;
        this.f35770f = photoSize2;
    }
    ...
    public final void run() {
        ...
        switch (this.f35766a) {
            case 0:
                nd ndVar = (nd) this.f35772r;
                TLRPC.InputFile inputFile = this.f35768c;
                TLRPC.InputFile inputFile2 = this.d;
                if (inputFile == null && inputFile2 == null) {
                    TLRPC.FileLocation fileLocation = this.f35767b.location;
                    ndVar.f39325x = fileLocation;
                    ndVar.f39326y = this.f35770f.location;
                    ndVar.f39304e.h(ImageLocation.getForLocal(fileLocation), "50_50", ndVar.f39321s, null);
                    ndVar.e0(true, false);
                    return;
                }
                ndVar.f39310i0 = inputFile;
                ndVar.f39311j0 = inputFile2;
                ndVar.f39312k0 = this.f35769e;
                ndVar.f39313l0 = this.f35771n;
                ndVar.m0 = this.h;
                if (ndVar.f39315n0) {
                    org.telegram.ui.ActionBar.d2 d2Var = ndVar.f39320r0;
                    if (d2Var != null) {
                        try {
                            d2Var.dismiss();
                            ndVar.f39320r0 = null;
                    ...
                    ndVar.f39297a.performClick();
                }
                ndVar.e0(false, true);
                ndVar.h.setImageDrawable(null);
                return;
            case 1:
                po poVar = (po) this.f35772r;
                TLRPC.PhotoSize photoSize = this.f35767b;
                TLRPC.FileLocation fileLocation2 = photoSize.location;
                poVar.f40081s0 = fileLocation2;
                TLRPC.InputFile inputFile3 = this.f35768c;
                TLRPC.InputFile inputFile4 = this.d;
                TLRPC.VideoSize videoSize = this.f35769e;
                if (inputFile3 == null && inputFile4 == null && videoSize == null) {
                    ...
                    org.telegram.ui.Components.z8 z8Var = poVar.f40078r;
                    Object obj = poVar.A0;
                    if (obj == null) {
                        obj = poVar.f40083u0;
                    }
                ...
                TLRPC.PhotoSize photoSize2 = this.f35770f;
                double d = this.h;
                long j11 = 0;
                if (j10 != 0) {
                    ...
                    if (user != null) {
                        ...
                        if (inputFile3 != null) {
                            j11 = inputFile3.f20859id;
                        } else if (inputFile4 != null) {
                            j11 = inputFile4.f20859id;
                        }
                    ...
                    long j12 = poVar.f40082t0;
                    TLRPC.FileLocation fileLocation3 = photoSize.location;
                    TLRPC.FileLocation fileLocation4 = photoSize2.location;
                    z4 = false;
                    messagesController.changeChatAvatar(j12, null, inputFile3, inputFile4, videoSize, d, this.f35771n, fileLocation3, fileLocation4, null);
                }
                if (poVar.J0) {
                    try {
                        org.telegram.ui.ActionBar.d2 d2Var2 = poVar.f40058b;
                    ...
                    poVar.K0 = z4;
                    poVar.f40056a.performClick();
                }
                poVar.n0(z4, true);
                return;
            case 2:
                l50 l50Var = (l50) this.f35772r;
                long j13 = l50Var.f38544e;
                d60 d60Var = l50Var.f38545f;
                AccountInstance accountInstance = d60Var.d;
                TLRPC.InputFile inputFile5 = this.f35768c;
                TLRPC.InputFile inputFile6 = this.d;
                TLRPC.VideoSize videoSize2 = this.f35769e;
                TLRPC.PhotoSize photoSize3 = this.f35767b;
                TLRPC.PhotoSize photoSize4 = this.f35770f;
                if (inputFile5 == null && inputFile6 == null && videoSize2 == null) {
                    l50Var.f38543c = photoSize3.location;
                    TLRPC.FileLocation fileLocation5 = photoSize4.location;
                    l50Var.f38542b = fileLocation5;
                    ImageLocation forLocal2 = ImageLocation.getForLocal(fileLocation5);
                    l50Var.d = forLocal2;
                    d60Var.f35993b.A(forLocal2, ImageLocation.getForLocal(l50Var.f38543c));
                    AndroidUtilities.updateVisibleRows(d60Var.N);
                    return;
                }
                double d10 = this.h;
                String str = this.f35771n;
                if (j13 > 0) {
                ...
                return;
            case 3:
                f70 f70Var = (f70) this.f35772r;
                TLRPC.InputFile inputFile7 = this.f35768c;
                TLRPC.InputFile inputFile8 = this.d;
                TLRPC.VideoSize videoSize3 = this.f35769e;
                if (inputFile7 == null && inputFile8 == null && videoSize3 == null) {
                    TLRPC.FileLocation fileLocation6 = this.f35767b.location;
                    f70Var.f36700y = fileLocation6;
                    f70Var.B = this.f35770f.location;
                    f70Var.d.h(ImageLocation.getForLocal(fileLocation6), "50_50", f70Var.f36696r, null);
                    f70Var.Z(true, false);
                    return;
                }
                f70Var.C = inputFile7;
                f70Var.D = inputFile8;
                f70Var.E = videoSize3;
                f70Var.F = this.f35771n;
                f70Var.G = this.h;
                if (f70Var.I) {
                    f70Var.getMessagesController().createChat(f70Var.f36692c.getText().toString(), f70Var.H, null, f70Var.M, f70Var.P, f70Var.R, f70Var.Q, f70Var.T, f70Var);
                }
                f70Var.Z(false, true);
                f70Var.f36694f.setImageDrawable(null);
                return;
            case 4:
                ProfileActivity.d0((ProfileActivity) this.f35772r, this.f35768c, this.d, this.f35769e, this.h, this.f35771n, this.f35767b, this.f35770f);
                return;
            case 5:
                v81.d0((v81) this.f35772r, this.f35768c, this.d, this.f35769e, this.h, this.f35771n, this.f35767b, this.f35770f);
                return;
            default:
                th.n nVar = (th.n) this.f35772r;
                nVar.getClass();
                TLRPC.PhotoSize photoSize5 = this.f35767b;
                TLRPC.FileLocation fileLocation7 = photoSize5.location;
                nVar.C = fileLocation7;
                TLRPC.InputFile inputFile9 = this.f35768c;
                TLRPC.InputFile inputFile10 = this.d;
                TLRPC.VideoSize videoSize4 = this.f35769e;
                if (inputFile9 == null && inputFile10 == null && videoSize4 == null) {
                    nVar.v.h(ImageLocation.getForLocal(fileLocation7), "50_50", nVar.f48198y, nVar.E);
                    nVar.a0(true, false);
                    z10 = true;
                } else {
                    z10 = true;
                    nVar.getMessagesController().changeChatAvatar(nVar.f48189b, null, inputFile9, inputFile10, videoSize4, this.h, this.f35771n, photoSize5.location, this.f35770f.location, null);
                    nVar.a0(false, true);
                }
                nVar.d.V2.N(z10);
                return;
