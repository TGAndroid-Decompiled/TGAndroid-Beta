...
public final class d40 extends FrameLayout {
    public final Rect f32919a;
    public final RectF f32920b;
    public final Path f32921c;
    public final i60 d;

    public d40(i60 i60Var, LaunchActivity launchActivity) {
        super(launchActivity);
        this.d = i60Var;
        this.f32919a = new Rect();
        this.f32920b = new RectF();
        this.f32921c = new Path();
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (i60Var.f34424d2 != 1.0f) {
            if (i60Var.X2 != null && i60Var.f34416b3) {
                canvas.save();
                ...
                float f7 = i60Var.f34424d2;
                int dp = (int) ((AndroidUtilities.dp(13.0f) * f7) + ((1.0f - i60Var.f34424d2) * measuredHeight));
                ...
                canvas.restore();
            } else if (i60Var.f34411a3 != null && i60Var.Z2 == null && i60Var.O2) {
                canvas.save();
                float measuredHeight2 = (i60Var.f34411a3.getAvatarImageView().getMeasuredHeight() / 2.0f) * (getMeasuredHeight() / i60Var.f34411a3.getAvatarImageView().getMeasuredHeight());
                float f10 = i60Var.f34424d2;
                int dp2 = (int) ((AndroidUtilities.dp(13.0f) * f10) + ((1.0f - i60Var.f34424d2) * measuredHeight2));
                int i11 = (int) ((1.0f - f10) * measuredHeight2);
                i60Var.f34411a3.getAvatarImageView().getImageReceiver().setImageCoords(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight());
                i60Var.f34411a3.getAvatarImageView().r(dp2, dp2, i11, i11);
                i60Var.f34411a3.getAvatarImageView().getImageReceiver().draw(canvas);
                i60Var.f34411a3.getAvatarImageView().setRoundRadius(i60Var.f34411a3.getAvatarImageView().getMeasuredHeight() / 2);
                canvas.restore();
            }
        }
        c40Var.setAlpha(i60Var.f34424d2);
        Path path = this.f32921c;
        path.reset();
        RectF rectF = this.f32920b;
