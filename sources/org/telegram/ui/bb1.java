...
public final class bb1 extends View {
    public ImageReceiver f32371a;
    public ImageReceiver f32372b;
    public View f32373c;
    public org.telegram.ui.Components.ef0 d;
    public Path e;
    public Drawable f32374f;
    ...
    public final void draw(Canvas canvas) {
        ...
        ImageReceiver imageReceiver = this.f32371a;
        ...
        this.f32372b.setImageCoords(dp - AndroidUtilities.dp(30.0f), measuredHeight - AndroidUtilities.dp(30.0f), AndroidUtilities.dp(60.0f), AndroidUtilities.dp(60.0f));
        Drawable drawable = this.f32374f;
        ...
        if (this.f32373c != null) {
            CropAreaView cropAreaView = this.d.f23948b.f14323a;
            float dp2 = AndroidUtilities.dp(60.0f) / cropAreaView.f22226a;
            float left = (0.0f - this.d.getLeft()) - cropAreaView.f22228b;
            canvas.save();
            canvas.clipPath(path);
            canvas.scale(dp2, dp2, 0.0f, 0.0f);
            canvas.translate(left, (0.0f - this.d.getTop()) - cropAreaView.f22230c);
            canvas.translate((dp - AndroidUtilities.dp(30.0f)) / dp2, (measuredHeight - AndroidUtilities.dp(30.0f)) / dp2);
            PhotoViewer.t1().f31245g4 = true;
            this.f32373c.draw(canvas);
            PhotoViewer.t1().f31245g4 = false;
            canvas.restore();
        }
        super.draw(canvas);
        this.f32373c.invalidate();
        invalidate();
    }
    ...
    public final void onAttachedToWindow() {
        ...
        this.f32371a.onAttachedToWindow();
        this.f32372b.onAttachedToWindow();
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        this.f32371a.onDetachedFromWindow();
        this.f32372b.onDetachedFromWindow();
    }

    @Override
    public final void onMeasure(int i10, int i11) {
        this.f32371a.setRoundRadius(AndroidUtilities.dp(30.0f));
        this.f32372b.setRoundRadius(AndroidUtilities.dp(30.0f));
