...
public final class bb1 extends View {
    public ImageReceiver f32370a;
    public ImageReceiver f32371b;
    public View f32372c;
    public org.telegram.ui.Components.ef0 d;
    public Path e;
    public Drawable f32373f;
    ...
    public final void draw(Canvas canvas) {
        ...
        ImageReceiver imageReceiver = this.f32370a;
        ...
        this.f32371b.setImageCoords(dp - AndroidUtilities.dp(30.0f), measuredHeight - AndroidUtilities.dp(30.0f), AndroidUtilities.dp(60.0f), AndroidUtilities.dp(60.0f));
        Drawable drawable = this.f32373f;
        ...
        if (this.f32372c != null) {
            CropAreaView cropAreaView = this.d.f23947b.f14323a;
            ...
            PhotoViewer.t1().f31244g4 = true;
            this.f32372c.draw(canvas);
            PhotoViewer.t1().f31244g4 = false;
            canvas.restore();
        }
        super.draw(canvas);
        this.f32372c.invalidate();
        invalidate();
    }
    ...
    public final void onAttachedToWindow() {
        ...
        this.f32370a.onAttachedToWindow();
        this.f32371b.onAttachedToWindow();
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        this.f32370a.onDetachedFromWindow();
        this.f32371b.onDetachedFromWindow();
    }

    @Override
    public final void onMeasure(int i10, int i11) {
        this.f32370a.setRoundRadius(AndroidUtilities.dp(30.0f));
        this.f32371b.setRoundRadius(AndroidUtilities.dp(30.0f));
