...
public final class aa0 implements Runnable {
    public final LaunchActivity f31734a;
    public final org.telegram.ui.ActionBar.n2 f31735b;
    public final int f31736c;
    public final TLRPC.User d;
    public final TLRPC.TL_messages_botApp e;
    public final AtomicBoolean f31737f;
    public final String h;
    public final boolean f31738n;
    public final boolean f31739r;
    public final boolean f31740s;
    ...
    public aa0(LaunchActivity launchActivity, org.telegram.ui.ActionBar.n2 n2Var, int i10, TLRPC.User user, TLRPC.TL_messages_botApp tL_messages_botApp, AtomicBoolean atomicBoolean, String str, boolean z10, boolean z11, boolean z12, boolean z13) {
        this.f31734a = launchActivity;
        this.f31735b = n2Var;
        this.f31736c = i10;
        this.d = user;
        this.e = tL_messages_botApp;
        this.f31737f = atomicBoolean;
        this.h = str;
        this.f31738n = z10;
        this.f31739r = z11;
        this.f31740s = z12;
    ...
    public final void run() {
        ...
        org.telegram.ui.ActionBar.n2 n2Var = this.f31735b;
        if (n2Var != null && LaunchActivity.C1) {
            LaunchActivity launchActivity = this.f31734a;
            if (!launchActivity.isFinishing() && !launchActivity.isDestroyed()) {
                ...
                boolean z10 = this.f31737f.get();
                int i10 = this.f31736c;
                String str = this.h;
                boolean z11 = this.f31738n;
                boolean z12 = this.f31739r;
                ...
                if (launchActivity.P() == null || launchActivity.P().k(b10) == null) {
                    SharedPrefsHelper.setWebViewConfirmShown(launchActivity.O, user.f18259id, true);
                    ei.k3 k3Var = new ei.k3(launchActivity, n2Var.getResourceProvider());
                    ei.b3 b3Var = k3Var.f8451x;
                    if (b3Var != null) {
                        b3Var.setWasOpenedByLinkIntent(this.f31740s);
                    }
                    k3Var.w(!z11);
                    if (z12) {
                        k3Var.x(true, false, k3Var.f8428e0);
                    }
                    k3Var.A0 = false;
                    k3Var.f8435k0 = launchActivity;
                    k3Var.s(n2Var, b10);
                    k3Var.show();
