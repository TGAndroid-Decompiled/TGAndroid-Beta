        ...
        if (videoPlayerHolderBase.firstFrameRendered) {
            ...
            if (textureView != null && textureView.getSurfaceTexture() != null) {
                if (Build.VERSION.SDK_INT >= 24) {
                    ...
                    surface.release();
                    obj.f39349b = createBitmap;
                    return obj;
                }
                obj.f39349b = textureView2.getBitmap();
            }
        }
        return obj;
    }
