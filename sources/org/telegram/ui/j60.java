...
public final class j60 extends org.telegram.ui.Components.rl0 {
    public ChatObject.Call f37846c;
    public final int d;
    public ArrayList f37848f;
    public w30 h;
    public final d60 f37849n;
    public final ArrayList f37847e = new ArrayList();
    public boolean f37850r = false;
    ...
    public final void E(org.telegram.ui.Components.voip.l lVar, boolean z4) {
        if (z4 && lVar.getRenderer() == null) {
            lVar.setRenderer(org.telegram.ui.Components.voip.u.c(this.f37848f, this.h, null, null, lVar, lVar.getParticipant(), this.f37846c, this.f37849n));
    ...
    public final int F() {
        org.telegram.ui.Components.sl0 sl0Var = this.f37849n.f36034k2;
        int size = this.f37847e.size();
        if (size <= 1) {
            return sl0Var.getMeasuredHeight();
        }
        if (size <= 4) {
            return sl0Var.getMeasuredHeight() / 2;
        }
        return (int) (sl0Var.getMeasuredHeight() / 2.5f);
    }

    public final void G(ArrayList arrayList, w30 w30Var) {
        this.f37848f = arrayList;
        this.h = w30Var;
    }
    ...
    public final void I(org.telegram.ui.Components.sl0 sl0Var, boolean z4) {
        ...
        ArrayList arrayList = this.f37847e;
        if (z4) {
            ArrayList arrayList2 = new ArrayList();
            arrayList2.addAll(arrayList);
            arrayList.clear();
            arrayList.addAll(this.f37846c.visibleVideoParticipants);
    ...
    public final void v(f2.m1 m1Var, int i10) {
        ...
        MessageObject.getPeerId(this.f37846c.selfPeer);
        lVar.d = videoParticipant;
        if (participant != null && !participant.equals(videoParticipant) && lVar.f32141e && lVar.getRenderer() != null) {
            E(lVar, false);
            E(lVar, true);
