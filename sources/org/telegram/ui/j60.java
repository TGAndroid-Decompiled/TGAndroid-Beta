...
public final class j60 extends org.telegram.ui.Components.vl0 {
    public ChatObject.Call f34644c;
    public final int d;
    public ArrayList f34645f;
    public v30 h;
    public final d60 f34646n;
    public final ArrayList e = new ArrayList();
    public boolean f34647r = false;
    ...
    public final void E(org.telegram.ui.Components.voip.l lVar, boolean z10) {
        if (z10 && lVar.getRenderer() == null) {
            lVar.setRenderer(org.telegram.ui.Components.voip.u.c(this.f34645f, this.h, null, null, lVar, lVar.getParticipant(), this.f34644c, this.f34646n));
    ...
    public final int F() {
        org.telegram.ui.Components.wl0 wl0Var = this.f34646n.f32972n2;
    ...
    public final void I(org.telegram.ui.Components.wl0 wl0Var, boolean z10) {
        ...
        if (z10) {
            ...
            arrayList.clear();
            arrayList.addAll(this.f34644c.visibleVideoParticipants);
    ...
    public final void v(s4.c1 c1Var, int i10) {
        org.telegram.ui.Components.voip.l lVar = (org.telegram.ui.Components.voip.l) c1Var.f42946a;
        ...
        MessageObject.getPeerId(this.f34644c.selfPeer);
