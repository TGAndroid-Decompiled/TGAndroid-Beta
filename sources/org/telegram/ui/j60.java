...
public final class j60 extends org.telegram.ui.Components.vl0 {
    public ChatObject.Call f34659c;
    public final int d;
    public ArrayList f34660f;
    public v30 h;
    public final d60 f34661n;
    public final ArrayList e = new ArrayList();
    public boolean f34662r = false;
    ...
    public final void E(org.telegram.ui.Components.voip.l lVar, boolean z10) {
        if (z10 && lVar.getRenderer() == null) {
            lVar.setRenderer(org.telegram.ui.Components.voip.u.c(this.f34660f, this.h, null, null, lVar, lVar.getParticipant(), this.f34659c, this.f34661n));
    ...
    public final int F() {
        org.telegram.ui.Components.wl0 wl0Var = this.f34661n.f32989n2;
    ...
    public final void I(org.telegram.ui.Components.wl0 wl0Var, boolean z10) {
        ...
        if (z10) {
            ...
            arrayList.clear();
            arrayList.addAll(this.f34659c.visibleVideoParticipants);
    ...
    public final void v(s4.c1 c1Var, int i10) {
        org.telegram.ui.Components.voip.l lVar = (org.telegram.ui.Components.voip.l) c1Var.f42961a;
        ...
        MessageObject.getPeerId(this.f34659c.selfPeer);
