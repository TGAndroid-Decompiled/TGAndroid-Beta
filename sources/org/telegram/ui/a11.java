...
public final class a11 extends View implements org.telegram.ui.Components.uh0 {
    ...
    public final Rect f31895b;
    public final Rect f31896c;
    public final RectF d;
    public final GradientDrawable e;
    public final GradientDrawable f31897f;
    public final ValueAnimator h;
    public final float[] f31898n;
    public final Paint f31899r;
    public final Paint f31900s;
    public final Paint v;
    public final GradientDrawable[] f31901w;
    public final boolean[] f31902x;
    public final float[] f31903y;
    ...
    @Override
    public final void a() {
        Arrays.fill(this.f31902x, false);
        postInvalidateOnAnimation();
    }

    @Override
    public final void b(boolean z10) {
        this.f31902x[!z10 ? 1 : 0] = true;
        postInvalidateOnAnimation();
    }
    ...
    public final void e(float f7, boolean z10) {
        ...
        this.e.setAlpha(i10);
        this.f31897f.setAlpha(i10);
        this.f31899r.setAlpha((int) (66.0f * f7));
        this.f31900s.setAlpha((int) (85.0f * f7));
        this.v.setAlpha(i10);
        this.G = f7;
        if (!z10) {
            this.F = f7;
    ...
    public final void onSizeChanged(int i10, int i11, int i12, int i13) {
        int currentActionBarHeight = org.telegram.ui.ActionBar.k.getCurrentActionBarHeight() + this.f31894a;
        Rect rect = this.f31895b;
        rect.set(0, 0, i10, (int) (currentActionBarHeight * 0.5f));
        Rect rect2 = this.f31896c;
        ...
        this.f31897f.setBounds(0, ((i11 - this.P.O3()) - AndroidUtilities.dp(72.0f)) - AndroidUtilities.dp(24.0f), i10, rect2.top);
        GradientDrawable[] gradientDrawableArr = this.f31901w;
        int i14 = i10 / 5;
