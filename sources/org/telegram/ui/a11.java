...
public final class a11 extends View implements org.telegram.ui.Components.jh0 {
    public boolean E;
    public float F;
    public float G;
    public float[] H;
    ...
    public final Rect f31652b;
    public final Rect f31653c;
    public final RectF d;
    public final GradientDrawable e;
    public final GradientDrawable f31654f;
    public final ValueAnimator h;
    public final float[] f31655n;
    public final Paint f31656r;
    public final Paint f31657s;
    public final Paint v;
    public final GradientDrawable[] f31658w;
    public final boolean[] f31659x;
    public final float[] f31660y;
    ...
    @Override
    public final void a() {
        Arrays.fill(this.f31659x, false);
        postInvalidateOnAnimation();
    }

    @Override
    public final void b(boolean z10) {
        this.f31659x[!z10 ? 1 : 0] = true;
        postInvalidateOnAnimation();
    }
    ...
    public final void e(float f7, boolean z10) {
        ...
        this.e.setAlpha(i10);
        this.f31654f.setAlpha(i10);
        this.f31656r.setAlpha((int) (66.0f * f7));
        this.f31657s.setAlpha((int) (85.0f * f7));
        this.v.setAlpha(i10);
        this.G = f7;
        if (!z10) {
            this.F = f7;
    ...
    public final void onSizeChanged(int i10, int i11, int i12, int i13) {
        int currentActionBarHeight = org.telegram.ui.ActionBar.k.getCurrentActionBarHeight() + this.f31651a;
        Rect rect = this.f31652b;
        rect.set(0, 0, i10, (int) (currentActionBarHeight * 0.5f));
        Rect rect2 = this.f31653c;
        ...
        this.f31654f.setBounds(0, ((i11 - this.P.O3()) - AndroidUtilities.dp(72.0f)) - AndroidUtilities.dp(24.0f), i10, rect2.top);
        GradientDrawable[] gradientDrawableArr = this.f31658w;
        int i14 = i10 / 5;
