...
public final class gp implements Runnable {
    ...
    public final rp f37239b;
    public final org.telegram.ui.ActionBar.d2[] f37240c;
    public final int d;

    public gp(rp rpVar, org.telegram.ui.ActionBar.d2[] d2VarArr, int i10, int i11) {
        this.f37238a = i11;
        this.f37239b = rpVar;
        this.f37240c = d2VarArr;
        this.d = i10;
    }
    ...
    public final void run() {
        switch (this.f37238a) {
            case 0:
                org.telegram.ui.ActionBar.d2[] d2VarArr = this.f37240c;
                org.telegram.ui.ActionBar.d2 d2Var = d2VarArr[0];
                if (d2Var != null) {
                    final rp rpVar = this.f37239b;
                ...
                return;
            default:
                org.telegram.ui.ActionBar.d2[] d2VarArr2 = this.f37240c;
                org.telegram.ui.ActionBar.d2 d2Var2 = d2VarArr2[0];
                if (d2Var2 != null) {
                    final rp rpVar2 = this.f37239b;
