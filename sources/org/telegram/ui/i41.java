...
public final class i41 extends og.b {
    ...
    @Override
    public final int h() {
        return this.d.f31706s.size();
    }

    @Override
    public final int j(int i10) {
        return ((j41) this.d.f31706s.get(i10)).f15700a;
    }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        ArrayList arrayList = saveToGallerySettingsActivity.f31706s;
        boolean z10 = false;
        if (((j41) arrayList.get(i10)).f15700a == 1) {
            org.telegram.ui.Cells.r8 r8Var = (org.telegram.ui.Cells.r8) view;
            if (saveToGallerySettingsActivity.v.size() > 0) {
                z10 = true;
            }
            r8Var.setNeedDivider(z10);
        } else if (((j41) arrayList.get(i10)).f15700a == 6) {
            ...
            if (i10 == saveToGallerySettingsActivity.h) {
                ...
                int i12 = saveToGallerySettingsActivity.f31700a;
                if (i12 == 1) {
        ...
        } else if (((j41) arrayList.get(i10)).f15700a == 5) {
            ((org.telegram.ui.Cells.m4) view).setText(((j41) arrayList.get(i10)).d);
        } else if (((j41) arrayList.get(i10)).f15700a == 2) {
            org.telegram.ui.Cells.za zaVar = (org.telegram.ui.Cells.za) view;
            SaveToGallerySettingsHelper.DialogException dialogException = ((j41) arrayList.get(i10)).f34627c;
            ...
            zaVar.d(userOrChat, str, dialogException.createDescription(i11), (i10 == arrayList.size() - 1 || ((j41) arrayList.get(i10 + 1)).f15700a == 2) ? true : true);
        }
    }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        switch (i10) {
            ...
            case 2:
                ...
                zaVar.setBackgroundColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19045d6, false));
                linearLayout = zaVar;
                view = linearLayout;
                break;
            case 3:
            ...
            case 4:
                ...
                r8Var2.e(-1, org.telegram.ui.ActionBar.h6.f19265p7);
                r8Var2.setBackgroundColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19045d6, false));
                yaVar = r8Var2;
                view = yaVar;
                break;
            case 5:
            ...
            case 8:
                ...
                so0Var.f28290w.X(so0Var.getProgress(), false);
                linearLayout2.setBackgroundColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19045d6, false));
            ...
            case 9:
                ...
                if (DialogObject.isUserDialog(saveToGallerySettingsActivity.f31701b)) {
                    i12 = ((org.telegram.ui.ActionBar.m2) saveToGallerySettingsActivity).currentAccount;
                    chat = MessagesController.getInstance(i12).getUser(Long.valueOf(saveToGallerySettingsActivity.f31701b));
                } else {
                    i11 = ((org.telegram.ui.ActionBar.m2) saveToGallerySettingsActivity).currentAccount;
                    chat = MessagesController.getInstance(i11).getChat(Long.valueOf(-saveToGallerySettingsActivity.f31701b));
                }
                yaVar2.a(chat, null);
                yaVar2.setBackgroundColor(saveToGallerySettingsActivity.getThemedColor(org.telegram.ui.ActionBar.h6.f19045d6));
                yaVar = yaVar2;
                view = yaVar;
                break;
            case 10:
                View b7Var = new org.telegram.ui.Cells.b7(viewGroup.getContext(), (org.telegram.ui.Cells.c1) null);
                b7Var.setBackgroundDrawable(org.telegram.ui.ActionBar.h6.U0(saveToGallerySettingsActivity.getParentActivity(), R.drawable.greydivider_bottom, org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19009b7, saveToGallerySettingsActivity.getResourceProvider())));
                yaVar = b7Var;
                view = yaVar;
                break;
        }
