...
public final class da0 implements oy {
    ...
    public final LaunchActivity f32973b;
    ...
    public final boolean u(uy uyVar, ArrayList arrayList, CharSequence charSequence, boolean z10, boolean z11, int i10, int i11, dg1 dg1Var) {
        int i12 = this.f32972a;
        TLRPC.User user = this.e;
        int i13 = this.d;
        String str = this.f32974c;
        LaunchActivity launchActivity = this.f32973b;
        switch (i12) {
            case 0:
            ...
            default:
                ...
                tL_inputMediaGame.f18174id = tL_inputGameShortName;
