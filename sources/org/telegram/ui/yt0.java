...
public final class yt0 extends AnimatorListenerAdapter {
    ...
    public final PhotoViewer f40013c;

    public yt0(PhotoViewer photoViewer, int i10, int i11) {
        this.f40011a = i11;
        this.f40013c = photoViewer;
        this.f40012b = i10;
    }
    ...
    public final void onAnimationEnd(Animator animator) {
        switch (this.f40011a) {
            case 0:
                PhotoViewer photoViewer = this.f40013c;
                zt0 zt0Var = photoViewer.N1;
                zt0Var.e.setVisibility(0);
                FrameLayout frameLayout = zt0Var.f42001r;
                ...
                zt0Var.f42003w.animate().alpha(1.0f).translationX(0.0f).setInterpolator(qrVar).setDuration(320L).start();
                photoViewer.f31365u4 = this.f40012b;
                photoViewer.q6 = null;
                photoViewer.f31313o6 = -1;
                return;
            default:
                int i10 = this.f40012b;
                PhotoViewer photoViewer2 = this.f40013c;
                photoViewer2.f31365u4 = i10;
