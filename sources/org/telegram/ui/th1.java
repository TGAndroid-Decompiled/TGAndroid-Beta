...
public abstract class th1 extends org.telegram.ui.ActionBar.m2 {
    public final SparseArray f38123a;
    public k0 f38124b;
    public sh1 f38125c;
    public int d;
    public float e;
    ...
    public boolean h;
    public String f38127n;
    public int f38128r;
    public Runnable f38129s;

    public th1() {
        super(null);
        this.f38123a = new SparseArray();
        this.d = -1;
        this.e = 0.0f;
    }
    ...
    public final void U() {
        ...
        boolean z10;
        float f10;
        SparseArray sparseArray = this.f38123a;
        int size = sparseArray.size();
        for (int i10 = 0; i10 < size; i10++) {
            rh1 rh1Var = (rh1) sparseArray.valueAt(i10);
            int keyAt = sparseArray.keyAt(i10);
            if (rh1Var != null) {
                org.telegram.ui.ActionBar.m2 m2Var = rh1Var.f37336a;
                if (m2Var.fragmentView != null) {
                    float r10 = this.f38125c.r(keyAt);
                    boolean z11 = this.f38126f;
                    if (z11) {
                        f7 = this.e;
                    } else {
                        f7 = 0.0f;
                    ...
                    if (!rh1Var.f37338c && f12 >= 1.0f) {
                        m2Var.onBecomeFullyVisible();
                        rh1Var.f37338c = true;
                    }
                    if (rh1Var.f37338c && ((f12 == 0.0f && !z12) || r10 == 0.0f)) {
                        m2Var.onBecomeFullyHidden();
                        rh1Var.f37338c = false;
                    }
    ...
    public final org.telegram.ui.ActionBar.m2 X() {
        sh1 sh1Var = this.f38125c;
        if (sh1Var == null) {
            return null;
        }
        rh1 rh1Var = (rh1) this.f38123a.get(sh1Var.getCurrentPosition());
        if (rh1Var == null) {
            return null;
        }
        return rh1Var.f37336a;
    }
    ...
    public View createView(Context context) {
        ...
        this.f38124b = new k0((yg0) this, context, 13);
        ...
        this.f38125c.setAdapter(new zv0(this, context, 3));
        this.f38124b.addView(this.f38125c, w7.y5.c(-1.0f, -1));
        k0 k0Var = this.f38124b;
    ...
    public final void setTitleOverlayText(String str, int i10, Runnable runnable) {
        ...
        this.f38127n = str;
        this.f38128r = i10;
        this.f38129s = runnable;
        SparseArray sparseArray = this.f38123a;
        int size = sparseArray.size();
        for (int i11 = 0; i11 < size; i11++) {
            rh1 rh1Var = (rh1) sparseArray.valueAt(i11);
            if (rh1Var != null) {
                rh1Var.f37336a.setTitleOverlayText(str, i10, runnable);
            }
        }
    }
