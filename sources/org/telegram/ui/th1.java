...
public final class th1 implements TextWatcher {
    public final UsersSelectActivity f37788a;

    public th1(UsersSelectActivity usersSelectActivity) {
        this.f37788a = usersSelectActivity;
    }

    @Override
    public final void afterTextChanged(Editable editable) {
        UsersSelectActivity usersSelectActivity = this.f37788a;
        if (usersSelectActivity.f31915c.length() != 0) {
            wh1 wh1Var = usersSelectActivity.h;
            boolean z10 = wh1Var.f39176n;
            if (!z10) {
                ...
                usersSelectActivity.f31916f.d.setText(LocaleController.getString(R.string.NoResult));
            }
            usersSelectActivity.f31916f.e(true, true);
            usersSelectActivity.h.L(usersSelectActivity.f31915c.getText().toString());
            return;
        }
        ...
        usersSelectActivity.f31916f.d.setText(LocaleController.getString(R.string.NoContacts));
    }
