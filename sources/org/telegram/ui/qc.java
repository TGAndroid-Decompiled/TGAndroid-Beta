...
public final class qc extends View {
    public final Paint f36853a;
    public final Paint f36854b;
    public final Paint f36855c;
    public final Paint d;
    public final Path e;
    public final Path f36856f;
    public boolean h;
    public boolean f36857n;
    public final org.telegram.ui.Components.yc f36858r;
    public boolean f36859s;
    public final org.telegram.ui.Components.e6 v;
    public final rc f36860w;
    ...
    public qc(rc rcVar, Context context) {
        ...
        this.f36853a = paint;
        this.f36854b = new Paint(1);
        this.f36855c = new Paint(1);
        this.d = new Paint(1);
        this.e = new Path();
        this.f36856f = new Path();
        this.f36858r = new org.telegram.ui.Components.yc(this);
    ...
    public final void a(MessagesController.PeerColor peerColor) {
        boolean q6;
        org.telegram.ui.ActionBar.d6 d6Var = this.f36860w.f37295a;
        if (d6Var != null) {
            q6 = d6Var.a();
        } else {
            q6 = org.telegram.ui.ActionBar.h6.I.q();
        }
        Paint paint = this.f36855c;
        Paint paint2 = this.f36854b;
        ...
        this.f36857n = peerColor.hasColor3();
    }

    @Override
    public final void dispatchDraw(Canvas canvas) {
        canvas.save();
        float a2 = this.f36858r.a(0.05f);
        canvas.scale(a2, a2, getMeasuredWidth() / 2.0f, getMeasuredHeight() / 2.0f);
        canvas.save();
        canvas.clipPath(this.e);
        canvas.drawPaint(this.f36854b);
        if (this.h) {
            canvas.drawPath(this.f36856f, this.f36855c);
        }
        canvas.restore();
        if (this.f36857n) {
            canvas.save();
        ...
        float e = this.v.e(this.f36859s);
        if (e > 0.0f) {
            float dpf2 = AndroidUtilities.dpf2(2.0f);
            Paint paint = this.f36853a;
