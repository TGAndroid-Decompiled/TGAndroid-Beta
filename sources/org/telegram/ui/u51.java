...
public final class u51 extends FrameLayout {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (!a71Var.Q0) {
        ...
        } else if (this.f38327c) {
            canvas.save();
            boolean z10 = this.d;
            Paint paint = this.f38326b;
            if (z10) {
            ...
            if (a71Var.n()) {
                AndroidUtilities.rectTmp.set((dp - (a71Var.f32010a1 * dp)) + getPaddingLeft(), com.google.android.gms.internal.vision.e2.z(1.0f, a71Var.f32013b1, height, getPaddingTop()), ((width - dp) * a71Var.f32010a1) + getPaddingLeft() + dp, getPaddingTop() + height);
            } else {
                AndroidUtilities.rectTmp.set((dp - (a71Var.f32010a1 * dp)) + getPaddingLeft(), getPaddingTop(), ((width - dp) * a71Var.f32010a1) + getPaddingLeft() + dp, (height * a71Var.f32013b1) + getPaddingTop());
            }
