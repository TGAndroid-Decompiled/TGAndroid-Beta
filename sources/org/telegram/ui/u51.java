...
public final class u51 extends FrameLayout {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (!a71Var.Q0) {
            ...
            if (a71Var.n()) {
                AndroidUtilities.rectTmp.set((dp - (a71Var.f32011a1 * dp)) + getPaddingLeft(), com.google.android.gms.internal.vision.e2.z(1.0f, a71Var.f32014b1, height, getPaddingTop()), ((width - dp) * a71Var.f32011a1) + getPaddingLeft() + dp, getPaddingTop() + height);
            } else {
                AndroidUtilities.rectTmp.set((dp - (a71Var.f32011a1 * dp)) + getPaddingLeft(), getPaddingTop(), ((width - dp) * a71Var.f32011a1) + getPaddingLeft() + dp, (height * a71Var.f32014b1) + getPaddingTop());
            }
