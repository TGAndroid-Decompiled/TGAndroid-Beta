...
public final class cy0 implements MessagesStorage.BooleanCallback, ls {
    public final ProfileActivity f32818a;
    public final TLRPC.User f32819b;

    public cy0(ProfileActivity profileActivity, TLRPC.User user) {
        this.f32818a = profileActivity;
        this.f32819b = user;
    }

    @Override
    public void b() {
        ProfileActivity.j0(this.f32818a, this.f32819b);
    }

    @Override
    public void run(boolean z10) {
        org.telegram.ui.ActionBar.m2 m2Var;
        ProfileActivity profileActivity = this.f32818a;
        ...
        profileActivity.getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.needDeleteDialog, Long.valueOf(profileActivity.f31584i1), this.f32819b, profileActivity.E2, Boolean.valueOf(z10));
    }
}
