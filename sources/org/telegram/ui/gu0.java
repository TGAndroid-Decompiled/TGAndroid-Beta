...
public final class gu0 implements ViewTreeObserver.OnPreDrawListener {
    public final av0 f36816a;
    public final Integer f36817b;
    public final PhotoViewer f36818c;

    public gu0(PhotoViewer photoViewer, av0 av0Var, Integer num) {
        this.f36818c = photoViewer;
        this.f36816a = av0Var;
        this.f36817b = num;
    }
    ...
    public final boolean onPreDraw() {
        PhotoViewer photoViewer = this.f36818c;
        ...
        photoViewer.f33702s3.setTranslationY(AndroidUtilities.dp(32.0f));
        photoViewer.f33702s3.animate().alpha(1.0f).translationY(0.0f).setDuration(150L).setInterpolator(prVar).start();
        photoViewer.f33577e0.setAlpha(0.0f);
        photoViewer.L0.setAlpha(0);
        photoViewer.f33658n4 = 4;
        ...
        animatorSet.playTogether(ObjectAnimator.ofFloat(photoViewer.f33577e0, property, 0.0f, 1.0f).setDuration(220L), ObjectAnimator.ofFloat(photoViewer.f33621j0, property, 0.0f, 1.0f).setDuration(220L), duration2, duration3);
