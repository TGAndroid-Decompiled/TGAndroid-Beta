...
public final class s10 extends org.telegram.ui.Components.hl0 {
    ...
    public final int R() {
        x10 x10Var = this.v;
        int i10 = 0;
        if (x10Var.f42553n.isEmpty()) {
            return 0;
        }
        int size = x10Var.f42553n.size();
        if (!x10Var.f42553n.isEmpty() && !x10Var.N) {
            i10 = 1;
        }
        return size + i10;
    }
    ...
    public final View T(int i10, View view) {
        if (view == null) {
            view = new org.telegram.ui.Cells.u3(this.f40275r, null);
