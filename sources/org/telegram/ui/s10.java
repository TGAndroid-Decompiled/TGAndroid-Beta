...
public final class s10 extends org.telegram.ui.Components.ll0 {
    ...
    @Override
    public final int h() {
        z10 z10Var = this.f37359c;
        if (z10Var.f40077f.isEmpty()) {
            return 0;
        }
        return z10Var.f40077f.size() + (!z10Var.N ? 1 : 0);
    }

    @Override
    public final int j(int i10) {
        if (i10 >= this.f37359c.f40077f.size()) {
            return 3;
        }
        return 0;
    }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (c1Var.f42700f == 0) {
            ...
            z10 z10Var = this.f37359c;
            MessageObject messageObject = (MessageObject) z10Var.f40077f.get(i10);
