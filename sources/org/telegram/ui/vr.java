...
public final class vr extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public int f41658a0;
    public int f41659a1;
    public org.telegram.ui.Components.xw0 f41660b;
    public int f41661b0;
    public int f41662b1;
    public bi.o0 f41663c;
    public int f41664c0;
    public int f41665c1;
    public hg.j0 d;
    public int f41666d0;
    ...
    public ur f41668e;
    public int f41669e0;
    public final int f41670e1;
    public org.telegram.ui.ActionBar.v0 f41671f;
    public int f41672f0;
    public int f41673f1;
    public int f41674g0;
    public int f41675g1;
    ...
    public int m0;
    public or f41685m1;
    public UndoView f41686n;
    public int f41687n0;
    public final boolean f41688n1;
    public int f41689o0;
    public boolean f41690o1;
    public int f41691p0;
    public int f41692p1;
    public int f41693q0;
    public int f41694q1;
    public TLRPC.Chat f41695r;
    public int f41696r0;
    public boolean f41697r1;
    public TLRPC.ChatFull f41698s;
    public int f41699s0;
    public int f41700s1;
    public int f41701t0;
    public final boolean f41702t1;
    public int f41703u0;
    public final boolean f41704u1;
    public final boolean v;
    public int f41705v0;
    public boolean f41706v1;
    public final boolean f41707w;
    public boolean f41708w0;
    public boolean f41709w1;
    public final boolean f41710x;
    public int f41711x0;
    public boolean f41712x1;
    public final String f41713y;
    public int f41714y0;
    public boolean f41715y1;
    public int f41716z0;
    public long f41717z1;
    ...
    public vr(Bundle bundle) {
        ...
        this.f41688n1 = this.arguments.getBoolean("open_search");
        this.f41670e1 = this.arguments.getInt("selectType");
        ...
        this.f41713y = ChatObject.getBannedRightsString(this.E);
        boolean isCommunity = ChatObject.isCommunity(this.f41695r);
        this.f41707w = isCommunity;
        if (ChatObject.isChannel(this.f41695r) && !this.f41695r.megagroup && !isCommunity) {
            z10 = true;
        }
        this.v = z10;
        this.f41710x = ChatObject.isForum(this.f41695r);
        TLRPC.Chat chat2 = this.f41695r;
        if (chat2 != null) {
    ...
    public static void U(vr vrVar, long j3) {
        if (j3 != 0) {
            vrVar.N = j3;
            vrVar.f41695r = MessagesController.getInstance(vrVar.currentAccount).getChat(Long.valueOf(j3));
            vrVar.u0();
        }
    }
    ...
    public static void c0(vr vrVar, TLRPC.User user) {
        ...
        UndoView undoView = vrVar.f41686n;
        long j3 = -vrVar.N;
        boolean z12 = vrVar.v;
        if (z12) {
            i10 = 9;
    ...
    public final void A0(pr prVar) {
        ...
        B0();
        prVar.f(prVar.d);
        s4.o.c(prVar, true).b(this.f41657a);
        bi.o0 o0Var = this.f41663c;
        if (o0Var != null && this.d != null && o0Var.getChildCount() > 0) {
            int i10 = 0;
            int i11 = -1;
            while (true) {
                if (i10 < this.f41663c.getChildCount()) {
                    i11 = RecyclerView.R(this.f41663c.getChildAt(i10));
                    if (i11 != -1) {
                        view = this.f41663c.getChildAt(i10);
                        break;
                    }
                    i10++;
                } else {
            ...
            if (view != null) {
                this.d.h1(i11, view.getTop() - this.f41663c.getPaddingTop());
            }
        }
    }
    ...
    public final View createView(Context context) {
        ...
        if (i11 == 0 && i12 != 2 && i12 != 0 && i12 != 3) {
            if (i12 == 1 && ChatObject.isChannelAndNotMegaGroup(this.f41695r) && ChatObject.hasAdminRights(this.f41695r)) {
            ...
            this.f41668e = new ur(this, context);
            ...
            if (i12 == 3) {
                this.f41671f.setSearchFieldHint(LocaleController.getString("ChannelSearchException", R.string.ChannelSearchException));
            } else {
                this.f41671f.setSearchFieldHint(LocaleController.getString("Search", R.string.Search));
            }
            if (!ChatObject.isChannel(this.f41695r) && !this.f41695r.creator) {
                this.f41671f.setVisibility(8);
            }
            if (i12 == 3) {
        ...
        frameLayout.setBackgroundColor(getThemedColor(org.telegram.ui.ActionBar.j6.f20635a7));
        ...
        int i14 = org.telegram.ui.ActionBar.j6.f20781i6;
        ...
        this.f41660b.f32783e.setText(LocaleController.getString(R.string.SearchEmptyViewFilteredSubtitle2));
        this.f41660b.setVisibility(8);
        this.f41660b.setAnimateLayoutChange(true);
        this.f41660b.e(true, false);
        frameLayout2.addView(this.f41660b, w7.x5.c(-1.0f, -1));
        this.f41660b.addView(frameLayout3, 0);
        bi.o0 o0Var = new bi.o0(this, context, 9);
        this.f41663c = o0Var;
        o0Var.o1();
        bi.o0 o0Var2 = this.f41663c;
        ...
        irVar.C = false;
        irVar.f45806m = false;
        this.f41663c.setItemAnimator(irVar);
        bi.o0 o0Var3 = this.f41663c;
        o0Var3.Y1 = true;
        o0Var3.Z1 = 0;
        rr rrVar = new rr(this, context);
        this.f41657a = rrVar;
        o0Var3.setAdapter(rrVar);
        bi.o0 o0Var4 = this.f41663c;
        if (!LocaleController.isRTL) {
            i10 = 2;
        }
        o0Var4.setVerticalScrollbarPosition(i10);
        frameLayout2.addView(this.f41663c, w7.x5.c(-1.0f, -1));
        this.actionBar.setAdaptiveBackground(this.f41663c);
        this.f41663c.setOnItemClickListener(new tq(this, 3));
        this.f41663c.setOnItemLongClickListener(new tq(this, 4));
        if (this.f41671f != null) {
            this.f41663c.setOnScrollListener(new i3(this, 7));
        }
        UndoView undoView = new UndoView(context);
        this.f41686n = undoView;
        frameLayout2.addView(undoView, w7.x5.d(-1, -2.0f, 83, 8.0f, 0.0f, 8.0f, 8.0f));
        B0();
        this.f41663c.setEmptyView(this.f41660b);
        bi.o0 o0Var5 = this.f41663c;
        o0Var5.Y1 = false;
        o0Var5.Z1 = 0;
        if (this.f41688n1) {
            this.f41671f.z(false);
        }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.chatInfoDidLoad) {
            ...
            if (chatFull.f19897id == this.N) {
                if (!booleanValue || !ChatObject.isChannel(this.f41695r)) {
                    if (this.f41698s != null) {
                        z10 = true;
                    } else {
                        z10 = false;
                    }
                    this.f41698s = chatFull;
                    if (!z10) {
                        int k02 = k0();
                        this.f41694q1 = k02;
                        this.f41692p1 = k02;
                        int i12 = this.f41698s.boosts_unrestrict;
                        if (i12 > 0) {
                            z11 = true;
                        } else {
                            z11 = false;
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f41663c, 16, new Class[]{org.telegram.ui.Cells.l4.class, org.telegram.ui.Cells.a5.class, org.telegram.ui.Cells.x4.class, org.telegram.ui.Cells.v8.class, org.telegram.ui.Cells.ea.class, org.telegram.ui.Components.sv0.class}, null, null, null, org.telegram.ui.ActionBar.j6.f20691d6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f41663c, 32768, null, null, null, null, org.telegram.ui.ActionBar.j6.f20965s8));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f41663c, 4096, null, null, null, null, org.telegram.ui.ActionBar.j6.f20781i6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f41663c, 0, new Class[]{View.class}, org.telegram.ui.ActionBar.j6.f20813k0, null, null, org.telegram.ui.ActionBar.j6.f20692d7));
        int i10 = org.telegram.ui.ActionBar.j6.f20655b7;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f41663c, 32, new Class[]{org.telegram.ui.Cells.e9.class}, null, null, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f41663c, 0, new Class[]{org.telegram.ui.Cells.e9.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.B6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f41663c, 32, new Class[]{org.telegram.ui.Cells.a7.class}, null, null, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f41663c, 0, new Class[]{org.telegram.ui.Cells.l4.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.L6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f41663c, 0, new Class[]{org.telegram.ui.Cells.u3.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f7));
        int i11 = org.telegram.ui.ActionBar.j6.G6;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f41663c, 0, new Class[]{org.telegram.ui.Cells.ea.class}, new String[]{"textView"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f41663c, 0, new Class[]{org.telegram.ui.Cells.ea.class}, new String[]{"valueTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.I6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f41663c, 0, new Class[]{org.telegram.ui.Cells.v8.class}, new String[]{"textView"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f41663c, 0, new Class[]{org.telegram.ui.Cells.v8.class}, new String[]{"valueTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f21089z6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f41663c, 0, new Class[]{org.telegram.ui.Cells.v8.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.U6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f41663c, 0, new Class[]{org.telegram.ui.Cells.v8.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.V6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f41663c, 0, new Class[]{org.telegram.ui.Cells.a5.class}, new String[]{"nameTextView"}, null, null, -1, null, i11));
        int i12 = org.telegram.ui.ActionBar.j6.f21070y6;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f41663c, 0, new Class[]{org.telegram.ui.Cells.a5.class}, new String[]{"statusColor"}, null, null, -1, eVar, i12));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f41663c, 0, new Class[]{org.telegram.ui.Cells.a5.class}, new String[]{"statusOnlineColor"}, null, null, -1, eVar, org.telegram.ui.ActionBar.j6.f20874n6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f41686n, 32, null, null, null, null, org.telegram.ui.ActionBar.j6.Fi));
        int i13 = org.telegram.ui.ActionBar.j6.Gi;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f41686n, 0, new Class[]{UndoView.class}, new String[]{"undoImageView"}, null, null, -1, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f41686n, 0, new Class[]{UndoView.class}, new String[]{"undoTextView"}, null, null, -1, null, i13));
        int i14 = org.telegram.ui.ActionBar.j6.Hi;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f41686n, 0, new Class[]{UndoView.class}, new String[]{"infoTextView"}, null, null, -1, null, i14));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f41686n, 0, new Class[]{UndoView.class}, new String[]{"textPaint"}, null, null, -1, null, i14));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f41686n, 0, new Class[]{UndoView.class}, new String[]{"progressPaint"}, null, null, -1, null, i14));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f41686n, 8, new Class[]{UndoView.class}, new String[]{"leftImageView"}, null, null, -1, null, i14));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f41663c, 262144, new Class[]{org.telegram.ui.Cells.x4.class}, new String[]{"textView"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f41663c, 262144, new Class[]{org.telegram.ui.Cells.x4.class}, new String[]{"imageView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f20855m6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f41663c, 262144, new Class[]{org.telegram.ui.Cells.x4.class}, new String[]{"imageView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f21000u6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f41663c, 262144, new Class[]{org.telegram.ui.Cells.x4.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f21018v6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f41663c, 0, new Class[]{org.telegram.ui.Components.xw0.class}, new String[]{"title"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f41663c, 0, new Class[]{org.telegram.ui.Components.xw0.class}, new String[]{"subtitle"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f41660b.d, 4, null, null, null, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f41660b.f32783e, 4, null, null, null, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f41663c, 0, new Class[]{org.telegram.ui.Cells.a5.class}, null, org.telegram.ui.ActionBar.j6.f20938r0, null, org.telegram.ui.ActionBar.j6.J7));
    ...
    public final boolean h0(TLObject tLObject, boolean z10, View view) {
        ...
        String str2;
        int i14;
        if (tLObject == null || (i10 = this.f41670e1) != 0) {
            return false;
        }
        if (tLObject instanceof TLRPC.ChannelParticipant) {
            ...
            if (tLObject instanceof TLRPC.ChatParticipant) {
                ...
                str = "";
                z11 = ChatObject.canAddAdmins(this.f41695r);
        ...
        if (i16 == 2) {
            ...
            if (ChatObject.canAddAdmins(this.f41695r) && ((tLObject instanceof TLRPC.TL_channelParticipant) || (tLObject instanceof TLRPC.TL_channelParticipantBanned) || (tLObject instanceof TLRPC.TL_chatParticipant) || z11)) {
                z13 = true;
            } else {
                z13 = false;
            }
            ...
            if (ChatObject.canBlockUsers(this.f41695r) && z15 && !z21 && ChatObject.isChannel(this.f41695r) && !this.f41695r.gigagroup) {
                z17 = true;
            } else {
                z17 = false;
            }
            ...
            if (!z14 && (!ChatObject.canBlockUsers(this.f41695r) || !z15)) {
                z18 = false;
            } else {
                z18 = true;
            }
            if (!z10 && z18) {
                ...
                H.W(this.f41663c.U0(view, false));
                ...
                if (ChatObject.canBlockUsers(this.f41695r) && z15) {
                    z19 = true;
                } else {
                    z19 = false;
                }
        ...
        if (i16 == 3 && ChatObject.canBlockUsers(this.f41695r)) {
            vrVar = this;
            ...
            String str3 = str;
            vrVar = this;
            if (i16 == 0 && ChatObject.canBlockUsers(vrVar.f41695r)) {
                if (ChatObject.canAddUsers(vrVar.f41695r) && i15 > 0 && !ChatObject.isCommunity(vrVar.f41695r)) {
            ...
            } else if (i16 == 1 && ChatObject.canAddAdmins(vrVar.f41695r) && z11) {
                if (!vrVar.f41695r.creator && (tLObject instanceof TLRPC.TL_channelParticipantCreator)) {
                    j10 = j13;
                } else {
                    j10 = j13;
        ...
        H2.W(vrVar.f41663c.U0(view, false));
        H2.S = 190;
        if (H2.x() > 0) {
            z12 = true;
        } else {
    ...
    public final int k0() {
        TLRPC.ChatFull chatFull = this.f41698s;
        if (chatFull != null) {
    ...
    public final void onBecomeFullyHidden() {
        UndoView undoView = this.f41686n;
        if (undoView != null) {
            undoView.e(0, true);
        }
    }
    ...
    public final void onInsets(int i10, int i11, int i12, int i13) {
        this.f41663c.setPadding(0, 0, 0, i13);
        this.f41663c.setClipToPadding(false);
        this.f41686n.setTranslationY(-i13);
    }
    ...
    public final void onResume() {
        ...
        rr rrVar = this.f41657a;
        if (rrVar != null) {
            rrVar.l();
        }
        org.telegram.ui.Components.xw0 xw0Var = this.f41660b;
        if (xw0Var != null) {
    ...
    public final void onTransitionAnimationEnd(boolean z10, boolean z11) {
        ...
        if (z10 && !z11 && this.f41688n1) {
            this.f41671f.getSearchField().requestFocus();
            AndroidUtilities.showKeyboard(this.f41671f.getSearchField());
            this.f41671f.setVisibility(8);
        }
    }

    public final boolean p0(int i10) {
        if (i10 != this.V && i10 != this.W && i10 != this.X && i10 != this.Y && i10 != this.Z && i10 != this.f41658a0 && i10 != this.f41682k0 && i10 != this.f41661b0 && i10 != this.f41664c0 && i10 != this.f41666d0) {
            return false;
        }
        return true;
    }
    ...
    public final void r0() {
        ...
        if (!this.Q) {
            ...
            if (z10 && i11 == 2) {
            ...
            } else if (!ChatObject.isChannel(this.f41695r)) {
                this.Q = false;
                arrayList3.clear();
                arrayList.clear();
                arrayList2.clear();
                ...
                iVar.b();
                if (i11 == 1) {
                    TLRPC.ChatFull chatFull2 = this.f41698s;
                    if (chatFull2 != null && (chatParticipants = chatFull2.participants) != null) {
                        int size3 = chatParticipants.participants.size();
                        while (i10 < size3) {
                            TLRPC.ChatParticipant chatParticipant = this.f41698s.participants.participants.get(i10);
                ...
                } else if (i11 == 2 && (chatFull = this.f41698s) != null && chatFull.participants != null) {
                    long j3 = getUserConfig().clientUserId;
                    int size4 = this.f41698s.participants.participants.size();
                    while (i10 < size4) {
                        TLRPC.ChatParticipant chatParticipant2 = this.f41698s.participants.participants.get(i10);
                        int i14 = this.f41670e1;
                ...
                rr rrVar2 = this.f41657a;
                if (rrVar2 != null) {
                    rrVar2.l();
                }
                B0();
                rr rrVar3 = this.f41657a;
                if (rrVar3 != null) {
                    rrVar3.l();
                }
            } else {
    ...
    public final ArrayList s0() {
        ...
        if (i10 == 0) {
            ...
            TLRPC.ChatFull chatFull = this.f41698s;
            if (chatFull != null && chatFull.participants_count <= 200 && (chat = this.f41695r) != null && chat.megagroup) {
                tL_channels_getParticipants.filter = new TLRPC.TL_channelParticipantsRecent();
            } else if (this.f41670e1 == 1) {
                if (!this.J) {
                    this.f41683k1 = 2;
    ...
    public final void v0(long j3) {
        ...
        for (int i10 = 0; i10 < 3; i10++) {
            ...
            if (tLObject != null) {
                ...
                if (this.O == 0 && (chatFull = this.f41698s) != null) {
        ...
        s4.h0 adapter = this.f41663c.getAdapter();
        ur urVar = this.f41668e;
        if (adapter == urVar) {
            hg.b2 b2Var = urVar.h;
    ...
    public final pr w0() {
        ...
        prVar.f39646b = this.f41667d1;
        prVar.f39651i = this.X0;
        prVar.f39652j = this.Y0;
        prVar.f39654l.clear();
        prVar.f39654l.addAll(this.G);
        prVar.h = this.V0;
        prVar.f39650g = this.U0;
        prVar.f39655m.clear();
        prVar.f39655m.addAll(this.H);
        prVar.f39648e = this.E0;
        prVar.f39649f = this.F0;
        prVar.f39653k.clear();
        prVar.f39653k.addAll(this.F);
        prVar.f(prVar.f39647c);
        return prVar;
    }
    ...
    public final void x0(TLRPC.ChatFull chatFull) {
        ...
        if (chatFull != null) {
            ...
            this.f41694q1 = k02;
            this.f41692p1 = k02;
            int i10 = this.f41698s.boosts_unrestrict;
            boolean z11 = false;
            if (i10 > 0) {
                z10 = true;
            } else {
    ...
    public final void y0(int i10) {
        if (!this.isPaused && this.B1) {
            if (this.f41663c.getAdapter() != this.f41657a || !this.R) {
                org.telegram.ui.Components.t00 t00Var = null;
                for (int i11 = 0; i11 < this.f41663c.getChildCount(); i11++) {
                    View childAt = this.f41663c.getChildAt(i11);
                    if (childAt instanceof org.telegram.ui.Components.t00) {
                        t00Var = childAt;
                    }
                }
                if (t00Var != null) {
                    this.f41663c.removeView(t00Var);
                    i10--;
                }
                this.f41663c.getViewTreeObserver().addOnPreDrawListener(new cr(this, t00Var, i10, 0));
            }
        }
    }
