...
public final class vr extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public int f41630a0;
    public int f41631a1;
    public org.telegram.ui.Components.xw0 f41632b;
    public int f41633b0;
    public int f41634b1;
    public bi.o0 f41635c;
    public int f41636c0;
    public int f41637c1;
    public hg.j0 d;
    public int f41638d0;
    ...
    public ur f41640e;
    public int f41641e0;
    public final int f41642e1;
    public org.telegram.ui.ActionBar.v0 f41643f;
    public int f41644f0;
    public int f41645f1;
    public int f41646g0;
    public int f41647g1;
    ...
    public int m0;
    public or f41657m1;
    public UndoView f41658n;
    public int f41659n0;
    public final boolean f41660n1;
    public int f41661o0;
    public boolean f41662o1;
    public int f41663p0;
    public int f41664p1;
    public int f41665q0;
    public int f41666q1;
    public TLRPC.Chat f41667r;
    public int f41668r0;
    public boolean f41669r1;
    public TLRPC.ChatFull f41670s;
    public int f41671s0;
    public int f41672s1;
    public int f41673t0;
    public final boolean f41674t1;
    public int f41675u0;
    public final boolean f41676u1;
    public final boolean v;
    public int f41677v0;
    public boolean f41678v1;
    public final boolean f41679w;
    public boolean f41680w0;
    public boolean f41681w1;
    public final boolean f41682x;
    public int f41683x0;
    public boolean f41684x1;
    public final String f41685y;
    public int f41686y0;
    public boolean f41687y1;
    public int f41688z0;
    public long f41689z1;
    ...
    public vr(Bundle bundle) {
        ...
        this.f41660n1 = this.arguments.getBoolean("open_search");
        this.f41642e1 = this.arguments.getInt("selectType");
        ...
        this.f41685y = ChatObject.getBannedRightsString(this.E);
        boolean isCommunity = ChatObject.isCommunity(this.f41667r);
        this.f41679w = isCommunity;
        if (ChatObject.isChannel(this.f41667r) && !this.f41667r.megagroup && !isCommunity) {
            z10 = true;
        }
        this.v = z10;
        this.f41682x = ChatObject.isForum(this.f41667r);
        TLRPC.Chat chat2 = this.f41667r;
        if (chat2 != null) {
    ...
    public static void U(vr vrVar, long j3) {
        if (j3 != 0) {
            vrVar.N = j3;
            vrVar.f41667r = MessagesController.getInstance(vrVar.currentAccount).getChat(Long.valueOf(j3));
            vrVar.u0();
        }
    }
    ...
    public static void c0(vr vrVar, TLRPC.User user) {
        ...
        UndoView undoView = vrVar.f41658n;
        long j3 = -vrVar.N;
        boolean z12 = vrVar.v;
        if (z12) {
            i10 = 9;
    ...
    public final void A0(pr prVar) {
        ...
        B0();
        prVar.f(prVar.d);
        s4.o.c(prVar, true).b(this.f41629a);
        bi.o0 o0Var = this.f41635c;
        if (o0Var != null && this.d != null && o0Var.getChildCount() > 0) {
            int i10 = 0;
            int i11 = -1;
            while (true) {
                if (i10 < this.f41635c.getChildCount()) {
                    i11 = RecyclerView.R(this.f41635c.getChildAt(i10));
                    if (i11 != -1) {
                        view = this.f41635c.getChildAt(i10);
                        break;
                    }
                    i10++;
                } else {
            ...
            if (view != null) {
                this.d.h1(i11, view.getTop() - this.f41635c.getPaddingTop());
            }
        }
    }
    ...
    public final View createView(Context context) {
        ...
        if (i11 == 0 && i12 != 2 && i12 != 0 && i12 != 3) {
            if (i12 == 1 && ChatObject.isChannelAndNotMegaGroup(this.f41667r) && ChatObject.hasAdminRights(this.f41667r)) {
            ...
            this.f41640e = new ur(this, context);
            ...
            if (i12 == 3) {
                this.f41643f.setSearchFieldHint(LocaleController.getString("ChannelSearchException", R.string.ChannelSearchException));
            } else {
                this.f41643f.setSearchFieldHint(LocaleController.getString("Search", R.string.Search));
            }
            if (!ChatObject.isChannel(this.f41667r) && !this.f41667r.creator) {
                this.f41643f.setVisibility(8);
            }
            if (i12 == 3) {
        ...
        frameLayout.setBackgroundColor(getThemedColor(org.telegram.ui.ActionBar.j6.f20607a7));
        ...
        int i14 = org.telegram.ui.ActionBar.j6.f20753i6;
        ...
        this.f41632b.f32755e.setText(LocaleController.getString(R.string.SearchEmptyViewFilteredSubtitle2));
        this.f41632b.setVisibility(8);
        this.f41632b.setAnimateLayoutChange(true);
        this.f41632b.e(true, false);
        frameLayout2.addView(this.f41632b, w7.x5.c(-1.0f, -1));
        this.f41632b.addView(frameLayout3, 0);
        bi.o0 o0Var = new bi.o0(this, context, 9);
        this.f41635c = o0Var;
        o0Var.o1();
        bi.o0 o0Var2 = this.f41635c;
        ...
        irVar.C = false;
        irVar.f45777m = false;
        this.f41635c.setItemAnimator(irVar);
        bi.o0 o0Var3 = this.f41635c;
        o0Var3.Y1 = true;
        o0Var3.Z1 = 0;
        rr rrVar = new rr(this, context);
        this.f41629a = rrVar;
        o0Var3.setAdapter(rrVar);
        bi.o0 o0Var4 = this.f41635c;
        if (!LocaleController.isRTL) {
            i10 = 2;
        }
        o0Var4.setVerticalScrollbarPosition(i10);
        frameLayout2.addView(this.f41635c, w7.x5.c(-1.0f, -1));
        this.actionBar.setAdaptiveBackground(this.f41635c);
        this.f41635c.setOnItemClickListener(new tq(this, 3));
        this.f41635c.setOnItemLongClickListener(new tq(this, 4));
        if (this.f41643f != null) {
            this.f41635c.setOnScrollListener(new i3(this, 7));
        }
        UndoView undoView = new UndoView(context);
        this.f41658n = undoView;
        frameLayout2.addView(undoView, w7.x5.d(-1, -2.0f, 83, 8.0f, 0.0f, 8.0f, 8.0f));
        B0();
        this.f41635c.setEmptyView(this.f41632b);
        bi.o0 o0Var5 = this.f41635c;
        o0Var5.Y1 = false;
        o0Var5.Z1 = 0;
        if (this.f41660n1) {
            this.f41643f.z(false);
        }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.chatInfoDidLoad) {
            ...
            if (chatFull.f19870id == this.N) {
                if (!booleanValue || !ChatObject.isChannel(this.f41667r)) {
                    if (this.f41670s != null) {
                        z10 = true;
                    } else {
                        z10 = false;
                    }
                    this.f41670s = chatFull;
                    if (!z10) {
                        int k02 = k0();
                        this.f41666q1 = k02;
                        this.f41664p1 = k02;
                        int i12 = this.f41670s.boosts_unrestrict;
                        if (i12 > 0) {
                            z11 = true;
                        } else {
                            z11 = false;
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f41635c, 16, new Class[]{org.telegram.ui.Cells.l4.class, org.telegram.ui.Cells.a5.class, org.telegram.ui.Cells.x4.class, org.telegram.ui.Cells.v8.class, org.telegram.ui.Cells.ea.class, org.telegram.ui.Components.sv0.class}, null, null, null, org.telegram.ui.ActionBar.j6.f20663d6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f41635c, 32768, null, null, null, null, org.telegram.ui.ActionBar.j6.f20937s8));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f41635c, 4096, null, null, null, null, org.telegram.ui.ActionBar.j6.f20753i6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f41635c, 0, new Class[]{View.class}, org.telegram.ui.ActionBar.j6.f20785k0, null, null, org.telegram.ui.ActionBar.j6.f20664d7));
        int i10 = org.telegram.ui.ActionBar.j6.f20627b7;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f41635c, 32, new Class[]{org.telegram.ui.Cells.e9.class}, null, null, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f41635c, 0, new Class[]{org.telegram.ui.Cells.e9.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.B6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f41635c, 32, new Class[]{org.telegram.ui.Cells.a7.class}, null, null, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f41635c, 0, new Class[]{org.telegram.ui.Cells.l4.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.L6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f41635c, 0, new Class[]{org.telegram.ui.Cells.u3.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f7));
        int i11 = org.telegram.ui.ActionBar.j6.G6;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f41635c, 0, new Class[]{org.telegram.ui.Cells.ea.class}, new String[]{"textView"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f41635c, 0, new Class[]{org.telegram.ui.Cells.ea.class}, new String[]{"valueTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.I6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f41635c, 0, new Class[]{org.telegram.ui.Cells.v8.class}, new String[]{"textView"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f41635c, 0, new Class[]{org.telegram.ui.Cells.v8.class}, new String[]{"valueTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f21061z6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f41635c, 0, new Class[]{org.telegram.ui.Cells.v8.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.U6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f41635c, 0, new Class[]{org.telegram.ui.Cells.v8.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.V6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f41635c, 0, new Class[]{org.telegram.ui.Cells.a5.class}, new String[]{"nameTextView"}, null, null, -1, null, i11));
        int i12 = org.telegram.ui.ActionBar.j6.f21042y6;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f41635c, 0, new Class[]{org.telegram.ui.Cells.a5.class}, new String[]{"statusColor"}, null, null, -1, eVar, i12));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f41635c, 0, new Class[]{org.telegram.ui.Cells.a5.class}, new String[]{"statusOnlineColor"}, null, null, -1, eVar, org.telegram.ui.ActionBar.j6.f20846n6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f41658n, 32, null, null, null, null, org.telegram.ui.ActionBar.j6.Fi));
        int i13 = org.telegram.ui.ActionBar.j6.Gi;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f41658n, 0, new Class[]{UndoView.class}, new String[]{"undoImageView"}, null, null, -1, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f41658n, 0, new Class[]{UndoView.class}, new String[]{"undoTextView"}, null, null, -1, null, i13));
        int i14 = org.telegram.ui.ActionBar.j6.Hi;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f41658n, 0, new Class[]{UndoView.class}, new String[]{"infoTextView"}, null, null, -1, null, i14));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f41658n, 0, new Class[]{UndoView.class}, new String[]{"textPaint"}, null, null, -1, null, i14));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f41658n, 0, new Class[]{UndoView.class}, new String[]{"progressPaint"}, null, null, -1, null, i14));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f41658n, 8, new Class[]{UndoView.class}, new String[]{"leftImageView"}, null, null, -1, null, i14));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f41635c, 262144, new Class[]{org.telegram.ui.Cells.x4.class}, new String[]{"textView"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f41635c, 262144, new Class[]{org.telegram.ui.Cells.x4.class}, new String[]{"imageView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f20827m6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f41635c, 262144, new Class[]{org.telegram.ui.Cells.x4.class}, new String[]{"imageView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f20972u6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f41635c, 262144, new Class[]{org.telegram.ui.Cells.x4.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f20990v6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f41635c, 0, new Class[]{org.telegram.ui.Components.xw0.class}, new String[]{"title"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f41635c, 0, new Class[]{org.telegram.ui.Components.xw0.class}, new String[]{"subtitle"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f41632b.d, 4, null, null, null, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f41632b.f32755e, 4, null, null, null, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f41635c, 0, new Class[]{org.telegram.ui.Cells.a5.class}, null, org.telegram.ui.ActionBar.j6.f20910r0, null, org.telegram.ui.ActionBar.j6.J7));
    ...
    public final boolean h0(TLObject tLObject, boolean z10, View view) {
        ...
        String str2;
        int i14;
        if (tLObject == null || (i10 = this.f41642e1) != 0) {
            return false;
        }
        if (tLObject instanceof TLRPC.ChannelParticipant) {
            ...
            if (tLObject instanceof TLRPC.ChatParticipant) {
                ...
                str = "";
                z11 = ChatObject.canAddAdmins(this.f41667r);
        ...
        if (i16 == 2) {
            ...
            if (ChatObject.canAddAdmins(this.f41667r) && ((tLObject instanceof TLRPC.TL_channelParticipant) || (tLObject instanceof TLRPC.TL_channelParticipantBanned) || (tLObject instanceof TLRPC.TL_chatParticipant) || z11)) {
                z13 = true;
            } else {
                z13 = false;
            }
            ...
            if (ChatObject.canBlockUsers(this.f41667r) && z15 && !z21 && ChatObject.isChannel(this.f41667r) && !this.f41667r.gigagroup) {
                z17 = true;
            } else {
                z17 = false;
            }
            ...
            if (!z14 && (!ChatObject.canBlockUsers(this.f41667r) || !z15)) {
                z18 = false;
            } else {
                z18 = true;
            }
            if (!z10 && z18) {
                ...
                H.W(this.f41635c.U0(view, false));
                ...
                if (ChatObject.canBlockUsers(this.f41667r) && z15) {
                    z19 = true;
                } else {
                    z19 = false;
                }
        ...
        if (i16 == 3 && ChatObject.canBlockUsers(this.f41667r)) {
            vrVar = this;
            ...
            String str3 = str;
            vrVar = this;
            if (i16 == 0 && ChatObject.canBlockUsers(vrVar.f41667r)) {
                if (ChatObject.canAddUsers(vrVar.f41667r) && i15 > 0 && !ChatObject.isCommunity(vrVar.f41667r)) {
            ...
            } else if (i16 == 1 && ChatObject.canAddAdmins(vrVar.f41667r) && z11) {
                if (!vrVar.f41667r.creator && (tLObject instanceof TLRPC.TL_channelParticipantCreator)) {
                    j10 = j13;
                } else {
                    j10 = j13;
        ...
        H2.W(vrVar.f41635c.U0(view, false));
        H2.S = 190;
        if (H2.x() > 0) {
            z12 = true;
        } else {
    ...
    public final int k0() {
        TLRPC.ChatFull chatFull = this.f41670s;
        if (chatFull != null) {
    ...
    public final void onBecomeFullyHidden() {
        UndoView undoView = this.f41658n;
        if (undoView != null) {
            undoView.e(0, true);
        }
    }
    ...
    public final void onInsets(int i10, int i11, int i12, int i13) {
        this.f41635c.setPadding(0, 0, 0, i13);
        this.f41635c.setClipToPadding(false);
        this.f41658n.setTranslationY(-i13);
    }
    ...
    public final void onResume() {
        ...
        rr rrVar = this.f41629a;
        if (rrVar != null) {
            rrVar.l();
        }
        org.telegram.ui.Components.xw0 xw0Var = this.f41632b;
        if (xw0Var != null) {
    ...
    public final void onTransitionAnimationEnd(boolean z10, boolean z11) {
        ...
        if (z10 && !z11 && this.f41660n1) {
            this.f41643f.getSearchField().requestFocus();
            AndroidUtilities.showKeyboard(this.f41643f.getSearchField());
            this.f41643f.setVisibility(8);
        }
    }

    public final boolean p0(int i10) {
        if (i10 != this.V && i10 != this.W && i10 != this.X && i10 != this.Y && i10 != this.Z && i10 != this.f41630a0 && i10 != this.f41654k0 && i10 != this.f41633b0 && i10 != this.f41636c0 && i10 != this.f41638d0) {
            return false;
        }
        return true;
    }
    ...
    public final void r0() {
        ...
        if (!this.Q) {
            ...
            if (z10 && i11 == 2) {
            ...
            } else if (!ChatObject.isChannel(this.f41667r)) {
                this.Q = false;
                arrayList3.clear();
                arrayList.clear();
                arrayList2.clear();
                ...
                iVar.b();
                if (i11 == 1) {
                    TLRPC.ChatFull chatFull2 = this.f41670s;
                    if (chatFull2 != null && (chatParticipants = chatFull2.participants) != null) {
                        int size3 = chatParticipants.participants.size();
                        while (i10 < size3) {
                            TLRPC.ChatParticipant chatParticipant = this.f41670s.participants.participants.get(i10);
                ...
                } else if (i11 == 2 && (chatFull = this.f41670s) != null && chatFull.participants != null) {
                    long j3 = getUserConfig().clientUserId;
                    int size4 = this.f41670s.participants.participants.size();
                    while (i10 < size4) {
                        TLRPC.ChatParticipant chatParticipant2 = this.f41670s.participants.participants.get(i10);
                        int i14 = this.f41642e1;
                ...
                rr rrVar2 = this.f41629a;
                if (rrVar2 != null) {
                    rrVar2.l();
                }
                B0();
                rr rrVar3 = this.f41629a;
                if (rrVar3 != null) {
                    rrVar3.l();
                }
            } else {
    ...
    public final ArrayList s0() {
        ...
        if (i10 == 0) {
            ...
            TLRPC.ChatFull chatFull = this.f41670s;
            if (chatFull != null && chatFull.participants_count <= 200 && (chat = this.f41667r) != null && chat.megagroup) {
                tL_channels_getParticipants.filter = new TLRPC.TL_channelParticipantsRecent();
            } else if (this.f41642e1 == 1) {
                if (!this.J) {
                    this.f41655k1 = 2;
    ...
    public final void v0(long j3) {
        ...
        for (int i10 = 0; i10 < 3; i10++) {
            ...
            if (tLObject != null) {
                ...
                if (this.O == 0 && (chatFull = this.f41670s) != null) {
        ...
        s4.h0 adapter = this.f41635c.getAdapter();
        ur urVar = this.f41640e;
        if (adapter == urVar) {
            hg.b2 b2Var = urVar.h;
    ...
    public final pr w0() {
        ...
        prVar.f39618b = this.f41639d1;
        prVar.f39623i = this.X0;
        prVar.f39624j = this.Y0;
        prVar.f39626l.clear();
        prVar.f39626l.addAll(this.G);
        prVar.h = this.V0;
        prVar.f39622g = this.U0;
        prVar.f39627m.clear();
        prVar.f39627m.addAll(this.H);
        prVar.f39620e = this.E0;
        prVar.f39621f = this.F0;
        prVar.f39625k.clear();
        prVar.f39625k.addAll(this.F);
        prVar.f(prVar.f39619c);
        return prVar;
    }
    ...
    public final void x0(TLRPC.ChatFull chatFull) {
        ...
        if (chatFull != null) {
            ...
            this.f41666q1 = k02;
            this.f41664p1 = k02;
            int i10 = this.f41670s.boosts_unrestrict;
            boolean z11 = false;
            if (i10 > 0) {
                z10 = true;
            } else {
    ...
    public final void y0(int i10) {
        if (!this.isPaused && this.B1) {
            if (this.f41635c.getAdapter() != this.f41629a || !this.R) {
                org.telegram.ui.Components.t00 t00Var = null;
                for (int i11 = 0; i11 < this.f41635c.getChildCount(); i11++) {
                    View childAt = this.f41635c.getChildAt(i11);
                    if (childAt instanceof org.telegram.ui.Components.t00) {
                        t00Var = childAt;
                    }
                }
                if (t00Var != null) {
                    this.f41635c.removeView(t00Var);
                    i10--;
                }
                this.f41635c.getViewTreeObserver().addOnPreDrawListener(new cr(this, t00Var, i10, 0));
            }
        }
    }
