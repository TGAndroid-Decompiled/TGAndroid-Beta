    ...
    public w5(y5 y5Var, Activity activity) {
        ...
        q1Var.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view) {
                ...
                int i10 = r2;
                w5 w5Var = this.f41789b;
                switch (i10) {
                    case 0:
                        y5 y5Var2 = w5Var.f42380a;
                        long j10 = y5Var2.M;
        ...
        if (MessagesController.getInstance(y5Var.N).giveawayGiftsPurchaseAvailable && ChatObject.hasAdminRights(y5Var.f43551d0)) {
