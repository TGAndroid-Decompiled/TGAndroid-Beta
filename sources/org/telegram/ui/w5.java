...
public final class w5 extends o20 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public boolean Y;
    public int Z;
    public final ArrayList f38532a0;
    public int f38533b0;
    public LimitPreviewView f38534c0;
    public final p5 f38535d0;
    public boolean f38536e0;
    public LinearLayout f38537f0;
    public final TLRPC.Chat f38538g0;
    public String f38539h0;
    public String f38540i0;
    public int f38541j0;
    public int f38542k0;
    public int f38543l0;
    public int m0;
    ...
    public w5(long j3) {
        ...
        this.f38532a0 = new ArrayList();
        this.f38533b0 = 0;
        this.f38535d0 = new p5(this);
        this.f38539h0 = "";
        this.f38540i0 = "";
        this.f38541j0 = 5;
        this.f38542k0 = 5;
        this.P = j3;
        this.f38538g0 = MessagesController.getInstance(i10).getChat(Long.valueOf(-j3));
    }
    ...
    public static void x0(w5 w5Var, Context context, View view, int i10) {
        ...
        if (view instanceof yg.b) {
            ...
            if (z11 && boost.stars > 0) {
                ...
                if (((!z12 && !z11) || boost.user_id < 0) && !boost.unclaimed) {
                    ...
                    tL_payments_checkedGiftCode.from_id = MessagesController.getInstance(UserConfig.selectedAccount).getPeer(-w5Var.f38538g0.f18083id);
                    int i11 = boost.date;
        ...
        if (((v5) w5Var.f38532a0.get(i10)).f15508a == 9) {
            if (w5Var.f38533b0 == 1) {
                z10 = true;
            }
    ...
    public final void C0(CountDownLatch countDownLatch, m5 m5Var) {
        ...
        tL_premium_getBoostsList.limit = this.f38542k0;
        tL_premium_getBoostsList.offset = this.f38539h0;
        int i10 = this.Q;
    ...
    public final void D0(CountDownLatch countDownLatch, m5 m5Var) {
        TL_stories.TL_premium_getBoostsList tL_premium_getBoostsList = new TL_stories.TL_premium_getBoostsList();
        tL_premium_getBoostsList.limit = this.f38541j0;
        tL_premium_getBoostsList.gifts = true;
        tL_premium_getBoostsList.offset = this.f38540i0;
        int i10 = this.Q;
        tL_premium_getBoostsList.peer = MessagesController.getInstance(i10).getInputPeer(this.P);
    ...
    public final void F0(boolean z10) {
        ...
        if (this.f38534c0 == null) {
            ...
            this.f38534c0 = limitPreviewView;
            limitPreviewView.f22077c0 = true;
            limitPreviewView.setDarkGradientProvider(new z0(this, 5));
        }
        if (this.f38534c0.getParent() != null) {
            ((ViewGroup) this.f38534c0.getParent()).removeView(this.f38534c0);
        }
        TL_stories.TL_premium_boostsStatus tL_premium_boostsStatus = this.R;
        if (tL_premium_boostsStatus != null) {
            this.f38534c0.e(tL_premium_boostsStatus, false);
            if (z10) {
                this.f38534c0.setAlpha(0.0f);
                this.f38534c0.animate().alpha(1.0f).start();
            }
        }
        TLRPC.Chat chat = this.f38538g0;
    ...
    public final void G0(boolean z10) {
        ...
        boolean z12;
        boolean z13;
        ArrayList arrayList = this.f38532a0;
            ...
            if (i15 == 0) {
                ...
                if (arrayList3.isEmpty()) {
                    ...
                    for (int i16 = 0; i16 < arrayList3.size(); i16++) {
                        ...
                        arrayList.add(new v5(boost, z12, this.f38533b0));
                    }
                    if (this.W) {
                ...
                if (arrayList4.isEmpty()) {
                    ...
                    for (int i17 = 0; i17 < arrayList4.size(); i17++) {
                        ...
                        arrayList.add(new v5(boost2, z11, this.f38533b0));
                    }
                    if (this.Y) {
                        arrayList.add(new og.a(9, true));
                    } else {
    ...
    public final View createView(Context context) {
        ...
        this.f35660c.setOnItemClickListener(new ai.n6(3, this, context));
        Activity parentActivity = getParentActivity();
        LinearLayout linearLayout = new LinearLayout(parentActivity);
        this.f38537f0 = linearLayout;
        linearLayout.setOrientation(1);
        this.f38537f0.addView(new ai.q2(parentActivity), w7.x5.t(100, 100, 17, 0, 120, 0, 0));
        ((ViewGroup) this.fragmentView).addView(this.f38537f0, w7.x5.e(-1, -2, 17));
        this.f38537f0.setAlpha(0.0f);
        if (this.R == null) {
            this.f38537f0.animate().alpha(1.0f).setDuration(200L).setStartDelay(500L).start();
            getMessagesController().getBoostsController().getBoostsStats(this.P, new n5(this, 1));
        } else {
            this.f38537f0.setVisibility(8);
            E0(null);
        }
        G0(false);
        return createView;
