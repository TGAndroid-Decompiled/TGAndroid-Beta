...
public final class c50 extends org.telegram.ui.Components.m30 {
    ...
    public final void n(int i10) {
        ...
        d60 d60Var = this.f32571n.f33829b;
        d60Var.f33026w0 = false;
        alertDialog$Builder.f18662a.R = LocaleController.getString(R.string.VoipGroupStartRecordingTitle);
        if (i10 == 0) {
            if (d60Var.f32936a1.call.rtmp_stream) {
                i13 = R.string.VoipGroupStartRecordingRtmpText;
            } else {
                i13 = R.string.VoipGroupStartRecordingText;
            }
            alertDialog$Builder.f18662a.T = LocaleController.getString(i13);
        ...
        alertDialog$Builder.f18662a.f18706y0 = false;
        EditTextBoldCursor editTextBoldCursor = new EditTextBoldCursor(getContext());
        editTextBoldCursor.setBackgroundDrawable(org.telegram.ui.ActionBar.h6.T(getContext(), org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19252nh, false), org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19271oh, false)));
