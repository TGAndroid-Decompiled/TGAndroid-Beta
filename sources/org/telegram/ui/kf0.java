...
public final class kf0 extends org.telegram.ui.Components.vv0 {
    public final yg0 E;
    public final org.telegram.ui.Components.bj0 f35260a;
    public final TextView f35261b;
    public final TextView f35262c;
    public final TextView d;
    public final TextView e;
    public final TextView f35263f;
    public w5 h;
    public Bundle f35264n;
    public String f35265r;
    public String f35266s;
    public String v;
    public int f35267w;
    public int f35268x;
    ...
    public final void m(Bundle bundle, boolean z10) {
        ...
        this.f35264n = bundle;
        this.f35265r = bundle.getString("phoneFormated");
        this.f35266s = bundle.getString("phoneHash");
        this.v = bundle.getString("code");
        this.f35267w = bundle.getInt("startTime");
        this.f35268x = bundle.getInt("waitTime");
        int i10 = R.string.ResetAccountInfo;
        gf.b c10 = gf.b.c();
        this.f35262c.setText(AndroidUtilities.replaceTags(LocaleController.formatString("ResetAccountInfo", i10, LocaleController.addNbsp(c10.b("+" + this.f35265r)))));
        o();
    ...
    public final void n() {
        ...
        this.f35261b.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i10, false));
        this.f35262c.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i10, false));
        this.f35263f.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i10, false));
    ...
    public final void o() {
        ...
        int i11;
        int i12;
        int i13 = this.f35268x;
        i10 = ((org.telegram.ui.ActionBar.o2) this.E).currentAccount;
        int currentTime = i13 - (ConnectionsManager.getInstance(i10).getCurrentTime() - this.f35267w);
        int i14 = 0;
        ...
        Boolean bool = this.f35269y;
        if (bool != null && bool.booleanValue() == z10) {
            return;
        }
        org.telegram.ui.Components.bj0 bj0Var = this.f35260a;
        if (!z10) {
        ...
        this.f35263f.setVisibility(i12);
        if (!z10) {
            i14 = 4;
        }
        this.d.setVisibility(i14);
        this.f35269y = Boolean.valueOf(z10);
    }
}
