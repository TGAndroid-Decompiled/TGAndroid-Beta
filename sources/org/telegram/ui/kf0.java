...
public final class kf0 extends org.telegram.ui.Components.vv0 {
    public final yg0 E;
    public final org.telegram.ui.Components.bj0 f35265a;
    public final TextView f35266b;
    public final TextView f35267c;
    public final TextView d;
    public final TextView e;
    public final TextView f35268f;
    public w5 h;
    public Bundle f35269n;
    public String f35270r;
    public String f35271s;
    public String v;
    public int f35272w;
    public int f35273x;
    public Boolean f35274y;
    ...
    public final void m(Bundle bundle, boolean z10) {
        ...
        this.f35269n = bundle;
        this.f35270r = bundle.getString("phoneFormated");
        this.f35271s = bundle.getString("phoneHash");
        this.v = bundle.getString("code");
        this.f35272w = bundle.getInt("startTime");
        this.f35273x = bundle.getInt("waitTime");
        int i10 = R.string.ResetAccountInfo;
        gf.b c10 = gf.b.c();
        this.f35267c.setText(AndroidUtilities.replaceTags(LocaleController.formatString("ResetAccountInfo", i10, LocaleController.addNbsp(c10.b("+" + this.f35270r)))));
        o();
    ...
    public final void n() {
        ...
        this.f35266b.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i10, false));
        this.f35267c.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i10, false));
        this.f35268f.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i10, false));
    ...
    public final void o() {
        ...
        int i11;
        int i12;
        int i13 = this.f35273x;
        i10 = ((org.telegram.ui.ActionBar.o2) this.E).currentAccount;
        int currentTime = i13 - (ConnectionsManager.getInstance(i10).getCurrentTime() - this.f35272w);
        int i14 = 0;
        ...
        Boolean bool = this.f35274y;
        if (bool != null && bool.booleanValue() == z10) {
            return;
        }
        org.telegram.ui.Components.bj0 bj0Var = this.f35265a;
        if (!z10) {
        ...
        this.f35268f.setVisibility(i12);
        if (!z10) {
            i14 = 4;
        }
        this.d.setVisibility(i14);
        this.f35274y = Boolean.valueOf(z10);
    }
}
