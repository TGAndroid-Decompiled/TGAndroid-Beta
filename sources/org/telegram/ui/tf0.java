...
public final class tf0 extends org.telegram.ui.Components.fw0 implements NotificationCenter.NotificationCenterDelegate {
    public static final int f38073t0 = 0;
    ...
    public int V;
    public int W;
    public final org.telegram.ui.Components.ij0 f38074a;
    public double f38075a0;
    public String f38076b;
    public double f38077b0;
    public String f38078c;
    public boolean f38079c0;
    public String d;
    public boolean f38080d0;
    public String e;
    public String f38081e0;
    public final yr f38082f;
    public final int f38083f0;
    public int f38084g0;
    public final org.telegram.ui.Components.voip.o2 h;
    public int f38085h0;
    public boolean f38086i0;
    public String f38087j0;
    public String f38088k0;
    public String f38089l0;
    public int m0;
    public final TextView f38090n;
    public String f38091n0;
    public Bundle f38092o0;
    public TLRPC.TL_auth_sentCode f38093p0;
    public boolean f38094q0;
    public final TextView f38095r;
    public final gf0 f38096r0;
    public final org.telegram.ui.Components.lj0 f38097s;
    public final qg0 f38098s0;
    public final rf0 v;
    public final zd0 f38099w;
    public final rf0 f38100x;
    public final FrameLayout f38101y;
    ...
    public static void o(tf0 tf0Var, Context context) {
        ...
        try {
            ...
            sb3.append(str3);
            sb3.append("\n");
            if (!TextUtils.isEmpty(tf0Var.f38081e0)) {
                sb3.append("Error: ");
                sb3.append(tf0Var.f38081e0);
                sb3.append("\n");
            }
            sb3.append("\n\n================================================\n");
            ...
            tf0Var.f38098s0.l1(LocaleController.getString(R.string.AppName), LocaleController.getString("NoMailInstalled", R.string.NoMailInstalled));
        }
    }
    ...
    public final void A(int i10) {
        ...
        if (ij0Var != null) {
            ...
            this.Q = true;
            org.telegram.ui.Components.ij0 ij0Var2 = this.f38074a;
            if (ij0Var2.f25068a0 != ij0Var2.e[0] - 1) {
                ij0Var2.f25092t0 = new mf0(this, i10, 0);
                return;
            }
            ij0Var.f25092t0 = new gf0(this, 3);
            org.telegram.ui.Components.lj0 lj0Var = this.f38097s;
    ...
    public final boolean c(boolean z10) {
        int i10;
        qg0 qg0Var = this.f38098s0;
        if (qg0Var.F != 0) {
            qg0Var.finishFragment();
            return false;
        }
        int i11 = this.f38085h0;
        if (i11 != 0) {
            ...
            a2Var.R = string;
            a2Var.T = AndroidUtilities.replaceTags(LocaleController.formatString("EditNumberInfo", R.string.EditNumberInfo, this.f38076b));
            ...
            tL_auth_cancelCode.phone_code_hash = this.f38078c;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (this.f38079c0) {
            yr yrVar = this.f38082f;
            if (yrVar.f40237f != null) {
                if (i10 == NotificationCenter.didReceiveSmsCode) {
                    yrVar.setText("" + objArr[0]);
                    h(null);
                } else if (i10 == NotificationCenter.didReceiveCall) {
                    String str = "" + objArr[0];
                    if (AndroidUtilities.checkPhonePattern(this.f38087j0, str)) {
                        if (!this.f38087j0.equals("*")) {
                            this.f38089l0 = str;
    ...
    public final void g() {
        ...
        this.f38086i0 = false;
        this.f38080d0 = false;
        if (this.f38085h0 != 0 && (bundle = this.H) != null) {
    ...
    public final void h(String str) {
        ...
        int i12;
        qg0 qg0Var = this.f38098s0;
        int i13 = qg0Var.f36885a;
        if (i13 == 11) {
            if (this.f38080d0) {
                return;
            }
        } else if (!this.f38080d0) {
        ...
        int i15 = qg0Var.f36885a;
        if (i15 < 1 || i15 > 4 || !yrVar.e) {
            this.f38080d0 = true;
            int i16 = this.f38083f0;
            if (i16 == 15) {
                NotificationCenter.getGlobalInstance().removeObserver(this, NotificationCenter.didReceiveSmsCode);
            } else if (i16 == 2) {
                AndroidUtilities.setWaitingForSms(false);
            ...
            if (i17 != 1) {
                if (i17 != 2) {
                    ...
                    tL_auth_signIn.phone_code_hash = this.f38078c;
                ...
                changephone.phone_code_hash = this.f38078c;
                w();
                yrVar.e = true;
            ...
            confirmphone.phone_code_hash = this.f38078c;
            w();
            yrVar.e = true;
            as[] asVarArr3 = yrVar.f40237f;
    ...
    @Override
    public final void j() {
        org.telegram.ui.Components.ij0 ij0Var = this.f38074a;
        if (ij0Var != null) {
            ij0Var.M(0);
        }
        AndroidUtilities.runOnUIThread(new gf0(this, 0), qg0.f36884t0);
    }
    ...
    public final void l(Bundle bundle) {
        String code = this.f38082f.getCode();
        int length = code.length();
        int i10 = this.f38083f0;
        if (length != 0) {
            bundle.putString("smsview_code_" + i10, code);
        }
        String str = this.f38089l0;
        if (str != null) {
    ...
    public final void n() {
        ...
        if (i12 != 15) {
            this.f38100x.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.q6, false));
        }
    ...
    public final void onConfigurationChanged(Configuration configuration) {
        ...
        yr yrVar = this.f38082f;
        if (yrVar != null && (asVarArr = yrVar.f40237f) != null) {
    ...
    public final void s() {
        ...
        this.S = new Timer();
        this.f38077b0 = System.currentTimeMillis();
    ...
    public final void x() {
        int i10;
        if (!this.f38080d0 && !this.f38086i0) {
            qg0 qg0Var = this.f38098s0;
            if (!qg0Var.f36903o0) {
                this.f38086i0 = true;
                this.v.invalidate();
                this.f38100x.invalidate();
                Bundle bundle = new Bundle();
                bundle.putString("phone", this.f38076b);
                bundle.putString("ephone", this.e);
                bundle.putString("phoneFormated", this.d);
                bundle.putInt("prevType", this.f38083f0);
                this.f38080d0 = true;
                TLRPC.TL_auth_resendCode tL_auth_resendCode = new TLRPC.TL_auth_resendCode();
                tL_auth_resendCode.phone_number = this.d;
                tL_auth_resendCode.phone_code_hash = this.f38078c;
                i10 = ((org.telegram.ui.ActionBar.m2) qg0Var).currentAccount;
    ...
    public final void y() {
        ...
        while (true) {
            ...
            yrVar.f40237f[i10].i(1.0f);
            i10++;
        }
        zd0 zd0Var = this.f38099w;
        if (zd0Var.getCurrentView() != this.E) {
            zd0Var.showNext();
        }
        yrVar.f40237f[0].requestFocus();
        if (this.f38083f0 == 11) {
            f7 = 3.5f;
        } else {
            f7 = 10.0f;
