...
public final class aj0 extends ca1 {
        ...
        if (this.f32617r.f33346c <= 0) {
            ...
            if (gVar.f11152t0.G) {
                ...
                if (this.f32618s == 4) {
                    ...
                    g(false);
                } else if (this.f32617r.f33348g == null) {
                } else {
                    f();
                    String str = this.f32617r.f33348g + "_" + selectedDate;
                    ...
                    tL_loadAsyncGraph.token = this.f32617r.f33348g;
                    if (selectedDate != 0) {
                    ...
                    ?? obj = new Object();
                    dj0Var.f33144w = obj;
                    dj0Var.f33140f.getClass();
                    obj.f37278a = RecyclerView.R(this);
                    gVar.f11152t0.d(true, false);
                    i10 = ((org.telegram.ui.ActionBar.m2) dj0Var).currentAccount;
                    int sendRequest = ConnectionsManager.getInstance(i10).sendRequest(tL_loadAsyncGraph, new aa(this, str, (Object) obj, 25), null, null, 0, dj0Var.f33132a.stats_dc, 1, true);
    ...
    public final void f() {
        bj0 bj0Var = this.v;
        dj0 dj0Var = bj0Var.d;
        ra1 ra1Var = dj0Var.f33144w;
        if (ra1Var != null) {
            ra1Var.f37279b = true;
        }
        int childCount = dj0Var.f33140f.getChildCount();
        for (int i10 = 0; i10 < childCount; i10++) {
            View childAt = bj0Var.d.f33140f.getChildAt(i10);
            if (childAt instanceof ca1) {
                ((ca1) childAt).f32613b.f11152t0.d(false, true);
            }
        }
    }
