...
public final class aj0 extends org.telegram.ui.Components.fo {
    public final ej0 f32165v0;

    public aj0(ej0 ej0Var, Context context) {
        super(context, null, false, null);
        this.f32165v0 = ej0Var;
    }

    @Override
    public final void dispatchDraw(Canvas canvas) {
        super.dispatchDraw(canvas);
        ej0 ej0Var = this.f32165v0;
        ej0Var.W.setImageCoords(ej0Var.f33404b0.getAvatarImageView().getX(), ej0Var.f33404b0.getAvatarImageView().getY(), ej0Var.f33404b0.getAvatarImageView().getWidth(), ej0Var.f33404b0.getAvatarImageView().getHeight());
        if (ej0Var.Y) {
            canvas.save();
    ...
    public final void onAttachedToWindow() {
        ...
        this.f32165v0.W.onAttachedToWindow();
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        this.f32165v0.W.onDetachedFromWindow();
    }
}
