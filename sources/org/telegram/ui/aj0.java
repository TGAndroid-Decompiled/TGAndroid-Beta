...
public final class aj0 extends ca1 {
        ...
        if (this.f32616r.f33345c <= 0) {
            ...
            if (gVar.f11152t0.G) {
                ...
                if (this.f32617s == 4) {
                    ...
                    ?? obj = new Object();
                    dj0Var.f33143w = obj;
                    dj0Var.f33139f.getClass();
                    obj.f37277a = RecyclerView.R(this);
                    gVar.f11152t0.d(true, false);
                    i10 = ((org.telegram.ui.ActionBar.m2) dj0Var).currentAccount;
                    int sendRequest = ConnectionsManager.getInstance(i10).sendRequest(tL_loadAsyncGraph, new aa(this, str, (Object) obj, 25), null, null, 0, dj0Var.f33131a.stats_dc, 1, true);
    ...
    public final void f() {
        bj0 bj0Var = this.v;
        dj0 dj0Var = bj0Var.d;
        ra1 ra1Var = dj0Var.f33143w;
        if (ra1Var != null) {
            ra1Var.f37278b = true;
        }
        int childCount = dj0Var.f33139f.getChildCount();
        for (int i10 = 0; i10 < childCount; i10++) {
            View childAt = bj0Var.d.f33139f.getChildAt(i10);
            if (childAt instanceof ca1) {
                ((ca1) childAt).f32612b.f11152t0.d(false, true);
            }
        }
    }
