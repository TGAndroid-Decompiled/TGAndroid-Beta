...
public final class t01 extends View {
    ...
    public t01(ProfileActivity profileActivity, Context context) {
        ...
        z4.a adapter = profileActivity.f31615n0.getAdapter();
        ...
        ofFloat.addListener(new c70(5, this, profileActivity.f31616n1));
        profileActivity.f31615n0.b(new s01(this));
        adapter.f48382a.registerObserver(new h1.a(this, 2));
    }
    ...
    public final void a(boolean z10) {
        ...
        float measureText = this.f37905b.measureText(((String) this.f37907f.d(profileActivity.f31615n0.getCurrentItem())).toString());
    ...
    public final void b(float f7) {
        boolean z10;
        ProfileActivity profileActivity = this.f37908n;
        if (profileActivity.f31631p2 && profileActivity.f31615n0.getRealCount() > 20) {
            z10 = true;
        } else {
            z10 = false;
        }
    ...
    public final void c() {
        gz0 gz0Var;
        ProfileActivity profileActivity = this.f37908n;
        if (profileActivity.T0 != null && (gz0Var = profileActivity.f31615n0) != null && profileActivity.f31631p2) {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        canvas.drawText(((String) this.f37907f.d(this.f37908n.f31615n0.getCurrentItem())).toString(), rectF.centerX(), AndroidUtilities.dpf2(18.5f) + rectF.top, this.f37905b);
    }
