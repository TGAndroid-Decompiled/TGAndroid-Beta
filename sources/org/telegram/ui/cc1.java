...
public final class cc1 extends LinearLayout {
    ...
    public void dispatchDraw(Canvas canvas) {
        switch (this.f32752a) {
            case 12:
                ...
                return;
            case 18:
                xh.p1 p1Var = (xh.p1) this.f32753b;
                RectF rectF = p1Var.h;
                RectF rectF2 = p1Var.f46061f;
                RectF rectF3 = p1Var.e;
                Paint paint = p1Var.f46062n;
                paint.setColor(org.telegram.ui.ActionBar.i6.l1(0.1f, org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18816c6, false)));
                float d = p1Var.f46060c.d(p1Var.f46059b, false);
                double d10 = d;
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        switch (this.f32752a) {
            case 1:
                if (!((di.i) this.f32753b).f7760e0) {
                    return false;
                }
                return super.dispatchTouchEvent(motionEvent);
            case 9:
                ScrollSlidingTextTabStrip scrollSlidingTextTabStrip = (ScrollSlidingTextTabStrip) this.f32753b;
                SparseIntArray sparseIntArray = scrollSlidingTextTabStrip.O;
                if (scrollSlidingTextTabStrip.f22165b != null && scrollSlidingTextTabStrip.f22180n0) {
                    if (motionEvent.getAction() == 0) {
                        ...
                        scrollSlidingTextTabStrip.f22168c0 = view;
                        if (view != null && getParent() != null) {
                            sparseIntArray.get(indexOfChild(scrollSlidingTextTabStrip.f22168c0));
                            scrollSlidingTextTabStrip.f22165b.getClass();
                            scrollSlidingTextTabStrip.f22168c0 = null;
                            return super.dispatchTouchEvent(motionEvent);
                        }
                    } else if (motionEvent.getAction() == 2) {
                        View view2 = scrollSlidingTextTabStrip.f22168c0;
                        if (view2 != null) {
                            view2.setTranslationX(motionEvent.getX() - 0.0f);
                            int indexOfChild = indexOfChild(scrollSlidingTextTabStrip.f22168c0);
                            if (scrollSlidingTextTabStrip.f22179n == indexOfChild) {
                            ...
                            float width = (scrollSlidingTextTabStrip.f22168c0.getWidth() / 2.0f) + scrollSlidingTextTabStrip.f22168c0.getX();
                            int width2 = scrollSlidingTextTabStrip.f22168c0.getWidth();
                            if (width < 0.0f) {
                                i10 = 0;
                            } else {
                                i10 = 0;
                            ...
                            if (i10 != indexOfChild) {
                                org.telegram.ui.Components.lm0 lm0Var = scrollSlidingTextTabStrip.f22165b;
                                sparseIntArray.get(i10);
                                lm0Var.getClass();
                            }
                        }
                    } else if (motionEvent.getAction() == 1) {
                        View view3 = scrollSlidingTextTabStrip.f22168c0;
                        if (view3 != null) {
                            view3.animate().translationX(0.0f).translationY(0.0f).setDuration(320L).setUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) {
                                ...
                                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                                    switch (r2) {
                                        case 0:
                                            cc1 cc1Var = this.f25376b;
                                            cc1Var.invalidate();
                                            ((ScrollSlidingTextTabStrip) cc1Var.f32753b).invalidate();
                                            return;
                                        default:
                                            cc1 cc1Var2 = this.f25376b;
                                            cc1Var2.invalidate();
                                            ((ScrollSlidingTextTabStrip) cc1Var2.f32753b).invalidate();
                                            return;
                                    }
                                }
                        ...
                        View view4 = scrollSlidingTextTabStrip.f22168c0;
                        if (view4 != null) {
                    ...
                    if (scrollSlidingTextTabStrip.f22168c0 != null || super.dispatchTouchEvent(motionEvent)) {
                        return true;
                    }
                    return false;
                }
                return super.dispatchTouchEvent(motionEvent);
            case 19:
                if (!((yh.w3) this.f32753b).U.c(0)) {
                    return false;
                }
                return super.dispatchTouchEvent(motionEvent);
            case 20:
                if (!((yh.x7) this.f32753b).f47946f0) {
                    return false;
                }
                return super.dispatchTouchEvent(motionEvent);
            default:
    ...
    public boolean drawChild(Canvas canvas, View view, long j3) {
        switch (this.f32752a) {
            case 5:
                if (view == ((org.telegram.ui.Components.c9) this.f32753b).f22979a) {
                    return true;
                }
                return super.drawChild(canvas, view, j3);
            case 8:
                org.telegram.ui.Components.im0 im0Var = (org.telegram.ui.Components.im0) this.f32753b;
                if (view instanceof org.telegram.ui.Components.dx0) {
                    ((org.telegram.ui.Components.dx0) view).a(im0Var.f25072i0);
                }
                if (view == im0Var.f25083s) {
                    return true;
                }
                return super.drawChild(canvas, view, j3);
            case 13:
                boolean drawChild = super.drawChild(canvas, view, j3);
                l70 l70Var = (l70) this.f32753b;
                ...
                return drawChild;
            case 17:
                rg.k1 k1Var = ((rg.j1) this.f32753b).f42331c;
                if (view == k1Var.f42356r0 && k1Var.H0) {
                    return true;
                }
                return super.drawChild(canvas, view, j3);
            default:
    ...
    public void invalidate() {
        switch (this.f32752a) {
            case 0:
                ...
                int i10 = 0;
                while (true) {
                    org.telegram.ui.Cells.y0[] y0VarArr = (org.telegram.ui.Cells.y0[]) this.f32753b;
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        switch (this.f32752a) {
            case 16:
                ...
                accessibilityNodeInfo.setVisibleToUser(((ui1) this.f32753b).B0);
                return;
            default:
                super.onInitializeAccessibilityNodeInfo(accessibilityNodeInfo);
                return;
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        switch (this.f32752a) {
            case 4:
                return org.telegram.ui.ActionBar.v4.b((org.telegram.ui.ActionBar.v4) this.f32753b);
            default:
        ...
        switch (this.f32752a) {
            case 6:
                ...
                for (int i15 = 0; i15 < getChildCount(); i15++) {
                    ...
                    if (childAt != ((org.telegram.ui.Components.aw) this.f32753b).f22490s.F && childAt != null) {
                ...
                return;
            case 7:
                ((org.telegram.ui.Components.b20) this.f32753b).f22566c.a(getMeasuredWidth());
            ...
            case 9:
                ...
                if (scrollSlidingTextTabStrip.f22178l0 && sparseIntArray.indexOfKey(scrollSlidingTextTabStrip.f22181r) >= 0 && scrollSlidingTextTabStrip.f22163a.getChildAt(sparseIntArray.get(scrollSlidingTextTabStrip.f22181r)) != null) {
                    scrollSlidingTextTabStrip.i(sparseIntArray.get(scrollSlidingTextTabStrip.f22181r), false);
                    scrollSlidingTextTabStrip.f22178l0 = false;
                    return;
                }
                return;
        }
    ...
    public void onMeasure(int i10, int i11) {
        ...
        switch (this.f32752a) {
            ...
            case 2:
                ...
                ii.d2 d2Var = (ii.d2) this.f32753b;
                ...
                LinearLayout linearLayout2 = d2Var.f11314n0;
                if (linearLayout2 != null) {
                    ...
                    ViewGroup.MarginLayoutParams marginLayoutParams2 = (ViewGroup.MarginLayoutParams) d2Var.f11314n0.getLayoutParams();
                    paddingRight += d2Var.f11314n0.getMeasuredWidth() + marginLayoutParams2.leftMargin + marginLayoutParams2.rightMargin;
                }
                LinearLayout linearLayout3 = d2Var.f11315o0;
                if (linearLayout3 != null) {
                    ...
                    ViewGroup.MarginLayoutParams marginLayoutParams3 = (ViewGroup.MarginLayoutParams) d2Var.f11315o0.getLayoutParams();
                    paddingRight += d2Var.f11315o0.getMeasuredWidth() + marginLayoutParams3.leftMargin + marginLayoutParams3.rightMargin;
                }
                d2Var.f11311k0 = Math.max(0, size2 - paddingRight);
                super.onMeasure(i10, i11);
                return;
            case 3:
                int size3 = View.MeasureSpec.getSize(i10);
                int paddingRight2 = getPaddingRight() + getPaddingLeft();
                ii.b4 b4Var = (ii.b4) this.f32753b;
                ...
                return;
            case 4:
                org.telegram.ui.ActionBar.v4 v4Var = (org.telegram.ui.ActionBar.v4) this.f32753b;
                ...
                return;
            case 6:
                super.onMeasure(Math.max(View.MeasureSpec.getSize(i10), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(((org.telegram.ui.Components.aw) this.f32753b).f26179b.getChildCount() * 32), 1073741824)), i11);
                return;
            case 11:
                super.onMeasure(i10, i11);
                if (LocaleController.isRTL) {
                    ((org.telegram.ui.Components.t31) this.f32753b).f28046c.setPivotX(getMeasuredWidth());
                    return;
                }
                return;
            case 14:
                ...
                if (i14 != 0) {
                    ...
                    if (((PhotoViewer) this.f32753b).f30979j1.getVisibility() == 0) {
                        if (((PhotoViewer) this.f32753b).Y7 < 2) {
                            i12 = 48;
                        } else {
                            i12 = 64;
                        }
                        int max = Math.max(0, (min - AndroidUtilities.dp(i12)) / 2);
                        ((PhotoViewer) this.f32753b).f30979j1.setPadding(max, 0, max, 0);
                    }
            ...
            case 15:
                super.onMeasure(i10, i11);
                hh1 hh1Var = (hh1) this.f32753b;
                ViewGroup.MarginLayoutParams marginLayoutParams7 = (ViewGroup.MarginLayoutParams) hh1Var.f34272c.getLayoutParams();
                int i17 = 0;
                if (hh1Var.f34268a.getVisibility() == 8) {
    ...
    public void setAlpha(float f7) {
        switch (this.f32752a) {
            case 9:
                super.setAlpha(f7);
                ((ScrollSlidingTextTabStrip) this.f32753b).invalidate();
                return;
            default:
                super.setAlpha(f7);
                return;
    ...
    public void setVisibility(int i10) {
        switch (this.f32752a) {
            case 10:
                org.telegram.ui.Components.yw0 yw0Var = (org.telegram.ui.Components.yw0) this.f32753b;
                org.telegram.ui.Components.u9 u9Var = yw0Var.f30416b;
