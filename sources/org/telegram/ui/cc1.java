...
public final class cc1 implements RequestDelegate {
    public final int f33080a;
    public final jd1 f33081b;

    public cc1(jd1 jd1Var, int i10) {
        this.f33080a = i10;
        this.f33081b = jd1Var;
    }
    ...
    public final void run(final TLObject tLObject, TLRPC.TL_error tL_error) {
        switch (this.f33080a) {
            case 0:
                ...
                return;
            default:
                final jd1 jd1Var2 = this.f33081b;
                AndroidUtilities.runOnUIThread(new Runnable() {
                    @Override
                    public final void run() {
                        switch (r3) {
