...
public final class cc1 extends LinearLayout {
    ...
    public void dispatchDraw(Canvas canvas) {
        switch (this.f35070a) {
            case 12:
                ...
                return;
            case 18:
                yh.o1 o1Var = (yh.o1) this.f35071b;
                RectF rectF = o1Var.h;
                RectF rectF2 = o1Var.f50473f;
                RectF rectF3 = o1Var.f50472e;
                Paint paint = o1Var.f50474n;
                paint.setColor(org.telegram.ui.ActionBar.j6.l1(0.1f, org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20646c6, false)));
                float d = o1Var.f50471c.d(o1Var.f50470b, false);
                double d10 = d;
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        switch (this.f35070a) {
            case 1:
                if (!((ei.i) this.f35071b).f9135e0) {
                    return false;
                }
                return super.dispatchTouchEvent(motionEvent);
            case 9:
                ScrollSlidingTextTabStrip scrollSlidingTextTabStrip = (ScrollSlidingTextTabStrip) this.f35071b;
                SparseIntArray sparseIntArray = scrollSlidingTextTabStrip.O;
                if (scrollSlidingTextTabStrip.f24117b != null && scrollSlidingTextTabStrip.f24133n0) {
                    if (motionEvent.getAction() == 0) {
                        ...
                        scrollSlidingTextTabStrip.f24120c0 = view;
                        if (view != null && getParent() != null) {
                            sparseIntArray.get(indexOfChild(scrollSlidingTextTabStrip.f24120c0));
                            scrollSlidingTextTabStrip.f24117b.getClass();
                            scrollSlidingTextTabStrip.f24120c0 = null;
                            return super.dispatchTouchEvent(motionEvent);
                        }
                    } else if (motionEvent.getAction() == 2) {
                        View view2 = scrollSlidingTextTabStrip.f24120c0;
                        if (view2 != null) {
                            view2.setTranslationX(motionEvent.getX() - 0.0f);
                            int indexOfChild = indexOfChild(scrollSlidingTextTabStrip.f24120c0);
                            if (scrollSlidingTextTabStrip.f24132n == indexOfChild) {
                            ...
                            float width = (scrollSlidingTextTabStrip.f24120c0.getWidth() / 2.0f) + scrollSlidingTextTabStrip.f24120c0.getX();
                            int width2 = scrollSlidingTextTabStrip.f24120c0.getWidth();
                            if (width < 0.0f) {
                                i10 = 0;
                            } else {
                                i10 = 0;
                            ...
                            if (i10 != indexOfChild) {
                                org.telegram.ui.Components.lm0 lm0Var = scrollSlidingTextTabStrip.f24117b;
                                sparseIntArray.get(i10);
                                lm0Var.getClass();
                            }
                        }
                    } else if (motionEvent.getAction() == 1) {
                        View view3 = scrollSlidingTextTabStrip.f24120c0;
                        if (view3 != null) {
                            view3.animate().translationX(0.0f).translationY(0.0f).setDuration(320L).setUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) {
                                ...
                                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                                    switch (r2) {
                                        case 0:
                                            cc1 cc1Var = this.f27541b;
                                            cc1Var.invalidate();
                                            ((ScrollSlidingTextTabStrip) cc1Var.f35071b).invalidate();
                                            return;
                                        default:
                                            cc1 cc1Var2 = this.f27541b;
                                            cc1Var2.invalidate();
                                            ((ScrollSlidingTextTabStrip) cc1Var2.f35071b).invalidate();
                                            return;
                                    }
                                }
                        ...
                        View view4 = scrollSlidingTextTabStrip.f24120c0;
                        if (view4 != null) {
                    ...
                    if (scrollSlidingTextTabStrip.f24120c0 != null || super.dispatchTouchEvent(motionEvent)) {
                        return true;
                    }
                    return false;
                }
                return super.dispatchTouchEvent(motionEvent);
            case 19:
                if (!((zh.t3) this.f35071b).U.c(0)) {
                    return false;
                }
                return super.dispatchTouchEvent(motionEvent);
            case 20:
                if (!((zh.v7) this.f35071b).f52739f0) {
                    return false;
                }
                return super.dispatchTouchEvent(motionEvent);
            default:
    ...
    public boolean drawChild(Canvas canvas, View view, long j3) {
        switch (this.f35070a) {
            case 5:
                if (view == ((org.telegram.ui.Components.f9) this.f35071b).f25965a) {
                    return true;
                }
                return super.drawChild(canvas, view, j3);
            case 8:
                org.telegram.ui.Components.im0 im0Var = (org.telegram.ui.Components.im0) this.f35071b;
                if (view instanceof org.telegram.ui.Components.cx0) {
                    ((org.telegram.ui.Components.cx0) view).a(im0Var.f27178i0);
                }
                if (view == im0Var.f27189s) {
                    return true;
                }
                return super.drawChild(canvas, view, j3);
            case 13:
                boolean drawChild = super.drawChild(canvas, view, j3);
                l70 l70Var = (l70) this.f35071b;
                if (view == l70Var.f38209b && l70Var.f38217x != null) {
                    int measuredHeight = l70Var.f38215s.getMeasuredHeight();
                    l70Var.f38217x.setBounds(0, measuredHeight, getMeasuredWidth(), l70Var.f38217x.getIntrinsicHeight() + measuredHeight);
                    l70Var.f38217x.draw(canvas);
                }
                return drawChild;
            case 17:
                sg.o1 o1Var = ((sg.n1) this.f35071b).f46186c;
                if (view == o1Var.f46211r0 && o1Var.H0) {
                    return true;
                }
                return super.drawChild(canvas, view, j3);
            default:
    ...
    public void invalidate() {
        switch (this.f35070a) {
            case 0:
                ...
                int i10 = 0;
                while (true) {
                    org.telegram.ui.Cells.y0[] y0VarArr = (org.telegram.ui.Cells.y0[]) this.f35071b;
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        switch (this.f35070a) {
            case 16:
                ...
                accessibilityNodeInfo.setVisibleToUser(((ui1) this.f35071b).B0);
                return;
            default:
                super.onInitializeAccessibilityNodeInfo(accessibilityNodeInfo);
                return;
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        switch (this.f35070a) {
            case 4:
                return org.telegram.ui.ActionBar.v4.b((org.telegram.ui.ActionBar.v4) this.f35071b);
            default:
        ...
        switch (this.f35070a) {
            case 6:
                ...
                for (int i15 = 0; i15 < getChildCount(); i15++) {
                    ...
                    if (childAt != ((org.telegram.ui.Components.zv) this.f35071b).f33238s.F && childAt != null) {
                ...
                return;
            case 7:
                ((org.telegram.ui.Components.b20) this.f35071b).f24519c.a(getMeasuredWidth());
            ...
            case 9:
                ...
                if (scrollSlidingTextTabStrip.f24131l0 && sparseIntArray.indexOfKey(scrollSlidingTextTabStrip.f24134r) >= 0 && scrollSlidingTextTabStrip.f24115a.getChildAt(sparseIntArray.get(scrollSlidingTextTabStrip.f24134r)) != null) {
                    scrollSlidingTextTabStrip.i(sparseIntArray.get(scrollSlidingTextTabStrip.f24134r), false);
                    scrollSlidingTextTabStrip.f24131l0 = false;
                    return;
                }
                return;
        }
    ...
    public void onMeasure(int i10, int i11) {
        ...
        switch (this.f35070a) {
            ...
            case 2:
                ...
                ji.c2 c2Var = (ji.c2) this.f35071b;
            ...
            case 3:
                ...
                ji.a4 a4Var = (ji.a4) this.f35071b;
                ...
                return;
            case 4:
                org.telegram.ui.ActionBar.v4 v4Var = (org.telegram.ui.ActionBar.v4) this.f35071b;
                ...
                return;
            case 6:
                super.onMeasure(Math.max(View.MeasureSpec.getSize(i10), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(((org.telegram.ui.Components.zv) this.f35071b).f28471b.getChildCount() * 32), 1073741824)), i11);
                return;
            case 11:
                super.onMeasure(i10, i11);
                if (LocaleController.isRTL) {
                    ((org.telegram.ui.Components.s31) this.f35071b).f30184c.setPivotX(getMeasuredWidth());
                    return;
                }
                return;
            case 14:
                ...
                if (i14 != 0) {
                    ...
                    if (((PhotoViewer) this.f35071b).f33595j1.getVisibility() == 0) {
                        if (((PhotoViewer) this.f35071b).X7 < 2) {
                            i12 = 48;
                        } else {
                            i12 = 64;
                        }
                        int max = Math.max(0, (min - AndroidUtilities.dp(i12)) / 2);
                        ((PhotoViewer) this.f35071b).f33595j1.setPadding(max, 0, max, 0);
                    }
            ...
            case 15:
                super.onMeasure(i10, i11);
                hh1 hh1Var = (hh1) this.f35071b;
                ViewGroup.MarginLayoutParams marginLayoutParams7 = (ViewGroup.MarginLayoutParams) hh1Var.f37007c.getLayoutParams();
                int i17 = 0;
                if (hh1Var.f37003a.getVisibility() == 8) {
    ...
    public void setAlpha(float f7) {
        switch (this.f35070a) {
            case 9:
                super.setAlpha(f7);
                ((ScrollSlidingTextTabStrip) this.f35071b).invalidate();
                return;
            default:
                super.setAlpha(f7);
                return;
    ...
    public void setVisibility(int i10) {
        switch (this.f35070a) {
            case 10:
                org.telegram.ui.Components.xw0 xw0Var = (org.telegram.ui.Components.xw0) this.f35071b;
                org.telegram.ui.Components.x9 x9Var = xw0Var.f32754b;
