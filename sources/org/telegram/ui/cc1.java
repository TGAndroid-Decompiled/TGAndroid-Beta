...
public final class cc1 extends org.telegram.ui.Cells.pa {
    ...
    public void A1(org.telegram.ui.ActionBar.i6 i6Var) {
        ...
        switch (this.j3) {
            case 0:
                fc1 fc1Var = ((fc1) this.f32633k3).e.f31793a;
                ThemeActivity themeActivity = fc1Var.e;
                if (themeActivity.getParentActivity() != null) {
                    if ((i6Var.F == null || i6Var.U) && themeActivity.f31801f != 1) {
    ...
    public final void B1() {
        ...
        switch (this.j3) {
            case 0:
                ((fc1) this.f32633k3).e.A0(false);
                return;
            default:
                runnable = ((org.telegram.ui.ActionBar.a3) this.f32633k3).f18627a.dismissRunnable;
                runnable.run();
                return;
        }
    }
