...
public final class he1 extends FrameLayout {
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        switch (this.f34144a) {
            case 0:
                ke1 ke1Var = this.f34145b;
                if (ke1Var.f35082x > 0.0f && ke1Var.v != null) {
                    ke1Var.f35081w.reset();
                    float width = getWidth() / ke1Var.f35079r.getWidth();
                    ke1Var.f35081w.postScale(width, width);
                    ke1Var.f35080s.setLocalMatrix(ke1Var.f35081w);
                    ke1Var.v.setAlpha((int) (ke1Var.f35082x * 255.0f));
                    canvas2 = canvas;
    ...
    public boolean drawChild(Canvas canvas, View view, long j3) {
        switch (this.f34144a) {
            case 1:
                ...
                canvas.save();
                canvas.clipRect(0.0f, AndroidUtilities.lerp(ke1Var.L, 0.0f, ke1Var.f35082x), getWidth(), AndroidUtilities.lerp(ke1Var.M, getHeight(), ke1Var.f35082x));
    ...
    public void onSizeChanged(int i10, int i11, int i12, int i13) {
        switch (this.f34144a) {
            case 0:
                ...
                ke1 ke1Var = this.f34145b;
                gh.d.c(ke1Var.E, ke1Var.f35071b);
                ke1Var.F.d();
                return;
            default:
                super.onSizeChanged(i10, i11, i12, i13);
