        ...
        if (i11 >= 23 && AndroidUtilities.isSimAvailable()) {
            ...
            if (qg0Var.v) {
                ...
                if (!qg0Var.f36906r.isEmpty()) {
                    ...
                    if (!z10 && (!z11 || !z12)) {
                        alertDialog$Builder.f18661a.T = LocaleController.getString("AllowReadCallAndLog", R.string.AllowReadCallAndLog);
                        i10 = R.raw.calls_log;
                    } else if (z11 && z12) {
                        alertDialog$Builder.f18661a.T = LocaleController.getString("AllowReadCall", R.string.AllowReadCall);
                        i10 = R.raw.incoming_calls;
                    } else {
                        alertDialog$Builder.f18661a.T = LocaleController.getString("AllowReadCallLog", R.string.AllowReadCallLog);
                        i10 = R.raw.calls_log;
                    }
                    alertDialog$Builder.m(i10, 46, org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.L5, false), null);
                    qg0Var.h = qg0Var.showDialog(alertDialog$Builder.f18661a);
                    pg0Var.L = true;
                    return;
                }
            }
