        ...
        switch (i13) {
            case 0:
                ...
                if (j10 != 0) {
                    ...
                    profileActivity.getMessagesController().deleteParticipantFromChat(profileActivity.f31294f1, user);
                    ...
                    if (profileActivity.f31397u2.participants.participants.remove(chatParticipant)) {
                ...
                if (AndroidUtilities.isTablet()) {
                    i10 = 0;
                    profileActivity.getNotificationCenter().lambda$postNotificationNameOnUIThread$1(i14, Long.valueOf(-profileActivity.f31294f1));
                } else {
                    i10 = 0;
                    profileActivity.getNotificationCenter().lambda$postNotificationNameOnUIThread$1(i14, new Object[0]);
                }
                profileActivity.getMessagesController().deleteParticipantFromChat(profileActivity.f31294f1, profileActivity.getMessagesController().getUser(Long.valueOf(profileActivity.getUserConfig().getClientUserId())));
            ...
            case 3:
                ...
                profileActivity3.E2 = profileActivity3.getMessagesStorage().getChat(profileActivity3.f31294f1);
            ...
            case 5:
                ...
                ((org.telegram.ui.Cells.r8) ((View) obj)).setChecked(profileActivity5.f31383s2.g());
                return;
            case 6:
                ProfileActivity profileActivity6 = (ProfileActivity) obj2;
                if (!((boolean[]) obj)[0] && (t8Var = profileActivity6.f31422x5) != null) {
                    t8Var.run();
                }
                profileActivity6.f31422x5 = null;
                return;
            case 7:
                mz0 mz0Var = (mz0) obj2;
                a0.i iVar = (a0.i) obj;
                ProfileActivity profileActivity7 = mz0Var.f35914b1.f36191c;
                Activity parentActivity = profileActivity7.getParentActivity();
                l01 l01Var = profileActivity7.f31343m5;
                int m10 = iVar.m();
                if (iVar.m() == 1) {
            ...
            case 8:
                a01 a01Var = (a01) obj2;
                a0.i iVar2 = (a0.i) obj;
                ProfileActivity profileActivity8 = a01Var.f31663b1;
                Activity parentActivity2 = profileActivity8.getParentActivity();
                l01 l01Var2 = profileActivity8.f31343m5;
                int m11 = iVar2.m();
                if (iVar2.m() == 1) {
            ...
            case 11:
                ...
                int i16 = 0;
                while (true) {
                    k11[] k11VarArr = l11Var.f35421c;
                    if (i16 < k11VarArr.length) {
                        k11 k11Var = k11VarArr[i16];
                        if (k11Var != null) {
                            String str6 = k11Var.f34976a;
            ...
            case 16:
                ...
                c41Var.f32665b = (TLRPC.TL_channels_sponsoredMessageReportResultChooseOption) obj;
                c41Var.f32666c = null;
                c41Var.d = null;
                c41Var.f32667f.Y2.N(false);
                return;
            case 17:
            ...
            case 18:
                ...
                c41Var2.f32665b = null;
                c41Var2.f32666c = (TLRPC.TL_reportResultChooseOption) obj;
                c41Var2.d = null;
                c41Var2.f32667f.Y2.N(false);
                return;
            case 19:
            ...
            case 21:
                ...
                ((fv0) obj).f33767a.setVisible(false, true);
                return;
            case 22:
            ...
            case 26:
                z81 z81Var = (z81) obj2;
                a0.i iVar3 = (a0.i) obj;
                g91 g91Var = z81Var.f40161b1;
                Activity parentActivity3 = g91Var.getParentActivity();
                y8 y8Var = g91Var.f33923b;
                int m12 = iVar3.m();
                if (iVar3.m() == 1) {
