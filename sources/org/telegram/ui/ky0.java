...
public final class ky0 implements RequestDelegate {
    public final int f35163a;
    public final ProfileActivity f35164b;

    public ky0(ProfileActivity profileActivity, int i10) {
        this.f35163a = i10;
        this.f35164b = profileActivity;
    }
    ...
    public final void run(final TLObject tLObject, final TLRPC.TL_error tL_error) {
        switch (this.f35163a) {
            case 0:
                final ProfileActivity profileActivity = this.f35164b;
                ...
                return;
            case 1:
                final ProfileActivity profileActivity2 = this.f35164b;
                AndroidUtilities.runOnUIThread(new Runnable() {
                    @Override
                    public final void run() {
                        switch (r4) {
                ...
                return;
            case 2:
                final ProfileActivity profileActivity3 = this.f35164b;
                AndroidUtilities.runOnUIThread(new Runnable() {
                    @Override
                    public final void run() {
                        switch (r4) {
                ...
                return;
            case 3:
                final ProfileActivity profileActivity4 = this.f35164b;
                AndroidUtilities.runOnUIThread(new Runnable() {
                    @Override
                    public final void run() {
                        switch (r4) {
            ...
            case 4:
                if (tLObject != null) {
                    AndroidUtilities.runOnUIThread(new ix0(10, this.f35164b, tLObject));
                    return;
                }
                return;
            default:
                boolean z10 = tLObject instanceof TL_account.TL_password;
                ProfileActivity profileActivity5 = this.f35164b;
                if (z10) {
