...
public final class q7 extends g7 {
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        boolean z11;
        float f7;
        k7 k7Var = (k7) c1Var.f42627a;
        org.telegram.ui.Cells.i7 i7Var = (org.telegram.ui.Cells.i7) k7Var.f34589b.getChildAt(0);
        ...
        k7Var.setTag(aVar);
        s7 s7Var = this.f36305n;
        if (aVar.f49141f == null) {
            TLRPC.TL_message tL_message = new TLRPC.TL_message();
            tL_message.out = true;
            tL_message.f18104id = i10;
            ...
            tL_message.message = "";
            tL_message.attachPath = aVar.f49138a.getPath();
            TLRPC.TL_messageMediaDocument tL_messageMediaDocument = new TLRPC.TL_messageMediaDocument();
            tL_message.media = tL_messageMediaDocument;
            tL_messageMediaDocument.flags |= 3;
            tL_messageMediaDocument.document = new TLRPC.TL_document();
            tL_message.flags |= 768;
            tL_message.dialog_id = aVar.f49139b;
            String fileExtension = FileLoader.getFileExtension(aVar.f49138a);
        ...
        if (i7Var.f20232f0 != z13) {
            i7Var.f20232f0 = z13;
            i7Var.invalidate();
        }
        k7Var.d = z11;
        k7Var.f34590c.setText(AndroidUtilities.formatFileSize(aVar.f49140c));
        k7Var.f34588a.a(this.f36305n.f37140f.f49149j.contains(aVar), z10);
    }
