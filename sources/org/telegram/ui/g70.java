...
public class g70 extends org.telegram.ui.ActionBar.o2 implements NotificationCenter.NotificationCenterDelegate, le.d, View.OnClickListener, ph.d {
    ...
    public ArrayList f33868a0;
    public final le.e f33869b;
    public org.telegram.ui.Components.m30 f33870b0;
    public final le.b f33871c;
    public int f33872c0;
    public ai.n4 d;
    public org.telegram.ui.Components.ae0 f33873d0;
    public ci.s6 e;
    public boolean f33874e0;
    public org.telegram.ui.Components.b20 f33875f;
    public final HashSet f33876f0;
    public boolean f33877g0;
    public y60 h;
    public boolean f33878h0;
    public ArrayList f33879i0;
    public boolean f33880j0;
    public boolean f33881k0;
    public int f33882l0;
    public int m0;
    public org.telegram.ui.Components.ml0 f33883n;
    public int f33884n0;
    public final Rect f33885o0;
    public final ah.i f33886p0;
    public final fh.d f33887q0;
    public s4.c0 f33888r;
    public ah.o f33889r0;
    public org.telegram.ui.Components.zw0 f33890s;
    public final ArrayList f33891s0;
    public final RectF f33892t0;
    public final RectF f33893u0;
    public e70 v;
    public c70 f33894w;
    public b70 f33895x;
    public org.telegram.ui.Components.y10 f33896y;
    ...
    public g70(Bundle bundle) {
        ...
        this.f33869b = new le.e(3, this, qrVar, 350L);
        this.f33871c = new le.b(4, this, qrVar, 350L, false);
        this.Z = new a0.i();
        this.f33868a0 = new ArrayList();
        this.f33876f0 = new HashSet();
        this.f33882l0 = -4;
        this.f33885o0 = new Rect();
        ArrayList arrayList = new ArrayList(2);
        this.f33891s0 = arrayList;
        RectF rectF = new RectF();
        this.f33892t0 = rectF;
        RectF rectF2 = new RectF();
        this.f33893u0 = rectF2;
        arrayList.add(rectF);
        ...
        if (i12 >= 31) {
            this.f33886p0 = new ah.i(false);
            this.f33887q0 = new fh.d(null);
            return;
        }
        this.f33886p0 = null;
        this.f33887q0 = null;
    ...
    public static void U(g70 g70Var, Context context, View view, int i10) {
        ...
        if (i10 == e70Var.f33308w) {
        ...
        } else if (i10 == 0 && e70Var.F != 0 && !e70Var.f33305n) {
            ...
            if (f4Var.f20086r) {
                ...
                if (m30Var == null) {
                    org.telegram.ui.Components.m30 m30Var2 = new org.telegram.ui.Components.m30(g70Var.f33875f.f22543r.getContext(), "premium");
                    g70Var.X = m30Var2;
                    g70Var.h.a(m30Var2);
                ...
                g70Var.k0();
            } else if (f4Var.f20087s) {
                org.telegram.ui.Components.m30 m30Var3 = g70Var.Y;
                if (m30Var3 == null) {
                    org.telegram.ui.Components.m30 m30Var4 = new org.telegram.ui.Components.m30(g70Var.f33875f.f22543r.getContext(), "miniapps");
                    g70Var.Y = m30Var4;
                    g70Var.h.a(m30Var4);
                ...
                if (iVar == null || iVar.h(j3) < 0) {
                    ...
                    if (m30Var5 != null) {
                        ...
                        org.telegram.ui.Components.m30 m30Var6 = new org.telegram.ui.Components.m30(g70Var.f33875f.f22543r.getContext(), object);
                        g70Var.h.a(m30Var6);
    ...
    public static void Z(g70 g70Var) {
        ...
        g70Var.f33871c.a(!g70Var.Z.i(), true);
    }

    public static void a0(g70 g70Var, Canvas canvas, RectF rectF, Paint paint) {
        fh.d dVar;
        canvas.drawRect(rectF, paint);
        if (Build.VERSION.SDK_INT >= 29 && SharedConfig.chatBlurEnabled() && (dVar = g70Var.f33887q0) != null) {
    ...
    public final void D(int i10, float f7, float f10, le.e eVar) {
        if (i10 == 3) {
            int paddingTop = this.f33883n.getPaddingTop();
            j0();
            org.telegram.ui.Components.b20 b20Var = this.f33875f;
            le.e eVar2 = this.f33869b;
            b20Var.setTranslationY(eVar2.e);
            i0();
            this.e.setTranslationY(AndroidUtilities.dp(48.0f) + eVar2.e);
            this.d.invalidate();
            int paddingTop2 = this.f33883n.getPaddingTop();
            if (paddingTop2 != paddingTop && !((le.b) this.e.f5517c).f13985f) {
                this.f33883n.scrollBy(0, paddingTop - paddingTop2);
            }
        } else if (i10 == 4) {
            g0();
            i0();
    ...
    public final View createView(Context context) {
        ...
        this.f33875f = new org.telegram.ui.Components.b20(context, this.resourceProvider);
        ...
        y60 y60Var2 = this.h;
        this.Z = y60Var2.f23729b;
        this.f33868a0 = y60Var2.f23730c;
        r0();
        this.f33875f.f22543r.setOnEditorActionListener(new ka(this, 4));
        this.f33875f.f22543r.setOnKeyListener(new z60(0, this));
        this.f33875f.f22543r.addTextChangedListener(new l0(this, 6));
        ArrayList arrayList = this.f33879i0;
        if (arrayList != null) {
            p0(arrayList, this.f33880j0, this.f33881k0);
        }
        ...
        this.f33890s.e(true, false);
        this.f33890s.d.setText(LocaleController.getString(R.string.NoResult));
        j0Var.addView(this.f33890s);
        this.f33888r = new s4.c0(1, false);
        org.telegram.ui.Components.ml0 ml0Var = new org.telegram.ui.Components.ml0(context, null);
        this.f33883n = ml0Var;
        ml0Var.setFastScrollEnabled(0);
        this.f33883n.setEmptyView(this.f33890s);
        org.telegram.ui.Components.ml0 ml0Var2 = this.f33883n;
        e70 e70Var = new e70(this, context);
        this.v = e70Var;
        ml0Var2.setAdapter(e70Var);
        this.f33883n.setLayoutManager(this.f33888r);
        this.f33883n.setVerticalScrollBarEnabled(false);
        this.f33883n.setClipToPadding(false);
        org.telegram.ui.Components.ml0 ml0Var3 = this.f33883n;
        ...
        org.telegram.ui.Components.ml0 ml0Var4 = this.f33883n;
        float f7 = -this.f33867a;
        j0Var.addView(ml0Var4, w7.x5.d(-1, -1.0f, 119, 0.0f, f7, 0.0f, f7));
        this.f33883n.setOnItemClickListener(new ai.o6(17, this, context));
        this.f33883n.setOnScrollListener(new h3(this, 13));
        org.telegram.ui.Components.ml0 ml0Var5 = this.f33883n;
        ml0Var5.Y1 = true;
        ml0Var5.Z1 = 0;
        ...
        if (!z11 && !z12 && !z10) {
            ...
            this.f33896y.f30075c.setImageDrawable(h2Var);
        } else {
            y10Var.f30075c.setImageResource(R.drawable.floating_check);
        }
        if (!z13) {
            j0Var.addView(this.f33896y, org.telegram.ui.Components.y10.b());
        }
        this.f33896y.setOnClickListener(new x60(this, 1));
        this.f33896y.e(this.E, false);
        this.f33896y.setContentDescription(LocaleController.getString(R.string.Next));
        if (z13) {
        ...
        j0Var.addView(this.f33875f, w7.x5.d(-1, 40.0f, 48, 11.0f, 0.0f, 11.0f, 0.0f));
        j0Var.addView(this.h);
        org.telegram.ui.Components.ml0 ml0Var6 = this.f33883n;
        Objects.requireNonNull(ml0Var6);
        this.f33889r0 = new ah.o(ml0Var6, j0Var, new zs(ml0Var6, 0));
        this.f33883n.D0(new w60(this, 3));
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.contactsDidLoad) {
            ...
            if (this.f33883n != null) {
                ...
                int childCount = this.f33883n.getChildCount();
                if ((MessagesController.UPDATE_MASK_AVATAR & intValue) != 0 || (MessagesController.UPDATE_MASK_NAME & intValue) != 0 || (MessagesController.UPDATE_MASK_STATUS & intValue) != 0) {
                    for (int i12 = 0; i12 < childCount; i12++) {
                        View childAt = this.f33883n.getChildAt(i12);
    ...
    public final void e0() {
        ah.i iVar;
        int i10;
        if (Build.VERSION.SDK_INT >= 31 && (iVar = this.f33886p0) != null) {
            int dp = AndroidUtilities.dp(48.0f);
            float measuredHeight = this.actionBar.getMeasuredHeight() + AndroidUtilities.dp(48.0f) + this.f33872c0;
            RectF rectF = this.f33892t0;
            rectF.set(0.0f, 0.0f, this.fragmentView.getMeasuredWidth(), measuredHeight);
            float f7 = -dp;
            rectF.inset(0.0f, f7);
            if (this.F != null) {
                RectF rectF2 = this.f33893u0;
            ...
            if (this.F != null && this.f33871c.e > 0.0f) {
                i10 = 2;
            } else {
                i10 = 1;
            }
            iVar.g(i10, this.f33891s0);
            iVar.e(this.f33889r0, this.fragmentView.getMeasuredWidth(), this.fragmentView.getMeasuredHeight());
        }
    }
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f33883n, 32768, null, null, null, null, i11));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f33883n, 4096, null, null, null, null, org.telegram.ui.ActionBar.j6.f18952i6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f33883n, 33554432, null, null, null, null, org.telegram.ui.ActionBar.j6.f19009l7));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f33883n, 33554432, null, null, null, null, org.telegram.ui.ActionBar.j6.f19028m7));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f33883n, 33554432, null, null, null, null, org.telegram.ui.ActionBar.j6.f19048n7));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f33883n, 0, new Class[]{View.class}, org.telegram.ui.ActionBar.j6.f18984k0, null, null, org.telegram.ui.ActionBar.j6.f18863d7));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f33890s, 4, null, null, null, null, org.telegram.ui.ActionBar.j6.f18845c7));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f33890s, 2048, null, null, null, null, org.telegram.ui.ActionBar.j6.f18934h6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f33883n, 16, new Class[]{org.telegram.ui.Cells.e4.class}, null, null, null, org.telegram.ui.ActionBar.j6.e7));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f33883n, 0, new Class[]{org.telegram.ui.Cells.e4.class}, new String[]{"drawable"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.Zh));
        int i12 = org.telegram.ui.ActionBar.j6.f18817ai;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f33883n, 4, new Class[]{org.telegram.ui.Cells.e4.class}, new String[]{"textView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f33883n, 4, new Class[]{org.telegram.ui.Cells.f4.class}, new String[]{"textView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f33883n, 4, new Class[]{org.telegram.ui.Cells.f4.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f18953i7));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f33883n, 4, new Class[]{org.telegram.ui.Cells.f4.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f18971j7));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f33883n, 4, new Class[]{org.telegram.ui.Cells.f4.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f18991k7));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f33883n, 262148, new Class[]{org.telegram.ui.Cells.f4.class}, new String[]{"statusTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f19047n6));
        int i13 = org.telegram.ui.ActionBar.j6.f19244y6;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f33883n, 262148, new Class[]{org.telegram.ui.Cells.f4.class}, new String[]{"statusTextView"}, null, null, -1, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f33883n, 0, new Class[]{org.telegram.ui.Cells.f4.class}, null, org.telegram.ui.ActionBar.j6.f19112r0, null, org.telegram.ui.ActionBar.j6.J7));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.h.getSpansContainer(), 0, new Class[]{org.telegram.ui.Components.m30.class}, null, null, null, org.telegram.ui.ActionBar.j6.f18855ci));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.h.getSpansContainer(), 0, new Class[]{org.telegram.ui.Components.m30.class}, null, null, null, org.telegram.ui.ActionBar.j6.f18836bi));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.h.getSpansContainer(), 0, new Class[]{org.telegram.ui.Components.m30.class}, null, null, null, org.telegram.ui.ActionBar.j6.f18874di));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f33890s.d, 4, null, null, null, null, org.telegram.ui.ActionBar.j6.G6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f33890s.e, 4, null, null, null, null, i13));
        org.telegram.ui.Components.ae0 ae0Var = this.f33873d0;
        if (ae0Var != null) {
    ...
    public final void h0() {
        org.telegram.ui.Components.y10 y10Var = this.f33896y;
        if (y10Var != null) {
            y10Var.setTranslationY(-Math.max(this.m0, this.f33884n0));
        }
    }

    public final void i0() {
        if (this.f33883n.a1()) {
            this.f33883n.setClipBounds(null);
            return;
        }
        int i10 = this.m0;
        int i11 = this.f33867a;
        int measuredHeight = this.actionBar.getMeasuredHeight() + AndroidUtilities.dp(i11 + 48) + ((int) this.f33869b.e);
        int measuredWidth = this.f33883n.getMeasuredWidth();
        int B = org.telegram.messenger.w1.B(i11, this.f33883n.getMeasuredHeight(), (int) ((AndroidUtilities.dp(76.0f) + i10) * this.f33871c.e));
        Rect rect = this.f33885o0;
        rect.set(0, measuredHeight, measuredWidth, B);
        this.f33883n.setClipBounds(rect);
    }
    ...
    public final void j(r0.l1 l1Var) {
        this.f33884n0 = l1Var.f41877a.f(8).d;
        h0();
    }
    ...
    public final void j0() {
        ...
        org.telegram.ui.Components.ml0 ml0Var = this.f33883n;
        int i11 = this.f33867a;
        ml0Var.setPadding(0, this.actionBar.getMeasuredHeight() + AndroidUtilities.dp(i11 + 48) + ((int) this.f33869b.e), 0, AndroidUtilities.dp(i11) + this.m0 + i10);
        this.f33890s.setPadding(0, 0, 0, this.m0);
    }
    ...
    public final void k0() {
        ...
        for (int i10 = 0; i10 < childCount; i10++) {
            View childAt = this.f33883n.getChildAt(i10);
            if (childAt instanceof org.telegram.ui.Cells.f4) {
    ...
    public final void onClick(View view) {
        ...
        org.telegram.ui.Components.m30 m30Var2 = this.f33870b0;
        if (m30Var2 != null) {
            m30Var2.a();
        }
        this.f33870b0 = m30Var;
        m30Var.b();
    }
    ...
    public final void p0(ArrayList arrayList, boolean z10, boolean z11) {
        ...
        AndroidUtilities.updateVisibleRows(this.f33883n);
    }
    ...
    public final void q0(int i10) {
        ...
        AndroidUtilities.doOnPreDraw(this.f33883n, new org.telegram.ui.Components.id(this, i10, 16));
    }

    public final void r0() {
        e70 e70Var;
        ci.h2 h2Var = this.f33875f.f22543r;
        if (h2Var == null) {
            return;
        }
        if (this.M == 2) {
    ...
    public final void s0() {
        ...
        if (i10 != 2 && z11) {
            if (this.E && this.f33868a0.isEmpty()) {
                this.f33896y.e(false, true);
                this.E = false;
            } else if (!this.E && !this.f33868a0.isEmpty()) {
                this.f33896y.e(true, true);
                this.E = true;
            }
        }
    }
