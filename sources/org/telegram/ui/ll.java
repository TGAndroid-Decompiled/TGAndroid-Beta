    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        switch (this.M0) {
            case 3:
                ...
                if (isFocusable()) {
                    if (profileActivity.h != null || profileActivity.f31345n != null) {
                        StringBuilder sb2 = new StringBuilder(getText());
                        if (profileActivity.f31345n != null) {
                            if (sb2.length() > 0) {
                                sb2.append(", ");
                            }
                            sb2.append(profileActivity.f31345n);
                        }
        ...
        switch (this.M0) {
            case 0:
                ...
                if (this == boVar.D2[0] && boVar.H2[1] != null) {
                    if (boVar.O4 && f7 < 0.0f) {
                        boVar.f32533z2.setTranslationY(f7 / 2.0f);
                        return;
                    } else {
                        boVar.f32533z2.setTranslationY(0.0f);
                        return;
                    }
                }
                return;
