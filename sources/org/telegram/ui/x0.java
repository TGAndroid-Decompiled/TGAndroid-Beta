...
public final class x0 extends AnimatorListenerAdapter {
    ...
    public final void onAnimationEnd(Animator animator) {
        h4 h4Var = this.f39302b;
        ArrayList arrayList = h4Var.f34114d0;
        if (h4Var.f34116f0.f19990f) {
            ArrayList arrayList2 = new ArrayList();
            h4Var.f34130u0[0].setBackgroundDrawable(null);
            l3[] l3VarArr = h4Var.f34130u0;
            l3 l3Var = l3VarArr[1];
            l3VarArr[1] = l3VarArr[0];
            l3VarArr[0] = l3Var;
            h4Var.f34118h0.i();
            h4Var.Z0.a(h4Var.f34130u0[0].getBackgroundColor(), true);
            h4Var.f34111a1.a(h4Var.f34130u0[1].getBackgroundColor(), true);
            u3 u3Var = h4Var.K;
            if (u3Var != null) {
                u3Var.m();
            }
            for (int size = arrayList.size() - 1; size > this.f39301a; size--) {
                arrayList2.add(arrayList.remove(size));
            }
            h4Var.O0.T(h4Var.f34130u0[0].f35305b);
            org.telegram.ui.Cells.r9 r9Var = h4Var.O0;
            r9Var.E0 = h4Var.f34130u0[0].d;
            r9Var.f(true);
            h4Var.i0(false);
            h4Var.f0();
            h4Var.f34130u0[1].b();
        ...
        articleViewer$WindowView.f19990f = false;
