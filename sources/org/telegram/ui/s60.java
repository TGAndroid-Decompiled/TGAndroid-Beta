...
public final class s60 implements View.OnKeyListener {
    ...
    public final org.telegram.ui.ActionBar.m2 f37588c;
        ...
        switch (this.f37586a) {
            case 0:
                ...
                if (keyEvent.getAction() == 0) {
                    ...
                    this.f37587b = z10;
                    return false;
                } else if (keyEvent.getAction() != 1 || !this.f37587b || z60Var.f40351a0.isEmpty()) {
                    return false;
                } else {
                    z60Var.h.c((org.telegram.ui.Components.n30) hg.c.g(1, z60Var.f40351a0));
                    z60Var.s0();
                    z60Var.k0();
                    return true;
                }
            default:
                UsersSelectActivity usersSelectActivity = (UsersSelectActivity) this.f37588c;
                ...
                if (keyEvent.getAction() == 0) {
                    ...
                    this.f37587b = z11;
                    return false;
                } else if (keyEvent.getAction() != 1 || !this.f37587b || arrayList.isEmpty()) {
                    return false;
                } else {
                    org.telegram.ui.Components.n30 n30Var = (org.telegram.ui.Components.n30) hg.c.g(1, arrayList);
                    usersSelectActivity.f31881b.b(n30Var);
                    if (usersSelectActivity.f31888x == 2) {
