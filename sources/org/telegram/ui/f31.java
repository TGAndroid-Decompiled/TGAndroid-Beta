...
public final class f31 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public boolean R;
    public final g31 S;
    public final org.telegram.ui.Components.kp f33532b;
    public final c31 f33533c;
    public final g31 d;
    public final Window e;
    public final Drawable f33534f;
    public final ci.n6 h;
    public final TextView f33535n;
    public final org.telegram.ui.Components.t00 f33536r;
    public final TextView f33537s;
    public final LinearLayout v;
    public final TextView f33538w;
    public final ImageView f33539x;
    public final org.telegram.ui.Components.ml0 f33540y;
    public final Paint f33531a = new Paint(1);
    public int L = -1;
    ...
    public f31(g31 g31Var, g31 g31Var2, Window window) {
        ...
        this.f33533c = new s4.d0(parentActivity);
        Drawable mutate = parentActivity.getResources().getDrawable(R.drawable.sheet_shadow_round).mutate();
        this.f33534f = mutate;
        int themedColor = g31Var2.getThemedColor(org.telegram.ui.ActionBar.j6.f18934h5);
        PorterDuff.Mode mode = PorterDuff.Mode.MULTIPLY;
        mutate.setColorFilter(new PorterDuffColorFilter(themedColor, mode));
        ci.n6 n6Var = new ci.n6(this, parentActivity, g31Var2);
        this.h = n6Var;
        TextView textView = new TextView(parentActivity);
        this.f33535n = textView;
        textView.setEllipsize(TextUtils.TruncateAt.MIDDLE);
        textView.setLines(1);
        textView.setSingleLine(true);
        textView.setTextColor(g31Var2.getThemedColor(org.telegram.ui.ActionBar.j6.f18970j5));
        ...
        org.telegram.ui.Components.t00 t00Var = new org.telegram.ui.Components.t00(parentActivity, g31Var2.f33832a);
        this.f33536r = t00Var;
        ...
        org.telegram.ui.Components.kp kpVar = new org.telegram.ui.Components.kp(i10, 2, g31Var.f33832a);
        this.f33532b = kpVar;
    ...
    public final void b(int i10) {
        this.L = i10;
        org.telegram.ui.Components.kp kpVar = this.f33532b;
        kpVar.E(i10);
