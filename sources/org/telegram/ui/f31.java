...
public final class f31 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public boolean R;
    public final g31 S;
    public final org.telegram.ui.Components.jp f36279b;
    public final c31 f36280c;
    public final g31 d;
    public final Window f36281e;
    public final Drawable f36282f;
    public final ah.w h;
    public final TextView f36283n;
    public final org.telegram.ui.Components.t00 f36284r;
    public final TextView f36285s;
    public final LinearLayout v;
    public final TextView f36286w;
    public final ImageView f36287x;
    public final org.telegram.ui.Components.ll0 f36288y;
    public final Paint f36278a = new Paint(1);
    public int L = -1;
    ...
    public f31(g31 g31Var, g31 g31Var2, Window window) {
        ...
        this.f36280c = new s4.d0(parentActivity);
        Drawable mutate = parentActivity.getResources().getDrawable(R.drawable.sheet_shadow_round).mutate();
        this.f36282f = mutate;
        int themedColor = g31Var2.getThemedColor(org.telegram.ui.ActionBar.j6.f20762h5);
        PorterDuff.Mode mode = PorterDuff.Mode.MULTIPLY;
        mutate.setColorFilter(new PorterDuffColorFilter(themedColor, mode));
        ah.w wVar = new ah.w(this, parentActivity, g31Var2);
        this.h = wVar;
        TextView textView = new TextView(parentActivity);
        this.f36283n = textView;
        textView.setEllipsize(TextUtils.TruncateAt.MIDDLE);
        textView.setLines(1);
        textView.setSingleLine(true);
        textView.setTextColor(g31Var2.getThemedColor(org.telegram.ui.ActionBar.j6.f20798j5));
        ...
        org.telegram.ui.Components.t00 t00Var = new org.telegram.ui.Components.t00(parentActivity, g31Var2.f36566a);
        this.f36284r = t00Var;
        ...
        org.telegram.ui.Components.jp jpVar = new org.telegram.ui.Components.jp(i10, 2, g31Var.f36566a);
        this.f36279b = jpVar;
    ...
    public final void b(int i10) {
        this.L = i10;
        org.telegram.ui.Components.jp jpVar = this.f36279b;
        jpVar.E(i10);
