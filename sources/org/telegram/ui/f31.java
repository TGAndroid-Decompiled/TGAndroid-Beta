...
public final class f31 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public boolean R;
    public final g31 S;
    public final org.telegram.ui.Components.jp f36252b;
    public final c31 f36253c;
    public final g31 d;
    public final Window f36254e;
    public final Drawable f36255f;
    public final ah.w h;
    public final TextView f36256n;
    public final org.telegram.ui.Components.t00 f36257r;
    public final TextView f36258s;
    public final LinearLayout v;
    public final TextView f36259w;
    public final ImageView f36260x;
    public final org.telegram.ui.Components.ll0 f36261y;
    public final Paint f36251a = new Paint(1);
    public int L = -1;
    ...
    public f31(g31 g31Var, g31 g31Var2, Window window) {
        ...
        this.f36253c = new s4.d0(parentActivity);
        Drawable mutate = parentActivity.getResources().getDrawable(R.drawable.sheet_shadow_round).mutate();
        this.f36255f = mutate;
        int themedColor = g31Var2.getThemedColor(org.telegram.ui.ActionBar.j6.f20735h5);
        PorterDuff.Mode mode = PorterDuff.Mode.MULTIPLY;
        mutate.setColorFilter(new PorterDuffColorFilter(themedColor, mode));
        ah.w wVar = new ah.w(this, parentActivity, g31Var2);
        this.h = wVar;
        TextView textView = new TextView(parentActivity);
        this.f36256n = textView;
        textView.setEllipsize(TextUtils.TruncateAt.MIDDLE);
        textView.setLines(1);
        textView.setSingleLine(true);
        textView.setTextColor(g31Var2.getThemedColor(org.telegram.ui.ActionBar.j6.f20771j5));
        ...
        org.telegram.ui.Components.t00 t00Var = new org.telegram.ui.Components.t00(parentActivity, g31Var2.f36539a);
        this.f36257r = t00Var;
        ...
        org.telegram.ui.Components.jp jpVar = new org.telegram.ui.Components.jp(i10, 2, g31Var.f36539a);
        this.f36252b = jpVar;
    ...
    public final void b(int i10) {
        this.L = i10;
        org.telegram.ui.Components.jp jpVar = this.f36252b;
        jpVar.E(i10);
