...
public final class z50 extends Drawable {
    ...
    public int d;
    public final View e;
    public final Paint f40338a = new Paint(1);
    public float f40340c = 1.0f;
    ...
    public final void draw(Canvas canvas) {
        ...
        Paint paint = this.f40338a;
        paint.setColor(-1147527);
        paint.setAlpha((int) (this.f40340c * 255.0f));
        canvas.drawCircle(centerX, dp, AndroidUtilities.dp(4.0f), paint);
        long elapsedRealtime = SystemClock.elapsedRealtime();
        long j3 = elapsedRealtime - this.f40339b;
        if (j3 > 17) {
            j3 = 17;
        }
        this.f40339b = elapsedRealtime;
        int i10 = this.d;
        if (i10 == 0) {
            float f7 = (((float) j3) / 2000.0f) + this.f40340c;
            this.f40340c = f7;
            if (f7 >= 1.0f) {
                this.f40340c = 1.0f;
                this.d = 1;
            ...
            float f10 = this.f40340c - (((float) j3) / 2000.0f);
            this.f40340c = f10;
            if (f10 < 0.5f) {
                this.f40340c = 0.5f;
                this.d = 0;
