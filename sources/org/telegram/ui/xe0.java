...
public final class xe0 extends org.telegram.ui.Components.uv0 {
    ...
    public final wg0 f39596a0;
    public final org.telegram.ui.Components.yc0 f39597b;
    public final ci.h2 f39598c;
    ...
    public final TextView f39600n;
    public final TextView f39601r;
    public final TextView f39602s;
    public final xf0 v;
    public boolean f39603w;
    public boolean f39604x;
    ...
    public final void h(String str) {
        ...
        String obj = this.f39598c.getText().toString();
        if (obj.length() == 0) {
            s(false);
        } else if (!p(obj)) {
            s(true);
    ...
    @Override
    public final void j() {
        AndroidUtilities.runOnUIThread(new ue0(this, 3), wg0.f39192t0);
    }

    @Override
    public final void k(Bundle bundle) {
        Bundle bundle2 = bundle.getBundle("recoveryview_word" + this.f39595a);
        this.L = bundle2;
        if (bundle2 != null) {
            m(bundle2, true);
        }
    ...
    public final void l(Bundle bundle) {
        if (this.L != null) {
            bundle.putBundle("recoveryview_word" + this.f39595a, this.L);
        }
    }
    ...
    public final void m(Bundle bundle, boolean z10) {
        ...
        String str2 = this.K;
        TextView textView = this.f39601r;
        if (str2 == null) {
            if (!z11) {
        ...
        int i15 = org.telegram.ui.ActionBar.i6.f19218y6;
    ...
    public final void n() {
        ...
        wg0 wg0Var = this.f39596a0;
        this.f39600n.setTextColor(wg0Var.getThemedColor(i10));
        this.f39601r.setTextColor(wg0Var.getThemedColor(org.telegram.ui.ActionBar.i6.D6));
        int themedColor = wg0Var.getThemedColor(i10);
        ci.h2 h2Var = this.f39598c;
        h2Var.setTextColor(themedColor);
        h2Var.setCursorColor(wg0Var.getThemedColor(org.telegram.ui.ActionBar.i6.f18982l6));
    ...
    public final void o(boolean z10) {
        ...
        if (this.f39603w && !this.f39604x) {
            f10 = 1.0f;
        }
        float f13 = (0.1f * f10) + 0.9f;
        ViewPropertyAnimator alpha = this.f39599f.animate().scaleX(f13).scaleY(f13).alpha(f10);
        float f14 = 1.0f - f10;
        if (this.f39604x) {
            f12 = 5.0f;
        }
    ...
    public final void q(boolean z10) {
        ...
        if (TextUtils.isEmpty(this.f39598c.getText()) && clipboardManager != null && clipboardManager.hasPrimaryClip()) {
            z11 = true;
        } else {
            z11 = false;
        }
        if (this.f39603w != z11) {
            ...
            float f16 = 0.9f;
            float f17 = 0.7f;
            TextView textView = this.f39602s;
            TextView textView2 = this.f39599f;
            float f18 = 0.0f;
            float f19 = 1.0f;
            if (z10) {
                ...
                ViewPropertyAnimator alpha2 = scaleX2.scaleY(f16).alpha((!this.f39603w || this.f39604x) ? 0.0f : 0.0f);
                if (!this.f39603w || this.f39604x) {
                    if (this.f39604x) {
                        f15 = 5.0f;
                    }
                ...
                textView2.setAlpha((!this.f39603w || this.f39604x) ? 0.0f : 0.0f);
                if (!this.f39603w || this.f39604x) {
                    if (this.f39604x) {
                        f15 = 5.0f;
                    }
    ...
    public final void s(boolean z10) {
        ...
        int i11;
        ci.h2 h2Var = this.f39598c;
        if (this.f39596a0.getParentActivity() == null) {
            return;
        }
        try {
