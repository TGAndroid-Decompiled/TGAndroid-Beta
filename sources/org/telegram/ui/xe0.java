...
public final class xe0 extends org.telegram.ui.Components.tv0 {
    ...
    public final wg0 f42728a0;
    public final org.telegram.ui.Components.zc0 f42729b;
    public final di.h2 f42730c;
    public final org.telegram.ui.Components.voip.l2 d;
    public final TextView f42731e;
    public final TextView f42732f;
    public final org.telegram.ui.Components.aj0 h;
    public final TextView f42733n;
    public final TextView f42734r;
    public final TextView f42735s;
    public final xf0 v;
    public boolean f42736w;
    public boolean f42737x;
    public boolean f42738y;
    ...
    public final void h(String str) {
        ...
        String obj = this.f42730c.getText().toString();
        if (obj.length() == 0) {
            s(false);
        } else if (!p(obj)) {
            s(true);
    ...
    @Override
    public final void j() {
        AndroidUtilities.runOnUIThread(new ue0(this, 3), wg0.f42385t0);
    }

    @Override
    public final void k(Bundle bundle) {
        Bundle bundle2 = bundle.getBundle("recoveryview_word" + this.f42727a);
        this.L = bundle2;
        if (bundle2 != null) {
            m(bundle2, true);
        }
    ...
    public final void l(Bundle bundle) {
        if (this.L != null) {
            bundle.putBundle("recoveryview_word" + this.f42727a, this.L);
        }
    }
    ...
    public final void m(Bundle bundle, boolean z10) {
        ...
        String str2 = this.K;
        TextView textView = this.f42734r;
        if (str2 == null) {
            if (!z11) {
    ...
    public final void n() {
        ...
        wg0 wg0Var = this.f42728a0;
        this.f42733n.setTextColor(wg0Var.getThemedColor(i10));
        this.f42734r.setTextColor(wg0Var.getThemedColor(org.telegram.ui.ActionBar.j6.D6));
        int themedColor = wg0Var.getThemedColor(i10);
        di.h2 h2Var = this.f42730c;
        h2Var.setTextColor(themedColor);
        h2Var.setCursorColor(wg0Var.getThemedColor(org.telegram.ui.ActionBar.j6.f20836l6));
    ...
    public final void o(boolean z10) {
        ...
        float f12 = -5.0f;
        ViewPropertyAnimator translationY = this.f42731e.animate().scaleX(f11).scaleY(f11).alpha(f7).translationY((1.0f - f7) * AndroidUtilities.dp(-5.0f));
        org.telegram.ui.Components.pr prVar = org.telegram.ui.Components.pr.h;
        org.telegram.messenger.wl.q(translationY, prVar, 290L);
        if (this.f42736w && !this.f42737x) {
            f10 = 1.0f;
        }
        float f13 = (0.1f * f10) + 0.9f;
        ViewPropertyAnimator alpha = this.f42732f.animate().scaleX(f13).scaleY(f13).alpha(f10);
        float f14 = 1.0f - f10;
        if (this.f42737x) {
            f12 = 5.0f;
        }
    ...
    public final void q(boolean z10) {
        ...
        if (TextUtils.isEmpty(this.f42730c.getText()) && clipboardManager != null && clipboardManager.hasPrimaryClip()) {
            z11 = true;
        } else {
            z11 = false;
        }
        if (this.f42736w != z11) {
            ...
            float f16 = 0.9f;
            float f17 = 0.7f;
            TextView textView = this.f42735s;
            TextView textView2 = this.f42732f;
            float f18 = 0.0f;
            float f19 = 1.0f;
            if (z10) {
                ...
                ViewPropertyAnimator alpha2 = scaleX2.scaleY(f16).alpha((!this.f42736w || this.f42737x) ? 0.0f : 0.0f);
                if (!this.f42736w || this.f42737x) {
                    if (this.f42737x) {
                        f15 = 5.0f;
                    }
                ...
                textView2.setAlpha((!this.f42736w || this.f42737x) ? 0.0f : 0.0f);
                if (!this.f42736w || this.f42737x) {
                    if (this.f42737x) {
                        f15 = 5.0f;
                    }
    ...
    public final void s(boolean z10) {
        ...
        int i11;
        di.h2 h2Var = this.f42730c;
        if (this.f42728a0.getParentActivity() == null) {
            return;
        }
        try {
