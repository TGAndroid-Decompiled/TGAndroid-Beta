...
public final class xe0 extends org.telegram.ui.Components.uv0 {
    ...
    public final wg0 f39604a0;
    public final org.telegram.ui.Components.yc0 f39605b;
    public final ci.h2 f39606c;
    ...
    public final TextView f39608n;
    public final TextView f39609r;
    public final TextView f39610s;
    public final xf0 v;
    public boolean f39611w;
    public boolean f39612x;
    ...
    public final void h(String str) {
        ...
        String obj = this.f39606c.getText().toString();
        if (obj.length() == 0) {
            s(false);
        } else if (!p(obj)) {
            s(true);
    ...
    @Override
    public final void j() {
        AndroidUtilities.runOnUIThread(new ue0(this, 3), wg0.f39196t0);
    }

    @Override
    public final void k(Bundle bundle) {
        Bundle bundle2 = bundle.getBundle("recoveryview_word" + this.f39603a);
        this.L = bundle2;
        if (bundle2 != null) {
            m(bundle2, true);
        }
    ...
    public final void l(Bundle bundle) {
        if (this.L != null) {
            bundle.putBundle("recoveryview_word" + this.f39603a, this.L);
        }
    }
    ...
    public final void m(Bundle bundle, boolean z10) {
        ...
        String str2 = this.K;
        TextView textView = this.f39609r;
        if (str2 == null) {
            if (!z11) {
            ...
            org.telegram.messenger.vl.q(i11, new Object[]{str}, textView);
        } else {
            if (!z11) {
            ...
            org.telegram.messenger.vl.q(i10, new Object[]{str, str2}, textView);
        }
        wg0.T0(wg0Var, h2Var);
        h2Var.requestFocus();
        ...
        xf0Var.setTextColor(org.telegram.ui.ActionBar.i6.w0(null, i15, false));
        int i16 = this.E;
    ...
    public final void n() {
        ...
        wg0 wg0Var = this.f39604a0;
        this.f39608n.setTextColor(wg0Var.getThemedColor(i10));
        this.f39609r.setTextColor(wg0Var.getThemedColor(org.telegram.ui.ActionBar.i6.D6));
        int themedColor = wg0Var.getThemedColor(i10);
        ci.h2 h2Var = this.f39606c;
        h2Var.setTextColor(themedColor);
        h2Var.setCursorColor(wg0Var.getThemedColor(org.telegram.ui.ActionBar.i6.f18979l6));
    ...
    public final void o(boolean z10) {
        ...
        if (this.f39611w && !this.f39612x) {
            f10 = 1.0f;
        }
        float f13 = (0.1f * f10) + 0.9f;
        ViewPropertyAnimator alpha = this.f39607f.animate().scaleX(f13).scaleY(f13).alpha(f10);
        float f14 = 1.0f - f10;
        if (this.f39612x) {
            f12 = 5.0f;
        }
    ...
    public final void q(boolean z10) {
        ...
        if (TextUtils.isEmpty(this.f39606c.getText()) && clipboardManager != null && clipboardManager.hasPrimaryClip()) {
            z11 = true;
        } else {
            z11 = false;
        }
        if (this.f39611w != z11) {
            ...
            float f16 = 0.9f;
            float f17 = 0.7f;
            TextView textView = this.f39610s;
            TextView textView2 = this.f39607f;
            float f18 = 0.0f;
            float f19 = 1.0f;
            if (z10) {
                ...
                ViewPropertyAnimator alpha2 = scaleX2.scaleY(f16).alpha((!this.f39611w || this.f39612x) ? 0.0f : 0.0f);
                if (!this.f39611w || this.f39612x) {
                    if (this.f39612x) {
                        f15 = 5.0f;
                    }
                ...
                textView2.setAlpha((!this.f39611w || this.f39612x) ? 0.0f : 0.0f);
                if (!this.f39611w || this.f39612x) {
                    if (this.f39612x) {
                        f15 = 5.0f;
                    }
    ...
    public final void s(boolean z10) {
        ...
        int i11;
        ci.h2 h2Var = this.f39606c;
        if (this.f39604a0.getParentActivity() == null) {
            return;
        }
        try {
