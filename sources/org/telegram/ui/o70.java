...
public final class o70 extends org.telegram.ui.Components.ll0 {
    ...
    public final boolean D(s4.c1 c1Var) {
        int b10 = c1Var.b();
        p70 p70Var = this.d;
        if (b10 != p70Var.f36549r && b10 != p70Var.f36548n && b10 != p70Var.f36550s && b10 != 0) {
            return false;
        }
        return true;
    }
    ...
    public final int h() {
        ...
        return p70Var.f36551w;
    }

    @Override
    public final int j(int i10) {
        p70 p70Var = this.d;
        if (i10 != p70Var.f36548n && i10 != p70Var.f36550s && i10 != p70Var.f36549r) {
        ...
        if (i11 != 0) {
            if (i11 != 1) {
                if (i11 == 2) {
                    ...
                    TLRPC.TL_chatInviteExported tL_chatInviteExported = p70Var.f36547f;
                    if (tL_chatInviteExported != null) {
                        str = tL_chatInviteExported.link;
                    } else {
                        str = "error";
                    }
                    p8Var.f20603a.setText(str);
            ...
            if (i10 == i12) {
                e9Var.setText("");
                e9Var.setBackgroundDrawable(org.telegram.ui.ActionBar.j6.V0(context, R.drawable.greydivider_bottom, org.telegram.ui.ActionBar.j6.f18826b7));
                return;
                ...
                e9Var.setBackgroundDrawable(org.telegram.ui.ActionBar.j6.V0(context, R.drawable.greydivider, org.telegram.ui.ActionBar.j6.f18826b7));
                return;
            } else {
                return;
            }
