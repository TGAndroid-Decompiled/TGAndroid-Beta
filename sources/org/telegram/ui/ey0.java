        ...
        if (b10 != i10) {
            ...
            if (b10 != i11) {
                ...
                if (b10 != i12) {
                    ...
                    if (b10 != i13 && b10 != privacySettingsActivity.f31247s) {
                        i14 = privacySettingsActivity.secretWebpageRow;
                        if (b10 != i14) {
                            i15 = privacySettingsActivity.webSessionsRow;
                            if (b10 != i15 && (b10 != privacySettingsActivity.f31245n || privacySettingsActivity.getContactsController().getLoadingPrivacyInfo(1))) {
            ...
            if (i10 != i11) {
                ...
                if (i10 != i12) {
                    ...
                    if (i10 != i13) {
                        ...
                        if (i10 != i14 && i10 != privacySettingsActivity.f31245n) {
                            ...
                            if (i10 != i15) {
                                ...
                                if (i10 != i16) {
                                    ...
                                    if (i10 != i17 && i10 != privacySettingsActivity.H) {
                                        if (i10 != privacySettingsActivity.h && i10 != privacySettingsActivity.E && i10 != privacySettingsActivity.f31246r && i10 != privacySettingsActivity.v && i10 != privacySettingsActivity.N && i10 != privacySettingsActivity.I && i10 != privacySettingsActivity.L && i10 != privacySettingsActivity.f31249x) {
                                            if (i10 != 0 && i10 != privacySettingsActivity.f31250y && i10 != privacySettingsActivity.f31244f && i10 != privacySettingsActivity.M && i10 != privacySettingsActivity.F && i10 != privacySettingsActivity.K && i10 != privacySettingsActivity.f31248w) {
                                                        ...
                                                        if (i10 != i20) {
                                                            ...
                                                            if (i10 != i21) {
                                                                if (i10 != privacySettingsActivity.J) {
                                                                    ...
                                                                    if (i10 != i22 && i10 != privacySettingsActivity.f31247s) {
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i42 != 0) {
            if (i42 != 1) {
                if (i42 != 2) {
                    if (i42 != 3) {
                        if (i42 == 5) {
                            ...
                            org.telegram.ui.Components.n6 n6Var = r8Var.f20816c;
                            ...
                            if (i10 == i34) {
                                ...
                                String str8 = "";
                                if (i10 != privacySettingsActivity.f31247s) {
                                    ...
                                    if (i10 != i35) {
                                        ...
                                        if (password2 == null) {
                                            ...
                                            if (indexOf != lastIndexOf && indexOf != -1 && lastIndexOf != -1) {
                                                ...
                                                obj.f26907c = i46;
                                                valueOf.setSpan(new org.telegram.ui.Components.q01(obj, 0), indexOf, i46, 0);
                                            }
                                            z16 = false;
                                            str4 = valueOf;
                                        }
                                        ...
                                        r8Var.f20821w = 16;
                                        r8Var.f20820s = 58;
                                        org.telegram.ui.ActionBar.k5 k5Var = r8Var.f20814a;
                                        ...
                                        bj0Var.setImageResource(i47);
                                        r8Var.f20819r = true;
                                        r8Var.setWillNotDraw(false);
                                        Switch r02 = r8Var.f20817f;
                                        if (r02 != null) {
                                            r02.setVisibility(8);
                                        }
                                    ...
                                    if (privacySettingsActivity.f31239a0.j0() == 0) {
                                        if (privacySettingsActivity.getMessagesController().lastKnownSessionsCount == 0) {
                                            str5 = "";
                                            z17 = true;
                                            privacySettingsActivity.getMessagesController().lastKnownSessionsCount = privacySettingsActivity.f31239a0.j0();
                                        ...
                                        format2 = String.format(LocaleController.getInstance().getCurrentLocale(), "%d", Integer.valueOf(privacySettingsActivity.f31239a0.j0()));
                                    }
                                    str5 = format2;
                                    privacySettingsActivity.getMessagesController().lastKnownSessionsCount = privacySettingsActivity.f31239a0.j0();
                                    r8Var.s(LocaleController.getString(R.string.SessionsTitle), str5, true, R.drawable.msg2_devices, false);
                ...
                if (i10 == privacySettingsActivity.f31244f) {
                    ...
                    return;
                } else if (i10 == privacySettingsActivity.f31250y) {
                    ...
                    return;
                } else if (i10 == privacySettingsActivity.f31248w) {
            ...
            if (i10 == privacySettingsActivity.E) {
                ...
                return;
            } else if (i10 == privacySettingsActivity.f31246r) {
                ...
                return;
            } else if (i10 == privacySettingsActivity.f31249x) {
                                        ...
                                        if (i10 != i19) {
                                            ...
                                            if (i10 != i20) {
                                                ...
                                                if (i10 != i21) {
                                                    ...
                                                    eaVar.getValueImageView().setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19027m6, false), PorterDuff.Mode.MULTIPLY));
                                                    z17 = z13;
                                                }
                                            } else {
