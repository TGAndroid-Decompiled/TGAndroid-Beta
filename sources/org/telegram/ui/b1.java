...
public final class b1 extends View implements org.telegram.ui.Cells.p9, e3 {
    public final p70 f32268a;
    public final g4 f32269b;
    public b3 f32270c;
    public int d;
    public final int e;
    public TL_iv.pageBlockAuthorDate f32271f;
    ...
    public final void onDraw(Canvas canvas) {
        if (this.f32271f != null && this.f32270c != null) {
            canvas.save();
            canvas.translate(this.d, this.e);
            i4.v(this.f32268a, canvas, this, 0);
            this.f32270c.draw(canvas, this);
            canvas.restore();
        }
    }
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        accessibilityNodeInfo.setText(i4.j(this.f32268a, this.f32269b, b3Var));
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        TL_iv.pageBlockAuthorDate pageblockauthordate = this.f32271f;
        int i13 = 1;
        if (pageblockauthordate != null) {
            TL_iv.RichText richText = pageblockauthordate.author;
            g4 g4Var = this.f32269b;
            ...
            CharSequence C = i4.C(this.f32268a, webPage, this, richText, richText, pageblockauthordate, size);
            i12 = size;
            ...
            if (this.f32271f.published_date != 0 && !TextUtils.isEmpty(C)) {
                r32 = LocaleController.formatString(R.string.ArticleDateByAuthor, LocaleController.getInstance().getChatFullDate().format(this.f32271f.published_date * 1000), C);
            } else if (!TextUtils.isEmpty(C)) {
                r32 = LocaleController.formatString(R.string.ArticleByAuthor, C);
            } else {
                r32 = LocaleController.getInstance().getChatFullDate().format(this.f32271f.published_date * 1000);
            }
            ...
            b3 q6 = i4.q(this.f32268a, this, r32, null, i12 - AndroidUtilities.dp(36.0f), this.e, this.f32271f, this.f32269b);
            this.f32270c = q6;
            if (q6 != null) {
                int height = this.f32270c.d.getHeight() + AndroidUtilities.dp(16.0f);
                if (g4Var != null && g4Var.G) {
                    this.d = (int) Math.floor(((i12 - this.f32270c.d.getLineLeft(0)) - this.f32270c.d.getLineWidth(0)) - AndroidUtilities.dp(16.0f));
                } else {
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        if (!i4.l(this.f32268a, this.f32269b, motionEvent, this, this.f32270c, this.d, this.e) && !super.onTouchEvent(motionEvent)) {
            return false;
        }
        return true;
    }
    ...
    public void setBlock(TL_iv.pageBlockAuthorDate pageblockauthordate) {
        this.f32271f = pageblockauthordate;
        requestLayout();
    }
}
