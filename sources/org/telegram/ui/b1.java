...
public final class b1 extends View implements DownloadController.FileDownloadProgressListener, org.telegram.ui.Cells.l9 {
    ...
    public final o70 f35278a;
    public final j4 f35279b;
    public d3 f35280c;
    public d3 d;
    public final RadialProgress2 f35281e;
    public final org.telegram.ui.Components.ho0 f35282f;
    public boolean h;
    public int f35283n;
    ...
    public String v;
    public d3 f35286w;
    public StaticLayout f35287x;
    public int f35288y;

    public b1(Context context, o70 o70Var, j4 j4Var) {
        super(context);
        this.f35284r = AndroidUtilities.dp(58.0f);
        this.f35278a = o70Var;
        this.f35279b = j4Var;
        RadialProgress2 radialProgress2 = new RadialProgress2(this, null);
        this.f35281e = radialProgress2;
    ...
    public final void a(boolean z4) {
        ...
        RadialProgress2 radialProgress2 = this.f35281e;
        if (isEmpty) {
    ...
    public final void b() {
        ...
        if (this.I != null && (messageObject = this.J) != null) {
            org.telegram.ui.Components.ho0 ho0Var = this.f35282f;
            if (!ho0Var.f27535e) {
            ...
            if (str == null || !str.equals(formatShortDuration)) {
                ...
                TextPaint textPaint = l4.f38580b1;
                textPaint.setTextSize(AndroidUtilities.dp(16.0f));
                this.f35287x = new StaticLayout(formatShortDuration, textPaint, (int) Math.ceil(textPaint.measureText(formatShortDuration)), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
            }
            l4.f38580b1.setColor(this.f35278a.b());
            invalidate();
        }
    }
    ...
    public final void fillTextLayoutBlocks(ArrayList arrayList) {
        d3 d3Var = this.f35286w;
        if (d3Var != null) {
            arrayList.add(d3Var);
        }
        d3 d3Var2 = this.f35280c;
        if (d3Var2 != null) {
    ...
    public final void onDetachedFromWindow() {
        ...
        DownloadController.getInstance(((l4) this.f35278a).U).removeLoadingFileObserver(this);
        d3 d3Var = this.f35286w;
        if (d3Var != null) {
            d3Var.detach(this);
        }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        int i10 = org.telegram.ui.ActionBar.k6.f21757ie;
        int i11 = org.telegram.ui.ActionBar.k6.f21774je;
        int i12 = org.telegram.ui.ActionBar.k6.f21967uc;
        int i13 = org.telegram.ui.ActionBar.k6.f21985vc;
        RadialProgress2 radialProgress2 = this.f35281e;
        radialProgress2.g(i10, i11, i12, i13);
        int i14 = org.telegram.ui.ActionBar.k6.Bd;
        o70 o70Var = this.f35278a;
        ((l4) o70Var).getClass();
        int i15 = 0;
        radialProgress2.d = org.telegram.ui.ActionBar.k6.w0(null, i14, false);
        radialProgress2.draw(canvas);
        canvas.save();
        canvas.translate(this.f35288y, this.B);
        this.f35282f.b(canvas);
        canvas.restore();
        if (this.f35287x != null) {
            canvas.save();
            canvas.translate(AndroidUtilities.dp(54.0f) + this.C, AndroidUtilities.dp(6.0f) + this.B);
            this.f35287x.draw(canvas);
            canvas.restore();
        }
        if (this.f35286w != null) {
            canvas.save();
            this.f35286w.f35986s = AndroidUtilities.dp(54.0f) + this.C;
            this.f35286w.v = this.B - AndroidUtilities.dp(16.0f);
            d3 d3Var = this.f35286w;
            canvas.translate(d3Var.f35986s, d3Var.v);
            l4.v(o70Var, canvas, this, 0);
            this.f35286w.draw(canvas, this);
            canvas.restore();
            i15 = 1;
        }
        d3 d3Var2 = this.f35280c;
        int i16 = this.f35284r;
        if (d3Var2 != null) {
            canvas.save();
            d3 d3Var3 = this.f35280c;
            int i17 = this.f35283n;
            d3Var3.f35986s = i17;
            d3Var3.v = i16;
            canvas.translate(i17, i16);
            l4.v(o70Var, canvas, this, i15);
            this.f35280c.draw(canvas, this);
            canvas.restore();
            i15++;
        }
        if (this.d != null) {
            canvas.save();
            d3 d3Var4 = this.d;
            int i18 = this.f35283n;
            d3Var4.f35986s = i18;
            int i19 = this.f35285s;
            d3Var4.v = i16 + i19;
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (this.f35286w != null) {
            sb.append(", ");
            sb.append(this.f35286w.d.getText());
        }
        if (this.f35280c != null) {
            sb.append(", ");
            sb.append(this.f35280c.d.getText());
        }
        if (this.d != null) {
            sb.append(", ");
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (pageblockaudio != null) {
            ...
            if (i13 > 0) {
                this.f35283n = AndroidUtilities.dp(18.0f) + AndroidUtilities.dp(i13 * 14);
            } else {
                this.f35283n = AndroidUtilities.dp(18.0f);
            }
            int dp2 = (size - this.f35283n) - AndroidUtilities.dp(18.0f);
            int dp3 = AndroidUtilities.dp(44.0f);
            this.C = AndroidUtilities.dp(16.0f);
            int dp4 = AndroidUtilities.dp(5.0f);
            this.D = dp4;
            int i14 = this.C;
            this.f35281e.q(i14, dp4, i14 + dp3, dp4 + dp3);
            TL_iv.pageBlockAudio pageblockaudio2 = this.H;
            d3 q10 = l4.q(this.f35278a, this, null, pageblockaudio2.caption.text, dp2, this.f35284r, pageblockaudio2, this.f35279b);
            this.f35280c = q10;
            if (q10 != null) {
                int height = this.f35280c.d.getHeight() + AndroidUtilities.dp(8.0f);
                this.f35285s = height;
            ...
            int i15 = this.f35284r + this.f35285s;
            if (this.f35279b.D) {
            ...
            d3 p10 = l4.p(this.f35278a, this, null, richText, dp2, i15, pageblockaudio3, alignment2, 0, this.f35279b);
            this.d = p10;
            if (p10 != null) {
            ...
            if (TextUtils.isEmpty(musicTitle) && TextUtils.isEmpty(musicAuthor)) {
                ...
                d3 d3Var = new d3(this.f35278a);
                this.f35286w = d3Var;
                d3Var.d = new StaticLayout(ellipsize, l4.f38580b1, dp5, Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
                this.f35286w.f35984n = this.H;
                this.B = AndroidUtilities.dp(11.0f) + ((dp3 - AndroidUtilities.dp(30.0f)) / 2) + this.D;
            }
            this.f35282f.j(dp5, AndroidUtilities.dp(30.0f));
        } else {
            i12 = 1;
        }
    ...
    public final void onProgressDownload(String str, long j10, long j11) {
        this.f35281e.o(Math.min(1.0f, ((float) j10) / ((float) j11)), true);
        if (this.E != 3) {
            a(true);
        }
    }
