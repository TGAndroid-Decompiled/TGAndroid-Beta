...
public final class vv implements DialogInterface.OnClickListener {
    ...
    public final NotificationCenter.NotificationCenterDelegate f38626b;

    public vv(NotificationCenter.NotificationCenterDelegate notificationCenterDelegate, int i10) {
        this.f38625a = i10;
        this.f38626b = notificationCenterDelegate;
    }
    ...
    public final void onClick(DialogInterface dialogInterface, int i10) {
        ...
        switch (this.f38625a) {
            case 0:
                uy uyVar = (uy) this.f38626b;
                if (i10 == 0) {
                    uyVar.getMessagesStorage().readAllDialogs(1);
                    return;
                } else if (i10 != 1 || uyVar.f38277e0 == null) {
                    return;
                } else {
                    while (true) {
                        ...
                        if (i11 < tyVarArr.length) {
                            ...
                            if (tyVar.f37911s == 0 && tyVar.getVisibility() == 0) {
                                org.telegram.ui.Cells.s2 Q3 = uy.Q3(uyVar.f38277e0[i11]);
                                qy qyVar = uyVar.f38277e0[i11].f37905a;
                                int i12 = qy.f37004v3;
                                qyVar.A1(true, Q3);
                            }
                            i11++;
