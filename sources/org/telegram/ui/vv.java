...
public final class vv implements DialogInterface.OnClickListener {
    ...
    public final NotificationCenter.NotificationCenterDelegate f41703b;

    public vv(NotificationCenter.NotificationCenterDelegate notificationCenterDelegate, int i10) {
        this.f41702a = i10;
        this.f41703b = notificationCenterDelegate;
    }
    ...
    public final void onClick(DialogInterface dialogInterface, int i10) {
        ...
        switch (this.f41702a) {
            case 0:
                uy uyVar = (uy) this.f41703b;
                if (i10 == 0) {
                    uyVar.getMessagesStorage().readAllDialogs(1);
                    return;
                } else if (i10 != 1 || uyVar.f41259e0 == null) {
                    return;
                } else {
                    while (true) {
                        ...
                        if (i11 < tyVarArr.length) {
                            ...
                            if (tyVar.f40865s == 0 && tyVar.getVisibility() == 0) {
                                org.telegram.ui.Cells.r2 Q3 = uy.Q3(uyVar.f41259e0[i11]);
                                qy qyVar = uyVar.f41259e0[i11].f40858a;
                                int i12 = qy.f39998v3;
                                qyVar.y1(true, Q3);
                            }
                            i11++;
