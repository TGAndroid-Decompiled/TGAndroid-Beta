...
public final class m51 implements Runnable {
    ...
    public final void run() {
        switch (this.f35693a) {
            case 0:
                i71 i71Var = this.f35694b;
                i71Var.getClass();
                HashSet hashSet = zg.f0.f49050a;
            ...
            case 1:
                ...
                i71Var2.f34483q0.E(true);
                return;
            case 2:
                this.f35694b.U1.start();
                return;
            case 3:
                this.f35694b.B(true, true, true);
                return;
            default:
                i71 i71Var3 = this.f35694b;
