...
public final class m51 extends FrameLayout {
    ...
    public void dispatchDraw(Canvas canvas) {
        switch (this.f35488a) {
            case 6:
                org.telegram.ui.ActionBar.h6.f19146i3.setBounds(0, 0, getMeasuredWidth(), org.telegram.ui.ActionBar.h6.f19146i3.getIntrinsicHeight());
    ...
    public void onDraw(Canvas canvas) {
        switch (this.f35488a) {
            case 5:
                super.onDraw(canvas);
                canvas.drawRect(0.0f, 0.0f, getMeasuredWidth(), 1.0f, org.telegram.ui.ActionBar.h6.f19181k0);
                return;
            default:
                super.onDraw(canvas);
                return;
