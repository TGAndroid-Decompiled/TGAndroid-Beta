...
public final class ks0 extends org.telegram.ui.ActionBar.j {
    public final org.telegram.ui.ActionBar.d6 f35167a;
    public final PhotoViewer f35168b;

    public ks0(PhotoViewer photoViewer, org.telegram.ui.ActionBar.d6 d6Var) {
        this.f35168b = photoViewer;
        this.f35167a = d6Var;
    }
    ...
    public final boolean a() {
        ...
        boolean z10;
        PhotoViewer photoViewer = this.f35168b;
        if (photoViewer.T4 != null || photoViewer.f31201b5 != null) {
            return true;
        }
        if (photoViewer.f31191a5 != null) {
            FileLoader fileLoader = FileLoader.getInstance(photoViewer.T);
            ImageLocation imageLocation = photoViewer.f31191a5;
            ...
            if (photoViewer.f31416z5 == 0 && !photoViewer.B5) {
                z10 = false;
            } else {
                z10 = true;
            }
            ...
            ImageLocation imageLocation2 = photoViewer.f31191a5;
            ...
            return false;
        } else if (photoViewer.f31274j7 != null) {
            return true;
        } else {
            return false;
        }
