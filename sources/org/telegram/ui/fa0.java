...
public final class fa0 implements Utilities.Callback {
    ...
    public final LaunchActivity f33556b;

    public fa0(LaunchActivity launchActivity, int i10) {
        this.f33555a = i10;
        this.f33556b = launchActivity;
    }
    ...
    public final void run(Object obj) {
        ...
        LaunchActivity launchActivity = this.f33556b;
        switch (i10) {
            case 0:
                boolean booleanValue = ((Boolean) obj).booleanValue();
                if (launchActivity.f30841q0 != null && booleanValue && LiteMode.getPowerSaverLevel() < 100 && (lastFragment = launchActivity.f30841q0.getLastFragment()) != null && !(lastFragment instanceof nc0)) {
                    ...
                    a02.getClass();
                    Context W = a02.W();
                    org.telegram.ui.ActionBar.e6 e6Var = a02.f28687c;
                    org.telegram.ui.Components.lc lcVar = new org.telegram.ui.Components.lc(W, e6Var);
                    lcVar.f25905a.setImageDrawable(w9Var);
                    lcVar.f25906b.setText(string);
                    lcVar.f25907c.setText(formatString);
                    org.telegram.ui.Components.mc mcVar = new org.telegram.ui.Components.mc(a02.W(), e6Var, true);
                    mcVar.e(string2);
                    mcVar.f26136a = f90Var;
