...
public final class m80 extends ViewGroup {
    public AnimatorSet f35701a;
    public boolean f35702b;
    public final ArrayList f35703c;
    ...
    public final void a(org.telegram.ui.Components.m30 m30Var) {
        ...
        AnimatorSet animatorSet = this.f35701a;
        if (animatorSet != null && animatorSet.isRunning()) {
            this.f35701a.setupEndValues();
            this.f35701a.cancel();
        }
        this.f35702b = false;
        AnimatorSet animatorSet2 = new AnimatorSet();
        this.f35701a = animatorSet2;
        animatorSet2.addListener(new org.telegram.ui.Components.qk0(7, this, m30Var));
        this.f35701a.setInterpolator(org.telegram.ui.Components.qr.h);
        this.f35701a.setDuration(320L);
        this.e = m30Var;
        ArrayList arrayList = this.f35703c;
        arrayList.clear();
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        n80 n80Var = this.h;
        if (i12 > n80Var.f35975x - AndroidUtilities.dp(12.0f)) {
            z11 = true;
        } else {
            z11 = false;
        }
        ...
        if (i13 > n80Var.f35975x - AndroidUtilities.dp(12.0f)) {
            z12 = true;
        } else {
            z12 = false;
        }
        if (!this.f35702b) {
            ...
            if (this.f35701a != null) {
                this.f35704f = AndroidUtilities.dp(28.0f) + dp2;
                this.f35701a.playTogether(arrayList);
                this.f35701a.start();
                this.f35702b = true;
            } else {
                this.f35704f = dp5;
        ...
        if (z12) {
            max = n80Var.f35975x - AndroidUtilities.dp(12.0f);
        } else {
            ...
            max = Math.max(dp6, Math.min(i14, n80Var.f35975x - AndroidUtilities.dp(12.0f)));
        }
        n80Var.f35968b.a(max);
        l80 l80Var = n80Var.d;
        if (l80Var != null) {
            if (this.e != null) {
                i15 = 1;
            ...
            ViewPropertyAnimator animate = l80Var.f35477c.animate();
            float f16 = 0.0f;
            float f17 = 1.0f;
            if (z10) {
                f7 = 1.0f;
            ...
            l80Var.f35478f.e.post(new b0(l80Var, f14, 3));
        }
        setMeasuredDimension(size, this.f35704f);
    }
}
