...
public final class s91 extends org.telegram.ui.Components.za {
    public static final int f37430d0 = 0;
    public final yh.a X;
    public final LinearLayout Y;
    public final LinearLayout Z;
    public boolean f37431a0;
    public boolean f37432b0;
    public org.telegram.ui.Components.x51 f37433c0;
    ...
    public s91(final Context context, final int i10, final org.telegram.ui.ActionBar.f6 f6Var, final pf pfVar) {
        ...
        yh.a aVar = new yh.a(context, i10, zf.b.f48983b, f6Var);
        this.X = aVar;
        aVar.setScaleX(0.6f);
        aVar.setScaleY(0.6f);
        aVar.setAlpha(0.0f);
        ...
        a1.d dVar = new a1.d(context, new int[]{i14, i15, i16, i17, i18, i19, i19}, f6Var, qz0Var, 18);
        ...
        TextView b13 = w7.b6.b(context, 14.0f, org.telegram.ui.ActionBar.j6.f19245y6, false, null);
        b13.setGravity(17);
        ...
        dVar2.setOnClickListener(new View.OnClickListener() {
            ...
            public final void onClick(View view2) {
                ...
                try {
                    ...
                    } else if (yh.v5.y(i23, true).f47926f.toDouble() < parseDouble) {
                        new di.h(context, f6Var, zf.a.i((long) (parseDouble * 1.0E9d), zf.b.f48983b), true, new p91(0));
                    } else {
        ...
        ml0Var.setPadding(i24, 0, i24, AndroidUtilities.dp(68.0f));
        this.f37433c0.N(false);
    }

    public final void P() {
        boolean z10;
        float f7;
        if (this.f37431a0 && !isDismissed() && !isKeyboardVisible()) {
            z10 = true;
        } else {
            z10 = false;
        }
        if (this.f37432b0 != z10) {
            this.f37432b0 = z10;
            yh.a aVar = this.X;
            if (aVar != null) {
                aVar.setEnabled(z10);
