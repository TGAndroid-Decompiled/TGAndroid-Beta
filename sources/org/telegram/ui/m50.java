...
public final class m50 extends Dialog {
    public final ai.n4 f35480a;
    public final n50 f35481b;
    public Bitmap f35482c;
    public Paint d;
    public BitmapShader e;
    public final Matrix f35483f;
    public float h;
    public ValueAnimator f35484n;
    public boolean f35485r;

    public m50(Context context, n50 n50Var) {
        super(context, R.style.TransparentDialog);
        this.f35483f = new Matrix();
        this.f35481b = n50Var;
    ...
    public final void b(float f7, l50 l50Var) {
        ValueAnimator valueAnimator = this.f35484n;
        if (valueAnimator != null) {
            valueAnimator.cancel();
            this.f35484n = null;
        }
        ValueAnimator ofFloat = ValueAnimator.ofFloat(this.h, f7);
        this.f35484n = ofFloat;
        ofFloat.addUpdateListener(new c3(this, 16));
        this.f35484n.addListener(new ai.t2(this, f7, l50Var, 3));
        this.f35484n.setDuration(420L);
        this.f35484n.setInterpolator(org.telegram.ui.Components.sr.h);
        this.f35484n.start();
    }
    ...
    public final void onCreate(Bundle bundle) {
        ...
        setContentView(this.f35480a, new ViewGroup.LayoutParams(-1, -1));
