    ...
    public final void b(int i10) {
        ...
        if (i10 == -1) {
            ...
            if (n1Var != null && n1Var.isShowing()) {
                v0Var.f21378b.measure(org.telegram.messenger.wl.d(40.0f, AndroidUtilities.displaySize.x, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.displaySize.y, Integer.MIN_VALUE));
                v0Var.O(true, true);
            }
        } else if (i10 == 6) {
