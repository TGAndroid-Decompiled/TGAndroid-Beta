...
public final class m50 extends Dialog {
    public final ai.n4 f35482a;
    public final n50 f35483b;
    public Bitmap f35484c;
    public Paint d;
    public BitmapShader e;
    public final Matrix f35485f;
    public float h;
    public ValueAnimator f35486n;
    public boolean f35487r;

    public m50(Context context, n50 n50Var) {
        super(context, R.style.TransparentDialog);
        this.f35485f = new Matrix();
        this.f35483b = n50Var;
    ...
    public final void b(float f7, l50 l50Var) {
        ValueAnimator valueAnimator = this.f35486n;
        if (valueAnimator != null) {
            valueAnimator.cancel();
            this.f35486n = null;
        }
        ValueAnimator ofFloat = ValueAnimator.ofFloat(this.h, f7);
        this.f35486n = ofFloat;
        ofFloat.addUpdateListener(new c3(this, 16));
        this.f35486n.addListener(new ai.t2(this, f7, l50Var, 3));
        this.f35486n.setDuration(420L);
        this.f35486n.setInterpolator(org.telegram.ui.Components.rr.h);
        this.f35486n.start();
    }
    ...
    public final void onCreate(Bundle bundle) {
        ...
        setContentView(this.f35482a, new ViewGroup.LayoutParams(-1, -1));
