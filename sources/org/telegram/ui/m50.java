...
public final class m50 extends Dialog {
    public final ai.n4 f35481a;
    public final n50 f35482b;
    public Bitmap f35483c;
    public Paint d;
    public BitmapShader e;
    public final Matrix f35484f;
    public float h;
    public ValueAnimator f35485n;
    public boolean f35486r;

    public m50(Context context, n50 n50Var) {
        super(context, R.style.TransparentDialog);
        this.f35484f = new Matrix();
        this.f35482b = n50Var;
    ...
    public final void b(float f7, l50 l50Var) {
        ValueAnimator valueAnimator = this.f35485n;
        if (valueAnimator != null) {
            valueAnimator.cancel();
            this.f35485n = null;
        }
        ValueAnimator ofFloat = ValueAnimator.ofFloat(this.h, f7);
        this.f35485n = ofFloat;
        ofFloat.addUpdateListener(new c3(this, 16));
        this.f35485n.addListener(new ai.t2(this, f7, l50Var, 3));
        this.f35485n.setDuration(420L);
        this.f35485n.setInterpolator(org.telegram.ui.Components.rr.h);
        this.f35485n.start();
    }
    ...
    public final void onCreate(Bundle bundle) {
        ...
        setContentView(this.f35481a, new ViewGroup.LayoutParams(-1, -1));
