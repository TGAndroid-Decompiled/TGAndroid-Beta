...
public final class m50 extends org.telegram.ui.ActionBar.j {
    public final Activity f38600a;
    public final j60 f38601b;
    ...
    public final void b(int i10) {
        ...
        int i13;
        String str;
        j60 j60Var = this.f38601b;
        if (i10 == -1) {
            j60Var.onBackPressed();
        } else if (i10 == 1) {
            j60Var.f37540a1.call.join_muted = false;
            j60.F0(j60Var);
        } else if (i10 == 2) {
            j60Var.f37540a1.call.join_muted = true;
            j60.F0(j60Var);
        } else if (i10 == 3) {
            j60Var.j1(false);
        } else if (i10 == 12) {
            ...
            if (ChatObject.isChannelOrGiga(j60Var.Z0)) {
                alertDialog$Builder.f20225a.R = LocaleController.getString(R.string.VoipChannelEndAlertTitle);
                alertDialog$Builder.f20225a.T = LocaleController.getString(R.string.VoipChannelEndAlertText);
            } else {
                alertDialog$Builder.f20225a.R = LocaleController.getString(R.string.VoipGroupEndAlertTitle);
                alertDialog$Builder.f20225a.T = LocaleController.getString(R.string.VoipGroupEndAlertText);
            }
            ...
            if (call.recording) {
                ...
                alertDialog$Builder2.f20225a.I = org.telegram.ui.ActionBar.j6.f20916pg;
                alertDialog$Builder2.f20225a.R = LocaleController.getString(R.string.VoipGroupStopRecordingTitle);
                if (ChatObject.isChannelOrGiga(j60Var.Z0)) {
                    alertDialog$Builder2.f20225a.T = LocaleController.getString(R.string.VoipChannelStopRecordingText);
                } else {
                    alertDialog$Builder2.f20225a.T = LocaleController.getString(R.string.VoipGroupStopRecordingText);
                }
                alertDialog$Builder2.k(LocaleController.getString(R.string.Stop), new bi.h(10, this, z10));
                alertDialog$Builder2.h(LocaleController.getString(R.string.Cancel), null);
                int w04 = org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f21009ug, false);
                org.telegram.ui.ActionBar.b2 b2Var2 = alertDialog$Builder2.f20225a;
                b2Var2.i(w04);
                b2Var2.show();
                b2Var2.o(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20880ng, false));
                return;
            }
            ...
            j60Var.f37585l0 = true;
            j60Var.f37623u1.setVisibility(0);
            j60Var.f37627v1.setVisibility(0);
            j60Var.f37593n1.setVisibility(8);
            j60Var.f37637x1.setVisibility(8);
            j60Var.f37642y1.setVisibility(8);
            j60Var.f37632w1.setVisibility(8);
            j60Var.f37610r1.setVisibility(8);
            j60Var.f37597o1.setVisibility(8);
            j60Var.f37615s1.setVisibility(8);
            j60Var.f37619t1.setVisibility(8);
            j60Var.f37581k0.setVisibility(8);
            j60Var.f37601p1.setVisibility(8);
            j60Var.f37605q1.setVisibility(8);
            org.telegram.ui.ActionBar.v0 v0Var = j60Var.f37582k1;
            org.telegram.ui.ActionBar.n1 n1Var = v0Var.d;
            if (n1Var != null && n1Var.isShowing()) {
                v0Var.f21405b.measure(org.telegram.messenger.wl.d(40.0f, AndroidUtilities.displaySize.x, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.displaySize.y, Integer.MIN_VALUE));
                v0Var.O(true, true);
            }
        } else if (i10 == 6) {
            ...
            alertDialog$Builder3.f20225a.I = org.telegram.ui.ActionBar.j6.f20916pg;
            if (ChatObject.isChannelOrGiga(j60Var.Z0)) {
                alertDialog$Builder3.f20225a.R = LocaleController.getString(R.string.VoipChannelTitle);
            } else {
                alertDialog$Builder3.f20225a.R = LocaleController.getString(R.string.VoipGroupTitle);
            }
            alertDialog$Builder3.f20225a.f20287y0 = false;
            ...
            if (!TextUtils.isEmpty(j60Var.f37540a1.call.title)) {
                editTextBoldCursor.setText(j60Var.f37540a1.call.title);
            ...
            int w05 = org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20735fg, false);
            ...
            org.telegram.ui.ActionBar.f3 f3Var = new org.telegram.ui.ActionBar.f3(1, (Context) this.f38600a, (org.telegram.ui.ActionBar.f6) null, false);
            ...
            int i16 = org.telegram.ui.ActionBar.j6.f20828kg;
            ...
            f3Var.show();
            f3Var.setTitleColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20880ng, false));
            for (int i17 = 0; i17 < f3Var.getItemViews().size(); i17++) {
                org.telegram.ui.ActionBar.y2 y2Var = f3Var.getItemViews().get(i17);
                if (i17 == i11) {
                    w02 = org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20916pg, false);
                    y2Var.f21568f = true;
                } else {
                    w02 = org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20880ng, false);
                }
                y2Var.setTextColor(w02);
                y2Var.setIconColor(w02);
                y2Var.setBackground(org.telegram.ui.ActionBar.j6.f0(i0.a.k(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20770hg, false), 12), 2, -1));
            }
        }
    }
}
