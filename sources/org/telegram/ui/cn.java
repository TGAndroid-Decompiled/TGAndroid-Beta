...
public final class cn extends org.telegram.ui.Components.uq0 {
    public final MessageObject f32750b1;
    public final in f32751c1;
    ...
    public cn(in inVar, Activity activity, wn wnVar, ArrayList arrayList, boolean z10, boolean z11, org.telegram.ui.ActionBar.d6 d6Var, boolean z12, MessageObject messageObject) {
        ...
        this.f32751c1 = inVar;
        this.f32750b1 = messageObject;
        this.f28874a0 = z12;
    }

    @Override
    public final void R0(a0.i iVar, int i10, TLRPC.TL_forumTopic tL_forumTopic, boolean z10) {
        in inVar = this.f32751c1;
        wn wnVar = inVar.f34558a;
        int i11 = wn.Gc;
        wnVar.Q7();
        if (inVar.f34558a.y3 != null && z10) {
            if (iVar.m() == 1) {
                if (((TLRPC.Dialog) iVar.n(0)).f18340id != inVar.f34558a.getUserConfig().getClientUserId() || !org.telegram.ui.Components.xc.a0(inVar.f34558a).e0(i10, ((TLRPC.Dialog) iVar.n(0)).f18340id)) {
                    inVar.f34558a.y3.k(((TLRPC.Dialog) iVar.n(0)).f18340id, 53, Integer.valueOf(i10), tL_forumTopic, null, null);
                    return;
                }
                return;
            }
            inVar.f34558a.y3.k(0L, 53, Integer.valueOf(i10), Integer.valueOf(iVar.m()), null, null);
        }
    }
    ...
    public final void S0(final View view) {
        ci.ec ecVar;
        wn wnVar = this.f32751c1.f34558a;
        ...
        MessageObject messageObject = this.f32750b1;
        if (messageObject.getGroupId() != 0) {
            groupedMessages = (MessageObject.GroupedMessages) wnVar.f39702x6.f(messageObject.getGroupId());
        }
