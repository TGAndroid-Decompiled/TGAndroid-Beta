...
public final class cn extends org.telegram.ui.Components.uq0 {
    ...
    public final void R0(a0.i iVar, int i10, TLRPC.TL_forumTopic tL_forumTopic, boolean z10) {
        ...
        int i11 = wn.Gc;
        wnVar.Q7();
        if (inVar.f34557a.y3 != null && z10) {
            if (iVar.m() == 1) {
                if (((TLRPC.Dialog) iVar.n(0)).f18339id != inVar.f34557a.getUserConfig().getClientUserId() || !org.telegram.ui.Components.xc.a0(inVar.f34557a).e0(i10, ((TLRPC.Dialog) iVar.n(0)).f18339id)) {
                    inVar.f34557a.y3.k(((TLRPC.Dialog) iVar.n(0)).f18339id, 53, Integer.valueOf(i10), tL_forumTopic, null, null);
                    return;
                }
                return;
            }
            inVar.f34557a.y3.k(0L, 53, Integer.valueOf(i10), Integer.valueOf(iVar.m()), null, null);
        }
    }
    ...
    public final void S0(final View view) {
        ci.ec ecVar;
        wn wnVar = this.f32750c1.f34557a;
