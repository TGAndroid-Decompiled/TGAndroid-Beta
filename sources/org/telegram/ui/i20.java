...
public final class i20 extends FrameLayout {
    public org.telegram.ui.ActionBar.k5 f34422a;
    public ImageView f34423b;

    @Override
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        int dp;
        int measuredWidth;
        ImageView imageView = this.f34423b;
        int i14 = i12 - i10;
        org.telegram.ui.ActionBar.k5 k5Var = this.f34422a;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f34422a.measure(org.telegram.messenger.wl.d(94.0f, size, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), 1073741824));
        this.f34423b.measure(View.MeasureSpec.makeMeasureSpec(size, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(50.0f), 1073741824));
