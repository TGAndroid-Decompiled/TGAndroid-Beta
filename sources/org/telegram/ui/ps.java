...
public final class ps implements org.telegram.ui.ActionBar.z1, org.telegram.ui.Components.zk0, org.telegram.ui.Components.nl0, r0.n {
    public final ContactsActivity f36675a;

    public ps(ContactsActivity contactsActivity) {
        this.f36675a = contactsActivity;
    }

    @Override
    public r0.l1 Q0(View view, r0.l1 l1Var) {
        int i10 = AndroidUtilities.getDefaultWindowInsets(l1Var, false).d;
        ContactsActivity contactsActivity = this.f36675a;
        contactsActivity.f31039q0 = i10;
        contactsActivity.j0();
        contactsActivity.i0();
        contactsActivity.h0();
