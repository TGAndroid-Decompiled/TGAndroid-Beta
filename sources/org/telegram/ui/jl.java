        ...
        switch (this.G) {
            case 1:
                ...
                if (((org.telegram.ui.Components.qo) this.J).h) {
                    ...
                    rectF.set(this.f29987a.getImageX(), this.f29987a.getImageY(), this.f29987a.getImageX2(), this.f29987a.getImageY2());
                    ...
                    hVar.setBounds((int) this.f29987a.getImageX(), (int) this.f29987a.getImageY(), (int) this.f29987a.getImageX2(), (int) this.f29987a.getImageY2());
                    hVar.draw(canvas);
                    invalidate();
                    canvas.restore();
                    return;
        ...
        switch (this.G) {
            case 0:
                ...
                if (this.f29992r) {
                    ...
                    int[] roundRadius = this.f29987a.getRoundRadius();
            ...
            case 3:
                ...
                super.onDraw(canvas);
                if (((org.telegram.ui.Components.a60) this.J).f22512d0) {
