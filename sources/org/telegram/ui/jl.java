...
public final class jl extends org.telegram.ui.ActionBar.j5 {
    ...
    public jl(Object obj, Context context, int i10) {
        super(context);
        this.M0 = i10;
        this.N0 = obj;
    }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        switch (this.M0) {
            case 3:
                ...
                if (isFocusable()) {
                    if (profileActivity.h != null || profileActivity.f31633n != null) {
                        StringBuilder sb2 = new StringBuilder(getText());
                        if (profileActivity.f31633n != null) {
                            if (sb2.length() > 0) {
                                sb2.append(", ");
                            }
                            sb2.append(profileActivity.f31633n);
                        }
        ...
        switch (this.M0) {
            case 0:
                ...
                if (this == znVar.D2[0] && znVar.H2[1] != null) {
                    if (znVar.O4 && f7 < 0.0f) {
                        znVar.f40578z2.setTranslationY(f7 / 2.0f);
                        return;
                    } else {
                        znVar.f40578z2.setTranslationY(0.0f);
                        return;
                    }
                }
                return;
