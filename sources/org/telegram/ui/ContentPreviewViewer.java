...
public class ContentPreviewViewer {
    ...
    public class AnonymousClass1 implements Runnable {
        ...
        public void run() {
            ...
            if (ContentPreviewViewer.this.currentContentType == 0) {
                if (!MessageObject.isPremiumSticker(ContentPreviewViewer.this.currentDocument) || AccountInstance.getInstance(ContentPreviewViewer.this.currentAccount).getUserConfig().isPremium()) {
                    ...
                    View$OnClickListenerC00391 view$OnClickListenerC00391 = new View$OnClickListenerC00391(arrayList2, isStickerInFavorites);
                    ...
                    for (int i10 = 0; i10 < arrayList.size(); i10++) {
                        ...
                        addItem.setOnClickListener(view$OnClickListenerC00391);
                    }
        ...
        class View$OnClickListenerC00391 implements View.OnClickListener {
            final ArrayList val$actions;
            final boolean val$inFavs;

            View$OnClickListenerC00391(ArrayList arrayList, boolean z) {
