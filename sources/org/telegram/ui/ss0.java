...
public final class ss0 extends org.telegram.ui.ActionBar.j {
    public final org.telegram.ui.ActionBar.e6 f37456a;
    public final PhotoViewer f37457b;

    public ss0(PhotoViewer photoViewer, org.telegram.ui.ActionBar.e6 e6Var) {
        this.f37457b = photoViewer;
        this.f37456a = e6Var;
    }
    ...
    public final boolean a() {
        ...
        boolean z10;
        PhotoViewer photoViewer = this.f37457b;
        if (photoViewer.T4 != null || photoViewer.f30911b5 != null) {
            return true;
        }
        if (photoViewer.f30901a5 != null) {
            FileLoader fileLoader = FileLoader.getInstance(photoViewer.T);
            ImageLocation imageLocation = photoViewer.f30901a5;
            ...
            if (photoViewer.f31126z5 == 0 && !photoViewer.B5) {
                z10 = false;
            } else {
                z10 = true;
            }
            ...
            ImageLocation imageLocation2 = photoViewer.f30901a5;
            ...
            return false;
        } else if (photoViewer.f30984j7 != null) {
            return true;
        } else {
            return false;
        }
