    ...
    public final void run() {
        ...
        switch (this.f37859a) {
            ...
            case 1:
                ...
                if (photoViewer4.F2 != null || ((au0Var = photoViewer4.f31233f0) != null && au0Var.f22684x)) {
                    if (photoViewer4.f31337r1) {
                        if (!photoViewer4.S7.f23872r) {
                        ...
                        if (this.f37860b.f31255h5) {
                            ...
                            if (Math.abs(elapsedRealtime - this.f37860b.S3) >= 500) {
                                ...
                                if (au0Var2 != null && au0Var2.f22684x) {
            ...
            default:
                ...
                if (org.telegram.ui.Components.og0.x(false, photoViewer18.f31402y, null, m6Var, photoViewer18.U, photoViewer18.V, photoViewer18.K3)) {
