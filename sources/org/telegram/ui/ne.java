    ...
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        switch (this.f39330a) {
            case 0:
                ...
                return;
            case 1:
                xn xnVar2 = this.f39331b;
                xnVar2.getClass();
                xnVar2.f43160f3 = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                xnVar2.lc();
                return;
            case 2:
                xn xnVar3 = this.f39331b;
                xnVar3.getClass();
                xnVar3.f43160f3 = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                xnVar3.lc();
                return;
            case 3:
                xn xnVar4 = this.f39331b;
                xnVar4.getClass();
                xnVar4.Aa = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                xnVar4.o9();
                return;
            default:
                xn xnVar5 = this.f39331b;
                xnVar5.getClass();
