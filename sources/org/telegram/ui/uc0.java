    ...
    public final void run() {
        switch (this.f38038a) {
            case 0:
                ...
                return;
            case 1:
                kd0 kd0Var2 = this.f38039b;
                kd0Var2.getLocationController().setProximityLocation(kd0Var2.f35221e0, 0, true);
                kd0Var2.G = false;
                return;
            case 2:
                kd0 kd0Var3 = this.f38039b;
                ...
                return;
            case 3:
                hd0 hd0Var = this.f38039b.f35244x;
                if (hd0Var != null) {
                    hd0Var.a();
                    return;
                }
            ...
            case 4:
                ...
                return;
            default:
                AndroidUtilities.runOnUIThread(new uc0(this.f38039b, 0));
                return;
        }
    }
}
