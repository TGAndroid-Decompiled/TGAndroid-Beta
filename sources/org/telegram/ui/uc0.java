        ...
        switch (this.f41064a) {
            case 0:
                ...
                if (id0Var.I != null) {
                    ...
                    TLRPC.TL_channelLocation tL_channelLocation = id0Var.f37339z0;
                    if (tL_channelLocation != null) {
                        ...
                        if (DialogObject.isUserDialog(id0Var.f37312e0)) {
                            obj2.f35076c = id0Var.getMessagesController().getUser(Long.valueOf(id0Var.f37312e0));
                        } else {
                            obj2.d = id0Var.getMessagesController().getChat(Long.valueOf(-id0Var.f37312e0));
                        }
                        obj2.f35074a = id0Var.f37312e0;
                        id0Var.v0(obj2);
                        try {
                            ...
                            if (g02 != null) {
                                ...
                                obj2.f35077e = id0Var.I.addMarker(position);
                                if (!UserObject.isUserSelf(obj2.f35076c)) {
                                    IMapsProvider.IMarkerOptions flat = ApplicationLoader.getMapsProvider().onCreateMarkerOptions().position(latLng).flat(true);
                                    flat.icon(R.drawable.map_pin_circle);
                                    flat.anchor(0.5f, 0.5f);
                                    obj2.f35078f = id0Var.I.addMarker(flat);
                                }
                                id0Var.f37315g0.add(obj2);
                                id0Var.f37316h0.k(obj2, obj2.f35074a);
                            }
                        } catch (Exception e7) {
                            FileLog.e(e7);
                        }
                        id0Var.I.moveCamera(ApplicationLoader.getMapsProvider().newCameraUpdateLatLngZoom(obj2.f35077e.getPosition(), maxZoomLevel));
                    } else {
                        ...
                        if (messageObject != null) {
                            if (messageObject.isLiveLocation()) {
                                ...
                                if (!id0Var.l0()) {
                                    id0Var.I.moveCamera(ApplicationLoader.getMapsProvider().newCameraUpdateLatLngZoom(c02.f35077e.getPosition(), maxZoomLevel));
                                }
                            } else {
                                IMapsProvider.LatLng latLng2 = new IMapsProvider.LatLng(id0Var.f37336x0.getLatitude(), id0Var.f37336x0.getLongitude());
                                try {
                                ...
                                id0Var.f37314f0 = false;
                                id0Var.l0();
                            }
                        } else {
                            Location location = new Location("network");
                            id0Var.f37336x0 = location;
                            ...
                            if (tL_channelLocation2 != null) {
                                ...
                                id0Var.f37336x0.setLatitude(id0Var.A0.geo_point.lat);
                                id0Var.f37336x0.setLongitude(id0Var.A0.geo_point._long);
                                id0Var.f37336x0.setAccuracy(id0Var.A0.geo_point.accuracy_radius);
                                id0Var.T.L(id0Var.f37336x0);
                            } else {
                                location.setLatitude(20.659322d);
                                id0Var.f37336x0.setLongitude(-11.40625d);
                            }
                        }
                    }
                    try {
                    ...
                    for (int size = providers.size() - 1; size >= 0; size--) {
                        ...
                        if (location2 != null) {
                            id0Var.f37334w0 = location2;
                            id0Var.t0(location2);
                            if (id0Var.f37307b0 && id0Var.getParentActivity() != null) {
                                id0Var.f37307b0 = false;
                                id0Var.d0();
                            }
                            imageView = id0Var.f37308c;
                            if (imageView == null && imageView.getVisibility() == 0 && (sharingLocationInfo = id0Var.getLocationController().getSharingLocationInfo(id0Var.f37312e0)) != null && (i11 = sharingLocationInfo.proximityMeters) > 0) {
                                id0Var.e0(i11);
                                return;
                            }
                            return;
                ...
                return;
            default:
                id0 id0Var2 = this.f41065b;
                Location location3 = (Location) obj;
                id0Var2.t0(location3);
                id0Var2.getLocationController().setMapLocation(location3, id0Var2.f37310d0);
                id0Var2.f37310d0 = false;
                return;
        }
    }
}
