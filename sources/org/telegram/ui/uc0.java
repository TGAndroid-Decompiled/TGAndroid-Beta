        ...
        switch (this.f37975a) {
            case 0:
                ...
                if (id0Var.I != null) {
                    ...
                    TLRPC.TL_channelLocation tL_channelLocation = id0Var.f34646z0;
                    if (tL_channelLocation != null) {
                        ...
                        if (DialogObject.isUserDialog(id0Var.f34619e0)) {
                            obj2.f32755c = id0Var.getMessagesController().getUser(Long.valueOf(id0Var.f34619e0));
                        } else {
                            obj2.d = id0Var.getMessagesController().getChat(Long.valueOf(-id0Var.f34619e0));
                        }
                        obj2.f32753a = id0Var.f34619e0;
                        id0Var.v0(obj2);
                        try {
                            ...
                            if (g02 != null) {
                                ...
                                if (!UserObject.isUserSelf(obj2.f32755c)) {
                                    IMapsProvider.IMarkerOptions flat = ApplicationLoader.getMapsProvider().onCreateMarkerOptions().position(latLng).flat(true);
                                    flat.icon(R.drawable.map_pin_circle);
                                    flat.anchor(0.5f, 0.5f);
                                    obj2.f32756f = id0Var.I.addMarker(flat);
                                }
                                id0Var.f34622g0.add(obj2);
                                id0Var.f34623h0.k(obj2, obj2.f32753a);
                            }
                        } catch (Exception e) {
                            FileLog.e(e);
                        }
                        ...
                        if (messageObject != null) {
                            if (messageObject.isLiveLocation()) {
                                ...
                                IMapsProvider.LatLng latLng2 = new IMapsProvider.LatLng(id0Var.f34643x0.getLatitude(), id0Var.f34643x0.getLongitude());
                                try {
                                ...
                                id0Var.f34621f0 = false;
                                id0Var.l0();
                            }
                        } else {
                            Location location = new Location("network");
                            id0Var.f34643x0 = location;
                            ...
                            if (tL_channelLocation2 != null) {
                                ...
                                id0Var.f34643x0.setLatitude(id0Var.A0.geo_point.lat);
                                id0Var.f34643x0.setLongitude(id0Var.A0.geo_point._long);
                                id0Var.f34643x0.setAccuracy(id0Var.A0.geo_point.accuracy_radius);
                                id0Var.T.L(id0Var.f34643x0);
                            } else {
                                location.setLatitude(20.659322d);
                                id0Var.f34643x0.setLongitude(-11.40625d);
                            }
                        }
                    }
                    try {
                    ...
                    for (int size = providers.size() - 1; size >= 0; size--) {
                        ...
                        if (location2 != null) {
                            id0Var.f34641w0 = location2;
                            id0Var.t0(location2);
                            if (id0Var.f34615b0 && id0Var.getParentActivity() != null) {
                                id0Var.f34615b0 = false;
                                id0Var.d0();
                            }
                            imageView = id0Var.f34616c;
                            if (imageView == null && imageView.getVisibility() == 0 && (sharingLocationInfo = id0Var.getLocationController().getSharingLocationInfo(id0Var.f34619e0)) != null && (i11 = sharingLocationInfo.proximityMeters) > 0) {
                                id0Var.e0(i11);
                                return;
                            }
                            return;
                ...
                return;
            default:
                id0 id0Var2 = this.f37976b;
                Location location3 = (Location) obj;
                id0Var2.t0(location3);
                id0Var2.getLocationController().setMapLocation(location3, id0Var2.f34618d0);
                id0Var2.f34618d0 = false;
                return;
        }
    }
}
