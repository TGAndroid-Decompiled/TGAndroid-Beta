...
public final class pi1 extends FrameLayout {
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        ui1 ui1Var = this.f39532e;
        org.telegram.ui.Components.voip.a3 a3Var = ui1Var.v;
        if (view == a3Var && (ui1Var.f41138n0 || ui1Var.m0)) {
            return false;
        }
        if ((view != a3Var && view != ui1Var.f41115c0 && (view != ui1Var.Y || !ui1Var.f41109a0)) || (!ui1Var.f41126g1 && ui1Var.f41130i1 == null)) {
            return super.drawChild(canvas, view, j3);
        }
        canvas.save();
        float f7 = ui1Var.f41124f1;
        canvas.scale(f7, f7, ui1Var.f41113b1, ui1Var.f41116c1);
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent.getActionMasked() == 1) {
            ui1Var.f41153y.b(false, false);
            ui1Var.v.a();
            AndroidUtilities.cancelRunOnUIThread(ei1Var);
            if (ui1Var.f41140p0 == 3) {
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (!ui1Var.f41128h1 && !ui1Var.f41110a1 && !ui1Var.f41126g1 && motionEvent.getActionMasked() != 0) {
            ui1.j(ui1Var);
            return false;
        }
        if (motionEvent.getActionMasked() == 0) {
            ui1Var.f41128h1 = false;
            ui1Var.f41110a1 = false;
            ui1Var.f41126g1 = false;
        }
        if (ui1Var.m0) {
            q2Var = ui1Var.f41115c0;
        } else {
            q2Var = ui1Var.f41117d0;
        }
        if (motionEvent.getActionMasked() != 0 && motionEvent.getActionMasked() != 5) {
            if (motionEvent.getActionMasked() == 2 && ui1Var.f41110a1) {
                int i10 = -1;
                int i11 = -1;
                for (int i12 = 0; i12 < motionEvent.getPointerCount(); i12++) {
                    if (ui1Var.f41118d1 == motionEvent.getPointerId(i12)) {
                        i10 = i12;
                    }
                    if (ui1Var.f41121e1 == motionEvent.getPointerId(i12)) {
                        i11 = i12;
                    }
                }
                if (i10 != -1 && i11 != -1) {
                    ...
                    ui1Var.f41124f1 = hypot;
                    if (hypot > 1.005f && !ui1Var.f41126g1) {
                        ...
                        ui1Var.f41116c1 = y3;
                        ui1Var.W0 = y3;
                        ui1Var.f41124f1 = 1.0f;
                        ui1Var.Y0 = 0.0f;
                        ui1Var.Z0 = 0.0f;
                        getParent().requestDisallowInterceptTouchEvent(true);
                        ui1Var.f41126g1 = true;
                        ui1Var.f41110a1 = true;
                    }
            ...
            } else if (motionEvent.getActionMasked() == 1 || ((motionEvent.getActionMasked() == 6 && motionEvent.getPointerCount() >= 2 && ((ui1Var.f41118d1 == motionEvent.getPointerId(0) && ui1Var.f41121e1 == motionEvent.getPointerId(1)) || (ui1Var.f41118d1 == motionEvent.getPointerId(1) && ui1Var.f41121e1 == motionEvent.getPointerId(0)))) || motionEvent.getActionMasked() == 3)) {
                getParent().requestDisallowInterceptTouchEvent(false);
                ui1.j(ui1Var);
            }
        } else {
            if (motionEvent.getActionMasked() == 0) {
                ...
                ui1Var.f41128h1 = contains;
                if (!contains) {
                    ui1.j(ui1Var);
                }
            }
            if (ui1Var.f41128h1 && !ui1Var.f41110a1 && motionEvent.getPointerCount() == 2) {
                ...
                ui1Var.W0 = y12;
                ui1Var.f41124f1 = 1.0f;
                ui1Var.f41118d1 = motionEvent.getPointerId(0);
                ui1Var.f41121e1 = motionEvent.getPointerId(1);
                ui1Var.f41110a1 = true;
            }
        }
        ...
        if (action != 0) {
            ...
            } else if (this.f39531c) {
                float x14 = motionEvent.getX() - this.f39529a;
                float y13 = motionEvent.getY() - this.f39530b;
                long currentTimeMillis = System.currentTimeMillis();
                float f10 = (y13 * y13) + (x14 * x14);
                float f11 = ui1Var.f41146t0;
                if (f10 < f11 * f11 && currentTimeMillis - this.d < 300 && currentTimeMillis - ui1Var.K0 > 300) {
                    ui1Var.K0 = System.currentTimeMillis();
                    if (ui1Var.C0) {
                        ui1Var.m(false);
                    } else if (ui1Var.f41155z0) {
                        ui1Var.A(!ui1Var.f41152x0);
                        ui1Var.f41141q0 = ui1Var.f41140p0;
                        if (!ui1Var.f41152x0 && (b3Var = ui1Var.N0) != null && b3Var.V) {
                            b3Var.e(true);
                        }
                        ui1Var.H();
                    }
            ...
            this.f39529a = motionEvent.getX();
            this.f39530b = motionEvent.getY();
            this.f39531c = true;
            this.d = System.currentTimeMillis();
        }
        if (!ui1Var.f41128h1 && !this.f39531c) {
            return false;
        }
        return true;
    }
