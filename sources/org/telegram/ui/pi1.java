...
public final class pi1 extends FrameLayout {
    public float f39556a;
    public float f39557b;
    public boolean f39558c;
    public long d;
    public final ui1 f39559e;
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        ui1 ui1Var = this.f39559e;
        org.telegram.ui.Components.voip.a3 a3Var = ui1Var.v;
        if (view == a3Var && (ui1Var.f41165n0 || ui1Var.m0)) {
            return false;
        }
        if ((view != a3Var && view != ui1Var.f41142c0 && (view != ui1Var.Y || !ui1Var.f41136a0)) || (!ui1Var.f41153g1 && ui1Var.f41157i1 == null)) {
            return super.drawChild(canvas, view, j3);
        }
        canvas.save();
        float f7 = ui1Var.f41151f1;
        canvas.scale(f7, f7, ui1Var.f41140b1, ui1Var.f41143c1);
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent.getActionMasked() == 1) {
            ui1Var.f41180y.b(false, false);
            ui1Var.v.a();
            AndroidUtilities.cancelRunOnUIThread(ei1Var);
            if (ui1Var.f41167p0 == 3) {
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (!ui1Var.f41155h1 && !ui1Var.f41137a1 && !ui1Var.f41153g1 && motionEvent.getActionMasked() != 0) {
            ui1.j(ui1Var);
            return false;
        }
        if (motionEvent.getActionMasked() == 0) {
            ui1Var.f41155h1 = false;
            ui1Var.f41137a1 = false;
            ui1Var.f41153g1 = false;
        }
        if (ui1Var.m0) {
            q2Var = ui1Var.f41142c0;
        } else {
            q2Var = ui1Var.f41144d0;
        }
        if (motionEvent.getActionMasked() != 0 && motionEvent.getActionMasked() != 5) {
            if (motionEvent.getActionMasked() == 2 && ui1Var.f41137a1) {
                int i10 = -1;
                int i11 = -1;
                for (int i12 = 0; i12 < motionEvent.getPointerCount(); i12++) {
                    if (ui1Var.f41145d1 == motionEvent.getPointerId(i12)) {
                        i10 = i12;
                    }
                    if (ui1Var.f41148e1 == motionEvent.getPointerId(i12)) {
                        i11 = i12;
                    }
                }
                if (i10 != -1 && i11 != -1) {
                    ...
                    ui1Var.f41151f1 = hypot;
                    if (hypot > 1.005f && !ui1Var.f41153g1) {
                        ...
                        ui1Var.f41153g1 = true;
                        ui1Var.f41137a1 = true;
                    }
            ...
            } else if (motionEvent.getActionMasked() == 1 || ((motionEvent.getActionMasked() == 6 && motionEvent.getPointerCount() >= 2 && ((ui1Var.f41145d1 == motionEvent.getPointerId(0) && ui1Var.f41148e1 == motionEvent.getPointerId(1)) || (ui1Var.f41145d1 == motionEvent.getPointerId(1) && ui1Var.f41148e1 == motionEvent.getPointerId(0)))) || motionEvent.getActionMasked() == 3)) {
                getParent().requestDisallowInterceptTouchEvent(false);
                ui1.j(ui1Var);
            }
        } else {
            if (motionEvent.getActionMasked() == 0) {
                ...
                ui1Var.f41155h1 = contains;
                if (!contains) {
                    ui1.j(ui1Var);
                }
            }
            if (ui1Var.f41155h1 && !ui1Var.f41137a1 && motionEvent.getPointerCount() == 2) {
                ...
                ui1Var.W0 = y12;
                ui1Var.f41151f1 = 1.0f;
                ui1Var.f41145d1 = motionEvent.getPointerId(0);
                ui1Var.f41148e1 = motionEvent.getPointerId(1);
                ui1Var.f41137a1 = true;
            }
        }
        ...
        if (action != 0) {
            ...
            } else if (this.f39558c) {
                float x14 = motionEvent.getX() - this.f39556a;
                float y13 = motionEvent.getY() - this.f39557b;
                long currentTimeMillis = System.currentTimeMillis();
                float f10 = (y13 * y13) + (x14 * x14);
                float f11 = ui1Var.f41173t0;
                if (f10 < f11 * f11 && currentTimeMillis - this.d < 300 && currentTimeMillis - ui1Var.K0 > 300) {
                    ui1Var.K0 = System.currentTimeMillis();
                    if (ui1Var.C0) {
                        ui1Var.m(false);
                    } else if (ui1Var.f41182z0) {
                        ui1Var.A(!ui1Var.f41179x0);
                        ui1Var.f41168q0 = ui1Var.f41167p0;
                        if (!ui1Var.f41179x0 && (b3Var = ui1Var.N0) != null && b3Var.V) {
                            b3Var.e(true);
                        }
                        ui1Var.H();
                    }
            ...
            this.f39556a = motionEvent.getX();
            this.f39557b = motionEvent.getY();
            this.f39558c = true;
            this.d = System.currentTimeMillis();
        }
        if (!ui1Var.f41155h1 && !this.f39558c) {
            return false;
        }
        return true;
    }
