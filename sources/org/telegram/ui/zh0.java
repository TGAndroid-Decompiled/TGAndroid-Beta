...
public final class zh0 extends org.telegram.ui.Components.ll0 {
    public final Context f40260c;
    public final ai0 d;

    public zh0(ai0 ai0Var, Context context) {
        this.d = ai0Var;
        this.f40260c = context;
    }
    ...
    public final boolean D(s4.c1 c1Var) {
        int b10 = c1Var.b();
        ai0 ai0Var = this.d;
        if (ai0Var.Q != b10 && ai0Var.f31900x != b10) {
            if (b10 < ai0Var.f31901y || b10 >= ai0Var.E) {
    ...
    public final int j(int i10) {
        ai0 ai0Var = this.d;
        if (i10 == ai0Var.f31894r) {
            return 0;
        }
        if (i10 == ai0Var.f31896s || i10 == ai0Var.L || i10 == ai0Var.S || i10 == ai0Var.P) {
            return 1;
        }
        if (i10 == ai0Var.v) {
            return 2;
        }
        if (i10 == ai0Var.f31900x) {
            return 3;
        }
        if (i10 != ai0Var.f31899w && i10 != ai0Var.J && i10 != ai0Var.M && i10 != ai0Var.R && i10 != ai0Var.T) {
            if (i10 < ai0Var.f31901y || i10 >= ai0Var.E) {
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        int i11;
        ai0 ai0Var = this.d;
        Context context = this.f40260c;
        switch (i10) {
            case 1:
                v80Var = new org.telegram.ui.Cells.l4(context, 23);
                break;
            case 2:
                org.telegram.ui.Components.v80 v80Var2 = new org.telegram.ui.Components.v80(this.f40260c, ai0Var, null, true, ai0Var.h);
            ...
            case 9:
                ...
                break;
            case 10:
                v80Var = new org.telegram.ui.Cells.a5(8, 6, this.f40260c, null, false);
                break;
            case 11:
            ...
            default:
                ...
                textView.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18920g9, false));
