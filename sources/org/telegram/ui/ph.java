...
public final class ph implements Utilities.Callback {
    ...
    public final void run(Object obj) {
        ...
        switch (this.f36634a) {
            case 0:
                bo.Y((bo) this.e, this.f36635b, this.f36636c, this.d, (Boolean) obj);
                return;
            default:
                Boolean bool = (Boolean) obj;
                i10 = ((org.telegram.ui.ActionBar.o2) ((oj) this.e).f36367b).currentAccount;
                ...
                y3.i0(this.f36635b, this.f36636c, z10, true);
                return;
        }
    }
}
