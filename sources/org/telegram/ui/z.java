...
public final class z implements View.OnClickListener {
    ...
    public final void onClick(View view) {
        ...
        boolean z12 = false;
        Object obj = this.d;
        Object obj2 = this.f40057c;
        Object obj3 = this.f40056b;
        switch (i10) {
            case 0:
                h4 h4Var = (h4) obj3;
                ...
                new org.telegram.ui.Components.vc(l3Var.f35437f, null).k(false).k(true);
                return;
            case 1:
                f7 f7Var = (f7) obj3;
                ...
                zh.a aVar = ((o7) obj2).d;
                long j3 = aVar.f49223b;
                if (j3 > 0) {
                    bundle.putLong("user_id", j3);
                } else {
                    bundle.putLong("chat_id", -j3);
                }
                bundle.putInt("message_id", aVar.f49226g);
                o2Var.presentFragment(new bo(bundle));
                f7Var.e.E.dismiss();
                org.telegram.ui.ActionBar.o1 o1Var = f7Var.f33569a;
                if (o1Var != null) {
                    o1Var.d(true);
                    return;
                }
            ...
            case 7:
                ...
                org.telegram.ui.ActionBar.o2 o2Var2 = nnVar.f36139a;
            ...
            case 9:
                ...
                PhotoViewer photoViewer = ((yr) obj3).f40012c.f37551a;
                    ...
                    while (true) {
                        if (i11 < size) {
                            ...
                            for (int i12 = 0; i12 < arrayList.size(); i12++) {
                                ...
                                if (f71Var3.f23818k < j10 && org.telegram.ui.Components.h71.Y(f71Var3.f23820m)) {
                                    j10 = f71Var3.f23818k;
                                    f71Var2 = f71Var3;
                                }
                            }
                            if (f71Var2 != null) {
                                document = f71Var2.f23815g;
                            } else {
                                document = ((org.telegram.ui.Components.f71) arrayList.get(0)).f23815g;
                            }
                        }
                    }
                }
                if (document != null) {
                    ...
                    if (pathToAttach != null && pathToAttach.exists()) {
                        MediaController.saveFile(pathToAttach.toString(), photoViewer.f31132y, 1, null, null, new qr0(photoViewer, 1));
                    } else {
                        ArrayList arrayList2 = new ArrayList();
                        messageObject2.qualityToSave = document;
                        arrayList2.add(messageObject2);
                        MediaController.saveFilesFromMessages(photoViewer.f31132y, AccountInstance.getInstance(photoViewer.T), arrayList2, new wa(photoViewer, 3));
                    }
                    photoViewer.f31040o0.M(null, null);
                    return;
                }
                return;
            case 10:
                ...
                org.telegram.ui.Components.c5.O((Context) obj2, LocaleController.getString(R.string.ResetToOriginalPhotoTitle), LocaleController.formatString(R.string.ResetToOriginalPhotoMessage, user.first_name), LocaleController.getString(R.string.Reset), new ls(usVar, user, 1), usVar.f38191r).o();
                return;
            case 11:
                gh0 gh0Var = (gh0) obj3;
                ((org.telegram.ui.Components.n70) obj2).u();
                int i13 = ((MessagesController.DialogFilter) obj).f15613id;
                if (gh0Var.f31904c.getCurrentPosition() == 0 && (wyVar = gh0Var.J) != null) {
                    wyVar.w4(i13);
                    return;
                }
                if (gh0Var.J == null) {
