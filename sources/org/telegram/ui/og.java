...
public final class og implements Utilities.Callback2 {
    public final int f36342a = 0;
    public final bo f36343b;
    public final org.telegram.ui.Cells.t1 f36344c;
    public final nf.e d;
    ...
    public final void run(Object obj, Object obj2) {
        ...
        switch (this.f36342a) {
            case 0:
                ...
                CharacterStyle characterStyle = (CharacterStyle) this.f36345f;
                ...
                bo boVar = this.f36343b;
                org.telegram.ui.Cells.t1 t1Var2 = this.f36344c;
            ...
            default:
                bj bjVar = (bj) this.d;
                int[] iArr = (int[]) this.e;
                MessageObject messageObject = (MessageObject) this.f36345f;
                TLRPC.messages_Messages messages_messages = (TLRPC.messages_Messages) obj;
                TLRPC.TL_error tL_error = (TLRPC.TL_error) obj2;
                bo boVar2 = this.f36343b;
                if (boVar2.f32542zb == bjVar) {
                    iArr[0] = 0;
                    bjVar.c(false);
                    if (messages_messages != null) {
                        ...
                        if (richMessage != null && (message = messageObject.messageOwner) != null) {
                            ...
                            nn nnVar = boVar2.f32402oc;
                            if (nnVar != null && (t1Var = this.f36344c) != null) {
