...
public final class dx0 extends ww0 {
    public final int f33233r = 0;
    public final org.telegram.ui.Components.ll0 f33234s;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        switch (this.f33233r) {
            ...
            default:
                ...
                ImageView imageView2 = this.f39182c;
                rectF2.set(imageView2.getLeft(), imageView2.getTop(), imageView2.getRight(), imageView2.getBottom());
                rg.j1 j1Var = (rg.j1) this.f33234s;
                j1Var.f42357c.f42380p0.d(0, 0.0f, 0, getMeasuredWidth(), -this.f39183f.e, j1Var.f42357c.f42370e0);
                canvas.drawRoundRect(rectF2, AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f), j1Var.f42357c.f42380p0.f42578f);
                super.dispatchDraw(canvas);
                return;
        }
    }
