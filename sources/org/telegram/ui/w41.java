...
public final class w41 implements Runnable {
    ...
    public final SecretMediaViewer f41787b;

    public w41(SecretMediaViewer secretMediaViewer, int i10) {
        this.f41786a = i10;
        this.f41787b = secretMediaViewer;
    }
    ...
    public final void run() {
        ...
        SecretMediaViewer secretMediaViewer = this.f41787b;
        switch (i10) {
            case 0:
                secretMediaViewer.K0 = null;
                secretMediaViewer.m0 = 0;
                secretMediaViewer.f34095e.setLayerType(0, null);
                secretMediaViewer.f34095e.setVisibility(4);
                secretMediaViewer.f34125s = false;
            ...
            case 1:
                ...
                if (wVar != null) {
                    ...
                    new ArrayList();
                    AndroidUtilities.runOnUIThread(new w41(secretMediaViewer, 4), 50L);
                    secretMediaViewer.f34095e.setScaleX(1.0f);
                    secretMediaViewer.f34095e.setScaleY(1.0f);
                    return;
                }
                return;
            case 2:
                ...
                if (c51Var != null) {
                    ...
                    int[] iArr = secretMediaViewer.f34108j1;
                    Arrays.fill(iArr, 0);
                    int[] iArr2 = secretMediaViewer.f34110k1;
                    Arrays.fill(iArr2, 0);
                    c51 c51Var2 = secretMediaViewer.f34139y;
                    if (c51Var2 != null) {
                        long max = Math.max(0L, c51Var2.n()) / 1000;
                        long max2 = Math.max(0L, secretMediaViewer.f34139y.p()) / 1000;
                        iArr[0] = (int) (max / 60);
                        iArr[1] = (int) (max % 60);
                        iArr2[0] = (int) (max2 / 60);
                        iArr2[1] = (int) (max2 % 60);
                    ...
                    if (secretMediaViewer.f34139y.y()) {
                        AndroidUtilities.runOnUIThread(secretMediaViewer.f34106i1, 17L);
                        return;
                    }
                    return;
                }
            ...
            case 3:
                ...
                return;
            default:
                ImageReceiver.BitmapHolder bitmapHolder = secretMediaViewer.f34105i0;
                if (bitmapHolder != null) {
                    bitmapHolder.release();
                    secretMediaViewer.f34105i0 = null;
                }
                secretMediaViewer.h.setImageBitmap((Bitmap) null);
                try {
                    if (secretMediaViewer.d.getParent() != null) {
                        ((WindowManager) secretMediaViewer.f34087b.getSystemService("window")).removeView(secretMediaViewer.d);
                    }
                } catch (Exception e7) {
                    FileLog.e(e7);
                }
                secretMediaViewer.f34107j0 = false;
                return;
        }
    }
