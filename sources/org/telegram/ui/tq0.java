...
public final class tq0 extends org.telegram.ui.ActionBar.h5 {
    public final sl0 f37849f = new sl0(this, 11);
    public final cr0 h;
    ...
    public final void q(EditText editText) {
        ...
        if (editText.getText().length() == 0) {
            cr0 cr0Var = this.h;
            cr0Var.f32879f.clear();
            cr0Var.h.clear();
            cr0Var.v = null;
            cr0Var.f32894s = true;
            cr0Var.f32892r = false;
            if (cr0Var.f32901x != 0) {
                i10 = ((org.telegram.ui.ActionBar.o2) cr0Var).currentAccount;
                ConnectionsManager.getInstance(i10).cancelRequest(cr0Var.f32901x, true);
                cr0Var.f32901x = 0;
            }
