...
public final class tq0 extends org.telegram.ui.Components.ov0 {
    public int f40842w0;
    public boolean f40843x0;
    public int f40844y0;
    public final br0 f40845z0;

    public tq0(br0 br0Var, Context context) {
        super(context, null);
        this.f40845z0 = br0Var;
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f40843x0 = true;
        int dp = ((size2 - AndroidUtilities.dp(4.0f)) - AndroidUtilities.dp(4.0f)) / br0Var.f34920g0;
        br0Var.R = dp;
        if (this.f40844y0 != dp) {
            this.f40844y0 = dp;
        ...
        if (br0Var.Y) {
            ...
            br0Var.M.y1(Math.max(1, ((br0Var.f34920g0 - 1) * AndroidUtilities.dp(2.0f)) + (br0Var.R * br0Var.f34920g0)));
        }
        this.f40843x0 = false;
        ...
        int R = R();
        if (AndroidUtilities.dp(20.0f) >= 0 && !AndroidUtilities.isInMultiwindow && br0Var.f34915d0 != null && br0Var.Z.getParent() == this) {
            size4 -= br0Var.f34915d0.getEmojiPadding();
            makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(size4, 1073741824);
        }
        int i12 = size4;
        int i13 = makeMeasureSpec;
        if (R > AndroidUtilities.dp(20.0f) && (huVar = br0Var.f34915d0) != null) {
            this.f40843x0 = true;
            huVar.j();
            this.f40843x0 = false;
        }
        org.telegram.ui.Components.hu huVar2 = br0Var.f34915d0;
        if (huVar2 != null && huVar2.f26878e) {
        ...
        for (int i14 = 0; i14 < childCount; i14++) {
            ...
            if (childAt != null && childAt.getVisibility() != 8) {
                org.telegram.ui.Components.hu huVar3 = br0Var.f34915d0;
