...
public final class ba0 implements Runnable {
    public final LaunchActivity f34672a;
    public final org.telegram.ui.ActionBar.n2 f34673b;
    public final int f34674c;
    public final TLRPC.User d;
    public final TLRPC.TL_messages_botApp f34675e;
    public final AtomicBoolean f34676f;
    ...
    public ba0(LaunchActivity launchActivity, org.telegram.ui.ActionBar.n2 n2Var, int i10, TLRPC.User user, TLRPC.TL_messages_botApp tL_messages_botApp, AtomicBoolean atomicBoolean, String str, boolean z10, boolean z11, boolean z12, boolean z13) {
        this.f34672a = launchActivity;
        this.f34673b = n2Var;
        this.f34674c = i10;
        this.d = user;
        this.f34675e = tL_messages_botApp;
    ...
    public final void run() {
        ...
        org.telegram.ui.ActionBar.n2 n2Var = this.f34673b;
        if (n2Var != null && LaunchActivity.C1) {
            LaunchActivity launchActivity = this.f34672a;
            if (!launchActivity.isFinishing() && !launchActivity.isDestroyed()) {
                TLRPC.User user = this.d;
                long j3 = user.f20016id;
                TLRPC.TL_messages_botApp tL_messages_botApp = this.f34675e;
                TLRPC.BotApp botApp = tL_messages_botApp.app;
                boolean z10 = this.f34676f.get();
                int i10 = this.f34674c;
                String str = this.h;
                boolean z11 = this.f34677n;
                boolean z12 = this.f34678r;
                ...
                if (launchActivity.P() == null || launchActivity.P().k(b10) == null) {
                    ...
                    if (b3Var != null) {
                        b3Var.setWasOpenedByLinkIntent(this.f34679s);
                    }
                    k3Var.w(!z11);
                    if (z12) {
