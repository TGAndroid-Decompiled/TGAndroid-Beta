...
public final class as extends Drawable {
    public final org.telegram.ui.ActionBar.f6 f31064a;
    public final Paint f31065b = new Paint(1);
    public final Paint f31066c;
    public final Drawable d;
    public final RectF e;
    public final org.telegram.ui.Components.n6 f31067f;
    public final org.telegram.ui.Components.n6 f31068g;
    public final Paint h;
    public final Path f31069i;
    public final Drawable f31070j;
    public int f31071k;
    public boolean f31072l;
    public final org.telegram.ui.Components.d6 f31073m;
    ...
    public as(Context context, int i10, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        Path path = new Path();
        this.f31069i = path;
        this.f31073m = new org.telegram.ui.Components.d6(new fj(this, 12), 320L, org.telegram.ui.Components.wr.h, 0);
        zr zrVar = new zr(0, this);
        this.f31064a = f6Var;
        this.d = context.getResources().getDrawable(i10).mutate();
        this.f31070j = context.getResources().getDrawable(R.drawable.mini_casting_fill).mutate();
        paint.setColor(-1);
    ...
    public final void draw(Canvas canvas) {
        ...
        int i10;
        float f12;
        float e = this.f31073m.e(this.f31072l);
        org.telegram.ui.Components.n6 n6Var = this.f31067f;
        float d = n6Var.d() + (n6Var.g() * AndroidUtilities.dp(5.0f));
        org.telegram.ui.Components.n6 n6Var2 = this.f31068g;
        ...
        if (d * f15 > 0.0f) {
            ...
            n6Var.f25442w = (int) (n6Var.g() * 255.0f * f15);
            float f16 = f7 / 2.0f;
        ...
        if (e > 0.0f) {
            canvas2.save();
            int v02 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Oh, this.f31064a);
            int i13 = this.f31071k;
            Drawable drawable2 = this.f31070j;
            if (i13 != v02) {
                this.f31071k = v02;
            ...
            if (e > 0.5f) {
                ...
                canvas2.drawPath(this.f31069i, this.h);
                canvas2.restore();
            }
        ...
        if (i10 > 0) {
            ...
            n6Var2.f25442w = (int) (n6Var2.g() * f12);
            float f17 = f7 / 2.0f;
