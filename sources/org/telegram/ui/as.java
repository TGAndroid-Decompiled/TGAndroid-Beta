...
public final class as extends Drawable {
    public final org.telegram.ui.ActionBar.f6 f31960a;
    public final Paint f31961b = new Paint(1);
    public final Paint f31962c;
    public final Drawable d;
    public final RectF e;
    public final org.telegram.ui.Components.m6 f31963f;
    public final org.telegram.ui.Components.m6 f31964g;
    public final Paint h;
    public final Path f31965i;
    public final Drawable f31966j;
    public int f31967k;
    public boolean f31968l;
    public final org.telegram.ui.Components.c6 f31969m;
    ...
    public as(Context context, int i10, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        Path path = new Path();
        this.f31965i = path;
        this.f31969m = new org.telegram.ui.Components.c6(new ej(this, 12), 320L, org.telegram.ui.Components.qr.h, 0);
        zr zrVar = new zr(0, this);
        this.f31960a = f6Var;
        this.d = context.getResources().getDrawable(i10).mutate();
        this.f31966j = context.getResources().getDrawable(R.drawable.mini_casting_fill).mutate();
        paint.setColor(-1);
    ...
    public final void draw(Canvas canvas) {
        ...
        int i10;
        float f12;
        float e = this.f31969m.e(this.f31968l);
        org.telegram.ui.Components.m6 m6Var = this.f31963f;
        float d = m6Var.d() + (m6Var.g() * AndroidUtilities.dp(5.0f));
        org.telegram.ui.Components.m6 m6Var2 = this.f31964g;
        ...
        if (d * f15 > 0.0f) {
            ...
            m6Var.f26084w = (int) (m6Var.g() * 255.0f * f15);
            float f16 = f7 / 2.0f;
        ...
        if (e > 0.0f) {
            canvas2.save();
            int v02 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Oh, this.f31960a);
            int i13 = this.f31967k;
            Drawable drawable2 = this.f31966j;
            if (i13 != v02) {
                this.f31967k = v02;
            ...
            if (e > 0.5f) {
                ...
                canvas2.drawPath(this.f31965i, this.h);
                canvas2.restore();
            }
        ...
        if (i10 > 0) {
            ...
            m6Var2.f26084w = (int) (m6Var2.g() * f12);
            float f17 = f7 / 2.0f;
