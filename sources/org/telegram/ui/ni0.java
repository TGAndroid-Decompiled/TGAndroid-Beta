        ...
        switch (this.f38965a) {
            case 0:
                ...
                if (!arrayList.isEmpty()) {
                    ...
                    if (mediaLocation != null) {
                        if (fzVar.f36513s == null) {
                            TLRPC.Document document = mediaLocation.document;
                            if (document != null) {
                                fzVar.f36513s = FileLoader.getAttachFileName(document, "tgs");
                            } else {
                                fzVar.f36513s = FileLoader.getAttachFileName(mediaLocation.location, "tgs");
                            }
                        }
                        if (fzVar.f36513s != null) {
                            Float fileProgress = ImageLoader.getInstance().getFileProgress(fzVar.f36513s);
                ...
                return;
            default:
                cj0 cj0Var2 = this.f38966b;
                kb0 kb0Var = cj0Var2.d;
                if (kb0Var != null) {
                    if (cj0Var2.E == 1.0f && cj0Var2.f35145n != null) {
                        z10 = true;
                    } else {
                        z10 = false;
                    }
                ...
                if (cj0Var2.E > 0.0f && cj0Var2.f35145n != null) {
                    cj0Var2.f35150r.reset();
                    float width = getWidth() / cj0Var2.f35137f.getWidth();
                    cj0Var2.f35150r.postScale(width, width);
                    cj0Var2.h.setLocalMatrix(cj0Var2.f35150r);
                    cj0Var2.f35145n.setAlpha((int) (cj0Var2.E * 255.0f));
                    canvas2 = canvas;
                    canvas2.drawRect(0.0f, 0.0f, getWidth(), getHeight(), cj0Var2.f35145n);
                } else {
                    canvas2 = canvas;
                }
    ...
    public void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        switch (this.f38965a) {
            case 1:
                ...
                cj0 cj0Var = this.f38966b;
                if (!cj0Var.f35139g0 || cj0Var.f35140h0) {
                    ...
                    if (cj0Var.F.getWidth() > 0) {
                        ...
                        int measuredHeight3 = (cj0Var.G.getMeasuredHeight() - AndroidUtilities.dp(8.0f)) - cj0Var.f35135e.d;
                        ...
                        FrameLayout frameLayout = cj0Var.f35134d0;
                        if (frameLayout != null) {
                            frameLayout.setX(i2.g.f(6.0f, (cj0Var.X.l() + iArr[0]) - cj0Var.f35134d0.getMeasuredWidth(), 0));
                            RectF rectF = cj0Var.f35144l0;
                            if (rectF != null) {
                                FrameLayout frameLayout2 = cj0Var.f35134d0;
                                float max = Math.max(cj0Var.f35135e.f11426b, rectF.top - frameLayout2.getMeasuredWidth());
                                cj0Var.f35133c0 = max;
                                frameLayout2.setY(max);
                                qi0 qi0Var = cj0Var.f35136e0;
                                if (qi0Var != null) {
                                    qi0Var.setY(Math.max(cj0Var.f35135e.f11426b, (cj0Var.f35144l0.top - AndroidUtilities.dp(24.0f)) - cj0Var.f35136e0.getMeasuredHeight()));
                                }
                            } else {
                                float height2 = (cj0Var.X.getHeight() + iArr[1]) - vi0Var.getMeasuredHeight();
                                FrameLayout frameLayout3 = cj0Var.f35134d0;
                                float max2 = Math.max(cj0Var.f35135e.f11426b, height2 - frameLayout3.getMeasuredHeight()) + AndroidUtilities.dp(24.0f);
                                cj0Var.f35133c0 = max2;
                                frameLayout3.setY(max2);
                                qi0 qi0Var2 = cj0Var.f35136e0;
                                if (qi0Var2 != null) {
                                    qi0Var2.setY(Math.max(0.0f, (height2 - qi0Var2.getMeasuredHeight()) - cj0Var.f35133c0));
                                }
                            }
                        }
                    }
                    cj0Var.f35139g0 = true;
                    return;
                }
                return;
            default:
    ...
    public void onSizeChanged(int i10, int i11, int i12, int i13) {
        switch (this.f38965a) {
            case 1:
                ...
                cj0 cj0Var = this.f38966b;
                hh.d.c(cj0Var.f35142j0, cj0Var.F);
                ViewGroup viewGroup = cj0Var.Z;
                if (viewGroup != null) {
