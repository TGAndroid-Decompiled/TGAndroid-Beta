...
public final class ni0 extends gz {
    ...
    public final void h(fz fzVar) {
        ...
        ui0 ui0Var = bj0Var.K;
        if (fzVar != null) {
            if (bj0Var.f32188l0 != null) {
                fzVar.f33722c = true;
                float f7 = (gz.f() * AndroidUtilities.density) / 1.3f;
                float f10 = f7 / 3.0f;
                fzVar.d = f10;
                fzVar.e = f10;
                fzVar.f33720a = Utilities.clamp(bj0Var.f32188l0.right - (0.75f * f7), AndroidUtilities.displaySize.x - f7, 0.0f);
                fzVar.f33721b = bj0Var.f32188l0.bottom - (f7 / 2.0f);
                return;
            }
            ...
            if (t1Var != null && t1Var.isAttachedToWindow() && bj0Var.Q.getMessageObject() != null && bj0Var.Q.getMessageObject().getId() == bj0Var.R) {
                ...
                fzVar.e = f12;
                float f13 = f11 / 2.0f;
                fzVar.f33720a = Utilities.clamp(((ui0Var.getScaleX() * bj0Var.Q.getTimeX()) + iArr[0]) - f13, AndroidUtilities.displaySize.x - f11, 0.0f);
                fzVar.f33721b = ((ui0Var.getScaleY() * bj0Var.Q.getTimeY()) + iArr[1]) - f13;
            }
        }
    }
}
