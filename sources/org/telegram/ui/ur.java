...
public final class ur extends Drawable {
    public final org.telegram.ui.ActionBar.d6 f38200a;
    public final Paint f38201b = new Paint(1);
    public final Paint f38202c;
    public final Drawable d;
    public final RectF e;
    public final org.telegram.ui.Components.o6 f38203f;
    public final org.telegram.ui.Components.o6 f38204g;
    public final Paint h;
    public final Path f38205i;
    public final Drawable f38206j;
    public int f38207k;
    public boolean f38208l;
    public final org.telegram.ui.Components.e6 f38209m;
    ...
    public ur(Context context, int i10, org.telegram.ui.ActionBar.d6 d6Var) {
        ...
        Path path = new Path();
        this.f38205i = path;
        this.f38209m = new org.telegram.ui.Components.e6(new aj(this, 12), 320L, org.telegram.ui.Components.rr.h, 0);
        tr trVar = new tr(0, this);
        this.f38200a = d6Var;
        this.d = context.getResources().getDrawable(i10).mutate();
        this.f38206j = context.getResources().getDrawable(R.drawable.mini_casting_fill).mutate();
        paint.setColor(-1);
    ...
    public final void draw(Canvas canvas) {
        ...
        int i10;
        float f12;
        float e = this.f38209m.e(this.f38208l);
        org.telegram.ui.Components.o6 o6Var = this.f38203f;
        float d = o6Var.d() + (o6Var.g() * AndroidUtilities.dp(5.0f));
        org.telegram.ui.Components.o6 o6Var2 = this.f38204g;
        ...
        if (d * f15 > 0.0f) {
            ...
            o6Var.f26631w = (int) (o6Var.g() * 255.0f * f15);
            float f16 = f7 / 2.0f;
        ...
        if (e > 0.0f) {
            canvas2.save();
            int v02 = org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.Oh, this.f38200a);
            int i13 = this.f38207k;
            Drawable drawable2 = this.f38206j;
            if (i13 != v02) {
                this.f38207k = v02;
            ...
            if (e > 0.5f) {
                ...
                canvas2.drawPath(this.f38205i, this.h);
                canvas2.restore();
            }
        ...
        if (i10 > 0) {
            ...
            o6Var2.f26631w = (int) (o6Var2.g() * f12);
            float f17 = f7 / 2.0f;
