...
public final class ur extends org.telegram.ui.ActionBar.o2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public int f38123a0;
    public int f38124a1;
    public org.telegram.ui.Components.zw0 f38125b;
    public int f38126b0;
    public int f38127b1;
    public ai.w0 f38128c;
    public int f38129c0;
    public int f38130c1;
    public gg.j0 d;
    public int f38131d0;
    ...
    public tr e;
    public int f38133e0;
    public final int f38134e1;
    public org.telegram.ui.ActionBar.w0 f38135f;
    public int f38136f0;
    public int f38137f1;
    public int f38138g0;
    public int f38139g1;
    ...
    public int m0;
    public nr f38149m1;
    public UndoView f38150n;
    public int f38151n0;
    public final boolean f38152n1;
    public int f38153o0;
    public boolean f38154o1;
    public int f38155p0;
    public int f38156p1;
    public int f38157q0;
    public int f38158q1;
    public TLRPC.Chat f38159r;
    public int f38160r0;
    public boolean f38161r1;
    public TLRPC.ChatFull f38162s;
    public int f38163s0;
    public int f38164s1;
    public int f38165t0;
    public final boolean f38166t1;
    public int f38167u0;
    public final boolean f38168u1;
    public final boolean v;
    public int f38169v0;
    public boolean f38170v1;
    public final boolean f38171w;
    public boolean f38172w0;
    public boolean f38173w1;
    public final boolean f38174x;
    public int f38175x0;
    public boolean f38176x1;
    public final String f38177y;
    public int f38178y0;
    public boolean f38179y1;
    public int f38180z0;
    public long f38181z1;
    ...
    public ur(Bundle bundle) {
        ...
        this.f38152n1 = this.arguments.getBoolean("open_search");
        this.f38134e1 = this.arguments.getInt("selectType");
        ...
        this.f38177y = ChatObject.getBannedRightsString(this.E);
        boolean isCommunity = ChatObject.isCommunity(this.f38159r);
        this.f38171w = isCommunity;
        if (ChatObject.isChannel(this.f38159r) && !this.f38159r.megagroup && !isCommunity) {
            z10 = true;
        }
        this.v = z10;
        this.f38174x = ChatObject.isForum(this.f38159r);
        TLRPC.Chat chat2 = this.f38159r;
        if (chat2 != null) {
    ...
    public static void U(ur urVar, long j3) {
        if (j3 != 0) {
            urVar.N = j3;
            urVar.f38159r = MessagesController.getInstance(urVar.currentAccount).getChat(Long.valueOf(j3));
            urVar.u0();
        }
    }
    ...
    public static void c0(ur urVar, TLRPC.User user) {
        ...
        UndoView undoView = urVar.f38150n;
        long j3 = -urVar.N;
        boolean z12 = urVar.v;
        if (z12) {
            i10 = 9;
    ...
    public final void A0(or orVar) {
        ...
        B0();
        orVar.f(orVar.d);
        s4.o.c(orVar, true).b(this.f38122a);
        ai.w0 w0Var = this.f38128c;
        if (w0Var != null && this.d != null && w0Var.getChildCount() > 0) {
            int i10 = 0;
            int i11 = -1;
            while (true) {
                if (i10 < this.f38128c.getChildCount()) {
                    i11 = RecyclerView.S(this.f38128c.getChildAt(i10));
                    if (i11 != -1) {
                        view = this.f38128c.getChildAt(i10);
                        break;
                    }
                    i10++;
                } else {
            ...
            if (view != null) {
                this.d.h1(i11, view.getTop() - this.f38128c.getPaddingTop());
            }
        }
    }
    ...
    public final View createView(Context context) {
        ...
        if (i11 == 0 && i12 != 2 && i12 != 0 && i12 != 3) {
            if (i12 == 1 && ChatObject.isChannelAndNotMegaGroup(this.f38159r) && ChatObject.hasAdminRights(this.f38159r)) {
            ...
            if (i12 == 3) {
                this.f38135f.setSearchFieldHint(LocaleController.getString("ChannelSearchException", R.string.ChannelSearchException));
            } else {
                this.f38135f.setSearchFieldHint(LocaleController.getString("Search", R.string.Search));
            }
            if (!ChatObject.isChannel(this.f38159r) && !this.f38159r.creator) {
                this.f38135f.setVisibility(8);
            }
            if (i12 == 3) {
        ...
        frameLayout.setBackgroundColor(getThemedColor(org.telegram.ui.ActionBar.j6.f18807a7));
        ...
        this.f38125b.e.setText(LocaleController.getString(R.string.SearchEmptyViewFilteredSubtitle2));
        this.f38125b.setVisibility(8);
        this.f38125b.setAnimateLayoutChange(true);
        this.f38125b.e(true, false);
        frameLayout2.addView(this.f38125b, w7.x5.c(-1.0f, -1));
        this.f38125b.addView(frameLayout3, 0);
        ai.w0 w0Var = new ai.w0(this, context, 9);
        this.f38128c = w0Var;
        w0Var.q1();
        ai.w0 w0Var2 = this.f38128c;
        ...
        hrVar.C = false;
        hrVar.f42737m = false;
        this.f38128c.setItemAnimator(hrVar);
        ai.w0 w0Var3 = this.f38128c;
        w0Var3.Y1 = true;
        w0Var3.Z1 = 0;
        qr qrVar = new qr(this, context);
        this.f38122a = qrVar;
        w0Var3.setAdapter(qrVar);
        ai.w0 w0Var4 = this.f38128c;
        if (!LocaleController.isRTL) {
            i10 = 2;
        }
        w0Var4.setVerticalScrollbarPosition(i10);
        frameLayout2.addView(this.f38128c, w7.x5.c(-1.0f, -1));
        this.actionBar.setAdaptiveBackground(this.f38128c);
        this.f38128c.setOnItemClickListener(new sq(this, 3));
        this.f38128c.setOnItemLongClickListener(new sq(this, 4));
        if (this.f38135f != null) {
            this.f38128c.setOnScrollListener(new h3(this, 7));
        }
        UndoView undoView = new UndoView(context);
        this.f38150n = undoView;
        frameLayout2.addView(undoView, w7.x5.d(-1, -2.0f, 83, 8.0f, 0.0f, 8.0f, 8.0f));
        B0();
        this.f38128c.setEmptyView(this.f38125b);
        ai.w0 w0Var5 = this.f38128c;
        w0Var5.Y1 = false;
        w0Var5.Z1 = 0;
        if (this.f38152n1) {
            this.f38135f.z(false);
        }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.chatInfoDidLoad) {
            ...
            if (chatFull.f18122id == this.N) {
                if (!booleanValue || !ChatObject.isChannel(this.f38159r)) {
                    if (this.f38162s != null) {
                        z10 = true;
                    } else {
                        z10 = false;
                    }
                    this.f38162s = chatFull;
                    if (!z10) {
                        int k02 = k0();
                        this.f38158q1 = k02;
                        this.f38156p1 = k02;
                        int i12 = this.f38162s.boosts_unrestrict;
                        if (i12 > 0) {
                            z11 = true;
                        } else {
                            z11 = false;
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f38128c, 16, new Class[]{org.telegram.ui.Cells.l4.class, org.telegram.ui.Cells.a5.class, org.telegram.ui.Cells.x4.class, org.telegram.ui.Cells.v8.class, org.telegram.ui.Cells.ea.class, org.telegram.ui.Components.uv0.class}, null, null, null, org.telegram.ui.ActionBar.j6.f18863d6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f38128c, 32768, null, null, null, null, org.telegram.ui.ActionBar.j6.f19140s8));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f38128c, 4096, null, null, null, null, org.telegram.ui.ActionBar.j6.f18953i6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f38128c, 0, new Class[]{View.class}, org.telegram.ui.ActionBar.j6.f18985k0, null, null, org.telegram.ui.ActionBar.j6.f18864d7));
        int i10 = org.telegram.ui.ActionBar.j6.f18827b7;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f38128c, 32, new Class[]{org.telegram.ui.Cells.e9.class}, null, null, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f38128c, 0, new Class[]{org.telegram.ui.Cells.e9.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.B6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f38128c, 32, new Class[]{org.telegram.ui.Cells.a7.class}, null, null, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f38128c, 0, new Class[]{org.telegram.ui.Cells.l4.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.L6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f38128c, 0, new Class[]{org.telegram.ui.Cells.u3.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f7));
        int i11 = org.telegram.ui.ActionBar.j6.G6;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f38128c, 0, new Class[]{org.telegram.ui.Cells.ea.class}, new String[]{"textView"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f38128c, 0, new Class[]{org.telegram.ui.Cells.ea.class}, new String[]{"valueTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.I6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f38128c, 0, new Class[]{org.telegram.ui.Cells.v8.class}, new String[]{"textView"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f38128c, 0, new Class[]{org.telegram.ui.Cells.v8.class}, new String[]{"valueTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f19264z6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f38128c, 0, new Class[]{org.telegram.ui.Cells.v8.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.U6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f38128c, 0, new Class[]{org.telegram.ui.Cells.v8.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.V6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f38128c, 0, new Class[]{org.telegram.ui.Cells.a5.class}, new String[]{"nameTextView"}, null, null, -1, null, i11));
        int i12 = org.telegram.ui.ActionBar.j6.f19245y6;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f38128c, 0, new Class[]{org.telegram.ui.Cells.a5.class}, new String[]{"statusColor"}, null, null, -1, eVar, i12));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f38128c, 0, new Class[]{org.telegram.ui.Cells.a5.class}, new String[]{"statusOnlineColor"}, null, null, -1, eVar, org.telegram.ui.ActionBar.j6.f19048n6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f38150n, 32, null, null, null, null, org.telegram.ui.ActionBar.j6.Fi));
        int i13 = org.telegram.ui.ActionBar.j6.Gi;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f38150n, 0, new Class[]{UndoView.class}, new String[]{"undoImageView"}, null, null, -1, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f38150n, 0, new Class[]{UndoView.class}, new String[]{"undoTextView"}, null, null, -1, null, i13));
        int i14 = org.telegram.ui.ActionBar.j6.Hi;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f38150n, 0, new Class[]{UndoView.class}, new String[]{"infoTextView"}, null, null, -1, null, i14));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f38150n, 0, new Class[]{UndoView.class}, new String[]{"textPaint"}, null, null, -1, null, i14));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f38150n, 0, new Class[]{UndoView.class}, new String[]{"progressPaint"}, null, null, -1, null, i14));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f38150n, 8, new Class[]{UndoView.class}, new String[]{"leftImageView"}, null, null, -1, null, i14));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f38128c, 262144, new Class[]{org.telegram.ui.Cells.x4.class}, new String[]{"textView"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f38128c, 262144, new Class[]{org.telegram.ui.Cells.x4.class}, new String[]{"imageView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f19028m6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f38128c, 262144, new Class[]{org.telegram.ui.Cells.x4.class}, new String[]{"imageView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f19175u6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f38128c, 262144, new Class[]{org.telegram.ui.Cells.x4.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f19193v6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f38128c, 0, new Class[]{org.telegram.ui.Components.zw0.class}, new String[]{"title"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f38128c, 0, new Class[]{org.telegram.ui.Components.zw0.class}, new String[]{"subtitle"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f38125b.d, 4, null, null, null, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f38125b.e, 4, null, null, null, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f38128c, 0, new Class[]{org.telegram.ui.Cells.a5.class}, null, org.telegram.ui.ActionBar.j6.f19113r0, null, org.telegram.ui.ActionBar.j6.J7));
    ...
    public final boolean h0(TLObject tLObject, boolean z10, View view) {
        ...
        String str2;
        int i14;
        if (tLObject == null || (i10 = this.f38134e1) != 0) {
            return false;
        }
        if (tLObject instanceof TLRPC.ChannelParticipant) {
            ...
            if (tLObject instanceof TLRPC.ChatParticipant) {
                ...
                str = "";
                z11 = ChatObject.canAddAdmins(this.f38159r);
        ...
        if (i16 == 2) {
            ...
            if (ChatObject.canAddAdmins(this.f38159r) && ((tLObject instanceof TLRPC.TL_channelParticipant) || (tLObject instanceof TLRPC.TL_channelParticipantBanned) || (tLObject instanceof TLRPC.TL_chatParticipant) || z11)) {
                z13 = true;
            } else {
                z13 = false;
            }
            ...
            if (ChatObject.canBlockUsers(this.f38159r) && z15 && !z21 && ChatObject.isChannel(this.f38159r) && !this.f38159r.gigagroup) {
                z17 = true;
            } else {
                z17 = false;
            }
            ...
            if (!z14 && (!ChatObject.canBlockUsers(this.f38159r) || !z15)) {
                z18 = false;
            } else {
                z18 = true;
            }
            if (!z10 && z18) {
                ...
                H.W(this.f38128c.W0(view, false));
                ...
                if (ChatObject.canBlockUsers(this.f38159r) && z15) {
                    z19 = true;
                } else {
                    z19 = false;
                }
        ...
        if (i16 == 3 && ChatObject.canBlockUsers(this.f38159r)) {
            urVar = this;
            ...
            String str3 = str;
            urVar = this;
            if (i16 == 0 && ChatObject.canBlockUsers(urVar.f38159r)) {
                if (ChatObject.canAddUsers(urVar.f38159r) && i15 > 0 && !ChatObject.isCommunity(urVar.f38159r)) {
            ...
            } else if (i16 == 1 && ChatObject.canAddAdmins(urVar.f38159r) && z11) {
                if (!urVar.f38159r.creator && (tLObject instanceof TLRPC.TL_channelParticipantCreator)) {
                    j10 = j13;
                } else {
                    j10 = j13;
        ...
        H2.W(urVar.f38128c.W0(view, false));
        H2.S = 190;
        if (H2.x() > 0) {
            z12 = true;
        } else {
    ...
    public final int k0() {
        TLRPC.ChatFull chatFull = this.f38162s;
        if (chatFull != null) {
    ...
    public final void onBecomeFullyHidden() {
        UndoView undoView = this.f38150n;
        if (undoView != null) {
            undoView.e(0, true);
        }
    }
    ...
    public final void onInsets(int i10, int i11, int i12, int i13) {
        this.f38128c.setPadding(0, 0, 0, i13);
        this.f38128c.setClipToPadding(false);
        this.f38150n.setTranslationY(-i13);
    }
    ...
    public final void onResume() {
        ...
        qr qrVar = this.f38122a;
        if (qrVar != null) {
            qrVar.l();
        }
        org.telegram.ui.Components.zw0 zw0Var = this.f38125b;
        if (zw0Var != null) {
    ...
    public final void onTransitionAnimationEnd(boolean z10, boolean z11) {
        ...
        if (z10 && !z11 && this.f38152n1) {
            this.f38135f.getSearchField().requestFocus();
            AndroidUtilities.showKeyboard(this.f38135f.getSearchField());
            this.f38135f.setVisibility(8);
        }
    }

    public final boolean p0(int i10) {
        if (i10 != this.V && i10 != this.W && i10 != this.X && i10 != this.Y && i10 != this.Z && i10 != this.f38123a0 && i10 != this.f38146k0 && i10 != this.f38126b0 && i10 != this.f38129c0 && i10 != this.f38131d0) {
            return false;
        }
        return true;
    }
    ...
    public final void r0() {
        ...
        if (!this.Q) {
            ...
            if (z10 && i11 == 2) {
            ...
            } else if (!ChatObject.isChannel(this.f38159r)) {
                this.Q = false;
                arrayList3.clear();
                arrayList.clear();
                arrayList2.clear();
                ...
                iVar.b();
                if (i11 == 1) {
                    TLRPC.ChatFull chatFull2 = this.f38162s;
                    if (chatFull2 != null && (chatParticipants = chatFull2.participants) != null) {
                        int size3 = chatParticipants.participants.size();
                        while (i10 < size3) {
                            TLRPC.ChatParticipant chatParticipant = this.f38162s.participants.participants.get(i10);
                ...
                } else if (i11 == 2 && (chatFull = this.f38162s) != null && chatFull.participants != null) {
                    long j3 = getUserConfig().clientUserId;
                    int size4 = this.f38162s.participants.participants.size();
                    while (i10 < size4) {
                        TLRPC.ChatParticipant chatParticipant2 = this.f38162s.participants.participants.get(i10);
                        int i14 = this.f38134e1;
                ...
                qr qrVar2 = this.f38122a;
                if (qrVar2 != null) {
                    qrVar2.l();
                }
                B0();
                qr qrVar3 = this.f38122a;
                if (qrVar3 != null) {
                    qrVar3.l();
                }
            } else {
    ...
    public final ArrayList s0() {
        ...
        if (i10 == 0) {
            ...
            TLRPC.ChatFull chatFull = this.f38162s;
            if (chatFull != null && chatFull.participants_count <= 200 && (chat = this.f38159r) != null && chat.megagroup) {
                tL_channels_getParticipants.filter = new TLRPC.TL_channelParticipantsRecent();
            } else if (this.f38134e1 == 1) {
                if (!this.J) {
                    this.f38147k1 = 2;
    ...
    public final void v0(long j3) {
        ...
        for (int i10 = 0; i10 < 3; i10++) {
            ...
            if (tLObject != null) {
                ...
                if (this.O == 0 && (chatFull = this.f38162s) != null) {
        ...
        s4.h0 adapter = this.f38128c.getAdapter();
        tr trVar = this.e;
        if (adapter == trVar) {
            gg.c2 c2Var = trVar.h;
    ...
    public final or w0() {
        ...
        orVar.f36408b = this.f38132d1;
        orVar.f36412i = this.X0;
        orVar.f36413j = this.Y0;
        orVar.f36415l.clear();
        orVar.f36415l.addAll(this.G);
        orVar.h = this.V0;
        orVar.f36411g = this.U0;
        orVar.f36416m.clear();
        orVar.f36416m.addAll(this.H);
        orVar.e = this.E0;
        orVar.f36410f = this.F0;
        orVar.f36414k.clear();
        orVar.f36414k.addAll(this.F);
        orVar.f(orVar.f36409c);
        return orVar;
    }
    ...
    public final void x0(TLRPC.ChatFull chatFull) {
        ...
        if (chatFull != null) {
            ...
            this.f38158q1 = k02;
            this.f38156p1 = k02;
            int i10 = this.f38162s.boosts_unrestrict;
            boolean z11 = false;
            if (i10 > 0) {
                z10 = true;
            } else {
    ...
    public final void y0(int i10) {
        if (!this.isPaused && this.B1) {
            if (this.f38128c.getAdapter() != this.f38122a || !this.R) {
                org.telegram.ui.Components.t00 t00Var = null;
                for (int i11 = 0; i11 < this.f38128c.getChildCount(); i11++) {
                    View childAt = this.f38128c.getChildAt(i11);
                    if (childAt instanceof org.telegram.ui.Components.t00) {
                        t00Var = childAt;
                    }
                }
                if (t00Var != null) {
                    this.f38128c.removeView(t00Var);
                    i10--;
                }
                this.f38128c.getViewTreeObserver().addOnPreDrawListener(new br(this, t00Var, i10, 0));
            }
        }
    }
