...
public final class ur extends Drawable {
    public final org.telegram.ui.ActionBar.g6 f41910a;
    public final Paint f41911b = new Paint(1);
    public final Paint f41912c;
    public final Drawable d;
    public final RectF f41913e;
    public final org.telegram.ui.Components.j6 f41914f;
    public final org.telegram.ui.Components.j6 f41915g;
    public final Paint h;
    public final Path f41916i;
    public final Drawable f41917j;
    public int f41918k;
    public boolean f41919l;
    public final org.telegram.ui.Components.z5 f41920m;

    public ur(Context context, int i10, org.telegram.ui.ActionBar.g6 g6Var) {
        Paint paint = new Paint(1);
        this.f41912c = paint;
        this.f41913e = new RectF();
        ...
        Path path = new Path();
        this.f41916i = path;
        this.f41920m = new org.telegram.ui.Components.z5(new zi(this, 12), 320L, org.telegram.ui.Components.pr.h, 0);
        tr trVar = new tr(0, this);
        this.f41910a = g6Var;
        this.d = context.getResources().getDrawable(i10).mutate();
        this.f41917j = context.getResources().getDrawable(R.drawable.mini_casting_fill).mutate();
        paint.setColor(-1);
    ...
    public final void draw(Canvas canvas) {
        ...
        int i10;
        float f13;
        float e6 = this.f41920m.e(this.f41919l);
        org.telegram.ui.Components.j6 j6Var = this.f41914f;
        float d = j6Var.d() + (j6Var.g() * AndroidUtilities.dp(5.0f));
        org.telegram.ui.Components.j6 j6Var2 = this.f41915g;
        ...
        Paint paint2 = this.f41912c;
        RectF rectF = this.f41913e;
        if (i11 > 0) {
            f10 = dp;
            float f14 = f10 / 2.0f;
            f11 = height;
        ...
        if (d * f16 > 0.0f) {
            ...
            j6Var.f28017w = (int) (j6Var.g() * 255.0f * f16);
            float f17 = f10 / 2.0f;
        ...
        if (e6 > 0.0f) {
            canvas2.save();
            int v02 = org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.Oh, this.f41910a);
            int i13 = this.f41918k;
            Drawable drawable2 = this.f41917j;
            if (i13 != v02) {
                this.f41918k = v02;
            ...
            if (e6 > 0.5f) {
                ...
                canvas2.drawPath(this.f41916i, this.h);
                canvas2.restore();
            }
        ...
        if (i10 > 0) {
            ...
            j6Var2.f28017w = (int) (j6Var2.g() * f13);
            float f18 = f10 / 2.0f;
