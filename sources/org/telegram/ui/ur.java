...
public final class ur extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public int f38108a0;
    public int f38109a1;
    public org.telegram.ui.Components.yw0 f38110b;
    public int f38111b0;
    public int f38112b1;
    public ai.w0 f38113c;
    public int f38114c0;
    public int f38115c1;
    public gg.j0 d;
    public int f38116d0;
    ...
    public tr e;
    public int f38118e0;
    public final int f38119e1;
    public org.telegram.ui.ActionBar.v0 f38120f;
    public int f38121f0;
    public int f38122f1;
    public int f38123g0;
    public int f38124g1;
    ...
    public int m0;
    public nr f38134m1;
    public UndoView f38135n;
    public int f38136n0;
    public final boolean f38137n1;
    public int f38138o0;
    public boolean f38139o1;
    public int f38140p0;
    public int f38141p1;
    public int f38142q0;
    public int f38143q1;
    public TLRPC.Chat f38144r;
    public int f38145r0;
    public boolean f38146r1;
    public TLRPC.ChatFull f38147s;
    public int f38148s0;
    public int f38149s1;
    public int f38150t0;
    public final boolean f38151t1;
    public int f38152u0;
    public final boolean f38153u1;
    public final boolean v;
    public int f38154v0;
    public boolean f38155v1;
    public final boolean f38156w;
    public boolean f38157w0;
    public boolean f38158w1;
    public final boolean f38159x;
    public int f38160x0;
    public boolean f38161x1;
    public final String f38162y;
    public int f38163y0;
    public boolean f38164y1;
    public int f38165z0;
    public long f38166z1;
    ...
    public ur(Bundle bundle) {
        ...
        this.f38137n1 = this.arguments.getBoolean("open_search");
        this.f38119e1 = this.arguments.getInt("selectType");
        ...
        this.f38162y = ChatObject.getBannedRightsString(this.E);
        boolean isCommunity = ChatObject.isCommunity(this.f38144r);
        this.f38156w = isCommunity;
        if (ChatObject.isChannel(this.f38144r) && !this.f38144r.megagroup && !isCommunity) {
            z10 = true;
        }
        this.v = z10;
        this.f38159x = ChatObject.isForum(this.f38144r);
        TLRPC.Chat chat2 = this.f38144r;
        if (chat2 != null) {
    ...
    public static void U(ur urVar, long j3) {
        if (j3 != 0) {
            urVar.N = j3;
            urVar.f38144r = MessagesController.getInstance(urVar.currentAccount).getChat(Long.valueOf(j3));
            urVar.u0();
        }
    }
    ...
    public static org.telegram.ui.ActionBar.d5 X(ur urVar) {
        return urVar.parentLayout;
    }

    public static org.telegram.ui.ActionBar.d5 Y(ur urVar) {
        return urVar.parentLayout;
    }

    public static org.telegram.ui.ActionBar.d5 Z(ur urVar) {
        return urVar.parentLayout;
    }

    public static org.telegram.ui.ActionBar.d5 a0(ur urVar) {
        return urVar.parentLayout;
    }

    public static org.telegram.ui.ActionBar.d5 b0(ur urVar) {
        return urVar.parentLayout;
    }
    ...
    public static void c0(ur urVar, TLRPC.User user) {
        ...
        UndoView undoView = urVar.f38135n;
        long j3 = -urVar.N;
        boolean z12 = urVar.v;
        if (z12) {
            i10 = 9;
        ...
        while (i11 < 3) {
            ...
            TLObject tLObject = (TLObject) iVar.f(user.f18256id);
            if (tLObject instanceof TLRPC.ChannelParticipant) {
    ...
    public final void A0(or orVar) {
        ...
        B0();
        orVar.f(orVar.d);
        s4.o.c(orVar, true).b(this.f38107a);
        ai.w0 w0Var = this.f38113c;
        if (w0Var != null && this.d != null && w0Var.getChildCount() > 0) {
            int i10 = 0;
            int i11 = -1;
            while (true) {
                if (i10 < this.f38113c.getChildCount()) {
                    i11 = RecyclerView.R(this.f38113c.getChildAt(i10));
                    if (i11 != -1) {
                        view = this.f38113c.getChildAt(i10);
                        break;
                    }
                    i10++;
                } else {
            ...
            if (view != null) {
                this.d.h1(i11, view.getTop() - this.f38113c.getPaddingTop());
            }
        }
    }
    ...
    public final View createView(Context context) {
        ...
        if (i11 == 0 && i12 != 2 && i12 != 0 && i12 != 3) {
            if (i12 == 1 && ChatObject.isChannelAndNotMegaGroup(this.f38144r) && ChatObject.hasAdminRights(this.f38144r)) {
            ...
            if (i12 == 3) {
                this.f38120f.setSearchFieldHint(LocaleController.getString("ChannelSearchException", R.string.ChannelSearchException));
            } else {
                this.f38120f.setSearchFieldHint(LocaleController.getString("Search", R.string.Search));
            }
            if (!ChatObject.isChannel(this.f38144r) && !this.f38144r.creator) {
                this.f38120f.setVisibility(8);
            }
            if (i12 == 3) {
        ...
        frameLayout.setBackgroundColor(getThemedColor(org.telegram.ui.ActionBar.i6.f18778a7));
        ...
        this.f38110b.e.setText(LocaleController.getString(R.string.SearchEmptyViewFilteredSubtitle2));
        this.f38110b.setVisibility(8);
        this.f38110b.setAnimateLayoutChange(true);
        this.f38110b.e(true, false);
        frameLayout2.addView(this.f38110b, w7.x5.c(-1.0f, -1));
        this.f38110b.addView(frameLayout3, 0);
        ai.w0 w0Var = new ai.w0(this, context, 9);
        this.f38113c = w0Var;
        w0Var.p1();
        ai.w0 w0Var2 = this.f38113c;
        ...
        hrVar.C = false;
        hrVar.f42706m = false;
        this.f38113c.setItemAnimator(hrVar);
        ai.w0 w0Var3 = this.f38113c;
        w0Var3.Y1 = true;
        w0Var3.Z1 = 0;
        qr qrVar = new qr(this, context);
        this.f38107a = qrVar;
        w0Var3.setAdapter(qrVar);
        ai.w0 w0Var4 = this.f38113c;
        if (!LocaleController.isRTL) {
            i10 = 2;
        }
        w0Var4.setVerticalScrollbarPosition(i10);
        frameLayout2.addView(this.f38113c, w7.x5.c(-1.0f, -1));
        this.actionBar.setAdaptiveBackground(this.f38113c);
        this.f38113c.setOnItemClickListener(new sq(this, 3));
        this.f38113c.setOnItemLongClickListener(new sq(this, 4));
        if (this.f38120f != null) {
            this.f38113c.setOnScrollListener(new h3(this, 7));
        }
        UndoView undoView = new UndoView(context);
        this.f38135n = undoView;
        frameLayout2.addView(undoView, w7.x5.d(-1, -2.0f, 83, 8.0f, 0.0f, 8.0f, 8.0f));
        B0();
        this.f38113c.setEmptyView(this.f38110b);
        ai.w0 w0Var5 = this.f38113c;
        w0Var5.Y1 = false;
        w0Var5.Z1 = 0;
        if (this.f38137n1) {
            this.f38120f.z(false);
        }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.chatInfoDidLoad) {
            ...
            if (chatFull.f18110id == this.N) {
                if (!booleanValue || !ChatObject.isChannel(this.f38144r)) {
                    if (this.f38147s != null) {
                        z10 = true;
                    } else {
                        z10 = false;
                    }
                    this.f38147s = chatFull;
                    if (!z10) {
                        int k02 = k0();
                        this.f38143q1 = k02;
                        this.f38141p1 = k02;
                        int i12 = this.f38147s.boosts_unrestrict;
                        if (i12 > 0) {
                            z11 = true;
                        } else {
                            z11 = false;
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f38113c, 16, new Class[]{org.telegram.ui.Cells.m4.class, org.telegram.ui.Cells.b5.class, org.telegram.ui.Cells.y4.class, org.telegram.ui.Cells.v8.class, org.telegram.ui.Cells.ea.class, org.telegram.ui.Components.tv0.class}, null, null, null, org.telegram.ui.ActionBar.i6.f18834d6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f38113c, 32768, null, null, null, null, org.telegram.ui.ActionBar.i6.f19110s8));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f38113c, 4096, null, null, null, null, org.telegram.ui.ActionBar.i6.f18923i6));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f38113c, 0, new Class[]{View.class}, org.telegram.ui.ActionBar.i6.f18955k0, null, null, org.telegram.ui.ActionBar.i6.f18835d7));
        int i10 = org.telegram.ui.ActionBar.i6.f18798b7;
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f38113c, 32, new Class[]{org.telegram.ui.Cells.e9.class}, null, null, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f38113c, 0, new Class[]{org.telegram.ui.Cells.e9.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.i6.B6));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f38113c, 32, new Class[]{org.telegram.ui.Cells.a7.class}, null, null, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f38113c, 0, new Class[]{org.telegram.ui.Cells.m4.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.i6.L6));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f38113c, 0, new Class[]{org.telegram.ui.Cells.v3.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.i6.f7));
        int i11 = org.telegram.ui.ActionBar.i6.G6;
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f38113c, 0, new Class[]{org.telegram.ui.Cells.ea.class}, new String[]{"textView"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f38113c, 0, new Class[]{org.telegram.ui.Cells.ea.class}, new String[]{"valueTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.i6.I6));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f38113c, 0, new Class[]{org.telegram.ui.Cells.v8.class}, new String[]{"textView"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f38113c, 0, new Class[]{org.telegram.ui.Cells.v8.class}, new String[]{"valueTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.i6.f19234z6));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f38113c, 0, new Class[]{org.telegram.ui.Cells.v8.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.i6.U6));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f38113c, 0, new Class[]{org.telegram.ui.Cells.v8.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.i6.V6));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f38113c, 0, new Class[]{org.telegram.ui.Cells.b5.class}, new String[]{"nameTextView"}, null, null, -1, null, i11));
        int i12 = org.telegram.ui.ActionBar.i6.f19215y6;
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f38113c, 0, new Class[]{org.telegram.ui.Cells.b5.class}, new String[]{"statusColor"}, null, null, -1, eVar, i12));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f38113c, 0, new Class[]{org.telegram.ui.Cells.b5.class}, new String[]{"statusOnlineColor"}, null, null, -1, eVar, org.telegram.ui.ActionBar.i6.f19018n6));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f38135n, 32, null, null, null, null, org.telegram.ui.ActionBar.i6.Fi));
        int i13 = org.telegram.ui.ActionBar.i6.Gi;
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f38135n, 0, new Class[]{UndoView.class}, new String[]{"undoImageView"}, null, null, -1, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f38135n, 0, new Class[]{UndoView.class}, new String[]{"undoTextView"}, null, null, -1, null, i13));
        int i14 = org.telegram.ui.ActionBar.i6.Hi;
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f38135n, 0, new Class[]{UndoView.class}, new String[]{"infoTextView"}, null, null, -1, null, i14));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f38135n, 0, new Class[]{UndoView.class}, new String[]{"textPaint"}, null, null, -1, null, i14));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f38135n, 0, new Class[]{UndoView.class}, new String[]{"progressPaint"}, null, null, -1, null, i14));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f38135n, 8, new Class[]{UndoView.class}, new String[]{"leftImageView"}, null, null, -1, null, i14));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f38113c, 262144, new Class[]{org.telegram.ui.Cells.y4.class}, new String[]{"textView"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f38113c, 262144, new Class[]{org.telegram.ui.Cells.y4.class}, new String[]{"imageView"}, null, null, -1, null, org.telegram.ui.ActionBar.i6.f18998m6));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f38113c, 262144, new Class[]{org.telegram.ui.Cells.y4.class}, new String[]{"imageView"}, null, null, -1, null, org.telegram.ui.ActionBar.i6.f19145u6));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f38113c, 262144, new Class[]{org.telegram.ui.Cells.y4.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.i6.f19163v6));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f38113c, 0, new Class[]{org.telegram.ui.Components.yw0.class}, new String[]{"title"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f38113c, 0, new Class[]{org.telegram.ui.Components.yw0.class}, new String[]{"subtitle"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f38110b.d, 4, null, null, null, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f38110b.e, 4, null, null, null, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f38113c, 0, new Class[]{org.telegram.ui.Cells.b5.class}, null, org.telegram.ui.ActionBar.i6.f19083r0, null, org.telegram.ui.ActionBar.i6.J7));
    ...
    public final boolean h0(TLObject tLObject, boolean z10, View view) {
        ...
        String str2;
        int i14;
        if (tLObject == null || (i10 = this.f38119e1) != 0) {
            return false;
        }
        if (tLObject instanceof TLRPC.ChannelParticipant) {
            ...
            if (tLObject instanceof TLRPC.ChatParticipant) {
                ...
                str = "";
                z11 = ChatObject.canAddAdmins(this.f38144r);
        ...
        if (i16 == 2) {
            ...
            if (ChatObject.canAddAdmins(this.f38144r) && ((tLObject instanceof TLRPC.TL_channelParticipant) || (tLObject instanceof TLRPC.TL_channelParticipantBanned) || (tLObject instanceof TLRPC.TL_chatParticipant) || z11)) {
                z13 = true;
            } else {
                z13 = false;
            }
            ...
            if (ChatObject.canBlockUsers(this.f38144r) && z15 && !z21 && ChatObject.isChannel(this.f38144r) && !this.f38144r.gigagroup) {
                z17 = true;
            } else {
                z17 = false;
            }
            ...
            if (!z14 && (!ChatObject.canBlockUsers(this.f38144r) || !z15)) {
                z18 = false;
            } else {
                z18 = true;
            }
            if (!z10 && z18) {
                ...
                H.W(this.f38113c.V0(view, false));
                ...
                H.l(i17, LocaleController.getString(i13), new dj(zqVar, 11), z14);
                H.l(R.drawable.msg_permissions, LocaleController.getString("ChangePermissions", R.string.ChangePermissions), new org.telegram.ui.ActionBar.n5((org.telegram.ui.ActionBar.n2) this, tLObject, (TLObject) user, (Object) zqVar, 13), z23);
                if (ChatObject.canBlockUsers(this.f38144r) && z15) {
                    z19 = true;
                } else {
                    z19 = false;
                }
        ...
        if (i16 == 3 && ChatObject.canBlockUsers(this.f38144r)) {
            urVar = this;
            ...
            String str3 = str;
            urVar = this;
            if (i16 == 0 && ChatObject.canBlockUsers(urVar.f38144r)) {
                if (ChatObject.canAddUsers(urVar.f38144r) && i15 > 0 && !ChatObject.isCommunity(urVar.f38144r)) {
            ...
            } else if (i16 == 1 && ChatObject.canAddAdmins(urVar.f38144r) && z11) {
                if (!urVar.f38144r.creator && (tLObject instanceof TLRPC.TL_channelParticipantCreator)) {
                    j10 = j13;
                } else {
                    j10 = j13;
        ...
        H2.W(urVar.f38113c.V0(view, false));
        H2.S = 190;
        if (H2.x() > 0) {
            z12 = true;
        } else {
    ...
    public final int k0() {
        TLRPC.ChatFull chatFull = this.f38147s;
        if (chatFull != null) {
    ...
    public final void onBecomeFullyHidden() {
        UndoView undoView = this.f38135n;
        if (undoView != null) {
            undoView.e(0, true);
        }
    }
    ...
    public final void onInsets(int i10, int i11, int i12, int i13) {
        this.f38113c.setPadding(0, 0, 0, i13);
        this.f38113c.setClipToPadding(false);
        this.f38135n.setTranslationY(-i13);
    }
    ...
    public final void onResume() {
        ...
        qr qrVar = this.f38107a;
        if (qrVar != null) {
            qrVar.l();
        }
        org.telegram.ui.Components.yw0 yw0Var = this.f38110b;
        if (yw0Var != null) {
    ...
    public final void onTransitionAnimationEnd(boolean z10, boolean z11) {
        ...
        if (z10 && !z11 && this.f38137n1) {
            this.f38120f.getSearchField().requestFocus();
            AndroidUtilities.showKeyboard(this.f38120f.getSearchField());
            this.f38120f.setVisibility(8);
        }
    }

    public final boolean p0(int i10) {
        if (i10 != this.V && i10 != this.W && i10 != this.X && i10 != this.Y && i10 != this.Z && i10 != this.f38108a0 && i10 != this.f38131k0 && i10 != this.f38111b0 && i10 != this.f38114c0 && i10 != this.f38116d0) {
            return false;
        }
        return true;
    }
    ...
    public final void r0() {
        ...
        if (!this.Q) {
            ...
            if (z10 && i11 == 2) {
            ...
            } else if (!ChatObject.isChannel(this.f38144r)) {
                this.Q = false;
                arrayList3.clear();
                arrayList.clear();
                arrayList2.clear();
                ...
                iVar.b();
                if (i11 == 1) {
                    TLRPC.ChatFull chatFull2 = this.f38147s;
                    if (chatFull2 != null && (chatParticipants = chatFull2.participants) != null) {
                        int size3 = chatParticipants.participants.size();
                        while (i10 < size3) {
                            TLRPC.ChatParticipant chatParticipant = this.f38147s.participants.participants.get(i10);
                ...
                } else if (i11 == 2 && (chatFull = this.f38147s) != null && chatFull.participants != null) {
                    long j3 = getUserConfig().clientUserId;
                    int size4 = this.f38147s.participants.participants.size();
                    while (i10 < size4) {
                        TLRPC.ChatParticipant chatParticipant2 = this.f38147s.participants.participants.get(i10);
                        int i14 = this.f38119e1;
                ...
                qr qrVar2 = this.f38107a;
                if (qrVar2 != null) {
                    qrVar2.l();
                }
                B0();
                qr qrVar3 = this.f38107a;
                if (qrVar3 != null) {
                    qrVar3.l();
                }
            } else {
    ...
    public final ArrayList s0() {
        ...
        if (i10 == 0) {
            ...
            TLRPC.ChatFull chatFull = this.f38147s;
            if (chatFull != null && chatFull.participants_count <= 200 && (chat = this.f38144r) != null && chat.megagroup) {
                tL_channels_getParticipants.filter = new TLRPC.TL_channelParticipantsRecent();
            } else if (this.f38119e1 == 1) {
                if (!this.J) {
                    this.f38132k1 = 2;
    ...
    public final void v0(long j3) {
        ...
        for (int i10 = 0; i10 < 3; i10++) {
            ...
            if (tLObject != null) {
                ...
                if (this.O == 0 && (chatFull = this.f38147s) != null) {
        ...
        s4.h0 adapter = this.f38113c.getAdapter();
        tr trVar = this.e;
        if (adapter == trVar) {
            gg.c2 c2Var = trVar.h;
            Object f7 = c2Var.f9689f.f(j3);
            if (f7 != null) {
                c2Var.e.remove(f7);
            }
            Object f10 = c2Var.h.f(j3);
            if (f10 != null) {
                c2Var.f9690g.remove(f10);
            }
    ...
    public final or w0() {
        ...
        orVar.f36324b = this.f38117d1;
        orVar.f36328i = this.X0;
        orVar.f36329j = this.Y0;
        orVar.f36331l.clear();
        orVar.f36331l.addAll(this.G);
        orVar.h = this.V0;
        orVar.f36327g = this.U0;
        orVar.f36332m.clear();
        orVar.f36332m.addAll(this.H);
        orVar.e = this.E0;
        orVar.f36326f = this.F0;
        orVar.f36330k.clear();
        orVar.f36330k.addAll(this.F);
        orVar.f(orVar.f36325c);
        return orVar;
    }
    ...
    public final void x0(TLRPC.ChatFull chatFull) {
        ...
        if (chatFull != null) {
            ...
            this.f38143q1 = k02;
            this.f38141p1 = k02;
            int i10 = this.f38147s.boosts_unrestrict;
            boolean z11 = false;
            if (i10 > 0) {
                z10 = true;
            } else {
    ...
    public final void y0(int i10) {
        if (!this.isPaused && this.B1) {
            if (this.f38113c.getAdapter() != this.f38107a || !this.R) {
                org.telegram.ui.Components.t00 t00Var = null;
                for (int i11 = 0; i11 < this.f38113c.getChildCount(); i11++) {
                    View childAt = this.f38113c.getChildAt(i11);
                    if (childAt instanceof org.telegram.ui.Components.t00) {
                        t00Var = childAt;
                    }
                }
                if (t00Var != null) {
                    this.f38113c.removeView(t00Var);
                    i10--;
                }
                this.f38113c.getViewTreeObserver().addOnPreDrawListener(new br(this, t00Var, i10, 0));
            }
        }
    }
