...
public final class pp extends LinearLayout implements NotificationCenter.NotificationCenterDelegate {
    public org.telegram.ui.Components.u9 f36676a;
    public org.telegram.ui.Components.i90 f36677b;
    public int f36678c;

    public final void a() {
        boolean z10;
        org.telegram.ui.Components.u9 u9Var = this.f36676a;
        ...
        if (tL_messages_stickerSet != null && tL_messages_stickerSet.documents.size() >= 3) {
            u9Var.i(ImageLocation.getForDocument(tL_messages_stickerSet.documents.get(2)), "104_104", "tgs", this.f36677b, tL_messages_stickerSet);
            return;
        }
        ...
        u9Var.setImageDrawable(this.f36677b);
    }
    ...
    public final void onAttachedToWindow() {
        ...
        a();
        NotificationCenter.getInstance(this.f36678c).addObserver(this, NotificationCenter.diceStickersDidLoad);
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        NotificationCenter.getInstance(this.f36678c).removeObserver(this, NotificationCenter.diceStickersDidLoad);
    }
}
