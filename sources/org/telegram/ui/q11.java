...
public final class q11 extends org.telegram.ui.Components.sl0 {
    ...
    public final void v(f2.m1 m1Var, int i10) {
        ...
        switch (i14) {
            ...
            case 5:
                ...
                r11Var.h = contains;
                r11Var.f40749f.a(contains, false);
    ...
    public final void w(f2.m1 m1Var, int i10, List list) {
        ...
        if (i13 == 5 && !list.isEmpty()) {
            r11 r11Var = (r11) view;
            if (list.contains(1) && (contains = arrayList.contains(proxyListActivity.F.get(i10 - proxyListActivity.f34745r))) != r11Var.h) {
                r11Var.h = contains;
                r11Var.f40749f.a(contains, true);
            }
            if (list.contains(2)) {
                    ...
                    if (i10 != 3) {
                        if (i10 != 4) {
                            if (i10 != 6) {
                                ...
                                z6Var.setBackgroundColor(org.telegram.ui.ActionBar.k6.w0(null, org.telegram.ui.ActionBar.k6.f21659d6, false));
                            } else {
