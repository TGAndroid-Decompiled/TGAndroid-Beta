...
public final class wi0 extends org.telegram.ui.Components.ml0 {
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        dj0 dj0Var = this.f39052b3;
        if (dj0Var.f33167w && ((view == (t1Var = dj0Var.Q) && t1Var != null && t1Var.getCurrentPosition() == null) || view == dj0Var.X)) {
            return false;
        }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        int max = Math.max(AndroidUtilities.dp(12.0f) + l4, -((AndroidUtilities.dp(7.0f) + dj0Var.f33157o0[0]) - getMeasuredWidth()));
        int i13 = dj0Var.O;
