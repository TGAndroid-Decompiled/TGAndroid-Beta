...
public final class wi0 extends org.telegram.ui.Components.ml0 {
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        dj0 dj0Var = this.f39047b3;
        if (dj0Var.f33163w && ((view == (t1Var = dj0Var.Q) && t1Var != null && t1Var.getCurrentPosition() == null) || view == dj0Var.X)) {
            return false;
        }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        for (int i14 = 0; i14 < getChildCount(); i14++) {
            ...
            if (childAt.getTop() != 0 && (childAt instanceof cj0)) {
                ...
                cj0Var.Fe = childAt.getTop();
                cj0Var.Ge = childAt.getBottom();
                cj0Var.He = cj0Var.getMessageObject().getId();
            }
        }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        super.onMeasure(i10, View.MeasureSpec.makeMeasureSpec(Math.max(0, ((AndroidUtilities.displaySize.y - (dp + measuredHeight)) - AndroidUtilities.dp(8.0f)) - dj0Var.e.f10592b), Integer.MIN_VALUE));
        if (dj0Var.m0) {
            l4 = dj0Var.Y;
        } else {
            l4 = dj0Var.W.l();
        }
        int max = Math.max(AndroidUtilities.dp(12.0f) + l4, -((AndroidUtilities.dp(7.0f) + dj0Var.f33153o0[0]) - getMeasuredWidth()));
        int i13 = dj0Var.O;
