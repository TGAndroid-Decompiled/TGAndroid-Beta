...
public final class ut0 extends AnimatorListenerAdapter {
    ...
    public final PhotoViewer f41245b;

    public ut0(PhotoViewer photoViewer, int i10) {
        this.f41245b = photoViewer;
        this.f41244a = i10;
    }
    ...
    public final void onAnimationEnd(Animator animator) {
        ...
        int i11;
        boolean z11;
        PhotoViewer photoViewer = this.f41245b;
        int i12 = photoViewer.f33720u4;
        int i13 = 8;
        if (i12 == 1) {
            photoViewer.C1.a();
            mg.q qVar = photoViewer.C1.f30896b;
            qVar.d = null;
            qVar.J = false;
            ...
            cropAreaView.f23987o0 = 1.0f;
            cropAreaView.f23988p0 = 0.0f;
            cropAreaView.f23989q0 = 0.0f;
            cropAreaView.invalidate();
        } else if (i12 == 2) {
            try {
                photoViewer.f33576e0.removeView(photoViewer.I1);
            } catch (Exception e7) {
                FileLog.e(e7);
            }
            photoViewer.I1 = null;
            ...
            try {
                photoViewer.f33576e0.removeView(photoViewer.L1.getView());
            } catch (Exception e10) {
                FileLog.e(e10);
            }
            photoViewer.L1 = null;
            ...
            photoViewer.f33576e0.post(new ej0(23, this, photoViewer.N1));
            photoViewer.N1 = null;
            photoViewer.f33730v5.m(false, true);
            photoViewer.f33740w5.m(false, true);
        } else if (i12 == 5) {
            photoViewer.f33684q5.setVisibility(8);
            org.telegram.ui.Components.kf0 kf0Var = photoViewer.f33684q5;
            kf0Var.d = null;
            kf0Var.f27841a.o(false, null, 0L, 0.0f);
        }
        photoViewer.f33676p6 = null;
        int i14 = photoViewer.f33720u4;
        photoViewer.f33720u4 = this.f41244a;
        ...
        if (photoViewer.f33559c2 == 11 && (i14 == 3 || i14 == 2 || i14 == 1 || i14 == 4)) {
            photoViewer.f33563c6 = photoViewer.f33608h6;
            photoViewer.f33572d6 = photoViewer.f33617i6;
            photoViewer.f33582e6 = photoViewer.f33625j6;
            photoViewer.f33591f6 = photoViewer.f33634k6;
        } else {
        ...
        photoViewer.f33576e0.invalidate();
        fv0 fv0Var = photoViewer.f33618i7;
        if (fv0Var != null) {
            PhotoViewer photoViewer2 = fv0Var.d;
            photoViewer2.d = fv0Var.f36505c;
            WindowManager.LayoutParams layoutParams = photoViewer2.f33566d0;
            layoutParams.flags = -2147286784;
            layoutParams.softInputMode = 272;
            photoViewer2.f33593g0.setFocusable(false);
            photoViewer2.f33576e0.setFocusable(false);
            photoViewer2.L0.setAlpha(255);
            photoViewer2.f33576e0.setAlpha(1.0f);
            ArrayList arrayList = fv0Var.f36504b;
            int i15 = fv0Var.f36503a;
            photoViewer2.Y1(null, null, null, null, arrayList, null, null, i15, fv0Var.f36505c.E((MessageObject) arrayList.get(i15), null, fv0Var.f36503a, true, false));
            photoViewer.f33618i7 = null;
            ku0 ku0Var = new ku0();
        ...
        bi.a4 a4Var = photoViewer.f33703s5;
        if (a4Var != null) {
        ...
        if (photoViewer.f33577e1.getTag() != null) {
            org.telegram.ui.ActionBar.k0 k0Var = photoViewer.f33577e1;
            if (photoViewer.f33568d2) {
                i11 = 8;
            } else {
                i11 = 0;
            }
            k0Var.setVisibility(i11);
            arrayList2.add(ObjectAnimator.ofFloat(photoViewer.f33577e1, property2, 1.0f));
        }
        if (photoViewer.f33586f1.getTag() != null) {
            org.telegram.ui.Components.f90 f90Var = photoViewer.f33586f1;
            if (!photoViewer.f33568d2 && photoViewer.J4 && ((av0Var = photoViewer.d) == null || av0Var.N())) {
                i10 = 0;
            } else {
                i10 = 8;
            }
            f90Var.setVisibility(i10);
            arrayList2.add(ObjectAnimator.ofFloat(photoViewer.f33586f1, property2, 1.0f));
        }
        if (photoViewer.f33594g1.getTag() != null) {
            ys0 ys0Var = photoViewer.f33594g1;
            if (!photoViewer.f33568d2) {
                i13 = 0;
            }
            ys0Var.setVisibility(i13);
            arrayList2.add(ObjectAnimator.ofFloat(photoViewer.f33594g1, property2, 1.0f));
        }
        View view = photoViewer.f33620j0;
        if (view != null) {
            view.setVisibility(0);
            arrayList2.add(ObjectAnimator.ofFloat(photoViewer.f33620j0, property2, 1.0f));
        }
