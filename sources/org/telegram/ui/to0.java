...
public final class to0 extends FrameLayout {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        int themedColor = xo0Var.getThemedColor(org.telegram.ui.ActionBar.j6.f20720ei);
        Paint paint = this.f40832a;
        ...
        canvas.drawCircle(dp, -AndroidUtilities.dp(28.0f), Math.max(getWidth(), getHeight()) * this.f40833b, paint);
    }
}
