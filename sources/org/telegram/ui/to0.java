...
public final class to0 extends FrameLayout {
    public final Paint f40805a;
    public float f40806b;
    public o1.k f40807c;
    public final xo0 d;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        int themedColor = xo0Var.getThemedColor(org.telegram.ui.ActionBar.j6.f20693ei);
        Paint paint = this.f40805a;
        ...
        canvas.drawCircle(dp, -AndroidUtilities.dp(28.0f), Math.max(getWidth(), getHeight()) * this.f40806b, paint);
    }
}
