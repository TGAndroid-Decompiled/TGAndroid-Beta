...
public final class vw implements org.telegram.ui.Components.e00 {
    ...
    public final int a(int i10) {
        wy wyVar = this.f38511b;
        if (wyVar.R0 != 3) {
            if (i10 == wyVar.f39320z0.getDefaultTabId()) {
    ...
    public final void b(float f7) {
        ...
        if (i10 != 0 || wyVar.f39215e0[1].getVisibility() == 0 || wyVar.f39243j2) {
            if (wyVar.f39234h3) {
                vy vyVar = wyVar.f39215e0[0];
                vyVar.setTranslationX((-f7) * vyVar.getMeasuredWidth());
                vy[] vyVarArr = wyVar.f39215e0;
                vyVarArr[1].setTranslationX(vyVarArr[0].getMeasuredWidth() - (f7 * wyVar.f39215e0[0].getMeasuredWidth()));
            } else {
                vy vyVar2 = wyVar.f39215e0[0];
                vyVar2.setTranslationX(vyVar2.getMeasuredWidth() * f7);
                vy[] vyVarArr2 = wyVar.f39215e0;
                vyVarArr2[1].setTranslationX((f7 * vyVarArr2[0].getMeasuredWidth()) - wyVar.f39215e0[0].getMeasuredWidth());
            }
            if (i10 == 0) {
                vy[] vyVarArr3 = wyVar.f39215e0;
                ...
                wy.f1(wyVar, true);
                wyVar.T4(false);
                wyVar.f39320z0.O = false;
                wyVar.r3(wyVar.f39215e0[0]);
                wyVar.f39215e0[0].d.getClass();
                wyVar.f39215e0[1].d.getClass();
            }
        }
    }
    ...
    public final void c(org.telegram.ui.Components.g00 g00Var, boolean z10) {
        ...
        int i11;
        wy wyVar = this.f38511b;
        int i12 = wyVar.f39215e0[0].h;
        int i13 = g00Var.f24051a;
        if (i12 != i13) {
            if (g00Var.f24054f) {
                wyVar.f39320z0.i(i13);
                i11 = ((org.telegram.ui.ActionBar.o2) wyVar).currentAccount;
                wyVar.showDialog(new rg.j0(3, i11, this.f38510a, wyVar, null));
                return;
            }
            ArrayList<MessagesController.DialogFilter> dialogFilters = wyVar.getMessagesController().getDialogFilters();
            if (!g00Var.e && ((i10 = g00Var.f24051a) < 0 || i10 >= dialogFilters.size())) {
                return;
            }
            vy vyVar = wyVar.f39215e0[1];
            vyVar.h = g00Var.f24051a;
