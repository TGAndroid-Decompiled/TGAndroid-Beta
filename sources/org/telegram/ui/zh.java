...
public final class zh extends AnimatorListenerAdapter {
    public final wn f43936a;
    public final boolean f43937b;
    public final org.telegram.ui.ActionBar.l5 f43938c;
    public final boolean d;
    public final hg.q f43939e;
    ...
    public final void onAnimationEnd(Animator animator) {
        ...
        wn wnVar = this.f43936a;
        wnVar.setTranslationY(0.0f);
        boolean z4 = this.f43937b;
        if (!z4) {
            wnVar.setTranslationY(0.0f);
        }
        org.telegram.ui.ActionBar.l5 l5Var = this.f43938c;
        if (!z4) {
            l5Var.setTranslationY(0.0f);
        }
        boolean z10 = this.d;
        hg.q qVar = this.f43939e;
        if (!z10) {
            qVar.setTranslationY(0.0f);
        }
        xnVar.f43432z2[0].setTranslationX(0.0f);
        xnVar.f43432z2[1].setTranslationX(0.0f);
        xnVar.f43419y2[1].setAlpha(1.0f);
        xnVar.f43419y2[1].setScaleX(1.0f);
        xnVar.f43419y2[1].setScaleY(1.0f);
        xnVar.f43419y2[0].setAlpha(1.0f);
        xnVar.f43419y2[0].setScaleX(1.0f);
        xnVar.f43419y2[0].setScaleY(1.0f);
        ...
        if (this.f43940f) {
            xnVar.f43419y2[1].setImageBitmap(null);
            xnVar.f43419y2[1].setVisibility(4);
        }
        org.telegram.ui.Components.p9[] p9VarArr = xnVar.f43419y2;
