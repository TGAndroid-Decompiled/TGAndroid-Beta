...
public final class jq0 extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public iq0 V;
    public CharSequence f34951a;
    public final HashMap f34952b;
    public final ArrayList f34953c;
    public ArrayList d;
    public boolean e;
    public int f34954f;
    public org.telegram.ui.Components.ll0 h;
    public hq0 f34955n;
    public FrameLayout f34956r;
    public TextView f34957s;
    public boolean v;
    public final int f34958w;
    ...
    public static void U(jq0 jq0Var, MediaController.AlbumEntry albumEntry) {
        if (albumEntry != null) {
            ar0 ar0Var = new ar0(0, albumEntry, jq0Var.f34952b, jq0Var.f34953c, jq0Var.f34958w, jq0Var.E, jq0Var.F, false);
            ...
            ar0Var.f31932s0 = new fq0(jq0Var);
        ...
        if (jq0Var.f34960y) {
            gr0 gr0Var = new gr0(hashMap, arrayList, jq0Var.f34958w, jq0Var.E, jq0Var.F);
            Editable text2 = jq0Var.M.getText();
            jq0Var.f34951a = text2;
            ar0 ar0Var2 = gr0Var.f33990a;
            if (ar0Var2 != null) {
                ar0Var2.d = text2;
                org.telegram.ui.Components.ju juVar2 = ar0Var2.f31914d0;
                if (juVar2 != null) {
                    juVar2.setText(text2);
                }
            }
            gq0 gq0Var = new gq0(jq0Var, hashMap, arrayList);
            ar0 ar0Var3 = gr0Var.f33990a;
            ar0Var3.f31932s0 = gq0Var;
            ar0 ar0Var4 = gr0Var.f33991b;
            ar0Var4.f31932s0 = gq0Var;
            ar0Var3.f31933t0 = new fr0(gr0Var, 0);
            ar0Var4.f31933t0 = new fr0(gr0Var, 1);
            int i10 = jq0Var.G;
            boolean z10 = jq0Var.H;
            ar0Var3.f0(i10, z10);
            gr0Var.f33991b.f0(i10, z10);
            jq0Var.presentFragment(gr0Var);
            return;
        }
        ar0 ar0Var5 = new ar0(0, albumEntry, hashMap, arrayList, jq0Var.f34958w, jq0Var.E, jq0Var.F, false);
        Editable text3 = jq0Var.M.getText();
        jq0Var.f34951a = text3;
        ar0Var5.d = text3;
        org.telegram.ui.Components.ju juVar3 = ar0Var5.f31914d0;
        if (juVar3 != null) {
            juVar3.setText(text3);
        }
        ar0Var5.f31932s0 = new cq0(jq0Var, hashMap, arrayList);
    ...
    public final View createView(Context context) {
        ...
        this.f34957s = textView;
        textView.setTextColor(-8355712);
        this.f34957s.setTextSize(1, 20.0f);
        this.f34957s.setGravity(17);
        this.f34957s.setVisibility(8);
        this.f34957s.setText(LocaleController.getString(R.string.NoPhotos));
        this.P.addView(this.f34957s, w7.x5.d(-1, -1.0f, 51, 0.0f, 0.0f, 0.0f, 48.0f));
        this.f34957s.setOnTouchListener(new bi.d(2));
        FrameLayout frameLayout = new FrameLayout(context);
        this.f34956r = frameLayout;
        frameLayout.setVisibility(8);
        this.P.addView(this.f34956r, w7.x5.d(-1, -1.0f, 51, 0.0f, 0.0f, 0.0f, 48.0f));
        RadialProgressView radialProgressView = new RadialProgressView(context, null);
        radialProgressView.setProgressColor(-11371101);
        this.f34956r.addView(radialProgressView, w7.x5.e(-2, -2, 17));
        ...
        CharSequence charSequence = this.f34951a;
        if (charSequence != null) {
        ...
        if (this.e && ((arrayList = this.d) == null || arrayList.isEmpty())) {
            ...
            this.h.setEmptyView(this.f34957s);
        }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.albumsDidLoad) {
            if (this.classGuid == ((Integer) objArr[0]).intValue()) {
                int i12 = this.f34958w;
                if (i12 != 1 && i12 != 2 && i12 != 10 && this.f34959x) {
                    this.d = (ArrayList) objArr[1];
                } else {
                    this.d = (ArrayList) objArr[2];
                }
                FrameLayout frameLayout = this.f34956r;
                if (frameLayout != null) {
                    frameLayout.setVisibility(8);
                }
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.h, 0, new Class[]{View.class}, null, new Drawable[]{org.telegram.ui.ActionBar.i6.R4}, null, org.telegram.ui.ActionBar.i6.f18840da));
    ...
    public final boolean onFragmentCreate() {
        ...
        boolean z10 = true;
        if (i10 != 1 && i10 != 2 && i10 != 10 && this.f34959x) {
