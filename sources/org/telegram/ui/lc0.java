...
public final class lc0 extends FrameLayout {
    public final org.telegram.ui.Components.z9 f38318a;
    public final SpannableStringBuilder f38319b;
    public final org.telegram.ui.Cells.w1 f38320c;
    public final TextView d;
    public final org.telegram.ui.Cells.w1 f38321e;
    public final TextView f38322f;
    public final org.telegram.ui.Components.fo0 h;
    public final jc0 f38323n;
    public boolean f38324r;
    public float f38325s;
    public ValueAnimator v;
    public float f38326w;
    public ValueAnimator f38327x;
    public final nc0 f38328y;
    ...
    public lc0(nc0 nc0Var, Context context) {
        ...
        w1Var2.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20874n6, false));
        frameLayout.addView(w1Var2, w7.x5.e(-2, -2, 17));
        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder("b");
        this.f38319b = spannableStringBuilder;
        org.telegram.ui.Components.z9 z9Var = new org.telegram.ui.Components.z9();
        this.f38318a = z9Var;
        z9Var.f33129a = w1Var2.getPaint();
        z9Var.f33133f = AndroidUtilities.dp(1.5f);
    ...
    public final void a() {
        ...
        org.telegram.ui.Cells.w1 w1Var = this.f38321e;
        w1Var.a();
        if (powerSaverLevel <= 0) {
            ...
            this.f38318a.a(f11 / 100.0f, true);
            w1Var.c(AndroidUtilities.replaceCharSequence("%s", LocaleController.getString(R.string.LiteBatteryWhenBelow), TextUtils.concat(String.format("%d%% ", Integer.valueOf(Math.round(f11))), this.f38319b)), !LocaleController.isRTL, true);
        }
        ...
        org.telegram.ui.Cells.w1 w1Var2 = this.f38320c;
        ...
        if (this.f38325s != f7) {
            ...
            ValueAnimator ofFloat = ValueAnimator.ofFloat(this.f38325s, f7);
            this.v = ofFloat;
            ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) {
                public final lc0 f37324b;
                ...
                public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                    switch (r2) {
                        case 0:
                            ...
                            lc0Var.f38325s = floatValue;
                            textView.setTextColor(i0.a.d(floatValue, w02, w03));
                            return;
                        default:
                            lc0 lc0Var2 = this.f37324b;
        ...
        if (this.f38326w != f12) {
            this.f38326w = f12;
            ValueAnimator valueAnimator2 = this.f38327x;
            if (valueAnimator2 != null) {
                valueAnimator2.cancel();
                this.f38327x = null;
            }
            ValueAnimator ofFloat2 = ValueAnimator.ofFloat(this.f38326w, f12);
            this.f38327x = ofFloat2;
            ...
            this.f38327x.addListener(new kc0(this, f12, 1));
            this.f38327x.setInterpolator(org.telegram.ui.Components.pr.h);
            this.f38327x.setDuration(320L);
            this.f38327x.start();
        }
    }
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        this.f38323n.onInitializeAccessibilityNodeInfo(this, accessibilityNodeInfo);
    }
    ...
    public final void onPopulateAccessibilityEvent(AccessibilityEvent accessibilityEvent) {
        ...
        this.f38323n.onPopulateAccessibilityEvent(this, accessibilityEvent);
    }

    @Override
    public final boolean performAccessibilityAction(int i10, Bundle bundle) {
        return this.f38323n.performAccessibilityAction(this, i10, bundle);
    }
}
