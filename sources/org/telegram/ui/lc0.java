...
public final class lc0 extends FrameLayout {
    public final org.telegram.ui.Components.w9 f35423a;
    public final SpannableStringBuilder f35424b;
    public final org.telegram.ui.Cells.w1 f35425c;
    public final TextView d;
    public final org.telegram.ui.Cells.w1 e;
    public final TextView f35426f;
    public final org.telegram.ui.Components.fo0 h;
    public final jc0 f35427n;
    public boolean f35428r;
    public float f35429s;
    public ValueAnimator v;
    public float f35430w;
    public ValueAnimator f35431x;
    public final nc0 f35432y;
    ...
    public lc0(nc0 nc0Var, Context context) {
        ...
        w1Var2.setTextColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f19021n6, false));
        frameLayout.addView(w1Var2, w7.x5.e(-2, -2, 17));
        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder("b");
        this.f35424b = spannableStringBuilder;
        org.telegram.ui.Components.w9 w9Var = new org.telegram.ui.Components.w9();
        this.f35423a = w9Var;
        w9Var.f29671a = w1Var2.getPaint();
        w9Var.f29674f = AndroidUtilities.dp(1.5f);
    ...
    public final void a() {
        ...
        if (powerSaverLevel <= 0) {
            ...
            this.f35423a.a(f11 / 100.0f, true);
            w1Var.c(AndroidUtilities.replaceCharSequence("%s", LocaleController.getString(R.string.LiteBatteryWhenBelow), TextUtils.concat(String.format("%d%% ", Integer.valueOf(Math.round(f11))), this.f35424b)), !LocaleController.isRTL, true);
        }
        ...
        org.telegram.ui.Cells.w1 w1Var2 = this.f35425c;
        ...
        if (this.f35429s != f7) {
            ...
            ValueAnimator ofFloat = ValueAnimator.ofFloat(this.f35429s, f7);
            this.v = ofFloat;
            ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) {
                public final lc0 f34607b;
                ...
                public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                    switch (r2) {
                        case 0:
                            ...
                            lc0Var.f35429s = floatValue;
                            textView.setTextColor(i0.a.d(floatValue, w02, w03));
                            return;
                        default:
                            lc0 lc0Var2 = this.f34607b;
        ...
        if (this.f35430w != f12) {
            this.f35430w = f12;
            ValueAnimator valueAnimator2 = this.f35431x;
            if (valueAnimator2 != null) {
                valueAnimator2.cancel();
                this.f35431x = null;
            }
            ValueAnimator ofFloat2 = ValueAnimator.ofFloat(this.f35430w, f12);
            this.f35431x = ofFloat2;
            ...
            this.f35431x.addListener(new kc0(this, f12, 1));
            this.f35431x.setInterpolator(org.telegram.ui.Components.qr.h);
            this.f35431x.setDuration(320L);
            this.f35431x.start();
        }
    }
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        this.f35427n.onInitializeAccessibilityNodeInfo(this, accessibilityNodeInfo);
    }
    ...
    public final void onPopulateAccessibilityEvent(AccessibilityEvent accessibilityEvent) {
        ...
        this.f35427n.onPopulateAccessibilityEvent(this, accessibilityEvent);
    }

    @Override
    public final boolean performAccessibilityAction(int i10, Bundle bundle) {
        return this.f35427n.performAccessibilityAction(this, i10, bundle);
    }
}
