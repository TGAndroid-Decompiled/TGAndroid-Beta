...
public final class h70 extends org.telegram.ui.Components.vl0 {
    ...
    public final boolean D(s4.c1 c1Var) {
        int b10 = c1Var.b();
        i70 i70Var = this.d;
        if (b10 != i70Var.f34428r && b10 != i70Var.f34427n && b10 != i70Var.f34429s && b10 != 0) {
            return false;
        }
        return true;
    }
    ...
    public final int h() {
        ...
        return i70Var.f34430w;
    }

    @Override
    public final int j(int i10) {
        i70 i70Var = this.d;
        if (i10 != i70Var.f34427n && i10 != i70Var.f34429s && i10 != i70Var.f34428r) {
        ...
        if (i11 != 0) {
            if (i11 != 1) {
                if (i11 == 2) {
                    ...
                    TLRPC.TL_chatInviteExported tL_chatInviteExported = i70Var.f34426f;
                    if (tL_chatInviteExported != null) {
                        str = tL_chatInviteExported.link;
                    } else {
                        str = "error";
                    }
                    p8Var.f20819a.setText(str);
            ...
            if (i10 == i12) {
                ...
                e9Var.setBackgroundDrawable(org.telegram.ui.ActionBar.h6.V0(context, R.drawable.greydivider, org.telegram.ui.ActionBar.h6.f19024b7));
                return;
            } else {
                return;
            }
