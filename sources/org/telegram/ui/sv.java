    ...
    public final void onClick(View view) {
        ...
        switch (this.f41377a) {
            ...
            case 4:
                ...
                return;
            case 5:
                py pyVar6 = this.f41378b;
                ArrayList arrayList4 = pyVar6.F2;
                if (pyVar6.f40308z2 != null && !arrayList4.isEmpty()) {
                    ArrayList arrayList5 = new ArrayList();
                    for (int i11 = 0; i11 < arrayList4.size(); i11++) {
                        arrayList5.add(MessagesStorage.TopicKey.of(((Long) arrayList4.get(i11)).longValue(), 0L));
                    }
                    pyVar6.f40308z2.v(pyVar6, arrayList5, pyVar6.f40303y1.getFieldText(), false, pyVar6.G2, pyVar6.H2, pyVar6.I2, null);
                    return;
                }
                return;
            case 6:
                this.f41378b.b4(true);
                return;
            case 7:
                this.f41378b.finishPreviewFragment();
                return;
            case 8:
                py pyVar7 = this.f41378b;
                pyVar7.f40292w0.setIsEditing(false);
                pyVar7.I4(false);
                return;
            case 9:
                py pyVar8 = this.f41378b;
                pyVar8.getClass();
                pyVar8.showDialog(new fg.n1((org.telegram.ui.ActionBar.p2) pyVar8, 2, true));
                return;
            case 10:
                py pyVar9 = this.f41378b;
                pyVar9.getContactsController().loadGlobalPrivacySetting();
                pyVar9.K4();
                return;
            case 11:
                this.f41378b.p4(view);
                return;
            case 12:
                py.s0(this.f41378b);
                return;
            ...
            case 14:
                ...
                return;
            case 15:
                py pyVar10 = this.f41378b;
                pyVar10.showDialog(org.telegram.ui.Components.z4.m(pyVar10.getParentActivity(), LocaleController.getString(R.string.EditProfileBirthdayTitle), LocaleController.getString(R.string.EditProfileBirthdayButton), null, new vv(pyVar10, 1), new nv(pyVar10, 17), false, false, pyVar10.getResourceProvider()).f21207a);
                return;
            case 16:
                py.C0(this.f41378b);
                return;
