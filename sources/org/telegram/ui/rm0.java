...
public final class rm0 implements en0 {
    public final TLRPC.SecureValueType f37168a;
    ...
    public static void a(rm0 rm0Var, SecureDocument secureDocument, TLRPC.TL_secureFile tL_secureFile) {
        ...
        ImageLoader.getInstance().replaceImageInCache(secureDocument.secureFile.dc_id + "_" + secureDocument.secureFile.f18244id, tL_secureFile.dc_id + "_" + tL_secureFile.f18244id, null, false);
    }
    ...
    public static TLRPC.InputSecureFile b(SecureDocument secureDocument) {
        if (secureDocument.inputFile != null) {
            ...
            tL_inputSecureFileUploaded.f18177id = tL_inputFile.f18123id;
        ...
        tL_inputSecureFile.f18176id = tL_secureFile.f18244id;
    ...
    public final void c(TLRPC.TL_secureRequiredType tL_secureRequiredType, String str, String str2, TLRPC.TL_secureRequiredType tL_secureRequiredType2, String str3, ArrayList arrayList, SecureDocument secureDocument, ArrayList arrayList2, SecureDocument secureDocument2, SecureDocument secureDocument3, Runnable runnable, o0.a aVar) {
        ...
        if (!isEmpty) {
            ...
            tL_secureData.data = (byte[]) k12.f4259c;
            tL_secureData.data_hash = (byte[]) k12.d;
            tL_secureData.secret = (byte[]) k12.f4257a;
        } else if (!TextUtils.isEmpty(str)) {
            TLRPC.SecureValueType secureValueType = this.f37168a;
        ...
        if (tL_secureRequiredType2 != null) {
            ...
            if (!TextUtils.isEmpty(str3)) {
                ...
                tL_secureData2.data = (byte[]) k13.f4259c;
                tL_secureData2.data_hash = (byte[]) k13.d;
                tL_secureData2.secret = (byte[]) k13.f4257a;
            }
        ...
        savesecurevalue2.secure_secret_id = on0Var.f36261b1;
        i10 = ((org.telegram.ui.ActionBar.n2) on0Var).currentAccount;
