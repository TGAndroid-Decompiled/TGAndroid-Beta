...
public final class b91 extends LinearLayout {
    public final org.telegram.ui.ActionBar.e1[] f32359a;
    ...
    public b91(ContextThemeWrapper contextThemeWrapper, final ir0 ir0Var) {
        ...
        c10.setOnClickListener(new View.OnClickListener() {
            ...
            public final void onClick(View view) {
                ...
                switch (i10) {
                    case 0:
                        PhotoViewer photoViewer = ir0Var2.f34574a;
                        Drawable[] drawableArr = PhotoViewer.U8;
                        photoViewer.D0(true, true, 0.2f);
                        return;
                    case 1:
                        PhotoViewer photoViewer2 = ir0Var2.f34574a;
                        Drawable[] drawableArr2 = PhotoViewer.U8;
                        photoViewer2.D0(true, true, 0.5f);
                        return;
                    case 2:
                        PhotoViewer photoViewer3 = ir0Var2.f34574a;
                        Drawable[] drawableArr3 = PhotoViewer.U8;
                        photoViewer3.D0(true, true, 1.0f);
                        return;
                    case 3:
                        PhotoViewer photoViewer4 = ir0Var2.f34574a;
                        Drawable[] drawableArr4 = PhotoViewer.U8;
                        photoViewer4.D0(true, true, 1.5f);
                        return;
                    default:
                        PhotoViewer photoViewer5 = ir0Var2.f34574a;
