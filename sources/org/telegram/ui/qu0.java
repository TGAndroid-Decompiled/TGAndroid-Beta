...
public final class qu0 extends vh.o {
    ...
    public boolean W;
    public org.telegram.ui.Components.g90 f36940a0;
    public Layout f36941b0;
    public Path f36942c0;
    ...
    public qu0(Context context, ou0 ou0Var, org.telegram.ui.Cells.aa aaVar, final Utilities.Callback2 callback2, final Utilities.Callback3 callback3) {
        ...
        this.f44459x = new org.telegram.ui.Components.b90(this) {
        ...
        this.f44460y = new org.telegram.ui.Components.b90(this) {
            public final qu0 f36682b;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.W) {
            ...
            Path path = this.f36942c0;
            if (path == null || this.f36941b0 != layout) {
                if (path == null) {
                    this.f36942c0 = new Path();
                } else {
                    path.rewind();
                }
                if (layout != null) {
                    ...
                    while (i11 < layout.getLineCount()) {
                        ...
                        this.f36942c0.addRect(getPaddingLeft() + lineLeft, getPaddingTop() + f10, getPaddingLeft() + lineRight, getPaddingTop() + f7, Path.Direction.CW);
                        i11++;
                        f10 = f7;
                    }
                }
                this.f36941b0 = layout;
            }
            if (this.f36940a0 == null) {
                org.telegram.ui.Components.g90 g90Var = new org.telegram.ui.Components.g90();
                this.f36940a0 = g90Var;
                g90Var.f24280x = this.f36942c0;
                g90Var.j(4.0f);
                this.f36940a0.f(org.telegram.ui.ActionBar.i6.l1(0.3f, -1), org.telegram.ui.ActionBar.i6.l1(0.1f, -1), org.telegram.ui.ActionBar.i6.l1(0.2f, -1), org.telegram.ui.ActionBar.i6.l1(0.7f, -1));
                this.f36940a0.setCallback(this);
            }
            this.f36940a0.setBounds(0, 0, getWidth(), getHeight());
            this.f36940a0.draw(canvas);
        }
        if (this.W) {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (aaVar != null && aaVar.y()) {
            canvas.save();
            canvas.translate(getPaddingLeft(), getPaddingTop());
            if (aaVar != null && getStaticTextLayout() != null && aaVar.f19804u0 == this) {
                aaVar.X(canvas);
            }
            canvas.restore();
        }
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        if (drawable != this.f36940a0 && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
