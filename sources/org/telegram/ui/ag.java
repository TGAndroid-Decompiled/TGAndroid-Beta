...
public final class ag implements org.telegram.ui.Components.oj0, org.telegram.ui.ActionBar.a2 {
    ...
    public final co f34423b;
    public final MessageObject f34424c;

    public ag(co coVar, MessageObject messageObject, int i10) {
        this.f34422a = i10;
        this.f34423b = coVar;
        this.f34424c = messageObject;
    }
    ...
    public void a(long j3, TLRPC.MessagePeerReaction messagePeerReaction) {
        switch (this.f34422a) {
            case 0:
                ...
                co coVar = this.f34423b;
                if (messagePeerReaction != null && messagePeerReaction.reaction != null) {
                    bundle.putInt("report_reaction_message_id", this.f34424c.getId());
            ...
            default:
                ...
                if (messagePeerReaction != null && messagePeerReaction.reaction != null) {
                    bundle2.putInt("report_reaction_message_id", this.f34424c.getId());
    ...
    public void g(org.telegram.ui.ActionBar.b2 b2Var, int i10) {
        co coVar = this.f34423b;
        org.telegram.ui.ActionBar.b2[] b2VarArr = {new org.telegram.ui.ActionBar.b2(coVar.getParentActivity(), 3, coVar.f35248ea)};
        TLRPC.TL_messages_editMessage tL_messages_editMessage = new TLRPC.TL_messages_editMessage();
        MessageObject messageObject = this.f34424c;
