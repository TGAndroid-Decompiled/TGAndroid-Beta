...
public final class m9 extends org.telegram.ui.ActionBar.o2 implements NotificationCenter.NotificationCenterDelegate, fh0 {
    ...
    public final fh.d f35708a0;
    public j9 f35709b;
    public final ah.c f35710b0;
    public s4.c0 f35711c;
    public ah.o f35712c0;
    public org.telegram.ui.Components.f61 d;
    public final ArrayList f35713d0;
    public org.telegram.ui.Components.pk0 e;
    public final RectF f35714e0;
    public org.telegram.ui.Components.y10 f35715f;
    public final RectF f35716f0;
    public org.telegram.ui.Components.t00 h;
    public y8 f35717n;
    public ci.s6 f35718r;
    public ci.f4 f35719s;
    public boolean v;
    public boolean f35720w;
    public ImageView f35721x;
    public NumberTextView f35722y;
    ...
    public static void U(m9 m9Var) {
        ...
        ImageView imageView = m9Var.f35721x;
        if (imageView != null) {
            imageView.setColorFilter(new PorterDuffColorFilter(m9Var.getThemedColor(org.telegram.ui.ActionBar.j6.f19246y8), PorterDuff.Mode.MULTIPLY));
            m9Var.f35721x.setBackground(org.telegram.ui.ActionBar.j6.f0(m9Var.getThemedColor(org.telegram.ui.ActionBar.j6.f19265z8), 1, -1));
        }
    ...
    public static void X(m9 m9Var, org.telegram.ui.Components.j51 j51Var, View view) {
        ...
        if (i10 == 2) {
            ...
            if (obj instanceof i9) {
                ...
                } else if (i9Var.f34510a != 0 && !arrayList.isEmpty()) {
                    boolean z10 = i9Var.e;
                ...
                bundle2.putLong("chat_id", ((l9) view).f35483c.f18121id);
                m9Var.getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.closeChats, new Object[0]);
    ...
    public static void o0(final Context context, int i10, TLRPC.InputGroupCall inputGroupCall, String str, final org.telegram.ui.ActionBar.f6 f6Var, boolean z10, final boolean z11) {
        String str2;
        int i11;
        int v02 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f18933h5, f6Var);
        ...
        int v03 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19244y6, f6Var);
        ...
        int i14 = org.telegram.ui.ActionBar.j6.f18806a7;
        ...
        imageView3.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19117r5, f6Var), mode));
        ...
        if (z10) {
            ...
            c9Var.setGravity(17);
            c9Var.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19263z6, f6Var));
    ...
    public final View createView(Context context) {
        ...
        this.d.q1();
        this.d.Y2.f29851r = false;
        this.f35717n = new y8(this, context, 0);
        hh.k kVar = new hh.k(this.f35717n);
        y8 y8Var = this.f35717n;
        ah.c cVar = this.f35710b0;
        cVar.f425f = kVar;
        cVar.f426g = y8Var;
        org.telegram.ui.Components.f61 f61Var2 = this.d;
        Objects.requireNonNull(f61Var2);
        this.f35712c0 = new ah.o(f61Var2, y8Var, new x8(f61Var2, 0));
        this.d.D0(new l8(this, 6));
        y8 y8Var2 = this.f35717n;
        ...
        this.h.f27976w = false;
        j9 j9Var = new j9(this, context, this.h);
        this.f35709b = j9Var;
        this.f35717n.addView(j9Var, w7.x5.c(-1.0f, -1));
        this.d.setClipToPadding(false);
        this.d.setEmptyView(this.f35709b);
        ...
        org.telegram.ui.Components.pk0 pk0Var = new org.telegram.ui.Components.pk0(this.d, this.f35711c);
        this.e = pk0Var;
        pk0Var.h = new m8(this);
        y8 y8Var3 = this.f35717n;
        org.telegram.ui.Components.f61 f61Var5 = this.d;
        float f7 = -this.f35707a;
        ...
        this.f35715f = y10Var;
        y10Var.f30075c.setImageResource(R.drawable.filled_calls_plus);
        this.f35715f.setContentDescription(LocaleController.getString(R.string.Call));
        this.f35715f.setOnClickListener(new p8(this, 3));
        this.f35717n.addView(this.f35715f, org.telegram.ui.Components.y10.b());
        ...
        a9 a9Var = new a9(this, context, this, this.f35717n, this.resourceProvider, 0);
        this.O = a9Var;
        this.N.addView(a9Var);
        this.M.setCallFragmentContextView(this.O);
        this.f35717n.addView(this.M, w7.x5.d(-1, -2.0f, 48, 0.0f, -14.0f, 0.0f, 0.0f));
        this.f35717n.addView(this.actionBar);
        ci.s6 s6Var = new ci.s6(context, this.parentLayout);
        this.f35718r = s6Var;
        s6Var.b(false, false);
        this.f35717n.addView(this.f35718r, w7.x5.e(-1, 5, 48));
        this.actionBar.setDrawBlurBackground(this.f35717n);
    ...
    public final void f0() {
        ...
        if (Build.VERSION.SDK_INT >= 31 && (iVar = this.Y) != null) {
            ...
            this.f35714e0.set(0.0f, -dp, this.fragmentView.getMeasuredWidth(), this.actionBar.getMeasuredHeight() + dp);
            RectF rectF = this.f35716f0;
            ...
            iVar.g(i10, this.f35713d0);
            iVar.e(this.f35712c0, this.fragmentView.getMeasuredWidth(), this.fragmentView.getMeasuredHeight());
        }
    }

    public final void g0() {
        this.f35715f.setTranslationY(((-this.W) - this.U) - this.V);
    }
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35709b, 4, new Class[]{j9.class}, new String[]{"emptyTextView1"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.G6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35709b, 4, new Class[]{j9.class}, new String[]{"emptyTextView2"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f18845c7));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.d, 0, new Class[]{org.telegram.ui.Cells.r4.class}, new String[]{"progressBar"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f18934h6));
        ...
        org.telegram.ui.Components.y10 y10Var = this.f35715f;
        if (y10Var != null) {
            arrayList.add(new org.telegram.ui.ActionBar.l6(y10Var.f30075c, 8, null, null, null, null, org.telegram.ui.ActionBar.j6.O9));
            arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35715f.f30075c, 32, null, null, null, null, org.telegram.ui.ActionBar.j6.P9));
            arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35715f.f30075c, 65568, null, null, null, null, org.telegram.ui.ActionBar.j6.Q9));
        }
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.d, 0, new Class[]{h9.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.f18947i1}, null, org.telegram.ui.ActionBar.j6.A9));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.d, 0, new Class[]{h9.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.f18893f1}, null, org.telegram.ui.ActionBar.j6.f19266z9));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.d, 0, new Class[]{h9.class}, org.telegram.ui.ActionBar.j6.P0, null, null, org.telegram.ui.ActionBar.j6.f19081p6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.d, 0, new Class[]{h9.class}, null, org.telegram.ui.ActionBar.j6.f19112r0, null, org.telegram.ui.ActionBar.j6.J7));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.d, 0, new Class[]{View.class}, null, new Drawable[]{null, null, org.telegram.ui.ActionBar.j6.W4, org.telegram.ui.ActionBar.j6.Y4}, null, org.telegram.ui.ActionBar.j6.f19119r7));
    ...
    public final void i0() {
        ...
        this.f35709b.setPadding(0, 0, 0, this.W + this.T);
    }
    ...
    public final void onBecomeFullyVisible() {
        ...
        if (!this.S && getUserConfig().showCallsTab && MessagesController.getGlobalMainSettings().getInt("hidecallshint", 0) < 2) {
            ...
            f4Var.d = 3000L;
            f4Var.l(1.0f, -25.0f);
            this.f35719s.setPadding(0, AndroidUtilities.dp(4.0f), 0, 0);
            this.f35719s.s(AndroidUtilities.replaceTags(LocaleController.getString(R.string.TapToHideCallsTab)));
            this.f35717n.addView(this.f35719s, w7.x5.e(-1, 80, 48));
            this.f35719s.setTranslationY((org.telegram.ui.ActionBar.k.getCurrentActionBarHeight() + AndroidUtilities.statusBarHeight) - AndroidUtilities.dp(16.0f));
            this.f35719s.u();
            this.S = true;
    ...
    public final boolean onFragmentCreate() {
        ...
        if (bundle != null) {
            ...
            this.f35720w = this.arguments.getBoolean("hasMainTabs", false);
        }
        if (this.f35720w) {
    ...
    public final void q0() {
        ...
        if (s10) {
            ...
            if (!a2) {
                ...
                if (this.f35720w) {
                    ...
                    this.f35721x = imageView;
                    imageView.setScaleType(ImageView.ScaleType.CENTER);
                    this.f35721x.setImageDrawable(new org.telegram.ui.ActionBar.h2(true));
                    this.f35721x.setColorFilter(new PorterDuffColorFilter(getThemedColor(org.telegram.ui.ActionBar.j6.f19246y8), PorterDuff.Mode.MULTIPLY));
                    this.f35721x.setBackground(org.telegram.ui.ActionBar.j6.f0(getThemedColor(org.telegram.ui.ActionBar.j6.f19265z8), 1, -1));
                    this.f35721x.setOnClickListener(new p8(this, 1));
                    j3.addView(this.f35721x, w7.x5.q(54, 54, 16));
                    arrayList2.add(this.f35721x);
                }
                NumberTextView numberTextView = new NumberTextView(j3.getContext());
                this.f35722y = numberTextView;
                numberTextView.setTextSize(18);
                this.f35722y.setTypeface(AndroidUtilities.bold());
                this.f35722y.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19246y8, false));
                NumberTextView numberTextView2 = this.f35722y;
                if (this.f35720w) {
                    i10 = 18;
                } else {
                    i10 = 72;
                ...
                this.f35722y.setOnTouchListener(new bi.d(2));
        ...
        this.f35722y.a(arrayList.size(), z10);
    }

    @Override
    public final void r() {
        if (this.f35711c.L0() < 15) {
            this.d.y0(0);
            return;
        }
    ...
    @Override
    public final fh.d x() {
        return this.f35708a0;
    }

    public m9(Bundle bundle) {
        super(bundle);
        int i10 = Build.VERSION.SDK_INT;
        this.f35707a = i10 >= 31 ? 48 : 0;
        this.v = true;
        ...
        this.X = new Rect();
        ArrayList arrayList = new ArrayList();
        this.f35713d0 = arrayList;
        RectF rectF = new RectF();
        this.f35714e0 = rectF;
        RectF rectF2 = new RectF();
        this.f35716f0 = rectF2;
        arrayList.add(rectF);
        arrayList.add(rectF2);
        fh.c cVar = new fh.c();
        cVar.a(getThemedColor(org.telegram.ui.ActionBar.j6.f18806a7));
        if (i10 >= 31) {
