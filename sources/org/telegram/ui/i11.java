...
public final class i11 extends org.telegram.ui.ActionBar.j {
    ...
    public final void b(int i10) {
        ...
        int i16;
        int i17;
        l11 l11Var = this.f34790b;
        long j10 = l11Var.f35621f;
        long j11 = l11Var.e;
        String str = this.f34789a;
        if (i10 == -1) {
            if (!l11Var.h && l11Var.f35622n) {
            ...
            if (l11Var.f35623r != null) {
                ...
                obj.f35797c = c3;
                if (c3 != 0) {
                    obj.f35795a = org.telegram.messenger.y3.c("notifyuntil_", str, notificationsSettings, 0);
                }
                l11Var.f35623r.v(obj);
            }
        }
