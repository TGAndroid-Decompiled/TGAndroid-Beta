...
public final class wp0 extends Drawable {
    public static final int f42476j = 0;
    public float f42477a = AndroidUtilities.dpf2(10.6665f);
    public final boolean f42478b;
    public Paint f42479c;
    public final Paint d;
    public final Paint f42480e;
    public final Paint f42481f;
    public final Path f42482g;
    public final Path h;
    public final org.telegram.ui.Components.o5 f42483i;
    ...
    public wp0(int i10, int i11, int i12) {
        ...
        this.f42481f = paint3;
        this.f42482g = new Path();
        this.h = new Path();
        this.f42478b = i12 != i10;
        paint.setColor(i10);
        paint2.setColor(i11);
        paint3.setColor(i12);
        this.f42483i = null;
    ...
    public final void d() {
        ...
        Path path2 = this.f42482g;
        path2.rewind();
        path2.moveTo(this.f42477a * 2.0f, 0.0f);
        float f10 = this.f42477a;
        path2.lineTo(f10 * 2.0f, f10 * 2.0f);
        path2.lineTo(0.0f, this.f42477a * 2.0f);
        path2.close();
    }
    ...
    public final void draw(Canvas canvas) {
        canvas.save();
        canvas.translate(getBounds().centerX() - this.f42477a, getBounds().centerY() - this.f42477a);
        Paint paint = this.f42479c;
        if (paint != null) {
            float f7 = this.f42477a;
        ...
        canvas.drawPath(this.f42482g, this.f42480e);
        if (this.f42478b) {
            RectF rectF = AndroidUtilities.rectTmp;
            rectF.set(this.f42477a - AndroidUtilities.dp(3.66f), this.f42477a - AndroidUtilities.dp(3.66f), this.f42477a + AndroidUtilities.dp(3.66f), this.f42477a + AndroidUtilities.dp(3.66f));
            float f10 = this.f42477a;
            canvas.rotate(45.0f, f10, f10);
            canvas.drawRoundRect(rectF, AndroidUtilities.dp(2.33f), AndroidUtilities.dp(2.33f), this.f42481f);
        }
        canvas.restore();
        org.telegram.ui.Components.o5 o5Var = this.f42483i;
        if (o5Var != null) {
    ...
    public final void f(float f7, int i10) {
        ...
        this.f42479c.setStrokeWidth(f7);
        this.f42479c.setColor(i10);
    }

    @Override
    public final int getIntrinsicHeight() {
        return (int) (this.f42477a * 2.0f);
    }
