...
public final class o20 implements View.OnClickListener {
    ...
    public final void onClick(View view) {
        ...
        int i13 = 0;
        d60 d60Var = this.f36013b;
        switch (i12) {
            case 0:
                org.telegram.ui.ActionBar.u0 u0Var = d60Var.f32960k1;
                org.telegram.ui.ActionBar.e1 e1Var = d60Var.f33005v1;
                org.telegram.ui.ActionBar.e1 e1Var2 = d60Var.f33001u1;
                org.telegram.ui.ActionBar.e1 e1Var3 = d60Var.f32979p1;
                ChatObject.Call call = d60Var.f32919a1;
                if (call != null && !d60Var.a2.f29452b) {
                    if (call.call.join_muted) {
                        int i14 = org.telegram.ui.ActionBar.h6.f19124hg;
                        ...
                        int i15 = org.telegram.ui.ActionBar.h6.f19402wg;
                        ...
                        int i16 = org.telegram.ui.ActionBar.h6.f19402wg;
                        ...
                        int i17 = org.telegram.ui.ActionBar.h6.f19124hg;
            ...
            case 1:
                if (d60Var.r1()) {
                    if (sf.c.a(d60Var.f32952i0) > 0) {
                        org.telegram.ui.Components.voip.k1.n(d60Var.f32952i0);
                        d60Var.dismiss();
                        return;
                    }
                    org.telegram.ui.Components.e5.B(d60Var.f32952i0, null, true).o();
                    return;
                } else if (AndroidUtilities.checkInlinePermissions(d60Var.f32952i0)) {
            ...
            case 2:
                ...
                if (sharedInstance != null) {
                    ...
                    LaunchActivity launchActivity = d60Var.f32952i0;
                    if (launchActivity != null) {
                        d60Var.f32952i0.startActivityForResult(((MediaProjectionManager) launchActivity.getSystemService("media_projection")).createScreenCaptureIntent(), 520);
                        return;
                    }
                    return;
                }
            ...
            case 6:
                ...
                org.telegram.ui.Components.fu fuVar = d60Var.H.f25862a;
                fuVar.requestFocus();
            ...
            case 8:
                ...
                return;
            case 9:
                ChatObject.Call call5 = d60Var.f32919a1;
                ...
                if (sharedInstance2 != null && sharedInstance2.getVideoState(false) == 2) {
                    ...
                    for (int i18 = 0; i18 < arrayList.size(); i18++) {
                        ...
                        if (videoParticipant.participant.self && !videoParticipant.presentation) {
                            org.telegram.ui.Components.voip.p pVar = uVar.f29633a;
                            if (uVar.J0 == null) {
                                uVar.K0 = false;
                                ImageView imageView = uVar.f29664x0;
                                if (imageView == null) {
                                    uVar.f29664x0 = new ImageView(uVar.getContext());
                                } else {
                                ...
                                if (pVar.d.isFirstFrameRendered()) {
                                    ...
                                    if (bitmap != null) {
                                        ...
                                        uVar.f29664x0.setBackground(new BitmapDrawable(bitmap));
                                    }
                                    uVar.f29664x0.setAlpha(0.0f);
                                } else {
                                    uVar.f29664x0.setAlpha(1.0f);
                                }
                                if (uVar.f29664x0.getParent() == null) {
                                    pVar.addView(uVar.f29664x0);
                                }
                                ((FrameLayout.LayoutParams) uVar.f29664x0.getLayoutParams()).gravity = 17;
                                ...
                                uVar.J0.setInterpolator(org.telegram.ui.Components.rr.f28022f);
                                uVar.J0.start();
                            }
                        }
                    }
