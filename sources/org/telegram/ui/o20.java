...
public final class o20 implements View.OnClickListener {
    ...
    public final void onClick(View view) {
        ...
        int i13 = 0;
        d60 d60Var = this.f39508b;
        switch (i12) {
            case 0:
                org.telegram.ui.ActionBar.w0 w0Var = d60Var.f36021h1;
                org.telegram.ui.ActionBar.g1 g1Var = d60Var.f36066s1;
                org.telegram.ui.ActionBar.g1 g1Var2 = d60Var.f36061r1;
                org.telegram.ui.ActionBar.g1 g1Var3 = d60Var.f36039m1;
                ChatObject.Call call = d60Var.X0;
                if (call != null && !d60Var.X1.f32145b) {
                    if (call.call.join_muted) {
                        int i14 = org.telegram.ui.ActionBar.k6.f21743hg;
                        ...
                        int i15 = org.telegram.ui.ActionBar.k6.f22010wg;
                        ...
                        int i16 = org.telegram.ui.ActionBar.k6.f22010wg;
                        ...
                        int i17 = org.telegram.ui.ActionBar.k6.f21743hg;
            ...
            case 1:
                if (d60Var.r1()) {
                    if (ff.d.a(d60Var.f36012f0) > 0) {
                        org.telegram.ui.Components.voip.h1.n(d60Var.f36012f0);
                        d60Var.dismiss();
                        return;
                    }
                    org.telegram.ui.Components.z4.B(d60Var.f36012f0, null, true).o();
                    return;
                } else if (AndroidUtilities.checkInlinePermissions(d60Var.f36012f0)) {
            ...
            case 2:
                ...
                if (sharedInstance != null) {
                    ...
                    LaunchActivity launchActivity = d60Var.f36012f0;
                    if (launchActivity != null) {
                        d60Var.f36012f0.startActivityForResult(((MediaProjectionManager) launchActivity.getSystemService("media_projection")).createScreenCaptureIntent(), 520);
                        return;
                    }
                    return;
                }
            ...
            case 6:
                ...
                org.telegram.ui.Components.au auVar = d60Var.E.f26997a;
                auVar.requestFocus();
                ...
                if (sharedInstance2 != null && sharedInstance2.getVideoState(false) == 2) {
                    ...
                    for (int i18 = 0; i18 < arrayList.size(); i18++) {
                        ...
                        if (videoParticipant.participant.self && !videoParticipant.presentation) {
                            org.telegram.ui.Components.voip.p pVar = uVar.f32365a;
                            if (uVar.G0 == null) {
                                uVar.H0 = false;
                                ImageView imageView = uVar.f32392u0;
                                if (imageView == null) {
                                    uVar.f32392u0 = new ImageView(uVar.getContext());
                                } else {
                                    imageView.animate().cancel();
                                }
                                if (pVar.d.isFirstFrameRendered()) {
                                    Bitmap bitmap = pVar.f32357e.getBitmap(100, 100);
                                    if (bitmap != null) {
                                        Utilities.blurBitmap(bitmap, 3);
                                        uVar.f32392u0.setBackground(new BitmapDrawable(bitmap));
                                    }
                                    uVar.f32392u0.setAlpha(0.0f);
                                } else {
                                    uVar.f32392u0.setAlpha(1.0f);
                                }
                                if (uVar.f32392u0.getParent() == null) {
                                    pVar.addView(uVar.f32392u0);
                                }
                                ((FrameLayout.LayoutParams) uVar.f32392u0.getLayoutParams()).gravity = 17;
                                ...
                                uVar.G0.setInterpolator(org.telegram.ui.Components.pr.f30168f);
                                uVar.G0.start();
                            }
                        }
                    }
            ...
            default:
                ...
                d60Var.f36080v3 = Integer.valueOf(i13);
                d60Var.N1(true, true);
                d60Var.f36080v3 = null;
                AndroidUtilities.runOnUIThread(new org.telegram.ui.Components.im(d60Var, i13, 12));
                return;
        }
    }
}
