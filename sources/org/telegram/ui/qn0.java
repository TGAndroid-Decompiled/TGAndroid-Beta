...
public final class qn0 extends org.telegram.ui.ActionBar.o2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public EditTextBoldCursor[] f36948a0;
    public boolean f36949a1;
    public final int f36950b;
    public ScrollView f36951b0;
    public long f36952b1;
    public long f36953c;
    public LinearLayout f36954c0;
    public byte[] f36955c1;
    public final String d;
    public LinearLayout f36956d0;
    public String f36957d1;
    public final String e;
    public LinearLayout f36958e0;
    public byte[] f36959e1;
    public boolean f36960f;
    public LinearLayout f36961f0;
    public boolean f36962f1;
    public LinearLayout f36963g0;
    public boolean f36964g1;
    public final String h;
    public LinearLayout f36965h0;
    public qn0 f36966h1;
    public LinearLayout f36967i0;
    public final ArrayList f36968i1;
    public org.telegram.ui.Cells.l4 f36969j0;
    public SecureDocument f36970j1;
    public final ArrayList f36971k0;
    public final ArrayList f36972k1;
    public org.telegram.ui.Cells.a7 f36973l0;
    public SecureDocument l1;
    public org.telegram.ui.Cells.a7 m0;
    public SecureDocument f36974m1;
    public final String f36975n;
    public org.telegram.ui.Cells.e9 f36976n0;
    public final HashMap f36977n1;
    public org.telegram.ui.Cells.e9 f36978o0;
    public final HashMap f36979o1;
    public org.telegram.ui.Cells.e9 f36980p0;
    public final HashMap f36981p1;
    public org.telegram.ui.Cells.e9 f36982q0;
    public final HashMap f36983q1;
    public final String f36984r;
    public org.telegram.ui.Cells.ea f36985r0;
    public final HashMap f36986r1;
    public String f36987s;
    public int f36988s0;
    public final HashMap f36989s1;
    public final boolean[] f36990t0;
    public final HashMap f36991t1;
    public boolean f36992u0;
    public final HashMap f36993u1;
    public String v;
    public boolean f36994v0;
    public final HashMap f36995v1;
    public String f36996w;
    public TextView f36997w0;
    public HashMap f36998w1;
    public final int[] f36999x;
    public org.telegram.ui.Cells.ea f37000x0;
    public HashMap f37001x1;
    public TL_account.authorizationForm f37002y;
    public org.telegram.ui.Cells.ea f37003y0;
    public final HashMap f37004y1;
    public org.telegram.ui.Cells.a7 f37005z0;
    public String f37006z1;
    ...
    public qn0(int i10, TL_account.authorizationForm authorizationform, TL_account.Password password, TLRPC.TL_secureRequiredType tL_secureRequiredType, TLRPC.TL_secureValue tL_secureValue, TLRPC.TL_secureRequiredType tL_secureRequiredType2, TLRPC.TL_secureValue tL_secureValue2, HashMap hashMap, HashMap hashMap2) {
        ...
        this.f36987s = "";
        this.v = "";
        this.f36999x = new int[3];
        this.f36971k0 = new ArrayList();
        this.f36990t0 = new boolean[3];
        this.f36992u0 = true;
        this.U0 = new ArrayList();
        this.V0 = new HashMap();
        this.W0 = new HashMap();
        this.X0 = new HashMap();
        this.f36968i1 = new ArrayList();
        this.f36972k1 = new ArrayList();
        this.f36977n1 = new HashMap();
        this.f36979o1 = new HashMap();
        this.f36981p1 = new HashMap();
        this.f36983q1 = new HashMap();
        this.f36986r1 = new HashMap();
        this.f36993u1 = new HashMap();
        this.f36995v1 = new HashMap();
        this.f37004y1 = new HashMap();
        this.D1 = new pm0(this);
        this.f36950b = i10;
        this.f37002y = authorizationform;
        this.E = tL_secureRequiredType;
        if (tL_secureRequiredType != null) {
            this.f36992u0 = tL_secureRequiredType.native_names;
        }
        this.H = tL_secureValue;
        this.F = tL_secureRequiredType2;
        this.I = tL_secureValue2;
        this.J = password;
        this.f36989s1 = hashMap;
        this.f36991t1 = hashMap2;
        if (i10 == 3) {
        ...
        if (hashMap == null) {
            this.f36989s1 = new HashMap();
        }
        if (hashMap2 == null) {
            this.f36991t1 = new HashMap();
        }
        if (i10 == 5) {
    ...
    public static boolean D0(org.telegram.ui.qn0 r14) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.qn0.D0(org.telegram.ui.qn0):boolean");
    }
    ...
    public static void U(qn0 qn0Var, TLRPC.TL_auth_passwordRecovery tL_auth_passwordRecovery) {
    ...
    public static void V(qn0 qn0Var) {
        ...
        HashMap hashMap = qn0Var.f36986r1;
        HashMap hashMap2 = qn0Var.f36983q1;
        String str = qn0Var.f36984r;
        ArrayList arrayList2 = new ArrayList();
        int size = qn0Var.f37002y.required_types.size();
        for (int i12 = 0; i12 < size; i12++) {
            TLRPC.SecureRequiredType secureRequiredType = qn0Var.f37002y.required_types.get(i12);
            ...
            HashMap hashMap3 = (HashMap) qn0Var.f36993u1.get(o1(tL_secureRequiredType.type));
        ...
        acceptauthorization.bot_id = qn0Var.f36953c;
        ...
        int i14 = 0;
        while (i14 < size3) {
            qm0 qm0Var = (qm0) arrayList2.get(i14);
            TLRPC.TL_secureValue tL_secureValue = qm0Var.f36941a;
            ...
            if (securePlainData != null) {
                ...
                try {
                    ...
                    if (qm0Var.f36943c && !tL_secureValue.translation.isEmpty()) {
    ...
    public static void W(qn0 qn0Var, TLRPC.TL_error tL_error, String str, gn0 gn0Var, TLObject tLObject, TL_account.sendVerifyPhoneCode sendverifyphonecode) {
        if (tL_error == null) {
            HashMap hashMap = new HashMap();
            hashMap.put("phone", str);
            qn0 qn0Var2 = new qn0(7, qn0Var.f37002y, qn0Var.J, qn0Var.E, (TLRPC.TL_secureValue) null, (TLRPC.TL_secureRequiredType) null, (TLRPC.TL_secureValue) null, hashMap, (HashMap) null);
            qn0Var2.currentAccount = qn0Var.currentAccount;
            qn0Var2.f36959e1 = qn0Var.f36959e1;
            qn0Var2.f36955c1 = qn0Var.f36955c1;
            qn0Var2.B1 = gn0Var;
    ...
    public static void X(qn0 qn0Var, SecureDocument secureDocument, int i10) {
        HashMap hashMap = qn0Var.f36977n1;
        int i11 = qn0Var.S0;
        if (i11 == 1) {
            SecureDocument secureDocument2 = qn0Var.f36970j1;
            if (secureDocument2 != null) {
                on0 on0Var = (on0) hashMap.remove(secureDocument2);
                if (on0Var != null) {
                    qn0Var.f36963g0.removeView(on0Var);
                }
                qn0Var.f36970j1 = null;
            }
        } else if (i11 == 4) {
            if (qn0Var.f36972k1.size() >= 20) {
                return;
            }
        } else if (i11 == 2) {
            ...
            if (secureDocument3 != null) {
                ...
                if (on0Var2 != null) {
                    qn0Var.f36958e0.removeView(on0Var2);
                }
                qn0Var.l1 = null;
            }
        } else if (i11 == 3) {
            SecureDocument secureDocument4 = qn0Var.f36974m1;
            if (secureDocument4 != null) {
                on0 on0Var3 = (on0) hashMap.remove(secureDocument4);
                if (on0Var3 != null) {
                    qn0Var.f36961f0.removeView(on0Var3);
                }
                qn0Var.f36974m1 = null;
            }
        } else if (i11 == 0 && qn0Var.f36968i1.size() >= 20) {
            return;
        }
        qn0Var.f36979o1.put(secureDocument.path, secureDocument);
    ...
    public static void Y(org.telegram.ui.qn0 r9, boolean r10, java.lang.String r11) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.qn0.Y(org.telegram.ui.qn0, boolean, java.lang.String):void");
    }

    public static void Z(int i10, String str, SecureDocument secureDocument, on0 on0Var, qn0 qn0Var) {
        HashMap hashMap = qn0Var.f36979o1;
        qn0Var.f36977n1.remove(secureDocument);
        if (i10 == 1) {
            qn0Var.f36970j1 = null;
            qn0Var.f36963g0.removeView(on0Var);
        } else if (i10 == 4) {
            qn0Var.f36972k1.remove(secureDocument);
            qn0Var.f36965h0.removeView(on0Var);
        } else if (i10 == 2) {
            qn0Var.l1 = null;
            qn0Var.f36958e0.removeView(on0Var);
        } else if (i10 == 3) {
            qn0Var.f36974m1 = null;
            qn0Var.f36961f0.removeView(on0Var);
        } else {
            qn0Var.f36968i1.remove(secureDocument);
            qn0Var.f36956d0.removeView(on0Var);
        }
        if (str != null) {
            HashMap hashMap2 = qn0Var.f37001x1;
            if (hashMap2 != null) {
                hashMap2.remove(str);
            }
            HashMap hashMap3 = qn0Var.f37004y1;
            if (hashMap3 != null) {
                hashMap3.remove(str);
            }
        }
    ...
    public static void a0(qn0 qn0Var) {
        TL_account.deleteSecureValue deletesecurevalue = new TL_account.deleteSecureValue();
        for (int i10 = 0; i10 < qn0Var.f37002y.values.size(); i10++) {
            deletesecurevalue.types.add(qn0Var.f37002y.values.get(i10).type);
        }
        qn0Var.y1();
    ...
    public static void c0(qn0 qn0Var) {
        ...
        } else if (qn0Var.getParentActivity() == null) {
        } else {
    ...
    public static void d0(qn0 qn0Var) {
        Activity parentActivity = qn0Var.getParentActivity();
        nf.f.s(parentActivity, "https://telegram.org/deactivate?phone=" + UserConfig.getInstance(qn0Var.currentAccount).getClientPhone());
    }
    ...
    public static int f0(qn0 qn0Var) {
        return qn0Var.currentAccount;
    }
    ...
    public static int s0(qn0 qn0Var) {
        return qn0Var.currentAccount;
    }

    public static int t0(qn0 qn0Var) {
        return qn0Var.currentAccount;
    }
    ...
    public final void C1() {
        ...
        if (getParentActivity() != null && !arrayList.isEmpty()) {
            ...
            alertDialog$Builder.f18447a.R = LocaleController.getString(R.string.PassportNoDocumentsAdd);
    ...
    public final void D1() {
        ...
        int i11 = this.S0;
        ArrayList arrayList = this.f36968i1;
        int i12 = 1;
    ...
    public final void E1(TLRPC.TL_secureRequiredType tL_secureRequiredType, TLRPC.TL_secureRequiredType tL_secureRequiredType2, ArrayList arrayList, boolean z10) {
        ...
        if (i11 != -1) {
            HashMap hashMap4 = this.f36993u1;
            if (!z10) {
            ...
            TL_account.authorizationForm authorizationform = this.f37002y;
            int i12 = i11;
            TL_account.Password password = this.J;
            HashMap hashMap7 = this.f36981p1;
            ...
            qn0 qn0Var = new qn0(i12, authorizationform, password, tL_secureRequiredType, r12, tL_secureRequiredType2, r13, hashMap8, hashMap3);
            qn0Var.B1 = new tm0(this, secureValueType2, z10, i10);
            qn0Var.currentAccount = this.currentAccount;
            qn0Var.f36959e1 = this.f36959e1;
            qn0Var.f36955c1 = this.f36955c1;
            qn0Var.f36953c = this.f36953c;
            qn0Var.f36998w1 = hashMap6;
            qn0Var.f36994v0 = z10;
            qn0Var.f37001x1 = hashMap2;
            qn0Var.G = arrayList;
            if (i12 == 4) {
                qn0Var.f36957d1 = this.f36957d1;
            }
    ...
    public final TLRPC.TL_secureValue H1(TLRPC.TL_secureRequiredType tL_secureRequiredType) {
        ...
        int size = this.f37002y.values.size();
        for (int i10 = 0; i10 < size; i10++) {
            if (tL_secureRequiredType.type.getClass() == this.f37002y.values.get(i10).type.getClass()) {
                return this.f37002y.values.remove(i10);
            }
        }
        return null;
    }
    ...
    public final void I1(View view) {
        while (view != null && this.f36954c0.indexOfChild(view) < 0) {
            view = (View) view.getParent();
        }
        if (view != null) {
            this.f36951b0.smoothScrollTo(0, view.getTop() - ((this.f36951b0.getMeasuredHeight() - view.getMeasuredHeight()) / 2));
        }
    }
    ...
    public final void J1(HashMap hashMap, EditTextBoldCursor editTextBoldCursor, String str) {
        ...
        HashMap hashMap2 = this.f36998w1;
        HashMap hashMap3 = this.f37004y1;
        ...
        HashMap hashMap4 = this.f37001x1;
    ...
    public final void K1(Bundle bundle, int i10, boolean z10) {
        ...
        if (z10) {
            ...
            animatorSet.addListener(new org.telegram.ui.Components.qk0(vv0Var2, vv0Var, 8));
            animatorSet.start();
            return;
        }
    ...
    public final void L1(org.telegram.tgnet.TLRPC.TL_secureRequiredType r31, java.lang.String r32, java.lang.String r33, org.telegram.tgnet.TLRPC.TL_secureRequiredType r34, java.lang.String r35, boolean r36, int r37) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.qn0.L1(org.telegram.tgnet.TLRPC$TL_secureRequiredType, java.lang.String, java.lang.String, org.telegram.tgnet.TLRPC$TL_secureRequiredType, java.lang.String, boolean, int):void");
    }
    ...
    public final void N1(boolean z10, boolean z11) {
        ...
        if (z10 && this.L != null) {
            ...
            this.M.addListener(new um0(this, z11, 0));
            ...
            this.M.addListener(new um0(this, z11, 1));
            this.M.setDuration(150L);
            this.M.start();
        }
    }
    ...
    public final void Q1() {
        if (this.f37002y.values.isEmpty()) {
            this.A0.setVisibility(0);
            this.f36973l0.setVisibility(8);
            this.f36969j0.setVisibility(8);
            this.f37000x0.setVisibility(8);
            this.f37003y0.setVisibility(8);
            this.f37005z0.setVisibility(8);
            return;
        }
        this.A0.setVisibility(8);
        this.f36973l0.setVisibility(0);
        this.f36969j0.setVisibility(0);
        this.f37003y0.setVisibility(0);
        this.f37005z0.setVisibility(0);
    ...
    public final void R0(final SecureDocument secureDocument, final int i10) {
        ...
        HashMap hashMap;
        if (i10 == 1) {
            this.f36970j1 = secureDocument;
            if (this.f36963g0 == null) {
                return;
            }
        } else if (i10 == 4) {
            this.f36972k1.add(secureDocument);
            if (this.f36965h0 == null) {
                return;
            }
        } else if (i10 == 2) {
            this.l1 = secureDocument;
            if (this.f36958e0 == null) {
                return;
            }
        } else if (i10 == 3) {
            this.f36974m1 = secureDocument;
            if (this.f36961f0 == null) {
                return;
            }
        } else {
            this.f36968i1.add(secureDocument);
            if (this.f36956d0 == null) {
                return;
            }
        }
        if (getParentActivity() == null) {
        ...
        if (i10 == 1) {
            ...
            this.f36958e0.addView(on0Var, w7.x5.n(-1, -2));
            str = "front" + n12;
        } else if (i10 == 3) {
            string = LocaleController.getString(R.string.PassportReverseSide);
            this.f36961f0.addView(on0Var, w7.x5.n(-1, -2));
            str = "reverse" + n12;
        } else {
            string = LocaleController.getString(R.string.AttachPhoto);
            this.f36956d0.addView(on0Var, w7.x5.n(-1, -2));
            str = "files" + n12;
        }
        if (str != null && (hashMap = this.f37001x1) != null && (formatDateForBan = (String) hashMap.get(str)) != null) {
            on0Var.f36392b.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19083p7, false));
            this.f37004y1.put(str, "");
        } else {
            formatDateForBan = LocaleController.formatDateForBan(secureDocument.secureFile.date);
        }
        on0Var.f36391a.setText(string);
        on0Var.f36392b.setText(formatDateForBan);
        org.telegram.ui.Components.u9 u9Var = on0Var.f36393c;
        u9Var.getClass();
        u9Var.m(ImageLocation.getForSecureDocument(secureDocument), "48_48", null, null, null, null, 0, null);
        on0Var.f36394f = secureDocument;
        on0Var.a(false);
        on0Var.setOnClickListener(new ci.o4(this, i10, 20));
        on0Var.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public final boolean onLongClick(View view) {
                ...
                int i11 = i10;
                if (i11 == 1) {
                    alertDialog$Builder.f18447a.T = LocaleController.getString(R.string.PassportDeleteSelfie);
                } else {
                    alertDialog$Builder.f18447a.T = LocaleController.getString(R.string.PassportDeleteScan);
                }
                ...
                qn0Var.showDialog(alertDialog$Builder.f18447a);
                return true;
            }
        });
    }
    ...
    public final void S1(int r7) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.qn0.S1(int):void");
    }
    ...
    public final org.telegram.ui.pn0 U0(android.content.Context r28, org.telegram.tgnet.TLRPC.TL_secureRequiredType r29, java.util.ArrayList r30, boolean r31, boolean r32) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.qn0.U0(android.content.Context, org.telegram.tgnet.TLRPC$TL_secureRequiredType, java.util.ArrayList, boolean, boolean):org.telegram.ui.pn0");
    }
        ...
        if (this.f36948a0 != null) {
            ...
            if (this.E.native_names && !TextUtils.isEmpty(this.v) && !"EN".equals(str3)) {
                if (this.f36982q0.getVisibility() != 0) {
                    ...
                    int i11 = 0;
                    while (true) {
                        editTextBoldCursorArr = this.f36948a0;
                        if (i11 >= editTextBoldCursorArr.length) {
                            break;
                        }
                    ...
                    if (editTextBoldCursorArr[0].length() == 0 && this.f36948a0[1].length() == 0 && this.f36948a0[2].length() == 0) {
                        int i12 = 0;
                        while (true) {
                            boolean[] zArr = this.f36990t0;
                            if (i12 >= zArr.length) {
                                break;
                            } else if (zArr[i12]) {
                                this.f36948a0[0].setText(this.Y[0].getText());
                                this.f36948a0[1].setText(this.Y[1].getText());
                                this.f36948a0[2].setText(this.Y[2].getText());
                                break;
                            } else {
                                i12++;
                            }
                    ...
                    this.m0.setBackgroundDrawable(org.telegram.ui.ActionBar.j6.V0(getParentActivity(), R.drawable.greydivider, org.telegram.ui.ActionBar.j6.f18827b7));
                }
                this.f36982q0.setText(LocaleController.formatString("PassportNativeInfo", R.string.PassportNativeInfo, str2));
                if (str3 != null) {
                ...
                if (str != null) {
                    this.f36969j0.setText(LocaleController.formatString("PassportNativeHeaderLang", R.string.PassportNativeHeaderLang, str));
                } else {
                    this.f36969j0.setText(LocaleController.getString(R.string.PassportNativeHeader));
                }
                for (int i13 = 0; i13 < 3; i13++) {
                    if (i13 != 0) {
                        if (i13 != 1) {
                            if (i13 == 2) {
                                if (str != null) {
                                    this.f36948a0[i13].setHintText(LocaleController.getString(R.string.PassportSurname));
                                } else {
                                    this.f36948a0[i13].setHintText(LocaleController.formatString("PassportSurnameCountry", R.string.PassportSurnameCountry, str2));
                                }
                            }
                        } else if (str != null) {
                            this.f36948a0[i13].setHintText(LocaleController.getString(R.string.PassportMidname));
                        } else {
                            this.f36948a0[i13].setHintText(LocaleController.formatString("PassportMidnameCountry", R.string.PassportMidnameCountry, str2));
                        }
                    } else if (str != null) {
                        this.f36948a0[i13].setHintText(LocaleController.getString(R.string.PassportName));
                    } else {
                        this.f36948a0[i13].setHintText(LocaleController.formatString("PassportNameCountry", R.string.PassportNameCountry, str2));
                    }
                }
                if (z10) {
                    AndroidUtilities.runOnUIThread(new zl0(this, 2));
                }
            } else if (this.f36982q0.getVisibility() != 8) {
                this.f36982q0.setVisibility(8);
                this.f36969j0.setVisibility(8);
                this.T.setVisibility(8);
                while (true) {
                    EditTextBoldCursor[] editTextBoldCursorArr2 = this.f36948a0;
                ...
                if (((this.f36953c != 0 || this.F == null) && this.H != null && !this.f36994v0) || this.I != null) {
                    this.m0.setBackgroundDrawable(org.telegram.ui.ActionBar.j6.V0(getParentActivity(), R.drawable.greydivider, org.telegram.ui.ActionBar.j6.f18827b7));
                } else {
                    this.m0.setBackgroundDrawable(org.telegram.ui.ActionBar.j6.V0(getParentActivity(), R.drawable.greydivider_bottom, org.telegram.ui.ActionBar.j6.f18827b7));
                }
            }
        }
    }
    ...
    public final void a1(boolean z10) {
        ...
        String str;
        String str2;
        if (this.f36980p0 != null) {
            HashMap hashMap = this.f36998w1;
            HashMap hashMap2 = this.f37004y1;
            if (hashMap != null && ((z10 || hashMap2.containsKey("error_all")) && (str2 = (String) this.f36998w1.get("error_all")) != null)) {
            ...
            if (this.f37001x1 != null && ((z10 || hashMap2.containsKey("error_document_all")) && (str = (String) this.f37001x1.get("error_all")) != null)) {
            ...
            if (spannableStringBuilder != null) {
                spannableStringBuilder.setSpan(new ForegroundColorSpan(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19083p7, false)), 0, spannableStringBuilder.length(), 33);
                this.f36980p0.setText(spannableStringBuilder);
                this.f36980p0.setVisibility(0);
            } else if (this.f36980p0.getVisibility() != 8) {
                this.f36980p0.setVisibility(8);
            }
        }
    }
    ...
    public final void b1(Context context) {
        ...
        this.f36980p0.setPadding(0, AndroidUtilities.dp(7.0f), 0, 0);
        this.f36954c0.addView(this.f36980p0, w7.x5.n(-1, -2));
        a1(true);
        TLRPC.TL_secureRequiredType tL_secureRequiredType = this.F;
        if (tL_secureRequiredType != null) {
            ...
            org.telegram.ui.Cells.l4 l4Var2 = this.f36969j0;
            int i12 = org.telegram.ui.ActionBar.j6.f18863d6;
            l4Var2.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, i12, false));
            this.f36954c0.addView(this.f36969j0, w7.x5.n(-1, -2));
            LinearLayout linearLayout = new LinearLayout(context);
            this.f36956d0 = linearLayout;
            linearLayout.setOrientation(1);
            this.f36954c0.addView(this.f36956d0, w7.x5.n(-1, -2));
            ...
            if (hashMap != null) {
                ...
                if (str4 != null) {
                    ...
                    spannableStringBuilder.append((CharSequence) "\n\n");
                    spannableStringBuilder.append((CharSequence) this.f37006z1);
                    spannableStringBuilder.setSpan(new ForegroundColorSpan(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19083p7, false)), 0, str4.length(), 33);
                    hashMap2.put("files_all", "");
                    str3 = spannableStringBuilder;
                }
            }
            this.f36976n0.setText(str3);
            this.f36954c0.addView(this.f36976n0, w7.x5.n(-1, -2));
            if (this.F.translation_required) {
                org.telegram.ui.Cells.l4 l4Var3 = new org.telegram.ui.Cells.l4(context);
                this.f36969j0 = l4Var3;
                l4Var3.setText(LocaleController.getString(R.string.PassportTranslation));
                this.f36969j0.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, i12, false));
                this.f36954c0.addView(this.f36969j0, w7.x5.n(-1, -2));
                LinearLayout linearLayout2 = new LinearLayout(context);
                this.f36965h0 = linearLayout2;
                linearLayout2.setOrientation(1);
                this.f36954c0.addView(this.f36965h0, w7.x5.n(-1, -2));
                ...
                String str5 = this.A1;
                HashMap hashMap3 = this.f37001x1;
                String str6 = str5;
                if (hashMap3 != null) {
                    ...
                    if (str7 != null) {
                        ...
                        spannableStringBuilder2.setSpan(new ForegroundColorSpan(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19083p7, false)), 0, str7.length(), 33);
                        hashMap2.put("translation_all", "");
                        str6 = spannableStringBuilder2;
                    }
                }
                this.f36978o0.setText(str6);
                this.f36954c0.addView(this.f36978o0, w7.x5.n(-1, -2));
            }
        } else {
            j3 = 0;
        ...
        this.f36969j0 = l4Var4;
        l4Var4.setText(LocaleController.getString(R.string.PassportAddressHeader));
        this.f36969j0.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18863d6, false));
        this.f36954c0.addView(this.f36969j0, w7.x5.n(-1, -2));
        this.Y = new EditTextBoldCursor[6];
        for (int i13 = 0; i13 < 6; i13++) {
            EditTextBoldCursor editTextBoldCursor = new EditTextBoldCursor(context);
            this.Y[i13] = editTextBoldCursor;
            km0 km0Var = new km0(context, editTextBoldCursor, 0);
            km0Var.setWillNotDraw(false);
            this.f36954c0.addView(km0Var, w7.x5.n(-1, -2));
            int i14 = org.telegram.ui.ActionBar.j6.f18863d6;
            km0Var.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, i14, false));
            int i15 = 5;
            if (i13 == 5) {
                View view = new View(context);
                this.S = view;
                view.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, i14, false));
                this.f36954c0.addView(this.S, w7.x5.n(-1, 6));
            }
            if (this.f36994v0 && this.F != null) {
            ...
            this.Y[i13].setLineColors(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18991k6, false), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19009l6, false), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19083p7, false));
            if (i13 == 5) {
            ...
            J1(this.f36989s1, this.Y[i13], str);
            if (i13 == 2) {
                this.Y[i13].addTextChangedListener(new lm0(this, editTextBoldCursor, str));
                this.Y[i13].setFilters(new InputFilter[]{new InputFilter.LengthFilter(10)});
            } else {
                this.Y[i13].addTextChangedListener(new mm0(this, editTextBoldCursor, str, 0));
            }
            ...
            km0Var.addView(this.Y[i13], w7.x5.d(-1, 64.0f, 51, 21.0f, 0.0f, 21.0f, 0.0f));
        ...
        this.f36973l0 = a7Var;
        this.f36954c0.addView(a7Var, w7.x5.n(-1, -2));
        if (this.f36994v0 && this.F != null) {
            this.f36969j0.setVisibility(8);
            this.f36973l0.setVisibility(8);
        }
        long j10 = this.f36953c;
        TLRPC.TL_secureValue tL_secureValue = this.I;
        if (((j10 != j3 || this.F == null) && this.H != null && !this.f36994v0) || tL_secureValue != null) {
            if (tL_secureValue != null) {
                T0(tL_secureValue.files);
                V0(tL_secureValue.translation);
            }
            org.telegram.ui.Cells.a7 a7Var2 = this.f36973l0;
            int i17 = R.drawable.greydivider;
            int i18 = org.telegram.ui.ActionBar.j6.f18827b7;
            ...
            eaVar3.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19083p7, false));
            ...
            this.f36954c0.addView(eaVar3, w7.x5.n(-1, -2));
            ...
            this.f36973l0 = a7Var3;
            a7Var3.setBackgroundDrawable(org.telegram.ui.ActionBar.j6.V0(context, R.drawable.greydivider_bottom, i18));
            this.f36954c0.addView(this.f36973l0, w7.x5.n(-1, -2));
        } else {
            org.telegram.ui.Cells.a7 a7Var4 = this.f36973l0;
            int i19 = R.drawable.greydivider_bottom;
            int i20 = org.telegram.ui.ActionBar.j6.f18827b7;
            a7Var4.setBackgroundDrawable(org.telegram.ui.ActionBar.j6.V0(context, i19, i20));
            if (this.f36994v0 && this.F != null) {
                this.f36976n0.setBackgroundDrawable(org.telegram.ui.ActionBar.j6.V0(context, R.drawable.greydivider_bottom, i20));
            }
        }
        S1(0);
        S1(4);
    ...
    public final android.view.View createView(android.content.Context r37) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.qn0.createView(android.content.Context):android.view.View");
    }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.fileUploaded) {
            ...
            if (secureDocument != null) {
                ...
                HashMap hashMap2 = this.f36977n1;
                ...
                if (i12 == 0) {
                    if (this.f36976n0 != null && !TextUtils.isEmpty(this.f37006z1)) {
                        this.f36976n0.setText(this.f37006z1);
                    }
                    hashMap3.remove("files_all");
                } else if (i12 == 4) {
                    if (this.f36978o0 != null && !TextUtils.isEmpty(this.A1)) {
                        this.f36978o0.setText(this.A1);
                    }
    ...
    public final void e1(Context context) {
        ...
        int i13 = org.telegram.ui.ActionBar.j6.f18827b7;
        ...
        if (tL_secureRequiredType != null) {
            ...
            this.f36954c0.addView(this.f36969j0, w7.x5.n(-1, -2));
            LinearLayout linearLayout = new LinearLayout(context);
            this.f36958e0 = linearLayout;
            linearLayout.setOrientation(1);
            this.f36954c0.addView(this.f36958e0, w7.x5.n(-1, -2));
            ...
            this.f36954c0.addView(this.U, w7.x5.n(-1, -2));
            this.U.setOnClickListener(new am0(this, 0));
            LinearLayout linearLayout2 = new LinearLayout(context);
            this.f36961f0 = linearLayout2;
            linearLayout2.setOrientation(1);
            this.f36954c0.addView(this.f36961f0, w7.x5.n(-1, -2));
            ...
            this.f36954c0.addView(this.V, w7.x5.n(-1, -2));
            this.V.setOnClickListener(new am0(this, 2));
            if (this.F.selfie_required) {
                LinearLayout linearLayout3 = new LinearLayout(context);
                this.f36963g0 = linearLayout3;
                linearLayout3.setOrientation(1);
                this.f36954c0.addView(this.f36963g0, w7.x5.n(-1, -2));
                ...
                this.f36954c0.addView(this.W, w7.x5.n(-1, -2));
            ...
            this.f36976n0.setText(LocaleController.getString(R.string.PassportPersonalUploadInfo));
            this.f36954c0.addView(this.f36976n0, w7.x5.n(-1, -2));
            if (this.F.translation_required) {
                org.telegram.ui.Cells.l4 l4Var3 = new org.telegram.ui.Cells.l4(context);
                this.f36969j0 = l4Var3;
                l4Var3.setText(LocaleController.getString(R.string.PassportTranslation));
                this.f36969j0.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, i15, false));
                this.f36954c0.addView(this.f36969j0, w7.x5.n(-1, -2));
                LinearLayout linearLayout4 = new LinearLayout(context);
                this.f36965h0 = linearLayout4;
                ...
                if (hashMap != null) {
                    ...
                    if (str5 != null) {
                        ...
                        spannableStringBuilder.setSpan(new ForegroundColorSpan(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19083p7, false)), 0, str5.length(), 33);
                        this.f37004y1.put("translation_all", "");
                        str4 = spannableStringBuilder;
                    }
                }
                this.f36978o0.setText(str4);
                this.f36954c0.addView(this.f36978o0, w7.x5.n(-1, -2));
            }
        } else {
            j3 = 0;
            org.telegram.ui.Cells.ea eaVar2 = new org.telegram.ui.Cells.ea(context);
            this.f36985r0 = eaVar2;
            eaVar2.setBackgroundDrawable(org.telegram.ui.ActionBar.j6.K0(true));
            this.f36985r0.b(LocaleController.getString(R.string.PassportScanPassport), false);
            this.f36954c0.addView(this.f36985r0, w7.x5.n(-1, -2));
            this.f36985r0.setOnClickListener(new am0(this, 5));
            org.telegram.ui.Cells.e9 e9Var4 = new org.telegram.ui.Cells.e9(context);
            this.f36976n0 = e9Var4;
            e9Var4.setBackgroundDrawable(org.telegram.ui.ActionBar.j6.V0(context, R.drawable.greydivider, i13));
            this.f36976n0.setText(LocaleController.getString(R.string.PassportScanPassportInfo));
            this.f36954c0.addView(this.f36976n0, w7.x5.n(-1, -2));
        }
        org.telegram.ui.Cells.l4 l4Var4 = new org.telegram.ui.Cells.l4(context);
        this.f36969j0 = l4Var4;
        ...
        int i17 = 0;
        while (true) {
            HashMap hashMap2 = this.f36989s1;
            if (i17 < i10) {
                EditTextBoldCursor editTextBoldCursor = new EditTextBoldCursor(context);
                this.Y[i17] = editTextBoldCursor;
                km0 km0Var = new km0(context, editTextBoldCursor, 1);
                km0Var.setWillNotDraw(z10);
                this.f36954c0.addView(km0Var, w7.x5.n(i14, 64));
                int i18 = org.telegram.ui.ActionBar.j6.f18863d6;
                km0Var.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, i18, z10));
                if (i17 == i10 - 1) {
                    View view = new View(context);
                    this.S = view;
                    view.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, i18, z10));
                    this.f36954c0.addView(this.S, w7.x5.n(i14, 6));
                }
                if (this.f36994v0 && this.F != null && i17 < i16) {
                    km0Var.setVisibility(8);
                    View view2 = this.S;
                    if (view2 != null) {
                        view2.setVisibility(8);
                ...
                this.Y[i17].setLineColors(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18991k6, false), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19009l6, false), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19083p7, false));
                int i20 = 5;
                if (i17 != 5 && i17 != 6) {
                    if (i17 != 3 && i17 != 8) {
                        if (i17 == 4) {
                ...
                HashMap hashMap3 = this.f36991t1;
                switch (i17) {
                    case 0:
                ...
                if (i17 != 0 && i17 != 2 && i17 != 1) {
                    this.Y[i17].addTextChangedListener(new org.telegram.ui.Components.kx0(this, editTextBoldCursor, str2, hashMap2));
                } else {
                    this.Y[i17].addTextChangedListener(new om0(this, editTextBoldCursor, str2));
                }
                ...
                km0Var.addView(this.Y[i17], w7.x5.d(-1, -1.0f, 51, 21.0f, 0.0f, 21.0f, 0.0f));
                ...
                this.f36969j0 = l4Var5;
                l4Var5.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18863d6, false));
                this.f36954c0.addView(this.f36969j0, w7.x5.n(-1, -2));
                this.f36948a0 = new EditTextBoldCursor[3];
                int i21 = 0;
                for (int i22 = 3; i21 < i22; i22 = 3) {
                    EditTextBoldCursor editTextBoldCursor5 = new EditTextBoldCursor(context);
                    this.f36948a0[i21] = editTextBoldCursor5;
                    km0 km0Var2 = new km0(context, editTextBoldCursor5, 2);
                    km0Var2.setWillNotDraw(false);
                    this.f36954c0.addView(km0Var2, w7.x5.n(-1, 64));
                    int i23 = org.telegram.ui.ActionBar.j6.f18863d6;
                    km0Var2.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, i23, false));
                    if (i21 == 2) {
                        View view3 = new View(context);
                        this.T = view3;
                        view3.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, i23, false));
                        this.f36954c0.addView(this.T, w7.x5.n(-1, 6));
                    }
                    this.f36948a0[i21].setTag(Integer.valueOf(i21));
                    this.f36948a0[i21].setSupportRtlHint(true);
                    this.f36948a0[i21].setTextSize(1, 16.0f);
                    this.f36948a0[i21].setHintColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.H6, false));
                    EditTextBoldCursor editTextBoldCursor6 = this.f36948a0[i21];
                    int i24 = org.telegram.ui.ActionBar.j6.G6;
                    editTextBoldCursor6.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i24, false));
                    this.f36948a0[i21].setHeaderHintColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.L6, false));
                    this.f36948a0[i21].setTransformHintToHeader(true);
                    this.f36948a0[i21].setBackgroundDrawable(null);
                    this.f36948a0[i21].setCursorColor(org.telegram.ui.ActionBar.j6.w0(null, i24, false));
                    this.f36948a0[i21].setCursorSize(AndroidUtilities.dp(20.0f));
                    this.f36948a0[i21].setCursorWidth(1.5f);
                    this.f36948a0[i21].setLineColors(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18991k6, false), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19009l6, false), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19083p7, false));
                    this.f36948a0[i21].setInputType(16385);
                    this.f36948a0[i21].setImeOptions(268435461);
                    if (i21 != 0) {
                        if (i21 != 1) {
                            if (i21 == 2) {
                    ...
                    J1(hashMap2, this.f36948a0[i21], str);
                    EditTextBoldCursor editTextBoldCursor7 = this.f36948a0[i21];
                    editTextBoldCursor7.setSelection(editTextBoldCursor7.length());
                    if (i21 == 0 || i21 == 2 || i21 == 1) {
                        this.f36948a0[i21].addTextChangedListener(new mm0(this, editTextBoldCursor5, str, 1));
                    }
                    this.f36948a0[i21].setPadding(0, 0, 0, 0);
                    EditTextBoldCursor editTextBoldCursor8 = this.f36948a0[i21];
                    if (LocaleController.isRTL) {
                        i11 = 5;
                    } else {
                        i11 = 3;
                    ...
                    km0Var2.addView(this.f36948a0[i21], w7.x5.d(-1, -1.0f, 51, 21.0f, 0.0f, 21.0f, 0.0f));
                    this.f36948a0[i21].setOnEditorActionListener(new yl0(this, 2));
                    i21++;
                }
                org.telegram.ui.Cells.e9 e9Var5 = new org.telegram.ui.Cells.e9(context);
                this.f36982q0 = e9Var5;
                this.f36954c0.addView(e9Var5, w7.x5.n(-1, -2));
                long j10 = this.f36953c;
                TLRPC.TL_secureValue tL_secureValue = this.I;
                if (((j10 != j3 || this.F == null) && this.H != null && !this.f36994v0) || tL_secureValue != null) {
                    if (tL_secureValue != null) {
                    ...
                    org.telegram.ui.Cells.e9 e9Var6 = this.f36982q0;
                    int i25 = R.drawable.greydivider;
                    int i26 = org.telegram.ui.ActionBar.j6.f18827b7;
                    ...
                    this.f36973l0 = a7Var2;
                    a7Var2.setBackgroundDrawable(org.telegram.ui.ActionBar.j6.V0(context, R.drawable.greydivider_bottom, i26));
                    this.f36954c0.addView(this.f36973l0, w7.x5.n(-1, -2));
                } else {
                    this.f36982q0.setBackgroundDrawable(org.telegram.ui.ActionBar.j6.V0(context, R.drawable.greydivider_bottom, org.telegram.ui.ActionBar.j6.f18827b7));
                }
                P1();
                Y0(false);
                return;
    ...
    public final void f1(android.content.Context r19) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.qn0.f1(android.content.Context):void");
    }
    ...
    public final void g1(Context context) {
        ...
        this.f36954c0.addView(eaVar, w7.x5.n(-1, -2));
        ...
        this.f36976n0.setText(LocaleController.getString(R.string.PassportPhoneUseSameInfo));
        this.f36954c0.addView(this.f36976n0, w7.x5.n(-1, -2));
        org.telegram.ui.Cells.l4 l4Var = new org.telegram.ui.Cells.l4(context);
        this.f36969j0 = l4Var;
        ...
        for (int i11 = 0; i11 < 3; i11++) {
            ...
            if (i11 == 1) {
                ...
                this.f36954c0.addView(frameLayout, w7.x5.n(-1, 50));
            ...
            if (i11 == 1) {
                ...
                this.f36997w0 = textView;
                textView.setText("+");
                this.f36997w0.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i12, false));
                this.f36997w0.setTextSize(1, 16.0f);
                frameLayout.addView(this.f36997w0, w7.x5.k(21.0f, 12.0f, 0.0f, 6.0f, -2, -2));
                ...
                this.Y[i11].addTextChangedListener(new dn0(this));
            } else if (i11 == 2) {
            ...
            if (i11 == 2) {
                this.Y[i11].setOnKeyListener(new xg(this, 1));
            }
            if (i11 == 0) {
                View view = new View(context);
                this.f36971k0.add(view);
                view.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18864d7, false));
        ...
        org.telegram.ui.Cells.e9 e9Var2 = new org.telegram.ui.Cells.e9(context);
        this.f36976n0 = e9Var2;
        e9Var2.setBackgroundDrawable(org.telegram.ui.ActionBar.j6.V0(context, R.drawable.greydivider_bottom, org.telegram.ui.ActionBar.j6.f18827b7));
        this.f36976n0.setText(LocaleController.getString(R.string.PassportPhoneUploadInfo));
        this.f36954c0.addView(this.f36976n0, w7.x5.n(-1, -2));
    }
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36951b0, 32768, null, null, null, null, i10));
        ...
        int i11 = 0;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36954c0, 0, new Class[]{View.class}, org.telegram.ui.ActionBar.j6.f18985k0, null, null, org.telegram.ui.ActionBar.j6.f18864d7));
        View view = this.S;
        int i12 = org.telegram.ui.ActionBar.j6.f18863d6;
        ...
        int i13 = 0;
        while (true) {
            ArrayList arrayList2 = this.f36971k0;
            if (i13 >= arrayList2.size()) {
                break;
            }
            arrayList.add(new org.telegram.ui.ActionBar.l6((View) arrayList2.get(i13), 1, null, null, null, null, org.telegram.ui.ActionBar.j6.f18864d7));
            i13++;
        }
        for (Map.Entry entry : this.f36977n1.entrySet()) {
            on0 on0Var = (on0) entry.getValue();
            arrayList.add(new org.telegram.ui.ActionBar.l6(on0Var, 268435456, new Class[]{on0.class}, null, null, null, org.telegram.ui.ActionBar.j6.f18863d6));
            ...
            arrayList.add(new org.telegram.ui.ActionBar.l6(on0Var, 0, new Class[]{on0.class}, new String[]{"valueTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f19264z6));
        }
        int i14 = org.telegram.ui.ActionBar.j6.f18863d6;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36954c0, 268435456, new Class[]{org.telegram.ui.Cells.d9.class}, null, null, null, i14));
        int i15 = org.telegram.ui.ActionBar.j6.G6;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36954c0, 0, new Class[]{org.telegram.ui.Cells.d9.class}, new String[]{"textView"}, null, null, -1, null, i15));
        int i16 = org.telegram.ui.ActionBar.j6.f19264z6;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36954c0, 0, new Class[]{org.telegram.ui.Cells.d9.class}, new String[]{"valueTextView"}, null, null, -1, null, i16));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36954c0, 268435456, new Class[]{org.telegram.ui.Cells.ea.class}, null, null, null, i14));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36954c0, 0, new Class[]{org.telegram.ui.Cells.ea.class}, new String[]{"textView"}, null, null, -1, null, i15));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36954c0, 0, new Class[]{org.telegram.ui.Cells.ea.class}, new String[]{"valueTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.I6));
        int i17 = org.telegram.ui.ActionBar.j6.f18827b7;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36954c0, 32, new Class[]{org.telegram.ui.Cells.a7.class}, null, null, null, i17));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36954c0, 268435456, new Class[]{pn0.class}, null, null, null, i14));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36954c0, 4, new Class[]{pn0.class}, new String[]{"textView"}, null, null, -1, null, i15));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36954c0, 4, new Class[]{pn0.class}, null, null, null, org.telegram.ui.ActionBar.j6.f18864d7));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36954c0, 4, new Class[]{pn0.class}, new String[]{"valueTextView"}, null, null, -1, null, i16));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36954c0, 8, new Class[]{pn0.class}, new String[]{"checkImageView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.Mh));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36954c0, 16, new Class[]{org.telegram.ui.Cells.l4.class}, null, null, null, i14));
        int i18 = org.telegram.ui.ActionBar.j6.L6;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36954c0, 0, new Class[]{org.telegram.ui.Cells.l4.class}, new String[]{"textView"}, null, null, -1, null, i18));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36954c0, 32, new Class[]{org.telegram.ui.Cells.e9.class}, null, null, null, i17));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36954c0, 0, new Class[]{org.telegram.ui.Cells.e9.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.B6));
        if (this.Y != null) {
            int i19 = 0;
            while (true) {
                EditTextBoldCursor[] editTextBoldCursorArr = this.Y;
                ...
                arrayList.add(new org.telegram.ui.ActionBar.l6((View) editTextBoldCursorArr[i19].getParent(), 1, null, null, null, null, org.telegram.ui.ActionBar.j6.f18863d6));
                ...
                arrayList.add(new org.telegram.ui.ActionBar.l6(this.Y[i19], 32, null, null, null, null, org.telegram.ui.ActionBar.j6.f18991k6));
                arrayList.add(new org.telegram.ui.ActionBar.l6(this.Y[i19], 65568, null, null, null, null, org.telegram.ui.ActionBar.j6.f19009l6));
                arrayList.add(new org.telegram.ui.ActionBar.l6(this.Y[i19], 2080, null, null, null, null, org.telegram.ui.ActionBar.j6.f19083p7));
                i19++;
            }
        } else {
            ...
            arrayList.add(new org.telegram.ui.ActionBar.l6(null, 32, null, null, null, null, org.telegram.ui.ActionBar.j6.f18991k6));
            arrayList.add(new org.telegram.ui.ActionBar.l6(null, 65568, null, null, null, null, org.telegram.ui.ActionBar.j6.f19009l6));
            arrayList.add(new org.telegram.ui.ActionBar.l6(null, 2080, null, null, null, null, org.telegram.ui.ActionBar.j6.f19083p7));
        }
        if (this.f36948a0 != null) {
            while (true) {
                EditTextBoldCursor[] editTextBoldCursorArr2 = this.f36948a0;
                ...
                arrayList.add(new org.telegram.ui.ActionBar.l6((View) editTextBoldCursorArr2[i11].getParent(), 1, null, null, null, null, org.telegram.ui.ActionBar.j6.f18863d6));
                arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36948a0[i11], 16777220, null, null, null, null, org.telegram.ui.ActionBar.j6.G6));
                arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36948a0[i11], 8388608, null, null, null, null, org.telegram.ui.ActionBar.j6.H6));
                arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36948a0[i11], 8390656, null, null, null, null, org.telegram.ui.ActionBar.j6.L6));
                arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36948a0[i11], 32, null, null, null, null, org.telegram.ui.ActionBar.j6.f18991k6));
                arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36948a0[i11], 65568, null, null, null, null, org.telegram.ui.ActionBar.j6.f19009l6));
                arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36948a0[i11], 2080, null, null, null, null, org.telegram.ui.ActionBar.j6.f19083p7));
                i11++;
            }
        }
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.F0, 2048, null, null, null, null, org.telegram.ui.ActionBar.j6.f18935h6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.K0, 4, null, null, null, null, org.telegram.ui.ActionBar.j6.f19119r6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36997w0, 4, null, null, null, null, org.telegram.ui.ActionBar.j6.G6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.O, 4, null, null, null, null, org.telegram.ui.ActionBar.j6.f19167th));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.Q, 32, null, null, null, null, org.telegram.ui.ActionBar.j6.f19130rh));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.Q, 65568, null, null, null, null, org.telegram.ui.ActionBar.j6.f19149sh));
        org.telegram.ui.Components.tq tqVar = this.N;
        ...
        int i23 = org.telegram.ui.ActionBar.j6.f19264z6;
    ...
    public final byte[] i1(byte[] bArr, byte[] bArr2) {
        ...
        byte[] bArr3 = new byte[32];
        System.arraycopy(this.f36959e1, 0, bArr3, 0, 32);
        byte[] bArr4 = new byte[16];
        System.arraycopy(this.f36959e1, 32, bArr4, 0, 16);
        byte[] bArr5 = new byte[32];
        System.arraycopy(this.f36955c1, 0, bArr5, 0, 32);
            ...
            public final void run(TLObject tLObject, final TLRPC.TL_error tL_error) {
                ...
                AndroidUtilities.runOnUIThread(new Runnable() {
                    ...
                    public final void run() {
                        ...
                        int i11 = 0;
                        if (qn0Var2.f36950b == 8) {
                            pn0 pn0Var = (pn0) qn0Var2.f36983q1.remove(tL_secureRequiredType6);
                            if (pn0Var != null) {
                                qn0Var2.f36954c0.removeView(pn0Var);
                                View childAt = qn0Var2.f36954c0.getChildAt(linearLayout.getChildCount() - 6);
                                    ...
                                    if (i12 < size) {
                                        ...
                                        if (r12 != null) {
                                            ...
                                            if (tL_secureData2 != null) {
                                                str2 = qn0.h1(tL_secureData2.data, qn0Var2.i1(tL_secureData2.secret, tL_secureData2.data_hash), r12.data.data_hash);
                                            } else {
                                                str2 = null;
                                            }
                                            str = str2;
                            ...
                            if (z15) {
                                ...
                                qn0Var2.L1(tL_secureRequiredType6, null, null, tL_secureRequiredType5, str, z14, i11);
                            } else {
                                ...
                                if (r13 != null && (tL_secureData = r13.data) != null) {
                                    str3 = qn0.h1(tL_secureData.data, qn0Var2.i1(tL_secureData.secret, tL_secureData.data_hash), r13.data.data_hash);
                                }
                                if (arrayList3 != null) {
                                    i10 = arrayList3.size();
                                } else {
                                ...
                                qn0Var2.L1(tL_secureRequiredType6, null, str3, tL_secureRequiredType8, str4, z14, i10);
                            }
                        }
    ...
    public final cf.c k1(byte[] bArr) {
        ...
        byte[] bArr6 = new byte[32];
        System.arraycopy(this.f36959e1, 0, bArr6, 0, 32);
        byte[] bArr7 = new byte[16];
        System.arraycopy(this.f36959e1, 32, bArr7, 0, 16);
        byte[] bArr8 = new byte[32];
        System.arraycopy(this.f36955c1, 0, bArr8, 0, 32);
        Utilities.aesCbcEncryptionByteArraySafe(bArr8, bArr6, bArr7, 0, 32, 0, 0);
    ...
    public final String m1() {
        ...
        int size = arrayList.size();
        for (int i12 = 0; i12 < size; i12++) {
            sb2.append(((SecureDocument) arrayList.get(i12)).secureFile.f18256id);
        }
        SecureDocument secureDocument = this.l1;
        if (secureDocument != null) {
            sb2.append(secureDocument.secureFile.f18256id);
        }
        SecureDocument secureDocument2 = this.f36974m1;
        if (secureDocument2 != null) {
            sb2.append(secureDocument2.secureFile.f18256id);
        }
        SecureDocument secureDocument3 = this.f36970j1;
        if (secureDocument3 != null) {
            sb2.append(secureDocument3.secureFile.f18256id);
        }
        ArrayList arrayList2 = this.f36972k1;
        int size2 = arrayList2.size();
        for (int i13 = 0; i13 < size2; i13++) {
            sb2.append(((SecureDocument) arrayList2.get(i13)).secureFile.f18256id);
        }
        return sb2.toString();
    }
    ...
    public final void onActivityResultFragment(int i10, int i11, Intent intent) {
        if (i11 == -1) {
            ...
            org.telegram.ui.Components.vi viVar = this.R0;
            if (viVar != null) {
                viVar.f28757j0.g0(i10, intent, this.Q0);
            }
            this.Q0 = null;
        }
    }
    ...
    public final void onDialogDismiss(Dialog dialog) {
        if (this.f36950b == 3 && Build.VERSION.SDK_INT >= 23 && dialog == this.L1) {
    ...
    public final void onRequestPermissionsResultFragment(int i10, String[] strArr, int[] iArr) {
        ...
        if ((i11 == 1 || i11 == 2) && (viVar = this.R0) != null) {
            if (i10 == 17) {
                ...
                F1(0);
            } else if (i10 == 22 && iArr != null && iArr.length > 0 && iArr[0] == 0 && (eaVar = this.f36985r0) != null) {
                eaVar.callOnClick();
            }
        } else if (i11 == 3 && i10 == 6) {
    ...
    public final void onResume() {
        ...
        if (this.f36950b == 5 && (viewGroupArr = this.Z) != null && (viewGroup = viewGroupArr[0]) != null && viewGroup.getVisibility() == 0) {
    ...
    public final TLRPC.TL_secureValue r1(TLRPC.TL_secureRequiredType tL_secureRequiredType, boolean z10) {
        ...
        if (tL_secureRequiredType != null) {
            int size = this.f37002y.values.size();
            for (int i10 = 0; i10 < size; i10++) {
                TLRPC.TL_secureValue tL_secureValue = this.f37002y.values.get(i10);
    ...
    public final boolean s1(Class cls) {
        int size = this.f37002y.values.size();
        for (int i10 = 0; i10 < size; i10++) {
            if (this.f37002y.values.get(i10).type.getClass() == cls) {
                return false;
            }
        }
        return true;
    ...
    public qn0(int i10, long j3, String str, String str2, String str3, String str4, String str5, TL_account.authorizationForm authorizationform, TL_account.Password password) {
        ...
        try {
            ...
            while (i12 < size) {
                ...
                HashMap hashMap = (HashMap) this.f36993u1.get(o12);
                if (hashMap == null) {
                    hashMap = new HashMap();
                    i11 = size;
                    this.f36993u1.put(o12, hashMap);
                    this.f36995v1.put(o12, str6);
                } else {
                    i11 = size;
                }
                if (bArr != null) {
