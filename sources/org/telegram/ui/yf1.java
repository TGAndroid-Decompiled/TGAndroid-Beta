...
public final class yf1 extends org.telegram.ui.Components.xl0 {
    ...
    @Override
    public final int h() {
        bg1 bg1Var = this.f39924c;
        if (bg1Var.m0) {
            return 0;
        }
        return bg1Var.f32469l0;
    }

    @Override
    public final int j(int i10) {
        bg1 bg1Var = this.f39924c;
        if (i10 != bg1Var.f32466i0 && i10 != bg1Var.f32463f0) {
            if (i10 >= bg1Var.f32464g0 && i10 < bg1Var.f32465h0) {
                return 2;
            }
            if (i10 >= bg1Var.f32467j0 && i10 < bg1Var.f32468k0) {
                return 3;
            }
            return 0;
        }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (j(i10) == 2) {
            ...
            taVar.setTopic((TLRPC.TL_forumTopic) bg1Var.f32461d0.get(i10 - bg1Var.f32464g0));
            if (i10 != bg1Var.f32465h0 - 1) {
                z10 = true;
            } else {
                z10 = false;
            }
        ...
        if (j(i10) == 3) {
            MessageObject messageObject = (MessageObject) bg1Var.f32462e0.get(i10 - bg1Var.f32467j0);
            cg1 cg1Var = (cg1) view;
            if (i10 != bg1Var.f32468k0 - 1) {
                z11 = true;
            }
            cg1Var.W4 = z11;
            ...
            TLRPC.TL_forumTopic findTopic = fg1Var.f33656s.findTopic(fg1Var.f33621a, topicId);
            if (findTopic == null) {
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        boolean z10;
        fg1 fg1Var = this.f39924c.f32477u0;
        if (i10 != 1) {
            if (i10 != 2) {
                if (i10 == 3) {
