...
public final class se0 implements RequestDelegate {
    ...
    public final ze0 f37476b;
    public final TLRPC.TL_auth_signIn f37477c;

    public se0(ze0 ze0Var, TLRPC.TL_auth_signIn tL_auth_signIn, int i10) {
        this.f37475a = i10;
        this.f37476b = ze0Var;
        this.f37477c = tL_auth_signIn;
    }
    ...
    public final void run(final TLObject tLObject, final TLRPC.TL_error tL_error) {
        switch (this.f37475a) {
            case 0:
                final ze0 ze0Var = this.f37476b;
                final TLRPC.TL_auth_signIn tL_auth_signIn = this.f37477c;
                AndroidUtilities.runOnUIThread(new Runnable() {
                    ...
                    public final void run() {
                        ...
                        switch (r5) {
                            case 0:
                                ze0 ze0Var2 = ze0Var;
                                int i11 = ze0Var2.f40227a;
                                ci.h2 h2Var = ze0Var2.f40230c;
                                yg0 yg0Var = ze0Var2.f40228a0;
                ...
                return;
            default:
                final ze0 ze0Var2 = this.f37476b;
                final TLRPC.TL_auth_signIn tL_auth_signIn2 = this.f37477c;
                AndroidUtilities.runOnUIThread(new Runnable() {
                    @Override
                    public final void run() {
                        int i10;
                        switch (r5) {
                            case 0:
                                ...
                                int i11 = ze0Var22.f40227a;
                                ci.h2 h2Var = ze0Var22.f40230c;
                                yg0 yg0Var = ze0Var22.f40228a0;
                                yg0Var.k1(false, true);
                                TLRPC.TL_error tL_error2 = tL_error;
