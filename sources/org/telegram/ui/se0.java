...
public final class se0 extends org.telegram.ui.Components.uv0 {
    ...
    public final rg0 f37253a0;
    public final org.telegram.ui.Components.yc0 f37254b;
    public final ci.h2 f37255c;
    public final org.telegram.ui.Components.voip.n2 d;
    public final TextView e;
    public final TextView f37256f;
    public final org.telegram.ui.Components.bj0 h;
    public final TextView f37257n;
    public final TextView f37258r;
    public final TextView f37259s;
    public final sf0 v;
    public boolean f37260w;
    public boolean f37261x;
    public boolean f37262y;

    public se0(org.telegram.ui.rg0 r28, android.content.Context r29, int r30) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.se0.<init>(org.telegram.ui.rg0, android.content.Context, int):void");
    }
    ...
    public final void h(String str) {
        ...
        String obj = this.f37255c.getText().toString();
        if (obj.length() == 0) {
            s(false);
        } else if (!p(obj)) {
            s(true);
    ...
    @Override
    public final void j() {
        AndroidUtilities.runOnUIThread(new pe0(this, 3), rg0.f36817t0);
    }

    @Override
    public final void k(Bundle bundle) {
        Bundle bundle2 = bundle.getBundle("recoveryview_word" + this.f37252a);
        this.L = bundle2;
        if (bundle2 != null) {
            m(bundle2, true);
        }
    ...
    public final void l(Bundle bundle) {
        if (this.L != null) {
            bundle.putBundle("recoveryview_word" + this.f37252a, this.L);
        }
    }
    ...
    public final void m(Bundle bundle, boolean z10) {
        ...
        if (bundle == null) {
            if (this.S != null && this.T != null) {
                ...
                sf0Var.setText(AndroidUtilities.replaceArrows(LocaleController.getString(i12), true, AndroidUtilities.dp(1.0f), AndroidUtilities.dp(1.0f)));
                return;
            }
            return;
        }
        ci.h2 h2Var = this.f37255c;
        h2Var.setText("");
        this.L = bundle;
        this.K = null;
        ...
        String str2 = this.K;
        TextView textView = this.f37258r;
        if (str2 == null) {
            if (!z11) {
            ...
            org.telegram.messenger.ul.q(i11, new Object[]{str}, textView);
        } else {
            if (!z11) {
            ...
            org.telegram.messenger.ul.q(i10, new Object[]{str, str2}, textView);
        }
        rg0.T0(rg0Var, h2Var);
        h2Var.requestFocus();
        ...
        sf0Var.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, i15, false));
        int i16 = this.E;
        if (i16 != 2 && i16 != 4 && i16 != 3) {
            ...
            sf0Var.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, i15, false));
            sf0Var.setTag(R.id.color_key_tag, Integer.valueOf(i15));
    ...
    public final void n() {
        ...
        rg0 rg0Var = this.f37253a0;
        this.f37257n.setTextColor(rg0Var.getThemedColor(i10));
        this.f37258r.setTextColor(rg0Var.getThemedColor(org.telegram.ui.ActionBar.h6.D6));
        int themedColor = rg0Var.getThemedColor(i10);
        ci.h2 h2Var = this.f37255c;
        h2Var.setTextColor(themedColor);
        h2Var.setCursorColor(rg0Var.getThemedColor(org.telegram.ui.ActionBar.h6.f18934l6));
    ...
    public final void o(boolean z10) {
        ...
        if (this.f37260w && !this.f37261x) {
            f10 = 1.0f;
        }
        float f13 = (0.1f * f10) + 0.9f;
        ViewPropertyAnimator alpha = this.f37256f.animate().scaleX(f13).scaleY(f13).alpha(f10);
        float f14 = 1.0f - f10;
        if (this.f37261x) {
            f12 = 5.0f;
        }
    ...
    public final void q(boolean z10) {
        ...
        if (TextUtils.isEmpty(this.f37255c.getText()) && clipboardManager != null && clipboardManager.hasPrimaryClip()) {
            z11 = true;
        } else {
            z11 = false;
        }
        if (this.f37260w != z11) {
            ...
            float f16 = 0.9f;
            float f17 = 0.7f;
            TextView textView = this.f37259s;
            TextView textView2 = this.f37256f;
            float f18 = 0.0f;
            float f19 = 1.0f;
            if (z10) {
                ...
                ViewPropertyAnimator alpha2 = scaleX2.scaleY(f16).alpha((!this.f37260w || this.f37261x) ? 0.0f : 0.0f);
                if (!this.f37260w || this.f37261x) {
                    if (this.f37261x) {
                        f15 = 5.0f;
                    }
                ...
                textView2.setAlpha((!this.f37260w || this.f37261x) ? 0.0f : 0.0f);
                if (!this.f37260w || this.f37261x) {
                    if (this.f37261x) {
                        f15 = 5.0f;
                    }
    ...
    public final void s(boolean z10) {
        ...
        int i11;
        ci.h2 h2Var = this.f37255c;
        if (this.f37253a0.getParentActivity() == null) {
            return;
        }
        try {
