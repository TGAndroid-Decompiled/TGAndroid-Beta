...
public final class fu extends org.telegram.ui.Components.ll0 {
    ...
    public final int j(int i10) {
        ...
        if (i10 == dataAutoDownloadActivity.f30746s) {
            return 1;
        }
        if (i10 != dataAutoDownloadActivity.f30745r && i10 != dataAutoDownloadActivity.v) {
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        int i23;
        DataAutoDownloadActivity dataAutoDownloadActivity = this.d;
        int i24 = dataAutoDownloadActivity.f30743f;
        DownloadController.Preset preset = dataAutoDownloadActivity.G;
        int i25 = c1Var.f42630f;
        ...
        if (i25 != 0) {
                ...
                if (i25 != 3) {
                    ...
                    if (i25 != 4) {
                        if (i25 == 5) {
                            ...
                            if (i10 == dataAutoDownloadActivity.f30747w) {
                                f9Var.setText(LocaleController.getString(R.string.AutoDownloadAudioInfo));
                                f9Var.setFixedSize(0);
                                f9Var.setImportantForAccessibility(1);
                                return;
                            } else if (i10 == dataAutoDownloadActivity.f30744n) {
                                if (dataAutoDownloadActivity.f30745r == -1) {
                                    if (i24 == 0) {
            ...
            if (i10 == dataAutoDownloadActivity.f30745r) {
        ...
        if (i10 == i11) {
            ...
            if (preset.enabled) {
                i12 = org.telegram.ui.ActionBar.h6.f18825f6;
            } else {
                i12 = org.telegram.ui.ActionBar.h6.f18808e6;
            }
            x8Var.setTag(Integer.valueOf(i12));
            if (preset.enabled) {
                i13 = org.telegram.ui.ActionBar.h6.f18825f6;
            } else {
                i13 = org.telegram.ui.ActionBar.h6.f18808e6;
            }
            ...
            if (i10 != 1) {
                if (i10 != 2) {
                    if (i10 != 3) {
                        ...
                        tv0Var2.setCallback(new eu(this, 0));
                        tv0Var = tv0Var2;
                    }
                } else {
