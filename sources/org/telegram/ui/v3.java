...
public final class v3 implements org.telegram.ui.ActionBar.i2, org.telegram.ui.ActionBar.s3 {
    ...
    public boolean J;
    public final i4 K;
    public final AnimationNotificationsLocker f38619a = new AnimationNotificationsLocker();
    public org.telegram.ui.ActionBar.m2 f38620b;
    public final u3 f38621c;
    public View d;
    public org.telegram.ui.ActionBar.h3 e;
    public boolean f38622f;
    public boolean h;
    public boolean f38623n;
    public boolean f38624r;
    public boolean f38625s;
    public ai.d5 v;
    public float f38626w;
    public float f38627x;
    public ValueAnimator f38628y;
    ...
    public final org.telegram.ui.ActionBar.l3 a() {
        ...
        i4 i4Var = this.K;
        l3Var.E = i4Var.f34396h0.getTitle();
        l3Var.J = i4Var;
        ...
        if (!this.F) {
            ...
            progress = i4Var.f34408u0[0].getProgress();
        }
        l3Var.I = progress;
        m3 m3Var3 = i4Var.f34408u0[0];
        l3Var.f19600c = m3Var3;
        if (m3Var3 != null && m3Var3.getWebView() != null) {
            bitmap = i4Var.f34408u0[0].getWebView().getFavicon();
        }
        l3Var.F = bitmap;
        m3 m3Var4 = l3Var.f19600c;
        if (m3Var4 != null) {
            l3Var.f19602g = m3Var4.getWidth();
            l3Var.h = l3Var.f19600c.getHeight();
        }
        l3Var.f19603i = l();
    ...
    public final boolean attachedToParent() {
        return this.f38621c.isAttachedToWindow();
    }
    ...
    public final void f() {
        ValueAnimator valueAnimator = this.f38628y;
        if (valueAnimator != null) {
            valueAnimator.cancel();
        }
        ValueAnimator ofFloat = ValueAnimator.ofFloat(this.f38626w, 1.0f);
        this.f38628y = ofFloat;
        ofFloat.addUpdateListener(new s3(this, 1));
        this.f38628y.addListener(new ai.b(this, 28));
        this.f38628y.setInterpolator(org.telegram.ui.Components.rr.h);
        this.f38628y.setDuration(320L);
        this.f38628y.start();
    }
    ...
    public final int getNavigationBarColor(int i10) {
        ...
        if (this.f38623n) {
            ...
            min = Math.min(this.f38626w, 1.0f - this.f38627x) * (1.0f - this.I);
        }
        int j3 = j();
        l0 l0Var = this.K.f34396h0;
        if (l0Var != null) {
            j3 = i0.a.d(l0Var.f39228a0, j3, l0Var.f39257x);
        }
    ...
    public final void h() {
        if (this.f38625s != isFullyVisible()) {
            this.f38625s = isFullyVisible();
            org.telegram.ui.ActionBar.m2 m2Var = this.f38620b;
            if (m2Var != null && (m2Var.getParentLayout() instanceof ActionBarLayout)) {
                ActionBarLayout actionBarLayout = (ActionBarLayout) this.f38620b.getParentLayout();
                org.telegram.ui.ActionBar.v vVar = actionBarLayout.f18640s;
                if (vVar != null) {
                    vVar.invalidate();
                }
                org.telegram.ui.ActionBar.v vVar2 = actionBarLayout.f18645w;
                if (vVar2 != null) {
                    vVar2.invalidate();
                    return;
                }
    ...
    public final void i() {
        ...
        boolean z10 = false;
        if (h3Var2 != null) {
            int navigationBarColor = h3Var2.f18959a.getNavigationBarColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19004a7, false));
            h3Var2.d.setColor(navigationBarColor);
            h3Var2.f18961c.invalidate();
        ...
        LaunchActivity.G1.H(true, true, true);
        if (AndroidUtilities.computePerceivedBrightness(getNavigationBarColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19004a7, false))) >= 0.721f) {
            z10 = true;
        }
    ...
    public final boolean isAttachedLightStatusBar() {
        ...
        if (this.f38623n) {
            ...
            min = (1.0f - this.I) * Math.min(this.f38626w, 1.0f - this.f38627x);
        }
        if (this.F && min > 0.25f) {
            if (!SharedConfig.adaptableColorInBrowser) {
                ...
                i4 i4Var = this.K;
                if (i4Var.f34408u0[0].getVisibility() == 0) {
                    f7 = 1.0f - (i4Var.f34408u0[0].getTranslationX() / i4Var.f34408u0[0].getWidth());
                }
                d = i0.a.d(1.0f - f7, i4Var.f34408u0[0].getActionBarColor(), i4Var.f34408u0[1].getActionBarColor());
            }
    ...
    public final boolean isFullyVisible() {
        if (this.G && this.f38627x <= 0.0f && this.f38626w >= 1.0f && this.I <= 0.0f && !this.f38623n && !this.h) {
            return true;
        }
        return false;
    }
    ...
    public final boolean isShown() {
        u3 u3Var;
        if (this.h || this.f38624r || this.f38626w <= 0.5f || (u3Var = this.f38621c) == null || !u3Var.isAttachedToWindow() || AndroidUtilities.lerp(u3Var.H0.l() - AndroidUtilities.dp(20.0f), 0, Utilities.clamp01(u3Var.A0.f23845c)) >= u3Var.getHeight() || this.I >= 1.0f) {
            return false;
        }
        return true;
    }
    ...
    public final int j() {
        ...
        if (i4Var.f34408u0[0].getVisibility() != 0) {
            ...
            translationX = 1.0f - (i4Var.f34408u0[0].getTranslationX() / i4Var.f34408u0[0].getWidth());
        }
        return i0.a.d(1.0f - translationX, i4Var.f34408u0[0].getBackgroundColor(), i4Var.f34408u0[1].getBackgroundColor());
    }
    ...
    public final int l() {
        ...
        if (m3Var2 != null && m3Var2.getVisibility() == 0) {
            i10 = (int) (i4Var.f34408u0[0].getAlpha() * i4Var.f34408u0[0].getListTop() * f7);
        }
        m3 m3Var3 = i4Var.f34408u0[1];
        if (m3Var3 != null && m3Var3.getVisibility() == 0) {
            return i10 + ((int) (i4Var.f34408u0[1].getAlpha() * i4Var.f34408u0[1].getListTop() * f10));
        }
        return i10;
    }
    ...
    public final void m() {
        i4 i4Var = this.K;
        i4Var.f34408u0[0].setLastVisible(this.J);
        i4Var.f34408u0[1].setLastVisible(false);
    }
    ...
    public final boolean onAttachedBackPressed() {
        i4 i4Var = this.K;
        if (i4Var.f34402o0) {
            AndroidUtilities.hideKeyboard(this.f38621c);
            return true;
        }
    ...
    public final void release() {
        ...
        if (m2Var != null) {
            ...
            if (this.e == null) {
                AndroidUtilities.removeFromParent(this.f38621c);
            }
        }
        ai.d5 d5Var = this.v;
        if (d5Var != null) {
    ...
    public final void setLastVisible(boolean z10) {
        this.J = z10;
        i4 i4Var = this.K;
        i4Var.f34408u0[0].setLastVisible(z10);
        i4Var.f34408u0[1].setLastVisible(false);
    }
