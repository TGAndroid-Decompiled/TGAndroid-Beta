...
public final class v3 implements org.telegram.ui.ActionBar.i2, org.telegram.ui.ActionBar.s3 {
    ...
    public final void f() {
        ...
        this.f38627y.setInterpolator(org.telegram.ui.Components.rr.h);
    ...
    public final boolean isShown() {
        u3 u3Var;
        if (this.h || this.f38623r || this.f38625w <= 0.5f || (u3Var = this.f38620c) == null || !u3Var.isAttachedToWindow() || AndroidUtilities.lerp(u3Var.H0.l() - AndroidUtilities.dp(20.0f), 0, Utilities.clamp01(u3Var.A0.f23844c)) >= u3Var.getHeight() || this.I >= 1.0f) {
            return false;
        }
        return true;
    }
