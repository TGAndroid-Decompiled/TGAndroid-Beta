...
public abstract class c21 extends org.telegram.ui.Components.ea implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final f01 G;
    public final bi.a h;
    public final org.telegram.ui.Components.h81 f32636n;
    public final ai.x8 f32637r;
    public final b21 f32638s;
    public int v;
    public boolean f32639w;
    public ValueAnimator f32640x;
    public float f32641y;
    ...
    public c21(Context context, org.telegram.ui.Components.pv0 pv0Var, ai.x8 x8Var, final org.telegram.ui.Components.rr0 rr0Var) {
        ...
        int i14 = org.telegram.ui.ActionBar.i6.f19110s8;
        n10.P = i10;
        n10.Q = i11;
        n10.R = i12;
        n10.S = i13;
        n10.T = i14;
        n10.O.setColor(org.telegram.ui.ActionBar.i6.v0(i10, n10.f24604j0));
        n10.f24612r = 12;
                ...
                switch (r3) {
                    case 0:
                        ...
                        if (num.intValue() == -1) {
                            ...
                            org.telegram.ui.Components.c5.S(rr0Var2.f27665a, rr0Var2.f27666b, rr0Var2.f27667c, new org.telegram.ui.Components.lv(rr0Var2, 19));
                            return Boolean.TRUE;
                        }
                        return Boolean.FALSE;
                    default:
                        View view = (View) obj2;
                        if (num.intValue() != -1 && num.intValue() != 0 && !tr0Var.f32639w) {
                            ...
                            if (storiesController.i(yu0Var.f30364j1)) {
                                    ...
                                    public final void run() {
                                        switch (r3) {
                                            case 0:
                                                ...
                                                yu0Var2.O0(yu0Var2.f30389v1, yu0Var2.f30364j1, intValue);
                                                return;
                                            case 1:
                                                yu0 yu0Var3 = rr0Var3.d;
                                                yu0Var3.Q0(yu0Var3.f30389v1, yu0Var3.f30364j1, intValue);
                                                return;
                                            case 2:
                                            ...
                                            default:
                                                ...
                                                yu0Var4.P0(yu0Var4.f30389v1, yu0Var4.f30364j1, intValue);
                                                return;
                                        }
                                    }
                                }, false);
                                yu0Var.x(H, n2Var, yu0Var.f30364j1, intValue);
    ...
    public final void b(boolean z10, boolean z11, boolean z12) {
        ...
        this.E = z10;
        setEnabled(z10);
        ValueAnimator valueAnimator = this.f32640x;
        ...
        float f10 = this.f32641y;
        if (z10) {
            f7 = 1.0f;
        }
        ValueAnimator ofFloat = ValueAnimator.ofFloat(f10, f7);
        this.f32640x = ofFloat;
        ofFloat.setDuration(480L);
        this.f32640x.setInterpolator(org.telegram.ui.Components.qr.h);
        this.f32640x.addUpdateListener(new a21(this, 0));
        this.f32640x.start();
    }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.storyAlbumsCollectionsUpdate) {
            ...
            ai.x8 x8Var = this.f32637r;
            if (longValue == x8Var.f1701b) {
                org.telegram.ui.Components.h81 h81Var = this.f32636n;
                if (h81Var != null) {
                ...
                } else if (h81Var != null && i12 > 0 && x8Var.b(i12) == null) {
                    h81Var.d(0, 0);
                }
            }
        }
    ...
    public int getCurrentAlbumId() {
        return this.f32638s.f(this.f32636n.getCurrentPosition());
    }
    ...
    public float getVisualHeight() {
        return getMeasuredHeight() * this.f32641y;
    }

    @Override
    public final void onAttachedToWindow() {
        super.onAttachedToWindow();
        NotificationCenter.getInstance(this.f32637r.f1700a).addObserver(this, NotificationCenter.storyAlbumsCollectionsUpdate);
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        NotificationCenter.getInstance(this.f32637r.f1700a).removeObserver(this, NotificationCenter.storyAlbumsCollectionsUpdate);
    }
