...
public abstract class c21 extends org.telegram.ui.Components.ea implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final g01 G;
    public final bi.a h;
    public final org.telegram.ui.Components.i81 f32649n;
    public final ai.x8 f32650r;
    public final b21 f32651s;
    public int v;
    public boolean f32652w;
    public ValueAnimator f32653x;
    public float f32654y;
    ...
    public c21(Context context, org.telegram.ui.Components.qv0 qv0Var, ai.x8 x8Var, final org.telegram.ui.Components.sr0 sr0Var) {
        ...
        int i14 = org.telegram.ui.ActionBar.j6.f19140s8;
        n10.P = i10;
        n10.Q = i11;
        n10.R = i12;
        n10.S = i13;
        n10.T = i14;
        n10.O.setColor(org.telegram.ui.ActionBar.j6.v0(i10, n10.f24886j0));
        n10.f24894r = 12;
                ...
                switch (r3) {
                    case 0:
                        ...
                        if (num.intValue() == -1) {
                            ...
                            org.telegram.ui.Components.c5.S(sr0Var2.f27913a, sr0Var2.f27914b, sr0Var2.f27915c, new org.telegram.ui.Components.lv(sr0Var2, 19));
                            return Boolean.TRUE;
                        }
                        return Boolean.FALSE;
                    default:
                        View view = (View) obj2;
                        if (num.intValue() != -1 && num.intValue() != 0 && !ur0Var.f32652w) {
                            ...
                            if (storiesController.i(zu0Var.f30634j1)) {
                                    ...
                                    public final void run() {
                                        switch (r3) {
                                            case 0:
                                                ...
                                                zu0Var2.O0(zu0Var2.f30659v1, zu0Var2.f30634j1, intValue);
                                                return;
                                            case 1:
                                                zu0 zu0Var3 = sr0Var3.d;
                                                zu0Var3.Q0(zu0Var3.f30659v1, zu0Var3.f30634j1, intValue);
                                                return;
                                            case 2:
                                            ...
                                            default:
                                                ...
                                                zu0Var4.P0(zu0Var4.f30659v1, zu0Var4.f30634j1, intValue);
                                                return;
                                        }
                                    }
                                }, false);
                                zu0Var.x(H, o2Var, zu0Var.f30634j1, intValue);
    ...
    public final void b(boolean z10, boolean z11, boolean z12) {
        ...
        this.E = z10;
        setEnabled(z10);
        ValueAnimator valueAnimator = this.f32653x;
        ...
        float f10 = this.f32654y;
        if (z10) {
            f7 = 1.0f;
        }
        ValueAnimator ofFloat = ValueAnimator.ofFloat(f10, f7);
        this.f32653x = ofFloat;
        ofFloat.setDuration(480L);
        this.f32653x.setInterpolator(org.telegram.ui.Components.qr.h);
        this.f32653x.addUpdateListener(new b3(this, 29));
        this.f32653x.start();
    }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.storyAlbumsCollectionsUpdate) {
            ...
            ai.x8 x8Var = this.f32650r;
            if (longValue == x8Var.f1704b) {
                org.telegram.ui.Components.i81 i81Var = this.f32649n;
                if (i81Var != null) {
    ...
    public int getCurrentAlbumId() {
        return this.f32651s.f(this.f32649n.getCurrentPosition());
    }
    ...
    public float getVisualHeight() {
        return getMeasuredHeight() * this.f32654y;
    }

    @Override
    public final void onAttachedToWindow() {
        super.onAttachedToWindow();
        NotificationCenter.getInstance(this.f32650r.f1703a).addObserver(this, NotificationCenter.storyAlbumsCollectionsUpdate);
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        NotificationCenter.getInstance(this.f32650r.f1703a).removeObserver(this, NotificationCenter.storyAlbumsCollectionsUpdate);
    }
