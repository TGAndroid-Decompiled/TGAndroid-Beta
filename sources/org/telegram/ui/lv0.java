            ...
            if (tv0Var.f37773d0) {
                ...
                for (int i20 = 0; i20 < charSequenceArr.length; i20++) {
                    if (!TextUtils.isEmpty(org.telegram.ui.Components.vn.Y(charSequenceArr[i20]))) {
                        ...
                        int[] iArr2 = tv0Var.f37788r;
                        if (iArr2 != null && i20 < iArr2.length) {
                            todoItem.f18228id = iArr2[i20];
                        } else {
                            i15++;
                            todoItem.f18228id = i15;
                        }
                ...
                tv0Var.f37774e0.a(tL_messageMediaToDo);
                tv0Var.finishFragment();
            } else if (!tv0Var.L || tv0Var.f37767a.getAlpha() == 1.0f) {
                ...
                ArrayList arrayList = new ArrayList(tv0Var.f37783n);
                int i23 = 0;
                ...
                tv0Var.f37774e0.a(tL_messageMediaPoll);
                tv0Var.finishFragment();
            } else {
                int i25 = 0;
                ...
                if (i25 <= 0) {
                    ...
                    for (int i26 = tv0Var.f37784n0; i26 < tv0Var.f37784n0 + tv0Var.f37799y; i26++) {
                        s4.c1 K = tv0Var.f37771c.K(i26);
                        if (K != null) {
                            View view = K.f42627a;
