...
public final class z10 extends og.a {
    ...
    public final boolean equals(Object obj) {
        ...
        z10 z10Var = (z10) obj;
        int i10 = z10Var.f15508a;
        int i11 = this.f15508a;
        if (i10 != i11) {
            return false;
        }
        if ((i11 == 0 || i11 == 4 || i11 == 3 || i11 == 6) && !TextUtils.equals(this.f39934c, z10Var.f39934c)) {
            return false;
        }
        ...
        if (i12 == 2) {
            ...
            if (dialogFilter != null && dialogFilter.f15577id != dialogFilter2.f15577id) {
                return false;
            }
        }
        if (i12 == 5) {
            ...
            if (tL_dialogFilterSuggested != null && tL_dialogFilterSuggested.filter.f18088id != tL_dialogFilterSuggested2.filter.f18088id) {
                return false;
            }
        }
        return true;
