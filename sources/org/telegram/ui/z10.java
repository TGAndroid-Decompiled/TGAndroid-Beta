...
public final class z10 extends FrameLayout {
    ...
    public final org.telegram.ui.ActionBar.j5 f40034a;
    public final TextView f40035b;
    public final ImageView f40036c;
    public int d;
    public int e;
    public final View f40037f;
    public final ImageView h;
    public final org.telegram.ui.Components.j30 f40038n;
    public boolean f40039r;
    public final org.telegram.ui.Components.g90 f40040s;
    public boolean v;
    public float f40041w;
    public MessagesController.DialogFilter f40042x;
    public ValueAnimator f40043y;
    ...
    public z10(FiltersSetupActivity filtersSetupActivity, Context context) {
        ...
        textView.setTextColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f19237z6, false));
        ...
        g90Var.C = true;
        g90Var.f24277t = 2.0f;
        int i22 = org.telegram.ui.ActionBar.i6.f18926i6;
        ...
        g90Var.f24279w.setStrokeWidth(dp);
        g90Var.j(40.0f);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        MessagesController.DialogFilter dialogFilter = this.f40042x;
        if (dialogFilter != null) {
            boolean z10 = dialogFilter.locked;
            if (z10) {
                float f7 = this.f40041w;
                if (f7 != 1.0f) {
                    this.f40041w = f7 + 0.10666667f;
                    invalidate();
                }
            }
            if (!z10) {
                float f10 = this.f40041w;
                if (f10 != 0.0f) {
                    this.f40041w = f10 - 0.10666667f;
                    invalidate();
                }
            }
        }
        float clamp = Utilities.clamp(this.f40041w, 1.0f, 0.0f);
        this.f40041w = clamp;
        org.telegram.ui.ActionBar.j5 j5Var = this.f40034a;
    ...
    public void setOnReorderButtonTouchListener(View.OnTouchListener onTouchListener) {
        this.f40036c.setOnTouchListener(onTouchListener);
    }
}
