...
public final class z10 extends og.b {
    ...
    public final int j(int i10) {
        ...
        if (i10 >= 0) {
            ...
            if (i10 >= filtersSetupActivity.f31075n.size() || (x10Var = (x10) filtersSetupActivity.f31075n.get(i10)) == null) {
                return 3;
            }
            return x10Var.f15700a;
        }
        return 3;
    }
        ...
        if (i10 != 0) {
            if (i10 != 1) {
                if (i10 != 2) {
                    ...
                    if (i10 != 3) {
                        if (i10 != 4) {
                            if (i10 != 6) {
                                ...
                                frameLayout.f31950b = textView2;
                                org.telegram.messenger.ok.t(textView2, org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19447z6, false), 1, 13.0f, 1);
                            ...
                            frameLayout2.f32283a = h5Var;
                            h5Var.setTextSize(16);
                            if (LocaleController.isRTL) {
                                i15 = 5;
                            }
                            h5Var.setGravity(i15);
                            int i16 = org.telegram.ui.ActionBar.h6.f19246o6;
                            ...
                            frameLayout2.f32284b = imageView;
                    ...
                    v10Var2.setBackgroundColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19045d6, false));
                ...
                frameLayout3.f38851a = imageView2;
