...
public final class z10 extends FrameLayout {
    ...
    public final org.telegram.ui.ActionBar.j5 f40007a;
    public final TextView f40008b;
    public final ImageView f40009c;
    public int d;
    public int e;
    public final View f40010f;
    public final ImageView h;
    public final org.telegram.ui.Components.j30 f40011n;
    public boolean f40012r;
    public final org.telegram.ui.Components.g90 f40013s;
    public boolean v;
    public float f40014w;
    public MessagesController.DialogFilter f40015x;
    public ValueAnimator f40016y;
    ...
    public z10(FiltersSetupActivity filtersSetupActivity, Context context) {
        ...
        j5Var.setEmojiColor(org.telegram.ui.ActionBar.i6.v0(i19, e6Var));
        ...
        textView.setTextColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f19234z6, false));
        ...
        g90Var.C = true;
        g90Var.f24274t = 2.0f;
        int i22 = org.telegram.ui.ActionBar.i6.f18923i6;
        ...
        g90Var.f24276w.setStrokeWidth(dp);
        g90Var.j(40.0f);
        ...
        j30Var.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.i6.w0(null, i18, false), mode));
    ...
    public final void onDraw(Canvas canvas) {
        ...
        MessagesController.DialogFilter dialogFilter = this.f40015x;
        if (dialogFilter != null) {
            boolean z10 = dialogFilter.locked;
            if (z10) {
                float f7 = this.f40014w;
                if (f7 != 1.0f) {
                    this.f40014w = f7 + 0.10666667f;
                    invalidate();
                }
            }
            if (!z10) {
                float f10 = this.f40014w;
                if (f10 != 0.0f) {
                    this.f40014w = f10 - 0.10666667f;
                    invalidate();
                }
            }
        }
        float clamp = Utilities.clamp(this.f40014w, 1.0f, 0.0f);
        this.f40014w = clamp;
        org.telegram.ui.ActionBar.j5 j5Var = this.f40007a;
    ...
    public void setOnReorderButtonTouchListener(View.OnTouchListener onTouchListener) {
        this.f40009c.setOnTouchListener(onTouchListener);
    }
}
