...
public final class te implements Runnable {
    ...
    public final co f40749b;
    public final MessageObject f40750c;

    public te(co coVar, MessageObject messageObject, int i10) {
        this.f40748a = i10;
        this.f40749b = coVar;
        this.f40750c = messageObject;
    }
    ...
    public final void run() {
        ...
        switch (this.f40748a) {
            case 0:
                MessageObject messageObject = this.f40750c;
                TLRPC.MessageMedia messageMedia = messageObject.messageOwner.media;
                if (messageMedia != null && (webPage = messageMedia.webpage) != null && webPage.cached_page != null) {
                    LaunchActivity launchActivity = LaunchActivity.G1;
                    if (launchActivity == null || launchActivity.P() == null || LaunchActivity.G1.P().l(messageObject) == null) {
                        this.f40749b.createArticleViewer(false).N(messageObject, null, null, null);
                        return;
                    }
                    return;
                }
                return;
            case 1:
                co coVar = this.f40749b;
                coVar.getClass();
                MessageObject messageObject2 = this.f40750c;
            ...
            case 2:
                int id2 = this.f40750c.getId();
                co coVar2 = this.f40749b;
                coVar2.Xa(id2, 0, true, 0, true, 0, null, null, new ug(coVar2, 13));
                if (coVar2.f35306h6.isEmpty()) {
                    coVar2.Lb(false);
                    return;
                }
                return;
            case 3:
                co coVar3 = this.f40749b;
                coVar3.getClass();
                MessageObject messageObject3 = this.f40750c;
                ...
                return;
            case 4:
                co coVar4 = this.f40749b;
                coVar4.getClass();
                MessageObject messageObject4 = this.f40750c;
                ...
                return;
            case 5:
                co coVar5 = this.f40749b;
                coVar5.getClass();
                MessageObject messageObject5 = this.f40750c;
                ...
                return;
            case 6:
                co coVar6 = this.f40749b;
                coVar6.getClass();
                MessageObject messageObject6 = this.f40750c;
            ...
            case 7:
                co coVar7 = this.f40749b;
                coVar7.getMessagesController().pinMessage(coVar7.f35264e, coVar7.f35276f, this.f40750c.getId(), true, false, false);
                coVar7.A3 = null;
                return;
            default:
                co coVar8 = this.f40749b;
                org.telegram.ui.Components.yc.a0(coVar8).c(LocaleController.getString(R.string.AdHidden)).j();
                MessageObject messageObject7 = this.f40750c;
