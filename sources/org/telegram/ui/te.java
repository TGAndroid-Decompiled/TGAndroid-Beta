...
public final class te implements org.telegram.ui.ActionBar.c2, org.telegram.ui.Components.go, MessagesStorage.BooleanCallback, org.telegram.ui.Components.wj0, ResultCallback, kh.d, xg.a, xg.b, u60, ns, org.telegram.ui.Components.kl0, xg.d, org.telegram.ui.Components.yk0, FlagSecureReason.FlagSecureCondition, zu0 {
    public final int f41523a;
    public final xn f41524b;
    ...
    @Override
    public void a() {
        xn xnVar = this.f41524b;
        if (xnVar.f43356v3 == null && xnVar.getParentActivity() != null) {
            xnVar.Q7();
            xnVar.f43356v3.m(xnVar.Q5, xnVar.f43156f, 8);
        }
    }
    ...
    public void b(TLRPC.Document document) {
        switch (this.f41523a) {
            case 2:
                xn.u0(this.f41524b, document);
                return;
            default:
                xn.v0(this.f41524b, document);
                return;
        }
    }
    ...
    public void c(float[] fArr) {
        xn xnVar = this.f41524b;
        fArr[1] = xnVar.f43340u0.getBottom() - xnVar.f43391xa;
        fArr[0] = (xnVar.f43340u0.getTop() + xnVar.f43288p9) - AndroidUtilities.dp(4.0f);
    }
        ...
        switch (this.f41523a) {
            case 9:
                ...
                if (xnVar.getParentActivity() != null && xnVar.getParentActivity() != null) {
                    fi fiVar = new fi(xnVar, xnVar, xnVar.getParentActivity(), xnVar.f43114ba, arrayList);
                ...
                return;
            default:
                xn xnVar2 = this.f41524b;
                if (xnVar2.getParentActivity() != null && xnVar2.getParentActivity() != null) {
                    cj cjVar = new cj(xnVar2, xnVar2, xnVar2.getParentActivity(), xnVar2.f43114ba, arrayList);
    ...
    public boolean f(int i10, View view) {
        ...
        if (xnVar.getParentActivity() != null) {
            ...
            if ((adapter.F != null || adapter.G != null) && i10 != 0) {
                ...
                if (adapter2.f48753t0 != null && !adapter2.f48735e0) {
                    return false;
                }
                ...
                if (J instanceof uf.r0) {
                    ...
                    if (xnVar.F1.getAdapter().G != null) {
                        ...
                        alertDialog$Builder.f21168a.Q = LocaleController.getString(R.string.ClearSearch);
    ...
    public void g(boolean z4, boolean z10) {
        xn xnVar = this.f41524b;
        xnVar.J0.i(xnVar.f43127ca.c(), z4, z10);
    }

    @Override
    public void i(int i10, ArrayList arrayList) {
        xn xnVar = this.f41524b;
        xnVar.getMessagesController().addUsersToChat(xnVar.f43143e, xnVar, arrayList, i10, null, null, null);
        xnVar.getMessagesController().hidePeerSettingsBar(xnVar.Q5, xnVar.f43156f, xnVar.f43143e);
        xnVar.Qc(true);
        xnVar.oc(true);
    }
    ...
    public void j(org.telegram.ui.ActionBar.d2 d2Var, int i10) {
        switch (this.f41523a) {
            case 0:
                qk qkVar = this.f41524b.f43395y0;
                if (qkVar != null) {
                    qkVar.callOnClick();
                    return;
                }
            ...
            default:
                ...
                if (messageObject == null) {
                    messageObject = (MessageObject) xnVar.f43236l6[0].get(xnVar.I4);
                }
                xnVar.cc(messageObject);
                return;
            case 4:
                xn xnVar2 = this.f41524b;
                MessagePreviewParams messagePreviewParams = xnVar2.f43122c5;
            ...
            case 5:
                ...
                return;
            case 6:
                xn xnVar3 = this.f41524b;
                xnVar3.getMessagesController().unblockPeer(xnVar3.f43156f.f20992id);
                return;
            case 8:
                this.f41524b.finishFragment();
                return;
            case 10:
                uf.u0 adapter = this.f41524b.F1.getAdapter();
                adapter.f48756w.c();
                adapter.F.clear();
                adapter.l();
                ...
                return;
            case 12:
                xn xnVar4 = this.f41524b;
                xnVar4.showDialog(new ul(xnVar4, xnVar4.getParentActivity(), xnVar4));
                return;
            case 13:
                xn xnVar5 = this.f41524b;
                xnVar5.Q7();
                UndoView undoView = xnVar5.f43356v3;
                if (undoView != null) {
                ...
                return;
            case 15:
                xn xnVar6 = this.f41524b;
                MessagePreviewParams messagePreviewParams2 = xnVar6.f43122c5;
    ...
    public void k(int i10) {
        ...
        if (i10 == 1) {
            ...
            xnVar.A4 = true;
            xnVar.getMessagesController().getNextReactionMention(xnVar.Q5, xnVar.b(), xnVar.f43195i1, new jg(xnVar, 0));
        } else if (i10 == 4) {
            xnVar.A4 = true;
            xnVar.getMessagesController().getNextPollVotesMention(xnVar.Q5, xnVar.b(), xnVar.f43207j1, new jg(xnVar, 1));
        } else if (i10 == 6) {
            xnVar.Y8(true);
        } else if (i10 == 5) {
            xnVar.Y8(false);
