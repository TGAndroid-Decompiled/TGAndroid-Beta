...
public final class q30 implements View.OnClickListener {
    public final w5 f36746a = new w5(this, 5);
    public final i60 f36747b;
    ...
    public final void onClick(View view) {
        ...
        i60 i60Var = this.f36747b;
        o30 o30Var = i60Var.f34504x;
        ...
        if (i60Var.f34410a1 != null && i60Var.F1 != 3) {
            int i11 = 6;
            int i12 = 0;
            if (i60Var.r1() && !i60Var.f34410a1.isScheduled()) {
                a40 a40Var = i60Var.a2;
                if (a40Var != null && a40Var.f29058b && (AndroidUtilities.isTablet() || i60.F3 == i60Var.q1())) {
                    i60Var.e1(null);
                    if (i60.F3) {
                        AndroidUtilities.runOnUIThread(new g10(this, 5), 200L);
                    }
                    i60Var.f34443i0.setRequestedOrientation(-1);
                    return;
                    ...
                    if (i60Var.q1()) {
                        i60Var.f34443i0.setRequestedOrientation(6);
                        return;
                    } else {
                        i60Var.f34443i0.setRequestedOrientation(1);
                        return;
            ...
            if (i13 == 5) {
                if (!i60Var.H1) {
                    ...
                    accountInstance.getConnectionsManager().sendRequest(startscheduledgroupcall, new RequestDelegate(this) {
                        ...
                        public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                            switch (r2) {
                                case 0:
                                    q30 q30Var = this.f36423b;
                                    if (tLObject != null) {
                                        q30Var.f36747b.d.getMessagesController().processUpdates((TLRPC.Updates) tLObject, false);
                                        return;
                                    } else {
                                        q30Var.getClass();
                                        return;
                                ...
                                default:
                                    q30 q30Var2 = this.f36423b;
                                    if (tLObject != null) {
                                        q30Var2.f36747b.d.getMessagesController().processUpdates((TLRPC.Updates) tLObject, false);
                                        return;
                                    } else {
                                        q30Var2.getClass();
                                        return;
                ...
                if (VoIPService.getSharedInstance() != null && (i10 = i60Var.T1) != 1 && i10 != 2 && i10 != 6 && i10 != 5) {
                    ...
                    if (i14 != 2 && i14 != 4) {
                        try {
                            if (i14 == 0) {
                                if (Build.VERSION.SDK_INT >= 23 && (launchActivity = i60Var.f34443i0) != null && launchActivity.checkSelfPermission("android.permission.RECORD_AUDIO") != 0) {
                        ...
                        xi0Var.P(i15);
                        xi0Var.R(i15 - 1, this.f36746a);
                        o30Var.setAnimation(xi0Var);
                        xi0Var.M(i12);
                        o30Var.d();
                        if (i60Var.F1 == 2) {
                            long peerId = MessageObject.getPeerId(((TLRPC.GroupCallParticipant) i60Var.f34410a1.participants.f(MessageObject.getPeerId(i60Var.A0))).peer);
                ...
                if (i13 == 6 && (i40Var = i60Var.f34461n0) != null) {
                    i40Var.b(true);
                }
                TL_phone.toggleGroupCallStartSubscription togglegroupcallstartsubscription = new TL_phone.toggleGroupCallStartSubscription();
                togglegroupcallstartsubscription.call = i60Var.f34410a1.getInputGroupCall();
                TLRPC.GroupCall groupCall = i60Var.f34410a1.call;
                ...
                if (i60Var.f34410a1.call.schedule_start_subscribed) {
                    i11 = 7;
                }
                i60Var.J1(i11, true);
            }
