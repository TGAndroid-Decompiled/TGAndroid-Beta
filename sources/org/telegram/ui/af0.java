...
public final class af0 extends org.telegram.ui.Components.vv0 {
    public final ng0 B;
    public final org.telegram.ui.Components.jj0 f32565a;
    public final TextView f32566b;
    public final TextView f32567c;
    public final TextView d;
    public final TextView e;
    public final TextView f32568f;
    public z5 h;
    public Bundle f32569n;
    ...
    public af0(ng0 ng0Var, Context context) {
        ...
        this.f32565a = imageView;
        imageView.setAutoRepeat(true);
        imageView.f(R.raw.sandclock, 120, 120, null);
        frameLayout.addView((View) imageView, k7.b6.e(120, 120, 1));
    ...
    public final void m(Bundle bundle, boolean z4) {
        ...
        this.f32569n = bundle;
        this.f32570r = bundle.getString("phoneFormated");
        this.f32571s = bundle.getString("phoneHash");
        this.v = bundle.getString("code");
        this.f32572w = bundle.getInt("startTime");
        this.f32573x = bundle.getInt("waitTime");
        int i10 = R.string.ResetAccountInfo;
        se.b c3 = se.b.c();
        this.f32567c.setText(AndroidUtilities.replaceTags(LocaleController.formatString("ResetAccountInfo", i10, LocaleController.addNbsp(c3.b("+" + this.f32570r)))));
        o();
    ...
    public final void n() {
        ...
        this.f32566b.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i10, false));
        this.f32567c.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i10, false));
        this.f32568f.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i10, false));
    ...
    public final void o() {
        ...
        int i11;
        int i12;
        int i13 = this.f32573x;
        i10 = ((org.telegram.ui.ActionBar.p2) this.B).currentAccount;
        int currentTime = i13 - (ConnectionsManager.getInstance(i10).getCurrentTime() - this.f32572w);
        int i14 = 0;
        ...
        Boolean bool = this.f32574y;
        if (bool != null && bool.booleanValue() == z4) {
            return;
        }
        org.telegram.ui.Components.jj0 jj0Var = this.f32565a;
        if (!z4) {
        ...
        this.f32568f.setVisibility(i12);
        if (!z4) {
            i14 = 4;
        }
        this.d.setVisibility(i14);
        this.f32574y = Boolean.valueOf(z4);
    }
}
