...
public final class w51 extends org.telegram.ui.Components.dw {
    public final int f38897g0;
    public final a71 f38898h0;
    ...
    public w51(a71 a71Var, Context context, org.telegram.ui.ActionBar.d6 d6Var, boolean z10, boolean z11, int i10, jx0 jx0Var, int i11, int i12) {
        ...
        this.f38898h0 = a71Var;
        this.f38897g0 = i12;
    }

    @Override
    public final ColorFilter getEmojiColorFilter() {
        return this.f38898h0.f32035k1;
    }
    ...
    public final boolean h(int i10) {
        ...
        int i13;
        int i14;
        a71 a71Var = this.f38898h0;
        SparseIntArray sparseIntArray = a71Var.f32063x0;
        int i15 = 0;
        if (a71Var.f32061w1) {
            return false;
        }
        int i16 = this.f38897g0;
        if (i16 == 4 && i10 == 0) {
            a71Var.Q = !a71Var.Q;
            a71Var.f32019d0.setVisibility(8);
            org.telegram.ui.Components.dw dwVar = a71Var.f32017c0[a71Var.Q ? 1 : 0];
            a71Var.f32019d0 = dwVar;
            dwVar.setVisibility(0);
            org.telegram.ui.Components.zv zvVar = a71Var.f32019d0.f23748x;
            ...
            org.telegram.ui.Components.zv zvVar2 = a71Var.f32019d0.f23748x;
            if (a71Var.Q) {
            ...
            a71Var.f32048r0.h1(0, 0);
            return true;
        }
        org.telegram.ui.Components.zv zvVar3 = this.E;
        if (zvVar3 != null && this.f23741b0) {
            i11 = 1;
        } else {
            i11 = 0;
        }
        int i17 = i11 + 1;
        if (zvVar3 != null && this.f23741b0 && i10 == 1) {
            i12 = a71Var.f32038n;
        } else {
        ...
        a71Var.f32019d0.j(i10, true);
        a71Var.f32028h0.L1 = true;
        a71Var.v(null, true, true);
        r51 r51Var = a71Var.f32024f0;
        if (r51Var != null && (o61Var = r51Var.f36413n) != null) {
            o61Var.F1(null);
        }
        return true;
    }
    ...
    public final void i(org.telegram.ui.Components.zv zvVar) {
        ValueAnimator valueAnimator = this.f38898h0.U1;
