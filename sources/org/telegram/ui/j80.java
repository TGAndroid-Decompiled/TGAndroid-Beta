...
public final class j80 extends FrameLayout implements org.telegram.ui.ActionBar.z5 {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        Paint paint = this.f34723a;
        paint.setShadowLayer(dpf2, 0.0f, dpf22, 285212672);
        int i10 = org.telegram.ui.ActionBar.j6.f19062d6;
        l80 l80Var = this.f34726f;
        paint.setColor(l80Var.getThemedColor(i10));
        RectF rectF = AndroidUtilities.rectTmp;
        rectF.set(AndroidUtilities.dp(12.0f), AndroidUtilities.dp(3.0f), getWidth() - AndroidUtilities.dp(12.0f), AndroidUtilities.dp(3.0f) + l80Var.f35279b.e + AndroidUtilities.dp(3.0f));
        Path path = this.f34724b;
        path.rewind();
        path.addRoundRect(rectF, AndroidUtilities.dp(20.0f), AndroidUtilities.dp(20.0f), Path.Direction.CW);
        GradientDrawable gradientDrawable = this.e;
        if (gradientDrawable != null) {
            gradientDrawable.setBounds(0, 0, getWidth(), Math.min(getHeight(), AndroidUtilities.dp(24.0f) + ((int) l80Var.f35279b.e)));
            this.e.draw(canvas);
        }
        canvas.save();
    ...
    @Override
    public final void e() {
        int themedColor = this.f34726f.getThemedColor(org.telegram.ui.ActionBar.j6.f19006a7);
