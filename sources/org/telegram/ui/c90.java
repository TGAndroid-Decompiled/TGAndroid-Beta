...
public final class c90 implements Runnable {
    ...
    public final void run() {
        ...
        String q6;
        int i17 = this.f32587a;
        TLRPC.TL_wallPaper tL_wallPaper = null;
        int i18 = 0;
        Object obj = this.e;
        Object obj2 = this.f32590f;
        Object obj3 = this.f32589c;
        Object obj4 = this.d;
        Object obj5 = this.f32588b;
        switch (i17) {
            case 0:
                ...
                if (tLObject instanceof TLRPC.TL_wallPaper) {
                    ...
                    od1Var.F1 = z10;
                    od1Var.E1 = z11;
                    od1Var.f36167n1 = wallPaperSettings3.intensity;
            ...
            case 1:
                ...
                if (qyVar != null) {
                    ...
                    ((wn) m2Var).W9(user.f18468id, str3, true);
                    return;
                } else {
                    return;
                }
            case 2:
                ...
                if (tLObject2 != null) {
                    if (tLObject2 instanceof TLRPC.TL_urlAuthResultRequest) {
                        cl0.b(false, launchActivity3.O, tL_messages_requestUrlAuth, (TLRPC.TL_urlAuthResultRequest) tLObject2, null, null, null, false, null);
                        return;
                    } else if (tLObject2 instanceof TLRPC.TL_urlAuthResultAccepted) {
                        cl0.b(false, launchActivity3.O, tL_messages_requestUrlAuth, (TLRPC.TL_urlAuthResultAccepted) tLObject2, null, null, null, false, null);
                        return;
            ...
            case 4:
                ...
                int i19 = zb0Var.f40419b;
                LaunchActivity launchActivity5 = zb0Var.f40418a;
                if (tL_error4 != null) {
                    ...
                    if (tLObject4 instanceof TLRPC.TL_payments_paymentFormStars) {
                        ...
                        yh.t5.y(i19, false).Y(null, tL_inputInvoiceSlug, (TLRPC.TL_payments_paymentFormStars) tLObject4, new tb0(zb0Var, 1), new f90(p4Var, 1));
                        return;
                    }
                ...
                if (str6 != null) {
                    if (str6.contains("EMAIL_INVALID")) {
                        ...
                        if (tL_error6.text.contains("PHONE_CODE_EXPIRED")) {
                            ...
                            org.telegram.ui.Components.e5.f0(i12, tL_error6, qg0Var2, sendverifyemailcode, ff0Var.f33648w);
                            return;
                        } else {
                            return;
                        }
            ...
            case 9:
                ...
                zf0Var.f40445b.setLoading(false);
                if (tLObject8 instanceof TLRPC.PaymentForm) {
                    ...
                    oo0Var2.V0 = true;
                    oo0Var2.f36269c1 = new Utilities.Callback() {
                        @Override
                                        ...
                                        public final void run() {
                                            switch (r4) {
                                                case 0:
                                                    ...
                                                    zf0 zf0Var3 = zf0Var2;
                                                    if (!zf0Var3.f40447f) {
                                                        zf0Var3.f40447f = true;
                                                        zf0Var3.h = str7;
                                                        zf0Var3.f40448n = str8;
                                                        zf0Var3.f40449r = j3;
                                                        zf0Var3.f40445b.setLoading(true);
                                                        zf0Var3.p();
                                                        return;
                                                    }
                                                    return;
                                                default:
                                                    ...
                                                    zf0 zf0Var4 = zf0Var2;
                                                    if (!zf0Var4.f40447f) {
                                                        zf0Var4.f40447f = true;
                                                        zf0Var4.h = str9;
                                                        zf0Var4.f40448n = str10;
                                                        zf0Var4.f40449r = j10;
                                                        zf0Var4.f40445b.setLoading(true);
                                                        zf0Var4.p();
                                                        return;
                                                    }
                                                    return;
                                        ...
                                        public final void run() {
                                            switch (r4) {
                                                case 0:
                                                    ...
                                                    if (!zf0Var32.f40447f) {
                                                        zf0Var32.f40447f = true;
                                                        zf0Var32.h = str7;
                                                        zf0Var32.f40448n = str8;
                                                        zf0Var32.f40449r = j3;
                                                        zf0Var32.f40445b.setLoading(true);
                                                        zf0Var32.p();
                                                        return;
                                                    }
                                                    return;
                    ...
                    oo0Var2.f36271d1 = new Utilities.Callback() {
                        @Override
                        public final void run(Object obj6) {
                            switch (r4) {
                                case 0:
            ...
            case 10:
                ...
                if (tL_error9 == null && bVar != null) {
                    ...
                    ea1Var.e = bVar;
                    ea1Var.f33319c = tL_loadAsyncGraph.f18550x;
                    ej0Var.g0();
                    return;
                }
                ej0Var.g0();
            ...
            case 12:
                ...
                ((jm0) gn0Var.B1).c(gn0Var.E, (String) gn0Var.f33998s1.get("email"), null, null, null, null, null, null, null, null, il0Var, aVar);
                return;
            case 13:
                cn0 cn0Var = (cn0) obj5;
            ...
            case 15:
                ...
                PhotoViewer photoViewer = ((xt0) obj5).f39974r;
                photoViewer.f31308p4 = null;
                nu0 nu0Var = photoViewer.f31209e0;
                if (nu0Var != null && photoViewer.f31226g0 != null) {
                    nu0Var.setLayerType(0, null);
                    photoViewer.f31290n4 = 0;
                    photoViewer.F1();
                    photoViewer.f31299o4 = 0L;
                    photoViewer.G1 = null;
                    photoViewer.E1.f14268a = false;
                    photoViewer.H1 = null;
                    photoViewer.F1.f14268a = false;
                    photoViewer.C2();
                    photoViewer.y2();
                    ...
                    vu0 vu0Var = photoViewer.f31316q4;
                    if (vu0Var != null) {
                        vu0Var.f38804a.setVisible(true, true);
                    }
                    vu0 vu0Var2 = photoViewer.f31325r4;
                    if (vu0Var2 != null && !vu0Var2.f38819s) {
                        vu0Var2.f38804a.setVisible(false, true);
                    }
                    if (arrayList2 != null && (i16 = photoViewer.f31193c2) != 3 && i16 != 1 && ((tu0Var = photoViewer.d) == null || !tu0Var.O())) {
                        photoViewer.R1();
                    }
                    org.telegram.ui.Components.s71 s71Var = photoViewer.F2;
                    if (s71Var != null && s71Var.y() && photoViewer.f31322r1 && !photoViewer.f31233g7.isEmpty()) {
            ...
            case 17:
                ...
                if (tL_error12 != null && (str = tL_error12.text) != null && str.startsWith("FLOOD_WAIT_")) {
                    if (privacyControlActivity2.getParentActivity() != null) {
                        ...
                        privacyControlActivity2.showDialog(a2Var2);
                        return;
                    }
                    return;
                }
            ...
            case 18:
                ...
                AlertDialog$Builder alertDialog$Builder2 = new AlertDialog$Builder(profileActivity.getParentActivity(), 0, profileActivity.f31684z0);
            ...
            case 19:
                ...
                if (tLObject10 instanceof TL_fragment.TL_collectibleInfo) {
                    ...
                    if (profileActivity2.f31541e1 != 0) {
                        profileActivity2.getMessagesController().getUser(Long.valueOf(profileActivity2.f31541e1));
                    } else {
                        profileActivity2.getMessagesController().getChat(Long.valueOf(profileActivity2.f31549f1));
                    }
                    ...
                    org.telegram.ui.Components.yc ycVar = new org.telegram.ui.Components.yc(pz0Var.f28888w, profileActivity2.f31684z0);
                    ...
                    org.telegram.ui.Components.qc w10 = ycVar.w(i21, AndroidUtilities.withLearnMore(AndroidUtilities.replaceTags(LocaleController.formatString(i22, str9, format, formatCurrency, q6)), new ix0(8, profileActivity2, tL_collectibleInfo)));
            ...
            case 20:
                ...
                if (tLObject11 instanceof TL_fragment.TL_collectibleInfo) {
                    d20.a(profileActivity3.getParentActivity(), 1, str10, user3, (TL_fragment.TL_collectibleInfo) tLObject11, profileActivity3.f31684z0);
                    return;
                } else {
            ...
            case 22:
                ...
                if (((String) obj3).equals(a11Var.f31945y)) {
                    if (!a11Var.f31943w && (m2Var2 instanceof ProfileActivity)) {
                        try {
                            ((ProfileActivity) m2Var2).P.f25164b.getImageReceiver().startAnimation();
                    ...
                    a11Var.f31943w = true;
                    a11Var.f31941r = arrayList3;
                    a11Var.f31942s = arrayList4;
                    a11Var.f31940n = arrayList5;
                    a11Var.l();
            ...
            default:
                ...
                int i23 = z4Var.Y;
                org.telegram.ui.ActionBar.m2 m2Var3 = z4Var.f22949n;
                if (((TLObject) obj4) instanceof TLRPC.TL_boolTrue) {
    ...
    public c90(TLObject tLObject, MessagesController messagesController, ai.e4 e4Var, tg.f fVar, TLRPC.TL_error tL_error) {
        this.f32587a = 27;
        this.d = tLObject;
        this.f32588b = messagesController;
        this.f32589c = e4Var;
        this.e = fVar;
        this.f32590f = tL_error;
    }
    ...
    public c90(TLRPC.TL_error tL_error, Utilities.Callback callback, TLObject tLObject, MessagesController messagesController, Utilities.Callback callback2, int i10) {
        ...
        this.f32588b = callback;
        this.d = tLObject;
        this.f32589c = messagesController;
        this.e = callback2;
    }

    public c90(LaunchActivity launchActivity, TLObject tLObject, org.telegram.ui.ActionBar.a2 a2Var, m80 m80Var, TLRPC.TL_error tL_error) {
        this.f32587a = 3;
        this.f32588b = launchActivity;
        this.d = tLObject;
        this.e = a2Var;
        this.f32589c = m80Var;
        this.f32590f = tL_error;
    ...
    public c90(wj0 wj0Var, TLRPC.TL_contacts_importedContacts tL_contacts_importedContacts, TLRPC.TL_inputPhoneContact tL_inputPhoneContact, TLRPC.TL_error tL_error, TLRPC.TL_contacts_importContacts tL_contacts_importContacts) {
        this.f32587a = 11;
        this.f32588b = wj0Var;
        this.f32589c = tL_contacts_importedContacts;
