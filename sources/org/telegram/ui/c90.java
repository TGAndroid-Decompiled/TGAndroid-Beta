...
public final class c90 implements Runnable {
    ...
    public final void run() {
        ...
        String q6;
        int i17 = this.f32600a;
        TLRPC.TL_wallPaper tL_wallPaper = null;
        int i18 = 0;
        Object obj = this.e;
        Object obj2 = this.f32603f;
        Object obj3 = this.f32602c;
        Object obj4 = this.d;
        Object obj5 = this.f32601b;
        switch (i17) {
            case 0:
                ...
                if (tLObject instanceof TLRPC.TL_wallPaper) {
                    ...
                    od1Var.F1 = z10;
                    od1Var.E1 = z11;
                    od1Var.f36190n1 = wallPaperSettings3.intensity;
            ...
            case 4:
                ...
                int i19 = zb0Var.f40434b;
                LaunchActivity launchActivity5 = zb0Var.f40433a;
                if (tL_error4 != null) {
                ...
                if (str6 != null) {
                    if (str6.contains("EMAIL_INVALID")) {
                        ...
                        if (tL_error6.text.contains("PHONE_CODE_EXPIRED")) {
                            ...
                            org.telegram.ui.Components.e5.f0(i12, tL_error6, qg0Var2, sendverifyemailcode, ff0Var.f33662w);
                            return;
                        } else {
                            return;
                        }
            ...
            case 9:
                ...
                if (tLObject8 instanceof TLRPC.PaymentForm) {
                    ...
                    oo0Var2.V0 = true;
                    oo0Var2.f36284c1 = new Utilities.Callback() {
                        @Override
                                        ...
                                        public final void run() {
                                            switch (r4) {
                                                case 0:
                                                    ...
                                                    zf0 zf0Var3 = zf0Var2;
                                                    if (!zf0Var3.f40462f) {
                                                        zf0Var3.f40462f = true;
                                                        zf0Var3.h = str7;
                                                        zf0Var3.f40463n = str8;
                                                        zf0Var3.f40464r = j3;
                                                        zf0Var3.f40460b.setLoading(true);
                                                        zf0Var3.p();
                                                        return;
                                                    }
                                                    return;
                                                default:
                                                    ...
                                                    zf0 zf0Var4 = zf0Var2;
                                                    if (!zf0Var4.f40462f) {
                                                        zf0Var4.f40462f = true;
                                                        zf0Var4.h = str9;
                                                        zf0Var4.f40463n = str10;
                                                        zf0Var4.f40464r = j10;
                                                        zf0Var4.f40460b.setLoading(true);
                                                        zf0Var4.p();
                                                        return;
                                                    }
                                                    return;
                                        ...
                                        public final void run() {
                                            switch (r4) {
                                                case 0:
                                                    ...
                                                    if (!zf0Var32.f40462f) {
                                                        zf0Var32.f40462f = true;
                                                        zf0Var32.h = str7;
                                                        zf0Var32.f40463n = str8;
                                                        zf0Var32.f40464r = j3;
                                                        zf0Var32.f40460b.setLoading(true);
                                                        zf0Var32.p();
                                                        return;
                                                    }
                                                    return;
                    ...
                    oo0Var2.f36286d1 = new Utilities.Callback() {
                        @Override
                        public final void run(Object obj6) {
                            switch (r4) {
                                case 0:
                    ...
                    oo0Var2.f36288e1 = new h20(zf0Var, 1);
            ...
            case 10:
                ...
                if (tL_error9 == null && bVar != null) {
                    ...
                    ea1Var.e = bVar;
                    ea1Var.f33345c = tL_loadAsyncGraph.f18564x;
                    dj0Var.g0();
                    return;
                }
                dj0Var.g0();
            ...
            case 12:
                ...
                ((jm0) gn0Var.B1).c(gn0Var.E, (String) gn0Var.f34010s1.get("email"), null, null, null, null, null, null, null, null, il0Var, aVar);
                return;
            case 13:
                cn0 cn0Var = (cn0) obj5;
            ...
            case 15:
                ...
                PhotoViewer photoViewer = ((xt0) obj5).f39988r;
                photoViewer.f31321p4 = null;
                nu0 nu0Var = photoViewer.f31222e0;
                if (nu0Var != null && photoViewer.f31239g0 != null) {
                    nu0Var.setLayerType(0, null);
                    photoViewer.f31303n4 = 0;
                    photoViewer.F1();
                    photoViewer.f31312o4 = 0L;
                    photoViewer.G1 = null;
                    ...
                    vu0 vu0Var = photoViewer.f31329q4;
                    if (vu0Var != null) {
                        vu0Var.f38818a.setVisible(true, true);
                    }
                    vu0 vu0Var2 = photoViewer.f31338r4;
                    if (vu0Var2 != null && !vu0Var2.f38833s) {
                        vu0Var2.f38818a.setVisible(false, true);
                    }
                    if (arrayList2 != null && (i16 = photoViewer.f31206c2) != 3 && i16 != 1 && ((tu0Var = photoViewer.d) == null || !tu0Var.O())) {
                        photoViewer.R1();
                    }
                    org.telegram.ui.Components.t71 t71Var = photoViewer.F2;
                    if (t71Var != null && t71Var.y() && photoViewer.f31335r1 && !photoViewer.f31246g7.isEmpty()) {
                        PhotoViewer.Z(photoViewer, photoViewer.F2.n());
                        PhotoViewer.Y(photoViewer, true);
                    }
                    if (photoViewer.f31357t4) {
            ...
            case 18:
                ...
                AlertDialog$Builder alertDialog$Builder2 = new AlertDialog$Builder(profileActivity.getParentActivity(), 0, profileActivity.f31697z0);
            ...
            case 19:
                ...
                if (tLObject10 instanceof TL_fragment.TL_collectibleInfo) {
                    ...
                    if (profileActivity2.f31554e1 != 0) {
                        profileActivity2.getMessagesController().getUser(Long.valueOf(profileActivity2.f31554e1));
                    } else {
                        profileActivity2.getMessagesController().getChat(Long.valueOf(profileActivity2.f31562f1));
                    }
                    ...
                    org.telegram.ui.Components.xc xcVar = new org.telegram.ui.Components.xc(pz0Var.f29742w, profileActivity2.f31697z0);
            ...
            case 20:
                ...
                if (tLObject11 instanceof TL_fragment.TL_collectibleInfo) {
                    d20.a(profileActivity3.getParentActivity(), 1, str10, user3, (TL_fragment.TL_collectibleInfo) tLObject11, profileActivity3.f31697z0);
                    return;
                } else {
            ...
            case 22:
                ...
                if (((String) obj3).equals(a11Var.f31958y)) {
                    if (!a11Var.f31956w && (m2Var2 instanceof ProfileActivity)) {
                        try {
                            ((ProfileActivity) m2Var2).P.f25545b.getImageReceiver().startAnimation();
                    ...
                    a11Var.f31956w = true;
                    a11Var.f31954r = arrayList3;
                    a11Var.f31955s = arrayList4;
                    a11Var.f31953n = arrayList5;
                    a11Var.l();
    ...
    public c90(TLObject tLObject, MessagesController messagesController, ai.e4 e4Var, tg.f fVar, TLRPC.TL_error tL_error) {
        this.f32600a = 27;
        this.d = tLObject;
        this.f32601b = messagesController;
        this.f32602c = e4Var;
        this.e = fVar;
        this.f32603f = tL_error;
    }
    ...
    public c90(TLRPC.TL_error tL_error, Utilities.Callback callback, TLObject tLObject, MessagesController messagesController, Utilities.Callback callback2, int i10) {
        ...
        this.f32601b = callback;
        this.d = tLObject;
        this.f32602c = messagesController;
        this.e = callback2;
    }
    ...
    public c90(wj0 wj0Var, TLRPC.TL_contacts_importedContacts tL_contacts_importedContacts, TLRPC.TL_inputPhoneContact tL_inputPhoneContact, TLRPC.TL_error tL_error, TLRPC.TL_contacts_importContacts tL_contacts_importContacts) {
        this.f32600a = 11;
        this.f32601b = wj0Var;
        this.f32602c = tL_contacts_importedContacts;
