...
public final class md1 extends org.telegram.ui.Components.vl0 {
    ...
    public final void v(s4.c1 c1Var, int i10) {
        BlendMode blendMode;
        org.telegram.ui.Cells.k5 k5Var = (org.telegram.ui.Cells.k5) c1Var.f42961a;
        od1 od1Var = this.d;
        k5Var.setPattern((TLRPC.TL_wallPaper) od1Var.U0.get(i10));
        k5Var.getImageReceiver().setColorFilter(new PorterDuffColorFilter(od1Var.f36184j1, od1Var.f36204s1));
        if (Build.VERSION.SDK_INT >= 29) {
            int i11 = 0;
            if (od1Var.f36156b == 1) {
                int B0 = org.telegram.ui.ActionBar.h6.B0(org.telegram.ui.ActionBar.h6.Pd);
                long j3 = od1Var.f36202s.f18894l;
                int i12 = (int) j3;
                if (i12 != 0 || j3 == 0) {
                    i11 = i12 != 0 ? i12 : B0;
                }
            ...
            if (i11 != 0 && od1Var.l1 >= 0.0f) {
                ImageReceiver imageReceiver = od1Var.f36215x0.getImageReceiver();
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        ?? w9Var = new org.telegram.ui.Components.w9(this.f35539c);
        w9Var.G = new RectF();
