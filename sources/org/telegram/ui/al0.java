...
public final class al0 extends org.telegram.ui.ActionBar.p2 implements org.telegram.ui.Components.kk, NotificationCenter.NotificationCenterDelegate {
    ...
    public Ringtone P;
    public long Q;
    public final ArrayList f31027a;
    public final ArrayList f31028b;
    public final ArrayList f31029c;
    ...
    public static void W(al0 al0Var) {
        al0Var.J.clear();
        xk0 xk0Var = al0Var.f31030f;
        xk0Var.q(0, xk0Var.f38768c.f31031n);
        al0Var.b0();
    }
    ...
    public final void Z(yk0 yk0Var) {
        int i10 = yk0Var.f39020c;
        SparseArray sparseArray = this.J;
        if (sparseArray.get(i10) != null) {
            sparseArray.remove(yk0Var.f39020c);
        } else if (yk0Var.f39018a) {
            sparseArray.put(yk0Var.f39020c, yk0Var);
        } else {
            return;
        }
        b0();
        xk0 xk0Var = this.f31030f;
        xk0Var.q(0, xk0Var.f38768c.f31031n);
    }
    ...
    public final void c0() {
        ...
        this.F = -1;
        this.f31031n = 1;
        ArrayList arrayList = this.f31027a;
        if (!arrayList.isEmpty()) {
            int i10 = this.f31031n;
            this.f31032r = i10;
            int size = arrayList.size() + i10;
            this.f31031n = size;
            this.f31033s = size;
        }
        int i11 = this.f31031n;
        this.v = i11;
        this.f31031n = i11 + 2;
        this.f31034w = i11 + 1;
        ArrayList arrayList2 = this.f31028b;
    ...
    public final View createView(Context context) {
        ...
        this.actionBar.A(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f17965f8, this.h), false);
        this.actionBar.C(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f18256v8, this.h), false);
        ...
        if (this.L == 0) {
            ...
            org.telegram.ui.Components.jo joVar2 = this.K;
        ...
        this.d.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f18308y8, this.h));
        ...
        frameLayout.setBackgroundColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f17872a7, this.h));
        ...
        this.f31030f = xk0Var;
        xk0Var.C(true);
        this.e.setAdapter(this.f31030f);
        ((s4.j) this.e.getItemAnimator()).f41645m = false;
        ...
        for (int i11 = 0; i11 < getMediaDataController().ringtoneDataStore.e.size(); i11++) {
            ...
            obj.f39018a = true;
            obj.d = bVar.f42127c;
            TLRPC.Document document3 = bVar.f42125a;
            String str = document3.file_name_fixed;
            obj.f39021f = str;
            obj.e = document3;
            obj.f39021f = a0(document3, str);
            obj.f39022g = bVar.f42126b;
            yk0 yk0Var = this.N;
            if (yk0Var != null && (document = yk0Var.e) != null && (document2 = bVar.f42125a) != null && document.f17201id == document2.f17201id) {
                this.N = null;
                this.H = obj;
            }
            this.f31027a.add(obj);
        }
        ...
        this.G = i13 + 1;
        obj2.f39020c = i13;
        obj2.f39021f = LocaleController.getString(R.string.NoSound);
        this.f31028b.add(obj2);
        ?? obj3 = new Object();
        int i14 = this.G;
        this.G = i14 + 1;
        obj3.f39020c = i14;
        obj3.f39021f = LocaleController.getString(R.string.DefaultRingtone);
        obj3.f39019b = true;
        this.f31028b.add(obj3);
        yk0 yk0Var2 = this.N;
        if (yk0Var2 != null && yk0Var2.e == null && yk0Var2.f39022g.equals("NoSound")) {
            this.N = null;
            this.H = obj2;
        }
        yk0 yk0Var3 = this.N;
        if (yk0Var3 != null && yk0Var3.e == null && yk0Var3.f39022g.equals("Default")) {
            this.N = null;
            this.H = obj3;
        }
        while (cursor.moveToNext()) {
            ...
            obj4.f39022g = str2;
            yk0 yk0Var4 = this.N;
            if (yk0Var4 != null && yk0Var4.e == null && yk0Var4.f39022g.equals(str2)) {
                this.N = null;
                this.H = obj4;
            }
            this.f31028b.add(obj4);
        }
        if (getMediaDataController().ringtoneDataStore.f42133f && this.H == null) {
            this.H = obj3;
            this.I = true;
        }
        c0();
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.onUserRingtonesUpdated) {
            ...
            for (int i13 = 0; i13 < getMediaDataController().ringtoneDataStore.e.size(); i13++) {
                ...
                ?? obj = new Object();
                yk0 yk0Var = (yk0) hashMap.get(Integer.valueOf(bVar.f42127c));
                if (yk0Var != null) {
                    if (yk0Var == this.H) {
                        this.H = obj;
                    }
                    obj.f39020c = yk0Var.f39020c;
                } else {
                    int i14 = this.G;
                    this.G = i14 + 1;
                    obj.f39020c = i14;
                ...
                TLRPC.Document document3 = bVar.f42125a;
                if (document3 != null) {
                    obj.f39021f = document3.file_name_fixed;
                } else {
                    obj.f39021f = new File(bVar.f42126b).getName();
                }
                TLRPC.Document document4 = bVar.f42125a;
                obj.e = document4;
                obj.f39021f = a0(document4, obj.f39021f);
                obj.f39022g = bVar.f42126b;
                yk0 yk0Var2 = this.N;
                if (yk0Var2 != null && (document = yk0Var2.e) != null && (document2 = bVar.f42125a) != null && document.f17201id == document2.f17201id) {
                    this.N = null;
                    this.H = obj;
                }
                arrayList.add(obj);
        ...
        if (i10 == 21 && intent != null && this.O != null) {
            ...
            if (intent.getData() != null) {
                ...
                if (path != null) {
                    ...
                    if (this.O.f29395p0.M(new File(path))) {
                ...
                for (int i12 = 0; i12 < clipData.getItemCount(); i12++) {
                    ...
                    if (this.O.f29395p0.M(new File(uri2))) {
    ...
    public final void onFragmentDestroy() {
        ...
        if (this.H != null && this.I) {
            ...
            yk0 yk0Var = this.H;
            if (yk0Var.f39018a && (document = yk0Var.e) != null) {
                edit.putLong(str3, document.f17201id);
                edit.putString(str, this.H.f39021f);
                edit.putString(str2, "NoSound");
            } else if (yk0Var.f39022g != null) {
                edit.putString(str, yk0Var.f39021f);
                edit.putString(str2, this.H.f39022g);
                edit.remove(str3);
            } else if (yk0Var.f39019b) {
