...
public final class al0 extends org.telegram.ui.ActionBar.o2 implements org.telegram.ui.Components.fk, NotificationCenter.NotificationCenterDelegate {
    ...
    public final ArrayList f31918b;
    public final ArrayList f31919c;
    ...
    public static void W(al0 al0Var) {
        al0Var.J.clear();
        xk0 xk0Var = al0Var.f31920f;
        xk0Var.q(0, xk0Var.f39665c.f31921n);
        al0Var.b0();
    }
    ...
    public final void Z(yk0 yk0Var) {
        int i10 = yk0Var.f39934c;
        SparseArray sparseArray = this.J;
        if (sparseArray.get(i10) != null) {
            sparseArray.remove(yk0Var.f39934c);
        } else if (yk0Var.f39932a) {
            sparseArray.put(yk0Var.f39934c, yk0Var);
        } else {
            return;
        }
        b0();
        xk0 xk0Var = this.f31920f;
        xk0Var.q(0, xk0Var.f39665c.f31921n);
    }
    ...
    public final void c0() {
        ...
        this.F = -1;
        this.f31921n = 1;
        ArrayList arrayList = this.f31917a;
        ...
        int i11 = this.f31921n;
        this.v = i11;
        this.f31921n = i11 + 2;
        this.f31924w = i11 + 1;
        ArrayList arrayList2 = this.f31918b;
        if (!arrayList2.isEmpty()) {
            int i12 = this.f31921n;
            int i13 = i12 + 1;
            this.f31921n = i13;
            this.f31926y = i12;
            this.E = i13;
    ...
    public final View createView(Context context) {
        ...
        this.actionBar.A(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f18900f8, this.h), false);
        this.actionBar.B(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19195v8, this.h), false);
        ...
        this.d.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19247y8, this.h));
        ...
        frameLayout.setBackgroundColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f18807a7, this.h));
        ...
        this.f31920f = xk0Var;
        xk0Var.C(true);
        this.e.setAdapter(this.f31920f);
        ((s4.j) this.e.getItemAnimator()).f42737m = false;
        ...
        for (int i11 = 0; i11 < getMediaDataController().ringtoneDataStore.e.size(); i11++) {
            ...
            obj.f39932a = true;
            obj.d = bVar.f43720c;
            TLRPC.Document document3 = bVar.f43718a;
            String str = document3.file_name_fixed;
            obj.f39935f = str;
            obj.e = document3;
            obj.f39935f = a0(document3, str);
            obj.f39936g = bVar.f43719b;
            yk0 yk0Var = this.N;
            if (yk0Var != null && (document = yk0Var.e) != null && (document2 = bVar.f43718a) != null && document.f18127id == document2.f18127id) {
                this.N = null;
                this.H = obj;
            }
            this.f31917a.add(obj);
        }
        ...
        this.G = i13 + 1;
        obj2.f39934c = i13;
        obj2.f39935f = LocaleController.getString(R.string.NoSound);
        this.f31918b.add(obj2);
        ?? obj3 = new Object();
        int i14 = this.G;
        this.G = i14 + 1;
        obj3.f39934c = i14;
        obj3.f39935f = LocaleController.getString(R.string.DefaultRingtone);
        obj3.f39933b = true;
        this.f31918b.add(obj3);
        yk0 yk0Var2 = this.N;
        if (yk0Var2 != null && yk0Var2.e == null && yk0Var2.f39936g.equals("NoSound")) {
            this.N = null;
            this.H = obj2;
        }
        yk0 yk0Var3 = this.N;
        if (yk0Var3 != null && yk0Var3.e == null && yk0Var3.f39936g.equals("Default")) {
            this.N = null;
            this.H = obj3;
        }
        while (cursor.moveToNext()) {
            ...
            obj4.f39936g = str2;
            yk0 yk0Var4 = this.N;
            if (yk0Var4 != null && yk0Var4.e == null && yk0Var4.f39936g.equals(str2)) {
                this.N = null;
                this.H = obj4;
            }
            this.f31918b.add(obj4);
        }
        if (getMediaDataController().ringtoneDataStore.f43726f && this.H == null) {
            this.H = obj3;
            this.I = true;
        }
        c0();
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.onUserRingtonesUpdated) {
            ...
            for (int i13 = 0; i13 < getMediaDataController().ringtoneDataStore.e.size(); i13++) {
                ...
                ?? obj = new Object();
                yk0 yk0Var = (yk0) hashMap.get(Integer.valueOf(bVar.f43720c));
                if (yk0Var != null) {
                    if (yk0Var == this.H) {
                        this.H = obj;
                    }
                    obj.f39934c = yk0Var.f39934c;
                } else {
                    int i14 = this.G;
                    this.G = i14 + 1;
                    obj.f39934c = i14;
                ...
                TLRPC.Document document3 = bVar.f43718a;
                if (document3 != null) {
                    obj.f39935f = document3.file_name_fixed;
                } else {
                    obj.f39935f = new File(bVar.f43719b).getName();
                }
                TLRPC.Document document4 = bVar.f43718a;
                obj.e = document4;
                obj.f39935f = a0(document4, obj.f39935f);
                obj.f39936g = bVar.f43719b;
                yk0 yk0Var2 = this.N;
                if (yk0Var2 != null && (document = yk0Var2.e) != null && (document2 = bVar.f43718a) != null && document.f18127id == document2.f18127id) {
                    this.N = null;
                    this.H = obj;
                }
                arrayList.add(obj);
        ...
        if (i10 == 21 && intent != null && this.O != null) {
            ...
            if (intent.getData() != null) {
                ...
                if (path != null) {
                    ...
                    if (this.O.f28774p0.M(new File(path))) {
                ...
                for (int i12 = 0; i12 < clipData.getItemCount(); i12++) {
                    ...
                    if (this.O.f28774p0.M(new File(uri2))) {
    ...
    public final void onFragmentDestroy() {
        ...
        if (this.H != null && this.I) {
            ...
            yk0 yk0Var = this.H;
            if (yk0Var.f39932a && (document = yk0Var.e) != null) {
                edit.putLong(str3, document.f18127id);
                edit.putString(str, this.H.f39935f);
                edit.putString(str2, "NoSound");
            } else if (yk0Var.f39936g != null) {
                edit.putString(str, yk0Var.f39935f);
                edit.putString(str2, this.H.f39936g);
                edit.remove(str3);
            } else if (yk0Var.f39933b) {
