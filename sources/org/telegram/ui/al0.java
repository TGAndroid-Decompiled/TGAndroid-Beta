...
public final class al0 implements Runnable {
    ...
    public final PasscodeActivity f35207b;

    public al0(PasscodeActivity passcodeActivity, int i10) {
        this.f35206a = i10;
        this.f35207b = passcodeActivity;
    }
    ...
    public final void run() {
        ...
        switch (this.f35206a) {
            case 0:
                PasscodeActivity passcodeActivity = this.f35207b;
            ...
            case 1:
                ...
                PasscodeActivity passcodeActivity3 = this.f35207b;
                ...
                return;
            case 2:
                PasscodeActivity passcodeActivity4 = this.f35207b;
                ...
                return;
            case 3:
                PasscodeActivity passcodeActivity5 = this.f35207b;
                if (passcodeActivity5.e0()) {
                    for (cs csVar : passcodeActivity5.f34211n.f43982f) {
                        csVar.i(0.0f);
                    }
                    return;
                }
                ...
                return;
            case 4:
                PasscodeActivity passcodeActivity6 = this.f35207b;
