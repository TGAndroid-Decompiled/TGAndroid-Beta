...
public final class cx0 {
    public final TLRPC.TL_premiumSubscriptionOption f32796a;
    public int f32797b;
    public long f32798c;
    public long d;
    public long e;
    ...
    public cx0(TLRPC.TL_premiumSubscriptionOption tL_premiumSubscriptionOption) {
        this.f32796a = tL_premiumSubscriptionOption;
    }

    public final void a() {
        c5.o oVar = this.f32799f;
        if (oVar != null && this.f32800g == null) {
    ...
    public final String b() {
        ...
        TLRPC.TL_premiumSubscriptionOption tL_premiumSubscriptionOption = this.f32796a;
        if (!useInvoiceBilling && tL_premiumSubscriptionOption.store_product != null) {
            if (this.f32799f != null) {
                a();
                c5.n nVar = this.f32800g;
                if (nVar == null) {
                    return "";
                }
    ...
    public final String d() {
        if (!BuildVars.useInvoiceBilling() && this.f32796a.store_product != null) {
            if (this.f32799f == null) {
                return "";
            }
    ...
    public final long h() {
        if (this.f32798c == 0) {
            long g10 = g();
            if (g10 != 0) {
                this.f32798c = g10 / this.f32796a.months;
            }
        }
        return this.f32798c;
    }
    ...
    public final long i() {
        if (this.d == 0) {
            long g10 = g();
            if (g10 != 0) {
                this.d = (long) ((g10 / this.f32796a.months) * 12.0d);
            }
        }
        return this.d;
    }
