...
public final class e3 extends vu0 {
    public final int[] f33274a = new int[2];
    public final List f33275b;
    public final h4 f33276c;
    ...
    public final fv0 E(MessageObject messageObject, TLRPC.FileLocation fileLocation, int i10, boolean z10, boolean z11) {
        if (i10 >= 0) {
            List list = this.f33275b;
            if (i10 < list.size()) {
                h4 h4Var = this.f33276c;
                int[] iArr = this.f33274a;
                ImageReceiver c02 = c0(h4Var.f34173u0[0].f35435b, (TL_iv.PageBlock) list.get(i10), iArr);
                if (c02 != null) {
                    fv0 fv0Var = new fv0();
                    fv0Var.f33768b = iArr[0];
                    fv0Var.f33769c = iArr[1];
                    fv0Var.d = h4Var.f34173u0[0].f35435b;
                    fv0Var.f33767a = c02;
                    fv0Var.e = c02.getBitmapSafe();
                    fv0Var.h = c02.getRoundRadius(true);
                    fv0Var.f33773j = h4Var.I0;
                    return fv0Var;
                }
                return null;
            }
    ...
    public final ImageReceiver d0(View view, TL_iv.PageBlock pageBlock, int[] iArr) {
        ...
        if (view instanceof c2) {
            ...
            TextureView textureView = w2Var.f38557n;
            if (w2Var.L == pageBlock) {
                view.getLocationInWindow(iArr);
                h4 h4Var = this.f33276c;
                if (w2Var == h4Var.f38593x && (videoPlayerHolderBase = h4Var.f38592w) != null && videoPlayerHolderBase.firstFrameRendered && textureView.getSurfaceTexture() != null) {
            ...
            ImageReceiver c02 = c0(((j1) view).f34749a, pageBlock, iArr);
            if (c02 != null) {
                return c02;
            }
            return null;
        } else if (view instanceof p2) {
            ImageReceiver c03 = c0(((p2) view).f36497a, pageBlock, iArr);
            if (c03 != null) {
                return c03;
            }
            return null;
            ...
            if (wk0Var2 != null && (d03 = d0(wk0Var2.f42702a, pageBlock, iArr)) != null) {
                return d03;
            }
            return null;
        } else if ((view instanceof a2) && (wk0Var = ((a2) view).d) != null && (d02 = d0(wk0Var.f42702a, pageBlock, iArr)) != null) {
            return d02;
        } else {
            return null;
        }
