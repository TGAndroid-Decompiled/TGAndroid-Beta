...
public final class qu extends FrameLayout {
    public final ImageView f36134a;
    public final TextView f36135b;
    ...
    public qu(bv bvVar, Context context) {
        ...
        int i10;
        int i11;
        setBackgroundColor(bvVar.getThemedColor(org.telegram.ui.ActionBar.j6.f17928d6));
        ImageView imageView = new ImageView(context);
        this.f36134a = imageView;
        ...
        addView(imageView, w7.a6.d(28, 28.0f, i10 | 16, 18.0f, 0.0f, 18.0f, 0.0f));
        ...
        addView(linearLayout, w7.a6.i(-1.0f, -2.0f, i11 | 16, 64.0f, 0.0f, 20.0f, 0.0f));
        ...
        this.f36135b = textView;
        textView.setTextSize(1, 16.0f);
        int i12 = org.telegram.ui.ActionBar.j6.G6;
        textView.setTextColor(bvVar.getThemedColor(i12));
        textView.setEllipsize(TextUtils.TruncateAt.END);
        textView.setSingleLine();
        textView.setLines(1);
        ImageView imageView2 = new ImageView(context);
        this.f36136c = imageView2;
        imageView2.setScaleType(ImageView.ScaleType.FIT_CENTER);
        imageView2.setImageResource(R.drawable.arrow_more);
        imageView2.setColorFilter(new PorterDuffColorFilter(bvVar.getThemedColor(i12), PorterDuff.Mode.MULTIPLY));
        ...
        textView2.setTextColor(bvVar.getThemedColor(org.telegram.ui.ActionBar.j6.f18126o6));
