...
public final class qu extends FrameLayout {
    public final ImageView f37023a;
    public final TextView f37024b;
    public final ImageView f37025c;
    ...
    public qu(bv bvVar, Context context) {
        ...
        int i10;
        int i11;
        setBackgroundColor(bvVar.getThemedColor(org.telegram.ui.ActionBar.j6.f18863d6));
        ImageView imageView = new ImageView(context);
        this.f37023a = imageView;
        ...
        textView2.setTextColor(bvVar.getThemedColor(org.telegram.ui.ActionBar.j6.f19065o6));
