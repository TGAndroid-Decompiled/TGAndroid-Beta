...
public class d10 extends ReplacementSpan {
    public final TextPaint f32905a;
    public final Paint f32906b;
    public StaticLayout f32907c;
    public float d;
    public float e;
    public int f32908f;
    public final int h;
    public CharSequence f32909n;

    public d10(int i10) {
        TextPaint textPaint = new TextPaint(1);
        this.f32905a = textPaint;
    ...
    public final void a() {
        if (this.f32907c == null) {
            StaticLayout staticLayout = new StaticLayout(this.f32909n, this.f32905a, AndroidUtilities.displaySize.x, Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
            this.f32907c = staticLayout;
            this.d = staticLayout.getLineWidth(0);
            this.e = this.f32907c.getHeight();
        }
    }
    ...
    public void draw(Canvas canvas, CharSequence charSequence, int i10, int i11, float f7, int i12, int i13, int i14, Paint paint) {
        ...
        float f10;
        a();
        int i16 = this.f32908f;
        if (i16 == 0) {
            i16 = paint.getColor();
        }
        Paint paint2 = this.f32906b;
        paint2.setColor(i16);
        ...
        TextPaint textPaint = this.f32905a;
