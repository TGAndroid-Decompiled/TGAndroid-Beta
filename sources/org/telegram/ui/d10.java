...
public class d10 extends ReplacementSpan {
    public final TextPaint f32891a;
    public final Paint f32892b;
    public StaticLayout f32893c;
    public float d;
    public float e;
    public int f32894f;
    public final int h;
    public CharSequence f32895n;

    public d10(int i10) {
        TextPaint textPaint = new TextPaint(1);
        this.f32891a = textPaint;
    ...
    public final void a() {
        if (this.f32893c == null) {
            StaticLayout staticLayout = new StaticLayout(this.f32895n, this.f32891a, AndroidUtilities.displaySize.x, Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
            this.f32893c = staticLayout;
            this.d = staticLayout.getLineWidth(0);
            this.e = this.f32893c.getHeight();
        }
    }
    ...
    public void draw(Canvas canvas, CharSequence charSequence, int i10, int i11, float f7, int i12, int i13, int i14, Paint paint) {
        ...
        float f10;
        a();
        int i16 = this.f32894f;
        if (i16 == 0) {
            i16 = paint.getColor();
        }
        Paint paint2 = this.f32892b;
        paint2.setColor(i16);
        ...
        TextPaint textPaint = this.f32891a;
