...
public final class px0 extends org.telegram.ui.Components.ql0 {
        ...
        if (b10 != i10) {
            ...
            if (b10 != i11) {
                ...
                if (b10 != i12) {
                    ...
                    if (b10 != i13 && b10 != privacySettingsActivity.f31998s) {
                        i14 = privacySettingsActivity.secretWebpageRow;
                        if (b10 != i14) {
                            i15 = privacySettingsActivity.webSessionsRow;
                            if (b10 != i15 && (b10 != privacySettingsActivity.f31996n || privacySettingsActivity.getContactsController().getLoadingPrivacyInfo(1))) {
            ...
            if (i10 != i11) {
                ...
                if (i10 != i12) {
                    ...
                    if (i10 != i13) {
                        ...
                        if (i10 != i14 && i10 != privacySettingsActivity.f31996n) {
                            ...
                            if (i10 != i15) {
                                ...
                                if (i10 != i16) {
                                    ...
                                    if (i10 != i17 && i10 != privacySettingsActivity.E) {
                                        if (i10 != privacySettingsActivity.h && i10 != privacySettingsActivity.B && i10 != privacySettingsActivity.f31997r && i10 != privacySettingsActivity.v && i10 != privacySettingsActivity.K && i10 != privacySettingsActivity.F && i10 != privacySettingsActivity.I && i10 != privacySettingsActivity.f32000x) {
                                            if (i10 != 0 && i10 != privacySettingsActivity.f32001y && i10 != privacySettingsActivity.f31995f && i10 != privacySettingsActivity.J && i10 != privacySettingsActivity.C && i10 != privacySettingsActivity.H && i10 != privacySettingsActivity.f31999w) {
                                                        ...
                                                        if (i10 != i20) {
                                                            ...
                                                            if (i10 != i21) {
                                                                if (i10 != privacySettingsActivity.G) {
                                                                    ...
                                                                    if (i10 != i22 && i10 != privacySettingsActivity.f31998s) {
    ...
    public final void v(f2.l1 l1Var, int i10) {
        ...
        if (i42 != 0) {
                ...
                if (i42 != 2) {
                    if (i42 != 3) {
                        if (i42 == 5) {
                            ...
                            org.telegram.ui.Components.k6 k6Var = n8Var.f21439c;
                            ...
                            if (i10 == i34) {
                                ...
                                n8Var.s(LocaleController.getString("AutoDeleteMessages", R.string.AutoDeleteMessages), str6, true, R.drawable.msg2_autodelete, true);
                            } else {
                                String str8 = "";
                                if (i10 != privacySettingsActivity.f31998s) {
                                    ...
                                    if (i10 != i35) {
                                        ...
                                        if (i10 != i36) {
                                            ...
                                            if (i10 != i37) {
                                                ...
                                                if (i10 != i38) {
                                                    ...
                                                    n8Var.s(LocaleController.getString(R.string.Passcode), string2, true, i40, true);
                                                }
                                            } else {
                                            ...
                                            n8Var.s(LocaleController.getString(R.string.TwoStepVerification), str3, true, i41, true);
                                        }
                                    } else {
                                        ...
                                        n8Var.f21444w = 16;
                                        n8Var.f21443s = 58;
                                        org.telegram.ui.ActionBar.k5 k5Var = n8Var.f21437a;
                                        ...
                                        jj0Var.setImageResource(i47);
                                        n8Var.f21442r = true;
                                        n8Var.setWillNotDraw(false);
                                        Switch r02 = n8Var.f21440f;
                                        if (r02 != null) {
                                            r02.setVisibility(8);
                                        }
                    ...
                    r8Var.f(string7, z17, false);
                    return;
                }
                org.telegram.ui.Cells.l4 l4Var = (org.telegram.ui.Cells.l4) view;
                if (i10 == privacySettingsActivity.f31995f) {
                    ...
                    return;
                } else if (i10 == privacySettingsActivity.f32001y) {
                    ...
                    return;
                } else if (i10 == privacySettingsActivity.f31999w) {
            ...
            if (i10 == privacySettingsActivity.B) {
                ...
                return;
            } else if (i10 == privacySettingsActivity.f31997r) {
                ...
                return;
            } else if (i10 == privacySettingsActivity.f32000x) {
        ...
        if (i10 != i11) {
            ...
            if (i10 != i12) {
                ...
                if (i10 == i13) {
                    ...
                    z9Var.c(LocaleController.getString("PrivacyLastSeen", R.string.PrivacyLastSeen), str7, false, true);
                    ...
                    if (i10 != i14) {
                        ...
                        if (i10 != i15) {
                            ...
                            if (i10 != i16) {
                                ...
                                if (i10 != i17) {
                                    ...
                                    if (i10 != i18) {
                                        ...
                                        if (i10 != i19) {
                                            ...
                                            if (i10 != i20) {
                                                ...
                                                if (i10 != i21) {
                                                        ...
                                                        if (i10 != i23) {
                                                            ...
                                                            if (i10 == i24) {
                                                                ...
                                                                if (i10 != i25) {
                                                                    ...
                                                                    z9Var.c(LocaleController.getString("MapPreviewProvider", R.string.MapPreviewProvider), string, privacySettingsActivity.O, true);
                                                            ...
                                                            z9Var.c(LocaleController.getString("DeleteAccountIfAwayFor3", R.string.DeleteAccountIfAwayFor3), str7, privacySettingsActivity.N, false);
                                                    ...
                                                    z9Var.c(u03, x02, false, z13);
                                                    z9Var.getValueImageView().setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20042m6, false), PorterDuff.Mode.MULTIPLY));
                                                    z16 = z12;
                                                }
                                            } else {
                                                ...
                                                z9Var.c(LocaleController.getString("PrivacyForwards", R.string.PrivacyForwards), str7, false, true);
                                            }
                                        } else {
                                            ...
                                            z9Var.c(LocaleController.getString(R.string.PrivacyGifts), str7, false, true);
                                        }
                                    } else {
                                        ...
                                        z9Var.c(LocaleController.getString(R.string.PrivacyBirthday), str7, false, true);
                                    }
                                } else {
                                    ...
                                    z9Var.c(LocaleController.getString(R.string.PrivacyMusic), str7, false, true);
                                }
                            } else {
                                ...
                                z9Var.c(LocaleController.getString("PrivacyBio", R.string.PrivacyBio), str7, false, true);
                            }
                        } else {
                            ...
                            z9Var.c(LocaleController.getString("PrivacyProfilePhoto", R.string.PrivacyProfilePhoto), str7, false, true);
                        }
                    } else {
                        ...
                        z9Var.c(LocaleController.getString("Calls", R.string.Calls), str7, false, true);
                    }
                } else {
                    ...
                    z9Var.c(LocaleController.getString(R.string.PrivacyInvites), str7, false, false);
                }
            } else {
                ...
                z9Var.c(LocaleController.getString("PrivacyPhone", R.string.PrivacyPhone), str7, false, true);
            }
            z16 = z10;
        } else {
    ...
    public final f2.l1 x(ViewGroup viewGroup, int i10) {
        View z9Var;
        Context context = this.f37245c;
        if (i10 != 0) {
            if (i10 != 1) {
                if (i10 != 2) {
                    if (i10 != 4) {
                        if (i10 != 5) {
                            z9Var = new org.telegram.ui.Cells.r8(context);
                        } else {
                            z9Var = new org.telegram.ui.Cells.n8(context);
                        }
                    } else {
                        z9Var = new org.telegram.ui.Cells.y6(context, (b) null);
                    }
                } else {
                    z9Var = new org.telegram.ui.Cells.l4(context);
                }
            } else {
