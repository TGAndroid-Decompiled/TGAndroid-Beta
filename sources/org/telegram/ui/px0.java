...
public final class px0 extends ClickableSpan {
    ...
    public final void onClick(View view) {
        ...
        ((ClipboardManager) ApplicationLoader.applicationContext.getSystemService("clipboard")).setPrimaryClip(ClipData.newPlainText("label", this.f36692a));
        org.telegram.ui.Components.xc a02 = org.telegram.ui.Components.xc.a0(this.f36693b.d);
        String string = LocaleController.getString(R.string.LinkCopied);
        org.telegram.ui.ActionBar.d6 resourceProvider = this.f36693b.d.getResourceProvider();
        a02.getClass();
