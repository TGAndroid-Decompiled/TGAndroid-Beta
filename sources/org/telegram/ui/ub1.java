...
public final class ub1 extends LinearLayout {
    ...
    public void dispatchDraw(Canvas canvas) {
        switch (this.f38424a) {
            case 12:
                ...
                return;
            case 18:
                xh.q1 q1Var = (xh.q1) this.f38425b;
                RectF rectF = q1Var.h;
                RectF rectF2 = q1Var.f46357f;
                RectF rectF3 = q1Var.e;
                Paint paint = q1Var.f46358n;
                ...
                float d = q1Var.f46356c.d(q1Var.f46355b, false);
                double d10 = d;
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        switch (this.f38424a) {
            case 1:
                if (!((di.i) this.f38425b).f7745e0) {
                    return false;
                }
                return super.dispatchTouchEvent(motionEvent);
            case 9:
                ScrollSlidingTextTabStrip scrollSlidingTextTabStrip = (ScrollSlidingTextTabStrip) this.f38425b;
                ...
                if (scrollSlidingTextTabStrip.f22390b != null && scrollSlidingTextTabStrip.f22405n0) {
                    if (motionEvent.getAction() == 0) {
                        ...
                        if (view2 != null) {
                            ...
                            if (i10 != indexOfChild) {
                                org.telegram.ui.Components.ym0 ym0Var = scrollSlidingTextTabStrip.f22390b;
                        ...
                        if (view3 != null) {
                            view3.animate().translationX(0.0f).translationY(0.0f).setDuration(320L).setUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) {
                                ...
                                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                                    switch (r2) {
                                        case 0:
                                            ub1 ub1Var = this.f30105b;
                                            ub1Var.invalidate();
                                            ((ScrollSlidingTextTabStrip) ub1Var.f38425b).invalidate();
                                            return;
                                        default:
                                            ub1 ub1Var2 = this.f30105b;
                                            ub1Var2.invalidate();
                                            ((ScrollSlidingTextTabStrip) ub1Var2.f38425b).invalidate();
                                            return;
                                    }
                                }
                ...
                return super.dispatchTouchEvent(motionEvent);
            case 19:
                if (!((yh.u3) this.f38425b).U.c(0)) {
                    return false;
                }
                return super.dispatchTouchEvent(motionEvent);
            case 20:
                if (!((yh.w7) this.f38425b).f48195f0) {
                    return false;
                }
                return super.dispatchTouchEvent(motionEvent);
            default:
    ...
    public boolean drawChild(Canvas canvas, View view, long j3) {
        switch (this.f38424a) {
            case 5:
                if (view == ((org.telegram.ui.Components.e9) this.f38425b).f23877a) {
                    return true;
                }
                return super.drawChild(canvas, view, j3);
            case 8:
                org.telegram.ui.Components.vm0 vm0Var = (org.telegram.ui.Components.vm0) this.f38425b;
                if (view instanceof org.telegram.ui.Components.ox0) {
                    ((org.telegram.ui.Components.ox0) view).a(vm0Var.f29136i0);
                }
                if (view == vm0Var.f29147s) {
                    return true;
                }
                return super.drawChild(canvas, view, j3);
            case 13:
                boolean drawChild = super.drawChild(canvas, view, j3);
                g70 g70Var = (g70) this.f38425b;
                if (view == g70Var.f33835b && g70Var.f33842x != null) {
                    int measuredHeight = g70Var.f33840s.getMeasuredHeight();
                    g70Var.f33842x.setBounds(0, measuredHeight, getMeasuredWidth(), g70Var.f33842x.getIntrinsicHeight() + measuredHeight);
                    g70Var.f33842x.draw(canvas);
                }
                return drawChild;
            case 17:
                rg.k1 k1Var = ((rg.j1) this.f38425b).f42618c;
                if (view == k1Var.f42643r0 && k1Var.H0) {
                    return true;
                }
                return super.drawChild(canvas, view, j3);
            default:
    ...
    public void invalidate() {
        switch (this.f38424a) {
            case 0:
                ...
                int i10 = 0;
                while (true) {
                    org.telegram.ui.Cells.y0[] y0VarArr = (org.telegram.ui.Cells.y0[]) this.f38425b;
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        switch (this.f38424a) {
            case 16:
                ...
                accessibilityNodeInfo.setVisibleToUser(((mi1) this.f38425b).B0);
                return;
            default:
                super.onInitializeAccessibilityNodeInfo(accessibilityNodeInfo);
                return;
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        switch (this.f38424a) {
            case 4:
                return org.telegram.ui.ActionBar.t4.b((org.telegram.ui.ActionBar.t4) this.f38425b);
            default:
        ...
        switch (this.f38424a) {
            case 6:
                ...
                for (int i15 = 0; i15 < getChildCount(); i15++) {
                    ...
                    if (childAt != ((org.telegram.ui.Components.cw) this.f38425b).f23420s.F && childAt != null) {
                ...
                return;
            case 7:
                ((org.telegram.ui.Components.d20) this.f38425b).f23472c.a(getMeasuredWidth());
    ...
    public void onMeasure(int i10, int i11) {
        ...
        switch (this.f38424a) {
            ...
            case 2:
                ...
                ii.e2 e2Var = (ii.e2) this.f38425b;
            ...
            case 3:
                ...
                ii.c4 c4Var = (ii.c4) this.f38425b;
                ...
                return;
            case 4:
                org.telegram.ui.ActionBar.t4 t4Var = (org.telegram.ui.ActionBar.t4) this.f38425b;
                ...
                return;
            case 6:
                super.onMeasure(Math.max(View.MeasureSpec.getSize(i10), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(((org.telegram.ui.Components.cw) this.f38425b).f30927b.getChildCount() * 32), 1073741824)), i11);
                return;
            case 11:
                super.onMeasure(i10, i11);
                if (LocaleController.isRTL) {
                    ((org.telegram.ui.Components.h41) this.f38425b).f24669c.setPivotX(getMeasuredWidth());
                    return;
                }
                return;
            case 14:
                ...
                if (i14 != 0) {
                    ...
                    if (((PhotoViewer) this.f38425b).f31267j1.getVisibility() == 0) {
                        if (((PhotoViewer) this.f38425b).Y7 < 2) {
                            i12 = 48;
                        } else {
                            i12 = 64;
                        }
                        int max = Math.max(0, (min - AndroidUtilities.dp(i12)) / 2);
                        ((PhotoViewer) this.f38425b).f31267j1.setPadding(max, 0, max, 0);
                    }
            ...
            case 15:
                super.onMeasure(i10, i11);
                zg1 zg1Var = (zg1) this.f38425b;
                ViewGroup.MarginLayoutParams marginLayoutParams7 = (ViewGroup.MarginLayoutParams) zg1Var.f40473c.getLayoutParams();
                int i17 = 0;
                if (zg1Var.f40469a.getVisibility() == 8) {
    ...
    public void setAlpha(float f7) {
        switch (this.f38424a) {
            case 9:
                super.setAlpha(f7);
                ((ScrollSlidingTextTabStrip) this.f38425b).invalidate();
                return;
            default:
                super.setAlpha(f7);
                return;
    ...
    public void setVisibility(int i10) {
        switch (this.f38424a) {
            case 10:
                org.telegram.ui.Components.jx0 jx0Var = (org.telegram.ui.Components.jx0) this.f38425b;
                org.telegram.ui.Components.w9 w9Var = jx0Var.f25545b;
