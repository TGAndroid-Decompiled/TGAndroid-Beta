...
public final class ub1 extends LinearLayout {
    ...
    public void dispatchDraw(Canvas canvas) {
        switch (this.f38425a) {
            case 12:
                ...
                return;
            case 18:
                xh.q1 q1Var = (xh.q1) this.f38426b;
                RectF rectF = q1Var.h;
                RectF rectF2 = q1Var.f46358f;
                RectF rectF3 = q1Var.e;
                Paint paint = q1Var.f46359n;
                paint.setColor(org.telegram.ui.ActionBar.h6.l1(0.1f, org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19041c6, false)));
                float d = q1Var.f46357c.d(q1Var.f46356b, false);
                double d10 = d;
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        switch (this.f38425a) {
            case 1:
                if (!((di.i) this.f38426b).f7745e0) {
                    return false;
                }
                return super.dispatchTouchEvent(motionEvent);
            case 9:
                ScrollSlidingTextTabStrip scrollSlidingTextTabStrip = (ScrollSlidingTextTabStrip) this.f38426b;
                SparseIntArray sparseIntArray = scrollSlidingTextTabStrip.O;
                if (scrollSlidingTextTabStrip.f22390b != null && scrollSlidingTextTabStrip.f22405n0) {
                    if (motionEvent.getAction() == 0) {
                        ...
                        scrollSlidingTextTabStrip.f22393c0 = view;
                        if (view != null && getParent() != null) {
                            sparseIntArray.get(indexOfChild(scrollSlidingTextTabStrip.f22393c0));
                            scrollSlidingTextTabStrip.f22390b.getClass();
                            scrollSlidingTextTabStrip.f22393c0 = null;
                            return super.dispatchTouchEvent(motionEvent);
                        }
                    } else if (motionEvent.getAction() == 2) {
                        View view2 = scrollSlidingTextTabStrip.f22393c0;
                        if (view2 != null) {
                            view2.setTranslationX(motionEvent.getX() - 0.0f);
                            int indexOfChild = indexOfChild(scrollSlidingTextTabStrip.f22393c0);
                            if (scrollSlidingTextTabStrip.f22404n == indexOfChild) {
                            ...
                            float width = (scrollSlidingTextTabStrip.f22393c0.getWidth() / 2.0f) + scrollSlidingTextTabStrip.f22393c0.getX();
                            int width2 = scrollSlidingTextTabStrip.f22393c0.getWidth();
                            if (width < 0.0f) {
                                i10 = 0;
                            } else {
                                i10 = 0;
                            ...
                            if (i10 != indexOfChild) {
                                org.telegram.ui.Components.xm0 xm0Var = scrollSlidingTextTabStrip.f22390b;
                                sparseIntArray.get(i10);
                                xm0Var.getClass();
                            }
                        }
                    } else if (motionEvent.getAction() == 1) {
                        View view3 = scrollSlidingTextTabStrip.f22393c0;
                        if (view3 != null) {
                            view3.animate().translationX(0.0f).translationY(0.0f).setDuration(320L).setUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) {
                                ...
                                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                                    switch (r2) {
                                        case 0:
                                            ub1 ub1Var = this.f29182b;
                                            ub1Var.invalidate();
                                            ((ScrollSlidingTextTabStrip) ub1Var.f38426b).invalidate();
                                            return;
                                        default:
                                            ub1 ub1Var2 = this.f29182b;
                                            ub1Var2.invalidate();
                                            ((ScrollSlidingTextTabStrip) ub1Var2.f38426b).invalidate();
                                            return;
                                    }
                                }
                        ...
                        View view4 = scrollSlidingTextTabStrip.f22393c0;
                        if (view4 != null) {
                    ...
                    if (scrollSlidingTextTabStrip.f22393c0 != null || super.dispatchTouchEvent(motionEvent)) {
                        return true;
                    }
                    return false;
                }
                return super.dispatchTouchEvent(motionEvent);
            case 19:
                if (!((yh.u3) this.f38426b).U.c(0)) {
                    return false;
                }
                return super.dispatchTouchEvent(motionEvent);
            case 20:
                if (!((yh.w7) this.f38426b).f48196f0) {
                    return false;
                }
                return super.dispatchTouchEvent(motionEvent);
            default:
    ...
    public boolean drawChild(Canvas canvas, View view, long j3) {
        switch (this.f38425a) {
            case 5:
                if (view == ((org.telegram.ui.Components.e9) this.f38426b).f23878a) {
                    return true;
                }
                return super.drawChild(canvas, view, j3);
            case 8:
                org.telegram.ui.Components.um0 um0Var = (org.telegram.ui.Components.um0) this.f38426b;
                if (view instanceof org.telegram.ui.Components.nx0) {
                    ((org.telegram.ui.Components.nx0) view).a(um0Var.f28824i0);
                }
                if (view == um0Var.f28835s) {
                    return true;
                }
                return super.drawChild(canvas, view, j3);
            case 13:
                boolean drawChild = super.drawChild(canvas, view, j3);
                g70 g70Var = (g70) this.f38426b;
                if (view == g70Var.f33836b && g70Var.f33843x != null) {
                    int measuredHeight = g70Var.f33841s.getMeasuredHeight();
                    g70Var.f33843x.setBounds(0, measuredHeight, getMeasuredWidth(), g70Var.f33843x.getIntrinsicHeight() + measuredHeight);
                    g70Var.f33843x.draw(canvas);
                }
                return drawChild;
            case 17:
                rg.k1 k1Var = ((rg.j1) this.f38426b).f42619c;
                if (view == k1Var.f42644r0 && k1Var.H0) {
                    return true;
                }
                return super.drawChild(canvas, view, j3);
            default:
    ...
    public void invalidate() {
        switch (this.f38425a) {
            case 0:
                ...
                int i10 = 0;
                while (true) {
                    org.telegram.ui.Cells.y0[] y0VarArr = (org.telegram.ui.Cells.y0[]) this.f38426b;
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        switch (this.f38425a) {
            case 16:
                ...
                accessibilityNodeInfo.setVisibleToUser(((mi1) this.f38426b).B0);
                return;
            default:
                super.onInitializeAccessibilityNodeInfo(accessibilityNodeInfo);
                return;
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        switch (this.f38425a) {
            case 4:
                return org.telegram.ui.ActionBar.t4.b((org.telegram.ui.ActionBar.t4) this.f38426b);
            default:
        ...
        switch (this.f38425a) {
            case 6:
                ...
                for (int i15 = 0; i15 < getChildCount(); i15++) {
                    ...
                    if (childAt != ((org.telegram.ui.Components.bw) this.f38426b).f23110s.F && childAt != null) {
                ...
                return;
            case 7:
                ((org.telegram.ui.Components.c20) this.f38426b).f23157c.a(getMeasuredWidth());
            ...
            case 9:
                ...
                if (scrollSlidingTextTabStrip.f22403l0 && sparseIntArray.indexOfKey(scrollSlidingTextTabStrip.f22406r) >= 0 && scrollSlidingTextTabStrip.f22388a.getChildAt(sparseIntArray.get(scrollSlidingTextTabStrip.f22406r)) != null) {
                    scrollSlidingTextTabStrip.i(sparseIntArray.get(scrollSlidingTextTabStrip.f22406r), false);
                    scrollSlidingTextTabStrip.f22403l0 = false;
                    return;
                }
                return;
        }
    ...
    public void onMeasure(int i10, int i11) {
        ...
        switch (this.f38425a) {
            ...
            case 2:
                ...
                ii.e2 e2Var = (ii.e2) this.f38426b;
            ...
            case 3:
                ...
                ii.c4 c4Var = (ii.c4) this.f38426b;
                ...
                return;
            case 4:
                org.telegram.ui.ActionBar.t4 t4Var = (org.telegram.ui.ActionBar.t4) this.f38426b;
                ...
                return;
            case 6:
                super.onMeasure(Math.max(View.MeasureSpec.getSize(i10), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(((org.telegram.ui.Components.bw) this.f38426b).f30650b.getChildCount() * 32), 1073741824)), i11);
                return;
            case 11:
                super.onMeasure(i10, i11);
                if (LocaleController.isRTL) {
                    ((org.telegram.ui.Components.g41) this.f38426b).f24365c.setPivotX(getMeasuredWidth());
                    return;
                }
                return;
            case 14:
                ...
                if (i14 != 0) {
                    ...
                    if (((PhotoViewer) this.f38426b).f31268j1.getVisibility() == 0) {
                        if (((PhotoViewer) this.f38426b).Y7 < 2) {
                            i12 = 48;
                        } else {
                            i12 = 64;
                        }
                        int max = Math.max(0, (min - AndroidUtilities.dp(i12)) / 2);
                        ((PhotoViewer) this.f38426b).f31268j1.setPadding(max, 0, max, 0);
                    }
            ...
            case 15:
                super.onMeasure(i10, i11);
                zg1 zg1Var = (zg1) this.f38426b;
                ViewGroup.MarginLayoutParams marginLayoutParams7 = (ViewGroup.MarginLayoutParams) zg1Var.f40474c.getLayoutParams();
                int i17 = 0;
                if (zg1Var.f40470a.getVisibility() == 8) {
    ...
    public void setAlpha(float f7) {
        switch (this.f38425a) {
            case 9:
                super.setAlpha(f7);
                ((ScrollSlidingTextTabStrip) this.f38426b).invalidate();
                return;
            default:
                super.setAlpha(f7);
                return;
    ...
    public void setVisibility(int i10) {
        switch (this.f38425a) {
            case 10:
                org.telegram.ui.Components.ix0 ix0Var = (org.telegram.ui.Components.ix0) this.f38426b;
                org.telegram.ui.Components.w9 w9Var = ix0Var.f25189b;
