...
public final class jb extends sb {
    public final hh.l f34910x0;
    public final vb f34911y0;

    public jb(vb vbVar, Context context) {
        super(vbVar, context);
        this.f34911y0 = vbVar;
        this.f34910x0 = new hh.l();
    }
    ...
    public final void onAttachedToWindow() {
        ...
        if (playingMessageObject != null && playingMessageObject.isRoundVideo() && playingMessageObject.eventId != 0) {
            ...
            if (dialogId == (-vbVar.f38501f.f18343id)) {
                MediaController.getInstance().setTextureView(vbVar.Q0(false), vbVar.f38500e0, vbVar.f38499d0, true);
            }
        }
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        vb vbVar = this.f34911y0;
        fh.a aVar = vbVar.f38493a.f9081a;
        ...
        for (int i12 = 0; i12 < childCount; i12++) {
            ...
            if (childAt != null && childAt.getVisibility() != 8) {
                ...
                if (childAt != kVar4) {
                    if (childAt != vbVar.v && childAt != vbVar.f38509n) {
                        if (childAt == vbVar.H) {
