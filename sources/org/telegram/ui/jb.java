...
public final class jb extends sb {
    public final hh.l f34885x0;
    public final vb f34886y0;

    public jb(vb vbVar, Context context) {
        super(vbVar, context);
        this.f34886y0 = vbVar;
        this.f34885x0 = new hh.l();
    }
    ...
    public final void onAttachedToWindow() {
        ...
        if (playingMessageObject != null && playingMessageObject.isRoundVideo() && playingMessageObject.eventId != 0) {
            ...
            if (dialogId == (-vbVar.f38480f.f18328id)) {
                MediaController.getInstance().setTextureView(vbVar.Q0(false), vbVar.f38479e0, vbVar.f38478d0, true);
            }
        }
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        vb vbVar = this.f34886y0;
        fh.a aVar = vbVar.f38472a.f9081a;
        ...
        for (int i12 = 0; i12 < childCount; i12++) {
            ...
            if (childAt != null && childAt.getVisibility() != 8) {
                ...
                if (childAt != kVar4) {
                    if (childAt != vbVar.v && childAt != vbVar.f38488n) {
                        if (childAt == vbVar.H) {
