...
public final class kp implements Runnable {
    ...
    public final up f35218b;
    public final org.telegram.ui.ActionBar.b2[] f35219c;
    public final int d;

    public kp(up upVar, org.telegram.ui.ActionBar.b2[] b2VarArr, int i10, int i11) {
        this.f35217a = i11;
        this.f35218b = upVar;
        this.f35219c = b2VarArr;
        this.d = i10;
    }
    ...
    public final void run() {
        switch (this.f35217a) {
            case 0:
                org.telegram.ui.ActionBar.b2[] b2VarArr = this.f35219c;
                org.telegram.ui.ActionBar.b2 b2Var = b2VarArr[0];
                if (b2Var != null) {
                    final up upVar = this.f35218b;
                ...
                return;
            default:
                org.telegram.ui.ActionBar.b2[] b2VarArr2 = this.f35219c;
                org.telegram.ui.ActionBar.b2 b2Var2 = b2VarArr2[0];
                if (b2Var2 != null) {
                    final up upVar2 = this.f35218b;
