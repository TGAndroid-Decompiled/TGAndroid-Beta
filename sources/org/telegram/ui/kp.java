...
public final class kp extends LinearLayout implements NotificationCenter.NotificationCenterDelegate {
    public org.telegram.ui.Components.w9 f35086a;
    public org.telegram.ui.Components.t90 f35087b;
    public int f35088c;

    public final void a() {
        boolean z10;
        org.telegram.ui.Components.w9 w9Var = this.f35086a;
        ...
        if (tL_messages_stickerSet != null && tL_messages_stickerSet.documents.size() >= 3) {
            w9Var.i(ImageLocation.getForDocument(tL_messages_stickerSet.documents.get(2)), "104_104", "tgs", this.f35087b, tL_messages_stickerSet);
            return;
        }
        ...
        w9Var.setImageDrawable(this.f35087b);
    }
    ...
    public final void onAttachedToWindow() {
        ...
        a();
        NotificationCenter.getInstance(this.f35088c).addObserver(this, NotificationCenter.diceStickersDidLoad);
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        NotificationCenter.getInstance(this.f35088c).removeObserver(this, NotificationCenter.diceStickersDidLoad);
    }
}
