...
public final class kp extends org.telegram.ui.Components.ll0 {
    public static final int f38127b3 = 0;
    public final jp X2;
    public boolean Y2;
    public final Paint Z2;
    public final lp f38128a3;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (i10 < i11) {
            int v02 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20691d6, this.f28252p2);
            Paint paint = this.Z2;
            paint.setColor(v02);
            canvas2 = canvas;
            ...
            if (arrayList.get(i11) == tL_username) {
                ...
                if (i11 >= 0 && i11 < arrayList.size() && (tL_username2 = (TLRPC.TL_username) arrayList.get(i11)) != null) {
                        ...
                        if (RecyclerView.R(childAt) == i12) {
                            ...
                            if (childAt instanceof na) {
                                ...
                                if (tL_username3 != null) {
                                    naVar.a(tL_username3, naVar.f38918w, true, naVar.f38919x);
                                }
                            }
                        } else {
                            i17++;
                    ...
                    if (i13 >= 0 && i12 != i13) {
                        int i18 = i13 - 1;
                        jp jpVar = this.X2;
                        ArrayList arrayList2 = jpVar.f37853c.f38128a3.N;
