...
public final class se implements Runnable {
    ...
    public final bo f37377b;
    public final MessageObject f37378c;

    public se(bo boVar, MessageObject messageObject, int i10) {
        this.f37376a = i10;
        this.f37377b = boVar;
        this.f37378c = messageObject;
    }
    ...
    public final void run() {
        ...
        switch (this.f37376a) {
            case 0:
                MessageObject messageObject = this.f37378c;
                TLRPC.MessageMedia messageMedia = messageObject.messageOwner.media;
                if (messageMedia != null && (webPage = messageMedia.webpage) != null && webPage.cached_page != null) {
                    LaunchActivity launchActivity = LaunchActivity.G1;
                    if (launchActivity == null || launchActivity.P() == null || LaunchActivity.G1.P().l(messageObject) == null) {
                        this.f37377b.createArticleViewer(false).N(messageObject, null, null, null);
                        return;
                    }
                    return;
                }
                return;
            case 1:
                bo boVar = this.f37377b;
                boVar.getClass();
                MessageObject messageObject2 = this.f37378c;
            ...
            case 2:
                int id2 = this.f37378c.getId();
                bo boVar2 = this.f37377b;
                boVar2.Xa(id2, 0, true, 0, true, 0, null, null, new ug(boVar2, 13));
                if (boVar2.f32325h6.isEmpty()) {
                    boVar2.Lb(false);
                    return;
                }
                return;
            case 3:
                bo boVar3 = this.f37377b;
                boVar3.getClass();
                MessageObject messageObject3 = this.f37378c;
                int replyMsgId = messageObject3.getReplyMsgId();
                int i15 = messageObject3.messageOwner.f18130id;
                ...
                return;
            case 4:
                bo boVar4 = this.f37377b;
                boVar4.getClass();
                MessageObject messageObject4 = this.f37378c;
                int replyMsgId2 = messageObject4.getReplyMsgId();
                int i16 = messageObject4.messageOwner.f18130id;
                ...
                return;
            case 5:
                bo boVar5 = this.f37377b;
                boVar5.getClass();
                MessageObject messageObject5 = this.f37378c;
                int replyMsgId3 = messageObject5.getReplyMsgId();
                int i17 = messageObject5.messageOwner.f18130id;
                ...
                return;
            case 6:
                bo boVar6 = this.f37377b;
                boVar6.getClass();
                MessageObject messageObject6 = this.f37378c;
            ...
            case 7:
                bo boVar7 = this.f37377b;
                boVar7.getMessagesController().pinMessage(boVar7.e, boVar7.f32295f, this.f37378c.getId(), true, false, false);
                boVar7.A3 = null;
                return;
            default:
                bo boVar8 = this.f37377b;
                org.telegram.ui.Components.vc.a0(boVar8).c(LocaleController.getString(R.string.AdHidden)).j();
                MessageObject messageObject7 = this.f37378c;
