...
public final class o90 implements Runnable {
    public final int f39140a = 1;
    public final LaunchActivity f39141b;
    public final Bundle f39142c;
    public final Long d;
    public final r80 f39143e;
    public final boolean f39144f;
    public final of.e h;
    public final Long f39145n;
    public final Integer f39146r;
    public final Integer f39147s;
    public final byte[] v;
    public final org.telegram.ui.ActionBar.n2 f39148w;
    public final int f39149x;
    public final Object f39150y;
    ...
    public final void run() {
        ...
        Object obj = this.f39150y;
        switch (i10) {
            case 0:
                r80 r80Var = this.f39143e;
                ...
                LaunchActivity launchActivity = this.f39141b;
                if (z10) {
                    ...
                    if (!tL_messages_chats.chats.isEmpty()) {
                        ...
                        Long l4 = this.d;
                        if (chat != null && this.f39144f && ChatObject.isBoostSupported(chat)) {
                            launchActivity.s0(Long.valueOf(-l4.longValue()), null, this.h, null);
                        } else if (chat != null && chat.forum) {
                            Long l10 = this.f39145n;
                            Integer num = this.f39147s;
                            byte[] bArr = this.v;
                            if (l10 != null) {
                                launchActivity.k0(-l4.longValue(), this.f39146r, null, num, bArr, null, 0, -1);
                            } else {
                                launchActivity.k0(-l4.longValue(), null, null, num, bArr, null, 0, -1);
                            }
                        }
                        org.telegram.ui.ActionBar.n2 n2Var = this.f39148w;
                        Bundle bundle = this.f39142c;
                        if (n2Var == null || MessagesController.getInstance(this.f39149x).checkCanOpenChat(bundle, n2Var)) {
            ...
            default:
                ...
                LaunchActivity launchActivity2 = this.f39141b;
                org.telegram.ui.ActionBar.d5 O = launchActivity2.O();
                Bundle bundle2 = this.f39142c;
                if (!((ActionBarLayout) O).P(new co(bundle2))) {
                    ...
                    iArr[0] = ConnectionsManager.getInstance(launchActivity2.O).sendRequest(tL_channels_getChannels, new org.telegram.messenger.g1(launchActivity2, this.f39143e, this.f39144f, l11, this.h, this.f39145n, this.f39146r, this.f39147s, this.v, this.f39148w, this.f39149x, bundle2));
                    return;
                }
                return;
        }
