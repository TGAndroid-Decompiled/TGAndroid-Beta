...
public final class o90 implements Runnable {
    public final int f39167a = 1;
    public final LaunchActivity f39168b;
    public final Bundle f39169c;
    public final Long d;
    public final r80 f39170e;
    public final boolean f39171f;
    public final of.e h;
    public final Long f39172n;
    public final Integer f39173r;
    public final Integer f39174s;
    public final byte[] v;
    public final org.telegram.ui.ActionBar.n2 f39175w;
    public final int f39176x;
    public final Object f39177y;
    ...
    public final void run() {
        ...
        Object obj = this.f39177y;
        switch (i10) {
            case 0:
                r80 r80Var = this.f39170e;
                ...
                LaunchActivity launchActivity = this.f39168b;
                if (z10) {
                    ...
                    if (!tL_messages_chats.chats.isEmpty()) {
                        ...
                        Long l4 = this.d;
                        if (chat != null && this.f39171f && ChatObject.isBoostSupported(chat)) {
                            launchActivity.s0(Long.valueOf(-l4.longValue()), null, this.h, null);
                        } else if (chat != null && chat.forum) {
                            Long l10 = this.f39172n;
                            Integer num = this.f39174s;
                            byte[] bArr = this.v;
                            if (l10 != null) {
                                launchActivity.k0(-l4.longValue(), this.f39173r, null, num, bArr, null, 0, -1);
                            } else {
                                launchActivity.k0(-l4.longValue(), null, null, num, bArr, null, 0, -1);
                            }
                        }
                        org.telegram.ui.ActionBar.n2 n2Var = this.f39175w;
                        Bundle bundle = this.f39169c;
                        if (n2Var == null || MessagesController.getInstance(this.f39176x).checkCanOpenChat(bundle, n2Var)) {
            ...
            default:
                ...
                LaunchActivity launchActivity2 = this.f39168b;
                org.telegram.ui.ActionBar.d5 O = launchActivity2.O();
                Bundle bundle2 = this.f39169c;
                if (!((ActionBarLayout) O).P(new co(bundle2))) {
                    ...
                    iArr[0] = ConnectionsManager.getInstance(launchActivity2.O).sendRequest(tL_channels_getChannels, new org.telegram.messenger.g1(launchActivity2, this.f39170e, this.f39171f, l11, this.h, this.f39172n, this.f39173r, this.f39174s, this.v, this.f39175w, this.f39176x, bundle2));
                    return;
                }
                return;
        }
