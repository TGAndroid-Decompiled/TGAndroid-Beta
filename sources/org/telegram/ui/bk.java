...
public final class bk extends s4.s0 {
    ...
    public final co d;
    public float f34825a = 0.0f;
    public final int f34827c = AndroidUtilities.dp(100.0f);
    ...
    public final void a(RecyclerView recyclerView, int i10) {
        co coVar = this.d;
        if (i10 == 0) {
            org.telegram.ui.Cells.t1 t1Var = coVar.f35373p2;
            if (t1Var != null) {
                coVar.f35350n2.e(t1Var, -1, coVar.f35385q2, coVar.f35398r2, true);
                coVar.f35373p2 = null;
            }
            coVar.j3 = false;
            coVar.f35314k3 = false;
            coVar.f35326l3 = false;
            coVar.f35337m3 = false;
            coVar.f9(true);
            coVar.g9(true);
            ...
            coVar.f35474x0.setOverScrollMode(0);
            coVar.f35222c9.W();
            coVar.Wc(false);
            coVar.q9(1);
            coVar.f35420sa = false;
            return;
        }
        di.f4 f4Var = coVar.f35488y1;
    ...
    public final void b(RecyclerView recyclerView, int i10, int i11) {
        ...
        this.f34826b = z10;
        int L0 = coVar.f35499z0.L0();
        aa.a aVar = null;
        if (((i11 != 0 && coVar.f35420sa && recyclerView.getScrollState() == 2) || recyclerView.getScrollState() == 1) && coVar.N4 != 0) {
            if (this.f34826b && !coVar.O4) {
                if (!coVar.f35474x0.X1 && L0 != -1) {
                    int N0 = coVar.f35499z0.N0();
                    MessageObject messageObject = null;
                    while (true) {
                        if (N0 >= L0) {
                            View m10 = coVar.f35499z0.m(N0);
        ...
        if (i11 != 0 && coVar.j3 && !coVar.f35254f3) {
        ...
        if (coVar.t9() && i11 != 0 && coVar.f35314k3 && !coVar.f35254f3) {
            if (coVar.L7 != Integer.MAX_VALUE) {
                coVar.Ia();
                coVar.Wc(false);
            }
        ...
        if (L0 != -1) {
            ...
            if (L0 == 0 && coVar.E6[0]) {
                if (i11 >= 0) {
                    coVar.f35272g9 = false;
                    coVar.vc();
                }
            } else {
                aa.a[] aVarArr = coVar.f35300j1.f14967e;
                if (1 < aVarArr.length) {
                    aVar = aVarArr[1];
                }
                ...
                } else if (coVar.f35312k1 && z12) {
                    float f10 = this.f34825a + i11;
                    this.f34825a = f10;
                    if (f10 < (-i12)) {
                        coVar.f35272g9 = false;
                        coVar.vc();
        ...
        coVar.r9();
        coVar.f35222c9.H();
        ArrayList arrayList = coVar.f35484xa.F;
        for (int i13 = 0; i13 < arrayList.size(); i13++) {
            if (!((fz) arrayList.get(i13)).f36499c) {
                ((fz) arrayList.get(i13)).f36498b -= i11;
            }
        }
        ah.e1 e1Var = ah.e1.B;
        if (e1Var != null) {
