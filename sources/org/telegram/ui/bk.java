...
public final class bk extends s4.s0 {
    ...
    public final co d;
    public float f34852a = 0.0f;
    public final int f34854c = AndroidUtilities.dp(100.0f);
    ...
    public final void a(RecyclerView recyclerView, int i10) {
        co coVar = this.d;
        if (i10 == 0) {
            org.telegram.ui.Cells.t1 t1Var = coVar.f35400p2;
            if (t1Var != null) {
                coVar.f35377n2.e(t1Var, -1, coVar.f35412q2, coVar.f35425r2, true);
                coVar.f35400p2 = null;
            }
            coVar.j3 = false;
            coVar.f35341k3 = false;
            coVar.f35353l3 = false;
            coVar.f35364m3 = false;
            coVar.f9(true);
            coVar.g9(true);
            ...
            coVar.f35501x0.setOverScrollMode(0);
            coVar.f35249c9.W();
            coVar.Wc(false);
            coVar.q9(1);
            coVar.f35447sa = false;
            return;
        }
        di.f4 f4Var = coVar.f35515y1;
    ...
    public final void b(RecyclerView recyclerView, int i10, int i11) {
        ...
        this.f34853b = z10;
        int L0 = coVar.f35526z0.L0();
        aa.a aVar = null;
        if (((i11 != 0 && coVar.f35447sa && recyclerView.getScrollState() == 2) || recyclerView.getScrollState() == 1) && coVar.N4 != 0) {
            if (this.f34853b && !coVar.O4) {
                if (!coVar.f35501x0.X1 && L0 != -1) {
                    int N0 = coVar.f35526z0.N0();
                    MessageObject messageObject = null;
                    while (true) {
                        if (N0 >= L0) {
                            View m10 = coVar.f35526z0.m(N0);
        ...
        if (i11 != 0 && coVar.j3 && !coVar.f35281f3) {
        ...
        if (coVar.t9() && i11 != 0 && coVar.f35341k3 && !coVar.f35281f3) {
            if (coVar.L7 != Integer.MAX_VALUE) {
                coVar.Ia();
                coVar.Wc(false);
            }
        ...
        if (L0 != -1) {
            ...
            if (L0 == 0 && coVar.E6[0]) {
                if (i11 >= 0) {
                    coVar.f35299g9 = false;
                    coVar.vc();
                }
            } else {
                aa.a[] aVarArr = coVar.f35327j1.f14993e;
                if (1 < aVarArr.length) {
                    aVar = aVarArr[1];
                }
                ...
                int i12 = this.f34854c;
                if (i11 > 0) {
                    if (!z12) {
                        float f7 = this.f34852a + i11;
                        this.f34852a = f7;
                        if (f7 > i12) {
                            this.f34852a = 0.0f;
                            coVar.f35299g9 = true;
                ...
                } else if (coVar.f35339k1 && z12) {
                    float f10 = this.f34852a + i11;
                    this.f34852a = f10;
                    if (f10 < (-i12)) {
                        coVar.f35299g9 = false;
                        coVar.vc();
        ...
        coVar.r9();
        coVar.f35249c9.H();
        ArrayList arrayList = coVar.f35511xa.F;
        for (int i13 = 0; i13 < arrayList.size(); i13++) {
            if (!((fz) arrayList.get(i13)).f36526c) {
                ((fz) arrayList.get(i13)).f36525b -= i11;
            }
        }
        ah.e1 e1Var = ah.e1.B;
        if (e1Var != null) {
