...
public final class ar0 extends org.telegram.ui.Components.ll0 {
    ...
    public final boolean D(s4.c1 c1Var) {
        ...
        if (cr0Var.J == null) {
            if (TextUtils.isEmpty(cr0Var.v)) {
                ...
                return true;
            } else if (c1Var.b() >= cr0Var.f32879f.size()) {
                return false;
            } else {
                return true;
            }
    ...
    public final int h() {
        ...
        if (albumEntry == null) {
            if (cr0Var.f32879f.isEmpty()) {
                if (!TextUtils.isEmpty(cr0Var.v) || cr0Var.f32887n.isEmpty()) {
                    return 0;
                }
                return cr0Var.f32887n.size() + 2;
            }
            return cr0Var.f32879f.size() + (!cr0Var.f32894s ? 1 : 0);
        }
    ...
    public final int j(int i10) {
        ...
        if (cr0Var.f32879f.isEmpty()) {
            if (i10 == cr0Var.f32887n.size()) {
                return 4;
            }
            return 3;
        } else if (i10 < cr0Var.f32879f.size()) {
            return 0;
        } else {
            return 1;
        }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        cr0 cr0Var = this.d;
        MediaController.AlbumEntry albumEntry = cr0Var.J;
        ArrayList arrayList = cr0Var.f32887n;
        ArrayList arrayList2 = cr0Var.f32875c;
        HashMap hashMap = cr0Var.f32873b;
            ...
            if (i10 != 1) {
                if (i10 != 2) {
                    if (i10 != 3) {
                        ...
                        viewGroup2 = r8Var;
                        if (z10) {
                            r8Var.f20814a.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, cr0Var.f32898v0, false));
                            r8Var.e.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19128rg, false), PorterDuff.Mode.MULTIPLY));
                            viewGroup2 = r8Var;
                        }
                    }
                } else {
