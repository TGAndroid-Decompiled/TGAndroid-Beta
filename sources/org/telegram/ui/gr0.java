...
public final class gr0 extends org.telegram.ui.ActionBar.n2 {
    public static final org.telegram.ui.Components.jr0 f33989y = new org.telegram.ui.Components.jr0(4);
    public final ar0 f33990a;
    public final ar0 f33991b;
    public org.telegram.ui.ActionBar.v0 f33992c;
    public org.telegram.ui.Components.ju d;
    public boolean e;
    public final Paint f33993f;
    public ScrollSlidingTextTabStrip h;
    public final er0[] f33994n;
    public AnimatorSet f33995r;
    public boolean f33996s;
    public boolean v;
    public boolean f33997w;
    public int f33998x;

    public gr0(HashMap hashMap, ArrayList arrayList, int i10, boolean z10, bo boVar) {
        super(null);
        this.e = true;
        this.f33993f = new Paint();
        this.f33994n = new er0[2];
        this.f33990a = new ar0(0, null, hashMap, arrayList, i10, z10, boVar, false);
        this.f33991b = new ar0(1, null, hashMap, arrayList, i10, z10, boVar, false);
    }
    ...
    public static void h0(gr0 gr0Var, String str) {
        gr0Var.f33992c.getSearchField().setText(str);
        gr0Var.f33992c.getSearchField().setSelection(str.length());
        gr0Var.actionBar.w();
    }
    ...
    public final View createView(Context context) {
        er0[] er0VarArr;
        View view;
        this.actionBar.setBackgroundColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18907h5, false));
        ...
        EditTextBoldCursor searchField = this.f33992c.getSearchField();
        ...
        this.f33998x = ViewConfiguration.get(context).getScaledMaximumFlingVelocity();
        dr0 dr0Var = new dr0(this, context);
        this.fragmentView = dr0Var;
        dr0Var.setWillNotDraw(false);
        ar0 ar0Var = this.f33990a;
        ar0Var.setParentFragment(this);
        org.telegram.ui.Components.ju juVar = ar0Var.f31914d0;
        this.d = juVar;
        ...
        for (int i13 = 0; i13 < 4; i13++) {
            if (i13 != 0) {
                if (i13 != 1) {
                    if (i13 != 2) {
                        view = ar0Var.f31913c0;
                    } else {
                        view = ar0Var.f31911b0;
                    }
                } else {
                    view = ar0Var.f31909a0;
                }
            } else {
                view = ar0Var.Z;
            }
        ...
        j0 j0Var = ar0Var.f31909a0;
        s50 s50Var = ar0Var.f31911b0;
        View view2 = ar0Var.f31913c0;
        org.telegram.ui.Components.ju juVar2 = ar0Var.f31914d0;
        ar0 ar0Var2 = this.f33991b;
        ar0Var2.Z = frameLayout;
        ar0Var2.f31909a0 = j0Var;
        ar0Var2.f31914d0 = juVar2;
        ar0Var2.f31911b0 = s50Var;
        ar0Var2.f31913c0 = view2;
        ar0Var2.f31928q0 = false;
        ar0Var2.setParentFragment(this);
        int i14 = 0;
        while (true) {
            er0VarArr = this.f33994n;
            ...
            if (i14 == 0) {
                ...
                er0Var2.f33390a = ar0Var;
                er0Var2.d = ar0Var.K;
            } else if (i14 == 1) {
                er0 er0Var3 = er0VarArr[i14];
                er0Var3.f33390a = ar0Var2;
                er0Var3.d = ar0Var2.K;
                er0Var3.setVisibility(8);
            }
            er0VarArr[i14].d.setScrollingTouchSlop(1);
            er0 er0Var4 = er0VarArr[i14];
            er0Var4.f33391b = (FrameLayout) er0Var4.f33390a.getFragmentView();
            er0VarArr[i14].d.setClipToPadding(false);
            er0 er0Var5 = er0VarArr[i14];
            er0Var5.f33392c = er0Var5.f33390a.getActionBar();
            er0 er0Var6 = er0VarArr[i14];
            er0Var6.addView(er0Var6.f33391b, w7.x5.c(-1.0f, -1));
            er0 er0Var7 = er0VarArr[i14];
            er0Var7.addView(er0Var7.f33392c, w7.x5.c(-2.0f, -1));
            er0VarArr[i14].f33392c.setVisibility(8);
        ...
        dr0Var.addView(ar0Var.f31909a0, w7.x5.d(60, 60.0f, 85, 0.0f, 0.0f, 12.0f, 10.0f));
        dr0Var.addView(ar0Var.f31911b0, w7.x5.d(42, 24.0f, 85, 0.0f, 0.0f, -2.0f, 9.0f));
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f33992c.getSearchField(), 16777216, null, null, null, null, i11));
        ...
        arrayList.addAll(this.f33990a.getThemeDescriptions());
        arrayList.addAll(this.f33991b.getThemeDescriptions());
        return arrayList;
    }
    ...
    public final void onResume() {
        super.onResume();
        org.telegram.ui.ActionBar.v0 v0Var = this.f33992c;
        if (v0Var != null) {
            v0Var.z(true);
