...
public final class gr0 extends org.telegram.ui.ActionBar.n2 {
    public static final org.telegram.ui.Components.ir0 f36752y = new org.telegram.ui.Components.ir0(4);
    public final br0 f36753a;
    public final br0 f36754b;
    public org.telegram.ui.ActionBar.v0 f36755c;
    public org.telegram.ui.Components.hu d;
    public boolean f36756e;
    public final Paint f36757f;
    public ScrollSlidingTextTabStrip h;
    public final er0[] f36758n;
    public AnimatorSet f36759r;
    ...
    public gr0(HashMap hashMap, ArrayList arrayList, int i10, boolean z10, co coVar) {
        ...
        this.f36758n = new er0[2];
        this.f36753a = new br0(0, null, hashMap, arrayList, i10, z10, coVar, false);
        this.f36754b = new br0(1, null, hashMap, arrayList, i10, z10, coVar, false);
    }
    ...
    public static void h0(gr0 gr0Var, String str) {
        gr0Var.f36755c.getSearchField().setText(str);
        gr0Var.f36755c.getSearchField().setSelection(str.length());
        gr0Var.actionBar.w();
    }
    ...
    public final View createView(Context context) {
        er0[] er0VarArr;
        View view;
        this.actionBar.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20735h5, false));
        ...
        EditTextBoldCursor searchField = this.f36755c.getSearchField();
        ...
        this.f36762x = ViewConfiguration.get(context).getScaledMaximumFlingVelocity();
        dr0 dr0Var = new dr0(this, context);
        this.fragmentView = dr0Var;
        dr0Var.setWillNotDraw(false);
        br0 br0Var = this.f36753a;
        br0Var.setParentFragment(this);
        org.telegram.ui.Components.hu huVar = br0Var.f34888d0;
        this.d = huVar;
        ...
        for (int i13 = 0; i13 < 4; i13++) {
            if (i13 != 0) {
                if (i13 != 1) {
                    if (i13 != 2) {
                        view = br0Var.f34887c0;
                    } else {
                        view = br0Var.f34885b0;
                    }
                } else {
                    view = br0Var.f34883a0;
                }
            } else {
                view = br0Var.Z;
            }
        ...
        j0 j0Var = br0Var.f34883a0;
        t50 t50Var = br0Var.f34885b0;
        View view2 = br0Var.f34887c0;
        org.telegram.ui.Components.hu huVar2 = br0Var.f34888d0;
        br0 br0Var2 = this.f36754b;
        br0Var2.Z = frameLayout;
        br0Var2.f34883a0 = j0Var;
        br0Var2.f34888d0 = huVar2;
        br0Var2.f34885b0 = t50Var;
        br0Var2.f34887c0 = view2;
        br0Var2.f34903q0 = false;
        br0Var2.setParentFragment(this);
        int i14 = 0;
        while (true) {
            er0VarArr = this.f36758n;
            ...
            if (i14 == 0) {
                ...
                er0Var2.f36155a = br0Var;
                er0Var2.d = br0Var.K;
            } else if (i14 == 1) {
                er0 er0Var3 = er0VarArr[i14];
                er0Var3.f36155a = br0Var2;
                er0Var3.d = br0Var2.K;
                er0Var3.setVisibility(8);
            }
            er0VarArr[i14].d.setScrollingTouchSlop(1);
            er0 er0Var4 = er0VarArr[i14];
            er0Var4.f36156b = (FrameLayout) er0Var4.f36155a.getFragmentView();
            er0VarArr[i14].d.setClipToPadding(false);
            er0 er0Var5 = er0VarArr[i14];
            er0Var5.f36157c = er0Var5.f36155a.getActionBar();
            er0 er0Var6 = er0VarArr[i14];
            er0Var6.addView(er0Var6.f36156b, w7.x5.c(-1.0f, -1));
            er0 er0Var7 = er0VarArr[i14];
            er0Var7.addView(er0Var7.f36157c, w7.x5.c(-2.0f, -1));
            er0VarArr[i14].f36157c.setVisibility(8);
        ...
        dr0Var.addView(br0Var.f34883a0, w7.x5.d(60, 60.0f, 85, 0.0f, 0.0f, 12.0f, 10.0f));
        dr0Var.addView(br0Var.f34885b0, w7.x5.d(42, 24.0f, 85, 0.0f, 0.0f, -2.0f, 9.0f));
        ...
        if (scrollSlidingTextTabStrip3 != null) {
            ...
            if (currentTabId >= 0) {
                er0VarArr[0].f36158e = currentTabId;
            }
            this.h.c();
        }
        j0(false);
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36755c.getSearchField(), 16777216, null, null, null, null, i11));
        ...
        arrayList.addAll(this.f36753a.getThemeDescriptions());
        arrayList.addAll(this.f36754b.getThemeDescriptions());
        return arrayList;
    }
    ...
    public final void onResume() {
        super.onResume();
        org.telegram.ui.ActionBar.v0 v0Var = this.f36755c;
        if (v0Var != null) {
            v0Var.z(true);
