...
public final class gr0 implements Utilities.Callback {
    ...
    public final PhotoViewer f34029b;

    public gr0(PhotoViewer photoViewer, int i10) {
        this.f34028a = i10;
        this.f34029b = photoViewer;
    }
    ...
    public final void run(Object obj) {
        ...
        switch (this.f34028a) {
            case 0:
                PhotoViewer photoViewer = this.f34029b;
                qg.k2 k2Var = (qg.k2) obj;
                Drawable[] drawableArr = PhotoViewer.U8;
                try {
                    boolean isEmpty = TextUtils.isEmpty(((MediaController.MediaEditState) photoViewer.f31233g7.get(photoViewer.P4)).filterPath);
                    ...
                    photoViewer.f31345t5.post(new ar0(photoViewer, 9));
                    return;
                } catch (Exception e) {
                    FileLog.e(e);
                    return;
            ...
            case 1:
                Uri uri = (Uri) obj;
                org.telegram.ui.Components.yc.F(this.f34029b.f31209e0, true).j();
                return;
            case 2:
                PhotoViewer photoViewer2 = this.f34029b;
                photoViewer2.L1.f41770h2 = photoViewer2.K1.c();
                photoViewer2.f31209e0.invalidate();
                int max = Math.max(((Integer) obj).intValue(), photoViewer2.L1.f41774j2);
                ...
                ValueAnimator valueAnimator = photoViewer2.f31338s7;
                if (valueAnimator != null) {
                    valueAnimator.cancel();
                    photoViewer2.f31338s7 = null;
                }
                if (photoViewer2.f31353u4 != 3) {
                    f7 = 0.0f;
                }
                ValueAnimator ofFloat = ValueAnimator.ofFloat(photoViewer2.Z5, f7);
                photoViewer2.f31338s7 = ofFloat;
                ofFloat.addUpdateListener(new zq0(photoViewer2, 9));
                photoViewer2.f31338s7.setDuration(320L);
                ValueAnimator valueAnimator2 = photoViewer2.f31338s7;
                org.telegram.ui.Components.rr rrVar = org.telegram.ui.Components.rr.h;
                valueAnimator2.setInterpolator(rrVar);
                photoViewer2.f31338s7.start();
                ...
                ObjectAnimator ofFloat4 = ObjectAnimator.ofFloat(photoViewer2.L1.f41759c1, property, Math.min(0, AndroidUtilities.dp(40.0f) + i11));
                ci.w5 w5Var = photoViewer2.L1.f41765f1;
                ...
                if (!st0Var.f41770h2 && !st0Var.f41768g2) {
                    z10 = true;
                } else {
                    z10 = false;
                }
                ...
                TextView textView3 = st0Var.f41793z1;
                if (!st0Var.f41770h2 && !st0Var.f41768g2) {
                    z13 = false;
                } else {
                    z13 = true;
                ...
                return;
            case 3:
                PhotoViewer photoViewer3 = this.f34029b;
                MediaController.PhotoEntry photoEntry = (MediaController.PhotoEntry) obj;
                if (!photoViewer3.f31317q5.f28766b.N && (i10 = photoViewer3.P4) >= 0 && i10 < photoViewer3.f31233g7.size() && (photoViewer3.f31233g7.get(photoViewer3.P4) instanceof MediaController.PhotoEntry)) {
                    org.telegram.ui.Components.uf0 uf0Var = photoViewer3.f31317q5;
                    ci.a4 a4Var = uf0Var.h;
                    if (a4Var != null) {
                        a4Var.dismiss();
                        uf0Var.h = null;
                    }
                    photoViewer3.f31317q5.f28766b.setLoading(true);
                    Utilities.globalQueue.postRunnable(new org.telegram.ui.Components.vn0(photoViewer3, photoEntry, (MediaController.PhotoEntry) photoViewer3.f31233g7.get(photoViewer3.P4), PhotoViewer.y1(), 28));
                    return;
                }
                return;
            case 4:
                PhotoViewer photoViewer4 = this.f34029b;
                Integer num = (Integer) obj;
                Object obj2 = photoViewer4.f31233g7.get(photoViewer4.P4);
                ...
                return;
            case 5:
                PhotoViewer photoViewer5 = this.f34029b;
                ...
                photoViewer5.f31210e1.setTranslationY(photoViewer5.U1.getAlpha() * (-org.telegram.messenger.f0.b(46.0f, num2.intValue(), 0)));
                photoViewer5.f31219f1.setTranslationY(photoViewer5.U1.getAlpha() * (-org.telegram.messenger.f0.b(46.0f, num2.intValue(), 0)));
                photoViewer5.f31227g1.setTranslationY(photoViewer5.U1.getAlpha() * (-org.telegram.messenger.f0.b(46.0f, num2.intValue(), 0)));
                ...
                return;
            case 6:
                PhotoViewer photoViewer6 = this.f34029b;
                Integer num3 = (Integer) obj;
                Object obj3 = photoViewer6.f31233g7.get(photoViewer6.P4);
            ...
            case 7:
                ...
                return;
            case 8:
                PhotoViewer photoViewer7 = this.f34029b;
                Boolean bool = (Boolean) obj;
                Drawable[] drawableArr2 = PhotoViewer.U8;
                photoViewer7.B0(0, false);
                return;
            default:
                PhotoViewer photoViewer8 = this.f34029b;
