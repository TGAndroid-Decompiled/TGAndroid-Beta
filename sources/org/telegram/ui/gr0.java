...
public final class gr0 extends org.telegram.ui.ActionBar.p2 {
    public static final org.telegram.ui.Components.sr0 f33165y = new org.telegram.ui.Components.sr0(4);
    public final br0 f33166a;
    public final br0 f33167b;
    public org.telegram.ui.ActionBar.w0 f33168c;
    public org.telegram.ui.Components.nu d;
    public boolean e;
    public final Paint f33169f;
    public ScrollSlidingTextTabStrip h;
    public final er0[] f33170n;
    public AnimatorSet f33171r;
    public boolean f33172s;
    public boolean v;
    ...
    public gr0(HashMap hashMap, ArrayList arrayList, int i10, boolean z10, eo eoVar) {
        super(null);
        this.e = true;
        this.f33169f = new Paint();
        this.f33170n = new er0[2];
        this.f33166a = new br0(0, null, hashMap, arrayList, i10, z10, eoVar, false);
        this.f33167b = new br0(1, null, hashMap, arrayList, i10, z10, eoVar, false);
    }
    ...
    public static void h0(gr0 gr0Var, String str) {
        gr0Var.f33168c.getSearchField().setText(str);
        gr0Var.f33168c.getSearchField().setSelection(str.length());
        gr0Var.actionBar.w();
    }
    ...
    public final View createView(Context context) {
        er0[] er0VarArr;
        View view;
        this.actionBar.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f17998h5, false));
        ...
        EditTextBoldCursor searchField = this.f33168c.getSearchField();
        ...
        this.f33174x = ViewConfiguration.get(context).getScaledMaximumFlingVelocity();
        dr0 dr0Var = new dr0(this, context);
        this.fragmentView = dr0Var;
        dr0Var.setWillNotDraw(false);
        br0 br0Var = this.f33166a;
        ...
        for (int i13 = 0; i13 < 4; i13++) {
            if (i13 != 0) {
                if (i13 != 1) {
                    if (i13 != 2) {
                        view = br0Var.f31368c0;
                    } else {
                        view = br0Var.f31366b0;
                    }
                } else {
                    view = br0Var.f31364a0;
                }
            } else {
                view = br0Var.Z;
            }
        ...
        k0 k0Var = br0Var.f31364a0;
        t50 t50Var = br0Var.f31366b0;
        View view2 = br0Var.f31368c0;
        org.telegram.ui.Components.nu nuVar2 = br0Var.f31369d0;
        br0 br0Var2 = this.f33167b;
        br0Var2.Z = frameLayout;
        br0Var2.f31364a0 = k0Var;
        br0Var2.f31369d0 = nuVar2;
        br0Var2.f31366b0 = t50Var;
        br0Var2.f31368c0 = view2;
        br0Var2.f31383q0 = false;
        br0Var2.setParentFragment(this);
        int i14 = 0;
        while (true) {
            er0VarArr = this.f33170n;
            ...
            if (i14 == 0) {
                ...
                er0Var2.f32588a = br0Var;
                er0Var2.d = br0Var.K;
            } else if (i14 == 1) {
                er0 er0Var3 = er0VarArr[i14];
                er0Var3.f32588a = br0Var2;
                er0Var3.d = br0Var2.K;
                er0Var3.setVisibility(8);
            }
            er0VarArr[i14].d.setScrollingTouchSlop(1);
            er0 er0Var4 = er0VarArr[i14];
            er0Var4.f32589b = (FrameLayout) er0Var4.f32588a.getFragmentView();
            er0VarArr[i14].d.setClipToPadding(false);
            er0 er0Var5 = er0VarArr[i14];
            er0Var5.f32590c = er0Var5.f32588a.getActionBar();
            er0 er0Var6 = er0VarArr[i14];
            er0Var6.addView(er0Var6.f32589b, w7.a6.c(-1.0f, -1));
            er0 er0Var7 = er0VarArr[i14];
            er0Var7.addView(er0Var7.f32590c, w7.a6.c(-2.0f, -1));
            er0VarArr[i14].f32590c.setVisibility(8);
        ...
        dr0Var.addView(br0Var.f31364a0, w7.a6.d(60, 60.0f, 85, 0.0f, 0.0f, 12.0f, 10.0f));
        dr0Var.addView(br0Var.f31366b0, w7.a6.d(42, 24.0f, 85, 0.0f, 0.0f, -2.0f, 9.0f));
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f33168c.getSearchField(), 16777216, null, null, null, null, i11));
        ...
        arrayList.addAll(this.f33166a.getThemeDescriptions());
        arrayList.addAll(this.f33167b.getThemeDescriptions());
        return arrayList;
    }
    ...
    public final void onResume() {
        super.onResume();
        org.telegram.ui.ActionBar.w0 w0Var = this.f33168c;
        if (w0Var != null) {
            w0Var.z(true);
