...
public final class fh1 extends ScrollView {
    ...
    public fh1(gh1 gh1Var, Context context) {
        super(context);
        this.e = gh1Var;
        this.f33578a = new int[2];
        this.f33579b = new Rect();
        this.f33580c = true;
    }
    ...
    public final void onScrollChanged(int i10, int i11, int i12, int i13) {
        ...
        gh1 gh1Var = this.e;
        TextView textView = gh1Var.f33912c;
        if (textView != null) {
            int[] iArr = this.f33578a;
            textView.getLocationOnScreen(iArr);
            int measuredHeight = gh1Var.f33912c.getMeasuredHeight() + iArr[1];
            ...
            if (gh1Var.f33912c.getTag() == null) {
                z11 = true;
            } else {
                z11 = false;
            }
            if (z10 != z11) {
                TextView textView2 = gh1Var.f33912c;
                if (z10) {
                    num = null;
                } else {
                    num = 1;
                ...
                gh1Var.K.addListener(new cr0(this, 25));
                gh1Var.K.start();
            }
        }
    }
    ...
    public final void requestChildFocus(View view, View view2) {
        if (Build.VERSION.SDK_INT < 29 && view2 != null && !this.f33580c) {
