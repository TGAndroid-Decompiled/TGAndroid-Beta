...
public final class y70 extends org.telegram.ui.ActionBar.m2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public TextView f40056f;
    public GradientDrawable h;
    public bi.o f40057n;
    public FrameLayout f40058r;
    public ci.m6 f40059s;
    ...
    public y70() {
        super(null);
        this.f40053a = new Object();
        this.f40054b = new Object();
        this.f40055c = UserConfig.selectedAccount;
        this.f40060w = 0;
        this.f40061x = false;
        this.f40062y = false;
    }
    ...
    public final void V(boolean z10) {
        ...
        this.f40056f.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.q6, false));
        this.f40057n.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.Sh, false));
        bi.o oVar = this.f40057n;
        ...
        if (z10) {
            ...
            for (int i12 = 0; i12 < this.d.getChildCount(); i12++) {
                ...
                ((TextView) childAt.findViewWithTag(this.f40053a)).setTextColor(org.telegram.ui.ActionBar.h6.w0(null, i13, false));
                ((TextView) childAt.findViewWithTag(this.f40054b)).setTextColor(org.telegram.ui.ActionBar.h6.w0(null, i13, false));
            }
            return;
        }
    ...
    public final View createView(Context context) {
        ...
        this.f40058r = frameLayout2;
        this.f40059s.addView(frameLayout2, w7.y5.d(-1, -2.0f, 51, 0.0f, 78.0f, 0.0f, 0.0f));
        TextureView textureView = new TextureView(context);
        this.f40058r.addView(textureView, w7.y5.e(200, 150, 17));
        ...
        this.f40059s.addView(this.d, w7.y5.c(-1.0f, -1));
        ...
        this.f40057n.setText(LocaleController.getString(R.string.StartMessaging));
        this.f40057n.setGravity(17);
        this.f40057n.setTypeface(AndroidUtilities.bold());
        this.f40057n.setTextSize(1, 15.0f);
        this.f40057n.setPadding(AndroidUtilities.dp(34.0f), 0, AndroidUtilities.dp(34.0f), 0);
        this.f40059s.addView(this.f40057n, w7.y5.d(-1, 48.0f, 81, 16.0f, 0.0f, 16.0f, 76.0f));
        this.f40057n.setOnClickListener(new View.OnClickListener(this) {
            public final y70 f37966b;
            ...
            public final void onClick(View view) {
                switch (r2) {
                    case 0:
                        ...
                        return;
                    default:
                        y70 y70Var2 = this.f37966b;
                        if (!y70Var2.f40062y && y70Var2.L != null) {
                            y70Var2.f40062y = true;
                            ...
                            LocaleController.getInstance().applyLanguage(y70Var2.L, true, false, y70Var2.f40055c);
                            return;
                        }
                        return;
                }
        ...
        this.e = saVar;
        this.f40059s.addView(saVar, w7.y5.d(66, 5.0f, 49, 0.0f, 350.0f, 0.0f, 0.0f));
        TextView textView = new TextView(context);
        this.f40056f = textView;
        textView.setGravity(17);
        this.f40056f.setTextSize(1, 16.0f);
        this.f40059s.addView(this.f40056f, w7.y5.d(-2, 30.0f, 81, 0.0f, 0.0f, 0.0f, 20.0f));
        this.f40056f.setOnClickListener(new View.OnClickListener(this) {
            public final y70 f37966b;
        ...
        float f7 = 4;
        this.f40059s.addView(frameLayout, w7.y5.d(64, 64.0f, 53, 0.0f, f7, f7, 0.0f));
        this.fragmentView = scrollView;
        NotificationCenter.getGlobalInstance().addObserver(this, NotificationCenter.suggestedLangpack);
        int i13 = this.f40055c;
    ...
    public final ArrayList getThemeDescriptions() {
        return w7.b6.a(new e(this, 18), org.telegram.ui.ActionBar.h6.f19045d6, org.telegram.ui.ActionBar.h6.q6, org.telegram.ui.ActionBar.h6.P9, org.telegram.ui.ActionBar.h6.Q9, org.telegram.ui.ActionBar.h6.Sh, org.telegram.ui.ActionBar.h6.G6);
    }
    ...
    public final void onFragmentDestroy() {
        ...
        NotificationCenter.getInstance(this.f40055c).removeObserver(this, NotificationCenter.configLoaded);
