...
public final class qx extends n41 {
    ...
    public qx(wy wyVar, Context context, py pyVar, Context context2) {
        ...
        this.V = context2;
        this.e = 0.0f;
        this.f35942n = new AnimationNotificationsLocker();
        this.M = true;
    }
    ...
    public final void d(boolean z10) {
        vy vyVar = this.T;
        vyVar.f38529c.G = true;
        vyVar.d.O(this.T.f38527a, c());
        vy vyVar2 = this.T;
        vyVar2.d.G = false;
        vyVar2.G.G = false;
        wy wyVar = this.W;
        wyVar.A4(false, true);
        this.T.f38527a.setClipChildren(true);
        this.T.f38527a.invalidate();
        this.T.d.l();
        this.T.G.l();
        this.T.f38527a.z1(null, 0.0f, z10);
        wyVar.f39321y = false;
    ...
    public final void e(boolean z10) {
        ...
        if (vyVar.F == null) {
            ...
            vy vyVar2 = this.T;
            int i11 = this.T.f38533s;
            int i12 = wyVar.V2;
            boolean z11 = wyVar.f39257l2;
        ...
        vy vyVar5 = this.T;
        gg.m mVar2 = vyVar5.G;
        mVar2.h = vyVar5.f38533s;
        mVar2.l();
        vy vyVar6 = this.T;
        vyVar6.d.O(vyVar6.f38527a, false);
        vy vyVar7 = this.T;
        vyVar7.d.G = true;
        vyVar7.G.G = true;
        vyVar7.f38529c.H = false;
        wyVar.A4(true, true);
        wyVar.c4(this.S);
        this.T.d.l();
        this.T.G.l();
        ...
        vy vyVar8 = this.T;
        vyVar8.f38527a.z1(vyVar8.F, f7, false);
        this.T.f38527a.setClipChildren(false);
        this.T.f38527a.C0();
        wyVar.D3();
        wyVar.U4();
    }
    ...
    public final void setOpenProgress(float f7) {
        ...
        if (vyVar2 != null && (syVar = vyVar2.f38527a) != null) {
            syVar.requestLayout();
        }
