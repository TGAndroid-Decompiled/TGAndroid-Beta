...
public final class z71 implements RequestDelegate {
    public final int f40067a;
    public final SessionsActivity f40068b;

    public z71(SessionsActivity sessionsActivity, int i10) {
        this.f40067a = i10;
        this.f40068b = sessionsActivity;
    }
    ...
    public final void run(final TLObject tLObject, final TLRPC.TL_error tL_error) {
        switch (this.f40067a) {
            case 0:
                AndroidUtilities.runOnUIThread(new xz0(this.f40068b, 17));
                return;
            case 1:
                final SessionsActivity sessionsActivity = this.f40068b;
                ...
                return;
            case 2:
                final SessionsActivity sessionsActivity2 = this.f40068b;
                AndroidUtilities.runOnUIThread(new Runnable() {
                    @Override
                    public final void run() {
                        org.telegram.ui.Components.xc a02;
                        ...
                        switch (r4) {
                            case 0:
                                ...
                                if (sessionsActivity22.getParentActivity() != null) {
                                    ...
                                    org.telegram.messenger.z0.o(i11, a02, i102, 36);
                ...
                return;
            default:
                final SessionsActivity sessionsActivity3 = this.f40068b;
                AndroidUtilities.runOnUIThread(new Runnable() {
                    @Override
                    public final void run() {
                        org.telegram.ui.Components.xc a02;
                        ...
                        switch (r4) {
                            case 0:
                                ...
                                if (sessionsActivity22.getParentActivity() != null) {
                                    ...
                                    org.telegram.messenger.z0.o(i112, a02, i102, 36);
                                    sessionsActivity22.k0(false);
                                    return;
                                }
                                return;
