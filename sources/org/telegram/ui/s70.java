...
public final class s70 implements TextureView.SurfaceTextureListener {
    ...
    public final NotificationCenter.NotificationCenterDelegate f41042b;

    public s70(NotificationCenter.NotificationCenterDelegate notificationCenterDelegate, int i10) {
        this.f41041a = i10;
        this.f41042b = notificationCenterDelegate;
    }
        ...
        switch (this.f41041a) {
            case 0:
                ...
                if (v70Var.F == null && surfaceTexture != null) {
                    ...
                    u70 u70Var = v70Var.F;
                    u70Var.postRunnable(u70Var.f41747w);
                    return;
                }
                return;
            default:
    ...
    public final boolean onSurfaceTextureDestroyed(SurfaceTexture surfaceTexture) {
        ...
        switch (this.f41041a) {
            case 0:
                ...
                return true;
            default:
                PhotoViewer photoViewer = (PhotoViewer) this.f41042b;
