...
public final class gy0 extends org.telegram.ui.Components.xl0 {
    ...
    public final int j(int i10) {
        ...
        if (i10 == hy0Var.f34335n) {
            return 3;
        }
        if (i10 == hy0Var.f34334f) {
            return 2;
        }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i11 == 1) {
            long keyAt = hy0Var.getMessagesController().blockePeers.keyAt(i10 - hy0Var.f34336r);
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        FrameLayout f9Var;
        if (i10 != 0) {
            Context context = this.f34020c;
            if (i10 != 1) {
                if (i10 != 2) {
                    if (i10 != 4) {
                        org.telegram.ui.Cells.n4 n4Var2 = new org.telegram.ui.Cells.n4(this.f34020c, org.telegram.ui.ActionBar.j6.L6, 21, 11, false, null);
                        n4Var2.setHeight(43);
                        n4Var = n4Var2;
                    } else {
            ...
            org.telegram.ui.Cells.c5 c5Var = new org.telegram.ui.Cells.c5(7, 6, this.f34020c, null, true);
