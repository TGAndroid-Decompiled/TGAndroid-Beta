    ...
    public final void b(org.telegram.ui.Components.ic icVar) {
        switch (this.f35061a) {
            ...
            case 2:
                ...
                xn xnVar = (xn) this.f35062b;
                qg.b c3 = xnVar.G.c(nbVar, null, true);
                rg.d dVar = new rg.d(xnVar.f43114ba);
            ...
            case 3:
                return;
            case 4:
                py pyVar = (py) this.f35062b;
                UndoView undoView = pyVar.f40257v0[0];
                if (undoView != null && undoView.getVisibility() == 0) {
                    pyVar.f40257v0[0].e(2, true);
                    return;
                }
                return;
            case 5:
    ...
    public final void c(float f10) {
        switch (this.f35061a) {
            ...
            case 2:
                return;
            case 3:
                ContactsActivity contactsActivity = (ContactsActivity) this.f35062b;
            ...
            case 4:
                ...
                UndoView undoView = pyVar.f40257v0[0];
                if (undoView == null || undoView.getVisibility() != 0) {
                    pyVar.f40238r1 = Math.max(0.0f, (f10 - pyVar.f40169d4) - pyVar.f40186g4);
                    pyVar.X4();
                    return;
                }
                return;
    ...
    public final boolean e() {
        switch (this.f35061a) {
            ...
            case 7:
                return true;
            case 8:
                if (((ProfileActivity) this.f35062b).f34671p5 == null) {
                    return true;
                }
                return false;
            default:
    ...
    public final int f(int i10) {
        ...
        switch (this.f35061a) {
            case 0:
                ...
                break;
            case 1:
                return ((bd) this.f35062b).L.getMeasuredHeight();
            case 2:
                xn xnVar = (xn) this.f35062b;
                if (i10 == 1) {
                    return 0;
                }
                return Math.round(xnVar.P.getInputBubbleHeight() + AndroidUtilities.dp(16.0f) + xnVar.W8(org.telegram.ui.Components.s21.f30977c) + xnVar.v.c());
            case 3:
                ContactsActivity contactsActivity = (ContactsActivity) this.f35062b;
            ...
            case 4:
                py pyVar = (py) this.f35062b;
                if (pyVar.U2 != 0) {
                    return AndroidUtilities.dp(60.0f) + pyVar.f40169d4;
                }
                return pyVar.n3();
            case 5:
                i12 = ((wg0) this.f35062b).I;
                i11 = AndroidUtilities.dp(64.0f);
                break;
            case 6:
                PhotoViewer photoViewer = ((iu0) this.f35062b).B0;
                int i13 = 0;
                if (photoViewer.O4) {
                    ms0 ms0Var = photoViewer.R1;
                    if (ms0Var != null) {
                        i13 = ms0Var.I.f45400l;
                ...
                return i13;
            case 7:
                return ((PremiumPreviewFragment) this.f35062b).f34496l0.d;
            case 8:
                ProfileActivity profileActivity = (ProfileActivity) this.f35062b;
            ...
            default:
                sf1 sf1Var = (sf1) this.f35062b;
                h51 h51Var = sf1Var.f41214l0;
                if (h51Var != null && h51Var.getVisibility() == 0) {
                    return sf1Var.f41214l0.getMeasuredHeight();
                }
                return 0;
        }
        return i11 + i12;
    ...
    public final int h(int i10) {
        ...
        switch (this.f35061a) {
            ...
            case 2:
                ...
                max2 = (int) Math.max(0.0f, xnVar.f43301q9);
                break;
            case 3:
                return 0;
            case 4:
                ...
                if (owVar != null && owVar.getVisibility() == 0) {
                    i13 = pyVar.f40262w0.getMeasuredHeight();
                } else {
                    i13 = 0;
                }
                int i16 = i12 + i13;
