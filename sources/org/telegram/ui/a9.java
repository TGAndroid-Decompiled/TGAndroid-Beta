...
public final class a9 extends TextView {
    ...
    public final org.telegram.ui.ActionBar.f6 f34356b;

    public a9(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context);
        this.f34356b = f6Var;
        this.f34355a = new Paint(1);
    }

    @Override
    public final void dispatchDraw(Canvas canvas) {
        int l1 = org.telegram.ui.ActionBar.j6.l1(0.8f, org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f21062z6, this.f34356b));
        Paint paint = this.f34355a;
        paint.setColor(l1);
