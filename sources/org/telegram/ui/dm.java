...
public final class dm extends vu0 {
    public final MessageObject f33188a;
    public final MediaController.PhotoEntry f33189b;
    public final em f33190c;

    public dm(em emVar, MessageObject messageObject, MediaController.PhotoEntry photoEntry) {
        this.f33190c = emVar;
        this.f33188a = messageObject;
        this.f33189b = photoEntry;
    }

    @Override
    public final fv0 E(MessageObject messageObject, TLRPC.FileLocation fileLocation, int i10, boolean z10, boolean z11) {
        return this.f33190c.f33445a.Q.Fa.E(this.f33188a, fileLocation, i10, z10, false);
    }

    @Override
    public final void o(int i10, VideoEditedInfo videoEditedInfo, boolean z10, int i11, int i12, boolean z11) {
        nm nmVar = this.f33190c.f33445a;
        MessageObject messageObject = this.f33188a;
        messageObject.settingAvatar = true;
        MediaController.PhotoEntry photoEntry = this.f33189b;
        ...
        u40Var.t(photoEntry);
        u40Var.f28276b = new fa(currentAccount, ejVar, parentLayout, u40Var);
    }
}
