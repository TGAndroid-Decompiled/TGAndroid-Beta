    ...
    public final boolean onPreDraw() {
        ...
        switch (i10) {
            case 0:
                ...
                RectF cameraRect = wnVar.f39423b3.getCameraRect();
                ...
                org.telegram.ui.Components.f60 cameraContainer = wnVar.f39423b3.getCameraContainer();
                ...
                View buttonsLayout = wnVar.f39423b3.getButtonsLayout();
                Property property = View.ALPHA;
                animatorSet.playTogether(ofFloat, ofFloat2, ofFloat3, ObjectAnimator.ofFloat(buttonsLayout, property, 0.0f), ObjectAnimator.ofInt(wnVar.f39423b3.getPaint(), org.telegram.ui.Components.s6.f28171b, 0), ObjectAnimator.ofFloat(wnVar.f39423b3.getMuteImageView(), property, 0.0f));
                ...
                ofFloat4.setInterpolator(org.telegram.ui.Components.sr.f28339f);
                animatorSet2.playTogether(ofFloat4, animatorSet);
                animatorSet2.setDuration(300L);
                org.telegram.ui.Components.i60 i60Var = wnVar.f39423b3;
                if (i60Var != null) {
                    i60Var.setIsMessageTransition(true);
                }
                animatorSet2.addListener(new ai.z(14, this, cameraContainer));
                animatorSet2.start();
                return true;
            case 1:
                ((vx) obj).f38844b.f37032e0[0].f36693a.getViewTreeObserver().removeOnPreDrawListener(this);
            ...
            default:
                ...
                if (ybVar != null) {
                    ...
                    hVar.f44076a.getLocationInWindow(iArr3);
                    hVar.X = (hVar.W.f30615a.getMeasuredWidth() / 2.0f) + (f10 - iArr3[0]) + hVar.W.f30615a.getLeft();
                    hVar.Y = (hVar.W.f30615a.getMeasuredHeight() / 2.0f) + ((translationY + f7) - iArr3[1]) + hVar.W.f30615a.getTop();
                }
                hVar.c();
                return true;
        }
