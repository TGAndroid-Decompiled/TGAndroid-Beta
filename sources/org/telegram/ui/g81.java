...
public final class g81 implements RequestDelegate {
    ...
    public final void run(final TLObject tLObject, final TLRPC.TL_error tL_error) {
        switch (this.f33843a) {
            case 0:
                AndroidUtilities.runOnUIThread(new e01(this.f33844b, 17));
                return;
            case 1:
                final SessionsActivity sessionsActivity = this.f33844b;
                ...
                return;
            case 2:
                final SessionsActivity sessionsActivity2 = this.f33844b;
                AndroidUtilities.runOnUIThread(new Runnable() {
                    @Override
                    public final void run() {
                        org.telegram.ui.Components.vc a02;
                ...
                return;
            default:
                final SessionsActivity sessionsActivity3 = this.f33844b;
                AndroidUtilities.runOnUIThread(new Runnable() {
                    @Override
                    public final void run() {
                        org.telegram.ui.Components.vc a02;
