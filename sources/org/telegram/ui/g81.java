...
public final class g81 implements RequestDelegate {
    public final int f33783a;
    public final SessionsActivity f33784b;

    public g81(SessionsActivity sessionsActivity, int i10) {
        this.f33783a = i10;
        this.f33784b = sessionsActivity;
    }
    ...
    public final void run(final TLObject tLObject, final TLRPC.TL_error tL_error) {
        switch (this.f33783a) {
            case 0:
                AndroidUtilities.runOnUIThread(new e01(this.f33784b, 17));
                return;
            case 1:
                final SessionsActivity sessionsActivity = this.f33784b;
                ...
                return;
            case 2:
                final SessionsActivity sessionsActivity2 = this.f33784b;
                AndroidUtilities.runOnUIThread(new Runnable() {
                    @Override
                    public final void run() {
                        org.telegram.ui.Components.xc a02;
                        ...
                        switch (r4) {
                            case 0:
                                ...
                                if (sessionsActivity22.getParentActivity() != null) {
                                    ...
                                    org.telegram.messenger.q.q(i11, a02, i102, 36);
                ...
                return;
            default:
                final SessionsActivity sessionsActivity3 = this.f33784b;
                AndroidUtilities.runOnUIThread(new Runnable() {
                    @Override
                    public final void run() {
                        org.telegram.ui.Components.xc a02;
                        ...
                        switch (r4) {
                            case 0:
                                ...
                                if (sessionsActivity22.getParentActivity() != null) {
                                    ...
                                    org.telegram.messenger.q.q(i112, a02, i102, 36);
                                    sessionsActivity22.k0(false);
                                    return;
                                }
                                return;
