...
public final class ua implements Utilities.Callback {
    ...
    public ua(NotificationCenter.NotificationCenterDelegate notificationCenterDelegate, Object obj, Object obj2, Object obj3, Object obj4, int i10) {
        this.f37998a = i10;
        this.f37999b = notificationCenterDelegate;
        this.f38000c = obj;
        this.d = obj2;
        this.e = obj3;
        this.f38001f = obj4;
    ...
    public final void run(Object obj) {
        ...
        switch (this.f37998a) {
            case 0:
                AndroidUtilities.runOnUIThread(new ai.z8((wb) this.f37999b, (TLRPC.ChannelParticipant) obj, (ArrayList) this.f38000c, (ArrayList) this.d, (ArrayList) this.e, (ta) this.f38001f));
                return;
            case 1:
                final bo boVar = (bo) this.f37999b;
                org.telegram.ui.Cells.t1 t1Var = (org.telegram.ui.Cells.t1) this.f38000c;
                String str = (String) this.d;
                TLRPC.TL_contact tL_contact = (TLRPC.TL_contact) this.e;
                CharacterStyle characterStyle = (CharacterStyle) this.f38001f;
                ...
                return;
            case 2:
                bo boVar2 = (bo) this.f37999b;
                TLRPC.TL_document tL_document = (TLRPC.TL_document) this.f38000c;
                String str2 = (String) this.d;
                MessageObject.SendAnimationData sendAnimationData = (MessageObject.SendAnimationData) this.f38001f;
                Long l4 = (Long) obj;
                int i10 = boVar2.R3;
                Object obj2 = this.e;
                if (i10 == 1) {
                    org.telegram.ui.Components.c5.M(boVar2.getParentActivity(), boVar2.T5, new a1.d(boVar2, tL_document, str2, obj2, 4), boVar2.f32275ea);
                } else {
                    boVar2.getSendMessagesHelper().sendSticker(tL_document, str2, boVar2.T5, boVar2.f32381n5, boVar2.X3, null, boVar2.f32355l5, sendAnimationData, true, 0, 0, false, obj2, boVar2.C8(), l4.longValue(), boVar2.N8(), boVar2.f32295g5);
                ...
                return;
            case 3:
                ArrayList arrayList = (ArrayList) this.f38000c;
                ArrayList arrayList2 = (ArrayList) this.d;
                ArrayList arrayList3 = (ArrayList) this.e;
                Runnable runnable = (Runnable) obj;
                org.telegram.ui.Components.jy jyVar = ((org.telegram.ui.Components.iy) this.f37999b).f25047a;
                String str3 = jyVar.v;
                ArrayList arrayList4 = jyVar.f25461r;
                ArrayList arrayList5 = jyVar.h;
                ArrayList arrayList6 = jyVar.f25462s;
                org.telegram.ui.Components.kz kzVar = jyVar.F;
                if (((String) this.f38001f).equals(str3)) {
                    ...
                    arrayList5.clear();
                    arrayList5.addAll(jyVar.f25460n);
                    arrayList4.clear();
                    ...
                    while (i12 < size) {
                        ...
                        if (longSparseIntArray.indexOfKey(cyVar.f23155c.f18148id) < 0) {
                            longSparseIntArray.append(cyVar.f23155c.f18148id, 1);
                    ...
                    while (i11 < size2) {
                        ...
                        if (longSparseIntArray.indexOfKey(cyVar2.f23155c.f18148id) < 0) {
                            longSparseIntArray.append(cyVar2.f23155c.f18148id, 1);
            ...
            case 4:
                ...
                return;
            default:
                yh.a4.s0((yh.a4) this.f37999b, (TL_stars.StarGift) this.f38000c, (TL_stars.StarGiftAttribute) this.d, (org.telegram.ui.Components.xc[]) this.e, (boolean[]) this.f38001f, (ArrayList) obj);
                return;
        }
    }
