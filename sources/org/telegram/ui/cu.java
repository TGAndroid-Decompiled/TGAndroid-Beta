...
public final class cu extends org.telegram.ui.Components.za {
    ...
    public final ci.d Y;
    public final ci.d Z;
    public final ArrayList f32865a0;
    public final HashSet f32866b0;
    public boolean f32867c0;
    public org.telegram.ui.Components.w51 f32868d0;

    public cu(Activity activity, HashSet hashSet) {
        super(activity, null, false, false, new ai.d());
        ArrayList arrayList = new ArrayList();
        this.f32865a0 = arrayList;
        HashSet hashSet2 = new HashSet();
        this.f32866b0 = hashSet2;
        ...
        imageView.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view) {
                switch (r2) {
                    case 0:
                        this.f32578b.dismiss();
                        return;
                    case 1:
                        this.f32578b.S(false);
                        return;
                    default:
                        this.f32578b.S(true);
                        return;
        ...
        org.telegram.ui.Components.w51 w51Var = this.f32868d0;
        if (w51Var != null) {
            w51Var.N(false);
        }
        s4.j jVar = new s4.j();
    ...
    public static void R(cu cuVar, ArrayList arrayList) {
        ...
        ArrayList arrayList2 = cuVar.f32865a0;
