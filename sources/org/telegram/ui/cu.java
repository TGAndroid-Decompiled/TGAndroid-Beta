    ...
    public final int compare(Object obj, Object obj2) {
        ...
        switch (this.f33429a) {
            case 0:
                ...
                return 0;
            case 1:
                return Long.compare(((su) obj2).f29422c, ((su) obj).f29422c);
            case 2:
            ...
            case 13:
                ...
                return 0;
            case 14:
                return (int) (((org.telegram.ui.web.j) obj2).f39540c - ((org.telegram.ui.web.j) obj).f39540c);
            case 15:
                return (int) (((org.telegram.ui.web.j) obj2).f39540c - ((org.telegram.ui.web.j) obj).f39540c);
            case 16:
                mg.q0 q0Var = (mg.q0) obj2;
                String str = ((mg.q0) obj).f14107f;
                if (str != null && str.equals("❤")) {
                    i12 = -1;
                } else {
                    i12 = 0;
                }
                String str2 = q0Var.f14107f;
            ...
            case 18:
                ...
                int compare = Integer.compare(bVar.f43985c, bVar2.f43985c);
                if (compare == 0) {
                    return bVar.f43984b.compareTo(bVar2.f43984b);
                }
                return compare;
            case 19:
                int i27 = ((tf.y) obj).f44881b;
                int i28 = ((tf.y) obj2).f44881b;
                if (i27 < i28) {
                    return 1;
                }
                if (i27 > i28) {
            ...
            case 21:
                int i29 = ((tf.i1) obj).f44756b;
                int i30 = ((tf.i1) obj2).f44756b;
                if (i29 < i30) {
                    return 1;
                }
                if (i29 > i30) {
            ...
            case 23:
                return ((uf.o1) obj).f45409c - ((uf.o1) obj2).f45409c;
            case 24:
                return Integer.compare(((w4.d) obj2).f46410b, ((w4.d) obj).f46410b);
            default:
                return ((f2.l1) obj2).f5785a.getTop() - ((f2.l1) obj).f5785a.getTop();
        }
    }
}
