...
public final class k50 implements org.telegram.ui.Components.u40 {
    ...
    public TLRPC.FileLocation f34936b;
    public TLRPC.FileLocation f34937c;
    public ImageLocation d;
    public final long e;
    public final d60 f34938f;
    ...
    public final void B(float f7) {
        this.f34938f.f32938b.O(this.d, f7);
        a(f7);
    }
        ...
        if (j50Var != null) {
            for (int i10 = 0; i10 < j50Var.getChildCount(); i10++) {
                ...
                if (childAt instanceof org.telegram.ui.Cells.e4) {
                    ...
                    if (e4Var.c()) {
                        org.telegram.ui.Cells.z3 z3Var = e4Var.f20239x;
