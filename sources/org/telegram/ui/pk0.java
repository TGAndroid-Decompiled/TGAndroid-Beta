...
public final class pk0 extends org.telegram.ui.Components.wl0 {
    public final sk0 f36570c;
    ...
    @Override
    public final int h() {
        return this.f36570c.f37812n;
    }

    @Override
    public final long i(int i10) {
        qk0 qk0Var;
        sk0 sk0Var = this.f36570c;
        int i11 = sk0Var.E;
        if (i10 >= i11 && i10 < sk0Var.F) {
            qk0Var = (qk0) sk0Var.f37809b.get(i10 - i11);
        } else {
            int i12 = sk0Var.f37813r;
            if (i10 >= i12 && i10 < sk0Var.f37814s) {
                qk0Var = (qk0) sk0Var.f37808a.get(i10 - i12);
            } else {
                qk0Var = null;
            }
        }
        if (qk0Var != null) {
            return qk0Var.f36936c;
        }
        sk0Var.getClass();
        if (i10 == 0) {
            return 1L;
        }
        if (i10 == sk0Var.f37817y) {
            return 2L;
        }
        if (i10 == sk0Var.v) {
            return 3L;
        }
        if (i10 == sk0Var.f37815w) {
            return 4L;
        }
        if (i10 == sk0Var.f37816x) {
            return 5L;
        }
    ...
    public final int j(int i10) {
        ...
        sk0Var.getClass();
        if (i10 != 0 && i10 != sk0Var.f37817y) {
            if (i10 == sk0Var.v) {
                return 2;
            }
            if (i10 != sk0Var.f37815w && i10 != sk0Var.f37816x) {
                return 0;
            }
            return 3;
        }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i11 != 0) {
            if (i11 != 1) {
                if (i11 == 2) {
                    ...
                    g2Var.f20325b.setImageDrawable(rqVar);
                    g2Var.f20326c = false;
                    return;
                }
                return;
        ...
        if (i10 >= i12 && i10 < sk0Var.F) {
            qk0Var = (qk0) sk0Var.f37809b.get(i10 - i12);
        } else {
            qk0Var = null;
        }
        int i13 = sk0Var.f37813r;
        if (i10 >= i13 && i10 < sk0Var.f37814s) {
            qk0Var = (qk0) sk0Var.f37808a.get(i10 - i13);
        }
        if (qk0Var != null) {
            if (rk0Var.e == qk0Var) {
                z10 = true;
            ...
            if (sk0Var.J.get(qk0Var.f36936c) != null) {
                z12 = true;
            } else {
                z12 = false;
            }
            rk0Var.e = qk0Var;
            rk0Var.f37370a.setText(qk0Var.f36937f);
            if (i10 != sk0Var.F - 1) {
                z13 = true;
            }
            rk0Var.d = z13;
            rk0Var.f37371b.a(z11, z10);
            rk0Var.f37372c.a(z12, z10);
        }
    }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        org.telegram.ui.ActionBar.d6 d6Var = this.f36570c.h;
        ...
        if (i10 != 0) {
            ...
            frameLayout.f37371b = radioButton;
            ...
            frameLayout.f37372c = ppVar;
            int i22 = org.telegram.ui.ActionBar.h6.f19059d6;
            ppVar.b(-1, i22, org.telegram.ui.ActionBar.h6.f19187k7);
