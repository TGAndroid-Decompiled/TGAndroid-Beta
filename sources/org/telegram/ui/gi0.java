        ...
        switch (this.f33948a) {
            case 0:
                ...
                if (!arrayList.isEmpty()) {
                    ...
                    if (mediaLocation != null) {
                        if (bzVar.f32526s == null) {
                            TLRPC.Document document = mediaLocation.document;
                            if (document != null) {
                                bzVar.f32526s = FileLoader.getAttachFileName(document, "tgs");
                            } else {
                                bzVar.f32526s = FileLoader.getAttachFileName(mediaLocation.location, "tgs");
                            }
                        }
                        if (bzVar.f32526s != null) {
                            Float fileProgress = ImageLoader.getInstance().getFileProgress(bzVar.f32526s);
                ...
                return;
            default:
                vi0 vi0Var2 = this.f33949b;
                eb0 eb0Var = vi0Var2.d;
                if (eb0Var != null) {
                    if (vi0Var2.E == 1.0f && vi0Var2.f38741n != null) {
                        z10 = true;
                    } else {
                        z10 = false;
                    }
                ...
                if (vi0Var2.E > 0.0f && vi0Var2.f38741n != null) {
                    vi0Var2.f38746r.reset();
                    float width = getWidth() / vi0Var2.f38733f.getWidth();
                    vi0Var2.f38746r.postScale(width, width);
                    vi0Var2.h.setLocalMatrix(vi0Var2.f38746r);
                    vi0Var2.f38741n.setAlpha((int) (vi0Var2.E * 255.0f));
                    canvas2 = canvas;
                    canvas2.drawRect(0.0f, 0.0f, getWidth(), getHeight(), vi0Var2.f38741n);
                } else {
                    canvas2 = canvas;
                }
    ...
    public void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        switch (this.f33948a) {
            case 1:
                ...
                vi0 vi0Var = this.f33949b;
                if (!vi0Var.f38735g0 || vi0Var.f38736h0) {
                    ...
                    if (vi0Var.F.getWidth() > 0) {
                        ...
                        FrameLayout frameLayout = vi0Var.f38731d0;
                        if (frameLayout != null) {
                            frameLayout.setX(org.telegram.messenger.f0.b(6.0f, (vi0Var.X.l() + iArr[0]) - vi0Var.f38731d0.getMeasuredWidth(), 0));
                            RectF rectF = vi0Var.f38740l0;
                            if (rectF != null) {
                                FrameLayout frameLayout2 = vi0Var.f38731d0;
                                ...
                                if (ji0Var != null) {
                                    ji0Var.setY(Math.max(vi0Var.e.f10577b, (vi0Var.f38740l0.top - AndroidUtilities.dp(24.0f)) - vi0Var.f38732e0.getMeasuredHeight()));
                                }
                            } else {
                                float height2 = (vi0Var.X.getHeight() + iArr[1]) - oi0Var.getMeasuredHeight();
                                FrameLayout frameLayout3 = vi0Var.f38731d0;
                                float max2 = Math.max(vi0Var.e.f10577b, height2 - frameLayout3.getMeasuredHeight()) + AndroidUtilities.dp(24.0f);
                                vi0Var.f38730c0 = max2;
                                frameLayout3.setY(max2);
                                ji0 ji0Var2 = vi0Var.f38732e0;
                                if (ji0Var2 != null) {
                                    ji0Var2.setY(Math.max(0.0f, (height2 - ji0Var2.getMeasuredHeight()) - vi0Var.f38730c0));
                                }
                            }
                        }
                    }
                    vi0Var.f38735g0 = true;
                    return;
                }
                return;
            default:
    ...
    public void onSizeChanged(int i10, int i11, int i12, int i13) {
        switch (this.f33948a) {
            case 1:
                ...
                vi0 vi0Var = this.f33949b;
                gh.d.c(vi0Var.f38738j0, vi0Var.F);
                ViewGroup viewGroup = vi0Var.Z;
                if (viewGroup != null) {
