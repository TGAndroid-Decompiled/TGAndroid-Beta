...
public final class gi0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    public static final org.telegram.ui.Components.ac0 f33985n;
    public static final org.telegram.ui.Components.ac0 f33986r;
    public final int f33987a;
    public final org.telegram.ui.Components.u9 f33988b;
    public final org.telegram.ui.ActionBar.k5 f33989c;
    public final TextView d;
    public final org.telegram.ui.Components.f9 e;
    public final org.telegram.ui.Components.lw0 f33990f;
    public TLObject h;

    static {
        int i10 = R.drawable.msg_mini_checks;
        int i11 = org.telegram.ui.ActionBar.j6.f19245y6;
        f33985n = new org.telegram.ui.Components.ac0(i10, i11);
        f33986r = new org.telegram.ui.Components.ac0(R.drawable.mini_checklist_done_outline, i11);
    }

    public gi0(Context context) {
        super(context);
        int i10;
        this.f33987a = UserConfig.selectedAccount;
        ...
        this.f33990f = new org.telegram.ui.Components.lw0(this);
        ...
        textView.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19245y6, false));
    ...
    public final void a(TLObject tLObject, boolean z10, int i10) {
        ...
        org.telegram.ui.Components.lw0 lw0Var = this.f33990f;
        if (z11) {
        ...
        org.telegram.ui.ActionBar.k5 k5Var = this.f33989c;
        k5Var.i(a2);
        if (tLObject != null) {
            org.telegram.ui.Components.f9 f9Var = this.e;
            int i11 = this.f33987a;
            f9Var.j(i11, tLObject);
            this.f33988b.h(ImageLocation.getForUserOrChat(i11, tLObject, 1), "50_50", f9Var, tLObject);
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.userEmojiStatusUpdated) {
            ...
            if (user != null && user2 != null && user.f18268id == user2.f18268id) {
                this.h = user2;
                int w02 = org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19267z9, false);
    ...
    public final void onAttachedToWindow() {
        ...
        this.f33990f.f25983a.a();
        NotificationCenter.getInstance(this.f33987a).addObserver(this, NotificationCenter.userEmojiStatusUpdated);
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        this.f33990f.f25983a.b();
        NotificationCenter.getInstance(this.f33987a).removeObserver(this, NotificationCenter.userEmojiStatusUpdated);
    }

    @Override
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        super.onInitializeAccessibilityNodeInfo(accessibilityNodeInfo);
        String formatString = LocaleController.formatString("AccDescrPersonHasSeen", R.string.AccDescrPersonHasSeen, this.f33989c.getText());
        TextView textView = this.d;
