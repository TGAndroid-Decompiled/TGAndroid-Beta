...
public final class fi0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    public static final org.telegram.ui.Components.bc0 f36436n;
    public static final org.telegram.ui.Components.bc0 f36437r;
    public final int f36438a;
    public final org.telegram.ui.Components.x9 f36439b;
    public final org.telegram.ui.ActionBar.j5 f36440c;
    public final TextView d;
    public final org.telegram.ui.Components.i9 f36441e;
    public final org.telegram.ui.Components.jw0 f36442f;
    public TLObject h;

    static {
        int i10 = R.drawable.msg_mini_checks;
        int i11 = org.telegram.ui.ActionBar.j6.f21069y6;
        f36436n = new org.telegram.ui.Components.bc0(i10, i11);
        f36437r = new org.telegram.ui.Components.bc0(R.drawable.mini_checklist_done_outline, i11);
    }

    public fi0(Context context) {
        super(context);
        int i10;
        this.f36438a = UserConfig.selectedAccount;
        this.f36441e = new org.telegram.ui.Components.i9((org.telegram.ui.ActionBar.f6) null);
        ...
        this.f36442f = new org.telegram.ui.Components.jw0(this);
        ...
        textView.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f21069y6, false));
    ...
    public final void a(TLObject tLObject, boolean z10, int i10) {
        ...
        this.h = tLObject;
        int w02 = org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f21091z9, false);
        boolean z11 = tLObject instanceof TLRPC.User;
        org.telegram.ui.Components.jw0 jw0Var = this.f36442f;
        if (z11) {
        ...
        org.telegram.ui.ActionBar.j5 j5Var = this.f36440c;
        j5Var.i(a2);
        if (tLObject != null) {
            org.telegram.ui.Components.i9 i9Var = this.f36441e;
            int i11 = this.f36438a;
            i9Var.j(i11, tLObject);
            this.f36439b.h(ImageLocation.getForUserOrChat(i11, tLObject, 1), "50_50", i9Var, tLObject);
    ...
    public final void onAttachedToWindow() {
        ...
        this.f36442f.f27607a.a();
        NotificationCenter.getInstance(this.f36438a).addObserver(this, NotificationCenter.userEmojiStatusUpdated);
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        this.f36442f.f27607a.b();
        NotificationCenter.getInstance(this.f36438a).removeObserver(this, NotificationCenter.userEmojiStatusUpdated);
    }

    @Override
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        super.onInitializeAccessibilityNodeInfo(accessibilityNodeInfo);
        String formatString = LocaleController.formatString("AccDescrPersonHasSeen", R.string.AccDescrPersonHasSeen, this.f36440c.getText());
        TextView textView = this.d;
