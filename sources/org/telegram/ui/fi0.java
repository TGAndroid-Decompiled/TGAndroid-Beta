...
public final class fi0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    public static final org.telegram.ui.Components.jc0 f33548n;
    public static final org.telegram.ui.Components.jc0 f33549r;
    public final int f33550a;
    public final org.telegram.ui.Components.w9 f33551b;
    public final org.telegram.ui.ActionBar.j5 f33552c;
    public final TextView d;
    public final org.telegram.ui.Components.h9 e;
    public final org.telegram.ui.Components.ww0 f33553f;
    public TLObject h;

    static {
        int i10 = R.drawable.msg_mini_checks;
        int i11 = org.telegram.ui.ActionBar.j6.f19445y6;
        f33548n = new org.telegram.ui.Components.jc0(i10, i11);
        f33549r = new org.telegram.ui.Components.jc0(R.drawable.mini_checklist_done_outline, i11);
    }

    public fi0(Context context) {
        super(context);
        int i10;
        this.f33550a = UserConfig.selectedAccount;
        ...
        this.f33553f = new org.telegram.ui.Components.ww0(this);
        ...
        textView.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19445y6, false));
    ...
    public final void a(TLObject tLObject, boolean z10, int i10) {
        ...
        org.telegram.ui.Components.jc0 jc0Var;
        this.h = tLObject;
        int w02 = org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19467z9, false);
        boolean z11 = tLObject instanceof TLRPC.User;
        org.telegram.ui.Components.ww0 ww0Var = this.f33553f;
        if (z11) {
            a2 = ww0Var.a((TLRPC.User) tLObject, null, w02, false);
        } else if (tLObject instanceof TLRPC.Chat) {
            a2 = ww0Var.a(null, (TLRPC.Chat) tLObject, w02, false);
        } else {
            a2 = ww0Var.a(null, null, w02, false);
        }
        org.telegram.ui.ActionBar.j5 j5Var = this.f33552c;
        j5Var.i(a2);
        if (tLObject != null) {
            org.telegram.ui.Components.h9 h9Var = this.e;
            int i11 = this.f33550a;
            h9Var.j(i11, tLObject);
            this.f33551b.h(ImageLocation.getForUserOrChat(i11, tLObject, 1), "50_50", h9Var, tLObject);
        ...
        textView.setText(TextUtils.concat(jc0Var.a(getContext(), null), LocaleController.formatSeenDate(i10)));
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.userEmojiStatusUpdated) {
            ...
            if (user != null && user2 != null && user.f18443id == user2.f18443id) {
                this.h = user2;
                int w02 = org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19467z9, false);
                boolean z10 = user2 instanceof TLRPC.User;
                org.telegram.ui.Components.ww0 ww0Var = this.f33553f;
                if (z10) {
                    a2 = ww0Var.a(user2, null, w02, true);
                } else {
                    a2 = ww0Var.a(null, null, w02, true);
                }
                this.f33552c.i(a2);
            }
        }
    ...
    public final void onAttachedToWindow() {
        ...
        this.f33553f.f30176a.a();
        NotificationCenter.getInstance(this.f33550a).addObserver(this, NotificationCenter.userEmojiStatusUpdated);
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        this.f33553f.f30176a.b();
        NotificationCenter.getInstance(this.f33550a).removeObserver(this, NotificationCenter.userEmojiStatusUpdated);
    }

    @Override
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        super.onInitializeAccessibilityNodeInfo(accessibilityNodeInfo);
        String formatString = LocaleController.formatString("AccDescrPersonHasSeen", R.string.AccDescrPersonHasSeen, this.f33552c.getText());
        TextView textView = this.d;
