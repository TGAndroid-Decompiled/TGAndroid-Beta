...
public final class jv extends FrameLayout {
    ...
    public int d;
    public int f38225e;
    public VelocityTracker f38226f;
    public boolean h;
    public final lv f38227n;
    ...
    public final boolean b(MotionEvent motionEvent, boolean z4) {
        ...
        lv lvVar = this.f38227n;
        kv[] kvVarArr = lvVar.f38886f;
        ScrollSlidingTextTabStrip scrollSlidingTextTabStrip = lvVar.f38885e;
        ...
        lvVar.f38885e.setEnabled(false);
        kv kvVar = kvVarArr[1];
        kvVar.f38522f = i12;
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        if (!a() && !this.f38227n.f38885e.E && !onTouchEvent(motionEvent)) {
            return false;
        }
        return true;
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        for (int i12 = 0; i12 < kvVarArr.length; i12++) {
            ...
            if (kvVar != null) {
                ...
                mh.d1 d1Var = kvVarArr[i12].f38521e;
                if (d1Var != null) {
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent != null) {
            if (this.f38226f == null) {
                this.f38226f = VelocityTracker.obtain();
            }
            this.f38226f.addMovement(motionEvent);
        }
        if (motionEvent != null && motionEvent.getAction() == 0 && !this.f38223b && !this.f38224c) {
            this.f38222a = motionEvent.getPointerId(0);
            this.f38224c = true;
            this.d = (int) motionEvent.getX();
            this.f38225e = (int) motionEvent.getY();
            this.f38226f.clear();
        } else if (motionEvent != null && motionEvent.getAction() == 2 && motionEvent.getPointerId(0) == this.f38222a) {
            int x10 = (int) (motionEvent.getX() - this.d);
            int abs = Math.abs(((int) motionEvent.getY()) - this.f38225e);
            if (this.f38223b && (((z11 = lvVar.f38888r) && x10 > 0) || (!z11 && x10 < 0))) {
                if (x10 < 0) {
                    z12 = true;
                } else {
                    z12 = false;
                ...
                if (!b(motionEvent, z12)) {
                    ...
                    lvVar.f38885e.j(0.0f, kvVarArr[1].f38522f);
                }
            }
            if (this.f38224c && !this.f38223b) {
                ...
                lvVar.f38885e.j(Math.abs(x10) / kvVarArr[0].getMeasuredWidth(), kvVarArr[1].f38522f);
            }
        } else if (motionEvent == null || (motionEvent.getPointerId(0) == this.f38222a && (motionEvent.getAction() == 3 || motionEvent.getAction() == 1 || motionEvent.getAction() == 6))) {
            this.f38226f.computeCurrentVelocity(1000, lvVar.v);
            if (motionEvent != null && motionEvent.getAction() != 3) {
                f10 = this.f38226f.getXVelocity();
                f11 = this.f38226f.getYVelocity();
                if (!this.f38223b && Math.abs(f10) >= 3000.0f && Math.abs(f10) > Math.abs(f11)) {
                    if (f10 < 0.0f) {
                        z10 = true;
                    } else {
                        z10 = false;
            ...
            if (this.f38223b) {
                ...
                lvVar.h.setInterpolator(lv.f38881x);
            ...
            VelocityTracker velocityTracker = this.f38226f;
