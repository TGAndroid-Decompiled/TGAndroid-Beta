...
public final class zv implements View.OnLongClickListener {
    ...
    public final boolean onLongClick(View view) {
        switch (this.f40582a) {
            case 0:
                qy qyVar = this.f40583b;
                qyVar.r4(qyVar.I2, 104, true, true, null);
                return true;
            case 1:
                qy qyVar2 = this.f40583b;
                ...
                org.telegram.ui.Components.z70 H = org.telegram.ui.Components.z70.H(qyVar2, view);
                ...
                return true;
            case 2:
                this.f40583b.p4(view);
                return true;
            default:
                qy qyVar3 = this.f40583b;
