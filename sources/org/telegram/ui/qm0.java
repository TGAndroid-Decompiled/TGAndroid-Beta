...
public final class qm0 implements RequestDelegate {
    ...
    public final void run(TLObject tLObject, final TLRPC.TL_error tL_error) {
        switch (this.f36930a) {
            case 0:
                AndroidUtilities.runOnUIThread(new rm0(this.f36931b, tLObject, tL_error));
                return;
            case 1:
                final sm0 sm0Var = this.f36931b;
                ...
                return;
            case 2:
                final sm0 sm0Var2 = this.f36931b;
                AndroidUtilities.runOnUIThread(new Runnable() {
                    @Override
                    public final void run() {
                        int i10;
                ...
                return;
            case 3:
                AndroidUtilities.runOnUIThread(new rm0(this.f36931b, tL_error, tLObject, 1));
                return;
            default:
                AndroidUtilities.runOnUIThread(new rm0(this.f36931b, tL_error, tLObject, 2));
                return;
        }
    }
}
