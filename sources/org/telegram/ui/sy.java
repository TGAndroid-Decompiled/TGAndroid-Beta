...
public final class sy extends s4.v {
    ...
    public final long d(RecyclerView recyclerView, int i10, float f7, float f10) {
        ...
        if (i10 == 8 && (r2Var = (uyVar = this.h).X0) != null) {
            AndroidUtilities.runOnUIThread(new jh(1, r2Var), this.f40598g.f40895x.f45858e);
            uyVar.X0 = null;
        }
    ...
    public final boolean n(RecyclerView recyclerView, s4.c1 c1Var, s4.c1 c1Var2) {
        ...
        int i10;
        uy uyVar = this.h;
        ArrayList arrayList = uyVar.f41266a1;
        ...
        if (view instanceof org.telegram.ui.Cells.r2) {
            ...
            if (dialog != null && uyVar.g4(dialog) && !DialogObject.isFolderDialogId(dialogId)) {
                int b10 = c1Var.b();
                int b11 = c1Var2.b();
                ty tyVar = this.f40598g;
                if (tyVar.f40886a.getItemAnimator() == null) {
                    tyVar.f40886a.setItemAnimator(tyVar.f40895x);
                }
                bx bxVar = tyVar.d;
                uy uyVar2 = bxVar.R;
                int i11 = bxVar.F;
                ...
                bxVar.W(null);
                int i15 = uyVar.f41287e0[0].f40893s;
                if (i15 != 7) {
                    i10 = 8;
                    if (i15 != 8) {
                        uyVar.Z0 = true;
                ...
                if (uyVar.f41287e0[0].f40893s == i10) {
                    c11 = 1;
                }
    ...
    public final void p(s4.c1 c1Var, int i10) {
        if (c1Var != null) {
            this.f40598g.f40886a.c1(false);
        }
        this.d = c1Var;
        if (c1Var != null) {
            View view = c1Var.f45767a;
            if (view instanceof org.telegram.ui.Cells.r2) {
                ((org.telegram.ui.Cells.r2) view).f22671w = false;
            }
        }
    }
    ...
    public final void q(s4.c1 c1Var) {
        ...
        if (c1Var != null) {
            ...
            if (Utilities.random.nextInt(1000) == 1) {
                if (uyVar.V0 == null) {
                    qy qyVar2 = tyVar.f40886a;
                    ?? obj = new Object();
                    obj.f24700a = new Paint(1);
                    Paint paint = new Paint(1);
                    obj.f24701b = paint;
                    obj.f24703e = 0L;
                    obj.f24704f = new RectF();
                ...
                bd0Var.h = 0.0f;
                bd0Var.f24705g = 0.0f;
                bd0Var.f24703e = System.currentTimeMillis();
                bd0Var.f24702c.invalidate();
                return;
            }
            a0Var.run();
            return;
