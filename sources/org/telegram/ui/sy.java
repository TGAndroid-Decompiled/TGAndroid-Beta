...
public final class sy extends org.telegram.ui.Components.ga implements ai.s9 {
    public static final int f37572v3 = 0;
    public boolean f37573d3;
    public boolean f37574e3;
    public boolean f37575f3;
    public final vy f37576g3;
    public int f37577h3;
    public float f37578i3;
    public final Paint j3;
    public final RectF f37579k3;
    public org.telegram.ui.Components.ml0 f37580l3;
    public LongSparseArray f37581m3;
    public Paint f37582n3;
    public float f37583o3;
    public float f37584p3;
    public float f37585q3;
    public boolean f37586r3;
    public ai.rc f37587s3;
    public int f37588t3;
    public final wy f37589u3;
    ...
    public final void A1(boolean z10, org.telegram.ui.Cells.r2 r2Var) {
        ...
        if (SharedConfig.archiveHidden) {
            if (r2Var != null) {
                ...
                w0(0, top, org.telegram.ui.Components.qr.f27384g);
                if (z10) {
                    wyVar.f39217d1 = true;
                } else {
                    B1();
    ...
    public final void a(int[] iArr) {
        int paddingTop = (int) (getPaddingTop() + this.f37589u3.N);
        iArr[0] = paddingTop;
    ...
    public final void addView(View view, int i10, ViewGroup.LayoutParams layoutParams) {
        ...
        view.setTranslationY(wy.f39198z4);
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        if (motionEvent.getAction() == 0 && motionEvent.getY() < getPaddingTop() + this.f37589u3.N) {
            return false;
        }
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        if (getItemAnimator() != null && getItemAnimator().k() && (view instanceof org.telegram.ui.Cells.r2) && ((org.telegram.ui.Cells.r2) view).f20752r) {
            return true;
        }
    ...
    public final void onDraw(Canvas canvas) {
        vy vyVar = this.f37576g3;
        if (vyVar.f38531n != null && wy.f39198z4 != 0.0f) {
            int paddingTop = getPaddingTop();
            if (paddingTop != 0) {
                canvas.save();
                canvas.translate(0.0f, paddingTop);
            }
            vyVar.f38531n.c(canvas, true);
            if (paddingTop != 0) {
                canvas.restore();
            }
        }
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (!this.X1) {
            wy wyVar = this.f37589u3;
            if (!wyVar.f39206b1 && !this.f37576g3.f38535x.k()) {
                if (motionEvent.getAction() == 0) {
                    kVar = ((org.telegram.ui.ActionBar.o2) wyVar).actionBar;
                    wyVar.f39212c1 = !kVar.s();
                }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        this.f37577h3 = getPaddingTop();
        this.f37589u3.f39320x3 = 0.0f;
        this.f37576g3.getClass();
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        vy vyVar = this.f37576g3;
        int L0 = vyVar.f38529c.L0();
        wy wyVar = this.f37589u3;
        if (L0 != -1 && vyVar.e.f42851y == 0 && vyVar.f38529c.f42699y < 0 && vyVar.f38527a.getScrollState() != 1) {
            s4.c1 L = vyVar.f38527a.L(L0);
            if (L != null) {
                ...
                this.f37575f3 = true;
                vyVar.f38529c.h1(L0, (int) ((top - this.f37577h3) + wyVar.f39320x3 + 0));
                this.f37575f3 = false;
            }
        } else if (L0 == -1 && this.f37574e3) {
            zw zwVar = vyVar.f38529c;
            if (vyVar.f38533s == 0 && wyVar.Z3()) {
                i12 = 1;
            } else {
                i12 = 0;
            }
        ...
        this.f37588t3 += (int) (AndroidUtilities.dp(50.0f) * S3);
        ...
        this.f37588t3 -= AndroidUtilities.dp(Math.max(S3, f7) * 5.0f);
        int n32 = wyVar.n3();
        if (dp2 != this.Y2 || n32 != getPaddingBottom()) {
            setTopGlowOffset(dp2);
            setPadding(0, dp2, 0, n32);
            if (wyVar.K) {
                vyVar.f38534w.setPaddingTop(dp2 - AndroidUtilities.dp(81.0f));
            } else {
                vyVar.f38534w.setPaddingTop(dp2);
            }
        ...
        this.f37575f3 = false;
        if (this.f37574e3 && wyVar.getMessagesController().dialogsLoaded) {
            if (vyVar.f38533s == 0 && wyVar.Z3()) {
                this.f37575f3 = true;
        ...
        if (!wyVar.f39257l2 && dp2 != 0 && (vyVarArr = wyVar.f39221e0) != null && vyVarArr.length > 1 && !wyVar.f39258l3 && (animatorSet = wyVar.f39230f3) != null) {
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (!this.X1) {
            wy wyVar = this.f37589u3;
            if (wyVar.f39206b1 || wyVar.f39321y) {
                return false;
            }
            ...
            if (action == 1 || action == 3) {
                s4.y yVar = vyVar.e;
                if (yVar.f42851y != 0) {
                    uy uyVar = vyVar.f38530f;
                    if (uyVar.e) {
                        uyVar.f38246f = true;
                        if (yVar.g(null, 4) != 0 && (c1Var = vyVar.f38530f.d) != null) {
            ...
            if (vyVar.f38533s == 0 && ((action == 1 || action == 3) && vyVar.v == 2 && wyVar.Z3() && ((s4.c0) getLayoutManager()).L0() == 0)) {
                int paddingTop = getPaddingTop();
                ...
                if (Q3 != null) {
                    ...
                    long currentTimeMillis = System.currentTimeMillis() - wyVar.f39214c3;
