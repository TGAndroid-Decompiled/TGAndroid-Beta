...
public final class sy extends s4.v {
    public s4.c1 d;
    public boolean f40569e;
    public boolean f40570f;
    public final ty f40571g;
    public final uy h;
    ...
    public final long d(RecyclerView recyclerView, int i10, float f7, float f10) {
        ...
        if (i10 == 8 && (r2Var = (uyVar = this.h).X0) != null) {
            AndroidUtilities.runOnUIThread(new jh(1, r2Var), this.f40571g.f40868x.f45830e);
            uyVar.X0 = null;
        }
    ...
    public final boolean n(RecyclerView recyclerView, s4.c1 c1Var, s4.c1 c1Var2) {
        ...
        int i10;
        uy uyVar = this.h;
        ArrayList arrayList = uyVar.f41239a1;
        ...
        if (view instanceof org.telegram.ui.Cells.r2) {
            ...
            if (dialog != null && uyVar.g4(dialog) && !DialogObject.isFolderDialogId(dialogId)) {
                int b10 = c1Var.b();
                int b11 = c1Var2.b();
                ty tyVar = this.f40571g;
                if (tyVar.f40859a.getItemAnimator() == null) {
                    tyVar.f40859a.setItemAnimator(tyVar.f40868x);
                }
                bx bxVar = tyVar.d;
                uy uyVar2 = bxVar.R;
                int i11 = bxVar.F;
                ...
                bxVar.W(null);
                int i15 = uyVar.f41260e0[0].f40866s;
                if (i15 != 7) {
                    i10 = 8;
                    if (i15 != 8) {
                        uyVar.Z0 = true;
                ...
                if (uyVar.f41260e0[0].f40866s == i10) {
                    c11 = 1;
                }
    ...
    public final void p(s4.c1 c1Var, int i10) {
        if (c1Var != null) {
            this.f40571g.f40859a.c1(false);
        }
        this.d = c1Var;
        if (c1Var != null) {
            View view = c1Var.f45739a;
            if (view instanceof org.telegram.ui.Cells.r2) {
                ((org.telegram.ui.Cells.r2) view).f22644w = false;
            }
        }
    }
    ...
    public final void q(s4.c1 c1Var) {
        ...
        if (c1Var != null) {
            ...
            if (Utilities.random.nextInt(1000) == 1) {
                if (uyVar.V0 == null) {
                    qy qyVar2 = tyVar.f40859a;
                    ?? obj = new Object();
                    obj.f24673a = new Paint(1);
                    Paint paint = new Paint(1);
                    obj.f24674b = paint;
                    obj.f24676e = 0L;
                    obj.f24677f = new RectF();
                ...
                bd0Var.h = 0.0f;
                bd0Var.f24678g = 0.0f;
                bd0Var.f24676e = System.currentTimeMillis();
                bd0Var.f24675c.invalidate();
                return;
            }
            a0Var.run();
            return;
