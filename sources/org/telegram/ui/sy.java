...
public final class sy extends View implements NotificationCenter.NotificationCenterDelegate {
    ...
    public float h;
    public final ImageReceiver f37886n;
    public final ImageReceiver f37887r;
    public final org.telegram.ui.Components.jj0 f37888s;
    public final org.telegram.ui.Components.jj0 v;
    public boolean f37889w;
    public int f37890x;
    public boolean f37891y;

    public sy(Context context, int i10) {
        super(context);
        this.f37882a = new Paint(1);
        this.f37883b = new Paint(1);
        this.d = new ArrayList();
        ImageReceiver imageReceiver = new ImageReceiver(this);
        this.f37886n = imageReceiver;
        ImageReceiver imageReceiver2 = new ImageReceiver(this);
        this.f37887r = imageReceiver2;
        this.f37884c = i10;
        imageReceiver.ignoreNotifications = true;
        imageReceiver2.ignoreNotifications = true;
        org.telegram.ui.Components.jj0 jj0Var = new org.telegram.ui.Components.jj0(R.raw.download_progress, AndroidUtilities.dp(28.0f), AndroidUtilities.dp(28.0f), true, null);
        this.f37888s = jj0Var;
        org.telegram.ui.Components.jj0 jj0Var2 = new org.telegram.ui.Components.jj0(R.raw.download_finish, AndroidUtilities.dp(28.0f), AndroidUtilities.dp(28.0f), true, null);
        this.v = jj0Var2;
        imageReceiver.setImageBitmap(jj0Var);
        imageReceiver2.setImageBitmap(jj0Var2);
    ...
    public final void a() {
        ...
        this.f37888s.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.h6.w0(null, i10, false), PorterDuff.Mode.SRC_IN));
    ...
    public final void b() {
        ...
        while (true) {
            ...
            hashMap.put(((ry) arrayList.get(i11)).f37536c, (ry) arrayList.get(i11));
        ...
        if (arrayList.size() == 0 && !this.f37891y) {
    ...
    public final void c() {
        MessagesStorage.getInstance(this.f37884c);
        int i10 = 0;
        long j3 = 0;
        long j10 = 0;
        while (true) {
            ...
            j3 += ((ry) arrayList.get(i10)).f37534a;
            j10 += ((ry) arrayList.get(i10)).f37535b;
            i10++;
        }
        if (j3 == 0) {
            this.e = 1.0f;
        ...
        this.h = ((this.e - this.f37885f) * 16.0f) / 150.0f;
        invalidate();
    }
    ...
    public final void onAttachedToWindow() {
        ...
        b();
        NotificationCenter.getInstance(this.f37884c).addObserver(this, NotificationCenter.onDownloadingFilesChanged);
        this.f37886n.onAttachedToWindow();
        this.f37887r.onAttachedToWindow();
    }
    ...
    public final void onDetachedFromWindow() {
        ...
        while (true) {
            ...
            if (i10 < size) {
                ...
                this.f37886n.onDetachedFromWindow();
                this.f37887r.onDetachedFromWindow();
                return;
            }
        }
    }
    ...
    public final void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        if (getAlpha() != 0.0f) {
            int i10 = this.f37890x;
            int i11 = org.telegram.ui.ActionBar.h6.f19392v8;
            int w02 = org.telegram.ui.ActionBar.h6.w0(null, i11, false);
            ImageReceiver imageReceiver = this.f37887r;
            ImageReceiver imageReceiver2 = this.f37886n;
            Paint paint = this.f37882a;
            Paint paint2 = this.f37883b;
            if (i10 != w02) {
                this.f37890x = org.telegram.ui.ActionBar.h6.w0(null, i11, false);
            ...
            rectF.set(dp3, f13, ((getMeasuredWidth() - (2.0f * dp3)) * this.f37885f) + dp3, f14);
            ...
            if (this.e == 1.0f && !this.f37889w && this.f37888s.f25422a0 == 0) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        float f7 = dp;
        this.f37886n.setImageCoords(f7, f7, getMeasuredWidth() - i12, getMeasuredHeight() - i12);
        this.f37887r.setImageCoords(f7, f7, getMeasuredWidth() - i12, getMeasuredHeight() - (dp * 2));
    }
