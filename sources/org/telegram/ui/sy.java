...
public final class sy extends s4.v {
    ...
    public final long d(RecyclerView recyclerView, int i10, float f7, float f10) {
        ...
        if (i10 == 8 && (r2Var = (uyVar = this.h).X0) != null) {
            AndroidUtilities.runOnUIThread(new ih(1, r2Var), this.f37507g.f37760x.e);
            uyVar.X0 = null;
        }
    ...
    public final boolean n(RecyclerView recyclerView, s4.c1 c1Var, s4.c1 c1Var2) {
        ...
        int i10;
        uy uyVar = this.h;
        ArrayList arrayList = uyVar.f38202a1;
        ...
        if (view instanceof org.telegram.ui.Cells.r2) {
            ...
            if (dialog != null && uyVar.g4(dialog) && !DialogObject.isFolderDialogId(dialogId)) {
                int b10 = c1Var.b();
                int b11 = c1Var2.b();
                ty tyVar = this.f37507g;
                if (tyVar.f37752a.getItemAnimator() == null) {
                    tyVar.f37752a.setItemAnimator(tyVar.f37760x);
                }
                bx bxVar = tyVar.d;
                uy uyVar2 = bxVar.R;
                int i11 = bxVar.F;
                ArrayList R3 = uyVar2.R3(i11, bxVar.h, bxVar.f9853r, false);
                int G = bxVar.G(b10);
                int G2 = bxVar.G(b11);
                ...
                if (i12 != 7 && i12 != 8) {
                    ...
                    int i14 = dialogFilter.pinnedDialogs.get(dialog2.f18113id);
                    dialogFilter.pinnedDialogs.put(dialog2.f18113id, dialogFilter.pinnedDialogs.get(dialog3.f18113id));
                    dialogFilter.pinnedDialogs.put(dialog3.f18113id, i14);
                }
                Collections.swap(R3, G, G2);
                bxVar.W(null);
                int i15 = uyVar.f38222e0[0].f37758s;
                if (i15 != 7) {
                    i10 = 8;
                    if (i15 != 8) {
                        uyVar.Z0 = true;
                ...
                if (uyVar.f38222e0[0].f37758s == i10) {
                    c11 = 1;
                }
    ...
    public final void p(s4.c1 c1Var, int i10) {
        if (c1Var != null) {
            this.f37507g.f37752a.d1(false);
        }
        this.d = c1Var;
        if (c1Var != null) {
            View view = c1Var.f42671a;
            if (view instanceof org.telegram.ui.Cells.r2) {
                ((org.telegram.ui.Cells.r2) view).f20766w = false;
            }
        }
    }
    ...
    public final void q(s4.c1 c1Var) {
        ...
        uy uyVar = this.h;
        if (c1Var != null) {
            org.telegram.ui.Cells.r2 r2Var = (org.telegram.ui.Cells.r2) c1Var.f42671a;
            ...
            if (Utilities.random.nextInt(1000) == 1) {
                if (uyVar.V0 == null) {
                    qy qyVar2 = tyVar.f37752a;
                    ?? obj = new Object();
                    obj.f22359a = new Paint(1);
                    Paint paint = new Paint(1);
                    obj.f22360b = paint;
                    obj.e = 0L;
                    obj.f22362f = new RectF();
