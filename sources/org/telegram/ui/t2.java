...
public final class t2 extends FrameLayout implements org.telegram.ui.Components.jz0, org.telegram.ui.Cells.p9 {
    public final u70 f37539a;
    public final f4 f37540b;
    public final s2 f37541c;
    public a3 d;
    ...
    public TL_iv.pageBlockTable f37545s;
    ...
    public final void a() {
        ...
        for (int i11 = 0; i11 < childCount; i11++) {
            ...
            org.telegram.ui.Components.cz0 cz0Var = d.f23434b;
            if (cz0Var != null) {
                cz0Var.setX((AndroidUtilities.dp(18.0f) + (d.b() + this.f37542f)) - this.f37541c.getScrollX());
                d.f23434b.setY(d.c() + this.h);
                d.f23434b.setRow(d.f23439j + 10);
                d.f23447r = i10;
                i10++;
            }
        }
    ...
    public final org.telegram.ui.Components.cz0 createTextLayout(TL_iv.pageTableCell pagetablecell, int i10) {
        ...
        return h4.p(this.f37539a, this, null, pagetablecell.text, i10, -1, this.f37545s, alignment2, 0, this.f37540b);
    }
    ...
    public final void fillTextLayoutBlocks(ArrayList arrayList) {
        ...
        for (int i10 = 0; i10 < childCount; i10++) {
            org.telegram.ui.Components.cz0 cz0Var = kz0Var.d(i10).f23434b;
            if (cz0Var != null) {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        a3 a3Var = this.d;
        u70 u70Var = this.f37539a;
        if (a3Var != null) {
            canvas.save();
            canvas.translate(this.f37543n, 0);
            h4.v(u70Var, canvas, this, 0);
            this.d.draw(canvas, this);
            canvas.restore();
        }
        h4.u(canvas, u70Var, this.f37545s, getMeasuredHeight());
    }
                ...
                while (true) {
                    ...
                    if (indexOf >= 0) {
                        ...
                        if (indexOf == 0 || AndroidUtilities.isPunctuationCharacter(lowerCase.charAt(indexOf - 1))) {
                            ...
                            this.f37540b.f33491y.put(u70Var.F + this.f37545s + a3Var.f31667r + indexOf, Integer.valueOf(staticLayout.getLineTop(staticLayout.getLineForOffset(indexOf)) + i11));
                        }
                        i12 = length;
                    } else {
                        return;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        TL_iv.pageBlockTable pageblocktable = this.f37545s;
        if (pageblocktable != null) {
            ...
            if (i14 > 0) {
                ...
                this.f37542f = 0;
                u70Var.getClass();
                this.f37543n = AndroidUtilities.dp(18);
                dp = size - AndroidUtilities.dp(36);
            }
            int i15 = dp;
            TL_iv.pageBlockTable pageblocktable2 = this.f37545s;
            a3 p5 = h4.p(this.f37539a, this, null, pageblocktable2.title, i15, 0, pageblocktable2, Layout.Alignment.ALIGN_CENTER, 0, this.f37540b);
            this.d = p5;
            if (p5 != null) {
                i13 = AndroidUtilities.dp(8.0f) + p5.d.getHeight();
                this.h = i13;
                a3 a3Var = this.d;
                a3Var.f31668s = this.f37543n;
                a3Var.v = 0;
            } else {
                this.h = AndroidUtilities.dp(8.0f);
                i13 = 0;
            }
            int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(size - this.f37542f, 1073741824);
            ...
            TL_iv.pageBlockTable pageblocktable3 = this.f37545s;
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        while (i10 < childCount) {
            ...
            if (cz0Var instanceof a3) {
                a3 a3Var = (a3) cz0Var;
                s2 s2Var = this.f37541c;
                int b10 = d.b() + (s2Var.getPaddingLeft() - s2Var.getScrollX()) + this.f37542f;
                int i11 = this.h;
                MotionEvent motionEvent3 = motionEvent;
                motionEvent2 = motionEvent3;
                if (h4.l(this.f37539a, this.f37540b, motionEvent3, this, a3Var, b10, d.c() + i11)) {
                    return true;
                }
            } else {
        ...
        if (!h4.l(this.f37539a, this.f37540b, motionEvent4, this, this.d, this.f37543n, 0) && !super.onTouchEvent(motionEvent4)) {
            return false;
        }
        return true;
    }
    ...
    public void setBlock(TL_iv.pageBlockTable pageblocktable) {
        boolean z10;
        int i10;
        this.f37545s = pageblocktable;
        int i11 = org.telegram.ui.ActionBar.i6.f18834d6;
        ((h4) this.f37539a).getClass();
        AndroidUtilities.setScrollViewEdgeEffectColor(this.f37541c, org.telegram.ui.ActionBar.i6.w0(null, i11, false));
        org.telegram.ui.Components.kz0 kz0Var = this.e;
        kz0Var.P.clear();
        kz0Var.K.clear();
        kz0Var.g();
        kz0Var.setDrawLines(this.f37545s.bordered);
        kz0Var.setStriped(this.f37545s.striped);
        f4 f4Var = this.f37540b;
        if (f4Var != null && f4Var.G) {
            z10 = true;
        } else {
        ...
        kz0Var.setRtl(z10);
        if (!this.f37545s.rows.isEmpty()) {
            TL_iv.pageTableRow pagetablerow = this.f37545s.rows.get(0);
        ...
        int size2 = this.f37545s.rows.size();
        for (int i14 = 0; i14 < size2; i14++) {
            TL_iv.pageTableRow pagetablerow2 = this.f37545s.rows.get(i14);
