...
public final class t2 extends FrameLayout implements org.telegram.ui.Components.kz0, org.telegram.ui.Cells.p9 {
    public final w70 f37614a;
    public final f4 f37615b;
    public final s2 f37616c;
    public a3 d;
    public final org.telegram.ui.Components.lz0 e;
    public int f37617f;
    public int h;
    public int f37618n;
    public boolean f37619r;
    public TL_iv.pageBlockTable f37620s;
    ...
    public final void a() {
        ...
        for (int i11 = 0; i11 < childCount; i11++) {
            ...
            org.telegram.ui.Components.dz0 dz0Var = d.f23702b;
            if (dz0Var != null) {
                dz0Var.setX((AndroidUtilities.dp(18.0f) + (d.b() + this.f37617f)) - this.f37616c.getScrollX());
                d.f23702b.setY(d.c() + this.h);
                d.f23702b.setRow(d.f23707j + 10);
                d.f23715r = i10;
                i10++;
            }
        }
    ...
    public final org.telegram.ui.Components.dz0 createTextLayout(TL_iv.pageTableCell pagetablecell, int i10) {
        ...
        return h4.p(this.f37614a, this, null, pagetablecell.text, i10, -1, this.f37620s, alignment2, 0, this.f37615b);
    }
    ...
    public final void fillTextLayoutBlocks(ArrayList arrayList) {
        ...
        for (int i10 = 0; i10 < childCount; i10++) {
            org.telegram.ui.Components.dz0 dz0Var = lz0Var.d(i10).f23702b;
            if (dz0Var != null) {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        a3 a3Var = this.d;
        w70 w70Var = this.f37614a;
        if (a3Var != null) {
            canvas.save();
            canvas.translate(this.f37618n, 0);
            h4.v(w70Var, canvas, this, 0);
            this.d.draw(canvas, this);
            canvas.restore();
        }
        h4.u(canvas, w70Var, this.f37620s, getMeasuredHeight());
    }
                ...
                while (true) {
                    ...
                    if (indexOf >= 0) {
                        ...
                        if (indexOf == 0 || AndroidUtilities.isPunctuationCharacter(lowerCase.charAt(indexOf - 1))) {
                            ...
                            this.f37615b.f33544y.put(w70Var.F + this.f37620s + a3Var.f31693r + indexOf, Integer.valueOf(staticLayout.getLineTop(staticLayout.getLineForOffset(indexOf)) + i11));
                        }
                        i12 = length;
                    } else {
                        return;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        TL_iv.pageBlockTable pageblocktable = this.f37620s;
        if (pageblocktable != null) {
            ...
            if (i14 > 0) {
                ...
                this.f37617f = 0;
                w70Var.getClass();
                this.f37618n = AndroidUtilities.dp(18);
                dp = size - AndroidUtilities.dp(36);
            }
            int i15 = dp;
            TL_iv.pageBlockTable pageblocktable2 = this.f37620s;
            a3 p5 = h4.p(this.f37614a, this, null, pageblocktable2.title, i15, 0, pageblocktable2, Layout.Alignment.ALIGN_CENTER, 0, this.f37615b);
            this.d = p5;
            if (p5 != null) {
                i13 = AndroidUtilities.dp(8.0f) + p5.d.getHeight();
                this.h = i13;
                a3 a3Var = this.d;
                a3Var.f31694s = this.f37618n;
                a3Var.v = 0;
            } else {
                this.h = AndroidUtilities.dp(8.0f);
                i13 = 0;
            }
            int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(size - this.f37617f, 1073741824);
            ...
            TL_iv.pageBlockTable pageblocktable3 = this.f37620s;
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        while (i10 < childCount) {
            ...
            if (dz0Var instanceof a3) {
                a3 a3Var = (a3) dz0Var;
                s2 s2Var = this.f37616c;
                int b10 = d.b() + (s2Var.getPaddingLeft() - s2Var.getScrollX()) + this.f37617f;
                int i11 = this.h;
                MotionEvent motionEvent3 = motionEvent;
                motionEvent2 = motionEvent3;
                if (h4.l(this.f37614a, this.f37615b, motionEvent3, this, a3Var, b10, d.c() + i11)) {
                    return true;
                }
            } else {
        ...
        if (!h4.l(this.f37614a, this.f37615b, motionEvent4, this, this.d, this.f37618n, 0) && !super.onTouchEvent(motionEvent4)) {
            return false;
        }
        return true;
    }
    ...
    public void setBlock(TL_iv.pageBlockTable pageblocktable) {
        boolean z10;
        int i10;
        this.f37620s = pageblocktable;
        int i11 = org.telegram.ui.ActionBar.j6.f18862d6;
        ((h4) this.f37614a).getClass();
        AndroidUtilities.setScrollViewEdgeEffectColor(this.f37616c, org.telegram.ui.ActionBar.j6.w0(null, i11, false));
        org.telegram.ui.Components.lz0 lz0Var = this.e;
        lz0Var.P.clear();
        lz0Var.K.clear();
        lz0Var.g();
        lz0Var.setDrawLines(this.f37620s.bordered);
        lz0Var.setStriped(this.f37620s.striped);
        f4 f4Var = this.f37615b;
        if (f4Var != null && f4Var.G) {
            z10 = true;
        } else {
        ...
        lz0Var.setRtl(z10);
        if (!this.f37620s.rows.isEmpty()) {
            TL_iv.pageTableRow pagetablerow = this.f37620s.rows.get(0);
        ...
        int size2 = this.f37620s.rows.size();
        for (int i14 = 0; i14 < size2; i14++) {
            TL_iv.pageTableRow pagetablerow2 = this.f37620s.rows.get(i14);
