...
public final class t2 extends HorizontalScrollView {
    public final p70 f37946a;
    public final u2 f37947b;
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        this.f37947b.e.getMeasuredWidth();
        getMeasuredWidth();
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        if (this.f37947b.e.getMeasuredWidth() <= getMeasuredWidth() - AndroidUtilities.dp(36.0f)) {
            return false;
        }
