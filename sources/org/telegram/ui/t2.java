...
public final class t2 extends HorizontalScrollView {
    public final p70 f37947a;
    public final u2 f37948b;
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        this.f37948b.e.getMeasuredWidth();
        getMeasuredWidth();
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        if (this.f37948b.e.getMeasuredWidth() <= getMeasuredWidth() - AndroidUtilities.dp(36.0f)) {
            return false;
        }
