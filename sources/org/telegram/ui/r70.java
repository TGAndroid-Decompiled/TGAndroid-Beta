...
public final class r70 extends LinearLayout {
    public final org.telegram.ui.Components.zt f40085a;
    public boolean f40086b;
    public int f40087c;
    public yt d;
    public String f40088e;
    public final q70 f40089f;
    public final u70 h;

    public r70(u70 u70Var, Context context) {
        super(context);
        this.h = u70Var;
        this.f40089f = new q70(this);
        TextView g10 = org.telegram.messenger.w1.g(context, 1, 16.0f);
        g10.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20771j5, false));
        ...
        ztVar.setLinkTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20741hc, false));
        ztVar.setHighlightColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20982uf, false));
        ...
        ztVar.setHandlesColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20999vf, false));
    ...
    public final void onDraw(Canvas canvas) {
        if (this.f40086b) {
            canvas.drawLine(AndroidUtilities.dp(20.0f), getHeight() - 1, getWidth() - getPaddingRight(), getHeight() - 1, org.telegram.ui.ActionBar.j6.f20786k0);
        }
    }
}
