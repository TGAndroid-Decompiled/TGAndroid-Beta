...
public abstract class gs extends EditTextBoldCursor {
    ...
    public boolean H;
    public float f36762b;
    public float f36763c;
    public float d;
    public float f36764e;
    public o1.k f36765f;
    public o1.k h;
    public o1.k f36766n;
    public o1.k f36767r;
    ...
    public float v;
    public float f36769w;
    public boolean f36770x;
    public Bitmap f36771y;
    ...
    public final void j(float f7) {
        k(this.f36765f, f7 * 100.0f);
    }

    public final void l(float f7) {
        k(this.f36766n, f7 * 100.0f);
        o1.k kVar = this.f36767r;
        kVar.c();
        if (f7 != 0.0f) {
    ...
    public final void m() {
        if (getMeasuredHeight() != 0 && getMeasuredWidth() != 0 && getLayout() != null) {
            Bitmap bitmap = this.f36771y;
            if (bitmap == null || bitmap.getHeight() != getMeasuredHeight() || this.f36771y.getWidth() != getMeasuredWidth()) {
                Bitmap bitmap2 = this.f36771y;
                if (bitmap2 != null) {
                    bitmap2.recycle();
                }
                this.f36771y = Bitmap.createBitmap(getMeasuredWidth(), getMeasuredHeight(), Bitmap.Config.ARGB_8888);
                this.E = new Canvas(this.f36771y);
            }
            this.f36771y.eraseColor(0);
