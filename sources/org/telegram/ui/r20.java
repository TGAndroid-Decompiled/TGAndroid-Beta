...
public final class r20 implements View.OnClickListener {
    ...
    public final org.telegram.ui.Cells.z1[] f40741b;

    public r20(org.telegram.ui.Cells.z1[] z1VarArr, int i10) {
        this.f40740a = i10;
        this.f40741b = z1VarArr;
    }
    ...
    public final void onClick(View view) {
        switch (this.f40740a) {
            case 0:
                ...
                org.telegram.ui.Cells.z1[] z1VarArr = this.f40741b;
                z1VarArr[intValue].c(!z1VarArr[num.intValue()].b(), true);
                return;
            case 1:
                org.telegram.ui.Cells.z1 z1Var = this.f40741b[0];
                z1Var.c(!z1Var.b(), true);
                return;
            default:
                org.telegram.ui.Cells.z1 z1Var2 = this.f40741b[0];
