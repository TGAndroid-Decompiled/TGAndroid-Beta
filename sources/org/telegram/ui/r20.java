...
public final class r20 implements View.OnClickListener {
    ...
    public final org.telegram.ui.Cells.a2[] f37161b;

    public r20(org.telegram.ui.Cells.a2[] a2VarArr, int i10) {
        this.f37160a = i10;
        this.f37161b = a2VarArr;
    }
    ...
    public final void onClick(View view) {
        switch (this.f37160a) {
            case 0:
                ...
                org.telegram.ui.Cells.a2[] a2VarArr = this.f37161b;
                a2VarArr[intValue].c(!a2VarArr[num.intValue()].b(), true);
                return;
            case 1:
                org.telegram.ui.Cells.a2 a2Var = this.f37161b[0];
                a2Var.c(!a2Var.b(), true);
                return;
            default:
                org.telegram.ui.Cells.a2 a2Var2 = this.f37161b[0];
