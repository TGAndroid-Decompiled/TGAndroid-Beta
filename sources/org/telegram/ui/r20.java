...
public abstract class r20 extends org.telegram.ui.ActionBar.n2 {
    ...
    public int N;
    public int O;
    public final n20 f36936a;
    public final n20 f36937b;
    public org.telegram.ui.Components.wl0 f36938c;
    public Drawable d;
    public rg.v1 e;
    public boolean f36939f;
    public boolean h;
    public float f36940n;
    public int f36941r;
    public q20 f36942s;
    public float v;
    public final Canvas f36943w;
    public float f36944x;
    public o20 f36945y;
    ...
    public r20() {
        ...
        this.f36936a = new n20(i10, i11, i12, i13, null, 0);
        n20 n20Var = new n20(i10, i11, i12, i13, null, 1);
        this.f36937b = n20Var;
        this.f36943w = new Canvas(Bitmap.createBitmap(100, 100, Bitmap.Config.ARGB_8888));
        this.E = -1;
        this.G = true;
        this.K = new Paint();
        n20Var.f42817n = true;
    ...
    public View createView(Context context) {
        ...
        this.f36938c = new org.telegram.ui.Components.wl0(context, null);
        if (this.G) {
            this.F = new org.telegram.ui.Components.pz(this.f36938c, (AndroidUtilities.dp(68.0f) + this.I) - AndroidUtilities.dp(16.0f));
        } else {
            this.F = new s4.c0();
        }
        this.f36938c.setLayoutManager(this.F);
        s4.c0 c0Var = this.F;
        if (c0Var instanceof org.telegram.ui.Components.pz) {
            ((org.telegram.ui.Components.pz) c0Var).R = true;
        }
        s4.h0 n02 = n0();
        this.f36938c.setAdapter(n02);
        if (n02 instanceof org.telegram.ui.Components.l61) {
            org.telegram.ui.Components.wl0 wl0Var = this.f36938c;
            m20 m20Var = new m20(this, 0);
            int dp = AndroidUtilities.dp(12.0f);
            float dp2 = AndroidUtilities.dp(16.0f);
            org.telegram.ui.Components.wl0 wl0Var2 = this.f36938c;
            Objects.requireNonNull(wl0Var2);
            wl0Var.s1(m20Var, dp, dp2, new fu(wl0Var2, 11), true);
        } else {
            this.f36938c.setSections(true);
        }
        this.f36938c.setClipToPadding(false);
        this.f36938c.j(new h3(this, 11));
        this.f36945y = new o20(context);
        q20 q20Var = this.f36942s;
        rg.v1 p02 = p0();
        this.e = p02;
        q20Var.addView(p02, w7.y5.c(-2.0f, -1));
        this.f36942s.addView(this.f36945y, w7.y5.c(-2.0f, -1));
        this.f36942s.addView(this.f36938c, w7.y5.c(-1.0f, -1));
        this.f36942s.addView(this.actionBar);
        this.fragmentView = this.f36942s;
    ...
    public final void m0(String str, CharSequence charSequence, FrameLayout frameLayout, s5 s5Var) {
        o20 o20Var = this.f36945y;
        FrameLayout frameLayout2 = (FrameLayout) o20Var.e;
        FrameLayout frameLayout3 = (FrameLayout) o20Var.d;
        ((TextView) o20Var.f36092b).setText(str);
        org.telegram.ui.Components.l90 l90Var = (org.telegram.ui.Components.l90) o20Var.f36093c;
    ...
    public void onInsets(int i10, int i11, int i12, int i13) {
        this.f36938c.setPadding(0, 0, 0, i13);
    }
    ...
    public final void s0() {
        ...
        if (wl0Var != null && wl0Var.getChildCount() > 0) {
            int i11 = 0;
            while (true) {
                if (i11 < this.f36938c.getChildCount()) {
                    view = this.f36938c.getChildAt(i11);
    ...
    public final Paint t0(float f7, float f10) {
        int measuredWidth = this.f36942s.getMeasuredWidth();
        int measuredHeight = this.f36942s.getMeasuredHeight();
        n20 n20Var = this.f36937b;
        n20Var.d(0, (-f7) - ((this.f36942s.getMeasuredWidth() * 0.1f) * this.f36940n), 0, measuredWidth, -f10, measuredHeight);
        return n20Var.f42810f;
    }

    public final void u0() {
        if (this.f36942s.getMeasuredWidth() != 0 && this.f36942s.getMeasuredHeight() != 0 && this.f36945y != null) {
            int measuredWidth = this.f36942s.getMeasuredWidth();
            int measuredHeight = this.f36942s.getMeasuredHeight();
            n20 n20Var = this.f36936a;
            n20Var.d(0, 0.0f, 0, measuredWidth, 0.0f, measuredHeight);
            Canvas canvas = this.f36943w;
            canvas.save();
            canvas.scale(100.0f / this.f36942s.getMeasuredWidth(), 100.0f / this.f36942s.getMeasuredHeight());
            canvas.drawRect(0.0f, 0.0f, this.f36942s.getMeasuredWidth(), this.f36942s.getMeasuredHeight(), n20Var.f42810f);
            canvas.restore();
        }
    }

    public final void v0() {
        if (this.f36945y != null && this.actionBar != null) {
            this.K.setColor(getThemedColor(org.telegram.ui.ActionBar.j6.f19133h5));
            ...
            o20 o20Var = this.f36945y;
            if (o20Var != null) {
                TextView textView = (TextView) o20Var.f36092b;
                if (this.M) {
                    int i11 = org.telegram.ui.ActionBar.j6.G6;
                    textView.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i11, false));
                    ((org.telegram.ui.Components.l90) this.f36945y.f36093c).setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i11, false));
                    ((org.telegram.ui.Components.l90) this.f36945y.f36093c).setLinkTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.gc, false));
                } else {
                    textView.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i10, false));
                    ((org.telegram.ui.Components.l90) this.f36945y.f36093c).setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i10, false));
                    ((org.telegram.ui.Components.l90) this.f36945y.f36093c).setLinkTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.gc, false));
                }
            }
            u0();
