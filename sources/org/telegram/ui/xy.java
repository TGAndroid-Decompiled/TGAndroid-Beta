...
public final class xy extends org.telegram.ui.ActionBar.j {
    ...
    public final void b(int i10) {
        int i11;
        dz dzVar = this.f39705a;
        int i12 = dzVar.f33132w;
        ArrayList arrayList = dzVar.e;
        int i13 = dzVar.f33133x;
        if (i10 == -1) {
            if (dzVar.f33134y == null) {
                dzVar.Y();
            } else {
            ...
            y0 y0Var = dzVar.f33134y;
            if (y0Var != null) {
                int i15 = y0Var.f39716a;
                Object obj = y0Var.f39717b;
                switch (i15) {
                    case 25:
