...
public final class mn {
    ...
    public ArrayList f35629j;
    public TLRPC.TodoItem f35630k;
    public TLRPC.PollAnswer f35631l;
    public boolean f35627g = false;
    public int d = -1;

    public mn(int i10, int i11, MessageObject messageObject) {
        this.f35623a = messageObject;
        this.f35624b = i10;
        this.f35625c = i11;
        e();
    }
    ...
    public final void a(MessageObject messageObject) {
        ...
        if (message != null && (str = message.message) != null) {
            ...
            if (i12 >= this.f35624b && i12 <= str.length() && this.f35624b <= messageObject.messageOwner.message.length() && (i10 = this.f35624b) >= 0 && (i11 = this.f35625c) >= 0) {
                if (TextUtils.equals(this.f35628i, messageObject.messageOwner.message.substring(i10, i11))) {
                    this.f35623a = messageObject;
                    e();
                    this.f35626f = false;
                    return;
                }
                int indexOf = messageObject.messageOwner.message.indexOf(this.f35628i);
                if (indexOf >= 0) {
                    this.f35623a = messageObject;
                    this.f35625c = (this.f35625c - this.f35624b) + indexOf;
                    this.f35624b = indexOf;
                    e();
                    this.f35626f = false;
                    return;
                }
                this.f35623a = messageObject;
                this.f35624b = 0;
                this.f35625c = messageObject.messageOwner.message.length();
                e();
                this.f35626f = true;
                return;
            }
            FileLog.e("ReplyQuote.checkEdit: start/end are invalid (" + this.f35624b + ", " + this.f35625c + ", len=" + messageObject.messageOwner.message.length() + ")");
            this.f35626f = false;
            return;
        }
    ...
    public final boolean d() {
        if (this.f35627g) {
            ...
            return !TextUtils.isEmpty(this.f35628i);
        }
        return true;
    }
    ...
    public final boolean e() {
        ...
        MessageObject messageObject = this.f35623a;
        if (messageObject != null && (message = messageObject.messageOwner) != null && (str = message.message) != null) {
            if (this.f35627g) {
                ...
                this.f35631l = findPollItem;
                return true;
            } else {
                int i11 = this.f35625c;
                if (i11 >= this.f35624b && i11 <= str.length() && this.f35624b <= this.f35623a.messageOwner.message.length() && (i10 = this.f35624b) >= 0 && this.f35625c >= 0) {
                    String str2 = this.f35623a.messageOwner.message;
                    int max = Math.max(0, i10);
                    while (max < this.f35625c && Character.isWhitespace(str2.charAt(max))) {
                        max++;
                    }
                    int min = Math.min(this.f35625c, str2.length());
                    ...
                    this.f35628i = this.f35623a.messageOwner.message.substring(max, min);
                    ArrayList arrayList = this.f35629j;
                    if (arrayList != null) {
                        arrayList.clear();
                    }
                    ArrayList<TLRPC.MessageEntity> arrayList2 = this.f35623a.messageOwner.entities;
                    if (arrayList2 != null && !arrayList2.isEmpty()) {
                        for (int i12 = 0; i12 < this.f35623a.messageOwner.entities.size(); i12++) {
                            TLRPC.MessageEntity messageEntity = this.f35623a.messageOwner.entities.get(i12);
                            ...
                            if (AndroidUtilities.intersect1dInclusive(max, min, i13, messageEntity.length + i13)) {
                                ...
                                if ((i15 >= 0 || i16 >= 0) && (i15 <= min || i16 <= min)) {
                                    ...
                                    this.f35629j.add(tL_messageEntityCustomEmoji);
                                }
                            }
                        }
                    }
                ...
                FileLog.e("ReplyQuote: start/end are invalid (" + this.f35624b + ", " + this.f35625c + ", len=" + this.f35623a.messageOwner.message.length() + ")");
                return false;
            }
        }
