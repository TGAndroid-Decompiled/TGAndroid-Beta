...
public final class pu extends FrameLayout {
    public final ImageView f36707a;
    public final TextView f36708b;
    public final ImageView f36709c;
    ...
    public pu(av avVar, Context context) {
        ...
        int i10;
        int i11;
        setBackgroundColor(avVar.getThemedColor(org.telegram.ui.ActionBar.j6.f19109d6));
        ImageView imageView = new ImageView(context);
        this.f36707a = imageView;
        ...
        textView2.setTextColor(avVar.getThemedColor(org.telegram.ui.ActionBar.j6.f19311o6));
