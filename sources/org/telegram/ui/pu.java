...
public final class pu extends og.b {
    ...
    public final boolean D(s4.c1 c1Var) {
        switch (this.d) {
            case 0:
                mu muVar = (mu) ((ru) this.e).f37451c3.get(c1Var.b());
    ...
    public final int h() {
        switch (this.d) {
            case 0:
                return ((ru) this.e).f37451c3.size();
            default:
                return ((hc0) this.e).f34177s.size();
        }
    }
    ...
    public final int j(int i10) {
        switch (this.d) {
            case 0:
                return ((mu) ((ru) this.e).f37451c3.get(i10)).f15700a;
            default:
                hc0 hc0Var = (hc0) this.e;
                if (i10 >= 0 && i10 < hc0Var.f34177s.size()) {
                    return ((bc0) hc0Var.f34177s.get(i10)).f15700a;
                }
                return 2;
        }
    }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        switch (i11) {
            case 0:
                ...
                org.telegram.ui.ActionBar.d6 d6Var = ruVar.f30094p2;
                if (i10 != 0) {
                    if (i10 != 1) {
                        if (i10 != 3) {
                            if (i10 != 4) {
                                if (i10 != 5) {
                                    if (i10 != 6) {
                                        if (i10 != 7) {
                                            ...
                                            int i13 = ru.f37448p3;
                                            lnVar.setBackgroundColor(org.telegram.ui.ActionBar.h6.v0(i12, ruVar.f30094p2));
                                            r8Var = lnVar;
                                        }
                                    } else {
                                        ?? view2 = new View(ruVar.getContext());
                                        view2.f38221a = new Path();
                                    ...
                                    r8Var2.setTextColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19265p7, d6Var));
                                    r8Var2.setBackgroundColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19045d6, d6Var));
                                    r8Var = r8Var2;
                                }
                            } else {
                                View m4Var = new org.telegram.ui.Cells.m4(ruVar.getContext());
                                m4Var.setBackgroundColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19045d6, d6Var));
                                r8Var = m4Var;
                            }
                        } else {
                        ...
                        frameLayout.f38542a = textView;
                        textView.setGravity(17);
                        textView.setTextSize(1, 13.0f);
                        textView.setTextColor(vuVar.getThemedColor(org.telegram.ui.ActionBar.h6.f19428y6));
                    ...
                    int[] iArr = vu.e;
                    ou ouVar = new ou(this, context2, iArr.length, iArr, vu.f38799f);
                    ruVar.f37461n3 = ouVar;
                    ouVar.setInterceptTouch(false);
                    View view3 = ruVar.f37461n3;
                    view3.setTag(-33024);
                    r8Var = view3;
                }
