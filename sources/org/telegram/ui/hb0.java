        ...
        switch (this.f34180a) {
            case 2:
                ...
                if (i10 < arrayList.size()) {
                    rb0Var.f37288w.setText(LocaleController.formatDateAudio(rb0Var.getConnectionsManager().getCurrentTime() + ((Integer) arrayList.get(i10)).intValue(), false));
                    return;
                }
                rb0Var.f37288w.setText("");
                return;
            default:
                rb0 rb0Var2 = this.f34181b;
