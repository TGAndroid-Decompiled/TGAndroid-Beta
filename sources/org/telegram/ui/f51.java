...
public final class f51 implements Runnable {
    ...
    public final void run() {
        switch (this.f36269a) {
            case 0:
                k51 k51Var = this.f36270b;
                f51 f51Var = k51Var.Z;
                org.telegram.ui.Components.g71 g71Var = k51Var.f37931w;
                if (g71Var != null) {
                    k51Var.f37919a0 = ((float) g71Var.n()) / ((float) k51Var.f37931w.p());
                    i51 i51Var = k51Var.N;
                    if (i51Var != null) {
                        i51Var.Xd = (k51Var.f37931w.p() - k51Var.f37931w.n()) / 1000;
                        k51Var.N.q4();
                        org.telegram.ui.Components.io0 seekBarWaveform = k51Var.N.getSeekBarWaveform();
                        if (seekBarWaveform != null) {
                            float f7 = k51Var.f37919a0;
