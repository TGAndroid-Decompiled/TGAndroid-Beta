...
public final class f51 extends org.telegram.ui.Cells.t1 {
    public boolean Fe;
    ...
    public org.telegram.ui.Components.x11 Oe;
    public final org.telegram.ui.Components.c6 Pe;
    public final int Qe;
    public final int Re;
    public final h51 Se;

    public f51(h51 h51Var, Context context, int i10, org.telegram.ui.ActionBar.e6 e6Var, int i11, int i12) {
    ...
    public final void E1(Canvas canvas) {
        ...
        h51 h51Var = this.Se;
        if (paint != null) {
            float f7 = h51Var.f34170s;
            RectF rectF = h51Var.R;
            if (f7 > 0.0f) {
                if (h51Var.Q) {
                    if (this.f21181oe) {
                        Bitmap bitmap = h51Var.P.getBitmap();
                        if (bitmap != null) {
                            canvas.save();
                            Path path = this.Le;
                            path.rewind();
                    ...
                    getPhotoImage().setAlpha(Math.max(1.0f - this.Pe.e(h51Var.Q), 1.0f - h51Var.f34170s));
            ...
            this.Ke.reset();
            float width2 = (rectF.width() / 76.8f) * h51Var.v;
        ...
        canvas.saveLayerAlpha(h51Var.R, (int) (h51Var.v * 178.0f), 31);
        ...
        canvas.drawArc(rectF2, -90.0f, (1.0f - h51Var.f34160a0) * (-360.0f), false, paint3);
        if (this.Oe == null) {
        ...
        this.Oe.a((1.0f - h51Var.f34160a0) * (-360.0f), 1.0f, canvas, paint3, rectF2);
        canvas.restore();
    }
    ...
    public final void d2(Canvas canvas, float f7, Integer num) {
        ...
        zg.q0 q0Var = this.N;
        h51 h51Var = this.Se;
        canvas.translate(AndroidUtilities.lerp(0, -q0Var.f49144c, h51Var.f34170s), AndroidUtilities.lerp(h51Var.O.getBackgroundDrawableBottom() - getBackgroundDrawableBottom(), q0Var.f49154p, h51Var.f34170s));
        super.d2(canvas, (1.0f - h51Var.f34170s) * f7, num);
        canvas.restore();
    }
    ...
    public final void m2(float f7, Canvas canvas, boolean z10) {
        ...
        h51 h51Var = this.Se;
        if (h51Var.S) {
            int i10 = this.f21192pb;
            MessageObject messageObject = h51Var.M;
            int i11 = 0;
            if (messageObject != null && messageObject.isOutOwner()) {
                MessageObject messageObject2 = h51Var.M;
                if (messageObject2 != null && messageObject2.type == 19) {
                    i11 = 4;
                }
                i11 += 20;
            }
            canvas.translate(((this.He.right - (AndroidUtilities.dp(8 + i11) + i10)) - this.f21222rb) * h51Var.f34170s, 0.0f);
        }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (z10) {
            ...
            AndroidUtilities.lerp(rectF3, rectF2, h51Var.f34170s, rectF);
            U3(rectF.left, rectF.top, rectF.width(), rectF.height());
            getPhotoImage().setRoundRadius((int) rectF.width());
            if (h51Var.f34170s > 0.0f && h51Var.Q) {
                canvas2 = canvas;
                canvas2.saveLayerAlpha(0.0f, 0.0f, getWidth(), getHeight(), 255, 31);
            } else {
                canvas2 = canvas;
            }
            this.f21284ve = 1.0f - h51Var.f34170s;
        } else {
            canvas2 = canvas;
        }
        S1(canvas2);
        if (h51Var.S && h51Var.f34170s > 0.0f && h51Var.Q) {
            canvas2.restore();
        }
    }
