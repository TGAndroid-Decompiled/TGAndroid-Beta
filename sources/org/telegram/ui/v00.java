...
public abstract class v00 extends FrameLayout {
    public final org.telegram.ui.ActionBar.n2 f38245a;
    public final int f38246b;
    public final int f38247c;
    public final Drawable d;
    public final Drawable e;
    public final org.telegram.ui.Components.p6 f38248f;
    public final org.telegram.ui.Components.p6 h;
    public final Paint f38249n;
    public final Paint f38250r;
    public float f38251s;
    public boolean v;
    public ValueAnimator f38252w;
    public String f38253x;
    public TL_chatlists.TL_exportedChatlistInvite f38254y;
    ...
    public v00(Context context, org.telegram.ui.ActionBar.n2 n2Var, int i10, int i11) {
        ...
        addView(p6Var, w7.x5.d(-1, 20.0f, 55, f7, 10.33f, f10, 0.0f));
        ...
        p6Var2.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19189z6, false));
        if (LocaleController.isRTL) {
            i13 = 5;
        } else {
            i13 = 3;
        ...
        addView(p6Var2, w7.x5.d(-1, 16.0f, 55, f11, 33.33f, f12, 0.0f));
    ...
    public final void a() {
        ...
        tL_inputChatlistDialogFilter.filter_id = this.f38247c;
        tL_chatlists_deleteExportedInvite.slug = substring;
        u00 u00Var = new u00(this, 2);
        ConnectionsManager.getInstance(this.f38246b).sendRequest(tL_chatlists_deleteExportedInvite, new mo(21, this, u00Var));
    ...
    public void c() {
        org.telegram.ui.ActionBar.n2 n2Var = this.f38245a;
        if (!(n2Var instanceof c10)) {
            return;
        }
        ai.w0 w0Var = ((c10) n2Var).f32219a;
    ...
    public final void d() {
        ...
        org.telegram.ui.Components.ki0 ki0Var = new org.telegram.ui.Components.ki0(getContext(), LocaleController.getString(R.string.InviteByQRCode), this.f38253x, LocaleController.getString(R.string.QRCodeLinkHelpFolder), false);
    ...
    public final void e(TL_chatlists.TL_exportedChatlistInvite tL_exportedChatlistInvite, boolean z10) {
        boolean z11;
        if (this.f38254y == tL_exportedChatlistInvite) {
            z11 = true;
        } else {
            z11 = false;
        }
        this.f38254y = tL_exportedChatlistInvite;
        ...
        org.telegram.ui.Components.p6 p6Var = this.f38248f;
        if (isEmpty) {
        ...
        if ((z12 ? 1.0f : 0.0f) != this.f38251s) {
            ValueAnimator valueAnimator = this.f38252w;
            ...
            float f7 = 0.0f;
            if (z11) {
                float f10 = this.f38251s;
                if (z12) {
                    f7 = 1.0f;
                }
                ValueAnimator ofFloat = ValueAnimator.ofFloat(f10, f7);
                this.f38252w = ofFloat;
                ofFloat.addUpdateListener(new c3(this, 13));
                this.f38252w.addListener(new org.telegram.ui.Components.ca(28, this, z12));
                this.f38252w.setInterpolator(org.telegram.ui.Components.rr.h);
                this.f38252w.setDuration(350L);
                this.f38252w.start();
                return;
            }
            if (z12) {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float f7 = dp;
        canvas.drawCircle(f7, getMeasuredHeight() / 2.0f, AndroidUtilities.dp(16.0f), this.f38249n);
        if (this.f38251s > 0.0f) {
            canvas.drawCircle(f7, getMeasuredHeight() / 2.0f, AndroidUtilities.dp(16.0f) * this.f38251s, this.f38250r);
        }
        float f10 = this.f38251s;
        if (f10 < 1.0f) {
        ...
        if (this.v) {
            ...
            canvas.drawRect(dp2, measuredHeight, measuredWidth - i10, getMeasuredHeight(), org.telegram.ui.ActionBar.h6.f18910k0);
        }
    }
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        TL_chatlists.TL_exportedChatlistInvite tL_exportedChatlistInvite = this.f38254y;
        String str2 = "";
        if (tL_exportedChatlistInvite == null || TextUtils.isEmpty(tL_exportedChatlistInvite.title)) {
            str = "";
        } else {
            str = a4.a.t(new StringBuilder(), this.f38254y.title, "\n ");
        }
        sb2.append(str);
        org.telegram.messenger.ul.m(R.string.InviteLink, ", ", sb2);
        sb2.append((Object) this.h.getText());
        TL_chatlists.TL_exportedChatlistInvite tL_exportedChatlistInvite2 = this.f38254y;
