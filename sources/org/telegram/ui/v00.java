...
public final class v00 extends org.telegram.ui.Cells.l4 {
    public final TextView f38251r;
    public final u00 f38252s;
    public int v;
    public final org.telegram.ui.Components.f5 f38253w;
    public boolean f38254x;
    public final h10 f38255y;
    ...
    public final void d(int i10, boolean z10) {
        ...
        TextView textView = this.f38251r;
        ...
        this.v = i12;
        u00 u00Var = this.f38252s;
        if (!z11) {
            u00Var.setEmojiColor(i12);
        }
        if (!z10) {
            this.f38253w.a(this.v, true);
        }
        if (z11 != this.f38254x) {
            this.f38254x = z11;
