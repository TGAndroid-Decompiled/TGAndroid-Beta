...
public final class v00 extends org.telegram.ui.Cells.l4 {
    public final TextView f38256r;
    public final u00 f38257s;
    public int v;
    public final org.telegram.ui.Components.f5 f38258w;
    public boolean f38259x;
    public final h10 f38260y;
    ...
    public final void d(int i10, boolean z10) {
        ...
        TextView textView = this.f38256r;
        ...
        this.v = i12;
        u00 u00Var = this.f38257s;
        if (!z11) {
            u00Var.setEmojiColor(i12);
        }
        if (!z10) {
            this.f38258w.a(this.v, true);
        }
        if (z11 != this.f38259x) {
            this.f38259x = z11;
