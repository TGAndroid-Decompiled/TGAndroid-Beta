...
public final class ie extends LinearLayout {
    public final LinearLayout f37368a;
    public final LinearLayout[] f37369b;
    public final org.telegram.ui.Components.y5[] f37370c;
    public final TextView[] d;
    public final TextView f37371e;
    public final DecimalFormat f37372f;

    public ie(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context);
        this.f37369b = new LinearLayout[2];
        this.f37370c = new org.telegram.ui.Components.y5[2];
        ...
        for (int i10 = 0; i10 < 2; i10++) {
            this.f37369b[i10] = new LinearLayout(context);
            this.f37369b[i10].setOrientation(0);
            this.f37368a.addView(this.f37369b[i10], w7.x5.o(-1, -2, 1.0f, 119));
            this.f37370c[i10] = new org.telegram.ui.Components.y5(context);
            this.f37370c[i10].setTypeface(AndroidUtilities.bold());
            this.f37370c[i10].setTextSize(1, 16.0f);
            this.f37370c[i10].setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.G6, f6Var));
            this.f37369b[i10].addView(this.f37370c[i10], w7.x5.t(-2, -2, 80, 0, 0, 5, 0));
            this.d[i10] = new org.telegram.ui.Components.y5(context);
            this.d[i10].setTextSize(1, 11.5f);
            this.d[i10].setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f21070y6, f6Var));
            this.f37369b[i10].addView(this.d[i10], w7.x5.q(-2, -2, 80));
        }
        TextView textView = new TextView(context);
        this.f37371e = textView;
        textView.setTextSize(1, 13.0f);
        textView.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f21070y6, f6Var));
        addView(textView, w7.x5.t(-1, -2, 55, 22, 5, 22, 9));
        DecimalFormatSymbols decimalFormatSymbols = new DecimalFormatSymbols(Locale.US);
        decimalFormatSymbols.setDecimalSeparator('.');
        DecimalFormat decimalFormat = new DecimalFormat("#.##", decimalFormatSymbols);
        this.f37372f = decimalFormat;
    ...
    public void set(he heVar) {
        ...
        int indexOf;
        this.f37371e.setText(heVar.f36991c);
        int i11 = 0;
        while (i11 < 2) {
            if (i11 == 0) {
                str = heVar.f36990b;
            ...
            LinearLayout[] linearLayoutArr = this.f37369b;
            if (i11 == 0 && !heVar.f36989a) {
                linearLayoutArr[i11].setVisibility(8);
            } else if (i11 == 1 && !heVar.f36994g) {
                linearLayoutArr[i11].setVisibility(8);
            } else {
                ...
                TextView[] textViewArr = this.f37370c;
                if (equalsIgnoreCase) {
                    String format = this.f37372f.format(heVar.d / 1.0E9d);
                    ...
                    if ("XTR".equalsIgnoreCase(str)) {
                        if (i10 == 0) {
                            ...
                            spannableStringBuilder2.append((CharSequence) zh.v7.J0(heVar.f36995i, 0.8f, ' '));
                        }
                ...
                textView.setText("≈" + BillingController.getInstance().formatCurrency(j3, heVar.f36993f));
                i11 = i10 + 1;
            }
            i10 = i11;
            i11 = i10 + 1;
