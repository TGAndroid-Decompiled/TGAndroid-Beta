...
public final class ao0 implements mo0 {
    public final Runnable f32205a;
    public final oo0 f32206b;
    ...
    public final boolean c(String str, String str2, boolean z10, TLRPC.TL_inputPaymentCredentialsGooglePay tL_inputPaymentCredentialsGooglePay, TLRPC.TL_paymentSavedCredentialsCard tL_paymentSavedCredentialsCard) {
        String str3;
        oo0 oo0Var = this.f32206b;
        oo0Var.f36316y0 = tL_paymentSavedCredentialsCard;
        oo0Var.f36312w0 = str;
        oo0Var.U0 = z10;
        oo0Var.f36314x0 = str2;
        ...
        if (d9Var != null) {
            ...
            String str4 = oo0Var.f36314x0;
            if (str4 != null && str4.length() > 1) {
                str3 = oo0Var.f36314x0.substring(0, 1).toUpperCase() + oo0Var.f36314x0.substring(1);
            } else {
                str3 = oo0Var.f36314x0;
            }
        ...
        Runnable runnable = this.f32205a;
        if (runnable != null) {
            runnable.run();
        }
        return false;
