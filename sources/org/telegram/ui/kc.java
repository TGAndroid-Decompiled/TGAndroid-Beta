...
public final class kc extends View {
    ...
    public final Canvas f35012b;
    public final float f35013c;
    public final float d;
    public final float e;
    public final Paint f35014f;
    public final Bitmap h;
    public final Paint f35015n;
    ...
    public final void onDraw(Canvas canvas) {
        switch (this.f35011a) {
            case 0:
                ...
                ad adVar = (ad) this.v;
                boolean z10 = adVar.J;
                Paint paint = this.f35015n;
                float f7 = this.e;
                float f10 = this.d;
                float f11 = this.f35013c;
                if (z10) {
                    float f12 = adVar.f32102n0;
                    if (f12 > 0.0f) {
                        this.f35012b.drawCircle(f11, f10, f7 * f12, this.f35014f);
                    }
                    canvas.drawBitmap(this.h, 0.0f, 0.0f, paint);
                } else {
                    canvas.drawCircle(f11, f10, (1.0f - adVar.f32102n0) * f7, paint);
                }
                canvas.save();
                canvas.translate(this.f35016r, this.f35017s);
                adVar.L.draw(canvas);
                canvas.restore();
                return;
            case 1:
                ...
                Paint paint2 = this.f35015n;
                float f13 = this.e;
                float f14 = this.d;
                float f15 = this.f35013c;
                if (z11) {
                    float f16 = tp0Var.Y;
                    if (f16 > 0.0f) {
                        this.f35012b.drawCircle(f15, f14, f13 * f16, this.f35014f);
                    }
            ...
            default:
                ...
                Paint paint3 = this.f35015n;
                float f17 = this.e;
                float f18 = this.d;
                float f19 = this.f35013c;
                if (a2) {
                    float f20 = od1Var.f36157i2;
                    if (f20 > 0.0f) {
                        this.f35012b.drawCircle(f19, f18, f17 * f20, this.f35014f);
                    }
                    canvas.drawBitmap(this.h, 0.0f, 0.0f, paint3);
                } else {
                    canvas.drawCircle(f19, f18, (1.0f - od1Var.f36157i2) * f17, paint3);
                }
                canvas.save();
                canvas.translate(this.f35016r, this.f35017s);
