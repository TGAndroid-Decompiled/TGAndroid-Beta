...
public final class rh0 extends org.telegram.ui.ActionBar.p2 {
    public final org.telegram.ui.Components.ga0 f40965a;

    public rh0(long j10) {
        super(null);
        this.f40965a = new org.telegram.ui.Components.ga0(this, this, getLayoutContainer(), j10);
    }
    ...
    public final View createView(Context context) {
        ...
        org.telegram.ui.Components.ga0 ga0Var = this.f40965a;
        if (ga0Var.f11304a) {
        ...
        if (ga0Var.f11314m == null) {
            ...
            frameLayout.setBackgroundColor(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.f21605a7, p2Var.getResourceProvider()));
            ...
            ga0Var.f11317p = tl0Var;
            tl0Var.setAdapter(ga0Var.f11308f);
            ga0Var.f11317p.p1();
            ...
            ga0Var.f11317p.setSelectorDrawableColor(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.f21750i6, p2Var.getResourceProvider()));
    ...
    public final boolean onBackPressed(boolean z4) {
        kh.u uVar = this.f40965a.f11320s;
        if (uVar != null) {
            if (z4) {
                uVar.e(false);
            }
