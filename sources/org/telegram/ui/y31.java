...
public final class y31 extends cg.c {
    ...
    public final int j(int i10) {
        return ((z31) this.d.f34757s.get(i10)).f2505a;
    }
    ...
    public final void v(f2.m1 m1Var, int i10) {
        ...
        if (((z31) arrayList.get(i10)).f2505a == 1) {
        ...
        } else if (((z31) arrayList.get(i10)).f2505a == 7) {
        ...
        } else if (((z31) arrayList.get(i10)).f2505a == 5) {
            ...
            vaVar.d(userOrChat, str, dialogException.createDescription(i11), (i10 == arrayList.size() - 1 || ((z31) arrayList.get(i10 + 1)).f2505a == 2) ? true : true);
        }
    }
    ...
    public final f2.m1 x(ViewGroup viewGroup, int i10) {
        ...
        switch (i10) {
            ...
            case 8:
                ...
                linearLayout2.addView(lo0Var, k7.c6.t(-1, 38, 0, 5, 0, 5, 4));
                long j10 = saveToGallerySettingsActivity.X().limitVideo;
                ...
                lo0Var.f28793w.X(lo0Var.getProgress(), false);
                linearLayout2.setBackgroundColor(org.telegram.ui.ActionBar.k6.w0(null, org.telegram.ui.ActionBar.k6.f21659d6, false));
            ...
            case 9:
                ...
                uaVar2.a(chat, null);
                uaVar2.setBackgroundColor(saveToGallerySettingsActivity.getThemedColor(org.telegram.ui.ActionBar.k6.f21659d6));
                uaVar = uaVar2;
                view = uaVar;
                break;
            case 10:
                View z6Var = new org.telegram.ui.Cells.z6(viewGroup.getContext(), (b) null);
                z6Var.setBackgroundDrawable(org.telegram.ui.ActionBar.k6.U0(saveToGallerySettingsActivity.getParentActivity(), R.drawable.greydivider_bottom, org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.f21624b7, saveToGallerySettingsActivity.getResourceProvider())));
                uaVar = z6Var;
                view = uaVar;
                break;
        }
