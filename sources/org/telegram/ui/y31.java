...
public final class y31 extends FrameLayout {
    public final org.telegram.ui.Components.c6 f39787a;
    public float f39788b;
    public final Path f39789c;
    public Boolean d;
    public final d41 e;
    ...
    public y31(d41 d41Var, Context context) {
        super(context);
        this.e = d41Var;
        this.f39787a = new org.telegram.ui.Components.c6(this, 250L, org.telegram.ui.Components.qr.h);
        this.f39789c = new Path();
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        while (i12 < length) {
            ...
            if (view == null) {
                ...
                while (true) {
                    ...
                    if (H >= 0 && H < x51Var.f29857x.size() && (G = x51Var.G(H)) != null && G.f15543a == 28) {
                ...
                viewArr = viewPages;
                this.f39788b = (paddingTop * clamp) + f11;
        ...
        if (this.f39788b <= AndroidUtilities.statusBarHeight) {
            f7 = 1.0f;
        } else {
            f7 = 0.0f;
        }
        float d = this.f39787a.d(f7, false);
        float f13 = AndroidUtilities.statusBarHeight;
        float f14 = f13 * d;
        this.f39788b = Math.max(f13, this.f39788b) - (AndroidUtilities.statusBarHeight * d);
        RectF rectF = AndroidUtilities.rectTmp;
        i10 = ((org.telegram.ui.ActionBar.g3) d41Var).backgroundPaddingLeft;
        float f15 = this.f39788b;
        int width = getWidth();
        ...
        canvas.drawRoundRect(rectF, lerp, lerp, d41Var.f33000c);
        canvas.save();
        Path path = this.f39789c;
        path.rewind();
        ...
        if (AndroidUtilities.computePerceivedBrightness(d41Var.getThemedColor(org.telegram.ui.ActionBar.j6.f18934h5)) > 0.721f) {
            z11 = true;
        } else {
            z11 = false;
        }
        if (AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.j6.v(d41Var.getThemedColor(org.telegram.ui.ActionBar.j6.f19140s8), 855638016)) > 0.721f) {
            z12 = true;
        } else {
            z12 = false;
        }
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        if (motionEvent.getAction() == 0 && motionEvent.getY() < this.f39788b) {
            this.e.dismiss();
            return true;
        }
