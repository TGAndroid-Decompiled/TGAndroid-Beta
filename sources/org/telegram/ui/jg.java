...
public final class jg implements e2.h {
    ...
    public final void accept(Object obj) {
        switch (this.f34878a) {
            case 0:
                this.f34879b.E1 = (ChannelBoostsController.CanApplyBoost) obj;
                return;
            case 1:
                View view = (View) obj;
                boolean z10 = view instanceof org.telegram.ui.Cells.t1;
                bo boVar = this.f34879b;
                if (z10) {
                    ...
                    w0Var.f21521e0 = boVar.t9();
                    w0Var.f21534i0 = boVar.C9();
                    boVar.B9();
                    boVar.Q8();
                    int R82 = boVar.R8();
                    if (w0Var.f21537j0 != R82) {
                        w0Var.f21537j0 = R82;
                        w0Var.invalidate();
                        return;
                    }
