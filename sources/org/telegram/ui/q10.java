...
public final class q10 extends org.telegram.ui.Components.pl0 {
    public final Context f40320r;
    public final p10 f40321s = new p10(this);
    public final t10 v;

    public q10(t10 t10Var, Context context) {
        this.v = t10Var;
        this.f40320r = context;
    }
    ...
    public final int M(int i10) {
        t10 t10Var = this.v;
        int i11 = 1;
        if (i10 >= t10Var.f41442n.size()) {
            return 1;
        }
        int size = ((ArrayList) t10Var.f41445r.get(t10Var.f41442n.get(i10))).size();
        if (i10 == 0) {
            i11 = 0;
        }
        return size + i11;
    ...
    public final int R() {
        t10 t10Var = this.v;
        ArrayList arrayList = t10Var.f41442n;
        int i10 = 0;
        if (t10Var.f41434f.isEmpty() || (arrayList.isEmpty() && t10Var.J)) {
            return 0;
        }
    ...
    public final View T(int i10, View view) {
        if (view == null) {
            view = new org.telegram.ui.Cells.u3(this.f40320r, null);
            view.setBackgroundColor(org.telegram.ui.ActionBar.k6.w0(null, org.telegram.ui.ActionBar.k6.f21678e7, false) & (-218103809));
        }
        if (i10 == 0) {
            view.setAlpha(0.0f);
            return view;
        ...
        if (i10 < t10Var.f41442n.size()) {
            view.setAlpha(1.0f);
            ((org.telegram.ui.Cells.u3) view).setText(LocaleController.formatSectionDate(((MessageObject) ((ArrayList) t10Var.f41445r.get((String) t10Var.f41442n.get(i10))).get(0)).messageOwner.date));
        }
        return view;
    }
    ...
    public final void W(int i10, int i11, f2.m1 m1Var) {
        ...
        if (i12 != 2) {
            ArrayList arrayList2 = (ArrayList) t10Var.f41445r.get((String) arrayList.get(i10));
    ...
    public final f2.m1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 != 0) {
            if (i10 != 1) {
                ...
                l7Var.setDelegate(this.f40321s);
                u3Var = l7Var;
            }
        } else {
