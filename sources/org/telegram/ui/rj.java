...
public final class rj extends ai.f7 {
    public int Z2;
    public final ArrayList f37342a3;
    public final ArrayList f37343b3;
    public final ArrayList f37344c3;
    public final ArrayList f37345d3;
    public final ArrayList f37346e3;
    public int f37347f3;
    public int f37348g3;
    public int f37349h3;
    public long f37350i3;
    public float j3;
    public float f37351k3;
    public boolean f37352l3;
    public final float f37353m3;
    public final Paint f37354n3;
    public final Paint f37355o3;
    public final o1.j f37356p3;
    public final o1.k f37357q3;
    public final o1.j f37358r3;
    public final o1.k f37359s3;
    public final o1.j f37360t3;
    public final o1.k f37361u3;
    public boolean f37362v3;
    public final Path f37363w3;
    public boolean f37364x3;
    public int y3;
    public final wn f37365z3;

    public rj(wn wnVar, Context context, un unVar) {
        super(wnVar, context, unVar, 1);
        this.f37365z3 = wnVar;
        this.f37342a3 = new ArrayList();
        this.f37343b3 = new ArrayList();
        this.f37344c3 = new ArrayList();
        this.f37345d3 = new ArrayList();
        this.f37346e3 = new ArrayList(10);
        this.f37353m3 = 2000.0f;
        Paint paint = new Paint(1);
        this.f37354n3 = paint;
        Paint paint2 = new Paint(1);
        this.f37355o3 = paint2;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (wnVar.N9 != 0.0f) {
            ...
            if (wnVar.U9 != 0.0f) {
                f7 = (wnVar.f39694x0.getMeasuredHeight() - wnVar.N9) * wnVar.U9;
            } else {
                f7 = 0.0f;
            }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (wnVar.N9 != 0.0f && (motionEvent.getAction() == 1 || motionEvent.getAction() == 3)) {
            ...
            if (motionEvent.getAction() == 1 && min == 1.0f && (upVar = wnVar.P9) != null && !upVar.R) {
                if (upVar.K != 1.0f) {
                    ...
                    upVar2.J.setInterpolator(srVar);
                    upVar2.J.start();
                } else {
                    wn.X1(wnVar);
                }
        ...
        if (!this.X1) {
            ...
            if (!kVar.s() && !wnVar.A9()) {
                y1(motionEvent);
                if (wnVar.f39479f9 || onTouchEvent) {
                    return true;
                }
            } else {
                return onTouchEvent;
    ...
    public final void requestDisallowInterceptTouchEvent(boolean z10) {
        ...
        if (this.f37365z3.f39455d9 != null) {
            y1(null);
        }
    }
    ...
    public final void x1(Canvas canvas, RectF rectF) {
        ...
        float f12;
        float f13;
        ArrayList arrayList2 = this.f37342a3;
        ...
        ArrayList arrayList3 = this.f37343b3;
        ...
        ArrayList arrayList4 = this.f37344c3;
        ...
        ArrayList arrayList5 = this.f37345d3;
    ...
    public final void y1(MotionEvent motionEvent) {
        ...
        if (motionEvent != null && motionEvent.getAction() == 0 && !wnVar.f39479f9 && !wnVar.f39467e9 && wnVar.f39455d9 == null) {
            ...
            if (!z10) {
                ...
                if (pressedChildView instanceof org.telegram.ui.Cells.u1) {
                    ...
                    wnVar.f39455d9 = (org.telegram.ui.Cells.u1) pressedChildView;
                    MessageObject T1 = wn.T1(wnVar);
                    boolean F6 = wnVar.F6(T1);
                    int i10 = wnVar.R3;
                    if ((i10 == 0 || i10 == 5 || i10 == 8 || (i10 == 3 && wnVar.f39450d4 == wnVar.getUserConfig().getClientUserId())) && (((arrayList = wnVar.f39410a4) == null || !arrayList.contains(T1)) && ((wnVar.E8(T1) != 1 || (T1.getDialogId() != wnVar.L6 && !T1.needDrawBluredPreview())) && ((wnVar.h != null || T1.getId() >= 0) && (((chat2 = wnVar.e) == null || !ChatObject.isForum(chat2) || F6) && !wnVar.b9() && (!T1.isEphemeral() || !T1.isOut())))))) {
                        this.f37349h3 = motionEvent.getPointerId(0);
                        wnVar.f39467e9 = true;
                        this.f37347f3 = (int) motionEvent.getX();
                        this.f37348g3 = (int) motionEvent.getY();
                        return;
                    }
                    wn.V1(wnVar, 0.0f);
                    wnVar.f39455d9 = null;
        ...
        if (wnVar.f39455d9 != null && motionEvent != null && motionEvent.getAction() == 2 && motionEvent.getPointerId(0) == this.f37349h3) {
            int max = Math.max(AndroidUtilities.dp(-80.0f), Math.min(0, (int) (motionEvent.getX() - this.f37347f3)));
            int abs = Math.abs(((int) motionEvent.getY()) - this.f37348g3);
            if (getScrollState() == 0 && wnVar.f39467e9 && !wnVar.f39479f9 && max <= (-AndroidUtilities.getPixelsInCM(0.4f, true)) && Math.abs(max) / 3 > abs) {
                MotionEvent obtain = MotionEvent.obtain(0L, 0L, 3, 0.0f, 0.0f, 0);
                wnVar.f39455d9.onTouchEvent(obtain);
        ...
        } else if (wnVar.f39455d9 != null) {
            if (motionEvent != null) {
                if (motionEvent.getPointerId(0) == this.f37349h3) {
            ...
            if (motionEvent != null && motionEvent.getAction() != 3) {
                org.telegram.ui.Cells.u1 u1Var2 = wnVar.f39455d9;
            ...
            org.telegram.ui.Cells.u1 u1Var3 = wnVar.f39455d9;
            ...
            this.f37350i3 = System.currentTimeMillis();
            this.j3 = 0.0f;
            invalidate();
            wnVar.f39467e9 = false;
