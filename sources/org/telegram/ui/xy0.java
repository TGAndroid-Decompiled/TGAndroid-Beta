...
public final class xy0 implements View.OnClickListener {
    ...
    public final void onClick(View view) {
        ...
        switch (this.f39729a) {
            case 0:
                ProfileActivity profileActivity = (ProfileActivity) this.f39730b;
                TLRPC.Chat chat = (TLRPC.Chat) this.f39731c;
                long j12 = profileActivity.f31286e1;
                ...
                return;
            case 1:
                q21 q21Var = (q21) this.f39730b;
                Context context = (Context) this.f39731c;
                StringBuilder sb2 = new StringBuilder();
                String obj = q21Var.f36786a[0].getText().toString();
                String obj2 = q21Var.f36786a[3].getText().toString();
                String obj3 = q21Var.f36786a[2].getText().toString();
                String obj4 = q21Var.f36786a[1].getText().toString();
                String obj5 = q21Var.f36786a[4].getText().toString();
                try {
            ...
            case 2:
                x51 x51Var2 = (x51) this.f39730b;
                Context context2 = (Context) this.f39731c;
                if (x51Var2.f33322w == null) {
                    ...
                    if (context2 == null) {
                        ...
                        b3Var2.b(u3Var3);
                        org.telegram.ui.ActionBar.g3 g3Var = b3Var2.f18471a;
                        g3Var.show();
                        g3Var.setBackgroundColor(w03);
                        g3Var.fixNavigationBar(w03);
                        b3Var = b3Var2;
                    }
                    b3Var.f18471a.setOnHideListener(new ei.e0(x51Var, zArr, 11));
                    org.telegram.ui.ActionBar.g3 g3Var2 = b3Var.f18471a;
                    g3Var2.show();
                    x51Var.f33322w = g3Var2;
                    x51Var.c(false);
                    return;
                }
                return;
            case 3:
                v71 v71Var = (v71) this.f39730b;
                org.telegram.ui.Components.rc rcVar = (org.telegram.ui.Components.rc) this.f39731c;
                if (v71Var.Z.g() != 0) {
                    rcVar.run(new ArrayList(v71Var.f38325a0.values()));
                    v71Var.dismiss();
                    return;
                }
                return;
            case 4:
                SessionsActivity sessionsActivity = (SessionsActivity) this.f39730b;
                ((AlertDialog$Builder) this.f39731c).f18447a.L0.run();
                ...
                return;
            case 5:
                EditTextBoldCursor editTextBoldCursor = (EditTextBoldCursor) this.f39730b;
                editTextBoldCursor.setText(yh.y7.M0(((Long) this.f39731c).longValue()));
                editTextBoldCursor.setSelection(editTextBoldCursor.getText().length());
                return;
            case 6:
                ab1 ab1Var = ((fa1) this.f39730b).f33607d0;
                ab1Var.getOrCreateStoryViewer().C(ab1Var.getParentActivity(), ((xa1) this.f39731c).b(), ab1Var.f31820z0, ai.u9.a(ab1Var.S));
                return;
            case 7:
                ja1 ja1Var = (ja1) this.f39730b;
                kg.f fVar = (kg.f) this.f39731c;
                int i12 = ja1Var.f34836c;
                ka1 ka1Var = ja1Var.d;
                org.telegram.ui.Components.s00 s00Var = ja1Var.f34834a;
                if (s00Var.f27734c) {
                    ...
                    while (true) {
                        if (i13 < size) {
                            if (i13 == i12 || !((ja1) arrayList.get(i13)).f34834a.f27734c || !((ja1) arrayList.get(i13)).f34834a.f27733b) {
                                i13++;
                            }
                        } else {
                            i11 = 1;
                    ...
                    s00Var.setChecked(!s00Var.f27733b);
                    fVar.f13631n = s00Var.f27733b;
                    ka1Var.f35179b.z();
                    if (ka1Var.f35183r.f35748c > 0 && i12 < gVar.d.size()) {
                        ((kg.f) gVar.d.get(i12)).f13631n = s00Var.f27733b;
                        gVar.z();
                        return;
                    }
                    return;
                ...
                return;
            case 8:
                wy wyVar = (wy) this.f39731c;
                AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(wyVar.getParentActivity());
                alertDialog$Builder.f18447a.R = LocaleController.getString(R.string.LocalDatabaseClearTextTitle);
                alertDialog$Builder.f18447a.T = LocaleController.getString(R.string.LocalDatabaseClearText);
                alertDialog$Builder.h(LocaleController.getString(R.string.Cancel), null);
                alertDialog$Builder.k(LocaleController.getString(R.string.CacheClear), new tv0(9, (ib1) this.f39730b, wyVar));
                ...
                return;
            case 9:
                ce1 ce1Var = (ce1) this.f39730b;
                Context context3 = (Context) this.f39731c;
                if (ce1Var.getParentActivity() != null) {
                    ...
                    org.telegram.messenger.w1.q(textView3, org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18970j5, false), 1, 20.0f);
                    ...
                    ce1Var.showDialog(b3Var3.f18471a);
                    return;
                }
                return;
            case 10:
                ti1 ti1Var = (ti1) this.f39730b;
                Context context4 = (Context) this.f39731c;
                tg.n1 n1Var = ti1Var.M;
                if (n1Var != null) {
                    n1Var.dismiss();
                    ti1Var.M = null;
                }
                tg.n1 n1Var2 = new tg.n1(context4, ti1Var.f37761a, null, 4, new ai.a1());
                TLRPC.User user = ti1Var.f37767c;
                if (user != null) {
                    j3 = user.f18268id;
                } else {
                    j3 = 0;
                ...
                return;
            case 11:
                ci.d dVar = (ci.d) this.f39730b;
                int[] iArr = (int[]) this.f39731c;
                if (!dVar.N && (cVar = kj1.d) != null) {
                    ...
                    try {
                        ...
                        n6.l.n(eVar, y8.j0.f46408a).addOnSuccessListener(new c7(cVar, dVar, iArr, 24)).addOnFailureListener(new jj1(dVar, 0));
                        return;
                    } catch (Exception e) {
                        FileLog.e(e);
                ...
                return;
            case 12:
                org.telegram.ui.web.k kVar = (org.telegram.ui.web.k) this.f39730b;
                kVar.f38849b = true;
                ((x) this.f39731c).run();
                kVar.f38855w.Y2.N(true);
                return;
            case 13:
                pg.x xVar = (pg.x) this.f39730b;
                Context context5 = (Context) this.f39731c;
                if (!xVar.f41066n.c()) {
                    Bitmap snapshotView = AndroidUtilities.snapshotView(xVar.f41066n.e());
                    Bitmap createBitmap = Bitmap.createBitmap(snapshotView.getWidth(), snapshotView.getHeight(), Bitmap.Config.ARGB_8888);
                    Canvas canvas = new Canvas(createBitmap);
                    canvas.drawColor(-16777216);
                    xVar.f41066n.b(canvas);
                    canvas.drawBitmap(snapshotView, 0.0f, 0.0f, (Paint) null);
                    snapshotView.recycle();
                    pg.n nVar = new pg.n(xVar, context5, createBitmap);
                    xVar.f41066n.f().addView(nVar, w7.x5.c(-1.0f, -1));
                    pg.u uVar = xVar.f41066n;
                ...
                return;
            case 14:
                qg.p2 p2Var = (qg.p2) this.f39730b;
                ci.hd hdVar = (ci.hd) this.f39731c;
                qg.m2[] m2VarArr = p2Var.H;
                if (m2VarArr != null && m2VarArr.length != 0 && p2Var.I != null && (j10 = p2Var.j(p2Var.f41598n0, p2Var.f41599o0)) != null) {
                    hdVar.run(j10);
                    return;
                }
                return;
            case 15:
                org.telegram.ui.Components.un.d0((bo) this.f39731c, 41026, new org.telegram.ui.web.b1((qh.c) this.f39730b, 7), null);
                return;
            case 16:
                rg.j0.V((rg.j0) this.f39730b, (Context) this.f39731c);
                return;
            case 17:
                tg.t0 t0Var2 = (tg.t0) this.f39730b;
                TLRPC.Chat chat2 = (TLRPC.Chat) this.f39731c;
                ArrayList arrayList3 = t0Var2.X;
                if (!arrayList3.isEmpty()) {
                    tg.e0 e0Var = t0Var2.f43250a0;
                    if (!e0Var.N) {
                ...
                return;
            case 18:
                tg.n1 n1Var3 = (tg.n1) this.f39730b;
                ArrayList arrayList5 = (ArrayList) this.f39731c;
                HashSet hashSet2 = n1Var3.f43209h0;
                ...
                return;
            case 19:
                tg.n1.S((tg.n1) this.f39730b, (TLRPC.User) this.f39731c, view);
                return;
            case 20:
                final ug.e eVar2 = (ug.e) this.f39730b;
                final vg.a aVar = (vg.a) this.f39731c;
                if (eVar2.d) {
                    if (!aVar.f44325a.N) {
                        aVar.b(true);
                        String str2 = eVar2.h;
                            ...
                            public final void run(Object obj8) {
                                switch (r3) {
                                    case 0:
                                        ...
                                        c0Var.f43144r.dismiss();
                                        return;
                                    default:
                                        aVar.b(false);
                                        e eVar3 = eVar2;
                                        k.c((TLRPC.TL_error) obj8, eVar3.f43750n, eVar3.f43748c, new c(eVar3, 1));
                                        return;
                                }
                            }
                        };
                ...
                ((tg.c0) eVar2).f43144r.dismiss();
                return;
            case 21:
                TLRPC.Chat chat3 = (TLRPC.Chat) this.f39731c;
                vg.f fVar2 = ((vg.g) this.f39730b).f44353s;
                if (fVar2 != null) {
                    tg.b0 b0Var = ((tg.v) fVar2).f43257a;
                    b0Var.f43117c0.remove(chat3);
                    b0Var.a0(true, true);
                    return;
                }
                return;
            case 22:
                ((org.telegram.ui.web.b1) this.f39730b).run((TLRPC.TL_payments_checkedGiftCode) this.f39731c);
                return;
            case 23:
                ((org.telegram.ui.web.b1) this.f39730b).run((TLRPC.Chat) this.f39731c);
                return;
            case 24:
                xh.c.P((xh.c) this.f39730b, (TL_stars.TL_StarGiftAuctionAcquiredGift) this.f39731c);
                return;
            case 25:
                xh.h4 h4Var = (xh.h4) this.f39730b;
                h4Var.getClass();
                if (((yh.m7) this.f39731c).f47499f > 0) {
                    h4Var.presentFragment(new yh.y7());
                    return;
                }
                return;
            case 26:
                xh.g4.P((xh.g4) this.f39730b, (xh.f4) this.f39731c);
                return;
            case 27:
                xh.l4 l4Var = (xh.l4) this.f39730b;
                ei.r4 r4Var = (ei.r4) this.f39731c;
                ...
                if (!hashSet3.isEmpty()) {
                    ...
                    while (it.hasNext()) {
                        ...
                        ArrayList arrayList7 = l4Var.Y.f47526l;
                ...
                return;
            case 28:
                yh.n5 n5Var = ((xh.i4) this.f39730b).f45957c.Y;
                n5Var.e = !n5Var.e;
                ((org.telegram.messenger.kk) this.f39731c).run();
                n5Var.i(true);
                return;
            default:
                yh.g.X((yh.g) this.f39730b, (Context) this.f39731c, view);
                return;
        }
    }
}
