...
public final class sf1 extends View {
    public final HashMap f37390a;
    public final tf1 f37391b;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        for (int i18 = 0; i18 < tf1Var.F().size(); i18++) {
            if (tf1Var.F().get(i18) != null && ((vf1) tf1Var.F().get(i18)).f38528c != null) {
                String str = ((vf1) tf1Var.F().get(i18)).f38528c.title;
                HashMap hashMap = this.f37390a;
                ...
                if (((vf1) tf1Var.F().get(i18)).f38528c.f18161id == 1) {
                    dp2 = dp4;
                }
                if (((vf1) tf1Var.F().get(i18)).f38528c.hidden) {
                    i16++;
                }
                i17 += dp4;
            }
