...
public class o01 extends org.telegram.ui.Components.u9 implements org.telegram.ui.Components.nv0 {
    public static final s0 f36197g0 = new s0("crossfadeProgress", 3);
    public boolean G;
    public float H;
    public float I;
    public int J;
    ...
    public float f36199b0;
    public org.telegram.ui.Components.ph0 f36200c0;
    public boolean f36201d0;
    public float f36202e0;
    public Runnable f36203f0;
    ...
    public final void invalidate() {
        super.invalidate();
        org.telegram.ui.Components.ph0 ph0Var = this.f36200c0;
        if (ph0Var != null) {
            ph0Var.invalidate();
        }
        Runnable runnable = this.f36203f0;
        if (runnable != null) {
            runnable.run();
        }
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (z10) {
            org.telegram.ui.Components.gh0 blurDrawer = this.f36200c0.getBlurDrawer();
            if (blurDrawer == null) {
                z12 = false;
            }
            boolean z13 = z12;
        ...
        float A = org.telegram.messenger.w1.A(1.0f, this.V, this.f36202e0, (1.0f - this.f36199b0) * f7);
        ...
        if (imageReceiver != null && f12 > f11 && (this.V < 1.0f || !this.f36198a0)) {
            float f22 = A * f10;
        ...
        if (this.V > f11 && this.f36198a0 && f12 > f11) {
        ...
        if (z11) {
            ...
            if (!this.G && !gh0Var.f24219a && this.f36200c0.getRealPosition() != 0) {
                f13 = 1.0f;
            } else {
                f13 = 1.0f - this.H;
            }
