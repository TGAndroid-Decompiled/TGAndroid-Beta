    ...
    public final void onClick(View view) {
        switch (this.f36180a) {
            case 0:
                ...
                return;
            default:
                ProfileActivity profileActivity3 = this.f36181b.e;
                ...
                if (i10 >= 0) {
                    profileActivity3.f31558c.h1(i10, profileActivity3.V5 - profileActivity3.f31543a.getPaddingTop());
                    return;
                }
                return;
        }
