...
public final class x8 extends s4.s0 {
    ...
    public final void b(RecyclerView recyclerView, int i10, int i11) {
        ...
        int L0 = k9Var.f34984c.L0();
        boolean z11 = false;
        if (L0 == -1) {
            abs = 0;
        } else {
            abs = Math.abs(k9Var.f34984c.N0() - L0) + 1;
        }
        if (abs > 0) {
            int size = k9Var.d.Y2.f25293x.size();
        ...
        if (i11 != 0 && this.f39858a) {
            org.telegram.ui.Components.z10 z10Var = k9Var.f34988f;
            if (i11 < 0) {
                z10 = true;
            } else {
                z10 = false;
        ...
        this.f39858a = true;
        k9Var.f34991r.b((L0 != 0 || i12 < k9Var.d.getPaddingTop()) ? true : true, true);
