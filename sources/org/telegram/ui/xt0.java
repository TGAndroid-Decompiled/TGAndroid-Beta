...
public final class xt0 extends AnimatorListenerAdapter {
    ...
    public final PhotoViewer f42920c;

    public xt0(PhotoViewer photoViewer, int i10, int i11) {
        this.f42918a = i11;
        this.f42920c = photoViewer;
        this.f42919b = i10;
    }
    ...
    public final void onAnimationEnd(Animator animator) {
        switch (this.f42918a) {
            case 0:
                PhotoViewer photoViewer = this.f42920c;
                yt0 yt0Var = photoViewer.N1;
                yt0Var.f45584e.setVisibility(0);
                FrameLayout frameLayout = yt0Var.f45587r;
                ...
                yt0Var.f45589w.animate().alpha(1.0f).translationX(0.0f).setInterpolator(prVar).setDuration(320L).start();
                photoViewer.f33721u4 = this.f42919b;
                photoViewer.q6 = null;
                photoViewer.f33669o6 = -1;
                return;
            default:
                int i10 = this.f42919b;
                PhotoViewer photoViewer2 = this.f42920c;
                photoViewer2.f33721u4 = i10;
