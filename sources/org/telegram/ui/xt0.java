...
public final class xt0 extends AnimatorListenerAdapter {
    ...
    public final PhotoViewer f42893c;

    public xt0(PhotoViewer photoViewer, int i10, int i11) {
        this.f42891a = i11;
        this.f42893c = photoViewer;
        this.f42892b = i10;
    }
    ...
    public final void onAnimationEnd(Animator animator) {
        switch (this.f42891a) {
            case 0:
                PhotoViewer photoViewer = this.f42893c;
                yt0 yt0Var = photoViewer.N1;
                yt0Var.f45556e.setVisibility(0);
                FrameLayout frameLayout = yt0Var.f45559r;
                ...
                yt0Var.f45561w.animate().alpha(1.0f).translationX(0.0f).setInterpolator(prVar).setDuration(320L).start();
                photoViewer.f33694u4 = this.f42892b;
                photoViewer.q6 = null;
                photoViewer.f33642o6 = -1;
                return;
            default:
                int i10 = this.f42892b;
                PhotoViewer photoViewer2 = this.f42893c;
                photoViewer2.f33694u4 = i10;
