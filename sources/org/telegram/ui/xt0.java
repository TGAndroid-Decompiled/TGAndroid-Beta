...
public final class xt0 implements ViewTreeObserver.OnPreDrawListener {
    public final ClippingImageView[] f39983a;
    public final ViewGroup.LayoutParams f39984b;
    public final float f39985c;
    public final vu0 d;
    public final float e;
    public final tu0 f39986f;
    public final ArrayList h;
    public final Integer f39987n;
    public final PhotoViewer f39988r;
    ...
    public xt0(PhotoViewer photoViewer, ClippingImageView[] clippingImageViewArr, ViewGroup.LayoutParams layoutParams, float f7, vu0 vu0Var, float f10, tu0 tu0Var, ArrayList arrayList, Integer num) {
        this.f39988r = photoViewer;
        this.f39983a = clippingImageViewArr;
        this.f39984b = layoutParams;
        this.f39985c = f7;
        this.d = vu0Var;
        this.e = f10;
        this.f39986f = tu0Var;
    ...
    public final boolean onPreDraw() {
        ...
        int i14;
        int i15;
        PhotoViewer photoViewer = this.f39988r;
        Rect rect = photoViewer.f31346s2;
        PhotoViewer.BackgroundDrawable backgroundDrawable = photoViewer.L0;
        float[][] fArr = photoViewer.f31278k4;
        ClippingImageView[] clippingImageViewArr = this.f39983a;
        ...
        photoViewer.f31239g0.getViewTreeObserver().removeOnPreDrawListener(this);
        int i16 = photoViewer.f31206c2;
        ViewGroup.LayoutParams layoutParams = this.f39984b;
        if (i16 == 1) {
            ...
            int measuredWidth2 = photoViewer.f31239g0.getMeasuredWidth();
            v9 = com.google.android.gms.internal.vision.e2.v(layoutParams.width, f7, (measuredWidth2 - i15) - rect.right, 2.0f) + rect.left;
        } else {
            c10 = 0;
            float measuredWidth3 = photoViewer.f31239g0.getMeasuredWidth() / layoutParams.width;
            ...
            v9 = com.google.android.gms.internal.vision.e2.v(layoutParams.width, f7, photoViewer.f31239g0.getMeasuredWidth(), 2.0f);
            photoViewer.f31200b6 = 0.0f;
            photoViewer.f31237f6 = 0.0f;
        }
        vu0 vu0Var = this.d;
        int abs = (int) Math.abs(this.f39985c - vu0Var.f38818a.getImageX());
        float imageY = vu0Var.f38818a.getImageY();
        float f16 = this.e;
        int abs2 = (int) Math.abs(f16 - imageY);
        if (vu0Var.f38818a.isAspectFit()) {
            abs = 0;
        }
        int[] iArr = new int[2];
        vu0Var.d.getLocationInWindow(iArr);
        float f17 = vu0Var.f38820c + f16;
        int i19 = (int) ((iArr[1] - f17) + vu0Var.f38824j);
        if (i19 < 0) {
            i19 = 0;
        }
        int height = (int) (((f17 + layoutParams.height) - (vu0Var.d.getHeight() + i12)) + vu0Var.f38823i);
        if (height < 0) {
            height = 0;
        }
        int max = Math.max(i19, abs2);
        int max2 = Math.max(height, abs2);
        fArr[c10][c10] = photoViewer.f31248h0.getScaleX();
        fArr[c10][1] = photoViewer.f31248h0.getScaleY();
        fArr[c10][2] = photoViewer.f31248h0.getTranslationX();
        fArr[c10][3] = photoViewer.f31248h0.getTranslationY();
        float[] fArr2 = fArr[c10];
        float f18 = abs;
        float f19 = vu0Var.f38825k;
        int i20 = 3;
        fArr2[4] = f18 * f19;
        fArr2[5] = max * f19;
        fArr2[6] = max2 * f19;
        int[] radius = photoViewer.f31248h0.getRadius();
        ...
        photoViewer.f31222e0.setAlpha(0.0f);
        photoViewer.f31266j0.setAlpha(0.0f);
        c90 c90Var = new c90(this, clippingImageViewArr, this.h, this.f39987n, this.f39986f, 15);
        photoViewer.f31321p4 = c90Var;
        if (!photoViewer.f31284l2) {
            ...
            for (int i23 = 0; i23 < clippingImageViewArr.length; i23++) {
                ObjectAnimator ofFloat = ObjectAnimator.ofFloat(clippingImageViewArr[i23], org.telegram.ui.Components.s6.f28173f, 0.0f, 1.0f);
                if (i23 == 0) {
            ...
            if (clippingImageViewArr.length > 1) {
                arrayList.add(ObjectAnimator.ofFloat(photoViewer.f31248h0, View.ALPHA, 0.0f, 1.0f));
            }
            ...
            arrayList.add(ObjectAnimator.ofFloat(photoViewer.f31266j0, property, 0.0f, 1.0f));
            if (photoViewer.f31206c2 == 1) {
            ...
            photoViewer.f31222e0.setLayerType(2, null);
            photoViewer.x2(false);
            photoViewer.f31312o4 = System.currentTimeMillis();
