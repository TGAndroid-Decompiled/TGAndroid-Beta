...
public final class k10 extends tu0 {
    ...
    public final CharSequence C(int i10) {
        return LocaleController.formatDateAudio(((MessageObject) this.f35006a.f39446f.get(i10)).messageOwner.date, false);
    }
    ...
    public final dv0 E(MessageObject messageObject, TLRPC.FileLocation fileLocation, int i10, boolean z10, boolean z11) {
        ...
        if (messageObject != null) {
            ai.w0 w0Var = this.f35006a.f39440b;
            ...
            for (int i12 = 0; i12 < childCount; i12++) {
                ...
                if (childAt instanceof org.telegram.ui.Cells.u7) {
                    ...
                    for (int i13 = 0; i13 < 6; i13++) {
                        if (i13 >= u7Var.e) {
                            ...
                            messageObject2 = u7Var.f21443b[i13];
                        }
                        ...
                        if (messageObject2.getId() == messageObject.getId()) {
                            if (i13 >= u7Var.e) {
                                ...
                                u9Var = u7Var.f21442a[i13].f20610a;
                            }
                ...
                if (photoImage != null) {
                    ...
                    dv0Var.f33144n = -iArr[1];
                    dv0Var.f33134a = photoImage;
                    dv0Var.f33145o = false;
                    dv0Var.h = photoImage.getRoundRadius(true);
                    dv0Var.e = dv0Var.f33134a.getBitmapSafe();
                    ...
                    if (PhotoViewer.M1(messageObject) && (pinnedHeader = w0Var.getPinnedHeader()) != null) {
                        ...
                        int i14 = i11 - dv0Var.f33136c;
                        if (i14 > childAt.getHeight()) {
                            w0Var.scrollBy(0, -(pinnedHeader.getHeight() + i14));
                            return dv0Var;
                        }
                        int height = dv0Var.f33136c - w0Var.getHeight();
                        if (childAt instanceof org.telegram.ui.Cells.j7) {
    ...
    public final boolean Y() {
        x10 x10Var = this.f35006a;
        if (!x10Var.N) {
            x10Var.h(x10Var.E, x10Var.F, x10Var.H, x10Var.G, x10Var.f39464y, x10Var.J, x10Var.f39462w, false);
            return true;
        }
        return true;
    }
    ...
    public final CharSequence b0(int i10) {
        return x10.d((MessageObject) this.f35006a.f39446f.get(i10), true, 0, null);
    }

    @Override
    public final int y() {
        return this.f35006a.O;
    }
}
