...
public final class g41 implements org.telegram.ui.Components.ml0, org.telegram.ui.Components.ol0, ky {
    public final SaveToGallerySettingsActivity f33818a;

    public g41(SaveToGallerySettingsActivity saveToGallerySettingsActivity) {
        this.f33818a = saveToGallerySettingsActivity;
    }
    ...
    public void c(float f7, float f10, int i10, View view) {
        SaveToGallerySettingsActivity saveToGallerySettingsActivity = this.f33818a;
        ...
        if (i10 == saveToGallerySettingsActivity.e) {
        ...
        } else if (i10 == saveToGallerySettingsActivity.f31716f) {
            ...
            int i11 = saveToGallerySettingsActivity.f31713a;
            if (i11 == 2) {
            ...
            bundle2.putLong("dialog_id", ((j41) arrayList.get(i10)).f34640c.dialogId);
            bundle2.putInt("type", saveToGallerySettingsActivity.f31713a);
