...
public final class g41 implements org.telegram.ui.Components.ll0, org.telegram.ui.Components.nl0, ky {
    public final SaveToGallerySettingsActivity f33820a;

    public g41(SaveToGallerySettingsActivity saveToGallerySettingsActivity) {
        this.f33820a = saveToGallerySettingsActivity;
    }
    ...
    public void c(float f7, float f10, int i10, View view) {
        SaveToGallerySettingsActivity saveToGallerySettingsActivity = this.f33820a;
        ...
        if (i10 == saveToGallerySettingsActivity.e) {
        ...
        } else if (i10 == saveToGallerySettingsActivity.f31718f) {
            ...
            int i11 = saveToGallerySettingsActivity.f31715a;
            if (i11 == 2) {
            ...
            bundle2.putLong("dialog_id", ((j41) arrayList.get(i10)).f34642c.dialogId);
            bundle2.putInt("type", saveToGallerySettingsActivity.f31715a);
