...
public final class g41 extends org.telegram.ui.ActionBar.o2 implements NotificationCenter.NotificationCenterDelegate {
    public static boolean f33845s;
    public static HashSet v;
    public f41 f33846a;
    public org.telegram.ui.Components.ml0 f33847b;
    public f41 f33848c;
    public org.telegram.ui.Components.mz d;
    public int e;
    public ArrayList f33849f;
    public ArrayList h;
    public HashSet f33850n;
    public HashSet f33851r;
    ...
    public static void U(g41 g41Var, View view, int i10) {
        ...
        if (g41Var.getParentActivity() != null && g41Var.parentLayout != null && (view instanceof org.telegram.ui.Cells.x8)) {
            int i11 = 0;
            if (g41Var.f33847b.getAdapter() == g41Var.f33848c) {
                z10 = true;
            } else {
                z10 = false;
            }
            if (z10 && (arrayList = g41Var.f33849f) != null) {
            ...
            if (language != null && language.code != null) {
                ...
                if (g41Var.f33851r.contains(str)) {
                    Collection.EL.removeIf(g41Var.f33851r, new t80(str, 2));
                } else {
                    g41Var.f33851r.add(str);
                }
                if (g41Var.f33851r.size() == 1 && g41Var.f33851r.contains(currentLocaleInfo.pluralLangCode)) {
                    a0(null, null);
                } else {
                    a0(g41Var.f33851r, Boolean.TRUE);
                }
                if (z10) {
                    int i13 = 0;
                    while (i11 < g41Var.f33849f.size()) {
                        if (TextUtils.equals(str, ((TranslateController.Language) g41Var.f33849f.get(i11)).code)) {
                            g41Var.Z(i13);
                        }
                        i11++;
                        i13++;
    ...
    public final void X() {
        ...
        ArrayList arrayList2 = new ArrayList(this.f33850n);
        ...
        while (i10 < this.h.size()) {
            ...
            if (TextUtils.equals(language2.code, str)) {
                ...
                i10--;
                language = language2;
            } else if (this.f33850n.contains(language2.code)) {
    ...
    public final void Z(int i10) {
        int b10;
        s4.h0 adapter = this.f33847b.getAdapter();
        for (int i11 = 0; i11 < this.f33847b.getChildCount(); i11++) {
            s4.c1 U = this.f33847b.U(this.f33847b.getChildAt(i11));
    ...
    public final View createView(Context context) {
        ...
        this.f33846a = new f41(this, context, false);
        this.f33848c = new f41(this, context, true);
        ...
        this.f33847b = ml0Var;
        ml0Var.q1();
        this.f33847b.setEmptyView(this.d);
        this.f33847b.setLayoutManager(new s4.c0(1, false));
        this.f33847b.setVerticalScrollBarEnabled(false);
        this.f33847b.setAdapter(this.f33846a);
        frameLayout2.addView(this.f33847b, w7.x5.c(-1.0f, -1));
        this.f33847b.setOnItemClickListener(new b31(this, 2));
        this.f33847b.setOnScrollListener(new h3(this, 27));
        return this.fragmentView;
    }

    @Override
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.suggestedLangpack && this.f33846a != null) {
            X();
            this.f33846a.l();
        }
    }
    ...
    public final ArrayList getThemeDescriptions() {
        ArrayList arrayList = new ArrayList();
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f33847b, 16, new Class[]{org.telegram.ui.Cells.p4.class}, null, null, null, org.telegram.ui.ActionBar.j6.f18863d6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f33847b, 32768, null, null, null, null, org.telegram.ui.ActionBar.j6.f19140s8));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f33847b, 4096, null, null, null, null, org.telegram.ui.ActionBar.j6.f18953i6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.d, 4, null, null, null, null, org.telegram.ui.ActionBar.j6.f18846c7));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f33847b, 0, new Class[]{View.class}, org.telegram.ui.ActionBar.j6.f18985k0, null, null, org.telegram.ui.ActionBar.j6.f18864d7));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f33847b, 0, new Class[]{org.telegram.ui.Cells.p4.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.G6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f33847b, 0, new Class[]{org.telegram.ui.Cells.p4.class}, new String[]{"textView2"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.A6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f33847b, 0, new Class[]{org.telegram.ui.Cells.p4.class}, new String[]{"checkImage"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.Mh));
        return arrayList;
    }
