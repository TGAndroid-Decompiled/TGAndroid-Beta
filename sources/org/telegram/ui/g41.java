...
public final class g41 implements org.telegram.ui.Components.ll0, org.telegram.ui.Components.nl0, ky {
    public final SaveToGallerySettingsActivity f33804a;

    public g41(SaveToGallerySettingsActivity saveToGallerySettingsActivity) {
        this.f33804a = saveToGallerySettingsActivity;
    }
    ...
    public void c(float f7, float f10, int i10, View view) {
        SaveToGallerySettingsActivity saveToGallerySettingsActivity = this.f33804a;
        ...
        } else if (i10 == saveToGallerySettingsActivity.f31703f) {
            SaveToGallerySettingsHelper.Settings X2 = saveToGallerySettingsActivity.X();
            X2.saveVideo = !X2.saveVideo;
            saveToGallerySettingsActivity.Y();
            saveToGallerySettingsActivity.Z();
        } else if (((j41) arrayList.get(i10)).f15700a == 1) {
            Bundle bundle = new Bundle();
            bundle.putBoolean("onlySelect", true);
            bundle.putBoolean("checkCanWrite", false);
            int i11 = saveToGallerySettingsActivity.f31700a;
            if (i11 == 2) {
    ...
    public boolean mo18c(float f7, float f10, int i10, View view) {
        SaveToGallerySettingsActivity saveToGallerySettingsActivity = this.f33804a;
        ArrayList arrayList = saveToGallerySettingsActivity.f31706s;
        if (((j41) arrayList.get(i10)).f15700a == 2) {
