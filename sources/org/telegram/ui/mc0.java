...
public final class mc0 extends FrameLayout {
    ...
    public final LinearLayout f35693b;
    public final ai.p4 f35694c;
    public final org.telegram.ui.Components.n6 d;
    public final ImageView e;
    public final Switch f35695f;
    public final org.telegram.ui.Components.np h;
    public boolean f35696n;
    public boolean f35697r;
    public boolean f35698s;
    public boolean v;
    public int f35699w;
    public int f35700x;
    public final nc0 f35701y;
    ...
    public mc0(nc0 nc0Var, Context context) {
        ...
        int w02 = org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18998m6, false);
        ...
        int i19 = org.telegram.ui.ActionBar.i6.f18834d6;
    ...
    public final void b(boolean z10, boolean z11) {
        ...
        if (this.f35698s != z10) {
            ...
            Switch r12 = this.f35695f;
            LinearLayout linearLayout = this.f35693b;
            ImageView imageView = this.f35692a;
            float f15 = 1.0f;
            if (z11) {
    ...
    public final void c(hc0 hc0Var, boolean z10) {
        ...
        int i10 = hc0Var.e;
        this.f35699w = a(value & i10);
        this.f35700x = a(i10);
        boolean z11 = false;
        String format = String.format("%d/%d", Integer.valueOf(this.f35699w), Integer.valueOf(this.f35700x));
    ...
    public final void onDraw(Canvas canvas) {
        ...
        super.onDraw(canvas);
        boolean z10 = LocaleController.isRTL;
        ai.p4 p4Var = this.f35694c;
        if (z10) {
            if (this.f35697r) {
                float dp = AndroidUtilities.dp(75.0f);
                canvas.drawRect(dp - AndroidUtilities.dp(0.66f), (getMeasuredHeight() - AndroidUtilities.dp(20.0f)) / 2.0f, dp, (AndroidUtilities.dp(20.0f) + getMeasuredHeight()) / 2.0f, org.telegram.ui.ActionBar.i6.f18955k0);
            }
            if (this.f35696n) {
                ...
                canvas.drawLine(measuredWidth + i10, getMeasuredHeight() - 1, 0.0f, getMeasuredHeight() - 1, org.telegram.ui.ActionBar.i6.f18955k0);
                return;
            }
            return;
        }
        if (this.f35697r) {
            ...
            canvas.drawRect(measuredWidth2 - AndroidUtilities.dp(0.66f), (getMeasuredHeight() - AndroidUtilities.dp(20.0f)) / 2.0f, measuredWidth2, (AndroidUtilities.dp(20.0f) + getMeasuredHeight()) / 2.0f, org.telegram.ui.ActionBar.i6.f18955k0);
        }
        if (this.f35696n) {
            canvas.drawLine(p4Var.getTranslationX() + AndroidUtilities.dp(64.0f), getMeasuredHeight() - 1, getMeasuredWidth(), getMeasuredHeight() - 1, org.telegram.ui.ActionBar.i6.f18955k0);
        }
    }
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (npVar.getVisibility() == 0) {
            ...
            accessibilityNodeInfo.setChecked(this.f35695f.h);
        }
        StringBuilder sb2 = new StringBuilder();
        sb2.append(this.f35694c.getText());
        if (this.v) {
            sb2.append('\n');
            sb2.append(LocaleController.formatString("Of", R.string.Of, Integer.valueOf(this.f35699w), Integer.valueOf(this.f35700x)));
        }
