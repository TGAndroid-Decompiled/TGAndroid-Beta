        ...
        switch (this.f39076a) {
            case 0:
                ...
                if (bd0Var.F != null) {
                    ...
                    TLRPC.TL_channelLocation tL_channelLocation = bd0Var.f35482w0;
                    if (tL_channelLocation != null) {
                        ...
                        if (DialogObject.isUserDialog(bd0Var.f35455b0)) {
                            obj2.f42202c = bd0Var.getMessagesController().getUser(Long.valueOf(bd0Var.f35455b0));
                        } else {
                            obj2.d = bd0Var.getMessagesController().getChat(Long.valueOf(-bd0Var.f35455b0));
                        }
                        obj2.f42200a = bd0Var.f35455b0;
                        bd0Var.v0(obj2);
                        try {
                            ...
                            if (g02 != null) {
                                ...
                                obj2.f42203e = bd0Var.F.addMarker(position);
                                if (!UserObject.isUserSelf(obj2.f42202c)) {
                                    IMapsProvider.IMarkerOptions flat = ApplicationLoader.getMapsProvider().onCreateMarkerOptions().position(latLng).flat(true);
                                    flat.icon(R.drawable.map_pin_circle);
                                    flat.anchor(0.5f, 0.5f);
                                    obj2.f42204f = bd0Var.F.addMarker(flat);
                                }
                                bd0Var.f35458d0.add(obj2);
                                bd0Var.f35460e0.k(obj2, obj2.f42200a);
                            }
                        } catch (Exception e6) {
                            FileLog.e(e6);
                        }
                        bd0Var.F.moveCamera(ApplicationLoader.getMapsProvider().newCameraUpdateLatLngZoom(obj2.f42203e.getPosition(), maxZoomLevel));
                    } else {
                        MessageObject messageObject = bd0Var.f35486y0;
                        if (messageObject != null) {
                            if (messageObject.isLiveLocation()) {
                                vc0 c02 = bd0Var.c0(bd0Var.f35486y0.messageOwner);
                                if (!bd0Var.l0()) {
                                    bd0Var.F.moveCamera(ApplicationLoader.getMapsProvider().newCameraUpdateLatLngZoom(c02.f42203e.getPosition(), maxZoomLevel));
                                }
                            } else {
                                IMapsProvider.LatLng latLng2 = new IMapsProvider.LatLng(bd0Var.f35479u0.getLatitude(), bd0Var.f35479u0.getLongitude());
                                try {
                                ...
                                bd0Var.f35457c0 = false;
                                bd0Var.l0();
                            }
                        } else {
                            Location location = new Location("network");
                            bd0Var.f35479u0 = location;
                            TLRPC.TL_channelLocation tL_channelLocation2 = bd0Var.f35484x0;
                            if (tL_channelLocation2 != null) {
                                ...
                                bd0Var.f35479u0.setLatitude(bd0Var.f35484x0.geo_point.lat);
                                bd0Var.f35479u0.setLongitude(bd0Var.f35484x0.geo_point._long);
                                bd0Var.f35479u0.setAccuracy(bd0Var.f35484x0.geo_point.accuracy_radius);
                                bd0Var.Q.L(bd0Var.f35479u0);
                            } else {
                                location.setLatitude(20.659322d);
                                bd0Var.f35479u0.setLongitude(-11.40625d);
                            }
                        }
                    }
                    try {
                    ...
                    bd0Var.F.setOnMarkerClickListener(new IMapsProvider.OnMarkerClickListener() {
                        ...
                        public final boolean onClick(IMapsProvider.IMarker iMarker) {
                            ...
                            ArrayList arrayList = bd0Var2.f35458d0;
                            if (iMarker.getTag() instanceof ad0) {
                                bd0Var2.U.setVisibility(4);
                                if (!bd0Var2.f35487z0) {
                                    ImageView imageView2 = bd0Var2.f35452a;
                                    ...
                                    bd0Var2.f35452a.setTag(Integer.valueOf(i16));
                                    bd0Var2.f35487z0 = true;
                                }
                                int i17 = 0;
                                while (true) {
                                    ...
                                    if (vc0Var != null && vc0Var.f42203e == iMarker) {
                                        bd0Var2.f35462f0 = vc0Var.f42200a;
                                        if (bd0Var2.f35463g0) {
                                            bd0Var2.f35463g0 = false;
                                            bd0Var2.C0();
                                        }
                                        bd0Var2.F.animateCamera(ApplicationLoader.getMapsProvider().newCameraUpdateLatLngZoom(vc0Var.f42203e.getPosition(), maxZoomLevel));
                                    } else {
                                        i17++;
                                    }
                                }
                                yc0 yc0Var = bd0Var2.f35483x;
                                bd0 bd0Var3 = yc0Var.f43601b;
                                HashMap hashMap = yc0Var.f43600a;
                                ad0 ad0Var = (ad0) iMarker.getTag();
                                if (ad0Var != null && bd0Var3.f35467k0 != ad0Var) {
                                    bd0Var3.y0(false);
                                    IMapsProvider.IMarker iMarker2 = bd0Var3.f35466j0;
                                    if (iMarker2 != null) {
                                        ...
                                        bd0Var3.f35466j0 = null;
                                    }
                                    bd0Var3.f35467k0 = ad0Var;
                                    bd0Var3.f35466j0 = iMarker;
                                    Context context = yc0Var.getContext();
                                    FrameLayout frameLayout = new FrameLayout(context);
                                    yc0Var.addView(frameLayout, k7.c6.c(114.0f, -2));
                                    FrameLayout frameLayout2 = new FrameLayout(context);
                                    bd0Var3.f35468l0 = frameLayout2;
                                    frameLayout2.setBackgroundResource(R.drawable.venue_tooltip);
                                    bd0Var3.f35468l0.getBackground().setColorFilter(new PorterDuffColorFilter(bd0Var3.getThemedColor(org.telegram.ui.ActionBar.k6.f21731h5), PorterDuff.Mode.MULTIPLY));
                                    frameLayout.addView(bd0Var3.f35468l0, k7.c6.c(71.0f, -2));
                                    bd0Var3.f35468l0.setAlpha(0.0f);
                                    bd0Var3.f35468l0.setOnClickListener(new hb0(2, yc0Var, ad0Var));
                                    ...
                                    FrameLayout frameLayout3 = bd0Var3.f35468l0;
                                    if (LocaleController.isRTL) {
                                        i13 = 5;
                                    } else {
                                        i13 = 3;
                                    ...
                                    h.setGravity(i14);
                                    FrameLayout frameLayout4 = bd0Var3.f35468l0;
                                    if (LocaleController.isRTL) {
                                        i15 = 5;
                                    } else {
                                        i15 = 3;
                                    ...
                                    textView.setText(ad0Var.f35134c.title);
                                    h.setText(LocaleController.getString(R.string.TapToSendLocation));
                                    FrameLayout frameLayout5 = new FrameLayout(context);
                                    frameLayout5.setBackground(org.telegram.ui.ActionBar.k6.K(AndroidUtilities.dp(36.0f), org.telegram.ui.Cells.u4.a(ad0Var.f35132a)));
                                    frameLayout.addView(frameLayout5, k7.c6.d(36, 36.0f, 81, 0.0f, 0.0f, 0.0f, 4.0f));
                                    org.telegram.ui.Components.p9 p9Var = new org.telegram.ui.Components.p9(context);
                                    p9Var.f(android.support.v4.media.a.r(new StringBuilder("https://ss3.4sqi.net/img/categories_v2/"), ad0Var.f35134c.venue_type, "_64.png"), null, null);
                    ...
                    for (int size = providers.size() - 1; size >= 0; size--) {
                        ...
                        if (location2 != null) {
                            bd0Var.f35478t0 = location2;
                            bd0Var.t0(location2);
                            if (bd0Var.Y && bd0Var.getParentActivity() != null) {
                                bd0Var.Y = false;
                                bd0Var.d0();
                            }
                            imageView = bd0Var.f35456c;
                            if (imageView == null && imageView.getVisibility() == 0 && (sharingLocationInfo = bd0Var.getLocationController().getSharingLocationInfo(bd0Var.f35455b0)) != null && (i11 = sharingLocationInfo.proximityMeters) > 0) {
                                bd0Var.e0(i11);
                                return;
                            }
                            return;
                ...
                return;
            default:
                bd0 bd0Var2 = this.f39077b;
                Location location3 = (Location) obj;
                bd0Var2.t0(location3);
                bd0Var2.getLocationController().setMapLocation(location3, bd0Var2.f35453a0);
                bd0Var2.f35453a0 = false;
                return;
        }
    }
}
