...
public final class ci1 implements View.OnClickListener {
    ...
    public final ti1 f32773b;
    public final VoIPService f32774c;

    public ci1(ti1 ti1Var, VoIPService voIPService, int i10) {
        this.f32772a = i10;
        this.f32773b = ti1Var;
        this.f32774c = voIPService;
    }
    ...
    public final void onClick(View view) {
        switch (this.f32772a) {
            case 0:
                ti1 ti1Var = this.f32773b;
                AndroidUtilities.runOnUIThread(new di1(ti1Var, 8));
                int i10 = ti1Var.L;
                if (i10 > 0) {
                    this.f32774c.sendCallRating(i10);
                    return;
                }
                return;
            default:
                ti1 ti1Var2 = this.f32773b;
                AndroidUtilities.runOnUIThread(new di1(ti1Var2, 10));
                int i11 = ti1Var2.L;
                if (i11 > 0) {
                    this.f32774c.sendCallRating(i11);
                    return;
                }
                return;
        }
