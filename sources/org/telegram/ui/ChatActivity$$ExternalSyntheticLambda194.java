...
public final class ChatActivity$$ExternalSyntheticLambda194 implements Runnable {
    ...
    public ChatActivity$$ExternalSyntheticLambda194(Object obj, int i, int i2, int i3, int i4, int i5) {
        this.$r8$classId = i5;
        this.f$0 = obj;
        this.f$1 = i;
        this.f$2 = i2;
