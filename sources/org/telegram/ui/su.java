...
public final class su extends cg.c {
    ...
    public final boolean D(f2.m1 m1Var) {
        switch (this.d) {
            case 0:
                pu puVar = (pu) ((uu) this.f41308e).Z2.get(m1Var.b());
    ...
    public final int h() {
        switch (this.d) {
            case 0:
                return ((uu) this.f41308e).Z2.size();
            default:
                return ((fc0) this.f41308e).f36769s.size();
        }
    }
    ...
    public final int j(int i10) {
        switch (this.d) {
            case 0:
                return ((pu) ((uu) this.f41308e).Z2.get(i10)).f2505a;
            default:
                fc0 fc0Var = (fc0) this.f41308e;
                if (i10 >= 0 && i10 < fc0Var.f36769s.size()) {
                    return ((zb0) fc0Var.f36769s.get(i10)).f2505a;
                }
                return 2;
        }
    }
    ...
    public final f2.m1 x(ViewGroup viewGroup, int i10) {
        ...
        int i11 = this.d;
        View view = null;
        Object obj = this.f41308e;
        switch (i11) {
            case 0:
                uu uuVar = (uu) obj;
                yu yuVar = uuVar.f41940l3;
                org.telegram.ui.ActionBar.g6 g6Var = uuVar.f31106m2;
                if (i10 != 0) {
                    if (i10 != 1) {
                        if (i10 != 3) {
                            if (i10 != 4) {
                                if (i10 != 5) {
                                    if (i10 != 6) {
                                        if (i10 != 7) {
                                            ...
                                            int i13 = uu.f41929m3;
                                            inVar.setBackgroundColor(org.telegram.ui.ActionBar.k6.v0(i12, uuVar.f31106m2));
                                            o8Var = inVar;
                                        }
                                    } else {
                                        ?? view2 = new View(uuVar.getContext());
                                        view2.f42860a = new Path();
                                    ...
                                    o8Var2.setTextColor(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.f21878p7, g6Var));
                                    o8Var2.setBackgroundColor(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.f21661d6, g6Var));
                                    o8Var = o8Var2;
                                }
                            } else {
                                View m4Var = new org.telegram.ui.Cells.m4(uuVar.getContext());
                                m4Var.setBackgroundColor(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.f21661d6, g6Var));
                                o8Var = m4Var;
                            }
                        } else {
                        ...
                        frameLayout.f43453a = textView;
                        textView.setGravity(17);
                        textView.setTextSize(1, 13.0f);
                        textView.setTextColor(yuVar.getThemedColor(org.telegram.ui.ActionBar.k6.f22038y6));
                    ...
                    int[] iArr = yu.f43697e;
                    ru ruVar = new ru(this, context2, iArr.length, iArr, yu.f43698f);
                    uuVar.f41939k3 = ruVar;
                    ruVar.setInterceptTouch(false);
                    View view3 = uuVar.f41939k3;
                    view3.setTag(-33024);
                    o8Var = view3;
                }
