...
public final class eh0 extends FrameLayout {
    ...
    public final hh0 G;
    public int f37827a;
    public final LinearLayout f37828b;
    public final TextView f37829c;
    public final TextView d;
    public final LinearLayout f37830e;
    public final TextView f37831f;
    public final TextView h;
    public TLRPC.TL_chatInviteExported f37832n;
    public int f37833r;
    public final Paint f37834s;
    public final Paint v;
    public final RectF f37835w;
    public final ImageView f37836x;
    public int f37837y;

    public eh0(hh0 hh0Var, Context context) {
        super(context);
        this.G = hh0Var;
        this.f37834s = new Paint(1);
        Paint paint = new Paint(1);
        this.v = paint;
        this.f37835w = new RectF();
        this.A = 1.0f;
        this.F = new org.telegram.ui.Components.o11();
        paint.setStyle(Paint.Style.STROKE);
        paint.setStrokeCap(Paint.Cap.ROUND);
        LinearLayout linearLayout = new LinearLayout(context);
        this.f37828b = linearLayout;
        linearLayout.setOrientation(1);
        addView(linearLayout, i7.f6.d(-1, -2.0f, 16, 64.0f, 0.0f, 30.0f, 0.0f));
        TextView textView = new TextView(context);
        this.f37829c = textView;
        ...
        this.f37830e = linearLayout2;
        linearLayout2.setOrientation(1);
        TextView textView3 = new TextView(context);
        this.f37831f = textView3;
    ...
    public final int a(float f9, int i10) {
        TLRPC.TL_chatInviteExported tL_chatInviteExported = this.f37832n;
        ...
        if (i10 == 3) {
            return org.telegram.ui.ActionBar.g6.w0(null, org.telegram.ui.ActionBar.g6.f23192ka, false);
        }
        if (i10 == 1) {
            if (f9 > 0.5f) {
                return i0.a.d(1.0f - ((f9 - 0.5f) / 0.5f), org.telegram.ui.ActionBar.g6.w0(null, org.telegram.ui.ActionBar.g6.f23245na, false), org.telegram.ui.ActionBar.g6.w0(null, org.telegram.ui.ActionBar.g6.f23264oa, false));
            }
            return i0.a.d(1.0f - (f9 / 0.5f), org.telegram.ui.ActionBar.g6.w0(null, org.telegram.ui.ActionBar.g6.f23264oa, false), org.telegram.ui.ActionBar.g6.w0(null, org.telegram.ui.ActionBar.g6.f23192ka, false));
        } else if (i10 == 2) {
            return org.telegram.ui.ActionBar.g6.w0(null, org.telegram.ui.ActionBar.g6.f23264oa, false);
        } else {
            if (i10 == 4) {
                return org.telegram.ui.ActionBar.g6.w0(null, org.telegram.ui.ActionBar.g6.V8, false);
            }
            return org.telegram.ui.ActionBar.g6.w0(null, org.telegram.ui.ActionBar.g6.Oh, false);
        }
    }
    ...
    public final void b(TLRPC.TL_chatInviteExported tL_chatInviteExported, int i10) {
        ...
        ImageView imageView = this.f37836x;
        LinearLayout linearLayout = this.f37830e;
        if (tL_starsSubscriptionPricing != null) {
            ...
            TextView textView = this.f37831f;
            textView.setText(X0);
        ...
        ((ViewGroup.MarginLayoutParams) this.f37828b.getLayoutParams()).rightMargin = dp;
        boolean isEmpty = TextUtils.isEmpty(tL_chatInviteExported.title);
        hh0 hh0Var = this.G;
        TextView textView3 = this.f37829c;
        if (!isEmpty) {
        ...
        if (tL_chatInviteExported.permanent && !tL_chatInviteExported.revoked) {
            ...
            if (tL_chatInviteExported.expire_date > 0) {
                ...
                vsVar2.f34176b = AndroidUtilities.dp(1.5f);
                ...
                long currentTimeMillis = (tL_chatInviteExported.expire_date * 1000) - ((hh0Var.f38926j0 * 1000) + System.currentTimeMillis());
            ...
            vsVar3.f34176b = AndroidUtilities.dp(1.5f);
        ...
        if (tL_chatInviteExported.request_needed) {
            ...
            vsVar4.f34176b = AndroidUtilities.dp(1.5f);
