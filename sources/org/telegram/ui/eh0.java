...
public final class eh0 implements org.telegram.ui.Components.ml0, org.telegram.ui.ActionBar.z1 {
    ...
    public boolean d(int i10, View view) {
        sh0 sh0Var = this.f33383a;
        if ((i10 < sh0Var.f37781y || i10 >= sh0Var.E) && (i10 < sh0Var.H || i10 >= sh0Var.I)) {
            return false;
        }
        ((ph0) view).f36536x.callOnClick();
        try {
    ...
    public void f(org.telegram.ui.ActionBar.a2 a2Var, int i10) {
        ...
        sh0 sh0Var = this.f33383a;
        tL_messages_deleteRevokedExportedChatInvites.peer = sh0Var.getMessagesController().getInputPeer(-sh0Var.f37769n);
        long j3 = sh0Var.f37761f;
