...
public final class eh0 extends ReplacementSpan {
    ...
    public final TextPaint f33405c;
    public final Paint d;
    public final float e;
    public final gh0 f33406f;

    public eh0(gh0 gh0Var, int i10, boolean z10) {
        this.f33406f = gh0Var;
        TextPaint textPaint = new TextPaint(1);
        this.f33405c = textPaint;
        this.d = new Paint(1);
        String valueOf = String.valueOf(i10);
        this.f33403a = valueOf;
        this.f33404b = z10;
    ...
    public final void draw(Canvas canvas, CharSequence charSequence, int i10, int i11, float f7, int i12, int i13, int i14, Paint paint) {
        ...
        gh0 gh0Var = this.f33406f;
        int themedColor = gh0Var.getThemedColor(i15);
        Paint paint2 = this.d;
        paint2.setColor(themedColor);
        int themedColor2 = gh0Var.getThemedColor(org.telegram.ui.ActionBar.j6.f19140s8);
        TextPaint textPaint = this.f33405c;
