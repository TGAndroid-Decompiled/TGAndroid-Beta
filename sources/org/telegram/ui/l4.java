...
public class l4 extends FrameLayout {
    public final k4 f35215a;
    public float f35216b;
    public int f35217c;
    public boolean d;
    public int e;
    public final Matrix f35218f;

    public l4(Context context) {
        super(context);
        this.f35218f = new Matrix();
        this.f35217c = 0;
        this.f35215a = new k4(this, 0);
    }
    ...
    public void onMeasure(int i10, int i11) {
        ...
        if (this.f35216b > 0.0f) {
            int measuredWidth = getMeasuredWidth();
            int measuredHeight = getMeasuredHeight();
            float f11 = measuredWidth;
            float f12 = measuredHeight;
            float f13 = (this.f35216b / (f11 / f12)) - 1.0f;
            float abs = Math.abs(f13);
            k4 k4Var = this.f35215a;
            if (abs <= 0.01f) {
                if (!k4Var.f34924b) {
                    k4Var.f34924b = true;
                    ((l4) k4Var.f34925c).post(k4Var);
                    return;
                }
                return;
            }
            int i12 = this.f35217c;
            if (i12 != 0) {
                if (i12 != 1) {
                    if (i12 != 2) {
                        if (i12 != 3) {
