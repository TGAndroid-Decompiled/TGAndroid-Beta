...
public class l4 extends FrameLayout {
    public final k4 f35216a;
    public float f35217b;
    public int f35218c;
    public boolean d;
    public int e;
    public final Matrix f35219f;

    public l4(Context context) {
        super(context);
        this.f35219f = new Matrix();
        this.f35218c = 0;
        this.f35216a = new k4(this, 0);
    }
    ...
    public void onMeasure(int i10, int i11) {
        ...
        if (this.f35217b > 0.0f) {
            int measuredWidth = getMeasuredWidth();
            int measuredHeight = getMeasuredHeight();
            float f11 = measuredWidth;
            float f12 = measuredHeight;
            float f13 = (this.f35217b / (f11 / f12)) - 1.0f;
            float abs = Math.abs(f13);
            k4 k4Var = this.f35216a;
            if (abs <= 0.01f) {
                if (!k4Var.f34925b) {
                    k4Var.f34925b = true;
                    ((l4) k4Var.f34926c).post(k4Var);
                    return;
                }
                return;
            }
