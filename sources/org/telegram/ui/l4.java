...
public final class l4 extends org.telegram.ui.Components.ql0 {
    ...
    public int G;
    public final n4 I;
    public final Context f35641c;
    public final ArrayList d = new ArrayList();
    public final ArrayList e = new ArrayList();
    public final ArrayList f35642f = new ArrayList();
    public final HashMap h = new HashMap();
    public final HashMap f35643n = new HashMap();
    public final HashMap f35644r = new HashMap();
    public final HashMap f35645s = new HashMap();
    public final ArrayList v = new ArrayList();
    public final HashMap f35646w = new HashMap();
    public final ArrayList f35647x = new ArrayList();
    public final HashMap f35648y = new HashMap();
    ...
    public final void E(TL_iv.PageBlock pageBlock, l4 l4Var) {
        ...
        ArrayList arrayList = this.f35642f;
        if (z4) {
        ...
        } else if ((pageBlock instanceof TL_iv.pageBlockVideo) && k4.g(l4Var.B, pageBlock)) {
    ...
    public final void G(Object obj, TL_iv.PageBlock pageBlock) {
        if (!(obj instanceof TL_iv.textEmpty)) {
            HashMap hashMap = this.f35646w;
            if (hashMap.containsKey(obj)) {
                return;
            }
            hashMap.put(obj, pageBlock);
            this.f35647x.add(obj);
        }
    }

    public final void H(int r32, f2.l1 r33, org.telegram.tgnet.tl.TL_iv.PageBlock r34, int r35, int r36, boolean r37) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.l4.H(int, f2.l1, org.telegram.tgnet.tl.TL_iv$PageBlock, int, int, boolean):void");
    }

    public final boolean J(b4 b4Var) {
        TL_iv.PageBlock z4 = n4.z(b4Var.f32728a);
        if (z4 instanceof TL_iv.pageBlockDetails) {
            return ((TL_iv.pageBlockDetails) z4).open;
        }
        if (z4 instanceof b4) {
            b4 b4Var2 = (b4) z4;
            TL_iv.PageBlock z10 = n4.z(b4Var2.f32729b);
    ...
    public final void v(f2.l1 l1Var, int i10) {
        ...
        if (i11 >= 0) {
            ...
            if (i11 < arrayList.size()) {
                H(l1Var.f5777f, l1Var, (TL_iv.PageBlock) arrayList.get(i11), i11, arrayList.size(), false);
            }
        }
    }
    ...
    public final f2.l1 x(ViewGroup viewGroup, int i10) {
        TextView textView;
        View b3Var;
        Context context = this.f35641c;
        if (i10 != 2147483646) {
            n4 n4Var = this.I;
            switch (i10) {
                case 0:
                    textView = new f2(context, n4Var, this);
                    break;
                case 1:
                    textView = new z1(context, n4Var, this);
                    break;
                case 2:
                    textView = new q1(context);
                    break;
                case 3:
                    textView = new w1(n4Var, context, this);
                    break;
                case 4:
                    textView = new w2(context, n4Var, this);
                    break;
                case 5:
                    ...
                    break;
                case 6:
                    textView = new l2(context, n4Var, this);
                    break;
                case 7:
                    textView = new f1(context, n4Var, this);
                    break;
                case 8:
                    textView = new u2(n4Var, context, this);
                    break;
                case 9:
                    ...
                    break;
                case 10:
                    textView = new e1(context, n4Var, this);
                    break;
                case 11:
                    textView = new z2(context, n4Var, this);
                    break;
                case 12:
                    textView = new b2(context, n4Var, this);
                    break;
                case 13:
                    textView = new y1(context, n4Var, this);
                    break;
                case 14:
                    textView = new k2(context, n4Var, this);
                    break;
                case 15:
                    textView = new v2(context, n4Var, this);
                    break;
                case 16:
                    textView = new x1(context, n4Var, this);
                    break;
                case 17:
                    textView = new n1(n4Var, context, this);
                    break;
                case 18:
                    ...
                    break;
                case 19:
                    textView = new d1(context, n4Var, this);
                    break;
                case 20:
                    textView = new a2(context, n4Var, this);
                    break;
                case 21:
                    textView = new e2(context, n4Var, this);
                    break;
                case 22:
                    textView = new c2(context, n4Var, this);
                    break;
                case 23:
                    textView = new m2(context, n4Var, this);
                    break;
                case 24:
                    textView = new p1(context, n4Var, this);
                    break;
                case 25:
                    textView = new y2(context, n4Var, this);
                    break;
                case 26:
                    textView = new n2(context, n4Var, this);
                    break;
                case 27:
                ...
                default:
                    switch (i10) {
                        case 90:
                            ...
                            break;
                        case 91:
                            textView = new u3(n4Var, context, true);
                            break;
                        case 92:
                            textView = new d2(context, n4Var);
                            break;
                        default:
    ...
    public final void y(f2.l1 l1Var) {
        ...
        n4 n4Var = u3Var.e;
        TextView textView = u3Var.f38684a;
        TextView textView2 = u3Var.f38685b;
        if (i10 == 0) {
            u3Var.f38686c = false;
