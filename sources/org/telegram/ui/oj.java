...
public final class oj extends org.telegram.ui.ActionBar.j {
    ...
    public final void b(int i10) {
        ...
        if (i10 == -1) {
                ...
                if (kVar.s()) {
                    ...
                    boVar.wb(new Runnable(this) {
                        ...
                        public final void run() {
                            switch (r2) {
                                case 0:
                                    this.f35565b.f36367b.finishFragment();
                                    return;
                                default:
                                    oj ojVar = this.f35565b;
                                    ojVar.getClass();
                                    bo boVar2 = ojVar.f36367b;
            ...
            if (i10 == 10) {
                ...
                for (int i18 = 1; i18 >= 0; i18--) {
                    ...
                    for (int i20 = 0; i20 < arrayList.size(); i20++) {
                        ...
                        if (arrayList.size() != 1 && ((user3 = boVar.f32281f) == null || !user3.self)) {
                            z15 = true;
                        } else {
                            z15 = false;
                        }
                ...
                if (boVar.getParentActivity() != null) {
                    boVar.showDialog(org.telegram.ui.Components.c5.V(boVar.getParentActivity(), boVar.h, boVar.f32279ea).f18447a);
                }
            } else if (i10 == 15 || i10 == 16 || i10 == 26) {
                boolean z16 = false;
                if (boVar.getParentActivity() != null) {
                    if (i10 == 15 && ChatObject.isMonoForum(boVar.e)) {
                        if (boVar.f32261d4 != 0 && (user2 = boVar.getMessagesController().getUser(Long.valueOf(boVar.f32261d4))) != null) {
                    ...
                    if (i10 == 26 || (i10 == 15 && boVar.h == null && (((user = boVar.f32281f) != null && !UserObject.isUserSelf(user) && !UserObject.isDeleted(boVar.f32281f)) || ((chatFull = boVar.Z7) != null && chatFull.can_delete_channel)))) {
                        boolean z17 = z10;
                        org.telegram.ui.Components.c5.r(boVar, -1, boVar.f32281f, boVar.e, z17, new nj(this, z17), boVar.getResourceProvider());
                        return;
                    }
                    if (i10 == 15) {
                        z11 = true;
                    ...
                    TLRPC.User user4 = boVar.f32281f;
                    if (boVar.h != null) {
                        z16 = true;
                    }
                ...
                if (boVar.f32281f != null && boVar.getParentActivity() != null) {
                ...
                try {
                    boVar.getMediaDataController().installShortcut(boVar.f32281f.f18268id, MediaDataController.SHORTCUT_TYPE_USER_OR_CHAT);
                } catch (Exception e) {
                    FileLog.e(e);
                }
            } else if (i10 == 29) {
                ...
                for (int i26 = 1; i26 >= 0; i26--) {
                    if (messageObject == null && sparseArrayArr3[i26].size() == 1) {
                        ...
                        messageObject = (MessageObject) boVar.f32397o6[i26].get(((Integer) arrayList3.get(0)).intValue());
                    }
                ...
                org.telegram.ui.ActionBar.g1 g1Var = new org.telegram.ui.ActionBar.g1(0, this.f36366a, boVar.getResourceProvider(), true, true);
                ...
                if (i10 == 50) {
                    ...
                    if (textView2 != null) {
                        textView2.setTextColor(boVar.getThemedColor(org.telegram.ui.ActionBar.j6.f19101q7));
                    }
                } else if (i10 == 73) {
            ...
            } else if (boVar.f32281f != null && boVar.getParentActivity() != null) {
                TLRPC.User user5 = boVar.f32281f;
                if (i10 == 33) {
                    z12 = true;
                } else {
                    z12 = false;
                ...
                org.telegram.ui.Components.voip.f2.m(user5, z12, z13, boVar.getParentActivity(), boVar.getMessagesController().getUserFull(boVar.f32281f.f18268id), boVar.getAccountInstance());
            }
        }
    }
}
