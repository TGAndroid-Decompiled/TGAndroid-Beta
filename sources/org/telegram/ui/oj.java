...
public final class oj implements org.telegram.ui.Components.po {
    ...
    public final void dismiss() {
        this.f36257a.f39496h0.M(null, null);
    }

    @Override
    public final void n() {
        wn wnVar = this.f36257a;
        wnVar.bc(true);
        org.telegram.ui.Components.xc.A(wnVar, wnVar.getMessagesController().isDialogMuted(wnVar.T5, wnVar.d()), wnVar.f39470ea).j();
    }
    ...
    public final void o() {
        ...
        if (wnVar.T5 != 0 && wnVar.R3 != 3) {
            if (wnVar.f39472f != null) {
                wnVar.getMessagesController().putUser(wnVar.f39472f, true);
            }
            ...
            wnVar.presentFragment(new n11(bundle, wnVar.f39470ea));
        }
    }
