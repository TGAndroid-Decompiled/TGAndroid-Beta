...
public final class bz extends s4.v {
    ...
    public final boolean n(RecyclerView recyclerView, s4.c1 c1Var, s4.c1 c1Var2) {
        ...
        int b11 = c1Var2.b();
        dz dzVar = this.e;
        az azVar = dzVar.f33174a;
        dz dzVar2 = azVar.d;
        int i10 = dzVar2.f33178n;
        ArrayList arrayList = dzVar2.e;
        int i11 = b10 - i10;
        int i12 = b11 - i10;
        int i13 = dzVar2.f33179r - i10;
        if (i11 >= 0 && i12 >= 0 && i11 < i13 && i12 < i13) {
            ...
            if (b11 != dzVar.f33179r - 1) {
                z10 = true;
            } else {
                z10 = false;
            }
            h4Var.setDrawDivider(z10);
            org.telegram.ui.Cells.h4 h4Var2 = (org.telegram.ui.Cells.h4) c1Var2.f42974a;
            if (b10 != dzVar.f33179r - 1) {
                z11 = true;
            }
