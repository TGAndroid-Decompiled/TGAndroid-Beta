...
public final class uc1 implements View.OnClickListener {
    ...
    public final void onClick(View view) {
        switch (this.f37967a) {
            case 0:
                vd1 vd1Var = this.f37969c;
                vd1Var.F0.setRotation(this.f37968b);
                this.f37968b -= 45;
                vd1Var.F0.animate().rotationBy(-45.0f).setDuration(300L).setInterpolator(org.telegram.ui.Components.qr.f27716g).start();
                kd1[] kd1VarArr = vd1Var.f38526w0;
                ...
                if (kd1Var != null) {
                    ...
                    if (background instanceof org.telegram.ui.Components.lc0) {
                        ...
                        if (vd1Var.f38470b == 2) {
                            vd1Var.f38492h1 += 45;
                            while (true) {
                                int i10 = vd1Var.f38492h1;
                                if (i10 >= 360) {
                                    vd1Var.f38492h1 = i10 - 360;
                                } else {
                            ...
                            g6Var.f18887n += 45;
                            while (true) {
                                int i11 = g6Var.f18887n;
                                if (i11 >= 360) {
                                    g6Var.f18887n = i11 - 360;
                                } else {
                ...
                return;
            default:
                vd1 vd1Var2 = this.f37969c;
                org.telegram.ui.ActionBar.q5 q5Var = vd1Var2.R;
                vd1Var2.G0.setRotation(this.f37968b);
                this.f37968b -= 45;
                vd1Var2.G0.animate().rotationBy(-45.0f).setDuration(300L).setInterpolator(org.telegram.ui.Components.qr.f27716g).start();
                ...
                if (i12 != 0) {
                    ...
                    g6Var2.e = g6Var2.f18880f;
                    g6Var2.f18880f = g6Var2.f18881g;
                    g6Var2.f18881g = i12;
                    g6Var2.h = i13;
                } else {
                    int i14 = g6Var2.e;
                ...
                vd1Var2.V.e(g6Var2.f18881g, 2);
                vd1Var2.V.e(g6Var2.f18880f, 1);
                ...
                vd1Var2.K0[1].b(1, g6Var2.f18880f);
                vd1Var2.K0[1].b(2, g6Var2.f18881g);
