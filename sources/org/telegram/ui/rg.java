        ...
        switch (i10) {
            case 0:
                if (wnVar.getParentActivity() != null && wnVar.fragmentView != null && wnVar.Y != null && wnVar.Ea == null && wnVar.getMessagesController().getSendPaidMessagesStars(wnVar.a()) <= 0 && (sendButton = wnVar.Y.getSendButton()) != null && wnVar.Y.getEditField() != null && wnVar.Y.getEditField().getText().length() != 0) {
                    ...
                    if (wnVar.f39510i2 == null) {
                        org.telegram.ui.Components.j40 j40Var = new org.telegram.ui.Components.j40(4, wnVar.getParentActivity(), wnVar.f39470ea, false);
                        wnVar.f39510i2 = j40Var;
                        j40Var.a();
                        wnVar.f39510i2.setAlpha(0.0f);
                        wnVar.f39510i2.setVisibility(4);
                        wnVar.f39510i2.setText(LocaleController.getString(R.string.ScheduledHint));
                        wnVar.X0.addView(wnVar.f39510i2, w7.y5.d(-2, -2.0f, 51, 10.0f, 0.0f, 10.0f, 0.0f));
                    }
                    wnVar.f39510i2.f(sendButton, true);
                    wnVar.f39523j2 = true;
                    return;
                }
                return;
            case 1:
                ...
                if (jkVar != null && wnVar.Bc != null) {
                    if (jkVar.t0()) {
                        wnVar.Y.m0(false);
                        AndroidUtilities.showKeyboard(wnVar.Bc.f42038a);
                        wnVar.Bc.f42039b.f42035a.a(false, true);
                        return;
                    }
                    wnVar.Y.V0(false, false, false);
                    wnVar.Y.s1();
                    wnVar.Bc.f42039b.f42035a.a(true, true);
                    return;
                }
                return;
            case 2:
                ...
                if (wnVar.f39696x0 != null && wnVar.A0 != null) {
                    int i11 = Integer.MAX_VALUE;
                    int i12 = Integer.MIN_VALUE;
                    for (int i13 = 0; i13 < wnVar.f39696x0.getChildCount(); i13++) {
                        View childAt = wnVar.f39696x0.getChildAt(i13);
                    ...
                    if (i11 <= i12) {
                        ...
                        for (int i15 = 0; i15 < arrayList.size(); i15++) {
                            ...
                            MessageObject.GroupedMessages groupedMessages = (MessageObject.GroupedMessages) wnVar.f39702x6.f(messageObject.getGroupId());
            ...
            case 12:
                ...
                return;
            case 13:
                org.telegram.ui.ActionBar.a2 a2Var = new org.telegram.ui.ActionBar.a2(wnVar.getParentActivity(), 3, wnVar.f39470ea);
                wnVar.f39591ob = a2Var;
                a2Var.setOnShowListener(new mf(wnVar, 1));
                wnVar.f39591ob.setOnCancelListener(wnVar.f39566ma);
                wnVar.f39591ob.q(500L);
                return;
            case 14:
                wnVar.N6();
                return;
            case 15:
                wnVar.f39408a = (wnVar.f39408a + 1) % 3;
                return;
            case 16:
                wnVar.f39421b = !wnVar.f39421b;
                return;
            case 17:
                wnVar.A7(true);
            ...
            case 23:
                nk nkVar = wnVar.R2;
                if ((nkVar == null || nkVar.getVisibility() != 0) && (e4Var = wnVar.f39684w1) != null) {
                    e4Var.u();
                    return;
                }
                return;
            ...
            case 27:
                ...
                wnVar.X0.addView(wnVar.f39710y1, e);
                wnVar.f39710y1.setTranslationY(-AndroidUtilities.navigationBarHeight);
                wnVar.f39710y1.m(0.0f, wnVar.Y.getEmojiButton().getX() + AndroidUtilities.dp(22.0f));
                wnVar.f39710y1.u();
                return;
            case 28:
                int i17 = wn.Gc;
