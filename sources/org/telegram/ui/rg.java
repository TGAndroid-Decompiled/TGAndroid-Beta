        ...
        switch (i10) {
            case 0:
                if (wnVar.getParentActivity() != null && wnVar.fragmentView != null && wnVar.Y != null && wnVar.Ea == null && wnVar.getMessagesController().getSendPaidMessagesStars(wnVar.a()) <= 0 && (sendButton = wnVar.Y.getSendButton()) != null && wnVar.Y.getEditField() != null && wnVar.Y.getEditField().getText().length() != 0) {
                    ...
                    if (wnVar.f39494i2 == null) {
                        org.telegram.ui.Components.j40 j40Var = new org.telegram.ui.Components.j40(4, wnVar.getParentActivity(), wnVar.f39454ea, false);
                        wnVar.f39494i2 = j40Var;
                        j40Var.a();
                        wnVar.f39494i2.setAlpha(0.0f);
                        wnVar.f39494i2.setVisibility(4);
                        wnVar.f39494i2.setText(LocaleController.getString(R.string.ScheduledHint));
                        wnVar.X0.addView(wnVar.f39494i2, w7.y5.d(-2, -2.0f, 51, 10.0f, 0.0f, 10.0f, 0.0f));
                    }
                    wnVar.f39494i2.f(sendButton, true);
                    wnVar.f39507j2 = true;
                    return;
                }
                return;
            case 1:
                ...
                if (jkVar != null && wnVar.Bc != null) {
                    if (jkVar.t0()) {
                        wnVar.Y.m0(false);
                        AndroidUtilities.showKeyboard(wnVar.Bc.f42023a);
                        wnVar.Bc.f42024b.f42020a.a(false, true);
                        return;
                    }
                    wnVar.Y.V0(false, false, false);
                    wnVar.Y.s1();
                    wnVar.Bc.f42024b.f42020a.a(true, true);
                    return;
                }
                return;
            case 2:
                ...
                if (wnVar.f39680x0 != null && wnVar.A0 != null) {
                    int i11 = Integer.MAX_VALUE;
                    int i12 = Integer.MIN_VALUE;
                    for (int i13 = 0; i13 < wnVar.f39680x0.getChildCount(); i13++) {
                    ...
                    if (i11 <= i12) {
                        ...
                        for (int i15 = 0; i15 < arrayList.size(); i15++) {
                            ...
                            MessageObject.GroupedMessages groupedMessages = (MessageObject.GroupedMessages) wnVar.f39686x6.f(messageObject.getGroupId());
            ...
            case 12:
                ...
                return;
            case 13:
                org.telegram.ui.ActionBar.a2 a2Var = new org.telegram.ui.ActionBar.a2(wnVar.getParentActivity(), 3, wnVar.f39454ea);
                wnVar.f39575ob = a2Var;
                a2Var.setOnShowListener(new mf(wnVar, 1));
                wnVar.f39575ob.setOnCancelListener(wnVar.f39550ma);
                wnVar.f39575ob.q(500L);
                return;
            case 14:
                wnVar.N6();
                return;
            case 15:
                wnVar.f39392a = (wnVar.f39392a + 1) % 3;
                return;
            case 16:
                wnVar.f39405b = !wnVar.f39405b;
                return;
            case 17:
                wnVar.A7(true);
            ...
            case 23:
                nk nkVar = wnVar.R2;
                if ((nkVar == null || nkVar.getVisibility() != 0) && (e4Var = wnVar.f39668w1) != null) {
                    e4Var.u();
                    return;
                }
                return;
            ...
            case 27:
                ...
                wnVar.X0.addView(wnVar.f39694y1, e);
                wnVar.f39694y1.setTranslationY(-AndroidUtilities.navigationBarHeight);
                wnVar.f39694y1.m(0.0f, wnVar.Y.getEmojiButton().getX() + AndroidUtilities.dp(22.0f));
                wnVar.f39694y1.u();
                return;
            case 28:
                int i17 = wn.Gc;
