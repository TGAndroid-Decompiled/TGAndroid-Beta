...
public final class rg implements lv0, jy {
    public final boolean f40840a;
    public final int f40841b;
    public final Object f40842c;
    ...
    public boolean v(py pyVar, ArrayList arrayList, CharSequence charSequence, boolean z4, boolean z10, int i10, int i11, sf1 sf1Var) {
        LaunchActivity launchActivity = (LaunchActivity) this.f40842c;
        String str = (String) this.d;
        Pattern pattern = LaunchActivity.f34134y1;
        long j10 = ((MessagesStorage.TopicKey) arrayList.get(0)).dialogId;
        Bundle bundle = new Bundle();
        bundle.putBoolean("scrollToTopOnResume", true);
        bundle.putBoolean("hasUrl", this.f40840a);
