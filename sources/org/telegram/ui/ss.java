...
public final class ss extends org.telegram.ui.ActionBar.j {
    public final ContactsActivity f37840a;

    public ss(ContactsActivity contactsActivity) {
        this.f37840a = contactsActivity;
    }
    ...
    public final void b(int i10) {
        ...
        ContactsActivity contactsActivity = this.f37840a;
        if (i10 == -1) {
        ...
        if (i10 == 100) {
            ...
            if (iVar.m() == 1) {
                alertDialog$Builder.f18647a.R = LocaleController.getString(R.string.DeleteContactTitle);
                alertDialog$Builder.f18647a.T = LocaleController.getString(R.string.DeleteContactSubtitle);
            } else {
                alertDialog$Builder.f18647a.R = LocaleController.formatPluralString("DeleteContactsTitle", iVar.m(), new Object[0]);
                alertDialog$Builder.f18647a.T = LocaleController.getString(R.string.DeleteContactsSubtitle);
            }
            ...
            usVar.Y(i12, false);
            org.telegram.ui.ActionBar.u0 u0Var = contactsActivity.f31029s;
            ...
            contactsActivity.f31014f.x0(0);
            AndroidUtilities.doOnPreDraw(contactsActivity.Z.f23131r, new aj(this, 14));
        }
    }
}
