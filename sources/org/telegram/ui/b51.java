...
public final class b51 extends FrameLayout {
    public final Paint f32242a;
    public final Paint f32243b;
    public final RectF f32244c;
    public final org.telegram.ui.Components.m21 d;
    public boolean e;
    public long f32245f;
    public long h;
    public final org.telegram.ui.Components.ij0 f32246n;
    public final TextPaint f32247r;
    public StaticLayout f32248s;
    public float v;
    public float f32249w;
    public final SecretMediaViewer f32250x;

    public b51(SecretMediaViewer secretMediaViewer, Activity activity) {
        super(activity);
        this.f32250x = secretMediaViewer;
        this.f32244c = new RectF();
        this.d = new org.telegram.ui.Components.m21();
        this.f32247r = new TextPaint(1);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float max;
        MessageObject messageObject = this.f32250x.f31698h0;
        if (messageObject != null) {
            ...
            if (message.destroyTime != 0 || message.ttl == Integer.MAX_VALUE) {
                if (this.f32245f == 0) {
                    ...
                    max = ((float) Math.max(0L, this.f32245f - (System.currentTimeMillis() + (ConnectionsManager.getInstance(secretMediaViewer.f31680a).getTimeDifference() * 1000)))) / (((float) this.h) * 1000.0f);
                }
                boolean z10 = this.e;
                Paint paint = this.f32243b;
                Paint paint2 = this.f32242a;
                float f7 = max;
                RectF rectF = this.f32244c;
                if (z10) {
                    canvas.save();
                    canvas.translate(rectF.centerX() - (this.v / 2.0f), rectF.centerY() - (this.f32249w / 2.0f));
                    this.f32248s.draw(canvas);
                    canvas.restore();
                    ...
                    org.telegram.ui.Components.ij0 ij0Var = this.f32246n;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f32244c.set(measuredWidth - dpf2, measuredHeight - dpf2, measuredWidth + dpf2, dpf2 + measuredHeight);
