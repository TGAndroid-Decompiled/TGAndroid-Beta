...
public final class b51 extends Dialog {
    ...
    public float v;
    public org.telegram.ui.Components.s71 f32334w;
    ...
    public final void c(boolean z10, w41 w41Var) {
        ...
        this.f32329e0.setInterpolator(rrVar);
        this.f32329e0.start();
    }
    ...
    public final void dismiss() {
        ...
        if (!this.f32325b0) {
            ...
            org.telegram.ui.Components.s71 s71Var = this.f32334w;
            if (s71Var != null) {
                s71Var.B();
                this.f32334w.H();
                this.f32334w = null;
            ...
            if (h0Var != null) {
                ...
                this.Y = null;
                org.telegram.ui.Components.k11 k11Var = new org.telegram.ui.Components.k11(this.f32322a, null);
                this.d = k11Var;
                k0Var.addView(k11Var, w7.y5.e(-1, -1, 119));
                org.telegram.ui.Components.k11 k11Var2 = this.d;
                z41 z41Var2 = this.N;
                w41 w41Var = new w41(this, 1);
                org.telegram.ui.Components.i11 i11Var = k11Var2.f25597a;
                if (i11Var != null) {
                    i11Var.e(z41Var2, 1.5f, w41Var);
                    Choreographer.getInstance().postFrameCallback(k11Var2.f25598b);
                } else {
                    org.telegram.ui.Components.j11 j11Var = new org.telegram.ui.Components.j11(z41Var2, w41Var);
                    j11Var.f25244g = 1.5f;
                    k11Var2.f25599c.add(j11Var);
                }
            ...
            if (ktVar != null) {
                ...
                SensorManager sensorManager = ktVar.f25868a;
                if (ktVar.f25872n) {
                    Sensor sensor = ktVar.f25871f;
                    if (sensor != null) {
                    ...
                    sensorManager.unregisterListener(ktVar, ktVar.f25870c);
        ...
        if (AndroidUtilities.isSafeToShow(getContext())) {
            ...
            if (ktVar != null) {
                ...
                if (!ktVar.f25872n) {
                    ...
                    sensorManager.registerListener(ktVar, ktVar.f25870c, 3);
