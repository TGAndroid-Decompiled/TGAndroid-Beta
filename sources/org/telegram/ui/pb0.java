        ...
        switch (this.f36587a) {
            case 2:
                ...
                if (i10 < arrayList.size()) {
                    zb0Var.f40206w.setText(LocaleController.formatDateAudio(zb0Var.getConnectionsManager().getCurrentTime() + ((Integer) arrayList.get(i10)).intValue(), false));
                    return;
                }
                zb0Var.f40206w.setText("");
                return;
            default:
                zb0 zb0Var2 = this.f36588b;
