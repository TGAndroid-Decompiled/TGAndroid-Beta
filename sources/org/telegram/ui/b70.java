...
public final class b70 implements Runnable {
    ...
    public final void run() {
        ...
        switch (this.f32068a) {
            case 0:
                c70 c70Var = this.f32069b;
                String str2 = this.f32070c;
                c70Var.getClass();
                AndroidUtilities.runOnUIThread(new b70(c70Var, str2, 1));
                return;
            case 1:
                c70 c70Var2 = this.f32069b;
                String str3 = this.f32070c;
                gg.c2 c2Var = c70Var2.f32691f;
                ...
                return;
            default:
                c70 c70Var3 = this.f32069b;
                String str4 = this.f32070c;
                ArrayList arrayList2 = c70Var3.f32693r;
