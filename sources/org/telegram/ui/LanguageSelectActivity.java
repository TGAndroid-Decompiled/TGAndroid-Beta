...
public class LanguageSelectActivity extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public org.telegram.ui.Components.ll0 f33444b;
    public u80 f33445c;
    public org.telegram.ui.Components.mz d;
    private int doNotTranslatePosition;
    public ArrayList f33446e;
    public ArrayList f33447f;
    public ArrayList h;
    ...
    public static boolean V(LanguageSelectActivity languageSelectActivity, View view, int i10) {
        ...
        try {
            if (languageSelectActivity.getParentActivity() != null && languageSelectActivity.parentLayout != null && (view instanceof org.telegram.ui.Cells.g9)) {
                if (languageSelectActivity.f33444b.getAdapter() == languageSelectActivity.f33445c) {
                    z10 = true;
                } else {
                    z10 = false;
                }
                if (!z10) {
                    i10 -= languageSelectActivity.f33449r;
                }
                if (z10) {
                    localeInfo = (LocaleController.LocaleInfo) languageSelectActivity.f33446e.get(i10);
                    ...
                    localeInfo = (LocaleController.LocaleInfo) languageSelectActivity.f33447f.get(i10);
                }
    ...
    public static void X(LanguageSelectActivity languageSelectActivity, LocaleController.LocaleInfo localeInfo) {
        if (LocaleController.getInstance().deleteLanguage(localeInfo, languageSelectActivity.currentAccount)) {
            ...
            u80 u80Var = languageSelectActivity.f33443a;
            if (u80Var != null) {
                u80Var.l();
            }
            u80 u80Var2 = languageSelectActivity.f33445c;
            if (u80Var2 != null) {
                u80Var2.l();
            }
        }
    ...
    public final View createView(Context context) {
        ...
        this.f33443a = new u80(this, context, false);
        this.f33445c = new u80(this, context, true);
        ...
        this.f33444b = ll0Var;
        ll0Var.o1();
        this.actionBar.setAdaptiveBackground(this.f33444b);
        this.f33444b.setEmptyView(this.d);
        this.f33444b.setLayoutManager(new s4.c0(1, false));
        this.f33444b.setVerticalScrollBarEnabled(false);
        this.f33444b.setAdapter(this.f33443a);
        t80 t80Var = new t80(this);
        t80Var.n(400L);
        t80Var.C = false;
        t80Var.o(org.telegram.ui.Components.pr.h);
        this.f33444b.setItemAnimator(t80Var);
        frameLayout2.addView(this.f33444b, w7.x5.c(-1.0f, -1));
        this.f33444b.setOnItemClickListener(new i(this, 15));
        this.f33444b.setOnItemLongClickListener(new iu(this, 13));
        this.f33444b.setOnScrollListener(new i3(this, 17));
        return this.fragmentView;
    }

    @Override
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.suggestedLangpack && this.f33443a != null) {
            f0();
    ...
    public final void f0() {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            ...
            if (localeInfo.serverIndex != Integer.MAX_VALUE) {
                this.f33447f.add(localeInfo);
            } else {
                this.h.add(localeInfo);
            }
        }
        Collections.sort(this.f33447f, wtVar);
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f33444b, 16, new Class[]{org.telegram.ui.Cells.p4.class}, null, null, null, org.telegram.ui.ActionBar.j6.f20690d6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f33444b, 32768, null, null, null, null, org.telegram.ui.ActionBar.j6.f20964s8));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f33444b, 4096, null, null, null, null, org.telegram.ui.ActionBar.j6.f20780i6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.d, 4, null, null, null, null, org.telegram.ui.ActionBar.j6.f20673c7));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f33444b, 0, new Class[]{View.class}, org.telegram.ui.ActionBar.j6.f20812k0, null, null, org.telegram.ui.ActionBar.j6.f20691d7));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f33444b, 32, new Class[]{org.telegram.ui.Cells.a7.class}, null, null, null, org.telegram.ui.ActionBar.j6.f20654b7));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f33444b, 0, new Class[]{org.telegram.ui.Cells.p4.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.G6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f33444b, 0, new Class[]{org.telegram.ui.Cells.p4.class}, new String[]{"textView2"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.A6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f33444b, 0, new Class[]{org.telegram.ui.Cells.p4.class}, new String[]{"checkImage"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.Mh));
        return arrayList;
    }
    ...
    public final void onInsets(int i10, int i11, int i12, int i13) {
        this.f33444b.setPadding(0, 0, 0, i13);
        this.f33444b.setClipToPadding(false);
    }
