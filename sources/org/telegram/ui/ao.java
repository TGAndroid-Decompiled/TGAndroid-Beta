...
public final class ao extends Drawable {
    ...
    public View f32675b;
    public int f32676c = 255;
    public final float d;
    public final nh.y2 e;
    public final org.telegram.ui.Components.dc0 f32677f;
    public final TLRPC.WallPaper f32678g;
    public boolean h;
    public boolean f32679i;
    public final ArrayList f32680j;
        ...
        if (wallPaper.document != null) {
            ...
            if (wallPaperSettings != null && wallPaperSettings.intensity >= 0) {
                if (wallPaperSettings.second_background_color == 0) {
                    ...
                    a2 = new BitmapDrawable(dc0Var.f24241k);
                }
            } else {
    ...
    public final Drawable c(boolean z4) {
        org.telegram.ui.Components.dc0 dc0Var = this.f32677f;
        if (dc0Var != null) {
            return dc0Var;
        }
        nh.y2 y2Var = this.e;
    ...
    public final void draw(Canvas canvas) {
        ...
        y2Var.setAlpha(this.f32676c / 255.0f);
        y2Var.draw(canvas);
        if (z4 && f10 != 0.0f) {
    ...
    public final void f(View view) {
        ArrayList arrayList = this.f32680j;
        if (!arrayList.contains(view)) {
            arrayList.add(view);
        }
        int size = arrayList.size();
        nh.y2 y2Var = this.e;
        if (size > 0 && !this.f32679i) {
            this.f32679i = true;
            y2Var.onAttachedToWindow();
        } else if (arrayList.size() <= 0 && this.f32679i) {
            this.f32679i = false;
