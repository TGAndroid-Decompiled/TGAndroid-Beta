...
public final class ek0 implements org.telegram.ui.Components.po {
    ...
    public final nk0 f33437c;
    public final boolean d;
    public final int e;
    public final ArrayList f33438f;
    ...
    public final void a() {
        ...
        ArrayList arrayList = notificationsCustomSettingsActivity.f31158w;
        nk0 nk0Var = this.f33437c;
        ArrayList arrayList2 = this.f33438f;
        if (arrayList2 != arrayList && (indexOf = arrayList.indexOf(nk0Var)) >= 0) {
            notificationsCustomSettingsActivity.f31158w.remove(indexOf);
            notificationsCustomSettingsActivity.f31159x.remove(Long.valueOf(nk0Var.d));
        }
        arrayList2.remove(nk0Var);
        if (arrayList2 == notificationsCustomSettingsActivity.f31158w) {
    ...
    public final void b() {
        org.telegram.ui.ActionBar.k kVar;
        NotificationsCustomSettingsActivity notificationsCustomSettingsActivity = this.h;
        if (notificationsCustomSettingsActivity.getMessagesController().isDialogMuted(this.f33435a, 0) != this.f33436b) {
            a();
            return;
        }
        ...
        nk0 nk0Var = this.f33437c;
        sb2.append(nk0Var.d);
        nk0Var.f35919b = notificationsSettings.getBoolean(sb2.toString(), false);
        ...
        if (this.d) {
            notificationsCustomSettingsActivity.f31158w.add(nk0Var);
            notificationsCustomSettingsActivity.f31159x.put(Long.valueOf(nk0Var.d), nk0Var);
            notificationsCustomSettingsActivity.l0(true);
        } else {
            notificationsCustomSettingsActivity.f31151a.getAdapter().m(this.e);
        }
        kVar = ((org.telegram.ui.ActionBar.m2) notificationsCustomSettingsActivity).actionBar;
        kVar.h(true);
    }
    ...
    public final void n() {
        ...
        long j3 = 0;
        long j10 = this.f33435a;
        notificationsCustomSettingsActivity.getNotificationsController().muteDialog(this.f33435a, j3, !messagesController.isDialogMuted(j10, j3));
    ...
    @Override
    public final void o() {
        long j3 = this.f33435a;
        if (j3 != 0) {
            n11 n11Var = new n11(v7.j.e(j3, "dialog_id"), null);
            n11Var.f35731r = new g(this, 28);
    ...
    public final void r() {
        int i10;
        String sharedPrefKey = NotificationsController.getSharedPrefKey(this.f33435a, 0);
        NotificationsCustomSettingsActivity notificationsCustomSettingsActivity = this.h;
    ...
    public final void u(int i10) {
        NotificationsCustomSettingsActivity notificationsCustomSettingsActivity = this.h;
        if (i10 == 0) {
            if (notificationsCustomSettingsActivity.getMessagesController().isDialogMuted(this.f33435a, 0)) {
                n();
            }
            if (org.telegram.ui.Components.xc.a(notificationsCustomSettingsActivity)) {
            ...
            notificationsCustomSettingsActivity.getNotificationsController().muteUntil(this.f33435a, 0, i10);
            if (org.telegram.ui.Components.xc.a(notificationsCustomSettingsActivity)) {
