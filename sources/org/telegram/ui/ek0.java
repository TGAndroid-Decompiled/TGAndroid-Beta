...
public final class ek0 implements org.telegram.ui.Components.po {
    ...
    public final void a() {
        ...
        ArrayList arrayList = notificationsCustomSettingsActivity.f31143w;
        nk0 nk0Var = this.f33421c;
        ArrayList arrayList2 = this.f33422f;
        if (arrayList2 != arrayList && (indexOf = arrayList.indexOf(nk0Var)) >= 0) {
            notificationsCustomSettingsActivity.f31143w.remove(indexOf);
            notificationsCustomSettingsActivity.f31144x.remove(Long.valueOf(nk0Var.d));
        }
        arrayList2.remove(nk0Var);
        if (arrayList2 == notificationsCustomSettingsActivity.f31143w) {
    ...
    public final void b() {
        org.telegram.ui.ActionBar.k kVar;
        NotificationsCustomSettingsActivity notificationsCustomSettingsActivity = this.h;
        if (notificationsCustomSettingsActivity.getMessagesController().isDialogMuted(this.f33419a, 0) != this.f33420b) {
            a();
            return;
        }
        ...
        nk0 nk0Var = this.f33421c;
        sb2.append(nk0Var.d);
        nk0Var.f35895b = notificationsSettings.getBoolean(sb2.toString(), false);
        ...
        if (this.d) {
            notificationsCustomSettingsActivity.f31143w.add(nk0Var);
            notificationsCustomSettingsActivity.f31144x.put(Long.valueOf(nk0Var.d), nk0Var);
            notificationsCustomSettingsActivity.l0(true);
        } else {
            notificationsCustomSettingsActivity.f31136a.getAdapter().m(this.e);
        }
        kVar = ((org.telegram.ui.ActionBar.m2) notificationsCustomSettingsActivity).actionBar;
        kVar.h(true);
    }
    ...
    public final void n() {
        ...
        notificationsCustomSettingsActivity.getNotificationsController().muteDialog(this.f33419a, j3, !messagesController.isDialogMuted(j10, j3));
    ...
    @Override
    public final void o() {
        long j3 = this.f33419a;
        if (j3 != 0) {
            n11 n11Var = new n11(v7.j.e(j3, "dialog_id"), null);
            n11Var.f35717r = new g(this, 28);
    ...
    public final void r() {
        int i10;
        String sharedPrefKey = NotificationsController.getSharedPrefKey(this.f33419a, 0);
        NotificationsCustomSettingsActivity notificationsCustomSettingsActivity = this.h;
    ...
    public final void u(int i10) {
        NotificationsCustomSettingsActivity notificationsCustomSettingsActivity = this.h;
        if (i10 == 0) {
            if (notificationsCustomSettingsActivity.getMessagesController().isDialogMuted(this.f33419a, 0)) {
                n();
            }
            if (org.telegram.ui.Components.yc.a(notificationsCustomSettingsActivity)) {
            ...
            notificationsCustomSettingsActivity.getNotificationsController().muteUntil(this.f33419a, 0, i10);
            if (org.telegram.ui.Components.yc.a(notificationsCustomSettingsActivity)) {
