...
public final class ek0 extends org.telegram.ui.ActionBar.f3 implements AdapterView.OnItemSelectedListener {
    public static final int f36104d0 = 0;
    public boolean E;
    public boolean F;
    public boolean G;
    public boolean H;
    ...
    public final TextView f36105a0;
    public final LinearLayout f36106b;
    public String f36107b0;
    public final org.telegram.ui.Components.sq f36108c;
    public int f36109c0;
    public final org.telegram.ui.Components.yc0 d;
    public final org.telegram.ui.Components.yc0 f36110e;
    public final FrameLayout f36111f;
    public final View h;
    public final di.d f36112n;
    public final org.telegram.ui.Components.yc0 f36113r;
    public final org.telegram.ui.Components.zc0 f36114s;
    public final org.telegram.ui.Components.d90 v;
    public final ArrayList f36115w;
    public final HashMap f36116x;
    public final HashMap f36117y;
    ...
    public static void q(ek0 ek0Var) {
        ...
        for (int min = Math.min(3, replaceAll.length()); min >= 0; min--) {
            ...
            List list = (List) ek0Var.f36116x.get(substring);
            if (list != null && !list.isEmpty()) {
                List list2 = (List) ek0Var.f36117y.get(substring);
        ...
        if (!z10) {
            if (!TextUtils.isEmpty(ek0Var.f36107b0)) {
                ek0Var.f36107b0 = null;
                ek0Var.y(null);
            }
        } else if (!TextUtils.equals(ek0Var.f36107b0, replaceAll)) {
            ek0Var.f36107b0 = replaceAll;
            ek0Var.y(replaceAll);
        }
    }
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36110e, 4, null, null, null, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36110e, 8388608, null, null, null, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36110e, 32, null, null, null, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36110e, 65568, null, null, null, null, i13));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36108c, 0, null, null, null, null, org.telegram.ui.ActionBar.j6.D7));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f36108c, 0, null, null, null, null, org.telegram.ui.ActionBar.j6.E7));
        return arrayList;
    }
    ...
    public final void onItemSelected(AdapterView adapterView, View view, int i10, long j3) {
        ...
        this.E = true;
        this.O.setText(((vt) this.f36115w.get(i10)).f41696c);
        this.E = false;
    }
    ...
    public final void r() {
        ...
        String obj2 = this.f36110e.getEditText().getText().toString();
        if (this.f36113r.getVisibility() == 0) {
            str = this.f36113r.getEditText().getText().toString();
        } else {
            str = "";
        }
    ...
    public final void t(CharSequence charSequence) {
        if (TextUtils.isEmpty(charSequence)) {
            ...
            this.f36105a0.animate().setInterpolator(prVar).translationX(-AndroidUtilities.dp(30.0f)).setDuration(150L);
        ...
        ViewPropertyAnimator animate2 = this.f36105a0.animate();
        org.telegram.ui.Components.pr prVar2 = org.telegram.ui.Components.pr.f29467f;
    ...
    public final void v(String str, boolean z10) {
        ...
        if (!TextUtils.isEmpty(str)) {
            ...
            if (this.I.startsWith("+")) {
                ...
                while (true) {
                    if (i10 >= 1) {
                        List list = (List) this.f36116x.get(str2.substring(0, i10));
                        if (list != null && list.size() > 0) {
                            String str3 = ((vt) list.get(0)).f41696c;
                            this.O.setText(str3);
    ...
    public final void w(boolean z10) {
        ...
        ViewPropertyAnimator animate2 = this.f36111f.animate();
        if (z10) {
    ...
    public final void x(boolean z10) {
        ...
        float f11;
        float f12;
        boolean z11 = this.S.f28478a.f23908q;
        final boolean z12 = !z11;
        float f13 = 0.0f;
        int i12 = 0;
        if (z10) {
            this.f36112n.setVisibility(0);
            ViewPropertyAnimator animate = this.f36112n.animate();
            if (!z11) {
                f11 = 1.0f;
            } else {
                f11 = 0.0f;
            ...
            alpha.setInterpolator(prVar).setDuration(420L).withEndAction(new Runnable(this) {
                ...
                public final void run() {
                    switch (r3) {
                        case 0:
                            boolean z13 = z12;
                            ek0 ek0Var = this.f34467b;
                            if (!z13) {
                                ek0Var.f36112n.setVisibility(4);
                                return;
                            } else {
                                ek0Var.getClass();
                                return;
                        ...
                        default:
                            boolean z15 = z12;
                            ek0 ek0Var3 = this.f34467b;
                            if (z15) {
                                ek0Var3.f36113r.setVisibility(4);
                                return;
                            } else {
                                ek0Var3.getClass();
                                return;
            ...
            this.f36113r.setVisibility(0);
            ViewPropertyAnimator animate3 = this.f36113r.animate();
            if (z11) {
                f13 = 1.0f;
            }
        ...
        this.f36112n.animate().cancel();
        if (!z11) {
            i10 = 0;
        } else {
            i10 = 4;
        }
        this.f36112n.setVisibility(i10);
        if (!z11) {
            f7 = 1.0f;
        } else {
            f7 = 0.0f;
        }
        this.f36112n.setAlpha(f7);
        ...
        this.h.setAlpha(f10);
        this.f36113r.animate().cancel();
        if (!z11) {
            i12 = 4;
        }
        this.f36113r.setVisibility(i12);
        if (z11) {
            f13 = 1.0f;
        }
        this.f36113r.setAlpha(f13);
    }

    public final void y(String str) {
        if (this.f36109c0 >= 0) {
            ConnectionsManager.getInstance(this.currentAccount).cancelRequest(this.f36109c0, true);
            this.f36109c0 = -1;
        }
        if (TextUtils.isEmpty(str)) {
        ...
        this.R.setImageDrawable(new org.telegram.ui.Components.sp(AndroidUtilities.dp(30.0f), AndroidUtilities.dp(3.0f), getThemedColor(org.telegram.ui.ActionBar.j6.f20827m5)));
        this.v.setText("");
        w(true);
        ...
        this.f36109c0 = ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_contacts_resolvePhone, new bc0(6, this, oj0Var));
    }
