...
public final class dl extends org.telegram.ui.Components.gk0 {
    public final int[] l1;
    public ValueAnimator f33172m1;
    public boolean f33173n1;
    public final bo f33174o1;
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        kVar = ((org.telegram.ui.ActionBar.o2) this.f33174o1).actionBar;
        ...
        if (k10 != null) {
            ...
            if (z11) {
                s(f7 - x10, !this.f33173n1);
            } else {
                s(f7 - width, !this.f33173n1);
            }
            this.f33173n1 = false;
        }
    }
    ...
    public final void s(float f7, boolean z10) {
        ValueAnimator valueAnimator = this.f33172m1;
        ...
        this.f33172m1 = ofFloat;
        ofFloat.addUpdateListener(new b3(this, 5));
        this.f33172m1.setInterpolator(org.telegram.ui.Components.qr.h);
        this.f33172m1.setDuration(420L);
        this.f33172m1.start();
    }
}
