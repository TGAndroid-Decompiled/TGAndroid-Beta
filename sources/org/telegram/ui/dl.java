...
public final class dl extends org.telegram.ui.Components.fk0 {
    public final int[] l1;
    public ValueAnimator f35839m1;
    public boolean f35840n1;
    public final co f35841o1;
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        kVar = ((org.telegram.ui.ActionBar.n2) this.f35841o1).actionBar;
        ...
        if (k10 != null) {
            ...
            if (z11) {
                s(f7 - x10, !this.f35840n1);
            } else {
                s(f7 - width, !this.f35840n1);
            }
            this.f35840n1 = false;
        }
    }
    ...
    public final void s(float f7, boolean z10) {
        ValueAnimator valueAnimator = this.f35839m1;
        ...
        this.f35839m1 = ofFloat;
        ofFloat.addUpdateListener(new c3(this, 6));
        this.f35839m1.setInterpolator(org.telegram.ui.Components.pr.h);
        this.f35839m1.setDuration(420L);
        this.f35839m1.start();
    }
}
