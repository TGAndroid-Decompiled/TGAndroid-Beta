...
public final class hl0 implements Utilities.Callback {
    ...
    public hl0(i71 i71Var, String str, boolean z10, ArrayList arrayList, HashMap hashMap, ArrayList arrayList2, LinkedHashSet linkedHashSet, LinkedHashSet linkedHashSet2, ArrayList arrayList3, ArrayList arrayList4, boolean z11) {
        ...
        this.f34299b = str;
        this.f34300c = z10;
        this.f34301f = arrayList;
        this.f34302g = hashMap;
        this.h = arrayList2;
        this.f34303i = linkedHashSet;
        this.f34304j = linkedHashSet2;
        this.f34305k = arrayList3;
        this.f34306l = arrayList4;
        this.d = z11;
    }
    ...
    public final void run(Object obj) {
        switch (this.f34298a) {
            case 0:
                final TLRPC.TL_messages_requestUrlAuth tL_messages_requestUrlAuth = (TLRPC.TL_messages_requestUrlAuth) this.f34301f;
                final org.telegram.ui.ActionBar.g3 g3Var = (org.telegram.ui.ActionBar.g3) this.f34302g;
                final boolean z10 = this.f34300c;
                final String str = this.f34299b;
                final TLRPC.UrlAuthResult urlAuthResult = (TLRPC.UrlAuthResult) this.f34303i;
                final String[] strArr = (String[]) this.f34304j;
                final boolean z11 = this.d;
                final org.telegram.ui.web.d1 d1Var = (org.telegram.ui.web.d1) this.f34305k;
                final String str2 = (String) this.h;
                final org.telegram.ui.ActionBar.f6 f6Var = (org.telegram.ui.ActionBar.f6) this.f34306l;
            ...
            default:
                ...
                final String str3 = this.f34299b;
                final boolean z12 = this.f34300c;
                final ArrayList arrayList = (ArrayList) this.f34301f;
                final HashMap hashMap = (HashMap) this.f34302g;
                final ArrayList arrayList2 = (ArrayList) this.h;
                final LinkedHashSet linkedHashSet = (LinkedHashSet) this.f34303i;
                final LinkedHashSet linkedHashSet2 = (LinkedHashSet) this.f34304j;
                final ArrayList arrayList3 = (ArrayList) this.f34305k;
                final ArrayList arrayList4 = (ArrayList) this.f34306l;
                ...
                AndroidUtilities.runOnUIThread(new Runnable() {
                    ...
                    public final void run() {
                        ...
                        String str4 = i71Var2.f34507z1;
                        String str5 = str3;
                        if (str5 != str4) {
                            return;
                        }
                        i71Var2.f34505y1 = true;
                        i71Var2.z(true, z12);
                        z51 z51Var = i71Var2.f34462f0;
                        if (z51Var != null) {
                            z51Var.d(true);
                        }
    ...
    public hl0(int[] iArr, TLRPC.TL_messages_requestUrlAuth tL_messages_requestUrlAuth, org.telegram.ui.ActionBar.g3 g3Var, boolean z10, String str, TLRPC.UrlAuthResult urlAuthResult, String[] strArr, boolean z11, org.telegram.ui.web.d1 d1Var, String str2, org.telegram.ui.ActionBar.f6 f6Var) {
        this.e = iArr;
        this.f34301f = tL_messages_requestUrlAuth;
        this.f34302g = g3Var;
        this.f34300c = z10;
        this.f34299b = str;
        this.f34303i = urlAuthResult;
        this.f34304j = strArr;
        this.d = z11;
        this.f34305k = d1Var;
        this.h = str2;
