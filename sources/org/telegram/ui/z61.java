...
public abstract class z61 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public int f40003a;
    public final t51 f40004a0;
    public float f40005a1;
    public int f40006b;
    public final ci.r6 f40007b0;
    public float f40008b1;
    public int f40009c;
    public final org.telegram.ui.Components.dw[] f40010c0;
    public final org.telegram.ui.ActionBar.n2 f40011c1;
    public int d;
    public org.telegram.ui.Components.dw f40012d0;
    public final int f40013d1;
    public int e;
    public final r51 f40014e0;
    public final x51 f40015e1;
    public int f40016f;
    public final q51 f40017f0;
    public final int f40018f1;
    public final l51 f40019g0;
    public boolean f40020g1;
    public int h;
    public final w51 f40021h0;
    public boolean f40022h1;
    public final m51 f40023i0;
    public ValueAnimator f40024i1;
    public final FrameLayout f40025j0;
    public Drawable f40026j1;
    public final ci.m6 f40027k0;
    public final PorterDuffColorFilter f40028k1;
    public final org.telegram.ui.Components.w9 f40029l0;
    public float l1;
    public final View m0;
    public int f40030m1;
    public int f40031n;
    public final org.telegram.ui.Components.ln f40032n0;
    public org.telegram.ui.Components.o5 f40033n1;
    public final View f40034o0;
    public Rect f40035o1;
    public final y51 f40036p0;
    public View f40037p1;
    public final j61 f40038q0;
    public float f40039q1;
    public int f40040r;
    public final n51 f40041r0;
    public i61 f40042r1;
    public int f40043s;
    public final org.telegram.ui.Components.pk0 f40044s0;
    public Rect f40045s1;
    public final View f40046t0;
    public final OvershootInterpolator f40047t1;
    public int f40048u0;
    public ValueAnimator f40049u1;
    public int v;
    public final ArrayList f40050v0;
    public boolean f40051v1;
    public int f40052w;
    public final SparseIntArray f40053w0;
    public boolean f40054w1;
    public int f40055x;
    public final SparseIntArray f40056x0;
    public boolean f40057x1;
    public int f40058y;
    public final SparseIntArray f40059y0;
    public boolean f40060y1;
    public final SparseIntArray f40061z0;
    public String f40062z1;
    public static final List Z1 = Arrays.asList("😖", "😫", "🫠", "😨", "❓");
    public static final boolean[] f40001b2 = new boolean[4];
    public static final HashMap f40002c2 = new HashMap();
    ...
    public static void a(z61 z61Var, int i10, int i11) {
        int i12;
        org.telegram.ui.Components.pk0 pk0Var = z61Var.f40044s0;
        n51 n51Var = z61Var.f40041r0;
        ...
        ci.m1 m1Var = new ci.m1(z61Var, z61Var.f40021h0.getContext(), 4);
        m1Var.f42777a = i10;
        m1Var.f13094p = i11;
        n51Var.w0(m1Var);
    }
    ...
    public Drawable getPremiumStar() {
        if (this.f40026j1 == null) {
            int i10 = this.W;
            if (i10 != 5 && i10 != 9 && i10 != 10 && i10 != 7) {
                this.f40026j1 = ApplicationLoader.applicationContext.getResources().getDrawable(R.drawable.msg_settings_premium).mutate();
            } else {
                this.f40026j1 = ApplicationLoader.applicationContext.getResources().getDrawable(R.drawable.msg_filled_blocked).mutate();
            }
            this.f40026j1.setColorFilter(this.f40028k1);
        }
        return this.f40026j1;
    }
    ...
    public static ArrayList j(HashSet hashSet, ArrayList arrayList) {
        ...
        while (i10 < arrayList.size()) {
            ...
            if (document == null || hashSet.contains(Long.valueOf(document.f18089id))) {
    ...
    public void setBigReactionAnimatedEmoji(org.telegram.ui.Components.q5 q5Var) {
        ...
        if (this.I && (q5Var2 = this.W0) != q5Var) {
            ...
            this.W0 = q5Var;
            if (q5Var != null) {
                q5Var.setColorFilter(this.f40028k1);
                this.W0.a(this);
            }
        }
    }
    ...
    public static void t(int i10) {
        ...
        if (!zArr[i10] && MediaDataController.getInstance(i10) != null) {
            ...
            org.telegram.ui.Components.vw0.f29407x3.fetch(i10, 1, new ai.m(i10, 1));
        }
    }

    public final void A(Long l4) {
        this.K.remove(l4);
        w51 w51Var = this.f40021h0;
        if (w51Var != null) {
            int i10 = 0;
            boolean z10 = false;
            for (int i11 = 0; i11 < w51Var.getChildCount(); i11++) {
                if (w51Var.getChildAt(i11) instanceof i61) {
                    ...
                    if (z5Var != null && z5Var.getDocumentId() == l4.longValue()) {
                        ...
                        if (document != null && document.f18089id == l4.longValue()) {
                            i61Var.f();
                        }
                    }
                    z10 = true;
            ...
            if (!z10) {
                while (true) {
                    ArrayList arrayList = this.f40050v0;
    ...
    public final void B(boolean r40, boolean r41, boolean r42) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.z61.B(boolean, boolean, boolean):void");
    }

    public final void C() {
        q51 q51Var = this.f40017f0;
        if (q51Var == null) {
            return;
        }
        if (this.f40060y1) {
        ...
        if (w51Var.getChildCount() > 0) {
            ...
            if (RecyclerView.R(childAt) == this.f40003a && "searchbox".equals(childAt.getTag())) {
                q51Var.setVisibility(0);
    ...
    public final void E(float f7) {
        ...
        View view = this.m0;
        if (view != null) {
            float interpolation = org.telegram.ui.Components.rr.f27702g.getInterpolation(w7.p.a((((f7 * 800.0f) - 0.0f) / 120.0f) / 1.0f, 0.0f, 1.0f));
        ...
        org.telegram.ui.Components.ln lnVar = this.f40032n0;
        if (lnVar != null) {
        ...
        this.f40007b0.setAlpha(a14);
        this.f40017f0.setAlpha(a14);
        int i12 = 0;
        for (int i13 = 0; i13 < this.f40012d0.f26443b.getChildCount(); i13++) {
            this.f40012d0.f26443b.getChildAt(i13).setAlpha(a14);
        }
        if (this.f40033n1 != null) {
            invalidate();
        }
        float f12 = 1.0f - a14;
        t51 t51Var = this.f40004a0;
        t51Var.setTranslationY(AndroidUtilities.dp(-5.0f) * f12);
        if (lnVar != null) {
            lnVar.setTranslationY(AndroidUtilities.dp(-5.0f) * f12);
        }
        this.f40005a1 = (interpolation2 * 0.85f) + 0.15f;
        this.f40008b1 = (interpolation3 * 0.925f) + 0.075f;
        t51Var.invalidateOutline();
        if (lnVar != null) {
            lnVar.setAlpha(a14);
        }
        r51 r51Var = this.f40014e0;
        r51Var.setAlpha(a14);
        r51Var.setScaleX(Math.min(this.f40005a1, 1.0f));
        ...
        for (int i14 = 0; i14 < this.f40012d0.f26443b.getChildCount(); i14++) {
            View childAt = this.f40012d0.f26443b.getChildAt(i14);
            if (f7 == 0.0f) {
        ...
        while (true) {
            w51 w51Var = this.f40021h0;
            if (i12 < w51Var.getChildCount()) {
                View childAt2 = w51Var.getChildAt(i12);
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        org.telegram.ui.Components.o5 o5Var = this.f40033n1;
        if (o5Var != null && (num = this.Y0) != null) {
            Rect bounds = o5Var.getBounds();
            View view = this.f40037p1;
            if (view == null) {
                scaleY = 1.0f;
            } else {
                scaleY = view.getScaleY();
            }
            int alpha = this.f40033n1.getAlpha();
            View view2 = this.f40037p1;
            if (view2 == null) {
                bounds.height();
            } else {
                view2.getHeight();
            ...
            this.f40033n1.v = (int) (Math.pow(this.f40004a0.getAlpha(), 0.25d) * alpha * this.l1);
            if (this.f40035o1 == null) {
                this.f40035o1 = new Rect();
            }
            ...
            this.f40035o1.set((int) (intValue - width), (int) (scrimDrawableTranslationY - height), (int) (intValue + width), (int) (scrimDrawableTranslationY + height));
            org.telegram.ui.Components.o5 o5Var2 = this.f40033n1;
            Rect rect = this.f40035o1;
            int i12 = rect.left;
            Rect rect2 = this.f40035o1;
            o5Var2.setBounds(i12, rect.top, (int) ((rect.width() / scaleY) + i12), (int) ((rect2.height() / scaleY) + rect2.top));
            Rect rect3 = this.f40035o1;
            canvas.scale(scaleY, scaleY, rect3.left, rect3.top);
            this.f40033n1.draw(canvas);
            org.telegram.ui.Components.o5 o5Var3 = this.f40033n1;
            o5Var3.v = alpha;
            o5Var3.setBounds(bounds);
            canvas.restore();
        }
        super.dispatchDraw(canvas);
        i61 i61Var = this.f40042r1;
        if (i61Var != null && this.f40045s1 != null && i61Var.E != null) {
            canvas.save();
            canvas.translate(0.0f, -getTranslationY());
            this.f40042r1.E.setAlpha((int) (this.f40039q1 * 255.0f));
            this.f40042r1.E.setBounds(this.f40045s1);
            this.f40042r1.E.setColorFilter(new PorterDuffColorFilter(i0.a.d(1.0f - this.l1, this.f40018f1, this.f40030m1), PorterDuff.Mode.SRC_IN));
            this.f40042r1.E.draw(canvas);
            canvas.restore();
        }
    }
    ...
    public final void h() {
        ...
        if (canScrollVertically != this.f40051v1) {
            this.f40051v1 = canScrollVertically;
            ViewPropertyAnimator animate = this.f40034o0.animate();
    ...
    public final void i(int r9, android.view.View r10) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.z61.i(int, android.view.View):void");
    }
    ...
    public final void o(android.view.View r14, org.telegram.ui.Components.z5 r15) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.z61.o(android.view.View, org.telegram.ui.Components.z5):void");
    }
    ...
    public void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (z10 && this.W == 6) {
            this.f40041r0.y1((getMeasuredWidth() / AndroidUtilities.dp(42.0f)) * 5);
        }
    }
    ...
    public final void s(p61 p61Var) {
        Integer num = this.Y1;
        if (num != null) {
            Parcelable parcelable = (Parcelable) f40002c2.get(num);
        }
        this.T1 = p61Var;
        boolean z10 = this.Q0;
        w51 w51Var = this.f40021h0;
        ...
        if (i11 != 3 && i11 != 4 && i11 != 6) {
            ...
            this.U1 = ofFloat;
            ofFloat.addUpdateListener(new b51(this, 0));
            this.U1.addListener(new wq0(this, 20));
            c51 c51Var = new c51(this, 0);
            zg.f0.f48969f = true;
            zg.f0.e = true;
            zg.f0.f48970g = false;
            if (zg.f0.d) {
            ...
            zg.f0.f48968c = c51Var;
            NotificationCenter.getGlobalInstance().lambda$postNotificationNameOnUIThread$1(NotificationCenter.stopAllHeavyOperations, 512);
            this.W1.lock();
            this.U1.setDuration(800L);
            w51Var.setLayerType(2, null);
            this.f40017f0.setLayerType(2, null);
            this.f40014e0.setLayerType(2, null);
            this.f40007b0.setLayerType(2, null);
            org.telegram.ui.Components.ln lnVar = this.f40032n0;
            if (lnVar != null) {
    ...
    public void setDrawBackground(boolean z10) {
        this.Q0 = z10;
        this.f40004a0.setClipToOutline(z10);
        ci.r6 r6Var = this.f40007b0;
        if (!z10) {
    ...
    public void setEnterAnimationInProgress(boolean z10) {
        if (this.T != z10) {
            this.T = z10;
            if (!z10) {
                AndroidUtilities.forEachViews((RecyclerView) this.f40021h0, (Utilities.Callback<View>) new ai.i(21));
                for (int i10 = 0; i10 < this.f40012d0.f26443b.getChildCount(); i10++) {
                    View childAt = this.f40012d0.f26443b.getChildAt(i10);
                    childAt.setScaleX(1.0f);
                    childAt.setScaleY(1.0f);
                }
                this.f40012d0.f26443b.invalidate();
            }
        }
    }
    ...
    public void setSelectedReactions(HashSet<zg.p0> hashSet) {
        ...
        for (int i10 = 0; i10 < arrayList.size(); i10++) {
            if (arrayList.get(i10) != null && ((zg.p0) arrayList.get(i10)).f49072g != 0) {
                hashSet2.add(Long.valueOf(((zg.p0) arrayList.get(i10)).f49072g));
            }
        }
    }
    ...
    public final void v(String str, boolean z10, boolean z11) {
        ...
        if (isEmpty) {
            ...
            if (!z12) {
                ...
                j61Var.E(false);
            } else if (!str.equals(this.f40062z1)) {
    ...
    public final void w(float f7) {
        ValueAnimator valueAnimator = this.f40024i1;
        if (valueAnimator != null) {
            valueAnimator.cancel();
            this.f40024i1 = null;
        }
        ValueAnimator ofFloat = ValueAnimator.ofFloat(this.f40046t0.getAlpha(), f7 * 0.25f);
        this.f40024i1 = ofFloat;
        ofFloat.addUpdateListener(new b51(this, 2));
        this.f40024i1.setDuration(200L);
        this.f40024i1.setInterpolator(org.telegram.ui.Components.rr.f27701f);
        this.f40024i1.start();
    }
    ...
    public final void z(boolean z10, boolean z11) {
        ...
        ValueAnimator ofFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
        this.E1 = ofFloat;
        ofFloat.addUpdateListener(new f51(this, z10, 0));
        this.E1.addListener(new s51(this, z10, 0));
        this.E1.setDuration(320L);
        this.E1.setInterpolator(org.telegram.ui.Components.rr.h);
        this.E1.start();
        ViewPropertyAnimator animate = ((View) w51Var.getParent()).animate();
        if (this.F1 && z11) {
            f7 = -AndroidUtilities.dp(36.0f);
        } else {
            f7 = 0.0f;
        }
        org.telegram.messenger.ul.r(animate.translationY(f7).setUpdateListener(new b51(this, 1)), org.telegram.ui.Components.rr.f27701f, 160L);
        if (this.F1 && z11) {
    ...
    public z61(org.telegram.ui.ActionBar.n2 n2Var, Context context, boolean z10, Integer num, int i10, boolean z11, org.telegram.ui.ActionBar.d6 d6Var, int i11) {
        this(n2Var, context, z10, num, i10, z11, d6Var, i11, org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19118v6, d6Var));
    }

    public z61(org.telegram.ui.ActionBar.n2 r41, android.content.Context r42, boolean r43, java.lang.Integer r44, int r45, boolean r46, org.telegram.ui.ActionBar.d6 r47, int r48, int r49) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.z61.<init>(org.telegram.ui.ActionBar.n2, android.content.Context, boolean, java.lang.Integer, int, boolean, org.telegram.ui.ActionBar.d6, int, int):void");
    }
