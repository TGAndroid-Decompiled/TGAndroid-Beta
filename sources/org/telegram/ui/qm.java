...
public final class qm extends org.telegram.ui.Cells.n9 {
        ...
        if (xnVar != null) {
            ...
            if (messageObject != null) {
                ...
                if (b10.f36696i != null) {
                    ...
                    xn xnVar2 = this.B0;
                    xnVar2.f40052i5 = b10;
                    xnVar2.f40076k5 = messageObject;
                    if (xnVar2.h != null) {
                        z4 = true;
                    }
                    xnVar2.f39976c5 = new MessagePreviewParams(z4, xnVar2.y9(), ChatObject.isMonoForum(this.B0.e));
                    xn xnVar3 = this.B0;
                    xnVar3.f39976c5.updateReply(xnVar3.f40076k5, xnVar3.y8(messageObject.getGroupId()), this.B0.a(), this.B0.f40052i5);
    ...
    public final boolean e() {
        ...
        if (xnVar2 == null || xnVar2.a() != 489000) {
            ...
            if (!this.f21458x0 && (xnVar = this.B0) != null && xnVar.h == null && (((u9Var2 = this.W) == null || (((org.telegram.ui.Cells.t1) u9Var2).getMessageObject() != null && ((org.telegram.ui.Cells.t1) this.W).getMessageObject().type != 23 && !((org.telegram.ui.Cells.t1) this.W).getMessageObject().isVoiceTranscriptionOpen() && !((org.telegram.ui.Cells.t1) this.W).getMessageObject().isInvoice() && ((org.telegram.ui.Cells.t1) this.W).getMessageObject().richLayout == null && !this.B0.Z8.f21456v0)) && !this.B0.getMessagesController().getTranslateController().isTranslatingDialog(this.B0.Q5) && !UserObject.isService(this.B0.Q5) && (!z4 || (chat = this.B0.e) == null || ChatObject.canWriteToChat(chat)))) {
                return true;
            }
        }
        return false;
    ...
    public final int u(int i10) {
        return org.telegram.ui.ActionBar.j6.v0(i10, this.B0.f39968ba);
    }
}
