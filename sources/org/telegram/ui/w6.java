...
public final class w6 extends s7 {
    ...
    public void e(boolean z10) {
        z6 z6Var = ((x6) this.f41777x).f42598e;
        if (z10) {
            z6.b0(z6Var, true);
    ...
    public final void onMeasure(int i10, int i11) {
        switch (this.f41776w) {
            case 0:
                ...
                return;
            default:
                super.onMeasure(i10, View.MeasureSpec.makeMeasureSpec((((kv) this.f41777x).h - org.telegram.ui.ActionBar.k.getCurrentActionBarHeight()) - AndroidUtilities.statusBarHeight, 1073741824));
                return;
        }
    }
}
