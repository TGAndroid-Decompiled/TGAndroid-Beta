    ...
    public final void onMeasure(int i10, int i11) {
        switch (this.f38897w) {
            case 0:
                ...
                return;
            default:
                super.onMeasure(i10, View.MeasureSpec.makeMeasureSpec((((fv) this.f38898x).h - org.telegram.ui.ActionBar.k.getCurrentActionBarHeight()) - AndroidUtilities.statusBarHeight, 1073741824));
                return;
        }
    }
}
