...
public final class gb1 extends org.telegram.ui.Components.h51 {
    public static final int f33809b = 0;
    public org.telegram.ui.Cells.s7 f33810a;
    ...
    public final View createView(Context context, org.telegram.ui.Components.ll0 ll0Var, int i10, int i11, org.telegram.ui.ActionBar.e6 e6Var) {
        if (this.f33810a == null) {
            this.f33810a = new org.telegram.ui.Cells.s7(context, e6Var);
        }
        org.telegram.ui.Cells.t7 t7Var = new org.telegram.ui.Cells.t7(context, this.f33810a, i10);
        t7Var.f21386w0 = true;
        t7Var.f21363d0 = true;
        return t7Var;
    }
    ...
    public final boolean equals(org.telegram.ui.Components.i51 i51Var, org.telegram.ui.Components.i51 i51Var2) {
        if (i51Var.f24905q == i51Var2.f24905q && i51Var.e == i51Var2.e && i51Var.B == i51Var2.B) {
            return true;
        }
        return false;
    }
