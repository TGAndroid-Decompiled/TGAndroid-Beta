...
public final class ej extends AnimatorListenerAdapter {
    public final int f36122a = 1;
    public final boolean f36123b;
    public int f36124c;
    public final Object d;
    public final NotificationCenter.NotificationCenterDelegate f36125e;
    ...
    public final void onAnimationEnd(Animator animator) {
        ...
        switch (this.f36122a) {
            case 0:
                ...
                return;
            default:
                int i11 = this.f36124c;
                org.telegram.ui.Components.xu0 xu0Var = (org.telegram.ui.Components.xu0) this.f36125e;
                int[] iArr = xu0Var.f32733m1;
                org.telegram.ui.Components.qt0[] qt0VarArr = xu0Var.f32730k0;
                xu0Var.f32738o1 = false;
                boolean z10 = this.f36123b;
                if (z10) {
                    int i12 = xu0Var.f32742q1;
                    iArr[i11] = i12;
                    if (i11 == 0) {
                        SharedConfig.setMediaColumnsCount(i12);
                    } else if (xu0Var.c0(((org.telegram.ui.Components.qt0) this.d).F) >= 5) {
                        SharedConfig.setStoriesColumnsCount(xu0Var.f32742q1);
                    }
                }
                for (int i13 = 0; i13 < qt0VarArr.length; i13++) {
                    ...
                    if (qt0Var != null && qt0Var.h != null && (((i10 = qt0Var.F) == 0 || org.telegram.ui.Components.xu0.p0(i10)) && (adapter = qt0VarArr[i13].h.getAdapter()) != null)) {
                        int h = adapter.h();
                        if (i13 == 0) {
                            xu0Var.f32750t1[0].g(false);
                        }
                        if (z10) {
                            qt0VarArr[i13].f29852x.y1(iArr[i11]);
                            qt0VarArr[i13].h.a0();
                            if (adapter.h() == h) {
                ...
                if (xu0Var.f32746s >= 0) {
                    for (int i14 = 0; i14 < qt0VarArr.length; i14++) {
                        ...
                        if (qt0Var2.F == xu0Var.f32740p1) {
                            if (z10 && (m10 = qt0Var2.f29850s.m(xu0Var.f32746s)) != null) {
                                xu0Var.v = m10.getTop();
                            }
                            org.telegram.ui.Components.qt0 qt0Var3 = qt0VarArr[i14];
                            qt0Var3.f29852x.h1(xu0Var.f32746s, (-qt0Var3.h.getPaddingTop()) + xu0Var.v);
                        }
                    }
                } else {
                    xu0Var.X0();
    ...
    public void onAnimationStart(Animator animator) {
        ...
        switch (this.f36122a) {
            case 0:
                ...
                i10 = ((org.telegram.ui.ActionBar.n2) ((co) this.f36125e)).currentAccount;
                this.f36124c = NotificationCenter.getInstance(i10).setAnimationInProgress(this.f36124c, null);
                return;
            default:
                super.onAnimationStart(animator);
                return;
