...
public final class ph1 extends org.telegram.ui.Components.uk0 {
    public final Context f36115c;
    public final gg.c2 f36116f;
    public Runnable h;
    public boolean f36117n;
    public final int f36119s;
    public final UsersSelectActivity v;
    public ArrayList d = new ArrayList();
    public ArrayList e = new ArrayList();
    public final ArrayList f36118r = new ArrayList();
    ...
    public ph1(UsersSelectActivity usersSelectActivity, Context context) {
        ...
        if (usersSelectActivity.F) {
            ...
            int i10 = usersSelectActivity.f31587x;
            if (i10 == 2) {
                this.f36119s = (!usersSelectActivity.H ? 1 : 0) + 5;
            } else if (i10 == 0) {
        ...
        int i11 = usersSelectActivity.f31587x;
        if (i11 != 2) {
            z10 = true;
        } else {
            z10 = false;
        ...
        for (int i12 = 0; i12 < size; i12++) {
            ...
            if (!DialogObject.isEncryptedDialog(dialog.f18087id)) {
                if (DialogObject.isUserDialog(dialog.f18087id)) {
                    TLRPC.User user = usersSelectActivity.getMessagesController().getUser(Long.valueOf(dialog.f18087id));
                    if (user != null && ((usersSelectActivity.G || !UserObject.isUserSelf(user)) && (!user.bot || z10))) {
                        this.f36118r.add(user);
                        if (UserObject.isUserSelf(user)) {
                            z12 = true;
                        }
                    }
                } else {
                    TLRPC.Chat chat = usersSelectActivity.getMessagesController().getChat(Long.valueOf(-dialog.f18087id));
                    if (z11 && chat != null) {
                        this.f36118r.add(chat);
                    }
                }
            }
        }
        if (!z12 && usersSelectActivity.G) {
            this.f36118r.add(0, usersSelectActivity.getMessagesController().getUser(Long.valueOf(usersSelectActivity.getUserConfig().clientUserId)));
        }
        gg.c2 c2Var = new gg.c2(false);
        this.f36116f = c2Var;
        c2Var.f9684p = false;
        c2Var.f9672a = new nl0(this, 25);
    }
    ...
    public final void L(String str) {
        ...
        if (str == null) {
            this.d.clear();
            this.e.clear();
            this.f36116f.f(null, null);
            this.f36116f.g(null, true, false, false, false, 0L, false, 0, 0);
            l();
            return;
        }
    ...
    public final int j(int i10) {
        ...
        if (!this.f36117n) {
            UsersSelectActivity usersSelectActivity = this.v;
            if (!usersSelectActivity.F ? !((i11 = usersSelectActivity.f31587x) != 2 ? i11 != 0 || (!usersSelectActivity.I ? !(i10 == 0 || i10 == 4) : !(i10 == 0 || i10 == 6)) : i10 != 0 && i10 != (!usersSelectActivity.H ? 1 : 0) + 4) : i10 == 0) {
                return 2;
            }
        }
        return 1;
