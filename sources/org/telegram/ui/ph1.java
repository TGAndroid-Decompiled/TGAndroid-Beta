...
public final class ph1 extends org.telegram.ui.Components.el0 {
    ...
    public final gg.c2 f36550f;
    public Runnable h;
    public boolean f36551n;
    public final int f36553s;
    public final UsersSelectActivity v;
    public ArrayList d = new ArrayList();
    public ArrayList e = new ArrayList();
    public final ArrayList f36552r = new ArrayList();
    ...
    public ph1(UsersSelectActivity usersSelectActivity, Context context) {
        ...
        if (usersSelectActivity.F) {
            ...
            int i10 = usersSelectActivity.f31902x;
            if (i10 == 2) {
                this.f36553s = (!usersSelectActivity.H ? 1 : 0) + 5;
            } else if (i10 == 0) {
        ...
        int i11 = usersSelectActivity.f31902x;
        if (i11 != 2) {
            z10 = true;
        } else {
            z10 = false;
        ...
        for (int i12 = 0; i12 < size; i12++) {
            ...
            if (!DialogObject.isEncryptedDialog(dialog.f18339id)) {
                if (DialogObject.isUserDialog(dialog.f18339id)) {
                    ...
                    if (z11 && chat != null) {
                        this.f36552r.add(chat);
                    }
                }
            }
        }
        if (!z12 && usersSelectActivity.G) {
            this.f36552r.add(0, usersSelectActivity.getMessagesController().getUser(Long.valueOf(usersSelectActivity.getUserConfig().clientUserId)));
        }
    ...
    public final void L(String str) {
        ...
        if (str == null) {
            this.d.clear();
            this.e.clear();
            this.f36550f.f(null, null);
            this.f36550f.g(null, true, false, false, false, 0L, false, 0, 0);
            l();
            return;
        }
    ...
    public final int j(int i10) {
        ...
        if (!this.f36551n) {
            UsersSelectActivity usersSelectActivity = this.v;
            if (!usersSelectActivity.F ? !((i11 = usersSelectActivity.f31902x) != 2 ? i11 != 0 || (!usersSelectActivity.I ? !(i10 == 0 || i10 == 4) : !(i10 == 0 || i10 == 6)) : i10 != 0 && i10 != (!usersSelectActivity.H ? 1 : 0) + 4) : i10 == 0) {
                return 2;
            }
        }
        return 1;
