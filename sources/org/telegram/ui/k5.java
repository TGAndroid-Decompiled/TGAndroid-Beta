...
public final class k5 implements RequestDelegate {
    ...
    public final w5 f34571b;
    public final CountDownLatch f34572c;
    public final Runnable d;

    public k5(w5 w5Var, CountDownLatch countDownLatch, Runnable runnable, int i10) {
        this.f34570a = i10;
        this.f34571b = w5Var;
        this.f34572c = countDownLatch;
        this.d = runnable;
    }
    ...
    public final void run(final TLObject tLObject, TLRPC.TL_error tL_error) {
        switch (this.f34570a) {
            case 0:
                final w5 w5Var = this.f34571b;
                final CountDownLatch countDownLatch = this.f34572c;
                        ...
                        switch (r5) {
                            case 0:
                                ...
                                if (tLObject2 != null) {
                                    ...
                                    w5Var2.f38540i0 = tL_premium_boostsList.next_offset;
                                    ...
                                    while (true) {
                                        ...
                                        if (i11 < size) {
                                            ...
                                            w5Var2.Z = Math.max(0, tL_premium_boostsList.count - i10);
                                            if (!TextUtils.isEmpty(tL_premium_boostsList.next_offset) && w5Var2.Z > 0) {
                                                z10 = true;
                                            }
                                            w5Var2.Y = z10;
                                            w5Var2.f38543l0 = tL_premium_boostsList.count;
                            ...
                            default:
                                ...
                                if (tLObject3 != null) {
                                    ...
                                    w5Var3.f38539h0 = tL_premium_boostsList2.next_offset;
                                    ...
                                    while (true) {
                                        ...
                                        if (i15 < size2) {
                                            ...
                                            w5Var3.X = Math.max(0, tL_premium_boostsList2.count - i14);
                ...
                return;
            default:
                final w5 w5Var2 = this.f34571b;
                final CountDownLatch countDownLatch2 = this.f34572c;
                        ...
                        switch (r5) {
                            case 0:
                                ...
                                if (tLObject2 != null) {
                                    ...
                                    w5Var22.f38540i0 = tL_premium_boostsList.next_offset;
                                    arrayList.addAll(tL_premium_boostsList.boosts);
                                    int size = arrayList.size();
                                    int i10 = 0;
                                    int i11 = 0;
                                    while (true) {
                                        ...
                                        if (i11 < size) {
                                            ...
                                            w5Var22.Z = Math.max(0, tL_premium_boostsList.count - i10);
                                            if (!TextUtils.isEmpty(tL_premium_boostsList.next_offset) && w5Var22.Z > 0) {
                                                z10 = true;
                                            }
                                            w5Var22.Y = z10;
                                            w5Var22.f38543l0 = tL_premium_boostsList.count;
