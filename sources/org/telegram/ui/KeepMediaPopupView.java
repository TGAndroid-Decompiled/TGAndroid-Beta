...
public class KeepMediaPopupView extends ActionBarPopupWindow.ActionBarPopupWindowLayout {
    ...
    public KeepMediaPopupView(BaseFragment baseFragment, Context context) {
        ...
        actionBarMenuSubItemAddItem.setColors(Theme.getColor(null, i, false), Theme.getColor(null, i, false));
        ...
        this.exceptionsView.setOnClickListener(new PhotoViewer$$ExternalSyntheticLambda91(6, this, baseFragment));
        for (int i2 = 0; i2 < this.checkItems.size(); i2++) {
            this.checkItems.get(i2).item.setOnClickListener(new ChatActivity$$ExternalSyntheticLambda323(this, this.checkItems.get(i2).type, 3));
        }
    ...
    public boolean lambda$new$1(final DialogsActivity dialogsActivity, DialogsActivity dialogsActivity2, ArrayList arrayList, CharSequence charSequence, boolean z, boolean z2, int i, int i2, TopicsFragment topicsFragment) {
        ...
        AndroidUtilities.runOnUIThread(new KeepMediaPopupView$$ExternalSyntheticLambda0(cacheChatsExceptionsFragment, 0, keepMediaException), 150L);
        return true;
    }
    ...
    public void lambda$new$2(BaseFragment baseFragment, View view) {
        ...
        dialogsActivity.setDelegate(new DialogsActivity$$ExternalSyntheticLambda6(this, dialogsActivity));
