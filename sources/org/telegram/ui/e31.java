...
public final class e31 implements org.telegram.ui.ActionBar.k6 {
    public boolean f35917a = false;
    public final f31 f35918b;
    ...
    public final void a(float f7) {
        ArrayList arrayList;
        f31 f31Var = this.f35918b;
        if (f7 == 0.0f && !this.f35917a) {
            ...
            if (jpVar != null && (arrayList = jpVar.d) != null) {
                ...
                while (i10 < size) {
                    ...
                    i10++;
                    ((org.telegram.ui.Components.kp) obj).f27885c = f31Var.M ? 1 : 0;
                }
            }
            if (!f31Var.Q) {
                org.telegram.ui.Components.jp jpVar2 = f31Var.f36252b;
