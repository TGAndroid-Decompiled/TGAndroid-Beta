...
public class e31 extends org.telegram.ui.ActionBar.n2 {
    ...
    public boolean P;
    public i0.b Q;
    public final o0.a f33158a;
    public final org.telegram.ui.ActionBar.d4 f33159b;
    public final Rect f33160c;
    public final a0.f d;
    public int[] e;
    public d31 f33161f;
    public org.telegram.ui.Components.lc0 h;
    public org.telegram.ui.Components.lc0 f33162n;
    public org.telegram.ui.Components.lc0 f33163r;
    public ValueAnimator f33164s;
    public ValueAnimator v;
    public s50 f33165w;
    public ci.n6 f33166x;
    public org.telegram.ui.Components.w9 f33167y;
    ...
    public e31(Bundle bundle) {
        ...
        c4Var.f18733a = org.telegram.ui.ActionBar.j6.N0("Blue");
        c4Var.e = 99;
        d4Var.f18777f.add(c4Var);
        org.telegram.ui.ActionBar.c4 c4Var2 = new org.telegram.ui.ActionBar.c4();
        c4Var2.f18733a = org.telegram.ui.ActionBar.j6.N0("Dark Blue");
        c4Var2.e = 0;
        d4Var.f18777f.add(c4Var2);
        this.f33159b = d4Var;
        this.f33160c = new Rect();
        this.d = new a0.m(0);
        this.e = null;
    ...
    public static void W(e31 e31Var, boolean z10, org.telegram.ui.ActionBar.d4 d4Var, org.telegram.ui.ActionBar.c5 c5Var) {
        o0.a aVar = e31Var.f33158a;
        if (z10) {
            aVar.f15439b = d4Var.b(((e31) aVar.f15440c).currentAccount, e31Var.K ? 1 : 0);
        } else {
            aVar.f15439b = e31Var.J.b(((e31) aVar.f15440c).currentAccount, e31Var.K ? 1 : 0);
        }
        c5Var.h = new q21(e31Var, 3);
        ((ActionBarLayout) e31Var.parentLayout).f(c5Var, null);
        LinearLayout linearLayout = e31Var.f33161f.v;
    ...
    public static void X(e31 e31Var) {
        e31Var.f33159b.n(e31Var.currentAccount);
            ...
            if (bitmap == null) {
                ...
                if (iArr != null) {
                    if (this.f33163r == null) {
                        this.f33163r = new org.telegram.ui.Components.lc0(true, 0, 0, 0, 0);
                    }
                    this.f33163r.n(iArr[0], iArr[1], iArr[2], iArr[3]);
                    this.f33163r.setBounds(AndroidUtilities.dp(6.0f), AndroidUtilities.dp(6.0f), canvas.getWidth() - AndroidUtilities.dp(6.0f), canvas.getHeight() - AndroidUtilities.dp(6.0f));
                    this.f33163r.draw(canvas);
                }
    ...
    public final void c0(List list) {
        if (list != null && !list.isEmpty() && this.f33161f != null) {
            list.set(0, this.f33159b);
            ...
            for (int i10 = 0; i10 < list.size(); i10++) {
                ...
                boolean z10 = this.K;
                lpVar.f26232c = z10 ? 1 : 0;
                lpVar.e = b0(d4Var, z10);
                arrayList.add(lpVar);
            }
            org.telegram.ui.Components.kp kpVar = this.f33161f.f32848b;
            kpVar.d = arrayList;
            kpVar.l();
            int i11 = 0;
            while (true) {
                if (i11 != arrayList.size()) {
                    if (fg.b.a(((org.telegram.ui.Components.lp) arrayList.get(i11)).f26230a.f18776c, this.J.f18776c)) {
                        this.f33161f.K = (org.telegram.ui.Components.lp) arrayList.get(i11);
                        break;
                    }
                    i11++;
                } else {
    ...
    public final void d0(int i10, org.telegram.ui.ActionBar.d4 d4Var, boolean z10) {
        ...
        this.J = d4Var;
        org.telegram.ui.ActionBar.c4 c4Var = (org.telegram.ui.ActionBar.c4) d4Var.f18777f.get(z11 ? 1 : 0);
        ValueAnimator valueAnimator = this.f33164s;
        ...
        this.f33162n = lc0Var;
        lc0Var.q(false);
        this.f33162n.setAlpha(255);
        org.telegram.ui.Components.lc0 lc0Var2 = new org.telegram.ui.Components.lc0();
        this.h = lc0Var2;
        lc0Var2.setCallback(this.f33165w);
        this.h.n(c4Var.f18740k, c4Var.f18741l, c4Var.f18742m, c4Var.f18743n);
        this.h.r(this.f33165w);
        this.h.s(1.0f);
        org.telegram.ui.Components.lc0 lc0Var3 = this.h;
        lc0Var3.N = true;
        org.telegram.ui.Components.lc0 lc0Var4 = this.f33162n;
        if (lc0Var4 != null) {
            lc0Var3.h = lc0Var4.h;
        }
        this.E.f39681a.h = lc0Var3.h;
        TLRPC.WallPaper k10 = this.J.k(z11 ? 1 : 0);
        if (k10 != null) {
            org.telegram.ui.Components.lc0 lc0Var5 = this.h;
            lc0Var5.t(lc0Var5.f26119u, k10.settings.intensity);
        ...
        if (z10) {
            ...
            this.f33164s = ofFloat;
            ofFloat.addUpdateListener(new ai.x(23, this, iArr));
            this.f33164s.addListener(new org.telegram.ui.Components.al0(12, this, iArr));
            this.f33164s.setDuration((int) (f7 * 250.0f));
            this.f33164s.start();
        } else {
            if (iArr != null) {
                y21 y21Var = this.E;
                y21Var.f39681a.n(iArr[0], iArr[1], iArr[2], iArr[3]);
                y21Var.invalidate();
                System.arraycopy(iArr, 0, this.e, 0, 4);
            }
            this.f33162n = null;
            this.f33165w.invalidate();
        }
        if (this.K) {
        ...
        c5Var.f18748f = false;
        c5Var.e = true;
        c5Var.f18754m = this.f33158a;
        c5Var.f18753l = (int) (f7 * 250.0f);
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        int i11 = 0;
        arrayList.add(new org.telegram.ui.ActionBar.l6(null, 32, null, null, new Drawable[]{d31Var.f32850f}, c31Var, i10));
        arrayList.add(new org.telegram.ui.ActionBar.l6(d31Var.f32851n, 4, null, null, null, null, org.telegram.ui.ActionBar.j6.f19169j5));
        arrayList.add(new org.telegram.ui.ActionBar.l6(d31Var.f32856y, 16, new Class[]{org.telegram.ui.Components.j21.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19151i5));
        int size = arrayList.size();
        int i12 = 0;
        while (i12 < size) {
            Object obj = arrayList.get(i12);
            i12++;
            ((org.telegram.ui.ActionBar.l6) obj).f19585o = d31Var.d.f33158a;
        }
        themeDescriptions.addAll(arrayList);
        wy0 wy0Var = new wy0(3, this);
        TextView textView = this.f33161f.f32853s;
        ...
        themeDescriptions.add(new org.telegram.ui.ActionBar.l6(this.f33161f.f32853s, 65568, null, null, null, null, org.telegram.ui.ActionBar.j6.Qh));
        TextView textView2 = this.f33161f.f32854w;
        if (textView2 != null) {
            themeDescriptions.add(new org.telegram.ui.ActionBar.l6(textView2, 4, null, null, null, wy0Var, i13));
            themeDescriptions.add(new org.telegram.ui.ActionBar.l6(this.f33161f.f32855x, 8, null, null, null, wy0Var, i13));
        }
        int size2 = themeDescriptions.size();
        while (i11 < size2) {
            org.telegram.ui.ActionBar.l6 l6Var = themeDescriptions.get(i11);
            i11++;
            l6Var.f19585o = this.f33158a;
        }
