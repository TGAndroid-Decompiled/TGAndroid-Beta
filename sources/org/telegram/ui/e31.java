...
public final class e31 implements org.telegram.ui.ActionBar.k6 {
    ...
    public final void a(float f7) {
        ArrayList arrayList;
        f31 f31Var = this.f33281b;
        if (f7 == 0.0f && !this.f33280a) {
            ...
            if (kpVar != null && (arrayList = kpVar.d) != null) {
                ...
                while (i10 < size) {
                    ...
                    i10++;
                    ((org.telegram.ui.Components.lp) obj).f25959c = f31Var.M ? 1 : 0;
                }
            }
            if (!f31Var.Q) {
                org.telegram.ui.Components.kp kpVar2 = f31Var.f33532b;
