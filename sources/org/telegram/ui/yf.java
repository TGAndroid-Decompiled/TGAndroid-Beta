    ...
    public final void e(Canvas canvas, RectF rectF) {
        ...
        switch (this.f43611a) {
            case 0:
                ...
                pm pmVar3 = pmVar;
                float f10 = xnVar.f43365vc.f50541e;
                int i10 = (int) ((1.0f - f10) * 255.0f);
                int i11 = (int) (255.0f * f10);
                if (f10 > 0.0f) {
                    canvas.drawColor(org.telegram.ui.ActionBar.k6.l1(f10 * 0.85f, xnVar.getThemedColor(org.telegram.ui.ActionBar.k6.f21661d6)));
                }
                ug.c.a(new yf(pmVar2, 1), canvas, rectF, xnVar.f43340u0, pmVar3, i10);
                ...
                if (ekVar != null && ekVar.getVisibility() == 0) {
                    int childCount = xnVar.f43256n1.getChildCount();
                    for (int i12 = 0; i12 < childCount; i12++) {
                        View childAt = xnVar.f43256n1.getChildAt(i12);
                        if ((childAt instanceof zn) && childAt.getVisibility() == 0) {
                            zn znVar = (zn) childAt;
                            yn ynVar = znVar.f43986a;
                            pm pmVar4 = ynVar.U0;
            ...
            default:
                ...
                xn xnVar3 = this.f43612b.G0;
                if (xnVar3.f43340u0.Y0()) {
                    xnVar3.f43340u0.e(canvas, rectF);
                    return;
                }
                xnVar3.f43340u0.v1(canvas, rectF);
                for (int i13 = 0; i13 < xnVar3.f43340u0.getChildCount(); i13++) {
                    View childAt2 = xnVar3.f43340u0.getChildAt(i13);
                    if (!xn.d2(xnVar3, childAt2, rectF)) {
                        if (childAt2 instanceof org.telegram.ui.Cells.t1) {
                            ...
                            canvas.restore();
                            xnVar3.f43340u0.drawChild(canvas, childAt2, uptimeMillis);
                            if (t1Var.U2()) {
                                canvas.save();
                ...
                xnVar3.f43340u0.w1(canvas, rectF);
                return;
        }
    }
