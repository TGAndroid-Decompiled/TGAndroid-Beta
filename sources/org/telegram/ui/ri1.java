...
public final class ri1 implements org.telegram.ui.Components.voip.d {
    ...
    public final void a() {
        ti1 ti1Var = this.f37123a;
        if (ti1Var.f37724p0 == 17) {
        ...
        } else if (Build.VERSION.SDK_INT >= 23 && ti1Var.f37696b.checkSelfPermission("android.permission.RECORD_AUDIO") != 0) {
            ti1Var.f37696b.requestPermissions(new String[]{"android.permission.RECORD_AUDIO"}, 101);
