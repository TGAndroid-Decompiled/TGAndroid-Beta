...
public final class kq0 extends org.telegram.ui.ActionBar.e5 {
    public final il0 f35127f = new il0(this, 11);
    public final tq0 h;
    ...
    public final void q(EditText editText) {
        ...
        if (editText.getText().length() == 0) {
            tq0 tq0Var = this.h;
            tq0Var.f38179f.clear();
            tq0Var.h.clear();
            tq0Var.v = null;
            tq0Var.f38194s = true;
            tq0Var.f38192r = false;
            if (tq0Var.f38201x != 0) {
                i10 = ((org.telegram.ui.ActionBar.m2) tq0Var).currentAccount;
                ConnectionsManager.getInstance(i10).cancelRequest(tq0Var.f38201x, true);
                tq0Var.f38201x = 0;
            }
