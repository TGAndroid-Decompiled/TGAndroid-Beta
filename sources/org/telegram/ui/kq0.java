...
public final class kq0 extends org.telegram.ui.ActionBar.e5 {
    public final il0 f35159f = new il0(this, 11);
    public final tq0 h;
    ...
    public final void q(EditText editText) {
        ...
        if (editText.getText().length() == 0) {
            tq0 tq0Var = this.h;
            tq0Var.f38195f.clear();
            tq0Var.h.clear();
            tq0Var.v = null;
            tq0Var.f38210s = true;
            tq0Var.f38208r = false;
            if (tq0Var.f38217x != 0) {
                i10 = ((org.telegram.ui.ActionBar.m2) tq0Var).currentAccount;
                ConnectionsManager.getInstance(i10).cancelRequest(tq0Var.f38217x, true);
                tq0Var.f38217x = 0;
            }
