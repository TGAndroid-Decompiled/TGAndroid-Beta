...
public final class tt implements Runnable {
    ...
    public final void run() {
        ...
        int i11 = this.f38234a;
        int i12 = 0;
        Object obj = this.f38236c;
        ...
        switch (i11) {
            case 0:
                ...
                if (wtVar.f39755f) {
                    utVar.e = arrayList;
                    if (wtVar.e && (xl0Var = wtVar.f39752a) != null) {
                        s4.h0 adapter = xl0Var.getAdapter();
                        ut utVar2 = wtVar.d;
                        if (adapter != utVar2) {
                            wtVar.f39752a.setAdapter(utVar2);
                            wtVar.f39752a.setFastScrollVisible(false);
                        }
                    }
                    utVar.l();
                    return;
            ...
            case 4:
                ...
                return;
            case 5:
                ((py) obj).f36693a.postOnAnimation(new lv((qy) obj2, 14));
                return;
            case 6:
                qy qyVar2 = (qy) obj2;
            ...
            case 9:
                ...
                qy qyVar4 = ((bx) obj2).f32505a;
                qyVar4.H2 = null;
                org.telegram.ui.Components.ar0 ar0Var = qyVar4.G2;
            ...
            case 10:
                ...
                ((px) obj2).f36690b.removeSelfFromStack();
                if (m2VarArr[1] != null) {
            ...
            case 11:
                cz czVar = (cz) obj2;
                wn wnVar = czVar.f32819a;
                org.telegram.ui.Components.gy0 gy0Var = new org.telegram.ui.Components.gy0(wnVar.getParentActivity(), czVar.f32819a, ((MessageObject) obj).getInputStickerSet(), null, wnVar.Y, wnVar.getResourceProvider());
            ...
            case 12:
                ...
                xz xzVar = wzVar.E;
                yz yzVar = xzVar.f40006c;
                Utilities.Callback callback = yzVar.f40291x;
                if (callback != null) {
                    callback.run(yzVar.d);
                }
                xzVar.f40006c.finishFragment();
                return;
            case 13:
                b10 b10Var = (b10) obj2;
                yz yzVar2 = new yz(b10Var.f32277r, ((s00) obj).f37561m);
                yzVar2.f40292y = new b00(b10Var, 1);
                yzVar2.f40291x = new b00(b10Var, 2);
            ...
            case 14:
                ...
                b10Var2.h = false;
                b10Var2.f32278s = false;
                b10Var2.f32277r.flags = b10Var2.f32281y;
                b10Var2.i0(true);
            ...
            case 16:
                ...
                MessagesController.DialogFilter dialogFilter = b10Var4.f32277r;
                if (a2Var != null) {
                    try {
                        a2Var.dismiss();
                    } catch (Exception e) {
            ...
            case 18:
                ...
                if (((TLRPC.TL_messages_toggleDialogFilterTags) obj).enabled && !filtersSetupActivity.f31092x) {
                    filtersSetupActivity.getMessagesController().loadRemoteFilters(true);
                    filtersSetupActivity.f31092x = true;
                    return;
                }
                return;
            case 19:
            ...
            case 20:
                ...
                for (int i14 = 0; i14 < arrayList6.size(); i14++) {
                    if (((org.telegram.ui.Components.voip.u) arrayList6.get(i14)).f29587w != null) {
                        arrayList5.remove(((org.telegram.ui.Components.voip.u) arrayList6.get(i14)).f29587w);
                    }
                }
            ...
            case 23:
                ((d60) ((w5) obj2).f38894b).U0.setNewColors((int[]) obj);
                return;
            case 24:
            ...
            case 25:
                ...
                l70 l70Var = k70Var.f34958a;
                l70Var.e = str;
                TLRPC.TL_messages_getStickerSet tL_messages_getStickerSet = new TLRPC.TL_messages_getStickerSet();
                TLRPC.TL_inputStickerSetShortName tL_inputStickerSetShortName = new TLRPC.TL_inputStickerSetShortName();
                tL_messages_getStickerSet.stickerset = tL_inputStickerSetShortName;
                tL_inputStickerSetShortName.short_name = str;
                l70Var.f35234c = l70Var.h.getConnectionsManager().sendRequest(tL_messages_getStickerSet, new lo(24, k70Var, str), 66);
                return;
            case 26:
                TLObject tLObject2 = (TLObject) obj;
                l70 l70Var2 = ((k70) obj2).f34958a;
                if (tLObject2 != null) {
            ...
            case 27:
                ...
                n70Var.f35757n = o70Var.getConnectionsManager().sendRequest(tL_messages_searchStickerSets, new aa(n70Var, str2, str2, 14), 66);
                return;
            case 28:
            ...
            default:
                ...
                languageSelectActivity.f31095c.l();
                return;
        }
    }
}
