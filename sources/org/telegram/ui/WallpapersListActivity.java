...
public class WallpapersListActivity extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate {
    public static final int[][] f34275k0 = {new int[]{-2368069, -9722489, -2762611, -7817084}, new int[]{-7487253, -4599318, -3755537, -1320977}, new int[]{-6832405, -5117462, -3755537, -1067044}, new int[]{-7676942, -7827988, -1859606, -9986835}, new int[]{-5190165, -6311702, -4461867, -5053475}, new int[]{-2430264, -6114049, -1258497, -4594945}, new int[]{-2298990, -7347754, -9985038, -8006011}, new int[]{-1399954, -990074, -876865, -1523602}, new int[]{-15438, -1916673, -6222, -471346}, new int[]{-2891798}, new int[]{-5913125}, new int[]{-9463352}, new int[]{-2956375}, new int[]{-5974898}, new int[]{-8537234}, new int[]{-1647186}, new int[]{-2769263}, new int[]{-3431303}, new int[]{-1326919}, new int[]{-2054243}, new int[]{-3573648}, new int[]{-1328696}, new int[]{-2056777}, new int[]{-2984557}, new int[]{-2440467}, new int[]{-2906649}, new int[]{-4880430}, new int[]{-4013331}, new int[]{-5921305}, new int[]{-8421424}, new int[]{-4005139}, new int[]{-5908761}, new int[]{-8406320}, new int[]{-2702663}, new int[]{-6518654}, new int[]{-16777216}};
    public static final int[][] f34276l0 = {new int[]{-14797481, -15394250, -14924974, -14006975}, new int[]{-14867905, -14870478, -14997181, -15460815}, new int[]{-14666695, -15720408, -14861254, -15260107}, new int[]{-14932175, -15066075, -14208965, -15000799}, new int[]{-12968902, -14411460, -13029826, -15067598}, new int[]{-13885157, -12307670, -14542561, -12899018}, new int[]{-14797481, -15196106, -14924974, -15325638}, new int[]{-15658442, -15449521, -16047308, -12897955}, new int[]{-13809610, -15258855, -13221071, -15715791}, new int[]{-14865092}, new int[]{-15656154}, new int[]{-16051170}, new int[]{-14731745}, new int[]{-15524075}, new int[]{-15853808}, new int[]{-13685209}, new int[]{-14014945}, new int[]{-15132649}, new int[]{-12374480}, new int[]{-13755362}, new int[]{-14740716}, new int[]{-12374468}, new int[]{-13755352}, new int[]{-14740709}, new int[]{-12833213}, new int[]{-14083026}, new int[]{-14872031}, new int[]{-13554109}, new int[]{-14803922}, new int[]{-15461855}, new int[]{-13680833}, new int[]{-14602960}, new int[]{-15458784}, new int[]{-14211804}, new int[]{-15132906}, new int[]{-16777216}};
    public static final int[] m0 = {-16746753, -65536, -30208, -13824, -16718798, -14702165, -9240406, -409915, -9224159, -16777216, -10725281, -1};
    public static final String[] f34277n0 = {"Blue", "Red", "Orange", "Yellow", "Green", "Teal", "Purple", "Pink", "Brown", "Black", "Gray", "White"};
    public static final int[] f34278o0 = {R.string.Blue, R.string.Red, R.string.Orange, R.string.Yellow, R.string.Green, R.string.Teal, R.string.Purple, R.string.Pink, R.string.Brown, R.string.Black, R.string.Gray, R.string.White};
    public hj1 E;
    public gj1 F;
    public hj1 G;
    ...
    public boolean Z;
    public int f34279a;
    public boolean f34280a0;
    public int f34281b;
    public final ArrayList f34282b0;
    public int f34283c;
    public final HashMap f34284c0;
    public int d;
    public final HashMap f34285d0;
    public int f34286e;
    public final ArrayList f34287e0;
    public int f34288f;
    public final ArrayList f34289f0;
    public ArrayList f34290g0;
    public int h;
    public final HashMap f34291h0;
    public final LongSparseArray f34292i0;
    public boolean f34293j0;
    public int f34294n;
    public int f34295r;
    public int f34296s;
    private int uploadImageRow;
    public final int v;
    public Paint f34297w;
    public Paint f34298x;
    public gj1 f34299y;
    ...
    public WallpapersListActivity(int i10) {
        ...
        this.R = 3;
        this.S = "";
        this.f34282b0 = new ArrayList();
        this.f34284c0 = new HashMap();
        this.f34285d0 = new HashMap();
        this.f34287e0 = new ArrayList();
        this.f34289f0 = new ArrayList();
        this.f34290g0 = new ArrayList();
        this.f34291h0 = new HashMap();
        this.f34292i0 = new LongSparseArray();
        this.v = i10;
    }

    public static void U(WallpapersListActivity wallpapersListActivity) {
        if (wallpapersListActivity.actionBar.s()) {
            wallpapersListActivity.f34292i0.clear();
    ...
    public static void V(WallpapersListActivity wallpapersListActivity, int i10) {
        if (wallpapersListActivity.getParentActivity() != null && wallpapersListActivity.H.getAdapter() != wallpapersListActivity.J) {
            if (i10 == wallpapersListActivity.uploadImageRow) {
            ...
            } else if (i10 == wallpapersListActivity.f34281b) {
                WallpapersListActivity wallpapersListActivity2 = new WallpapersListActivity(1);
                wallpapersListActivity2.f34290g0 = wallpapersListActivity.f34290g0;
                ...
                alertDialog$Builder.f20225a.R = LocaleController.getString(R.string.ResetChatBackgroundsAlertTitle);
                alertDialog$Builder.f20225a.T = LocaleController.getString(R.string.ResetChatBackgroundsAlert);
    ...
    public static void r0(WallpapersListActivity wallpapersListActivity, org.telegram.ui.Components.ij ijVar, Object obj, int i10) {
        ...
        if (wallpapersListActivity.actionBar.s()) {
            ...
            wallpapersListActivity.f34293j0 = false;
            if (longSparseArray.indexOfKey(wallPaper.f20048id) >= 0) {
                z10 = true;
            }
        ...
        if (z11) {
            ...
            str = ((gj1) gj1Var).f36724a;
        } else if (gj1Var instanceof hj1) {
            str = ((hj1) gj1Var).f37078a;
        } else {
            str = null;
        }
        if (z11) {
            ...
            if (tL_wallPaper.pattern) {
                ...
                gj1Var2.f36729g = tL_wallPaper;
                gj1Var2.f36733l = tL_wallPaper;
                gj1Var = gj1Var2;
            }
        }
        ...
        if (wallpapersListActivity.S.equals(str)) {
            boolean z12 = wallpapersListActivity.f34280a0;
        ...
        zoVar.U0 = wallpapersListActivity.f34290g0;
        if (zoVar.f41944b == 1 || (zoVar.B1 instanceof gj1)) {
            ((gj1) zoVar.B1).getClass();
        }
        zoVar.c1(0L);
        ?? obj3 = new Object();
        obj3.f21169a = true;
        zoVar.f41941a.f41925a = wallpapersListActivity.resourceProvider;
        obj3.f21171c = new q31(4);
        obj3.f21172e = true;
    ...
    public static boolean s0(WallpapersListActivity wallpapersListActivity, org.telegram.ui.Components.ij ijVar, Object obj, int i10) {
        ...
        if (i11 != 2 && i11 != 3) {
            ...
            if (!wallpapersListActivity.actionBar.s() && wallpapersListActivity.getParentActivity() != null && (obj2 instanceof TLRPC.WallPaper)) {
                ...
                wallpapersListActivity.f34292i0.put(((TLRPC.WallPaper) obj2).f20048id, obj);
    ...
    public final void A0() {
        ...
        gj1 gj1Var = this.f34299y;
        ArrayList arrayList = this.f34287e0;
        if (gj1Var != null) {
        ...
        int i16 = 0;
        while (true) {
            hashMap = this.f34284c0;
            if (i16 < size) {
                Object obj3 = arrayList.get(i16);
                if (obj3 instanceof gj1) {
                    r52 = (gj1) obj3;
                    String str3 = r52.f36724a;
                    if (str3 != null) {
                        r52.f36729g = (TLRPC.TL_wallPaper) hashMap.get(str3);
                    }
                    if (!"c".equals(r52.f36724a)) {
                        String str4 = r52.f36724a;
                        if (str4 != null && !TextUtils.equals(this.S, str4)) {
                            i16++;
                        }
                    }
                    if (this.T == r52.f36725b) {
                        int i17 = this.U;
                        if (i17 != r52.f36726c) {
                            continue;
                        } else if (this.V != r52.d) {
                            continue;
                        } else if (this.W != r52.f36727e) {
                            continue;
                        } else if (i17 == 0 || this.X == r52.f36728f) {
                            break;
                        }
                    } else {
                        continue;
        ...
        if (r52 instanceof TLRPC.WallPaper) {
            ...
            String str5 = this.S;
            if ((r52 instanceof gj1) && (wallPaper = r52.f36733l) != null) {
        ...
        try {
            Collections.sort(arrayList, new Comparator() {
                ...
                public final int compare(Object obj4, Object obj5) {
                    ArrayList arrayList2 = WallpapersListActivity.this.f34282b0;
                    if (obj4 instanceof gj1) {
                        obj4 = ((gj1) obj4).f36733l;
                    }
                    if (obj5 instanceof gj1) {
                        obj5 = ((gj1) obj5).f36733l;
                    }
        ...
        if (org.telegram.ui.ActionBar.j6.d1() && TextUtils.isEmpty(org.telegram.ui.ActionBar.j6.f20756h0)) {
            if (this.G == null) {
                ?? obj4 = new Object();
                obj4.f37078a = "t";
                obj4.f37079b = -2;
        ...
        if (!TextUtils.isEmpty(this.S) && ("d".equals(this.S) || obj != null)) {
            if (obj == null && this.T != 0 && "c".equals(this.S)) {
                ...
                if (i18 != 0 && (i13 = this.V) != 0 && (i14 = this.W) != 0) {
                    ...
                    this.f34299y = gj1Var4;
                    gj1Var4.f36728f = this.X;
                } else {
                    this.f34299y = new gj1(this.T, i18, this.S, this.X);
                }
                arrayList.add(0, this.f34299y);
            }
        } else if (!"c".equals(this.S) && (i12 = this.T) != 0) {
            if (i6Var.f20580i0 != null) {
                gj1 gj1Var5 = new gj1(this.S, i12, this.U, this.V, this.W, this.X, this.Y, this.Z, new File(ApplicationLoader.getFilesDirFixed(), i6Var.f20580i0.f20301a));
                this.f34299y = gj1Var5;
                gj1Var5.f36729g = tL_wallPaper;
            ...
            if (i19 != 0) {
                ...
                if (i20 != 0 && (i11 = this.V) != 0) {
                    ...
                    this.f34299y = gj1Var6;
                    gj1Var6.f36728f = this.X;
                } else {
                    this.f34299y = new gj1(i19, i20, this.S, this.X);
                }
                arrayList.add(0, this.f34299y);
            } else if (i6Var.f20580i0 != null && !hashMap.containsKey(this.S)) {
                hj1 hj1Var3 = new hj1(new File(ApplicationLoader.getFilesDirFixed(), i6Var.f20580i0.f20301a), new File(ApplicationLoader.getFilesDirFixed(), i6Var.f20580i0.f20302b), this.S);
                this.E = hj1Var3;
                if (this.G != null) {
                    i10 = 1;
                } else {
    ...
    public final void B0(boolean z10) {
        long j3 = 0;
        if (!z10) {
            ArrayList arrayList = this.f34282b0;
            int size = arrayList.size();
            long j10 = 0;
    ...
    public final void C0() {
        ...
        if (!arrayList.isEmpty()) {
            ...
            this.d = i11;
            this.f34279a = i11 + ceil;
        } else {
            this.d = -1;
        }
        if (i10 == 0) {
            int i12 = this.f34279a;
            this.f34288f = i12;
            this.h = i12 + 1;
            this.f34279a = i12 + 3;
            this.f34294n = i12 + 2;
    ...
    public final View createView(Context context) {
        this.f34297w = new Paint(1);
        Paint paint = new Paint(1);
        this.f34298x = paint;
        paint.setStrokeWidth(AndroidUtilities.dp(1.0f));
        this.f34298x.setStyle(Paint.Style.STROKE);
        this.f34298x.setColor(855638016);
        ...
        if (i10 == 0) {
            ...
            j3.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20964s8, false));
            org.telegram.ui.ActionBar.k kVar = this.actionBar;
            int i11 = org.telegram.ui.ActionBar.j6.f21019v8;
            kVar.C(org.telegram.ui.ActionBar.j6.w0(null, i11, false), true);
            this.actionBar.B(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20983t8, false), true);
        ...
        this.H.setGlowColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20711e8, false));
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.wallpapersDidLoad) {
            ...
            this.f34290g0.clear();
            HashMap hashMap2 = this.f34291h0;
            hashMap2.clear();
            HashMap hashMap3 = this.f34284c0;
            ArrayList arrayList3 = this.f34289f0;
            int i15 = this.v;
            HashMap hashMap4 = this.f34285d0;
            ArrayList arrayList4 = this.f34287e0;
            if (i15 != 1 && i15 != 2) {
                arrayList4.clear();
                arrayList3.clear();
                hashMap4.clear();
                ArrayList arrayList5 = this.f34282b0;
                arrayList5.clear();
                hashMap3.clear();
            ...
            while (i16 < size) {
                ...
                if ("fqv01SQemVIBAAAApND8LDRUhRU".equals(wallPaper.slug)) {
                    ...
                    if (i17 != 0) {
                        ...
                        gj1Var.f36724a = wallPaper.slug;
                        gj1Var.h = wallPaperSettings4.intensity / 100.0f;
                        gj1Var.f36728f = AndroidUtilities.getWallpaperRotation(wallPaperSettings4.rotation, false);
                        gj1Var.f36733l = wallPaper;
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.N, 4, null, null, null, null, org.telegram.ui.ActionBar.j6.f20673c7));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.N, 2048, null, null, null, null, org.telegram.ui.ActionBar.j6.f20762h6));
    ...
    public final boolean onFragmentCreate() {
        int i10 = this.v;
        if (i10 != 0 && i10 != 2) {
            z0(this.f34287e0, org.telegram.ui.ActionBar.j6.I.q());
            if (i10 == 1 && this.f34290g0.isEmpty()) {
    ...
    public final void onFragmentDestroy() {
        ...
        if (i10 != 0 && i10 != 2) {
            ...
            jj1 jj1Var = this.J;
            if (jj1Var.f37818s != 0) {
                ConnectionsManager.getInstance(jj1Var.E.currentAccount).cancelRequest(jj1Var.f37818s, true);
                jj1Var.f37818s = 0;
            }
            NotificationCenter.getGlobalInstance().removeObserver(this, NotificationCenter.wallpapersDidLoad);
    ...
    public final void onResume() {
        ...
        org.telegram.ui.ActionBar.b6 b6Var = org.telegram.ui.ActionBar.j6.I.f20580i0;
        if (b6Var != null) {
            String str2 = b6Var.f20303c;
            this.S = str2;
            if (str2 == null) {
                this.S = "";
            }
            this.T = b6Var.d;
            this.U = b6Var.f20304e;
            this.V = b6Var.f20305f;
            this.W = b6Var.f20306g;
            this.X = b6Var.h;
            this.Y = b6Var.f20309k;
            this.Z = b6Var.f20308j;
            this.f34280a0 = b6Var.f20307i;
        } else {
    ...
    public final void restoreSelfArgs(Bundle bundle) {
        this.Q.f29346a = bundle.getString("path");
    }

    @Override
    public final void saveSelfArgs(Bundle bundle) {
        String str = this.Q.f29346a;
        if (str != null) {
