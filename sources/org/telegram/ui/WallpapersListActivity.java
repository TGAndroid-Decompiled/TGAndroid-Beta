...
public class WallpapersListActivity extends org.telegram.ui.ActionBar.m2 implements NotificationCenter.NotificationCenterDelegate {
    public static final int[][] f31905k0 = {new int[]{-2368069, -9722489, -2762611, -7817084}, new int[]{-7487253, -4599318, -3755537, -1320977}, new int[]{-6832405, -5117462, -3755537, -1067044}, new int[]{-7676942, -7827988, -1859606, -9986835}, new int[]{-5190165, -6311702, -4461867, -5053475}, new int[]{-2430264, -6114049, -1258497, -4594945}, new int[]{-2298990, -7347754, -9985038, -8006011}, new int[]{-1399954, -990074, -876865, -1523602}, new int[]{-15438, -1916673, -6222, -471346}, new int[]{-2891798}, new int[]{-5913125}, new int[]{-9463352}, new int[]{-2956375}, new int[]{-5974898}, new int[]{-8537234}, new int[]{-1647186}, new int[]{-2769263}, new int[]{-3431303}, new int[]{-1326919}, new int[]{-2054243}, new int[]{-3573648}, new int[]{-1328696}, new int[]{-2056777}, new int[]{-2984557}, new int[]{-2440467}, new int[]{-2906649}, new int[]{-4880430}, new int[]{-4013331}, new int[]{-5921305}, new int[]{-8421424}, new int[]{-4005139}, new int[]{-5908761}, new int[]{-8406320}, new int[]{-2702663}, new int[]{-6518654}, new int[]{-16777216}};
    public static final int[][] f31906l0 = {new int[]{-14797481, -15394250, -14924974, -14006975}, new int[]{-14867905, -14870478, -14997181, -15460815}, new int[]{-14666695, -15720408, -14861254, -15260107}, new int[]{-14932175, -15066075, -14208965, -15000799}, new int[]{-12968902, -14411460, -13029826, -15067598}, new int[]{-13885157, -12307670, -14542561, -12899018}, new int[]{-14797481, -15196106, -14924974, -15325638}, new int[]{-15658442, -15449521, -16047308, -12897955}, new int[]{-13809610, -15258855, -13221071, -15715791}, new int[]{-14865092}, new int[]{-15656154}, new int[]{-16051170}, new int[]{-14731745}, new int[]{-15524075}, new int[]{-15853808}, new int[]{-13685209}, new int[]{-14014945}, new int[]{-15132649}, new int[]{-12374480}, new int[]{-13755362}, new int[]{-14740716}, new int[]{-12374468}, new int[]{-13755352}, new int[]{-14740709}, new int[]{-12833213}, new int[]{-14083026}, new int[]{-14872031}, new int[]{-13554109}, new int[]{-14803922}, new int[]{-15461855}, new int[]{-13680833}, new int[]{-14602960}, new int[]{-15458784}, new int[]{-14211804}, new int[]{-15132906}, new int[]{-16777216}};
    public static final int[] m0 = {-16746753, -65536, -30208, -13824, -16718798, -14702165, -9240406, -409915, -9224159, -16777216, -10725281, -1};
    public static final String[] f31907n0 = {"Blue", "Red", "Orange", "Yellow", "Green", "Teal", "Purple", "Pink", "Brown", "Black", "Gray", "White"};
    public static final int[] f31908o0 = {R.string.Blue, R.string.Red, R.string.Orange, R.string.Yellow, R.string.Green, R.string.Teal, R.string.Purple, R.string.Pink, R.string.Brown, R.string.Black, R.string.Gray, R.string.White};
    public zi1 E;
    public yi1 F;
    public zi1 G;
    ...
    public boolean Z;
    public int f31909a;
    public boolean f31910a0;
    public int f31911b;
    public final ArrayList f31912b0;
    public int f31913c;
    public final HashMap f31914c0;
    public int d;
    public final HashMap f31915d0;
    public int e;
    public final ArrayList f31916e0;
    public int f31917f;
    public final ArrayList f31918f0;
    public ArrayList f31919g0;
    public int h;
    public final HashMap f31920h0;
    public final LongSparseArray f31921i0;
    public boolean f31922j0;
    public int f31923n;
    public int f31924r;
    public int f31925s;
    private int uploadImageRow;
    public final int v;
    public Paint f31926w;
    public Paint f31927x;
    public yi1 f31928y;
    ...
    public WallpapersListActivity(int i10) {
        ...
        this.R = 3;
        this.S = "";
        this.f31912b0 = new ArrayList();
        this.f31914c0 = new HashMap();
        this.f31915d0 = new HashMap();
        this.f31916e0 = new ArrayList();
        this.f31918f0 = new ArrayList();
        this.f31919g0 = new ArrayList();
        this.f31920h0 = new HashMap();
        this.f31921i0 = new LongSparseArray();
        this.v = i10;
    }

    public static void U(WallpapersListActivity wallpapersListActivity) {
        if (wallpapersListActivity.actionBar.s()) {
            wallpapersListActivity.f31921i0.clear();
    ...
    public static void V(WallpapersListActivity wallpapersListActivity, int i10) {
        if (wallpapersListActivity.getParentActivity() != null && wallpapersListActivity.H.getAdapter() != wallpapersListActivity.J) {
            if (i10 == wallpapersListActivity.uploadImageRow) {
            ...
            } else if (i10 == wallpapersListActivity.f31911b) {
                WallpapersListActivity wallpapersListActivity2 = new WallpapersListActivity(1);
                wallpapersListActivity2.f31919g0 = wallpapersListActivity.f31919g0;
                ...
                alertDialog$Builder.f18662a.R = LocaleController.getString(R.string.ResetChatBackgroundsAlertTitle);
                alertDialog$Builder.f18662a.T = LocaleController.getString(R.string.ResetChatBackgroundsAlert);
    ...
    public static void r0(WallpapersListActivity wallpapersListActivity, org.telegram.ui.Components.jj jjVar, Object obj, int i10) {
        ...
        if (wallpapersListActivity.actionBar.s()) {
            ...
            if (longSparseArray.indexOfKey(wallPaper.f18488id) >= 0) {
                longSparseArray.remove(wallPaper.f18488id);
            } else {
                longSparseArray.put(wallPaper.f18488id, yi1Var);
            }
            ...
            wallpapersListActivity.f31922j0 = false;
            if (longSparseArray.indexOfKey(wallPaper.f18488id) >= 0) {
                z10 = true;
            }
            jjVar.c(i10, z10, true);
            return;
        }
        ...
        if (z11) {
            ...
            str = ((yi1) yi1Var).f40168a;
        } else if (yi1Var instanceof zi1) {
            str = ((zi1) yi1Var).f40515a;
        } else {
            str = null;
        }
        if (z11) {
            ...
            if (tL_wallPaper.pattern) {
                ...
                yi1Var2.f40172g = tL_wallPaper;
                yi1Var2.f40176l = tL_wallPaper;
                yi1Var = yi1Var2;
            }
        }
        org.telegram.ui.Components.bp bpVar = new org.telegram.ui.Components.bp(yi1Var, null, true, 4);
        if (wallpapersListActivity.v == 1) {
            bpVar.I1 = new ri1(wallpapersListActivity);
        }
        if (wallpapersListActivity.S.equals(str)) {
            boolean z12 = wallpapersListActivity.f31910a0;
        ...
        bpVar.U0 = wallpapersListActivity.f31919g0;
        if (bpVar.f36156b == 1 || (bpVar.B1 instanceof yi1)) {
            ((yi1) bpVar.B1).getClass();
        }
        bpVar.c1(0L);
        ?? obj3 = new Object();
        obj3.f19582a = true;
        bpVar.f36153a.f36140a = wallpapersListActivity.resourceProvider;
        obj3.f19584c = new l21(5);
        obj3.e = true;
        wallpapersListActivity.showAsSheet(bpVar, obj3);
    }
    ...
    public static boolean s0(WallpapersListActivity wallpapersListActivity, org.telegram.ui.Components.jj jjVar, Object obj, int i10) {
        ...
        if (i11 != 2 && i11 != 3) {
            ...
            if (!wallpapersListActivity.actionBar.s() && wallpapersListActivity.getParentActivity() != null && (obj2 instanceof TLRPC.WallPaper)) {
                ...
                wallpapersListActivity.f31921i0.put(((TLRPC.WallPaper) obj2).f18488id, obj);
    ...
    public final void A0() {
        ...
        yi1 yi1Var = this.f31928y;
        ArrayList arrayList = this.f31916e0;
        if (yi1Var != null) {
        ...
        int i16 = 0;
        while (true) {
            hashMap = this.f31914c0;
            if (i16 < size) {
                Object obj3 = arrayList.get(i16);
                if (obj3 instanceof yi1) {
                    r52 = (yi1) obj3;
                    String str3 = r52.f40168a;
                    if (str3 != null) {
                        r52.f40172g = (TLRPC.TL_wallPaper) hashMap.get(str3);
                    }
                    if (!"c".equals(r52.f40168a)) {
                        String str4 = r52.f40168a;
                        if (str4 != null && !TextUtils.equals(this.S, str4)) {
                            i16++;
                        }
                    }
                    if (this.T == r52.f40169b) {
                        int i17 = this.U;
                        if (i17 != r52.f40170c) {
                            continue;
                            ...
                            continue;
                        } else if (i17 == 0 || this.X == r52.f40171f) {
                            break;
                        }
                    } else {
                        continue;
        ...
        if (r52 instanceof TLRPC.WallPaper) {
            ...
            org.telegram.ui.ActionBar.z5 z5Var = org.telegram.ui.ActionBar.h6.I.f18945i0;
            ...
            obj = obj2;
            j10 = tL_wallPaper3.f18488id;
        } else {
            String str5 = this.S;
            if ((r52 instanceof yi1) && (wallPaper = r52.f40176l) != null) {
                j3 = wallPaper.f18488id;
            } else {
                j3 = 0;
            }
            str = str5;
        ...
        try {
            Collections.sort(arrayList, new Comparator() {
                ...
                public final int compare(Object obj4, Object obj5) {
                    ArrayList arrayList2 = WallpapersListActivity.this.f31912b0;
                    if (obj4 instanceof yi1) {
                        obj4 = ((yi1) obj4).f40176l;
                    }
                    if (obj5 instanceof yi1) {
                        obj5 = ((yi1) obj5).f40176l;
                    }
                    if ((obj4 instanceof TLRPC.WallPaper) && (obj5 instanceof TLRPC.WallPaper)) {
                        ...
                        long j11 = j10;
                        if (j11 != 0) {
                            if (wallPaper2.f18488id != j11) {
                                if (wallPaper3.f18488id == j11) {
                                    return 1;
                                }
                            } else {
                                return -1;
        ...
        if (org.telegram.ui.ActionBar.h6.d1() && TextUtils.isEmpty(org.telegram.ui.ActionBar.h6.f19125h0)) {
            if (this.G == null) {
                ?? obj4 = new Object();
                obj4.f40515a = "t";
                obj4.f40516b = -2;
        ...
        if (!TextUtils.isEmpty(this.S) && ("d".equals(this.S) || obj != null)) {
            if (obj == null && this.T != 0 && "c".equals(this.S)) {
                ...
                if (i18 != 0 && (i13 = this.V) != 0 && (i14 = this.W) != 0) {
                    ...
                    this.f31928y = yi1Var4;
                    yi1Var4.f40171f = this.X;
                } else {
                    this.f31928y = new yi1(this.T, i18, this.S, this.X);
                }
                arrayList.add(0, this.f31928y);
            }
        } else if (!"c".equals(this.S) && (i12 = this.T) != 0) {
            if (g6Var.f18945i0 != null) {
                yi1 yi1Var5 = new yi1(this.S, i12, this.U, this.V, this.W, this.X, this.Y, this.Z, new File(ApplicationLoader.getFilesDirFixed(), g6Var.f18945i0.f19959a));
                this.f31928y = yi1Var5;
                yi1Var5.f40172g = tL_wallPaper;
            ...
            if (i19 != 0) {
                ...
                if (i20 != 0 && (i11 = this.V) != 0) {
                    ...
                    this.f31928y = yi1Var6;
                    yi1Var6.f40171f = this.X;
                } else {
                    this.f31928y = new yi1(i19, i20, this.S, this.X);
                }
                arrayList.add(0, this.f31928y);
            } else if (g6Var.f18945i0 != null && !hashMap.containsKey(this.S)) {
                zi1 zi1Var3 = new zi1(new File(ApplicationLoader.getFilesDirFixed(), g6Var.f18945i0.f19959a), new File(ApplicationLoader.getFilesDirFixed(), g6Var.f18945i0.f19960b), this.S);
                this.E = zi1Var3;
                if (this.G != null) {
                    i10 = 1;
                } else {
    ...
    public final void B0(boolean z10) {
        long j3 = 0;
        if (!z10) {
            ArrayList arrayList = this.f31912b0;
            int size = arrayList.size();
            long j10 = 0;
            for (int i10 = 0; i10 < size; i10++) {
                Object obj = arrayList.get(i10);
                if (obj instanceof TLRPC.WallPaper) {
                    long j11 = ((TLRPC.WallPaper) obj).f18488id;
                    if (j11 >= 0) {
    ...
    public final void C0() {
        ...
        if (!arrayList.isEmpty()) {
            ...
            this.d = i11;
            this.f31909a = i11 + ceil;
        } else {
            this.d = -1;
        }
        if (i10 == 0) {
            int i12 = this.f31909a;
            this.f31917f = i12;
            this.h = i12 + 1;
            this.f31909a = i12 + 3;
            this.f31923n = i12 + 2;
    ...
    public final View createView(Context context) {
        this.f31926w = new Paint(1);
        Paint paint = new Paint(1);
        this.f31927x = paint;
        paint.setStrokeWidth(AndroidUtilities.dp(1.0f));
        this.f31927x.setStyle(Paint.Style.STROKE);
        this.f31927x.setColor(855638016);
        ...
        if (i10 == 0) {
            ...
            j3.setBackgroundColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19338s8, false));
            org.telegram.ui.ActionBar.k kVar = this.actionBar;
            int i11 = org.telegram.ui.ActionBar.h6.f19393v8;
            kVar.B(org.telegram.ui.ActionBar.h6.w0(null, i11, false), true);
            this.actionBar.A(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19357t8, false), true);
        ...
        this.H.setGlowColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19080e8, false));
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.wallpapersDidLoad) {
            ...
            this.f31919g0.clear();
            HashMap hashMap2 = this.f31920h0;
            hashMap2.clear();
            HashMap hashMap3 = this.f31914c0;
            ArrayList arrayList3 = this.f31918f0;
            int i15 = this.v;
            HashMap hashMap4 = this.f31915d0;
            ArrayList arrayList4 = this.f31916e0;
            if (i15 != 1 && i15 != 2) {
                arrayList4.clear();
                arrayList3.clear();
                hashMap4.clear();
                ArrayList arrayList5 = this.f31912b0;
                arrayList5.clear();
                hashMap3.clear();
            ...
            while (i16 < size) {
                ...
                if ("fqv01SQemVIBAAAApND8LDRUhRU".equals(wallPaper.slug)) {
                    ...
                    if (wallPaper instanceof TLRPC.TL_wallPaper) {
                        ...
                        if (!(document instanceof TLRPC.TL_documentEmpty)) {
                            if (wallPaper.pattern && document != null) {
                                i12 = i15;
                                if (!hashMap2.containsKey(Long.valueOf(document.f18342id))) {
                                    this.f31919g0.add(wallPaper);
                                    hashMap2.put(Long.valueOf(wallPaper.document.f18342id), wallPaper);
                                }
                            } else {
                                i12 = i15;
                            }
                    ...
                    if (i17 != 0) {
                        ...
                        yi1Var.f40168a = wallPaper.slug;
                        yi1Var.h = wallPaperSettings4.intensity / 100.0f;
                        yi1Var.f40171f = AndroidUtilities.getWallpaperRotation(wallPaperSettings4.rotation, false);
                        yi1Var.f40176l = wallPaper;
                        if (wallPaper.f18488id < 0) {
                            String a2 = yi1Var.a();
            ...
            if (arrayList6 != null) {
                ...
                for (int i19 = 0; i19 < size2; i19++) {
                    getMessagesStorage().deleteWallpaper(((TLRPC.WallPaper) arrayList6.get(i19)).f18488id);
                }
            }
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.H, 32768, null, null, null, null, org.telegram.ui.ActionBar.h6.f19338s8));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.H, 4096, null, null, null, null, org.telegram.ui.ActionBar.h6.f19149i6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.H, 0, new Class[]{org.telegram.ui.Cells.r8.class}, new String[]{"imageView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.f19224m6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.N, 4, null, null, null, null, org.telegram.ui.ActionBar.h6.f19043c7));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.N, 2048, null, null, null, null, org.telegram.ui.ActionBar.h6.f19131h6));
    ...
    public final boolean onFragmentCreate() {
        int i10 = this.v;
        if (i10 != 0 && i10 != 2) {
            z0(this.f31916e0, org.telegram.ui.ActionBar.h6.I.q());
            if (i10 == 1 && this.f31919g0.isEmpty()) {
    ...
    public final void onFragmentDestroy() {
        ...
        if (i10 != 0 && i10 != 2) {
            ...
            bj1 bj1Var = this.J;
            if (bj1Var.f32442s != 0) {
                ConnectionsManager.getInstance(bj1Var.E.currentAccount).cancelRequest(bj1Var.f32442s, true);
                bj1Var.f32442s = 0;
            }
            NotificationCenter.getGlobalInstance().removeObserver(this, NotificationCenter.wallpapersDidLoad);
    ...
    public final void onResume() {
        ...
        if (z5Var != null) {
            ...
            this.T = z5Var.d;
            this.U = z5Var.e;
            this.V = z5Var.f19962f;
            this.W = z5Var.f19963g;
            this.X = z5Var.h;
            this.Y = z5Var.f19966k;
            this.Z = z5Var.f19965j;
            this.f31910a0 = z5Var.f19964i;
        } else {
    ...
    public final void restoreSelfArgs(Bundle bundle) {
        this.Q.f23546a = bundle.getString("path");
    }

    @Override
    public final void saveSelfArgs(Bundle bundle) {
        String str = this.Q.f23546a;
        if (str != null) {
