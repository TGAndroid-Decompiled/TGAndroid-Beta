...
public class WallpapersListActivity extends org.telegram.ui.ActionBar.o2 implements NotificationCenter.NotificationCenterDelegate {
    public static final int[][] f31635i0 = {new int[]{-2368069, -9722489, -2762611, -7817084}, new int[]{-7487253, -4599318, -3755537, -1320977}, new int[]{-6832405, -5117462, -3755537, -1067044}, new int[]{-7676942, -7827988, -1859606, -9986835}, new int[]{-5190165, -6311702, -4461867, -5053475}, new int[]{-2430264, -6114049, -1258497, -4594945}, new int[]{-2298990, -7347754, -9985038, -8006011}, new int[]{-1399954, -990074, -876865, -1523602}, new int[]{-15438, -1916673, -6222, -471346}, new int[]{-2891798}, new int[]{-5913125}, new int[]{-9463352}, new int[]{-2956375}, new int[]{-5974898}, new int[]{-8537234}, new int[]{-1647186}, new int[]{-2769263}, new int[]{-3431303}, new int[]{-1326919}, new int[]{-2054243}, new int[]{-3573648}, new int[]{-1328696}, new int[]{-2056777}, new int[]{-2984557}, new int[]{-2440467}, new int[]{-2906649}, new int[]{-4880430}, new int[]{-4013331}, new int[]{-5921305}, new int[]{-8421424}, new int[]{-4005139}, new int[]{-5908761}, new int[]{-8406320}, new int[]{-2702663}, new int[]{-6518654}, new int[]{-16777216}};
    public static final int[][] f31636j0 = {new int[]{-14797481, -15394250, -14924974, -14006975}, new int[]{-14867905, -14870478, -14997181, -15460815}, new int[]{-14666695, -15720408, -14861254, -15260107}, new int[]{-14932175, -15066075, -14208965, -15000799}, new int[]{-12968902, -14411460, -13029826, -15067598}, new int[]{-13885157, -12307670, -14542561, -12899018}, new int[]{-14797481, -15196106, -14924974, -15325638}, new int[]{-15658442, -15449521, -16047308, -12897955}, new int[]{-13809610, -15258855, -13221071, -15715791}, new int[]{-14865092}, new int[]{-15656154}, new int[]{-16051170}, new int[]{-14731745}, new int[]{-15524075}, new int[]{-15853808}, new int[]{-13685209}, new int[]{-14014945}, new int[]{-15132649}, new int[]{-12374480}, new int[]{-13755362}, new int[]{-14740716}, new int[]{-12374468}, new int[]{-13755352}, new int[]{-14740709}, new int[]{-12833213}, new int[]{-14083026}, new int[]{-14872031}, new int[]{-13554109}, new int[]{-14803922}, new int[]{-15461855}, new int[]{-13680833}, new int[]{-14602960}, new int[]{-15458784}, new int[]{-14211804}, new int[]{-15132906}, new int[]{-16777216}};
    public static final int[] f31637k0 = {-16746753, -65536, -30208, -13824, -16718798, -14702165, -9240406, -409915, -9224159, -16777216, -10725281, -1};
    public static final String[] f31638l0 = {"Blue", "Red", "Orange", "Yellow", "Green", "Teal", "Purple", "Pink", "Brown", "Black", "Gray", "White"};
    ...
    public int f31639a;
    public final HashMap f31640a0;
    public int f31641b;
    public final HashMap f31642b0;
    public int f31643c;
    public final ArrayList f31644c0;
    public int d;
    public final ArrayList f31645d0;
    public int e;
    public ArrayList f31646e0;
    public int f31647f;
    public final HashMap f31648f0;
    public final LongSparseArray f31649g0;
    public int h;
    public boolean f31650h0;
    public int f31651n;
    public final int f31652r;
    public Paint f31653s;
    ...
    public WallpapersListActivity(int i10) {
        ...
        this.f31640a0 = new HashMap();
        this.f31642b0 = new HashMap();
        this.f31644c0 = new ArrayList();
        this.f31645d0 = new ArrayList();
        this.f31646e0 = new ArrayList();
        this.f31648f0 = new HashMap();
        this.f31649g0 = new LongSparseArray();
        this.f31652r = i10;
    }

    public static void U(WallpapersListActivity wallpapersListActivity) {
        if (wallpapersListActivity.actionBar.s()) {
            wallpapersListActivity.f31649g0.clear();
    ...
    public static void V(WallpapersListActivity wallpapersListActivity, int i10) {
        if (wallpapersListActivity.getParentActivity() != null && wallpapersListActivity.F.getAdapter() != wallpapersListActivity.H) {
            if (i10 == wallpapersListActivity.uploadImageRow) {
            ...
            } else if (i10 == wallpapersListActivity.f31641b) {
                WallpapersListActivity wallpapersListActivity2 = new WallpapersListActivity(1);
                wallpapersListActivity2.f31646e0 = wallpapersListActivity.f31646e0;
                ...
                alertDialog$Builder.f18447a.R = LocaleController.getString(R.string.ResetChatBackgroundsAlertTitle);
                alertDialog$Builder.f18447a.T = LocaleController.getString(R.string.ResetChatBackgroundsAlert);
    ...
    public static void r0(WallpapersListActivity wallpapersListActivity, org.telegram.ui.Components.ij ijVar, Object obj, int i10) {
        ...
        if (wallpapersListActivity.actionBar.s()) {
            ...
            if (longSparseArray.indexOfKey(wallPaper.f18273id) >= 0) {
                longSparseArray.remove(wallPaper.f18273id);
            } else {
                longSparseArray.put(wallPaper.f18273id, fj1Var);
            }
            ...
            wallpapersListActivity.f31650h0 = false;
            if (longSparseArray.indexOfKey(wallPaper.f18273id) >= 0) {
                z10 = true;
            }
        ...
        if (z11) {
            ...
            str = ((fj1) fj1Var).f33708a;
        } else if (fj1Var instanceof gj1) {
            str = ((gj1) fj1Var).f34006a;
        } else {
            str = null;
        }
        if (z11) {
            ...
            if (tL_wallPaper.pattern) {
                ...
                fj1Var2.f33712g = tL_wallPaper;
                fj1Var2.f33716l = tL_wallPaper;
                fj1Var = fj1Var2;
            }
        }
        org.telegram.ui.Components.ap apVar = new org.telegram.ui.Components.ap(fj1Var, null, true, 4);
        if (wallpapersListActivity.f31652r == 1) {
        ...
        apVar.U0 = wallpapersListActivity.f31646e0;
        if (apVar.f39539b == 1 || (apVar.B1 instanceof fj1)) {
            ((fj1) apVar.B1).getClass();
        }
        apVar.c1(0L);
        ?? obj3 = new Object();
        obj3.f19398a = true;
        apVar.f39536a.f39522a = wallpapersListActivity.resourceProvider;
        obj3.f19400c = new p91(3);
        obj3.e = true;
    ...
    public static boolean s0(WallpapersListActivity wallpapersListActivity, org.telegram.ui.Components.ij ijVar, Object obj, int i10) {
        ...
        int i11 = wallpapersListActivity.f31652r;
        if (i11 != 2 && i11 != 3) {
            if (obj instanceof fj1) {
                obj2 = ((fj1) obj).f33716l;
            } else {
                obj2 = obj;
            }
            if (!wallpapersListActivity.actionBar.s() && wallpapersListActivity.getParentActivity() != null && (obj2 instanceof TLRPC.WallPaper)) {
                ...
                wallpapersListActivity.f31649g0.put(((TLRPC.WallPaper) obj2).f18273id, obj);
    ...
    public final void A0() {
        ...
        Object obj2;
        int i15 = this.f31652r;
        if (i15 != 0 && i15 != 2) {
            return;
        }
        MessagesController.getGlobalMainSettings();
        fj1 fj1Var = this.f31654w;
        ArrayList arrayList = this.f31644c0;
        if (fj1Var != null) {
            arrayList.remove(fj1Var);
            this.f31654w = null;
        }
        gj1 gj1Var = this.f31655x;
        if (gj1Var != null) {
            arrayList.remove(gj1Var);
            this.f31655x = null;
        }
        fj1 fj1Var2 = this.f31656y;
        if (fj1Var2 == null) {
            fj1 fj1Var3 = new fj1("d", -2368069, -9722489, -2762611, -7817084);
            this.f31656y = fj1Var3;
            fj1Var3.h = 0.34f;
        } else {
        ...
        int i16 = 0;
        while (true) {
            hashMap = this.f31640a0;
            if (i16 < size) {
                Object obj3 = arrayList.get(i16);
                if (obj3 instanceof fj1) {
                    r52 = (fj1) obj3;
                    String str3 = r52.f33708a;
                    if (str3 != null) {
                        r52.f33712g = (TLRPC.TL_wallPaper) hashMap.get(str3);
                    }
                    if (!"c".equals(r52.f33708a)) {
                        String str4 = r52.f33708a;
                        if (str4 != null && !TextUtils.equals(this.Q, str4)) {
                            i16++;
                        }
                    }
                    if (this.R == r52.f33709b) {
                        int i17 = this.S;
                        if (i17 != r52.f33710c) {
                            continue;
                            ...
                            continue;
                        } else if (i17 == 0 || this.V == r52.f33711f) {
                            break;
                        }
                    } else {
                        continue;
        ...
        if (r52 instanceof TLRPC.WallPaper) {
            ...
            obj = obj2;
            j10 = tL_wallPaper3.f18273id;
        } else {
            String str5 = this.Q;
            if ((r52 instanceof fj1) && (wallPaper = r52.f33716l) != null) {
                j3 = wallPaper.f18273id;
            } else {
                j3 = 0;
            }
            str = str5;
            ...
            Collections.sort(arrayList, new Comparator() {
                ...
                public final int compare(Object obj4, Object obj5) {
                    ...
                    if (obj4 instanceof fj1) {
                        obj4 = ((fj1) obj4).f33716l;
                    }
                    if (obj5 instanceof fj1) {
                        obj5 = ((fj1) obj5).f33716l;
                    }
                    if ((obj4 instanceof TLRPC.WallPaper) && (obj5 instanceof TLRPC.WallPaper)) {
                        ...
                        long j11 = j10;
                        if (j11 != 0) {
                            if (wallPaper2.f18273id != j11) {
                                if (wallPaper3.f18273id == j11) {
                                    return 1;
                                }
                            } else {
                                return -1;
        ...
        if (org.telegram.ui.ActionBar.j6.d1() && TextUtils.isEmpty(org.telegram.ui.ActionBar.j6.f18929h0)) {
            if (this.E == null) {
                ?? obj4 = new Object();
                obj4.f34006a = "t";
                obj4.f34007b = -2;
        ...
        if (!TextUtils.isEmpty(this.Q) && ("d".equals(this.Q) || obj != null)) {
            if (obj == null && this.R != 0 && "c".equals(this.Q)) {
                ...
                if (i18 != 0 && (i13 = this.T) != 0 && (i14 = this.U) != 0) {
                    ...
                    this.f31654w = fj1Var4;
                    fj1Var4.f33711f = this.V;
                } else {
                    this.f31654w = new fj1(this.R, i18, this.Q, this.V);
                }
                arrayList.add(0, this.f31654w);
            }
        } else if (!"c".equals(this.Q) && (i12 = this.R) != 0) {
            if (i6Var.f18769i0 != null) {
                fj1 fj1Var5 = new fj1(this.Q, i12, this.S, this.T, this.U, this.V, this.W, this.X, new File(ApplicationLoader.getFilesDirFixed(), i6Var.f18769i0.f18538a));
                this.f31654w = fj1Var5;
                fj1Var5.f33712g = tL_wallPaper;
            ...
            if (i19 != 0) {
                ...
                if (i20 != 0 && (i11 = this.T) != 0) {
                    ...
                    this.f31654w = fj1Var6;
                    fj1Var6.f33711f = this.V;
                } else {
                    this.f31654w = new fj1(i19, i20, this.Q, this.V);
                }
                arrayList.add(0, this.f31654w);
            } else if (i6Var.f18769i0 != null && !hashMap.containsKey(this.Q)) {
                gj1 gj1Var3 = new gj1(new File(ApplicationLoader.getFilesDirFixed(), i6Var.f18769i0.f18538a), new File(ApplicationLoader.getFilesDirFixed(), i6Var.f18769i0.f18539b), this.Q);
                this.f31655x = gj1Var3;
                if (this.E != null) {
                    i10 = 1;
                } else {
                    i10 = 0;
        ...
        if (!"d".equals(this.Q) && !arrayList.isEmpty()) {
            arrayList.add(1, this.f31656y);
        } else {
            arrayList.add(0, this.f31656y);
        }
        C0();
    }
        ...
        if (!z10) {
            ...
            for (int i10 = 0; i10 < size; i10++) {
                ...
                if (obj instanceof TLRPC.WallPaper) {
                    long j11 = ((TLRPC.WallPaper) obj).f18273id;
                    if (j11 >= 0) {
    ...
    public final View createView(Context context) {
        ...
        if (i10 == 0) {
            ...
            j3.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19140s8, false));
            org.telegram.ui.ActionBar.k kVar = this.actionBar;
            int i11 = org.telegram.ui.ActionBar.j6.f19195v8;
            kVar.B(org.telegram.ui.ActionBar.j6.w0(null, i11, false), true);
            this.actionBar.A(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19159t8, false), true);
        ...
        ml0Var2.setBackgroundColor(getThemedColor(i12));
        ...
        this.F.setGlowColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18883e8, false));
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.wallpapersDidLoad) {
            ...
            this.f31646e0.clear();
            HashMap hashMap2 = this.f31648f0;
            hashMap2.clear();
            HashMap hashMap3 = this.f31640a0;
            ArrayList arrayList3 = this.f31645d0;
            int i15 = this.f31652r;
            HashMap hashMap4 = this.f31642b0;
            ArrayList arrayList4 = this.f31644c0;
            if (i15 != 1 && i15 != 2) {
                arrayList4.clear();
                arrayList3.clear();
                hashMap4.clear();
            ...
            while (i16 < size) {
                ...
                if ("fqv01SQemVIBAAAApND8LDRUhRU".equals(wallPaper.slug)) {
                    ...
                    if (wallPaper instanceof TLRPC.TL_wallPaper) {
                        ...
                        if (!(document instanceof TLRPC.TL_documentEmpty)) {
                            if (wallPaper.pattern && document != null) {
                                i12 = i15;
                                if (!hashMap2.containsKey(Long.valueOf(document.f18127id))) {
                                    this.f31646e0.add(wallPaper);
                                    hashMap2.put(Long.valueOf(wallPaper.document.f18127id), wallPaper);
                                }
                            } else {
                                i12 = i15;
                            }
                    ...
                    if (i17 != 0) {
                        ...
                        fj1Var.f33708a = wallPaper.slug;
                        fj1Var.h = wallPaperSettings4.intensity / 100.0f;
                        fj1Var.f33711f = AndroidUtilities.getWallpaperRotation(wallPaperSettings4.rotation, false);
                        fj1Var.f33716l = wallPaper;
                        if (wallPaper.f18273id < 0) {
                            String a2 = fj1Var.a();
            ...
            if (arrayList6 != null) {
                ...
                for (int i19 = 0; i19 < size2; i19++) {
                    getMessagesStorage().deleteWallpaper(((TLRPC.WallPaper) arrayList6.get(i19)).f18273id);
                }
            }
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.F, 32768, null, null, null, null, org.telegram.ui.ActionBar.j6.f19140s8));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.F, 4096, null, null, null, null, org.telegram.ui.ActionBar.j6.f18953i6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.F, 0, new Class[]{org.telegram.ui.Cells.r8.class}, new String[]{"imageView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f19028m6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.L, 4, null, null, null, null, org.telegram.ui.ActionBar.j6.f18846c7));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.L, 2048, null, null, null, null, org.telegram.ui.ActionBar.j6.f18935h6));
    ...
    public final boolean onFragmentCreate() {
        int i10 = this.f31652r;
        if (i10 != 0 && i10 != 2) {
            z0(this.f31644c0, org.telegram.ui.ActionBar.j6.I.q());
            if (i10 == 1 && this.f31646e0.isEmpty()) {
    ...
    public final void onFragmentDestroy() {
        ...
        if (i10 != 0 && i10 != 2) {
            ...
            ij1 ij1Var = this.H;
            if (ij1Var.f34615s != 0) {
                ConnectionsManager.getInstance(ij1Var.E.currentAccount).cancelRequest(ij1Var.f34615s, true);
                ij1Var.f34615s = 0;
            }
            NotificationCenter.getGlobalInstance().removeObserver(this, NotificationCenter.wallpapersDidLoad);
    ...
    public final void onResume() {
        ...
        if (c6Var != null) {
            ...
            this.R = c6Var.d;
            this.S = c6Var.e;
            this.T = c6Var.f18541f;
            this.U = c6Var.f18542g;
            this.V = c6Var.h;
            this.W = c6Var.f18545k;
            this.X = c6Var.f18544j;
            this.Y = c6Var.f18543i;
        } else {
    ...
    public final void restoreSelfArgs(Bundle bundle) {
        this.O.f27243a = bundle.getString("path");
    }

    @Override
    public final void saveSelfArgs(Bundle bundle) {
        String str = this.O.f27243a;
        if (str != null) {
