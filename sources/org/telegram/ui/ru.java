...
public final class ru extends org.telegram.ui.Components.wl0 {
    public static final int f37464p3 = 0;
    public boolean X2;
    public int Y2;
    public final s4.c0 Z2;
    public final pu f37465a3;
    public final ArrayList f37466b3;
    public final ArrayList f37467c3;
    public final float[] f37468d3;
    public final int[] f37469e3;
    public final ArrayList f37470f3;
    public qu[] f37471g3;
    public qu[] f37472h3;
    public final boolean[] f37473i3;
    public long j3;
    public long f37474k3;
    public long f37475l3;
    public boolean f37476m3;
    public ou f37477n3;
    public final vu f37478o3;
    ...
    public ru(vu vuVar, Activity activity) {
        ...
        this.X2 = false;
        this.Y2 = 0;
        this.f37466b3 = new ArrayList();
        this.f37467c3 = new ArrayList();
        this.f37468d3 = new float[7];
        this.f37469e3 = new int[7];
        this.f37470f3 = new ArrayList();
        this.f37473i3 = new boolean[7];
    ...
    public final void A1(boolean z10) {
        ...
        String format;
        CharSequence concat;
        ArrayList arrayList = this.f37466b3;
        arrayList.clear();
        ArrayList arrayList2 = this.f37467c3;
        ...
        int i14 = 0;
        while (true) {
            qu[] quVarArr = this.f37471g3;
            if (i14 >= quVarArr.length) {
                break;
            }
            qu quVar = quVarArr[i14];
            long j10 = j3;
            long j11 = quVar.f23314c;
            int i15 = quVar.d;
            if (!this.f37476m3 && !this.f37470f3.contains(Integer.valueOf(i15))) {
                z11 = false;
            } else {
                z11 = true;
            }
        ...
        if (!arrayList3.isEmpty()) {
            ...
            while (i22 < arrayList3.size()) {
                ...
                if (i23 >= 0 && !this.f37473i3[i23]) {
                    qu quVar2 = this.f37471g3[i23];
                    int[] iArr2 = vu.f38816n;
                    int i24 = quVar2.d;
                    int i25 = quVar2.f36989g;
                    int i26 = quVar2.h;
                    long j13 = quVar2.e;
                    spannableString = spannableString4;
                    spannableString2 = spannableString5;
                    long j14 = quVar2.f36988f;
                    int i27 = iArr2[i24];
                    if (i27 == 0) {
                        if (j14 > j12 || i26 > 0) {
                            i22++;
        ...
        if (!this.f37476m3) {
            ...
            arrayList2.add(new mu(-1, R.drawable.msg_filled_data_sent, -11565578, -13276952, LocaleController.getString(R.string.BytesSent), AndroidUtilities.formatFileSize(this.f37475l3)));
            arrayList2.add(new mu(-1, R.drawable.msg_filled_data_received, -11154873, -14175180, LocaleController.getString(R.string.BytesReceived), AndroidUtilities.formatFileSize(this.f37474k3)));
        }
        if (!arrayList3.isEmpty()) {
            i10 = 3;
    ...
    public final void z1() {
        ...
        this.f37474k3 = w1(6);
        this.f37475l3 = y1(6);
        if (this.f37471g3 == null) {
            this.f37471g3 = new qu[7];
        }
        if (this.f37472h3 == null) {
            this.f37472h3 = new qu[7];
        }
        int i19 = 0;
        while (true) {
            int[] iArr = vu.f38816n;
            int length = iArr.length;
            float[] fArr = this.f37468d3;
            if (i19 < length) {
                int i20 = iArr[i19];
                long w12 = w1(i20) + y1(i20);
                qu[] quVarArr = this.f37472h3;
                qu[] quVarArr2 = this.f37471g3;
                ...
                Arrays.sort(this.f37471g3, new cf(20));
                AndroidUtilities.roundPercents(fArr, this.f37469e3);
                Arrays.fill(this.f37473i3, true);
                return;
            }
        }
    }
