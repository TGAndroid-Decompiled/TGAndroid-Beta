...
public final class ru extends og.a {
    ...
    public final boolean equals(Object obj) {
        ...
        ru ruVar = (ru) obj;
        CharSequence charSequence = ruVar.f37249f;
        int i10 = ruVar.f15719a;
        int i11 = this.f15719a;
        if (i10 != i11) {
            return false;
        }
        CharSequence charSequence2 = this.f37249f;
        if (i11 != 1 && i11 != 4 && i11 != 3 && i11 != 5) {
            if (i11 != 2) {
                return true;
            }
            if (ruVar.h != this.h || !TextUtils.equals(charSequence2, charSequence) || ruVar.d != this.d || ruVar.e != this.e || ruVar.f37248c != this.f37248c) {
                return false;
            }
            return true;
        }
    ...
    public ru(int i10, int i11, int i12, int i13, CharSequence charSequence, CharSequence charSequence2) {
        ...
        this.d = i12;
        this.e = i13;
        this.f37249f = charSequence;
        this.f37250g = charSequence2;
    }
}
