...
public final class wv0 implements org.telegram.ui.Components.ky {
    ...
    public final boolean k() {
        EditTextBoldCursor editField = this.f39183a.f32937b0.getEditField();
        if (editField == null) {
            return false;
        }
    ...
    public final void x(long j3, TLRPC.Document document, String str, boolean z10) {
        ...
        cw0 cw0Var = this.f39183a;
        EditTextBoldCursor editField = cw0Var.f32937b0.getEditField();
        if (editField == null) {
            return;
        }
        int selectionEnd = editField.getSelectionEnd();
        ...
        try {
            ...
            x5Var.cacheType = cw0Var.R.f25714c;
