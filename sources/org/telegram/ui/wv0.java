...
public final class wv0 implements View.OnClickListener {
    public final zh0 f39768a;
    public final wn f39769b;
    public final org.telegram.ui.Components.wl0 f39770c;
    public final LinearLayout d;
    public final org.telegram.ui.Components.y70 e;
    public final org.telegram.ui.Components.y70 f39771f;
    public final dw0 h;
    ...
    public final void onClick(View view) {
        ...
        if (!arrayList2.isEmpty()) {
            ...
            if (SharedConfig.messageSeenHintCount > 0 && wnVar.X0.getKeyboardHeight() < AndroidUtilities.dp(20.0f)) {
                org.telegram.ui.Components.qc t10 = new org.telegram.ui.Components.xc(org.telegram.ui.Components.lb.a(dw0Var.getContext()), dw0Var.f33205b).t(AndroidUtilities.replaceTags(LocaleController.getString(R.string.MessageSeenTooltipMessage)), null);
                wnVar.f39571n1 = t10;
                t10.f27578j = 4000;
                t10.j();
                SharedConfig.updateMessageSeenHintCount(SharedConfig.messageSeenHintCount - 1);
            }
            org.telegram.ui.Components.wl0 wl0Var = this.f39770c;
            wl0Var.requestLayout();
            this.d.requestLayout();
            wl0Var.getAdapter().l();
            this.e.K(this.f39771f);
        }
    }
}
