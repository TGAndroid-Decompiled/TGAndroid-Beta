...
public abstract class i71 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public int f34448a;
    public final c61 f34449a0;
    public float f34450a1;
    public int f34451b;
    public final ci.s6 f34452b0;
    public float f34453b1;
    public int f34454c;
    public final org.telegram.ui.Components.cw[] f34455c0;
    public final org.telegram.ui.ActionBar.o2 f34456c1;
    public int d;
    public org.telegram.ui.Components.cw f34457d0;
    public final int f34458d1;
    public int e;
    public final a61 f34459e0;
    public final g61 f34460e1;
    public int f34461f;
    public final z51 f34462f0;
    public final int f34463f1;
    public final t41 f34464g0;
    public boolean f34465g1;
    public int h;
    public final f61 f34466h0;
    public boolean f34467h1;
    public final v51 f34468i0;
    public ValueAnimator f34469i1;
    public final FrameLayout f34470j0;
    public Drawable f34471j1;
    public final ci.n6 f34472k0;
    public final PorterDuffColorFilter f34473k1;
    public final org.telegram.ui.Components.u9 f34474l0;
    public float l1;
    public final View m0;
    public int f34475m1;
    public int f34476n;
    public final org.telegram.ui.Components.kn f34477n0;
    public org.telegram.ui.Components.m5 f34478n1;
    public final View f34479o0;
    public Rect f34480o1;
    public final h61 f34481p0;
    public View f34482p1;
    public final s61 f34483q0;
    public float f34484q1;
    public int f34485r;
    public final w51 f34486r0;
    public r61 f34487r1;
    public int f34488s;
    public final org.telegram.ui.Components.pk0 f34489s0;
    public Rect f34490s1;
    public final View f34491t0;
    public final OvershootInterpolator f34492t1;
    public int f34493u0;
    public ValueAnimator f34494u1;
    public int v;
    public final ArrayList f34495v0;
    public boolean f34496v1;
    public int f34497w;
    public final SparseIntArray f34498w0;
    public boolean f34499w1;
    public int f34500x;
    public final SparseIntArray f34501x0;
    public boolean f34502x1;
    public int f34503y;
    public final SparseIntArray f34504y0;
    public boolean f34505y1;
    public final SparseIntArray f34506z0;
    public String f34507z1;
    public static final List Z1 = Arrays.asList("😖", "😫", "🫠", "😨", "❓");
    public static final boolean[] f34446b2 = new boolean[4];
    public static final HashMap f34447c2 = new HashMap();
    ...
    public static void a(i71 i71Var, int i10, int i11) {
        int i12;
        org.telegram.ui.Components.pk0 pk0Var = i71Var.f34489s0;
        w51 w51Var = i71Var.f34486r0;
        ...
        ci.m1 m1Var = new ci.m1(i71Var, i71Var.f34466h0.getContext(), 4);
        m1Var.f42852a = i10;
        m1Var.f13105p = i11;
        w51Var.w0(m1Var);
    }
    ...
    public Drawable getPremiumStar() {
        if (this.f34471j1 == null) {
            int i10 = this.W;
            if (i10 != 5 && i10 != 9 && i10 != 10 && i10 != 7) {
                this.f34471j1 = ApplicationLoader.applicationContext.getResources().getDrawable(R.drawable.msg_settings_premium).mutate();
            } else {
                this.f34471j1 = ApplicationLoader.applicationContext.getResources().getDrawable(R.drawable.msg_filled_blocked).mutate();
            }
            this.f34471j1.setColorFilter(this.f34473k1);
        }
        return this.f34471j1;
    }
    ...
    public void setBigReactionAnimatedEmoji(org.telegram.ui.Components.o5 o5Var) {
        ...
        if (this.I && (o5Var2 = this.W0) != o5Var) {
            ...
            this.W0 = o5Var;
            if (o5Var != null) {
                o5Var.setColorFilter(this.f34473k1);
                this.W0.a(this);
            }
        }
    }
    ...
    public static void t(final int i10) {
        ...
        if (!zArr[i10] && MediaDataController.getInstance(i10) != null) {
            ...
            org.telegram.ui.Components.xw0.f30003x3.fetch(i10, 1, new Utilities.Callback() {
                @Override
    ...
    public final void A(Long l4) {
        ...
        if (f61Var != null) {
            ...
            if (!z10) {
                while (true) {
                    ArrayList arrayList = this.f34495v0;
    ...
    public final void C() {
        ...
        if (f61Var.getChildCount() > 0) {
            ...
            if (RecyclerView.S(childAt) == this.f34448a && "searchbox".equals(childAt.getTag())) {
                z51Var.setVisibility(0);
    ...
    public final void E(float f7) {
        ...
        View view = this.m0;
        if (view != null) {
            float interpolation = org.telegram.ui.Components.qr.f27384g.getInterpolation(w7.p.a((((f7 * 800.0f) - 0.0f) / 120.0f) / 1.0f, 0.0f, 1.0f));
        ...
        org.telegram.ui.Components.kn knVar = this.f34477n0;
        if (knVar != null) {
        ...
        this.f34452b0.setAlpha(a14);
        this.f34462f0.setAlpha(a14);
        int i12 = 0;
        for (int i13 = 0; i13 < this.f34457d0.f26505b.getChildCount(); i13++) {
            this.f34457d0.f26505b.getChildAt(i13).setAlpha(a14);
        }
        if (this.f34478n1 != null) {
            invalidate();
        }
        float f12 = 1.0f - a14;
        c61 c61Var = this.f34449a0;
        c61Var.setTranslationY(AndroidUtilities.dp(-5.0f) * f12);
        if (knVar != null) {
            knVar.setTranslationY(AndroidUtilities.dp(-5.0f) * f12);
        }
        this.f34450a1 = (interpolation2 * 0.85f) + 0.15f;
        this.f34453b1 = (interpolation3 * 0.925f) + 0.075f;
        c61Var.invalidateOutline();
        if (knVar != null) {
            knVar.setAlpha(a14);
        }
        a61 a61Var = this.f34459e0;
        a61Var.setAlpha(a14);
        a61Var.setScaleX(Math.min(this.f34450a1, 1.0f));
        ...
        for (int i14 = 0; i14 < this.f34457d0.f26505b.getChildCount(); i14++) {
            View childAt = this.f34457d0.f26505b.getChildAt(i14);
            if (f7 == 0.0f) {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        org.telegram.ui.Components.m5 m5Var = this.f34478n1;
        if (m5Var != null && (num = this.Y0) != null) {
            Rect bounds = m5Var.getBounds();
            View view = this.f34482p1;
            if (view == null) {
                scaleY = 1.0f;
            } else {
                scaleY = view.getScaleY();
            }
            int alpha = this.f34478n1.getAlpha();
            View view2 = this.f34482p1;
            if (view2 == null) {
                bounds.height();
            } else {
                view2.getHeight();
            ...
            this.f34478n1.v = (int) (Math.pow(this.f34449a0.getAlpha(), 0.25d) * alpha * this.l1);
            if (this.f34480o1 == null) {
                this.f34480o1 = new Rect();
            }
            ...
            this.f34480o1.set((int) (intValue - width), (int) (scrimDrawableTranslationY - height), (int) (intValue + width), (int) (scrimDrawableTranslationY + height));
            org.telegram.ui.Components.m5 m5Var2 = this.f34478n1;
            Rect rect = this.f34480o1;
            int i12 = rect.left;
            Rect rect2 = this.f34480o1;
            m5Var2.setBounds(i12, rect.top, (int) ((rect.width() / scaleY) + i12), (int) ((rect2.height() / scaleY) + rect2.top));
            Rect rect3 = this.f34480o1;
            canvas.scale(scaleY, scaleY, rect3.left, rect3.top);
            this.f34478n1.draw(canvas);
            org.telegram.ui.Components.m5 m5Var3 = this.f34478n1;
            m5Var3.v = alpha;
            m5Var3.setBounds(bounds);
            canvas.restore();
        }
        super.dispatchDraw(canvas);
        r61 r61Var = this.f34487r1;
        if (r61Var != null && this.f34490s1 != null && r61Var.E != null) {
            canvas.save();
            canvas.translate(0.0f, -getTranslationY());
            this.f34487r1.E.setAlpha((int) (this.f34484q1 * 255.0f));
            this.f34487r1.E.setBounds(this.f34490s1);
            this.f34487r1.E.setColorFilter(new PorterDuffColorFilter(i0.a.d(1.0f - this.l1, this.f34463f1, this.f34475m1), PorterDuff.Mode.SRC_IN));
            this.f34487r1.E.draw(canvas);
            canvas.restore();
        }
    }
    ...
    public final void h() {
        ...
        if (canScrollVertically != this.f34496v1) {
            this.f34496v1 = canScrollVertically;
            ViewPropertyAnimator animate = this.f34479o0.animate();
    ...
    public void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (z10 && this.W == 6) {
            this.f34486r0.y1((getMeasuredWidth() / AndroidUtilities.dp(42.0f)) * 5);
        }
    }
    ...
    public final void s(y61 y61Var) {
        Integer num = this.Y1;
        if (num != null) {
            Parcelable parcelable = (Parcelable) f34447c2.get(num);
        }
        this.T1 = y61Var;
        boolean z10 = this.Q0;
        f61 f61Var = this.f34466h0;
        ...
        if (i11 != 3 && i11 != 4 && i11 != 6) {
            ...
            zg.f0.f49052c = m51Var;
            NotificationCenter.getGlobalInstance().lambda$postNotificationNameOnUIThread$1(NotificationCenter.stopAllHeavyOperations, 512);
            this.W1.lock();
            this.U1.setDuration(800L);
            f61Var.setLayerType(2, null);
            this.f34462f0.setLayerType(2, null);
            this.f34459e0.setLayerType(2, null);
            this.f34452b0.setLayerType(2, null);
            org.telegram.ui.Components.kn knVar = this.f34477n0;
            if (knVar != null) {
    ...
    public void setDrawBackground(boolean z10) {
        this.Q0 = z10;
        this.f34449a0.setClipToOutline(z10);
        ci.s6 s6Var = this.f34452b0;
        if (!z10) {
    ...
    public void setEnterAnimationInProgress(boolean z10) {
        if (this.T != z10) {
            this.T = z10;
            if (!z10) {
                AndroidUtilities.forEachViews((RecyclerView) this.f34466h0, (e2.h) new ai.i(29));
                for (int i10 = 0; i10 < this.f34457d0.f26505b.getChildCount(); i10++) {
                    View childAt = this.f34457d0.f26505b.getChildAt(i10);
                    childAt.setScaleX(1.0f);
                    childAt.setScaleY(1.0f);
                }
                this.f34457d0.f26505b.invalidate();
            }
        }
    }
    ...
    public void setSelectedReactions(HashSet<zg.p0> hashSet) {
        ...
        for (int i10 = 0; i10 < arrayList.size(); i10++) {
            if (arrayList.get(i10) != null && ((zg.p0) arrayList.get(i10)).f49156g != 0) {
                hashSet2.add(Long.valueOf(((zg.p0) arrayList.get(i10)).f49156g));
            }
        }
    }
    ...
    public final void v(String str, boolean z10, boolean z11) {
        ...
        if (isEmpty) {
            ...
            if (!z12) {
                ...
                s61Var.E(false);
            } else if (!str.equals(this.f34507z1)) {
    ...
    public final void w(float f7) {
        ValueAnimator valueAnimator = this.f34469i1;
        if (valueAnimator != null) {
            valueAnimator.cancel();
            this.f34469i1 = null;
        }
        ValueAnimator ofFloat = ValueAnimator.ofFloat(this.f34491t0.getAlpha(), f7 * 0.25f);
        this.f34469i1 = ofFloat;
        ofFloat.addUpdateListener(new l51(this, 2));
        this.f34469i1.setDuration(200L);
        this.f34469i1.setInterpolator(org.telegram.ui.Components.qr.f27383f);
        this.f34469i1.start();
    }
    ...
    public final void z(boolean z10, boolean z11) {
        ...
        org.telegram.messenger.wl.q(animate.translationY(f7).setUpdateListener(new l51(this, 1)), org.telegram.ui.Components.qr.f27383f, 160L);
        if (this.F1 && z11) {
    ...
    public i71(org.telegram.ui.ActionBar.o2 o2Var, Context context, boolean z10, Integer num, int i10, boolean z11, org.telegram.ui.ActionBar.f6 f6Var, int i11) {
        this(o2Var, context, z10, num, i10, z11, f6Var, i11, org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19193v6, f6Var));
    }
