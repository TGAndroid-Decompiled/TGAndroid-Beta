...
public final class h9 extends FrameLayout {
    ...
    public h9(k9 k9Var, Context context, org.telegram.ui.Components.t00 t00Var) {
        ...
        textView2.setTextColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18817c7, false));
    ...
    public final void a() {
        ...
        this.f34201a.animate().alpha(0.0f).setDuration(150L).start();
        this.f34202b.animate().alpha(0.0f).setDuration(150L).start();
        this.f34203c.animate().alpha(1.0f).setDuration(150L).start();
    }

    public final void b() {
        org.telegram.ui.Components.aj0 aj0Var = this.d;
        aj0Var.animate().alpha(1.0f).setDuration(150L).start();
        this.f34201a.animate().alpha(1.0f).setDuration(150L).start();
        this.f34202b.animate().alpha(1.0f).setDuration(150L).start();
        this.f34203c.animate().alpha(0.0f).setDuration(150L).start();
        aj0Var.d();
    }
