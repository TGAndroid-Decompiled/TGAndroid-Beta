...
public final class h9 extends FrameLayout {
    ...
    public final org.telegram.ui.Components.i9 f34213b;
    ...
    public h9(Context context, int i10) {
        ...
        h6Var.f20194b0 = AndroidUtilities.dp(f7);
        h6Var.f20195c0 = -AndroidUtilities.dp(7.0f);
        ...
        if (checkBoxBase.f21988x != w02) {
            checkBoxBase.f21988x = w02;
            checkBoxBase.b();
        }
