...
public final class ca implements RequestDelegate {
    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        int i11 = 0;
        Object obj = this.d;
        Object obj2 = this.f32708c;
        Object obj3 = this.f32707b;
        switch (i10) {
            case 0:
            ...
            case 4:
                ...
                boVar.f32262d5.messageOwner.voiceTranscriptionRated = true;
                boVar.getMessagesStorage().updateMessageVoiceTranscriptionOpen(boVar.f32262d5.getDialogId(), boVar.f32262d5.getId(), boVar.f32262d5.messageOwner);
            ...
            case 25:
                ...
                if (tLObject instanceof TL_stats.TL_statsGraph) {
                    try {
                        bVar = ab1.e0(new JSONObject(((TL_stats.TL_statsGraph) tLObject).json.data), ij0Var.f35183r.f35751i, false);
