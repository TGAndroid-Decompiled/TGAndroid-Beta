...
public final class qp extends LinearLayout implements NotificationCenter.NotificationCenterDelegate {
    public org.telegram.ui.Components.x9 f39957a;
    public org.telegram.ui.Components.j90 f39958b;
    public int f39959c;

    public final void a() {
        boolean z10;
        org.telegram.ui.Components.x9 x9Var = this.f39957a;
        ...
        if (tL_messages_stickerSet != null && tL_messages_stickerSet.documents.size() >= 3) {
            x9Var.i(ImageLocation.getForDocument(tL_messages_stickerSet.documents.get(2)), "104_104", "tgs", this.f39958b, tL_messages_stickerSet);
            return;
        }
        ...
        x9Var.setImageDrawable(this.f39958b);
    }
    ...
    public final void onAttachedToWindow() {
        ...
        a();
        NotificationCenter.getInstance(this.f39959c).addObserver(this, NotificationCenter.diceStickersDidLoad);
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        NotificationCenter.getInstance(this.f39959c).removeObserver(this, NotificationCenter.diceStickersDidLoad);
    }
}
