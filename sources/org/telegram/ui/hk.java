...
public final class hk implements st {
    ...
    @Override
    public final long a() {
        return this.f34288a.T5;
    }

    @Override
    public final boolean b() {
        return this.f34288a.D6();
    }

    @Override
    public final boolean c() {
        if (this.f34288a.R3 == 1) {
            return true;
        }
        return false;
    }
    ...
    public final void m(TLRPC.Document document, String str, Object obj, boolean z10, int i10, int i11) {
        this.f34288a.Y.d(document, str, obj, null, true, z10, i10, i11);
    }
