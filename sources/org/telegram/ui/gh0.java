...
public final class gh0 extends org.telegram.ui.Components.g6 {
    ...
    public final le.b Q;
    public final me.b R;
    public final org.telegram.ui.ActionBar.f6 f36702s;
    public int v;
    public float[] f36703w;
    public float[] f36704x;
    public int[] f36705y;
    ...
    public void setSkipDrawSelector(boolean z10) {
        this.I = z10;
        if (z10) {
            this.J.setColor(org.telegram.ui.ActionBar.j6.l1(0.09f, org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.al, this.f36702s)));
        }
    ...
    public final void o() {
        ...
        for (int i10 = 0; i10 < entriesCount; i10++) {
            le.g n10 = this.f26288c.n(i10);
            ((ph.b) ((org.telegram.ui.Components.f6) n10.f15406a).f25953a).setVisualWidth(n10.b().width());
        }
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        while (true) {
            ...
            if (i15 < 3) {
                if (fArr[i15] != f12) {
                    int childCount = getChildCount();
                    float[] fArr2 = this.f36703w;
                    if (fArr2 == null || fArr2.length < childCount) {
                        this.f36703w = new float[childCount];
                        this.f36704x = new float[childCount];
                        this.f36705y = new int[childCount];
                    ...
                    for (int i17 = 0; i17 < childCount; i17++) {
                        ...
                        if (!d(childAt)) {
                            ...
                            if (childAt instanceof fh0) {
                                ...
                                f11 = bVar.T.measureText(bVar.f44113a.getText().toString());
                            } else {
                                f11 = 0.0f;
                            }
                            this.f36703w[i17] = f11;
        ...
        for (int i21 = 0; i21 < childCount4; i21++) {
            if (!d(getChildAt(i21))) {
                float[] fArr3 = this.f36703w;
                this.f36704x[i21] = f7;
                fArr3[i21] = f7;
                this.f36705y[i21] = i12;
            } else {
                float[] fArr4 = this.f36704x;
                float f17 = this.f36703w[i21] + dp2;
                fArr4[i21] = f17;
                int[] iArr2 = this.f36705y;
                if (f17 > max + dp2) {
                    i13 = 0;
                } else {
                    i13 = 1;
        ...
        if (i20 == 0) {
            ...
            for (int i22 = 0; i22 < childCount5; i22++) {
                this.f36705y[i22] = d(getChildAt(i22)) ? 1 : 0;
            }
            i20 = this.G;
        }
        ...
        if (f16 > f18) {
            ...
            if (f16 < f20) {
                ...
                for (int i24 = 0; i24 < childCount7; i24++) {
                    float[] fArr6 = this.f36704x;
                    fArr6[i24] = (this.f36705y[i24] * f21) + fArr6[i24];
                }
            }
        }
        ...
        for (int i26 = 0; i26 < childCount8; i26++) {
            if (d(getChildAt(i26))) {
                this.E[i26] = Math.round(this.f36704x[i26]);
                this.F[i26] = i25;
                i25 += this.E[i26];
            }
        }
