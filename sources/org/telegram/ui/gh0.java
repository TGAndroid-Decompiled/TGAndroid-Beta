...
public final class gh0 extends org.telegram.ui.Components.e6 {
    ...
    public final le.b Q;
    public final me.b R;
    public final org.telegram.ui.ActionBar.e6 f33855s;
    public int v;
    public float[] f33856w;
    public float[] f33857x;
    public int[] f33858y;
    ...
    public gh0(Context context, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        new ArrayList();
        new ArrayList();
        o1.c cVar = o1.h.f15337s;
        o1.c cVar2 = o1.h.f15336r;
        o1.c cVar3 = o1.h.f15333o;
        o1.c cVar4 = o1.h.f15335q;
        new o1.l(1.0f);
        new ArrayList();
        new ArrayList();
        o1.c cVar5 = o1.h.f15334p;
        new o1.l(1.0f);
        o1.k kVar = new o1.k(this, new org.telegram.ui.Components.ob(1));
        this.K = kVar;
        o1.k kVar2 = new o1.k(this, new org.telegram.ui.Components.ob(2));
        this.L = kVar2;
        kVar.f15349u = org.telegram.ui.Cells.q3.l(1.0f, 1500.0f, 0.75f);
    ...
    public static void m(gh0 gh0Var, float f7, boolean z10, boolean z11) {
        ...
        if (z10) {
            ...
            while (true) {
                ...
                if (childAt3.getVisibility() == 0 && (childAt3 instanceof oh.b) && ((oh.b) childAt3).h.f13973f) {
                    view2 = childAt3;
                    break;
                }
                i12++;
            ...
            if (view2 != null) {
                ...
                if (kVar2.f15342f) {
                    ...
                    if (kVar2.f15349u == null) {
                        kVar2.f15349u = new o1.l(0.0f);
                    }
                    kVar2.f15349u.f15355i = 0.0f;
                    kVar2.f();
                }
        ...
        if (view != null) {
            ...
            if (z11) {
                ...
                if (0.0f != width3 || 0.0f != x10) {
                    ...
                    if (kVar.f15349u == null) {
                        kVar.f15349u = new o1.l(x10);
                    }
                    kVar.f15349u.f15355i = x10;
                    kVar.f();
                }
            }
        }
    ...
    public void setSkipDrawSelector(boolean z10) {
        this.I = z10;
        if (z10) {
            this.J.setColor(org.telegram.ui.ActionBar.i6.l1(0.09f, org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.al, this.f33855s)));
        }
    ...
    public final void o() {
        ...
        for (int i10 = 0; i10 < entriesCount; i10++) {
            le.g n10 = this.f23552c.n(i10);
            ((oh.b) ((org.telegram.ui.Components.d6) n10.f13982a).f23225a).setVisualWidth(n10.b().width());
        }
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        while (true) {
            ...
            if (i15 < 3) {
                if (fArr[i15] != f12) {
                    int childCount = getChildCount();
                    float[] fArr2 = this.f33856w;
                    if (fArr2 == null || fArr2.length < childCount) {
                        this.f33856w = new float[childCount];
                        this.f33857x = new float[childCount];
                        this.f33858y = new int[childCount];
                    ...
                    for (int i17 = 0; i17 < childCount; i17++) {
                        ...
                        if (!d(childAt)) {
                            ...
                            if (childAt instanceof fh0) {
                                ...
                                f11 = bVar.T.measureText(bVar.f15544a.getText().toString());
                            } else {
                                f11 = 0.0f;
                            }
                            this.f33856w[i17] = f11;
        ...
        for (int i21 = 0; i21 < childCount4; i21++) {
            if (!d(getChildAt(i21))) {
                float[] fArr3 = this.f33856w;
                this.f33857x[i21] = f7;
                fArr3[i21] = f7;
                this.f33858y[i21] = i12;
            } else {
                float[] fArr4 = this.f33857x;
                float f17 = this.f33856w[i21] + dp2;
                fArr4[i21] = f17;
                int[] iArr2 = this.f33858y;
                if (f17 > max + dp2) {
                    i13 = 0;
                } else {
                    i13 = 1;
        ...
        if (i20 == 0) {
            ...
            for (int i22 = 0; i22 < childCount5; i22++) {
                this.f33858y[i22] = d(getChildAt(i22)) ? 1 : 0;
            }
            i20 = this.G;
        }
        ...
        if (f16 > f18) {
            ...
            if (f16 < f20) {
                ...
                for (int i24 = 0; i24 < childCount7; i24++) {
                    float[] fArr6 = this.f33857x;
                    fArr6[i24] = (this.f33858y[i24] * f21) + fArr6[i24];
                }
            }
        }
        ...
        for (int i26 = 0; i26 < childCount8; i26++) {
            if (d(getChildAt(i26))) {
                this.E[i26] = Math.round(this.f33857x[i26]);
                this.F[i26] = i25;
                i25 += this.E[i26];
            }
        }
