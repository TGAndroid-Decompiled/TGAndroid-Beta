...
public class AnimatedPhoneNumberEditText extends f40 {
    ...
    public final ArrayList f21910f;
    public final TextPaint h;
    public ObjectAnimator f21911n;
    public float f21912r;
    public String f21913s;
    public final o1.d v;
    public final ArrayList f21914w;
    public final ArrayList f21915x;
    ...
    public AnimatedPhoneNumberEditText(Context context) {
        ...
        this.f21914w = new ArrayList();
        this.f21915x = new ArrayList();
    }

    public static void j(AnimatedPhoneNumberEditText animatedPhoneNumberEditText, boolean z10, String str) {
        animatedPhoneNumberEditText.f21914w.clear();
        ArrayList arrayList = animatedPhoneNumberEditText.f21915x;
    ...
    public final void i(int i10) {
        ArrayList arrayList = this.f21914w;
        if (i10 < arrayList.size()) {
            this.f24014b.setAlpha((int) (((Float) arrayList.get(i10)).floatValue() * 255.0f));
        }
    }
    ...
    public void setHintText(String str) {
        ...
        Boolean bool = this.f21916y;
        ArrayList arrayList = this.f21914w;
        ArrayList arrayList2 = this.f21915x;
        if (bool != null && bool.booleanValue() == z10) {
            ...
            arrayList2.clear();
            this.f21916y = Boolean.valueOf(z10);
    ...
    public void setNewText(String str) {
        ...
        String str2;
        TextPaint textPaint;
        ArrayList arrayList2 = this.f21910f;
        if (arrayList2 != null && (arrayList = this.e) != null && !Objects.equals(this.f21913s, str)) {
            ObjectAnimator objectAnimator = this.f21911n;
            ...
            arrayList.clear();
            int i10 = 0;
            if (TextUtils.isEmpty(this.f21913s) && !TextUtils.isEmpty(str)) {
                z10 = true;
            } else {
                z10 = false;
            }
            ...
            while (i10 < str.length()) {
                ...
                if (!arrayList2.isEmpty() && i10 < this.f21913s.length()) {
                    str2 = this.f21913s.substring(i10, i11);
                } else {
                    str2 = null;
                }
            ...
            if (!arrayList2.isEmpty()) {
                ...
                this.f21911n = ofFloat;
                ofFloat.setDuration(150L);
                this.f21911n.addListener(new org.telegram.ui.t4(this, 27));
                this.f21911n.start();
            }
            this.f21913s = str;
            invalidate();
