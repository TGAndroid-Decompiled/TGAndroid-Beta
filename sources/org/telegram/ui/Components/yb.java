...
public final class yb implements ek0 {
    ...
    public final void h(View view, zg.p0 p0Var, boolean z10, boolean z11) {
        boolean z12;
        zb zbVar = this.f30205a;
        org.telegram.ui.ActionBar.n2 n2Var = zbVar.f30537f;
        if (zbVar.e == null) {
            return;
        }
        ...
        for (int i11 = 0; i11 < zbVar.e.size(); i11++) {
            ...
            arrayList.add(p0Var);
            n2Var.getSendMessagesHelper().sendReaction(messageObject, arrayList, p0Var, false, false, zbVar.f30537f, null);
