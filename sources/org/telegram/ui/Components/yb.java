...
public class yb extends nb {
    ...
    public yb(Context context, org.telegram.ui.ActionBar.d6 d6Var) {
        ...
        this.f30583b.setSingleLine();
        this.f30583b.setTypeface(Typeface.SANS_SERIF);
        this.f30583b.setTextSize(1, 15.0f);
        this.f30583b.setEllipsize(TextUtils.TruncateAt.END);
        this.f30583b.setPadding(0, AndroidUtilities.dp(8.0f), 0, AndroidUtilities.dp(8.0f));
        addView(this.f30583b, w7.y5.i(-2.0f, -2.0f, 8388627, 56.0f, 0.0f, 16.0f, 0.0f));
        this.f30583b.setLinkTextColor(getThemedColor(org.telegram.ui.ActionBar.h6.Gi));
    ...
    public final void c(int i10, int i11, int i12, String... strArr) {
        lj0 lj0Var = this.f30582a;
        lj0Var.f(i10, i11, i12, null);
        for (String str : strArr) {
            lj0Var.h(this.f30584c, str);
        }
    }
    ...
    public void setIconPaddingBottom(int i10) {
        this.f30582a.setLayoutParams(w7.y5.i(56.0f, 48 - i10, 8388627, 0.0f, 0.0f, 0.0f, i10));
    }

    public void setTextColor(int i10) {
        this.f30584c = i10;
        this.f30583b.setTextColor(i10);
    }
