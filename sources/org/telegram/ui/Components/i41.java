...
public abstract class i41 extends org.telegram.ui.ActionBar.e3 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final CharSequence f24913c;
    public final TLRPC.InputPeer d;
    public final int e;
    public final boolean f24914f;
    public final TL_iv.RichMessage h;
    public final RichMessageLayout.PreviewView f24915n;
    public final RichMessageLayout.PreviewView f24916r;
    public final String f24917s;
    public String v;
    public String f24918w;
    public final g41 f24919x;
    public final bi.o f24920y;
    ...
    public i41(Context context, String str, String str2, CharSequence charSequence, TLRPC.InputPeer inputPeer, int i10, boolean z10, TL_iv.RichMessage richMessage) {
        ...
        n90Var.setHighlightColor(getThemedColor(org.telegram.ui.ActionBar.h6.f19367uf));
        int themedColor = getThemedColor(org.telegram.ui.ActionBar.h6.f19384vf);
        try {
        ...
        RichMessageLayout.PreviewView previewView3 = this.f24916r;
        ...
        frameLayout.setBackgroundColor(getThemedColor(org.telegram.ui.ActionBar.h6.f19115h5));
    ...
    public static void m(i41 i41Var, TLRPC.TL_textWithEntities tL_textWithEntities, TLRPC.TL_textWithEntities tL_textWithEntities2, TLRPC.TL_error tL_error) {
        ...
        if (tL_error != null && "TRANSLATIONS_DISABLED_ALT".equalsIgnoreCase(tL_error.text)) {
            ...
            e41 e41Var = i41Var.f24919x.e;
            String str = i41Var.f24918w;
            i41Var.v = str;
    ...
    public static void o(i41 i41Var, TLObject tLObject) {
        RichMessageLayout.PreviewView previewView = i41Var.f24916r;
        i41Var.f24912b = null;
    ...
    public static void p(i41 i41Var, String str, Boolean bool) {
        ...
        if (str != null) {
            ...
            yc ycVar = new yc((FrameLayout) i41Var.containerView, i41Var.resourcesProvider);
            if (bool.booleanValue()) {
    ...
    public final void M() {
        ...
        if (this.f24912b != null) {
            ConnectionsManager.getInstance(this.currentAccount).cancelRequest(this.f24912b.intValue(), true);
            this.f24912b = null;
        }
        ...
        if (richMessage != null && inputPeer != null) {
            ...
            tL_messages_translateRichMessage.f18442id.add(Integer.valueOf(i10));
            tL_messages_translateRichMessage.to_lang = TranslateController.normalizeLanguage(str);
            this.f24912b = Integer.valueOf(ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_translateRichMessage, new y1(this, 16)));
            return;
        }
        TLRPC.TL_textWithEntities tL_textWithEntities = new TLRPC.TL_textWithEntities();
        CharSequence charSequence2 = this.f24913c;
        ...
        if (this.f24914f && inputPeer != null) {
            ...
            tL_messages_summarizeText.f18441id = i10;
            tL_messages_summarizeText.to_lang = TranslateController.normalizeLanguage(str);
            this.f24912b = Integer.valueOf(ConnectionsManager.getInstance(this.currentAccount).sendRequestTyped(tL_messages_summarizeText, new Object(), new ai.m0(13, this, tL_textWithEntities)));
            return;
        }
        ...
        if (inputPeer != null) {
            ...
            tL_messages_translateText.f18443id.add(Integer.valueOf(i10));
        } else {
            tL_messages_translateText.flags |= 2;
            tL_messages_translateText.text.add(tL_textWithEntities);
        }
        tL_messages_translateText.to_lang = TranslateController.normalizeLanguage(str);
        this.f24912b = Integer.valueOf(ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_translateText, new org.telegram.ui.lo(17, this, tL_textWithEntities)));
    }
