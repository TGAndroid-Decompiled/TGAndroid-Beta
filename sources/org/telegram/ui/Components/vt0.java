...
public final class vt0 extends ll0 {
    public final Context f29407c;
    public br0 e;
    public int f29409n;
    public final int f29410r;
    public int f29411s;
    public final zu0 v;
    public ArrayList d = new ArrayList();
    public ArrayList f29408f = new ArrayList();
    public int h = 0;
    ...
    public final boolean D(s4.c1 c1Var) {
        if (this.f29408f.size() + this.d.size() != 0) {
            return true;
        }
        return false;
    }
    ...
    public final MessageObject E(int i10) {
        ...
        return (MessageObject) this.f29408f.get(i10 - this.d.size());
    }

    public final void F(final int i10, final String str, long j3, long j10) {
        org.telegram.ui.ActionBar.o2 o2Var = this.v.f30659v1;
                        ...
                        if (tL_error == null) {
                            ...
                            for (int i13 = 0; i13 < messages_messages.messages.size(); i13++) {
                                ...
                                if (i14 == 0 || message.f18142id <= i14) {
                                    arrayList.add(new MessageObject(vt0Var.v.f30659v1.getCurrentAccount(), message, false, true));
                                }
                            }
                        }
    ...
    public final void G(String str, boolean z10) {
        ...
        if (!this.d.isEmpty() || !this.f29408f.isEmpty()) {
            this.d.clear();
            this.f29408f.clear();
            l();
        }
        ...
        zu0 zu0Var = this.v;
        if (isEmpty) {
            if (!this.d.isEmpty() || !this.f29408f.isEmpty() || this.f29411s != 0) {
                this.d.clear();
                this.f29408f.clear();
                if (this.h != 0) {
                    zu0Var.f30659v1.getConnectionsManager().cancelRequest(this.h, true);
                    this.h = 0;
                    this.f29411s--;
                    return;
                }
        ...
        while (true) {
            ...
            if (i10 < st0VarArr.length) {
                ...
                if (st0Var.F == this.f29410r) {
                    st0Var.f27927w.e(true, z10);
                }
                i10++;
            } else {
