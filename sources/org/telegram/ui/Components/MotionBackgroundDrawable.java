...
public class MotionBackgroundDrawable extends Drawable {
    ...
    public MotionBackgroundDrawable() {
        ...
        this.updateAnimationRunnable = new GroupCallPip$$ExternalSyntheticLambda2(this, 21);
    ...
    private void drawGiftImage(Canvas canvas, int i, float f, float f2, float f3, float f4) {
        List<WallpaperGiftPatternPosition> list = this.giftPatternPositions;
    ...
    public void updateAnimation() {
        ...
        if (f < 1.0f) {
            ...
            if (z) {
                ...
                float interpolation2 = this.interpolator.getInterpolation(f);
            ...
            if (z2) {
                ...
                this.paint3.setAlpha((int) (SvgHelper$SvgDrawable$$ExternalSyntheticOutline0.m(i6, 0.33333334f, interpolation, 0.33333334f) * 255.0f));
