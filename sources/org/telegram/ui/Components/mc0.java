...
public final class mc0 extends Drawable {
    public static final boolean f26429e0;
    public static final boolean f26430f0;
    public Matrix A;
    public boolean B;
    ...
    public int f26432a0;
    public long f26433b;
    public final gh.a f26434b0;
    public WeakReference f26435c;
    public Bitmap f26436c0;
    public boolean d;
    public int f26437d0;
    public final rr e;
    public int f26438f;
    ...
    public float h;
    public int f26440i;
    public final RectF f26441j;
    public Bitmap f26442k;
    public Bitmap f26443l;
    public final Bitmap[] f26444m;
    public final Paint f26445n;
    public final Paint f26446o;
    public final Paint f26447p;
    public int f26448q;
    public Canvas f26449r;
    public Canvas f26450s;
    public boolean f26451t;
    public Bitmap f26452u;
    public BitmapShader v;
    public BitmapShader f26453w;
    public Bitmap f26454x;
    public ImageReceiver f26455y;
    public boolean f26456z;
    ...
    public mc0() {
        this.f26431a = new int[]{-12423849, -531317, -7888252, -133430};
        this.e = new rr(0.33d, 0.0d, 0.0d, 1.0d);
        this.h = 1.0f;
        this.f26441j = new RectF();
        this.f26444m = new Bitmap[3];
        this.f26445n = new Paint(2);
        this.f26446o = new Paint(2);
        this.f26447p = new Paint();
        this.f26448q = 100;
        ...
        this.V = new gh.a();
        this.W = new gh.a();
        this.f26434b0 = new gh.a();
        h();
    }

    public static int g(int i10, int i11, int i12, int i13) {
        boolean j3 = j(i10, i11, i12, i13);
        boolean z10 = f26430f0;
        if (j3) {
            if (!z10) {
    ...
    public final void a(Canvas canvas, int i10, float f7, float f10, float f11, float f12) {
        List list = this.R;
        if (list != null && this.f26455y != null && i10 >= 0 && i10 < list.size()) {
            dg.c cVar = (dg.c) this.R.get(i10);
            canvas.save();
            canvas.translate(f7, f10);
            canvas.scale(f11, f12);
            canvas.concat(cVar.f7713b);
            this.f26455y.setImageCoords(cVar.f7712a);
            this.f26455y.draw(canvas);
            canvas.restore();
        }
    }

    public final void b(Canvas canvas, RectF rectF, int i10) {
        if (this.R != null && this.f26452u != null) {
            a(canvas, i10, rectF.left, rectF.top, rectF.width() / this.f26452u.getWidth(), rectF.height() / this.f26452u.getHeight());
        }
    }
    ...
    public final void c() {
        ...
        while (i10 < 3) {
            ...
            if (i10 < 0) {
                ...
                bitmap = this.f26444m[i10];
            }
            Utilities.generateGradient(bitmap, this.f26440i, f7, this.f26431a);
            i10 = i11;
        }
    }
    ...
    public final void draw(Canvas canvas) {
        ...
        int height = this.f26442k.getHeight();
        ...
        if (Build.VERSION.SDK_INT >= 28 && this.Q != null && this.f26442k != null && e != null) {
            z10 = true;
        } else {
            z10 = false;
        }
        int i13 = this.f26448q;
        float f16 = 1.0f;
        Paint paint = this.f26445n;
        Paint paint2 = this.f26446o;
        RectF rectF = this.f26441j;
        if (i13 < 0) {
            boolean z11 = f26429e0;
            if (!z10 && (!z11 || e == null)) {
                canvas.drawColor(i0.a.k(-16777216, (int) (this.L * this.K)));
            }
            if (e != null) {
                if (z11) {
                    int i14 = (((int) (this.L * this.J)) * (-this.f26448q)) / 100;
                    if (this.f26452u != null) {
                        Bitmap e7 = e();
                        gh.a aVar = this.f26434b0;
                        if (aVar.a(e7) || this.f26436c0 == null || this.f26437d0 != i14) {
                            int width3 = this.f26452u.getWidth();
                            int height3 = this.f26452u.getHeight();
                            this.f26437d0 = i14;
                            Bitmap bitmap = this.f26436c0;
                            if (bitmap == null || bitmap.getWidth() != width3 || this.f26436c0.getHeight() != height3) {
                                this.f26436c0 = Bitmap.createBitmap(width3, height3, Bitmap.Config.ARGB_8888);
                            }
                            Utilities.applyAlphaInvert(e7, this.f26436c0, i14);
                        }
                        aVar.b(e7);
                    }
                    ...
                    if (this.f26436c0 != null) {
                        canvas.drawBitmap(this.f26442k, (Rect) null, rectF, paint);
                        canvas.drawBitmap(this.f26436c0, (Rect) null, rectF, paint);
                    } else {
                        canvas.drawColor(i0.a.k(-16777216, (int) (this.L * this.K)));
                    }
                    ...
                    float min = 1.0f / Math.min(this.f26442k.getWidth() / bounds.width(), this.f26442k.getHeight() / bounds.height());
                    ...
                    if (!this.f26456z || max3 > 1.4f || max3 < 0.8f) {
                        this.A.preScale(max3, max3);
                        f16 = max3;
                    }
                    this.f26453w.setLocalMatrix(this.A);
                    paint2.setColorFilter(null);
                    paint2.setAlpha((int) ((Math.abs(this.f26448q) / 100.0f) * this.L * this.J));
                    rectF.set(bounds.left, bounds.top, bounds.right, bounds.bottom);
                    if (z10) {
                        Paint e10 = this.Q.e(this.f26442k, e, this.U, (int) (this.L * this.J), this.f26448q, canvas.isHardwareAccelerated());
                        this.Q.d(this.A);
                        this.Q.c(rectF);
                        float f23 = this.I;
            ...
            if (this.I != 0) {
                ...
                float min2 = 1.0f / Math.min(this.f26442k.getWidth() / bounds.width(), this.f26442k.getHeight() / bounds.height());
            ...
            if (e != null) {
                ...
                paint2.setAlpha((int) ((Math.abs(this.f26448q) / 100.0f) * this.L * this.J));
                if (z12) {
                    Paint e11 = this.Q.e(this.f26442k, e, this.U, (int) (this.L * this.J), this.f26448q, canvas.isHardwareAccelerated());
                    rc0 rc0Var = this.Q;
                    RectF rectF2 = rc0Var.f27949j;
                    rectF2.set(0.0f, 0.0f, rc0Var.f27947g, rc0Var.h);
                    Matrix matrix = rc0Var.f27948i;
                ...
                paint2.setAlpha((int) ((Math.abs(this.f26448q) / 100.0f) * this.L * this.J * 0.8f));
                b(canvas, rectF, this.S);
            }
        }
        canvas.restore();
    ...
    public final Bitmap e() {
        ...
        Bitmap bitmap2 = this.f26454x;
        gh.a aVar2 = this.W;
        boolean a10 = aVar2.a(bitmap2);
        boolean z11 = true;
        if (this.f26432a0 != this.S) {
            z10 = true;
        } else {
            z10 = false;
        }
        ...
        int width = this.f26452u.getWidth();
        int height = this.f26452u.getHeight();
        ...
        Bitmap.Config config = this.f26452u.getConfig();
        if (config == Bitmap.Config.ARGB_8888) {
            Utilities.copyBitmaps(this.f26452u, this.X);
        } else if (config == Bitmap.Config.ALPHA_8) {
            Utilities.expandAlphaToBlack(this.f26452u, this.X);
        }
        if (this.Z == null) {
        ...
        Paint paint2 = this.Z;
        int i10 = this.S;
        if (this.f26454x != null && this.R != null) {
            for (int i11 = 0; i11 < this.R.size(); i11++) {
                if (i11 != i10) {
                    dg.c cVar = (dg.c) this.R.get(i11);
                    canvas.save();
                    canvas.concat(cVar.f7713b);
                    canvas.drawBitmap(this.f26454x, (Rect) null, cVar.f7712a, paint2);
                    canvas.restore();
                }
            }
        }
        this.f26432a0 = this.S;
        aVar.b(this.f26452u);
        aVar2.b(this.f26454x);
        return this.X;
    }

    public final int f() {
        int[] iArr = this.f26431a;
    ...
    public final void h() {
        ...
        this.f26442k = createBitmap;
        createBitmap.setHasAlpha(false);
        for (int i12 = 0; i12 < 3; i12++) {
            Bitmap createBitmap2 = Bitmap.createBitmap(i10, i11, Bitmap.Config.ARGB_8888);
            this.f26444m[i12] = createBitmap2;
            createBitmap2.setHasAlpha(false);
        }
        this.f26449r = new Canvas(this.f26442k);
        Bitmap createBitmap3 = Bitmap.createBitmap(i10, i11, Bitmap.Config.ARGB_8888);
        this.f26443l = createBitmap3;
        createBitmap3.setHasAlpha(false);
        this.f26450s = new Canvas(this.f26443l);
        Utilities.generateGradient(this.f26442k, this.f26440i, this.e.getInterpolation(this.h), this.f26431a);
        if (f26430f0) {
            this.f26446o.setBlendMode(org.telegram.ui.u6.a());
        }
    }

    public final void i() {
        invalidateSelf();
        WeakReference weakReference = this.f26435c;
        if (weakReference != null && weakReference.get() != null) {
            ((View) this.f26435c.get()).invalidate();
        }
        if (this.f26451t) {
    ...
    public final void k() {
        this.T = true;
        ImageReceiver imageReceiver = this.f26455y;
    ...
    public final void o(int i10, int i11, int i12, int i13, int i14, boolean z10) {
        ...
        if (iArr[0] != i10 || iArr[1] != i11 || iArr[2] != i12 || iArr[3] != i13) {
            ...
            iArr[2] = i12;
            iArr[3] = i13;
            Bitmap bitmap = this.f26442k;
            if (bitmap != null) {
                Utilities.generateGradient(bitmap, this.f26440i, this.e.getInterpolation(this.h), iArr);
                if (z10) {
                    i();
                }
            }
    ...
    public final void r(View view) {
        this.f26435c = new WeakReference(view);
        ImageReceiver imageReceiver = this.f26455y;
        if (imageReceiver != null) {
    ...
    public final void setAlpha(int i10) {
        this.L = i10;
        this.f26445n.setAlpha(i10);
        this.f26446o.setAlpha(i10);
    }
    ...
    public final void t(Bitmap bitmap, int i10) {
        ...
        if (bitmap != null) {
            ...
            if (i10 < 0) {
                if (!z11) {
                    Bitmap bitmap2 = this.f26442k;
                    Shader.TileMode tileMode = Shader.TileMode.CLAMP;
                    this.v = new BitmapShader(bitmap2, tileMode, tileMode);
                    Bitmap bitmap3 = this.f26452u;
                    Shader.TileMode tileMode2 = Shader.TileMode.REPEAT;
                    this.f26453w = new BitmapShader(bitmap3, tileMode2, tileMode2);
                    this.f26456z = true;
                    paint.setShader(new ComposeShader(this.v, this.f26453w, PorterDuff.Mode.DST_IN));
    ...
    public final void w(int i10) {
        ...
        this.v = bitmapShader;
        this.f26445n.setShader(bitmapShader);
        i();
    }
    ...
    public final void x(boolean z10) {
        if (this.h >= 1.0f && LiteMode.isEnabled(32)) {
            ...
            this.B = z10;
            this.h = 0.0f;
            int i10 = this.f26440i - 1;
            this.f26440i = i10;
            if (i10 < 0) {
                this.f26440i = 7;
            }
            i();
            this.f26450s.drawBitmap(this.f26442k, 0.0f, 0.0f, (Paint) null);
            c();
            return;
        }
        i();
    ...
    public final void y() {
        ...
        this.h = 0.0f;
        i();
        Utilities.generateGradient(this.f26443l, this.f26440i, 0.0f, this.f26431a);
        c();
    }
    ...
    public final void z() {
        ...
        long j3 = elapsedRealtime - this.f26433b;
        if (j3 > 20) {
            j3 = 17;
        }
        this.f26433b = elapsedRealtime;
        if (j3 > 1) {
            boolean z11 = this.N;
            if (z11 && this.h == 1.0f) {
                this.h = 0.0f;
            ...
            if (f13 < 1.0f) {
                ...
                if (z11) {
                    ...
                    if (z13) {
                        ...
                        if ((c10 == 0 && f12 > 0.25f) || ((c10 == 1 && f12 > 0.5f) || (c10 == 2 && f12 > 0.75f))) {
                            if (this.E) {
                                int i11 = this.f26440i + 1;
                                this.f26440i = i11;
                                if (i11 > 7) {
                                    this.f26440i = 0;
                                }
                            } else {
                                int i12 = this.f26440i - 1;
                                this.f26440i = i12;
                                if (i12 < 0) {
                                    this.f26440i = 7;
                                }
                ...
                if (z12) {
                    Utilities.generateGradient(this.f26442k, this.f26440i, f10, this.f26431a);
                } else {
                    Paint paint = this.f26447p;
                    Bitmap[] bitmapArr = this.f26444m;
                    if (f10 != 1.0f) {
                        int i15 = (int) (f10 / 0.33333334f);
                        if (i15 == 0) {
                            this.f26449r.drawBitmap(this.f26443l, 0.0f, 0.0f, (Paint) null);
                        } else {
                            this.f26449r.drawBitmap(bitmapArr[i15 - 1], 0.0f, 0.0f, (Paint) null);
                        }
                        paint.setAlpha((int) (((f10 - (i15 * 0.33333334f)) / 0.33333334f) * 255.0f));
                        this.f26449r.drawBitmap(bitmapArr[i15], 0.0f, 0.0f, paint);
                    } else {
                        this.f26449r.drawBitmap(bitmapArr[2], 0.0f, 0.0f, paint);
                    }
                }
                i();
            }
