...
public final class mc0 extends Drawable {
    public final Drawable f26996a;
    public final Paint f26997b;
    public final Paint f26998c;
    public final z5 d;
    public boolean e;
    ...
    public mc0(Context context) {
        ...
        this.f26998c = paint2;
        this.d = new z5(new cc0(this, 2), 200L, nr.f27347g, 0);
        this.f26996a = context.getResources().getDrawable(R.drawable.filled_sound_on).mutate();
    ...
    public final void draw(Canvas canvas) {
        ...
        Drawable drawable = this.f26996a;
        ...
        if (e > 0.0f) {
            ...
            float f12 = centerY;
            float f13 = dp;
            canvas.drawLine(f11, f12, f13, f10, this.f26998c);
            Paint paint = this.f26997b;
