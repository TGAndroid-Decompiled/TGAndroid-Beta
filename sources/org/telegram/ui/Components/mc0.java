...
public abstract class mc0 extends qv0 implements r0.m, View.OnLayoutChangeListener {
    public int A0;
    public boolean B0;
    public final b2.q0 f26128w0;
    public View f26129x0;
    public lc0 f26130y0;
    public org.telegram.ui.ActionBar.e3 f26131z0;

    public mc0(Context context) {
        super(context, null);
        this.f26128w0 = new Object();
    }

    public void E(ViewGroup viewGroup, int i10, int i11, int[] iArr, int i12) {
        lc0 lc0Var;
        int max;
        if (viewGroup == this.f26129x0 && (lc0Var = this.f26130y0) != null && ((org.telegram.ui.u7) lc0Var).getListView() != null) {
            int top = this.f26130y0.getTop();
            if (i11 < 0) {
                if (top <= this.A0) {
                    ml0 listView = ((org.telegram.ui.u7) this.f26130y0).getListView();
                    ...
                    return;
                } else if (this.f26131z0 != null && !this.f26129x0.canScrollVertically(i11)) {
                    this.f26131z0.onNestedScroll(viewGroup, 0, 0, i10, i11);
                    return;
                } else {
                    return;
                }
            }
            org.telegram.ui.ActionBar.e3 e3Var = this.f26131z0;
            if (e3Var != null) {
    ...
    public final void Z() {
        View view = this.f26129x0;
        if (view != null && this.f26130y0 != null) {
            this.A0 = (view.getMeasuredHeight() - this.f26129x0.getPaddingBottom()) - this.f26130y0.getMeasuredHeight();
        }
    }
    ...
    public void j(ViewGroup viewGroup, int i10, int i11, int i12, int i13, int i14, int[] iArr) {
        ...
        if (viewGroup == this.f26129x0 && (lc0Var = this.f26130y0) != null && ((org.telegram.ui.u7) lc0Var).getListView() != null) {
            ml0 listView = ((org.telegram.ui.u7) this.f26130y0).getListView();
            if (this.f26130y0.getTop() == this.A0) {
                iArr[1] = i13;
    ...
    public void setChildLayout(lc0 lc0Var) {
        if (this.f26130y0 != lc0Var) {
            this.f26130y0 = lc0Var;
