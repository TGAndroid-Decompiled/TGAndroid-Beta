...
public abstract class mc0 extends pv0 implements r0.m, View.OnLayoutChangeListener {
    ...
    public int B0;
    public boolean C0;
    public final b2.q0 f26140w0;
    public View f26141x0;
    public lc0 f26142y0;
    public org.telegram.ui.ActionBar.d3 f26143z0;

    public mc0(Context context) {
        super(context, null);
        this.f26140w0 = new Object();
    }

    public void E(ViewGroup viewGroup, int i10, int i11, int[] iArr, int i12) {
        lc0 lc0Var;
        int max;
        if (viewGroup == this.f26141x0 && (lc0Var = this.f26142y0) != null && ((org.telegram.ui.s7) lc0Var).getListView() != null) {
            int top = this.f26142y0.getTop();
            if (i11 < 0) {
                if (top <= this.A0) {
                    ll0 listView = ((org.telegram.ui.s7) this.f26142y0).getListView();
                    ...
                    return;
                } else if (this.f26143z0 != null && !this.f26141x0.canScrollVertically(i11)) {
                    this.f26143z0.onNestedScroll(viewGroup, 0, 0, i10, i11);
                    return;
                } else {
                    return;
                }
            }
            org.telegram.ui.ActionBar.d3 d3Var = this.f26143z0;
            if (d3Var != null) {
    ...
    public final void a0(lc0 lc0Var, int i10) {
        this.B0 = i10;
        if (this.f26142y0 != lc0Var) {
            this.f26142y0 = lc0Var;
    ...
    public final void b0() {
        View view = this.f26141x0;
        if (view != null && this.f26142y0 != null) {
            if (this.B0 != 0) {
                this.A0 = view.getPaddingTop() + this.B0;
            } else {
                this.A0 = (view.getMeasuredHeight() - this.f26141x0.getPaddingBottom()) - this.f26142y0.getMeasuredHeight();
            }
        }
    }
    ...
    public void j(ViewGroup viewGroup, int i10, int i11, int i12, int i13, int i14, int[] iArr) {
        ...
        if (viewGroup == this.f26141x0 && (lc0Var = this.f26142y0) != null && ((org.telegram.ui.s7) lc0Var).getListView() != null) {
            ll0 listView = ((org.telegram.ui.s7) this.f26142y0).getListView();
            if (this.f26142y0.getTop() == this.A0) {
                iArr[1] = i13;
