...
public final class u0 implements View.OnClickListener {
    ...
    public final TLRPC.User f28575b;
    public final org.telegram.ui.ActionBar.n2 f28576c;
    ...
    public final void onClick(View view) {
        switch (this.f28574a) {
            case 0:
                ...
                bundle.putLong("user_id", this.f28575b.f18490id);
                org.telegram.ui.ActionBar.n2 n2Var = this.f28576c;
                if (n2Var.getMessagesController().checkCanOpenChat(bundle, n2Var)) {
                    n2Var.presentFragment(new ProfileActivity(bundle, null));
                }
                this.d.f18669a.L0.run();
                return;
            default:
                Bundle bundle2 = new Bundle();
                bundle2.putLong("user_id", this.f28575b.f18490id);
                org.telegram.ui.ActionBar.n2 n2Var2 = this.f28576c;
