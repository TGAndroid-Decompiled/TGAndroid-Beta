...
public final class ds implements Predicate {
    ...
    public final TLObject f23723b;

    public ds(int i10, TLObject tLObject) {
        this.f23722a = i10;
        this.f23723b = tLObject;
    }
    ...
    public final boolean test(Object obj) {
        switch (this.f23722a) {
            case 0:
                return MessageObject.peersEqual((TLRPC.InputPeer) this.f23723b, ((MessageObject) obj).messageOwner.from_id);
            default:
                MessageObject messageObject = (MessageObject) obj;
                TLObject tLObject = this.f23723b;
