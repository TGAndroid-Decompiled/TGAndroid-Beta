...
public class OutlineTextContainerView extends FrameLayout {
    ...
    private static final SimpleFloatPropertyCompat<OutlineTextContainerView> TITLE_PROGRESS_PROPERTY = new SimpleFloatPropertyCompat("titleProgress", new SimpleFloatPropertyCompat.Getter() {
        @Override
        public final float get(Object obj) {
            float f;
