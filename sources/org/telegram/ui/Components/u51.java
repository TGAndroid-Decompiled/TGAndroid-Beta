...
public final class u51 extends ww0 {
    ...
    @Override
    public final void d() {
        this.f28594f = System.currentTimeMillis();
        this.f28595g = true;
        invalidateSelf();
    }
    ...
    public final void draw(Canvas canvas) {
        ...
        Paint paint = this.f28597j;
        if (paint == null) {
            paint = org.telegram.ui.ActionBar.j6.f19072c2;
            paint.setAlpha(255);
        }
        float f7 = i12;
        float[] fArr = this.f28593c;
    ...
    public final void f() {
        if (this.f28595g) {
            if (NotificationCenter.getInstance(this.f28591a).isAnimationInProgress() && !this.f28596i) {
                AndroidUtilities.runOnUIThread(new wq0(this, 26), 100L);
                return;
            }
            long currentTimeMillis = System.currentTimeMillis();
            long j3 = currentTimeMillis - this.f28594f;
            this.f28594f = currentTimeMillis;
            if (j3 > 50) {
                j3 = 50;
            }
            for (int i10 = 0; i10 < 3; i10++) {
