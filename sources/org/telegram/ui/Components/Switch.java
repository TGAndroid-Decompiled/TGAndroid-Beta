...
public class Switch extends View {
    ...
    public final le.b f22210a;
    public int f22211a0;
    public final RectF f22212b;
    public float f22213c;
    public ObjectAnimator d;
    public ObjectAnimator e;
    public boolean f22214f;
    public boolean h;
    public final Paint f22215n;
    public final Paint f22216r;
    public int f22217s;
    public float v;
    public int f22218w;
    public int f22219x;
    ...
    public Switch(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context);
        this.f22210a = new le.b(0, new k2.v(this, 2), qr.h, 380L, true);
        this.v = 1.0f;
        this.f22218w = org.telegram.ui.ActionBar.j6.f19120r7;
        this.f22219x = org.telegram.ui.ActionBar.j6.V6;
        int i10 = org.telegram.ui.ActionBar.j6.f18863d6;
        this.f22220y = i10;
        this.E = i10;
        this.K = new int[]{16842910, 16842919};
        this.W = f6Var;
        this.f22212b = new RectF();
        this.f22215n = new Paint(1);
