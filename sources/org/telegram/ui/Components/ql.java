...
public final class ql implements Utilities.Callback {
    ...
    public final void run(Object obj) {
        ...
        switch (this.f27698a) {
            case 0:
                Long l4 = (Long) obj;
                wi wiVar = ((yl) this.e).f30639b.f27088b;
                if (wiVar != null) {
                    wiVar.I1 = true;
                }
                wiVar.Z1.B1(7, true, this.f27699b, this.d, 0, 0L, wiVar.s1(), this.f27700c, l4.longValue());
            ...
            default:
                ...
                ChatAttachAlertPhotoLayout chatAttachAlertPhotoLayout = ((vl) this.e).f29179c;
                wi wiVar2 = chatAttachAlertPhotoLayout.f27088b;
                wiVar2.f30048s2 = true;
                wiVar2.I1 = true;
                ...
                uiVar.B1(i10, true, this.f27700c, this.d, 0, 0L, wiVar2.s1(), z10, l10.longValue());
                ChatAttachAlertPhotoLayout.f22122r1.clear();
                ChatAttachAlertPhotoLayout.f22124t1.clear();
