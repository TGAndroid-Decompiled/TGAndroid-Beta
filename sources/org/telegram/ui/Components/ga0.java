...
public final class ga0 extends nz {
    ...
    public final jv0 D1(int i10) {
        ...
        na0 na0Var = this.Y;
        if (i10 == 0) {
            jv0Var.f25443a = this.f42776m;
            jv0Var.f25444b = na0Var.e.h;
            jv0Var.f25445c = true;
            return jv0Var;
        }
        int i12 = i10 - 1;
        ...
        if (J instanceof TLRPC.BotInlineResult) {
            ...
            if (document != null) {
                ...
                if (closestPhotoSizeWithSize2 != null) {
                    f7 = closestPhotoSizeWithSize2.f18137w;
                } else {
                    f7 = 100.0f;
                }
                jv0Var.f25443a = f7;
                ...
                while (i11 < botInlineResult.content.attributes.size()) {
                    ...
                    if (!(documentAttribute2 instanceof TLRPC.TL_documentAttributeImageSize) && !(documentAttribute2 instanceof TLRPC.TL_documentAttributeVideo)) {
                        ...
                        jv0Var.f25443a = documentAttribute2.f18119w;
                        jv0Var.f25444b = documentAttribute2.h;
                        break;
                    }
                }
                ...
                while (i11 < botInlineResult.thumb.attributes.size()) {
                    ...
                    if (!(documentAttribute3 instanceof TLRPC.TL_documentAttributeImageSize) && !(documentAttribute3 instanceof TLRPC.TL_documentAttributeVideo)) {
                        ...
                        jv0Var.f25443a = documentAttribute3.f18119w;
                        jv0Var.f25444b = documentAttribute3.h;
                        break;
                    }
                }
            } else {
                ...
                if (photo != null && (closestPhotoSizeWithSize = FileLoader.getClosestPhotoSizeWithSize(photo.sizes, AndroidUtilities.getPhotoSize())) != null) {
                    jv0Var.f25443a = closestPhotoSizeWithSize.f18137w;
                    jv0Var.f25444b = closestPhotoSizeWithSize.h;
                }
            }
        }
        return jv0Var;
