        ...
        if (i10 == -1) {
            ...
            if (na0Var.I != null) {
                ...
                if (!arrayList.isEmpty()) {
                    ...
                    alertDialog$Builder.f18647a.T = LocaleController.formatPluralString("DeleteStoriesSubtitle", arrayList.size(), new Object[0]);
