...
public final class ga0 extends nz {
    ...
    public final int A() {
        na0 na0Var = this.Y;
        if (na0Var.f26427f.I() == null && na0Var.f26427f.U == null) {
            return B();
        }
        return B() - 1;
    }
    ...
    public final kv0 D1(int i10) {
        ...
        na0 na0Var = this.Y;
        if (i10 == 0) {
            kv0Var.f25695a = this.f42798m;
            kv0Var.f25696b = na0Var.e.h;
            kv0Var.f25697c = true;
            return kv0Var;
        }
        int i12 = i10 - 1;
            ...
            if (document != null) {
                ...
                while (i11 < botInlineResult.content.attributes.size()) {
                    ...
                    if (!(documentAttribute2 instanceof TLRPC.TL_documentAttributeImageSize) && !(documentAttribute2 instanceof TLRPC.TL_documentAttributeVideo)) {
                        ...
                        kv0Var.f25695a = documentAttribute2.f18128w;
                        kv0Var.f25696b = documentAttribute2.h;
                        break;
                    }
                }
                ...
                while (i11 < botInlineResult.thumb.attributes.size()) {
                    ...
                    if (!(documentAttribute3 instanceof TLRPC.TL_documentAttributeImageSize) && !(documentAttribute3 instanceof TLRPC.TL_documentAttributeVideo)) {
                        ...
                        kv0Var.f25695a = documentAttribute3.f18128w;
                        kv0Var.f25696b = documentAttribute3.h;
                        break;
                    }
                }
            } else {
                ...
                if (photo != null && (closestPhotoSizeWithSize = FileLoader.getClosestPhotoSizeWithSize(photo.sizes, AndroidUtilities.getPhotoSize())) != null) {
                    kv0Var.f25695a = closestPhotoSizeWithSize.f18146w;
                    kv0Var.f25696b = closestPhotoSizeWithSize.h;
                }
            }
        }
        return kv0Var;
