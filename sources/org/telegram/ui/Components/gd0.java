...
public final class gd0 extends FrameLayout {
    public Bitmap f26361a;
    public HashMap f26362b;
        ...
        if (arrayList != null && !arrayList.isEmpty()) {
            ...
            for (int i13 = 0; i13 < size; i13++) {
                ...
                if (x9Var != null) {
                    ...
                    this.f26362b.put(x9Var, mediaEntity);
                }
            }
        }
    }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (this.f26362b != null) {
            ...
            for (int i17 = 0; i17 < childCount; i17++) {
                ...
                VideoEditedInfo.MediaEntity mediaEntity = (VideoEditedInfo.MediaEntity) this.f26362b.get(childAt);
                if (mediaEntity != null) {
