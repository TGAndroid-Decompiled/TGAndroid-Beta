...
public final class gd0 implements Runnable {
    ...
    public final void run() {
        ...
        sd0 sd0Var = this.f24196b;
        switch (i10) {
            case 0:
                EditTextBoldCursor editTextBoldCursor = sd0Var.f27844r;
                if (sd0Var.f27847x.getVisibility() != 0 && editTextBoldCursor != null) {
