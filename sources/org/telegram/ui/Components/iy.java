...
public final class iy implements View.OnClickListener {
    ...
    public final void onClick(View view) {
        ...
        int i12 = org.telegram.ui.ActionBar.h6.f19228n5;
        int i13 = lz.O2;
        ...
        textView2.setTextColor(lzVar.z(org.telegram.ui.ActionBar.h6.f19151j5));
        if (LocaleController.isRTL) {
            i11 = 5;
        } else {
            i11 = 3;
        ...
        Object obj = lyVar.f26217w;
        if (obj == null) {
            obj = lzVar.W0;
        }
        textView3.setText(LocaleController.formatString("EmojiSuggestionsUrl", i15, obj));
        textView3.setTextSize(1, 15.0f);
        textView3.setTextColor(lzVar.z(org.telegram.ui.ActionBar.h6.f19171k5));
        if (LocaleController.isRTL) {
            i14 = 5;
        }
