...
public final class it0 extends kl0 {
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (view instanceof org.telegram.ui.Cells.ab) {
            ...
            if (chatParticipant != null) {
                ...
                if (UserObject.isUserSelf(user) && ChatObject.canManageMyTag(n2Var.getMessagesController().getChat(Long.valueOf(-yu0Var.f30367j1)))) {
                    z14 = true;
                } else {
                    z14 = false;
                }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        yu0 yu0Var = this.f25136f;
        if (i10 == 20) {
            lt0 M = yu0.M(7, yu0Var.f30367j1, this.f25135c, yu0Var.F1);
            M.setLayoutParams(new s4.p0(-1, -1));
            return new s4.c1(M);
        }
        org.telegram.ui.Cells.ab abVar = new org.telegram.ui.Cells.ab(9, 0, this.f25135c, yu0Var.F1, true, false);
