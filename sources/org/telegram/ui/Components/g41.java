...
public final class g41 extends FrameLayout {
    ...
    public final org.telegram.ui.pk f24347b;
    public final ub1 f24348c;
    public final TextView d;
    public final e41 e;
    public final View f24349f;
    public final i41 h;
    ...
    public g41(i41 i41Var, Context context) {
        ...
        int themedColor = i41Var.getThemedColor(org.telegram.ui.ActionBar.h6.f19115h5);
        String str = i41Var.f24917s;
        ...
        imageView.setBackground(org.telegram.ui.ActionBar.h6.f0(i41Var.getThemedColor(org.telegram.ui.ActionBar.h6.f19134i6), 1, -1));
        imageView.setAlpha(0.0f);
        imageView.setOnClickListener(new View.OnClickListener(this) {
            public final g41 f23459b;
            ...
            public final void onClick(View view2) {
                ...
                switch (r2) {
                    case 0:
                        this.f23459b.h.dismiss();
                        return;
                    default:
                        g41 g41Var = this.f23459b;
                        e41 e41Var = g41Var.e;
                        ...
                        for (int i13 = 0; i13 < locales.size(); i13++) {
                            ...
                            if (!localeInfo.pluralLangCode.equals(i41Var2.f24917s) && "remote".equals(localeInfo.pathToFile)) {
    ...
    public final void setTranslationY(float f7) {
        ...
        float interpolation = rr.f28023g.getInterpolation(a2);
        float lerp = AndroidUtilities.lerp(0.85f, 1.0f, interpolation);
        org.telegram.ui.pk pkVar = this.f24347b;
