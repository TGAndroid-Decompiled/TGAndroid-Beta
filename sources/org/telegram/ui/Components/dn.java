...
public final class dn implements my {
    public final Utilities.Callback f26307a;
    public final an f26308b;

    public dn(Utilities.Callback callback, an anVar) {
        this.f26307a = callback;
        this.f26308b = anVar;
    }
    ...
    public final void m(View view, TLRPC.Document document, String str, Object obj, MessageObject.SendAnimationData sendAnimationData, boolean z4, int i10) {
        this.f26307a.run(new fh.i(document, obj));
        this.f26308b.dismiss(true);
    }
    ...
    public final void x(long j10, TLRPC.Document document, String str, boolean z4) {
        this.f26307a.run(new fh.i(document, null));
        this.f26308b.dismiss(true);
    }
