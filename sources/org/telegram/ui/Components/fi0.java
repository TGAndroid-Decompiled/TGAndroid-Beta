...
public final class fi0 extends View {
    ...
    public float K;
    public float L;
    public final org.telegram.ui.ActionBar.f6 f24118a;
    public final PorterDuffColorFilter f24119b;
    public final PorterDuffColorFilter f24120c;
    public u01 d;
    public u01 e;
    public final Paint f24121f;
    public final Paint h;
    public final Path f24122n;
    public final Drawable f24123r;
    public final RectF f24124s;
    public final Paint v;
    public final Paint f24125w;
    public final Path f24126x;
    public final yc f24127y;

    public fi0(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context);
        PorterDuff.Mode mode = PorterDuff.Mode.SRC_IN;
        this.f24119b = new PorterDuffColorFilter(-1, mode);
        this.f24120c = new PorterDuffColorFilter(-16777216, mode);
        this.f24121f = new Paint();
        Paint paint = new Paint();
        this.h = paint;
        Path path = new Path();
        this.f24122n = path;
        this.f24124s = new RectF();
        this.v = new Paint(1);
        this.f24125w = new Paint(1);
        this.f24126x = new Path();
        this.f24127y = new yc(this);
        this.E = -1;
        this.f24118a = f6Var;
        this.f24123r = context.getResources().getDrawable(R.drawable.files_music).mutate();
    ...
    public final void a() {
        ...
        this.E = i10;
        if (z10) {
            porterDuffColorFilter = this.f24120c;
        } else {
            porterDuffColorFilter = this.f24119b;
        }
        this.f24123r.setColorFilter(porterDuffColorFilter);
        this.f24121f.setColor(this.E);
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        RectF rectF = this.f24124s;
        yc ycVar = this.f24127y;
        if (action == 0) {
    ...
    public final void onDraw(Canvas canvas) {
        if (this.d != null && this.e != null) {
            ...
            float a2 = this.f24127y.a(0.02f);
            if (clamp01 > 0.0f) {
                int width = getWidth() - (AndroidUtilities.dp(12.0f) * 2);
                this.d.f28503p = (width - AndroidUtilities.dp(35.0f)) / 2.0f;
                this.e.f28503p = (width - this.d.l()) - AndroidUtilities.dp(35.0f);
                ...
                int i12 = i10 - i11;
                int i13 = i10 + i11;
                Drawable drawable = this.f24123r;
                ...
                canvas.drawPath(this.f24122n, paint3);
                canvas.restore();
                canvas.restore();
            }
        }
    ...
    public void setColor(MessagesController.PeerColor peerColor) {
        int bgColor1;
        int bgColor2;
        org.telegram.ui.ActionBar.f6 f6Var = this.f24118a;
        if (peerColor == null) {
            bgColor1 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19372s8, f6Var);
            bgColor2 = bgColor1;
        } else {
        ...
        if (peerColor == null) {
            this.G = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19094d6, f6Var);
            this.H = true;
        } else {
