...
public final class v30 extends View implements GestureDetector.OnGestureListener {
    ...
    public ValueAnimator f31101a0;
    public final ArrayList f31102b;
    public ValueAnimator f31103b0;
    public final ArrayList f31104c;
    public float f31105c0;
    public final ArrayList d;
    public final ArrayList f31106e;
    public int f31107f;
    public long h;
    public final int f31108n;
    public final int f31109r;
    public final int f31110s;
    public final int v;
    public int f31111w;
    public float f31112x;
    public float f31113y;
    ...
    public v30(ContextThemeWrapper contextThemeWrapper, int i10) {
        ...
        this.f31108n = AndroidUtilities.dp(42.0f);
        this.f31109r = AndroidUtilities.dp(56.0f);
    ...
    private ImageReceiver getFreeReceiver() {
        ...
        ArrayList arrayList = this.f31102b;
        ...
        this.f31104c.add(imageReceiver);
        imageReceiver.setCurrentAccount(((org.telegram.ui.us0) this.W).f41243a.T);
        return imageReceiver;
    }

    private int getMaxScrollX() {
        return ((this.v * 2) + this.f31108n) * this.f31107f;
    }

    private int getMinScrollX() {
        return ((this.v * 2) + this.f31108n) * (-((this.d.size() - this.f31107f) - 1));
    }
    ...
    public final void a(int i10, boolean z10) {
        ...
        Object obj;
        ArrayList arrayList = this.f31102b;
        ArrayList arrayList2 = this.f31104c;
            ...
            if (!arrayList3.isEmpty()) {
                ...
                if (z10) {
                    ...
                    while (i15 < size) {
                        ...
                        int i16 = ((i13 + i14) * (param - this.f31107f)) + measuredWidth2 + i10;
                ...
                String str2 = "avatar_";
                int i17 = this.f31109r;
                int i18 = this.f31110s;
                ArrayList arrayList4 = this.f31106e;
                if (i11 != Integer.MIN_VALUE) {
                    int size2 = arrayList3.size();
                    while (i11 < size2) {
                        int i19 = ((i13 + i14) * (i11 - this.f31107f)) + measuredWidth2 + i10;
                        ...
                        if (arrayList4.get(0) instanceof MessageObject) {
                            ...
                            org.telegram.ui.wu0 wu0Var = ((org.telegram.ui.us0) this.W).f41243a.f33627j7;
                            if (wu0Var != null) {
                                obj = wu0Var.g();
                            } else {
                                obj = null;
                            ...
                            obj = "avatar_" + ((org.telegram.ui.us0) this.W).f41243a.f33769z5;
                        }
                ...
                if (i12 != Integer.MAX_VALUE) {
                    while (i12 >= 0) {
                        int i23 = ((i13 + i14) * (i12 - this.f31107f)) + i22 + i10 + i13;
                        if (i23 <= 0) {
                            break;
                        }
                        ...
                        if (arrayList4.get(0) instanceof MessageObject) {
                            ...
                            org.telegram.ui.wu0 wu0Var2 = ((org.telegram.ui.us0) this.W).f41243a.f33627j7;
                            if (wu0Var2 != null) {
                                sb2 = wu0Var2.g();
                            } else {
                                sb2 = null;
                            ...
                            str = str2;
                            sb3.append(((org.telegram.ui.us0) this.W).f41243a.f33769z5);
                            sb2 = sb3.toString();
                ...
                ValueAnimator valueAnimator = this.f31101a0;
    ...
    public final boolean c() {
        if (this.U && this.f31103b0 == null) {
            if (this.f31105c0 <= 0.0f && this.V) {
                ValueAnimator valueAnimator = this.f31101a0;
                if (valueAnimator != null && valueAnimator.isStarted()) {
                    return true;
                }
    ...
    public final void e() {
        ...
        int i10 = this.T;
        if (i10 >= 0 && i10 < this.f31106e.size()) {
            this.Q = true;
            this.M = false;
            int i11 = this.T;
            this.L = i11;
            this.F = i11;
            this.J = (this.f31108n + this.v) * (this.f31107f - i11);
            this.K = this.f31111w;
            this.f31112x = 1.0f;
            this.T = -1;
            u30 u30Var = this.W;
            if (u30Var != null) {
                PhotoViewer photoViewer = ((org.telegram.ui.us0) u30Var).f41243a;
    ...
    public final void f() {
        ...
        int i11;
        int i12;
        int i13 = this.f31111w;
        int abs = Math.abs(i13);
        int i14 = this.f31108n;
        int i15 = this.v;
        int i16 = (i14 / 2) + i15;
        int i17 = -1;
        if (abs > i16) {
        ...
        this.T = this.f31107f - i10;
        PhotoViewer photoViewer = ((org.telegram.ui.us0) this.W).f41243a;
        int i18 = photoViewer.P4;
        ArrayList arrayList = photoViewer.f33545a7;
        ArrayList arrayList2 = photoViewer.Y6;
        org.telegram.ui.wu0 wu0Var = photoViewer.f33627j7;
        if (wu0Var != null) {
            list = wu0Var.getAll();
        } else {
            list = null;
        ...
        if (i18 != i19 && i19 >= 0 && i19 < this.d.size()) {
            Object obj = this.f31106e.get(this.T);
            ...
            if (!arrayList.isEmpty()) {
                ...
                for (int size = arrayList.size(); i26 < size; size = i14) {
                    ...
                    if (param == i27) {
                        ...
                        if (i28 < i27) {
                            if (param < i27) {
                                if (param <= i28) {
                                    imageReceiver.setImageX(((((i16 + i29) * ((imageReceiver.getParam() - this.f31107f) + 1)) + measuredWidth) - (i29 + i25)) + i24);
                                } else {
                                    imageReceiver.setImageX(((i29 + i16) * (imageReceiver.getParam() - this.f31107f)) + measuredWidth + i24);
                                }
                                i14 = size;
                            } else {
                                i14 = size;
                                imageReceiver.setImageX(((i29 + i16) * ((imageReceiver.getParam() - this.f31107f) - 1)) + measuredWidth + i21 + i29 + i24);
                            }
                        } else {
                            i14 = size;
                            if (param < i27) {
                                ...
                                imageReceiver.setImageX(i29 + i25 + ((i16 + i29) * ((imageReceiver.getParam() - this.f31107f) - 2)) + measuredWidth + i21 + i29 + i24);
                            }
                        }
                        if (param == this.F) {
                    ...
                    imageReceiver.setAlpha(this.f31105c0);
                ...
                if (i30 >= 0) {
                    ...
                    if (f16 > 0.0f) {
                        ...
                        if (i30 == this.f31107f) {
                            ...
                            this.f31111w = this.K + ((int) Math.ceil(this.f31113y * (this.J - i13)));
                        } else {
                            pr prVar = pr.f29495g;
                            this.E = prVar.getInterpolation(1.0f - f18);
                            if (this.Q) {
                                float f21 = this.f31113y;
                                if (f21 > 0.0f) {
                                ...
                                this.f31111w = this.K + ((int) Math.ceil(interpolation * (this.J - i12)));
                            } else {
                                this.f31113y = prVar.getInterpolation(this.f31112x);
                                this.f31111w = (int) Math.ceil(this.E * this.J);
                            }
                        }
                        if (this.f31112x <= 0.0f) {
                            this.f31107f = this.L;
                            this.f31112x = 1.0f;
                            this.f31113y = 1.0f;
                            this.E = 0.0f;
                ...
                if (!scroller.isFinished()) {
                    if (scroller.computeScrollOffset()) {
                        this.f31111w = scroller.getCurrX();
                        f();
                        invalidate();
                    }
                    if (scroller.isFinished()) {
    ...
    public final boolean onFling(MotionEvent motionEvent, MotionEvent motionEvent2, float f7, float f10) {
        ...
        scroller.abortAnimation();
        if (this.d.size() >= 10) {
            scroller.fling(this.f31111w, 0, Math.round(f7), 0, getMinScrollX(), getMaxScrollX(), 0, 0);
            return false;
        }
        return false;
    }
    ...
    public final boolean onScroll(MotionEvent motionEvent, MotionEvent motionEvent2, float f7, float f10) {
        this.f31111w = (int) (this.f31111w - f7);
        int minScrollX = getMinScrollX();
        int maxScrollX = getMaxScrollX();
        int i10 = this.f31111w;
        if (i10 < minScrollX) {
            this.f31111w = minScrollX;
        } else if (i10 > maxScrollX) {
            this.f31111w = maxScrollX;
        }
        f();
        return false;
    }
    ...
    public final boolean onSingleTapUp(MotionEvent motionEvent) {
        ...
        e();
        ArrayList arrayList3 = this.f31104c;
    ...
    public void setAnimationsEnabled(boolean z10) {
        if (this.S != z10) {
            ...
            if (!z10) {
                ...
                ValueAnimator valueAnimator2 = this.f31103b0;
    ...
    public void setMoveProgress(float f7) {
        ...
        if (!this.P && this.L < 0) {
            ...
            if (i11 >= 0 && i11 < arrayList.size()) {
                this.f31113y = 1.0f - Math.abs(f7);
            } else {
                this.f31113y = 1.0f;
            }
            this.E = 1.0f - this.f31113y;
            if (i10 != 0) {
                z10 = true;
            } else {
                z10 = false;
            ...
            invalidate();
            if (!arrayList.isEmpty()) {
                if (f7 >= 0.0f || this.f31107f != arrayList.size() - 1) {
                    if (i10 <= 0 || this.f31107f != 0) {
                        int i12 = (int) (f7 * (this.f31108n + this.v));
                        this.f31111w = i12;
                        a(i12, true);
                    }
                }
