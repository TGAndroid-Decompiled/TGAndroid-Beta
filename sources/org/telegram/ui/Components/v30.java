...
public abstract class v30 extends org.telegram.ui.ActionBar.h3 {
    public final z4.g f27806b;
    public final s30 f27807c;
    ...
    public v30(Context context, TLRPC.Chat chat, boolean z10) {
        ...
        viewGroup2.addView(textView, w7.a6.d(-2, -2.0f, i11 | 48, 24.0f, 29.0f, 24.0f, 0.0f));
        ...
        s30Var.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i14, false));
        ...
        while (true) {
            ...
            this.d.addView(this.e[i15], w7.a6.n(-2, -1));
            if (i15 == 0) {
            ...
            this.e[i15].setOnClickListener(new bi.j5(this, i15, 9));
            i15++;
        }
        if (z10) {
            this.f27806b.setCurrentItem(1);
        }
    }
    ...
    public static void m(v30 v30Var) {
        ...
        if (textView != null) {
            measuredWidth2 -= (((textView.getMeasuredWidth() / 2) + textView.getLeft()) - measuredWidth) * v30Var.f27808f;
        }
        for (int i11 = 0; i11 < textViewArr.length; i11++) {
            ...
            if (i11 >= i12 && i11 <= i12 + 1) {
                if (i11 == i12) {
                    float f11 = v30Var.f27808f;
                    f10 = 1.0f - (0.3f * f11);
                    f7 = 1.0f - (f11 * 0.1f);
                } else {
                    float f12 = v30Var.f27808f;
                    f10 = 0.7f + (0.3f * f12);
                    f7 = 0.9f + (f12 * 0.1f);
                }
            }
