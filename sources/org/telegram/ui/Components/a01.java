...
public final class a01 extends ReplacementSpan {
    public static final int f26610f = 0;
    public ImageReceiver f26611a;
    public int f26612b;
    public int f26613c;
    ...
    public final void draw(Canvas canvas, CharSequence charSequence, int i10, int i11, float f9, int i12, int i13, int i14, Paint paint) {
        int i15 = this.f26612b;
        int i16 = this.f26613c;
        ImageReceiver imageReceiver = this.f26611a;
        canvas.save();
        if (this.d) {
            imageReceiver.setImageCoords((int) f9, i13 - (i16 - this.f26614e), i15, i16);
        } else {
