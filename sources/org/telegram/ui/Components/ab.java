...
public abstract class ab extends org.telegram.ui.ActionBar.f3 {
    ...
    public int V;
    public int W;
    public final Drawable f22635b;
    public final gg.b0 f22636c;
    public final vl0 d;
    public final wa e;
    public boolean f22637f;
    public int h;
    public final org.telegram.ui.ActionBar.n2 f22638n;
    public final boolean f22639r;
    public final ua f22640s;
    public float v;
    public boolean f22641w;
    public float f22642x;
    ...
    public void I(Canvas canvas, View view) {
        ...
        if (!this.f22639r) {
            ...
            if (i15 == 1) {
                ...
                AndroidUtilities.updateViewVisibilityAnimated(waVar, z11, 1.0f, this.f22637f);
            } else if (i15 == 2) {
            ...
            if (L()) {
                ...
                if (this.f22643y && f12 > 0.0f) {
                    ...
                    org.telegram.ui.ActionBar.j6.f19383t0.setColor(getThemedColor(org.telegram.ui.ActionBar.j6.Ii));
                    org.telegram.ui.ActionBar.j6.f19383t0.setAlpha((int) (paint.getAlpha() * f12));
    ...
    public final void J() {
        vl0 vl0Var = this.d;
        if (vl0Var != null && this.f22636c != null && vl0Var.getChildCount() > 0) {
            View view = null;
            int i10 = -1;
    ...
    public final void u() {
        if (this.backDrawable != null && this.containerView != null && this.shadowDrawable != null && L() && !this.f22639r) {
    ...
    public final boolean z() {
        if (i0.a.f(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19165h5, this.resourcesProvider)) > 0.699999988079071d) {
            return true;
        }
        return false;
    }
    ...
    public ab(Context context, org.telegram.ui.ActionBar.n2 n2Var, za zaVar) {
        super(zaVar.f30794b, context, zaVar.f30797g, zaVar.f30793a);
        ua uaVar;
        this.v = 0.4f;
        this.f22641w = true;
        this.f22642x = 1.0f;
        ...
        this.O = false;
        this.U = -1;
        boolean z10 = zaVar.f30795c;
        boolean z11 = zaVar.d;
        boolean z12 = zaVar.e;
        int i10 = zaVar.f30796f;
        this.f22638n = n2Var;
        this.f22639r = z10;
        this.f22635b = context.getDrawable(R.drawable.header_shadow).mutate();
        if (z11) {
        ...
        ua uaVar3 = this.f22640s;
        if (uaVar3 != null) {
            uaVar3.setBottomSheetContainerView(getContainer());
            this.f22640s.setTargetListView(w10);
        }
        if (z10) {
            ...
            this.e = waVar;
            waVar.setBackgroundColor(getThemedColor(org.telegram.ui.ActionBar.j6.f19165h5));
            waVar.setTitleColor(getThemedColor(org.telegram.ui.ActionBar.j6.G6));
            waVar.A(getThemedColor(org.telegram.ui.ActionBar.j6.f19498z8), false);
            waVar.setBackButtonImage(R.drawable.ic_ab_back);
            waVar.B(getThemedColor(org.telegram.ui.ActionBar.j6.f19479y8), false);
