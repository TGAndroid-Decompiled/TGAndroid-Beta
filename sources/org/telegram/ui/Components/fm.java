...
public final class fm extends dl0 {
    ...
    public final boolean E(tl0 tl0Var) {
        ...
        boolean isEmpty = ChatAttachAlertPhotoLayout.f24737o1.isEmpty();
        ChatAttachAlertPhotoLayout chatAttachAlertPhotoLayout = this.v;
        if ((!isEmpty || ((albumEntry = chatAttachAlertPhotoLayout.Q0) != null && !albumEntry.photos.isEmpty())) && chatAttachAlertPhotoLayout.f26546b.O && h() > 30) {
            return true;
        }
        return false;
    }
    ...
    public final String F(int i10) {
        ...
        if (M == null) {
            int i11 = this.f26946r;
            ChatAttachAlertPhotoLayout chatAttachAlertPhotoLayout = this.v;
            if (i10 <= i11) {
                ArrayList arrayList2 = ChatAttachAlertPhotoLayout.f24737o1;
    ...
    public final float H(tl0 tl0Var) {
        int i10 = this.v.J0;
        int ceil = (int) Math.ceil(this.f26945n / i10);
        if (tl0Var.getChildCount() != 0) {
            int measuredHeight = tl0Var.getChildAt(0).getMeasuredHeight();
            View childAt = tl0Var.getChildAt(0);
            int R = RecyclerView.R(childAt);
            if (R >= 0) {
                return Utilities.clamp((((R / i10) * measuredHeight) - childAt.getTop()) / ((ceil * measuredHeight) - (tl0Var.getMeasuredHeight() - org.telegram.ui.ActionBar.k.getCurrentActionBarHeight())), 1.0f, 0.0f);
            }
        }
        return 0.0f;
    }
    ...
    public final fl0 L() {
        ChatAttachAlertPhotoLayout chatAttachAlertPhotoLayout = this.v;
        org.telegram.ui.Cells.t5 t5Var = new org.telegram.ui.Cells.t5(this.f26942c, chatAttachAlertPhotoLayout.f26545a);
    ...
    public final int h() {
        ...
        if (!chatAttachAlertPhotoLayout.f24773s0) {
            return 1;
        }
        int i10 = 0;
        this.f26943e = false;
        ...
        this.f26946r = i10;
        if (!z4) {
            i10 += ChatAttachAlertPhotoLayout.f24737o1.size();
            MediaController.AlbumEntry albumEntry = chatAttachAlertPhotoLayout.Q0;
            if (albumEntry != null) {
                i10 += albumEntry.photos.size();
            }
        }
        if (this.f26943e && i10 > chatAttachAlertPhotoLayout.J0 && !chatAttachAlertPhotoLayout.L0) {
            this.f26944f = true;
            i10++;
        }
        if (this == fmVar) {
    ...
    public final int j(int i10) {
        ...
        if (chatAttachAlertPhotoLayout.f24773s0) {
            ...
            if (chatAttachAlertPhotoLayout.f24748d1 && i11 == 0) {
                return 4;
            }
            if (this == fmVar && i10 == this.f26945n - 1) {
                return 2;
            }
            if (z4) {
                return 3;
    ...
    public final void l() {
        ...
        if (this == chatAttachAlertPhotoLayout.D) {
            ...
            if ((h() == 1 && !chatAttachAlertPhotoLayout.M0 && chatAttachAlertPhotoLayout.Q0 == null) || !chatAttachAlertPhotoLayout.f24773s0) {
                i10 = 0;
            } else {
                i10 = 4;
            }
    ...
    public final void v(f2.m1 m1Var, int i10) {
        ...
        if (i11 != 0) {
            if (i11 != 1) {
                if (i11 != 3) {
                    if (i11 == 7) {
                        ((i20) view).setUseAnEmojiVisible(chatAttachAlertPhotoLayout.f24748d1);
                        return;
                    }
                    return;
                }
        ...
        if (this.f26944f && i10 > chatAttachAlertPhotoLayout.J0) {
            i10--;
        }
        ...
        if (this == chatAttachAlertPhotoLayout.D) {
            ...
            if (chatAttachAlertPhotoLayout.f24772s.f5816o == 1) {
                z4 = true;
            } else {
                z4 = false;
            }
        ...
        if ((miVar.f29040c0 instanceof org.telegram.ui.xn) && miVar.Q1) {
            t5Var.b(ChatAttachAlertPhotoLayout.f24739q1.indexOf(Integer.valueOf(b02.imageId)), hashMap.containsKey(Integer.valueOf(b02.imageId)), false);
        } else {
            t5Var.b(-1, hashMap.containsKey(Integer.valueOf(b02.imageId)), false);
        }
        if (!chatAttachAlertPhotoLayout.f24774t0 && b02.isVideo) {
            t5Var.setAlpha(0.3f);
        } else if (!chatAttachAlertPhotoLayout.f24775u0 && !b02.isVideo) {
            t5Var.setAlpha(0.3f);
        } else {
            t5Var.setAlpha(1.0f);
        }
    ...
    public final f2.m1 x(ViewGroup viewGroup, int i10) {
        ChatAttachAlertPhotoLayout chatAttachAlertPhotoLayout = this.v;
        mi miVar = chatAttachAlertPhotoLayout.f26546b;
        org.telegram.ui.ActionBar.g6 g6Var = chatAttachAlertPhotoLayout.f26545a;
        if (i10 != 0) {
            Context context = this.f26942c;
            if (i10 != 1) {
                if (i10 != 2) {
                    if (i10 != 4) {
                        if (i10 != 5) {
                            if (i10 != 7) {
                                if (i10 != 8) {
                                    ...
                                    frameLayout.f23217a = imageView;
                                    ImageView.ScaleType scaleType = ImageView.ScaleType.CENTER;
                                    imageView.setScaleType(scaleType);
                                    int v02 = org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.f21608aa, g6Var);
                                    PorterDuff.Mode mode = PorterDuff.Mode.MULTIPLY;
                                    imageView.setColorFilter(new PorterDuffColorFilter(v02, mode));
                                    frameLayout.addView(imageView, k7.c6.d(44, 44.0f, 17, 5.0f, 0.0f, 0.0f, 27.0f));
                                    ImageView imageView2 = new ImageView(context);
                                    frameLayout.f23218b = imageView2;
                                    imageView2.setScaleType(scaleType);
                                    imageView2.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.f21627ba, g6Var), mode));
                                    frameLayout.addView(imageView2, k7.c6.d(44, 44.0f, 17, 5.0f, 0.0f, 0.0f, 27.0f));
                                    TextView textView = new TextView(context);
                                    frameLayout.f23219c = textView;
                                    org.telegram.ui.b.l(org.telegram.ui.ActionBar.k6.f21645ca, g6Var, textView, 1, 12.0f);
                            ...
                            i20Var.isClickable();
                            i20Var.f27652b.setOnClickListener(new g0(new hl(chatAttachAlertPhotoLayout, 5), 18));
                            i20Var.f27651a.setOnClickListener(new g0(new hl(chatAttachAlertPhotoLayout, 6), 19));
                            i20Var.f27653c.setOnClickListener(new w2(20, i20Var, new v2(this, 2)));
            ...
            view.f23166a = AndroidUtilities.dp(0.0f);
