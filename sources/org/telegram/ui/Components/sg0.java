...
public final class sg0 extends FrameLayout {
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        switch (i10) {
            case 1:
                Paint paint = (Paint) this.f28253c;
                if (this.f28252b) {
                ...
                return;
            case 2:
                Paint paint2 = (Paint) this.f28253c;
                if (this.f28252b) {
            ...
            case 3:
                ...
                if (!this.f28252b && r51Var.f36413r > 0.0f) {
                    if (((Paint) this.f28253c) == null) {
                        ...
                        ((Paint) this.f28253c).setXfermode(new PorterDuffXfermode(PorterDuff.Mode.DST_OUT));
                    }
                    canvas.saveLayerAlpha(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight(), 255, 31);
                    super.dispatchDraw(canvas);
                    ((Paint) this.f28253c).setAlpha((int) (r51Var.f36413r * 255.0f));
                    canvas.drawRect(0.0f, 0.0f, AndroidUtilities.dp(18.0f), getMeasuredHeight(), (Paint) this.f28253c);
                    canvas.restore();
                    return;
                }
                super.dispatchDraw(canvas);
            ...
            case 4:
                ...
                if (view instanceof TextView) {
                    ...
                    if ((z10 || z12) && limitPreviewView.f22330e0 != null) {
                        canvas.saveLayer(view.getLeft(), view.getTop(), view.getRight(), view.getBottom(), (Paint) this.f28253c, 31);
                        rg.t tVar = limitPreviewView.f22330e0;
                        float x10 = getX() + ((ViewGroup) getParent()).getX();
                        float y3 = ((ViewGroup) getParent()).getY();
                        canvas.drawRect(view.getLeft(), view.getTop(), view.getRight(), view.getBottom(), ((org.telegram.ui.v5) ((org.telegram.ui.z0) tVar).f40300b).t0(x10, getY() + y3));
                        canvas.restore();
                        invalidate();
                        return drawChild;
                    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        switch (this.f28251a) {
            case 0:
                ...
                org.telegram.ui.ActionBar.h6.f19348t0.setColor(Color.argb((int) (ah0Var.f22691f.getAlpha() * 255.0f), Color.red(w03), Color.green(w03), Color.blue(w03)));
                canvas.drawRect(ah0.F(ah0Var), 0.0f, getMeasuredWidth() - ah0.G(ah0Var), AndroidUtilities.statusBarHeight, org.telegram.ui.ActionBar.h6.f19348t0);
                return;
            default:
                super.onDraw(canvas);
                return;
        ...
        switch (this.f28251a) {
            case 0:
                ...
                if (motionEvent.getAction() == 0 && ah0Var.E != 0) {
                    if (motionEvent.getY() < AndroidUtilities.dp(12.0f) + ah0Var.E && ah0Var.f22691f.getAlpha() == 0.0f) {
                        ah0Var.dismiss();
                        return true;
                    }
                }
