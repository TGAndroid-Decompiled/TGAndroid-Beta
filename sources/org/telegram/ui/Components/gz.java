...
public final class gz extends vl0 {
    ...
    public String N;
    public final lz Q;
    public final fz f24569c;
    public long d;
    public TLRPC.StickerSet e;
    public ArrayList f24570f;
    public final Context h;
    public int f24575x;
    public boolean f24576y;
    public final SparseArray f24571n = new SparseArray();
    public final SparseArray f24572r = new SparseArray();
    public final SparseArray f24573s = new SparseArray();
    public final SparseIntArray v = new SparseIntArray();
    public final SparseArray f24574w = new SparseArray();
    ...
    public gz(lz lzVar, Context context) {
        this.Q = lzVar;
        this.h = context;
        ?? aVar = new nh.a(context, lzVar.f26236c1, new d(this, 12), new mv(this, 3), lzVar.Z1);
        this.f24569c = aVar;
    ...
    public final int j(int i10) {
        ...
        if (i10 == 1 && this.f24575x == 1) {
            return 5;
        }
        Object obj = this.f24572r.get(i10);
        if (obj == null) {
            return 1;
        }
    ...
    public final void l() {
        ...
        this.P = -1;
        SparseArray sparseArray = this.f24571n;
        sparseArray.clear();
        SparseIntArray sparseIntArray = this.v;
        sparseIntArray.clear();
        SparseArray sparseArray2 = this.f24572r;
        sparseArray2.clear();
        SparseArray sparseArray3 = this.f24574w;
        sparseArray3.clear();
        this.f24575x = 0;
        int size = this.G.size() + this.E.size();
        this.f24569c.Y2.N(false);
        long j3 = this.d;
        String str = "";
        SparseArray sparseArray4 = this.f24573s;
        if (j3 != 0) {
            ArrayList arrayList = this.f24570f;
            int i15 = this.f24575x;
            this.f24575x = i15 + 1;
            sparseArray2.put(i15, "search");
            if (size > 0) {
                int i16 = this.f24575x;
                this.f24575x = i16 + 1;
                this.P = i16;
                sparseArray2.put(i16, "packs");
                int i17 = this.f24575x;
                this.f24575x = i17 + 1;
            ...
            if (str2 != null && !"".equals(str2)) {
                sparseArray3.put(this.f24575x, str2);
            }
            int size2 = arrayList.size();
            int i18 = 0;
            int i19 = 0;
            while (i18 < size2) {
                int i20 = this.f24575x + i19;
            ...
            this.f24575x = (ceil * czVar.d) + this.f24575x;
        } else {
            ...
            int i24 = this.f24575x;
            this.f24575x = i24 + 1;
            sparseArray2.put(i24, "search");
            if (size > 0) {
                int i25 = this.f24575x;
                this.f24575x = i25 + 1;
                this.P = i25;
            ...
            if (!isEmpty) {
                ...
                while (i28 < size3) {
                    ...
                    if (str3 != null && !str.equals(str3)) {
                        sparseArray3.put(this.f24575x + i29, str3);
                        str = str3;
                    }
                ...
                this.f24575x = (czVar.d * ceil2) + this.f24575x;
                i10 = i37 + ceil2;
            } else {
                i11 = i14;
                z11 = isEmpty;
            ...
            if (z12) {
                ...
                if (str5 != null) {
                    sparseArray3.put(this.f24575x, str5);
                }
                int size5 = this.K.size();
                int i41 = 0;
                for (int i42 = 0; i42 < size5; i42++) {
                    int i43 = this.f24575x + i41;
                ...
                this.f24575x = (ceil3 * czVar.d) + this.f24575x;
            }
            if (z11 && !z12 && i12 == 0) {
                this.f24575x = 1;
            }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        lz lzVar = this.Q;
        LongSparseArray longSparseArray = lzVar.f26310z1;
        LongSparseArray longSparseArray2 = lzVar.f26307y1;
        int i12 = c1Var.f42963f;
        View view = c1Var.f42960a;
        SparseArray sparseArray = this.f24572r;
        boolean z11 = true;
        char c10 = 1;
        int i13 = 1;
        z11 = true;
        if (i12 != 0) {
            ...
            if (i10 == this.f24575x) {
                ...
                Object obj2 = this.f24571n.get(i14);
                ...
                if (num == null) {
                    ...
                    int B = org.telegram.messenger.ok.B(82.0f, (int) Math.ceil(num.intValue() / lzVar.f26306y0.d), lzVar.h.getHeight());
                    if (B > 0) {
                        i13 = B;
                    }
                    l3Var.setHeight(i13);
        ...
        f8Var.d(document, null, this.f24573s.get(i10), (String) this.f24574w.get(i10), false, false);
        if (!lzVar.f26258j1.contains(document) && !lzVar.f26261k1.contains(document)) {
            z11 = false;
        }
        f8Var.setRecent(z11);
    }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        switch (i10) {
            ...
            case 1:
                ...
                break;
            case 2:
                f2Var = new org.telegram.ui.Cells.o8(this.h, false, false, lzVar.Z1, lzVar.f26256i2);
                break;
            case 3:
            ...
            case 4:
                ...
                f2Var.setLayoutParams(new s4.p0(-1, lzVar.f26232b1));
                break;
            case 5:
