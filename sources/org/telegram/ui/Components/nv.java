...
public final class nv implements org.telegram.ui.ActionBar.q0, Utilities.Callback5, org.telegram.ui.ActionBar.z1, gg.b2, GenericProvider, f90, ff0, ml0, org.telegram.ui.ky, ai.t9, MessagesStorage.StringCallback, y81, LanguageDetector.StringCallback, dw0 {
    ...
    public void a(int i10) {
        i70 i70Var = (i70) this.f26801b;
        m70 m70Var = i70Var.f24934n;
        m70Var.J(i70Var.f24933f - 1);
        if (i70Var.h == null && !i70Var.e.e() && i70Var.h() <= 2) {
            m70Var.f22910s.e(false, true);
        }
        i70Var.l();
    }
    ...
    public void b(boolean z10) {
        ai.d9 d9Var = (ai.d9) this.f26801b;
        if (z10) {
            d9Var.p(30, false);
        }
    }
    ...
    public boolean d(int i10, View view) {
        ...
        switch (this.f26800a) {
            case 15:
                ak0 ak0Var = (ak0) this.f26801b;
                ArrayList arrayList = ak0Var.f22699n;
                if (ak0Var.f22698f.j(i10) == 0 && (zj0Var = ak0Var.F) != null) {
                ...
                return true;
            default:
                in0 in0Var = (in0) this.f26801b;
                hn0 hn0Var = in0Var.f25095c;
                MessageObject E = hn0Var.E(i10);
                in0 in0Var2 = hn0Var.f24816c;
                if (E == null) {
                    return false;
                }
                if (!in0Var.I.g()) {
                    in0Var.I.a();
                    hn0Var.q(0, in0Var2.f25098r);
                }
                if (in0Var.I.g()) {
                    in0Var.I.e(E, view, 0);
                    if (!in0Var.I.g()) {
    ...
    public void f(org.telegram.ui.ActionBar.a2 a2Var, int i10) {
        switch (this.f26800a) {
            case 2:
                MediaDataController.getInstance(((cz) this.f26801b).v.f26229c1).clearRecentStickers();
                return;
            case 4:
                ((xm) this.f26801b).run();
                return;
            case 5:
                ...
                return;
            case 7:
                m70.Q((m70) this.f26801b);
                return;
            case 23:
                AndroidUtilities.hideKeyboard((EditTextBoldCursor) this.f26801b);
                return;
            case 24:
                hy0 hy0Var = (hy0) this.f26801b;
                hy0Var.e.presentFragment(new StickersActivity(hy0Var.d, null));
                a2Var.dismiss();
                return;
            default:
                AndroidUtilities.hideKeyboard((jy0) this.f26801b);
                a2Var.dismiss();
                return;
        }
    }
    ...
    public void h(int i10) {
        Utilities.Callback callback = ((v51) this.f26801b).C;
        if (callback != null) {
    ...
    public Object provide(Object obj) {
        mc0 mc0Var = (mc0) obj;
        return Float.valueOf(((o1.j) this.f26801b).f15517a / 100.0f);
    }
    ...
    public void run(String str) {
        switch (this.f26800a) {
            case 20:
                final jv0 jv0Var = ((ds0) this.f26801b).d;
                jv0.r(jv0Var).r(jv0Var.f25518j1, str, new Utilities.Callback() {
                    @Override
                ...
                return;
            case 21:
                final jv0 jv0Var2 = ((nt0) this.f26801b).d;
                jv0.r(jv0Var2).r(jv0Var2.f25518j1, str, new Utilities.Callback() {
                    @Override
                    public final void run(Object obj) {
                        int i10 = r2;
    ...
    public boolean u(org.telegram.ui.qy qyVar, ArrayList arrayList, CharSequence charSequence, boolean z10, boolean z11, int i10, int i11, wf1 wf1Var) {
        long j3;
        lo0 lo0Var = (lo0) this.f26801b;
        int i12 = lo0Var.H0;
        ArrayList<MessageObject> arrayList2 = new ArrayList<>();
        HashMap hashMap = lo0Var.f26167z0;
