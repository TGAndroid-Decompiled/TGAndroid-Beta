...
public final class e30 extends LinearLayout implements VoIPService.StateListener, NotificationCenter.NotificationCenterDelegate {
    ...
    public org.telegram.ui.Components.voip.v2 f24445c;
    public org.telegram.ui.Components.voip.v2 d;
    public p9 e;
    public RectF f24446f;
    public Paint h;
    public LinearGradient f24447n;
    public int f24448r;
    public float f24449s;
    public float v;
    ...
    public static void b(e30 e30Var, Context context) {
        ...
        org.telegram.ui.c60.t1(context2, c30Var, z4, false);
    }
    ...
    public final void d(boolean z4) {
        ...
        org.telegram.ui.Components.voip.v2 v2Var2 = this.f24445c;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.groupCallUpdated) {
            e();
            if (VoIPService.getSharedInstance() != null && (mutedByAdmin = VoIPService.getSharedInstance().mutedByAdmin()) != this.f24452y) {
                this.f24452y = mutedByAdmin;
                invalidate();
            }
        }
    }
    ...
    public final void e() {
        String str;
        TextView textView = this.f24444b;
        VoIPService sharedInstance = VoIPService.getSharedInstance();
    ...
    public final void onAttachedToWindow() {
        ...
        if (sharedInstance != null && sharedInstance.groupCall != null) {
            ...
            int[] iArr = org.telegram.ui.ActionBar.j6.f20123p8;
            long j11 = 0;
            if (chat != null) {
                j10 = chat.f19184id;
            } else {
            ...
            int[] iArr2 = org.telegram.ui.ActionBar.j6.f20142q8;
            if (chat != null) {
                j11 = chat.f19184id;
            }
            ...
            this.f24443a.setText(str);
            e();
            sharedInstance.registerStateListener(this);
            if (VoIPService.getSharedInstance() != null) {
                this.f24452y = VoIPService.getSharedInstance().mutedByAdmin();
            }
            float f11 = 0.0f;
            if (this.f24452y) {
                f10 = 1.0f;
            ...
            this.C = f10;
            this.B = (VoIPService.getSharedInstance() == null || VoIPService.getSharedInstance().isMicMute() || this.f24452y) ? 1.0f : 1.0f;
        }
    ...
    public final void onDetachedFromWindow() {
        ...
        NotificationCenter.getInstance(this.f24451x).removeObserver(this, NotificationCenter.groupCallUpdated);
    }
