    ...
    public final void run() {
        switch (this.f26397a) {
            case 0:
                ...
                return;
            case 1:
                af.g.s(this.f26398b, LocaleController.getString(R.string.StarsTOSLink));
                return;
            case 2:
                Activity findActivity = AndroidUtilities.findActivity(this.f26398b);
                ...
                return;
            default:
                Activity findActivity2 = AndroidUtilities.findActivity(this.f26398b);
