...
public final class m40 extends Drawable {
    public byte[] f28376a;
    public final Paint f28377b = new Paint();
    public final int[] f28378c = {-1, -2758925, -13805707, -13657655};
    ...
    public final void draw(Canvas canvas) {
        ...
        if (bArr != null) {
            ...
            int[] iArr = this.f28378c;
            Paint paint = this.f28377b;
            if (length == 16) {
                ...
                for (int i11 = 0; i11 < 8; i11++) {
                    ...
                    while (i12 < 8) {
                        int i13 = i10 + 2;
                        paint.setColor(iArr[Math.abs((this.f28376a[i10 / 8] >> (i10 % 8)) & 3) % 4]);
            ...
            while (i15 < 12) {
                ...
                for (int i17 = 0; i17 < 12; i17++) {
                    paint.setColor(iArr[Math.abs((this.f28376a[i16 / 8] >> (i16 % 8)) & 3) % 4]);
