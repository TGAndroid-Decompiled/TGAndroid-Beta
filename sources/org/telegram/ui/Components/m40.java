...
public final class m40 extends Drawable {
    public byte[] f26060a;
    public final Paint f26061b = new Paint();
    public final int[] f26062c = {-1, -2758925, -13805707, -13657655};

    @Override
    public final void draw(Canvas canvas) {
        byte[] bArr = this.f26060a;
        if (bArr != null) {
            int length = bArr.length;
            int[] iArr = this.f26062c;
            Paint paint = this.f26061b;
            if (length == 16) {
                ...
                for (int i11 = 0; i11 < 8; i11++) {
                    ...
                    while (i12 < 8) {
                        int i13 = i10 + 2;
                        paint.setColor(iArr[Math.abs((this.f26060a[i10 / 8] >> (i10 % 8)) & 3) % 4]);
            ...
            while (i15 < 12) {
                ...
                for (int i17 = 0; i17 < 12; i17++) {
                    paint.setColor(iArr[Math.abs((this.f26060a[i16 / 8] >> (i16 % 8)) & 3) % 4]);
