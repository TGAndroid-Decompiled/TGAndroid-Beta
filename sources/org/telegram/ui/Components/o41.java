...
public final class o41 extends pv0 {
    ...
    public boolean D0;
    public final p41 E0;
    public final Paint f26588w0;
    public boolean f26589x0;
    public boolean f26590y0;
    public boolean f26591z0;
    ...
    public final float Z() {
        p41 p41Var = this.E0;
        return Math.min(1.0f, Math.max(0.0f, p41Var.f26932f / (p41Var.f26930b * 2.0f)));
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        p41 p41Var = this.E0;
        d51 d51Var = p41Var.e;
        int i12 = p41Var.f26930b;
        GradientDrawable gradientDrawable = p41Var.f26931c;
        float Z = Z();
        boolean z13 = false;
        ...
        if (this.D0 != z11) {
            this.D0 = z11;
            if (AndroidUtilities.computePerceivedBrightness(p41Var.getThemedColor(org.telegram.ui.ActionBar.h6.f18859h5)) > 0.721f) {
                z12 = true;
            } else {
                z12 = false;
            }
            if (AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.h6.v(p41Var.getThemedColor(org.telegram.ui.ActionBar.h6.f19065s8), 855638016)) > 0.721f) {
                z13 = true;
            }
            if (!z11) {
                z12 = z13;
        ...
        if (this.B0 > 0.0f) {
            int themedColor2 = p41Var.getThemedColor(org.telegram.ui.ActionBar.h6.f18859h5);
            Paint paint = this.f26588w0;
            paint.setColor(themedColor2);
            int max = (int) Math.max(0.0f, d51Var.getTranslationY() + (AndroidUtilities.statusBarHeight - i12) + ((1.0f - Z()) * i12) + p41Var.f26932f + AndroidUtilities.dp(24.0f));
            i10 = ((org.telegram.ui.ActionBar.f3) p41Var).backgroundPaddingLeft;
        ...
        gradientDrawable.setColor(i0.a.k(p41Var.getThemedColor(org.telegram.ui.ActionBar.h6.Ii), (int) (Color.alpha(themedColor) * Z)));
        gradientDrawable.setBounds((getWidth() - dp) / 2, org.telegram.messenger.z0.C(10.0f, p41Var.f26932f, i13), (getWidth() + dp) / 2, AndroidUtilities.dp(10.0f) + p41Var.f26932f + i13 + dp2);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (Z > 0.0f && Z < 1.0f) {
            ...
            gradientDrawable.setColor(p41Var.getThemedColor(org.telegram.ui.ActionBar.h6.f18859h5));
            float[] fArr = this.C0;
            fArr[3] = dp;
            fArr[2] = dp;
            fArr[1] = dp;
            ...
            gradientDrawable.setBounds(i12, p41Var.f26932f + i15, width - i13, AndroidUtilities.dp(24.0f) + p41Var.f26932f + i15);
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        if (motionEvent.getAction() == 0) {
            p41 p41Var = this.E0;
            if (p41Var.f26932f != 0 && motionEvent.getY() < p41Var.f26932f) {
                p41Var.dismiss();
                return true;
            }
        }
