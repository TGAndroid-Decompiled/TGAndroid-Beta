...
public final class o41 extends v51 {
    ...
    public final void bindView(View view, w51 w51Var, boolean z10, k61 k61Var, s61 s61Var) {
        ...
        LinearLayout linearLayout = p41Var.f27221r;
        LinearLayout linearLayout2 = p41Var.h;
        LinearLayout linearLayout3 = p41Var.f27217b;
        p41Var.f27218c.setText(charSequence);
        p41Var.d.setText(charSequence2);
        p41Var.e.setText(charSequence3);
        ImageView imageView = p41Var.f27219f;
        int i12 = 8;
        ...
        linearLayout.setOnClickListener(new ft(19, p41Var, onClickListener));
        p41Var.e();
    }

    @Override
    public final boolean contentsEquals(w51 w51Var, w51 w51Var2) {
        if (TextUtils.equals(w51Var.f29895l, w51Var2.f29895l) && TextUtils.equals(w51Var.f29896m, w51Var2.f29896m) && TextUtils.equals(w51Var.f29897n, w51Var2.f29897n) && w51Var.E == w51Var2.E) {
            return true;
        }
        return false;
    }
