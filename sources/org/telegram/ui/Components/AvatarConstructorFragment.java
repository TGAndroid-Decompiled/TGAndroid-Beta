...
public class AvatarConstructorFragment extends BaseFragment {
    public static final float STICKER_DEFAULT_ROUND_RADIUS = 0.13f;
    public static final float STICKER_DEFAULT_SCALE = 0.7f;
    ...
    float progressToLightStatusBar;
        ...
        public BackgroundSelectView(Context context) {
            ...
            while (true) {
                ...
                if (i3 >= iArr3.length) {
                    ...
                    setOnItemClickListener(new StarAppsSheet$$ExternalSyntheticLambda0(this, 1));
                    RecyclerView.Adapter adapter = new RecyclerView.Adapter() {
                        private static final int VIEW_TYPE_ADD_CUSTOM = 1;
                        private static final int VIEW_TYPE_GRADIENT = 0;
                        ...
                        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i4) {
                            ...
                            gradientSelectorView.setSelectedInternal(backgroundSelectView.selectedItemId == backgroundSelectView.gradients.get(i4).stableId, true);
                        }
    ...
    public class GradientSelectorView extends View {
        ...
        public void onDraw(Canvas canvas) {
            ...
            if (this.progressToSelect.get() == 0.0f) {
                ...
                canvas.drawCircle(measuredWidth, measuredHeight, ((1.0f - this.progressToSelect.get()) * AndroidUtilities.dp(5.0f)) + AndroidUtilities.dp(10.0f), paint);
            }
            if (this.isLocked) {
            ...
            if (this.isCustom) {
                ...
                canvas.drawCircle(measuredWidth - (this.progressToSelect.get() * AndroidUtilities.dp(5.0f)), measuredHeight, AndroidUtilities.dp(1.5f), this.optionsPaint);
                canvas.drawCircle((this.progressToSelect.get() * AndroidUtilities.dp(5.0f)) + measuredWidth, measuredHeight, AndroidUtilities.dp(1.5f), this.optionsPaint);
            }
        }
    ...
    public class PreviewView extends FrameLayout {
        ...
        public void dispatchDraw(Canvas canvas) {
            ...
            canvas.clipRect(0.0f, (-i) / 2.0f, getMeasuredWidth(), ((i / 2.0f) * AvatarConstructorFragment.this.progressToExpand) + getMeasuredHeight());
            BackgroundGradient backgroundGradient = this.backgroundGradient;
            if (backgroundGradient != null) {
                this.gradientTools.setColors(backgroundGradient.color1, backgroundGradient.color2, backgroundGradient.color3, backgroundGradient.color4);
            ...
            if (animatedEmojiDrawable == null) {
                ...
                float f9 = previewView.cx - fLerp2;
                float f10 = previewView.cy - fLerp2;
            ...
            animatedEmojiDrawable2.setBounds((int) (f12 - fLerp2), (int) (f13 - fLerp2), (int) (f12 + fLerp2), (int) (f13 + fLerp2));
    ...
    public void discardEditor() {
        ...
        builder.setPositiveButton(LocaleController.getString(R.string.PassportDiscard), new AvatarConstructorFragment$$ExternalSyntheticLambda4(this, 1));
    ...
    public void lambda$showColorPicker$6(boolean[] zArr, View view) {
        ...
        this.bottomSheet.lambda$showGiftOfferSheet$15();
    }
    ...
    public void onDonePressed() {
        ...
        if (isLocked()) {
            BulletinFactory.of(this.bottomBulletinContainer, this.resourceProvider).createSimpleBulletin(R.raw.star_premium_2, AndroidUtilities.premiumText(LocaleController.getString(R.string.PremiumAvatarToast), new AvatarConstructorFragment$$ExternalSyntheticLambda3(this, 1))).show();
            return;
        }
    ...
    public void setExpanded(final boolean z, final boolean z2, boolean z3) {
        ...
        this.expandAnimator.addUpdateListener(new InstantCameraView$$ExternalSyntheticLambda3(this, z2, i));
    ...
    public void showColorPicker() {
        ...
        ColorPicker colorPicker = new ColorPicker(getContext(), z, new AvatarConstructorFragment$$ExternalSyntheticLambda4(this, i)) {
            @Override
        ...
        frameLayout.setOnClickListener(new AIEditorAlert$$ExternalSyntheticLambda16(16, this, zArr));
    ...
    public View createView(Context context) {
        ...
        ActionBar actionBar2 = new ActionBar(getContext(), null);
        ...
        final ContainerLayout containerLayout = new ContainerLayout(context) {
            ...
            public void dispatchDraw(Canvas canvas) {
                ...
                if (!avatarConstructorFragment.isLandscapeMode) {
                    if (!avatarConstructorFragment.drawForBlur) {
                        ...
                        rectF.set(x, fLerp - (avatarConstructorFragment4.progressToExpand * f), avatarConstructorFragment4.previewView.getMeasuredWidth() + x, (f * AvatarConstructorFragment.this.progressToExpand) + AvatarConstructorFragment.this.previewView.getMeasuredHeight() + fLerp);
                        float f2 = AvatarConstructorFragment.this.previewView.cx + x;
                        float f3 = AvatarConstructorFragment.this.previewView.cy + fLerp;
                        AvatarConstructorFragment avatarConstructorFragment5 = AvatarConstructorFragment.this;
                        avatarConstructorFragment5.avatarClickableArea.setRect((int) (f2 - avatarConstructorFragment5.previewView.size), (int) (f3 - AvatarConstructorFragment.this.previewView.size), (int) (AvatarConstructorFragment.this.previewView.size + f2), (int) (AvatarConstructorFragment.this.previewView.size + f3));
                        canvas.restore();
                    }
            ...
            public boolean drawChild(Canvas canvas, View view, long j) {
                ...
                if (view == ((BaseFragment) avatarConstructorFragment).actionBar) {
                    ...
                    if (avatarConstructorFragment2.keyboardVisibleProgress > 0.0f) {
                        avatarConstructorFragment2.actionBarPaint.setColor(Theme.getColor(null, Theme.key_windowBackgroundWhite, false));
                        AvatarConstructorFragment avatarConstructorFragment3 = AvatarConstructorFragment.this;
                        ...
                        ((ActionBarLayout) AvatarConstructorFragment.this.getParentLayout()).drawHeaderShadow(canvas2, (int) (AvatarConstructorFragment.this.keyboardVisibleProgress * 255.0f), view.getMeasuredHeight());
                    } else {
                        canvas2 = canvas;
                    }
                } else {
            ...
            public void onMeasure(int i2, int i3) {
                ...
                if (avatarConstructorFragment3.isLandscapeMode) {
                    ...
                    ((ViewGroup.MarginLayoutParams) AvatarConstructorFragment.this.button.getLayoutParams()).rightMargin = AndroidUtilities.dp(16.0f) + size2;
                ...
                if (z2 != AvatarConstructorFragment.this.keyboardVisible) {
                    ...
                    AvatarConstructorFragment avatarConstructorFragment5 = AvatarConstructorFragment.this;
                    int iDp = avatarConstructorFragment5.keyboardVisible ? AndroidUtilities.dp(8.0f) + ((BaseFragment) AvatarConstructorFragment.this).actionBar.getMeasuredHeight() + (-avatarConstructorFragment5.selectAnimatedEmojiDialog.getTop()) : 0;
                    LinearLayout linearLayout = AvatarConstructorFragment.this.linearLayout;
                    linearLayout.setTranslationY((linearLayout.getTranslationY() + ((ViewGroup.MarginLayoutParams) AvatarConstructorFragment.this.linearLayout.getLayoutParams()).topMargin) - iDp);
                    ((ViewGroup.MarginLayoutParams) AvatarConstructorFragment.this.linearLayout.getLayoutParams()).topMargin = iDp;
        ...
        containerLayout.setBackgroundColor(Theme.getColor(null, Theme.key_windowBackgroundGray, false));
        ...
        this.chooseEmojiHint.setTextColor(Theme.getColor(null, i2, false));
        ...
        this.button.setOnClickListener(new HintView$$ExternalSyntheticLambda0(this, 12));
        ...
        canvasButton.setDelegate(new AvatarConstructorFragment$$ExternalSyntheticLambda3(this, 0));
    ...
    public boolean isLightStatusBar() {
        ...
        if (this.isLightInternal != z) {
            ...
            if (this.actionBar.getAlpha() == 0.0f) {
                ...
                valueAnimatorOfFloat.addUpdateListener(new ButtonBounce$$ExternalSyntheticLambda0(this, 24));
    ...
    public boolean onBackPressed(boolean z) {
        ...
        if (z) {
            ...
            builder.setMessage(LocaleController.getString(R.string.PhotoEditorDiscardAlert));
            builder.setTitle(LocaleController.getString(R.string.DiscardChanges));
            builder.setPositiveButton(LocaleController.getString(R.string.PassportDiscard), new AvatarConstructorFragment$$ExternalSyntheticLambda4(this, 0));
            builder.setNegativeButton(LocaleController.getString(R.string.Cancel), null);
            AlertDialog alertDialogCreate = builder.create();
            showDialog(alertDialogCreate);
            alertDialogCreate.redPositive();
