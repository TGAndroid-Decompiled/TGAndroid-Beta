...
public final class l5 implements Runnable {
    ...
    public final void run() {
        switch (this.f26020a) {
            case 0:
                AndroidUtilities.runOnUIThread(new l5(this.f26021b, this.f26022c, this.d, 1));
                return;
            default:
                m5 m5Var = this.f26021b;
                int i10 = m5Var.e;
                HashSet hashSet = new HashSet(this.f26022c);
