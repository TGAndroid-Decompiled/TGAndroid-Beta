...
public final class d2 implements sc0, MediaDataController.KeywordResultCallback, BillingController.ProductDetailsResponseListenerLegacy, org.telegram.ui.ActionBar.b2, OnFailureListener, Utilities.Callback2Return {
    ...
    public void f(org.telegram.ui.ActionBar.c2 c2Var, int i10) {
        ...
        switch (this.f23184a) {
            case 3:
                ...
                org.telegram.ui.qn0.Z(this.f23185b, (String) this.f23187f, secureDocument, on0Var, (org.telegram.ui.qn0) this.f23186c);
                return;
            default:
                yh.f3 f3Var = (yh.f3) this.f23186c;
                Context context = (Context) this.d;
                org.telegram.ui.ActionBar.f6 f6Var = (org.telegram.ui.ActionBar.f6) this.e;
                Utilities.Callback2 callback2 = (Utilities.Callback2) this.f23187f;
                yh.d3 d3Var = (yh.d3) f3Var.f47185o.get(f3Var.f47187q);
                if (d3Var != null) {
                    zf.a aVar2 = d3Var.f47103c;
                    yh.v5 x10 = yh.v5.x(this.f23185b, f3Var.f47187q);
                    if (x10.e) {
                        aVar = zf.a.l(x10.p());
                    } else {
                        aVar = null;
                    }
                    if (aVar != null && aVar2.f48981b > aVar.f48981b) {
                        zf.b bVar = f3Var.f47187q;
                        if (bVar == zf.b.f48982a) {
                            new yh.n7(context, f6Var, aVar2.a(), 14, null, null, 0L).show();
                            return;
                        } else if (bVar == zf.b.f48983b) {
                            new di.h(context, f6Var, d3Var.f47103c, true, null).show();
                            return;
                        } else {
                            return;
                        }
                    }
                    nf.e eVar = f3Var.f47184n;
                    if (eVar != null) {
                        eVar.a(false);
                        f3Var.f47184n = null;
                    }
    ...
    public void onProductDetailsResponse(c5.h hVar, List list) {
        AndroidUtilities.runOnUIThread(new gg.e1((org.telegram.ui.hg0) this.f23186c, (String) this.d, hVar, list, (String) this.e, (String) this.f23187f, this.f23185b));
    }
    ...
    public Object run(Object obj, Object obj2) {
        ...
        int i10;
        or0 or0Var = (or0) this.f23186c;
        org.telegram.ui.ActionBar.o2 o2Var = (org.telegram.ui.ActionBar.o2) this.d;
        Context context = (Context) this.e;
        org.telegram.ui.ActionBar.f6 f6Var = (org.telegram.ui.ActionBar.f6) this.f23187f;
        ...
        if (num.intValue() != -1 && num.intValue() != -2 && num.intValue() != 0 && !or0Var.L) {
            ...
            String publicUsername = DialogObject.getPublicUsername(MessagesController.getInstance(i12).getUserOrChat(or0Var.f46135c));
            boolean h = m5Var.h();
