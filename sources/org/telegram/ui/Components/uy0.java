...
public final class uy0 extends Drawable {
    ...
    public final z5 f31753b;
    public final Drawable f31754c;
    public final Drawable d;
    public int f31755e = 255;

    public uy0(org.telegram.ui.Cells.t1 t1Var) {
        this.f31753b = new z5(t1Var, 420L, pr.h);
        this.f31754c = t1Var.getContext().getResources().getDrawable(R.drawable.summary_arrow);
    ...
    public final void draw(Canvas canvas) {
        ...
        drawable.setAlpha(this.f31755e);
        drawable.draw(canvas);
        float e6 = this.f31753b.e(this.f31752a);
        ...
        Drawable drawable2 = this.f31754c;
        drawable2.setBounds(bounds2);
        drawable2.setAlpha(this.f31755e);
    ...
    public final int getIntrinsicHeight() {
        return this.f31754c.getIntrinsicHeight();
    }

    @Override
    public final int getIntrinsicWidth() {
        return this.f31754c.getIntrinsicWidth();
    }
    ...
    public final void setColorFilter(ColorFilter colorFilter) {
        this.f31754c.setColorFilter(colorFilter);
