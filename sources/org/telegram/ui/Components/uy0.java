...
public final class uy0 extends vl0 {
    public final xy0 f28944c;
    public final xy0 d;

    public uy0(xy0 xy0Var, xy0 xy0Var2) {
        this.d = xy0Var;
        this.f28944c = xy0Var2;
    }
    ...
    @Override
    public final int h() {
        ArrayList arrayList = this.f28944c.f30429w;
        if (arrayList == null) {
            return 0;
        }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        String str;
        wy0 wy0Var = (wy0) c1Var.f42946a;
        xy0 xy0Var = this.f28944c;
        ArrayList arrayList = xy0Var.f30429w;
        if (arrayList == null) {
            str = null;
        } else {
        ...
        if (str != null && str.startsWith("animated_")) {
            try {
                ...
                if (!(drawable instanceof q5) || ((q5) drawable).i() != parseLong) {
                    wy0Var.setImageDrawable(q5.n(UserConfig.selectedAccount, parseLong, null, wy0Var.f30192f.d()));
                }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        return new s4.c1(new wy0(this.d, this.f28944c.getContext()));
    }
}
