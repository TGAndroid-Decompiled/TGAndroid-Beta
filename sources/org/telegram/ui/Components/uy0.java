...
public final class uy0 extends FrameLayout {
    ...
    public Paint f28513b;
    public Paint f28514c;
    public Paint d;
    public RectF e;
    public ty0 f28515f;
    public String[] h;
    ...
    public int f28518s;
    public bj0[] v;
    public float f28519w;
    public float f28520x;
    public int f28521y;

    public final yi0 a(int i10) {
        int i11;
        yi0[] yi0VarArr = this.f28517r;
    ...
    public final void b() {
        ...
        if (this.G == null && this.F != (value = this.f28515f.getValue())) {
            this.F = value;
            int i10 = (this.f28518s + 1) % 2;
            yi0 a2 = a(value);
            if (a2 != null) {
            ...
            AndroidUtilities.updateViewVisibilityAnimated(bj0VarArr[this.f28518s], false, 0.5f, true);
    ...
    public final void c(int i10) {
        yi0[] yi0VarArr = this.f28517r;
        if (yi0VarArr[i10] != null) {
            int d = i0.a.d(0.9f, org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18862d6, false), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18847c9, false));
            int w02 = org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18883e9, false);
            if (i10 == 2) {
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        accessibilityNodeInfo.setContentDescription(this.h[this.f28515f.getValue()]);
    ...
    public void setBackgroundColor(int i10) {
        ...
        for (int i11 = 0; i11 < this.f28517r.length; i11++) {
            c(i11);
        }
        ty0Var.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18969j5, false));
        ty0Var.invalidate();
    }
}
