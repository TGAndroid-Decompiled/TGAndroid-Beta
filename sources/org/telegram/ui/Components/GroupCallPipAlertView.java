...
public class GroupCallPipAlertView extends LinearLayout implements VoIPService.StateListener, NotificationCenter.NotificationCenterDelegate {
    ...
    public GroupCallPipAlertView(final Context context, int i) {
        ...
        FrameLayout frameLayout2 = this.groupInfoContainer;
        int iDp = AndroidUtilities.dp(6.0f);
        int alphaComponent = ColorUtils.setAlphaComponent(-1, 76);
        frameLayout2.setBackground(Theme.createSimpleSelectorRoundRectDrawable(iDp, iDp, iDp, iDp, 0, alphaComponent, alphaComponent));
        this.groupInfoContainer.setOnClickListener(new HintView$$ExternalSyntheticLambda0(this, 25));
        ...
        this.soundButton.setOnClickListener(new View.OnClickListener(this) {
        ...
        final int i4 = 2;
        this.leaveButton.setOnClickListener(new View.OnClickListener(this) {
            public final GroupCallPipAlertView f$0;
    ...
    public void lambda$new$4(Context context, View view) {
        GroupCallActivity.onLeaveClick(getContext(), new GroupCallPipAlertView$$ExternalSyntheticLambda0(context, 0), Build.VERSION.SDK_INT < 23 || Settings.canDrawOverlays(context));
    }
