...
public class qq extends Drawable implements Drawable.Callback {
    public Drawable f27726a;
    public final Drawable f27727b;
    ...
    public qq(Drawable drawable, Drawable drawable2, int i10, int i11) {
        this.f27726a = drawable;
        this.f27727b = drawable2;
        this.f27728c = i10;
        this.d = i11;
        if (drawable2 != null) {
    ...
    public void draw(Canvas canvas) {
        canvas.save();
        canvas.translate(this.f27734x, 0.0f);
        if (this.f27731r) {
        ...
        Drawable drawable = this.f27726a;
        if (drawable != null) {
            drawable.setBounds(getBounds());
            this.f27726a.draw(canvas);
        }
        Drawable drawable2 = this.f27727b;
        if (drawable2 != null) {
            boolean z10 = this.f27733w;
            int i10 = this.d;
            int i11 = this.f27728c;
            if (z10) {
                ...
                int centerX = (getBounds().centerX() - (this.e / 2)) + i11 + this.f27732s;
    ...
    public final Drawable.ConstantState getConstantState() {
        return this.f27727b.getConstantState();
    }

    @Override
    public final int getIntrinsicHeight() {
        int i10 = this.f27730n;
        if (i10 != 0) {
            return i10;
        }
        return this.f27726a.getIntrinsicHeight();
    }
    ...
    public final int getIntrinsicWidth() {
        ...
        return this.f27726a.getIntrinsicWidth();
    }
    ...
    public final int getMinimumHeight() {
        ...
        return this.f27726a.getMinimumHeight();
    }
    ...
    public final int getMinimumWidth() {
        ...
        return this.f27726a.getMinimumWidth();
    }

    @Override
    public final int getOpacity() {
        return this.f27727b.getOpacity();
    }

    @Override
    public final int[] getState() {
        return this.f27727b.getState();
    }
    ...
    public final boolean isStateful() {
        return this.f27727b.isStateful();
    }

    @Override
    public final void jumpToCurrentState() {
        this.f27727b.jumpToCurrentState();
    }
    ...
    public final void setAlpha(int i10) {
        this.f27727b.setAlpha(i10);
        this.f27726a.setAlpha(i10);
    }

    @Override
    public void setColorFilter(ColorFilter colorFilter) {
        this.f27727b.setColorFilter(colorFilter);
    }

    @Override
    public final boolean setState(int[] iArr) {
        this.f27727b.setState(iArr);
        return true;
    }
