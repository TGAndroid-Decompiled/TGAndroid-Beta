    ...
    public static void a(org.telegram.ui.wn wnVar, int i10, TLRPC.Chat chat, TLRPC.User user, TLRPC.TL_forumTopic tL_forumTopic, long j3, int i11, int i12) {
        ...
        if ((chat != null || user != null) && (parentLayout = wnVar.getParentLayout()) != null) {
            ...
            for (n9 n9Var : parentLayout.getPulledDialogs()) {
                if (tL_forumTopic != null || n9Var.f26665f != j3) {
                    if (tL_forumTopic != null && (tL_forumTopic2 = n9Var.e) != null && tL_forumTopic2.f18373id == tL_forumTopic.f18373id) {
                        return;
                    }
                } else {
                    return;
            ...
            ?? obj = new Object();
            obj.f26662a = org.telegram.ui.wn.class;
            obj.f26663b = i10;
            obj.f26665f = j3;
            obj.h = i12;
            obj.f26666g = i11;
