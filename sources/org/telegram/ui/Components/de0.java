...
public class de0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    public static final int[] f23666a0 = {R.id.passcode_btn_0, R.id.passcode_btn_1, R.id.passcode_btn_2, R.id.passcode_btn_3, R.id.passcode_btn_4, R.id.passcode_btn_5, R.id.passcode_btn_6, R.id.passcode_btn_7, R.id.passcode_btn_8, R.id.passcode_btn_9, R.id.passcode_btn_backspace, R.id.passcode_btn_fingerprint};
    ...
    public final int[] W;
    public Drawable f23667a;
    public final FrameLayout f23668b;
    public final TextView f23669c;
    public final FrameLayout d;
    public final ai.x5 e;
    public final ArrayList f23670f;
    public final FrameLayout h;
    public final be0 f23671n;
    public final EditTextBoldCursor f23672r;
    public final ci.m9 f23673s;
    public final ci.n6 v;
    public final TextView f23674w;
    public final TextView f23675x;
    public final ImageView f23676y;
    ...
    public de0(Context context) {
        ...
        this.f23672r = editTextBoldCursor;
                        ...
                        if (de0Var.U) {
                            ...
                            switch (intValue) {
                                ...
                                case 10:
                                    ...
                                    break;
                                case 11:
                                    ArrayList arrayList = (ArrayList) m9Var2.f5049c;
                                    Property property = View.TRANSLATION_Y;
                                    Property property2 = View.ALPHA;
                                    Property property3 = View.SCALE_Y;
                                    Property property4 = View.SCALE_X;
                                    ArrayList arrayList2 = (ArrayList) m9Var2.f5048b;
        ...
        while (true) {
            ...
            this.f23670f.add(be0Var);
            i11++;
        }
        for (i10 = 11; i10 >= 0; i10--) {
            this.e.addView((FrameLayout) this.f23670f.get(i10), w7.y5.e(60, 60, 51));
        }
        d();
    }
    ...
    public static void a(de0 de0Var) {
        ...
        float f7;
        float f10;
        FrameLayout frameLayout = de0Var.f23668b;
        ci.m9 m9Var = de0Var.f23673s;
        ...
        if (frameLayout != null) {
            ...
            org.telegram.messenger.rk.s(scaleX.scaleY(f11), qr.h, 320L);
        }
    }
    ...
    public final void b(nc0 nc0Var) {
        ...
        kVar2.f15537u = org.telegram.ui.Cells.c1.m(100.0f, 300.0f, 1.0f);
        this.L = kVar2;
        kVar2.a(new ei.m4(4, this, nc0Var));
        this.L.b(new j7(nc0Var, 4));
        this.L.f();
    }
    ...
    public final void c() {
        ...
        fe0 fe0Var;
        if (Build.VERSION.SDK_INT >= 23 && (findActivity = AndroidUtilities.findActivity(getContext())) != null && this.f23671n.getVisibility() == 0 && !ApplicationLoader.mainInterfacePaused) {
            if (findActivity instanceof LaunchActivity) {
                LaunchActivity launchActivity = (LaunchActivity) findActivity;
                ArrayList arrayList = launchActivity.B0;
                if (arrayList.isEmpty() && (fe0Var = launchActivity.A0) != null) {
                    if (this != fe0Var.f24213b) {
                        return;
                    }
            ...
            try {
                if (new aa.a(new k6.h(getContext(), 1)).i(15) == 0 && FingerprintController.isKeyReady() && !FingerprintController.checkDeviceFingerprintsChanged()) {
                    ...
                    lVar.f12912b = LocaleController.getString(R.string.UnlockToUse);
    ...
    public final void e() {
        ...
        EditTextBoldCursor editTextBoldCursor = this.f23672r;
        FrameLayout frameLayout = this.h;
        org.telegram.ui.Cells.u6 u6Var = this.R;
        TextView textView = this.f23675x;
        if (j10 > 0) {
    ...
    public final boolean g() {
        ...
        if (j4Var != null && j4Var.c()) {
            AndroidUtilities.hideKeyboard(this.f23672r);
            return false;
        }
        return true;
    }
    ...
    public final void i() {
        e();
        if (this.f23675x.getVisibility() != 0) {
            if (SharedConfig.passcodeType == 1) {
                EditTextBoldCursor editTextBoldCursor = this.f23672r;
    ...
    public final void j(boolean z10, int i10, int i11, org.telegram.ui.r80 r80Var) {
        ...
        if (z12) {
            ...
            this.f23667a = org.telegram.ui.ActionBar.j6.r0();
            ...
            if (org.telegram.ui.ActionBar.j6.W && !"CJz3BZ6YGEYBAAAABboWp6SAv04".equals(org.telegram.ui.ActionBar.j6.H0()) && !"qeZWES8rGVIEAAAARfWlK1lnfiI".equals(org.telegram.ui.ActionBar.j6.H0())) {
                org.telegram.ui.ActionBar.b6 b6Var = org.telegram.ui.ActionBar.j6.I.f19000i0;
                ...
                if (!"d".equals(org.telegram.ui.ActionBar.j6.H0())) {
                    ...
                    if (!org.telegram.ui.ActionBar.j6.f19212j0 && !"CJz3BZ6YGEYBAAAABboWp6SAv04".equals(H0) && !"qeZWES8rGVIEAAAARfWlK1lnfiI".equals(H0)) {
        ...
        Drawable drawable = this.f23667a;
        if (drawable instanceof nc0) {
            nc0 nc0Var = (nc0) drawable;
            int[] iArr = nc0Var.f26725a;
            if (z11) {
            ...
            this.f23667a = new nc0(false, iArr[0], iArr[1], iArr[2], iArr[3]);
            if (nc0Var.f26746u != null && nc0Var.f26742q < 0) {
                n6Var.setBackgroundColor(2130706432);
            } else {
                n6Var.setBackgroundColor(570425344);
            }
            ((nc0) this.f23667a).r(n6Var);
        }
        this.f23674w.setText(LocaleController.getString(R.string.AppLocked));
        int i16 = SharedConfig.passcodeType;
        ImageView imageView = this.E;
        ImageView imageView2 = this.f23676y;
        ai.x5 x5Var = this.e;
        ci.m9 m9Var = this.f23673s;
        if (i16 == 0) {
            if (textView.getVisibility() != 0) {
            ...
            imageView.setVisibility(this.f23671n.getVisibility());
        }
        setVisibility(0);
    ...
    public final void k(boolean z10) {
        ...
        if (!z10) {
            if (SharedConfig.passcodeRetryInMs <= 0) {
                ...
                FrameLayout frameLayout = this.f23668b;
                if (length == 0) {
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        TextView textView = this.f23674w;
        int[] iArr = this.W;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (z10) {
            ...
            nj0Var.setTranslationX((f11 / f10) - AndroidUtilities.dp(29.0f));
            ...
            int z11 = org.telegram.messenger.rk.z(140.0f, i17, 2);
            if (SharedConfig.passcodeType == 0) {
            ...
            if (AndroidUtilities.isTablet()) {
                ...
                if (i17 > AndroidUtilities.dp(528.0f)) {
                    i19 = org.telegram.messenger.rk.z(528.0f, i17, 2);
        ...
        for (int i23 = 0; i23 < 12; i23++) {
            ...
            FrameLayout frameLayout3 = (FrameLayout) this.f23670f.get(i23);
