...
public class de0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    public static final int[] f23679a0 = {R.id.passcode_btn_0, R.id.passcode_btn_1, R.id.passcode_btn_2, R.id.passcode_btn_3, R.id.passcode_btn_4, R.id.passcode_btn_5, R.id.passcode_btn_6, R.id.passcode_btn_7, R.id.passcode_btn_8, R.id.passcode_btn_9, R.id.passcode_btn_backspace, R.id.passcode_btn_fingerprint};
    ...
    public de0(Context context) {
        ...
        this.f23685r = editTextBoldCursor;
                            ...
                            switch (intValue) {
                                ...
                                case 11:
                                    ...
                                    if (sb2.length() == 0) {
                                        ...
                                        ((AnimatorSet) j9Var2.e).addListener(new zd0(j9Var2, 1));
        ...
        while (true) {
            ...
            be0Var.setTag(Integer.valueOf(i11));
            if (i11 == 11) {
                int dp = AndroidUtilities.dp(30.0f);
                be0Var.setBackground(org.telegram.ui.ActionBar.h6.i0(dp, dp, dp, dp, 0, 654311423, 654311423));
                be0Var.setImage(R.drawable.filled_clear);
                be0Var.setOnLongClickListener(new o10(this, 1));
                ...
                be0Var.setBackground(org.telegram.ui.ActionBar.h6.i0(dp2, dp2, dp2, dp2, 0, 654311423, 654311423));
                ...
                be0Var.setBackground(org.telegram.ui.ActionBar.h6.i0(dp3, dp3, dp3, dp3, 654311423, 1291845631, 1291845631));
                be0Var.setContentDescription(i11 + "");
                be0Var.setNum(i11);
                if (i11 == 0) {
            ...
            this.f23683f.add(be0Var);
            i11++;
        }
        for (i10 = 11; i10 >= 0; i10--) {
            this.e.addView((FrameLayout) this.f23683f.get(i10), w7.y5.e(60, 60, 51));
        }
        d();
    }
    ...
    public static void a(de0 de0Var) {
        ...
        float f7;
        float f10;
        FrameLayout frameLayout = de0Var.f23681b;
        ci.j9 j9Var = de0Var.f23686s;
    ...
    public final void c() {
        ...
        fe0 fe0Var;
        if (Build.VERSION.SDK_INT >= 23 && (findActivity = AndroidUtilities.findActivity(getContext())) != null && this.f23684n.getVisibility() == 0 && !ApplicationLoader.mainInterfacePaused) {
            if (findActivity instanceof LaunchActivity) {
                LaunchActivity launchActivity = (LaunchActivity) findActivity;
                ArrayList arrayList = launchActivity.B0;
                if (arrayList.isEmpty() && (fe0Var = launchActivity.A0) != null) {
                    if (this != fe0Var.f24260b) {
                        return;
                    }
            ...
            try {
                if (new aa.a(new k6.h(getContext(), 1)).f(15) == 0 && FingerprintController.isKeyReady() && !FingerprintController.checkDeviceFingerprintsChanged()) {
                    a6.m mVar = new a6.m(LaunchActivity.G1, f0.e.e(getContext()), new vd0(this));
    ...
    public final void d() {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.de0.d():void");
    }
    ...
    public final void e() {
        ...
        EditTextBoldCursor editTextBoldCursor = this.f23685r;
        FrameLayout frameLayout = this.h;
        org.telegram.ui.Cells.t6 t6Var = this.R;
        TextView textView = this.f23688x;
        if (j10 > 0) {
    ...
    public final boolean g() {
        ...
        if (i4Var != null && i4Var.c()) {
            AndroidUtilities.hideKeyboard(this.f23685r);
            return false;
        }
        return true;
    }
    ...
    public final void i() {
        e();
        if (this.f23688x.getVisibility() != 0) {
            if (SharedConfig.passcodeType == 1) {
                EditTextBoldCursor editTextBoldCursor = this.f23685r;
    ...
    public final void j(boolean z10, int i10, int i11, org.telegram.ui.n80 n80Var) {
        ...
        v9 v9Var = null;
        this.f23680a = null;
        boolean z12 = org.telegram.ui.ActionBar.h6.r0() instanceof nc0;
        ci.m6 m6Var = this.v;
        if (z12) {
            z11 = !org.telegram.ui.ActionBar.h6.I.q();
            this.f23680a = org.telegram.ui.ActionBar.h6.r0();
        ...
        if (drawable instanceof nc0) {
            ...
            this.f23680a = new nc0(false, iArr[0], iArr[1], iArr[2], iArr[3]);
            if (nc0Var.f26773u != null && nc0Var.f26769q < 0) {
                m6Var.setBackgroundColor(2130706432);
            } else {
                m6Var.setBackgroundColor(570425344);
            }
            ((nc0) this.f23680a).r(m6Var);
        }
        this.f23687w.setText(LocaleController.getString(R.string.AppLocked));
        int i16 = SharedConfig.passcodeType;
        ImageView imageView = this.E;
        ImageView imageView2 = this.f23689y;
        ai.w5 w5Var = this.e;
        ci.j9 j9Var = this.f23686s;
        if (i16 == 0) {
            if (textView.getVisibility() != 0) {
            ...
            imageView.setVisibility(this.f23684n.getVisibility());
        }
        setVisibility(0);
        ...
        if (z10) {
            setAlpha(0.0f);
            getViewTreeObserver().addOnGlobalLayoutListener(new yd0(this, i10, i11, n80Var));
            requestLayout();
        } else {
            setAlpha(1.0f);
            this.P = 1.0f;
            f(1.0f);
            mj0 mj0Var = this.I;
            mj0Var.setScaleX(1.0f);
            mj0Var.setScaleY(1.0f);
            mj0Var.i();
            mj0Var.getAnimatedDrawable().N(38, false, false);
            if (n80Var != null) {
                n80Var.run();
            }
        }
    ...
    public final void k(boolean z10) {
        ...
        if (!z10) {
            if (SharedConfig.passcodeRetryInMs <= 0) {
                ...
                FrameLayout frameLayout = this.f23681b;
                if (length == 0) {
        ...
        mj0 mj0Var = this.I;
        mj0Var.getAnimatedDrawable().P(71);
        mj0Var.getAnimatedDrawable().N(37, false, false);
        mj0Var.d();
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        TextView textView = this.f23687w;
        int[] iArr = this.W;
        ...
        if (!isTablet && getContext().getResources().getConfiguration().orientation == 2) {
            ...
            this.H = dp;
            mj0Var.setTranslationY(dp);
            return;
        }
        int dp2 = iArr[1] - AndroidUtilities.dp(100.0f);
        this.H = dp2;
        mj0Var.setTranslationY(dp2);
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (z10) {
            ...
            mj0Var.setTranslationX((f11 / f10) - AndroidUtilities.dp(29.0f));
            ...
            mj0Var.setTranslationX((size / 2.0f) - AndroidUtilities.dp(29.0f));
        ...
        for (int i23 = 0; i23 < 12; i23++) {
            ...
            FrameLayout frameLayout3 = (FrameLayout) this.f23683f.get(i23);
