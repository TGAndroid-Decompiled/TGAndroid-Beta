...
public final class ak0 extends FrameLayout {
    public final Paint f22703a;
    public final RectF f22704b;
    public final float f22705c;
    public final v9 d;
    public final ImageView e;
    public final TextView f22706f;
    public final View h;
    public float f22707n;
    public final Drawable f22708r;
    public int f22709s;
    public zg.o0 v;
    ...
    public ak0(Context context) {
        ...
        this.f22703a = new Paint(1);
        new Path();
        this.f22704b = new RectF();
        this.f22705c = AndroidUtilities.dp(32.0f);
        ...
        this.f22706f = textView;
        textView.setImportantForAccessibility(2);
        textView.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19281n8, false));
        textView.setTypeface(AndroidUtilities.bold());
        addView(textView, w7.y5.i(-1.0f, -2.0f, 8388627, 40.0f, 0.0f, 8.0f, 0.0f));
        paint.setStyle(Paint.Style.STROKE);
        paint.setStrokeWidth(AndroidUtilities.dp(1.0f));
        setWillNotDraw(false);
        setOutlineProgress(this.f22707n);
    }
    ...
    public final void a(int i10, TLRPC.ReactionCount reactionCount) {
        ...
        this.f22706f.setText(formatShortNumber);
        ...
        if (str != null) {
            for (TLRPC.TL_availableReaction tL_availableReaction : MediaDataController.getInstance(i10).getReactionsList()) {
                if (tL_availableReaction.reaction.equals(this.v.f49423f)) {
                    v9Var.i(ImageLocation.getForDocument(tL_availableReaction.center_icon), "40_40_lastreactframe", "webp", DocumentObject.getSvgThumb(tL_availableReaction.static_icon, org.telegram.ui.ActionBar.j6.f19038a7, 1.0f), tL_availableReaction);
        ...
        v9Var.setAnimatedEmojiDrawable(new p5(0, i10, this.v.f49424g));
        v9Var.setVisibility(0);
        imageView.setVisibility(8);
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        float f7 = this.f22705c;
        canvas.drawRoundRect(rectF, f7, f7, this.f22703a);
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (this.f22707n > 0.5d) {
            accessibilityNodeInfo.setSelected(true);
        }
        zg.o0 o0Var = this.v;
        if (o0Var != null) {
            accessibilityNodeInfo.setText(LocaleController.formatPluralString("AccDescrNumberOfPeopleReactions", this.f22709s, o0Var));
        } else {
            accessibilityNodeInfo.setText(LocaleController.formatPluralString("ReactionsCount", this.f22709s, new Object[0]));
        }
    }
    ...
    public void setOutlineProgress(float f7) {
        ...
        this.f22703a.setColor(i0.a.d(f7, k10, w02));
        this.f22706f.setTextColor(d);
        this.f22708r.setColorFilter(new PorterDuffColorFilter(d, PorterDuff.Mode.MULTIPLY));
