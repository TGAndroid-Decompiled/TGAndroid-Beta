...
public final class ak0 extends s4.s0 {
    ...
    public final void b(RecyclerView recyclerView, int i10, int i11) {
        ...
        float f10 = 0.0f;
        if (z10 != this.f22432a) {
            ValueAnimator valueAnimator = this.f22434c;
            if (valueAnimator != null) {
                valueAnimator.cancel();
            }
            float f11 = gk0Var.f24299r;
            if (z10) {
                f7 = 1.0f;
            } else {
                f7 = 0.0f;
            }
            this.f22434c = c(f11, f7, new q0.a(this) {
                public final ak0 f30263b;
                ...
                public final void accept(Object obj) {
                    ...
                    switch (r2) {
                        case 0:
                            gk0 gk0Var2 = this.f30263b.e;
                            Paint paint = gk0Var2.h;
                            float floatValue = f12.floatValue();
                            gk0Var2.f24299r = floatValue;
                            paint.setAlpha((int) (floatValue * 255.0f));
                            gk0Var2.invalidate();
                            return;
                        default:
                            gk0 gk0Var3 = this.f30263b.e;
                            Paint paint2 = gk0Var3.f24294n;
                            float floatValue2 = f12.floatValue();
                            gk0Var3.f24301s = floatValue2;
        ...
        if (j0Var.N0() != gk0Var.f24269a0.h() - 1) {
            z11 = true;
        }
        if (z11 != this.f22433b) {
