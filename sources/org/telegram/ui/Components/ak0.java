...
public final class ak0 extends FrameLayout {
    ...
    public final MessageObject f22640c;
    public final TLRPC.Reaction d;
    public final sj0 e;
    public final tj0 f22641f;
    public final vj0 h;
    public final ArrayList f22642n;
    public final LongSparseArray f22643r;
    public String f22644s;
    public boolean v;
    ...
    public ak0(Context context, org.telegram.ui.ActionBar.e6 e6Var, int i10, MessageObject messageObject, TLRPC.ReactionCount reactionCount, boolean z10) {
        ...
        this.f22643r = new LongSparseArray();
        this.f22646x = true;
        ArrayList arrayList = new ArrayList();
        this.H = arrayList;
        this.I = new ArrayList();
        this.f22639b = i10;
        this.f22640c = messageObject;
        ...
        if (Build.VERSION.SDK_INT >= 29) {
            sj0Var.setVerticalScrollbarThumbDrawable(new ColorDrawable(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19152i6, false)));
        }
        ...
        this.h = vj0Var;
        vj0Var.f(org.telegram.ui.ActionBar.j6.G8, org.telegram.ui.ActionBar.j6.f19152i6, -1);
        vj0Var.setIsSingleCell(true);
        vj0Var.setItemsCount(this.f22638a);
    ...
    public static void a(ak0 ak0Var, TLObject tLObject) {
        ...
        LongSparseArray longSparseArray = ak0Var.f22643r;
        ArrayList arrayList2 = ak0Var.f22642n;
        int i10 = ak0Var.f22639b;
    ...
    public final void c() {
        ...
        MessageObject messageObject = this.f22640c;
        tL_messages_getMessageReactionsList.peer = messagesController.getInputPeer(messageObject.getDialogId());
        tL_messages_getMessageReactionsList.f18389id = messageObject.getId();
    ...
    public final void h(List list) {
        ArrayList arrayList = this.f22642n;
        if (arrayList != null && !arrayList.isEmpty()) {
            Iterator it = list.iterator();
            while (it.hasNext()) {
                pj0 pj0Var = (pj0) it.next();
                TLObject tLObject = pj0Var.f27249a;
                if (pj0Var.f27251c > 0) {
                    int i10 = 0;
                    while (true) {
                        if (i10 < arrayList.size()) {
                            TLRPC.MessagePeerReaction messagePeerReaction = (TLRPC.MessagePeerReaction) arrayList.get(i10);
                            if (messagePeerReaction != null && messagePeerReaction.date <= 0 && MessageObject.getPeerId(messagePeerReaction.peer_id) == pj0Var.f27250b) {
                                messagePeerReaction.date = pj0Var.f27251c;
        ...
        while (it2.hasNext()) {
            ...
            long j3 = pj0Var2.f27250b;
            TLObject tLObject2 = pj0Var2.f27249a;
            LongSparseArray longSparseArray = this.f22643r;
            if (((ArrayList) longSparseArray.get(j3)) == null) {
                ...
                if (tLObject2 instanceof TLRPC.User) {
                    ...
                    tL_peerUser.user_id = ((TLRPC.User) tLObject2).f18443id;
                } else if (tLObject2 instanceof TLRPC.Chat) {
                    TLRPC.TL_peerChat tL_peerChat = new TLRPC.TL_peerChat();
                    tL_messagePeerReaction.peer_id = tL_peerChat;
                    tL_peerChat.chat_id = ((TLRPC.Chat) tLObject2).f18296id;
                }
                tL_messagePeerReaction.date = pj0Var2.f27251c;
    ...
    public final void i() {
        ...
        while (true) {
            ...
            TLRPC.InputStickerSet inputStickerSet = MessageObject.getInputStickerSet(q5.f(i10, ((zg.o0) arrayList3.get(i11)).f49378g));
            if (inputStickerSet != null && !hashSet.contains(Long.valueOf(inputStickerSet.f18316id))) {
                arrayList2.add(inputStickerSet);
                hashSet.add(Long.valueOf(inputStickerSet.f18316id));
            }
            i11++;
        }
        ...
        arrayList.addAll(arrayList2);
        cb0 cb0Var = new cb0(this.f22639b, getContext(), this.K, arrayList2, 1);
        this.J = cb0Var;
        cb0Var.K = false;
    }
