...
public final class l81 extends View {
    ...
    public MediaMetadataRetriever f26028r;
    public k81 f26029s;
    ...
    public l81(Context context) {
        ...
        paint2.setColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19053a7, false));
        this.L = 0;
        j81 j81Var = this.P;
        if (j81Var != null) {
            j81Var.b();
    ...
    public final void a(boolean z10) {
        synchronized (T) {
            try {
                MediaMetadataRetriever mediaMetadataRetriever = this.f26028r;
        ...
        if (this.f26028r != null) {
            if (i10 == 0) {
                if (this.I) {
                    ...
                    this.f26032y = (int) Math.ceil((getMeasuredWidth() - AndroidUtilities.dp(16.0f)) / this.F);
                }
                this.f26031x = this.f26023a / this.F;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        int dp = AndroidUtilities.dp(12.0f) + ((int) (this.f26024b * measuredWidth));
        int dp2 = AndroidUtilities.dp(12.0f) + ((int) (measuredWidth * this.f26025c));
        float f7 = 32.0f;
        int measuredHeight = (getMeasuredHeight() - AndroidUtilities.dp(32.0f)) >> 1;
        ArrayList arrayList = this.v;
        if (arrayList.isEmpty() && this.f26030w == null) {
            b(0);
        }
        if (!arrayList.isEmpty()) {
            if (!this.O) {
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        if (motionEvent != null) {
            ...
            int dp = AndroidUtilities.dp(12.0f) + ((int) (this.f26024b * f7));
            int dp2 = AndroidUtilities.dp(12.0f) + ((int) (this.f26025c * f7));
            if (motionEvent.getAction() == 0) {
                getParent().requestDisallowInterceptTouchEvent(true);
                if (this.f26028r != null) {
                    int dp3 = AndroidUtilities.dp(24.0f);
                    if (dp - dp3 <= x10 && x10 <= dp + dp3 && y3 >= 0.0f && y3 <= getMeasuredHeight()) {
                        k81 k81Var = this.f26029s;
                        if (k81Var != null) {
                            ((df) k81Var).f23677a.Z2.K(0.0f, 1);
                        }
                        this.f26026f = true;
                        this.f26027n = (int) (x10 - dp);
                        this.P.setTime((int) ((((float) this.f26023a) / 1000.0f) * this.f26024b));
                        this.P.setCx(AndroidUtilities.dp(4.0f) + getLeft() + dp);
                        this.P.a(true);
                        invalidate();
                        return true;
                    } else if (dp2 - dp3 <= x10 && x10 <= dp3 + dp2 && y3 >= 0.0f && y3 <= getMeasuredHeight()) {
                        k81 k81Var2 = this.f26029s;
                        if (k81Var2 != null) {
                            ((df) k81Var2).f23677a.Z2.K(0.0f, 1);
                        }
                        this.h = true;
                        this.f26027n = (int) (x10 - dp2);
                        this.P.setTime((int) ((((float) this.f26023a) / 1000.0f) * this.f26025c));
                ...
                if (motionEvent.getAction() == 2) {
                    if (this.f26026f) {
                        ...
                        this.f26024b = dp4;
                        float f10 = this.f26025c;
                        float f11 = f10 - dp4;
                        float f12 = this.G;
                        if (f11 > f12) {
                            this.f26025c = dp4 + f12;
                        } else {
                            float f13 = this.H;
                            if (f13 != 0.0f && f11 < f13) {
                                float f14 = f10 - f13;
                        ...
                        this.P.setCx(((AndroidUtilities.dpf2(12.0f) + (f7 * this.f26024b)) + getLeft()) - AndroidUtilities.dp(4.0f));
                        this.P.setTime((int) ((((float) this.f26023a) / 1000.0f) * this.f26024b));
                        this.P.a(true);
                        k81 k81Var3 = this.f26029s;
                        if (k81Var3 != null) {
                            float f15 = this.f26024b;
                            ChatActivityEnterView chatActivityEnterView = ((df) k81Var3).f23677a;
                            VideoEditedInfo videoEditedInfo = chatActivityEnterView.f21997e3;
                        ...
                        this.f26025c = dp5;
                        float f16 = this.f26024b;
                        float f17 = dp5 - f16;
                        float f18 = this.G;
                        if (f17 > f18) {
                            this.f26024b = dp5 - f18;
                        } else {
                            float f19 = this.H;
                            if (f19 != 0.0f && f17 < f19) {
                                float f20 = f16 + f19;
                        ...
                        this.P.setCx(AndroidUtilities.dpf2(12.0f) + (f7 * this.f26025c) + getLeft() + AndroidUtilities.dp(4.0f));
                        this.P.a(true);
                        this.P.setTime((int) ((((float) this.f26023a) / 1000.0f) * this.f26025c));
                        k81 k81Var4 = this.f26029s;
                        if (k81Var4 != null) {
                            float f21 = this.f26025c;
                            ChatActivityEnterView chatActivityEnterView2 = ((df) k81Var4).f23677a;
                            VideoEditedInfo videoEditedInfo2 = chatActivityEnterView2.f21997e3;
            ...
            } else if (this.f26026f) {
                k81 k81Var5 = this.f26029s;
                if (k81Var5 != null) {
                    ((df) k81Var5).f23677a.Z2.K(0.0f, 0);
                }
                this.f26026f = false;
                invalidate();
                this.P.a(false);
                ...
                k81 k81Var6 = this.f26029s;
                if (k81Var6 != null) {
                    ((df) k81Var6).f23677a.Z2.K(0.0f, 0);
                }
                this.h = false;
                invalidate();
                this.P.a(false);
    ...
    public void setVideoPath(String str) {
        ...
        this.f26028r = mediaMetadataRetriever;
        this.f26024b = 0.0f;
        this.f26025c = 1.0f;
        try {
            mediaMetadataRetriever.setDataSource(str);
            this.f26023a = Long.parseLong(this.f26028r.extractMetadata(9));
        } catch (Exception e) {
            FileLog.e(e);
        }
        invalidate();
