...
public final class l81 implements SensorEventListener {
    public final float[] f25872a = new float[3];
    public final float[] f25873b = new float[3];
    public int f25874c;
    public final WindowManager d;
    public final SensorManager e;
    public final Sensor f25875f;
    public boolean h;
    public k81 f25876n;
    ...
    public l81(Context context) {
        ...
        this.f25875f = sensorManager.getDefaultSensor(1);
    }
