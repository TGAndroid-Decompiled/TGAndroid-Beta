...
public final class ks extends f6 {
    ...
    public ch.d f25807s;
    public final Path v;
    public final RectF f25808w;
    public int f25809x;
    public FragmentContextView f25810y;

    public ks(Context context) {
        super(context);
        this.v = new Path();
        this.f25808w = new RectF();
        this.f25809x = 24;
        setOrientation(1);
        ch.d dVar = this.f25807s;
        if (dVar != null) {
            dVar.v();
        }
        invalidate();
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (getMetadata().f14200c.f14208a != 0.0f) {
            ...
            FragmentContextView fragmentContextView2 = this.f25810y;
            ...
            if (fragmentContextView2 != null && ((currentStyle = fragmentContextView2.getCurrentStyle()) == 3 || currentStyle == 1)) {
                ...
                for (int i10 = 0; i10 < entriesCount; i10++) {
                    ...
                    View view2 = ((e6) n10.f14194a).f23866a;
                    float c10 = n10.c();
                    if (c10 > 0.0f && (fragmentContextView = this.f25810y) != null && (fragmentContextView == view2 || fragmentContextView.getParent() == view2)) {
                        id capsuleBlobDrawable = this.f25810y.getCapsuleBlobDrawable();
            ...
            while (i12 < entriesCount2) {
                ...
                View view4 = ((e6) n11.f14194a).f23866a;
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (!super.dispatchTouchEvent(motionEvent)) {
            if (motionEvent.getAction() != 0 || (dVar = this.f25807s) == null || !dVar.getBounds().contains((int) motionEvent.getX(), (int) motionEvent.getY())) {
                return false;
            }
            return true;
        }
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        boolean z10;
        FragmentContextView fragmentContextView = this.f25810y;
    ...
    public final void j() {
        ...
        RectF rectF = this.f25808w;
        rectF.set(getPaddingLeft(), getPaddingTop(), getMeasuredWidth() - getPaddingRight(), getPaddingTop() + f7);
        float min = Math.min(AndroidUtilities.dp(this.f25809x), Math.min(rectF.width(), rectF.height()) / 2.0f);
        Path path = this.v;
        path.rewind();
        ...
        if (dVar != null) {
            ...
            this.f25807s.setBounds(AndroidUtilities.dp(4.0f), AndroidUtilities.dp(14.0f), getMeasuredWidth() - AndroidUtilities.dp(4.0f), ((getPaddingBottom() + getPaddingTop()) + ((int) f7)) - AndroidUtilities.dp(14.0f));
            this.f25807s.q(Math.min(AndroidUtilities.dp(this.f25809x), f7 / 2.0f));
        }
    }
    ...
    public void setCallFragmentContextView(FragmentContextView fragmentContextView) {
        this.f25810y = fragmentContextView;
