...
public final class du0 implements org.telegram.ui.Cells.k1 {
    ...
    public final org.telegram.ui.ActionBar.e6 f23396b;
    public final fu0 f23397c;
    ...
    public final void P0(int i10, org.telegram.ui.Cells.t1 t1Var) {
        if (i10 == 80) {
            org.telegram.ui.ActionBar.n2 n2Var = this.f23397c.f24091s.f30389v1;
    ...
    public final void j(org.telegram.ui.Cells.t1 t1Var, ArrayList arrayList, int i10, int i11, int i12) {
        SendMessagesHelper.getInstance(this.f23395a).sendVote(t1Var.getMessageObject(), arrayList, null);
    }
    ...
    public final void n(org.telegram.ui.Cells.t1 t1Var, TLRPC.PollAnswer pollAnswer, TLRPC.MessageMedia messageMedia, int i10) {
        ...
        yu0 yu0Var = this.f23397c.f24091s;
        MessageObject messageObject = t1Var.getMessageObject();
        TLRPC.MessageMedia media = MessageObject.getMedia(messageObject);
        if (messageMedia != null && messageObject != null && (media instanceof TLRPC.TL_messageMediaPoll)) {
            TLRPC.TL_messageMediaPoll tL_messageMediaPoll = (TLRPC.TL_messageMediaPoll) media;
            TLRPC.GeoPoint geoPoint = messageMedia.geo;
            org.telegram.ui.ActionBar.e6 e6Var = this.f23396b;
            int i14 = this.f23395a;
            if (geoPoint != null) {
                if (AndroidUtilities.isMapsInstalled(yu0Var.f30389v1)) {
                    org.telegram.ui.id0 id0Var = new org.telegram.ui.id0(3);
                    id0Var.setResourceProvider(e6Var);
                    TLRPC.TL_message tL_message = new TLRPC.TL_message();
                    tL_message.local_id = -1;
                    tL_message.peer_id = MessagesController.getInstance(i14).getPeer(yu0Var.f30364j1);
                    ...
                    yu0Var.f30389v1.presentFragment(id0Var);
                }
            } else if (MessageObject.isAnyKindOfStickerOrEmoji(messageMedia.document)) {
                org.telegram.ui.st.q().w(yu0Var.f30389v1.getParentActivity());
                ...
                q6.t(document4, null, "", null, null, i13, false, t1Var.getMessageObject(), this.f23396b, 200);
            } else {
                ...
                if (i11 > -1 && !arrayList2.isEmpty()) {
                    ...
                    PhotoViewer.t1().J2(null, yu0Var.f30389v1, e6Var);
                    PhotoViewer.t1().a2(arrayList2, i11, yu0Var.f30364j1, 0L, 0L, new cu0(this));
                }
            }
        }
    }
