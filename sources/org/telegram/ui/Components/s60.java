...
public final class s60 implements View.OnClickListener {
    ...
    public final TLRPC.User f28166b;
    ...
    public final void onClick(View view) {
        ...
        switch (this.f28165a) {
            case 0:
                ...
                l01.b(context, i10, -c70Var.f23263g0, this.f28166b, this.f28167c, this.d, this.e, this.f28168f, d6Var);
                return;
            default:
                jv0 jv0Var = ((tt0) this.h).f28614f;
                l01.b(jv0Var.getContext(), jv0Var.f25559v1.getCurrentAccount(), jv0Var.f25534j1, this.f28166b, this.f28167c, this.d, this.e, this.f28168f, jv0Var.F1);
                return;
        }
    }
}
