...
public final class bc0 {
    public SpannableStringBuilder f24688a;
    public int f24689b;
    public Drawable f24690c;
    public float d;
    public final int f24691e;
    public final int f24692f;
    public int f24693g = -1;
    public int h = -1;
    public float f24694i = 4.66f;
    ...
    public final CharSequence a(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        int dp;
        int dp2;
        SpannableStringBuilder spannableStringBuilder = this.f24688a;
        int i10 = this.f24692f;
        if (spannableStringBuilder != null && this.f24690c != null && AndroidUtilities.density == this.d) {
            if (this.f24689b != org.telegram.ui.ActionBar.j6.v0(i10, f6Var)) {
                Drawable drawable = this.f24690c;
            ...
            Drawable mutate = context.getResources().getDrawable(this.f24691e).mutate();
            this.f24690c = mutate;
            ...
            if (i11 <= 0) {
                dp = this.f24690c.getIntrinsicWidth();
            } else {
                dp = AndroidUtilities.dp(i11);
            }
            int i12 = this.h;
            if (i12 <= 0) {
                dp2 = this.f24690c.getIntrinsicHeight();
            } else {
                dp2 = AndroidUtilities.dp(i12);
            }
            int dp3 = AndroidUtilities.dp(this.f24694i);
            this.f24690c.setBounds(0, dp3, dp, dp2 + dp3);
            spannableStringBuilder2.setSpan(new ImageSpan(this.f24690c, 2), 0, 1, 33);
            spannableStringBuilder2.setSpan(new org.telegram.ui.Cells.p2(AndroidUtilities.dp(2.0f)), 1, 2, 33);
            this.f24688a = spannableStringBuilder2;
