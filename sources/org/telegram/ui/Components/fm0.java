...
public final class fm0 extends ww0 {
    public float d;
    public final Paint f24139f;
    public boolean f24136a = false;
    public long f24137b = 0;
    public boolean f24138c = false;
    public int e = 1;

    public fm0(boolean z10) {
        if (z10) {
            this.f24139f = new Paint(1);
        }
    }

    @Override
    public final void b(int i10) {
        Paint paint = this.f24139f;
        if (paint != null) {
            paint.setColor(i10);
        }
    }
    ...
    @Override
    public final void d() {
        this.f24137b = System.currentTimeMillis();
        this.f24138c = true;
        invalidateSelf();
    }
    ...
    public final void draw(Canvas canvas) {
        ...
        if (this.f24138c) {
            ...
            long j3 = currentTimeMillis - this.f24137b;
            this.f24137b = currentTimeMillis;
            if (j3 > 50) {
                j3 = 50;
            }
            float f10 = this.d;
