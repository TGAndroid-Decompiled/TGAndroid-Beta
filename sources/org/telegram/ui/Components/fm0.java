    ...
    public final void onAnimationEnd(Animator animator) {
        ...
        switch (this.f24016a) {
            case 0:
                ...
                cc1 cc1Var = im0Var.e;
                im0Var.f25071h0 = null;
                boolean z10 = this.f24017b;
                if (z10) {
                    f7 = 1.0f;
                } else {
                    f7 = 0.0f;
                ...
                if (!z10) {
                    ...
                    float f10 = this.f24018c;
                    float scrollX = (im0Var.getScrollX() + f10) / (im0Var.f25073j0 * cc1Var.getChildCount());
                    ...
                    im0Var.f25075l0 = (im0Var.getScrollX() + f10) - f11;
                    int i11 = (int) (f11 - f10);
                    im0Var.m0 = i11;
                    if (i11 < 0) {
                        im0Var.m0 = 0;
    ...
    public void onAnimationStart(Animator animator) {
        switch (this.f24016a) {
            case 1:
                ...
                wh.l lVar = ((wh.m) this.d).f45106y;
                lVar.setVisibility(0);
                if (this.f24017b) {
                    float f7 = this.f24018c;
                    lVar.setScaleX(f7);
                    lVar.setScaleY(f7);
                    return;
                }
