...
public final class fm0 extends Transition {
    ...
    public final void captureEndValues(TransitionValues transitionValues) {
        ...
        switch (this.f24008a) {
            ...
            case 1:
                ...
                ux0 ux0Var = (ux0) this.f24009b;
                viewGroup = ((org.telegram.ui.ActionBar.f3) ux0Var).containerView;
                map.put("offset", Integer.valueOf(viewGroup.getTop() + ux0Var.f28572e0));
                return;
            case 2:
                View view = transitionValues.view;
                PhotoViewer photoViewer = (PhotoViewer) this.f24009b;
            ...
            default:
                ...
                SecretMediaViewer secretMediaViewer = (SecretMediaViewer) this.f24009b;
                if (view2 == secretMediaViewer.Z) {
                    transitionValues.values.put("translationY", Integer.valueOf(secretMediaViewer.f31408a0.getPendingMarginTopDiff()));
                    return;
                }
                return;
        }
    ...
    public final void captureStartValues(TransitionValues transitionValues) {
        ...
        switch (this.f24008a) {
            ...
            case 2:
                View view = transitionValues.view;
                org.telegram.ui.ut0 ut0Var = ((PhotoViewer) this.f24009b).T1;
                if (view == ut0Var) {
            ...
            default:
                View view2 = transitionValues.view;
                org.telegram.ui.ut0 ut0Var2 = ((SecretMediaViewer) this.f24009b).f31408a0;
                if (view2 == ut0Var2) {
        ...
        switch (i10) {
            ...
            case 2:
                ...
                if (transitionValues.view == photoViewer.T1) {
                    ...
                    ofInt.addListener(new org.telegram.ui.wt0(this, 0));
            ...
            default:
                ...
                if (transitionValues.view == secretMediaViewer.f31408a0) {
                    ...
                    ofFloat4.addListener(new org.telegram.ui.q41(this, 1));
                    return ofFloat4;
                }
        }
    }
