        ...
        switch (this.f26129a) {
            case 0:
                ...
                if (!z10) {
                    ...
                    float f10 = this.f26131c;
                    float scrollX = (im0Var.getScrollX() + f10) / (im0Var.f27178j0 * cc1Var.getChildCount());
                    ...
                    im0Var.f27180l0 = (im0Var.getScrollX() + f10) - f11;
                    int i11 = (int) (f11 - f10);
                    im0Var.m0 = i11;
                    if (i11 < 0) {
                        im0Var.m0 = 0;
    ...
    public void onAnimationStart(Animator animator) {
        switch (this.f26129a) {
            case 1:
                ...
                xh.l lVar = ((xh.m) this.d).f49441y;
                lVar.setVisibility(0);
                if (this.f26130b) {
                    float f7 = this.f26131c;
                    lVar.setScaleX(f7);
                    lVar.setScaleY(f7);
                    return;
                }
