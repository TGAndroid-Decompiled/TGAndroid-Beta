...
public final class v70 {
    ...
    public boolean Y;
    public boolean Z;
    public final ViewGroup f28963a;
    public float f28964a0;
    public ViewGroup f28965b;
    public float f28966b0;
    public final org.telegram.ui.ActionBar.n2 f28967c;
    public boolean f28968c0;
    public final org.telegram.ui.ActionBar.f6 d;
    public boolean f28969d0;
    public final Context e;
    public View f28970e0;
    public final View f28971f;
    public l70 f28972f0;
    public Drawable f28973g;
    public m70 f28974g0;
    public int h;
    public final int[] f28975h0;
    public int f28976i;
    public Integer f28977i0;
    public boolean f28978j;
    public Integer f28979j0;
    public int f28980k;
    public Integer f28981k0;
    public int f28982l;
    public Integer f28983l0;
    public q70 f28984m;
    public ValueAnimator m0;
    public fh.b f28985n;
    public boolean f28986n0;
    public final float[] f28987o;
    public vr f28988o0;
    public Runnable f28989p;
    public View f28990p0;
    public float f28991q;
    public final int[] f28992q0;
    public float f28993r;
    public int f28994s;
    ...
    public v70(org.telegram.ui.ActionBar.n2 n2Var, View view, boolean z10, boolean z11) {
        ...
        this.f28971f = view;
        this.f28994s = ((double) AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19094d6, resourceProvider))) > 0.705d ? 102 : 51;
        this.E = z10;
        this.G = z11;
        this.F = false;
        B();
    ...
    public static void a(v70 v70Var, ViewGroup viewGroup) {
        ...
        ValueAnimator ofFloat = ValueAnimator.ofFloat(t70Var.f28313w, 0.0f);
        v70Var.m0 = ofFloat;
    ...
    public static void f(v70 v70Var, ai.x8 x8Var, final HashSet hashSet, boolean z10, Runnable runnable, final Utilities.Callback callback) {
        ...
        v70Var.r(scrollView, w7.y5.n(-1, -2));
        float f7 = 0.12f;
    ...
    public final void C() {
        ...
        this.f28970e0 = view;
        view.getLocationOnScreen(this.f28975h0);
        this.f28972f0 = new ViewTreeObserver.OnScrollChangedListener() {
            @Override
            public final void onScrollChanged() {
                q70 q70Var;
                v70 v70Var = v70.this;
                if (v70Var.f28970e0 != null && (q70Var = v70Var.f28984m) != null && q70Var.isShowing()) {
                    int[] iArr = new int[2];
                    v70Var.f28970e0.getLocationOnScreen(iArr);
                    int i10 = iArr[0];
                    int[] iArr2 = v70Var.f28975h0;
        ...
        this.f28970e0.getViewTreeObserver().addOnScrollChangedListener(this.f28972f0);
        m70 m70Var = new m70(this, 0);
        this.f28974g0 = m70Var;
        this.f28970e0.addOnLayoutChangeListener(m70Var);
    }

    public final boolean D() {
        q70 q70Var = this.f28984m;
        if (q70Var != null && q70Var.isShowing()) {
            return true;
        }
        return false;
    }
    ...
    public final void N() {
        View view = this.f28970e0;
        if (view != null) {
            if (this.f28972f0 != null) {
                ViewTreeObserver viewTreeObserver = view.getViewTreeObserver();
                if (viewTreeObserver.isAlive()) {
                    viewTreeObserver.removeOnScrollChangedListener(this.f28972f0);
                }
            }
            m70 m70Var = this.f28974g0;
            if (m70Var != null) {
                this.f28970e0.removeOnLayoutChangeListener(m70Var);
            }
        }
        this.f28972f0 = null;
        this.f28974g0 = null;
    ...
    public final void O() {
        ...
        int y3;
        q70 q70Var = this.f28984m;
        if (q70Var != null && q70Var.isShowing() && (view = this.f28971f) != null && (viewGroup = this.f28965b) != null && this.A != null && this.D != null) {
            float[] fArr = this.f28987o;
            ...
            float f14 = x10 + this.f28991q;
            this.f28964a0 = f14;
            float f15 = y3 + this.f28993r;
            this.f28966b0 = f15;
            this.f28984m.update((int) f14, (int) f15, -1, -1);
        }
    }
    ...
    public final void R(ia iaVar, float f7, float f10) {
        ...
        if (viewGroup instanceof ActionBarPopupWindow$ActionBarPopupWindowLayout) {
            viewGroup.setBackground(new la(new ma(iaVar, viewGroup, 5, false), this.A.getX() + this.f28964a0 + f7, this.A.getY() + this.f28966b0 + f10, mutate, AndroidUtilities.dp(12.0f)));
            return;
        }
        for (int i10 = 0; i10 < this.A.getChildCount(); i10++) {
            View childAt = this.A.getChildAt(i10);
            if (childAt instanceof ActionBarPopupWindow$ActionBarPopupWindowLayout) {
                childAt.setBackground(new la(new ma(iaVar, childAt, 5, false), this.A.getX() + this.f28964a0 + f7 + childAt.getX(), this.A.getY() + this.f28966b0 + f10 + childAt.getY(), mutate, AndroidUtilities.dp(12.0f)));
            }
        }
    }
    ...
    public final void S(int i10, int i11) {
        View childAt;
        this.f28979j0 = Integer.valueOf(i10);
        this.f28981k0 = Integer.valueOf(i11);
    ...
    public final void T(int i10) {
        View childAt;
        this.f28977i0 = Integer.valueOf(i10);
        if (this.A != null) {
            for (int i11 = 0; i11 < this.A.getChildCount(); i11++) {
                if (i11 == this.A.getChildCount() - 1) {
                    childAt = this.D;
    ...
    public final void V(int i10) {
        ...
        if (i10 == 5 && this.E) {
            ViewGroup viewGroup = this.A;
            if (viewGroup instanceof ActionBarPopupWindow$ActionBarPopupWindowLayout) {
                ((ActionBarPopupWindow$ActionBarPopupWindowLayout) viewGroup).f18646c = true;
            }
        }
    }

    public final void W(Drawable drawable) {
        this.f28973g = drawable;
        this.h = 0;
    ...
    public final void X(float f7) {
        q70 q70Var = this.f28984m;
        if (q70Var != null) {
            q70Var.update((int) this.f28964a0, (int) (this.f28966b0 + f7), -1, -1);
        }
    }
    ...
    public final void Z() {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.v70.Z():void");
    }
    ...
    public final void b0(int i10, int i11) {
        ...
        View view2 = this.f28990p0;
        if (view2 != null) {
            int[] iArr = this.f28992q0;
            view2.getLocationOnScreen(iArr);
            this.f28990p0.drawableHotspotChanged(i10 - iArr[0], i11 - iArr[1]);
        }
    }
    ...
    public final void d(org.telegram.ui.ActionBar.f1 f1Var) {
        ...
        f1Var.c(v02, v03);
        f1Var.setSelectorColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19049ai, f6Var));
        Integer num3 = this.f28983l0;
        if (num3 != null) {
            l1 = num3.intValue();
        } else {
    ...
    public final void e(int i10, boolean z10, Runnable runnable) {
        ...
        f1Var.f18843a.setPadding(dp, 0, i11, 0);
    ...
    public final void g(TLObject tLObject, boolean z10, Runnable runnable) {
        ...
        if (tLObject instanceof TLRPC.Chat) {
            ...
            if (user.f18475id == UserConfig.getInstance(UserConfig.selectedAccount).getClientUserId()) {
        ...
        f1Var.f18843a.setPadding(dp, 0, i10, 0);
        v9 v9Var = new v9(context);
        g9 g9Var = new g9((org.telegram.ui.ActionBar.f6) null);
        g9Var.p(tLObject);
        v9Var.setRoundRadius(AndroidUtilities.dp(34.0f));
    ...
    public final void n(TLObject tLObject, String str, Runnable runnable) {
        ...
        org.telegram.messenger.rk.n(org.telegram.ui.ActionBar.j6.f19332q5, f6Var, h, 1, 13.0f);
    ...
    public final void p(int i10, int i11, CharSequence charSequence) {
        ...
        p4Var.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19201j5, this.d));
    ...
    public final void u() {
        ...
        Runnable runnable = this.f28989p;
        if (runnable != null) {
            runnable.run();
        }
    }
    ...
    public v70(ViewGroup viewGroup, org.telegram.ui.ActionBar.f6 f6Var, View view, boolean z10, boolean z11, boolean z12) {
        ...
        this.f28971f = view;
        this.f28994s = ((double) AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19094d6, f6Var))) > 0.705d ? 102 : 51;
        this.E = z10;
        this.F = z11;
        this.G = z12;
        B();
