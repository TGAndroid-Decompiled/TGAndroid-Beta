...
public final class td implements Runnable {
    ...
    public final ChatActivityEnterView f28468b;

    public td(ChatActivityEnterView chatActivityEnterView, int i10) {
        this.f28467a = i10;
        this.f28468b = chatActivityEnterView;
    }
    ...
    public final void run() {
        ...
        boolean z10 = true;
        ChatActivityEnterView chatActivityEnterView = this.f28468b;
        switch (i10) {
            case 0:
            ...
            case 5:
                ...
                if (AndroidUtilities.isTablet()) {
                    ...
                    if (activity instanceof LaunchActivity) {
                        ActionBarLayout actionBarLayout = ((LaunchActivity) activity).f31118r0;
                ...
                if (!chatActivityEnterView.f21998j2 && z10 && (qfVar = chatActivityEnterView.E0) != null) {
                    try {
                        qfVar.requestFocus();
                        return;
                    } catch (Exception e) {
            ...
            case 18:
                ...
                return;
            case 19:
                int i14 = ChatActivityEnterView.f21938n5;
                ChatActivityEnterView chatActivityEnterView2 = this.f28468b;
            ...
            case 21:
                ...
                return;
            case 22:
                chatActivityEnterView.f22009l3 = false;
                chatActivityEnterView.I0();
                return;
            case 23:
                int i15 = ChatActivityEnterView.f21938n5;
            ...
            case 28:
                ...
                String str = chatActivityEnterView.f21990i0;
                String str2 = chatActivityEnterView.f21996j0;
                ...
                if (launchActivity != null && launchActivity.P() != null && LaunchActivity.G1.P().k(b10) != null) {
                    ei.c0 c0Var2 = chatActivityEnterView.f22007l0;
                    if (c0Var2 != null) {
                        c0Var2.setOpened(false);
                        return;
                    }
                    return;
                } else if (org.telegram.ui.zb0.l(chatActivityEnterView.f21996j0)) {
                    ?? obj = new Object();
                    obj.f15423c = new td(chatActivityEnterView, 1);
                    nf.f.k(chatActivityEnterView.getContext(), chatActivityEnterView.f21996j0, false, false, obj);
                    return;
                } else {
                    ...
                    k3Var.s(wnVar5, b10);
                    k3Var.show();
                    ei.c0 c0Var3 = chatActivityEnterView.f22007l0;
                    if (c0Var3 != null) {
            ...
            default:
                if (chatActivityEnterView.f22007l0 != null && !SharedPrefsHelper.isWebViewConfirmShown(chatActivityEnterView.Q, chatActivityEnterView.Q2)) {
                    chatActivityEnterView.f22007l0.setOpened(false);
                    return;
                }
                return;
        }
