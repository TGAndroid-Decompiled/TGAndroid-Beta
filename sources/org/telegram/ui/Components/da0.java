...
public abstract class da0 extends p61 {
    ...
    public da0(org.telegram.ui.ActionBar.o2 o2Var, long j3) {
        ...
        this.f26944w.J.setHint(LocaleController.getString(R.string.SearchMemberRequests));
        wh.g gVar = ca0Var.f45137f;
        this.f26940f = gVar;
        this.e = gVar;
        this.d.setAdapter(gVar);
        this.d.q1();
        ai.w0 w0Var = this.d;
        ca0Var.f45146p = w0Var;
    ...
    public final void E(MotionEvent motionEvent, ci.h2 h2Var) {
        ...
        if (action == 0) {
            this.Y = this.f26946y;
            ca0Var.i(false);
        } else if (motionEvent.getAction() == 1 && Math.abs(this.f26946y - this.Y) < this.T && !this.Z) {
    ...
    public final void I(int i10) {
        super.I(i10);
        this.V.setTranslationY(this.f26939c.getMeasuredHeight() + i10);
        float f7 = i10;
    ...
    public final void show() {
        ca0 ca0Var = this.U;
        if (ca0Var.f45135b && this.f26946y == 0) {
            this.f26946y = AndroidUtilities.dp(8.0f);
        }
        super.show();
        ca0Var.f45135b = false;
    }
}
