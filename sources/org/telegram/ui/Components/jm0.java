...
public abstract class jm0 extends HorizontalScrollView {
    public static final int f25326t0 = 0;
    public final c6 E;
    ...
    public float W;
    public int f25327a;
    public float f25328a0;
    public im0 f25329b;
    public boolean f25330b0;
    public final LinearLayout.LayoutParams f25331c;
    public float f25332c0;
    public final LinearLayout.LayoutParams d;
    public float f25333d0;
    public final dc1 e;
    public final em0 f25334e0;
    public hm0 f25335f;
    public boolean f25336f0;
    public boolean f25337g0;
    public HashMap h;
    public ValueAnimator f25338h0;
    public float f25339i0;
    public final float f25340j0;
    public final float f25341k0;
    public float f25342l0;
    public int m0;
    public HashMap f25343n;
    public final Paint f25344n0;
    public boolean f25345o0;
    public final c6 f25346p0;
    public boolean f25347q0;
    public final SparseArray f25348r;
    public long f25349r0;
    public View f25350s;
    public final em0 f25351s0;
    public float v;
    ...
    public jm0(Context context, org.telegram.ui.ActionBar.f6 f6Var, boolean z10) {
        super(context);
        this.f25327a = 1;
        this.f25329b = im0.f24960a;
        this.h = new HashMap();
        this.f25343n = new HashMap();
        this.f25348r = new SparseArray();
        qr qrVar = qr.h;
        ...
        this.f25334e0 = new em0(this, 0);
        this.f25336f0 = false;
        this.f25340j0 = AndroidUtilities.dp(64.0f);
        this.f25341k0 = AndroidUtilities.dp(33.0f);
        this.m0 = -1;
        this.f25344n0 = new Paint();
        this.f25345o0 = true;
        this.f25346p0 = new c6(this, 350L, qrVar);
        this.f25351s0 = new em0(this, 1);
        this.O = f6Var;
        this.P = z10;
        ...
        this.f25331c = new LinearLayout.LayoutParams(AndroidUtilities.dp(33.0f), -1);
    ...
    public final FrameLayout b(int i10, Drawable drawable) {
        ...
        this.f25353x = i12 + 1;
        FrameLayout frameLayout = (FrameLayout) this.f25343n.get(i11);
        boolean z10 = true;
        if (frameLayout != null) {
    ...
    public final ex0 c(int i10, Drawable drawable) {
        ...
        int i12 = this.f25353x;
        this.f25353x = i12 + 1;
        ex0 ex0Var = (ex0) this.f25343n.get(i11);
        boolean z10 = true;
        if (ex0Var != null) {
            g(i11, ex0Var, i12);
        } else {
            ex0Var = new ex0(getContext(), 1);
            ex0Var.f23684f.setImageDrawable(drawable);
            ex0Var.setFocusable(true);
            ex0Var.setOnClickListener(new cm0(this, 4));
            ex0Var.setExpanded(this.f25336f0);
            ex0Var.a(this.f25339i0);
    ...
    public final void cancelLongPress() {
        ...
        this.f25330b0 = false;
        AndroidUtilities.cancelRunOnUIThread(this.f25334e0);
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        float f12;
        float f13;
        float f14 = this.f25341k0 - this.f25340j0;
        float f15 = (1.0f - this.f25339i0) * this.f25342l0;
        int i10 = 0;
        while (true) {
            dc1Var = this.e;
            ...
            if (dc1Var.getChildAt(i10) instanceof ex0) {
                ...
                float f16 = ex0Var.f23690y;
                if (ex0Var.getLeft() != f16 && ex0Var.E) {
                    ex0Var.f23682b = f16 - ex0Var.getLeft();
                    ValueAnimator valueAnimator = ex0Var.f23689x;
                    if (valueAnimator != null) {
                        valueAnimator.removeAllListeners();
                        ex0Var.f23689x.cancel();
                    }
                    ValueAnimator ofFloat = ValueAnimator.ofFloat(ex0Var.f23682b, 0.0f);
                    ex0Var.f23689x = ofFloat;
                    ofFloat.addUpdateListener(new dx0(ex0Var, this, 0));
                    ex0Var.f23689x.addListener(new qk0(3, ex0Var, this));
                    ex0Var.f23689x.start();
                }
                ex0Var.E = false;
                if (this.f25337g0) {
                    ex0Var.setTranslationX(com.google.android.gms.internal.vision.e2.z(1.0f, this.f25339i0, i10 * f14, f15) + ex0Var.f23682b);
                } else {
                    ex0Var.setTranslationX(ex0Var.f23682b);
                }
            }
            i10++;
        }
        ...
        if (this.f25337g0) {
            height = com.google.android.gms.internal.vision.e2.b(1.0f, this.f25339i0, AndroidUtilities.dp(50.0f), getHeight());
        }
        float f17 = height;
        if (this.f25345o0) {
            f7 = 1.0f;
        ...
        float d = this.f25346p0.d(f7, false);
        if (!isInEditMode() && this.f25353x != 0 && this.J >= 0) {
            c6 c6Var = this.E;
            float d10 = c6Var.d(this.f25354y, false);
            ...
            if (view != null && view2 != null) {
                f10 = 2.0f;
                float f19 = d10 - floor;
                f11 = AndroidUtilities.lerp((AndroidUtilities.lerp(AndroidUtilities.dp(33.0f), AndroidUtilities.dp(64.0f), this.f25339i0) / 2.0f) + view.getTranslationX() + view.getLeft(), (AndroidUtilities.lerp(AndroidUtilities.dp(33.0f), AndroidUtilities.dp(64.0f), this.f25339i0) / 2.0f) + view2.getTranslationX() + view2.getLeft(), f19);
                ...
                f10 = 2.0f;
                if (view != null) {
                    f11 = (AndroidUtilities.lerp(AndroidUtilities.dp(33.0f), AndroidUtilities.dp(64.0f), this.f25339i0) / 2.0f) + view.getTranslationX() + view.getLeft();
                    if (view instanceof ex0) {
                    ...
                    if (view2 != null) {
                        f11 = (AndroidUtilities.lerp(AndroidUtilities.dp(33.0f), AndroidUtilities.dp(64.0f), this.f25339i0) / 2.0f) + view2.getTranslationX() + view2.getLeft();
                        if (view2 instanceof ex0) {
            ...
            float interpolation = qr.f27382i.getInterpolation(this.f25339i0);
        ...
        if (!isInEditMode() && this.f25353x != 0 && this.M > 0) {
            int i11 = this.I;
            Paint paint2 = this.H;
            paint2.setColor(i11);
    ...
    public final boolean f(MotionEvent motionEvent) {
        ...
        em0 em0Var = this.f25334e0;
        if (action == 0 && this.f25350s == null) {
            this.f25330b0 = true;
            AndroidUtilities.runOnUIThread(em0Var, 500L);
            this.W = motionEvent.getX();
            this.f25328a0 = motionEvent.getY();
        }
        if (this.f25330b0 && motionEvent.getAction() == 2) {
            float abs = Math.abs(motionEvent.getX() - this.W);
            float f7 = this.G;
            if (abs > f7 || Math.abs(motionEvent.getY() - this.f25328a0) > f7) {
                this.f25330b0 = false;
                AndroidUtilities.cancelRunOnUIThread(em0Var);
            }
        }
        int action2 = motionEvent.getAction();
        em0 em0Var2 = this.f25351s0;
        dc1 dc1Var = this.e;
        if (action2 == 2 && this.f25350s != null) {
            ...
            if (this.U != ceil && e(ceil)) {
                ...
                this.U = ceil;
                dc1Var.removeView(this.f25350s);
                dc1Var.addView(this.f25350s, this.U);
                invalidate();
            }
            this.f25333d0 = this.W - motionEvent.getX();
            float x10 = motionEvent.getX();
            if (x10 < this.f25350s.getMeasuredWidth() / 2.0f) {
                this.f25347q0 = false;
                if (this.f25349r0 <= 0) {
                    this.f25349r0 = System.currentTimeMillis();
                }
                AndroidUtilities.runOnUIThread(em0Var2, 16L);
            } else if (x10 > getMeasuredWidth() - (this.f25350s.getMeasuredWidth() / 2.0f)) {
                this.f25347q0 = true;
                if (this.f25349r0 <= 0) {
                    this.f25349r0 = System.currentTimeMillis();
                }
    ...
    public final void g(String str, FrameLayout frameLayout, int i10) {
        HashMap hashMap = this.f25343n;
        if (hashMap != null) {
            hashMap.remove(str);
        }
        this.f25348r.put(i10, frameLayout);
    }
    ...
    public float getExpandedOffset() {
        if (this.f25337g0) {
            return AndroidUtilities.dp(50.0f) * this.f25339i0;
        }
        return 0.0f;
    }
    ...
    public final void h() {
        ...
        SparseArray sparseArray = this.f25348r;
    ...
    public final void i(final float f7, final boolean z10) {
        float f10;
        if (this.f25336f0 != z10) {
            this.f25336f0 = z10;
            if (!z10) {
                fling(0);
            }
            ValueAnimator valueAnimator = this.f25338h0;
            if (valueAnimator != null) {
                valueAnimator.removeAllListeners();
                this.f25338h0.cancel();
            }
            float f11 = this.f25339i0;
            if (z10) {
                f10 = 1.0f;
            } else {
                f10 = 0.0f;
            ...
            ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                    ...
                    if (!z10) {
                        ...
                        float f12 = f7;
                        float scrollX = (jm0Var.getScrollX() + f12) / (jm0Var.f25340j0 * dc1Var.getChildCount());
                        ...
                        jm0Var.f25342l0 = (jm0Var.getScrollX() + f12) - f13;
                    }
                    jm0Var.f25339i0 = ((Float) valueAnimator2.getAnimatedValue()).floatValue();
            ...
            this.f25338h0.addListener(new gm0(this, z10, f7, 0));
            this.f25338h0.start();
            dc1 dc1Var = this.e;
            if (z10) {
                this.f25337g0 = true;
            ...
            if (z10) {
                float childCount = this.f25340j0 * dc1Var.getChildCount() * ((getScrollX() + f7) / (this.f25341k0 * dc1Var.getChildCount()));
                this.f25342l0 = childCount - (getScrollX() + f7);
    ...
    public final void q() {
        for (int i10 = 0; i10 < this.f25353x; i10++) {
            View childAt = this.e.getChildAt(i10);
            if (this.f25352w) {
                childAt.setLayoutParams(this.d);
            } else {
                childAt.setLayoutParams(this.f25331c);
            }
        }
    }
    ...
    public void setType(im0 im0Var) {
        if (im0Var != null && this.f25329b != im0Var) {
            this.f25329b = im0Var;
