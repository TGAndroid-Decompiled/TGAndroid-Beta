...
public final class ls0 extends g.p {
    ...
    public final ViewGroup f28302e;

    public ls0(ViewGroup viewGroup, Object obj, int i10) {
        this.f28301c = i10;
        this.f28302e = viewGroup;
        this.d = obj;
    }
    ...
    public final int i(int i10) {
        ...
        switch (this.f28301c) {
            case 0:
                ...
                s4.h0 adapter = qt0Var.f29822r.getAdapter();
                xu0 xu0Var = (xu0) this.f28302e;
                ru0 ru0Var = xu0Var.I;
                if (adapter == ru0Var) {
                    if (ru0Var.j(i10) != 2) {
                        return 1;
                    }
                    return qt0Var.f29823s.J;
            ...
            default:
                ...
                v51 v51Var = ((d61) this.f28302e).Y2;
                if (v51Var == null) {
                    return hVar.J;
                }
                h51 G = v51Var.G(i10);
