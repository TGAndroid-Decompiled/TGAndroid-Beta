...
public final class z80 implements View.OnClickListener {
    ...
    public final void onClick(View view) {
        ...
        switch (this.f30846a) {
            case 0:
                this.f30847b.f24474r.h();
                return;
            case 1:
                g90 g90Var = this.f30847b;
                org.telegram.ui.ActionBar.n1 n1Var = g90Var.f24475s;
                if (n1Var != null) {
                    n1Var.d(true);
                }
                g90Var.f24474r.a();
                return;
            case 2:
                g90 g90Var2 = this.f30847b;
                String str = g90Var2.f24470b;
                ...
                g90Var2.E.show();
                org.telegram.ui.ActionBar.n1 n1Var2 = g90Var2.f24475s;
                if (n1Var2 != null) {
                    n1Var2.d(true);
                    return;
                }
                return;
            default:
                g90 g90Var3 = this.f30847b;
                org.telegram.ui.ActionBar.n1 n1Var3 = g90Var3.f24475s;
                if (n1Var3 != null) {
                    n1Var3.d(true);
                }
                org.telegram.ui.ActionBar.n2 n2Var = g90Var3.f24471c;
                if (n2Var.getParentActivity() != null) {
                    ...
                    alertDialog$Builder.f18669a.T = LocaleController.getString(R.string.RevokeAlert);
                    alertDialog$Builder.k(LocaleController.getString(R.string.RevokeButton), new y80(g90Var3, 1));
                    alertDialog$Builder.h(LocaleController.getString(R.string.Cancel), null);
                    TextView textView = (TextView) alertDialog$Builder.f18669a.d(-1);
                    if (textView != null) {
