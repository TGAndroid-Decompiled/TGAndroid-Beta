...
public final class z80 {
    public View f30497a;
    public org.telegram.ui.Cells.b1 f30498b;
    public final ArrayList f30499c = new ArrayList();
    public int d = 0;
    public final ArrayList e = new ArrayList();
    public int f30500f = 0;
    ...
    public final void a(d90 d90Var, Object obj) {
        this.f30499c.add(new Pair(d90Var, obj));
        this.d++;
        h(obj, true);
    }
    ...
    public final void d(boolean z10) {
        if (z10) {
            ...
            while (true) {
                int i12 = this.d;
                ArrayList arrayList = this.f30499c;
                if (i11 < i12) {
    ...
    public final void e() {
        for (int i10 = 0; i10 < this.f30500f; i10++) {
            m(i10, true);
        }
    }
    ...
    public final boolean f(Canvas canvas) {
        int i10 = 0;
        boolean z10 = false;
        while (i10 < this.f30500f) {
            ((g90) ((Pair) this.e.get(i10)).first).draw(canvas);
            i10++;
            z10 = true;
        }
        for (int i11 = 0; i11 < this.d; i11++) {
            if (!((d90) ((Pair) this.f30499c.get(i11)).first).a(canvas) && !z10) {
                z10 = false;
            } else {
                z10 = true;
            }
    ...
    public final boolean g(Canvas canvas, Object obj) {
        ...
        for (int i11 = 0; i11 < this.d; i11++) {
            ArrayList arrayList2 = this.f30499c;
    ...
    public final void h(Object obj, boolean z10) {
        ...
        if (obj instanceof View) {
            ...
            if (!a3Var.f31664c && (view2 = a3Var.f31663b) != null) {
                view2.invalidate();
            }
        } else if (z10 && (view = this.f30497a) != null) {
            view.invalidate();
        }
        org.telegram.ui.Cells.b1 b1Var = this.f30498b;
        if (b1Var != null) {
            b1Var.run();
        }
    }
    ...
    public final void j(int i10) {
        if (i10 >= 0 && i10 < this.d) {
            Pair pair = (Pair) this.f30499c.get(i10);
            d90 d90Var = (d90) pair.first;
            if (d90Var.f23254p < 0) {
                d90Var.f23254p = Math.max(d90Var.f23253o + d90Var.f23255q, SystemClock.elapsedRealtime());
                h(pair.second, true);
                AndroidUtilities.runOnUIThread(new y80(this, d90Var, 1), Math.max(0L, (d90Var.f23254p - SystemClock.elapsedRealtime()) + 175));
            }
        }
    }
            ...
            if (pair != null) {
                if (z10) {
                    if (d90Var.f23254p < 0) {
                        d90Var.f23254p = Math.max(d90Var.f23253o + d90Var.f23255q, SystemClock.elapsedRealtime());
                        h(pair.second, true);
                        AndroidUtilities.runOnUIThread(new y80(this, d90Var, 0), Math.max(0L, (d90Var.f23254p - SystemClock.elapsedRealtime()) + 175));
                        return;
                    }
                    return;
                }
            ...
            if (pair != null) {
                ...
                if (z10) {
                    if (!g90Var.b()) {
                        ...
                        long j3 = 0;
                        if (g90Var.f24260c > 0) {
                            j3 = 320 - (SystemClock.elapsedRealtime() - g90Var.f24260c);
                        }
