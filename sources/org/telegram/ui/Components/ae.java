...
public final class ae implements fi.m0, org.telegram.ui.ActionBar.a2, xt, org.telegram.ui.ActionBar.l1 {
    public final ChatActivityEnterView f24370a;

    public ae(ChatActivityEnterView chatActivityEnterView) {
        this.f24370a = chatActivityEnterView;
    }

    @Override
    public void g(org.telegram.ui.ActionBar.b2 b2Var, int i10) {
        int i11 = ChatActivityEnterView.f23688m5;
        ChatActivityEnterView chatActivityEnterView = this.f24370a;
    ...
    public void n(KeyEvent keyEvent) {
        ...
        if (keyEvent.getKeyCode() == 4 && keyEvent.getRepeatCount() == 0 && (mfVar = (chatActivityEnterView = this.f24370a).N0) != null && mfVar.isShowing()) {
