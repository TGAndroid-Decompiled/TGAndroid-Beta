...
public final class q51 extends vl0 {
    ...
    public int f27518w;
    public final r51 f27519x;
    public final SparseArray d = new SparseArray();
    public final ArrayList e = new ArrayList();
    public final SparseArray f27514f = new SparseArray();
    public final HashMap h = new HashMap();
    public final ArrayList f27515n = new ArrayList();
    public int v = 5;
    ...
    public final void E(View view, int i10, boolean z10) {
        ...
        boolean z16;
        boolean z17;
        r51 r51Var = this.f27519x;
        LongSparseArray longSparseArray = r51Var.e;
        LongSparseArray longSparseArray2 = r51Var.d;
        TLRPC.StickerSetCovered[] stickerSetCoveredArr = r51Var.f27873c;
        int i11 = r51Var.f27871a;
        MediaDataController mediaDataController = MediaDataController.getInstance(i11);
        int i12 = this.f27518w;
    ...
    public final void G() {
        ...
        SparseArray sparseArray = this.d;
        sparseArray.clear();
        SparseArray sparseArray2 = this.f27514f;
        sparseArray2.clear();
        ...
        arrayList.clear();
        this.f27518w = 0;
        MediaDataController mediaDataController = MediaDataController.getInstance(r51Var.f27871a);
        ArrayList arrayList2 = new ArrayList(mediaDataController.getFeaturedStickerSets());
        int size = arrayList2.size();
        arrayList2.addAll(this.f27515n);
        int i11 = 0;
        int i12 = 0;
        while (true) {
            int i13 = 1;
            ...
            if (!stickerSetCovered.covers.isEmpty() || stickerSetCovered.cover != null) {
                if (i11 == size) {
                    int i14 = this.f27518w;
                    this.f27518w = i14 + 1;
                    sparseArray.put(i14, -1);
                }
                arrayList.add(stickerSetCovered);
                sparseArray2.put(this.f27518w, stickerSetCovered);
                hashMap.put(stickerSetCovered, Integer.valueOf(this.f27518w));
                int i15 = this.f27518w;
                this.f27518w = i15 + 1;
                int i16 = i12 + 1;
                ...
                if (!stickerSetCovered.covers.isEmpty()) {
                    ...
                    for (int i17 = 0; i17 < stickerSetCovered.covers.size(); i17++) {
                        sparseArray.put(this.f27518w + i17, stickerSetCovered.covers.get(i17));
                    }
                } else {
                    sparseArray.put(this.f27518w, stickerSetCovered.cover);
                }
                int i18 = 0;
                while (true) {
                    i10 = this.v * i13;
                    ...
                    sparseArray2.put(this.f27518w + i18, stickerSetCovered);
                    i18++;
                }
                this.f27518w = i10 + this.f27518w;
                i12 = i16;
            }
            i11++;
        }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        ((org.telegram.ui.Cells.f8) view).d((TLRPC.Document) this.d.get(i10), null, this.f27514f.get(i10), null, false, false);
    }
        ...
        if (i10 != 0) {
            if (i10 != 1) {
                if (i10 != 2) {
                                    ...
                                    public final void onClick(View view) {
                                        switch (r2) {
                                            ...
                                            default:
                                                ...
                                                q51 q51Var2 = this.f27271b;
                                                r51 r51Var3 = q51Var2.f27519x;
                    ...
                    org.telegram.ui.Cells.s3 s3Var = new org.telegram.ui.Cells.s3(17, this.f27513c, r51Var.P, true, true);
