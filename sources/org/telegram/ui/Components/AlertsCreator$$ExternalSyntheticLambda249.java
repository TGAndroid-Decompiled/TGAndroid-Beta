...
public final class AlertsCreator$$ExternalSyntheticLambda249 implements TextView.OnEditorActionListener {
    ...
    public AlertsCreator$$ExternalSyntheticLambda249(EditTextBoldCursor editTextBoldCursor, int i, Object obj, AlertDialog[] alertDialogArr, View view, int i2) {
        this.$r8$classId = i2;
    ...
    public final boolean onEditorAction(TextView textView, int i, KeyEvent keyEvent) {
        switch (this.$r8$classId) {
            case 0:
                return AlertsCreator.lambda$createSimpleTextInputAlert$13(this.f$0, this.f$1, (MessagesStorage.StringCallback) this.f$2, this.f$3, this.f$4, textView, i, keyEvent);
            default:
                if (i != 6) {
                    return false;
                }
