...
public final class e1 implements bc0 {

    public final int f27919a;

    public final int[] f27920b;

    public e1(int i10, int[] iArr) {
        this.f27919a = i10;
        this.f27920b = iArr;
    }
    ...
    public final String g(int i10) {
        switch (this.f27919a) {
            ...
            default:
                ...
                return i12 < 525600 ? LocaleController.formatPluralString("Months", i12 / 44640, new Object[0]) : LocaleController.formatPluralString("Years", i12 / 525600, new Object[0]);
        }
    }
}
