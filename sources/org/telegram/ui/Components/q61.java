...
public final class q61 extends Drawable implements u5, v6, NotificationCenter.NotificationCenterDelegate {
    public final o20 f27263a;
    public final int f27264b;
    public float f27265c;
    public final boolean d;
    public ImageReceiver e;
    public final HashSet f27266f;
    public final o5 h;
    public final p61 f27267n;
    public final ImageReceiver f27268r;
    public final int f27269s;
    public boolean v;
    public final TLRPC.TL_videoSizeStickerMarkup f27270w;
    ...
    public q61(TLRPC.VideoSize videoSize, boolean z10, int i10) {
        ...
        o20 o20Var = new o20();
        this.f27263a = o20Var;
        this.f27266f = new HashSet();
        this.f27268r = new ImageReceiver();
        this.f27269s = UserConfig.selectedAccount;
        this.f27264b = i10;
        this.d = z10;
        ...
        if (videoSize instanceof TLRPC.TL_videoSizeEmojiMarkup) {
            ...
            this.f27270w = (TLRPC.TL_videoSizeStickerMarkup) videoSize;
    ...
    public final void b(ImageReceiver imageReceiver) {
        ...
        if (hashSet.isEmpty()) {
            ...
            p61 p61Var = this.f27267n;
            if (p61Var != null) {
                p61Var.onDetachedFromWindow();
            }
            ImageReceiver imageReceiver2 = this.f27268r;
            if (imageReceiver2 != null) {
                imageReceiver2.onDetachedFromWindow();
            }
        }
        if (this.f27270w != null) {
            NotificationCenter.getInstance(this.f27269s).removeObserver(this, NotificationCenter.groupStickersDidLoad);
        }
    }
    ...
    public final void c(ImageReceiver imageReceiver) {
        if (imageReceiver != null) {
            this.f27265c = imageReceiver.getRoundRadius()[0];
            HashSet hashSet = this.f27266f;
            if (hashSet.isEmpty()) {
                o5 o5Var = this.h;
                if (o5Var != null) {
            ...
            if (this.f27270w != null) {
                NotificationCenter.getInstance(this.f27269s).addObserver(this, NotificationCenter.groupStickersDidLoad);
            }
        }
    }
    ...
    public final void draw(Canvas canvas) {
        ...
        o20 o20Var = this.f27263a;
        o20Var.b(getBounds().left, getBounds().top, getBounds().right, getBounds().bottom);
        Paint paint = o20Var.f26657c;
        if (this.e != null) {
            this.f27265c = imageReceiver.getRoundRadius()[0];
        }
        float f7 = this.f27265c;
        if (f7 == 0.0f) {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj != null && q61.class == obj.getClass()) {
            q61 q61Var = (q61) obj;
            o5 o5Var = q61Var.h;
            if (this.f27264b == q61Var.f27264b) {
                o20 o20Var = this.f27263a;
                int i10 = o20Var.d;
                o20 o20Var2 = q61Var.f27263a;
                if (i10 == o20Var2.d && o20Var.e == o20Var2.e && o20Var.f26658f == o20Var2.f26658f && o20Var.f26659g == o20Var2.f26659g) {
                    o5 o5Var2 = this.h;
                    ...
                    TLRPC.TL_videoSizeStickerMarkup tL_videoSizeStickerMarkup2 = this.f27270w;
                    if (tL_videoSizeStickerMarkup2 != null && (tL_videoSizeStickerMarkup = q61Var.f27270w) != null && tL_videoSizeStickerMarkup2.stickerset.f18129id == tL_videoSizeStickerMarkup.stickerset.f18129id && tL_videoSizeStickerMarkup2.sticker_id == tL_videoSizeStickerMarkup.sticker_id) {
                        return true;
                    }
                }
            }
    ...
    public final void invalidate() {
        Iterator it = this.f27266f.iterator();
        while (it.hasNext()) {
    ...
    public final void setAlpha(int i10) {
        this.f27263a.f26657c.setAlpha(i10);
        o5 o5Var = this.h;
        if (o5Var != null) {
            o5Var.setAlpha(i10);
        }
