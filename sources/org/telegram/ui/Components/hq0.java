...
public final class hq0 extends ql0 {
    ...
    public int f25481w = -1;
    public int f25482x = -1;
    public int f25483y = -1;
    public int B = -1;
    public int C = -1;
    ...
    public hq0(lq0 lq0Var, Context context) {
        ...
        ?? j1Var = new tf.j1(false);
        this.e = j1Var;
        j1Var.f44819a = new o3.c(this, 7);
    }
    ...
    public final void E(String str) {
        if (str != null && str.equals(this.f25478n)) {
            return;
        }
        this.f25478n = str;
        if (this.f25477f != null) {
            Utilities.searchQueue.cancelRunnable(this.f25477f);
            this.f25477f = null;
        }
        eq0 eq0Var = this.h;
        if (eq0Var != null) {
    ...
    public final int h() {
        ...
        this.B = -1;
        this.C = -1;
        if (TextUtils.isEmpty(this.f25478n)) {
            int i10 = this.D;
            this.f25483y = i10;
            this.D = i10 + 2;
            this.f25481w = i10 + 1;
    ...
    public final void v(f2.l1 l1Var, int i10) {
        ...
        boolean isEmpty = TextUtils.isEmpty(this.f25478n);
        String str4 = null;
        fq0 fq0Var = this.e;
        ...
        if (isEmpty) {
            ...
            long j12 = 0;
            if (i13 >= 0 && i10 >= i13) {
                TLObject tLObject3 = ((tf.y) lq0Var.B0.get(i10 - i13)).f44942a;
            ...
            if (view instanceof org.telegram.ui.Cells.g6) {
                ...
                g6Var.t(tLObject2, tL_encryptedChat2, str3, null, false, false);
                if (i10 < h() - 2) {
                    z12 = true;
                } else {
                    z12 = false;
        ...
        if (view instanceof org.telegram.ui.Cells.g6) {
            ...
            g6Var2.t(tLObject, null, str2, null, false, false);
            if (i15 < h() - 2) {
                z10 = true;
            } else {
                z10 = false;
        ...
        String str8 = str2;
        if (view instanceof org.telegram.ui.Cells.d7) {
            org.telegram.ui.Cells.d7 d7Var2 = (org.telegram.ui.Cells.d7) view;
            if (hVar.h(j11) >= 0) {
                z4 = true;
            } else {
                z4 = false;
            }
            d7Var2.c(j11, z4, str8);
        }
    }
    ...
    public final f2.l1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 == 0) {
            ...
            org.telegram.ui.Cells.t3 t3Var2 = new org.telegram.ui.Cells.t3(context, f6Var4);
            t3Var2.setTextColor(org.telegram.ui.ActionBar.j6.f19918f7);
            t3Var2.setBackgroundColor(lq0Var.getThemedColor(org.telegram.ui.ActionBar.j6.f19899e7));
            t3Var2.setText(LocaleController.getString(R.string.Recent));
            t3Var = t3Var2;
        } else if (i10 != 4) {
            if (i10 == 5) {
            ...
            t3Var = new eg.h0(this, context, 17);
        }
