...
public abstract class hq0 extends FrameLayout {
    public org.telegram.ui.ActionBar.k5 f24718a;
    public org.telegram.ui.ActionBar.k5 f24719b;
    public ci.eb f24720c;
    public int d;
    public AnimatorSet e;
    public Paint f24721f;
    public RectF h;
    ...
    public final void a(int i10) {
        ...
        this.e.setInterpolator(qr.f27384g);
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        ((FrameLayout.LayoutParams) this.f24719b.getLayoutParams()).width = size;
        FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) this.f24718a.getLayoutParams();
