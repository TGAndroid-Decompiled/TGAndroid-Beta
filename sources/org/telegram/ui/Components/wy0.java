...
public final class wy0 extends FrameLayout {
    ...
    public int C;
    public nq0 D;
    public Paint f30446a;
    public Paint f30447b;
    public Paint f30448c;
    public Paint d;
    public RectF e;
    public vy0 f30449f;
    public String[] h;
    ...
    public int f30452s;
    public jj0[] v;
    public float f30453w;
    public float f30454x;
    public int f30455y;

    public final gj0 a(int i10) {
        int i11;
        gj0[] gj0VarArr = this.f30451r;
        if (gj0VarArr[i10] == null) {
            ...
            int i12 = i11;
            gj0VarArr[i10] = new gj0(i12, kh.a2.j(i12, ""), AndroidUtilities.dp(28.0f), AndroidUtilities.dp(28.0f), true, null);
            c(i10);
        }
    ...
    public final void b() {
        ...
        if (this.D == null && this.C != (value = this.f30449f.getValue())) {
            this.C = value;
            int i10 = (this.f30452s + 1) % 2;
            gj0 a2 = a(value);
            if (a2 != null) {
            ...
            AndroidUtilities.updateViewVisibilityAnimated(jj0VarArr[this.f30452s], false, 0.5f, true);
    ...
    public final void c(int i10) {
        gj0[] gj0VarArr = this.f30451r;
        if (gj0VarArr[i10] != null) {
            int d = i0.a.d(0.9f, org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19906d6, false), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19891c9, false));
            int w02 = org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19926e9, false);
            if (i10 == 2) {
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        accessibilityNodeInfo.setContentDescription(this.h[this.f30449f.getValue()]);
    ...
    public void setBackgroundColor(int i10) {
        ...
        for (int i11 = 0; i11 < this.f30451r.length; i11++) {
            c(i11);
        }
        vy0Var.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20012j5, false));
        vy0Var.invalidate();
    }
}
