...
public final class qg extends FrameLayout {
    ...
    public ci.f4 f27291a;
    public ci.f4 f27292b;
    public ShapeDrawable f27293c;
    public final Drawable d;
    public final String e;
    public StaticLayout f27294f;
    public float h;
    public final TextPaint f27295n;
    public final Paint f27296r;
    public final Paint f27297s;
    public final Paint v;
    public final Path f27298w;
    public final Paint f27299x;
    public final ci.l f27300y;

    public qg(ChatActivityEnterView chatActivityEnterView, Context context) {
        super(context);
        this.V = chatActivityEnterView;
        TextPaint textPaint = new TextPaint(1);
        this.f27295n = textPaint;
        this.f27296r = new Paint(1);
        this.f27297s = new Paint(1);
        Paint paint = new Paint(1);
        this.v = paint;
        this.f27298w = new Path();
        this.f27299x = new Paint(1);
        this.I = new RectF();
        this.J = new RectF();
        this.L = new Path();
        this.M = r4;
        ...
        drawable.setColorFilter(new PorterDuffColorFilter(chatActivityEnterView.j0(org.telegram.ui.ActionBar.j6.f18833be), PorterDuff.Mode.MULTIPLY));
        this.f27293c = org.telegram.ui.ActionBar.j6.b0(AndroidUtilities.dp(5.0f), chatActivityEnterView.j0(org.telegram.ui.ActionBar.j6.f19109qf));
    ...
    public final void a() {
        ci.f4 f4Var = this.f27291a;
        if (f4Var != null) {
            f4Var.f4638l0 = new og(this, f4Var, 1);
            f4Var.e(true);
            this.f27291a = null;
        }
        ci.f4 f4Var2 = this.f27292b;
        if (f4Var2 != null) {
    ...
    public final void b() {
        ...
        this.f27292b.s(AndroidUtilities.replaceTags(LocaleController.getString(i10)));
        ci.f4 f4Var2 = this.f27292b;
        f4Var2.h = ci.f4.a(f4Var2.getText(), this.f27292b.getTextPaint());
        if (chatActivityEnterView.O) {
            ci.f4 f4Var3 = this.f27292b;
        ...
        addView(this.f27292b, w7.x5.d(-1, -1.0f, 119, 0.0f, 0.0f, 54.0f, 58.0f));
        ci.f4 f4Var4 = this.f27292b;
    ...
    public final void c() {
        ...
        ChatActivityEnterView chatActivityEnterView = this.V;
        this.f27300y.e(chatActivityEnterView.j0(i10), chatActivityEnterView.j0(org.telegram.ui.ActionBar.j6.f18853cf), -1);
        this.f27295n.setColor(chatActivityEnterView.j0(org.telegram.ui.ActionBar.j6.f19091pf));
        int dp = AndroidUtilities.dp(5.0f);
        int i15 = org.telegram.ui.ActionBar.j6.f19109qf;
        this.f27293c = org.telegram.ui.ActionBar.j6.b0(dp, chatActivityEnterView.j0(i15));
        int j02 = chatActivityEnterView.j0(i15);
        PorterDuff.Mode mode = PorterDuff.Mode.SRC_IN;
        this.d.setColorFilter(new PorterDuffColorFilter(j02, mode));
        this.f27296r.setColor(chatActivityEnterView.j0(org.telegram.ui.ActionBar.j6.f18814ae));
        if (this.Q) {
            i11 = org.telegram.ui.ActionBar.j6.Wk;
        } else {
            i11 = org.telegram.ui.ActionBar.j6.Zd;
        }
        this.f27297s.setColor(chatActivityEnterView.j0(i11));
        if (this.Q) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.H != size) {
            this.H = size;
            StaticLayout staticLayout = new StaticLayout(this.e, this.f27295n, AndroidUtilities.dp(220.0f), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, true);
            this.f27294f = staticLayout;
            int lineCount = staticLayout.getLineCount();
            this.h = 0.0f;
            for (int i12 = 0; i12 < lineCount; i12++) {
                float lineWidth = this.f27294f.getLineWidth(i12);
                if (lineWidth > this.h) {
                    this.h = lineWidth;
                }
            }
        ...
        if (action == 0) {
            ...
            if (this.U && rectF.contains(x10, y3)) {
                if (chatActivityEnterView.f21759c1) {
                    ...
                    if (MediaController.getInstance().isRecordingPaused() && (chatActivityEnterView.f21790h1.getAudioLeft() > 0.01f || chatActivityEnterView.f21790h1.getAudioRight() < 0.99f)) {
                        ...
                        if (MessagesController.getGlobalMainSettings().getBoolean("trimvoicehint", true)) {
                            ...
                            alertDialog$Builder.f18447a.R = LocaleController.getString(R.string.RecordingTrimTitle);
                            alertDialog$Builder.f18447a.T = LocaleController.getString(R.string.RecordingTrimText);
    ...
    public void setBlurredBackgroundFactory(ah.c cVar) {
        this.Q = true;
        if (this.P == null) {
            this.P = new dh.b(org.telegram.ui.ActionBar.j6.f18814ae, this.V.V3);
        }
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        if (drawable != this.f27300y && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
