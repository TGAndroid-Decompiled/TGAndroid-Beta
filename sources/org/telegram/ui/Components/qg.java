...
public final class qg extends j1.b {
    ...
    public final int g(float f7, float f10) {
        rg rgVar = this.f27594o;
        ChatActivityEnterView chatActivityEnterView = rgVar.V;
        if (chatActivityEnterView.f22020r4 && chatActivityEnterView.M1 != null && chatActivityEnterView.R3.contains(f7, f10)) {
            return 2;
        }
        if (chatActivityEnterView.P && chatActivityEnterView.M1 != null && chatActivityEnterView.f21993m4 > 0.1f && rgVar.J.contains(f7, f10)) {
            return 4;
        }
        return -1;
    }
    ...
    public final void h(ArrayList arrayList) {
        ChatActivityEnterView chatActivityEnterView = this.f27594o.V;
    ...
    public final void l(int i10, s0.c cVar) {
        ...
        if (i10 == 2) {
            ...
            if (chatActivityEnterView.f22004o4 > 0.5f) {
