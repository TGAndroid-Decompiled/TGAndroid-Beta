...
public final class qg extends FrameLayout {
    ...
    public ci.f4 f27329a;
    public ci.f4 f27330b;
    public ShapeDrawable f27331c;
    public final Drawable d;
    public final String e;
    public StaticLayout f27332f;
    public float h;
    public final TextPaint f27333n;
    public final Paint f27334r;
    public final Paint f27335s;
    public final Paint v;
    public final Path f27336w;
    public final Paint f27337x;
    public final ci.l f27338y;

    public qg(ChatActivityEnterView chatActivityEnterView, Context context) {
        super(context);
        this.V = chatActivityEnterView;
        TextPaint textPaint = new TextPaint(1);
        this.f27333n = textPaint;
        this.f27334r = new Paint(1);
        this.f27335s = new Paint(1);
        Paint paint = new Paint(1);
        this.v = paint;
        this.f27336w = new Path();
        this.f27337x = new Paint(1);
        this.I = new RectF();
        this.J = new RectF();
        this.L = new Path();
        this.M = r4;
        ...
        drawable.setColorFilter(new PorterDuffColorFilter(chatActivityEnterView.j0(org.telegram.ui.ActionBar.i6.f18804be), PorterDuff.Mode.MULTIPLY));
        this.f27331c = org.telegram.ui.ActionBar.i6.b0(AndroidUtilities.dp(5.0f), chatActivityEnterView.j0(org.telegram.ui.ActionBar.i6.f19079qf));
    ...
    public final void a() {
        ci.f4 f4Var = this.f27329a;
        if (f4Var != null) {
            f4Var.f4635l0 = new og(this, f4Var, 1);
            f4Var.e(true);
            this.f27329a = null;
        }
        ci.f4 f4Var2 = this.f27330b;
        if (f4Var2 != null) {
            f4Var2.f4635l0 = new og(this, f4Var2, 2);
            f4Var2.e(true);
            this.f27330b = null;
        }
    }
    ...
    public final void b() {
        ...
        this.f27330b.s(AndroidUtilities.replaceTags(LocaleController.getString(i10)));
        ci.f4 f4Var2 = this.f27330b;
        f4Var2.h = ci.f4.a(f4Var2.getText(), this.f27330b.getTextPaint());
        if (chatActivityEnterView.O) {
            ci.f4 f4Var3 = this.f27330b;
        ...
        addView(this.f27330b, w7.x5.d(-1, -1.0f, 119, 0.0f, 0.0f, 54.0f, 58.0f));
        ci.f4 f4Var4 = this.f27330b;
        f4Var4.f4635l0 = new og(this, f4Var4, 0);
        f4Var4.u();
    }
    ...
    public final void c() {
        ...
        ChatActivityEnterView chatActivityEnterView = this.V;
        this.f27338y.e(chatActivityEnterView.j0(i10), chatActivityEnterView.j0(org.telegram.ui.ActionBar.i6.f18824cf), -1);
        this.f27333n.setColor(chatActivityEnterView.j0(org.telegram.ui.ActionBar.i6.f19061pf));
        int dp = AndroidUtilities.dp(5.0f);
        int i15 = org.telegram.ui.ActionBar.i6.f19079qf;
        this.f27331c = org.telegram.ui.ActionBar.i6.b0(dp, chatActivityEnterView.j0(i15));
        int j02 = chatActivityEnterView.j0(i15);
        PorterDuff.Mode mode = PorterDuff.Mode.SRC_IN;
        this.d.setColorFilter(new PorterDuffColorFilter(j02, mode));
        this.f27334r.setColor(chatActivityEnterView.j0(org.telegram.ui.ActionBar.i6.f18785ae));
        if (this.Q) {
            i11 = org.telegram.ui.ActionBar.i6.Wk;
        } else {
            i11 = org.telegram.ui.ActionBar.i6.Zd;
        }
        this.f27335s.setColor(chatActivityEnterView.j0(i11));
        if (this.Q) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.H != size) {
            this.H = size;
            StaticLayout staticLayout = new StaticLayout(this.e, this.f27333n, AndroidUtilities.dp(220.0f), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, true);
            this.f27332f = staticLayout;
            int lineCount = staticLayout.getLineCount();
            this.h = 0.0f;
            for (int i12 = 0; i12 < lineCount; i12++) {
                float lineWidth = this.f27332f.getLineWidth(i12);
                if (lineWidth > this.h) {
                    this.h = lineWidth;
                }
            }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            if (chatActivityEnterView.P && chatActivityEnterView.M1 != null && chatActivityEnterView.f21803m4 > 0.1f) {
            ...
            if (this.U && rectF.contains(x10, y3)) {
                if (chatActivityEnterView.f21743c1) {
                    ...
                    if (MediaController.getInstance().isRecordingPaused() && (chatActivityEnterView.f21774h1.getAudioLeft() > 0.01f || chatActivityEnterView.f21774h1.getAudioRight() < 0.99f)) {
                        ...
                        if (MessagesController.getGlobalMainSettings().getBoolean("trimvoicehint", true)) {
                            ...
                            alertDialog$Builder.f18435a.R = LocaleController.getString(R.string.RecordingTrimTitle);
                            alertDialog$Builder.f18435a.T = LocaleController.getString(R.string.RecordingTrimText);
    ...
    public void setBlurredBackgroundFactory(ah.c cVar) {
        this.Q = true;
        if (this.P == null) {
            this.P = new dh.b(org.telegram.ui.ActionBar.i6.f18785ae, this.V.V3);
        }
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        if (drawable != this.f27338y && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
