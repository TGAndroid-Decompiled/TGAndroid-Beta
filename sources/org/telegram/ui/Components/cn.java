...
public final class cn implements ki {
    public final org.telegram.ui.ActionBar.p2 f26010a;
    public final Utilities.Callback f26011b;
    public final an f26012c;
    ...
    public final void B0(wg wgVar) {
        NotificationCenter.getInstance(this.f26010a.getCurrentAccount()).doOnIdle(wgVar);
    }

    @Override
    public final void I1(int i10, boolean z4, boolean z10, int i11, int i12, long j10, boolean z11, boolean z12, long j11) {
        an anVar = this.f26012c;
        ChatAttachAlertPhotoLayout chatAttachAlertPhotoLayout = anVar.f29072g0;
        Utilities.Callback callback = this.f26011b;
        if (i10 == 15) {
            org.telegram.ui.ActionBar.p2 p2Var = this.f26010a;
