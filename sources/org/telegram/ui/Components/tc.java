...
public final class tc extends ReplacementSpan {
    public final org.telegram.ui.ActionBar.f6 f28956a;
    public final Paint f28957b = new Paint(1);
    public final k01 f28958c;
    public final Runnable d;
    public rc e;
    public Integer f28959f;

    public tc(CharSequence charSequence, Runnable runnable, org.telegram.ui.ActionBar.f6 f6Var) {
        this.f28956a = f6Var;
        this.d = runnable;
        this.f28958c = new k01(charSequence, 12.0f, null);
    }
    ...
    public final int a() {
        return (int) (this.f28958c.f26084c + AndroidUtilities.dp(14.0f));
    }
    ...
    public final void draw(Canvas canvas, CharSequence charSequence, int i10, int i11, float f10, int i12, int i13, int i14, Paint paint) {
        ...
        Integer num = this.f28959f;
        if (num != null) {
            v02 = num.intValue();
        } else {
            v02 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Oh, this.f28956a);
        }
        int i15 = v02;
        ...
        this.f28958c.c(f10 + AndroidUtilities.dp(7.0f), f11, 1.0f, i15, canvas);
        canvas.restore();
    }
