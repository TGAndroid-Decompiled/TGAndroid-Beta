...
public final class h5 {
    public HashMap f25327a;
    public HashMap f25328b;
    public HashSet f25329c;
    public fg d;
    public final int e;
                ...
                try {
                    ...
                    if (hashMap != null && (document = (TLRPC.Document) hashMap.get(Long.valueOf(j10))) != null) {
                        ...
                        if (this.f25328b == null) {
                            this.f25328b = new HashMap();
                        }
                        ArrayList arrayList = (ArrayList) this.f25328b.get(Long.valueOf(j10));
                        if (arrayList != null) {
                            arrayList.add(i5Var);
                            return;
                        }
                        ...
                        this.f25328b.put(Long.valueOf(j10), arrayList2);
                        if (this.f25329c == null) {
                            this.f25329c = new HashSet();
                        }
                        this.f25329c.add(Long.valueOf(j10));
                        if (this.d != null) {
                            return;
                        }
        ...
        if (a()) {
            ...
            for (int i10 = 0; i10 < arrayList.size(); i10++) {
                if (arrayList.get(i10) instanceof TLRPC.Document) {
                    ...
                    e(document);
                    HashMap hashMap = this.f25328b;
                    if (hashMap != null && (arrayList2 = (ArrayList) hashMap.remove(Long.valueOf(document.f19190id))) != null) {
        ...
        synchronized (this) {
            try {
                if (this.f25327a == null) {
                    this.f25327a = new HashMap();
                }
                this.f25327a.put(Long.valueOf(document.f19190id), document);
            } catch (Throwable th2) {
                throw th2;
            }
        }
