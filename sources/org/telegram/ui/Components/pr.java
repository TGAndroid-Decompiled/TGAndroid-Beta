...
public final class pr implements Interpolator {
    public static final pr f29494f = new pr(0.25d, 0.1d, 0.25d, 1.0d);
    public static final pr f29495g = new pr(0.0d, 0.0d, 0.58d, 1.0d);
    public static final pr h = new pr(0.23d, 1.0d, 0.32d, 1.0d);
    public static final pr f29496i = new pr(0.42d, 0.0d, 1.0d, 1.0d);
    public static final pr f29497j = new pr(0.42d, 0.0d, 0.58d, 1.0d);
    public static final pr f29498k = new pr(0.34d, 1.56d, 0.64d, 1.0d);
    public static final PathInterpolator f29499l;
    public final PointF f29500a;
    public final PointF f29501b;
    public final PointF f29502c;
    public final PointF d;
    public final PointF f29503e;
    ...
    public final float getInterpolation(float f7) {
        ...
        while (true) {
            pointF = this.f29501b;
            pointF2 = this.f29500a;
            pointF3 = this.f29502c;
            pointF4 = this.d;
            pointF5 = this.f29503e;
            if (i10 >= 14) {
                break;
            }
