...
public final class pr implements Interpolator {
    public static final pr f29467f = new pr(0.25d, 0.1d, 0.25d, 1.0d);
    public static final pr f29468g = new pr(0.0d, 0.0d, 0.58d, 1.0d);
    public static final pr h = new pr(0.23d, 1.0d, 0.32d, 1.0d);
    public static final pr f29469i = new pr(0.42d, 0.0d, 1.0d, 1.0d);
    public static final pr f29470j = new pr(0.42d, 0.0d, 0.58d, 1.0d);
    public static final pr f29471k = new pr(0.34d, 1.56d, 0.64d, 1.0d);
    public static final PathInterpolator f29472l;
    public final PointF f29473a;
    public final PointF f29474b;
    public final PointF f29475c;
    public final PointF d;
    public final PointF f29476e;
    ...
    public final float getInterpolation(float f7) {
        ...
        while (true) {
            pointF = this.f29474b;
            pointF2 = this.f29473a;
            pointF3 = this.f29475c;
            pointF4 = this.d;
            pointF5 = this.f29476e;
            if (i10 >= 14) {
                break;
            }
