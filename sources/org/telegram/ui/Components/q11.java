...
public final class q11 extends FrameLayout {
    ...
    public final o11 f27194b;
    public final ThemeEditorView.EditorAlert f27195c;

    public q11(ThemeEditorView.EditorAlert editorAlert, Context context) {
        super(context);
        this.f27195c = editorAlert;
        ...
        this.f27193a = imageView2;
        imageView2.setScaleType(scaleType);
        fq fqVar = new fq();
        imageView2.setImageDrawable(fqVar);
        fqVar.f23979f = AndroidUtilities.dp(7.0f);
