...
public final class q11 extends FrameLayout {
    public final ImageView f27190a;
    public final o11 f27191b;
    public final ThemeEditorView.EditorAlert f27192c;

    public q11(ThemeEditorView.EditorAlert editorAlert, Context context) {
        super(context);
        this.f27192c = editorAlert;
        ...
        this.f27190a = imageView2;
        imageView2.setScaleType(scaleType);
        fq fqVar = new fq();
        imageView2.setImageDrawable(fqVar);
        fqVar.f23976f = AndroidUtilities.dp(7.0f);
