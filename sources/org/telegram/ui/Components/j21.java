...
public class j21 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public i21 f25147f;
    public i21 h;
    public float f25148n;
    public final Paint f25149r;
    public final Paint f25150s;
    public final RectF v;
    public final Path f25151w;
    public final org.telegram.ui.ActionBar.e6 f25152x;
    public ValueAnimator f25153y;

    public j21(int i10, int i11, Context context, org.telegram.ui.ActionBar.e6 e6Var) {
        super(context);
        this.f25144a = AndroidUtilities.dp(8.0f);
        this.f25145b = AndroidUtilities.dp(6.0f);
        this.f25146c = AndroidUtilities.dp(4.0f);
        this.d = AndroidUtilities.dp(21.0f);
        this.e = AndroidUtilities.dp(41.0f);
        this.f25147f = new i21(this);
        this.f25148n = 1.0f;
        Paint paint = new Paint(1);
        this.f25149r = paint;
        this.f25150s = new Paint(1);
        this.v = new RectF();
        this.f25151w = new Path();
    ...
    public StaticLayout getNoThemeStaticLayout() {
        ...
        this.E = textPaint;
        textPaint.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.We, this.f25152x));
    ...
    public final void d() {
        if (this.H.getImageReceiver().getLottieAnimation() != null) {
            ...
            if (!this.H.getImageReceiver().getLottieAnimation().f24985k0) {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.N != null) {
            canvas.save();
            canvas.clipPath(this.f25151w);
            this.N.setBounds(0, 0, getMeasuredWidth(), getMeasuredHeight());
            this.N.draw(canvas);
            canvas.restore();
        }
        if (this.f25148n != 1.0f && (i21Var2 = this.h) != null) {
            i21Var2.b(canvas, 1.0f);
        }
        float f7 = this.f25148n;
        if (f7 != 0.0f) {
            this.f25147f.b(canvas, f7);
        }
        if (this.f25148n != 1.0f && (i21Var = this.h) != null) {
            i21Var.a(canvas, 1.0f);
        }
        float f10 = this.f25148n;
        if (f10 != 0.0f) {
            this.f25147f.a(canvas, f10);
        }
        float f11 = this.f25148n;
        if (f11 != 1.0f) {
    ...
    public final void f(lp lpVar, long j3, boolean z10) {
        ...
        this.V = i17;
        this.G = lpVar;
        TLRPC.Document f7 = lpVar.f26230a.f();
        org.telegram.ui.ActionBar.d4 d4Var2 = lpVar.f26230a;
        if (d4Var2.d instanceof TLRPC.TL_chatThemeUniqueGift) {
            j10 = ChatThemeController.getInstance(d4Var2.f18778g).getGiftThemeUser(((TLRPC.TL_chatThemeUniqueGift) d4Var2.d).gift.slug);
        } else {
            j10 = 0;
        }
        this.U = j10;
        ...
        if (z11) {
            if (f7 != null) {
                drawable = DocumentObject.getSvgThumb(f7, org.telegram.ui.ActionBar.j6.f19045c7, 0.2f);
            } else {
                drawable = null;
            }
            if (drawable == null) {
                Emoji.preloadEmoji(lpVar.f26230a.e);
                drawable = Emoji.getEmojiDrawable(lpVar.f26230a.e);
            }
            this.H.h(ImageLocation.getForDocument(f7), "50_50", drawable, null);
            lpVar.f26230a.getClass();
        ...
        w9 w9Var = this.H;
        if (lpVar.f26230a.m() && this.T != null) {
            i10 = 8;
        } else {
            i10 = 0;
        }
        ...
        if (z11 || z12) {
            ...
            i21 i21Var = this.f25147f;
            lp lpVar2 = this.G;
            if (lpVar2 == null || (d4Var = lpVar2.f26230a) == null) {
                j11 = 0;
            } else {
                org.telegram.ui.ActionBar.c4 c4Var = (org.telegram.ui.ActionBar.c4) d4Var.f18777f.get(lpVar2.f26232c);
                int i18 = c4Var.h;
                if (this.U != 0) {
                    i18 = c4Var.f18740k;
                }
                Paint paint = i21Var.f24826c;
                Paint paint2 = i21Var.f24824a;
                Paint paint3 = i21Var.f24825b;
                paint.setColor(i18);
                paint3.setColor(c4Var.f18738i);
                if (this.G.f26230a.m()) {
                    i11 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Oh, this.f25152x);
                } else {
                    i11 = c4Var.f18739j;
                }
                ...
                lp lpVar3 = this.G;
                fg.a aVar = (fg.a) lpVar3.f26230a.f18777f.get(lpVar3.f26232c);
                if (aVar != null) {
                    org.telegram.ui.ActionBar.c4 c4Var2 = (org.telegram.ui.ActionBar.c4) aVar;
                    if (c4Var2.a() != 0) {
                        lp lpVar4 = this.G;
                        int i19 = ((org.telegram.ui.ActionBar.c4) lpVar4.f26230a.f18777f.get(lpVar4.f26232c)).d;
                        ...
                        if (arrayList.size() > 1) {
                            ...
                            float dp = this.f25146c + AndroidUtilities.dp(8.0f);
                        ...
                        if (this.G != null) {
                            ...
                            this.G.f26231b = lc0Var;
                        }
                        j11 = 0;
                        i21Var.d = this.G.f26231b;
                        invalidate();
                    }
                }
                lp lpVar5 = this.G;
                org.telegram.ui.ActionBar.c4 c4Var3 = (org.telegram.ui.ActionBar.c4) lpVar5.f26230a.f18777f.get(lpVar5.f26232c);
                if (this.G != null) {
                    int i24 = c4Var3.f18740k;
                    int i25 = c4Var3.f18741l;
                    int i26 = c4Var3.f18742m;
                    int i27 = c4Var3.f18743n;
                    int i28 = c4Var3.f18744o;
                    j11 = 0;
                    if (c4Var3.f18733a.k(false) != null) {
                        if (i25 != 0) {
                        ...
                        org.telegram.ui.ActionBar.i6 i6Var = c4Var3.f18733a;
                        if (i6Var != null && (i6Var.P > 0 || i6Var.f18945c != null)) {
                            org.telegram.ui.ActionBar.i6 i6Var2 = c4Var3.f18733a;
                            Bitmap scaledBitmap = AndroidUtilities.getScaledBitmap(AndroidUtilities.dp(112.0f), AndroidUtilities.dp(134.0f), i6Var2.f18945c, i6Var2.f18943b, i6Var2.P);
                            ...
                            org.telegram.ui.ActionBar.d4 d4Var3 = this.G.f26230a;
            ...
            long i29 = lpVar.f26230a.i(this.V);
            if (i29 != j11) {
                TLRPC.WallPaper k10 = lpVar.f26230a.k(this.V);
                if (k10 != null) {
                    lpVar.f26230a.p(this.V, new ei.u1(this, i29, lpVar, k10.settings.intensity));
                }
            } else {
                SparseArray sparseArray = lpVar.f26230a.j(this.V).f18942a0;
                if (sparseArray != null) {
                    g6Var = (org.telegram.ui.ActionBar.g6) sparseArray.get(((org.telegram.ui.ActionBar.c4) lpVar.f26230a.f18777f.get(this.V)).e);
                } else {
                    g6Var = null;
                }
                if (g6Var != null && (tL_theme = g6Var.f18891r) != null && tL_theme.settings.size() > 0) {
                    TLRPC.WallPaper wallPaper2 = g6Var.f18891r.settings.get(0).wallpaper;
                ...
                } else if (g6Var != null && g6Var.f18891r == null) {
                    int i30 = (int) (g6Var.f18889p * 100.0f);
                    Drawable drawable2 = lpVar.f26231b;
                    if (drawable2 instanceof lc0) {
                        lc0 lc0Var6 = (lc0) drawable2;
                        lc0Var6.t(lc0Var6.f26119u, i30);
                    }
        ...
        org.telegram.ui.ActionBar.d4 d4Var4 = this.G.f26230a;
        if (d4Var4 != null && !d4Var4.m()) {
            fg.b bVar = this.G.f26230a.f18776c;
    ...
    public final void g(boolean z10, boolean z11) {
        float f7 = 0.0f;
        if (!z11) {
            ValueAnimator valueAnimator = this.f25153y;
        ...
        if (this.W != z10) {
            float f10 = this.M;
            ValueAnimator valueAnimator2 = this.f25153y;
            ...
            this.f25153y = ofFloat;
            ofFloat.addUpdateListener(new q70(this, 27));
            this.f25153y.addListener(new ca(20, this, z10));
            this.f25153y.setDuration(250L);
            this.f25153y.start();
        }
        this.W = z10;
    }
    ...
    public final void onSizeChanged(int i10, int i11, int i12, int i13) {
        ...
        float f7 = this.f25146c;
        RectF rectF = this.v;
        rectF.set(f7, f7, i10 - f7, i11 - f7);
        Path path = this.f25151w;
        path.reset();
        float f10 = this.f25145b;
    ...
    public void setBackgroundColor(int i10) {
        ...
        org.telegram.ui.ActionBar.e6 e6Var = this.f25152x;
        this.f25150s.setColor(org.telegram.ui.ActionBar.j6.v0(i11, e6Var));
