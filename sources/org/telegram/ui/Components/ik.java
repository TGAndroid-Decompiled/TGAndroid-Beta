...
public final class ik extends vl0 {
    public final ArrayList f25076c = new ArrayList();
    public final ArrayList d = new ArrayList();
    public final ArrayList e = new ArrayList();
    public final Context f25077f;
    public final pk h;
    ...
    public final jk E(int i10) {
        int f7;
        ArrayList arrayList = this.f25076c;
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i11 != 0) {
            ...
            int i12 = E.f25432a;
            if (i12 != 0) {
                String str = E.f25433b;
                String str2 = E.f25434c;
                if (i10 != this.f25076c.size() - 1) {
                    z10 = true;
                } else {
                    z10 = false;
                }
                ...
                k7Var.d(E.f25433b, E.f25434c, E.d.toUpperCase().substring(0, Math.min(E.d.length(), 4)), E.e, 0, false);
            }
            File file = E.f25435f;
            if (file != null) {
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        View m4Var;
        View view;
        org.telegram.ui.ActionBar.d6 d6Var = this.h.f27082a;
        Context context = this.f25077f;
        if (i10 != 0) {
            if (i10 != 1) {
                if (i10 != 2) {
