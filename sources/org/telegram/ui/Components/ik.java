...
public final class ik extends vl0 {
    public final ArrayList f25102c = new ArrayList();
    public final ArrayList d = new ArrayList();
    public final ArrayList e = new ArrayList();
    public final Context f25103f;
    public final pk h;

    public ik(pk pkVar, Context context) {
        this.h = pkVar;
        this.f25103f = context;
    }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i11 != 0) {
            ...
            int i12 = E.f25438a;
            if (i12 != 0) {
                String str = E.f25439b;
                String str2 = E.f25440c;
                if (i10 != this.f25102c.size() - 1) {
                    z10 = true;
                } else {
                    z10 = false;
                }
                ...
                k7Var.d(E.f25439b, E.f25440c, E.d.toUpperCase().substring(0, Math.min(E.d.length(), 4)), E.e, 0, false);
            }
            File file = E.f25441f;
            if (file != null) {
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        View m4Var;
        View view;
        org.telegram.ui.ActionBar.d6 d6Var = this.h.f27086a;
        Context context = this.f25103f;
        if (i10 != 0) {
            if (i10 != 1) {
                if (i10 != 2) {
