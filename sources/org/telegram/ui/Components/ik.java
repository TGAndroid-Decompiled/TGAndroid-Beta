...
public final class ik extends di {
    public final kz f25735n;
    public final sl0 f25736r;
    public final f2.i0 f25737s;
    ...
    public ik(li liVar, Context context, org.telegram.ui.ActionBar.f6 f6Var, boolean z4) {
        ...
        this.f25735n = kzVar;
        kzVar.f26470t0 = false;
        kzVar.J(z10, z4, false, false);
        kzVar.f26446l2 = true;
        ww wwVar = kzVar.f26483x;
        if (wwVar != null) {
            wwVar.setVisibility(8);
        }
        kzVar.f26448m2 = true;
        ImageView imageView = kzVar.f26487y;
        if (imageView != null) {
        ...
        this.f25737s = (f2.i0) x10.getLayoutManager();
    ...
    public int getListTopPadding() {
        return this.f25736r.getPaddingTop();
    }
    ...
    public void setDelegate(ky kyVar) {
        this.f25735n.setDelegate(kyVar);
    }
