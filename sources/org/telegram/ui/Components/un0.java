...
public abstract class un0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final org.telegram.ui.ActionBar.m2 f28841b;
    public final org.telegram.ui.ActionBar.d6 f28842c;
    public final ai.w0 d;
    public final gg.n0 e;
    public LinearLayout f28843f;
    public long h;
    public final ArrayList f28844n;
    public final ArrayList f28845r;
    public boolean f28846s;
    public ah.c v;
    public dh.e f28847w;
    public final Paint f28848x;
    public final long f28849y;
    ...
    public un0(int i10, long j3, Context context, org.telegram.ui.ActionBar.m2 m2Var, org.telegram.ui.ActionBar.d6 d6Var) {
        ...
        this.f28845r = new ArrayList();
        this.f28848x = new Paint(1);
        this.f28840a = i10;
        this.f28841b = m2Var;
        this.f28842c = d6Var;
        this.f28849y = j3;
    ...
    public static void c(Context context, int i10, TLRPC.Reaction reaction, org.telegram.ui.ActionBar.d6 d6Var) {
        ...
        on0Var.setLineColors(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19186k6, d6Var), org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19204l6, d6Var), org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19279p7, d6Var));
    ...
    public final boolean a() {
        if (this.f28845r.isEmpty() && !this.f28846s) {
            return false;
        }
        return true;
    }
    ...
    public final void d(ah.c cVar, dh.e eVar) {
        ...
        Paint paint = this.f28848x;
        paint.setStrokeWidth(dpf2);
        paint.setStyle(Paint.Style.STROKE);
        View view = this.f28843f;
        if (view != null) {
            ch.d c10 = cVar.c(view, null, false);
            c10.o(eh.b.o(this.f28842c));
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.savedReactionTagsUpdate) {
            ...
            if (longValue == 0 || longValue == this.f28849y) {
                h(true);
            }
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        if (view == this.d && (linearLayout = this.f28843f) != null) {
            if (linearLayout.getAlpha() >= 1.0f) {
                return false;
            }
            canvas.saveLayerAlpha(0.0f, 0.0f, getWidth(), getHeight(), (int) ((1.0f - this.f28843f.getAlpha()) * 255.0f), 31);
    ...
    public final void e(zg.o0 o0Var, boolean z10) {
        ...
        int i10 = 0;
        while (true) {
            ArrayList arrayList = this.f28845r;
            if (i10 < arrayList.size()) {
                long j3 = o0Var.h;
                zg.o0 o0Var2 = ((rn0) arrayList.get(i10)).f28011a;
                long j10 = o0Var2.h;
                if (j3 == j10) {
                    this.h = j10;
                    if (z10) {
    ...
    public void h(boolean z10) {
        ...
        ArrayList arrayList = this.f28844n;
        arrayList.clear();
        ArrayList arrayList2 = this.f28845r;
        arrayList.addAll(arrayList2);
        arrayList2.clear();
        int i11 = this.f28840a;
        MessagesController messagesController = MessagesController.getInstance(i11);
        long j3 = this.f28849y;
        ...
        if (!isPremium) {
            if (this.f28843f == null) {
                ...
                this.f28843f.addView(s9Var, w7.y5.q(-2, -2, 16));
                this.f28843f.addView(textView, w7.y5.q(-2, -2, 16));
                this.f28843f.setPadding(AndroidUtilities.dp(7.0f), 0, 0, 0);
                this.f28843f.setClipToPadding(false);
                addView(this.f28843f, w7.y5.d(-2, -1.0f, 19, 5.0f, 0.0f, 5.0f, 0.0f));
            }
            if (!z10) {
                this.f28843f.setVisibility(0);
                this.f28843f.setAlpha(0.0f);
                this.f28843f.animate().alpha(1.0f).start();
                return;
            }
            return;
        }
        LinearLayout linearLayout2 = this.f28843f;
