...
public class CheckBoxBase {
    ...
    public final Rect f21931b = new Rect();
    public final RectF f21932c = new RectF();
    public float e = 1.0f;
    public float h = 1.0f;
    public final Path f21936j = new Path();
    public boolean f21937k = true;
    public float f21939m = 1.0f;
    public int f21944r = org.telegram.ui.ActionBar.h6.f18917k7;

    public CheckBoxBase(int i10, View view, org.telegram.ui.ActionBar.d6 d6Var) {
        int i11 = org.telegram.ui.ActionBar.h6.f18940lc;
        this.f21945s = i11;
        this.f21946t = i11;
        this.f21947u = org.telegram.ui.ActionBar.h6.f18859h5;
        this.v = 0.0f;
        this.f21948w = 1.0f;
        this.f21951z = true;
        this.G = new x1(24);
    ...
    public final void b() {
        View view = this.f21930a;
        if (view == null) {
            return;
        }
        if (view.getParent() != null) {
            ((View) this.f21930a.getParent()).invalidate();
        }
        this.f21930a.invalidate();
    }
    ...
    public final void f(int i10, boolean z10, boolean z11) {
        ...
        if (this.f21938l && z11) {
            ...
            this.f21942p = ofFloat;
            ofFloat.addListener(new r8(this, 13));
            this.f21942p.setInterpolator(rr.f27702g);
            this.f21942p.setDuration(this.H);
            this.f21942p.start();
            return;
        }
        ObjectAnimator objectAnimator = this.f21942p;
    ...
    public final void h(int i10, int i11, int i12) {
        if (this.f21945s == i10 && this.f21946t == i11 && this.f21944r == i12) {
            return;
        }
        this.f21945s = i10;
        this.f21946t = i11;
