...
public class ai0 extends yp implements NotificationCenter.NotificationCenterDelegate {
    public boolean A0;
    public boolean B0;
    public final xl0 C0;
    public final zh0 D0;
    ...
    public final ArrayList f22651a1;
    public final ArrayList f22652b1;
    public int f22653c1;
    public final SparseArray f22654d1;
    public boolean f22655e1;
    public boolean f22656f1;
    public boolean f22657g1;
    public org.telegram.ui.hv0 f22658h1;
    public boolean f22659i1;
    public int f22660j1;
    public int f22661k1;
    public int l1;
    public int f22662m1;
    ...
    public int f22664o1;
    public rh0 f22665p1;
    public ImageLocation f22666q1;
    public ImageLocation f22667r1;
    public final PointF f22668x0;
    public final int f22669y0;
    public final org.telegram.ui.ActionBar.k f22670z0;

    public ai0(Context context, org.telegram.ui.ActionBar.k kVar, xl0 xl0Var, org.telegram.ui.q4 q4Var) {
        super(context);
        this.f22668x0 = new PointF();
        this.A0 = true;
        this.B0 = true;
        ...
        this.f22651a1 = new ArrayList();
        this.f22652b1 = new ArrayList();
        this.f22654d1 = new SparseArray();
        this.f22655e1 = true;
        this.f22660j1 = -1;
        this.f22661k1 = -1;
        ...
        this.f22670z0 = kVar;
        this.f22669y0 = ViewConfiguration.get(context).getScaledTouchSlop();
        this.G0 = q4Var;
        b(new sh0(this));
        zh0 zh0Var = new zh0(this, getContext(), null);
        this.D0 = zh0Var;
        setAdapter((xp) zh0Var);
    ...
    public final void A(ImageLocation imageLocation, ImageLocation imageLocation2) {
        ...
        this.W0.add(0, null);
        this.V0.add(0, null);
        this.f22651a1.add(0, -1);
        this.f22652b1.add(0, Float.valueOf(0.0f));
        this.D0.g();
        L();
        this.f22666q1 = imageLocation;
        this.f22667r1 = imageLocation2;
    }

    public final void B(float f7, int i10) {
        float f10;
        int i11 = this.f22660j1;
        float f11 = 0.0f;
        if (i11 >= 0 || this.f22661k1 >= 0) {
            if (i11 < 0) {
                i11 = this.f22661k1;
            }
    ...
    public final View E(int i10) {
        zh0 zh0Var = this.D0;
        if (zh0Var != null) {
            ArrayList arrayList = zh0Var.f30883c;
            if (arrayList.size() > i10 && i10 >= 0) {
                wh0 wh0Var = (wh0) arrayList.get(i10);
                xh0 xh0Var = wh0Var.f30001b;
                if (xh0Var == null) {
                    return wh0Var.f30002c;
                }
                return xh0Var;
            }
            return null;
    ...
    public final boolean H(e71 e71Var, ImageLocation imageLocation, ImageLocation imageLocation2, boolean z10) {
        ...
        int i11 = 0;
        if (imageLocation != null && imageLocation2 != null && this.f22653c1 == 0) {
    ...
    public final void N(int i10, int i11) {
        ...
        zh0 zh0Var = this.D0;
        if (zh0Var != null) {
            for (int i12 = 0; i12 < zh0Var.f30883c.size(); i12++) {
                if (((wh0) zh0Var.f30883c.get(i12)).f30002c != null) {
                    uh0 uh0Var = ((wh0) zh0Var.f30883c.get(i12)).f30002c;
                    int i13 = this.f22662m1;
                    int i14 = this.f22663n1;
                    uh0Var.r(i13, i13, i14, i14);
                }
            }
        }
    }
        ...
        if (imageLocation != null) {
            ...
            while (true) {
                ...
                if (i10 >= arrayList.size()) {
                    ...
                    this.f22652b1.set(i10, Float.valueOf(f7));
                    SparseArray sparseArray = this.f22654d1;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        ArrayList arrayList5 = ai0Var2.U0;
        ArrayList arrayList6 = ai0Var2.T0;
        if (i10 == i16) {
            MessagesController.DialogPhotos dialogPhotos2 = (MessagesController.DialogPhotos) objArr[0];
            if (ai0Var2.S0 == dialogPhotos2) {
                ArrayList arrayList7 = new ArrayList(dialogPhotos2.photos);
                if (!arrayList7.isEmpty() || !dialogPhotos2.fromCache) {
                    ai0Var2.f22660j1 = -1;
                    ai0Var2.f22661k1 = -1;
                    int i17 = ai0Var2.L0;
                    TLRPC.User user4 = MessagesController.getInstance(i17).getUser(Long.valueOf(ai0Var2.E0));
                    TLRPC.UserFull userFull = MessagesController.getInstance(i17).getUserFull(ai0Var2.E0);
                    ...
                    if (user4 != null && user4.self && UserObject.hasFallbackPhoto(userFull)) {
                        ...
                        ai0Var2.f22661k1 = arrayList7.size() - 1;
                    }
                    arrayList5.clear();
                    arrayList6.clear();
                    ArrayList arrayList8 = ai0Var2.X0;
                    arrayList8.clear();
                    ArrayList arrayList9 = ai0Var2.W0;
                    arrayList9.clear();
                    ArrayList arrayList10 = ai0Var2.Y0;
                    arrayList10.clear();
                    ArrayList arrayList11 = ai0Var2.Z0;
                    arrayList11.clear();
                    ArrayList arrayList12 = ai0Var2.V0;
                    arrayList12.clear();
                    ArrayList arrayList13 = ai0Var2.f22651a1;
                    arrayList13.clear();
                    ArrayList arrayList14 = ai0Var2.f22652b1;
                    arrayList14.clear();
                    if (DialogObject.isChatDialog(ai0Var2.E0)) {
                        TLRPC.Chat chat = MessagesController.getInstance(i17).getChat(Long.valueOf(-ai0Var2.E0));
                        ...
                        if (imageLocation != null) {
                            ...
                            arrayList5.add(null);
                            TLRPC.ChatFull chatFull = ai0Var2.F0;
                            if (chatFull != null && FileLoader.isSamePhoto((TLRPC.FileLocation) imageLocation.location, chatFull.chat_photo)) {
                                arrayList12.add(ai0Var2.F0.chat_photo);
                                if (!ai0Var2.F0.chat_photo.video_sizes.isEmpty()) {
                                    TLRPC.VideoSize closestVideoSizeWithSize = FileLoader.getClosestVideoSizeWithSize(ai0Var2.F0.chat_photo.video_sizes, 1000);
                                    arrayList9.add(ImageLocation.getForPhoto(closestVideoSizeWithSize, ai0Var2.F0.chat_photo));
                    ...
                    while (true) {
                        ...
                        if (photo2 == null || (photo2 instanceof TLRPC.TL_photoEmpty) || (arrayList3 = photo2.sizes) == null) {
                            ...
                            if (closestPhotoSizeWithSize2 != null) {
                                ...
                                if (forPhoto != null) {
                                    ImageLocation imageLocation3 = ai0Var2.P0;
                                    num = num2;
                                    if (imageLocation3 != null) {
                                        if (imageLocation3.photoId == forPhoto.photoId && !z10 && ai0Var2.E0 != UserConfig.getInstance(i13).getClientUserId()) {
                                            arrayList5.add(null);
                                            arrayList.add(ai0Var2.P0);
                                            ImageLocation imageLocation4 = ai0Var2.Q0;
                                            ...
                                            if (!photo2.video_sizes.isEmpty()) {
                                                ...
                                                if (vectorMarkupVideoSize != null) {
                                                    ...
                                                    arrayList11.add(new e71(vectorMarkupVideoSize, z14, 2));
                                                    obj = null;
                                                    arrayList9.add(null);
                                                    arrayList6.add(null);
                                                } else {
                                    ...
                                    if (!photo2.video_sizes.isEmpty()) {
                                        ...
                                        if (vectorMarkupVideoSize2 != null) {
                                            ...
                                            user = user2;
                                            arrayList11.add(new e71(vectorMarkupVideoSize2, z13, 2));
                                            z12 = false;
                                            arrayList9.add(null);
                                            arrayList6.add(null);
                                        } else {
                    ...
                    if (z10) {
                        ...
                        if (!ai0Var.H0 || ai0Var.f22656f1) {
                            ai0Var.L();
                            ai0Var.getAdapter().g();
                            ai0Var.B(0.0f, ai0Var.getRealPosition());
                        }
                    }
                    if (ai0Var.f22661k1 < 0 && ai0Var.f22660j1 < 0) {
                        z11 = false;
                        ai0Var.B(0.0f, 0);
                    } else {
                        z11 = false;
                    ...
                    ai0Var.f22656f1 = z11;
                    vh0 vh0Var = ai0Var.G0;
                    if (vh0Var != null) {
                        vh0Var.c();
                    }
                    ImageLocation imageLocation5 = ai0Var.f22666q1;
                    if (imageLocation5 != null) {
                        ai0Var.A(imageLocation5, ai0Var.f22667r1);
                        return;
                    }
                    return;
                }
        ...
        SparseArray sparseArray = ai0Var2.f22654d1;
        if (i10 == i28) {
        ...
        } else if (i10 == NotificationCenter.reloadDialogPhotos && ai0Var2.f22653c1 == 0 && (dialogPhotos = ai0Var2.S0) != null) {
            dialogPhotos.reset();
            MessagesController.DialogPhotos dialogPhotos3 = ai0Var2.S0;
            int currentItem = ai0Var2.getCurrentItem();
            zh0 zh0Var = ai0Var2.D0;
            if (zh0Var != null) {
                i12 = zh0Var.j();
            } else {
                i12 = 0;
    ...
    public rh0 getBlurDrawer() {
        return this.f22665p1;
    }
    ...
    public w9 getCurrentItemView() {
        zh0 zh0Var = this.D0;
        if (zh0Var != null && !zh0Var.f30883c.isEmpty()) {
            return ((wh0) zh0Var.f30883c.get(getCurrentItem())).f30002c;
        }
        return null;
    }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        rh0 rh0Var = this.f22665p1;
        if (rh0Var != null) {
            rh0Var.setTranslationY(getHeight() - this.f22665p1.getMeasuredHeight());
        }
    }
    ...
    public final boolean onTouchEvent(android.view.MotionEvent r22) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.ai0.onTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    public void setAnimatedFileMaybe(d6 d6Var) {
        zh0 zh0Var;
        if (d6Var != null && (zh0Var = this.D0) != null) {
            int childCount = getChildCount();
            for (int i10 = 0; i10 < childCount; i10++) {
                View childAt = getChildAt(i10);
                if ((childAt instanceof w9) && zh0Var.k(zh0Var.d.indexOf(childAt)) == 0) {
                    w9 w9Var = (w9) childAt;
    ...
    public ai0(Context context, long j3, org.telegram.ui.ActionBar.k kVar, xl0 xl0Var, org.telegram.ui.d01 d01Var, vh0 vh0Var, rh0 rh0Var) {
        super(context);
        this.f22668x0 = new PointF();
        this.A0 = true;
        this.B0 = true;
        ...
        this.f22660j1 = -1;
        this.f22661k1 = -1;
        this.f22665p1 = rh0Var;
        setPadding(0, 0, 0, rh0Var == null ? 0 : rh0Var.f27922n);
        if (rh0Var != null) {
            rh0Var.setView(this);
        }
        setVisibility(8);
        ...
        this.C0 = xl0Var;
        this.f22670z0 = kVar;
        zh0 zh0Var = new zh0(this, getContext(), d01Var);
        this.D0 = zh0Var;
        setAdapter((xp) zh0Var);
        this.f22669y0 = ViewConfiguration.get(context).getScaledTouchSlop();
        this.G0 = vh0Var;
        b(new th0((org.telegram.ui.gz0) this));
        NotificationCenter.getInstance(i10).addObserver(this, NotificationCenter.dialogPhotosLoaded);
        NotificationCenter.getInstance(i10).addObserver(this, NotificationCenter.fileLoaded);
        NotificationCenter.getInstance(i10).addObserver(this, NotificationCenter.fileLoadProgressChanged);
        NotificationCenter.getInstance(i10).addObserver(this, NotificationCenter.reloadDialogPhotos);
