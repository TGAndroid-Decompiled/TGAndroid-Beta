...
public final class zi0 {
    public final View f30897a;
    public final int f30898b;
    public final int f30899c;
    public final int d;
    public final dj0 e;
    public final TextPaint f30900f;
    public RectF f30901g;
    ...
    public zi0(eu euVar, Layout layout, Spanned spanned, dj0 dj0Var) {
        ...
        this.f30897a = euVar;
        this.e = dj0Var;
        this.f30900f = layout.getPaint();
        dj0Var.f23612c = spanned.getSpanStart(dj0Var);
        boolean z13 = dj0Var.f23610a;
        ...
        int lineForOffset = layout.getLineForOffset(dj0Var.f23612c);
        ...
        if (z13) {
            ...
            this.f30898b = AndroidUtilities.dp(3 - i13) + lineTop;
            ...
            this.f30899c = lineBottom - AndroidUtilities.dp(2 - i15);
        } else {
            ...
            this.f30898b = AndroidUtilities.dp(3 - i10) + lineTop2;
            ...
            this.f30899c = lineBottom2 - AndroidUtilities.dp(2 - i11);
        }
        dj0Var.f23615r = false;
        float f7 = 0.0f;
        ...
        if (z13 && euVar != null && dj0Var.J == null) {
    ...
    public final void a(Canvas canvas, int i10, int i11) {
        ...
        dj0 dj0Var = this.e;
        int i15 = dj0Var.I;
        float[] fArr = dj0Var.f23619y;
        boolean z10 = dj0Var.f23610a;
        Paint paint = dj0Var.f23618x;
        Paint paint2 = dj0Var.F;
        Path path = dj0Var.H;
        float[] fArr2 = dj0Var.G;
        Path path2 = dj0Var.E;
        Drawable drawable = dj0Var.f23617w;
        if (i15 != i11) {
            dj0Var.I = i11;
        ...
        int i16 = this.f30898b;
        float f7 = i16;
        float f10 = i12;
        int i17 = i12;
        int i18 = this.f30899c;
        float f11 = i18;
        ...
        if (z10 && this.f30897a != null && dj0Var.J != null) {
            if (this.f30901g == null) {
                this.f30901g = new RectF();
            }
            ...
            rectF = rectF2;
            dj0Var.J.a(canvas, this.f30901g, i17 - dp3, i18 - dp3, i11, dj0Var.e, b());
        } else {
            rectF = rectF2;
            i13 = i16;
            i14 = i18;
    ...
    public final boolean b() {
        if (this.e.f23610a && this.f30899c - this.f30898b > this.f30900f.getTextSize() * 1.3f * 3) {
            return true;
        }
        return false;
    }
