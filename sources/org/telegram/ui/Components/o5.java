...
public class o5 extends Drawable implements w5 {
    ...
    public final OvershootInterpolator f26920c;
    public final e6 d;
    public final e6 e;
    public final Drawable[] f26921f;
    public View h;
    public org.telegram.ui.a71 f26922n;
    public final boolean f26923r;
    public final int f26924s;
    public int v;
    public boolean f26925w;
    public Integer f26926x;
    public boolean f26927y;
    ...
    public final void a() {
        if (!this.f26925w) {
            this.f26925w = true;
            Drawable[] drawableArr = this.f26921f;
    ...
    public final Drawable c() {
        return this.f26921f[0];
    }

    public final boolean d() {
        if (this.f26921f[0] != null) {
            return false;
        }
        return true;
    }
    ...
    public final void draw(Canvas canvas) {
        ...
        if (drawableArr[0] != null) {
            ...
            OvershootInterpolator overshootInterpolator = this.f26920c;
            if (z10) {
                ai.l4 l4Var = ((q5) drawable3).f27505k;
                if (l4Var != null) {
    ...
    public final void f() {
        q5 q5Var;
        ai.l4 l4Var;
        Drawable drawable = this.f26921f[0];
        if ((drawable instanceof q5) && (l4Var = (q5Var = (q5) drawable).f27505k) != null) {
            q5Var.w(l4Var);
    ...
    public final void g(Drawable drawable, boolean z10) {
        ...
        if (z10) {
            ...
            Drawable drawable2 = drawableArr[1];
            if (drawable2 != null) {
                if (this.f26925w && (drawable2 instanceof q5)) {
                    ((q5) drawable2).p(this);
                }
                drawableArr[1] = null;
            }
    ...
    public void invalidate() {
        View view = this.h;
        if (view != null) {
            if (this.f26923r && (view.getParent() instanceof View)) {
                ((View) this.h.getParent()).invalidate();
            } else {
                this.h.invalidate();
            }
        }
        org.telegram.ui.a71 a71Var = this.f26922n;
        if (a71Var != null) {
            a71Var.invalidate();
        }
        invalidateSelf();
