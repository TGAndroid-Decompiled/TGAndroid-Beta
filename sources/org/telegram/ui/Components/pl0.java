...
public final class pl0 extends l20 {
    ...
    public final boolean a() {
        if (((vl0) this.f27384b.f27606b).Y0 != null) {
            return true;
        }
        return false;
    }
    ...
    public final void b(MotionEvent motionEvent, View view) {
        vl0 vl0Var = (vl0) this.f27384b.f27606b;
        if (view != null) {
    ...
    public final boolean onDoubleTap(MotionEvent motionEvent) {
        kl0 kl0Var;
        vl0 vl0Var = (vl0) this.f27384b.f27606b;
        View view = this.f27383a;
        if (view != null && (kl0Var = vl0Var.W0) != null && kl0Var.c1(view)) {
            vl0Var.W0.q0(this.f27383a, motionEvent.getX(), motionEvent.getY());
            this.f27383a = null;
            return true;
        }
        return false;
    ...
    public final boolean onSingleTapConfirmed(MotionEvent motionEvent) {
        kl0 kl0Var;
        View view = this.f27383a;
        if (view != null && (kl0Var = ((vl0) this.f27384b.f27606b).W0) != null && kl0Var.c1(view)) {
            b(motionEvent, this.f27383a);
            this.f27383a = null;
            return true;
        }
        return false;
