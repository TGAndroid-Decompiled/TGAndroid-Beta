...
public final class pl0 implements Runnable {
    ...
    public final void run() {
        rl0 rl0Var = this.e.f27702b;
        wl0 wl0Var = (wl0) rl0Var.f27999b;
        if (this == wl0Var.S1) {
            wl0Var.S1 = null;
        }
        View view = this.f27381a;
        if (view != null) {
            wl0Var.h1(view, 0.0f, 0.0f, false);
            if (!((wl0) rl0Var.f27999b).R1) {
                try {
                ...
                if (i10 != -1) {
                    wl0 wl0Var2 = (wl0) rl0Var.f27999b;
                    ...
                    if (ll0Var != null) {
                        ll0Var.c(this.f27383c - view.getX(), this.d - view.getY(), i10, view);
                    }
                }
            }
        }
