...
public final class ay implements View.OnClickListener {
    ...
    public final void onClick(View view) {
        ...
        cy cyVar = this.f24473b;
        switch (i11) {
            case 0:
                xx xxVar = cyVar.f25125s;
                if (xxVar != null && (stickerSet = xxVar.f32765b) != null) {
                    kz kzVar = cyVar.E;
                    if (!kzVar.f27998w2) {
                        kzVar.f27998w2 = true;
            ...
            case 1:
                sg.r0 r0Var = cyVar.h;
                TextView textView = cyVar.f25122f;
                TextView textView2 = cyVar.f25121e;
                if (textView2 != null && textView2.getVisibility() == 0 && textView2.isEnabled()) {
                    ...
                    return;
                } else if (r0Var != null && r0Var.getVisibility() == 0 && r0Var.f46242r.isEnabled()) {
                    r0Var.performClick();
                    return;
                } else {
                    return;
            ...
            case 2:
                kz kzVar2 = cyVar.E;
                ArrayList arrayList2 = kzVar2.f27973p1;
                xx xxVar2 = cyVar.f25125s;
                if (xxVar2 != null && (stickerSet2 = xxVar2.f32765b) != null) {
                    xxVar2.f32768f = true;
                    tx txVar = kzVar2.R;
                    int i12 = kzVar2.f27933c1;
                    ArrayList arrayList3 = kzVar2.f27976q1;
                    kx kxVar = kzVar2.P;
                    if (!arrayList2.contains(Long.valueOf(stickerSet2.f19896id))) {
                        arrayList2.add(Long.valueOf(cyVar.f25125s.f32765b.f19896id));
                    }
                    cyVar.a(true);
                    int i13 = 0;
                    while (true) {
                        if (i13 < kxVar.getChildCount()) {
                            if ((kxVar.getChildAt(i13) instanceof zx) && (R = RecyclerView.R((view2 = kxVar.getChildAt(i13)))) >= 0 && (i10 = txVar.f30731w.get(R)) >= 0 && i10 < arrayList3.size() && arrayList3.get(i10) != null && cyVar.f25125s != null && ((xx) arrayList3.get(i10)).f32765b.f19896id == cyVar.f25125s.f32765b.f19896id) {
                    ...
                    if (cyVar.f25123n == null) {
                        TLRPC.TL_inputStickerSetID tL_inputStickerSetID2 = new TLRPC.TL_inputStickerSetID();
                        TLRPC.StickerSet stickerSet4 = cyVar.f25125s.f32765b;
                        ...
                        cyVar.f25123n = tL_inputStickerSetID2;
            ...
            case 3:
                kz kzVar3 = cyVar.E;
                xx xxVar3 = cyVar.f25125s;
                if (xxVar3 != null && (stickerSet3 = xxVar3.f32765b) != null) {
                    xxVar3.f32768f = false;
                    ArrayList arrayList4 = kzVar3.f27973p1;
                    int i14 = kzVar3.f27933c1;
                    ...
                    if (cyVar.f25124r == null) {
                        TLRPC.TL_inputStickerSetID tL_inputStickerSetID3 = new TLRPC.TL_inputStickerSetID();
                        TLRPC.StickerSet stickerSet6 = cyVar.f25125s.f32765b;
                        ...
                        cyVar.f25124r = tL_inputStickerSetID3;
