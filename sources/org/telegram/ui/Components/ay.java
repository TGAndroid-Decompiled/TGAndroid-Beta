...
public final class ay implements View.OnClickListener {
    ...
    public final void onClick(View view) {
        ...
        cy cyVar = this.f22754b;
        switch (i11) {
            case 0:
                xx xxVar = cyVar.f23366s;
                if (xxVar != null && (stickerSet = xxVar.f30387b) != null) {
                    kz kzVar = cyVar.E;
                    if (!kzVar.f25952v2) {
                        kzVar.f25952v2 = true;
            ...
            case 1:
                rg.p0 p0Var = cyVar.h;
                TextView textView = cyVar.f23363f;
                ...
                if (textView2 != null && textView2.getVisibility() == 0 && textView2.isEnabled()) {
                    ...
                    return;
                } else if (p0Var != null && p0Var.getVisibility() == 0 && p0Var.f42680r.isEnabled()) {
                    p0Var.performClick();
                    return;
                } else {
                    return;
            ...
            case 2:
                kz kzVar2 = cyVar.E;
                ArrayList arrayList2 = kzVar2.f25931p1;
                xx xxVar2 = cyVar.f23366s;
                if (xxVar2 != null && (stickerSet2 = xxVar2.f30387b) != null) {
                    xxVar2.f30389f = true;
                    tx txVar = kzVar2.R;
                    int i12 = kzVar2.f25892c1;
                    ArrayList arrayList3 = kzVar2.f25934q1;
                    wx wxVar = kzVar2.P;
                    if (!arrayList2.contains(Long.valueOf(stickerSet2.f18323id))) {
                        arrayList2.add(Long.valueOf(cyVar.f23366s.f30387b.f18323id));
                    }
                    cyVar.a(true);
                    int i13 = 0;
                    while (true) {
                        if (i13 < wxVar.getChildCount()) {
                            if ((wxVar.getChildAt(i13) instanceof zx) && (S = RecyclerView.S((view2 = wxVar.getChildAt(i13)))) >= 0 && (i10 = txVar.f28493w.get(S)) >= 0 && i10 < arrayList3.size() && arrayList3.get(i10) != null && cyVar.f23366s != null && ((xx) arrayList3.get(i10)).f30387b.f18323id == cyVar.f23366s.f30387b.f18323id) {
                    ...
                    if (cyVar.f23364n == null) {
                        TLRPC.TL_inputStickerSetID tL_inputStickerSetID2 = new TLRPC.TL_inputStickerSetID();
                        TLRPC.StickerSet stickerSet4 = cyVar.f23366s.f30387b;
                        tL_inputStickerSetID2.f18316id = stickerSet4.f18323id;
                        ...
                        cyVar.f23364n = tL_inputStickerSetID2;
            ...
            case 3:
                kz kzVar3 = cyVar.E;
                xx xxVar3 = cyVar.f23366s;
                if (xxVar3 != null && (stickerSet3 = xxVar3.f30387b) != null) {
                    xxVar3.f30389f = false;
                    ArrayList arrayList4 = kzVar3.f25931p1;
                    int i14 = kzVar3.f25892c1;
                    arrayList4.remove(Long.valueOf(stickerSet3.f18323id));
                    cyVar.a(true);
                    ox oxVar = kzVar3.I;
                    if (oxVar != null) {
                    ...
                    if (cyVar.f23365r == null) {
                        TLRPC.TL_inputStickerSetID tL_inputStickerSetID3 = new TLRPC.TL_inputStickerSetID();
                        TLRPC.StickerSet stickerSet6 = cyVar.f23366s.f30387b;
                        tL_inputStickerSetID3.f18316id = stickerSet6.f18323id;
                        ...
                        cyVar.f23365r = tL_inputStickerSetID3;
