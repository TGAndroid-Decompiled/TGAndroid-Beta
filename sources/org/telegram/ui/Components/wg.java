...
public final class wg extends FrameLayout {
    public final org.telegram.ui.ActionBar.h5 f29994a;
    public final RectF f29995b;
    public final Paint f29996c;
    ...
    public final void onDraw(Canvas canvas) {
        if (this.e) {
            ...
            float f10 = f7 / 2.0f;
            canvas.drawRoundRect(rectF, f10, f10, this.f29996c);
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        this.f29996c.setShader(new LinearGradient(0.0f, 0.0f, getMeasuredWidth(), 0.0f, new int[]{-9071617, -5999873}, new float[]{0.0f, 1.0f}, Shader.TileMode.CLAMP));
    }
}
