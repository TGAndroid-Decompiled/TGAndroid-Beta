...
public final class g21 {
    ...
    public final Paint f24324c;
    public Drawable d;
    public Drawable e;
    public final h21 f24325f;

    public g21(h21 h21Var) {
        this.f24325f = h21Var;
        Paint paint = new Paint(1);
        this.f24322a = paint;
        this.f24323b = new Paint(1);
        this.f24324c = new Paint(1);
    ...
    public final void a(Canvas canvas, float f7) {
        ...
        float f20 = h21Var.d;
        float f21 = h21Var.f24614c;
        int i12 = h21Var.K;
        RectF rectF = h21Var.v;
        if (!h21Var.W && h21Var.f24621y == null) {
            f10 = 255.0f;
            f11 = 4.0f;
            f12 = 0.5f;
        } else {
            mp mpVar = h21Var.G;
            f10 = 255.0f;
            org.telegram.ui.ActionBar.a4 a4Var = (org.telegram.ui.ActionBar.a4) mpVar.f26557a.f18745f.get(mpVar.f26559c);
            if (h21Var.G.f26557a.m()) {
                i10 = org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.Oh, h21Var.f24620x);
            } else {
                i10 = a4Var.f18701j;
            }
            Paint paint = this.f24322a;
            paint.setColor(i10);
            ...
            float f22 = h21Var.f24612a;
            canvas.drawRoundRect(rectF, f22, f22, paint);
        }
        int i13 = (int) (f7 * f10);
        Paint paint2 = this.f24323b;
        paint2.setAlpha(i13);
        Paint paint3 = this.f24324c;
        paint3.setAlpha(i13);
        rectF.set(f21, f21, h21Var.getWidth() - f21, h21Var.getHeight() - f21);
        org.telegram.ui.ActionBar.b4 b4Var = h21Var.G.f26557a;
        if (b4Var != null) {
            if (b4Var.m()) {
                h21Var.G.f26557a.getClass();
            } else if (i12 != 4) {
                if (i12 == 2) {
                    if (h21Var.G.e != null) {
        ...
        if (h21Var.T == null) {
            float f23 = h21Var.f24613b;
            canvas.drawRoundRect(rectF, f23, f23, h21Var.f24618s);
            canvas.save();
    ...
    public final void b(Canvas canvas, float f7) {
        ...
        if (drawable != null) {
            canvas.save();
            canvas.clipPath(h21Var.f24619w);
            ...
            if ((drawable3 instanceof ColorDrawable) || ((drawable3 instanceof mc0) && (i10 = (iArr = ((mc0) drawable3).f26424a)[0]) == iArr[1] && i10 == iArr[2] && i10 == iArr[3])) {
                int alpha = h21Var.f24617r.getAlpha();
                h21Var.f24617r.setAlpha((int) (alpha * f7));
                float f10 = h21Var.f24614c;
                RectF rectF = AndroidUtilities.rectTmp;
                rectF.set(f10, f10, h21Var.getWidth() - f10, h21Var.getHeight() - f10);
                float f11 = h21Var.f24613b;
                canvas.drawRoundRect(rectF, f11, f11, h21Var.f24617r);
                h21Var.f24617r.setAlpha(alpha);
            }
            canvas.restore();
            return;
        }
        mp mpVar = h21Var.G;
        if (mpVar != null && (b4Var = mpVar.f26557a) != null && b4Var.m() && h21Var.N != null) {
            return;
        }
        RectF rectF2 = h21Var.v;
        float f12 = h21Var.f24613b;
        canvas.drawRoundRect(rectF2, f12, f12, h21Var.f24618s);
    }
}
