...
public final class g21 implements Runnable {
    public final int f24139a = 0;
    public final boolean f24140b;
    public final long f24141c;
    public final NotificationCenter.NotificationCenterDelegate d;
    public final Object e;
    public final Object f24142f;
    public final Object h;
    public final TLObject f24143n;

    public g21(w21 w21Var, boolean z10, org.telegram.ui.ActionBar.f1 f1Var, o70 o70Var, long j3, TLRPC.User user, TLRPC.Chat chat) {
        this.d = w21Var;
        this.f24140b = z10;
        this.e = f1Var;
        this.f24142f = o70Var;
    ...
    public final void run() {
        ...
        switch (this.f24139a) {
            case 0:
                ...
                final o70 o70Var = (o70) this.f24142f;
                final TLRPC.User user = (TLRPC.User) this.h;
                final TLRPC.Chat chat = (TLRPC.Chat) this.f24143n;
                boolean z10 = this.f24140b;
                ...
                return;
            default:
                yh.g.Z((yh.g) this.d, (TLRPC.TL_error) this.e, (TwoStepVerificationActivity) this.f24142f, (Activity) this.h, this.f24140b, this.f24141c, this.f24143n);
                return;
        }
    }

    public g21(yh.g gVar, TLRPC.TL_error tL_error, TwoStepVerificationActivity twoStepVerificationActivity, Activity activity, boolean z10, long j3, TLObject tLObject) {
        this.d = gVar;
        this.e = tL_error;
        this.f24142f = twoStepVerificationActivity;
        this.h = activity;
        this.f24140b = z10;
        this.f24141c = j3;
        this.f24143n = tLObject;
    }
}
