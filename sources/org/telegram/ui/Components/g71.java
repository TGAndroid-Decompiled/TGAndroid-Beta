...
public final class g71 extends View {
    public final o6 f24419a;
    public final o6 f24420b;
    public final Paint f24421c;
    ...
    public g71(Context context) {
        ...
        this.e = paint3;
        sr srVar = sr.h;
        this.h = new e6(this, 0L, 300L, srVar);
        this.f24423n = new int[]{144, 240, 360, 480, 720, 1080, 1440, 2160};
        o6 o6Var = new o6(true, false, false, false);
        this.f24419a = o6Var;
        o6Var.k(0.4f, 360L, srVar);
        ...
        o6Var2.f26961a.setXfermode(new PorterDuffXfermode(mode));
    ...
    public final void a(int i10, boolean z10, boolean z11) {
        ...
        this.f24422f = z12;
        o6 o6Var = this.f24419a;
        o6 o6Var2 = this.f24420b;
        if (z11) {
            ...
            if (length < 0) {
                ...
                o6Var2.q("2K", TextUtils.isEmpty(o6Var2.f26965g), true);
            } else if (length == 7) {
                o6Var2.q("4K", TextUtils.isEmpty(o6Var2.f26965g), true);
            } else {
                o6Var2.q("" + iArr[length], TextUtils.isEmpty(o6Var2.f26965g), true);
            }
        }
        setClickable(!this.f24422f);
        invalidate();
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        float e = (1.0f - (this.h.e(this.f24422f) * 0.35f)) * 255.0f;
        int i10 = (int) e;
        Paint paint = this.f24421c;
        paint.setAlpha(i10);
    ...
    public void setPhotoState(boolean z10) {
        ...
        this.f24419a.q(str, true, true);
        this.f24420b.q("", false, true);
    }

    @Override
    public final boolean verifyDrawable(Drawable drawable) {
        if (this.f24419a != drawable && this.f24420b != drawable && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
