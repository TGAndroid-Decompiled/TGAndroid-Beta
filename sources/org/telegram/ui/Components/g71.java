...
public final class g71 implements Runnable {
    ...
    public final void run() {
        switch (this.f24384a) {
            case 0:
                wz wzVar = ((i71) this.f24385b).f24961b;
                if (wzVar != null) {
            ...
            case 1:
                ...
                return;
            case 2:
                s71 s71Var2 = ((r71) this.f24385b).f27900f;
                s71Var2.f28182a0.removeCallbacksAndMessages(null);
                s71Var2.K.onVisualizerUpdate(false, true, null);
                return;
            case 3:
                ((u71) this.f24385b).f28739g = false;
                return;
            case 4:
                ((o91) ((ki.d) ((org.telegram.ui.Cells.fa) this.f24385b).f20316b).f13671b).v.b();
                return;
            default:
                ((k91) this.f24385b).d(false, true);
                return;
        }
    }
}
