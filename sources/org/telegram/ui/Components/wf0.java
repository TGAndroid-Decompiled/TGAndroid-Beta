...
public final class wf0 extends FrameLayout {
    ...
    public boolean d;
    public final PipRoundVideoView f32262e;

    public wf0(PipRoundVideoView pipRoundVideoView, Activity activity) {
        super(activity);
        this.f32262e = pipRoundVideoView;
    }

    @Override
    public final void onDraw(Canvas canvas) {
        org.telegram.ui.ActionBar.h5 h5Var = org.telegram.ui.ActionBar.j6.f20789k3;
        if (h5Var != null) {
            h5Var.setAlpha((int) (getAlpha() * 255.0f));
            org.telegram.ui.ActionBar.j6.f20789k3.setBounds(AndroidUtilities.dp(1.0f), AndroidUtilities.dp(2.0f), AndroidUtilities.dp(125.0f), AndroidUtilities.dp(125.0f));
            org.telegram.ui.ActionBar.j6.f20789k3.draw(canvas);
            org.telegram.ui.ActionBar.j6.S1.setColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20921ra, false));
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        if (motionEvent.getAction() == 0) {
            this.f32259a = motionEvent.getRawX();
            this.f32260b = motionEvent.getRawY();
            this.d = true;
        }
        return true;
    }
