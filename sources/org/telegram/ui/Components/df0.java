...
public final class df0 extends FrameLayout {
    ...
    public RectF f24269r;
    public float f24270s;
    public float v;
    public float f24271w;
    public float f24272x;
    ...
    private PointF getActualCenterPoint() {
        ...
        float width = (this.e.x * f10) + ((getWidth() - f10) / 2.0f);
        if (!this.H) {
        ...
        float f12 = jv0Var.f26062a;
        return new PointF(width, (this.e.y * f12) + org.telegram.messenger.y3.a(f12, f11, 2.0f, x10));
    }

    private float getActualInnerRadius() {
        jv0 jv0Var = this.d;
        return Math.min(jv0Var.f26062a, jv0Var.f26063b) * this.f24267f;
    }

    private float getActualOuterRadius() {
        jv0 jv0Var = this.d;
        return Math.min(jv0Var.f26062a, jv0Var.f26063b) * this.h;
    }
    ...
    public final void c(int i10, MotionEvent motionEvent) {
        ...
        jv0 jv0Var = this.d;
        float min = Math.min(jv0Var.f26062a, jv0Var.f26063b);
        float f13 = this.f24267f * min;
        float f14 = this.h * min;
        float abs = (float) Math.abs((Math.sin(a(this.f24268n) + 1.5707963267948966d) * f12) + (Math.cos(a(this.f24268n) + 1.5707963267948966d) * f11));
        float f15 = 0.0f;
        if (i10 != 1) {
            if (i10 != 2) {
            ...
            if (i14 == 0) {
                ...
                if (c3 != 1) {
                    if (c3 != 2) {
                        if (c3 != 3) {
                            if (c3 == 5) {
                                ...
                                this.f24268n = (((((float) Math.sqrt((f17 * f17) + (f16 * f16))) * ((i13 * 2) - 1)) / 3.1415927f) / 1.15f) + this.f24268n;
                                this.f24270s = x10;
                                this.v = y10;
                            }
                        } else {
                            this.h = Math.max(this.f24267f + 0.02f, (this.f24266c + (abs - this.f24265b)) / min);
                        }
                    } else {
                        this.f24267f = Math.min(Math.max(0.1f, (this.f24266c + (abs - this.f24265b)) / min), this.h - 0.02f);
                    }
                } else {
                    float f18 = x10 - this.f24270s;
                    float f19 = y10 - this.v;
                    float width = (getWidth() - jv0Var.f26062a) / 2.0f;
                    if (!z12) {
                    ...
                    float height = getHeight();
                    float f20 = jv0Var.f26063b;
                    float x11 = e2.c.x(height, f20, 2.0f, i12);
                    PointF pointF = new PointF(Math.max(width, Math.min(jv0Var.f26062a + width, this.f24264a.x + f18)), Math.max(x11, Math.min(f20 + x11, this.f24264a.y + f19)));
                    float f21 = pointF.x - width;
                    float f22 = jv0Var.f26062a;
                    this.e = new PointF(f21 / f22, (((f22 - jv0Var.f26063b) / 2.0f) + (pointF.y - x11)) / f22);
                }
            } else if (i14 == 1) {
                ...
                if (c10 != 1) {
                    if (c10 != 2) {
                        if (c10 == 3) {
                            this.h = Math.max(this.f24267f + 0.02f, (this.f24266c + (sqrt - this.f24265b)) / min);
                        }
                    } else {
                        this.f24267f = Math.min(Math.max(0.1f, (this.f24266c + (sqrt - this.f24265b)) / min), this.h - 0.02f);
                    }
                } else {
                    float f23 = x10 - this.f24270s;
                    float f24 = y10 - this.v;
                    float width2 = (getWidth() - jv0Var.f26062a) / 2.0f;
                    if (!z12) {
                    ...
                    float f25 = jv0Var.f26063b;
                    float x12 = e2.c.x(height2, f25, 2.0f, i11);
                    PointF pointF2 = new PointF(Math.max(width2, Math.min(jv0Var.f26062a + width2, this.f24264a.x + f23)), Math.max(x12, Math.min(f25 + x12, this.f24264a.y + f24)));
                    float f26 = pointF2.x - width2;
                    float f27 = jv0Var.f26062a;
                    this.e = new PointF(f26 / f27, (((f27 - jv0Var.f26063b) / 2.0f) + (pointF2.y - x12)) / f27);
                }
            }
            invalidate();
            cf0 cf0Var = this.I;
            if (cf0Var != null) {
                ...
                float f28 = this.f24267f;
                float f29 = this.h;
                of0 of0Var = ((gf0) cf0Var).f25135a;
                of0Var.U = f29;
                of0Var.V = pointF3;
                of0Var.W = f28;
                of0Var.f27524a0 = a(this.f24268n) + 1.5707964f;
        ...
        if (i15 == 0) {
            if (sqrt < f31) {
                this.J = 2;
                this.f24264a = actualCenterPoint;
                return;
            }
            float f32 = f13 - f30;
    ...
    public final void d(int i10, MotionEvent motionEvent) {
        if (i10 != 1) {
            ...
            this.f24271w = b(motionEvent);
            this.f24272x = 1.0f;
            this.J = 5;
        }
        float b10 = b(motionEvent);
        float c3 = vh.w2.c(b10 - this.f24271w, AndroidUtilities.density, 0.01f, this.f24272x);
        this.f24272x = c3;
        float max = Math.max(0.1f, this.f24267f * c3);
        this.f24267f = max;
        this.h = Math.max(max + 0.02f, this.h * this.f24272x);
        this.f24272x = 1.0f;
        this.f24271w = b10;
        invalidate();
        cf0 cf0Var = this.I;
    ...
    public final boolean onTouchEvent(android.view.MotionEvent r21) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.df0.onTouchEvent(android.view.MotionEvent):boolean");
    }
