...
public abstract class y8 extends FrameLayout {
    ...
    public final TLRPC.TL_emojiList f30938n;
    public final int f30939r;
    public int f30940s;
    public int v;
    public float f30941w;
    public boolean f30942x;
    public final x8 f30943y;
    ...
    public y8(Context context) {
        ...
        this.v = 0;
        this.f30941w = 1.0f;
        this.f30943y = new x8((cm) this);
        TLRPC.TL_emojiList a2 = a(i10);
        this.f30938n = a2;
        this.f30936c = new p9(context);
        this.d = new p9(context);
        addView(this.f30936c, k7.b6.e(50, 50, 1));
        addView(this.d, k7.b6.e(50, 50, 1));
        if (!a2.document_id.isEmpty()) {
            l5 l5Var = new l5(4, i10, a2.document_id.get(0).longValue());
            this.f30934a = l5Var;
            this.f30936c.setAnimatedEmojiDrawable(l5Var);
            b();
        }
        int[] iArr = w8.Z[this.f30940s];
        int i11 = iArr[0];
        int i12 = iArr[1];
        int i13 = iArr[2];
        int i14 = iArr[3];
    ...
    public static TLRPC.TL_emojiList a(int i10) {
        ...
        if (stickerSets.isEmpty()) {
            ...
            for (int i11 = 0; i11 < featuredEmojiSets.size(); i11++) {
                ...
                if (document != null) {
                    tL_emojiList2.document_id.add(Long.valueOf(document.f19165id));
                } else if (stickerSetCovered instanceof TLRPC.TL_stickerSetFullCovered) {
                    TLRPC.TL_stickerSetFullCovered tL_stickerSetFullCovered = (TLRPC.TL_stickerSetFullCovered) stickerSetCovered;
                    if (!tL_stickerSetFullCovered.documents.isEmpty()) {
                        tL_emojiList2.document_id.add(Long.valueOf(tL_stickerSetFullCovered.documents.get(0).f19165id));
                    }
                }
            }
        } else {
            for (int i12 = 0; i12 < stickerSets.size(); i12++) {
                ...
                if (!tL_messages_stickerSet.documents.isEmpty()) {
                    tL_emojiList2.document_id.add(Long.valueOf(tL_messages_stickerSet.documents.get(Math.abs(Utilities.fastRandom.nextInt() % tL_messages_stickerSet.documents.size())).f19165id));
                }
            }
        }
    ...
    public final void b() {
        ...
        int i10 = this.v + 1;
        TLRPC.TL_emojiList tL_emojiList = this.f30938n;
        if (i10 > tL_emojiList.document_id.size() - 1) {
            this.f30942x = true;
            return;
        }
        l5 l5Var = new l5(4, this.f30939r, tL_emojiList.document_id.get(i10).longValue());
        this.f30935b = l5Var;
        l5Var.f26589m = true;
        l5Var.v();
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        q20 q20Var2 = this.f30937f;
        if (q20Var2 != null) {
            q20Var2.b(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight());
        }
        float f10 = this.f30941w;
        if (f10 == 1.0f) {
            this.e.f28050c.setAlpha(255);
            canvas.drawRect(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight(), this.e.f28050c);
            this.f30936c.setAlpha(1.0f);
            this.f30936c.setScaleX(1.0f);
            this.f30936c.setScaleY(1.0f);
            this.d.setAlpha(0.0f);
        } else {
            float interpolation = mr.f27122f.getInterpolation(f10);
            this.e.f28050c.setAlpha(255);
            canvas.drawRect(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight(), this.e.f28050c);
            this.f30937f.f28050c.setAlpha((int) (255.0f * interpolation));
            canvas.drawRect(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight(), this.f30937f.f28050c);
            this.f30941w += 0.064f;
            float f11 = 1.0f - interpolation;
            this.f30936c.setAlpha(f11);
            this.f30936c.setScaleX(f11);
            this.f30936c.setScaleY(f11);
            this.f30936c.setPivotY(0.0f);
            ...
            if (this.f30941w > 1.0f) {
                this.f30941w = 1.0f;
                this.e = this.f30937f;
                p9 p9Var2 = this.f30936c;
                this.f30936c = this.d;
                this.d = p9Var2;
            }
            invalidate();
    ...
    public final void onAttachedToWindow() {
        ...
        AndroidUtilities.runOnUIThread(this.f30943y, 1000L);
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        AndroidUtilities.cancelRunOnUIThread(this.f30943y);
    }
    ...
    public void onMeasure(int i10, int i11) {
        ...
        ViewGroup.LayoutParams layoutParams = this.f30936c.getLayoutParams();
        this.f30936c.getLayoutParams().height = i12;
        layoutParams.width = i12;
        ViewGroup.LayoutParams layoutParams2 = this.d.getLayoutParams();
        this.d.getLayoutParams().height = i12;
        layoutParams2.width = i12;
        ((FrameLayout.LayoutParams) this.f30936c.getLayoutParams()).topMargin = i13;
