            ...
            case 0:
                ...
                if (actionMasked == 0 || actionMasked == 5) {
                    if (motionEvent.getPointerCount() == 1) {
                        fg0Var.f23921f0 = true;
                        fg0Var.f23922g0 = new float[]{motionEvent.getX(), motionEvent.getY()};
                        AndroidUtilities.runOnUIThread(fg0Var.f23923h0, 500L);
                    } else {
                ...
                if (actionMasked != 1 && actionMasked != 3 && actionMasked != 6) {
                    if (actionMasked == 2 && (photoViewer = fg0Var.V) != null && (mt0Var = photoViewer.f30936c4) != null && mt0Var.rewinding) {
                ...
                if (fg0Var.f23933y != null) {
                    MotionEvent obtain = MotionEvent.obtain(motionEvent);
                    obtain.offsetLocation(fg0Var.f23933y.getX(), fg0Var.f23933y.getY());
                    boolean dispatchTouchEvent = fg0Var.f23933y.dispatchTouchEvent(motionEvent);
                    obtain.recycle();
                    if (actionMasked == 1 || actionMasked == 3 || actionMasked == 6) {
                        fg0Var.f23933y = null;
                    }
                ...
                boolean onTouchEvent = fg0Var.f23930s.onTouchEvent(obtain2);
                obtain2.recycle();
                if (!fg0Var.f23930s.isInProgress() && fg0Var.v.y(motionEvent)) {
                    z10 = true;
                } else {
                    z10 = false;
                }
                if (actionMasked == 1 || actionMasked == 3 || actionMasked == 6) {
                    fg0Var.f23931w = false;
                    fg0Var.f23932x = false;
                    if (fg0Var.f23918d0) {
                        fg0Var.f23918d0 = false;
                        fg0 fg0Var2 = fg0.f23911p0;
                        vu vuVar = fg0Var2.U;
                        if (vuVar != null) {
                            vuVar.H();
                        } else {
    ...
    public void onConfigurationChanged(Configuration configuration) {
        ...
        switch (this.f23550a) {
            case 0:
                ...
                fg0 fg0Var = this.f23551b;
                fg0Var.G = null;
                AndroidUtilities.setPreferredMaxRefreshRate(fg0Var.f23914b, fg0Var.d, fg0Var.f23916c);
                if (fg0Var.H != fg0Var.t() * fg0Var.J || fg0Var.I != fg0Var.r() * fg0Var.J) {
                    ...
                    WindowManager.LayoutParams layoutParams2 = fg0Var.f23916c;
    ...
    public void onDraw(Canvas canvas) {
        switch (this.f23550a) {
            case 1:
                ...
                if (photoViewer != null && photoViewer.f30926b4 != null) {
                    canvas.save();
                    canvas.translate(getLeft(), getTop());
                    fg0Var.V.f30926b4.draw(canvas, getRight() - getLeft(), getBottom() - getTop());
                    canvas.restore();
                    return;
                }
                return;
