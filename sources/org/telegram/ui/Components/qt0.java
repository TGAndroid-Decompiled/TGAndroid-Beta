...
public final class qt0 extends ll0 {
    ...
    public pt0 f27404f;
    public final TLRPC.Chat f27405n;
    public final zu0 f27407s;
    public ArrayList d = new ArrayList();
    public int h = 0;
    public int f27406r = 0;
    ...
    public final void F(String str, boolean z10) {
        ...
        if (this.f27404f != null) {
            Utilities.searchQueue.cancelRunnable(this.f27404f);
            this.f27404f = null;
        }
        this.d.clear();
        this.e.f(null, null);
        gg.c2 c2Var = this.e;
        if (ChatObject.isChannel(this.f27405n)) {
            j3 = this.f27405n.f18121id;
        } else {
            j3 = 0;
        }
        ...
        int i10 = 0;
        while (true) {
            st0[] st0VarArr = this.f27407s.f30635k0;
            if (i10 >= st0VarArr.length) {
                break;
            }
            if (st0VarArr[i10].F == 7 && !TextUtils.isEmpty(str)) {
                this.f27407s.f30635k0[i10].f27927w.e(true, z10);
            }
            i10++;
        }
    ...
    public final void l() {
        ...
        this.h = size;
        if (size > 0) {
            zu0 zu0Var = this.f27407s;
            if (zu0Var.V0) {
                st0 st0Var = zu0Var.f30635k0[0];
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        zu0 zu0Var = this.f27407s;
        org.telegram.ui.Cells.a5 a5Var = new org.telegram.ui.Cells.a5(9, 5, this.f27403c, zu0Var.F1, true);
        a5Var.setBackgroundColor(zu0Var.h0(org.telegram.ui.ActionBar.j6.f18863d6));
