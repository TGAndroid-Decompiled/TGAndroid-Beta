...
public final class fa0 extends org.telegram.ui.ActionBar.p2 implements su0, ag.b, NotificationCenter.NotificationCenterDelegate {
    ...
    public int f26856r;
    public FrameLayout f26857s;
    public final FrameLayout[] v;
    public final org.telegram.ui.ActionBar.l5[] f26858w;
    public final k6[] f26859x;
    public aa0 f26860y;

    public fa0(Bundle bundle, ru0 ru0Var) {
        super(bundle);
        this.v = new FrameLayout[2];
        this.f26858w = new org.telegram.ui.ActionBar.l5[2];
        this.f26859x = new k6[2];
        this.I = true;
        this.J = true;
        this.K = -12;
    ...
    public final void M() {
        ru0 ru0Var;
        ca0 ca0Var = this.S;
        if (ca0Var != null && (ru0Var = this.f26851b) != null) {
            ca0Var.setNewMediaCounts(ru0Var.f30867c);
        }
        a0();
    }

    public final void X(TLRPC.ChatFull chatFull) {
        this.f26852c = chatFull;
    }
    ...
    public final void Y(int i10, boolean z4, boolean z10) {
        ...
        if (i11 != 3) {
            if (i10 != 1 || i11 != 2) {
                ...
                fArr[i10] = f10;
                org.telegram.ui.ActionBar.l5[] l5VarArr = this.f26858w;
    ...
    public final void Z() {
        ...
        this.actionBar.setBackgroundColor(org.telegram.ui.ActionBar.k6.w0(null, org.telegram.ui.ActionBar.k6.f21605a7, false));
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.userInfoDidLoad && ((Long) objArr[0]).longValue() == this.f26853e) {
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.m6(null, 0, null, null, null, t6Var, org.telegram.ui.ActionBar.k6.f21659d6));
        arrayList.add(new org.telegram.ui.ActionBar.m6(null, 0, null, null, null, t6Var, org.telegram.ui.ActionBar.k6.f22055z8));
    ...
    public final boolean onFragmentCreate() {
        int i10;
        this.f26850a = getArguments().getInt("type", 0);
        this.f26853e = getArguments().getLong("dialog_id");
        this.f26854f = getArguments().getLong("topic_id", 0L);
        this.h = getArguments().getString("hashtag", "");
        this.f26855n = getArguments().getString("username", "");
        this.f26856r = getArguments().getInt("storiesCount", -1);
        int i11 = this.f26850a;
        if (i11 == 2) {
            i10 = 9;
        } else if (i11 == 1) {
        ...
        if (DialogObject.isUserDialog(this.f26853e) && this.f26854f == 0) {
            TLRPC.User user = getMessagesController().getUser(Long.valueOf(this.f26853e));
            if (UserObject.isUserSelf(user)) {
                getMessagesController().loadUserInfo(user, false, this.classGuid);
                this.d = getMessagesController().getUserFull(this.f26853e);
            }
        }
        if (this.f26851b == null) {
            this.f26851b = new ru0(this);
        }
        this.f26851b.f30874x.add(this);
