...
public final class fa0 implements org.telegram.ui.ActionBar.z1, gh.b, rv0, sv0, ImageReceiver.ImageReceiverDelegate, r0.n, GenericProvider, LanguageDetector.ExceptionCallback {
    ...
    public void b(Object obj, float f7) {
        switch (this.f24118a) {
            case 3:
                jd0 jd0Var = (jd0) obj;
                jd0Var.f25391f = f7;
                if (!jd0Var.f25397y || jd0Var.F) {
                    jd0Var.f25390c.setStrokeWidth(AndroidUtilities.lerp(jd0Var.v, jd0Var.f25395w, f7));
                    jd0Var.f();
                }
                jd0Var.invalidate();
                return;
            ...
            case 11:
                ...
                try {
                    AndroidUtilities.updateViewLayout(og0Var.f27045b, og0Var.d, layoutParams);
                    return;
            ...
            case 13:
                og0 og0Var2 = (og0) obj;
                WindowManager.LayoutParams layoutParams2 = og0Var2.f27047c;
                og0Var2.L = f7;
                layoutParams2.y = (int) f7;
                try {
                    AndroidUtilities.updateViewLayout(og0Var2.f27045b, og0Var2.d, layoutParams2);
                    return;
            ...
            default:
                ...
                AndroidUtilities.updateViewLayout(k1Var.f29414b, k1Var.d, layoutParams3);
                return;
        }
    }
    ...
    public float get(Object obj) {
        switch (this.f24118a) {
            case 2:
                return ((jd0) obj).f25391f;
            case 4:
                return ((jd0) obj).f25392n;
            case 6:
                return ((jd0) obj).f25394s;
            case 10:
                return ((og0) obj).K;
            case 12:
                return ((og0) obj).L;
            case 17:
                return ((jp0) obj).f25460n;
            default:
