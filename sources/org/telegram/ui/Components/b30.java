    ...
    public final void run() {
        switch (this.f22866a) {
            case 0:
                ...
                return;
            case 1:
                nf.f.s(this.f22867b, LocaleController.getString(R.string.StarsTOSLink));
                return;
            case 2:
                Activity findActivity = AndroidUtilities.findActivity(this.f22867b);
                ...
                return;
            default:
                Activity findActivity2 = AndroidUtilities.findActivity(this.f22867b);
