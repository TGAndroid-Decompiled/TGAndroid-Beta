    ...
    public final void run() {
        switch (this.f22557a) {
            case 0:
                ...
                return;
            case 1:
                nf.f.s(this.f22558b, LocaleController.getString(R.string.StarsTOSLink));
                return;
            case 2:
                Activity findActivity = AndroidUtilities.findActivity(this.f22558b);
                ...
                return;
            default:
                Activity findActivity2 = AndroidUtilities.findActivity(this.f22558b);
