...
public final class q0 implements View.OnClickListener {
    ...
    public final void onClick(View view) {
        ...
        switch (this.f28020a) {
            case 0:
                this.f28022c[0] = ((Integer) view.getTag()).intValue();
                LinearLayout linearLayout = this.f28021b;
                ...
                for (int i10 = 0; i10 < childCount; i10++) {
                    ...
                    if (childAt instanceof org.telegram.ui.Cells.k6) {
                        ...
                        k6Var.f21305c.a(z4, true);
                    }
                }
                return;
            default:
                LinearLayout linearLayout2 = this.f28021b;
                ...
                for (int i11 = 0; i11 < childCount2; i11++) {
                    ...
                    k6Var2.f21305c.a(z10, true);
                }
                this.f28022c[0] = org.telegram.ui.Cells.u8.f22413f[((Integer) view.getTag()).intValue()];
                return;
        }
    }
