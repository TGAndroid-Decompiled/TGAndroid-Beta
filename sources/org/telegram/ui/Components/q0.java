...
public final class q0 implements View.OnClickListener {
    ...
    public final void onClick(View view) {
        ...
        switch (this.f27468a) {
            case 0:
                this.f27470c[0] = ((Integer) view.getTag()).intValue();
                LinearLayout linearLayout = this.f27469b;
                ...
                for (int i10 = 0; i10 < childCount; i10++) {
                    ...
                    if (childAt instanceof org.telegram.ui.Cells.l6) {
                        ...
                        l6Var.f20613c.a(z10, true);
                    }
                }
                return;
            default:
                LinearLayout linearLayout2 = this.f27469b;
                ...
                for (int i11 = 0; i11 < childCount2; i11++) {
                    ...
                    l6Var2.f20613c.a(z11, true);
                }
                this.f27470c[0] = org.telegram.ui.Cells.y8.f21888f[((Integer) view.getTag()).intValue()];
                return;
        }
    }
