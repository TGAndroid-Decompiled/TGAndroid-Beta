    ...
    public final void run() {
        switch (this.f29899a) {
            case 0:
                ...
                return;
            case 1:
                g71 g71Var2 = ((f71) this.f29900b).f23845f;
                g71Var2.f24228a0.removeCallbacksAndMessages(null);
                g71Var2.K.onVisualizerUpdate(false, true, null);
                return;
            case 2:
                ((i71) this.f29900b).f24920g = false;
                return;
            case 3:
                ((c91) ((j50) ((org.telegram.ui.Cells.fa) this.f29900b).f20113b).f25235b).v.b();
                return;
            default:
                ((y81) this.f29900b).d(false, true);
                return;
        }
    }
}
