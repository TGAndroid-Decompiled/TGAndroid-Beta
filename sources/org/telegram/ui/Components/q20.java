...
public final class q20 implements ValueAnimator.AnimatorUpdateListener {
    ...
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        ...
        int i11 = this.f29582e;
        int i12 = this.d;
        int i13 = this.f29581c;
        int i14 = this.f29580b;
        View view = this.f29583f;
        switch (i10) {
            case 0:
                r20 r20Var = (r20) view;
                ...
                r20Var.f29920r.setColor(r20Var.M);
            ...
            default:
                ...
                k8Var.f52200r = i0.a.d(floatValue2, i14, i13);
                k8Var.f52201s = i0.a.d(floatValue2, i12, i11);
