...
public final class q20 extends s4.o {
    ...
    public final ArrayList f27475c;
    public final t20 d;

    public q20(t20 t20Var, ArrayList arrayList, ArrayList arrayList2) {
        this.d = t20Var;
        this.f27474b = arrayList;
        this.f27475c = arrayList2;
    }
    ...
    public final boolean b(int i10, int i11) {
        ...
        ArrayList arrayList2 = this.f27475c;
        if (size3 >= 0 && size3 < t20Var.f28382f.size() && size2 >= 0 && size2 < arrayList2.size()) {
            if (MessageObject.getPeerId(((TLRPC.GroupCallParticipant) arrayList2.get(size2)).peer) != MessageObject.getPeerId(((TLRPC.GroupCallParticipant) t20Var.f28382f.get(size3)).peer)) {
                return false;
            }
            return true;
        }
        ...
        if (i11 < t20Var.e.size()) {
            ...
            groupCallParticipant2 = (TLRPC.GroupCallParticipant) t20Var.f28382f.get(size3);
        }
    ...
    public final int d() {
        t20 t20Var = this.d;
        return t20Var.f28382f.size() + t20Var.e.size();
    }

    @Override
    public final int e() {
        return this.f27475c.size() + this.f27474b.size();
    }
}
