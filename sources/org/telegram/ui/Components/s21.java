...
public final class s21 extends FrameLayout {
    ...
    public final org.telegram.ui.ActionBar.e6 f27752b;
    public yo0 f27753c;
    public final c90 d;
    public final m6 e;
    public final ai.n4 f27754f;
    public final ImageView h;
    public boolean f27755n;
    public final c6 f27756r;
    public boolean f27757s;
    public int v;
    public long f27758w;
    ...
    public s21(Context context, int i10, org.telegram.ui.ActionBar.e6 e6Var) {
        super(context);
        this.f27756r = new c6(this, 360L, qr.h);
        this.f27757s = false;
        this.f27759x = false;
        this.f27760y = false;
    ...
    public int getTextColor() {
        ...
        org.telegram.ui.ActionBar.e6 e6Var = this.f27752b;
    ...
    public final void b(long j3, TLRPC.TL_forumTopic tL_forumTopic, boolean z10) {
        ...
        setSelected(z10);
        h();
        e(tL_forumTopic.unread_count, MessagesController.getInstance(this.f27751a).isDialogMuted(j3, this.f27758w), z11);
    ...
    public final void d(boolean z10, boolean z11, boolean z12) {
        ...
        if (z10) {
            ...
            p21Var.f26934b.setColor(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.Oh, this.f27752b));
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        if (view == this.d) {
            canvas.save();
            float e = this.f27756r.e(this.f27755n);
            if (e > 0.0f) {
                if (this.f27753c == null) {
                    this.f27753c = new yo0(this);
                }
                canvas.translate(getWidth() / 2.0f, getHeight() / 2.0f);
                this.f27753c.a(canvas, e);
                canvas.translate((-getWidth()) / 2.0f, (-getHeight()) / 2.0f);
            }
    ...
    public final void g(long j3, TLRPC.TL_forumTopic tL_forumTopic, boolean z10) {
        ...
        if (this.f27758w == peerDialogId) {
            z11 = true;
        } else {
            z11 = false;
        }
        this.f27758w = peerDialogId;
        this.h.setVisibility(8);
        c90 c90Var = this.d;
        c90Var.setVisibility(0);
        ...
        if (userOrChat != null) {
            ...
            f9 f9Var = g5Var3.f33769c;
            f9Var.j(g5Var3.e, userOrChat);
            g5Var3.f33768b.setForUserOrChat(userOrChat, f9Var);
