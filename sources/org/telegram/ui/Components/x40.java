...
public final class x40 extends org.telegram.ui.ActionBar.e3 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public x40(Context context, String str, org.telegram.ui.wn wnVar, org.telegram.ui.ActionBar.d6 d6Var) {
        ...
        frameLayout2.f29894c = imageView2;
        ...
        frameLayout2.f29893b = textView3;
        ...
        for (int i13 = 0; i13 < 2; i13++) {
            this.f30253b[i13] = new TextView(context);
            this.f30253b[i13].setTextSize(1, 16.0f);
            this.f30253b[i13].setTypeface(AndroidUtilities.bold());
            this.f30253b[i13].setTextColor(getThemedColor(org.telegram.ui.ActionBar.h6.f19165j5));
            frameLayout.addView(this.f30253b[i13], w7.y5.d(-2, -2.0f, 49, 17.0f, 340.0f, 17.0f, 0.0f));
            this.f30258s[i13] = new TextView(context);
            this.f30258s[i13].setTextSize(1, 14.0f);
            this.f30258s[i13].setTextColor(getThemedColor(org.telegram.ui.ActionBar.h6.f19315r5));
            this.f30258s[i13].setGravity(1);
            frameLayout.addView(this.f30258s[i13], w7.y5.d(-2, -2.0f, 49, 30.0f, 368.0f, 30.0f, 44.0f));
            if (i13 == 0) {
                this.f30258s[i13].setText(LocaleController.getString(R.string.ImportImportingInfo));
            } else {
                this.f30258s[i13].setAlpha(0.0f);
                this.f30258s[i13].setTranslationY(AndroidUtilities.dp(10.0f));
                this.f30253b[i13].setAlpha(0.0f);
                this.f30253b[i13].setTranslationY(AndroidUtilities.dp(10.0f));
            }
        }
        if (this.e != null) {
            ...
            this.f30254c.setText(String.format("%d%%", Integer.valueOf(importingHistory.uploadProgress)));
            this.d.a(importingHistory.uploadProgress / 100.0f, false);
            this.f30253b[0].setText(LocaleController.formatString("ImportCount", R.string.ImportCount, AndroidUtilities.formatFileSize(importingHistory.getUploadedCount()), AndroidUtilities.formatFileSize(importingHistory.getTotalCount())));
            this.f30258s[1].setText(LocaleController.getString(R.string.ImportDoneInfo));
            this.f30253b[1].setText(LocaleController.getString(R.string.ImportDoneTitle));
        ...
        this.f30254c.setText(String.format("%d%%", Integer.valueOf(importingStickers.uploadProgress)));
        this.d.a(importingStickers.uploadProgress / 100.0f, false);
        this.f30253b[0].setText(LocaleController.formatString("ImportCount", R.string.ImportCount, AndroidUtilities.formatFileSize(importingStickers.getUploadedCount()), AndroidUtilities.formatFileSize(importingStickers.getTotalCount())));
        this.f30258s[1].setText(LocaleController.getString(R.string.ImportStickersDoneInfo));
        this.f30253b[1].setText(LocaleController.getString(R.string.ImportStickersDoneTitle));
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        x80 x80Var = this.d;
        TextView[] textViewArr = this.f30253b;
        TextView textView = this.f30254c;
        lj0 lj0Var = this.f30255f;
        if (i10 == i12) {
            if (objArr.length > 1) {
                dismiss();
                return;
            ...
            if (!this.f30256n && ((180 - lj0Var.getAnimatedDrawable().f25068a0) * 16.6d) + 3000.0d >= importingHistory.timeUntilFinish) {
            ...
            if (!this.f30256n && ((180 - lj0Var.getAnimatedDrawable().f25068a0) * 16.6d) + 3000.0d >= importingStickers.timeUntilFinish) {
                lj0Var.setAutoRepeat(false);
                this.f30256n = true;
            }
    ...
    public final void m() {
        this.f30256n = true;
        this.f30255f.setAutoRepeat(false);
        w40 w40Var = this.h;
        ...
        TextView[] textViewArr = this.f30258s;
        ...
        TextView[] textViewArr2 = this.f30253b;
        ...
        w40Var.f29892a.animate().scaleY(1.0f).setInterpolator(new OvershootInterpolator(1.02f)).setDuration(250L).start();
        w40Var.f29894c.animate().scaleY(1.0f).scaleX(1.0f).setInterpolator(new OvershootInterpolator(1.02f)).setDuration(250L).start();
        w40Var.f29894c.d();
        animatorSet.start();
    }
}
