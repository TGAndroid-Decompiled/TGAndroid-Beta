...
public final class x40 extends org.telegram.ui.ActionBar.e3 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final lj0 f30241f;
    public final w40 h;
    public boolean f30242n;
    public final ij0 f30243r;
    public final TextView[] f30244s;
    public final String v;

    public x40(Context context, String str, org.telegram.ui.wn wnVar, org.telegram.ui.ActionBar.d6 d6Var) {
        super(1, context, d6Var, false);
        this.f30239b = new TextView[2];
        this.f30244s = new TextView[2];
        ...
        frameLayout2.f29879c = imageView2;
        ...
        frameLayout2.f29878b = textView3;
        ...
        for (int i13 = 0; i13 < 2; i13++) {
            this.f30239b[i13] = new TextView(context);
            this.f30239b[i13].setTextSize(1, 16.0f);
            this.f30239b[i13].setTypeface(AndroidUtilities.bold());
            this.f30239b[i13].setTextColor(getThemedColor(org.telegram.ui.ActionBar.h6.f19151j5));
            frameLayout.addView(this.f30239b[i13], w7.y5.d(-2, -2.0f, 49, 17.0f, 340.0f, 17.0f, 0.0f));
            this.f30244s[i13] = new TextView(context);
            this.f30244s[i13].setTextSize(1, 14.0f);
            this.f30244s[i13].setTextColor(getThemedColor(org.telegram.ui.ActionBar.h6.f19301r5));
            this.f30244s[i13].setGravity(1);
            frameLayout.addView(this.f30244s[i13], w7.y5.d(-2, -2.0f, 49, 30.0f, 368.0f, 30.0f, 44.0f));
            if (i13 == 0) {
                this.f30244s[i13].setText(LocaleController.getString(R.string.ImportImportingInfo));
            } else {
                this.f30244s[i13].setAlpha(0.0f);
                this.f30244s[i13].setTranslationY(AndroidUtilities.dp(10.0f));
                this.f30239b[i13].setAlpha(0.0f);
                this.f30239b[i13].setTranslationY(AndroidUtilities.dp(10.0f));
            }
        }
        if (this.e != null) {
            ...
            this.f30240c.setText(String.format("%d%%", Integer.valueOf(importingHistory.uploadProgress)));
            this.d.a(importingHistory.uploadProgress / 100.0f, false);
            this.f30239b[0].setText(LocaleController.formatString("ImportCount", R.string.ImportCount, AndroidUtilities.formatFileSize(importingHistory.getUploadedCount()), AndroidUtilities.formatFileSize(importingHistory.getTotalCount())));
            this.f30244s[1].setText(LocaleController.getString(R.string.ImportDoneInfo));
            this.f30239b[1].setText(LocaleController.getString(R.string.ImportDoneTitle));
        ...
        this.f30240c.setText(String.format("%d%%", Integer.valueOf(importingStickers.uploadProgress)));
        this.d.a(importingStickers.uploadProgress / 100.0f, false);
        this.f30239b[0].setText(LocaleController.formatString("ImportCount", R.string.ImportCount, AndroidUtilities.formatFileSize(importingStickers.getUploadedCount()), AndroidUtilities.formatFileSize(importingStickers.getTotalCount())));
        this.f30244s[1].setText(LocaleController.getString(R.string.ImportStickersDoneInfo));
        this.f30239b[1].setText(LocaleController.getString(R.string.ImportStickersDoneTitle));
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        x80 x80Var = this.d;
        TextView[] textViewArr = this.f30239b;
        TextView textView = this.f30240c;
        lj0 lj0Var = this.f30241f;
        if (i10 == i12) {
            if (objArr.length > 1) {
                dismiss();
                return;
            ...
            if (!this.f30242n && ((180 - lj0Var.getAnimatedDrawable().f25042a0) * 16.6d) + 3000.0d >= importingHistory.timeUntilFinish) {
            ...
            if (!this.f30242n && ((180 - lj0Var.getAnimatedDrawable().f25042a0) * 16.6d) + 3000.0d >= importingStickers.timeUntilFinish) {
                lj0Var.setAutoRepeat(false);
                this.f30242n = true;
            }
    ...
    public final void m() {
        this.f30242n = true;
        this.f30241f.setAutoRepeat(false);
        w40 w40Var = this.h;
        w40Var.setVisibility(0);
        AnimatorSet animatorSet = new AnimatorSet();
        animatorSet.setDuration(250L);
        animatorSet.setInterpolator(rr.f28023g);
        ...
        TextView[] textViewArr = this.f30244s;
        ...
        TextView[] textViewArr2 = this.f30239b;
        ...
        w40Var.f29877a.animate().scaleY(1.0f).setInterpolator(new OvershootInterpolator(1.02f)).setDuration(250L).start();
        w40Var.f29879c.animate().scaleY(1.0f).scaleX(1.0f).setInterpolator(new OvershootInterpolator(1.02f)).setDuration(250L).start();
        w40Var.f29879c.d();
        animatorSet.start();
    }
}
