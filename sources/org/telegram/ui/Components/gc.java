...
public final class gc extends FrameLayout {
    public final e6 f26335a;
    public final e6 f26336b;
    public final Paint f26337c;
    public final RectF d;
    public final long f26338e;
    public final hc f26339f;

    public gc(hc hcVar, Activity activity) {
        super(activity);
        this.f26339f = hcVar;
        pr prVar = pr.h;
        this.f26335a = new e6(this, 320L, prVar);
        this.f26336b = new e6(this, 320L, prVar);
        ...
        this.d = new RectF();
        this.f26338e = System.currentTimeMillis();
    }

    @Override
    public final void onDraw(Canvas canvas) {
        boolean z10;
        hc hcVar = this.f26339f;
        float d = this.f26335a.d(hcVar.f26702a, false);
        if (hcVar.f26702a >= 1.0f) {
            z10 = true;
        } else {
            z10 = false;
        }
        float e7 = this.f26336b.e(z10);
        ...
        float currentTimeMillis = (((float) (System.currentTimeMillis() - this.f26338e)) * 0.45f) % 5400.0f;
