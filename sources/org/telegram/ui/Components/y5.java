...
public class y5 extends ReplacementSpan {
    ...
    public y5(TLRPC.Document document, Paint.FontMetricsInt fontMetricsInt) {
        this(document.f17201id, 1.2f, fontMetricsInt);
        ...
        if (this.isAdded) {
            ...
            ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) {
                ...
                public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                    switch (r2) {
                        case 0:
                            y5.b(this.f26318b, valueAnimator2);
                            return;
                        default:
                            y5.a(this.f26318b, valueAnimator2);
                            return;
                    }
                }
            });
            ...
            this.scaleAnimator.setInterpolator(wr.f28819f);
            ...
            ofFloat2.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) {
                ...
                public final void onAnimationUpdate(ValueAnimator valueAnimator22) {
                    switch (r2) {
                        case 0:
                            y5.b(this.f26318b, valueAnimator22);
                            return;
                        default:
                            y5.a(this.f26318b, valueAnimator22);
                            return;
                    }
                }
            });
    ...
    public static void drawAnimatedEmojis(Canvas canvas, Layout layout, u5 u5Var, float f7, List<uh.h> list, float f10, float f11, float f12, float f13, ColorFilter colorFilter) {
        ...
        ArrayList arrayList = u5Var.f27565c;
        int i10 = 0;
        ...
        while (true) {
            ...
            if (w5Var.f28661a == layout) {
                ArrayList arrayList2 = w5Var.f28662b;
                int i12 = 0;
                while (i12 < arrayList2.size()) {
                    ...
                    if (t5Var != null) {
                        ...
                        if (y5Var.spanDrawn) {
                            ...
                            float max = (list == null || list.isEmpty() || !t5Var.v) ? 1.0f : Math.max(0.0f, list.get(i10).f42782n);
                            t5Var.f27332r = f12;
                            t5Var.f27333s = max;
                            t5Var.getClass();
                            ...
                            t5Var.f27331n = false;
                            p5 p5Var2 = t5Var.f27330f;
                            if (p5Var2 == null) {
                                if (t5Var.h != null) {
                                    float extraScale = t5Var.d.getExtraScale();
                                    t5Var.h.setAlpha((int) (t5Var.f27333s * 255.0f * f13));
                            ...
                            } else if (p5Var2.f26033k != null) {
                                p5Var2.setColorFilter(colorFilter == null ? org.telegram.ui.ActionBar.j6.f18251v3 : colorFilter);
                                t5Var.f27330f.q(currentTimeMillis);
                                float extraScale2 = t5Var.d.getExtraScale();
                                if (extraScale2 == 1.0f && !t5Var.d.invert) {
                                    p5 p5Var3 = t5Var.f27330f;
                                    Rect rect2 = t5Var.e;
                                    float f17 = t5Var.f27333s * f13;
                                    gg.h1 h1Var = p5Var3.f26033k;
                                    if (h1Var != null) {
                                        h1Var.setImageCoords(rect2);
                                        p5Var3.f26033k.setAlpha(f17);
                                        p5Var3.f26033k.draw(canvas);
                                    }
                                } else {
                                    canvas.save();
                                    canvas.scale((t5Var.d.invert ? -1 : 1) * extraScale2, extraScale2, t5Var.e.centerX(), t5Var.e.centerY());
                                    p5 p5Var4 = t5Var.f27330f;
                                    Rect rect3 = t5Var.e;
                                    float f18 = t5Var.f27333s * f13;
                                    gg.h1 h1Var2 = p5Var4.f26033k;
                                    if (h1Var2 != null) {
                                        h1Var2.setImageCoords(rect3);
                                        p5Var4.f26033k.setAlpha(f18);
                                        p5Var4.f26033k.draw(canvas);
                                    }
                                    canvas.restore();
                                }
    ...
    public y5(TLRPC.Document document, float f7, Paint.FontMetricsInt fontMetricsInt) {
        this(document.f17201id, f7, fontMetricsInt);
        this.document = document;
    }
    ...
    public static u5 update(int i10, View view, boolean z10, u5 u5Var, boolean z11, Layout... layoutArr) {
        ...
        while (i15 < layoutArr.length) {
            ...
            if (layout == null || !(layout.getText() instanceof Spanned)) {
                ...
                while (y5VarArr != null && i16 < y5VarArr.length) {
                    ...
                    if (y5Var == null) {
                        ...
                        if (r12 == 0) {
                            r12 = new Object();
                            r12.f27563a = new ArrayList();
                            r12.f27564b = new HashMap();
                            r12.f27565c = new ArrayList();
                        }
                        ArrayList arrayList2 = r12.f27563a;
                        int i17 = 0;
                        while (true) {
                            if (i17 >= arrayList2.size()) {
                                t5Var = fontMetricsInt;
                                break;
                            } else if (((t5) arrayList2.get(i17)).d == y5Var && ((t5) arrayList2.get(i17)).f27329c == layout) {
                        ...
                        if (t5Var == 0) {
                            ...
                            if (y5Var.documentAbsolutePath != null) {
                                i12 = i15;
                                t5Var2.f27330f = p5.n(UserConfig.selectedAccount, y5Var.getDocumentId(), y5Var.documentAbsolutePath, i13);
                            } else {
                                i12 = i15;
                                TLRPC.Document document = y5Var.document;
                                if (document != null) {
                                    t5Var2.f27330f = p5.m(UserConfig.selectedAccount, i13, document);
                                } else {
                                    long j3 = y5Var.documentId;
                                    if (j3 != 0) {
                                        t5Var2.f27330f = p5.n(UserConfig.selectedAccount, j3, null, i13);
                                    }
                                }
                            }
                            int i18 = y5Var.cacheType;
                            if ((i18 == 20 || i18 == 21) && !TextUtils.isEmpty(y5Var.emoji)) {
                                p5 p5Var = t5Var2.f27330f;
                                if (p5Var != null) {
                                    p5Var.r(y5Var.emoji);
                                } else {
                            ...
                            HashMap hashMap = r12.f27564b;
                            w5 w5Var = (w5) hashMap.get(layout);
                            if (w5Var == null) {
                                w5Var = new w5(view, layout);
                                hashMap.put(layout, w5Var);
                                r12.f27565c.add(w5Var);
                            }
                            w5Var.f28662b.add(t5Var2);
                            w5Var.a();
                            p5 p5Var2 = t5Var2.f27330f;
                            if (p5Var2 != null) {
                                p5Var2.b(t5Var2);
                            }
                        } else {
            ...
            if (u5Var2 != null) {
                ArrayList arrayList3 = u5Var2.f27563a;
                int i19 = 0;
                while (i19 < arrayList3.size()) {
                    if (((t5) arrayList3.get(i19)).f27329c == layout) {
        ...
        if (u5Var2 != null) {
            ArrayList arrayList4 = u5Var2.f27563a;
            int i21 = 0;
            while (i21 < arrayList4.size()) {
                Layout layout2 = ((t5) arrayList4.get(i21)).f27329c;
                int i22 = 0;
                while (true) {
