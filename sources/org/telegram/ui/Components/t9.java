...
public final class t9 extends View {
    public Bitmap f28937a;
    public Bitmap f28938b;
    ...
    public final void onDraw(Canvas canvas) {
        int i10;
        Bitmap bitmap;
        Paint paint = this.f28939c;
        for (int i11 = 0; i11 < this.d; i11++) {
            if (i11 < this.e) {
                i10 = org.telegram.ui.ActionBar.j6.f20066m5;
            } else {
                i10 = org.telegram.ui.ActionBar.j6.f20190t5;
            }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        for (int i12 = 0; i12 < this.d; i12++) {
            if (motionEvent.getX() > dp && motionEvent.getX() < AndroidUtilities.dp(48.0f) + dp && this.e != (i10 = i12 + 1)) {
                this.e = i10;
                s9 s9Var = this.f28940f;
                if (s9Var != null) {
                    View view = ((org.telegram.ui.Components.voip.t1) s9Var).f29955a;
                    if (i10 > 0) {
                        z4 = true;
                    }
                    view.setEnabled(z4);
