...
public final class jq implements TextWatcher {
    public final int f25414a = 1;
    public final int f25415b;
    public final View f25416c;
        ...
        switch (i11) {
            case 0:
                ...
                if (!mqVar.f26504r) {
                    ...
                    mqVar.f26495a.x0(color, mqVar.S, true);
                    mqVar.f26504r = false;
                    return;
                }
                return;
