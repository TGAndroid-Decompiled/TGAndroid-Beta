...
public final class jq implements TextWatcher {
    ...
    public final void afterTextChanged(Editable editable) {
        ...
        int i12 = this.f25396b;
        View view = this.f25397c;
        boolean z10 = false;
        switch (i11) {
            case 0:
                mq mqVar = (mq) view;
                ...
                if (!mqVar.f26223r) {
                    ...
                    mqVar.f26214a.x0(color, mqVar.S, true);
                    mqVar.f26223r = false;
                    return;
                }
                return;
