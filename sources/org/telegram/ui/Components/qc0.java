...
public abstract class qc0 extends qv0 implements r0.n, View.OnLayoutChangeListener {
    public final c5.e f30365t0;
    public View f30366u0;
    public pc0 f30367v0;
    public org.telegram.ui.ActionBar.f3 f30368w0;
    public int f30369x0;
    public int f30370y0;
    public boolean f30371z0;

    public qc0(Context context) {
        super(context, null);
        this.f30365t0 = new Object();
    }

    public void E(ViewGroup viewGroup, int i10, int i11, int[] iArr, int i12) {
        pc0 pc0Var;
        int max;
        if (viewGroup == this.f30366u0 && (pc0Var = this.f30367v0) != null && ((org.telegram.ui.u7) pc0Var).getListView() != null) {
            int top = this.f30367v0.getTop();
            if (i11 < 0) {
                if (top <= this.f30369x0) {
                    tl0 listView = ((org.telegram.ui.u7) this.f30367v0).getListView();
                    ...
                    return;
                } else if (this.f30368w0 != null && !this.f30366u0.canScrollVertically(i11)) {
                    this.f30368w0.onNestedScroll(viewGroup, 0, 0, i10, i11);
                    return;
                } else {
                    return;
                }
            }
            org.telegram.ui.ActionBar.f3 f3Var = this.f30368w0;
            if (f3Var != null) {
    ...
    public final boolean Z() {
        pc0 pc0Var = this.f30367v0;
        if (pc0Var != null && pc0Var.getTop() == this.f30369x0) {
            return true;
        }
        return false;
    }
    ...
    public final void a0(pc0 pc0Var, int i10) {
        this.f30370y0 = i10;
        if (this.f30367v0 != pc0Var) {
            this.f30367v0 = pc0Var;
            if (this.f30371z0 && pc0Var != null) {
    ...
    public final void b0() {
        View view = this.f30366u0;
        if (view != null && this.f30367v0 != null) {
            if (this.f30370y0 != 0) {
                this.f30369x0 = view.getPaddingTop() + this.f30370y0;
            } else {
                this.f30369x0 = (view.getMeasuredHeight() - this.f30366u0.getPaddingBottom()) - this.f30367v0.getMeasuredHeight();
            }
        }
    }
    ...
    public void j(ViewGroup viewGroup, int i10, int i11, int i12, int i13, int i14, int[] iArr) {
        ...
        if (viewGroup == this.f30366u0 && (pc0Var = this.f30367v0) != null && ((org.telegram.ui.u7) pc0Var).getListView() != null) {
            tl0 listView = ((org.telegram.ui.u7) this.f30367v0).getListView();
            if (this.f30367v0.getTop() == this.f30369x0) {
                iArr[1] = i13;
