...
public abstract class zg0 extends FrameLayout {
    public final y5 f30876a;
    public final TextView f30877b;
    public final org.telegram.ui.Cells.x1 f30878c;
    public final bh0 d;

    public zg0(bh0 bh0Var, Context context) {
        super(context);
        int i10;
        int i11;
        int i12;
        ...
        x1Var.setOnClickListener(new j80(this, 9));
    ...
    public final void a(String str, ArrayList arrayList, int i10, int i11, int i12, boolean z10) {
        ...
        this.f30877b.setText(spannableStringBuilder);
        org.telegram.ui.Cells.x1 x1Var = this.f30878c;
        if (i12 == 0) {
            if (this.d.f23021r.quiz) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        measureChildWithMargins(this.f30876a, i10, AndroidUtilities.dp(32.0f) + measuredWidth, makeMeasureSpec, 0);
