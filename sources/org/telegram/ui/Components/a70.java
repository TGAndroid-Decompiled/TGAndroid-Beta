...
public final class a70 extends ViewGroup {
    ...
    public final ArrayList f22324b;
    public m30 f22325c;
    public boolean d;
    public final b70 e;
    ...
    public final void a(m30 m30Var, boolean z10) {
        this.d = true;
        b70 b70Var = this.e;
        b70Var.f22672f0.k(m30Var, m30Var.getUid());
        AnimatorSet animatorSet = b70Var.f22670d0;
        if (animatorSet != null) {
            animatorSet.setupEndValues();
            b70Var.f22670d0.cancel();
        }
        this.f22323a = false;
        if (z10) {
            AnimatorSet animatorSet2 = new AnimatorSet();
            b70Var.f22670d0 = animatorSet2;
            animatorSet2.addListener(new z60(this, 1));
            b70Var.f22670d0.setDuration(150L);
            b70Var.f22670d0.setInterpolator(qr.f27420f);
    ...
    public final void b(m30 m30Var) {
        this.d = false;
        b70 b70Var = this.e;
        b70Var.f22672f0.l(m30Var.getUid());
        ...
        ArrayList arrayList = this.f22324b;
        arrayList.clear();
        arrayList.add(ObjectAnimator.ofFloat(this.f22325c, View.SCALE_X, 1.0f, 0.01f));
        arrayList.add(ObjectAnimator.ofFloat(this.f22325c, View.SCALE_Y, 1.0f, 0.01f));
        arrayList.add(ObjectAnimator.ofFloat(this.f22325c, View.ALPHA, 1.0f, 0.0f));
        requestLayout();
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        while (true) {
            ...
            if (!(childAt instanceof m30)) {
                ...
                if (childAt != this.f22325c && childAt.getMeasuredWidth() + i15 > dp) {
                ...
                if (childAt != this.f22325c) {
                    i15 = org.telegram.messenger.y0.C(9.0f, childAt.getMeasuredWidth(), i15);
                }
                i16 = org.telegram.messenger.y0.C(9.0f, childAt.getMeasuredWidth(), i16);
            }
            i14++;
            v1Var2 = v1Var;
        }
        ...
        if (b70Var.m0 != null) {
            if (b70Var.f22673g0) {
                f7 = Math.min(b70Var.f22684s0, dp6);
            } else {
                f7 = 0;
            }
        } else {
            f7 = hg.c.f(52.0f, Math.min(b70Var.f22684s0, dp6), 0);
        }
        int i17 = b70Var.f22686u0;
        if (b70Var.m0 == null && b70Var.f22672f0.m() > 0) {
            i12 = AndroidUtilities.dp(56.0f);
        } else {
            i12 = 0;
        }
        b70Var.f22686u0 = i12;
        if (f7 != b70Var.f22680o0 || i17 != i12) {
            b70Var.f22680o0 = f7;
            if (w0Var.getAdapter() != null && w0Var.getAdapter().h() > 0 && (K = w0Var.K(0)) != null) {
                w0Var.getAdapter().m(0);
                b70Var.R.h1(0, K.f42671a.getTop() - w0Var.getPaddingTop());
        ...
        int min = Math.min(b70Var.f22684s0, dp6);
        int i18 = b70Var.f22677k0;
        if (i18 != min) {
        ...
        boolean z10 = this.d;
        if (z10 && dp6 > b70Var.f22684s0) {
            AndroidUtilities.runOnUIThread(new Runnable(this) {
                public final a70 f30164b;
                ...
                public final void run() {
                    switch (r3) {
                        case 0:
                            b70 b70Var2 = this.f30164b.e;
                            b70Var2.V.smoothScrollTo(0, dp6 - b70Var2.f22684s0);
                            return;
                        default:
                            b70 b70Var3 = this.f30164b.e;
                            b70Var3.V.smoothScrollTo(0, dp6 - b70Var3.f22684s0);
                            return;
                    }
                }
            });
        ...
        if (!this.f22323a && (animatorSet = b70Var.f22670d0) != null) {
            animatorSet.playTogether(arrayList);
            b70Var.f22670d0.addListener(new z60(this, 0));
            b70Var.f22670d0.start();
            this.f22323a = true;
        }
        if (b70Var.f22670d0 == null) {
            b70Var.f22677k0 = min;
