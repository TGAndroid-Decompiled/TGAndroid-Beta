...
public class vu0 extends su0 {
    ...
    public final int f32549n;
    public final ArrayList f32550r;
    public oh.l6 f32551s;
    public final int v;
    public final tu0 f32552w;
    public boolean f32553x;
    public final ArrayList f32554y;
    ...
    public final String F(int i10) {
        ...
        if (l6Var == null || i10 < 0 || i10 >= l6Var.f17404i.size() || (messageObject = (MessageObject) this.f32551s.f17404i.get(i10)) == null || (storyItem = messageObject.storyItem) == null) {
            return null;
        }
    ...
    public final boolean M(int i10) {
        oh.l6 l6Var;
        if (!this.h && (l6Var = this.f32551s) != null) {
            if (l6Var instanceof oh.d6) {
                yu0 yu0Var = this.C;
                TLRPC.User user = MessagesController.getInstance(yu0Var.f33649s1.getCurrentAccount()).getUser(Long.valueOf(yu0Var.f33624g1));
                if (user != null && user.bot && user.bot_has_main_app && user.bot_can_edit) {
                    return true;
                }
                return false;
            } else if (i10 >= 0 && i10 < l6Var.f17404i.size()) {
                MessageObject messageObject = (MessageObject) this.f32551s.f17404i.get(i10);
                oh.l6 l6Var2 = this.f32551s;
                if (l6Var2.f17402f > 0) {
                    return true;
                }
    ...
    public final void N() {
        ...
        if (l6Var != null && !this.h) {
            yu0 yu0Var = this.C;
            boolean z4 = yu0Var.f33628i1;
            qt0[] qt0VarArr = yu0Var.f33625h0;
            int[] iArr = yu0Var.f33630j1;
            if ((!z4 || (yu0Var.f33626h1 && l6Var.g() > 1)) && this.f32551s.g() > 0 && !yu0Var.v0()) {
                boolean z10 = false;
                if (this.f32551s.g() < 5) {
                    iArr[1] = this.f32551s.g();
                    ...
                    yu0Var.f33626h1 = z10;
                } else if (yu0Var.f33626h1) {
                    yu0Var.f33626h1 = false;
    ...
    public final void P() {
        ...
        int O = O();
        this.f32551s.p(Math.min(100, Math.max(1, O / 2) * O * O), false);
    }
    ...
    public final int h() {
        ...
        int size = this.f32550r.size();
        if (!this.f32551s.l() || !this.C.i0()) {
            i10 = this.f32551s.g();
        }
        return size + i10;
    }
    ...
    public void l() {
        if (this.f32551s != null) {
            yu0 yu0Var = this.C;
            if (yu0Var.r0()) {
                ArrayList arrayList = this.f32550r;
                arrayList.clear();
                ArrayList E = MessagesController.getInstance(this.f32551s.f17400c).getStoriesController().E(yu0Var.f33624g1);
                if (E != null) {
                    arrayList.addAll(E);
                }
            }
    ...
    public final void v(f2.m1 m1Var, int i10) {
        ...
        char c3;
        boolean z11;
        if (this.f32551s != null && m1Var.f5879f == 19) {
            ...
            if (view instanceof org.telegram.ui.Cells.r7) {
                ...
                if (i10 >= 0 && i10 < arrayList.size()) {
                    ...
                    if (s6Var.H == null) {
                        ...
                        tL_storyItem.f21082id = i11;
                        tL_storyItem.attachPath = s6Var.f17741f;
                        MessageObject messageObject = new MessageObject(this.f32551s.f17400c, tL_storyItem);
                ...
                if (size >= 0 && size < this.f32551s.f17404i.size()) {
                    MessageObject messageObject2 = (MessageObject) this.f32551s.f17404i.get(size);
                    if (messageObject2 != null && this.f32551s.m(messageObject2.getId())) {
                        z4 = true;
                    } else {
                        z4 = false;
                    }
                    ...
                    if (yu0Var.f33666z1 && messageObject2 != null) {
                        SparseArray[] sparseArrayArr = yu0Var.W0;
                        if (messageObject2.getDialogId() == yu0Var.f33624g1) {
                            c3 = 0;
                        } else {
                            c3 = 1;
                        }
    ...
    public final f2.m1 x(ViewGroup viewGroup, int i10) {
        ...
        if (view instanceof org.telegram.ui.Cells.r7) {
            ((org.telegram.ui.Cells.r7) view).f23560a0 = true;
        }
        return x10;
    }
    ...
    public vu0(yu0 yu0Var, Context context, int i10, boolean z4) {
        ...
        TLRPC.User user;
        this.C = yu0Var;
        this.f32550r = new ArrayList();
        this.f32554y = new ArrayList();
        this.h = z4;
        this.f32549n = i10;
        ...
        if (!TextUtils.isEmpty(yu0Var.getStoriesHashtag())) {
            ...
            if (i10 > 0) {
                this.f32551s = p2Var.getMessagesController().getStoriesController().A(yu0Var.f33624g1, 0, i10, true);
            } else {
                this.f32551s = p2Var.getMessagesController().getStoriesController().A(yu0Var.f33624g1, z10 ? 4 : z4 ? 1 : 0, -1, true);
            }
        }
        oh.l6 l6Var = this.f32551s;
        if (l6Var != null) {
            this.v = l6Var.o();
            this.f32552w = new tu0(this, p2Var.getMessagesController().getStoriesController(), yu0Var.f33624g1, this.f32551s.f17400c);
        }
        N();
    }
