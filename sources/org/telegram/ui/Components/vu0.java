...
public class vu0 extends su0 {
    ...
    public final ArrayList f30090r;
    public nh.l6 f30091s;
    public final int v;
    public final tu0 f30092w;
    public boolean f30093x;
    public final ArrayList f30094y;
    ...
    public final String F(int i10) {
        ...
        if (l6Var == null || i10 < 0 || i10 >= l6Var.f15580i.size() || (messageObject = (MessageObject) this.f30091s.f15580i.get(i10)) == null || (storyItem = messageObject.storyItem) == null) {
            return null;
        }
    ...
    public final boolean M(int i10) {
        nh.l6 l6Var;
        if (!this.h && (l6Var = this.f30091s) != null) {
            if (l6Var instanceof nh.d6) {
                yu0 yu0Var = this.C;
                TLRPC.User user = MessagesController.getInstance(yu0Var.f31144s1.getCurrentAccount()).getUser(Long.valueOf(yu0Var.f31119g1));
                if (user != null && user.bot && user.bot_has_main_app && user.bot_can_edit) {
                    return true;
                }
                return false;
            } else if (i10 >= 0 && i10 < l6Var.f15580i.size()) {
                MessageObject messageObject = (MessageObject) this.f30091s.f15580i.get(i10);
                nh.l6 l6Var2 = this.f30091s;
                if (l6Var2.f15578f > 0) {
                    return true;
                }
    ...
    public final void N() {
        ...
        if (l6Var != null && !this.h) {
            yu0 yu0Var = this.C;
            boolean z4 = yu0Var.f31123i1;
            qt0[] qt0VarArr = yu0Var.f31120h0;
            int[] iArr = yu0Var.f31125j1;
            if ((!z4 || (yu0Var.f31121h1 && l6Var.g() > 1)) && this.f30091s.g() > 0 && !yu0Var.v0()) {
                boolean z10 = false;
                if (this.f30091s.g() < 5) {
                    iArr[1] = this.f30091s.g();
                    ...
                    yu0Var.f31121h1 = z10;
                } else if (yu0Var.f31121h1) {
                    yu0Var.f31121h1 = false;
    ...
    public final int O() {
        ...
        return yu0Var.f31132n1;
    }

    public final void P() {
        if (this.f30091s == null) {
            return;
        }
        int O = O();
        this.f30091s.p(Math.min(100, Math.max(1, O / 2) * O * O), false);
    }
    ...
    public final int h() {
        ...
        int size = this.f30090r.size();
        if (!this.f30091s.l() || !this.C.i0()) {
            i10 = this.f30091s.g();
        }
        return size + i10;
    }
    ...
    public void l() {
        if (this.f30091s != null) {
            yu0 yu0Var = this.C;
            if (yu0Var.r0()) {
                ArrayList arrayList = this.f30090r;
                arrayList.clear();
                ArrayList E = MessagesController.getInstance(this.f30091s.f15577c).getStoriesController().E(yu0Var.f31119g1);
                if (E != null) {
                    arrayList.addAll(E);
                }
            }
    ...
    public final void v(f2.l1 l1Var, int i10) {
        ...
        char c3;
        boolean z11;
        if (this.f30091s != null && l1Var.f5788f == 19) {
            ...
            if (view instanceof org.telegram.ui.Cells.r7) {
                ...
                if (i10 >= 0 && i10 < arrayList.size()) {
                    ...
                    if (s6Var.H == null) {
                        ...
                        tL_storyItem.f19419id = i11;
                        tL_storyItem.attachPath = s6Var.f15884f;
                        MessageObject messageObject = new MessageObject(this.f30091s.f15577c, tL_storyItem);
                ...
                if (size >= 0 && size < this.f30091s.f15580i.size()) {
                    MessageObject messageObject2 = (MessageObject) this.f30091s.f15580i.get(size);
                    if (messageObject2 != null && this.f30091s.m(messageObject2.getId())) {
                        z4 = true;
                    } else {
                        z4 = false;
                    }
                    ...
                    if (yu0Var.f31161z1 && messageObject2 != null) {
                        SparseArray[] sparseArrayArr = yu0Var.W0;
                        if (messageObject2.getDialogId() == yu0Var.f31119g1) {
                            c3 = 0;
                        } else {
                            c3 = 1;
                        }
    ...
    public final f2.l1 x(ViewGroup viewGroup, int i10) {
        ...
        if (view instanceof org.telegram.ui.Cells.r7) {
            ((org.telegram.ui.Cells.r7) view).f21766a0 = true;
        }
        return x10;
    }
    ...
    public vu0(yu0 yu0Var, Context context, int i10, boolean z4) {
        ...
        TLRPC.User user;
        this.C = yu0Var;
        this.f30090r = new ArrayList();
        this.f30094y = new ArrayList();
        this.h = z4;
        this.f30089n = i10;
        ...
        if (!TextUtils.isEmpty(yu0Var.getStoriesHashtag())) {
            ...
            if (i10 > 0) {
                this.f30091s = p2Var.getMessagesController().getStoriesController().A(yu0Var.f31119g1, 0, i10, true);
            } else {
                this.f30091s = p2Var.getMessagesController().getStoriesController().A(yu0Var.f31119g1, z10 ? 4 : z4 ? 1 : 0, -1, true);
            }
        }
        nh.l6 l6Var = this.f30091s;
        if (l6Var != null) {
            this.v = l6Var.o();
            this.f30092w = new tu0(this, p2Var.getMessagesController().getStoriesController(), yu0Var.f31119g1, this.f30091s.f15577c);
        }
        N();
    }
