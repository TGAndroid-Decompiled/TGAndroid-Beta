...
public class vu0 extends su0 {
    ...
    public final ArrayList f29437r;
    public ai.d9 f29438s;
    public final int v;
    public final tu0 f29439w;
    public boolean f29440x;
    public final ArrayList f29441y;
    ...
    public final String F(int i10) {
        ...
        if (d9Var == null || i10 < 0 || i10 >= d9Var.f718i.size() || (messageObject = (MessageObject) this.f29438s.f718i.get(i10)) == null || (storyItem = messageObject.storyItem) == null) {
            return null;
        }
    ...
    public final boolean M(int i10) {
        ai.d9 d9Var;
        if (!this.h && (d9Var = this.f29438s) != null) {
            if (d9Var instanceof ai.t8) {
                yu0 yu0Var = this.F;
                TLRPC.User user = MessagesController.getInstance(yu0Var.f30389v1.getCurrentAccount()).getUser(Long.valueOf(yu0Var.f30364j1));
                if (user != null && user.bot && user.bot_has_main_app && user.bot_can_edit) {
                    return true;
                }
                return false;
            } else if (i10 >= 0 && i10 < d9Var.f718i.size()) {
                MessageObject messageObject = (MessageObject) this.f29438s.f718i.get(i10);
                ai.d9 d9Var2 = this.f29438s;
                if (d9Var2.f716f > 0) {
                    return true;
                }
    ...
    public final void N() {
        ...
        if (d9Var != null && !this.h) {
            ...
            if ((!z10 || (yu0Var.f30366k1 && d9Var.g() > 1)) && this.f29438s.g() > 0 && !yu0Var.v0()) {
                boolean z11 = false;
                if (this.f29438s.g() < 5) {
                    iArr[1] = this.f29438s.g();
                    ...
                    yu0Var.f30366k1 = z11;
                } else if (yu0Var.f30366k1) {
                    yu0Var.f30366k1 = false;
    ...
    public final int O() {
        ...
        return yu0Var.f30377q1;
    }

    public final void P() {
        if (this.f29438s == null) {
            return;
        }
        int O = O();
        this.f29438s.p(Math.min(100, Math.max(1, O / 2) * O * O), false);
    }
    ...
    public final int h() {
        ...
        int size = this.f29437r.size();
        if (!this.f29438s.l() || !this.F.i0()) {
            i10 = this.f29438s.g();
        }
        return size + i10;
    }
    ...
    public void l() {
        if (this.f29438s != null) {
            yu0 yu0Var = this.F;
            if (yu0Var.r0()) {
                ArrayList arrayList = this.f29437r;
                arrayList.clear();
                ArrayList E = MessagesController.getInstance(this.f29438s.f715c).getStoriesController().E(yu0Var.f30364j1);
                if (E != null) {
                    arrayList.addAll(E);
                }
            }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        char c10;
        boolean z12;
        if (this.f29438s != null && c1Var.f42674f == 19) {
            ...
            if (view instanceof org.telegram.ui.Cells.t7) {
                ...
                if (i10 >= 0 && i10 < arrayList.size()) {
                    ...
                    if (k9Var.K == null) {
                        ...
                        tL_storyItem.f18344id = i11;
                        tL_storyItem.attachPath = k9Var.f1141f;
                        MessageObject messageObject = new MessageObject(this.f29438s.f715c, tL_storyItem);
                ...
                if (size >= 0 && size < this.f29438s.f718i.size()) {
                    MessageObject messageObject2 = (MessageObject) this.f29438s.f718i.get(size);
                    if (messageObject2 != null && this.f29438s.m(messageObject2.getId())) {
                        z10 = true;
                    } else {
                        z10 = false;
                    }
                    ...
                    if (yu0Var.C1 && messageObject2 != null) {
                        ...
                        if (messageObject2.getDialogId() == yu0Var.f30364j1) {
                            c10 = 0;
                        } else {
                            c10 = 1;
                        }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (view instanceof org.telegram.ui.Cells.t7) {
            ((org.telegram.ui.Cells.t7) view).f21363d0 = true;
        }
        return x10;
    }
    ...
    public vu0(yu0 yu0Var, Context context, int i10, boolean z10) {
        ...
        TLRPC.User user;
        this.F = yu0Var;
        this.f29437r = new ArrayList();
        this.f29441y = new ArrayList();
        this.h = z10;
        this.f29436n = i10;
        ...
        if (!TextUtils.isEmpty(yu0Var.getStoriesHashtag())) {
            ...
            if (i10 > 0) {
                this.f29438s = n2Var.getMessagesController().getStoriesController().A(yu0Var.f30364j1, 0, i10, true);
            } else {
                this.f29438s = n2Var.getMessagesController().getStoriesController().A(yu0Var.f30364j1, z11 ? 4 : z10 ? 1 : 0, -1, true);
            }
        }
        ai.d9 d9Var = this.f29438s;
        if (d9Var != null) {
            this.v = d9Var.o();
            this.f29439w = new tu0(this, n2Var.getMessagesController().getStoriesController(), yu0Var.f30364j1, this.f29438s.f715c);
        }
        N();
    }
