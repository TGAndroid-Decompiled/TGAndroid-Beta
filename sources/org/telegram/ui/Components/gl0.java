...
public final class gl0 extends m20 {
    ...
    public final boolean a() {
        if (((ml0) this.f24367b.f24749b).Y0 != null) {
            return true;
        }
        return false;
    }
    ...
    public final void b(MotionEvent motionEvent, View view) {
        ml0 ml0Var = (ml0) this.f24367b.f24749b;
        if (view != null) {
    ...
    public final boolean onDoubleTap(MotionEvent motionEvent) {
        ...
        if (view != null && (bl0Var = ml0Var.W0) != null && bl0Var.d1(view)) {
            ml0Var.W0.r0(this.f24366a, motionEvent.getX(), motionEvent.getY());
            this.f24366a = null;
            return true;
        }
        return false;
    ...
    public final boolean onSingleTapConfirmed(MotionEvent motionEvent) {
        bl0 bl0Var;
        View view = this.f24366a;
        if (view != null && (bl0Var = ((ml0) this.f24367b.f24749b).W0) != null && bl0Var.d1(view)) {
            b(motionEvent, this.f24366a);
            this.f24366a = null;
            return true;
        }
        return false;
