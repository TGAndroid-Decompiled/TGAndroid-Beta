...
public final class gl0 extends l20 {
    ...
    public final boolean a() {
        if (((ml0) this.f24342b.f24693b).Y0 != null) {
            return true;
        }
        return false;
    }
    ...
    public final void b(MotionEvent motionEvent, View view) {
        ml0 ml0Var = (ml0) this.f24342b.f24693b;
        if (view != null) {
    ...
    public final boolean onDoubleTap(MotionEvent motionEvent) {
        ...
        if (view != null && (bl0Var = ml0Var.W0) != null && bl0Var.d1(view)) {
            ml0Var.W0.r0(this.f24341a, motionEvent.getX(), motionEvent.getY());
            this.f24341a = null;
            return true;
        }
        return false;
    ...
    public final boolean onSingleTapConfirmed(MotionEvent motionEvent) {
        bl0 bl0Var;
        View view = this.f24341a;
        if (view != null && (bl0Var = ((ml0) this.f24342b.f24693b).W0) != null && bl0Var.d1(view)) {
            b(motionEvent, this.f24341a);
            this.f24341a = null;
            return true;
        }
        return false;
