...
public final class v81 extends AsyncTask {
    ...
    public v81(b91 b91Var, String str, int i10) {
        ...
        switch (i10) {
            case 1:
                this.d = b91Var;
                this.f31185c = new String[4];
                this.f31184b = str;
                return;
            case 2:
                this.d = b91Var;
                this.f31185c = new String[2];
                this.f31184b = str;
                return;
            case 3:
                this.d = b91Var;
    ...
    public final Object doInBackground(Object[] objArr) {
        switch (this.f31183a) {
            case 0:
                ...
                String[] strArr = this.f31185c;
                Locale locale = Locale.US;
                this.d.getClass();
                String c10 = b91.c(this, "http://www.aparat.com/video/video/embed/vt/frame/showvideo/yes/videohash/" + this.f31184b, null, true);
                if (isCancelled()) {
                    return null;
                }
                try {
                    Matcher matcher = b91.f24636r0.matcher(c10);
                    if (matcher.find()) {
            ...
            case 1:
                ...
                String[] strArr2 = this.f31185c;
                Locale locale2 = Locale.US;
                this.d.getClass();
                String c11 = b91.c(this, "https://coub.com/api/v2/coubs/" + this.f31184b + ".json", null, true);
                if (isCancelled()) {
                    return null;
                }
                try {
            ...
            case 2:
                ...
                try {
                    Matcher matcher2 = b91.f24637s0.matcher(c12);
                    if (matcher2.find()) {
            ...
            case 3:
                ...
                String[] strArr4 = this.f31185c;
                HashMap hashMap = new HashMap();
                hashMap.put("Client-ID", "jzkbprff40iqj646a697cyrvl0zt2m6");
                int indexOf = this.f31184b.indexOf(38);
                if (indexOf > 0) {
                    this.f31184b = this.f31184b.substring(0, indexOf);
                }
                Locale locale3 = Locale.US;
                this.d.getClass();
                String c13 = b91.c(this, "https://api.twitch.tv/kraken/streams/" + this.f31184b + "?stream_type=all", hashMap, false);
                if (isCancelled()) {
                    return null;
                }
                try {
                    new JSONObject(c13).getJSONObject("stream");
                    JSONObject jSONObject3 = new JSONObject(b91.c(this, "https://api.twitch.tv/api/channels/" + this.f31184b + "/access_token", hashMap, false));
                    ...
                    URLEncoder.encode("https://youtube.googleapis.com/v/" + this.f31184b, "UTF-8");
            ...
            default:
                ...
                String[] strArr5 = this.f31185c;
                Locale locale4 = Locale.US;
                this.d.getClass();
                String c14 = b91.c(this, "https://player.vimeo.com/video/" + this.f31184b + "/config", null, true);
                if (isCancelled()) {
                    return null;
                }
                try {
    ...
    public final void onPostExecute(Object obj) {
        switch (this.f31183a) {
            ...
            case 1:
                ...
                b91 b91Var2 = this.d;
                if (str2 != null) {
                    b91Var2.f24664w = true;
                    b91Var2.f24665x = str2;
                    String[] strArr = this.f31185c;
                    b91Var2.f24666y = strArr[1];
                    b91Var2.E = strArr[2];
                    b91Var2.F = strArr[3];
                    if (b91Var2.f24663s) {
                        b91Var2.i();
            ...
            case 2:
                ...
                b91 b91Var3 = this.d;
                if (str3 != null) {
                    b91Var3.f24664w = true;
                    b91Var3.f24665x = str3;
                    b91Var3.f24666y = this.f31185c[1];
                    if (b91Var3.f24663s) {
                        b91Var3.i();
                    }
                    b91Var3.j(false, true);
                    b91Var3.f24655f0.d(true, true);
                    return;
                } else if (!isCancelled()) {
                    b91Var3.h();
                    return;
            ...
            case 3:
                ...
                b91 b91Var4 = this.d;
                if (str4 != null) {
                    b91Var4.f24664w = true;
                    b91Var4.f24665x = str4;
                    b91Var4.f24666y = this.f31185c[1];
                    if (b91Var4.f24663s) {
                        b91Var4.i();
                    }
                    b91Var4.j(false, true);
                    b91Var4.f24655f0.d(true, true);
                    return;
                } else if (!isCancelled()) {
                    b91Var4.h();
                    return;
            ...
            default:
                ...
                b91 b91Var5 = this.d;
                if (str5 != null) {
                    b91Var5.f24664w = true;
                    b91Var5.f24665x = str5;
                    b91Var5.f24666y = this.f31185c[1];
                    if (b91Var5.f24663s) {
                        b91Var5.i();
                    }
                    b91Var5.j(false, true);
                    b91Var5.f24655f0.d(true, true);
                    return;
                } else if (!isCancelled()) {
                    b91Var5.h();
                    return;
