...
public final class v81 extends AsyncTask {
    ...
    public v81(b91 b91Var, String str, int i10) {
        ...
        switch (i10) {
            case 1:
                this.d = b91Var;
                this.f28691c = new String[4];
                this.f28690b = str;
                return;
            case 2:
                this.d = b91Var;
                this.f28691c = new String[2];
                this.f28690b = str;
                return;
            case 3:
                this.d = b91Var;
    ...
    public final Object doInBackground(Object[] objArr) {
        switch (this.f28689a) {
            case 0:
                ...
                String[] strArr = this.f28691c;
                Locale locale = Locale.US;
                this.d.getClass();
                String c10 = b91.c(this, "http://www.aparat.com/video/video/embed/vt/frame/showvideo/yes/videohash/" + this.f28690b, null, true);
                if (isCancelled()) {
                    return null;
                }
                try {
                    Matcher matcher = b91.f22610r0.matcher(c10);
                    if (matcher.find()) {
            ...
            case 1:
                ...
                String[] strArr2 = this.f28691c;
                Locale locale2 = Locale.US;
                this.d.getClass();
                String c11 = b91.c(this, "https://coub.com/api/v2/coubs/" + this.f28690b + ".json", null, true);
                if (isCancelled()) {
                    return null;
                }
                try {
            ...
            case 2:
                ...
                try {
                    Matcher matcher2 = b91.f22611s0.matcher(c12);
                    if (matcher2.find()) {
            ...
            case 3:
                ...
                String[] strArr4 = this.f28691c;
                HashMap hashMap = new HashMap();
                hashMap.put("Client-ID", "jzkbprff40iqj646a697cyrvl0zt2m6");
                int indexOf = this.f28690b.indexOf(38);
                if (indexOf > 0) {
                    this.f28690b = this.f28690b.substring(0, indexOf);
                }
                Locale locale3 = Locale.US;
                this.d.getClass();
                String c13 = b91.c(this, "https://api.twitch.tv/kraken/streams/" + this.f28690b + "?stream_type=all", hashMap, false);
                if (isCancelled()) {
                    return null;
                }
                try {
                    new JSONObject(c13).getJSONObject("stream");
                    JSONObject jSONObject3 = new JSONObject(b91.c(this, "https://api.twitch.tv/api/channels/" + this.f28690b + "/access_token", hashMap, false));
                    ...
                    URLEncoder.encode("https://youtube.googleapis.com/v/" + this.f28690b, "UTF-8");
            ...
            default:
                ...
                String[] strArr5 = this.f28691c;
                Locale locale4 = Locale.US;
                this.d.getClass();
                String c14 = b91.c(this, "https://player.vimeo.com/video/" + this.f28690b + "/config", null, true);
                if (isCancelled()) {
                    return null;
                }
                try {
    ...
    public final void onPostExecute(Object obj) {
        switch (this.f28689a) {
            ...
            case 1:
                ...
                b91 b91Var2 = this.d;
                if (str2 != null) {
                    b91Var2.f22637w = true;
                    b91Var2.f22638x = str2;
                    String[] strArr = this.f28691c;
                    b91Var2.f22639y = strArr[1];
                    b91Var2.E = strArr[2];
                    b91Var2.F = strArr[3];
                    if (b91Var2.f22636s) {
                        b91Var2.i();
            ...
            case 2:
                ...
                b91 b91Var3 = this.d;
                if (str3 != null) {
                    b91Var3.f22637w = true;
                    b91Var3.f22638x = str3;
                    b91Var3.f22639y = this.f28691c[1];
                    if (b91Var3.f22636s) {
                        b91Var3.i();
                    }
                    b91Var3.j(false, true);
                    b91Var3.f22628f0.d(true, true);
                    return;
                } else if (!isCancelled()) {
                    b91Var3.h();
                    return;
            ...
            case 3:
                ...
                b91 b91Var4 = this.d;
                if (str4 != null) {
                    b91Var4.f22637w = true;
                    b91Var4.f22638x = str4;
                    b91Var4.f22639y = this.f28691c[1];
                    if (b91Var4.f22636s) {
                        b91Var4.i();
                    }
                    b91Var4.j(false, true);
                    b91Var4.f22628f0.d(true, true);
                    return;
                } else if (!isCancelled()) {
                    b91Var4.h();
                    return;
            ...
            default:
                ...
                b91 b91Var5 = this.d;
                if (str5 != null) {
                    b91Var5.f22637w = true;
                    b91Var5.f22638x = str5;
                    b91Var5.f22639y = this.f28691c[1];
                    if (b91Var5.f22636s) {
                        b91Var5.i();
                    }
                    b91Var5.j(false, true);
                    b91Var5.f22628f0.d(true, true);
                    return;
                } else if (!isCancelled()) {
                    b91Var5.h();
                    return;
