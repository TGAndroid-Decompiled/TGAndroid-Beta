...
public final class m21 extends f61 {
    public final org.telegram.ui.n20 f26018f3;
    public final c6 f26019g3;
    public final c6 f26020h3;
    public final RectF f26021i3;
    public final Paint j3;
    public final c6 f26022k3;
    public Drawable f26023l3;
    public int f26024m3;
    public final Paint f26025n3;
    public final y21 f26026o3;
    ...
    public m21(y21 y21Var, Context context, int i10, l21 l21Var, d21 d21Var, d21 d21Var2, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.f26026o3 = y21Var;
        this.f26018f3 = new org.telegram.ui.n20();
        qr qrVar = qr.h;
        this.f26019g3 = new c6(this, 320L, qrVar);
        this.f26020h3 = new c6(this, 320L, qrVar);
        this.f26021i3 = new RectF();
        this.j3 = new Paint(1);
        this.f26022k3 = new c6(this, 420L, qrVar);
        this.f26025n3 = new Paint(1);
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        float f12;
        int i10;
        float e = this.f26019g3.e(canScrollHorizontally(-1));
        float e7 = this.f26020h3.e(canScrollHorizontally(1));
        ...
        if (f13 > width) {
            ...
            if (this.f26023l3 == null) {
                this.f26023l3 = getContext().getResources().getDrawable(R.drawable.msg_limit_pin).mutate();
            }
            int v02 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f18828b9, f6Var);
            if (this.f26024m3 != v02) {
                Drawable drawable = this.f26023l3;
                this.f26024m3 = v02;
                drawable.setColorFilter(new PorterDuffColorFilter(v02, PorterDuff.Mode.SRC_IN));
            }
            this.f26023l3.setBounds((int) (AndroidUtilities.dp(-17.0f) + f13), (int) (rectF.top + AndroidUtilities.dp(10.0f)), (int) (f13 + AndroidUtilities.dp(-7.0f)), (int) (rectF.top + AndroidUtilities.dp(20.0f)));
            this.f26023l3.draw(canvas2);
        } else {
            f7 = 14.0f;
            f10 = 1.0f;
        }
        super.dispatchDraw(canvas);
        y21 y21Var = this.f26026o3;
        long j3 = y21Var.H;
        long j10 = y21Var.V;
        c6 c6Var = this.f26022k3;
        if (j3 != j10) {
            y21Var.I = j3;
            c6Var.d(0.0f, true);
        }
        ...
        if (z10) {
            canvas2.save();
            org.telegram.ui.n20 n20Var = this.f26018f3;
            if (i14 > 0) {
