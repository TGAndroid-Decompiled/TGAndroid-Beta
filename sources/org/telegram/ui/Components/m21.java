...
public final class m21 extends g61 {
    ...
    public final z5 f26945d3;
    public Drawable f26946e3;
    public int f26947f3;
    public final Paint f26948g3;
    ...
    public m21(Context context, int i10, j21 j21Var, e21 e21Var, e21 e21Var2, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.f26945d3 = new z5(this, 320L, mr.h);
        this.f26948g3 = new Paint(1);
    }

    @Override
    public final void dispatchDraw(Canvas canvas) {
        Canvas canvas2;
        float e = this.f26945d3.e(canScrollVertically(-1));
        ...
        if (f10 > height) {
            ...
            if (this.f26946e3 == null) {
                this.f26946e3 = getContext().getResources().getDrawable(R.drawable.msg_limit_pin).mutate();
            }
            int v03 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19848b9, f6Var);
            if (this.f26947f3 != v03) {
                Drawable drawable = this.f26946e3;
                this.f26947f3 = v03;
                drawable.setColorFilter(new PorterDuffColorFilter(v03, PorterDuff.Mode.SRC_IN));
            }
            this.f26946e3.setBounds((int) (rectF.left + AndroidUtilities.dp(4.0f)), (int) (rectF.top + AndroidUtilities.dp(2.66f)), (int) (rectF.left + AndroidUtilities.dp(13.66f)), (int) (rectF.top + AndroidUtilities.dp(12.32f)));
            this.f26946e3.draw(canvas2);
        }
