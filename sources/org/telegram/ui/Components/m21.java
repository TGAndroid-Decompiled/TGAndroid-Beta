...
public final class m21 extends d61 {
    public final org.telegram.ui.l20 f28357f3;
    public final e6 f28358g3;
    public Drawable f28359h3;
    public int f28360i3;
    ...
    public m21(Context context, int i10, j21 j21Var, b21 b21Var, b21 b21Var2, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.f28357f3 = new org.telegram.ui.l20();
        this.f28358g3 = new e6(this, 320L, pr.h);
        this.j3 = new Paint(1);
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        Canvas canvas2;
        float e7 = this.f28358g3.e(canScrollVertically(-1));
        ...
        if (f7 > height) {
            int i12 = org.telegram.ui.ActionBar.j6.f20938s9;
            ...
            if (this.f28359h3 == null) {
                this.f28359h3 = getContext().getResources().getDrawable(R.drawable.msg_limit_pin).mutate();
            }
            int v03 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20629b9, f6Var);
            if (this.f28360i3 != v03) {
                Drawable drawable = this.f28359h3;
                this.f28360i3 = v03;
                drawable.setColorFilter(new PorterDuffColorFilter(v03, PorterDuff.Mode.SRC_IN));
            }
            this.f28359h3.setBounds((int) (rectF.left + AndroidUtilities.dp(4.0f)), (int) (rectF.top + AndroidUtilities.dp(2.66f)), (int) (rectF.left + AndroidUtilities.dp(13.66f)), (int) (rectF.top + AndroidUtilities.dp(12.32f)));
            this.f28359h3.draw(canvas2);
        }
        ...
        if (i10 > 0) {
            ...
            this.f28357f3.b(canvas2, rectF2, 1, e7);
            canvas2.restore();
            canvas2.restore();
        }
    }
