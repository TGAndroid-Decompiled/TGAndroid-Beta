...
public class ViewPagerFixed extends FrameLayout {
    ...
    private static final Interpolator interpolator = new ViewPagerFixed$$ExternalSyntheticLambda2(0);
    ...
    public void lambda$scrollToPosition$1(ValueAnimator valueAnimator) {
        ...
        if (this.animatingForward) {
            setTranslationX(view, (1.0f - fFloatValue) * viewArr[0].getMeasuredWidth());
            View view2 = this.viewPages[0];
            setTranslationX(view2, (-view2.getMeasuredWidth()) * fFloatValue);
        } else {
            setTranslationX(view, (1.0f - fFloatValue) * (-viewArr[0].getMeasuredWidth()));
            View view3 = this.viewPages[0];
            setTranslationX(view3, view3.getMeasuredWidth() * fFloatValue);
        }
    ...
    public void cancelTouches() {
        ...
        if (this.startedTracking) {
            ...
            float fDistanceInfluenceForSnapDuration = (distanceInfluenceForSnapDuration(Math.min(1.0f, (measuredWidth * 1.0f) / measuredWidth2)) * f) + f;
        ...
        this.tabsView.setDelegate(new TabsView.TabsViewDelegate() {
            ...
            public void onPageScrolled(float f) {
                ...
                if (viewPagerFixed6.animatingForward) {
                    ...
                    viewPagerFixed7.setTranslationX(viewArr[1], (1.0f - f) * viewArr[0].getMeasuredWidth());
                    ...
                    viewPagerFixed9.setTranslationX(viewArr2[1], (1.0f - f) * (-viewArr2[0].getMeasuredWidth()));
            ...
            if (view != null && view.getVisibility() == 0 && (recyclerListViewFindRecyclerView = findRecyclerView(this.viewPages[i])) != null) {
                for (int i2 = 0; i2 < recyclerListViewFindRecyclerView.getChildCount(); i2++) {
                    ...
                    if (childAt.getY() < AndroidUtilities.dp(100.0f) + AndroidUtilities.dp(203.0f)) {
                        ...
                        canvas.translate(this.viewPages[i].getX(), childAt.getY() + recyclerListViewFindRecyclerView.getY() + this.viewPages[i].getY() + getY());
                        childAt.draw(canvas);
    ...
    public float getPositionAnimated() {
        ...
        return (this.nextPosition * Utilities.clamp(1.0f - Math.abs(this.viewPages[1].getTranslationX() / getAvailableTranslationX()), 1.0f, 0.0f)) + fClamp;
    }

    public float getPositionVisibility(int i) {
        return getMeasuredWidth() == 0 ? MathUtils.clamp(1 - Math.abs(getCurrentPosition() - i), 0, 1) : MathUtils.clamp(1.0f - Math.abs(getPositionAnimated() - i), 0.0f, 1.0f);
    }
    ...
    public void rebuild(boolean z) {
        ...
        valueAnimatorOfFloat.addUpdateListener(new ViewPagerFixed$$ExternalSyntheticLambda0(this, 3));
        this.tabsAnimation.playTogether(valueAnimatorOfFloat);
        this.tabsAnimation.setInterpolator(interpolator);
    ...
    public static class TabsView extends FrameLayout {
        ...
        public class TabView extends View {
            ...
            public void onDraw(Canvas canvas) {
                ...
                if (this.currentTab.id != Integer.MAX_VALUE && TabsView.this.editingAnimationProgress != 0.0f) {
                    ...
                    canvas2.translate(AndroidUtilities.dp(0.66f) * f2, 0.0f);
                    canvas2.rotate(f2, getMeasuredWidth() / 2, getMeasuredHeight() / 2);
                }
                ...
                if (TabsView.this.selectorType == 9) {
                    ...
                    TabsView.this.textPaint.setColor(ColorUtils.blendARGB(TabsView.this.animatingIndicatorProgress, Theme.getColor(i4, TabsView.this.resourcesProvider), Theme.getColor(i3, TabsView.this.resourcesProvider)));
                } else {
                ...
                if (i13 > 0) {
                    ...
                    iDp = AndroidUtilities.dp(10.0f) + Math.max(AndroidUtilities.dp(10.0f), iCeil);
                } else {
                    str = null;
                    iCeil = 0;
                    iDp = 0;
                ...
                if (this.currentTab.id != Integer.MAX_VALUE && (TabsView.this.isEditing || TabsView.this.editingStartAnimationProgress != 0.0f)) {
                    iDp = (int) ((TabsView.this.editingStartAnimationProgress * (AndroidUtilities.dp(20.0f) - iDp)) + iDp);
                }
                int i14 = iDp;
                int i15 = this.currentTab.titleWidth;
                if (i14 != 0) {
                    iDp2 = AndroidUtilities.dp((str2 != null ? 1.0f : TabsView.this.editingStartAnimationProgress) * 6.0f) + i14;
                } else {
                    iDp2 = 0;
                }
                this.tabWidth = i15 + iDp2;
                ...
                if (str2 != null || (this.currentTab.id != Integer.MAX_VALUE && (TabsView.this.isEditing || TabsView.this.editingStartAnimationProgress != 0.0f))) {
                    ...
                    if (Theme.hasThemeKey(i12) && Theme.hasThemeKey(i8)) {
                        ...
                        if ((TabsView.this.animatingIndicator || TabsView.this.manualScrollingToPosition != -1) && ((i9 = this.currentTab.id) == i10 || i9 == i11)) {
                            TabsView.this.counterPaint.setColor(ColorUtils.blendARGB(TabsView.this.animatingIndicatorProgress, Theme.getColor(i8, TabsView.this.resourcesProvider), color));
                        } else {
                    ...
                    int iDp3 = AndroidUtilities.dp(6.0f) + measuredWidth + this.currentTab.titleWidth;
                    ...
                    this.rect.set(iDp3, iM$2, iDp3 + i14, AndroidUtilities.dp(20.0f) + iM$2);
                    RectF rectF = this.rect;
                    float f3 = AndroidUtilities.density * 11.5f;
                    canvas2.drawRoundRect(rectF, f3, f3, TabsView.this.counterPaint);
                    if (str2 != null) {
                        ...
                        canvas2.drawText(str2, ImageReceiver$$ExternalSyntheticOutline0.m(rectF2.width(), iCeil, 2.0f, rectF2.left), AndroidUtilities.dp(14.5f) + iM$2, TabsView.this.textCounterPaint);
                    }
                    if (this.currentTab.id != Integer.MAX_VALUE && (TabsView.this.isEditing || TabsView.this.editingStartAnimationProgress != 0.0f)) {
            ...
            public void onMeasure(int i, int i2) {
                setMeasuredDimension(TabsView.this.additionalTabWidth + AndroidUtilities.dp(TabsView.this.tabMarginDp * 2) + this.currentTab.getWidth(false, TabsView.this.textPaint), View.MeasureSpec.getSize(i2));
            }
        ...
        public TabsView(Context context, boolean z, int i, Theme.ResourcesProvider resourcesProvider) {
                    ...
                    LinearSmoothScroller linearSmoothScroller = new LinearSmoothScroller(recyclerView.getContext()) {
                        ...
                        public void onTargetFound(View view, RecyclerView.State state2, RecyclerView.SmoothScroller.Action action) {
                            ...
                            if (iCalculateDxToMakeVisible > 0 || (iCalculateDxToMakeVisible == 0 && view.getLeft() - AndroidUtilities.dp(21.0f) < 0)) {
                                ...
                                if (AndroidUtilities.dp(21.0f) + view.getRight() > TabsView.this.getMeasuredWidth()) {
                                    iCalculateDxToMakeVisible -= AndroidUtilities.dp(60.0f);
                                }
                            }
            ...
            this.listView.setOnItemClickListener(new ViewPagerFixed$TabsView$$ExternalSyntheticLambda4(this));
            this.listView.setOnItemLongClickListener(new ViewPagerFixed$TabsView$$ExternalSyntheticLambda4(this));
        ...
        public static float access$3116(TabsView tabsView, float f) {
        ...
        public boolean lambda$new$1(View view, int i) {
            ...
            return callback2Return.run(Integer.valueOf(((TabView) view).currentTab.id), view).booleanValue();
        }
        ...
        public void lambda$scrollToTab$2(ValueAnimator valueAnimator) {
            float fFloatValue = ((Float) valueAnimator.getAnimatedValue()).floatValue();
        ...
        public void lambda$setReordering$3(boolean z, View view) {
            TabsViewDelegate tabsViewDelegate;
        ...
        private void scrollToChild(int i) {
            ...
            if (this.listView.getVisibility() == 8 || this.listView.getMeasuredWidth() == 0) {
                AndroidUtilities.runOnUIThread(new EmojiView$$ExternalSyntheticLambda9(this, i, 17), 100L);
            } else {
                this.listView.smoothScrollToPosition(i);
            }
        }
        ...
        private void updateTabsWidths() {
            ...
            for (int i = 0; i < size; i++) {
                ...
                iDp += AndroidUtilities.dp(this.tabMarginDp * 2) + width + this.additionalTabWidth;
            }
        }
        ...
        public void addTab(int i, CharSequence charSequence) {
            ...
            this.allTabsWidth = RichMessageLayout$RichDetailsEndBlock$$ExternalSyntheticOutline0.m(this.tabMarginDp * 2, tab.getWidth(true, this.textPaint), this.allTabsWidth);
            this.tabs.add(tab);
        }
        ...
        public boolean drawChild(Canvas canvas, View view, long j) {
            ...
            if (view == this.listView) {
                ...
                if (this.animatingIndicator || this.manualScrollingToPosition != -1) {
                    ...
                    if (iFindFirstVisibleItemPosition == -1 || (viewHolderFindViewHolderForAdapterPosition = this.listView.findViewHolderForAdapterPosition(iFindFirstVisibleItemPosition)) == null) {
                        ...
                        if (this.additionalTabWidth != 0) {
                            ...
                            iDp = AndroidUtilities.dp(this.tabMarginDp) + (((int) (((i4 - i3) * this.animatingIndicatorProgress) + i3)) - (this.positionToX.get(iFindFirstVisibleItemPosition) - viewHolderFindViewHolderForAdapterPosition.itemView.getLeft()));
                        }
                ...
                int x = (int) (this.listView.getX() + iDp);
                if (iLerp != 0) {
                    ...
                    if (i7 != 9 && i7 != 10) {
                        ...
                        if (this.selectorType != -2) {
                            this.selectorDrawable.setBounds(x, (int) ((this.hideProgress * AndroidUtilities.dpr(4.0f)) + (measuredHeight - AndroidUtilities.dpr(4.0f))), iLerp + x, (int) ((this.hideProgress * AndroidUtilities.dpr(4.0f)) + measuredHeight));
                            this.selectorDrawable.draw(canvas);
                            return zDrawChild;
                        }
                        float f8 = this.additionalTabWidth / 2.0f;
                        int iDp2 = (measuredHeight / 2) - AndroidUtilities.dp(14.0f);
                        this.selectorDrawable.setBounds((int) ((x - AndroidUtilities.dp(12.5f)) - f8), iDp2, (int) (AndroidUtilities.dp(12.5f) + x + iLerp + f8), AndroidUtilities.dp(28.0f) + iDp2);
                        this.selectorDrawable.setAlpha(31);
                        this.selectorDrawable.draw(canvas);
                        return zDrawChild;
                    }
                    this.selectorPaint.setColor(Theme.multAlpha(0.15f, this.textPaint.getColor()));
        ...
        public void scrollToTab(int i, int i2) {
            ...
            valueAnimatorOfFloat.addUpdateListener(new WaveDrawable$$ExternalSyntheticLambda1(this, 8));
        ...
        public void setIsEditing(boolean z) {
            ...
            for (int iM = 0; iM < size; iM = LocationController$$ExternalSyntheticOutline0.m(arrayList.get(iM).id, iM, 1, tL_messages_updateDialogFiltersOrder.order)) {
                arrayList.get(iM);
            }
            ConnectionsManager.getInstance(UserConfig.selectedAccount).sendRequest(tL_messages_updateDialogFiltersOrder, new EmojiView$23$$ExternalSyntheticLambda0(6));
        ...
        public void setReordering(boolean z) {
            ...
            AndroidUtilities.forEachViews((RecyclerView) this.listView, (Consumer) new ViewPagerFixed$TabsView$$ExternalSyntheticLambda3(this, z, 0));
        }
        ...
        public interface TabsViewDelegate {
            ...
            public abstract class CC {
                public static boolean $default$canPerformActions(TabsViewDelegate tabsViewDelegate) {
                    return true;
                }

                public static boolean $default$canReorder(TabsViewDelegate tabsViewDelegate, int i) {
                    return false;
                }

                public static boolean $default$needsTab(TabsViewDelegate tabsViewDelegate, int i) {
                    return true;
                }

                public static void $default$invalidateBlur(TabsViewDelegate tabsViewDelegate) {
                }

                public static void $default$onSamePageSelected(TabsViewDelegate tabsViewDelegate) {
                }

                public static void $default$applyReorder(TabsViewDelegate tabsViewDelegate, ArrayList arrayList) {
                }

                public static void $default$onPageScrolled(TabsViewDelegate tabsViewDelegate, float f) {
                }

                public static void $default$onPageSelected(TabsViewDelegate tabsViewDelegate, int i, boolean z) {
                }
            }
        }
    }
