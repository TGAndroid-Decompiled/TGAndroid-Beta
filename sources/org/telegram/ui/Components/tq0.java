...
public final class tq0 extends xl0 {
    ...
    public final TLRPC.TL_forumTopic E(int i10) {
        ...
        ArrayList arrayList = this.f28521f;
        if (arrayList != null && i11 >= 0 && i11 < arrayList.size()) {
            return (TLRPC.TL_forumTopic) this.f28521f.get(i11);
        }
        return null;
    }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        int dp;
        if (c1Var.f42998f == 0) {
            org.telegram.ui.Cells.i7 i7Var = (org.telegram.ui.Cells.i7) c1Var.f42995a;
            if (i10 == 1 && this.d) {
                i7Var.setAsNewBotForumTopic(this.e);
            } else if (this.f28521f != null) {
                TLRPC.TL_forumTopic E = E(i10);
                wq0 wq0Var = this.h;
                TLRPC.Dialog dialog = wq0Var.C0;
                if (E != null && wq0Var.U.h(E.f18395id) >= 0) {
                    z10 = true;
                } else {
                    z10 = false;
                }
                org.telegram.ui.Cells.f7 f7Var = i7Var.f20453b;
                int i11 = i7Var.f20455f;
                v9 v9Var = i7Var.f20452a;
                TextView textView = i7Var.f20454c;
                if (dialog != null) {
                    TLRPC.Chat chat = MessagesController.getInstance(i11).getChat(Long.valueOf(-dialog.f18347id));
                    String str = "";
                    if (dialog.f18347id > 0) {
                    ...
                    if (ChatObject.isMonoForum(chat)) {
                        ...
                        if (DialogObject.isUserDialog(peerDialogId)) {
                            ...
                            textView.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19216j5, i7Var.h));
                            f7Var.m(i11, user);
                            if (user != null) {
