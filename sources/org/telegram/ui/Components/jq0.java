...
public final class jq0 extends Drawable {
    public long f25407a = 0;
    public final float[] f25408b = {0.0f, -0.5f};
    public final Drawable f25409c;
    ...
    public jq0(Context context, int i10) {
        this.f25410f = i10;
        if (i10 == 4) {
            this.f25409c = context.getResources().getDrawable(R.drawable.filled_extend_location).mutate();
            ...
            this.f25409c = context.getResources().getDrawable(R.drawable.filled_stop_location).mutate();
            this.d = context.getResources().getDrawable(R.drawable.smallanimationpinleft).mutate();
            this.e = context.getResources().getDrawable(R.drawable.smallanimationpinright).mutate();
        } else if (i10 == 1) {
            this.f25409c = context.getResources().getDrawable(R.drawable.smallanimationpin).mutate();
            this.d = context.getResources().getDrawable(R.drawable.smallanimationpinleft).mutate();
            this.e = context.getResources().getDrawable(R.drawable.smallanimationpinright).mutate();
        } else {
            this.f25409c = context.getResources().getDrawable(R.drawable.animationpin).mutate();
    ...
    public final void draw(Canvas canvas) {
        ...
        int i10;
        float y3;
        Drawable drawable = this.f25409c;
        ...
        long j3 = currentTimeMillis - this.f25407a;
        this.f25407a = currentTimeMillis;
        if (j3 > 16) {
            j3 = 16;
        }
    ...
    public final void setColorFilter(ColorFilter colorFilter) {
        this.f25409c.setColorFilter(colorFilter);
