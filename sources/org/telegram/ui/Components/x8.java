...
public final class x8 implements ValueAnimator.AnimatorUpdateListener {
    ...
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        ...
        c9 c9Var = this.d;
        c9Var.N = floatValue;
        float lerp = AndroidUtilities.lerp(this.f29880a, this.f29881b, floatValue);
        kVar = ((org.telegram.ui.ActionBar.o2) c9Var).actionBar;
        kVar.getTitleTextView().setAlpha(c9Var.N);
        if (c9Var.F && !this.f29882c) {
            c9Var.i0(1.0f - c9Var.N, false);
        }
        c9Var.f22970r.setTranslationY(lerp);
        c9Var.f22973x.setTranslationY(lerp);
