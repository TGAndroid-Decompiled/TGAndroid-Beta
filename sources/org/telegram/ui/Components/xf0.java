    ...
    public boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        switch (this.h) {
            case 0:
                ...
                PipRoundVideoView pipRoundVideoView = (PipRoundVideoView) this.f32549n;
                if (view == pipRoundVideoView.f24051c && (playingMessageObject = MediaController.getInstance().getPlayingMessageObject()) != null) {
                    ...
                    canvas.drawArc(pipRoundVideoView.E, -90.0f, playingMessageObject.audioProgress * 360.0f, false, org.telegram.ui.ActionBar.j6.f20814k2);
                }
                return drawChild;
            default:
    ...
    public void onMeasure(int i10, int i11) {
        switch (this.h) {
            case 1:
                ...
                b91 b91Var = (b91) this.f32549n;
                if (b91Var.f24654f != null) {
