...
public final class r21 extends FrameLayout {
    ...
    public final org.telegram.ui.ActionBar.d6 f27533b;
    public yo0 f27534c;
    public final d90 d;
    public final o6 e;
    public final ai.n4 f27535f;
    public final ImageView h;
    public boolean f27536n;
    public final e6 f27537r;
    ...
    public r21(Context context, int i10, org.telegram.ui.ActionBar.d6 d6Var) {
        super(context);
        this.f27537r = new e6(this, 360L, rr.h);
        this.f27538s = false;
        this.f27540x = false;
        this.f27541y = false;
    ...
    public int getTextColor() {
        ...
        org.telegram.ui.ActionBar.d6 d6Var = this.f27533b;
    ...
    public final void b(long j3, TLRPC.TL_forumTopic tL_forumTopic, boolean z10) {
        ...
        setSelected(z10);
        h();
        e(tL_forumTopic.unread_count, MessagesController.getInstance(this.f27532a).isDialogMuted(j3, this.f27539w), z11);
    ...
    public final void d(boolean z10, boolean z11, boolean z12) {
        ...
        if (z10) {
            ...
            o21Var.f26577b.setColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.Oh, this.f27533b));
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        if (view == this.d) {
            canvas.save();
            float e = this.f27537r.e(this.f27536n);
            if (e > 0.0f) {
                if (this.f27534c == null) {
                    this.f27534c = new yo0(this);
                }
                canvas.translate(getWidth() / 2.0f, getHeight() / 2.0f);
                this.f27534c.a(canvas, e);
                canvas.translate((-getWidth()) / 2.0f, (-getHeight()) / 2.0f);
            }
    ...
    public final void g(long j3, TLRPC.TL_forumTopic tL_forumTopic, boolean z10) {
        ...
        if (this.f27539w == peerDialogId) {
            z11 = true;
        } else {
            z11 = false;
        }
        this.f27539w = peerDialogId;
        this.h.setVisibility(8);
        d90 d90Var = this.d;
        d90Var.setVisibility(0);
        ...
        if (userOrChat != null) {
            ...
            h9 h9Var = h5Var3.f33733c;
            h9Var.j(h5Var3.e, userOrChat);
            h5Var3.f33732b.setForUserOrChat(userOrChat, h9Var);
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (f7 > 0.0f) {
            ...
            n4Var.layout(dp3 + d90Var.getMeasuredWidth() + dp2, i16 - (n4Var.getMeasuredHeight() / 2), n4Var.getMeasuredWidth() + AndroidUtilities.dp(4.66f) + measuredWidth2, (n4Var.getMeasuredHeight() / 2) + i16);
        }
