...
public final class w9 extends Drawable {
    public TextPaint f29615a;
    public final Paint f29616b;
    public final Paint f29617c;
    public final Paint d;
    public final float e;
    public float f29618f;
    public float f29619g;
    public final RectF h;
    public ValueAnimator f29620i;

    public w9() {
        Paint paint = new Paint(1);
        this.f29616b = paint;
        this.f29617c = new Paint(1);
        this.d = new Paint(1);
        this.e = 1.0f;
        this.f29618f = 0.0f;
        this.f29619g = 1.0f;
    ...
    public final void a(float f7, boolean z10) {
        ...
        ValueAnimator valueAnimator = this.f29620i;
        ...
        ValueAnimator ofFloat = ValueAnimator.ofFloat(this.f29619g, max);
        this.f29620i = ofFloat;
        ofFloat.addUpdateListener(new i6(this, 5));
        this.f29620i.addListener(new org.telegram.ui.ActionBar.a1(this, max, 4));
        this.f29620i.setInterpolator(qr.h);
        this.f29620i.setDuration(200L);
        this.f29620i.start();
    }
    ...
    public final void draw(Canvas canvas) {
        if (getBounds() != null) {
            ...
            int i11 = getBounds().top + ((int) this.f29618f);
            int width = getBounds().width();
            int height = getBounds().height();
            int centerX = getBounds().centerX();
            int centerY = getBounds().centerY() + ((int) this.f29618f);
            TextPaint textPaint = this.f29615a;
            Paint paint = this.d;
            Paint paint2 = this.f29617c;
            Paint paint3 = this.f29616b;
            if (textPaint != null) {
            ...
            rectF.set((((f11 - AndroidUtilities.dpf2(13.0f)) / 2.0f) + f10) - AndroidUtilities.dpf2(1.66f), ((f13 - AndroidUtilities.dpf2(7.33f)) / 2.0f) + f12, Math.max(AndroidUtilities.dpf2(1.1f), this.f29619g * AndroidUtilities.dpf2(13.0f)) + ((((f11 - AndroidUtilities.dpf2(13.0f)) / 2.0f) + f10) - AndroidUtilities.dpf2(1.66f)), ((AndroidUtilities.dpf2(7.33f) + f13) / 2.0f) + f12);
    ...
    public final void setAlpha(int i10) {
        this.f29616b.setAlpha(i10);
        this.f29617c.setAlpha(i10);
        this.d.setAlpha(i10);
    }

    @Override
    public final void setColorFilter(ColorFilter colorFilter) {
        this.f29616b.setColorFilter(colorFilter);
        this.f29617c.setColorFilter(colorFilter);
