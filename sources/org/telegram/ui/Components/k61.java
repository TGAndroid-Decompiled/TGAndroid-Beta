...
public class k61 extends og.b {
    ...
    public Utilities.Callback2 f25645s;
    public final org.telegram.ui.ActionBar.d6 v;
    public ig.f f25648y;
    public boolean f25644r = true;
    public final ArrayList f25646w = new ArrayList();
    public final ArrayList f25647x = new ArrayList();
    public int E = 0;
    public final ArrayList F = new ArrayList();
    public final ArrayList G = new ArrayList();

    public k61(xl0 xl0Var, Context context, int i10, int i11, boolean z10, Utilities.Callback2 callback2, org.telegram.ui.ActionBar.d6 d6Var) {
        this.d = xl0Var;
        this.e = context;
        this.f25642f = i10;
        this.h = i11;
        this.f25643n = z10;
        this.f25645s = callback2;
        this.v = d6Var;
        N(false);
    }
    ...
    public final void F(int i10) {
        if (i10 >= 0) {
            ...
            if (i10 < arrayList.size()) {
                ...
                this.L.run(Integer.valueOf(i10), new ArrayList(this.f25647x.subList(i61Var.f24986a, i61Var.f24987b + 1)));
                this.K = false;
            }
        }
    }
    ...
    public final w51 G(int i10) {
        if (i10 >= 0) {
            ArrayList arrayList = this.f25647x;
            if (i10 < arrayList.size()) {
    ...
    public final int H(int i10) {
        ...
        while (true) {
            ...
            if (i11 < arrayList.size()) {
                ...
                if (i10 >= i61Var.f24986a && i10 <= i61Var.f24987b) {
                    return i11;
                }
                i11++;
            } else {
    ...
    public final boolean J(int i10) {
        w51 G = G(i10);
        w51 G2 = G(i10 + 1);
        if (G != null && !G.f29893j && G2 != null && K(G2.f15715a) == K(G.f15715a)) {
            return true;
        }
        return false;
    }
    ...
    public final void L() {
        i61 i61Var = this.I;
        if (i61Var != null) {
            i61Var.f24987b = Math.max(0, this.f25647x.size() - 1);
        }
    }
    ...
    public void N(boolean z10) {
        xl0 xl0Var = this.d;
        if (xl0Var != null && xl0Var.b0()) {
            xl0Var.post(new zr0(5, this, z10));
        } else {
            P(z10);
        }
    }
    ...
    public final void P(boolean z10) {
        xl0 xl0Var = this.d;
        if (xl0Var == null || !xl0Var.b0()) {
            ArrayList arrayList = this.f25646w;
            arrayList.clear();
            ArrayList arrayList2 = this.f25647x;
            arrayList.addAll(arrayList2);
            arrayList2.clear();
            this.H = null;
            this.F.clear();
            this.G.clear();
            Utilities.Callback2 callback2 = this.f25645s;
            if (callback2 != null) {
    ...
    public final void R() {
        xl0 xl0Var = this.d;
        if (xl0Var != null) {
            ArrayList arrayList = xl0Var.K2;
            if (arrayList == null) {
                xl0Var.K2 = new ArrayList();
            } else {
                arrayList.clear();
            }
            ...
            while (i10 < size) {
                ...
                i10++;
                i61 i61Var = (i61) obj;
                xl0Var.K2.add(Long.valueOf(AndroidUtilities.pack(i61Var.f24986a, i61Var.f24987b)));
            }
        }
    }
    ...
    public final void T() {
        i61 i61Var = this.H;
        if (i61Var != null) {
            i61Var.f24987b = Math.max(0, (this.f25647x.size() + this.E) - 1);
            i61 i61Var2 = this.H;
            if (i61Var2.f24986a == i61Var2.f24987b) {
    ...
    public final void U() {
        ?? obj = new Object();
        this.H = obj;
        obj.f24986a = this.f25647x.size() + this.E;
        i61 i61Var = this.H;
        i61Var.f24987b = -1;
        this.F.add(i61Var);
    }
    ...
    public s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 >= 10000) {
            v51 F = w51.F(i10);
            if (F != null) {
                a2Var = F.createView(this.e, this.d, this.f25642f, this.h, this.v);
            } else {
            ...
            switch (i10) {
                ...
                case 23:
                    if (this.f25648y == null) {
                        this.f25648y = new ig.f(null);
                    }
                    ig.f fVar = this.f25648y;
                    int i19 = this.h;
                    a2Var = new qa1(this.e, this.f25642f, i10 - 18, fVar, i19);
                    break;
                case 24:
