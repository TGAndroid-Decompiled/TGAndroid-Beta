...
public final class b10 extends View {
    ...
    public k01 f25460f;
    public k01 h;
    public LinearGradient f25461n;
    public LinearGradient f25462r;
    public Paint f25463s;
    public Paint v;
    public Matrix f25464w;
    public Matrix f25465x;
    public j6 f25466y;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float f14;
        float f15;
        Paint paint = this.f25457b;
        Matrix matrix = this.f25465x;
        Matrix matrix2 = this.f25464w;
        Path path = this.f25458c;
        k01 k01Var2 = this.f25459e;
        j6 j6Var = this.f25466y;
        k01 k01Var3 = this.h;
        super.onDraw(canvas);
        canvas.saveLayerAlpha(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight(), 255, 31);
        float measuredWidth = getMeasuredWidth() / 2.0f;
        float measuredHeight = getMeasuredHeight() / 2.0f;
        k01 k01Var4 = this.f25460f;
        if (k01Var4 != null) {
            canvas.save();
            float f16 = k01Var4.f28227c;
            f10 = 15.32f;
            CharSequence charSequence = j6Var.f28003g;
        ...
        CharSequence charSequence2 = j6Var.f28003g;
        if (charSequence2 == null || charSequence2.length() == 0) {
            ...
            f13 = measuredHeight;
            k01Var = k01Var4;
            rect.set((int) (k01Var4.f28227c + f11 + AndroidUtilities.dp(4.66f)), (int) (measuredHeight - AndroidUtilities.dp(9.0f)), (int) (j6Var.d() + k01Var4.f28227c + f11 + AndroidUtilities.dp(f10)), (int) (f13 + AndroidUtilities.dp(9.0f)));
        ...
        float f18 = (f11 - dp) - k01Var2.f28227c;
        canvas.save();
        ...
        if (k01Var3 != null) {
            ...
            k01Var3.d(canvas);
            canvas.restore();
            f19 += dp + k01Var3.f28227c;
        }
        float f20 = f19;
        float dp2 = AndroidUtilities.dp(12.0f) + (k01Var.j() / f14) + f13;
        canvas.drawRect(0.0f, dp2, getMeasuredWidth(), 1.0f + dp2, this.f25456a);
        path.rewind();
        ...
        this.f25461n.setLocalMatrix(matrix2);
        ...
        this.f25462r.setLocalMatrix(matrix);
        canvas.drawRect(0.0f, 0.0f, measuredWidth, getMeasuredHeight(), this.f25463s);
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        if (drawable != this.f25466y && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
