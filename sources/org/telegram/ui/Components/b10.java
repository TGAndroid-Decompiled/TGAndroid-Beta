...
public final class b10 extends View {
    public TextPaint f22830a;
    public Paint f22831b;
    public Path f22832c;
    public float[] d;
    public t01 e;
    public t01 f22833f;
    public t01 h;
    public LinearGradient f22834n;
    public LinearGradient f22835r;
    public Paint f22836s;
    public Paint v;
    public Matrix f22837w;
    public Matrix f22838x;
    public o6 f22839y;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float f13;
        float f14;
        Paint paint = this.f22831b;
        Matrix matrix = this.f22838x;
        Matrix matrix2 = this.f22837w;
        Path path = this.f22832c;
        t01 t01Var2 = this.e;
        o6 o6Var = this.f22839y;
        t01 t01Var3 = this.h;
        super.onDraw(canvas);
        canvas.saveLayerAlpha(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight(), 255, 31);
        float measuredWidth = getMeasuredWidth() / 2.0f;
        float measuredHeight = getMeasuredHeight() / 2.0f;
        t01 t01Var4 = this.f22833f;
        if (t01Var4 != null) {
            canvas.save();
            float f15 = t01Var4.f28357c;
            f7 = 15.32f;
            CharSequence charSequence = o6Var.f26928g;
        ...
        CharSequence charSequence2 = o6Var.f26928g;
        if (charSequence2 == null || charSequence2.length() == 0) {
            ...
            f12 = measuredHeight;
            t01Var = t01Var4;
            rect.set((int) (t01Var4.f28357c + f10 + AndroidUtilities.dp(4.66f)), (int) (measuredHeight - AndroidUtilities.dp(9.0f)), (int) (o6Var.d() + t01Var4.f28357c + f10 + AndroidUtilities.dp(f7)), (int) (f12 + AndroidUtilities.dp(9.0f)));
        ...
        float f17 = (f10 - dp) - t01Var2.f28357c;
        canvas.save();
        ...
        if (t01Var3 != null) {
            ...
            t01Var3.d(canvas);
            canvas.restore();
            f18 += dp + t01Var3.f28357c;
        }
        float f19 = f18;
        float dp2 = AndroidUtilities.dp(12.0f) + (t01Var.j() / f13) + f12;
        canvas.drawRect(0.0f, dp2, getMeasuredWidth(), 1.0f + dp2, this.f22830a);
        path.rewind();
        ...
        this.f22834n.setLocalMatrix(matrix2);
        ...
        this.f22835r.setLocalMatrix(matrix);
        canvas.drawRect(0.0f, 0.0f, measuredWidth, getMeasuredHeight(), this.f22836s);
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        if (drawable != this.f22839y && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
