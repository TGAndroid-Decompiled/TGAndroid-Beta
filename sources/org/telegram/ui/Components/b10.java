...
public final class b10 extends View {
    public TextPaint f22548a;
    public Paint f22549b;
    public Path f22550c;
    public float[] d;
    public f01 e;
    public f01 f22551f;
    public f01 h;
    public LinearGradient f22552n;
    public LinearGradient f22553r;
    public Paint f22554s;
    public Paint v;
    public Matrix f22555w;
    public Matrix f22556x;
    public o6 f22557y;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float f13;
        float f14;
        Paint paint = this.f22549b;
        Matrix matrix = this.f22556x;
        Matrix matrix2 = this.f22555w;
        Path path = this.f22550c;
        f01 f01Var2 = this.e;
        o6 o6Var = this.f22557y;
        f01 f01Var3 = this.h;
        super.onDraw(canvas);
        canvas.saveLayerAlpha(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight(), 255, 31);
        float measuredWidth = getMeasuredWidth() / 2.0f;
        float measuredHeight = getMeasuredHeight() / 2.0f;
        f01 f01Var4 = this.f22551f;
        if (f01Var4 != null) {
            canvas.save();
            float f15 = f01Var4.f23785c;
            f7 = 15.32f;
            CharSequence charSequence = o6Var.f26617g;
        ...
        CharSequence charSequence2 = o6Var.f26617g;
        if (charSequence2 == null || charSequence2.length() == 0) {
            ...
            f12 = measuredHeight;
            f01Var = f01Var4;
            rect.set((int) (f01Var4.f23785c + f10 + AndroidUtilities.dp(4.66f)), (int) (measuredHeight - AndroidUtilities.dp(9.0f)), (int) (o6Var.d() + f01Var4.f23785c + f10 + AndroidUtilities.dp(f7)), (int) (f12 + AndroidUtilities.dp(9.0f)));
        ...
        float f17 = (f10 - dp) - f01Var2.f23785c;
        canvas.save();
        ...
        if (f01Var3 != null) {
            ...
            f01Var3.d(canvas);
            canvas.restore();
            f18 += dp + f01Var3.f23785c;
        }
        float f19 = f18;
        float dp2 = AndroidUtilities.dp(12.0f) + (f01Var.j() / f13) + f12;
        canvas.drawRect(0.0f, dp2, getMeasuredWidth(), 1.0f + dp2, this.f22548a);
        path.rewind();
        ...
        this.f22552n.setLocalMatrix(matrix2);
        ...
        this.f22553r.setLocalMatrix(matrix);
        canvas.drawRect(0.0f, 0.0f, measuredWidth, getMeasuredHeight(), this.f22554s);
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        if (drawable != this.f22557y && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
