...
public final class b10 extends FrameLayout {
    ...
    public final CharSequence f22776b;
    public final a10 f22777c;
    public final y5 d;
    public final c10 e;
    ...
    public b10(c10 c10Var, Context context, boolean z10, CharSequence charSequence, ArrayList arrayList, boolean z11) {
        ...
        view.f22456a = textPaint;
        TextPaint textPaint2 = new TextPaint(1);
        Paint paint = new Paint(1);
        view.f22457b = paint;
        view.f22458c = new Path();
        ...
        view.v = paint3;
        view.f22463w = new Matrix();
        view.f22464x = new Matrix();
        ...
        o6Var.r(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19062d6, false));
        ...
        v01Var2.s(view);
        TextPaint textPaint3 = v01Var2.f28866a;
        textPaint3.setColor(w02);
        view.f22459f = v01Var2;
        ...
        this.f22776b = replaceEmoji;
        this.f22776b = MessageObject.replaceAnimatedEmoji(replaceEmoji, arrayList, y5Var.getPaint().getFontMetricsInt(), false, 0.8f, 0);
        ...
        y5Var.setEmojiColor(org.telegram.ui.ActionBar.j6.v0(i14, e6Var));
    ...
    public final void a() {
        ...
        int i11;
        c10 c10Var = this.e;
        ArrayList arrayList = c10Var.f23150g0;
        boolean z10 = c10Var.f23145b0;
        CharSequence charSequence = this.f22776b;
        y5 y5Var = this.d;
        if (z10) {
        ...
        } else if (this.f22775a) {
            if (arrayList != null) {
                i10 = arrayList.size();
            } else {
                i10 = 0;
            }
            a10 a10Var = this.f22777c;
            o6 o6Var = a10Var.f22465y;
            if (i10 > 0) {
                str = hg.k0.h(i10, "+");
            } else {
                str = "";
