...
public class TableView extends android.widget.TableLayout {
    ...
    public static class TableRowContent extends FrameLayout {
        ...
        public void onDraw(Canvas canvas) {
            ...
            if (this.first || this.last) {
                ...
                rectF.set(this.table.hw, this.table.hw, getWidth() - this.table.hw, (this.table.hw * AndroidUtilities.dp(this.last ? -1.0f : 1.0f)) + getHeight());
                if (!this.right) {
                    rectF.right = this.table.w + rectF.right;
                }
                ...
                canvas2 = canvas;
                canvas2.drawRect(this.table.hw, this.table.hw, getWidth() - this.table.hw, this.table.hw + getHeight(), this.table.borderPaint);
            }
    ...
    public static class TableRowFullContent extends FrameLayout {
        ...
        public void onDraw(Canvas canvas) {
            ...
            if (this.first || this.last) {
                ...
                if (this.filled) {
                    canvas2 = canvas;
                    canvas2.drawRect(this.table.hw, this.table.hw, this.table.hw + getWidth(), this.table.hw + getHeight(), this.table.backgroundPaint);
                } else {
                    canvas2 = canvas;
                }
                canvas2.drawRect(this.table.hw, this.table.hw, getWidth() - this.table.hw, this.table.hw + getHeight(), this.table.borderPaint);
    ...
    public static class TableRowTitle extends TextView {
        ...
        public void onDraw(Canvas canvas) {
            ...
            if (this.first || this.last) {
                ...
                this.table.path.rewind();
                RectF rectF = AndroidUtilities.rectTmp;
                rectF.set(this.table.hw, this.table.hw, this.table.hw + getWidth(), (this.table.hw * AndroidUtilities.dp(this.last ? -1.0f : 1.0f)) + getHeight());
                this.table.path.addRoundRect(rectF, this.table.radii, Path.Direction.CW);
                canvas2.drawPath(this.table.path, this.table.backgroundPaint);
                canvas2.drawPath(this.table.path, this.table.borderPaint);
            } else {
                canvas2 = canvas;
                canvas2.drawRect(this.table.hw, this.table.hw, this.table.hw + getWidth(), this.table.hw + getHeight(), this.table.backgroundPaint);
                canvas2.drawRect(this.table.hw, this.table.hw, this.table.hw + getWidth(), this.table.hw + getHeight(), this.table.borderPaint);
            }
            super.onDraw(canvas2);
        }
    ...
    public TableRowFullContent addFullRow(CharSequence charSequence) {
        SpoilersTextView spoilersTextView = new SpoilersTextView(getContext(), true, null);
    ...
    public TableRow addRow(CharSequence charSequence, View view) {
        TableRow tableRow = new TableRow(getContext());
    ...
    public TableRow addRowMonospaced(CharSequence charSequence, CharSequence charSequence2, int i, Runnable runnable) {
        ...
        if (runnable != null) {
            ...
            imageView.setOnClickListener(new UndoView$$ExternalSyntheticLambda6(7, charSequence2, runnable));
            ScaleStateListAnimator.apply(imageView);
            imageView.setBackground(Theme.createSelectorDrawable(Theme.multAlpha(0.1f, Theme.getColor(i2, this.resourcesProvider)), 7, -1));
    ...
    public TableRow addRowUserWithEmojiStatus(CharSequence charSequence, final int i, final long j, final Runnable runnable) {
        ...
        Utilities.Callback<Object[]> callback = new Utilities.Callback() {
            ...
            public final void run(Object obj) {
                ...
                LinkSpanDrawable.LinksSimpleTextView linksSimpleTextView2 = linksSimpleTextView;
                Drawable drawable = drawableMutate;
                TableView.lambda$addRowUserWithEmojiStatus$1(j, i, swapAnimatedEmojiDrawable2, linksSimpleTextView2, drawable, color, (Object[]) obj);
            }
        };
        callback.run(null);
        linksSimpleTextView.setRightDrawable(swapAnimatedEmojiDrawable);
