...
public class go0 extends FrameLayout {
    public static float[] f24355j0;
    public static Path f24356k0;
    ...
    public float V;
    public int W;
    public final org.telegram.ui.Cells.f1 f24357a;
    public StaticLayout[] f24358a0;
    public final Paint f24359b;
    public TextPaint f24360b0;
    public final Paint f24361c;
    public float f24362c0;
    public final int d;
    public int f24363d0;
    public final int e;
    public long f24364e0;
    public int f24365f;
    public float f24366f0;
    public final RectF f24367g0;
    public final c6 h;
    public int f24368h0;
    public int f24369i0;
    public int f24370n;
    public float f24371r;
    public float f24372s;
    public boolean v;
    public fo0 f24373w;
    ...
    private void setTimestampIndex(int i10) {
        if (this.f24368h0 != i10) {
            this.f24368h0 = i10;
            if (i10 >= 0 && i10 < this.S.size()) {
                this.N.setText((CharSequence) ((Pair) this.S.get(this.f24368h0)).second);
            }
        }
    }
    ...
    public final StaticLayout b(int i10, CharSequence charSequence) {
        ...
        if (this.f24360b0 == null) {
            TextPaint textPaint = new TextPaint(1);
            this.f24360b0 = textPaint;
            textPaint.setTextSize(AndroidUtilities.dp(12.0f));
        }
        this.f24360b0.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Si, this.M));
        ...
        if (Build.VERSION.SDK_INT >= 23) {
            return StaticLayout.Builder.obtain(charSequence2, 0, charSequence2.length(), this.f24360b0, i10).setMaxLines(1).setAlignment(Layout.Alignment.ALIGN_CENTER).setEllipsize(TextUtils.TruncateAt.END).setEllipsizedWidth(Math.min(AndroidUtilities.dp(400.0f), i10)).build();
        }
        CharSequence charSequence3 = charSequence2;
        return new StaticLayout(charSequence3, 0, charSequence3.length(), this.f24360b0, i10, Layout.Alignment.ALIGN_CENTER, 1.0f, 0.0f, false, TextUtils.TruncateAt.END, Math.min(AndroidUtilities.dp(400.0f), i10));
    }

    public final int c() {
        return Math.max((int) (this.f24372s * (getMeasuredWidth() - this.e)), 0);
    }
        ...
        if (action != 1 && motionEvent.getAction() != 3) {
                ...
                if (!this.O) {
                    ...
                    if (Math.abs(motionEvent.getY() - this.Q) <= viewConfiguration.getScaledTouchSlop() && Math.abs(motionEvent.getX() - this.P) > viewConfiguration.getScaledTouchSlop()) {
                        ...
                        if (motionEvent.getY() >= 0.0f && motionEvent.getY() <= getMeasuredHeight()) {
                            if (this.f24365f - measuredHeight > motionEvent.getX() || motionEvent.getX() > this.f24365f + i10 + measuredHeight) {
                                int x10 = ((int) motionEvent.getX()) - (i10 / 2);
                                this.f24365f = x10;
                                if (x10 < c()) {
                                    this.f24365f = c();
                                } else if (this.f24365f > getMeasuredWidth() - i11) {
                                    this.f24365f = getMeasuredWidth() - i11;
                                }
                            }
                            this.f24370n = (int) (motionEvent.getX() - this.f24365f);
                            this.v = true;
                            this.f24373w.B();
                            if (zVar != null) {
                    ...
                    int x11 = (int) (motionEvent.getX() - this.f24370n);
                    this.f24365f = x11;
                    if (x11 < c()) {
                        this.f24365f = c();
                    } else if (this.f24365f > getMeasuredWidth() - i11) {
                    ...
                    if (this.f24374x) {
                        if (this.L) {
                            ...
                            f(this.f24365f / (getMeasuredWidth() - i11), false);
                        }
                    }
                    if (zVar != null) {
                        zVar.setHotspot(motionEvent.getX(), motionEvent.getY());
            ...
            if (motionEvent.getAction() == 1) {
                if (Math.abs(motionEvent.getY() - this.Q) < ViewConfiguration.get(getContext()).getScaledTouchSlop()) {
                    ...
                    if (this.f24365f - measuredHeight2 > motionEvent.getX() || motionEvent.getX() > this.f24365f + i10 + measuredHeight2) {
            ...
            if (this.v) {
                if (motionEvent.getAction() == 1) {
                    if (this.L) {
                        ...
                        f(this.f24365f / (getMeasuredWidth() - i11), true);
                    }
                }
                if (zVar != null) {
    ...
    public final void e(float f7, boolean z10) {
        ...
        if (i12 != i11) {
            ...
            if (i11 < c()) {
                this.f24365f = c();
            } else if (this.f24365f > getMeasuredWidth() - i10) {
                this.f24365f = getMeasuredWidth() - i10;
            }
            invalidate();
        }
    }
    ...
    public final void g(MessageObject messageObject) {
        ...
        if (valueOf.longValue() < 0) {
            ...
            this.W = -1;
            this.V = 0.0f;
            StaticLayout[] staticLayoutArr = this.f24358a0;
        ...
        if (z10 || this.U != valueOf.longValue()) {
            ...
            if (getTimestampLabelWidth() != this.f24369i0) {
                requestLayout();
            }
            if (!(charSequence instanceof Spanned)) {
                ...
                this.W = -1;
                this.V = 0.0f;
                StaticLayout[] staticLayoutArr2 = this.f24358a0;
            ...
            try {
                ...
                for (n51 n51Var : n51VarArr) {
                    if (n51Var != null && n51Var.getURL() != null && n51Var.d != null && n51Var.getURL().startsWith("audio?") && (parseInt = Utilities.parseInt((CharSequence) n51Var.getURL().substring(6))) != null && parseInt.intValue() >= 0) {
                        ...
                        Emoji.replaceEmoji(spannableStringBuilder, this.f24360b0.getFontMetricsInt(), false);
                ...
                this.W = -1;
                this.V = 0.0f;
                StaticLayout[] staticLayoutArr3 = this.f24358a0;
    ...
    public float getProgress() {
        ...
        return this.f24365f / (getMeasuredWidth() - this.e);
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float f23 = this.H;
        if (f23 < 1.0f) {
            float interpolation = 1.0f - kt.f25681c.getInterpolation(Math.min(1.0f, f23 * 3.0f));
        ...
        if (arrayList != null && !arrayList.isEmpty()) {
            ...
            if (this.f24358a0 == null) {
                this.f24358a0 = new StaticLayout[2];
            }
            if (this.U > 600000) {
                i10 = AndroidUtilities.dp(42.0f);
            } else {
            ...
            if (size != this.W) {
                ...
                if (size >= 0 && size < this.S.size()) {
                    ...
                    if (charSequence == null) {
                        this.f24358a0[0] = null;
                    } else {
                        this.f24358a0[0] = b((int) abs, charSequence);
                    }
                } else {
                    this.f24358a0[0] = null;
                }
            ...
            if (this.f24362c0 < 1.0f) {
                long min = Math.min(17L, Math.abs(SystemClock.elapsedRealtime() - this.f24364e0));
                if (this.S.size() > 8) {
                    f14 = 160.0f;
                } else {
                    f14 = 220.0f;
                }
                this.f24362c0 = Math.min((((float) min) / f14) + this.f24362c0, 1.0f);
                invalidate();
                this.f24364e0 = SystemClock.elapsedRealtime();
            }
            if (this.V < 1.0f) {
                this.V = Math.min((((float) Math.min(17L, Math.abs(SystemClock.elapsedRealtime() - this.f24364e0))) / 200.0f) + this.V, 1.0f);
                invalidate();
                SystemClock.elapsedRealtime();
            }
            float interpolation3 = qr.f27380f.getInterpolation(this.f24362c0);
            canvas2.save();
            canvas2.translate(f24 + AndroidUtilities.dp(25.0f), (getMeasuredHeight() / 2.0f) + AndroidUtilities.dp(14.0f));
            this.f24360b0.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Si, f6Var));
            if (this.f24358a0[1] != null) {
                canvas2.save();
                if (this.f24363d0 != 0) {
                    f13 = 0.0f;
                    canvas2.translate((AndroidUtilities.dp(f10) * (-this.f24363d0) * interpolation3) + AndroidUtilities.dp(f11), 0.0f);
                } else {
                    f13 = 0.0f;
                }
                canvas2.translate(f13, (-this.f24358a0[1].getHeight()) / 2.0f);
                this.f24360b0.setAlpha((int) ((1.0f - interpolation3) * 255.0f * this.V));
                canvas2.restore();
            }
            if (this.f24358a0[0] != null) {
                canvas2.save();
                if (this.f24363d0 != 0) {
                    f12 = 0.0f;
                    canvas2.translate(com.google.android.gms.internal.vision.e2.z(1.0f, interpolation3, AndroidUtilities.dp(f10) * this.f24363d0, AndroidUtilities.dp(f11)), 0.0f);
                } else {
                    f12 = 0.0f;
                }
                canvas2.translate(f12, (-this.f24358a0[0].getHeight()) / 2.0f);
                this.f24360b0.setAlpha((int) (interpolation3 * 255.0f * this.V));
                canvas2.restore();
            }
            canvas2.restore();
        }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f24369i0 = timestampLabelWidth;
        this.N.measure(View.MeasureSpec.makeMeasureSpec(timestampLabelWidth, 1073741824), 0);
        if (this.f24371r != -100.0f && getMeasuredWidth() > 0) {
            setProgress(this.f24371r);
            this.f24371r = -100.0f;
        }
    }
    ...
    public go0(Context context, org.telegram.ui.ActionBar.f6 f6Var, boolean z10) {
        super(context);
        this.h = new c6(this, 0L, 60L, qr.f27381g);
        this.f24371r = -100.0f;
        this.f24372s = -1.0f;
        ...
        this.f24362c0 = 1.0f;
        this.f24366f0 = -1.0f;
        this.f24367g0 = new RectF();
        this.f24368h0 = -1;
        this.M = f6Var;
        setWillNotDraw(false);
        this.f24359b = new Paint(1);
