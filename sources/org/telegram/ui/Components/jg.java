...
public final class jg implements Runnable {
    public final ChatActivityEnterView f27504a;

    public jg(ChatActivityEnterView chatActivityEnterView) {
        this.f27504a = chatActivityEnterView;
    }
    ...
    public final void run() {
        ...
        boolean z11;
        int i10;
        ChatActivityEnterView chatActivityEnterView = this.f27504a;
        ...
        if (ogVar != null && activity != null) {
            ...
            if (slideTextView != null) {
                ...
                chatActivityEnterView.f23722j1.setTranslationY(0.0f);
            }
            SendMessageChatArguments sendMessageChatArguments = null;
            chatActivityEnterView.f23673b3 = null;
            chatActivityEnterView.f23666a3 = null;
            if (chatActivityEnterView.f23678c1) {
                ...
                ug ugVar = chatActivityEnterView.f23727k1;
                if (ugVar != null) {
                    ugVar.h = false;
                }
