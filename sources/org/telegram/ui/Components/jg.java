...
public final class jg implements Runnable {
    public final ChatActivityEnterView f27531a;

    public jg(ChatActivityEnterView chatActivityEnterView) {
        this.f27531a = chatActivityEnterView;
    }
    ...
    public final void run() {
        ...
        boolean z11;
        int i10;
        ChatActivityEnterView chatActivityEnterView = this.f27531a;
        ...
        if (ogVar != null && activity != null) {
            ...
            if (slideTextView != null) {
                ...
                chatActivityEnterView.f23749j1.setTranslationY(0.0f);
            }
            SendMessageChatArguments sendMessageChatArguments = null;
            chatActivityEnterView.f23700b3 = null;
            chatActivityEnterView.f23693a3 = null;
            if (chatActivityEnterView.f23705c1) {
                ...
                ug ugVar = chatActivityEnterView.f23754k1;
                if (ugVar != null) {
                    ugVar.h = false;
                }
