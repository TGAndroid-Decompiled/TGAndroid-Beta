...
public abstract class yd0 {
    public static int f35053a = 1500;
    ...
    public static void g(String[] strArr, Utilities.Callback callback) {
        ...
        if (activity != null) {
            if (Build.VERSION.SDK_INT >= 23) {
                int i11 = f35053a;
                f35053a = i11 + 1;
                NotificationCenter.NotificationCenterDelegate[] notificationCenterDelegateArr = {new xd0(i11, callback, notificationCenterDelegateArr)};
