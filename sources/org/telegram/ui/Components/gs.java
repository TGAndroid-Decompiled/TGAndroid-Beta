...
public final class gs {
    ...
    public static gs b(org.telegram.ui.Cells.r2 r2Var, MessagesController.DialogFilter dialogFilter) {
        ?? obj = new Object();
        obj.f24451a = dialogFilter.f15603id;
        obj.f24452b = dialogFilter.color;
        ...
        g01Var.s(r2Var);
        obj.f24453c = g01Var;
        obj.f24453c.r(MessageObject.replaceAnimatedEmoji(Emoji.replaceEmoji(spannableStringBuilder, g01Var.f24147a.getFontMetricsInt(), false), dialogFilter.entities, obj.f24453c.f24147a.getFontMetricsInt()));
        obj.f24453c.p(26);
        int dp = AndroidUtilities.dp(9.32f);
        g01 g01Var2 = obj.f24453c;
        obj.e = dp + ((int) g01Var2.f24149c);
        g01Var2.j();
    ...
    public final void a(Canvas canvas) {
        ...
        this.f24453c.c(AndroidUtilities.dp(4.66f), AndroidUtilities.dp(14.66f) / 2.0f, 1.0f, this.d, canvas);
    }
}
