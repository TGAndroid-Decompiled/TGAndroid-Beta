...
public final class mh implements Utilities.Callback4 {
    ...
    public final KeyEvent.Callback f26408b;

    public mh(KeyEvent.Callback callback, int i10) {
        this.f26407a = i10;
        this.f26408b = callback;
    }
