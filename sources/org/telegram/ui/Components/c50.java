...
public final class c50 {
    ...
    public final FloatBuffer f23171g;
    public final FloatBuffer h;
    public final int[] f23174k;
    public final b50 f23169c = new b50(R.raw.round_blur_stage_0_frag);
    public final b50 d = new b50(R.raw.round_blur_stage_3_frag);
    public final z40 e = new z40();
    public final a50 f23170f = new a50();
    public int f23172i = 0;
    public final int[] f23173j = new int[1];
    ...
    public c50(int i10, int i11) {
        ...
        for (int i19 = 5; i18 < i19; i19 = 5) {
            GLES20.glBindTexture(3553, this.f23174k[i18]);
            if (i18 < 2) {
                i12 = 9729;
            } else {
                i12 = 9728;
            ...
            if (i18 == 4) {
                ...
                float e = a4.a.e(i21, this.f23167a, 2.0f, -1.0f);
                d(fArr2, 24, -1.0f, e, e);
                ...
                float f7 = (round3 / this.f23167a) * 2.0f;
        ...
        GLES20.glGenFramebuffers(1, this.f23173j, 0);
    ...
    public final void b() {
        ...
        this.f23170f.a();
        this.d.a();
        GLES20.glDeleteTextures(5, this.f23174k, 0);
        GLES20.glDeleteFramebuffers(1, this.f23173j, 0);
    }
}
