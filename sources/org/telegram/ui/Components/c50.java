...
public final class c50 {
    ...
    public final FloatBuffer f22931g;
    public final FloatBuffer h;
    public final int[] f22934k;
    public final b50 f22929c = new b50(R.raw.round_blur_stage_0_frag);
    public final b50 d = new b50(R.raw.round_blur_stage_3_frag);
    public final z40 e = new z40();
    public final a50 f22930f = new a50();
    public int f22932i = 0;
    public final int[] f22933j = new int[1];
    ...
    public c50(int i10, int i11) {
        ...
        for (int i19 = 5; i18 < i19; i19 = 5) {
            GLES20.glBindTexture(3553, this.f22934k[i18]);
            if (i18 < 2) {
                i12 = 9729;
            } else {
                i12 = 9728;
            ...
            if (i18 == 4) {
                ...
                float e = a4.a.e(i21, this.f22927a, 2.0f, -1.0f);
                d(fArr2, 24, -1.0f, e, e);
                ...
                float f7 = (round3 / this.f22927a) * 2.0f;
        ...
        GLES20.glGenFramebuffers(1, this.f22933j, 0);
        FloatBuffer i26 = org.telegram.messenger.ul.i(ByteBuffer.allocateDirect(144));
        this.f22931g = i26;
        i26.put(fArr2).position(0);
        FloatBuffer i27 = org.telegram.messenger.ul.i(ByteBuffer.allocateDirect(928));
        this.h = i27;
        i27.put(fArr).position(0);
    }
    ...
    public final void b() {
        ...
        this.f22930f.a();
        this.d.a();
        GLES20.glDeleteTextures(5, this.f22934k, 0);
        GLES20.glDeleteFramebuffers(1, this.f22933j, 0);
    }
}
