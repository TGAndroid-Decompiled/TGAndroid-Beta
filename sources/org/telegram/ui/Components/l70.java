...
public final class l70 extends ViewGroup {
    ...
    public final void a(n30 n30Var, boolean z10) {
        this.d = true;
        m70 m70Var = this.e;
        m70Var.f26380f0.k(n30Var, n30Var.getUid());
        AnimatorSet animatorSet = m70Var.f26378d0;
        if (animatorSet != null) {
            animatorSet.setupEndValues();
            m70Var.f26378d0.cancel();
        }
        this.f26037a = false;
        if (z10) {
            AnimatorSet animatorSet2 = new AnimatorSet();
            m70Var.f26378d0 = animatorSet2;
            animatorSet2.addListener(new k70(this, 1));
            m70Var.f26378d0.setDuration(150L);
            m70Var.f26378d0.setInterpolator(rr.f28030f);
    ...
    public final void b(n30 n30Var) {
        this.d = false;
        m70 m70Var = this.e;
        m70Var.f26380f0.l(n30Var.getUid());
        ...
        ArrayList arrayList = this.f26038b;
        arrayList.clear();
        arrayList.add(ObjectAnimator.ofFloat(this.f26039c, View.SCALE_X, 1.0f, 0.01f));
        arrayList.add(ObjectAnimator.ofFloat(this.f26039c, View.SCALE_Y, 1.0f, 0.01f));
        arrayList.add(ObjectAnimator.ofFloat(this.f26039c, View.ALPHA, 1.0f, 0.0f));
        requestLayout();
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        while (true) {
            ...
            if (!(childAt instanceof n30)) {
                ...
                if (childAt != this.f26039c && childAt.getMeasuredWidth() + i15 > dp) {
        ...
        if (m70Var.m0 != null) {
            if (m70Var.f26381g0) {
                b10 = Math.min(m70Var.f26392s0, dp6);
            } else {
                b10 = 0;
            }
        } else {
            b10 = org.telegram.messenger.f0.b(52.0f, Math.min(m70Var.f26392s0, dp6), 0);
        }
        int i17 = m70Var.f26394u0;
        if (m70Var.m0 == null && m70Var.f26380f0.m() > 0) {
            i12 = AndroidUtilities.dp(56.0f);
        } else {
            i12 = 0;
        }
        m70Var.f26394u0 = i12;
        if (b10 != m70Var.f26388o0 || i17 != i12) {
            m70Var.f26388o0 = b10;
            if (w0Var.getAdapter() != null && w0Var.getAdapter().h() > 0 && (K = w0Var.K(0)) != null) {
                w0Var.getAdapter().m(0);
                m70Var.R.h1(0, K.f42960a.getTop() - w0Var.getPaddingTop());
        ...
        int min = Math.min(m70Var.f26392s0, dp6);
        int i18 = m70Var.f26385k0;
        if (i18 != min) {
        ...
        boolean z10 = this.d;
        if (z10 && dp6 > m70Var.f26392s0) {
            AndroidUtilities.runOnUIThread(new Runnable(this) {
                public final l70 f25299b;
                ...
                public final void run() {
                    switch (r3) {
                        case 0:
                            m70 m70Var2 = this.f25299b.e;
                            m70Var2.V.smoothScrollTo(0, dp6 - m70Var2.f26392s0);
                            return;
                        default:
                            m70 m70Var3 = this.f25299b.e;
                            m70Var3.V.smoothScrollTo(0, dp6 - m70Var3.f26392s0);
                            return;
                    }
                }
            });
        ...
        if (!this.f26037a && (animatorSet = m70Var.f26378d0) != null) {
            animatorSet.playTogether(arrayList);
            m70Var.f26378d0.addListener(new k70(this, 0));
            m70Var.f26378d0.start();
            this.f26037a = true;
        }
        if (m70Var.f26378d0 == null) {
            m70Var.f26385k0 = min;
