...
public final class l70 extends ViewGroup {
    ...
    public final void a(m30 m30Var, boolean z10) {
        this.d = true;
        m70 m70Var = this.e;
        m70Var.f26355f0.k(m30Var, m30Var.getUid());
        AnimatorSet animatorSet = m70Var.f26353d0;
        if (animatorSet != null) {
            animatorSet.setupEndValues();
            m70Var.f26353d0.cancel();
        }
        this.f26007a = false;
        if (z10) {
            AnimatorSet animatorSet2 = new AnimatorSet();
            m70Var.f26353d0 = animatorSet2;
            animatorSet2.addListener(new k70(this, 1));
            m70Var.f26353d0.setDuration(150L);
            m70Var.f26353d0.setInterpolator(qr.f27653f);
    ...
    public final void b(m30 m30Var) {
        this.d = false;
        m70 m70Var = this.e;
        m70Var.f26355f0.l(m30Var.getUid());
        ...
        ArrayList arrayList = this.f26008b;
        arrayList.clear();
        arrayList.add(ObjectAnimator.ofFloat(this.f26009c, View.SCALE_X, 1.0f, 0.01f));
        arrayList.add(ObjectAnimator.ofFloat(this.f26009c, View.SCALE_Y, 1.0f, 0.01f));
        arrayList.add(ObjectAnimator.ofFloat(this.f26009c, View.ALPHA, 1.0f, 0.0f));
        requestLayout();
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        while (true) {
            ...
            if (!(childAt instanceof m30)) {
                ...
                if (childAt != this.f26009c && childAt.getMeasuredWidth() + i15 > dp) {
        ...
        if (m70Var.m0 != null) {
            if (m70Var.f26356g0) {
                b10 = Math.min(m70Var.f26367s0, dp6);
            } else {
                b10 = 0;
            }
        } else {
            b10 = org.telegram.messenger.l0.b(52.0f, Math.min(m70Var.f26367s0, dp6), 0);
        }
        int i17 = m70Var.f26369u0;
        if (m70Var.m0 == null && m70Var.f26355f0.m() > 0) {
            i12 = AndroidUtilities.dp(56.0f);
        } else {
            i12 = 0;
        }
        m70Var.f26369u0 = i12;
        if (b10 != m70Var.f26363o0 || i17 != i12) {
            m70Var.f26363o0 = b10;
            if (w0Var.getAdapter() != null && w0Var.getAdapter().h() > 0 && (L = w0Var.L(0)) != null) {
                w0Var.getAdapter().m(0);
                m70Var.R.h1(0, L.f42995a.getTop() - w0Var.getPaddingTop());
        ...
        int min = Math.min(m70Var.f26367s0, dp6);
        int i18 = m70Var.f26360k0;
        if (i18 != min) {
                ...
                public final void run() {
                    switch (r3) {
                        case 0:
                            ...
                            m70Var2.V.smoothScrollTo(0, dp6 - m70Var2.f26367s0);
                            return;
                        default:
                            m70 m70Var3 = this.f25300b.e;
                            m70Var3.V.smoothScrollTo(0, dp6 - m70Var3.f26367s0);
                            return;
                    }
                }
            });
        ...
        if (!this.f26007a && (animatorSet = m70Var.f26353d0) != null) {
            animatorSet.playTogether(arrayList);
            m70Var.f26353d0.addListener(new k70(this, 0));
            m70Var.f26353d0.start();
            this.f26007a = true;
        }
        if (m70Var.f26353d0 == null) {
            m70Var.f26360k0 = min;
