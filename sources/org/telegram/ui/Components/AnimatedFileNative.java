...
public class AnimatedFileNative {
    ...
    public long f21692b;
    public final AtomicBoolean f21693c = new AtomicBoolean(false);
    ...
    public final int b(Bitmap bitmap, long j3) {
        this.f21693c.get();
        long j10 = this.f21692b;
        int[] iArr = this.f21691a;
    ...
    public final void f() {
        if (this.f21693c.compareAndSet(false, true)) {
            long j3 = this.f21692b;
            this.f21692b = 0L;
            if (j3 != 0) {
