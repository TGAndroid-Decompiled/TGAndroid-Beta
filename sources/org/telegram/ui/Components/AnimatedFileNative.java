...
public class AnimatedFileNative {
    ...
    public long f23679b;
    public final AtomicBoolean f23680c = new AtomicBoolean(false);
    ...
    public final int b(Bitmap bitmap, long j3) {
        this.f23680c.get();
        long j10 = this.f23679b;
        int[] iArr = this.f23678a;
    ...
    public final void f() {
        if (this.f23680c.compareAndSet(false, true)) {
            long j3 = this.f23679b;
            this.f23679b = 0L;
            if (j3 != 0) {
