...
public class lj0 extends ImageView {
    ...
    public final void a() {
        ij0 ij0Var = this.f26120b;
        if (ij0Var != null) {
            ij0Var.stop();
        }
        jj0 jj0Var = this.f26121c;
        if (jj0Var != null) {
    ...
    public final boolean b() {
        ij0 ij0Var = this.f26120b;
        if (ij0Var != null && ij0Var.f25082k0) {
            return true;
        }
        return false;
    }
    ...
    public final void d() {
        ij0 ij0Var = this.f26120b;
        if (ij0Var != null || this.f26121c != null) {
            this.f26122f = true;
            if (this.e) {
                if (ij0Var != null) {
                    ij0Var.start();
    ...
    public final void g(int i10, int i11, TLRPC.Document document) {
        ...
        if (document != null) {
            ...
            if (this.f26123n) {
                this.f26121c.setImage(ImageLocation.getForDocument(document), i10 + "_" + i11 + "_lastframe", ImageLocation.getForDocument(closestPhotoSizeWithSize, document), a4.a.l(i10, i11, "_"), imageLocation, str, null, 0L, null, document, 1);
            } else if ("video/webm".equals(document.mime_type)) {
                jj0 jj0Var3 = this.f26121c;
                ...
                this.f26121c.setImage(ImageLocation.getForDocument(document), i10 + "_" + i11 + "", ImageLocation.getForDocument(closestPhotoSizeWithSize, document), a4.a.l(i10, i11, "_"), imageLocation, str, svgThumb, 0L, null, document, 1);
            }
            this.f26121c.setAspectFit(true);
            this.f26121c.setParentView(this);
            if (this.d) {
                this.f26121c.setAutoRepeat(1);
                this.f26121c.setAllowStartLottieAnimation(true);
                this.f26121c.setAllowStartAnimation(true);
            } else {
                this.f26121c.setAutoRepeat(0);
            }
            jj0 jj0Var4 = this.f26121c;
            Integer num = this.h;
            if (num != null) {
                i12 = num.intValue();
            } else {
            ...
            this.f26121c.clip = false;
            setImageDrawable(new kj0(this, i10, i11));
            if (this.e) {
                this.f26121c.onAttachedToWindow();
            }
        }
    }
    ...
    public final void h(int i10, String str) {
        ...
        this.f26119a.put(str, Integer.valueOf(i10));
        ij0 ij0Var = this.f26120b;
        if (ij0Var != null) {
            ij0Var.Q(i10, str);
        }
    ...
    public void setAnimation(ij0 ij0Var) {
        ...
        HashMap hashMap = this.f26119a;
        if (hashMap != null) {
            this.f26120b.Z = true;
            for (Map.Entry entry : hashMap.entrySet()) {
                ij0 ij0Var2 = this.f26120b;
                Integer num = (Integer) entry.getValue();
                num.getClass();
                ij0Var2.f25091s.put((String) entry.getKey(), num);
                ij0Var2.G();
            }
            this.f26120b.o();
        }
        this.f26120b.J(true);
        setImageDrawable(this.f26120b);
    }
