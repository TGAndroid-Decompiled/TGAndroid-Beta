...
public final class f71 implements View.OnLayoutChangeListener {
    ...
    public final n7.z0 f24155c;

    public f71(n7.z0 z0Var, View view) {
        this.f24155c = z0Var;
    ...
    public final void onLayoutChange(View view, int i10, int i11, int i12, int i13, int i14, int i15, int i16, int i17) {
        ...
        Boolean bool = this.f24153a;
        if (bool == null || bool.booleanValue() != z10) {
            this.f24153a = Boolean.valueOf(z10);
            this.f24154b = true;
        }
        if (i15 != 0 && i15 != i11 && !this.f24154b) {
            n7.z0 z0Var = this.f24155c;
