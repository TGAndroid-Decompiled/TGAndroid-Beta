...
public final class f71 {
    ...
    public static f71 d(int i10, TLRPC.Document document, TLRPC.Document document2, int i11, boolean z10) {
        ...
        if (tL_documentAttributeVideo != null) {
            ...
            obj.f23816i = tL_documentAttributeVideo.f18128w;
            obj.f23817j = tL_documentAttributeVideo.h;
            obj.f23819l = j3 / d;
        }
    ...
    public final void e(boolean z10) {
        if (!b() && this.f23815g != null) {
            File pathToAttach = FileLoader.getInstance(this.f23811a).getPathToAttach(this.f23815g, null, false, z10);
            if (pathToAttach != null && pathToAttach.exists()) {
                this.d = Uri.fromFile(pathToAttach);
            } else {
                File pathToAttach2 = FileLoader.getInstance(this.f23811a).getPathToAttach(this.f23815g, null, true, z10);
                if (pathToAttach2 != null && pathToAttach2.exists()) {
        ...
        if (!c() && this.h != null) {
            File pathToAttach3 = FileLoader.getInstance(this.f23811a).getPathToAttach(this.h, null, false, z10);
            if (pathToAttach3 != null && pathToAttach3.exists()) {
                this.f23814f = Uri.fromFile(pathToAttach3);
                return;
            }
            File pathToAttach4 = FileLoader.getInstance(this.f23811a).getPathToAttach(this.h, null, true, z10);
            if (pathToAttach4 != null && pathToAttach4.exists()) {
                this.f23814f = Uri.fromFile(pathToAttach4);
            }
        }
    }
}
