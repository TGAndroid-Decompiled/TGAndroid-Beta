...
public final class i01 extends ReplacementSpan {
    public static final int f24785f = 0;
    public ImageReceiver f24786a;
    public int f24787b;
    public int f24788c;
    ...
    public final void draw(Canvas canvas, CharSequence charSequence, int i10, int i11, float f7, int i12, int i13, int i14, Paint paint) {
        int i15 = this.f24787b;
        int i16 = this.f24788c;
        ImageReceiver imageReceiver = this.f24786a;
        canvas.save();
        if (this.d) {
