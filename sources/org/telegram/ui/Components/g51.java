...
public final class g51 extends mw0 {
    ...
    @Override
    public final void d() {
        this.f25053f = System.currentTimeMillis();
        this.f25054g = true;
        invalidateSelf();
    }
    ...
    public final void f() {
        if (this.f25054g) {
            if (NotificationCenter.getInstance(this.f25050a).isAnimationInProgress() && !this.f25055i) {
                AndroidUtilities.runOnUIThread(new nq0(this, 26), 100L);
                return;
            }
            long currentTimeMillis = System.currentTimeMillis();
            long j10 = currentTimeMillis - this.f25053f;
            this.f25053f = currentTimeMillis;
            if (j10 > 50) {
                j10 = 50;
            }
            for (int i10 = 0; i10 < 3; i10++) {
