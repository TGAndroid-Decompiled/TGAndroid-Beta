...
public class yw0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public float I;
    public boolean J;
    public final bc1 f30418a;
    public final u9 f30419b;
    public final RadialProgressView f30420c;
    public final vh.o d;
    public final c90 e;
    public final ci.d f30421f;
    public boolean h;
    public final org.telegram.ui.ActionBar.e6 f30422n;
    public int f30423r;
    public final View f30424s;
    public int v;
    public final int f30425w;
    public boolean f30426x;
    public final org.telegram.ui.Cells.l7 f30427y;
    ...
    public final void b(int i10, boolean z10) {
        if (this.v != i10) {
            ...
            float f7 = i12 + i11;
            RadialProgressView radialProgressView = this.f30420c;
            bc1 bc1Var = this.f30418a;
            if (z10) {
    ...
    public final void c() {
        ...
        int i10;
        int i11 = this.f30423r;
        u9 u9Var = this.f30419b;
        if (i11 != 0) {
            boolean z10 = true;
            if (i11 != 1) {
                ...
                if (i11 == 16) {
                    ...
                    if (stickerSetByName != null && (i10 = this.f30423r) >= 0 && i10 < stickerSetByName.documents.size()) {
                        document2 = stickerSetByName.documents.get(this.f30423r);
                    }
    ...
    public void onAttachedToWindow() {
        ...
        NotificationCenter.getInstance(this.f30425w).addObserver(this, NotificationCenter.diceStickersDidLoad);
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        NotificationCenter.getInstance(this.f30425w).removeObserver(this, NotificationCenter.diceStickersDidLoad);
    }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if ((this.E || this.f30426x) && (i14 = this.F) > 0 && i14 != getMeasuredHeight()) {
            float measuredHeight = (this.F - getMeasuredHeight()) / 2.0f;
            bc1 bc1Var = this.f30418a;
            bc1Var.setTranslationY(bc1Var.getTranslationY() + measuredHeight);
            if (!this.f30426x) {
                bc1Var.animate().translationY(0.0f).setInterpolator(qr.f27423f).setDuration(250L);
            }
            RadialProgressView radialProgressView = this.f30420c;
            if (radialProgressView != null) {
                radialProgressView.setTranslationY(radialProgressView.getTranslationY() + measuredHeight);
                if (!this.f30426x) {
                    radialProgressView.animate().translationY(0.0f).setInterpolator(qr.f27423f).setDuration(250L);
                }
            }
        }
    ...
    public void setPreventMoving(boolean z10) {
        this.f30426x = z10;
        if (!z10) {
            this.f30418a.setTranslationY(0.0f);
            RadialProgressView radialProgressView = this.f30420c;
            if (radialProgressView != null) {
    ...
    public yw0(Context context, View view, int i10, org.telegram.ui.ActionBar.e6 e6Var) {
        super(context);
        this.f30425w = UserConfig.selectedAccount;
        this.f30427y = new org.telegram.ui.Cells.l7(this, 24);
        this.G = org.telegram.ui.ActionBar.i6.f18819c7;
        this.f30422n = e6Var;
        this.f30424s = view;
        this.f30423r = i10;
        ...
        bc1Var.addView(u9Var, w7.x5.q(117, 117, 1));
        bc1Var.addView(oVar, w7.x5.t(-2, -2, 1, 0, 12, 0, 0));
        bc1Var.addView(c90Var, w7.x5.t(-2, -2, 1, 0, 8, 0, 0));
        bc1Var.addView(dVar, w7.x5.t(-1, 48, 1, 28, 16, 28, 0));
        addView(bc1Var, w7.x5.d(-2, -2.0f, 17, 46.0f, 0.0f, 46.0f, 30.0f));
        if (view == null) {
            RadialProgressView radialProgressView = new RadialProgressView(context, e6Var);
            this.f30420c = radialProgressView;
            radialProgressView.setAlpha(0.0f);
            radialProgressView.setScaleY(0.5f);
            radialProgressView.setScaleX(0.5f);
