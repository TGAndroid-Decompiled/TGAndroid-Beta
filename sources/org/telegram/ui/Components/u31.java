...
public final class u31 extends FrameLayout {
    public final ImageView f28269a;
    public final org.telegram.ui.tk f28270b;
    public final dc1 f28271c;
    public final TextView d;
    public final s31 e;
    public final View f28272f;
    public final w31 h;
    ...
    public u31(w31 w31Var, Context context) {
        ...
        int themedColor = w31Var.getThemedColor(org.telegram.ui.ActionBar.j6.f18934h5);
        String str = w31Var.f29517s;
        view.setBackgroundColor(themedColor);
        addView(view, w7.x5.d(-1, 44.0f, 55, 0.0f, 12.0f, 0.0f, 0.0f));
        ImageView imageView = new ImageView(context);
        this.f28269a = imageView;
        ...
        imageView.setBackground(org.telegram.ui.ActionBar.j6.f0(w31Var.getThemedColor(org.telegram.ui.ActionBar.j6.f18953i6), 1, -1));
        imageView.setAlpha(0.0f);
        imageView.setOnClickListener(new View.OnClickListener(this) {
            public final u31 f27530b;
            ...
            public final void onClick(View view2) {
                ...
                switch (r2) {
                    case 0:
                        this.f27530b.h.dismiss();
                        return;
                    default:
                        u31 u31Var = this.f27530b;
                        s31 s31Var = u31Var.e;
                        ...
                        for (int i13 = 0; i13 < locales.size(); i13++) {
                            ...
                            if (!localeInfo.pluralLangCode.equals(w31Var2.f29517s) && "remote".equals(localeInfo.pathToFile)) {
    ...
    public final void setTranslationY(float f7) {
        ...
        float interpolation = qr.f27384g.getInterpolation(a2);
        float lerp = AndroidUtilities.lerp(0.85f, 1.0f, interpolation);
        org.telegram.ui.tk tkVar = this.f28270b;
