...
public abstract class u31 extends org.telegram.ui.ActionBar.f3 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final CharSequence f28402c;
    public final TLRPC.InputPeer d;
    public final int e;
    public final boolean f28403f;
    public final TL_iv.RichMessage h;
    public final RichMessageLayout.PreviewView f28404n;
    public final RichMessageLayout.PreviewView f28405r;
    public final String f28406s;
    public String v;
    public String f28407w;
    public final s31 f28408x;
    public final bi.o f28409y;
    ...
    public u31(Context context, String str, String str2, CharSequence charSequence, TLRPC.InputPeer inputPeer, int i10, boolean z10, TL_iv.RichMessage richMessage) {
        ...
        d90Var.setHighlightColor(getThemedColor(org.telegram.ui.ActionBar.h6.f19109uf));
        int themedColor = getThemedColor(org.telegram.ui.ActionBar.h6.f19126vf);
        try {
        ...
        RichMessageLayout.PreviewView previewView3 = this.f28405r;
        ...
        frameLayout.setBackgroundColor(getThemedColor(org.telegram.ui.ActionBar.h6.f18859h5));
    ...
    public static void m(u31 u31Var, TLRPC.TL_textWithEntities tL_textWithEntities, TLRPC.TL_textWithEntities tL_textWithEntities2, TLRPC.TL_error tL_error) {
        ...
        if (tL_error != null && "TRANSLATIONS_DISABLED_ALT".equalsIgnoreCase(tL_error.text)) {
            ...
            q31 q31Var = u31Var.f28408x.e;
            String str = u31Var.f28407w;
            u31Var.v = str;
    ...
    public static void o(u31 u31Var, TLObject tLObject) {
        RichMessageLayout.PreviewView previewView = u31Var.f28405r;
        u31Var.f28401b = null;
    ...
    public static void p(u31 u31Var, String str, Boolean bool) {
        ...
        if (str != null) {
            ...
            xc xcVar = new xc((FrameLayout) u31Var.containerView, u31Var.resourcesProvider);
            if (bool.booleanValue()) {
                i10 = R.string.TranslationFailedAlert1;
            } else {
                i10 = R.string.TranslationFailedAlert2;
            }
            org.telegram.messenger.z0.p(i10, xcVar, null);
            q31 q31Var = u31Var.f28408x.e;
            String str2 = u31Var.f28407w;
            u31Var.v = str2;
    ...
    public final void M() {
        ...
        if (this.f28401b != null) {
            ConnectionsManager.getInstance(this.currentAccount).cancelRequest(this.f28401b.intValue(), true);
            this.f28401b = null;
        }
        ...
        if (richMessage != null && inputPeer != null) {
            ...
            tL_messages_translateRichMessage.f18204id.add(Integer.valueOf(i10));
            tL_messages_translateRichMessage.to_lang = TranslateController.normalizeLanguage(str);
            this.f28401b = Integer.valueOf(ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_translateRichMessage, new y1(this, 16)));
            return;
        }
        TLRPC.TL_textWithEntities tL_textWithEntities = new TLRPC.TL_textWithEntities();
        CharSequence charSequence2 = this.f28402c;
        ...
        if (this.f28403f && inputPeer != null) {
            ...
            tL_messages_summarizeText.f18203id = i10;
            tL_messages_summarizeText.to_lang = TranslateController.normalizeLanguage(str);
            this.f28401b = Integer.valueOf(ConnectionsManager.getInstance(this.currentAccount).sendRequestTyped(tL_messages_summarizeText, new Object(), new ai.m0(13, this, tL_textWithEntities)));
            return;
        }
        ...
        if (inputPeer != null) {
            ...
            tL_messages_translateText.f18205id.add(Integer.valueOf(i10));
        } else {
            tL_messages_translateText.flags |= 2;
            tL_messages_translateText.text.add(tL_textWithEntities);
        }
        tL_messages_translateText.to_lang = TranslateController.normalizeLanguage(str);
        this.f28401b = Integer.valueOf(ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_translateText, new org.telegram.ui.mo(17, this, tL_textWithEntities)));
    }
