...
public final class u31 extends View {
    ...
    public final Paint f28551b;
    public final Paint f28552c;
    public Drawable d;
    public boolean e;
    public int f28553f;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.e) {
            ...
            canvas2.drawRoundRect(rectF, dp, dp, this.f28551b);
        }
        int i10 = this.f28553f;
        Paint paint = this.f28552c;
        if (i10 != 0) {
            if (i10 == 1) {
                ...
                canvas2.save();
                canvas2.translate((-AndroidUtilities.dp(2.0f)) * this.f28550a, 0.0f);
                canvas2.rotate(this.f28550a * 90.0f, getWidth() / 2.0f, getHeight() / 2.0f);
                canvas2.drawLine(dp2 + ((width - dp2) * this.f28550a), height, width, height, paint);
                int dp3 = AndroidUtilities.dp((this.f28550a * (-1.0f)) + 9.0f);
                int dp4 = AndroidUtilities.dp((this.f28550a * 7.0f) + 9.0f);
                double d = width;
                double d10 = dp3;
                double d11 = height;
            ...
            float max = (Math.max(0.4f, this.f28550a) - 0.4f) / 0.6f;
            if (max != 0.0f) {
    ...
    public void setBackgroundColor(int i10) {
        this.f28551b.setColor(i10);
        invalidate();
    }

    public void setColor(int i10) {
        this.f28552c.setColor(i10);
        invalidate();
    }
