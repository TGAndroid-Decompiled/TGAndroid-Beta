...
public abstract class p61 extends org.telegram.ui.ActionBar.g3 {
    ...
    public final FrameLayout f26942c;
    public final ai.w0 d;
    public ll0 e;
    public ll0 f26943f;
    public final Drawable h;
    public final View f26944n;
    public AnimatorSet f26945r;
    public final zw0 f26946s;
    public final t00 v;
    public final o61 f26947w;
    public final RectF f26948x;
    public int f26949y;
    ...
    public p61(Context context, int i10, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.f26948x = new RectF();
        this.G = true;
        this.H = true;
        this.I = org.telegram.ui.ActionBar.j6.Ii;
        this.J = org.telegram.ui.ActionBar.j6.f18953i6;
        ...
        org.telegram.ui.ActionBar.f6 f6Var2 = zw0Var.f30679n;
    ...
    public final void F(boolean z10) {
        ...
        if ((z10 && view.getTag() != null) || (!z10 && view.getTag() == null)) {
            ...
            AnimatorSet animatorSet = this.f26945r;
            if (animatorSet != null) {
                animatorSet.cancel();
            }
            AnimatorSet animatorSet2 = new AnimatorSet();
            this.f26945r = animatorSet2;
            ...
            this.f26945r.setDuration(150L);
            this.f26945r.addListener(new aa(24, this, z10));
            this.f26945r.start();
        }
    }
    ...
    public void I(int i10) {
        ...
        float f7 = i10;
        this.f26942c.setTranslationY(f7);
        this.f26946s.setTranslationY(f7);
        this.containerView.invalidate();
    }
    ...
    public void L() {
        ...
        if (w0Var.getChildCount() > 0) {
            s4.c1 L = w0Var.L(0);
            if (L != null) {
                i10 = L.f42702a.getTop() - AndroidUtilities.dp(8.0f);
            } else {
                i10 = 0;
            }
    ...
    @Override
    public void dismiss() {
        AndroidUtilities.hideKeyboard(this.f26947w.J);
        super.dismiss();
    }
    ...
    public final void setTitle(CharSequence charSequence) {
        ...
        if (this.f26941b == null) {
            ...
            textView.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f18970j5, this.resourcesProvider));
            this.f26941b.setTextSize(1, 20.0f);
            this.f26941b.setTypeface(AndroidUtilities.bold());
            this.f26941b.setLines(1);
            this.f26941b.setMaxLines(1);
            this.f26941b.setSingleLine(true);
            ...
            this.f26941b.setEllipsize(TextUtils.TruncateAt.END);
            TextView textView3 = this.f26941b;
            FrameLayout.LayoutParams d = w7.x5.d(-1, 36.0f, 51, 16.0f, 0.0f, 0.0f, 0.0f);
            FrameLayout frameLayout = this.f26942c;
            frameLayout.addView(textView3, d);
            ((FrameLayout.LayoutParams) this.f26947w.getLayoutParams()).topMargin = AndroidUtilities.dp(30.0f);
            frameLayout.getLayoutParams().height = AndroidUtilities.dp(94.0f);
        }
        this.f26941b.setText(charSequence);
    }
