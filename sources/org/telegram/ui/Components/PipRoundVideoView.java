...
public class PipRoundVideoView implements NotificationCenter.NotificationCenterDelegate {
    ...
    public class AnonymousClass4 extends AspectRatioFrameLayout {
        ...
        final Paint val$aspectPaint;

        public AnonymousClass4(Context context, Paint paint) {
            super(context);
            this.val$aspectPaint = paint;
        ...
        public void dispatchDraw(Canvas canvas) {
            ...
            canvas.drawPath(this.aspectPath, this.val$aspectPaint);
        }
    ...
    public void show(Activity activity, Runnable runnable) {
        ...
        PipFrameLayout pipFrameLayout = new PipFrameLayout(activity) {
            ...
            public void onDraw(Canvas canvas) {
                TextCell.AnonymousClass2 anonymousClass2 = Theme.chat_roundVideoShadow;
                if (anonymousClass2 != null) {
                    ((Paint) anonymousClass2.val$imageReceiver).setAlpha((int) (getAlpha() * 255.0f));
                ...
                if (motionEvent.getAction() == 2) {
                    ...
                    if (this.startDragging) {
                        ...
                        if (PipRoundVideoView.this.windowLayoutParams.x < 0) {
                            fM = zzir.m(PipRoundVideoView.this.windowLayoutParams.x, i, 0.5f, 1.0f);
                            ...
                            fM = TextureRenderer$$ExternalSyntheticOutline0.m((PipRoundVideoView.this.windowLayoutParams.x - AndroidUtilities.displaySize.x) + PipRoundVideoView.this.windowLayoutParams.width, i, 0.5f, 1.0f);
                        }
                        if (PipRoundVideoView.this.windowView.getAlpha() != fM) {
                            PipRoundVideoView.this.windowView.setAlpha(fM);
                        }
