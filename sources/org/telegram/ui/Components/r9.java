...
public final class r9 extends Drawable {
    public TextPaint f28416a;
    public final Paint f28417b;
    public final Paint f28418c;
    public final Paint d;
    public final float e;
    public float f28419f;
    public float f28420g;
    public final RectF h;
    public ValueAnimator f28421i;
    ...
    public final void a(float f10, boolean z4) {
        ...
        ValueAnimator valueAnimator = this.f28421i;
        ...
        ValueAnimator ofFloat = ValueAnimator.ofFloat(this.f28420g, max);
        this.f28421i = ofFloat;
        ofFloat.addUpdateListener(new f6(this, 5));
        this.f28421i.addListener(new org.telegram.ui.ActionBar.a1(this, max, 4));
        this.f28421i.setInterpolator(nr.h);
        this.f28421i.setDuration(200L);
        this.f28421i.start();
    }
    ...
    public final void draw(Canvas canvas) {
        if (getBounds() != null) {
            ...
            int i11 = getBounds().top + ((int) this.f28419f);
            int width = getBounds().width();
            int height = getBounds().height();
            int centerX = getBounds().centerX();
            int centerY = getBounds().centerY() + ((int) this.f28419f);
            TextPaint textPaint = this.f28416a;
            Paint paint = this.d;
            Paint paint2 = this.f28418c;
            Paint paint3 = this.f28417b;
            if (textPaint != null) {
    ...
    public final void setAlpha(int i10) {
        this.f28417b.setAlpha(i10);
        this.f28418c.setAlpha(i10);
        this.d.setAlpha(i10);
    }

    @Override
    public final void setColorFilter(ColorFilter colorFilter) {
        this.f28417b.setColorFilter(colorFilter);
        this.f28418c.setColorFilter(colorFilter);
    ...
    public r9(float f10, int i10) {
        this();
        a(f10, false);
        this.f28417b.setColor(-1);
        this.f28418c.setColor(-1);
        this.d.setColor(i10);
        this.e = 1.3f;
        invalidateSelf();
    }
