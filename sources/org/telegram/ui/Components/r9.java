...
public final class r9 extends Drawable {
    ...
    public final void a(float f10, boolean z4) {
        ...
        ValueAnimator valueAnimator = this.f30652i;
        ...
        ValueAnimator ofFloat = ValueAnimator.ofFloat(this.f30651g, max);
        this.f30652i = ofFloat;
        ofFloat.addUpdateListener(new f6(this, 5));
        this.f30652i.addListener(new org.telegram.ui.ActionBar.a1(this, max, 4));
        this.f30652i.setInterpolator(pr.h);
        this.f30652i.setDuration(200L);
        this.f30652i.start();
    }
    ...
    public final void draw(Canvas canvas) {
        if (getBounds() != null) {
            ...
            int i11 = getBounds().top + ((int) this.f30650f);
            int width = getBounds().width();
            int height = getBounds().height();
            int centerX = getBounds().centerX();
            int centerY = getBounds().centerY() + ((int) this.f30650f);
            TextPaint textPaint = this.f30646a;
            Paint paint = this.d;
            Paint paint2 = this.f30648c;
            Paint paint3 = this.f30647b;
            if (textPaint != null) {
            ...
            if (this.f30649e != 1.0f) {
                canvas.save();
                float f10 = this.f30649e;
    ...
    public final int getIntrinsicHeight() {
        return AndroidUtilities.dp(this.f30649e * 24.0f);
    }
    ...
    public final void setAlpha(int i10) {
        this.f30647b.setAlpha(i10);
        this.f30648c.setAlpha(i10);
        this.d.setAlpha(i10);
    }

    @Override
    public final void setColorFilter(ColorFilter colorFilter) {
        this.f30647b.setColorFilter(colorFilter);
        this.f30648c.setColorFilter(colorFilter);
    ...
    public r9(float f10, int i10) {
        this();
        a(f10, false);
        this.f30647b.setColor(-1);
        this.f30648c.setColor(-1);
        this.d.setColor(i10);
        this.f30649e = 1.3f;
        invalidateSelf();
    }
