...
public class PhonebookShareAlert extends BottomSheet {
            ...
            if (i2 == 1) {
                ...
                if (i < PhonebookShareAlert.this.phoneStartRow || i >= PhonebookShareAlert.this.phoneEndRow) {
                    ...
                    if (i4 == 1) {
                        ...
                        i3 = i4 == 20 ? R.drawable.msg_info : R.drawable.msg_info;
                    }
                } else {
    ...
    public class TextCheckBoxCell extends FrameLayout {
        ...
        public void onLayout(boolean z, int i, int i2, int i3, int i4) {
            ...
            textView.layout(textView.getLeft(), iDp, this.valueTextView.getRight(), this.valueTextView.getMeasuredHeight() + iDp);
        }
        ...
        public void onMeasure(int i, int i2) {
            ...
            setMeasuredDimension(View.MeasureSpec.getSize(i), MessageObject$$ExternalSyntheticOutline0.m(20.0f, this.valueTextView.getMeasuredHeight() + this.textView.getMeasuredHeight(), AndroidUtilities.dp(64.0f)) + (this.needDivider ? 1 : 0));
        }
    ...
    public class UserCell extends LinearLayout {
        public UserCell(Context context) {
            ...
            TextView textView = new TextView(context);
            AccountFrozenAlert$$ExternalSyntheticOutline1.m(17.0f, 1, textView);
            ...
            if (userStatus != null) {
                ...
                textViewM.setTextColor(PhonebookShareAlert.this.getThemedColor(Theme.key_dialogTextGray3));
                textViewM.setSingleLine(true);
                textViewM.setEllipsize(truncateAt);
                textViewM.setText(userStatus);
                addView(textViewM, LayoutHelper.createLinear(-2, -2, 49, 10, 3, 10, z ? 27 : 11));
            }
        }
    }
    ...
    public void lambda$new$2(int i, View view, View view2) {
        ...
        if (i5 != 3) {
            ...
            builder.setItems(new CharSequence[]{LocaleController.getString(R.string.Copy)}, new PhonebookShareAlert$$ExternalSyntheticLambda2(objArr == true ? 1 : 0, this, vcardItem));
            builder.show();
        } else {
    ...
    public void lambda$new$6(Theme.ResourcesProvider resourcesProvider, View view) {
        ...
        if (this.isImport) {
            ...
            builder.setItems(new CharSequence[]{LocaleController.getString(R.string.CreateNewContact), LocaleController.getString(R.string.AddToExistingContact)}, new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialogInterface, int i) {
                    ...
                    try {
                        PhonebookShareAlert.this.parentFragment.getParentActivity().startActivity(intent2);
        ...
        if ((baseFragment instanceof ChatActivity) && ((ChatActivity) baseFragment).isInScheduleMode()) {
            AlertsCreator.createScheduleDatePickerDialog(getContext(), ((ChatActivity) this.parentFragment).getDialogId(), new PhonebookShareAlert$$ExternalSyntheticLambda0(this), resourcesProvider);
        } else {
            BaseFragment baseFragment2 = this.parentFragment;
            AlertsCreator.ensurePaidMessageConfirmation(this.currentAccount, baseFragment2 instanceof ChatActivity ? ((ChatActivity) baseFragment2).getDialogId() : 0L, 1, new PasscodeView$$ExternalSyntheticLambda8(this, 9));
        }
    }
    ...
    public PhonebookShareAlert(BaseFragment baseFragment, ContactsController.Contact contact, TLRPC.User user, Uri uri, File file, String str, String str2, String str3, final Theme.ResourcesProvider resourcesProvider) {
        ...
        super(baseFragment.getParentActivity(), false, false, resourcesProvider);
        ...
        FrameLayout frameLayout = new FrameLayout(parentActivity) {
            ...
            public void onDraw(Canvas canvas) {
                ...
                int iDp = ((BottomSheet) PhonebookShareAlert.this).backgroundPaddingTop + AndroidUtilities.dp(30.0f) + getMeasuredHeight();
                ...
                int i5 = i3 + i4;
                ((BottomSheet) PhonebookShareAlert.this).shadowDrawable.setBounds(0, i5, getMeasuredWidth(), iDp - i4);
                ...
                if (fMin != 1.0f) {
                    ...
                    this.rect.set(((BottomSheet) PhonebookShareAlert.this).backgroundPaddingLeft, ((BottomSheet) PhonebookShareAlert.this).backgroundPaddingTop + i5, getMeasuredWidth() - ((BottomSheet) PhonebookShareAlert.this).backgroundPaddingLeft, AndroidUtilities.dp(24.0f) + ((BottomSheet) PhonebookShareAlert.this).backgroundPaddingTop + i5);
                    float f = fDp * fMin;
        ...
        for (final int i3 = 0; i3 < itemCount; i3++) {
            View viewCreateView = this.listAdapter.createView(parentActivity, i3);
            ...
            if ((i3 >= this.phoneStartRow && i3 < this.phoneEndRow) || (i3 >= this.vcardStartRow && i3 < this.vcardEndRow)) {
                ...
                viewCreateView.setOnClickListener(new AlertsCreator$$ExternalSyntheticLambda134(this, i3, viewCreateView, 4));
        ...
        textView2.setBackground(Theme.createSimpleSelectorRoundRectDrawable(iDp, iDp, iDp, iDp, themedColor, themedColor2, themedColor2));
        frameLayout.addView(this.buttonTextView, LayoutHelper.createFrame(-1, 48.0f, 83, 14.0f, 14.0f, 14.0f, 14.0f));
        this.buttonTextView.setOnClickListener(new UndoView$$ExternalSyntheticLambda6(3, this, resourcesProvider));
    }
}
