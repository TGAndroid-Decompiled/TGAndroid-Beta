...
public final class fd extends Drawable {
    ...
    public void onBoundsChange(Rect rect) {
        switch (this.f26014a) {
            case 5:
                ((ImageReceiver) this.f26015b).setImageCoords(AndroidUtilities.dp(2.0f) + rect.left, AndroidUtilities.dp(2.0f) + rect.top, org.telegram.messenger.vl.v(2.0f, rect.left, rect.right - AndroidUtilities.dp(2.0f)), org.telegram.messenger.vl.v(2.0f, rect.top, rect.bottom - AndroidUtilities.dp(2.0f)));
                return;
            default:
