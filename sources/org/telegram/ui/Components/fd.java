...
public final class fd extends Drawable {
    ...
    public final void draw(Canvas canvas) {
        ...
        switch (this.f26041a) {
            case 0:
                gd gdVar = (gd) this.f26043c;
                if (gdVar.f26376c > 1) {
                    gdVar.c(canvas, gdVar.f26386o);
                    return;
                } else {
                    gdVar.c(canvas, (Paint) this.f26042b);
                    return;
                }
            case 1:
                Paint paint = (Paint) this.f26042b;
                ChatActivityEnterView chatActivityEnterView = (ChatActivityEnterView) this.f26043c;
                if (chatActivityEnterView.U0 != null) {
                    ...
                    float y3 = (chatActivityEnterView.U0.getY() - chatActivityEnterView.getHeight()) + org.telegram.ui.ActionBar.j6.f20777i3.getIntrinsicHeight();
                ...
                return;
            case 2:
                Paint paint2 = (Paint) this.f26043c;
                canvas.drawRect(getBounds(), (Paint) this.f26042b);
                ...
                return;
            case 3:
                p6 p6Var = (p6) this.f26043c;
                Paint paint3 = (Paint) this.f26042b;
                if (paint3 != null) {
                    paint3.setStrokeWidth(AndroidUtilities.dpf2(1.6f));
                    RectF rectF = AndroidUtilities.rectTmp;
                    rectF.set(((AndroidUtilities.dp(24.0f) - p6Var.d()) / 2.0f) - AndroidUtilities.dpf2(3.0f), AndroidUtilities.dpf2(0.2f) + ((AndroidUtilities.dp(24.0f) - p6Var.f29314e) / 2.0f), AndroidUtilities.dpf2(3.0f) + ((p6Var.d() + AndroidUtilities.dp(24.0f)) / 2.0f), (AndroidUtilities.dp(24.0f) + p6Var.f29314e) / 2.0f);
                    canvas.drawRoundRect(rectF, AndroidUtilities.dpf2(3.0f), AndroidUtilities.dpf2(3.0f), paint3);
                }
                p6Var.f29311a.setStrokeWidth(AndroidUtilities.dpf2(0.3f));
                p6Var.setBounds(0, (int) ((AndroidUtilities.dp(24.0f) - p6Var.f29314e) / 2.0f), AndroidUtilities.dp(24.0f), (int) ((AndroidUtilities.dp(24.0f) + p6Var.f29314e) / 2.0f));
                p6Var.draw(canvas);
                return;
            case 4:
                Bitmap bitmap = (Bitmap) this.f26042b;
                if (!bitmap.isRecycled()) {
                    canvas.drawBitmap(bitmap, (Rect) null, (Rect) this.f26043c, (Paint) null);
                    return;
                }
                return;
            default:
                ImageReceiver imageReceiver = (ImageReceiver) this.f26042b;
                imageReceiver.draw(canvas);
                Drawable drawable = (Drawable) this.f26043c;
    ...
    public int getAlpha() {
        switch (this.f26041a) {
            case 5:
                return (int) (((ImageReceiver) this.f26042b).getAlpha() * 255.0f);
            default:
    ...
    public void l(float f7, boolean z10) {
        p6 p6Var = (p6) this.f26043c;
        String str = a(f7) + "X";
        if (z10 && TextUtils.equals(p6Var.f29316g, str)) {
            return;
        }
        p6Var.b();
    ...
    public void onBoundsChange(Rect rect) {
        switch (this.f26041a) {
            case 5:
                ((ImageReceiver) this.f26042b).setImageCoords(AndroidUtilities.dp(2.0f) + rect.left, AndroidUtilities.dp(2.0f) + rect.top, org.telegram.messenger.wl.v(2.0f, rect.left, rect.right - AndroidUtilities.dp(2.0f)), org.telegram.messenger.wl.v(2.0f, rect.top, rect.bottom - AndroidUtilities.dp(2.0f)));
                return;
            default:
    ...
    public final void setAlpha(int i10) {
        switch (this.f26041a) {
            ...
            case 4:
                return;
            default:
                ((ImageReceiver) this.f26042b).setAlpha(i10 / 255.0f);
                return;
        }
    }
        ...
        switch (this.f26041a) {
            case 4:
                ...
                if (bitmap != null && !bitmap.isRecycled()) {
                    ...
                    ((Rect) this.f26043c).set(i16, i17, round + i16, round2 + i17);
                    return;
                }
                return;
            default:
    ...
    public fd(ImageReceiver imageReceiver, Drawable drawable) {
        this.f26041a = 5;
        this.f26042b = imageReceiver;
        this.f26043c = drawable;
    }

    public fd(ChatActivityEnterView chatActivityEnterView) {
        this.f26041a = 1;
        this.f26043c = chatActivityEnterView;
        Paint paint = new Paint();
        this.f26042b = paint;
        paint.setColor(0);
    }
