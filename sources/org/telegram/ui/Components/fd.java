...
public final class fd extends Drawable {
    ...
    public final void draw(Canvas canvas) {
        ...
        switch (this.f24143a) {
            case 0:
                gd gdVar = (gd) this.f24145c;
                if (gdVar.f24420c > 1) {
                    gdVar.c(canvas, gdVar.f24429o);
                    return;
                } else {
                    gdVar.c(canvas, (Paint) this.f24144b);
                    return;
                }
            case 1:
                Paint paint = (Paint) this.f24144b;
                ChatActivityEnterView chatActivityEnterView = (ChatActivityEnterView) this.f24145c;
                if (chatActivityEnterView.U0 != null) {
                    ...
                    float y3 = (chatActivityEnterView.U0.getY() - chatActivityEnterView.getHeight()) + org.telegram.ui.ActionBar.h6.f19131i3.getIntrinsicHeight();
                ...
                return;
            case 2:
                Paint paint2 = (Paint) this.f24145c;
                canvas.drawRect(getBounds(), (Paint) this.f24144b);
                ...
                return;
            case 3:
                o6 o6Var = (o6) this.f24145c;
                Paint paint3 = (Paint) this.f24144b;
                if (paint3 != null) {
                ...
                o6Var.f26924a.setStrokeWidth(AndroidUtilities.dpf2(0.3f));
                ...
                return;
            case 4:
                Bitmap bitmap = (Bitmap) this.f24144b;
                if (!bitmap.isRecycled()) {
                    canvas.drawBitmap(bitmap, (Rect) null, (Rect) this.f24145c, (Paint) null);
                    return;
                }
                return;
            default:
                ImageReceiver imageReceiver = (ImageReceiver) this.f24144b;
                imageReceiver.draw(canvas);
                Drawable drawable = (Drawable) this.f24145c;
                ...
                int imageHeight = (int) ((((imageReceiver.getImageHeight() / 2.0f) - intrinsicHeight) + imageReceiver.getImageY()) - ((1.0f - rr.f28026k.getInterpolation(imageReceiver.getCurrentAlpha())) * AndroidUtilities.dp(16.0f)));
    ...
    public int getAlpha() {
        switch (this.f24143a) {
            case 5:
                return (int) (((ImageReceiver) this.f24144b).getAlpha() * 255.0f);
            default:
    ...
    public void l(float f7, boolean z10) {
        o6 o6Var = (o6) this.f24145c;
        String str = a(f7) + "X";
        if (z10 && TextUtils.equals(o6Var.f26928g, str)) {
            return;
        }
        o6Var.b();
    ...
    public void onBoundsChange(Rect rect) {
        switch (this.f24143a) {
            case 5:
                ((ImageReceiver) this.f24144b).setImageCoords(AndroidUtilities.dp(2.0f) + rect.left, AndroidUtilities.dp(2.0f) + rect.top, org.telegram.messenger.ok.y(2.0f, rect.left, rect.right - AndroidUtilities.dp(2.0f)), org.telegram.messenger.ok.y(2.0f, rect.top, rect.bottom - AndroidUtilities.dp(2.0f)));
                return;
            default:
    ...
    public final void setAlpha(int i10) {
        switch (this.f24143a) {
            ...
            case 4:
                return;
            default:
                ((ImageReceiver) this.f24144b).setAlpha(i10 / 255.0f);
                return;
        }
    }
        ...
        switch (this.f24143a) {
            case 4:
                ...
                if (bitmap != null && !bitmap.isRecycled()) {
                    ...
                    ((Rect) this.f24145c).set(i16, i17, round + i16, round2 + i17);
                    return;
                }
                return;
            default:
    ...
    public fd(ImageReceiver imageReceiver, Drawable drawable) {
        this.f24143a = 5;
        this.f24144b = imageReceiver;
        this.f24145c = drawable;
    }

    public fd(ChatActivityEnterView chatActivityEnterView) {
        this.f24143a = 1;
        this.f24145c = chatActivityEnterView;
        Paint paint = new Paint();
        this.f24144b = paint;
        paint.setColor(0);
    }
