...
public final class fd {
    public static final int[] f24150p = {16842910, 16842919};
    public vq f24151a;
    public final ArrayList f24152b = new ArrayList();
    public int f24153c;
    public boolean d;
    public final org.telegram.ui.Cells.z e;
    public final View f24154f;
    public final Paint f24155g;
    public Runnable h;
    public boolean f24156i;
    public Runnable f24157j;
    public final org.telegram.ui.Cells.t6 f24158k;
    public boolean f24159l;
    public final CornerPathEffect f24160m;
    public boolean f24161n;
    public final Paint f24162o;

    public fd(View view) {
        Paint paint = new Paint(1);
        this.f24155g = paint;
        this.f24158k = new org.telegram.ui.Cells.t6(this, 6);
        this.f24154f = view;
        CornerPathEffect cornerPathEffect = new CornerPathEffect(AndroidUtilities.dp(12.0f));
        this.f24160m = cornerPathEffect;
    ...
    public final void a(RectF rectF) {
        int i10 = this.f24153c + 1;
        this.f24153c = i10;
        ArrayList arrayList = this.f24152b;
        if (i10 > arrayList.size()) {
            arrayList.add(new RectF());
        }
        ((RectF) arrayList.get(this.f24153c - 1)).set(rectF);
    }
    ...
    public final boolean b(MotionEvent motionEvent) {
        ...
        View view = this.f24154f;
        org.telegram.ui.Cells.t6 t6Var = this.f24158k;
        org.telegram.ui.Cells.z zVar = this.e;
        if (action == 0) {
            for (int i10 = 0; i10 < this.f24153c; i10++) {
                float f7 = x10;
                float f10 = y3;
                if (((RectF) this.f24152b.get(i10)).contains(f7, f10)) {
                    this.d = true;
                    if (zVar != null) {
                        zVar.setHotspot(f7, f10);
                        zVar.setState(f24150p);
                    }
    ...
    public final void c(Canvas canvas, Paint paint) {
        ...
        CornerPathEffect cornerPathEffect = this.f24160m;
        org.telegram.ui.Cells.z zVar = this.e;
        int i11 = 0;
        ArrayList arrayList = this.f24152b;
        if (i10 > 1) {
            if (!this.f24156i) {
                vq vqVar = this.f24151a;
                if (vqVar == null) {
                    this.f24151a = new vq(0);
                } else {
                    vqVar.rewind();
                }
                int i12 = 0;
                ...
                while (true) {
                    ...
                    this.f24151a.addRect((RectF) arrayList.get(i11), Path.Direction.CCW);
                    if (zVar != null) {
