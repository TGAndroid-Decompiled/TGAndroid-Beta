...
public final class fa {
    public final ba f26830a;
    public final View f26831b;
    public final ColorMatrix f26832c;
    public final boolean d;
    public boolean f26833e;
    public float f26834f;
    public Paint f26835g;
    public Paint h;
    public final int f26836i;
    public final Integer f26837j;
    public final Path f26838k;
    public int f26839l;
    public int f26840m;
    public Bitmap f26841n;
    public BitmapShader f26842o;
    public final Matrix f26843p;
    public final RectF f26844q;
    public boolean f26845r;
    public Paint[] f26846s;
    public ValueAnimator f26847t;
    ...
    public final void b(Canvas canvas, boolean z4) {
        ...
        if (baVar.c() && Build.VERSION.SDK_INT >= 31) {
            ...
            RenderNode renderNode = (RenderNode) baVar.f25560l;
            if (!renderNode.hasDisplayList()) {
                RenderNode renderNode2 = (RenderNode) baVar.f25559k;
            ...
            if (renderNode.hasDisplayList()) {
                Matrix matrix = this.f26843p;
                matrix.postTranslate(-0.0f, -0.0f);
                this.h.setAlpha((int) 255.0f);
                canvas.saveLayer(null, this.h);
                canvas.concat(matrix);
                if (z4) {
                    int i14 = this.f26839l;
                    int width = renderNode.getWidth();
                    Path path = this.f26838k;
                    if (i14 != width || this.f26840m != renderNode.getHeight()) {
                        path.rewind();
    ...
    public final Paint c(float f10) {
        ...
        BitmapShader bitmapShader = this.f26842o;
        if (bitmapShader == null || this.f26841n != b10) {
            if (this.d && bitmapShader != null && (bitmap = this.f26841n) != null && !bitmap.isRecycled() && !b10.isRecycled()) {
                Paint paint = this.h;
                this.h = this.f26835g;
                this.f26835g = paint;
                this.f26833e = true;
                ValueAnimator valueAnimator = this.f26847t;
    ...
    public final Paint[] d() {
        ...
        if (c3 != null && z4) {
            c3.setAlpha((int) org.telegram.messenger.y3.y(1.0f, this.f26834f, 255.0f, 1.0f));
        }
        if (paint != null) {
            paint.setAlpha((int) 255.0f);
        }
        if (this.f26846s == null) {
            this.f26846s = new Paint[2];
        }
        Paint[] paintArr = this.f26846s;
        paintArr[0] = paint;
        paintArr[1] = c3;
        return paintArr;
    }
    ...
    public final void e(float f10, float f11, float f12, float f13) {
        ...
        RectF rectF2 = this.f26844q;
        if (rectF2.top != rectF.top || rectF2.bottom != rectF.bottom || rectF2.left != rectF.left || rectF2.right != rectF.right) {
            rectF2.set(rectF);
            Bitmap b10 = this.f26830a.b();
            if (b10 == null) {
                return;
            }
            if (this.f26842o == null || this.f26841n != b10) {
                this.f26841n = b10;
                Shader.TileMode tileMode = Shader.TileMode.CLAMP;
                BitmapShader bitmapShader = new BitmapShader(b10, tileMode, tileMode);
                this.f26842o = bitmapShader;
                this.h.setShader(bitmapShader);
            }
            float width = rectF2.width() / this.f26841n.getWidth();
            float height = rectF2.height() / this.f26841n.getHeight();
            Matrix matrix = this.f26843p;
            matrix.reset();
    ...
    public final void f(int i10, int i11, boolean z4) {
        ...
        if (baVar != null) {
            ArrayList arrayList = baVar.f25553c;
            View view3 = this.f26831b;
            do {
    ...
    public fa(ba baVar, View view, int i10, boolean z4) {
        this.f26835g = new Paint(3);
        this.h = new Paint(3);
        this.f26838k = new Path();
        this.f26843p = new Matrix();
        this.f26844q = new RectF();
        this.f26845r = false;
        this.f26848u = new int[2];
        this.v = new int[2];
        this.f26830a = baVar;
        this.f26831b = view;
        this.f26836i = i10;
        ...
        if (i10 == 0) {
            ...
            this.f26835g.setXfermode(new PorterDuffXfermode(mode));
            AndroidUtilities.adjustSaturationColorMatrix(colorMatrix, 0.3f);
        } else if (i10 == 2) {
            Paint paint2 = this.h;
            PorterDuff.Mode mode2 = PorterDuff.Mode.SRC_IN;
            paint2.setXfermode(new PorterDuffXfermode(mode2));
            this.f26835g.setXfermode(new PorterDuffXfermode(mode2));
            ...
            this.f26835g.setXfermode(new PorterDuffXfermode(mode3));
            AndroidUtilities.adjustBrightnessColorMatrix(colorMatrix, 0.4f);
            AndroidUtilities.adjustSaturationColorMatrix(colorMatrix, 0.45f);
        } else if (i10 == 10) {
            colorMatrix.setSaturation(1.6f);
            AndroidUtilities.multiplyBrightnessColorMatrix(colorMatrix, this.f26845r ? 0.97f : 0.92f);
            AndroidUtilities.adjustBrightnessColorMatrix(colorMatrix, this.f26845r ? 0.12f : -0.06f);
        }
        this.h.setColorFilter(new ColorMatrixColorFilter(colorMatrix));
        this.f26835g.setColorFilter(new ColorMatrixColorFilter(colorMatrix));
