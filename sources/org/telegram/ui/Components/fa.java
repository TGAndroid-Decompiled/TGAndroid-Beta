...
public final class fa {
    public final ba f26831a;
    public final View f26832b;
    public final ColorMatrix f26833c;
    public final boolean d;
    public boolean f26834e;
    public float f26835f;
    public Paint f26836g;
    public Paint h;
    public final int f26837i;
    public final Integer f26838j;
    public final Path f26839k;
    public int f26840l;
    public int f26841m;
    public Bitmap f26842n;
    public BitmapShader f26843o;
    public final Matrix f26844p;
    public final RectF f26845q;
    public boolean f26846r;
    public Paint[] f26847s;
    public ValueAnimator f26848t;
    ...
    public final void b(Canvas canvas, boolean z4) {
        ...
        if (baVar.c() && Build.VERSION.SDK_INT >= 31) {
            ...
            RenderNode renderNode = (RenderNode) baVar.f25549l;
            if (!renderNode.hasDisplayList()) {
                RenderNode renderNode2 = (RenderNode) baVar.f25548k;
            ...
            if (renderNode.hasDisplayList()) {
                Matrix matrix = this.f26844p;
                matrix.postTranslate(-0.0f, -0.0f);
                this.h.setAlpha((int) 255.0f);
                canvas.saveLayer(null, this.h);
                canvas.concat(matrix);
                if (z4) {
                    int i14 = this.f26840l;
                    int width = renderNode.getWidth();
                    Path path = this.f26839k;
                    if (i14 != width || this.f26841m != renderNode.getHeight()) {
                        path.rewind();
    ...
    public final Paint c(float f10) {
        ...
        BitmapShader bitmapShader = this.f26843o;
        if (bitmapShader == null || this.f26842n != b10) {
            if (this.d && bitmapShader != null && (bitmap = this.f26842n) != null && !bitmap.isRecycled() && !b10.isRecycled()) {
                Paint paint = this.h;
                this.h = this.f26836g;
                this.f26836g = paint;
                this.f26834e = true;
                ValueAnimator valueAnimator = this.f26848t;
    ...
    public final Paint[] d() {
        ...
        if (c3 != null && z4) {
            c3.setAlpha((int) org.telegram.messenger.y3.y(1.0f, this.f26835f, 255.0f, 1.0f));
        }
        if (paint != null) {
            paint.setAlpha((int) 255.0f);
        }
        if (this.f26847s == null) {
            this.f26847s = new Paint[2];
        }
        Paint[] paintArr = this.f26847s;
        paintArr[0] = paint;
        paintArr[1] = c3;
        return paintArr;
    }
    ...
    public final void e(float f10, float f11, float f12, float f13) {
        ...
        RectF rectF2 = this.f26845q;
        if (rectF2.top != rectF.top || rectF2.bottom != rectF.bottom || rectF2.left != rectF.left || rectF2.right != rectF.right) {
            rectF2.set(rectF);
            Bitmap b10 = this.f26831a.b();
            if (b10 == null) {
                return;
            }
            if (this.f26843o == null || this.f26842n != b10) {
                this.f26842n = b10;
                Shader.TileMode tileMode = Shader.TileMode.CLAMP;
                BitmapShader bitmapShader = new BitmapShader(b10, tileMode, tileMode);
                this.f26843o = bitmapShader;
                this.h.setShader(bitmapShader);
            }
            float width = rectF2.width() / this.f26842n.getWidth();
            float height = rectF2.height() / this.f26842n.getHeight();
            Matrix matrix = this.f26844p;
            matrix.reset();
    ...
    public final void f(int i10, int i11, boolean z4) {
        ...
        if (baVar != null) {
            ArrayList arrayList = baVar.f25542c;
            View view3 = this.f26832b;
            do {
    ...
    public fa(ba baVar, View view, int i10, boolean z4) {
        this.f26836g = new Paint(3);
        this.h = new Paint(3);
        this.f26839k = new Path();
        this.f26844p = new Matrix();
        this.f26845q = new RectF();
        this.f26846r = false;
        this.f26849u = new int[2];
        this.v = new int[2];
        this.f26831a = baVar;
        this.f26832b = view;
        this.f26837i = i10;
        ...
        if (i10 == 0) {
            ...
            this.f26836g.setXfermode(new PorterDuffXfermode(mode));
            AndroidUtilities.adjustSaturationColorMatrix(colorMatrix, 0.3f);
        } else if (i10 == 2) {
            Paint paint2 = this.h;
            PorterDuff.Mode mode2 = PorterDuff.Mode.SRC_IN;
            paint2.setXfermode(new PorterDuffXfermode(mode2));
            this.f26836g.setXfermode(new PorterDuffXfermode(mode2));
            ...
            this.f26836g.setXfermode(new PorterDuffXfermode(mode3));
            AndroidUtilities.adjustBrightnessColorMatrix(colorMatrix, 0.4f);
            AndroidUtilities.adjustSaturationColorMatrix(colorMatrix, 0.45f);
        } else if (i10 == 10) {
            colorMatrix.setSaturation(1.6f);
            AndroidUtilities.multiplyBrightnessColorMatrix(colorMatrix, this.f26846r ? 0.97f : 0.92f);
            AndroidUtilities.adjustBrightnessColorMatrix(colorMatrix, this.f26846r ? 0.12f : -0.06f);
        }
        this.h.setColorFilter(new ColorMatrixColorFilter(colorMatrix));
        this.f26836g.setColorFilter(new ColorMatrixColorFilter(colorMatrix));
