...
public final class y81 extends AsyncTask {
    ...
    public y81(e91 e91Var, String str, int i10) {
        ...
        switch (i10) {
            case 1:
                this.d = e91Var;
                this.f30961c = new String[4];
                this.f30960b = str;
                return;
            case 2:
                this.d = e91Var;
                this.f30961c = new String[2];
                this.f30960b = str;
                return;
            case 3:
                this.d = e91Var;
    ...
    public final Object doInBackground(Object[] objArr) {
        switch (this.f30959a) {
            case 0:
                ...
                String[] strArr = this.f30961c;
                Locale locale = Locale.US;
                this.d.getClass();
                String c3 = e91.c(this, "http://www.aparat.com/video/video/embed/vt/frame/showvideo/yes/videohash/" + this.f30960b, null, true);
                if (isCancelled()) {
                    return null;
                }
                try {
                    Matcher matcher = e91.f24520o0.matcher(c3);
                    if (matcher.find()) {
            ...
            case 1:
                ...
                String[] strArr2 = this.f30961c;
                Locale locale2 = Locale.US;
                this.d.getClass();
                String c10 = e91.c(this, "https://coub.com/api/v2/coubs/" + this.f30960b + ".json", null, true);
                if (isCancelled()) {
                    return null;
                }
                try {
            ...
            case 2:
                ...
                try {
                    Matcher matcher2 = e91.f24521p0.matcher(c11);
                    if (matcher2.find()) {
            ...
            case 3:
                ...
                String[] strArr4 = this.f30961c;
                HashMap hashMap = new HashMap();
                hashMap.put("Client-ID", "jzkbprff40iqj646a697cyrvl0zt2m6");
                int indexOf = this.f30960b.indexOf(38);
                if (indexOf > 0) {
                    this.f30960b = this.f30960b.substring(0, indexOf);
                }
                Locale locale3 = Locale.US;
                this.d.getClass();
                String c12 = e91.c(this, "https://api.twitch.tv/kraken/streams/" + this.f30960b + "?stream_type=all", hashMap, false);
                if (isCancelled()) {
                    return null;
                }
                try {
                    new JSONObject(c12).getJSONObject("stream");
                    JSONObject jSONObject3 = new JSONObject(e91.c(this, "https://api.twitch.tv/api/channels/" + this.f30960b + "/access_token", hashMap, false));
                    ...
                    URLEncoder.encode("https://youtube.googleapis.com/v/" + this.f30960b, "UTF-8");
            ...
            default:
                ...
                String[] strArr5 = this.f30961c;
                Locale locale4 = Locale.US;
                this.d.getClass();
                String c13 = e91.c(this, "https://player.vimeo.com/video/" + this.f30960b + "/config", null, true);
                if (isCancelled()) {
                    return null;
                }
                try {
    ...
    public final void onPostExecute(Object obj) {
        switch (this.f30959a) {
            ...
            case 1:
                ...
                e91 e91Var2 = this.d;
                if (str2 != null) {
                    e91Var2.f24545w = true;
                    e91Var2.f24546x = str2;
                    String[] strArr = this.f30961c;
                    e91Var2.f24547y = strArr[1];
                    e91Var2.B = strArr[2];
                    e91Var2.C = strArr[3];
                    if (e91Var2.f24544s) {
                        e91Var2.i();
            ...
            case 2:
                ...
                e91 e91Var3 = this.d;
                if (str3 != null) {
                    e91Var3.f24545w = true;
                    e91Var3.f24546x = str3;
                    e91Var3.f24547y = this.f30961c[1];
                    if (e91Var3.f24544s) {
                        e91Var3.i();
                    }
                    e91Var3.j(false, true);
                    e91Var3.f24535c0.d(true, true);
                    return;
                } else if (!isCancelled()) {
                    e91Var3.h();
                    return;
            ...
            case 3:
                ...
                e91 e91Var4 = this.d;
                if (str4 != null) {
                    e91Var4.f24545w = true;
                    e91Var4.f24546x = str4;
                    e91Var4.f24547y = this.f30961c[1];
                    if (e91Var4.f24544s) {
                        e91Var4.i();
                    }
                    e91Var4.j(false, true);
                    e91Var4.f24535c0.d(true, true);
                    return;
                } else if (!isCancelled()) {
                    e91Var4.h();
                    return;
            ...
            default:
                ...
                e91 e91Var5 = this.d;
                if (str5 != null) {
                    e91Var5.f24545w = true;
                    e91Var5.f24546x = str5;
                    e91Var5.f24547y = this.f30961c[1];
                    if (e91Var5.f24544s) {
                        e91Var5.i();
                    }
                    e91Var5.j(false, true);
                    e91Var5.f24535c0.d(true, true);
                    return;
                } else if (!isCancelled()) {
                    e91Var5.h();
                    return;
