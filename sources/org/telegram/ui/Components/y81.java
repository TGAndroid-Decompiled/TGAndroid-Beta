...
public final class y81 extends AsyncTask {
    ...
    public y81(e91 e91Var, String str, int i10) {
        ...
        switch (i10) {
            case 1:
                this.d = e91Var;
                this.f33437c = new String[4];
                this.f33436b = str;
                return;
            case 2:
                this.d = e91Var;
                this.f33437c = new String[2];
                this.f33436b = str;
                return;
            case 3:
                this.d = e91Var;
    ...
    public final Object doInBackground(Object[] objArr) {
        switch (this.f33435a) {
            case 0:
                ...
                String[] strArr = this.f33437c;
                Locale locale = Locale.US;
                this.d.getClass();
                String c3 = e91.c(this, "http://www.aparat.com/video/video/embed/vt/frame/showvideo/yes/videohash/" + this.f33436b, null, true);
                if (isCancelled()) {
                    return null;
                }
                try {
                    Matcher matcher = e91.f26506o0.matcher(c3);
                    if (matcher.find()) {
            ...
            case 1:
                ...
                String[] strArr2 = this.f33437c;
                Locale locale2 = Locale.US;
                this.d.getClass();
                String c10 = e91.c(this, "https://coub.com/api/v2/coubs/" + this.f33436b + ".json", null, true);
                if (isCancelled()) {
                    return null;
                }
                try {
            ...
            case 2:
                ...
                try {
                    Matcher matcher2 = e91.f26507p0.matcher(c11);
                    if (matcher2.find()) {
            ...
            case 3:
                ...
                String[] strArr4 = this.f33437c;
                HashMap hashMap = new HashMap();
                hashMap.put("Client-ID", "jzkbprff40iqj646a697cyrvl0zt2m6");
                int indexOf = this.f33436b.indexOf(38);
                if (indexOf > 0) {
                    this.f33436b = this.f33436b.substring(0, indexOf);
                }
                Locale locale3 = Locale.US;
                this.d.getClass();
                String c12 = e91.c(this, "https://api.twitch.tv/kraken/streams/" + this.f33436b + "?stream_type=all", hashMap, false);
                if (isCancelled()) {
                    return null;
                }
                try {
                    new JSONObject(c12).getJSONObject("stream");
                    JSONObject jSONObject3 = new JSONObject(e91.c(this, "https://api.twitch.tv/api/channels/" + this.f33436b + "/access_token", hashMap, false));
                    ...
                    URLEncoder.encode("https://youtube.googleapis.com/v/" + this.f33436b, "UTF-8");
                    String str2 = this.f33436b;
            ...
            default:
                ...
                String[] strArr5 = this.f33437c;
                Locale locale4 = Locale.US;
                this.d.getClass();
                String c13 = e91.c(this, "https://player.vimeo.com/video/" + this.f33436b + "/config", null, true);
                if (isCancelled()) {
                    return null;
                }
                try {
    ...
    public final void onPostExecute(Object obj) {
        switch (this.f33435a) {
            ...
            case 1:
                ...
                e91 e91Var2 = this.d;
                if (str2 != null) {
                    e91Var2.f26532w = true;
                    e91Var2.f26533x = str2;
                    String[] strArr = this.f33437c;
                    e91Var2.f26534y = strArr[1];
                    e91Var2.B = strArr[2];
                    e91Var2.C = strArr[3];
                    if (e91Var2.f26531s) {
                        e91Var2.i();
            ...
            case 2:
                ...
                e91 e91Var3 = this.d;
                if (str3 != null) {
                    e91Var3.f26532w = true;
                    e91Var3.f26533x = str3;
                    e91Var3.f26534y = this.f33437c[1];
                    if (e91Var3.f26531s) {
                        e91Var3.i();
                    }
                    e91Var3.j(false, true);
                    e91Var3.f26521c0.d(true, true);
                    return;
                } else if (!isCancelled()) {
                    e91Var3.h();
                    return;
            ...
            case 3:
                ...
                e91 e91Var4 = this.d;
                if (str4 != null) {
                    e91Var4.f26532w = true;
                    e91Var4.f26533x = str4;
                    e91Var4.f26534y = this.f33437c[1];
                    if (e91Var4.f26531s) {
                        e91Var4.i();
                    }
                    e91Var4.j(false, true);
                    e91Var4.f26521c0.d(true, true);
                    return;
                } else if (!isCancelled()) {
                    e91Var4.h();
                    return;
            ...
            default:
                ...
                e91 e91Var5 = this.d;
                if (str5 != null) {
                    e91Var5.f26532w = true;
                    e91Var5.f26533x = str5;
                    e91Var5.f26534y = this.f33437c[1];
                    if (e91Var5.f26531s) {
                        e91Var5.i();
                    }
                    e91Var5.j(false, true);
                    e91Var5.f26521c0.d(true, true);
                    return;
                } else if (!isCancelled()) {
                    e91Var5.h();
                    return;
