...
public final class y81 extends View {
    ...
    public float I;
    public final org.telegram.ui.ActionBar.d6 f30592a;
    public final Paint f30593b;
    public final Paint f30594c;
    ...
    public final Bitmap f30599w;
    public float f30600x;
    public ObjectAnimator f30601y;

    public y81(Context context, boolean z10, View view, org.telegram.ui.ActionBar.d6 d6Var) {
        super(context);
        this.F = new int[4];
    ...
    public final void a(boolean z10, boolean z11) {
        ...
        if (z11) {
            ...
            this.f30601y = ofFloat;
            ofFloat.setDuration(300L);
            this.f30601y.start();
            return;
        }
        ObjectAnimator objectAnimator = this.f30601y;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        RectF rectF = this.f30597r;
        rectF.set(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight());
        View view = this.E;
        org.telegram.ui.ActionBar.d6 d6Var = this.f30592a;
        ...
        canvas2.drawText(this.f30595f, AndroidUtilities.dp(28.0f) + A, AndroidUtilities.dp(21.0f), textPaint);
        canvas2.save();
        canvas2.translate(A, AndroidUtilities.dp(7.0f));
        Bitmap bitmap = this.f30599w;
        int i11 = 0;
        Paint paint3 = this.e;
        if (bitmap != null) {
            float f12 = this.f30600x;
            if (f12 <= 0.5f) {
                f7 = f12 / 0.5f;
                f10 = f7;
            } else {
            ...
            if (f10 != 1.0f) {
                ...
                canvas3.drawRoundRect(rectF, rectF.width() / 2.0f, rectF.height() / 2.0f, this.f30593b);
            }
            if (this.f30600x > 0.5f) {
                Paint paint4 = this.f30594c;
    ...
    public final void onMeasure(int i10, int i11) {
        super.onMeasure(org.telegram.messenger.ok.C(56.0f, this.f30596n, 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(32.0f), 1073741824));
    }
