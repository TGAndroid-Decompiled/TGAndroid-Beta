...
public final class lr0 implements Runnable {
    ...
    public final org.telegram.ui.ActionBar.d2[] f25080b;
    public final int f25081c;
    public final int d;

    public lr0(org.telegram.ui.ActionBar.d2[] d2VarArr, int i10, int i11, int i12) {
        this.f25079a = i12;
        this.f25080b = d2VarArr;
        this.f25081c = i10;
        this.d = i11;
    }
    ...
    public final void run() {
        switch (this.f25079a) {
            case 0:
                org.telegram.ui.ActionBar.d2[] d2VarArr = this.f25080b;
                org.telegram.ui.ActionBar.d2 d2Var = d2VarArr[0];
                if (d2Var != null) {
                    final int i10 = this.f25081c;
                ...
                return;
            default:
                org.telegram.ui.ActionBar.d2[] d2VarArr2 = this.f25080b;
                org.telegram.ui.ActionBar.d2 d2Var2 = d2VarArr2[0];
                if (d2Var2 != null) {
                    final int i12 = this.f25081c;
