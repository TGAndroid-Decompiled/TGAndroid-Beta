...
public final class r50 implements Runnable {
    ...
    public final void run() {
        ...
        v50 v50Var = this.f29963b;
        switch (i10) {
            case 0:
                v50Var.H0.m(false, false);
                return;
            case 1:
                NotificationCenter.getInstance(v50Var.H0.f32152a).lambda$postNotificationNameOnUIThread$1(NotificationCenter.stopAllHeavyOperations, 512);
                return;
            case 2:
                ...
                videoEditedInfo3.originalPath = w50Var.f32156b0.getAbsolutePath();
                v50Var.h(w50Var.f32156b0);
                w50Var.N.estimatedDuration = w50Var.f32164f0;
                NotificationCenter.getInstance(w50Var.f32152a).lambda$postNotificationNameOnUIThread$1(NotificationCenter.audioDidSent, Integer.valueOf(w50Var.Q), w50Var.N, w50Var.f32156b0.getAbsolutePath(), v50Var.A0);
                return;
            case 3:
                if (v50Var.G0 && (videoEditedInfo = v50Var.H0.N) != null) {
                    videoEditedInfo.notReadyYet = false;
                }
                v50Var.c(v50Var.f31124a, 0L, true);
