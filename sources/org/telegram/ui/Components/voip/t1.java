...
public final class t1 implements ViewTreeObserver.OnPreDrawListener {
    ...
    public final boolean onPreDraw() {
        ...
        if (!v1Var.P) {
            ...
            float measuredWidth = this.f29624a - ((v1Var.getMeasuredWidth() - (v1Var.getMeasuredWidth() * 0.23f)) / 2.0f);
            float measuredHeight = this.f29625b - ((v1Var.getMeasuredHeight() - (v1Var.getMeasuredHeight() * 0.23f)) / 2.0f);
            ...
            v1Var.animate().setListener(new q81(this, 8)).scaleX(1.0f).scaleY(1.0f).translationX(0.0f).translationY(0.0f).alpha(1.0f).setDuration(300L).setStartDelay(0L).setInterpolator(rr.f28031f).start();
            return false;
        }
        v1Var.M = false;
        v1Var.requestLayout();
