...
public final class t2 extends View {
    public StaticLayout f29213a;
    public final RectF f29214b;
    public final Paint f29215c;
    public final Paint d;
    public String e;
    public final TextPaint f29216f;
    public int h;
    public boolean f29217n;
    public final Drawable f29218r;
    public final i2.g0 f29219s;

    public t2(Activity activity) {
        super(activity);
        this.f29214b = new RectF();
        Paint paint = new Paint(1);
        this.f29215c = paint;
        Paint paint2 = new Paint(1);
        this.d = paint2;
        TextPaint textPaint = new TextPaint(1);
        this.f29216f = textPaint;
        this.h = 4;
        this.f29217n = false;
        this.f29219s = new i2.g0(this, 25);
    ...
    public final void a() {
        ...
        if (str == null || !str.equals(formatLongDuration)) {
            ...
            String str2 = this.e;
            TextPaint textPaint = this.f29216f;
            this.f29213a = new StaticLayout(str2, textPaint, (int) textPaint.measureText(str2), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
        }
    ...
    public final void onDraw(Canvas canvas) {
        int dp;
        Paint paint;
        StaticLayout staticLayout = this.f29213a;
        int i10 = 0;
    ...
    public void setVisibility(int i10) {
        if (getVisibility() != i10) {
            if (i10 == 0) {
                ...
                String str = this.e;
                TextPaint textPaint = this.f29216f;
                this.f29213a = new StaticLayout(str, textPaint, (int) textPaint.measureText(str), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
                a();
            } else {
                this.e = null;
                this.f29213a = null;
